...
<head>
  ...
  <title>PHP: CollectionFind::sort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-collectionfind.sort.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-collectionfind.sort.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collectionfind.sort.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-collectionfind.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-collectionfind.offset.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mysql-xdevapi-collectionmodify.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collectionfind.sort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysql-xdevapi-collectionfind.sort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysql-xdevapi-collectionfind.sort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysql-xdevapi-collectionfind.sort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysql-xdevapi-collectionfind.sort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysql-xdevapi-collectionfind.sort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysql-xdevapi-collectionfind.sort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysql-xdevapi-collectionfind.sort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysql-xdevapi-collectionfind.sort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysql-xdevapi-collectionfind.sort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysql-xdevapi-collectionfind.sort.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: CollectionFind::sort - Manual" />
<meta name="twitter:description" content="Set the sorting criteria" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CollectionFind::sort - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.mysql-xdevapi-collectionmodify.php">
          mysql_xdevapi\CollectionModify &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysql-xdevapi-collectionfind.offset.php">
          &laquo; CollectionFind::offset        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-collectionfind.sort.php' selected="selected">English</option>
            <option value='de/mysql-xdevapi-collectionfind.sort.php'>German</option>
            <option value='es/mysql-xdevapi-collectionfind.sort.php'>Spanish</option>
            <option value='fr/mysql-xdevapi-collectionfind.sort.php'>French</option>
            <option value='it/mysql-xdevapi-collectionfind.sort.php'>Italian</option>
            <option value='ja/mysql-xdevapi-collectionfind.sort.php'>Japanese</option>
            <option value='pt_BR/mysql-xdevapi-collectionfind.sort.php'>Brazilian Portuguese</option>
            <option value='ru/mysql-xdevapi-collectionfind.sort.php'>Russian</option>
            <option value='tr/mysql-xdevapi-collectionfind.sort.php'>Turkish</option>
            <option value='uk/mysql-xdevapi-collectionfind.sort.php'>Ukrainian</option>
            <option value='zh/mysql-xdevapi-collectionfind.sort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysql-xdevapi-collectionfind.sort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">CollectionFind::sort</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">CollectionFind::sort</span> &mdash; <span class="dc-title">Set the sorting criteria</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-mysql-xdevapi-collectionfind.sort-examples">
  ...
  <div class="example" id="example-1720">
   <p><strong>Example #1 <span class="function"><strong>mysql_xdevapi\CollectionFind::sort()</strong></span> example</strong></p>
  ...
  array(4) {
    ...
    string(8) &quot;Reginald&quot;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/collectionfind/sort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-collectionfind.sort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-collectionfind.sort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-collectionfind.sort.php">＋<small>add a note</small></a></span>
