...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-flush.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-field-type-oid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-free-result.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-flush.php' selected="selected">English</option>
            ...
            <option value='tr/function.pg-flush.php'>Turkish</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-flush-returnvalues">
  ...
  <p class="para">
   ...
   more remains or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <td>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-flush.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-flush%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-flush&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-flush.php">＋<small>add a note</small></a></span>
