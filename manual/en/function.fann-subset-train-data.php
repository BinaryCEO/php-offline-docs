...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-subset-train-data.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-shuffle-train-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-test.php">
...
<meta name="Description" content="Returns an copy of a subset of the train data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_subset_train_data - Manual" />
<meta name="twitter:description" content="Returns an copy of a subset of the train data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_subset_train_data - Manual" />
<meta itemprop="description" content="Returns an copy of a subset of the train data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an copy of a subset of the train data" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-subset-train-data.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.fann-subset-train-data.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_subset_train_data</span> &mdash; <span class="dc-title">Returns an copy of a subset of the train data</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.fann-subset-train-data-description">
  ...
  <p class="para rdfs-comment">
   Returns an copy of a subset of the train data <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>, starting at position
   <code class="literal">pos</code> and <code class="literal">length</code> elements forward.
  </p>
  <p class="para">
   The <code class="literal">fann_subset_train_data(train_data, 0, fann_length_train_data(train_data))</code> do the same as
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-subset-train-data-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-duplicate-train-data.php" class="function" rel="rdfs-seeAlso">fann_duplicate_train_data()</a> - Returns an exact copy of a fann train data</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-subset-train-data.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-subset-train-data%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-subset-train-data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-subset-train-data.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /></span><span class="comment">// Use this code to split your data into smaller sets.<br />// Useful for splitting your training data into training and testing groups<br /><br />// Load Data<br /></span><span class="default">$data_file </span><span class="keyword">= </span><span class="string">"MyTrainingData.data"</span><span class="keyword">;<br /></span><span class="default">$train_data </span><span class="keyword">= </span><span class="default">fann_read_train_from_file</span><span class="keyword">(</span><span class="default">dirname</span><span class="keyword">(</span><span class="default">__FILE__</span><span class="keyword">)  .  </span><span class="default">DIRECTORY_SEPARATOR  </span><span class="keyword">.  </span><span class="default">$data_file</span><span class="keyword">);<br /><br /></span><span class="comment">// Calculate how many examples are in the first group<br /></span><span class="default">$total_length </span><span class="keyword">= </span><span class="default">fann_length_train_data</span><span class="keyword">(</span><span class="default">$train_data</span><span class="keyword">);<br /></span><span class="default">$a_length </span><span class="keyword">= </span><span class="default">floor</span><span class="keyword">(</span><span class="default">$total_length </span><span class="keyword">/ </span><span class="default">10</span><span class="keyword">);<br /><br /></span><span class="comment">// Split the subsets<br /></span><span class="default">$training_data_a  </span><span class="keyword">= </span><span class="default">fann_subset_train_data</span><span class="keyword">(</span><span class="default">$train_data</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$a_length</span><span class="keyword">);<br /></span><span class="default">$training_data_b  </span><span class="keyword">= </span><span class="default">fann_subset_train_data</span><span class="keyword">(</span><span class="default">$train_data</span><span class="keyword">, </span><span class="default">$a_length</span><span class="keyword">, </span><span class="default">$total_length</span><span class="keyword">-</span><span class="default">$a_length</span><span class="keyword">);<br /><br /></span><span class="comment">// Save the training data to separate files<br /></span><span class="default">fann_save_train </span><span class="keyword">(</span><span class="default">$training_data_a</span><span class="keyword">, </span><span class="string">'MyTrainingData_Subset_A.data'</span><span class="keyword">); </span><span class="comment">// 1/10 of the training data<br /></span><span class="default">fann_save_train </span><span class="keyword">(</span><span class="default">$training_data_b</span><span class="keyword">, </span><span class="string">'MyTrainingData_Subset_B.data'</span><span class="keyword">); </span><span class="comment">// 9/10 of the training data</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fann-subset-train-data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-subset-train-data.php">＋<small>add a note</small></a></div>
