...
<head>
  ...
  <title>PHP: Imagick::getImageMatteColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagemattecolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagemattecolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagemattecolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagematte.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagemimetype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagemattecolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagemattecolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagemattecolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagemattecolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagemattecolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagemattecolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagemattecolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagemattecolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagemattecolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagemattecolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagemattecolor.php" hreflang="zh">
...
<meta name="Description" content="Returns the image matte color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageMatteColor - Manual" />
<meta name="twitter:description" content="Returns the image matte color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageMatteColor - Manual" />
<meta itemprop="description" content="Returns the image matte color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the image matte color" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagemimetype.php">
          Imagick::getImageMimeType &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagematte.php">
          &laquo; Imagick::getImageMatte        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagemattecolor.php' selected="selected">English</option>
            <option value='de/imagick.getimagemattecolor.php'>German</option>
            <option value='es/imagick.getimagemattecolor.php'>Spanish</option>
            <option value='fr/imagick.getimagemattecolor.php'>French</option>
            <option value='it/imagick.getimagemattecolor.php'>Italian</option>
            <option value='ja/imagick.getimagemattecolor.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagemattecolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagemattecolor.php'>Russian</option>
            <option value='tr/imagick.getimagemattecolor.php'>Turkish</option>
            <option value='uk/imagick.getimagemattecolor.php'>Ukrainian</option>
            <option value='zh/imagick.getimagemattecolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagemattecolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageMatteColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageMatteColor</span> &mdash; <span class="dc-title">Returns the image matte color</span></p>

 </div>

 <div id="imagick.getimagemattecolor-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimagemattecolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageMatteColor</strong></span>(): <span class="type"><a href="class.imagickpixel.php" class="type ImagickPixel">ImagickPixel</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagemattecolor-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagemattecolor-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagemattecolor-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagemattecolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagemattecolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagemattecolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagemattecolor.php">＋<small>add a note</small></a></span>
