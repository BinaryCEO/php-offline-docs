...
<head>
  ...
  <title>PHP: fileperms - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fileperms.php">
 <link rel="shorturl" href="https://www.php.net/fileperms">
 <link rel="alternate" href="https://www.php.net/fileperms" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fileowner.php">
 <link rel="next" href="https://www.php.net/manual/en/function.filesize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fileperms.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fileperms.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fileperms.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fileperms.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fileperms.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fileperms.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fileperms.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fileperms.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fileperms.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fileperms.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fileperms.php" hreflang="zh">
...
<meta name="Description" content="Gets file permissions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fileperms - Manual" />
<meta name="twitter:description" content="Gets file permissions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fileperms - Manual" />
<meta itemprop="description" content="Gets file permissions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets file permissions" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fileperms.php' selected="selected">English</option>
            <option value='de/function.fileperms.php'>German</option>
            <option value='es/function.fileperms.php'>Spanish</option>
            <option value='fr/function.fileperms.php'>French</option>
            <option value='it/function.fileperms.php'>Italian</option>
            <option value='ja/function.fileperms.php'>Japanese</option>
            <option value='pt_BR/function.fileperms.php'>Brazilian Portuguese</option>
            <option value='ru/function.fileperms.php'>Russian</option>
            <option value='tr/function.fileperms.php'>Turkish</option>
            <option value='uk/function.fileperms.php'>Ukrainian</option>
            <option value='zh/function.fileperms.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fileperms" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fileperms</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">fileperms</span> &mdash; <span class="dc-title">Gets file permissions</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fileperms-returnvalues">
  ...
  <p class="para">
   ...
   are the same as the permissions expected by <span class="function"><a href="function.chmod.php" class="function">chmod()</a></span>,
   however on most platforms the return value will also include information on
   the type of file given as <code class="parameter">filename</code>. The examples
  ...
  <p class="para">
   ...
   <code class="literal">st_mode</code> member of the structure returned by the C
   library&#039;s <span class="function"><a href="function.stat.php" class="function">stat()</a></span> function. Exactly which bits are set
...
Upon failure, an <strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> is emitted.
 ...
 <div class="refsect1 examples" id="refsect1-function.fileperms-examples">
  ...
  <p class="para">
   <div class="example" id="example-2364">
    <p><strong>Example #1 Display permissions as an octal value</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.stat.php" class="function" rel="rdfs-seeAlso">stat()</a> - Gives information about a file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/fileperms.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fileperms%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fileperms&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fileperms.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="113060">  <div class="votes">
    <div id="Vu113060">
    <a href="/manual/vote-note.php?id=113060&amp;page=function.fileperms&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113060">
    <a href="/manual/vote-note.php?id=113060&amp;page=function.fileperms&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113060" title="84% like this...">
    36
    </div>
  </div>
  <a href="#113060" class="name">
  <strong class="user"><em>coolmic at example dot com</em></strong></a><a class="genanchor" href="#113060"> &para;</a><div class="date" title="2013-08-23 03:52"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom113060">
<div class="phpcode"><code><span class="html">Don't use substr, use bit operator<br /><span class="default">&lt;?php<br />decoct</span><span class="keyword">(</span><span class="default">fileperms</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">) &amp; </span><span class="default">0777</span><span class="keyword">); </span><span class="comment">// return "755" for example<br /></span><span class="default">?&gt;<br /></span><br />If you want to compare permission<br /><span class="default">&lt;?php<br />0755 </span><span class="keyword">=== (</span><span class="default">fileperms</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">) &amp; </span><span class="default">0777</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="107719">  <div class="votes">
    <div id="Vu107719">
    <a href="/manual/vote-note.php?id=107719&amp;page=function.fileperms&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd107719">
    <a href="/manual/vote-note.php?id=107719&amp;page=function.fileperms&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V107719" title="68% like this...">
    6
    </div>
  </div>
  <a href="#107719" class="name">
  <strong class="user"><em>admin at torntech dot com</em></strong></a><a class="genanchor" href="#107719"> &para;</a><div class="date" title="2012-02-28 10:14"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom107719">
<div class="phpcode"><code><span class="html">This may not be immediately apparent to some, but you can use octdec( $octal_value ) to match the permissions retrieved by file perms<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">//assumes file has 2770 permissions<br /></span><span class="default">$perm</span><span class="keyword">= </span><span class="default">fileperms</span><span class="keyword">( </span><span class="default">__FILE__ </span><span class="keyword">); <br /></span><span class="default">$bit </span><span class="keyword">= </span><span class="string">"102770"</span><span class="keyword">;<br /><br /></span><span class="default">printf</span><span class="keyword">( </span><span class="string">"%s\n"</span><span class="keyword">, </span><span class="default">octdec</span><span class="keyword">( </span><span class="default">$bit </span><span class="keyword">) );<br /></span><span class="default">printf</span><span class="keyword">( </span><span class="string">"%s\n"</span><span class="keyword">, </span><span class="default">$perm</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="124785">  <div class="votes">
    <div id="Vu124785">
    <a href="/manual/vote-note.php?id=124785&amp;page=function.fileperms&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124785">
    <a href="/manual/vote-note.php?id=124785&amp;page=function.fileperms&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124785" title="66% like this...">
    1
    </div>
  </div>
  <a href="#124785" class="name">
  <strong class="user"><em>chris at ocproducts dot com</em></strong></a><a class="genanchor" href="#124785"> &para;</a><div class="date" title="2020-03-02 07:53"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124785">
<div class="phpcode"><code><span class="html">Windows has a very different file permission model to Unix and integrates them only minimally.<br /><br />Here's how Windows calculates the bitmask...<br /><br />u+w/g+w/o+w is set based on whether the file has the read only flag.<br /><br />u+r/g+w/o+w is always set.<br /><br />u+x/g+x/o+x is set based on whether $filename is an inherently executable file (e.g. bat) or a directory.<br /><br />Windows isn't integrating its ACLs at all.<br /><br />Here's the source of all this: <a href="https://docs.microsoft.com/en-us/cpp/c-runtime-library/reference/stat-functions?view=vs-2019" rel="nofollow" target="_blank">https://docs.microsoft.com/en-us/cpp/c-runtime-library/reference/stat-functions?view=vs-2019</a> (but it doesn't provide many details)</span></code></div>
  </div>
 </div>
  <div class="note" id="75502">  <div class="votes">
    <div id="Vu75502">
    <a href="/manual/vote-note.php?id=75502&amp;page=function.fileperms&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd75502">
    <a href="/manual/vote-note.php?id=75502&amp;page=function.fileperms&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V75502" title="61% like this...">
    5
    </div>
  </div>
  <a href="#75502" class="name">
  <strong class="user"><em>paul2712 at gmail dot com</em></strong></a><a class="genanchor" href="#75502"> &para;</a><div class="date" title="2007-06-02 09:08"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom75502">
<div class="phpcode"><code><span class="html">Do not forget: clearstatcache();<br />==============================<br /> <br />When ever you make a:<br /><br />mkdir($dstdir, 0770 ))<br /><br />or a:<br /><br />chmod($dstdir, 0774 ); <br /><br />You have to call:<br /><br />clearstatcache();<br /><br />before you can call:<br /><br />fileperms($dstdir);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fileperms&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fileperms.php">＋<small>add a note</small></a></div>
