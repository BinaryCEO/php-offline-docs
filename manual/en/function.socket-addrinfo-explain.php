...
<head>
  ...
  <title>PHP: socket_addrinfo_explain - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-addrinfo-explain.php">
 <link rel="shorturl" href="https://www.php.net/socket-addrinfo-explain">
 <link rel="alternate" href="https://www.php.net/socket-addrinfo-explain" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-addrinfo-connect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-addrinfo-lookup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-addrinfo-explain.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-addrinfo-explain.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-addrinfo-explain.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-addrinfo-explain.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-addrinfo-explain.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-addrinfo-explain.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-addrinfo-explain.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-addrinfo-explain.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-addrinfo-explain.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-addrinfo-explain.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-addrinfo-explain.php" hreflang="zh">
...
<meta name="Description" content="Get information about addrinfo" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_addrinfo_explain - Manual" />
<meta name="twitter:description" content="Get information about addrinfo" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_addrinfo_explain - Manual" />
<meta itemprop="description" content="Get information about addrinfo" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get information about addrinfo" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.socket-addrinfo-lookup.php">
          socket_addrinfo_lookup &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-addrinfo-connect.php">
          &laquo; socket_addrinfo_connect        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-addrinfo-explain.php' selected="selected">English</option>
            <option value='de/function.socket-addrinfo-explain.php'>German</option>
            <option value='es/function.socket-addrinfo-explain.php'>Spanish</option>
            <option value='fr/function.socket-addrinfo-explain.php'>French</option>
            <option value='it/function.socket-addrinfo-explain.php'>Italian</option>
            <option value='ja/function.socket-addrinfo-explain.php'>Japanese</option>
            <option value='pt_BR/function.socket-addrinfo-explain.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-addrinfo-explain.php'>Russian</option>
            <option value='tr/function.socket-addrinfo-explain.php'>Turkish</option>
            <option value='uk/function.socket-addrinfo-explain.php'>Ukrainian</option>
            <option value='zh/function.socket-addrinfo-explain.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-addrinfo-explain" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">socket_addrinfo_explain</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">socket_addrinfo_explain</span> &mdash; <span class="dc-title">Get information about addrinfo</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.socket-addrinfo-explain-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>socket_addrinfo_explain</strong></span>(<span class="methodparam"><span class="type"><a href="class.addressinfo.php" class="type AddressInfo">AddressInfo</a></span> <code class="parameter">$address</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>socket_addrinfo_explain()</strong></span> exposed the underlying
   <code class="literal">addrinfo</code> structure.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.socket-addrinfo-explain-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.socket-addrinfo-explain-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an array containing the fields in the <code class="literal">addrinfo</code> structure.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.socket-addrinfo-explain-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.socket-addrinfo-explain-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.socket-addrinfo-lookup.php" class="function" rel="rdfs-seeAlso">socket_addrinfo_lookup()</a> - Get array with contents of getaddrinfo about the given hostname</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-addrinfo-explain.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-addrinfo-explain%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-addrinfo-explain&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-addrinfo-explain.php">＋<small>add a note</small></a></span>
