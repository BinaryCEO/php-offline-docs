...
<head>
  ...
  <title>PHP: array_uintersect_uassoc - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.array-uintersect-uassoc.php">
 <link rel="shorturl" href="https://www.php.net/array-uintersect-uassoc">
 <link rel="alternate" href="https://www.php.net/array-uintersect-uassoc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.array-uintersect-assoc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.array-unique.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.array-uintersect-uassoc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.array-uintersect-uassoc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.array-uintersect-uassoc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.array-uintersect-uassoc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.array-uintersect-uassoc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.array-uintersect-uassoc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.array-uintersect-uassoc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.array-uintersect-uassoc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.array-uintersect-uassoc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.array-uintersect-uassoc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.array-uintersect-uassoc.php" hreflang="zh">
...
<meta name="Description" content="Computes the intersection of arrays with additional index check, compares data and indexes by separate callback functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: array_uintersect_uassoc - Manual" />
<meta name="twitter:description" content="Computes the intersection of arrays with additional index check, compares data and indexes by separate callback functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: array_uintersect_uassoc - Manual" />
<meta itemprop="description" content="Computes the intersection of arrays with additional index check, compares data and indexes by separate callback functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Computes the intersection of arrays with additional index check, compares data and indexes by separate callback functions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.array-uintersect-assoc.php">
          &laquo; array_uintersect_assoc        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.array-uintersect-uassoc.php' selected="selected">English</option>
            <option value='de/function.array-uintersect-uassoc.php'>German</option>
            <option value='es/function.array-uintersect-uassoc.php'>Spanish</option>
            <option value='fr/function.array-uintersect-uassoc.php'>French</option>
            <option value='it/function.array-uintersect-uassoc.php'>Italian</option>
            <option value='ja/function.array-uintersect-uassoc.php'>Japanese</option>
            <option value='pt_BR/function.array-uintersect-uassoc.php'>Brazilian Portuguese</option>
            <option value='ru/function.array-uintersect-uassoc.php'>Russian</option>
            <option value='tr/function.array-uintersect-uassoc.php'>Turkish</option>
            <option value='uk/function.array-uintersect-uassoc.php'>Ukrainian</option>
            <option value='zh/function.array-uintersect-uassoc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.array-uintersect-uassoc" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">array_uintersect_uassoc</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">array_uintersect_uassoc</span> &mdash; <span class="dc-title">Computes the intersection of arrays with additional index check, compares data and indexes by separate callback functions</span></p>
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$arrayA </span><span style="color: #007700">= [</span><span style="color: #DD0000">"string"</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">];<br /></span><span style="color: #0000BB">$arrayB </span><span style="color: #007700">= [[</span><span style="color: #DD0000">"value" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1</span><span style="color: #007700">]];<br /></span><span style="color: #FF8000">// $item1 and $item2 can be any of "string", 1 or ["value" =&gt; 1]<br /></span><span style="color: #0000BB">$compareFunc </span><span style="color: #007700">= static function (</span><span style="color: #0000BB">$item1</span><span style="color: #007700">, </span><span style="color: #0000BB">$item2</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$value1 </span><span style="color: #007700">= </span><span style="color: #0000BB">is_string</span><span style="color: #007700">(</span><span style="color: #0000BB">$item1</span><span style="color: #007700">) ? </span><span style="color: #0000BB">strlen</span><span style="color: #007700">(</span><span style="color: #0000BB">$item1</span><span style="color: #007700">) : (</span><span style="color: #0000BB">is_array</span><span style="color: #007700">(</span><span style="color: #0000BB">$item1</span><span style="color: #007700">) ? </span><span style="color: #0000BB">$item1</span><span style="color: #007700">[</span><span style="color: #DD0000">"value"</span><span style="color: #007700">] : </span><span style="color: #0000BB">$item1</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$value2 </span><span style="color: #007700">= </span><span style="color: #0000BB">is_string</span><span style="color: #007700">(</span><span style="color: #0000BB">$item2</span><span style="color: #007700">) ? </span><span style="color: #0000BB">strlen</span><span style="color: #007700">(</span><span style="color: #0000BB">$item2</span><span style="color: #007700">) : (</span><span style="color: #0000BB">is_array</span><span style="color: #007700">(</span><span style="color: #0000BB">$item2</span><span style="color: #007700">) ? </span><span style="color: #0000BB">$item2</span><span style="color: #007700">[</span><span style="color: #DD0000">"value"</span><span style="color: #007700">] : </span><span style="color: #0000BB">$item2</span><span style="color: #007700">);<br />    return </span><span style="color: #0000BB">$value1 </span><span style="color: #007700">&lt;=&gt; </span><span style="color: #0000BB">$value2</span><span style="color: #007700">;<br />};<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.array-uintersect-uassoc-returnvalues">
  ...
  <p class="para">
   ...
   <code class="parameter">array1</code> that are present in all the arguments.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.array-uintersect-uassoc-examples">
  ...
  <p class="para">
   <div class="example" id="example-5285">
    <p><strong>Example #1 <span class="function"><strong>array_uintersect_uassoc()</strong></span> example</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.array-uintersect-assoc.php" class="function" rel="rdfs-seeAlso">array_uintersect_assoc()</a> - Computes the intersection of arrays with additional index check, compares data by a callback function</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/array-uintersect-uassoc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.array-uintersect-uassoc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.array-uintersect-uassoc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-uintersect-uassoc.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="45251">  <div class="votes">
    <div id="Vu45251">
    <a href="/manual/vote-note.php?id=45251&amp;page=function.array-uintersect-uassoc&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd45251">
    <a href="/manual/vote-note.php?id=45251&amp;page=function.array-uintersect-uassoc&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V45251" title="55% like this...">
    2
    </div>
  </div>
  <a href="#45251" class="name">
  <strong class="user"><em>aidan at php dot net</em></strong></a><a class="genanchor" href="#45251"> &para;</a><div class="date" title="2004-08-31 03:52"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom45251">
<div class="phpcode"><code><span class="html">Please note, the correct function synopsis is:<br /><br />array array_uintersect_uassoc ( array array1, array array2 [, array ...], callback data_compare_func, callback key_compare_func)<br /><br />You may specifiy as many arrays as you like, but the last two parameters must be valid call back functions.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.array-uintersect-uassoc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-uintersect-uassoc.php">＋<small>add a note</small></a></div>
