...
<head>
  ...
  <title>PHP: oci_set_prefetch - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-set-prefetch.php">
 <link rel="shorturl" href="https://www.php.net/oci-set-prefetch">
 <link rel="alternate" href="https://www.php.net/oci-set-prefetch" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-set-module-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-set-prefetch-lob.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-set-prefetch.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-set-prefetch.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-set-prefetch.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-set-prefetch.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-set-prefetch.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-set-prefetch.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-set-prefetch.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-set-prefetch.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-set-prefetch.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-set-prefetch.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-set-prefetch.php" hreflang="zh">
...
<meta name="Description" content="Sets number of rows to be prefetched by queries" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_set_prefetch - Manual" />
<meta name="twitter:description" content="Sets number of rows to be prefetched by queries" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_set_prefetch - Manual" />
<meta itemprop="description" content="Sets number of rows to be prefetched by queries" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets number of rows to be prefetched by queries" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.oci-set-prefetch-lob.php">
          oci_set_prefetch_lob &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-set-module-name.php">
          &laquo; oci_set_module_name        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-set-prefetch.php' selected="selected">English</option>
            <option value='de/function.oci-set-prefetch.php'>German</option>
            <option value='es/function.oci-set-prefetch.php'>Spanish</option>
            <option value='fr/function.oci-set-prefetch.php'>French</option>
            <option value='it/function.oci-set-prefetch.php'>Italian</option>
            <option value='ja/function.oci-set-prefetch.php'>Japanese</option>
            <option value='pt_BR/function.oci-set-prefetch.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-set-prefetch.php'>Russian</option>
            <option value='tr/function.oci-set-prefetch.php'>Turkish</option>
            <option value='uk/function.oci-set-prefetch.php'>Ukrainian</option>
            <option value='zh/function.oci-set-prefetch.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-set-prefetch" class="refentry">
    ...
    <li>
     ...
     ini option
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-set-prefetch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-set-prefetch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-set-prefetch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-set-prefetch.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="28173">  <div class="votes">
    <div id="Vu28173">
    <a href="/manual/vote-note.php?id=28173&amp;page=function.oci-set-prefetch&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd28173">
    <a href="/manual/vote-note.php?id=28173&amp;page=function.oci-set-prefetch&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V28173" title="60% like this...">
    1
    </div>
  </div>
  <a href="#28173" class="name">
  <strong class="user"><em>bmichael at goldparrot dot com</em></strong></a><a class="genanchor" href="#28173"> &para;</a><div class="date" title="2003-01-04 03:00"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom28173">
<div class="phpcode"><code><span class="html">If your are using Oracle's OCI libraries, on any project, which PHP does, you can use this limit.
<br />
<br />I have done network level testing on the effect of this parameter.  It does improved efficiency.  Big Time.
<br />
<br />Oracle uses SQL*Net as the transport mechanism for data between your connection and the database.  That is why you must setup Oracle properly.
<br />
<br />This parameter tells SQL*NET to Buffer more results.  When SQL*NET (at the server) gets a request for data, it bundles up X rows (1,2,3,1000, etc) for transport.  It sends the appropriate SQL*NET headers back to the client, Waits for an ACK then begins sending data in MTU sized chunks (ethernet is something like 1500 bytes and ATM's WANS are around 1000 bytes).  The chunk size can also be tuned in SQL*NET, but with much less improvements.
<br />
<br />TCP/IP then takes the data across the wire, breaking it up into multiple TCP/IP packets.
<br />
<br />Once the exchange is done, the SQL*NET client sends an
<br />ACK back to the SQL*NET Listener (the Oracle Server) and the transaction is complete.
<br />
<br />Each round trip, SQL*NET looks up inside the server memory (UGA - user global area) to find the query results. It then grabs the rows necessary to send.  If it is one row, versus 1000 rows.  The process is the same. 
<br />
<br />There is much I could tell you on how the Database itself reacts.  If you can significantly lessen the amount of round trips you are making... WOW.  
<br />
<br />For more info on Oracle OCI go to <a href="http://otn.oracle.com" rel="nofollow" target="_blank">http://otn.oracle.com</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.oci-set-prefetch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-set-prefetch.php">＋<small>add a note</small></a></div>
