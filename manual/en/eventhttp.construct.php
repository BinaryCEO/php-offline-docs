...
<head>
  ...
  <title>PHP: EventHttp::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/eventhttp.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/eventhttp.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/eventhttp.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.eventhttp.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventhttp.bind.php">
 <link rel="next" href="https://www.php.net/manual/en/eventhttp.removeserveralias.php">

 <link rel="alternate" href="https://www.php.net/manual/en/eventhttp.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/eventhttp.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/eventhttp.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/eventhttp.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/eventhttp.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/eventhttp.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/eventhttp.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/eventhttp.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/eventhttp.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/eventhttp.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/eventhttp.construct.php" hreflang="zh">
...
<meta name="Description" content="Constructs EventHttp object (the HTTP server)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventHttp::__construct - Manual" />
<meta name="twitter:description" content="Constructs EventHttp object (the HTTP server)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventHttp::__construct - Manual" />
<meta itemprop="description" content="Constructs EventHttp object (the HTTP server)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Constructs EventHttp object (the HTTP server)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="eventhttp.removeserveralias.php">
          EventHttp::removeServerAlias &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="eventhttp.bind.php">
          &laquo; EventHttp::bind        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/eventhttp.construct.php' selected="selected">English</option>
            <option value='de/eventhttp.construct.php'>German</option>
            <option value='es/eventhttp.construct.php'>Spanish</option>
            <option value='fr/eventhttp.construct.php'>French</option>
            <option value='it/eventhttp.construct.php'>Italian</option>
            <option value='ja/eventhttp.construct.php'>Japanese</option>
            <option value='pt_BR/eventhttp.construct.php'>Brazilian Portuguese</option>
            <option value='ru/eventhttp.construct.php'>Russian</option>
            <option value='tr/eventhttp.construct.php'>Turkish</option>
            <option value='uk/eventhttp.construct.php'>Ukrainian</option>
            <option value='zh/eventhttp.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="eventhttp.construct" class="refentry">
...
Connection: close</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventhttp/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Feventhttp.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=eventhttp.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eventhttp.construct.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117543">  <div class="votes">
    <div id="Vu117543">
    <a href="/manual/vote-note.php?id=117543&amp;page=eventhttp.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117543">
    <a href="/manual/vote-note.php?id=117543&amp;page=eventhttp.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117543" title="no votes...">
    0
    </div>
  </div>
  <a href="#117543" class="name">
  <strong class="user"><em>Bas Vijfwinkel</em></strong></a><a class="genanchor" href="#117543"> &para;</a><div class="date" title="2015-06-26 09:22"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117543">
<div class="phpcode"><code><span class="html">If you try to use the SSL context parameter and you receive an error that you're using 2 parameters instead of 1, then your libevent library is not recent enough to support all features.<br />When installing the event extension with PECL, the libevent library needs a certain version to support certain functions.<br />PECL does not show any errors or warnings but simple disables everything that your libevent version does not support.<br /><br />For further details see my comment at<br /><a href="http://php.net/manual/en/event.examples.php" rel="nofollow" target="_blank">http://php.net/manual/en/event.examples.php</a></span></code></div>
  </div>
 </div>
  <div class="note" id="116833">  <div class="votes">
    <div id="Vu116833">
    <a href="/manual/vote-note.php?id=116833&amp;page=eventhttp.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116833">
    <a href="/manual/vote-note.php?id=116833&amp;page=eventhttp.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116833" title="50% like this...">
    0
    </div>
  </div>
  <a href="#116833" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#116833"> &para;</a><div class="date" title="2015-03-06 11:47"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116833">
<div class="phpcode"><code><span class="html">This demo code has a memory leak</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=eventhttp.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eventhttp.construct.php">＋<small>add a note</small></a></div>
