...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xml-set-unparsed-entity-decl-handler.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.xml-set-start-namespace-decl-handler.php">
 <link rel="next" href="https://www.php.net/manual/en/class.xmlparser.php">
...
<meta name="Description" content="Set up unparsed entity declaration handler" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: xml_set_unparsed_entity_decl_handler - Manual" />
<meta name="twitter:description" content="Set up unparsed entity declaration handler" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: xml_set_unparsed_entity_decl_handler - Manual" />
<meta itemprop="description" content="Set up unparsed entity declaration handler" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set up unparsed entity declaration handler" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xml-set-unparsed-entity-decl-handler.php' selected="selected">English</option>
            <option value='de/function.xml-set-unparsed-entity-decl-handler.php'>German</option>
            <option value='es/function.xml-set-unparsed-entity-decl-handler.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">xml_set_unparsed_entity_decl_handler</span> &mdash; <span class="dc-title">
 ...
 <div class="refsect1 description" id="refsect1-function.xml-set-unparsed-entity-decl-handler-description">
  ...
  <p class="para">
   The <code class="parameter">handler</code> will be called if the XML parser
...
<div class="annotation-interactive xmlcode"><pre class="xmlcode">&lt;!ENTITY &lt;parameter&gt;name&lt;/parameter&gt; {&lt;parameter&gt;publicId&lt;/parameter&gt; | &lt;parameter&gt;systemId&lt;/parameter&gt;}
  ...
  <p class="para">
   See <a href="http://www.w3.org/TR/1998/REC-xml-19980210#sec-external-ent" class="link external">&raquo;&nbsp;section 4.2.2 of
   ...
   The XML parser calling the handler.
         ...
         <dd>
          <span class="simpara">
           ...
           (<code class="parameter">systemId</code>) of the external entity.
          </span>
         </dd>
 ...
 <td>
  ...
  instance now; previously, a valid <code class="literal">xml</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xml/functions/xml-set-unparsed-entity-decl-handler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xml-set-unparsed-entity-decl-handler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xml-set-unparsed-entity-decl-handler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xml-set-unparsed-entity-decl-handler.php">＋<small>add a note</small></a></span>
