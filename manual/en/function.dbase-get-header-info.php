...
<head>
  ...
  <title>PHP: dbase_get_header_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.dbase-get-header-info.php">
 <link rel="shorturl" href="https://www.php.net/dbase-get-header-info">
 <link rel="alternate" href="https://www.php.net/dbase-get-header-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.dbase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.dbase-delete-record.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dbase-get-record.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.dbase-get-header-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.dbase-get-header-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.dbase-get-header-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.dbase-get-header-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.dbase-get-header-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.dbase-get-header-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.dbase-get-header-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.dbase-get-header-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.dbase-get-header-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.dbase-get-header-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.dbase-get-header-info.php" hreflang="zh">
...
<meta name="Description" content="Gets the header info of a database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: dbase_get_header_info - Manual" />
<meta name="twitter:description" content="Gets the header info of a database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: dbase_get_header_info - Manual" />
<meta itemprop="description" content="Gets the header info of a database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the header info of a database" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.dbase-get-record.php">
          dbase_get_record &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.dbase-delete-record.php">
          &laquo; dbase_delete_record        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.dbase-get-header-info.php' selected="selected">English</option>
            <option value='de/function.dbase-get-header-info.php'>German</option>
            <option value='es/function.dbase-get-header-info.php'>Spanish</option>
            <option value='fr/function.dbase-get-header-info.php'>French</option>
            <option value='it/function.dbase-get-header-info.php'>Italian</option>
            <option value='ja/function.dbase-get-header-info.php'>Japanese</option>
            <option value='pt_BR/function.dbase-get-header-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.dbase-get-header-info.php'>Russian</option>
            <option value='tr/function.dbase-get-header-info.php'>Turkish</option>
            <option value='uk/function.dbase-get-header-info.php'>Ukrainian</option>
            <option value='zh/function.dbase-get-header-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.dbase-get-header-info" class="refentry">
   ...
   <dl>
     ...
     <dd>
      <span class="simpara">
       ...
       boolean, etc.)
       The supported field types are listed in the <a href="intro.dbase.php" class="link">introduction section</a>.
      </span>
     </dd>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Path to dbase file<br /></span><span style="color: #0000BB">$db_path </span><span style="color: #007700">= </span><span style="color: #DD0000">"/tmp/test.dbf"</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">// Open dbase file<br /></span><span style="color: #0000BB">$dbh </span><span style="color: #007700">= </span><span style="color: #0000BB">dbase_open</span><span style="color: #007700">(</span><span style="color: #0000BB">$db_path</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">)<br />  or die(</span><span style="color: #DD0000">"Error! Could not open dbase database file '</span><span style="color: #0000BB">$db_path</span><span style="color: #DD0000">'."</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Get column information<br /></span><span style="color: #0000BB">$column_info </span><span style="color: #007700">= </span><span style="color: #0000BB">dbase_get_header_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$dbh</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Display information<br /></span><span style="color: #0000BB">print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">$column_info</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dbase/functions/dbase-get-header-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.dbase-get-header-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.dbase-get-header-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dbase-get-header-info.php">＋<small>add a note</small></a></span>
