...
<head>
  ...
  <title>PHP: socket_atmark - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-atmark.php">
 <link rel="shorturl" href="https://www.php.net/socket-atmark">
 <link rel="alternate" href="https://www.php.net/socket-atmark" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-addrinfo-lookup.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-bind.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-atmark.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-atmark.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-atmark.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-atmark.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-atmark.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-atmark.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-atmark.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-atmark.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-atmark.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-atmark.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-atmark.php" hreflang="zh">
...
<meta name="Description" content="Determines whether socket is at out-of-band mark" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_atmark - Manual" />
<meta name="twitter:description" content="Determines whether socket is at out-of-band mark" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_atmark - Manual" />
<meta itemprop="description" content="Determines whether socket is at out-of-band mark" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Determines whether socket is at out-of-band mark" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.socket-addrinfo-lookup.php">
          &laquo; socket_addrinfo_lookup        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-atmark.php' selected="selected">English</option>
            <option value='de/function.socket-atmark.php'>German</option>
            <option value='es/function.socket-atmark.php'>Spanish</option>
            <option value='fr/function.socket-atmark.php'>French</option>
            <option value='it/function.socket-atmark.php'>Italian</option>
            <option value='ja/function.socket-atmark.php'>Japanese</option>
            <option value='pt_BR/function.socket-atmark.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-atmark.php'>Russian</option>
            <option value='tr/function.socket-atmark.php'>Turkish</option>
            <option value='uk/function.socket-atmark.php'>Ukrainian</option>
            <option value='zh/function.socket-atmark.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-atmark" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">socket_atmark</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.3.0, PHP 8)</p><p class="refpurpose"><span class="refname">socket_atmark</span> &mdash; <span class="dc-title">Determines whether socket is at out-of-band mark</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.socket-atmark-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>socket_atmark</strong></span>(<span class="methodparam"><span class="type"><a href="class.socket.php" class="type Socket">Socket</a></span> <code class="parameter">$socket</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Determines whether <code class="parameter">socket</code> is at out-of-band mark.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.socket-atmark-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.socket-atmark-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Create a new socket<br /></span><span style="color: #0000BB">$sock </span><span style="color: #007700">= </span><span style="color: #0000BB">socket_create</span><span style="color: #007700">(</span><span style="color: #0000BB">AF_INET</span><span style="color: #007700">, </span><span style="color: #0000BB">SOCK_STREAM</span><span style="color: #007700">, </span><span style="color: #0000BB">SOL_TCP</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">socket_atmark</span><span style="color: #007700">(</span><span style="color: #0000BB">$sock</span><span style="color: #007700">));<br /></span><span style="color: #FF8000">// Close<br /></span><span style="color: #0000BB">socket_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$sock</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.socket-atmark-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.socket-create.php" class="function" rel="rdfs-seeAlso">socket_create()</a> - Create a socket (endpoint for communication)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-atmark.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-atmark%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-atmark&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-atmark.php">＋<small>add a note</small></a></span>
