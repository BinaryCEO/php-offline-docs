...
<head>
  ...
  <title>PHP: MongoDB\Driver\BulkWrite::update - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-bulkwrite.update.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-bulkwrite.update.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-bulkwrite.update.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-bulkwrite.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-bulkwrite.insert.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mongodb-driver-bulkwritecommand.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-bulkwrite.update.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-bulkwrite.update.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-bulkwrite.update.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-bulkwrite.update.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-bulkwrite.update.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-bulkwrite.update.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-bulkwrite.update.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-bulkwrite.update.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-bulkwrite.update.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-bulkwrite.update.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-bulkwrite.update.php" hreflang="zh">
...
<meta name="Description" content="Add an update operation to the bulk" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\BulkWrite::update - Manual" />
<meta name="twitter:description" content="Add an update operation to the bulk" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\BulkWrite::update - Manual" />
<meta itemprop="description" content="Add an update operation to the bulk" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add an update operation to the bulk" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.mongodb-driver-bulkwritecommand.php">
          MongoDB\Driver\BulkWriteCommand &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-bulkwrite.insert.php">
          &laquo; MongoDB\Driver\BulkWrite::insert        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-bulkwrite.update.php' selected="selected">English</option>
            <option value='de/mongodb-driver-bulkwrite.update.php'>German</option>
            <option value='es/mongodb-driver-bulkwrite.update.php'>Spanish</option>
            <option value='fr/mongodb-driver-bulkwrite.update.php'>French</option>
            <option value='it/mongodb-driver-bulkwrite.update.php'>Italian</option>
            <option value='ja/mongodb-driver-bulkwrite.update.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-bulkwrite.update.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-bulkwrite.update.php'>Russian</option>
            <option value='tr/mongodb-driver-bulkwrite.update.php'>Turkish</option>
            <option value='uk/mongodb-driver-bulkwrite.update.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-bulkwrite.update.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-bulkwrite.update" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.mongodb-driver-writeresult.php" class="classname">MongoDB\Driver\WriteResult</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/bulkwrite/update.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-bulkwrite.update%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-bulkwrite.update&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-bulkwrite.update.php">＋<small>add a note</small></a></span>
