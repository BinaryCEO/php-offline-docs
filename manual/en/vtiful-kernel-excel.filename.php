...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/vtiful-kernel-excel.filename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/vtiful-kernel-excel.filename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/vtiful-kernel-excel.filename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.vtiful-kernel-excel.php">
 <link rel="prev" href="https://www.php.net/manual/en/vtiful-kernel-excel.data.php">
 <link rel="next" href="https://www.php.net/manual/en/vtiful-kernel-excel.getHandle.php">
...
<meta name="Description" content="Vtiful\Kernel\Excel fileName" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Vtiful\Kernel\Excel::fileName - Manual" />
<meta name="twitter:description" content="Vtiful\Kernel\Excel fileName" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Vtiful\Kernel\Excel::fileName - Manual" />
<meta itemprop="description" content="Vtiful\Kernel\Excel fileName" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Vtiful\Kernel\Excel fileName" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/vtiful-kernel-excel.filename.php' selected="selected">English</option>
            ...
            <option value='ru/vtiful-kernel-excel.filename.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL xlswriter &gt;= 1.2.1)</p><p class="refpurpose"><span class="refname">Vtiful\Kernel\Excel::fileName</span> &mdash; <span class="dc-title">Vtiful\Kernel\Excel fileName</span></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$config </span><span style="color: #007700">= [<br />  </span><span style="color: #DD0000">'path' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'/home/viest'<br /></span><span style="color: #007700">];<br /><br /></span><span style="color: #0000BB">$fileObject </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Vtiful\Kernel\Excel</span><span style="color: #007700">(</span><span style="color: #0000BB">$config</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$file </span><span style="color: #007700">= </span><span style="color: #0000BB">$instance</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">fileName</span><span style="color: #007700">(</span><span style="color: #DD0000">'tutorial.xlsx'</span><span style="color: #007700">, </span><span style="color: #DD0000">'sheet'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xlswriter/xlsx-kernel/file-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fvtiful-kernel-excel.filename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=vtiful-kernel-excel.filename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/vtiful-kernel-excel.filename.php">＋<small>add a note</small></a></span>
