...
<head>
  ...
  <title>PHP: Imagick::getImageMimeType - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagemimetype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagemimetype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagemimetype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagemattecolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageorientation.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagemimetype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagemimetype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagemimetype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagemimetype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagemimetype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagemimetype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagemimetype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagemimetype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagemimetype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagemimetype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagemimetype.php" hreflang="zh">
...
<meta name="Description" content="Returns the image mime-type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageMimeType - Manual" />
<meta name="twitter:description" content="Returns the image mime-type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageMimeType - Manual" />
<meta itemprop="description" content="Returns the image mime-type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the image mime-type" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimageorientation.php">
          Imagick::getImageOrientation &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagemattecolor.php">
          &laquo; Imagick::getImageMatteColor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagemimetype.php' selected="selected">English</option>
            <option value='de/imagick.getimagemimetype.php'>German</option>
            <option value='es/imagick.getimagemimetype.php'>Spanish</option>
            <option value='fr/imagick.getimagemimetype.php'>French</option>
            <option value='it/imagick.getimagemimetype.php'>Italian</option>
            <option value='ja/imagick.getimagemimetype.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagemimetype.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagemimetype.php'>Russian</option>
            <option value='tr/imagick.getimagemimetype.php'>Turkish</option>
            <option value='uk/imagick.getimagemimetype.php'>Ukrainian</option>
            <option value='zh/imagick.getimagemimetype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagemimetype" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageMimeType</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageMimeType</span> &mdash; <span class="dc-title">Returns the image mime-type</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagemimetype-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageMimeType</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagemimetype-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagemimetype-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagemimetype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagemimetype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagemimetype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagemimetype.php">＋<small>add a note</small></a></span>
