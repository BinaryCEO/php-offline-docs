...
<head>
  ...
  <title>PHP: ImagickDraw::pathCurveToAbsolute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pathcurvetoabsolute.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pathcurvetoabsolute.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathcurvetoabsolute.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pathclose.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pathcurvetoquadraticbezierabsolute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathcurvetoabsolute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pathcurvetoabsolute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pathcurvetoabsolute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pathcurvetoabsolute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pathcurvetoabsolute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pathcurvetoabsolute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pathcurvetoabsolute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pathcurvetoabsolute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pathcurvetoabsolute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pathcurvetoabsolute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pathcurvetoabsolute.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::pathCurveToAbsolute - Manual" />
<meta name="twitter:description" content="Draws a cubic Bezier curve" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pathCurveToAbsolute - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.pathcurvetoquadraticbezierabsolute.php">
          ImagickDraw::pathCurveToQuadraticBezierAbsolute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pathclose.php">
          &laquo; ImagickDraw::pathClose        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pathcurvetoabsolute.php' selected="selected">English</option>
            <option value='de/imagickdraw.pathcurvetoabsolute.php'>German</option>
            <option value='es/imagickdraw.pathcurvetoabsolute.php'>Spanish</option>
            <option value='fr/imagickdraw.pathcurvetoabsolute.php'>French</option>
            <option value='it/imagickdraw.pathcurvetoabsolute.php'>Italian</option>
            <option value='ja/imagickdraw.pathcurvetoabsolute.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pathcurvetoabsolute.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pathcurvetoabsolute.php'>Russian</option>
            <option value='tr/imagickdraw.pathcurvetoabsolute.php'>Turkish</option>
            <option value='uk/imagickdraw.pathcurvetoabsolute.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pathcurvetoabsolute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pathcurvetoabsolute" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pathCurveToAbsolute</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::pathCurveToAbsolute</span> &mdash; <span class="dc-title">Draws a cubic Bezier curve</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.pathcurvetoabsolute-description">
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.pathcurvetoabsolute-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.pathcurvetoabsolute-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pathcurvetoabsolute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pathcurvetoabsolute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pathcurvetoabsolute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pathcurvetoabsolute.php">＋<small>add a note</small></a></span>
