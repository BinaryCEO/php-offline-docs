...
<head>
  ...
  <title>PHP: fbird_backup - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-backup.php">
 <link rel="shorturl" href="https://www.php.net/fbird-backup">
 <link rel="alternate" href="https://www.php.net/fbird-backup" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-affected-rows.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-blob-add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-backup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-backup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-backup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-backup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-backup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-backup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-backup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-backup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-backup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-backup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-backup.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_backup" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_backup - Manual" />
<meta name="twitter:description" content="Alias of ibase_backup" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_backup - Manual" />
<meta itemprop="description" content="Alias of ibase_backup" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_backup" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fbird-blob-add.php">
          fbird_blob_add &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-affected-rows.php">
          &laquo; fbird_affected_rows        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-backup.php' selected="selected">English</option>
            <option value='de/function.fbird-backup.php'>German</option>
            <option value='es/function.fbird-backup.php'>Spanish</option>
            <option value='fr/function.fbird-backup.php'>French</option>
            <option value='it/function.fbird-backup.php'>Italian</option>
            <option value='ja/function.fbird-backup.php'>Japanese</option>
            <option value='pt_BR/function.fbird-backup.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-backup.php'>Russian</option>
            <option value='tr/function.fbird-backup.php'>Turkish</option>
            <option value='uk/function.fbird-backup.php'>Ukrainian</option>
            <option value='zh/function.fbird-backup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-backup" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_backup</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_backup</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-backup.php" class="function">ibase_backup()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-backup-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.ibase-backup.php" class="function">ibase_backup()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-backup.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-backup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-backup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-backup.php">＋<small>add a note</small></a></span>
