...
<head>
  ...
  <title>PHP: ps_begin_pattern - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-begin-pattern.php">
 <link rel="shorturl" href="https://www.php.net/ps-begin-pattern">
 <link rel="alternate" href="https://www.php.net/ps-begin-pattern" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-begin-page.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-begin-template.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-begin-pattern.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-begin-pattern.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-begin-pattern.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-begin-pattern.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-begin-pattern.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-begin-pattern.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-begin-pattern.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-begin-pattern.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-begin-pattern.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-begin-pattern.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-begin-pattern.php" hreflang="zh">
...
<meta name="Description" content="Start a new pattern" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_begin_pattern - Manual" />
<meta name="twitter:description" content="Start a new pattern" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_begin_pattern - Manual" />
<meta itemprop="description" content="Start a new pattern" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Start a new pattern" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-begin-template.php">
          ps_begin_template &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-begin-page.php">
          &laquo; ps_begin_page        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-begin-pattern.php' selected="selected">English</option>
            <option value='de/function.ps-begin-pattern.php'>German</option>
            <option value='es/function.ps-begin-pattern.php'>Spanish</option>
            <option value='fr/function.ps-begin-pattern.php'>French</option>
            <option value='it/function.ps-begin-pattern.php'>Italian</option>
            <option value='ja/function.ps-begin-pattern.php'>Japanese</option>
            <option value='pt_BR/function.ps-begin-pattern.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-begin-pattern.php'>Russian</option>
            <option value='tr/function.ps-begin-pattern.php'>Turkish</option>
            <option value='uk/function.ps-begin-pattern.php'>Ukrainian</option>
            <option value='zh/function.ps-begin-pattern.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-begin-pattern" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_begin_pattern</h1>
  <p class="verinfo">(PECL ps &gt;= 1.2.0)</p><p class="refpurpose"><span class="refname">ps_begin_pattern</span> &mdash; <span class="dc-title">Start a new pattern</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-begin-pattern-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_begin_pattern</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$xstep</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$ystep</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$painttype</code></span><br>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.ps-setcolor.php" class="function">ps_setcolor()</a></span> and setting the color space to
   <code class="literal">pattern</code>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-begin-pattern-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">x-step</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">y-step</code></dt>
     <dd>
      <p class="para">
       The distance in pixel of placements of the pattern in
       vertical direction.
     ...
     <dt><code class="parameter">painttype</code></dt>
     <dd>
      <p class="para">
       Must be 1 or 2.
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-begin-pattern-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The identifier of the pattern  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.ps-begin-pattern-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3463">
    <p><strong>Example #1 Creating and using a pattern</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$ps </span><span style="color: #007700">= </span><span style="color: #0000BB">ps_new</span><span style="color: #007700">();<br /><br />if (!</span><span style="color: #0000BB">ps_open_file</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"pattern.ps"</span><span style="color: #007700">)) {<br />  print </span><span style="color: #DD0000">"Cannot open PostScript file\n"</span><span style="color: #007700">;<br />  exit;<br />}<br /><br /></span><span style="color: #0000BB">ps_set_parameter</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"warning"</span><span style="color: #007700">, </span><span style="color: #DD0000">"true"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_set_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Creator"</span><span style="color: #007700">, </span><span style="color: #DD0000">"pattern.php"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_set_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Author"</span><span style="color: #007700">, </span><span style="color: #DD0000">"Uwe Steinmann"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_set_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Title"</span><span style="color: #007700">, </span><span style="color: #DD0000">"Pattern example"</span><span style="color: #007700">);<br /><br /><br /></span><span style="color: #0000BB">$pspattern </span><span style="color: #007700">= </span><span style="color: #0000BB">ps_begin_pattern</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">10.0</span><span style="color: #007700">, </span><span style="color: #0000BB">10.0</span><span style="color: #007700">, </span><span style="color: #0000BB">10.0</span><span style="color: #007700">, </span><span style="color: #0000BB">10.0</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_setlinewidth</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">0.2</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_setcolor</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"stroke"</span><span style="color: #007700">, </span><span style="color: #DD0000">"rgb"</span><span style="color: #007700">, </span><span style="color: #0000BB">0.0</span><span style="color: #007700">, </span><span style="color: #0000BB">0.0</span><span style="color: #007700">, </span><span style="color: #0000BB">1.0</span><span style="color: #007700">, </span><span style="color: #0000BB">0.0</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_moveto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_lineto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">7</span><span style="color: #007700">, </span><span style="color: #0000BB">7</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_stroke</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_moveto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">7</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_lineto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">7</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_stroke</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_end_pattern</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">ps_begin_page</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">596</span><span style="color: #007700">, </span><span style="color: #0000BB">842</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_setcolor</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"both"</span><span style="color: #007700">, </span><span style="color: #DD0000">"pattern"</span><span style="color: #007700">, </span><span style="color: #0000BB">$pspattern</span><span style="color: #007700">, </span><span style="color: #0000BB">0.0</span><span style="color: #007700">, </span><span style="color: #0000BB">0.0</span><span style="color: #007700">, </span><span style="color: #0000BB">0.0</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_rect</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #0000BB">400</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_fill</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_end_page</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">ps_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_delete</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-begin-pattern-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-end-pattern.php" class="function" rel="rdfs-seeAlso">ps_end_pattern()</a> - End a pattern</span></li>
    <li><span class="function"><a href="function.ps-setcolor.php" class="function" rel="rdfs-seeAlso">ps_setcolor()</a> - Sets current color</span></li>
    <li><span class="function"><a href="function.ps-shading-pattern.php" class="function" rel="rdfs-seeAlso">ps_shading_pattern()</a> - Creates a pattern based on a shading</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-begin-pattern.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-begin-pattern%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-begin-pattern&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-begin-pattern.php">＋<small>add a note</small></a></span>
