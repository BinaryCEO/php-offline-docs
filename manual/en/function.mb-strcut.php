...
<head>
  ...
  <title>PHP: mb_strcut - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-strcut.php">
 <link rel="shorturl" href="https://www.php.net/mb-strcut">
 <link rel="alternate" href="https://www.php.net/mb-strcut" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-str-split.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-strimwidth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-strcut.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-strcut.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-strcut.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-strcut.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-strcut.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-strcut.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-strcut.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-strcut.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-strcut.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-strcut.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-strcut.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mb_strcut - Manual" />
<meta name="twitter:description" content="Get part of string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_strcut - Manual" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mb-strimwidth.php">
          mb_strimwidth &raquo;
              ...
              <div class="prev">
        <a href="function.mb-str-split.php">
          &laquo; mb_str_split        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-strcut.php' selected="selected">English</option>
            <option value='de/function.mb-strcut.php'>German</option>
            <option value='es/function.mb-strcut.php'>Spanish</option>
            <option value='fr/function.mb-strcut.php'>French</option>
            <option value='it/function.mb-strcut.php'>Italian</option>
            <option value='ja/function.mb-strcut.php'>Japanese</option>
            <option value='pt_BR/function.mb-strcut.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-strcut.php'>Russian</option>
            <option value='tr/function.mb-strcut.php'>Turkish</option>
            <option value='uk/function.mb-strcut.php'>Ukrainian</option>
            <option value='zh/function.mb-strcut.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-strcut" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-internal-encoding.php" class="function" rel="rdfs-seeAlso">mb_internal_encoding()</a> - Set/Get internal character encoding</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-strcut.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-strcut%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-strcut&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-strcut.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121877">  <div class="votes">
    <div id="Vu121877">
    <a href="/manual/vote-note.php?id=121877&amp;page=function.mb-strcut&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121877">
    <a href="/manual/vote-note.php?id=121877&amp;page=function.mb-strcut&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121877" title="62% like this...">
    4
    </div>
  </div>
  <a href="#121877" class="name">
  <strong class="user"><em>olivthill at gmail dot com</em></strong></a><a class="genanchor" href="#121877"> &para;</a><div class="date" title="2017-11-16 02:30"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121877">
<div class="phpcode"><code><span class="html">Here is an example with UTF8 characters, to see how the start and length arguments are working:<br /><br />  $str_utf8 = utf8_encode("Déjà_vu");<br />  $str_utf8_0 = mb_strcut($str_utf8, 0, 4, "UTF-8"); // Déj<br />  $str_utf8_1 = mb_strcut($str_utf8, 1, 4, "UTF-8"); // éj<br />  $str_utf8_2 = mb_strcut($str_utf8, 2, 4, "UTF-8"); // éj<br />  $str_utf8_3 = mb_strcut($str_utf8, 3, 4, "UTF-8"); // jà_<br />  $str_utf8_4 = mb_strcut($str_utf8, 4, 4, "UTF-8"); // à_v<br /><br />The string includes two special charaters, "é" and "à" internally coded with two bytes.<br />Note that a multibyte character is removed rather than kept in half at the end of the output.<br />Note also that the result is the same for a cut 1,4 and a cut 2,4 with this string.</span></code></div>
  </div>
 </div>
  <div class="note" id="45142">  <div class="votes">
    <div id="Vu45142">
    <a href="/manual/vote-note.php?id=45142&amp;page=function.mb-strcut&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd45142">
    <a href="/manual/vote-note.php?id=45142&amp;page=function.mb-strcut&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V45142" title="59% like this...">
    4
    </div>
  </div>
  <a href="#45142" class="name">
  <strong class="user"><em>t dot starling at physics dot unimelb dot edu dot au</em></strong></a><a class="genanchor" href="#45142"> &para;</a><div class="date" title="2004-08-27 04:01"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom45142">
<div class="phpcode"><code><span class="html">What the manual and the first commenter are trying to say is that mb_strcut uses byte offsets, as opposed to mb_substr which uses character offsets. <br /><br />Both mb_strcut and mb_substr appear to treat negative and out-of-range offsets and lengths in the basically the same way as substr. An exception is that if start is too large, an empty string will be returned rather than FALSE. Testing indicates that mb_strcut first works out start and end byte offsets, then moves each offset left to the nearest character boundary.</span></code></div>
  </div>
 </div>
  <div class="note" id="126615">  <div class="votes">
    <div id="Vu126615">
    <a href="/manual/vote-note.php?id=126615&amp;page=function.mb-strcut&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126615">
    <a href="/manual/vote-note.php?id=126615&amp;page=function.mb-strcut&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126615" title="50% like this...">
    0
    </div>
  </div>
  <a href="#126615" class="name">
  <strong class="user"><em>David Juhasz</em></strong></a><a class="genanchor" href="#126615"> &para;</a><div class="date" title="2021-11-15 11:49"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126615">
<div class="phpcode"><code><span class="html">This was driving me crazy, because mb_strcut() kept returning an empty string.  The $length parameter seems to have a max value of 2^32-1 (2147483647).<br /><br />Works:<br /><span class="default">&lt;?php<br />  </span><span class="comment"># output: Полуустав<br />  </span><span class="keyword">echo </span><span class="default">mb_strcut</span><span class="keyword">(</span><span class="string">'Полуустав'</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">pow</span><span class="keyword">(</span><span class="default">2</span><span class="keyword">,</span><span class="default">31</span><span class="keyword">)-</span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Doesn't work:<br /><span class="default">&lt;?php<br />  </span><span class="comment"># nothing is output<br />  </span><span class="keyword">echo </span><span class="default">mb_strcut</span><span class="keyword">(</span><span class="string">'Полуустав'</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">pow</span><span class="keyword">(</span><span class="default">2</span><span class="keyword">,</span><span class="default">31</span><span class="keyword">));<br /></span><span class="default">?&gt;<br /></span><br />My PHP_INT_MAX value is much larger than 2^32-1, so I'm not sure why larger values for $length don't work. :(<br /><br /><span class="default">&lt;?php<br />  </span><span class="comment"># output: 9223372036854775807<br />  </span><span class="keyword">echo </span><span class="default">PHP_INT_MAX</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="36115">  <div class="votes">
    <div id="Vu36115">
    <a href="/manual/vote-note.php?id=36115&amp;page=function.mb-strcut&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd36115">
    <a href="/manual/vote-note.php?id=36115&amp;page=function.mb-strcut&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V36115" title="47% like this...">
    -2
    </div>
  </div>
  <a href="#36115" class="name">
  <strong class="user"><em>oyag02 at yahoo dot co dot jp</em></strong></a><a class="genanchor" href="#36115"> &para;</a><div class="date" title="2003-09-26 03:53"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom36115">
<div class="phpcode"><code><span class="html">diffrence between mb_substr and mb_substr<br /><br />example:<br />mb_strcut('I_ROHA', 1, 2) returns 'I_'. Treated as byte stream.<br />mb_substr('I_ROHA', 1, 2) returns 'ROHA' Treated as character stream.<br /><br /># 'I_' 'RO' 'HA' means multi-byte character</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-strcut&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-strcut.php">＋<small>add a note</small></a></div>
