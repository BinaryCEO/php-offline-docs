...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.evio.php">
 <link rel="shorturl" href="https://www.php.net/evio">
 <link rel="alternate" href="https://www.php.net/evio" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ev.php">
 <link rel="prev" href="https://www.php.net/manual/en/evidle.createstopped.php">
 <link rel="next" href="https://www.php.net/manual/en/evio.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.evio.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.evio.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.evio.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.evio.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.evio.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.evio.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.evio.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.evio.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.evio.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.evio.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.evio.php" hreflang="zh">
...
<meta name="Description" content="The EvIo class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EvIo - Manual" />
<meta name="twitter:description" content="The EvIo class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EvIo - Manual" />
<meta itemprop="description" content="The EvIo class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The EvIo class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="evio.construct.php">
          EvIo::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="evidle.createstopped.php">
          &laquo; EvIdle::createStopped        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.evio.php' selected="selected">English</option>
            <option value='de/class.evio.php'>German</option>
            <option value='es/class.evio.php'>Spanish</option>
            <option value='fr/class.evio.php'>French</option>
            <option value='it/class.evio.php'>Italian</option>
            <option value='ja/class.evio.php'>Japanese</option>
            <option value='pt_BR/class.evio.php'>Brazilian Portuguese</option>
            <option value='ru/class.evio.php'>Russian</option>
            <option value='tr/class.evio.php'>Turkish</option>
            <option value='uk/class.evio.php'>Ukrainian</option>
            <option value='zh/class.evio.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.evio" class="reference">
   ...
   <div class="classsynopsis">
    ...
    <div class="fieldsynopsis">
     <span class="modifier">public</span>
      <var class="varname"><a href="class.evio.php#evio.props.fd">$<var class="varname">fd</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
      <var class="varname"><a href="class.evio.php#evio.props.events">$<var class="varname">events</var></a></var>;</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span>
   <span class="methodname"><a href="evio.construct.php" class="methodname">__construct</a></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam">
   ...
   <span class="methodname"><a href="evio.createstopped.php" class="methodname">createStopped</a></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam">
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span>
   <span class="methodname"><a href="evio.set.php" class="methodname">set</a></span>(<span class="methodparam">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="evio.construct.php">EvIo::__construct</a> — Constructs EvIo watcher object</li><li><a href="evio.createstopped.php">EvIo::createStopped</a> — Create stopped EvIo watcher object</li><li><a href="evio.set.php">EvIo::set</a> — Configures the watcher</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ev/evio.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.evio%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.evio&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.evio.php">＋<small>add a note</small></a></span>
