...
<head>
  ...
  <title>PHP: Gmagick::getimagedelay - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagedelay.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagedelay.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagedelay.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagecompose.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagedepth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagedelay.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagedelay.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagedelay.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagedelay.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagedelay.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagedelay.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagedelay.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagedelay.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagedelay.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagedelay.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagedelay.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimagedelay - Manual" />
<meta name="twitter:description" content="Gets the image delay" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagedelay - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimagedepth.php">
          Gmagick::getimagedepth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagecompose.php">
          &laquo; Gmagick::getimagecompose        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagedelay.php' selected="selected">English</option>
            <option value='de/gmagick.getimagedelay.php'>German</option>
            <option value='es/gmagick.getimagedelay.php'>Spanish</option>
            <option value='fr/gmagick.getimagedelay.php'>French</option>
            <option value='it/gmagick.getimagedelay.php'>Italian</option>
            <option value='ja/gmagick.getimagedelay.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagedelay.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagedelay.php'>Russian</option>
            <option value='tr/gmagick.getimagedelay.php'>Turkish</option>
            <option value='uk/gmagick.getimagedelay.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagedelay.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagedelay" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagedelay</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagedelay</span> &mdash; <span class="dc-title">Gets the image delay</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagedelay-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagedelay</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagedelay-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagedelay-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagedelay-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagedelay.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagedelay%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagedelay&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagedelay.php">＋<small>add a note</small></a></span>
