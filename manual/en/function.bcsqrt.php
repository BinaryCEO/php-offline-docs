...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.bcsqrt.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.bcscale.php">
 <link rel="next" href="https://www.php.net/manual/en/function.bcsub.php">
...
<meta name="Description" content="Get the square root of an arbitrary precision number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: bcsqrt - Manual" />
<meta name="twitter:description" content="Get the square root of an arbitrary precision number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: bcsqrt - Manual" />
<meta itemprop="description" content="Get the square root of an arbitrary precision number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the square root of an arbitrary precision number" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.bcsqrt.php' selected="selected">English</option>
            ...
            <option value='ja/function.bcsqrt.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">bcsqrt</span> &mdash; <span class="dc-title">Get the square root of an arbitrary precision number</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.bcsqrt-description">
  ...
  <p class="simpara">
   Return the square root of <code class="parameter">num</code>.
  </p>
 </div>
 ...
 <div class="refsect1 errors" id="refsect1-function.bcsqrt-errors">
  ...
  <p class="para">
   This function throws a <span class="classname"><a href="class.valueerror.php" class="classname">ValueError</a></span> in the following cases:
   <ul class="simplelist">
    <li><code class="parameter">num</code> is not a well-formed BCMath numeric string</li>
    <li><code class="parameter">num</code> is less than <code class="literal">0</code></li>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>
       If <code class="parameter">num</code> is not a well-formed BCMath numeric string,
       or less than <code class="literal">0</code>, a <span class="classname"><a href="class.valueerror.php" class="classname">ValueError</a></span> is thrown.
       Previously, <strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> was raised instead.
      </td>
     </tr>
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">scale</code> now needs to be between <code class="literal">0</code>
       and <code class="literal">2147483647</code>; previously, negative scales have been
       silently treated as <code class="literal">0</code>.
      </td>
     </tr>
 ...
 <div class="refsect1 examples" id="refsect1-function.bcsqrt-examples">
  ...
  <div class="example" id="example-3282">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="bcmath-number.sqrt.php" class="methodname" rel="rdfs-seeAlso">BcMath\Number::sqrt()</a> - Gets the square root of an arbitrary precision number</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/bc/functions/bcsqrt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.bcsqrt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.bcsqrt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.bcsqrt.php">＋<small>add a note</small></a></span>
