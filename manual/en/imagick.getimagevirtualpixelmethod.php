...
<head>
  ...
  <title>PHP: Imagick::getImageVirtualPixelMethod - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagevirtualpixelmethod.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagevirtualpixelmethod.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagevirtualpixelmethod.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageunits.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagewhitepoint.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagevirtualpixelmethod.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagevirtualpixelmethod.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagevirtualpixelmethod.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagevirtualpixelmethod.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagevirtualpixelmethod.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagevirtualpixelmethod.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagevirtualpixelmethod.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagevirtualpixelmethod.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagevirtualpixelmethod.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagevirtualpixelmethod.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagevirtualpixelmethod.php" hreflang="zh">
...
<meta name="Description" content="Returns the virtual pixel method" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageVirtualPixelMethod - Manual" />
<meta name="twitter:description" content="Returns the virtual pixel method" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageVirtualPixelMethod - Manual" />
<meta itemprop="description" content="Returns the virtual pixel method" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the virtual pixel method" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagewhitepoint.php">
          Imagick::getImageWhitePoint &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageunits.php">
          &laquo; Imagick::getImageUnits        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagevirtualpixelmethod.php' selected="selected">English</option>
            <option value='de/imagick.getimagevirtualpixelmethod.php'>German</option>
            <option value='es/imagick.getimagevirtualpixelmethod.php'>Spanish</option>
            <option value='fr/imagick.getimagevirtualpixelmethod.php'>French</option>
            <option value='it/imagick.getimagevirtualpixelmethod.php'>Italian</option>
            <option value='ja/imagick.getimagevirtualpixelmethod.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagevirtualpixelmethod.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagevirtualpixelmethod.php'>Russian</option>
            <option value='tr/imagick.getimagevirtualpixelmethod.php'>Turkish</option>
            <option value='uk/imagick.getimagevirtualpixelmethod.php'>Ukrainian</option>
            <option value='zh/imagick.getimagevirtualpixelmethod.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagevirtualpixelmethod" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageVirtualPixelMethod</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageVirtualPixelMethod</span> &mdash; <span class="dc-title">Returns the virtual pixel method</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagevirtualpixelmethod-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageVirtualPixelMethod</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagevirtualpixelmethod-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagevirtualpixelmethod-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagevirtualpixelmethod-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagevirtualpixelmethod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagevirtualpixelmethod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagevirtualpixelmethod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagevirtualpixelmethod.php">＋<small>add a note</small></a></span>
