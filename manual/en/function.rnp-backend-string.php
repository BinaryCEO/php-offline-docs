...
<head>
  ...
  <title>PHP: rnp_backend_string - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rnp-backend-string.php">
 <link rel="shorturl" href="https://www.php.net/rnp-backend-string">
 <link rel="alternate" href="https://www.php.net/rnp-backend-string" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.rnp.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.rnp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rnp-backend-version.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rnp-backend-string.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rnp-backend-string.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rnp-backend-string.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rnp-backend-string.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rnp-backend-string.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rnp-backend-string.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rnp-backend-string.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rnp-backend-string.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rnp-backend-string.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rnp-backend-string.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rnp-backend-string.php" hreflang="zh">
...
<meta name="Description" content="Return cryptographic backend library name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rnp_backend_string - Manual" />
<meta name="twitter:description" content="Return cryptographic backend library name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rnp_backend_string - Manual" />
<meta itemprop="description" content="Return cryptographic backend library name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return cryptographic backend library name" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.rnp-backend-version.php">
          rnp_backend_version &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.rnp.php">
          &laquo; Rnp Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rnp-backend-string.php' selected="selected">English</option>
            <option value='de/function.rnp-backend-string.php'>German</option>
            <option value='es/function.rnp-backend-string.php'>Spanish</option>
            <option value='fr/function.rnp-backend-string.php'>French</option>
            <option value='it/function.rnp-backend-string.php'>Italian</option>
            <option value='ja/function.rnp-backend-string.php'>Japanese</option>
            <option value='pt_BR/function.rnp-backend-string.php'>Brazilian Portuguese</option>
            <option value='ru/function.rnp-backend-string.php'>Russian</option>
            <option value='tr/function.rnp-backend-string.php'>Turkish</option>
            <option value='uk/function.rnp-backend-string.php'>Ukrainian</option>
            <option value='zh/function.rnp-backend-string.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rnp-backend-string" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">rnp_backend_string</h1>
  <p class="verinfo">(PECL rnp &gt;= 0.1.1)</p><p class="refpurpose"><span class="refname">rnp_backend_string</span> &mdash; <span class="dc-title">Return cryptographic backend library name</span></p>
  ...
  <p class="para">
   ...
   backends are &quot;Botan&quot; and &quot;OpenSSL&quot;.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/functions/rnp-backend-string.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rnp-backend-string%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rnp-backend-string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rnp-backend-string.php">＋<small>add a note</small></a></span>
