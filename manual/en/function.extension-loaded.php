...
<head>
  ...
  <title>PHP: extension_loaded - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.extension-loaded.php">
 <link rel="shorturl" href="https://www.php.net/extension-loaded">
 <link rel="alternate" href="https://www.php.net/extension-loaded" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.dl.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gc-collect-cycles.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.extension-loaded.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.extension-loaded.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.extension-loaded.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.extension-loaded.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.extension-loaded.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.extension-loaded.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.extension-loaded.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.extension-loaded.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.extension-loaded.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.extension-loaded.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.extension-loaded.php" hreflang="zh">
...
<meta name="Description" content="Find out whether an extension is loaded" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: extension_loaded - Manual" />
<meta name="twitter:description" content="Find out whether an extension is loaded" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: extension_loaded - Manual" />
<meta itemprop="description" content="Find out whether an extension is loaded" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Find out whether an extension is loaded" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.extension-loaded.php' selected="selected">English</option>
            <option value='de/function.extension-loaded.php'>German</option>
            <option value='es/function.extension-loaded.php'>Spanish</option>
            <option value='fr/function.extension-loaded.php'>French</option>
            <option value='it/function.extension-loaded.php'>Italian</option>
            <option value='ja/function.extension-loaded.php'>Japanese</option>
            <option value='pt_BR/function.extension-loaded.php'>Brazilian Portuguese</option>
            <option value='ru/function.extension-loaded.php'>Russian</option>
            <option value='tr/function.extension-loaded.php'>Turkish</option>
            <option value='uk/function.extension-loaded.php'>Ukrainian</option>
            <option value='zh/function.extension-loaded.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.extension-loaded" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">extension_loaded</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">extension_loaded</span> &mdash; <span class="dc-title">Find out whether an extension is loaded</span></p>
   ...
   <dl>
     ...
     <dd>
      ...
      <p class="para">
       ...
       <span class="function"><a href="function.phpinfo.php" class="function">phpinfo()</a></span> or if you&#039;re using the
       <code class="literal">CGI</code> or <code class="literal">CLI</code> version of
       PHP you can use the <strong class="option unknown">-m</strong> switch to
...
[Zend Modules]</pre>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.extension-loaded-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the extension identified by <code class="parameter">extension</code>
   is loaded, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.extension-loaded-examples">
  ...
  <p class="para">
   ...
   <p><strong>Example #1 <span class="function"><strong>extension_loaded()</strong></span> example</strong></p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.extension-loaded-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.dl.php" class="function" rel="rdfs-seeAlso">dl()</a> - Loads a PHP extension at runtime</span></li>
    <li><span class="function"><a href="function.function-exists.php" class="function" rel="rdfs-seeAlso">function_exists()</a> - Return true if the given function has been defined</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/extension-loaded.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.extension-loaded%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.extension-loaded&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.extension-loaded.php">＋<small>add a note</small></a></span>
