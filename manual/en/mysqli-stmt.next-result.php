...
<head>
  ...
  <title>PHP: mysqli_stmt::next_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-stmt.next-result.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-stmt.next-result.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-stmt.next-result.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-stmt.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-stmt.more-results.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-stmt.num-rows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-stmt.next-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli-stmt.next-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli-stmt.next-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli-stmt.next-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli-stmt.next-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli-stmt.next-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli-stmt.next-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli-stmt.next-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli-stmt.next-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli-stmt.next-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli-stmt.next-result.php" hreflang="zh">
...
<meta name="Description" content="Reads the next result from a multiple query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_stmt::next_result - Manual" />
<meta name="twitter:description" content="Reads the next result from a multiple query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_stmt::next_result - Manual" />
<meta itemprop="description" content="Reads the next result from a multiple query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads the next result from a multiple query" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli-stmt.num-rows.php">
          mysqli_stmt::$num_rows &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli-stmt.more-results.php">
          &laquo; mysqli_stmt::more_results        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-stmt.next-result.php' selected="selected">English</option>
            <option value='de/mysqli-stmt.next-result.php'>German</option>
            <option value='es/mysqli-stmt.next-result.php'>Spanish</option>
            <option value='fr/mysqli-stmt.next-result.php'>French</option>
            <option value='it/mysqli-stmt.next-result.php'>Italian</option>
            <option value='ja/mysqli-stmt.next-result.php'>Japanese</option>
            <option value='pt_BR/mysqli-stmt.next-result.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli-stmt.next-result.php'>Russian</option>
            <option value='tr/mysqli-stmt.next-result.php'>Turkish</option>
            <option value='uk/mysqli-stmt.next-result.php'>Ukrainian</option>
            <option value='zh/mysqli-stmt.next-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli-stmt.next-result" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="mysqli.multi-query.php" class="methodname" rel="rdfs-seeAlso">mysqli::multi_query()</a> - Performs one or more queries on the database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_stmt/next-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli-stmt.next-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli-stmt.next-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-stmt.next-result.php">＋<small>add a note</small></a></span>
