...
<head>
  ...
  <title>PHP: SolrDisMaxQuery::setBoostFunction - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrdismaxquery.setboostfunction.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrdismaxquery.setboostfunction.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrdismaxquery.setboostfunction.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrdismaxquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrdismaxquery.setbigramphraseslop.php">
 <link rel="next" href="https://www.php.net/manual/en/solrdismaxquery.setboostquery.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrdismaxquery.setboostfunction.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrdismaxquery.setboostfunction.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrdismaxquery.setboostfunction.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrdismaxquery.setboostfunction.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrdismaxquery.setboostfunction.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrdismaxquery.setboostfunction.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrdismaxquery.setboostfunction.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrdismaxquery.setboostfunction.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrdismaxquery.setboostfunction.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrdismaxquery.setboostfunction.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrdismaxquery.setboostfunction.php" hreflang="zh">
...
<meta name="Description" content="Sets a Boost Function (bf parameter)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrDisMaxQuery::setBoostFunction - Manual" />
<meta name="twitter:description" content="Sets a Boost Function (bf parameter)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrDisMaxQuery::setBoostFunction - Manual" />
<meta itemprop="description" content="Sets a Boost Function (bf parameter)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets a Boost Function (bf parameter)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrdismaxquery.setboostquery.php">
          SolrDisMaxQuery::setBoostQuery &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrdismaxquery.setbigramphraseslop.php">
          &laquo; SolrDisMaxQuery::setBigramPhraseSlop        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrdismaxquery.setboostfunction.php' selected="selected">English</option>
            <option value='de/solrdismaxquery.setboostfunction.php'>German</option>
            <option value='es/solrdismaxquery.setboostfunction.php'>Spanish</option>
            <option value='fr/solrdismaxquery.setboostfunction.php'>French</option>
            <option value='it/solrdismaxquery.setboostfunction.php'>Italian</option>
            <option value='ja/solrdismaxquery.setboostfunction.php'>Japanese</option>
            <option value='pt_BR/solrdismaxquery.setboostfunction.php'>Brazilian Portuguese</option>
            <option value='ru/solrdismaxquery.setboostfunction.php'>Russian</option>
            <option value='tr/solrdismaxquery.setboostfunction.php'>Turkish</option>
            <option value='uk/solrdismaxquery.setboostfunction.php'>Ukrainian</option>
            <option value='zh/solrdismaxquery.setboostfunction.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrdismaxquery.setboostfunction" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrDisMaxQuery::setBoostFunction</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">SolrDisMaxQuery::setBoostFunction</span> &mdash; <span class="dc-title">Sets a Boost Function (bf parameter)</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-solrdismaxquery.setboostfunction-examples">
  ...
  <div class="example" id="example-4970">
   <p><strong>Example #1 <span class="function"><strong>SolrDisMaxQuery::setBoostFunction()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">q=lucene&amp;defType=edismax&amp;bf=recip(ms(NOW,mydatefield),3.16e-11,1,1)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrdismaxquery/setboostfunction.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrdismaxquery.setboostfunction%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrdismaxquery.setboostfunction&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrdismaxquery.setboostfunction.php">＋<small>add a note</small></a></span>
