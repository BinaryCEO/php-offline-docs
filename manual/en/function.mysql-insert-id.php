...
<head>
  ...
  <title>PHP: mysql_insert_id - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-insert-id.php">
 <link rel="shorturl" href="https://www.php.net/mysql-insert-id">
 <link rel="alternate" href="https://www.php.net/mysql-insert-id" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-list-dbs.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-insert-id.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-insert-id.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-insert-id.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-insert-id.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-insert-id.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-insert-id.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-insert-id.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-insert-id.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-insert-id.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-insert-id.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-insert-id.php" hreflang="zh">
...
<meta name="Description" content="Get the ID generated in the last query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_insert_id - Manual" />
<meta name="twitter:description" content="Get the ID generated in the last query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_insert_id - Manual" />
<meta itemprop="description" content="Get the ID generated in the last query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the ID generated in the last query" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-insert-id.php' selected="selected">English</option>
            <option value='de/function.mysql-insert-id.php'>German</option>
            <option value='es/function.mysql-insert-id.php'>Spanish</option>
            <option value='fr/function.mysql-insert-id.php'>French</option>
            <option value='it/function.mysql-insert-id.php'>Italian</option>
            <option value='ja/function.mysql-insert-id.php'>Japanese</option>
            <option value='pt_BR/function.mysql-insert-id.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-insert-id.php'>Russian</option>
            <option value='tr/function.mysql-insert-id.php'>Turkish</option>
            <option value='uk/function.mysql-insert-id.php'>Ukrainian</option>
            <option value='zh/function.mysql-insert-id.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-insert-id" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-info.php" class="function" rel="rdfs-seeAlso">mysql_info()</a> - Get information about the most recent query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-insert-id.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-insert-id%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-insert-id&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-insert-id.php">＋<small>add a note</small></a></span>
