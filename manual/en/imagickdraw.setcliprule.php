...
<head>
  ...
  <title>PHP: ImagickDraw::setClipRule - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setcliprule.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setcliprule.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setcliprule.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setclippath.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setclipunits.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setcliprule.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setcliprule.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setcliprule.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setcliprule.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setcliprule.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setcliprule.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setcliprule.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setcliprule.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setcliprule.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setcliprule.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setcliprule.php" hreflang="zh">
...
<meta name="Description" content="Set the polygon fill rule to be used by the clipping path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setClipRule - Manual" />
<meta name="twitter:description" content="Set the polygon fill rule to be used by the clipping path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setClipRule - Manual" />
<meta itemprop="description" content="Set the polygon fill rule to be used by the clipping path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the polygon fill rule to be used by the clipping path" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setclipunits.php">
          ImagickDraw::setClipUnits &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setclippath.php">
          &laquo; ImagickDraw::setClipPath        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setcliprule.php' selected="selected">English</option>
            <option value='de/imagickdraw.setcliprule.php'>German</option>
            <option value='es/imagickdraw.setcliprule.php'>Spanish</option>
            <option value='fr/imagickdraw.setcliprule.php'>French</option>
            <option value='it/imagickdraw.setcliprule.php'>Italian</option>
            <option value='ja/imagickdraw.setcliprule.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setcliprule.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setcliprule.php'>Russian</option>
            <option value='tr/imagickdraw.setcliprule.php'>Turkish</option>
            <option value='uk/imagickdraw.setcliprule.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setcliprule.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setcliprule" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setClipRule</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setClipRule</span> &mdash; <span class="dc-title">Set the polygon fill rule to be used by the clipping path</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setcliprule-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setClipRule</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fillrule</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setcliprule-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setcliprule-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3168">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setcliprule.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setcliprule%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setcliprule&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setcliprule.php">＋<small>add a note</small></a></span>
