...
<head>
  ...
  <title>PHP: odbc_data_source - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-data-source.php">
 <link rel="shorturl" href="https://www.php.net/odbc-data-source">
 <link rel="alternate" href="https://www.php.net/odbc-data-source" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-cursor.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-do.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-data-source.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-data-source.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-data-source.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-data-source.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-data-source.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-data-source.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-data-source.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-data-source.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-data-source.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-data-source.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-data-source.php" hreflang="zh">
...
<meta name="Description" content="Returns information about available DSNs" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_data_source - Manual" />
<meta name="twitter:description" content="Returns information about available DSNs" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_data_source - Manual" />
<meta itemprop="description" content="Returns information about available DSNs" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns information about available DSNs" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-data-source.php' selected="selected">English</option>
            <option value='de/function.odbc-data-source.php'>German</option>
            <option value='es/function.odbc-data-source.php'>Spanish</option>
            <option value='fr/function.odbc-data-source.php'>French</option>
            <option value='it/function.odbc-data-source.php'>Italian</option>
            <option value='ja/function.odbc-data-source.php'>Japanese</option>
            <option value='pt_BR/function.odbc-data-source.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-data-source.php'>Russian</option>
            <option value='tr/function.odbc-data-source.php'>Turkish</option>
            <option value='uk/function.odbc-data-source.php'>Ukrainian</option>
            <option value='zh/function.odbc-data-source.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-data-source" class="refentry">
...
see <span class="function"><a href="function.odbc-connect.php" class="function">odbc_connect()</a></span> for details.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-data-source-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error, an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> upon success, and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> after fetching
 ...
 <div class="refsect1 examples" id="refsect1-function.odbc-data-source-examples">
  ...
  <div class="example" id="odbc-data-source.example.basic">
   <p><strong>Example #1 List available DSNs</strong></p>
...
(
    ...
    [description] =&gt; Microsoft Access Driver (*.mdb, *.accdb)
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-data-source.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-data-source%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-data-source&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-data-source.php">＋<small>add a note</small></a></span>
