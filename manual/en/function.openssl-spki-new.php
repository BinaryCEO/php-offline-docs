...
<head>
  ...
  <title>PHP: openssl_spki_new - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-spki-new.php">
 <link rel="shorturl" href="https://www.php.net/openssl-spki-new">
 <link rel="alternate" href="https://www.php.net/openssl-spki-new" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-spki-export-challenge.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-spki-verify.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-spki-new.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-spki-new.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-spki-new.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-spki-new.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-spki-new.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-spki-new.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-spki-new.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-spki-new.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-spki-new.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-spki-new.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-spki-new.php" hreflang="zh">
...
<meta name="Description" content="Generate a new signed public key and challenge" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_spki_new - Manual" />
<meta name="twitter:description" content="Generate a new signed public key and challenge" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_spki_new - Manual" />
<meta itemprop="description" content="Generate a new signed public key and challenge" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generate a new signed public key and challenge" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-spki-verify.php">
          openssl_spki_verify &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-spki-export-challenge.php">
          &laquo; openssl_spki_export_challenge        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-spki-new.php' selected="selected">English</option>
            <option value='de/function.openssl-spki-new.php'>German</option>
            <option value='es/function.openssl-spki-new.php'>Spanish</option>
            <option value='fr/function.openssl-spki-new.php'>French</option>
            <option value='it/function.openssl-spki-new.php'>Italian</option>
            <option value='ja/function.openssl-spki-new.php'>Japanese</option>
            <option value='pt_BR/function.openssl-spki-new.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-spki-new.php'>Russian</option>
            <option value='tr/function.openssl-spki-new.php'>Turkish</option>
            <option value='uk/function.openssl-spki-new.php'>Ukrainian</option>
            <option value='zh/function.openssl-spki-new.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-spki-new" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.openssl-csr-sign.php" class="function" rel="rdfs-seeAlso">openssl_csr_sign()</a> - Sign a CSR with another certificate (or itself) and generate a certificate</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-spki-new.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-spki-new%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-spki-new&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-spki-new.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119483">  <div class="votes">
    <div id="Vu119483">
    <a href="/manual/vote-note.php?id=119483&amp;page=function.openssl-spki-new&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119483">
    <a href="/manual/vote-note.php?id=119483&amp;page=function.openssl-spki-new&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119483" title="66% like this...">
    1
    </div>
  </div>
  <a href="#119483" class="name">
  <strong class="user"><em>julian at NOSPAM dot developer-heaven dot de</em></strong></a><a class="genanchor" href="#119483"> &para;</a><div class="date" title="2016-06-18 05:50"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119483">
<div class="phpcode"><code><span class="html">The usage of openssl_pkey_new() in the example above is wrong.<br />openssl_pkey_new() requires an array as first parameter<br /><br />Working example for openssl_pkey_new():<br /><a href="http://php.net/manual/de/function.openssl-pkey-new.php#111769" rel="nofollow" target="_blank">http://php.net/manual/de/function.openssl-pkey-new.php#111769</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-spki-new&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-spki-new.php">＋<small>add a note</small></a></div>
