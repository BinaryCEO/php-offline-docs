...
<head>
  ...
  <title>PHP: ps_end_template - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-end-template.php">
 <link rel="shorturl" href="https://www.php.net/ps-end-template">
 <link rel="alternate" href="https://www.php.net/ps-end-template" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-end-pattern.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-fill.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-end-template.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-end-template.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-end-template.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-end-template.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-end-template.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-end-template.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-end-template.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-end-template.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-end-template.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-end-template.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-end-template.php" hreflang="zh">
...
<meta name="Description" content="End a template" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_end_template - Manual" />
<meta name="twitter:description" content="End a template" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_end_template - Manual" />
<meta itemprop="description" content="End a template" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="End a template" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-fill.php">
          ps_fill &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-end-pattern.php">
          &laquo; ps_end_pattern        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-end-template.php' selected="selected">English</option>
            <option value='de/function.ps-end-template.php'>German</option>
            <option value='es/function.ps-end-template.php'>Spanish</option>
            <option value='fr/function.ps-end-template.php'>French</option>
            <option value='it/function.ps-end-template.php'>Italian</option>
            <option value='ja/function.ps-end-template.php'>Japanese</option>
            <option value='pt_BR/function.ps-end-template.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-end-template.php'>Russian</option>
            <option value='tr/function.ps-end-template.php'>Turkish</option>
            <option value='uk/function.ps-end-template.php'>Ukrainian</option>
            <option value='zh/function.ps-end-template.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-end-template" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_end_template</h1>
  <p class="verinfo">(PECL ps &gt;= 1.2.0)</p><p class="refpurpose"><span class="refname">ps_end_template</span> &mdash; <span class="dc-title">End a template</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-end-template-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_end_template</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Ends a template which was started with <span class="function"><a href="function.ps-begin-template.php" class="function">ps_begin_template()</a></span>.
   Once a template has been ended, it can be used like an image.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-end-template-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-end-template-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-end-template-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-begin-template.php" class="function" rel="rdfs-seeAlso">ps_begin_template()</a> - Start a new template</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-end-template.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-end-template%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-end-template&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-end-template.php">＋<small>add a note</small></a></span>
