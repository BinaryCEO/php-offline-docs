...
<head>
  ...
  <title>PHP: ctype_cntrl - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ctype-cntrl.php">
 <link rel="shorturl" href="https://www.php.net/ctype-cntrl">
 <link rel="alternate" href="https://www.php.net/ctype-cntrl" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ctype.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ctype-alpha.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ctype-digit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ctype-cntrl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ctype-cntrl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ctype-cntrl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ctype-cntrl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ctype-cntrl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ctype-cntrl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ctype-cntrl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ctype-cntrl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ctype-cntrl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ctype-cntrl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ctype-cntrl.php" hreflang="zh">
...
<meta name="Description" content="Check for control character(s)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ctype_cntrl - Manual" />
<meta name="twitter:description" content="Check for control character(s)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ctype_cntrl - Manual" />
<meta itemprop="description" content="Check for control character(s)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check for control character(s)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ctype-digit.php">
          ctype_digit &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ctype-cntrl.php' selected="selected">English</option>
            <option value='de/function.ctype-cntrl.php'>German</option>
            <option value='es/function.ctype-cntrl.php'>Spanish</option>
            <option value='fr/function.ctype-cntrl.php'>French</option>
            <option value='it/function.ctype-cntrl.php'>Italian</option>
            <option value='ja/function.ctype-cntrl.php'>Japanese</option>
            <option value='pt_BR/function.ctype-cntrl.php'>Brazilian Portuguese</option>
            <option value='ru/function.ctype-cntrl.php'>Russian</option>
            <option value='tr/function.ctype-cntrl.php'>Turkish</option>
            <option value='uk/function.ctype-cntrl.php'>Ukrainian</option>
            <option value='zh/function.ctype-cntrl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ctype-cntrl" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ctype_cntrl</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ctype_cntrl</span> &mdash; <span class="dc-title">Check for control character(s)</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ctype-cntrl-description">
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">text</code>, are control characters.
...
or an explicit call to <span class="function"><a href="function.chr.php" class="function">chr()</a></span> should be made.</p></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ctype-cntrl-returnvalues">
  ...
  <p class="para">
   ...
   a control character from the current locale, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
 ...
 <div class="refsect1 examples" id="refsect1-function.ctype-cntrl-examples">
  ...
  <p class="para">
   <div class="example" id="example-5364">
    <p><strong>Example #1 A <span class="function"><strong>ctype_cntrl()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.iscntrl.php" class="function" rel="rdfs-seeAlso">IntlChar::iscntrl()</a> - Check if code point is a control character</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ctype/functions/ctype-cntrl.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ctype-cntrl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ctype-cntrl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ctype-cntrl.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="111625">  <div class="votes">
    <div id="Vu111625">
    <a href="/manual/vote-note.php?id=111625&amp;page=function.ctype-cntrl&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111625">
    <a href="/manual/vote-note.php?id=111625&amp;page=function.ctype-cntrl&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111625" title="57% like this...">
    2
    </div>
  </div>
  <a href="#111625" class="name">
  <strong class="user"><em>Tor</em></strong></a><a class="genanchor" href="#111625"> &para;</a><div class="date" title="2013-03-09 10:02"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111625">
<div class="phpcode"><code><span class="html">Returns true if bytes are in the range of \x00-\x1f or \x7f (del). Returns false if bytes are in the range of \x20-\x7e or \x80-\xff.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ctype-cntrl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ctype-cntrl.php">＋<small>add a note</small></a></div>
