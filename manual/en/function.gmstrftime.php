...
<head>
  ...
  <title>PHP: gmstrftime - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmstrftime.php">
 <link rel="shorturl" href="https://www.php.net/gmstrftime">
 <link rel="alternate" href="https://www.php.net/gmstrftime" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmmktime.php">
 <link rel="next" href="https://www.php.net/manual/en/function.idate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmstrftime.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmstrftime.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmstrftime.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmstrftime.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmstrftime.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmstrftime.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmstrftime.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmstrftime.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmstrftime.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmstrftime.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmstrftime.php" hreflang="zh">
...
<meta name="Description" content="Format a GMT/UTC time/date according to locale settings" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmstrftime - Manual" />
<meta name="twitter:description" content="Format a GMT/UTC time/date according to locale settings" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmstrftime - Manual" />
<meta itemprop="description" content="Format a GMT/UTC time/date according to locale settings" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Format a GMT/UTC time/date according to locale settings" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmstrftime.php' selected="selected">English</option>
            <option value='de/function.gmstrftime.php'>German</option>
            <option value='es/function.gmstrftime.php'>Spanish</option>
            <option value='fr/function.gmstrftime.php'>French</option>
            <option value='it/function.gmstrftime.php'>Italian</option>
            <option value='ja/function.gmstrftime.php'>Japanese</option>
            <option value='pt_BR/function.gmstrftime.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmstrftime.php'>Russian</option>
            <option value='tr/function.gmstrftime.php'>Turkish</option>
            <option value='uk/function.gmstrftime.php'>Ukrainian</option>
            <option value='zh/function.gmstrftime.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmstrftime" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.strftime.php" class="function" rel="rdfs-seeAlso">strftime()</a> - Format a local time/date according to locale settings</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/gmstrftime.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmstrftime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmstrftime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmstrftime.php">＋<small>add a note</small></a></span>
