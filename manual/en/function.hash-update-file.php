...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.hash-update-file.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.hash-update.php">
 <link rel="next" href="https://www.php.net/manual/en/function.hash-update-stream.php">
...
<meta name="Description" content="Pump data into an active hashing context from a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: hash_update_file - Manual" />
<meta name="twitter:description" content="Pump data into an active hashing context from a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: hash_update_file - Manual" />
<meta itemprop="description" content="Pump data into an active hashing context from a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Pump data into an active hashing context from a file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.hash-update-file.php' selected="selected">English</option>
            ...
            <option value='zh/function.hash-update-file.php'>Chinese (Simplified)</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.2, PHP 7, PHP 8, PECL hash &gt;= 1.1)</p><p class="refpurpose"><span class="refname">hash_update_file</span> &mdash; <span class="dc-title">Pump data into an active hashing context from a file</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.hash-update-file-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Stream context as returned by <span class="function"><a href="function.stream-context-create.php" class="function">stream_context_create()</a></span>.
      </p>
     </dd>
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      <tr>
       <td>8.0.0</td>
       <td>
        <code class="parameter">stream_context</code> is now nullable.
       </td>
      </tr>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.hash-file.php" class="function" rel="rdfs-seeAlso">hash_file()</a> - Generate a hash value using the contents of a given file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/hash/functions/hash-update-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.hash-update-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.hash-update-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.hash-update-file.php">＋<small>add a note</small></a></span>
