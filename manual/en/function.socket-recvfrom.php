...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-recvfrom.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-recv.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-recvmsg.php">
...
<meta name="Description" content="Receives data from a socket whether or not it is connection-oriented" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_recvfrom - Manual" />
<meta name="twitter:description" content="Receives data from a socket whether or not it is connection-oriented" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_recvfrom - Manual" />
<meta itemprop="description" content="Receives data from a socket whether or not it is connection-oriented" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Receives data from a socket whether or not it is connection-oriented" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-recvfrom.php' selected="selected">English</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.socket-create.php" class="function" rel="rdfs-seeAlso">socket_create()</a> - Create a socket (endpoint for communication)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-recvfrom.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-recvfrom%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-recvfrom&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-recvfrom.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">If you use socket_recvfrom on a UDP socket and combine it with the MSG_DONTWAIT flag, it will raise a PHP Warning if there is nothing to read. AFAIK, there is no way around that warning except suppressing it with @ (i.e. you cannot check if there is data before calling socket_recvfrom).</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>ply2attoetensen-project.com</em></strong></a><a class="genanchor" href="#120350"> &para;</a><div class="date" title="2016-12-17 10:07"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120350">
<div class="phpcode"><code><span class="html">MSG_DONTWAIT doesn't seem to exist in windows sockets. However socket_set_nonblock() seems to do the trick.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Pay attention! On some PHP version the MSG_DONTWAIT flag is not defined (see <a href="https://bugs.php.net/bug.php?id=48326" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=48326</a>)</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>jaggerwang at gmail dot com</em></strong></a><a class="genanchor" href="#79045"> &para;</a><div class="date" title="2007-11-07 09:56"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom79045">
<div class="phpcode"><code><span class="html">I'm confused about the rerturn value of socket_recvfrom(), it said -1 when failed, but when I call like this:<br /><br />if (($len = @socket_recvfrom($sock, $result, 32, 0, $ip, $port)) == -1) {<br />    if ($this-&gt;_debug) {<br />        echo "socket_read() failed: " . socket_strerror(socket_last_error()) . "\n";<br />    }<br />    return false;<br />}<br /><br />variable $len = false, when I change the buffer length from 32 to 4096, it becomes right.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.socket-recvfrom&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-recvfrom.php">＋<small>add a note</small></a></div>
