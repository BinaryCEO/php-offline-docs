...
<head>
  ...
  <title>PHP: socket_setopt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-setopt.php">
 <link rel="shorturl" href="https://www.php.net/socket-setopt">
 <link rel="alternate" href="https://www.php.net/socket-setopt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-set-option.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-shutdown.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-setopt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-setopt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-setopt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-setopt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-setopt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-setopt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-setopt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-setopt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-setopt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-setopt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-setopt.php" hreflang="zh">
...
<meta name="Description" content="Alias of socket_set_option" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_setopt - Manual" />
<meta name="twitter:description" content="Alias of socket_set_option" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_setopt - Manual" />
<meta itemprop="description" content="Alias of socket_set_option" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of socket_set_option" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.socket-shutdown.php">
          socket_shutdown &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-set-option.php">
          &laquo; socket_set_option        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-setopt.php' selected="selected">English</option>
            <option value='de/function.socket-setopt.php'>German</option>
            <option value='es/function.socket-setopt.php'>Spanish</option>
            <option value='fr/function.socket-setopt.php'>French</option>
            <option value='it/function.socket-setopt.php'>Italian</option>
            <option value='ja/function.socket-setopt.php'>Japanese</option>
            <option value='pt_BR/function.socket-setopt.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-setopt.php'>Russian</option>
            <option value='tr/function.socket-setopt.php'>Turkish</option>
            <option value='uk/function.socket-setopt.php'>Ukrainian</option>
            <option value='zh/function.socket-setopt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-setopt" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">socket_setopt</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_setopt</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.socket-set-option.php" class="function">socket_set_option()</a></span></span></p>
  ...
  <p class="simpara">
   ...
   <span class="function"><a href="function.socket-set-option.php" class="function">socket_set_option()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-setopt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-setopt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-setopt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-setopt.php">＋<small>add a note</small></a></span>
