...
<head>
  ...
  <title>PHP: sapi_windows_cp_set - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sapi-windows-cp-set.php">
 <link rel="shorturl" href="https://www.php.net/sapi-windows-cp-set">
 <link rel="alternate" href="https://www.php.net/sapi-windows-cp-set" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.misc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sapi-windows-cp-is-utf8.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sapi-windows-generate-ctrl-event.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sapi-windows-cp-set.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sapi-windows-cp-set.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sapi-windows-cp-set.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sapi-windows-cp-set.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sapi-windows-cp-set.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sapi-windows-cp-set.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sapi-windows-cp-set.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sapi-windows-cp-set.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sapi-windows-cp-set.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sapi-windows-cp-set.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sapi-windows-cp-set.php" hreflang="zh">
...
<meta name="Description" content="Set process codepage" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sapi_windows_cp_set - Manual" />
<meta name="twitter:description" content="Set process codepage" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sapi_windows_cp_set - Manual" />
<meta itemprop="description" content="Set process codepage" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set process codepage" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sapi-windows-generate-ctrl-event.php">
          sapi_windows_generate_ctrl_event &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sapi-windows-cp-is-utf8.php">
          &laquo; sapi_windows_cp_is_utf8        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sapi-windows-cp-set.php' selected="selected">English</option>
            <option value='de/function.sapi-windows-cp-set.php'>German</option>
            <option value='es/function.sapi-windows-cp-set.php'>Spanish</option>
            <option value='fr/function.sapi-windows-cp-set.php'>French</option>
            <option value='it/function.sapi-windows-cp-set.php'>Italian</option>
            <option value='ja/function.sapi-windows-cp-set.php'>Japanese</option>
            <option value='pt_BR/function.sapi-windows-cp-set.php'>Brazilian Portuguese</option>
            <option value='ru/function.sapi-windows-cp-set.php'>Russian</option>
            <option value='tr/function.sapi-windows-cp-set.php'>Turkish</option>
            <option value='uk/function.sapi-windows-cp-set.php'>Ukrainian</option>
            <option value='zh/function.sapi-windows-cp-set.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sapi-windows-cp-set" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.sapi-windows-cp-get.php" class="function" rel="rdfs-seeAlso">sapi_windows_cp_get()</a> - Get current codepage</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/misc/functions/sapi-windows-cp-set.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sapi-windows-cp-set%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sapi-windows-cp-set&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sapi-windows-cp-set.php">＋<small>add a note</small></a></span>
