...
<head>
  ...
  <title>PHP: MongoDB\Driver\BulkWrite::delete - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-bulkwrite.delete.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-bulkwrite.delete.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-bulkwrite.delete.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-bulkwrite.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-bulkwrite.count.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-bulkwrite.insert.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-bulkwrite.delete.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-bulkwrite.delete.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-bulkwrite.delete.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-bulkwrite.delete.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-bulkwrite.delete.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-bulkwrite.delete.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-bulkwrite.delete.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-bulkwrite.delete.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-bulkwrite.delete.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-bulkwrite.delete.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-bulkwrite.delete.php" hreflang="zh">
...
<meta name="Description" content="Add a delete operation to the bulk" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\BulkWrite::delete - Manual" />
<meta name="twitter:description" content="Add a delete operation to the bulk" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\BulkWrite::delete - Manual" />
<meta itemprop="description" content="Add a delete operation to the bulk" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add a delete operation to the bulk" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mongodb-driver-bulkwrite.insert.php">
          MongoDB\Driver\BulkWrite::insert &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-bulkwrite.count.php">
          &laquo; MongoDB\Driver\BulkWrite::count        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-bulkwrite.delete.php' selected="selected">English</option>
            <option value='de/mongodb-driver-bulkwrite.delete.php'>German</option>
            <option value='es/mongodb-driver-bulkwrite.delete.php'>Spanish</option>
            <option value='fr/mongodb-driver-bulkwrite.delete.php'>French</option>
            <option value='it/mongodb-driver-bulkwrite.delete.php'>Italian</option>
            <option value='ja/mongodb-driver-bulkwrite.delete.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-bulkwrite.delete.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-bulkwrite.delete.php'>Russian</option>
            <option value='tr/mongodb-driver-bulkwrite.delete.php'>Turkish</option>
            <option value='uk/mongodb-driver-bulkwrite.delete.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-bulkwrite.delete.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-bulkwrite.delete" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-mongodb-driver-bulkwrite.delete-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>MongoDB\Driver\BulkWrite::delete</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.object.php" class="type object">object</a></span></span> <code class="parameter">$filter</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.array.php" class="type array">array</a></span></span> <code class="parameter">$deleteOptions</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-mongodb-driver-bulkwrite.delete-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">deleteOptions</code></dt>
    <dd>
     <p class="para">
       ...
       <caption><strong>deleteOptions</strong></caption>
        ...
        <tbody class="tbody">
         ...
         <tr>
          ...
          <td>Delete all matching documents (<strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>), or only the first matching document (<strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>)</td>
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.mongodb-driver-writeresult.php" class="classname">MongoDB\Driver\WriteResult</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/bulkwrite/delete.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-bulkwrite.delete%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-bulkwrite.delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-bulkwrite.delete.php">＋<small>add a note</small></a></span>
