...
<head>
  ...
  <title>PHP: fann_scale_train - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-scale-train.php">
 <link rel="shorturl" href="https://www.php.net/fann-scale-train">
 <link rel="alternate" href="https://www.php.net/fann-scale-train" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-scale-output-train-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-scale-train-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-scale-train.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-scale-train.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-scale-train.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-scale-train.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-scale-train.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-scale-train.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-scale-train.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-scale-train.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-scale-train.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-scale-train.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-scale-train.php" hreflang="zh">
...
<meta name="Description" content="Scale input and output data based on previously calculated parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_scale_train - Manual" />
<meta name="twitter:description" content="Scale input and output data based on previously calculated parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_scale_train - Manual" />
<meta itemprop="description" content="Scale input and output data based on previously calculated parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Scale input and output data based on previously calculated parameters" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-scale-train-data.php">
          fann_scale_train_data &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-scale-output-train-data.php">
          &laquo; fann_scale_output_train_data        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-scale-train.php' selected="selected">English</option>
            <option value='de/function.fann-scale-train.php'>German</option>
            <option value='es/function.fann-scale-train.php'>Spanish</option>
            <option value='fr/function.fann-scale-train.php'>French</option>
            <option value='it/function.fann-scale-train.php'>Italian</option>
            <option value='ja/function.fann-scale-train.php'>Japanese</option>
            <option value='pt_BR/function.fann-scale-train.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-scale-train.php'>Russian</option>
            <option value='tr/function.fann-scale-train.php'>Turkish</option>
            <option value='uk/function.fann-scale-train.php'>Ukrainian</option>
            <option value='zh/function.fann-scale-train.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-scale-train" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_scale_train</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_scale_train</span> &mdash; <span class="dc-title">Scale input and output data based on previously calculated parameters</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-scale-train-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_scale_train</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$train_data</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-scale-train-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-scale-train-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-scale-train-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-descale-train.php" class="function" rel="rdfs-seeAlso">fann_descale_train()</a> - Descale input and output data based on previously calculated parameters</span></li>
    <li><span class="function"><a href="function.fann-set-scaling-params.php" class="function" rel="rdfs-seeAlso">fann_set_scaling_params()</a> - Calculate input and output scaling parameters for future use based on training data</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-scale-train.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-scale-train%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-scale-train&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-scale-train.php">＋<small>add a note</small></a></span>
