...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.hrtime.php">
 <link rel="shorturl" href="https://www.php.net/hrtime">
 <link rel="alternate" href="https://www.php.net/hrtime" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.misc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.highlight-string.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ignore-user-abort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.hrtime.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.hrtime.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.hrtime.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.hrtime.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.hrtime.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.hrtime.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.hrtime.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.hrtime.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.hrtime.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.hrtime.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.hrtime.php" hreflang="zh">
...
<meta name="Description" content="Get the system's high resolution time" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: hrtime - Manual" />
<meta name="twitter:description" content="Get the system's high resolution time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: hrtime - Manual" />
<meta itemprop="description" content="Get the system's high resolution time" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the system's high resolution time" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ignore-user-abort.php">
          ignore_user_abort &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.highlight-string.php">
          &laquo; highlight_string        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.hrtime.php' selected="selected">English</option>
            <option value='de/function.hrtime.php'>German</option>
            <option value='es/function.hrtime.php'>Spanish</option>
            <option value='fr/function.hrtime.php'>French</option>
            <option value='it/function.hrtime.php'>Italian</option>
            <option value='ja/function.hrtime.php'>Japanese</option>
            <option value='pt_BR/function.hrtime.php'>Brazilian Portuguese</option>
            <option value='ru/function.hrtime.php'>Russian</option>
            <option value='tr/function.hrtime.php'>Turkish</option>
            <option value='uk/function.hrtime.php'>Ukrainian</option>
            <option value='zh/function.hrtime.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.hrtime" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">hrtime</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.3.0, PHP 8)</p><p class="refpurpose"><span class="refname">hrtime</span> &mdash; <span class="dc-title">Get the system&#039;s high resolution time</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.hrtime-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Whether the high resolution time should be returned as <span class="type"><a href="language.types.array.php" class="type array">array</a></span>
       or number.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.hrtime-returnvalues">
  ...
  <p class="para">
   ...
   parameter <code class="parameter">as_number</code> is false. Otherwise the nanoseconds
   are returned as <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> (64bit platforms) or <span class="type"><a href="language.types.float.php" class="type float">float</a></span>
   (32bit platforms).
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.hrtime-seealso">
  ...
  <ul class="simplelist">
   <li>The <a href="book.hrtime.php" class="link">High resolution timing</a> extension</li>
   <li><span class="function"><a href="function.microtime.php" class="function" rel="rdfs-seeAlso">microtime()</a> - Return current Unix timestamp with microseconds</span></li>
  </ul>
 </div>
