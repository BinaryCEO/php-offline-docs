...
<head>
  ...
  <title>PHP: eio_init - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-init.php">
 <link rel="shorturl" href="https://www.php.net/eio-init">
 <link rel="alternate" href="https://www.php.net/eio-init" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-grp-limit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-link.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-init.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-init.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-init.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-init.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-init.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-init.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-init.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-init.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-init.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-init.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-init.php" hreflang="zh">
...
<meta name="Description" content="(Re-)initialize Eio" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_init - Manual" />
<meta name="twitter:description" content="(Re-)initialize Eio" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_init - Manual" />
<meta itemprop="description" content="(Re-)initialize Eio" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="(Re-)initialize Eio" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-init.php' selected="selected">English</option>
            <option value='de/function.eio-init.php'>German</option>
            <option value='es/function.eio-init.php'>Spanish</option>
            <option value='fr/function.eio-init.php'>French</option>
            <option value='it/function.eio-init.php'>Italian</option>
            <option value='ja/function.eio-init.php'>Japanese</option>
            <option value='pt_BR/function.eio-init.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-init.php'>Russian</option>
            <option value='tr/function.eio-init.php'>Turkish</option>
            <option value='uk/function.eio-init.php'>Ukrainian</option>
            <option value='zh/function.eio-init.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-init" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_init</h1>
  <p class="verinfo">(PECL eio = 1.0.0)</p><p class="refpurpose"><span class="refname">eio_init</span> &mdash; <span class="dc-title">(Re-)initialize Eio</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.eio-init-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_init</strong></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-init.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-init%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-init&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-init.php">＋<small>add a note</small></a></span>
