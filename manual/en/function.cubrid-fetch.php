...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-fetch.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-execute.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-free-result.php">
...
<meta name="Description" content="Fetch the next row from a result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_fetch - Manual" />
<meta name="twitter:description" content="Fetch the next row from a result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_fetch - Manual" />
<meta itemprop="description" content="Fetch the next row from a result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetch the next row from a result set" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-fetch.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.cubrid-fetch.php'>Brazilian Portuguese</option>
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-fetch-object.php" class="function" rel="rdfs-seeAlso">cubrid_fetch_object()</a> - Fetch the next row and return it as an object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-fetch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-fetch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-fetch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-fetch.php">＋<small>add a note</small></a></span>
