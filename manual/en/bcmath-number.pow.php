...
<head>
  ...
  <title>PHP: BcMath\Number::pow - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/bcmath-number.pow.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/bcmath-number.pow.php">
 <link rel="alternate" href="https://www.php.net/manual/en/bcmath-number.pow.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.bcmath-number.php">
 <link rel="prev" href="https://www.php.net/manual/en/bcmath-number.mul.php">
 <link rel="next" href="https://www.php.net/manual/en/bcmath-number.powmod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/bcmath-number.pow.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/bcmath-number.pow.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/bcmath-number.pow.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/bcmath-number.pow.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/bcmath-number.pow.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/bcmath-number.pow.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/bcmath-number.pow.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/bcmath-number.pow.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/bcmath-number.pow.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/bcmath-number.pow.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/bcmath-number.pow.php" hreflang="zh">
...
<meta name="Description" content="Raises an arbitrary precision number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: BcMath\Number::pow - Manual" />
<meta name="twitter:description" content="Raises an arbitrary precision number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: BcMath\Number::pow - Manual" />
<meta itemprop="description" content="Raises an arbitrary precision number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Raises an arbitrary precision number" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="bcmath-number.powmod.php">
          BcMath\Number::powmod &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="bcmath-number.mul.php">
          &laquo; BcMath\Number::mul        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/bcmath-number.pow.php' selected="selected">English</option>
            <option value='de/bcmath-number.pow.php'>German</option>
            <option value='es/bcmath-number.pow.php'>Spanish</option>
            <option value='fr/bcmath-number.pow.php'>French</option>
            <option value='it/bcmath-number.pow.php'>Italian</option>
            <option value='ja/bcmath-number.pow.php'>Japanese</option>
            <option value='pt_BR/bcmath-number.pow.php'>Brazilian Portuguese</option>
            <option value='ru/bcmath-number.pow.php'>Russian</option>
            <option value='tr/bcmath-number.pow.php'>Turkish</option>
            <option value='uk/bcmath-number.pow.php'>Ukrainian</option>
            <option value='zh/bcmath-number.pow.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="bcmath-number.pow" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="bcmath-number.div.php" class="methodname" rel="rdfs-seeAlso">BcMath\Number::div()</a> - Divides by an arbitrary precision number</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/bc/bcmath/number/pow.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbcmath-number.pow%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=bcmath-number.pow&amp;repo=en&amp;redirect=https://www.php.net/manual/en/bcmath-number.pow.php">＋<small>add a note</small></a></span>
