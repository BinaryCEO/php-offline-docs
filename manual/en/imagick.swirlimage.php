...
<head>
  ...
  <title>PHP: Imagick::swirlImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.swirlimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.swirlimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.swirlimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.subimagematch.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.textureimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.swirlimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.swirlimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.swirlimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.swirlimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.swirlimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.swirlimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.swirlimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.swirlimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.swirlimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.swirlimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.swirlimage.php" hreflang="zh">
...
<meta name="Description" content="Swirls the pixels about the center of the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::swirlImage - Manual" />
<meta name="twitter:description" content="Swirls the pixels about the center of the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::swirlImage - Manual" />
<meta itemprop="description" content="Swirls the pixels about the center of the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Swirls the pixels about the center of the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.textureimage.php">
          Imagick::textureImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.subimagematch.php">
          &laquo; Imagick::subImageMatch        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.swirlimage.php' selected="selected">English</option>
            <option value='de/imagick.swirlimage.php'>German</option>
            <option value='es/imagick.swirlimage.php'>Spanish</option>
            <option value='fr/imagick.swirlimage.php'>French</option>
            <option value='it/imagick.swirlimage.php'>Italian</option>
            <option value='ja/imagick.swirlimage.php'>Japanese</option>
            <option value='pt_BR/imagick.swirlimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.swirlimage.php'>Russian</option>
            <option value='tr/imagick.swirlimage.php'>Turkish</option>
            <option value='uk/imagick.swirlimage.php'>Ukrainian</option>
            <option value='zh/imagick.swirlimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.swirlimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::swirlImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::swirlImage</span> &mdash; <span class="dc-title">Swirls the pixels about the center of the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.swirlimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">

   <span class="methodname"><strong>Imagick::swirlImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$degrees</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.swirlimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.swirlimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.swirlimage-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.swirlimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3129">
      <p><strong>Example #1  <span class="function"><strong>Imagick::swirlImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/swirlimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.swirlimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.swirlimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.swirlimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="94450">  <div class="votes">
    <div id="Vu94450">
    <a href="/manual/vote-note.php?id=94450&amp;page=imagick.swirlimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94450">
    <a href="/manual/vote-note.php?id=94450&amp;page=imagick.swirlimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94450" title="50% like this...">
    0
    </div>
  </div>
  <a href="#94450" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#94450"> &para;</a><div class="date" title="2009-11-05 08:47"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94450">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br />$img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'blablabla.jpg'</span><span class="keyword">);<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">swirlImage </span><span class="keyword">( </span><span class="default">20.0 </span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: image/jpeg"</span><span class="keyword">);<br />echo </span><span class="default">$img</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.swirlimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.swirlimage.php">＋<small>add a note</small></a></div>
