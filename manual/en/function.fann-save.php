...
<head>
  ...
  <title>PHP: fann_save - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-save.php">
 <link rel="shorturl" href="https://www.php.net/fann-save">
 <link rel="alternate" href="https://www.php.net/fann-save" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-run.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-save-train.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-save.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-save.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-save.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-save.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-save.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-save.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-save.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-save.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-save.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-save.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-save.php" hreflang="zh">
...
<meta name="Description" content="Saves the entire network to a configuration file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_save - Manual" />
<meta name="twitter:description" content="Saves the entire network to a configuration file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_save - Manual" />
<meta itemprop="description" content="Saves the entire network to a configuration file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Saves the entire network to a configuration file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-save-train.php">
          fann_save_train &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-run.php">
          &laquo; fann_run        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-save.php' selected="selected">English</option>
            <option value='de/function.fann-save.php'>German</option>
            <option value='es/function.fann-save.php'>Spanish</option>
            <option value='fr/function.fann-save.php'>French</option>
            <option value='it/function.fann-save.php'>Italian</option>
            <option value='ja/function.fann-save.php'>Japanese</option>
            <option value='pt_BR/function.fann-save.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-save.php'>Russian</option>
            <option value='tr/function.fann-save.php'>Turkish</option>
            <option value='uk/function.fann-save.php'>Ukrainian</option>
            <option value='zh/function.fann-save.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-save" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.fann-save-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_save</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$configuration_file</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   ...
   <span class="function"><a href="function.fann-create-from-file.php" class="function">fann_create_from_file()</a></span> to create an exact copy of the neural network
   and all of the parameters associated with the neural network.
  </p>
  <p class="para">
   These three parameters (<span class="function"><a href="function.fann-set-callback.php" class="function">fann_set_callback()</a></span>, <span class="function"><a href="function.fann-set-error-log.php" class="function">fann_set_error_log()</a></span>,
   <span class="function"><strong>fann_set_user_data()</strong></span>) are NOT saved to the file because they cannot safely be ported
   to a different location. Also temporary parameters generated during training like <span class="function"><a href="function.fann-get-mse.php" class="function">fann_get_MSE()</a></span>
   is not saved.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-save-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-create-from-file.php" class="function" rel="rdfs-seeAlso">fann_create_from_file()</a> - Constructs a backpropagation neural network from a configuration file</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-save.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-save%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-save&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-save.php">＋<small>add a note</small></a></span>
