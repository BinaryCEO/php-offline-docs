...
<head>
  ...
  <title>PHP: rnp_key_export_revocation - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rnp-key-export-revocation.php">
 <link rel="shorturl" href="https://www.php.net/rnp-key-export-revocation">
 <link rel="alternate" href="https://www.php.net/rnp-key-export-revocation" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.rnp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.rnp-key-export-autocrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rnp-key-get-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rnp-key-export-revocation.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rnp-key-export-revocation.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rnp-key-export-revocation.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rnp-key-export-revocation.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rnp-key-export-revocation.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rnp-key-export-revocation.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rnp-key-export-revocation.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rnp-key-export-revocation.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rnp-key-export-revocation.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rnp-key-export-revocation.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rnp-key-export-revocation.php" hreflang="zh">
...
<meta name="Description" content="Generate and export primary key revocation signature" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rnp_key_export_revocation - Manual" />
<meta name="twitter:description" content="Generate and export primary key revocation signature" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rnp_key_export_revocation - Manual" />
<meta itemprop="description" content="Generate and export primary key revocation signature" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generate and export primary key revocation signature" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.rnp-key-get-info.php">
          rnp_key_get_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.rnp-key-export-autocrypt.php">
          &laquo; rnp_key_export_autocrypt        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rnp-key-export-revocation.php' selected="selected">English</option>
            <option value='de/function.rnp-key-export-revocation.php'>German</option>
            <option value='es/function.rnp-key-export-revocation.php'>Spanish</option>
            <option value='fr/function.rnp-key-export-revocation.php'>French</option>
            <option value='it/function.rnp-key-export-revocation.php'>Italian</option>
            <option value='ja/function.rnp-key-export-revocation.php'>Japanese</option>
            <option value='pt_BR/function.rnp-key-export-revocation.php'>Brazilian Portuguese</option>
            <option value='ru/function.rnp-key-export-revocation.php'>Russian</option>
            <option value='tr/function.rnp-key-export-revocation.php'>Turkish</option>
            <option value='uk/function.rnp-key-export-revocation.php'>Ukrainian</option>
            <option value='zh/function.rnp-key-export-revocation.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rnp-key-export-revocation" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.rnp-key-export-revocation-returnvalues">
  ...
  <p class="para">
   Exported revocation signature on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/functions/rnp-key-export-revocation.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rnp-key-export-revocation%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rnp-key-export-revocation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rnp-key-export-revocation.php">＋<small>add a note</small></a></span>
