...
<div class="annotation-interactive examplescode"><pre class="examplescode">array(2) {
 ...
 <div class="head">
  ...
  <strong class="user"><em>Ghanshyam Katriya(anshkatriya at gmail)</em></strong></a><a class="genanchor" href="#116302"> &para;</a><div class="date" title="2014-12-09 10:15"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116302">
<div class="phpcode"><code><span class="html">Create multidimensional array unique for any single key index.
...
<div class="phpcode"><code><span class="html">Because of PHP comparaisons modalities, you can never distinguish null from others falsy values.<br />Note the absorbing nature of true and false booleans in mix types array.<br /><br /><span class="default">&lt;?php<br /><br />$a </span><span class="keyword">= [</span><span class="default">true</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">, </span><span class="default">null</span><span class="keyword">, </span><span class="string">''</span><span class="keyword">, </span><span class="string">'0'</span><span class="keyword">, </span><span class="string">'123'</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">123</span><span class="keyword">];<br />foreach ([</span><span class="string">'SORT_REGULAR'</span><span class="keyword">, </span><span class="string">'SORT_NUMERIC'</span><span class="keyword">, </span><span class="string">'SORT_STRING'</span><span class="keyword">, </span><span class="string">'SORT_LOCALE_STRING'</span><span class="keyword">] as </span><span class="default">$flag</span><span class="keyword">) {<br />    </span><span class="default">$a_new </span><span class="keyword">= </span><span class="default">array_unique</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">, </span><span class="default">constant</span><span class="keyword">(</span><span class="default">$flag</span><span class="keyword">));<br />    echo </span><span class="string">"</span><span class="keyword">{</span><span class="default">$flag</span><span class="keyword">}</span><span class="string"> ==&gt; "</span><span class="keyword">;<br />    </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$a_new</span><span class="keyword">);<br />}<br /><br /></span><span class="comment">/*<br /><br />Gives :<br /><br />SORT_REGULAR ==&gt; array(2) {<br />  [0]=&gt; bool(true)<br />  [1]=&gt; bool(false)<br />}<br />SORT_NUMERIC ==&gt; array(3) {<br />  [0]=&gt; bool(true)<br />  [1]=&gt; bool(false)<br />  [5]=&gt; string(3) "123"<br />}<br />SORT_STRING ==&gt; array(4) {<br />  [0]=&gt; bool(true)<br />  [1]=&gt; bool(false)<br />  [4]=&gt; string(1) "0"<br />  [5]=&gt; string(3) "123"<br />}<br />SORT_LOCALE_STRING ==&gt; array(4) {<br />  [0]=&gt; bool(true)<br />  [1]=&gt; bool(false)<br />  [4]=&gt; string(1) "0"<br />  [5]=&gt; string(3) "123"<br />}<br /><br />*/</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>Mike D. - michal at euro-net.pl</em></strong></a><a class="genanchor" href="#128025"> &para;</a><div class="date" title="2022-12-17 12:47"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128025">
<div class="phpcode"><code><span class="html">modified code originally posted by Ghanshyam Katriya(anshkatriya at gmail) [highest voted comment here].<br /><br />1. In php 7.4 counter $i breaks the function. Removed completely (imo was waste of keystrokes anyway).<br />2. I added second return value - array of duplicates. So you can take both and compare them (I had to).<br /><br />Example array (copy-paste from original post):<br /><span class="default">&lt;?php<br />$details </span><span class="keyword">= array(<br />    </span><span class="default">0 </span><span class="keyword">=&gt; array(</span><span class="string">"id"</span><span class="keyword">=&gt;</span><span class="string">"1"</span><span class="keyword">, </span><span class="string">"name"</span><span class="keyword">=&gt;</span><span class="string">"Mike"</span><span class="keyword">,    </span><span class="string">"num"</span><span class="keyword">=&gt;</span><span class="string">"9876543210"</span><span class="keyword">),<br />    </span><span class="default">1 </span><span class="keyword">=&gt; array(</span><span class="string">"id"</span><span class="keyword">=&gt;</span><span class="string">"2"</span><span class="keyword">, </span><span class="string">"name"</span><span class="keyword">=&gt;</span><span class="string">"Carissa"</span><span class="keyword">, </span><span class="string">"num"</span><span class="keyword">=&gt;</span><span class="string">"08548596258"</span><span class="keyword">),<br />    </span><span class="default">2 </span><span class="keyword">=&gt; array(</span><span class="string">"id"</span><span class="keyword">=&gt;</span><span class="string">"1"</span><span class="keyword">, </span><span class="string">"name"</span><span class="keyword">=&gt;</span><span class="string">"Mathew"</span><span class="keyword">,  </span><span class="string">"num"</span><span class="keyword">=&gt;</span><span class="string">"784581254"</span><span class="keyword">),<br />);<br /></span><span class="default">?&gt;</span> <br /><br />Function:<br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">unique_multidim_array</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">, </span><span class="default">$key</span><span class="keyword">) : array {<br />    </span><span class="default">$uniq_array </span><span class="keyword">= array();<br />    </span><span class="default">$dup_array </span><span class="keyword">= array();<br />    </span><span class="default">$key_array </span><span class="keyword">= array();<br /><br />    foreach(</span><span class="default">$array </span><span class="keyword">as </span><span class="default">$val</span><span class="keyword">) {<br />        if (!</span><span class="default">in_array</span><span class="keyword">(</span><span class="default">$val</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">], </span><span class="default">$key_array</span><span class="keyword">)) {<br />            </span><span class="default">$key_array</span><span class="keyword">[] = </span><span class="default">$val</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">];<br />            </span><span class="default">$uniq_array</span><span class="keyword">[] = </span><span class="default">$val</span><span class="keyword">;<br /></span><span class="comment">/*<br />            # 1st list to check:<br />            # echo "ID or sth: " . $val['building_id'] . "; Something else: " . $val['nodes_name'] . (...) "\n";<br />*/<br />        </span><span class="keyword">} else {<br />            </span><span class="default">$dup_array</span><span class="keyword">[] = </span><span class="default">$val</span><span class="keyword">;<br /></span><span class="comment">/*<br />            # 2nd list to check:<br />            # echo "ID or sth: " . $val['building_id'] . "; Something else: " . $val['nodes_name'] . (...) "\n";<br />*/<br />        </span><span class="keyword">}<br />    }<br />    return array(</span><span class="default">$uniq_array</span><span class="keyword">, </span><span class="default">$dup_array</span><span class="keyword">, </span><span class="comment">/* $key_array */</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;</span> <br /><br />Usage:<br /><span class="default">&lt;?php<br /></span><span class="keyword">list(</span><span class="default">$unique_addresses</span><span class="keyword">, </span><span class="default">$duplicates</span><span class="keyword">, </span><span class="comment">/* $unique_keys */</span><span class="keyword">) = </span><span class="default">unique_multidim_array</span><span class="keyword">(</span><span class="default">$details</span><span class="keyword">,</span><span class="string">'id'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Then:<br />var_dump($unique_addresses);<br />or<br />var_dump($duplicates);<br />or foreach or whatever. Personally I just echo-ed 1st and then 2nd (both DOUBLE COMMENTED) list in function itself (then copied both to notepad++ and compared them - just to be 100% sure), but in case you want to do something else with it - enjoy :)<br />Plus - as a bonus - you also get an array of UNIQUE keys you searched for (just uncomment &gt;$key_array&lt; in both: function return and function call code).<br /><br />From example array code returns:<br />var_dump($unique_addresses); <br />array(2) {<br />  [0]=&gt;<br />  array(3) {<br />    ["id"]=&gt;<br />    string(1) "1"<br />    ["name"]=&gt;<br />    string(4) "Mike"<br />    ["num"]=&gt;<br />    string(10) "9876543210"<br />  }<br />  [1]=&gt;<br />  array(3) {<br />    ["id"]=&gt;<br />    string(1) "2"<br />    ["name"]=&gt;<br />    string(7) "Carissa"<br />    ["num"]=&gt;<br />    string(11) "08548596258"<br />  }<br />}<br /><br />var_dump($duplicates); <br />array(1) {<br />  [0]=&gt;<br />  array(3) {<br />    ["id"]=&gt;<br />    string(1) "1"<br />    ["name"]=&gt;<br />    string(6) "Mathew"<br />    ["num"]=&gt;<br />    string(9) "784581254"<br />  }<br />}<br /><br />Plus keys, if you want.<br /><br />P.S.: in my - practical - case of DB querying I got around 4k uniques and 15k dupes :)</span></code></div>
  </div>
 </div>
  <div class="note" id="122857">  <div class="votes">
    ...
    <div class="tally" id="V122857" title="86% like this...">
    22
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">It's often faster to use a foreache and array_keys than array_unique:
<br />
<br />    <span class="default">&lt;?php
<br />
...
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br /></span><span class="comment">//removes duplicated objetcs from an array according to the property given<br /><br /></span><span class="keyword">class </span><span class="default">ArrayFilter<br /></span><span class="keyword">{<br /><br />    public static function </span><span class="default">dedupe_array_of_objets</span><span class="keyword">(array </span><span class="default">$array</span><span class="keyword">, </span><span class="default">string $property</span><span class="keyword">) : array<br />    {<br />        </span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />        </span><span class="default">$filteredArray </span><span class="keyword">= array();<br />        </span><span class="default">$keyArray </span><span class="keyword">= array();<br /><br />        foreach(</span><span class="default">$array </span><span class="keyword">as </span><span class="default">$item</span><span class="keyword">) {<br />            if (!</span><span class="default">in_array</span><span class="keyword">(</span><span class="default">$item</span><span class="keyword">-&gt;</span><span class="default">$property</span><span class="keyword">, </span><span class="default">$keyArray</span><span class="keyword">)) {<br />                </span><span class="default">$keyArray</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">] = </span><span class="default">$item</span><span class="keyword">-&gt;</span><span class="default">$property</span><span class="keyword">;<br />                </span><span class="default">$filteredArray</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">] = </span><span class="default">$item</span><span class="keyword">;<br />            }<br />            </span><span class="default">$i</span><span class="keyword">++;<br />        }<br />        return </span><span class="default">$filteredArray</span><span class="keyword">;<br />    }<br />}</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I needed to identify email addresses in a data table that were replicated, so I wrote the array_not_unique() function:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">array_not_unique</span><span class="keyword">(</span><span class="default">$raw_array</span><span class="keyword">) {<br />    </span><span class="default">$dupes </span><span class="keyword">= array();<br />    </span><span class="default">natcasesort</span><span class="keyword">(</span><span class="default">$raw_array</span><span class="keyword">);<br />    </span><span class="default">reset </span><span class="keyword">(</span><span class="default">$raw_array</span><span class="keyword">);<br /><br />    </span><span class="default">$old_key    </span><span class="keyword">= </span><span class="default">NULL</span><span class="keyword">;<br />    </span><span class="default">$old_value    </span><span class="keyword">= </span><span class="default">NULL</span><span class="keyword">;<br />    foreach (</span><span class="default">$raw_array </span><span class="keyword">as </span><span class="default">$key </span><span class="keyword">=&gt; </span><span class="default">$value</span><span class="keyword">) {<br />        if (</span><span class="default">$value </span><span class="keyword">=== </span><span class="default">NULL</span><span class="keyword">) { continue; }<br />        if (</span><span class="default">$old_value </span><span class="keyword">== </span><span class="default">$value</span><span class="keyword">) {<br />            </span><span class="default">$dupes</span><span class="keyword">[</span><span class="default">$old_key</span><span class="keyword">]    = </span><span class="default">$old_value</span><span class="keyword">;<br />            </span><span class="default">$dupes</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">]        = </span><span class="default">$value</span><span class="keyword">;<br />        }<br />        </span><span class="default">$old_value    </span><span class="keyword">= </span><span class="default">$value</span><span class="keyword">;<br />        </span><span class="default">$old_key    </span><span class="keyword">= </span><span class="default">$key</span><span class="keyword">;<br />    }<br />return </span><span class="default">$dupes</span><span class="keyword">;<br />}<br /><br /></span><span class="default">$raw_array     </span><span class="keyword">= array();<br /></span><span class="default">$raw_array</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">]    = </span><span class="string">'abc@xyz.com'</span><span class="keyword">;<br /></span><span class="default">$raw_array</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">]    = </span><span class="string">'def@xyz.com'</span><span class="keyword">;<br /></span><span class="default">$raw_array</span><span class="keyword">[</span><span class="default">3</span><span class="keyword">]    = </span><span class="string">'ghi@xyz.com'</span><span class="keyword">;<br /></span><span class="default">$raw_array</span><span class="keyword">[</span><span class="default">4</span><span class="keyword">]    = </span><span class="string">'abc@xyz.com'</span><span class="keyword">; </span><span class="comment">// Duplicate<br /><br /></span><span class="default">$common_stuff    </span><span class="keyword">= </span><span class="default">array_not_unique</span><span class="keyword">(</span><span class="default">$raw_array</span><span class="keyword">);<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$common_stuff</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>free dot smilesrg at gmail dot com</em></strong></a><a class="genanchor" href="#127884"> &para;</a><div class="date" title="2022-11-01 02:43"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom127884">
<div class="phpcode"><code><span class="html">$a = new StdClass();<br />$b = new StdClass();<br /><br />var_dump(array_unique([$a, $b, $b, $a], SORT_REGULAR));<br />//array(1) {<br />//  [0]=&gt;<br />//    object(stdClass)#1 (0) {<br />//  }<br />//}<br /><br />$a-&gt;name = 'One';<br />$b-&gt;name = 'Two';<br /><br />var_dump(array_unique([$a, $b, $b, $a], SORT_REGULAR));<br /><br />//array(2) {<br />//  [0]=&gt;<br />//  object(stdClass)#1 (1) {<br />//    ["name"]=&gt;<br />//    string(3) "One"<br />//  }<br />//  [1]=&gt;<br />//  object(stdClass)#2 (1) {<br />//    ["name"]=&gt;<br />//    string(3) "Two"<br />//  }<br />//}</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Here is a solution to make unique values keeping empty values for an array with keys :<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">array_unique_kempty</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) {<br />    </span><span class="default">$values </span><span class="keyword">= </span><span class="default">array_unique</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">);<br />    </span><span class="default">$return </span><span class="keyword">= </span><span class="default">array_combine</span><span class="keyword">(</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">), </span><span class="default">array_fill</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">count</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">),</span><span class="default">null</span><span class="keyword">));<br />    return </span><span class="default">array_merge</span><span class="keyword">(</span><span class="default">$return</span><span class="keyword">,</span><span class="default">$values</span><span class="keyword">);<br />}<br /><br /></span><span class="default">$myArray </span><span class="keyword">= [<br />    </span><span class="string">"test1" </span><span class="keyword">=&gt; </span><span class="string">"aaa"</span><span class="keyword">,<br />    </span><span class="string">"test2" </span><span class="keyword">=&gt; </span><span class="default">null</span><span class="keyword">,<br />    </span><span class="string">"test3" </span><span class="keyword">=&gt; </span><span class="string">"aaa"</span><span class="keyword">,<br />    </span><span class="string">"test4" </span><span class="keyword">=&gt; </span><span class="string">"bbb"</span><span class="keyword">,<br />    </span><span class="string">"test5" </span><span class="keyword">=&gt; </span><span class="default">null</span><span class="keyword">,<br />    </span><span class="string">"test6" </span><span class="keyword">=&gt; </span><span class="string">"ccc"</span><span class="keyword">,<br />    </span><span class="string">"test7" </span><span class="keyword">=&gt; </span><span class="string">"ddd"</span><span class="keyword">,<br />    </span><span class="string">"test8" </span><span class="keyword">=&gt; </span><span class="string">"ccc"<br /></span><span class="keyword">];<br /><br />echo </span><span class="string">"&lt;pre&gt;"</span><span class="keyword">.</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">array_unique_kempty</span><span class="keyword">(</span><span class="default">$myArray</span><span class="keyword">),</span><span class="default">true</span><span class="keyword">).</span><span class="string">"&lt;/pre&gt;"</span><span class="keyword">;<br /><br /></span><span class="comment">/*<br />Array<br />(<br />    [test1] =&gt; aaa<br />    [test2] =&gt; <br />    [test3] =&gt; <br />    [test4] =&gt; bbb<br />    [test5] =&gt; <br />    [test6] =&gt; ccc<br />    [test7] =&gt; ddd<br />    [test8] =&gt; <br />)<br />*/<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <strong class="user"><em>mnbayazit</em></strong></a><a class="genanchor" href="#78801"> &para;</a><div class="date" title="2007-10-28 02:18"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom78801">
<div class="phpcode"><code><span class="html">Case insensitive; will keep first encountered value.
<br />
<br /><span class="default">&lt;?php
<br />
...
<div class="phpcode"><code><span class="html">Case insensitive for PHP v4.x and up.
<br />
<br /><span class="default">&lt;?php
<br />
...
<div class="phpcode"><code><span class="html">My object unique function:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">object_unique</span><span class="keyword">( </span><span class="default">$obj </span><span class="keyword">){<br />    </span><span class="default">$objArray </span><span class="keyword">= (array) </span><span class="default">$obj</span><span class="keyword">;<br /><br />    </span><span class="default">$objArray </span><span class="keyword">= </span><span class="default">array_intersect_assoc</span><span class="keyword">( </span><span class="default">array_unique</span><span class="keyword">( </span><span class="default">$objArray </span><span class="keyword">), </span><span class="default">$objArray </span><span class="keyword">);<br /><br />    foreach( </span><span class="default">$obj </span><span class="keyword">as </span><span class="default">$n </span><span class="keyword">=&gt; </span><span class="default">$f </span><span class="keyword">) {<br />        if( !</span><span class="default">array_key_exists</span><span class="keyword">( </span><span class="default">$n</span><span class="keyword">, </span><span class="default">$objArray </span><span class="keyword">) ) unset( </span><span class="default">$obj</span><span class="keyword">-&gt;</span><span class="default">$n </span><span class="keyword">);<br />    }<br /><br />    return </span><span class="default">$obj</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />And these code:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">class </span><span class="default">Test</span><span class="keyword">{<br />    public </span><span class="default">$pr0 </span><span class="keyword">= </span><span class="string">'string'</span><span class="keyword">;<br />    public </span><span class="default">$pr1 </span><span class="keyword">= </span><span class="string">'string1'</span><span class="keyword">;<br />    public </span><span class="default">$pr2 </span><span class="keyword">= </span><span class="string">'string'</span><span class="keyword">;<br />    public </span><span class="default">$pr3 </span><span class="keyword">= </span><span class="string">'string2'</span><span class="keyword">;<br />}<br /><br /></span><span class="default">$obj </span><span class="keyword">= new </span><span class="default">Test</span><span class="keyword">;<br /><br /></span><span class="default">var_dump</span><span class="keyword">( </span><span class="default">object_unique</span><span class="keyword">( </span><span class="default">$obj </span><span class="keyword">) );<br /></span><span class="default">?&gt;<br /></span><br />returns:<br />object(Test)[1]<br />  public 'pr0' =&gt; string 'string' (length=6)<br />  public 'pr1' =&gt; string 'string1' (length=7)<br />  public 'pr3' =&gt; string 'string2' (length=7)</span></code></div>
  ...
  <strong class="user"><em>mostafatalebi at rocketmail dot com</em></strong></a><a class="genanchor" href="#113889"> &para;</a><div class="date" title="2013-12-13 02:38"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113889">
<div class="phpcode"><code><span class="html">If you find the need to get a sorted array without it preserving the keys, use this code which has worked for me:
<br />
<br /><span class="default">&lt;?php
<br />
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />The above code returns an array which is both unique and sorted from zero.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I had a problem with array_unique and multidimensional arrays ... Maybe there's a better way to do this, but this will work for any dimensional arrays.
<br />
<br /><span class="default">&lt;?php
...
<div class="phpcode"><code><span class="html">This is a script for multi_dimensional arrays
<br />
<br /><span class="default">&lt;?php
...
<div class="phpcode"><code><span class="html">recursive array unique for multiarrays<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">super_unique</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">)<br />{<br />  </span><span class="default">$result </span><span class="keyword">= </span><span class="default">array_map</span><span class="keyword">(</span><span class="string">"unserialize"</span><span class="keyword">, </span><span class="default">array_unique</span><span class="keyword">(</span><span class="default">array_map</span><span class="keyword">(</span><span class="string">"serialize"</span><span class="keyword">, </span><span class="default">$array</span><span class="keyword">)));<br /><br />  foreach (</span><span class="default">$result </span><span class="keyword">as </span><span class="default">$key </span><span class="keyword">=&gt; </span><span class="default">$value</span><span class="keyword">)<br />  {<br />    if ( </span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">) )<br />    {<br />      </span><span class="default">$result</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] = </span><span class="default">super_unique</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">);<br />    }<br />  }<br /><br />  return </span><span class="default">$result</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>keneks at gmail dot com</em></strong></a><a class="genanchor" href="#70034"> &para;</a><div class="date" title="2006-09-30 07:01"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom70034">
<div class="phpcode"><code><span class="html">Taking the advantage of array_unique, here is a simple function to check if an array has duplicate values.
<br />
...
<div class="phpcode"><code><span class="html">another method to get unique values is :
<br />
<br /><span class="default">&lt;?php
...
<br /></span>
<br />Output:
<br />Array ( [0] =&gt; a [1] =&gt; b [2] =&gt; c [3] =&gt; d [4] =&gt; e [5] =&gt; f )</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>jusvalceanu - SPAM at SPAM - yahoo dot com</em></strong></a><a class="genanchor" href="#86848"> &para;</a><div class="date" title="2008-11-06 02:23"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86848">
<div class="phpcode"><code><span class="html">so .... my problem was multidimensional sort.
<br />
<br /><span class="default">&lt;?php
...
<br />
<br />From Romania With Love</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Simple and clean way to get duplicate entries removed from a multidimensional array.<br /><br /><span class="default">&lt;?php<br />          $multi_array </span><span class="keyword">= </span><span class="default">$multi_array </span><span class="keyword">[</span><span class="default">0</span><span class="keyword">];<br />          </span><span class="default">$multi_array </span><span class="keyword">= </span><span class="default">array_unique</span><span class="keyword">(</span><span class="default">$multi_array</span><span class="keyword">);<br />          </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$multi_array</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>amri [ at t] dhstudio dot eu</em></strong></a><a class="genanchor" href="#95203"> &para;</a><div class="date" title="2009-12-18 02:36"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95203">
<div class="phpcode"><code><span class="html">I searched how to show only the de-duplicate elements from array, but failed. 
...
<br />)</span></code></div>
  ...
  <strong class="user"><em>Ludovico Grossi</em></strong></a><a class="genanchor" href="#116363"> &para;</a><div class="date" title="2014-12-19 02:01"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116363">
<div class="phpcode"><code><span class="html">[Editor's note: please note that this will not work well with non-scalar values in the array. Array keys can not be arrays themselves, nor streams, resources, etc. Flipping the array causes a change in key-name]
<br />
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />This works faster for small and big arrays.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>memandeemail at gmail dot com</em></strong></a><a class="genanchor" href="#60323"> &para;</a><div class="date" title="2006-01-03 10:47"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom60323">
<div class="phpcode"><code><span class="html">Problem:
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="127958">  <div class="votes">
    ...
    <div class="tally" id="V127958" title="100% like this...">
    2
    </div>
  </div>
  <a href="#127958" class="name">
  <strong class="user"><em>tasiot</em></strong></a><a class="genanchor" href="#127958"> &para;</a><div class="date" title="2022-11-23 10:45"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom127958">
<div class="phpcode"><code><span class="html">array_unique is not compatible with php 8.1 enums because enums don't have a string representation yet (even the BackedEnum of string type…).<br />You get an error: "Object of class XXXX could not be converted to string."<br /><br />So I wrote this function that creates a string representation of the enums and use the array keys to remove duplicates:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">array_unique_81</span><span class="keyword">(array </span><span class="default">$values</span><span class="keyword">): array<br />{<br />    </span><span class="default">$unique </span><span class="keyword">= [];<br />    foreach (</span><span class="default">$values </span><span class="keyword">as </span><span class="default">$value</span><span class="keyword">) {<br />        if (</span><span class="default">$value </span><span class="keyword">instanceof </span><span class="default">\UnitEnum</span><span class="keyword">) {<br />            </span><span class="default">$key </span><span class="keyword">= </span><span class="string">'e:' </span><span class="keyword">. </span><span class="default">\get_class</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">) . </span><span class="string">':' </span><span class="keyword">. </span><span class="default">$value</span><span class="keyword">-&gt;</span><span class="default">name</span><span class="keyword">;<br />        } else {<br />            </span><span class="default">$key </span><span class="keyword">= </span><span class="string">'s:' </span><span class="keyword">. (string)</span><span class="default">$value</span><span class="keyword">;<br />        }<br />        </span><span class="default">$unique</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] = </span><span class="default">$value</span><span class="keyword">;<br />    }<br />    return </span><span class="default">\array_values</span><span class="keyword">(</span><span class="default">$unique</span><span class="keyword">);<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">An other solution to remove duplicates entries of a multi-dimensional array based on key…<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">array_unique_multi</span><span class="keyword">(array </span><span class="default">$array</span><span class="keyword">, </span><span class="default">string $key</span><span class="keyword">): array <br />{<br />    </span><span class="default">$unique </span><span class="keyword">= [];<br />    foreach (</span><span class="default">$array </span><span class="keyword">as </span><span class="default">$v</span><span class="keyword">) {<br />        if (!</span><span class="default">array_key_exists</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">], </span><span class="default">$unique</span><span class="keyword">)) {<br />            </span><span class="default">$unique</span><span class="keyword">[</span><span class="default">$v</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">]] = </span><span class="default">$v</span><span class="keyword">;<br />        }<br />    }<br />    return </span><span class="default">array_values</span><span class="keyword">(</span><span class="default">$unique</span><span class="keyword">);<br />}<br /><br /></span><span class="comment">// Usage<br /></span><span class="default">$unique </span><span class="keyword">= </span><span class="default">array_unique_multi</span><span class="keyword">(</span><span class="default">$users</span><span class="keyword">, </span><span class="string">'id'</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />Or to preserve keys…<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">array_unique_amulti</span><span class="keyword">(array </span><span class="default">$array</span><span class="keyword">, </span><span class="default">string $key</span><span class="keyword">): array <br />{<br />    </span><span class="default">$keys </span><span class="keyword">= [];<br />    </span><span class="default">$unique </span><span class="keyword">= [];<br />    foreach (</span><span class="default">$array </span><span class="keyword">as </span><span class="default">$k </span><span class="keyword">=&gt; </span><span class="default">$v</span><span class="keyword">) {<br />        if (!isset(</span><span class="default">$keys</span><span class="keyword">[</span><span class="default">$v</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">]])) {<br />            </span><span class="default">$keys</span><span class="keyword">[</span><span class="default">$v</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">]] = </span><span class="default">true</span><span class="keyword">;<br />            </span><span class="default">$unique</span><span class="keyword">[</span><span class="default">$k</span><span class="keyword">] = </span><span class="default">$v</span><span class="keyword">;<br />        }<br />    }<br />    return </span><span class="default">$unique</span><span class="keyword">;<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Although array_unique is not intended to work with multi-dimensional arrays, it does on 5.2.9.  However, it does not for 5.2.5.  Beware.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>geuis dot teses at gmail dot com</em></strong></a><a class="genanchor" href="#70273"> &para;</a><div class="date" title="2006-10-09 10:27"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom70273">
<div class="phpcode"><code><span class="html">Here's the shortest line of code I could find/create to remove all duplicate entries from an array and then reindex the keys.
<br />
<br /><span class="default">&lt;?php
<br />
...
<div class="phpcode"><code><span class="html">The following is an efficient, adaptable implementation of array_unique which always retains the first key having a given value:
<br />
<br /><span class="default">&lt;?php
