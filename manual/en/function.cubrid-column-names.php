...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-column-names.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-col-size.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-column-types.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-column-names.php' selected="selected">English</option>
            ...
            <option value='tr/function.cubrid-column-names.php'>Turkish</option>
 ...
 <p class="para">
  ...
  <p class="para">
    Array of string values containing the column names, when process is successful, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure. 
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-column-names-examples">
  ...
  <div class="example" id="example-1222">
   <p><strong>Example #1 <span class="function"><strong>cubrid_column_names()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.cubrid-column-types.php" class="function" rel="rdfs-seeAlso">cubrid_column_types()</a> - Get column types in result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-column-names.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-column-names%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-column-names&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-column-names.php">＋<small>add a note</small></a></span>
