...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.intlcodepointbreakiterator.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/intlrulebasedbreakiterator.getrulestatusvec.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcodepointbreakiterator.getlastcodepoint.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.intlcodepointbreakiterator.php' selected="selected">English</option>
            ...
            <option value='zh/class.intlcodepointbreakiterator.php'>Chinese (Simplified)</option>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="intlbreakiterator.getpartsiterator.php" class="methodname">IntlBreakIterator::getPartsIterator</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$type</code><span class="initializer"> = IntlPartsIterator::KEY_SEQUENTIAL</span></span>): <span class="type"><a href="class.intlpartsiterator.php" class="type IntlPartsIterator">IntlPartsIterator</a></span></div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="intlcodepointbreakiterator.getlastcodepoint.php">IntlCodePointBreakIterator::getLastCodePoint</a> — Get last code point passed over after advancing or receding the iterator</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcodepointbreakiterator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.intlcodepointbreakiterator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.intlcodepointbreakiterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.intlcodepointbreakiterator.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>Matt Kynx</em></strong></a><a class="genanchor" href="#127706"> &para;</a><div class="date" title="2022-10-09 01:38"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom127706">
<div class="phpcode"><code><span class="html">An example of using this to find all the code points in a string that cannot be transliterated to Latin-ASCII:<br /><br /><span class="default">&lt;?php<br /><br />$string </span><span class="keyword">= </span><span class="string">"Народm, Intl gurus get paid €10000/hr 😁"</span><span class="keyword">;<br /><br /></span><span class="default">$latinAscii </span><span class="keyword">= </span><span class="default">Transliterator</span><span class="keyword">::</span><span class="default">create</span><span class="keyword">(</span><span class="string">'NFC; Any-Latin; Latin-ASCII;'</span><span class="keyword">);<br /></span><span class="default">$transliterated </span><span class="keyword">= </span><span class="default">$latinAscii</span><span class="keyword">-&gt;</span><span class="default">transliterate</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">);<br /><br /></span><span class="default">$codePoints </span><span class="keyword">= </span><span class="default">IntlBreakIterator</span><span class="keyword">::</span><span class="default">createCodePointInstance</span><span class="keyword">();<br /></span><span class="default">$codePoints</span><span class="keyword">-&gt;</span><span class="default">setText</span><span class="keyword">(</span><span class="default">$transliterated</span><span class="keyword">);<br /><br />foreach (</span><span class="default">$codePoints</span><span class="keyword">-&gt;</span><span class="default">getPartsIterator</span><span class="keyword">() as </span><span class="default">$char</span><span class="keyword">) {<br />    </span><span class="default">$ord </span><span class="keyword">= </span><span class="default">IntlChar</span><span class="keyword">::</span><span class="default">ord</span><span class="keyword">(</span><span class="default">$char</span><span class="keyword">);<br />    if (</span><span class="default">255 </span><span class="keyword">&lt; </span><span class="default">$ord</span><span class="keyword">) {<br />        echo </span><span class="default">IntlChar</span><span class="keyword">::</span><span class="default">charName</span><span class="keyword">(</span><span class="default">$ord</span><span class="keyword">) . </span><span class="string">"\n"</span><span class="keyword">;<br />    }<br />}<br /></span><span class="default">?&gt;<br /></span><br />Outputs:<br />EURO SIGN<br />GRINNING FACE WITH SMILING EYES</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.intlcodepointbreakiterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.intlcodepointbreakiterator.php">＋<small>add a note</small></a></div>
