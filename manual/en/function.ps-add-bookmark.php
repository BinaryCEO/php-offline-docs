...
<head>
  ...
  <title>PHP: ps_add_bookmark - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-add-bookmark.php">
 <link rel="shorturl" href="https://www.php.net/ps-add-bookmark">
 <link rel="alternate" href="https://www.php.net/ps-add-bookmark" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-add-launchlink.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-add-bookmark.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-add-bookmark.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-add-bookmark.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-add-bookmark.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-add-bookmark.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-add-bookmark.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-add-bookmark.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-add-bookmark.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-add-bookmark.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-add-bookmark.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-add-bookmark.php" hreflang="zh">
...
<meta name="Description" content="Add bookmark to current page" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_add_bookmark - Manual" />
<meta name="twitter:description" content="Add bookmark to current page" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_add_bookmark - Manual" />
<meta itemprop="description" content="Add bookmark to current page" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add bookmark to current page" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-add-launchlink.php">
          ps_add_launchlink &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.ps.php">
          &laquo; PS Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-add-bookmark.php' selected="selected">English</option>
            <option value='de/function.ps-add-bookmark.php'>German</option>
            <option value='es/function.ps-add-bookmark.php'>Spanish</option>
            <option value='fr/function.ps-add-bookmark.php'>French</option>
            <option value='it/function.ps-add-bookmark.php'>Italian</option>
            <option value='ja/function.ps-add-bookmark.php'>Japanese</option>
            <option value='pt_BR/function.ps-add-bookmark.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-add-bookmark.php'>Russian</option>
            <option value='tr/function.ps-add-bookmark.php'>Turkish</option>
            <option value='uk/function.ps-add-bookmark.php'>Ukrainian</option>
            <option value='zh/function.ps-add-bookmark.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-add-bookmark" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-add-weblink.php" class="function" rel="rdfs-seeAlso">ps_add_weblink()</a> - Adds link to a web location</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-add-bookmark.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-add-bookmark%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-add-bookmark&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-add-bookmark.php">＋<small>add a note</small></a></span>
