...
<head>
  ...
  <title>PHP: MongoDB\BSON\Type - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-bson-type.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-bson-type">
 <link rel="alternate" href="https://www.php.net/mongodb-bson-type" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.bson.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-bson-utcdatetime.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mongodb-bson-persistable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-bson-type.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-bson-type.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-bson-type.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-bson-type.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-bson-type.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-bson-type.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-bson-type.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-bson-type.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-bson-type.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-bson-type.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-bson-type.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\BSON\Type interface" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\Type - Manual" />
<meta name="twitter:description" content="The MongoDB\BSON\Type interface" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\Type - Manual" />
<meta itemprop="description" content="The MongoDB\BSON\Type interface" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\BSON\Type interface" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.mongodb-bson-persistable.php">
          MongoDB\BSON\Persistable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-bson-utcdatetime.tostring.php">
          &laquo; MongoDB\BSON\UTCDateTime::__toString        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-bson-type.php' selected="selected">English</option>
            <option value='de/class.mongodb-bson-type.php'>German</option>
            <option value='es/class.mongodb-bson-type.php'>Spanish</option>
            <option value='fr/class.mongodb-bson-type.php'>French</option>
            <option value='it/class.mongodb-bson-type.php'>Italian</option>
            <option value='ja/class.mongodb-bson-type.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-bson-type.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-bson-type.php'>Russian</option>
            <option value='tr/class.mongodb-bson-type.php'>Turkish</option>
            <option value='uk/class.mongodb-bson-type.php'>Ukrainian</option>
            <option value='zh/class.mongodb-bson-type.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-bson-type" class="reference">
  ...
  <div class="section" id="mongodb-bson-type.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">MongoDB\BSON\Type</strong>
     </span>
     {</div>
   ...
   <p class="para">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/bson/type.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-bson-type%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-bson-type&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-bson-type.php">＋<small>add a note</small></a></span>
