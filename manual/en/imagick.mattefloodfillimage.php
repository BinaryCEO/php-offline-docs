...
<head>
  ...
  <title>PHP: Imagick::matteFloodfillImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.mattefloodfillimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.mattefloodfillimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.mattefloodfillimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.mapimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.medianfilterimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.mattefloodfillimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.mattefloodfillimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.mattefloodfillimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.mattefloodfillimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.mattefloodfillimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.mattefloodfillimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.mattefloodfillimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.mattefloodfillimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.mattefloodfillimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.mattefloodfillimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.mattefloodfillimage.php" hreflang="zh">
...
<meta name="Description" content="Changes the transparency value of a color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::matteFloodfillImage - Manual" />
<meta name="twitter:description" content="Changes the transparency value of a color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::matteFloodfillImage - Manual" />
<meta itemprop="description" content="Changes the transparency value of a color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Changes the transparency value of a color" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.medianfilterimage.php">
          Imagick::medianFilterImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.mapimage.php">
          &laquo; Imagick::mapImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.mattefloodfillimage.php' selected="selected">English</option>
            <option value='de/imagick.mattefloodfillimage.php'>German</option>
            <option value='es/imagick.mattefloodfillimage.php'>Spanish</option>
            <option value='fr/imagick.mattefloodfillimage.php'>French</option>
            <option value='it/imagick.mattefloodfillimage.php'>Italian</option>
            <option value='ja/imagick.mattefloodfillimage.php'>Japanese</option>
            <option value='pt_BR/imagick.mattefloodfillimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.mattefloodfillimage.php'>Russian</option>
            <option value='tr/imagick.mattefloodfillimage.php'>Turkish</option>
            <option value='uk/imagick.mattefloodfillimage.php'>Ukrainian</option>
            <option value='zh/imagick.mattefloodfillimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.mattefloodfillimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::matteFloodfillImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::matteFloodfillImage</span> &mdash; <span class="dc-title">Changes the transparency value of a color</span></p>

 </div>

 <div id="imagick.mattefloodfillimage-refsynopsisdiv">
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.mattefloodfillimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
      An <span class="classname"><a href="class.imagickpixel.php" class="classname">ImagickPixel</a></span> object or string representing the border color.
      </p>
     </dd>
     ...
     <tbody class="tbody">
      <tr>
       ...
       <td>
        ...
        Previous versions allow only an <span class="classname"><a href="class.imagickpixel.php" class="classname">ImagickPixel</a></span> object.
       </td>
      </tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/mattefloodfillimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.mattefloodfillimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.mattefloodfillimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.mattefloodfillimage.php">＋<small>add a note</small></a></span>
