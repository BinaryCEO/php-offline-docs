...
<head>
  ...
  <title>PHP: trader_aroonosc - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-aroonosc.php">
 <link rel="shorturl" href="https://www.php.net/trader-aroonosc">
 <link rel="alternate" href="https://www.php.net/trader-aroonosc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-aroon.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-asin.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-aroonosc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-aroonosc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-aroonosc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-aroonosc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-aroonosc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-aroonosc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-aroonosc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-aroonosc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-aroonosc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-aroonosc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-aroonosc.php" hreflang="zh">
...
<meta name="Description" content="Aroon Oscillator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_aroonosc - Manual" />
<meta name="twitter:description" content="Aroon Oscillator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_aroonosc - Manual" />
<meta itemprop="description" content="Aroon Oscillator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Aroon Oscillator" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-asin.php">
          trader_asin &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-aroon.php">
          &laquo; trader_aroon        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-aroonosc.php' selected="selected">English</option>
            <option value='de/function.trader-aroonosc.php'>German</option>
            <option value='es/function.trader-aroonosc.php'>Spanish</option>
            <option value='fr/function.trader-aroonosc.php'>French</option>
            <option value='it/function.trader-aroonosc.php'>Italian</option>
            <option value='ja/function.trader-aroonosc.php'>Japanese</option>
            <option value='pt_BR/function.trader-aroonosc.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-aroonosc.php'>Russian</option>
            <option value='tr/function.trader-aroonosc.php'>Turkish</option>
            <option value='uk/function.trader-aroonosc.php'>Ukrainian</option>
            <option value='zh/function.trader-aroonosc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-aroonosc" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_aroonosc</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_aroonosc</span> &mdash; <span class="dc-title">Aroon Oscillator</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-aroonosc-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_aroonosc</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-aroonosc-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-aroonosc-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-aroonosc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-aroonosc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-aroonosc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-aroonosc.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125824">  <div class="votes">
    <div id="Vu125824">
    <a href="/manual/vote-note.php?id=125824&amp;page=function.trader-aroonosc&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125824">
    <a href="/manual/vote-note.php?id=125824&amp;page=function.trader-aroonosc&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125824" title="100% like this...">
    1
    </div>
  </div>
  <a href="#125824" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#125824"> &para;</a><div class="date" title="2021-02-15 04:48"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125824">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /></span><span class="comment">/*<br />The Aroon Oscillator uses the Aroon Indicator to gauge the strength of a trend and the likelihood that it will continue.<br />*/<br /><br /></span><span class="default">$highs </span><span class="keyword">= array(</span><span class="default">118.99</span><span class="keyword">, </span><span class="default">119.14</span><span class="keyword">, </span><span class="default">120.5</span><span class="keyword">, </span><span class="default">115.23</span><span class="keyword">, </span><span class="default">115.93</span><span class="keyword">, </span><span class="default">118.829</span><span class="keyword">, </span><span class="default">116</span><span class="keyword">, </span><span class="default">112.2</span><span class="keyword">, </span><span class="default">110.88</span><span class="keyword">, </span><span class="default">110.19</span><span class="keyword">, </span><span class="default">112.86</span><span class="keyword">, </span><span class="default">112.11</span><span class="keyword">, </span><span class="default">110.25</span><span class="keyword">, </span><span class="default">112.44</span><span class="keyword">);<br /></span><span class="default">$lows </span><span class="keyword">= array(</span><span class="default">112.68</span><span class="keyword">, </span><span class="default">115.26</span><span class="keyword">, </span><span class="default">112.5</span><span class="keyword">, </span><span class="default">110</span><span class="keyword">, </span><span class="default">112.8</span><span class="keyword">, </span><span class="default">113.61</span><span class="keyword">, </span><span class="default">112.04</span><span class="keyword">, </span><span class="default">108.71</span><span class="keyword">, </span><span class="default">106.09</span><span class="keyword">, </span><span class="default">103.1</span><span class="keyword">, </span><span class="default">109.16</span><span class="keyword">, </span><span class="default">106.77</span><span class="keyword">, </span><span class="default">105</span><span class="keyword">, </span><span class="default">107.67</span><span class="keyword">);<br /><br /></span><span class="default">$time_period </span><span class="keyword">= </span><span class="default">5</span><span class="keyword">;                 <br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">trader_aroonosc</span><span class="keyword">(</span><span class="default">$highs</span><span class="keyword">, </span><span class="default">$lows</span><span class="keyword">, </span><span class="default">$time_period</span><span class="keyword">));<br /></span><span class="comment">/*<br />array(9) {<br />  [5]=&gt;<br />  float(-20)<br />  [6]=&gt;<br />  float(-20)<br />  [7]=&gt;<br />  float(-100)<br />  [8]=&gt;<br />  float(-60)<br />  [9]=&gt;<br />  float(-80)<br />  [10]=&gt;<br />  float(-80)<br />  [11]=&gt;<br />  float(-60)<br />  [12]=&gt;<br />  float(20)<br />  [13]=&gt;<br />  float(20)<br />}<br />*/</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-aroonosc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-aroonosc.php">＋<small>add a note</small></a></div>
