...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-isatty.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-initgroups.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-kill.php">
...
<meta name="Description" content="Determine if a file descriptor is an interactive terminal" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_isatty - Manual" />
<meta name="twitter:description" content="Determine if a file descriptor is an interactive terminal" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_isatty - Manual" />
<meta itemprop="description" content="Determine if a file descriptor is an interactive terminal" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Determine if a file descriptor is an interactive terminal" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-isatty.php' selected="selected">English</option>
            <option value='de/function.posix-isatty.php'>German</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.posix-isatty-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if <code class="parameter">file_descriptor</code> is an open descriptor connected
   to a terminal and <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.4.0</td>
      <td>
       Set errno (error number) to <strong><code>EBADF</code></strong> when the
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.stream-isatty.php" class="function" rel="rdfs-seeAlso">stream_isatty()</a> - Check if a stream is a TTY</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-isatty.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-isatty%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-isatty&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-isatty.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Can be useful to determine whether output is being piped elsewhere, for PHP shell scripts, for example;<br /><br />#!/usr/local/bin/php<br /><span class="default">&lt;?php<br /></span><span class="keyword">if ( !</span><span class="default">posix_isatty</span><span class="keyword">(</span><span class="default">STDOUT</span><span class="keyword">) ) {<br />    </span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">STDOUT</span><span class="keyword">, </span><span class="string">"Invalid TTY\n"</span><span class="keyword">);<br />    exit(</span><span class="default">2</span><span class="keyword">);<br />}<br /></span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">STDOUT</span><span class="keyword">, </span><span class="string">"Enter you name\n"</span><span class="keyword">);<br /></span><span class="default">$name </span><span class="keyword">= </span><span class="default">fgets</span><span class="keyword">(</span><span class="default">STDIN</span><span class="keyword">);<br /></span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">STDOUT</span><span class="keyword">,</span><span class="string">"Hello </span><span class="default">$name</span><span class="string">\n"</span><span class="keyword">);<br />exit(</span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />If this script is like:<br /><br />script.php &gt; outfile<br /><br />outfile will contain "Invalid TTY"</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>KEINOS</em></strong></a><a class="genanchor" href="#125664"> &para;</a><div class="date" title="2021-01-08 10:34"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125664">
<div class="phpcode"><code><span class="html">It's quite complicated to understand its movements. But it determines if the file_descriptor is open AND connected to a terminal.<br /><br />Thus, while receiving data from the STDIN, for example, it will return false.<br /><br />This move is useful to optionally pipe STDIN to a PHP script, to avoid hanging when nothing is from STDIN.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">// Simply echoes the contents from STDIN if any<br />// and "no stdin" if not.<br /></span><span class="keyword">echo (</span><span class="default">posix_isatty</span><span class="keyword">(</span><span class="default">STDIN</span><span class="keyword">)) ? </span><span class="string">'no stdin' </span><span class="keyword">. </span><span class="default">PHP_EOL </span><span class="keyword">: </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="string">'php://stdin'</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.posix-isatty&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-isatty.php">＋<small>add a note</small></a></div>
