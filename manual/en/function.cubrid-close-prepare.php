...
<head>
  ...
  <title>PHP: cubrid_close_prepare - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-close-prepare.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-close-prepare">
 <link rel="alternate" href="https://www.php.net/cubrid-close-prepare" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-bind.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-close-request.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-close-prepare.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-close-prepare.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-close-prepare.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-close-prepare.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-close-prepare.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-close-prepare.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-close-prepare.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-close-prepare.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-close-prepare.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-close-prepare.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-close-prepare.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: cubrid_close_prepare - Manual" />
<meta name="twitter:description" content="Close the request handle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_close_prepare - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-close-request.php">
          cubrid_close_request &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-close-prepare.php' selected="selected">English</option>
            <option value='de/function.cubrid-close-prepare.php'>German</option>
            <option value='es/function.cubrid-close-prepare.php'>Spanish</option>
            <option value='fr/function.cubrid-close-prepare.php'>French</option>
            <option value='it/function.cubrid-close-prepare.php'>Italian</option>
            <option value='ja/function.cubrid-close-prepare.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-close-prepare.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-close-prepare.php'>Russian</option>
            <option value='tr/function.cubrid-close-prepare.php'>Turkish</option>
            <option value='uk/function.cubrid-close-prepare.php'>Ukrainian</option>
            <option value='zh/function.cubrid-close-prepare.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-close-prepare" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_close_prepare</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_close_prepare</span> &mdash; <span class="dc-title">Close the request handle</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-close-prepare-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_close_prepare</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$req_identifier</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   The <span class="function"><strong>cubrid_close_prepare()</strong></span> function closes the request
  ...
  <div class="refsect1 parameters" id="refsect1-function.cubrid-close-prepare-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-close-prepare-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$con </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_connect </span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #0000BB">33000</span><span style="color: #007700">, </span><span style="color: #DD0000">"demodb"</span><span style="color: #007700">, </span><span style="color: #DD0000">"dba"</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">$con</span><span style="color: #007700">) {<br />   echo </span><span style="color: #DD0000">"connected successfully"</span><span style="color: #007700">;<br />   </span><span style="color: #0000BB">$req </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_execute </span><span style="color: #007700">( </span><span style="color: #0000BB">$con</span><span style="color: #007700">, </span><span style="color: #DD0000">"select * from members"</span><span style="color: #007700">, <br />                           </span><span style="color: #0000BB">CUBRID_INCLUDE_OID </span><span style="color: #007700">| </span><span style="color: #0000BB">CUBRID_ASYNC</span><span style="color: #007700">);<br />   if (</span><span style="color: #0000BB">$req</span><span style="color: #007700">) {<br />      while ( list (</span><span style="color: #0000BB">$id</span><span style="color: #007700">, </span><span style="color: #0000BB">$name</span><span style="color: #007700">) = </span><span style="color: #0000BB">cubrid_fetch </span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">) ){<br />         echo </span><span style="color: #0000BB">$id</span><span style="color: #007700">;<br />         echo </span><span style="color: #0000BB">$name</span><span style="color: #007700">;<br />      } <br />      </span><span style="color: #0000BB">cubrid_close_prepare</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">); </span><span style="color: #FF8000">// or you can use cubrid_close_request($req)<br />   </span><span style="color: #007700">}<br />   </span><span style="color: #0000BB">cubrid_disconnect</span><span style="color: #007700">(</span><span style="color: #0000BB">$con</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <div class="refsect1 seealso" id="refsect1-function.cubrid-close-prepare-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.cubrid-close-request.php" class="function" rel="rdfs-seeAlso">cubrid_close_request()</a> - Close the request handle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-close-prepare.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-close-prepare%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-close-prepare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-close-prepare.php">＋<small>add a note</small></a></span>
