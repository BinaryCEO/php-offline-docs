...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cli-get-process-title.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.assert-options.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cli-set-process-title.php">
...
<meta name="Description" content="Returns the current process title" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cli_get_process_title - Manual" />
<meta name="twitter:description" content="Returns the current process title" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cli_get_process_title - Manual" />
<meta itemprop="description" content="Returns the current process title" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the current process title" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cli-get-process-title.php' selected="selected">English</option>
            ...
            <option value='tr/function.cli-get-process-title.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">cli_get_process_title</span> &mdash; <span class="dc-title">Returns the current process title</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.cli-get-process-title-description">
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.cli-set-process-title.php" class="function">cli_set_process_title()</a></span>. Note that this may not exactly
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cli-get-process-title-returnvalues">
  ...
  <p class="para">
   Return a string with the current process title or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on error.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.cli-set-process-title.php" class="function" rel="rdfs-seeAlso">cli_set_process_title()</a> - Sets the process title</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/cli-get-process-title.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cli-get-process-title%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cli-get-process-title&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cli-get-process-title.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">For versions of PHP &lt; 5.5.0, you can get the name of the script from $argv[0]: <a href="http://www.php.net/manual/en/reserved.variables.argv.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/reserved.variables.argv.php</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.cli-get-process-title&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cli-get-process-title.php">＋<small>add a note</small></a></div>
