...
<head>
  ...
  <title>PHP: Imagick::setRegistry - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setregistry.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setregistry.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setregistry.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setprogressmonitor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setresolution.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setregistry.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setregistry.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setregistry.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setregistry.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setregistry.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setregistry.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setregistry.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setregistry.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setregistry.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setregistry.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setregistry.php" hreflang="zh">
...
<meta name="Description" content="Sets the ImageMagick registry entry named key to value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setRegistry - Manual" />
<meta name="twitter:description" content="Sets the ImageMagick registry entry named key to value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setRegistry - Manual" />
<meta itemprop="description" content="Sets the ImageMagick registry entry named key to value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the ImageMagick registry entry named key to value" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setresolution.php">
          Imagick::setResolution &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setprogressmonitor.php">
          &laquo; Imagick::setProgressMonitor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setregistry.php' selected="selected">English</option>
            <option value='de/imagick.setregistry.php'>German</option>
            <option value='es/imagick.setregistry.php'>Spanish</option>
            <option value='fr/imagick.setregistry.php'>French</option>
            <option value='it/imagick.setregistry.php'>Italian</option>
            <option value='ja/imagick.setregistry.php'>Japanese</option>
            <option value='pt_BR/imagick.setregistry.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setregistry.php'>Russian</option>
            <option value='tr/imagick.setregistry.php'>Turkish</option>
            <option value='uk/imagick.setregistry.php'>Ukrainian</option>
            <option value='zh/imagick.setregistry.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setregistry" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setRegistry</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::setRegistry</span> &mdash; <span class="dc-title">Sets the ImageMagick registry entry named key to value</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setregistry-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::setRegistry</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setregistry-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setregistry-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setregistry.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setregistry%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setregistry&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setregistry.php">＋<small>add a note</small></a></span>
