...
<head>
  ...
  <title>PHP: mysqli::$connect_errno - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.connect-errno.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.connect-errno.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.connect-errno.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.commit.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.connect-error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.connect-errno.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.connect-errno.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.connect-errno.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.connect-errno.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.connect-errno.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.connect-errno.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.connect-errno.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.connect-errno.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.connect-errno.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.connect-errno.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.connect-errno.php" hreflang="zh">
...
<meta name="Description" content="Returns the error code from last connect call" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::$connect_errno - Manual" />
<meta name="twitter:description" content="Returns the error code from last connect call" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::$connect_errno - Manual" />
<meta itemprop="description" content="Returns the error code from last connect call" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the error code from last connect call" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli.connect-error.php">
          mysqli::$connect_error &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.commit.php">
          &laquo; mysqli::commit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.connect-errno.php' selected="selected">English</option>
            <option value='de/mysqli.connect-errno.php'>German</option>
            <option value='es/mysqli.connect-errno.php'>Spanish</option>
            <option value='fr/mysqli.connect-errno.php'>French</option>
            <option value='it/mysqli.connect-errno.php'>Italian</option>
            <option value='ja/mysqli.connect-errno.php'>Japanese</option>
            <option value='pt_BR/mysqli.connect-errno.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.connect-errno.php'>Russian</option>
            <option value='tr/mysqli.connect-errno.php'>Turkish</option>
            <option value='uk/mysqli.connect-errno.php'>Ukrainian</option>
            <option value='zh/mysqli.connect-errno.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.connect-errno" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli::$connect_errno</h1>
  <h1 class="refname">mysqli_connect_errno</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli::$connect_errno</span> -- <span class="refname">mysqli_connect_errno</span> &mdash; <span class="dc-title">Returns the error code from last connect call</span></p>
 ...
 <div class="refsect1 description" id="refsect1-mysqli.connect-errno-description">
  ...
  <div class="fieldsynopsis"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <var class="varname"><a href="mysqli.connect-errno.php">$mysqli-&gt;connect_errno</a></var>;</div>

  <p class="para">Procedural style</p>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysqli_connect_errno</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-mysqli.connect-errno-parameters">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli.sqlstate.php" class="function" rel="rdfs-seeAlso">mysqli_sqlstate()</a> - Returns the SQLSTATE error from previous MySQL operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/connect-errno.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.connect-errno%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.connect-errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.connect-errno.php">＋<small>add a note</small></a></span>
