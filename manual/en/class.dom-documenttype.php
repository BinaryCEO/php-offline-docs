...
<head>
  ...
  <title>PHP: Dom\DocumentType - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-documenttype.php">
 <link rel="shorturl" href="https://www.php.net/dom-documenttype">
 <link rel="alternate" href="https://www.php.net/dom-documenttype" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-documentfragment.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-dtdnamednodemap.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-documenttype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-documenttype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-documenttype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-documenttype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-documenttype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-documenttype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-documenttype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-documenttype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-documenttype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-documenttype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-documenttype.php" hreflang="zh">
...
<meta name="Description" content="The Dom\DocumentType class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\DocumentType - Manual" />
<meta name="twitter:description" content="The Dom\DocumentType class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\DocumentType - Manual" />
<meta itemprop="description" content="The Dom\DocumentType class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\DocumentType class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.dom-dtdnamednodemap.php">
          Dom\DtdNamedNodeMap &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dom-documentfragment.php">
          &laquo; Dom\DocumentFragment        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-documenttype.php' selected="selected">English</option>
            <option value='de/class.dom-documenttype.php'>German</option>
            <option value='es/class.dom-documenttype.php'>Spanish</option>
            <option value='fr/class.dom-documenttype.php'>French</option>
            <option value='it/class.dom-documenttype.php'>Italian</option>
            <option value='ja/class.dom-documenttype.php'>Japanese</option>
            <option value='pt_BR/class.dom-documenttype.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-documenttype.php'>Russian</option>
            <option value='tr/class.dom-documenttype.php'>Turkish</option>
            <option value='uk/class.dom-documenttype.php'>Ukrainian</option>
            <option value='zh/class.dom-documenttype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-documenttype" class="reference">
 <h1 class="title">The Dom\DocumentType class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>
  <div class="section" id="dom-documenttype.intro">
   <h2 class="title">Introduction</h2>
   <p class="simpara">
    Each <span class="classname"><a href="class.dom-document.php" class="classname">Dom\Document</a></span> has a <code class="literal">doctype</code>
    attribute whose value is either <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> or a <span class="classname"><strong class="classname">Dom\DocumentType</strong></span> object.
   </p>
   <p class="simpara">
    This is the modern, spec-compliant equivalent of
    <span class="classname"><a href="class.domimplementation.php" class="classname">DOMImplementation</a></span>.
   </p>
  </div>

  <div class="section" id="dom-documenttype.synopsis">
   <h2 class="title">Class synopsis</h2>
   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\DocumentType</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-documenttype.php#dom-documenttype.props.name">$<var class="varname">name</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="class.dom-dtdnamednodemap.php" class="type Dom\DtdNamedNodeMap">Dom\DtdNamedNodeMap</a></span>
      <var class="varname"><a href="class.dom-documenttype.php#dom-documenttype.props.entities">$<var class="varname">entities</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="class.dom-dtdnamednodemap.php" class="type Dom\DtdNamedNodeMap">Dom\DtdNamedNodeMap</a></span>
      <var class="varname"><a href="class.dom-documenttype.php#dom-documenttype.props.notations">$<var class="varname">notations</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-documenttype.php#dom-documenttype.props.publicid">$<var class="varname">publicId</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-documenttype.php#dom-documenttype.props.systemid">$<var class="varname">systemId</var></a></var>;</div>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-documenttype.php#dom-documenttype.props.internalsubset">$<var class="varname">internalSubset</var></a></var>;</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
  ...
  <div class="section" id="dom-documenttype.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-documenttype.props.publicid"><var class="varname">publicId</var></dt><dd>
      <p class="para">The public identifier of the external subset.</p>
     </dd>
    
    
     <dt id="dom-documenttype.props.systemid"><var class="varname">systemId</var></dt><dd>
      <p class="para">
       The system identifier of the external subset. This may be an
       absolute <abbr title="Uniform Resource Identifier">URI</abbr> or not.
      </p>
     </dd>
    
    
     <dt id="dom-documenttype.props.name"><var class="varname">name</var></dt><dd>
      <p class="para">
       The name of <abbr>DTD</abbr>; i.e., the name immediately following the
       <code class="literal">DOCTYPE</code> keyword.
      </p>
     </dd>
    
    
     <dt id="dom-documenttype.props.entities"><var class="varname">entities</var></dt>
     <dd>
      <span class="simpara">
       A <span class="classname"><a href="class.dom-dtdnamednodemap.php" class="classname">Dom\DtdNamedNodeMap</a></span> containing the general
       entities, both external and internal, declared in the <abbr class="abbrev">DTD</abbr>.
      </span>
     </dd>
    
    
     <dt id="dom-documenttype.props.notations"><var class="varname">notations</var></dt>
     <dd>
      <span class="simpara">
       A <span class="classname"><a href="class.dom-dtdnamednodemap.php" class="classname">Dom\DtdNamedNodeMap</a></span> containing the notations
       declared in the <abbr class="abbrev">DTD</abbr>.
      </span>
     </dd>
    
    
     <dt id="dom-documenttype.props.internalsubset"><var class="varname">internalSubset</var></dt><dd>
      <p class="para">
       The internal subset as a string, or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if there is none. This
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-documenttype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-documenttype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-documenttype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-documenttype.php">＋<small>add a note</small></a></span>
