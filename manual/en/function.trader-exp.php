...
<head>
  ...
  <title>PHP: trader_exp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-exp.php">
 <link rel="shorturl" href="https://www.php.net/trader-exp">
 <link rel="alternate" href="https://www.php.net/trader-exp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-errno.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-floor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-exp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-exp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-exp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-exp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-exp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-exp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-exp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-exp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-exp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-exp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-exp.php" hreflang="zh">
...
<meta name="Description" content="Vector Arithmetic Exp" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_exp - Manual" />
<meta name="twitter:description" content="Vector Arithmetic Exp" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_exp - Manual" />
<meta itemprop="description" content="Vector Arithmetic Exp" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Vector Arithmetic Exp" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-exp.php' selected="selected">English</option>
            <option value='de/function.trader-exp.php'>German</option>
            <option value='es/function.trader-exp.php'>Spanish</option>
            <option value='fr/function.trader-exp.php'>French</option>
            <option value='it/function.trader-exp.php'>Italian</option>
            <option value='ja/function.trader-exp.php'>Japanese</option>
            <option value='pt_BR/function.trader-exp.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-exp.php'>Russian</option>
            <option value='tr/function.trader-exp.php'>Turkish</option>
            <option value='uk/function.trader-exp.php'>Ukrainian</option>
            <option value='zh/function.trader-exp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-exp" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_exp</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_exp</span> &mdash; <span class="dc-title">Vector Arithmetic Exp</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-exp-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_exp</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   Calculates <strong><code>e</code></strong> raised to the power of each value in <code class="parameter">real</code>. Returns an array with the calculated data.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.trader-exp-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-exp-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-exp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-exp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-exp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-exp.php">＋<small>add a note</small></a></span>
