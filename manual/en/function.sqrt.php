...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sqrt.php">
 <link rel="shorturl" href="https://www.php.net/sqrt">
 <link rel="alternate" href="https://www.php.net/sqrt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.math.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sinh.php">
 <link rel="next" href="https://www.php.net/manual/en/function.tan.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sqrt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sqrt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sqrt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sqrt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sqrt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sqrt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sqrt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sqrt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sqrt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sqrt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sqrt.php" hreflang="zh">
...
<meta name="Description" content="Square root" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sqrt - Manual" />
<meta name="twitter:description" content="Square root" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sqrt - Manual" />
<meta itemprop="description" content="Square root" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Square root" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sqrt.php' selected="selected">English</option>
            <option value='de/function.sqrt.php'>German</option>
            <option value='es/function.sqrt.php'>Spanish</option>
            <option value='fr/function.sqrt.php'>French</option>
            <option value='it/function.sqrt.php'>Italian</option>
            <option value='ja/function.sqrt.php'>Japanese</option>
            <option value='pt_BR/function.sqrt.php'>Brazilian Portuguese</option>
            <option value='ru/function.sqrt.php'>Russian</option>
            <option value='tr/function.sqrt.php'>Turkish</option>
            <option value='uk/function.sqrt.php'>Ukrainian</option>
            <option value='zh/function.sqrt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sqrt" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sqrt</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">sqrt</span> &mdash; <span class="dc-title">Square root</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.sqrt-description">
  ...
  <p class="para rdfs-comment">
   Returns the square root of <code class="parameter">num</code>.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sqrt-returnvalues">
  ...
  <p class="para">
   The square root of <code class="parameter">num</code>
   or the special value <strong><code><a href="math.constants.php#constant.nan">NAN</a></code></strong> for negative numbers.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.sqrt-examples">
  ...
  <p class="para">
   <div class="example" id="example-3395">
    <p><strong>Example #1 <span class="function"><strong>sqrt()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><strong><code><a href="math.constants.php#constant.m-sqrt1-2">M_SQRT1_2</a></code></strong> - <code class="code">1/sqrt(2)</code></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/math/functions/sqrt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sqrt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sqrt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqrt.php">＋<small>add a note</small></a></span>
