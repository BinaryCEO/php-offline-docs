...
<head>
  ...
  <title>PHP: pspell_store_replacement - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pspell-store-replacement.php">
 <link rel="shorturl" href="https://www.php.net/pspell-store-replacement">
 <link rel="alternate" href="https://www.php.net/pspell-store-replacement" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pspell.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pspell-save-wordlist.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pspell-suggest.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pspell-store-replacement.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pspell-store-replacement.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pspell-store-replacement.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pspell-store-replacement.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pspell-store-replacement.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pspell-store-replacement.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pspell-store-replacement.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pspell-store-replacement.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pspell-store-replacement.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pspell-store-replacement.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pspell-store-replacement.php" hreflang="zh">
...
<meta name="Description" content="Store a replacement pair for a word" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pspell_store_replacement - Manual" />
<meta name="twitter:description" content="Store a replacement pair for a word" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pspell_store_replacement - Manual" />
<meta itemprop="description" content="Store a replacement pair for a word" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Store a replacement pair for a word" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pspell-suggest.php">
          pspell_suggest &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pspell-save-wordlist.php">
          &laquo; pspell_save_wordlist        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pspell-store-replacement.php' selected="selected">English</option>
            <option value='de/function.pspell-store-replacement.php'>German</option>
            <option value='es/function.pspell-store-replacement.php'>Spanish</option>
            <option value='fr/function.pspell-store-replacement.php'>French</option>
            <option value='it/function.pspell-store-replacement.php'>Italian</option>
            <option value='ja/function.pspell-store-replacement.php'>Japanese</option>
            <option value='pt_BR/function.pspell-store-replacement.php'>Brazilian Portuguese</option>
            <option value='ru/function.pspell-store-replacement.php'>Russian</option>
            <option value='tr/function.pspell-store-replacement.php'>Turkish</option>
            <option value='uk/function.pspell-store-replacement.php'>Ukrainian</option>
            <option value='zh/function.pspell-store-replacement.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pspell-store-replacement" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pspell_store_replacement</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pspell_store_replacement</span> &mdash; <span class="dc-title">Store a replacement pair for a word</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pspell-store-replacement-description">
  ...
  <p class="simpara">
   <span class="function"><strong>pspell_store_replacement()</strong></span> stores a replacement pair for
   a word, so that replacement can be returned by
   <span class="function"><a href="function.pspell-suggest.php" class="function">pspell_suggest()</a></span> later. In order to be able to take
   advantage of this function, you have to use
   <span class="function"><a href="function.pspell-new-personal.php" class="function">pspell_new_personal()</a></span> to open the dictionary. In order
   to permanently save the replacement pair, you have to
   use <span class="function"><a href="function.pspell-config-personal.php" class="function">pspell_config_personal()</a></span> and
   <span class="function"><a href="function.pspell-config-repl.php" class="function">pspell_config_repl()</a></span> to set the path where to save your
   custom wordlists, and then use <span class="function"><a href="function.pspell-save-wordlist.php" class="function">pspell_save_wordlist()</a></span>
 ...
 <div class="refsect1 parameters" id="refsect1-function.pspell-store-replacement-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The fixed spelling for the <code class="parameter">misspelled</code> word.
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.pspell-store-replacement-examples">
  ...
  <p class="para">
   <div class="example" id="example-2808">
    <p><strong>Example #1 <span class="function"><strong>pspell_store_replacement()</strong></span></strong></p>
   ...
   <p class="para">
    ...
    or later.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pspell/functions/pspell-store-replacement.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pspell-store-replacement%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pspell-store-replacement&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pspell-store-replacement.php">＋<small>add a note</small></a></span>
