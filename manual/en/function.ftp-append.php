...
<head>
  ...
  <title>PHP: ftp_append - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ftp-append.php">
 <link rel="shorturl" href="https://www.php.net/ftp-append">
 <link rel="alternate" href="https://www.php.net/ftp-append" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ftp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ftp-alloc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ftp-cdup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ftp-append.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ftp-append.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ftp-append.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ftp-append.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ftp-append.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ftp-append.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ftp-append.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ftp-append.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ftp-append.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ftp-append.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ftp-append.php" hreflang="zh">
...
<meta name="Description" content="Append the contents of a file to another file on the FTP server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ftp_append - Manual" />
<meta name="twitter:description" content="Append the contents of a file to another file on the FTP server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ftp_append - Manual" />
<meta itemprop="description" content="Append the contents of a file to another file on the FTP server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Append the contents of a file to another file on the FTP server" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ftp-append.php' selected="selected">English</option>
            <option value='de/function.ftp-append.php'>German</option>
            <option value='es/function.ftp-append.php'>Spanish</option>
            <option value='fr/function.ftp-append.php'>French</option>
            <option value='it/function.ftp-append.php'>Italian</option>
            <option value='ja/function.ftp-append.php'>Japanese</option>
            <option value='pt_BR/function.ftp-append.php'>Brazilian Portuguese</option>
            <option value='ru/function.ftp-append.php'>Russian</option>
            <option value='tr/function.ftp-append.php'>Turkish</option>
            <option value='uk/function.ftp-append.php'>Ukrainian</option>
            <option value='zh/function.ftp-append.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ftp-append" class="refentry">
 ...
 <td>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ftp/functions/ftp-append.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ftp-append%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ftp-append&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ftp-append.php">＋<small>add a note</small></a></span>
