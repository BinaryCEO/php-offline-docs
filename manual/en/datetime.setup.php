...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/datetime.setup.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/datetime.setup.php">
 <link rel="alternate" href="https://www.php.net/manual/en/datetime.setup.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.datetime.php">
 <link rel="next" href="https://www.php.net/manual/en/datetime.installation.php">

 <link rel="alternate" href="https://www.php.net/manual/en/datetime.setup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/datetime.setup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/datetime.setup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/datetime.setup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/datetime.setup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/datetime.setup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/datetime.setup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/datetime.setup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/datetime.setup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/datetime.setup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/datetime.setup.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/datetime.setup.php' selected="selected">English</option>
            <option value='de/datetime.setup.php'>German</option>
            <option value='es/datetime.setup.php'>Spanish</option>
            <option value='fr/datetime.setup.php'>French</option>
            <option value='it/datetime.setup.php'>Italian</option>
            <option value='ja/datetime.setup.php'>Japanese</option>
            <option value='pt_BR/datetime.setup.php'>Brazilian Portuguese</option>
            <option value='ru/datetime.setup.php'>Russian</option>
            <option value='tr/datetime.setup.php'>Turkish</option>
            <option value='uk/datetime.setup.php'>Ukrainian</option>
            <option value='zh/datetime.setup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="datetime.setup" class="chapter">
 <h1 class="title">Installing/Configuring</h1>
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="datetime.installation.php">Installation</a></li><li><a href="datetime.configuration.php">Runtime Configuration</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/setup.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdatetime.setup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=datetime.setup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/datetime.setup.php">＋<small>add a note</small></a></span>
