...
<head>
  ...
  <title>PHP: Imagick::subImageMatch - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.subimagematch.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.subimagematch.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.subimagematch.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.stripimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.swirlimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.subimagematch.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.subimagematch.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.subimagematch.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.subimagematch.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.subimagematch.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.subimagematch.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.subimagematch.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.subimagematch.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.subimagematch.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.subimagematch.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.subimagematch.php" hreflang="zh">
...
<meta name="Description" content="Searches for a subimage in the current image and returns a similarity image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::subImageMatch - Manual" />
<meta name="twitter:description" content="Searches for a subimage in the current image and returns a similarity image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::subImageMatch - Manual" />
<meta itemprop="description" content="Searches for a subimage in the current image and returns a similarity image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Searches for a subimage in the current image and returns a similarity image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.swirlimage.php">
          Imagick::swirlImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.stripimage.php">
          &laquo; Imagick::stripImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.subimagematch.php' selected="selected">English</option>
            <option value='de/imagick.subimagematch.php'>German</option>
            <option value='es/imagick.subimagematch.php'>Spanish</option>
            <option value='fr/imagick.subimagematch.php'>French</option>
            <option value='it/imagick.subimagematch.php'>Italian</option>
            <option value='ja/imagick.subimagematch.php'>Japanese</option>
            <option value='pt_BR/imagick.subimagematch.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.subimagematch.php'>Russian</option>
            <option value='tr/imagick.subimagematch.php'>Turkish</option>
            <option value='uk/imagick.subimagematch.php'>Ukrainian</option>
            <option value='zh/imagick.subimagematch.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.subimagematch" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.subimagematch-examples">
  ...
  <p class="para">
    <div class="example" id="example-3128">
      <p><strong>Example #1  <span class="function"><strong>Imagick::subImageMatch()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/subimagematch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.subimagematch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.subimagematch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.subimagematch.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126375">  <div class="votes">
    <div id="Vu126375">
    <a href="/manual/vote-note.php?id=126375&amp;page=imagick.subimagematch&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126375">
    <a href="/manual/vote-note.php?id=126375&amp;page=imagick.subimagematch&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126375" title="no votes...">
    0
    </div>
  </div>
  <a href="#126375" class="name">
  <strong class="user"><em>inipel at ya dot ru</em></strong></a><a class="genanchor" href="#126375"> &para;</a><div class="date" title="2021-08-31 12:01"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126375">
<div class="phpcode"><code><span class="html">After $ im-&gt;cropImage method, $ im-&gt;subImageMatch doesn't work, before using $ im-&gt;subImageMatch, use $ im-&gt;setImagePage(0, 0, 0, 0);<br /><br />The sequence is as follows:<br />$ im-&gt;cropImage();<br />$ im-&gt;setImagePage (0, 0, 0, 0);<br />$ im-&gt;subImageMatch()</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.subimagematch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.subimagematch.php">＋<small>add a note</small></a></div>
