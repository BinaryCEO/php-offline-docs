...
<head>
  ...
  <title>PHP: __PHP_Incomplete_Class - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.php-incomplete-class.php">
 <link rel="shorturl" href="https://www.php.net/php-incomplete-class">
 <link rel="alternate" href="https://www.php.net/php-incomplete-class" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.interfaces.php">
 <link rel="prev" href="https://www.php.net/manual/en/sensitiveparametervalue.getvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/reserved.attributes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.php-incomplete-class.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.php-incomplete-class.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.php-incomplete-class.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.php-incomplete-class.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.php-incomplete-class.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.php-incomplete-class.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.php-incomplete-class.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.php-incomplete-class.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.php-incomplete-class.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.php-incomplete-class.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.php-incomplete-class.php" hreflang="zh">
...
<meta name="Description" content="The __PHP_Incomplete_Class class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: __PHP_Incomplete_Class - Manual" />
<meta name="twitter:description" content="The __PHP_Incomplete_Class class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: __PHP_Incomplete_Class - Manual" />
<meta itemprop="description" content="The __PHP_Incomplete_Class class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The __PHP_Incomplete_Class class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reserved.attributes.php">
          Predefined Attributes &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="sensitiveparametervalue.getvalue.php">
          &laquo; SensitiveParameterValue::getValue        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.php-incomplete-class.php' selected="selected">English</option>
            <option value='de/class.php-incomplete-class.php'>German</option>
            <option value='es/class.php-incomplete-class.php'>Spanish</option>
            <option value='fr/class.php-incomplete-class.php'>French</option>
            <option value='it/class.php-incomplete-class.php'>Italian</option>
            <option value='ja/class.php-incomplete-class.php'>Japanese</option>
            <option value='pt_BR/class.php-incomplete-class.php'>Brazilian Portuguese</option>
            <option value='ru/class.php-incomplete-class.php'>Russian</option>
            <option value='tr/class.php-incomplete-class.php'>Turkish</option>
            <option value='uk/class.php-incomplete-class.php'>Ukrainian</option>
            <option value='zh/class.php-incomplete-class.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.php-incomplete-class" class="reference">
  ...
  string(16) &quot;MyUndefinedClass&quot;
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/php-incomplete-class.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.php-incomplete-class%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.php-incomplete-class&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.php-incomplete-class.php">＋<small>add a note</small></a></span>
