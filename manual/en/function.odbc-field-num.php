...
<head>
  ...
  <title>PHP: odbc_field_num - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-field-num.php">
 <link rel="shorturl" href="https://www.php.net/odbc-field-num">
 <link rel="alternate" href="https://www.php.net/odbc-field-num" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-field-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-field-precision.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-field-num.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-field-num.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-field-num.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-field-num.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-field-num.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-field-num.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-field-num.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-field-num.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-field-num.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-field-num.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-field-num.php" hreflang="zh">
...
<meta name="Description" content="Return column number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_field_num - Manual" />
<meta name="twitter:description" content="Return column number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_field_num - Manual" />
<meta itemprop="description" content="Return column number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return column number" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.odbc-field-precision.php">
          odbc_field_precision &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-field-name.php">
          &laquo; odbc_field_name        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-field-num.php' selected="selected">English</option>
            <option value='de/function.odbc-field-num.php'>German</option>
            <option value='es/function.odbc-field-num.php'>Spanish</option>
            <option value='fr/function.odbc-field-num.php'>French</option>
            <option value='it/function.odbc-field-num.php'>Italian</option>
            <option value='ja/function.odbc-field-num.php'>Japanese</option>
            <option value='pt_BR/function.odbc-field-num.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-field-num.php'>Russian</option>
            <option value='tr/function.odbc-field-num.php'>Turkish</option>
            <option value='uk/function.odbc-field-num.php'>Ukrainian</option>
            <option value='zh/function.odbc-field-num.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-field-num" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-field-num-returnvalues">
  ...
  <p class="para">
   Returns the field number as a integer, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
 ...
 <td>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-field-num.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-field-num%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-field-num&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-field-num.php">＋<small>add a note</small></a></span>
