...
<head>
  ...
  <title>PHP: SolrQuery::setTermsLimit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.settermslimit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.settermslimit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermslimit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.settermsincludeupperbound.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.settermslowerbound.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermslimit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.settermslimit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.settermslimit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.settermslimit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.settermslimit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.settermslimit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.settermslimit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.settermslimit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.settermslimit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.settermslimit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.settermslimit.php" hreflang="zh">
...
<meta name="Description" content="Sets the maximum number of terms to return" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setTermsLimit - Manual" />
<meta name="twitter:description" content="Sets the maximum number of terms to return" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setTermsLimit - Manual" />
<meta itemprop="description" content="Sets the maximum number of terms to return" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the maximum number of terms to return" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.settermslowerbound.php">
          SolrQuery::setTermsLowerBound &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.settermsincludeupperbound.php">
          &laquo; SolrQuery::setTermsIncludeUpperBound        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.settermslimit.php' selected="selected">English</option>
            <option value='de/solrquery.settermslimit.php'>German</option>
            <option value='es/solrquery.settermslimit.php'>Spanish</option>
            <option value='fr/solrquery.settermslimit.php'>French</option>
            <option value='it/solrquery.settermslimit.php'>Italian</option>
            <option value='ja/solrquery.settermslimit.php'>Japanese</option>
            <option value='pt_BR/solrquery.settermslimit.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.settermslimit.php'>Russian</option>
            <option value='tr/solrquery.settermslimit.php'>Turkish</option>
            <option value='uk/solrquery.settermslimit.php'>Ukrainian</option>
            <option value='zh/solrquery.settermslimit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.settermslimit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setTermsLimit</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setTermsLimit</span> &mdash; <span class="dc-title">Sets the maximum number of terms to return</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.settermslimit-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setTermsLimit</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$limit</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.settermslimit-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.settermslimit-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/settermslimit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.settermslimit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.settermslimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.settermslimit.php">＋<small>add a note</small></a></span>
