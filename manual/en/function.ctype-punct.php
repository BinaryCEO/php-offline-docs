...
<head>
  ...
  <title>PHP: ctype_punct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ctype-punct.php">
 <link rel="shorturl" href="https://www.php.net/ctype-punct">
 <link rel="alternate" href="https://www.php.net/ctype-punct" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ctype.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ctype-print.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ctype-space.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ctype-punct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ctype-punct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ctype-punct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ctype-punct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ctype-punct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ctype-punct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ctype-punct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ctype-punct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ctype-punct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ctype-punct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ctype-punct.php" hreflang="zh">
...
<meta name="Description" content="Check for any printable character which is not whitespace or an
   alphanumeric character" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ctype_punct - Manual" />
<meta name="twitter:description" content="Check for any printable character which is not whitespace or an
   alphanumeric character" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ctype_punct - Manual" />
<meta itemprop="description" content="Check for any printable character which is not whitespace or an
   alphanumeric character" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check for any printable character which is not whitespace or an
   alphanumeric character" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ctype-space.php">
          ctype_space &raquo;
              ...
              <div class="prev">
        <a href="function.ctype-print.php">
          &laquo; ctype_print        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ctype-punct.php' selected="selected">English</option>
            <option value='de/function.ctype-punct.php'>German</option>
            <option value='es/function.ctype-punct.php'>Spanish</option>
            <option value='fr/function.ctype-punct.php'>French</option>
            <option value='it/function.ctype-punct.php'>Italian</option>
            <option value='ja/function.ctype-punct.php'>Japanese</option>
            <option value='pt_BR/function.ctype-punct.php'>Brazilian Portuguese</option>
            <option value='ru/function.ctype-punct.php'>Russian</option>
            <option value='tr/function.ctype-punct.php'>Turkish</option>
            <option value='uk/function.ctype-punct.php'>Ukrainian</option>
            <option value='zh/function.ctype-punct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ctype-punct" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ctype_punct</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ctype_punct</span> &mdash; <span class="dc-title">
 ...
 <div class="refsect1 description" id="refsect1-function.ctype-punct-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ctype_punct</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$text</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">text</code>, are punctuation character.
  </p>
 </div>
...
or an explicit call to <span class="function"><a href="function.chr.php" class="function">chr()</a></span> should be made.</p></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ctype-punct-returnvalues">
  ...
  <p class="para">
   ...
   is printable, but neither letter, digit or blank, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
...
<div class="examplescode"><pre class="examplescode">The string ABasdk!@!$# does not consist of all punctuation.
 ...
 <div class="refsect1 seealso" id="refsect1-function.ctype-punct-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.ispunct.php" class="function" rel="rdfs-seeAlso">IntlChar::ispunct()</a> - Check if code point is punctuation character</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ctype/functions/ctype-punct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ctype-punct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ctype-punct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ctype-punct.php">＋<small>add a note</small></a></span>
