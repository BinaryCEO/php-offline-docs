...
<head>
  ...
  <title>PHP: UI\Controls\Form - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-controls-form.php">
 <link rel="shorturl" href="https://www.php.net/ui-controls-form">
 <link rel="alternate" href="https://www.php.net/ui-controls-form" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-controls-picker.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-controls-form.append.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-controls-form.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-controls-form.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-controls-form.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-controls-form.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-controls-form.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-controls-form.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-controls-form.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-controls-form.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-controls-form.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-controls-form.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-controls-form.php" hreflang="zh">
...
<meta name="Description" content="Control Form (Arrangement)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Controls\Form - Manual" />
<meta name="twitter:description" content="Control Form (Arrangement)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Controls\Form - Manual" />
<meta itemprop="description" content="Control Form (Arrangement)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Control Form (Arrangement)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ui-controls-form.append.php">
          UI\Controls\Form::append &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-controls-picker.construct.php">
          &laquo; UI\Controls\Picker::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-controls-form.php' selected="selected">English</option>
            <option value='de/class.ui-controls-form.php'>German</option>
            <option value='es/class.ui-controls-form.php'>Spanish</option>
            <option value='fr/class.ui-controls-form.php'>French</option>
            <option value='it/class.ui-controls-form.php'>Italian</option>
            <option value='ja/class.ui-controls-form.php'>Japanese</option>
            <option value='pt_BR/class.ui-controls-form.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-controls-form.php'>Russian</option>
            <option value='tr/class.ui-controls-form.php'>Turkish</option>
            <option value='uk/class.ui-controls-form.php'>Ukrainian</option>
            <option value='zh/class.ui-controls-form.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-controls-form" class="reference">

 <h1 class="title">Control Form (Arrangement)</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-controls-form.intro">
  ...
  <div class="section" id="ui-controls-form.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Controls\Form</strong>
     </span>
    ...
    <div class="fieldsynopsis">
     <span class="modifier">protected</span>
      <var class="varname"><a href="class.ui-controls-form.php#ui-controls-form.props.controls">$<var class="varname">controls</var></a></var>;</div>

    
    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><a href="ui-controls-form.append.php" class="methodname">append</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$label</code></span>, <span class="methodparam"><span class="type"><a href="class.ui-control.php" class="type UI\Control">UI\Control</a></span> <code class="parameter">$control</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$stretchy</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-form.delete.php" class="methodname">delete</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-form.ispadded.php" class="methodname">isPadded</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-form.setpadded.php" class="methodname">setPadded</a></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$padded</code></span>)</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-control.show.php" class="methodname">UI\Control::show</a></span>()</div>
  ...
  <div class="section" id="ui-controls-form.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="ui-controls-form.props.controls"><var class="varname">controls</var></dt>
     <dd>
      <p class="para">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-controls-form.append.php">UI\Controls\Form::append</a> — Append Control</li><li><a href="ui-controls-form.delete.php">UI\Controls\Form::delete</a> — Delete Control</li><li><a href="ui-controls-form.ispadded.php">UI\Controls\Form::isPadded</a> — Padding Detection</li><li><a href="ui-controls-form.setpadded.php">UI\Controls\Form::setPadded</a> — Set Padding</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.controls.form.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-controls-form%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-controls-form&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-controls-form.php">＋<small>add a note</small></a></span>
