...
<head>
  ...
  <title>PHP: Dom\Notation - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-notation.php">
 <link rel="shorturl" href="https://www.php.net/dom-notation">
 <link rel="alternate" href="https://www.php.net/dom-notation" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-nodelist.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-parentnode.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-notation.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-notation.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-notation.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-notation.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-notation.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-notation.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-notation.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-notation.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-notation.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-notation.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-notation.php" hreflang="zh">
...
<meta name="Description" content="The Dom\Notation class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\Notation - Manual" />
<meta name="twitter:description" content="The Dom\Notation class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\Notation - Manual" />
<meta itemprop="description" content="The Dom\Notation class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\Notation class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.dom-parentnode.php">
          Dom\ParentNode &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dom-nodelist.php">
          &laquo; Dom\NodeList        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-notation.php' selected="selected">English</option>
            <option value='de/class.dom-notation.php'>German</option>
            <option value='es/class.dom-notation.php'>Spanish</option>
            <option value='fr/class.dom-notation.php'>French</option>
            <option value='it/class.dom-notation.php'>Italian</option>
            <option value='ja/class.dom-notation.php'>Japanese</option>
            <option value='pt_BR/class.dom-notation.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-notation.php'>Russian</option>
            <option value='tr/class.dom-notation.php'>Turkish</option>
            <option value='uk/class.dom-notation.php'>Ukrainian</option>
            <option value='zh/class.dom-notation.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-notation" class="reference">
 <h1 class="title">The Dom\Notation class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-notation.synopsis">
   <h2 class="title">Class synopsis</h2>
   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\Notation</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-notation.php#dom-notation.props.publicid">$<var class="varname">publicId</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-notation.php#dom-notation.props.systemid">$<var class="varname">systemId</var></a></var>;</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
  ...
  <div class="section" id="dom-notation.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-notation.props.publicid"><var class="varname">publicId</var></dt><dd>
      <span class="simpara">The public identifier associated with the notation.</span>
     </dd>
    
    
     <dt id="dom-notation.props.systemid"><var class="varname">systemId</var></dt><dd>
      <span class="simpara">The system identifier associated with the notation.</span>
     </dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-notation.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-notation%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-notation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-notation.php">＋<small>add a note</small></a></span>
