...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-module-open.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-module-is-block-mode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-module-self-test.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-module-open.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-module-open.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-module-open.php" hreflang="uk">
...
<meta name="Description" content="Opens the module of the algorithm and the mode to be used" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_module_open - Manual" />
<meta name="twitter:description" content="Opens the module of the algorithm and the mode to be used" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_module_open - Manual" />
<meta itemprop="description" content="Opens the module of the algorithm and the mode to be used" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Opens the module of the algorithm and the mode to be used" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-module-open.php' selected="selected">English</option>
            ...
            <option value='ru/function.mcrypt-module-open.php'>Russian</option>
            <option value='tr/function.mcrypt-module-open.php'>Turkish</option>
            <option value='uk/function.mcrypt-module-open.php'>Ukrainian</option>
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 examples" id="refsect1-function.mcrypt-module-open-examples">
  ...
  <p class="para">
   <div class="example" id="example-1002">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mcrypt-generic-deinit.php" class="function" rel="rdfs-seeAlso">mcrypt_generic_deinit()</a> - This function deinitializes an encryption module</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-module-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-module-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-module-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-module-open.php">＋<small>add a note</small></a></span>
