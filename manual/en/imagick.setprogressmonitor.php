...
<head>
  ...
  <title>PHP: Imagick::setProgressMonitor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setprogressmonitor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setprogressmonitor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setprogressmonitor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setpointsize.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setregistry.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setprogressmonitor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setprogressmonitor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setprogressmonitor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setprogressmonitor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setprogressmonitor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setprogressmonitor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setprogressmonitor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setprogressmonitor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setprogressmonitor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setprogressmonitor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setprogressmonitor.php" hreflang="zh">
...
<meta name="Description" content="Set a callback to be called during processing" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setProgressMonitor - Manual" />
<meta name="twitter:description" content="Set a callback to be called during processing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setProgressMonitor - Manual" />
<meta itemprop="description" content="Set a callback to be called during processing" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set a callback to be called during processing" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setregistry.php">
          Imagick::setRegistry &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setpointsize.php">
          &laquo; Imagick::setPointSize        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setprogressmonitor.php' selected="selected">English</option>
            <option value='de/imagick.setprogressmonitor.php'>German</option>
            <option value='es/imagick.setprogressmonitor.php'>Spanish</option>
            <option value='fr/imagick.setprogressmonitor.php'>French</option>
            <option value='it/imagick.setprogressmonitor.php'>Italian</option>
            <option value='ja/imagick.setprogressmonitor.php'>Japanese</option>
            <option value='pt_BR/imagick.setprogressmonitor.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setprogressmonitor.php'>Russian</option>
            <option value='tr/imagick.setprogressmonitor.php'>Turkish</option>
            <option value='uk/imagick.setprogressmonitor.php'>Ukrainian</option>
            <option value='zh/imagick.setprogressmonitor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setprogressmonitor" class="refentry">
    ...
    <dd>
     ...
     <div class="methodsynopsis dc-description">
      <span class="methodname">
       ...
       <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$offset</code>
      </span>, <span class="methodparam">
       
       <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$span</code>
  ...
  <p class="para">
    <div class="example" id="example-3108">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setprogressmonitor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setprogressmonitor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setprogressmonitor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setprogressmonitor.php">＋<small>add a note</small></a></span>
