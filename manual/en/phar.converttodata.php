...
<head>
  ...
  <title>PHP: Phar::convertToData - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.converttodata.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.converttodata.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.converttodata.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.converttoexecutable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.converttodata.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.converttodata.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.converttodata.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.converttodata.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.converttodata.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.converttodata.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.converttodata.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.converttodata.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.converttodata.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.converttodata.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.converttodata.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.converttoexecutable.php">
          Phar::convertToExecutable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.construct.php">
          &laquo; Phar::__construct        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.converttodata.php' selected="selected">English</option>
            <option value='de/phar.converttodata.php'>German</option>
            <option value='es/phar.converttodata.php'>Spanish</option>
            <option value='fr/phar.converttodata.php'>French</option>
            <option value='it/phar.converttodata.php'>Italian</option>
            <option value='ja/phar.converttodata.php'>Japanese</option>
            <option value='pt_BR/phar.converttodata.php'>Brazilian Portuguese</option>
            <option value='ru/phar.converttodata.php'>Russian</option>
            <option value='tr/phar.converttodata.php'>Turkish</option>
            <option value='uk/phar.converttodata.php'>Ukrainian</option>
            <option value='zh/phar.converttodata.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.converttodata" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-phar.converttodata-examples">
  ...
  <p class="para">
   <div class="example" id="example-809">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phardata.converttodata.php" class="function" rel="rdfs-seeAlso">PharData::convertToData()</a> - Convert a phar archive to a non-executable tar or zip file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/convertToData.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.converttodata%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.converttodata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.converttodata.php">＋<small>add a note</small></a></span>
