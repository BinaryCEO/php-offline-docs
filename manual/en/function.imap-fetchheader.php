...
<head>
  ...
  <title>PHP: imap_fetchheader - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-fetchheader.php">
 <link rel="shorturl" href="https://www.php.net/imap-fetchheader">
 <link rel="alternate" href="https://www.php.net/imap-fetchheader" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-fetchbody.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-fetchmime.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-fetchheader.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-fetchheader.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-fetchheader.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-fetchheader.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-fetchheader.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-fetchheader.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-fetchheader.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-fetchheader.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-fetchheader.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-fetchheader.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-fetchheader.php" hreflang="zh">
...
<meta name="Description" content="Returns header for a message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_fetchheader - Manual" />
<meta name="twitter:description" content="Returns header for a message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_fetchheader - Manual" />
<meta itemprop="description" content="Returns header for a message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns header for a message" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-fetchmime.php">
          imap_fetchmime &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-fetchbody.php">
          &laquo; imap_fetchbody        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-fetchheader.php' selected="selected">English</option>
            <option value='de/function.imap-fetchheader.php'>German</option>
            <option value='es/function.imap-fetchheader.php'>Spanish</option>
            <option value='fr/function.imap-fetchheader.php'>French</option>
            <option value='it/function.imap-fetchheader.php'>Italian</option>
            <option value='ja/function.imap-fetchheader.php'>Japanese</option>
            <option value='pt_BR/function.imap-fetchheader.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-fetchheader.php'>Russian</option>
            <option value='tr/function.imap-fetchheader.php'>Turkish</option>
            <option value='uk/function.imap-fetchheader.php'>Ukrainian</option>
            <option value='zh/function.imap-fetchheader.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-fetchheader" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_fetchheader</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_fetchheader</span> &mdash; <span class="dc-title">Returns header for a message</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.imap-fetchheader-description">
  ...
  <p class="para rdfs-comment">
   This function causes a fetch of the complete, unfiltered <a href="https://datatracker.ietf.org/doc/html/rfc2822" class="link external">&raquo;&nbsp;RFC2822</a> format header of the specified
   message.
  </p>
 </div>
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
     ...
     <dd>
      <p class="para">
       The possible <code class="parameter">flags</code> are:
       <ul class="itemizedlist">
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.ft-uid">FT_UID</a></code></strong> - The <code class="parameter">message_num</code>
          argument is a UID
         </span>
        </li>
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.ft-internal">FT_INTERNAL</a></code></strong> - The return string
        ...
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.ft-prefetchtext">FT_PREFETCHTEXT</a></code></strong> - The RFC822.TEXT
          should be pre-fetched at the same time.  This avoids an
          extra RTT on an <abbr title="Internet Message Access Protocol">IMAP</abbr> connection if a full message text is
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-fetchheader-returnvalues">
  ...
  <p class="para">
   Returns the header of the specified message as a text string,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-fetch-overview.php" class="function" rel="rdfs-seeAlso">imap_fetch_overview()</a> - Read an overview of the information in the headers of the given message</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-fetchheader.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-fetchheader%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-fetchheader&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-fetchheader.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="98584">  <div class="votes">
    <div id="Vu98584">
    <a href="/manual/vote-note.php?id=98584&amp;page=function.imap-fetchheader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98584">
    <a href="/manual/vote-note.php?id=98584&amp;page=function.imap-fetchheader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98584" title="62% like this...">
    7
    </div>
  </div>
  <a href="#98584" class="name">
  <strong class="user"><em>rgagnon24 dot nospam at gmail dot com</em></strong></a><a class="genanchor" href="#98584"> &para;</a><div class="date" title="2010-06-24 09:52"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98584">
<div class="phpcode"><code><span class="html">Interesting that imap_headerinfo() does not allow a UID for the $msg_number field like all other fetching functions seem to allow.
<br />
<br />If you want to use a UID to fetch the headers, use this two-step process:
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="comment">/*
<br /> * assumes $mbox is your stream, and $uid is set 
<br /> * properly. Proper error checking is up to you.
<br /> */
<br /></span><span class="default">$hText </span><span class="keyword">= </span><span class="default">imap_fetchbody</span><span class="keyword">(</span><span class="default">$mbox</span><span class="keyword">, </span><span class="default">$uid</span><span class="keyword">, </span><span class="string">'0'</span><span class="keyword">, </span><span class="default">FT_UID</span><span class="keyword">);
<br /></span><span class="default">$headers </span><span class="keyword">= </span><span class="default">imap_rfc822_parse_headers</span><span class="keyword">(</span><span class="default">$hText</span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>
<br />The result is the same as the output of imap_headerinfo(), but you get to use the UID.</span></code></div>
  </div>
 </div>
  <div class="note" id="82339">  <div class="votes">
    <div id="Vu82339">
    <a href="/manual/vote-note.php?id=82339&amp;page=function.imap-fetchheader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd82339">
    <a href="/manual/vote-note.php?id=82339&amp;page=function.imap-fetchheader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V82339" title="63% like this...">
    3
    </div>
  </div>
  <a href="#82339" class="name">
  <strong class="user"><em>Jille at nomorecrap dot quis dot cx</em></strong></a><a class="genanchor" href="#82339"> &para;</a><div class="date" title="2008-04-06 03:15"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom82339">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?PHP<br />$headers</span><span class="keyword">=</span><span class="default">imap_fetchheader</span><span class="keyword">(</span><span class="default">$imap</span><span class="keyword">, </span><span class="default">$msgid</span><span class="keyword">);<br /></span><span class="default">preg_match_all</span><span class="keyword">(</span><span class="string">'/([^: ]+): (.+?(?:\r\n\s(?:.+?))*)\r\n/m'</span><span class="keyword">, </span><span class="default">$headers</span><span class="keyword">, </span><span class="default">$matches</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Works quite well for splitting headers,<br />$matches will contain 3 arrays:<br />$matches[0] are the full-lines (To: Jille@devnull.quis.cx\r\n)<br />$matches[1] will be the header (To)<br />$matches[2] will be the value (Jille@devnull.quis.cx)<br /><br />In multi-line values the 'multilining is not stripped!'<br />this could be achieved with something like:<br /><span class="default">&lt;?PHP<br />preg_replace</span><span class="keyword">(</span><span class="string">'/\r\n\s+/m'</span><span class="keyword">, </span><span class="string">''</span><span class="keyword">, </span><span class="default">$matches</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">]);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-fetchheader&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-fetchheader.php">＋<small>add a note</small></a></div>
