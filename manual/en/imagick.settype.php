...
<head>
  ...
  <title>PHP: Imagick::setType - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.settype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.settype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.settype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setsizeoffset.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.shadeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.settype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.settype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.settype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.settype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.settype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.settype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.settype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.settype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.settype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.settype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.settype.php" hreflang="zh">
...
<meta name="Description" content="Sets the image type attribute" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setType - Manual" />
<meta name="twitter:description" content="Sets the image type attribute" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setType - Manual" />
<meta itemprop="description" content="Sets the image type attribute" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image type attribute" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.shadeimage.php">
          Imagick::shadeImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setsizeoffset.php">
          &laquo; Imagick::setSizeOffset        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.settype.php' selected="selected">English</option>
            <option value='de/imagick.settype.php'>German</option>
            <option value='es/imagick.settype.php'>Spanish</option>
            <option value='fr/imagick.settype.php'>French</option>
            <option value='it/imagick.settype.php'>Italian</option>
            <option value='ja/imagick.settype.php'>Japanese</option>
            <option value='pt_BR/imagick.settype.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.settype.php'>Russian</option>
            <option value='tr/imagick.settype.php'>Turkish</option>
            <option value='uk/imagick.settype.php'>Ukrainian</option>
            <option value='zh/imagick.settype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.settype" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setType</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setType</span> &mdash; <span class="dc-title">Sets the image type attribute</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.settype-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setType</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$image_type</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.settype-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.settype-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/settype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.settype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.settype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.settype.php">＋<small>add a note</small></a></span>
