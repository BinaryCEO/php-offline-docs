...
<head>
  ...
  <title>PHP: geoip_region_by_name - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.geoip-region-by-name.php">
 <link rel="shorturl" href="https://www.php.net/geoip-region-by-name">
 <link rel="alternate" href="https://www.php.net/geoip-region-by-name" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.geoip.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.geoip-record-by-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.geoip-region-name-by-code.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.geoip-region-by-name.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.geoip-region-by-name.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.geoip-region-by-name.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.geoip-region-by-name.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.geoip-region-by-name.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.geoip-region-by-name.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.geoip-region-by-name.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.geoip-region-by-name.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.geoip-region-by-name.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.geoip-region-by-name.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.geoip-region-by-name.php" hreflang="zh">
...
<meta name="Description" content="Get the country code and region" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: geoip_region_by_name - Manual" />
<meta name="twitter:description" content="Get the country code and region" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: geoip_region_by_name - Manual" />
<meta itemprop="description" content="Get the country code and region" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the country code and region" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.geoip-region-name-by-code.php">
          geoip_region_name_by_code &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.geoip-record-by-name.php">
          &laquo; geoip_record_by_name        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.geoip-region-by-name.php' selected="selected">English</option>
            <option value='de/function.geoip-region-by-name.php'>German</option>
            <option value='es/function.geoip-region-by-name.php'>Spanish</option>
            <option value='fr/function.geoip-region-by-name.php'>French</option>
            <option value='it/function.geoip-region-by-name.php'>Italian</option>
            <option value='ja/function.geoip-region-by-name.php'>Japanese</option>
            <option value='pt_BR/function.geoip-region-by-name.php'>Brazilian Portuguese</option>
            <option value='ru/function.geoip-region-by-name.php'>Russian</option>
            <option value='tr/function.geoip-region-by-name.php'>Turkish</option>
            <option value='uk/function.geoip-region-by-name.php'>Ukrainian</option>
            <option value='zh/function.geoip-region-by-name.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.geoip-region-by-name" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.geoip-region-by-name-examples">
  ...
  <p class="para">
   <div class="example" id="example-3687">
...
(
    ...
    [region] =&gt; CA
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/geoip/functions/geoip-region-by-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.geoip-region-by-name%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.geoip-region-by-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.geoip-region-by-name.php">＋<small>add a note</small></a></span>
