...
<head>
  ...
  <title>PHP: openssl_pkey_get_private - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-pkey-get-private.php">
 <link rel="shorturl" href="https://www.php.net/openssl-pkey-get-private">
 <link rel="alternate" href="https://www.php.net/openssl-pkey-get-private" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-pkey-get-details.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-pkey-get-public.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-pkey-get-private.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-pkey-get-private.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-pkey-get-private.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-pkey-get-private.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-pkey-get-private.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-pkey-get-private.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-pkey-get-private.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-pkey-get-private.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-pkey-get-private.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-pkey-get-private.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-pkey-get-private.php" hreflang="zh">
...
<meta name="Description" content="Get a private key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_pkey_get_private - Manual" />
<meta name="twitter:description" content="Get a private key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_pkey_get_private - Manual" />
<meta itemprop="description" content="Get a private key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get a private key" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-pkey-get-public.php">
          openssl_pkey_get_public &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-pkey-get-details.php">
          &laquo; openssl_pkey_get_details        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-pkey-get-private.php' selected="selected">English</option>
            <option value='de/function.openssl-pkey-get-private.php'>German</option>
            <option value='es/function.openssl-pkey-get-private.php'>Spanish</option>
            <option value='fr/function.openssl-pkey-get-private.php'>French</option>
            <option value='it/function.openssl-pkey-get-private.php'>Italian</option>
            <option value='ja/function.openssl-pkey-get-private.php'>Japanese</option>
            <option value='pt_BR/function.openssl-pkey-get-private.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-pkey-get-private.php'>Russian</option>
            <option value='tr/function.openssl-pkey-get-private.php'>Turkish</option>
            <option value='uk/function.openssl-pkey-get-private.php'>Ukrainian</option>
            <option value='zh/function.openssl-pkey-get-private.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-pkey-get-private" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_pkey_get_private</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_pkey_get_private</span> &mdash; <span class="dc-title">Get a private key</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-pkey-get-private-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>openssl_pkey_get_private()</strong></span> parses
   <code class="parameter">private_key</code> and prepares it for use by other functions.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.openssl-pkey-get-private-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       <code class="parameter">private_key</code> can be one of the following:
       <ol type="1">
        ...
        <li class="listitem"><span class="simpara">A <abbr title="Privacy-Enhanced Mail">PEM</abbr> formatted private key.</span></li>
       </ol>
      </p>
     </dd>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">passphrase</code> is nullable now.
      </td>
     </tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-pkey-get-private.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-pkey-get-private%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-pkey-get-private&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkey-get-private.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114998">  <div class="votes">
    <div id="Vu114998">
    <a href="/manual/vote-note.php?id=114998&amp;page=function.openssl-pkey-get-private&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114998">
    <a href="/manual/vote-note.php?id=114998&amp;page=function.openssl-pkey-get-private&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114998" title="54% like this...">
    15
    </div>
  </div>
  <a href="#114998" class="name">
  <strong class="user"><em>kristof1 at mailbox dot hu</em></strong></a><a class="genanchor" href="#114998"> &para;</a><div class="date" title="2014-05-10 03:34"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114998">
<div class="phpcode"><code><span class="html">It's actually "file://key.pem" when you want to give a relative path using unix systems. It will be three '/' in case of absolute path (e.g "file:///home/username/..."). But this path consists of two '/' originated from "file://" and one '/' from the fact that home is a subfolder of the unix filesystem's root directory ("/home/username/..."). This two part will be concatenated and you will get three '/' characters following each other.<br /><br />So you only have to concatenate "file://" with an existing path string in every case.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-pkey-get-private&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkey-get-private.php">＋<small>add a note</small></a></div>
