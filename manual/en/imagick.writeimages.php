...
<head>
  ...
  <title>PHP: Imagick::writeImages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.writeimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.writeimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.writeimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.writeimagefile.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.writeimagesfile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.writeimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.writeimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.writeimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.writeimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.writeimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.writeimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.writeimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.writeimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.writeimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.writeimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.writeimages.php" hreflang="zh">
...
<meta name="Description" content="Writes an image or image sequence" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::writeImages - Manual" />
<meta name="twitter:description" content="Writes an image or image sequence" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::writeImages - Manual" />
<meta itemprop="description" content="Writes an image or image sequence" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Writes an image or image sequence" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.writeimagesfile.php">
          Imagick::writeImagesFile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.writeimagefile.php">
          &laquo; Imagick::writeImageFile        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.writeimages.php' selected="selected">English</option>
            <option value='de/imagick.writeimages.php'>German</option>
            <option value='es/imagick.writeimages.php'>Spanish</option>
            <option value='fr/imagick.writeimages.php'>French</option>
            <option value='it/imagick.writeimages.php'>Italian</option>
            <option value='ja/imagick.writeimages.php'>Japanese</option>
            <option value='pt_BR/imagick.writeimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.writeimages.php'>Russian</option>
            <option value='tr/imagick.writeimages.php'>Turkish</option>
            <option value='uk/imagick.writeimages.php'>Ukrainian</option>
            <option value='zh/imagick.writeimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.writeimages" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::writeImages</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::writeImages</span> &mdash; <span class="dc-title">Writes an image or image sequence</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.writeimages-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::writeImages</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$adjoin</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.writeimages-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">adjoin</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.writeimages-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/writeimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.writeimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.writeimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.writeimages.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="91465">  <div class="votes">
    <div id="Vu91465">
    <a href="/manual/vote-note.php?id=91465&amp;page=imagick.writeimages&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91465">
    <a href="/manual/vote-note.php?id=91465&amp;page=imagick.writeimages&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91465" title="62% like this...">
    6
    </div>
  </div>
  <a href="#91465" class="name">
  <strong class="user"><em>mbrugue</em></strong></a><a class="genanchor" href="#91465"> &para;</a><div class="date" title="2009-06-11 02:54"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91465">
<div class="phpcode"><code><span class="html">The second parameter spicifies if the object is write in multipage file (true) or split every page in a single file (false).
<br />
<br />Example:
<br />
<br /><span class="default">&lt;?php
<br />$multiTIFF </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();
<br />
<br /></span><span class="default">$files </span><span class="keyword">= </span><span class="default">scandir</span><span class="keyword">(</span><span class="default">$mytifspath</span><span class="keyword">);
<br />    
<br />foreach( </span><span class="default">$files </span><span class="keyword">as </span><span class="default">$f </span><span class="keyword">)
<br />{
<br />    </span><span class="default">$auxIMG </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();
<br />    </span><span class="default">$auxIMG</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$mytifspath</span><span class="keyword">.</span><span class="default">$f</span><span class="keyword">);
<br />    
<br />    </span><span class="default">$multiTIFF</span><span class="keyword">-&gt;</span><span class="default">addImage</span><span class="keyword">(</span><span class="default">$auxIMG</span><span class="keyword">);
<br />}
<br />
<br /></span><span class="comment">//file multi.TIF
<br /></span><span class="default">$multiTIFF</span><span class="keyword">-&gt;</span><span class="default">writeImages</span><span class="keyword">(</span><span class="string">'multi.TIF'</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);
<br />
<br /></span><span class="comment">//files multi-0.TIF, multi-1.TIF, ...
<br /></span><span class="default">$multiTIFF</span><span class="keyword">-&gt;</span><span class="default">writeImages</span><span class="keyword">(</span><span class="string">'multi.TIF'</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="95698">  <div class="votes">
    <div id="Vu95698">
    <a href="/manual/vote-note.php?id=95698&amp;page=imagick.writeimages&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd95698">
    <a href="/manual/vote-note.php?id=95698&amp;page=imagick.writeimages&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V95698" title="83% like this...">
    4
    </div>
  </div>
  <a href="#95698" class="name">
  <strong class="user"><em>Malou</em></strong></a><a class="genanchor" href="#95698"> &para;</a><div class="date" title="2010-01-16 01:25"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95698">
<div class="phpcode"><code><span class="html">As mbrugue sugest, the second parameter can also be use to save an animated gif:<br /><br /><span class="default">&lt;?php <br />$anim </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(); <br /><br /></span><span class="default">$files </span><span class="keyword">= </span><span class="default">scandir</span><span class="keyword">(</span><span class="default">$myFramesPath</span><span class="keyword">); <br />    <br />foreach( </span><span class="default">$files </span><span class="keyword">as </span><span class="default">$f </span><span class="keyword">) <br />{ <br />    </span><span class="default">$auxIMG </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(); <br />    </span><span class="default">$auxIMG</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$mytifspath</span><span class="keyword">.</span><span class="default">$f</span><span class="keyword">); <br />    <br />    </span><span class="default">$anim</span><span class="keyword">-&gt;</span><span class="default">addImage</span><span class="keyword">(</span><span class="default">$auxIMG</span><span class="keyword">); <br />} <br /><br /></span><span class="comment">//write animated gif<br /></span><span class="default">$anim</span><span class="keyword">-&gt;</span><span class="default">writeImages</span><span class="keyword">(</span><span class="string">'anim.gif'</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">); <br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.writeimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.writeimages.php">＋<small>add a note</small></a></div>
