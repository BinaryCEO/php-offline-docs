...
<head>
  ...
  <title>PHP: ps_fill - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-fill.php">
 <link rel="shorturl" href="https://www.php.net/ps-fill">
 <link rel="alternate" href="https://www.php.net/ps-fill" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-end-template.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-fill-stroke.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-fill.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-fill.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-fill.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-fill.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-fill.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-fill.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-fill.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-fill.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-fill.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-fill.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-fill.php" hreflang="zh">
...
<meta name="Description" content="Fills the current path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_fill - Manual" />
<meta name="twitter:description" content="Fills the current path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_fill - Manual" />
<meta itemprop="description" content="Fills the current path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fills the current path" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-fill-stroke.php">
          ps_fill_stroke &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-end-template.php">
          &laquo; ps_end_template        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-fill.php' selected="selected">English</option>
            <option value='de/function.ps-fill.php'>German</option>
            <option value='es/function.ps-fill.php'>Spanish</option>
            <option value='fr/function.ps-fill.php'>French</option>
            <option value='it/function.ps-fill.php'>Italian</option>
            <option value='ja/function.ps-fill.php'>Japanese</option>
            <option value='pt_BR/function.ps-fill.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-fill.php'>Russian</option>
            <option value='tr/function.ps-fill.php'>Turkish</option>
            <option value='uk/function.ps-fill.php'>Ukrainian</option>
            <option value='zh/function.ps-fill.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-fill" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-stroke.php" class="function" rel="rdfs-seeAlso">ps_stroke()</a> - Draws the current path</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-fill.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-fill%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-fill&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-fill.php">＋<small>add a note</small></a></span>
