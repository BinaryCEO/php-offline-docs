...
<head>
  ...
  <title>PHP: ZMQDevice - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.zmqdevice.php">
 <link rel="shorturl" href="https://www.php.net/zmqdevice">
 <link rel="alternate" href="https://www.php.net/zmqdevice" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.zmq.php">
 <link rel="prev" href="https://www.php.net/manual/en/zmqpoll.remove.php">
 <link rel="next" href="https://www.php.net/manual/en/zmqdevice.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.zmqdevice.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.zmqdevice.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.zmqdevice.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.zmqdevice.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.zmqdevice.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.zmqdevice.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.zmqdevice.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.zmqdevice.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.zmqdevice.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.zmqdevice.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.zmqdevice.php" hreflang="zh">
...
<meta name="Description" content="The ZMQDevice class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZMQDevice - Manual" />
<meta name="twitter:description" content="The ZMQDevice class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZMQDevice - Manual" />
<meta itemprop="description" content="The ZMQDevice class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ZMQDevice class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="zmqdevice.construct.php">
          ZMQDevice::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="zmqpoll.remove.php">
          &laquo; ZMQPoll::remove        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.zmqdevice.php' selected="selected">English</option>
            <option value='de/class.zmqdevice.php'>German</option>
            <option value='es/class.zmqdevice.php'>Spanish</option>
            <option value='fr/class.zmqdevice.php'>French</option>
            <option value='it/class.zmqdevice.php'>Italian</option>
            <option value='ja/class.zmqdevice.php'>Japanese</option>
            <option value='pt_BR/class.zmqdevice.php'>Brazilian Portuguese</option>
            <option value='ru/class.zmqdevice.php'>Russian</option>
            <option value='tr/class.zmqdevice.php'>Turkish</option>
            <option value='uk/class.zmqdevice.php'>Ukrainian</option>
            <option value='zh/class.zmqdevice.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.zmqdevice" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="zmqdevice.construct.php">ZMQDevice::__construct</a> — Construct a new device</li><li><a href="zmqdevice.getidletimeout.php">ZMQDevice::getIdleTimeout</a> — Get the idle timeout</li><li><a href="zmqdevice.gettimertimeout.php">ZMQDevice::getTimerTimeout</a> — Get the timer timeout</li><li><a href="zmqdevice.run.php">ZMQDevice::run</a> — Run the new device</li><li><a href="zmqdevice.setidlecallback.php">ZMQDevice::setIdleCallback</a> — Set the idle callback function</li><li><a href="zmqdevice.setidletimeout.php">ZMQDevice::setIdleTimeout</a> — Set the idle timeout</li><li><a href="zmqdevice.settimercallback.php">ZMQDevice::setTimerCallback</a> — Set the timer callback function</li><li><a href="zmqdevice.settimertimeout.php">ZMQDevice::setTimerTimeout</a> — Set the timer timeout</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zmq/zmqdevice.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.zmqdevice%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.zmqdevice&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.zmqdevice.php">＋<small>add a note</small></a></span>
