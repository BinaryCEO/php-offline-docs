...
<head>
  ...
  <title>PHP: rnp_supported_features - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rnp-supported-features.php">
 <link rel="shorturl" href="https://www.php.net/rnp-supported-features">
 <link rel="alternate" href="https://www.php.net/rnp-supported-features" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.rnp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.rnp-save-keys-to-path.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rnp-version-string.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rnp-supported-features.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rnp-supported-features.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rnp-supported-features.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rnp-supported-features.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rnp-supported-features.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rnp-supported-features.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rnp-supported-features.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rnp-supported-features.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rnp-supported-features.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rnp-supported-features.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rnp-supported-features.php" hreflang="zh">
...
<meta name="Description" content="Get supported features in JSON format" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rnp_supported_features - Manual" />
<meta name="twitter:description" content="Get supported features in JSON format" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rnp_supported_features - Manual" />
<meta itemprop="description" content="Get supported features in JSON format" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get supported features in JSON format" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.rnp-version-string.php">
          rnp_version_string &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.rnp-save-keys-to-path.php">
          &laquo; rnp_save_keys_to_path        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rnp-supported-features.php' selected="selected">English</option>
            <option value='de/function.rnp-supported-features.php'>German</option>
            <option value='es/function.rnp-supported-features.php'>Spanish</option>
            <option value='fr/function.rnp-supported-features.php'>French</option>
            <option value='it/function.rnp-supported-features.php'>Italian</option>
            <option value='ja/function.rnp-supported-features.php'>Japanese</option>
            <option value='pt_BR/function.rnp-supported-features.php'>Brazilian Portuguese</option>
            <option value='ru/function.rnp-supported-features.php'>Russian</option>
            <option value='tr/function.rnp-supported-features.php'>Turkish</option>
            <option value='uk/function.rnp-supported-features.php'>Ukrainian</option>
            <option value='zh/function.rnp-supported-features.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rnp-supported-features" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.rnp-supported-features-returnvalues">
  ...
  <p class="para">
   String containing JSON formatted array of supported algorithms, curves, etc or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/functions/rnp-supported-features.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rnp-supported-features%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rnp-supported-features&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rnp-supported-features.php">＋<small>add a note</small></a></span>
