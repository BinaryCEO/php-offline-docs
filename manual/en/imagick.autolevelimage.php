...
<head>
  ...
  <title>PHP: Imagick::autoLevelImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.autolevelimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.autolevelimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.autolevelimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.appendimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.averageimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.autolevelimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.autolevelimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.autolevelimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.autolevelimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.autolevelimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.autolevelimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.autolevelimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.autolevelimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.autolevelimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.autolevelimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.autolevelimage.php" hreflang="zh">
...
<meta name="Description" content="Adjusts the levels of a particular image channel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::autoLevelImage - Manual" />
<meta name="twitter:description" content="Adjusts the levels of a particular image channel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::autoLevelImage - Manual" />
<meta itemprop="description" content="Adjusts the levels of a particular image channel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adjusts the levels of a particular image channel" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.averageimages.php">
          Imagick::averageImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.appendimages.php">
          &laquo; Imagick::appendImages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.autolevelimage.php' selected="selected">English</option>
            <option value='de/imagick.autolevelimage.php'>German</option>
            <option value='es/imagick.autolevelimage.php'>Spanish</option>
            <option value='fr/imagick.autolevelimage.php'>French</option>
            <option value='it/imagick.autolevelimage.php'>Italian</option>
            <option value='ja/imagick.autolevelimage.php'>Japanese</option>
            <option value='pt_BR/imagick.autolevelimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.autolevelimage.php'>Russian</option>
            <option value='tr/imagick.autolevelimage.php'>Turkish</option>
            <option value='uk/imagick.autolevelimage.php'>Ukrainian</option>
            <option value='zh/imagick.autolevelimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.autolevelimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::autoLevelImage</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::autoLevelImage</span> &mdash; <span class="dc-title">Adjusts the levels of a particular image channel</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.autolevelimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::autoLevelImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.autolevelimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.autolevelimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-2970">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/autolevelimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.autolevelimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.autolevelimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.autolevelimage.php">＋<small>add a note</small></a></span>
