...
<head>
  ...
  <title>PHP: ps_rect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-rect.php">
 <link rel="shorturl" href="https://www.php.net/ps-rect">
 <link rel="alternate" href="https://www.php.net/ps-rect" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-place-image.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-restore.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-rect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-rect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-rect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-rect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-rect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-rect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-rect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-rect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-rect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-rect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-rect.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ps_rect - Manual" />
<meta name="twitter:description" content="Draws a rectangle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_rect - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-rect.php' selected="selected">English</option>
            <option value='de/function.ps-rect.php'>German</option>
            <option value='es/function.ps-rect.php'>Spanish</option>
            <option value='fr/function.ps-rect.php'>French</option>
            <option value='it/function.ps-rect.php'>Italian</option>
            <option value='ja/function.ps-rect.php'>Japanese</option>
            <option value='pt_BR/function.ps-rect.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-rect.php'>Russian</option>
            <option value='tr/function.ps-rect.php'>Turkish</option>
            <option value='uk/function.ps-rect.php'>Ukrainian</option>
            <option value='zh/function.ps-rect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-rect" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_rect</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_rect</span> &mdash; <span class="dc-title">Draws a rectangle</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-rect-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_rect</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$height</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Draws a rectangle with its lower left corner at (<code class="parameter">x</code>,
   <code class="parameter">y</code>). The rectangle starts and ends in its lower left
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-rect-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-rect-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-rect-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><strong>ps_cirle()</strong></span></li>
    <li><span class="function"><a href="function.ps-lineto.php" class="function" rel="rdfs-seeAlso">ps_lineto()</a> - Draws a line</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-rect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-rect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-rect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-rect.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="91512">  <div class="votes">
    <div id="Vu91512">
    <a href="/manual/vote-note.php?id=91512&amp;page=function.ps-rect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91512">
    <a href="/manual/vote-note.php?id=91512&amp;page=function.ps-rect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91512" title="66% like this...">
    5
    </div>
  </div>
  <a href="#91512" class="name">
  <strong class="user"><em>php at catchall dot toao dot net</em></strong></a><a class="genanchor" href="#91512"> &para;</a><div class="date" title="2009-06-14 08:23"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91512">
<div class="phpcode"><code><span class="html">Example: draw a purple box 144 points wide by 72 points high on a page in position 0, 0:<br /><br /><span class="default">&lt;?php<br />ps_setcolor</span><span class="keyword">(</span><span class="default">$ps</span><span class="keyword">, </span><span class="string">"fill"</span><span class="keyword">, </span><span class="string">"cmyk"</span><span class="keyword">, </span><span class="default">.5</span><span class="keyword">, </span><span class="default">.5</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">ps_rect</span><span class="keyword">(</span><span class="default">$ps</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">144</span><span class="keyword">, </span><span class="default">72</span><span class="keyword">);<br /></span><span class="default">ps_fill</span><span class="keyword">(</span><span class="default">$ps</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ps-rect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-rect.php">＋<small>add a note</small></a></div>
