...
<head>
  ...
  <title>PHP: Imagick::pingImageFile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.pingimagefile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.pingimagefile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.pingimagefile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.pingimageblob.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.polaroidimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.pingimagefile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.pingimagefile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.pingimagefile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.pingimagefile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.pingimagefile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.pingimagefile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.pingimagefile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.pingimagefile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.pingimagefile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.pingimagefile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.pingimagefile.php" hreflang="zh">
...
<meta name="Description" content="Get basic image attributes in a lightweight manner" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::pingImageFile - Manual" />
<meta name="twitter:description" content="Get basic image attributes in a lightweight manner" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::pingImageFile - Manual" />
<meta itemprop="description" content="Get basic image attributes in a lightweight manner" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get basic image attributes in a lightweight manner" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.polaroidimage.php">
          Imagick::polaroidImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.pingimageblob.php">
          &laquo; Imagick::pingImageBlob        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.pingimagefile.php' selected="selected">English</option>
            <option value='de/imagick.pingimagefile.php'>German</option>
            <option value='es/imagick.pingimagefile.php'>Spanish</option>
            <option value='fr/imagick.pingimagefile.php'>French</option>
            <option value='it/imagick.pingimagefile.php'>Italian</option>
            <option value='ja/imagick.pingimagefile.php'>Japanese</option>
            <option value='pt_BR/imagick.pingimagefile.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.pingimagefile.php'>Russian</option>
            <option value='tr/imagick.pingimagefile.php'>Turkish</option>
            <option value='uk/imagick.pingimagefile.php'>Ukrainian</option>
            <option value='zh/imagick.pingimagefile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.pingimagefile" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.pingimagefile-examples">
  ...
  <p class="para">
   <div class="example" id="example-3065">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="imagick.readimagefile.php" class="function" rel="rdfs-seeAlso">Imagick::readImageFile()</a> - Reads image from open filehandle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/pingimagefile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.pingimagefile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.pingimagefile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.pingimagefile.php">＋<small>add a note</small></a></span>
