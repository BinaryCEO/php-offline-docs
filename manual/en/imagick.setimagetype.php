...
<head>
  ...
  <title>PHP: Imagick::setImageType - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagetype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagetype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagetype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagetickspersecond.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageunits.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagetype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagetype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagetype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagetype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagetype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagetype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagetype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagetype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagetype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagetype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagetype.php" hreflang="zh">
...
<meta name="Description" content="Sets the image type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageType - Manual" />
<meta name="twitter:description" content="Sets the image type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageType - Manual" />
<meta itemprop="description" content="Sets the image type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image type" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimageunits.php">
          Imagick::setImageUnits &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagetickspersecond.php">
          &laquo; Imagick::setImageTicksPerSecond        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagetype.php' selected="selected">English</option>
            <option value='de/imagick.setimagetype.php'>German</option>
            <option value='es/imagick.setimagetype.php'>Spanish</option>
            <option value='fr/imagick.setimagetype.php'>French</option>
            <option value='it/imagick.setimagetype.php'>Italian</option>
            <option value='ja/imagick.setimagetype.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagetype.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagetype.php'>Russian</option>
            <option value='tr/imagick.setimagetype.php'>Turkish</option>
            <option value='uk/imagick.setimagetype.php'>Ukrainian</option>
            <option value='zh/imagick.setimagetype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagetype" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageType</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageType</span> &mdash; <span class="dc-title">Sets the image type</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagetype-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageType</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$image_type</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagetype-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagetype-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagetype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagetype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagetype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagetype.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115860">  <div class="votes">
    <div id="Vu115860">
    <a href="/manual/vote-note.php?id=115860&amp;page=imagick.setimagetype&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115860">
    <a href="/manual/vote-note.php?id=115860&amp;page=imagick.setimagetype&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115860" title="75% like this...">
    2
    </div>
  </div>
  <a href="#115860" class="name">
  <strong class="user"><em>quickshiftin at gmail dot com</em></strong></a><a class="genanchor" href="#115860"> &para;</a><div class="date" title="2014-10-04 06:29"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom115860">
<div class="phpcode"><code><span class="html">The cleaner way to set the type to grayscale is to use the Imagick class constant.<br /><br />$oBw = new \Imagick($sSourceImage);<br />$oBw-&gt;setImageType(\Imagick::IMGTYPE_GRAYSCALE);<br /><br />I've found this to be a rather harsh 'convert to grayscale' approach. Fred's color2gray script works much better, but it's written in Bash. Time to get it ported over lol<br /><br /><a href="http://www.fmwconcepts.com/imagemagick/color2gray/index.php" rel="nofollow" target="_blank">http://www.fmwconcepts.com/imagemagick/color2gray/index.php</a></span></code></div>
  </div>
 </div>
  <div class="note" id="124850">  <div class="votes">
    <div id="Vu124850">
    <a href="/manual/vote-note.php?id=124850&amp;page=imagick.setimagetype&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124850">
    <a href="/manual/vote-note.php?id=124850&amp;page=imagick.setimagetype&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124850" title="66% like this...">
    1
    </div>
  </div>
  <a href="#124850" class="name">
  <strong class="user"><em>Simon J</em></strong></a><a class="genanchor" href="#124850"> &para;</a><div class="date" title="2020-03-24 12:55"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124850">
<div class="phpcode"><code><span class="html">The different image types that can be specified are (from the Imagick::getImageType doc page):<br /><br />    Imagick::IMGTYPE_UNDEFINED<br />    Imagick::IMGTYPE_BILEVEL<br />    Imagick::IMGTYPE_GRAYSCALE<br />    Imagick::IMGTYPE_GRAYSCALEMATTE<br />    Imagick::IMGTYPE_PALETTE<br />    Imagick::IMGTYPE_PALETTEMATTE<br />    Imagick::IMGTYPE_TRUECOLOR<br />    Imagick::IMGTYPE_TRUECOLORMATTE<br />    Imagick::IMGTYPE_COLORSEPARATION<br />    Imagick::IMGTYPE_COLORSEPARATIONMATTE<br />    Imagick::IMGTYPE_OPTIMIZE<br /><br />The MATTE variants are equivalent to GrayscaleAlpha, etc. in the ImageMagick command line. If you're making something grayscale, I would recommend using IMGTYPE_GRAYSCALEMATTE.<br /><br /><span class="default">&lt;?php<br /><br />$im</span><span class="keyword">-&gt;</span><span class="default">setImageType</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_GRAYSCALEMATTE</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="106227">  <div class="votes">
    <div id="Vu106227">
    <a href="/manual/vote-note.php?id=106227&amp;page=imagick.setimagetype&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106227">
    <a href="/manual/vote-note.php?id=106227&amp;page=imagick.setimagetype&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106227" title="50% like this...">
    0
    </div>
  </div>
  <a href="#106227" class="name">
  <strong class="user"><em>lee dot traynor at skeptic dot de</em></strong></a><a class="genanchor" href="#106227"> &para;</a><div class="date" title="2011-10-19 01:37"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106227">
<div class="phpcode"><code><span class="html">This function can be used to desaturate an image, i.e. to convert a coloured image into a greyscale:<br /><br /><span class="default">&lt;?php<br /><br />$im </span><span class="keyword">= new </span><span class="default">Imagick </span><span class="keyword">(</span><span class="string">"image.jpg"</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageType </span><span class="keyword">(</span><span class="default">2</span><span class="keyword">);<br /></span><span class="comment">//is now in 256 shades of grey<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimagetype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagetype.php">＋<small>add a note</small></a></div>
