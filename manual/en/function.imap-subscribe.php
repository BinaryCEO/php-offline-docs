...
<head>
  ...
  <title>PHP: imap_subscribe - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-subscribe.php">
 <link rel="shorturl" href="https://www.php.net/imap-subscribe">
 <link rel="alternate" href="https://www.php.net/imap-subscribe" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-status.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-thread.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-subscribe.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-subscribe.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-subscribe.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-subscribe.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-subscribe.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-subscribe.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-subscribe.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-subscribe.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-subscribe.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-subscribe.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-subscribe.php" hreflang="zh">
...
<meta name="Description" content="Subscribe to a mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_subscribe - Manual" />
<meta name="twitter:description" content="Subscribe to a mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_subscribe - Manual" />
<meta itemprop="description" content="Subscribe to a mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Subscribe to a mailbox" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-thread.php">
          imap_thread &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-subscribe.php' selected="selected">English</option>
            <option value='de/function.imap-subscribe.php'>German</option>
            <option value='es/function.imap-subscribe.php'>Spanish</option>
            <option value='fr/function.imap-subscribe.php'>French</option>
            <option value='it/function.imap-subscribe.php'>Italian</option>
            <option value='ja/function.imap-subscribe.php'>Japanese</option>
            <option value='pt_BR/function.imap-subscribe.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-subscribe.php'>Russian</option>
            <option value='tr/function.imap-subscribe.php'>Turkish</option>
            <option value='uk/function.imap-subscribe.php'>Ukrainian</option>
            <option value='zh/function.imap-subscribe.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-subscribe" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_subscribe</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_subscribe</span> &mdash; <span class="dc-title">Subscribe to a mailbox</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-subscribe-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_subscribe</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$mailbox</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imap-subscribe-parameters">
...
<a href="imap.configuration.php#ini.imap.enable-insecure-rsh" class="link">imap.enable_insecure_rsh</a> is disabled.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-subscribe-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imap-subscribe-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-subscribe-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-unsubscribe.php" class="function" rel="rdfs-seeAlso">imap_unsubscribe()</a> - Unsubscribe from a mailbox</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-subscribe.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-subscribe%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-subscribe&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-subscribe.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="91193">  <div class="votes">
    <div id="Vu91193">
    <a href="/manual/vote-note.php?id=91193&amp;page=function.imap-subscribe&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91193">
    <a href="/manual/vote-note.php?id=91193&amp;page=function.imap-subscribe&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91193" title="100% like this...">
    1
    </div>
  </div>
  <a href="#91193" class="name">
  <strong class="user"><em>shacky</em></strong></a><a class="genanchor" href="#91193"> &para;</a><div class="date" title="2009-05-29 06:34"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91193">
<div class="phpcode"><code><span class="html">Hi,<br />When $mailbox string ends with '/' it doesn't subscribe and doesn't return any error. You need to rtrim this character.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-subscribe&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-subscribe.php">＋<small>add a note</small></a></div>
