...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="regexiterator.accept.php">RegexIterator::accept</a> — Get accept status</li><li><a href="regexiterator.construct.php">RegexIterator::__construct</a> — Create a new RegexIterator</li><li><a href="regexiterator.getflags.php">RegexIterator::getFlags</a> — Get flags</li><li><a href="regexiterator.getmode.php">RegexIterator::getMode</a> — Returns operation mode</li><li><a href="regexiterator.getpregflags.php">RegexIterator::getPregFlags</a> — Returns the regular expression flags</li><li><a href="regexiterator.getregex.php">RegexIterator::getRegex</a> — Returns current regular expression</li><li><a href="regexiterator.setflags.php">RegexIterator::setFlags</a> — Sets the flags</li><li><a href="regexiterator.setmode.php">RegexIterator::setMode</a> — Sets the operation mode</li><li><a href="regexiterator.setpregflags.php">RegexIterator::setPregFlags</a> — Sets the regular expression flags</li></ul>
 ...
 <div class="head">
  ...
  <strong class="user"><em>jinmoku at hotmail dot com</em></strong></a><a class="genanchor" href="#101337"> &para;</a><div class="date" title="2010-12-10 12:28"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101337">
<div class="phpcode"><code><span class="html">An exemple :
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <strong class="user"><em>chris dot snyder at totara dot com</em></strong></a><a class="genanchor" href="#128089"> &para;</a><div class="date" title="2023-01-06 06:29"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128089">
<div class="phpcode"><code><span class="html">In case the difference between modes RegexIterator::MATCH and RegexIterator::GET_MATCH is not immediately clear:<br /><br />MATCH will only return one value per matched element, as a string.<br /><br />GET_MATCH will return as many values, per matched element, as there are sub-patterns. If there are sub-patterns, each iteration returns an indexed array with the full pattern match at 0 and each of the sub-pattern matches as another element.<br /><br />If there are no sub-patterns, the behaviour of GET_MATCH is the same as MATCH.</span></code></div>
  </div>
 </div></div>
