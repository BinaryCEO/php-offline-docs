...
<head>
  ...
  <title>PHP: Imagick::displayImages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.displayimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.displayimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.displayimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.displayimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.distortimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.displayimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.displayimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.displayimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.displayimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.displayimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.displayimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.displayimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.displayimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.displayimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.displayimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.displayimages.php" hreflang="zh">
...
<meta name="Description" content="Displays an image or image sequence" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::displayImages - Manual" />
<meta name="twitter:description" content="Displays an image or image sequence" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::displayImages - Manual" />
<meta itemprop="description" content="Displays an image or image sequence" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Displays an image or image sequence" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.distortimage.php">
          Imagick::distortImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.displayimage.php">
          &laquo; Imagick::displayImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.displayimages.php' selected="selected">English</option>
            <option value='de/imagick.displayimages.php'>German</option>
            <option value='es/imagick.displayimages.php'>Spanish</option>
            <option value='fr/imagick.displayimages.php'>French</option>
            <option value='it/imagick.displayimages.php'>Italian</option>
            <option value='ja/imagick.displayimages.php'>Japanese</option>
            <option value='pt_BR/imagick.displayimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.displayimages.php'>Russian</option>
            <option value='tr/imagick.displayimages.php'>Turkish</option>
            <option value='uk/imagick.displayimages.php'>Ukrainian</option>
            <option value='zh/imagick.displayimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.displayimages" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::displayImages</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::displayImages</span> &mdash; <span class="dc-title">Displays an image or image sequence</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.displayimages-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::displayImages</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$servername</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.displayimages-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.displayimages-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.displayimages-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/displayimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.displayimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.displayimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.displayimages.php">＋<small>add a note</small></a></span>
