...
<head>
  ...
  <title>PHP: gmp_rootrem - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-rootrem.php">
 <link rel="shorturl" href="https://www.php.net/gmp-rootrem">
 <link rel="alternate" href="https://www.php.net/gmp-rootrem" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-root.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-scan0.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-rootrem.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-rootrem.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-rootrem.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-rootrem.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-rootrem.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-rootrem.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-rootrem.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-rootrem.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-rootrem.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-rootrem.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-rootrem.php" hreflang="zh">
...
<meta name="Description" content="Take the integer part and remainder of nth root" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_rootrem - Manual" />
<meta name="twitter:description" content="Take the integer part and remainder of nth root" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_rootrem - Manual" />
<meta itemprop="description" content="Take the integer part and remainder of nth root" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Take the integer part and remainder of nth root" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-rootrem.php' selected="selected">English</option>
            <option value='de/function.gmp-rootrem.php'>German</option>
            <option value='es/function.gmp-rootrem.php'>Spanish</option>
            <option value='fr/function.gmp-rootrem.php'>French</option>
            <option value='it/function.gmp-rootrem.php'>Italian</option>
            <option value='ja/function.gmp-rootrem.php'>Japanese</option>
            <option value='pt_BR/function.gmp-rootrem.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-rootrem.php'>Russian</option>
            <option value='tr/function.gmp-rootrem.php'>Turkish</option>
            <option value='uk/function.gmp-rootrem.php'>Ukrainian</option>
            <option value='zh/function.gmp-rootrem.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-rootrem" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_rootrem</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.6.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_rootrem</span> &mdash; <span class="dc-title">Take the integer part and remainder of nth root</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.gmp-rootrem-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_rootrem</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$nth</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
  ...
  <p class="para">
   ...
   numbers.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-rootrem.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-rootrem%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-rootrem&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-rootrem.php">＋<small>add a note</small></a></span>
