...
<head>
  ...
  <title>PHP: GearmanClient::error - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.error.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.error.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.error.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.echo.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.geterrno.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.error.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.error.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.error.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.error.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.error.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.error.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.error.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.error.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.error.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.error.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.error.php" hreflang="zh">
...
<meta name="Description" content="Returns an error string for the last error encountered" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::error - Manual" />
<meta name="twitter:description" content="Returns an error string for the last error encountered" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::error - Manual" />
<meta itemprop="description" content="Returns an error string for the last error encountered" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an error string for the last error encountered" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearmanclient.geterrno.php">
          GearmanClient::getErrno &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.echo.php">
          &laquo; GearmanClient::echo        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.error.php' selected="selected">English</option>
            <option value='de/gearmanclient.error.php'>German</option>
            <option value='es/gearmanclient.error.php'>Spanish</option>
            <option value='fr/gearmanclient.error.php'>French</option>
            <option value='it/gearmanclient.error.php'>Italian</option>
            <option value='ja/gearmanclient.error.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.error.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.error.php'>Russian</option>
            <option value='tr/gearmanclient.error.php'>Turkish</option>
            <option value='uk/gearmanclient.error.php'>Ukrainian</option>
            <option value='zh/gearmanclient.error.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.error" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="gearmanclient.geterrno.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::getErrno()</a> - Get an errno value</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/error.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.error%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.error&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.error.php">＋<small>add a note</small></a></span>
