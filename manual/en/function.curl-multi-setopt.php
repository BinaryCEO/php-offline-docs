...
<head>
  ...
  <title>PHP: curl_multi_setopt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.curl-multi-setopt.php">
 <link rel="shorturl" href="https://www.php.net/curl-multi-setopt">
 <link rel="alternate" href="https://www.php.net/curl-multi-setopt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.curl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.curl-multi-select.php">
 <link rel="next" href="https://www.php.net/manual/en/function.curl-multi-strerror.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.curl-multi-setopt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.curl-multi-setopt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.curl-multi-setopt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.curl-multi-setopt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.curl-multi-setopt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.curl-multi-setopt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.curl-multi-setopt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.curl-multi-setopt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.curl-multi-setopt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.curl-multi-setopt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.curl-multi-setopt.php" hreflang="zh">
...
<meta name="Description" content="Set a cURL multi option" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: curl_multi_setopt - Manual" />
<meta name="twitter:description" content="Set a cURL multi option" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: curl_multi_setopt - Manual" />
<meta itemprop="description" content="Set a cURL multi option" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set a cURL multi option" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.curl-multi-strerror.php">
          curl_multi_strerror &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.curl-multi-select.php">
          &laquo; curl_multi_select        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.curl-multi-setopt.php' selected="selected">English</option>
            <option value='de/function.curl-multi-setopt.php'>German</option>
            <option value='es/function.curl-multi-setopt.php'>Spanish</option>
            <option value='fr/function.curl-multi-setopt.php'>French</option>
            <option value='it/function.curl-multi-setopt.php'>Italian</option>
            <option value='ja/function.curl-multi-setopt.php'>Japanese</option>
            <option value='pt_BR/function.curl-multi-setopt.php'>Brazilian Portuguese</option>
            <option value='ru/function.curl-multi-setopt.php'>Russian</option>
            <option value='tr/function.curl-multi-setopt.php'>Turkish</option>
            <option value='uk/function.curl-multi-setopt.php'>Ukrainian</option>
            <option value='zh/function.curl-multi-setopt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.curl-multi-setopt" class="refentry">
 ...
 <td>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/curl/functions/curl-multi-setopt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.curl-multi-setopt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.curl-multi-setopt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-multi-setopt.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118931">  <div class="votes">
    <div id="Vu118931">
    <a href="/manual/vote-note.php?id=118931&amp;page=function.curl-multi-setopt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118931">
    <a href="/manual/vote-note.php?id=118931&amp;page=function.curl-multi-setopt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118931" title="50% like this...">
    0
    </div>
  </div>
  <a href="#118931" class="name">
  <strong class="user"><em>ryosuke_i_628 at yahoo dot co dot jp</em></strong></a><a class="genanchor" href="#118931"> &para;</a><div class="date" title="2016-03-01 10:30"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118931">
<div class="phpcode"><code><span class="html">If you want to enable both HTTP/1.1 pipelining and HTTP/2 multiplexing...<br /><br /><span class="default">&lt;?php<br />curl_multi_setopt</span><span class="keyword">(</span><span class="default">$mh</span><span class="keyword">, </span><span class="default">CURLMOPT_PIPELINING</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />or<br /><br /><span class="default">&lt;?php<br />curl_multi_setopt</span><span class="keyword">(</span><span class="default">$mh</span><span class="keyword">, </span><span class="default">CURLMOPT_PIPELINING</span><span class="keyword">, </span><span class="default">CURLPIPE_HTTP1 </span><span class="keyword">| </span><span class="default">CURLPIPE_MULTIPLEX</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.curl-multi-setopt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-multi-setopt.php">＋<small>add a note</small></a></div>
