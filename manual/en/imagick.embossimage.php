...
<head>
  ...
  <title>PHP: Imagick::embossImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.embossimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.embossimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.embossimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.edgeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.encipherimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.embossimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.embossimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.embossimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.embossimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.embossimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.embossimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.embossimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.embossimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.embossimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.embossimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.embossimage.php" hreflang="zh">
...
<meta name="Description" content="Returns a grayscale image with a three-dimensional effect" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::embossImage - Manual" />
<meta name="twitter:description" content="Returns a grayscale image with a three-dimensional effect" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::embossImage - Manual" />
<meta itemprop="description" content="Returns a grayscale image with a three-dimensional effect" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a grayscale image with a three-dimensional effect" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.encipherimage.php">
          Imagick::encipherImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.edgeimage.php">
          &laquo; Imagick::edgeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.embossimage.php' selected="selected">English</option>
            <option value='de/imagick.embossimage.php'>German</option>
            <option value='es/imagick.embossimage.php'>Spanish</option>
            <option value='fr/imagick.embossimage.php'>French</option>
            <option value='it/imagick.embossimage.php'>Italian</option>
            <option value='ja/imagick.embossimage.php'>Japanese</option>
            <option value='pt_BR/imagick.embossimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.embossimage.php'>Russian</option>
            <option value='tr/imagick.embossimage.php'>Turkish</option>
            <option value='uk/imagick.embossimage.php'>Ukrainian</option>
            <option value='zh/imagick.embossimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.embossimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::embossImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::embossImage</span> &mdash; <span class="dc-title">Returns a grayscale image with a three-dimensional effect</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.embossimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::embossImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$sigma</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.embossimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.embossimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.embossimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-2993">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/embossimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.embossimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.embossimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.embossimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="103405">  <div class="votes">
    <div id="Vu103405">
    <a href="/manual/vote-note.php?id=103405&amp;page=imagick.embossimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103405">
    <a href="/manual/vote-note.php?id=103405&amp;page=imagick.embossimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103405" title="no votes...">
    0
    </div>
  </div>
  <a href="#103405" class="name">
  <strong class="user"><em>DJ Mike</em></strong></a><a class="genanchor" href="#103405"> &para;</a><div class="date" title="2011-04-11 11:17"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103405">
<div class="phpcode"><code><span class="html">embossImage() will actually return a color image with a 3D effect. If you want a gray scale image, you can use imagefilter() from the regular GD functions. <br /><br /><span class="default">&lt;?php<br />header</span><span class="keyword">(</span><span class="string">"Content-type: image/jpeg"</span><span class="keyword">);<br /></span><span class="default">$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">"opossum.jpg"</span><span class="keyword">); <br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">embossImage</span><span class="keyword">( </span><span class="default">0</span><span class="keyword">, </span><span class="default">1 </span><span class="keyword">);<br />echo </span><span class="default">$image</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.embossimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.embossimage.php">＋<small>add a note</small></a></div>
