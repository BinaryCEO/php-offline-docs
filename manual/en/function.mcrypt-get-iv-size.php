...
<head>
  ...
  <title>PHP: mcrypt_get_iv_size - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-get-iv-size.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-get-iv-size">
 <link rel="alternate" href="https://www.php.net/mcrypt-get-iv-size" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-get-cipher-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-get-key-size.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-get-iv-size.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-get-iv-size.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-get-iv-size.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-get-iv-size.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-get-iv-size.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-get-iv-size.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-get-iv-size.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-get-iv-size.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-get-iv-size.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-get-iv-size.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-get-iv-size.php" hreflang="zh">
...
<meta name="Description" content="Returns the size of the IV belonging to a specific cipher/mode combination" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_get_iv_size - Manual" />
<meta name="twitter:description" content="Returns the size of the IV belonging to a specific cipher/mode combination" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_get_iv_size - Manual" />
<meta itemprop="description" content="Returns the size of the IV belonging to a specific cipher/mode combination" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the size of the IV belonging to a specific cipher/mode combination" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mcrypt-get-key-size.php">
          mcrypt_get_key_size &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-get-cipher-name.php">
          &laquo; mcrypt_get_cipher_name        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-get-iv-size.php' selected="selected">English</option>
            <option value='de/function.mcrypt-get-iv-size.php'>German</option>
            <option value='es/function.mcrypt-get-iv-size.php'>Spanish</option>
            <option value='fr/function.mcrypt-get-iv-size.php'>French</option>
            <option value='it/function.mcrypt-get-iv-size.php'>Italian</option>
            <option value='ja/function.mcrypt-get-iv-size.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-get-iv-size.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-get-iv-size.php'>Russian</option>
            <option value='tr/function.mcrypt-get-iv-size.php'>Turkish</option>
            <option value='uk/function.mcrypt-get-iv-size.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-get-iv-size.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-get-iv-size" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mcrypt-create-iv.php" class="function" rel="rdfs-seeAlso">mcrypt_create_iv()</a> - Creates an initialization vector (IV) from a random source</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-get-iv-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-get-iv-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-get-iv-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-get-iv-size.php">＋<small>add a note</small></a></span>
