...
<head>
  ...
  <title>PHP: pg_consume_input - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-consume-input.php">
 <link rel="shorturl" href="https://www.php.net/pg-consume-input">
 <link rel="alternate" href="https://www.php.net/pg-consume-input" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-connection-status.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-convert.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-consume-input.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-consume-input.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-consume-input.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-consume-input.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-consume-input.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-consume-input.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-consume-input.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-consume-input.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-consume-input.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-consume-input.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-consume-input.php" hreflang="zh">
...
<meta name="Description" content="Reads input on the connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_consume_input - Manual" />
<meta name="twitter:description" content="Reads input on the connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_consume_input - Manual" />
<meta itemprop="description" content="Reads input on the connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads input on the connection" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-consume-input.php' selected="selected">English</option>
            <option value='de/function.pg-consume-input.php'>German</option>
            <option value='es/function.pg-consume-input.php'>Spanish</option>
            <option value='fr/function.pg-consume-input.php'>French</option>
            <option value='it/function.pg-consume-input.php'>Italian</option>
            <option value='ja/function.pg-consume-input.php'>Japanese</option>
            <option value='pt_BR/function.pg-consume-input.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-consume-input.php'>Russian</option>
            <option value='tr/function.pg-consume-input.php'>Turkish</option>
            <option value='uk/function.pg-consume-input.php'>Ukrainian</option>
            <option value='zh/function.pg-consume-input.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-consume-input" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_consume_input</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.6.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_consume_input</span> &mdash; <span class="dc-title">Reads input on the connection</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-consume-input-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_consume_input</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_consume_input()</strong></span> consumes any input waiting to be read
   from the database server.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.pg-consume-input-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-consume-input-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if no error occurred, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if there was an error. Note that
   <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> does not necessarily indicate that input was waiting to be read.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.pg-consume-input-changelog">
 ...
 <td>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-consume-input.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-consume-input%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-consume-input&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-consume-input.php">＋<small>add a note</small></a></span>
