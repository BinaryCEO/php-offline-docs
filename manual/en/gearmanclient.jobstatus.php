...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.jobstatus.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.jobstatus.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.jobstatus.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.geterrno.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.ping.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.jobstatus.php' selected="selected">English</option>
            ...
            <option value='zh/gearmanclient.jobstatus.php'>Chinese (Simplified)</option>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="gearmanclient.dostatus.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::doStatus()</a> - Get the status for the running task</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/jobstatus.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.jobstatus%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.jobstatus&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.jobstatus.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">The example above reads: <br />if (!$stat[0]) // the job is known so it is not done<br /><br />I think the comment is wrong, it should read "the job is unknown, so it is done".<br />Regards,<br />Jan</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">@Jan<br /><br />if (!$stat[0]) // the job is known so it is not done<br /><br />I believe to be correct. I read it as, if $stat[0] returns anything but false, the job is currently running, so we are not done. However, if we cannot find $stat[0] (ie: the job handle no longer exists) then the job is done.<br /><br />--Richard</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gearmanclient.jobstatus&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.jobstatus.php">＋<small>add a note</small></a></div>
