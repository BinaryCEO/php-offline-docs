...
<head>
  ...
  <title>PHP: DateTimeZone::listIdentifiers - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/datetimezone.listidentifiers.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/datetimezone.listidentifiers.php">
 <link rel="alternate" href="https://www.php.net/manual/en/datetimezone.listidentifiers.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.datetimezone.php">
 <link rel="prev" href="https://www.php.net/manual/en/datetimezone.listabbreviations.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dateinterval.php">

 <link rel="alternate" href="https://www.php.net/manual/en/datetimezone.listidentifiers.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/datetimezone.listidentifiers.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/datetimezone.listidentifiers.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/datetimezone.listidentifiers.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/datetimezone.listidentifiers.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/datetimezone.listidentifiers.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/datetimezone.listidentifiers.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/datetimezone.listidentifiers.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/datetimezone.listidentifiers.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/datetimezone.listidentifiers.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/datetimezone.listidentifiers.php" hreflang="zh">
...
<meta name="Description" content="Returns a numerically indexed array containing all defined timezone identifiers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateTimeZone::listIdentifiers - Manual" />
<meta name="twitter:description" content="Returns a numerically indexed array containing all defined timezone identifiers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateTimeZone::listIdentifiers - Manual" />
<meta itemprop="description" content="Returns a numerically indexed array containing all defined timezone identifiers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a numerically indexed array containing all defined timezone identifiers" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="datetimezone.listabbreviations.php">
          &laquo; DateTimeZone::listAbbreviations        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/datetimezone.listidentifiers.php' selected="selected">English</option>
            <option value='de/datetimezone.listidentifiers.php'>German</option>
            <option value='es/datetimezone.listidentifiers.php'>Spanish</option>
            <option value='fr/datetimezone.listidentifiers.php'>French</option>
            <option value='it/datetimezone.listidentifiers.php'>Italian</option>
            <option value='ja/datetimezone.listidentifiers.php'>Japanese</option>
            <option value='pt_BR/datetimezone.listidentifiers.php'>Brazilian Portuguese</option>
            <option value='ru/datetimezone.listidentifiers.php'>Russian</option>
            <option value='tr/datetimezone.listidentifiers.php'>Turkish</option>
            <option value='uk/datetimezone.listidentifiers.php'>Ukrainian</option>
            <option value='zh/datetimezone.listidentifiers.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="datetimezone.listidentifiers" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-datetimezone.listidentifiers-examples">
  ...
  <p class="para">
   <div class="example" id="example-2245">
    <p><strong>Example #1 A <span class="methodname"><strong>DateTimeZone::listIdentifiers()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">Africa/Abidjan
Africa/Accra
Africa/Addis_Ababa
Africa/Algiers
Africa/Asmara</pre>
...
something similar to:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">Asia/Aden
Asia/Almaty
Asia/Amman
Asia/Anadyr
Asia/Aqtau</pre>
...
something similar to:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">Asia/Aden, Asia/Almaty, Asia/Amman, Asia/Anadyr, Asia/Aqtau, Asia/Aqtobe,
...
something similar to:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">Europe/Kyiv
Europe/Simferopol
Europe/Uzhgorod
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.timezone-abbreviations-list.php" class="function" rel="rdfs-seeAlso">timezone_abbreviations_list()</a> - Alias of DateTimeZone::listAbbreviations</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datetimezone/listidentifiers.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdatetimezone.listidentifiers%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=datetimezone.listidentifiers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/datetimezone.listidentifiers.php">＋<small>add a note</small></a></span>
