...
<head>
  ...
  <title>PHP: stats_cdf_negative_binomial - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-cdf-negative-binomial.php">
 <link rel="shorturl" href="https://www.php.net/stats-cdf-negative-binomial">
 <link rel="alternate" href="https://www.php.net/stats-cdf-negative-binomial" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-cdf-logistic.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-cdf-noncentral-chisquare.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-cdf-negative-binomial.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-cdf-negative-binomial.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-cdf-negative-binomial.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-cdf-negative-binomial.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-cdf-negative-binomial.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-cdf-negative-binomial.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-cdf-negative-binomial.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-cdf-negative-binomial.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-cdf-negative-binomial.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-cdf-negative-binomial.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-cdf-negative-binomial.php" hreflang="zh">
...
<meta name="Description" content="Calculates any one parameter of the negative binomial distribution given values for the others" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_cdf_negative_binomial - Manual" />
<meta name="twitter:description" content="Calculates any one parameter of the negative binomial distribution given values for the others" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_cdf_negative_binomial - Manual" />
<meta itemprop="description" content="Calculates any one parameter of the negative binomial distribution given values for the others" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calculates any one parameter of the negative binomial distribution given values for the others" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stats-cdf-noncentral-chisquare.php">
          stats_cdf_noncentral_chisquare &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-cdf-logistic.php">
          &laquo; stats_cdf_logistic        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-cdf-negative-binomial.php' selected="selected">English</option>
            <option value='de/function.stats-cdf-negative-binomial.php'>German</option>
            <option value='es/function.stats-cdf-negative-binomial.php'>Spanish</option>
            <option value='fr/function.stats-cdf-negative-binomial.php'>French</option>
            <option value='it/function.stats-cdf-negative-binomial.php'>Italian</option>
            <option value='ja/function.stats-cdf-negative-binomial.php'>Japanese</option>
            <option value='pt_BR/function.stats-cdf-negative-binomial.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-cdf-negative-binomial.php'>Russian</option>
            <option value='tr/function.stats-cdf-negative-binomial.php'>Turkish</option>
            <option value='uk/function.stats-cdf-negative-binomial.php'>Ukrainian</option>
            <option value='zh/function.stats-cdf-negative-binomial.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-cdf-negative-binomial" class="refentry">
  ...
  <p class="para">
   Returns CDF, x, r, or p, determined by <code class="parameter">which</code>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-cdf-negative-binomial.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-cdf-negative-binomial%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-cdf-negative-binomial&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-cdf-negative-binomial.php">＋<small>add a note</small></a></span>
