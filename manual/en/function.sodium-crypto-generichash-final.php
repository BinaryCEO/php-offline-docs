...
<head>
  ...
  <title>PHP: sodium_crypto_generichash_final - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-generichash-final.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-generichash-final">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-generichash-final" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-generichash.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-generichash-init.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-generichash-final.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-generichash-final.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-generichash-final.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-generichash-final.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-generichash-final.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-generichash-final.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-generichash-final.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-generichash-final.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-generichash-final.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-generichash-final.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-generichash-final.php" hreflang="zh">
...
<meta name="Description" content="Complete the hash" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_generichash_final - Manual" />
<meta name="twitter:description" content="Complete the hash" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_generichash_final - Manual" />
<meta itemprop="description" content="Complete the hash" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Complete the hash" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-generichash-init.php">
          sodium_crypto_generichash_init &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-generichash.php">
          &laquo; sodium_crypto_generichash        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-generichash-final.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-generichash-final.php'>German</option>
            <option value='es/function.sodium-crypto-generichash-final.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-generichash-final.php'>French</option>
            <option value='it/function.sodium-crypto-generichash-final.php'>Italian</option>
            <option value='ja/function.sodium-crypto-generichash-final.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-generichash-final.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-generichash-final.php'>Russian</option>
            <option value='tr/function.sodium-crypto-generichash-final.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-generichash-final.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-generichash-final.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-generichash-final" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_generichash_final</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_generichash_final</span> &mdash; <span class="dc-title">Complete the hash</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-generichash-final-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_generichash_final</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter reference">&$state</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code><span class="initializer"> = <strong><code><a href="sodium.constants.php#constant.sodium-crypto-generichash-bytes">SODIUM_CRYPTO_GENERICHASH_BYTES</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-generichash-final-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      Hash state returned from <span class="function"><a href="function.sodium-crypto-generichash-init.php" class="function">sodium_crypto_generichash_init()</a></span>
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-generichash-final-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.sodium-crypto-generichash-final-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="sodium-crypto-generichash-final.example.basic">
   <p><strong>Example #1 <span class="function"><strong>sodium_crypto_generichash_final()</strong></span> example</strong></p>
...
string(64) &quot;a2939a9163cb7c796ec28e01028489e72475c136b2697ea59e3e760ab4a8ab20&quot;</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-generichash-final.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-generichash-final%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-generichash-final&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-generichash-final.php">＋<small>add a note</small></a></span>
