...
<head>
  ...
  <title>PHP: cubrid_free_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-free-result.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-free-result">
 <link rel="alternate" href="https://www.php.net/cubrid-free-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-fetch.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-get.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-free-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-free-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-free-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-free-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-free-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-free-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-free-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-free-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-free-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-free-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-free-result.php" hreflang="zh">
...
<meta name="Description" content="Free the memory occupied by the result data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_free_result - Manual" />
<meta name="twitter:description" content="Free the memory occupied by the result data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_free_result - Manual" />
<meta itemprop="description" content="Free the memory occupied by the result data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Free the memory occupied by the result data" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-get.php">
          cubrid_get &raquo;
              ...
              <div class="prev">
        <a href="function.cubrid-fetch.php">
          &laquo; cubrid_fetch        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-free-result.php' selected="selected">English</option>
            <option value='de/function.cubrid-free-result.php'>German</option>
            <option value='es/function.cubrid-free-result.php'>Spanish</option>
            <option value='fr/function.cubrid-free-result.php'>French</option>
            <option value='it/function.cubrid-free-result.php'>Italian</option>
            <option value='ja/function.cubrid-free-result.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-free-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-free-result.php'>Russian</option>
            <option value='tr/function.cubrid-free-result.php'>Turkish</option>
            <option value='uk/function.cubrid-free-result.php'>Ukrainian</option>
            <option value='zh/function.cubrid-free-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-free-result" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_free_result</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_free_result</span> &mdash; <span class="dc-title">Free the memory occupied by the result data</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-free-result-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_free_result</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$req_identifier</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
    This function frees the memory occupied by the result data. It returns
    <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure. Note that it can only frees the
 ...
 <p class="para">
  ...
  <dd><p class="para">This is the request identifier.</p></dd>
...
<div class="examplescode"><pre class="examplescode">array(5) {
  ...
  string(4) &quot;time&quot;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-free-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-free-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-free-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-free-result.php">＋<small>add a note</small></a></span>
