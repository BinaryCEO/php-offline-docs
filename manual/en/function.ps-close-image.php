...
<head>
  ...
  <title>PHP: ps_close_image - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-close-image.php">
 <link rel="shorturl" href="https://www.php.net/ps-close-image">
 <link rel="alternate" href="https://www.php.net/ps-close-image" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-closepath.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-close-image.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-close-image.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-close-image.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-close-image.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-close-image.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-close-image.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-close-image.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-close-image.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-close-image.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-close-image.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-close-image.php" hreflang="zh">
...
<meta name="Description" content="Closes image and frees memory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_close_image - Manual" />
<meta name="twitter:description" content="Closes image and frees memory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_close_image - Manual" />
<meta itemprop="description" content="Closes image and frees memory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Closes image and frees memory" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-close-image.php' selected="selected">English</option>
            <option value='de/function.ps-close-image.php'>German</option>
            <option value='es/function.ps-close-image.php'>Spanish</option>
            <option value='fr/function.ps-close-image.php'>French</option>
            <option value='it/function.ps-close-image.php'>Italian</option>
            <option value='ja/function.ps-close-image.php'>Japanese</option>
            <option value='pt_BR/function.ps-close-image.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-close-image.php'>Russian</option>
            <option value='tr/function.ps-close-image.php'>Turkish</option>
            <option value='uk/function.ps-close-image.php'>Ukrainian</option>
            <option value='zh/function.ps-close-image.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-close-image" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_close_image</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_close_image</span> &mdash; <span class="dc-title">Closes image and frees memory</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-close-image-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_close_image</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$imageid</code></span>): <span class="type"><span class="type"><a href="language.types.void.php" class="type void">void</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-close-image-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-close-image-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-close-image-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-open-image-file.php" class="function" rel="rdfs-seeAlso">ps_open_image_file()</a> - Opens image from file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-close-image.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-close-image%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-close-image&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-close-image.php">＋<small>add a note</small></a></span>
