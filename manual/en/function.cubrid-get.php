...
<head>
  ...
  <title>PHP: cubrid_get - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-get.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-get">
 <link rel="alternate" href="https://www.php.net/cubrid-get" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-free-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-get-autocommit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-get.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-get.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-get.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-get.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-get.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-get.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-get.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-get.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-get.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-get.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-get.php" hreflang="zh">
...
<meta name="Description" content="Get a column using OID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_get - Manual" />
<meta name="twitter:description" content="Get a column using OID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_get - Manual" />
<meta itemprop="description" content="Get a column using OID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get a column using OID" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-get-autocommit.php">
          cubrid_get_autocommit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-free-result.php">
          &laquo; cubrid_free_result        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-get.php' selected="selected">English</option>
            <option value='de/function.cubrid-get.php'>German</option>
            <option value='es/function.cubrid-get.php'>Spanish</option>
            <option value='fr/function.cubrid-get.php'>French</option>
            <option value='it/function.cubrid-get.php'>Italian</option>
            <option value='ja/function.cubrid-get.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-get.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-get.php'>Russian</option>
            <option value='tr/function.cubrid-get.php'>Turkish</option>
            <option value='uk/function.cubrid-get.php'>Ukrainian</option>
            <option value='zh/function.cubrid-get.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-get" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-get-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_get</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$oid</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$attr</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.cubrid-get-parameters">
  ...
  <dd><p class="para">Name of the attribute that you want to read.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-get-returnvalues">
  ...
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> when process is unsuccessful or result is NULL (If error occurs to
...
array(4) {
  ...
  <p class="para">
   <ul class="simplelist">
   <li><span class="function"><a href="function.cubrid-put.php" class="function" rel="rdfs-seeAlso">cubrid_put()</a> - Update a column using OID</span></li>
   </ul>
  </p>
  </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-get.php">＋<small>add a note</small></a></span>
