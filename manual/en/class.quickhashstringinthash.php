...
<head>
  ...
  <title>PHP: QuickHashStringIntHash - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.quickhashstringinthash.php">
 <link rel="shorturl" href="https://www.php.net/quickhashstringinthash">
 <link rel="alternate" href="https://www.php.net/quickhashstringinthash" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.quickhash.php">
 <link rel="prev" href="https://www.php.net/manual/en/quickhashinthash.update.php">
 <link rel="next" href="https://www.php.net/manual/en/quickhashstringinthash.add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.quickhashstringinthash.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.quickhashstringinthash.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.quickhashstringinthash.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.quickhashstringinthash.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.quickhashstringinthash.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.quickhashstringinthash.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.quickhashstringinthash.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.quickhashstringinthash.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.quickhashstringinthash.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.quickhashstringinthash.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.quickhashstringinthash.php" hreflang="zh">
...
<meta name="Description" content="The QuickHashStringIntHash class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: QuickHashStringIntHash - Manual" />
<meta name="twitter:description" content="The QuickHashStringIntHash class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: QuickHashStringIntHash - Manual" />
<meta itemprop="description" content="The QuickHashStringIntHash class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The QuickHashStringIntHash class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="quickhashstringinthash.add.php">
          QuickHashStringIntHash::add &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="quickhashinthash.update.php">
          &laquo; QuickHashIntHash::update        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.quickhashstringinthash.php' selected="selected">English</option>
            <option value='de/class.quickhashstringinthash.php'>German</option>
            <option value='es/class.quickhashstringinthash.php'>Spanish</option>
            <option value='fr/class.quickhashstringinthash.php'>French</option>
            <option value='it/class.quickhashstringinthash.php'>Italian</option>
            <option value='ja/class.quickhashstringinthash.php'>Japanese</option>
            <option value='pt_BR/class.quickhashstringinthash.php'>Brazilian Portuguese</option>
            <option value='ru/class.quickhashstringinthash.php'>Russian</option>
            <option value='tr/class.quickhashstringinthash.php'>Turkish</option>
            <option value='uk/class.quickhashstringinthash.php'>Ukrainian</option>
            <option value='zh/class.quickhashstringinthash.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.quickhashstringinthash" class="reference">
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="quickhashstringinthash.update.php" class="methodname">update</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <div class="section" id="quickhashstringinthash.constants">
   ...
   <dl>
     ...
     <dd>
      <p class="para">If enabled, adding duplicate elements to a set (through either <span class="methodname"><a href="quickhashstringinthash.add.php" class="methodname">QuickHashStringIntHash::add()</a></span> or
      <span class="methodname"><a href="quickhashstringinthash.loadfromfile.php" class="methodname">QuickHashStringIntHash::loadFromFile()</a></span>) will result in those elements to be dropped from the
  ...
  adds a new one if the entry doesn't exist</li><li><a href="quickhashstringinthash.update.php">QuickHashStringIntHash::update</a> — This method updates an entry in the hash with a new value</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/quickhash/quickhashstringinthash.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.quickhashstringinthash%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.quickhashstringinthash&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.quickhashstringinthash.php">＋<small>add a note</small></a></span>
