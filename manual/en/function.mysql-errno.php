...
<head>
  ...
  <title>PHP: mysql_errno - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-errno.php">
 <link rel="shorturl" href="https://www.php.net/mysql-errno">
 <link rel="alternate" href="https://www.php.net/mysql-errno" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-drop-db.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-errno.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-errno.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-errno.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-errno.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-errno.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-errno.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-errno.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-errno.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-errno.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-errno.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-errno.php" hreflang="zh">
...
<meta name="Description" content="Returns the numerical value of the error message from previous MySQL operation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_errno - Manual" />
<meta name="twitter:description" content="Returns the numerical value of the error message from previous MySQL operation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_errno - Manual" />
<meta itemprop="description" content="Returns the numerical value of the error message from previous MySQL operation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the numerical value of the error message from previous MySQL operation" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-error.php">
          mysql_error &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-drop-db.php">
          &laquo; mysql_drop_db        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-errno.php' selected="selected">English</option>
            <option value='de/function.mysql-errno.php'>German</option>
            <option value='es/function.mysql-errno.php'>Spanish</option>
            <option value='fr/function.mysql-errno.php'>French</option>
            <option value='it/function.mysql-errno.php'>Italian</option>
            <option value='ja/function.mysql-errno.php'>Japanese</option>
            <option value='pt_BR/function.mysql-errno.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-errno.php'>Russian</option>
            <option value='tr/function.mysql-errno.php'>Turkish</option>
            <option value='uk/function.mysql-errno.php'>Ukrainian</option>
            <option value='zh/function.mysql-errno.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-errno" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_errno</h1>
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_errno</span> &mdash; <span class="dc-title">Returns the numerical value of the error message from previous MySQL operation</span></p>

 </div>

 <div id="function.mysql-errno-refsynopsisdiv">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli.errno.php" class="function">mysqli_errno()</a></span></li>
    <li><span class="methodname"><a href="pdo.errorcode.php" class="methodname">PDO::errorCode()</a></span></li>
   </ul>
  </div>
 </div>

 <div class="refsect1 description" id="refsect1-function.mysql-errno-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_errno</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$link_identifier</code><span class="initializer"> = NULL</span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
  ...
  <p class="para">
   ...
   issue warnings. Instead, use <span class="function"><strong>mysql_errno()</strong></span> to
   ...
   including <span class="function"><a href="function.mysql-error.php" class="function">mysql_error()</a></span> and
   <span class="function"><strong>mysql_errno()</strong></span>), so if you want to use it,
 ...
 <div class="refsect1 parameters" id="refsect1-function.mysql-errno-parameters">
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> level error is generated.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-errno-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-errno-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1886">
    <p><strong>Example #1 <span class="function"><strong>mysql_errno()</strong></span> example</strong></p>
...
1146: Table &#039;kossu.nonexistenttable&#039; doesn&#039;t exist</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mysql-errno-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><a href="http://dev.mysql.com/doc/mysql/en/error-handling.html" class="link external">&raquo;&nbsp;MySQL error codes</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-errno.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-errno%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-errno.php">＋<small>add a note</small></a></span>
