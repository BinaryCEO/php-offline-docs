...
<head>
  ...
  <title>PHP: ImagickDraw::render - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.render.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.render.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.render.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.rectangle.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.resetvectorgraphics.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.render.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.render.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.render.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.render.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.render.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.render.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.render.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.render.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.render.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.render.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.render.php" hreflang="zh">
...
<meta name="Description" content="Renders all preceding drawing commands onto the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::render - Manual" />
<meta name="twitter:description" content="Renders all preceding drawing commands onto the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::render - Manual" />
<meta itemprop="description" content="Renders all preceding drawing commands onto the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Renders all preceding drawing commands onto the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.resetvectorgraphics.php">
          ImagickDraw::resetVectorGraphics &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.rectangle.php">
          &laquo; ImagickDraw::rectangle        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.render.php' selected="selected">English</option>
            <option value='de/imagickdraw.render.php'>German</option>
            <option value='es/imagickdraw.render.php'>Spanish</option>
            <option value='fr/imagickdraw.render.php'>French</option>
            <option value='it/imagickdraw.render.php'>Italian</option>
            <option value='ja/imagickdraw.render.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.render.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.render.php'>Russian</option>
            <option value='tr/imagickdraw.render.php'>Turkish</option>
            <option value='uk/imagickdraw.render.php'>Ukrainian</option>
            <option value='zh/imagickdraw.render.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.render" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::render</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::render</span> &mdash; <span class="dc-title">Renders all preceding drawing commands onto the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.render-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::render</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.render-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/render.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.render%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.render&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.render.php">＋<small>add a note</small></a></span>
