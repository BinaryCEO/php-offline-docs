...
<head>
  ...
  <title>PHP: mcrypt_module_is_block_mode - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-module-is-block-mode.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-module-is-block-mode">
 <link rel="alternate" href="https://www.php.net/mcrypt-module-is-block-mode" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-module-is-block-algorithm-mode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-module-open.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-module-is-block-mode.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-module-is-block-mode.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-module-is-block-mode.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-module-is-block-mode.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-module-is-block-mode.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-module-is-block-mode.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-module-is-block-mode.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-module-is-block-mode.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-module-is-block-mode.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-module-is-block-mode.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-module-is-block-mode.php" hreflang="zh">
...
<meta name="Description" content="Returns if the specified mode outputs blocks or not" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_module_is_block_mode - Manual" />
<meta name="twitter:description" content="Returns if the specified mode outputs blocks or not" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_module_is_block_mode - Manual" />
<meta itemprop="description" content="Returns if the specified mode outputs blocks or not" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns if the specified mode outputs blocks or not" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mcrypt-module-open.php">
          mcrypt_module_open &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-module-is-block-algorithm-mode.php">
          &laquo; mcrypt_module_is_block_algorithm_mode        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-module-is-block-mode.php' selected="selected">English</option>
            <option value='de/function.mcrypt-module-is-block-mode.php'>German</option>
            <option value='es/function.mcrypt-module-is-block-mode.php'>Spanish</option>
            <option value='fr/function.mcrypt-module-is-block-mode.php'>French</option>
            <option value='it/function.mcrypt-module-is-block-mode.php'>Italian</option>
            <option value='ja/function.mcrypt-module-is-block-mode.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-module-is-block-mode.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-module-is-block-mode.php'>Russian</option>
            <option value='tr/function.mcrypt-module-is-block-mode.php'>Turkish</option>
            <option value='uk/function.mcrypt-module-is-block-mode.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-module-is-block-mode.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-module-is-block-mode" class="refentry">
  ...
  <p class="para">
   ...
   <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> for cfb and stream).
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-module-is-block-mode.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-module-is-block-mode%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-module-is-block-mode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-module-is-block-mode.php">＋<small>add a note</small></a></span>
