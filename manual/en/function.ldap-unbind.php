...
<head>
  ...
  <title>PHP: ldap_unbind - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-unbind.php">
 <link rel="shorturl" href="https://www.php.net/ldap-unbind">
 <link rel="alternate" href="https://www.php.net/ldap-unbind" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-t61-to-8859.php">
 <link rel="next" href="https://www.php.net/manual/en/class.ldap-connection.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-unbind.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-unbind.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-unbind.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-unbind.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-unbind.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-unbind.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-unbind.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-unbind.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-unbind.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-unbind.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-unbind.php" hreflang="zh">
...
<meta name="Description" content="Unbind from LDAP directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_unbind - Manual" />
<meta name="twitter:description" content="Unbind from LDAP directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_unbind - Manual" />
<meta itemprop="description" content="Unbind from LDAP directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Unbind from LDAP directory" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.ldap-connection.php">
          LDAP\Connection &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-t61-to-8859.php">
          &laquo; ldap_t61_to_8859        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-unbind.php' selected="selected">English</option>
            <option value='de/function.ldap-unbind.php'>German</option>
            <option value='es/function.ldap-unbind.php'>Spanish</option>
            <option value='fr/function.ldap-unbind.php'>French</option>
            <option value='it/function.ldap-unbind.php'>Italian</option>
            <option value='ja/function.ldap-unbind.php'>Japanese</option>
            <option value='pt_BR/function.ldap-unbind.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-unbind.php'>Russian</option>
            <option value='tr/function.ldap-unbind.php'>Turkish</option>
            <option value='uk/function.ldap-unbind.php'>Ukrainian</option>
            <option value='zh/function.ldap-unbind.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-unbind" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_unbind</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_unbind</span> &mdash; <span class="dc-title">Unbind from LDAP directory</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ldap-unbind-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_unbind</strong></span>(<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ldap-unbind-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ldap-unbind-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.ldap-unbind-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ldap-unbind-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-bind.php" class="function" rel="rdfs-seeAlso">ldap_bind()</a> - Bind to LDAP directory</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-unbind.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-unbind%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-unbind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-unbind.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="17203">  <div class="votes">
    <div id="Vu17203">
    <a href="/manual/vote-note.php?id=17203&amp;page=function.ldap-unbind&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd17203">
    <a href="/manual/vote-note.php?id=17203&amp;page=function.ldap-unbind&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V17203" title="75% like this...">
    26
    </div>
  </div>
  <a href="#17203" class="name">
  <strong class="user"><em>kmenard at wpi dot edu</em></strong></a><a class="genanchor" href="#17203"> &para;</a><div class="date" title="2001-11-29 11:47"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom17203">
<div class="phpcode"><code><span class="html">ldap_unbind kills the link descriptor.  So, if you want to rebind as another user, just bind again; don't unbind.  Otherwise, you'll have to open up a new connection.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-unbind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-unbind.php">＋<small>add a note</small></a></div>
