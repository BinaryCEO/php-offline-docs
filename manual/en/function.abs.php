...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.abs.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/ref.math.php">
 <link rel="next" href="https://www.php.net/manual/en/function.acos.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.abs.php' selected="selected">English</option>
            ...
            <option value='ja/function.abs.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">abs</span> &mdash; <span class="dc-title">Absolute value</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.abs-description">
  ...
  <p class="para rdfs-comment">
   Returns the absolute value of <code class="parameter">num</code>. 
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.abs-returnvalues">
  ...
  <p class="para">
   The absolute value of <code class="parameter">num</code>. If the
   argument <code class="parameter">num</code> is
   of type <span class="type"><a href="language.types.float.php" class="type float">float</a></span>, the return type is also <span class="type"><a href="language.types.float.php" class="type float">float</a></span>,
   otherwise it is <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> (as <span class="type"><a href="language.types.float.php" class="type float">float</a></span> usually has a
   bigger value range than <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>).
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.abs-examples">
  ...
  <p class="para">
   <div class="example" id="example-3359">
    <p><strong>Example #1 <span class="function"><strong>abs()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.gmp-sign.php" class="function" rel="rdfs-seeAlso">gmp_sign()</a> - Sign of number</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/math/functions/abs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.abs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.abs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.abs.php">＋<small>add a note</small></a></span>
