...
<head>
  ...
  <title>PHP: CommonMark\Node\CustomInline - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.commonmark-node-custominline.php">
 <link rel="shorturl" href="https://www.php.net/commonmark-node-custominline">
 <link rel="alternate" href="https://www.php.net/commonmark-node-custominline" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.cmark.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.commonmark-node-customblock.php">
 <link rel="next" href="https://www.php.net/manual/en/class.commonmark-node.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.commonmark-node-custominline.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.commonmark-node-custominline.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.commonmark-node-custominline.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.commonmark-node-custominline.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.commonmark-node-custominline.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.commonmark-node-custominline.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.commonmark-node-custominline.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.commonmark-node-custominline.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.commonmark-node-custominline.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.commonmark-node-custominline.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.commonmark-node-custominline.php" hreflang="zh">
...
<meta name="Description" content="CustomInline concrete CommonMark\Node" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CommonMark\Node\CustomInline - Manual" />
<meta name="twitter:description" content="CustomInline concrete CommonMark\Node" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CommonMark\Node\CustomInline - Manual" />
<meta itemprop="description" content="CustomInline concrete CommonMark\Node" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="CustomInline concrete CommonMark\Node" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.commonmark-node.php">
          CommonMark\Node &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.commonmark-node-customblock.php">
          &laquo; CommonMark\Node\CustomBlock        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.commonmark-node-custominline.php' selected="selected">English</option>
            <option value='de/class.commonmark-node-custominline.php'>German</option>
            <option value='es/class.commonmark-node-custominline.php'>Spanish</option>
            <option value='fr/class.commonmark-node-custominline.php'>French</option>
            <option value='it/class.commonmark-node-custominline.php'>Italian</option>
            <option value='ja/class.commonmark-node-custominline.php'>Japanese</option>
            <option value='pt_BR/class.commonmark-node-custominline.php'>Brazilian Portuguese</option>
            <option value='ru/class.commonmark-node-custominline.php'>Russian</option>
            <option value='tr/class.commonmark-node-custominline.php'>Turkish</option>
            <option value='uk/class.commonmark-node-custominline.php'>Ukrainian</option>
            <option value='zh/class.commonmark-node-custominline.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.commonmark-node-custominline" class="reference">

 <h1 class="title">CustomInline concrete CommonMark\Node</h1>
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      ...
      <span class="modifier">class</span> <strong class="classname">CommonMark\Node\CustomInline</strong>
     </span>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="commonmark-node.accept.php" class="methodname">CommonMark\Node::accept</a></span>(<span class="methodparam"><span class="type"><a href="class.commonmark-interfaces-ivisitor.php" class="type CommonMark\Interfaces\IVisitor">CommonMark\Interfaces\IVisitor</a></span> <code class="parameter">$visitor</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cmark/commonmark.node.custominline.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.commonmark-node-custominline%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.commonmark-node-custominline&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.commonmark-node-custominline.php">＋<small>add a note</small></a></span>
