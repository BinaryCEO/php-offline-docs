...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-public-decrypt.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-private-encrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-public-encrypt.php">
...
<meta name="Description" content="Decrypts data with public key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_public_decrypt - Manual" />
<meta name="twitter:description" content="Decrypts data with public key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_public_decrypt - Manual" />
<meta itemprop="description" content="Decrypts data with public key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decrypts data with public key" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-public-decrypt.php' selected="selected">English</option>
            ...
            <option value='ru/function.openssl-public-decrypt.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_public_decrypt</span> &mdash; <span class="dc-title">Decrypts data with public key</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-public-decrypt-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>openssl_public_decrypt()</strong></span> decrypts
   <code class="parameter">data</code> that was previous encrypted via
   <span class="function"><a href="function.openssl-private-encrypt.php" class="function">openssl_private_encrypt()</a></span> and stores the result into
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.openssl-private-decrypt.php" class="function" rel="rdfs-seeAlso">openssl_private_decrypt()</a> - Decrypts data with private key</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-public-decrypt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-public-decrypt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-public-decrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-public-decrypt.php">＋<small>add a note</small></a></span>
