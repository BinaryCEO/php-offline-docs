...
<head>
  ...
  <title>PHP: trader_beta - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-beta.php">
 <link rel="shorturl" href="https://www.php.net/trader-beta">
 <link rel="alternate" href="https://www.php.net/trader-beta" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-bbands.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-bop.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-beta.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-beta.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-beta.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-beta.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-beta.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-beta.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-beta.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-beta.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-beta.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-beta.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-beta.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: trader_beta - Manual" />
<meta name="twitter:description" content="Beta" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_beta - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-beta.php' selected="selected">English</option>
            <option value='de/function.trader-beta.php'>German</option>
            <option value='es/function.trader-beta.php'>Spanish</option>
            <option value='fr/function.trader-beta.php'>French</option>
            <option value='it/function.trader-beta.php'>Italian</option>
            <option value='ja/function.trader-beta.php'>Japanese</option>
            <option value='pt_BR/function.trader-beta.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-beta.php'>Russian</option>
            <option value='tr/function.trader-beta.php'>Turkish</option>
            <option value='uk/function.trader-beta.php'>Ukrainian</option>
            <option value='zh/function.trader-beta.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-beta" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_beta</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_beta</span> &mdash; <span class="dc-title">Beta</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-beta-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_beta</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real0</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real1</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-beta-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-beta-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-beta.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-beta%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-beta&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-beta.php">＋<small>add a note</small></a></span>
