...
<head>
  ...
  <title>PHP: eio_grp_add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-grp-add.php">
 <link rel="shorturl" href="https://www.php.net/eio-grp-add">
 <link rel="alternate" href="https://www.php.net/eio-grp-add" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-grp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-grp-cancel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-grp-add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-grp-add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-grp-add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-grp-add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-grp-add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-grp-add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-grp-add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-grp-add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-grp-add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-grp-add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-grp-add.php" hreflang="zh">
...
<meta name="Description" content="Adds a request to the request group" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_grp_add - Manual" />
<meta name="twitter:description" content="Adds a request to the request group" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_grp_add - Manual" />
<meta itemprop="description" content="Adds a request to the request group" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds a request to the request group" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.eio-grp-cancel.php">
          eio_grp_cancel &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-grp.php">
          &laquo; eio_grp        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-grp-add.php' selected="selected">English</option>
            <option value='de/function.eio-grp-add.php'>German</option>
            <option value='es/function.eio-grp-add.php'>Spanish</option>
            <option value='fr/function.eio-grp-add.php'>French</option>
            <option value='it/function.eio-grp-add.php'>Italian</option>
            <option value='ja/function.eio-grp-add.php'>Japanese</option>
            <option value='pt_BR/function.eio-grp-add.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-grp-add.php'>Russian</option>
            <option value='tr/function.eio-grp-add.php'>Turkish</option>
            <option value='uk/function.eio-grp-add.php'>Ukrainian</option>
            <option value='zh/function.eio-grp-add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-grp-add" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-grp-add-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_grp_add</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$grp</code></span>, <span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$req</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
 ...
 <div class="refsect1 examples" id="refsect1-function.eio-grp-add-examples">
  ...
  <div class="example" id="example-3513">
...
bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-grp-add-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.eio-grp-cancel.php" class="function" rel="rdfs-seeAlso">eio_grp_cancel()</a> - Cancels a request group</span></li>
   <li><span class="function"><a href="function.eio-grp-limit.php" class="function" rel="rdfs-seeAlso">eio_grp_limit()</a> - Set group limit</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-grp-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-grp-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-grp-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-grp-add.php">＋<small>add a note</small></a></span>
