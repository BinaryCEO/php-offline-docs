...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-point.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/ui.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-point.at.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-point.php' selected="selected">English</option>
            ...
            <option value='tr/class.ui-point.php'>Turkish</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-point.at.php">UI\Point::at</a> — Size Coercion</li><li><a href="ui-point.construct.php">UI\Point::__construct</a> — Construct a new Point</li><li><a href="ui-point.getx.php">UI\Point::getX</a> — Retrieves X</li><li><a href="ui-point.gety.php">UI\Point::getY</a> — Retrieves Y</li><li><a href="ui-point.setx.php">UI\Point::setX</a> — Set X</li><li><a href="ui-point.sety.php">UI\Point::setY</a> — Set Y</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.point.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-point%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-point&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-point.php">＋<small>add a note</small></a></span>
