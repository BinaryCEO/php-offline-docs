...
<head>
  ...
  <title>PHP: openssl_pkey_get_details - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-pkey-get-details.php">
 <link rel="shorturl" href="https://www.php.net/openssl-pkey-get-details">
 <link rel="alternate" href="https://www.php.net/openssl-pkey-get-details" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-pkey-free.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-pkey-get-private.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-pkey-get-details.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-pkey-get-details.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-pkey-get-details.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-pkey-get-details.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-pkey-get-details.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-pkey-get-details.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-pkey-get-details.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-pkey-get-details.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-pkey-get-details.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-pkey-get-details.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-pkey-get-details.php" hreflang="zh">
...
<meta name="Description" content="Returns an array with the key details" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_pkey_get_details - Manual" />
<meta name="twitter:description" content="Returns an array with the key details" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_pkey_get_details - Manual" />
<meta itemprop="description" content="Returns an array with the key details" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array with the key details" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-pkey-get-private.php">
          openssl_pkey_get_private &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-pkey-free.php">
          &laquo; openssl_pkey_free        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-pkey-get-details.php' selected="selected">English</option>
            <option value='de/function.openssl-pkey-get-details.php'>German</option>
            <option value='es/function.openssl-pkey-get-details.php'>Spanish</option>
            <option value='fr/function.openssl-pkey-get-details.php'>French</option>
            <option value='it/function.openssl-pkey-get-details.php'>Italian</option>
            <option value='ja/function.openssl-pkey-get-details.php'>Japanese</option>
            <option value='pt_BR/function.openssl-pkey-get-details.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-pkey-get-details.php'>Russian</option>
            <option value='tr/function.openssl-pkey-get-details.php'>Turkish</option>
            <option value='uk/function.openssl-pkey-get-details.php'>Ukrainian</option>
            <option value='zh/function.openssl-pkey-get-details.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-pkey-get-details" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_pkey_get_details</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_pkey_get_details</span> &mdash; <span class="dc-title">Returns an array with the key details</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.openssl-pkey-get-details-returnvalues">
  ...
  <p class="para">
   Returns an array with the key details on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
   Returned array has indexes <code class="literal">bits</code> (number of bits),
   <code class="literal">key</code> (string representation of the public key) and
   <code class="literal">type</code> (type of the key which is one of
   ...
   or <code class="literal">-1</code> meaning unknown).
  </p>
  <p class="para">
  ...
  <ul class="itemizedlist">
   <li class="listitem">
    <span class="simpara">
     <strong><code><a href="openssl.key-types.php#constant.openssl-keytype-rsa">OPENSSL_KEYTYPE_RSA</a></code></strong>, an additional array key named <code class="literal">&quot;rsa&quot;</code>, 
   ...
   <li class="listitem">
    <span class="simpara">
     <strong><code><a href="openssl.key-types.php#constant.openssl-keytype-dsa">OPENSSL_KEYTYPE_DSA</a></code></strong>, an additional array key named <code class="literal">&quot;dsa&quot;</code>, 
     containing the key data is returned.
    </span>
     <table class="doctable informaltable">
   ...
   <li class="listitem">
    <span class="simpara">
     <strong><code><a href="openssl.key-types.php#constant.openssl-keytype-dh">OPENSSL_KEYTYPE_DH</a></code></strong>, an additional array key named <code class="literal">&quot;dh&quot;</code>, 
     containing the key data is returned.
    </span>
     <table class="doctable informaltable">
   ...
   <li class="listitem">
    <span class="simpara">
     ...
     <strong><code><a href="openssl.key-types.php#constant.openssl-keytype-ed25519">OPENSSL_KEYTYPE_ED25519</a></code></strong>,
     <strong><code><a href="openssl.key-types.php#constant.openssl-keytype-x448">OPENSSL_KEYTYPE_X448</a></code></strong>,
     or <strong><code><a href="openssl.key-types.php#constant.openssl-keytype-ed448">OPENSSL_KEYTYPE_ED448</a></code></strong>
     an additional array key named
     <code class="literal">&quot;x25519&quot;</code>,
     <code class="literal">&quot;ed25519&quot;</code>,
     <code class="literal">&quot;x448&quot;</code>,
     or <code class="literal">&quot;ed448&quot;</code> respectively,
    ...
    <tbody class="tbody">
     <tr>
      ...
      <td>
       ...
       Specifically the <code class="literal">x25519</code>, <code class="literal">ed25519</code>,
       <code class="literal">x448</code> and <code class="literal">ed448</code> fields have been introduced.
      </td>
     </tr>
     ...
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-pkey-get-details.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-pkey-get-details%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-pkey-get-details&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkey-get-details.php">＋<small>add a note</small></a></span>
