...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-scanmailbox.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-scan.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-search.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-scanmailbox.php' selected="selected">English</option>
            <option value='de/function.imap-scanmailbox.php'>German</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_scanmailbox</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.imap-listscan.php" class="function">imap_listscan()</a></span></span></p>
  ...
  <p class="simpara">
   ...
   <span class="function"><a href="function.imap-listscan.php" class="function">imap_listscan()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-scanmailbox.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-scanmailbox%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-scanmailbox&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-scanmailbox.php">＋<small>add a note</small></a></span>
