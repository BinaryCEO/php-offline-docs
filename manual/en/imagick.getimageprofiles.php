...
<head>
  ...
  <title>PHP: Imagick::getImageProfiles - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageprofiles.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageprofiles.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageprofiles.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageprofile.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageproperties.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageprofiles.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageprofiles.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageprofiles.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageprofiles.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageprofiles.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageprofiles.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageprofiles.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageprofiles.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageprofiles.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageprofiles.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageprofiles.php" hreflang="zh">
...
<meta name="Description" content="Returns the image profiles" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageProfiles - Manual" />
<meta name="twitter:description" content="Returns the image profiles" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageProfiles - Manual" />
<meta itemprop="description" content="Returns the image profiles" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the image profiles" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimageproperties.php">
          Imagick::getImageProperties &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageprofile.php">
          &laquo; Imagick::getImageProfile        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageprofiles.php' selected="selected">English</option>
            <option value='de/imagick.getimageprofiles.php'>German</option>
            <option value='es/imagick.getimageprofiles.php'>Spanish</option>
            <option value='fr/imagick.getimageprofiles.php'>French</option>
            <option value='it/imagick.getimageprofiles.php'>Italian</option>
            <option value='ja/imagick.getimageprofiles.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageprofiles.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageprofiles.php'>Russian</option>
            <option value='tr/imagick.getimageprofiles.php'>Turkish</option>
            <option value='uk/imagick.getimageprofiles.php'>Ukrainian</option>
            <option value='zh/imagick.getimageprofiles.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageprofiles" class="refentry">
  ...
  <p class="para">
   Returns an array containing the image profiles or profile names.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageprofiles.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageprofiles%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageprofiles&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageprofiles.php">＋<small>add a note</small></a></span>
