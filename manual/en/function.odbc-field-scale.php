...
<head>
  ...
  <title>PHP: odbc_field_scale - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-field-scale.php">
 <link rel="shorturl" href="https://www.php.net/odbc-field-scale">
 <link rel="alternate" href="https://www.php.net/odbc-field-scale" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-field-precision.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-field-type.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-field-scale.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-field-scale.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-field-scale.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-field-scale.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-field-scale.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-field-scale.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-field-scale.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-field-scale.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-field-scale.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-field-scale.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-field-scale.php" hreflang="zh">
...
<meta name="Description" content="Get the scale of a field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_field_scale - Manual" />
<meta name="twitter:description" content="Get the scale of a field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_field_scale - Manual" />
<meta itemprop="description" content="Get the scale of a field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the scale of a field" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.odbc-field-type.php">
          odbc_field_type &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-field-precision.php">
          &laquo; odbc_field_precision        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-field-scale.php' selected="selected">English</option>
            <option value='de/function.odbc-field-scale.php'>German</option>
            <option value='es/function.odbc-field-scale.php'>Spanish</option>
            <option value='fr/function.odbc-field-scale.php'>French</option>
            <option value='it/function.odbc-field-scale.php'>Italian</option>
            <option value='ja/function.odbc-field-scale.php'>Japanese</option>
            <option value='pt_BR/function.odbc-field-scale.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-field-scale.php'>Russian</option>
            <option value='tr/function.odbc-field-scale.php'>Turkish</option>
            <option value='uk/function.odbc-field-scale.php'>Ukrainian</option>
            <option value='zh/function.odbc-field-scale.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-field-scale" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">odbc_field_scale</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">odbc_field_scale</span> &mdash; <span class="dc-title">Get the scale of a field</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.odbc-field-scale-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>odbc_field_scale</strong></span>(<span class="methodparam"><span class="type">Odbc\Result</span> <code class="parameter">$statement</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.odbc-field-scale-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-field-scale-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the field scale as a integer, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.odbc-field-scale-changelog">
 ...
 <td>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-field-scale.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-field-scale%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-field-scale&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-field-scale.php">＋<small>add a note</small></a></span>
