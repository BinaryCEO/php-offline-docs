...
<head>
  ...
  <title>PHP: stream_context_set_default - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-context-set-default.php">
 <link rel="shorturl" href="https://www.php.net/stream-context-set-default">
 <link rel="alternate" href="https://www.php.net/stream-context-set-default" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-context-get-params.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-context-set-option.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-context-set-default.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-context-set-default.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-context-set-default.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-context-set-default.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-context-set-default.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-context-set-default.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-context-set-default.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-context-set-default.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-context-set-default.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-context-set-default.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-context-set-default.php" hreflang="zh">
...
<meta name="Description" content="Set the default stream context" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_context_set_default - Manual" />
<meta name="twitter:description" content="Set the default stream context" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_context_set_default - Manual" />
<meta itemprop="description" content="Set the default stream context" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the default stream context" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-context-set-option.php">
          stream_context_set_option &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-context-get-params.php">
          &laquo; stream_context_get_params        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-context-set-default.php' selected="selected">English</option>
            <option value='de/function.stream-context-set-default.php'>German</option>
            <option value='es/function.stream-context-set-default.php'>Spanish</option>
            <option value='fr/function.stream-context-set-default.php'>French</option>
            <option value='it/function.stream-context-set-default.php'>Italian</option>
            <option value='ja/function.stream-context-set-default.php'>Japanese</option>
            <option value='pt_BR/function.stream-context-set-default.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-context-set-default.php'>Russian</option>
            <option value='tr/function.stream-context-set-default.php'>Turkish</option>
            <option value='uk/function.stream-context-set-default.php'>Ukrainian</option>
            <option value='zh/function.stream-context-set-default.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-context-set-default" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li>Listing of supported wrappers with context options (<a href="wrappers.php" class="xref">Supported Protocols and Wrappers</a>).</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-context-set-default.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-context-set-default%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-context-set-default&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-context-set-default.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126496">  <div class="votes">
    <div id="Vu126496">
    <a href="/manual/vote-note.php?id=126496&amp;page=function.stream-context-set-default&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126496">
    <a href="/manual/vote-note.php?id=126496&amp;page=function.stream-context-set-default&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126496" title="100% like this...">
    1
    </div>
  </div>
  <a href="#126496" class="name">
  <strong class="user"><em>Mahmoud Saeed</em></strong></a><a class="genanchor" href="#126496"> &para;</a><div class="date" title="2021-10-11 04:49"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126496">
<div class="phpcode"><code><span class="html">It's worth mentioning that passing an empty array will NOT reset default options.<br /><br /><span class="default">&lt;?php<br />stream_context_set_default</span><span class="keyword">(array()); </span><span class="comment">// Does nothing.<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stream-context-set-default&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-context-set-default.php">＋<small>add a note</small></a></div>
