...
<head>
  ...
  <title>PHP: Phar::isFileFormat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.isfileformat.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.isfileformat.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.isfileformat.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.iscompressed.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.isvalidpharfilename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.isfileformat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.isfileformat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.isfileformat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.isfileformat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.isfileformat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.isfileformat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.isfileformat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.isfileformat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.isfileformat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.isfileformat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.isfileformat.php" hreflang="zh">
...
<meta name="Description" content="Returns true if the phar archive is based on the tar/phar/zip file format depending on the parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::isFileFormat - Manual" />
<meta name="twitter:description" content="Returns true if the phar archive is based on the tar/phar/zip file format depending on the parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::isFileFormat - Manual" />
<meta itemprop="description" content="Returns true if the phar archive is based on the tar/phar/zip file format depending on the parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns true if the phar archive is based on the tar/phar/zip file format depending on the parameter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.isvalidpharfilename.php">
          Phar::isValidPharFilename &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.iscompressed.php">
          &laquo; Phar::isCompressed        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.isfileformat.php' selected="selected">English</option>
            <option value='de/phar.isfileformat.php'>German</option>
            <option value='es/phar.isfileformat.php'>Spanish</option>
            <option value='fr/phar.isfileformat.php'>French</option>
            <option value='it/phar.isfileformat.php'>Italian</option>
            <option value='ja/phar.isfileformat.php'>Japanese</option>
            <option value='pt_BR/phar.isfileformat.php'>Brazilian Portuguese</option>
            <option value='ru/phar.isfileformat.php'>Russian</option>
            <option value='tr/phar.isfileformat.php'>Turkish</option>
            <option value='uk/phar.isfileformat.php'>Ukrainian</option>
            <option value='zh/phar.isfileformat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.isfileformat" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.converttodata.php" class="function" rel="rdfs-seeAlso">Phar::convertToData()</a> - Convert a phar archive to a non-executable tar or zip file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/isFileFormat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.isfileformat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.isfileformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.isfileformat.php">＋<small>add a note</small></a></span>
