...
<head>
  ...
  <title>PHP: ImagickDraw::polygon - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.polygon.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.polygon.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.polygon.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.point.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.polyline.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.polygon.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.polygon.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.polygon.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.polygon.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.polygon.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.polygon.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.polygon.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.polygon.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.polygon.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.polygon.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.polygon.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::polygon - Manual" />
<meta name="twitter:description" content="Draws a polygon" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::polygon - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.polyline.php">
          ImagickDraw::polyline &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.point.php">
          &laquo; ImagickDraw::point        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.polygon.php' selected="selected">English</option>
            <option value='de/imagickdraw.polygon.php'>German</option>
            <option value='es/imagickdraw.polygon.php'>Spanish</option>
            <option value='fr/imagickdraw.polygon.php'>French</option>
            <option value='it/imagickdraw.polygon.php'>Italian</option>
            <option value='ja/imagickdraw.polygon.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.polygon.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.polygon.php'>Russian</option>
            <option value='tr/imagickdraw.polygon.php'>Turkish</option>
            <option value='uk/imagickdraw.polygon.php'>Ukrainian</option>
            <option value='zh/imagickdraw.polygon.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.polygon" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::polygon</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::polygon</span> &mdash; <span class="dc-title">Draws a polygon</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.polygon-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::polygon</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$coordinates</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.polygon-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.polygon-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.polygon-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3158">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::polygon()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/polygon.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.polygon%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.polygon&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.polygon.php">＋<small>add a note</small></a></span>
