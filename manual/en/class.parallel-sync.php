...
<head>
  ...
  <title>PHP: parallel\Sync - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.parallel-sync.php">
 <link rel="shorturl" href="https://www.php.net/parallel-sync">
 <link rel="alternate" href="https://www.php.net/parallel-sync" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.parallel.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.parallel-events-event-type.php">
 <link rel="next" href="https://www.php.net/manual/en/parallel-sync.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.parallel-sync.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.parallel-sync.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.parallel-sync.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.parallel-sync.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.parallel-sync.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.parallel-sync.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.parallel-sync.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.parallel-sync.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.parallel-sync.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.parallel-sync.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.parallel-sync.php" hreflang="zh">
...
<meta name="Description" content="The parallel\Sync class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: parallel\Sync - Manual" />
<meta name="twitter:description" content="The parallel\Sync class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: parallel\Sync - Manual" />
<meta itemprop="description" content="The parallel\Sync class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The parallel\Sync class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="parallel-sync.construct.php">
          parallel\Sync::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.parallel-events-event-type.php">
          &laquo; parallel\Events\Event\Type        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.parallel-sync.php' selected="selected">English</option>
            <option value='de/class.parallel-sync.php'>German</option>
            <option value='es/class.parallel-sync.php'>Spanish</option>
            <option value='fr/class.parallel-sync.php'>French</option>
            <option value='it/class.parallel-sync.php'>Italian</option>
            <option value='ja/class.parallel-sync.php'>Japanese</option>
            <option value='pt_BR/class.parallel-sync.php'>Brazilian Portuguese</option>
            <option value='ru/class.parallel-sync.php'>Russian</option>
            <option value='tr/class.parallel-sync.php'>Turkish</option>
            <option value='uk/class.parallel-sync.php'>Ukrainian</option>
            <option value='zh/class.parallel-sync.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.parallel-sync" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="parallel-sync.construct.php">parallel\Sync::__construct</a> — Construction</li><li><a href="parallel-sync.get.php">parallel\Sync::get</a> — Access</li><li><a href="parallel-sync.set.php">parallel\Sync::set</a> — Access</li><li><a href="parallel-sync.wait.php">parallel\Sync::wait</a> — Synchronization</li><li><a href="parallel-sync.notify.php">parallel\Sync::notify</a> — Synchronization</li><li><a href="parallel-sync.invoke.php">parallel\Sync::__invoke</a> — Synchronization</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/parallel/parallel.sync.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.parallel-sync%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.parallel-sync&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.parallel-sync.php">＋<small>add a note</small></a></span>
