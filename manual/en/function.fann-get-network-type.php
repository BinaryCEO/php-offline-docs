...
<head>
  ...
  <title>PHP: fann_get_network_type - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-network-type.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-network-type">
 <link rel="alternate" href="https://www.php.net/fann-get-network-type" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-mse.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-num-input.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-network-type.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-network-type.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-network-type.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-network-type.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-network-type.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-network-type.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-network-type.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-network-type.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-network-type.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-network-type.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-network-type.php" hreflang="zh">
...
<meta name="Description" content="Get the type of neural network it was created as" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_network_type - Manual" />
<meta name="twitter:description" content="Get the type of neural network it was created as" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_network_type - Manual" />
<meta itemprop="description" content="Get the type of neural network it was created as" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the type of neural network it was created as" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-get-num-input.php">
          fann_get_num_input &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-mse.php">
          &laquo; fann_get_MSE        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-network-type.php' selected="selected">English</option>
            <option value='de/function.fann-get-network-type.php'>German</option>
            <option value='es/function.fann-get-network-type.php'>Spanish</option>
            <option value='fr/function.fann-get-network-type.php'>French</option>
            <option value='it/function.fann-get-network-type.php'>Italian</option>
            <option value='ja/function.fann-get-network-type.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-network-type.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-network-type.php'>Russian</option>
            <option value='tr/function.fann-get-network-type.php'>Turkish</option>
            <option value='uk/function.fann-get-network-type.php'>Ukrainian</option>
            <option value='zh/function.fann-get-network-type.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-network-type" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_get_network_type</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_get_network_type</span> &mdash; <span class="dc-title">Get the type of neural network it was created as</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-get-network-type-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_get_network_type</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-get-network-type-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-network-type-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
    <a href="fann.constants.php#constants.fann-nettype" class="link">Network type</a> constant, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-network-type.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-network-type%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-network-type&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-network-type.php">＋<small>add a note</small></a></span>
