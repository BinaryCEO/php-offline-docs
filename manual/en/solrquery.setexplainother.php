...
<head>
  ...
  <title>PHP: SolrQuery::setExplainOther - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setexplainother.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setexplainother.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setexplainother.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setexpandrows.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setfacet.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setexplainother.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setexplainother.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setexplainother.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setexplainother.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setexplainother.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setexplainother.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setexplainother.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setexplainother.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setexplainother.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setexplainother.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setexplainother.php" hreflang="zh">
...
<meta name="Description" content="Sets the explainOther common query parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setExplainOther - Manual" />
<meta name="twitter:description" content="Sets the explainOther common query parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setExplainOther - Manual" />
<meta itemprop="description" content="Sets the explainOther common query parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the explainOther common query parameter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setfacet.php">
          SolrQuery::setFacet &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setexpandrows.php">
          &laquo; SolrQuery::setExpandRows        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setexplainother.php' selected="selected">English</option>
            <option value='de/solrquery.setexplainother.php'>German</option>
            <option value='es/solrquery.setexplainother.php'>Spanish</option>
            <option value='fr/solrquery.setexplainother.php'>French</option>
            <option value='it/solrquery.setexplainother.php'>Italian</option>
            <option value='ja/solrquery.setexplainother.php'>Japanese</option>
            <option value='pt_BR/solrquery.setexplainother.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setexplainother.php'>Russian</option>
            <option value='tr/solrquery.setexplainother.php'>Turkish</option>
            <option value='uk/solrquery.setexplainother.php'>Ukrainian</option>
            <option value='zh/solrquery.setexplainother.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setexplainother" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setExplainOther</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setExplainOther</span> &mdash; <span class="dc-title">Sets the explainOther common query parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setexplainother-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setExplainOther</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$query</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setexplainother-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setexplainother-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setexplainother.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setexplainother%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setexplainother&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setexplainother.php">＋<small>add a note</small></a></span>
