...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.removeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.removeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.removeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.remapimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.removeimageprofile.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.removeimage.php' selected="selected">English</option>
            ...
            <option value='pt_BR/imagick.removeimage.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::removeImage</span> &mdash; <span class="dc-title">Removes an image from the image list</span></p>
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/removeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.removeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.removeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.removeimage.php">＋<small>add a note</small></a></span>
