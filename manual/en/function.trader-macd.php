...
<head>
  ...
  <title>PHP: trader_macd - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-macd.php">
 <link rel="shorturl" href="https://www.php.net/trader-macd">
 <link rel="alternate" href="https://www.php.net/trader-macd" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-ma.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-macdext.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-macd.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-macd.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-macd.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-macd.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-macd.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-macd.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-macd.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-macd.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-macd.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-macd.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-macd.php" hreflang="zh">
...
<meta name="Description" content="Moving Average Convergence/Divergence" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_macd - Manual" />
<meta name="twitter:description" content="Moving Average Convergence/Divergence" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_macd - Manual" />
<meta itemprop="description" content="Moving Average Convergence/Divergence" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Moving Average Convergence/Divergence" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-macdext.php">
          trader_macdext &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-macd.php' selected="selected">English</option>
            <option value='de/function.trader-macd.php'>German</option>
            <option value='es/function.trader-macd.php'>Spanish</option>
            <option value='fr/function.trader-macd.php'>French</option>
            <option value='it/function.trader-macd.php'>Italian</option>
            <option value='ja/function.trader-macd.php'>Japanese</option>
            <option value='pt_BR/function.trader-macd.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-macd.php'>Russian</option>
            <option value='tr/function.trader-macd.php'>Turkish</option>
            <option value='uk/function.trader-macd.php'>Ukrainian</option>
            <option value='zh/function.trader-macd.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-macd" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_macd</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_macd</span> &mdash; <span class="dc-title">Moving Average Convergence/Divergence</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-macd-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_macd</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fastPeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$slowPeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$signalPeriod</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-macd-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">signalPeriod</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-macd-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-macd.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-macd%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-macd&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-macd.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114213">  <div class="votes">
    <div id="Vu114213">
    <a href="/manual/vote-note.php?id=114213&amp;page=function.trader-macd&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114213">
    <a href="/manual/vote-note.php?id=114213&amp;page=function.trader-macd&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114213" title="49% like this...">
    -1
    </div>
  </div>
  <a href="#114213" class="name">
  <strong class="user"><em>koenig at globaltown dot de</em></strong></a><a class="genanchor" href="#114213"> &para;</a><div class="date" title="2014-01-25 11:25"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114213">
<div class="phpcode"><code><span class="html">Return value of this function is an array of arrays :<br /><br />index [0]: MACD values<br />index [1]: Signal values<br />index [2]: Divergence values</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-macd&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-macd.php">＋<small>add a note</small></a></div>
