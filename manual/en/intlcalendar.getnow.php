...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.getnow.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.getnow.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getnow.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.getminimum.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.getrepeatedwalltimeoption.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.getnow.php' selected="selected">English</option>
            ...
            <option value='tr/intlcalendar.getnow.php'>Turkish</option>
 ...
 <div class="refsect1 examples" id="refsect1-intlcalendar.getnow-examples">
  ...
  <p class="para">
   ...
   <p><strong>Example #1 <span class="function"><strong>IntlCalendar::getNow()</strong></span></strong></p>
...
lunes, 17 de junio de 2013 01:36:54 Hora de verano de Europa central</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/getnow.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.getnow%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.getnow&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.getnow.php">＋<small>add a note</small></a></span>
