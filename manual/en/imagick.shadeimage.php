...
<head>
  ...
  <title>PHP: Imagick::shadeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.shadeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.shadeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.shadeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.settype.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.shadowimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.shadeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.shadeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.shadeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.shadeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.shadeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.shadeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.shadeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.shadeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.shadeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.shadeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.shadeimage.php" hreflang="zh">
...
<meta name="Description" content="Creates a 3D effect" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::shadeImage - Manual" />
<meta name="twitter:description" content="Creates a 3D effect" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::shadeImage - Manual" />
<meta itemprop="description" content="Creates a 3D effect" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a 3D effect" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.shadowimage.php">
          Imagick::shadowImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.settype.php">
          &laquo; Imagick::setType        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.shadeimage.php' selected="selected">English</option>
            <option value='de/imagick.shadeimage.php'>German</option>
            <option value='es/imagick.shadeimage.php'>Spanish</option>
            <option value='fr/imagick.shadeimage.php'>French</option>
            <option value='it/imagick.shadeimage.php'>Italian</option>
            <option value='ja/imagick.shadeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.shadeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.shadeimage.php'>Russian</option>
            <option value='tr/imagick.shadeimage.php'>Turkish</option>
            <option value='uk/imagick.shadeimage.php'>Ukrainian</option>
            <option value='zh/imagick.shadeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.shadeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::shadeImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::shadeImage</span> &mdash; <span class="dc-title">Creates a 3D effect</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.shadeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::shadeImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$gray</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$azimuth</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$elevation</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.shadeimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">azimuth</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">elevation</code></dt>
     <dd>
      <p class="para">
       Defines the light source direction.
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.shadeimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.shadeimage-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.shadeimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3110">
      <p><strong>Example #1  <span class="function"><strong>Imagick::shadeImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/shadeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.shadeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.shadeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.shadeimage.php">＋<small>add a note</small></a></span>
