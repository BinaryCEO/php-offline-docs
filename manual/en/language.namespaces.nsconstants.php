...
<head>
  ...
  <title>PHP: namespace keyword and __NAMESPACE__ - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.namespaces.nsconstants.php">
 <link rel="shorturl" href="https://www.php.net/namespaces.nsconstants">
 <link rel="alternate" href="https://www.php.net/namespaces.nsconstants" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.namespaces.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.namespaces.dynamic.php">
 <link rel="next" href="https://www.php.net/manual/en/language.namespaces.importing.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.namespaces.nsconstants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.namespaces.nsconstants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.namespaces.nsconstants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.namespaces.nsconstants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.namespaces.nsconstants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.namespaces.nsconstants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.namespaces.nsconstants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.namespaces.nsconstants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.namespaces.nsconstants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.namespaces.nsconstants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.namespaces.nsconstants.php" hreflang="zh">
...
<meta name="Description" content="The namespace keyword and __NAMESPACE__ magic constant" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: namespace keyword and __NAMESPACE__ - Manual" />
<meta name="twitter:description" content="The namespace keyword and __NAMESPACE__ magic constant" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: namespace keyword and __NAMESPACE__ - Manual" />
<meta itemprop="description" content="The namespace keyword and __NAMESPACE__ magic constant" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The namespace keyword and __NAMESPACE__ magic constant" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="language.namespaces.importing.php">
          Aliasing and Importing &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="language.namespaces.dynamic.php">
          &laquo; Namespaces and dynamic language features        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.namespaces.nsconstants.php' selected="selected">English</option>
            ...
            <option value='it/language.namespaces.nsconstants.php'>Italian</option>
            ...
            <option value='uk/language.namespaces.nsconstants.php'>Ukrainian</option>
  ...
  </div><div id="language.namespaces.nsconstants" class="sect1">
  ...
  <p class="para">
   ...
   the <strong><code><a href="language.constants.magic.php#constant.namespace">__NAMESPACE__</a></code></strong> magic constant, and the <code class="literal">namespace</code>
   keyword.
  </p>
  <p class="para">
   The value of <strong><code><a href="language.constants.magic.php#constant.namespace">__NAMESPACE__</a></code></strong> is a string that contains the current
   ...
   The <strong><code><a href="language.constants.magic.php#constant.namespace">__NAMESPACE__</a></code></strong> constant is useful for dynamically constructing
   names, for instance:
    ...
    <div class="example-contents">
     <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />namespace\func</span><span style="color: #007700">(); </span><span style="color: #FF8000">// calls function func()<br /></span><span style="color: #0000BB">namespace\sub\func</span><span style="color: #007700">(); </span><span style="color: #FF8000">// calls function sub\func()<br /></span><span style="color: #0000BB">namespace\cname</span><span style="color: #007700">::</span><span style="color: #0000BB">method</span><span style="color: #007700">(); </span><span style="color: #FF8000">// calls static method "method" of class cname<br /></span><span style="color: #0000BB">$a </span><span style="color: #007700">= new </span><span style="color: #0000BB">namespace\sub\cname</span><span style="color: #007700">(); </span><span style="color: #FF8000">// instantiates object of class sub\cname<br /></span><span style="color: #0000BB">$b </span><span style="color: #007700">= </span><span style="color: #0000BB">namespace\CONSTANT</span><span style="color: #007700">; </span><span style="color: #FF8000">// assigns value of constant CONSTANT to $b<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.namespaces.nsconstants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.namespaces.nsconstants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.namespaces.nsconstants.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96010">  <div class="votes">
    <div id="Vu96010">
    <a href="/manual/vote-note.php?id=96010&amp;page=language.namespaces.nsconstants&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96010">
    <a href="/manual/vote-note.php?id=96010&amp;page=language.namespaces.nsconstants&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96010" title="72% like this...">
    88
    </div>
  </div>
  <a href="#96010" class="name">
  <strong class="user"><em>a dot schaffhirt at sedna-soft dot de</em></strong></a><a class="genanchor" href="#96010"> &para;</a><div class="date" title="2010-02-02 06:24"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96010">
<div class="phpcode"><code><span class="html">Just in case you wonder what the practical use of the namespace keyword is...
<br />
...
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">namespace </span><span class="default">bar</span><span class="keyword">;
<br />use </span><span class="default">foo\Xyz</span><span class="keyword">;
<br />use </span><span class="default">foo\abc</span><span class="keyword">;
<br />new </span><span class="default">Xyz</span><span class="keyword">(); </span><span class="comment">// instantiates \foo\Xyz
<br /></span><span class="keyword">new </span><span class="default">namespace\Xyz</span><span class="keyword">(); </span><span class="comment">// instantiates \bar\Xyz
...
<br /></span><span class="default">\foo\abc</span><span class="keyword">(); </span><span class="comment">// it has to be invoked using the fully qualified name
<br /></span><span class="default">?&gt;
<br /></span>
...
<br />Best regards.</span></code></div>
  ...
  <div class="note" id="126965">  <div class="votes">
    <div id="Vu126965">
    <a href="/manual/vote-note.php?id=126965&amp;page=language.namespaces.nsconstants&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126965">
    <a href="/manual/vote-note.php?id=126965&amp;page=language.namespaces.nsconstants&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126965" title="37% like this...">
    -4
    </div>
  </div>
  <a href="#126965" class="name">
  <strong class="user"><em>bharatthapa45 at gmail dot com</em></strong></a><a class="genanchor" href="#126965"> &para;</a><div class="date" title="2022-03-30 08:37"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126965">
<div class="phpcode"><code><span class="html">Difference between __NAMESPACE__ and keyword 'namespace' that I find relevant is when invoking a class:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">namespace </span><span class="default">MyApp</span><span class="keyword">;<br /><br />class </span><span class="default">App </span><span class="keyword">{<br />    static function </span><span class="default">app</span><span class="keyword">(){<br />        echo </span><span class="string">'hello app'</span><span class="keyword">;<br />    }<br />}<br /><br /></span><span class="comment">// this will work:<br /></span><span class="default">$obj </span><span class="keyword">= new </span><span class="default">namespace\App</span><span class="keyword">::</span><span class="default">app</span><span class="keyword">();<br /><br /></span><span class="comment">// this will not work<br /></span><span class="default">$obj </span><span class="keyword">= new </span><span class="default">__NAMESPACE__\App</span><span class="keyword">::</span><span class="default">app</span><span class="keyword">();<br /><br /></span><span class="comment">// however this will work:<br /></span><span class="default">$obj </span><span class="keyword">= </span><span class="default">__NAMESPACE__ </span><span class="keyword">. </span><span class="string">'\App'</span><span class="keyword">;<br /></span><span class="default">$obj</span><span class="keyword">::</span><span class="default">foo</span><span class="keyword">();<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=language.namespaces.nsconstants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.namespaces.nsconstants.php">＋<small>add a note</small></a></div>
