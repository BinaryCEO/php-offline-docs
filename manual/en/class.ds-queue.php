...
<head>
  ...
  <title>PHP: Ds\Queue - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ds-queue.php">
 <link rel="shorturl" href="https://www.php.net/ds-queue">
 <link rel="alternate" href="https://www.php.net/ds-queue" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ds.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-stack.toarray.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-queue.allocate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ds-queue.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ds-queue.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ds-queue.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ds-queue.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ds-queue.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ds-queue.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ds-queue.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ds-queue.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ds-queue.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ds-queue.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ds-queue.php" hreflang="zh">
...
<meta name="Description" content="The Queue class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Ds\Queue - Manual" />
<meta name="twitter:description" content="The Queue class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Ds\Queue - Manual" />
<meta itemprop="description" content="The Queue class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Queue class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ds-queue.allocate.php">
          Ds\Queue::allocate &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ds-stack.toarray.php">
          &laquo; Ds\Stack::toArray        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ds-queue.php' selected="selected">English</option>
            <option value='de/class.ds-queue.php'>German</option>
            <option value='es/class.ds-queue.php'>Spanish</option>
            <option value='fr/class.ds-queue.php'>French</option>
            <option value='it/class.ds-queue.php'>Italian</option>
            <option value='ja/class.ds-queue.php'>Japanese</option>
            <option value='pt_BR/class.ds-queue.php'>Brazilian Portuguese</option>
            <option value='ru/class.ds-queue.php'>Russian</option>
            <option value='tr/class.ds-queue.php'>Turkish</option>
            <option value='uk/class.ds-queue.php'>Ukrainian</option>
            <option value='zh/class.ds-queue.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ds-queue" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ds-queue.allocate.php">Ds\Queue::allocate</a> — Allocates enough memory for a required capacity</li><li><a href="ds-queue.capacity.php">Ds\Queue::capacity</a> — Returns the current capacity</li><li><a href="ds-queue.clear.php">Ds\Queue::clear</a> — Removes all values</li><li><a href="ds-queue.construct.php">Ds\Queue::__construct</a> — Creates a new instance</li><li><a href="ds-queue.copy.php">Ds\Queue::copy</a> — Returns a shallow copy of the queue</li><li><a href="ds-queue.count.php">Ds\Queue::count</a> — Returns the number of values in the queue</li><li><a href="ds-queue.isempty.php">Ds\Queue::isEmpty</a> — Returns whether the queue is empty</li><li><a href="ds-queue.jsonserialize.php">Ds\Queue::jsonSerialize</a> — Returns a representation that can be converted to JSON</li><li><a href="ds-queue.peek.php">Ds\Queue::peek</a> — Returns the value at the front of the queue</li><li><a href="ds-queue.pop.php">Ds\Queue::pop</a> — Removes and returns the value at the front of the queue</li><li><a href="ds-queue.push.php">Ds\Queue::push</a> — Pushes values into the queue</li><li><a href="ds-queue.toarray.php">Ds\Queue::toArray</a> — Converts the queue to an array</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds.queue.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ds-queue%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ds-queue&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ds-queue.php">＋<small>add a note</small></a></span>
