...
<head>
  ...
  <title>PHP: Ds\Set::sorted - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-set.sorted.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-set.sorted.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-set.sorted.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-set.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-set.sort.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-set.sum.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ds-set.sorted.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ds-set.sorted.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ds-set.sorted.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ds-set.sorted.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ds-set.sorted.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ds-set.sorted.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ds-set.sorted.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ds-set.sorted.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ds-set.sorted.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ds-set.sorted.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ds-set.sorted.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Ds\Set::sorted - Manual" />
<meta name="twitter:description" content="Returns a sorted copy" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Ds\Set::sorted - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-set.sorted.php' selected="selected">English</option>
            <option value='de/ds-set.sorted.php'>German</option>
            <option value='es/ds-set.sorted.php'>Spanish</option>
            <option value='fr/ds-set.sorted.php'>French</option>
            <option value='it/ds-set.sorted.php'>Italian</option>
            <option value='ja/ds-set.sorted.php'>Japanese</option>
            <option value='pt_BR/ds-set.sorted.php'>Brazilian Portuguese</option>
            <option value='ru/ds-set.sorted.php'>Russian</option>
            <option value='tr/ds-set.sorted.php'>Turkish</option>
            <option value='uk/ds-set.sorted.php'>Ukrainian</option>
            <option value='zh/ds-set.sorted.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ds-set.sorted" class="refentry">
...
(
  ...
  <div class="example" id="example-4446">
...
(
    ...
    [4] =&gt; 1
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/set/sorted.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-set.sorted%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-set.sorted&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-set.sorted.php">＋<small>add a note</small></a></span>
