...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-error.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-errno.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-escape.php">
...
<meta name="Description" content="Return the LDAP error message of the last LDAP command" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_error - Manual" />
<meta name="twitter:description" content="Return the LDAP error message of the last LDAP command" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_error - Manual" />
<meta itemprop="description" content="Return the LDAP error message of the last LDAP command" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the LDAP error message of the last LDAP command" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-error.php' selected="selected">English</option>
            ...
            <option value='ru/function.ldap-error.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_error</span> &mdash; <span class="dc-title">Return the LDAP error message of the last LDAP command</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-error-description">
  ...
  <p class="para rdfs-comment">
   ...
   last LDAP command for the given <code class="parameter">ldap</code>.
  ...
  <p class="para">
   ...
   prefix your LDAP commands with <code class="literal">@</code> (at) characters to
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ldap-errno.php" class="function" rel="rdfs-seeAlso">ldap_errno()</a> - Return the LDAP error number of the last LDAP command</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-error.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-error%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-error&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-error.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>Michael Newton</em></strong></a><a class="genanchor" href="#121881"> &para;</a><div class="date" title="2017-11-18 12:23"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121881">
<div class="phpcode"><code><span class="html">Note that you can sometimes get more detailed error messages by getting the value of the LDAP_OPT_DIAGNOSTIC_MESSAGE option.<br /><br />For example, after a recent connection error the two gave very different info:<br /><br /><span class="default">&lt;?php<br />$conn </span><span class="keyword">= </span><span class="default">ldap_connect</span><span class="keyword">(</span><span class="default">$server</span><span class="keyword">);<br /></span><span class="default">ldap_search</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="default">$dn</span><span class="keyword">, </span><span class="default">$query</span><span class="keyword">);<br /><br />echo </span><span class="string">"ldap_error: " </span><span class="keyword">. </span><span class="default">ldap_error</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">);<br /></span><span class="default">ldap_get_option</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="default">LDAP_OPT_DIAGNOSTIC_MESSAGE</span><span class="keyword">, </span><span class="default">$err</span><span class="keyword">);<br />echo </span><span class="string">"ldap_get_option: </span><span class="default">$err</span><span class="string">"</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />This resulted in:<br /><br />  ldap_error: Can't contact LDAP server<br />  ldap_get_option: TLS: hostname does not match CN in peer certificate</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">For those wondering, this function appears to do the same thing as:<br /><span class="default">&lt;?php<br />ldap_err2str</span><span class="keyword">( </span><span class="default">ldap_errno</span><span class="keyword">() );<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-error&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-error.php">＋<small>add a note</small></a></div>
