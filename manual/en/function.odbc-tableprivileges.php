...
<head>
  ...
  <title>PHP: odbc_tableprivileges - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-tableprivileges.php">
 <link rel="shorturl" href="https://www.php.net/odbc-tableprivileges">
 <link rel="alternate" href="https://www.php.net/odbc-tableprivileges" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-statistics.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-tables.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-tableprivileges.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-tableprivileges.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-tableprivileges.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-tableprivileges.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-tableprivileges.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-tableprivileges.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-tableprivileges.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-tableprivileges.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-tableprivileges.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-tableprivileges.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-tableprivileges.php" hreflang="zh">
...
<meta name="Description" content="Lists tables and the privileges associated with each table" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_tableprivileges - Manual" />
<meta name="twitter:description" content="Lists tables and the privileges associated with each table" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_tableprivileges - Manual" />
<meta itemprop="description" content="Lists tables and the privileges associated with each table" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Lists tables and the privileges associated with each table" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-tableprivileges.php' selected="selected">English</option>
            <option value='de/function.odbc-tableprivileges.php'>German</option>
            <option value='es/function.odbc-tableprivileges.php'>Spanish</option>
            <option value='fr/function.odbc-tableprivileges.php'>French</option>
            <option value='it/function.odbc-tableprivileges.php'>Italian</option>
            <option value='ja/function.odbc-tableprivileges.php'>Japanese</option>
            <option value='pt_BR/function.odbc-tableprivileges.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-tableprivileges.php'>Russian</option>
            <option value='tr/function.odbc-tableprivileges.php'>Turkish</option>
            <option value='uk/function.odbc-tableprivileges.php'>Ukrainian</option>
            <option value='zh/function.odbc-tableprivileges.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-tableprivileges" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">odbc_tableprivileges</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">odbc_tableprivileges</span> &mdash; <span class="dc-title">Lists tables and the privileges associated with each table</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.odbc-tableprivileges-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>odbc_tableprivileges</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type">Odbc\Connection</span> <code class="parameter">$odbc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$catalog</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$schema</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$table</code></span><br>): <span class="type"><span class="type">Odbc\Result</span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
and <code class="literal">_</code> to match a single character.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-tableprivileges-returnvalues">
  ...
  <p class="simpara">
   ...
   <code class="literal">TABLE_NAME</code>, <code class="literal">PRIVILEGE</code> and <code class="literal">GRANTEE</code>.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.odbc-tableprivileges-changelog">
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.odbc-tableprivileges-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.odbc-tables.php" class="function" rel="rdfs-seeAlso">odbc_tables()</a> - Get the list of table names stored in a specific data source</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-tableprivileges.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-tableprivileges%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-tableprivileges&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-tableprivileges.php">＋<small>add a note</small></a></span>
