...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-vector.last.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-vector.last.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-vector.last.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-vector.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-vector.jsonserialize.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-vector.map.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-vector.last.php' selected="selected">English</option>
            ...
            <option value='zh/ds-vector.last.php'>Chinese (Simplified)</option>
 ...
 <div class="refsect1 examples" id="refsect1-ds-vector.last-examples">
  ...
  <div class="example" id="example-4304">
   <p><strong>Example #1 <span class="function"><strong>Ds\Vector::last()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">int(3)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/vector/last.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-vector.last%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-vector.last&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-vector.last.php">＋<small>add a note</small></a></span>
