...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.dom.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.dom.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.dom.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="next" href="https://www.php.net/manual/en/dom.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.dom.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.dom.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.dom.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.dom.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.dom.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.dom.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.dom.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.dom.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.dom.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.dom.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.dom.php" hreflang="zh">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.dom.php' selected="selected">English</option>
            <option value='de/intro.dom.php'>German</option>
            <option value='es/intro.dom.php'>Spanish</option>
            <option value='fr/intro.dom.php'>French</option>
            <option value='it/intro.dom.php'>Italian</option>
            <option value='ja/intro.dom.php'>Japanese</option>
            <option value='pt_BR/intro.dom.php'>Brazilian Portuguese</option>
            <option value='ru/intro.dom.php'>Russian</option>
            <option value='tr/intro.dom.php'>Turkish</option>
            <option value='uk/intro.dom.php'>Ukrainian</option>
            <option value='zh/intro.dom.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.dom" class="preface">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: <p class="para">The DOM extension uses UTF-8 encoding. Use <span class="function"><a href="function.mb-convert-encoding.php" class="function">mb_convert_encoding()</a></span>, <span class="methodname"><a href="uconverter.transcode.php" class="methodname">UConverter::transcode()</a></span>, or <span class="function"><a href="function.iconv.php" class="function">iconv()</a></span> to handle other encodings.</p></p></blockquote>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.dom%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.dom&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.dom.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124859">  <div class="votes">
    <div id="Vu124859">
    <a href="/manual/vote-note.php?id=124859&amp;page=intro.dom&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124859">
    <a href="/manual/vote-note.php?id=124859&amp;page=intro.dom&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124859" title="50% like this...">
    2
    </div>
  </div>
  <a href="#124859" class="name">
  <strong class="user"><em>captainjester at hotmail dot com</em></strong></a><a class="genanchor" href="#124859"> &para;</a><div class="date" title="2020-03-27 12:59"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124859">
<div class="phpcode"><code><span class="html">Be careful when using this for partial HTML. This will only take complete HTML documents with at least an HTML element and a BODY element. If you are working on partial HTML and you fill in the missing elements around it and don't specify in META elements the character encoding then it will be treated as ISO-8859-1 and will mangle UTF-8 strings. Example:<br /><br /><span class="default">&lt;?php<br />$body </span><span class="keyword">= </span><span class="default">getHtmlBody</span><span class="keyword">();<br /></span><span class="default">$doc </span><span class="keyword">= new </span><span class="default">DOMDocument</span><span class="keyword">();<br /></span><span class="default">$doc</span><span class="keyword">-&gt;</span><span class="default">loadHtml</span><span class="keyword">(</span><span class="string">"&lt;html&gt;&lt;body&gt;"</span><span class="keyword">.</span><span class="default">$body</span><span class="keyword">.</span><span class="string">"&lt;/body&gt;&lt;/html&gt;"</span><span class="keyword">);<br /></span><span class="comment">// $doc will treat your HTML ISO-8859-1.<br />// this is correct but may not be what you want if your source is UTF-8<br /></span><span class="default">?&gt;<br /></span><br /><span class="default">&lt;?php<br />$body </span><span class="keyword">= </span><span class="default">getHtmlBody</span><span class="keyword">();<br /></span><span class="default">$doc </span><span class="keyword">= new </span><span class="default">DOMDocument</span><span class="keyword">();<br /></span><span class="default">$doc</span><span class="keyword">-&gt;</span><span class="default">loadHtml</span><span class="keyword">(</span><span class="string">"&lt;html&gt;&lt;head&gt;&lt;meta charset=\"UTF-8\"&gt;&lt;meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"&gt;&lt;/head&gt;&lt;body&gt;"</span><span class="keyword">.</span><span class="default">$body</span><span class="keyword">.</span><span class="string">"&lt;/body&gt;&lt;/html&gt;"</span><span class="keyword">);<br /></span><span class="comment">// $doc will treat your HTML correctly as UTF-8.<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=intro.dom&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.dom.php">＋<small>add a note</small></a></div>
