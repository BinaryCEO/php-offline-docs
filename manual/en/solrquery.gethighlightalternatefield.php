...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightAlternateField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightalternatefield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightalternatefield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightalternatefield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlight.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightfields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightalternatefield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightalternatefield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightalternatefield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightalternatefield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightalternatefield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightalternatefield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightalternatefield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightalternatefield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightalternatefield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightalternatefield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightalternatefield.php" hreflang="zh">
...
<meta name="Description" content="Returns the highlight field to use as backup or default" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightAlternateField - Manual" />
<meta name="twitter:description" content="Returns the highlight field to use as backup or default" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightAlternateField - Manual" />
<meta itemprop="description" content="Returns the highlight field to use as backup or default" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the highlight field to use as backup or default" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.gethighlightfields.php">
          SolrQuery::getHighlightFields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlight.php">
          &laquo; SolrQuery::getHighlight        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightalternatefield.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightalternatefield.php'>German</option>
            <option value='es/solrquery.gethighlightalternatefield.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightalternatefield.php'>French</option>
            <option value='it/solrquery.gethighlightalternatefield.php'>Italian</option>
            <option value='ja/solrquery.gethighlightalternatefield.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightalternatefield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightalternatefield.php'>Russian</option>
            <option value='tr/solrquery.gethighlightalternatefield.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightalternatefield.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightalternatefield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightalternatefield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightAlternateField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightAlternateField</span> &mdash; <span class="dc-title">Returns the highlight field to use as backup or default</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightalternatefield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightAlternateField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightalternatefield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightalternatefield-returnvalues">
...
Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightalternatefield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightalternatefield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightalternatefield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightalternatefield.php">＋<small>add a note</small></a></span>
