...
<head>
  ...
  <title>PHP: ReflectionProperty::isPublic - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.ispublic.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.ispublic.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.ispublic.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.isprotectedset.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.isreadonly.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.ispublic.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.ispublic.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.ispublic.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.ispublic.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.ispublic.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.ispublic.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.ispublic.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.ispublic.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.ispublic.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.ispublic.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.ispublic.php" hreflang="zh">
...
<meta name="Description" content="Checks if property is public" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::isPublic - Manual" />
<meta name="twitter:description" content="Checks if property is public" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::isPublic - Manual" />
<meta itemprop="description" content="Checks if property is public" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if property is public" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionproperty.isreadonly.php">
          ReflectionProperty::isReadOnly &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.isprotectedset.php">
          &laquo; ReflectionProperty::isProtectedSet        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.ispublic.php' selected="selected">English</option>
            <option value='de/reflectionproperty.ispublic.php'>German</option>
            <option value='es/reflectionproperty.ispublic.php'>Spanish</option>
            <option value='fr/reflectionproperty.ispublic.php'>French</option>
            <option value='it/reflectionproperty.ispublic.php'>Italian</option>
            <option value='ja/reflectionproperty.ispublic.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.ispublic.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.ispublic.php'>Russian</option>
            <option value='tr/reflectionproperty.ispublic.php'>Turkish</option>
            <option value='uk/reflectionproperty.ispublic.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.ispublic.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.ispublic" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionProperty::isPublic</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionProperty::isPublic</span> &mdash; <span class="dc-title">Checks if property is public</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionproperty.ispublic-returnvalues">
  ...
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the property is marked public, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 ...
 <div class="refsect1 notes" id="refsect1-reflectionproperty.ispublic-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <span class="simpara">
    Be aware that a property being <code class="literal">public</code> does not always
    imply is it publicly writeable.  A property could be virtual with no
    <code class="literal">set</code> hook, or it could be <code class="literal">readonly</code>
    and already have been written to, or it could have a
    <a href="language.oop5.visibility.php#language.oop5.visibility-members-aviz" class="link"><code class="literal">set</code>
    visibility defined</a> that is non-public.  In all of those cases,
    this method will return <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> but the property will not be writeable.
   </span>
  </p></blockquote>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionproperty.isstatic.php" class="methodname" rel="rdfs-seeAlso">ReflectionProperty::isStatic()</a> - Checks if property is static</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/ispublic.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.ispublic%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.ispublic&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.ispublic.php">＋<small>add a note</small></a></span>
