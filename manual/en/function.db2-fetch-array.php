...
<head>
  ...
  <title>PHP: db2_fetch_array - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-fetch-array.php">
 <link rel="shorturl" href="https://www.php.net/db2-fetch-array">
 <link rel="alternate" href="https://www.php.net/db2-fetch-array" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-execute.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-fetch-assoc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-fetch-array.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-fetch-array.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-fetch-array.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-fetch-array.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-fetch-array.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-fetch-array.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-fetch-array.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-fetch-array.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-fetch-array.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-fetch-array.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-fetch-array.php" hreflang="zh">
...
<meta name="Description" content="Returns an array, indexed by column position, representing a row in a result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_fetch_array - Manual" />
<meta name="twitter:description" content="Returns an array, indexed by column position, representing a row in a result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_fetch_array - Manual" />
<meta itemprop="description" content="Returns an array, indexed by column position, representing a row in a result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array, indexed by column position, representing a row in a result set" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-fetch-array.php' selected="selected">English</option>
            <option value='de/function.db2-fetch-array.php'>German</option>
            <option value='es/function.db2-fetch-array.php'>Spanish</option>
            <option value='fr/function.db2-fetch-array.php'>French</option>
            <option value='it/function.db2-fetch-array.php'>Italian</option>
            <option value='ja/function.db2-fetch-array.php'>Japanese</option>
            <option value='pt_BR/function.db2-fetch-array.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-fetch-array.php'>Russian</option>
            <option value='tr/function.db2-fetch-array.php'>Turkish</option>
            <option value='uk/function.db2-fetch-array.php'>Ukrainian</option>
            <option value='zh/function.db2-fetch-array.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-fetch-array" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-result.php" class="function" rel="rdfs-seeAlso">db2_result()</a> - Returns a single column from a row in the result set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-fetch-array.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-fetch-array%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-fetch-array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-fetch-array.php">＋<small>add a note</small></a></span>
