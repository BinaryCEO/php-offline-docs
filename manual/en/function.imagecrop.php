...
<head>
  ...
  <title>PHP: imagecrop - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecrop.php">
 <link rel="shorturl" href="https://www.php.net/imagecrop">
 <link rel="alternate" href="https://www.php.net/imagecrop" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecreatetruecolor.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecropauto.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecrop.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecrop.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecrop.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecrop.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecrop.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecrop.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecrop.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecrop.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecrop.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecrop.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecrop.php" hreflang="zh">
...
<meta name="Description" content="Crop an image to the given rectangle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagecrop - Manual" />
<meta name="twitter:description" content="Crop an image to the given rectangle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecrop - Manual" />
<meta itemprop="description" content="Crop an image to the given rectangle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Crop an image to the given rectangle" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagecropauto.php">
          imagecropauto &raquo;
              ...
              <div class="prev">
        <a href="function.imagecreatetruecolor.php">
          &laquo; imagecreatetruecolor        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecrop.php' selected="selected">English</option>
            <option value='de/function.imagecrop.php'>German</option>
            <option value='es/function.imagecrop.php'>Spanish</option>
            <option value='fr/function.imagecrop.php'>French</option>
            <option value='it/function.imagecrop.php'>Italian</option>
            <option value='ja/function.imagecrop.php'>Japanese</option>
            <option value='pt_BR/function.imagecrop.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecrop.php'>Russian</option>
            <option value='tr/function.imagecrop.php'>Turkish</option>
            <option value='uk/function.imagecrop.php'>Ukrainian</option>
            <option value='zh/function.imagecrop.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecrop" class="refentry">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagecrop-returnvalues">
  ...
  <p class="para">
   Return cropped image object on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagecropauto.php" class="function" rel="rdfs-seeAlso">imagecropauto()</a> - Crop an image automatically using one of the available modes</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecrop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecrop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecrop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecrop.php">＋<small>add a note</small></a></span>
