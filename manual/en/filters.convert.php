...
<head>
  ...
  <title>PHP: Conversion Filters - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/filters.convert.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/filters.convert.php">
 <link rel="alternate" href="https://www.php.net/manual/en/filters.convert.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/filters.php">
 <link rel="prev" href="https://www.php.net/manual/en/filters.string.php">
 <link rel="next" href="https://www.php.net/manual/en/filters.compression.php">

 <link rel="alternate" href="https://www.php.net/manual/en/filters.convert.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/filters.convert.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/filters.convert.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/filters.convert.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/filters.convert.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/filters.convert.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/filters.convert.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/filters.convert.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/filters.convert.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/filters.convert.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/filters.convert.php" hreflang="zh">
...
<meta name="Description" content="Conversion Filters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Conversion Filters - Manual" />
<meta name="twitter:description" content="Conversion Filters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Conversion Filters - Manual" />
<meta itemprop="description" content="Conversion Filters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Conversion Filters" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="filters.compression.php">
          Compression Filters &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="filters.string.php">
          &laquo; String Filters        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/filters.convert.php' selected="selected">English</option>
            <option value='de/filters.convert.php'>German</option>
            <option value='es/filters.convert.php'>Spanish</option>
            <option value='fr/filters.convert.php'>French</option>
            <option value='it/filters.convert.php'>Italian</option>
            <option value='ja/filters.convert.php'>Japanese</option>
            <option value='pt_BR/filters.convert.php'>Brazilian Portuguese</option>
            <option value='ru/filters.convert.php'>Russian</option>
            <option value='tr/filters.convert.php'>Turkish</option>
            <option value='uk/filters.convert.php'>Ukrainian</option>
            <option value='zh/filters.convert.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="filters.convert" class="section">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$fp </span><span style="color: #007700">= </span><span style="color: #0000BB">fopen</span><span style="color: #007700">(</span><span style="color: #DD0000">'php://output'</span><span style="color: #007700">, </span><span style="color: #DD0000">'w'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">stream_filter_append</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">, </span><span style="color: #DD0000">'convert.iconv.utf-16le.utf-8'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">fwrite</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">, </span><span style="color: #DD0000">"T\0h\0i\0s\0 \0i\0s\0 \0a\0 \0t\0e\0s\0t\0.\0\n\0"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">/* Outputs: This is a test. */<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffilters.convert%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=filters.convert&amp;repo=en&amp;redirect=https://www.php.net/manual/en/filters.convert.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="127043">  <div class="votes">
    <div id="Vu127043">
    <a href="/manual/vote-note.php?id=127043&amp;page=filters.convert&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127043">
    <a href="/manual/vote-note.php?id=127043&amp;page=filters.convert&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127043" title="50% like this...">
    0
    </div>
  </div>
  <a href="#127043" class="name">
  <strong class="user"><em>marcus at synchromedia dot co dot uk</em></strong></a><a class="genanchor" href="#127043"> &para;</a><div class="date" title="2022-05-10 09:50"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom127043">
<div class="phpcode"><code><span class="html">It's not quite obvious what all the available parameters are for convert.quoted-printable-encode. If you want the stream filter to act the same way as the quoted_printable_encode function, you need these extra params, for example:<br /><br />stream_filter_append(<br />    STDOUT,<br />    'convert.quoted-printable-encode',<br />    STREAM_FILTER_WRITE,<br />    [<br />        'line-break-chars' =&gt; PHP_EOL,<br />        'line-length' =&gt; 75,<br />    ]<br />);<br />echo stream_copy_to_stream(STDIN, STDOUT);<br /><br />Without these extra params set, you may get no wrapping at all, or wrapping using the wrong line break sequence.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=filters.convert&amp;repo=en&amp;redirect=https://www.php.net/manual/en/filters.convert.php">＋<small>add a note</small></a></div>
