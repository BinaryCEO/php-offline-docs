...
<head>
  ...
  <title>PHP: Imagick::flopImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.flopimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.flopimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.flopimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.floodfillpaintimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.forwardfouriertransformimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.flopimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.flopimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.flopimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.flopimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.flopimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.flopimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.flopimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.flopimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.flopimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.flopimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.flopimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::flopImage - Manual" />
<meta name="twitter:description" content="Creates a horizontal mirror image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::flopImage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.forwardfouriertransformimage.php">
          Imagick::forwardFourierTransformImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.floodfillpaintimage.php">
          &laquo; Imagick::floodFillPaintImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.flopimage.php' selected="selected">English</option>
            <option value='de/imagick.flopimage.php'>German</option>
            <option value='es/imagick.flopimage.php'>Spanish</option>
            <option value='fr/imagick.flopimage.php'>French</option>
            <option value='it/imagick.flopimage.php'>Italian</option>
            <option value='ja/imagick.flopimage.php'>Japanese</option>
            <option value='pt_BR/imagick.flopimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.flopimage.php'>Russian</option>
            <option value='tr/imagick.flopimage.php'>Turkish</option>
            <option value='uk/imagick.flopimage.php'>Ukrainian</option>
            <option value='zh/imagick.flopimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.flopimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::flopImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::flopImage</span> &mdash; <span class="dc-title">Creates a horizontal mirror image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.flopimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::flopImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.flopimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.flopimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.flopimage-errors">
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.flopimage-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="imagick.flipimage.php" class="function" rel="rdfs-seeAlso">Imagick::flipimage()</a> - Creates a vertical mirror image</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/flopimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.flopimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.flopimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.flopimage.php">＋<small>add a note</small></a></span>
