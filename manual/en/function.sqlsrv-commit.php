...
<head>
  ...
  <title>PHP: sqlsrv_commit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sqlsrv-commit.php">
 <link rel="shorturl" href="https://www.php.net/sqlsrv-commit">
 <link rel="alternate" href="https://www.php.net/sqlsrv-commit" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sqlsrv-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sqlsrv-configure.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sqlsrv-commit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sqlsrv-commit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sqlsrv-commit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sqlsrv-commit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sqlsrv-commit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sqlsrv-commit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sqlsrv-commit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sqlsrv-commit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sqlsrv-commit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sqlsrv-commit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sqlsrv-commit.php" hreflang="zh">
...
<meta name="Description" content="Commits a transaction that was begun with sqlsrv_begin_transaction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sqlsrv_commit - Manual" />
<meta name="twitter:description" content="Commits a transaction that was begun with sqlsrv_begin_transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sqlsrv_commit - Manual" />
<meta itemprop="description" content="Commits a transaction that was begun with sqlsrv_begin_transaction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Commits a transaction that was begun with sqlsrv_begin_transaction" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sqlsrv-configure.php">
          sqlsrv_configure &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sqlsrv-close.php">
          &laquo; sqlsrv_close        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sqlsrv-commit.php' selected="selected">English</option>
            <option value='de/function.sqlsrv-commit.php'>German</option>
            <option value='es/function.sqlsrv-commit.php'>Spanish</option>
            <option value='fr/function.sqlsrv-commit.php'>French</option>
            <option value='it/function.sqlsrv-commit.php'>Italian</option>
            <option value='ja/function.sqlsrv-commit.php'>Japanese</option>
            <option value='pt_BR/function.sqlsrv-commit.php'>Brazilian Portuguese</option>
            <option value='ru/function.sqlsrv-commit.php'>Russian</option>
            <option value='tr/function.sqlsrv-commit.php'>Turkish</option>
            <option value='uk/function.sqlsrv-commit.php'>Ukrainian</option>
            <option value='zh/function.sqlsrv-commit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sqlsrv-commit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sqlsrv_commit</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_commit</span> &mdash; <span class="dc-title">Commits a transaction that was begun with <span class="function"><a href="function.sqlsrv-begin-transaction.php" class="function">sqlsrv_begin_transaction()</a></span></span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.sqlsrv-commit-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sqlsrv_commit</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Commits a transaction that was begun with <span class="function"><a href="function.sqlsrv-begin-transaction.php" class="function">sqlsrv_begin_transaction()</a></span>. 
   ...
   executed after the call to <span class="function"><a href="function.sqlsrv-begin-transaction.php" class="function">sqlsrv_begin_transaction()</a></span>. 
 ...
 <div class="refsect1 examples" id="refsect1-function.sqlsrv-commit-examples">
  ...
  <p class="para">
   <div class="example" id="example-2152">
    ...
    together with <span class="function"><a href="function.sqlsrv-begin-transaction.php" class="function">sqlsrv_begin_transaction()</a></span> and 
    <span class="function"><a href="function.sqlsrv-rollback.php" class="function">sqlsrv_rollback()</a></span>.
    </p></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.sqlsrv-commit-seealso">
  ...
  sqlsrv_begin_transaction</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlsrv/functions/sqlsrv-commit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sqlsrv-commit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sqlsrv-commit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-commit.php">＋<small>add a note</small></a></span>
