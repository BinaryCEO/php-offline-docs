...
<head>
  ...
  <title>PHP: Imagick::shadowImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.shadowimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.shadowimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.shadowimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.shadeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.sharpenimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.shadowimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.shadowimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.shadowimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.shadowimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.shadowimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.shadowimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.shadowimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.shadowimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.shadowimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.shadowimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.shadowimage.php" hreflang="zh">
...
<meta name="Description" content="Simulates an image shadow" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::shadowImage - Manual" />
<meta name="twitter:description" content="Simulates an image shadow" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::shadowImage - Manual" />
<meta itemprop="description" content="Simulates an image shadow" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Simulates an image shadow" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.sharpenimage.php">
          Imagick::sharpenImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.shadeimage.php">
          &laquo; Imagick::shadeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.shadowimage.php' selected="selected">English</option>
            <option value='de/imagick.shadowimage.php'>German</option>
            <option value='es/imagick.shadowimage.php'>Spanish</option>
            <option value='fr/imagick.shadowimage.php'>French</option>
            <option value='it/imagick.shadowimage.php'>Italian</option>
            <option value='ja/imagick.shadowimage.php'>Japanese</option>
            <option value='pt_BR/imagick.shadowimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.shadowimage.php'>Russian</option>
            <option value='tr/imagick.shadowimage.php'>Turkish</option>
            <option value='uk/imagick.shadowimage.php'>Ukrainian</option>
            <option value='zh/imagick.shadowimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.shadowimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::shadowImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::shadowImage</span> &mdash; <span class="dc-title">Simulates an image shadow</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.shadowimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::shadowImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$opacity</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$sigma</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.shadowimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.shadowimage-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.shadowimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3111">
      <p><strong>Example #1  <span class="function"><strong>Imagick::shadowImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/shadowimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.shadowimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.shadowimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.shadowimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="92502">  <div class="votes">
    <div id="Vu92502">
    <a href="/manual/vote-note.php?id=92502&amp;page=imagick.shadowimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92502">
    <a href="/manual/vote-note.php?id=92502&amp;page=imagick.shadowimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92502" title="62% like this...">
    2
    </div>
  </div>
  <a href="#92502" class="name">
  <strong class="user"><em>nilayanand at gmail dot com</em></strong></a><a class="genanchor" href="#92502"> &para;</a><div class="date" title="2009-07-27 10:43"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92502">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php
<br /></span><span class="comment">/* Read the image into the object */
<br /></span><span class="default">$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">( </span><span class="string">'a.jpg' </span><span class="keyword">);
...
<br /> 
<br /></span><span class="comment">/* Make the image a little smaller, maintain aspect ratio */
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">thumbnailImage</span><span class="keyword">( </span><span class="default">200</span><span class="keyword">, </span><span class="default">null </span><span class="keyword">);
<br /> 
<br /></span><span class="comment">/* Clone the current object */
<br /></span><span class="default">$shadow </span><span class="keyword">= </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">clone</span><span class="keyword">();
<br /> 
<br /></span><span class="comment">/* Set image background color to black
<br />        (this is the color of the shadow) */
<br /></span><span class="default">$shadow</span><span class="keyword">-&gt;</span><span class="default">setImageBackgroundColor</span><span class="keyword">( new </span><span class="default">ImagickPixel</span><span class="keyword">( </span><span class="string">'black' </span><span class="keyword">) );
<br /> 
<br /></span><span class="comment">/* Create the shadow */
<br /></span><span class="default">$shadow</span><span class="keyword">-&gt;</span><span class="default">shadowImage</span><span class="keyword">( </span><span class="default">80</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">, </span><span class="default">5</span><span class="keyword">, </span><span class="default">5 </span><span class="keyword">);
<br /> 
<br /></span><span class="comment">/* Imagick::shadowImage only creates the shadow.
<br />        That is why the original image is composited over it */
<br /></span><span class="default">$shadow</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">( </span><span class="default">$im</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPOSITE_OVER</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0 </span><span class="keyword">);
<br /> 
<br /></span><span class="comment">/* Display the image */
...
<br />echo </span><span class="default">$shadow</span><span class="keyword">;
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.shadowimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.shadowimage.php">＋<small>add a note</small></a></div>
