...
<head>
  ...
  <title>PHP: ImagickDraw::getStrokeMiterLimit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getstrokemiterlimit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getstrokemiterlimit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokemiterlimit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getstrokelinejoin.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getstrokeopacity.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokemiterlimit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getstrokemiterlimit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getstrokemiterlimit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getstrokemiterlimit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getstrokemiterlimit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getstrokemiterlimit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getstrokemiterlimit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getstrokemiterlimit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getstrokemiterlimit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getstrokemiterlimit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getstrokemiterlimit.php" hreflang="zh">
...
<meta name="Description" content="Returns the stroke miter limit" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getStrokeMiterLimit - Manual" />
<meta name="twitter:description" content="Returns the stroke miter limit" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getStrokeMiterLimit - Manual" />
<meta itemprop="description" content="Returns the stroke miter limit" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the stroke miter limit" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.getstrokeopacity.php">
          ImagickDraw::getStrokeOpacity &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getstrokelinejoin.php">
          &laquo; ImagickDraw::getStrokeLineJoin        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getstrokemiterlimit.php' selected="selected">English</option>
            <option value='de/imagickdraw.getstrokemiterlimit.php'>German</option>
            <option value='es/imagickdraw.getstrokemiterlimit.php'>Spanish</option>
            <option value='fr/imagickdraw.getstrokemiterlimit.php'>French</option>
            <option value='it/imagickdraw.getstrokemiterlimit.php'>Italian</option>
            <option value='ja/imagickdraw.getstrokemiterlimit.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getstrokemiterlimit.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getstrokemiterlimit.php'>Russian</option>
            <option value='tr/imagickdraw.getstrokemiterlimit.php'>Turkish</option>
            <option value='uk/imagickdraw.getstrokemiterlimit.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getstrokemiterlimit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getstrokemiterlimit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getStrokeMiterLimit</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getStrokeMiterLimit</span> &mdash; <span class="dc-title">Returns the stroke miter limit</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getstrokemiterlimit-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getStrokeMiterLimit</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getstrokemiterlimit-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an int describing the miter limit
   and 0 if no miter limit is set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getstrokemiterlimit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getstrokemiterlimit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getstrokemiterlimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getstrokemiterlimit.php">＋<small>add a note</small></a></span>
