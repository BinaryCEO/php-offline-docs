...
<head>
  ...
  <title>PHP: Imagick::transverseImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.transverseimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.transverseimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.transverseimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.transposeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.trimimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.transverseimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.transverseimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.transverseimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.transverseimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.transverseimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.transverseimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.transverseimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.transverseimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.transverseimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.transverseimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.transverseimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::transverseImage - Manual" />
<meta name="twitter:description" content="Creates a horizontal mirror image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::transverseImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.trimimage.php">
          Imagick::trimImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.transposeimage.php">
          &laquo; Imagick::transposeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.transverseimage.php' selected="selected">English</option>
            <option value='de/imagick.transverseimage.php'>German</option>
            <option value='es/imagick.transverseimage.php'>Spanish</option>
            <option value='fr/imagick.transverseimage.php'>French</option>
            <option value='it/imagick.transverseimage.php'>Italian</option>
            <option value='ja/imagick.transverseimage.php'>Japanese</option>
            <option value='pt_BR/imagick.transverseimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.transverseimage.php'>Russian</option>
            <option value='tr/imagick.transverseimage.php'>Turkish</option>
            <option value='uk/imagick.transverseimage.php'>Ukrainian</option>
            <option value='zh/imagick.transverseimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.transverseimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::transverseImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::transverseImage</span> &mdash; <span class="dc-title">Creates a horizontal mirror image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.transverseimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::transverseImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.transverseimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.transverseimage-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.transverseimage-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.transposeimage.php" class="function" rel="rdfs-seeAlso">Imagick::transposeImage()</a> - Creates a vertical mirror image</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/transverseimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.transverseimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.transverseimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.transverseimage.php">＋<small>add a note</small></a></span>
