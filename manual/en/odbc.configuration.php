...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/odbc.configuration.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/odbc.configuration.php">
 <link rel="alternate" href="https://www.php.net/manual/en/odbc.configuration.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/uodbc.setup.php">
 <link rel="prev" href="https://www.php.net/manual/en/odbc.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/uodbc.resources.php">

 <link rel="alternate" href="https://www.php.net/manual/en/odbc.configuration.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/odbc.configuration.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/odbc.configuration.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/odbc.configuration.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/odbc.configuration.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/odbc.configuration.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/odbc.configuration.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/odbc.configuration.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/odbc.configuration.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/odbc.configuration.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/odbc.configuration.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="uodbc.resources.php">
          Resource Types &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="odbc.installation.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/odbc.configuration.php' selected="selected">English</option>
            <option value='de/odbc.configuration.php'>German</option>
            <option value='es/odbc.configuration.php'>Spanish</option>
            <option value='fr/odbc.configuration.php'>French</option>
            <option value='it/odbc.configuration.php'>Italian</option>
            <option value='ja/odbc.configuration.php'>Japanese</option>
            <option value='pt_BR/odbc.configuration.php'>Brazilian Portuguese</option>
            <option value='ru/odbc.configuration.php'>Russian</option>
            <option value='tr/odbc.configuration.php'>Turkish</option>
            <option value='uk/odbc.configuration.php'>Ukrainian</option>
            <option value='zh/odbc.configuration.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="odbc.configuration" class="section">
    ...
    <p class="para">
     ...
     <strong><code><a href="uodbc.constants.php#constant.sql-cursor-static">SQL_CURSOR_STATIC</a></code></strong> (default).
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/ini.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fodbc.configuration%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=odbc.configuration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/odbc.configuration.php">＋<small>add a note</small></a></span>
