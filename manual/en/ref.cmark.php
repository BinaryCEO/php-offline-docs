...
<head>
  ...
  <title>PHP: CommonMark Functions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.cmark.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/commonmark-cql.invoke.php">
 <link rel="next" href="https://www.php.net/manual/en/function.commonmark-parse.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ref.cmark.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ref.cmark.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ref.cmark.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ref.cmark.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ref.cmark.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ref.cmark.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ref.cmark.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ref.cmark.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ref.cmark.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ref.cmark.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ref.cmark.php" hreflang="zh">
...
<meta name="Description" content="CommonMark Functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CommonMark Functions - Manual" />
<meta name="twitter:description" content="CommonMark Functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CommonMark Functions - Manual" />
<meta itemprop="description" content="CommonMark Functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="CommonMark Functions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.commonmark-parse.php">
          CommonMark\Parse &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="commonmark-cql.invoke.php">
          &laquo; CommonMark\CQL::__invoke        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.cmark.php' selected="selected">English</option>
            <option value='de/ref.cmark.php'>German</option>
            <option value='es/ref.cmark.php'>Spanish</option>
            <option value='fr/ref.cmark.php'>French</option>
            <option value='it/ref.cmark.php'>Italian</option>
            <option value='ja/ref.cmark.php'>Japanese</option>
            <option value='pt_BR/ref.cmark.php'>Brazilian Portuguese</option>
            <option value='ru/ref.cmark.php'>Russian</option>
            <option value='tr/ref.cmark.php'>Turkish</option>
            <option value='uk/ref.cmark.php'>Ukrainian</option>
            <option value='zh/ref.cmark.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ref.cmark" class="reference">
 <h1 class="title">CommonMark Functions</h1>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="function.commonmark-parse.php">CommonMark\Parse</a> — Parsing</li><li><a href="function.commonmark-render.php">CommonMark\Render</a> — Rendering</li><li><a href="function.commonmark-render-html.php">CommonMark\Render\HTML</a> — Rendering</li><li><a href="function.commonmark-render-latex.php">CommonMark\Render\Latex</a> — Rendering</li><li><a href="function.commonmark-render-man.php">CommonMark\Render\Man</a> — Rendering</li><li><a href="function.commonmark-render-xml.php">CommonMark\Render\XML</a> — Rendering</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cmark/reference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fref.cmark%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ref.cmark&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.cmark.php">＋<small>add a note</small></a></span>
