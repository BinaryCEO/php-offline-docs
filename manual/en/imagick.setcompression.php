...
<head>
  ...
  <title>PHP: Imagick::setCompression - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setcompression.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setcompression.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setcompression.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setcolorspace.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setcompressionquality.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setcompression.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setcompression.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setcompression.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setcompression.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setcompression.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setcompression.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setcompression.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setcompression.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setcompression.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setcompression.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setcompression.php" hreflang="zh">
...
<meta name="Description" content="Sets the object's default compression type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setCompression - Manual" />
<meta name="twitter:description" content="Sets the object's default compression type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setCompression - Manual" />
<meta itemprop="description" content="Sets the object's default compression type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the object's default compression type" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setcompressionquality.php">
          Imagick::setCompressionQuality &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setcolorspace.php">
          &laquo; Imagick::setColorspace        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setcompression.php' selected="selected">English</option>
            <option value='de/imagick.setcompression.php'>German</option>
            <option value='es/imagick.setcompression.php'>Spanish</option>
            <option value='fr/imagick.setcompression.php'>French</option>
            <option value='it/imagick.setcompression.php'>Italian</option>
            <option value='ja/imagick.setcompression.php'>Japanese</option>
            <option value='pt_BR/imagick.setcompression.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setcompression.php'>Russian</option>
            <option value='tr/imagick.setcompression.php'>Turkish</option>
            <option value='uk/imagick.setcompression.php'>Ukrainian</option>
            <option value='zh/imagick.setcompression.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setcompression" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setCompression</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setCompression</span> &mdash; <span class="dc-title">Sets the object&#039;s default compression type</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setcompression-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setCompression</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$compression</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setcompression-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The compression type. See the <a href="imagick.constants.php" class="link">Imagick::COMPRESSION_*</a> constants.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setcompression-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setcompression.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setcompression%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setcompression&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setcompression.php">＋<small>add a note</small></a></span>
