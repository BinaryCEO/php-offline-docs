...
<head>
  ...
  <title>PHP: Imagick::sepiaToneImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.sepiatoneimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.sepiatoneimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.sepiatoneimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.separateimagechannel.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setbackgroundcolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.sepiatoneimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.sepiatoneimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.sepiatoneimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.sepiatoneimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.sepiatoneimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.sepiatoneimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.sepiatoneimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.sepiatoneimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.sepiatoneimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.sepiatoneimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.sepiatoneimage.php" hreflang="zh">
...
<meta name="Description" content="Sepia tones an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::sepiaToneImage - Manual" />
<meta name="twitter:description" content="Sepia tones an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::sepiaToneImage - Manual" />
<meta itemprop="description" content="Sepia tones an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sepia tones an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setbackgroundcolor.php">
          Imagick::setBackgroundColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.separateimagechannel.php">
          &laquo; Imagick::separateImageChannel        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.sepiatoneimage.php' selected="selected">English</option>
            <option value='de/imagick.sepiatoneimage.php'>German</option>
            <option value='es/imagick.sepiatoneimage.php'>Spanish</option>
            <option value='fr/imagick.sepiatoneimage.php'>French</option>
            <option value='it/imagick.sepiatoneimage.php'>Italian</option>
            <option value='ja/imagick.sepiatoneimage.php'>Japanese</option>
            <option value='pt_BR/imagick.sepiatoneimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.sepiatoneimage.php'>Russian</option>
            <option value='tr/imagick.sepiatoneimage.php'>Turkish</option>
            <option value='uk/imagick.sepiatoneimage.php'>Ukrainian</option>
            <option value='zh/imagick.sepiatoneimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.sepiatoneimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::sepiaToneImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::sepiaToneImage</span> &mdash; <span class="dc-title">Sepia tones an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.sepiatoneimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::sepiaToneImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$threshold</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.sepiatoneimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.sepiatoneimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.sepiatoneimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-3088">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/sepiatoneimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.sepiatoneimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.sepiatoneimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.sepiatoneimage.php">＋<small>add a note</small></a></span>
