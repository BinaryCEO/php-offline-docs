...
<head>
  ...
  <title>PHP: Imagick::writeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.writeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.writeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.writeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.whitethresholdimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.writeimagefile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.writeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.writeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.writeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.writeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.writeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.writeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.writeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.writeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.writeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.writeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.writeimage.php" hreflang="zh">
...
<meta name="Description" content="Writes an image to the specified filename" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::writeImage - Manual" />
<meta name="twitter:description" content="Writes an image to the specified filename" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::writeImage - Manual" />
<meta itemprop="description" content="Writes an image to the specified filename" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Writes an image to the specified filename" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.writeimagefile.php">
          Imagick::writeImageFile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.whitethresholdimage.php">
          &laquo; Imagick::whiteThresholdImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.writeimage.php' selected="selected">English</option>
            <option value='de/imagick.writeimage.php'>German</option>
            <option value='es/imagick.writeimage.php'>Spanish</option>
            <option value='fr/imagick.writeimage.php'>French</option>
            <option value='it/imagick.writeimage.php'>Italian</option>
            <option value='ja/imagick.writeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.writeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.writeimage.php'>Russian</option>
            <option value='tr/imagick.writeimage.php'>Turkish</option>
            <option value='uk/imagick.writeimage.php'>Ukrainian</option>
            <option value='zh/imagick.writeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.writeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::writeImage</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::writeImage</span> &mdash; <span class="dc-title">Writes an image to the specified filename</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.writeimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::writeImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code><span class="initializer"> = NULL</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/writeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.writeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.writeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.writeimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114714">  <div class="votes">
    <div id="Vu114714">
    <a href="/manual/vote-note.php?id=114714&amp;page=imagick.writeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114714">
    <a href="/manual/vote-note.php?id=114714&amp;page=imagick.writeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114714" title="63% like this...">
    13
    </div>
  </div>
  <a href="#114714" class="name">
  <strong class="user"><em>SkepticaLee</em></strong></a><a class="genanchor" href="#114714"> &para;</a><div class="date" title="2014-03-27 02:30"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114714">
<div class="phpcode"><code><span class="html">When running Imagick as packaged with the Abyss Web Server, neither this method nor writeImages () works. Instead the format has to be declared and the file saved by using another method or procedure, e.g.:<br /><br /><span class="default">&lt;?php<br />$im </span><span class="keyword">= new </span><span class="default">Imagick </span><span class="keyword">();<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">newImage </span><span class="keyword">(</span><span class="default">300</span><span class="keyword">, </span><span class="default">225</span><span class="keyword">, </span><span class="string">"blue"</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage </span><span class="keyword">(</span><span class="string">"test_0.jpg"</span><span class="keyword">); </span><span class="comment">// fails with no error message<br />//instead<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageFormat </span><span class="keyword">(</span><span class="string">"jpeg"</span><span class="keyword">);<br /></span><span class="default">file_put_contents </span><span class="keyword">(</span><span class="string">"test_1.jpg"</span><span class="keyword">, </span><span class="default">$im</span><span class="keyword">); </span><span class="comment">// works, or:<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">imageWriteFile </span><span class="keyword">(</span><span class="default">fopen </span><span class="keyword">(</span><span class="string">"test_2.jpg"</span><span class="keyword">, </span><span class="string">"wb"</span><span class="keyword">)); </span><span class="comment">//also works<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="104112">  <div class="votes">
    <div id="Vu104112">
    <a href="/manual/vote-note.php?id=104112&amp;page=imagick.writeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104112">
    <a href="/manual/vote-note.php?id=104112&amp;page=imagick.writeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104112" title="50% like this...">
    0
    </div>
  </div>
  <a href="#104112" class="name">
  <strong class="user"><em>icinagle at gmail dot com</em></strong></a><a class="genanchor" href="#104112"> &para;</a><div class="date" title="2011-05-23 06:47"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104112">
<div class="phpcode"><code><span class="html">If you are trying to manipulate a uploaded file and then save the file all in the same request with Apache + mod_dav this will fail.<br />mod_dav puts a lock on the file during the request where the file is uploaded so trying to save the smallest file, e.g. 1kb will fail with a "Failed to allocate memory" error.</span></code></div>
  </div>
 </div>
  <div class="note" id="110703">  <div class="votes">
    <div id="Vu110703">
    <a href="/manual/vote-note.php?id=110703&amp;page=imagick.writeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110703">
    <a href="/manual/vote-note.php?id=110703&amp;page=imagick.writeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110703" title="47% like this...">
    -1
    </div>
  </div>
  <a href="#110703" class="name">
  <strong class="user"><em>pfz at pfzone dot org</em></strong></a><a class="genanchor" href="#110703"> &para;</a><div class="date" title="2012-11-24 05:47"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110703">
<div class="phpcode"><code><span class="html">With Imagick 3.1.0RC2, PHP4.8<br />If you plan to overwrite the file you're working on, before doing writeImage, consider clearing the file buffer before the write statement : <br /><br /><span class="default">&lt;?php<br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$your_file</span><span class="keyword">);<br /></span><span class="comment">/* some processing */<br /><br /></span><span class="default">clearstatcache</span><span class="keyword">(</span><span class="default">dirname</span><span class="keyword">(</span><span class="default">$your_file</span><span class="keyword">));<br /></span><span class="comment">// or<br /></span><span class="default">unlink</span><span class="keyword">(</span><span class="default">$your_file</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">$your_file</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span>It happened to me that the resulting file size was wrong. This could lead to truncation, as the file is not expanded.<br />This happened while working on JPEG, and PNG. <br /><br />this line worked for me without this hack. <br /><span class="default">&lt;?php<br />file_put_contents</span><span class="keyword">(</span><span class="default">$your_file</span><span class="keyword">, </span><span class="default">$image</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Do not rely on getImageLength() for sending your image, especially when keepalive is ON. Content length is then relevant, and must be set. If the wrong size is given, your image will be truncated.<br />Use filesize($your_file_) once written or strlen($image) instead (which renders your image and updates getImageLength() result).</span></code></div>
  </div>
 </div>
  <div class="note" id="115359">  <div class="votes">
    <div id="Vu115359">
    <a href="/manual/vote-note.php?id=115359&amp;page=imagick.writeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115359">
    <a href="/manual/vote-note.php?id=115359&amp;page=imagick.writeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115359" title="27% like this...">
    -5
    </div>
  </div>
  <a href="#115359" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#115359"> &para;</a><div class="date" title="2014-07-11 10:25"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115359">
<div class="phpcode"><code><span class="html">I opened image with Imagick::readImageBlob. When I wanted to save resized image Imagick::writeImage did not work, but Imagick::writeImageFile did.<br /><br />$image = new Imagick();<br />$image-&gt;readImageBlob($image_data);<br />// $image-&gt;writeImage($fileDst)    did not work<br />if($f=fopen($fileDst, "w")){ <br />  $image-&gt;writeImageFile($f);<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.writeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.writeimage.php">＋<small>add a note</small></a></div>
