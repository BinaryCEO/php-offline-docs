...
<head>
  ...
  <title>PHP: imagegd2 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagegd2.php">
 <link rel="shorturl" href="https://www.php.net/imagegd2">
 <link rel="alternate" href="https://www.php.net/imagegd2" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagegd.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagegetclip.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagegd2.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagegd2.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagegd2.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagegd2.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagegd2.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagegd2.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagegd2.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagegd2.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagegd2.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagegd2.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagegd2.php" hreflang="zh">
...
<meta name="Description" content="Output GD2 image to browser or file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagegd2 - Manual" />
<meta name="twitter:description" content="Output GD2 image to browser or file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagegd2 - Manual" />
<meta itemprop="description" content="Output GD2 image to browser or file" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imagegetclip.php">
          imagegetclip &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagegd2.php' selected="selected">English</option>
            <option value='de/function.imagegd2.php'>German</option>
            <option value='es/function.imagegd2.php'>Spanish</option>
            <option value='fr/function.imagegd2.php'>French</option>
            <option value='it/function.imagegd2.php'>Italian</option>
            <option value='ja/function.imagegd2.php'>Japanese</option>
            <option value='pt_BR/function.imagegd2.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagegd2.php'>Russian</option>
            <option value='tr/function.imagegd2.php'>Turkish</option>
            <option value='uk/function.imagegd2.php'>Ukrainian</option>
            <option value='zh/function.imagegd2.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagegd2" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagegd2</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.7, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagegd2</span> &mdash; <span class="dc-title">Output GD2 image to browser or file</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagegd2-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagegd2</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$file</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$chunk_size</code><span class="initializer"> = 128</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mode</code><span class="initializer"> = <strong><code><a href="image.constants.php#constant.img-gd2-raw">IMG_GD2_RAW</a></code></strong></span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Outputs or saves the given <code class="parameter">image</code> in GD2 format.
  </p>
 </div>
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
     ...
     <dd>
      <p class="para">
       Either <strong><code><a href="image.constants.php#constant.img-gd2-raw">IMG_GD2_RAW</a></code></strong> or 
       <strong><code><a href="image.constants.php#constant.img-gd2-compressed">IMG_GD2_COMPRESSED</a></code></strong>. Default is 
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagegd2-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.3</td>
      <td>
       <code class="parameter">file</code> is now nullable.
      </td>
     </tr>
 ...
 <p class="para">
  <div class="example" id="example-2906">
   <p><strong>Example #1 Outputting a GD2 image</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Create a blank image and add some text<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatetruecolor</span><span style="color: #007700">(</span><span style="color: #0000BB">120</span><span style="color: #007700">, </span><span style="color: #0000BB">20</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$text_color </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecolorallocate</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">233</span><span style="color: #007700">, </span><span style="color: #0000BB">14</span><span style="color: #007700">, </span><span style="color: #0000BB">91</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">imagestring</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">,  </span><span style="color: #DD0000">"A Simple Text String"</span><span style="color: #007700">, </span><span style="color: #0000BB">$text_color</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Save the gd2 image<br />// The file format for GD2 images is .gd2, see http://www.libgd.org/GdFileFormats<br /></span><span style="color: #0000BB">imagegd2</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #DD0000">'simple.gd2'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.imagegd2-notes">
  ...
  <div class="warning"><strong class="warning">Warning</strong><p class="simpara">The GD
...
purposes.</p></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagegd2-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagegd.php" class="function" rel="rdfs-seeAlso">imagegd()</a> - Output GD image to browser or file</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagegd2.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagegd2%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagegd2&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagegd2.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="104402">  <div class="votes">
    <div id="Vu104402">
    <a href="/manual/vote-note.php?id=104402&amp;page=function.imagegd2&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104402">
    <a href="/manual/vote-note.php?id=104402&amp;page=function.imagegd2&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104402" title="62% like this...">
    2
    </div>
  </div>
  <a href="#104402" class="name">
  <strong class="user"><em>Nick</em></strong></a><a class="genanchor" href="#104402"> &para;</a><div class="date" title="2011-06-13 12:49"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104402">
<div class="phpcode"><code><span class="html">You can use this function in combination with imagecreatefromstring() to clone the gd resource with minimum fuss (no writing to tmp file):<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">cloneGd</span><span class="keyword">(</span><span class="default">$gd</span><span class="keyword">)<br />{<br />    </span><span class="default">ob_start</span><span class="keyword">();<br />    </span><span class="default">imagegd2</span><span class="keyword">(</span><span class="default">$gd</span><span class="keyword">);<br />    return </span><span class="default">imagecreatefromstring</span><span class="keyword">(</span><span class="default">ob_get_clean</span><span class="keyword">());<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="130420">  <div class="votes">
    <div id="Vu130420">
    <a href="/manual/vote-note.php?id=130420&amp;page=function.imagegd2&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130420">
    <a href="/manual/vote-note.php?id=130420&amp;page=function.imagegd2&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130420" title="no votes...">
    0
    </div>
  </div>
  <a href="#130420" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#130420"> &para;</a><div class="date" title="2025-07-15 05:39"><strong>2 months ago</strong></div>
  <div class="text" id="Hcom130420">
<div class="phpcode"><code><span class="html">This function produces an empty file (0 bytes) if a gdlib version is used without gd2 image format support. Which is planed to be removed completely with gdlib 3.</span></code></div>
  </div>
 </div>
  <div class="note" id="31284">  <div class="votes">
    <div id="Vu31284">
    <a href="/manual/vote-note.php?id=31284&amp;page=function.imagegd2&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd31284">
    <a href="/manual/vote-note.php?id=31284&amp;page=function.imagegd2&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V31284" title="40% like this...">
    -1
    </div>
  </div>
  <a href="#31284" class="name">
  <strong class="user"><em>mark at teckis dot com</em></strong></a><a class="genanchor" href="#31284"> &para;</a><div class="date" title="2003-04-16 06:33"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom31284">
<div class="phpcode"><code><span class="html">yes, the gd2 file format does improve the speed of image creations as the data-setup is designed to be native for the GD function - ie, the image doesn't have to be converted to a usable format prior to processing.<br /><br />you may also note that the newer gd2 format creates much smaller size files than the older imagegd function, certainly for images involving chunks of single colours anyway. you'll probably find this function most useful for saving overlay images or background images used in larger image creation scripts.<br /><br />to read a ping or jpeg image (.png / .jpg) and save a .gd2 version to server...<br /><br />$img = $_GET['img'];<br />if(file_exists($img))<br />    {<br />    $dim = getimagesize($img);<br />    $cr = ($dim[2] &lt; 4) ? ($dim[2] &lt; 3) ? ($dim[2] &lt; 2) ? NULL : imagecreatefromjpeg($img) : imagecreatefrompng($img) : Null;<br />    if($cr !== NULL)<br />          {<br />         imagegd2($cr,substr($img,0,strrpos($img,'.')).'.gd2');<br />          }<br />    }<br /><br />should save a copy with the same filename and directory using extension .gd2 - which can then be nicely and swiftly read using either imagecreatefromgd2 or imagecreatefromgd2part</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagegd2&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagegd2.php">＋<small>add a note</small></a></div>
