...
<head>
  ...
  <title>PHP: Imagick::getQuantumRange - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getquantumrange.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getquantumrange.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getquantumrange.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getquantumdepth.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getregistry.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getquantumrange.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getquantumrange.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getquantumrange.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getquantumrange.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getquantumrange.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getquantumrange.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getquantumrange.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getquantumrange.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getquantumrange.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getquantumrange.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getquantumrange.php" hreflang="zh">
...
<meta name="Description" content="Returns the Imagick quantum range" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getQuantumRange - Manual" />
<meta name="twitter:description" content="Returns the Imagick quantum range" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getQuantumRange - Manual" />
<meta itemprop="description" content="Returns the Imagick quantum range" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the Imagick quantum range" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getregistry.php">
          Imagick::getRegistry &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getquantumdepth.php">
          &laquo; Imagick::getQuantumDepth        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getquantumrange.php' selected="selected">English</option>
            <option value='de/imagick.getquantumrange.php'>German</option>
            <option value='es/imagick.getquantumrange.php'>Spanish</option>
            <option value='fr/imagick.getquantumrange.php'>French</option>
            <option value='it/imagick.getquantumrange.php'>Italian</option>
            <option value='ja/imagick.getquantumrange.php'>Japanese</option>
            <option value='pt_BR/imagick.getquantumrange.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getquantumrange.php'>Russian</option>
            <option value='tr/imagick.getquantumrange.php'>Turkish</option>
            <option value='uk/imagick.getquantumrange.php'>Ukrainian</option>
            <option value='zh/imagick.getquantumrange.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getquantumrange" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getQuantumRange</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getQuantumRange</span> &mdash; <span class="dc-title">Returns the Imagick quantum range</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getquantumrange-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::getQuantumRange</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getquantumrange-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getquantumrange-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an associative array containing the quantum range as an
   <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> (<code class="literal">&quot;quantumRangeLong&quot;</code>) and as a 
   <span class="type"><a href="language.types.string.php" class="type string">string</a></span> (<code class="literal">&quot;quantumRangeString&quot;</code>).
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-imagick.getquantumrange-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getquantumrange.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getquantumrange%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getquantumrange&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getquantumrange.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108511">  <div class="votes">
    <div id="Vu108511">
    <a href="/manual/vote-note.php?id=108511&amp;page=imagick.getquantumrange&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108511">
    <a href="/manual/vote-note.php?id=108511&amp;page=imagick.getquantumrange&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108511" title="no votes...">
    0
    </div>
  </div>
  <a href="#108511" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108511"> &para;</a><div class="date" title="2012-05-02 09:42"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108511">
<div class="phpcode"><code><span class="html">The getQuantumRange is a useful function, since many of the ImageMagick functions accept parameters from 0 to a maximum of the Quantum Range.  When getting a return value for this, it doesn't return a string.  It actually returns an array, with one type being a String ('quantumRangeLong') and the other type being a Long Int ('quantumRangeString').  Here's some sample code and the results, given a color, BMP file photograph that is 600x450 pixels...<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.bmp"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get Quantum Range<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$imagick_type_quantum_range </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getQuantumRange</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Print Results<br />        // ---------------------------------------------<br /><br />    </span><span class="keyword">print(</span><span class="string">"&lt;pre&gt;"</span><span class="keyword">);<br />    </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$imagick_type_quantum_range</span><span class="keyword">);<br />    print(</span><span class="string">"&lt;/pre&gt;"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />Output:<br /><br />Array<br />(<br />    [quantumRangeLong] =&gt; 65535<br />    [quantumRangeString] =&gt; 65535<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getquantumrange&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getquantumrange.php">＋<small>add a note</small></a></div>
