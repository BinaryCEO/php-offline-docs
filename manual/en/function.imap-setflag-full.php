...
<head>
  ...
  <title>PHP: imap_setflag_full - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-setflag-full.php">
 <link rel="shorturl" href="https://www.php.net/imap-setflag-full">
 <link rel="alternate" href="https://www.php.net/imap-setflag-full" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-setacl.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-sort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-setflag-full.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-setflag-full.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-setflag-full.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-setflag-full.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-setflag-full.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-setflag-full.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-setflag-full.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-setflag-full.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-setflag-full.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-setflag-full.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-setflag-full.php" hreflang="zh">
...
<meta name="Description" content="Sets flags on messages" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_setflag_full - Manual" />
<meta name="twitter:description" content="Sets flags on messages" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_setflag_full - Manual" />
<meta itemprop="description" content="Sets flags on messages" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets flags on messages" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-setflag-full.php' selected="selected">English</option>
            <option value='de/function.imap-setflag-full.php'>German</option>
            <option value='es/function.imap-setflag-full.php'>Spanish</option>
            <option value='fr/function.imap-setflag-full.php'>French</option>
            <option value='it/function.imap-setflag-full.php'>Italian</option>
            <option value='ja/function.imap-setflag-full.php'>Japanese</option>
            <option value='pt_BR/function.imap-setflag-full.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-setflag-full.php'>Russian</option>
            <option value='tr/function.imap-setflag-full.php'>Turkish</option>
            <option value='uk/function.imap-setflag-full.php'>Ukrainian</option>
            <option value='zh/function.imap-setflag-full.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-setflag-full" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_setflag_full</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_setflag_full</span> &mdash; <span class="dc-title">Sets flags on messages</span></p>
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
     ...
     <dd>
      <p class="para">
       The flags which you can set are <code class="literal">\Seen</code>, 
       <code class="literal">\Answered</code>, <code class="literal">\Flagged</code>,
       <code class="literal">\Deleted</code>, and <code class="literal">\Draft</code> as
       defined by <a href="https://datatracker.ietf.org/doc/html/rfc2060" class="link external">&raquo;&nbsp;RFC2060</a>.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       ...
       <ul class="itemizedlist">
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.st-uid">ST_UID</a></code></strong> - The sequence argument contains UIDs
 ...
 <div class="refsect1 errors" id="refsect1-function.imap-setflag-full-errors">
  ...
  <p class="para">
   Throws a <span class="classname"><a href="class.valueerror.php" class="classname">ValueError</a></span> if <code class="parameter">options</code>
   is invalid.
  </p>
 </div>
  ...
  instance now; previously, a valid <code class="literal">imap</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
     ...
     <tr>
      ...
      <td>
       ...
       <code class="parameter">options</code> parameter values. Previously,
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$mbox </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_open</span><span style="color: #007700">(</span><span style="color: #DD0000">"{imap.example.org:143}"</span><span style="color: #007700">, </span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"password"</span><span style="color: #007700">)<br />     or die(</span><span style="color: #DD0000">"can't connect: " </span><span style="color: #007700">. </span><span style="color: #0000BB">imap_last_error</span><span style="color: #007700">());<br /><br /></span><span style="color: #0000BB">$status </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_setflag_full</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">, </span><span style="color: #DD0000">"2,5"</span><span style="color: #007700">, </span><span style="color: #DD0000">"\\Seen \\Flagged"</span><span style="color: #007700">);<br /><br />echo </span><span style="color: #0000BB">gettype</span><span style="color: #007700">(</span><span style="color: #0000BB">$status</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />echo </span><span style="color: #0000BB">$status </span><span style="color: #007700">. </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">imap_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-setflag-full-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-clearflag-full.php" class="function" rel="rdfs-seeAlso">imap_clearflag_full()</a> - Clears flags on messages</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-setflag-full.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-setflag-full%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-setflag-full&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-setflag-full.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="18684">  <div class="votes">
    <div id="Vu18684">
    <a href="/manual/vote-note.php?id=18684&amp;page=function.imap-setflag-full&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd18684">
    <a href="/manual/vote-note.php?id=18684&amp;page=function.imap-setflag-full&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V18684" title="90% like this...">
    25
    </div>
  </div>
  <a href="#18684" class="name">
  <strong class="user"><em>AJCartmell at ricardo dot com</em></strong></a><a class="genanchor" href="#18684"> &para;</a><div class="date" title="2002-01-31 06:29"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom18684">
<div class="phpcode"><code><span class="html">Spent ages trying to get this to work, then eventually remembered I had opened the mailbox READONLY - obviously you need write permission for setting flags!</span></code></div>
  </div>
 </div>
  <div class="note" id="99500">  <div class="votes">
    <div id="Vu99500">
    <a href="/manual/vote-note.php?id=99500&amp;page=function.imap-setflag-full&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd99500">
    <a href="/manual/vote-note.php?id=99500&amp;page=function.imap-setflag-full&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V99500" title="100% like this...">
    5
    </div>
  </div>
  <a href="#99500" class="name">
  <strong class="user"><em>daniel dot blackburn at galorwebservices dot com</em></strong></a><a class="genanchor" href="#99500"> &para;</a><div class="date" title="2010-08-20 02:13"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom99500">
<div class="phpcode"><code><span class="html">Where possible I would avoid using POP3 accounts. My host allowed me to upgrade to IMAP and it is so much easier. I think the only way to accurately create any form of mail client with POP3 is to download the messages into an SQL database which is a big task to start with, considering the IMAP standards have the functionality we need built in.<br />I experimented with flag setting in POP3 and it seems they do not stick at all, and it is almost impossible to retrieve the number of unread messages (ie. the Seen / Unseen thing does not work)<br />Converted to IMAP and it's working - the majority of the functions in this section seem to be IMAP focussed and WILL NOT generally work with POP3</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-setflag-full&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-setflag-full.php">＋<small>add a note</small></a></div>
