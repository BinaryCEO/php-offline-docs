...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration70.other-changes.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration70.other-changes.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration70.other-changes.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration70.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration70.removed-exts-sapis.php">
 <link rel="next" href="https://www.php.net/manual/en/migration56.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration70.other-changes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration70.other-changes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration70.other-changes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration70.other-changes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration70.other-changes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration70.other-changes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration70.other-changes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration70.other-changes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration70.other-changes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration70.other-changes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration70.other-changes.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="migration56.php">
          Migrating from PHP 5.5.x to PHP 5.6.x &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="migration70.removed-exts-sapis.php">
          &laquo; Removed Extensions and SAPIs        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration70.other-changes.php' selected="selected">English</option>
            <option value='de/migration70.other-changes.php'>German</option>
            <option value='es/migration70.other-changes.php'>Spanish</option>
            <option value='fr/migration70.other-changes.php'>French</option>
            <option value='it/migration70.other-changes.php'>Italian</option>
            <option value='ja/migration70.other-changes.php'>Japanese</option>
            <option value='pt_BR/migration70.other-changes.php'>Brazilian Portuguese</option>
            <option value='ru/migration70.other-changes.php'>Russian</option>
            <option value='tr/migration70.other-changes.php'>Turkish</option>
            <option value='uk/migration70.other-changes.php'>Ukrainian</option>
            <option value='zh/migration70.other-changes.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration70.other-changes" class="sect1">
  ...
  <p class="para">
   ...
   UTC).
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration70/other-changes.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration70.other-changes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration70.other-changes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration70.other-changes.php">＋<small>add a note</small></a></span>
