...
<head>
  ...
  <title>PHP: openssl_random_pseudo_bytes - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-random-pseudo-bytes.php">
 <link rel="shorturl" href="https://www.php.net/openssl-random-pseudo-bytes">
 <link rel="alternate" href="https://www.php.net/openssl-random-pseudo-bytes" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-public-encrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-seal.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-random-pseudo-bytes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-random-pseudo-bytes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-random-pseudo-bytes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-random-pseudo-bytes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-random-pseudo-bytes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-random-pseudo-bytes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-random-pseudo-bytes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-random-pseudo-bytes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-random-pseudo-bytes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-random-pseudo-bytes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-random-pseudo-bytes.php" hreflang="zh">
...
<meta name="Description" content="Generate a pseudo-random string of bytes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_random_pseudo_bytes - Manual" />
<meta name="twitter:description" content="Generate a pseudo-random string of bytes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_random_pseudo_bytes - Manual" />
<meta itemprop="description" content="Generate a pseudo-random string of bytes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generate a pseudo-random string of bytes" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-seal.php">
          openssl_seal &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-public-encrypt.php">
          &laquo; openssl_public_encrypt        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-random-pseudo-bytes.php' selected="selected">English</option>
            <option value='de/function.openssl-random-pseudo-bytes.php'>German</option>
            <option value='es/function.openssl-random-pseudo-bytes.php'>Spanish</option>
            <option value='fr/function.openssl-random-pseudo-bytes.php'>French</option>
            <option value='it/function.openssl-random-pseudo-bytes.php'>Italian</option>
            <option value='ja/function.openssl-random-pseudo-bytes.php'>Japanese</option>
            <option value='pt_BR/function.openssl-random-pseudo-bytes.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-random-pseudo-bytes.php'>Russian</option>
            <option value='tr/function.openssl-random-pseudo-bytes.php'>Turkish</option>
            <option value='uk/function.openssl-random-pseudo-bytes.php'>Ukrainian</option>
            <option value='zh/function.openssl-random-pseudo-bytes.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-random-pseudo-bytes" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.openssl-random-pseudo-bytes-returnvalues">
  ...
  <p class="para">
   Returns the generated <span class="type"><a href="language.types.string.php" class="type string">string</a></span> of bytes.
  </p>
 </div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.random-int.php" class="function" rel="rdfs-seeAlso">random_int()</a> - Get a cryptographically secure, uniformly selected integer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-random-pseudo-bytes.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-random-pseudo-bytes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-random-pseudo-bytes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-random-pseudo-bytes.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">8 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="113214">  <div class="votes">
    <div id="Vu113214">
    <a href="/manual/vote-note.php?id=113214&amp;page=function.openssl-random-pseudo-bytes&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113214">
    <a href="/manual/vote-note.php?id=113214&amp;page=function.openssl-random-pseudo-bytes&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113214" title="73% like this...">
    36
    </div>
  </div>
  <a href="#113214" class="name">
  <strong class="user"><em>nahun@telemako</em></strong></a><a class="genanchor" href="#113214"> &para;</a><div class="date" title="2013-09-13 07:25"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom113214">
<div class="phpcode"><code><span class="html">Here's an example to show the distribution of random numbers as an image. Credit to Hayley Watson at the mt_rand page for the original comparison between rand and mt_rand.<br /><br />rand is red, mt_rand is green and openssl_random_pseudo_bytes is blue.<br /><br />NOTE: This is only a basic representation of the distribution of the data. Has nothing to do with the strength of the algorithms or their reliability.<br /><br /><span class="default">&lt;?php<br />header</span><span class="keyword">(</span><span class="string">"Content-type: image/png"</span><span class="keyword">);<br /></span><span class="default">$sizex</span><span class="keyword">=</span><span class="default">800</span><span class="keyword">;<br /></span><span class="default">$sizey</span><span class="keyword">=</span><span class="default">800</span><span class="keyword">;<br /><br /></span><span class="default">$img </span><span class="keyword">= </span><span class="default">imagecreatetruecolor</span><span class="keyword">(</span><span class="default">3 </span><span class="keyword">* </span><span class="default">$sizex</span><span class="keyword">,</span><span class="default">$sizey</span><span class="keyword">);<br /></span><span class="default">$r </span><span class="keyword">= </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">,</span><span class="default">255</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">$g </span><span class="keyword">= </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">$b </span><span class="keyword">= </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">);<br /></span><span class="default">imagefilledrectangle</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">3 </span><span class="keyword">* </span><span class="default">$sizex</span><span class="keyword">, </span><span class="default">$sizey</span><span class="keyword">, </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">));<br /><br /></span><span class="default">$p </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />for(</span><span class="default">$i</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">100000</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++) {<br />    </span><span class="default">$np </span><span class="keyword">= </span><span class="default">rand</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">$sizex</span><span class="keyword">);<br />    </span><span class="default">imagesetpixel</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">$p</span><span class="keyword">, </span><span class="default">$np</span><span class="keyword">, </span><span class="default">$r</span><span class="keyword">);<br />    </span><span class="default">$p </span><span class="keyword">= </span><span class="default">$np</span><span class="keyword">;<br />}<br /><br /></span><span class="default">$p </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />for(</span><span class="default">$i</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">100000</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++) {<br />    </span><span class="default">$np </span><span class="keyword">= </span><span class="default">mt_rand</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">$sizex</span><span class="keyword">);<br />    </span><span class="default">imagesetpixel</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">$p </span><span class="keyword">+ </span><span class="default">$sizex</span><span class="keyword">, </span><span class="default">$np</span><span class="keyword">, </span><span class="default">$g</span><span class="keyword">);<br />    </span><span class="default">$p </span><span class="keyword">= </span><span class="default">$np</span><span class="keyword">;<br />}<br /><br /></span><span class="default">$p </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />for(</span><span class="default">$i</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">100000</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++) {<br />    </span><span class="default">$np </span><span class="keyword">= </span><span class="default">floor</span><span class="keyword">(</span><span class="default">$sizex</span><span class="keyword">*(</span><span class="default">hexdec</span><span class="keyword">(</span><span class="default">bin2hex</span><span class="keyword">(</span><span class="default">openssl_random_pseudo_bytes</span><span class="keyword">(</span><span class="default">4</span><span class="keyword">)))/</span><span class="default">0xffffffff</span><span class="keyword">));<br />    </span><span class="default">imagesetpixel</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">$p </span><span class="keyword">+ (</span><span class="default">2</span><span class="keyword">*</span><span class="default">$sizex</span><span class="keyword">), </span><span class="default">$np</span><span class="keyword">, </span><span class="default">$b</span><span class="keyword">);<br />    </span><span class="default">$p </span><span class="keyword">= </span><span class="default">$np</span><span class="keyword">;<br />}<br /><br /></span><span class="default">imagepng</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">);<br /></span><span class="default">imagedestroy</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="118658">  <div class="votes">
    <div id="Vu118658">
    <a href="/manual/vote-note.php?id=118658&amp;page=function.openssl-random-pseudo-bytes&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118658">
    <a href="/manual/vote-note.php?id=118658&amp;page=function.openssl-random-pseudo-bytes&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118658" title="82% like this...">
    11
    </div>
  </div>
  <a href="#118658" class="name">
  <strong class="user"><em>powtac at gmx dot de</em></strong></a><a class="genanchor" href="#118658"> &para;</a><div class="date" title="2016-01-15 02:55"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118658">
<div class="phpcode"><code><span class="html">[Editor's note: the bug has been fixed as of PHP 5.4.44, 5.5.28 and PHP 5.6.12]
<br />
<br />Until PHP 5.6 openssl_random_pseudo_bytes() did NOT use a "cryptographically strong algorithm"! 
<br />See bug report <a href="https://bugs.php.net/bug.php?id=70014" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=70014</a> and the corresponding source code at <a href="https://github.com/php/php-src/blob/php-5.6.10/ext/openssl/openssl.c#L5408" rel="nofollow" target="_blank">https://github.com/php/php-src/blob/php-5.6.10/ext/openssl/openssl.c#L5408</a></span></code></div>
  </div>
 </div>
  <div class="note" id="104322">  <div class="votes">
    <div id="Vu104322">
    <a href="/manual/vote-note.php?id=104322&amp;page=function.openssl-random-pseudo-bytes&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104322">
    <a href="/manual/vote-note.php?id=104322&amp;page=function.openssl-random-pseudo-bytes&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104322" title="62% like this...">
    11
    </div>
  </div>
  <a href="#104322" class="name">
  <strong class="user"><em>christophe dot weis at statec dot etat dot lu</em></strong></a><a class="genanchor" href="#104322"> &para;</a><div class="date" title="2011-06-09 12:09"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104322">
<div class="phpcode"><code><span class="html">Another replacement for rand() using OpenSSL.<br /><br />Note that a solution where the result is truncated using the modulo operator ( % ) is not cryptographically secure, as the generated numbers are not equally distributed, i.e. some numbers may occur more often than others.<br /><br />A better solution than using the modulo operator is to drop the result if it is too large and generate a new one.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">crypto_rand_secure</span><span class="keyword">(</span><span class="default">$min</span><span class="keyword">, </span><span class="default">$max</span><span class="keyword">) {<br />        </span><span class="default">$range </span><span class="keyword">= </span><span class="default">$max </span><span class="keyword">- </span><span class="default">$min</span><span class="keyword">;<br />        if (</span><span class="default">$range </span><span class="keyword">== </span><span class="default">0</span><span class="keyword">) return </span><span class="default">$min</span><span class="keyword">; </span><span class="comment">// not so random...<br />        </span><span class="default">$log </span><span class="keyword">= </span><span class="default">log</span><span class="keyword">(</span><span class="default">$range</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">);<br />        </span><span class="default">$bytes </span><span class="keyword">= (int) (</span><span class="default">$log </span><span class="keyword">/ </span><span class="default">8</span><span class="keyword">) + </span><span class="default">1</span><span class="keyword">; </span><span class="comment">// length in bytes<br />        </span><span class="default">$bits </span><span class="keyword">= (int) </span><span class="default">$log </span><span class="keyword">+ </span><span class="default">1</span><span class="keyword">; </span><span class="comment">// length in bits<br />        </span><span class="default">$filter </span><span class="keyword">= (int) (</span><span class="default">1 </span><span class="keyword">&lt;&lt; </span><span class="default">$bits</span><span class="keyword">) - </span><span class="default">1</span><span class="keyword">; </span><span class="comment">// set all lower bits to 1<br />        </span><span class="keyword">do {<br />            </span><span class="default">$rnd </span><span class="keyword">= </span><span class="default">hexdec</span><span class="keyword">(</span><span class="default">bin2hex</span><span class="keyword">(</span><span class="default">openssl_random_pseudo_bytes</span><span class="keyword">(</span><span class="default">$bytes</span><span class="keyword">, </span><span class="default">$s</span><span class="keyword">)));<br />            </span><span class="default">$rnd </span><span class="keyword">= </span><span class="default">$rnd </span><span class="keyword">&amp; </span><span class="default">$filter</span><span class="keyword">; </span><span class="comment">// discard irrelevant bits<br />        </span><span class="keyword">} while (</span><span class="default">$rnd </span><span class="keyword">&gt;= </span><span class="default">$range</span><span class="keyword">);<br />        return </span><span class="default">$min </span><span class="keyword">+ </span><span class="default">$rnd</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="124269">  <div class="votes">
    <div id="Vu124269">
    <a href="/manual/vote-note.php?id=124269&amp;page=function.openssl-random-pseudo-bytes&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124269">
    <a href="/manual/vote-note.php?id=124269&amp;page=function.openssl-random-pseudo-bytes&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124269" title="66% like this...">
    1
    </div>
  </div>
  <a href="#124269" class="name">
  <strong class="user"><em>mailjeffclayton [at] gmail</em></strong></a><a class="genanchor" href="#124269"> &para;</a><div class="date" title="2019-10-07 05:55"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124269">
<div class="phpcode"><code><span class="html">Getting an integer value from a given range with an even distribution:<br /><br />This function I created to solve the problem of modulo results causing overlap of ranged results (which gave an uneven distribution).<br /><br />What I mean for those not as familiar with the problem: <br /><br />Using bytes for base 256 (base 16) and attempting to find a value in a range of values that may be for example 10-20 (a spread of 11) will not divide evenly, so values (using mod) will overlap and give more priority to some numbers than others.<br /><br />Instead of calculating based on byte values, I used the byte values as keys to sort. This is very fast, and does not require large multiplications of data space that easily go over the value of Max Int.<br /><br />Additionally: To make the user-supplied arguments not care about order I am using a handy swap function I found in the wild in conjunction with my function below.<br /><br />// swap function<br /><br />function swap(&amp;$a,&amp;$b) { list($a,$b)=array($b,$a); } // swap 2 variables-- no temp variable needed!<br /><br />// function to get a random value within a given range of integers<br />    <br />function get_secure_random_ranged_value($max=99, $min=0) // handles 1 or 2 arguments, order does not matter<br />{<br />    $sortarray = array();<br />    $lo = (int)$min; <br />    $hi = (int)$max;<br />    if ($lo &gt; $hi) swap($lo,$hi); <br />    $data_range = abs($hi - $lo) + 1; // +1 includes both the lowest 'zero' value and highest value of range<br />    $bytes_per_key = 4; // Max: ffff hex = 4,294,967,296 dec (over 4 billion) -- large span of random values covers massive datasets<br />    $num_bytes = $data_range * $bytes_per_key; <br />    $byte_string = (bin2hex(openssl_random_pseudo_bytes($num_bytes))); // only one call needed to get string of bytes<br />    $byte_blocksize = $bytes_per_key &lt;&lt; 1; // shift multiply by 2 since a byte is 2 characters wide<br />    <br />    while ($key = substr($byte_string,0,$byte_blocksize)) { // get next byte block from string<br />        $byte_string = substr($byte_string,$byte_blocksize); // remove selected byte block from string<br />        $sortarray[]=$key; // populate the array with keys temporarily as array values<br />    } <br />        <br />    $sortarray = array_flip($sortarray); // swap to use the byte values as keys <br />    ksort($sortarray); // randomize by keys<br />    return array_shift($sortarray) + $lo; // grab top value from array and add it to the lowest value in the range    <br />} <br /><br />//<br />// example getting values from 0 to 21:<br />//<br />    <br />for ($i=1;$i&lt;=10;$i++) { $rnd = get_secure_random_ranged_value(21); echo "-&gt; result: ".($rnd)." &lt;br /&gt;\n";  } <br /><br />//<br />// example getting values from 14 to 21:<br />//<br /><br />for ($i=1;$i&lt;=10;$i++) { $rnd = get_secure_random_ranged_value(14,21); echo "-&gt; result: ".($rnd)." &lt;br /&gt;\n";  } <br /><br />//<br />// sample results from 14-21<br />//<br /><br />-&gt; result: 14<br />-&gt; result: 18<br />-&gt; result: 20<br />-&gt; result: 15<br />-&gt; result: 20<br />-&gt; result: 16<br />-&gt; result: 21<br />-&gt; result: 15<br />-&gt; result: 16<br />-&gt; result: 17</span></code></div>
  </div>
 </div>
  <div class="note" id="101795">  <div class="votes">
    <div id="Vu101795">
    <a href="/manual/vote-note.php?id=101795&amp;page=function.openssl-random-pseudo-bytes&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd101795">
    <a href="/manual/vote-note.php?id=101795&amp;page=function.openssl-random-pseudo-bytes&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V101795" title="61% like this...">
    4
    </div>
  </div>
  <a href="#101795" class="name">
  <strong class="user"><em>acatalept at gmail</em></strong></a><a class="genanchor" href="#101795"> &para;</a><div class="date" title="2011-01-11 11:24"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101795">
<div class="phpcode"><code><span class="html">FYI, openssl_random_pseudo_bytes() can be incredibly slow under Windows, to the point of being unusable.  It frequently times out (&gt;30 seconds execution time) on several Windows machines of mine.<br /><br />Apparently, it's a known problem with OpenSSL (not PHP specifically).<br /><br />See: <a href="http://www.google.com/search?q=openssl_random_pseudo_bytes+slow" rel="nofollow" target="_blank">http://www.google.com/search?q=openssl_random_pseudo_bytes+slow</a></span></code></div>
  </div>
 </div>
  <div class="note" id="93078">  <div class="votes">
    <div id="Vu93078">
    <a href="/manual/vote-note.php?id=93078&amp;page=function.openssl-random-pseudo-bytes&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd93078">
    <a href="/manual/vote-note.php?id=93078&amp;page=function.openssl-random-pseudo-bytes&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V93078" title="57% like this...">
    5
    </div>
  </div>
  <a href="#93078" class="name">
  <strong class="user"><em>Tyler Larson</em></strong></a><a class="genanchor" href="#93078"> &para;</a><div class="date" title="2009-08-21 02:29"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom93078">
<div class="phpcode"><code><span class="html">If you don't have this function but you do have OpenSSL installed, you can always fake it:<br /><br /><span class="default">&lt;?php<br />    </span><span class="keyword">function </span><span class="default">openssl_random_pseudo_bytes</span><span class="keyword">(</span><span class="default">$length</span><span class="keyword">) {<br />        </span><span class="default">$length_n </span><span class="keyword">= (int) </span><span class="default">$length</span><span class="keyword">; </span><span class="comment">// shell injection is no fun<br />        </span><span class="default">$handle </span><span class="keyword">= </span><span class="default">popen</span><span class="keyword">(</span><span class="string">"/usr/bin/openssl rand </span><span class="default">$length_n</span><span class="string">"</span><span class="keyword">, </span><span class="string">"r"</span><span class="keyword">);<br />        </span><span class="default">$data </span><span class="keyword">= </span><span class="default">stream_get_contents</span><span class="keyword">(</span><span class="default">$handle</span><span class="keyword">);<br />        </span><span class="default">pclose</span><span class="keyword">(</span><span class="default">$handle</span><span class="keyword">);<br />        return </span><span class="default">$data</span><span class="keyword">;<br />    }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="101947">  <div class="votes">
    <div id="Vu101947">
    <a href="/manual/vote-note.php?id=101947&amp;page=function.openssl-random-pseudo-bytes&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd101947">
    <a href="/manual/vote-note.php?id=101947&amp;page=function.openssl-random-pseudo-bytes&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V101947" title="44% like this...">
    -3
    </div>
  </div>
  <a href="#101947" class="name">
  <strong class="user"><em>crrodriguez at opensuse dot org</em></strong></a><a class="genanchor" href="#101947"> &para;</a><div class="date" title="2011-01-19 09:32"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101947">
<div class="phpcode"><code><span class="html">Remember to request at very least 8 bytes of entropy, ideally 32 or 64, to avoid possible theorical bruteforce attacks.</span></code></div>
  </div>
 </div>
  <div class="note" id="121975">  <div class="votes">
    <div id="Vu121975">
    <a href="/manual/vote-note.php?id=121975&amp;page=function.openssl-random-pseudo-bytes&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121975">
    <a href="/manual/vote-note.php?id=121975&amp;page=function.openssl-random-pseudo-bytes&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121975" title="30% like this...">
    -4
    </div>
  </div>
  <a href="#121975" class="name">
  <strong class="user"><em>umairkhi at hotmail dot com</em></strong></a><a class="genanchor" href="#121975"> &para;</a><div class="date" title="2017-12-05 07:07"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121975">
<div class="phpcode"><code><span class="html">After the fix of insecure number generation here:<br /><br /><a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2015-8867" rel="nofollow" target="_blank">http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2015-8867</a><br /><br />This function as well as the text here needs an update. I believe this function is safe to use in FIPS compliant apps as well as it now used RAND_bytes instead of  the insecure RAND_pseudo_bytes().</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-random-pseudo-bytes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-random-pseudo-bytes.php">＋<small>add a note</small></a></div>
