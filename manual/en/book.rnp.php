...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.rnp.php">
 <link rel="shorturl" href="https://www.php.net/rnp">
 <link rel="alternate" href="https://www.php.net/rnp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/refs.crypto.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.password-verify.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.rnp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.rnp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.rnp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.rnp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.rnp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.rnp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.rnp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.rnp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.rnp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.rnp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.rnp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.rnp.php" hreflang="zh">
...
<meta name="Description" content="Rnp" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Rnp - Manual" />
<meta name="twitter:description" content="Rnp" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Rnp - Manual" />
<meta itemprop="description" content="Rnp" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rnp" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intro.rnp.php">
          Introduction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.password-verify.php">
          &laquo; password_verify        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.rnp.php' selected="selected">English</option>
            <option value='de/book.rnp.php'>German</option>
            <option value='es/book.rnp.php'>Spanish</option>
            <option value='fr/book.rnp.php'>French</option>
            <option value='it/book.rnp.php'>Italian</option>
            <option value='ja/book.rnp.php'>Japanese</option>
            <option value='pt_BR/book.rnp.php'>Brazilian Portuguese</option>
            <option value='ru/book.rnp.php'>Russian</option>
            <option value='tr/book.rnp.php'>Turkish</option>
            <option value='uk/book.rnp.php'>Ukrainian</option>
            <option value='zh/book.rnp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.rnp" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.rnp.php">Introduction</a></li><li><a href="rnp.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="rnp.requirements.php">Requirements</a></li><li><a href="rnp.installation.php">Installation</a></li></ul></li><li><a href="rnp.constants.php">Predefined Constants</a></li><li><a href="rnp.examples.php">Examples</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="rnp.examples-clearsign.php">Clearsign text</a></li></ul></li><li><a href="ref.rnp.php">Rnp Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.rnp-backend-string.php">rnp_backend_string</a> — Return cryptographic backend library name</li><li><a href="function.rnp-backend-version.php">rnp_backend_version</a> — Return cryptographic backend library version</li><li><a href="function.rnp-decrypt.php">rnp_decrypt</a> — Decrypt PGP message</li><li><a href="function.rnp-dump-packets.php">rnp_dump_packets</a> — Dump OpenPGP packets stream information in humand-readable format</li><li><a href="function.rnp-dump-packets-to-json.php">rnp_dump_packets_to_json</a> — Dump OpenPGP packets stream information to the JSON string</li><li><a href="function.rnp-ffi-create.php">rnp_ffi_create</a> — Create the top-level object used for interacting with the library</li><li><a href="function.rnp-ffi-destroy.php">rnp_ffi_destroy</a> — Destroy the top-level object used for interacting with the library</li><li><a href="function.rnp-ffi-set-pass-provider.php">rnp_ffi_set_pass_provider</a> — Set password provider callback function</li><li><a href="function.rnp-import-keys.php">rnp_import_keys</a> — Import keys from PHP string to the keyring and receive JSON describing new/updated keys</li><li><a href="function.rnp-import-signatures.php">rnp_import_signatures</a> — Import standalone signatures to the keyring and receive JSON describing updated keys</li><li><a href="function.rnp-key-export.php">rnp_key_export</a> — Export a key</li><li><a href="function.rnp-key-export-autocrypt.php">rnp_key_export_autocrypt</a> — Export minimal key for autocrypt feature (just 5 packets: key, uid, signature,
   encryption subkey, signature)</li><li><a href="function.rnp-key-export-revocation.php">rnp_key_export_revocation</a> — Generate and export primary key revocation signature</li><li><a href="function.rnp-key-get-info.php">rnp_key_get_info</a> — Get information about the key</li><li><a href="function.rnp-key-remove.php">rnp_key_remove</a> — Remove a key from keyring(s)</li><li><a href="function.rnp-key-revoke.php">rnp_key_revoke</a> — Revoke a key or subkey by generating and adding revocation signature</li><li><a href="function.rnp-list-keys.php">rnp_list_keys</a> — Enumerate all keys present in a keyring by specified identifer type</li><li><a href="function.rnp-load-keys.php">rnp_load_keys</a> — Load keys from PHP string</li><li><a href="function.rnp-load-keys-from-path.php">rnp_load_keys_from_path</a> — Load keys from specified path</li><li><a href="function.rnp-locate-key.php">rnp_locate_key</a> — Search for the key</li><li><a href="function.rnp-op-encrypt.php">rnp_op_encrypt</a> — Encrypt message</li><li><a href="function.rnp-op-generate-key.php">rnp_op_generate_key</a> — Generate key</li><li><a href="function.rnp-op-sign.php">rnp_op_sign</a> — Perform signing operation on a binary data, return embedded signature(s)</li><li><a href="function.rnp-op-sign-cleartext.php">rnp_op_sign_cleartext</a> — Perform signing operation on a textual data, return cleartext signed message</li><li><a href="function.rnp-op-sign-detached.php">rnp_op_sign_detached</a> — Perform signing operation, return detached signature(s)</li><li><a href="function.rnp-op-verify.php">rnp_op_verify</a> — Verify embedded or cleartext signatures</li><li><a href="function.rnp-op-verify-detached.php">rnp_op_verify_detached</a> — Verify detached signatures</li><li><a href="function.rnp-save-keys.php">rnp_save_keys</a> — Save keys to PHP string</li><li><a href="function.rnp-save-keys-to-path.php">rnp_save_keys_to_path</a> — Save keys to specified path</li><li><a href="function.rnp-supported-features.php">rnp_supported_features</a> — Get supported features in JSON format</li><li><a href="function.rnp-version-string.php">rnp_version_string</a> — RNP library version</li><li><a href="function.rnp-version-string-full.php">rnp_version_string_full</a> — Full version string of RNP library</li></ul></li><li><a href="class.rnpffi.php">RnpFFI</a> — The RnpFFI class</li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/book.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.rnp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.rnp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.rnp.php">＋<small>add a note</small></a></span>
