...
<head>
  ...
  <title>PHP: eio_sync_file_range - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-sync-file-range.php">
 <link rel="shorturl" href="https://www.php.net/eio-sync-file-range">
 <link rel="alternate" href="https://www.php.net/eio-sync-file-range" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-sync.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-syncfs.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-sync-file-range.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-sync-file-range.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-sync-file-range.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-sync-file-range.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-sync-file-range.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-sync-file-range.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-sync-file-range.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-sync-file-range.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-sync-file-range.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-sync-file-range.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-sync-file-range.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: eio_sync_file_range - Manual" />
<meta name="twitter:description" content="Sync a file segment with disk" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_sync_file_range - Manual" />
<meta itemprop="description" content="Sync a file segment with disk" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sync a file segment with disk" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-sync-file-range.php' selected="selected">English</option>
            <option value='de/function.eio-sync-file-range.php'>German</option>
            <option value='es/function.eio-sync-file-range.php'>Spanish</option>
            <option value='fr/function.eio-sync-file-range.php'>French</option>
            <option value='it/function.eio-sync-file-range.php'>Italian</option>
            <option value='ja/function.eio-sync-file-range.php'>Japanese</option>
            <option value='pt_BR/function.eio-sync-file-range.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-sync-file-range.php'>Russian</option>
            <option value='tr/function.eio-sync-file-range.php'>Turkish</option>
            <option value='uk/function.eio-sync-file-range.php'>Ukrainian</option>
            <option value='zh/function.eio-sync-file-range.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-sync-file-range" class="refentry">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-sync-file-range-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>eio_sync_file_range()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-sync-file-range.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-sync-file-range%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-sync-file-range&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-sync-file-range.php">＋<small>add a note</small></a></span>
