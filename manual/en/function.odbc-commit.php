...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-commit.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-columns.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-connect.php">
...
<meta name="Description" content="Commit an ODBC transaction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_commit - Manual" />
<meta name="twitter:description" content="Commit an ODBC transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_commit - Manual" />
<meta itemprop="description" content="Commit an ODBC transaction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Commit an ODBC transaction" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-commit.php' selected="selected">English</option>
            <option value='de/function.odbc-commit.php'>German</option>
            <option value='es/function.odbc-commit.php'>Spanish</option>
            <option value='fr/function.odbc-commit.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">odbc_commit</span> &mdash; <span class="dc-title">Commit an ODBC transaction</span></p>
 ...
 <td>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-commit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-commit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-commit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-commit.php">＋<small>add a note</small></a></span>
