...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intl.setup.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intl.setup.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intl.setup.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.intl.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.intl.php">
 <link rel="next" href="https://www.php.net/manual/en/intl.requirements.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intl.setup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intl.setup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intl.setup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intl.setup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intl.setup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intl.setup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intl.setup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intl.setup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intl.setup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intl.setup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intl.setup.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intl.setup.php' selected="selected">English</option>
            <option value='de/intl.setup.php'>German</option>
            <option value='es/intl.setup.php'>Spanish</option>
            <option value='fr/intl.setup.php'>French</option>
            <option value='it/intl.setup.php'>Italian</option>
            <option value='ja/intl.setup.php'>Japanese</option>
            <option value='pt_BR/intl.setup.php'>Brazilian Portuguese</option>
            <option value='ru/intl.setup.php'>Russian</option>
            <option value='tr/intl.setup.php'>Turkish</option>
            <option value='uk/intl.setup.php'>Ukrainian</option>
            <option value='zh/intl.setup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intl.setup" class="chapter">
 <h1 class="title">Installing/Configuring</h1>
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="intl.requirements.php">Requirements</a></li><li><a href="intl.installation.php">Installation</a></li><li><a href="intl.configuration.php">Runtime Configuration</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintl.setup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intl.setup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intl.setup.php">＋<small>add a note</small></a></span>
