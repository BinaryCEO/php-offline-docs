...
<head>
  ...
  <title>PHP: SolrQuery::removeFacetField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.removefacetfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.removefacetfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removefacetfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.removefacetdateother.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.removefacetquery.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removefacetfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.removefacetfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.removefacetfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.removefacetfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.removefacetfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.removefacetfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.removefacetfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.removefacetfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.removefacetfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.removefacetfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.removefacetfield.php" hreflang="zh">
...
<meta name="Description" content="Removes one of the facet.date parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::removeFacetField - Manual" />
<meta name="twitter:description" content="Removes one of the facet.date parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::removeFacetField - Manual" />
<meta itemprop="description" content="Removes one of the facet.date parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes one of the facet.date parameters" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.removefacetquery.php">
          SolrQuery::removeFacetQuery &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.removefacetdateother.php">
          &laquo; SolrQuery::removeFacetDateOther        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.removefacetfield.php' selected="selected">English</option>
            <option value='de/solrquery.removefacetfield.php'>German</option>
            <option value='es/solrquery.removefacetfield.php'>Spanish</option>
            <option value='fr/solrquery.removefacetfield.php'>French</option>
            <option value='it/solrquery.removefacetfield.php'>Italian</option>
            <option value='ja/solrquery.removefacetfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.removefacetfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.removefacetfield.php'>Russian</option>
            <option value='tr/solrquery.removefacetfield.php'>Turkish</option>
            <option value='uk/solrquery.removefacetfield.php'>Ukrainian</option>
            <option value='zh/solrquery.removefacetfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.removefacetfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::removeFacetField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::removeFacetField</span> &mdash; <span class="dc-title">Removes one of the facet.date parameters</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.removefacetfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::removeFacetField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.removefacetfield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.removefacetfield-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/removefacetfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.removefacetfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.removefacetfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.removefacetfield.php">＋<small>add a note</small></a></span>
