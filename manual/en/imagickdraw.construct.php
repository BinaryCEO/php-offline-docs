...
<head>
  ...
  <title>PHP: ImagickDraw::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.composite.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.destroy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.construct.php" hreflang="zh">
...
<meta name="Description" content="The ImagickDraw constructor" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::__construct - Manual" />
<meta name="twitter:description" content="The ImagickDraw constructor" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::__construct - Manual" />
<meta itemprop="description" content="The ImagickDraw constructor" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ImagickDraw constructor" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.destroy.php">
          ImagickDraw::destroy &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.composite.php">
          &laquo; ImagickDraw::composite        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.construct.php' selected="selected">English</option>
            <option value='de/imagickdraw.construct.php'>German</option>
            <option value='es/imagickdraw.construct.php'>Spanish</option>
            <option value='fr/imagickdraw.construct.php'>French</option>
            <option value='it/imagickdraw.construct.php'>Italian</option>
            <option value='ja/imagickdraw.construct.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.construct.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.construct.php'>Russian</option>
            <option value='tr/imagickdraw.construct.php'>Turkish</option>
            <option value='uk/imagickdraw.construct.php'>Ukrainian</option>
            <option value='zh/imagickdraw.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.construct" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::__construct</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::__construct</span> &mdash; <span class="dc-title">The ImagickDraw constructor</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.construct-description">
  <h3 class="title">Description</h3>
  <div class="constructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::__construct</strong></span>()</div>

  <div class="warning"><strong class="warning">Warning</strong><p class="simpara">This function is
currently not documented; only its argument list is available.
</p></div>
  <p class="para">
   The <span class="classname"><a href="class.imagickdraw.php" class="classname">ImagickDraw</a></span> constructor.
  </p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.construct-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.construct.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="89981">  <div class="votes">
    <div id="Vu89981">
    <a href="/manual/vote-note.php?id=89981&amp;page=imagickdraw.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd89981">
    <a href="/manual/vote-note.php?id=89981&amp;page=imagickdraw.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V89981" title="22% like this...">
    -5
    </div>
  </div>
  <a href="#89981" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#89981"> &para;</a><div class="date" title="2009-03-31 02:59"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom89981">
<div class="phpcode"><code><span class="html">To set up and output an image the very minimum:<br /><span class="default">&lt;?php<br />$img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">( </span><span class="default">200</span><span class="keyword">, </span><span class="default">200</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">( </span><span class="string">'lime' </span><span class="keyword">) );<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">( </span><span class="string">"png" </span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">( </span><span class="string">"Content-Type: image/png" </span><span class="keyword">);<br />echo </span><span class="default">$img</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span>Copy, paste; and if imagemagick is enabled it should come up with a lime colored square.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.construct.php">＋<small>add a note</small></a></div>
