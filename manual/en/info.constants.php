...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/info.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/info.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/info.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/info.configuration.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/info.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/info.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/info.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/info.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/info.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/info.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/info.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/info.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/info.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/info.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/info.constants.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ref.info.php">
          PHP Options/Info Functions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="info.configuration.php">
          &laquo; Runtime Configuration        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.basic.php.php'>Affecting PHP's Behaviour</a></li>      <li><a href='book.info.php'>PHP Options/Info</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/info.constants.php' selected="selected">English</option>
            <option value='de/info.constants.php'>German</option>
            <option value='es/info.constants.php'>Spanish</option>
            <option value='fr/info.constants.php'>French</option>
            <option value='it/info.constants.php'>Italian</option>
            <option value='ja/info.constants.php'>Japanese</option>
            <option value='pt_BR/info.constants.php'>Brazilian Portuguese</option>
            <option value='ru/info.constants.php'>Russian</option>
            <option value='tr/info.constants.php'>Turkish</option>
            <option value='uk/info.constants.php'>Ukrainian</option>
            <option value='zh/info.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="info.constants" class="appendix">
...
<p class="simpara">This feature was <em>REMOVED</em> as of PHP 8.0.0.</p>
   ...
   <tbody class="tbody">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Finfo.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=info.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/info.constants.php">＋<small>add a note</small></a></span>
 ...
 <div class="note">There are no user contributed notes for this page.</div></section>    </section><!-- layout-content -->
        ...
        <ul class='parent-menu-list'>
                                    <li>
                <a href="book.info.php">PHP Options/Info</a>
                            ...
                            <a href="intro.info.php" title="Introduction">Introduction</a>
                                                ...
                                                <li class="">
                            <a href="info.setup.php" title="Installing/Configuring">Installing/Configuring</a>
                        </li>
                                                <li class="current">
                            <a href="info.constants.php" title="Predefined Constants">Predefined Constants</a>
                        </li>
                                                <li class="">
                            <a href="ref.info.php" title="PHP Options/Info Functions">PHP Options/Info Functions</a>
                        </li>
