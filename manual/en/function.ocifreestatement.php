...
<head>
  ...
  <title>PHP: ocifreestatement - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocifreestatement.php">
 <link rel="shorturl" href="https://www.php.net/ocifreestatement">
 <link rel="alternate" href="https://www.php.net/ocifreestatement" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocifreedesc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ociinternaldebug.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocifreestatement.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocifreestatement.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocifreestatement.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocifreestatement.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocifreestatement.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocifreestatement.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocifreestatement.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocifreestatement.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocifreestatement.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocifreestatement.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocifreestatement.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_free_statement" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocifreestatement - Manual" />
<meta name="twitter:description" content="Alias of oci_free_statement" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocifreestatement - Manual" />
<meta itemprop="description" content="Alias of oci_free_statement" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_free_statement" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ociinternaldebug.php">
          ociinternaldebug &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocifreedesc.php">
          &laquo; ocifreedesc        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocifreestatement.php' selected="selected">English</option>
            <option value='de/function.ocifreestatement.php'>German</option>
            <option value='es/function.ocifreestatement.php'>Spanish</option>
            <option value='fr/function.ocifreestatement.php'>French</option>
            <option value='it/function.ocifreestatement.php'>Italian</option>
            <option value='ja/function.ocifreestatement.php'>Japanese</option>
            <option value='pt_BR/function.ocifreestatement.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocifreestatement.php'>Russian</option>
            <option value='tr/function.ocifreestatement.php'>Turkish</option>
            <option value='uk/function.ocifreestatement.php'>Ukrainian</option>
            <option value='zh/function.ocifreestatement.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocifreestatement" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocifreestatement</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocifreestatement</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-free-statement.php" class="function">oci_free_statement()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocifreestatement-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-free-statement.php" class="function">oci_free_statement()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocifreestatement.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocifreestatement%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocifreestatement&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocifreestatement.php">＋<small>add a note</small></a></span>
