...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pcntl-exec.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pcntl-errno.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pcntl-fork.php">
...
<meta name="Description" content="Executes specified program in current process space" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pcntl_exec - Manual" />
<meta name="twitter:description" content="Executes specified program in current process space" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pcntl_exec - Manual" />
<meta itemprop="description" content="Executes specified program in current process space" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Executes specified program in current process space" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pcntl-exec.php' selected="selected">English</option>
            ...
            <option value='ja/function.pcntl-exec.php'>Japanese</option>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pcntl/functions/pcntl-exec.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pcntl-exec%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pcntl-exec&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pcntl-exec.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>agodong at verizon dot net</em></strong></a><a class="genanchor" href="#71612"> &para;</a><div class="date" title="2006-12-07 10:47"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom71612">
<div class="phpcode"><code><span class="html">Some people might find it useful to run other program using the same process as a different user. This is very usefull if the script is running under root. Here is a simple code to achieve that under *nix PHP CLI:<br /><br />#!/usr/bin/php -q<br /><span class="default">&lt;?php<br /></span><span class="comment">//Enter run-as user below (argument needed to be passed when the script is called), otherwise it will run as the caller user process.<br /><br /></span><span class="default">$username </span><span class="keyword">= </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'argv'</span><span class="keyword">][</span><span class="default">1</span><span class="keyword">];<br /><br /></span><span class="default">$user </span><span class="keyword">= </span><span class="default">posix_getpwnam</span><span class="keyword">(</span><span class="default">$username</span><span class="keyword">);<br /></span><span class="default">posix_setuid</span><span class="keyword">(</span><span class="default">$user</span><span class="keyword">[</span><span class="string">'uid'</span><span class="keyword">]);<br /></span><span class="default">posix_setgid</span><span class="keyword">(</span><span class="default">$user</span><span class="keyword">[</span><span class="string">'gid'</span><span class="keyword">]);<br /></span><span class="default">pcntl_exec</span><span class="keyword">(</span><span class="string">'/path/to/cmd'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />I use this as a part of socket program so that a program can be run under different user from remote location.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>eric kilfoil</em></strong></a><a class="genanchor" href="#70708"> &para;</a><div class="date" title="2006-10-24 10:01"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom70708">
<div class="phpcode"><code><span class="html">The pcntl_exec() function works exactly like the standard (unix-style) exec() function.  It differs from the regular PHP exec() function in that the process calling the pcntl_exec() is replaced with the process that gets called.  This is the ideal method for creating children.  In a simple example (that does no error checking):<br /><br />switch (pcntl_fork()) {<br />  case 0:<br />    $cmd = "/path/to/command";<br />    $args = array("arg1", "arg2");<br />    pcntl_exec($cmd, $args);<br />    // the child will only reach this point on exec failure,<br />    // because execution shifts to the pcntl_exec()ed command<br />    exit(0);<br />  default:<br />    break;<br />}<br /><br />// parent continues<br />echo "I am the parent";<br /><br />--<br /><br />since this is not being executed through a shell, you must provide the exact path from the filesystem root.  Look at the execve() man page for more information.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">As a side note, if I'm reading the comments below correctly, you should not run this if you're using a PHP webserver module, as it will replace the webserver's process with whatever process you're telling it to run.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pcntl-exec&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pcntl-exec.php">＋<small>add a note</small></a></div>
