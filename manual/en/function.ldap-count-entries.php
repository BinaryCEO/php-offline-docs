...
<head>
  ...
  <title>PHP: ldap_count_entries - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-count-entries.php">
 <link rel="shorturl" href="https://www.php.net/ldap-count-entries">
 <link rel="alternate" href="https://www.php.net/ldap-count-entries" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-control-paged-result-response.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-count-references.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-count-entries.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-count-entries.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-count-entries.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-count-entries.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-count-entries.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-count-entries.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-count-entries.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-count-entries.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-count-entries.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-count-entries.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-count-entries.php" hreflang="zh">
...
<meta name="Description" content="Count the number of entries in a search" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_count_entries - Manual" />
<meta name="twitter:description" content="Count the number of entries in a search" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_count_entries - Manual" />
<meta itemprop="description" content="Count the number of entries in a search" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Count the number of entries in a search" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ldap-count-references.php">
          ldap_count_references &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-control-paged-result-response.php">
          &laquo; ldap_control_paged_result_response        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-count-entries.php' selected="selected">English</option>
            <option value='de/function.ldap-count-entries.php'>German</option>
            <option value='es/function.ldap-count-entries.php'>Spanish</option>
            <option value='fr/function.ldap-count-entries.php'>French</option>
            <option value='it/function.ldap-count-entries.php'>Italian</option>
            <option value='ja/function.ldap-count-entries.php'>Japanese</option>
            <option value='pt_BR/function.ldap-count-entries.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-count-entries.php'>Russian</option>
            <option value='tr/function.ldap-count-entries.php'>Turkish</option>
            <option value='uk/function.ldap-count-entries.php'>Ukrainian</option>
            <option value='zh/function.ldap-count-entries.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-count-entries" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_count_entries</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_count_entries</span> &mdash; <span class="dc-title">Count the number of entries in a search</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ldap-count-entries-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_count_entries</strong></span>(<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>, <span class="methodparam"><span class="type"><a href="class.ldap-result.php" class="type LDAP\Result">LDAP\Result</a></span> <code class="parameter">$result</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ldap-count-entries-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ldap-count-entries-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns number of entries in the result, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.ldap-count-entries-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.ldap-count-entries-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="ldap-count-entries.example.basic">
    <p><strong>Example #1 <span class="function"><strong>ldap_count_entries()</strong></span> example</strong></p>
    <div class="example-contents"><p>
     Retrieve number of entries in the result.
    </p></div>
    <div class="example-contents">
     <div class="phpcode"><code><span style="color: #000000">// $ds is a valid LDAP\Connection instance for a directory server<br /><br />     $dn        = 'ou=example,dc=org';<br />     $filter    = '(|(sn=Doe*)(givenname=John*))';<br />     $justthese = array('ou', 'sn', 'givenname', 'mail');<br /><br />     $sr = ldap_search($ds, $dn, $filter, $justthese);<br /><br />     var_dump(ldap_count_entries($ds, $sr));</span></code></div>
    </div>
    ...
    <div class="example-contents screen">
     <div class="examplescode"><pre class="examplescode">int(1)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-count-entries.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-count-entries%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-count-entries&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-count-entries.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117561">  <div class="votes">
    <div id="Vu117561">
    <a href="/manual/vote-note.php?id=117561&amp;page=function.ldap-count-entries&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117561">
    <a href="/manual/vote-note.php?id=117561&amp;page=function.ldap-count-entries&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117561" title="50% like this...">
    0
    </div>
  </div>
  <a href="#117561" class="name">
  <strong class="user"><em>martin dot keckeis1 at gmail dot com</em></strong></a><a class="genanchor" href="#117561"> &para;</a><div class="date" title="2015-06-29 12:11"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117561">
<div class="phpcode"><code><span class="html">If your search result is larger then the directory limit, it will just show you the maximum number of return entries possible by the directory (.e.g 2000 in some ActiveDirectories)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-count-entries&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-count-entries.php">＋<small>add a note</small></a></div>
