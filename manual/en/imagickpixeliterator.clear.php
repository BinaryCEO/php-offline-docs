...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickpixeliterator.clear.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickpixeliterator.clear.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickpixeliterator.clear.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickpixeliterator.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.imagickpixeliterator.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickpixeliterator.construct.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickpixeliterator.clear.php' selected="selected">English</option>
            <option value='de/imagickpixeliterator.clear.php'>German</option>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 examples" id="refsect1-imagickpixeliterator.clear-examples">
  ...
  <p class="para">
    <div class="example" id="example-3212">
      <p><strong>Example #1  <span class="function"><strong>ImagickPixelIterator::clear()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickpixeliterator/clear.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickpixeliterator.clear%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickpixeliterator.clear&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickpixeliterator.clear.php">＋<small>add a note</small></a></span>
