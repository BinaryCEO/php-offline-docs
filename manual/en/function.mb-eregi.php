...
<head>
  ...
  <title>PHP: mb_eregi - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-eregi.php">
 <link rel="shorturl" href="https://www.php.net/mb-eregi">
 <link rel="alternate" href="https://www.php.net/mb-eregi" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-ereg-search-setpos.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-eregi-replace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-eregi.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-eregi.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-eregi.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-eregi.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-eregi.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-eregi.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-eregi.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-eregi.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-eregi.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-eregi.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-eregi.php" hreflang="zh">
...
<meta name="Description" content="Regular expression match ignoring case with multibyte support" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_eregi - Manual" />
<meta name="twitter:description" content="Regular expression match ignoring case with multibyte support" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_eregi - Manual" />
<meta itemprop="description" content="Regular expression match ignoring case with multibyte support" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Regular expression match ignoring case with multibyte support" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mb-eregi-replace.php">
          mb_eregi_replace &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mb-ereg-search-setpos.php">
          &laquo; mb_ereg_search_setpos        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-eregi.php' selected="selected">English</option>
            <option value='de/function.mb-eregi.php'>German</option>
            <option value='es/function.mb-eregi.php'>Spanish</option>
            <option value='fr/function.mb-eregi.php'>French</option>
            <option value='it/function.mb-eregi.php'>Italian</option>
            <option value='ja/function.mb-eregi.php'>Japanese</option>
            <option value='pt_BR/function.mb-eregi.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-eregi.php'>Russian</option>
            <option value='tr/function.mb-eregi.php'>Turkish</option>
            <option value='uk/function.mb-eregi.php'>Ukrainian</option>
            <option value='zh/function.mb-eregi.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-eregi" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_eregi</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_eregi</span> &mdash; <span class="dc-title">Regular expression match ignoring case with multibyte support</span></p>

 </div>
   
 <div class="refsect1 description" id="refsect1-function.mb-eregi-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_eregi</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pattern</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter reference">&$matches</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-eregi-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The <span class="type"><a href="language.types.string.php" class="type string">string</a></span> being searched.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-eregi-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.mb-eregi-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     ...
     <tr>
      <td>7.1.0</td>
      <td>
       <span class="function"><strong>mb_eregi()</strong></span> will now set <code class="parameter">matches</code> to
 ...
 <div class="refsect1 notes" id="refsect1-function.mb-eregi-notes">
...
will be used as the character encoding for this function.</p></p></blockquote>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mb-eregi-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-ereg.php" class="function" rel="rdfs-seeAlso">mb_ereg()</a> - Regular expression match with multibyte support</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-eregi.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-eregi%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-eregi&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-eregi.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="99632">  <div class="votes">
    <div id="Vu99632">
    <a href="/manual/vote-note.php?id=99632&amp;page=function.mb-eregi&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd99632">
    <a href="/manual/vote-note.php?id=99632&amp;page=function.mb-eregi&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V99632" title="60% like this...">
    3
    </div>
  </div>
  <a href="#99632" class="name">
  <strong class="user"><em>bubalula at gmail dot com</em></strong></a><a class="genanchor" href="#99632"> &para;</a><div class="date" title="2010-08-27 07:44"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom99632">
<div class="phpcode"><code><span class="html">This function does not work - it is not case insensitive for non latin characters.</span></code></div>
  </div>
 </div>
  <div class="note" id="31123">  <div class="votes">
    <div id="Vu31123">
    <a href="/manual/vote-note.php?id=31123&amp;page=function.mb-eregi&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd31123">
    <a href="/manual/vote-note.php?id=31123&amp;page=function.mb-eregi&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V31123" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#31123" class="name">
  <strong class="user"><em>steve at brainwashstudios dot com</em></strong></a><a class="genanchor" href="#31123"> &para;</a><div class="date" title="2003-04-10 07:52"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom31123">
<div class="phpcode"><code><span class="html">When this function is perfected, and is not experimental, it may be very usefull in the searching and pinpointing of places inside large text files.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-eregi&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-eregi.php">＋<small>add a note</small></a></div>
