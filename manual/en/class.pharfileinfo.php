...
<head>
  ...
  <title>PHP: PharFileInfo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.pharfileinfo.php">
 <link rel="shorturl" href="https://www.php.net/pharfileinfo">
 <link rel="alternate" href="https://www.php.net/pharfileinfo" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phardata.setstub.php">
 <link rel="next" href="https://www.php.net/manual/en/pharfileinfo.chmod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.pharfileinfo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.pharfileinfo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.pharfileinfo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.pharfileinfo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.pharfileinfo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.pharfileinfo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.pharfileinfo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.pharfileinfo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.pharfileinfo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.pharfileinfo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.pharfileinfo.php" hreflang="zh">
...
<meta name="Description" content="The PharFileInfo class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PharFileInfo - Manual" />
<meta name="twitter:description" content="The PharFileInfo class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PharFileInfo - Manual" />
<meta itemprop="description" content="The PharFileInfo class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The PharFileInfo class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="pharfileinfo.chmod.php">
          PharFileInfo::chmod &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phardata.setstub.php">
          &laquo; PharData::setStub        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.pharfileinfo.php' selected="selected">English</option>
            <option value='de/class.pharfileinfo.php'>German</option>
            <option value='es/class.pharfileinfo.php'>Spanish</option>
            <option value='fr/class.pharfileinfo.php'>French</option>
            <option value='it/class.pharfileinfo.php'>Italian</option>
            <option value='ja/class.pharfileinfo.php'>Japanese</option>
            <option value='pt_BR/class.pharfileinfo.php'>Brazilian Portuguese</option>
            <option value='ru/class.pharfileinfo.php'>Russian</option>
            <option value='tr/class.pharfileinfo.php'>Turkish</option>
            <option value='uk/class.pharfileinfo.php'>Ukrainian</option>
            <option value='zh/class.pharfileinfo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.pharfileinfo" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 1.0.0)</p>
  ...
  <div class="section" id="pharfileinfo.synopsis">
   ...
   <div class="classsynopsis"><div class="classsynopsisinfo">
     ...
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">PharFileInfo</strong></strong>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>)</div>

    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.chmod.php" class="methodname">chmod</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$perms</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.compress.php" class="methodname">compress</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$compression</code></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.decompress.php" class="methodname">decompress</a></span>(): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.delmetadata.php" class="methodname">delMetadata</a></span>(): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.getcrc32.php" class="methodname">getCRC32</a></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.getcompressedsize.php" class="methodname">getCompressedSize</a></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.getcontent.php" class="methodname">getContent</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.getmetadata.php" class="methodname">getMetadata</a></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$unserializeOptions</code><span class="initializer"> = []</span></span>): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.getpharflags.php" class="methodname">getPharFlags</a></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.hasmetadata.php" class="methodname">hasMetadata</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.iscrcchecked.php" class="methodname">isCRCChecked</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.iscompressed.php" class="methodname">isCompressed</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span> <code class="parameter">$compression</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.setmetadata.php" class="methodname">setMetadata</a></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$metadata</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>

    <div class="destructorsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pharfileinfo.destruct.php" class="methodname">__destruct</a></span>()</div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="pharfileinfo.chmod.php">PharFileInfo::chmod</a> — Sets file-specific permission bits</li><li><a href="pharfileinfo.compress.php">PharFileInfo::compress</a> — Compresses the current Phar entry with either zlib or bzip2 compression</li><li><a href="pharfileinfo.construct.php">PharFileInfo::__construct</a> — Construct a Phar entry object</li><li><a href="pharfileinfo.decompress.php">PharFileInfo::decompress</a> — Decompresses the current Phar entry within the phar</li><li><a href="pharfileinfo.delmetadata.php">PharFileInfo::delMetadata</a> — Deletes the metadata of the entry</li><li><a href="pharfileinfo.destruct.php">PharFileInfo::__destruct</a> — Destructs a Phar entry object</li><li><a href="pharfileinfo.getcrc32.php">PharFileInfo::getCRC32</a> — Returns CRC32 code or throws an exception if CRC has not been verified</li><li><a href="pharfileinfo.getcompressedsize.php">PharFileInfo::getCompressedSize</a> — Returns the actual size of the file (with compression) inside the Phar archive</li><li><a href="pharfileinfo.getcontent.php">PharFileInfo::getContent</a> — Get the complete file contents of the entry</li><li><a href="pharfileinfo.getmetadata.php">PharFileInfo::getMetadata</a> — Returns file-specific meta-data saved with a file</li><li><a href="pharfileinfo.getpharflags.php">PharFileInfo::getPharFlags</a> — Returns the Phar file entry flags</li><li><a href="pharfileinfo.hasmetadata.php">PharFileInfo::hasMetadata</a> — Returns the metadata of the entry</li><li><a href="pharfileinfo.iscrcchecked.php">PharFileInfo::isCRCChecked</a> — Returns whether file entry has had its CRC verified</li><li><a href="pharfileinfo.iscompressed.php">PharFileInfo::isCompressed</a> — Returns whether the entry is compressed</li><li><a href="pharfileinfo.setmetadata.php">PharFileInfo::setMetadata</a> — Sets file-specific meta-data saved with a file</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/PharFileInfo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.pharfileinfo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.pharfileinfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.pharfileinfo.php">＋<small>add a note</small></a></span>
