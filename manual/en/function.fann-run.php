...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-run.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-reset-mse.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-save.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-run.php' selected="selected">English</option>
            ...
            <option value='tr/function.fann-run.php'>Turkish</option>
  ...
  <p class="para">
   Array of output values, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-run.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-run%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-run&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-run.php">＋<small>add a note</small></a></span>
