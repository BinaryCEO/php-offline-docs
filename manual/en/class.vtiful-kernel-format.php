...
<head>
  ...
  <title>PHP: Vtiful\Kernel\Format - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.vtiful-kernel-format.php">
 <link rel="shorturl" href="https://www.php.net/vtiful-kernel-format">
 <link rel="alternate" href="https://www.php.net/vtiful-kernel-format" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.xlswriter.php">
 <link rel="prev" href="https://www.php.net/manual/en/vtiful-kernel-excel.setRow.php">
 <link rel="next" href="https://www.php.net/manual/en/vtiful-kernel-format.align.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.vtiful-kernel-format.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.vtiful-kernel-format.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.vtiful-kernel-format.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.vtiful-kernel-format.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.vtiful-kernel-format.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.vtiful-kernel-format.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.vtiful-kernel-format.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.vtiful-kernel-format.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.vtiful-kernel-format.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.vtiful-kernel-format.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.vtiful-kernel-format.php" hreflang="zh">
...
<meta name="Description" content="The Vtiful\Kernel\Format class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Vtiful\Kernel\Format - Manual" />
<meta name="twitter:description" content="The Vtiful\Kernel\Format class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Vtiful\Kernel\Format - Manual" />
<meta itemprop="description" content="The Vtiful\Kernel\Format class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Vtiful\Kernel\Format class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="vtiful-kernel-format.align.php">
          Vtiful\Kernel\Format::align &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="vtiful-kernel-excel.setRow.php">
          &laquo; Vtiful\Kernel\Excel::setRow        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.vtiful-kernel-format.php' selected="selected">English</option>
            <option value='de/class.vtiful-kernel-format.php'>German</option>
            <option value='es/class.vtiful-kernel-format.php'>Spanish</option>
            <option value='fr/class.vtiful-kernel-format.php'>French</option>
            <option value='it/class.vtiful-kernel-format.php'>Italian</option>
            <option value='ja/class.vtiful-kernel-format.php'>Japanese</option>
            <option value='pt_BR/class.vtiful-kernel-format.php'>Brazilian Portuguese</option>
            <option value='ru/class.vtiful-kernel-format.php'>Russian</option>
            <option value='tr/class.vtiful-kernel-format.php'>Turkish</option>
            <option value='uk/class.vtiful-kernel-format.php'>Ukrainian</option>
            <option value='zh/class.vtiful-kernel-format.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.vtiful-kernel-format" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="vtiful-kernel-format.align.php">Vtiful\Kernel\Format::align</a> — Vtiful\Kernel\Format align</li><li><a href="vtiful-kernel-format.bold.php">Vtiful\Kernel\Format::bold</a> — Vtiful\Kernel\Format bold</li><li><a href="vtiful-kernel-format.italic.php">Vtiful\Kernel\Format::italic</a> — Vtiful\Kernel\Format italic</li><li><a href="vtiful-kernel-format.underline.php">Vtiful\Kernel\Format::underline</a> — Vtiful\Kernel\Format underline</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xlswriter/xlsx-format.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.vtiful-kernel-format%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.vtiful-kernel-format&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.vtiful-kernel-format.php">＋<small>add a note</small></a></span>
