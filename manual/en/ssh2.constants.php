...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ssh2.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ssh2.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ssh2.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ssh2.php">
 <link rel="prev" href="https://www.php.net/manual/en/ssh2.resources.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.ssh2.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ssh2.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ssh2.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ssh2.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ssh2.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ssh2.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ssh2.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ssh2.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ssh2.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ssh2.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ssh2.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ssh2.constants.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ssh2.constants.php' selected="selected">English</option>
            <option value='de/ssh2.constants.php'>German</option>
            <option value='es/ssh2.constants.php'>Spanish</option>
            <option value='fr/ssh2.constants.php'>French</option>
            <option value='it/ssh2.constants.php'>Italian</option>
            <option value='ja/ssh2.constants.php'>Japanese</option>
            <option value='pt_BR/ssh2.constants.php'>Brazilian Portuguese</option>
            <option value='ru/ssh2.constants.php'>Russian</option>
            <option value='tr/ssh2.constants.php'>Turkish</option>
            <option value='uk/ssh2.constants.php'>Ukrainian</option>
            <option value='zh/ssh2.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ssh2.constants" class="appendix">
   ...
   <dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ssh2/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fssh2.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ssh2.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ssh2.constants.php">＋<small>add a note</small></a></span>
