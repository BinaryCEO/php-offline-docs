...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.file-get-contents.php">
 <link rel="shorturl" href="https://www.php.net/file-get-contents">
 <link rel="alternate" href="https://www.php.net/file-get-contents" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.file-exists.php">
 <link rel="next" href="https://www.php.net/manual/en/function.file-put-contents.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.file-get-contents.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.file-get-contents.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.file-get-contents.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.file-get-contents.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.file-get-contents.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.file-get-contents.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.file-get-contents.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.file-get-contents.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.file-get-contents.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.file-get-contents.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.file-get-contents.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: file_get_contents - Manual" />
<meta name="twitter:description" content="Reads entire file into a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: file_get_contents - Manual" />
<meta itemprop="description" content="Reads entire file into a string" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.file-put-contents.php">
          file_put_contents &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.file-get-contents.php' selected="selected">English</option>
            <option value='de/function.file-get-contents.php'>German</option>
            <option value='es/function.file-get-contents.php'>Spanish</option>
            <option value='fr/function.file-get-contents.php'>French</option>
            <option value='it/function.file-get-contents.php'>Italian</option>
            ...
            <option value='uk/function.file-get-contents.php'>Ukrainian</option>
   ...
   <ul class="simplelist">
    ...
    <li><a href="reserved.variables.httpresponseheader.php" class="link">$http_response_header</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/file-get-contents.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.file-get-contents%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.file-get-contents&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.file-get-contents.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108309">  <div class="votes">
    <div id="Vu108309">
    <a href="/manual/vote-note.php?id=108309&amp;page=function.file-get-contents&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108309">
    <a href="/manual/vote-note.php?id=108309&amp;page=function.file-get-contents&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108309" title="51% like this...">
    39
    </div>
  </div>
  <a href="#108309" class="name">
  <strong class="user"><em>Bart Friederichs</em></strong></a><a class="genanchor" href="#108309"> &para;</a><div class="date" title="2012-04-16 12:17"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108309">
<div class="phpcode"><code><span class="html">file_get_contents can do a POST, create a context for that first:
<br />
<br /><span class="default">&lt;?php
<br />
<br />$opts </span><span class="keyword">= array(</span><span class="string">'http' </span><span class="keyword">=&gt;
<br />  array(
<br />    </span><span class="string">'method'  </span><span class="keyword">=&gt; </span><span class="string">'POST'</span><span class="keyword">,
<br />    </span><span class="string">'header'  </span><span class="keyword">=&gt; </span><span class="string">"Content-Type: text/xml\r\n"</span><span class="keyword">.
<br />      </span><span class="string">"Authorization: Basic "</span><span class="keyword">.</span><span class="default">base64_encode</span><span class="keyword">(</span><span class="string">"</span><span class="default">$https_user</span><span class="string">:</span><span class="default">$https_password</span><span class="string">"</span><span class="keyword">).</span><span class="string">"\r\n"</span><span class="keyword">,
<br />    </span><span class="string">'content' </span><span class="keyword">=&gt; </span><span class="default">$body</span><span class="keyword">,
<br />    </span><span class="string">'timeout' </span><span class="keyword">=&gt; </span><span class="default">60
...
<br /></span><span class="default">$url </span><span class="keyword">= </span><span class="string">'<a href="https://" rel="nofollow" target="_blank">https://</a>'</span><span class="keyword">.</span><span class="default">$https_server</span><span class="keyword">;
<br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">$url</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">, </span><span class="default">$context</span><span class="keyword">, -</span><span class="default">1</span><span class="keyword">, </span><span class="default">40000</span><span class="keyword">);
<br />
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="128784">  <div class="votes">
    <div id="Vu128784">
    <a href="/manual/vote-note.php?id=128784&amp;page=function.file-get-contents&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128784">
    <a href="/manual/vote-note.php?id=128784&amp;page=function.file-get-contents&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128784" title="57% like this...">
    4
    </div>
  </div>
  <a href="#128784" class="name">
  <strong class="user"><em>brentcontact at daha dot us</em></strong></a><a class="genanchor" href="#128784"> &para;</a><div class="date" title="2023-08-08 10:55"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128784">
<div class="phpcode"><code><span class="html">To prevent mixed content most browsers/functions will use the protocol already used if you specify only // instead of <a href="http://" rel="nofollow" target="_blank">http://</a> or <a href="https://." rel="nofollow" target="_blank">https://.</a> This is not the case with file_get_contents. You must specify the protocol. <br /><br />This does not work:<br /><span class="default">&lt;?php<br />$jsonData </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="string">'//example.com/file.json'</span><span class="keyword">);<br />print </span><span class="default">$jsonData</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Specifying only 'example.com/file.json' without the double slash does not work either.<br /><br />When running on Apache 2.4 , using $_SERVER['REQUEST_SCHEME'] is a better way to be protocol agnostic.<br /><span class="default">&lt;?php<br />$jsonData </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'REQUEST_SCHEME'</span><span class="keyword">].</span><span class="string">'://example.com/file.json'</span><span class="keyword">);<br />print </span><span class="default">$jsonData</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />If using another web server, you may have to get the protocol another way or hard code it.</span></code></div>
  ...
  <div class="note" id="129074">  <div class="votes">
    <div id="Vu129074">
    <a href="/manual/vote-note.php?id=129074&amp;page=function.file-get-contents&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129074">
    <a href="/manual/vote-note.php?id=129074&amp;page=function.file-get-contents&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129074" title="56% like this...">
    3
    </div>
  </div>
  <a href="#129074" class="name">
  <strong class="user"><em>KC</em></strong></a><a class="genanchor" href="#129074"> &para;</a><div class="date" title="2023-11-29 01:58"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129074">
<div class="phpcode"><code><span class="html">If doing a negative offset to grab the end of a file and the file is shorter than the offset, then file_get_contents( ) will return false.<br /><br />If you want it to just return what is available when the file is shorter than the negative offset, you could try again.<br /><br />For example...<br /><br />$contents = file_get_contents( $log_file, false, null, -4096 ); // Get last 4KB<br /><br />if ( false === $contents ) {<br />    // Maybe error, or maybe file less than 4KB in size.<br /><br />    $contents = file_get_contents( $log_file, false, null );<br /><br />    if ( false === $contents ) {<br />        // Handle real error.<br />    }<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.file-get-contents&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.file-get-contents.php">＋<small>add a note</small></a></div>
