...
<head>
  ...
  <title>PHP: gmp_pow - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-pow.php">
 <link rel="shorturl" href="https://www.php.net/gmp-pow">
 <link rel="alternate" href="https://www.php.net/gmp-pow" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-popcount.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-powm.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-pow.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-pow.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-pow.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-pow.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-pow.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-pow.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-pow.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-pow.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-pow.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-pow.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-pow.php" hreflang="zh">
...
<meta name="Description" content="Raise number into power" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_pow - Manual" />
<meta name="twitter:description" content="Raise number into power" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_pow - Manual" />
<meta itemprop="description" content="Raise number into power" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Raise number into power" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-pow.php' selected="selected">English</option>
            <option value='de/function.gmp-pow.php'>German</option>
            <option value='es/function.gmp-pow.php'>Spanish</option>
            <option value='fr/function.gmp-pow.php'>French</option>
            <option value='it/function.gmp-pow.php'>Italian</option>
            <option value='ja/function.gmp-pow.php'>Japanese</option>
            <option value='pt_BR/function.gmp-pow.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-pow.php'>Russian</option>
            <option value='tr/function.gmp-pow.php'>Turkish</option>
            <option value='uk/function.gmp-pow.php'>Ukrainian</option>
            <option value='zh/function.gmp-pow.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-pow" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_pow</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_pow</span> &mdash; <span class="dc-title">Raise number into power</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-pow-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_pow</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$exponent</code></span>): <span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span></div>

  <p class="para rdfs-comment">
   Raise <code class="parameter">num</code> into power <code class="parameter">exponent</code>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.gmp-pow-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-pow-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The new (raised) number, as a GMP number. The case of 
   <code class="literal">0^0</code> yields 1.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.gmp-pow-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3340">
    <p><strong>Example #1 <span class="function"><strong>gmp_pow()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">2147483648
1</pre>
</div>
    </div>
   </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-pow.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-pow%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-pow&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-pow.php">＋<small>add a note</small></a></span>
