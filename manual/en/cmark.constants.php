...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/cmark.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/cmark.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/cmark.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.cmark.php">
 <link rel="prev" href="https://www.php.net/manual/en/cmark.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/class.commonmark-node-document.php">

 <link rel="alternate" href="https://www.php.net/manual/en/cmark.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/cmark.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/cmark.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/cmark.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/cmark.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/cmark.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/cmark.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/cmark.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/cmark.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/cmark.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/cmark.constants.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.commonmark-node-document.php">
          CommonMark\Node\Document &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/cmark.constants.php' selected="selected">English</option>
            <option value='de/cmark.constants.php'>German</option>
            <option value='es/cmark.constants.php'>Spanish</option>
            <option value='fr/cmark.constants.php'>French</option>
            <option value='it/cmark.constants.php'>Italian</option>
            <option value='ja/cmark.constants.php'>Japanese</option>
            <option value='pt_BR/cmark.constants.php'>Brazilian Portuguese</option>
            <option value='ru/cmark.constants.php'>Russian</option>
            <option value='tr/cmark.constants.php'>Turkish</option>
            <option value='uk/cmark.constants.php'>Ukrainian</option>
            <option value='zh/cmark.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="cmark.constants" class="appendix">
   ...
   <dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cmark/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcmark.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=cmark.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/cmark.constants.php">＋<small>add a note</small></a></span>
