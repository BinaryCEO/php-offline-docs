...
<head>
  ...
  <title>PHP: date_sub - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-sub.php">
 <link rel="shorturl" href="https://www.php.net/date-sub">
 <link rel="alternate" href="https://www.php.net/date-sub" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-parse-from-format.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-sun-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-sub.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-sub.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-sub.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-sub.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-sub.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-sub.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-sub.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-sub.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-sub.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-sub.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-sub.php" hreflang="zh">
...
<meta name="Description" content="Alias of DateTime::sub" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_sub - Manual" />
<meta name="twitter:description" content="Alias of DateTime::sub" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_sub - Manual" />
<meta itemprop="description" content="Alias of DateTime::sub" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTime::sub" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.date-parse-from-format.php">
          &laquo; date_parse_from_format        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-sub.php' selected="selected">English</option>
            <option value='de/function.date-sub.php'>German</option>
            <option value='es/function.date-sub.php'>Spanish</option>
            <option value='fr/function.date-sub.php'>French</option>
            <option value='it/function.date-sub.php'>Italian</option>
            <option value='ja/function.date-sub.php'>Japanese</option>
            <option value='pt_BR/function.date-sub.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-sub.php'>Russian</option>
            <option value='tr/function.date-sub.php'>Turkish</option>
            <option value='uk/function.date-sub.php'>Ukrainian</option>
            <option value='zh/function.date-sub.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-sub" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">date_sub</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">date_sub</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetime.sub.php" class="methodname">DateTime::sub()</a></span></span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.date-sub-description">
  ...
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetime.sub.php" class="methodname">DateTime::sub()</a></span>
  </p>
 </div>
  ...
  <p class="para">
   ...
   a DateTime object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-sub.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-sub%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-sub&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-sub.php">＋<small>add a note</small></a></span>
