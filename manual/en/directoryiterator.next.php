...
<head>
  ...
  <title>PHP: DirectoryIterator::next - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/directoryiterator.next.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/directoryiterator.next.php">
 <link rel="alternate" href="https://www.php.net/manual/en/directoryiterator.next.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.directoryiterator.php">
 <link rel="prev" href="https://www.php.net/manual/en/directoryiterator.key.php">
 <link rel="next" href="https://www.php.net/manual/en/directoryiterator.rewind.php">

 <link rel="alternate" href="https://www.php.net/manual/en/directoryiterator.next.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/directoryiterator.next.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/directoryiterator.next.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/directoryiterator.next.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/directoryiterator.next.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/directoryiterator.next.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/directoryiterator.next.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/directoryiterator.next.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/directoryiterator.next.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/directoryiterator.next.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/directoryiterator.next.php" hreflang="zh">
...
<meta name="Description" content="Move forward to next DirectoryIterator item" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DirectoryIterator::next - Manual" />
<meta name="twitter:description" content="Move forward to next DirectoryIterator item" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DirectoryIterator::next - Manual" />
<meta itemprop="description" content="Move forward to next DirectoryIterator item" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Move forward to next DirectoryIterator item" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="directoryiterator.rewind.php">
          DirectoryIterator::rewind &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="directoryiterator.key.php">
          &laquo; DirectoryIterator::key        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/directoryiterator.next.php' selected="selected">English</option>
            <option value='de/directoryiterator.next.php'>German</option>
            <option value='es/directoryiterator.next.php'>Spanish</option>
            <option value='fr/directoryiterator.next.php'>French</option>
            <option value='it/directoryiterator.next.php'>Italian</option>
            <option value='ja/directoryiterator.next.php'>Japanese</option>
            <option value='pt_BR/directoryiterator.next.php'>Brazilian Portuguese</option>
            <option value='ru/directoryiterator.next.php'>Russian</option>
            <option value='tr/directoryiterator.next.php'>Turkish</option>
            <option value='uk/directoryiterator.next.php'>Ukrainian</option>
            <option value='zh/directoryiterator.next.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="directoryiterator.next" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-directoryiterator.next-examples">
  ...
  <p class="para">
   <div class="example" id="example-3921">
    <p><strong>Example #1 <span class="methodname"><strong>DirectoryIterator::next()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="iterator.next.php" class="methodname" rel="rdfs-seeAlso">Iterator::next()</a> - Move forward to next element</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/directoryiterator/next.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdirectoryiterator.next%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=directoryiterator.next&amp;repo=en&amp;redirect=https://www.php.net/manual/en/directoryiterator.next.php">＋<small>add a note</small></a></span>
