...
<head>
  ...
  <title>PHP: ps_moveto - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-moveto.php">
 <link rel="shorturl" href="https://www.php.net/ps-moveto">
 <link rel="alternate" href="https://www.php.net/ps-moveto" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-makespotcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-new.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-moveto.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-moveto.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-moveto.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-moveto.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-moveto.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-moveto.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-moveto.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-moveto.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-moveto.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-moveto.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-moveto.php" hreflang="zh">
...
<meta name="Description" content="Sets current point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_moveto - Manual" />
<meta name="twitter:description" content="Sets current point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_moveto - Manual" />
<meta itemprop="description" content="Sets current point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets current point" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-moveto.php' selected="selected">English</option>
            <option value='de/function.ps-moveto.php'>German</option>
            <option value='es/function.ps-moveto.php'>Spanish</option>
            <option value='fr/function.ps-moveto.php'>French</option>
            <option value='it/function.ps-moveto.php'>Italian</option>
            <option value='ja/function.ps-moveto.php'>Japanese</option>
            <option value='pt_BR/function.ps-moveto.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-moveto.php'>Russian</option>
            <option value='tr/function.ps-moveto.php'>Turkish</option>
            <option value='uk/function.ps-moveto.php'>Ukrainian</option>
            <option value='zh/function.ps-moveto.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-moveto" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_moveto</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_moveto</span> &mdash; <span class="dc-title">Sets current point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-moveto-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_moveto</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Sets the current point to new coordinates. If this is the first call of
   <span class="function"><strong>ps_moveto()</strong></span> after a previous path has been ended then it
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-moveto-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-moveto-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-moveto-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-lineto.php" class="function" rel="rdfs-seeAlso">ps_lineto()</a> - Draws a line</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-moveto.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-moveto%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-moveto&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-moveto.php">＋<small>add a note</small></a></span>
