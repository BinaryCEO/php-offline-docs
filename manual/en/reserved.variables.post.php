...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reserved.variables.post.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reserved.variables.post.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reserved.variables.post.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.variables.php">
 <link rel="prev" href="https://www.php.net/manual/en/reserved.variables.get.php">
 <link rel="next" href="https://www.php.net/manual/en/reserved.variables.files.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reserved.variables.post.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reserved.variables.post.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reserved.variables.post.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reserved.variables.post.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reserved.variables.post.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reserved.variables.post.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reserved.variables.post.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reserved.variables.post.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reserved.variables.post.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reserved.variables.post.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reserved.variables.post.php" hreflang="zh">
...
<meta name="Description" content="HTTP POST variables" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: $_POST - Manual" />
<meta name="twitter:description" content="HTTP POST variables" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: $_POST - Manual" />
<meta itemprop="description" content="HTTP POST variables" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="HTTP POST variables" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reserved.variables.post.php' selected="selected">English</option>
            ...
            <option value='it/reserved.variables.post.php'>Italian</option>
            ...
            <option value='uk/reserved.variables.post.php'>Ukrainian</option>
  ...
  </div><div id="reserved.variables.post" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">$_POST</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">$_POST</span> &mdash; <span class="dc-title">HTTP POST variables</span></p>
 ...
 <div class="refsect1 description" id="refsect1-reserved.variables.post-description">
  ...
  <p class="para">
   ...
   via the HTTP POST method when using <code class="literal">application/x-www-form-urlencoded</code>
   or <code class="literal">multipart/form-data</code> as the HTTP Content-Type in the request.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-reserved.variables.post-examples">
  ...
  <p class="para">
   <div class="example" id="variable.post.basic">
    <p><strong>Example #1 <var class="varname">$_POST</var> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><a href="book.filter.php" class="link">The filter extension</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/variables/post.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freserved.variables.post%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reserved.variables.post&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reserved.variables.post.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">6 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="87650">  <div class="votes">
    <div id="Vu87650">
    <a href="/manual/vote-note.php?id=87650&amp;page=reserved.variables.post&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd87650">
    <a href="/manual/vote-note.php?id=87650&amp;page=reserved.variables.post&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V87650" title="61% like this...">
    279
    </div>
  </div>
  <a href="#87650" class="name">
  <strong class="user"><em>james dot ellis at gmail dot com</em></strong></a><a class="genanchor" href="#87650"> &para;</a><div class="date" title="2008-12-14 05:38"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom87650">
<div class="phpcode"><code><span class="html">One feature of PHP's processing of POST and GET variables is that it automatically decodes indexed form variable names.<br /><br />I've seem innumerable projects that jump through extra &amp; un-needed processing hoops to decode variables when PHP does it all for you:<br /><br />Example pseudo code:<br /><br />Many web sites do this:<br /><br />&lt;form ....&gt;<br />&lt;input name="person_0_first_name" value="john" /&gt;<br />&lt;input name="person_0_last_name" value="smith" /&gt;<br />...<br /><br />&lt;input name="person_1_first_name" value="jane" /&gt;<br />&lt;input name="person_1_last_name" value="jones" /&gt;<br />&lt;/form&gt;<br /><br />When they could do this:<br /><br />&lt;form ....&gt;<br />&lt;input name="person[0][first_name]" value="john" /&gt;<br />&lt;input name="person[0][last_name]" value="smith" /&gt;<br />...<br />&lt;input name="person[1][first_name]" value="jane" /&gt;<br />&lt;input name="person[1][last_name]" value="jones" /&gt;<br />&lt;/form&gt;<br /><br />With the first example you'd have to do string parsing / regexes to get the correct values out so they can be married with other data in your app... whereas with the second example.. you will end up with something like:<br /><span class="default">&lt;?php<br />var_dump</span><span class="keyword">(</span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'person'</span><span class="keyword">]);<br /></span><span class="comment">//will get you something like:<br /></span><span class="keyword">array (<br /></span><span class="default">0 </span><span class="keyword">=&gt; array(</span><span class="string">'first_name'</span><span class="keyword">=&gt;</span><span class="string">'john'</span><span class="keyword">,</span><span class="string">'last_name'</span><span class="keyword">=&gt;</span><span class="string">'smith'</span><span class="keyword">),<br /></span><span class="default">1 </span><span class="keyword">=&gt; array(</span><span class="string">'first_name'</span><span class="keyword">=&gt;</span><span class="string">'jane'</span><span class="keyword">,</span><span class="string">'last_name'</span><span class="keyword">=&gt;</span><span class="string">'jones'</span><span class="keyword">),<br />)<br /></span><span class="default">?&gt;<br /></span><br />This is invaluable when you want to link various posted form data to other hashes on the server side, when you need to store posted data in separate "compartment" arrays or when you want to link your POSTed data into different record handlers in various Frameworks.<br /><br />Remember also that using [] as in index will cause a sequential numeric array to be created once the data is posted, so sometimes it's better to define your indexes explicitly.</span></code></div>
  </div>
 </div>
  <div class="note" id="125651">  <div class="votes">
    <div id="Vu125651">
    <a href="/manual/vote-note.php?id=125651&amp;page=reserved.variables.post&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125651">
    <a href="/manual/vote-note.php?id=125651&amp;page=reserved.variables.post&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125651" title="63% like this...">
    56
    </div>
  </div>
  <a href="#125651" class="name">
  <strong class="user"><em>php (at) vxvr /dot de</em></strong></a><a class="genanchor" href="#125651"> &para;</a><div class="date" title="2021-01-03 04:13"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125651">
<div class="phpcode"><code><span class="html">If you want to receive application/json post data in your script you can not use $_POST. $_POST does only handle form data.<br />Read from php://input instead. You can use fopen or file_get_contents.<br /><br />Example:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Get the JSON contents<br /></span><span class="default">$json </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="string">'php://input'</span><span class="keyword">);<br /><br /></span><span class="comment">// decode the json data<br /></span><span class="default">$data </span><span class="keyword">= </span><span class="default">json_decode</span><span class="keyword">(</span><span class="default">$json</span><span class="keyword">);<br /> </span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="117808">  <div class="votes">
    <div id="Vu117808">
    <a href="/manual/vote-note.php?id=117808&amp;page=reserved.variables.post&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117808">
    <a href="/manual/vote-note.php?id=117808&amp;page=reserved.variables.post&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117808" title="57% like this...">
    75
    </div>
  </div>
  <a href="#117808" class="name">
  <strong class="user"><em>darren_wheatley at hotmail dot com</em></strong></a><a class="genanchor" href="#117808"> &para;</a><div class="date" title="2015-08-13 03:08"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117808">
<div class="phpcode"><code><span class="html">I know it's a pretty basic thing but I had issues trying to access the $_POST variable on a form submission from my HTML page. It took me ages to work out and I couldn't find the help I needed in google. Hence this post.<br /><br />Make sure your input items have the NAME attribute. The id attribute is not enough! The name attribute on your input controls is what $_POST uses to index the data and therefore show the results.</span></code></div>
  </div>
 </div>
  <div class="note" id="114598">  <div class="votes">
    <div id="Vu114598">
    <a href="/manual/vote-note.php?id=114598&amp;page=reserved.variables.post&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114598">
    <a href="/manual/vote-note.php?id=114598&amp;page=reserved.variables.post&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114598" title="54% like this...">
    36
    </div>
  </div>
  <a href="#114598" class="name">
  <strong class="user"><em>CXJ</em></strong></a><a class="genanchor" href="#114598"> &para;</a><div class="date" title="2014-03-10 08:18"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114598">
<div class="phpcode"><code><span class="html">Note that $_POST is NOT set for all HTTP POST operations,  but only for specific types of POST operations.  I have not been able to find documentation, but here's what I've found so far.<br /><br />$_POST _is_ set for:<br /><br />Content-Type: application/x-www-form-urlencoded<br /><br />In other words,  for standard web forms.<br /><br />$_POST is NOT set for:<br /><br />Content-Type:text/xml<br /><br />A type used for a generic HTTP POST operation.</span></code></div>
  </div>
 </div>
  <div class="note" id="119608">  <div class="votes">
    <div id="Vu119608">
    <a href="/manual/vote-note.php?id=119608&amp;page=reserved.variables.post&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119608">
    <a href="/manual/vote-note.php?id=119608&amp;page=reserved.variables.post&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119608" title="55% like this...">
    26
    </div>
  </div>
  <a href="#119608" class="name">
  <strong class="user"><em>woodhavenbp at yahoo dot com</em></strong></a><a class="genanchor" href="#119608"> &para;</a><div class="date" title="2016-07-15 04:21"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119608">
<div class="phpcode"><code><span class="html">There's an earlier note here about correctly referencing elements in $_POST which is accurate.  $_POST is an associative array indexed by form element NAMES, not IDs.  One way to think of it is like this:  element "id=" is for CSS, while element "name=" is for PHP.  If you are referring to your element ID in the POST array, it won't work.  You must assign a name attribute to your element to reference it correctly in the POST array.  These two attributes can be the same for simplicity, i.e., <br />&lt;input type="text" id="txtForm" name="txtForm"&gt;...&lt;/input&gt;</span></code></div>
  </div>
 </div>
  <div class="note" id="87512">  <div class="votes">
    <div id="Vu87512">
    <a href="/manual/vote-note.php?id=87512&amp;page=reserved.variables.post&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd87512">
    <a href="/manual/vote-note.php?id=87512&amp;page=reserved.variables.post&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V87512" title="52% like this...">
    15
    </div>
  </div>
  <a href="#87512" class="name">
  <strong class="user"><em>paul at youngish dot homelinux^org</em></strong></a><a class="genanchor" href="#87512"> &para;</a><div class="date" title="2008-12-08 01:09"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom87512">
<div class="phpcode"><code><span class="html">For a page with multiple forms here is one way of processing the different POST values that you may receive.  This code is good for when you have distinct forms on a page.  Adding another form only requires an extra entry in the array and switch statements. <br /><br /><span class="default">&lt;?php<br /><br /> </span><span class="keyword">if (!empty(</span><span class="default">$_POST</span><span class="keyword">))<br /> {<br />    </span><span class="comment">// Array of post values for each different form on your page.<br />    </span><span class="default">$postNameArr </span><span class="keyword">= array(</span><span class="string">'F1_Submit'</span><span class="keyword">, </span><span class="string">'F2_Submit'</span><span class="keyword">, </span><span class="string">'F3_Submit'</span><span class="keyword">);        <br /><br />    </span><span class="comment">// Find all of the post identifiers within $_POST<br />    </span><span class="default">$postIdentifierArr </span><span class="keyword">= array();<br />        <br />    foreach (</span><span class="default">$postNameArr </span><span class="keyword">as </span><span class="default">$postName</span><span class="keyword">)<br />    {<br />        if (</span><span class="default">array_key_exists</span><span class="keyword">(</span><span class="default">$postName</span><span class="keyword">, </span><span class="default">$_POST</span><span class="keyword">))<br />        {<br />             </span><span class="default">$postIdentifierArr</span><span class="keyword">[] = </span><span class="default">$postName</span><span class="keyword">;<br />        }<br />    }<br /><br />    </span><span class="comment">// Only one form should be submitted at a time so we should have one<br />    // post identifier.  The die statements here are pretty harsh you may consider<br />    // a warning rather than this. <br />    </span><span class="keyword">if (</span><span class="default">count</span><span class="keyword">(</span><span class="default">$postIdentifierArr</span><span class="keyword">) != </span><span class="default">1</span><span class="keyword">)<br />    {<br />        </span><span class="default">count</span><span class="keyword">(</span><span class="default">$postIdentifierArr</span><span class="keyword">) &lt; </span><span class="default">1 </span><span class="keyword">or<br />            die(</span><span class="string">"\$_POST contained more than one post identifier: " </span><span class="keyword">.<br />               </span><span class="default">implode</span><span class="keyword">(</span><span class="string">" "</span><span class="keyword">, </span><span class="default">$postIdentifierArr</span><span class="keyword">));<br /><br />        </span><span class="comment">// We have not died yet so we must have less than one.<br />        </span><span class="keyword">die(</span><span class="string">"\$_POST did not contain a known post identifier."</span><span class="keyword">);<br />    }<br />         <br />    switch (</span><span class="default">$postIdentifierArr</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">])<br />    {<br />    case </span><span class="string">'F1_Submit'</span><span class="keyword">:<br />       echo </span><span class="string">"Perform actual code for F1_Submit."</span><span class="keyword">;<br />       break;<br /><br />    case </span><span class="string">'Modify'</span><span class="keyword">:<br />       echo </span><span class="string">"Perform actual code for F2_Submit."</span><span class="keyword">;<br />       break;<br />           <br />    case </span><span class="string">'Delete'</span><span class="keyword">:<br />       echo </span><span class="string">"Perform actual code for F3_Submit."</span><span class="keyword">;<br />       break;<br />    }<br />}<br />else </span><span class="comment">// $_POST is empty.<br /></span><span class="keyword">{<br />    echo </span><span class="string">"Perform code for page without POST data. "</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reserved.variables.post&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reserved.variables.post.php">＋<small>add a note</small></a></div>
