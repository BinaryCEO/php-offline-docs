...
<head>
  ...
  <title>PHP: eio_rename - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-rename.php">
 <link rel="shorturl" href="https://www.php.net/eio-rename">
 <link rel="alternate" href="https://www.php.net/eio-rename" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-realpath.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-rmdir.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-rename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-rename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-rename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-rename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-rename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-rename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-rename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-rename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-rename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-rename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-rename.php" hreflang="zh">
...
<meta name="Description" content="Change the name or location of a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_rename - Manual" />
<meta name="twitter:description" content="Change the name or location of a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_rename - Manual" />
<meta itemprop="description" content="Change the name or location of a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Change the name or location of a file" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.eio-rmdir.php">
          eio_rmdir &raquo;
              ...
              <div class="prev">
        <a href="function.eio-realpath.php">
          &laquo; eio_realpath        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-rename.php' selected="selected">English</option>
            <option value='de/function.eio-rename.php'>German</option>
            <option value='es/function.eio-rename.php'>Spanish</option>
            <option value='fr/function.eio-rename.php'>French</option>
            <option value='it/function.eio-rename.php'>Italian</option>
            <option value='ja/function.eio-rename.php'>Japanese</option>
            <option value='pt_BR/function.eio-rename.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-rename.php'>Russian</option>
            <option value='tr/function.eio-rename.php'>Turkish</option>
            <option value='uk/function.eio-rename.php'>Ukrainian</option>
            <option value='zh/function.eio-rename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-rename" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-rename-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_rename</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$new_path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-rename-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>eio_rename()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
<div class="examplescode"><pre class="examplescode">eio_rename_ok</pre>
</div>
   </div>
  </div>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-rename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-rename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-rename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-rename.php">＋<small>add a note</small></a></span>
