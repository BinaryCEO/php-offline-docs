...
<head>
  ...
  <title>PHP: trader_macdext - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-macdext.php">
 <link rel="shorturl" href="https://www.php.net/trader-macdext">
 <link rel="alternate" href="https://www.php.net/trader-macdext" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-macd.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-macdfix.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-macdext.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-macdext.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-macdext.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-macdext.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-macdext.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-macdext.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-macdext.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-macdext.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-macdext.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-macdext.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-macdext.php" hreflang="zh">
...
<meta name="Description" content="MACD with controllable MA type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_macdext - Manual" />
<meta name="twitter:description" content="MACD with controllable MA type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_macdext - Manual" />
<meta itemprop="description" content="MACD with controllable MA type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="MACD with controllable MA type" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-macdfix.php">
          trader_macdfix &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-macdext.php' selected="selected">English</option>
            <option value='de/function.trader-macdext.php'>German</option>
            <option value='es/function.trader-macdext.php'>Spanish</option>
            <option value='fr/function.trader-macdext.php'>French</option>
            <option value='it/function.trader-macdext.php'>Italian</option>
            <option value='ja/function.trader-macdext.php'>Japanese</option>
            <option value='pt_BR/function.trader-macdext.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-macdext.php'>Russian</option>
            <option value='tr/function.trader-macdext.php'>Turkish</option>
            <option value='uk/function.trader-macdext.php'>Ukrainian</option>
            <option value='zh/function.trader-macdext.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-macdext" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_macdext</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_macdext</span> &mdash; <span class="dc-title">MACD with controllable MA type</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.trader-macdext-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_macdext</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fastPeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fastMAType</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$slowPeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$slowMAType</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$signalPeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$signalMAType</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-macdext-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">fastMAType</code></dt>
    <dd>
     <p class="para">
      Type of Moving Average for fast MA. <a href="trader.constants.php" class="link">TRADER_MA_TYPE_*</a> series of constants should be used.
     </p>
    </dd>
    ...
    <dt><code class="parameter">slowMAType</code></dt>
    <dd>
     <p class="para">
      Type of Moving Average for slow MA. <a href="trader.constants.php" class="link">TRADER_MA_TYPE_*</a> series of constants should be used.
     </p>
    </dd>
    ...
    <dt><code class="parameter">signalMAType</code></dt>
    <dd>
     <p class="para">
      Type of Moving Average for signal line. <a href="trader.constants.php" class="link">TRADER_MA_TYPE_*</a> series of constants should be used.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-macdext-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-macdext.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-macdext%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-macdext&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-macdext.php">＋<small>add a note</small></a></span>
