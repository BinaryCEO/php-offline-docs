...
<head>
  ...
  <title>PHP: ImagickDraw::getFillOpacity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getfillopacity.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getfillopacity.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfillopacity.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getfillcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getfillrule.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfillopacity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getfillopacity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getfillopacity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getfillopacity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getfillopacity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getfillopacity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getfillopacity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getfillopacity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getfillopacity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getfillopacity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getfillopacity.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::getFillOpacity - Manual" />
<meta name="twitter:description" content="Returns the opacity used when drawing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getFillOpacity - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.getfillrule.php">
          ImagickDraw::getFillRule &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getfillcolor.php">
          &laquo; ImagickDraw::getFillColor        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getfillopacity.php' selected="selected">English</option>
            <option value='de/imagickdraw.getfillopacity.php'>German</option>
            <option value='es/imagickdraw.getfillopacity.php'>Spanish</option>
            <option value='fr/imagickdraw.getfillopacity.php'>French</option>
            <option value='it/imagickdraw.getfillopacity.php'>Italian</option>
            <option value='ja/imagickdraw.getfillopacity.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getfillopacity.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getfillopacity.php'>Russian</option>
            <option value='tr/imagickdraw.getfillopacity.php'>Turkish</option>
            <option value='uk/imagickdraw.getfillopacity.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getfillopacity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getfillopacity" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getFillOpacity</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getFillOpacity</span> &mdash; <span class="dc-title">Returns the opacity used when drawing</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getfillopacity-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getFillOpacity</strong></span>(): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getfillopacity-returnvalues">
  ...
  <p class="para">
   The opacity. 
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getfillopacity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getfillopacity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getfillopacity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getfillopacity.php">＋<small>add a note</small></a></span>
