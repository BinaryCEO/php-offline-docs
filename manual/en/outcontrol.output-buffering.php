...
<head>
  ...
  <title>PHP: Output Buffering - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/outcontrol.output-buffering.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/outcontrol.output-buffering.php">
 <link rel="alternate" href="https://www.php.net/manual/en/outcontrol.output-buffering.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.outcontrol.php">
 <link rel="prev" href="https://www.php.net/manual/en/outcontrol.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/outcontrol.flushing-system-buffers.php">

 <link rel="alternate" href="https://www.php.net/manual/en/outcontrol.output-buffering.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/outcontrol.output-buffering.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/outcontrol.output-buffering.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/outcontrol.output-buffering.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/outcontrol.output-buffering.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/outcontrol.output-buffering.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/outcontrol.output-buffering.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/outcontrol.output-buffering.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/outcontrol.output-buffering.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/outcontrol.output-buffering.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/outcontrol.output-buffering.php" hreflang="zh">
...
<meta name="Description" content="Output Buffering" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Output Buffering - Manual" />
<meta name="twitter:description" content="Output Buffering" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Output Buffering - Manual" />
<meta itemprop="description" content="Output Buffering" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Output Buffering" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/outcontrol.output-buffering.php' selected="selected">English</option>
            <option value='de/outcontrol.output-buffering.php'>German</option>
            <option value='es/outcontrol.output-buffering.php'>Spanish</option>
            <option value='fr/outcontrol.output-buffering.php'>French</option>
            <option value='it/outcontrol.output-buffering.php'>Italian</option>
            <option value='ja/outcontrol.output-buffering.php'>Japanese</option>
            <option value='pt_BR/outcontrol.output-buffering.php'>Brazilian Portuguese</option>
            <option value='ru/outcontrol.output-buffering.php'>Russian</option>
            <option value='tr/outcontrol.output-buffering.php'>Turkish</option>
            <option value='uk/outcontrol.output-buffering.php'>Ukrainian</option>
            <option value='zh/outcontrol.output-buffering.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="outcontrol.output-buffering" class="chapter">
   ...
   <ul class="itemizedlist">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/outcontrol/output-buffering.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Foutcontrol.output-buffering%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=outcontrol.output-buffering&amp;repo=en&amp;redirect=https://www.php.net/manual/en/outcontrol.output-buffering.php">＋<small>add a note</small></a></span>
