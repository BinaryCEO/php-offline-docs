...
<head>
  ...
  <title>PHP: ReflectionParameter::__toString - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionparameter.tostring.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionparameter.tostring.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionparameter.tostring.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionparameter.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionparameter.isvariadic.php">
 <link rel="next" href="https://www.php.net/manual/en/class.reflectionproperty.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionparameter.tostring.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionparameter.tostring.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionparameter.tostring.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionparameter.tostring.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionparameter.tostring.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionparameter.tostring.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionparameter.tostring.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionparameter.tostring.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionparameter.tostring.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionparameter.tostring.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionparameter.tostring.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ReflectionParameter::__toString - Manual" />
<meta name="twitter:description" content="To string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionParameter::__toString - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.reflectionproperty.php">
          ReflectionProperty &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionparameter.isvariadic.php">
          &laquo; ReflectionParameter::isVariadic        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionparameter.tostring.php' selected="selected">English</option>
            <option value='de/reflectionparameter.tostring.php'>German</option>
            <option value='es/reflectionparameter.tostring.php'>Spanish</option>
            <option value='fr/reflectionparameter.tostring.php'>French</option>
            <option value='it/reflectionparameter.tostring.php'>Italian</option>
            <option value='ja/reflectionparameter.tostring.php'>Japanese</option>
            <option value='pt_BR/reflectionparameter.tostring.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionparameter.tostring.php'>Russian</option>
            <option value='tr/reflectionparameter.tostring.php'>Turkish</option>
            <option value='uk/reflectionparameter.tostring.php'>Ukrainian</option>
            <option value='zh/reflectionparameter.tostring.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionparameter.tostring" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionParameter::__toString</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionParameter::__toString</span> &mdash; <span class="dc-title">To string</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionparameter.tostring-examples">
  ...
  <p class="para">
   <div class="example" id="example-5592">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionParameter::__toString()</strong></span> example</strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">Parameter #0 [ &lt;required&gt; string $string ]</pre>
</div>
    </div>
   </div>
  </p>
   ...
   <ul class="simplelist">
    ...
    <li><a href="language.oop5.magic.php#object.tostring" class="link">__toString()</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionparameter/tostring.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionparameter.tostring%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionparameter.tostring&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionparameter.tostring.php">＋<small>add a note</small></a></span>
