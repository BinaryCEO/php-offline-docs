...
<head>
  ...
  <title>PHP: SolrQuery::getQuery - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getquery.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getquery.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getquery.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getmltqueryfields.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getrows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getquery.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getquery.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getquery.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getquery.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getquery.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getquery.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getquery.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getquery.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getquery.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getquery.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getquery.php" hreflang="zh">
...
<meta name="Description" content="Returns the main query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getQuery - Manual" />
<meta name="twitter:description" content="Returns the main query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getQuery - Manual" />
<meta itemprop="description" content="Returns the main query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the main query" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getrows.php">
          SolrQuery::getRows &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getmltqueryfields.php">
          &laquo; SolrQuery::getMltQueryFields        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getquery.php' selected="selected">English</option>
            <option value='de/solrquery.getquery.php'>German</option>
            <option value='es/solrquery.getquery.php'>Spanish</option>
            <option value='fr/solrquery.getquery.php'>French</option>
            <option value='it/solrquery.getquery.php'>Italian</option>
            <option value='ja/solrquery.getquery.php'>Japanese</option>
            <option value='pt_BR/solrquery.getquery.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getquery.php'>Russian</option>
            <option value='tr/solrquery.getquery.php'>Turkish</option>
            <option value='uk/solrquery.getquery.php'>Ukrainian</option>
            <option value='zh/solrquery.getquery.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getquery" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getQuery</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getQuery</span> &mdash; <span class="dc-title">Returns the main query</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getquery-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getQuery</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
Returns the main search query
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getquery-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getquery-returnvalues">
...
Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getquery.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getquery%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getquery&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getquery.php">＋<small>add a note</small></a></span>
