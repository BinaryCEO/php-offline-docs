...
<head>
  ...
  <title>PHP: Collection::add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-collection.add.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-collection.add.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collection.add.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-collection.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.mysql-xdevapi-collection.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-collection.addorreplaceone.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collection.add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysql-xdevapi-collection.add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysql-xdevapi-collection.add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysql-xdevapi-collection.add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysql-xdevapi-collection.add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysql-xdevapi-collection.add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysql-xdevapi-collection.add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysql-xdevapi-collection.add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysql-xdevapi-collection.add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysql-xdevapi-collection.add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysql-xdevapi-collection.add.php" hreflang="zh">
...
<meta name="Description" content="Add collection document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Collection::add - Manual" />
<meta name="twitter:description" content="Add collection document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Collection::add - Manual" />
<meta itemprop="description" content="Add collection document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add collection document" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysql-xdevapi-collection.addorreplaceone.php">
          Collection::addOrReplaceOne &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.mysql-xdevapi-collection.php">
          &laquo; mysql_xdevapi\Collection        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-collection.add.php' selected="selected">English</option>
            <option value='de/mysql-xdevapi-collection.add.php'>German</option>
            <option value='es/mysql-xdevapi-collection.add.php'>Spanish</option>
            <option value='fr/mysql-xdevapi-collection.add.php'>French</option>
            <option value='it/mysql-xdevapi-collection.add.php'>Italian</option>
            <option value='ja/mysql-xdevapi-collection.add.php'>Japanese</option>
            <option value='pt_BR/mysql-xdevapi-collection.add.php'>Brazilian Portuguese</option>
            <option value='ru/mysql-xdevapi-collection.add.php'>Russian</option>
            <option value='tr/mysql-xdevapi-collection.add.php'>Turkish</option>
            <option value='uk/mysql-xdevapi-collection.add.php'>Ukrainian</option>
            <option value='zh/mysql-xdevapi-collection.add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysql-xdevapi-collection.add" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-mysql-xdevapi-collection.add-examples">
  ...
  <div class="example" id="example-1692">
   <p><strong>Example #1 <span class="function"><strong>mysql_xdevapi\Collection::add()</strong></span> example</strong></p>
   ...
   <p class="para">
    ...
    MySQL Server 5.7.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/collection/add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-collection.add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-collection.add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-collection.add.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123056">  <div class="votes">
    <div id="Vu123056">
    <a href="/manual/vote-note.php?id=123056&amp;page=mysql-xdevapi-collection.add&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123056">
    <a href="/manual/vote-note.php?id=123056&amp;page=mysql-xdevapi-collection.add&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123056" title="75% like this...">
    2
    </div>
  </div>
  <a href="#123056" class="name">
  <strong class="user"><em>cyork at echodreamz dot com</em></strong></a><a class="genanchor" href="#123056"> &para;</a><div class="date" title="2018-08-20 08:51"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom123056">
<div class="phpcode"><code><span class="html">Seems that (at least with MySQL 5.7.23) if you do not set an _id field in the array of items to "add", it fails with error...<br /><br /> [HY000] Document is missing a required field<br /><br />Adding "_id" =&gt; xxxx does resolve the issue.</span></code></div>
  </div>
 </div>
  <div class="note" id="123023">  <div class="votes">
    <div id="Vu123023">
    <a href="/manual/vote-note.php?id=123023&amp;page=mysql-xdevapi-collection.add&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123023">
    <a href="/manual/vote-note.php?id=123023&amp;page=mysql-xdevapi-collection.add&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123023" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#123023" class="name">
  <strong class="user"><em>jcastro at eftec dot cl</em></strong></a><a class="genanchor" href="#123023"> &para;</a><div class="date" title="2018-08-09 02:14"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom123023">
<div class="phpcode"><code><span class="html">It returns a mysql_xdevapi\CollectionAdd instead of a mysql_xdevapi\Result</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysql-xdevapi-collection.add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-collection.add.php">＋<small>add a note</small></a></div>
