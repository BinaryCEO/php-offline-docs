...
<head>
  ...
  <title>PHP: svn_cleanup - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-cleanup.php">
 <link rel="shorturl" href="https://www.php.net/svn-cleanup">
 <link rel="alternate" href="https://www.php.net/svn-cleanup" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-checkout.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-client-version.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-cleanup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-cleanup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-cleanup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-cleanup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-cleanup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-cleanup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-cleanup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-cleanup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-cleanup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-cleanup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-cleanup.php" hreflang="zh">
...
<meta name="Description" content="Recursively cleanup a working copy directory, finishing incomplete operations and removing locks" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_cleanup - Manual" />
<meta name="twitter:description" content="Recursively cleanup a working copy directory, finishing incomplete operations and removing locks" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_cleanup - Manual" />
<meta itemprop="description" content="Recursively cleanup a working copy directory, finishing incomplete operations and removing locks" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Recursively cleanup a working copy directory, finishing incomplete operations and removing locks" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.svn-client-version.php">
          svn_client_version &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.svn-checkout.php">
          &laquo; svn_checkout        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-cleanup.php' selected="selected">English</option>
            <option value='de/function.svn-cleanup.php'>German</option>
            <option value='es/function.svn-cleanup.php'>Spanish</option>
            <option value='fr/function.svn-cleanup.php'>French</option>
            <option value='it/function.svn-cleanup.php'>Italian</option>
            <option value='ja/function.svn-cleanup.php'>Japanese</option>
            <option value='pt_BR/function.svn-cleanup.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-cleanup.php'>Russian</option>
            <option value='tr/function.svn-cleanup.php'>Turkish</option>
            <option value='uk/function.svn-cleanup.php'>Ukrainian</option>
            <option value='zh/function.svn-cleanup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-cleanup" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="http://svnbook.red-bean.com/en/1.2/svn.ref.svn.c.cleanup.html" class="link external">&raquo;&nbsp;SVN documentation on svn cleanup</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-cleanup.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-cleanup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-cleanup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-cleanup.php">＋<small>add a note</small></a></span>
