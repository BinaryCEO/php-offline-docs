...
<head>
  ...
  <title>PHP: Imagick::identifyImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.identifyimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.identifyimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.identifyimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.identifyformat.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.implodeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.identifyimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.identifyimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.identifyimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.identifyimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.identifyimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.identifyimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.identifyimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.identifyimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.identifyimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.identifyimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.identifyimage.php" hreflang="zh">
...
<meta name="Description" content="Identifies an image and fetches attributes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::identifyImage - Manual" />
<meta name="twitter:description" content="Identifies an image and fetches attributes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::identifyImage - Manual" />
<meta itemprop="description" content="Identifies an image and fetches attributes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Identifies an image and fetches attributes" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.implodeimage.php">
          Imagick::implodeImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.identifyformat.php">
          &laquo; Imagick::identifyFormat        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.identifyimage.php' selected="selected">English</option>
            <option value='de/imagick.identifyimage.php'>German</option>
            <option value='es/imagick.identifyimage.php'>Spanish</option>
            <option value='fr/imagick.identifyimage.php'>French</option>
            <option value='it/imagick.identifyimage.php'>Italian</option>
            <option value='ja/imagick.identifyimage.php'>Japanese</option>
            <option value='pt_BR/imagick.identifyimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.identifyimage.php'>Russian</option>
            <option value='tr/imagick.identifyimage.php'>Turkish</option>
            <option value='uk/imagick.identifyimage.php'>Ukrainian</option>
            <option value='zh/imagick.identifyimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.identifyimage" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.identifyimage-examples">
  ...
  <p class="para">
   <div class="example" id="example-3021">
...
(
    ...
    [signature] =&gt; 9a6dc8f604f97d0d691c0286176ddf992e188f0bebba98494b2146ee2d7118da
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/identifyimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.identifyimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.identifyimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.identifyimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125037">  <div class="votes">
    <div id="Vu125037">
    <a href="/manual/vote-note.php?id=125037&amp;page=imagick.identifyimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125037">
    <a href="/manual/vote-note.php?id=125037&amp;page=imagick.identifyimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125037" title="66% like this...">
    1
    </div>
  </div>
  <a href="#125037" class="name">
  <strong class="user"><em>rhuanpachecok at gmail dot com</em></strong></a><a class="genanchor" href="#125037"> &para;</a><div class="date" title="2020-05-23 03:41"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125037">
<div class="phpcode"><code><span class="html">I have created a function to parse the "rawOutput" because the information provided by this function is quite useless.<br /><br />function parseIdentify($info) {<br />    $lines = explode("\n", $info);<br />    <br />    $outputs = [];<br />    $output = [];<br />    $keys = [];<br />    <br />    $currSpaces = 0;<br />    $raw = false;<br />    <br />    foreach($lines as $line) {<br />        $trimLine = trim($line);<br />        <br />        if(empty($trimLine)) continue;<br />        <br />        if($raw) {<br />            preg_match('/^[0-9]+:\s/', $trimLine, $match);<br />            <br />            if(!empty($match)) {<br />                $regex = '/([\d]+):';<br />                $regex .= '\s(\([\d|\s]{1,3},[\d|\s]{1,3},[\d|\s]{1,3},[\d|\s]{1,3}\))';<br />                $regex .= '\s(#\w+)';<br />                $regex .= '\s(srgba\([\d|\s]{1,3},[\d|\s]{1,3},[\d|\s]{1,3},[\d|\s|.]+\)|\w+)/';<br /><br />                preg_match($regex, $trimLine, $matches);<br />                array_shift($matches);<br />                <br />                $output['Image'][$raw][] = $matches;<br />                <br />                continue;<br />            }<br />            <br />            else {<br />                $raw = false;<br />                array_pop($keys);<br />            }<br />        }<br />        <br />        preg_match('/^\s+/', $line, $match);<br />        <br />        $spaces = isset($match[0]) ? strlen($match[0]) : $spaces = 0;<br />        $parts = preg_split('/:\s/', $trimLine, 2);<br />        <br />        $_key = ucwords($parts[0]);<br />        $_key = str_replace(' ', '', $_key);<br />        $_val = isset($parts[1]) ? $parts[1] : [];<br />        <br />        if($_key == 'Image') {<br />            if(!empty($output)) {<br />                $outputs[] = $output['Image'];<br />                $output = [];<br />            }<br />            <br />            $_val = [];<br />        }<br />        <br />        if($spaces &lt; $currSpaces) {<br />            for($i = 0; $i &lt; ($currSpaces - $spaces) / 2; $i++) {<br />                array_pop($keys);<br />            }<br />        }<br />        <br />        if(is_array($_val)) {<br />            $_key = rtrim($_key, ':');<br />            $keys[] = $_key;<br />            <br />            if($_key == 'Histogram' || $_key == 'Colormap') {<br />                $raw = $_key;<br />            }<br />        }<br />        <br />        $currSpaces = $spaces;<br />        $arr = &amp;$output;<br />        <br />        foreach($keys as $key) {<br />            if(!isset($arr[$key])) {<br />                $arr[$key] = $_val;<br />            }<br />            <br />            $arr = &amp;$arr[$key];<br />        }<br />        <br />        if(!is_array($_val)) {<br />            $arr[$_key] = $_val;<br />        }<br />        <br />    }<br />    <br />    $outputs[] = $output['Image'];<br />    <br />    return count($outputs) &gt; 1 ? $outputs : $outputs[0];<br />}<br /><br />Usage example:<br /><br />$img = new Imagick('example.png');<br />$identify = parseIdentify($img-&gt;identifyImage(true)['rawOutput']);<br /><br />But the "rawOutput" that this function returns only contains the first frame if it is a GIF. Alternatively you can use the command "identify" to get the data of all the frames:<br /><br />$identify = parseIdentify(shell_exec('identify -verbose example.gif'));</span></code></div>
  </div>
 </div>
  <div class="note" id="101048">  <div class="votes">
    <div id="Vu101048">
    <a href="/manual/vote-note.php?id=101048&amp;page=imagick.identifyimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd101048">
    <a href="/manual/vote-note.php?id=101048&amp;page=imagick.identifyimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V101048" title="50% like this...">
    0
    </div>
  </div>
  <a href="#101048" class="name">
  <strong class="user"><em>php at ontheroad dot net dot nz</em></strong></a><a class="genanchor" href="#101048"> &para;</a><div class="date" title="2010-11-22 08:04"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101048">
<div class="phpcode"><code><span class="html">If you use the option to append the raw output, you can extract the mime type from there.  I'm not sure what's going on in the background here, but it seems far less useful than the command line identify tool.</span></code></div>
  </div>
 </div>
  <div class="note" id="83611">  <div class="votes">
    <div id="Vu83611">
    <a href="/manual/vote-note.php?id=83611&amp;page=imagick.identifyimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd83611">
    <a href="/manual/vote-note.php?id=83611&amp;page=imagick.identifyimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V83611" title="50% like this...">
    0
    </div>
  </div>
  <a href="#83611" class="name">
  <strong class="user"><em>rob at OhReally dot nl</em></strong></a><a class="genanchor" href="#83611"> &para;</a><div class="date" title="2008-06-04 06:49"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom83611">
<div class="phpcode"><code><span class="html">The array returned by Imagick::identifyImage():<br /><br />Array<br />(<br />    [imageName] =&gt; /some/path/image.jpg<br />    [format] =&gt; JPEG (Joint Photographic Experts Group JFIF format)<br />    [geometry] =&gt; Array<br />        (<br />            [width] =&gt; 90<br />            [height] =&gt; 90<br />        )<br /><br />    [type] =&gt; TrueColor<br />    [colorSpace] =&gt; RGB<br />    [resolution] =&gt; Array<br />        (<br />            [x] =&gt; 300<br />            [y] =&gt; 300<br />        )<br /><br />    [units] =&gt; PixelsPerInch<br />    [fileSize] =&gt; 1.88672kb<br />    [compression] =&gt; JPEG<br />    [signature] =&gt; 9a6dc8f604f97d0d691c0286176ddf992e188f0bebba98494b2146ee2d7118da<br />)<br /><br />Looks like the only way to get the mimetype is getimagesize()...</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.identifyimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.identifyimage.php">＋<small>add a note</small></a></div>
