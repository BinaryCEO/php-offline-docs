...
<head>
  ...
  <title>PHP: Imagick::enhanceImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.enhanceimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.enhanceimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.enhanceimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.encipherimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.equalizeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.enhanceimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.enhanceimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.enhanceimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.enhanceimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.enhanceimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.enhanceimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.enhanceimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.enhanceimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.enhanceimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.enhanceimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.enhanceimage.php" hreflang="zh">
...
<meta name="Description" content="Improves the quality of a noisy image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::enhanceImage - Manual" />
<meta name="twitter:description" content="Improves the quality of a noisy image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::enhanceImage - Manual" />
<meta itemprop="description" content="Improves the quality of a noisy image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Improves the quality of a noisy image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.equalizeimage.php">
          Imagick::equalizeImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.encipherimage.php">
          &laquo; Imagick::encipherImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.enhanceimage.php' selected="selected">English</option>
            <option value='de/imagick.enhanceimage.php'>German</option>
            <option value='es/imagick.enhanceimage.php'>Spanish</option>
            <option value='fr/imagick.enhanceimage.php'>French</option>
            <option value='it/imagick.enhanceimage.php'>Italian</option>
            <option value='ja/imagick.enhanceimage.php'>Japanese</option>
            <option value='pt_BR/imagick.enhanceimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.enhanceimage.php'>Russian</option>
            <option value='tr/imagick.enhanceimage.php'>Turkish</option>
            <option value='uk/imagick.enhanceimage.php'>Ukrainian</option>
            <option value='zh/imagick.enhanceimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.enhanceimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::enhanceImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::enhanceImage</span> &mdash; <span class="dc-title">Improves the quality of a noisy image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.enhanceimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::enhanceImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.enhanceimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.enhanceimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.enhanceimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-2994">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/enhanceimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.enhanceimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.enhanceimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.enhanceimage.php">＋<small>add a note</small></a></span>
