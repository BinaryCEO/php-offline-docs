...
<head>
  ...
  <title>PHP: SolrQuery::setMltMaxWordLength - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setmltmaxwordlength.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setmltmaxwordlength.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltmaxwordlength.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setmltmaxnumtokens.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setmltmindocfrequency.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltmaxwordlength.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setmltmaxwordlength.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setmltmaxwordlength.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setmltmaxwordlength.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setmltmaxwordlength.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setmltmaxwordlength.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setmltmaxwordlength.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setmltmaxwordlength.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setmltmaxwordlength.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setmltmaxwordlength.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setmltmaxwordlength.php" hreflang="zh">
...
<meta name="Description" content="Sets the maximum word length" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setMltMaxWordLength - Manual" />
<meta name="twitter:description" content="Sets the maximum word length" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setMltMaxWordLength - Manual" />
<meta itemprop="description" content="Sets the maximum word length" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the maximum word length" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setmltmindocfrequency.php">
          SolrQuery::setMltMinDocFrequency &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setmltmaxnumtokens.php">
          &laquo; SolrQuery::setMltMaxNumTokens        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setmltmaxwordlength.php' selected="selected">English</option>
            <option value='de/solrquery.setmltmaxwordlength.php'>German</option>
            <option value='es/solrquery.setmltmaxwordlength.php'>Spanish</option>
            <option value='fr/solrquery.setmltmaxwordlength.php'>French</option>
            <option value='it/solrquery.setmltmaxwordlength.php'>Italian</option>
            <option value='ja/solrquery.setmltmaxwordlength.php'>Japanese</option>
            <option value='pt_BR/solrquery.setmltmaxwordlength.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setmltmaxwordlength.php'>Russian</option>
            <option value='tr/solrquery.setmltmaxwordlength.php'>Turkish</option>
            <option value='uk/solrquery.setmltmaxwordlength.php'>Ukrainian</option>
            <option value='zh/solrquery.setmltmaxwordlength.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setmltmaxwordlength" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setMltMaxWordLength</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setMltMaxWordLength</span> &mdash; <span class="dc-title">Sets the maximum word length</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setmltmaxwordlength-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setMltMaxWordLength</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$maxWordLength</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setmltmaxwordlength-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">maxWordLength</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setmltmaxwordlength-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setmltmaxwordlength.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setmltmaxwordlength%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setmltmaxwordlength&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setmltmaxwordlength.php">＋<small>add a note</small></a></span>
