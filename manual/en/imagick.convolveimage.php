...
<head>
  ...
  <title>PHP: Imagick::convolveImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.convolveimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.convolveimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.convolveimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.contraststretchimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.count.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.convolveimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.convolveimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.convolveimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.convolveimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.convolveimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.convolveimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.convolveimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.convolveimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.convolveimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.convolveimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.convolveimage.php" hreflang="zh">
...
<meta name="Description" content="Applies a custom convolution kernel to the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::convolveImage - Manual" />
<meta name="twitter:description" content="Applies a custom convolution kernel to the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::convolveImage - Manual" />
<meta itemprop="description" content="Applies a custom convolution kernel to the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Applies a custom convolution kernel to the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.contraststretchimage.php">
          &laquo; Imagick::contrastStretchImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.convolveimage.php' selected="selected">English</option>
            <option value='de/imagick.convolveimage.php'>German</option>
            <option value='es/imagick.convolveimage.php'>Spanish</option>
            <option value='fr/imagick.convolveimage.php'>French</option>
            <option value='it/imagick.convolveimage.php'>Italian</option>
            <option value='ja/imagick.convolveimage.php'>Japanese</option>
            <option value='pt_BR/imagick.convolveimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.convolveimage.php'>Russian</option>
            <option value='tr/imagick.convolveimage.php'>Turkish</option>
            <option value='uk/imagick.convolveimage.php'>Ukrainian</option>
            <option value='zh/imagick.convolveimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.convolveimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::convolveImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::convolveImage</span> &mdash; <span class="dc-title">Applies a custom convolution kernel to the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.convolveimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::convolveImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$kernel</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.convolveimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">kernel</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.convolveimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.convolveimage-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.convolveimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-2987">
      <p><strong>Example #1  <span class="function"><strong>Imagick::convolveImage()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">convolveImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">, </span><span style="color: #0000BB">$bias</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernelMatrix</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">));    <br />    </span><span style="color: #FF8000">//$edgeFindingKernel = [-1, -1, -1, -1, 8, -1, -1, -1, -1,];<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageBias</span><span style="color: #007700">(</span><span style="color: #0000BB">$bias </span><span style="color: #007700">* </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">getQuantum</span><span style="color: #007700">());<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">convolveImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$kernelMatrix</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/jpg"</span><span style="color: #007700">);<br />    echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/convolveimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.convolveimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.convolveimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.convolveimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124363">  <div class="votes">
    <div id="Vu124363">
    <a href="/manual/vote-note.php?id=124363&amp;page=imagick.convolveimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124363">
    <a href="/manual/vote-note.php?id=124363&amp;page=imagick.convolveimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124363" title="no votes...">
    0
    </div>
  </div>
  <a href="#124363" class="name">
  <strong class="user"><em>ahmed at zigzapps dot com</em></strong></a><a class="genanchor" href="#124363"> &para;</a><div class="date" title="2019-11-04 12:57"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124363">
<div class="phpcode"><code><span class="html">The provided example is wrong. Here's a correct sample:<br /><br />$matrix = [[1,-1,1],[-1,1,-1],[1,-1,1]];<br />$kernel = \ImagickKernel::fromMatrix($matrix); <br /><br />$imagick = new Imagick();<br />$imagick-&gt;readimage($file.'/z.png');<br />$imagick-&gt;convolveImage ($kernel);<br />$imagick-&gt;writeimage('convolve.png');<br />$imagick-&gt;clear();<br />$imagick-&gt;destroy();</span></code></div>
  </div>
 </div>
  <div class="note" id="113318">  <div class="votes">
    <div id="Vu113318">
    <a href="/manual/vote-note.php?id=113318&amp;page=imagick.convolveimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113318">
    <a href="/manual/vote-note.php?id=113318&amp;page=imagick.convolveimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113318" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#113318" class="name">
  <strong class="user"><em>peter at musicalsaw dot com</em></strong></a><a class="genanchor" href="#113318"> &para;</a><div class="date" title="2013-09-25 10:22"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom113318">
<div class="phpcode"><code><span class="html">Example of convolveImage:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// run an edge detection filter on an image<br /></span><span class="default">$image </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">( </span><span class="string">"diana.png" </span><span class="keyword">); <br /></span><span class="default">$edgeArray </span><span class="keyword">= array(-</span><span class="default">1</span><span class="keyword">,-</span><span class="default">1</span><span class="keyword">,-</span><span class="default">1</span><span class="keyword">,-</span><span class="default">1</span><span class="keyword">,</span><span class="default">8</span><span class="keyword">,-</span><span class="default">1</span><span class="keyword">,-</span><span class="default">1</span><span class="keyword">,-</span><span class="default">1</span><span class="keyword">,-</span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">convolveImage </span><span class="keyword">(</span><span class="default">$edgeArray</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">thresholdImage</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'Content-type: image/png'</span><span class="keyword">);<br />echo </span><span class="default">$image</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.convolveimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.convolveimage.php">＋<small>add a note</small></a></div>
