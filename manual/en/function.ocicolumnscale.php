...
<head>
  ...
  <title>PHP: ocicolumnscale - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocicolumnscale.php">
 <link rel="shorturl" href="https://www.php.net/ocicolumnscale">
 <link rel="alternate" href="https://www.php.net/ocicolumnscale" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocicolumnprecision.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocicolumnsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocicolumnscale.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocicolumnscale.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocicolumnscale.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocicolumnscale.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocicolumnscale.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocicolumnscale.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocicolumnscale.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocicolumnscale.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocicolumnscale.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocicolumnscale.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocicolumnscale.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_field_scale" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocicolumnscale - Manual" />
<meta name="twitter:description" content="Alias of oci_field_scale" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocicolumnscale - Manual" />
<meta itemprop="description" content="Alias of oci_field_scale" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_field_scale" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ocicolumnsize.php">
          ocicolumnsize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocicolumnprecision.php">
          &laquo; ocicolumnprecision        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocicolumnscale.php' selected="selected">English</option>
            <option value='de/function.ocicolumnscale.php'>German</option>
            <option value='es/function.ocicolumnscale.php'>Spanish</option>
            <option value='fr/function.ocicolumnscale.php'>French</option>
            <option value='it/function.ocicolumnscale.php'>Italian</option>
            <option value='ja/function.ocicolumnscale.php'>Japanese</option>
            <option value='pt_BR/function.ocicolumnscale.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocicolumnscale.php'>Russian</option>
            <option value='tr/function.ocicolumnscale.php'>Turkish</option>
            <option value='uk/function.ocicolumnscale.php'>Ukrainian</option>
            <option value='zh/function.ocicolumnscale.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocicolumnscale" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocicolumnscale</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocicolumnscale</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-field-scale.php" class="function">oci_field_scale()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocicolumnscale-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-field-scale.php" class="function">oci_field_scale()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocicolumnscale.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocicolumnscale%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocicolumnscale&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocicolumnscale.php">＋<small>add a note</small></a></span>
