...
<head>
  ...
  <title>PHP: SolrQuery::getTermsPrefix - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gettermsprefix.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gettermsprefix.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermsprefix.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gettermsmincount.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gettermsreturnraw.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermsprefix.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gettermsprefix.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gettermsprefix.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gettermsprefix.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gettermsprefix.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gettermsprefix.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gettermsprefix.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gettermsprefix.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gettermsprefix.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gettermsprefix.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gettermsprefix.php" hreflang="zh">
...
<meta name="Description" content="Returns the term prefix" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getTermsPrefix - Manual" />
<meta name="twitter:description" content="Returns the term prefix" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getTermsPrefix - Manual" />
<meta itemprop="description" content="Returns the term prefix" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the term prefix" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gettermsreturnraw.php">
          SolrQuery::getTermsReturnRaw &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gettermsmincount.php">
          &laquo; SolrQuery::getTermsMinCount        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gettermsprefix.php' selected="selected">English</option>
            <option value='de/solrquery.gettermsprefix.php'>German</option>
            <option value='es/solrquery.gettermsprefix.php'>Spanish</option>
            <option value='fr/solrquery.gettermsprefix.php'>French</option>
            <option value='it/solrquery.gettermsprefix.php'>Italian</option>
            <option value='ja/solrquery.gettermsprefix.php'>Japanese</option>
            <option value='pt_BR/solrquery.gettermsprefix.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gettermsprefix.php'>Russian</option>
            <option value='tr/solrquery.gettermsprefix.php'>Turkish</option>
            <option value='uk/solrquery.gettermsprefix.php'>Ukrainian</option>
            <option value='zh/solrquery.gettermsprefix.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gettermsprefix" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getTermsPrefix</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getTermsPrefix</span> &mdash; <span class="dc-title">Returns the term prefix</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gettermsprefix-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getTermsPrefix</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gettermsprefix-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gettermsprefix-returnvalues">
...
Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gettermsprefix.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gettermsprefix%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gettermsprefix&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gettermsprefix.php">＋<small>add a note</small></a></span>
