...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.mcrypt.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.hash-update-stream.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.mcrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.mcrypt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.mcrypt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.mcrypt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.mcrypt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.mcrypt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.mcrypt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.mcrypt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.mcrypt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.mcrypt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.mcrypt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.mcrypt.php" hreflang="zh">
...
<meta name="Description" content="Mcrypt" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Mcrypt - Manual" />
<meta name="twitter:description" content="Mcrypt" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Mcrypt - Manual" />
<meta itemprop="description" content="Mcrypt" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Mcrypt" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intro.mcrypt.php">
          Introduction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.hash-update-stream.php">
          &laquo; hash_update_stream        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.mcrypt.php' selected="selected">English</option>
            <option value='de/book.mcrypt.php'>German</option>
            <option value='es/book.mcrypt.php'>Spanish</option>
            <option value='fr/book.mcrypt.php'>French</option>
            <option value='it/book.mcrypt.php'>Italian</option>
            <option value='ja/book.mcrypt.php'>Japanese</option>
            <option value='pt_BR/book.mcrypt.php'>Brazilian Portuguese</option>
            <option value='ru/book.mcrypt.php'>Russian</option>
            <option value='tr/book.mcrypt.php'>Turkish</option>
            <option value='uk/book.mcrypt.php'>Ukrainian</option>
            <option value='zh/book.mcrypt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.mcrypt" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.mcrypt.php">Introduction</a></li><li><a href="mcrypt.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="mcrypt.requirements.php">Requirements</a></li><li><a href="mcrypt.installation.php">Installation</a></li><li><a href="mcrypt.configuration.php">Runtime Configuration</a></li><li><a href="mcrypt.resources.php">Resource Types</a></li></ul></li><li><a href="mcrypt.constants.php">Predefined Constants</a></li><li><a href="mcrypt.ciphers.php">Mcrypt ciphers</a></li><li><a href="ref.mcrypt.php">Mcrypt Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.mcrypt-create-iv.php">mcrypt_create_iv</a> — Creates an initialization vector (IV) from a random source</li><li><a href="function.mcrypt-decrypt.php">mcrypt_decrypt</a> — Decrypts crypttext with given parameters</li><li><a href="function.mcrypt-enc-get-algorithms-name.php">mcrypt_enc_get_algorithms_name</a> — Returns the name of the opened algorithm</li><li><a href="function.mcrypt-enc-get-block-size.php">mcrypt_enc_get_block_size</a> — Returns the blocksize of the opened algorithm</li><li><a href="function.mcrypt-enc-get-iv-size.php">mcrypt_enc_get_iv_size</a> — Returns the size of the IV of the opened algorithm</li><li><a href="function.mcrypt-enc-get-key-size.php">mcrypt_enc_get_key_size</a> — Returns the maximum supported keysize of the opened mode</li><li><a href="function.mcrypt-enc-get-modes-name.php">mcrypt_enc_get_modes_name</a> — Returns the name of the opened mode</li><li><a href="function.mcrypt-enc-get-supported-key-sizes.php">mcrypt_enc_get_supported_key_sizes</a> — Returns an array with the supported keysizes of the opened algorithm</li><li><a href="function.mcrypt-enc-is-block-algorithm.php">mcrypt_enc_is_block_algorithm</a> — Checks whether the algorithm of the opened mode is a block algorithm</li><li><a href="function.mcrypt-enc-is-block-algorithm-mode.php">mcrypt_enc_is_block_algorithm_mode</a> — Checks whether the encryption of the opened mode works on blocks</li><li><a href="function.mcrypt-enc-is-block-mode.php">mcrypt_enc_is_block_mode</a> — Checks whether the opened mode outputs blocks</li><li><a href="function.mcrypt-enc-self-test.php">mcrypt_enc_self_test</a> — Runs a self test on the opened module</li><li><a href="function.mcrypt-encrypt.php">mcrypt_encrypt</a> — Encrypts plaintext with given parameters</li><li><a href="function.mcrypt-generic.php">mcrypt_generic</a> — This function encrypts data</li><li><a href="function.mcrypt-generic-deinit.php">mcrypt_generic_deinit</a> — This function deinitializes an encryption module</li><li><a href="function.mcrypt-generic-init.php">mcrypt_generic_init</a> — This function initializes all buffers needed for encryption</li><li><a href="function.mcrypt-get-block-size.php">mcrypt_get_block_size</a> — Gets the block size of the specified cipher</li><li><a href="function.mcrypt-get-cipher-name.php">mcrypt_get_cipher_name</a> — Gets the name of the specified cipher</li><li><a href="function.mcrypt-get-iv-size.php">mcrypt_get_iv_size</a> — Returns the size of the IV belonging to a specific cipher/mode combination</li><li><a href="function.mcrypt-get-key-size.php">mcrypt_get_key_size</a> — Gets the key size of the specified cipher</li><li><a href="function.mcrypt-list-algorithms.php">mcrypt_list_algorithms</a> — Gets an array of all supported ciphers</li><li><a href="function.mcrypt-list-modes.php">mcrypt_list_modes</a> — Gets an array of all supported modes</li><li><a href="function.mcrypt-module-close.php">mcrypt_module_close</a> — Closes the mcrypt module</li><li><a href="function.mcrypt-module-get-algo-block-size.php">mcrypt_module_get_algo_block_size</a> — Returns the blocksize of the specified algorithm</li><li><a href="function.mcrypt-module-get-algo-key-size.php">mcrypt_module_get_algo_key_size</a> — Returns the maximum supported keysize of the opened mode</li><li><a href="function.mcrypt-module-get-supported-key-sizes.php">mcrypt_module_get_supported_key_sizes</a> — Returns an array with the supported keysizes of the opened algorithm</li><li><a href="function.mcrypt-module-is-block-algorithm.php">mcrypt_module_is_block_algorithm</a> — This function checks whether the specified algorithm is a block algorithm</li><li><a href="function.mcrypt-module-is-block-algorithm-mode.php">mcrypt_module_is_block_algorithm_mode</a> — Returns if the specified module is a block algorithm or not</li><li><a href="function.mcrypt-module-is-block-mode.php">mcrypt_module_is_block_mode</a> — Returns if the specified mode outputs blocks or not</li><li><a href="function.mcrypt-module-open.php">mcrypt_module_open</a> — Opens the module of the algorithm and the mode to be used</li><li><a href="function.mcrypt-module-self-test.php">mcrypt_module_self_test</a> — This function runs a self test on the specified module</li><li><a href="function.mdecrypt-generic.php">mdecrypt_generic</a> — Decrypts data</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/book.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.mcrypt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.mcrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.mcrypt.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124073">  <div class="votes">
    <div id="Vu124073">
    <a href="/manual/vote-note.php?id=124073&amp;page=book.mcrypt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124073">
    <a href="/manual/vote-note.php?id=124073&amp;page=book.mcrypt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124073" title="63% like this...">
    10
    </div>
  </div>
  <a href="#124073" class="name">
  <strong class="user"><em>zelnaga at gmail dot com</em></strong></a><a class="genanchor" href="#124073"> &para;</a><div class="date" title="2019-07-25 09:02"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom124073">
<div class="phpcode"><code><span class="html">If you're wanting to use mcrypt on a newer version of PHP where it's been deprecated try the shim for it instead:<br /><br /><a href="https://github.com/phpseclib/mcrypt_compat" rel="nofollow" target="_blank">https://github.com/phpseclib/mcrypt_compat</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=book.mcrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.mcrypt.php">＋<small>add a note</small></a></div>
