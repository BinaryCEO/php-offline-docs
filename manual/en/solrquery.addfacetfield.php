...
<head>
  ...
  <title>PHP: SolrQuery::addFacetField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addfacetfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addfacetfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addfacetfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addfacetdateother.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addfacetquery.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addfacetfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addfacetfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addfacetfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addfacetfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addfacetfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addfacetfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addfacetfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addfacetfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addfacetfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addfacetfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addfacetfield.php" hreflang="zh">
...
<meta name="Description" content="Adds another field to the facet" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addFacetField - Manual" />
<meta name="twitter:description" content="Adds another field to the facet" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addFacetField - Manual" />
<meta itemprop="description" content="Adds another field to the facet" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds another field to the facet" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.addfacetquery.php">
          SolrQuery::addFacetQuery &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addfacetdateother.php">
          &laquo; SolrQuery::addFacetDateOther        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addfacetfield.php' selected="selected">English</option>
            <option value='de/solrquery.addfacetfield.php'>German</option>
            <option value='es/solrquery.addfacetfield.php'>Spanish</option>
            <option value='fr/solrquery.addfacetfield.php'>French</option>
            <option value='it/solrquery.addfacetfield.php'>Italian</option>
            <option value='ja/solrquery.addfacetfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.addfacetfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addfacetfield.php'>Russian</option>
            <option value='tr/solrquery.addfacetfield.php'>Turkish</option>
            <option value='uk/solrquery.addfacetfield.php'>Ukrainian</option>
            <option value='zh/solrquery.addfacetfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addfacetfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addFacetField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::addFacetField</span> &mdash; <span class="dc-title">Adds another field to the facet</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addfacetfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addFacetField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.addfacetfield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addfacetfield-returnvalues">
...
(
    [color] =&gt; SolrObject Object
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addfacetfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addfacetfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addfacetfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addfacetfield.php">＋<small>add a note</small></a></span>
