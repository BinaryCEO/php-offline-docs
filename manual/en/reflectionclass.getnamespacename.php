...
<head>
  ...
  <title>PHP: ReflectionClass::getNamespaceName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getnamespacename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getnamespacename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getnamespacename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getname.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getparentclass.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getnamespacename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getnamespacename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getnamespacename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getnamespacename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getnamespacename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getnamespacename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getnamespacename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getnamespacename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getnamespacename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getnamespacename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getnamespacename.php" hreflang="zh">
...
<meta name="Description" content="Gets namespace name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getNamespaceName - Manual" />
<meta name="twitter:description" content="Gets namespace name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getNamespaceName - Manual" />
<meta itemprop="description" content="Gets namespace name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets namespace name" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.getparentclass.php">
          ReflectionClass::getParentClass &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getname.php">
          &laquo; ReflectionClass::getName        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getnamespacename.php' selected="selected">English</option>
            <option value='de/reflectionclass.getnamespacename.php'>German</option>
            <option value='es/reflectionclass.getnamespacename.php'>Spanish</option>
            <option value='fr/reflectionclass.getnamespacename.php'>French</option>
            <option value='it/reflectionclass.getnamespacename.php'>Italian</option>
            <option value='ja/reflectionclass.getnamespacename.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getnamespacename.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getnamespacename.php'>Russian</option>
            <option value='tr/reflectionclass.getnamespacename.php'>Turkish</option>
            <option value='uk/reflectionclass.getnamespacename.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getnamespacename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getnamespacename" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::getNamespaceName</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getNamespaceName</span> &mdash; <span class="dc-title">Gets namespace name</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.getnamespacename-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::getNamespaceName</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.getnamespacename-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.getnamespacename-returnvalues">
...
string(3) &quot;Foo&quot;</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.getnamespacename-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.getparentclass.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getParentClass()</a> - Gets parent class</span></li>
    <li><a href="language.namespaces.php" class="link">namespaces</a></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getnamespacename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getnamespacename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getnamespacename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getnamespacename.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="105392">  <div class="votes">
    <div id="Vu105392">
    <a href="/manual/vote-note.php?id=105392&amp;page=reflectionclass.getnamespacename&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105392">
    <a href="/manual/vote-note.php?id=105392&amp;page=reflectionclass.getnamespacename&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105392" title="63% like this...">
    5
    </div>
  </div>
  <a href="#105392" class="name">
  <strong class="user"><em>francois</em></strong></a><a class="genanchor" href="#105392"> &para;</a><div class="date" title="2011-08-14 04:08"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105392">
<div class="phpcode"><code><span class="html">If the object does not belong to a namespace, an empty string is returned</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.getnamespacename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getnamespacename.php">＋<small>add a note</small></a></div>
