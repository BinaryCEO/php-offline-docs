...
<head>
  ...
  <title>PHP: openssl_x509_check_private_key - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-x509-check-private-key.php">
 <link rel="shorturl" href="https://www.php.net/openssl-x509-check-private-key">
 <link rel="alternate" href="https://www.php.net/openssl-x509-check-private-key" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-verify.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-x509-checkpurpose.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-x509-check-private-key.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-x509-check-private-key.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-x509-check-private-key.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-x509-check-private-key.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-x509-check-private-key.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-x509-check-private-key.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-x509-check-private-key.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-x509-check-private-key.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-x509-check-private-key.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-x509-check-private-key.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-x509-check-private-key.php" hreflang="zh">
...
<meta name="Description" content="Checks if a private key corresponds to a certificate" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_x509_check_private_key - Manual" />
<meta name="twitter:description" content="Checks if a private key corresponds to a certificate" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_x509_check_private_key - Manual" />
<meta itemprop="description" content="Checks if a private key corresponds to a certificate" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if a private key corresponds to a certificate" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-x509-checkpurpose.php">
          openssl_x509_checkpurpose &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-verify.php">
          &laquo; openssl_verify        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-x509-check-private-key.php' selected="selected">English</option>
            <option value='de/function.openssl-x509-check-private-key.php'>German</option>
            <option value='es/function.openssl-x509-check-private-key.php'>Spanish</option>
            <option value='fr/function.openssl-x509-check-private-key.php'>French</option>
            <option value='it/function.openssl-x509-check-private-key.php'>Italian</option>
            <option value='ja/function.openssl-x509-check-private-key.php'>Japanese</option>
            <option value='pt_BR/function.openssl-x509-check-private-key.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-x509-check-private-key.php'>Russian</option>
            <option value='tr/function.openssl-x509-check-private-key.php'>Turkish</option>
            <option value='uk/function.openssl-x509-check-private-key.php'>Ukrainian</option>
            <option value='zh/function.openssl-x509-check-private-key.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-x509-check-private-key" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_x509_check_private_key</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_x509_check_private_key</span> &mdash; <span class="dc-title">Checks if a private key corresponds to a certificate</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-x509-check-private-key-description">
  ...
  <p class="para rdfs-comment">
   Checks whether the given <code class="parameter">private_key</code> is the private key
   that corresponds to <code class="parameter">certificate</code>.
  </p>
  <div class="warning"><strong class="warning">Warning</strong>
    <p class="para">
     The function does not check if <code class="parameter">private_key</code> is indeed a private key or not.
    ...
    <p class="para">
     This means, for example, that a public key could be given for <code class="parameter">private_key</code>
     and the function may return <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>.
    </p>
  </div>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.openssl-x509-check-private-key-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if <code class="parameter">private_key</code> is the private key that
   corresponds to <code class="parameter">certificate</code>, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>
    ...
    <tbody class="tbody">
     ...
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-x509-check-private-key.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-x509-check-private-key%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-x509-check-private-key&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-x509-check-private-key.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121979">  <div class="votes">
    <div id="Vu121979">
    <a href="/manual/vote-note.php?id=121979&amp;page=function.openssl-x509-check-private-key&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121979">
    <a href="/manual/vote-note.php?id=121979&amp;page=function.openssl-x509-check-private-key&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121979" title="62% like this...">
    7
    </div>
  </div>
  <a href="#121979" class="name">
  <strong class="user"><em>tomsie at toms dot ie</em></strong></a><a class="genanchor" href="#121979"> &para;</a><div class="date" title="2017-12-05 01:51"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121979">
<div class="phpcode"><code><span class="html">This function DOES return TRUE if the key has a passphrase, you just need to set up the data in such a way that the function can understand it. It is not documented here.<br /><br />This error message led me to the solution:<br /><br />PHP Warning:  openssl_x509_check_private_key(): key array must be of the form array(0 =&amp;gt; key, 1 =&amp;gt; phrase)<br /><br />So this works:<br /><br />$certFile = file_get_contents('cert.crt');<br />$keyFile = file_get_contents('cert.key');<br />$keyPassphrase = "password1234";<br />$keyCheckData = array(0=&gt;$keyFile,1=&gt;$keyPassphrase);<br />$result = openssl_x509_check_private_key($certFile,$keyCheckData);</span></code></div>
  </div>
 </div>
  <div class="note" id="117170">  <div class="votes">
    <div id="Vu117170">
    <a href="/manual/vote-note.php?id=117170&amp;page=function.openssl-x509-check-private-key&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117170">
    <a href="/manual/vote-note.php?id=117170&amp;page=function.openssl-x509-check-private-key&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117170" title="50% like this...">
    0
    </div>
  </div>
  <a href="#117170" class="name">
  <strong class="user"><em>jared at enhancesoft dot com</em></strong></a><a class="genanchor" href="#117170"> &para;</a><div class="date" title="2015-04-24 08:58"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117170">
<div class="phpcode"><code><span class="html">This function will return FALSE if the private key requires a pass phrase.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-x509-check-private-key&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-x509-check-private-key.php">＋<small>add a note</small></a></div>
