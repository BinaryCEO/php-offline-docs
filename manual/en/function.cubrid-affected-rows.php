...
<head>
  ...
  <title>PHP: cubrid_affected_rows - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-affected-rows.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-affected-rows">
 <link rel="alternate" href="https://www.php.net/cubrid-affected-rows" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/cubridmysql.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/cubridmysql.cubrid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-client-encoding.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-affected-rows.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-affected-rows.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-affected-rows.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-affected-rows.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-affected-rows.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-affected-rows.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-affected-rows.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-affected-rows.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-affected-rows.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-affected-rows.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-affected-rows.php" hreflang="zh">
...
<meta name="Description" content="Return the number of rows affected by the last SQL statement" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_affected_rows - Manual" />
<meta name="twitter:description" content="Return the number of rows affected by the last SQL statement" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_affected_rows - Manual" />
<meta itemprop="description" content="Return the number of rows affected by the last SQL statement" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the number of rows affected by the last SQL statement" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-client-encoding.php">
          cubrid_client_encoding &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="cubridmysql.cubrid.php">
          &laquo; CUBRID MySQL Compatibility Functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-affected-rows.php' selected="selected">English</option>
            <option value='de/function.cubrid-affected-rows.php'>German</option>
            <option value='es/function.cubrid-affected-rows.php'>Spanish</option>
            <option value='fr/function.cubrid-affected-rows.php'>French</option>
            <option value='it/function.cubrid-affected-rows.php'>Italian</option>
            <option value='ja/function.cubrid-affected-rows.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-affected-rows.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-affected-rows.php'>Russian</option>
            <option value='tr/function.cubrid-affected-rows.php'>Turkish</option>
            <option value='uk/function.cubrid-affected-rows.php'>Ukrainian</option>
            <option value='zh/function.cubrid-affected-rows.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-affected-rows" class="refentry">
 ...
 <p class="para">
  <dl>
    ...
    <dd><p class="para">The CUBRID connection. If the connection identifier is not
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.cubrid-execute.php" class="function" rel="rdfs-seeAlso">cubrid_execute()</a> - Execute a prepared SQL statement</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/cubridmysql/cubrid-affected-rows.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-affected-rows%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-affected-rows&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-affected-rows.php">＋<small>add a note</small></a></span>
