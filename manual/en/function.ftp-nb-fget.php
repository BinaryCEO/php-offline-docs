...
<head>
  ...
  <title>PHP: ftp_nb_fget - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ftp-nb-fget.php">
 <link rel="shorturl" href="https://www.php.net/ftp-nb-fget">
 <link rel="alternate" href="https://www.php.net/ftp-nb-fget" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ftp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ftp-nb-continue.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ftp-nb-fput.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ftp-nb-fget.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ftp-nb-fget.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ftp-nb-fget.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ftp-nb-fget.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ftp-nb-fget.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ftp-nb-fget.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ftp-nb-fget.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ftp-nb-fget.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ftp-nb-fget.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ftp-nb-fget.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ftp-nb-fget.php" hreflang="zh">
...
<meta name="Description" content="Retrieves a file from the FTP server and writes it to an open file (non-blocking)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ftp_nb_fget - Manual" />
<meta name="twitter:description" content="Retrieves a file from the FTP server and writes it to an open file (non-blocking)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ftp_nb_fget - Manual" />
<meta itemprop="description" content="Retrieves a file from the FTP server and writes it to an open file (non-blocking)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieves a file from the FTP server and writes it to an open file (non-blocking)" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ftp-nb-fput.php">
          ftp_nb_fput &raquo;
              ...
              <div class="prev">
        <a href="function.ftp-nb-continue.php">
          &laquo; ftp_nb_continue        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ftp-nb-fget.php' selected="selected">English</option>
            <option value='de/function.ftp-nb-fget.php'>German</option>
            <option value='es/function.ftp-nb-fget.php'>Spanish</option>
            <option value='fr/function.ftp-nb-fget.php'>French</option>
            <option value='it/function.ftp-nb-fget.php'>Italian</option>
            <option value='ja/function.ftp-nb-fget.php'>Japanese</option>
            <option value='pt_BR/function.ftp-nb-fget.php'>Brazilian Portuguese</option>
            <option value='ru/function.ftp-nb-fget.php'>Russian</option>
            <option value='tr/function.ftp-nb-fget.php'>Turkish</option>
            <option value='uk/function.ftp-nb-fget.php'>Ukrainian</option>
            <option value='zh/function.ftp-nb-fget.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ftp-nb-fget" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.ftp-nb-fget-examples">
  ...
  <p class="para">
   <div class="example" id="example-4569">
    <p><strong>Example #1 <span class="function"><strong>ftp_nb_fget()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ftp-get.php" class="function" rel="rdfs-seeAlso">ftp_get()</a> - Downloads a file from the FTP server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ftp/functions/ftp-nb-fget.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ftp-nb-fget%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ftp-nb-fget&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ftp-nb-fget.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="47439">  <div class="votes">
    <div id="Vu47439">
    <a href="/manual/vote-note.php?id=47439&amp;page=function.ftp-nb-fget&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd47439">
    <a href="/manual/vote-note.php?id=47439&amp;page=function.ftp-nb-fget&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V47439" title="72% like this...">
    5
    </div>
  </div>
  <a href="#47439" class="name">
  <strong class="user"><em>pilif at pilif dot ch</em></strong></a><a class="genanchor" href="#47439"> &para;</a><div class="date" title="2004-11-16 05:53"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom47439">
<div class="phpcode"><code><span class="html">If you want to monitor the progress of the download, you may use the filesize()-Function.
<br />
<br />But note: The results of said function are cached, so you'll always get 0 bytes. Call clearstatcache() before calling filesize() to determine the actual size of the downloaded file.
<br />
<br />This may have performance implications, but if you want to provide the information, there's no way around it.
<br />
<br />Above sample extended:
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="comment">// get the size of the remote file
<br /></span><span class="default">$fs </span><span class="keyword">= </span><span class="default">ftp_size</span><span class="keyword">(</span><span class="default">$my_connection</span><span class="keyword">, </span><span class="string">"test"</span><span class="keyword">);
<br />
<br /></span><span class="comment">// Initate the download
<br /></span><span class="default">$ret </span><span class="keyword">= </span><span class="default">ftp_nb_get</span><span class="keyword">(</span><span class="default">$my_connection</span><span class="keyword">, </span><span class="string">"test"</span><span class="keyword">, </span><span class="string">"README"</span><span class="keyword">, </span><span class="default">FTP_BINARY</span><span class="keyword">);
<br />while (</span><span class="default">$ret </span><span class="keyword">== </span><span class="default">FTP_MOREDATA</span><span class="keyword">) {
<br />   
<br />   </span><span class="default">clearstatcache</span><span class="keyword">(); </span><span class="comment">// &lt;- this is important
<br />   </span><span class="default">$dld </span><span class="keyword">= </span><span class="default">filesize</span><span class="keyword">(</span><span class="default">$locfile</span><span class="keyword">);
<br />   if ( </span><span class="default">$dld </span><span class="keyword">&gt; </span><span class="default">0 </span><span class="keyword">){
<br />       </span><span class="comment">// calculate percentage
<br />       </span><span class="default">$i </span><span class="keyword">= (</span><span class="default">$dld</span><span class="keyword">/</span><span class="default">$fs</span><span class="keyword">)*</span><span class="default">100</span><span class="keyword">;
<br />       </span><span class="default">printf</span><span class="keyword">(</span><span class="string">"\r\t%d%% downloaded"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);
<br />   }   
<br />
<br />   </span><span class="comment">// Continue downloading...
<br />   </span><span class="default">$ret </span><span class="keyword">= </span><span class="default">ftp_nb_continue </span><span class="keyword">(</span><span class="default">$my_connection</span><span class="keyword">);
<br />}
<br />if (</span><span class="default">$ret </span><span class="keyword">!= </span><span class="default">FTP_FINISHED</span><span class="keyword">) {
<br />   echo </span><span class="string">"There was an error downloading the file..."</span><span class="keyword">;
<br />   exit(</span><span class="default">1</span><span class="keyword">);
<br />}
<br /></span><span class="default">?&gt;
<br /></span>
<br />Philip</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ftp-nb-fget&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ftp-nb-fget.php">＋<small>add a note</small></a></div>
