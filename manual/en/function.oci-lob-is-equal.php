...
<head>
  ...
  <title>PHP: oci_lob_is_equal - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-lob-is-equal.php">
 <link rel="shorturl" href="https://www.php.net/oci-lob-is-equal">
 <link rel="alternate" href="https://www.php.net/oci-lob-is-equal" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-lob-copy.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-new-collection.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-lob-is-equal.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-lob-is-equal.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-lob-is-equal.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-lob-is-equal.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-lob-is-equal.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-lob-is-equal.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-lob-is-equal.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-lob-is-equal.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-lob-is-equal.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-lob-is-equal.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-lob-is-equal.php" hreflang="zh">
...
<meta name="Description" content="Compares two LOB/FILE locators for equality" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_lob_is_equal - Manual" />
<meta name="twitter:description" content="Compares two LOB/FILE locators for equality" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_lob_is_equal - Manual" />
<meta itemprop="description" content="Compares two LOB/FILE locators for equality" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Compares two LOB/FILE locators for equality" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.oci-new-collection.php">
          oci_new_collection &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-lob-copy.php">
          &laquo; oci_lob_copy        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-lob-is-equal.php' selected="selected">English</option>
            <option value='de/function.oci-lob-is-equal.php'>German</option>
            <option value='es/function.oci-lob-is-equal.php'>Spanish</option>
            <option value='fr/function.oci-lob-is-equal.php'>French</option>
            <option value='it/function.oci-lob-is-equal.php'>Italian</option>
            <option value='ja/function.oci-lob-is-equal.php'>Japanese</option>
            <option value='pt_BR/function.oci-lob-is-equal.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-lob-is-equal.php'>Russian</option>
            <option value='tr/function.oci-lob-is-equal.php'>Turkish</option>
            <option value='uk/function.oci-lob-is-equal.php'>Ukrainian</option>
            <option value='zh/function.oci-lob-is-equal.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-lob-is-equal" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">oci_lob_is_equal</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">oci_lob_is_equal</span> &mdash; <span class="dc-title">Compares two LOB/FILE locators for equality</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.oci-lob-is-equal-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>oci_lob_is_equal</strong></span>(<span class="methodparam"><span class="type"><a href="class.ocilob.php" class="type OCILob">OCILob</a></span> <code class="parameter">$lob1</code></span>, <span class="methodparam"><span class="type"><a href="class.ocilob.php" class="type OCILob">OCILob</a></span> <code class="parameter">$lob2</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.oci-lob-is-equal-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">lob1</code></dt>
     <dd>
      <p class="para">
       A LOB identifier.
      </p>
     ...
     <dt><code class="parameter">lob2</code></dt>
     <dd>
      <p class="para">
       A LOB identifier.
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.oci-lob-is-equal-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if these objects are equal, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>


 <div class="refsect1 notes" id="refsect1-function.oci-lob-is-equal-notes">
   ...
   <p class="para">
    The OCILob class was called OCI-Lob prior to PHP 8 and PECL OCI8 3.0.0.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-lob-is-equal.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-lob-is-equal%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-lob-is-equal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-lob-is-equal.php">＋<small>add a note</small></a></span>
