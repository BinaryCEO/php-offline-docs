...
<head>
  ...
  <title>PHP: SolrQuery::getMltFields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getmltfields.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getmltfields.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltfields.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getmltcount.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getmltmaxnumqueryterms.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltfields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getmltfields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getmltfields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getmltfields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getmltfields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getmltfields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getmltfields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getmltfields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getmltfields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getmltfields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getmltfields.php" hreflang="zh">
...
<meta name="Description" content="Returns all the fields to use for similarity" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getMltFields - Manual" />
<meta name="twitter:description" content="Returns all the fields to use for similarity" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getMltFields - Manual" />
<meta itemprop="description" content="Returns all the fields to use for similarity" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns all the fields to use for similarity" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getmltmaxnumqueryterms.php">
          SolrQuery::getMltMaxNumQueryTerms &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getmltcount.php">
          &laquo; SolrQuery::getMltCount        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getmltfields.php' selected="selected">English</option>
            <option value='de/solrquery.getmltfields.php'>German</option>
            <option value='es/solrquery.getmltfields.php'>Spanish</option>
            <option value='fr/solrquery.getmltfields.php'>French</option>
            <option value='it/solrquery.getmltfields.php'>Italian</option>
            <option value='ja/solrquery.getmltfields.php'>Japanese</option>
            <option value='pt_BR/solrquery.getmltfields.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getmltfields.php'>Russian</option>
            <option value='tr/solrquery.getmltfields.php'>Turkish</option>
            <option value='uk/solrquery.getmltfields.php'>Ukrainian</option>
            <option value='zh/solrquery.getmltfields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getmltfields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getMltFields</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getMltFields</span> &mdash; <span class="dc-title">Returns all the fields to use for similarity</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getmltfields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getMltFields</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
...
Returns all the fields to use for similarity
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getmltfields-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getmltfields-returnvalues">
...
Returns an array on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getmltfields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getmltfields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getmltfields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getmltfields.php">＋<small>add a note</small></a></span>
