...
<head>
  ...
  <title>PHP: EventHttp::bind - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/eventhttp.bind.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/eventhttp.bind.php">
 <link rel="alternate" href="https://www.php.net/manual/en/eventhttp.bind.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.eventhttp.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventhttp.addserveralias.php">
 <link rel="next" href="https://www.php.net/manual/en/eventhttp.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/eventhttp.bind.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/eventhttp.bind.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/eventhttp.bind.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/eventhttp.bind.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/eventhttp.bind.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/eventhttp.bind.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/eventhttp.bind.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/eventhttp.bind.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/eventhttp.bind.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/eventhttp.bind.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/eventhttp.bind.php" hreflang="zh">
...
<meta name="Description" content="Binds an HTTP server on the specified address and port" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventHttp::bind - Manual" />
<meta name="twitter:description" content="Binds an HTTP server on the specified address and port" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventHttp::bind - Manual" />
<meta itemprop="description" content="Binds an HTTP server on the specified address and port" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Binds an HTTP server on the specified address and port" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="eventhttp.construct.php">
          EventHttp::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="eventhttp.addserveralias.php">
          &laquo; EventHttp::addServerAlias        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/eventhttp.bind.php' selected="selected">English</option>
            <option value='de/eventhttp.bind.php'>German</option>
            <option value='es/eventhttp.bind.php'>Spanish</option>
            <option value='fr/eventhttp.bind.php'>French</option>
            <option value='it/eventhttp.bind.php'>Italian</option>
            <option value='ja/eventhttp.bind.php'>Japanese</option>
            <option value='pt_BR/eventhttp.bind.php'>Brazilian Portuguese</option>
            <option value='ru/eventhttp.bind.php'>Russian</option>
            <option value='tr/eventhttp.bind.php'>Turkish</option>
            <option value='uk/eventhttp.bind.php'>Ukrainian</option>
            <option value='zh/eventhttp.bind.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="eventhttp.bind" class="refentry">
   ...
   <li>
    <span class="methodname"><a href="eventhttp.accept.php" class="methodname" rel="rdfs-seeAlso">EventHttp::accept()</a> - Makes an HTTP server accept connections on the specified socket stream or resource</span>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventhttp/bind.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Feventhttp.bind%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=eventhttp.bind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eventhttp.bind.php">＋<small>add a note</small></a></span>
