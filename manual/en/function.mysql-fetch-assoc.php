...
<head>
  ...
  <title>PHP: mysql_fetch_assoc - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-fetch-assoc.php">
 <link rel="shorturl" href="https://www.php.net/mysql-fetch-assoc">
 <link rel="alternate" href="https://www.php.net/mysql-fetch-assoc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-fetch-array.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-fetch-field.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-fetch-assoc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-fetch-assoc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-fetch-assoc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-fetch-assoc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-fetch-assoc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-fetch-assoc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-fetch-assoc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-fetch-assoc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-fetch-assoc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-fetch-assoc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-fetch-assoc.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mysql_fetch_assoc - Manual" />
<meta name="twitter:description" content="Fetch a result row as an associative array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_fetch_assoc - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-fetch-field.php">
          mysql_fetch_field &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-fetch-array.php">
          &laquo; mysql_fetch_array        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-fetch-assoc.php' selected="selected">English</option>
            <option value='de/function.mysql-fetch-assoc.php'>German</option>
            <option value='es/function.mysql-fetch-assoc.php'>Spanish</option>
            <option value='fr/function.mysql-fetch-assoc.php'>French</option>
            <option value='it/function.mysql-fetch-assoc.php'>Italian</option>
            <option value='ja/function.mysql-fetch-assoc.php'>Japanese</option>
            <option value='pt_BR/function.mysql-fetch-assoc.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-fetch-assoc.php'>Russian</option>
            <option value='tr/function.mysql-fetch-assoc.php'>Turkish</option>
            <option value='uk/function.mysql-fetch-assoc.php'>Ukrainian</option>
            <option value='zh/function.mysql-fetch-assoc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-fetch-assoc" class="refentry">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    ...
    <li>
     ...
     with <code class="parameter">mode</code> as <strong><code><a href="pdo.constants.php#pdo.constants.fetch-assoc">PDO::FETCH_ASSOC</a></code></strong>
    </li>
   </ul>
  </div>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-error.php" class="function" rel="rdfs-seeAlso">mysql_error()</a> - Returns the text of the error message from previous MySQL operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-fetch-assoc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-fetch-assoc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-fetch-assoc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-fetch-assoc.php">＋<small>add a note</small></a></span>
