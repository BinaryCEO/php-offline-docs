...
<head>
  ...
  <title>PHP: DateMalformedIntervalStringException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.datemalformedintervalstringexception.php">
 <link rel="shorturl" href="https://www.php.net/datemalformedintervalstringexception">
 <link rel="alternate" href="https://www.php.net/datemalformedintervalstringexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dateinvalidtimezoneexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.datemalformedperiodstringexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.datemalformedintervalstringexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.datemalformedintervalstringexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.datemalformedintervalstringexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.datemalformedintervalstringexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.datemalformedintervalstringexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.datemalformedintervalstringexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.datemalformedintervalstringexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.datemalformedintervalstringexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.datemalformedintervalstringexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.datemalformedintervalstringexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.datemalformedintervalstringexception.php" hreflang="zh">
...
<meta name="Description" content="The DateMalformedIntervalStringException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateMalformedIntervalStringException - Manual" />
<meta name="twitter:description" content="The DateMalformedIntervalStringException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateMalformedIntervalStringException - Manual" />
<meta itemprop="description" content="The DateMalformedIntervalStringException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DateMalformedIntervalStringException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.datemalformedperiodstringexception.php">
          DateMalformedPeriodStringException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dateinvalidtimezoneexception.php">
          &laquo; DateInvalidTimeZoneException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.datemalformedintervalstringexception.php' selected="selected">English</option>
            <option value='de/class.datemalformedintervalstringexception.php'>German</option>
            <option value='es/class.datemalformedintervalstringexception.php'>Spanish</option>
            <option value='fr/class.datemalformedintervalstringexception.php'>French</option>
            <option value='it/class.datemalformedintervalstringexception.php'>Italian</option>
            <option value='ja/class.datemalformedintervalstringexception.php'>Japanese</option>
            <option value='pt_BR/class.datemalformedintervalstringexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.datemalformedintervalstringexception.php'>Russian</option>
            <option value='tr/class.datemalformedintervalstringexception.php'>Turkish</option>
            <option value='uk/class.datemalformedintervalstringexception.php'>Ukrainian</option>
            <option value='zh/class.datemalformedintervalstringexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.datemalformedintervalstringexception" class="reference">
 <h1 class="title">The DateMalformedIntervalStringException class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.3.0)</p>


  <div class="section" id="datemalformedintervalstringexception.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    Thrown when an invalid <code class="parameter">duration</code> argument is passed to
    <span class="methodname"><a href="dateinterval.construct.php" class="methodname">DateInterval::__construct()</a></span>.
   </p>
  </div>


  <div class="section" id="datemalformedintervalstringexception.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">DateMalformedIntervalStringException</strong></strong>
    

    
     <span class="modifier">extends</span>
      <a href="class.dateexception.php" class="classname">DateException</a>
     {</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datemalformedintervalstringexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.datemalformedintervalstringexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.datemalformedintervalstringexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.datemalformedintervalstringexception.php">＋<small>add a note</small></a></span>
