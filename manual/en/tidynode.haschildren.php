...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/tidynode.haschildren.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/tidynode.haschildren.php">
 <link rel="alternate" href="https://www.php.net/manual/en/tidynode.haschildren.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.tidynode.php">
 <link rel="prev" href="https://www.php.net/manual/en/tidynode.getprevioussibling.php">
 <link rel="next" href="https://www.php.net/manual/en/tidynode.hassiblings.php">
...
<meta name="Description" content="Checks if a node has children" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: tidyNode::hasChildren - Manual" />
<meta name="twitter:description" content="Checks if a node has children" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: tidyNode::hasChildren - Manual" />
<meta itemprop="description" content="Checks if a node has children" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if a node has children" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/tidynode.haschildren.php' selected="selected">English</option>
            ...
            <option value='pt_BR/tidynode.haschildren.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">tidyNode::hasChildren</span> &mdash; <span class="dc-title">Checks if a node has children</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-tidynode.haschildren-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the node has children, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-tidynode.haschildren-examples">
  ...
  <p class="para">
   <div class="example" id="example-4101">
    <p><strong>Example #1 <span class="function"><strong>tidyNode::hasChildren()</strong></span> example</strong></p>
...
bool(false)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/tidy/tidynode/haschildren.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ftidynode.haschildren%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=tidynode.haschildren&amp;repo=en&amp;redirect=https://www.php.net/manual/en/tidynode.haschildren.php">＋<small>add a note</small></a></span>
