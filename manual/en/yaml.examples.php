...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/yaml.examples.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/yaml.examples.php">
 <link rel="alternate" href="https://www.php.net/manual/en/yaml.examples.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.yaml.php">
 <link rel="prev" href="https://www.php.net/manual/en/yaml.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/yaml.callbacks.php">

 <link rel="alternate" href="https://www.php.net/manual/en/yaml.examples.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/yaml.examples.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/yaml.examples.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/yaml.examples.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/yaml.examples.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/yaml.examples.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/yaml.examples.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/yaml.examples.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/yaml.examples.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/yaml.examples.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/yaml.examples.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/yaml.examples.php' selected="selected">English</option>
            <option value='de/yaml.examples.php'>German</option>
            <option value='es/yaml.examples.php'>Spanish</option>
            <option value='fr/yaml.examples.php'>French</option>
            <option value='it/yaml.examples.php'>Italian</option>
            <option value='ja/yaml.examples.php'>Japanese</option>
            <option value='pt_BR/yaml.examples.php'>Brazilian Portuguese</option>
            <option value='ru/yaml.examples.php'>Russian</option>
            <option value='tr/yaml.examples.php'>Turkish</option>
            <option value='uk/yaml.examples.php'>Ukrainian</option>
            <option value='zh/yaml.examples.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="yaml.examples" class="chapter">
 <h1 class="title">Examples</h1>

 <div class="example" id="example-4146">
  <p><strong>Example #1 Yaml Example</strong></p>
...
bool(true)
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaml/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fyaml.examples%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=yaml.examples&amp;repo=en&amp;redirect=https://www.php.net/manual/en/yaml.examples.php">＋<small>add a note</small></a></span>
