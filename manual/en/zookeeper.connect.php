...
<head>
  ...
  <title>PHP: Zookeeper::connect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/zookeeper.connect.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/zookeeper.connect.php">
 <link rel="alternate" href="https://www.php.net/manual/en/zookeeper.connect.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.zookeeper.php">
 <link rel="prev" href="https://www.php.net/manual/en/zookeeper.close.php">
 <link rel="next" href="https://www.php.net/manual/en/zookeeper.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/zookeeper.connect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/zookeeper.connect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/zookeeper.connect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/zookeeper.connect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/zookeeper.connect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/zookeeper.connect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/zookeeper.connect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/zookeeper.connect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/zookeeper.connect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/zookeeper.connect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/zookeeper.connect.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Zookeeper::connect - Manual" />
<meta name="twitter:description" content="Create a handle to used communicate with zookeeper" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Zookeeper::connect - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="zookeeper.construct.php">
          Zookeeper::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="zookeeper.close.php">
          &laquo; Zookeeper::close        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/zookeeper.connect.php' selected="selected">English</option>
            <option value='de/zookeeper.connect.php'>German</option>
            <option value='es/zookeeper.connect.php'>Spanish</option>
            <option value='fr/zookeeper.connect.php'>French</option>
            <option value='it/zookeeper.connect.php'>Italian</option>
            <option value='ja/zookeeper.connect.php'>Japanese</option>
            <option value='pt_BR/zookeeper.connect.php'>Brazilian Portuguese</option>
            <option value='ru/zookeeper.connect.php'>Russian</option>
            <option value='tr/zookeeper.connect.php'>Turkish</option>
            <option value='uk/zookeeper.connect.php'>Ukrainian</option>
            <option value='zh/zookeeper.connect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="zookeeper.connect" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.zookeeperexception.php" class="classname">ZookeeperException</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeeper/connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fzookeeper.connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=zookeeper.connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zookeeper.connect.php">＋<small>add a note</small></a></span>
