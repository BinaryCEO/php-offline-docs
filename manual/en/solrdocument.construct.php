...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrdocument.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrdocument.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrdocument.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrdocument.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrdocument.clone.php">
 <link rel="next" href="https://www.php.net/manual/en/solrdocument.current.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrdocument.construct.php' selected="selected">English</option>
            ...
            <option value='pt_BR/solrdocument.construct.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrDocument::__construct</span> &mdash; <span class="dc-title">Constructor</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrdocument.construct-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrdocument/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrdocument.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrdocument.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrdocument.construct.php">＋<small>add a note</small></a></span>
