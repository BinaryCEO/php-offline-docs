...
<head>
  ...
  <title>PHP: swoole_event_set - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.swoole-event-set.php">
 <link rel="shorturl" href="https://www.php.net/swoole-event-set">
 <link rel="alternate" href="https://www.php.net/swoole-event-set" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.swoole-funcs.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.swoole-event-exit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.swoole-event-wait.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.swoole-event-set.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.swoole-event-set.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.swoole-event-set.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.swoole-event-set.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.swoole-event-set.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.swoole-event-set.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.swoole-event-set.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.swoole-event-set.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.swoole-event-set.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.swoole-event-set.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.swoole-event-set.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: swoole_event_set - Manual" />
<meta name="twitter:description" content="Update the event callback functions of a socket" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: swoole_event_set - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.swoole-event-wait.php">
          swoole_event_wait &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.swoole-event-exit.php">
          &laquo; swoole_event_exit        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.swoole-event-set.php' selected="selected">English</option>
            <option value='de/function.swoole-event-set.php'>German</option>
            <option value='es/function.swoole-event-set.php'>Spanish</option>
            <option value='fr/function.swoole-event-set.php'>French</option>
            <option value='it/function.swoole-event-set.php'>Italian</option>
            <option value='ja/function.swoole-event-set.php'>Japanese</option>
            <option value='pt_BR/function.swoole-event-set.php'>Brazilian Portuguese</option>
            <option value='ru/function.swoole-event-set.php'>Russian</option>
            <option value='tr/function.swoole-event-set.php'>Turkish</option>
            <option value='uk/function.swoole-event-set.php'>Ukrainian</option>
            <option value='zh/function.swoole-event-set.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.swoole-event-set" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.swoole-event-set-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/swoole/functions/swoole-event-set.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.swoole-event-set%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.swoole-event-set&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.swoole-event-set.php">＋<small>add a note</small></a></span>
