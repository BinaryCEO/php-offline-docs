...
<head>
  ...
  <title>PHP: openal_listener_get - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openal-listener-get.php">
 <link rel="shorturl" href="https://www.php.net/openal-listener-get">
 <link rel="alternate" href="https://www.php.net/openal-listener-get" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openal.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openal-device-open.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openal-listener-set.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openal-listener-get.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openal-listener-get.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openal-listener-get.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openal-listener-get.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openal-listener-get.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openal-listener-get.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openal-listener-get.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openal-listener-get.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openal-listener-get.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openal-listener-get.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openal-listener-get.php" hreflang="zh">
...
<meta name="Description" content="Retrieve a listener property" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openal_listener_get - Manual" />
<meta name="twitter:description" content="Retrieve a listener property" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openal_listener_get - Manual" />
<meta itemprop="description" content="Retrieve a listener property" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve a listener property" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openal-listener-set.php">
          openal_listener_set &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openal-device-open.php">
          &laquo; openal_device_open        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openal-listener-get.php' selected="selected">English</option>
            <option value='de/function.openal-listener-get.php'>German</option>
            <option value='es/function.openal-listener-get.php'>Spanish</option>
            <option value='fr/function.openal-listener-get.php'>French</option>
            <option value='it/function.openal-listener-get.php'>Italian</option>
            <option value='ja/function.openal-listener-get.php'>Japanese</option>
            <option value='pt_BR/function.openal-listener-get.php'>Brazilian Portuguese</option>
            <option value='ru/function.openal-listener-get.php'>Russian</option>
            <option value='tr/function.openal-listener-get.php'>Turkish</option>
            <option value='uk/function.openal-listener-get.php'>Ukrainian</option>
            <option value='zh/function.openal-listener-get.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openal-listener-get" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.openal-listener-get-returnvalues">
  ...
  <p class="para">
   Returns a float or array of floats (as appropriate) or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.openal-listener-set.php" class="function" rel="rdfs-seeAlso">openal_listener_set()</a> - Set a listener property</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openal/functions/openal-listener-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openal-listener-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openal-listener-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openal-listener-get.php">＋<small>add a note</small></a></span>
