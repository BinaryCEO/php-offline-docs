...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/wrappers.data.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/wrappers.data.php">
 <link rel="alternate" href="https://www.php.net/manual/en/wrappers.data.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/wrappers.php">
 <link rel="prev" href="https://www.php.net/manual/en/wrappers.compression.php">
 <link rel="next" href="https://www.php.net/manual/en/wrappers.glob.php">

 <link rel="alternate" href="https://www.php.net/manual/en/wrappers.data.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/wrappers.data.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/wrappers.data.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/wrappers.data.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/wrappers.data.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/wrappers.data.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/wrappers.data.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/wrappers.data.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/wrappers.data.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/wrappers.data.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/wrappers.data.php" hreflang="zh">
...
<meta name="Description" content="Data (RFC 2397)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: data:// - Manual" />
<meta name="twitter:description" content="Data (RFC 2397)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: data:// - Manual" />
<meta itemprop="description" content="Data (RFC 2397)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Data (RFC 2397)" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/wrappers.data.php' selected="selected">English</option>
            ...
            <option value='it/wrappers.data.php'>Italian</option>
            ...
            <option value='uk/wrappers.data.php'>Ukrainian</option>
  ...
  </div><div id="wrappers.data" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-wrappers.data-description">
  ...
  <p class="para">
   ...
   The <var class="filename">data:</var> (<a href="https://datatracker.ietf.org/doc/html/rfc2397" class="link external">&raquo;&nbsp;RFC
   2397</a>) stream wrapper.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$fp   </span><span style="color: #007700">= </span><span style="color: #0000BB">fopen</span><span style="color: #007700">(</span><span style="color: #DD0000">'data://text/plain;base64,'</span><span style="color: #007700">, </span><span style="color: #DD0000">'r'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$meta </span><span style="color: #007700">= </span><span style="color: #0000BB">stream_get_meta_data</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// prints "text/plain"<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$meta</span><span style="color: #007700">[</span><span style="color: #DD0000">'mediatype'</span><span style="color: #007700">];<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/wrappers/data.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fwrappers.data%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=wrappers.data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/wrappers.data.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="100979">  <div class="votes">
    <div id="Vu100979">
    <a href="/manual/vote-note.php?id=100979&amp;page=wrappers.data&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd100979">
    <a href="/manual/vote-note.php?id=100979&amp;page=wrappers.data&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V100979" title="72% like this...">
    26
    </div>
  </div>
  <a href="#100979" class="name">
  <strong class="user"><em>from dot php dot net at brainbox dot cz</em></strong></a><a class="genanchor" href="#100979"> &para;</a><div class="date" title="2010-11-18 04:37"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom100979">
<div class="phpcode"><code><span class="html">When passing plain string without base64 encoding, do not forget to pass the string through URLENCODE(), because PHP automatically urldecodes all entities inside passed string (and therefore all + get lost, all % entities will be converted to the corresponding characters).
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="97679">  <div class="votes">
    <div id="Vu97679">
    <a href="/manual/vote-note.php?id=97679&amp;page=wrappers.data&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd97679">
    <a href="/manual/vote-note.php?id=97679&amp;page=wrappers.data&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V97679" title="60% like this...">
    13
    </div>
  </div>
  <a href="#97679" class="name">
  <strong class="user"><em>admin deskbitz net</em></strong></a><a class="genanchor" href="#97679"> &para;</a><div class="date" title="2010-05-02 12:54"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97679">
<div class="phpcode"><code><span class="html">If you want to create a gd-image directly out of a sql-database-field you might want to use:
<br />
<br /><span class="default">&lt;?php
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />this goes also for gif, png, etc using the correct "imagecreatefrom$$$"-function and mime-type.</span></code></div>
  </div>
 </div>
  <div class="note" id="85581">  <div class="votes">
    <div id="Vu85581">
    <a href="/manual/vote-note.php?id=85581&amp;page=wrappers.data&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd85581">
    <a href="/manual/vote-note.php?id=85581&amp;page=wrappers.data&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V85581" title="53% like this...">
    4
    </div>
  </div>
  <a href="#85581" class="name">
  <strong class="user"><em>sandaimespaceman at gmail dot com</em></strong></a><a class="genanchor" href="#85581"> &para;</a><div class="date" title="2008-09-06 06:30"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom85581">
<div class="phpcode"><code><span class="html">Now PHP supports data: protocol w/out "//" like data:text/plain, not data://text/plain,<br /><br />I tried it.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=wrappers.data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/wrappers.data.php">＋<small>add a note</small></a></div>
