...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mysql-xdevapi-collection.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-client.getsession.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-collection.add.php">
...
<meta name="Description" content="Collection class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_xdevapi\Collection - Manual" />
<meta name="twitter:description" content="Collection class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_xdevapi\Collection - Manual" />
<meta itemprop="description" content="Collection class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Collection class" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mysql-xdevapi-collection.php' selected="selected">English</option>
            ...
            <option value='fr/class.mysql-xdevapi-collection.php'>French</option>
 ...
 <h1 class="title">Collection class</h1>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mysql-xdevapi-collection.add.php">Collection::add</a> — Add collection document</li><li><a href="mysql-xdevapi-collection.addorreplaceone.php">Collection::addOrReplaceOne</a> — Add or replace collection document</li><li><a href="mysql-xdevapi-collection.construct.php">Collection::__construct</a> — Collection constructor</li><li><a href="mysql-xdevapi-collection.count.php">Collection::count</a> — Get document count</li><li><a href="mysql-xdevapi-collection.createindex.php">Collection::createIndex</a> — Create collection index</li><li><a href="mysql-xdevapi-collection.dropindex.php">Collection::dropIndex</a> — Drop collection index</li><li><a href="mysql-xdevapi-collection.existsindatabase.php">Collection::existsInDatabase</a> — Check if collection exists in database</li><li><a href="mysql-xdevapi-collection.find.php">Collection::find</a> — Search for document</li><li><a href="mysql-xdevapi-collection.getname.php">Collection::getName</a> — Get collection name</li><li><a href="mysql-xdevapi-collection.getone.php">Collection::getOne</a> — Get one document</li><li><a href="mysql-xdevapi-collection.getschema.php">Collection::getSchema</a> — Get schema object</li><li><a href="mysql-xdevapi-collection.getsession.php">Collection::getSession</a> — Get session object</li><li><a href="mysql-xdevapi-collection.modify.php">Collection::modify</a> — Modify collection documents</li><li><a href="mysql-xdevapi-collection.remove.php">Collection::remove</a> — Remove collection documents</li><li><a href="mysql-xdevapi-collection.removeone.php">Collection::removeOne</a> — Remove one collection document</li><li><a href="mysql-xdevapi-collection.replaceone.php">Collection::replaceOne</a> — Replace one collection document</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql-xdevapi.collection.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mysql-xdevapi-collection%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mysql-xdevapi-collection&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mysql-xdevapi-collection.php">＋<small>add a note</small></a></span>
