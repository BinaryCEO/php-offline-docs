...
<head>
  ...
  <title>PHP: odbc_procedurecolumns - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-procedurecolumns.php">
 <link rel="shorturl" href="https://www.php.net/odbc-procedurecolumns">
 <link rel="alternate" href="https://www.php.net/odbc-procedurecolumns" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-primarykeys.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-procedures.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-procedurecolumns.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-procedurecolumns.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-procedurecolumns.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-procedurecolumns.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-procedurecolumns.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-procedurecolumns.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-procedurecolumns.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-procedurecolumns.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-procedurecolumns.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-procedurecolumns.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-procedurecolumns.php" hreflang="zh">
...
<meta name="Description" content="Retrieve information about parameters to procedures" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_procedurecolumns - Manual" />
<meta name="twitter:description" content="Retrieve information about parameters to procedures" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_procedurecolumns - Manual" />
<meta itemprop="description" content="Retrieve information about parameters to procedures" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve information about parameters to procedures" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.odbc-procedures.php">
          odbc_procedures &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-primarykeys.php">
          &laquo; odbc_primarykeys        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-procedurecolumns.php' selected="selected">English</option>
            <option value='de/function.odbc-procedurecolumns.php'>German</option>
            <option value='es/function.odbc-procedurecolumns.php'>Spanish</option>
            <option value='fr/function.odbc-procedurecolumns.php'>French</option>
            <option value='it/function.odbc-procedurecolumns.php'>Italian</option>
            <option value='ja/function.odbc-procedurecolumns.php'>Japanese</option>
            <option value='pt_BR/function.odbc-procedurecolumns.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-procedurecolumns.php'>Russian</option>
            <option value='tr/function.odbc-procedurecolumns.php'>Turkish</option>
            <option value='uk/function.odbc-procedurecolumns.php'>Ukrainian</option>
            <option value='zh/function.odbc-procedurecolumns.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-procedurecolumns" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">odbc_procedurecolumns</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">odbc_procedurecolumns</span> &mdash; <span class="dc-title">Retrieve information about parameters to procedures</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.odbc-procedurecolumns-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>odbc_procedurecolumns</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type">Odbc\Connection</span> <code class="parameter">$odbc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$catalog</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$schema</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$procedure</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$column</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><span class="type">Odbc\Result</span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.odbc-procedurecolumns-parameters">
...
and <code class="literal">_</code> to match a single character.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-procedurecolumns-returnvalues">
  ...
  <p class="para">
   ...
   <ul class="itemizedlist">
    ...
    <li class="listitem"><span class="simpara"><code class="literal">COLUMN_TYPE</code></span></li>
  ...
  <p class="simpara">
   The result set is ordered by <code class="literal">PROCEDURE_CAT</code>, <code class="literal">PROCEDURE_SCHEM</code>,
   <code class="literal">PROCEDURE_NAME</code> and <code class="literal">COLUMN_TYPE</code>.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.odbc-procedurecolumns-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.odbc-procedurecolumns-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="odbc-procedurecolumns.example.basic">
   <p><strong>Example #1 List Columns of a stored Procedure</strong></p>
   <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">odbc_connect</span><span style="color: #007700">(</span><span style="color: #0000BB">$dsn</span><span style="color: #007700">, </span><span style="color: #0000BB">$user</span><span style="color: #007700">, </span><span style="color: #0000BB">$pass</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$columns </span><span style="color: #007700">= </span><span style="color: #0000BB">odbc_procedurecolumns</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">'TutorialDB'</span><span style="color: #007700">, </span><span style="color: #DD0000">'dbo'</span><span style="color: #007700">, </span><span style="color: #DD0000">'GetEmployeeSalesYTD;1'</span><span style="color: #007700">, </span><span style="color: #DD0000">'%'</span><span style="color: #007700">);<br />while ((</span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">odbc_fetch_array</span><span style="color: #007700">(</span><span style="color: #0000BB">$columns</span><span style="color: #007700">))) {<br />    </span><span style="color: #0000BB">print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">$row</span><span style="color: #007700">);<br />    break; </span><span style="color: #FF8000">// further rows omitted for brevity<br /></span><span style="color: #007700">}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.odbc-procedurecolumns-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.odbc-columns.php" class="function" rel="rdfs-seeAlso">odbc_columns()</a> - Lists the column names in specified tables</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-procedurecolumns.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-procedurecolumns%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-procedurecolumns&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-procedurecolumns.php">＋<small>add a note</small></a></span>
