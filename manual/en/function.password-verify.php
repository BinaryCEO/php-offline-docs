...
<head>
  ...
  <title>PHP: password_verify - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.password-verify.php">
 <link rel="shorturl" href="https://www.php.net/password-verify">
 <link rel="alternate" href="https://www.php.net/password-verify" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.password.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.password-needs-rehash.php">
 <link rel="next" href="https://www.php.net/manual/en/book.rnp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.password-verify.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.password-verify.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.password-verify.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.password-verify.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.password-verify.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.password-verify.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.password-verify.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.password-verify.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.password-verify.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.password-verify.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.password-verify.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: password_verify - Manual" />
<meta name="twitter:description" content="Verifies that a password matches a hash" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: password_verify - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.password-verify.php' selected="selected">English</option>
            <option value='de/function.password-verify.php'>German</option>
            <option value='es/function.password-verify.php'>Spanish</option>
            <option value='fr/function.password-verify.php'>French</option>
            <option value='it/function.password-verify.php'>Italian</option>
            <option value='ja/function.password-verify.php'>Japanese</option>
            <option value='pt_BR/function.password-verify.php'>Brazilian Portuguese</option>
            <option value='ru/function.password-verify.php'>Russian</option>
            <option value='tr/function.password-verify.php'>Turkish</option>
            <option value='uk/function.password-verify.php'>Ukrainian</option>
            <option value='zh/function.password-verify.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.password-verify" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.sodium-crypto-pwhash-str-verify.php" class="function" rel="rdfs-seeAlso">sodium_crypto_pwhash_str_verify()</a> - Verifies that a password matches a hash</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/password/functions/password-verify.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.password-verify%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.password-verify&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.password-verify.php">＋<small>add a note</small></a></span>
