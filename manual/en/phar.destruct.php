...
<head>
  ...
  <title>PHP: Phar::__destruct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.destruct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.destruct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.destruct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.delete.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.extractto.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.destruct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.destruct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.destruct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.destruct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.destruct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.destruct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.destruct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.destruct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.destruct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.destruct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.destruct.php" hreflang="zh">
...
<meta name="Description" content="Destructs a Phar archive object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::__destruct - Manual" />
<meta name="twitter:description" content="Destructs a Phar archive object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::__destruct - Manual" />
<meta itemprop="description" content="Destructs a Phar archive object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Destructs a Phar archive object" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.destruct.php' selected="selected">English</option>
            <option value='de/phar.destruct.php'>German</option>
            <option value='es/phar.destruct.php'>Spanish</option>
            <option value='fr/phar.destruct.php'>French</option>
            <option value='it/phar.destruct.php'>Italian</option>
            <option value='ja/phar.destruct.php'>Japanese</option>
            <option value='pt_BR/phar.destruct.php'>Brazilian Portuguese</option>
            <option value='ru/phar.destruct.php'>Russian</option>
            <option value='tr/phar.destruct.php'>Turkish</option>
            <option value='uk/phar.destruct.php'>Ukrainian</option>
            <option value='zh/phar.destruct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.destruct" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::__destruct</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">Phar::__destruct</span> &mdash; <span class="dc-title">Destructs a Phar archive object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-phar.destruct-description">
  <h3 class="title">Description</h3>
  <div class="destructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::__destruct</strong></span>()</div>

 </div>


 <div class="refsect1 parameters" id="refsect1-phar.destruct-parameters">
  ...
  <p class="para">This function has no parameters.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/destruct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.destruct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.destruct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.destruct.php">＋<small>add a note</small></a></span>
