...
<head>
  ...
  <title>PHP: ArrayObject::natsort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/arrayobject.natsort.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/arrayobject.natsort.php">
 <link rel="alternate" href="https://www.php.net/manual/en/arrayobject.natsort.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.arrayobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/arrayobject.natcasesort.php">
 <link rel="next" href="https://www.php.net/manual/en/arrayobject.offsetexists.php">

 <link rel="alternate" href="https://www.php.net/manual/en/arrayobject.natsort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/arrayobject.natsort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/arrayobject.natsort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/arrayobject.natsort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/arrayobject.natsort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/arrayobject.natsort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/arrayobject.natsort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/arrayobject.natsort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/arrayobject.natsort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/arrayobject.natsort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/arrayobject.natsort.php" hreflang="zh">
...
<meta name="Description" content="Sort entries using a &quot;natural order&quot; algorithm" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ArrayObject::natsort - Manual" />
<meta name="twitter:description" content="Sort entries using a &quot;natural order&quot; algorithm" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ArrayObject::natsort - Manual" />
<meta itemprop="description" content="Sort entries using a &quot;natural order&quot; algorithm" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sort entries using a &quot;natural order&quot; algorithm" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="arrayobject.offsetexists.php">
          ArrayObject::offsetExists &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="arrayobject.natcasesort.php">
          &laquo; ArrayObject::natcasesort        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/arrayobject.natsort.php' selected="selected">English</option>
            <option value='de/arrayobject.natsort.php'>German</option>
            <option value='es/arrayobject.natsort.php'>Spanish</option>
            <option value='fr/arrayobject.natsort.php'>French</option>
            <option value='it/arrayobject.natsort.php'>Italian</option>
            <option value='ja/arrayobject.natsort.php'>Japanese</option>
            <option value='pt_BR/arrayobject.natsort.php'>Brazilian Portuguese</option>
            <option value='ru/arrayobject.natsort.php'>Russian</option>
            <option value='tr/arrayobject.natsort.php'>Turkish</option>
            <option value='uk/arrayobject.natsort.php'>Ukrainian</option>
            <option value='zh/arrayobject.natsort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="arrayobject.natsort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ArrayObject::natsort</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ArrayObject::natsort</span> &mdash; <span class="dc-title">Sort entries using a &quot;natural order&quot; algorithm</span></p>
 ...
 <div class="refsect1 description" id="refsect1-arrayobject.natsort-description">
  ...
  in the way a human being would while maintaining key/value associations.
   ...
   (used in <a href="arrayobject.asort.php" class="link">ArrayObject::asort</a>) method
 ...
 <div class="refsect1 examples" id="refsect1-arrayobject.natsort-examples">
  ...
  <p class="para">
   <div class="example" id="example-3867">
    <p><strong>Example #1 <span class="function"><strong>ArrayObject::natsort()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.natsort.php" class="function" rel="rdfs-seeAlso">natsort()</a> - Sort an array using a &quot;natural order&quot; algorithm</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/arrayobject/natsort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Farrayobject.natsort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=arrayobject.natsort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/arrayobject.natsort.php">＋<small>add a note</small></a></span>
