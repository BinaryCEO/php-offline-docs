...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-blob-get.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-blob-echo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-blob-import.php">
...
<meta name="Description" content="Get len bytes data from open blob" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_blob_get - Manual" />
<meta name="twitter:description" content="Get len bytes data from open blob" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_blob_get - Manual" />
<meta itemprop="description" content="Get len bytes data from open blob" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get len bytes data from open blob" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-blob-get.php' selected="selected">English</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_blob_get</span> &mdash; <span class="dc-title">Get len bytes data from open blob</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ibase-blob-get-description">
  ...
  <p class="para rdfs-comment">
   This function returns at most <code class="parameter">len</code> bytes from a BLOB
   that has been opened for reading by <span class="function"><a href="function.ibase-blob-open.php" class="function">ibase_blob_open()</a></span>.
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    It is not possible to read from a BLOB that has been opened for writing
    by <span class="function"><a href="function.ibase-blob-create.php" class="function">ibase_blob_create()</a></span>.
   </p>
  </p></blockquote>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ibase-blob-get-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       A BLOB handle opened with <span class="function"><a href="function.ibase-blob-open.php" class="function">ibase_blob_open()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-blob-get-returnvalues">
  ...
  <p class="para">
   Returns at most <code class="parameter">len</code> bytes from the BLOB, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>
   on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.ibase-blob-get-examples">
  ...
  <p class="para">
   <div class="example" id="example-1323">
    <p><strong>Example #1 <span class="function"><strong>ibase_blob_get()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-blob-echo.php" class="function" rel="rdfs-seeAlso">ibase_blob_echo()</a> - Output blob contents to browser</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-blob-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-blob-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-blob-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-blob-get.php">＋<small>add a note</small></a></span>
