...
<head>
  ...
  <title>PHP: win32_get_last_control_message - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.win32-get-last-control-message.php">
 <link rel="shorturl" href="https://www.php.net/win32-get-last-control-message">
 <link rel="alternate" href="https://www.php.net/win32-get-last-control-message" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.win32service.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.win32-delete-service.php">
 <link rel="next" href="https://www.php.net/manual/en/function.win32-get-service-env-vars.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.win32-get-last-control-message.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.win32-get-last-control-message.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.win32-get-last-control-message.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.win32-get-last-control-message.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.win32-get-last-control-message.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.win32-get-last-control-message.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.win32-get-last-control-message.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.win32-get-last-control-message.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.win32-get-last-control-message.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.win32-get-last-control-message.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.win32-get-last-control-message.php" hreflang="zh">
...
<meta name="Description" content="Returns the last control message that was sent to this service" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: win32_get_last_control_message - Manual" />
<meta name="twitter:description" content="Returns the last control message that was sent to this service" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: win32_get_last_control_message - Manual" />
<meta itemprop="description" content="Returns the last control message that was sent to this service" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the last control message that was sent to this service" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.win32-get-service-env-vars.php">
          win32_get_service_env_vars &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.win32-delete-service.php">
          &laquo; win32_delete_service        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.win32-get-last-control-message.php' selected="selected">English</option>
            <option value='de/function.win32-get-last-control-message.php'>German</option>
            <option value='es/function.win32-get-last-control-message.php'>Spanish</option>
            <option value='fr/function.win32-get-last-control-message.php'>French</option>
            <option value='it/function.win32-get-last-control-message.php'>Italian</option>
            <option value='ja/function.win32-get-last-control-message.php'>Japanese</option>
            <option value='pt_BR/function.win32-get-last-control-message.php'>Brazilian Portuguese</option>
            <option value='ru/function.win32-get-last-control-message.php'>Russian</option>
            <option value='tr/function.win32-get-last-control-message.php'>Turkish</option>
            <option value='uk/function.win32-get-last-control-message.php'>Ukrainian</option>
            <option value='zh/function.win32-get-last-control-message.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.win32-get-last-control-message" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">win32_get_last_control_message</h1>
  <p class="verinfo">(PECL win32service &gt;=0.1.0)</p><p class="refpurpose"><span class="refname">win32_get_last_control_message</span> &mdash; <span class="dc-title">Returns the last control message that was sent to this service</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.win32-get-last-control-message-returnvalues">
  ...
  <p class="para">
   ...
   <a href="win32service.constants.php#win32service.constants.servicecontrol" class="link">Win32Service Service Control Message Constants</a>:
 ...
 <div class="refsect1 seealso" id="refsect1-function.win32-get-last-control-message-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><a href="win32service.constants.php#win32service.constants.servicecontrol" class="link">Win32Service Service Control Message Constants</a></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/win32service/functions/win32-get-last-control-message.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.win32-get-last-control-message%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.win32-get-last-control-message&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.win32-get-last-control-message.php">＋<small>add a note</small></a></span>
