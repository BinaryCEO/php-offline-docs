...
<head>
  ...
  <title>PHP: IntlChar::getPropertyEnum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.getpropertyenum.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.getpropertyenum.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.getpropertyenum.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.getnumericvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.getpropertyname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.getpropertyenum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.getpropertyenum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.getpropertyenum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.getpropertyenum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.getpropertyenum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.getpropertyenum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.getpropertyenum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.getpropertyenum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.getpropertyenum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.getpropertyenum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.getpropertyenum.php" hreflang="zh">
...
<meta name="Description" content="Get the property constant value for a given property name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::getPropertyEnum - Manual" />
<meta name="twitter:description" content="Get the property constant value for a given property name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::getPropertyEnum - Manual" />
<meta itemprop="description" content="Get the property constant value for a given property name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the property constant value for a given property name" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.getpropertyname.php">
          IntlChar::getPropertyName &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.getnumericvalue.php">
          &laquo; IntlChar::getNumericValue        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.getpropertyenum.php' selected="selected">English</option>
            <option value='de/intlchar.getpropertyenum.php'>German</option>
            <option value='es/intlchar.getpropertyenum.php'>Spanish</option>
            <option value='fr/intlchar.getpropertyenum.php'>French</option>
            <option value='it/intlchar.getpropertyenum.php'>Italian</option>
            <option value='ja/intlchar.getpropertyenum.php'>Japanese</option>
            <option value='pt_BR/intlchar.getpropertyenum.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.getpropertyenum.php'>Russian</option>
            <option value='tr/intlchar.getpropertyenum.php'>Turkish</option>
            <option value='uk/intlchar.getpropertyenum.php'>Ukrainian</option>
            <option value='zh/intlchar.getpropertyenum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.getpropertyenum" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::getPropertyEnum</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::getPropertyEnum</span> &mdash; <span class="dc-title">Get the property constant value for a given property name</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlchar.getpropertyenum-description">
  ...
  <p class="para">
   ...
   <strong><code><a href="class.intlchar.php#intlchar.constants.property-general-category-mask">IntlChar::PROPERTY_GENERAL_CATEGORY_MASK</a></code></strong>. These names are not in PropertyAliases.txt.
  </p>
  <p class="para">
   This function complements <span class="function"><a href="intlchar.getpropertyname.php" class="function">IntlChar::getPropertyName()</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.getpropertyenum-returnvalues">
  ...
  <p class="para">
   Returns an <code class="literal">IntlChar::PROPERTY_</code> constant value,
   or <strong><code><a href="class.intlchar.php#intlchar.constants.property-invalid-code">IntlChar::PROPERTY_INVALID_CODE</a></code></strong> if the given name does not match any property.
  </p>
 </div>
...
bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-intlchar.getpropertyenum-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="intlchar.getpropertyname.php" class="function" rel="rdfs-seeAlso">IntlChar::getPropertyName()</a> - Get the Unicode name for a property</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/getpropertyenum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.getpropertyenum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.getpropertyenum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.getpropertyenum.php">＋<small>add a note</small></a></span>
