...
<head>
  ...
  <title>PHP: imap_scan - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-scan.php">
 <link rel="shorturl" href="https://www.php.net/imap-scan">
 <link rel="alternate" href="https://www.php.net/imap-scan" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-savebody.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-scanmailbox.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-scan.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-scan.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-scan.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-scan.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-scan.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-scan.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-scan.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-scan.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-scan.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-scan.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-scan.php" hreflang="zh">
...
<meta name="Description" content="Alias of imap_listscan" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_scan - Manual" />
<meta name="twitter:description" content="Alias of imap_listscan" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_scan - Manual" />
<meta itemprop="description" content="Alias of imap_listscan" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of imap_listscan" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-scanmailbox.php">
          imap_scanmailbox &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-savebody.php">
          &laquo; imap_savebody        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-scan.php' selected="selected">English</option>
            <option value='de/function.imap-scan.php'>German</option>
            <option value='es/function.imap-scan.php'>Spanish</option>
            <option value='fr/function.imap-scan.php'>French</option>
            <option value='it/function.imap-scan.php'>Italian</option>
            <option value='ja/function.imap-scan.php'>Japanese</option>
            <option value='pt_BR/function.imap-scan.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-scan.php'>Russian</option>
            <option value='tr/function.imap-scan.php'>Turkish</option>
            <option value='uk/function.imap-scan.php'>Ukrainian</option>
            <option value='zh/function.imap-scan.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-scan" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_scan</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_scan</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.imap-listscan.php" class="function">imap_listscan()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.imap-scan-description">
  ...
  <p class="simpara">
   ...
   <span class="function"><a href="function.imap-listscan.php" class="function">imap_listscan()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-scan.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-scan%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-scan&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-scan.php">＋<small>add a note</small></a></span>
