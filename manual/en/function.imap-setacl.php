...
<head>
  ...
  <title>PHP: imap_setacl - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-setacl.php">
 <link rel="shorturl" href="https://www.php.net/imap-setacl">
 <link rel="alternate" href="https://www.php.net/imap-setacl" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-set-quota.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-setflag-full.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-setacl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-setacl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-setacl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-setacl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-setacl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-setacl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-setacl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-setacl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-setacl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-setacl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-setacl.php" hreflang="zh">
...
<meta name="Description" content="Sets the ACL for a given mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_setacl - Manual" />
<meta name="twitter:description" content="Sets the ACL for a given mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_setacl - Manual" />
<meta itemprop="description" content="Sets the ACL for a given mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the ACL for a given mailbox" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-setflag-full.php">
          imap_setflag_full &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-set-quota.php">
          &laquo; imap_set_quota        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-setacl.php' selected="selected">English</option>
            <option value='de/function.imap-setacl.php'>German</option>
            <option value='es/function.imap-setacl.php'>Spanish</option>
            <option value='fr/function.imap-setacl.php'>French</option>
            <option value='it/function.imap-setacl.php'>Italian</option>
            <option value='ja/function.imap-setacl.php'>Japanese</option>
            <option value='pt_BR/function.imap-setacl.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-setacl.php'>Russian</option>
            <option value='tr/function.imap-setacl.php'>Turkish</option>
            <option value='uk/function.imap-setacl.php'>Ukrainian</option>
            <option value='zh/function.imap-setacl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-setacl" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_setacl</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.7, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_setacl</span> &mdash; <span class="dc-title">Sets the ACL for a given mailbox</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-setacl-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_setacl</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$mailbox</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$user_id</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$rights</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
<a href="imap.configuration.php#ini.imap.enable-insecure-rsh" class="link">imap.enable_insecure_rsh</a> is disabled.
     ...
     <dt><code class="parameter">rights</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imap-setacl-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-setacl-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-getacl.php" class="function" rel="rdfs-seeAlso">imap_getacl()</a> - Gets the ACL for a given mailbox</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-setacl.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-setacl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-setacl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-setacl.php">＋<small>add a note</small></a></span>
