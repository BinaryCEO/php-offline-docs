...
<head>
  ...
  <title>PHP: Imagick::getImageTicksPerSecond - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagetickspersecond.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagetickspersecond.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagetickspersecond.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagesize.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagetotalinkdensity.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagetickspersecond.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagetickspersecond.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagetickspersecond.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagetickspersecond.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagetickspersecond.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagetickspersecond.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagetickspersecond.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagetickspersecond.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagetickspersecond.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagetickspersecond.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagetickspersecond.php" hreflang="zh">
...
<meta name="Description" content="Gets the image ticks-per-second" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageTicksPerSecond - Manual" />
<meta name="twitter:description" content="Gets the image ticks-per-second" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageTicksPerSecond - Manual" />
<meta itemprop="description" content="Gets the image ticks-per-second" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image ticks-per-second" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagetotalinkdensity.php">
          Imagick::getImageTotalInkDensity &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagesize.php">
          &laquo; Imagick::getImageSize        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagetickspersecond.php' selected="selected">English</option>
            <option value='de/imagick.getimagetickspersecond.php'>German</option>
            <option value='es/imagick.getimagetickspersecond.php'>Spanish</option>
            <option value='fr/imagick.getimagetickspersecond.php'>French</option>
            <option value='it/imagick.getimagetickspersecond.php'>Italian</option>
            <option value='ja/imagick.getimagetickspersecond.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagetickspersecond.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagetickspersecond.php'>Russian</option>
            <option value='tr/imagick.getimagetickspersecond.php'>Turkish</option>
            <option value='uk/imagick.getimagetickspersecond.php'>Ukrainian</option>
            <option value='zh/imagick.getimagetickspersecond.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagetickspersecond" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageTicksPerSecond</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageTicksPerSecond</span> &mdash; <span class="dc-title">Gets the image ticks-per-second</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagetickspersecond-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageTicksPerSecond</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagetickspersecond-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagetickspersecond-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagetickspersecond-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagetickspersecond.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagetickspersecond%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagetickspersecond&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagetickspersecond.php">＋<small>add a note</small></a></span>
