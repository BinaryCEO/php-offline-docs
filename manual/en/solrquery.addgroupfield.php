...
<head>
  ...
  <title>PHP: SolrQuery::addGroupField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addgroupfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addgroupfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addgroupfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addfilterquery.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addgroupfunction.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addgroupfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addgroupfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addgroupfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addgroupfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addgroupfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addgroupfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addgroupfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addgroupfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addgroupfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addgroupfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addgroupfield.php" hreflang="zh">
...
<meta name="Description" content="Add a field to be used to group results" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addGroupField - Manual" />
<meta name="twitter:description" content="Add a field to be used to group results" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addGroupField - Manual" />
<meta itemprop="description" content="Add a field to be used to group results" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add a field to be used to group results" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.addgroupfunction.php">
          SolrQuery::addGroupFunction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addfilterquery.php">
          &laquo; SolrQuery::addFilterQuery        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addgroupfield.php' selected="selected">English</option>
            <option value='de/solrquery.addgroupfield.php'>German</option>
            <option value='es/solrquery.addgroupfield.php'>Spanish</option>
            <option value='fr/solrquery.addgroupfield.php'>French</option>
            <option value='it/solrquery.addgroupfield.php'>Italian</option>
            <option value='ja/solrquery.addgroupfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.addgroupfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addgroupfield.php'>Russian</option>
            <option value='tr/solrquery.addgroupfield.php'>Turkish</option>
            <option value='uk/solrquery.addgroupfield.php'>Ukrainian</option>
            <option value='zh/solrquery.addgroupfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addgroupfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addGroupField</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::addGroupField</span> &mdash; <span class="dc-title">Add a field to be used to group results</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addgroupfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addGroupField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
  ...
  <p class="para rdfs-comment">
    ...
    Uses group.field parameter
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-solrquery.addgroupfield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addgroupfield-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.addgroupfield-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.setgroupcachepercent.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupCachePercent()</a> - Enables caching for result grouping</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addgroupfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addgroupfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addgroupfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addgroupfield.php">＋<small>add a note</small></a></span>
