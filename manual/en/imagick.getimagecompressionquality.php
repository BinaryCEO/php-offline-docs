...
<head>
  ...
  <title>PHP: Imagick::getImageCompressionQuality - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagecompressionquality.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagecompressionquality.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagecompressionquality.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagecompression.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagedelay.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagecompressionquality.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagecompressionquality.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagecompressionquality.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagecompressionquality.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagecompressionquality.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagecompressionquality.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagecompressionquality.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagecompressionquality.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagecompressionquality.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagecompressionquality.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagecompressionquality.php" hreflang="zh">
...
<meta name="Description" content="Gets the current image's compression quality" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageCompressionQuality - Manual" />
<meta name="twitter:description" content="Gets the current image's compression quality" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageCompressionQuality - Manual" />
<meta itemprop="description" content="Gets the current image's compression quality" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the current image's compression quality" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagedelay.php">
          Imagick::getImageDelay &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagecompression.php">
          &laquo; Imagick::getImageCompression        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagecompressionquality.php' selected="selected">English</option>
            <option value='de/imagick.getimagecompressionquality.php'>German</option>
            <option value='es/imagick.getimagecompressionquality.php'>Spanish</option>
            <option value='fr/imagick.getimagecompressionquality.php'>French</option>
            <option value='it/imagick.getimagecompressionquality.php'>Italian</option>
            <option value='ja/imagick.getimagecompressionquality.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagecompressionquality.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagecompressionquality.php'>Russian</option>
            <option value='tr/imagick.getimagecompressionquality.php'>Turkish</option>
            <option value='uk/imagick.getimagecompressionquality.php'>Ukrainian</option>
            <option value='zh/imagick.getimagecompressionquality.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagecompressionquality" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageCompressionQuality</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.2.2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageCompressionQuality</span> &mdash; <span class="dc-title">Gets the current image&#039;s compression quality</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagecompressionquality-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageCompressionQuality</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagecompressionquality-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagecompressionquality-returnvalues">
  ...
  <p class="para">
   Returns integer describing the images compression quality
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagecompressionquality.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagecompressionquality%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagecompressionquality&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagecompressionquality.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125007">  <div class="votes">
    <div id="Vu125007">
    <a href="/manual/vote-note.php?id=125007&amp;page=imagick.getimagecompressionquality&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125007">
    <a href="/manual/vote-note.php?id=125007&amp;page=imagick.getimagecompressionquality&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125007" title="50% like this...">
    0
    </div>
  </div>
  <a href="#125007" class="name">
  <strong class="user"><em>sNniffer</em></strong></a><a class="genanchor" href="#125007"> &para;</a><div class="date" title="2020-05-14 03:13"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125007">
<div class="phpcode"><code><span class="html">using<br /><br />    $img = new Imagick();<br />    $img-&gt;readImage( $local_da_imagem );<br />    print_r( $img-&gt;getImageCompressionQuality() );</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagecompressionquality&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagecompressionquality.php">＋<small>add a note</small></a></div>
