...
<head>
  ...
  <title>PHP: UI\Controls\Button - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-controls-button.php">
 <link rel="shorturl" href="https://www.php.net/ui-controls-button">
 <link rel="alternate" href="https://www.php.net/ui-controls-button" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-controls-check.settext.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-controls-button.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-controls-button.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-controls-button.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-controls-button.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-controls-button.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-controls-button.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-controls-button.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-controls-button.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-controls-button.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-controls-button.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-controls-button.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-controls-button.php" hreflang="zh">
...
<meta name="Description" content="Button Control" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Controls\Button - Manual" />
<meta name="twitter:description" content="Button Control" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Controls\Button - Manual" />
<meta itemprop="description" content="Button Control" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Button Control" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ui-controls-button.construct.php">
          UI\Controls\Button::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-controls-check.settext.php">
          &laquo; UI\Controls\Check::setText        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-controls-button.php' selected="selected">English</option>
            <option value='de/class.ui-controls-button.php'>German</option>
            <option value='es/class.ui-controls-button.php'>Spanish</option>
            <option value='fr/class.ui-controls-button.php'>French</option>
            <option value='it/class.ui-controls-button.php'>Italian</option>
            <option value='ja/class.ui-controls-button.php'>Japanese</option>
            <option value='pt_BR/class.ui-controls-button.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-controls-button.php'>Russian</option>
            <option value='tr/class.ui-controls-button.php'>Turkish</option>
            <option value='uk/class.ui-controls-button.php'>Ukrainian</option>
            <option value='zh/class.ui-controls-button.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-controls-button" class="reference">

 <h1 class="title">Button Control</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-controls-button.intro">
  ...
  <div class="section" id="ui-controls-button.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Controls\Button</strong>
     </span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="ui-controls-button.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$text</code></span>)</div>
    

    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-button.gettext.php" class="methodname">getText</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">protected</span> <span class="methodname"><a href="ui-controls-button.onclick.php" class="methodname">onClick</a></span>()</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-button.settext.php" class="methodname">setText</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$text</code></span>)</div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-controls-button.construct.php">UI\Controls\Button::__construct</a> — Construct a new Button</li><li><a href="ui-controls-button.gettext.php">UI\Controls\Button::getText</a> — Get Text</li><li><a href="ui-controls-button.onclick.php">UI\Controls\Button::onClick</a> — Click Handler</li><li><a href="ui-controls-button.settext.php">UI\Controls\Button::setText</a> — Set Text</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.controls.button.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-controls-button%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-controls-button&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-controls-button.php">＋<small>add a note</small></a></span>
