...
<head>
  ...
  <title>PHP: ImagickDraw::getStrokeLineCap - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getstrokelinecap.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getstrokelinecap.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokelinecap.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getstrokedashoffset.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getstrokelinejoin.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokelinecap.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getstrokelinecap.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getstrokelinecap.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getstrokelinecap.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getstrokelinecap.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getstrokelinecap.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getstrokelinecap.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getstrokelinecap.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getstrokelinecap.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getstrokelinecap.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getstrokelinecap.php" hreflang="zh">
...
<meta name="Description" content="Returns the shape to be used at the end of open subpaths when they are stroked" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getStrokeLineCap - Manual" />
<meta name="twitter:description" content="Returns the shape to be used at the end of open subpaths when they are stroked" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getStrokeLineCap - Manual" />
<meta itemprop="description" content="Returns the shape to be used at the end of open subpaths when they are stroked" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the shape to be used at the end of open subpaths when they are stroked" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.getstrokelinejoin.php">
          ImagickDraw::getStrokeLineJoin &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getstrokedashoffset.php">
          &laquo; ImagickDraw::getStrokeDashOffset        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getstrokelinecap.php' selected="selected">English</option>
            <option value='de/imagickdraw.getstrokelinecap.php'>German</option>
            <option value='es/imagickdraw.getstrokelinecap.php'>Spanish</option>
            <option value='fr/imagickdraw.getstrokelinecap.php'>French</option>
            <option value='it/imagickdraw.getstrokelinecap.php'>Italian</option>
            <option value='ja/imagickdraw.getstrokelinecap.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getstrokelinecap.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getstrokelinecap.php'>Russian</option>
            <option value='tr/imagickdraw.getstrokelinecap.php'>Turkish</option>
            <option value='uk/imagickdraw.getstrokelinecap.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getstrokelinecap.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getstrokelinecap" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getStrokeLineCap</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getStrokeLineCap</span> &mdash; <span class="dc-title">Returns the shape to be used at the end of open subpaths when they are stroked</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getstrokelinecap-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getStrokeLineCap</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getstrokelinecap-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a <a href="imagick.constants.php#imagick.constants.linecap" class="link">LINECAP</a> constant
   (<code class="literal">imagick::LINECAP_*</code>), or 0 if stroke linecap is not set.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getstrokelinecap.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getstrokelinecap%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getstrokelinecap&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getstrokelinecap.php">＋<small>add a note</small></a></span>
