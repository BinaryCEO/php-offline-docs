...
<head>
  ...
  <title>PHP: Imagick::opaquePaintImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.opaquepaintimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.opaquepaintimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.opaquepaintimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.oilpaintimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.optimizeimagelayers.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.opaquepaintimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.opaquepaintimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.opaquepaintimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.opaquepaintimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.opaquepaintimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.opaquepaintimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.opaquepaintimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.opaquepaintimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.opaquepaintimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.opaquepaintimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.opaquepaintimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::opaquePaintImage - Manual" />
<meta name="twitter:description" content="Changes the color value of any pixel that matches target" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::opaquePaintImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.optimizeimagelayers.php">
          Imagick::optimizeImageLayers &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.oilpaintimage.php">
          &laquo; Imagick::oilPaintImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.opaquepaintimage.php' selected="selected">English</option>
            <option value='de/imagick.opaquepaintimage.php'>German</option>
            <option value='es/imagick.opaquepaintimage.php'>Spanish</option>
            <option value='fr/imagick.opaquepaintimage.php'>French</option>
            <option value='it/imagick.opaquepaintimage.php'>Italian</option>
            <option value='ja/imagick.opaquepaintimage.php'>Japanese</option>
            <option value='pt_BR/imagick.opaquepaintimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.opaquepaintimage.php'>Russian</option>
            <option value='tr/imagick.opaquepaintimage.php'>Turkish</option>
            <option value='uk/imagick.opaquepaintimage.php'>Ukrainian</option>
            <option value='zh/imagick.opaquepaintimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.opaquepaintimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::opaquePaintImage</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::opaquePaintImage</span> &mdash; <span class="dc-title">Changes the color value of any pixel that matches target</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.opaquepaintimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::opaquePaintImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$target</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fill</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$fuzz</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$invert</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/opaquepaintimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.opaquepaintimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.opaquepaintimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.opaquepaintimage.php">＋<small>add a note</small></a></span>
