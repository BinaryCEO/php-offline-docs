...
<head>
  ...
  <title>PHP: mysql_fetch_lengths - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-fetch-lengths.php">
 <link rel="shorturl" href="https://www.php.net/mysql-fetch-lengths">
 <link rel="alternate" href="https://www.php.net/mysql-fetch-lengths" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-fetch-field.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-fetch-object.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-fetch-lengths.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-fetch-lengths.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-fetch-lengths.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-fetch-lengths.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-fetch-lengths.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-fetch-lengths.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-fetch-lengths.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-fetch-lengths.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-fetch-lengths.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-fetch-lengths.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-fetch-lengths.php" hreflang="zh">
...
<meta name="Description" content="Get the length of each output in a result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_fetch_lengths - Manual" />
<meta name="twitter:description" content="Get the length of each output in a result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_fetch_lengths - Manual" />
<meta itemprop="description" content="Get the length of each output in a result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the length of each output in a result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-fetch-object.php">
          mysql_fetch_object &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-fetch-field.php">
          &laquo; mysql_fetch_field        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-fetch-lengths.php' selected="selected">English</option>
            <option value='de/function.mysql-fetch-lengths.php'>German</option>
            <option value='es/function.mysql-fetch-lengths.php'>Spanish</option>
            <option value='fr/function.mysql-fetch-lengths.php'>French</option>
            <option value='it/function.mysql-fetch-lengths.php'>Italian</option>
            <option value='ja/function.mysql-fetch-lengths.php'>Japanese</option>
            <option value='pt_BR/function.mysql-fetch-lengths.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-fetch-lengths.php'>Russian</option>
            <option value='tr/function.mysql-fetch-lengths.php'>Turkish</option>
            <option value='uk/function.mysql-fetch-lengths.php'>Ukrainian</option>
            <option value='zh/function.mysql-fetch-lengths.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-fetch-lengths" class="refentry">
 ...
 <div id="function.mysql-fetch-lengths-refsynopsisdiv">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli-result.lengths.php" class="function">mysqli_fetch_lengths()</a></span></li>
    <li><span class="methodname"><a href="pdostatement.getcolumnmeta.php" class="methodname">PDOStatement::getColumnMeta()</a></span></li>
   </ul>
  </div>
 </div>

 <div class="refsect1 description" id="refsect1-function.mysql-fetch-lengths-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_fetch_lengths</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  <p class="para">
   <span class="function"><strong>mysql_fetch_lengths()</strong></span> stores the lengths of
   ...
   <span class="function"><a href="function.mysql-fetch-array.php" class="function">mysql_fetch_array()</a></span>, and
   <span class="function"><a href="function.mysql-fetch-object.php" class="function">mysql_fetch_object()</a></span> in an array, starting at
   offset 0.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.mysql-fetch-lengths-parameters">
...
<span class="function"><a href="function.mysql-query.php" class="function">mysql_query()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-fetch-lengths-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   An <span class="type"><a href="language.types.array.php" class="type array">array</a></span> of lengths on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.mysql-fetch-lengths-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1895">
    <p><strong>Example #1 A <span class="function"><strong>mysql_fetch_lengths()</strong></span> example</strong></p>
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.mysql-fetch-lengths-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.mysql-field-len.php" class="function" rel="rdfs-seeAlso">mysql_field_len()</a> - Returns the length of the specified field</span></li>
    ...
    <li><span class="function"><a href="function.strlen.php" class="function" rel="rdfs-seeAlso">strlen()</a> - Get string length</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-fetch-lengths.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-fetch-lengths%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-fetch-lengths&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-fetch-lengths.php">＋<small>add a note</small></a></span>
