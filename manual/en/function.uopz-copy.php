...
<head>
  ...
  <title>PHP: uopz_copy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.uopz-copy.php">
 <link rel="shorturl" href="https://www.php.net/uopz-copy">
 <link rel="alternate" href="https://www.php.net/uopz-copy" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uopz.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.uopz-compose.php">
 <link rel="next" href="https://www.php.net/manual/en/function.uopz-del-function.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.uopz-copy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.uopz-copy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.uopz-copy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.uopz-copy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.uopz-copy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.uopz-copy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.uopz-copy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.uopz-copy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.uopz-copy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.uopz-copy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.uopz-copy.php" hreflang="zh">
...
<meta name="Description" content="Copy a function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: uopz_copy - Manual" />
<meta name="twitter:description" content="Copy a function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: uopz_copy - Manual" />
<meta itemprop="description" content="Copy a function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Copy a function" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.uopz-del-function.php">
          uopz_del_function &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.uopz-compose.php">
          &laquo; uopz_compose        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.uopz-copy.php' selected="selected">English</option>
            <option value='de/function.uopz-copy.php'>German</option>
            <option value='es/function.uopz-copy.php'>Spanish</option>
            <option value='fr/function.uopz-copy.php'>French</option>
            <option value='it/function.uopz-copy.php'>Italian</option>
            <option value='ja/function.uopz-copy.php'>Japanese</option>
            <option value='pt_BR/function.uopz-copy.php'>Brazilian Portuguese</option>
            <option value='ru/function.uopz-copy.php'>Russian</option>
            <option value='tr/function.uopz-copy.php'>Turkish</option>
            <option value='uk/function.uopz-copy.php'>Ukrainian</option>
            <option value='zh/function.uopz-copy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.uopz-copy" class="refentry">
...
<div class="examplescode"><pre class="examplescode">string(5) &quot;dummy&quot;</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uopz/functions/uopz-copy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.uopz-copy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.uopz-copy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.uopz-copy.php">＋<small>add a note</small></a></span>
