...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.ldap.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.ldap.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.ldap.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.ldap.php">
 <link rel="next" href="https://www.php.net/manual/en/ldap.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.ldap.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.ldap.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.ldap.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.ldap.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.ldap.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.ldap.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.ldap.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.ldap.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.ldap.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.ldap.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.ldap.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.ldap.php' selected="selected">English</option>
            <option value='de/intro.ldap.php'>German</option>
            <option value='es/intro.ldap.php'>Spanish</option>
            <option value='fr/intro.ldap.php'>French</option>
            <option value='it/intro.ldap.php'>Italian</option>
            <option value='ja/intro.ldap.php'>Japanese</option>
            <option value='pt_BR/intro.ldap.php'>Brazilian Portuguese</option>
            <option value='ru/intro.ldap.php'>Russian</option>
            <option value='tr/intro.ldap.php'>Turkish</option>
            <option value='uk/intro.ldap.php'>Ukrainian</option>
            <option value='zh/intro.ldap.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.ldap" class="preface">
  ...
  <p class="para">
   ...
   HTML format.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.ldap%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.ldap&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.ldap.php">＋<small>add a note</small></a></span>
