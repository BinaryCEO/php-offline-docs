...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-rollback.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-restore.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-rollback-ret.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-rollback.php' selected="selected">English</option>
            <option value='de/function.ibase-rollback.php'>German</option>
            <option value='es/function.ibase-rollback.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_rollback</span> &mdash; <span class="dc-title">Roll back a transaction</span></p>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-rollback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-rollback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-rollback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-rollback.php">＋<small>add a note</small></a></span>
