...
<head>
  ...
  <title>PHP: Gmagick::getimagewhitepoint - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagewhitepoint.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagewhitepoint.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagewhitepoint.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimageunits.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagewidth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagewhitepoint.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagewhitepoint.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagewhitepoint.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagewhitepoint.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagewhitepoint.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagewhitepoint.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagewhitepoint.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagewhitepoint.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagewhitepoint.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagewhitepoint.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagewhitepoint.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimagewhitepoint - Manual" />
<meta name="twitter:description" content="Returns the chromaticity white point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagewhitepoint - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.getimagewidth.php">
          Gmagick::getimagewidth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimageunits.php">
          &laquo; Gmagick::getimageunits        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagewhitepoint.php' selected="selected">English</option>
            <option value='de/gmagick.getimagewhitepoint.php'>German</option>
            <option value='es/gmagick.getimagewhitepoint.php'>Spanish</option>
            <option value='fr/gmagick.getimagewhitepoint.php'>French</option>
            <option value='it/gmagick.getimagewhitepoint.php'>Italian</option>
            <option value='ja/gmagick.getimagewhitepoint.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagewhitepoint.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagewhitepoint.php'>Russian</option>
            <option value='tr/gmagick.getimagewhitepoint.php'>Turkish</option>
            <option value='uk/gmagick.getimagewhitepoint.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagewhitepoint.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagewhitepoint" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagewhitepoint</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagewhitepoint</span> &mdash; <span class="dc-title">Returns the chromaticity white point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagewhitepoint-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagewhitepoint</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagewhitepoint-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagewhitepoint-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagewhitepoint-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagewhitepoint.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagewhitepoint%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagewhitepoint&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagewhitepoint.php">＋<small>add a note</small></a></span>
