...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/yaf.setup.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/yaf.setup.php">
 <link rel="alternate" href="https://www.php.net/manual/en/yaf.setup.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.yaf.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.yaf.php">
 <link rel="next" href="https://www.php.net/manual/en/yaf.installation.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/yaf.setup.php' selected="selected">English</option>
            <option value='de/yaf.setup.php'>German</option>
            <option value='es/yaf.setup.php'>Spanish</option>
            <option value='fr/yaf.setup.php'>French</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="yaf.installation.php">Installation</a></li><li><a href="yaf.configuration.php">Runtime Configuration</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fyaf.setup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=yaf.setup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/yaf.setup.php">＋<small>add a note</small></a></span>
