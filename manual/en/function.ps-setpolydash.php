...
<head>
  ...
  <title>PHP: ps_setpolydash - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-setpolydash.php">
 <link rel="shorturl" href="https://www.php.net/ps-setpolydash">
 <link rel="alternate" href="https://www.php.net/ps-setpolydash" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-setoverprintmode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-shading.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-setpolydash.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-setpolydash.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-setpolydash.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-setpolydash.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-setpolydash.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-setpolydash.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-setpolydash.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-setpolydash.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-setpolydash.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-setpolydash.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-setpolydash.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ps_setpolydash - Manual" />
<meta name="twitter:description" content="Sets appearance of a dashed line" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_setpolydash - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-setpolydash.php' selected="selected">English</option>
            <option value='de/function.ps-setpolydash.php'>German</option>
            <option value='es/function.ps-setpolydash.php'>Spanish</option>
            <option value='fr/function.ps-setpolydash.php'>French</option>
            <option value='it/function.ps-setpolydash.php'>Italian</option>
            <option value='ja/function.ps-setpolydash.php'>Japanese</option>
            <option value='pt_BR/function.ps-setpolydash.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-setpolydash.php'>Russian</option>
            <option value='tr/function.ps-setpolydash.php'>Turkish</option>
            <option value='uk/function.ps-setpolydash.php'>Ukrainian</option>
            <option value='zh/function.ps-setpolydash.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-setpolydash" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-setdash.php" class="function" rel="rdfs-seeAlso">ps_setdash()</a> - Sets appearance of a dashed line</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-setpolydash.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-setpolydash%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-setpolydash&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-setpolydash.php">＋<small>add a note</small></a></span>
