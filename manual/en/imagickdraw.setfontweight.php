...
<head>
  ...
  <title>PHP: ImagickDraw::setFontWeight - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setfontweight.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setfontweight.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfontweight.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setfontstyle.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setgravity.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfontweight.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setfontweight.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setfontweight.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setfontweight.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setfontweight.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setfontweight.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setfontweight.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setfontweight.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setfontweight.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setfontweight.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setfontweight.php" hreflang="zh">
...
<meta name="Description" content="Sets the font weight" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setFontWeight - Manual" />
<meta name="twitter:description" content="Sets the font weight" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setFontWeight - Manual" />
<meta itemprop="description" content="Sets the font weight" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the font weight" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.setgravity.php">
          ImagickDraw::setGravity &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setfontstyle.php">
          &laquo; ImagickDraw::setFontStyle        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setfontweight.php' selected="selected">English</option>
            <option value='de/imagickdraw.setfontweight.php'>German</option>
            <option value='es/imagickdraw.setfontweight.php'>Spanish</option>
            <option value='fr/imagickdraw.setfontweight.php'>French</option>
            <option value='it/imagickdraw.setfontweight.php'>Italian</option>
            <option value='ja/imagickdraw.setfontweight.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setfontweight.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setfontweight.php'>Russian</option>
            <option value='tr/imagickdraw.setfontweight.php'>Turkish</option>
            <option value='uk/imagickdraw.setfontweight.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setfontweight.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setfontweight" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setFontWeight</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setFontWeight</span> &mdash; <span class="dc-title">Sets the font weight</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setfontweight-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setFontWeight</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$weight</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setfontweight-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setfontweight-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3179">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setfontweight.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setfontweight%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setfontweight&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfontweight.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="91121">  <div class="votes">
    <div id="Vu91121">
    <a href="/manual/vote-note.php?id=91121&amp;page=imagickdraw.setfontweight&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91121">
    <a href="/manual/vote-note.php?id=91121&amp;page=imagickdraw.setfontweight&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91121" title="55% like this...">
    1
    </div>
  </div>
  <a href="#91121" class="name">
  <strong class="user"><em>skmanji at manji dot org</em></strong></a><a class="genanchor" href="#91121"> &para;</a><div class="date" title="2009-05-26 05:15"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91121">
<div class="phpcode"><code><span class="html">Valid Range 100-900. I found that any value 551 and above would give me bold.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.setfontweight&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfontweight.php">＋<small>add a note</small></a></div>
