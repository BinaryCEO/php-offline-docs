...
<head>
  ...
  <title>PHP: Imagick::setImageColorspace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagecolorspace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagecolorspace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagecolorspace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagecolormapcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagecompose.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagecolorspace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagecolorspace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagecolorspace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagecolorspace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagecolorspace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagecolorspace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagecolorspace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagecolorspace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagecolorspace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagecolorspace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagecolorspace.php" hreflang="zh">
...
<meta name="Description" content="Sets the image colorspace" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageColorspace - Manual" />
<meta name="twitter:description" content="Sets the image colorspace" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageColorspace - Manual" />
<meta itemprop="description" content="Sets the image colorspace" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image colorspace" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimagecompose.php">
          Imagick::setImageCompose &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagecolormapcolor.php">
          &laquo; Imagick::setImageColormapColor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagecolorspace.php' selected="selected">English</option>
            <option value='de/imagick.setimagecolorspace.php'>German</option>
            <option value='es/imagick.setimagecolorspace.php'>Spanish</option>
            <option value='fr/imagick.setimagecolorspace.php'>French</option>
            <option value='it/imagick.setimagecolorspace.php'>Italian</option>
            <option value='ja/imagick.setimagecolorspace.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagecolorspace.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagecolorspace.php'>Russian</option>
            <option value='tr/imagick.setimagecolorspace.php'>Turkish</option>
            <option value='uk/imagick.setimagecolorspace.php'>Ukrainian</option>
            <option value='zh/imagick.setimagecolorspace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagecolorspace" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageColorspace</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageColorspace</span> &mdash; <span class="dc-title">Sets the image colorspace</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.setimagecolorspace-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageColorspace</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$colorspace</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Sets the image colorspace. This method should be used when creating new images. To change the colorspace of an existing image, you should use <span class="methodname"><a href="imagick.transformimagecolorspace.php" class="methodname">Imagick::transformImageColorspace()</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagecolorspace-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
        One of the <a href="imagick.constants.php#imagick.constants.colorspace" class="link">COLORSPACE constants</a>
      </p>
     </dd>
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagecolorspace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagecolorspace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagecolorspace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagecolorspace.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">8 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116565">  <div class="votes">
    <div id="Vu116565">
    <a href="/manual/vote-note.php?id=116565&amp;page=imagick.setimagecolorspace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116565">
    <a href="/manual/vote-note.php?id=116565&amp;page=imagick.setimagecolorspace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116565" title="80% like this...">
    9
    </div>
  </div>
  <a href="#116565" class="name">
  <strong class="user"><em>pilot114 at bk dot ru</em></strong></a><a class="genanchor" href="#116565"> &para;</a><div class="date" title="2015-01-22 01:58"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116565">
<div class="phpcode"><code><span class="html">Simlest way converting from CMYK to RGB:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">if (</span><span class="default">$jpeg</span><span class="keyword">-&gt;</span><span class="default">getImageColorspace</span><span class="keyword">() == </span><span class="default">\Imagick</span><span class="keyword">::</span><span class="default">COLORSPACE_CMYK</span><span class="keyword">) {<br />    </span><span class="default">$jpeg</span><span class="keyword">-&gt;</span><span class="default">transformimagecolorspace</span><span class="keyword">(</span><span class="default">\Imagick</span><span class="keyword">::</span><span class="default">COLORSPACE_SRGB</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;<br /></span><br />It is pretty work in current stable Image Magick (6.9.0-4).</span></code></div>
  </div>
 </div>
  <div class="note" id="107716">  <div class="votes">
    <div id="Vu107716">
    <a href="/manual/vote-note.php?id=107716&amp;page=imagick.setimagecolorspace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd107716">
    <a href="/manual/vote-note.php?id=107716&amp;page=imagick.setimagecolorspace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V107716" title="67% like this...">
    12
    </div>
  </div>
  <a href="#107716" class="name">
  <strong class="user"><em>eth at ethaniel dot com</em></strong></a><a class="genanchor" href="#107716"> &para;</a><div class="date" title="2012-02-28 06:15"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom107716">
<div class="phpcode"><code><span class="html">When converting from CMYK to RGB using this function, the image can become inverted. To fix this, use a workaround (don't forget to download the .icc files online): 
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="85981">  <div class="votes">
    <div id="Vu85981">
    <a href="/manual/vote-note.php?id=85981&amp;page=imagick.setimagecolorspace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd85981">
    <a href="/manual/vote-note.php?id=85981&amp;page=imagick.setimagecolorspace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V85981" title="72% like this...">
    5
    </div>
  </div>
  <a href="#85981" class="name">
  <strong class="user"><em>jdstraughan dot com at gmail dot com</em></strong></a><a class="genanchor" href="#85981"> &para;</a><div class="date" title="2008-09-26 12:16"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom85981">
<div class="phpcode"><code><span class="html">FYI, here is the breakdown for (int $colorspace):<br /><br />Constants:<br />0 - UndefinedColorspace    <br />1 - RGBColorspace    <br />2 - GRAYColorspace    <br />3 - TransparentColorspace    <br />4 - OHTAColorspace    <br />5 - LABColorspace    <br />6 - XYZColorspace    <br />7 - YCbCrColorspace    <br />8 - YCCColorspace    <br />9 - YIQColorspace    <br />10 - YPbPrColorspace    <br />11 - YUVColorspace    <br />12 - CMYKColorspace    <br />13 - sRGBColorspace    <br />14 - HSBColorspace    <br />15 - HSLColorspace    <br />16 - HWBColorspace</span></code></div>
  </div>
 </div>
  <div class="note" id="112426">  <div class="votes">
    <div id="Vu112426">
    <a href="/manual/vote-note.php?id=112426&amp;page=imagick.setimagecolorspace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112426">
    <a href="/manual/vote-note.php?id=112426&amp;page=imagick.setimagecolorspace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112426" title="57% like this...">
    1
    </div>
  </div>
  <a href="#112426" class="name">
  <strong class="user"><em>kevin.a.florida</em></strong></a><a class="genanchor" href="#112426"> &para;</a><div class="date" title="2013-06-15 03:53"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112426">
<div class="phpcode"><code><span class="html">I have a better solution for solving inverted colors on php 5.3.x than posted.  All the other solutions I found darkens the image or messes with the colors.<br /><br />See below (note: my imagick object is $jpeg)<br /><br />$range = $jpeg-&gt;getQuantumRange();<br />            $php_vs_arr = preg_split("/\./", phpversion());<br />            $php_vs = $php_vs_arr[0] . '.' . $php_vs_arr[1];<br />            if ($jpeg-&gt;getImageColorspace() == Imagick::COLORSPACE_CMYK) {<br />                    <br />                //make sure cmyk color-space is set correctly<br />                $jpeg-&gt;setImageColorspace(12);<br />                    <br />                // then we add an RGB profile<br />                $icc_rgb = file_get_contents(FRAMEWORK_PATH . DS . 'color' . DS . 'AdobeRGB1998.icc');<br />                $jpeg-&gt;profileImage('icc', $icc_rgb);<br />                unset($icc_rgb);<br />                    <br />                //set color space to rgb<br />                $jpeg-&gt;setImageColorspace(13);<br />            <br />                //fix gamma, hue, saturation, brightness<br />                if($php_vs &lt; 5.3) {<br />                    //ADJUST GAMMA BY 20% for 5.2.x<br />                    $jpeg-&gt;levelImage(0, 2.0, $range['quantumRangeString']);<br />                } else {<br />                    //php 5.3 hack FOR INVERTED COLORS<br />                    $jpeg-&gt;negateImage(false, Imagick::CHANNEL_ALL);<br />                }<br />                    <br />            }<br />            $jpeg-&gt;stripImage();<br />            //end convert to RGB=========================|</span></code></div>
  </div>
 </div>
  <div class="note" id="121977">  <div class="votes">
    <div id="Vu121977">
    <a href="/manual/vote-note.php?id=121977&amp;page=imagick.setimagecolorspace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121977">
    <a href="/manual/vote-note.php?id=121977&amp;page=imagick.setimagecolorspace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121977" title="50% like this...">
    0
    </div>
  </div>
  <a href="#121977" class="name">
  <strong class="user"><em>Cesare Bordi</em></strong></a><a class="genanchor" href="#121977"> &para;</a><div class="date" title="2017-12-05 08:27"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121977">
<div class="phpcode"><code><span class="html">These are the basic steps to convert an image from RGB to CMYK:<br /><br />$image = new Imagick();<br />$image-&gt;readImage(rgb.jpg);<br />$image-&gt;setImageColorSpace(Imagick::COLORSPACE_CMYK);<br />$image-&gt;profileImage('icc', file_get_contents(/path/CoatedFOGRA27.icc'));<br />$image-&gt;negateImage(FALSE, imagick::COLOR_CYAN);<br />$image-&gt;negateImage(FALSE, imagick::COLOR_MAGENTA);<br />$image-&gt;negateImage(FALSE, imagick::COLOR_YELLOW);<br />$image-&gt;negateImage(FALSE, imagick::COLOR_BLACK);<br />$image-&gt;writeImage(cmyk.rgb);</span></code></div>
  </div>
 </div>
  <div class="note" id="98703">  <div class="votes">
    <div id="Vu98703">
    <a href="/manual/vote-note.php?id=98703&amp;page=imagick.setimagecolorspace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98703">
    <a href="/manual/vote-note.php?id=98703&amp;page=imagick.setimagecolorspace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98703" title="50% like this...">
    0
    </div>
  </div>
  <a href="#98703" class="name">
  <strong class="user"><em>mettedraq at gmail dot com</em></strong></a><a class="genanchor" href="#98703"> &para;</a><div class="date" title="2010-07-01 12:21"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98703">
<div class="phpcode"><code><span class="html">This is how to Monochrome a jpg [on Windows].. since I couldn't find it anywhere else.
<br />
<br /><span class="default">&lt;?php
<br />header</span><span class="keyword">(</span><span class="string">"Content-type: image/jpeg"</span><span class="keyword">);
<br />
<br /></span><span class="default">$IMagick </span><span class="keyword">= new </span><span class="default">IMagick</span><span class="keyword">(</span><span class="string">'c:\\testing\\fruit.jpg'</span><span class="keyword">);
<br /></span><span class="default">$IMagick</span><span class="keyword">-&gt;</span><span class="default">setImageColorSpace</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COLORSPACE_GRAY</span><span class="keyword">);
<br />
<br />echo </span><span class="default">$IMagick</span><span class="keyword">;
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="97769">  <div class="votes">
    <div id="Vu97769">
    <a href="/manual/vote-note.php?id=97769&amp;page=imagick.setimagecolorspace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd97769">
    <a href="/manual/vote-note.php?id=97769&amp;page=imagick.setimagecolorspace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V97769" title="no votes...">
    0
    </div>
  </div>
  <a href="#97769" class="name">
  <strong class="user"><em>charlie at midsouthhost dot com</em></strong></a><a class="genanchor" href="#97769"> &para;</a><div class="date" title="2010-05-06 09:45"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97769">
<div class="phpcode"><code><span class="html">If your getting strange/bad color rendering from a PDF, after trying the colorspace constants noted by jdstraughan, try other values outside that range.<br /><br />In one case for me only $image-&gt;setImageColorSpace(22) provided useful color. I have found posts elsewhere using values up to 255.</span></code></div>
  </div>
 </div>
  <div class="note" id="121976">  <div class="votes">
    <div id="Vu121976">
    <a href="/manual/vote-note.php?id=121976&amp;page=imagick.setimagecolorspace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121976">
    <a href="/manual/vote-note.php?id=121976&amp;page=imagick.setimagecolorspace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121976" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#121976" class="name">
  <strong class="user"><em>cesarebordi</em></strong></a><a class="genanchor" href="#121976"> &para;</a><div class="date" title="2017-12-05 08:26"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121976">
<div class="phpcode"><code><span class="html">These are the basic steps to convert an image from RGB to CMYK:<br /><br />$image = new Imagick();<br />$image-&gt;readImage(rgb.jpg);<br />$image-&gt;setImageColorSpace(Imagick::COLORSPACE_CMYK);<br />$image-&gt;profileImage('icc', file_get_contents(/path/CoatedFOGRA27.icc'));<br />$image-&gt;negateImage(FALSE, imagick::COLOR_CYAN);<br />$image-&gt;negateImage(FALSE, imagick::COLOR_MAGENTA);<br />$image-&gt;negateImage(FALSE, imagick::COLOR_YELLOW);<br />$image-&gt;negateImage(FALSE, imagick::COLOR_BLACK);<br />$image-&gt;writeImage(cmyk.rgb);<br /><br />For more information: <br /><a href="http://www.cesarebordi.it/imagemagick-php-convertire-rgb-to-cmyk-web-developer/" rel="nofollow" target="_blank">http://www.cesarebordi.it/imagemagick-php-convertire-rgb-to-cmyk-web-developer/</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimagecolorspace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagecolorspace.php">＋<small>add a note</small></a></div>
