...
<head>
  ...
  <title>PHP: eio_stat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-stat.php">
 <link rel="shorturl" href="https://www.php.net/eio-stat">
 <link rel="alternate" href="https://www.php.net/eio-stat" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-set-min-parallel.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-statvfs.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-stat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-stat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-stat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-stat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-stat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-stat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-stat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-stat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-stat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-stat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-stat.php" hreflang="zh">
...
<meta name="Description" content="Get file status" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_stat - Manual" />
<meta name="twitter:description" content="Get file status" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_stat - Manual" />
<meta itemprop="description" content="Get file status" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get file status" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.eio-statvfs.php">
          eio_statvfs &raquo;
              ...
              <div class="prev">
        <a href="function.eio-set-min-parallel.php">
          &laquo; eio_set_min_parallel        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-stat.php' selected="selected">English</option>
            <option value='de/function.eio-stat.php'>German</option>
            <option value='es/function.eio-stat.php'>Spanish</option>
            <option value='fr/function.eio-stat.php'>French</option>
            <option value='it/function.eio-stat.php'>Italian</option>
            <option value='ja/function.eio-stat.php'>Japanese</option>
            <option value='pt_BR/function.eio-stat.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-stat.php'>Russian</option>
            <option value='tr/function.eio-stat.php'>Turkish</option>
            <option value='uk/function.eio-stat.php'>Ukrainian</option>
            <option value='zh/function.eio-stat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-stat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_stat</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_stat</span> &mdash; <span class="dc-title">Get file status</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-stat-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_stat</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>eio_stat()</strong></span> returns file status information in
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-stat-parameters">
...
array(12) {
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-stat-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-lstat.php" class="function" rel="rdfs-seeAlso">eio_lstat()</a> - Get file status</span></li>
   <li><span class="function"><a href="function.eio-fstat.php" class="function" rel="rdfs-seeAlso">eio_fstat()</a> - Get file status</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-stat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-stat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-stat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-stat.php">＋<small>add a note</small></a></span>
