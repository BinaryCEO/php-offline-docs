...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.preg-quote.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.preg-match-all.php">
 <link rel="next" href="https://www.php.net/manual/en/function.preg-replace.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/ru/function.preg-quote.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.preg-quote.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.preg-quote.php" hreflang="uk">
...
<meta name="Description" content="Quote regular expression characters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: preg_quote - Manual" />
<meta name="twitter:description" content="Quote regular expression characters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: preg_quote - Manual" />
<meta itemprop="description" content="Quote regular expression characters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Quote regular expression characters" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.preg-quote.php' selected="selected">English</option>
            ...
            <option value='ru/function.preg-quote.php'>Russian</option>
            <option value='tr/function.preg-quote.php'>Turkish</option>
            <option value='uk/function.preg-quote.php'>Ukrainian</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.escapeshellcmd.php" class="function" rel="rdfs-seeAlso">escapeshellcmd()</a> - Escape shell metacharacters</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pcre/functions/preg-quote.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.preg-quote%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.preg-quote&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.preg-quote.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">6 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="80049">  <div class="votes">
    <div id="Vu80049">
    <a href="/manual/vote-note.php?id=80049&amp;page=function.preg-quote&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd80049">
    <a href="/manual/vote-note.php?id=80049&amp;page=function.preg-quote&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V80049" title="79% like this...">
    76
    </div>
  </div>
  <a href="#80049" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#80049"> &para;</a><div class="date" title="2007-12-26 03:13"><strong>17 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">Wondering why your preg_replace fails, even if you have used preg_quote?<br /><br />Try adding the delimiter / - preg_quote($string, '/');</span></code></div>
  ...
  <div class="note" id="92350">  <div class="votes">
    <div id="Vu92350">
    <a href="/manual/vote-note.php?id=92350&amp;page=function.preg-quote&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92350">
    <a href="/manual/vote-note.php?id=92350&amp;page=function.preg-quote&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92350" title="68% like this...">
    16
    </div>
  </div>
  <a href="#92350" class="name">
  <strong class="user"><em>zooly</em></strong></a><a class="genanchor" href="#92350"> &para;</a><div class="date" title="2009-07-21 01:07"><strong>16 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">To escape characters with special meaning, like: .-[]() and so on, use \Q and \E.<br /><br />For example:<br /><br /><span class="default">&lt;?php </span><span class="keyword">echo ( </span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/^'</span><span class="keyword">.( </span><span class="default">$myvar </span><span class="keyword">= </span><span class="string">'te.t' </span><span class="keyword">).</span><span class="string">'$/i'</span><span class="keyword">, </span><span class="string">'test'</span><span class="keyword">) ? </span><span class="string">'match' </span><span class="keyword">: </span><span class="string">'nomatch' </span><span class="keyword">); </span><span class="default">?&gt;<br /></span><br />Will result in: match<br /><br />But:<br /><br /><span class="default">&lt;?php </span><span class="keyword">echo ( </span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/^\Q'</span><span class="keyword">.( </span><span class="default">$myvar </span><span class="keyword">= </span><span class="string">'te.t' </span><span class="keyword">).</span><span class="string">'\E$/i'</span><span class="keyword">, </span><span class="string">'test'</span><span class="keyword">) ? </span><span class="string">'match' </span><span class="keyword">: </span><span class="string">'nomatch' </span><span class="keyword">); </span><span class="default">?&gt;<br /></span><br />Will result in: nomatch</span></code></div>
  ...
  <div class="note" id="123876">  <div class="votes">
    <div id="Vu123876">
    <a href="/manual/vote-note.php?id=123876&amp;page=function.preg-quote&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123876">
    <a href="/manual/vote-note.php?id=123876&amp;page=function.preg-quote&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123876" title="64% like this...">
    5
    </div>
  </div>
  <a href="#123876" class="name">
  <strong class="user"><em>ed at happysoftware dot com</em></strong></a><a class="genanchor" href="#123876"> &para;</a><div class="date" title="2019-05-22 07:31"><strong>6 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">It should be noted that the forward slash is not escaped.  Since many regexes are surrounded by forward slashes, if you have one in your regex as  text you must escape it yourself otherwise it'll terminat the regex.</span></code></div>
  ...
  <div class="note" id="121568">  <div class="votes">
    <div id="Vu121568">
    <a href="/manual/vote-note.php?id=121568&amp;page=function.preg-quote&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121568">
    <a href="/manual/vote-note.php?id=121568&amp;page=function.preg-quote&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121568" title="61% like this...">
    4
    </div>
  </div>
  <a href="#121568" class="name">
  <strong class="user"><em>rwillmann at crooce dot com</em></strong></a><a class="genanchor" href="#121568"> &para;</a><div class="date" title="2017-08-25 11:53"><strong>8 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">List of specials is incomplete:<br /><br />--- sample code ---<br /><br />$specials = '.\+*?[^]$(){}=!&lt;&gt;|:-';<br /><br />for ($i = 0; $i &lt;= 255; $i++) {<br /><br />    if (chr($i) !== preg_quote(chr($i))) {<br /><br />        printf("Character 0x%02x quoted%s\n",<br />               $i,<br />               (strpos($specials, chr($i)) === FALSE) ? ' (+)' : '');<br />    } /* if */<br />} /* for */<br /><br />--- sample code ---<br /><br />--- output ---<br /><br />Character 0x00 quoted (+)<br />Character 0x21 quoted<br />Character 0x24 quoted<br />Character 0x28 quoted<br />Character 0x29 quoted<br />Character 0x2a quoted<br />Character 0x2b quoted<br />Character 0x2d quoted<br />Character 0x2e quoted<br />Character 0x3a quoted<br />Character 0x3c quoted<br />Character 0x3d quoted<br />Character 0x3e quoted<br />Character 0x3f quoted<br />Character 0x5b quoted<br />Character 0x5c quoted<br />Character 0x5d quoted<br />Character 0x5e quoted<br />Character 0x7b quoted<br />Character 0x7c quoted<br />Character 0x7d quoted<br /><br />--- output ---</span></code></div>
  ...
  <div class="note" id="125779">  <div class="votes">
    <div id="Vu125779">
    <a href="/manual/vote-note.php?id=125779&amp;page=function.preg-quote&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125779">
    <a href="/manual/vote-note.php?id=125779&amp;page=function.preg-quote&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125779" title="54% like this...">
    1
    </div>
  </div>
  <a href="#125779" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#125779"> &para;</a><div class="date" title="2021-02-05 09:34"><strong>4 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">I discovered that, in addition to escaping the special regular expression characters, preg_quote() encodes the NUL byte to its octal representation:<br /><br /><span class="default">&lt;?php<br />var_dump</span><span class="keyword">(</span><span class="default">preg_quote</span><span class="keyword">(</span><span class="string">"\0"</span><span class="keyword">));<br /></span><span class="default">?&gt;<br /></span><br />Output:<br /><br />string(4) "\000"</span></code></div>
  ...
  <div class="note" id="125730">  <div class="votes">
    <div id="Vu125730">
    <a href="/manual/vote-note.php?id=125730&amp;page=function.preg-quote&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125730">
    <a href="/manual/vote-note.php?id=125730&amp;page=function.preg-quote&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125730" title="43% like this...">
    -4
    </div>
  </div>
  <a href="#125730" class="name">
  <strong class="user"><em>rawr at t-regx dot com</em></strong></a><a class="genanchor" href="#125730"> &para;</a><div class="date" title="2021-01-28 12:56"><strong>4 years ago</strong></div>
...
<div class="foot"><a href="/manual/add-note.php?sect=function.preg-quote&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.preg-quote.php">＋<small>add a note</small></a></div>
