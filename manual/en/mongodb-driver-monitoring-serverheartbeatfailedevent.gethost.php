...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-monitoring-serverheartbeatfailedevent.gethost.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-monitoring-serverheartbeatfailedevent.gethost.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-monitoring-serverheartbeatfailedevent.gethost.php" hreflang="x-default">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-monitoring-serverheartbeatfailedevent.geterror.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-monitoring-serverheartbeatfailedevent.getport.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-monitoring-serverheartbeatfailedevent.gethost.php' selected="selected">English</option>
            ...
            <option value='zh/mongodb-driver-monitoring-serverheartbeatfailedevent.gethost.php'>Chinese (Simplified)</option>
  ...
  <ul class="simplelist">
   <li>Throws <span class="classname"><a href="class.mongodb-driver-exception-invalidargumentexception.php" class="classname">MongoDB\Driver\Exception\InvalidArgumentException</a></span> on argument parsing errors.</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/monitoring/serverheartbeatfailedevent/gethost.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-monitoring-serverheartbeatfailedevent.gethost%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-monitoring-serverheartbeatfailedevent.gethost&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-monitoring-serverheartbeatfailedevent.gethost.php">＋<small>add a note</small></a></span>
