...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.before.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.before.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.before.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.after.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.clear.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.before.php' selected="selected">English</option>
            <option value='de/intlcalendar.before.php'>German</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlcalendar.before-returnvalues">
  ...
  <p class="para">On failure <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> is also returned. To detect error conditions use <span class="function"><a href="function.intl-get-error-code.php" class="function">intl_get_error_code()</a></span>, or set up Intl to throw <a href="intl.configuration.php#ini.intl.use-exceptions" class="link">exceptions</a>.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/before.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.before%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.before&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.before.php">＋<small>add a note</small></a></span>
