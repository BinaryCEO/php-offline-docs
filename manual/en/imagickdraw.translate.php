...
<head>
  ...
  <title>PHP: ImagickDraw::translate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.translate.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.translate.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.translate.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.skewy.php">
 <link rel="next" href="https://www.php.net/manual/en/class.imagickpixel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.translate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.translate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.translate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.translate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.translate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.translate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.translate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.translate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.translate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.translate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.translate.php" hreflang="zh">
...
<meta name="Description" content="Applies a translation to the current coordinate system" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::translate - Manual" />
<meta name="twitter:description" content="Applies a translation to the current coordinate system" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::translate - Manual" />
<meta itemprop="description" content="Applies a translation to the current coordinate system" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Applies a translation to the current coordinate system" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.imagickpixel.php">
          ImagickPixel &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.skewy.php">
          &laquo; ImagickDraw::skewY        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.translate.php' selected="selected">English</option>
            <option value='de/imagickdraw.translate.php'>German</option>
            <option value='es/imagickdraw.translate.php'>Spanish</option>
            <option value='fr/imagickdraw.translate.php'>French</option>
            <option value='it/imagickdraw.translate.php'>Italian</option>
            <option value='ja/imagickdraw.translate.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.translate.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.translate.php'>Russian</option>
            <option value='tr/imagickdraw.translate.php'>Turkish</option>
            <option value='uk/imagickdraw.translate.php'>Ukrainian</option>
            <option value='zh/imagickdraw.translate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.translate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::translate</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::translate</span> &mdash; <span class="dc-title">Applies a translation to the current coordinate system</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.translate-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::translate</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.translate-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.translate-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.translate-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3199">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::translate()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/translate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.translate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.translate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.translate.php">＋<small>add a note</small></a></span>
