...
<head>
  ...
  <title>PHP: Imagick::getImageChannelStatistics - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagechannelstatistics.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagechannelstatistics.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagechannelstatistics.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagechannelrange.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageclipmask.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagechannelstatistics.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagechannelstatistics.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagechannelstatistics.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagechannelstatistics.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagechannelstatistics.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagechannelstatistics.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagechannelstatistics.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagechannelstatistics.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagechannelstatistics.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagechannelstatistics.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagechannelstatistics.php" hreflang="zh">
...
<meta name="Description" content="Returns statistics for each channel in the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageChannelStatistics - Manual" />
<meta name="twitter:description" content="Returns statistics for each channel in the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageChannelStatistics - Manual" />
<meta itemprop="description" content="Returns statistics for each channel in the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns statistics for each channel in the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimageclipmask.php">
          Imagick::getImageClipMask &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagechannelrange.php">
          &laquo; Imagick::getImageChannelRange        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagechannelstatistics.php' selected="selected">English</option>
            <option value='de/imagick.getimagechannelstatistics.php'>German</option>
            <option value='es/imagick.getimagechannelstatistics.php'>Spanish</option>
            <option value='fr/imagick.getimagechannelstatistics.php'>French</option>
            <option value='it/imagick.getimagechannelstatistics.php'>Italian</option>
            <option value='ja/imagick.getimagechannelstatistics.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagechannelstatistics.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagechannelstatistics.php'>Russian</option>
            <option value='tr/imagick.getimagechannelstatistics.php'>Turkish</option>
            <option value='uk/imagick.getimagechannelstatistics.php'>Ukrainian</option>
            <option value='zh/imagick.getimagechannelstatistics.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagechannelstatistics" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageChannelStatistics</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageChannelStatistics</span> &mdash; <span class="dc-title">Returns statistics for each channel in the image</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimagechannelstatistics-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageChannelStatistics</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagechannelstatistics-parameters">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagechannelstatistics.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagechannelstatistics%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagechannelstatistics&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagechannelstatistics.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108651">  <div class="votes">
    <div id="Vu108651">
    <a href="/manual/vote-note.php?id=108651&amp;page=imagick.getimagechannelstatistics&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108651">
    <a href="/manual/vote-note.php?id=108651&amp;page=imagick.getimagechannelstatistics&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108651" title="50% like this...">
    0
    </div>
  </div>
  <a href="#108651" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108651"> &para;</a><div class="date" title="2012-05-14 11:19"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108651">
<div class="phpcode"><code><span class="html">The ImageMagick function 'getImageChannelStatistics' returns an array of arrays.  The first array has keys with values set to 0, 1, 2, 4, 8, and 32.  Each of these arrays, in turn, has five values, mean, minima, maxima, standard deviation, and depth.  A sample print_r of the array produces...<br /><br />Array<br />(<br />    [0] =&gt; Array<br />        (<br />            [mean] =&gt; 0<br />            [minima] =&gt; 1.0E+37<br />            [maxima] =&gt; -1.0E-37<br />            [standardDeviation] =&gt; 0<br />            [depth] =&gt; 1<br />        )<br /><br />    [1] =&gt; Array<br />        (<br />            [mean] =&gt; 13215.2836185<br />            [minima] =&gt; 0<br />            [maxima] =&gt; 65535<br />            [standardDeviation] =&gt; 19099.2202751<br />            [depth] =&gt; 8<br />        )<br /><br />[etc., etc..]<br />}<br /><br />What does each 0, 1, 2, etc., value mean for the keys?  Those are shared, evaluated values of the ImageMagick Channel Constants.  You have the channel constant values that look like imagick::CHANNEL_UNDEFINED, with "_VALUE" values of: undefined, red, gray, cyan, green, magenta, blue, yellow, alpha, opacity, matte, black, index, all, and default.  If you actually print out these constants, you get '0' for undefined, '1' for red, gray, and cyan, '2' for green and magenta, '4' for blue and yellow, and '8' for alpha, opacity, and matte, or '32' for black and index.  Why do multiple channels share the same evaluated integer values?  That's because they're colors from different color spaces, with Red/Green/Blue being the RGB spectrum, Cyan/Magenta/Yellow/blacK being the CMYK spectrum, etc., etc..  If you want to get the statistical result values for Cyan or Red, you'll be accessing the same channel keys.<br /><br />There are five values produced for each color channel.  The element values for the keys 'mean' and 'standardDeviation' are the results from the getImageChannelMean function.  The element values for the keys 'minima' and 'maxima' are the results from the getChannelRange function.  And the element values for the key 'depth' is the result from the getImageChannelDepth function.  All of these values can be useful in terms of measuring the Channel values of a particular image.<br /><br />And now, some sample code :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br /><br />        // Create Imagick Object<br />        // ---------------------------------------------<br />    <br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Filename to Open<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$file_to_grab_with_location </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.bmp"</span><span class="keyword">;<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />            <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab_with_location</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br /><br />        </span><span class="comment">// Read File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br /><br />        </span><span class="comment">// Get Statistics<br />        // ---------------------------------------------<br />                <br />    </span><span class="default">$imagick_type_channel_statistics </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageChannelStatistics</span><span class="keyword">();<br /><br />        </span><span class="comment">// Print Statistics<br />        // ---------------------------------------------<br /><br />    </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$imagick_type_channel_statistics</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagechannelstatistics&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagechannelstatistics.php">＋<small>add a note</small></a></div>
