...
<head>
  ...
  <title>PHP: pg_lo_import - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-lo-import.php">
 <link rel="shorturl" href="https://www.php.net/pg-lo-import">
 <link rel="alternate" href="https://www.php.net/pg-lo-import" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-lo-export.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-lo-open.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-lo-import.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-lo-import.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-lo-import.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-lo-import.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-lo-import.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-lo-import.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-lo-import.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-lo-import.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-lo-import.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-lo-import.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-lo-import.php" hreflang="zh">
...
<meta name="Description" content="Import a large object from file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_lo_import - Manual" />
<meta name="twitter:description" content="Import a large object from file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_lo_import - Manual" />
<meta itemprop="description" content="Import a large object from file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Import a large object from file" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-lo-open.php">
          pg_lo_open &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-lo-export.php">
          &laquo; pg_lo_export        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-lo-import.php' selected="selected">English</option>
            <option value='de/function.pg-lo-import.php'>German</option>
            <option value='es/function.pg-lo-import.php'>Spanish</option>
            <option value='fr/function.pg-lo-import.php'>French</option>
            <option value='it/function.pg-lo-import.php'>Italian</option>
            <option value='ja/function.pg-lo-import.php'>Japanese</option>
            <option value='pt_BR/function.pg-lo-import.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-lo-import.php'>Russian</option>
            <option value='tr/function.pg-lo-import.php'>Turkish</option>
            <option value='uk/function.pg-lo-import.php'>Ukrainian</option>
            <option value='zh/function.pg-lo-import.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-lo-import" class="refentry">
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-lo-import-returnvalues">
  ...
  <p class="para">
   The <var class="varname">OID</var> of the newly created large object,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />   $database </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=jacarta"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #DD0000">"begin"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">$oid </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_lo_import</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #DD0000">'/tmp/lob.dat'</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #DD0000">"commit"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-lo-import-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-lo-export.php" class="function" rel="rdfs-seeAlso">pg_lo_export()</a> - Export a large object to file</span></li>
    <li><span class="function"><a href="function.pg-lo-open.php" class="function" rel="rdfs-seeAlso">pg_lo_open()</a> - Open a large object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-lo-import.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-lo-import%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-lo-import&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-import.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="23944">  <div class="votes">
    <div id="Vu23944">
    <a href="/manual/vote-note.php?id=23944&amp;page=function.pg-lo-import&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd23944">
    <a href="/manual/vote-note.php?id=23944&amp;page=function.pg-lo-import&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V23944" title="100% like this...">
    1
    </div>
  </div>
  <a href="#23944" class="name">
  <strong class="user"><em>vi2 at vi2 dot com</em></strong></a><a class="genanchor" href="#23944"> &para;</a><div class="date" title="2002-08-01 05:54"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom23944">
<div class="phpcode"><code><span class="html">its not very clear if pg_lo_import needs to have pg_lo_open called first. Because pg_lo_import handles the process of writign to the file, it seems logical that pg_lo_open does not need to be called. However due to the ugly nature of how postgres handles oid objects, it would be nice to have this documented.</span></code></div>
  </div>
 </div>
  <div class="note" id="22471">  <div class="votes">
    <div id="Vu22471">
    <a href="/manual/vote-note.php?id=22471&amp;page=function.pg-lo-import&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd22471">
    <a href="/manual/vote-note.php?id=22471&amp;page=function.pg-lo-import&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V22471" title="100% like this...">
    1
    </div>
  </div>
  <a href="#22471" class="name">
  <strong class="user"><em>yohgaki at php dot net</em></strong></a><a class="genanchor" href="#22471"> &para;</a><div class="date" title="2002-06-19 06:04"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom22471">
<div class="phpcode"><code><span class="html">Due to a bug, OLD API does not available with PHP 4.2.0 and 4.2.1.<br /><br />PHP 4.2.2 will support OLD API again and will be kept long enough.<br /><br />New API will be available PHP 4.2.0 to later versions.</span></code></div>
  </div>
 </div>
  <div class="note" id="22470">  <div class="votes">
    <div id="Vu22470">
    <a href="/manual/vote-note.php?id=22470&amp;page=function.pg-lo-import&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd22470">
    <a href="/manual/vote-note.php?id=22470&amp;page=function.pg-lo-import&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V22470" title="100% like this...">
    1
    </div>
  </div>
  <a href="#22470" class="name">
  <strong class="user"><em>yohgaki at php dot net</em></strong></a><a class="genanchor" href="#22470"> &para;</a><div class="date" title="2002-06-19 06:00"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom22470">
<div class="phpcode"><code><span class="html">Due to a bug, PHP 4.2.0 and 4.2.1 does not support pg_lo_import() old API. It's fixed in PHP 4.2.2.<br /><br />BTW, new API will be always available from PHP 4.2.0 to later versions. Older API will be kept long enough, also.</span></code></div>
  </div>
 </div>
  <div class="note" id="21511">  <div class="votes">
    <div id="Vu21511">
    <a href="/manual/vote-note.php?id=21511&amp;page=function.pg-lo-import&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd21511">
    <a href="/manual/vote-note.php?id=21511&amp;page=function.pg-lo-import&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V21511" title="50% like this...">
    0
    </div>
  </div>
  <a href="#21511" class="name">
  <strong class="user"><em>ceco at noxis dot net</em></strong></a><a class="genanchor" href="#21511"> &para;</a><div class="date" title="2002-05-15 11:08"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom21511">
<div class="phpcode"><code><span class="html">it works for me (php-4.2.1)<br /><br />not like this<br /><br />int pg_lo_import ( string pathname [, resource connection])<br /><br />but <br />int pg_lo_import ( resource connection, string pathname )<br /><br />don't know the reason</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-lo-import&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-import.php">＋<small>add a note</small></a></div>
