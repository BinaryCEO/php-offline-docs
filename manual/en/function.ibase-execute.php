...
<head>
  ...
  <title>PHP: ibase_execute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-execute.php">
 <link rel="shorturl" href="https://www.php.net/ibase-execute">
 <link rel="alternate" href="https://www.php.net/ibase-execute" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-errmsg.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-fetch-assoc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-execute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-execute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-execute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-execute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-execute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-execute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-execute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-execute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-execute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-execute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-execute.php" hreflang="zh">
...
<meta name="Description" content="Execute a previously prepared query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_execute - Manual" />
<meta name="twitter:description" content="Execute a previously prepared query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_execute - Manual" />
<meta itemprop="description" content="Execute a previously prepared query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Execute a previously prepared query" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-fetch-assoc.php">
          ibase_fetch_assoc &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-errmsg.php">
          &laquo; ibase_errmsg        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-execute.php' selected="selected">English</option>
            <option value='de/function.ibase-execute.php'>German</option>
            <option value='es/function.ibase-execute.php'>Spanish</option>
            <option value='fr/function.ibase-execute.php'>French</option>
            <option value='it/function.ibase-execute.php'>Italian</option>
            <option value='ja/function.ibase-execute.php'>Japanese</option>
            <option value='pt_BR/function.ibase-execute.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-execute.php'>Russian</option>
            <option value='tr/function.ibase-execute.php'>Turkish</option>
            <option value='uk/function.ibase-execute.php'>Ukrainian</option>
            <option value='zh/function.ibase-execute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-execute" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ibase-query.php" class="function" rel="rdfs-seeAlso">ibase_query()</a> - Execute a query on an InterBase database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-execute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-execute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-execute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-execute.php">＋<small>add a note</small></a></span>
