...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-set-nonblock.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-set-block.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-set-option.php">
...
<meta name="Description" content="Sets nonblocking mode for file descriptor fd" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_set_nonblock - Manual" />
<meta name="twitter:description" content="Sets nonblocking mode for file descriptor fd" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_set_nonblock - Manual" />
<meta itemprop="description" content="Sets nonblocking mode for file descriptor fd" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets nonblocking mode for file descriptor fd" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-set-nonblock.php' selected="selected">English</option>
            ...
            <option value='ja/function.socket-set-nonblock.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_set_nonblock</span> &mdash; <span class="dc-title">Sets nonblocking mode for file descriptor fd</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.socket-set-nonblock-description">
  ...
  <p class="para rdfs-comment">
   ...
   <strong><code><a href="dio.constants.php#constant.o-nonblock">O_NONBLOCK</a></code></strong> flag on the socket specified by
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$socket </span><span style="color: #007700">= </span><span style="color: #0000BB">socket_create_listen</span><span style="color: #007700">(</span><span style="color: #0000BB">1223</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">socket_set_nonblock</span><span style="color: #007700">(</span><span style="color: #0000BB">$socket</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">socket_accept</span><span style="color: #007700">(</span><span style="color: #0000BB">$socket</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="example-contents"><p>
     ...
     sets the socket to <strong><code><a href="dio.constants.php#constant.o-nonblock">O_NONBLOCK</a></code></strong> mode. 
     <span class="function"><a href="function.socket-accept.php" class="function">socket_accept()</a></span> will immediately fail unless there is a
 ...
 <div class="refsect1 seealso" id="refsect1-function.socket-set-nonblock-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.socket-set-block.php" class="function" rel="rdfs-seeAlso">socket_set_block()</a> - Sets blocking mode on a socket</span></li>
    ...
    <li><span class="function"><a href="function.stream-set-blocking.php" class="function" rel="rdfs-seeAlso">stream_set_blocking()</a> - Set blocking/non-blocking mode on a stream</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-set-nonblock.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-set-nonblock%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-set-nonblock&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-set-nonblock.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Beware, when using this function within a loop (i.e. a demon with a socket). The socket_accept(), for example, emits a warning each time there is no incoming connection available to be read. My php error log file got huge in a matter of seconds, eventually crashing the server.
<br />
<br />Of course, i used the @ before the function to take care of that problem.
<br />
<br />[EDITOR: One can (and should) use socket_select to detect a new connection on a socket (it's a "readable" event)]</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.socket-set-nonblock&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-set-nonblock.php">＋<small>add a note</small></a></div>
