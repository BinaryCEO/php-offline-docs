...
<head>
  ...
  <title>PHP: Gmagick::setimageblueprimary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimageblueprimary.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimageblueprimary.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageblueprimary.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimagebackgroundcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagebordercolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageblueprimary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimageblueprimary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimageblueprimary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimageblueprimary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimageblueprimary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimageblueprimary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimageblueprimary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimageblueprimary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimageblueprimary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimageblueprimary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimageblueprimary.php" hreflang="zh">
...
<meta name="Description" content="Sets the image chromaticity blue primary point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::setimageblueprimary - Manual" />
<meta name="twitter:description" content="Sets the image chromaticity blue primary point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimageblueprimary - Manual" />
<meta itemprop="description" content="Sets the image chromaticity blue primary point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image chromaticity blue primary point" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.setimagebordercolor.php">
          Gmagick::setimagebordercolor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimagebackgroundcolor.php">
          &laquo; Gmagick::setimagebackgroundcolor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimageblueprimary.php' selected="selected">English</option>
            <option value='de/gmagick.setimageblueprimary.php'>German</option>
            <option value='es/gmagick.setimageblueprimary.php'>Spanish</option>
            <option value='fr/gmagick.setimageblueprimary.php'>French</option>
            <option value='it/gmagick.setimageblueprimary.php'>Italian</option>
            <option value='ja/gmagick.setimageblueprimary.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimageblueprimary.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimageblueprimary.php'>Russian</option>
            <option value='tr/gmagick.setimageblueprimary.php'>Turkish</option>
            <option value='uk/gmagick.setimageblueprimary.php'>Ukrainian</option>
            <option value='zh/gmagick.setimageblueprimary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimageblueprimary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimageblueprimary</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimageblueprimary</span> &mdash; <span class="dc-title">Sets the image chromaticity blue primary point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimageblueprimary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimageblueprimary</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimageblueprimary-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimageblueprimary-returnvalues">
  ...
  <div class="refsect1 errors" id="refsect1-gmagick.setimageblueprimary-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimageblueprimary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimageblueprimary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimageblueprimary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimageblueprimary.php">＋<small>add a note</small></a></span>
