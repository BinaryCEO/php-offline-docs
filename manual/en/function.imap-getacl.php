...
<head>
  ...
  <title>PHP: imap_getacl - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-getacl.php">
 <link rel="shorturl" href="https://www.php.net/imap-getacl">
 <link rel="alternate" href="https://www.php.net/imap-getacl" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-get-quotaroot.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-getmailboxes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-getacl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-getacl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-getacl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-getacl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-getacl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-getacl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-getacl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-getacl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-getacl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-getacl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-getacl.php" hreflang="zh">
...
<meta name="Description" content="Gets the ACL for a given mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_getacl - Manual" />
<meta name="twitter:description" content="Gets the ACL for a given mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_getacl - Manual" />
<meta itemprop="description" content="Gets the ACL for a given mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the ACL for a given mailbox" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-getmailboxes.php">
          imap_getmailboxes &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-get-quotaroot.php">
          &laquo; imap_get_quotaroot        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-getacl.php' selected="selected">English</option>
            <option value='de/function.imap-getacl.php'>German</option>
            <option value='es/function.imap-getacl.php'>Spanish</option>
            <option value='fr/function.imap-getacl.php'>French</option>
            <option value='it/function.imap-getacl.php'>Italian</option>
            <option value='ja/function.imap-getacl.php'>Japanese</option>
            <option value='pt_BR/function.imap-getacl.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-getacl.php'>Russian</option>
            <option value='tr/function.imap-getacl.php'>Turkish</option>
            <option value='uk/function.imap-getacl.php'>Ukrainian</option>
            <option value='zh/function.imap-getacl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-getacl" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_getacl</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_getacl</span> &mdash; <span class="dc-title">Gets the ACL for a given mailbox</span></p>
...
<a href="imap.configuration.php#ini.imap.enable-insecure-rsh" class="link">imap.enable_insecure_rsh</a> is disabled.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-getacl-returnvalues">
  ...
  <p class="para">
   Returns an associative array of &quot;folder&quot; =&gt; &quot;acl&quot; pairs,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-getacl-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-setacl.php" class="function" rel="rdfs-seeAlso">imap_setacl()</a> - Sets the ACL for a given mailbox</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-getacl.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-getacl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-getacl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-getacl.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118955">  <div class="votes">
    <div id="Vu118955">
    <a href="/manual/vote-note.php?id=118955&amp;page=function.imap-getacl&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118955">
    <a href="/manual/vote-note.php?id=118955&amp;page=function.imap-getacl&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118955" title="no votes...">
    0
    </div>
  </div>
  <a href="#118955" class="name">
  <strong class="user"><em>hartmut dot woehrle at hwds dot ch</em></strong></a><a class="genanchor" href="#118955"> &para;</a><div class="date" title="2016-03-07 02:13"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118955">
<div class="phpcode"><code><span class="html">Maybe the functionality changed over the years but the examples are wrong.<br />It does NOT return [subfolder] =&gt; ACL <br /><br />At the moment (PHP5) the usage and answer of imap_getacl is the following:<br />You ask for the folder and get the ACLs for exactly this folder (no Wildcards)<br /><br />Example:<br />When you have the folder Business in your mailbox<br /><br />print_r(imap_getacl($connection , "user/john.doe/Business"));<br /><br />returns the following:<br /><br />Array<br />(<br />    [john.doe@example.com] =&gt; lrswipkxtecda<br />    [cyrus@example.com] =&gt; lrswipkxtecd<br />    [secretary@example.com] =&gt; lrsp<br />    [department@example.com] =&gt; lrs<br />) <br /><br />Which means you have to loop over your directories (imap_list) and list the ACL for ever folder seperately.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-getacl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-getacl.php">＋<small>add a note</small></a></div>
