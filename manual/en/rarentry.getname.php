...
<head>
  ...
  <title>PHP: RarEntry::getName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/rarentry.getname.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/rarentry.getname.php">
 <link rel="alternate" href="https://www.php.net/manual/en/rarentry.getname.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.rarentry.php">
 <link rel="prev" href="https://www.php.net/manual/en/rarentry.getmethod.php">
 <link rel="next" href="https://www.php.net/manual/en/rarentry.getpackedsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/rarentry.getname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/rarentry.getname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/rarentry.getname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/rarentry.getname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/rarentry.getname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/rarentry.getname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/rarentry.getname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/rarentry.getname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/rarentry.getname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/rarentry.getname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/rarentry.getname.php" hreflang="zh">
...
<meta name="Description" content="Get name of the entry" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: RarEntry::getName - Manual" />
<meta name="twitter:description" content="Get name of the entry" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: RarEntry::getName - Manual" />
<meta itemprop="description" content="Get name of the entry" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get name of the entry" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="rarentry.getpackedsize.php">
          RarEntry::getPackedSize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="rarentry.getmethod.php">
          &laquo; RarEntry::getMethod        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/rarentry.getname.php' selected="selected">English</option>
            <option value='de/rarentry.getname.php'>German</option>
            <option value='es/rarentry.getname.php'>Spanish</option>
            <option value='fr/rarentry.getname.php'>French</option>
            <option value='it/rarentry.getname.php'>Italian</option>
            <option value='ja/rarentry.getname.php'>Japanese</option>
            <option value='pt_BR/rarentry.getname.php'>Brazilian Portuguese</option>
            <option value='ru/rarentry.getname.php'>Russian</option>
            <option value='tr/rarentry.getname.php'>Turkish</option>
            <option value='uk/rarentry.getname.php'>Ukrainian</option>
            <option value='zh/rarentry.getname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="rarentry.getname" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-rarentry.getname-examples">
  ...
  <p class="para">
   <div class="example" id="example-902">
    <p><strong>Example #1 <span class="methodname"><strong>RarEntry::getName()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">//this example is safe even in pages not encoded in UTF-8<br />//for those encoded in UTF-8, the call to mb_convert_encoding is unnecessary<br /><br /></span><span style="color: #0000BB">$rar_file </span><span style="color: #007700">= </span><span style="color: #0000BB">rar_open</span><span style="color: #007700">(</span><span style="color: #DD0000">'example.rar'</span><span style="color: #007700">) or die(</span><span style="color: #DD0000">"Failed to open Rar archive"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$entry </span><span style="color: #007700">= </span><span style="color: #0000BB">rar_entry_get</span><span style="color: #007700">(</span><span style="color: #0000BB">$rar_file</span><span style="color: #007700">, </span><span style="color: #DD0000">'Dir/file.txt'</span><span style="color: #007700">) or die(</span><span style="color: #DD0000">"Failed to find such entry"</span><span style="color: #007700">);<br /><br />echo </span><span style="color: #DD0000">"Entry name: " </span><span style="color: #007700">. </span><span style="color: #0000BB">mb_convert_encoding</span><span style="color: #007700">(<br />    </span><span style="color: #0000BB">htmlentities</span><span style="color: #007700">(<br />        </span><span style="color: #0000BB">$entry</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getName</span><span style="color: #007700">(),<br />        </span><span style="color: #0000BB">ENT_COMPAT</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">"UTF-8"<br />    </span><span style="color: #007700">),<br />    </span><span style="color: #DD0000">"HTML-ENTITIES"</span><span style="color: #007700">,<br />    </span><span style="color: #DD0000">"UTF-8"<br /></span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rar/rarentry/getname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Frarentry.getname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=rarentry.getname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/rarentry.getname.php">＋<small>add a note</small></a></span>
