...
<head>
  ...
  <title>PHP: Gmagick::setimagewhitepoint - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagewhitepoint.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagewhitepoint.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagewhitepoint.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimageunits.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setsamplingfactors.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagewhitepoint.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimagewhitepoint.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimagewhitepoint.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimagewhitepoint.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimagewhitepoint.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimagewhitepoint.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimagewhitepoint.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimagewhitepoint.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimagewhitepoint.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimagewhitepoint.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimagewhitepoint.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimagewhitepoint - Manual" />
<meta name="twitter:description" content="Sets the image chromaticity white point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimagewhitepoint - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.setsamplingfactors.php">
          Gmagick::setsamplingfactors &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimageunits.php">
          &laquo; Gmagick::setimageunits        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagewhitepoint.php' selected="selected">English</option>
            <option value='de/gmagick.setimagewhitepoint.php'>German</option>
            <option value='es/gmagick.setimagewhitepoint.php'>Spanish</option>
            <option value='fr/gmagick.setimagewhitepoint.php'>French</option>
            <option value='it/gmagick.setimagewhitepoint.php'>Italian</option>
            <option value='ja/gmagick.setimagewhitepoint.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimagewhitepoint.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimagewhitepoint.php'>Russian</option>
            <option value='tr/gmagick.setimagewhitepoint.php'>Turkish</option>
            <option value='uk/gmagick.setimagewhitepoint.php'>Ukrainian</option>
            <option value='zh/gmagick.setimagewhitepoint.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimagewhitepoint" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimagewhitepoint</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimagewhitepoint</span> &mdash; <span class="dc-title">Sets the image chromaticity white point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimagewhitepoint-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimagewhitepoint</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimagewhitepoint-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimagewhitepoint-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimagewhitepoint-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagewhitepoint.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagewhitepoint%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagewhitepoint&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagewhitepoint.php">＋<small>add a note</small></a></span>
