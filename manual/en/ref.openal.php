...
<head>
  ...
  <title>PHP: OpenAL Functions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.openal.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/openal.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openal-buffer-create.php">
...
<meta name="Description" content="OpenAL Functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: OpenAL Functions - Manual" />
<meta name="twitter:description" content="OpenAL Functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: OpenAL Functions - Manual" />
<meta itemprop="description" content="OpenAL Functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="OpenAL Functions" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.openal.php' selected="selected">English</option>
            <option value='de/ref.openal.php'>German</option>
            <option value='es/ref.openal.php'>Spanish</option>
 ...
 <h1 class="title">OpenAL Functions</h1>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="function.openal-buffer-create.php">openal_buffer_create</a> — Generate OpenAL buffer</li><li><a href="function.openal-buffer-data.php">openal_buffer_data</a> — Load a buffer with data</li><li><a href="function.openal-buffer-destroy.php">openal_buffer_destroy</a> — Destroys an OpenAL buffer</li><li><a href="function.openal-buffer-get.php">openal_buffer_get</a> — Retrieve an OpenAL buffer property</li><li><a href="function.openal-buffer-loadwav.php">openal_buffer_loadwav</a> — Load a .wav file into a buffer</li><li><a href="function.openal-context-create.php">openal_context_create</a> — Create an audio processing context</li><li><a href="function.openal-context-current.php">openal_context_current</a> — Make the specified context current</li><li><a href="function.openal-context-destroy.php">openal_context_destroy</a> — Destroys a context</li><li><a href="function.openal-context-process.php">openal_context_process</a> — Process the specified context</li><li><a href="function.openal-context-suspend.php">openal_context_suspend</a> — Suspend the specified context</li><li><a href="function.openal-device-close.php">openal_device_close</a> — Close an OpenAL device</li><li><a href="function.openal-device-open.php">openal_device_open</a> — Initialize the OpenAL audio layer</li><li><a href="function.openal-listener-get.php">openal_listener_get</a> — Retrieve a listener property</li><li><a href="function.openal-listener-set.php">openal_listener_set</a> — Set a listener property</li><li><a href="function.openal-source-create.php">openal_source_create</a> — Generate a source resource</li><li><a href="function.openal-source-destroy.php">openal_source_destroy</a> — Destroy a source resource</li><li><a href="function.openal-source-get.php">openal_source_get</a> — Retrieve an OpenAL source property</li><li><a href="function.openal-source-pause.php">openal_source_pause</a> — Pause the source</li><li><a href="function.openal-source-play.php">openal_source_play</a> — Start playing the source</li><li><a href="function.openal-source-rewind.php">openal_source_rewind</a> — Rewind the source</li><li><a href="function.openal-source-set.php">openal_source_set</a> — Set source property</li><li><a href="function.openal-source-stop.php">openal_source_stop</a> — Stop playing the source</li><li><a href="function.openal-stream.php">openal_stream</a> — Begin streaming on a source</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openal/reference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fref.openal%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ref.openal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.openal.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">OpenAL aims to provide a standardized API for something called '3D' sound, just like OpenGL does for '3D' video rendering.<br /><br />The fun part of OpenAL is that it does all the DSP for you, so you don't need to know a lot about audio. Since OpenAL comes from Creative Labs, it supports hardware rendering of audio with most if not all SoundBlaster audio controllers. They come with chips from EMU-systems and are specifically designed to mix down multichannel audio with DSP effects like reverb and chorus, which could consume a lot CPU speed.<br /><br />The downside of OpenAL is that (at this time of writing) it is focus on games only. It doesn't do MIDI at all, it doesn't record anything, it doesn't work like a synthesizer. The only thing you can do with OpenAL is play sounds in a simulated 3D environment.<br />It probably doesn't work on the web.<br /><br />To use OpenAL you need to read the documentation about OpenAL.<br /><br />Note concerning audio users: there's no such thing as '3D' audio with speakers. Technically, when people have only two ears, they really can't distinguish sound from above or below, even in front or from behind. To achieve this people merely hear volume, the brightness of sound and the phase difference. One should be able to hear more '3D' sound with only two quality-class speakers than with a consumer class 5.1-set.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I made a PHP-Gtk2 OpenAL demo which allows you to define as many sound sources as you like and position them relative to the listener by drag and drop: <a href="http://gnope.org/p/Tools_OpenALdemo" rel="nofollow" target="_blank">http://gnope.org/p/Tools_OpenALdemo</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=ref.openal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.openal.php">＋<small>add a note</small></a></div>
