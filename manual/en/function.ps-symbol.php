...
<head>
  ...
  <title>PHP: ps_symbol - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-symbol.php">
 <link rel="shorturl" href="https://www.php.net/ps-symbol">
 <link rel="alternate" href="https://www.php.net/ps-symbol" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-stroke.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-symbol-name.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-symbol.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-symbol.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-symbol.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-symbol.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-symbol.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-symbol.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-symbol.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-symbol.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-symbol.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-symbol.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-symbol.php" hreflang="zh">
...
<meta name="Description" content="Output a glyph" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_symbol - Manual" />
<meta name="twitter:description" content="Output a glyph" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_symbol - Manual" />
<meta itemprop="description" content="Output a glyph" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Output a glyph" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-symbol-name.php">
          ps_symbol_name &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-stroke.php">
          &laquo; ps_stroke        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-symbol.php' selected="selected">English</option>
            <option value='de/function.ps-symbol.php'>German</option>
            <option value='es/function.ps-symbol.php'>Spanish</option>
            <option value='fr/function.ps-symbol.php'>French</option>
            <option value='it/function.ps-symbol.php'>Italian</option>
            <option value='ja/function.ps-symbol.php'>Japanese</option>
            <option value='pt_BR/function.ps-symbol.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-symbol.php'>Russian</option>
            <option value='tr/function.ps-symbol.php'>Turkish</option>
            <option value='uk/function.ps-symbol.php'>Ukrainian</option>
            <option value='zh/function.ps-symbol.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-symbol" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_symbol</h1>
  <p class="verinfo">(PECL ps &gt;= 1.2.0)</p><p class="refpurpose"><span class="refname">ps_symbol</span> &mdash; <span class="dc-title">Output a glyph</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-symbol-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_symbol</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$ord</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Output the glyph at position <code class="parameter">ord</code> in the font
   encoding vector of the current font. The font encoding for a font can be
   set when loading the font with <span class="function"><a href="function.ps-findfont.php" class="function">ps_findfont()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-symbol-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-symbol-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-symbol-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-symbol-name.php" class="function" rel="rdfs-seeAlso">ps_symbol_name()</a> - Gets name of a glyph</span></li>
    <li><span class="function"><a href="function.ps-symbol-width.php" class="function" rel="rdfs-seeAlso">ps_symbol_width()</a> - Gets width of a glyph</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-symbol.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-symbol%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-symbol&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-symbol.php">＋<small>add a note</small></a></span>
