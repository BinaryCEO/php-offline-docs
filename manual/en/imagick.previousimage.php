...
<head>
  ...
  <title>PHP: Imagick::previousImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.previousimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.previousimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.previousimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.previewimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.profileimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.previousimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.previousimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.previousimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.previousimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.previousimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.previousimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.previousimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.previousimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.previousimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.previousimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.previousimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::previousImage - Manual" />
<meta name="twitter:description" content="Move to the previous image in the object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::previousImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.profileimage.php">
          Imagick::profileImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.previewimages.php">
          &laquo; Imagick::previewImages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.previousimage.php' selected="selected">English</option>
            <option value='de/imagick.previousimage.php'>German</option>
            <option value='es/imagick.previousimage.php'>Spanish</option>
            <option value='fr/imagick.previousimage.php'>French</option>
            <option value='it/imagick.previousimage.php'>Italian</option>
            <option value='ja/imagick.previousimage.php'>Japanese</option>
            <option value='pt_BR/imagick.previousimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.previousimage.php'>Russian</option>
            <option value='tr/imagick.previousimage.php'>Turkish</option>
            <option value='uk/imagick.previousimage.php'>Ukrainian</option>
            <option value='zh/imagick.previousimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.previousimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::previousImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::previousImage</span> &mdash; <span class="dc-title">Move to the previous image in the object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.previousimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::previousImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.previousimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.previousimage-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/previousimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.previousimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.previousimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.previousimage.php">＋<small>add a note</small></a></span>
