...
<head>
  ...
  <title>PHP: tidy::getOpt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/tidy.getopt.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/tidy.getopt.php">
 <link rel="alternate" href="https://www.php.net/manual/en/tidy.getopt.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.tidy.php">
 <link rel="prev" href="https://www.php.net/manual/en/tidy.gethtmlver.php">
 <link rel="next" href="https://www.php.net/manual/en/tidy.getoptdoc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/tidy.getopt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/tidy.getopt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/tidy.getopt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/tidy.getopt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/tidy.getopt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/tidy.getopt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/tidy.getopt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/tidy.getopt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/tidy.getopt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/tidy.getopt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/tidy.getopt.php" hreflang="zh">
...
<meta name="Description" content="Returns the value of the specified configuration option for the tidy document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: tidy::getOpt - Manual" />
<meta name="twitter:description" content="Returns the value of the specified configuration option for the tidy document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: tidy::getOpt - Manual" />
<meta itemprop="description" content="Returns the value of the specified configuration option for the tidy document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the value of the specified configuration option for the tidy document" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="tidy.getoptdoc.php">
          tidy::getOptDoc &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="tidy.gethtmlver.php">
          &laquo; tidy::getHtmlVer        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/tidy.getopt.php' selected="selected">English</option>
            <option value='de/tidy.getopt.php'>German</option>
            <option value='es/tidy.getopt.php'>Spanish</option>
            <option value='fr/tidy.getopt.php'>French</option>
            <option value='it/tidy.getopt.php'>Italian</option>
            <option value='ja/tidy.getopt.php'>Japanese</option>
            <option value='pt_BR/tidy.getopt.php'>Brazilian Portuguese</option>
            <option value='ru/tidy.getopt.php'>Russian</option>
            <option value='tr/tidy.getopt.php'>Turkish</option>
            <option value='uk/tidy.getopt.php'>Ukrainian</option>
            <option value='zh/tidy.getopt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="tidy.getopt" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-tidy.getopt-examples">
  ...
  <p class="para">
   <div class="example" id="example-4088">
...
string(9) &quot;some text&quot;</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/tidy/tidy/getopt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ftidy.getopt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=tidy.getopt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/tidy.getopt.php">＋<small>add a note</small></a></span>
