...
<head>
  ...
  <title>PHP: xml_set_end_namespace_decl_handler - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xml-set-end-namespace-decl-handler.php">
 <link rel="shorturl" href="https://www.php.net/xml-set-end-namespace-decl-handler">
 <link rel="alternate" href="https://www.php.net/xml-set-end-namespace-decl-handler" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.xml.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.xml-set-element-handler.php">
 <link rel="next" href="https://www.php.net/manual/en/function.xml-set-external-entity-ref-handler.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.xml-set-end-namespace-decl-handler.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.xml-set-end-namespace-decl-handler.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.xml-set-end-namespace-decl-handler.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.xml-set-end-namespace-decl-handler.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.xml-set-end-namespace-decl-handler.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.xml-set-end-namespace-decl-handler.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.xml-set-end-namespace-decl-handler.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.xml-set-end-namespace-decl-handler.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.xml-set-end-namespace-decl-handler.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.xml-set-end-namespace-decl-handler.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.xml-set-end-namespace-decl-handler.php" hreflang="zh">
...
<meta name="Description" content="Set up end namespace declaration handler" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: xml_set_end_namespace_decl_handler - Manual" />
<meta name="twitter:description" content="Set up end namespace declaration handler" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: xml_set_end_namespace_decl_handler - Manual" />
<meta itemprop="description" content="Set up end namespace declaration handler" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set up end namespace declaration handler" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.xml-set-external-entity-ref-handler.php">
          xml_set_external_entity_ref_handler &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.xml-set-element-handler.php">
          &laquo; xml_set_element_handler        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xml-set-end-namespace-decl-handler.php' selected="selected">English</option>
            <option value='de/function.xml-set-end-namespace-decl-handler.php'>German</option>
            <option value='es/function.xml-set-end-namespace-decl-handler.php'>Spanish</option>
            <option value='fr/function.xml-set-end-namespace-decl-handler.php'>French</option>
            <option value='it/function.xml-set-end-namespace-decl-handler.php'>Italian</option>
            <option value='ja/function.xml-set-end-namespace-decl-handler.php'>Japanese</option>
            <option value='pt_BR/function.xml-set-end-namespace-decl-handler.php'>Brazilian Portuguese</option>
            <option value='ru/function.xml-set-end-namespace-decl-handler.php'>Russian</option>
            <option value='tr/function.xml-set-end-namespace-decl-handler.php'>Turkish</option>
            <option value='uk/function.xml-set-end-namespace-decl-handler.php'>Ukrainian</option>
            <option value='zh/function.xml-set-end-namespace-decl-handler.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.xml-set-end-namespace-decl-handler" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.xml-set-start-namespace-decl-handler.php" class="function" rel="rdfs-seeAlso">xml_set_start_namespace_decl_handler()</a> - Set up start namespace declaration handler</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xml/functions/xml-set-end-namespace-decl-handler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xml-set-end-namespace-decl-handler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xml-set-end-namespace-decl-handler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xml-set-end-namespace-decl-handler.php">＋<small>add a note</small></a></span>
