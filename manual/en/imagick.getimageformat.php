...
<head>
  ...
  <title>PHP: Imagick::getImageFormat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageformat.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageformat.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageformat.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagefilename.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagegamma.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageformat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageformat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageformat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageformat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageformat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageformat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageformat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageformat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageformat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageformat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageformat.php" hreflang="zh">
...
<meta name="Description" content="Returns the format of a particular image in a sequence" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageFormat - Manual" />
<meta name="twitter:description" content="Returns the format of a particular image in a sequence" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageFormat - Manual" />
<meta itemprop="description" content="Returns the format of a particular image in a sequence" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the format of a particular image in a sequence" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagegamma.php">
          Imagick::getImageGamma &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagefilename.php">
          &laquo; Imagick::getImageFilename        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageformat.php' selected="selected">English</option>
            <option value='de/imagick.getimageformat.php'>German</option>
            <option value='es/imagick.getimageformat.php'>Spanish</option>
            <option value='fr/imagick.getimageformat.php'>French</option>
            <option value='it/imagick.getimageformat.php'>Italian</option>
            <option value='ja/imagick.getimageformat.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageformat.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageformat.php'>Russian</option>
            <option value='tr/imagick.getimageformat.php'>Turkish</option>
            <option value='uk/imagick.getimageformat.php'>Ukrainian</option>
            <option value='zh/imagick.getimageformat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageformat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageFormat</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageFormat</span> &mdash; <span class="dc-title">Returns the format of a particular image in a sequence</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimageformat-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageFormat</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimageformat-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageformat-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimageformat-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageformat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageformat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageformat.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="111450">  <div class="votes">
    <div id="Vu111450">
    <a href="/manual/vote-note.php?id=111450&amp;page=imagick.getimageformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111450">
    <a href="/manual/vote-note.php?id=111450&amp;page=imagick.getimageformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111450" title="50% like this...">
    0
    </div>
  </div>
  <a href="#111450" class="name">
  <strong class="user"><em>orrd101 at yahoo dot com</em></strong></a><a class="genanchor" href="#111450"> &para;</a><div class="date" title="2013-02-21 12:49"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111450">
<div class="phpcode"><code><span class="html">Use Imagick::queryFormats() to get a list of possible format names that might be returned by this function.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimageformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageformat.php">＋<small>add a note</small></a></div>
