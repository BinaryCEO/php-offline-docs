...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-fetchmime.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-fetchheader.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-fetchstructure.php">
...
<meta name="Description" content="Fetch MIME headers for a particular section of the message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_fetchmime - Manual" />
<meta name="twitter:description" content="Fetch MIME headers for a particular section of the message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_fetchmime - Manual" />
<meta itemprop="description" content="Fetch MIME headers for a particular section of the message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetch MIME headers for a particular section of the message" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-fetchmime.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.imap-fetchmime.php'>Brazilian Portuguese</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.imap-fetchheader.php" class="function" rel="rdfs-seeAlso">imap_fetchheader()</a> - Returns header for a message</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-fetchmime.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-fetchmime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-fetchmime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-fetchmime.php">＋<small>add a note</small></a></span>
