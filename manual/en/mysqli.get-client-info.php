...
<head>
  ...
  <title>PHP: mysqli::$client_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.get-client-info.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.get-client-info.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.get-client-info.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.get-charset.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.get-client-version.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.get-client-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.get-client-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.get-client-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.get-client-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.get-client-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.get-client-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.get-client-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.get-client-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.get-client-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.get-client-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.get-client-info.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mysqli::$client_info - Manual" />
<meta name="twitter:description" content="Get MySQL client info" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::$client_info - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli.get-client-version.php">
          mysqli::$client_version &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.get-charset.php">
          &laquo; mysqli::get_charset        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.get-client-info.php' selected="selected">English</option>
            <option value='de/mysqli.get-client-info.php'>German</option>
            <option value='es/mysqli.get-client-info.php'>Spanish</option>
            <option value='fr/mysqli.get-client-info.php'>French</option>
            <option value='it/mysqli.get-client-info.php'>Italian</option>
            <option value='ja/mysqli.get-client-info.php'>Japanese</option>
            <option value='pt_BR/mysqli.get-client-info.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.get-client-info.php'>Russian</option>
            <option value='tr/mysqli.get-client-info.php'>Turkish</option>
            <option value='uk/mysqli.get-client-info.php'>Ukrainian</option>
            <option value='zh/mysqli.get-client-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.get-client-info" class="refentry">
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli::$client_info</span> -- <span class="refname">mysqli::get_client_info</span> -- <span class="refname">mysqli_get_client_info</span> &mdash; <span class="dc-title">Get MySQL client info</span></p>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.1.0</td>
      <td>
       Calling <span class="function"><strong>mysqli_get_client_info()</strong></span> with the
       <code class="parameter">mysql</code> argument has been deprecated.
     ...
     <tr>
      <td>8.1.0</td>
      <td>
       The object-oriented style <span class="methodname"><strong>mysqli::get_client_info()</strong></span>
       has been deprecated.
      </td>
     </tr>
 ...
 <div class="refsect1 examples" id="refsect1-mysqli.get-client-info-examples">
  ...
  <p class="para">
   <div class="example" id="example-1594">
    <p><strong>Example #1 mysqli_get_client_info</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">/* We don't need a connection to determine<br />   the version of mysql client library */<br /><br /></span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Client library version: %s\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">mysqli_get_client_info</span><span style="color: #007700">());<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli.get-client-info-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli.get-client-version.php" class="function" rel="rdfs-seeAlso">mysqli_get_client_version()</a> - Returns the MySQL client version as an integer</span></li>
    ...
    <li><span class="function"><a href="mysqli.get-server-version.php" class="function" rel="rdfs-seeAlso">mysqli_get_server_version()</a> - Returns the version of the MySQL server as an integer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/get-client-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.get-client-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.get-client-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.get-client-info.php">＋<small>add a note</small></a></span>
