...
<head>
  ...
  <title>PHP: Imagick::newImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.newimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.newimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.newimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.negateimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.newpseudoimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.newimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.newimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.newimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.newimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.newimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.newimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.newimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.newimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.newimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.newimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.newimage.php" hreflang="zh">
...
<meta name="Description" content="Creates a new image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::newImage - Manual" />
<meta name="twitter:description" content="Creates a new image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::newImage - Manual" />
<meta itemprop="description" content="Creates a new image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a new image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.newpseudoimage.php">
          Imagick::newPseudoImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.negateimage.php">
          &laquo; Imagick::negateImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.newimage.php' selected="selected">English</option>
            <option value='de/imagick.newimage.php'>German</option>
            <option value='es/imagick.newimage.php'>Spanish</option>
            <option value='fr/imagick.newimage.php'>French</option>
            <option value='it/imagick.newimage.php'>Italian</option>
            <option value='ja/imagick.newimage.php'>Japanese</option>
            <option value='pt_BR/imagick.newimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.newimage.php'>Russian</option>
            <option value='tr/imagick.newimage.php'>Turkish</option>
            <option value='uk/imagick.newimage.php'>Ukrainian</option>
            <option value='zh/imagick.newimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.newimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::newImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::newImage</span> &mdash; <span class="dc-title">Creates a new image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.newimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::newImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$cols</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rows</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$background</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$format</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.newimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">cols</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.newimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.newimage-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-imagick.newimage-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.newimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3058">
    <p><strong>Example #1 Using <span class="function"><strong>Imagick::newImage()</strong></span>:</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$image </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, new </span><span style="color: #0000BB">ImagickPixel</span><span style="color: #007700">(</span><span style="color: #DD0000">'red'</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">'png'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">'Content-type: image/png'</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$image</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/newimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.newimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.newimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.newimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="91686">  <div class="votes">
    <div id="Vu91686">
    <a href="/manual/vote-note.php?id=91686&amp;page=imagick.newimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91686">
    <a href="/manual/vote-note.php?id=91686&amp;page=imagick.newimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91686" title="76% like this...">
    43
    </div>
  </div>
  <a href="#91686" class="name">
  <strong class="user"><em>christian dot reinecke at web dot de</em></strong></a><a class="genanchor" href="#91686"> &para;</a><div class="date" title="2009-06-23 04:35"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91686">
<div class="phpcode"><code><span class="html">The color value (3rd argument) for transparency is "none".</span></code></div>
  </div>
 </div>
  <div class="note" id="117048">  <div class="votes">
    <div id="Vu117048">
    <a href="/manual/vote-note.php?id=117048&amp;page=imagick.newimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117048">
    <a href="/manual/vote-note.php?id=117048&amp;page=imagick.newimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117048" title="66% like this...">
    5
    </div>
  </div>
  <a href="#117048" class="name">
  <strong class="user"><em>jfalner1 at gmail dot com</em></strong></a><a class="genanchor" href="#117048"> &para;</a><div class="date" title="2015-04-07 06:17"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117048">
<div class="phpcode"><code><span class="html">As it isn't obvious, the cols and rows arguments correspond to the width and height of the new image, expressed in pixels.  Example #1 would generate a 100 pixel by 100 pixel image.</span></code></div>
  </div>
 </div>
  <div class="note" id="119756">  <div class="votes">
    <div id="Vu119756">
    <a href="/manual/vote-note.php?id=119756&amp;page=imagick.newimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119756">
    <a href="/manual/vote-note.php?id=119756&amp;page=imagick.newimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119756" title="100% like this...">
    1
    </div>
  </div>
  <a href="#119756" class="name">
  <strong class="user"><em>Eduard Sukharev</em></strong></a><a class="genanchor" href="#119756"> &para;</a><div class="date" title="2016-08-18 04:39"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119756">
<div class="phpcode"><code><span class="html">It's not obvious and may be related only to some specific versions of ImageMagick (tested only for 6.7.7 and 6.8.9), but $cols and $rows must be a positive non-zero value.<br /><br /><span class="default">&lt;?php<br /><br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'red'</span><span class="keyword">));<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'png'</span><span class="keyword">);<br /><br /></span><span class="default">file_put_contents</span><span class="keyword">(</span><span class="string">'image.png'</span><span class="keyword">, </span><span class="default">$image</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />In this case imagemagick will crash without throwing any exception and you'll get something along the lines (in your apache error log or console output):<br /><br />    unable to acquire cache view `No such file or directory' @ fatal/cache-view.c/AcquireAuthenticCacheView/121.<br /><br />This might be the case when you calculate $cols and $rows (say, based on user input and predefined target image DPI):<br /><br /><span class="default">&lt;?php<br /><br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">$userInput</span><span class="keyword">-&gt;</span><span class="default">getWidth</span><span class="keyword">() * </span><span class="default">$defaultPpi</span><span class="keyword">, </span><span class="default">$userInput</span><span class="keyword">-&gt;</span><span class="default">getHeight</span><span class="keyword">() * </span><span class="default">$defaultPpi</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'white'</span><span class="keyword">));<br /></span><span class="default">?&gt;<br /></span><br />In this case if user requested image with 0.006 width (in inches), the code would work for $defaultPpi = 300 ppi, but would crash for <br />$defaultPpi = 72 ppi</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.newimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.newimage.php">＋<small>add a note</small></a></div>
