...
<head>
  ...
  <title>PHP: ReflectionProperty::getHooks - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.gethooks.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.gethooks.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.gethooks.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.gethook.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.getmodifiers.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.gethooks.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.gethooks.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.gethooks.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.gethooks.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.gethooks.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.gethooks.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.gethooks.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.gethooks.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.gethooks.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.gethooks.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.gethooks.php" hreflang="zh">
...
<meta name="Description" content="Returns an array of all hooks on this property" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::getHooks - Manual" />
<meta name="twitter:description" content="Returns an array of all hooks on this property" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::getHooks - Manual" />
<meta itemprop="description" content="Returns an array of all hooks on this property" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array of all hooks on this property" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionproperty.getmodifiers.php">
          ReflectionProperty::getModifiers &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.gethook.php">
          &laquo; ReflectionProperty::getHook        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.gethooks.php' selected="selected">English</option>
            <option value='de/reflectionproperty.gethooks.php'>German</option>
            <option value='es/reflectionproperty.gethooks.php'>Spanish</option>
            <option value='fr/reflectionproperty.gethooks.php'>French</option>
            <option value='it/reflectionproperty.gethooks.php'>Italian</option>
            <option value='ja/reflectionproperty.gethooks.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.gethooks.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.gethooks.php'>Russian</option>
            <option value='tr/reflectionproperty.gethooks.php'>Turkish</option>
            <option value='uk/reflectionproperty.gethooks.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.gethooks.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.gethooks" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionproperty.gethooks-examples">
  ...
  <div class="example" id="reflectionproperty.gethooks.example.basic">
   <p><strong>Example #1 <span class="methodname"><strong>ReflectionProperty::getHooks()</strong></span> example</strong></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="reflectionproperty.hashooks.php" class="methodname" rel="rdfs-seeAlso">ReflectionProperty::hasHooks()</a> - Returns whether the property has any hooks defined</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/gethooks.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.gethooks%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.gethooks&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.gethooks.php">＋<small>add a note</small></a></span>
