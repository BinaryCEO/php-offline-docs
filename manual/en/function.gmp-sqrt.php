...
<head>
  ...
  <title>PHP: gmp_sqrt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-sqrt.php">
 <link rel="shorturl" href="https://www.php.net/gmp-sqrt">
 <link rel="alternate" href="https://www.php.net/gmp-sqrt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-sign.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-sqrtrem.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-sqrt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-sqrt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-sqrt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-sqrt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-sqrt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-sqrt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-sqrt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-sqrt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-sqrt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-sqrt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-sqrt.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: gmp_sqrt - Manual" />
<meta name="twitter:description" content="Calculate square root" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_sqrt - Manual" />
<meta itemprop="description" content="Calculate square root" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calculate square root" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-sqrt.php' selected="selected">English</option>
            <option value='de/function.gmp-sqrt.php'>German</option>
            <option value='es/function.gmp-sqrt.php'>Spanish</option>
            <option value='fr/function.gmp-sqrt.php'>French</option>
            <option value='it/function.gmp-sqrt.php'>Italian</option>
            <option value='ja/function.gmp-sqrt.php'>Japanese</option>
            <option value='pt_BR/function.gmp-sqrt.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-sqrt.php'>Russian</option>
            <option value='tr/function.gmp-sqrt.php'>Turkish</option>
            <option value='uk/function.gmp-sqrt.php'>Ukrainian</option>
            <option value='zh/function.gmp-sqrt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-sqrt" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_sqrt</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_sqrt</span> &mdash; <span class="dc-title">Calculate square root</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-sqrt-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_sqrt</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num</code></span>): <span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span></div>

  <p class="para rdfs-comment">
   Calculates square root of <code class="parameter">num</code>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.gmp-sqrt-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-sqrt-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-sqrt-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3353">
    <p><strong>Example #1 <span class="function"><strong>gmp_sqrt()</strong></span> example</strong></p>
...
1234567890</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-sqrt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-sqrt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-sqrt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-sqrt.php">＋<small>add a note</small></a></span>
