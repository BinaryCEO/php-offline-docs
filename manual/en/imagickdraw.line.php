...
<head>
  ...
  <title>PHP: ImagickDraw::line - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.line.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.line.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.line.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getvectorgraphics.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.matte.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.line.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.line.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.line.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.line.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.line.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.line.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.line.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.line.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.line.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.line.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.line.php" hreflang="zh">
...
<meta name="Description" content="Draws a line" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::line - Manual" />
<meta name="twitter:description" content="Draws a line" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::line - Manual" />
<meta itemprop="description" content="Draws a line" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws a line" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.matte.php">
          ImagickDraw::matte &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getvectorgraphics.php">
          &laquo; ImagickDraw::getVectorGraphics        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.line.php' selected="selected">English</option>
            <option value='de/imagickdraw.line.php'>German</option>
            <option value='es/imagickdraw.line.php'>Spanish</option>
            <option value='fr/imagickdraw.line.php'>French</option>
            <option value='it/imagickdraw.line.php'>Italian</option>
            <option value='ja/imagickdraw.line.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.line.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.line.php'>Russian</option>
            <option value='tr/imagickdraw.line.php'>Turkish</option>
            <option value='uk/imagickdraw.line.php'>Ukrainian</option>
            <option value='zh/imagickdraw.line.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.line" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::line</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::line</span> &mdash; <span class="dc-title">Draws a line</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.line-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::line</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$start_x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$start_y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$end_x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$end_y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.line-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.line-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3151">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/line.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.line%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.line&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.line.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96397">  <div class="votes">
    <div id="Vu96397">
    <a href="/manual/vote-note.php?id=96397&amp;page=imagickdraw.line&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96397">
    <a href="/manual/vote-note.php?id=96397&amp;page=imagickdraw.line&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96397" title="42% like this...">
    -1
    </div>
  </div>
  <a href="#96397" class="name">
  <strong class="user"><em>GaryM at BinaryFarm dot com</em></strong></a><a class="genanchor" href="#96397"> &para;</a><div class="date" title="2010-02-24 11:48"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96397">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br /></span><span class="comment">// a twist on the above radar screen. <br />// This makes random colored spokes from a center point<br /><br />    </span><span class="default">$width </span><span class="keyword">=  </span><span class="default">400</span><span class="keyword">;<br />    </span><span class="default">$height </span><span class="keyword">= </span><span class="default">400</span><span class="keyword">;<br />   <br />    </span><span class="default">$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">( </span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">( </span><span class="string">'wheat' </span><span class="keyword">) );<br />    </span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();<br />   </span><span class="comment">//$draw-&gt;setStrokeColor( new ImagickPixel( 'black' ) );<br /><br />    </span><span class="default">$rx </span><span class="keyword">= </span><span class="default">$width </span><span class="keyword">/ </span><span class="default">2</span><span class="keyword">;<br />    </span><span class="default">$ry </span><span class="keyword">= </span><span class="default">$height </span><span class="keyword">/ </span><span class="default">2</span><span class="keyword">;<br />    </span><span class="default">$total </span><span class="keyword">= </span><span class="default">2</span><span class="keyword">*</span><span class="default">M_PI</span><span class="keyword">;<br />    </span><span class="default">$part </span><span class="keyword">= </span><span class="default">$total </span><span class="keyword">/ </span><span class="default">16</span><span class="keyword">;<br />    while( </span><span class="default">$total </span><span class="keyword">&gt; </span><span class="default">0  </span><span class="keyword">)<br />    {<br />        </span><span class="default">$ex </span><span class="keyword">= </span><span class="default">$rx </span><span class="keyword">+</span><span class="default">$rx </span><span class="keyword">* </span><span class="default">sin</span><span class="keyword">( </span><span class="default">$total </span><span class="keyword">);<br />        </span><span class="default">$ey </span><span class="keyword">= </span><span class="default">$ry </span><span class="keyword">+</span><span class="default">$ry </span><span class="keyword">* </span><span class="default">cos</span><span class="keyword">( </span><span class="default">$total </span><span class="keyword">);<br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">line  </span><span class="keyword">( </span><span class="default">$rx</span><span class="keyword">, </span><span class="default">$ry</span><span class="keyword">, </span><span class="default">$ex</span><span class="keyword">, </span><span class="default">$ey </span><span class="keyword">);<br />        </span><span class="default">$total </span><span class="keyword">-= </span><span class="default">$part</span><span class="keyword">;<br /><br />    </span><span class="comment">// We need three HEX numbers to create an RGB color code like '#FF33DD'.<br /><br />    </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setStrokeColor</span><span class="keyword">( </span><span class="default">get_random_color</span><span class="keyword">() );<br />    }<br />    </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">( </span><span class="default">$draw </span><span class="keyword">);<br />    </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">( </span><span class="string">"png" </span><span class="keyword">);<br />    </span><span class="default">header</span><span class="keyword">( </span><span class="string">"Content-Type: image/png" </span><span class="keyword">);<br />    echo </span><span class="default">$image</span><span class="keyword">;<br />    exit;<br /><br />function </span><span class="default">get_random_color</span><span class="keyword">()        </span><span class="comment">// Thanks to Greg R. for this nice little function.<br /></span><span class="keyword">{<br />    for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">&lt;</span><span class="default">6</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++)<br />    {<br />        </span><span class="default">$c </span><span class="keyword">.=  </span><span class="default">dechex</span><span class="keyword">(</span><span class="default">rand</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">15</span><span class="keyword">));<br />    }<br />    return </span><span class="string">"#</span><span class="default">$c</span><span class="string">"</span><span class="keyword">;<br />} <br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.line&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.line.php">＋<small>add a note</small></a></div>
