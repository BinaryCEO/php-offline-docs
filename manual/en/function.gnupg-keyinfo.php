...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$gpg </span><span style="color: #007700">= new </span><span style="color: #0000BB">gnupg</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$info </span><span style="color: #007700">= </span><span style="color: #0000BB">$gpg</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">keyinfo</span><span style="color: #007700">(</span><span style="color: #DD0000">"test"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">$info</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="head">
  ...
  <div class="note" id="112619">  <div class="votes">
    ...
    <div class="tally" id="V112619" title="81% like this...">
    10
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">You CAN list all keys in the keyring, you only have to pass an empty string ''.<br /><br /><span class="default">&lt;?php<br />$gpg </span><span class="keyword">= new </span><span class="default">gnupg</span><span class="keyword">();<br /></span><span class="default">$info </span><span class="keyword">= </span><span class="default">$gpg </span><span class="keyword">-&gt; </span><span class="default">keyinfo</span><span class="keyword">(</span><span class="string">''</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$info</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />That's it! ;)</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Returns an array of information blocks. An information block looks like<br /><span class="default">&lt;?php<br /></span><span class="keyword">array (<br />    </span><span class="string">'disabled' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'expired' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'revoked' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'is_secret' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'can_sign' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'can_encrypt' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'uids' </span><span class="keyword">=&gt; &lt;array </span><span class="default">of uid blocks</span><span class="keyword">&gt;,<br />    </span><span class="string">'subkeys' </span><span class="keyword">=&gt; &lt;array </span><span class="default">of subkey blocks</span><span class="keyword">&gt;,<br />)<br /></span><span class="default">?&gt;<br /></span>An uid data block looks like<br /><span class="default">&lt;?php<br /></span><span class="keyword">array (<br />    </span><span class="string">'name' </span><span class="keyword">=&gt; &lt;</span><span class="default">string</span><span class="keyword">&gt;,<br />    </span><span class="string">'comment' </span><span class="keyword">=&gt; &lt;</span><span class="default">string</span><span class="keyword">&gt;,<br />    </span><span class="string">'email' </span><span class="keyword">=&gt; &lt;</span><span class="default">string</span><span class="keyword">&gt;,<br />    </span><span class="string">'uid' </span><span class="keyword">=&gt; &lt;</span><span class="default">string</span><span class="keyword">&gt;,<br />    </span><span class="string">'revoked' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'invalid' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />)<br /></span><span class="default">?&gt;<br /></span>A subkey block looks like<br /><span class="default">&lt;?php<br /></span><span class="keyword">array (<br />    </span><span class="string">'fingerprint' </span><span class="keyword">=&gt; &lt;</span><span class="default">string</span><span class="keyword">&gt;,<br />    </span><span class="string">'keyid' </span><span class="keyword">=&gt; &lt;</span><span class="default">string</span><span class="keyword">&gt;,<br />    </span><span class="string">'timestamp' </span><span class="keyword">=&gt; &lt;</span><span class="default">int</span><span class="keyword">&gt;,<br />    </span><span class="string">'expires' </span><span class="keyword">=&gt; &lt;</span><span class="default">int</span><span class="keyword">&gt;,<br />    </span><span class="string">'is_secret' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'invalid' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'can_encrypt' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'can_sign' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'disabled' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'expired' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />    </span><span class="string">'revoked' </span><span class="keyword">=&gt; &lt;</span><span class="default">bool</span><span class="keyword">&gt;,<br />),<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
