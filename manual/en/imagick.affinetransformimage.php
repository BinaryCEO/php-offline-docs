...
<head>
  ...
  <title>PHP: Imagick::affineTransformImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.affinetransformimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.affinetransformimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.affinetransformimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.addnoiseimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.animateimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.affinetransformimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.affinetransformimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.affinetransformimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.affinetransformimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.affinetransformimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.affinetransformimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.affinetransformimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.affinetransformimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.affinetransformimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.affinetransformimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.affinetransformimage.php" hreflang="zh">
...
<meta name="Description" content="Transforms an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::affineTransformImage - Manual" />
<meta name="twitter:description" content="Transforms an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::affineTransformImage - Manual" />
<meta itemprop="description" content="Transforms an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Transforms an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.animateimages.php">
          Imagick::animateImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.addnoiseimage.php">
          &laquo; Imagick::addNoiseImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.affinetransformimage.php' selected="selected">English</option>
            <option value='de/imagick.affinetransformimage.php'>German</option>
            <option value='es/imagick.affinetransformimage.php'>Spanish</option>
            <option value='fr/imagick.affinetransformimage.php'>French</option>
            <option value='it/imagick.affinetransformimage.php'>Italian</option>
            <option value='ja/imagick.affinetransformimage.php'>Japanese</option>
            <option value='pt_BR/imagick.affinetransformimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.affinetransformimage.php'>Russian</option>
            <option value='tr/imagick.affinetransformimage.php'>Turkish</option>
            <option value='uk/imagick.affinetransformimage.php'>Ukrainian</option>
            <option value='zh/imagick.affinetransformimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.affinetransformimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::affineTransformImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::affineTransformImage</span> &mdash; <span class="dc-title">Transforms an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.affinetransformimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::affineTransformImage</strong></span>(<span class="methodparam"><span class="type"><a href="class.imagickdraw.php" class="type ImagickDraw">ImagickDraw</a></span> <code class="parameter">$matrix</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.affinetransformimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.affinetransformimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-2967">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/affinetransformimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.affinetransformimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.affinetransformimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.affinetransformimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124738">  <div class="votes">
    <div id="Vu124738">
    <a href="/manual/vote-note.php?id=124738&amp;page=imagick.affinetransformimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124738">
    <a href="/manual/vote-note.php?id=124738&amp;page=imagick.affinetransformimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124738" title="100% like this...">
    2
    </div>
  </div>
  <a href="#124738" class="name">
  <strong class="user"><em>SkepticaLee</em></strong></a><a class="genanchor" href="#124738"> &para;</a><div class="date" title="2020-02-19 08:37"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124738">
<div class="phpcode"><code><span class="html">This function is obsolete. Use distortImage() instead, with the affine transformation constant, and an array of six values, sx, rx, ry, sy, tx, ty.</span></code></div>
  </div>
 </div>
  <div class="note" id="116415">  <div class="votes">
    <div id="Vu116415">
    <a href="/manual/vote-note.php?id=116415&amp;page=imagick.affinetransformimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116415">
    <a href="/manual/vote-note.php?id=116415&amp;page=imagick.affinetransformimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116415" title="50% like this...">
    0
    </div>
  </div>
  <a href="#116415" class="name">
  <strong class="user"><em>peter dot e dot lind at gmail dot com</em></strong></a><a class="genanchor" href="#116415"> &para;</a><div class="date" title="2014-12-30 08:27"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116415">
<div class="phpcode"><code><span class="html">This method has not been properly implemented it seems - it has no effect whatsoever on the image.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.affinetransformimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.affinetransformimage.php">＋<small>add a note</small></a></div>
