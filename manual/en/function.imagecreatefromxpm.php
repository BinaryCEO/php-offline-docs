...
<head>
  ...
  <title>PHP: imagecreatefromxpm - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecreatefromxpm.php">
 <link rel="shorturl" href="https://www.php.net/imagecreatefromxpm">
 <link rel="alternate" href="https://www.php.net/imagecreatefromxpm" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecreatefromxbm.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecreatetruecolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecreatefromxpm.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecreatefromxpm.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecreatefromxpm.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecreatefromxpm.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecreatefromxpm.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecreatefromxpm.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecreatefromxpm.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecreatefromxpm.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecreatefromxpm.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecreatefromxpm.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecreatefromxpm.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: imagecreatefromxpm - Manual" />
<meta name="twitter:description" content="Create a new image from file or URL" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecreatefromxpm - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagecreatetruecolor.php">
          imagecreatetruecolor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagecreatefromxbm.php">
          &laquo; imagecreatefromxbm        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecreatefromxpm.php' selected="selected">English</option>
            <option value='de/function.imagecreatefromxpm.php'>German</option>
            <option value='es/function.imagecreatefromxpm.php'>Spanish</option>
            <option value='fr/function.imagecreatefromxpm.php'>French</option>
            <option value='it/function.imagecreatefromxpm.php'>Italian</option>
            <option value='ja/function.imagecreatefromxpm.php'>Japanese</option>
            <option value='pt_BR/function.imagecreatefromxpm.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecreatefromxpm.php'>Russian</option>
            <option value='tr/function.imagecreatefromxpm.php'>Turkish</option>
            <option value='uk/function.imagecreatefromxpm.php'>Ukrainian</option>
            <option value='zh/function.imagecreatefromxpm.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecreatefromxpm" class="refentry">
...
provide.</p></div>
 ...
 <div class="refsect1 examples" id="refsect1-function.imagecreatefromxpm-examples">
  ...
  <p class="para">
   <div class="example" id="example-2875">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Check for XPM support<br /></span><span style="color: #007700">if(!(</span><span style="color: #0000BB">imagetypes</span><span style="color: #007700">() &amp; </span><span style="color: #0000BB">IMG_XPM</span><span style="color: #007700">))<br />{<br />    die(</span><span style="color: #DD0000">'Support for xpm was not found!'</span><span style="color: #007700">);<br />}<br /><br /></span><span style="color: #FF8000">// Create the image instance<br /></span><span style="color: #0000BB">$xpm </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatefromxpm</span><span style="color: #007700">(</span><span style="color: #DD0000">'./example.xpm'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Do image operations here<br /><br />// PHP has no support for writing xpm images<br />// so in this case we save the image as a <br />// jpeg file with 100% quality<br /></span><span style="color: #0000BB">imagejpeg</span><span style="color: #007700">(</span><span style="color: #0000BB">$xpm</span><span style="color: #007700">, </span><span style="color: #DD0000">'./example.jpg'</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecreatefromxpm.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecreatefromxpm%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecreatefromxpm&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecreatefromxpm.php">＋<small>add a note</small></a></span>
