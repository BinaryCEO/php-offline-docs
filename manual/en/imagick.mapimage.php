...
<head>
  ...
  <title>PHP: Imagick::mapImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.mapimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.mapimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.mapimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.magnifyimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.mattefloodfillimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.mapimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.mapimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.mapimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.mapimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.mapimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.mapimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.mapimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.mapimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.mapimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.mapimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.mapimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::mapImage - Manual" />
...
<meta itemprop="name" content="PHP: Imagick::mapImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.mattefloodfillimage.php">
          Imagick::matteFloodfillImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.magnifyimage.php">
          &laquo; Imagick::magnifyImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.mapimage.php' selected="selected">English</option>
            <option value='de/imagick.mapimage.php'>German</option>
            <option value='es/imagick.mapimage.php'>Spanish</option>
            <option value='fr/imagick.mapimage.php'>French</option>
            <option value='it/imagick.mapimage.php'>Italian</option>
            <option value='ja/imagick.mapimage.php'>Japanese</option>
            <option value='pt_BR/imagick.mapimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.mapimage.php'>Russian</option>
            <option value='tr/imagick.mapimage.php'>Turkish</option>
            <option value='uk/imagick.mapimage.php'>Ukrainian</option>
            <option value='zh/imagick.mapimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.mapimage" class="refentry">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/mapimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.mapimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.mapimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.mapimage.php">＋<small>add a note</small></a></span>
