...
<head>
  ...
  <title>PHP: ssh2_publickey_list - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ssh2-publickey-list.php">
 <link rel="shorturl" href="https://www.php.net/ssh2-publickey-list">
 <link rel="alternate" href="https://www.php.net/ssh2-publickey-list" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ssh2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ssh2-publickey-init.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ssh2-publickey-remove.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ssh2-publickey-list.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ssh2-publickey-list.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ssh2-publickey-list.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ssh2-publickey-list.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ssh2-publickey-list.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ssh2-publickey-list.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ssh2-publickey-list.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ssh2-publickey-list.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ssh2-publickey-list.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ssh2-publickey-list.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ssh2-publickey-list.php" hreflang="zh">
...
<meta name="Description" content="List currently authorized publickeys" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ssh2_publickey_list - Manual" />
<meta name="twitter:description" content="List currently authorized publickeys" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ssh2_publickey_list - Manual" />
<meta itemprop="description" content="List currently authorized publickeys" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="List currently authorized publickeys" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ssh2-publickey-remove.php">
          ssh2_publickey_remove &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ssh2-publickey-init.php">
          &laquo; ssh2_publickey_init        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ssh2-publickey-list.php' selected="selected">English</option>
            <option value='de/function.ssh2-publickey-list.php'>German</option>
            <option value='es/function.ssh2-publickey-list.php'>Spanish</option>
            <option value='fr/function.ssh2-publickey-list.php'>French</option>
            <option value='it/function.ssh2-publickey-list.php'>Italian</option>
            <option value='ja/function.ssh2-publickey-list.php'>Japanese</option>
            <option value='pt_BR/function.ssh2-publickey-list.php'>Brazilian Portuguese</option>
            <option value='ru/function.ssh2-publickey-list.php'>Russian</option>
            <option value='tr/function.ssh2-publickey-list.php'>Turkish</option>
            <option value='uk/function.ssh2-publickey-list.php'>Ukrainian</option>
            <option value='zh/function.ssh2-publickey-list.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ssh2-publickey-list" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ssh2-publickey-list-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ssh2_publickey_list</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$pkey</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
    ...
    <caption><strong>Publickey elements</strong></caption>
     ...
     <tbody class="tbody">
      <tr>
       ...
       <code class="literal">ssh-dss</code> or <code class="literal">ssh-rsa</code>.</td>
      </tr>
      ...
      <tr>
       ...
       servers, is <code class="literal">comment</code>, which may be any freeform
       string.</td>
      </tr>
...
<div class="examplescode"><pre class="examplescode">Key: ssh-rsa
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ssh2-publickey-remove.php" class="function" rel="rdfs-seeAlso">ssh2_publickey_remove()</a> - Remove an authorized publickey</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ssh2/functions/ssh2-publickey-list.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ssh2-publickey-list%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ssh2-publickey-list&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ssh2-publickey-list.php">＋<small>add a note</small></a></span>
