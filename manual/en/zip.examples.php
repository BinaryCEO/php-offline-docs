...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/zip.examples.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/zip.examples.php">
 <link rel="alternate" href="https://www.php.net/manual/en/zip.examples.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.zip.php">
 <link rel="prev" href="https://www.php.net/manual/en/zip.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/class.ziparchive.php">

 <link rel="alternate" href="https://www.php.net/manual/en/zip.examples.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/zip.examples.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/zip.examples.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/zip.examples.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/zip.examples.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/zip.examples.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/zip.examples.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/zip.examples.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/zip.examples.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/zip.examples.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/zip.examples.php" hreflang="zh">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$zip </span><span style="color: #007700">= </span><span style="color: #0000BB">zip_open</span><span style="color: #007700">(</span><span style="color: #DD0000">"/tmp/test2.zip"</span><span style="color: #007700">);<br /><br />if (</span><span style="color: #0000BB">$zip</span><span style="color: #007700">) {<br />    while (</span><span style="color: #0000BB">$zip_entry </span><span style="color: #007700">= </span><span style="color: #0000BB">zip_read</span><span style="color: #007700">(</span><span style="color: #0000BB">$zip</span><span style="color: #007700">)) {<br />        echo </span><span style="color: #DD0000">"Name:               " </span><span style="color: #007700">. </span><span style="color: #0000BB">zip_entry_name</span><span style="color: #007700">(</span><span style="color: #0000BB">$zip_entry</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Actual Filesize:    " </span><span style="color: #007700">. </span><span style="color: #0000BB">zip_entry_filesize</span><span style="color: #007700">(</span><span style="color: #0000BB">$zip_entry</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Compressed Size:    " </span><span style="color: #007700">. </span><span style="color: #0000BB">zip_entry_compressedsize</span><span style="color: #007700">(</span><span style="color: #0000BB">$zip_entry</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Compression Method: " </span><span style="color: #007700">. </span><span style="color: #0000BB">zip_entry_compressionmethod</span><span style="color: #007700">(</span><span style="color: #0000BB">$zip_entry</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br />        if (</span><span style="color: #0000BB">zip_entry_open</span><span style="color: #007700">(</span><span style="color: #0000BB">$zip</span><span style="color: #007700">, </span><span style="color: #0000BB">$zip_entry</span><span style="color: #007700">, </span><span style="color: #DD0000">"r"</span><span style="color: #007700">)) {<br />            echo </span><span style="color: #DD0000">"File Contents:\n"</span><span style="color: #007700">;<br />            </span><span style="color: #0000BB">$buf </span><span style="color: #007700">= </span><span style="color: #0000BB">zip_entry_read</span><span style="color: #007700">(</span><span style="color: #0000BB">$zip_entry</span><span style="color: #007700">, </span><span style="color: #0000BB">zip_entry_filesize</span><span style="color: #007700">(</span><span style="color: #0000BB">$zip_entry</span><span style="color: #007700">));<br />            echo </span><span style="color: #DD0000">"</span><span style="color: #0000BB">$buf</span><span style="color: #DD0000">\n"</span><span style="color: #007700">;<br /><br />            </span><span style="color: #0000BB">zip_entry_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$zip_entry</span><span style="color: #007700">);<br />        }<br />        echo </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br />    }<br /><br />    </span><span style="color: #0000BB">zip_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$zip</span><span style="color: #007700">);<br /><br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fzip.examples%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=zip.examples&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zip.examples.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="85714">  <div class="votes">
    <div id="Vu85714">
    <a href="/manual/vote-note.php?id=85714&amp;page=zip.examples&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd85714">
    <a href="/manual/vote-note.php?id=85714&amp;page=zip.examples&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V85714" title="74% like this...">
    41
    </div>
  </div>
  <a href="#85714" class="name">
  <strong class="user"><em>info at peterhofer dot ch</em></strong></a><a class="genanchor" href="#85714"> &para;</a><div class="date" title="2008-09-13 09:03"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom85714">
<div class="phpcode"><code><span class="html">All these examples will not work if the php script has no write access within the folder. <br /><br />Although you may say this is obvious, I found that in this case, $zip-&gt;open("name", ZIPARCHIVE::CREATE) doesn't return an error as it might not try to access the file system but rather allocates memory. <br /><br />It is only $zip-&gt;close() that returns the error. This might cause you seeking at the wrong end.</span></code></div>
  </div>
 </div>
  <div class="note" id="112538">  <div class="votes">
    <div id="Vu112538">
    <a href="/manual/vote-note.php?id=112538&amp;page=zip.examples&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112538">
    <a href="/manual/vote-note.php?id=112538&amp;page=zip.examples&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112538" title="61% like this...">
    8
    </div>
  </div>
  <a href="#112538" class="name">
  <strong class="user"><em>webmaster @ anonymous</em></strong></a><a class="genanchor" href="#112538"> &para;</a><div class="date" title="2013-06-27 04:38"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112538">
<div class="phpcode"><code><span class="html">you can use this code for reading JAR files (java archives)<br /><br />JAR files use the same ZIP format, so can be easily read<br /><br />$zf = zip_open(realpath('D:/lucene/allinone/lucene-core.jar')); $i=1;<br />while($zf &amp;&amp; $ze = zip_read($zf)) {<br />    $zi[$i]['zip entry name']= zip_entry_name($ze);<br />    $zi[$i]['zip entry filesize']= zip_entry_filesize($ze);<br />    $zi[$i]['zip entry compressed size']= zip_entry_compressedsize($ze);<br />    $zi[$i]['zip entry compression method']= zip_entry_compressionmethod($ze);<br />    $zi[$i]['zip entry open status'] = zip_entry_open($zf,$ze);<br />    //$zi[$i]['zip entry file contents'] = zip_entry_read($ze,100);<br />    $i++;<br />}<br />print_r($zi);<br />zip_close($zf);</span></code></div>
  </div>
 </div>
  <div class="note" id="82590">  <div class="votes">
    <div id="Vu82590">
    <a href="/manual/vote-note.php?id=82590&amp;page=zip.examples&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd82590">
    <a href="/manual/vote-note.php?id=82590&amp;page=zip.examples&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V82590" title="57% like this...">
    11
    </div>
  </div>
  <a href="#82590" class="name">
  <strong class="user"><em>geandjay at gmail dot com</em></strong></a><a class="genanchor" href="#82590"> &para;</a><div class="date" title="2008-04-17 09:25"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom82590">
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="86131">  <div class="votes">
    <div id="Vu86131">
    <a href="/manual/vote-note.php?id=86131&amp;page=zip.examples&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd86131">
    <a href="/manual/vote-note.php?id=86131&amp;page=zip.examples&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V86131" title="48% like this...">
    -1
    </div>
  </div>
  <a href="#86131" class="name">
  <strong class="user"><em>Stefano Di Paolo</em></strong></a><a class="genanchor" href="#86131"> &para;</a><div class="date" title="2008-10-04 07:13"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86131">
<div class="phpcode"><code><span class="html">1) If you want to add files to a ZIP archive but you don't know if the ZiP file exists or not, you MUST check: this changes the way you open it !.<br />2) you can not append multiple flags, can use only one (or none).<br /><br />If the zip does not exists, open it with: <br />$ziph-&gt;open($archiveFile, ZIPARCHIVE::CM_PKWARE_IMPLODE)<br />(or a different compression method)<br /><br />If the zip already exists, open it with:<br />$ziph-&gt;open($archiveFile)<br />or<br />$ziph-&gt;open($archiveFile, ZIPARCHIVE::CHECKCONS)<br /><br />Example: make backup files every hour and ZIP them all in a daily ZIP archive, so you want to get only one ZIP per day, each ZIP containing 24 files:<br /><span class="default">&lt;?php<br />  </span><span class="keyword">function </span><span class="default">archivebackup</span><span class="keyword">(</span><span class="default">$archiveFile</span><span class="keyword">, </span><span class="default">$file</span><span class="keyword">, &amp;</span><span class="default">$errMsg</span><span class="keyword">)<br />  {<br />    </span><span class="default">$ziph </span><span class="keyword">= new </span><span class="default">ZipArchive</span><span class="keyword">();<br />    if(</span><span class="default">file_exists</span><span class="keyword">(</span><span class="default">$archiveFile</span><span class="keyword">))<br />    {<br />      if(</span><span class="default">$ziph</span><span class="keyword">-&gt;</span><span class="default">open</span><span class="keyword">(</span><span class="default">$archiveFile</span><span class="keyword">, </span><span class="default">ZIPARCHIVE</span><span class="keyword">::</span><span class="default">CHECKCONS</span><span class="keyword">) !== </span><span class="default">TRUE</span><span class="keyword">)<br />      {<br />        </span><span class="default">$errMsg </span><span class="keyword">= </span><span class="string">"Unable to Open </span><span class="default">$archiveFile</span><span class="string">"</span><span class="keyword">;<br />        return </span><span class="default">1</span><span class="keyword">;<br />      }<br />    }<br />    else<br />    {<br />      if(</span><span class="default">$ziph</span><span class="keyword">-&gt;</span><span class="default">open</span><span class="keyword">(</span><span class="default">$archiveFile</span><span class="keyword">, </span><span class="default">ZIPARCHIVE</span><span class="keyword">::</span><span class="default">CM_PKWARE_IMPLODE</span><span class="keyword">) !== </span><span class="default">TRUE</span><span class="keyword">)<br />      {<br />        </span><span class="default">$errMsg </span><span class="keyword">= </span><span class="string">"Could not Create </span><span class="default">$archiveFile</span><span class="string">"</span><span class="keyword">;<br />        return </span><span class="default">1</span><span class="keyword">;<br />      }<br />    }<br />    if(!</span><span class="default">$ziph</span><span class="keyword">-&gt;</span><span class="default">addFile</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">))<br />    {<br />      </span><span class="default">$errMsg </span><span class="keyword">= </span><span class="string">"error archiving </span><span class="default">$file</span><span class="string"> in </span><span class="default">$archiveFile</span><span class="string">"</span><span class="keyword">;<br />      return </span><span class="default">2</span><span class="keyword">;<br />    }<br />    </span><span class="default">$ziph</span><span class="keyword">-&gt;</span><span class="default">close</span><span class="keyword">();<br />    <br />    return </span><span class="default">0</span><span class="keyword">;<br />  }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=zip.examples&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zip.examples.php">＋<small>add a note</small></a></div>
