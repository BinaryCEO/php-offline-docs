...
<head>
  ...
  <title>PHP: MongoDB\Driver\Monitoring\LogSubscriber - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-monitoring-logsubscriber.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-monitoring-logsubscriber">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-monitoring-logsubscriber" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.monitoring.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-monitoring-commandsubscriber.commandsucceeded.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-monitoring-logsubscriber.log.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-monitoring-logsubscriber.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-monitoring-logsubscriber.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-monitoring-logsubscriber.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-monitoring-logsubscriber.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-monitoring-logsubscriber.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-monitoring-logsubscriber.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-monitoring-logsubscriber.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-monitoring-logsubscriber.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-monitoring-logsubscriber.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-monitoring-logsubscriber.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-monitoring-logsubscriber.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\Monitoring\LogSubscriber interface" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Monitoring\LogSubscriber - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\Monitoring\LogSubscriber interface" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Monitoring\LogSubscriber - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\Monitoring\LogSubscriber interface" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\Monitoring\LogSubscriber interface" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-monitoring-logsubscriber.log.php">
          MongoDB\Driver\Monitoring\LogSubscriber::log &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-monitoring-commandsubscriber.commandsucceeded.php">
          &laquo; MongoDB\Driver\Monitoring\CommandSubscriber::commandSucceeded        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-monitoring-logsubscriber.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-monitoring-logsubscriber.php'>German</option>
            <option value='es/class.mongodb-driver-monitoring-logsubscriber.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-monitoring-logsubscriber.php'>French</option>
            <option value='it/class.mongodb-driver-monitoring-logsubscriber.php'>Italian</option>
            <option value='ja/class.mongodb-driver-monitoring-logsubscriber.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-monitoring-logsubscriber.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-monitoring-logsubscriber.php'>Russian</option>
            <option value='tr/class.mongodb-driver-monitoring-logsubscriber.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-monitoring-logsubscriber.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-monitoring-logsubscriber.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-monitoring-logsubscriber" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-monitoring-logsubscriber.log.php">MongoDB\Driver\Monitoring\LogSubscriber::log</a> — Notification method for a log message</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/monitoring/logsubscriber.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-monitoring-logsubscriber%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-monitoring-logsubscriber&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-monitoring-logsubscriber.php">＋<small>add a note</small></a></span>
