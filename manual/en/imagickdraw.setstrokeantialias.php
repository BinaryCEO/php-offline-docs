...
<head>
  ...
  <title>PHP: ImagickDraw::setStrokeAntialias - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setstrokeantialias.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setstrokeantialias.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokeantialias.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setstrokealpha.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setstrokecolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokeantialias.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setstrokeantialias.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setstrokeantialias.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setstrokeantialias.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setstrokeantialias.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setstrokeantialias.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setstrokeantialias.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setstrokeantialias.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setstrokeantialias.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setstrokeantialias.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setstrokeantialias.php" hreflang="zh">
...
<meta name="Description" content="Controls whether stroked outlines are antialiased" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setStrokeAntialias - Manual" />
<meta name="twitter:description" content="Controls whether stroked outlines are antialiased" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setStrokeAntialias - Manual" />
<meta itemprop="description" content="Controls whether stroked outlines are antialiased" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Controls whether stroked outlines are antialiased" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setstrokecolor.php">
          ImagickDraw::setStrokeColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setstrokealpha.php">
          &laquo; ImagickDraw::setStrokeAlpha        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setstrokeantialias.php' selected="selected">English</option>
            <option value='de/imagickdraw.setstrokeantialias.php'>German</option>
            <option value='es/imagickdraw.setstrokeantialias.php'>Spanish</option>
            <option value='fr/imagickdraw.setstrokeantialias.php'>French</option>
            <option value='it/imagickdraw.setstrokeantialias.php'>Italian</option>
            <option value='ja/imagickdraw.setstrokeantialias.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setstrokeantialias.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setstrokeantialias.php'>Russian</option>
            <option value='tr/imagickdraw.setstrokeantialias.php'>Turkish</option>
            <option value='uk/imagickdraw.setstrokeantialias.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setstrokeantialias.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setstrokeantialias" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setStrokeAntialias</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setStrokeAntialias</span> &mdash; <span class="dc-title">Controls whether stroked outlines are antialiased</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setstrokeantialias-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setStrokeAntialias</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$enabled</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setstrokeantialias-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">enabled</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setstrokeantialias-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3182">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setstrokeantialias.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setstrokeantialias%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setstrokeantialias&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokeantialias.php">＋<small>add a note</small></a></span>
