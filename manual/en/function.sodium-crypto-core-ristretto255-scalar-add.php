...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-scalar-add.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-random.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-scalar-complement.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-core-ristretto255-scalar-add.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.sodium-crypto-core-ristretto255-scalar-add.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 8 &gt;= 8.1.0)</p><p class="refpurpose"><span class="refname">sodium_crypto_core_ristretto255_scalar_add</span> &mdash; <span class="dc-title">Adds a scalar value</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.sodium-crypto-core-ristretto255-scalar-add-description">
  ...
  <p class="para rdfs-comment">
   Adds an element <code class="parameter">y</code> to <code class="parameter">x</code>.
 ...
 <div class="refsect1 examples" id="refsect1-function.sodium-crypto-core-ristretto255-scalar-add-examples">
  ...
  <p class="para">
   <div class="example" id="example-1068">
    <p><strong>Example #1 <span class="function"><strong>sodium_crypto_core_ristretto255_scalar_add()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.sodium-crypto-core-ristretto255-scalar-sub.php" class="function" rel="rdfs-seeAlso">sodium_crypto_core_ristretto255_scalar_sub()</a> - Subtracts a scalar value</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-core-ristretto255-scalar-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-core-ristretto255-scalar-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-core-ristretto255-scalar-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-scalar-add.php">＋<small>add a note</small></a></span>
