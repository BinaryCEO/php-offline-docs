...
<head>
  ...
  <title>PHP: pg_client_encoding - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-client-encoding.php">
 <link rel="shorturl" href="https://www.php.net/pg-client-encoding">
 <link rel="alternate" href="https://www.php.net/pg-client-encoding" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-cancel-query.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-client-encoding.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-client-encoding.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-client-encoding.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-client-encoding.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-client-encoding.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-client-encoding.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-client-encoding.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-client-encoding.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-client-encoding.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-client-encoding.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-client-encoding.php" hreflang="zh">
...
<meta name="Description" content="Gets the client encoding" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_client_encoding - Manual" />
<meta name="twitter:description" content="Gets the client encoding" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_client_encoding - Manual" />
<meta itemprop="description" content="Gets the client encoding" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the client encoding" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-client-encoding.php' selected="selected">English</option>
            <option value='de/function.pg-client-encoding.php'>German</option>
            <option value='es/function.pg-client-encoding.php'>Spanish</option>
            <option value='fr/function.pg-client-encoding.php'>French</option>
            <option value='it/function.pg-client-encoding.php'>Italian</option>
            <option value='ja/function.pg-client-encoding.php'>Japanese</option>
            <option value='pt_BR/function.pg-client-encoding.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-client-encoding.php'>Russian</option>
            <option value='tr/function.pg-client-encoding.php'>Turkish</option>
            <option value='uk/function.pg-client-encoding.php'>Ukrainian</option>
            <option value='zh/function.pg-client-encoding.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-client-encoding" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_client_encoding</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.3, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_client_encoding</span> &mdash; <span class="dc-title">
   Gets the client encoding
  </span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-client-encoding-description">
  <h3 class="title">Description</h3>     
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_client_encoding</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span></span> <code class="parameter">$connection</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   PostgreSQL supports automatic character set conversion between 
   server and client for certain character sets.
   <span class="function"><strong>pg_client_encoding()</strong></span> returns the client
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    <span class="function"><strong>pg_client_encoding()</strong></span> always returns
    <code class="literal">SQL_ASCII</code>. Supported encoding depends on PostgreSQL
    version.  Refer to the PostgreSQL Documentation supported encodings.
   </p>
   <p class="para">
    The function used to be called <span class="function"><strong>pg_clientencoding()</strong></span>.
   </p>
  </p></blockquote>
 </div>


<div class="refsect1 parameters" id="refsect1-function.pg-client-encoding-parameters">
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-client-encoding-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.pg-client-encoding-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-client-encoding-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2040">
    <p><strong>Example #1 <span class="function"><strong>pg_client_encoding()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">Client encoding is: ISO-8859-1</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-client-encoding-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-set-client-encoding.php" class="function" rel="rdfs-seeAlso">pg_set_client_encoding()</a> - Set the client encoding</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-client-encoding.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-client-encoding%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-client-encoding&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-client-encoding.php">＋<small>add a note</small></a></span>
