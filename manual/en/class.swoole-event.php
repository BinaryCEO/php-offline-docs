...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.swoole-event.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/swoole-coroutine-lock.unlock.php">
 <link rel="next" href="https://www.php.net/manual/en/swoole-event.add.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.swoole-event.php' selected="selected">English</option>
            ...
            <option value='ja/class.swoole-event.php'>Japanese</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="swoole-event.add.php">Swoole\Event::add</a> — Add new callback functions of a socket into the EventLoop.</li><li><a href="swoole-event.defer.php">Swoole\Event::defer</a> — Add a callback function to the next event loop.</li><li><a href="swoole-event.del.php">Swoole\Event::del</a> — Remove all event callback functions of a socket.</li><li><a href="swoole-event.exit.php">Swoole\Event::exit</a> — Exit the eventloop, only available at client side.</li><li><a href="swoole-event.set.php">Swoole\Event::set</a> — Update the event callback functions of a socket.</li><li><a href="swoole-event.wait.php">Swoole\Event::wait</a> — Description</li><li><a href="swoole-event.write.php">Swoole\Event::write</a> — Write data to the socket.</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/swoole/swoole.event.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.swoole-event%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.swoole-event&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.swoole-event.php">＋<small>add a note</small></a></span>
