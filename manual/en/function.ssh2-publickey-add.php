...
<head>
  ...
  <title>PHP: ssh2_publickey_add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ssh2-publickey-add.php">
 <link rel="shorturl" href="https://www.php.net/ssh2-publickey-add">
 <link rel="alternate" href="https://www.php.net/ssh2-publickey-add" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ssh2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ssh2-poll.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ssh2-publickey-init.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ssh2-publickey-add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ssh2-publickey-add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ssh2-publickey-add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ssh2-publickey-add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ssh2-publickey-add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ssh2-publickey-add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ssh2-publickey-add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ssh2-publickey-add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ssh2-publickey-add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ssh2-publickey-add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ssh2-publickey-add.php" hreflang="zh">
...
<meta name="Description" content="Add an authorized publickey" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ssh2_publickey_add - Manual" />
<meta name="twitter:description" content="Add an authorized publickey" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ssh2_publickey_add - Manual" />
<meta itemprop="description" content="Add an authorized publickey" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add an authorized publickey" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ssh2-publickey-add.php' selected="selected">English</option>
            <option value='de/function.ssh2-publickey-add.php'>German</option>
            <option value='es/function.ssh2-publickey-add.php'>Spanish</option>
            <option value='fr/function.ssh2-publickey-add.php'>French</option>
            <option value='it/function.ssh2-publickey-add.php'>Italian</option>
            <option value='ja/function.ssh2-publickey-add.php'>Japanese</option>
            <option value='pt_BR/function.ssh2-publickey-add.php'>Brazilian Portuguese</option>
            <option value='ru/function.ssh2-publickey-add.php'>Russian</option>
            <option value='tr/function.ssh2-publickey-add.php'>Turkish</option>
            <option value='uk/function.ssh2-publickey-add.php'>Ukrainian</option>
            <option value='zh/function.ssh2-publickey-add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ssh2-publickey-add" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ssh2-publickey-list.php" class="function" rel="rdfs-seeAlso">ssh2_publickey_list()</a> - List currently authorized publickeys</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ssh2/functions/ssh2-publickey-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ssh2-publickey-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ssh2-publickey-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ssh2-publickey-add.php">＋<small>add a note</small></a></span>
