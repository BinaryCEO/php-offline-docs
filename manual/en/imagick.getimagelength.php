...
<head>
  ...
  <title>PHP: Imagick::getImageLength - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagelength.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagelength.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagelength.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageiterations.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagematte.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagelength.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagelength.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagelength.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagelength.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagelength.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagelength.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagelength.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagelength.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagelength.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagelength.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagelength.php" hreflang="zh">
...
<meta name="Description" content="Returns the image length in bytes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageLength - Manual" />
<meta name="twitter:description" content="Returns the image length in bytes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageLength - Manual" />
<meta itemprop="description" content="Returns the image length in bytes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the image length in bytes" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagematte.php">
          Imagick::getImageMatte &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageiterations.php">
          &laquo; Imagick::getImageIterations        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagelength.php' selected="selected">English</option>
            <option value='de/imagick.getimagelength.php'>German</option>
            <option value='es/imagick.getimagelength.php'>Spanish</option>
            <option value='fr/imagick.getimagelength.php'>French</option>
            <option value='it/imagick.getimagelength.php'>Italian</option>
            <option value='ja/imagick.getimagelength.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagelength.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagelength.php'>Russian</option>
            <option value='tr/imagick.getimagelength.php'>Turkish</option>
            <option value='uk/imagick.getimagelength.php'>Ukrainian</option>
            <option value='zh/imagick.getimagelength.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagelength" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageLength</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageLength</span> &mdash; <span class="dc-title">Returns the image length in bytes</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagelength-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageLength</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagelength-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagelength-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.getimagelength-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3012">
    <p><strong>Example #1 Using <span class="function"><strong>Imagick::getImageLength()</strong></span>:</strong></p>
    <div class="example-contents"><p>
     Getting image length in bytes
    </p></div>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$image </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">(</span><span style="color: #DD0000">'test.jpg'</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageLength</span><span style="color: #007700">() . </span><span style="color: #DD0000">' bytes'</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagelength.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagelength%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagelength&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagelength.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128146">  <div class="votes">
    <div id="Vu128146">
    <a href="/manual/vote-note.php?id=128146&amp;page=imagick.getimagelength&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128146">
    <a href="/manual/vote-note.php?id=128146&amp;page=imagick.getimagelength&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128146" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#128146" class="name">
  <strong class="user"><em>seb dot gibbs at ymail dot com</em></strong></a><a class="genanchor" href="#128146"> &para;</a><div class="date" title="2023-01-24 12:43"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128146">
<div class="phpcode"><code><span class="html">Quite often a jpeg image blob filesize will grow when reading back the image blob data!<br /><br />eg.<br /><br />$img = new Imagick();<br />$img-&gt;readImage($filename);<br /><br />$sizeA = $img-&gt;getImageLength();<br />$blobdata = $img-&gt;getImageBlob();<br />$sizeB = $img-&gt;getImageLength();<br /><br />Quite often sizeB will be greater than sizeA depending on the jpeg image being read</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagelength&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagelength.php">＋<small>add a note</small></a></div>
