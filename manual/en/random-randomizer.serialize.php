...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/random-randomizer.serialize.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/random-randomizer.serialize.php">
 <link rel="alternate" href="https://www.php.net/manual/en/random-randomizer.serialize.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.random-randomizer.php">
 <link rel="prev" href="https://www.php.net/manual/en/random-randomizer.pickarraykeys.php">
 <link rel="next" href="https://www.php.net/manual/en/random-randomizer.shufflearray.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/random-randomizer.serialize.php' selected="selected">English</option>
            <option value='de/random-randomizer.serialize.php'>German</option>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 examples" id="refsect1-random-randomizer.serialize-examples">
  ...
  <div class="example" id="example-3786">
   <p><strong>Example #1 <span class="function"><strong>Random\Randomizer::__serialize()</strong></span> example</strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">...</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/random/random/randomizer/serialize.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Frandom-randomizer.serialize%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=random-randomizer.serialize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/random-randomizer.serialize.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">$engine = new \Random\Engine\Xoshiro256StarStar();<br /><br />$randomizer = new \Random\Randomizer($engine);<br /><br />echo "First random number: " . $randomizer-&gt;getInt(1, 100) . PHP_EOL;<br /><br />$serializedEngine = serialize($engine);<br /><br />$restoredEngine = unserialize($serializedEngine);<br />$restoredRandomizer = new \Random\Randomizer($restoredEngine);<br /><br />echo "Second random number (after restore): " . $restoredRandomizer-&gt;getInt(1, 100) . PHP_EOL;</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=random-randomizer.serialize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/random-randomizer.serialize.php">＋<small>add a note</small></a></div>
