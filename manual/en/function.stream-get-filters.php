...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-get-filters.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-get-contents.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-get-line.php">
...
<meta name="Description" content="Retrieve list of registered filters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_get_filters - Manual" />
<meta name="twitter:description" content="Retrieve list of registered filters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_get_filters - Manual" />
<meta itemprop="description" content="Retrieve list of registered filters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve list of registered filters" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-get-filters.php' selected="selected">English</option>
            <option value='de/function.stream-get-filters.php'>German</option>
            <option value='es/function.stream-get-filters.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_get_filters</span> &mdash; <span class="dc-title">Retrieve list of registered filters</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-function.stream-get-filters-examples">
  ...
  <p class="para">
   <div class="example" id="example-4056">
    <p><strong>Example #1 Using <span class="function"><strong>stream_get_filters()</strong></span></strong></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.stream-get-wrappers.php" class="function" rel="rdfs-seeAlso">stream_get_wrappers()</a> - Retrieve list of registered streams</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-get-filters.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-get-filters%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-get-filters&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-get-filters.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>Jasper Bekkers</em></strong></a><a class="genanchor" href="#57490"> &para;</a><div class="date" title="2005-10-05 11:53"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom57490">
<div class="phpcode"><code><span class="html">Filters to be used within the convert filter are base64-encode,  base64-decode, quoted-printable-encode and quoted-printable-decode. Note: those are not in the string filter, as currently reported by the manual!<br /><br />Example usage is:<br /><span class="default">&lt;?php<br />$h </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">'gecodeerd.txt'</span><span class="keyword">, </span><span class="string">'r'</span><span class="keyword">);<br /></span><span class="default">stream_filter_append</span><span class="keyword">(</span><span class="default">$h</span><span class="keyword">, </span><span class="string">'convert.base64-decode'</span><span class="keyword">);<br /></span><span class="default">fpassthru</span><span class="keyword">(</span><span class="default">$h</span><span class="keyword">);<br /></span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$h</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span>Or<br /><span class="default">&lt;?php<br />$filter </span><span class="keyword">= </span><span class="string">'convert.base64-decode'</span><span class="keyword">;<br /></span><span class="default">$file </span><span class="keyword">= </span><span class="string">'coded.txt'</span><span class="keyword">;<br /></span><span class="default">$h </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">'php://filter/read=' </span><span class="keyword">. </span><span class="default">$filter </span><span class="keyword">. </span><span class="string">'/resource=' </span><span class="keyword">. </span><span class="default">$file</span><span class="keyword">,</span><span class="string">'r'</span><span class="keyword">); <br /></span><span class="default">fpassthru</span><span class="keyword">(</span><span class="default">$h</span><span class="keyword">);<br /></span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$h</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stream-get-filters&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-get-filters.php">＋<small>add a note</small></a></div>
