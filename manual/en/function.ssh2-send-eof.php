...
<head>
  ...
  <title>PHP: ssh2_send_eof - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ssh2-send-eof.php">
 <link rel="shorturl" href="https://www.php.net/ssh2-send-eof">
 <link rel="alternate" href="https://www.php.net/ssh2-send-eof" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ssh2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ssh2-scp-send.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ssh2-sftp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ssh2-send-eof.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ssh2-send-eof.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ssh2-send-eof.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ssh2-send-eof.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ssh2-send-eof.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ssh2-send-eof.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ssh2-send-eof.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ssh2-send-eof.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ssh2-send-eof.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ssh2-send-eof.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ssh2-send-eof.php" hreflang="zh">
...
<meta name="Description" content="Send EOF to stream" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ssh2_send_eof - Manual" />
<meta name="twitter:description" content="Send EOF to stream" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ssh2_send_eof - Manual" />
<meta itemprop="description" content="Send EOF to stream" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Send EOF to stream" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ssh2-send-eof.php' selected="selected">English</option>
            <option value='de/function.ssh2-send-eof.php'>German</option>
            <option value='es/function.ssh2-send-eof.php'>Spanish</option>
            <option value='fr/function.ssh2-send-eof.php'>French</option>
            <option value='it/function.ssh2-send-eof.php'>Italian</option>
            <option value='ja/function.ssh2-send-eof.php'>Japanese</option>
            <option value='pt_BR/function.ssh2-send-eof.php'>Brazilian Portuguese</option>
            <option value='ru/function.ssh2-send-eof.php'>Russian</option>
            <option value='tr/function.ssh2-send-eof.php'>Turkish</option>
            <option value='uk/function.ssh2-send-eof.php'>Ukrainian</option>
            <option value='zh/function.ssh2-send-eof.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ssh2-send-eof" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.ssh2-fetch-stream.php" class="function" rel="rdfs-seeAlso">ssh2_fetch_stream()</a> - Fetch an extended data stream</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ssh2/functions/ssh2-send-eof.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ssh2-send-eof%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ssh2-send-eof&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ssh2-send-eof.php">＋<small>add a note</small></a></span>
