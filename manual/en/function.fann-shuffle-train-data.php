...
<head>
  ...
  <title>PHP: fann_shuffle_train_data - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-shuffle-train-data.php">
 <link rel="shorturl" href="https://www.php.net/fann-shuffle-train-data">
 <link rel="alternate" href="https://www.php.net/fann-shuffle-train-data" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-weight-array.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-subset-train-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-shuffle-train-data.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-shuffle-train-data.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-shuffle-train-data.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-shuffle-train-data.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-shuffle-train-data.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-shuffle-train-data.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-shuffle-train-data.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-shuffle-train-data.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-shuffle-train-data.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-shuffle-train-data.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-shuffle-train-data.php" hreflang="zh">
...
<meta name="Description" content="Shuffles training data, randomizing the order" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_shuffle_train_data - Manual" />
<meta name="twitter:description" content="Shuffles training data, randomizing the order" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_shuffle_train_data - Manual" />
<meta itemprop="description" content="Shuffles training data, randomizing the order" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Shuffles training data, randomizing the order" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-subset-train-data.php">
          fann_subset_train_data &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-set-weight-array.php">
          &laquo; fann_set_weight_array        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-shuffle-train-data.php' selected="selected">English</option>
            <option value='de/function.fann-shuffle-train-data.php'>German</option>
            <option value='es/function.fann-shuffle-train-data.php'>Spanish</option>
            <option value='fr/function.fann-shuffle-train-data.php'>French</option>
            <option value='it/function.fann-shuffle-train-data.php'>Italian</option>
            <option value='ja/function.fann-shuffle-train-data.php'>Japanese</option>
            <option value='pt_BR/function.fann-shuffle-train-data.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-shuffle-train-data.php'>Russian</option>
            <option value='tr/function.fann-shuffle-train-data.php'>Turkish</option>
            <option value='uk/function.fann-shuffle-train-data.php'>Ukrainian</option>
            <option value='zh/function.fann-shuffle-train-data.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-shuffle-train-data" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_shuffle_train_data</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_shuffle_train_data</span> &mdash; <span class="dc-title">Shuffles training data, randomizing the order</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-shuffle-train-data-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_shuffle_train_data</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$train_data</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-shuffle-train-data-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-shuffle-train-data-returnvalues">
  ...
  <p class="para">Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-shuffle-train-data.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-shuffle-train-data%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-shuffle-train-data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-shuffle-train-data.php">＋<small>add a note</small></a></span>
