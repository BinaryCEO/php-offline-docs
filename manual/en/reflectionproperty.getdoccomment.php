...
<head>
  ...
  <title>PHP: ReflectionProperty::getDocComment - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.getdoccomment.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.getdoccomment.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.getdoccomment.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.getdefaultvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.gethook.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.getdoccomment.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.getdoccomment.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.getdoccomment.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.getdoccomment.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.getdoccomment.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.getdoccomment.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.getdoccomment.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.getdoccomment.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.getdoccomment.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.getdoccomment.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.getdoccomment.php" hreflang="zh">
...
<meta name="Description" content="Gets the property doc comment" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::getDocComment - Manual" />
<meta name="twitter:description" content="Gets the property doc comment" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::getDocComment - Manual" />
<meta itemprop="description" content="Gets the property doc comment" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the property doc comment" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionproperty.gethook.php">
          ReflectionProperty::getHook &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.getdefaultvalue.php">
          &laquo; ReflectionProperty::getDefaultValue        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.getdoccomment.php' selected="selected">English</option>
            <option value='de/reflectionproperty.getdoccomment.php'>German</option>
            <option value='es/reflectionproperty.getdoccomment.php'>Spanish</option>
            <option value='fr/reflectionproperty.getdoccomment.php'>French</option>
            <option value='it/reflectionproperty.getdoccomment.php'>Italian</option>
            <option value='ja/reflectionproperty.getdoccomment.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.getdoccomment.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.getdoccomment.php'>Russian</option>
            <option value='tr/reflectionproperty.getdoccomment.php'>Turkish</option>
            <option value='uk/reflectionproperty.getdoccomment.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.getdoccomment.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.getdoccomment" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionproperty.getdoccomment-examples">
  ...
  <p class="para">
   <div class="example" id="example-5599">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionProperty::getDocComment()</strong></span> example</strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">string(53) &quot;/**
  ...
  <p class="para">
   <div class="example" id="example-5600">
    <p><strong>Example #2 Multiple property declarations</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionproperty.getvalue.php" class="methodname" rel="rdfs-seeAlso">ReflectionProperty::getValue()</a> - Gets value</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/getdoccomment.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.getdoccomment%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.getdoccomment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.getdoccomment.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="127126">  <div class="votes">
    <div id="Vu127126">
    <a href="/manual/vote-note.php?id=127126&amp;page=reflectionproperty.getdoccomment&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127126">
    <a href="/manual/vote-note.php?id=127126&amp;page=reflectionproperty.getdoccomment&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127126" title="100% like this...">
    2
    </div>
  </div>
  <a href="#127126" class="name">
  <strong class="user"><em>Jim</em></strong></a><a class="genanchor" href="#127126"> &para;</a><div class="date" title="2022-05-23 02:51"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom127126">
<div class="phpcode"><code><span class="html">Unfortunately, inherited doc comments are not supported.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">class </span><span class="default">A </span><span class="keyword">{<br />    </span><span class="comment">/**<br />     * @var string<br />     */<br />    </span><span class="keyword">public </span><span class="default">string $prop </span><span class="keyword">= </span><span class="string">'A'</span><span class="keyword">;<br />}<br /><br />class </span><span class="default">B </span><span class="keyword">extends </span><span class="default">A </span><span class="keyword">{<br />    public </span><span class="default">string $prop </span><span class="keyword">= </span><span class="string">'B'</span><span class="keyword">;<br />}<br /><br /></span><span class="default">$prop </span><span class="keyword">= new </span><span class="default">ReflectionProperty</span><span class="keyword">(</span><span class="string">'B'</span><span class="keyword">, </span><span class="string">'prop'</span><span class="keyword">);<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$prop</span><span class="keyword">-&gt;</span><span class="default">getDocComment</span><span class="keyword">());<br /><br /></span><span class="default">?&gt;<br /></span><br />results in FALSE</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionproperty.getdoccomment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.getdoccomment.php">＋<small>add a note</small></a></div>
