...
<head>
  ...
  <title>PHP: fbird_blob_import - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-blob-import.php">
 <link rel="shorturl" href="https://www.php.net/fbird-blob-import">
 <link rel="alternate" href="https://www.php.net/fbird-blob-import" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-blob-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-blob-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-blob-import.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-blob-import.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-blob-import.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-blob-import.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-blob-import.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-blob-import.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-blob-import.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-blob-import.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-blob-import.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-blob-import.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-blob-import.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_blob_import" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_blob_import - Manual" />
<meta name="twitter:description" content="Alias of ibase_blob_import" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_blob_import - Manual" />
<meta itemprop="description" content="Alias of ibase_blob_import" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_blob_import" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fbird-blob-info.php">
          fbird_blob_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-blob-get.php">
          &laquo; fbird_blob_get        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-blob-import.php' selected="selected">English</option>
            <option value='de/function.fbird-blob-import.php'>German</option>
            <option value='es/function.fbird-blob-import.php'>Spanish</option>
            <option value='fr/function.fbird-blob-import.php'>French</option>
            <option value='it/function.fbird-blob-import.php'>Italian</option>
            <option value='ja/function.fbird-blob-import.php'>Japanese</option>
            <option value='pt_BR/function.fbird-blob-import.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-blob-import.php'>Russian</option>
            <option value='tr/function.fbird-blob-import.php'>Turkish</option>
            <option value='uk/function.fbird-blob-import.php'>Ukrainian</option>
            <option value='zh/function.fbird-blob-import.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-blob-import" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_blob_import</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_blob_import</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-blob-import.php" class="function">ibase_blob_import()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-blob-import-description">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fbird-blob-import-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fbird-blob-create.php" class="function" rel="rdfs-seeAlso">fbird_blob_create()</a> - Alias of ibase_blob_create</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-blob-import.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-blob-import%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-blob-import&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-blob-import.php">＋<small>add a note</small></a></span>
