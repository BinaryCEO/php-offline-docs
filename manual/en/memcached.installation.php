...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.installation.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.installation.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.installation.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/memcached.setup.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.requirements.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.configuration.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.installation.php' selected="selected">English</option>
            ...
            <option value='tr/memcached.installation.php'>Turkish</option>
 ...
 <p class="para">
  ...
  built with SASL support enabled.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/configure.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.installation%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.installation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.installation.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Do not lose your time to install it on Ubuntu just trying "sudo apt-get install php5-memcached". There is something you need to do that sure installing memcached. Anyway...
<br />
<br />Step 1.
...
<div class="phpcode"><code><span class="html">For PHP 7 seems to work:<br /><br />    $ sudo apt-get install memcached<br />    $ sudo apt-get install php-memcached<br />    $ sudo apachectl graceful<br /><br />## php 7.2.19 / ubuntu 18.04.1<br /><br />$mc = new Memcached();<br />$mc-&gt;addServer("localhost", 11211);<br />...</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">i'm planning on using membase for my website and i was really struggling to install the memcashed php client on ubuntu with pear, but actually there is an easier way:<br /><br />$ sudo apt-get install php5-memcached<br /><br />you dont even need to install the membase server first - this can be done afterwards. hope this helps someone!</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>Clint Priest</em></strong></a><a class="genanchor" href="#94510"> &para;</a><div class="date" title="2009-11-09 10:53"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94510">
<div class="phpcode"><code><span class="html">If your server has --enable-json=shared as mine did, this extension requires you to have extension=json.so to load properly.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=memcached.installation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.installation.php">＋<small>add a note</small></a></div>
