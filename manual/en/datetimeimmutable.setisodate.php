...
<head>
  ...
  <title>PHP: DateTimeImmutable::setISODate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/datetimeimmutable.setisodate.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/datetimeimmutable.setisodate.php">
 <link rel="alternate" href="https://www.php.net/manual/en/datetimeimmutable.setisodate.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.datetimeimmutable.php">
 <link rel="prev" href="https://www.php.net/manual/en/datetimeimmutable.setdate.php">
 <link rel="next" href="https://www.php.net/manual/en/datetimeimmutable.settime.php">

 <link rel="alternate" href="https://www.php.net/manual/en/datetimeimmutable.setisodate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/datetimeimmutable.setisodate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/datetimeimmutable.setisodate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/datetimeimmutable.setisodate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/datetimeimmutable.setisodate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/datetimeimmutable.setisodate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/datetimeimmutable.setisodate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/datetimeimmutable.setisodate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/datetimeimmutable.setisodate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/datetimeimmutable.setisodate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/datetimeimmutable.setisodate.php" hreflang="zh">
...
<meta name="Description" content="Sets the ISO date" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateTimeImmutable::setISODate - Manual" />
<meta name="twitter:description" content="Sets the ISO date" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateTimeImmutable::setISODate - Manual" />
<meta itemprop="description" content="Sets the ISO date" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the ISO date" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="datetimeimmutable.settime.php">
          DateTimeImmutable::setTime &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="datetimeimmutable.setdate.php">
          &laquo; DateTimeImmutable::setDate        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/datetimeimmutable.setisodate.php' selected="selected">English</option>
            <option value='de/datetimeimmutable.setisodate.php'>German</option>
            <option value='es/datetimeimmutable.setisodate.php'>Spanish</option>
            <option value='fr/datetimeimmutable.setisodate.php'>French</option>
            <option value='it/datetimeimmutable.setisodate.php'>Italian</option>
            <option value='ja/datetimeimmutable.setisodate.php'>Japanese</option>
            <option value='pt_BR/datetimeimmutable.setisodate.php'>Brazilian Portuguese</option>
            <option value='ru/datetimeimmutable.setisodate.php'>Russian</option>
            <option value='tr/datetimeimmutable.setisodate.php'>Turkish</option>
            <option value='uk/datetimeimmutable.setisodate.php'>Ukrainian</option>
            <option value='zh/datetimeimmutable.setisodate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="datetimeimmutable.setisodate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">DateTimeImmutable::setISODate</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">DateTimeImmutable::setISODate</span> &mdash; <span class="dc-title">Sets the ISO date</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-datetimeimmutable.setisodate-examples">
  ...
  <div class="example" id="example-2215">
   <p><strong>Example #1 <span class="function"><strong>DateTimeImmutable::setISODate()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">2008-01-07
2008-01-13</pre>
</div>
   </div>
  </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$date </span><span style="color: #007700">= new </span><span style="color: #0000BB">DateTimeImmutable</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$newDate </span><span style="color: #007700">= </span><span style="color: #0000BB">$date</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setISODate</span><span style="color: #007700">(</span><span style="color: #0000BB">2008</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">7</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$newDate</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">format</span><span style="color: #007700">(</span><span style="color: #DD0000">'Y-m-d'</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">$newDate </span><span style="color: #007700">= </span><span style="color: #0000BB">$date</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setISODate</span><span style="color: #007700">(</span><span style="color: #0000BB">2008</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">8</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$newDate</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">format</span><span style="color: #007700">(</span><span style="color: #DD0000">'Y-m-d'</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">$newDate </span><span style="color: #007700">= </span><span style="color: #0000BB">$date</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setISODate</span><span style="color: #007700">(</span><span style="color: #0000BB">2008</span><span style="color: #007700">, </span><span style="color: #0000BB">53</span><span style="color: #007700">, </span><span style="color: #0000BB">7</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$newDate</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">format</span><span style="color: #007700">(</span><span style="color: #DD0000">'Y-m-d'</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   ...
   <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">2008-01-13
2008-01-14
2009-01-04</pre>
</div>
   </div>
  ...
  <div class="example" id="example-2217">
   <p><strong>Example #3 Finding the month a week is in</strong></p>
   <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$date </span><span style="color: #007700">= new </span><span style="color: #0000BB">DateTimeImmutable</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$newDate </span><span style="color: #007700">= </span><span style="color: #0000BB">$date</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setISODate</span><span style="color: #007700">(</span><span style="color: #0000BB">2008</span><span style="color: #007700">, </span><span style="color: #0000BB">14</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$newDate</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">format</span><span style="color: #007700">(</span><span style="color: #DD0000">'n'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="datetimeimmutable.settime.php" class="function" rel="rdfs-seeAlso">DateTimeImmutable::setTime()</a> - Sets the time</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datetimeimmutable/setisodate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdatetimeimmutable.setisodate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=datetimeimmutable.setisodate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/datetimeimmutable.setisodate.php">＋<small>add a note</small></a></span>
