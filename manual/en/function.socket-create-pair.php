...
<head>
  ...
  <title>PHP: socket_create_pair - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-create-pair.php">
 <link rel="shorturl" href="https://www.php.net/socket-create-pair">
 <link rel="alternate" href="https://www.php.net/socket-create-pair" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-create-listen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-export-stream.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-create-pair.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-create-pair.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-create-pair.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-create-pair.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-create-pair.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-create-pair.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-create-pair.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-create-pair.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-create-pair.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-create-pair.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-create-pair.php" hreflang="zh">
...
<meta name="Description" content="Creates a pair of indistinguishable sockets and stores them in an array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_create_pair - Manual" />
<meta name="twitter:description" content="Creates a pair of indistinguishable sockets and stores them in an array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_create_pair - Manual" />
<meta itemprop="description" content="Creates a pair of indistinguishable sockets and stores them in an array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a pair of indistinguishable sockets and stores them in an array" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.socket-export-stream.php">
          socket_export_stream &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-create-listen.php">
          &laquo; socket_create_listen        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-create-pair.php' selected="selected">English</option>
            <option value='de/function.socket-create-pair.php'>German</option>
            <option value='es/function.socket-create-pair.php'>Spanish</option>
            <option value='fr/function.socket-create-pair.php'>French</option>
            <option value='it/function.socket-create-pair.php'>Italian</option>
            <option value='ja/function.socket-create-pair.php'>Japanese</option>
            <option value='pt_BR/function.socket-create-pair.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-create-pair.php'>Russian</option>
            <option value='tr/function.socket-create-pair.php'>Turkish</option>
            <option value='uk/function.socket-create-pair.php'>Ukrainian</option>
            <option value='zh/function.socket-create-pair.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-create-pair" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">socket_create_pair</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_create_pair</span> &mdash; <span class="dc-title">Creates a pair of indistinguishable sockets and stores them in an array</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.socket-create-pair-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>socket_create_pair</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$domain</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$protocol</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter reference">&$pair</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>socket_create_pair()</strong></span> creates two connected and
   indistinguishable sockets, and stores them in <code class="parameter">pair</code>.
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       family to be used by the socket. See <span class="function"><a href="function.socket-create.php" class="function">socket_create()</a></span>
       for the full list.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       ...
       to be used by the socket. See <span class="function"><a href="function.socket-create.php" class="function">socket_create()</a></span> for the 
       full list.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       ...
       name by using <span class="function"><a href="function.getprotobyname.php" class="function">getprotobyname()</a></span>. If
      ...
      <p class="para">
       See <span class="function"><a href="function.socket-create.php" class="function">socket_create()</a></span> for the full list of supported 
       protocols.
      </p>
     </dd>
    
    
     <dt><code class="parameter">pair</code></dt>
     <dd>
      <p class="para">
       Reference to an array in which the two <span class="classname"><a href="class.socket.php" class="classname">Socket</a></span> instances will be inserted.
      </p>
     </dd>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">pair</code> is a reference to an array of <span class="classname"><a href="class.socket.php" class="classname">Socket</a></span> instances now;
       previously, it was a reference to an array of <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>s.
      </td>
     </tr>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.socket-strerror.php" class="function" rel="rdfs-seeAlso">socket_strerror()</a> - Return a string describing a socket error</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-create-pair.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-create-pair%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-create-pair&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-create-pair.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="90784">  <div class="votes">
    <div id="Vu90784">
    <a href="/manual/vote-note.php?id=90784&amp;page=function.socket-create-pair&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd90784">
    <a href="/manual/vote-note.php?id=90784&amp;page=function.socket-create-pair&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V90784" title="80% like this...">
    3
    </div>
  </div>
  <a href="#90784" class="name">
  <strong class="user"><em>cweiske at php dot net</em></strong></a><a class="genanchor" href="#90784"> &para;</a><div class="date" title="2009-05-09 01:45"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom90784">
<div class="phpcode"><code><span class="html">The underlying sockpair() function does only support AF_UNIX at least on BSD and Linux.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.socket-create-pair&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-create-pair.php">＋<small>add a note</small></a></div>
