...
<head>
  ...
  <title>PHP: SolrQuery::getGroupNGroups - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getgroupngroups.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getgroupngroups.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupngroups.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getgroupmain.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getgroupoffset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupngroups.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getgroupngroups.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getgroupngroups.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getgroupngroups.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getgroupngroups.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getgroupngroups.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getgroupngroups.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getgroupngroups.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getgroupngroups.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getgroupngroups.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getgroupngroups.php" hreflang="zh">
...
<meta name="Description" content="Returns the group.ngroups value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getGroupNGroups - Manual" />
<meta name="twitter:description" content="Returns the group.ngroups value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getGroupNGroups - Manual" />
<meta itemprop="description" content="Returns the group.ngroups value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the group.ngroups value" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getgroupoffset.php">
          SolrQuery::getGroupOffset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getgroupmain.php">
          &laquo; SolrQuery::getGroupMain        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getgroupngroups.php' selected="selected">English</option>
            <option value='de/solrquery.getgroupngroups.php'>German</option>
            <option value='es/solrquery.getgroupngroups.php'>Spanish</option>
            <option value='fr/solrquery.getgroupngroups.php'>French</option>
            <option value='it/solrquery.getgroupngroups.php'>Italian</option>
            <option value='ja/solrquery.getgroupngroups.php'>Japanese</option>
            <option value='pt_BR/solrquery.getgroupngroups.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getgroupngroups.php'>Russian</option>
            <option value='tr/solrquery.getgroupngroups.php'>Turkish</option>
            <option value='uk/solrquery.getgroupngroups.php'>Ukrainian</option>
            <option value='zh/solrquery.getgroupngroups.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getgroupngroups" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getGroupNGroups</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getGroupNGroups</span> &mdash; <span class="dc-title">Returns the group.ngroups value</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getgroupngroups-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getGroupNGroups</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getgroupngroups-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getgroupngroups-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.getgroupngroups-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.setgroupngroups.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupNGroups()</a> - If true, Solr includes the number of groups that have matched the query in the results</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getgroupngroups.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getgroupngroups%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getgroupngroups&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getgroupngroups.php">＋<small>add a note</small></a></span>
