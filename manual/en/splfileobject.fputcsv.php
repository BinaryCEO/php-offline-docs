...
<head>
  ...
  <title>PHP: SplFileObject::fputcsv - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileobject.fputcsv.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileobject.fputcsv.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.fputcsv.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileobject.fpassthru.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileobject.fread.php">

 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.fputcsv.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/splfileobject.fputcsv.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/splfileobject.fputcsv.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/splfileobject.fputcsv.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/splfileobject.fputcsv.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/splfileobject.fputcsv.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/splfileobject.fputcsv.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/splfileobject.fputcsv.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/splfileobject.fputcsv.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/splfileobject.fputcsv.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/splfileobject.fputcsv.php" hreflang="zh">
...
<meta name="Description" content="Write a field array as a CSV line" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplFileObject::fputcsv - Manual" />
<meta name="twitter:description" content="Write a field array as a CSV line" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplFileObject::fputcsv - Manual" />
<meta itemprop="description" content="Write a field array as a CSV line" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Write a field array as a CSV line" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="splfileobject.fread.php">
          SplFileObject::fread &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="splfileobject.fpassthru.php">
          &laquo; SplFileObject::fpassthru        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileobject.fputcsv.php' selected="selected">English</option>
            <option value='de/splfileobject.fputcsv.php'>German</option>
            <option value='es/splfileobject.fputcsv.php'>Spanish</option>
            <option value='fr/splfileobject.fputcsv.php'>French</option>
            <option value='it/splfileobject.fputcsv.php'>Italian</option>
            <option value='ja/splfileobject.fputcsv.php'>Japanese</option>
            <option value='pt_BR/splfileobject.fputcsv.php'>Brazilian Portuguese</option>
            <option value='ru/splfileobject.fputcsv.php'>Russian</option>
            <option value='tr/splfileobject.fputcsv.php'>Turkish</option>
            <option value='uk/splfileobject.fputcsv.php'>Ukrainian</option>
            <option value='zh/splfileobject.fputcsv.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="splfileobject.fputcsv" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SplFileObject::fputcsv</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">SplFileObject::fputcsv</span> &mdash; <span class="dc-title">Write a field array as a CSV line</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-splfileobject.fputcsv-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SplFileObject::fputcsv</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$fields</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$separator</code><span class="initializer"> = &quot;,&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$enclosure</code><span class="initializer"> = &quot;\&quot;&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$escape</code><span class="initializer"> = &quot;\\&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$eol</code><span class="initializer"> = &quot;\n&quot;</span></span><br>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Writes the <code class="parameter">fields</code> array to the file
   as a <abbr title="Comma Separated Value">CSV</abbr> line.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-splfileobject.fputcsv-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-splfileobject.fputcsv-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-splfileobject.fputcsv-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-splfileobject.fputcsv-changelog">
...
&quot;&quot;&quot;aaa&quot;&quot;&quot;,&quot;&quot;&quot;bbb&quot;&quot;&quot;</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-splfileobject.fputcsv-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.str-getcsv.php" class="function" rel="rdfs-seeAlso">str_getcsv()</a> - Parse a CSV string into an array</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileobject/fputcsv.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileobject.fputcsv%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileobject.fputcsv&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileobject.fputcsv.php">＋<small>add a note</small></a></span>
