...
<head>
  ...
  <title>PHP: ImagickDraw::setViewbox - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setviewbox.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setviewbox.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setviewbox.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setvectorgraphics.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.skewx.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setviewbox.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setviewbox.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setviewbox.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setviewbox.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setviewbox.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setviewbox.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setviewbox.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setviewbox.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setviewbox.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setviewbox.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setviewbox.php" hreflang="zh">
...
<meta name="Description" content="Sets the overall canvas size" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setViewbox - Manual" />
<meta name="twitter:description" content="Sets the overall canvas size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setViewbox - Manual" />
<meta itemprop="description" content="Sets the overall canvas size" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the overall canvas size" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.skewx.php">
          ImagickDraw::skewX &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setvectorgraphics.php">
          &laquo; ImagickDraw::setVectorGraphics        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setviewbox.php' selected="selected">English</option>
            <option value='de/imagickdraw.setviewbox.php'>German</option>
            <option value='es/imagickdraw.setviewbox.php'>Spanish</option>
            <option value='fr/imagickdraw.setviewbox.php'>French</option>
            <option value='it/imagickdraw.setviewbox.php'>Italian</option>
            <option value='ja/imagickdraw.setviewbox.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setviewbox.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setviewbox.php'>Russian</option>
            <option value='tr/imagickdraw.setviewbox.php'>Turkish</option>
            <option value='uk/imagickdraw.setviewbox.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setviewbox.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setviewbox" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setViewbox</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setViewbox</span> &mdash; <span class="dc-title">Sets the overall canvas size</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.setviewbox-examples">
  ...
  <p class="para">
    <div class="example" id="example-3196">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::setViewBox()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setviewbox.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setviewbox%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setviewbox&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setviewbox.php">＋<small>add a note</small></a></span>
