...
<head>
  ...
  <title>PHP: imagesetinterpolation - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagesetinterpolation.php">
 <link rel="shorturl" href="https://www.php.net/imagesetinterpolation">
 <link rel="alternate" href="https://www.php.net/imagesetinterpolation" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagesetclip.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagesetpixel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagesetinterpolation.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagesetinterpolation.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagesetinterpolation.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagesetinterpolation.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagesetinterpolation.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagesetinterpolation.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagesetinterpolation.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagesetinterpolation.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagesetinterpolation.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagesetinterpolation.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagesetinterpolation.php" hreflang="zh">
...
<meta name="Description" content="Set the interpolation method" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagesetinterpolation - Manual" />
<meta name="twitter:description" content="Set the interpolation method" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagesetinterpolation - Manual" />
<meta itemprop="description" content="Set the interpolation method" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the interpolation method" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagesetinterpolation.php' selected="selected">English</option>
            <option value='de/function.imagesetinterpolation.php'>German</option>
            <option value='es/function.imagesetinterpolation.php'>Spanish</option>
            <option value='fr/function.imagesetinterpolation.php'>French</option>
            <option value='it/function.imagesetinterpolation.php'>Italian</option>
            <option value='ja/function.imagesetinterpolation.php'>Japanese</option>
            <option value='pt_BR/function.imagesetinterpolation.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagesetinterpolation.php'>Russian</option>
            <option value='tr/function.imagesetinterpolation.php'>Turkish</option>
            <option value='uk/function.imagesetinterpolation.php'>Ukrainian</option>
            <option value='zh/function.imagesetinterpolation.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagesetinterpolation" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagegetinterpolation.php" class="function" rel="rdfs-seeAlso">imagegetinterpolation()</a> - Get the interpolation method</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagesetinterpolation.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagesetinterpolation%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagesetinterpolation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagesetinterpolation.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121938">  <div class="votes">
    <div id="Vu121938">
    <a href="/manual/vote-note.php?id=121938&amp;page=function.imagesetinterpolation&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121938">
    <a href="/manual/vote-note.php?id=121938&amp;page=function.imagesetinterpolation&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121938" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#121938" class="name">
  <strong class="user"><em>shaun at slickdesign dot com dot au</em></strong></a><a class="genanchor" href="#121938"> &para;</a><div class="date" title="2017-11-29 08:27"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121938">
<div class="phpcode"><code><span class="html">Setting the interpolation does not carry through to any images created by imageaffine() or imagerotate(). It defaults to IMG_BILINEAR_FIXED and would need to be set on each generated image as required.<br /><br /><span class="default">&lt;?php<br />imagesetinterpolation</span><span class="keyword">( </span><span class="default">$image</span><span class="keyword">, </span><span class="default">IMG_NEAREST_NEIGHBOUR </span><span class="keyword">);<br /><br /></span><span class="comment">// Rotated using IMG_NEAREST_NEIGHBOUR<br /></span><span class="default">$rotated </span><span class="keyword">= </span><span class="default">imagerotate</span><span class="keyword">( </span><span class="default">$image</span><span class="keyword">, </span><span class="default">45</span><span class="keyword">, </span><span class="default">$transparent </span><span class="keyword">);<br /><br /></span><span class="comment">// Rotated using IMG_BILINEAR_FIXED<br /></span><span class="default">$rotated_again </span><span class="keyword">= </span><span class="default">imagerotate</span><span class="keyword">( </span><span class="default">$rotated</span><span class="keyword">, </span><span class="default">45</span><span class="keyword">, </span><span class="default">$transparent </span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Setting the interpolation to IMG_NEAREST_NEIGHBOUR can help to preserve details and prevent sampling issues when rotating an image at 90 degree increments, including when rotating clockwise.<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Rotated image can appear blurred and on a slight angle.<br /></span><span class="default">$rotated </span><span class="keyword">= </span><span class="default">imagerotate</span><span class="keyword">( </span><span class="default">$image</span><span class="keyword">, -</span><span class="default">360</span><span class="keyword">, </span><span class="default">$transparent </span><span class="keyword">);<br /><br /></span><span class="comment">// Similar to starting Image although it may still show a background or be on a slight angle.<br /></span><span class="default">imagesetinterpolation</span><span class="keyword">( </span><span class="default">$image</span><span class="keyword">, </span><span class="default">IMG_NEAREST_NEIGHBOUR </span><span class="keyword">);<br /></span><span class="default">$rotated </span><span class="keyword">= </span><span class="default">imagerotate</span><span class="keyword">( </span><span class="default">$image</span><span class="keyword">, -</span><span class="default">360</span><span class="keyword">, </span><span class="default">$transparent </span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagesetinterpolation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagesetinterpolation.php">＋<small>add a note</small></a></div>
