...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/regexp.reference.comments.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/regexp.reference.comments.php">
 <link rel="alternate" href="https://www.php.net/manual/en/regexp.reference.comments.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reference.pcre.pattern.syntax.php">
 <link rel="prev" href="https://www.php.net/manual/en/regexp.reference.conditional.php">
 <link rel="next" href="https://www.php.net/manual/en/regexp.reference.recursive.php">

 <link rel="alternate" href="https://www.php.net/manual/en/regexp.reference.comments.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/regexp.reference.comments.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/regexp.reference.comments.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/regexp.reference.comments.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/regexp.reference.comments.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/regexp.reference.comments.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/regexp.reference.comments.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/regexp.reference.comments.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/regexp.reference.comments.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/regexp.reference.comments.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/regexp.reference.comments.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="regexp.reference.recursive.php">
          Recursive patterns &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="regexp.reference.conditional.php">
          &laquo; Conditional subpatterns        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/regexp.reference.comments.php' selected="selected">English</option>
            <option value='de/regexp.reference.comments.php'>German</option>
            <option value='es/regexp.reference.comments.php'>Spanish</option>
            <option value='fr/regexp.reference.comments.php'>French</option>
            <option value='it/regexp.reference.comments.php'>Italian</option>
            <option value='ja/regexp.reference.comments.php'>Japanese</option>
            <option value='pt_BR/regexp.reference.comments.php'>Brazilian Portuguese</option>
            <option value='ru/regexp.reference.comments.php'>Russian</option>
            <option value='tr/regexp.reference.comments.php'>Turkish</option>
            <option value='uk/regexp.reference.comments.php'>Ukrainian</option>
            <option value='zh/regexp.reference.comments.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="regexp.reference.comments" class="section">
...
int(1)
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fregexp.reference.comments%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=regexp.reference.comments&amp;repo=en&amp;redirect=https://www.php.net/manual/en/regexp.reference.comments.php">＋<small>add a note</small></a></span>
