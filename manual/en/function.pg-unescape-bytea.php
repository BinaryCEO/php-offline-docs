...
<head>
  ...
  <title>PHP: pg_unescape_bytea - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-unescape-bytea.php">
 <link rel="shorturl" href="https://www.php.net/pg-unescape-bytea">
 <link rel="alternate" href="https://www.php.net/pg-unescape-bytea" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-tty.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-untrace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-unescape-bytea.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-unescape-bytea.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-unescape-bytea.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-unescape-bytea.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-unescape-bytea.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-unescape-bytea.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-unescape-bytea.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-unescape-bytea.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-unescape-bytea.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-unescape-bytea.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-unescape-bytea.php" hreflang="zh">
...
<meta name="Description" content="Unescape binary for bytea type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_unescape_bytea - Manual" />
<meta name="twitter:description" content="Unescape binary for bytea type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_unescape_bytea - Manual" />
<meta itemprop="description" content="Unescape binary for bytea type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Unescape binary for bytea type" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-unescape-bytea.php' selected="selected">English</option>
            <option value='de/function.pg-unescape-bytea.php'>German</option>
            <option value='es/function.pg-unescape-bytea.php'>Spanish</option>
            <option value='fr/function.pg-unescape-bytea.php'>French</option>
            <option value='it/function.pg-unescape-bytea.php'>Italian</option>
            <option value='ja/function.pg-unescape-bytea.php'>Japanese</option>
            <option value='pt_BR/function.pg-unescape-bytea.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-unescape-bytea.php'>Russian</option>
            <option value='tr/function.pg-unescape-bytea.php'>Turkish</option>
            <option value='uk/function.pg-unescape-bytea.php'>Ukrainian</option>
            <option value='zh/function.pg-unescape-bytea.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-unescape-bytea" class="refentry">
 ...
 <div class="refsect1 parameters" id="refsect1-function.pg-unescape-bytea-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       A <span class="type"><a href="language.types.string.php" class="type string">string</a></span> containing PostgreSQL bytea data to be converted into
       a PHP binary string.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-unescape-bytea-returnvalues">
  ...
  <p class="para">
   A <span class="type"><a href="language.types.string.php" class="type string">string</a></span> containing the unescaped data.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-escape-string.php" class="function" rel="rdfs-seeAlso">pg_escape_string()</a> - Escape a string for query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-unescape-bytea.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-unescape-bytea%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-unescape-bytea&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-unescape-bytea.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="100436">  <div class="votes">
    <div id="Vu100436">
    <a href="/manual/vote-note.php?id=100436&amp;page=function.pg-unescape-bytea&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd100436">
    <a href="/manual/vote-note.php?id=100436&amp;page=function.pg-unescape-bytea&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V100436" title="64% like this...">
    5
    </div>
  </div>
  <a href="#100436" class="name">
  <strong class="user"><em>liviu dot mirea at gmail dot com</em></strong></a><a class="genanchor" href="#100436"> &para;</a><div class="date" title="2010-10-15 10:06"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom100436">
<div class="phpcode"><code><span class="html">PostgreSQL 9.0 introduced "hex" as the new default format for encoding binary data. Because "pg_unescape_bytea" only works with the old "escape" format, you need to do pg_query('SET bytea_output = "escape";'); before executing your select queries.
<br />
<br />More details can be found here: <a href="http://www.postgresql.org/docs/9.0/static/datatype-binary.html" rel="nofollow" target="_blank">http://www.postgresql.org/docs/9.0/static/datatype-binary.html</a>
<br />
<br />[Ed: Recent PostgreSQL versions support unescaping the "hex" format.]</span></code></div>
  </div>
 </div>
  <div class="note" id="102980">  <div class="votes">
    <div id="Vu102980">
    <a href="/manual/vote-note.php?id=102980&amp;page=function.pg-unescape-bytea&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102980">
    <a href="/manual/vote-note.php?id=102980&amp;page=function.pg-unescape-bytea&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102980" title="50% like this...">
    0
    </div>
  </div>
  <a href="#102980" class="name">
  <strong class="user"><em>muralito at montevideo dot com dot uy</em></strong></a><a class="genanchor" href="#102980"> &para;</a><div class="date" title="2011-03-17 05:10"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102980">
<div class="phpcode"><code><span class="html">The workaround is to configure a property in the postgres database for the user, to make postgres behave as the old default.<br /><br />ALTER USER username SET bytea_output = 'escape';<br /><br />(or using the pgadmin interface)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-unescape-bytea&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-unescape-bytea.php">＋<small>add a note</small></a></div>
