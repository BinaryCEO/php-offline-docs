...
<head>
  ...
  <title>PHP: ImagickDraw::popPattern - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.poppattern.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.poppattern.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.poppattern.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.popdefs.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.push.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.poppattern.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.poppattern.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.poppattern.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.poppattern.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.poppattern.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.poppattern.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.poppattern.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.poppattern.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.poppattern.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.poppattern.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.poppattern.php" hreflang="zh">
...
<meta name="Description" content="Terminates a pattern definition" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::popPattern - Manual" />
<meta name="twitter:description" content="Terminates a pattern definition" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::popPattern - Manual" />
<meta itemprop="description" content="Terminates a pattern definition" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Terminates a pattern definition" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.push.php">
          ImagickDraw::push &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.popdefs.php">
          &laquo; ImagickDraw::popDefs        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.poppattern.php' selected="selected">English</option>
            <option value='de/imagickdraw.poppattern.php'>German</option>
            <option value='es/imagickdraw.poppattern.php'>Spanish</option>
            <option value='fr/imagickdraw.poppattern.php'>French</option>
            <option value='it/imagickdraw.poppattern.php'>Italian</option>
            <option value='ja/imagickdraw.poppattern.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.poppattern.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.poppattern.php'>Russian</option>
            <option value='tr/imagickdraw.poppattern.php'>Turkish</option>
            <option value='uk/imagickdraw.poppattern.php'>Ukrainian</option>
            <option value='zh/imagickdraw.poppattern.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.poppattern" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::popPattern</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::popPattern</span> &mdash; <span class="dc-title">Terminates a pattern definition</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.poppattern-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::popPattern</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.poppattern-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/poppattern.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.poppattern%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.poppattern&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.poppattern.php">＋<small>add a note</small></a></span>
