...
<head>
  ...
  <title>PHP: Imagick::getPage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getpage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getpage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getpage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getpackagename.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getpixeliterator.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getpage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getpage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getpage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getpage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getpage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getpage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getpage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getpage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getpage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getpage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getpage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::getPage - Manual" />
<meta name="twitter:description" content="Returns the page geometry" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getPage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getpixeliterator.php">
          Imagick::getPixelIterator &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getpackagename.php">
          &laquo; Imagick::getPackageName        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getpage.php' selected="selected">English</option>
            <option value='de/imagick.getpage.php'>German</option>
            <option value='es/imagick.getpage.php'>Spanish</option>
            <option value='fr/imagick.getpage.php'>French</option>
            <option value='it/imagick.getpage.php'>Italian</option>
            <option value='ja/imagick.getpage.php'>Japanese</option>
            <option value='pt_BR/imagick.getpage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getpage.php'>Russian</option>
            <option value='tr/imagick.getpage.php'>Turkish</option>
            <option value='uk/imagick.getpage.php'>Ukrainian</option>
            <option value='zh/imagick.getpage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getpage" class="refentry">
  ...
  <p class="para">
   ...
   throwing ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getpage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getpage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getpage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getpage.php">＋<small>add a note</small></a></span>
