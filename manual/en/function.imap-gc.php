...
<head>
  ...
  <title>PHP: imap_gc - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-gc.php">
 <link rel="shorturl" href="https://www.php.net/imap-gc">
 <link rel="alternate" href="https://www.php.net/imap-gc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-fetchtext.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-get-quota.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-gc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-gc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-gc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-gc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-gc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-gc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-gc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-gc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-gc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-gc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-gc.php" hreflang="zh">
...
<meta name="Description" content="Clears IMAP cache" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_gc - Manual" />
<meta name="twitter:description" content="Clears IMAP cache" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_gc - Manual" />
<meta itemprop="description" content="Clears IMAP cache" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clears IMAP cache" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-get-quota.php">
          imap_get_quota &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-fetchtext.php">
          &laquo; imap_fetchtext        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-gc.php' selected="selected">English</option>
            <option value='de/function.imap-gc.php'>German</option>
            <option value='es/function.imap-gc.php'>Spanish</option>
            <option value='fr/function.imap-gc.php'>French</option>
            <option value='it/function.imap-gc.php'>Italian</option>
            <option value='ja/function.imap-gc.php'>Japanese</option>
            <option value='pt_BR/function.imap-gc.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-gc.php'>Russian</option>
            <option value='tr/function.imap-gc.php'>Turkish</option>
            <option value='uk/function.imap-gc.php'>Ukrainian</option>
            <option value='zh/function.imap-gc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-gc" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_gc</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_gc</span> &mdash; <span class="dc-title">Clears IMAP cache</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-gc-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_gc</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
     ...
     <dd>
      <p class="para">
       ...
       <strong><code><a href="imap.constants.php#constant.imap-gc-elt">IMAP_GC_ELT</a></code></strong> (message cache elements), 
       <strong><code><a href="imap.constants.php#constant.imap-gc-env">IMAP_GC_ENV</a></code></strong> (envelope and bodies),
       <strong><code><a href="imap.constants.php#constant.imap-gc-texts">IMAP_GC_TEXTS</a></code></strong> (texts).
      </p>
     </dd>
 ...
 <div class="refsect1 errors" id="refsect1-function.imap-gc-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imap-gc-changelog">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$mbox </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_open</span><span style="color: #007700">(</span><span style="color: #DD0000">"{imap.example.org:143}"</span><span style="color: #007700">, </span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">imap_gc</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">, </span><span style="color: #0000BB">IMAP_GC_ELT</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-gc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-gc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-gc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-gc.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="92431">  <div class="votes">
    <div id="Vu92431">
    <a href="/manual/vote-note.php?id=92431&amp;page=function.imap-gc&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92431">
    <a href="/manual/vote-note.php?id=92431&amp;page=function.imap-gc&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92431" title="71% like this...">
    3
    </div>
  </div>
  <a href="#92431" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#92431"> &para;</a><div class="date" title="2009-07-23 12:47"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92431">
<div class="phpcode"><code><span class="html">If you notice that you're program's memory usage is increasing (as observed using ps) while calling the imap functions, calling this function should free that memory.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-gc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-gc.php">＋<small>add a note</small></a></div>
