...
<head>
  ...
  <title>PHP: ps_setfont - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-setfont.php">
 <link rel="shorturl" href="https://www.php.net/ps-setfont">
 <link rel="alternate" href="https://www.php.net/ps-setfont" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-setflat.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-setgray.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-setfont.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-setfont.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-setfont.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-setfont.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-setfont.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-setfont.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-setfont.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-setfont.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-setfont.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-setfont.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-setfont.php" hreflang="zh">
...
<meta name="Description" content="Sets font to use for following output" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_setfont - Manual" />
<meta name="twitter:description" content="Sets font to use for following output" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_setfont - Manual" />
<meta itemprop="description" content="Sets font to use for following output" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets font to use for following output" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-setgray.php">
          ps_setgray &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-setflat.php">
          &laquo; ps_setflat        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-setfont.php' selected="selected">English</option>
            <option value='de/function.ps-setfont.php'>German</option>
            <option value='es/function.ps-setfont.php'>Spanish</option>
            <option value='fr/function.ps-setfont.php'>French</option>
            <option value='it/function.ps-setfont.php'>Italian</option>
            <option value='ja/function.ps-setfont.php'>Japanese</option>
            <option value='pt_BR/function.ps-setfont.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-setfont.php'>Russian</option>
            <option value='tr/function.ps-setfont.php'>Turkish</option>
            <option value='uk/function.ps-setfont.php'>Ukrainian</option>
            <option value='zh/function.ps-setfont.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-setfont" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_setfont</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_setfont</span> &mdash; <span class="dc-title">Sets font to use for following output</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-setfont-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_setfont</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fontid</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$size</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Sets a font, which has to be loaded before with
   <span class="function"><a href="function.ps-findfont.php" class="function">ps_findfont()</a></span>. Outputting text without setting a font
   results in an error.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-setfont-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The font identifier as returned by <span class="function"><a href="function.ps-findfont.php" class="function">ps_findfont()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-setfont-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-setfont-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-set-text-pos.php" class="function" rel="rdfs-seeAlso">ps_set_text_pos()</a> - Sets position for text output</span> for an example.</li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-setfont.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-setfont%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-setfont&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-setfont.php">＋<small>add a note</small></a></span>
