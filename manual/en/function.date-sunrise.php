...
<head>
  ...
  <title>PHP: date_sunrise - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-sunrise.php">
 <link rel="shorturl" href="https://www.php.net/date-sunrise">
 <link rel="alternate" href="https://www.php.net/date-sunrise" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-sun-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-sunset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-sunrise.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-sunrise.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-sunrise.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-sunrise.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-sunrise.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-sunrise.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-sunrise.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-sunrise.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-sunrise.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-sunrise.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-sunrise.php" hreflang="zh">
...
<meta name="Description" content="Returns time of sunrise for a given day and location" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_sunrise - Manual" />
<meta name="twitter:description" content="Returns time of sunrise for a given day and location" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_sunrise - Manual" />
<meta itemprop="description" content="Returns time of sunrise for a given day and location" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns time of sunrise for a given day and location" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.date-sunset.php">
          date_sunset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.date-sun-info.php">
          &laquo; date_sun_info        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-sunrise.php' selected="selected">English</option>
            <option value='de/function.date-sunrise.php'>German</option>
            <option value='es/function.date-sunrise.php'>Spanish</option>
            <option value='fr/function.date-sunrise.php'>French</option>
            <option value='it/function.date-sunrise.php'>Italian</option>
            <option value='ja/function.date-sunrise.php'>Japanese</option>
            <option value='pt_BR/function.date-sunrise.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-sunrise.php'>Russian</option>
            <option value='tr/function.date-sunrise.php'>Turkish</option>
            <option value='uk/function.date-sunrise.php'>Ukrainian</option>
            <option value='zh/function.date-sunrise.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-sunrise" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">date_sunrise</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">date_sunrise</span> &mdash; <span class="dc-title">Returns time of sunrise for a given day and location</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.date-sunrise-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The <code class="parameter">timestamp</code> of the day from which the sunrise
       time is taken.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.date-sunrise-returnvalues">
  ...
  <p class="para">
   Returns the sunrise time in a specified <code class="parameter">returnFormat</code> on
...
<div class="examplescode"><pre class="examplescode">Mon Dec 20 2004, sunrise time : 08:54</pre>
</div>
    </div>
   </div>
   <div class="example" id="example-2288">
    <p><strong>Example #2 No sunrise</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.date-sun-info.php" class="function" rel="rdfs-seeAlso">date_sun_info()</a> - Returns an array with information about sunset/sunrise and twilight begin/end</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-sunrise.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-sunrise%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-sunrise&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-sunrise.php">＋<small>add a note</small></a></span>
