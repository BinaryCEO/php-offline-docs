...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-errcode.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-drop-db.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-errmsg.php">
...
<meta name="Description" content="Return an error code" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_errcode - Manual" />
<meta name="twitter:description" content="Return an error code" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_errcode - Manual" />
<meta itemprop="description" content="Return an error code" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return an error code" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-errcode.php' selected="selected">English</option>
            ...
            <option value='ja/function.ibase-errcode.php'>Japanese</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ibase-errmsg.php" class="function" rel="rdfs-seeAlso">ibase_errmsg()</a> - Return error messages</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-errcode.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-errcode%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-errcode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-errcode.php">＋<small>add a note</small></a></span>
