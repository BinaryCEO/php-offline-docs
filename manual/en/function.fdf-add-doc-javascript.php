...
<head>
  ...
  <title>PHP: fdf_add_doc_javascript - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-add-doc-javascript.php">
 <link rel="shorturl" href="https://www.php.net/fdf-add-doc-javascript">
 <link rel="alternate" href="https://www.php.net/fdf-add-doc-javascript" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-add-template.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdf-add-doc-javascript.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdf-add-doc-javascript.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdf-add-doc-javascript.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdf-add-doc-javascript.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdf-add-doc-javascript.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdf-add-doc-javascript.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdf-add-doc-javascript.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdf-add-doc-javascript.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdf-add-doc-javascript.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdf-add-doc-javascript.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdf-add-doc-javascript.php" hreflang="zh">
...
<meta name="Description" content="Adds javascript code to the FDF document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_add_doc_javascript - Manual" />
<meta name="twitter:description" content="Adds javascript code to the FDF document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_add_doc_javascript - Manual" />
<meta itemprop="description" content="Adds javascript code to the FDF document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds javascript code to the FDF document" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fdf-add-template.php">
          fdf_add_template &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.fdf.php">
          &laquo; FDF Functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-add-doc-javascript.php' selected="selected">English</option>
            <option value='de/function.fdf-add-doc-javascript.php'>German</option>
            <option value='es/function.fdf-add-doc-javascript.php'>Spanish</option>
            <option value='fr/function.fdf-add-doc-javascript.php'>French</option>
            <option value='it/function.fdf-add-doc-javascript.php'>Italian</option>
            <option value='ja/function.fdf-add-doc-javascript.php'>Japanese</option>
            <option value='pt_BR/function.fdf-add-doc-javascript.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdf-add-doc-javascript.php'>Russian</option>
            <option value='tr/function.fdf-add-doc-javascript.php'>Turkish</option>
            <option value='uk/function.fdf-add-doc-javascript.php'>Ukrainian</option>
            <option value='zh/function.fdf-add-doc-javascript.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdf-add-doc-javascript" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fdf_add_doc_javascript</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5 &lt; 5.3.0, PECL fdf SVN)</p><p class="refpurpose"><span class="refname">fdf_add_doc_javascript</span> &mdash; <span class="dc-title">Adds javascript code to the FDF document</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.fdf-add-doc-javascript-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fdf_add_doc_javascript</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$fdf_document</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$script_name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$script_code</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fdf-add-doc-javascript-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">script_name</code></dt>
     <dd>
      <p class="para">
       The script name.
      </p>
     ...
     <dt><code class="parameter">script_code</code></dt>
     <dd>
      <p class="para">
       The script code. It is strongly suggested to use <code class="literal">\r</code>
 ...
 <div class="refsect1 examples" id="refsect1-function.fdf-add-doc-javascript-examples">
  ...
  <p class="para">
   <div class="example" id="example-3398">
...
%%EOF</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-add-doc-javascript.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-add-doc-javascript%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-add-doc-javascript&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-add-doc-javascript.php">＋<small>add a note</small></a></span>
