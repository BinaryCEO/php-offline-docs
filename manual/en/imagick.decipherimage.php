...
<head>
  ...
  <title>PHP: Imagick::decipherImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.decipherimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.decipherimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.decipherimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.cyclecolormapimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.deconstructimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.decipherimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.decipherimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.decipherimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.decipherimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.decipherimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.decipherimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.decipherimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.decipherimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.decipherimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.decipherimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.decipherimage.php" hreflang="zh">
...
<meta name="Description" content="Deciphers an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::decipherImage - Manual" />
<meta name="twitter:description" content="Deciphers an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::decipherImage - Manual" />
<meta itemprop="description" content="Deciphers an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Deciphers an image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.deconstructimages.php">
          Imagick::deconstructImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.cyclecolormapimage.php">
          &laquo; Imagick::cycleColormapImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.decipherimage.php' selected="selected">English</option>
            <option value='de/imagick.decipherimage.php'>German</option>
            <option value='es/imagick.decipherimage.php'>Spanish</option>
            <option value='fr/imagick.decipherimage.php'>French</option>
            <option value='it/imagick.decipherimage.php'>Italian</option>
            <option value='ja/imagick.decipherimage.php'>Japanese</option>
            <option value='pt_BR/imagick.decipherimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.decipherimage.php'>Russian</option>
            <option value='tr/imagick.decipherimage.php'>Turkish</option>
            <option value='uk/imagick.decipherimage.php'>Ukrainian</option>
            <option value='zh/imagick.decipherimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.decipherimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::decipherImage</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::decipherImage</span> &mdash; <span class="dc-title">Deciphers an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.decipherimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::decipherImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$passphrase</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>


  <p class="para rdfs-comment">
   Deciphers image that has been enciphered before. The image must be enciphered
   using <span class="function"><a href="imagick.encipherimage.php" class="function">Imagick::encipherImage()</a></span>.
   This method is available if Imagick has been compiled against ImageMagick version 6.3.9 or newer.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.decipherimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.decipherimage-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.decipherimage-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.encipherimage.php" class="function" rel="rdfs-seeAlso">Imagick::encipherImage()</a> - Enciphers an image</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/decipherimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.decipherimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.decipherimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.decipherimage.php">＋<small>add a note</small></a></span>
