...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.namespaces.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/language.oop5.changelog.php">
 <link rel="next" href="https://www.php.net/manual/en/language.namespaces.rationale.php">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="language.namespaces.rationale.php">Overview</a></li><li><a href="language.namespaces.definition.php">Namespaces</a></li><li><a href="language.namespaces.nested.php">Sub-namespaces</a></li><li><a href="language.namespaces.definitionmultiple.php">Defining multiple namespaces in the same file</a></li><li><a href="language.namespaces.basics.php">Basics</a></li><li><a href="language.namespaces.dynamic.php">Namespaces and dynamic language features</a></li><li><a href="language.namespaces.nsconstants.php">namespace keyword and __NAMESPACE__</a></li><li><a href="language.namespaces.importing.php">Aliasing and Importing</a></li><li><a href="language.namespaces.global.php">Global space</a></li><li><a href="language.namespaces.fallback.php">Fallback to global space</a></li><li><a href="language.namespaces.rules.php">Name resolution rules</a></li><li><a href="language.namespaces.faq.php">FAQ</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.namespaces%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.namespaces&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.namespaces.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Tested on PHP 7.0.5, Windows<br />The line "use animate;" equals the line "use animate as animate;"<br />but the "use other\animate;" equals "use other\animate as animate;"<br /><br />file1:<br /><span class="default">&lt;?php </span><span class="keyword">namespace </span><span class="default">foo</span><span class="keyword">;<br />  class </span><span class="default">Cat </span><span class="keyword">{ <br />    static function </span><span class="default">says</span><span class="keyword">() {echo </span><span class="string">'meoow'</span><span class="keyword">;}  } </span><span class="default">?&gt;<br /></span><br />file2:<br /><span class="default">&lt;?php </span><span class="keyword">namespace </span><span class="default">bar</span><span class="keyword">;<br />  class </span><span class="default">Dog </span><span class="keyword">{<br />    static function </span><span class="default">says</span><span class="keyword">() {echo </span><span class="string">'ruff'</span><span class="keyword">;}  } </span><span class="default">?&gt;<br /></span><br />file3:<br /><span class="default">&lt;?php </span><span class="keyword">namespace </span><span class="default">other\animate</span><span class="keyword">;<br />  class </span><span class="default">Animal </span><span class="keyword">{<br />    static function </span><span class="default">breathes</span><span class="keyword">() {echo </span><span class="string">'air'</span><span class="keyword">;}  } </span><span class="default">?&gt;<br /></span><br />file4:<br /><span class="default">&lt;?php </span><span class="keyword">namespace </span><span class="default">fub</span><span class="keyword">;<br />  include </span><span class="string">'file1.php'</span><span class="keyword">;<br />  include </span><span class="string">'file2.php'</span><span class="keyword">;<br />  include </span><span class="string">'file3.php'</span><span class="keyword">;<br />  use </span><span class="default">foo </span><span class="keyword">as </span><span class="default">feline</span><span class="keyword">;<br />  use </span><span class="default">bar </span><span class="keyword">as </span><span class="default">canine</span><span class="keyword">;<br />  use </span><span class="default">other\animate</span><span class="keyword">;       </span><span class="comment">//use other\animate as animate;<br />  </span><span class="keyword">echo </span><span class="default">feline\Cat</span><span class="keyword">::</span><span class="default">says</span><span class="keyword">(), </span><span class="string">"&lt;br /&gt;\n"</span><span class="keyword">;<br />  echo </span><span class="default">canine\Dog</span><span class="keyword">::</span><span class="default">says</span><span class="keyword">(), </span><span class="string">"&lt;br /&gt;\n"</span><span class="keyword">;<br />  echo </span><span class="default">\animate\Animal</span><span class="keyword">::</span><span class="default">breathes</span><span class="keyword">(), </span><span class="string">"&lt;br /&gt;\n"</span><span class="keyword">;  </span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="118554">  <div class="votes">
    ...
    <div class="tally" id="V118554" title="53% like this...">
    16
    </div>
  </div>
  <a href="#118554" class="name">
  <strong class="user"><em>varuninorbit at yahoo dot co dot in</em></strong></a><a class="genanchor" href="#118554"> &para;</a><div class="date" title="2015-12-27 06:43"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118554">
<div class="phpcode"><code><span class="html">here is a simple example to use namespace<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">namespace </span><span class="default">app\a</span><span class="keyword">{<br />    class </span><span class="default">one</span><span class="keyword">{<br />       public static function </span><span class="default">_1</span><span class="keyword">(){<br />        echo </span><span class="string">'a one _1&lt;br&gt;'</span><span class="keyword">;<br />       }<br />    }<br />}<br /><br />namespace </span><span class="default">app\b</span><span class="keyword">{<br />    class </span><span class="default">one</span><span class="keyword">{<br />        public static function </span><span class="default">_2</span><span class="keyword">(){<br />            echo </span><span class="string">'b one _2&lt;br&gt;'</span><span class="keyword">;<br />        }<br />    }<br />}<br /><br />namespace </span><span class="default">app</span><span class="keyword">{<br /><br />    echo </span><span class="default">a\one</span><span class="keyword">::</span><span class="default">_1</span><span class="keyword">();<br />    echo </span><span class="default">b\one</span><span class="keyword">::</span><span class="default">_2</span><span class="keyword">();<br />    echo </span><span class="default">a\two</span><span class="keyword">::</span><span class="default">_1</span><span class="keyword">();<br />}<br /><br />namespace </span><span class="default">app\a</span><span class="keyword">{<br />    class </span><span class="default">two</span><span class="keyword">{<br />       public static function </span><span class="default">_1</span><span class="keyword">(){<br />        echo </span><span class="string">'a two _1&lt;br&gt;'</span><span class="keyword">;<br />       }<br />    }<br />}<br /><br /></span><span class="default">prints <br />a one _1<br />b one _2<br />a two _1</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">In addition to using namespaces and closures, the use keyword has another new meaning as of PHP 5.4 - using traits:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">trait </span><span class="default">Hello </span><span class="keyword">{<br />    public function </span><span class="default">sayHello</span><span class="keyword">() {<br />        echo </span><span class="string">'Hello '</span><span class="keyword">;<br />    }<br />}<br /><br />trait </span><span class="default">World </span><span class="keyword">{<br />    public function </span><span class="default">sayWorld</span><span class="keyword">() {<br />        echo </span><span class="string">'World'</span><span class="keyword">;<br />    }<br />}<br /><br />class </span><span class="default">MyHelloWorld </span><span class="keyword">{<br />    use </span><span class="default">Hello</span><span class="keyword">, </span><span class="default">World</span><span class="keyword">;<br />    public function </span><span class="default">sayExclamationMark</span><span class="keyword">() {<br />        echo </span><span class="string">'!'</span><span class="keyword">;<br />    }<br />}<br /><br /></span><span class="default">$o </span><span class="keyword">= new </span><span class="default">MyHelloWorld</span><span class="keyword">();<br /></span><span class="default">$o</span><span class="keyword">-&gt;</span><span class="default">sayHello</span><span class="keyword">();<br /></span><span class="default">$o</span><span class="keyword">-&gt;</span><span class="default">sayWorld</span><span class="keyword">();<br /></span><span class="default">$o</span><span class="keyword">-&gt;</span><span class="default">sayExclamationMark</span><span class="keyword">();<br /></span><span class="default">?&gt;<br /></span><br />More info here: <a href="http://php.net/manual/en/language.oop5.traits.php" rel="nofollow" target="_blank">http://php.net/manual/en/language.oop5.traits.php</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=language.namespaces&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.namespaces.php">＋<small>add a note</small></a></div>
