...
<head>
  ...
  <title>PHP: Imagick::spreadImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.spreadimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.spreadimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.spreadimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.spliceimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.statisticimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.spreadimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.spreadimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.spreadimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.spreadimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.spreadimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.spreadimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.spreadimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.spreadimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.spreadimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.spreadimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.spreadimage.php" hreflang="zh">
...
<meta name="Description" content="Randomly displaces each pixel in a block" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::spreadImage - Manual" />
<meta name="twitter:description" content="Randomly displaces each pixel in a block" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::spreadImage - Manual" />
<meta itemprop="description" content="Randomly displaces each pixel in a block" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Randomly displaces each pixel in a block" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.statisticimage.php">
          Imagick::statisticImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.spliceimage.php">
          &laquo; Imagick::spliceImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.spreadimage.php' selected="selected">English</option>
            <option value='de/imagick.spreadimage.php'>German</option>
            <option value='es/imagick.spreadimage.php'>Spanish</option>
            <option value='fr/imagick.spreadimage.php'>French</option>
            <option value='it/imagick.spreadimage.php'>Italian</option>
            <option value='ja/imagick.spreadimage.php'>Japanese</option>
            <option value='pt_BR/imagick.spreadimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.spreadimage.php'>Russian</option>
            <option value='tr/imagick.spreadimage.php'>Turkish</option>
            <option value='uk/imagick.spreadimage.php'>Ukrainian</option>
            <option value='zh/imagick.spreadimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.spreadimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::spreadImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::spreadImage</span> &mdash; <span class="dc-title">Randomly displaces each pixel in a block</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.spreadimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::spreadImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.spreadimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.spreadimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.spreadimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-3126">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/spreadimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.spreadimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.spreadimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.spreadimage.php">＋<small>add a note</small></a></span>
