...
<head>
  ...
  <title>PHP: pg_connection_reset - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-connection-reset.php">
 <link rel="shorturl" href="https://www.php.net/pg-connection-reset">
 <link rel="alternate" href="https://www.php.net/pg-connection-reset" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-connection-busy.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-connection-status.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-connection-reset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-connection-reset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-connection-reset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-connection-reset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-connection-reset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-connection-reset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-connection-reset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-connection-reset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-connection-reset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-connection-reset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-connection-reset.php" hreflang="zh">
...
<meta name="Description" content="Reset connection (reconnect)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_connection_reset - Manual" />
<meta name="twitter:description" content="Reset connection (reconnect)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_connection_reset - Manual" />
<meta itemprop="description" content="Reset connection (reconnect)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reset connection (reconnect)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-connection-status.php">
          pg_connection_status &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-connection-busy.php">
          &laquo; pg_connection_busy        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-connection-reset.php' selected="selected">English</option>
            <option value='de/function.pg-connection-reset.php'>German</option>
            <option value='es/function.pg-connection-reset.php'>Spanish</option>
            <option value='fr/function.pg-connection-reset.php'>French</option>
            <option value='it/function.pg-connection-reset.php'>Italian</option>
            <option value='ja/function.pg-connection-reset.php'>Japanese</option>
            <option value='pt_BR/function.pg-connection-reset.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-connection-reset.php'>Russian</option>
            <option value='tr/function.pg-connection-reset.php'>Turkish</option>
            <option value='uk/function.pg-connection-reset.php'>Ukrainian</option>
            <option value='zh/function.pg-connection-reset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-connection-reset" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_connection_reset</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_connection_reset</span> &mdash; <span class="dc-title">
   Reset connection (reconnect)
  </span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-connection-reset-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_connection_reset</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_connection_reset()</strong></span> resets the connection.
   It is useful for error recovery.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.pg-connection-reset-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-connection-reset-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.pg-connection-reset-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-connection-reset-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2044">
    <p><strong>Example #1 <span class="function"><strong>pg_connection_reset()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />  $dbconn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=publisher"</span><span style="color: #007700">) or die(</span><span style="color: #DD0000">"Could not connect"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">$dbconn2 </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connection_reset</span><span style="color: #007700">(</span><span style="color: #0000BB">$dbconn</span><span style="color: #007700">);<br />  if (</span><span style="color: #0000BB">$dbconn2</span><span style="color: #007700">) {<br />      echo </span><span style="color: #DD0000">"reset successful\n"</span><span style="color: #007700">;<br />  } else {<br />      echo </span><span style="color: #DD0000">"reset failed\n"</span><span style="color: #007700">;<br />  }<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-connection-reset-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-connection-status.php" class="function" rel="rdfs-seeAlso">pg_connection_status()</a> - Get connection status</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-connection-reset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-connection-reset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-connection-reset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-connection-reset.php">＋<small>add a note</small></a></span>
