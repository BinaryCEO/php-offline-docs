...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightMergeContiguous - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightmergecontiguous.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightmergecontiguous.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightmergecontiguous.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightmaxanalyzedchars.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightquery.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightmergecontiguous.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightmergecontiguous.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightmergecontiguous.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightmergecontiguous.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightmergecontiguous.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightmergecontiguous.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightmergecontiguous.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightmergecontiguous.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightmergecontiguous.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightmergecontiguous.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightmergecontiguous.php" hreflang="zh">
...
<meta name="Description" content="Whether or not to collapse contiguous fragments into a single fragment" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightMergeContiguous - Manual" />
<meta name="twitter:description" content="Whether or not to collapse contiguous fragments into a single fragment" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightMergeContiguous - Manual" />
<meta itemprop="description" content="Whether or not to collapse contiguous fragments into a single fragment" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Whether or not to collapse contiguous fragments into a single fragment" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.sethighlightquery.php">
          SolrQuery::setHighlightQuery &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightmaxanalyzedchars.php">
          &laquo; SolrQuery::setHighlightMaxAnalyzedChars        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightmergecontiguous.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightmergecontiguous.php'>German</option>
            <option value='es/solrquery.sethighlightmergecontiguous.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightmergecontiguous.php'>French</option>
            <option value='it/solrquery.sethighlightmergecontiguous.php'>Italian</option>
            <option value='ja/solrquery.sethighlightmergecontiguous.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightmergecontiguous.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightmergecontiguous.php'>Russian</option>
            <option value='tr/solrquery.sethighlightmergecontiguous.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightmergecontiguous.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightmergecontiguous.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightmergecontiguous" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightMergeContiguous</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightMergeContiguous</span> &mdash; <span class="dc-title">Whether or not to collapse contiguous fragments into a single fragment</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightmergecontiguous-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightMergeContiguous</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightmergecontiguous-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightmergecontiguous-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightmergecontiguous.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightmergecontiguous%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightmergecontiguous&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightmergecontiguous.php">＋<small>add a note</small></a></span>
