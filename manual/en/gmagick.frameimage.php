...
<head>
  ...
  <title>PHP: Gmagick::frameimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.frameimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.frameimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.frameimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.flopimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.gammaimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.frameimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.frameimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.frameimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.frameimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.frameimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.frameimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.frameimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.frameimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.frameimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.frameimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.frameimage.php" hreflang="zh">
...
<meta name="Description" content="Adds a simulated three-dimensional border" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::frameimage - Manual" />
<meta name="twitter:description" content="Adds a simulated three-dimensional border" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::frameimage - Manual" />
<meta itemprop="description" content="Adds a simulated three-dimensional border" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds a simulated three-dimensional border" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.gammaimage.php">
          Gmagick::gammaimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.flopimage.php">
          &laquo; Gmagick::flopimage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.frameimage.php' selected="selected">English</option>
            <option value='de/gmagick.frameimage.php'>German</option>
            <option value='es/gmagick.frameimage.php'>Spanish</option>
            <option value='fr/gmagick.frameimage.php'>French</option>
            <option value='it/gmagick.frameimage.php'>Italian</option>
            <option value='ja/gmagick.frameimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.frameimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.frameimage.php'>Russian</option>
            <option value='tr/gmagick.frameimage.php'>Turkish</option>
            <option value='uk/gmagick.frameimage.php'>Ukrainian</option>
            <option value='zh/gmagick.frameimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.frameimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::frameimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::frameimage</span> &mdash; <span class="dc-title">Adds a simulated three-dimensional border</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.frameimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::frameimage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.gmagickpixel.php" class="type GmagickPixel">GmagickPixel</a></span> <code class="parameter">$color</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$inner_bevel</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$outer_bevel</code></span><br>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
...
Adds a simulated three-dimensional border around the image. The width and height specify the border width of the vertical and horizontal sides of the frame. The inner and outer bevels indicate the width of the inner and outer shadows of the frame.
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.frameimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       <span class="classname"><a href="class.gmagickpixel.php" class="classname">GmagickPixel</a></span> object or a float representing the matte color.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.frameimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The framed <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.frameimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/frameimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.frameimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.frameimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.frameimage.php">＋<small>add a note</small></a></span>
