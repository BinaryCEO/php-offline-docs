...
<head>
  ...
  <title>PHP: SolrQuery::getFacetDateGap - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfacetdategap.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfacetdategap.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetdategap.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfacetdatefields.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfacetdatehardend.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetdategap.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfacetdategap.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfacetdategap.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfacetdategap.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfacetdategap.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfacetdategap.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfacetdategap.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfacetdategap.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfacetdategap.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfacetdategap.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfacetdategap.php" hreflang="zh">
...
<meta name="Description" content="Returns the value of the facet.date.gap parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFacetDateGap - Manual" />
<meta name="twitter:description" content="Returns the value of the facet.date.gap parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFacetDateGap - Manual" />
<meta itemprop="description" content="Returns the value of the facet.date.gap parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the value of the facet.date.gap parameter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getfacetdatehardend.php">
          SolrQuery::getFacetDateHardEnd &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfacetdatefields.php">
          &laquo; SolrQuery::getFacetDateFields        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfacetdategap.php' selected="selected">English</option>
            <option value='de/solrquery.getfacetdategap.php'>German</option>
            <option value='es/solrquery.getfacetdategap.php'>Spanish</option>
            <option value='fr/solrquery.getfacetdategap.php'>French</option>
            <option value='it/solrquery.getfacetdategap.php'>Italian</option>
            <option value='ja/solrquery.getfacetdategap.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfacetdategap.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfacetdategap.php'>Russian</option>
            <option value='tr/solrquery.getfacetdategap.php'>Turkish</option>
            <option value='uk/solrquery.getfacetdategap.php'>Ukrainian</option>
            <option value='zh/solrquery.getfacetdategap.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfacetdategap" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFacetDateGap</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFacetDateGap</span> &mdash; <span class="dc-title">Returns the value of the facet.date.gap parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfacetdategap-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFacetDateGap</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfacetdategap-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfacetdategap-returnvalues">
...
Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfacetdategap.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfacetdategap%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfacetdategap&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfacetdategap.php">＋<small>add a note</small></a></span>
