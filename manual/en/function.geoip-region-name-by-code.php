...
<head>
  ...
  <title>PHP: geoip_region_name_by_code - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.geoip-region-name-by-code.php">
 <link rel="shorturl" href="https://www.php.net/geoip-region-name-by-code">
 <link rel="alternate" href="https://www.php.net/geoip-region-name-by-code" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.geoip.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.geoip-region-by-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.geoip-setup-custom-directory.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.geoip-region-name-by-code.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.geoip-region-name-by-code.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.geoip-region-name-by-code.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.geoip-region-name-by-code.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.geoip-region-name-by-code.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.geoip-region-name-by-code.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.geoip-region-name-by-code.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.geoip-region-name-by-code.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.geoip-region-name-by-code.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.geoip-region-name-by-code.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.geoip-region-name-by-code.php" hreflang="zh">
...
<meta name="Description" content="Returns the region name for some country and region code combo" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: geoip_region_name_by_code - Manual" />
<meta name="twitter:description" content="Returns the region name for some country and region code combo" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: geoip_region_name_by_code - Manual" />
<meta itemprop="description" content="Returns the region name for some country and region code combo" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the region name for some country and region code combo" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.geoip-setup-custom-directory.php">
          geoip_setup_custom_directory &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.geoip-region-by-name.php">
          &laquo; geoip_region_by_name        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.geoip-region-name-by-code.php' selected="selected">English</option>
            <option value='de/function.geoip-region-name-by-code.php'>German</option>
            <option value='es/function.geoip-region-name-by-code.php'>Spanish</option>
            <option value='fr/function.geoip-region-name-by-code.php'>French</option>
            <option value='it/function.geoip-region-name-by-code.php'>Italian</option>
            <option value='ja/function.geoip-region-name-by-code.php'>Japanese</option>
            <option value='pt_BR/function.geoip-region-name-by-code.php'>Brazilian Portuguese</option>
            <option value='ru/function.geoip-region-name-by-code.php'>Russian</option>
            <option value='tr/function.geoip-region-name-by-code.php'>Turkish</option>
            <option value='uk/function.geoip-region-name-by-code.php'>Ukrainian</option>
            <option value='zh/function.geoip-region-name-by-code.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.geoip-region-name-by-code" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.geoip-region-name-by-code-examples">
  ...
  <p class="para">
   <div class="example" id="example-3688">
    <p><strong>Example #1 A <span class="function"><strong>geoip_region_name_by_code()</strong></span> example using region code for US/Canada</strong></p>
...
<div class="examplescode"><pre class="examplescode">Region name for CA/QC is: Quebec</pre>
   ...
   <div class="example" id="example-3689">
    <p><strong>Example #2 A <span class="function"><strong>geoip_region_name_by_code()</strong></span> example using FIPS codes</strong></p>
    <div class="example-contents"><p>
...
<div class="examplescode"><pre class="examplescode">Region name for JP/01 is: Aichi</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/geoip/functions/geoip-region-name-by-code.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.geoip-region-name-by-code%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.geoip-region-name-by-code&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.geoip-region-name-by-code.php">＋<small>add a note</small></a></span>
