...
<head>
  ...
  <title>PHP: DOMEntityReference - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.domentityreference.php">
 <link rel="shorturl" href="https://www.php.net/domentityreference">
 <link rel="alternate" href="https://www.php.net/domentityreference" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.domentity.php">
 <link rel="next" href="https://www.php.net/manual/en/domentityreference.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.domentityreference.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.domentityreference.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.domentityreference.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.domentityreference.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.domentityreference.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.domentityreference.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.domentityreference.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.domentityreference.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.domentityreference.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.domentityreference.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.domentityreference.php" hreflang="zh">
...
<meta name="Description" content="The DOMEntityReference class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMEntityReference - Manual" />
<meta name="twitter:description" content="The DOMEntityReference class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMEntityReference - Manual" />
<meta itemprop="description" content="The DOMEntityReference class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DOMEntityReference class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="domentityreference.construct.php">
          DOMEntityReference::__construct &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.domentityreference.php' selected="selected">English</option>
            <option value='de/class.domentityreference.php'>German</option>
            <option value='es/class.domentityreference.php'>Spanish</option>
            <option value='fr/class.domentityreference.php'>French</option>
            <option value='it/class.domentityreference.php'>Italian</option>
            <option value='ja/class.domentityreference.php'>Japanese</option>
            <option value='pt_BR/class.domentityreference.php'>Brazilian Portuguese</option>
            <option value='ru/class.domentityreference.php'>Russian</option>
            <option value='tr/class.domentityreference.php'>Turkish</option>
            <option value='uk/class.domentityreference.php'>Ukrainian</option>
            <option value='zh/class.domentityreference.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.domentityreference" class="reference">
 <h1 class="title">The DOMEntityReference class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>
  ...
  <div class="section" id="domentityreference.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">DOMEntityReference</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="domentityreference.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>)</div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="domentityreference.construct.php">DOMEntityReference::__construct</a> — Creates a new DOMEntityReference object</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domentityreference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.domentityreference%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.domentityreference&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.domentityreference.php">＋<small>add a note</small></a></span>
