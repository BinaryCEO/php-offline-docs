...
<head>
  ...
  <title>PHP: Imagick::spliceImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.spliceimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.spliceimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.spliceimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.sparsecolorimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.spreadimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.spliceimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.spliceimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.spliceimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.spliceimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.spliceimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.spliceimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.spliceimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.spliceimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.spliceimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.spliceimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.spliceimage.php" hreflang="zh">
...
<meta name="Description" content="Splices a solid color into the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::spliceImage - Manual" />
<meta name="twitter:description" content="Splices a solid color into the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::spliceImage - Manual" />
<meta itemprop="description" content="Splices a solid color into the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Splices a solid color into the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.spreadimage.php">
          Imagick::spreadImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.sparsecolorimage.php">
          &laquo; Imagick::sparseColorImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.spliceimage.php' selected="selected">English</option>
            <option value='de/imagick.spliceimage.php'>German</option>
            <option value='es/imagick.spliceimage.php'>Spanish</option>
            <option value='fr/imagick.spliceimage.php'>French</option>
            <option value='it/imagick.spliceimage.php'>Italian</option>
            <option value='ja/imagick.spliceimage.php'>Japanese</option>
            <option value='pt_BR/imagick.spliceimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.spliceimage.php'>Russian</option>
            <option value='tr/imagick.spliceimage.php'>Turkish</option>
            <option value='uk/imagick.spliceimage.php'>Ukrainian</option>
            <option value='zh/imagick.spliceimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.spliceimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::spliceImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::spliceImage</span> &mdash; <span class="dc-title">Splices a solid color into the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.spliceimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::spliceImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.spliceimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.spliceimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3125">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/spliceimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.spliceimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.spliceimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.spliceimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119263">  <div class="votes">
    <div id="Vu119263">
    <a href="/manual/vote-note.php?id=119263&amp;page=imagick.spliceimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119263">
    <a href="/manual/vote-note.php?id=119263&amp;page=imagick.spliceimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119263" title="no votes...">
    0
    </div>
  </div>
  <a href="#119263" class="name">
  <strong class="user"><em>fake0 at shenafu dot com</em></strong></a><a class="genanchor" href="#119263"> &para;</a><div class="date" title="2016-04-29 03:16"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119263">
<div class="phpcode"><code><span class="html">spliceImage() increases the dimensions of the image without stretching the original image by creating a box of the same color as the image's background.<br /><br />You can set the color with setImageBackgroundColor() before running spliceImage().<br /><br />The $width and $height parameters define how much is increased horizontally and vertically, respectively, which determines how big the box is. (Note that these values are not always the same size as the box.) The final dimensions of the new image are<br />$newWidth = $oldWidth + $width<br />$newHeight = $oldHeight + $height<br /><br />So, to expand the image in both directions, $width and $height should be positive values. To expand in only one direction (horizontally or vertically), set one of these values to 0 ($height or $width respectively).<br /><br />The $x and $y parameters are relative to the original image and define where to put the box. If $x and $y are one of the corners of the original image, the box is placed in the respective corner and expands the image outward from that corner. Otherwise, the box splits the original image to the sides or corners and places the box in the middle of the new image. Thus, you use $x and $y to direct where and how the original image is split. Any remaining space is filled with the background color.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.spliceimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.spliceimage.php">＋<small>add a note</small></a></div>
