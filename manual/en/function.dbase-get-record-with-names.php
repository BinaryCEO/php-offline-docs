...
<head>
  ...
  <title>PHP: dbase_get_record_with_names - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.dbase-get-record-with-names.php">
 <link rel="shorturl" href="https://www.php.net/dbase-get-record-with-names">
 <link rel="alternate" href="https://www.php.net/dbase-get-record-with-names" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.dbase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.dbase-get-record.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dbase-numfields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.dbase-get-record-with-names.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.dbase-get-record-with-names.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.dbase-get-record-with-names.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.dbase-get-record-with-names.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.dbase-get-record-with-names.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.dbase-get-record-with-names.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.dbase-get-record-with-names.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.dbase-get-record-with-names.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.dbase-get-record-with-names.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.dbase-get-record-with-names.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.dbase-get-record-with-names.php" hreflang="zh">
...
<meta name="Description" content="Gets a record from a database as an associative array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: dbase_get_record_with_names - Manual" />
<meta name="twitter:description" content="Gets a record from a database as an associative array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: dbase_get_record_with_names - Manual" />
<meta itemprop="description" content="Gets a record from a database as an associative array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets a record from a database as an associative array" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.dbase-numfields.php">
          dbase_numfields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.dbase-get-record.php">
          &laquo; dbase_get_record        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.dbase-get-record-with-names.php' selected="selected">English</option>
            <option value='de/function.dbase-get-record-with-names.php'>German</option>
            <option value='es/function.dbase-get-record-with-names.php'>Spanish</option>
            <option value='fr/function.dbase-get-record-with-names.php'>French</option>
            <option value='it/function.dbase-get-record-with-names.php'>Italian</option>
            <option value='ja/function.dbase-get-record-with-names.php'>Japanese</option>
            <option value='pt_BR/function.dbase-get-record-with-names.php'>Brazilian Portuguese</option>
            <option value='ru/function.dbase-get-record-with-names.php'>Russian</option>
            <option value='tr/function.dbase-get-record-with-names.php'>Turkish</option>
            <option value='uk/function.dbase-get-record-with-names.php'>Ukrainian</option>
            <option value='zh/function.dbase-get-record-with-names.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.dbase-get-record-with-names" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.dbase-get-record.php" class="function" rel="rdfs-seeAlso">dbase_get_record()</a> - Gets a record from a database as an indexed array</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dbase/functions/dbase-get-record-with-names.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.dbase-get-record-with-names%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.dbase-get-record-with-names&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dbase-get-record-with-names.php">＋<small>add a note</small></a></span>
