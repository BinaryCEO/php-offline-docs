...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.posix.php">
 <link rel="shorturl" href="https://www.php.net/posix">
 <link rel="alternate" href="https://www.php.net/posix" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/refs.fileprocess.process.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pcntl-wtermsig.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.posix.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.posix.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.posix.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.posix.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.posix.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.posix.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.posix.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.posix.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.posix.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.posix.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.posix.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.posix.php" hreflang="zh">
...
<meta name="Description" content="POSIX" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: POSIX - Manual" />
<meta name="twitter:description" content="POSIX" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: POSIX - Manual" />
<meta itemprop="description" content="POSIX" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="POSIX" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intro.posix.php">
          Introduction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pcntl-wtermsig.php">
          &laquo; pcntl_wtermsig        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.posix.php' selected="selected">English</option>
            <option value='de/book.posix.php'>German</option>
            <option value='es/book.posix.php'>Spanish</option>
            <option value='fr/book.posix.php'>French</option>
            <option value='it/book.posix.php'>Italian</option>
            <option value='ja/book.posix.php'>Japanese</option>
            <option value='pt_BR/book.posix.php'>Brazilian Portuguese</option>
            <option value='ru/book.posix.php'>Russian</option>
            <option value='tr/book.posix.php'>Turkish</option>
            <option value='uk/book.posix.php'>Ukrainian</option>
            <option value='zh/book.posix.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.posix" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.posix.php">Introduction</a></li><li><a href="posix.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="posix.installation.php">Installation</a></li></ul></li><li><a href="posix.constants.php">Predefined Constants</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="posix.constants.access.php">posix_access constants</a></li><li><a href="posix.constants.mknod.php">posix_mknod constants</a></li><li><a href="posix.constants.setrlimit.php">posix_setrlimit constants</a></li><li><a href="posix.constants.pathconf.php">posix_pathconf constants</a></li><li><a href="posix.constants.sysconf.php">posix_sysconf constants</a></li></ul></li><li><a href="ref.posix.php">POSIX Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.posix-access.php">posix_access</a> — Determine accessibility of a file</li><li><a href="function.posix-ctermid.php">posix_ctermid</a> — Get path name of controlling terminal</li><li><a href="function.posix-eaccess.php">posix_eaccess</a> — Determine accessibility of a file</li><li><a href="function.posix-errno.php">posix_errno</a> — Alias of posix_get_last_error</li><li><a href="function.posix-fpathconf.php">posix_fpathconf</a> — Returns the value of a configurable limit</li><li><a href="function.posix-get-last-error.php">posix_get_last_error</a> — Retrieve the error number set by the last posix function that failed</li><li><a href="function.posix-getcwd.php">posix_getcwd</a> — Pathname of current directory</li><li><a href="function.posix-getegid.php">posix_getegid</a> — Return the effective group ID of the current process</li><li><a href="function.posix-geteuid.php">posix_geteuid</a> — Return the effective user ID of the current process</li><li><a href="function.posix-getgid.php">posix_getgid</a> — Return the real group ID of the current process</li><li><a href="function.posix-getgrgid.php">posix_getgrgid</a> — Return info about a group by group id</li><li><a href="function.posix-getgrnam.php">posix_getgrnam</a> — Return info about a group by name</li><li><a href="function.posix-getgroups.php">posix_getgroups</a> — Return the group set of the current process</li><li><a href="function.posix-getlogin.php">posix_getlogin</a> — Return login name</li><li><a href="function.posix-getpgid.php">posix_getpgid</a> — Get process group id for job control</li><li><a href="function.posix-getpgrp.php">posix_getpgrp</a> — Return the current process group identifier</li><li><a href="function.posix-getpid.php">posix_getpid</a> — Return the current process identifier</li><li><a href="function.posix-getppid.php">posix_getppid</a> — Return the parent process identifier</li><li><a href="function.posix-getpwnam.php">posix_getpwnam</a> — Return info about a user by username</li><li><a href="function.posix-getpwuid.php">posix_getpwuid</a> — Return info about a user by user id</li><li><a href="function.posix-getrlimit.php">posix_getrlimit</a> — Return info about system resource limits</li><li><a href="function.posix-getsid.php">posix_getsid</a> — Get the current sid of the process</li><li><a href="function.posix-getuid.php">posix_getuid</a> — Return the real user ID of the current process</li><li><a href="function.posix-initgroups.php">posix_initgroups</a> — Calculate the group access list</li><li><a href="function.posix-isatty.php">posix_isatty</a> — Determine if a file descriptor is an interactive terminal</li><li><a href="function.posix-kill.php">posix_kill</a> — Send a signal to a process</li><li><a href="function.posix-mkfifo.php">posix_mkfifo</a> — Create a fifo special file (a named pipe)</li><li><a href="function.posix-mknod.php">posix_mknod</a> — Create a special or ordinary file (POSIX.1)</li><li><a href="function.posix-pathconf.php">posix_pathconf</a> — Returns the value of a configurable limit</li><li><a href="function.posix-setegid.php">posix_setegid</a> — Set the effective GID of the current process</li><li><a href="function.posix-seteuid.php">posix_seteuid</a> — Set the effective UID of the current process</li><li><a href="function.posix-setgid.php">posix_setgid</a> — Set the GID of the current process</li><li><a href="function.posix-setpgid.php">posix_setpgid</a> — Set process group id for job control</li><li><a href="function.posix-setrlimit.php">posix_setrlimit</a> — Set system resource limits</li><li><a href="function.posix-setsid.php">posix_setsid</a> — Make the current process a session leader</li><li><a href="function.posix-setuid.php">posix_setuid</a> — Set the UID of the current process</li><li><a href="function.posix-strerror.php">posix_strerror</a> — Retrieve the system error message associated with the given errno</li><li><a href="function.posix-sysconf.php">posix_sysconf</a> — Returns system runtime information</li><li><a href="function.posix-times.php">posix_times</a> — Get process times</li><li><a href="function.posix-ttyname.php">posix_ttyname</a> — Determine terminal device name</li><li><a href="function.posix-uname.php">posix_uname</a> — Get system name</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/book.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.posix%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.posix&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.posix.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="83886">  <div class="votes">
    <div id="Vu83886">
    <a href="/manual/vote-note.php?id=83886&amp;page=book.posix&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd83886">
    <a href="/manual/vote-note.php?id=83886&amp;page=book.posix&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V83886" title="50% like this...">
    0
    </div>
  </div>
  <a href="#83886" class="name">
  <strong class="user"><em>docvert at holloway dot co dot nz</em></strong></a><a class="genanchor" href="#83886"> &para;</a><div class="date" title="2008-06-16 05:45"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom83886">
<div class="phpcode"><code><span class="html">I suggest changing the description of posix_times() from "Get process times" to "Get current process times" in order to follow the "current process" naming convention of the other functions.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=book.posix&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.posix.php">＋<small>add a note</small></a></div>
