...
<head>
  ...
  <title>PHP: Gmagick::setimagechanneldepth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagechanneldepth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagechanneldepth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagechanneldepth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimagebordercolor.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagecolorspace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagechanneldepth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimagechanneldepth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimagechanneldepth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimagechanneldepth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimagechanneldepth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimagechanneldepth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimagechanneldepth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimagechanneldepth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimagechanneldepth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimagechanneldepth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimagechanneldepth.php" hreflang="zh">
...
<meta name="Description" content="Sets the depth of a particular image channel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::setimagechanneldepth - Manual" />
<meta name="twitter:description" content="Sets the depth of a particular image channel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimagechanneldepth - Manual" />
<meta itemprop="description" content="Sets the depth of a particular image channel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the depth of a particular image channel" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.setimagecolorspace.php">
          Gmagick::setimagecolorspace &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimagebordercolor.php">
          &laquo; Gmagick::setimagebordercolor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagechanneldepth.php' selected="selected">English</option>
            <option value='de/gmagick.setimagechanneldepth.php'>German</option>
            <option value='es/gmagick.setimagechanneldepth.php'>Spanish</option>
            <option value='fr/gmagick.setimagechanneldepth.php'>French</option>
            <option value='it/gmagick.setimagechanneldepth.php'>Italian</option>
            <option value='ja/gmagick.setimagechanneldepth.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimagechanneldepth.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimagechanneldepth.php'>Russian</option>
            <option value='tr/gmagick.setimagechanneldepth.php'>Turkish</option>
            <option value='uk/gmagick.setimagechanneldepth.php'>Ukrainian</option>
            <option value='zh/gmagick.setimagechanneldepth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimagechanneldepth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimagechanneldepth</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimagechanneldepth</span> &mdash; <span class="dc-title">Sets the depth of a particular image channel</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimagechanneldepth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimagechanneldepth</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$depth</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimagechanneldepth-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       One of the <a href="gmagick.constants.php#gmagick.constants.channel" class="link">Channel</a> constant
       (<code class="literal">Gmagick::CHANNEL_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimagechanneldepth-returnvalues">
  ...
  <div class="refsect1 errors" id="refsect1-gmagick.setimagechanneldepth-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagechanneldepth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagechanneldepth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagechanneldepth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagechanneldepth.php">＋<small>add a note</small></a></span>
