...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splobjectstorage.next.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splobjectstorage.next.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splobjectstorage.next.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splobjectstorage.php">
 <link rel="prev" href="https://www.php.net/manual/en/splobjectstorage.key.php">
 <link rel="next" href="https://www.php.net/manual/en/splobjectstorage.offsetexists.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splobjectstorage.next.php' selected="selected">English</option>
            ...
            <option value='zh/splobjectstorage.next.php'>Chinese (Simplified)</option>
 ...
 <div class="refsect1 examples" id="refsect1-splobjectstorage.next-examples">
  ...
  <p class="para">
   <div class="example" id="example-3888">
    <p><strong>Example #1 <span class="function"><strong>SplObjectStorage::next()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="splobjectstorage.rewind.php" class="methodname" rel="rdfs-seeAlso">SPLObjectStorage::rewind()</a> - Rewind the iterator to the first storage element</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splobjectstorage/next.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplobjectstorage.next%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splobjectstorage.next&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splobjectstorage.next.php">＋<small>add a note</small></a></span>
