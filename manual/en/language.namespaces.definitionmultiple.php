...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.namespaces.definitionmultiple.php">
 <link rel="shorturl" href="https://www.php.net/namespaces.definitionmultiple">
 <link rel="alternate" href="https://www.php.net/namespaces.definitionmultiple" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.namespaces.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.namespaces.nested.php">
 <link rel="next" href="https://www.php.net/manual/en/language.namespaces.basics.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.namespaces.definitionmultiple.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.namespaces.definitionmultiple.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.namespaces.definitionmultiple.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.namespaces.definitionmultiple.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.namespaces.definitionmultiple.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.namespaces.definitionmultiple.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.namespaces.definitionmultiple.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.namespaces.definitionmultiple.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.namespaces.definitionmultiple.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.namespaces.definitionmultiple.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.namespaces.definitionmultiple.php" hreflang="zh">
...
<meta name="Description" content="Defining multiple namespaces in the same file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Defining multiple namespaces in the same file - Manual" />
<meta name="twitter:description" content="Defining multiple namespaces in the same file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Defining multiple namespaces in the same file - Manual" />
<meta itemprop="description" content="Defining multiple namespaces in the same file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Defining multiple namespaces in the same file" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/language.namespaces.definitionmultiple.php'>Italian</option>
            ...
            <option value='uk/language.namespaces.definitionmultiple.php'>Ukrainian</option>
    ...
    <div class="example-contents">
     <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">declare(</span><span style="color: #0000BB">encoding</span><span style="color: #007700">=</span><span style="color: #DD0000">'UTF-8'</span><span style="color: #007700">);<br />namespace </span><span style="color: #0000BB">MyProject </span><span style="color: #007700">{<br /><br />const </span><span style="color: #0000BB">CONNECT_OK </span><span style="color: #007700">= </span><span style="color: #0000BB">1</span><span style="color: #007700">;<br />class </span><span style="color: #0000BB">Connection </span><span style="color: #007700">{ </span><span style="color: #FF8000">/* ... */ </span><span style="color: #007700">}<br />function </span><span style="color: #0000BB">connect</span><span style="color: #007700">() { </span><span style="color: #FF8000">/* ... */  </span><span style="color: #007700">}<br />}<br /><br />namespace { </span><span style="color: #FF8000">// global code<br /></span><span style="color: #0000BB">session_start</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$a </span><span style="color: #007700">= </span><span style="color: #0000BB">MyProject\connect</span><span style="color: #007700">();<br />echo </span><span style="color: #0000BB">MyProject\Connection</span><span style="color: #007700">::</span><span style="color: #0000BB">start</span><span style="color: #007700">();<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.namespaces.definitionmultiple%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.namespaces.definitionmultiple&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.namespaces.definitionmultiple.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="112865">  <div class="votes">
    ...
    <div class="tally" id="V112865" title="78% like this...">
    102
    </div>
  </div>
  <a href="#112865" class="name">
  <strong class="user"><em>leaksin [ at ] gmail [ dot ] com</em></strong></a><a class="genanchor" href="#112865"> &para;</a><div class="date" title="2013-07-30 10:04"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112865">
<div class="phpcode"><code><span class="html">using of global namespaces and multiple namespaces in one PHP file increase the complexity and decrease readability of the code.<br />Let's try not use this scheme even it's very necessary (although there is not)</span></code></div>
  </div>
 </div>
  <div class="note" id="117524">  <div class="votes">
    ...
    <div class="tally" id="V117524" title="80% like this...">
    55
    </div>
  </div>
  <a href="#117524" class="name">
  <strong class="user"><em>jigar dot vy at gmail dot com</em></strong></a><a class="genanchor" href="#117524"> &para;</a><div class="date" title="2015-06-24 12:52"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117524">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br /></span><span class="comment">// You cannot mix bracketed namespace declarations with unbracketed namespace declarations - will result in a Fatal error<br /><br /></span><span class="keyword">namespace </span><span class="default">a</span><span class="keyword">;<br /><br />echo </span><span class="string">"I belong to namespace a"</span><span class="keyword">;<br /><br />namespace </span><span class="default">b </span><span class="keyword">{<br />    echo </span><span class="string">"I'm from namespace b"</span><span class="keyword">;<br />}</span></span></code></div>
  </div>
 </div>
  <div class="note" id="116739">  <div class="votes">
    ...
    <div class="tally" id="V116739" title="70% like this...">
    26
    </div>
  </div>
  <a href="#116739" class="name">
  <strong class="user"><em>Rahul Sonar</em></strong></a><a class="genanchor" href="#116739"> &para;</a><div class="date" title="2015-02-21 09:43"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116739">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /></span><span class="comment">//Namespace can be used in this way also<br /></span><span class="keyword">namespace </span><span class="default">MyProject </span><span class="keyword">{<br /><br />function </span><span class="default">connect</span><span class="keyword">() { echo </span><span class="string">"ONE"</span><span class="keyword">;  }<br />    </span><span class="default">Sub\Level\connect</span><span class="keyword">();<br />}<br /><br />namespace </span><span class="default">MyProject\Sub </span><span class="keyword">{<br />    <br />function </span><span class="default">connect</span><span class="keyword">() { echo </span><span class="string">"TWO"</span><span class="keyword">;  }<br />    </span><span class="default">Level\connect</span><span class="keyword">();<br />}<br /><br />namespace </span><span class="default">MyProject\Sub\Level </span><span class="keyword">{<br />    <br />    function </span><span class="default">connect</span><span class="keyword">() { echo </span><span class="string">"THREE"</span><span class="keyword">;  }    <br />    </span><span class="default">\MyProject\Sub\Level\connect</span><span class="keyword">(); </span><span class="comment">// OR we can use this as below<br />    </span><span class="default">connect</span><span class="keyword">();<br />}</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">There are rational examples of where the ability to blend multiple namespaces into a single file is not only desirable but also absolutely necessary.  An example of where this ability is useful is over in the very popular phpseclib library where they are PSR-4 compliant but, in order to be compliant, they have to read a directory of files to know what classes are available so that the autoloader can load the correct files.  If they, instead, just bundled the defaults into one file using this mechanism already supported by PHP core, there would be no need to do extraneous scanning of the file system.<br /><br />That's just one legitimate use-case where strict compliance with PSRs gets in the way of good software development.</span></code></div>
  ...
  <div class="note" id="117533">  <div class="votes">
    ...
    <div class="tally" id="V117533" title="56% like this...">
    5
    </div>
  </div>
  <a href="#117533" class="name">
  <strong class="user"><em>Ishan Fernando</em></strong></a><a class="genanchor" href="#117533"> &para;</a><div class="date" title="2015-06-25 07:15"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117533">
<div class="phpcode"><code><span class="html">//call same named function using namespace<br /><br />//food.php<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">namespace </span><span class="default">Food</span><span class="keyword">;<br /><br />require (</span><span class="string">'Apple.php'</span><span class="keyword">);<br />require(</span><span class="string">'Orange.php'</span><span class="keyword">);<br /><br />use </span><span class="default">Apples</span><span class="keyword">;<br />use </span><span class="default">Oranges</span><span class="keyword">;<br /><br />  </span><span class="default">Apples\eat</span><span class="keyword">();<br />  </span><span class="default">Oranges\eat</span><span class="keyword">();<br /> </span><span class="default">?&gt;<br /></span><br />//Apple.php<br /><span class="default">&lt;?php<br /></span><span class="keyword">namespace </span><span class="default">Apples</span><span class="keyword">;<br /><br />function </span><span class="default">eat</span><span class="keyword">()<br />{<br />  echo </span><span class="string">"eat apple"</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />//Orange.php<br /><span class="default">&lt;?php<br /></span><span class="keyword">namespace </span><span class="default">Oranges</span><span class="keyword">;<br /><br />function </span><span class="default">eat</span><span class="keyword">()<br />{<br />  echo </span><span class="string">"eat Orange"</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=language.namespaces.definitionmultiple&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.namespaces.definitionmultiple.php">＋<small>add a note</small></a></div>
