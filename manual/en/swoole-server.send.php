...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/swoole-server.send.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/swoole-server.send.php">
 <link rel="alternate" href="https://www.php.net/manual/en/swoole-server.send.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.swoole-server.php">
 <link rel="prev" href="https://www.php.net/manual/en/swoole-server.resume.php">
 <link rel="next" href="https://www.php.net/manual/en/swoole-server.sendfile.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/swoole-server.send.php' selected="selected">English</option>
            <option value='de/swoole-server.send.php'>German</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-swoole-server.send-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/swoole/swoole/server/send.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fswoole-server.send%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=swoole-server.send&amp;repo=en&amp;redirect=https://www.php.net/manual/en/swoole-server.send.php">＋<small>add a note</small></a></span>
