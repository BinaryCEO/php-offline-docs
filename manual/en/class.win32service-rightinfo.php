...
<head>
  ...
  <title>PHP: Win32Service\RightInfo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.win32service-rightinfo.php">
 <link rel="shorturl" href="https://www.php.net/win32service-rightinfo">
 <link rel="alternate" href="https://www.php.net/win32service-rightinfo" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.win32service.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.win32serviceexception.php">
 <link rel="next" href="https://www.php.net/manual/en/win32service-rightinfo.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.win32service-rightinfo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.win32service-rightinfo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.win32service-rightinfo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.win32service-rightinfo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.win32service-rightinfo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.win32service-rightinfo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.win32service-rightinfo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.win32service-rightinfo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.win32service-rightinfo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.win32service-rightinfo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.win32service-rightinfo.php" hreflang="zh">
...
<meta name="Description" content="The Win32Service\RightInfo class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Win32Service\RightInfo - Manual" />
<meta name="twitter:description" content="The Win32Service\RightInfo class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Win32Service\RightInfo - Manual" />
<meta itemprop="description" content="The Win32Service\RightInfo class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Win32Service\RightInfo class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="win32service-rightinfo.construct.php">
          Win32Service\RightInfo::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.win32serviceexception.php">
          &laquo; Win32ServiceException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.win32service-rightinfo.php' selected="selected">English</option>
            <option value='de/class.win32service-rightinfo.php'>German</option>
            <option value='es/class.win32service-rightinfo.php'>Spanish</option>
            <option value='fr/class.win32service-rightinfo.php'>French</option>
            <option value='it/class.win32service-rightinfo.php'>Italian</option>
            <option value='ja/class.win32service-rightinfo.php'>Japanese</option>
            <option value='pt_BR/class.win32service-rightinfo.php'>Brazilian Portuguese</option>
            <option value='ru/class.win32service-rightinfo.php'>Russian</option>
            <option value='tr/class.win32service-rightinfo.php'>Turkish</option>
            <option value='uk/class.win32service-rightinfo.php'>Ukrainian</option>
            <option value='zh/class.win32service-rightinfo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.win32service-rightinfo" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="win32service-rightinfo.construct.php">Win32Service\RightInfo::__construct</a> — Create a new RightInfo (not used)</li><li><a href="win32service-rightinfo.get-domain.php">Win32Service\RightInfo::getDomain</a> — Return the user's domain</li><li><a href="win32service-rightinfo.get-full-username.php">Win32Service\RightInfo::getFullUsername</a> — Return the domain and username</li><li><a href="win32service-rightinfo.get-rights.php">Win32Service\RightInfo::getRights</a> — Return the rights list</li><li><a href="win32service-rightinfo.get-username.php">Win32Service\RightInfo::getUsername</a> — Return the username</li><li><a href="win32service-rightinfo.is-deny-access.php">Win32Service\RightInfo::isDenyAccess</a> — Return true if the RightInfo concerns deny access to the resource</li><li><a href="win32service-rightinfo.is-grant-access.php">Win32Service\RightInfo::isGrantAccess</a> — Return true if the RightInfo concern grants access to the resource</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/win32service/win32servicerightinfo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.win32service-rightinfo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.win32service-rightinfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.win32service-rightinfo.php">＋<small>add a note</small></a></span>
