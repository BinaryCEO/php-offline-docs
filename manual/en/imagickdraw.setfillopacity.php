...
<head>
  ...
  <title>PHP: ImagickDraw::setFillOpacity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setfillopacity.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setfillopacity.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfillopacity.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setfillcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setfillpatternurl.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfillopacity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setfillopacity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setfillopacity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setfillopacity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setfillopacity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setfillopacity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setfillopacity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setfillopacity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setfillopacity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setfillopacity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setfillopacity.php" hreflang="zh">
...
<meta name="Description" content="Sets the opacity to use when drawing using the fill color or fill texture" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setFillOpacity - Manual" />
<meta name="twitter:description" content="Sets the opacity to use when drawing using the fill color or fill texture" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setFillOpacity - Manual" />
<meta itemprop="description" content="Sets the opacity to use when drawing using the fill color or fill texture" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the opacity to use when drawing using the fill color or fill texture" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setfillpatternurl.php">
          ImagickDraw::setFillPatternURL &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setfillcolor.php">
          &laquo; ImagickDraw::setFillColor        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setfillopacity.php' selected="selected">English</option>
            <option value='de/imagickdraw.setfillopacity.php'>German</option>
            <option value='es/imagickdraw.setfillopacity.php'>Spanish</option>
            <option value='fr/imagickdraw.setfillopacity.php'>French</option>
            <option value='it/imagickdraw.setfillopacity.php'>Italian</option>
            <option value='ja/imagickdraw.setfillopacity.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setfillopacity.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setfillopacity.php'>Russian</option>
            <option value='tr/imagickdraw.setfillopacity.php'>Turkish</option>
            <option value='uk/imagickdraw.setfillopacity.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setfillopacity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setfillopacity" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setFillOpacity</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setFillOpacity</span> &mdash; <span class="dc-title">Sets the opacity to use when drawing using the fill color or fill texture</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setfillopacity-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setFillOpacity</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$opacity</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setfillopacity-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setfillopacity-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.setfillopacity-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3172">
      <p><strong>Example #1  <span class="function"><strong>ImagickDraw::setFillOpacity()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setfillopacity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setfillopacity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setfillopacity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfillopacity.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117781">  <div class="votes">
    <div id="Vu117781">
    <a href="/manual/vote-note.php?id=117781&amp;page=imagickdraw.setfillopacity&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117781">
    <a href="/manual/vote-note.php?id=117781&amp;page=imagickdraw.setfillopacity&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117781" title="75% like this...">
    2
    </div>
  </div>
  <a href="#117781" class="name">
  <strong class="user"><em>Michael Voek</em></strong></a><a class="genanchor" href="#117781"> &para;</a><div class="date" title="2015-08-08 12:55"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117781">
<div class="phpcode"><code><span class="html">When fill color is changed, this is reset to 1.0 or to defined alpha with #aaxxx color format, where aa is alpha.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.setfillopacity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfillopacity.php">＋<small>add a note</small></a></div>
