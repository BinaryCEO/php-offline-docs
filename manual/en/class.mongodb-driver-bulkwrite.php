...
<head>
  ...
  <title>PHP: MongoDB\Driver\BulkWrite - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-bulkwrite.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-bulkwrite">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-bulkwrite" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.mongodb.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-query.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-bulkwrite.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-bulkwrite.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-bulkwrite.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-bulkwrite.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-bulkwrite.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-bulkwrite.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-bulkwrite.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-bulkwrite.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-bulkwrite.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-bulkwrite.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-bulkwrite.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-bulkwrite.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\BulkWrite class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\BulkWrite - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\BulkWrite class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\BulkWrite - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\BulkWrite class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\BulkWrite class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-bulkwrite.construct.php">
          MongoDB\Driver\BulkWrite::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-query.construct.php">
          &laquo; MongoDB\Driver\Query::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-bulkwrite.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-bulkwrite.php'>German</option>
            <option value='es/class.mongodb-driver-bulkwrite.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-bulkwrite.php'>French</option>
            <option value='it/class.mongodb-driver-bulkwrite.php'>Italian</option>
            <option value='ja/class.mongodb-driver-bulkwrite.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-bulkwrite.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-bulkwrite.php'>Russian</option>
            <option value='tr/class.mongodb-driver-bulkwrite.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-bulkwrite.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-bulkwrite.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-bulkwrite" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-bulkwrite.construct.php">MongoDB\Driver\BulkWrite::__construct</a> — Create a new BulkWrite</li><li><a href="mongodb-driver-bulkwrite.count.php">MongoDB\Driver\BulkWrite::count</a> — Count number of write operations in the bulk</li><li><a href="mongodb-driver-bulkwrite.delete.php">MongoDB\Driver\BulkWrite::delete</a> — Add a delete operation to the bulk</li><li><a href="mongodb-driver-bulkwrite.insert.php">MongoDB\Driver\BulkWrite::insert</a> — Add an insert operation to the bulk</li><li><a href="mongodb-driver-bulkwrite.update.php">MongoDB\Driver\BulkWrite::update</a> — Add an update operation to the bulk</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/bulkwrite.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-bulkwrite%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-bulkwrite&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-bulkwrite.php">＋<small>add a note</small></a></span>
