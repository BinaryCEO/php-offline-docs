...
<head>
  ...
  <title>PHP: Imagick::setImageOrientation - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageorientation.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageorientation.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageorientation.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageopacity.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagepage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageorientation.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageorientation.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageorientation.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageorientation.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageorientation.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageorientation.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageorientation.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageorientation.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageorientation.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageorientation.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageorientation.php" hreflang="zh">
...
<meta name="Description" content="Sets the image orientation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageOrientation - Manual" />
<meta name="twitter:description" content="Sets the image orientation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageOrientation - Manual" />
<meta itemprop="description" content="Sets the image orientation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image orientation" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimagepage.php">
          Imagick::setImagePage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageopacity.php">
          &laquo; Imagick::setImageOpacity        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageorientation.php' selected="selected">English</option>
            <option value='de/imagick.setimageorientation.php'>German</option>
            <option value='es/imagick.setimageorientation.php'>Spanish</option>
            <option value='fr/imagick.setimageorientation.php'>French</option>
            <option value='it/imagick.setimageorientation.php'>Italian</option>
            <option value='ja/imagick.setimageorientation.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageorientation.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageorientation.php'>Russian</option>
            <option value='tr/imagick.setimageorientation.php'>Turkish</option>
            <option value='uk/imagick.setimageorientation.php'>Ukrainian</option>
            <option value='zh/imagick.setimageorientation.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageorientation" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageOrientation</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageOrientation</span> &mdash; <span class="dc-title">Sets the image orientation</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimageorientation-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageOrientation</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$orientation</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageorientation-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">orientation</code></dt>
     <dd>
      <p class="para">
       One of the <a href="imagick.constants.php#imagick.constants.orientation" class="link">orientation constants</a>
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageorientation-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.setimageorientation-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3099">
      <p><strong>Example #1  <span class="function"><strong>Imagick::setImageOrientation()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">//Doesn't appear to do anything<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">setImageOrientation</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">, </span><span style="color: #0000BB">$orientationType</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">));<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageOrientation</span><span style="color: #007700">(</span><span style="color: #0000BB">$orientationType</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/jpg"</span><span style="color: #007700">);<br />    echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageorientation.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageorientation%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageorientation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageorientation.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="111447">  <div class="votes">
    <div id="Vu111447">
    <a href="/manual/vote-note.php?id=111447&amp;page=imagick.setimageorientation&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111447">
    <a href="/manual/vote-note.php?id=111447&amp;page=imagick.setimageorientation&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111447" title="80% like this...">
    3
    </div>
  </div>
  <a href="#111447" class="name">
  <strong class="user"><em>orrd101 at yahoo dot com</em></strong></a><a class="genanchor" href="#111447"> &para;</a><div class="date" title="2013-02-20 09:20"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111447">
<div class="phpcode"><code><span class="html">Be aware that Imagick::setImageOrientation() doesn't actually rotate the image, it just changes the EXIF rotation info that will be saved with the image. In some cases that may be what you want to do, but  if you're trying to rotate an image, this probably isn't the way you want to do it. The problem with relying on the EXIF rotation info is that many web browsers ignore and some image viewing software ignore the EXIF information and don't auto-rotate it automatically.  This function is best used to correct EXIF rotation information just before saving an image. <br /><br />To actually rotate an image, use Imagick::rotateImage().  <br /><br />And then maybe use this function to save the correct EXIF orientation data.  For example: $image-&gt;setImageOrientation(imagick::ORIENTATION_TOPLEFT);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimageorientation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageorientation.php">＋<small>add a note</small></a></div>
