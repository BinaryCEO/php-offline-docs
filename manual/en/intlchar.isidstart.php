...
<head>
  ...
  <title>PHP: IntlChar::isIDStart - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.isidstart.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.isidstart.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isidstart.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.isidpart.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.isisocontrol.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isidstart.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.isidstart.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.isidstart.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.isidstart.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.isidstart.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.isidstart.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.isidstart.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.isidstart.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.isidstart.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.isidstart.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.isidstart.php" hreflang="zh">
...
<meta name="Description" content="Check if code point is permissible as the first character in an identifier" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::isIDStart - Manual" />
<meta name="twitter:description" content="Check if code point is permissible as the first character in an identifier" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::isIDStart - Manual" />
<meta itemprop="description" content="Check if code point is permissible as the first character in an identifier" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if code point is permissible as the first character in an identifier" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.isisocontrol.php">
          IntlChar::isISOControl &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.isidpart.php">
          &laquo; IntlChar::isIDPart        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.isidstart.php' selected="selected">English</option>
            <option value='de/intlchar.isidstart.php'>German</option>
            <option value='es/intlchar.isidstart.php'>Spanish</option>
            <option value='fr/intlchar.isidstart.php'>French</option>
            <option value='it/intlchar.isidstart.php'>Italian</option>
            <option value='ja/intlchar.isidstart.php'>Japanese</option>
            <option value='pt_BR/intlchar.isidstart.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.isidstart.php'>Russian</option>
            <option value='tr/intlchar.isidstart.php'>Turkish</option>
            <option value='uk/intlchar.isidstart.php'>Ukrainian</option>
            <option value='zh/intlchar.isidstart.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.isidstart" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::isIDStart</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::isIDStart</span> &mdash; <span class="dc-title">Check if code point is permissible as the first character in an identifier</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-intlchar.isidstart-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::isIDStart</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$codepoint</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>
  ...
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> for characters with general categories &quot;L&quot; (letters) and &quot;Nl&quot; (letter numbers).
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-intlchar.isidstart-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.isidstart-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if
   <code class="parameter">codepoint</code> may start an identifier, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not. Returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-intlchar.isidstart-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-2730">
   <p><strong>Example #1 Testing different code points</strong></p>
   <div class="example-contents">
    <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isIDStart</span><span style="color: #007700">(</span><span style="color: #DD0000">"A"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isIDStart</span><span style="color: #007700">(</span><span style="color: #DD0000">"$"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isIDStart</span><span style="color: #007700">(</span><span style="color: #DD0000">"\n"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isIDStart</span><span style="color: #007700">(</span><span style="color: #DD0000">"\u{2603}"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>
...
bool(false)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-intlchar.isidstart-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><strong><code><a href="class.intlchar.php#intlchar.constants.property-id-start">IntlChar::PROPERTY_ID_START</a></code></strong></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/isidstart.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.isidstart%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.isidstart&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.isidstart.php">＋<small>add a note</small></a></span>
