...
<head>
  ...
  <title>PHP: enchant_dict_add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.enchant-dict-add.php">
 <link rel="shorturl" href="https://www.php.net/enchant-dict-add">
 <link rel="alternate" href="https://www.php.net/enchant-dict-add" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.enchant.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.enchant-broker-set-ordering.php">
 <link rel="next" href="https://www.php.net/manual/en/function.enchant-dict-add-to-personal.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.enchant-dict-add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.enchant-dict-add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.enchant-dict-add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.enchant-dict-add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.enchant-dict-add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.enchant-dict-add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.enchant-dict-add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.enchant-dict-add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.enchant-dict-add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.enchant-dict-add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.enchant-dict-add.php" hreflang="zh">
...
<meta name="Description" content="Add a word to personal word list" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: enchant_dict_add - Manual" />
<meta name="twitter:description" content="Add a word to personal word list" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: enchant_dict_add - Manual" />
<meta itemprop="description" content="Add a word to personal word list" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add a word to personal word list" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.enchant-dict-add-to-personal.php">
          enchant_dict_add_to_personal &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.enchant-broker-set-ordering.php">
          &laquo; enchant_broker_set_ordering        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.enchant-dict-add.php' selected="selected">English</option>
            <option value='de/function.enchant-dict-add.php'>German</option>
            <option value='es/function.enchant-dict-add.php'>Spanish</option>
            <option value='fr/function.enchant-dict-add.php'>French</option>
            <option value='it/function.enchant-dict-add.php'>Italian</option>
            <option value='ja/function.enchant-dict-add.php'>Japanese</option>
            <option value='pt_BR/function.enchant-dict-add.php'>Brazilian Portuguese</option>
            <option value='ru/function.enchant-dict-add.php'>Russian</option>
            <option value='tr/function.enchant-dict-add.php'>Turkish</option>
            <option value='uk/function.enchant-dict-add.php'>Ukrainian</option>
            <option value='zh/function.enchant-dict-add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.enchant-dict-add" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">enchant_dict_add</h1>
  <p class="verinfo">(PHP 8)</p><p class="refpurpose"><span class="refname">enchant_dict_add</span> &mdash; <span class="dc-title">Add a word to personal word list</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-function.enchant-dict-add-examples">
  ...
  <div class="example" id="example-2456">
   <p><strong>Example #1 Adding a word to a PWL</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.enchant-broker-request-dict.php" class="function" rel="rdfs-seeAlso">enchant_broker_request_dict()</a> - Create a new dictionary using a tag</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/enchant/functions/enchant-dict-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.enchant-dict-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.enchant-dict-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.enchant-dict-add.php">＋<small>add a note</small></a></span>
