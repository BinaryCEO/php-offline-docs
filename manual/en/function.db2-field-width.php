...
<head>
  ...
  <title>PHP: db2_field_width - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-field-width.php">
 <link rel="shorturl" href="https://www.php.net/db2-field-width">
 <link rel="alternate" href="https://www.php.net/db2-field-width" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-field-type.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-foreign-keys.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-field-width.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-field-width.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-field-width.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-field-width.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-field-width.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-field-width.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-field-width.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-field-width.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-field-width.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-field-width.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-field-width.php" hreflang="zh">
...
<meta name="Description" content="Returns the width of the current value of the indicated column in a result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_field_width - Manual" />
<meta name="twitter:description" content="Returns the width of the current value of the indicated column in a result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_field_width - Manual" />
<meta itemprop="description" content="Returns the width of the current value of the indicated column in a result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the width of the current value of the indicated column in a result set" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.db2-foreign-keys.php">
          db2_foreign_keys &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-field-type.php">
          &laquo; db2_field_type        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-field-width.php' selected="selected">English</option>
            <option value='de/function.db2-field-width.php'>German</option>
            <option value='es/function.db2-field-width.php'>Spanish</option>
            <option value='fr/function.db2-field-width.php'>French</option>
            <option value='it/function.db2-field-width.php'>Italian</option>
            <option value='ja/function.db2-field-width.php'>Japanese</option>
            <option value='pt_BR/function.db2-field-width.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-field-width.php'>Russian</option>
            <option value='tr/function.db2-field-width.php'>Turkish</option>
            <option value='uk/function.db2-field-width.php'>Ukrainian</option>
            <option value='zh/function.db2-field-width.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-field-width" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">db2_field_width</h1>
  <p class="verinfo">(PECL ibm_db2 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">db2_field_width</span> &mdash; <span class="dc-title">
   Returns the width of the current value of the indicated column in a result set
  </span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.db2-field-width-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_field_width</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stmt</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$column</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.db2-field-width-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-field-width-returnvalues">
  ...
  <p class="para">
   ...
   exist in the result set, <span class="function"><strong>db2_field_width()</strong></span> returns
 ...
 <div class="refsect1 seealso" id="refsect1-function.db2-field-width-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-field-type.php" class="function" rel="rdfs-seeAlso">db2_field_type()</a> - Returns the data type of the indicated column in a result set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-field-width.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-field-width%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-field-width&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-field-width.php">＋<small>add a note</small></a></span>
