...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gc-disable.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.gc-collect-cycles.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gc-enable.php">
...
<meta name="Description" content="Deactivates the circular reference collector" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gc_disable - Manual" />
<meta name="twitter:description" content="Deactivates the circular reference collector" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gc_disable - Manual" />
<meta itemprop="description" content="Deactivates the circular reference collector" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Deactivates the circular reference collector" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gc-disable.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.gc-disable.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gc_disable</span> &mdash; <span class="dc-title">Deactivates the circular reference collector</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.gc-disable-description">
  ...
  <p class="para rdfs-comment">
   ...
   <a href="info.configuration.php#ini.zend.enable-gc" class="link">zend.enable_gc</a> to <code class="literal">0</code>.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><a href="features.gc.php" class="link">Garbage Collection</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/gc-disable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gc-disable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gc-disable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gc-disable.php">＋<small>add a note</small></a></span>
