...
<head>
  ...
  <title>PHP: db2_fetch_row - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-fetch-row.php">
 <link rel="shorturl" href="https://www.php.net/db2-fetch-row">
 <link rel="alternate" href="https://www.php.net/db2-fetch-row" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-fetch-object.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-field-display-size.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-fetch-row.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-fetch-row.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-fetch-row.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-fetch-row.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-fetch-row.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-fetch-row.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-fetch-row.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-fetch-row.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-fetch-row.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-fetch-row.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-fetch-row.php" hreflang="zh">
...
<meta name="Description" content="Sets the result set pointer to the next row or requested row" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_fetch_row - Manual" />
<meta name="twitter:description" content="Sets the result set pointer to the next row or requested row" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_fetch_row - Manual" />
<meta itemprop="description" content="Sets the result set pointer to the next row or requested row" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the result set pointer to the next row or requested row" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.db2-field-display-size.php">
          db2_field_display_size &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-fetch-object.php">
          &laquo; db2_fetch_object        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-fetch-row.php' selected="selected">English</option>
            <option value='de/function.db2-fetch-row.php'>German</option>
            <option value='es/function.db2-fetch-row.php'>Spanish</option>
            <option value='fr/function.db2-fetch-row.php'>French</option>
            <option value='it/function.db2-fetch-row.php'>Italian</option>
            <option value='ja/function.db2-fetch-row.php'>Japanese</option>
            <option value='pt_BR/function.db2-fetch-row.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-fetch-row.php'>Russian</option>
            <option value='tr/function.db2-fetch-row.php'>Turkish</option>
            <option value='uk/function.db2-fetch-row.php'>Ukrainian</option>
            <option value='zh/function.db2-fetch-row.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-fetch-row" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.db2-fetch-row-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_fetch_row</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stmt</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$row_number</code><span class="initializer"> = -1</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   ...
   <span class="function"><a href="function.db2-result.php" class="function">db2_result()</a></span> function.
  </p>
  <p class="para">
   Rather than calling <span class="function"><strong>db2_fetch_row()</strong></span> and
   <span class="function"><a href="function.db2-result.php" class="function">db2_result()</a></span>, most applications will call one of
   ...
   or <span class="function"><a href="function.db2-fetch-array.php" class="function">db2_fetch_array()</a></span> to advance the result set pointer
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-fetch-row-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the requested row exists in the result set. Returns
   <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if the requested row does not exist in the result set.
  </p>
 </div>
  ...
  <p class="para">
   <div class="example" id="example-1371">
    ...
    <div class="example-contents"><p>
     ...
     result set with <span class="function"><a href="function.db2-result.php" class="function">db2_result()</a></span>.
    </p></div>
...
goat Rickety Ride</pre>
   ...
   <div class="example" id="example-1372">
    ...
    <div class="example-contents"><p>
     On i5/OS it is recommended that you use <span class="function"><a href="function.db2-fetch-both.php" class="function">db2_fetch_both()</a></span>, 
     <span class="function"><a href="function.db2-fetch-array.php" class="function">db2_fetch_array()</a></span>, or <span class="function"><a href="function.db2-fetch-object.php" class="function">db2_fetch_object()</a></span> 
     over <span class="function"><strong>db2_fetch_row()</strong></span>/<span class="function"><a href="function.db2-result.php" class="function">db2_result()</a></span>. In general 
     <span class="function"><strong>db2_fetch_row()</strong></span>/<span class="function"><a href="function.db2-result.php" class="function">db2_result()</a></span> have more issues 
     with various column types in <code class="literal">EBCIDIC</code> to <code class="literal">ASCII</code> 
     translation, including possible truncation in <code class="literal">DBCS</code> applications. 
     You may also find the performance of <span class="function"><a href="function.db2-fetch-both.php" class="function">db2_fetch_both()</a></span>, 
     <span class="function"><a href="function.db2-fetch-array.php" class="function">db2_fetch_array()</a></span>, and <span class="function"><a href="function.db2-fetch-object.php" class="function">db2_fetch_object()</a></span> to 
     be superior to <span class="function"><strong>db2_fetch_row()</strong></span>/<span class="function"><a href="function.db2-result.php" class="function">db2_result()</a></span>.
    </p></div>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />  $conn </span><span style="color: #007700">= </span><span style="color: #0000BB">db2_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">""</span><span style="color: #007700">,</span><span style="color: #DD0000">""</span><span style="color: #007700">,</span><span style="color: #DD0000">""</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">'SELECT SPECIFIC_SCHEMA, SPECIFIC_NAME, ROUTINE_SCHEMA, ROUTINE_NAME, ROUTINE_TYPE, ROUTINE_CREATED, ROUTINE_BODY, IN_PARMS, OUT_PARMS, INOUT_PARMS, PARAMETER_STYLE, EXTERNAL_NAME, EXTERNAL_LANGUAGE FROM QSYS2.SYSROUTINES FETCH FIRST 2 ROWS ONLY'</span><span style="color: #007700">;<br />  </span><span style="color: #0000BB">$stmt </span><span style="color: #007700">= </span><span style="color: #0000BB">db2_exec</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$sql</span><span style="color: #007700">, array(</span><span style="color: #DD0000">'cursor' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">DB2_SCROLLABLE</span><span style="color: #007700">));<br />  while (</span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">db2_fetch_both</span><span style="color: #007700">(</span><span style="color: #0000BB">$stmt</span><span style="color: #007700">)){<br />    echo </span><span style="color: #DD0000">"&lt;br&gt;db2_fetch_both </span><span style="color: #007700">{</span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #DD0000">'SPECIFIC_NAME'</span><span style="color: #007700">]}</span><span style="color: #DD0000"> </span><span style="color: #007700">{</span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #DD0000">'ROUTINE_CREATED'</span><span style="color: #007700">]}</span><span style="color: #DD0000"> </span><span style="color: #007700">{</span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #0000BB">5</span><span style="color: #007700">]}</span><span style="color: #DD0000">"</span><span style="color: #007700">;<br />  }<br />  </span><span style="color: #0000BB">$stmt </span><span style="color: #007700">= </span><span style="color: #0000BB">db2_exec</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$sql</span><span style="color: #007700">, array(</span><span style="color: #DD0000">'cursor' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">DB2_SCROLLABLE</span><span style="color: #007700">));<br />  while (</span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">db2_fetch_array</span><span style="color: #007700">(</span><span style="color: #0000BB">$stmt</span><span style="color: #007700">)){<br />    echo </span><span style="color: #DD0000">"&lt;br&gt;db2_fetch_array </span><span style="color: #007700">{</span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #0000BB">1</span><span style="color: #007700">]}</span><span style="color: #DD0000">  </span><span style="color: #007700">{</span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #0000BB">5</span><span style="color: #007700">]}</span><span style="color: #DD0000">"</span><span style="color: #007700">;<br />  }<br />  </span><span style="color: #0000BB">$stmt </span><span style="color: #007700">= </span><span style="color: #0000BB">db2_exec</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$sql</span><span style="color: #007700">, array(</span><span style="color: #DD0000">'cursor' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">DB2_SCROLLABLE</span><span style="color: #007700">));<br />  while (</span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">db2_fetch_object</span><span style="color: #007700">(</span><span style="color: #0000BB">$stmt</span><span style="color: #007700">)){<br />    echo </span><span style="color: #DD0000">"&lt;br&gt;db2_fetch_object </span><span style="color: #007700">{</span><span style="color: #0000BB">$row</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">SPECIFIC_NAME</span><span style="color: #007700">}</span><span style="color: #DD0000"> </span><span style="color: #007700">{</span><span style="color: #0000BB">$row</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">ROUTINE_CREATED</span><span style="color: #007700">}</span><span style="color: #DD0000">"</span><span style="color: #007700">;<br />  }<br />  </span><span style="color: #0000BB">db2_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="example-contents"><p>The above example will output:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">db2_fetch_both MATCH_ANIMAL 2006-08-25-17.10.23.775000 2006-08-25-17.10.23.775000
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-result.php" class="function" rel="rdfs-seeAlso">db2_result()</a> - Returns a single column from a row in the result set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-fetch-row.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-fetch-row%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-fetch-row&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-fetch-row.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="72501">  <div class="votes">
    <div id="Vu72501">
    <a href="/manual/vote-note.php?id=72501&amp;page=function.db2-fetch-row&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd72501">
    <a href="/manual/vote-note.php?id=72501&amp;page=function.db2-fetch-row&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V72501" title="100% like this...">
    1
    </div>
  </div>
  <a href="#72501" class="name">
  <strong class="user"><em>krisdover at hotmail dot com</em></strong></a><a class="genanchor" href="#72501"> &para;</a><div class="date" title="2007-01-21 12:54"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom72501">
<div class="phpcode"><code><span class="html">if the second parameter (the row number) is specified, your connection needs to have the CURSOR option set to DB2_SCROLLABLE. Otherwise all calls to this function will fail. Internal to the ibm_db2 extension module the db2cli api function SQLFetchScroll() generates the error "CLI0145E  Fetch type out of range" since it requires a scrollable resultset to work, instead of the default forward only resultset.<br /><br />hope this saves someone the time it took me to track this down in the db2cli traces.<br /><br />Regards,<br />Kris Dover</span></code></div>
  </div>
 </div>
  <div class="note" id="59107">  <div class="votes">
    <div id="Vu59107">
    <a href="/manual/vote-note.php?id=59107&amp;page=function.db2-fetch-row&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd59107">
    <a href="/manual/vote-note.php?id=59107&amp;page=function.db2-fetch-row&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V59107" title="100% like this...">
    1
    </div>
  </div>
  <a href="#59107" class="name">
  <strong class="user"><em>andrey at php dot net</em></strong></a><a class="genanchor" href="#59107"> &para;</a><div class="date" title="2005-11-26 01:11"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom59107">
<div class="phpcode"><code><span class="html">If the second parameter is 0 or NULL (which eventually evaluates to 0) then the internal pointer is moved forward. &lt; 0 value will return an warning.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-fetch-row&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-fetch-row.php">＋<small>add a note</small></a></div>
