...
<head>
  ...
  <title>PHP: array_sum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.array-sum.php">
 <link rel="shorturl" href="https://www.php.net/array-sum">
 <link rel="alternate" href="https://www.php.net/array-sum" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.array-splice.php">
 <link rel="next" href="https://www.php.net/manual/en/function.array-udiff.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.array-sum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.array-sum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.array-sum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.array-sum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.array-sum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.array-sum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.array-sum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.array-sum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.array-sum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.array-sum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.array-sum.php" hreflang="zh">
...
<meta name="Description" content="Calculate the sum of values in an array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: array_sum - Manual" />
<meta name="twitter:description" content="Calculate the sum of values in an array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: array_sum - Manual" />
<meta itemprop="description" content="Calculate the sum of values in an array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calculate the sum of values in an array" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.array-udiff.php">
          array_udiff &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.array-splice.php">
          &laquo; array_splice        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.array-sum.php' selected="selected">English</option>
            <option value='de/function.array-sum.php'>German</option>
            <option value='es/function.array-sum.php'>Spanish</option>
            <option value='fr/function.array-sum.php'>French</option>
            <option value='it/function.array-sum.php'>Italian</option>
            <option value='ja/function.array-sum.php'>Japanese</option>
            <option value='pt_BR/function.array-sum.php'>Brazilian Portuguese</option>
            <option value='ru/function.array-sum.php'>Russian</option>
            <option value='tr/function.array-sum.php'>Turkish</option>
            <option value='uk/function.array-sum.php'>Ukrainian</option>
            <option value='zh/function.array-sum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.array-sum" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">array_sum</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">array_sum</span> &mdash; <span class="dc-title">Calculate the sum of values in an array</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.array-sum-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>array_sum</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$array</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.float.php" class="type float">float</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>array_sum()</strong></span> returns the sum of values in an array.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.array-sum-returnvalues">
  ...
  <p class="para">
   Returns the sum of values as an integer or float; <code class="literal">0</code> if the
   <code class="parameter">array</code> is empty.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.array-sum-examples">
  ...
  <p class="para">
   <div class="example" id="example-5278">
    <p><strong>Example #1 <span class="function"><strong>array_sum()</strong></span> examples</strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">sum(a) = 20
sum(b) = 6.9</pre>
</div>
    </div>
   </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/array-sum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.array-sum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.array-sum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-sum.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126810">  <div class="votes">
    <div id="Vu126810">
    <a href="/manual/vote-note.php?id=126810&amp;page=function.array-sum&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126810">
    <a href="/manual/vote-note.php?id=126810&amp;page=function.array-sum&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126810" title="60% like this...">
    23
    </div>
  </div>
  <a href="#126810" class="name">
  <strong class="user"><em>rodrigo at adboosters dot com</em></strong></a><a class="genanchor" href="#126810"> &para;</a><div class="date" title="2022-01-28 12:29"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126810">
<div class="phpcode"><code><span class="html">If you want to calculate the sum in multi-dimensional arrays:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">array_multisum</span><span class="keyword">(array </span><span class="default">$arr</span><span class="keyword">): </span><span class="default">float </span><span class="keyword">{<br />    </span><span class="default">$sum </span><span class="keyword">= </span><span class="default">array_sum</span><span class="keyword">(</span><span class="default">$arr</span><span class="keyword">);<br />    foreach(</span><span class="default">$arr </span><span class="keyword">as </span><span class="default">$child</span><span class="keyword">) {<br />        </span><span class="default">$sum </span><span class="keyword">+= </span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$child</span><span class="keyword">) ? </span><span class="default">array_multisum</span><span class="keyword">(</span><span class="default">$child</span><span class="keyword">) : </span><span class="default">0</span><span class="keyword">;<br />    }<br />    return </span><span class="default">$sum</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />Example:<br /><br /><span class="default">&lt;?php<br />$data </span><span class="keyword">= <br />[<br />    </span><span class="string">'a' </span><span class="keyword">=&gt; </span><span class="default">5</span><span class="keyword">,<br />    </span><span class="string">'b' </span><span class="keyword">=&gt; <br />    [<br />        </span><span class="string">'c' </span><span class="keyword">=&gt; </span><span class="default">7</span><span class="keyword">, <br />        </span><span class="string">'d' </span><span class="keyword">=&gt; </span><span class="default">3<br />    </span><span class="keyword">],<br />    </span><span class="string">'e' </span><span class="keyword">=&gt; </span><span class="default">4</span><span class="keyword">,<br />    </span><span class="string">'f' </span><span class="keyword">=&gt; <br />    [<br />        </span><span class="string">'g' </span><span class="keyword">=&gt; </span><span class="default">6</span><span class="keyword">,<br />        </span><span class="string">'h' </span><span class="keyword">=&gt; <br />        [<br />            </span><span class="string">'i' </span><span class="keyword">=&gt; </span><span class="default">1</span><span class="keyword">,<br />            </span><span class="string">'j' </span><span class="keyword">=&gt; </span><span class="default">2<br />        </span><span class="keyword">]<br />    ]<br />];<br /><br />echo </span><span class="default">array_multisum</span><span class="keyword">(</span><span class="default">$data</span><span class="keyword">);<br /><br /></span><span class="comment">//output: 28<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="128066">  <div class="votes">
    <div id="Vu128066">
    <a href="/manual/vote-note.php?id=128066&amp;page=function.array-sum&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128066">
    <a href="/manual/vote-note.php?id=128066&amp;page=function.array-sum&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128066" title="53% like this...">
    2
    </div>
  </div>
  <a href="#128066" class="name">
  <strong class="user"><em>harl at gmail dot com</em></strong></a><a class="genanchor" href="#128066"> &para;</a><div class="date" title="2022-12-29 11:31"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128066">
<div class="phpcode"><code><span class="html">array_sum() doesn't "ignore strings if they are not convertible", it converts them to zero. array_product() does the same thing, where the difference between "ignoring" and "converting to zero" is much more obvious.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.array-sum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-sum.php">＋<small>add a note</small></a></div>
