...
<head>
  ...
  <title>PHP: expect_expectl - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.expect-expectl.php">
 <link rel="shorturl" href="https://www.php.net/expect-expectl">
 <link rel="alternate" href="https://www.php.net/expect-expectl" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.expect.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.expect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.expect-popen.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.expect-expectl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.expect-expectl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.expect-expectl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.expect-expectl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.expect-expectl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.expect-expectl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.expect-expectl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.expect-expectl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.expect-expectl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.expect-expectl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.expect-expectl.php" hreflang="zh">
...
<meta name="Description" content="Waits until the output from a process matches one
  of the patterns, a specified time period has passed, or an EOF is seen" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: expect_expectl - Manual" />
<meta name="twitter:description" content="Waits until the output from a process matches one
  of the patterns, a specified time period has passed, or an EOF is seen" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: expect_expectl - Manual" />
<meta itemprop="description" content="Waits until the output from a process matches one
  of the patterns, a specified time period has passed, or an EOF is seen" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Waits until the output from a process matches one
  of the patterns, a specified time period has passed, or an EOF is seen" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.expect-popen.php">
          expect_popen &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.expect.php">
          &laquo; Expect Functions        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.fileprocess.process.php'>Process Control Extensions</a></li>      <li><a href='book.expect.php'>Expect</a></li>      <li><a href='ref.expect.php'>Expect Functions</a></li>      </ul>
    </div>
  </div>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.expect-expectl.php' selected="selected">English</option>
            <option value='de/function.expect-expectl.php'>German</option>
            <option value='es/function.expect-expectl.php'>Spanish</option>
            <option value='fr/function.expect-expectl.php'>French</option>
            <option value='it/function.expect-expectl.php'>Italian</option>
            <option value='ja/function.expect-expectl.php'>Japanese</option>
            <option value='pt_BR/function.expect-expectl.php'>Brazilian Portuguese</option>
            <option value='ru/function.expect-expectl.php'>Russian</option>
            <option value='tr/function.expect-expectl.php'>Turkish</option>
            <option value='uk/function.expect-expectl.php'>Ukrainian</option>
            <option value='zh/function.expect-expectl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.expect-expectl" class="refentry">
 <div class="refnamediv">
  ...
  of the patterns, a specified time period has passed, or an <abbr title="End Of File">EOF</abbr> is seen
  </span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.expect-expectl-description">
  ...
  <p class="para rdfs-comment">
   ...
   a specified time period has passed, or an <abbr title="End Of File">EOF</abbr> is seen.
  </p>
  <p class="para">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Copies file from remote host:<br /></span><span style="color: #0000BB">ini_set</span><span style="color: #007700">(</span><span style="color: #DD0000">"expect.timeout"</span><span style="color: #007700">, </span><span style="color: #0000BB">30</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$stream </span><span style="color: #007700">= </span><span style="color: #0000BB">fopen</span><span style="color: #007700">(</span><span style="color: #DD0000">"expect://scp user@remotehost:/var/log/messages /home/user/messages.txt"</span><span style="color: #007700">, </span><span style="color: #DD0000">"r"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$cases </span><span style="color: #007700">= array(<br />    </span><span style="color: #FF8000">// array(pattern, value to return if pattern matched)<br />    </span><span style="color: #007700">array(</span><span style="color: #DD0000">"password:"</span><span style="color: #007700">, </span><span style="color: #DD0000">"asked for password"</span><span style="color: #007700">),<br />    array(</span><span style="color: #DD0000">"yes/no)?"</span><span style="color: #007700">,  </span><span style="color: #DD0000">"asked for yes/no"</span><span style="color: #007700">)<br />);<br /><br />while (</span><span style="color: #0000BB">true</span><span style="color: #007700">) {<br />    switch (</span><span style="color: #0000BB">expect_expectl</span><span style="color: #007700">(</span><span style="color: #0000BB">$stream</span><span style="color: #007700">, </span><span style="color: #0000BB">$cases</span><span style="color: #007700">)) {<br />        case </span><span style="color: #DD0000">"asked for password"</span><span style="color: #007700">:<br />            </span><span style="color: #0000BB">fwrite</span><span style="color: #007700">(</span><span style="color: #0000BB">$stream</span><span style="color: #007700">, </span><span style="color: #DD0000">"my password\n"</span><span style="color: #007700">);<br />            break;<br />        case </span><span style="color: #DD0000">"asked for yes/no"</span><span style="color: #007700">:<br />            </span><span style="color: #0000BB">fwrite</span><span style="color: #007700">(</span><span style="color: #0000BB">$stream</span><span style="color: #007700">, </span><span style="color: #DD0000">"yes\n"</span><span style="color: #007700">);<br />            break;<br />        case </span><span style="color: #0000BB">EXP_TIMEOUT</span><span style="color: #007700">:<br />        case </span><span style="color: #0000BB">EXP_EOF</span><span style="color: #007700">:<br />            break </span><span style="color: #0000BB">2</span><span style="color: #007700">; </span><span style="color: #FF8000">// break both the switch statement and the while loop<br />        </span><span style="color: #007700">default:<br />            die(</span><span style="color: #DD0000">"Error has occurred!"</span><span style="color: #007700">);<br />    }<br />}<br /><br /></span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$stream</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.expect-expectl-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.expect-popen.php" class="function" rel="rdfs-seeAlso">expect_popen()</a> - Execute command via Bourne shell, and open the PTY stream to
  the process</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/expect/functions/expect-expectl.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.expect-expectl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.expect-expectl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.expect-expectl.php">＋<small>add a note</small></a></span>
 ...
 <div class="note">There are no user contributed notes for this page.</div></section>    </section><!-- layout-content -->
        ...
        <ul class='parent-menu-list'>
                                    <li>
                <a href="ref.expect.php">Expect Functions</a>

                                    <ul class='child-menu-list'>

                                                <li class="current">
                            <a href="function.expect-expectl.php" title="expect_&#8203;expectl">expect_&#8203;expectl</a>
                        </li>
                                                <li class="">
                            <a href="function.expect-popen.php" title="expect_&#8203;popen">expect_&#8203;popen</a>
                        </li>
