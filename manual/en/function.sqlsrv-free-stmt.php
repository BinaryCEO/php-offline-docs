...
<head>
  ...
  <title>PHP: sqlsrv_free_stmt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sqlsrv-free-stmt.php">
 <link rel="shorturl" href="https://www.php.net/sqlsrv-free-stmt">
 <link rel="alternate" href="https://www.php.net/sqlsrv-free-stmt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sqlsrv-field-metadata.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sqlsrv-get-config.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sqlsrv-free-stmt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sqlsrv-free-stmt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sqlsrv-free-stmt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sqlsrv-free-stmt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sqlsrv-free-stmt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sqlsrv-free-stmt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sqlsrv-free-stmt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sqlsrv-free-stmt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sqlsrv-free-stmt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sqlsrv-free-stmt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sqlsrv-free-stmt.php" hreflang="zh">
...
<meta name="Description" content="Frees all resources for the specified statement" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sqlsrv_free_stmt - Manual" />
<meta name="twitter:description" content="Frees all resources for the specified statement" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sqlsrv_free_stmt - Manual" />
<meta itemprop="description" content="Frees all resources for the specified statement" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Frees all resources for the specified statement" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sqlsrv-get-config.php">
          sqlsrv_get_config &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sqlsrv-field-metadata.php">
          &laquo; sqlsrv_field_metadata        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sqlsrv-free-stmt.php' selected="selected">English</option>
            <option value='de/function.sqlsrv-free-stmt.php'>German</option>
            <option value='es/function.sqlsrv-free-stmt.php'>Spanish</option>
            <option value='fr/function.sqlsrv-free-stmt.php'>French</option>
            <option value='it/function.sqlsrv-free-stmt.php'>Italian</option>
            <option value='ja/function.sqlsrv-free-stmt.php'>Japanese</option>
            <option value='pt_BR/function.sqlsrv-free-stmt.php'>Brazilian Portuguese</option>
            <option value='ru/function.sqlsrv-free-stmt.php'>Russian</option>
            <option value='tr/function.sqlsrv-free-stmt.php'>Turkish</option>
            <option value='uk/function.sqlsrv-free-stmt.php'>Ukrainian</option>
            <option value='zh/function.sqlsrv-free-stmt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sqlsrv-free-stmt" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.sqlsrv-free-stmt-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sqlsrv_free_stmt</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stmt</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       Note that <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> is a valid parameter value. This allows the function to be 
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #0000BB">$serverName</span><span style="color: #007700">, </span><span style="color: #0000BB">$connectionInfo</span><span style="color: #007700">);<br />if( </span><span style="color: #0000BB">$conn </span><span style="color: #007700">=== </span><span style="color: #0000BB">false </span><span style="color: #007700">) {<br />     die( </span><span style="color: #0000BB">print_r</span><span style="color: #007700">( </span><span style="color: #0000BB">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #0000BB">true</span><span style="color: #007700">));<br />}<br /><br /></span><span style="color: #0000BB">$stmt </span><span style="color: #007700">= </span><span style="color: #0000BB">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"SELECT * FROM Table_1"</span><span style="color: #007700">);<br />if( </span><span style="color: #0000BB">$stmt </span><span style="color: #007700">=== </span><span style="color: #0000BB">false </span><span style="color: #007700">) {<br />     die( </span><span style="color: #0000BB">print_r</span><span style="color: #007700">( </span><span style="color: #0000BB">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #0000BB">true</span><span style="color: #007700">));<br />}<br /><br /></span><span style="color: #FF8000">/*-------------------------------<br />     Process query results here.<br />-------------------------------*/<br /><br />/* Free the statement resources. */<br /></span><span style="color: #0000BB">sqlsrv_free_stmt</span><span style="color: #007700">( </span><span style="color: #0000BB">$stmt</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   ...
   <span class="function"><a href="function.sqlsrv-cancel.php" class="function">sqlsrv_cancel()</a></span> is that a statement resource cancelled with 
   <span class="function"><a href="function.sqlsrv-cancel.php" class="function">sqlsrv_cancel()</a></span> can be re-executed if it was created with 
   <span class="function"><a href="function.sqlsrv-prepare.php" class="function">sqlsrv_prepare()</a></span>. A statement resource cancelled with 
 ...
 <div class="refsect1 seealso" id="refsect1-function.sqlsrv-free-stmt-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.sqlsrv-cancel.php" class="function" rel="rdfs-seeAlso">sqlsrv_cancel()</a> - Cancels a statement</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlsrv/functions/sqlsrv-free-stmt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sqlsrv-free-stmt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sqlsrv-free-stmt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-free-stmt.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116534">  <div class="votes">
    <div id="Vu116534">
    <a href="/manual/vote-note.php?id=116534&amp;page=function.sqlsrv-free-stmt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116534">
    <a href="/manual/vote-note.php?id=116534&amp;page=function.sqlsrv-free-stmt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116534" title="50% like this...">
    0
    </div>
  </div>
  <a href="#116534" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#116534"> &para;</a><div class="date" title="2015-01-19 07:28"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116534">
<div class="phpcode"><code><span class="html">If you accidentally call this with an invalid $stmt resource, you may see unexpected fatal errors.<br /><br />I had left behind a call here when cleaning up some code and this caused the my IIS server to generate an error 500 resource not found error.  Furthermore it seemed to only affect some users and not all and I could not isolate why only selected users got the error when it was called for all users.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sqlsrv-free-stmt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-free-stmt.php">＋<small>add a note</small></a></div>
