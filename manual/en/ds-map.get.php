...
<head>
  ...
  <title>PHP: Ds\Map::get - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-map.get.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-map.get.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-map.get.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-map.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-map.first.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-map.haskey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ds-map.get.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ds-map.get.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ds-map.get.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ds-map.get.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ds-map.get.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ds-map.get.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ds-map.get.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ds-map.get.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ds-map.get.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ds-map.get.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ds-map.get.php" hreflang="zh">
...
<meta name="Description" content="Returns the value for a given key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Ds\Map::get - Manual" />
<meta name="twitter:description" content="Returns the value for a given key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Ds\Map::get - Manual" />
<meta itemprop="description" content="Returns the value for a given key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the value for a given key" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-map.get.php' selected="selected">English</option>
            <option value='de/ds-map.get.php'>German</option>
            <option value='es/ds-map.get.php'>Spanish</option>
            <option value='fr/ds-map.get.php'>French</option>
            <option value='it/ds-map.get.php'>Italian</option>
            <option value='ja/ds-map.get.php'>Japanese</option>
            <option value='pt_BR/ds-map.get.php'>Brazilian Portuguese</option>
            <option value='ru/ds-map.get.php'>Russian</option>
            <option value='tr/ds-map.get.php'>Turkish</option>
            <option value='uk/ds-map.get.php'>Ukrainian</option>
            <option value='zh/ds-map.get.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ds-map.get" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-ds-map.get-examples">
  ...
  <div class="example" id="example-4377">
   <p><strong>Example #1 <span class="function"><strong>Ds\Map::get()</strong></span> example</strong></p>
...
int(10)</pre>
  ...
  <div class="example" id="example-4378">
   <p><strong>Example #2 <span class="function"><strong>Ds\Map::get()</strong></span> example using array syntax</strong></p>
   <div class="example-contents">
...
<div class="examplescode"><pre class="examplescode">int(1)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/map/get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-map.get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-map.get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-map.get.php">＋<small>add a note</small></a></span>
