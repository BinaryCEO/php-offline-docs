...
<head>
  ...
  <title>PHP: SolrQuery::getFacetOffset - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfacetoffset.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfacetoffset.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetoffset.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfacetmissing.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfacetprefix.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetoffset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfacetoffset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfacetoffset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfacetoffset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfacetoffset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfacetoffset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfacetoffset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfacetoffset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfacetoffset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfacetoffset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfacetoffset.php" hreflang="zh">
...
<meta name="Description" content="Returns an offset into the list of constraints to be used for pagination" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFacetOffset - Manual" />
<meta name="twitter:description" content="Returns an offset into the list of constraints to be used for pagination" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFacetOffset - Manual" />
<meta itemprop="description" content="Returns an offset into the list of constraints to be used for pagination" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an offset into the list of constraints to be used for pagination" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getfacetprefix.php">
          SolrQuery::getFacetPrefix &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfacetmissing.php">
          &laquo; SolrQuery::getFacetMissing        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfacetoffset.php' selected="selected">English</option>
            <option value='de/solrquery.getfacetoffset.php'>German</option>
            <option value='es/solrquery.getfacetoffset.php'>Spanish</option>
            <option value='fr/solrquery.getfacetoffset.php'>French</option>
            <option value='it/solrquery.getfacetoffset.php'>Italian</option>
            <option value='ja/solrquery.getfacetoffset.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfacetoffset.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfacetoffset.php'>Russian</option>
            <option value='tr/solrquery.getfacetoffset.php'>Turkish</option>
            <option value='uk/solrquery.getfacetoffset.php'>Ukrainian</option>
            <option value='zh/solrquery.getfacetoffset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfacetoffset" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFacetOffset</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFacetOffset</span> &mdash; <span class="dc-title">Returns an offset into the list of constraints to be used for pagination</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfacetoffset-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFacetOffset</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfacetoffset-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfacetoffset-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfacetoffset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfacetoffset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfacetoffset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfacetoffset.php">＋<small>add a note</small></a></span>
