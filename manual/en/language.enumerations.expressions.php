...
<head>
  ...
  <title>PHP: Enum values in constant expressions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.enumerations.expressions.php">
 <link rel="shorturl" href="https://www.php.net/enumerations.expressions">
 <link rel="alternate" href="https://www.php.net/enumerations.expressions" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.enumerations.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.enumerations.traits.php">
 <link rel="next" href="https://www.php.net/manual/en/language.enumerations.object-differences.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.enumerations.expressions.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.enumerations.expressions.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.enumerations.expressions.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.enumerations.expressions.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.enumerations.expressions.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.enumerations.expressions.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.enumerations.expressions.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.enumerations.expressions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.enumerations.expressions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.enumerations.expressions.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.enumerations.expressions.php" hreflang="zh">
...
<meta name="Description" content="Enum values in constant expressions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Enum values in constant expressions - Manual" />
<meta name="twitter:description" content="Enum values in constant expressions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Enum values in constant expressions - Manual" />
<meta itemprop="description" content="Enum values in constant expressions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enum values in constant expressions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="language.enumerations.object-differences.php">
          Differences from objects &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="language.enumerations.traits.php">
          &laquo; Traits        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.enumerations.expressions.php' selected="selected">English</option>
            <option value='de/language.enumerations.expressions.php'>German</option>
            <option value='es/language.enumerations.expressions.php'>Spanish</option>
            <option value='fr/language.enumerations.expressions.php'>French</option>
            <option value='it/language.enumerations.expressions.php'>Italian</option>
            <option value='ja/language.enumerations.expressions.php'>Japanese</option>
            <option value='pt_BR/language.enumerations.expressions.php'>Brazilian Portuguese</option>
            <option value='ru/language.enumerations.expressions.php'>Russian</option>
            <option value='tr/language.enumerations.expressions.php'>Turkish</option>
            <option value='uk/language.enumerations.expressions.php'>Ukrainian</option>
            <option value='zh/language.enumerations.expressions.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="language.enumerations.expressions" class="sect1">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// This is an entirely legal Enum definition.<br /></span><span style="color: #007700">enum </span><span style="color: #0000BB">Direction </span><span style="color: #007700">implements </span><span style="color: #0000BB">ArrayAccess<br /></span><span style="color: #007700">{<br />    case </span><span style="color: #0000BB">Up</span><span style="color: #007700">;<br />    case </span><span style="color: #0000BB">Down</span><span style="color: #007700">;<br /><br />    public function </span><span style="color: #0000BB">offsetExists</span><span style="color: #007700">(</span><span style="color: #0000BB">$offset</span><span style="color: #007700">): </span><span style="color: #0000BB">bool<br />    </span><span style="color: #007700">{<br />        return </span><span style="color: #0000BB">false</span><span style="color: #007700">;<br />    }<br /><br />    public function </span><span style="color: #0000BB">offsetGet</span><span style="color: #007700">(</span><span style="color: #0000BB">$offset</span><span style="color: #007700">): </span><span style="color: #0000BB">mixed<br />    </span><span style="color: #007700">{<br />        return </span><span style="color: #0000BB">null</span><span style="color: #007700">;<br />    }<br /><br />    public function </span><span style="color: #0000BB">offsetSet</span><span style="color: #007700">(</span><span style="color: #0000BB">$offset</span><span style="color: #007700">, </span><span style="color: #0000BB">$value</span><span style="color: #007700">): </span><span style="color: #0000BB">void<br />    </span><span style="color: #007700">{<br />        throw new </span><span style="color: #0000BB">Exception</span><span style="color: #007700">();<br />    }<br /><br />    public function </span><span style="color: #0000BB">offsetUnset</span><span style="color: #007700">(</span><span style="color: #0000BB">$offset</span><span style="color: #007700">): </span><span style="color: #0000BB">void<br />    </span><span style="color: #007700">{<br />        throw new </span><span style="color: #0000BB">Exception</span><span style="color: #007700">();<br />    }<br />}<br /><br />class </span><span style="color: #0000BB">Foo<br /></span><span style="color: #007700">{<br />    </span><span style="color: #FF8000">// This is allowed.<br />    </span><span style="color: #007700">const </span><span style="color: #0000BB">DOWN </span><span style="color: #007700">= </span><span style="color: #0000BB">Direction</span><span style="color: #007700">::</span><span style="color: #0000BB">Down</span><span style="color: #007700">;<br /><br />    </span><span style="color: #FF8000">// This is disallowed, as it may not be deterministic.<br />    </span><span style="color: #007700">const </span><span style="color: #0000BB">UP </span><span style="color: #007700">= </span><span style="color: #0000BB">Direction</span><span style="color: #007700">::</span><span style="color: #0000BB">Up</span><span style="color: #007700">[</span><span style="color: #DD0000">'short'</span><span style="color: #007700">];<br />    </span><span style="color: #FF8000">// Fatal error: Cannot use [] on enums in constant expression<br /></span><span style="color: #007700">}<br /><br /></span><span style="color: #FF8000">// This is entirely legal, because it's not a constant expression.<br /></span><span style="color: #0000BB">$x </span><span style="color: #007700">= </span><span style="color: #0000BB">Direction</span><span style="color: #007700">::</span><span style="color: #0000BB">Up</span><span style="color: #007700">[</span><span style="color: #DD0000">'short'</span><span style="color: #007700">];<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #DD0000">"\$x is " </span><span style="color: #007700">. </span><span style="color: #0000BB">var_export</span><span style="color: #007700">(</span><span style="color: #0000BB">$x</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">));<br /><br /></span><span style="color: #0000BB">$foo </span><span style="color: #007700">= new </span><span style="color: #0000BB">Foo</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.enumerations.expressions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.enumerations.expressions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.enumerations.expressions.php">＋<small>add a note</small></a></span>
