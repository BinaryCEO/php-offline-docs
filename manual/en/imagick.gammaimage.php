...
<head>
  ...
  <title>PHP: Imagick::gammaImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.gammaimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.gammaimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.gammaimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.fximage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.gaussianblurimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.gammaimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.gammaimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.gammaimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.gammaimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.gammaimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.gammaimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.gammaimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.gammaimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.gammaimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.gammaimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.gammaimage.php" hreflang="zh">
...
<meta name="Description" content="Gamma-corrects an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::gammaImage - Manual" />
<meta name="twitter:description" content="Gamma-corrects an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::gammaImage - Manual" />
<meta itemprop="description" content="Gamma-corrects an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gamma-corrects an image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.gaussianblurimage.php">
          Imagick::gaussianBlurImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.fximage.php">
          &laquo; Imagick::fxImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.gammaimage.php' selected="selected">English</option>
            <option value='de/imagick.gammaimage.php'>German</option>
            <option value='es/imagick.gammaimage.php'>Spanish</option>
            <option value='fr/imagick.gammaimage.php'>French</option>
            <option value='it/imagick.gammaimage.php'>Italian</option>
            <option value='ja/imagick.gammaimage.php'>Japanese</option>
            <option value='pt_BR/imagick.gammaimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.gammaimage.php'>Russian</option>
            <option value='tr/imagick.gammaimage.php'>Turkish</option>
            <option value='uk/imagick.gammaimage.php'>Ukrainian</option>
            <option value='zh/imagick.gammaimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.gammaimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::gammaImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::gammaImage</span> &mdash; <span class="dc-title">Gamma-corrects an image</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.gammaimage-examples">
  ...
  <p class="para">
    <div class="example" id="example-3008">
      <p><strong>Example #1  <span class="function"><strong>Imagick::gammaImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/gammaimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.gammaimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.gammaimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.gammaimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122524">  <div class="votes">
    <div id="Vu122524">
    <a href="/manual/vote-note.php?id=122524&amp;page=imagick.gammaimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122524">
    <a href="/manual/vote-note.php?id=122524&amp;page=imagick.gammaimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122524" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#122524" class="name">
  <strong class="user"><em>majidted at gmail dot com</em></strong></a><a class="genanchor" href="#122524"> &para;</a><div class="date" title="2018-03-19 12:59"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122524">
<div class="phpcode"><code><span class="html">You should use PECL to install this library. Or if you are using composer like me, you should use this packagist package or the similar packages:<br /><br />"<a href="https://packagist.org/packages/tpmanc/yii2-imagick" rel="nofollow" target="_blank">https://packagist.org/packages/tpmanc/yii2-imagick</a>"</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.gammaimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.gammaimage.php">＋<small>add a note</small></a></div>
