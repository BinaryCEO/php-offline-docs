...
<head>
  ...
  <title>PHP: socket_set_block - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-set-block.php">
 <link rel="shorturl" href="https://www.php.net/socket-set-block">
 <link rel="alternate" href="https://www.php.net/socket-set-block" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-sendto.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-set-nonblock.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-set-block.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-set-block.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-set-block.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-set-block.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-set-block.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-set-block.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-set-block.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-set-block.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-set-block.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-set-block.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-set-block.php" hreflang="zh">
...
<meta name="Description" content="Sets blocking mode on a socket" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_set_block - Manual" />
<meta name="twitter:description" content="Sets blocking mode on a socket" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_set_block - Manual" />
<meta itemprop="description" content="Sets blocking mode on a socket" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets blocking mode on a socket" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.socket-set-nonblock.php">
          socket_set_nonblock &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-sendto.php">
          &laquo; socket_sendto        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-set-block.php' selected="selected">English</option>
            <option value='de/function.socket-set-block.php'>German</option>
            <option value='es/function.socket-set-block.php'>Spanish</option>
            <option value='fr/function.socket-set-block.php'>French</option>
            <option value='it/function.socket-set-block.php'>Italian</option>
            <option value='ja/function.socket-set-block.php'>Japanese</option>
            <option value='pt_BR/function.socket-set-block.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-set-block.php'>Russian</option>
            <option value='tr/function.socket-set-block.php'>Turkish</option>
            <option value='uk/function.socket-set-block.php'>Ukrainian</option>
            <option value='zh/function.socket-set-block.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-set-block" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$socket </span><span style="color: #007700">= </span><span style="color: #0000BB">socket_create_listen</span><span style="color: #007700">(</span><span style="color: #0000BB">1223</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">socket_set_block</span><span style="color: #007700">(</span><span style="color: #0000BB">$socket</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">socket_accept</span><span style="color: #007700">(</span><span style="color: #0000BB">$socket</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.socket-set-block-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.socket-set-nonblock.php" class="function" rel="rdfs-seeAlso">socket_set_nonblock()</a> - Sets nonblocking mode for file descriptor fd</span></li>
    <li><span class="function"><a href="function.socket-set-option.php" class="function" rel="rdfs-seeAlso">socket_set_option()</a> - Sets socket options for the socket</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-set-block.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-set-block%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-set-block&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-set-block.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116277">  <div class="votes">
    <div id="Vu116277">
    <a href="/manual/vote-note.php?id=116277&amp;page=function.socket-set-block&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116277">
    <a href="/manual/vote-note.php?id=116277&amp;page=function.socket-set-block&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116277" title="53% like this...">
    1
    </div>
  </div>
  <a href="#116277" class="name">
  <strong class="user"><em>laacz at laacz dot lv</em></strong></a><a class="genanchor" href="#116277"> &para;</a><div class="date" title="2014-12-04 08:43"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116277">
<div class="phpcode"><code><span class="html">Besides true and false socket_set_block might return NULL if you're not too careful. That would happen when passing non socket resource as first parameter. <br /><br />E.g. socket_set_block(false)) would return NULL and emit warning that you're trying to do things with non-socket.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.socket-set-block&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-set-block.php">＋<small>add a note</small></a></div>
