...
<head>
  ...
  <title>PHP: DOMProcessingInstruction - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.domprocessinginstruction.php">
 <link rel="shorturl" href="https://www.php.net/domprocessinginstruction">
 <link rel="alternate" href="https://www.php.net/domprocessinginstruction" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/domparentnode.replacechildren.php">
 <link rel="next" href="https://www.php.net/manual/en/domprocessinginstruction.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.domprocessinginstruction.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.domprocessinginstruction.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.domprocessinginstruction.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.domprocessinginstruction.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.domprocessinginstruction.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.domprocessinginstruction.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.domprocessinginstruction.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.domprocessinginstruction.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.domprocessinginstruction.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.domprocessinginstruction.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.domprocessinginstruction.php" hreflang="zh">
...
<meta name="Description" content="The DOMProcessingInstruction class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMProcessingInstruction - Manual" />
<meta name="twitter:description" content="The DOMProcessingInstruction class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMProcessingInstruction - Manual" />
<meta itemprop="description" content="The DOMProcessingInstruction class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DOMProcessingInstruction class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="domprocessinginstruction.construct.php">
          DOMProcessingInstruction::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domparentnode.replacechildren.php">
          &laquo; DOMParentNode::replaceChildren        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.domprocessinginstruction.php' selected="selected">English</option>
            <option value='de/class.domprocessinginstruction.php'>German</option>
            <option value='es/class.domprocessinginstruction.php'>Spanish</option>
            <option value='fr/class.domprocessinginstruction.php'>French</option>
            <option value='it/class.domprocessinginstruction.php'>Italian</option>
            <option value='ja/class.domprocessinginstruction.php'>Japanese</option>
            <option value='pt_BR/class.domprocessinginstruction.php'>Brazilian Portuguese</option>
            <option value='ru/class.domprocessinginstruction.php'>Russian</option>
            <option value='tr/class.domprocessinginstruction.php'>Turkish</option>
            <option value='uk/class.domprocessinginstruction.php'>Ukrainian</option>
            <option value='zh/class.domprocessinginstruction.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.domprocessinginstruction" class="reference">
 <h1 class="title">The DOMProcessingInstruction class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>
 
  <div class="section" id="domprocessinginstruction.intro">
  ...
  <div class="section" id="domprocessinginstruction.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">DOMProcessingInstruction</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.domprocessinginstruction.php#domprocessinginstruction.props.target">$<var class="varname">target</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.domprocessinginstruction.php#domprocessinginstruction.props.data">$<var class="varname">data</var></a></var>;</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="domprocessinginstruction.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code><span class="initializer"> = &quot;&quot;</span></span>)</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domnode.wakeup.php" class="methodname">DOMNode::__wakeup</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="domprocessinginstruction.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="domprocessinginstruction.props.target"><var class="varname">target</var></dt>
     <dd>
     ...
     <dt id="domprocessinginstruction.props.data"><var class="varname">data</var></dt>
     <dd>
      <span class="simpara">Application-specific data.</span>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="domprocessinginstruction.construct.php">DOMProcessingInstruction::__construct</a> — Creates a new DOMProcessingInstruction object</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domprocessinginstruction.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.domprocessinginstruction%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.domprocessinginstruction&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.domprocessinginstruction.php">＋<small>add a note</small></a></span>
