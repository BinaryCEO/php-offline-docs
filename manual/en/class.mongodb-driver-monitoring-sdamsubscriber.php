...
<head>
  ...
  <title>PHP: MongoDB\Driver\Monitoring\SDAMSubscriber - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-monitoring-sdamsubscriber.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-monitoring-sdamsubscriber">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-monitoring-sdamsubscriber" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.monitoring.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-monitoring-logsubscriber.log.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-monitoring-sdamsubscriber.serverchanged.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-monitoring-sdamsubscriber.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-monitoring-sdamsubscriber.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-monitoring-sdamsubscriber.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-monitoring-sdamsubscriber.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-monitoring-sdamsubscriber.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-monitoring-sdamsubscriber.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-monitoring-sdamsubscriber.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-monitoring-sdamsubscriber.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-monitoring-sdamsubscriber.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-monitoring-sdamsubscriber.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-monitoring-sdamsubscriber.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\Monitoring\SDAMSubscriber interface" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Monitoring\SDAMSubscriber - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\Monitoring\SDAMSubscriber interface" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Monitoring\SDAMSubscriber - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\Monitoring\SDAMSubscriber interface" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\Monitoring\SDAMSubscriber interface" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-monitoring-sdamsubscriber.serverchanged.php">
          MongoDB\Driver\Monitoring\SDAMSubscriber::serverChanged &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-monitoring-logsubscriber.log.php">
          &laquo; MongoDB\Driver\Monitoring\LogSubscriber::log        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-monitoring-sdamsubscriber.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-monitoring-sdamsubscriber.php'>German</option>
            <option value='es/class.mongodb-driver-monitoring-sdamsubscriber.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-monitoring-sdamsubscriber.php'>French</option>
            <option value='it/class.mongodb-driver-monitoring-sdamsubscriber.php'>Italian</option>
            <option value='ja/class.mongodb-driver-monitoring-sdamsubscriber.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-monitoring-sdamsubscriber.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-monitoring-sdamsubscriber.php'>Russian</option>
            <option value='tr/class.mongodb-driver-monitoring-sdamsubscriber.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-monitoring-sdamsubscriber.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-monitoring-sdamsubscriber.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-monitoring-sdamsubscriber" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-monitoring-sdamsubscriber.serverchanged.php">MongoDB\Driver\Monitoring\SDAMSubscriber::serverChanged</a> — Notification method for a server description change</li><li><a href="mongodb-driver-monitoring-sdamsubscriber.serverclosed.php">MongoDB\Driver\Monitoring\SDAMSubscriber::serverClosed</a> — Notification method for closing a server</li><li><a href="mongodb-driver-monitoring-sdamsubscriber.serverheartbeatfailed.php">MongoDB\Driver\Monitoring\SDAMSubscriber::serverHeartbeatFailed</a> — Notification method for a failed server heartbeat</li><li><a href="mongodb-driver-monitoring-sdamsubscriber.serverheartbeatstarted.php">MongoDB\Driver\Monitoring\SDAMSubscriber::serverHeartbeatStarted</a> — Notification method for a started server heartbeat</li><li><a href="mongodb-driver-monitoring-sdamsubscriber.serverheartbeatsucceeded.php">MongoDB\Driver\Monitoring\SDAMSubscriber::serverHeartbeatSucceeded</a> — Notification method for a successful server heartbeat</li><li><a href="mongodb-driver-monitoring-sdamsubscriber.serveropening.php">MongoDB\Driver\Monitoring\SDAMSubscriber::serverOpening</a> — Notification method for opening a server</li><li><a href="mongodb-driver-monitoring-sdamsubscriber.topologychanged.php">MongoDB\Driver\Monitoring\SDAMSubscriber::topologyChanged</a> — Notification method for a topology description change</li><li><a href="mongodb-driver-monitoring-sdamsubscriber.topologyclosed.php">MongoDB\Driver\Monitoring\SDAMSubscriber::topologyClosed</a> — Notification method for closing the topology</li><li><a href="mongodb-driver-monitoring-sdamsubscriber.topologyopening.php">MongoDB\Driver\Monitoring\SDAMSubscriber::topologyOpening</a> — Notification method for opening the topology</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/monitoring/sdamsubscriber.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-monitoring-sdamsubscriber%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-monitoring-sdamsubscriber&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-monitoring-sdamsubscriber.php">＋<small>add a note</small></a></span>
