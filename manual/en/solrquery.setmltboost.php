...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setmltboost.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setmltboost.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltboost.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setmlt.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setmltcount.php">
...
<meta name="Description" content="Set if the query will be boosted by the interesting term relevance" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setMltBoost - Manual" />
<meta name="twitter:description" content="Set if the query will be boosted by the interesting term relevance" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setMltBoost - Manual" />
<meta itemprop="description" content="Set if the query will be boosted by the interesting term relevance" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set if the query will be boosted by the interesting term relevance" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setmltboost.php' selected="selected">English</option>
            ...
            <option value='ru/solrquery.setmltboost.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setMltBoost</span> &mdash; <span class="dc-title">Set if the query will be boosted by the interesting term relevance</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setmltboost-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Sets to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>
      </p>
     </dd>
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setmltboost.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setmltboost%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setmltboost&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setmltboost.php">＋<small>add a note</small></a></span>
