...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rtrim.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.quotemeta.php">
 <link rel="next" href="https://www.php.net/manual/en/function.setlocale.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rtrim.php' selected="selected">English</option>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.ltrim.php" class="function" rel="rdfs-seeAlso">ltrim()</a> - Strip whitespace (or other characters) from the beginning of a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/rtrim.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rtrim%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rtrim&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rtrim.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">I have an obsessive love for php's array functions given how extremely easy they've made complex string handling for me in various situations... so, have another string-rtrim() variant:
<br />
...
<br /></span>
<br />Astonishingly, something I didn't expect, but: It completely compares to harmor's rstrtrim below, execution time wise. o_o Whee!</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">True, the Perl chomp() will only trim newline characters. There is, however, the Perl chop() function which is pretty much identical to the PHP rtrim()
<br />
<br />---
<br />
...
<div class="phpcode"><code><span class="html">I'm sure there's a better way to strip strings from the end of strings.
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="comment">/**
<br /> * Strip a string from the end of a string
<br /> *
<br /> * @param string $str      the input string
<br /> * @param string $remove   OPTIONAL string to remove
<br /> *  
<br /> * @return string the modified string
<br />  */
<br /></span><span class="keyword">function </span><span class="default">rstrtrim</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">, </span><span class="default">$remove</span><span class="keyword">=</span><span class="default">null</span><span class="keyword">)
<br />{
<br />    </span><span class="default">$str    </span><span class="keyword">= (string)</span><span class="default">$str</span><span class="keyword">;
<br />    </span><span class="default">$remove </span><span class="keyword">= (string)</span><span class="default">$remove</span><span class="keyword">;    
<br />    
<br />    if(empty(</span><span class="default">$remove</span><span class="keyword">))
<br />    {
<br />        return </span><span class="default">rtrim</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">);
<br />    }
<br />    
<br />    </span><span class="default">$len </span><span class="keyword">= </span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$remove</span><span class="keyword">);
<br />    </span><span class="default">$offset </span><span class="keyword">= </span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">)-</span><span class="default">$len</span><span class="keyword">;
<br />    while(</span><span class="default">$offset </span><span class="keyword">&gt; </span><span class="default">0 </span><span class="keyword">&amp;&amp; </span><span class="default">$offset </span><span class="keyword">== </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">, </span><span class="default">$remove</span><span class="keyword">, </span><span class="default">$offset</span><span class="keyword">))
<br />    {
<br />        </span><span class="default">$str </span><span class="keyword">= </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$offset</span><span class="keyword">);
<br />        </span><span class="default">$offset </span><span class="keyword">= </span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">)-</span><span class="default">$len</span><span class="keyword">;
<br />    }
<br />    
<br />    return </span><span class="default">rtrim</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">);    
<br />    
<br />} </span><span class="comment">//End of function rstrtrim($str, $remove=null)
<br />
<br /></span><span class="keyword">echo </span><span class="default">rstrtrim</span><span class="keyword">(</span><span class="string">'Hello World!!!'</span><span class="keyword">, </span><span class="string">'!'</span><span class="keyword">)   .</span><span class="string">'&lt;br /&gt;'</span><span class="keyword">; </span><span class="comment">//"Hello World"
<br /></span><span class="keyword">echo </span><span class="default">rstrtrim</span><span class="keyword">(</span><span class="string">'Hello World!!!'</span><span class="keyword">, </span><span class="string">'!!'</span><span class="keyword">)  .</span><span class="string">'&lt;br /&gt;'</span><span class="keyword">; </span><span class="comment">//"Hello World!"
<br /></span><span class="keyword">echo </span><span class="default">rstrtrim</span><span class="keyword">(</span><span class="string">'Hello World!!!'</span><span class="keyword">, </span><span class="string">'!!!'</span><span class="keyword">) .</span><span class="string">'&lt;br /&gt;'</span><span class="keyword">; </span><span class="comment">//"Hello World"
<br /></span><span class="keyword">echo </span><span class="default">rstrtrim</span><span class="keyword">(</span><span class="string">'Hello World!!!'</span><span class="keyword">, </span><span class="string">'!!!!'</span><span class="keyword">).</span><span class="string">'&lt;br /&gt;'</span><span class="keyword">; </span><span class="comment">//"Hello World!!!"
<br /></span><span class="default">?&gt;</span></span></code></div>
...
<div class="foot"><a href="/manual/add-note.php?sect=function.rtrim&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rtrim.php">＋<small>add a note</small></a></div>
