...
<head>
  ...
  <title>PHP: Imagick::quantizeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.quantizeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.quantizeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.quantizeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.profileimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.quantizeimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.quantizeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.quantizeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.quantizeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.quantizeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.quantizeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.quantizeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.quantizeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.quantizeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.quantizeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.quantizeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.quantizeimage.php" hreflang="zh">
...
<meta name="Description" content="Analyzes the colors within a reference image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::quantizeImage - Manual" />
<meta name="twitter:description" content="Analyzes the colors within a reference image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::quantizeImage - Manual" />
<meta itemprop="description" content="Analyzes the colors within a reference image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Analyzes the colors within a reference image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.quantizeimages.php">
          Imagick::quantizeImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.profileimage.php">
          &laquo; Imagick::profileImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.quantizeimage.php' selected="selected">English</option>
            <option value='de/imagick.quantizeimage.php'>German</option>
            <option value='es/imagick.quantizeimage.php'>Spanish</option>
            <option value='fr/imagick.quantizeimage.php'>French</option>
            <option value='it/imagick.quantizeimage.php'>Italian</option>
            <option value='ja/imagick.quantizeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.quantizeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.quantizeimage.php'>Russian</option>
            <option value='tr/imagick.quantizeimage.php'>Turkish</option>
            <option value='uk/imagick.quantizeimage.php'>Ukrainian</option>
            <option value='zh/imagick.quantizeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.quantizeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::quantizeImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::quantizeImage</span> &mdash; <span class="dc-title">Analyzes the colors within a reference image</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.quantizeimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::quantizeImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$numberColors</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$colorspace</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$treedepth</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$dither</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$measureError</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.quantizeimage-examples">
  ...
  <p class="para">
    <div class="example" id="example-3068">
      <p><strong>Example #1  <span class="function"><strong>Imagick::quantizeImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/quantizeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.quantizeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.quantizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.quantizeimage.php">＋<small>add a note</small></a></span>
