...
<head>
  ...
  <title>PHP: trader_ht_dcperiod - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-ht-dcperiod.php">
 <link rel="shorturl" href="https://www.php.net/trader-ht-dcperiod">
 <link rel="alternate" href="https://www.php.net/trader-ht-dcperiod" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-get-unstable-period.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-ht-dcphase.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-ht-dcperiod.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-ht-dcperiod.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-ht-dcperiod.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-ht-dcperiod.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-ht-dcperiod.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-ht-dcperiod.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-ht-dcperiod.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-ht-dcperiod.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-ht-dcperiod.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-ht-dcperiod.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-ht-dcperiod.php" hreflang="zh">
...
<meta name="Description" content="Hilbert Transform - Dominant Cycle Period" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_ht_dcperiod - Manual" />
<meta name="twitter:description" content="Hilbert Transform - Dominant Cycle Period" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_ht_dcperiod - Manual" />
<meta itemprop="description" content="Hilbert Transform - Dominant Cycle Period" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Hilbert Transform - Dominant Cycle Period" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.trader-ht-dcphase.php">
          trader_ht_dcphase &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-get-unstable-period.php">
          &laquo; trader_get_unstable_period        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-ht-dcperiod.php' selected="selected">English</option>
            <option value='de/function.trader-ht-dcperiod.php'>German</option>
            <option value='es/function.trader-ht-dcperiod.php'>Spanish</option>
            <option value='fr/function.trader-ht-dcperiod.php'>French</option>
            <option value='it/function.trader-ht-dcperiod.php'>Italian</option>
            <option value='ja/function.trader-ht-dcperiod.php'>Japanese</option>
            <option value='pt_BR/function.trader-ht-dcperiod.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-ht-dcperiod.php'>Russian</option>
            <option value='tr/function.trader-ht-dcperiod.php'>Turkish</option>
            <option value='uk/function.trader-ht-dcperiod.php'>Ukrainian</option>
            <option value='zh/function.trader-ht-dcperiod.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-ht-dcperiod" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_ht_dcperiod</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_ht_dcperiod</span> &mdash; <span class="dc-title">Hilbert Transform - Dominant Cycle Period</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-ht-dcperiod-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_ht_dcperiod</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-ht-dcperiod-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-ht-dcperiod-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-ht-dcperiod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-ht-dcperiod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-ht-dcperiod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-ht-dcperiod.php">＋<small>add a note</small></a></span>
