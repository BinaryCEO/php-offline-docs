...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rand.php">
 <link rel="shorturl" href="https://www.php.net/rand">
 <link rel="alternate" href="https://www.php.net/rand" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.random.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mt-srand.php">
 <link rel="next" href="https://www.php.net/manual/en/function.random-bytes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rand.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rand.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rand.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rand.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rand.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rand.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rand.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rand.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rand.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rand.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rand.php" hreflang="zh">
...
<meta name="Description" content="Generate a random integer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rand - Manual" />
<meta name="twitter:description" content="Generate a random integer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rand - Manual" />
<meta itemprop="description" content="Generate a random integer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generate a random integer" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rand.php' selected="selected">English</option>
            <option value='de/function.rand.php'>German</option>
            <option value='es/function.rand.php'>Spanish</option>
            <option value='fr/function.rand.php'>French</option>
            <option value='it/function.rand.php'>Italian</option>
            <option value='ja/function.rand.php'>Japanese</option>
            <option value='pt_BR/function.rand.php'>Brazilian Portuguese</option>
            <option value='ru/function.rand.php'>Russian</option>
            <option value='tr/function.rand.php'>Turkish</option>
            <option value='uk/function.rand.php'>Ukrainian</option>
            <option value='zh/function.rand.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rand" class="refentry">
 ...
 <div class="refsect1 notes" id="refsect1-function.rand-notes">
  ...
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="para">
    ...
    be within the range <span class="function"><a href="function.getrandmax.php" class="function">getrandmax()</a></span>. i.e. (<code class="parameter">max</code> -
    <code class="parameter">min</code>) &lt;= <span class="function"><a href="function.getrandmax.php" class="function">getrandmax()</a></span>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.random-bytes.php" class="function" rel="rdfs-seeAlso">random_bytes()</a> - Get cryptographically secure random bytes</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/random/functions/rand.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rand%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rand&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rand.php">＋<small>add a note</small></a></span>
