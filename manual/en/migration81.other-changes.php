...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration81.other-changes.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration81.other-changes.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration81.other-changes.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration81.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration81.deprecated.php">
 <link rel="next" href="https://www.php.net/manual/en/migration80.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration81.other-changes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration81.other-changes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration81.other-changes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration81.other-changes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration81.other-changes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration81.other-changes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration81.other-changes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration81.other-changes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration81.other-changes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration81.other-changes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration81.other-changes.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="migration80.php">
          Migrating from PHP 7.4.x to PHP 8.0.x &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration81.other-changes.php' selected="selected">English</option>
            <option value='de/migration81.other-changes.php'>German</option>
            <option value='es/migration81.other-changes.php'>Spanish</option>
            <option value='fr/migration81.other-changes.php'>French</option>
            <option value='it/migration81.other-changes.php'>Italian</option>
            <option value='ja/migration81.other-changes.php'>Japanese</option>
            <option value='pt_BR/migration81.other-changes.php'>Brazilian Portuguese</option>
            <option value='ru/migration81.other-changes.php'>Russian</option>
            <option value='tr/migration81.other-changes.php'>Turkish</option>
            <option value='uk/migration81.other-changes.php'>Ukrainian</option>
            <option value='zh/migration81.other-changes.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration81.other-changes" class="sect1">
 ...
 <div class="sect2" id="migration81.other-changes.functions">
  ...
  <div class="sect3" id="migration81.other-changes.functions.core">
   ...
   <p class="para">
    The order of properties used in <a href="control-structures.foreach.php" class="link"><code class="literal">foreach</code></a>, <span class="function"><a href="function.var-dump.php" class="function">var_dump()</a></span>,
    ...
    <p class="para">
     ...
     <code class="literal">&quot;C:\foo\&quot;</code>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration81/other-changes.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration81.other-changes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration81.other-changes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration81.other-changes.php">＋<small>add a note</small></a></span>
