...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.yaz-connect.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.yaz-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.yaz-database.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.yaz-connect.php' selected="selected">English</option>
            ...
            <option value='zh/function.yaz-connect.php'>Chinese (Simplified)</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.yaz-close.php" class="function" rel="rdfs-seeAlso">yaz_close()</a> - Close YAZ connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaz/functions/yaz-connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.yaz-connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.yaz-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.yaz-connect.php">＋<small>add a note</small></a></span>
