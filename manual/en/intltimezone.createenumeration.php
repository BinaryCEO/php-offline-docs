...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intltimezone.createenumeration.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intltimezone.createenumeration.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intltimezone.createenumeration.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intltimezone.php">
 <link rel="prev" href="https://www.php.net/manual/en/intltimezone.createdefault.php">
 <link rel="next" href="https://www.php.net/manual/en/intltimezone.createtimezone.php">
...
<meta name="Description" content="Get an enumeration over time zone IDs associated with the
  given country or offset" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlTimeZone::createEnumeration - Manual" />
<meta name="twitter:description" content="Get an enumeration over time zone IDs associated with the
  given country or offset" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlTimeZone::createEnumeration - Manual" />
<meta itemprop="description" content="Get an enumeration over time zone IDs associated with the
  given country or offset" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get an enumeration over time zone IDs associated with the
  given country or offset" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intltimezone.createenumeration.php' selected="selected">English</option>
            <option value='de/intltimezone.createenumeration.php'>German</option>
            <option value='es/intltimezone.createenumeration.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlTimeZone::createEnumeration</span> -- <span class="refname">intltz_create_enumeration</span> &mdash; <span class="dc-title">Get an enumeration over time zone IDs associated with the
  given country or offset</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intltimezone.createenumeration-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intltimezone/createenumeration.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintltimezone.createenumeration%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intltimezone.createenumeration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intltimezone.createenumeration.php">＋<small>add a note</small></a></span>
