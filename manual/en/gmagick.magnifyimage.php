...
<head>
  ...
  <title>PHP: Gmagick::magnifyimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.magnifyimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.magnifyimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.magnifyimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.levelimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.mapimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.magnifyimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.magnifyimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.magnifyimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.magnifyimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.magnifyimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.magnifyimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.magnifyimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.magnifyimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.magnifyimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.magnifyimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.magnifyimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::magnifyimage - Manual" />
<meta name="twitter:description" content="Scales an image proportionally 2x" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::magnifyimage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.mapimage.php">
          Gmagick::mapimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.levelimage.php">
          &laquo; Gmagick::levelimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.magnifyimage.php' selected="selected">English</option>
            <option value='de/gmagick.magnifyimage.php'>German</option>
            <option value='es/gmagick.magnifyimage.php'>Spanish</option>
            <option value='fr/gmagick.magnifyimage.php'>French</option>
            <option value='it/gmagick.magnifyimage.php'>Italian</option>
            <option value='ja/gmagick.magnifyimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.magnifyimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.magnifyimage.php'>Russian</option>
            <option value='tr/gmagick.magnifyimage.php'>Turkish</option>
            <option value='uk/gmagick.magnifyimage.php'>Ukrainian</option>
            <option value='zh/gmagick.magnifyimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.magnifyimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::magnifyimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::magnifyimage</span> &mdash; <span class="dc-title">Scales an image proportionally 2x</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.magnifyimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::magnifyimage</strong></span>(): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.magnifyimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.magnifyimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Magnified <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.magnifyimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/magnifyimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.magnifyimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.magnifyimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.magnifyimage.php">＋<small>add a note</small></a></span>
