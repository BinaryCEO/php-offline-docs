...
<head>
  ...
  <title>PHP: ps_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-close.php">
 <link rel="shorturl" href="https://www.php.net/ps-close">
 <link rel="alternate" href="https://www.php.net/ps-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-clip.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-close-image.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-close.php" hreflang="zh">
...
<meta name="Description" content="Closes a PostScript document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_close - Manual" />
<meta name="twitter:description" content="Closes a PostScript document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_close - Manual" />
<meta itemprop="description" content="Closes a PostScript document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Closes a PostScript document" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-close.php' selected="selected">English</option>
            <option value='de/function.ps-close.php'>German</option>
            <option value='es/function.ps-close.php'>Spanish</option>
            <option value='fr/function.ps-close.php'>French</option>
            <option value='it/function.ps-close.php'>Italian</option>
            <option value='ja/function.ps-close.php'>Japanese</option>
            <option value='pt_BR/function.ps-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-close.php'>Russian</option>
            <option value='tr/function.ps-close.php'>Turkish</option>
            <option value='uk/function.ps-close.php'>Ukrainian</option>
            <option value='zh/function.ps-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_close</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_close</span> &mdash; <span class="dc-title">Closes a PostScript document</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-close-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_close</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   ...
   It also writes the bookmark tree. <span class="function"><strong>ps_close()</strong></span> does
   not free any resources, which is done by <span class="function"><a href="function.ps-delete.php" class="function">ps_delete()</a></span>.
  </p>
  <p class="para">
   This function is also called by <span class="function"><a href="function.ps-delete.php" class="function">ps_delete()</a></span> if it
   has not been called before.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-close-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-close-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-close-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-delete.php" class="function" rel="rdfs-seeAlso">ps_delete()</a> - Deletes all resources of a PostScript document</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-close.php">＋<small>add a note</small></a></span>
