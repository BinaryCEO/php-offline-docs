...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightSnippets - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightsnippets.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightsnippets.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightsnippets.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightsimplepre.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightusephrasehighlighter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightsnippets.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightsnippets.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightsnippets.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightsnippets.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightsnippets.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightsnippets.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightsnippets.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightsnippets.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightsnippets.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightsnippets.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightsnippets.php" hreflang="zh">
...
<meta name="Description" content="Returns the maximum number of highlighted snippets to generate per field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightSnippets - Manual" />
<meta name="twitter:description" content="Returns the maximum number of highlighted snippets to generate per field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightSnippets - Manual" />
<meta itemprop="description" content="Returns the maximum number of highlighted snippets to generate per field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the maximum number of highlighted snippets to generate per field" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.gethighlightusephrasehighlighter.php">
          SolrQuery::getHighlightUsePhraseHighlighter &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightsimplepre.php">
          &laquo; SolrQuery::getHighlightSimplePre        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightsnippets.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightsnippets.php'>German</option>
            <option value='es/solrquery.gethighlightsnippets.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightsnippets.php'>French</option>
            <option value='it/solrquery.gethighlightsnippets.php'>Italian</option>
            <option value='ja/solrquery.gethighlightsnippets.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightsnippets.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightsnippets.php'>Russian</option>
            <option value='tr/solrquery.gethighlightsnippets.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightsnippets.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightsnippets.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightsnippets" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightSnippets</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightSnippets</span> &mdash; <span class="dc-title">Returns the maximum number of highlighted snippets to generate per field</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightsnippets-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightSnippets</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightsnippets-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightsnippets-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightsnippets.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightsnippets%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightsnippets&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightsnippets.php">＋<small>add a note</small></a></span>
