...
<head>
  ...
  <title>PHP: eio_grp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-grp.php">
 <link rel="shorturl" href="https://www.php.net/eio-grp">
 <link rel="alternate" href="https://www.php.net/eio-grp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-get-last-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-grp-add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-grp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-grp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-grp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-grp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-grp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-grp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-grp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-grp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-grp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-grp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-grp.php" hreflang="zh">
...
<meta name="Description" content="Creates a request group" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_grp - Manual" />
<meta name="twitter:description" content="Creates a request group" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_grp - Manual" />
<meta itemprop="description" content="Creates a request group" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a request group" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.eio-grp-add.php">
          eio_grp_add &raquo;
              ...
              <div class="prev">
        <a href="function.eio-get-last-error.php">
          &laquo; eio_get_last_error        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-grp.php' selected="selected">English</option>
            <option value='de/function.eio-grp.php'>German</option>
            <option value='es/function.eio-grp.php'>Spanish</option>
            <option value='fr/function.eio-grp.php'>French</option>
            <option value='it/function.eio-grp.php'>Italian</option>
            <option value='ja/function.eio-grp.php'>Japanese</option>
            <option value='pt_BR/function.eio-grp.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-grp.php'>Russian</option>
            <option value='tr/function.eio-grp.php'>Turkish</option>
            <option value='uk/function.eio-grp.php'>Ukrainian</option>
            <option value='zh/function.eio-grp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-grp" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-grp-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_grp</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-grp-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>eio_grp()</strong></span> returns request group resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.eio-grp-add.php" class="function" rel="rdfs-seeAlso">eio_grp_add()</a> - Adds a request to the request group</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-grp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-grp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-grp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-grp.php">＋<small>add a note</small></a></span>
