...
<head>
  ...
  <title>PHP: IntlIterator - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.intliterator.php">
 <link rel="shorturl" href="https://www.php.net/intliterator">
 <link rel="alternate" href="https://www.php.net/intliterator" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.intl.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.intlexception.php">
 <link rel="next" href="https://www.php.net/manual/en/intliterator.current.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.intliterator.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.intliterator.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.intliterator.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.intliterator.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.intliterator.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.intliterator.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.intliterator.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.intliterator.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.intliterator.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.intliterator.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.intliterator.php" hreflang="zh">
...
<meta name="Description" content="The IntlIterator class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlIterator - Manual" />
<meta name="twitter:description" content="The IntlIterator class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlIterator - Manual" />
<meta itemprop="description" content="The IntlIterator class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The IntlIterator class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intliterator.current.php">
          IntlIterator::current &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.intlexception.php">
          &laquo; IntlException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.intliterator.php' selected="selected">English</option>
            <option value='de/class.intliterator.php'>German</option>
            <option value='es/class.intliterator.php'>Spanish</option>
            <option value='fr/class.intliterator.php'>French</option>
            <option value='it/class.intliterator.php'>Italian</option>
            <option value='ja/class.intliterator.php'>Japanese</option>
            <option value='pt_BR/class.intliterator.php'>Brazilian Portuguese</option>
            <option value='ru/class.intliterator.php'>Russian</option>
            <option value='tr/class.intliterator.php'>Turkish</option>
            <option value='uk/class.intliterator.php'>Ukrainian</option>
            <option value='zh/class.intliterator.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.intliterator" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="intliterator.current.php">IntlIterator::current</a> — Get the current element</li><li><a href="intliterator.key.php">IntlIterator::key</a> — Get the current key</li><li><a href="intliterator.next.php">IntlIterator::next</a> — Move forward to the next element</li><li><a href="intliterator.rewind.php">IntlIterator::rewind</a> — Rewind the iterator to the first element</li><li><a href="intliterator.valid.php">IntlIterator::valid</a> — Check if current position is valid</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intliterator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.intliterator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.intliterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.intliterator.php">＋<small>add a note</small></a></span>
