...
<head>
  ...
  <title>PHP: PharData::convertToData - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phardata.converttodata.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phardata.converttodata.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phardata.converttodata.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phardata.php">
 <link rel="prev" href="https://www.php.net/manual/en/phardata.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/phardata.converttoexecutable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phardata.converttodata.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phardata.converttodata.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phardata.converttodata.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phardata.converttodata.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phardata.converttodata.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phardata.converttodata.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phardata.converttodata.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phardata.converttodata.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phardata.converttodata.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phardata.converttodata.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phardata.converttodata.php" hreflang="zh">
...
<meta name="Description" content="Convert a phar archive to a non-executable tar or zip file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PharData::convertToData - Manual" />
<meta name="twitter:description" content="Convert a phar archive to a non-executable tar or zip file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PharData::convertToData - Manual" />
<meta itemprop="description" content="Convert a phar archive to a non-executable tar or zip file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Convert a phar archive to a non-executable tar or zip file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phardata.converttoexecutable.php">
          PharData::convertToExecutable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phardata.construct.php">
          &laquo; PharData::__construct        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phardata.converttodata.php' selected="selected">English</option>
            <option value='de/phardata.converttodata.php'>German</option>
            <option value='es/phardata.converttodata.php'>Spanish</option>
            <option value='fr/phardata.converttodata.php'>French</option>
            <option value='it/phardata.converttodata.php'>Italian</option>
            <option value='ja/phardata.converttodata.php'>Japanese</option>
            <option value='pt_BR/phardata.converttodata.php'>Brazilian Portuguese</option>
            <option value='ru/phardata.converttodata.php'>Russian</option>
            <option value='tr/phardata.converttodata.php'>Turkish</option>
            <option value='uk/phardata.converttodata.php'>Ukrainian</option>
            <option value='zh/phardata.converttodata.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phardata.converttodata" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">PharData::convertToData</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">PharData::convertToData</span> &mdash; <span class="dc-title">Convert a phar archive to a non-executable tar or zip file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-phardata.converttodata-description">
  ...
  <p class="para">
   ...
   it is better to use the <span class="function"><a href="phardata.compress.php" class="function">PharData::compress()</a></span> method for logical
   consistency.
  </p>
  <p class="para">
 ...
 <div class="refsect1 errors" id="refsect1-phardata.converttodata-errors">
  ...
  <p class="para">
   ...
   has not concluded with <span class="function"><a href="phar.stopbuffering.php" class="function">Phar::stopBuffering()</a></span>, and a
   <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> if any problems are encountered
   during the phar creation process.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-phardata.converttodata-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-phardata.converttodata-examples">
  ...
  <p class="para">
   <div class="example" id="example-852">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phardata.converttoexecutable.php" class="function" rel="rdfs-seeAlso">PharData::convertToExecutable()</a> - Convert a non-executable tar/zip archive to an executable phar archive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/PharData/convertToData.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphardata.converttodata%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phardata.converttodata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.converttodata.php">＋<small>add a note</small></a></span>
