...
<head>
  ...
  <title>PHP: UI\Area - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-area.php">
 <link rel="shorturl" href="https://www.php.net/ui-area">
 <link rel="alternate" href="https://www.php.net/ui-area" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-menuitem.setchecked.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-area.ondraw.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-area.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-area.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-area.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-area.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-area.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-area.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-area.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-area.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-area.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-area.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-area.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: UI\Area - Manual" />
<meta name="twitter:description" content="Area" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Area - Manual" />
<meta itemprop="description" content="Area" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ui-area.ondraw.php">
          UI\Area::onDraw &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-menuitem.setchecked.php">
          &laquo; UI\MenuItem::setChecked        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-area.php' selected="selected">English</option>
            <option value='de/class.ui-area.php'>German</option>
            <option value='es/class.ui-area.php'>Spanish</option>
            <option value='fr/class.ui-area.php'>French</option>
            <option value='it/class.ui-area.php'>Italian</option>
            <option value='ja/class.ui-area.php'>Japanese</option>
            <option value='pt_BR/class.ui-area.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-area.php'>Russian</option>
            <option value='tr/class.ui-area.php'>Turkish</option>
            <option value='uk/class.ui-area.php'>Ukrainian</option>
            <option value='zh/class.ui-area.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-area" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>
  ...
  <div class="section" id="ui-area.intro">
  ...
  <div class="section" id="ui-area.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Area</strong>
     </span>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-area.php#ui-area.constants.ctrl"><var class="varname">Ctrl</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-area.php#ui-area.constants.alt"><var class="varname">Alt</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-area.php#ui-area.constants.shift"><var class="varname">Shift</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-area.php#ui-area.constants.super"><var class="varname">Super</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-area.php#ui-area.constants.down"><var class="varname">Down</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-area.php#ui-area.constants.up"><var class="varname">Up</var></a></var>;</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description">
   <span class="modifier">protected</span> <span class="methodname"><a href="ui-area.ondraw.php" class="methodname">onDraw</a></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.ui-draw-pen.php" class="type UI\Draw\Pen">UI\Draw\Pen</a></span> <code class="parameter">$pen</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.ui-size.php" class="type UI\Size">UI\Size</a></span> <code class="parameter">$areaSize</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.ui-point.php" class="type UI\Point">UI\Point</a></span> <code class="parameter">$clipPoint</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.ui-size.php" class="type UI\Size">UI\Size</a></span> <code class="parameter">$clipSize</code></span><br>)</div>
<div class="methodsynopsis dc-description"><span class="modifier">protected</span> <span class="methodname"><a href="ui-area.onkey.php" class="methodname">onKey</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$ext</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code></span>)</div>
<div class="methodsynopsis dc-description"><span class="modifier">protected</span> <span class="methodname"><a href="ui-area.onmouse.php" class="methodname">onMouse</a></span>(<span class="methodparam"><span class="type"><a href="class.ui-point.php" class="type UI\Point">UI\Point</a></span> <code class="parameter">$areaPoint</code></span>, <span class="methodparam"><span class="type"><a href="class.ui-size.php" class="type UI\Size">UI\Size</a></span> <code class="parameter">$areaSize</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code></span>)</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-area.redraw.php" class="methodname">redraw</a></span>()</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-area.scrollto.php" class="methodname">scrollTo</a></span>(<span class="methodparam"><span class="type"><a href="class.ui-point.php" class="type UI\Point">UI\Point</a></span> <code class="parameter">$point</code></span>, <span class="methodparam"><span class="type"><a href="class.ui-size.php" class="type UI\Size">UI\Size</a></span> <code class="parameter">$size</code></span>)</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-area.setsize.php" class="methodname">setSize</a></span>(<span class="methodparam"><span class="type"><a href="class.ui-size.php" class="type UI\Size">UI\Size</a></span> <code class="parameter">$size</code></span>)</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-control.show.php" class="methodname">UI\Control::show</a></span>()</div>
  ...
  <div class="section" id="ui-area.constants">
   <h2 class="title">Predefined Constants</h2>
   <dl>

    
     <dt id="ui-area.constants.ctrl"><strong><code><a href="class.ui-area.php#ui-area.constants.ctrl">UI\Area::Ctrl</a></code></strong></dt>
     <dd>
      <span class="simpara">
       Shall be set in the modifiers passed to key and mouse events
       when the <kbd class="keycap">CTRL</kbd> key is active
      </span>
     </dd>
    

    
     <dt id="ui-area.constants.alt"><strong><code><a href="class.ui-area.php#ui-area.constants.alt">UI\Area::Alt</a></code></strong></dt>
     <dd>
      <span class="simpara">
       Shall be set in the modifiers passed to key and mouse events
       when the <kbd class="keycap">ALT</kbd> key is active
      </span>
     </dd>
    

    
     <dt id="ui-area.constants.shift"><strong><code><a href="class.ui-area.php#ui-area.constants.shift">UI\Area::Shift</a></code></strong></dt>
     <dd>
      <span class="simpara">
       Shall be set in the modifiers passed to key and mouse events
       when the <kbd class="keycap">SHIFT</kbd> key is active
      </span>
     </dd>
    

    
     <dt id="ui-area.constants.super"><strong><code><a href="class.ui-area.php#ui-area.constants.super">UI\Area::Super</a></code></strong></dt>
     <dd>
      <p class="para"/>
     </dd>
     ...
     <dt id="ui-area.constants.down"><strong><code><a href="class.ui-area.php#ui-area.constants.down">UI\Area::Down</a></code></strong></dt>
     <dd>
      <p class="para">Shall be set in the modifiers passed to key and mouse events</p>
     </dd>
    

    
     <dt id="ui-area.constants.up"><strong><code><a href="class.ui-area.php#ui-area.constants.up">UI\Area::Up</a></code></strong></dt>
     <dd>
      <p class="para">Shall be set in the modifiers passed to key and mouse events</p>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-area.ondraw.php">UI\Area::onDraw</a> — Draw Callback</li><li><a href="ui-area.onkey.php">UI\Area::onKey</a> — Key Callback</li><li><a href="ui-area.onmouse.php">UI\Area::onMouse</a> — Mouse Callback</li><li><a href="ui-area.redraw.php">UI\Area::redraw</a> — Redraw Area</li><li><a href="ui-area.scrollto.php">UI\Area::scrollTo</a> — Area Scroll</li><li><a href="ui-area.setsize.php">UI\Area::setSize</a> — Set Size</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.area.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-area%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-area&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-area.php">＋<small>add a note</small></a></span>
