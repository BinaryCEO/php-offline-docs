...
<head>
  ...
  <title>PHP: Imagick::quantizeImages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.quantizeimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.quantizeimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.quantizeimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.quantizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.queryfontmetrics.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.quantizeimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.quantizeimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.quantizeimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.quantizeimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.quantizeimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.quantizeimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.quantizeimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.quantizeimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.quantizeimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.quantizeimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.quantizeimages.php" hreflang="zh">
...
<meta name="Description" content="Analyzes the colors within a sequence of images" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::quantizeImages - Manual" />
<meta name="twitter:description" content="Analyzes the colors within a sequence of images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::quantizeImages - Manual" />
<meta itemprop="description" content="Analyzes the colors within a sequence of images" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Analyzes the colors within a sequence of images" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.queryfontmetrics.php">
          Imagick::queryFontMetrics &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.quantizeimage.php">
          &laquo; Imagick::quantizeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.quantizeimages.php' selected="selected">English</option>
            <option value='de/imagick.quantizeimages.php'>German</option>
            <option value='es/imagick.quantizeimages.php'>Spanish</option>
            <option value='fr/imagick.quantizeimages.php'>French</option>
            <option value='it/imagick.quantizeimages.php'>Italian</option>
            <option value='ja/imagick.quantizeimages.php'>Japanese</option>
            <option value='pt_BR/imagick.quantizeimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.quantizeimages.php'>Russian</option>
            <option value='tr/imagick.quantizeimages.php'>Turkish</option>
            <option value='uk/imagick.quantizeimages.php'>Ukrainian</option>
            <option value='zh/imagick.quantizeimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.quantizeimages" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::quantizeImages</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::quantizeImages</span> &mdash; <span class="dc-title">Analyzes the colors within a sequence of images</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.quantizeimages-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::quantizeImages</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$numberColors</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$colorspace</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$treedepth</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$dither</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$measureError</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.quantizeimages-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">numberColors</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.quantizeimages-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.quantizeimages-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/quantizeimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.quantizeimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.quantizeimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.quantizeimages.php">＋<small>add a note</small></a></span>
