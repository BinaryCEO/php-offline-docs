...
<head>
  ...
  <title>PHP: CommonMark\Node\Paragraph - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.commonmark-node-paragraph.php">
 <link rel="shorturl" href="https://www.php.net/commonmark-node-paragraph">
 <link rel="alternate" href="https://www.php.net/commonmark-node-paragraph" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.cmark.php">
 <link rel="prev" href="https://www.php.net/manual/en/commonmark-node-heading.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/class.commonmark-node-blockquote.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.commonmark-node-paragraph.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.commonmark-node-paragraph.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.commonmark-node-paragraph.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.commonmark-node-paragraph.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.commonmark-node-paragraph.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.commonmark-node-paragraph.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.commonmark-node-paragraph.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.commonmark-node-paragraph.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.commonmark-node-paragraph.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.commonmark-node-paragraph.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.commonmark-node-paragraph.php" hreflang="zh">
...
<meta name="Description" content="Paragraph concrete CommonMark\Node" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CommonMark\Node\Paragraph - Manual" />
<meta name="twitter:description" content="Paragraph concrete CommonMark\Node" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CommonMark\Node\Paragraph - Manual" />
<meta itemprop="description" content="Paragraph concrete CommonMark\Node" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Paragraph concrete CommonMark\Node" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.commonmark-node-blockquote.php">
          CommonMark\Node\BlockQuote &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="commonmark-node-heading.construct.php">
          &laquo; CommonMark\Node\Heading::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.commonmark-node-paragraph.php' selected="selected">English</option>
            <option value='de/class.commonmark-node-paragraph.php'>German</option>
            <option value='es/class.commonmark-node-paragraph.php'>Spanish</option>
            <option value='fr/class.commonmark-node-paragraph.php'>French</option>
            <option value='it/class.commonmark-node-paragraph.php'>Italian</option>
            <option value='ja/class.commonmark-node-paragraph.php'>Japanese</option>
            <option value='pt_BR/class.commonmark-node-paragraph.php'>Brazilian Portuguese</option>
            <option value='ru/class.commonmark-node-paragraph.php'>Russian</option>
            <option value='tr/class.commonmark-node-paragraph.php'>Turkish</option>
            <option value='uk/class.commonmark-node-paragraph.php'>Ukrainian</option>
            <option value='zh/class.commonmark-node-paragraph.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.commonmark-node-paragraph" class="reference">
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="commonmark-node.accept.php" class="methodname">CommonMark\Node::accept</a></span>(<span class="methodparam"><span class="type"><a href="class.commonmark-interfaces-ivisitor.php" class="type CommonMark\Interfaces\IVisitor">CommonMark\Interfaces\IVisitor</a></span> <code class="parameter">$visitor</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cmark/commonmark.node.paragraph.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.commonmark-node-paragraph%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.commonmark-node-paragraph&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.commonmark-node-paragraph.php">＋<small>add a note</small></a></span>
