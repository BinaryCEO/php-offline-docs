...
<head>
  ...
  <title>PHP: SolrQuery::setTermsReturnRaw - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.settermsreturnraw.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.settermsreturnraw.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsreturnraw.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.settermsprefix.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.settermssort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsreturnraw.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.settermsreturnraw.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.settermsreturnraw.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.settermsreturnraw.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.settermsreturnraw.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.settermsreturnraw.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.settermsreturnraw.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.settermsreturnraw.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.settermsreturnraw.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.settermsreturnraw.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.settermsreturnraw.php" hreflang="zh">
...
<meta name="Description" content="Return the raw characters of the indexed term" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setTermsReturnRaw - Manual" />
<meta name="twitter:description" content="Return the raw characters of the indexed term" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setTermsReturnRaw - Manual" />
<meta itemprop="description" content="Return the raw characters of the indexed term" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the raw characters of the indexed term" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.settermssort.php">
          SolrQuery::setTermsSort &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.settermsprefix.php">
          &laquo; SolrQuery::setTermsPrefix        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.settermsreturnraw.php' selected="selected">English</option>
            <option value='de/solrquery.settermsreturnraw.php'>German</option>
            <option value='es/solrquery.settermsreturnraw.php'>Spanish</option>
            <option value='fr/solrquery.settermsreturnraw.php'>French</option>
            <option value='it/solrquery.settermsreturnraw.php'>Italian</option>
            <option value='ja/solrquery.settermsreturnraw.php'>Japanese</option>
            <option value='pt_BR/solrquery.settermsreturnraw.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.settermsreturnraw.php'>Russian</option>
            <option value='tr/solrquery.settermsreturnraw.php'>Turkish</option>
            <option value='uk/solrquery.settermsreturnraw.php'>Ukrainian</option>
            <option value='zh/solrquery.settermsreturnraw.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.settermsreturnraw" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setTermsReturnRaw</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setTermsReturnRaw</span> &mdash; <span class="dc-title">Return the raw characters of the indexed term</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.settermsreturnraw-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setTermsReturnRaw</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.settermsreturnraw-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.settermsreturnraw-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/settermsreturnraw.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.settermsreturnraw%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.settermsreturnraw&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.settermsreturnraw.php">＋<small>add a note</small></a></span>
