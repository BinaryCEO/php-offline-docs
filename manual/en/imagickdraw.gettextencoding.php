...
<head>
  ...
  <title>PHP: ImagickDraw::getTextEncoding - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.gettextencoding.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.gettextencoding.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextencoding.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.gettextdecoration.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.gettextinterlinespacing.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextencoding.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.gettextencoding.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.gettextencoding.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.gettextencoding.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.gettextencoding.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.gettextencoding.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.gettextencoding.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.gettextencoding.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.gettextencoding.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.gettextencoding.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.gettextencoding.php" hreflang="zh">
...
<meta name="Description" content="Returns the code set used for text annotations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getTextEncoding - Manual" />
<meta name="twitter:description" content="Returns the code set used for text annotations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getTextEncoding - Manual" />
<meta itemprop="description" content="Returns the code set used for text annotations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the code set used for text annotations" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.gettextinterlinespacing.php">
          ImagickDraw::getTextInterlineSpacing &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.gettextdecoration.php">
          &laquo; ImagickDraw::getTextDecoration        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.gettextencoding.php' selected="selected">English</option>
            <option value='de/imagickdraw.gettextencoding.php'>German</option>
            <option value='es/imagickdraw.gettextencoding.php'>Spanish</option>
            <option value='fr/imagickdraw.gettextencoding.php'>French</option>
            <option value='it/imagickdraw.gettextencoding.php'>Italian</option>
            <option value='ja/imagickdraw.gettextencoding.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.gettextencoding.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.gettextencoding.php'>Russian</option>
            <option value='tr/imagickdraw.gettextencoding.php'>Turkish</option>
            <option value='uk/imagickdraw.gettextencoding.php'>Ukrainian</option>
            <option value='zh/imagickdraw.gettextencoding.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.gettextencoding" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getTextEncoding</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getTextEncoding</span> &mdash; <span class="dc-title">Returns the code set used for text annotations</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.gettextencoding-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getTextEncoding</strong></span>(): <span class="type"><span class="type"><a href="language.types.singleton.php" class="type false">false</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.gettextencoding-returnvalues">
  ...
  <p class="para">
   ...
   or false if text encoding is not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/gettextencoding.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.gettextencoding%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.gettextencoding&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.gettextencoding.php">＋<small>add a note</small></a></span>
