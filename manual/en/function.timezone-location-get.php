...
<head>
  ...
  <title>PHP: timezone_location_get - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.timezone-location-get.php">
 <link rel="shorturl" href="https://www.php.net/timezone-location-get">
 <link rel="alternate" href="https://www.php.net/timezone-location-get" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.timezone-identifiers-list.php">
 <link rel="next" href="https://www.php.net/manual/en/function.timezone-name-from-abbr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.timezone-location-get.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.timezone-location-get.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.timezone-location-get.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.timezone-location-get.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.timezone-location-get.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.timezone-location-get.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.timezone-location-get.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.timezone-location-get.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.timezone-location-get.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.timezone-location-get.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.timezone-location-get.php" hreflang="zh">
...
<meta name="Description" content="Alias of DateTimeZone::getLocation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: timezone_location_get - Manual" />
<meta name="twitter:description" content="Alias of DateTimeZone::getLocation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: timezone_location_get - Manual" />
<meta itemprop="description" content="Alias of DateTimeZone::getLocation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTimeZone::getLocation" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.timezone-name-from-abbr.php">
          timezone_name_from_abbr &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.timezone-identifiers-list.php">
          &laquo; timezone_identifiers_list        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.timezone-location-get.php' selected="selected">English</option>
            <option value='de/function.timezone-location-get.php'>German</option>
            <option value='es/function.timezone-location-get.php'>Spanish</option>
            <option value='fr/function.timezone-location-get.php'>French</option>
            <option value='it/function.timezone-location-get.php'>Italian</option>
            <option value='ja/function.timezone-location-get.php'>Japanese</option>
            <option value='pt_BR/function.timezone-location-get.php'>Brazilian Portuguese</option>
            <option value='ru/function.timezone-location-get.php'>Russian</option>
            <option value='tr/function.timezone-location-get.php'>Turkish</option>
            <option value='uk/function.timezone-location-get.php'>Ukrainian</option>
            <option value='zh/function.timezone-location-get.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.timezone-location-get" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">timezone_location_get</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">timezone_location_get</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetimezone.getlocation.php" class="methodname">DateTimeZone::getLocation()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.timezone-location-get-description">
  <h3 class="title">Description</h3>
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetimezone.getlocation.php" class="methodname">DateTimeZone::getLocation()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/timezone-location-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.timezone-location-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.timezone-location-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.timezone-location-get.php">＋<small>add a note</small></a></span>
