...
<head>
  ...
  <title>PHP: MongoDB\BSON\TimestampInterface - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-bson-timestampinterface.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-bson-timestampinterface">
 <link rel="alternate" href="https://www.php.net/mongodb-bson-timestampinterface" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.bson.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-bson-regexinterface.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-bson-timestampinterface.getincrement.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-bson-timestampinterface.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-bson-timestampinterface.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-bson-timestampinterface.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-bson-timestampinterface.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-bson-timestampinterface.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-bson-timestampinterface.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-bson-timestampinterface.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-bson-timestampinterface.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-bson-timestampinterface.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-bson-timestampinterface.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-bson-timestampinterface.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\BSON\TimestampInterface interface" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\TimestampInterface - Manual" />
<meta name="twitter:description" content="The MongoDB\BSON\TimestampInterface interface" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\TimestampInterface - Manual" />
<meta itemprop="description" content="The MongoDB\BSON\TimestampInterface interface" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\BSON\TimestampInterface interface" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-bson-timestampinterface.getincrement.php">
          MongoDB\BSON\TimestampInterface::getIncrement &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-bson-regexinterface.tostring.php">
          &laquo; MongoDB\BSON\RegexInterface::__toString        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-bson-timestampinterface.php' selected="selected">English</option>
            <option value='de/class.mongodb-bson-timestampinterface.php'>German</option>
            <option value='es/class.mongodb-bson-timestampinterface.php'>Spanish</option>
            <option value='fr/class.mongodb-bson-timestampinterface.php'>French</option>
            <option value='it/class.mongodb-bson-timestampinterface.php'>Italian</option>
            <option value='ja/class.mongodb-bson-timestampinterface.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-bson-timestampinterface.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-bson-timestampinterface.php'>Russian</option>
            <option value='tr/class.mongodb-bson-timestampinterface.php'>Turkish</option>
            <option value='uk/class.mongodb-bson-timestampinterface.php'>Ukrainian</option>
            <option value='zh/class.mongodb-bson-timestampinterface.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-bson-timestampinterface" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(mongodb &gt;=1.3.0)</p>
  <div class="section" id="mongodb-bson-timestampinterface.intro">
   ...
   <p class="para">
    ...
    <span class="classname"><a href="class.mongodb-bson-timestamp.php" class="classname">MongoDB\BSON\Timestamp</a></span> to be used as a
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-bson-timestampinterface.getincrement.php">MongoDB\BSON\TimestampInterface::getIncrement</a> — Returns the increment component of this TimestampInterface</li><li><a href="mongodb-bson-timestampinterface.gettimestamp.php">MongoDB\BSON\TimestampInterface::getTimestamp</a> — Returns the timestamp component of this TimestampInterface</li><li><a href="mongodb-bson-timestampinterface.tostring.php">MongoDB\BSON\TimestampInterface::__toString</a> — Returns the string representation of this TimestampInterface</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/bson/timestampinterface.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-bson-timestampinterface%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-bson-timestampinterface&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-bson-timestampinterface.php">＋<small>add a note</small></a></span>
