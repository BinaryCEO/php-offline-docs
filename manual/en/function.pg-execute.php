...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-execute.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-escape-string.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-fetch-all.php">
...
<meta name="Description" content="Sends a request to execute a prepared statement with given parameters, and waits for the result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_execute - Manual" />
<meta name="twitter:description" content="Sends a request to execute a prepared statement with given parameters, and waits for the result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_execute - Manual" />
<meta itemprop="description" content="Sends a request to execute a prepared statement with given parameters, and waits for the result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sends a request to execute a prepared statement with given parameters, and waits for the result" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-execute.php' selected="selected">English</option>
            <option value='de/function.pg-execute.php'>German</option>
            <option value='es/function.pg-execute.php'>Spanish</option>
            <option value='fr/function.pg-execute.php'>French</option>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-execute-description">
  ...
  <p class="para">
    ...
    <span class="function"><strong>pg_execute()</strong></span> is supported only against PostgreSQL 7.4 or
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-execute-examples">
  ...
  <p class="para">
   <div class="example" id="example-2056">
    <p><strong>Example #1 Using <span class="function"><strong>pg_execute()</strong></span></strong></p>
   ...
   given parameters, and waits for completion</span></li>
    ...
    <li><span class="function"><a href="function.pg-query-params.php" class="function" rel="rdfs-seeAlso">pg_query_params()</a> - Submits a command to the server and waits for the result, with the ability to pass parameters separately from the SQL command text</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-execute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-execute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-execute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-execute.php">＋<small>add a note</small></a></span>
