...
<head>
  ...
  <title>PHP: openssl_cms_sign - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-cms-sign.php">
 <link rel="shorturl" href="https://www.php.net/openssl-cms-sign">
 <link rel="alternate" href="https://www.php.net/openssl-cms-sign" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-cms-read.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-cms-verify.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-cms-sign.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-cms-sign.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-cms-sign.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-cms-sign.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-cms-sign.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-cms-sign.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-cms-sign.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-cms-sign.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-cms-sign.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-cms-sign.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-cms-sign.php" hreflang="zh">
...
<meta name="Description" content="Sign a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_cms_sign - Manual" />
<meta name="twitter:description" content="Sign a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_cms_sign - Manual" />
<meta itemprop="description" content="Sign a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sign a file" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-cms-verify.php">
          openssl_cms_verify &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-cms-read.php">
          &laquo; openssl_cms_read        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-cms-sign.php' selected="selected">English</option>
            <option value='de/function.openssl-cms-sign.php'>German</option>
            <option value='es/function.openssl-cms-sign.php'>Spanish</option>
            <option value='fr/function.openssl-cms-sign.php'>French</option>
            <option value='it/function.openssl-cms-sign.php'>Italian</option>
            <option value='ja/function.openssl-cms-sign.php'>Japanese</option>
            <option value='pt_BR/function.openssl-cms-sign.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-cms-sign.php'>Russian</option>
            <option value='tr/function.openssl-cms-sign.php'>Turkish</option>
            <option value='uk/function.openssl-cms-sign.php'>Ukrainian</option>
            <option value='zh/function.openssl-cms-sign.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-cms-sign" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_cms_sign</h1>
  <p class="verinfo">(PHP 8)</p><p class="refpurpose"><span class="refname">openssl_cms_sign</span> &mdash; <span class="dc-title">Sign a file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-cms-sign-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>openssl_cms_sign</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$input_filename</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$output_filename</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="class.opensslcertificate.php" class="type OpenSSLCertificate">OpenSSLCertificate</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$certificate</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><span class="type"><a href="class.opensslasymmetrickey.php" class="type OpenSSLAsymmetricKey">OpenSSLAsymmetricKey</a></span>|<span class="type"><a href="class.opensslcertificate.php" class="type OpenSSLCertificate">OpenSSLCertificate</a></span>|<span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$private_key</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.array.php" class="type array">array</a></span></span> <code class="parameter">$headers</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="openssl.constants.other.php#constant.openssl-encoding-smime">OPENSSL_ENCODING_SMIME</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$untrusted_certificates_filename</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.openssl-cms-sign-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      The key associated with <code class="parameter">certificate</code>.
      See <a href="openssl.certparams.php" class="link">Key/Certificate parameters</a> for a list of valid values.
     </p>
    </dd>
    ...
    <dd>
     <p class="para">
      Flags to be passed to <span class="function"><strong>cms_sign()</strong></span>.
     </p>
    </dd>
    ...
    <dd>
     <p class="para">
      The encoding of the output file. One of <strong><code><a href="openssl.constants.other.php#constant.openssl-encoding-smime">OPENSSL_ENCODING_SMIME</a></code></strong>,
 ...
 <div class="refsect1 examples" id="refsect1-function.openssl-cms-sign-examples">
  ...
  <p class="para">
   <div class="example" id="example-1012">
    <p><strong>Example #1 <span class="function"><strong>openssl_cms_sign()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />openssl_cms_sign</span><span style="color: #007700">(</span><span style="color: #DD0000">'input.txt'</span><span style="color: #007700">, </span><span style="color: #DD0000">'output.txt'</span><span style="color: #007700">, </span><span style="color: #DD0000">'file://cert.pem'</span><span style="color: #007700">, </span><span style="color: #DD0000">'file://privkey.pem'</span><span style="color: #007700">, </span><span style="color: #0000BB">null</span><span style="color: #007700">, </span><span style="color: #0000BB">OPENSSL_CMS_BINARY</span><span style="color: #007700">, </span><span style="color: #0000BB">OPENSSL_ENCODING_DER</span><span style="color: #007700">, </span><span style="color: #DD0000">'chain.pem'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-cms-sign.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-cms-sign%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-cms-sign&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-cms-sign.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126047">  <div class="votes">
    <div id="Vu126047">
    <a href="/manual/vote-note.php?id=126047&amp;page=function.openssl-cms-sign&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126047">
    <a href="/manual/vote-note.php?id=126047&amp;page=function.openssl-cms-sign&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126047" title="66% like this...">
    2
    </div>
  </div>
  <a href="#126047" class="name">
  <strong class="user"><em>miranda dot markmorgan at gmail dot com</em></strong></a><a class="genanchor" href="#126047"> &para;</a><div class="date" title="2021-05-01 11:30"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126047">
<div class="phpcode"><code><span class="html">Manage to make it work at last.<br /><br />$dn = array(<br />    "countryName" =&gt; "XX",<br />    "stateOrProvinceName" =&gt; "Location",<br />    "localityName" =&gt; "Local",<br />    "organizationName" =&gt; "Sample Organization",<br />    "organizationalUnitName" =&gt; "Organizational Unit",<br />    "commonName" =&gt; "Sample",<br />    "emailAddress" =&gt; "contactus@email.com"<br />);<br /><br />// Generate a new private (and public) key pair<br />$privkey = openssl_pkey_new(array(<br />    "private_key_bits" =&gt; 4096,<br />    "private_key_type" =&gt; OPENSSL_KEYTYPE_RSA,<br />));<br /><br />// Generate a certificate signing request<br />$csr = openssl_csr_new($dn, $privkey, array('digest_alg' =&gt; 'sha512'));<br /><br />// Generate a self-signed cert, valid for 365 days<br />$x509 = openssl_csr_sign($csr, null, $privkey, $days=365, array('digest_alg' =&gt; 'sha512'));<br /><br />// Save your private key, CSR and self-signed cert for later use<br />openssl_csr_export($csr, $csrout) and var_dump($csrout); // .csr<br />openssl_x509_export($x509, $certout) and var_dump($certout); // .crt.pem<br />openssl_pkey_export($privkey, $pkeyout, "user_defined_password") and var_dump($pkeyout); // .key.pem<br /><br />if(openssl_cms_sign ( "file_to_sign", "Sample.p7m" , $x509 , $privkey, null , 0 , 0 , null )){<br />    echo "SIGNED SUCCESSFULLY! Sample.p7m created... \r\n";<br />}<br />else<br />{<br />    echo "SIGNED FAILED!\r\n";<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-cms-sign&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-cms-sign.php">＋<small>add a note</small></a></div>
