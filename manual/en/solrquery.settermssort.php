...
<head>
  ...
  <title>PHP: SolrQuery::setTermsSort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.settermssort.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.settermssort.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermssort.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.settermsreturnraw.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.settermsupperbound.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermssort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.settermssort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.settermssort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.settermssort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.settermssort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.settermssort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.settermssort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.settermssort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.settermssort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.settermssort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.settermssort.php" hreflang="zh">
...
<meta name="Description" content="Specifies how to sort the returned terms" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setTermsSort - Manual" />
<meta name="twitter:description" content="Specifies how to sort the returned terms" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setTermsSort - Manual" />
<meta itemprop="description" content="Specifies how to sort the returned terms" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies how to sort the returned terms" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.settermsupperbound.php">
          SolrQuery::setTermsUpperBound &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.settermsreturnraw.php">
          &laquo; SolrQuery::setTermsReturnRaw        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.settermssort.php' selected="selected">English</option>
            <option value='de/solrquery.settermssort.php'>German</option>
            <option value='es/solrquery.settermssort.php'>Spanish</option>
            <option value='fr/solrquery.settermssort.php'>French</option>
            <option value='it/solrquery.settermssort.php'>Italian</option>
            <option value='ja/solrquery.settermssort.php'>Japanese</option>
            <option value='pt_BR/solrquery.settermssort.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.settermssort.php'>Russian</option>
            <option value='tr/solrquery.settermssort.php'>Turkish</option>
            <option value='uk/solrquery.settermssort.php'>Ukrainian</option>
            <option value='zh/solrquery.settermssort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.settermssort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setTermsSort</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setTermsSort</span> &mdash; <span class="dc-title">Specifies how to sort the returned terms</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.settermssort-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setTermsSort</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$sortType</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.settermssort-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">sortType</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.settermssort-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/settermssort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.settermssort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.settermssort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.settermssort.php">＋<small>add a note</small></a></span>
