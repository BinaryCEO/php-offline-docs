...
<head>
  ...
  <title>PHP: ReflectionClass::isTrait - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.istrait.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.istrait.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.istrait.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.issubclassof.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.isuninitializedlazyobject.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.istrait.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.istrait.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.istrait.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.istrait.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.istrait.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.istrait.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.istrait.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.istrait.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.istrait.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.istrait.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.istrait.php" hreflang="zh">
...
<meta name="Description" content="Returns whether this is a trait" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::isTrait - Manual" />
<meta name="twitter:description" content="Returns whether this is a trait" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::isTrait - Manual" />
<meta itemprop="description" content="Returns whether this is a trait" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns whether this is a trait" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.isuninitializedlazyobject.php">
          ReflectionClass::isUninitializedLazyObject &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.issubclassof.php">
          &laquo; ReflectionClass::isSubclassOf        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.istrait.php' selected="selected">English</option>
            <option value='de/reflectionclass.istrait.php'>German</option>
            <option value='es/reflectionclass.istrait.php'>Spanish</option>
            <option value='fr/reflectionclass.istrait.php'>French</option>
            <option value='it/reflectionclass.istrait.php'>Italian</option>
            <option value='ja/reflectionclass.istrait.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.istrait.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.istrait.php'>Russian</option>
            <option value='tr/reflectionclass.istrait.php'>Turkish</option>
            <option value='uk/reflectionclass.istrait.php'>Ukrainian</option>
            <option value='zh/reflectionclass.istrait.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.istrait" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::isTrait</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::isTrait</span> &mdash; <span class="dc-title">Returns whether this is a trait</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.istrait-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::isTrait</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Check whether this <span class="type"><a href="class.reflectionclass.php" class="type ReflectionClass">ReflectionClass</a></span> refers to a trait.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-reflectionclass.istrait-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.istrait-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if this is a trait, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/istrait.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.istrait%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.istrait&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.istrait.php">＋<small>add a note</small></a></span>
