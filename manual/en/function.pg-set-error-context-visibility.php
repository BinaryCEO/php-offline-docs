...
<head>
  ...
  <title>PHP: pg_set_error_context_visibility - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-set-error-context-visibility.php">
 <link rel="shorturl" href="https://www.php.net/pg-set-error-context-visibility">
 <link rel="alternate" href="https://www.php.net/pg-set-error-context-visibility" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-set-client-encoding.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-set-error-verbosity.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-set-error-context-visibility.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-set-error-context-visibility.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-set-error-context-visibility.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-set-error-context-visibility.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-set-error-context-visibility.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-set-error-context-visibility.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-set-error-context-visibility.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-set-error-context-visibility.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-set-error-context-visibility.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-set-error-context-visibility.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-set-error-context-visibility.php" hreflang="zh">
...
<meta name="Description" content="Determines the visibility of the context's error messages returned by pg_last_error
   and pg_result_error" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_set_error_context_visibility - Manual" />
<meta name="twitter:description" content="Determines the visibility of the context's error messages returned by pg_last_error
   and pg_result_error" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_set_error_context_visibility - Manual" />
<meta itemprop="description" content="Determines the visibility of the context's error messages returned by pg_last_error
   and pg_result_error" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Determines the visibility of the context's error messages returned by pg_last_error
   and pg_result_error" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-set-error-verbosity.php">
          pg_set_error_verbosity &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-set-client-encoding.php">
          &laquo; pg_set_client_encoding        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-set-error-context-visibility.php' selected="selected">English</option>
            <option value='de/function.pg-set-error-context-visibility.php'>German</option>
            <option value='es/function.pg-set-error-context-visibility.php'>Spanish</option>
            <option value='fr/function.pg-set-error-context-visibility.php'>French</option>
            <option value='it/function.pg-set-error-context-visibility.php'>Italian</option>
            <option value='ja/function.pg-set-error-context-visibility.php'>Japanese</option>
            <option value='pt_BR/function.pg-set-error-context-visibility.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-set-error-context-visibility.php'>Russian</option>
            <option value='tr/function.pg-set-error-context-visibility.php'>Turkish</option>
            <option value='uk/function.pg-set-error-context-visibility.php'>Ukrainian</option>
            <option value='zh/function.pg-set-error-context-visibility.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-set-error-context-visibility" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_set_error_context_visibility</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">pg_set_error_context_visibility</span> &mdash; <span class="dc-title">
   Determines the visibility of the context&#039;s error messages returned by <span class="function"><a href="function.pg-last-error.php" class="function">pg_last_error()</a></span>
   and <span class="function"><a href="function.pg-result-error.php" class="function">pg_result_error()</a></span>
  </span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-set-error-context-visibility-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_set_error_context_visibility</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$visibility</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.pg-set-error-context-visibility-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">visibility</code></dt>
     <dd>
      <p class="para">
       The required visibility: <strong><code><a href="pgsql.constants.php#constant.pgsql-show-context-never">PGSQL_SHOW_CONTEXT_NEVER</a></code></strong>,
       <strong><code><a href="pgsql.constants.php#constant.pgsql-show-context-errors">PGSQL_SHOW_CONTEXT_ERRORS</a></code></strong>
       or <strong><code><a href="pgsql.constants.php#constant.pgsql-show-context-always">PGSQL_SHOW_CONTEXT_ALWAYS</a></code></strong>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-set-error-context-visibility-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The previous visibility level: <strong><code><a href="pgsql.constants.php#constant.pgsql-show-context-never">PGSQL_SHOW_CONTEXT_NEVER</a></code></strong>,
   <strong><code><a href="pgsql.constants.php#constant.pgsql-show-context-errors">PGSQL_SHOW_CONTEXT_ERRORS</a></code></strong>
   or <strong><code><a href="pgsql.constants.php#constant.pgsql-show-context-always">PGSQL_SHOW_CONTEXT_ALWAYS</a></code></strong>.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />  $dbconn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=publisher"</span><span style="color: #007700">) or die(</span><span style="color: #DD0000">"Could not connect"</span><span style="color: #007700">);<br /><br />  if (!</span><span style="color: #0000BB">pg_connection_busy</span><span style="color: #007700">(</span><span style="color: #0000BB">$dbconn</span><span style="color: #007700">)) {<br />      </span><span style="color: #0000BB">pg_send_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$dbconn</span><span style="color: #007700">, </span><span style="color: #DD0000">"select * from doesnotexist;"</span><span style="color: #007700">);<br />  }<br /><br />  </span><span style="color: #0000BB">pg_set_error_context_visibility</span><span style="color: #007700">(</span><span style="color: #0000BB">$dbconn</span><span style="color: #007700">, </span><span style="color: #0000BB">PGSQL_SHOW_CONTEXT_ALWAYS</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">$res1 </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_get_result</span><span style="color: #007700">(</span><span style="color: #0000BB">$dbconn</span><span style="color: #007700">);<br />  echo </span><span style="color: #0000BB">pg_result_error</span><span style="color: #007700">(</span><span style="color: #0000BB">$res1</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-set-error-context-visibility-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-result-error.php" class="function" rel="rdfs-seeAlso">pg_result_error()</a> - Get error message associated with result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-set-error-context-visibility.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-set-error-context-visibility%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-set-error-context-visibility&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-set-error-context-visibility.php">＋<small>add a note</small></a></span>
