...
<head>
  ...
  <title>PHP: ZipArchive::setEncryptionIndex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.setencryptionindex.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.setencryptionindex.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setencryptionindex.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.setcompressionname.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.setencryptionname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setencryptionindex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.setencryptionindex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.setencryptionindex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.setencryptionindex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.setencryptionindex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.setencryptionindex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.setencryptionindex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.setencryptionindex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.setencryptionindex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.setencryptionindex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.setencryptionindex.php" hreflang="zh">
...
<meta name="Description" content="Set the encryption method of an entry defined by its index" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::setEncryptionIndex - Manual" />
<meta name="twitter:description" content="Set the encryption method of an entry defined by its index" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::setEncryptionIndex - Manual" />
<meta itemprop="description" content="Set the encryption method of an entry defined by its index" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the encryption method of an entry defined by its index" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.setencryptionname.php">
          ZipArchive::setEncryptionName &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.setcompressionname.php">
          &laquo; ZipArchive::setCompressionName        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.setencryptionindex.php' selected="selected">English</option>
            <option value='de/ziparchive.setencryptionindex.php'>German</option>
            <option value='es/ziparchive.setencryptionindex.php'>Spanish</option>
            <option value='fr/ziparchive.setencryptionindex.php'>French</option>
            <option value='it/ziparchive.setencryptionindex.php'>Italian</option>
            <option value='ja/ziparchive.setencryptionindex.php'>Japanese</option>
            <option value='pt_BR/ziparchive.setencryptionindex.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.setencryptionindex.php'>Russian</option>
            <option value='tr/ziparchive.setencryptionindex.php'>Turkish</option>
            <option value='uk/ziparchive.setencryptionindex.php'>Ukrainian</option>
            <option value='zh/ziparchive.setencryptionindex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.setencryptionindex" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="ziparchive.setencryptionname.php" class="methodname" rel="rdfs-seeAlso">ZipArchive::setEncryptionName()</a> - Set the encryption method of an entry defined by its name</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/setencryptionindex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.setencryptionindex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.setencryptionindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.setencryptionindex.php">＋<small>add a note</small></a></span>
