...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.finfo-open.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.finfo-file.php">
 <link rel="next" href="https://www.php.net/manual/en/function.finfo-set-flags.php">
...
<meta name="Description" content="Create a new finfo instance" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: finfo_open - Manual" />
<meta name="twitter:description" content="Create a new finfo instance" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: finfo_open - Manual" />
<meta itemprop="description" content="Create a new finfo instance" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a new finfo instance" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.finfo-open.php' selected="selected">English</option>
            <option value='de/function.finfo-open.php'>German</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.finfo-close.php" class="function" rel="rdfs-seeAlso">finfo_close()</a> - Close finfo instance</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fileinfo/functions/finfo-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.finfo-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.finfo-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.finfo-open.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">For most common image files:<br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">minimime</span><span class="keyword">(</span><span class="default">$fname</span><span class="keyword">) {<br />    </span><span class="default">$fh</span><span class="keyword">=</span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$fname</span><span class="keyword">,</span><span class="string">'rb'</span><span class="keyword">);<br />    if (</span><span class="default">$fh</span><span class="keyword">) { <br />        </span><span class="default">$bytes6</span><span class="keyword">=</span><span class="default">fread</span><span class="keyword">(</span><span class="default">$fh</span><span class="keyword">,</span><span class="default">6</span><span class="keyword">);<br />        </span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$fh</span><span class="keyword">); <br />        if (</span><span class="default">$bytes6</span><span class="keyword">===</span><span class="default">false</span><span class="keyword">) return </span><span class="default">false</span><span class="keyword">;<br />        if (</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$bytes6</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">3</span><span class="keyword">)==</span><span class="string">"\xff\xd8\xff"</span><span class="keyword">) return </span><span class="string">'image/jpeg'</span><span class="keyword">;<br />        if (</span><span class="default">$bytes6</span><span class="keyword">==</span><span class="string">"\x89PNG\x0d\x0a"</span><span class="keyword">) return </span><span class="string">'image/png'</span><span class="keyword">;<br />        if (</span><span class="default">$bytes6</span><span class="keyword">==</span><span class="string">"GIF87a" </span><span class="keyword">|| </span><span class="default">$bytes6</span><span class="keyword">==</span><span class="string">"GIF89a"</span><span class="keyword">) return </span><span class="string">'image/gif'</span><span class="keyword">;<br />        return </span><span class="string">'application/octet-stream'</span><span class="keyword">;<br />    }<br />    return </span><span class="default">false</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">On my Debian squeeze system, the path needed is like :<br /><span class="default">&lt;?php <br /> $finfo </span><span class="keyword">= new </span><span class="default">finfo</span><span class="keyword">(</span><span class="default">FILEINFO_MIME</span><span class="keyword">, </span><span class="string">"/usr/share/misc/magic.mgc"</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Since it costed me some time to find the needed magic database files for Windows, just a hint:<br /><br />The last release of the GnuWin32 project with both needed files (magic and magic.mime) currently was "file-4.23".<br />All releases after 4.23 to 4.25-1 did not contain both needed files.<br /><br />Hope that helps.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>php at kingsquare dot nl</em></strong></a><a class="genanchor" href="#80583"> &para;</a><div class="date" title="2008-01-23 07:41"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom80583">
<div class="phpcode"><code><span class="html">The current version (1.04) doesnt support a different mime.magic database than the server default.<br /><br />(the documentation is thus not correct)<br />Ubuntu default location is '/usr/share/file/magic'. In order for the examples to work all finfo_open()-commands must be issued with the extra location accordingly:<br /><span class="default">&lt;?php<br />$file </span><span class="keyword">= </span><span class="string">"/path/to/file.jpg"</span><span class="keyword">;<br /></span><span class="default">$handle </span><span class="keyword">= </span><span class="default">finfo_open</span><span class="keyword">(</span><span class="default">FILEINFO_MIME</span><span class="keyword">, </span><span class="string">'/usr/share/file/magic'</span><span class="keyword">);<br /></span><span class="default">$mime_type </span><span class="keyword">= </span><span class="default">finfo_file</span><span class="keyword">(</span><span class="default">$handle</span><span class="keyword">,</span><span class="default">$file</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>ian at createanet dot co dot uk</em></strong></a><a class="genanchor" href="#78927"> &para;</a><div class="date" title="2007-11-02 08:50"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom78927">
<div class="phpcode"><code><span class="html">Couldn't get finfo to return the mimetype in the way expected so i made a function to do it with system()<br /><br /><span class="default">&lt;?php <br /></span><span class="keyword">function </span><span class="default">get_mime_type</span><span class="keyword">(</span><span class="default">$filepath</span><span class="keyword">) {<br />    </span><span class="default">ob_start</span><span class="keyword">();<br />    </span><span class="default">system</span><span class="keyword">(</span><span class="string">"file -i -b </span><span class="keyword">{</span><span class="default">$filepath</span><span class="keyword">}</span><span class="string">"</span><span class="keyword">);<br />    </span><span class="default">$output </span><span class="keyword">= </span><span class="default">ob_get_clean</span><span class="keyword">();<br />    </span><span class="default">$output </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">(</span><span class="string">"; "</span><span class="keyword">,</span><span class="default">$output</span><span class="keyword">);<br />    if ( </span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$output</span><span class="keyword">) ) {<br />        </span><span class="default">$output </span><span class="keyword">= </span><span class="default">$output</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">];<br />    }<br />    return </span><span class="default">$output</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />hope it works for other people too</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>mark at dynom dot nl</em></strong></a><a class="genanchor" href="#86897"> &para;</a><div class="date" title="2008-11-09 12:34"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86897">
<div class="phpcode"><code><span class="html">It seems there is quite some inconsistency in distributions and loading of magic files.<br /><br />On Archlinux, the file is located here:<br />/usr/share/misc/file/magic.mgc<br /><br />But this:<br /><br /><span class="default">&lt;?php<br />$fi </span><span class="keyword">= new </span><span class="default">finfo</span><span class="keyword">(</span><span class="default">FILEINFO_MIME</span><span class="keyword">, </span><span class="string">'/usr/share/misc/file/magic'</span><span class="keyword">);<br /></span><span class="default">$fi</span><span class="keyword">-&gt;</span><span class="default">file</span><span class="keyword">(</span><span class="string">'/tmp/fubar.txt'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Actually segfaults, where if I type the full name (including the file extension:)<br /><br /><span class="default">&lt;?php<br />$fi </span><span class="keyword">= new </span><span class="default">finfo</span><span class="keyword">(</span><span class="default">FILEINFO_MIME</span><span class="keyword">, </span><span class="string">'/usr/share/misc/file/magic.mgc'</span><span class="keyword">); </span><span class="comment">// added ".mgc"<br /></span><span class="default">$fi</span><span class="keyword">-&gt;</span><span class="default">file</span><span class="keyword">(</span><span class="string">'/tmp/fubar.txt'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />It works as expected, so I guess something goes wrong with "A .mime and/or .mgc suffix is added if needed."</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">On Windows systems people might find that this always returns "application/x-dpkg".<br />There are 2 ways of solving this problem:<br />1. Get the mime-magic database file from GnuWin32 at &lt;<a href="http://sourceforge.net/projects/gnuwin32/&gt;" rel="nofollow" target="_blank">http://sourceforge.net/projects/gnuwin32/&gt;</a><br />2. You can manually "fix" the mime-magic file by editing it and escaping all lines starting with !, thus changing each one to \!</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.finfo-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.finfo-open.php">＋<small>add a note</small></a></div>
