...
<head>
  ...
  <title>PHP: SolrQuery::setMltMinDocFrequency - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setmltmindocfrequency.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setmltmindocfrequency.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltmindocfrequency.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setmltmaxwordlength.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setmltmintermfrequency.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltmindocfrequency.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setmltmindocfrequency.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setmltmindocfrequency.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setmltmindocfrequency.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setmltmindocfrequency.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setmltmindocfrequency.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setmltmindocfrequency.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setmltmindocfrequency.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setmltmindocfrequency.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setmltmindocfrequency.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setmltmindocfrequency.php" hreflang="zh">
...
<meta name="Description" content="Sets the mltMinDoc frequency" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setMltMinDocFrequency - Manual" />
<meta name="twitter:description" content="Sets the mltMinDoc frequency" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setMltMinDocFrequency - Manual" />
<meta itemprop="description" content="Sets the mltMinDoc frequency" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the mltMinDoc frequency" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setmltmintermfrequency.php">
          SolrQuery::setMltMinTermFrequency &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setmltmaxwordlength.php">
          &laquo; SolrQuery::setMltMaxWordLength        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setmltmindocfrequency.php' selected="selected">English</option>
            <option value='de/solrquery.setmltmindocfrequency.php'>German</option>
            <option value='es/solrquery.setmltmindocfrequency.php'>Spanish</option>
            <option value='fr/solrquery.setmltmindocfrequency.php'>French</option>
            <option value='it/solrquery.setmltmindocfrequency.php'>Italian</option>
            <option value='ja/solrquery.setmltmindocfrequency.php'>Japanese</option>
            <option value='pt_BR/solrquery.setmltmindocfrequency.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setmltmindocfrequency.php'>Russian</option>
            <option value='tr/solrquery.setmltmindocfrequency.php'>Turkish</option>
            <option value='uk/solrquery.setmltmindocfrequency.php'>Ukrainian</option>
            <option value='zh/solrquery.setmltmindocfrequency.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setmltmindocfrequency" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setMltMinDocFrequency</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setMltMinDocFrequency</span> &mdash; <span class="dc-title">Sets the mltMinDoc frequency</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setmltmindocfrequency-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setMltMinDocFrequency</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$minDocFrequency</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setmltmindocfrequency-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">minDocFrequency</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setmltmindocfrequency-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setmltmindocfrequency.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setmltmindocfrequency%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setmltmindocfrequency&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setmltmindocfrequency.php">＋<small>add a note</small></a></span>
