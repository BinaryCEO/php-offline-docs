...
<head>
  ...
  <title>PHP: gettimeofday - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gettimeofday.php">
 <link rel="shorturl" href="https://www.php.net/gettimeofday">
 <link rel="alternate" href="https://www.php.net/gettimeofday" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.getdate.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmdate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gettimeofday.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gettimeofday.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gettimeofday.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gettimeofday.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gettimeofday.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gettimeofday.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gettimeofday.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gettimeofday.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gettimeofday.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gettimeofday.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gettimeofday.php" hreflang="zh">
...
<meta name="Description" content="Get current time" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gettimeofday - Manual" />
<meta name="twitter:description" content="Get current time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gettimeofday - Manual" />
<meta itemprop="description" content="Get current time" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get current time" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gettimeofday.php' selected="selected">English</option>
            <option value='de/function.gettimeofday.php'>German</option>
            <option value='es/function.gettimeofday.php'>Spanish</option>
            <option value='fr/function.gettimeofday.php'>French</option>
            <option value='it/function.gettimeofday.php'>Italian</option>
            <option value='ja/function.gettimeofday.php'>Japanese</option>
            <option value='pt_BR/function.gettimeofday.php'>Brazilian Portuguese</option>
            <option value='ru/function.gettimeofday.php'>Russian</option>
            <option value='tr/function.gettimeofday.php'>Turkish</option>
            <option value='uk/function.gettimeofday.php'>Ukrainian</option>
            <option value='zh/function.gettimeofday.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gettimeofday" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gettimeofday</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gettimeofday</span> &mdash; <span class="dc-title">Get current time</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gettimeofday-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       When set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, a float instead of an array is returned.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gettimeofday-returnvalues">
  ...
  <p class="para">
   By default an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> is returned. If <code class="parameter">as_float</code>
   is set, then a <span class="type"><a href="language.types.float.php" class="type float">float</a></span> is returned.
  </p>
  <p class="para">
   Array keys:
 ...
 <div class="refsect1 examples" id="refsect1-function.gettimeofday-examples">
  ...
  <p class="para">
   <div class="example" id="example-2292">
    <p><strong>Example #1 <span class="function"><strong>gettimeofday()</strong></span> example</strong></p>
...
1073504408.23910</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/gettimeofday.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gettimeofday%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gettimeofday&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gettimeofday.php">＋<small>add a note</small></a></span>
