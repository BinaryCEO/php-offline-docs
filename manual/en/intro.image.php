...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.image.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.image.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.image.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.image.php">
 <link rel="next" href="https://www.php.net/manual/en/image.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.image.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.image.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.image.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.image.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.image.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.image.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.image.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.image.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.image.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.image.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.image.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.image.php' selected="selected">English</option>
            <option value='de/intro.image.php'>German</option>
            <option value='es/intro.image.php'>Spanish</option>
            <option value='fr/intro.image.php'>French</option>
            <option value='it/intro.image.php'>Italian</option>
            <option value='ja/intro.image.php'>Japanese</option>
            <option value='pt_BR/intro.image.php'>Brazilian Portuguese</option>
            <option value='ru/intro.image.php'>Russian</option>
            <option value='tr/intro.image.php'>Turkish</option>
            <option value='uk/intro.image.php'>Ukrainian</option>
            <option value='zh/intro.image.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.image" class="preface">
  ...
  <p class="para">
   ...
   about compiling support for one or more formats, see the installation chapter.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.image%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.image&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.image.php">＋<small>add a note</small></a></span>
