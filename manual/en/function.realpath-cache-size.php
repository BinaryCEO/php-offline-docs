...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.realpath-cache-size.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.realpath-cache-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rename.php">
...
<meta name="Description" content="Get realpath cache size" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: realpath_cache_size - Manual" />
<meta name="twitter:description" content="Get realpath cache size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: realpath_cache_size - Manual" />
<meta itemprop="description" content="Get realpath cache size" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get realpath cache size" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.realpath-cache-size.php' selected="selected">English</option>
            ...
            <option value='zh/function.realpath-cache-size.php'>Chinese (Simplified)</option>
    ...
    <li>
     ...
     configuration option
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/realpath-cache-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.realpath-cache-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.realpath-cache-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.realpath-cache-size.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">"realpath_cache_size" is used by PHP to cache the real file system paths of filenames referenced instead of looking them up each time.  Every time you perform any of the various file functions or include/require a file and use a relative path, PHP has to look up where that file really exists. PHP caches those values so it doesn’t have to search the current working directory and include_path for the file you are working on.
<br />If your website uses lots of relative path files, think about increasing this value.  What value is required can be better estimated after monitoring by how fast the cache fills using realpath_cache_size() after restarting. Its contents can be viewed using realpath_cache_get().</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>superaap at gmail dot com</em></strong></a><a class="genanchor" href="#100770"> &para;</a><div class="date" title="2010-11-05 07:41"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom100770">
<div class="phpcode"><code><span class="html">Note that the realpath cache is not used if either safe_mode is on or an open_basedir restriction is in effect.<br />This is having a huge performance effect, causing lots of calls to lstat.<br /><br />A bugreport has already been filed at <a href="http://bugs.php.net/bug.php?id=52312" rel="nofollow" target="_blank">http://bugs.php.net/bug.php?id=52312</a></span></code></div>
  </div>
 </div>
  <div class="note" id="116625">  <div class="votes">
    ...
    <div class="tally" id="V116625" title="50% like this...">
    0
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Realpath_cache_size default parameter settings are too low (16k).<br />In the windows and Polish language assessed following be at least a 32k or 64k.<br />otherwise appache sometimes locks up (especially when using IE).</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.realpath-cache-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.realpath-cache-size.php">＋<small>add a note</small></a></div>
