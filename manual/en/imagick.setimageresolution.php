...
<head>
  ...
  <title>PHP: Imagick::setImageResolution - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageresolution.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageresolution.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageresolution.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagerenderingintent.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagescene.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageresolution.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageresolution.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageresolution.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageresolution.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageresolution.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageresolution.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageresolution.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageresolution.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageresolution.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageresolution.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageresolution.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::setImageResolution - Manual" />
<meta name="twitter:description" content="Sets the image resolution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageResolution - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimagescene.php">
          Imagick::setImageScene &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagerenderingintent.php">
          &laquo; Imagick::setImageRenderingIntent        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageresolution.php' selected="selected">English</option>
            <option value='de/imagick.setimageresolution.php'>German</option>
            <option value='es/imagick.setimageresolution.php'>Spanish</option>
            <option value='fr/imagick.setimageresolution.php'>French</option>
            <option value='it/imagick.setimageresolution.php'>Italian</option>
            <option value='ja/imagick.setimageresolution.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageresolution.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageresolution.php'>Russian</option>
            <option value='tr/imagick.setimageresolution.php'>Turkish</option>
            <option value='uk/imagick.setimageresolution.php'>Ukrainian</option>
            <option value='zh/imagick.setimageresolution.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageresolution" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageResolution</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageResolution</span> &mdash; <span class="dc-title">Sets the image resolution</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimageresolution-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageResolution</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x_resolution</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y_resolution</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageresolution-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageresolution-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimageresolution-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.setimageresolution-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3101">
      <p><strong>Example #1  <span class="function"><strong>Imagick::setImageResolution()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageresolution.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageresolution%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageresolution&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageresolution.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96182">  <div class="votes">
    <div id="Vu96182">
    <a href="/manual/vote-note.php?id=96182&amp;page=imagick.setimageresolution&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96182">
    <a href="/manual/vote-note.php?id=96182&amp;page=imagick.setimageresolution&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96182" title="54% like this...">
    2
    </div>
  </div>
  <a href="#96182" class="name">
  <strong class="user"><em>craig dot fairhurst at nospamyouds dot com</em></strong></a><a class="genanchor" href="#96182"> &para;</a><div class="date" title="2010-02-12 10:12"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96182">
<div class="phpcode"><code><span class="html">Note that any changes to the resolution (-density option) must be made before specifying the file, so construct the object with no file path and then use $object-&gt;readImage('path/to/file'); otherwise the density won't change. <br />Also see Imagick::setResolution.</span></code></div>
  </div>
 </div>
  <div class="note" id="92288">  <div class="votes">
    <div id="Vu92288">
    <a href="/manual/vote-note.php?id=92288&amp;page=imagick.setimageresolution&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92288">
    <a href="/manual/vote-note.php?id=92288&amp;page=imagick.setimageresolution&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92288" title="28% like this...">
    -3
    </div>
  </div>
  <a href="#92288" class="name">
  <strong class="user"><em>octave at web dot de</em></strong></a><a class="genanchor" href="#92288"> &para;</a><div class="date" title="2009-07-17 09:27"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92288">
<div class="phpcode"><code><span class="html">This method uses the ImageMagick "-density {$x_resolution}x{$y_resolution}" parameter</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimageresolution&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageresolution.php">＋<small>add a note</small></a></div>
