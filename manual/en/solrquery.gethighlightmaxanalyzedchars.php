...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightMaxAnalyzedChars - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightmaxanalyzedchars.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightmaxanalyzedchars.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightmaxanalyzedchars.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightmaxalternatefieldlength.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightmergecontiguous.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightmaxanalyzedchars.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightmaxanalyzedchars.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightmaxanalyzedchars.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightmaxanalyzedchars.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightmaxanalyzedchars.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightmaxanalyzedchars.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightmaxanalyzedchars.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightmaxanalyzedchars.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightmaxanalyzedchars.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightmaxanalyzedchars.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightmaxanalyzedchars.php" hreflang="zh">
...
<meta name="Description" content="Returns the maximum number of characters into a document to look for suitable snippets" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightMaxAnalyzedChars - Manual" />
<meta name="twitter:description" content="Returns the maximum number of characters into a document to look for suitable snippets" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightMaxAnalyzedChars - Manual" />
<meta itemprop="description" content="Returns the maximum number of characters into a document to look for suitable snippets" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the maximum number of characters into a document to look for suitable snippets" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.gethighlightmergecontiguous.php">
          SolrQuery::getHighlightMergeContiguous &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightmaxalternatefieldlength.php">
          &laquo; SolrQuery::getHighlightMaxAlternateFieldLength        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightmaxanalyzedchars.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightmaxanalyzedchars.php'>German</option>
            <option value='es/solrquery.gethighlightmaxanalyzedchars.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightmaxanalyzedchars.php'>French</option>
            <option value='it/solrquery.gethighlightmaxanalyzedchars.php'>Italian</option>
            <option value='ja/solrquery.gethighlightmaxanalyzedchars.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightmaxanalyzedchars.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightmaxanalyzedchars.php'>Russian</option>
            <option value='tr/solrquery.gethighlightmaxanalyzedchars.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightmaxanalyzedchars.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightmaxanalyzedchars.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightmaxanalyzedchars" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightMaxAnalyzedChars</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightMaxAnalyzedChars</span> &mdash; <span class="dc-title">Returns the maximum number of characters into a document to look for suitable snippets</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightmaxanalyzedchars-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightMaxAnalyzedChars</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightmaxanalyzedchars-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightmaxanalyzedchars-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightmaxanalyzedchars.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightmaxanalyzedchars%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightmaxanalyzedchars&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightmaxanalyzedchars.php">＋<small>add a note</small></a></span>
