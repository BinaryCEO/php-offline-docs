...
<head>
  ...
  <title>PHP: pg_lo_read - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-lo-read.php">
 <link rel="shorturl" href="https://www.php.net/pg-lo-read">
 <link rel="alternate" href="https://www.php.net/pg-lo-read" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-lo-open.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-lo-read-all.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-lo-read.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-lo-read.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-lo-read.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-lo-read.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-lo-read.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-lo-read.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-lo-read.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-lo-read.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-lo-read.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-lo-read.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-lo-read.php" hreflang="zh">
...
<meta name="Description" content="Read a large object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_lo_read - Manual" />
<meta name="twitter:description" content="Read a large object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_lo_read - Manual" />
<meta itemprop="description" content="Read a large object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Read a large object" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-lo-read.php' selected="selected">English</option>
            <option value='de/function.pg-lo-read.php'>German</option>
            <option value='es/function.pg-lo-read.php'>Spanish</option>
            <option value='fr/function.pg-lo-read.php'>French</option>
            <option value='it/function.pg-lo-read.php'>Italian</option>
            <option value='ja/function.pg-lo-read.php'>Japanese</option>
            <option value='pt_BR/function.pg-lo-read.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-lo-read.php'>Russian</option>
            <option value='tr/function.pg-lo-read.php'>Turkish</option>
            <option value='uk/function.pg-lo-read.php'>Ukrainian</option>
            <option value='zh/function.pg-lo-read.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-lo-read" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.pg-lo-read-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_lo_read</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-lob.php" class="type PgSql\Lob">PgSql\Lob</a></span> <code class="parameter">$lob</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code><span class="initializer"> = 8192</span></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   returns it as a <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.
  </p>
  <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-lo-read-returnvalues">
  ...
  <p class="para">
   A <span class="type"><a href="language.types.string.php" class="type string">string</a></span> containing <code class="parameter">length</code> bytes from the
   large object, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />   $doc_oid </span><span style="color: #007700">= </span><span style="color: #0000BB">189762345</span><span style="color: #007700">;<br />   </span><span style="color: #0000BB">$database </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=jacarta"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #DD0000">"begin"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">$handle </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_lo_open</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #0000BB">$doc_oid</span><span style="color: #007700">, </span><span style="color: #DD0000">"r"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">$data </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_lo_read</span><span style="color: #007700">(</span><span style="color: #0000BB">$handle</span><span style="color: #007700">, </span><span style="color: #0000BB">50000</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #DD0000">"commit"</span><span style="color: #007700">);<br />   echo </span><span style="color: #0000BB">$data</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-lo-read-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-lo-read-all.php" class="function" rel="rdfs-seeAlso">pg_lo_read_all()</a> - Reads an entire large object and send straight to browser</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-lo-read.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-lo-read%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-lo-read&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-read.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="105486">  <div class="votes">
    <div id="Vu105486">
    <a href="/manual/vote-note.php?id=105486&amp;page=function.pg-lo-read&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105486">
    <a href="/manual/vote-note.php?id=105486&amp;page=function.pg-lo-read&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105486" title="0% like this...">
    -4
    </div>
  </div>
  <a href="#105486" class="name">
  <strong class="user"><em>bobahspb at gmail dot com</em></strong></a><a class="genanchor" href="#105486"> &para;</a><div class="date" title="2011-08-22 03:43"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105486">
<div class="phpcode"><code><span class="html">Be careful: pg_lo_export() create empty file without "begin"/"end".<br />See docs: "...it is necessary to enclose it within a transaction block..."</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-lo-read&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-read.php">＋<small>add a note</small></a></div>
