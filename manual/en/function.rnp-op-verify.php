...
<head>
  ...
  <title>PHP: rnp_op_verify - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rnp-op-verify.php">
 <link rel="shorturl" href="https://www.php.net/rnp-op-verify">
 <link rel="alternate" href="https://www.php.net/rnp-op-verify" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.rnp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.rnp-op-sign-detached.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rnp-op-verify-detached.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rnp-op-verify.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rnp-op-verify.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rnp-op-verify.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rnp-op-verify.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rnp-op-verify.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rnp-op-verify.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rnp-op-verify.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rnp-op-verify.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rnp-op-verify.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rnp-op-verify.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rnp-op-verify.php" hreflang="zh">
...
<meta name="Description" content="Verify embedded or cleartext signatures" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rnp_op_verify - Manual" />
<meta name="twitter:description" content="Verify embedded or cleartext signatures" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rnp_op_verify - Manual" />
<meta itemprop="description" content="Verify embedded or cleartext signatures" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Verify embedded or cleartext signatures" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.rnp-op-verify-detached.php">
          rnp_op_verify_detached &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.rnp-op-sign-detached.php">
          &laquo; rnp_op_sign_detached        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rnp-op-verify.php' selected="selected">English</option>
            <option value='de/function.rnp-op-verify.php'>German</option>
            <option value='es/function.rnp-op-verify.php'>Spanish</option>
            <option value='fr/function.rnp-op-verify.php'>French</option>
            <option value='it/function.rnp-op-verify.php'>Italian</option>
            <option value='ja/function.rnp-op-verify.php'>Japanese</option>
            <option value='pt_BR/function.rnp-op-verify.php'>Brazilian Portuguese</option>
            <option value='ru/function.rnp-op-verify.php'>Russian</option>
            <option value='tr/function.rnp-op-verify.php'>Turkish</option>
            <option value='uk/function.rnp-op-verify.php'>Ukrainian</option>
            <option value='zh/function.rnp-op-verify.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rnp-op-verify" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">rnp_op_verify</h1>
  <p class="verinfo">(PECL rnp &gt;= 0.1.1)</p><p class="refpurpose"><span class="refname">rnp_op_verify</span> &mdash; <span class="dc-title">Verify embedded or cleartext signatures</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.rnp-op-verify-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>rnp_op_verify</strong></span>(<span class="methodparam"><span class="type"><a href="class.rnpffi.php" class="type RnpFFI">RnpFFI</a></span> <code class="parameter">$ffi</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.rnp-op-verify-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.rnp-op-verify-returnvalues">
    ...
    <tbody class="tbody">
     ...
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/functions/rnp-op-verify.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rnp-op-verify%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rnp-op-verify&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rnp-op-verify.php">＋<small>add a note</small></a></span>
