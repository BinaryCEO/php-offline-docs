...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openal-context-current.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.openal-context-create.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openal-context-destroy.php">
...
<meta name="Description" content="Make the specified context current" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openal_context_current - Manual" />
<meta name="twitter:description" content="Make the specified context current" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openal_context_current - Manual" />
<meta itemprop="description" content="Make the specified context current" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Make the specified context current" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openal-context-current.php' selected="selected">English</option>
            <option value='de/function.openal-context-current.php'>German</option>
            <option value='es/function.openal-context-current.php'>Spanish</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.openal-context-create.php" class="function" rel="rdfs-seeAlso">openal_context_create()</a> - Create an audio processing context</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openal/functions/openal-context-current.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openal-context-current%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openal-context-current&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openal-context-current.php">＋<small>add a note</small></a></span>
