...
<head>
  ...
  <title>PHP: Gmagick::getimagegreenprimary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagegreenprimary.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagegreenprimary.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagegreenprimary.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagegamma.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimageheight.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagegreenprimary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagegreenprimary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagegreenprimary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagegreenprimary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagegreenprimary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagegreenprimary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagegreenprimary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagegreenprimary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagegreenprimary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagegreenprimary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagegreenprimary.php" hreflang="zh">
...
<meta name="Description" content="Returns the chromaticy green primary point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::getimagegreenprimary - Manual" />
<meta name="twitter:description" content="Returns the chromaticy green primary point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagegreenprimary - Manual" />
<meta itemprop="description" content="Returns the chromaticy green primary point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the chromaticy green primary point" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimageheight.php">
          Gmagick::getimageheight &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagegamma.php">
          &laquo; Gmagick::getimagegamma        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagegreenprimary.php' selected="selected">English</option>
            <option value='de/gmagick.getimagegreenprimary.php'>German</option>
            <option value='es/gmagick.getimagegreenprimary.php'>Spanish</option>
            <option value='fr/gmagick.getimagegreenprimary.php'>French</option>
            <option value='it/gmagick.getimagegreenprimary.php'>Italian</option>
            <option value='ja/gmagick.getimagegreenprimary.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagegreenprimary.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagegreenprimary.php'>Russian</option>
            <option value='tr/gmagick.getimagegreenprimary.php'>Turkish</option>
            <option value='uk/gmagick.getimagegreenprimary.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagegreenprimary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagegreenprimary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagegreenprimary</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagegreenprimary</span> &mdash; <span class="dc-title">Returns the chromaticy green primary point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagegreenprimary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagegreenprimary</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagegreenprimary-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagegreenprimary-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagegreenprimary-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagegreenprimary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagegreenprimary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagegreenprimary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagegreenprimary.php">＋<small>add a note</small></a></span>
