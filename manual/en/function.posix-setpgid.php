...
<head>
  ...
  <title>PHP: posix_setpgid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-setpgid.php">
 <link rel="shorturl" href="https://www.php.net/posix-setpgid">
 <link rel="alternate" href="https://www.php.net/posix-setpgid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-setgid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-setrlimit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-setpgid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-setpgid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-setpgid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-setpgid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-setpgid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-setpgid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-setpgid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-setpgid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-setpgid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-setpgid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-setpgid.php" hreflang="zh">
...
<meta name="Description" content="Set process group id for job control" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_setpgid - Manual" />
<meta name="twitter:description" content="Set process group id for job control" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_setpgid - Manual" />
<meta itemprop="description" content="Set process group id for job control" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set process group id for job control" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.posix-setrlimit.php">
          posix_setrlimit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.posix-setgid.php">
          &laquo; posix_setgid        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-setpgid.php' selected="selected">English</option>
            <option value='de/function.posix-setpgid.php'>German</option>
            <option value='es/function.posix-setpgid.php'>Spanish</option>
            <option value='fr/function.posix-setpgid.php'>French</option>
            <option value='it/function.posix-setpgid.php'>Italian</option>
            <option value='ja/function.posix-setpgid.php'>Japanese</option>
            <option value='pt_BR/function.posix-setpgid.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-setpgid.php'>Russian</option>
            <option value='tr/function.posix-setpgid.php'>Turkish</option>
            <option value='uk/function.posix-setpgid.php'>Ukrainian</option>
            <option value='zh/function.posix-setpgid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-setpgid" class="refentry">
    ...
    <li>
     ...
     information on process groups and job control.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-setpgid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-setpgid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-setpgid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-setpgid.php">＋<small>add a note</small></a></span>
