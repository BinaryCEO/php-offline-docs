...
<head>
  ...
  <title>PHP: SolrQuery::getFacetDateOther - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfacetdateother.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfacetdateother.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetdateother.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfacetdatehardend.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfacetdatestart.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetdateother.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfacetdateother.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfacetdateother.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfacetdateother.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfacetdateother.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfacetdateother.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfacetdateother.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfacetdateother.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfacetdateother.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfacetdateother.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfacetdateother.php" hreflang="zh">
...
<meta name="Description" content="Returns the value for the facet.date.other parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFacetDateOther - Manual" />
<meta name="twitter:description" content="Returns the value for the facet.date.other parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFacetDateOther - Manual" />
<meta itemprop="description" content="Returns the value for the facet.date.other parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the value for the facet.date.other parameter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getfacetdatestart.php">
          SolrQuery::getFacetDateStart &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfacetdatehardend.php">
          &laquo; SolrQuery::getFacetDateHardEnd        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfacetdateother.php' selected="selected">English</option>
            <option value='de/solrquery.getfacetdateother.php'>German</option>
            <option value='es/solrquery.getfacetdateother.php'>Spanish</option>
            <option value='fr/solrquery.getfacetdateother.php'>French</option>
            <option value='it/solrquery.getfacetdateother.php'>Italian</option>
            <option value='ja/solrquery.getfacetdateother.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfacetdateother.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfacetdateother.php'>Russian</option>
            <option value='tr/solrquery.getfacetdateother.php'>Turkish</option>
            <option value='uk/solrquery.getfacetdateother.php'>Ukrainian</option>
            <option value='zh/solrquery.getfacetdateother.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfacetdateother" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFacetDateOther</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFacetDateOther</span> &mdash; <span class="dc-title">Returns the value for the facet.date.other parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfacetdateother-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFacetDateOther</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfacetdateother-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfacetdateother-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
Returns an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfacetdateother.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfacetdateother%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfacetdateother&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfacetdateother.php">＋<small>add a note</small></a></span>
