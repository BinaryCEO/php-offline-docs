...
<head>
  ...
  <title>PHP: sodium_bin2base64 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-bin2base64.php">
 <link rel="shorturl" href="https://www.php.net/sodium-bin2base64">
 <link rel="alternate" href="https://www.php.net/sodium-bin2base64" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-base642bin.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-bin2hex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-bin2base64.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-bin2base64.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-bin2base64.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-bin2base64.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-bin2base64.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-bin2base64.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-bin2base64.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-bin2base64.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-bin2base64.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-bin2base64.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-bin2base64.php" hreflang="zh">
...
<meta name="Description" content="Encodes a raw binary string with base64." />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_bin2base64 - Manual" />
<meta name="twitter:description" content="Encodes a raw binary string with base64." />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_bin2base64 - Manual" />
<meta itemprop="description" content="Encodes a raw binary string with base64." />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Encodes a raw binary string with base64." />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-bin2hex.php">
          sodium_bin2hex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-base642bin.php">
          &laquo; sodium_base642bin        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-bin2base64.php' selected="selected">English</option>
            <option value='de/function.sodium-bin2base64.php'>German</option>
            <option value='es/function.sodium-bin2base64.php'>Spanish</option>
            <option value='fr/function.sodium-bin2base64.php'>French</option>
            <option value='it/function.sodium-bin2base64.php'>Italian</option>
            <option value='ja/function.sodium-bin2base64.php'>Japanese</option>
            <option value='pt_BR/function.sodium-bin2base64.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-bin2base64.php'>Russian</option>
            <option value='tr/function.sodium-bin2base64.php'>Turkish</option>
            <option value='uk/function.sodium-bin2base64.php'>Ukrainian</option>
            <option value='zh/function.sodium-bin2base64.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-bin2base64" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_bin2base64</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_bin2base64</span> &mdash; <span class="dc-title">Encodes a raw binary string with base64.</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.sodium-bin2base64-description">
  ...
  <p class="para rdfs-comment">
   Converts a raw binary string into a base64-encoded string. Unlike <span class="function"><a href="function.base64-encode.php" class="function">base64_encode()</a></span>,
   <span class="function"><strong>sodium_bin2base64()</strong></span> is constant-time (a property that is important for any code that
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      <ul class="simplelist">
       <li>
        <strong><code><a href="sodium.constants.php#constant.sodium-base64-variant-original">SODIUM_BASE64_VARIANT_ORIGINAL</a></code></strong> for standard (<code class="literal">A-Za-z0-9/\+</code>)
        Base64 encoding.
       </li>
       <li>
        <strong><code><a href="sodium.constants.php#constant.sodium-base64-variant-original-no-padding">SODIUM_BASE64_VARIANT_ORIGINAL_NO_PADDING</a></code></strong> for standard (<code class="literal">A-Za-z0-9/\+</code>)
        Base64 encoding, without <code class="literal">=</code> padding characters.
       </li>
       <li>
        <strong><code><a href="sodium.constants.php#constant.sodium-base64-variant-urlsafe">SODIUM_BASE64_VARIANT_URLSAFE</a></code></strong> for URL-safe (<code class="literal">A-Za-z0-9\-_</code>) Base64 encoding.
       </li>
       <li>
        <strong><code><a href="sodium.constants.php#constant.sodium-base64-variant-urlsafe-no-padding">SODIUM_BASE64_VARIANT_URLSAFE_NO_PADDING</a></code></strong> for URL-safe (<code class="literal">A-Za-z0-9\-_</code>)
        Base64 encoding, without <code class="literal">=</code> padding characters.
       </li>
      </ul>
     </p>
  ...
  <p class="para">
   Base64-encoded string.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-bin2base64.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-bin2base64%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-bin2base64&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-bin2base64.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123728">  <div class="votes">
    <div id="Vu123728">
    <a href="/manual/vote-note.php?id=123728&amp;page=function.sodium-bin2base64&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123728">
    <a href="/manual/vote-note.php?id=123728&amp;page=function.sodium-bin2base64&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123728" title="65% like this...">
    7
    </div>
  </div>
  <a href="#123728" class="name">
  <strong class="user"><em>davidw at example dot com</em></strong></a><a class="genanchor" href="#123728"> &para;</a><div class="date" title="2019-04-02 04:53"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123728">
<div class="phpcode"><code><span class="html">bin: The data you wish to encode<br />id: The variant of encoding to use, which can be one of the following constants. You'll need to reuse this value when decoding with sodium_base642bin.<br /><br />SODIUM_BASE64_VARIANT_ORIGINAL            = 1<br />SODIUM_BASE64_VARIANT_ORIGINAL_NO_PADDING = 3<br />SODIUM_BASE64_VARIANT_URLSAFE             = 5<br />SODIUM_BASE64_VARIANT_URLSAFE_NO_PADDING  = 7</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-bin2base64&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-bin2base64.php">＋<small>add a note</small></a></div>
