...
<head>
  ...
  <title>PHP: imagesy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagesy.php">
 <link rel="shorturl" href="https://www.php.net/imagesy">
 <link rel="alternate" href="https://www.php.net/imagesy" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagesx.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagetruecolortopalette.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagesy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagesy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagesy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagesy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagesy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagesy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagesy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagesy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagesy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagesy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagesy.php" hreflang="zh">
...
<meta name="Description" content="Get image height" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagesy - Manual" />
<meta name="twitter:description" content="Get image height" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagesy - Manual" />
<meta itemprop="description" content="Get image height" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get image height" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagesy.php' selected="selected">English</option>
            <option value='de/function.imagesy.php'>German</option>
            <option value='es/function.imagesy.php'>Spanish</option>
            <option value='fr/function.imagesy.php'>French</option>
            <option value='it/function.imagesy.php'>Italian</option>
            <option value='ja/function.imagesy.php'>Japanese</option>
            <option value='pt_BR/function.imagesy.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagesy.php'>Russian</option>
            <option value='tr/function.imagesy.php'>Turkish</option>
            <option value='uk/function.imagesy.php'>Ukrainian</option>
            <option value='zh/function.imagesy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagesy" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagesy</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagesy</span> &mdash; <span class="dc-title">Get image height</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagesy-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagesy</strong></span>(<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Returns the height of the given <code class="parameter">image</code> object.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imagesy-parameters">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagesy-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Return the height of the <code class="parameter">image</code>.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.imagesy-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.imagesy-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2938">
    <p><strong>Example #1 Using <span class="function"><strong>imagesy()</strong></span></strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// create a 300*200 image<br /></span><span style="color: #0000BB">$img </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatetruecolor</span><span style="color: #007700">(</span><span style="color: #0000BB">300</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">);<br /><br />echo </span><span style="color: #0000BB">imagesy</span><span style="color: #007700">(</span><span style="color: #0000BB">$img</span><span style="color: #007700">); </span><span style="color: #FF8000">// 200<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagesy-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imagesx.php" class="function" rel="rdfs-seeAlso">imagesx()</a> - Get image width</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagesy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagesy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagesy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagesy.php">＋<small>add a note</small></a></span>
