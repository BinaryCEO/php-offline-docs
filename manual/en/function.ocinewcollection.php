...
<head>
  ...
  <title>PHP: ocinewcollection - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocinewcollection.php">
 <link rel="shorturl" href="https://www.php.net/ocinewcollection">
 <link rel="alternate" href="https://www.php.net/ocinewcollection" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocilogon.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocinewcursor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocinewcollection.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocinewcollection.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocinewcollection.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocinewcollection.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocinewcollection.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocinewcollection.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocinewcollection.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocinewcollection.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocinewcollection.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocinewcollection.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocinewcollection.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_new_collection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocinewcollection - Manual" />
<meta name="twitter:description" content="Alias of oci_new_collection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocinewcollection - Manual" />
<meta itemprop="description" content="Alias of oci_new_collection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_new_collection" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ocinewcursor.php">
          ocinewcursor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocilogon.php">
          &laquo; ocilogon        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocinewcollection.php' selected="selected">English</option>
            <option value='de/function.ocinewcollection.php'>German</option>
            <option value='es/function.ocinewcollection.php'>Spanish</option>
            <option value='fr/function.ocinewcollection.php'>French</option>
            <option value='it/function.ocinewcollection.php'>Italian</option>
            <option value='ja/function.ocinewcollection.php'>Japanese</option>
            <option value='pt_BR/function.ocinewcollection.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocinewcollection.php'>Russian</option>
            <option value='tr/function.ocinewcollection.php'>Turkish</option>
            <option value='uk/function.ocinewcollection.php'>Ukrainian</option>
            <option value='zh/function.ocinewcollection.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocinewcollection" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocinewcollection</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocinewcollection</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-new-collection.php" class="function">oci_new_collection()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocinewcollection-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-new-collection.php" class="function">oci_new_collection()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocinewcollection.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocinewcollection%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocinewcollection&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocinewcollection.php">＋<small>add a note</small></a></span>
