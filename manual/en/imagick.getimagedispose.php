...
<head>
  ...
  <title>PHP: Imagick::getImageDispose - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagedispose.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagedispose.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagedispose.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagedepth.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagedistortion.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagedispose.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagedispose.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagedispose.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagedispose.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagedispose.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagedispose.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagedispose.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagedispose.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagedispose.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagedispose.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagedispose.php" hreflang="zh">
...
<meta name="Description" content="Gets the image disposal method" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageDispose - Manual" />
<meta name="twitter:description" content="Gets the image disposal method" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageDispose - Manual" />
<meta itemprop="description" content="Gets the image disposal method" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image disposal method" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagedistortion.php">
          Imagick::getImageDistortion &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagedepth.php">
          &laquo; Imagick::getImageDepth        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagedispose.php' selected="selected">English</option>
            <option value='de/imagick.getimagedispose.php'>German</option>
            <option value='es/imagick.getimagedispose.php'>Spanish</option>
            <option value='fr/imagick.getimagedispose.php'>French</option>
            <option value='it/imagick.getimagedispose.php'>Italian</option>
            <option value='ja/imagick.getimagedispose.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagedispose.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagedispose.php'>Russian</option>
            <option value='tr/imagick.getimagedispose.php'>Turkish</option>
            <option value='uk/imagick.getimagedispose.php'>Ukrainian</option>
            <option value='zh/imagick.getimagedispose.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagedispose" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageDispose</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageDispose</span> &mdash; <span class="dc-title">Gets the image disposal method</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagedispose-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageDispose</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagedispose-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagedispose-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagedispose-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagedispose.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagedispose%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagedispose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagedispose.php">＋<small>add a note</small></a></span>
