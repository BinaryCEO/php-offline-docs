...
<head>
  ...
  <title>PHP: CompileError - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.compileerror.php">
 <link rel="shorturl" href="https://www.php.net/compileerror">
 <link rel="alternate" href="https://www.php.net/compileerror" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.divisionbyzeroerror.php">
 <link rel="next" href="https://www.php.net/manual/en/class.parseerror.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.compileerror.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.compileerror.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.compileerror.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.compileerror.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.compileerror.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.compileerror.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.compileerror.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.compileerror.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.compileerror.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.compileerror.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.compileerror.php" hreflang="zh">
...
<meta name="Description" content="CompileError" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CompileError - Manual" />
<meta name="twitter:description" content="CompileError" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CompileError - Manual" />
<meta itemprop="description" content="CompileError" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="CompileError" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.compileerror.php' selected="selected">English</option>
            <option value='de/class.compileerror.php'>German</option>
            <option value='es/class.compileerror.php'>Spanish</option>
            <option value='fr/class.compileerror.php'>French</option>
            <option value='it/class.compileerror.php'>Italian</option>
            <option value='ja/class.compileerror.php'>Japanese</option>
            <option value='pt_BR/class.compileerror.php'>Brazilian Portuguese</option>
            <option value='ru/class.compileerror.php'>Russian</option>
            <option value='tr/class.compileerror.php'>Turkish</option>
            <option value='uk/class.compileerror.php'>Ukrainian</option>
            <option value='zh/class.compileerror.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.compileerror" class="reference">
 <h1 class="title">CompileError</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 7 &gt; 7.3.0, PHP 8)</p>


  <div class="section" id="compileerror.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    <span class="ooclass"><span class="classname"><strong class="classname">CompileError</strong></span></span> is thrown for some
    compilation errors, which formerly issued a fatal error.
   </p>
  </div>


  <div class="section" id="compileerror.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">CompileError</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="error.clone.php" class="methodname">Error::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/compileerror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.compileerror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.compileerror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.compileerror.php">＋<small>add a note</small></a></span>
