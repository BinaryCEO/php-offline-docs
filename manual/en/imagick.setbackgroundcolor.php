...
<head>
  ...
  <title>PHP: Imagick::setBackgroundColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setbackgroundcolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setbackgroundcolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setbackgroundcolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.sepiatoneimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setcolorspace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setbackgroundcolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setbackgroundcolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setbackgroundcolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setbackgroundcolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setbackgroundcolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setbackgroundcolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setbackgroundcolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setbackgroundcolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setbackgroundcolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setbackgroundcolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setbackgroundcolor.php" hreflang="zh">
...
<meta name="Description" content="Sets the object's default background color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setBackgroundColor - Manual" />
<meta name="twitter:description" content="Sets the object's default background color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setBackgroundColor - Manual" />
<meta itemprop="description" content="Sets the object's default background color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the object's default background color" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setcolorspace.php">
          Imagick::setColorspace &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.sepiatoneimage.php">
          &laquo; Imagick::sepiaToneImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setbackgroundcolor.php' selected="selected">English</option>
            <option value='de/imagick.setbackgroundcolor.php'>German</option>
            <option value='es/imagick.setbackgroundcolor.php'>Spanish</option>
            <option value='fr/imagick.setbackgroundcolor.php'>French</option>
            <option value='it/imagick.setbackgroundcolor.php'>Italian</option>
            <option value='ja/imagick.setbackgroundcolor.php'>Japanese</option>
            <option value='pt_BR/imagick.setbackgroundcolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setbackgroundcolor.php'>Russian</option>
            <option value='tr/imagick.setbackgroundcolor.php'>Turkish</option>
            <option value='uk/imagick.setbackgroundcolor.php'>Ukrainian</option>
            <option value='zh/imagick.setbackgroundcolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setbackgroundcolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setBackgroundColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setBackgroundColor</span> &mdash; <span class="dc-title">Sets the object&#039;s default background color</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.setbackgroundcolor-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setBackgroundColor</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$background</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setbackgroundcolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setbackgroundcolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setbackgroundcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setbackgroundcolor.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="107709">  <div class="votes">
    <div id="Vu107709">
    <a href="/manual/vote-note.php?id=107709&amp;page=imagick.setbackgroundcolor&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd107709">
    <a href="/manual/vote-note.php?id=107709&amp;page=imagick.setbackgroundcolor&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V107709" title="52% like this...">
    2
    </div>
  </div>
  <a href="#107709" class="name">
  <strong class="user"><em>eleg</em></strong></a><a class="genanchor" href="#107709"> &para;</a><div class="date" title="2012-02-28 02:59"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom107709">
<div class="phpcode"><code><span class="html">Be cautious and set bgcolor BEFORE importing a SVG with transparency!  :-/
<br />
<br /><span class="default">&lt;?php
<br />
<br />$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setBackgroundColor</span><span class="keyword">(new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'transparent'</span><span class="keyword">));
<br />
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="string">'carte_Alain2.svg'</span><span class="keyword">);
<br />
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">"png32"</span><span class="keyword">);
<br />
...
<br />echo </span><span class="default">$im</span><span class="keyword">;
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setbackgroundcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setbackgroundcolor.php">＋<small>add a note</small></a></div>
