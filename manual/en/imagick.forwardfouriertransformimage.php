...
<head>
  ...
  <title>PHP: Imagick::forwardFourierTransformImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.forwardfouriertransformimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.forwardfouriertransformimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.forwardfouriertransformimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.flopimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.frameimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.forwardfouriertransformimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.forwardfouriertransformimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.forwardfouriertransformimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.forwardfouriertransformimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.forwardfouriertransformimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.forwardfouriertransformimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.forwardfouriertransformimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.forwardfouriertransformimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.forwardfouriertransformimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.forwardfouriertransformimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.forwardfouriertransformimage.php" hreflang="zh">
...
<meta name="Description" content="Implements the discrete Fourier transform (DFT)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::forwardFourierTransformImage - Manual" />
<meta name="twitter:description" content="Implements the discrete Fourier transform (DFT)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::forwardFourierTransformImage - Manual" />
<meta itemprop="description" content="Implements the discrete Fourier transform (DFT)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Implements the discrete Fourier transform (DFT)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.frameimage.php">
          Imagick::frameImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.flopimage.php">
          &laquo; Imagick::flopImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.forwardfouriertransformimage.php' selected="selected">English</option>
            <option value='de/imagick.forwardfouriertransformimage.php'>German</option>
            <option value='es/imagick.forwardfouriertransformimage.php'>Spanish</option>
            <option value='fr/imagick.forwardfouriertransformimage.php'>French</option>
            <option value='it/imagick.forwardfouriertransformimage.php'>Italian</option>
            <option value='ja/imagick.forwardfouriertransformimage.php'>Japanese</option>
            <option value='pt_BR/imagick.forwardfouriertransformimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.forwardfouriertransformimage.php'>Russian</option>
            <option value='tr/imagick.forwardfouriertransformimage.php'>Turkish</option>
            <option value='uk/imagick.forwardfouriertransformimage.php'>Ukrainian</option>
            <option value='zh/imagick.forwardfouriertransformimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.forwardfouriertransformimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::forwardFourierTransformImage</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::forwardFourierTransformImage</span> &mdash; <span class="dc-title">Implements the discrete Fourier transform (DFT)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.forwardfouriertransformimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::forwardFourierTransformimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$magnitude</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.forwardfouriertransformimage-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">magnitude</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.forwardfouriertransformimage-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.forwardfouriertransformimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3002">
      <p><strong>Example #1  <span class="function"><strong>Imagick::forwardFourierTransformImage()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">//Utility function for forwardTransformImage<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">createMask</span><span style="color: #007700">() {<br />    </span><span style="color: #0000BB">$draw </span><span style="color: #007700">= new </span><span style="color: #0000BB">\ImagickDraw</span><span style="color: #007700">();<br /><br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setStrokeOpacity</span><span style="color: #007700">(</span><span style="color: #0000BB">0</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setStrokeColor</span><span style="color: #007700">(</span><span style="color: #DD0000">'rgb(255, 255, 255)'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setFillColor</span><span style="color: #007700">(</span><span style="color: #DD0000">'rgb(255, 255, 255)'</span><span style="color: #007700">);<br /><br />    </span><span style="color: #FF8000">//Draw a circle on the y-axis, with it's centre<br />    //at x, y that touches the origin<br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">circle</span><span style="color: #007700">(</span><span style="color: #0000BB">250</span><span style="color: #007700">, </span><span style="color: #0000BB">250</span><span style="color: #007700">, </span><span style="color: #0000BB">220</span><span style="color: #007700">, </span><span style="color: #0000BB">250</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">512</span><span style="color: #007700">, </span><span style="color: #0000BB">512</span><span style="color: #007700">, </span><span style="color: #DD0000">"black"</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">drawImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$draw</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">gaussianBlurImage</span><span style="color: #007700">(</span><span style="color: #0000BB">20</span><span style="color: #007700">, </span><span style="color: #0000BB">20</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">autoLevelImage</span><span style="color: #007700">();<br /><br />    return </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">;<br />}<br /><br /><br />function </span><span style="color: #0000BB">forwardFourierTransformImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">));<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">resizeimage</span><span style="color: #007700">(</span><span style="color: #0000BB">512</span><span style="color: #007700">, </span><span style="color: #0000BB">512</span><span style="color: #007700">, </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">FILTER_LANCZOS</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$mask </span><span style="color: #007700">= </span><span style="color: #0000BB">createMask</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">forwardFourierTransformImage</span><span style="color: #007700">(</span><span style="color: #0000BB">true</span><span style="color: #007700">);<br /><br />    @</span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setimageindex</span><span style="color: #007700">(</span><span style="color: #0000BB">0</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$magnitude </span><span style="color: #007700">= </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getimage</span><span style="color: #007700">();<br /><br />    @</span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setimageindex</span><span style="color: #007700">(</span><span style="color: #0000BB">1</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$imagickPhase </span><span style="color: #007700">= </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getimage</span><span style="color: #007700">();<br /><br />    if (</span><span style="color: #0000BB">true</span><span style="color: #007700">) {<br />        </span><span style="color: #0000BB">$imagickPhase</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">compositeImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$mask</span><span style="color: #007700">, </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">COMPOSITE_MULTIPLY</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br />    }<br /><br />    if (</span><span style="color: #0000BB">false</span><span style="color: #007700">) {<br />        </span><span style="color: #0000BB">$output </span><span style="color: #007700">= clone </span><span style="color: #0000BB">$imagickPhase</span><span style="color: #007700">;<br />        </span><span style="color: #0000BB">$output</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setimageformat</span><span style="color: #007700">(</span><span style="color: #DD0000">'png'</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$output</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />    }<br /><br />    </span><span style="color: #0000BB">$magnitude</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">inverseFourierTransformImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagickPhase</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$magnitude</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setimageformat</span><span style="color: #007700">(</span><span style="color: #DD0000">'png'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />    echo </span><span style="color: #0000BB">$magnitude</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/forwardfouriertransformimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.forwardfouriertransformimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.forwardfouriertransformimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.forwardfouriertransformimage.php">＋<small>add a note</small></a></span>
