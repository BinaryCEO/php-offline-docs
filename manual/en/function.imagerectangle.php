...
<head>
  ...
  <title>PHP: imagerectangle - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagerectangle.php">
 <link rel="shorturl" href="https://www.php.net/imagerectangle">
 <link rel="alternate" href="https://www.php.net/imagerectangle" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagepolygon.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imageresolution.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagerectangle.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagerectangle.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagerectangle.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagerectangle.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagerectangle.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagerectangle.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagerectangle.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagerectangle.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagerectangle.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagerectangle.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagerectangle.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: imagerectangle - Manual" />
<meta name="twitter:description" content="Draw a rectangle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagerectangle - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imageresolution.php">
          imageresolution &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagepolygon.php">
          &laquo; imagepolygon        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagerectangle.php' selected="selected">English</option>
            <option value='de/function.imagerectangle.php'>German</option>
            <option value='es/function.imagerectangle.php'>Spanish</option>
            <option value='fr/function.imagerectangle.php'>French</option>
            <option value='it/function.imagerectangle.php'>Italian</option>
            <option value='ja/function.imagerectangle.php'>Japanese</option>
            <option value='pt_BR/function.imagerectangle.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagerectangle.php'>Russian</option>
            <option value='tr/function.imagerectangle.php'>Turkish</option>
            <option value='uk/function.imagerectangle.php'>Ukrainian</option>
            <option value='zh/function.imagerectangle.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagerectangle" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagerectangle</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagerectangle</span> &mdash; <span class="dc-title">Draw a rectangle</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.imagerectangle-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>imagerectangle()</strong></span> creates a rectangle starting at
...
something similar to:</p></div>
    <div class="mediaobject">
     ...
     <div class="imageobject">
      <img src="images/21009b70229598c6a80eef8b45bf282b-imagerectangle.jpg" alt="Output of example : Simple imagerectangle() example" width="200" height="200" />
     </div>
    </div>
   </div>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagerectangle.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagerectangle%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagerectangle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagerectangle.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117432">  <div class="votes">
    <div id="Vu117432">
    <a href="/manual/vote-note.php?id=117432&amp;page=function.imagerectangle&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117432">
    <a href="/manual/vote-note.php?id=117432&amp;page=function.imagerectangle&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117432" title="53% like this...">
    2
    </div>
  </div>
  <a href="#117432" class="name">
  <strong class="user"><em>stanislav dot eckert at vizson dot de</em></strong></a><a class="genanchor" href="#117432"> &para;</a><div class="date" title="2015-06-10 09:15"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117432">
<div class="phpcode"><code><span class="html">Please pay attention if you want to draw pixel perfect rectangles: Since this function uses absolute values for the second coordinate points (instead of width and height), you might face a logical problem. PHP counts from 0. But a pixel at position 0,0 occupies already a 1x1 space. In the example above you have the following line:<br /><br />imagerectangle($canvas, 50, 50, 150, 150, $pink);<br /><br />If you don't pay attention, you might thing that the difference between the two coordinates is exactly 100 and assume that the drawn rectangle would have the dimension of 100 x 100 pixels too. But it would be 101 x 101, because PHP counts from 0 and imagerectangle() uses absolute coordinates for the second point too. A smaller example: A rectangle with coordinates 0,0 and 5,5 means 0,1,2,3,4,5 which are 6 pixels, not 5.</span></code></div>
  </div>
 </div>
  <div class="note" id="76037">  <div class="votes">
    <div id="Vu76037">
    <a href="/manual/vote-note.php?id=76037&amp;page=function.imagerectangle&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd76037">
    <a href="/manual/vote-note.php?id=76037&amp;page=function.imagerectangle&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V76037" title="48% like this...">
    -1
    </div>
  </div>
  <a href="#76037" class="name">
  <strong class="user"><em>rogier</em></strong></a><a class="genanchor" href="#76037"> &para;</a><div class="date" title="2007-06-27 05:27"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom76037">
<div class="phpcode"><code><span class="html">In addition to Corey's note, this is the kind of code he means. Note that I always draw an outer grid border, so drawing lines will always take <br />1 + ceil((rows+cols)/2) actions. For a 20X20 grid, this means 21 actions, a 10X25 grid takes 19 Actions<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">draw_grid</span><span class="keyword">(&amp;</span><span class="default">$img</span><span class="keyword">, </span><span class="default">$x0</span><span class="keyword">, </span><span class="default">$y0</span><span class="keyword">, </span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">, </span><span class="default">$cols</span><span class="keyword">, </span><span class="default">$rows</span><span class="keyword">, </span><span class="default">$color</span><span class="keyword">) {<br />    </span><span class="comment">//draw outer border<br />    </span><span class="default">imagerectangle</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">$x0</span><span class="keyword">, </span><span class="default">$y0</span><span class="keyword">, </span><span class="default">$x0</span><span class="keyword">+</span><span class="default">$width</span><span class="keyword">*</span><span class="default">$cols</span><span class="keyword">, </span><span class="default">$y0</span><span class="keyword">+</span><span class="default">$height</span><span class="keyword">*</span><span class="default">$rows</span><span class="keyword">, </span><span class="default">$color</span><span class="keyword">);<br />    </span><span class="comment">//first draw horizontal<br />    </span><span class="default">$x1 </span><span class="keyword">= </span><span class="default">$x0</span><span class="keyword">;<br />    </span><span class="default">$x2 </span><span class="keyword">= </span><span class="default">$x0 </span><span class="keyword">+ </span><span class="default">$cols</span><span class="keyword">*</span><span class="default">$width</span><span class="keyword">;<br />    for (</span><span class="default">$n</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">; </span><span class="default">$n</span><span class="keyword">&lt;</span><span class="default">ceil</span><span class="keyword">(</span><span class="default">$rows</span><span class="keyword">/</span><span class="default">2</span><span class="keyword">); </span><span class="default">$n</span><span class="keyword">++) {<br />        </span><span class="default">$y1 </span><span class="keyword">= </span><span class="default">$y0 </span><span class="keyword">+ </span><span class="default">2</span><span class="keyword">*</span><span class="default">$n</span><span class="keyword">*</span><span class="default">$height</span><span class="keyword">;<br />        </span><span class="default">$y2 </span><span class="keyword">= </span><span class="default">$y0 </span><span class="keyword">+ (</span><span class="default">2</span><span class="keyword">*</span><span class="default">$n</span><span class="keyword">+</span><span class="default">1</span><span class="keyword">)*</span><span class="default">$height</span><span class="keyword">;<br />        </span><span class="default">imagerectangle</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">$x1</span><span class="keyword">,</span><span class="default">$y1</span><span class="keyword">,</span><span class="default">$x2</span><span class="keyword">,</span><span class="default">$y2</span><span class="keyword">, </span><span class="default">$color</span><span class="keyword">);<br />    }<br />    </span><span class="comment">//then draw vertical<br />    </span><span class="default">$y1 </span><span class="keyword">= </span><span class="default">$y0</span><span class="keyword">;<br />    </span><span class="default">$y2 </span><span class="keyword">= </span><span class="default">$y0 </span><span class="keyword">+ </span><span class="default">$rows</span><span class="keyword">*</span><span class="default">$height</span><span class="keyword">;<br />    for (</span><span class="default">$n</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">; </span><span class="default">$n</span><span class="keyword">&lt;</span><span class="default">ceil</span><span class="keyword">(</span><span class="default">$cols</span><span class="keyword">/</span><span class="default">2</span><span class="keyword">); </span><span class="default">$n</span><span class="keyword">++) {<br />        </span><span class="default">$x1 </span><span class="keyword">= </span><span class="default">$x0 </span><span class="keyword">+ </span><span class="default">2</span><span class="keyword">*</span><span class="default">$n</span><span class="keyword">*</span><span class="default">$width</span><span class="keyword">;<br />        </span><span class="default">$x2 </span><span class="keyword">= </span><span class="default">$x0 </span><span class="keyword">+ (</span><span class="default">2</span><span class="keyword">*</span><span class="default">$n</span><span class="keyword">+</span><span class="default">1</span><span class="keyword">)*</span><span class="default">$width</span><span class="keyword">;<br />        </span><span class="default">imagerectangle</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">$x1</span><span class="keyword">,</span><span class="default">$y1</span><span class="keyword">,</span><span class="default">$x2</span><span class="keyword">,</span><span class="default">$y2</span><span class="keyword">, </span><span class="default">$color</span><span class="keyword">);<br />    }<br />}<br /><br /></span><span class="comment">//example<br /></span><span class="default">$img </span><span class="keyword">= </span><span class="default">imagecreatetruecolor</span><span class="keyword">(</span><span class="default">300</span><span class="keyword">, </span><span class="default">200</span><span class="keyword">);<br /></span><span class="default">$red   </span><span class="keyword">= </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">,   </span><span class="default">0</span><span class="keyword">,   </span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">draw_grid</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">15</span><span class="keyword">,</span><span class="default">20</span><span class="keyword">,</span><span class="default">20</span><span class="keyword">,</span><span class="default">10</span><span class="keyword">,</span><span class="default">$red</span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-type: image/png"</span><span class="keyword">);<br /></span><span class="default">imagepng</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">);<br /></span><span class="default">imagedestroy</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span>have fun ;)</span></code></div>
  </div>
 </div>
  <div class="note" id="27744">  <div class="votes">
    <div id="Vu27744">
    <a href="/manual/vote-note.php?id=27744&amp;page=function.imagerectangle&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd27744">
    <a href="/manual/vote-note.php?id=27744&amp;page=function.imagerectangle&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V27744" title="46% like this...">
    -1
    </div>
  </div>
  <a href="#27744" class="name">
  <strong class="user"><em>eustaquiorangel at yahoo dot com</em></strong></a><a class="genanchor" href="#27744"> &para;</a><div class="date" title="2002-12-17 09:21"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom27744">
<div class="phpcode"><code><span class="html">If you want an empty rectangle, I mean, just the borders, fill it first with the ImageFilledRectangle function with the background color and then draw it with this function.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagerectangle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagerectangle.php">＋<small>add a note</small></a></div>
