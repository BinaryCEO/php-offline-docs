...
<head>
  ...
  <title>PHP: xdiff_file_rabdiff - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xdiff-file-rabdiff.php">
 <link rel="shorturl" href="https://www.php.net/xdiff-file-rabdiff">
 <link rel="alternate" href="https://www.php.net/xdiff-file-rabdiff" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.xdiff.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.xdiff-file-patch-binary.php">
 <link rel="next" href="https://www.php.net/manual/en/function.xdiff-string-bdiff.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.xdiff-file-rabdiff.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.xdiff-file-rabdiff.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.xdiff-file-rabdiff.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.xdiff-file-rabdiff.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.xdiff-file-rabdiff.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.xdiff-file-rabdiff.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.xdiff-file-rabdiff.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.xdiff-file-rabdiff.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.xdiff-file-rabdiff.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.xdiff-file-rabdiff.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.xdiff-file-rabdiff.php" hreflang="zh">
...
<meta name="Description" content="Make binary diff of two files using the Rabin's polynomial fingerprinting algorithm" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: xdiff_file_rabdiff - Manual" />
<meta name="twitter:description" content="Make binary diff of two files using the Rabin's polynomial fingerprinting algorithm" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: xdiff_file_rabdiff - Manual" />
<meta itemprop="description" content="Make binary diff of two files using the Rabin's polynomial fingerprinting algorithm" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Make binary diff of two files using the Rabin's polynomial fingerprinting algorithm" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.xdiff-string-bdiff.php">
          xdiff_string_bdiff &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.xdiff-file-patch-binary.php">
          &laquo; xdiff_file_patch_binary        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xdiff-file-rabdiff.php' selected="selected">English</option>
            <option value='de/function.xdiff-file-rabdiff.php'>German</option>
            <option value='es/function.xdiff-file-rabdiff.php'>Spanish</option>
            <option value='fr/function.xdiff-file-rabdiff.php'>French</option>
            <option value='it/function.xdiff-file-rabdiff.php'>Italian</option>
            <option value='ja/function.xdiff-file-rabdiff.php'>Japanese</option>
            <option value='pt_BR/function.xdiff-file-rabdiff.php'>Brazilian Portuguese</option>
            <option value='ru/function.xdiff-file-rabdiff.php'>Russian</option>
            <option value='tr/function.xdiff-file-rabdiff.php'>Turkish</option>
            <option value='uk/function.xdiff-file-rabdiff.php'>Ukrainian</option>
            <option value='zh/function.xdiff-file-rabdiff.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.xdiff-file-rabdiff" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.xdiff-file-rabdiff-examples">
  ...
  <p class="para">
   <div class="example" id="example-2447">
    <p><strong>Example #1 <span class="function"><strong>xdiff_file_rabdiff()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.xdiff-file-bpatch.php" class="function" rel="rdfs-seeAlso">xdiff_file_bpatch()</a> - Patch a file with a binary diff</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xdiff/functions/xdiff-file-rabdiff.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xdiff-file-rabdiff%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xdiff-file-rabdiff&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xdiff-file-rabdiff.php">＋<small>add a note</small></a></span>
