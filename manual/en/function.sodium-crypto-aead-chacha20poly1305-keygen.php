...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-keygen.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-ietf-keygen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-aead-xchacha20poly1305-ietf-decrypt.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-aead-chacha20poly1305-keygen.php' selected="selected">English</option>
            ...
            <option value='zh/function.sodium-crypto-aead-chacha20poly1305-keygen.php'>Chinese (Simplified)</option>
  ...
  <p class="para">
   Returns a 256-bit random key.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-aead-chacha20poly1305-keygen.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-aead-chacha20poly1305-keygen%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-aead-chacha20poly1305-keygen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-keygen.php">＋<small>add a note</small></a></span>
