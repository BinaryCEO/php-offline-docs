...
<head>
  ...
  <title>PHP: Imagick::setCompressionQuality - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setcompressionquality.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setcompressionquality.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setcompressionquality.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setcompression.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setfilename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setcompressionquality.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setcompressionquality.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setcompressionquality.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setcompressionquality.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setcompressionquality.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setcompressionquality.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setcompressionquality.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setcompressionquality.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setcompressionquality.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setcompressionquality.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setcompressionquality.php" hreflang="zh">
...
<meta name="Description" content="Sets the object's default compression quality" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setCompressionQuality - Manual" />
<meta name="twitter:description" content="Sets the object's default compression quality" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setCompressionQuality - Manual" />
<meta itemprop="description" content="Sets the object's default compression quality" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the object's default compression quality" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setfilename.php">
          Imagick::setFilename &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setcompression.php">
          &laquo; Imagick::setCompression        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setcompressionquality.php' selected="selected">English</option>
            <option value='de/imagick.setcompressionquality.php'>German</option>
            <option value='es/imagick.setcompressionquality.php'>Spanish</option>
            <option value='fr/imagick.setcompressionquality.php'>French</option>
            <option value='it/imagick.setcompressionquality.php'>Italian</option>
            <option value='ja/imagick.setcompressionquality.php'>Japanese</option>
            <option value='pt_BR/imagick.setcompressionquality.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setcompressionquality.php'>Russian</option>
            <option value='tr/imagick.setcompressionquality.php'>Turkish</option>
            <option value='uk/imagick.setcompressionquality.php'>Ukrainian</option>
            <option value='zh/imagick.setcompressionquality.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setcompressionquality" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setCompressionQuality</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setCompressionQuality</span> &mdash; <span class="dc-title">Sets the object&#039;s default compression quality</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setcompressionquality-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setCompressionQuality</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$quality</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <div class="caution"><strong class="caution">Caution</strong>
   <p class="para">
    This method only works for new images e.g. those created through Imagick::newPseudoImage. For existing images you should use <span class="methodname"><a href="imagick.setimagecompressionquality.php" class="methodname">Imagick::setImageCompressionQuality()</a></span>.
   </p>
  </div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setcompressionquality-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       An <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> between 1 and 100, 1 = high compression, 100 low compression.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setcompressionquality-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3089">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setcompressionquality.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setcompressionquality%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setcompressionquality&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setcompressionquality.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96836">  <div class="votes">
    <div id="Vu96836">
    <a href="/manual/vote-note.php?id=96836&amp;page=imagick.setcompressionquality&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96836">
    <a href="/manual/vote-note.php?id=96836&amp;page=imagick.setcompressionquality&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96836" title="86% like this...">
    31
    </div>
  </div>
  <a href="#96836" class="name">
  <strong class="user"><em>deeps chennai</em></strong></a><a class="genanchor" href="#96836"> &para;</a><div class="date" title="2010-03-18 02:59"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96836">
<div class="phpcode"><code><span class="html">A note for people who just couldn't get this working..
<br />
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />and this is backwards compatible (Works on PHP 5.1.6 as well as 5.2.10)</span></code></div>
  </div>
 </div>
  <div class="note" id="99209">  <div class="votes">
    <div id="Vu99209">
    <a href="/manual/vote-note.php?id=99209&amp;page=imagick.setcompressionquality&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd99209">
    <a href="/manual/vote-note.php?id=99209&amp;page=imagick.setcompressionquality&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V99209" title="77% like this...">
    5
    </div>
  </div>
  <a href="#99209" class="name">
  <strong class="user"><em>charles dot hall at sas dot com</em></strong></a><a class="genanchor" href="#99209"> &para;</a><div class="date" title="2010-08-03 11:31"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom99209">
<div class="phpcode"><code><span class="html">I had to insert a call to "stripImage()" in order to actually see the filesize shrink.
<br />
<br /><span class="default">&lt;?php
<br />   $img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();
<br />   </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">);
<br />   </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">setImageCompression</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">COMPRESSION_JPEG</span><span class="keyword">);
<br />   </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">setImageCompressionQuality</span><span class="keyword">(</span><span class="default">90</span><span class="keyword">);
<br />   </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">stripImage</span><span class="keyword">();
<br />   </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">$dest</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="82080">  <div class="votes">
    <div id="Vu82080">
    <a href="/manual/vote-note.php?id=82080&amp;page=imagick.setcompressionquality&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd82080">
    <a href="/manual/vote-note.php?id=82080&amp;page=imagick.setcompressionquality&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V82080" title="25% like this...">
    -4
    </div>
  </div>
  <a href="#82080" class="name">
  <strong class="user"><em>nVaux.com</em></strong></a><a class="genanchor" href="#82080"> &para;</a><div class="date" title="2008-03-26 08:24"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom82080">
<div class="phpcode"><code><span class="html">Sebastian's example works excellent, just one minor spelling mistake, it will give you an error otherwise.<br /><br /><span class="default">&lt;?php<br />$img</span><span class="keyword">-&gt;</span><span class="default">setCompression</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPRESSION_JPEG</span><span class="keyword">);<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">setCompressionQuality</span><span class="keyword">(</span><span class="default">80</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />I used Sebastians example, and made one that compresses all the images within a directory:<br /><br /><span class="default">&lt;?php<br />$images </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">glob</span><span class="keyword">(</span><span class="string">'images/*.jpg'</span><span class="keyword">));<br /><br />foreach(</span><span class="default">$images </span><span class="keyword">as </span><span class="default">$image</span><span class="keyword">)<br />{<br />    </span><span class="comment">// compression methods, see "Contants"-page for Imagick<br />    </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setCompression</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">COMPRESSION_JPEG</span><span class="keyword">);<br />    </span><span class="comment">// a value between 1 and 100, 1 = high compression, 100 low compression<br />    </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setCompressionQuality</span><span class="keyword">(</span><span class="default">80</span><span class="keyword">);<br />    </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">();<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setcompressionquality&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setcompressionquality.php">＋<small>add a note</small></a></div>
