...
<head>
  ...
  <title>PHP: Phar::interceptFileFuncs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.interceptfilefuncs.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.interceptfilefuncs.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.interceptfilefuncs.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.hasmetadata.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.isbuffering.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.interceptfilefuncs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.interceptfilefuncs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.interceptfilefuncs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.interceptfilefuncs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.interceptfilefuncs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.interceptfilefuncs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.interceptfilefuncs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.interceptfilefuncs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.interceptfilefuncs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.interceptfilefuncs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.interceptfilefuncs.php" hreflang="zh">
...
<meta name="Description" content="Instructs phar to intercept fopen, file_get_contents, opendir, and all of the stat-related functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::interceptFileFuncs - Manual" />
<meta name="twitter:description" content="Instructs phar to intercept fopen, file_get_contents, opendir, and all of the stat-related functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::interceptFileFuncs - Manual" />
<meta itemprop="description" content="Instructs phar to intercept fopen, file_get_contents, opendir, and all of the stat-related functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Instructs phar to intercept fopen, file_get_contents, opendir, and all of the stat-related functions" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.isbuffering.php">
          Phar::isBuffering &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.hasmetadata.php">
          &laquo; Phar::hasMetadata        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.interceptfilefuncs.php' selected="selected">English</option>
            <option value='de/phar.interceptfilefuncs.php'>German</option>
            <option value='es/phar.interceptfilefuncs.php'>Spanish</option>
            <option value='fr/phar.interceptfilefuncs.php'>French</option>
            <option value='it/phar.interceptfilefuncs.php'>Italian</option>
            <option value='ja/phar.interceptfilefuncs.php'>Japanese</option>
            <option value='pt_BR/phar.interceptfilefuncs.php'>Brazilian Portuguese</option>
            <option value='ru/phar.interceptfilefuncs.php'>Russian</option>
            <option value='tr/phar.interceptfilefuncs.php'>Turkish</option>
            <option value='uk/phar.interceptfilefuncs.php'>Ukrainian</option>
            <option value='zh/phar.interceptfilefuncs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.interceptfilefuncs" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />Phar</span><span style="color: #007700">::</span><span style="color: #0000BB">interceptFileFuncs</span><span style="color: #007700">();<br />include </span><span style="color: #DD0000">'phar://' </span><span style="color: #007700">. </span><span style="color: #0000BB">__FILE__ </span><span style="color: #007700">. </span><span style="color: #DD0000">'/file.php'</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-823">
  ...
  <p class="para">
   ...
   example code.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/interceptFileFuncs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.interceptfilefuncs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.interceptfilefuncs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.interceptfilefuncs.php">＋<small>add a note</small></a></span>
