...
<head>
  ...
  <title>PHP: SplFileInfo::isExecutable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileinfo.isexecutable.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileinfo.isexecutable.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileinfo.isexecutable.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileinfo.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileinfo.isdir.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileinfo.isfile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/splfileinfo.isexecutable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/splfileinfo.isexecutable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/splfileinfo.isexecutable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/splfileinfo.isexecutable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/splfileinfo.isexecutable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/splfileinfo.isexecutable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/splfileinfo.isexecutable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/splfileinfo.isexecutable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/splfileinfo.isexecutable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/splfileinfo.isexecutable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/splfileinfo.isexecutable.php" hreflang="zh">
...
<meta name="Description" content="Tells if the file is executable" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplFileInfo::isExecutable - Manual" />
<meta name="twitter:description" content="Tells if the file is executable" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplFileInfo::isExecutable - Manual" />
<meta itemprop="description" content="Tells if the file is executable" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Tells if the file is executable" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="splfileinfo.isfile.php">
          SplFileInfo::isFile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="splfileinfo.isdir.php">
          &laquo; SplFileInfo::isDir        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileinfo.isexecutable.php' selected="selected">English</option>
            <option value='de/splfileinfo.isexecutable.php'>German</option>
            <option value='es/splfileinfo.isexecutable.php'>Spanish</option>
            <option value='fr/splfileinfo.isexecutable.php'>French</option>
            <option value='it/splfileinfo.isexecutable.php'>Italian</option>
            <option value='ja/splfileinfo.isexecutable.php'>Japanese</option>
            <option value='pt_BR/splfileinfo.isexecutable.php'>Brazilian Portuguese</option>
            <option value='ru/splfileinfo.isexecutable.php'>Russian</option>
            <option value='tr/splfileinfo.isexecutable.php'>Turkish</option>
            <option value='uk/splfileinfo.isexecutable.php'>Ukrainian</option>
            <option value='zh/splfileinfo.isexecutable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="splfileinfo.isexecutable" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-splfileinfo.isexecutable-examples">
  ...
  <p class="para">
   <div class="example" id="example-3982">
    <p><strong>Example #1 <span class="function"><strong>SplFileInfo::isExecutable()</strong></span> example</strong></p>
...
bool(false)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileinfo/isexecutable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileinfo.isexecutable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileinfo.isexecutable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileinfo.isexecutable.php">＋<small>add a note</small></a></span>
