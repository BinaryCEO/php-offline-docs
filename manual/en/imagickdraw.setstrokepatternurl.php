...
<head>
  ...
  <title>PHP: ImagickDraw::setStrokePatternURL - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setstrokepatternurl.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setstrokepatternurl.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokepatternurl.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setstrokeopacity.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setstrokewidth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokepatternurl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setstrokepatternurl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setstrokepatternurl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setstrokepatternurl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setstrokepatternurl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setstrokepatternurl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setstrokepatternurl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setstrokepatternurl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setstrokepatternurl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setstrokepatternurl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setstrokepatternurl.php" hreflang="zh">
...
<meta name="Description" content="Sets the pattern used for stroking object outlines" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setStrokePatternURL - Manual" />
<meta name="twitter:description" content="Sets the pattern used for stroking object outlines" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setStrokePatternURL - Manual" />
<meta itemprop="description" content="Sets the pattern used for stroking object outlines" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the pattern used for stroking object outlines" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setstrokewidth.php">
          ImagickDraw::setStrokeWidth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setstrokeopacity.php">
          &laquo; ImagickDraw::setStrokeOpacity        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setstrokepatternurl.php' selected="selected">English</option>
            <option value='de/imagickdraw.setstrokepatternurl.php'>German</option>
            <option value='es/imagickdraw.setstrokepatternurl.php'>Spanish</option>
            <option value='fr/imagickdraw.setstrokepatternurl.php'>French</option>
            <option value='it/imagickdraw.setstrokepatternurl.php'>Italian</option>
            <option value='ja/imagickdraw.setstrokepatternurl.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setstrokepatternurl.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setstrokepatternurl.php'>Russian</option>
            <option value='tr/imagickdraw.setstrokepatternurl.php'>Turkish</option>
            <option value='uk/imagickdraw.setstrokepatternurl.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setstrokepatternurl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setstrokepatternurl" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setStrokePatternURL</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setStrokePatternURL</span> &mdash; <span class="dc-title">Sets the pattern used for stroking object outlines</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setstrokepatternurl-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setStrokePatternURL</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$stroke_url</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setstrokepatternurl-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">stroke_url</code></dt>
     <dd>
      <p class="para">
       stroke URL
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setstrokepatternurl-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setstrokepatternurl.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setstrokepatternurl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setstrokepatternurl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokepatternurl.php">＋<small>add a note</small></a></span>
