...
<head>
  ...
  <title>PHP: ImagickDraw::getTextKerning - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.gettextkerning.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.gettextkerning.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextkerning.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.gettextinterwordspacing.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.gettextundercolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextkerning.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.gettextkerning.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.gettextkerning.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.gettextkerning.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.gettextkerning.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.gettextkerning.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.gettextkerning.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.gettextkerning.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.gettextkerning.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.gettextkerning.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.gettextkerning.php" hreflang="zh">
...
<meta name="Description" content="Gets the text kerning" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getTextKerning - Manual" />
<meta name="twitter:description" content="Gets the text kerning" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getTextKerning - Manual" />
<meta itemprop="description" content="Gets the text kerning" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the text kerning" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.gettextundercolor.php">
          ImagickDraw::getTextUnderColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.gettextinterwordspacing.php">
          &laquo; ImagickDraw::getTextInterwordSpacing        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.gettextkerning.php' selected="selected">English</option>
            <option value='de/imagickdraw.gettextkerning.php'>German</option>
            <option value='es/imagickdraw.gettextkerning.php'>Spanish</option>
            <option value='fr/imagickdraw.gettextkerning.php'>French</option>
            <option value='it/imagickdraw.gettextkerning.php'>Italian</option>
            <option value='ja/imagickdraw.gettextkerning.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.gettextkerning.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.gettextkerning.php'>Russian</option>
            <option value='tr/imagickdraw.gettextkerning.php'>Turkish</option>
            <option value='uk/imagickdraw.gettextkerning.php'>Ukrainian</option>
            <option value='zh/imagickdraw.gettextkerning.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.gettextkerning" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getTextKerning</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3 &gt;= 3.1.0)</p><p class="refpurpose"><span class="refname">ImagickDraw::getTextKerning</span> &mdash; <span class="dc-title">Gets the text kerning</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.gettextkerning-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getTextKerning</strong></span>(): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.gettextkerning-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.gettextkerning-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/gettextkerning.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.gettextkerning%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.gettextkerning&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.gettextkerning.php">＋<small>add a note</small></a></span>
