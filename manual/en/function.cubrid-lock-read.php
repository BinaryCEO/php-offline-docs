...
<head>
  ...
  <title>PHP: cubrid_lock_read - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lock-read.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-lock-read">
 <link rel="alternate" href="https://www.php.net/cubrid-lock-read" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lob2-write.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lock-write.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-lock-read.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-lock-read.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-lock-read.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-lock-read.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-lock-read.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-lock-read.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-lock-read.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-lock-read.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-lock-read.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-lock-read.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-lock-read.php" hreflang="zh">
...
<meta name="Description" content="Set a read lock on the given OID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lock_read - Manual" />
<meta name="twitter:description" content="Set a read lock on the given OID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lock_read - Manual" />
<meta itemprop="description" content="Set a read lock on the given OID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set a read lock on the given OID" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-lock-write.php">
          cubrid_lock_write &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-lob2-write.php">
          &laquo; cubrid_lob2_write        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lock-read.php' selected="selected">English</option>
            <option value='de/function.cubrid-lock-read.php'>German</option>
            <option value='es/function.cubrid-lock-read.php'>Spanish</option>
            <option value='fr/function.cubrid-lock-read.php'>French</option>
            <option value='it/function.cubrid-lock-read.php'>Italian</option>
            <option value='ja/function.cubrid-lock-read.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-lock-read.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-lock-read.php'>Russian</option>
            <option value='tr/function.cubrid-lock-read.php'>Turkish</option>
            <option value='uk/function.cubrid-lock-read.php'>Ukrainian</option>
            <option value='zh/function.cubrid-lock-read.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-lock-read" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_lock_read</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_lock_read</span> &mdash; <span class="dc-title">Set a read lock on the given OID</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-lock-read-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_lock_read</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$oid</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_lock_read()</strong></span> function is used to put read
    lock on the instance pointed by given <code class="parameter">oid</code>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.cubrid-lock-read-parameters">
  ...
  <dd><p class="para">OID of the instance that you want to put read lock on.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-lock-read-returnvalues">
...
array(4) {
  ...
  <div class="refsect1 seealso" id="refsect1-function.cubrid-lock-read-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
   <li><span class="function"><a href="function.cubrid-lock-write.php" class="function" rel="rdfs-seeAlso">cubrid_lock_write()</a> - Set a write lock on the given OID</span></li>   
   </ul>
  </p>
  </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lock-read.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lock-read%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lock-read&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lock-read.php">＋<small>add a note</small></a></span>
