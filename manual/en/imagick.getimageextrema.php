...
<head>
  ...
  <title>PHP: Imagick::getImageExtrema - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageextrema.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageextrema.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageextrema.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagedistortion.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagefilename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageextrema.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageextrema.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageextrema.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageextrema.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageextrema.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageextrema.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageextrema.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageextrema.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageextrema.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageextrema.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageextrema.php" hreflang="zh">
...
<meta name="Description" content="Gets the extrema for the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageExtrema - Manual" />
<meta name="twitter:description" content="Gets the extrema for the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageExtrema - Manual" />
<meta itemprop="description" content="Gets the extrema for the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the extrema for the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagefilename.php">
          Imagick::getImageFilename &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagedistortion.php">
          &laquo; Imagick::getImageDistortion        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageextrema.php' selected="selected">English</option>
            <option value='de/imagick.getimageextrema.php'>German</option>
            <option value='es/imagick.getimageextrema.php'>Spanish</option>
            <option value='fr/imagick.getimageextrema.php'>French</option>
            <option value='it/imagick.getimageextrema.php'>Italian</option>
            <option value='ja/imagick.getimageextrema.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageextrema.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageextrema.php'>Russian</option>
            <option value='tr/imagick.getimageextrema.php'>Turkish</option>
            <option value='uk/imagick.getimageextrema.php'>Ukrainian</option>
            <option value='zh/imagick.getimageextrema.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageextrema" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageExtrema</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageExtrema</span> &mdash; <span class="dc-title">Gets the extrema for the image</span></p>

 </div>

 <div id="imagick.getimageextrema-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimageextrema-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageExtrema</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimageextrema-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageextrema-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimageextrema-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageextrema.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageextrema%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageextrema&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageextrema.php">＋<small>add a note</small></a></span>
