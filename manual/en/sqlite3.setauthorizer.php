...
<head>
  ...
  <title>PHP: SQLite3::setAuthorizer - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/sqlite3.setauthorizer.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/sqlite3.setauthorizer.php">
 <link rel="alternate" href="https://www.php.net/manual/en/sqlite3.setauthorizer.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.sqlite3.php">
 <link rel="prev" href="https://www.php.net/manual/en/sqlite3.querysingle.php">
 <link rel="next" href="https://www.php.net/manual/en/sqlite3.version.php">

 <link rel="alternate" href="https://www.php.net/manual/en/sqlite3.setauthorizer.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/sqlite3.setauthorizer.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/sqlite3.setauthorizer.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/sqlite3.setauthorizer.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/sqlite3.setauthorizer.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/sqlite3.setauthorizer.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/sqlite3.setauthorizer.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/sqlite3.setauthorizer.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/sqlite3.setauthorizer.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/sqlite3.setauthorizer.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/sqlite3.setauthorizer.php" hreflang="zh">
...
<meta name="Description" content="Configures a callback to be used as an authorizer to limit what a statement can do" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SQLite3::setAuthorizer - Manual" />
<meta name="twitter:description" content="Configures a callback to be used as an authorizer to limit what a statement can do" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SQLite3::setAuthorizer - Manual" />
<meta itemprop="description" content="Configures a callback to be used as an authorizer to limit what a statement can do" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Configures a callback to be used as an authorizer to limit what a statement can do" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="sqlite3.version.php">
          SQLite3::version &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="sqlite3.querysingle.php">
          &laquo; SQLite3::querySingle        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/sqlite3.setauthorizer.php' selected="selected">English</option>
            <option value='de/sqlite3.setauthorizer.php'>German</option>
            <option value='es/sqlite3.setauthorizer.php'>Spanish</option>
            <option value='fr/sqlite3.setauthorizer.php'>French</option>
            <option value='it/sqlite3.setauthorizer.php'>Italian</option>
            <option value='ja/sqlite3.setauthorizer.php'>Japanese</option>
            <option value='pt_BR/sqlite3.setauthorizer.php'>Brazilian Portuguese</option>
            <option value='ru/sqlite3.setauthorizer.php'>Russian</option>
            <option value='tr/sqlite3.setauthorizer.php'>Turkish</option>
            <option value='uk/sqlite3.setauthorizer.php'>Ukrainian</option>
            <option value='zh/sqlite3.setauthorizer.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="sqlite3.setauthorizer" class="refentry">
...
(
    ...
    [password] =&gt;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlite3/sqlite3/setauthorizer.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsqlite3.setauthorizer%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=sqlite3.setauthorizer&amp;repo=en&amp;redirect=https://www.php.net/manual/en/sqlite3.setauthorizer.php">＋<small>add a note</small></a></span>
