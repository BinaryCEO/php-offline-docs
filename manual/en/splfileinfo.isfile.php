...
<div class="phpcode"><code><span class="html">Documentation is a bit misleading.<br /><br />SplFileInfo-&gt;isFile() and other classes (e.g. DirectoryIterator-&gt;isFile()) return TRUE for symlinks of files. Better use getType() method instead, which returns 'link' for symlinks.<br /><br />This was reported long time ago - <a href="https://bugs.php.net/bug.php?id=72364" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=72364</a> , but docs are still not fixed.</span></code></div>
  </div>
 </div></div>
