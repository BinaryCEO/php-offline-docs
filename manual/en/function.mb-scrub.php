...
<head>
  ...
  <title>PHP: mb_scrub - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-scrub.php">
 <link rel="shorturl" href="https://www.php.net/mb-scrub">
 <link rel="alternate" href="https://www.php.net/mb-scrub" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-rtrim.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-send-mail.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-scrub.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-scrub.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-scrub.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-scrub.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-scrub.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-scrub.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-scrub.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-scrub.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-scrub.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-scrub.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-scrub.php" hreflang="zh">
...
<meta name="Description" content="Replace ill-formed byte sequences with the substitute character" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_scrub - Manual" />
<meta name="twitter:description" content="Replace ill-formed byte sequences with the substitute character" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_scrub - Manual" />
<meta itemprop="description" content="Replace ill-formed byte sequences with the substitute character" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Replace ill-formed byte sequences with the substitute character" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-scrub.php' selected="selected">English</option>
            <option value='de/function.mb-scrub.php'>German</option>
            <option value='es/function.mb-scrub.php'>Spanish</option>
            <option value='fr/function.mb-scrub.php'>French</option>
            <option value='it/function.mb-scrub.php'>Italian</option>
            <option value='ja/function.mb-scrub.php'>Japanese</option>
            <option value='pt_BR/function.mb-scrub.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-scrub.php'>Russian</option>
            <option value='tr/function.mb-scrub.php'>Turkish</option>
            <option value='uk/function.mb-scrub.php'>Ukrainian</option>
            <option value='zh/function.mb-scrub.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-scrub" class="refentry">
 ...
 <td>
  <code class="parameter">encoding</code> is nullable now.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-scrub.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-scrub%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-scrub&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-scrub.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122482">  <div class="votes">
    <div id="Vu122482">
    <a href="/manual/vote-note.php?id=122482&amp;page=function.mb-scrub&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122482">
    <a href="/manual/vote-note.php?id=122482&amp;page=function.mb-scrub&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122482" title="86% like this...">
    22
    </div>
  </div>
  <a href="#122482" class="name">
  <strong class="user"><em>Sammitch</em></strong></a><a class="genanchor" href="#122482"> &para;</a><div class="date" title="2018-03-06 08:32"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122482">
<div class="phpcode"><code><span class="html">Replaces 'ill-formed' byte sequences with '?'.<br /><br />See: <a href="https://github.com/php/php-src/pull/1099" rel="nofollow" target="_blank">https://github.com/php/php-src/pull/1099</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-scrub&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-scrub.php">＋<small>add a note</small></a></div>
