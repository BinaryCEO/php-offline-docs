...
<head>
  ...
  <title>PHP: ctype_alpha - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ctype-alpha.php">
 <link rel="shorturl" href="https://www.php.net/ctype-alpha">
 <link rel="alternate" href="https://www.php.net/ctype-alpha" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ctype.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ctype-alnum.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ctype-cntrl.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ctype-alpha.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ctype-alpha.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ctype-alpha.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ctype-alpha.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ctype-alpha.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ctype-alpha.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ctype-alpha.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ctype-alpha.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ctype-alpha.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ctype-alpha.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ctype-alpha.php" hreflang="zh">
...
<meta name="Description" content="Check for alphabetic character(s)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ctype_alpha - Manual" />
<meta name="twitter:description" content="Check for alphabetic character(s)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ctype_alpha - Manual" />
<meta itemprop="description" content="Check for alphabetic character(s)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check for alphabetic character(s)" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ctype-alpha.php' selected="selected">English</option>
            <option value='de/function.ctype-alpha.php'>German</option>
            <option value='es/function.ctype-alpha.php'>Spanish</option>
            <option value='fr/function.ctype-alpha.php'>French</option>
            <option value='it/function.ctype-alpha.php'>Italian</option>
            <option value='ja/function.ctype-alpha.php'>Japanese</option>
            <option value='pt_BR/function.ctype-alpha.php'>Brazilian Portuguese</option>
            <option value='ru/function.ctype-alpha.php'>Russian</option>
            <option value='tr/function.ctype-alpha.php'>Turkish</option>
            <option value='uk/function.ctype-alpha.php'>Ukrainian</option>
            <option value='zh/function.ctype-alpha.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ctype-alpha" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.isalpha.php" class="function" rel="rdfs-seeAlso">IntlChar::isalpha()</a> - Check if code point is a letter character</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ctype/functions/ctype-alpha.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ctype-alpha%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ctype-alpha&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ctype-alpha.php">＋<small>add a note</small></a></span>
