...
<head>
  ...
  <title>PHP: is_scalar - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.is-scalar.php">
 <link rel="shorturl" href="https://www.php.net/is-scalar">
 <link rel="alternate" href="https://www.php.net/is-scalar" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.var.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.is-resource.php">
 <link rel="next" href="https://www.php.net/manual/en/function.is-string.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.is-scalar.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.is-scalar.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.is-scalar.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.is-scalar.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.is-scalar.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.is-scalar.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.is-scalar.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.is-scalar.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.is-scalar.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.is-scalar.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.is-scalar.php" hreflang="zh">
...
<meta name="Description" content="Finds whether a variable is a scalar" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: is_scalar - Manual" />
<meta name="twitter:description" content="Finds whether a variable is a scalar" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: is_scalar - Manual" />
<meta itemprop="description" content="Finds whether a variable is a scalar" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Finds whether a variable is a scalar" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.is-string.php">
          is_string &raquo;
              ...
              <div class="prev">
        <a href="function.is-resource.php">
          &laquo; is_resource        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.is-scalar.php' selected="selected">English</option>
            <option value='de/function.is-scalar.php'>German</option>
            <option value='es/function.is-scalar.php'>Spanish</option>
            <option value='fr/function.is-scalar.php'>French</option>
            <option value='it/function.is-scalar.php'>Italian</option>
            <option value='ja/function.is-scalar.php'>Japanese</option>
            <option value='pt_BR/function.is-scalar.php'>Brazilian Portuguese</option>
            <option value='ru/function.is-scalar.php'>Russian</option>
            <option value='tr/function.is-scalar.php'>Turkish</option>
            <option value='uk/function.is-scalar.php'>Ukrainian</option>
            <option value='zh/function.is-scalar.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.is-scalar" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.is-scalar-examples">
  ...
  <p class="para">
   <div class="example" id="example-5660">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.is-array.php" class="function" rel="rdfs-seeAlso">is_array()</a> - Finds whether a variable is an array</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/var/functions/is-scalar.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.is-scalar%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.is-scalar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-scalar.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="55813">  <div class="votes">
    <div id="Vu55813">
    <a href="/manual/vote-note.php?id=55813&amp;page=function.is-scalar&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd55813">
    <a href="/manual/vote-note.php?id=55813&amp;page=function.is-scalar&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V55813" title="73% like this...">
    22
    </div>
  </div>
  <a href="#55813" class="name">
  <strong class="user"><em>Dr K</em></strong></a><a class="genanchor" href="#55813"> &para;</a><div class="date" title="2005-08-14 03:48"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom55813">
<div class="phpcode"><code><span class="html">Having hunted around the manual, I've not found a clear statement of what makes a type "scalar" (e.g. if some future version of the language introduces a new kind of type, what criterion will decide if it's "scalar"? - that goes beyond just listing what's scalar in the current version.)<br /><br />In other lanuages, it means "has ordering operators" - i.e. "less than" and friends.<br /><br />It (-:currently:-) appears to have the same meaning in PHP.</span></code></div>
  </div>
 </div>
  <div class="note" id="68522">  <div class="votes">
    <div id="Vu68522">
    <a href="/manual/vote-note.php?id=68522&amp;page=function.is-scalar&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd68522">
    <a href="/manual/vote-note.php?id=68522&amp;page=function.is-scalar&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V68522" title="65% like this...">
    11
    </div>
  </div>
  <a href="#68522" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#68522"> &para;</a><div class="date" title="2006-07-31 08:59"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom68522">
<div class="phpcode"><code><span class="html">Another warning in response to the previous note:<br />&gt; just a warning as it appears that an empty value is not a scalar.<br /><br />That statement is wrong--or, at least, has been fixed with a later revision than the one tested.  The following code generated the following output on PHP 4.3.9.<br /><br />CODE:<br /><span class="default">&lt;?php<br />    </span><span class="keyword">echo(</span><span class="string">'is_scalar() test:'</span><span class="keyword">.</span><span class="default">EOL</span><span class="keyword">);<br />    echo(</span><span class="string">"NULL: "      </span><span class="keyword">. </span><span class="default">print_R</span><span class="keyword">(</span><span class="default">is_scalar</span><span class="keyword">(</span><span class="default">NULL</span><span class="keyword">),     </span><span class="default">true</span><span class="keyword">) . </span><span class="default">EOL</span><span class="keyword">);<br />    echo(</span><span class="string">"false: "    </span><span class="keyword">. </span><span class="default">print_R</span><span class="keyword">(</span><span class="default">is_scalar</span><span class="keyword">(</span><span class="default">false</span><span class="keyword">),   </span><span class="default">true</span><span class="keyword">) . </span><span class="default">EOL</span><span class="keyword">);<br />    echo(</span><span class="string">"(empty): "  </span><span class="keyword">. </span><span class="default">print_R</span><span class="keyword">(</span><span class="default">is_scalar</span><span class="keyword">(</span><span class="string">''</span><span class="keyword">),      </span><span class="default">true</span><span class="keyword">) . </span><span class="default">EOL</span><span class="keyword">);<br />    echo(</span><span class="string">"0: "         </span><span class="keyword">. </span><span class="default">print_R</span><span class="keyword">(</span><span class="default">is_scalar</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">),       </span><span class="default">true</span><span class="keyword">) . </span><span class="default">EOL</span><span class="keyword">);<br />    echo(</span><span class="string">"'0': "      </span><span class="keyword">. </span><span class="default">print_R</span><span class="keyword">(</span><span class="default">is_scalar</span><span class="keyword">(</span><span class="string">'0'</span><span class="keyword">),     </span><span class="default">true</span><span class="keyword">) . </span><span class="default">EOL</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />OUTPUT:<br />is_scalar() test:<br />NULL: <br />false: 1<br />(empty): 1<br />0: 1<br />'0': 1<br /><br />THUS:<br />   * NULL is NOT a scalar<br />   * false, (empty string), 0, and "0" ARE scalars</span></code></div>
  </div>
 </div>
  <div class="note" id="55925">  <div class="votes">
    <div id="Vu55925">
    <a href="/manual/vote-note.php?id=55925&amp;page=function.is-scalar&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd55925">
    <a href="/manual/vote-note.php?id=55925&amp;page=function.is-scalar&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V55925" title="68% like this...">
    8
    </div>
  </div>
  <a href="#55925" class="name">
  <strong class="user"><em>efelch at gmail dot com</em></strong></a><a class="genanchor" href="#55925"> &para;</a><div class="date" title="2005-08-17 02:31"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom55925">
<div class="phpcode"><code><span class="html">A scalar is a single item or value, compared to things like arrays and objects which have multiple values. This tends to be the standard definition of the word in terms of programming. An integer, character, etc are scalars. Strings are probably considered scalars since they only hold "one" value (the value represented by the characters represented) and nothing else.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.is-scalar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-scalar.php">＋<small>add a note</small></a></div>
