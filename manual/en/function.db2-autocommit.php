...
<head>
  ...
  <title>PHP: db2_autocommit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-autocommit.php">
 <link rel="shorturl" href="https://www.php.net/db2-autocommit">
 <link rel="alternate" href="https://www.php.net/db2-autocommit" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-bind-param.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-autocommit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-autocommit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-autocommit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-autocommit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-autocommit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-autocommit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-autocommit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-autocommit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-autocommit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-autocommit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-autocommit.php" hreflang="zh">
...
<meta name="Description" content="Returns or sets the AUTOCOMMIT state for a database connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_autocommit - Manual" />
<meta name="twitter:description" content="Returns or sets the AUTOCOMMIT state for a database connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_autocommit - Manual" />
<meta itemprop="description" content="Returns or sets the AUTOCOMMIT state for a database connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns or sets the AUTOCOMMIT state for a database connection" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.db2-bind-param.php">
          db2_bind_param &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.ibm-db2.php">
          &laquo; IBM DB2 Functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-autocommit.php' selected="selected">English</option>
            <option value='de/function.db2-autocommit.php'>German</option>
            <option value='es/function.db2-autocommit.php'>Spanish</option>
            <option value='fr/function.db2-autocommit.php'>French</option>
            <option value='it/function.db2-autocommit.php'>Italian</option>
            <option value='ja/function.db2-autocommit.php'>Japanese</option>
            <option value='pt_BR/function.db2-autocommit.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-autocommit.php'>Russian</option>
            <option value='tr/function.db2-autocommit.php'>Turkish</option>
            <option value='uk/function.db2-autocommit.php'>Ukrainian</option>
            <option value='zh/function.db2-autocommit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-autocommit" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.db2-autocommit-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_autocommit</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$connection</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code><span class="initializer"> = ?</span></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>
     ...
     <dd>
      <p class="para">
       ...
       <dl>
         ...
         <dt><strong><code><a href="ibm-db2.constants.php#constant.db2-autocommit-off">DB2_AUTOCOMMIT_OFF</a></code></strong></dt>
         <dd>
          <p class="para">
         ...
         <dt><strong><code><a href="ibm-db2.constants.php#constant.db2-autocommit-on">DB2_AUTOCOMMIT_ON</a></code></strong></dt>
         <dd>
          <p class="para">
           Turns AUTOCOMMIT on.
          </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-autocommit-returnvalues">
  ...
  <p class="para">
   ...
   <strong><code><a href="ibm-db2.constants.php#constant.db2-autocommit-off">DB2_AUTOCOMMIT_OFF</a></code></strong> indicates that AUTOCOMMIT is off,
   while a value of <strong><code><a href="ibm-db2.constants.php#constant.db2-autocommit-on">DB2_AUTOCOMMIT_ON</a></code></strong> indicates that
   AUTOCOMMIT is on.
  </p>
  <p class="para">
 ...
 <div class="refsect1 examples" id="refsect1-function.db2-autocommit-examples">
  ...
  <p class="para">
   <div class="example" id="example-1339">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$options </span><span style="color: #007700">= array(</span><span style="color: #DD0000">'autocommit' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">DB2_AUTOCOMMIT_OFF</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">db2_connect</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #0000BB">$user</span><span style="color: #007700">, </span><span style="color: #0000BB">$password</span><span style="color: #007700">, </span><span style="color: #0000BB">$options</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Turn AUTOCOMMIT on<br /></span><span style="color: #0000BB">$rc </span><span style="color: #007700">= </span><span style="color: #0000BB">db2_autocommit</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">DB2_AUTOCOMMIT_ON</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">$rc</span><span style="color: #007700">) {<br />    print </span><span style="color: #DD0000">"Turning AUTOCOMMIT on succeeded.\n"</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #FF8000">// Check AUTOCOMMIT state<br /></span><span style="color: #0000BB">$ac </span><span style="color: #007700">= </span><span style="color: #0000BB">db2_autocommit</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">$ac </span><span style="color: #007700">== </span><span style="color: #0000BB">DB2_AUTOCOMMIT_OFF</span><span style="color: #007700">) {<br />    print </span><span style="color: #DD0000">"</span><span style="color: #0000BB">$ac</span><span style="color: #DD0000"> -- AUTOCOMMIT is off."</span><span style="color: #007700">;<br />} else {<br />    print </span><span style="color: #DD0000">"</span><span style="color: #0000BB">$ac</span><span style="color: #DD0000"> -- AUTOCOMMIT is on."</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="example-contents"><p>The above example will output:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">Turning AUTOCOMMIT on succeeded.
1 -- AUTOCOMMIT is on.</pre>
</div>
    </div>
   </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-pconnect.php" class="function" rel="rdfs-seeAlso">db2_pconnect()</a> - Returns a persistent connection to a database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-autocommit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-autocommit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-autocommit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-autocommit.php">＋<small>add a note</small></a></span>
