...
<head>
  ...
  <title>PHP: Imagick::getImageWidth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagewidth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagewidth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagewidth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagewhitepoint.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getinterlacescheme.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagewidth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagewidth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagewidth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagewidth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagewidth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagewidth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagewidth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagewidth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagewidth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagewidth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagewidth.php" hreflang="zh">
...
<meta name="Description" content="Returns the image width" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageWidth - Manual" />
<meta name="twitter:description" content="Returns the image width" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageWidth - Manual" />
<meta itemprop="description" content="Returns the image width" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the image width" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getinterlacescheme.php">
          Imagick::getInterlaceScheme &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagewhitepoint.php">
          &laquo; Imagick::getImageWhitePoint        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagewidth.php' selected="selected">English</option>
            <option value='de/imagick.getimagewidth.php'>German</option>
            <option value='es/imagick.getimagewidth.php'>Spanish</option>
            <option value='fr/imagick.getimagewidth.php'>French</option>
            <option value='it/imagick.getimagewidth.php'>Italian</option>
            <option value='ja/imagick.getimagewidth.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagewidth.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagewidth.php'>Russian</option>
            <option value='tr/imagick.getimagewidth.php'>Turkish</option>
            <option value='uk/imagick.getimagewidth.php'>Ukrainian</option>
            <option value='zh/imagick.getimagewidth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagewidth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageWidth</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageWidth</span> &mdash; <span class="dc-title">Returns the image width</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagewidth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageWidth</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagewidth-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagewidth-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagewidth-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagewidth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagewidth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagewidth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagewidth.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117118">  <div class="votes">
    <div id="Vu117118">
    <a href="/manual/vote-note.php?id=117118&amp;page=imagick.getimagewidth&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117118">
    <a href="/manual/vote-note.php?id=117118&amp;page=imagick.getimagewidth&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117118" title="100% like this...">
    3
    </div>
  </div>
  <a href="#117118" class="name">
  <strong class="user"><em>bob at majdak dot net</em></strong></a><a class="genanchor" href="#117118"> &para;</a><div class="date" title="2015-04-16 08:08"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117118">
<div class="phpcode"><code><span class="html">I am noticing that this is returning the original size of the image when it was opened, and not the size it may have been resized to with scaleImage or resizeImage.</span></code></div>
  </div>
 </div>
  <div class="note" id="114643">  <div class="votes">
    <div id="Vu114643">
    <a href="/manual/vote-note.php?id=114643&amp;page=imagick.getimagewidth&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114643">
    <a href="/manual/vote-note.php?id=114643&amp;page=imagick.getimagewidth&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114643" title="53% like this...">
    1
    </div>
  </div>
  <a href="#114643" class="name">
  <strong class="user"><em>terry</em></strong></a><a class="genanchor" href="#114643"> &para;</a><div class="date" title="2014-03-16 12:16"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114643">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">"picture.jpg"</span><span class="keyword">);<br /></span><span class="default">$width </span><span class="keyword">= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getImageWidth</span><span class="keyword">();<br />print </span><span class="string">"the image width is " </span><span class="keyword">. </span><span class="default">$width </span><span class="keyword">. </span><span class="string">" pixels"</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;<br /></span><br />Will print:<br />the image width is 200 pixels</span></code></div>
  </div>
 </div>
  <div class="note" id="117716">  <div class="votes">
    <div id="Vu117716">
    <a href="/manual/vote-note.php?id=117716&amp;page=imagick.getimagewidth&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117716">
    <a href="/manual/vote-note.php?id=117716&amp;page=imagick.getimagewidth&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117716" title="no votes...">
    0
    </div>
  </div>
  <a href="#117716" class="name">
  <strong class="user"><em>nospam dot karst at onlinq dot nl</em></strong></a><a class="genanchor" href="#117716"> &para;</a><div class="date" title="2015-07-28 07:19"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117716">
<div class="phpcode"><code><span class="html">"bob at majdak dot net" mentioned that this function does not return the resized image size.<br /><br />I use this function in production code, and it correctly returns the width for an image resized with `resizeImage()`. <br />I have not tested it with `scaleImage()`.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagewidth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagewidth.php">＋<small>add a note</small></a></div>
