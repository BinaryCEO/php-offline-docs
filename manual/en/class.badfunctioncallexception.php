...
<head>
  ...
  <title>PHP: BadFunctionCallException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.badfunctioncallexception.php">
 <link rel="shorturl" href="https://www.php.net/badfunctioncallexception">
 <link rel="alternate" href="https://www.php.net/badfunctioncallexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/spl.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/spl.exceptions.php">
 <link rel="next" href="https://www.php.net/manual/en/class.badmethodcallexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.badfunctioncallexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.badfunctioncallexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.badfunctioncallexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.badfunctioncallexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.badfunctioncallexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.badfunctioncallexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.badfunctioncallexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.badfunctioncallexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.badfunctioncallexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.badfunctioncallexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.badfunctioncallexception.php" hreflang="zh">
...
<meta name="Description" content="The BadFunctionCallException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: BadFunctionCallException - Manual" />
<meta name="twitter:description" content="The BadFunctionCallException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: BadFunctionCallException - Manual" />
<meta itemprop="description" content="The BadFunctionCallException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The BadFunctionCallException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.badmethodcallexception.php">
          BadMethodCallException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="spl.exceptions.php">
          &laquo; Exceptions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.badfunctioncallexception.php' selected="selected">English</option>
            <option value='de/class.badfunctioncallexception.php'>German</option>
            <option value='es/class.badfunctioncallexception.php'>Spanish</option>
            <option value='fr/class.badfunctioncallexception.php'>French</option>
            <option value='it/class.badfunctioncallexception.php'>Italian</option>
            <option value='ja/class.badfunctioncallexception.php'>Japanese</option>
            <option value='pt_BR/class.badfunctioncallexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.badfunctioncallexception.php'>Russian</option>
            <option value='tr/class.badfunctioncallexception.php'>Turkish</option>
            <option value='uk/class.badfunctioncallexception.php'>Ukrainian</option>
            <option value='zh/class.badfunctioncallexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.badfunctioncallexception" class="reference">
 <h1 class="title">The BadFunctionCallException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p>
 

  <div class="section" id="badfunctioncallexception.intro">
  ...
  <div class="section" id="badfunctioncallexception.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">BadFunctionCallException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/badfunctioncallexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.badfunctioncallexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.badfunctioncallexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.badfunctioncallexception.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120527">  <div class="votes">
    <div id="Vu120527">
    <a href="/manual/vote-note.php?id=120527&amp;page=class.badfunctioncallexception&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120527">
    <a href="/manual/vote-note.php?id=120527&amp;page=class.badfunctioncallexception&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120527" title="55% like this...">
    3
    </div>
  </div>
  <a href="#120527" class="name">
  <strong class="user"><em>evguenia dot chagnon at gmail dot com</em></strong></a><a class="genanchor" href="#120527"> &para;</a><div class="date" title="2017-01-26 12:14"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120527">
<div class="phpcode"><code><span class="html">For example: <br /><br />function foo($arg) {<br />    $func = 'do' . $arg;<br />    if (!is_callable($func)) {<br />        throw new BadFunctionCallException('Function ' . $func . ' is not callable');<br />    }<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="94635">  <div class="votes">
    <div id="Vu94635">
    <a href="/manual/vote-note.php?id=94635&amp;page=class.badfunctioncallexception&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94635">
    <a href="/manual/vote-note.php?id=94635&amp;page=class.badfunctioncallexception&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94635" title="50% like this...">
    0
    </div>
  </div>
  <a href="#94635" class="name">
  <strong class="user"><em>tom at tomwardrop dot com</em></strong></a><a class="genanchor" href="#94635"> &para;</a><div class="date" title="2009-11-15 07:42"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94635">
<div class="phpcode"><code><span class="html">A typical use for this exception, is in conjunction with the is_callable() function.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.badfunctioncallexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.badfunctioncallexception.php">＋<small>add a note</small></a></div>
