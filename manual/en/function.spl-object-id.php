...
<head>
  ...
  <title>PHP: spl_object_id - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.spl-object-id.php">
 <link rel="shorturl" href="https://www.php.net/spl-object-id">
 <link rel="alternate" href="https://www.php.net/spl-object-id" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.spl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.spl-object-hash.php">
 <link rel="next" href="https://www.php.net/manual/en/book.stream.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.spl-object-id.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.spl-object-id.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.spl-object-id.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.spl-object-id.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.spl-object-id.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.spl-object-id.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.spl-object-id.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.spl-object-id.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.spl-object-id.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.spl-object-id.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.spl-object-id.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.stream.php">
          Streams &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.spl-object-hash.php">
          &laquo; spl_object_hash        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.spl-object-id.php' selected="selected">English</option>
            <option value='de/function.spl-object-id.php'>German</option>
            <option value='es/function.spl-object-id.php'>Spanish</option>
            <option value='fr/function.spl-object-id.php'>French</option>
            <option value='it/function.spl-object-id.php'>Italian</option>
            <option value='ja/function.spl-object-id.php'>Japanese</option>
            <option value='pt_BR/function.spl-object-id.php'>Brazilian Portuguese</option>
            <option value='ru/function.spl-object-id.php'>Russian</option>
            <option value='tr/function.spl-object-id.php'>Turkish</option>
            <option value='uk/function.spl-object-id.php'>Ukrainian</option>
            <option value='zh/function.spl-object-id.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.spl-object-id" class="refentry">
   ...
   <p class="para">
    When an object is destroyed, its id may be reused for other objects.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/functions/spl-object-id.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.spl-object-id%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.spl-object-id&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.spl-object-id.php">＋<small>add a note</small></a></span>
