...
<head>
  ...
  <title>PHP: wincache_ucache_delete - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-ucache-delete.php">
 <link rel="shorturl" href="https://www.php.net/wincache-ucache-delete">
 <link rel="alternate" href="https://www.php.net/wincache-ucache-delete" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-ucache-dec.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-ucache-exists.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-ucache-delete.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-ucache-delete.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-ucache-delete.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-ucache-delete.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-ucache-delete.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-ucache-delete.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-ucache-delete.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-ucache-delete.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-ucache-delete.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-ucache-delete.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-ucache-delete.php" hreflang="zh">
...
<meta name="Description" content="Deletes variables from the user cache" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_ucache_delete - Manual" />
<meta name="twitter:description" content="Deletes variables from the user cache" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_ucache_delete - Manual" />
<meta itemprop="description" content="Deletes variables from the user cache" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Deletes variables from the user cache" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.wincache-ucache-exists.php">
          wincache_ucache_exists &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-ucache-dec.php">
          &laquo; wincache_ucache_dec        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-ucache-delete.php' selected="selected">English</option>
            <option value='de/function.wincache-ucache-delete.php'>German</option>
            <option value='es/function.wincache-ucache-delete.php'>Spanish</option>
            <option value='fr/function.wincache-ucache-delete.php'>French</option>
            <option value='it/function.wincache-ucache-delete.php'>Italian</option>
            <option value='ja/function.wincache-ucache-delete.php'>Japanese</option>
            <option value='pt_BR/function.wincache-ucache-delete.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-ucache-delete.php'>Russian</option>
            <option value='tr/function.wincache-ucache-delete.php'>Turkish</option>
            <option value='uk/function.wincache-ucache-delete.php'>Ukrainian</option>
            <option value='zh/function.wincache-ucache-delete.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-ucache-delete" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.wincache-ucache-delete-examples">
  ...
  <p class="para">
   <div class="example" id="example-751">
    <p><strong>Example #1 Using <span class="function"><strong>wincache_ucache_delete()</strong></span> with <code class="parameter">key</code> as a string</strong></p>
...
bool(false)</pre>
  ...
  <p class="para">
   <div class="example" id="example-752">
    <p><strong>Example #2 Using<span class="function"><strong>wincache_ucache_delete()</strong></span> with <code class="parameter">key</code> as an array</strong></p>
    <div class="example-contents">
...
<div class="examplescode"><pre class="examplescode">array(4) { [0]=&gt; string(5) &quot;green&quot; 
  ...
  <p class="para">
   <div class="example" id="example-753">
    <p><strong>Example #3 Using <span class="function"><strong>wincache_ucache_delete()</strong></span> with <code class="parameter">key</code> as an array where some elements cannot be deleted</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.wincache-ucache-info.php" class="function" rel="rdfs-seeAlso">wincache_ucache_info()</a> - Retrieves information about data stored in the user cache</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-ucache-delete.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-ucache-delete%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-ucache-delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-ucache-delete.php">＋<small>add a note</small></a></span>
