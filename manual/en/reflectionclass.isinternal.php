...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.isinternal.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.isinternal.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isinternal.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.isinterface.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.isiterable.php">
...
<meta name="Description" content="Checks if class is defined internally by an extension, or the core" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::isInternal - Manual" />
<meta name="twitter:description" content="Checks if class is defined internally by an extension, or the core" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::isInternal - Manual" />
<meta itemprop="description" content="Checks if class is defined internally by an extension, or the core" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if class is defined internally by an extension, or the core" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.isinternal.php' selected="selected">English</option>
            ...
            <option value='zh/reflectionclass.isinternal.php'>Chinese (Simplified)</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::isInternal</span> &mdash; <span class="dc-title">Checks if class is defined internally by an extension, or the core</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.isinternal-examples">
  ...
  <p class="para">
   <div class="example" id="example-5503">
    <p><strong>Example #1 Basic usage of <span class="methodname"><strong>ReflectionClass::isInternal()</strong></span></strong></p>
...
bool(false)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.isinternal-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.isuserdefined.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::isUserDefined()</a> - Checks if user defined</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/isinternal.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.isinternal%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.isinternal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isinternal.php">＋<small>add a note</small></a></span>
