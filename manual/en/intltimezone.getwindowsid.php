...
<head>
  ...
  <title>PHP: IntlTimeZone::getWindowsID - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intltimezone.getwindowsid.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intltimezone.getwindowsid.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intltimezone.getwindowsid.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intltimezone.php">
 <link rel="prev" href="https://www.php.net/manual/en/intltimezone.getunknown.php">
 <link rel="next" href="https://www.php.net/manual/en/intltimezone.hassamerules.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intltimezone.getwindowsid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intltimezone.getwindowsid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intltimezone.getwindowsid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intltimezone.getwindowsid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intltimezone.getwindowsid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intltimezone.getwindowsid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intltimezone.getwindowsid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intltimezone.getwindowsid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intltimezone.getwindowsid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intltimezone.getwindowsid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intltimezone.getwindowsid.php" hreflang="zh">
...
<meta name="Description" content="Translate a system timezone into a Windows timezone" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlTimeZone::getWindowsID - Manual" />
<meta name="twitter:description" content="Translate a system timezone into a Windows timezone" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlTimeZone::getWindowsID - Manual" />
<meta itemprop="description" content="Translate a system timezone into a Windows timezone" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Translate a system timezone into a Windows timezone" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intltimezone.hassamerules.php">
          IntlTimeZone::hasSameRules &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intltimezone.getunknown.php">
          &laquo; IntlTimeZone::getUnknown        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intltimezone.getwindowsid.php' selected="selected">English</option>
            <option value='de/intltimezone.getwindowsid.php'>German</option>
            <option value='es/intltimezone.getwindowsid.php'>Spanish</option>
            <option value='fr/intltimezone.getwindowsid.php'>French</option>
            <option value='it/intltimezone.getwindowsid.php'>Italian</option>
            <option value='ja/intltimezone.getwindowsid.php'>Japanese</option>
            <option value='pt_BR/intltimezone.getwindowsid.php'>Brazilian Portuguese</option>
            <option value='ru/intltimezone.getwindowsid.php'>Russian</option>
            <option value='tr/intltimezone.getwindowsid.php'>Turkish</option>
            <option value='uk/intltimezone.getwindowsid.php'>Ukrainian</option>
            <option value='zh/intltimezone.getwindowsid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intltimezone.getwindowsid" class="refentry">
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-intltimezone.getwindowsid-returnvalues">
  ...
  <p class="para">
   Returns the Windows timezone or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="intltimezone.getidforwindowsid.php" class="methodname" rel="rdfs-seeAlso">IntlTimeZone::getIDForWindowsID()</a> - Translate a Windows timezone into a system timezone</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intltimezone/getwindowsid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintltimezone.getwindowsid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intltimezone.getwindowsid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intltimezone.getwindowsid.php">＋<small>add a note</small></a></span>
