...
<head>
  ...
  <title>PHP: Imagick::selectiveBlurImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.selectiveblurimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.selectiveblurimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.selectiveblurimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.segmentimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.separateimagechannel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.selectiveblurimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.selectiveblurimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.selectiveblurimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.selectiveblurimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.selectiveblurimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.selectiveblurimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.selectiveblurimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.selectiveblurimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.selectiveblurimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.selectiveblurimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.selectiveblurimage.php" hreflang="zh">
...
<meta name="Description" content="Selectively blur an image within a contrast threshold" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::selectiveBlurImage - Manual" />
<meta name="twitter:description" content="Selectively blur an image within a contrast threshold" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::selectiveBlurImage - Manual" />
<meta itemprop="description" content="Selectively blur an image within a contrast threshold" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Selectively blur an image within a contrast threshold" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.separateimagechannel.php">
          Imagick::separateImageChannel &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.segmentimage.php">
          &laquo; Imagick::segmentImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.selectiveblurimage.php' selected="selected">English</option>
            <option value='de/imagick.selectiveblurimage.php'>German</option>
            <option value='es/imagick.selectiveblurimage.php'>Spanish</option>
            <option value='fr/imagick.selectiveblurimage.php'>French</option>
            <option value='it/imagick.selectiveblurimage.php'>Italian</option>
            <option value='ja/imagick.selectiveblurimage.php'>Japanese</option>
            <option value='pt_BR/imagick.selectiveblurimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.selectiveblurimage.php'>Russian</option>
            <option value='tr/imagick.selectiveblurimage.php'>Turkish</option>
            <option value='uk/imagick.selectiveblurimage.php'>Ukrainian</option>
            <option value='zh/imagick.selectiveblurimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.selectiveblurimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::selectiveBlurImage</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::selectiveBlurImage</span> &mdash; <span class="dc-title">Selectively blur an image within a contrast threshold</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.selectiveblurimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::selectiveBlurImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$sigma</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$threshold</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.selectiveblurimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.selectiveblurimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3086">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/selectiveblurimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.selectiveblurimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.selectiveblurimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.selectiveblurimage.php">＋<small>add a note</small></a></span>
