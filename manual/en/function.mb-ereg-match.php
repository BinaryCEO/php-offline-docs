...
<head>
  ...
  <title>PHP: mb_ereg_match - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-ereg-match.php">
 <link rel="shorturl" href="https://www.php.net/mb-ereg-match">
 <link rel="alternate" href="https://www.php.net/mb-ereg-match" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-ereg.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-ereg-replace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-ereg-match.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-ereg-match.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-ereg-match.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-ereg-match.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-ereg-match.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-ereg-match.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-ereg-match.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-ereg-match.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-ereg-match.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-ereg-match.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-ereg-match.php" hreflang="zh">
...
<meta name="Description" content="Regular expression match for multibyte string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_ereg_match - Manual" />
<meta name="twitter:description" content="Regular expression match for multibyte string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_ereg_match - Manual" />
<meta itemprop="description" content="Regular expression match for multibyte string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Regular expression match for multibyte string" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mb-ereg-replace.php">
          mb_ereg_replace &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mb-ereg.php">
          &laquo; mb_ereg        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-ereg-match.php' selected="selected">English</option>
            <option value='de/function.mb-ereg-match.php'>German</option>
            <option value='es/function.mb-ereg-match.php'>Spanish</option>
            <option value='fr/function.mb-ereg-match.php'>French</option>
            <option value='it/function.mb-ereg-match.php'>Italian</option>
            <option value='ja/function.mb-ereg-match.php'>Japanese</option>
            <option value='pt_BR/function.mb-ereg-match.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-ereg-match.php'>Russian</option>
            <option value='tr/function.mb-ereg-match.php'>Turkish</option>
            <option value='uk/function.mb-ereg-match.php'>Ukrainian</option>
            <option value='zh/function.mb-ereg-match.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-ereg-match" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_ereg_match</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_ereg_match</span> &mdash; <span class="dc-title">Regular expression match for multibyte string</span></p>

 </div>
   
 <div class="refsect1 description" id="refsect1-function.mb-ereg-match-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_ereg_match</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pattern</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$options</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   A regular expression match for a multibyte string
   <blockquote class="note"><p><strong class="note">Note</strong>: 
    <span class="simpara">
     <code class="parameter">pattern</code> is only matched at the beginning of
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-ereg-match-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The <span class="type"><a href="language.types.string.php" class="type string">string</a></span> being evaluated.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-ereg-match-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="simpara">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if
   <code class="parameter">string</code> matches the regular expression
   <code class="parameter">pattern</code>, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.mb-ereg-match-changelog">
 ...
 <div class="refsect1 notes" id="refsect1-function.mb-ereg-match-notes">
...
will be used as the character encoding for this function.</p></p></blockquote>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mb-ereg-match-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-ereg.php" class="function" rel="rdfs-seeAlso">mb_ereg()</a> - Regular expression match with multibyte support</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-ereg-match.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-ereg-match%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-ereg-match&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-ereg-match.php">＋<small>add a note</small></a></span>
