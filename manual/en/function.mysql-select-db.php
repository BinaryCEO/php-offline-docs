...
<head>
  ...
  <title>PHP: mysql_select_db - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-select-db.php">
 <link rel="shorturl" href="https://www.php.net/mysql-select-db">
 <link rel="alternate" href="https://www.php.net/mysql-select-db" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-set-charset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-select-db.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-select-db.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-select-db.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-select-db.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-select-db.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-select-db.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-select-db.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-select-db.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-select-db.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-select-db.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-select-db.php" hreflang="zh">
...
<meta name="Description" content="Select a MySQL database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_select_db - Manual" />
<meta name="twitter:description" content="Select a MySQL database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_select_db - Manual" />
<meta itemprop="description" content="Select a MySQL database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Select a MySQL database" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-set-charset.php">
          mysql_set_charset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-result.php">
          &laquo; mysql_result        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-select-db.php' selected="selected">English</option>
            <option value='de/function.mysql-select-db.php'>German</option>
            <option value='es/function.mysql-select-db.php'>Spanish</option>
            <option value='fr/function.mysql-select-db.php'>French</option>
            <option value='it/function.mysql-select-db.php'>Italian</option>
            <option value='ja/function.mysql-select-db.php'>Japanese</option>
            <option value='pt_BR/function.mysql-select-db.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-select-db.php'>Russian</option>
            <option value='tr/function.mysql-select-db.php'>Turkish</option>
            <option value='uk/function.mysql-select-db.php'>Ukrainian</option>
            <option value='zh/function.mysql-select-db.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-select-db" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-query.php" class="function" rel="rdfs-seeAlso">mysql_query()</a> - Send a MySQL query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-select-db.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-select-db%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-select-db&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-select-db.php">＋<small>add a note</small></a></span>
