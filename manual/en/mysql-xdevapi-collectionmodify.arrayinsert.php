...
<head>
  ...
  <title>PHP: CollectionModify::arrayInsert - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.arrayinsert.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.arrayinsert.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.arrayinsert.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-collectionmodify.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.arrayappend.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.bind.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.arrayinsert.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysql-xdevapi-collectionmodify.arrayinsert.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysql-xdevapi-collectionmodify.arrayinsert.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysql-xdevapi-collectionmodify.arrayinsert.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysql-xdevapi-collectionmodify.arrayinsert.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysql-xdevapi-collectionmodify.arrayinsert.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysql-xdevapi-collectionmodify.arrayinsert.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.arrayinsert.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysql-xdevapi-collectionmodify.arrayinsert.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysql-xdevapi-collectionmodify.arrayinsert.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysql-xdevapi-collectionmodify.arrayinsert.php" hreflang="zh">
...
<meta name="Description" content="Insert element into an array field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CollectionModify::arrayInsert - Manual" />
<meta name="twitter:description" content="Insert element into an array field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CollectionModify::arrayInsert - Manual" />
<meta itemprop="description" content="Insert element into an array field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Insert element into an array field" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysql-xdevapi-collectionmodify.bind.php">
          CollectionModify::bind &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysql-xdevapi-collectionmodify.arrayappend.php">
          &laquo; CollectionModify::arrayAppend        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-collectionmodify.arrayinsert.php' selected="selected">English</option>
            <option value='de/mysql-xdevapi-collectionmodify.arrayinsert.php'>German</option>
            <option value='es/mysql-xdevapi-collectionmodify.arrayinsert.php'>Spanish</option>
            <option value='fr/mysql-xdevapi-collectionmodify.arrayinsert.php'>French</option>
            <option value='it/mysql-xdevapi-collectionmodify.arrayinsert.php'>Italian</option>
            <option value='ja/mysql-xdevapi-collectionmodify.arrayinsert.php'>Japanese</option>
            <option value='pt_BR/mysql-xdevapi-collectionmodify.arrayinsert.php'>Brazilian Portuguese</option>
            <option value='ru/mysql-xdevapi-collectionmodify.arrayinsert.php'>Russian</option>
            <option value='tr/mysql-xdevapi-collectionmodify.arrayinsert.php'>Turkish</option>
            <option value='uk/mysql-xdevapi-collectionmodify.arrayinsert.php'>Ukrainian</option>
            <option value='zh/mysql-xdevapi-collectionmodify.arrayinsert.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysql-xdevapi-collectionmodify.arrayinsert" class="refentry">
...
(
    [0] =&gt; Array
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/collectionmodify/arrayinsert.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-collectionmodify.arrayinsert%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-collectionmodify.arrayinsert&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.arrayinsert.php">＋<small>add a note</small></a></span>
