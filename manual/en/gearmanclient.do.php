...
<head>
  ...
  <title>PHP: GearmanClient::do - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.do.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.do.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.do.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.data.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.dobackground.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.do.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.do.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.do.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.do.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.do.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.do.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.do.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.do.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.do.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.do.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.do.php" hreflang="zh">
...
<meta name="Description" content="Run a single task and return a result [deprecated]" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::do - Manual" />
<meta name="twitter:description" content="Run a single task and return a result [deprecated]" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::do - Manual" />
<meta itemprop="description" content="Run a single task and return a result [deprecated]" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Run a single task and return a result [deprecated]" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gearmanclient.dobackground.php">
          GearmanClient::doBackground &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.data.php">
          &laquo; GearmanClient::data        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.do.php' selected="selected">English</option>
            <option value='de/gearmanclient.do.php'>German</option>
            <option value='es/gearmanclient.do.php'>Spanish</option>
            <option value='fr/gearmanclient.do.php'>French</option>
            <option value='it/gearmanclient.do.php'>Italian</option>
            <option value='ja/gearmanclient.do.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.do.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.do.php'>Russian</option>
            <option value='tr/gearmanclient.do.php'>Turkish</option>
            <option value='uk/gearmanclient.do.php'>Ukrainian</option>
            <option value='zh/gearmanclient.do.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.do" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">GearmanClient::do</h1>
  <p class="verinfo">(PECL gearman &gt;= 0.5.0)</p><p class="refpurpose"><span class="refname">GearmanClient::do</span> &mdash; <span class="dc-title">Run a single task and return a result [deprecated]</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gearmanclient.do-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GearmanClient::do</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$function_name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$workload</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$unique</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   The <span class="methodname"><strong>GearmanClient::do()</strong></span> method is deprecated as of
   pecl/gearman 1.0.0. Use <span class="methodname"><a href="gearmanclient.donormal.php" class="methodname">GearmanClient::doNormal()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-gearmanclient.do-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gearmanclient.do-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-gearmanclient.do-examples">
...
Success: !olleH</pre>
   ...
   <div class="example" id="example-4601">
    ...
    <div class="example-contents"><p>
     ...
     Each subsequent call to <span class="methodname"><strong>GearmanClient::do()</strong></span>
...
Success: !olleH</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-gearmanclient.do-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.dolowbackground.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::doLowBackground()</a> - Run a low priority task in the background</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/do.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.do%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.do&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.do.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="98434">  <div class="votes">
    <div id="Vu98434">
    <a href="/manual/vote-note.php?id=98434&amp;page=gearmanclient.do&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98434">
    <a href="/manual/vote-note.php?id=98434&amp;page=gearmanclient.do&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98434" title="50% like this...">
    0
    </div>
  </div>
  <a href="#98434" class="name">
  <strong class="user"><em>Shane Harter</em></strong></a><a class="genanchor" href="#98434"> &para;</a><div class="date" title="2010-06-15 11:41"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98434">
<div class="phpcode"><code><span class="html">Note that this isn't blocking -- that do() will return as soon as the job is accepted by the Gearman jobserver. <br /><br />That lets you do..while until the return code is success or failure as you see in the examples.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gearmanclient.do&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.do.php">＋<small>add a note</small></a></div>
