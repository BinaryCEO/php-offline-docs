...
<head>
  ...
  <title>PHP: ps_arcn - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-arcn.php">
 <link rel="shorturl" href="https://www.php.net/ps-arcn">
 <link rel="alternate" href="https://www.php.net/ps-arcn" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-arc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-begin-page.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-arcn.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-arcn.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-arcn.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-arcn.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-arcn.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-arcn.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-arcn.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-arcn.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-arcn.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-arcn.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-arcn.php" hreflang="zh">
...
<meta name="Description" content="Draws an arc clockwise" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_arcn - Manual" />
<meta name="twitter:description" content="Draws an arc clockwise" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_arcn - Manual" />
<meta itemprop="description" content="Draws an arc clockwise" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws an arc clockwise" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-arcn.php' selected="selected">English</option>
            <option value='de/function.ps-arcn.php'>German</option>
            <option value='es/function.ps-arcn.php'>Spanish</option>
            <option value='fr/function.ps-arcn.php'>French</option>
            <option value='it/function.ps-arcn.php'>Italian</option>
            <option value='ja/function.ps-arcn.php'>Japanese</option>
            <option value='pt_BR/function.ps-arcn.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-arcn.php'>Russian</option>
            <option value='tr/function.ps-arcn.php'>Turkish</option>
            <option value='uk/function.ps-arcn.php'>Ukrainian</option>
            <option value='zh/function.ps-arcn.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-arcn" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-arc.php" class="function" rel="rdfs-seeAlso">ps_arc()</a> - Draws an arc counterclockwise</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-arcn.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-arcn%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-arcn&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-arcn.php">＋<small>add a note</small></a></span>
