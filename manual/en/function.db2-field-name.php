...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-field-name.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-field-display-size.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-field-num.php">
...
<meta name="Description" content="Returns the name of the column in the result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_field_name - Manual" />
<meta name="twitter:description" content="Returns the name of the column in the result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_field_name - Manual" />
<meta itemprop="description" content="Returns the name of the column in the result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the name of the column in the result set" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-field-name.php' selected="selected">English</option>
            <option value='de/function.db2-field-name.php'>German</option>
            <option value='es/function.db2-field-name.php'>Spanish</option>
            <option value='fr/function.db2-field-name.php'>French</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-field-name-returnvalues">
  ...
  <p class="para">
   ...
   set, <span class="function"><strong>db2_field_name()</strong></span> returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-field-width.php" class="function" rel="rdfs-seeAlso">db2_field_width()</a> - Returns the width of the current value of the indicated column in a result set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-field-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-field-name%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-field-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-field-name.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">example:
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="comment">// select all fields from salay table
<br /></span><span class="default">$sql </span><span class="keyword">= </span><span class="string">"SELECT * FROM SALARY"</span><span class="keyword">;
<br />
<br /></span><span class="default">$stmt </span><span class="keyword">= </span><span class="default">db2_prepare</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">,</span><span class="default">$sql</span><span class="keyword">);
<br />
<br />if(</span><span class="default">db2_execute</span><span class="keyword">(</span><span class="default">$stmt</span><span class="keyword">)){
<br />    </span><span class="default">$columns </span><span class="keyword">= </span><span class="default">db2_num_fields</span><span class="keyword">(</span><span class="default">$stmt</span><span class="keyword">);
<br />    for(</span><span class="default">$i</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">;</span><span class="default">$i</span><span class="keyword">&lt;</span><span class="default">$columns</span><span class="keyword">;</span><span class="default">$i</span><span class="keyword">++){
<br />        </span><span class="default">$fieldName</span><span class="keyword">[] = </span><span class="default">db2_field_name</span><span class="keyword">(</span><span class="default">$stmt</span><span class="keyword">,</span><span class="default">$i</span><span class="keyword">);
<br />    }
<br />    </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$fieldName</span><span class="keyword">);
<br />}else{
<br />    echo </span><span class="default">db2_stmt_errormsg</span><span class="keyword">();
<br />}
<br />
<br /></span><span class="comment">/* output
<br />* Array ( [0] =&gt; ID [1] =&gt; USERID [2] =&gt; VALUE ) 
<br />*/
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-field-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-field-name.php">＋<small>add a note</small></a></div>
