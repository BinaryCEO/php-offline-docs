...
<head>
  ...
  <title>PHP: fann_num_input_train_data - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-num-input-train-data.php">
 <link rel="shorturl" href="https://www.php.net/fann-num-input-train-data">
 <link rel="alternate" href="https://www.php.net/fann-num-input-train-data" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-merge-train-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-num-output-train-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-num-input-train-data.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-num-input-train-data.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-num-input-train-data.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-num-input-train-data.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-num-input-train-data.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-num-input-train-data.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-num-input-train-data.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-num-input-train-data.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-num-input-train-data.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-num-input-train-data.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-num-input-train-data.php" hreflang="zh">
...
<meta name="Description" content="Returns the number of inputs in each of the training patterns in the train data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_num_input_train_data - Manual" />
<meta name="twitter:description" content="Returns the number of inputs in each of the training patterns in the train data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_num_input_train_data - Manual" />
<meta itemprop="description" content="Returns the number of inputs in each of the training patterns in the train data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the number of inputs in each of the training patterns in the train data" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-num-output-train-data.php">
          fann_num_output_train_data &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-merge-train-data.php">
          &laquo; fann_merge_train_data        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-num-input-train-data.php' selected="selected">English</option>
            <option value='de/function.fann-num-input-train-data.php'>German</option>
            <option value='es/function.fann-num-input-train-data.php'>Spanish</option>
            <option value='fr/function.fann-num-input-train-data.php'>French</option>
            <option value='it/function.fann-num-input-train-data.php'>Italian</option>
            <option value='ja/function.fann-num-input-train-data.php'>Japanese</option>
            <option value='pt_BR/function.fann-num-input-train-data.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-num-input-train-data.php'>Russian</option>
            <option value='tr/function.fann-num-input-train-data.php'>Turkish</option>
            <option value='uk/function.fann-num-input-train-data.php'>Ukrainian</option>
            <option value='zh/function.fann-num-input-train-data.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-num-input-train-data" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_num_input_train_data</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_num_input_train_data</span> &mdash; <span class="dc-title">Returns the number of inputs in each of the training patterns in the train data</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-num-input-train-data-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_num_input_train_data</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$data</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Returns the number of inputs in each of the training patterns in the train data <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fann-num-input-train-data-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-num-input-train-data-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
    The number of inputs, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fann-num-input-train-data-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-num-output-train-data.php" class="function" rel="rdfs-seeAlso">fann_num_output_train_data()</a> - Returns the number of outputs in each of the training patterns in the train data</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-num-input-train-data.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-num-input-train-data%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-num-input-train-data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-num-input-train-data.php">＋<small>add a note</small></a></span>
