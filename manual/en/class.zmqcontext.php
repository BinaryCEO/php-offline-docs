...
<head>
  ...
  <title>PHP: ZMQContext - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.zmqcontext.php">
 <link rel="shorturl" href="https://www.php.net/zmqcontext">
 <link rel="alternate" href="https://www.php.net/zmqcontext" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.zmq.php">
 <link rel="prev" href="https://www.php.net/manual/en/zmq.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/zmqcontext.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.zmqcontext.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.zmqcontext.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.zmqcontext.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.zmqcontext.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.zmqcontext.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.zmqcontext.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.zmqcontext.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.zmqcontext.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.zmqcontext.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.zmqcontext.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.zmqcontext.php" hreflang="zh">
...
<meta name="Description" content="The ZMQContext class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZMQContext - Manual" />
<meta name="twitter:description" content="The ZMQContext class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZMQContext - Manual" />
<meta itemprop="description" content="The ZMQContext class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ZMQContext class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="zmqcontext.construct.php">
          ZMQContext::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="zmq.construct.php">
          &laquo; ZMQ::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.zmqcontext.php' selected="selected">English</option>
            <option value='de/class.zmqcontext.php'>German</option>
            <option value='es/class.zmqcontext.php'>Spanish</option>
            <option value='fr/class.zmqcontext.php'>French</option>
            <option value='it/class.zmqcontext.php'>Italian</option>
            <option value='ja/class.zmqcontext.php'>Japanese</option>
            <option value='pt_BR/class.zmqcontext.php'>Brazilian Portuguese</option>
            <option value='ru/class.zmqcontext.php'>Russian</option>
            <option value='tr/class.zmqcontext.php'>Turkish</option>
            <option value='uk/class.zmqcontext.php'>Ukrainian</option>
            <option value='zh/class.zmqcontext.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.zmqcontext" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="zmqcontext.construct.php">ZMQContext::__construct</a> — Construct a new ZMQContext object</li><li><a href="zmqcontext.getopt.php">ZMQContext::getOpt</a> — Get context option</li><li><a href="zmqcontext.getsocket.php">ZMQContext::getSocket</a> — Create a new socket</li><li><a href="zmqcontext.ispersistent.php">ZMQContext::isPersistent</a> — Whether the context is persistent</li><li><a href="zmqcontext.setopt.php">ZMQContext::setOpt</a> — Set a socket option</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zmq/zmqcontext.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.zmqcontext%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.zmqcontext&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.zmqcontext.php">＋<small>add a note</small></a></span>
