...
<head>
  ...
  <title>PHP: pg_update - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-update.php">
 <link rel="shorturl" href="https://www.php.net/pg-update">
 <link rel="alternate" href="https://www.php.net/pg-update" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-untrace.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-version.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-update.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-update.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-update.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-update.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-update.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-update.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-update.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-update.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-update.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-update.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-update.php" hreflang="zh">
...
<meta name="Description" content="Update table" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_update - Manual" />
<meta name="twitter:description" content="Update table" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_update - Manual" />
<meta itemprop="description" content="Update table" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Update table" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-version.php">
          pg_version &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-untrace.php">
          &laquo; pg_untrace        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-update.php' selected="selected">English</option>
            <option value='de/function.pg-update.php'>German</option>
            <option value='es/function.pg-update.php'>Spanish</option>
            <option value='fr/function.pg-update.php'>French</option>
            <option value='it/function.pg-update.php'>Italian</option>
            <option value='ja/function.pg-update.php'>Japanese</option>
            <option value='pt_BR/function.pg-update.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-update.php'>Russian</option>
            <option value='tr/function.pg-update.php'>Turkish</option>
            <option value='uk/function.pg-update.php'>Ukrainian</option>
            <option value='zh/function.pg-update.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-update" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-convert.php" class="function" rel="rdfs-seeAlso">pg_convert()</a> - Convert associative array values into forms suitable for SQL statements</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-update.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-update%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-update&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-update.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="80615">  <div class="votes">
    <div id="Vu80615">
    <a href="/manual/vote-note.php?id=80615&amp;page=function.pg-update&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd80615">
    <a href="/manual/vote-note.php?id=80615&amp;page=function.pg-update&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V80615" title="57% like this...">
    2
    </div>
  </div>
  <a href="#80615" class="name">
  <strong class="user"><em>dominik dot bonsch at homesono dot de</em></strong></a><a class="genanchor" href="#80615"> &para;</a><div class="date" title="2008-01-25 01:24"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom80615">
<div class="phpcode"><code><span class="html">Using pg_update() and pg_insert() without key validation is not secure! <br /><br />You need to check which data pairs you get, and if you want to allow to updated this column. <br /><br />Example: <br /><br />You have a table with tree colums: username, password, userlevel. <br /><br />Your users may change only their username, and their password but not their userlevel.<br /><br />If you don't filter the keys in the request array, every user can now change his userlevel just by sending a POST Request with "userlevel=&gt;100".<br /><br />So if you don't check if the key are allowed in your request array you'll get serious sql injection vulnarabilities in your code.</span></code></div>
  </div>
 </div>
  <div class="note" id="64400">  <div class="votes">
    <div id="Vu64400">
    <a href="/manual/vote-note.php?id=64400&amp;page=function.pg-update&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd64400">
    <a href="/manual/vote-note.php?id=64400&amp;page=function.pg-update&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V64400" title="40% like this...">
    -2
    </div>
  </div>
  <a href="#64400" class="name">
  <strong class="user"><em>jhooks</em></strong></a><a class="genanchor" href="#64400"> &para;</a><div class="date" title="2006-04-13 07:54"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom64400">
<div class="phpcode"><code><span class="html">&gt; Return Values<br />&gt; <br />&gt; Returns TRUE on success or FALSE on failure. Returns string if <br />&gt; PGSQL_DML_STRING is passed via options. <br /><br />I have found in my copy of PHP (version 4.4.0) that if you use the 'PGSQL_DML_STRING' option, the function does not execute any query.  It merely returns the query which would have been executed.  <br /><br />Another thing I noticed, pg_update does not seem to make use of pg_trace (atleast in 4.4.0).<br /><br />PS this isn't a bug report, just an explanation of some undocumented features I noticed.  As the manual says, the function is still in development so this behaviour may differ from version to version.</span></code></div>
  </div>
 </div>
  <div class="note" id="53828">  <div class="votes">
    <div id="Vu53828">
    <a href="/manual/vote-note.php?id=53828&amp;page=function.pg-update&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd53828">
    <a href="/manual/vote-note.php?id=53828&amp;page=function.pg-update&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V53828" title="30% like this...">
    -4
    </div>
  </div>
  <a href="#53828" class="name">
  <strong class="user"><em>sdibb at myway dot com</em></strong></a><a class="genanchor" href="#53828"> &para;</a><div class="date" title="2005-06-14 07:26"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom53828">
<div class="phpcode"><code><span class="html">This function is similar to PEAR::DB's autoExecute() function, with the only difference being that the where clause is an array instead of a string.<br /><br />Also, if you want to use your instance of the DB class with this function, you can reference the existing resource connection with $db-&gt;connection.<br /><br />An example would be:<br />&lt;?<br />     pg_update($db-&gt;connection, $arr_update, $arr_where);<br />?&gt;</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-update&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-update.php">＋<small>add a note</small></a></div>
