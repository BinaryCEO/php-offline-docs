...
<head>
  ...
  <title>PHP: openssl_pkey_derive - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-pkey-derive.php">
 <link rel="shorturl" href="https://www.php.net/openssl-pkey-derive">
 <link rel="alternate" href="https://www.php.net/openssl-pkey-derive" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-pkcs7-verify.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-pkey-export.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-pkey-derive.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-pkey-derive.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-pkey-derive.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-pkey-derive.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-pkey-derive.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-pkey-derive.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-pkey-derive.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-pkey-derive.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-pkey-derive.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-pkey-derive.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-pkey-derive.php" hreflang="zh">
...
<meta name="Description" content="Computes shared secret for public value of remote and local DH or ECDH key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_pkey_derive - Manual" />
<meta name="twitter:description" content="Computes shared secret for public value of remote and local DH or ECDH key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_pkey_derive - Manual" />
<meta itemprop="description" content="Computes shared secret for public value of remote and local DH or ECDH key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Computes shared secret for public value of remote and local DH or ECDH key" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-pkey-export.php">
          openssl_pkey_export &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-pkcs7-verify.php">
          &laquo; openssl_pkcs7_verify        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-pkey-derive.php' selected="selected">English</option>
            <option value='de/function.openssl-pkey-derive.php'>German</option>
            <option value='es/function.openssl-pkey-derive.php'>Spanish</option>
            <option value='fr/function.openssl-pkey-derive.php'>French</option>
            <option value='it/function.openssl-pkey-derive.php'>Italian</option>
            <option value='ja/function.openssl-pkey-derive.php'>Japanese</option>
            <option value='pt_BR/function.openssl-pkey-derive.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-pkey-derive.php'>Russian</option>
            <option value='tr/function.openssl-pkey-derive.php'>Turkish</option>
            <option value='uk/function.openssl-pkey-derive.php'>Ukrainian</option>
            <option value='zh/function.openssl-pkey-derive.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-pkey-derive" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.openssl-pkey-derive-returnvalues">
  ...
  <p class="para">
   The derived secret on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.openssl-pkey-derive-examples">
  ...
  <p class="para">
   <div class="example" id="openssl-pkey-derive.example.basic">
    <p><strong>Example #1 <span class="function"><strong>openssl_pkey_derive()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Load in private key<br /></span><span style="color: #0000BB">$priv </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_pkey_get_private</span><span style="color: #007700">(</span><span style="color: #DD0000">"-----BEGIN PRIVATE KEY-----<br />MIICJgIBADCCARcGCSqGSIb3DQEDATCCAQgCggEBAJLxRCaZ933uW+AXmabHFDDy<br />upojBIRlbmQLJZfigDaSA1f9YOTsIv+WwVFTX/J1mtCyx9uBcz0Nt2kmVwxWuc2f<br />VtCEMPsmLsVXX7xRUFLpyX1Y1IYGBVXQOoOvLWYQjpZgnx47Pkh1Ok1+smffztfC<br />0DCNt4KorWrbsPcmqBejXHN79KvWFjZmXOksRiNu/Bn76RiqvofC4z8Ri3kHXQG2<br />197JGZzzFXHadGC3xbkg8UxsNbYhVMKbm0iANfafUH7/hoS9UjAVQYtvwe7YNiW/<br />HnyfVCrKwcc7sadd8Iphh+3lf5P1AhaQEAMytanrzq9RDXKBxuvpSJifRYasZYsC<br />AQIEggEEAoIBAGwAYC2E81Y1U2Aox0U7u1+vBcbht/OO87tutMvc4NTLf6NLPHsW<br />cPqBixs+3rSn4fADzAIvdLBmogjtiIZoB6qyHrllF/2xwTVGEeYaZIupQH3bMK2b<br />6eUvnpuu4Ytksiz6VpXBBRMrIsj3frM+zUtnq8vKUr+TbjV2qyKR8l3eNDwzqz30<br />dlbKh9kIhZafclHfRVfyp+fVSKPfgrRAcLUgAbsVjOjPeJ90xQ4DTMZ6vjiv6tHM<br />hkSjJIcGhRtSBzVF/cT38GyCeTmiIA/dRz2d70lWrqDQCdp9ArijgnpjNKAAulSY<br />CirnMsGZTDGmLOHg4xOZ5FEAzZI2sFNLlcw=<br />-----END PRIVATE KEY-----<br />"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Load in public key<br /></span><span style="color: #0000BB">$pub </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_pkey_get_public</span><span style="color: #007700">(</span><span style="color: #DD0000">"-----BEGIN PUBLIC KEY-----<br />MIICJDCCARcGCSqGSIb3DQEDATCCAQgCggEBAJLxRCaZ933uW+AXmabHFDDyupoj<br />BIRlbmQLJZfigDaSA1f9YOTsIv+WwVFTX/J1mtCyx9uBcz0Nt2kmVwxWuc2fVtCE<br />MPsmLsVXX7xRUFLpyX1Y1IYGBVXQOoOvLWYQjpZgnx47Pkh1Ok1+smffztfC0DCN<br />t4KorWrbsPcmqBejXHN79KvWFjZmXOksRiNu/Bn76RiqvofC4z8Ri3kHXQG2197J<br />GZzzFXHadGC3xbkg8UxsNbYhVMKbm0iANfafUH7/hoS9UjAVQYtvwe7YNiW/Hnyf<br />VCrKwcc7sadd8Iphh+3lf5P1AhaQEAMytanrzq9RDXKBxuvpSJifRYasZYsCAQID<br />ggEFAAKCAQAiCSBpxvGgsTorxAWtcAlSmzAJnJxFgSPef0g7OjhESytnc8G2QYmx<br />ovMt5KVergcitztWh08hZQUdAYm4rI+zMlAFDdN8LWwBT/mGKSzRkWeprd8E7mvy<br />ucqC1YXCMqmIwPySvLQUB/Dl8kgau7BLAnIJm8VP+MVrn8g9gghD0qRCgPgtEaDV<br />vocfgnOU43rhKnIgO0cHOKtw2qybSFB8QuZrYugq4j8Bwkrzh6rdMMeyMl/ej5Aj<br />c0wamOzuBDtXt0T9+Fx3khHaowjCc7xJZRgZCxg43SbqMWJ9lUg94I7+LTX61Gyv<br />dtlkbGbtoDOnxeNnN93gwQZngGYZYciu<br />-----END PUBLIC KEY-----<br />"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Outputs the hex version of the derived key<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">bin2hex</span><span style="color: #007700">(</span><span style="color: #0000BB">openssl_pkey_derive</span><span style="color: #007700">(</span><span style="color: #0000BB">$pub</span><span style="color: #007700">,</span><span style="color: #0000BB">$priv</span><span style="color: #007700">));</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-pkey-derive.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-pkey-derive%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-pkey-derive&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkey-derive.php">＋<small>add a note</small></a></span>
