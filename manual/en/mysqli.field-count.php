...
<head>
  ...
  <title>PHP: mysqli::$field_count - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.field-count.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.field-count.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.field-count.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.execute-query.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.get-charset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.field-count.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.field-count.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.field-count.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.field-count.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.field-count.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.field-count.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.field-count.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.field-count.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.field-count.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.field-count.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.field-count.php" hreflang="zh">
...
<meta name="Description" content="Returns the number of columns for the most recent query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::$field_count - Manual" />
<meta name="twitter:description" content="Returns the number of columns for the most recent query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::$field_count - Manual" />
<meta itemprop="description" content="Returns the number of columns for the most recent query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the number of columns for the most recent query" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli.get-charset.php">
          mysqli::get_charset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.execute-query.php">
          &laquo; mysqli::execute_query        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.field-count.php' selected="selected">English</option>
            <option value='de/mysqli.field-count.php'>German</option>
            <option value='es/mysqli.field-count.php'>Spanish</option>
            <option value='fr/mysqli.field-count.php'>French</option>
            <option value='it/mysqli.field-count.php'>Italian</option>
            <option value='ja/mysqli.field-count.php'>Japanese</option>
            <option value='pt_BR/mysqli.field-count.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.field-count.php'>Russian</option>
            <option value='tr/mysqli.field-count.php'>Turkish</option>
            <option value='uk/mysqli.field-count.php'>Ukrainian</option>
            <option value='zh/mysqli.field-count.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.field-count" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli::$field_count</h1>
  <h1 class="refname">mysqli_field_count</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli::$field_count</span> -- <span class="refname">mysqli_field_count</span> &mdash; <span class="dc-title">Returns the number of columns for the most recent query</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-mysqli.field-count-description">
  <h3 class="title">Description</h3>
  <p class="para">Object-oriented style</p>
  <div class="fieldsynopsis"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <var class="varname"><a href="mysqli.field-count.php">$mysqli-&gt;field_count</a></var>;</div>

  <p class="para">Procedural style</p>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysqli_field_count</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli.php" class="type mysqli">mysqli</a></span> <code class="parameter">$mysql</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Returns the number of columns for the most recent query on the connection
   represented by the <code class="parameter">mysql</code> parameter. This function
   can be useful when using the <span class="function"><a href="mysqli.store-result.php" class="function">mysqli_store_result()</a></span>
 ...
 <div class="refsect1 parameters" id="refsect1-mysqli.field-count-parameters">
...
returned by <span class="function"><a href="function.mysqli-connect.php" class="function">mysqli_connect()</a></span> or <span class="function"><a href="mysqli.init.php" class="function">mysqli_init()</a></span>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli.field-count-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-mysqli.field-count-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-1592">
   <p><strong>Example #1 <var class="varname">$mysqli->field_count</var> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$link </span><span style="color: #007700">= </span><span style="color: #0000BB">mysqli_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #DD0000">"my_user"</span><span style="color: #007700">, </span><span style="color: #DD0000">"my_password"</span><span style="color: #007700">, </span><span style="color: #DD0000">"test"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">mysqli_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$link</span><span style="color: #007700">, </span><span style="color: #DD0000">"DROP TABLE IF EXISTS friends"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">mysqli_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$link</span><span style="color: #007700">, </span><span style="color: #DD0000">"CREATE TABLE friends (id int, name varchar(20))"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">mysqli_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$link</span><span style="color: #007700">, </span><span style="color: #DD0000">"INSERT INTO friends VALUES (1,'Hartmut'), (2, 'Ulf')"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">mysqli_real_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$link</span><span style="color: #007700">, </span><span style="color: #DD0000">"SELECT * FROM friends"</span><span style="color: #007700">);<br /><br />if (</span><span style="color: #0000BB">mysqli_field_count</span><span style="color: #007700">(</span><span style="color: #0000BB">$link</span><span style="color: #007700">)) {<br />    </span><span style="color: #FF8000">/* this was a select/show or describe query */<br />    </span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">mysqli_store_result</span><span style="color: #007700">(</span><span style="color: #0000BB">$link</span><span style="color: #007700">);<br /><br />    </span><span style="color: #FF8000">/* process resultset */<br />    </span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">mysqli_fetch_row</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">);<br /><br />    </span><span style="color: #FF8000">/* free resultset */<br />    </span><span style="color: #0000BB">mysqli_free_result</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">);<br />}<br /><br /></span><span style="color: #FF8000">/* close connection */<br /></span><span style="color: #0000BB">mysqli_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$link</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/field-count.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.field-count%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.field-count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.field-count.php">＋<small>add a note</small></a></span>
