...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pos.php">
 <link rel="shorturl" href="https://www.php.net/pos">
 <link rel="alternate" href="https://www.php.net/pos" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.next.php">
 <link rel="next" href="https://www.php.net/manual/en/function.prev.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pos.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pos.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pos.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pos.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pos.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pos.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pos.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pos.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pos.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pos.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pos.php" hreflang="zh">
...
<meta name="Description" content="Alias of current" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pos - Manual" />
<meta name="twitter:description" content="Alias of current" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pos - Manual" />
<meta itemprop="description" content="Alias of current" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of current" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pos.php' selected="selected">English</option>
            <option value='de/function.pos.php'>German</option>
            <option value='es/function.pos.php'>Spanish</option>
            <option value='fr/function.pos.php'>French</option>
            <option value='it/function.pos.php'>Italian</option>
            <option value='ja/function.pos.php'>Japanese</option>
            <option value='pt_BR/function.pos.php'>Brazilian Portuguese</option>
            <option value='ru/function.pos.php'>Russian</option>
            <option value='tr/function.pos.php'>Turkish</option>
            <option value='uk/function.pos.php'>Ukrainian</option>
            <option value='zh/function.pos.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pos" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pos</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pos</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.current.php" class="function">current()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pos-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.current.php" class="function">current()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/pos.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pos%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pos.php">＋<small>add a note</small></a></span>
