...
<head>
  ...
  <title>PHP: cubrid_next_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-next-result.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-next-result">
 <link rel="alternate" href="https://www.php.net/cubrid-next-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-move-cursor.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-num-cols.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-next-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-next-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-next-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-next-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-next-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-next-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-next-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-next-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-next-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-next-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-next-result.php" hreflang="zh">
...
<meta name="Description" content="Get result of next query when executing multiple SQL statements" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_next_result - Manual" />
<meta name="twitter:description" content="Get result of next query when executing multiple SQL statements" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_next_result - Manual" />
<meta itemprop="description" content="Get result of next query when executing multiple SQL statements" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get result of next query when executing multiple SQL statements" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-num-cols.php">
          cubrid_num_cols &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-move-cursor.php">
          &laquo; cubrid_move_cursor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-next-result.php' selected="selected">English</option>
            <option value='de/function.cubrid-next-result.php'>German</option>
            <option value='es/function.cubrid-next-result.php'>Spanish</option>
            <option value='fr/function.cubrid-next-result.php'>French</option>
            <option value='it/function.cubrid-next-result.php'>Italian</option>
            <option value='ja/function.cubrid-next-result.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-next-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-next-result.php'>Russian</option>
            <option value='tr/function.cubrid-next-result.php'>Turkish</option>
            <option value='uk/function.cubrid-next-result.php'>Ukrainian</option>
            <option value='zh/function.cubrid-next-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-next-result" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-next-result-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_next_result</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <strong><code>CUBRID_EXEC_QUERY_ALL</code></strong> flag is set upon
...
<div class="examplescode"><pre class="examplescode">------------ get_result_info --------------------
Row count:                     6
Column count:                  2
...
Last Column Type:              varchar
Last Column Len:               5
Second Column Flags:           not_null primary_key unique_key</pre>
</div>
   </div>
  </div>
 </div>
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-execute.php" class="function" rel="rdfs-seeAlso">cubrid_execute()</a> - Execute a prepared SQL statement</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-next-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-next-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-next-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-next-result.php">＋<small>add a note</small></a></span>
