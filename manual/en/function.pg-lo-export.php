...
<head>
  ...
  <title>PHP: pg_lo_export - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-lo-export.php">
 <link rel="shorturl" href="https://www.php.net/pg-lo-export">
 <link rel="alternate" href="https://www.php.net/pg-lo-export" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-lo-create.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-lo-import.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-lo-export.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-lo-export.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-lo-export.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-lo-export.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-lo-export.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-lo-export.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-lo-export.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-lo-export.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-lo-export.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-lo-export.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-lo-export.php" hreflang="zh">
...
<meta name="Description" content="Export a large object to file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_lo_export - Manual" />
<meta name="twitter:description" content="Export a large object to file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_lo_export - Manual" />
<meta itemprop="description" content="Export a large object to file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Export a large object to file" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-lo-export.php' selected="selected">English</option>
            <option value='de/function.pg-lo-export.php'>German</option>
            <option value='es/function.pg-lo-export.php'>Spanish</option>
            <option value='fr/function.pg-lo-export.php'>French</option>
            <option value='it/function.pg-lo-export.php'>Italian</option>
            <option value='ja/function.pg-lo-export.php'>Japanese</option>
            <option value='pt_BR/function.pg-lo-export.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-lo-export.php'>Russian</option>
            <option value='tr/function.pg-lo-export.php'>Turkish</option>
            <option value='uk/function.pg-lo-export.php'>Ukrainian</option>
            <option value='zh/function.pg-lo-export.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-lo-export" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-lo-import.php" class="function" rel="rdfs-seeAlso">pg_lo_import()</a> - Import a large object from file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-lo-export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-lo-export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-lo-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-export.php">＋<small>add a note</small></a></span>
