...
<head>
  ...
  <title>PHP: Imagick::setOption - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setoption.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setoption.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setoption.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setlastiterator.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setpage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setoption.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setoption.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setoption.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setoption.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setoption.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setoption.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setoption.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setoption.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setoption.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setoption.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setoption.php" hreflang="zh">
...
<meta name="Description" content="Set an option" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setOption - Manual" />
<meta name="twitter:description" content="Set an option" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setOption - Manual" />
<meta itemprop="description" content="Set an option" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set an option" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setpage.php">
          Imagick::setPage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setlastiterator.php">
          &laquo; Imagick::setLastIterator        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setoption.php' selected="selected">English</option>
            <option value='de/imagick.setoption.php'>German</option>
            <option value='es/imagick.setoption.php'>Spanish</option>
            <option value='fr/imagick.setoption.php'>French</option>
            <option value='it/imagick.setoption.php'>Italian</option>
            <option value='ja/imagick.setoption.php'>Japanese</option>
            <option value='pt_BR/imagick.setoption.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setoption.php'>Russian</option>
            <option value='tr/imagick.setoption.php'>Turkish</option>
            <option value='uk/imagick.setoption.php'>Ukrainian</option>
            <option value='zh/imagick.setoption.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setoption" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setOption</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setOption</span> &mdash; <span class="dc-title">Set an option</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setoption-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setOption</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setoption-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setoption-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.setoption-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3104">
      <p><strong>Example #1 Attempt to reach &#039;$extent&#039; size<span class="function"><strong>Imagick::setOption()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />    </span><span style="color: #007700">function </span><span style="color: #0000BB">renderJPG</span><span style="color: #007700">(</span><span style="color: #0000BB">$extent</span><span style="color: #007700">) {<br />        </span><span style="color: #0000BB">$imagePath </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">control</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImagePath</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">));<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">'jpg'</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setOption</span><span style="color: #007700">(</span><span style="color: #DD0000">'jpeg:extent'</span><span style="color: #007700">, </span><span style="color: #0000BB">$extent</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/jpg"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />    }<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3105">
      <p><strong>Example #2  <span class="function"><strong>Imagick::setOption()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />    </span><span style="color: #007700">function </span><span style="color: #0000BB">renderPNG</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">, </span><span style="color: #0000BB">$format</span><span style="color: #007700">) {<br /><br />        </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">));<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">'png'</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setOption</span><span style="color: #007700">(</span><span style="color: #DD0000">'png:format'</span><span style="color: #007700">, </span><span style="color: #0000BB">$format</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />    }<br />    <br />    </span><span style="color: #FF8000">//Save as 64bit PNG.<br />    </span><span style="color: #0000BB">renderPNG</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">, </span><span style="color: #DD0000">'png64'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3106">
      <p><strong>Example #3  <span class="function"><strong>Imagick::setOption()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />    </span><span style="color: #007700">function </span><span style="color: #0000BB">renderCustomBitDepthPNG</span><span style="color: #007700">() {<br />        </span><span style="color: #0000BB">$imagePath </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">control</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImagePath</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">));<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">'png'</span><span style="color: #007700">);<br />        <br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setOption</span><span style="color: #007700">(</span><span style="color: #DD0000">'png:bit-depth'</span><span style="color: #007700">, </span><span style="color: #DD0000">'16'</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setOption</span><span style="color: #007700">(</span><span style="color: #DD0000">'png:color-type'</span><span style="color: #007700">, </span><span style="color: #0000BB">6</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$crash </span><span style="color: #007700">= </span><span style="color: #0000BB">true</span><span style="color: #007700">;<br />        if (</span><span style="color: #0000BB">$crash</span><span style="color: #007700">) {<br />            echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />        }<br />        else {<br />            </span><span style="color: #0000BB">$tempFilename </span><span style="color: #007700">= </span><span style="color: #0000BB">tempnam</span><span style="color: #007700">(</span><span style="color: #DD0000">'./'</span><span style="color: #007700">, </span><span style="color: #DD0000">'imagick'</span><span style="color: #007700">);<br />            </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">writeimage</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #0000BB">$tempFilename</span><span style="color: #007700">));<br />            echo </span><span style="color: #0000BB">file_get_contents</span><span style="color: #007700">(</span><span style="color: #0000BB">$tempFilename</span><span style="color: #007700">);<br />        }<br />    }<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setoption.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setoption%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setoption&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setoption.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118047">  <div class="votes">
    <div id="Vu118047">
    <a href="/manual/vote-note.php?id=118047&amp;page=imagick.setoption&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118047">
    <a href="/manual/vote-note.php?id=118047&amp;page=imagick.setoption&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118047" title="88% like this...">
    7
    </div>
  </div>
  <a href="#118047" class="name">
  <strong class="user"><em>kicha at kreker dot org</em></strong></a><a class="genanchor" href="#118047"> &para;</a><div class="date" title="2015-09-24 02:48"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom118047">
<div class="phpcode"><code><span class="html">List of options (with key =&gt; value) on official imagemagick site:<br /><a href="http://www.imagemagick.org/script/command-line-options.php#define" rel="nofollow" target="_blank">http://www.imagemagick.org/script/command-line-options.php#define</a></span></code></div>
  </div>
 </div>
  <div class="note" id="104855">  <div class="votes">
    <div id="Vu104855">
    <a href="/manual/vote-note.php?id=104855&amp;page=imagick.setoption&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104855">
    <a href="/manual/vote-note.php?id=104855&amp;page=imagick.setoption&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104855" title="80% like this...">
    3
    </div>
  </div>
  <a href="#104855" class="name">
  <strong class="user"><em>alexandre at gaigalas dot net</em></strong></a><a class="genanchor" href="#104855"> &para;</a><div class="date" title="2011-07-11 02:43"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104855">
<div class="phpcode"><code><span class="html">If you want to extract a preview from a PDF file using the CropBox instead of the whole document, setOption() is the right method:<br /><br /><span class="default">&lt;?php<br />$handler </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$handler</span><span class="keyword">-&gt;</span><span class="default">setOption</span><span class="keyword">(</span><span class="string">'pdf:use-cropbox'</span><span class="keyword">, </span><span class="string">'true'</span><span class="keyword">);<br /></span><span class="default">$handler</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$imageFileName</span><span class="keyword">);<br /></span><span class="default">$handler</span><span class="keyword">-&gt;</span><span class="default">thumbnailImage</span><span class="keyword">(</span><span class="default">200</span><span class="keyword">, </span><span class="default">200</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">$handler</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'jpeg'</span><span class="keyword">);<br /></span><span class="default">$handler</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">$destThumbFileName</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />It is the equivalent to the -define pdf:use-cropbox=true for the convert command line tool. pdf:use-trimbox is also available.<br /><br />Note that on my environment the setOption only worked when i called it before the readImage method, which means that you can't pass the filename to the Imagick constructor directly.</span></code></div>
  </div>
 </div>
  <div class="note" id="124864">  <div class="votes">
    <div id="Vu124864">
    <a href="/manual/vote-note.php?id=124864&amp;page=imagick.setoption&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124864">
    <a href="/manual/vote-note.php?id=124864&amp;page=imagick.setoption&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124864" title="100% like this...">
    1
    </div>
  </div>
  <a href="#124864" class="name">
  <strong class="user"><em>SkepticaLee</em></strong></a><a class="genanchor" href="#124864"> &para;</a><div class="date" title="2020-03-29 07:17"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124864">
<div class="phpcode"><code><span class="html">Actually setImageArtifact () can be used if setOption () fails, e.g.<br /><br />$im-&gt;setImageartifact ("distort:viewport", "960x540+0-151");<br /><br />Or maybe setOption () is deprecated.</span></code></div>
  </div>
 </div>
  <div class="note" id="129401">  <div class="votes">
    <div id="Vu129401">
    <a href="/manual/vote-note.php?id=129401&amp;page=imagick.setoption&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129401">
    <a href="/manual/vote-note.php?id=129401&amp;page=imagick.setoption&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129401" title="no votes...">
    0
    </div>
  </div>
  <a href="#129401" class="name">
  <strong class="user"><em>dodginess at yahoo dot com</em></strong></a><a class="genanchor" href="#129401"> &para;</a><div class="date" title="2024-04-15 02:50"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129401">
<div class="phpcode"><code><span class="html">It does not appear to be possible to disable anti-aliasing using the setOption() method as might be expected, and calling the setOption() method like this does not do anything:<br /><br />$imagick-&gt;setOption('antialias', FALSE);<br /><br />As discussed at <a href="https://github.com/Imagick/imagick/issues/83" rel="nofollow" target="_blank">https://github.com/Imagick/imagick/issues/83</a> the correct way to do this appears to be to use the setAntiAlias() method, which is not currently documented in the PHP manual. As an example, to disable anti-aliasing for an image you can do this:<br /><br />$imagick-&gt;setAntiAlias(FALSE);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setoption&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setoption.php">＋<small>add a note</small></a></div>
