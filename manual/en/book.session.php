...
<head>
  ...
  <title>PHP: Sessions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.session.php">
 ...
 <link rel="index" href="https://www.php.net/manual/en/refs.basic.session.php">
 <link rel="prev" href="https://www.php.net/manual/en/refs.basic.session.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.session.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.session.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.session.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.session.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.session.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.session.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.session.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.session.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.session.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.session.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.session.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.session.php" hreflang="zh">
...
<meta name="Description" content="Session Handling" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Sessions - Manual" />
<meta name="twitter:description" content="Session Handling" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Sessions - Manual" />
<meta itemprop="description" content="Session Handling" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Session Handling" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intro.session.php">
          Introduction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="refs.basic.session.php">
          &laquo; Session Extensions        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.basic.session.php'>Session Extensions</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.session.php' selected="selected">English</option>
            <option value='de/book.session.php'>German</option>
            <option value='es/book.session.php'>Spanish</option>
            <option value='fr/book.session.php'>French</option>
            <option value='it/book.session.php'>Italian</option>
            <option value='ja/book.session.php'>Japanese</option>
            <option value='pt_BR/book.session.php'>Brazilian Portuguese</option>
            <option value='ru/book.session.php'>Russian</option>
            <option value='tr/book.session.php'>Turkish</option>
            <option value='uk/book.session.php'>Ukrainian</option>
            <option value='zh/book.session.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.session" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.session.php">Introduction</a></li><li><a href="session.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="session.requirements.php">Requirements</a></li><li><a href="session.installation.php">Installation</a></li><li><a href="session.configuration.php">Runtime Configuration</a></li></ul></li><li><a href="session.constants.php">Predefined Constants</a></li><li><a href="session.examples.php">Examples</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="session.examples.basic.php">Basic usage</a></li><li><a href="session.idpassing.php">Passing the Session ID</a></li><li><a href="session.customhandler.php">Custom Session Handlers</a></li></ul></li><li><a href="session.upload-progress.php">Session Upload Progress</a></li><li><a href="session.security.php">Sessions and Security</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="features.session.security.management.php">Session Management Basics</a></li><li><a href="session.security.ini.php">Securing Session INI Settings</a></li></ul></li><li><a href="ref.session.php">Session Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.session-abort.php">session_abort</a> — Discard session array changes and finish session</li><li><a href="function.session-cache-expire.php">session_cache_expire</a> — Get and/or set current cache expire</li><li><a href="function.session-cache-limiter.php">session_cache_limiter</a> — Get and/or set the current cache limiter</li><li><a href="function.session-commit.php">session_commit</a> — Alias of session_write_close</li><li><a href="function.session-create-id.php">session_create_id</a> — Create new session id</li><li><a href="function.session-decode.php">session_decode</a> — Decodes session data from a session encoded string</li><li><a href="function.session-destroy.php">session_destroy</a> — Destroys all data registered to a session</li><li><a href="function.session-encode.php">session_encode</a> — Encodes the current session data as a session encoded string</li><li><a href="function.session-gc.php">session_gc</a> — Perform session data garbage collection</li><li><a href="function.session-get-cookie-params.php">session_get_cookie_params</a> — Get the session cookie parameters</li><li><a href="function.session-id.php">session_id</a> — Get and/or set the current session id</li><li><a href="function.session-module-name.php">session_module_name</a> — Get and/or set the current session module</li><li><a href="function.session-name.php">session_name</a> — Get and/or set the current session name</li><li><a href="function.session-regenerate-id.php">session_regenerate_id</a> — Update the current session id with a newly generated one</li><li><a href="function.session-register-shutdown.php">session_register_shutdown</a> — Session shutdown function</li><li><a href="function.session-reset.php">session_reset</a> — Re-initialize session array with original values</li><li><a href="function.session-save-path.php">session_save_path</a> — Get and/or set the current session save path</li><li><a href="function.session-set-cookie-params.php">session_set_cookie_params</a> — Set the session cookie parameters</li><li><a href="function.session-set-save-handler.php">session_set_save_handler</a> — Sets user-level session storage functions</li><li><a href="function.session-start.php">session_start</a> — Start new or resume existing session</li><li><a href="function.session-status.php">session_status</a> — Returns the current session status</li><li><a href="function.session-unset.php">session_unset</a> — Free all session variables</li><li><a href="function.session-write-close.php">session_write_close</a> — Write session data and end session</li></ul></li><li><a href="class.sessionhandler.php">SessionHandler</a> — The SessionHandler class<ul class="chunklist chunklist_book chunklist_children"><li><a href="sessionhandler.close.php">SessionHandler::close</a> — Close the session</li><li><a href="sessionhandler.create-sid.php">SessionHandler::create_sid</a> — Return a new session ID</li><li><a href="sessionhandler.destroy.php">SessionHandler::destroy</a> — Destroy a session</li><li><a href="sessionhandler.gc.php">SessionHandler::gc</a> — Cleanup old sessions</li><li><a href="sessionhandler.open.php">SessionHandler::open</a> — Initialize session</li><li><a href="sessionhandler.read.php">SessionHandler::read</a> — Read session data</li><li><a href="sessionhandler.write.php">SessionHandler::write</a> — Write session data</li></ul></li><li><a href="class.sessionhandlerinterface.php">SessionHandlerInterface</a> — The SessionHandlerInterface class<ul class="chunklist chunklist_book chunklist_children"><li><a href="sessionhandlerinterface.close.php">SessionHandlerInterface::close</a> — Close the session</li><li><a href="sessionhandlerinterface.destroy.php">SessionHandlerInterface::destroy</a> — Destroy a session</li><li><a href="sessionhandlerinterface.gc.php">SessionHandlerInterface::gc</a> — Cleanup old sessions</li><li><a href="sessionhandlerinterface.open.php">SessionHandlerInterface::open</a> — Initialize session</li><li><a href="sessionhandlerinterface.read.php">SessionHandlerInterface::read</a> — Read session data</li><li><a href="sessionhandlerinterface.write.php">SessionHandlerInterface::write</a> — Write session data</li></ul></li><li><a href="class.sessionidinterface.php">SessionIdInterface</a> — The SessionIdInterface interface<ul class="chunklist chunklist_book chunklist_children"><li><a href="sessionidinterface.create-sid.php">SessionIdInterface::create_sid</a> — Create session ID</li></ul></li><li><a href="class.sessionupdatetimestamphandlerinterface.php">SessionUpdateTimestampHandlerInterface</a> — The SessionUpdateTimestampHandlerInterface interface<ul class="chunklist chunklist_book chunklist_children"><li><a href="sessionupdatetimestamphandlerinterface.updatetimestamp.php">SessionUpdateTimestampHandlerInterface::updateTimestamp</a> — Update timestamp</li><li><a href="sessionupdatetimestamphandlerinterface.validateid.php">SessionUpdateTimestampHandlerInterface::validateId</a> — Validate ID</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/session/book.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.session%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.session&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.session.php">＋<small>add a note</small></a></span>
        ...
        <ul class='parent-menu-list'>
                ...
                <a href="refs.basic.session.php">Session Extensions</a>
                                    ...
                                    <ul class='child-menu-list'>
                                                ...
                                                <li class="current">
                            <a href="book.session.php" title="Sessions">Sessions</a>
                        </li>
