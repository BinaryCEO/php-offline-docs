...
<head>
  ...
  <title>PHP: mb_substitute_character - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-substitute-character.php">
 <link rel="shorturl" href="https://www.php.net/mb-substitute-character">
 <link rel="alternate" href="https://www.php.net/mb-substitute-character" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-strwidth.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-substr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-substitute-character.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-substitute-character.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-substitute-character.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-substitute-character.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-substitute-character.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-substitute-character.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-substitute-character.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-substitute-character.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-substitute-character.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-substitute-character.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-substitute-character.php" hreflang="zh">
...
<meta name="Description" content="Set/Get substitution character" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_substitute_character - Manual" />
<meta name="twitter:description" content="Set/Get substitution character" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_substitute_character - Manual" />
<meta itemprop="description" content="Set/Get substitution character" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set/Get substitution character" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mb-substr.php">
          mb_substr &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mb-strwidth.php">
          &laquo; mb_strwidth        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-substitute-character.php' selected="selected">English</option>
            <option value='de/function.mb-substitute-character.php'>German</option>
            <option value='es/function.mb-substitute-character.php'>Spanish</option>
            <option value='fr/function.mb-substitute-character.php'>French</option>
            <option value='it/function.mb-substitute-character.php'>Italian</option>
            <option value='ja/function.mb-substitute-character.php'>Japanese</option>
            <option value='pt_BR/function.mb-substitute-character.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-substitute-character.php'>Russian</option>
            <option value='tr/function.mb-substitute-character.php'>Turkish</option>
            <option value='uk/function.mb-substitute-character.php'>Ukrainian</option>
            <option value='zh/function.mb-substitute-character.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-substitute-character" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_substitute_character</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_substitute_character</span> &mdash; <span class="dc-title">Set/Get substitution character</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-substitute-character-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_substitute_character</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span></span> <code class="parameter">$substitute_character</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   encoding. Invalid characters may be substituted <code class="literal">&quot;none&quot;</code> (no output),
   <span class="type"><a href="language.types.string.php" class="type string">string</a></span> or <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> value (Unicode character code value).
  </p>
  <p class="para">
   This setting affects <span class="function"><a href="function.mb-convert-encoding.php" class="function">mb_convert_encoding()</a></span>,
   <span class="function"><a href="function.mb-convert-variables.php" class="function">mb_convert_variables()</a></span>,
   ...
   and <span class="function"><a href="function.mb-send-mail.php" class="function">mb_send_mail()</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-substitute-character-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">substitute_character</code></dt>
     <dd>
      <p class="para">
       Specify the Unicode value as an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>, 
       or as one of the following <span class="type"><a href="language.types.string.php" class="type string">string</a></span>s:
       <ul class="itemizedlist">
        <li class="listitem">
         <span class="simpara">
          <code class="literal">&quot;none&quot;</code>: no output
         </span>
        </li>
        <li class="listitem">
         <span class="simpara">
          <code class="literal">&quot;long&quot;</code>: Output character code value (Example:
          <code class="literal">U+3000</code>, <code class="literal">JIS+7E7E</code>)
         </span>
        </li>
        <li class="listitem">
         <span class="simpara">
          <code class="literal">&quot;entity&quot;</code>: Output character entity (Example:
          <code class="literal">&amp;#x200;</code>)
         </span>
        </li>
       </ul>
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-substitute-character-returnvalues">
  ...
  <p class="para">
   If <code class="parameter">substitute_character</code> is set, it returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> for success,
   otherwise returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>. 
   If <code class="parameter">substitute_character</code> is not set, it returns the current
   setting.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.mb-substitute-character-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>
       Passing an empty string to <code class="parameter">substitute_character</code>
       is no longer supported; <code class="literal">&quot;none&quot;</code> should be passed instead.
      </td>
     </tr>
 ...
 <div class="refsect1 examples" id="refsect1-function.mb-substitute-character-examples">
  ...
  <p class="para">
   <div class="example" id="example-2793">
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Set with Unicode U+3013 (GETA MARK) */<br /></span><span style="color: #0000BB">mb_substitute_character</span><span style="color: #007700">(</span><span style="color: #0000BB">0x3013</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Set hex format */<br /></span><span style="color: #0000BB">mb_substitute_character</span><span style="color: #007700">(</span><span style="color: #DD0000">"long"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Display current setting */<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">mb_substitute_character</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-substitute-character.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-substitute-character%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-substitute-character&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-substitute-character.php">＋<small>add a note</small></a></span>
