...
<head>
  ...
  <title>PHP: Gmagick::queryfontmetrics - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.queryfontmetrics.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.queryfontmetrics.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.queryfontmetrics.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.quantizeimages.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.queryfonts.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.queryfontmetrics.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.queryfontmetrics.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.queryfontmetrics.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.queryfontmetrics.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.queryfontmetrics.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.queryfontmetrics.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.queryfontmetrics.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.queryfontmetrics.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.queryfontmetrics.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.queryfontmetrics.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.queryfontmetrics.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::queryfontmetrics - Manual" />
<meta name="twitter:description" content="Returns an array representing the font metrics" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::queryfontmetrics - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.queryfonts.php">
          Gmagick::queryfonts &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.quantizeimages.php">
          &laquo; Gmagick::quantizeimages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.queryfontmetrics.php' selected="selected">English</option>
            <option value='de/gmagick.queryfontmetrics.php'>German</option>
            <option value='es/gmagick.queryfontmetrics.php'>Spanish</option>
            <option value='fr/gmagick.queryfontmetrics.php'>French</option>
            <option value='it/gmagick.queryfontmetrics.php'>Italian</option>
            <option value='ja/gmagick.queryfontmetrics.php'>Japanese</option>
            <option value='pt_BR/gmagick.queryfontmetrics.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.queryfontmetrics.php'>Russian</option>
            <option value='tr/gmagick.queryfontmetrics.php'>Turkish</option>
            <option value='uk/gmagick.queryfontmetrics.php'>Ukrainian</option>
            <option value='zh/gmagick.queryfontmetrics.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.queryfontmetrics" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::queryfontmetrics</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::queryfontmetrics</span> &mdash; <span class="dc-title">Returns an array representing the font metrics</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.queryfontmetrics-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::queryfontmetrics</strong></span>(<span class="methodparam"><span class="type"><a href="class.gmagickdraw.php" class="type GmagickDraw">GmagickDraw</a></span> <code class="parameter">$draw</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$text</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.queryfontmetrics-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.queryfontmetrics-returnvalues">
  ...
  <div class="refsect1 errors" id="refsect1-gmagick.queryfontmetrics-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/queryfontmetrics.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.queryfontmetrics%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.queryfontmetrics&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.queryfontmetrics.php">＋<small>add a note</small></a></span>
