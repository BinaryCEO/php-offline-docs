...
<head>
  ...
  <title>PHP: Gmagick::getfilename - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getfilename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getfilename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getfilename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getcopyright.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagebackgroundcolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getfilename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getfilename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getfilename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getfilename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getfilename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getfilename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getfilename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getfilename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getfilename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getfilename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getfilename.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getfilename - Manual" />
<meta name="twitter:description" content="The filename associated with an image sequence" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getfilename - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimagebackgroundcolor.php">
          Gmagick::getimagebackgroundcolor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getcopyright.php">
          &laquo; Gmagick::getcopyright        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getfilename.php' selected="selected">English</option>
            <option value='de/gmagick.getfilename.php'>German</option>
            <option value='es/gmagick.getfilename.php'>Spanish</option>
            <option value='fr/gmagick.getfilename.php'>French</option>
            <option value='it/gmagick.getfilename.php'>Italian</option>
            <option value='ja/gmagick.getfilename.php'>Japanese</option>
            <option value='pt_BR/gmagick.getfilename.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getfilename.php'>Russian</option>
            <option value='tr/gmagick.getfilename.php'>Turkish</option>
            <option value='uk/gmagick.getfilename.php'>Ukrainian</option>
            <option value='zh/gmagick.getfilename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getfilename" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getfilename</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getfilename</span> &mdash; <span class="dc-title">The filename associated with an image sequence</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getfilename-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getfilename</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getfilename-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>

 
 <div class="refsect1 returnvalues" id="refsect1-gmagick.getfilename-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getfilename-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getfilename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getfilename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getfilename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getfilename.php">＋<small>add a note</small></a></span>
