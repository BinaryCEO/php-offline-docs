...
<head>
  ...
  <title>PHP: MongoDB\Driver\Server::executeBulkWriteCommand - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-server.executebulkwritecommand.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-server.executebulkwritecommand.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-server.executebulkwritecommand.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-server.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-server.executebulkwrite.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-server.executecommand.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-server.executebulkwritecommand.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-server.executebulkwritecommand.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-server.executebulkwritecommand.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-server.executebulkwritecommand.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-server.executebulkwritecommand.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-server.executebulkwritecommand.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-server.executebulkwritecommand.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-server.executebulkwritecommand.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-server.executebulkwritecommand.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-server.executebulkwritecommand.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-server.executebulkwritecommand.php" hreflang="zh">
...
<meta name="Description" content="Execute write operations on this server using the bulkWrite command" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Server::executeBulkWriteCommand - Manual" />
<meta name="twitter:description" content="Execute write operations on this server using the bulkWrite command" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Server::executeBulkWriteCommand - Manual" />
<meta itemprop="description" content="Execute write operations on this server using the bulkWrite command" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Execute write operations on this server using the bulkWrite command" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-server.executecommand.php">
          MongoDB\Driver\Server::executeCommand &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-server.executebulkwrite.php">
          &laquo; MongoDB\Driver\Server::executeBulkWrite        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-server.executebulkwritecommand.php' selected="selected">English</option>
            <option value='de/mongodb-driver-server.executebulkwritecommand.php'>German</option>
            <option value='es/mongodb-driver-server.executebulkwritecommand.php'>Spanish</option>
            <option value='fr/mongodb-driver-server.executebulkwritecommand.php'>French</option>
            <option value='it/mongodb-driver-server.executebulkwritecommand.php'>Italian</option>
            <option value='ja/mongodb-driver-server.executebulkwritecommand.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-server.executebulkwritecommand.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-server.executebulkwritecommand.php'>Russian</option>
            <option value='tr/mongodb-driver-server.executebulkwritecommand.php'>Turkish</option>
            <option value='uk/mongodb-driver-server.executebulkwritecommand.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-server.executebulkwritecommand.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-server.executebulkwritecommand" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="mongodb-driver-manager.executebulkwritecommand.php" class="function" rel="rdfs-seeAlso">MongoDB\Driver\Manager::executeBulkWriteCommand()</a> - Execute write operations using the bulkWrite command</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/server/executebulkwritecommand.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-server.executebulkwritecommand%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-server.executebulkwritecommand&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-server.executebulkwritecommand.php">＋<small>add a note</small></a></span>
