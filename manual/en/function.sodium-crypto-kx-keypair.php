...
<head>
  ...
  <title>PHP: sodium_crypto_kx_keypair - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-kx-keypair.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-kx-keypair">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-kx-keypair" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-kx-client-session-keys.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-kx-publickey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-kx-keypair.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-kx-keypair.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-kx-keypair.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-kx-keypair.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-kx-keypair.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-kx-keypair.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-kx-keypair.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-kx-keypair.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-kx-keypair.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-kx-keypair.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-kx-keypair.php" hreflang="zh">
...
<meta name="Description" content="Creates a new sodium keypair" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_kx_keypair - Manual" />
<meta name="twitter:description" content="Creates a new sodium keypair" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_kx_keypair - Manual" />
<meta itemprop="description" content="Creates a new sodium keypair" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a new sodium keypair" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-kx-publickey.php">
          sodium_crypto_kx_publickey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-kx-client-session-keys.php">
          &laquo; sodium_crypto_kx_client_session_keys        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-kx-keypair.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-kx-keypair.php'>German</option>
            <option value='es/function.sodium-crypto-kx-keypair.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-kx-keypair.php'>French</option>
            <option value='it/function.sodium-crypto-kx-keypair.php'>Italian</option>
            <option value='ja/function.sodium-crypto-kx-keypair.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-kx-keypair.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-kx-keypair.php'>Russian</option>
            <option value='tr/function.sodium-crypto-kx-keypair.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-kx-keypair.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-kx-keypair.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-kx-keypair" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_kx_keypair</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_kx_keypair</span> &mdash; <span class="dc-title">Creates a new sodium keypair</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-kx-keypair-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_kx_keypair</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.sodium-crypto-kx-secretkey.php" class="function">sodium_crypto_kx_secretkey()</a></span> and
   <span class="function"><a href="function.sodium-crypto-kx-publickey.php" class="function">sodium_crypto_kx_publickey()</a></span>, respectively.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-kx-keypair-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-kx-keypair-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.sodium-crypto-kx-keypair-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="sodium-crypto-kx-keypair.example.basic">
   <p><strong>Example #1 <span class="function"><strong>sodium_crypto_kx_keypair()</strong></span> usage</strong></p>
   <div class="example-contents"><p>
     Create a new keypair and retrieve the secret and the public key from it.
   </p></div>
   <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$keypair </span><span style="color: #007700">= </span><span style="color: #0000BB">sodium_crypto_kx_keypair</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$secret </span><span style="color: #007700">= </span><span style="color: #0000BB">sodium_crypto_kx_secretkey</span><span style="color: #007700">(</span><span style="color: #0000BB">$keypair</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$public </span><span style="color: #007700">= </span><span style="color: #0000BB">sodium_crypto_kx_publickey</span><span style="color: #007700">(</span><span style="color: #0000BB">$keypair</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"secret: %s\npublic: %s"</span><span style="color: #007700">, </span><span style="color: #0000BB">sodium_bin2hex</span><span style="color: #007700">(</span><span style="color: #0000BB">$secret</span><span style="color: #007700">), </span><span style="color: #0000BB">sodium_bin2hex</span><span style="color: #007700">(</span><span style="color: #0000BB">$public</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>

   <div class="example-contents"><p>The above example will output
something similar to:</p></div>
   <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">secret: e7c5c918fdc40762e6000542c0118f4368ce8fd242b0e48c1e17202797a25daf
public: d1f59fda8652caf40ed1a01d2b6f3802b60846986372cd8fa337b7c12c428b18</pre>
</div>
   </div>
  </div>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-kx-keypair.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-kx-keypair%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-kx-keypair&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-kx-keypair.php">＋<small>add a note</small></a></span>
