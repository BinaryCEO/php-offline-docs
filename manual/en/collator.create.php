...
<head>
  ...
  <title>PHP: Collator::create - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/collator.create.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/collator.create.php">
 <link rel="alternate" href="https://www.php.net/manual/en/collator.create.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.collator.php">
 <link rel="prev" href="https://www.php.net/manual/en/collator.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/collator.getattribute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/collator.create.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/collator.create.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/collator.create.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/collator.create.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/collator.create.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/collator.create.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/collator.create.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/collator.create.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/collator.create.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/collator.create.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/collator.create.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Collator::create - Manual" />
<meta name="twitter:description" content="Create a collator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Collator::create - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="collator.getattribute.php">
          Collator::getAttribute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="collator.construct.php">
          &laquo; Collator::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/collator.create.php' selected="selected">English</option>
            <option value='de/collator.create.php'>German</option>
            <option value='es/collator.create.php'>Spanish</option>
            <option value='fr/collator.create.php'>French</option>
            <option value='it/collator.create.php'>Italian</option>
            <option value='ja/collator.create.php'>Japanese</option>
            <option value='pt_BR/collator.create.php'>Brazilian Portuguese</option>
            <option value='ru/collator.create.php'>Russian</option>
            <option value='tr/collator.create.php'>Turkish</option>
            <option value='uk/collator.create.php'>Ukrainian</option>
            <option value='zh/collator.create.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="collator.create" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="collator.construct.php" class="function" rel="rdfs-seeAlso">Collator::__construct()</a> - Create a collator</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/collator/create.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcollator.create%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=collator.create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/collator.create.php">＋<small>add a note</small></a></span>
