...
<head>
  ...
  <title>PHP: Gmagick::rollimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.rollimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.rollimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.rollimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.resizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.rotateimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.rollimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.rollimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.rollimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.rollimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.rollimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.rollimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.rollimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.rollimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.rollimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.rollimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.rollimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::rollimage - Manual" />
<meta name="twitter:description" content="Offsets an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::rollimage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.rotateimage.php">
          Gmagick::rotateimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.resizeimage.php">
          &laquo; Gmagick::resizeimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.rollimage.php' selected="selected">English</option>
            <option value='de/gmagick.rollimage.php'>German</option>
            <option value='es/gmagick.rollimage.php'>Spanish</option>
            <option value='fr/gmagick.rollimage.php'>French</option>
            <option value='it/gmagick.rollimage.php'>Italian</option>
            <option value='ja/gmagick.rollimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.rollimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.rollimage.php'>Russian</option>
            <option value='tr/gmagick.rollimage.php'>Turkish</option>
            <option value='uk/gmagick.rollimage.php'>Ukrainian</option>
            <option value='zh/gmagick.rollimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.rollimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::rollimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::rollimage</span> &mdash; <span class="dc-title">Offsets an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.rollimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::rollimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.rollimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.rollimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.rollimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/rollimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.rollimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.rollimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.rollimage.php">＋<small>add a note</small></a></span>
