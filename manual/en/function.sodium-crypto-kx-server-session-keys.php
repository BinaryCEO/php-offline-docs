...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-kx-server-session-keys.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-kx-seed-keypair.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-pwhash.php">
...
<meta name="Description" content="Calculate the server-side session keys." />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_kx_server_session_keys - Manual" />
<meta name="twitter:description" content="Calculate the server-side session keys." />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_kx_server_session_keys - Manual" />
<meta itemprop="description" content="Calculate the server-side session keys." />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calculate the server-side session keys." />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-kx-server-session-keys.php' selected="selected">English</option>
            ...
            <option value='fr/function.sodium-crypto-kx-server-session-keys.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_kx_server_session_keys</span> &mdash; <span class="dc-title">Calculate the server-side session keys.</span></p>
  ...
  <p class="para">
   ...
   from the client. The second should be used for sending data to the client.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-kx-server-session-keys.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-kx-server-session-keys%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-kx-server-session-keys&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-kx-server-session-keys.php">＋<small>add a note</small></a></span>
