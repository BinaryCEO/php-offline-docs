...
<head>
  ...
  <title>PHP: QuickHashStringIntHash::loadFromFile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/quickhashstringinthash.loadfromfile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/quickhashstringinthash.loadfromfile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/quickhashstringinthash.loadfromfile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.quickhashstringinthash.php">
 <link rel="prev" href="https://www.php.net/manual/en/quickhashstringinthash.getsize.php">
 <link rel="next" href="https://www.php.net/manual/en/quickhashstringinthash.loadfromstring.php">

 <link rel="alternate" href="https://www.php.net/manual/en/quickhashstringinthash.loadfromfile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/quickhashstringinthash.loadfromfile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/quickhashstringinthash.loadfromfile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/quickhashstringinthash.loadfromfile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/quickhashstringinthash.loadfromfile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/quickhashstringinthash.loadfromfile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/quickhashstringinthash.loadfromfile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/quickhashstringinthash.loadfromfile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/quickhashstringinthash.loadfromfile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/quickhashstringinthash.loadfromfile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/quickhashstringinthash.loadfromfile.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: QuickHashStringIntHash::loadFromFile - Manual" />
<meta name="twitter:description" content="This factory method creates a hash from a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: QuickHashStringIntHash::loadFromFile - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="quickhashstringinthash.loadfromstring.php">
          QuickHashStringIntHash::loadFromString &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="quickhashstringinthash.getsize.php">
          &laquo; QuickHashStringIntHash::getSize        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/quickhashstringinthash.loadfromfile.php' selected="selected">English</option>
            <option value='de/quickhashstringinthash.loadfromfile.php'>German</option>
            <option value='es/quickhashstringinthash.loadfromfile.php'>Spanish</option>
            <option value='fr/quickhashstringinthash.loadfromfile.php'>French</option>
            <option value='it/quickhashstringinthash.loadfromfile.php'>Italian</option>
            <option value='ja/quickhashstringinthash.loadfromfile.php'>Japanese</option>
            <option value='pt_BR/quickhashstringinthash.loadfromfile.php'>Brazilian Portuguese</option>
            <option value='ru/quickhashstringinthash.loadfromfile.php'>Russian</option>
            <option value='tr/quickhashstringinthash.loadfromfile.php'>Turkish</option>
            <option value='uk/quickhashstringinthash.loadfromfile.php'>Ukrainian</option>
            <option value='zh/quickhashstringinthash.loadfromfile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="quickhashstringinthash.loadfromfile" class="refentry">
...
bucket lists:
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <span class="classname"><a href="class.quickhashinthash.php" class="classname">QuickHashIntHash</a></span> and <span class="classname"><a href="class.quickhashintstringhash.php" class="classname">QuickHashIntStringHash</a></span> classes, where it is
 ...
 <div class="refsect1 returnvalues" id="refsect1-quickhashstringinthash.loadfromfile-returnvalues">
  ...
  <p class="para">
   Returns a new <span class="classname"><a href="class.quickhashstringinthash.php" class="classname">QuickHashStringIntHash</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-quickhashstringinthash.loadfromfile-examples">
  ...
  <p class="para">
   <div class="example" id="example-5445">
...
1kgp =&gt; 73177</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/quickhash/quickhashstringinthash/loadfromfile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fquickhashstringinthash.loadfromfile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=quickhashstringinthash.loadfromfile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/quickhashstringinthash.loadfromfile.php">＋<small>add a note</small></a></span>
