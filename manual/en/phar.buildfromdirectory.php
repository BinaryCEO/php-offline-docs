...
<head>
  ...
  <title>PHP: Phar::buildFromDirectory - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.buildfromdirectory.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.buildfromdirectory.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.buildfromdirectory.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.apiversion.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.buildfromiterator.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.buildfromdirectory.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.buildfromdirectory.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.buildfromdirectory.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.buildfromdirectory.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.buildfromdirectory.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.buildfromdirectory.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.buildfromdirectory.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.buildfromdirectory.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.buildfromdirectory.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.buildfromdirectory.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.buildfromdirectory.php" hreflang="zh">
...
<meta name="Description" content="Construct a phar archive from the files within a directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::buildFromDirectory - Manual" />
<meta name="twitter:description" content="Construct a phar archive from the files within a directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::buildFromDirectory - Manual" />
<meta itemprop="description" content="Construct a phar archive from the files within a directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Construct a phar archive from the files within a directory" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.buildfromiterator.php">
          Phar::buildFromIterator &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.apiversion.php">
          &laquo; Phar::apiVersion        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.buildfromdirectory.php' selected="selected">English</option>
            <option value='de/phar.buildfromdirectory.php'>German</option>
            <option value='es/phar.buildfromdirectory.php'>Spanish</option>
            <option value='fr/phar.buildfromdirectory.php'>French</option>
            <option value='it/phar.buildfromdirectory.php'>Italian</option>
            <option value='ja/phar.buildfromdirectory.php'>Japanese</option>
            <option value='pt_BR/phar.buildfromdirectory.php'>Brazilian Portuguese</option>
            <option value='ru/phar.buildfromdirectory.php'>Russian</option>
            <option value='tr/phar.buildfromdirectory.php'>Turkish</option>
            <option value='uk/phar.buildfromdirectory.php'>Ukrainian</option>
            <option value='zh/phar.buildfromdirectory.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.buildfromdirectory" class="refentry">
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
  <p class="para">
   ...
   excluded.  For more fine-grained control, use <span class="function"><a href="phar.buildfromiterator.php" class="function">Phar::buildFromIterator()</a></span>.
  </p>
 </div>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.1.0</td>
      <td>
       <span class="methodname"><strong>Phar::buildFromDirectory()</strong></span> no longer returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
      </td>
     </tr>
 ...
 <div class="refsect1 seealso" id="refsect1-phar.buildfromdirectory-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="phar.buildfromiterator.php" class="function" rel="rdfs-seeAlso">Phar::buildFromIterator()</a> - Construct a phar archive from an iterator</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/buildFromDirectory.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.buildfromdirectory%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.buildfromdirectory&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.buildfromdirectory.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121091">  <div class="votes">
    <div id="Vu121091">
    <a href="/manual/vote-note.php?id=121091&amp;page=phar.buildfromdirectory&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121091">
    <a href="/manual/vote-note.php?id=121091&amp;page=phar.buildfromdirectory&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121091" title="87% like this...">
    6
    </div>
  </div>
  <a href="#121091" class="name">
  <strong class="user"><em>dalfarra at codref dot com</em></strong></a><a class="genanchor" href="#121091"> &para;</a><div class="date" title="2017-05-16 03:00"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121091">
<div class="phpcode"><code><span class="html">If you want to exclude a directory from the archive (but include all the other content), the regular expression must take into consideration the whole path of the file, not just the file or directory name relative to the source folder.<br /><br />As an example, if we want to exclude "nbproject" directory from the archive (and any occurrence of it):<br /><br />/tmp/myfolder<br />  /nbproject<br />  /something<br />  /something-else<br />    /nbproject<br />  /file1.php<br />  /file2.php<br /><br />the regex should be:<br /><span class="default">&lt;?php<br />  $exclude </span><span class="keyword">= </span><span class="string">'/^(?!(.*nbproject))(.*)$/i'</span><span class="keyword">;  </span><span class="comment">//ignoring the case<br /></span><span class="default">?&gt;<br /></span><br />A more complete example:<br /><span class="default">&lt;?php<br />    $archive_file </span><span class="keyword">= </span><span class="string">'myarchive.tar'</span><span class="keyword">;<br />    </span><span class="default">$folder_to_compress </span><span class="keyword">= </span><span class="string">'/tmp/myfolder'</span><span class="keyword">;<br />    </span><span class="default">$archive </span><span class="keyword">= new </span><span class="default">PharData</span><span class="keyword">(</span><span class="default">$archive_file</span><span class="keyword">);<br />    </span><span class="default">$exclude </span><span class="keyword">= </span><span class="string">'/^(?!(.*nbproject))(.*)$/i'</span><span class="keyword">;  <br />    </span><span class="default">$archive</span><span class="keyword">-&gt;</span><span class="default">buildFromDirectory</span><span class="keyword">(</span><span class="default">$folder_to_compress</span><span class="keyword">,</span><span class="default">$exclude</span><span class="keyword">);<br />    </span><span class="default">$archive</span><span class="keyword">-&gt;</span><span class="default">compress</span><span class="keyword">(</span><span class="default">Phar</span><span class="keyword">::</span><span class="default">GZ</span><span class="keyword">);<br />    </span><span class="default">unlink</span><span class="keyword">(</span><span class="default">$archive_file</span><span class="keyword">); </span><span class="comment">// as we already obtained a tar.gz<br /></span><span class="default">?&gt;<br /></span><br />the archive will contain:<br />/<br />  /something<br />  /something-else<br />  /file1.php<br />  /file2.php</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phar.buildfromdirectory&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.buildfromdirectory.php">＋<small>add a note</small></a></div>
