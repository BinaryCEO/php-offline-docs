...
<div class="phpcode"><code><span class="html">This is an example of how to allow fopen() to overwrite a file on an FTP site. If the stream context is not modified, an error will occur: "...failed to open stream: Remote file already exists and overwrite context option not specified...".<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// The path to the FTP file, including login arguments<br /></span><span class="default">$ftp_path </span><span class="keyword">= </span><span class="string">'<a href="ftp://username:password@example.com/example.txt" rel="nofollow" target="_blank">ftp://username:password@example.com/example.txt</a>'</span><span class="keyword">;<br /><br /></span><span class="comment">// Allows overwriting of existing files on the remote FTP server<br /></span><span class="default">$stream_options </span><span class="keyword">= array(</span><span class="string">'ftp' </span><span class="keyword">=&gt; array(</span><span class="string">'overwrite' </span><span class="keyword">=&gt; </span><span class="default">true</span><span class="keyword">));<br /><br /></span><span class="comment">// Creates a stream context resource with the defined options<br /></span><span class="default">$stream_context </span><span class="keyword">= </span><span class="default">stream_context_create</span><span class="keyword">(</span><span class="default">$stream_options</span><span class="keyword">);<br /><br /></span><span class="comment">// Opens the file for writing and truncates it to zero length <br /></span><span class="keyword">if (</span><span class="default">$fh </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$ftp_path</span><span class="keyword">, </span><span class="string">'w'</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$stream_context</span><span class="keyword">))<br />{<br />    </span><span class="comment">// Writes contents to the file<br />    </span><span class="default">fputs</span><span class="keyword">(</span><span class="default">$fh</span><span class="keyword">, </span><span class="string">'example contents'</span><span class="keyword">);<br />    <br />    </span><span class="comment">// Closes the file handle<br />    </span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$fh</span><span class="keyword">);<br />}<br />else<br />{<br />    die(</span><span class="string">'Could not open file.'</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <strong class="user"><em>dev at codesatori dot com</em></strong></a><a class="genanchor" href="#120220"> &para;</a><div class="date" title="2016-11-24 07:01"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120220">
<div class="phpcode"><code><span class="html">Apparently the overwrite-option only registers as false if it's absent. If I specify it as false, it acts the same as true and overwrites. Then, <br /><span class="default">&lt;?php<br /></span><span class="keyword">if (empty(</span><span class="default">$opts</span><span class="keyword">[</span><span class="string">'overwrite'</span><span class="keyword">])) {<br />    unset(</span><span class="default">$opts</span><span class="keyword">[</span><span class="string">'overwrite'</span><span class="keyword">]);<br />}<br /></span><span class="default">?&gt;<br /></span>...was the simple fix for my FTP stream wrapper class sporting default options. This is quite unexpected though; false means false even if I say so? Apparently PHP (7.0.2) just checks if the option exists, not its boolean value.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">// Ruta del ftp debe coincidir con la ruta del localhost<br />$ftp_path = '<a href="ftp://francisco:aaa@localhost:21/ftparchivo.txt" rel="nofollow" target="_blank">ftp://francisco:aaa@localhost:21/ftparchivo.txt</a>';<br />// Escribimos las opciones de stream<br />$stream_options = array('ftp' =&gt; array('overwrite' =&gt; TRUE));<br />// Creamos un contexto<br />$stream_context = stream_context_create($stream_options);<br />\escribir::verifacionnota($stream_context, 'STREAMCONTEXT');<br />// Abrimos el fichero que vamos a leer<br />$flujo = fopen($ftp_path, 'r', false, $stream_context);<br />//Funcion creada :vardump + string<br />\escribir::verifacionnota($flujo, 'VARDUMP FOPEN');<br /><br />$contenido = '';<br />//Traduccion mientras el contenido del archivo no este al final del fichero ==&gt; feof<br />while (!feof($flujo)) {<br />//Entonces lee 8192 bytes del archivo y añadelos a la variable contenido<br />$contenido .= fread($flujo, 8192);<br />}<br />\escribir::verifacionnota($contenido, 'VARDUMP CONTENIDO');<br />//Cerramos el flujo<br />fclose($flujo);</span></code></div>
  </div>
 </div></div>
