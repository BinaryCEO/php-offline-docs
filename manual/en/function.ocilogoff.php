...
<head>
  ...
  <title>PHP: ocilogoff - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocilogoff.php">
 <link rel="shorturl" href="https://www.php.net/ocilogoff">
 <link rel="alternate" href="https://www.php.net/ocilogoff" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ociloadlob.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocilogon.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocilogoff.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocilogoff.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocilogoff.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocilogoff.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocilogoff.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocilogoff.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocilogoff.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocilogoff.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocilogoff.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocilogoff.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocilogoff.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_close" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocilogoff - Manual" />
<meta name="twitter:description" content="Alias of oci_close" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocilogoff - Manual" />
<meta itemprop="description" content="Alias of oci_close" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_close" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocilogoff.php' selected="selected">English</option>
            <option value='de/function.ocilogoff.php'>German</option>
            <option value='es/function.ocilogoff.php'>Spanish</option>
            <option value='fr/function.ocilogoff.php'>French</option>
            <option value='it/function.ocilogoff.php'>Italian</option>
            <option value='ja/function.ocilogoff.php'>Japanese</option>
            <option value='pt_BR/function.ocilogoff.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocilogoff.php'>Russian</option>
            <option value='tr/function.ocilogoff.php'>Turkish</option>
            <option value='uk/function.ocilogoff.php'>Ukrainian</option>
            <option value='zh/function.ocilogoff.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocilogoff" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocilogoff</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocilogoff</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-close.php" class="function">oci_close()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocilogoff-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-close.php" class="function">oci_close()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocilogoff.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocilogoff%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocilogoff&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocilogoff.php">＋<small>add a note</small></a></span>
