...
<head>
  ...
  <title>PHP: ps_clip - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-clip.php">
 <link rel="shorturl" href="https://www.php.net/ps-clip">
 <link rel="alternate" href="https://www.php.net/ps-clip" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-circle.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-clip.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-clip.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-clip.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-clip.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-clip.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-clip.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-clip.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-clip.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-clip.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-clip.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-clip.php" hreflang="zh">
...
<meta name="Description" content="Clips drawing to current path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_clip - Manual" />
<meta name="twitter:description" content="Clips drawing to current path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_clip - Manual" />
<meta itemprop="description" content="Clips drawing to current path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clips drawing to current path" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-clip.php' selected="selected">English</option>
            <option value='de/function.ps-clip.php'>German</option>
            <option value='es/function.ps-clip.php'>Spanish</option>
            <option value='fr/function.ps-clip.php'>French</option>
            <option value='it/function.ps-clip.php'>Italian</option>
            <option value='ja/function.ps-clip.php'>Japanese</option>
            <option value='pt_BR/function.ps-clip.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-clip.php'>Russian</option>
            <option value='tr/function.ps-clip.php'>Turkish</option>
            <option value='uk/function.ps-clip.php'>Ukrainian</option>
            <option value='zh/function.ps-clip.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-clip" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_clip</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_clip</span> &mdash; <span class="dc-title">Clips drawing to current path</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-clip-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_clip</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-clip-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-clip-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-clip-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-closepath.php" class="function" rel="rdfs-seeAlso">ps_closepath()</a> - Closes path</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-clip.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-clip%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-clip&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-clip.php">＋<small>add a note</small></a></span>
