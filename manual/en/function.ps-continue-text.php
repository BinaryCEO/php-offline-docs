...
<head>
  ...
  <title>PHP: ps_continue_text - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-continue-text.php">
 <link rel="shorturl" href="https://www.php.net/ps-continue-text">
 <link rel="alternate" href="https://www.php.net/ps-continue-text" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-closepath-stroke.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-curveto.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-continue-text.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-continue-text.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-continue-text.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-continue-text.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-continue-text.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-continue-text.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-continue-text.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-continue-text.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-continue-text.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-continue-text.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-continue-text.php" hreflang="zh">
...
<meta name="Description" content="Continue text in next line" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_continue_text - Manual" />
<meta name="twitter:description" content="Continue text in next line" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_continue_text - Manual" />
<meta itemprop="description" content="Continue text in next line" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Continue text in next line" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-continue-text.php' selected="selected">English</option>
            <option value='de/function.ps-continue-text.php'>German</option>
            <option value='es/function.ps-continue-text.php'>Spanish</option>
            <option value='fr/function.ps-continue-text.php'>French</option>
            <option value='it/function.ps-continue-text.php'>Italian</option>
            <option value='ja/function.ps-continue-text.php'>Japanese</option>
            <option value='pt_BR/function.ps-continue-text.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-continue-text.php'>Russian</option>
            <option value='tr/function.ps-continue-text.php'>Turkish</option>
            <option value='uk/function.ps-continue-text.php'>Ukrainian</option>
            <option value='zh/function.ps-continue-text.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-continue-text" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-show-boxed.php" class="function" rel="rdfs-seeAlso">ps_show_boxed()</a> - Output text in a box</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-continue-text.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-continue-text%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-continue-text&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-continue-text.php">＋<small>add a note</small></a></span>
