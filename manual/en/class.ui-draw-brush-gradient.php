...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-draw-brush-gradient.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/ui-draw-brush.setcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-draw-brush-gradient.addstop.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-draw-brush-gradient.php' selected="selected">English</option>
            ...
            <option value='ja/class.ui-draw-brush-gradient.php'>Japanese</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-draw-brush-gradient.addstop.php">UI\Draw\Brush\Gradient::addStop</a> — Stop Manipulation</li><li><a href="ui-draw-brush-gradient.delstop.php">UI\Draw\Brush\Gradient::delStop</a> — Stop Manipulation</li><li><a href="ui-draw-brush-gradient.setstop.php">UI\Draw\Brush\Gradient::setStop</a> — Stop Manipulation</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.draw.brush.gradient.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-draw-brush-gradient%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-draw-brush-gradient&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-draw-brush-gradient.php">＋<small>add a note</small></a></span>
