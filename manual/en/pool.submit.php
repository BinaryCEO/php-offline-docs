...
<head>
  ...
  <title>PHP: Pool::submit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/pool.submit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/pool.submit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/pool.submit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.pool.php">
 <link rel="prev" href="https://www.php.net/manual/en/pool.shutdown.php">
 <link rel="next" href="https://www.php.net/manual/en/pool.submitTo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/pool.submit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/pool.submit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/pool.submit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/pool.submit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/pool.submit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/pool.submit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/pool.submit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/pool.submit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/pool.submit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/pool.submit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/pool.submit.php" hreflang="zh">
...
<meta name="Description" content="Submits an object for execution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Pool::submit - Manual" />
<meta name="twitter:description" content="Submits an object for execution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Pool::submit - Manual" />
<meta itemprop="description" content="Submits an object for execution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Submits an object for execution" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/pool.submit.php' selected="selected">English</option>
            <option value='de/pool.submit.php'>German</option>
            <option value='es/pool.submit.php'>Spanish</option>
            <option value='fr/pool.submit.php'>French</option>
            <option value='it/pool.submit.php'>Italian</option>
            <option value='ja/pool.submit.php'>Japanese</option>
            <option value='pt_BR/pool.submit.php'>Brazilian Portuguese</option>
            <option value='ru/pool.submit.php'>Russian</option>
            <option value='tr/pool.submit.php'>Turkish</option>
            <option value='uk/pool.submit.php'>Ukrainian</option>
            <option value='zh/pool.submit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="pool.submit" class="refentry">
...
<div class="examplescode"><pre class="examplescode">object(Pool)#1 (6) {
  ...
  int(1)
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pthreads/pool/submit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fpool.submit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=pool.submit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pool.submit.php">＋<small>add a note</small></a></span>
