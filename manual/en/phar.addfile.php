...
<head>
  ...
  <title>PHP: Phar::addFile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.addfile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.addfile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.addfile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.addemptydir.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.addfromstring.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.addfile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.addfile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.addfile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.addfile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.addfile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.addfile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.addfile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.addfile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.addfile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.addfile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.addfile.php" hreflang="zh">
...
<meta name="Description" content="Add a file from the filesystem to the phar archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::addFile - Manual" />
<meta name="twitter:description" content="Add a file from the filesystem to the phar archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::addFile - Manual" />
<meta itemprop="description" content="Add a file from the filesystem to the phar archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add a file from the filesystem to the phar archive" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.addfromstring.php">
          Phar::addFromString &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.addemptydir.php">
          &laquo; Phar::addEmptyDir        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.addfile.php' selected="selected">English</option>
            <option value='de/phar.addfile.php'>German</option>
            <option value='es/phar.addfile.php'>Spanish</option>
            <option value='fr/phar.addfile.php'>French</option>
            <option value='it/phar.addfile.php'>Italian</option>
            <option value='ja/phar.addfile.php'>Japanese</option>
            <option value='pt_BR/phar.addfile.php'>Brazilian Portuguese</option>
            <option value='ru/phar.addfile.php'>Russian</option>
            <option value='tr/phar.addfile.php'>Turkish</option>
            <option value='uk/phar.addfile.php'>Ukrainian</option>
            <option value='zh/phar.addfile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.addfile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::addFile</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">Phar::addFile</span> &mdash; <span class="dc-title">Add a file from the filesystem to the phar archive</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-phar.addfile-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::addFile</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$localName</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
  ...
  <p class="para">
   ...
   the optional second parameter <code class="parameter">localName</code> is a <span class="type"><a href="language.types.string.php" class="type string">string</a></span>,
   the file will be stored in the archive with that name, otherwise the
   <code class="literal">file</code> parameter is used as the path to store within
   the archive.  URLs must have a localname or an exception is thrown.
   This method is similar to <span class="function"><a href="ziparchive.addfile.php" class="function">ZipArchive::addFile()</a></span>.
  </p>

 </div>

 <div class="refsect1 parameters" id="refsect1-phar.addfile-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-phar.addfile-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-phar.addfile-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">localName</code> is now nullable.
      </td>
     </tr>
 ...
 <div class="refsect1 examples" id="refsect1-phar.addfile-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-798">
    <p><strong>Example #1 A <span class="function"><strong>Phar::addFile()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">try {<br />    </span><span style="color: #0000BB">$a </span><span style="color: #007700">= new </span><span style="color: #0000BB">Phar</span><span style="color: #007700">(</span><span style="color: #DD0000">'/path/to/phar.phar'</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$a</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addFile</span><span style="color: #007700">(</span><span style="color: #DD0000">'/full/path/to/file'</span><span style="color: #007700">);<br />    </span><span style="color: #FF8000">// demonstrates how this file is stored<br />    </span><span style="color: #0000BB">$b </span><span style="color: #007700">= </span><span style="color: #0000BB">$a</span><span style="color: #007700">[</span><span style="color: #DD0000">'full/path/to/file'</span><span style="color: #007700">]-&gt;</span><span style="color: #0000BB">getContent</span><span style="color: #007700">();<br /><br />    </span><span style="color: #0000BB">$a</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addFile</span><span style="color: #007700">(</span><span style="color: #DD0000">'/full/path/to/file'</span><span style="color: #007700">, </span><span style="color: #DD0000">'my/file.txt'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$c </span><span style="color: #007700">= </span><span style="color: #0000BB">$a</span><span style="color: #007700">[</span><span style="color: #DD0000">'my/file.txt'</span><span style="color: #007700">]-&gt;</span><span style="color: #0000BB">getContent</span><span style="color: #007700">();<br /><br />    </span><span style="color: #FF8000">// demonstrate URL usage<br />    </span><span style="color: #0000BB">$a</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addFile</span><span style="color: #007700">(</span><span style="color: #DD0000">'http://www.example.com'</span><span style="color: #007700">, </span><span style="color: #DD0000">'example.html'</span><span style="color: #007700">);<br />} catch (</span><span style="color: #0000BB">Exception $e</span><span style="color: #007700">) {<br />    </span><span style="color: #FF8000">// handle errors here<br /></span><span style="color: #007700">}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-phar.addfile-notes">
  <h3 class="title">Notes</h3>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
 <span class="simpara">
  <span class="function"><strong>Phar::addFile()</strong></span>, <span class="function"><a href="phar.addfromstring.php" class="function">Phar::addFromString()</a></span> and <span class="function"><a href="phar.offsetset.php" class="function">Phar::offsetSet()</a></span>
 ...
 <div class="refsect1 seealso" id="refsect1-phar.addfile-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.addfromstring.php" class="function" rel="rdfs-seeAlso">Phar::addFromString()</a> - Add a file from a string to the phar archive</span></li>
    <li><span class="function"><a href="phar.addemptydir.php" class="function" rel="rdfs-seeAlso">Phar::addEmptyDir()</a> - Add an empty directory to the phar archive</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/addFile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.addfile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.addfile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.addfile.php">＋<small>add a note</small></a></span>
