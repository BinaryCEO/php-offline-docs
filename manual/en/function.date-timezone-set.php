...
<head>
  ...
  <title>PHP: date_timezone_set - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-timezone-set.php">
 <link rel="shorturl" href="https://www.php.net/date-timezone-set">
 <link rel="alternate" href="https://www.php.net/date-timezone-set" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-timezone-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.getdate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-timezone-set.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-timezone-set.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-timezone-set.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-timezone-set.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-timezone-set.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-timezone-set.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-timezone-set.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-timezone-set.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-timezone-set.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-timezone-set.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-timezone-set.php" hreflang="zh">
...
<meta name="Description" content="Alias of DateTime::setTimezone" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_timezone_set - Manual" />
<meta name="twitter:description" content="Alias of DateTime::setTimezone" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_timezone_set - Manual" />
<meta itemprop="description" content="Alias of DateTime::setTimezone" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTime::setTimezone" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.getdate.php">
          getdate &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.date-timezone-get.php">
          &laquo; date_timezone_get        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-timezone-set.php' selected="selected">English</option>
            <option value='de/function.date-timezone-set.php'>German</option>
            <option value='es/function.date-timezone-set.php'>Spanish</option>
            <option value='fr/function.date-timezone-set.php'>French</option>
            <option value='it/function.date-timezone-set.php'>Italian</option>
            <option value='ja/function.date-timezone-set.php'>Japanese</option>
            <option value='pt_BR/function.date-timezone-set.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-timezone-set.php'>Russian</option>
            <option value='tr/function.date-timezone-set.php'>Turkish</option>
            <option value='uk/function.date-timezone-set.php'>Ukrainian</option>
            <option value='zh/function.date-timezone-set.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-timezone-set" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">date_timezone_set</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">date_timezone_set</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetime.settimezone.php" class="methodname">DateTime::setTimezone()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.date-timezone-set-description">
  <h3 class="title">Description</h3>
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetime.settimezone.php" class="methodname">DateTime::setTimezone()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-timezone-set.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-timezone-set%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-timezone-set&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-timezone-set.php">＋<small>add a note</small></a></span>
