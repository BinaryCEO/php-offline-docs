...
<head>
  ...
  <title>PHP: ldap_count_references - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-count-references.php">
 <link rel="shorturl" href="https://www.php.net/ldap-count-references">
 <link rel="alternate" href="https://www.php.net/ldap-count-references" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-count-entries.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-delete.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-count-references.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-count-references.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-count-references.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-count-references.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-count-references.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-count-references.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-count-references.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-count-references.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-count-references.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-count-references.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-count-references.php" hreflang="zh">
...
<meta name="Description" content="Counts the number of references in a search result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_count_references - Manual" />
<meta name="twitter:description" content="Counts the number of references in a search result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_count_references - Manual" />
<meta itemprop="description" content="Counts the number of references in a search result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Counts the number of references in a search result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ldap-delete.php">
          ldap_delete &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-count-entries.php">
          &laquo; ldap_count_entries        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-count-references.php' selected="selected">English</option>
            <option value='de/function.ldap-count-references.php'>German</option>
            <option value='es/function.ldap-count-references.php'>Spanish</option>
            <option value='fr/function.ldap-count-references.php'>French</option>
            <option value='it/function.ldap-count-references.php'>Italian</option>
            <option value='ja/function.ldap-count-references.php'>Japanese</option>
            <option value='pt_BR/function.ldap-count-references.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-count-references.php'>Russian</option>
            <option value='tr/function.ldap-count-references.php'>Turkish</option>
            <option value='uk/function.ldap-count-references.php'>Ukrainian</option>
            <option value='zh/function.ldap-count-references.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-count-references" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_count_references</h1>
  <p class="verinfo">(PHP 8)</p><p class="refpurpose"><span class="refname">ldap_count_references</span> &mdash; <span class="dc-title">Counts the number of references in a search result</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ldap-count-references-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_count_references</strong></span>(<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>, <span class="methodparam"><span class="type"><a href="class.ldap-result.php" class="type LDAP\Result">LDAP\Result</a></span> <code class="parameter">$result</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ldap-count-references-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ldap-count-references-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.ldap-count-references-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ldap-count-references-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.ldap-connect.php" class="function" rel="rdfs-seeAlso">ldap_connect()</a> - Connect to an LDAP server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-count-references.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-count-references%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-count-references&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-count-references.php">＋<small>add a note</small></a></span>
