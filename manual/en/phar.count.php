...
<head>
  ...
  <title>PHP: Phar::count - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.count.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.count.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.count.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.copy.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.createdefaultstub.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.count.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.count.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.count.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.count.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.count.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.count.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.count.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.count.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.count.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.count.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.count.php" hreflang="zh">
...
<meta name="Description" content="Returns the number of entries (files) in the Phar archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::count - Manual" />
<meta name="twitter:description" content="Returns the number of entries (files) in the Phar archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::count - Manual" />
<meta itemprop="description" content="Returns the number of entries (files) in the Phar archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the number of entries (files) in the Phar archive" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.count.php' selected="selected">English</option>
            <option value='de/phar.count.php'>German</option>
            <option value='es/phar.count.php'>Spanish</option>
            <option value='fr/phar.count.php'>French</option>
            <option value='it/phar.count.php'>Italian</option>
            <option value='ja/phar.count.php'>Japanese</option>
            <option value='pt_BR/phar.count.php'>Brazilian Portuguese</option>
            <option value='ru/phar.count.php'>Russian</option>
            <option value='tr/phar.count.php'>Turkish</option>
            <option value='uk/phar.count.php'>Ukrainian</option>
            <option value='zh/phar.count.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.count" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-phar.count-examples">
  ...
  <p class="para">
   <div class="example" id="example-812">
    <p><strong>Example #1 A <span class="function"><strong>Phar::count()</strong></span> example</strong></p>
...
The new phar has 1 entries</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/count.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.count%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.count.php">＋<small>add a note</small></a></span>
