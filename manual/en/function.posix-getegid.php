...
<head>
  ...
  <title>PHP: posix_getegid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-getegid.php">
 <link rel="shorturl" href="https://www.php.net/posix-getegid">
 <link rel="alternate" href="https://www.php.net/posix-getegid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-getcwd.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-geteuid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-getegid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-getegid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-getegid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-getegid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-getegid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-getegid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-getegid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-getegid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-getegid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-getegid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-getegid.php" hreflang="zh">
...
<meta name="Description" content="Return the effective group ID of the current process" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_getegid - Manual" />
<meta name="twitter:description" content="Return the effective group ID of the current process" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_getegid - Manual" />
<meta itemprop="description" content="Return the effective group ID of the current process" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the effective group ID of the current process" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.posix-geteuid.php">
          posix_geteuid &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.posix-getcwd.php">
          &laquo; posix_getcwd        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-getegid.php' selected="selected">English</option>
            <option value='de/function.posix-getegid.php'>German</option>
            <option value='es/function.posix-getegid.php'>Spanish</option>
            <option value='fr/function.posix-getegid.php'>French</option>
            <option value='it/function.posix-getegid.php'>Italian</option>
            <option value='ja/function.posix-getegid.php'>Japanese</option>
            <option value='pt_BR/function.posix-getegid.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-getegid.php'>Russian</option>
            <option value='tr/function.posix-getegid.php'>Turkish</option>
            <option value='uk/function.posix-getegid.php'>Ukrainian</option>
            <option value='zh/function.posix-getegid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-getegid" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">posix_getegid</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_getegid</span> &mdash; <span class="dc-title">Return the effective group ID of the current process</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.posix-getegid-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>posix_getegid</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.posix-getegid-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.posix-getegid-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> of the effective group ID.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.posix-getegid-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3576">
    <p><strong>Example #1 <span class="function"><strong>posix_getegid()</strong></span> example</strong></p>
    <div class="example-contents"><p>
     This example will print out the effective group id, once it is
     changed with <span class="function"><a href="function.posix-setegid.php" class="function">posix_setegid()</a></span>.
    </p></div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">echo </span><span style="color: #DD0000">'My real group id is '</span><span style="color: #007700">.</span><span style="color: #0000BB">posix_getgid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//20<br /></span><span style="color: #0000BB">posix_setegid</span><span style="color: #007700">(</span><span style="color: #0000BB">40</span><span style="color: #007700">);<br />echo </span><span style="color: #DD0000">'My real group id is '</span><span style="color: #007700">.</span><span style="color: #0000BB">posix_getgid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//20<br /></span><span style="color: #007700">echo </span><span style="color: #DD0000">'My effective group id is '</span><span style="color: #007700">.</span><span style="color: #0000BB">posix_getegid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//40<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.posix-getegid-notes">
  <h3 class="title">Notes</h3>
  <p class="para">
   <span class="function"><strong>posix_getegid()</strong></span> is different than 
   <span class="function"><a href="function.posix-getgid.php" class="function">posix_getgid()</a></span> because effective group ID can be changed by
   a calling process using <span class="function"><a href="function.posix-setegid.php" class="function">posix_setegid()</a></span>.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.posix-getegid-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.posix-setgid.php" class="function" rel="rdfs-seeAlso">posix_setgid()</a> - Set the GID of the current process</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-getegid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-getegid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-getegid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getegid.php">＋<small>add a note</small></a></span>
