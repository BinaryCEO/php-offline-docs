...
<head>
  ...
  <title>PHP: intl Functions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.intl.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/intliterator.valid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.intl-error-name.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ref.intl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ref.intl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ref.intl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ref.intl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ref.intl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ref.intl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ref.intl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ref.intl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ref.intl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ref.intl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ref.intl.php" hreflang="zh">
...
<meta name="Description" content="intl Functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: intl Functions - Manual" />
<meta name="twitter:description" content="intl Functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: intl Functions - Manual" />
<meta itemprop="description" content="intl Functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="intl Functions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.intl-error-name.php">
          intl_error_name &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intliterator.valid.php">
          &laquo; IntlIterator::valid        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.intl.php' selected="selected">English</option>
            <option value='de/ref.intl.php'>German</option>
            <option value='es/ref.intl.php'>Spanish</option>
            <option value='fr/ref.intl.php'>French</option>
            <option value='it/ref.intl.php'>Italian</option>
            <option value='ja/ref.intl.php'>Japanese</option>
            <option value='pt_BR/ref.intl.php'>Brazilian Portuguese</option>
            <option value='ru/ref.intl.php'>Russian</option>
            <option value='tr/ref.intl.php'>Turkish</option>
            <option value='uk/ref.intl.php'>Ukrainian</option>
            <option value='zh/ref.intl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ref.intl" class="reference">
 <h1 class="title">intl Functions</h1>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="function.intl-error-name.php">intl_error_name</a> — Get symbolic name for a given error code</li><li><a href="function.intl-get-error-code.php">intl_get_error_code</a> — Get the last error code</li><li><a href="function.intl-get-error-message.php">intl_get_error_message</a> — Get description of the last error</li><li><a href="function.intl-is-failure.php">intl_is_failure</a> — Check whether the given error code indicates failure</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/reference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fref.intl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ref.intl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.intl.php">＋<small>add a note</small></a></span>
