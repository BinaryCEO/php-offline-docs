...
<head>
  ...
  <title>PHP: ZookeeperException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.zookeeperexception.php">
 <link rel="shorturl" href="https://www.php.net/zookeeperexception">
 <link rel="alternate" href="https://www.php.net/zookeeperexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.zookeeper.php">
 <link rel="prev" href="https://www.php.net/manual/en/zookeeperconfig.set.php">
 <link rel="next" href="https://www.php.net/manual/en/class.zookeeperauthenticationexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.zookeeperexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.zookeeperexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.zookeeperexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.zookeeperexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.zookeeperexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.zookeeperexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.zookeeperexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.zookeeperexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.zookeeperexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.zookeeperexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.zookeeperexception.php" hreflang="zh">
...
<meta name="Description" content="The ZookeeperException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZookeeperException - Manual" />
<meta name="twitter:description" content="The ZookeeperException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZookeeperException - Manual" />
<meta itemprop="description" content="The ZookeeperException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ZookeeperException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.zookeeperauthenticationexception.php">
          ZookeeperAuthenticationException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="zookeeperconfig.set.php">
          &laquo; ZookeeperConfig::set        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.zookeeperexception.php' selected="selected">English</option>
            <option value='de/class.zookeeperexception.php'>German</option>
            <option value='es/class.zookeeperexception.php'>Spanish</option>
            <option value='fr/class.zookeeperexception.php'>French</option>
            <option value='it/class.zookeeperexception.php'>Italian</option>
            <option value='ja/class.zookeeperexception.php'>Japanese</option>
            <option value='pt_BR/class.zookeeperexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.zookeeperexception.php'>Russian</option>
            <option value='tr/class.zookeeperexception.php'>Turkish</option>
            <option value='uk/class.zookeeperexception.php'>Ukrainian</option>
            <option value='zh/class.zookeeperexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.zookeeperexception" class="reference">
 <h1 class="title">The ZookeeperException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PECL zookeeper &gt;= 0.3.0)</p>
 

  <div class="section" id="zookeeperexception.intro">
  ...
  <div class="section" id="zookeeperexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">ZookeeperException</strong>
     </span>
     <span class="ooclass">
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeeperexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.zookeeperexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.zookeeperexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.zookeeperexception.php">＋<small>add a note</small></a></span>
