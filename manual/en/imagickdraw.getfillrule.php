...
<head>
  ...
  <title>PHP: ImagickDraw::getFillRule - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getfillrule.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getfillrule.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfillrule.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getfillopacity.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getfont.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfillrule.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getfillrule.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getfillrule.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getfillrule.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getfillrule.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getfillrule.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getfillrule.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getfillrule.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getfillrule.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getfillrule.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getfillrule.php" hreflang="zh">
...
<meta name="Description" content="Returns the fill rule" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getFillRule - Manual" />
<meta name="twitter:description" content="Returns the fill rule" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getFillRule - Manual" />
<meta itemprop="description" content="Returns the fill rule" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the fill rule" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.getfont.php">
          ImagickDraw::getFont &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getfillopacity.php">
          &laquo; ImagickDraw::getFillOpacity        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getfillrule.php' selected="selected">English</option>
            <option value='de/imagickdraw.getfillrule.php'>German</option>
            <option value='es/imagickdraw.getfillrule.php'>Spanish</option>
            <option value='fr/imagickdraw.getfillrule.php'>French</option>
            <option value='it/imagickdraw.getfillrule.php'>Italian</option>
            <option value='ja/imagickdraw.getfillrule.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getfillrule.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getfillrule.php'>Russian</option>
            <option value='tr/imagickdraw.getfillrule.php'>Turkish</option>
            <option value='uk/imagickdraw.getfillrule.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getfillrule.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getfillrule" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getFillRule</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getFillRule</span> &mdash; <span class="dc-title">Returns the fill rule</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-imagickdraw.getfillrule-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getFillRule</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getfillrule-returnvalues">
  ...
  <p class="para">
   ...
   (<code class="literal">imagick::FILLRULE_*</code>).
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getfillrule.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getfillrule%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getfillrule&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getfillrule.php">＋<small>add a note</small></a></span>
