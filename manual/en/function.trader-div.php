...
<head>
  ...
  <title>PHP: trader_div - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-div.php">
 <link rel="shorturl" href="https://www.php.net/trader-div">
 <link rel="alternate" href="https://www.php.net/trader-div" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-dema.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-dx.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-div.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-div.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-div.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-div.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-div.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-div.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-div.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-div.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-div.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-div.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-div.php" hreflang="zh">
...
<meta name="Description" content="Vector Arithmetic Div" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_div - Manual" />
<meta name="twitter:description" content="Vector Arithmetic Div" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_div - Manual" />
<meta itemprop="description" content="Vector Arithmetic Div" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Vector Arithmetic Div" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.trader-dx.php">
          trader_dx &raquo;
              ...
              <div class="prev">
        <a href="function.trader-dema.php">
          &laquo; trader_dema        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-div.php' selected="selected">English</option>
            <option value='de/function.trader-div.php'>German</option>
            <option value='es/function.trader-div.php'>Spanish</option>
            <option value='fr/function.trader-div.php'>French</option>
            <option value='it/function.trader-div.php'>Italian</option>
            <option value='ja/function.trader-div.php'>Japanese</option>
            <option value='pt_BR/function.trader-div.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-div.php'>Russian</option>
            <option value='tr/function.trader-div.php'>Turkish</option>
            <option value='uk/function.trader-div.php'>Ukrainian</option>
            <option value='zh/function.trader-div.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-div" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_div</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_div</span> &mdash; <span class="dc-title">Vector Arithmetic Div</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-div-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_div</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real0</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real1</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   Divides each value from <code class="parameter">real0</code> by the corresponding
   value from <code class="parameter">real1</code> and returns the resulting array.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.trader-div-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-div-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-div.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-div%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-div&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-div.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125760">  <div class="votes">
    <div id="Vu125760">
    <a href="/manual/vote-note.php?id=125760&amp;page=function.trader-div&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125760">
    <a href="/manual/vote-note.php?id=125760&amp;page=function.trader-div&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125760" title="100% like this...">
    1
    </div>
  </div>
  <a href="#125760" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#125760"> &para;</a><div class="date" title="2021-02-03 05:37"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125760">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br />$result </span><span class="keyword">= </span><span class="default">trader_div</span><span class="keyword">([</span><span class="default">1</span><span class="keyword">,</span><span class="default">2</span><span class="keyword">,</span><span class="default">3</span><span class="keyword">,</span><span class="default">4</span><span class="keyword">,</span><span class="default">5</span><span class="keyword">], [</span><span class="default">6</span><span class="keyword">,</span><span class="default">7</span><span class="keyword">,</span><span class="default">8</span><span class="keyword">,</span><span class="default">9</span><span class="keyword">,</span><span class="default">10</span><span class="keyword">]);<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">);<br /></span><span class="comment">/*<br />array(5) {<br />  [0]=&gt;<br />  float(0.167) // 1 / 6<br />  [1]=&gt;<br />  float(0.286) / 2 / 7<br />  [2]=&gt;<br />  float(0.375) // 3 / 8<br />  [3]=&gt;<br />  float(0.444) // 4 / 9<br />  [4]=&gt;<br />  float(0.5) // 5 / 10<br />}<br />*/</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-div&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-div.php">＋<small>add a note</small></a></div>
