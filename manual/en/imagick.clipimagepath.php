...
<head>
  ...
  <title>PHP: Imagick::clipImagePath - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.clipimagepath.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.clipimagepath.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clipimagepath.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.clipimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.clippathimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clipimagepath.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.clipimagepath.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.clipimagepath.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.clipimagepath.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.clipimagepath.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.clipimagepath.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.clipimagepath.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.clipimagepath.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.clipimagepath.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.clipimagepath.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.clipimagepath.php" hreflang="zh">
...
<meta name="Description" content="Clips along the named paths from the 8BIM profile, if present" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::clipImagePath - Manual" />
<meta name="twitter:description" content="Clips along the named paths from the 8BIM profile, if present" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::clipImagePath - Manual" />
<meta itemprop="description" content="Clips along the named paths from the 8BIM profile, if present" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clips along the named paths from the 8BIM profile, if present" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.clippathimage.php">
          Imagick::clipPathImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.clipimage.php">
          &laquo; Imagick::clipImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.clipimagepath.php' selected="selected">English</option>
            <option value='de/imagick.clipimagepath.php'>German</option>
            <option value='es/imagick.clipimagepath.php'>Spanish</option>
            <option value='fr/imagick.clipimagepath.php'>French</option>
            <option value='it/imagick.clipimagepath.php'>Italian</option>
            <option value='ja/imagick.clipimagepath.php'>Japanese</option>
            <option value='pt_BR/imagick.clipimagepath.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.clipimagepath.php'>Russian</option>
            <option value='tr/imagick.clipimagepath.php'>Turkish</option>
            <option value='uk/imagick.clipimagepath.php'>Ukrainian</option>
            <option value='zh/imagick.clipimagepath.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.clipimagepath" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::clipImagePath</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::clipImagePath</span> &mdash; <span class="dc-title">Clips along the named paths from the 8BIM profile, if present</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.clipimagepath-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/clipimagepath.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.clipimagepath%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.clipimagepath&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.clipimagepath.php">＋<small>add a note</small></a></span>
