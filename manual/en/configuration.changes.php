...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/configuration.changes.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/configuration.changes.php">
 <link rel="alternate" href="https://www.php.net/manual/en/configuration.changes.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/configuration.php">
 <link rel="prev" href="https://www.php.net/manual/en/configuration.changes.modes.php">
 <link rel="next" href="https://www.php.net/manual/en/langref.php">

 <link rel="alternate" href="https://www.php.net/manual/en/configuration.changes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/configuration.changes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/configuration.changes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/configuration.changes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/configuration.changes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/configuration.changes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/configuration.changes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/configuration.changes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/configuration.changes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/configuration.changes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/configuration.changes.php" hreflang="zh">
...
<meta name="Description" content="How to change configuration settings" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: How to change configuration settings - Manual" />
<meta name="twitter:description" content="How to change configuration settings" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: How to change configuration settings - Manual" />
<meta itemprop="description" content="How to change configuration settings" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="How to change configuration settings" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="langref.php">
          Language Reference &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="configuration.changes.modes.php">
          &laquo; Where a configuration setting may be set        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/configuration.changes.php' selected="selected">English</option>
            ...
            <option value='it/configuration.changes.php'>Italian</option>
            ...
            <option value='uk/configuration.changes.php'>Ukrainian</option>
  ...
  </div><div id="configuration.changes" class="sect1">
  ...
  <div class="sect2" id="configuration.changes.apache">
   ...
   <p class="para">
    ...
    or <strong><code><a href="info.constants.php#constant.ini-system">INI_SYSTEM</a></code></strong>, have a look at the
    ...
    <dl>
      ...
      <dd>
       <p class="para">
        ...
        Can be used only with <strong><code><a href="info.constants.php#constant.ini-all">INI_ALL</a></code></strong> and <strong><code><a href="info.constants.php#constant.ini-perdir">INI_PERDIR</a></code></strong> type directives.
      ...
      <dd>
       <p class="para">
        ...
        Can be used only with <strong><code><a href="info.constants.php#constant.ini-all">INI_ALL</a></code></strong> and
        <strong><code><a href="info.constants.php#constant.ini-perdir">INI_PERDIR</a></code></strong> type directives.
       </p>
      </dd>
...
&lt;/IfModule&gt;</pre>
   ...
   <div class="caution"><strong class="caution">Caution</strong>
    <p class="para">
     ...
     such as <strong><code><a href="errorfunc.constants.php#constant.e-all">E_ALL</a></code></strong> or <strong><code><a href="errorfunc.constants.php#constant.e-notice">E_NOTICE</a></code></strong>
  ...
  <div class="sect2" id="configuration.changes.windows">
   ...
   <p class="simpara">
    ...
    <strong><code><a href="info.constants.php#constant.ini-user">INI_USER</a></code></strong> can be set
    this way, <strong><code><a href="info.constants.php#constant.ini-perdir">INI_PERDIR</a></code></strong> values can not,
   ...
   <p class="para">
    ...
    <span class="function"><a href="function.get-cfg-var.php" class="function">get_cfg_var()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fconfiguration.changes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=configuration.changes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/configuration.changes.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="80831">  <div class="votes">
    <div id="Vu80831">
    <a href="/manual/vote-note.php?id=80831&amp;page=configuration.changes&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd80831">
    <a href="/manual/vote-note.php?id=80831&amp;page=configuration.changes&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V80831" title="51% like this...">
    6
    </div>
  </div>
  <a href="#80831" class="name">
  <strong class="user"><em>contrees.du.reve at gmail dot com</em></strong></a><a class="genanchor" href="#80831"> &para;</a><div class="date" title="2008-02-02 05:25"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom80831">
<div class="phpcode"><code><span class="html">Being able to put php directives in httpd.conf and have them work on a per-directory or per-vitual host basis is just great. Now there's another aspect which might be worth being aware of:<br /><br />A php.ini directive put into your apache conf file applies to php when it runs as an apache module (i.e. in a web page), but NOT when it runs as CLI (command-line interface).<br /><br />Such feature that might be unwanted by an unhappy few, but I guess most will find it useful. As far as I'm concerned, I'm really happy that I can use open_basedir in my httpd.conf file, and it restricts the access of web users and sub-admins  of my domain, but it does NOT restrict my own command-line php scripts...</span></code></div>
  </div>
 </div>
  <div class="note" id="129875">  <div class="votes">
    <div id="Vu129875">
    <a href="/manual/vote-note.php?id=129875&amp;page=configuration.changes&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129875">
    <a href="/manual/vote-note.php?id=129875&amp;page=configuration.changes&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129875" title="25% like this...">
    -2
    </div>
  </div>
  <a href="#129875" class="name">
  <strong class="user"><em>ohcc at 163 dot com</em></strong></a><a class="genanchor" href="#129875"> &para;</a><div class="date" title="2024-11-26 10:44"><strong>10 months ago</strong></div>
  <div class="text" id="Hcom129875">
<div class="phpcode"><code><span class="html">If a directive has beeen set many times in different places, the precedence is as follows in descending order<br />php-fpm php_*[foo] = bar<br />command line argument -d foo=bar<br />environment variable foo=bar and referenced as ${foo} in php.ini<br />php.ini foo=bar</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=configuration.changes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/configuration.changes.php">＋<small>add a note</small></a></div>
