...
<head>
  ...
  <title>PHP: trader_ema - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-ema.php">
 <link rel="shorturl" href="https://www.php.net/trader-ema">
 <link rel="alternate" href="https://www.php.net/trader-ema" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-dx.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-errno.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-ema.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-ema.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-ema.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-ema.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-ema.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-ema.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-ema.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-ema.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-ema.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-ema.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-ema.php" hreflang="zh">
...
<meta name="Description" content="Exponential Moving Average" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_ema - Manual" />
<meta name="twitter:description" content="Exponential Moving Average" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_ema - Manual" />
<meta itemprop="description" content="Exponential Moving Average" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exponential Moving Average" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-errno.php">
          trader_errno &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-dx.php">
          &laquo; trader_dx        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-ema.php' selected="selected">English</option>
            <option value='de/function.trader-ema.php'>German</option>
            <option value='es/function.trader-ema.php'>Spanish</option>
            <option value='fr/function.trader-ema.php'>French</option>
            <option value='it/function.trader-ema.php'>Italian</option>
            <option value='ja/function.trader-ema.php'>Japanese</option>
            <option value='pt_BR/function.trader-ema.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-ema.php'>Russian</option>
            <option value='tr/function.trader-ema.php'>Turkish</option>
            <option value='uk/function.trader-ema.php'>Ukrainian</option>
            <option value='zh/function.trader-ema.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-ema" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-ema-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-ema.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-ema%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-ema&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-ema.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123013">  <div class="votes">
    <div id="Vu123013">
    <a href="/manual/vote-note.php?id=123013&amp;page=function.trader-ema&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123013">
    <a href="/manual/vote-note.php?id=123013&amp;page=function.trader-ema&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123013" title="70% like this...">
    7
    </div>
  </div>
  <a href="#123013" class="name">
  <strong class="user"><em>Ash Christos</em></strong></a><a class="genanchor" href="#123013"> &para;</a><div class="date" title="2018-08-08 07:28"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom123013">
<div class="phpcode"><code><span class="html">This method works fine. If you're finding that the EMA and SMA results are the same, the precision setting might still be the default or not tuned to your use case. (For example floats with more than 3 levels, sathoshi's, etc) <br /><br /># this is needed for 0.00XXXXZ levels<br />ini_set( 'trader.real_precision', '8' );</span></code></div>
  </div>
 </div>
  <div class="note" id="123902">  <div class="votes">
    <div id="Vu123902">
    <a href="/manual/vote-note.php?id=123902&amp;page=function.trader-ema&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123902">
    <a href="/manual/vote-note.php?id=123902&amp;page=function.trader-ema&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123902" title="65% like this...">
    6
    </div>
  </div>
  <a href="#123902" class="name">
  <strong class="user"><em>andy at siliconrockstar dot com</em></strong></a><a class="genanchor" href="#123902"> &para;</a><div class="date" title="2019-06-01 08:00"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123902">
<div class="phpcode"><code><span class="html">The trader_ema() function works correctly if you understand what the second argument is. The second argument is used to group the values into overlapping periods. Within the periods, the numbers undergo a simple average calculation.<br /><br />So if you call trader_ema($array, 6), and your array only has six values, you're going to get back a simple average, because there is no previous data to weight the value.<br /><br />If you call trader_ema($array, 3), then your six array values will be grouped into four overlapping groups of three, and you'll get back four values, each representing the EMA for that period.<br /><br />Below is the output of trader_ema(array(1,2,2,1,3,4), 3) and trader_sma(array(1,2,2,1,3,4), 3). You can see the first value is the same for both the EMA and SMA calculations.<br /><br />trader_ema(array(1,2,2,1,3,4), 3)<br /><br />array(4) {<br />  [2]=&gt;<br />  float(1.6666666667)<br />  [3]=&gt;<br />  float(1.3333333333)<br />  [4]=&gt;<br />  float(2.1666666667)<br />  [5]=&gt;<br />  float(3.0833333333)<br />}<br /><br />trader_sma(array(1,2,2,1,3,4), 3)<br /><br />array(4) {<br />  [2]=&gt;<br />  float(1.6666666667)<br />  [3]=&gt;<br />  float(1.6666666667)<br />  [4]=&gt;<br />  float(2)<br />  [5]=&gt;<br />  float(2.6666666667)<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="122995">  <div class="votes">
    <div id="Vu122995">
    <a href="/manual/vote-note.php?id=122995&amp;page=function.trader-ema&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122995">
    <a href="/manual/vote-note.php?id=122995&amp;page=function.trader-ema&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122995" title="61% like this...">
    4
    </div>
  </div>
  <a href="#122995" class="name">
  <strong class="user"><em>kazemi dot milad at gmail dot com</em></strong></a><a class="genanchor" href="#122995"> &para;</a><div class="date" title="2018-08-01 11:22"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122995">
<div class="phpcode"><code><span class="html">trader_ema in wrong calculate value <br />this return just simple moving avrage <br />for get ema correct use this code<br />$number is data array and $n is number of period<br />example:<br />$number[0]    =&gt; last value<br />$number[n]    =&gt;first value<br /><br />function exponentialMovingAverage(array $numbers, int $n): array<br />{<br />    $numbers=array_reverse($numbers);<br />    $m   = count($numbers);<br />    $α   = 2 / ($n + 1);<br />    $EMA = [];<br /><br />    // Start off by seeding with the first data point<br />    $EMA[] = $numbers[0];<br /><br />    // Each day after: EMAtoday = α⋅xtoday + (1-α)EMAyesterday<br />    for ($i = 1; $i &lt; $m; $i++) {<br />        $EMA[] = ($α * $numbers[$i]) + ((1 - $α) * $EMA[$i - 1]);<br />    }<br />    $EMA=array_reverse($EMA);<br />    return $EMA;<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-ema&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-ema.php">＋<small>add a note</small></a></div>
