...
<head>
  ...
  <title>PHP: SolrQuery::setStart - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setstart.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setstart.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setstart.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setshowdebuginfo.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setstats.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setstart.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setstart.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setstart.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setstart.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setstart.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setstart.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setstart.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setstart.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setstart.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setstart.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setstart.php" hreflang="zh">
...
<meta name="Description" content="Specifies the number of rows to skip" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setStart - Manual" />
<meta name="twitter:description" content="Specifies the number of rows to skip" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setStart - Manual" />
<meta itemprop="description" content="Specifies the number of rows to skip" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the number of rows to skip" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setstats.php">
          SolrQuery::setStats &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setshowdebuginfo.php">
          &laquo; SolrQuery::setShowDebugInfo        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setstart.php' selected="selected">English</option>
            <option value='de/solrquery.setstart.php'>German</option>
            <option value='es/solrquery.setstart.php'>Spanish</option>
            <option value='fr/solrquery.setstart.php'>French</option>
            <option value='it/solrquery.setstart.php'>Italian</option>
            <option value='ja/solrquery.setstart.php'>Japanese</option>
            <option value='pt_BR/solrquery.setstart.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setstart.php'>Russian</option>
            <option value='tr/solrquery.setstart.php'>Turkish</option>
            <option value='uk/solrquery.setstart.php'>Ukrainian</option>
            <option value='zh/solrquery.setstart.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setstart" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setStart</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setStart</span> &mdash; <span class="dc-title">Specifies the number of rows to skip</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setstart-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setStart</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$start</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setstart-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setstart-returnvalues">
  ...
  Returns the current SolrQuery object.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setstart.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setstart%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setstart&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setstart.php">＋<small>add a note</small></a></span>
