...
<head>
  ...
  <title>PHP: pg_field_name - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-field-name.php">
 <link rel="shorturl" href="https://www.php.net/pg-field-name">
 <link rel="alternate" href="https://www.php.net/pg-field-name" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-field-is-null.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-field-num.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-field-name.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-field-name.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-field-name.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-field-name.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-field-name.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-field-name.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-field-name.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-field-name.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-field-name.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-field-name.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-field-name.php" hreflang="zh">
...
<meta name="Description" content="Returns the name of a field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_field_name - Manual" />
<meta name="twitter:description" content="Returns the name of a field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_field_name - Manual" />
<meta itemprop="description" content="Returns the name of a field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the name of a field" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-field-name.php' selected="selected">English</option>
            <option value='de/function.pg-field-name.php'>German</option>
            <option value='es/function.pg-field-name.php'>Spanish</option>
            <option value='fr/function.pg-field-name.php'>French</option>
            <option value='it/function.pg-field-name.php'>Italian</option>
            <option value='ja/function.pg-field-name.php'>Japanese</option>
            <option value='pt_BR/function.pg-field-name.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-field-name.php'>Russian</option>
            <option value='tr/function.pg-field-name.php'>Turkish</option>
            <option value='uk/function.pg-field-name.php'>Ukrainian</option>
            <option value='zh/function.pg-field-name.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-field-name" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_field_name</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_field_name</span> &mdash; <span class="dc-title">Returns the name of a field</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-field-name-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_field_name</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-result.php" class="type PgSql\Result">PgSql\Result</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_field_name()</strong></span> returns the name of the field
   occupying the given <code class="parameter">field</code> in the
   given <code class="parameter">result</code> instance.  Field
   numbering starts from 0.
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    This function used to be called <span class="function"><strong>pg_fieldname()</strong></span>.
   </p>
  </p></blockquote>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.pg-field-name-parameters">
...
<span class="function"><a href="function.pg-query-params.php" class="function">pg_query_params()</a></span> or <span class="function"><a href="function.pg-execute.php" class="function">pg_execute()</a></span>(among others).</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-field-name-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.pg-field-name-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-field-name-examples">
...
field type: varchar</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-field-name-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-field-num.php" class="function" rel="rdfs-seeAlso">pg_field_num()</a> - Returns the field number of the named field</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-field-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-field-name%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-field-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-field-name.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="44666">  <div class="votes">
    <div id="Vu44666">
    <a href="/manual/vote-note.php?id=44666&amp;page=function.pg-field-name&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd44666">
    <a href="/manual/vote-note.php?id=44666&amp;page=function.pg-field-name&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V44666" title="100% like this...">
    2
    </div>
  </div>
  <a href="#44666" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#44666"> &para;</a><div class="date" title="2004-08-12 10:01"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom44666">
<div class="phpcode"><code><span class="html">In fact you can extract the size of the varchar field, by simply sending the following query:<br />"select a.atttypmod,a.attrelid from pg_attribute as a, pg_class as c where c.relname='$table' AND a.attrelid=c.oid AND a.attname='$field'"<br /><br />here is a simple function that does that:<br /><br />function get_field_size($table, $field, $link) {<br />                <br />        $result = pg_query($link, "select a.atttypmod,a.attrelid from pg_attribute as a, pg_class as c where c.relname='$table' AND a.attrelid=c.oid AND a.attname='$field'");                 <br />        <br />        $data = pg_fetch_object($result);<br />        <br />        return ($data-&gt;atttypmod - 4);        <br />    <br />}<br /><br />returned value is a size of a given field (also varchar)</span></code></div>
  </div>
 </div>
  <div class="note" id="10616">  <div class="votes">
    <div id="Vu10616">
    <a href="/manual/vote-note.php?id=10616&amp;page=function.pg-field-name&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd10616">
    <a href="/manual/vote-note.php?id=10616&amp;page=function.pg-field-name&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V10616" title="50% like this...">
    0
    </div>
  </div>
  <a href="#10616" class="name">
  <strong class="user"><em>ccasal at compuserve dot com</em></strong></a><a class="genanchor" href="#10616"> &para;</a><div class="date" title="2001-01-12 11:51"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom10616">
<div class="phpcode"><code><span class="html">The pg_fieldname function only returns the unqualified name from the select statement. example:
<br />
<br />select c.name, con.name from customer c, contacts con where con.customer_id = c.id;
<br />
<br />pg_fieldname will return "name" for both fields instead of c.name and con.name.
<br />
<br />This is a PostgreSQL limitation, not a PHP limitation.
<br />
<br />if you need different field names you should use :
<br />
<br />select c.name as customer_name, con.name as contact_name from customer c, contacts con where con.customer_id = c.id;
<br />
<br />then pg_fieldname will return "customer_name" and "contact_name"</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-field-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-field-name.php">＋<small>add a note</small></a></div>
