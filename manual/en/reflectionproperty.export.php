...
<head>
  ...
  <title>PHP: ReflectionProperty::export - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.export.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.export.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.export.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.getattributes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.export.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.export.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.export.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.export.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.export.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.export.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.export.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.export.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.export.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.export.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.export.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ReflectionProperty::export - Manual" />
<meta name="twitter:description" content="Export" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::export - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionproperty.getattributes.php">
          ReflectionProperty::getAttributes &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.construct.php">
          &laquo; ReflectionProperty::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.export.php' selected="selected">English</option>
            <option value='de/reflectionproperty.export.php'>German</option>
            <option value='es/reflectionproperty.export.php'>Spanish</option>
            <option value='fr/reflectionproperty.export.php'>French</option>
            <option value='it/reflectionproperty.export.php'>Italian</option>
            <option value='ja/reflectionproperty.export.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.export.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.export.php'>Russian</option>
            <option value='tr/reflectionproperty.export.php'>Turkish</option>
            <option value='uk/reflectionproperty.export.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.export.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.export" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionProperty::export</h1>
  <p class="verinfo">(PHP 5, PHP 7)</p><p class="refpurpose"><span class="refname">ReflectionProperty::export</span> &mdash; <span class="dc-title">Export</span></p>
...
as opposed to emitting it. Setting to <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> (the default) will do the opposite.              
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionproperty.export-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionproperty.tostring.php" class="methodname" rel="rdfs-seeAlso">ReflectionProperty::__toString()</a> - To string</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.export.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125320">  <div class="votes">
    <div id="Vu125320">
    <a href="/manual/vote-note.php?id=125320&amp;page=reflectionproperty.export&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125320">
    <a href="/manual/vote-note.php?id=125320&amp;page=reflectionproperty.export&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125320" title="no votes...">
    0
    </div>
  </div>
  <a href="#125320" class="name">
  <strong class="user"><em>antonfedonyuk at gmail dot com</em></strong></a><a class="genanchor" href="#125320"> &para;</a><div class="date" title="2020-09-03 03:16"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125320">
<div class="phpcode"><code><span class="html">Note: export() method is deprecated in PHP 7.4, use __toString() instead - this method return same result.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionproperty.export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.export.php">＋<small>add a note</small></a></div>
