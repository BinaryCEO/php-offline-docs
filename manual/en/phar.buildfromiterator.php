...
<head>
  ...
  <title>PHP: Phar::buildFromIterator - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.buildfromiterator.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.buildfromiterator.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.buildfromiterator.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.buildfromdirectory.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.cancompress.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.buildfromiterator.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.buildfromiterator.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.buildfromiterator.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.buildfromiterator.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.buildfromiterator.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.buildfromiterator.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.buildfromiterator.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.buildfromiterator.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.buildfromiterator.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.buildfromiterator.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.buildfromiterator.php" hreflang="zh">
...
<meta name="Description" content="Construct a phar archive from an iterator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::buildFromIterator - Manual" />
<meta name="twitter:description" content="Construct a phar archive from an iterator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::buildFromIterator - Manual" />
<meta itemprop="description" content="Construct a phar archive from an iterator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Construct a phar archive from an iterator" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.cancompress.php">
          Phar::canCompress &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.buildfromdirectory.php">
          &laquo; Phar::buildFromDirectory        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.buildfromiterator.php' selected="selected">English</option>
            <option value='de/phar.buildfromiterator.php'>German</option>
            <option value='es/phar.buildfromiterator.php'>Spanish</option>
            <option value='fr/phar.buildfromiterator.php'>French</option>
            <option value='it/phar.buildfromiterator.php'>Italian</option>
            <option value='ja/phar.buildfromiterator.php'>Japanese</option>
            <option value='pt_BR/phar.buildfromiterator.php'>Brazilian Portuguese</option>
            <option value='ru/phar.buildfromiterator.php'>Russian</option>
            <option value='tr/phar.buildfromiterator.php'>Turkish</option>
            <option value='uk/phar.buildfromiterator.php'>Ukrainian</option>
            <option value='zh/phar.buildfromiterator.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.buildfromiterator" class="refentry">
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
 ...
 <div class="refsect1 examples" id="refsect1-phar.buildfromiterator-examples">
  <h3 class="title">Examples</h3>
   <div class="example" id="example-802">
  ...
  <div class="example" id="example-803">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="phar.buildfromdirectory.php" class="function" rel="rdfs-seeAlso">Phar::buildFromDirectory()</a> - Construct a phar archive from the files within a directory</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/buildFromIterator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.buildfromiterator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.buildfromiterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.buildfromiterator.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116778">  <div class="votes">
    <div id="Vu116778">
    <a href="/manual/vote-note.php?id=116778&amp;page=phar.buildfromiterator&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116778">
    <a href="/manual/vote-note.php?id=116778&amp;page=phar.buildfromiterator&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116778" title="93% like this...">
    14
    </div>
  </div>
  <a href="#116778" class="name">
  <strong class="user"><em>cweiske at php dot net</em></strong></a><a class="genanchor" href="#116778"> &para;</a><div class="date" title="2015-02-26 01:43"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116778">
<div class="phpcode"><code><span class="html">You have to set a flag on the RecursiveDirectoryIterator because by default, the current (".") and parent directory ("..") are included in the listing. This leads to an error message similar to "returned a path ".." that is not in the base directory".<br /><br />To fix this, use "SKIP_DOTS":<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">new </span><span class="default">RecursiveDirectoryIterator</span><span class="keyword">(<br />    </span><span class="default">$srcRoot</span><span class="keyword">, </span><span class="default">FilesystemIterator</span><span class="keyword">::</span><span class="default">SKIP_DOTS<br /></span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="121019">  <div class="votes">
    <div id="Vu121019">
    <a href="/manual/vote-note.php?id=121019&amp;page=phar.buildfromiterator&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121019">
    <a href="/manual/vote-note.php?id=121019&amp;page=phar.buildfromiterator&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121019" title="50% like this...">
    0
    </div>
  </div>
  <a href="#121019" class="name">
  <strong class="user"><em>M8</em></strong></a><a class="genanchor" href="#121019"> &para;</a><div class="date" title="2017-04-25 09:38"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121019">
<div class="phpcode"><code><span class="html">Phars created from iterator (unlike from directory) does not have full-fledged directory structure. For example, functions like opendir() will fail, although fopen() does not.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phar.buildfromiterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.buildfromiterator.php">＋<small>add a note</small></a></div>
