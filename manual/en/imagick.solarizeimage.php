...
<head>
  ...
  <title>PHP: Imagick::solarizeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.solarizeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.solarizeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.solarizeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.smushimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.sparsecolorimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.solarizeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.solarizeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.solarizeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.solarizeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.solarizeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.solarizeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.solarizeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.solarizeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.solarizeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.solarizeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.solarizeimage.php" hreflang="zh">
...
<meta name="Description" content="Applies a solarizing effect to the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::solarizeImage - Manual" />
<meta name="twitter:description" content="Applies a solarizing effect to the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::solarizeImage - Manual" />
<meta itemprop="description" content="Applies a solarizing effect to the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Applies a solarizing effect to the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.sparsecolorimage.php">
          Imagick::sparseColorImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.smushimages.php">
          &laquo; Imagick::smushImages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.solarizeimage.php' selected="selected">English</option>
            <option value='de/imagick.solarizeimage.php'>German</option>
            <option value='es/imagick.solarizeimage.php'>Spanish</option>
            <option value='fr/imagick.solarizeimage.php'>French</option>
            <option value='it/imagick.solarizeimage.php'>Italian</option>
            <option value='ja/imagick.solarizeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.solarizeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.solarizeimage.php'>Russian</option>
            <option value='tr/imagick.solarizeimage.php'>Turkish</option>
            <option value='uk/imagick.solarizeimage.php'>Ukrainian</option>
            <option value='zh/imagick.solarizeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.solarizeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::solarizeImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::solarizeImage</span> &mdash; <span class="dc-title">Applies a solarizing effect to the image</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.solarizeimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::solarizeImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$threshold</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
    <div class="example" id="example-3118">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/solarizeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.solarizeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.solarizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.solarizeimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108512">  <div class="votes">
    <div id="Vu108512">
    <a href="/manual/vote-note.php?id=108512&amp;page=imagick.solarizeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108512">
    <a href="/manual/vote-note.php?id=108512&amp;page=imagick.solarizeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108512" title="no votes...">
    0
    </div>
  </div>
  <a href="#108512" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108512"> &para;</a><div class="date" title="2012-05-02 10:10"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108512">
<div class="phpcode"><code><span class="html">This is something neat that you can do to an image as part of making it artistic, probably in conjunction with other ImageMagick effects, like PosterizeImage and OilPaintImage.  SolarizeImage shifts the whole color spectrum toward red for an image -- white gets pushed directly into red, blues get pushed into greens, etc..  It is mostly a psychedelic effect.  You have the option of choosing one parameter for "Threshold", which is really simply how much of this effect you want to have in an image.  The minimum value is 0, and using a negative number defaults it to 0.  The maximum value is the Quantum Threshold.  You can get this value by the ImageMagick function getQuantumRange.  On my install of PHP, that value is set to 65535 (2^16).  Going higher than the Quantum Range defaults to the Quantum Range.  An image with this function performed on it at Threshold 0 has the maximum effect performed, and at Threshold maximum the image has no changes made to it at all.<br /><br />And now a simple demonstration of the code :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br /><br />        // Grab Image File Data<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab_with_location </span><span class="keyword">= </span><span class="string">"graphics_engine/image_workshop_directory/test.bmp"</span><span class="keyword">;<br />    <br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />            <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab_with_location</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Perform Function<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">solarizeImage</span><span class="keyword">(</span><span class="default">30000</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Filename<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_save_with_location </span><span class="keyword">= </span><span class="string">"graphics_engine/image_workshop_directory/test_new.bmp"</span><span class="keyword">;<br />    <br />        </span><span class="comment">// Save File<br />        // ---------------------------------------------<br />            <br />    </span><span class="default">$file_handle_for_saving_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_save_with_location</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">writeImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_saving_image_file</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.solarizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.solarizeimage.php">＋<small>add a note</small></a></div>
