...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.printf.php">
 <link rel="shorturl" href="https://www.php.net/printf">
 <link rel="alternate" href="https://www.php.net/printf" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.strings.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.print.php">
 <link rel="next" href="https://www.php.net/manual/en/function.quoted-printable-decode.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.printf.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.printf.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.printf.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.printf.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.printf.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.printf.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.printf.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.printf.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.printf.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.printf.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.printf.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: printf - Manual" />
<meta name="twitter:description" content="Output a formatted string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: printf - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.printf.php' selected="selected">English</option>
            <option value='de/function.printf.php'>German</option>
            <option value='es/function.printf.php'>Spanish</option>
            <option value='fr/function.printf.php'>French</option>
            <option value='it/function.printf.php'>Italian</option>
            <option value='ja/function.printf.php'>Japanese</option>
            <option value='pt_BR/function.printf.php'>Brazilian Portuguese</option>
            <option value='ru/function.printf.php'>Russian</option>
            <option value='tr/function.printf.php'>Turkish</option>
            <option value='uk/function.printf.php'>Ukrainian</option>
            <option value='zh/function.printf.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.printf" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">printf</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">printf</span> &mdash; <span class="dc-title">Output a formatted string</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.printf-description">
  ...
  <p class="simpara">
   Produces output according to <code class="parameter">format</code>.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.flush.php" class="function" rel="rdfs-seeAlso">flush()</a> - Flush system output buffer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/printf.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.printf%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.printf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.printf.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="2589">  <div class="votes">
    <div id="Vu2589">
    <a href="/manual/vote-note.php?id=2589&amp;page=function.printf&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd2589">
    <a href="/manual/vote-note.php?id=2589&amp;page=function.printf&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V2589" title="55% like this...">
    19
    </div>
  </div>
  <a href="#2589" class="name">
  <strong class="user"><em>dhosek at excite dot com</em></strong></a><a class="genanchor" href="#2589"> &para;</a><div class="date" title="1999-12-05 02:27"><strong>25 years ago</strong></div>
  <div class="text" id="Hcom2589">
<div class="phpcode"><code><span class="html">Be careful:
<br />printf ("(9.95 * 100) = %d \n", (9.95 * 100));
<br />
<br />'994'
<br />
<br />First %d converts a float to an int by truncation.
<br />
<br />Second floats are notorious for tiny little rounding errors.</span></code></div>
  </div>
 </div>
  <div class="note" id="51763">  <div class="votes">
    <div id="Vu51763">
    <a href="/manual/vote-note.php?id=51763&amp;page=function.printf&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd51763">
    <a href="/manual/vote-note.php?id=51763&amp;page=function.printf&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V51763" title="52% like this...">
    9
    </div>
  </div>
  <a href="#51763" class="name">
  <strong class="user"><em>php at mole dot gnubb dot net</em></strong></a><a class="genanchor" href="#51763"> &para;</a><div class="date" title="2005-04-10 06:15"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom51763">
<div class="phpcode"><code><span class="html">[Editor's Note: Or just use vprintf...]
<br />
<br />If you want to do something like <span class="default">&lt;?php printf</span><span class="keyword">(</span><span class="string">'There is a difference between %s and %s'</span><span class="keyword">, array(</span><span class="string">'good'</span><span class="keyword">, </span><span class="string">'evil'</span><span class="keyword">)); </span><span class="default">?&gt;</span> (this doesn't work)  instead of <span class="default">&lt;?php printf</span><span class="keyword">(</span><span class="string">'There is a difference between %s and %s'</span><span class="keyword">, </span><span class="string">'good'</span><span class="keyword">, </span><span class="string">'evil'</span><span class="keyword">); </span><span class="default">?&gt;</span> you can use this function:
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">function </span><span class="default">printf_array</span><span class="keyword">(</span><span class="default">$format</span><span class="keyword">, </span><span class="default">$arr</span><span class="keyword">)
<br />{
<br />    return </span><span class="default">call_user_func_array</span><span class="keyword">(</span><span class="string">'printf'</span><span class="keyword">, </span><span class="default">array_merge</span><span class="keyword">((array)</span><span class="default">$format</span><span class="keyword">, </span><span class="default">$arr</span><span class="keyword">));
<br />}
<br /></span><span class="default">?&gt;
<br /></span>
<br />Use it the following way:
<br /><span class="default">&lt;?php
<br />$goodevil </span><span class="keyword">= array(</span><span class="string">'good'</span><span class="keyword">, </span><span class="string">'evil'</span><span class="keyword">);
<br /></span><span class="default">printf_array</span><span class="keyword">(</span><span class="string">'There is a difference between %s and %s'</span><span class="keyword">, </span><span class="default">$goodevil</span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>and it will print:
<br />There is a difference between good and evil</span></code></div>
  </div>
 </div>
  <div class="note" id="16004">  <div class="votes">
    <div id="Vu16004">
    <a href="/manual/vote-note.php?id=16004&amp;page=function.printf&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd16004">
    <a href="/manual/vote-note.php?id=16004&amp;page=function.printf&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V16004" title="50% like this...">
    2
    </div>
  </div>
  <a href="#16004" class="name">
  <strong class="user"><em>deekayen at hotmail dot com</em></strong></a><a class="genanchor" href="#16004"> &para;</a><div class="date" title="2001-10-11 05:54"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom16004">
<div class="phpcode"><code><span class="html">You can use this function to format the decimal places in a number:
<br />
<br />$num = 2.12;
<br />printf("%.1f",$num);
<br />
...
<br />2.1
<br />
<br />see also: number_format()</span></code></div>
  </div>
 </div>
  <div class="note" id="129719">  <div class="votes">
    <div id="Vu129719">
    <a href="/manual/vote-note.php?id=129719&amp;page=function.printf&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129719">
    <a href="/manual/vote-note.php?id=129719&amp;page=function.printf&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129719" title="40% like this...">
    -1
    </div>
  </div>
  <a href="#129719" class="name">
  <strong class="user"><em>simon dot patrick at cantab dot net</em></strong></a><a class="genanchor" href="#129719"> &para;</a><div class="date" title="2024-08-24 11:24"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129719">
<div class="phpcode"><code><span class="html">A few things to note about printf:<br />1. The definition of specifier g (or G) is often wrongly stated as being "use e or f (or E or f), whichever results in the shorter string". The correct rule is given in the documentation and it does not always give this result. <br />2. For g/G/h/H, trailing zeros after the decimal point are removed (but not a zero just after the decimal point, in the e/E style).<br />3. g/G are locale-aware whether the e/E or f style is produced.<br />4. For b/o/x/X/u (that is, all integer styles except d) the result shown for negative values is the twos complement form of the number, 2**32 + v, where v is the (negative) value.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.printf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.printf.php">＋<small>add a note</small></a></div>
