...
<head>
  ...
  <title>PHP: SolrQuery::getMltMinWordLength - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getmltminwordlength.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getmltminwordlength.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltminwordlength.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getmltmintermfrequency.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getmltqueryfields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltminwordlength.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getmltminwordlength.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getmltminwordlength.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getmltminwordlength.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getmltminwordlength.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getmltminwordlength.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getmltminwordlength.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getmltminwordlength.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getmltminwordlength.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getmltminwordlength.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getmltminwordlength.php" hreflang="zh">
...
<meta name="Description" content="Returns the minimum word length below which words will be ignored" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getMltMinWordLength - Manual" />
<meta name="twitter:description" content="Returns the minimum word length below which words will be ignored" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getMltMinWordLength - Manual" />
<meta itemprop="description" content="Returns the minimum word length below which words will be ignored" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the minimum word length below which words will be ignored" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getmltqueryfields.php">
          SolrQuery::getMltQueryFields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getmltmintermfrequency.php">
          &laquo; SolrQuery::getMltMinTermFrequency        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getmltminwordlength.php' selected="selected">English</option>
            <option value='de/solrquery.getmltminwordlength.php'>German</option>
            <option value='es/solrquery.getmltminwordlength.php'>Spanish</option>
            <option value='fr/solrquery.getmltminwordlength.php'>French</option>
            <option value='it/solrquery.getmltminwordlength.php'>Italian</option>
            <option value='ja/solrquery.getmltminwordlength.php'>Japanese</option>
            <option value='pt_BR/solrquery.getmltminwordlength.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getmltminwordlength.php'>Russian</option>
            <option value='tr/solrquery.getmltminwordlength.php'>Turkish</option>
            <option value='uk/solrquery.getmltminwordlength.php'>Ukrainian</option>
            <option value='zh/solrquery.getmltminwordlength.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getmltminwordlength" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getMltMinWordLength</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getMltMinWordLength</span> &mdash; <span class="dc-title">Returns the minimum word length below which words will be ignored</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getmltminwordlength-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getMltMinWordLength</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getmltminwordlength-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getmltminwordlength-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getmltminwordlength.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getmltminwordlength%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getmltminwordlength&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getmltminwordlength.php">＋<small>add a note</small></a></span>
