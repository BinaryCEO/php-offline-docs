...
<head>
  ...
  <title>PHP: SolrQuery::setFacetLimit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setfacetlimit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setfacetlimit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetlimit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setfacetenumcachemindefaultfrequency.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setfacetmethod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetlimit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setfacetlimit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setfacetlimit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setfacetlimit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setfacetlimit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setfacetlimit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setfacetlimit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setfacetlimit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setfacetlimit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setfacetlimit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setfacetlimit.php" hreflang="zh">
...
<meta name="Description" content="Maps to facet.limit" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setFacetLimit - Manual" />
<meta name="twitter:description" content="Maps to facet.limit" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setFacetLimit - Manual" />
<meta itemprop="description" content="Maps to facet.limit" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Maps to facet.limit" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setfacetmethod.php">
          SolrQuery::setFacetMethod &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setfacetenumcachemindefaultfrequency.php">
          &laquo; SolrQuery::setFacetEnumCacheMinDefaultFrequency        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setfacetlimit.php' selected="selected">English</option>
            <option value='de/solrquery.setfacetlimit.php'>German</option>
            <option value='es/solrquery.setfacetlimit.php'>Spanish</option>
            <option value='fr/solrquery.setfacetlimit.php'>French</option>
            <option value='it/solrquery.setfacetlimit.php'>Italian</option>
            <option value='ja/solrquery.setfacetlimit.php'>Japanese</option>
            <option value='pt_BR/solrquery.setfacetlimit.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setfacetlimit.php'>Russian</option>
            <option value='tr/solrquery.setfacetlimit.php'>Turkish</option>
            <option value='uk/solrquery.setfacetlimit.php'>Ukrainian</option>
            <option value='zh/solrquery.setfacetlimit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setfacetlimit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setFacetLimit</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setFacetLimit</span> &mdash; <span class="dc-title">Maps to facet.limit</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setfacetlimit-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setFacetLimit</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$limit</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setfacetlimit-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setfacetlimit-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setfacetlimit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setfacetlimit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setfacetlimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setfacetlimit.php">＋<small>add a note</small></a></span>
