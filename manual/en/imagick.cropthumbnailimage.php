...
<head>
  ...
  <title>PHP: Imagick::cropThumbnailImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.cropthumbnailimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.cropthumbnailimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.cropthumbnailimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.cropimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.current.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.cropthumbnailimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.cropthumbnailimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.cropthumbnailimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.cropthumbnailimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.cropthumbnailimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.cropthumbnailimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.cropthumbnailimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.cropthumbnailimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.cropthumbnailimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.cropthumbnailimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.cropthumbnailimage.php" hreflang="zh">
...
<meta name="Description" content="Creates a crop thumbnail" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::cropThumbnailImage - Manual" />
<meta name="twitter:description" content="Creates a crop thumbnail" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::cropThumbnailImage - Manual" />
<meta itemprop="description" content="Creates a crop thumbnail" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a crop thumbnail" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.current.php">
          Imagick::current &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.cropimage.php">
          &laquo; Imagick::cropImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.cropthumbnailimage.php' selected="selected">English</option>
            <option value='de/imagick.cropthumbnailimage.php'>German</option>
            <option value='es/imagick.cropthumbnailimage.php'>Spanish</option>
            <option value='fr/imagick.cropthumbnailimage.php'>French</option>
            <option value='it/imagick.cropthumbnailimage.php'>Italian</option>
            <option value='ja/imagick.cropthumbnailimage.php'>Japanese</option>
            <option value='pt_BR/imagick.cropthumbnailimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.cropthumbnailimage.php'>Russian</option>
            <option value='tr/imagick.cropthumbnailimage.php'>Turkish</option>
            <option value='uk/imagick.cropthumbnailimage.php'>Ukrainian</option>
            <option value='zh/imagick.cropthumbnailimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.cropthumbnailimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::cropThumbnailImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::cropThumbnailImage</span> &mdash; <span class="dc-title">Creates a crop thumbnail</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.cropthumbnailimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::cropThumbnailImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$legacy</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.cropthumbnailimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.cropthumbnailimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.cropthumbnailimage-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/cropthumbnailimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.cropthumbnailimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.cropthumbnailimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.cropthumbnailimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="98236">  <div class="votes">
    <div id="Vu98236">
    <a href="/manual/vote-note.php?id=98236&amp;page=imagick.cropthumbnailimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98236">
    <a href="/manual/vote-note.php?id=98236&amp;page=imagick.cropthumbnailimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98236" title="68% like this...">
    6
    </div>
  </div>
  <a href="#98236" class="name">
  <strong class="user"><em>martijn at elicit dot nl</em></strong></a><a class="genanchor" href="#98236"> &para;</a><div class="date" title="2010-06-03 05:57"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98236">
<div class="phpcode"><code><span class="html">In my opinion this function is not working as expected, tested for imagemagick version 6.3.7 <br /><br />As described above, the function returns an image with a fixed height and a variable width. Here's a fix that will return a cropped thumbnail with the defined dimensions, without variations in the dimensions.<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// define widescreen dimensions<br /></span><span class="default">$width </span><span class="keyword">= </span><span class="default">160</span><span class="keyword">;<br /></span><span class="default">$height </span><span class="keyword">= </span><span class="default">90</span><span class="keyword">;<br /><br /></span><span class="comment">// load an image<br /></span><span class="default">$i </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">"your image file"</span><span class="keyword">);<br /></span><span class="comment">// get the current image dimensions<br /></span><span class="default">$geo </span><span class="keyword">= </span><span class="default">$i</span><span class="keyword">-&gt;</span><span class="default">getImageGeometry</span><span class="keyword">();<br /><br /></span><span class="comment">// crop the image<br /></span><span class="keyword">if((</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'width'</span><span class="keyword">]/</span><span class="default">$width</span><span class="keyword">) &lt; (</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'height'</span><span class="keyword">]/</span><span class="default">$height</span><span class="keyword">))<br />{<br />    </span><span class="default">$i</span><span class="keyword">-&gt;</span><span class="default">cropImage</span><span class="keyword">(</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'width'</span><span class="keyword">], </span><span class="default">floor</span><span class="keyword">(</span><span class="default">$height</span><span class="keyword">*</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'width'</span><span class="keyword">]/</span><span class="default">$width</span><span class="keyword">), </span><span class="default">0</span><span class="keyword">, ((</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'height'</span><span class="keyword">]-(</span><span class="default">$height</span><span class="keyword">*</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'width'</span><span class="keyword">]/</span><span class="default">$width</span><span class="keyword">))/</span><span class="default">2</span><span class="keyword">));<br />}<br />else<br />{<br />    </span><span class="default">$i</span><span class="keyword">-&gt;</span><span class="default">cropImage</span><span class="keyword">(</span><span class="default">ceil</span><span class="keyword">(</span><span class="default">$width</span><span class="keyword">*</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'height'</span><span class="keyword">]/</span><span class="default">$height</span><span class="keyword">), </span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'height'</span><span class="keyword">], ((</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'width'</span><span class="keyword">]-(</span><span class="default">$width</span><span class="keyword">*</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'height'</span><span class="keyword">]/</span><span class="default">$height</span><span class="keyword">))/</span><span class="default">2</span><span class="keyword">), </span><span class="default">0</span><span class="keyword">);<br />}<br /></span><span class="comment">// thumbnail the image<br /></span><span class="default">$i</span><span class="keyword">-&gt;</span><span class="default">ThumbnailImage</span><span class="keyword">(</span><span class="default">$width</span><span class="keyword">,</span><span class="default">$height</span><span class="keyword">,</span><span class="default">true</span><span class="keyword">);<br /><br /></span><span class="comment">// save or show or whatever the image<br /></span><span class="default">$i</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">"png"</span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: image/png"</span><span class="keyword">);<br />exit(</span><span class="default">$i</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="106710">  <div class="votes">
    <div id="Vu106710">
    <a href="/manual/vote-note.php?id=106710&amp;page=imagick.cropthumbnailimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106710">
    <a href="/manual/vote-note.php?id=106710&amp;page=imagick.cropthumbnailimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106710" title="83% like this...">
    4
    </div>
  </div>
  <a href="#106710" class="name">
  <strong class="user"><em>sonsandsons at gmail dot com</em></strong></a><a class="genanchor" href="#106710"> &para;</a><div class="date" title="2011-11-29 10:01"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106710">
<div class="phpcode"><code><span class="html">It's worth noting that using cropThumbnailImage can appear to give undesired results if you're using .gif image formats. If you are using .gif's, you'll need to compliment this function with a removal of the canvas.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">//instantiate the image magick class<br /></span><span class="default">$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$image_path</span><span class="keyword">);<br /><br /></span><span class="comment">//crop and resize the image<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">cropThumbnailImage</span><span class="keyword">(</span><span class="default">100</span><span class="keyword">,</span><span class="default">100</span><span class="keyword">);<br /><br /></span><span class="comment">//remove the canvas<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImagePage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="91478">  <div class="votes">
    <div id="Vu91478">
    <a href="/manual/vote-note.php?id=91478&amp;page=imagick.cropthumbnailimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91478">
    <a href="/manual/vote-note.php?id=91478&amp;page=imagick.cropthumbnailimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91478" title="57% like this...">
    2
    </div>
  </div>
  <a href="#91478" class="name">
  <strong class="user"><em>benford at bluhelix dot com</em></strong></a><a class="genanchor" href="#91478"> &para;</a><div class="date" title="2009-06-11 02:14"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91478">
<div class="phpcode"><code><span class="html">I found a relevant posting complete with demo code at this site:<br /><a href="http://valokuva.org/?p=8" rel="nofollow" target="_blank">http://valokuva.org/?p=8</a><br /><br />Sample code goes like this:<br /><span class="default">&lt;?php<br /></span><span class="comment">/* Read the image */<br /></span><span class="default">$im </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">( </span><span class="string">"test.png" </span><span class="keyword">);<br /></span><span class="comment">/* create the thumbnail */<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">cropThumbnailImage</span><span class="keyword">( </span><span class="default">80</span><span class="keyword">, </span><span class="default">80 </span><span class="keyword">);<br /></span><span class="comment">/* Write to a file */<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">( </span><span class="string">"th_80x80_test.png" </span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />This is a specialization of the cropImage method. At a high level, this method will create a thumbnail of a given image, with the thumbnail sized at ($width, $height). <br /><br />If the thumbnail does not match the aspect ratio of the source image, this is the method to use. The thumbnail will capture the entire image on the shorter edge of the source image (ie, vertical size on a landscape image). Then the thumbnail will be scaled down to meet your target height, while preserving the aspect ratio. Extra horizontal space that does not fit within the target $width will be cropped off evenly left and right.<br /><br />As a result, the thumbnail is usually a good representation of the source image.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.cropthumbnailimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.cropthumbnailimage.php">＋<small>add a note</small></a></div>
