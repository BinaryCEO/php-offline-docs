...
<head>
  ...
  <title>PHP: Imagick::getCopyright - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getcopyright.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getcopyright.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getcopyright.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getcompressionquality.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getfilename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getcopyright.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getcopyright.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getcopyright.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getcopyright.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getcopyright.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getcopyright.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getcopyright.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getcopyright.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getcopyright.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getcopyright.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getcopyright.php" hreflang="zh">
...
<meta name="Description" content="Returns the ImageMagick API copyright as a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getCopyright - Manual" />
<meta name="twitter:description" content="Returns the ImageMagick API copyright as a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getCopyright - Manual" />
<meta itemprop="description" content="Returns the ImageMagick API copyright as a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the ImageMagick API copyright as a string" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getfilename.php">
          Imagick::getFilename &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getcompressionquality.php">
          &laquo; Imagick::getCompressionQuality        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getcopyright.php' selected="selected">English</option>
            <option value='de/imagick.getcopyright.php'>German</option>
            <option value='es/imagick.getcopyright.php'>Spanish</option>
            <option value='fr/imagick.getcopyright.php'>French</option>
            <option value='it/imagick.getcopyright.php'>Italian</option>
            <option value='ja/imagick.getcopyright.php'>Japanese</option>
            <option value='pt_BR/imagick.getcopyright.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getcopyright.php'>Russian</option>
            <option value='tr/imagick.getcopyright.php'>Turkish</option>
            <option value='uk/imagick.getcopyright.php'>Ukrainian</option>
            <option value='zh/imagick.getcopyright.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getcopyright" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getCopyright</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getCopyright</span> &mdash; <span class="dc-title">Returns the ImageMagick API copyright as a string</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getcopyright-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::getCopyright</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getcopyright-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getcopyright-returnvalues">
  ...
  <p class="para">
   ...
   Magickwand C API.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getcopyright.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getcopyright%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getcopyright&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getcopyright.php">＋<small>add a note</small></a></span>
