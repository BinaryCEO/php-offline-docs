...
<head>
  ...
  <title>PHP: Imagick::colorizeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.colorizeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.colorizeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.colorizeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.colorfloodfillimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.colormatriximage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.colorizeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.colorizeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.colorizeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.colorizeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.colorizeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.colorizeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.colorizeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.colorizeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.colorizeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.colorizeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.colorizeimage.php" hreflang="zh">
...
<meta name="Description" content="Blends the fill color with the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::colorizeImage - Manual" />
<meta name="twitter:description" content="Blends the fill color with the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::colorizeImage - Manual" />
<meta itemprop="description" content="Blends the fill color with the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Blends the fill color with the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.colormatriximage.php">
          Imagick::colorMatrixImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.colorfloodfillimage.php">
          &laquo; Imagick::colorFloodfillImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.colorizeimage.php' selected="selected">English</option>
            <option value='de/imagick.colorizeimage.php'>German</option>
            <option value='es/imagick.colorizeimage.php'>Spanish</option>
            <option value='fr/imagick.colorizeimage.php'>French</option>
            <option value='it/imagick.colorizeimage.php'>Italian</option>
            <option value='ja/imagick.colorizeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.colorizeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.colorizeimage.php'>Russian</option>
            <option value='tr/imagick.colorizeimage.php'>Turkish</option>
            <option value='uk/imagick.colorizeimage.php'>Ukrainian</option>
            <option value='zh/imagick.colorizeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.colorizeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::colorizeImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::colorizeImage</span> &mdash; <span class="dc-title">Blends the fill color with the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.colorizeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::colorizeImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$colorize</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$opacity</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$legacy</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.colorizeimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">colorize</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.colorizeimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.colorizeimage-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-imagick.colorizeimage-changelog">
  ...
  <p class="para">
    <div class="example" id="example-2980">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/colorizeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.colorizeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.colorizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.colorizeimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">6 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114689">  <div class="votes">
    <div id="Vu114689">
    <a href="/manual/vote-note.php?id=114689&amp;page=imagick.colorizeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114689">
    <a href="/manual/vote-note.php?id=114689&amp;page=imagick.colorizeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114689" title="83% like this...">
    8
    </div>
  </div>
  <a href="#114689" class="name">
  <strong class="user"><em>Alex Lokhman [VisioN]</em></strong></a><a class="genanchor" href="#114689"> &para;</a><div class="date" title="2014-03-22 02:35"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114689">
<div class="phpcode"><code><span class="html">If you're looking for a solution to fill the image with a solid color, preserving background transparency, here is one way:<br /><br /><span class="default">&lt;?php<br />$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'image.png'</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageAlphaChannel</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">ALPHACHANNEL_EXTRACT</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageBackgroundColor</span><span class="keyword">(</span><span class="string">'color'</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageAlphaChannel</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">ALPHACHANNEL_SHAPE</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'output.png'</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">();<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="108624">  <div class="votes">
    <div id="Vu108624">
    <a href="/manual/vote-note.php?id=108624&amp;page=imagick.colorizeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108624">
    <a href="/manual/vote-note.php?id=108624&amp;page=imagick.colorizeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108624" title="78% like this...">
    8
    </div>
  </div>
  <a href="#108624" class="name">
  <strong class="user"><em>php at lfbittencourt dot com</em></strong></a><a class="genanchor" href="#108624"> &para;</a><div class="date" title="2012-05-11 01:26"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108624">
<div class="phpcode"><code><span class="html">Do you want a color overlay with TRUE opacity control? Try this:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">class </span><span class="default">YourImagick </span><span class="keyword">extends </span><span class="default">Imagick<br /></span><span class="keyword">{<br />    public function </span><span class="default">colorize</span><span class="keyword">(</span><span class="default">$color</span><span class="keyword">, </span><span class="default">$alpha </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">)<br />    {<br />        </span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();<br /><br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="default">$color</span><span class="keyword">);<br /><br />        if (</span><span class="default">is_float</span><span class="keyword">(</span><span class="default">$alpha</span><span class="keyword">)) {<br />            </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillAlpha</span><span class="keyword">(</span><span class="default">$alpha</span><span class="keyword">);<br />        }<br /><br />        </span><span class="default">$geometry </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">getImageGeometry</span><span class="keyword">();<br />        </span><span class="default">$width </span><span class="keyword">= </span><span class="default">$geometry</span><span class="keyword">[</span><span class="string">'width'</span><span class="keyword">];<br />        </span><span class="default">$height </span><span class="keyword">= </span><span class="default">$geometry</span><span class="keyword">[</span><span class="string">'height'</span><span class="keyword">];<br /><br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">rectangle</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">);<br /><br />        </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">);<br />    }<br />}<br /><br /></span><span class="default">?&gt;<br /></span><br />How to use:<br /><br /><span class="default">&lt;?php<br /><br />$imagick </span><span class="keyword">= new </span><span class="default">YourImagick</span><span class="keyword">(</span><span class="string">'example.png'</span><span class="keyword">);<br /><br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">colorize</span><span class="keyword">(</span><span class="string">'#ffcc00'</span><span class="keyword">, </span><span class="default">0.35</span><span class="keyword">);<br /><br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'Content-type: image/png'</span><span class="keyword">);<br /><br />echo </span><span class="default">$source</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="113930">  <div class="votes">
    <div id="Vu113930">
    <a href="/manual/vote-note.php?id=113930&amp;page=imagick.colorizeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113930">
    <a href="/manual/vote-note.php?id=113930&amp;page=imagick.colorizeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113930" title="100% like this...">
    3
    </div>
  </div>
  <a href="#113930" class="name">
  <strong class="user"><em>olav at redwall dot ee</em></strong></a><a class="genanchor" href="#113930"> &para;</a><div class="date" title="2013-12-18 12:24"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113930">
<div class="phpcode"><code><span class="html">To improve upon "php at lfbittencourt dot com"'s solution, this one blends the composited color, and takes opacity into account as well.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">class </span><span class="default">YourImagick </span><span class="keyword">extends </span><span class="default">Imagick<br /></span><span class="keyword">{<br />    public function </span><span class="default">colorize</span><span class="keyword">(</span><span class="default">$color</span><span class="keyword">, </span><span class="default">$alpha </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">, </span><span class="default">$composite_flag </span><span class="keyword">= </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPOSITE_COLORIZE</span><span class="keyword">)<br />    {<br />        </span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();<br /><br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="default">$color</span><span class="keyword">);<br /><br />        </span><span class="default">$geometry </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">getImageGeometry</span><span class="keyword">();<br />        </span><span class="default">$width </span><span class="keyword">= </span><span class="default">$geometry</span><span class="keyword">[</span><span class="string">'width'</span><span class="keyword">];<br />        </span><span class="default">$height </span><span class="keyword">= </span><span class="default">$geometry</span><span class="keyword">[</span><span class="string">'height'</span><span class="keyword">];<br /><br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">rectangle</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">);<br /><br />        </span><span class="default">$temporary </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />        </span><span class="default">$temporary</span><span class="keyword">-&gt;</span><span class="default">setBackgroundColor</span><span class="keyword">(new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'transparent'</span><span class="keyword">));<br />        </span><span class="default">$temporary</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'transparent'</span><span class="keyword">));<br />        </span><span class="default">$temporary</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'png32'</span><span class="keyword">);<br />        </span><span class="default">$temporary</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">);<br /><br />        </span><span class="default">$alphaChannel </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">clone</span><span class="keyword">();<br />        </span><span class="default">$alphaChannel</span><span class="keyword">-&gt;</span><span class="default">setImageAlphaChannel</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">ALPHACHANNEL_EXTRACT</span><span class="keyword">);<br />        </span><span class="default">$alphaChannel</span><span class="keyword">-&gt;</span><span class="default">negateImage</span><span class="keyword">(</span><span class="default">false</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">CHANNEL_ALL</span><span class="keyword">);<br />        </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">setImageClipMask</span><span class="keyword">(</span><span class="default">$alphaChannel</span><span class="keyword">);<br /><br />        </span><span class="default">$clone </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">clone</span><span class="keyword">();<br />        </span><span class="default">$clone</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">(</span><span class="default">$temporary</span><span class="keyword">, </span><span class="default">$composite_flag</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br />        </span><span class="default">$clone</span><span class="keyword">-&gt;</span><span class="default">setImageOpacity</span><span class="keyword">(</span><span class="default">$alpha</span><span class="keyword">);<br /><br />        </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">(</span><span class="default">$clone</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPOSITE_DEFAULT</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br />    }<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="127973">  <div class="votes">
    <div id="Vu127973">
    <a href="/manual/vote-note.php?id=127973&amp;page=imagick.colorizeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127973">
    <a href="/manual/vote-note.php?id=127973&amp;page=imagick.colorizeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127973" title="100% like this...">
    1
    </div>
  </div>
  <a href="#127973" class="name">
  <strong class="user"><em>adrien at unik dot solutions</em></strong></a><a class="genanchor" href="#127973"> &para;</a><div class="date" title="2022-12-01 01:09"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom127973">
<div class="phpcode"><code><span class="html">The solution published by "olav at redwall dot ee " was adding a black surround outside each non-transparent shape.<br /><br />Here is my improved version :<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">public function </span><span class="default">colorize</span><span class="keyword">(</span><span class="default">$color</span><span class="keyword">, </span><span class="default">$alpha </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">)<br />{<br />    </span><span class="default">$geometry </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">getImageGeometry</span><span class="keyword">();<br />    </span><span class="default">$width </span><span class="keyword">= </span><span class="default">$geometry</span><span class="keyword">[</span><span class="string">'width'</span><span class="keyword">];<br />    </span><span class="default">$height </span><span class="keyword">= </span><span class="default">$geometry</span><span class="keyword">[</span><span class="string">'height'</span><span class="keyword">];<br />        <br />    </span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">;<br />    </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="default">$color</span><span class="keyword">);<br />    </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">rectangle</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">);<br /><br />    </span><span class="default">$temporary </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">;<br />    </span><span class="default">$temporary</span><span class="keyword">-&gt;</span><span class="default">setBackgroundColor</span><span class="keyword">(new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'transparent'</span><span class="keyword">));<br />    </span><span class="default">$temporary</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'transparent'</span><span class="keyword">));<br />    </span><span class="default">$temporary</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'png32'</span><span class="keyword">);<br />    </span><span class="default">$temporary</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">);<br />    </span><span class="default">$temporary</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPOSITE_COPYOPACITY</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br />        <br />    </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">setImageArtifact</span><span class="keyword">(</span><span class="string">'compose:args'</span><span class="keyword">, (</span><span class="default">$alpha </span><span class="keyword">* </span><span class="default">100</span><span class="keyword">) . </span><span class="string">'%,100%'</span><span class="keyword">);<br />    </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">(</span><span class="default">$temporary</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPOSITE_DISSOLVE</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="107012">  <div class="votes">
    <div id="Vu107012">
    <a href="/manual/vote-note.php?id=107012&amp;page=imagick.colorizeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd107012">
    <a href="/manual/vote-note.php?id=107012&amp;page=imagick.colorizeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V107012" title="50% like this...">
    0
    </div>
  </div>
  <a href="#107012" class="name">
  <strong class="user"><em>talkol at gmail dot com</em></strong></a><a class="genanchor" href="#107012"> &para;</a><div class="date" title="2011-12-28 07:19"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom107012">
<div class="phpcode"><code><span class="html">When you're using an image with an alpha channel (for example a transparent png), a value of 1.0 will return a completely transparent image, but a value of 1 works just fine.</span></code></div>
  </div>
 </div>
  <div class="note" id="90164">  <div class="votes">
    <div id="Vu90164">
    <a href="/manual/vote-note.php?id=90164&amp;page=imagick.colorizeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd90164">
    <a href="/manual/vote-note.php?id=90164&amp;page=imagick.colorizeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V90164" title="40% like this...">
    -1
    </div>
  </div>
  <a href="#90164" class="name">
  <strong class="user"><em>lsmartinez at gmail dot com</em></strong></a><a class="genanchor" href="#90164"> &para;</a><div class="date" title="2009-04-08 09:42"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom90164">
<div class="phpcode"><code><span class="html">simplest example<br /><br /><span class="default">&lt;?php<br />$nombre </span><span class="keyword">= </span><span class="string">'001-4-0043.jpg'</span><span class="keyword">;<br /></span><span class="default">$img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$nombre</span><span class="keyword">);<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">negateImage</span><span class="keyword">(</span><span class="default">false</span><span class="keyword">);<br /></span><span class="comment">//$pixblu = new ImagickPixel('#000040');<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">colorizeImage</span><span class="keyword">(</span><span class="string">'#0000b0'</span><span class="keyword">,</span><span class="default">1.0</span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'content-type: image/jpeg'</span><span class="keyword">);<br />echo </span><span class="default">$img</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.colorizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.colorizeimage.php">＋<small>add a note</small></a></div>
