...
<head>
  ...
  <title>PHP: mysql_fetch_array - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-fetch-array.php">
 <link rel="shorturl" href="https://www.php.net/mysql-fetch-array">
 <link rel="alternate" href="https://www.php.net/mysql-fetch-array" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-escape-string.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-fetch-assoc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-fetch-array.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-fetch-array.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-fetch-array.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-fetch-array.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-fetch-array.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-fetch-array.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-fetch-array.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-fetch-array.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-fetch-array.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-fetch-array.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-fetch-array.php" hreflang="zh">
...
<meta name="Description" content="Fetch a result row as an associative array, a numeric array, or both" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_fetch_array - Manual" />
<meta name="twitter:description" content="Fetch a result row as an associative array, a numeric array, or both" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_fetch_array - Manual" />
<meta itemprop="description" content="Fetch a result row as an associative array, a numeric array, or both" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetch a result row as an associative array, a numeric array, or both" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-fetch-assoc.php">
          mysql_fetch_assoc &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-escape-string.php">
          &laquo; mysql_escape_string        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-fetch-array.php' selected="selected">English</option>
            <option value='de/function.mysql-fetch-array.php'>German</option>
            <option value='es/function.mysql-fetch-array.php'>Spanish</option>
            <option value='fr/function.mysql-fetch-array.php'>French</option>
            <option value='it/function.mysql-fetch-array.php'>Italian</option>
            <option value='ja/function.mysql-fetch-array.php'>Japanese</option>
            <option value='pt_BR/function.mysql-fetch-array.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-fetch-array.php'>Russian</option>
            <option value='tr/function.mysql-fetch-array.php'>Turkish</option>
            <option value='uk/function.mysql-fetch-array.php'>Ukrainian</option>
            <option value='zh/function.mysql-fetch-array.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-fetch-array" class="refentry">
...
<span class="function"><a href="function.mysql-query.php" class="function">mysql_query()</a></span>.</p></dd>
     ...
     <dd>
      <p class="para">
       ...
       take the following values: <strong><code><a href="mysql.constants.php#constant.mysql-assoc">MYSQL_ASSOC</a></code></strong>, 
       <strong><code><a href="mysql.constants.php#constant.mysql-num">MYSQL_NUM</a></code></strong>, and
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-fetch-array-returnvalues">
  ...
  <p class="para">
   Returns an array of strings that corresponds to the fetched row, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>
   ...
   <strong><code><a href="mysql.constants.php#constant.mysql-both">MYSQL_BOTH</a></code></strong> (default), you&#039;ll get an array with both 
   associative and number indices. Using <strong><code><a href="mysql.constants.php#constant.mysql-assoc">MYSQL_ASSOC</a></code></strong>, you 
   only get associative indices (as <span class="function"><a href="function.mysql-fetch-assoc.php" class="function">mysql_fetch_assoc()</a></span> 
   works), using <strong><code><a href="mysql.constants.php#constant.mysql-num">MYSQL_NUM</a></code></strong>, you only get number indices 
   (as <span class="function"><a href="function.mysql-fetch-row.php" class="function">mysql_fetch_row()</a></span> works).
  </p>
  <p class="para">
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-fetch-array-examples">
  ...
  <p class="para">
   <div class="example" id="example-1889">
    <p><strong>Example #1 Query with aliased duplicate field names</strong></p>
...
<div class="sqlcode"><pre class="sqlcode">SELECT table1.field AS foo, table2.field AS bar FROM table1, table2</pre>
  ...
  <p class="para">
   <div class="example" id="example-1890">
    <p><strong>Example #2 <span class="function"><strong>mysql_fetch_array()</strong></span> with <strong><code><a href="mysql.constants.php#constant.mysql-num">MYSQL_NUM</a></code></strong></strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />mysql_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #DD0000">"mysql_user"</span><span style="color: #007700">, </span><span style="color: #DD0000">"mysql_password"</span><span style="color: #007700">) or<br />    die(</span><span style="color: #DD0000">"Could not connect: " </span><span style="color: #007700">. </span><span style="color: #0000BB">mysql_error</span><span style="color: #007700">());<br /></span><span style="color: #0000BB">mysql_select_db</span><span style="color: #007700">(</span><span style="color: #DD0000">"mydb"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_query</span><span style="color: #007700">(</span><span style="color: #DD0000">"SELECT id, name FROM mytable"</span><span style="color: #007700">);<br /><br />while (</span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_fetch_array</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">, </span><span style="color: #0000BB">MYSQL_NUM</span><span style="color: #007700">)) {<br />    </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"ID: %s  Name: %s"</span><span style="color: #007700">, </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #0000BB">0</span><span style="color: #007700">], </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #0000BB">1</span><span style="color: #007700">]);  <br />}<br /><br /></span><span style="color: #0000BB">mysql_free_result</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-1891">
    <p><strong>Example #3 <span class="function"><strong>mysql_fetch_array()</strong></span> with <strong><code><a href="mysql.constants.php#constant.mysql-assoc">MYSQL_ASSOC</a></code></strong></strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />mysql_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #DD0000">"mysql_user"</span><span style="color: #007700">, </span><span style="color: #DD0000">"mysql_password"</span><span style="color: #007700">) or<br />    die(</span><span style="color: #DD0000">"Could not connect: " </span><span style="color: #007700">. </span><span style="color: #0000BB">mysql_error</span><span style="color: #007700">());<br /></span><span style="color: #0000BB">mysql_select_db</span><span style="color: #007700">(</span><span style="color: #DD0000">"mydb"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_query</span><span style="color: #007700">(</span><span style="color: #DD0000">"SELECT id, name FROM mytable"</span><span style="color: #007700">);<br /><br />while (</span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_fetch_array</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">, </span><span style="color: #0000BB">MYSQL_ASSOC</span><span style="color: #007700">)) {<br />    </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"ID: %s  Name: %s"</span><span style="color: #007700">, </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #DD0000">"id"</span><span style="color: #007700">], </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #DD0000">"name"</span><span style="color: #007700">]);<br />}<br /><br /></span><span style="color: #0000BB">mysql_free_result</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-1892">
    <p><strong>Example #4 <span class="function"><strong>mysql_fetch_array()</strong></span> with <strong><code><a href="mysql.constants.php#constant.mysql-both">MYSQL_BOTH</a></code></strong></strong></p>
    <div class="example-contents">
 ...
 <div class="refsect1 notes" id="refsect1-function.mysql-fetch-array-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   ...
   <p class="para">
    ...
    <span class="function"><strong>mysql_fetch_array()</strong></span> is <em>not 
    significantly</em> slower than using
    <span class="function"><a href="function.mysql-fetch-row.php" class="function">mysql_fetch_row()</a></span>, while it provides
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-query.php" class="function" rel="rdfs-seeAlso">mysql_query()</a> - Send a MySQL query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-fetch-array.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-fetch-array%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-fetch-array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-fetch-array.php">＋<small>add a note</small></a></span>
