...
<head>
  ...
  <title>PHP: filegroup - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.filegroup.php">
 <link rel="shorturl" href="https://www.php.net/filegroup">
 <link rel="alternate" href="https://www.php.net/filegroup" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.filectime.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fileinode.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.filegroup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.filegroup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.filegroup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.filegroup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.filegroup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.filegroup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.filegroup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.filegroup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.filegroup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.filegroup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.filegroup.php" hreflang="zh">
...
<meta name="Description" content="Gets file group" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: filegroup - Manual" />
<meta name="twitter:description" content="Gets file group" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: filegroup - Manual" />
<meta itemprop="description" content="Gets file group" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets file group" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.filegroup.php' selected="selected">English</option>
            <option value='de/function.filegroup.php'>German</option>
            <option value='es/function.filegroup.php'>Spanish</option>
            <option value='fr/function.filegroup.php'>French</option>
            <option value='it/function.filegroup.php'>Italian</option>
            <option value='ja/function.filegroup.php'>Japanese</option>
            <option value='pt_BR/function.filegroup.php'>Brazilian Portuguese</option>
            <option value='ru/function.filegroup.php'>Russian</option>
            <option value='tr/function.filegroup.php'>Turkish</option>
            <option value='uk/function.filegroup.php'>Ukrainian</option>
            <option value='zh/function.filegroup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.filegroup" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">filegroup</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">filegroup</span> &mdash; <span class="dc-title">Gets file group</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.filegroup-description">
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.posix-getgrgid.php" class="function">posix_getgrgid()</a></span> to resolve it to a group name.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.filegroup-returnvalues">
  ...
  <p class="para">
   Returns the group ID of the file, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if
   an error occurs. The group ID is returned in numerical format, use
   <span class="function"><a href="function.posix-getgrgid.php" class="function">posix_getgrgid()</a></span> to resolve it to a group name.
   Upon failure, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> is returned.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.filegroup-examples">
  ...
  <p class="para">
   <div class="example" id="example-2360">
    <p><strong>Example #1 Finding the group of a file</strong></p>
...
<span class="function"><a href="function.stat.php" class="function">stat()</a></span> family of functionality.</p></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.filegroup-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fileowner.php" class="function" rel="rdfs-seeAlso">fileowner()</a> - Gets file owner</span></li>
    <li><span class="function"><a href="function.posix-getgrgid.php" class="function" rel="rdfs-seeAlso">posix_getgrgid()</a> - Return info about a group by group id</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/filegroup.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.filegroup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.filegroup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.filegroup.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124783">  <div class="votes">
    <div id="Vu124783">
    <a href="/manual/vote-note.php?id=124783&amp;page=function.filegroup&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124783">
    <a href="/manual/vote-note.php?id=124783&amp;page=function.filegroup&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124783" title="50% like this...">
    0
    </div>
  </div>
  <a href="#124783" class="name">
  <strong class="user"><em>chris at ocproducts dot com</em></strong></a><a class="genanchor" href="#124783"> &para;</a><div class="date" title="2020-03-02 03:48"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124783">
<div class="phpcode"><code><span class="html">This function will always return 0 on Windows, because Windows does not support numeric group IDs.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.filegroup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.filegroup.php">＋<small>add a note</small></a></div>
