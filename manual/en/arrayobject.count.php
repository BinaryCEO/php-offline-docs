...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/arrayobject.count.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/arrayobject.count.php">
 <link rel="alternate" href="https://www.php.net/manual/en/arrayobject.count.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.arrayobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/arrayobject.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/arrayobject.exchangearray.php">
...
<meta name="Description" content="Get the number of public properties in the ArrayObject" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ArrayObject::count - Manual" />
<meta name="twitter:description" content="Get the number of public properties in the ArrayObject" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ArrayObject::count - Manual" />
<meta itemprop="description" content="Get the number of public properties in the ArrayObject" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the number of public properties in the ArrayObject" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/arrayobject.count.php' selected="selected">English</option>
            ...
            <option value='ru/arrayobject.count.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ArrayObject::count</span> &mdash; <span class="dc-title">Get the number of public properties in the ArrayObject</span></p>
 ...
 <div class="refsect1 description" id="refsect1-arrayobject.count-description">
  ...
  <p class="para rdfs-comment">
   Get the number of public properties in the <span class="classname"><a href="class.arrayobject.php" class="classname">ArrayObject</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-arrayobject.count-returnvalues">
  ...
  <p class="para">
   The number of public properties in the <span class="classname"><a href="class.arrayobject.php" class="classname">ArrayObject</a></span>.
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    When the <span class="classname"><a href="class.arrayobject.php" class="classname">ArrayObject</a></span> is constructed from an array all properties are public.
   </p>
  </p></blockquote>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-arrayobject.count-examples">
  ...
  <p class="para">
   <div class="example" id="example-3859">
    <p><strong>Example #1 <span class="methodname"><strong>ArrayObject::count()</strong></span> example</strong></p>
...
int(3)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/arrayobject/count.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Farrayobject.count%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=arrayobject.count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/arrayobject.count.php">＋<small>add a note</small></a></span>
