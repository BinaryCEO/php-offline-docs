...
<head>
  ...
  <title>PHP: ImagickDraw::pathFinish - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pathfinish.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pathfinish.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathfinish.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pathellipticarcrelative.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pathlinetoabsolute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathfinish.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pathfinish.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pathfinish.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pathfinish.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pathfinish.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pathfinish.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pathfinish.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pathfinish.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pathfinish.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pathfinish.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pathfinish.php" hreflang="zh">
...
<meta name="Description" content="Terminates the current path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::pathFinish - Manual" />
<meta name="twitter:description" content="Terminates the current path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pathFinish - Manual" />
<meta itemprop="description" content="Terminates the current path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Terminates the current path" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.pathlinetoabsolute.php">
          ImagickDraw::pathLineToAbsolute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pathellipticarcrelative.php">
          &laquo; ImagickDraw::pathEllipticArcRelative        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pathfinish.php' selected="selected">English</option>
            <option value='de/imagickdraw.pathfinish.php'>German</option>
            <option value='es/imagickdraw.pathfinish.php'>Spanish</option>
            <option value='fr/imagickdraw.pathfinish.php'>French</option>
            <option value='it/imagickdraw.pathfinish.php'>Italian</option>
            <option value='ja/imagickdraw.pathfinish.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pathfinish.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pathfinish.php'>Russian</option>
            <option value='tr/imagickdraw.pathfinish.php'>Turkish</option>
            <option value='uk/imagickdraw.pathfinish.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pathfinish.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pathfinish" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pathFinish</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::pathFinish</span> &mdash; <span class="dc-title">Terminates the current path</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.pathfinish-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::pathFinish</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.pathfinish-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pathfinish.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pathfinish%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pathfinish&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pathfinish.php">＋<small>add a note</small></a></span>
