...
<head>
  ...
  <title>PHP: ReflectionClass::export - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.export.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.export.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.export.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getattributes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.export.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.export.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.export.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.export.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.export.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.export.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.export.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.export.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.export.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.export.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.export.php" hreflang="zh">
...
<meta name="Description" content="Exports a class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::export - Manual" />
<meta name="twitter:description" content="Exports a class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::export - Manual" />
<meta itemprop="description" content="Exports a class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exports a class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.getattributes.php">
          ReflectionClass::getAttributes &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.construct.php">
          &laquo; ReflectionClass::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.export.php' selected="selected">English</option>
            <option value='de/reflectionclass.export.php'>German</option>
            <option value='es/reflectionclass.export.php'>Spanish</option>
            <option value='fr/reflectionclass.export.php'>French</option>
            <option value='it/reflectionclass.export.php'>Italian</option>
            <option value='ja/reflectionclass.export.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.export.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.export.php'>Russian</option>
            <option value='tr/reflectionclass.export.php'>Turkish</option>
            <option value='uk/reflectionclass.export.php'>Ukrainian</option>
            <option value='zh/reflectionclass.export.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.export" class="refentry">
...
otherwise <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> is returned.
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.export-examples">
  ...
  <p class="para">
   <div class="example" id="example-5468">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionclass.tostring.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::__toString()</a> - Returns the string representation of the ReflectionClass object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.export.php">＋<small>add a note</small></a></span>
