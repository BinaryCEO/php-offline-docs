...
<head>
  ...
  <title>PHP: Imagick::gaussianBlurImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.gaussianblurimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.gaussianblurimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.gaussianblurimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.gammaimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getcolorspace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.gaussianblurimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.gaussianblurimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.gaussianblurimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.gaussianblurimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.gaussianblurimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.gaussianblurimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.gaussianblurimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.gaussianblurimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.gaussianblurimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.gaussianblurimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.gaussianblurimage.php" hreflang="zh">
...
<meta name="Description" content="Blurs an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::gaussianBlurImage - Manual" />
<meta name="twitter:description" content="Blurs an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::gaussianBlurImage - Manual" />
<meta itemprop="description" content="Blurs an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Blurs an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getcolorspace.php">
          Imagick::getColorspace &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.gammaimage.php">
          &laquo; Imagick::gammaImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.gaussianblurimage.php' selected="selected">English</option>
            <option value='de/imagick.gaussianblurimage.php'>German</option>
            <option value='es/imagick.gaussianblurimage.php'>Spanish</option>
            <option value='fr/imagick.gaussianblurimage.php'>French</option>
            <option value='it/imagick.gaussianblurimage.php'>Italian</option>
            <option value='ja/imagick.gaussianblurimage.php'>Japanese</option>
            <option value='pt_BR/imagick.gaussianblurimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.gaussianblurimage.php'>Russian</option>
            <option value='tr/imagick.gaussianblurimage.php'>Turkish</option>
            <option value='uk/imagick.gaussianblurimage.php'>Ukrainian</option>
            <option value='zh/imagick.gaussianblurimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.gaussianblurimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::gaussianBlurImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::gaussianBlurImage</span> &mdash; <span class="dc-title">Blurs an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.gaussianblurimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::gaussianBlurImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$sigma</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.gaussianblurimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.gaussianblurimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.gaussianblurimage-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.gaussianblurimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3009">
      <p><strong>Example #1  <span class="function"><strong>Imagick::gaussianBlurImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/gaussianblurimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.gaussianblurimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.gaussianblurimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.gaussianblurimage.php">＋<small>add a note</small></a></span>
