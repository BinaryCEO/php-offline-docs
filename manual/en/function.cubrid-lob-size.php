...
<head>
  ...
  <title>PHP: cubrid_lob_size - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lob-size.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-lob-size">
 <link rel="alternate" href="https://www.php.net/cubrid-lob-size" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lob-send.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lob2-bind.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-lob-size.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-lob-size.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-lob-size.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-lob-size.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-lob-size.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-lob-size.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-lob-size.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-lob-size.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-lob-size.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-lob-size.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-lob-size.php" hreflang="zh">
...
<meta name="Description" content="Get BLOB/CLOB data size" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lob_size - Manual" />
<meta name="twitter:description" content="Get BLOB/CLOB data size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lob_size - Manual" />
<meta itemprop="description" content="Get BLOB/CLOB data size" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get BLOB/CLOB data size" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-lob2-bind.php">
          cubrid_lob2_bind &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-lob-send.php">
          &laquo; cubrid_lob_send        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lob-size.php' selected="selected">English</option>
            <option value='de/function.cubrid-lob-size.php'>German</option>
            <option value='es/function.cubrid-lob-size.php'>Spanish</option>
            <option value='fr/function.cubrid-lob-size.php'>French</option>
            <option value='it/function.cubrid-lob-size.php'>Italian</option>
            <option value='ja/function.cubrid-lob-size.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-lob-size.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-lob-size.php'>Russian</option>
            <option value='tr/function.cubrid-lob-size.php'>Turkish</option>
            <option value='uk/function.cubrid-lob-size.php'>Ukrainian</option>
            <option value='zh/function.cubrid-lob-size.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-lob-size" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-lob-size-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_lob_size</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$lob_identifier</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-lob-size-returnvalues">
  ...
  <p class="para">
    A string representing LOB data size, when process is successful, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.cubrid-lob-send.php" class="function" rel="rdfs-seeAlso">cubrid_lob_send()</a> - Read BLOB/CLOB data and send straight to browser</span></li>     
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lob-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lob-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lob-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lob-size.php">＋<small>add a note</small></a></span>
