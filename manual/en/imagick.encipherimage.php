...
<head>
  ...
  <title>PHP: Imagick::encipherImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.encipherimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.encipherimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.encipherimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.embossimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.enhanceimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.encipherimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.encipherimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.encipherimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.encipherimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.encipherimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.encipherimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.encipherimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.encipherimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.encipherimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.encipherimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.encipherimage.php" hreflang="zh">
...
<meta name="Description" content="Enciphers an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::encipherImage - Manual" />
<meta name="twitter:description" content="Enciphers an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::encipherImage - Manual" />
<meta itemprop="description" content="Enciphers an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enciphers an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.enhanceimage.php">
          Imagick::enhanceImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.embossimage.php">
          &laquo; Imagick::embossImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.encipherimage.php' selected="selected">English</option>
            <option value='de/imagick.encipherimage.php'>German</option>
            <option value='es/imagick.encipherimage.php'>Spanish</option>
            <option value='fr/imagick.encipherimage.php'>French</option>
            <option value='it/imagick.encipherimage.php'>Italian</option>
            <option value='ja/imagick.encipherimage.php'>Japanese</option>
            <option value='pt_BR/imagick.encipherimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.encipherimage.php'>Russian</option>
            <option value='tr/imagick.encipherimage.php'>Turkish</option>
            <option value='uk/imagick.encipherimage.php'>Ukrainian</option>
            <option value='zh/imagick.encipherimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.encipherimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::encipherImage</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::encipherImage</span> &mdash; <span class="dc-title">Enciphers an image</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.encipherimage-description">
  ...
  <p class="para rdfs-comment">
   ...
   until it has been deciphered using <span class="function"><a href="imagick.decipherimage.php" class="function">Imagick::decipherImage()</a></span>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.encipherimage-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.decipherimage.php" class="function" rel="rdfs-seeAlso">Imagick::decipherImage()</a> - Deciphers an image</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/encipherimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.encipherimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.encipherimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.encipherimage.php">＋<small>add a note</small></a></span>
