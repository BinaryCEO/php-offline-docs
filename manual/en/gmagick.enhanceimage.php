...
<head>
  ...
  <title>PHP: Gmagick::enhanceimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.enhanceimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.enhanceimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.enhanceimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.embossimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.equalizeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.enhanceimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.enhanceimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.enhanceimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.enhanceimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.enhanceimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.enhanceimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.enhanceimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.enhanceimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.enhanceimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.enhanceimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.enhanceimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::enhanceimage - Manual" />
<meta name="twitter:description" content="Improves the quality of a noisy image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::enhanceimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.equalizeimage.php">
          Gmagick::equalizeimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.embossimage.php">
          &laquo; Gmagick::embossimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.enhanceimage.php' selected="selected">English</option>
            <option value='de/gmagick.enhanceimage.php'>German</option>
            <option value='es/gmagick.enhanceimage.php'>Spanish</option>
            <option value='fr/gmagick.enhanceimage.php'>French</option>
            <option value='it/gmagick.enhanceimage.php'>Italian</option>
            <option value='ja/gmagick.enhanceimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.enhanceimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.enhanceimage.php'>Russian</option>
            <option value='tr/gmagick.enhanceimage.php'>Turkish</option>
            <option value='uk/gmagick.enhanceimage.php'>Ukrainian</option>
            <option value='zh/gmagick.enhanceimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.enhanceimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::enhanceimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::enhanceimage</span> &mdash; <span class="dc-title">Improves the quality of a noisy image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.enhanceimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::enhanceimage</strong></span>(): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.enhanceimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.enhanceimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The enhanced <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.enhanceimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/enhanceimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.enhanceimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.enhanceimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.enhanceimage.php">＋<small>add a note</small></a></span>
