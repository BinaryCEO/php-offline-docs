...
<head>
  ...
  <title>PHP: imap_body - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-body.php">
 <link rel="shorturl" href="https://www.php.net/imap-body">
 <link rel="alternate" href="https://www.php.net/imap-body" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-binary.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-bodystruct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-body.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-body.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-body.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-body.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-body.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-body.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-body.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-body.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-body.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-body.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-body.php" hreflang="zh">
...
<meta name="Description" content="Read the message body" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_body - Manual" />
<meta name="twitter:description" content="Read the message body" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_body - Manual" />
<meta itemprop="description" content="Read the message body" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Read the message body" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-bodystruct.php">
          imap_bodystruct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-binary.php">
          &laquo; imap_binary        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-body.php' selected="selected">English</option>
            <option value='de/function.imap-body.php'>German</option>
            <option value='es/function.imap-body.php'>Spanish</option>
            <option value='fr/function.imap-body.php'>French</option>
            <option value='it/function.imap-body.php'>Italian</option>
            <option value='ja/function.imap-body.php'>Japanese</option>
            <option value='pt_BR/function.imap-body.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-body.php'>Russian</option>
            <option value='tr/function.imap-body.php'>Turkish</option>
            <option value='uk/function.imap-body.php'>Ukrainian</option>
            <option value='zh/function.imap-body.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-body" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_body</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_body</span> &mdash; <span class="dc-title">Read the message body</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-body-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_body</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$message_num</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>imap_body()</strong></span> returns the body of the message,
   numbered <code class="parameter">message_num</code> in the current
   mailbox.
  </p>
  <p class="para">
   <span class="function"><strong>imap_body()</strong></span> will only return a verbatim copy of the
   message body. To extract single parts of a multipart MIME-encoded
   message you have to use <span class="function"><a href="function.imap-fetchstructure.php" class="function">imap_fetchstructure()</a></span> to
   analyze its structure and <span class="function"><a href="function.imap-fetchbody.php" class="function">imap_fetchbody()</a></span> to
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
     ...
     <dd>
      <p class="para">
       The optional <code class="parameter">flags</code> are a bit mask
       ...
       <ul class="itemizedlist">
        ...
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.ft-peek">FT_PEEK</a></code></strong> - Do not set the \Seen flag if not already set
         </span>
        </li>
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.ft-internal">FT_INTERNAL</a></code></strong> - The return string is in internal format, will
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-body-returnvalues">
  ...
  <p class="para">
   Returns the body of the specified message, as a string,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.imap-body-changelog">
 ...
 <td>
  ...
  instance now; previously, a valid <code class="literal">imap</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-body.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-body%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-body&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-body.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="95133">  <div class="votes">
    <div id="Vu95133">
    <a href="/manual/vote-note.php?id=95133&amp;page=function.imap-body&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd95133">
    <a href="/manual/vote-note.php?id=95133&amp;page=function.imap-body&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V95133" title="51% like this...">
    6
    </div>
  </div>
  <a href="#95133" class="name">
  <strong class="user"><em>deenfirdoush at gmail dot com</em></strong></a><a class="genanchor" href="#95133"> &para;</a><div class="date" title="2009-12-14 07:08"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95133">
<div class="phpcode"><code><span class="html">Simple example on how to read body message of the recent mail.
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="120526">  <div class="votes">
    <div id="Vu120526">
    <a href="/manual/vote-note.php?id=120526&amp;page=function.imap-body&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120526">
    <a href="/manual/vote-note.php?id=120526&amp;page=function.imap-body&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120526" title="52% like this...">
    3
    </div>
  </div>
  <a href="#120526" class="name">
  <strong class="user"><em>theloverkills at gmail dot com</em></strong></a><a class="genanchor" href="#120526"> &para;</a><div class="date" title="2017-01-26 10:45"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120526">
<div class="phpcode"><code><span class="html">Please note that the UID is NOT unique.<br />UID of the email may be not unique on the server (2 messages in different folders may have same UID).<br /><br />Basically, don't use the UID as a unique identifier.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-body&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-body.php">＋<small>add a note</small></a></div>
