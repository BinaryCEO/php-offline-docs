...
<head>
  ...
  <title>PHP: mb_convert_variables - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-convert-variables.php">
 <link rel="shorturl" href="https://www.php.net/mb-convert-variables">
 <link rel="alternate" href="https://www.php.net/mb-convert-variables" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-convert-kana.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-decode-mimeheader.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-convert-variables.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-convert-variables.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-convert-variables.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-convert-variables.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-convert-variables.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-convert-variables.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-convert-variables.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-convert-variables.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-convert-variables.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-convert-variables.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-convert-variables.php" hreflang="zh">
...
<meta name="Description" content="Convert character code in variable(s)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_convert_variables - Manual" />
<meta name="twitter:description" content="Convert character code in variable(s)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_convert_variables - Manual" />
<meta itemprop="description" content="Convert character code in variable(s)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Convert character code in variable(s)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mb-decode-mimeheader.php">
          mb_decode_mimeheader &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mb-convert-kana.php">
          &laquo; mb_convert_kana        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-convert-variables.php' selected="selected">English</option>
            <option value='de/function.mb-convert-variables.php'>German</option>
            <option value='es/function.mb-convert-variables.php'>Spanish</option>
            <option value='fr/function.mb-convert-variables.php'>French</option>
            <option value='it/function.mb-convert-variables.php'>Italian</option>
            <option value='ja/function.mb-convert-variables.php'>Japanese</option>
            <option value='pt_BR/function.mb-convert-variables.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-convert-variables.php'>Russian</option>
            <option value='tr/function.mb-convert-variables.php'>Turkish</option>
            <option value='uk/function.mb-convert-variables.php'>Ukrainian</option>
            <option value='zh/function.mb-convert-variables.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-convert-variables" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_convert_variables</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_convert_variables</span> &mdash; <span class="dc-title">Convert character code in variable(s)</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-convert-variables-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_convert_variables</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$to_encoding</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$from_encoding</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter reference">&$var</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter reference">&...$vars</code></span><br>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Converts 
   character encoding of variables <code class="parameter">var</code> and <code class="parameter">vars</code> in
   encoding <code class="parameter">from_encoding</code> to encoding 
   <code class="parameter">to_encoding</code>. 
  </p>
  <p class="para">
   <span class="function"><strong>mb_convert_variables()</strong></span> join strings in Array
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-convert-variables-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The encoding that the <span class="type"><a href="language.types.string.php" class="type string">string</a></span> is being converted to.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       <code class="parameter">from_encoding</code> is specified as an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> 
       or comma separated <span class="type"><a href="language.types.string.php" class="type string">string</a></span>, it tries to detect encoding from
       <code class="parameter">from-coding</code>. When <code class="parameter">from_encoding</code> 
       is omitted, <code class="literal">detect_order</code> is used.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       <code class="parameter">var</code> is the reference to the
       variable being converted. String, Array and Object are accepted.
       <span class="function"><strong>mb_convert_variables()</strong></span> assumes all parameters
     ...
     <dd>
      <p class="para">
       Additional <code class="parameter">var</code>s.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-convert-variables-returnvalues">
  ...
  <p class="para">
   ...
   or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> for failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.mb-convert-variables-examples">
  ...
  <p class="para">
   <div class="example" id="example-2767">
    <p><strong>Example #1 <span class="function"><strong>mb_convert_variables()</strong></span> example</strong></p>
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Convert variables $post1, $post2 to internal encoding */<br /></span><span style="color: #0000BB">$interenc </span><span style="color: #007700">= </span><span style="color: #0000BB">mb_internal_encoding</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$inputenc </span><span style="color: #007700">= </span><span style="color: #0000BB">mb_convert_variables</span><span style="color: #007700">(</span><span style="color: #0000BB">$interenc</span><span style="color: #007700">, </span><span style="color: #DD0000">"ASCII,UTF-8,SJIS-win"</span><span style="color: #007700">, </span><span style="color: #0000BB">$post1</span><span style="color: #007700">, </span><span style="color: #0000BB">$post2</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-convert-variables.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-convert-variables%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-convert-variables&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-convert-variables.php">＋<small>add a note</small></a></span>
