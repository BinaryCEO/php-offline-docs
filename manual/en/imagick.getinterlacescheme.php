...
<head>
  ...
  <title>PHP: Imagick::getInterlaceScheme - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getinterlacescheme.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getinterlacescheme.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getinterlacescheme.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagewidth.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getiteratorindex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getinterlacescheme.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getinterlacescheme.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getinterlacescheme.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getinterlacescheme.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getinterlacescheme.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getinterlacescheme.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getinterlacescheme.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getinterlacescheme.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getinterlacescheme.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getinterlacescheme.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getinterlacescheme.php" hreflang="zh">
...
<meta name="Description" content="Gets the object interlace scheme" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getInterlaceScheme - Manual" />
<meta name="twitter:description" content="Gets the object interlace scheme" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getInterlaceScheme - Manual" />
<meta itemprop="description" content="Gets the object interlace scheme" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the object interlace scheme" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getiteratorindex.php">
          Imagick::getIteratorIndex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagewidth.php">
          &laquo; Imagick::getImageWidth        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getinterlacescheme.php' selected="selected">English</option>
            <option value='de/imagick.getinterlacescheme.php'>German</option>
            <option value='es/imagick.getinterlacescheme.php'>Spanish</option>
            <option value='fr/imagick.getinterlacescheme.php'>French</option>
            <option value='it/imagick.getinterlacescheme.php'>Italian</option>
            <option value='ja/imagick.getinterlacescheme.php'>Japanese</option>
            <option value='pt_BR/imagick.getinterlacescheme.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getinterlacescheme.php'>Russian</option>
            <option value='tr/imagick.getinterlacescheme.php'>Turkish</option>
            <option value='uk/imagick.getinterlacescheme.php'>Ukrainian</option>
            <option value='zh/imagick.getinterlacescheme.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getinterlacescheme" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getInterlaceScheme</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getInterlaceScheme</span> &mdash; <span class="dc-title">Gets the object interlace scheme</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getinterlacescheme-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getInterlaceScheme</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getinterlacescheme-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getinterlacescheme-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Gets the wand <a href="imagick.constants.php#imagick.constants.interlace" class="link">interlace
   scheme</a>.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-imagick.getinterlacescheme-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getinterlacescheme.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getinterlacescheme%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getinterlacescheme&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getinterlacescheme.php">＋<small>add a note</small></a></span>
