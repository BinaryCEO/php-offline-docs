...
<head>
  ...
  <title>PHP: ZipArchive::replaceFile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.replacefile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.replacefile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.replacefile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.renamename.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.setarchivecomment.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.replacefile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.replacefile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.replacefile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.replacefile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.replacefile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.replacefile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.replacefile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.replacefile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.replacefile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.replacefile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.replacefile.php" hreflang="zh">
...
<meta name="Description" content="Replace file in ZIP archive with a given path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::replaceFile - Manual" />
<meta name="twitter:description" content="Replace file in ZIP archive with a given path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::replaceFile - Manual" />
<meta itemprop="description" content="Replace file in ZIP archive with a given path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Replace file in ZIP archive with a given path" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.setarchivecomment.php">
          ZipArchive::setArchiveComment &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.renamename.php">
          &laquo; ZipArchive::renameName        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.replacefile.php' selected="selected">English</option>
            <option value='de/ziparchive.replacefile.php'>German</option>
            <option value='es/ziparchive.replacefile.php'>Spanish</option>
            <option value='fr/ziparchive.replacefile.php'>French</option>
            <option value='it/ziparchive.replacefile.php'>Italian</option>
            <option value='ja/ziparchive.replacefile.php'>Japanese</option>
            <option value='pt_BR/ziparchive.replacefile.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.replacefile.php'>Russian</option>
            <option value='tr/ziparchive.replacefile.php'>Turkish</option>
            <option value='uk/ziparchive.replacefile.php'>Ukrainian</option>
            <option value='zh/ziparchive.replacefile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.replacefile" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-ziparchive.replacefile-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ZipArchive::replaceFile</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filepath</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$start</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code><span class="initializer"> = ZipArchive::LENGTH_TO_END</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 examples" id="refsect1-ziparchive.replacefile-examples">
  <h3 class="title">Examples</h3>
    ...
    <div class="example" id="example-945">
     <p><strong>Example #1 Open and replace</strong></p>
    ...
    <p class="para">
     <ul class="simplelist">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/replacefile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.replacefile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.replacefile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.replacefile.php">＋<small>add a note</small></a></span>
