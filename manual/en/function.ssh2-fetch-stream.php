...
<head>
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ssh2-exec.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ssh2-fingerprint.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ssh2-fetch-stream.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ssh2-fetch-stream.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ssh2-fetch-stream.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ssh2-fetch-stream.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ssh2-fetch-stream.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ssh2-fetch-stream.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ssh2-fetch-stream.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ssh2-fetch-stream.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ssh2-fetch-stream.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ssh2-fetch-stream.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ssh2-fetch-stream.php" hreflang="zh">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$connection </span><span style="color: #007700">= </span><span style="color: #0000BB">ssh2_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">'shell.example.com'</span><span style="color: #007700">, </span><span style="color: #0000BB">22</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ssh2_auth_password</span><span style="color: #007700">(</span><span style="color: #0000BB">$connection</span><span style="color: #007700">, </span><span style="color: #DD0000">'username'</span><span style="color: #007700">, </span><span style="color: #DD0000">'password'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$stdio_stream </span><span style="color: #007700">= </span><span style="color: #0000BB">ssh2_shell</span><span style="color: #007700">(</span><span style="color: #0000BB">$connection</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$stderr_stream </span><span style="color: #007700">= </span><span style="color: #0000BB">ssh2_fetch_stream</span><span style="color: #007700">(</span><span style="color: #0000BB">$stdio_stream</span><span style="color: #007700">, </span><span style="color: #0000BB">SSH2_STREAM_STDERR</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ssh2-fetch-stream&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ssh2-fetch-stream.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="125145">  <div class="votes">
    ...
    <div class="tally" id="V125145" title="70% like this...">
    7
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">In addition to the last post (13 years ago) from Dennis K. I corrected two typos (constant SSH2_STREAM_STDIO was misspellt) and removed (too many) brackets - this code works:<br /><br /><span class="default">&lt;?php<br />      $stdout_stream </span><span class="keyword">= </span><span class="default">ssh2_exec</span><span class="keyword">(</span><span class="default">$connection</span><span class="keyword">, </span><span class="string">"lsssss -la"</span><span class="keyword">);<br /><br />      </span><span class="default">$sio_stream </span><span class="keyword">= </span><span class="default">ssh2_fetch_stream</span><span class="keyword">(</span><span class="default">$stdout_stream</span><span class="keyword">, </span><span class="default">SSH2_STREAM_STDIO</span><span class="keyword">);<br />      </span><span class="default">$err_stream </span><span class="keyword">= </span><span class="default">ssh2_fetch_stream</span><span class="keyword">(</span><span class="default">$stdout_stream</span><span class="keyword">, </span><span class="default">SSH2_STREAM_STDERR</span><span class="keyword">);<br />      <br />      </span><span class="default">stream_set_blocking</span><span class="keyword">(</span><span class="default">$sio_stream</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br />      </span><span class="default">stream_set_blocking</span><span class="keyword">(</span><span class="default">$err_stream</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br />      <br />      </span><span class="default">$result_dio </span><span class="keyword">= </span><span class="default">stream_get_contents</span><span class="keyword">(</span><span class="default">$sio_stream</span><span class="keyword">);<br />      </span><span class="default">$result_err </span><span class="keyword">= </span><span class="default">stream_get_contents</span><span class="keyword">(</span><span class="default">$err_stream</span><span class="keyword">);<br /><br />      echo </span><span class="string">'stderr: ' </span><span class="keyword">. </span><span class="default">$result_err</span><span class="keyword">;<br />      echo </span><span class="string">'stdio : ' </span><span class="keyword">. </span><span class="default">$result_dio</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>Ricardo Striquer (ricardophp yohoocombr)</em></strong></a><a class="genanchor" href="#71830"> &para;</a><div class="date" title="2006-12-18 07:41"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom71830">
<div class="phpcode"><code><span class="html">I got a friend using those functions and he was not able to use this ssh2_fetch_stream function. First of all I got the ssh2_shell sample by webmaster at spectreanime dot com, but this function does not work with his sample, i believe thats because he use fwrite instead of ssh2_shell or ssh2_exec to run the command.<br /><br />This sample below is to run under a command line and is fully functional. note that i add the sleep as advised by webmaster at spectreanime dot com<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">echo </span><span class="string">"Connexion SSH "</span><span class="keyword">;<br />if (!(</span><span class="default">$connection</span><span class="keyword">=@</span><span class="default">ssh2_connect</span><span class="keyword">(</span><span class="string">"69.69.69.69"</span><span class="keyword">, </span><span class="default">22</span><span class="keyword">))) {<br />   echo </span><span class="string">"[FAILED]\n"</span><span class="keyword">;<br />   exit(</span><span class="default">1</span><span class="keyword">);<br />}<br />echo </span><span class="string">"[OK]\nAuthentification "</span><span class="keyword">;<br /><br />if (!@</span><span class="default">ssh2_auth_password</span><span class="keyword">(</span><span class="default">$connection</span><span class="keyword">,</span><span class="string">"root"</span><span class="keyword">,</span><span class="string">"YourPassword"</span><span class="keyword">)) {<br />   echo </span><span class="string">"[FAILED]\n"</span><span class="keyword">;<br />   exit(</span><span class="default">1</span><span class="keyword">);<br />}<br />echo </span><span class="string">"[OK]\n"</span><span class="keyword">;<br /><br /></span><span class="default">$stdout_stream </span><span class="keyword">= </span><span class="default">ssh2_exec</span><span class="keyword">(</span><span class="default">$connection</span><span class="keyword">, </span><span class="string">"/bin/lssss -la /tmp"</span><span class="keyword">);<br /></span><span class="default">sleep</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">$stderr_stream </span><span class="keyword">= </span><span class="default">ssh2_fetch_stream</span><span class="keyword">(</span><span class="default">$stdout_stream</span><span class="keyword">, </span><span class="default">SSH2_STREAM_STDERR</span><span class="keyword">);<br /><br />echo </span><span class="string">"Erros encontrados!\n------------\n"</span><span class="keyword">;<br />while(</span><span class="default">$line </span><span class="keyword">= </span><span class="default">fgets</span><span class="keyword">(</span><span class="default">$stderr_stream</span><span class="keyword">)) { </span><span class="default">flush</span><span class="keyword">(); echo </span><span class="default">$line</span><span class="keyword">.</span><span class="string">"\n"</span><span class="keyword">; }<br />echo </span><span class="string">"------------\n"</span><span class="keyword">;<br /><br />while(</span><span class="default">$line </span><span class="keyword">= </span><span class="default">fgets</span><span class="keyword">(</span><span class="default">$stdout_stream</span><span class="keyword">)) { </span><span class="default">flush</span><span class="keyword">(); echo </span><span class="default">$line</span><span class="keyword">.</span><span class="string">"\n"</span><span class="keyword">;}<br /><br /></span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$stdout_stream</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I successfully used fgets in PHP4
<br />
<br />examples
<br />
<br /><span class="default">&lt;?php
<br />$stderr </span><span class="keyword">= </span><span class="default">fgets</span><span class="keyword">(</span><span class="default">ssh2_fetch_stream</span><span class="keyword">(</span><span class="default">$channel</span><span class="keyword">, </span><span class="default">SSH2_STREAM_STDERR</span><span class="keyword">), </span><span class="default">8192</span><span class="keyword">);
<br />
<br /></span><span class="default">$str </span><span class="keyword">= </span><span class="default">fgets</span><span class="keyword">(</span><span class="default">ssh2_fetch_stream</span><span class="keyword">(</span><span class="default">$channel</span><span class="keyword">, </span><span class="default">SSH2_STREAM_STDIO</span><span class="keyword">), </span><span class="default">8192</span><span class="keyword">);
...
<div class="phpcode"><code><span class="html">In addition to the last post from Ricardo Striquer:<br /><br />Simple block the stream with stream_set_blocking(), and you dont have to sleep() the script...<br /><br /><span class="default">&lt;?php<br />stdout_stream </span><span class="keyword">= </span><span class="default">ssh2_exec</span><span class="keyword">(</span><span class="default">$connection</span><span class="keyword">, </span><span class="string">"/bin/lssss -la /tmp"</span><span class="keyword">);<br /><br /></span><span class="default">$err_stream </span><span class="keyword">= </span><span class="default">ssh2_fetch_stream</span><span class="keyword">(</span><span class="default">$stdout_stream</span><span class="keyword">, </span><span class="default">SSH2_STREAM_STDERR</span><span class="keyword">);<br /><br /></span><span class="default">$dio_stream </span><span class="keyword">= </span><span class="default">ssh2_fetch_stream</span><span class="keyword">(</span><span class="default">$stdout_stream</span><span class="keyword">, </span><span class="default">SSH2_STREAM_STDDIO</span><span class="keyword">);<br /><br /></span><span class="default">stream_set_blocking</span><span class="keyword">(</span><span class="default">$err_stream</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">stream_set_blocking</span><span class="keyword">(</span><span class="default">$dio_stream</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /><br /></span><span class="default">$result_err </span><span class="keyword">= </span><span class="default">stream_get_contents</span><span class="keyword">(</span><span class="default">$err_stream</span><span class="keyword">));<br /></span><span class="default">$result_dio </span><span class="keyword">= </span><span class="default">stream_get_contents</span><span class="keyword">(</span><span class="default">$dio_stream</span><span class="keyword">));<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ssh2-fetch-stream&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ssh2-fetch-stream.php">＋<small>add a note</small></a></div>
