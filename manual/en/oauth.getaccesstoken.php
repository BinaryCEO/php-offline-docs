...
<head>
  ...
  <title>PHP: OAuth::getAccessToken - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/oauth.getaccesstoken.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/oauth.getaccesstoken.php">
 <link rel="alternate" href="https://www.php.net/manual/en/oauth.getaccesstoken.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.oauth.php">
 <link rel="prev" href="https://www.php.net/manual/en/oauth.generatesignature.php">
 <link rel="next" href="https://www.php.net/manual/en/oauth.getcapath.php">

 <link rel="alternate" href="https://www.php.net/manual/en/oauth.getaccesstoken.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/oauth.getaccesstoken.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/oauth.getaccesstoken.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/oauth.getaccesstoken.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/oauth.getaccesstoken.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/oauth.getaccesstoken.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/oauth.getaccesstoken.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/oauth.getaccesstoken.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/oauth.getaccesstoken.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/oauth.getaccesstoken.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/oauth.getaccesstoken.php" hreflang="zh">
...
<meta name="Description" content="Fetch an access token" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: OAuth::getAccessToken - Manual" />
<meta name="twitter:description" content="Fetch an access token" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: OAuth::getAccessToken - Manual" />
<meta itemprop="description" content="Fetch an access token" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetch an access token" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="oauth.getcapath.php">
          OAuth::getCAPath &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="oauth.generatesignature.php">
          &laquo; OAuth::generateSignature        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/oauth.getaccesstoken.php' selected="selected">English</option>
            <option value='de/oauth.getaccesstoken.php'>German</option>
            <option value='es/oauth.getaccesstoken.php'>Spanish</option>
            <option value='fr/oauth.getaccesstoken.php'>French</option>
            <option value='it/oauth.getaccesstoken.php'>Italian</option>
            <option value='ja/oauth.getaccesstoken.php'>Japanese</option>
            <option value='pt_BR/oauth.getaccesstoken.php'>Brazilian Portuguese</option>
            <option value='ru/oauth.getaccesstoken.php'>Russian</option>
            <option value='tr/oauth.getaccesstoken.php'>Turkish</option>
            <option value='uk/oauth.getaccesstoken.php'>Ukrainian</option>
            <option value='zh/oauth.getaccesstoken.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="oauth.getaccesstoken" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">OAuth::getAccessToken</h1>
  <p class="verinfo">(PECL OAuth &gt;= 0.99.1)</p><p class="refpurpose"><span class="refname">OAuth::getAccessToken</span> &mdash; <span class="dc-title">Fetch an access token</span></p>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <a href="http://oauth.pbwiki.com/ScalableOAuth/" class="link external">&raquo;&nbsp;See ScalableOAuth</a>
     ...
     <dd>
      <p class="para">
       For service providers which support 1.0a, a <code class="parameter">verifier_token</code>
       must be passed while exchanging the request token for the access
       token. If the <code class="parameter">verifier_token</code> is present in <code class="parameter">$_GET</code> 
       or <code class="parameter">$_POST</code> it is passed automatically and the caller 
       does not need to specify a <code class="parameter">verifier_token</code> (usually if the access token 
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <tr>
       ...
       <td>
        The <code class="parameter">verifier_token</code> parameter was added
       </td>
      </tr>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="oauth.settoken.php" class="methodname" rel="rdfs-seeAlso">OAuth::setToken()</a> - Sets the token and secret</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oauth/oauth/getaccesstoken.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Foauth.getaccesstoken%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=oauth.getaccesstoken&amp;repo=en&amp;redirect=https://www.php.net/manual/en/oauth.getaccesstoken.php">＋<small>add a note</small></a></span>
