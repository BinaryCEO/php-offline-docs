...
<head>
  ...
  <title>PHP: IntlChar::isbase - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.isbase.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.isbase.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isbase.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.isalpha.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.isblank.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isbase.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.isbase.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.isbase.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.isbase.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.isbase.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.isbase.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.isbase.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.isbase.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.isbase.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.isbase.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.isbase.php" hreflang="zh">
...
<meta name="Description" content="Check if code point is a base character" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::isbase - Manual" />
<meta name="twitter:description" content="Check if code point is a base character" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::isbase - Manual" />
<meta itemprop="description" content="Check if code point is a base character" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if code point is a base character" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.isblank.php">
          IntlChar::isblank &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.isalpha.php">
          &laquo; IntlChar::isalpha        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.isbase.php' selected="selected">English</option>
            <option value='de/intlchar.isbase.php'>German</option>
            <option value='es/intlchar.isbase.php'>Spanish</option>
            <option value='fr/intlchar.isbase.php'>French</option>
            <option value='it/intlchar.isbase.php'>Italian</option>
            <option value='ja/intlchar.isbase.php'>Japanese</option>
            <option value='pt_BR/intlchar.isbase.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.isbase.php'>Russian</option>
            <option value='tr/intlchar.isbase.php'>Turkish</option>
            <option value='uk/intlchar.isbase.php'>Ukrainian</option>
            <option value='zh/intlchar.isbase.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.isbase" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-intlchar.isbase-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::isbase</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$codepoint</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>

  <p class="para rdfs-comment">
   Determines whether the specified code point is a base character.  <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> for general categories &quot;L&quot; (letters),
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.isbase-returnvalues">
  ...
  <p class="para">
   ...
   <code class="parameter">codepoint</code> is a base character, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not. Returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-intlchar.isbase-examples">
  ...
  <div class="example" id="example-2722">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.isdigit.php" class="function" rel="rdfs-seeAlso">IntlChar::isdigit()</a> - Check if code point is a digit character</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/isbase.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.isbase%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.isbase&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.isbase.php">＋<small>add a note</small></a></span>
