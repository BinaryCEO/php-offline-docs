...
<head>
  ...
  <title>PHP: ArrayObject::ksort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/arrayobject.ksort.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/arrayobject.ksort.php">
 <link rel="alternate" href="https://www.php.net/manual/en/arrayobject.ksort.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.arrayobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/arrayobject.getiteratorclass.php">
 <link rel="next" href="https://www.php.net/manual/en/arrayobject.natcasesort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/arrayobject.ksort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/arrayobject.ksort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/arrayobject.ksort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/arrayobject.ksort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/arrayobject.ksort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/arrayobject.ksort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/arrayobject.ksort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/arrayobject.ksort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/arrayobject.ksort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/arrayobject.ksort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/arrayobject.ksort.php" hreflang="zh">
...
<meta name="Description" content="Sort the entries by key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ArrayObject::ksort - Manual" />
<meta name="twitter:description" content="Sort the entries by key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ArrayObject::ksort - Manual" />
<meta itemprop="description" content="Sort the entries by key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sort the entries by key" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="arrayobject.natcasesort.php">
          ArrayObject::natcasesort &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="arrayobject.getiteratorclass.php">
          &laquo; ArrayObject::getIteratorClass        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/arrayobject.ksort.php' selected="selected">English</option>
            <option value='de/arrayobject.ksort.php'>German</option>
            <option value='es/arrayobject.ksort.php'>Spanish</option>
            <option value='fr/arrayobject.ksort.php'>French</option>
            <option value='it/arrayobject.ksort.php'>Italian</option>
            <option value='ja/arrayobject.ksort.php'>Japanese</option>
            <option value='pt_BR/arrayobject.ksort.php'>Brazilian Portuguese</option>
            <option value='ru/arrayobject.ksort.php'>Russian</option>
            <option value='tr/arrayobject.ksort.php'>Turkish</option>
            <option value='uk/arrayobject.ksort.php'>Ukrainian</option>
            <option value='zh/arrayobject.ksort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="arrayobject.ksort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ArrayObject::ksort</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ArrayObject::ksort</span> &mdash; <span class="dc-title">Sort the entries by key</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-arrayobject.ksort-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ArrayObject::ksort</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = <strong><code><a href="array.constants.php#constant.sort-regular">SORT_REGULAR</a></code></strong></span></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-arrayobject.ksort-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-arrayobject.ksort-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-arrayobject.ksort-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-arrayobject.ksort-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3865">
    <p><strong>Example #1 <span class="function"><strong>ArrayObject::ksort()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">a = orange
b = banana
c = apple
d = lemon</pre>
</div>
 ...
 <div class="refsect1 seealso" id="refsect1-arrayobject.ksort-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ksort.php" class="function" rel="rdfs-seeAlso">ksort()</a> - Sort an array by key in ascending order</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/arrayobject/ksort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Farrayobject.ksort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=arrayobject.ksort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/arrayobject.ksort.php">＋<small>add a note</small></a></span>
