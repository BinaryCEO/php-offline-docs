...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectiontype.tostring.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectiontype.tostring.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectiontype.tostring.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectiontype.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectiontype.allowsnull.php">
 <link rel="next" href="https://www.php.net/manual/en/class.reflectionuniontype.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectiontype.tostring.php' selected="selected">English</option>
            <option value='de/reflectiontype.tostring.php'>German</option>
            <option value='es/reflectiontype.tostring.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionType::__toString</span> &mdash; <span class="dc-title">To string</span></p>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>
       <span class="methodname"><strong>ReflectionType::__toString()</strong></span> has been undeprecated.
      </td>
     </tr>
     ...
     <tr>
      <td>7.1.0</td>
      <td>
       <span class="methodname"><strong>ReflectionType::__toString()</strong></span> has been deprecated.
      </td>
     </tr>
 ...
 <div class="refsect1 examples" id="refsect1-reflectiontype.tostring-examples">
  ...
  <p class="para">
   <div class="example" id="example-5621">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionType::__toString()</strong></span> example</strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">string</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectiontype.tostring-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionnamedtype.getname.php" class="methodname" rel="rdfs-seeAlso">ReflectionNamedType::getName()</a> - Get the name of the type as a string</span></li>
    ...
    <li><span class="methodname"><a href="reflectionuniontype.gettypes.php" class="methodname" rel="rdfs-seeAlso">ReflectionUnionType::getTypes()</a> - Returns the types included in the union type</span></li>
    <li><span class="methodname"><a href="reflectionparameter.gettype.php" class="methodname" rel="rdfs-seeAlso">ReflectionParameter::getType()</a> - Gets a parameter's type</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectiontype/tostring.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectiontype.tostring%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectiontype.tostring&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectiontype.tostring.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Regarding this method's deprecation:<br /><br />ReflectionType::__toString() was first deprecated in PHP 7.1.0 alpha1.<br />The deprecation notice was removed in PHP 7.1.0 RC3, before being reinstated in PHP 7.4.0 alpha1.<br /><br />Starting with PHP 7.1.0 beta 3, ReflectionParameter::getType() &amp; ReflectionFunctionAbstract::getReturnType() return instances of ReflectionNamedType instead of ReflectionType.<br />The ReflectionNamedType class inherits from ReflectionType but provides an additional getName() method which can be used to retrieve the type hint.<br /><br />Lastly, PHP 8.0.0 alpha1 introduced the concept of union types (see <a href="https://wiki.php.net/rfc/union_types_v2" rel="nofollow" target="_blank">https://wiki.php.net/rfc/union_types_v2</a>). As a result, ReflectionParameter::getType() &amp; ReflectionFunctionAbstract::getReturnType() will now return either instances of ReflectionNamedType or ReflectionUnionType depending on the type hint, both of which are descendants of ReflectionType.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectiontype.tostring&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectiontype.tostring.php">＋<small>add a note</small></a></div>
