...
<head>
  ...
  <title>PHP: assert_options - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.assert-options.php">
 <link rel="shorturl" href="https://www.php.net/assert-options">
 <link rel="alternate" href="https://www.php.net/assert-options" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.assert.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cli-get-process-title.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.assert-options.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.assert-options.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.assert-options.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.assert-options.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.assert-options.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.assert-options.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.assert-options.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.assert-options.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.assert-options.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.assert-options.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.assert-options.php" hreflang="zh">
...
<meta name="Description" content="Set/get the various assert flags" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: assert_options - Manual" />
<meta name="twitter:description" content="Set/get the various assert flags" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: assert_options - Manual" />
<meta itemprop="description" content="Set/get the various assert flags" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set/get the various assert flags" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.assert-options.php' selected="selected">English</option>
            <option value='de/function.assert-options.php'>German</option>
            <option value='es/function.assert-options.php'>Spanish</option>
            <option value='fr/function.assert-options.php'>French</option>
            <option value='it/function.assert-options.php'>Italian</option>
            <option value='ja/function.assert-options.php'>Japanese</option>
            <option value='pt_BR/function.assert-options.php'>Brazilian Portuguese</option>
            <option value='ru/function.assert-options.php'>Russian</option>
            <option value='tr/function.assert-options.php'>Turkish</option>
            <option value='uk/function.assert-options.php'>Ukrainian</option>
            <option value='zh/function.assert-options.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.assert-options" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.assert.php" class="function" rel="rdfs-seeAlso">assert()</a> - Checks an assertion</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/assert-options.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.assert-options%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.assert-options&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.assert-options.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="34269">  <div class="votes">
    <div id="Vu34269">
    <a href="/manual/vote-note.php?id=34269&amp;page=function.assert-options&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd34269">
    <a href="/manual/vote-note.php?id=34269&amp;page=function.assert-options&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V34269" title="56% like this...">
    5
    </div>
  </div>
  <a href="#34269" class="name">
  <strong class="user"><em>Fr?d?ric Bouchery</em></strong></a><a class="genanchor" href="#34269"> &para;</a><div class="date" title="2003-07-20 04:25"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom34269">
<div class="phpcode"><code><span class="html">Here is an exemple how to use the assertion callback function :<br /><br /><span class="default">&lt;?php<br />  assert_options</span><span class="keyword">( </span><span class="default">ASSERT_CALLBACK</span><span class="keyword">, </span><span class="string">'assert_callback'</span><span class="keyword">);<br /><br />  function </span><span class="default">assert_callback</span><span class="keyword">( </span><span class="default">$script</span><span class="keyword">, </span><span class="default">$line</span><span class="keyword">, </span><span class="default">$message </span><span class="keyword">) {<br />    echo </span><span class="string">'You have a design error in your script &lt;b&gt;'</span><span class="keyword">, </span><span class="default">$script</span><span class="keyword">,</span><span class="string">'&lt;/b&gt; : line &lt;b&gt;'</span><span class="keyword">, </span><span class="default">$line</span><span class="keyword">,</span><span class="string">'&lt;/b&gt; :&lt;br /&gt;'</span><span class="keyword">;<br />    echo </span><span class="string">'&lt;b&gt;'</span><span class="keyword">, </span><span class="default">ereg_replace</span><span class="keyword">( </span><span class="string">'^.*//\*'</span><span class="keyword">, </span><span class="string">''</span><span class="keyword">, </span><span class="default">$message </span><span class="keyword">), </span><span class="string">'&lt;/b&gt;&lt;br /&gt;&lt;br /&gt;'</span><span class="keyword">;<br />    echo </span><span class="string">'Open the source file and check it, because it\'s not a normal behaviour !'</span><span class="keyword">;<br />    exit;<br />  }<br /><br />  </span><span class="default">$x </span><span class="keyword">= </span><span class="default">3</span><span class="keyword">;<br />  </span><span class="default">assert</span><span class="keyword">(</span><span class="string">'is_integer( $x ) &amp;&amp; ($x &gt;= 0) &amp;&amp; ($x &lt;= 10); //* $x must be an integer value from 0 to 10' </span><span class="keyword">);<br />  echo </span><span class="string">"0 &lt;= </span><span class="default">$x</span><span class="string"> &lt;= 10"</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />assertion is usefull for "design by contract" methodology ...</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.assert-options&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.assert-options.php">＋<small>add a note</small></a></div>
