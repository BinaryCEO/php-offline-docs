...
<head>
  ...
  <title>PHP: ZipArchive::setMtimeIndex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.setmtimeindex.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.setmtimeindex.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setmtimeindex.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.setexternalattributesname.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.setmtimename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setmtimeindex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.setmtimeindex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.setmtimeindex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.setmtimeindex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.setmtimeindex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.setmtimeindex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.setmtimeindex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.setmtimeindex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.setmtimeindex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.setmtimeindex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.setmtimeindex.php" hreflang="zh">
...
<meta name="Description" content="Set the modification time of an entry defined by its index" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::setMtimeIndex - Manual" />
<meta name="twitter:description" content="Set the modification time of an entry defined by its index" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::setMtimeIndex - Manual" />
<meta itemprop="description" content="Set the modification time of an entry defined by its index" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the modification time of an entry defined by its index" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.setmtimename.php">
          ZipArchive::setMtimeName &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.setexternalattributesname.php">
          &laquo; ZipArchive::setExternalAttributesName        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.setmtimeindex.php' selected="selected">English</option>
            <option value='de/ziparchive.setmtimeindex.php'>German</option>
            <option value='es/ziparchive.setmtimeindex.php'>Spanish</option>
            <option value='fr/ziparchive.setmtimeindex.php'>French</option>
            <option value='it/ziparchive.setmtimeindex.php'>Italian</option>
            <option value='ja/ziparchive.setmtimeindex.php'>Japanese</option>
            <option value='pt_BR/ziparchive.setmtimeindex.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.setmtimeindex.php'>Russian</option>
            <option value='tr/ziparchive.setmtimeindex.php'>Turkish</option>
            <option value='uk/ziparchive.setmtimeindex.php'>Ukrainian</option>
            <option value='zh/ziparchive.setmtimeindex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.setmtimeindex" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ZipArchive::setMtimeIndex</h1>
  <p class="verinfo">(PHP &gt;= 8.0.0, PECL zip &gt;= 1.16.0)</p><p class="refpurpose"><span class="refname">ZipArchive::setMtimeIndex</span> &mdash; <span class="dc-title">Set the modification time of an entry defined by its index</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-ziparchive.setmtimeindex-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ZipArchive::setMtimeIndex</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timestamp</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-ziparchive.setmtimeindex-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-ziparchive.setmtimeindex-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-ziparchive.setmtimeindex-examples">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$zip </span><span style="color: #007700">= new </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">();<br />if (</span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">open</span><span style="color: #007700">(</span><span style="color: #DD0000">'test.zip'</span><span style="color: #007700">, </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">::</span><span style="color: #0000BB">CREATE</span><span style="color: #007700">) === </span><span style="color: #0000BB">TRUE</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addFile</span><span style="color: #007700">(</span><span style="color: #DD0000">'text.txt'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setMtimeIndex</span><span style="color: #007700">(</span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">mktime</span><span style="color: #007700">(</span><span style="color: #0000BB">0</span><span style="color: #007700">,</span><span style="color: #0000BB">0</span><span style="color: #007700">,</span><span style="color: #0000BB">0</span><span style="color: #007700">,</span><span style="color: #0000BB">12</span><span style="color: #007700">,</span><span style="color: #0000BB">25</span><span style="color: #007700">,</span><span style="color: #0000BB">2019</span><span style="color: #007700">));<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">close</span><span style="color: #007700">();<br />    echo </span><span style="color: #DD0000">"Ok\n"</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">"KO\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-ziparchive.setmtimeindex-notes">
 ...
 <div class="refsect1 seealso" id="refsect1-ziparchive.setmtimeindex-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="ziparchive.setmtimename.php" class="methodname" rel="rdfs-seeAlso">ZipArchive::setMtimeName()</a> - Set the modification time of an entry defined by its name</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/setmtimeindex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.setmtimeindex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.setmtimeindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.setmtimeindex.php">＋<small>add a note</small></a></span>
