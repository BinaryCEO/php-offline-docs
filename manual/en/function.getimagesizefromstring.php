...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.getimagesizefromstring.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.getimagesize.php">
 <link rel="next" href="https://www.php.net/manual/en/function.image-type-to-extension.php">
...
<meta name="Description" content="Get the size of an image from a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: getimagesizefromstring - Manual" />
<meta name="twitter:description" content="Get the size of an image from a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: getimagesizefromstring - Manual" />
<meta itemprop="description" content="Get the size of an image from a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the size of an image from a string" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.getimagesizefromstring.php' selected="selected">English</option>
            ...
            <option value='tr/function.getimagesizefromstring.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">getimagesizefromstring</span> &mdash; <span class="dc-title">Get the size of an image from a string</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.getimagesizefromstring-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>getimagesizefromstring</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter reference">&$image_info</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Identical to <span class="function"><a href="function.getimagesize.php" class="function">getimagesize()</a></span> except that <span class="function"><strong>getimagesizefromstring()</strong></span>
   accepts a string instead of a file name as the first parameter.
  </p>
  <p class="para">
   See the <span class="function"><a href="function.getimagesize.php" class="function">getimagesize()</a></span> documentation for details on how this
   function works.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.getimagesizefromstring-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      See <span class="function"><a href="function.getimagesize.php" class="function">getimagesize()</a></span>.
     </p>
    </dd>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.getimagesize.php" class="function" rel="rdfs-seeAlso">getimagesize()</a> - Get the size of an image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/getimagesizefromstring.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.getimagesizefromstring%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.getimagesizefromstring&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getimagesizefromstring.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>imageman</em></strong></a><a class="genanchor" href="#113976"> &para;</a><div class="date" title="2013-12-24 07:10"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113976">
<div class="phpcode"><code><span class="html">getimagesizefromstring function for &lt; 5.4<br /><br /><span class="default">&lt;?php<br />   </span><span class="keyword">if (!</span><span class="default">function_exists</span><span class="keyword">(</span><span class="string">'getimagesizefromstring'</span><span class="keyword">)) {<br />      function </span><span class="default">getimagesizefromstring</span><span class="keyword">(</span><span class="default">$string_data</span><span class="keyword">)<br />      {<br />         </span><span class="default">$uri </span><span class="keyword">= </span><span class="string">'data://application/octet-stream;base64,'  </span><span class="keyword">. </span><span class="default">base64_encode</span><span class="keyword">(</span><span class="default">$string_data</span><span class="keyword">);<br />         return </span><span class="default">getimagesize</span><span class="keyword">(</span><span class="default">$uri</span><span class="keyword">);<br />      }<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Just a quick comment on the solution by imageman for versions &lt; 5.4 you will need to enable allow_url_fopen in order to use the data wrapper.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.getimagesizefromstring&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getimagesizefromstring.php">＋<small>add a note</small></a></div>
