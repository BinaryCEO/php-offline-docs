...
<head>
  ...
  <title>PHP: pg_send_execute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-send-execute.php">
 <link rel="shorturl" href="https://www.php.net/pg-send-execute">
 <link rel="alternate" href="https://www.php.net/pg-send-execute" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-select.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-send-prepare.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-send-execute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-send-execute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-send-execute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-send-execute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-send-execute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-send-execute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-send-execute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-send-execute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-send-execute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-send-execute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-send-execute.php" hreflang="zh">
...
<meta name="Description" content="Sends a request to execute a prepared statement with given parameters, without waiting for the result(s)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_send_execute - Manual" />
<meta name="twitter:description" content="Sends a request to execute a prepared statement with given parameters, without waiting for the result(s)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_send_execute - Manual" />
<meta itemprop="description" content="Sends a request to execute a prepared statement with given parameters, without waiting for the result(s)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sends a request to execute a prepared statement with given parameters, without waiting for the result(s)" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-send-execute.php' selected="selected">English</option>
            <option value='de/function.pg-send-execute.php'>German</option>
            <option value='es/function.pg-send-execute.php'>Spanish</option>
            <option value='fr/function.pg-send-execute.php'>French</option>
            <option value='it/function.pg-send-execute.php'>Italian</option>
            <option value='ja/function.pg-send-execute.php'>Japanese</option>
            <option value='pt_BR/function.pg-send-execute.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-send-execute.php'>Russian</option>
            <option value='tr/function.pg-send-execute.php'>Turkish</option>
            <option value='uk/function.pg-send-execute.php'>Ukrainian</option>
            <option value='zh/function.pg-send-execute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-send-execute" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_send_execute</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_send_execute</span> &mdash; <span class="dc-title">Sends a request to execute a prepared statement with given parameters, without waiting for the result(s)</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-send-execute-description">
  ...
  <p class="para">
    This is similar to <span class="function"><a href="function.pg-send-query-params.php" class="function">pg_send_query_params()</a></span>, but the command to be executed is specified 
    by naming a previously-prepared statement, instead of giving a query string. The 
    function&#039;s parameters are handled identically to <span class="function"><a href="function.pg-execute.php" class="function">pg_execute()</a></span>. 
    Like <span class="function"><a href="function.pg-execute.php" class="function">pg_execute()</a></span>, it will not work on pre-7.4 versions of
    PostgreSQL.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-send-execute-examples">
  ...
  <p class="para">
   <div class="example" id="example-2112">
    <p><strong>Example #1 Using <span class="function"><strong>pg_send_execute()</strong></span></strong></p>
   ...
   given parameters, and waits for completion</span></li>
    ...
    <li><span class="function"><a href="function.pg-execute.php" class="function" rel="rdfs-seeAlso">pg_execute()</a> - Sends a request to execute a prepared statement with given parameters, and waits for the result</span></li>    
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-send-execute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-send-execute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-send-execute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-send-execute.php">＋<small>add a note</small></a></span>
