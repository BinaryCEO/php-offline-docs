...
<head>
  ...
  <title>PHP: cubrid_get_db_parameter - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-get-db-parameter.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-get-db-parameter">
 <link rel="alternate" href="https://www.php.net/cubrid-get-db-parameter" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-get-client-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-get-query-timeout.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-get-db-parameter.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-get-db-parameter.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-get-db-parameter.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-get-db-parameter.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-get-db-parameter.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-get-db-parameter.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-get-db-parameter.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-get-db-parameter.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-get-db-parameter.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-get-db-parameter.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-get-db-parameter.php" hreflang="zh">
...
<meta name="Description" content="Returns the CUBRID database parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_get_db_parameter - Manual" />
<meta name="twitter:description" content="Returns the CUBRID database parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_get_db_parameter - Manual" />
<meta itemprop="description" content="Returns the CUBRID database parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the CUBRID database parameters" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-get-query-timeout.php">
          cubrid_get_query_timeout &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-get-client-info.php">
          &laquo; cubrid_get_client_info        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-get-db-parameter.php' selected="selected">English</option>
            <option value='de/function.cubrid-get-db-parameter.php'>German</option>
            <option value='es/function.cubrid-get-db-parameter.php'>Spanish</option>
            <option value='fr/function.cubrid-get-db-parameter.php'>French</option>
            <option value='it/function.cubrid-get-db-parameter.php'>Italian</option>
            <option value='ja/function.cubrid-get-db-parameter.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-get-db-parameter.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-get-db-parameter.php'>Russian</option>
            <option value='tr/function.cubrid-get-db-parameter.php'>Turkish</option>
            <option value='uk/function.cubrid-get-db-parameter.php'>Ukrainian</option>
            <option value='zh/function.cubrid-get-db-parameter.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-get-db-parameter" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-get-db-parameter-description">
  ...
  <p class="para rdfs-comment">
   This function returns the CUBRID database parameters, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure. 
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-get-db-parameter-returnvalues">
  ...
  <p class="para">
   An associative array with CUBRID database parameters; on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.cubrid-get-autocommit.php" class="function" rel="rdfs-seeAlso">cubrid_get_autocommit()</a> - Get auto-commit mode of the connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-get-db-parameter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-get-db-parameter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-get-db-parameter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-get-db-parameter.php">＋<small>add a note</small></a></span>
