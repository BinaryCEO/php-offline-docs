...
<head>
  ...
  <title>PHP: Imagick::exportImagePixels - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.exportimagepixels.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.exportimagepixels.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.exportimagepixels.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.evaluateimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.extentimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.exportimagepixels.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.exportimagepixels.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.exportimagepixels.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.exportimagepixels.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.exportimagepixels.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.exportimagepixels.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.exportimagepixels.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.exportimagepixels.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.exportimagepixels.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.exportimagepixels.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.exportimagepixels.php" hreflang="zh">
...
<meta name="Description" content="Exports raw image pixels" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::exportImagePixels - Manual" />
<meta name="twitter:description" content="Exports raw image pixels" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::exportImagePixels - Manual" />
<meta itemprop="description" content="Exports raw image pixels" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exports raw image pixels" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.extentimage.php">
          Imagick::extentImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.evaluateimage.php">
          &laquo; Imagick::evaluateImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.exportimagepixels.php' selected="selected">English</option>
            <option value='de/imagick.exportimagepixels.php'>German</option>
            <option value='es/imagick.exportimagepixels.php'>Spanish</option>
            <option value='fr/imagick.exportimagepixels.php'>French</option>
            <option value='it/imagick.exportimagepixels.php'>Italian</option>
            <option value='ja/imagick.exportimagepixels.php'>Japanese</option>
            <option value='pt_BR/imagick.exportimagepixels.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.exportimagepixels.php'>Russian</option>
            <option value='tr/imagick.exportimagepixels.php'>Turkish</option>
            <option value='uk/imagick.exportimagepixels.php'>Ukrainian</option>
            <option value='zh/imagick.exportimagepixels.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.exportimagepixels" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::exportImagePixels</h1>
  <p class="verinfo">(PECL imagick 2 &gt;=2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::exportImagePixels</span> &mdash; <span class="dc-title">Exports raw image pixels</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.exportimagepixels-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::exportImagePixels</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$map</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$STORAGE</code></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   Exports image pixels into an array. The map defines the ordering of the exported 
   pixels. The size of the returned array is <code class="literal">width * height * strlen(map)</code>.
   This method is available if Imagick has been compiled against ImageMagick version 6.4.7 or newer.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.exportimagepixels-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Ordering of the exported pixels. For example <code class="literal">&quot;RGB&quot;</code>. 
     ...
     <dd>
      <p class="para">
       Refer to this list of <a href="imagick.constants.php#imagick.constants.pixel" class="link">pixel type constants</a>
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.exportimagepixels-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.exportimagepixels-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.exportimagepixels-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2997">
    <p><strong>Example #1 Using <span class="function"><strong>Imagick::exportImagePixels()</strong></span></strong></p>
    <div class="example-contents"><p>
     Export image pixels into an array
    </p></div>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">/* Create new object */<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /><br /></span><span style="color: #FF8000">/* Create new image */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newPseudoImage</span><span style="color: #007700">(</span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"magick:rose"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Export the image pixels */<br /></span><span style="color: #0000BB">$pixels </span><span style="color: #007700">= </span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">exportImagePixels</span><span style="color: #007700">(</span><span style="color: #0000BB">10</span><span style="color: #007700">, </span><span style="color: #0000BB">10</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #DD0000">"RGB"</span><span style="color: #007700">, </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">PIXEL_CHAR</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Output */<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$pixels</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>

    <div class="example-contents"><p>The above example will output:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">array(12) {
  [0]=&gt;
  int(72)
  [1]=&gt;
  int(64)
  ...
  int(111)
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/exportimagepixels.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.exportimagepixels%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.exportimagepixels&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.exportimagepixels.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="127031">  <div class="votes">
    <div id="Vu127031">
    <a href="/manual/vote-note.php?id=127031&amp;page=imagick.exportimagepixels&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127031">
    <a href="/manual/vote-note.php?id=127031&amp;page=imagick.exportimagepixels&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127031" title="100% like this...">
    2
    </div>
  </div>
  <a href="#127031" class="name">
  <strong class="user"><em>P S</em></strong></a><a class="genanchor" href="#127031"> &para;</a><div class="date" title="2022-05-06 04:37"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom127031">
<div class="phpcode"><code><span class="html">These are the letters for the map:<br /><br />R = red<br />G = green<br />B = blue<br />A = alpha (0 is transparent)<br />O = alpha (0 is opaque)<br />C = cyan<br />Y = yellow<br />M = magenta<br />K = black<br />I = intensity (for grayscale)<br />P = pad</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.exportimagepixels&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.exportimagepixels.php">＋<small>add a note</small></a></div>
