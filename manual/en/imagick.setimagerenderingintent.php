...
<head>
  ...
  <title>PHP: Imagick::setImageRenderingIntent - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagerenderingintent.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagerenderingintent.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagerenderingintent.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageredprimary.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageresolution.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagerenderingintent.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagerenderingintent.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagerenderingintent.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagerenderingintent.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagerenderingintent.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagerenderingintent.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagerenderingintent.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagerenderingintent.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagerenderingintent.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagerenderingintent.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagerenderingintent.php" hreflang="zh">
...
<meta name="Description" content="Sets the image rendering intent" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageRenderingIntent - Manual" />
<meta name="twitter:description" content="Sets the image rendering intent" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageRenderingIntent - Manual" />
<meta itemprop="description" content="Sets the image rendering intent" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image rendering intent" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimageresolution.php">
          Imagick::setImageResolution &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageredprimary.php">
          &laquo; Imagick::setImageRedPrimary        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagerenderingintent.php' selected="selected">English</option>
            <option value='de/imagick.setimagerenderingintent.php'>German</option>
            <option value='es/imagick.setimagerenderingintent.php'>Spanish</option>
            <option value='fr/imagick.setimagerenderingintent.php'>French</option>
            <option value='it/imagick.setimagerenderingintent.php'>Italian</option>
            <option value='ja/imagick.setimagerenderingintent.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagerenderingintent.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagerenderingintent.php'>Russian</option>
            <option value='tr/imagick.setimagerenderingintent.php'>Turkish</option>
            <option value='uk/imagick.setimagerenderingintent.php'>Ukrainian</option>
            <option value='zh/imagick.setimagerenderingintent.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagerenderingintent" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageRenderingIntent</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageRenderingIntent</span> &mdash; <span class="dc-title">Sets the image rendering intent</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagerenderingintent-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageRenderingIntent</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rendering_intent</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagerenderingintent-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">rendering_intent</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagerenderingintent-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagerenderingintent-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagerenderingintent.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagerenderingintent%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagerenderingintent&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagerenderingintent.php">＋<small>add a note</small></a></span>
