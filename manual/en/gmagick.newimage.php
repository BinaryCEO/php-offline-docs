...
<head>
  ...
  <title>PHP: Gmagick::newimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.newimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.newimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.newimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.motionblurimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.nextimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.newimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.newimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.newimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.newimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.newimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.newimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.newimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.newimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.newimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.newimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.newimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::newimage - Manual" />
<meta name="twitter:description" content="Creates a new image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::newimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.nextimage.php">
          Gmagick::nextimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.motionblurimage.php">
          &laquo; Gmagick::motionblurimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.newimage.php' selected="selected">English</option>
            <option value='de/gmagick.newimage.php'>German</option>
            <option value='es/gmagick.newimage.php'>Spanish</option>
            <option value='fr/gmagick.newimage.php'>French</option>
            <option value='it/gmagick.newimage.php'>Italian</option>
            <option value='ja/gmagick.newimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.newimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.newimage.php'>Russian</option>
            <option value='tr/gmagick.newimage.php'>Turkish</option>
            <option value='uk/gmagick.newimage.php'>Ukrainian</option>
            <option value='zh/gmagick.newimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.newimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::newimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::newimage</span> &mdash; <span class="dc-title">Creates a new image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.newimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::newimage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$background</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$format</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.newimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.newimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.newimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/newimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.newimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.newimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.newimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124270">  <div class="votes">
    <div id="Vu124270">
    <a href="/manual/vote-note.php?id=124270&amp;page=gmagick.newimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124270">
    <a href="/manual/vote-note.php?id=124270&amp;page=gmagick.newimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124270" title="100% like this...">
    4
    </div>
  </div>
  <a href="#124270" class="name">
  <strong class="user"><em>evitceted</em></strong></a><a class="genanchor" href="#124270"> &para;</a><div class="date" title="2019-10-07 11:05"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124270">
<div class="phpcode"><code><span class="html">To create a png with the transparent background:<br />newimage(width, height, "transparent", "png")</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gmagick.newimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.newimage.php">＋<small>add a note</small></a></div>
