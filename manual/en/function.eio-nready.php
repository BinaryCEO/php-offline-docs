...
<head>
  ...
  <title>PHP: eio_nready - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-nready.php">
 <link rel="shorturl" href="https://www.php.net/eio-nready">
 <link rel="alternate" href="https://www.php.net/eio-nready" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-npending.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-nreqs.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-nready.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-nready.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-nready.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-nready.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-nready.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-nready.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-nready.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-nready.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-nready.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-nready.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-nready.php" hreflang="zh">
...
<meta name="Description" content="Returns number of not-yet handled requests" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_nready - Manual" />
<meta name="twitter:description" content="Returns number of not-yet handled requests" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_nready - Manual" />
<meta itemprop="description" content="Returns number of not-yet handled requests" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns number of not-yet handled requests" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-nreqs.php">
          eio_nreqs &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-npending.php">
          &laquo; eio_npending        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-nready.php' selected="selected">English</option>
            <option value='de/function.eio-nready.php'>German</option>
            <option value='es/function.eio-nready.php'>Spanish</option>
            <option value='fr/function.eio-nready.php'>French</option>
            <option value='it/function.eio-nready.php'>Italian</option>
            <option value='ja/function.eio-nready.php'>Japanese</option>
            <option value='pt_BR/function.eio-nready.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-nready.php'>Russian</option>
            <option value='tr/function.eio-nready.php'>Turkish</option>
            <option value='uk/function.eio-nready.php'>Ukrainian</option>
            <option value='zh/function.eio-nready.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-nready" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_nready</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_nready</span> &mdash; <span class="dc-title">Returns number of not-yet handled requests</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-nready-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_nready</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-nready-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.eio-nready-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_nready()</strong></span> returns number of not-yet handled requests
  </p>
 </div>



 <div class="refsect1 seealso" id="refsect1-function.eio-nready-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><strong>eio_nready()</strong></span></li>
   <li><span class="function"><a href="function.eio-nthreads.php" class="function" rel="rdfs-seeAlso">eio_nthreads()</a> - Returns number of threads currently in use</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-nready.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-nready%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-nready&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-nready.php">＋<small>add a note</small></a></span>
