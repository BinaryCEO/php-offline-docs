...
<head>
  ...
  <title>PHP: ps_set_value - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-set-value.php">
 <link rel="shorturl" href="https://www.php.net/ps-set-value">
 <link rel="alternate" href="https://www.php.net/ps-set-value" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-set-text-pos.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-setcolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-set-value.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-set-value.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-set-value.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-set-value.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-set-value.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-set-value.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-set-value.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-set-value.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-set-value.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-set-value.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-set-value.php" hreflang="zh">
...
<meta name="Description" content="Sets certain values" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_set_value - Manual" />
<meta name="twitter:description" content="Sets certain values" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_set_value - Manual" />
<meta itemprop="description" content="Sets certain values" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets certain values" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-set-value.php' selected="selected">English</option>
            <option value='de/function.ps-set-value.php'>German</option>
            <option value='es/function.ps-set-value.php'>Spanish</option>
            <option value='fr/function.ps-set-value.php'>French</option>
            <option value='it/function.ps-set-value.php'>Italian</option>
            <option value='ja/function.ps-set-value.php'>Japanese</option>
            <option value='pt_BR/function.ps-set-value.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-set-value.php'>Russian</option>
            <option value='tr/function.ps-set-value.php'>Turkish</option>
            <option value='uk/function.ps-set-value.php'>Ukrainian</option>
            <option value='zh/function.ps-set-value.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-set-value" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_set_value</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_set_value</span> &mdash; <span class="dc-title">Sets certain values</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-set-value-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_set_value</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-set-value-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-set-value-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-set-value-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-get-value.php" class="function" rel="rdfs-seeAlso">ps_get_value()</a> - Gets certain values</span></li>
    <li><span class="function"><a href="function.ps-set-parameter.php" class="function" rel="rdfs-seeAlso">ps_set_parameter()</a> - Sets certain parameters</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-set-value.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-set-value%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-set-value&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-set-value.php">＋<small>add a note</small></a></span>
