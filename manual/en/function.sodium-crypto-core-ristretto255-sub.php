...
<head>
  ...
  <title>PHP: sodium_crypto_core_ristretto255_sub - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-sub.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-core-ristretto255-sub">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-core-ristretto255-sub" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-scalar-sub.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-generichash.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-sub.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-core-ristretto255-sub.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-core-ristretto255-sub.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-core-ristretto255-sub.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-core-ristretto255-sub.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-core-ristretto255-sub.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-core-ristretto255-sub.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-core-ristretto255-sub.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-core-ristretto255-sub.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-core-ristretto255-sub.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-core-ristretto255-sub.php" hreflang="zh">
...
<meta name="Description" content="Subtracts an element" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_core_ristretto255_sub - Manual" />
<meta name="twitter:description" content="Subtracts an element" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_core_ristretto255_sub - Manual" />
<meta itemprop="description" content="Subtracts an element" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Subtracts an element" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-generichash.php">
          sodium_crypto_generichash &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-core-ristretto255-scalar-sub.php">
          &laquo; sodium_crypto_core_ristretto255_scalar_sub        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-core-ristretto255-sub.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-core-ristretto255-sub.php'>German</option>
            <option value='es/function.sodium-crypto-core-ristretto255-sub.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-core-ristretto255-sub.php'>French</option>
            <option value='it/function.sodium-crypto-core-ristretto255-sub.php'>Italian</option>
            <option value='ja/function.sodium-crypto-core-ristretto255-sub.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-core-ristretto255-sub.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-core-ristretto255-sub.php'>Russian</option>
            <option value='tr/function.sodium-crypto-core-ristretto255-sub.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-core-ristretto255-sub.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-core-ristretto255-sub.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-core-ristretto255-sub" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_core_ristretto255_sub</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.1.0)</p><p class="refpurpose"><span class="refname">sodium_crypto_core_ristretto255_sub</span> &mdash; <span class="dc-title">Subtracts an element</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-core-ristretto255-sub-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_core_ristretto255_sub</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$p</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$q</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   Subtracts an element <code class="parameter">q</code> from <code class="parameter">p</code>.
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-core-ristretto255-sub-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">p</code></dt>
    <dd>
     <p class="para">
      An element.
     </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-core-ristretto255-sub-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.sodium-crypto-core-ristretto255-sub-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1073">
    <p><strong>Example #1 <span class="function"><strong>sodium_crypto_core_ristretto255_sub()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$foo </span><span style="color: #007700">= </span><span style="color: #0000BB">sodium_crypto_core_ristretto255_random</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$bar </span><span style="color: #007700">= </span><span style="color: #0000BB">sodium_crypto_core_ristretto255_random</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$value </span><span style="color: #007700">= </span><span style="color: #0000BB">sodium_crypto_core_ristretto255_add</span><span style="color: #007700">(</span><span style="color: #0000BB">$foo</span><span style="color: #007700">, </span><span style="color: #0000BB">$bar</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$value </span><span style="color: #007700">= </span><span style="color: #0000BB">sodium_crypto_core_ristretto255_sub</span><span style="color: #007700">(</span><span style="color: #0000BB">$value</span><span style="color: #007700">, </span><span style="color: #0000BB">$bar</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">hash_equals</span><span style="color: #007700">(</span><span style="color: #0000BB">$foo</span><span style="color: #007700">, </span><span style="color: #0000BB">$value</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
<div class="examplescode"><pre class="examplescode">bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.sodium-crypto-core-ristretto255-sub-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.sodium-crypto-core-ristretto255-random.php" class="function" rel="rdfs-seeAlso">sodium_crypto_core_ristretto255_random()</a> - Generates a random key</span></li>
    <li><span class="function"><a href="function.sodium-crypto-core-ristretto255-add.php" class="function" rel="rdfs-seeAlso">sodium_crypto_core_ristretto255_add()</a> - Adds an element</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-core-ristretto255-sub.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-core-ristretto255-sub%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-core-ristretto255-sub&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-sub.php">＋<small>add a note</small></a></span>
