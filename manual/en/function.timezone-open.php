...
<head>
  ...
  <title>PHP: timezone_open - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.timezone-open.php">
 <link rel="shorturl" href="https://www.php.net/timezone-open">
 <link rel="alternate" href="https://www.php.net/timezone-open" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.timezone-offset-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.timezone-transitions-get.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.timezone-open.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.timezone-open.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.timezone-open.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.timezone-open.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.timezone-open.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.timezone-open.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.timezone-open.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.timezone-open.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.timezone-open.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.timezone-open.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.timezone-open.php" hreflang="zh">
...
<meta name="Description" content="Alias of DateTimeZone::__construct" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: timezone_open - Manual" />
<meta name="twitter:description" content="Alias of DateTimeZone::__construct" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: timezone_open - Manual" />
<meta itemprop="description" content="Alias of DateTimeZone::__construct" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTimeZone::__construct" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.timezone-transitions-get.php">
          timezone_transitions_get &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.timezone-offset-get.php">
          &laquo; timezone_offset_get        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.timezone-open.php' selected="selected">English</option>
            <option value='de/function.timezone-open.php'>German</option>
            <option value='es/function.timezone-open.php'>Spanish</option>
            <option value='fr/function.timezone-open.php'>French</option>
            <option value='it/function.timezone-open.php'>Italian</option>
            <option value='ja/function.timezone-open.php'>Japanese</option>
            <option value='pt_BR/function.timezone-open.php'>Brazilian Portuguese</option>
            <option value='ru/function.timezone-open.php'>Russian</option>
            <option value='tr/function.timezone-open.php'>Turkish</option>
            <option value='uk/function.timezone-open.php'>Ukrainian</option>
            <option value='zh/function.timezone-open.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.timezone-open" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">timezone_open</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">timezone_open</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetimezone.construct.php" class="methodname">DateTimeZone::__construct()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.timezone-open-description">
  <h3 class="title">Description</h3>
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetimezone.construct.php" class="methodname">DateTimeZone::__construct()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/timezone-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.timezone-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.timezone-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.timezone-open.php">＋<small>add a note</small></a></span>
