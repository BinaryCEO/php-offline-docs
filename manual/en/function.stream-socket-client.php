...
<head>
  ...
  <title>PHP: stream_socket_client - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-socket-client.php">
 <link rel="shorturl" href="https://www.php.net/stream-socket-client">
 <link rel="alternate" href="https://www.php.net/stream-socket-client" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-socket-accept.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-socket-enable-crypto.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-socket-client.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-socket-client.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-socket-client.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-socket-client.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-socket-client.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-socket-client.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-socket-client.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-socket-client.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-socket-client.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-socket-client.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-socket-client.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: stream_socket_client - Manual" />
<meta name="twitter:description" content="Open Internet or Unix domain socket connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_socket_client - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stream-socket-enable-crypto.php">
          stream_socket_enable_crypto &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-socket-accept.php">
          &laquo; stream_socket_accept        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-socket-client.php' selected="selected">English</option>
            <option value='de/function.stream-socket-client.php'>German</option>
            <option value='es/function.stream-socket-client.php'>Spanish</option>
            <option value='fr/function.stream-socket-client.php'>French</option>
            <option value='it/function.stream-socket-client.php'>Italian</option>
            <option value='ja/function.stream-socket-client.php'>Japanese</option>
            <option value='pt_BR/function.stream-socket-client.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-socket-client.php'>Russian</option>
            <option value='tr/function.stream-socket-client.php'>Turkish</option>
            <option value='uk/function.stream-socket-client.php'>Ukrainian</option>
            <option value='zh/function.stream-socket-client.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-socket-client" class="refentry">
...
brackets—for example, <code class="literal">tcp://[fe80::1]:80</code>.</span></p></blockquote>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    See <a href="transports.php" class="xref">List of Supported Socket Transports</a> for a list of built in transports.
   </p>
  </p></blockquote>
 </div>
   ...
   arrays of streams with a timeout specified by seconds and microseconds</span></li>
    ...
    <li><a href="ref.curl.php" class="xref">cURL Functions</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-socket-client.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-socket-client%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-socket-client&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-socket-client.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="86667">  <div class="votes">
    <div id="Vu86667">
    <a href="/manual/vote-note.php?id=86667&amp;page=function.stream-socket-client&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd86667">
    <a href="/manual/vote-note.php?id=86667&amp;page=function.stream-socket-client&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V86667" title="70% like this...">
    22
    </div>
  </div>
  <a href="#86667" class="name">
  <strong class="user"><em>nicholas at nicholaswilliams dot net</em></strong></a><a class="genanchor" href="#86667"> &para;</a><div class="date" title="2008-10-28 05:08"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86667">
<div class="phpcode"><code><span class="html">For those wanting to use stream_socket_client() to connect to a local UNIX socket who can't find documentation on how to do it, here's a (rough) example:<br /><br /><span class="default">&lt;?php<br /><br />$sock </span><span class="keyword">= </span><span class="default">stream_socket_client</span><span class="keyword">(</span><span class="string">'unix:///full/path/to/my/socket.sock'</span><span class="keyword">, </span><span class="default">$errno</span><span class="keyword">, </span><span class="default">$errstr</span><span class="keyword">);<br /><br /></span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">, </span><span class="string">'SOME COMMAND'</span><span class="keyword">.</span><span class="string">"\r\n"</span><span class="keyword">);<br /><br />echo </span><span class="default">fread</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">, </span><span class="default">4096</span><span class="keyword">).</span><span class="string">"\n"</span><span class="keyword">;<br /><br /></span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="105393">  <div class="votes">
    <div id="Vu105393">
    <a href="/manual/vote-note.php?id=105393&amp;page=function.stream-socket-client&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105393">
    <a href="/manual/vote-note.php?id=105393&amp;page=function.stream-socket-client&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105393" title="69% like this...">
    10
    </div>
  </div>
  <a href="#105393" class="name">
  <strong class="user"><em>Vasil Rangelov a.k.a. boen_robot</em></strong></a><a class="genanchor" href="#105393"> &para;</a><div class="date" title="2011-08-14 01:11"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105393">
<div class="phpcode"><code><span class="html">The remote_socket argument, in its end (well... after the port), can also contain a "/" followed by a unique identifier. This is especially useful if you want to create multiple persistent connections to the same transport://host:port combo.<br /><br />Example:<br /><span class="default">&lt;?php<br />$socket </span><span class="keyword">= </span><span class="default">stream_socket_client</span><span class="keyword">(</span><span class="string">'tcp://mysql.example.com:3306/root'</span><span class="keyword">, </span><span class="default">$errorno</span><span class="keyword">, </span><span class="default">$errorstr</span><span class="keyword">, </span><span class="default">$timeout</span><span class="keyword">, </span><span class="default">STREAM_CLIENT_CONNECT </span><span class="keyword">| </span><span class="default">STREAM_CLIENT_PERSISTENT</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Note that while (p)fsockopen() follows a similar scheme, it doesn't have this particular feature.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stream-socket-client&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-socket-client.php">＋<small>add a note</small></a></div>
