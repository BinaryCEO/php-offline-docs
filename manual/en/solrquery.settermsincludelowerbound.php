...
<head>
  ...
  <title>PHP: SolrQuery::setTermsIncludeLowerBound - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.settermsincludelowerbound.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.settermsincludelowerbound.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsincludelowerbound.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.settermsfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.settermsincludeupperbound.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsincludelowerbound.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.settermsincludelowerbound.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.settermsincludelowerbound.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.settermsincludelowerbound.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.settermsincludelowerbound.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.settermsincludelowerbound.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.settermsincludelowerbound.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.settermsincludelowerbound.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.settermsincludelowerbound.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.settermsincludelowerbound.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.settermsincludelowerbound.php" hreflang="zh">
...
<meta name="Description" content="Include the lower bound term in the result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setTermsIncludeLowerBound - Manual" />
<meta name="twitter:description" content="Include the lower bound term in the result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setTermsIncludeLowerBound - Manual" />
<meta itemprop="description" content="Include the lower bound term in the result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Include the lower bound term in the result set" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.settermsincludeupperbound.php">
          SolrQuery::setTermsIncludeUpperBound &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.settermsfield.php">
          &laquo; SolrQuery::setTermsField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.settermsincludelowerbound.php' selected="selected">English</option>
            <option value='de/solrquery.settermsincludelowerbound.php'>German</option>
            <option value='es/solrquery.settermsincludelowerbound.php'>Spanish</option>
            <option value='fr/solrquery.settermsincludelowerbound.php'>French</option>
            <option value='it/solrquery.settermsincludelowerbound.php'>Italian</option>
            <option value='ja/solrquery.settermsincludelowerbound.php'>Japanese</option>
            <option value='pt_BR/solrquery.settermsincludelowerbound.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.settermsincludelowerbound.php'>Russian</option>
            <option value='tr/solrquery.settermsincludelowerbound.php'>Turkish</option>
            <option value='uk/solrquery.settermsincludelowerbound.php'>Ukrainian</option>
            <option value='zh/solrquery.settermsincludelowerbound.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.settermsincludelowerbound" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setTermsIncludeLowerBound</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setTermsIncludeLowerBound</span> &mdash; <span class="dc-title">Include the lower bound term in the result set</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.settermsincludelowerbound-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setTermsIncludeLowerBound</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.settermsincludelowerbound-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.settermsincludelowerbound-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/settermsincludelowerbound.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.settermsincludelowerbound%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.settermsincludelowerbound&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.settermsincludelowerbound.php">＋<small>add a note</small></a></span>
