...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.variables.superglobals.php">
 <link rel="shorturl" href="https://www.php.net/variables.superglobals">
 <link rel="alternate" href="https://www.php.net/variables.superglobals" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.variables.php">
 <link rel="prev" href="https://www.php.net/manual/en/reserved.variables.php">
 <link rel="next" href="https://www.php.net/manual/en/reserved.variables.globals.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.variables.superglobals.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.variables.superglobals.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.variables.superglobals.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.variables.superglobals.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.variables.superglobals.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.variables.superglobals.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.variables.superglobals.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.variables.superglobals.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.variables.superglobals.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.variables.superglobals.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.variables.superglobals.php" hreflang="zh">
...
<meta name="Description" content="Built-in variables that are always available in all scopes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Superglobals - Manual" />
<meta name="twitter:description" content="Built-in variables that are always available in all scopes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Superglobals - Manual" />
<meta itemprop="description" content="Built-in variables that are always available in all scopes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Built-in variables that are always available in all scopes" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.variables.superglobals.php' selected="selected">English</option>
            ...
            <option value='it/language.variables.superglobals.php'>Italian</option>
            ...
            <option value='uk/language.variables.superglobals.php'>Ukrainian</option>
  ...
  </div><div id="language.variables.superglobals" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="book.filter.php" class="link">The filter extension</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/variables/superglobals.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.variables.superglobals%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.variables.superglobals&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.variables.superglobals.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="112184">  <div class="votes">
    <div id="Vu112184">
    <a href="/manual/vote-note.php?id=112184&amp;page=language.variables.superglobals&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112184">
    <a href="/manual/vote-note.php?id=112184&amp;page=language.variables.superglobals&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112184" title="53% like this...">
    25
    </div>
  </div>
  <a href="#112184" class="name">
  <strong class="user"><em>kitchin</em></strong></a><a class="genanchor" href="#112184"> &para;</a><div class="date" title="2013-05-14 06:09"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112184">
<div class="phpcode"><code><span class="html">Since PHP 5.4, you cannot use a superglobal as the parameter to a function. This causes a fatal error:<br /><br />function foo($_GET) {<br />  // whatever<br />}<br /><br />It's called "shadowing" a superglobal, and I don't know why people ever did it, but I've seen it out there. The easy fix is just to rename the variable $get in the function, assuming that name is unique. <br /><br />There was no deprecation warning issued in previous versions of PHP, according to my testing, neither in 5.3 nor 5.2. The error messages in 5.4 are:<br />Fatal error: Cannot re-assign auto-global variable _GET in...<br />Fatal error: Cannot re-assign auto-global variable _COOKIE in...<br />etc.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=language.variables.superglobals&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.variables.superglobals.php">＋<small>add a note</small></a></div>
