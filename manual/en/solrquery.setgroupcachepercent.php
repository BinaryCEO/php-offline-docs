...
<head>
  ...
  <title>PHP: SolrQuery::setGroupCachePercent - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setgroupcachepercent.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setgroupcachepercent.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgroupcachepercent.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setgroup.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setgroupfacet.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgroupcachepercent.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setgroupcachepercent.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setgroupcachepercent.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setgroupcachepercent.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setgroupcachepercent.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setgroupcachepercent.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setgroupcachepercent.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setgroupcachepercent.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setgroupcachepercent.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setgroupcachepercent.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setgroupcachepercent.php" hreflang="zh">
...
<meta name="Description" content="Enables caching for result grouping" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setGroupCachePercent - Manual" />
<meta name="twitter:description" content="Enables caching for result grouping" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setGroupCachePercent - Manual" />
<meta itemprop="description" content="Enables caching for result grouping" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enables caching for result grouping" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setgroupfacet.php">
          SolrQuery::setGroupFacet &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setgroup.php">
          &laquo; SolrQuery::setGroup        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setgroupcachepercent.php' selected="selected">English</option>
            <option value='de/solrquery.setgroupcachepercent.php'>German</option>
            <option value='es/solrquery.setgroupcachepercent.php'>Spanish</option>
            <option value='fr/solrquery.setgroupcachepercent.php'>French</option>
            <option value='it/solrquery.setgroupcachepercent.php'>Italian</option>
            <option value='ja/solrquery.setgroupcachepercent.php'>Japanese</option>
            <option value='pt_BR/solrquery.setgroupcachepercent.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setgroupcachepercent.php'>Russian</option>
            <option value='tr/solrquery.setgroupcachepercent.php'>Turkish</option>
            <option value='uk/solrquery.setgroupcachepercent.php'>Ukrainian</option>
            <option value='zh/solrquery.setgroupcachepercent.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setgroupcachepercent" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.setgroupformat.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupFormat()</a> - Sets the group format, result structure (group.format parameter)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setgroupcachepercent.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setgroupcachepercent%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setgroupcachepercent&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setgroupcachepercent.php">＋<small>add a note</small></a></span>
