...
<head>
  ...
  <title>PHP: fann_set_input_scaling_params - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-input-scaling-params.php">
 <link rel="shorturl" href="https://www.php.net/fann-set-input-scaling-params">
 <link rel="alternate" href="https://www.php.net/fann-set-input-scaling-params" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-error-log.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-learning-momentum.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-set-input-scaling-params.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-set-input-scaling-params.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-set-input-scaling-params.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-set-input-scaling-params.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-set-input-scaling-params.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-set-input-scaling-params.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-set-input-scaling-params.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-set-input-scaling-params.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-set-input-scaling-params.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-set-input-scaling-params.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-set-input-scaling-params.php" hreflang="zh">
...
<meta name="Description" content="Calculate input scaling parameters for future use based on training data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_input_scaling_params - Manual" />
<meta name="twitter:description" content="Calculate input scaling parameters for future use based on training data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_input_scaling_params - Manual" />
<meta itemprop="description" content="Calculate input scaling parameters for future use based on training data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calculate input scaling parameters for future use based on training data" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-set-learning-momentum.php">
          fann_set_learning_momentum &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-set-error-log.php">
          &laquo; fann_set_error_log        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-input-scaling-params.php' selected="selected">English</option>
            <option value='de/function.fann-set-input-scaling-params.php'>German</option>
            <option value='es/function.fann-set-input-scaling-params.php'>Spanish</option>
            <option value='fr/function.fann-set-input-scaling-params.php'>French</option>
            <option value='it/function.fann-set-input-scaling-params.php'>Italian</option>
            <option value='ja/function.fann-set-input-scaling-params.php'>Japanese</option>
            <option value='pt_BR/function.fann-set-input-scaling-params.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-set-input-scaling-params.php'>Russian</option>
            <option value='tr/function.fann-set-input-scaling-params.php'>Turkish</option>
            <option value='uk/function.fann-set-input-scaling-params.php'>Ukrainian</option>
            <option value='zh/function.fann-set-input-scaling-params.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-set-input-scaling-params" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_set_input_scaling_params</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_set_input_scaling_params</span> &mdash; <span class="dc-title">Calculate input scaling parameters for future use based on training data</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-set-input-scaling-params-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_set_input_scaling_params</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$train_data</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$new_input_min</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$new_input_max</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-set-input-scaling-params-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-set-input-scaling-params-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-set-input-scaling-params-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-set-output-scaling-params.php" class="function" rel="rdfs-seeAlso">fann_set_output_scaling_params()</a> - Calculate output scaling parameters for future use based on training data</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-input-scaling-params.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-input-scaling-params%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-input-scaling-params&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-input-scaling-params.php">＋<small>add a note</small></a></span>
