...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightFragsize - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightfragsize.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightfragsize.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightfragsize.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightfragmenter.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlighthighlightmultiterm.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightfragsize.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightfragsize.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightfragsize.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightfragsize.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightfragsize.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightfragsize.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightfragsize.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightfragsize.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightfragsize.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightfragsize.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightfragsize.php" hreflang="zh">
...
<meta name="Description" content="The size of fragments to consider for highlighting" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightFragsize - Manual" />
<meta name="twitter:description" content="The size of fragments to consider for highlighting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightFragsize - Manual" />
<meta itemprop="description" content="The size of fragments to consider for highlighting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The size of fragments to consider for highlighting" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.sethighlighthighlightmultiterm.php">
          SolrQuery::setHighlightHighlightMultiTerm &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightfragmenter.php">
          &laquo; SolrQuery::setHighlightFragmenter        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightfragsize.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightfragsize.php'>German</option>
            <option value='es/solrquery.sethighlightfragsize.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightfragsize.php'>French</option>
            <option value='it/solrquery.sethighlightfragsize.php'>Italian</option>
            <option value='ja/solrquery.sethighlightfragsize.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightfragsize.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightfragsize.php'>Russian</option>
            <option value='tr/solrquery.sethighlightfragsize.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightfragsize.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightfragsize.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightfragsize" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightFragsize</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightFragsize</span> &mdash; <span class="dc-title">The size of fragments to consider for highlighting</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightfragsize-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightFragsize</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$size</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightfragsize-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightfragsize-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightfragsize.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightfragsize%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightfragsize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightfragsize.php">＋<small>add a note</small></a></span>
