...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/eio.examples.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/eio.examples.php">
 <link rel="alternate" href="https://www.php.net/manual/en/eio.examples.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/eio.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.eio.php">

 <link rel="alternate" href="https://www.php.net/manual/en/eio.examples.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/eio.examples.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/eio.examples.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/eio.examples.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/eio.examples.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/eio.examples.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/eio.examples.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/eio.examples.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/eio.examples.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/eio.examples.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/eio.examples.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/eio.examples.php' selected="selected">English</option>
            <option value='de/eio.examples.php'>German</option>
            <option value='es/eio.examples.php'>Spanish</option>
            <option value='fr/eio.examples.php'>French</option>
            <option value='it/eio.examples.php'>Italian</option>
            <option value='ja/eio.examples.php'>Japanese</option>
            <option value='pt_BR/eio.examples.php'>Brazilian Portuguese</option>
            <option value='ru/eio.examples.php'>Russian</option>
            <option value='tr/eio.examples.php'>Turkish</option>
            <option value='uk/eio.examples.php'>Ukrainian</option>
            <option value='zh/eio.examples.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="eio.examples" class="chapter">
...
my_nop 2
 ...
 <p><strong>Example #2 Calling <span class="function"><a href="function.eio-chmod.php" class="function">eio_chmod()</a></span></strong></p>
 <div class="example-contents">
...
2 seconds elapsed
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Feio.examples%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=eio.examples&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eio.examples.php">＋<small>add a note</small></a></span>
