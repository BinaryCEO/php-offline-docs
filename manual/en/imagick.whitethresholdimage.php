...
<head>
  ...
  <title>PHP: Imagick::whiteThresholdImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.whitethresholdimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.whitethresholdimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.whitethresholdimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.waveimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.writeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.whitethresholdimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.whitethresholdimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.whitethresholdimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.whitethresholdimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.whitethresholdimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.whitethresholdimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.whitethresholdimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.whitethresholdimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.whitethresholdimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.whitethresholdimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.whitethresholdimage.php" hreflang="zh">
...
<meta name="Description" content="Force all pixels above the threshold into white" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::whiteThresholdImage - Manual" />
<meta name="twitter:description" content="Force all pixels above the threshold into white" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::whiteThresholdImage - Manual" />
<meta itemprop="description" content="Force all pixels above the threshold into white" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Force all pixels above the threshold into white" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.writeimage.php">
          Imagick::writeImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.waveimage.php">
          &laquo; Imagick::waveImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.whitethresholdimage.php' selected="selected">English</option>
            <option value='de/imagick.whitethresholdimage.php'>German</option>
            <option value='es/imagick.whitethresholdimage.php'>Spanish</option>
            <option value='fr/imagick.whitethresholdimage.php'>French</option>
            <option value='it/imagick.whitethresholdimage.php'>Italian</option>
            <option value='ja/imagick.whitethresholdimage.php'>Japanese</option>
            <option value='pt_BR/imagick.whitethresholdimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.whitethresholdimage.php'>Russian</option>
            <option value='tr/imagick.whitethresholdimage.php'>Turkish</option>
            <option value='uk/imagick.whitethresholdimage.php'>Ukrainian</option>
            <option value='zh/imagick.whitethresholdimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.whitethresholdimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::whiteThresholdImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::whiteThresholdImage</span> &mdash; <span class="dc-title">Force all pixels above the threshold into white</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.whitethresholdimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::whiteThresholdImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$threshold</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.whitethresholdimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.whitethresholdimage-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-imagick.whitethresholdimage-changelog">
  ...
  <p class="para">
    <div class="example" id="example-3144">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/whitethresholdimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.whitethresholdimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.whitethresholdimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.whitethresholdimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="87328">  <div class="votes">
    <div id="Vu87328">
    <a href="/manual/vote-note.php?id=87328&amp;page=imagick.whitethresholdimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd87328">
    <a href="/manual/vote-note.php?id=87328&amp;page=imagick.whitethresholdimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V87328" title="50% like this...">
    0
    </div>
  </div>
  <a href="#87328" class="name">
  <strong class="user"><em>elmer at web-axis dot net</em></strong></a><a class="genanchor" href="#87328"> &para;</a><div class="date" title="2008-11-30 03:32"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom87328">
<div class="phpcode"><code><span class="html">Here's a example of this function:
<br />
<br /><span class="default">&lt;?php
<br />  $img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();
<br />  </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$image_file_name</span><span class="keyword">);
<br />  </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">whiteThresholdImage</span><span class="keyword">(</span><span class="string">'grey'</span><span class="keyword">);
<br />  </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">$thumb_file_name</span><span class="keyword">);
<br />  </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">clear</span><span class="keyword">();
<br />  </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">();
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.whitethresholdimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.whitethresholdimage.php">＋<small>add a note</small></a></div>
