...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionfunctionabstract.getreturntype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionfunctionabstract.getreturntype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionfunctionabstract.getreturntype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionfunctionabstract.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionfunctionabstract.getparameters.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionfunctionabstract.getshortname.php">
...
<meta name="Description" content="Gets the specified return type of a function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionFunctionAbstract::getReturnType - Manual" />
<meta name="twitter:description" content="Gets the specified return type of a function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionFunctionAbstract::getReturnType - Manual" />
<meta itemprop="description" content="Gets the specified return type of a function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the specified return type of a function" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionfunctionabstract.getreturntype.php' selected="selected">English</option>
            ...
            <option value='pt_BR/reflectionfunctionabstract.getreturntype.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionFunctionAbstract::getReturnType</span> &mdash; <span class="dc-title">Gets the specified return type of a function</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionfunctionabstract.getreturntype-returnvalues">
  ...
  <p class="para">
   Returns a <span class="classname"><a href="class.reflectiontype.php" class="classname">ReflectionType</a></span> object if a return type is
 ...
 <div class="refsect1 examples" id="refsect1-reflectionfunctionabstract.getreturntype-examples">
  ...
  <p class="para">
   <div class="example" id="example-5559">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionFunctionAbstract::getReturnType()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectiontype.tostring.php" class="methodname" rel="rdfs-seeAlso">ReflectionType::__toString()</a> - To string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionfunctionabstract/getreturntype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionfunctionabstract.getreturntype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionfunctionabstract.getreturntype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionfunctionabstract.getreturntype.php">＋<small>add a note</small></a></span>
