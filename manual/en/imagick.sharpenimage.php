...
<head>
  ...
  <title>PHP: Imagick::sharpenImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.sharpenimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.sharpenimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.sharpenimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.shadowimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.shaveimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.sharpenimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.sharpenimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.sharpenimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.sharpenimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.sharpenimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.sharpenimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.sharpenimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.sharpenimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.sharpenimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.sharpenimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.sharpenimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::sharpenImage - Manual" />
<meta name="twitter:description" content="Sharpens an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::sharpenImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.shaveimage.php">
          Imagick::shaveImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.shadowimage.php">
          &laquo; Imagick::shadowImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.sharpenimage.php' selected="selected">English</option>
            <option value='de/imagick.sharpenimage.php'>German</option>
            <option value='es/imagick.sharpenimage.php'>Spanish</option>
            <option value='fr/imagick.sharpenimage.php'>French</option>
            <option value='it/imagick.sharpenimage.php'>Italian</option>
            <option value='ja/imagick.sharpenimage.php'>Japanese</option>
            <option value='pt_BR/imagick.sharpenimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.sharpenimage.php'>Russian</option>
            <option value='tr/imagick.sharpenimage.php'>Turkish</option>
            <option value='uk/imagick.sharpenimage.php'>Ukrainian</option>
            <option value='zh/imagick.sharpenimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.sharpenimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::sharpenImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::sharpenImage</span> &mdash; <span class="dc-title">Sharpens an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.sharpenimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::sharpenImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$sigma</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   0 and <span class="function"><strong>Imagick::sharpenImage()</strong></span> selects a suitable radius
   for you.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.sharpenimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.sharpenimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3112">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/sharpenimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.sharpenimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.sharpenimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.sharpenimage.php">＋<small>add a note</small></a></span>
