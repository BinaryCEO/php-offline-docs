...
<head>
  ...
  <title>PHP: Introduction to PECL Installations - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/install.pecl.intro.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/install.pecl.intro.php">
 <link rel="alternate" href="https://www.php.net/manual/en/install.pecl.intro.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/install.pecl.php">
 <link rel="prev" href="https://www.php.net/manual/en/install.pecl.php">
 <link rel="next" href="https://www.php.net/manual/en/install.pecl.downloads.php">

 <link rel="alternate" href="https://www.php.net/manual/en/install.pecl.intro.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/install.pecl.intro.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/install.pecl.intro.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/install.pecl.intro.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/install.pecl.intro.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/install.pecl.intro.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/install.pecl.intro.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/install.pecl.intro.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/install.pecl.intro.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/install.pecl.intro.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/install.pecl.intro.php" hreflang="zh">
...
<meta name="Description" content="Introduction to PECL Installations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Introduction to PECL Installations - Manual" />
<meta name="twitter:description" content="Introduction to PECL Installations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Introduction to PECL Installations - Manual" />
<meta itemprop="description" content="Introduction to PECL Installations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Introduction to PECL Installations" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="install.pecl.downloads.php">
          Downloading PECL extensions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="install.pecl.php">
          &laquo; Installation of PECL extensions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/install.pecl.intro.php' selected="selected">English</option>
            <option value='de/install.pecl.intro.php'>German</option>
            <option value='es/install.pecl.intro.php'>Spanish</option>
            <option value='fr/install.pecl.intro.php'>French</option>
            <option value='it/install.pecl.intro.php'>Italian</option>
            <option value='ja/install.pecl.intro.php'>Japanese</option>
            <option value='pt_BR/install.pecl.intro.php'>Brazilian Portuguese</option>
            <option value='ru/install.pecl.intro.php'>Russian</option>
            <option value='tr/install.pecl.intro.php'>Turkish</option>
            <option value='uk/install.pecl.intro.php'>Ukrainian</option>
            <option value='zh/install.pecl.intro.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="install.pecl.intro" class="sect1">
  ...
  <p class="simpara">
   ...
   for details on the required tools and required versions.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Finstall.pecl.intro%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=install.pecl.intro&amp;repo=en&amp;redirect=https://www.php.net/manual/en/install.pecl.intro.php">＋<small>add a note</small></a></span>
