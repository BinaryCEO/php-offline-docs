...
<head>
  ...
  <title>PHP: Imagick::clear - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.clear.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.clear.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clear.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.clampimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.clipimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clear.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.clear.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.clear.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.clear.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.clear.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.clear.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.clear.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.clear.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.clear.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.clear.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.clear.php" hreflang="zh">
...
<meta name="Description" content="Clears all resources associated to Imagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::clear - Manual" />
<meta name="twitter:description" content="Clears all resources associated to Imagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::clear - Manual" />
<meta itemprop="description" content="Clears all resources associated to Imagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clears all resources associated to Imagick object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.clipimage.php">
          Imagick::clipImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.clampimage.php">
          &laquo; Imagick::clampImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.clear.php' selected="selected">English</option>
            <option value='de/imagick.clear.php'>German</option>
            <option value='es/imagick.clear.php'>Spanish</option>
            <option value='fr/imagick.clear.php'>French</option>
            <option value='it/imagick.clear.php'>Italian</option>
            <option value='ja/imagick.clear.php'>Japanese</option>
            <option value='pt_BR/imagick.clear.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.clear.php'>Russian</option>
            <option value='tr/imagick.clear.php'>Turkish</option>
            <option value='uk/imagick.clear.php'>Ukrainian</option>
            <option value='zh/imagick.clear.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.clear" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::clear</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::clear</span> &mdash; <span class="dc-title">Clears all resources associated to Imagick object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.clear-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::clear</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.clear-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.clear-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/clear.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.clear%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.clear&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.clear.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114556">  <div class="votes">
    <div id="Vu114556">
    <a href="/manual/vote-note.php?id=114556&amp;page=imagick.clear&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114556">
    <a href="/manual/vote-note.php?id=114556&amp;page=imagick.clear&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114556" title="75% like this...">
    20
    </div>
  </div>
  <a href="#114556" class="name">
  <strong class="user"><em>kd0bpv at gmail dot com</em></strong></a><a class="genanchor" href="#114556"> &para;</a><div class="date" title="2014-03-05 10:31"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114556">
<div class="phpcode"><code><span class="html">Imagick::destroy() has been deprecated in favor of Imagick::clear().</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.clear&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.clear.php">＋<small>add a note</small></a></div>
