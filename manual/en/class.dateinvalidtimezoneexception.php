...
<head>
  ...
  <title>PHP: DateInvalidTimeZoneException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dateinvalidtimezoneexception.php">
 <link rel="shorturl" href="https://www.php.net/dateinvalidtimezoneexception">
 <link rel="alternate" href="https://www.php.net/dateinvalidtimezoneexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dateinvalidoperationexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.datemalformedintervalstringexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dateinvalidtimezoneexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dateinvalidtimezoneexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dateinvalidtimezoneexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dateinvalidtimezoneexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dateinvalidtimezoneexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dateinvalidtimezoneexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dateinvalidtimezoneexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dateinvalidtimezoneexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dateinvalidtimezoneexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dateinvalidtimezoneexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dateinvalidtimezoneexception.php" hreflang="zh">
...
<meta name="Description" content="The DateInvalidTimeZoneException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateInvalidTimeZoneException - Manual" />
<meta name="twitter:description" content="The DateInvalidTimeZoneException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateInvalidTimeZoneException - Manual" />
<meta itemprop="description" content="The DateInvalidTimeZoneException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DateInvalidTimeZoneException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.datemalformedintervalstringexception.php">
          DateMalformedIntervalStringException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dateinvalidoperationexception.php">
          &laquo; DateInvalidOperationException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dateinvalidtimezoneexception.php' selected="selected">English</option>
            <option value='de/class.dateinvalidtimezoneexception.php'>German</option>
            <option value='es/class.dateinvalidtimezoneexception.php'>Spanish</option>
            <option value='fr/class.dateinvalidtimezoneexception.php'>French</option>
            <option value='it/class.dateinvalidtimezoneexception.php'>Italian</option>
            <option value='ja/class.dateinvalidtimezoneexception.php'>Japanese</option>
            <option value='pt_BR/class.dateinvalidtimezoneexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.dateinvalidtimezoneexception.php'>Russian</option>
            <option value='tr/class.dateinvalidtimezoneexception.php'>Turkish</option>
            <option value='uk/class.dateinvalidtimezoneexception.php'>Ukrainian</option>
            <option value='zh/class.dateinvalidtimezoneexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dateinvalidtimezoneexception" class="reference">
 <h1 class="title">The DateInvalidTimeZoneException class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.3.0)</p>


  <div class="section" id="dateinvalidtimezoneexception.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    Thrown when an incorrect value is passed to
    <span class="methodname"><a href="datetimezone.construct.php" class="methodname">DateTimeZone::__construct()</a></span>.
   </p>
  </div>


  <div class="section" id="dateinvalidtimezoneexception.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">DateInvalidTimeZoneException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/dateinvalidtimezoneexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dateinvalidtimezoneexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dateinvalidtimezoneexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dateinvalidtimezoneexception.php">＋<small>add a note</small></a></span>
