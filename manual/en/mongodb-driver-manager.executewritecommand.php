...
<head>
  ...
  <title>PHP: MongoDB\Driver\Manager::executeWriteCommand - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-manager.executewritecommand.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-manager.executewritecommand.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.executewritecommand.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-manager.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-manager.executereadwritecommand.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-manager.getencryptedfieldsmap.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.executewritecommand.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-manager.executewritecommand.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-manager.executewritecommand.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-manager.executewritecommand.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-manager.executewritecommand.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-manager.executewritecommand.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-manager.executewritecommand.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-manager.executewritecommand.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-manager.executewritecommand.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-manager.executewritecommand.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-manager.executewritecommand.php" hreflang="zh">
...
<meta name="Description" content="Execute a database command that writes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Manager::executeWriteCommand - Manual" />
<meta name="twitter:description" content="Execute a database command that writes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Manager::executeWriteCommand - Manual" />
<meta itemprop="description" content="Execute a database command that writes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Execute a database command that writes" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-manager.getencryptedfieldsmap.php">
          MongoDB\Driver\Manager::getEncryptedFieldsMap &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-manager.executereadwritecommand.php">
          &laquo; MongoDB\Driver\Manager::executeReadWriteCommand        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-manager.executewritecommand.php' selected="selected">English</option>
            <option value='de/mongodb-driver-manager.executewritecommand.php'>German</option>
            <option value='es/mongodb-driver-manager.executewritecommand.php'>Spanish</option>
            <option value='fr/mongodb-driver-manager.executewritecommand.php'>French</option>
            <option value='it/mongodb-driver-manager.executewritecommand.php'>Italian</option>
            <option value='ja/mongodb-driver-manager.executewritecommand.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-manager.executewritecommand.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-manager.executewritecommand.php'>Russian</option>
            <option value='tr/mongodb-driver-manager.executewritecommand.php'>Turkish</option>
            <option value='uk/mongodb-driver-manager.executewritecommand.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-manager.executewritecommand.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-manager.executewritecommand" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="mongodb-driver-server.executewritecommand.php" class="function" rel="rdfs-seeAlso">MongoDB\Driver\Server::executeWriteCommand()</a> - Execute a database command that writes on this server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/manager/executewritecommand.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-manager.executewritecommand%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-manager.executewritecommand&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-manager.executewritecommand.php">＋<small>add a note</small></a></span>
