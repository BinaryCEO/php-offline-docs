...
<head>
  ...
  <title>PHP: eio_cancel - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-cancel.php">
 <link rel="shorturl" href="https://www.php.net/eio-cancel">
 <link rel="alternate" href="https://www.php.net/eio-cancel" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-busy.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-chmod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-cancel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-cancel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-cancel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-cancel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-cancel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-cancel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-cancel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-cancel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-cancel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-cancel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-cancel.php" hreflang="zh">
...
<meta name="Description" content="Cancels a request" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_cancel - Manual" />
<meta name="twitter:description" content="Cancels a request" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_cancel - Manual" />
<meta itemprop="description" content="Cancels a request" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Cancels a request" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-cancel.php' selected="selected">English</option>
            <option value='de/function.eio-cancel.php'>German</option>
            <option value='es/function.eio-cancel.php'>Spanish</option>
            <option value='fr/function.eio-cancel.php'>French</option>
            <option value='it/function.eio-cancel.php'>Italian</option>
            <option value='ja/function.eio-cancel.php'>Japanese</option>
            <option value='pt_BR/function.eio-cancel.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-cancel.php'>Russian</option>
            <option value='tr/function.eio-cancel.php'>Turkish</option>
            <option value='uk/function.eio-cancel.php'>Ukrainian</option>
            <option value='zh/function.eio-cancel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-cancel" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-cancel-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_cancel</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$req</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-grp-cancel.php" class="function" rel="rdfs-seeAlso">eio_grp_cancel()</a> - Cancels a request group</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-cancel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-cancel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-cancel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-cancel.php">＋<small>add a note</small></a></span>
