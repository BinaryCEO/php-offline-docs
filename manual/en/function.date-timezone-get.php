...
<head>
  ...
  <title>PHP: date_timezone_get - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-timezone-get.php">
 <link rel="shorturl" href="https://www.php.net/date-timezone-get">
 <link rel="alternate" href="https://www.php.net/date-timezone-get" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-timestamp-set.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-timezone-set.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-timezone-get.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-timezone-get.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-timezone-get.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-timezone-get.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-timezone-get.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-timezone-get.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-timezone-get.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-timezone-get.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-timezone-get.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-timezone-get.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-timezone-get.php" hreflang="zh">
...
<meta name="Description" content="Alias of DateTime::getTimezone" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_timezone_get - Manual" />
<meta name="twitter:description" content="Alias of DateTime::getTimezone" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_timezone_get - Manual" />
<meta itemprop="description" content="Alias of DateTime::getTimezone" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTime::getTimezone" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.date-timezone-set.php">
          date_timezone_set &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.date-timestamp-set.php">
          &laquo; date_timestamp_set        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-timezone-get.php' selected="selected">English</option>
            <option value='de/function.date-timezone-get.php'>German</option>
            <option value='es/function.date-timezone-get.php'>Spanish</option>
            <option value='fr/function.date-timezone-get.php'>French</option>
            <option value='it/function.date-timezone-get.php'>Italian</option>
            <option value='ja/function.date-timezone-get.php'>Japanese</option>
            <option value='pt_BR/function.date-timezone-get.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-timezone-get.php'>Russian</option>
            <option value='tr/function.date-timezone-get.php'>Turkish</option>
            <option value='uk/function.date-timezone-get.php'>Ukrainian</option>
            <option value='zh/function.date-timezone-get.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-timezone-get" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">date_timezone_get</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">date_timezone_get</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetime.gettimezone.php" class="methodname">DateTime::getTimezone()</a></span></span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.date-timezone-get-description">
  ...
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetime.gettimezone.php" class="methodname">DateTime::getTimezone()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-timezone-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-timezone-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-timezone-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-timezone-get.php">＋<small>add a note</small></a></span>
