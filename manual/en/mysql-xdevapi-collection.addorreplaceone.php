...
<head>
  ...
  <title>PHP: Collection::addOrReplaceOne - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-collection.addorreplaceone.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-collection.addorreplaceone.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collection.addorreplaceone.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-collection.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-collection.add.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-collection.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collection.addorreplaceone.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysql-xdevapi-collection.addorreplaceone.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysql-xdevapi-collection.addorreplaceone.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysql-xdevapi-collection.addorreplaceone.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysql-xdevapi-collection.addorreplaceone.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysql-xdevapi-collection.addorreplaceone.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysql-xdevapi-collection.addorreplaceone.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysql-xdevapi-collection.addorreplaceone.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysql-xdevapi-collection.addorreplaceone.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysql-xdevapi-collection.addorreplaceone.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysql-xdevapi-collection.addorreplaceone.php" hreflang="zh">
...
<meta name="Description" content="Add or replace collection document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Collection::addOrReplaceOne - Manual" />
<meta name="twitter:description" content="Add or replace collection document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Collection::addOrReplaceOne - Manual" />
<meta itemprop="description" content="Add or replace collection document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add or replace collection document" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysql-xdevapi-collection.construct.php">
          Collection::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysql-xdevapi-collection.add.php">
          &laquo; Collection::add        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-collection.addorreplaceone.php' selected="selected">English</option>
            <option value='de/mysql-xdevapi-collection.addorreplaceone.php'>German</option>
            <option value='es/mysql-xdevapi-collection.addorreplaceone.php'>Spanish</option>
            <option value='fr/mysql-xdevapi-collection.addorreplaceone.php'>French</option>
            <option value='it/mysql-xdevapi-collection.addorreplaceone.php'>Italian</option>
            <option value='ja/mysql-xdevapi-collection.addorreplaceone.php'>Japanese</option>
            <option value='pt_BR/mysql-xdevapi-collection.addorreplaceone.php'>Brazilian Portuguese</option>
            <option value='ru/mysql-xdevapi-collection.addorreplaceone.php'>Russian</option>
            <option value='tr/mysql-xdevapi-collection.addorreplaceone.php'>Turkish</option>
            <option value='uk/mysql-xdevapi-collection.addorreplaceone.php'>Ukrainian</option>
            <option value='zh/mysql-xdevapi-collection.addorreplaceone.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysql-xdevapi-collection.addorreplaceone" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-mysql-xdevapi-collection.addorreplaceone-examples">
  ...
  <div class="example" id="example-1693">
   <p><strong>Example #1 <span class="function"><strong>mysql_xdevapi\Collection::addOrReplaceOne()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$session </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_xdevapi\getSession</span><span style="color: #007700">(</span><span style="color: #DD0000">"mysqlx://user:password@localhost"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$session</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">sql</span><span style="color: #007700">(</span><span style="color: #DD0000">"DROP DATABASE IF EXISTS addressbook"</span><span style="color: #007700">)-&gt;</span><span style="color: #0000BB">execute</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$session</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">sql</span><span style="color: #007700">(</span><span style="color: #DD0000">"CREATE DATABASE addressbook"</span><span style="color: #007700">)-&gt;</span><span style="color: #0000BB">execute</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$schema </span><span style="color: #007700">= </span><span style="color: #0000BB">$session</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getSchema</span><span style="color: #007700">(</span><span style="color: #DD0000">"addressbook"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$create </span><span style="color: #007700">= </span><span style="color: #0000BB">$schema</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">createCollection</span><span style="color: #007700">(</span><span style="color: #DD0000">"people"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$collection </span><span style="color: #007700">= </span><span style="color: #0000BB">$schema</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCollection</span><span style="color: #007700">(</span><span style="color: #DD0000">"people"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Using add()<br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">$collection</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">add</span><span style="color: #007700">(</span><span style="color: #DD0000">'{"name": "Wilma", "age": 23, "job": "Teacher"}'</span><span style="color: #007700">)-&gt;</span><span style="color: #0000BB">execute</span><span style="color: #007700">();<br /><br /></span><span style="color: #FF8000">// Using addOrReplaceOne()<br />// Note: we're passing in a known _id value here<br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">$collection</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addOrReplaceOne</span><span style="color: #007700">(</span><span style="color: #DD0000">'00005b6b53610000000000000056'</span><span style="color: #007700">, </span><span style="color: #DD0000">'{"name": "Fred",  "age": 21, "job": "Construction"}'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/collection/addorreplaceone.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-collection.addorreplaceone%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-collection.addorreplaceone&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-collection.addorreplaceone.php">＋<small>add a note</small></a></span>
