...
<head>
  ...
  <title>PHP: ImagickDraw::setStrokeDashArray - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setstrokedasharray.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setstrokedasharray.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokedasharray.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setstrokecolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setstrokedashoffset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokedasharray.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setstrokedasharray.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setstrokedasharray.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setstrokedasharray.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setstrokedasharray.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setstrokedasharray.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setstrokedasharray.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setstrokedasharray.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setstrokedasharray.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setstrokedasharray.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setstrokedasharray.php" hreflang="zh">
...
<meta name="Description" content="Specifies the pattern of dashes and gaps used to stroke paths" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setStrokeDashArray - Manual" />
<meta name="twitter:description" content="Specifies the pattern of dashes and gaps used to stroke paths" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setStrokeDashArray - Manual" />
<meta itemprop="description" content="Specifies the pattern of dashes and gaps used to stroke paths" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the pattern of dashes and gaps used to stroke paths" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setstrokedashoffset.php">
          ImagickDraw::setStrokeDashOffset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setstrokecolor.php">
          &laquo; ImagickDraw::setStrokeColor        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setstrokedasharray.php' selected="selected">English</option>
            <option value='de/imagickdraw.setstrokedasharray.php'>German</option>
            <option value='es/imagickdraw.setstrokedasharray.php'>Spanish</option>
            <option value='fr/imagickdraw.setstrokedasharray.php'>French</option>
            <option value='it/imagickdraw.setstrokedasharray.php'>Italian</option>
            <option value='ja/imagickdraw.setstrokedasharray.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setstrokedasharray.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setstrokedasharray.php'>Russian</option>
            <option value='tr/imagickdraw.setstrokedasharray.php'>Turkish</option>
            <option value='uk/imagickdraw.setstrokedasharray.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setstrokedasharray.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setstrokedasharray" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setStrokeDashArray</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setStrokeDashArray</span> &mdash; <span class="dc-title">Specifies the pattern of dashes and gaps used to stroke paths</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setstrokedasharray-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setStrokeDashArray</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.array.php" class="type array">array</a></span></span> <code class="parameter">$dashes</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setstrokedasharray-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">dashes</code></dt>
     <dd>
      <p class="para">
       array of floats
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setstrokedasharray-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3184">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setstrokedasharray.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setstrokedasharray%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setstrokedasharray&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokedasharray.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123691">  <div class="votes">
    <div id="Vu123691">
    <a href="/manual/vote-note.php?id=123691&amp;page=imagickdraw.setstrokedasharray&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123691">
    <a href="/manual/vote-note.php?id=123691&amp;page=imagickdraw.setstrokedasharray&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123691" title="66% like this...">
    1
    </div>
  </div>
  <a href="#123691" class="name">
  <strong class="user"><em>KV</em></strong></a><a class="genanchor" href="#123691"> &para;</a><div class="date" title="2019-03-13 02:47"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123691">
<div class="phpcode"><code><span class="html">To remove the dash and switch back to solid line, provide an array with a null value in it for $dashArray.<br /><br />-&gt;setStrokeDashArray( [null] );</span></code></div>
  </div>
 </div>
  <div class="note" id="86497">  <div class="votes">
    <div id="Vu86497">
    <a href="/manual/vote-note.php?id=86497&amp;page=imagickdraw.setstrokedasharray&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd86497">
    <a href="/manual/vote-note.php?id=86497&amp;page=imagickdraw.setstrokedasharray&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V86497" title="100% like this...">
    1
    </div>
  </div>
  <a href="#86497" class="name">
  <strong class="user"><em>andrew at ierbsolutions dot co dot uk</em></strong></a><a class="genanchor" href="#86497"> &para;</a><div class="date" title="2008-10-22 02:11"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86497">
<div class="phpcode"><code><span class="html">Example:<br /><br /><span class="default">&lt;?php<br />$base_image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'example.png'</span><span class="keyword">);<br /></span><span class="default">$rect </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();<br /></span><span class="default">$rect</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">"#EEEEEE"</span><span class="keyword">));<br /></span><span class="default">$rect</span><span class="keyword">-&gt;</span><span class="default">setFillOpacity</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">$rect</span><span class="keyword">-&gt;</span><span class="default">setStrokeColor</span><span class="keyword">(new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">"#FF0000"</span><span class="keyword">));<br /></span><span class="default">$rect</span><span class="keyword">-&gt;</span><span class="default">setStrokeDashArray</span><span class="keyword">(array(</span><span class="default">5</span><span class="keyword">,</span><span class="default">5</span><span class="keyword">,</span><span class="default">5</span><span class="keyword">));<br /></span><span class="default">$rect</span><span class="keyword">-&gt;</span><span class="default">rectangle</span><span class="keyword">(</span><span class="default">10</span><span class="keyword">, </span><span class="default">10</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">);<br /></span><span class="default">$base_image</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">(</span><span class="default">$rect</span><span class="keyword">);<br /><br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'Content-type: image/png'</span><span class="keyword">);<br />echo </span><span class="default">$base_image</span><span class="keyword">-&gt;</span><span class="default">getImage</span><span class="keyword">();<br />exit();<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.setstrokedasharray&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokedasharray.php">＋<small>add a note</small></a></div>
