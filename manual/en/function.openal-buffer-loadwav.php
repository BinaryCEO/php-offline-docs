...
<head>
  ...
  <title>PHP: openal_buffer_loadwav - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openal-buffer-loadwav.php">
 <link rel="shorturl" href="https://www.php.net/openal-buffer-loadwav">
 <link rel="alternate" href="https://www.php.net/openal-buffer-loadwav" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openal.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openal-buffer-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openal-context-create.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openal-buffer-loadwav.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openal-buffer-loadwav.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openal-buffer-loadwav.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openal-buffer-loadwav.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openal-buffer-loadwav.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openal-buffer-loadwav.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openal-buffer-loadwav.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openal-buffer-loadwav.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openal-buffer-loadwav.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openal-buffer-loadwav.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openal-buffer-loadwav.php" hreflang="zh">
...
<meta name="Description" content="Load a .wav file into a buffer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openal_buffer_loadwav - Manual" />
<meta name="twitter:description" content="Load a .wav file into a buffer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openal_buffer_loadwav - Manual" />
<meta itemprop="description" content="Load a .wav file into a buffer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Load a .wav file into a buffer" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openal-context-create.php">
          openal_context_create &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openal-buffer-get.php">
          &laquo; openal_buffer_get        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openal-buffer-loadwav.php' selected="selected">English</option>
            <option value='de/function.openal-buffer-loadwav.php'>German</option>
            <option value='es/function.openal-buffer-loadwav.php'>Spanish</option>
            <option value='fr/function.openal-buffer-loadwav.php'>French</option>
            <option value='it/function.openal-buffer-loadwav.php'>Italian</option>
            <option value='ja/function.openal-buffer-loadwav.php'>Japanese</option>
            <option value='pt_BR/function.openal-buffer-loadwav.php'>Brazilian Portuguese</option>
            <option value='ru/function.openal-buffer-loadwav.php'>Russian</option>
            <option value='tr/function.openal-buffer-loadwav.php'>Turkish</option>
            <option value='uk/function.openal-buffer-loadwav.php'>Ukrainian</option>
            <option value='zh/function.openal-buffer-loadwav.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openal-buffer-loadwav" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.openal-stream.php" class="function" rel="rdfs-seeAlso">openal_stream()</a> - Begin streaming on a source</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openal/functions/openal-buffer-loadwav.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openal-buffer-loadwav%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openal-buffer-loadwav&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openal-buffer-loadwav.php">＋<small>add a note</small></a></span>
