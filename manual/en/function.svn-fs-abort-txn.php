...
<head>
  ...
  <title>PHP: svn_fs_abort_txn - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-fs-abort-txn.php">
 <link rel="shorturl" href="https://www.php.net/svn-fs-abort-txn">
 <link rel="alternate" href="https://www.php.net/svn-fs-abort-txn" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-export.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-fs-apply-text.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-fs-abort-txn.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-fs-abort-txn.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-fs-abort-txn.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-fs-abort-txn.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-fs-abort-txn.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-fs-abort-txn.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-fs-abort-txn.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-fs-abort-txn.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-fs-abort-txn.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-fs-abort-txn.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-fs-abort-txn.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: svn_fs_abort_txn - Manual" />
<meta name="twitter:description" content="Aborts a transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_fs_abort_txn - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.svn-fs-apply-text.php">
          svn_fs_apply_text &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.svn-export.php">
          &laquo; svn_export        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-fs-abort-txn.php' selected="selected">English</option>
            <option value='de/function.svn-fs-abort-txn.php'>German</option>
            <option value='es/function.svn-fs-abort-txn.php'>Spanish</option>
            <option value='fr/function.svn-fs-abort-txn.php'>French</option>
            <option value='it/function.svn-fs-abort-txn.php'>Italian</option>
            <option value='ja/function.svn-fs-abort-txn.php'>Japanese</option>
            <option value='pt_BR/function.svn-fs-abort-txn.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-fs-abort-txn.php'>Russian</option>
            <option value='tr/function.svn-fs-abort-txn.php'>Turkish</option>
            <option value='uk/function.svn-fs-abort-txn.php'>Ukrainian</option>
            <option value='zh/function.svn-fs-abort-txn.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-fs-abort-txn" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">svn_fs_abort_txn</h1>
  <p class="verinfo">(PECL svn &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">svn_fs_abort_txn</span> &mdash; <span class="dc-title">Aborts a transaction</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.svn-fs-abort-txn-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>svn_fs_abort_txn</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$txn</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.svn-fs-abort-txn-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">txn</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.svn-fs-abort-txn-returnvalues">
 ...
 <div class="refsect1 notes" id="refsect1-function.svn-fs-abort-txn-notes">
...
This function should be used at your own risk.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-fs-abort-txn.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-fs-abort-txn%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-fs-abort-txn&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-fs-abort-txn.php">＋<small>add a note</small></a></span>
