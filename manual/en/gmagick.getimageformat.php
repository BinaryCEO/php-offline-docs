...
<head>
  ...
  <title>PHP: Gmagick::getimageformat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimageformat.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimageformat.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageformat.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagefilename.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagegamma.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageformat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimageformat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimageformat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimageformat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimageformat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimageformat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimageformat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimageformat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimageformat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimageformat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimageformat.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimageformat - Manual" />
<meta name="twitter:description" content="Returns the format of a particular image in a sequence" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimageformat - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimagegamma.php">
          Gmagick::getimagegamma &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagefilename.php">
          &laquo; Gmagick::getimagefilename        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimageformat.php' selected="selected">English</option>
            <option value='de/gmagick.getimageformat.php'>German</option>
            <option value='es/gmagick.getimageformat.php'>Spanish</option>
            <option value='fr/gmagick.getimageformat.php'>French</option>
            <option value='it/gmagick.getimageformat.php'>Italian</option>
            <option value='ja/gmagick.getimageformat.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimageformat.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimageformat.php'>Russian</option>
            <option value='tr/gmagick.getimageformat.php'>Turkish</option>
            <option value='uk/gmagick.getimageformat.php'>Ukrainian</option>
            <option value='zh/gmagick.getimageformat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimageformat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimageformat</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimageformat</span> &mdash; <span class="dc-title">Returns the format of a particular image in a sequence</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimageformat-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimageformat</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimageformat-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimageformat-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimageformat-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimageformat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimageformat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimageformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimageformat.php">＋<small>add a note</small></a></span>
