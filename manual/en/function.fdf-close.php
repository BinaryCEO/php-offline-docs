...
<head>
  ...
  <title>PHP: fdf_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-close.php">
 <link rel="shorturl" href="https://www.php.net/fdf-close">
 <link rel="alternate" href="https://www.php.net/fdf-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-add-template.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-create.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdf-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdf-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdf-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdf-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdf-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdf-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdf-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdf-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdf-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdf-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdf-close.php" hreflang="zh">
...
<meta name="Description" content="Close an FDF document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_close - Manual" />
<meta name="twitter:description" content="Close an FDF document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_close - Manual" />
<meta itemprop="description" content="Close an FDF document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close an FDF document" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-close.php' selected="selected">English</option>
            <option value='de/function.fdf-close.php'>German</option>
            <option value='es/function.fdf-close.php'>Spanish</option>
            <option value='fr/function.fdf-close.php'>French</option>
            <option value='it/function.fdf-close.php'>Italian</option>
            <option value='ja/function.fdf-close.php'>Japanese</option>
            <option value='pt_BR/function.fdf-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdf-close.php'>Russian</option>
            <option value='tr/function.fdf-close.php'>Turkish</option>
            <option value='uk/function.fdf-close.php'>Ukrainian</option>
            <option value='zh/function.fdf-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdf-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fdf_close</h1>
  <p class="verinfo">(PHP 4, PHP 5 &lt; 5.3.0, PECL fdf SVN)</p><p class="refpurpose"><span class="refname">fdf_close</span> &mdash; <span class="dc-title">Close an FDF document</span></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fdf-open.php" class="function" rel="rdfs-seeAlso">fdf_open()</a> - Open a FDF document</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-close.php">＋<small>add a note</small></a></span>
