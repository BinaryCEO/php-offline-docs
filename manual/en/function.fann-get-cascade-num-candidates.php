...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-cascade-num-candidates.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-cascade-num-candidate-groups.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-cascade-output-change-fraction.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-cascade-num-candidates.php' selected="selected">English</option>
            ...
            <option value='tr/function.fann-get-cascade-num-candidates.php'>Turkish</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-get-cascade-num-candidate-groups.php" class="function" rel="rdfs-seeAlso">fann_get_cascade_num_candidate_groups()</a> - Returns the number of candidate groups</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-cascade-num-candidates.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-cascade-num-candidates%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-cascade-num-candidates&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-cascade-num-candidates.php">＋<small>add a note</small></a></span>
