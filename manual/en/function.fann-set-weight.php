...
<head>
  ...
  <title>PHP: fann_set_weight - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-weight.php">
 <link rel="shorturl" href="https://www.php.net/fann-set-weight">
 <link rel="alternate" href="https://www.php.net/fann-set-weight" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-training-algorithm.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-weight-array.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-set-weight.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-set-weight.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-set-weight.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-set-weight.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-set-weight.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-set-weight.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-set-weight.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-set-weight.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-set-weight.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-set-weight.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-set-weight.php" hreflang="zh">
...
<meta name="Description" content="Set a connection in the network" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_weight - Manual" />
<meta name="twitter:description" content="Set a connection in the network" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_weight - Manual" />
<meta itemprop="description" content="Set a connection in the network" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set a connection in the network" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-set-weight-array.php">
          fann_set_weight_array &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-set-training-algorithm.php">
          &laquo; fann_set_training_algorithm        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-weight.php' selected="selected">English</option>
            <option value='de/function.fann-set-weight.php'>German</option>
            <option value='es/function.fann-set-weight.php'>Spanish</option>
            <option value='fr/function.fann-set-weight.php'>French</option>
            <option value='it/function.fann-set-weight.php'>Italian</option>
            <option value='ja/function.fann-set-weight.php'>Japanese</option>
            <option value='pt_BR/function.fann-set-weight.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-set-weight.php'>Russian</option>
            <option value='tr/function.fann-set-weight.php'>Turkish</option>
            <option value='uk/function.fann-set-weight.php'>Ukrainian</option>
            <option value='zh/function.fann-set-weight.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-set-weight" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_set_weight</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_set_weight</span> &mdash; <span class="dc-title">Set a connection in the network</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-set-weight-returnvalues">
  ...
  <p class="para">Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-weight.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-weight%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-weight&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-weight.php">＋<small>add a note</small></a></span>
