...
<head>
  ...
  <title>PHP: SQLSRV Functions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/sqlsrv.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sqlsrv-begin-transaction.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ref.sqlsrv.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ref.sqlsrv.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ref.sqlsrv.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ref.sqlsrv.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ref.sqlsrv.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ref.sqlsrv.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ref.sqlsrv.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ref.sqlsrv.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ref.sqlsrv.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ref.sqlsrv.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ref.sqlsrv.php" hreflang="zh">
...
<meta name="Description" content="SQLSRV Functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SQLSRV Functions - Manual" />
<meta name="twitter:description" content="SQLSRV Functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SQLSRV Functions - Manual" />
<meta itemprop="description" content="SQLSRV Functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="SQLSRV Functions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sqlsrv-begin-transaction.php">
          sqlsrv_begin_transaction &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.sqlsrv.php' selected="selected">English</option>
            <option value='de/ref.sqlsrv.php'>German</option>
            <option value='es/ref.sqlsrv.php'>Spanish</option>
            <option value='fr/ref.sqlsrv.php'>French</option>
            <option value='it/ref.sqlsrv.php'>Italian</option>
            <option value='ja/ref.sqlsrv.php'>Japanese</option>
            <option value='pt_BR/ref.sqlsrv.php'>Brazilian Portuguese</option>
            <option value='ru/ref.sqlsrv.php'>Russian</option>
            <option value='tr/ref.sqlsrv.php'>Turkish</option>
            <option value='uk/ref.sqlsrv.php'>Ukrainian</option>
            <option value='zh/ref.sqlsrv.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ref.sqlsrv" class="reference">
 <h1 class="title">SQLSRV Functions</h1>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="function.sqlsrv-begin-transaction.php">sqlsrv_begin_transaction</a> — Begins a database transaction</li><li><a href="function.sqlsrv-cancel.php">sqlsrv_cancel</a> — Cancels a statement</li><li><a href="function.sqlsrv-client-info.php">sqlsrv_client_info</a> — Returns information about the client and specified connection</li><li><a href="function.sqlsrv-close.php">sqlsrv_close</a> — Closes an open connection and releases resourses associated with the connection</li><li><a href="function.sqlsrv-commit.php">sqlsrv_commit</a> — Commits a transaction that was begun with sqlsrv_begin_transaction</li><li><a href="function.sqlsrv-configure.php">sqlsrv_configure</a> — Changes the driver error handling and logging configurations</li><li><a href="function.sqlsrv-connect.php">sqlsrv_connect</a> — Opens a connection to a Microsoft SQL Server database</li><li><a href="function.sqlsrv-errors.php">sqlsrv_errors</a> — Returns error and warning information about the last SQLSRV operation performed</li><li><a href="function.sqlsrv-execute.php">sqlsrv_execute</a> — Executes a statement prepared with sqlsrv_prepare</li><li><a href="function.sqlsrv-fetch.php">sqlsrv_fetch</a> — Makes the next row in a result set available for reading</li><li><a href="function.sqlsrv-fetch-array.php">sqlsrv_fetch_array</a> — Returns a row as an array</li><li><a href="function.sqlsrv-fetch-object.php">sqlsrv_fetch_object</a> — Retrieves the next row of data in a result set as an object</li><li><a href="function.sqlsrv-field-metadata.php">sqlsrv_field_metadata</a> — Retrieves metadata for the fields of a statement prepared by 
  ...
  DELETE query executed</li><li><a href="function.sqlsrv-send-stream-data.php">sqlsrv_send_stream_data</a> — Sends data from parameter streams to the server</li><li><a href="function.sqlsrv-server-info.php">sqlsrv_server_info</a> — Returns information about the server</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlsrv/reference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fref.sqlsrv%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ref.sqlsrv&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.sqlsrv.php">＋<small>add a note</small></a></span>
