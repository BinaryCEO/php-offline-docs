...
<head>
  ...
  <title>PHP: radius_get_attr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.radius-get-attr.php">
 <link rel="shorturl" href="https://www.php.net/radius-get-attr">
 <link rel="alternate" href="https://www.php.net/radius-get-attr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.radius.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.radius-demangle-mppe-key.php">
 <link rel="next" href="https://www.php.net/manual/en/function.radius-get-tagged-attr-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.radius-get-attr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.radius-get-attr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.radius-get-attr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.radius-get-attr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.radius-get-attr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.radius-get-attr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.radius-get-attr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.radius-get-attr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.radius-get-attr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.radius-get-attr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.radius-get-attr.php" hreflang="zh">
...
<meta name="Description" content="Extracts an attribute" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: radius_get_attr - Manual" />
<meta name="twitter:description" content="Extracts an attribute" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: radius_get_attr - Manual" />
<meta itemprop="description" content="Extracts an attribute" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Extracts an attribute" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.radius-get-tagged-attr-data.php">
          radius_get_tagged_attr_data &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.radius-demangle-mppe-key.php">
          &laquo; radius_demangle_mppe_key        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.radius-get-attr.php' selected="selected">English</option>
            <option value='de/function.radius-get-attr.php'>German</option>
            <option value='es/function.radius-get-attr.php'>Spanish</option>
            <option value='fr/function.radius-get-attr.php'>French</option>
            <option value='it/function.radius-get-attr.php'>Italian</option>
            <option value='ja/function.radius-get-attr.php'>Japanese</option>
            <option value='pt_BR/function.radius-get-attr.php'>Brazilian Portuguese</option>
            <option value='ru/function.radius-get-attr.php'>Russian</option>
            <option value='tr/function.radius-get-attr.php'>Turkish</option>
            <option value='uk/function.radius-get-attr.php'>Ukrainian</option>
            <option value='zh/function.radius-get-attr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.radius-get-attr" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.radius-send-request.php" class="function" rel="rdfs-seeAlso">radius_send_request()</a> - Sends the request and waits for a reply</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/radius/functions/radius-get-attr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.radius-get-attr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.radius-get-attr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.radius-get-attr.php">＋<small>add a note</small></a></span>
