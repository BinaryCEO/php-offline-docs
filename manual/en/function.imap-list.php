...
<head>
  ...
  <title>PHP: imap_list - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-list.php">
 <link rel="shorturl" href="https://www.php.net/imap-list">
 <link rel="alternate" href="https://www.php.net/imap-list" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-last-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-listmailbox.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-list.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-list.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-list.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-list.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-list.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-list.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-list.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-list.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-list.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-list.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-list.php" hreflang="zh">
...
<meta name="Description" content="Read the list of mailboxes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_list - Manual" />
<meta name="twitter:description" content="Read the list of mailboxes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_list - Manual" />
<meta itemprop="description" content="Read the list of mailboxes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Read the list of mailboxes" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-listmailbox.php">
          imap_listmailbox &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-last-error.php">
          &laquo; imap_last_error        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-list.php' selected="selected">English</option>
            <option value='de/function.imap-list.php'>German</option>
            <option value='es/function.imap-list.php'>Spanish</option>
            <option value='fr/function.imap-list.php'>French</option>
            <option value='it/function.imap-list.php'>Italian</option>
            <option value='ja/function.imap-list.php'>Japanese</option>
            <option value='pt_BR/function.imap-list.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-list.php'>Russian</option>
            <option value='tr/function.imap-list.php'>Turkish</option>
            <option value='uk/function.imap-list.php'>Ukrainian</option>
            <option value='zh/function.imap-list.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-list" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_list</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_list</span> &mdash; <span class="dc-title">Read the list of mailboxes</span></p>
...
mailboxes; &#039;<code class="literal">~/mail/%</code>&#039; on <code class="literal">UW_IMAPD</code> will return every mailbox in the <var class="filename">~/mail</var> directory, but none in subfolders of that directory.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-list-returnvalues">
  ...
  <p class="para">
   Returns an array containing the names of the mailboxes or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> in case of failure.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$mbox </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_open</span><span style="color: #007700">(</span><span style="color: #DD0000">"{imap.example.org}"</span><span style="color: #007700">, </span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"password"</span><span style="color: #007700">, </span><span style="color: #0000BB">OP_HALFOPEN</span><span style="color: #007700">)<br />      or die(</span><span style="color: #DD0000">"can't connect: " </span><span style="color: #007700">. </span><span style="color: #0000BB">imap_last_error</span><span style="color: #007700">());<br /><br /></span><span style="color: #0000BB">$list </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_list</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">, </span><span style="color: #DD0000">"{imap.example.org}"</span><span style="color: #007700">, </span><span style="color: #DD0000">"*"</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">is_array</span><span style="color: #007700">(</span><span style="color: #0000BB">$list</span><span style="color: #007700">)) {<br />    foreach (</span><span style="color: #0000BB">$list </span><span style="color: #007700">as </span><span style="color: #0000BB">$val</span><span style="color: #007700">) {<br />        echo </span><span style="color: #0000BB">imap_utf7_decode</span><span style="color: #007700">(</span><span style="color: #0000BB">$val</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />    }<br />} else {<br />    echo </span><span style="color: #DD0000">"imap_list failed: " </span><span style="color: #007700">. </span><span style="color: #0000BB">imap_last_error</span><span style="color: #007700">() . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #0000BB">imap_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-list-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-getmailboxes.php" class="function" rel="rdfs-seeAlso">imap_getmailboxes()</a> - Read the list of mailboxes, returning detailed information on each one</span></li>
    <li><span class="function"><a href="function.imap-lsub.php" class="function" rel="rdfs-seeAlso">imap_lsub()</a> - List all the subscribed mailboxes</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-list.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-list%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-list&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-list.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123704">  <div class="votes">
    <div id="Vu123704">
    <a href="/manual/vote-note.php?id=123704&amp;page=function.imap-list&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123704">
    <a href="/manual/vote-note.php?id=123704&amp;page=function.imap-list&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123704" title="72% like this...">
    5
    </div>
  </div>
  <a href="#123704" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#123704"> &para;</a><div class="date" title="2019-03-19 09:56"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123704">
<div class="phpcode"><code><span class="html">use <br />echo mb_convert_encoding($val, "utf-8", "UTF7-IMAP");<br />for cyrrilic folder names</span></code></div>
  </div>
 </div>
  <div class="note" id="85764">  <div class="votes">
    <div id="Vu85764">
    <a href="/manual/vote-note.php?id=85764&amp;page=function.imap-list&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd85764">
    <a href="/manual/vote-note.php?id=85764&amp;page=function.imap-list&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V85764" title="66% like this...">
    2
    </div>
  </div>
  <a href="#85764" class="name">
  <strong class="user"><em>c6h1206free at gmail dot com</em></strong></a><a class="genanchor" href="#85764"> &para;</a><div class="date" title="2008-09-16 12:00"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom85764">
<div class="phpcode"><code><span class="html">imap_list returns a simple array of strings that look just like the $ref parameter one needs to specify:<br /><br /><span class="default">&lt;?php<br /><br />  $srv </span><span class="keyword">= </span><span class="string">'{imap.example.com}'</span><span class="keyword">;<br /><br />  </span><span class="default">$conn </span><span class="keyword">= </span><span class="default">imap_open</span><span class="keyword">(</span><span class="default">$srv</span><span class="keyword">, </span><span class="string">'me'</span><span class="keyword">, </span><span class="string">'mypass'</span><span class="keyword">);<br /><br />  </span><span class="default">$boxes </span><span class="keyword">= </span><span class="default">imap_list</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="default">$srv</span><span class="keyword">, </span><span class="string">'*'</span><span class="keyword">);<br /><br />  </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$boxes</span><span class="keyword">);<br />  </span><span class="default">imap_close</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Output:<br /><br />&lt;pre&gt;<br />Array<br />(<br />    [0] =&gt; {imap.example.com}Calendar<br />    [1] =&gt; {imap.example.com}Contacts<br />    [2] =&gt; {imap.example.com}Deleted Items<br />    [3] =&gt; {imap.example.com}Drafts<br />    [4] =&gt; {imap.example.com}Journal<br />    [5] =&gt; {imap.example.com}Junk E-mail<br />    [6] =&gt; {imap.example.com}Notes<br />    [7] =&gt; {imap.example.com}Outbox<br />    [8] =&gt; {imap.example.com}RSS Feeds<br />    [9] =&gt; {imap.example.com}Sent Items  <br />    [10] =&gt; {imap.example.com}Tasks<br />)<br />&lt;/pre&gt;<br /><br />These directly fill in the $ref argument for every function that takes one.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-list&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-list.php">＋<small>add a note</small></a></div>
