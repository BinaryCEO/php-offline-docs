...
<head>
  ...
  <title>PHP: Reading Attributes with the Reflection API - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.attributes.reflection.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/language.attributes.syntax.php">
 <link rel="next" href="https://www.php.net/manual/en/language.attributes.classes.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/ru/language.attributes.reflection.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.attributes.reflection.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.attributes.reflection.php" hreflang="uk">
...
<meta name="Description" content="Reading Attributes with the Reflection API" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Reading Attributes with the Reflection API - Manual" />
<meta name="twitter:description" content="Reading Attributes with the Reflection API" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Reading Attributes with the Reflection API - Manual" />
<meta itemprop="description" content="Reading Attributes with the Reflection API" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reading Attributes with the Reflection API" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="language.attributes.classes.php">
          Declaring Attribute Classes &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="language.attributes.syntax.php">
          &laquo; Attribute syntax        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.attributes.reflection.php' selected="selected">English</option>
            ...
            <option value='ru/language.attributes.reflection.php'>Russian</option>
            <option value='tr/language.attributes.reflection.php'>Turkish</option>
            <option value='uk/language.attributes.reflection.php'>Ukrainian</option>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #007700">function </span><span style="color: #0000BB">dumpMyAttributeData</span><span style="color: #007700">(</span><span style="color: #0000BB">$reflection</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$attributes </span><span style="color: #007700">= </span><span style="color: #0000BB">$reflection</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getAttributes</span><span style="color: #007700">(</span><span style="color: #0000BB">MyAttribute</span><span style="color: #007700">::class);<br /><br />    foreach (</span><span style="color: #0000BB">$attributes </span><span style="color: #007700">as </span><span style="color: #0000BB">$attribute</span><span style="color: #007700">) {<br />       </span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$attribute</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getName</span><span style="color: #007700">());<br />       </span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$attribute</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getArguments</span><span style="color: #007700">());<br />       </span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$attribute</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newInstance</span><span style="color: #007700">());<br />    }<br />}<br /><br /></span><span style="color: #0000BB">dumpMyAttributeData</span><span style="color: #007700">(new </span><span style="color: #0000BB">ReflectionClass</span><span style="color: #007700">(</span><span style="color: #0000BB">Thing</span><span style="color: #007700">::class));</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.attributes.reflection%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.attributes.reflection&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.attributes.reflection.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125889">  <div class="votes">
    <div id="Vu125889">
    <a href="/manual/vote-note.php?id=125889&amp;page=language.attributes.reflection&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125889">
    <a href="/manual/vote-note.php?id=125889&amp;page=language.attributes.reflection&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125889" title="60% like this...">
    7
    </div>
  </div>
  <a href="#125889" class="name">
  <strong class="user"><em>Hirusha Sharma</em></strong></a><a class="genanchor" href="#125889"> &para;</a><div class="date" title="2021-03-08 08:34"><strong>4 years ago</strong></div>
...
<div class="foot"><a href="/manual/add-note.php?sect=language.attributes.reflection&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.attributes.reflection.php">＋<small>add a note</small></a></div>
