...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.ibase.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.ibase.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.ibase.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.ibase.php">
 <link rel="next" href="https://www.php.net/manual/en/ibase.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.ibase.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.ibase.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.ibase.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.ibase.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.ibase.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.ibase.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.ibase.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.ibase.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.ibase.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.ibase.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.ibase.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.ibase.php' selected="selected">English</option>
            <option value='de/intro.ibase.php'>German</option>
            <option value='es/intro.ibase.php'>Spanish</option>
            <option value='fr/intro.ibase.php'>French</option>
            <option value='it/intro.ibase.php'>Italian</option>
            <option value='ja/intro.ibase.php'>Japanese</option>
            <option value='pt_BR/intro.ibase.php'>Brazilian Portuguese</option>
            <option value='ru/intro.ibase.php'>Russian</option>
            <option value='tr/intro.ibase.php'>Turkish</option>
            <option value='uk/intro.ibase.php'>Ukrainian</option>
            <option value='zh/intro.ibase.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.ibase" class="preface">
   ...
   <p class="para">
    This extension supports InterBase versions 6 and up and Firebird version 2.0 and up.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.ibase%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.ibase&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.ibase.php">＋<small>add a note</small></a></span>
