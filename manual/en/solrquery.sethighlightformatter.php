...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightFormatter - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightformatter.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightformatter.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightformatter.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightalternatefield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightfragmenter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightformatter.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightformatter.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightformatter.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightformatter.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightformatter.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightformatter.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightformatter.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightformatter.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightformatter.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightformatter.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightformatter.php" hreflang="zh">
...
<meta name="Description" content="Specify a formatter for the highlight output" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightFormatter - Manual" />
<meta name="twitter:description" content="Specify a formatter for the highlight output" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightFormatter - Manual" />
<meta itemprop="description" content="Specify a formatter for the highlight output" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specify a formatter for the highlight output" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.sethighlightfragmenter.php">
          SolrQuery::setHighlightFragmenter &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightalternatefield.php">
          &laquo; SolrQuery::setHighlightAlternateField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightformatter.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightformatter.php'>German</option>
            <option value='es/solrquery.sethighlightformatter.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightformatter.php'>French</option>
            <option value='it/solrquery.sethighlightformatter.php'>Italian</option>
            <option value='ja/solrquery.sethighlightformatter.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightformatter.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightformatter.php'>Russian</option>
            <option value='tr/solrquery.sethighlightformatter.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightformatter.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightformatter.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightformatter" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightFormatter</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightFormatter</span> &mdash; <span class="dc-title">Specify a formatter for the highlight output</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightformatter-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightFormatter</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$formatter</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightformatter-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightformatter-returnvalues">
  ...
  <p class="para">
   Returns an instance of <span class="classname"><a href="class.solrquery.php" class="classname">SolrQuery</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightformatter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightformatter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightformatter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightformatter.php">＋<small>add a note</small></a></span>
