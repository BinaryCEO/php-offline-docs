...
<head>
  ...
  <title>PHP: DOMDocumentType - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.domdocumenttype.php">
 <link rel="shorturl" href="https://www.php.net/domdocumenttype">
 <link rel="alternate" href="https://www.php.net/domdocumenttype" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/domdocumentfragment.replacechildren.php">
 <link rel="next" href="https://www.php.net/manual/en/class.domelement.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.domdocumenttype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.domdocumenttype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.domdocumenttype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.domdocumenttype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.domdocumenttype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.domdocumenttype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.domdocumenttype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.domdocumenttype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.domdocumenttype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.domdocumenttype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.domdocumenttype.php" hreflang="zh">
...
<meta name="Description" content="The DOMDocumentType class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMDocumentType - Manual" />
<meta name="twitter:description" content="The DOMDocumentType class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMDocumentType - Manual" />
<meta itemprop="description" content="The DOMDocumentType class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DOMDocumentType class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.domelement.php">
          DOMElement &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domdocumentfragment.replacechildren.php">
          &laquo; DOMDocumentFragment::replaceChildren        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.domdocumenttype.php' selected="selected">English</option>
            <option value='de/class.domdocumenttype.php'>German</option>
            <option value='es/class.domdocumenttype.php'>Spanish</option>
            <option value='fr/class.domdocumenttype.php'>French</option>
            <option value='it/class.domdocumenttype.php'>Italian</option>
            <option value='ja/class.domdocumenttype.php'>Japanese</option>
            <option value='pt_BR/class.domdocumenttype.php'>Brazilian Portuguese</option>
            <option value='ru/class.domdocumenttype.php'>Russian</option>
            <option value='tr/class.domdocumenttype.php'>Turkish</option>
            <option value='uk/class.domdocumenttype.php'>Ukrainian</option>
            <option value='zh/class.domdocumenttype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.domdocumenttype" class="reference">
 <h1 class="title">The DOMDocumentType class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>
 

  <div class="section" id="domdocumenttype.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    Each <span class="classname"><a href="class.domdocument.php" class="classname">DOMDocument</a></span> has a <code class="literal">doctype</code>
    attribute whose value is either <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> or a <span class="classname"><strong class="classname">DOMDocumentType</strong></span> object.
   </p>
  </div>

 
  <div class="section" id="domdocumenttype.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">DOMDocumentType</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.domdocumenttype.php#domdocumenttype.props.name">$<var class="varname">name</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="class.domnamednodemap.php" class="type DOMNamedNodeMap">DOMNamedNodeMap</a></span>
      <var class="varname"><a href="class.domdocumenttype.php#domdocumenttype.props.entities">$<var class="varname">entities</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="class.domnamednodemap.php" class="type DOMNamedNodeMap">DOMNamedNodeMap</a></span>
      <var class="varname"><a href="class.domdocumenttype.php#domdocumenttype.props.notations">$<var class="varname">notations</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.domdocumenttype.php#domdocumenttype.props.publicid">$<var class="varname">publicId</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.domdocumenttype.php#domdocumenttype.props.systemid">$<var class="varname">systemId</var></a></var>;</div>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.domdocumenttype.php#domdocumenttype.props.internalsubset">$<var class="varname">internalSubset</var></a></var>;</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domnode.wakeup.php" class="methodname">DOMNode::__wakeup</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="domdocumenttype.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="domdocumenttype.props.publicid"><var class="varname">publicId</var></dt>
     <dd>
      <p class="para">The public identifier of the external subset.</p>
     </dd>
    
    
     <dt id="domdocumenttype.props.systemid"><var class="varname">systemId</var></dt>
     <dd>
      <p class="para">
     ...
     <dt id="domdocumenttype.props.name"><var class="varname">name</var></dt>
     <dd>
      <p class="para">
     ...
     <dt id="domdocumenttype.props.entities"><var class="varname">entities</var></dt>
     <dd>
      <p class="para">
       A <span class="classname"><a href="class.domnamednodemap.php" class="classname">DOMNamedNodeMap</a></span> containing the general 
       entities, both external and internal, declared in the <abbr>DTD</abbr>.
      </p>
     </dd>
    
    
     <dt id="domdocumenttype.props.notations"><var class="varname">notations</var></dt>
     <dd>
      <p class="para">
       A <span class="classname"><a href="class.domnamednodemap.php" class="classname">DOMNamedNodeMap</a></span> containing the notations
       declared in the <abbr>DTD</abbr>.
      </p>
     </dd>
    
    
     <dt id="domdocumenttype.props.internalsubset"><var class="varname">internalSubset</var></dt>
     <dd>
      <p class="para">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domdocumenttype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.domdocumenttype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.domdocumenttype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.domdocumenttype.php">＋<small>add a note</small></a></span>
