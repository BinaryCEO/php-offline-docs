...
<head>
  ...
  <title>PHP: posix_sysconf - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-sysconf.php">
 <link rel="shorturl" href="https://www.php.net/posix-sysconf">
 <link rel="alternate" href="https://www.php.net/posix-sysconf" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-strerror.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-times.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-sysconf.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-sysconf.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-sysconf.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-sysconf.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-sysconf.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-sysconf.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-sysconf.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-sysconf.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-sysconf.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-sysconf.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-sysconf.php" hreflang="zh">
...
<meta name="Description" content="Returns system runtime information" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_sysconf - Manual" />
<meta name="twitter:description" content="Returns system runtime information" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_sysconf - Manual" />
<meta itemprop="description" content="Returns system runtime information" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns system runtime information" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-sysconf.php' selected="selected">English</option>
            <option value='de/function.posix-sysconf.php'>German</option>
            <option value='es/function.posix-sysconf.php'>Spanish</option>
            <option value='fr/function.posix-sysconf.php'>French</option>
            <option value='it/function.posix-sysconf.php'>Italian</option>
            <option value='ja/function.posix-sysconf.php'>Japanese</option>
            <option value='pt_BR/function.posix-sysconf.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-sysconf.php'>Russian</option>
            <option value='tr/function.posix-sysconf.php'>Turkish</option>
            <option value='uk/function.posix-sysconf.php'>Ukrainian</option>
            <option value='zh/function.posix-sysconf.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-sysconf" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">posix_sysconf</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">posix_sysconf</span> &mdash; <span class="dc-title">Returns system runtime information</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.posix-sysconf-returnvalues">
  ...
  <p class="para">
   Returns the numeric value related to <code class="parameter">conf_id</code>
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.posix-sysconf-examples">
  ...
  <div class="example" id="function.posix-sysconf.example.basic">
   <p><strong>Example #1 <span class="function"><strong>posix_sysconf()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">2</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-sysconf.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-sysconf%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-sysconf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-sysconf.php">＋<small>add a note</small></a></span>
