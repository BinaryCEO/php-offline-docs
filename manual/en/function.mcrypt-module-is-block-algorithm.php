...
<head>
  ...
  <title>PHP: mcrypt_module_is_block_algorithm - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-module-is-block-algorithm.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-module-is-block-algorithm">
 <link rel="alternate" href="https://www.php.net/mcrypt-module-is-block-algorithm" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-module-get-supported-key-sizes.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-module-is-block-algorithm-mode.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-module-is-block-algorithm.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-module-is-block-algorithm.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-module-is-block-algorithm.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-module-is-block-algorithm.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-module-is-block-algorithm.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-module-is-block-algorithm.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-module-is-block-algorithm.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-module-is-block-algorithm.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-module-is-block-algorithm.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-module-is-block-algorithm.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-module-is-block-algorithm.php" hreflang="zh">
...
<meta name="Description" content="This function checks whether the specified algorithm is a block algorithm" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_module_is_block_algorithm - Manual" />
<meta name="twitter:description" content="This function checks whether the specified algorithm is a block algorithm" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_module_is_block_algorithm - Manual" />
<meta itemprop="description" content="This function checks whether the specified algorithm is a block algorithm" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="This function checks whether the specified algorithm is a block algorithm" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mcrypt-module-is-block-algorithm-mode.php">
          mcrypt_module_is_block_algorithm_mode &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-module-get-supported-key-sizes.php">
          &laquo; mcrypt_module_get_supported_key_sizes        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-module-is-block-algorithm.php' selected="selected">English</option>
            <option value='de/function.mcrypt-module-is-block-algorithm.php'>German</option>
            <option value='es/function.mcrypt-module-is-block-algorithm.php'>Spanish</option>
            <option value='fr/function.mcrypt-module-is-block-algorithm.php'>French</option>
            <option value='it/function.mcrypt-module-is-block-algorithm.php'>Italian</option>
            <option value='ja/function.mcrypt-module-is-block-algorithm.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-module-is-block-algorithm.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-module-is-block-algorithm.php'>Russian</option>
            <option value='tr/function.mcrypt-module-is-block-algorithm.php'>Turkish</option>
            <option value='uk/function.mcrypt-module-is-block-algorithm.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-module-is-block-algorithm.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-module-is-block-algorithm" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mcrypt_module_is_block_algorithm</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7 &lt; 7.2.0, PECL mcrypt &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">mcrypt_module_is_block_algorithm</span> &mdash; <span class="dc-title">This function checks whether the specified algorithm is a block algorithm</span></p>
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 description" id="refsect1-function.mcrypt-module-is-block-algorithm-description">
  ...
  <p class="para rdfs-comment">
   This function returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the specified algorithm is a block
   algorithm, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if it is a stream one.
  </p>
 </div>
  ...
  <p class="para">
   ...
   algorithm, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if it is a stream one.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-module-is-block-algorithm.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-module-is-block-algorithm%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-module-is-block-algorithm&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-module-is-block-algorithm.php">＋<small>add a note</small></a></span>
