...
<head>
  ...
  <title>PHP: Pdo\Firebird - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.pdo-firebird.php">
 <link rel="shorturl" href="https://www.php.net/pdo-firebird">
 <link rel="alternate" href="https://www.php.net/pdo-firebird" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/pdo.drivers.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.pdo-firebird.connection.php">
 <link rel="next" href="https://www.php.net/manual/en/pdo-firebird.getapiversion.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.pdo-firebird.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.pdo-firebird.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.pdo-firebird.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.pdo-firebird.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.pdo-firebird.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.pdo-firebird.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.pdo-firebird.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.pdo-firebird.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.pdo-firebird.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.pdo-firebird.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.pdo-firebird.php" hreflang="zh">
...
<meta name="Description" content="The Pdo\Firebird class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Pdo\Firebird - Manual" />
<meta name="twitter:description" content="The Pdo\Firebird class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Pdo\Firebird - Manual" />
<meta itemprop="description" content="The Pdo\Firebird class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Pdo\Firebird class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="pdo-firebird.getapiversion.php">
          Pdo\Firebird::getApiVersion &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.pdo-firebird.connection.php">
          &laquo; PDO_FIREBIRD DSN        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.pdo-firebird.php' selected="selected">English</option>
            <option value='de/class.pdo-firebird.php'>German</option>
            <option value='es/class.pdo-firebird.php'>Spanish</option>
            <option value='fr/class.pdo-firebird.php'>French</option>
            <option value='it/class.pdo-firebird.php'>Italian</option>
            <option value='ja/class.pdo-firebird.php'>Japanese</option>
            <option value='pt_BR/class.pdo-firebird.php'>Brazilian Portuguese</option>
            <option value='ru/class.pdo-firebird.php'>Russian</option>
            <option value='tr/class.pdo-firebird.php'>Turkish</option>
            <option value='uk/class.pdo-firebird.php'>Ukrainian</option>
            <option value='zh/class.pdo-firebird.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.pdo-firebird" class="reference">
 <h1 class="title">The Pdo\Firebird class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>
  ...
  <div class="section" id="pdo-firebird.synopsis">
   <h2 class="title">Class synopsis</h2>
   
   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Pdo\Firebird</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-firebird.php#pdo-firebird.constants.attr-date-format"><var class="varname">ATTR_DATE_FORMAT</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-firebird.php#pdo-firebird.constants.attr-time-format"><var class="varname">ATTR_TIME_FORMAT</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-firebird.php#pdo-firebird.constants.attr-timestamp-format"><var class="varname">ATTR_TIMESTAMP_FORMAT</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-firebird.php#pdo-firebird.constants.transaction-isolation-level"><var class="varname">TRANSACTION_ISOLATION_LEVEL</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-firebird.php#pdo-firebird.constants.read-committed"><var class="varname">READ_COMMITTED</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-firebird.php#pdo-firebird.constants.repeatable-read"><var class="varname">REPEATABLE_READ</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-firebird.php#pdo-firebird.constants.serializable"><var class="varname">SERIALIZABLE</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-firebird.php#pdo-firebird.constants.writable-transaction"><var class="varname">WRITABLE_TRANSACTION</var></a></var>;</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><a href="pdo-firebird.getapiversion.php" class="methodname">getApiVersion</a></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo.setattribute.php" class="methodname">PDO::setAttribute</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$attribute</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <div class="section" id="pdo-firebird.constants">
   ...
   <dl>
     ...
     <dt id="pdo-firebird.constants.attr-date-format"><strong><code><a href="class.pdo-firebird.php#pdo-firebird.constants.attr-date-format">Pdo\Firebird::ATTR_DATE_FORMAT</a></code></strong></dt>
     <dd>
      <span class="simpara">
     ...
     <dt id="pdo-firebird.constants.attr-time-format"><strong><code><a href="class.pdo-firebird.php#pdo-firebird.constants.attr-time-format">Pdo\Firebird::ATTR_TIME_FORMAT</a></code></strong></dt>
     <dd>
      <span class="simpara">
     ...
     <dt id="pdo-firebird.constants.attr-timestamp-format"><strong><code><a href="class.pdo-firebird.php#pdo-firebird.constants.attr-timestamp-format">Pdo\Firebird::ATTR_TIMESTAMP_FORMAT</a></code></strong></dt>
     <dd>
      <span class="simpara">
     ...
     <dt id="pdo-firebird.constants.transaction-isolation-level"><strong><code><a href="class.pdo-firebird.php#pdo-firebird.constants.transaction-isolation-level">Pdo\Firebird::TRANSACTION_ISOLATION_LEVEL</a></code></strong></dt>
     <dd>
      <span class="simpara">
       Attribute to sets the transaction isolation level.
       This can be one of <strong><code><a href="class.pdo-firebird.php#pdo-firebird.constants.read-committed">Pdo\Firebird::READ_COMMITTED</a></code></strong>,
       <strong><code><a href="class.pdo-firebird.php#pdo-firebird.constants.repeatable-read">Pdo\Firebird::REPEATABLE_READ</a></code></strong>,
       or <strong><code><a href="class.pdo-firebird.php#pdo-firebird.constants.serializable">Pdo\Firebird::SERIALIZABLE</a></code></strong>.
      </span>
     </dd>
    
    
     <dt id="pdo-firebird.constants.read-committed"><strong><code><a href="class.pdo-firebird.php#pdo-firebird.constants.read-committed">Pdo\Firebird::READ_COMMITTED</a></code></strong></dt>
     <dd>
      <span class="simpara">
       Flag denoting the <abbr>ANSI</abbr> transaction isolation
     ...
     <dt id="pdo-firebird.constants.repeatable-read"><strong><code><a href="class.pdo-firebird.php#pdo-firebird.constants.repeatable-read">Pdo\Firebird::REPEATABLE_READ</a></code></strong></dt>
     <dd>
      <span class="simpara">
       Flag denoting the <abbr>ANSI</abbr> transaction isolation
     ...
     <dt id="pdo-firebird.constants.serializable"><strong><code><a href="class.pdo-firebird.php#pdo-firebird.constants.serializable">Pdo\Firebird::SERIALIZABLE</a></code></strong></dt>
     <dd>
      <span class="simpara">
       Flag denoting the <abbr>ANSI</abbr> transaction isolation
     ...
     <dt id="pdo-firebird.constants.writable-transaction"><strong><code><a href="class.pdo-firebird.php#pdo-firebird.constants.writable-transaction">Pdo\Firebird::WRITABLE_TRANSACTION</a></code></strong></dt>
     <dd>
      <span class="simpara">
       Boolean attribute used to toggle the transaction access mode between
       <code class="literal">READ ONLY</code> and <code class="literal">READ WRITE</code>.
       By default, it is <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> indicating <code class="literal">READ WRITE</code>.
      </span>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="pdo-firebird.getapiversion.php">Pdo\Firebird::getApiVersion</a> — Get the API version</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pdo_firebird/pdo-firebird.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.pdo-firebird%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.pdo-firebird&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.pdo-firebird.php">＋<small>add a note</small></a></span>
