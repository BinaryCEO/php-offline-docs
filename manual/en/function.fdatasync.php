...
<head>
  ...
  <title>PHP: fdatasync - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdatasync.php">
 <link rel="shorturl" href="https://www.php.net/fdatasync">
 <link rel="alternate" href="https://www.php.net/fdatasync" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fclose.php">
 <link rel="next" href="https://www.php.net/manual/en/function.feof.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdatasync.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdatasync.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdatasync.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdatasync.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdatasync.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdatasync.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdatasync.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdatasync.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdatasync.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdatasync.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdatasync.php" hreflang="zh">
...
<meta name="Description" content="Synchronizes data (but not meta-data) to the file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdatasync - Manual" />
<meta name="twitter:description" content="Synchronizes data (but not meta-data) to the file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdatasync - Manual" />
<meta itemprop="description" content="Synchronizes data (but not meta-data) to the file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Synchronizes data (but not meta-data) to the file" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.feof.php">
          feof &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fclose.php">
          &laquo; fclose        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdatasync.php' selected="selected">English</option>
            <option value='de/function.fdatasync.php'>German</option>
            <option value='es/function.fdatasync.php'>Spanish</option>
            <option value='fr/function.fdatasync.php'>French</option>
            <option value='it/function.fdatasync.php'>Italian</option>
            <option value='ja/function.fdatasync.php'>Japanese</option>
            <option value='pt_BR/function.fdatasync.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdatasync.php'>Russian</option>
            <option value='tr/function.fdatasync.php'>Turkish</option>
            <option value='uk/function.fdatasync.php'>Ukrainian</option>
            <option value='zh/function.fdatasync.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdatasync" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fdatasync</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.1.0)</p><p class="refpurpose"><span class="refname">fdatasync</span> &mdash; <span class="dc-title">Synchronizes data (but not meta-data) to the file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.fdatasync-description">
  ...
  <p class="para rdfs-comment">
   This function synchronizes <code class="parameter">stream</code> contents to storage media, just like <span class="function"><a href="function.fsync.php" class="function">fsync()</a></span> does,
   but it does not synchronize file meta-data.
   Note that this function is only effectively different in POSIX systems.
   In Windows, this function is aliased to <span class="function"><a href="function.fsync.php" class="function">fsync()</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.fdatasync-examples">
  ...
  <p class="para">
   <div class="example" id="example-2342">
    <p><strong>Example #1 <span class="function"><strong>fdatasync()</strong></span> example</strong></p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.fdatasync-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fsync.php" class="function" rel="rdfs-seeAlso">fsync()</a> - Synchronizes changes to the file (including meta-data)</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/fdatasync.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdatasync%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdatasync&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdatasync.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128798">  <div class="votes">
    <div id="Vu128798">
    <a href="/manual/vote-note.php?id=128798&amp;page=function.fdatasync&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128798">
    <a href="/manual/vote-note.php?id=128798&amp;page=function.fdatasync&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128798" title="50% like this...">
    0
    </div>
  </div>
  <a href="#128798" class="name">
  <strong class="user"><em>greg at example dot com</em></strong></a><a class="genanchor" href="#128798"> &para;</a><div class="date" title="2023-08-13 07:35"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128798">
<div class="phpcode"><code><span class="html">Does not flush st_atime, st_mtime or st_size.<br /><br />If you need to use filesize after a write you will need need fsync() or fflush() instead.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fdatasync&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdatasync.php">＋<small>add a note</small></a></div>
