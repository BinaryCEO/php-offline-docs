...
<head>
  ...
  <title>PHP: Imagick::modulateImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.modulateimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.modulateimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.modulateimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.minifyimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.montageimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.modulateimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.modulateimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.modulateimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.modulateimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.modulateimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.modulateimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.modulateimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.modulateimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.modulateimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.modulateimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.modulateimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::modulateImage - Manual" />
<meta name="twitter:description" content="Control the brightness, saturation, and hue" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::modulateImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.montageimage.php">
          Imagick::montageImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.minifyimage.php">
          &laquo; Imagick::minifyImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.modulateimage.php' selected="selected">English</option>
            <option value='de/imagick.modulateimage.php'>German</option>
            <option value='es/imagick.modulateimage.php'>Spanish</option>
            <option value='fr/imagick.modulateimage.php'>French</option>
            <option value='it/imagick.modulateimage.php'>Italian</option>
            <option value='ja/imagick.modulateimage.php'>Japanese</option>
            <option value='pt_BR/imagick.modulateimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.modulateimage.php'>Russian</option>
            <option value='tr/imagick.modulateimage.php'>Turkish</option>
            <option value='uk/imagick.modulateimage.php'>Ukrainian</option>
            <option value='zh/imagick.modulateimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.modulateimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::modulateImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::modulateImage</span> &mdash; <span class="dc-title">Control the brightness, saturation, and hue</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.modulateimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3029">
      <p><strong>Example #1  <span class="function"><strong>Imagick::modulateImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/modulateimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.modulateimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.modulateimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.modulateimage.php">＋<small>add a note</small></a></span>
