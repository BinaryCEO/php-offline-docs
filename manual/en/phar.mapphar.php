...
<head>
  ...
  <title>PHP: Phar::mapPhar - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.mapphar.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.mapphar.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.mapphar.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.loadphar.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.mount.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.mapphar.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.mapphar.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.mapphar.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.mapphar.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.mapphar.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.mapphar.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.mapphar.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.mapphar.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.mapphar.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.mapphar.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.mapphar.php" hreflang="zh">
...
<meta name="Description" content="Reads the currently executed file (a phar) and registers its manifest" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::mapPhar - Manual" />
<meta name="twitter:description" content="Reads the currently executed file (a phar) and registers its manifest" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::mapPhar - Manual" />
<meta itemprop="description" content="Reads the currently executed file (a phar) and registers its manifest" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads the currently executed file (a phar) and registers its manifest" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.mapphar.php' selected="selected">English</option>
            <option value='de/phar.mapphar.php'>German</option>
            <option value='es/phar.mapphar.php'>Spanish</option>
            <option value='fr/phar.mapphar.php'>French</option>
            <option value='it/phar.mapphar.php'>Italian</option>
            <option value='ja/phar.mapphar.php'>Japanese</option>
            <option value='pt_BR/phar.mapphar.php'>Brazilian Portuguese</option>
            <option value='ru/phar.mapphar.php'>Russian</option>
            <option value='tr/phar.mapphar.php'>Turkish</option>
            <option value='uk/phar.mapphar.php'>Ukrainian</option>
            <option value='zh/phar.mapphar.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.mapphar" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-phar.mapphar-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">final</span> <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Phar::mapPhar</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$alias</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 errors" id="refsect1-phar.mapphar-errors">
  ...
  <p class="para">
   <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> is thrown if not called directly within PHP execution,
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">__autoload</span><span style="color: #007700">(</span><span style="color: #0000BB">$class</span><span style="color: #007700">)<br />{<br />    include </span><span style="color: #DD0000">'phar://me.phar/' </span><span style="color: #007700">. </span><span style="color: #0000BB">str_replace</span><span style="color: #007700">(</span><span style="color: #DD0000">'_'</span><span style="color: #007700">, </span><span style="color: #DD0000">'/'</span><span style="color: #007700">, </span><span style="color: #0000BB">$class</span><span style="color: #007700">) . </span><span style="color: #DD0000">'.php'</span><span style="color: #007700">;<br />}<br />try {<br />    </span><span style="color: #0000BB">Phar</span><span style="color: #007700">::</span><span style="color: #0000BB">mapPhar</span><span style="color: #007700">(</span><span style="color: #DD0000">'me.phar'</span><span style="color: #007700">);<br />    include </span><span style="color: #DD0000">'phar://me.phar/startup.php'</span><span style="color: #007700">;<br />} catch (</span><span style="color: #0000BB">PharException $e</span><span style="color: #007700">) {<br />    echo </span><span style="color: #0000BB">$e</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getMessage</span><span style="color: #007700">();<br />    die(</span><span style="color: #DD0000">'Cannot initialize Phar'</span><span style="color: #007700">);<br />}<br />__HALT_COMPILER();</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-phar.mapphar-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="phar.loadphar.php" class="function" rel="rdfs-seeAlso">Phar::loadPhar()</a> - Loads any phar archive with an alias</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/mapPhar.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.mapphar%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.mapphar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.mapphar.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="113377">  <div class="votes">
    <div id="Vu113377">
    <a href="/manual/vote-note.php?id=113377&amp;page=phar.mapphar&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113377">
    <a href="/manual/vote-note.php?id=113377&amp;page=phar.mapphar&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113377" title="55% like this...">
    1
    </div>
  </div>
  <a href="#113377" class="name">
  <strong class="user"><em>phofstetter at sensational dot ch</em></strong></a><a class="genanchor" href="#113377"> &para;</a><div class="date" title="2013-10-03 02:52"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113377">
<div class="phpcode"><code><span class="html">Be careful with mapPhar and opcode caches like opcache: They might cache files included by the symbolic name based on the symbolic name you give.<br /><br />This becomes a problem when a server is hosting multiple different versions of a phar file all using the same symbolic name because then subsequent include()'s in the phar file might load an already cached file from another version of the phar file.<br /><br />Instead, generate a unique name and use that in mapPhar and in subsequent include()'s<br /><br />See for example <a href="https://github.com/zendtech/ZendOptimizerPlus/issues/115#issuecomment-25612769" rel="nofollow" target="_blank">https://github.com/zendtech/ZendOptimizerPlus/issues/115#issuecomment-25612769</a> for the issue in the opcache module.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phar.mapphar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.mapphar.php">＋<small>add a note</small></a></div>
