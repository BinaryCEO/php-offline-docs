...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.filter.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.filter.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.filter.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.extentimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.flattenimages.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.filter.php' selected="selected">English</option>
            <option value='de/imagick.filter.php'>German</option>
            <option value='es/imagick.filter.php'>Spanish</option>
            <option value='fr/imagick.filter.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::filter</span> &mdash; <span class="dc-title">Applies a custom convolution kernel to the image</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.filter-examples">
  ...
  <p class="para">
    <div class="example" id="example-2998">
      <p><strong>Example #1  <span class="function"><strong>Imagick::filter()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/filter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.filter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.filter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.filter.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">-----Imagick  3.4.3  &amp;&amp;  ImageMagick 7.0.6  <br /><br />-----why cannot find filter method????? <br /><br />if (!method_exists(Imagick, 'filter')) {<br />    echo 'undefined filter()！';<br />} else {<br />    echo 'defined filter()！';<br />}</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">-----Imagick::filter cannot work!<br /><br />-----suse linux server   ,   imagick module version 3.4.3<br /><br />-----run Example #1 Imagick::filter()  , there is no result!  where is problem?<br /><br />thank you for your answer!<br /><br />Alex</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.filter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.filter.php">＋<small>add a note</small></a></div>
