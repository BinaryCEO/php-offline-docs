...
<head>
  ...
  <title>PHP: Imagick::listRegistry - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.listregistry.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.listregistry.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.listregistry.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.liquidrescaleimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.magnifyimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.listregistry.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.listregistry.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.listregistry.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.listregistry.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.listregistry.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.listregistry.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.listregistry.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.listregistry.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.listregistry.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.listregistry.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.listregistry.php" hreflang="zh">
...
<meta name="Description" content="List all the registry settings" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::listRegistry - Manual" />
<meta name="twitter:description" content="List all the registry settings" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::listRegistry - Manual" />
<meta itemprop="description" content="List all the registry settings" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="List all the registry settings" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.magnifyimage.php">
          Imagick::magnifyImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.liquidrescaleimage.php">
          &laquo; Imagick::liquidRescaleImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.listregistry.php' selected="selected">English</option>
            <option value='de/imagick.listregistry.php'>German</option>
            <option value='es/imagick.listregistry.php'>Spanish</option>
            <option value='fr/imagick.listregistry.php'>French</option>
            <option value='it/imagick.listregistry.php'>Italian</option>
            <option value='ja/imagick.listregistry.php'>Japanese</option>
            <option value='pt_BR/imagick.listregistry.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.listregistry.php'>Russian</option>
            <option value='tr/imagick.listregistry.php'>Turkish</option>
            <option value='uk/imagick.listregistry.php'>Ukrainian</option>
            <option value='zh/imagick.listregistry.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.listregistry" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::listRegistry</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::listRegistry</span> &mdash; <span class="dc-title">List all the registry settings</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.listregistry-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::listRegistry</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.listregistry-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.listregistry-returnvalues">
  ...
  <p class="para">
   An array containing the key/values from the registry.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/listregistry.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.listregistry%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.listregistry&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.listregistry.php">＋<small>add a note</small></a></span>
