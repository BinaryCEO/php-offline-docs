...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-tableselect.where.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-tableselect.where.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-tableselect.where.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-tableselect.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-tableselect.orderby.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mysql-xdevapi-tableupdate.php">
...
<meta name="Description" content="Set select search condition" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: TableSelect::where - Manual" />
<meta name="twitter:description" content="Set select search condition" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: TableSelect::where - Manual" />
<meta itemprop="description" content="Set select search condition" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set select search condition" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-tableselect.where.php' selected="selected">English</option>
            ...
            <option value='pt_BR/mysql-xdevapi-tableselect.where.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">TableSelect::where</span> &mdash; <span class="dc-title">Set select search condition</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-mysql-xdevapi-tableselect.where-examples">
  ...
  <div class="example" id="example-1864">
   <p><strong>Example #1 <span class="function"><strong>mysql_xdevapi\TableSelect::where()</strong></span> example</strong></p>
...
(
    [0] =&gt; Array
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/tableselect/where.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-tableselect.where%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-tableselect.where&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-tableselect.where.php">＋<small>add a note</small></a></span>
