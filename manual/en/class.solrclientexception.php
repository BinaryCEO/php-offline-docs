...
<head>
  ...
  <title>PHP: SolrClientException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.solrclientexception.php">
 <link rel="shorturl" href="https://www.php.net/solrclientexception">
 <link rel="alternate" href="https://www.php.net/solrclientexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.solr.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrexception.getinternalinfo.php">
 <link rel="next" href="https://www.php.net/manual/en/solrclientexception.getinternalinfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.solrclientexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.solrclientexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.solrclientexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.solrclientexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.solrclientexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.solrclientexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.solrclientexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.solrclientexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.solrclientexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.solrclientexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.solrclientexception.php" hreflang="zh">
...
<meta name="Description" content="The SolrClientException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrClientException - Manual" />
<meta name="twitter:description" content="The SolrClientException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrClientException - Manual" />
<meta itemprop="description" content="The SolrClientException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SolrClientException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrclientexception.getinternalinfo.php">
          SolrClientException::getInternalInfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrexception.getinternalinfo.php">
          &laquo; SolrException::getInternalInfo        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.solrclientexception.php' selected="selected">English</option>
            <option value='de/class.solrclientexception.php'>German</option>
            <option value='es/class.solrclientexception.php'>Spanish</option>
            <option value='fr/class.solrclientexception.php'>French</option>
            <option value='it/class.solrclientexception.php'>Italian</option>
            <option value='ja/class.solrclientexception.php'>Japanese</option>
            <option value='pt_BR/class.solrclientexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.solrclientexception.php'>Russian</option>
            <option value='tr/class.solrclientexception.php'>Turkish</option>
            <option value='uk/class.solrclientexception.php'>Ukrainian</option>
            <option value='zh/class.solrclientexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.solrclientexception" class="reference">

 <h1 class="title">The SolrClientException class</h1>
 

 <div class="partintro"><p class="verinfo">(PECL solr &gt;= 0.9.2)</p>


  <div class="section" id="solrclientexception.intro">
  ...
  <div class="section" id="solrclientexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">SolrClientException</strong>
     </span>
...
<div class="fieldsynopsis"><span class="modifier">protected</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="solrclientexception.getinternalinfo.php" class="methodname">getInternalInfo</a></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="solrclientexception.getinternalinfo.php">SolrClientException::getInternalInfo</a> — Returns internal information where the Exception was thrown</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrclientexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.solrclientexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.solrclientexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.solrclientexception.php">＋<small>add a note</small></a></span>
