...
<head>
  ...
  <title>PHP: trader_ht_phasor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-ht-phasor.php">
 <link rel="shorturl" href="https://www.php.net/trader-ht-phasor">
 <link rel="alternate" href="https://www.php.net/trader-ht-phasor" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-ht-dcphase.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-ht-sine.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-ht-phasor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-ht-phasor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-ht-phasor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-ht-phasor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-ht-phasor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-ht-phasor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-ht-phasor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-ht-phasor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-ht-phasor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-ht-phasor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-ht-phasor.php" hreflang="zh">
...
<meta name="Description" content="Hilbert Transform - Phasor Components" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_ht_phasor - Manual" />
<meta name="twitter:description" content="Hilbert Transform - Phasor Components" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_ht_phasor - Manual" />
<meta itemprop="description" content="Hilbert Transform - Phasor Components" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Hilbert Transform - Phasor Components" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-ht-sine.php">
          trader_ht_sine &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-ht-dcphase.php">
          &laquo; trader_ht_dcphase        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-ht-phasor.php' selected="selected">English</option>
            <option value='de/function.trader-ht-phasor.php'>German</option>
            <option value='es/function.trader-ht-phasor.php'>Spanish</option>
            <option value='fr/function.trader-ht-phasor.php'>French</option>
            <option value='it/function.trader-ht-phasor.php'>Italian</option>
            <option value='ja/function.trader-ht-phasor.php'>Japanese</option>
            <option value='pt_BR/function.trader-ht-phasor.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-ht-phasor.php'>Russian</option>
            <option value='tr/function.trader-ht-phasor.php'>Turkish</option>
            <option value='uk/function.trader-ht-phasor.php'>Ukrainian</option>
            <option value='zh/function.trader-ht-phasor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-ht-phasor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_ht_phasor</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_ht_phasor</span> &mdash; <span class="dc-title">Hilbert Transform - Phasor Components</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-ht-phasor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_ht_phasor</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-ht-phasor-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-ht-phasor-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-ht-phasor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-ht-phasor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-ht-phasor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-ht-phasor.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117369">  <div class="votes">
    <div id="Vu117369">
    <a href="/manual/vote-note.php?id=117369&amp;page=function.trader-ht-phasor&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117369">
    <a href="/manual/vote-note.php?id=117369&amp;page=function.trader-ht-phasor&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117369" title="80% like this...">
    3
    </div>
  </div>
  <a href="#117369" class="name">
  <strong class="user"><em>bitstocoins at gmail dot com</em></strong></a><a class="genanchor" href="#117369"> &para;</a><div class="date" title="2015-05-28 08:39"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117369">
<div class="phpcode"><code><span class="html">trader_ht_phasor is documented to take only one value<br /><br />it requires exactly 2 parameters to operate properly <br /><br />example is <br /><br />$htpa = trader_ht_phasor($a['open'],$a['close']);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-ht-phasor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-ht-phasor.php">＋<small>add a note</small></a></div>
