...
<head>
  ...
  <title>PHP: trader_mavp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-mavp.php">
 <link rel="shorturl" href="https://www.php.net/trader-mavp">
 <link rel="alternate" href="https://www.php.net/trader-mavp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-mama.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-max.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-mavp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-mavp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-mavp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-mavp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-mavp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-mavp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-mavp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-mavp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-mavp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-mavp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-mavp.php" hreflang="zh">
...
<meta name="Description" content="Moving average with variable period" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_mavp - Manual" />
<meta name="twitter:description" content="Moving average with variable period" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_mavp - Manual" />
<meta itemprop="description" content="Moving average with variable period" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Moving average with variable period" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-max.php">
          trader_max &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-mavp.php' selected="selected">English</option>
            <option value='de/function.trader-mavp.php'>German</option>
            <option value='es/function.trader-mavp.php'>Spanish</option>
            <option value='fr/function.trader-mavp.php'>French</option>
            <option value='it/function.trader-mavp.php'>Italian</option>
            <option value='ja/function.trader-mavp.php'>Japanese</option>
            <option value='pt_BR/function.trader-mavp.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-mavp.php'>Russian</option>
            <option value='tr/function.trader-mavp.php'>Turkish</option>
            <option value='uk/function.trader-mavp.php'>Ukrainian</option>
            <option value='zh/function.trader-mavp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-mavp" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_mavp</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_mavp</span> &mdash; <span class="dc-title">Moving average with variable period</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-mavp-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_mavp</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$periods</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$minPeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$maxPeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mAType</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-mavp-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">periods</code></dt>
    <dd>
     <p class="para">
      Array of real values.
     </p>
    ...
    <dt><code class="parameter">minPeriod</code></dt>
    <dd>
     <p class="para">
    ...
    <dt><code class="parameter">maxPeriod</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-mavp-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-mavp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-mavp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-mavp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-mavp.php">＋<small>add a note</small></a></span>
