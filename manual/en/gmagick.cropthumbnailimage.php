...
<head>
  ...
  <title>PHP: Gmagick::cropthumbnailimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.cropthumbnailimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.cropthumbnailimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.cropthumbnailimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.cropimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.current.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.cropthumbnailimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.cropthumbnailimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.cropthumbnailimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.cropthumbnailimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.cropthumbnailimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.cropthumbnailimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.cropthumbnailimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.cropthumbnailimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.cropthumbnailimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.cropthumbnailimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.cropthumbnailimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::cropthumbnailimage - Manual" />
<meta name="twitter:description" content="Creates a crop thumbnail" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::cropthumbnailimage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.current.php">
          Gmagick::current &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.cropimage.php">
          &laquo; Gmagick::cropimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.cropthumbnailimage.php' selected="selected">English</option>
            <option value='de/gmagick.cropthumbnailimage.php'>German</option>
            <option value='es/gmagick.cropthumbnailimage.php'>Spanish</option>
            <option value='fr/gmagick.cropthumbnailimage.php'>French</option>
            <option value='it/gmagick.cropthumbnailimage.php'>Italian</option>
            <option value='ja/gmagick.cropthumbnailimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.cropthumbnailimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.cropthumbnailimage.php'>Russian</option>
            <option value='tr/gmagick.cropthumbnailimage.php'>Turkish</option>
            <option value='uk/gmagick.cropthumbnailimage.php'>Ukrainian</option>
            <option value='zh/gmagick.cropthumbnailimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.cropthumbnailimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::cropthumbnailimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::cropthumbnailimage</span> &mdash; <span class="dc-title">Creates a crop thumbnail</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.cropthumbnailimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::cropthumbnailimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.cropthumbnailimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.cropthumbnailimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.cropthumbnailimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/cropthumbnailimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.cropthumbnailimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.cropthumbnailimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.cropthumbnailimage.php">＋<small>add a note</small></a></span>
