...
<head>
  ...
  <title>PHP: Imagick::getImageDelay - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagedelay.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagedelay.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagedelay.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagecompressionquality.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagedepth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagedelay.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagedelay.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagedelay.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagedelay.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagedelay.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagedelay.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagedelay.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagedelay.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagedelay.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagedelay.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagedelay.php" hreflang="zh">
...
<meta name="Description" content="Gets the image delay" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageDelay - Manual" />
<meta name="twitter:description" content="Gets the image delay" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageDelay - Manual" />
<meta itemprop="description" content="Gets the image delay" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image delay" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagedepth.php">
          Imagick::getImageDepth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagecompressionquality.php">
          &laquo; Imagick::getImageCompressionQuality        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagedelay.php' selected="selected">English</option>
            <option value='de/imagick.getimagedelay.php'>German</option>
            <option value='es/imagick.getimagedelay.php'>Spanish</option>
            <option value='fr/imagick.getimagedelay.php'>French</option>
            <option value='it/imagick.getimagedelay.php'>Italian</option>
            <option value='ja/imagick.getimagedelay.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagedelay.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagedelay.php'>Russian</option>
            <option value='tr/imagick.getimagedelay.php'>Turkish</option>
            <option value='uk/imagick.getimagedelay.php'>Ukrainian</option>
            <option value='zh/imagick.getimagedelay.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagedelay" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageDelay</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageDelay</span> &mdash; <span class="dc-title">Gets the image delay</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagedelay-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageDelay</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagedelay-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagedelay-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagedelay-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagedelay.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagedelay%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagedelay&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagedelay.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="105828">  <div class="votes">
    <div id="Vu105828">
    <a href="/manual/vote-note.php?id=105828&amp;page=imagick.getimagedelay&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105828">
    <a href="/manual/vote-note.php?id=105828&amp;page=imagick.getimagedelay&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105828" title="100% like this...">
    4
    </div>
  </div>
  <a href="#105828" class="name">
  <strong class="user"><em>jabaga at abv dot bg</em></strong></a><a class="genanchor" href="#105828"> &para;</a><div class="date" title="2011-09-18 08:31"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105828">
<div class="phpcode"><code><span class="html">Here is how you can get the delay between the frames in gif file:
<br />
<br /><span class="default">&lt;?php
<br />$animation </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">"file.gif"</span><span class="keyword">);
<br />
<br />foreach (</span><span class="default">$animation </span><span class="keyword">as </span><span class="default">$frame</span><span class="keyword">) {
<br />  </span><span class="default">$delay </span><span class="keyword">= </span><span class="default">$animation</span><span class="keyword">-&gt;</span><span class="default">getImageDelay</span><span class="keyword">();
<br />
<br />echo </span><span class="default">$delay</span><span class="keyword">;
<br />}
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="116582">  <div class="votes">
    <div id="Vu116582">
    <a href="/manual/vote-note.php?id=116582&amp;page=imagick.getimagedelay&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116582">
    <a href="/manual/vote-note.php?id=116582&amp;page=imagick.getimagedelay&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116582" title="no votes...">
    0
    </div>
  </div>
  <a href="#116582" class="name">
  <strong class="user"><em>ijtabahussain at live dot com</em></strong></a><a class="genanchor" href="#116582"> &para;</a><div class="date" title="2015-01-25 01:27"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116582">
<div class="phpcode"><code><span class="html">Seems to return the image delay in centiseconds</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagedelay&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagedelay.php">＋<small>add a note</small></a></div>
