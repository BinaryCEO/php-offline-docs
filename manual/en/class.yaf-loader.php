...
<head>
  ...
  <title>PHP: Yaf_Loader - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.yaf-loader.php">
 <link rel="shorturl" href="https://www.php.net/yaf-loader">
 <link rel="alternate" href="https://www.php.net/yaf-loader" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.yaf.php">
 <link rel="prev" href="https://www.php.net/manual/en/yaf-view-simple.setscriptpath.php">
 <link rel="next" href="https://www.php.net/manual/en/yaf-loader.autoload.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.yaf-loader.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.yaf-loader.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.yaf-loader.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.yaf-loader.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.yaf-loader.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.yaf-loader.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.yaf-loader.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.yaf-loader.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.yaf-loader.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.yaf-loader.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.yaf-loader.php" hreflang="zh">
...
<meta name="Description" content="The Yaf_Loader class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Yaf_Loader - Manual" />
<meta name="twitter:description" content="The Yaf_Loader class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Yaf_Loader - Manual" />
<meta itemprop="description" content="The Yaf_Loader class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Yaf_Loader class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="yaf-loader.autoload.php">
          Yaf_Loader::autoload &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="yaf-view-simple.setscriptpath.php">
          &laquo; Yaf_View_Simple::setScriptPath        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.yaf-loader.php' selected="selected">English</option>
            <option value='de/class.yaf-loader.php'>German</option>
            <option value='es/class.yaf-loader.php'>Spanish</option>
            <option value='fr/class.yaf-loader.php'>French</option>
            <option value='it/class.yaf-loader.php'>Italian</option>
            <option value='ja/class.yaf-loader.php'>Japanese</option>
            <option value='pt_BR/class.yaf-loader.php'>Brazilian Portuguese</option>
            <option value='ru/class.yaf-loader.php'>Russian</option>
            <option value='tr/class.yaf-loader.php'>Turkish</option>
            <option value='uk/class.yaf-loader.php'>Ukrainian</option>
            <option value='zh/class.yaf-loader.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.yaf-loader" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(Yaf &gt;=1.0.0)</p>
  ...
  <div class="section" id="yaf-loader.intro">
   ...
   <p class="para">
    The first time an instance of <span class="classname"><a href="class.yaf-application.php" class="classname">Yaf_Application</a></span> is retrieved, 
   ...
   <p class="para">
    ...
    <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>, thus give the chance to other autoload function. if it is Off 
    (by default), <span class="methodname"><a href="yaf-loader.autoload.php" class="methodname">Yaf_Loader::autoload()</a></span> will return 
    <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, and more important is that a very useful warning will be triggered 
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="yaf-loader.autoload.php">Yaf_Loader::autoload</a> — The autoload purpose</li><li><a href="yaf-loader.clearlocalnamespace.php">Yaf_Loader::clearLocalNamespace</a> — The clearLocalNamespace purpose</li><li><a href="yaf-loader.construct.php">Yaf_Loader::__construct</a> — The __construct purpose</li><li><a href="yaf-loader.getinstance.php">Yaf_Loader::getInstance</a> — The getInstance purpose</li><li><a href="yaf-loader.getlibrarypath.php">Yaf_Loader::getLibraryPath</a> — Get the library path</li><li><a href="yaf-loader.getlocalnamespace.php">Yaf_Loader::getLocalNamespace</a> — The getLocalNamespace purpose</li><li><a href="yaf-loader.getnamespacepath.php">Yaf_Loader::getNamespacePath</a> — Retieve path of a registered namespace</li><li><a href="yaf-loader.getnamespaces.php">Yaf_Loader::getLocalNamespace</a> — Retrive all register namespaces info</li><li><a href="yaf-loader.import.php">Yaf_Loader::import</a> — The import purpose</li><li><a href="yaf-loader.islocalname.php">Yaf_Loader::isLocalName</a> — The isLocalName purpose</li><li><a href="yaf-loader.registerlocalnamespace.php">Yaf_Loader::registerLocalNamespace</a> — Register local class prefix</li><li><a href="yaf-loader.registernamespace.php">Yaf_Loader::registerNamespace</a> — Register namespace with searching path</li><li><a href="yaf-loader.setlibrarypath.php">Yaf_Loader::setLibraryPath</a> — Change the library path</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaf/yaf-loader.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.yaf-loader%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.yaf-loader&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.yaf-loader.php">＋<small>add a note</small></a></span>
