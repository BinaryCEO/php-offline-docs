...
<head>
  ...
  <title>PHP: eio_sendfile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-sendfile.php">
 <link rel="shorturl" href="https://www.php.net/eio-sendfile">
 <link rel="alternate" href="https://www.php.net/eio-sendfile" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-seek.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-set-max-idle.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-sendfile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-sendfile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-sendfile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-sendfile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-sendfile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-sendfile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-sendfile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-sendfile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-sendfile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-sendfile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-sendfile.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: eio_sendfile - Manual" />
<meta name="twitter:description" content="Transfer data between file descriptors" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_sendfile - Manual" />
<meta itemprop="description" content="Transfer data between file descriptors" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.eio-set-max-idle.php">
          eio_set_max_idle &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-seek.php">
          &laquo; eio_seek        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-sendfile.php' selected="selected">English</option>
            <option value='de/function.eio-sendfile.php'>German</option>
            <option value='es/function.eio-sendfile.php'>Spanish</option>
            <option value='fr/function.eio-sendfile.php'>French</option>
            <option value='it/function.eio-sendfile.php'>Italian</option>
            <option value='ja/function.eio-sendfile.php'>Japanese</option>
            <option value='pt_BR/function.eio-sendfile.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-sendfile.php'>Russian</option>
            <option value='tr/function.eio-sendfile.php'>Turkish</option>
            <option value='uk/function.eio-sendfile.php'>Ukrainian</option>
            <option value='zh/function.eio-sendfile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-sendfile" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-sendfile-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_sendfile</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$out_fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$in_fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>eio_sendfile()</strong></span> copies  data between one file descriptor
   and another. See <code class="literal">SENDFILE(2)</code> man page for details.
  </p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-sendfile-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">out_fd</code></dt>
    <dd>
     <p class="para">
    ...
    <dt><code class="parameter">in_fd</code></dt>
    <dd>
     <p class="para">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-sendfile-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>eio_sendfile()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-sendfile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-sendfile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-sendfile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-sendfile.php">＋<small>add a note</small></a></span>
