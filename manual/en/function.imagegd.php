...
<head>
  ...
  <title>PHP: imagegd - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagegd.php">
 <link rel="shorturl" href="https://www.php.net/imagegd">
 <link rel="alternate" href="https://www.php.net/imagegd" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagegammacorrect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagegd2.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagegd.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagegd.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagegd.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagegd.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagegd.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagegd.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagegd.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagegd.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagegd.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagegd.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagegd.php" hreflang="zh">
...
<meta name="Description" content="Output GD image to browser or file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagegd - Manual" />
<meta name="twitter:description" content="Output GD image to browser or file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagegd - Manual" />
<meta itemprop="description" content="Output GD image to browser or file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Output GD image to browser or file" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagegd.php' selected="selected">English</option>
            <option value='de/function.imagegd.php'>German</option>
            <option value='es/function.imagegd.php'>Spanish</option>
            <option value='fr/function.imagegd.php'>French</option>
            <option value='it/function.imagegd.php'>Italian</option>
            <option value='ja/function.imagegd.php'>Japanese</option>
            <option value='pt_BR/function.imagegd.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagegd.php'>Russian</option>
            <option value='tr/function.imagegd.php'>Turkish</option>
            <option value='uk/function.imagegd.php'>Ukrainian</option>
            <option value='zh/function.imagegd.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagegd" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagegd</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.7, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagegd</span> &mdash; <span class="dc-title">Output GD image to browser or file</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagegd-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagegd</strong></span>(<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$file</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Outputs or saves the given <code class="parameter">image</code> in GD format.
  </p>
 </div>
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.imagegd-examples">
  ...
  <p class="para">
   <div class="example" id="example-2904">
...
purposes.</p></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagegd-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagegd2.php" class="function" rel="rdfs-seeAlso">imagegd2()</a> - Output GD2 image to browser or file</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagegd.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagegd%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagegd&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagegd.php">＋<small>add a note</small></a></span>
