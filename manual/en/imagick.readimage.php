...
<head>
  ...
  <title>PHP: Imagick::readImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.readimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.readimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.readimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.randomthresholdimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.readimageblob.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.readimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.readimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.readimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.readimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.readimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.readimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.readimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.readimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.readimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.readimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.readimage.php" hreflang="zh">
...
<meta name="Description" content="Reads image from filename" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::readImage - Manual" />
<meta name="twitter:description" content="Reads image from filename" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::readImage - Manual" />
<meta itemprop="description" content="Reads image from filename" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads image from filename" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.readimageblob.php">
          Imagick::readImageBlob &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.randomthresholdimage.php">
          &laquo; Imagick::randomThresholdImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.readimage.php' selected="selected">English</option>
            <option value='de/imagick.readimage.php'>German</option>
            <option value='es/imagick.readimage.php'>Spanish</option>
            <option value='fr/imagick.readimage.php'>French</option>
            <option value='it/imagick.readimage.php'>Italian</option>
            <option value='ja/imagick.readimage.php'>Japanese</option>
            <option value='pt_BR/imagick.readimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.readimage.php'>Russian</option>
            <option value='tr/imagick.readimage.php'>Turkish</option>
            <option value='uk/imagick.readimage.php'>Ukrainian</option>
            <option value='zh/imagick.readimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.readimage" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-imagick.readimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::readImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/readimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.readimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.readimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.readimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110811">  <div class="votes">
    <div id="Vu110811">
    <a href="/manual/vote-note.php?id=110811&amp;page=imagick.readimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110811">
    <a href="/manual/vote-note.php?id=110811&amp;page=imagick.readimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110811" title="63% like this...">
    29
    </div>
  </div>
  <a href="#110811" class="name">
  <strong class="user"><em>markus dot s dot schmitz at gmail dot com</em></strong></a><a class="genanchor" href="#110811"> &para;</a><div class="date" title="2012-12-11 10:43"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110811">
<div class="phpcode"><code><span class="html">Use this to convert all pages of a PDF to JPG:
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="111059">  <div class="votes">
    <div id="Vu111059">
    <a href="/manual/vote-note.php?id=111059&amp;page=imagick.readimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111059">
    <a href="/manual/vote-note.php?id=111059&amp;page=imagick.readimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111059" title="65% like this...">
    9
    </div>
  </div>
  <a href="#111059" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#111059"> &para;</a><div class="date" title="2013-01-10 03:50"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111059">
<div class="phpcode"><code><span class="html">What is the difference between ReadImage and ReadImageFile?  Based by looking at the pages, you would think that they behave the exact same, except in their arguments: ReadImage takes a string containing the folder location of the file, and ReadImageFile takes a handle pointing to the file location.  Initially, the first looks far more tempting, since you don't have to worry about fopen and fclose commands.<br /><br />But, there is a problem with the ReadImage function!  With an imagemagick object whose data was created from this function, I could scale, change the colors, and perform artistic effects upon the object, without any problems at all, but then there was a problem with saving: it seemed to be keep me stuck to the image format of the original image (in this case, a ".jpg", but it may be different elsewhere).  The functions setImageFormat and setFormat, programmed line after line, provided no effect to changing the format to png, bmp, or gif.  When the only line of code I changed was ReadImage to ReadImageFile, the problem disappears entirely.<br /><br />Some sample code to demonstrate (using PHP Version 5.2.17).  Input Filename: test.jpg.  Output Filenames: test_result_bad.bmp, test_result_bad.png, test_result_good.bmp, test_result_good.png.  The resultant filesizes should be enough to convince you that all bad files are merely duplicate jpgs...<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br /><br />        // Preset Image Location<br />        // ------------------------------<br /><br />    </span><span class="default">$image_file_location </span><span class="keyword">= </span><span class="string">"test.jpg"</span><span class="keyword">;<br /><br />        </span><span class="comment">// Create Objects<br />        // ------------------------------<br /><br />    </span><span class="default">$imagick_type_bad </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    </span><span class="default">$imagick_type_good </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /><br />        </span><span class="comment">// Grab Data - BAD METHOD<br />        // ------------------------------<br /><br />    </span><span class="default">$imagick_type_bad</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$image_file_location</span><span class="keyword">);<br /><br />        </span><span class="comment">// Grab Data - GOOD METHOD<br />        // ------------------------------<br />    <br />    </span><span class="default">$file_handle_for_viewing_image </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$image_file_location</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />    </span><span class="default">$imagick_type_good</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image</span><span class="keyword">);<br />    <br />    </span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image</span><span class="keyword">);<br /><br />        </span><span class="comment">// Save File - BAD DATA<br />        // ------------------------------<br /><br />    </span><span class="default">$file_handle_for_saving_bad_bmp </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">"test_result_bad.bmp"</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br /><br />    </span><span class="default">$imagick_type_bad_bmp </span><span class="keyword">= clone </span><span class="default">$imagick_type_bad</span><span class="keyword">;<br />    </span><span class="default">$imagick_type_bad_bmp</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">"bmp"</span><span class="keyword">);<br />    </span><span class="default">$imagick_type_bad_bmp</span><span class="keyword">-&gt;</span><span class="default">setFormat</span><span class="keyword">(</span><span class="string">"bmp"</span><span class="keyword">);<br />    </span><span class="default">$imagick_type_bad_bmp</span><span class="keyword">-&gt;</span><span class="default">writeImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_saving_bad_bmp</span><span class="keyword">);<br /><br />    </span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$file_handle_for_saving_bad_bmp</span><span class="keyword">);<br /><br />    </span><span class="default">$file_handle_for_saving_bad_png </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">"test_result_bad.png"</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br /><br />    </span><span class="default">$imagick_type_bad_png </span><span class="keyword">= clone </span><span class="default">$imagick_type_bad</span><span class="keyword">;<br />    </span><span class="default">$imagick_type_bad_png</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">"png"</span><span class="keyword">);<br />    </span><span class="default">$imagick_type_bad_png</span><span class="keyword">-&gt;</span><span class="default">setFormat</span><span class="keyword">(</span><span class="string">"png"</span><span class="keyword">);<br />    </span><span class="default">$imagick_type_bad_png</span><span class="keyword">-&gt;</span><span class="default">writeImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_saving_bad_png</span><span class="keyword">);<br /><br />    </span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$file_handle_for_saving_bad_png</span><span class="keyword">);<br /><br />        </span><span class="comment">// Save File - Good DATA<br />        // ------------------------------<br /><br />    </span><span class="default">$file_handle_for_saving_good_bmp </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">"test_result_good.bmp"</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br /><br />    </span><span class="default">$imagick_type_good_bmp </span><span class="keyword">= clone </span><span class="default">$imagick_type_good</span><span class="keyword">;<br />    </span><span class="default">$imagick_type_good_bmp</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">"bmp"</span><span class="keyword">);<br />    </span><span class="default">$imagick_type_good_bmp</span><span class="keyword">-&gt;</span><span class="default">setFormat</span><span class="keyword">(</span><span class="string">"bmp"</span><span class="keyword">);<br />    </span><span class="default">$imagick_type_good_bmp</span><span class="keyword">-&gt;</span><span class="default">writeImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_saving_good_bmp</span><span class="keyword">);<br /><br />    </span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$file_handle_for_saving_good_bmp</span><span class="keyword">);<br /><br />    </span><span class="default">$file_handle_for_saving_good_png </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">"test_result_good.png"</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br /><br />    </span><span class="default">$imagick_type_good_png </span><span class="keyword">= clone </span><span class="default">$imagick_type_good</span><span class="keyword">;<br />    </span><span class="default">$imagick_type_good_png</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">"png"</span><span class="keyword">);<br />    </span><span class="default">$imagick_type_good_png</span><span class="keyword">-&gt;</span><span class="default">setFormat</span><span class="keyword">(</span><span class="string">"png"</span><span class="keyword">);<br />    </span><span class="default">$imagick_type_good_png</span><span class="keyword">-&gt;</span><span class="default">writeImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_saving_good_png</span><span class="keyword">);<br /><br />    </span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$file_handle_for_saving_good_png</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.readimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.readimage.php">＋<small>add a note</small></a></div>
