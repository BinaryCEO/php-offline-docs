...
<head>
  ...
  <title>PHP: XMLReader::moveToFirstAttribute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/xmlreader.movetofirstattribute.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/xmlreader.movetofirstattribute.php">
 <link rel="alternate" href="https://www.php.net/manual/en/xmlreader.movetofirstattribute.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.xmlreader.php">
 <link rel="prev" href="https://www.php.net/manual/en/xmlreader.movetoelement.php">
 <link rel="next" href="https://www.php.net/manual/en/xmlreader.movetonextattribute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/xmlreader.movetofirstattribute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/xmlreader.movetofirstattribute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/xmlreader.movetofirstattribute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/xmlreader.movetofirstattribute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/xmlreader.movetofirstattribute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/xmlreader.movetofirstattribute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/xmlreader.movetofirstattribute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/xmlreader.movetofirstattribute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/xmlreader.movetofirstattribute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/xmlreader.movetofirstattribute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/xmlreader.movetofirstattribute.php" hreflang="zh">
...
<meta name="Description" content="Position cursor on the first Attribute" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: XMLReader::moveToFirstAttribute - Manual" />
<meta name="twitter:description" content="Position cursor on the first Attribute" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: XMLReader::moveToFirstAttribute - Manual" />
<meta itemprop="description" content="Position cursor on the first Attribute" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Position cursor on the first Attribute" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="xmlreader.movetonextattribute.php">
          XMLReader::moveToNextAttribute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="xmlreader.movetoelement.php">
          &laquo; XMLReader::moveToElement        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/xmlreader.movetofirstattribute.php' selected="selected">English</option>
            <option value='de/xmlreader.movetofirstattribute.php'>German</option>
            <option value='es/xmlreader.movetofirstattribute.php'>Spanish</option>
            <option value='fr/xmlreader.movetofirstattribute.php'>French</option>
            <option value='it/xmlreader.movetofirstattribute.php'>Italian</option>
            <option value='ja/xmlreader.movetofirstattribute.php'>Japanese</option>
            <option value='pt_BR/xmlreader.movetofirstattribute.php'>Brazilian Portuguese</option>
            <option value='ru/xmlreader.movetofirstattribute.php'>Russian</option>
            <option value='tr/xmlreader.movetofirstattribute.php'>Turkish</option>
            <option value='uk/xmlreader.movetofirstattribute.php'>Ukrainian</option>
            <option value='zh/xmlreader.movetofirstattribute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="xmlreader.movetofirstattribute" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">XMLReader::moveToFirstAttribute</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">XMLReader::moveToFirstAttribute</span> &mdash; <span class="dc-title">Position cursor on the first Attribute</span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="xmlreader.movetonextattribute.php" class="methodname" rel="rdfs-seeAlso">XMLReader::moveToNextAttribute()</a> - Position cursor on the next Attribute</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xmlreader/xmlreader/movetofirstattribute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fxmlreader.movetofirstattribute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=xmlreader.movetofirstattribute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/xmlreader.movetofirstattribute.php">＋<small>add a note</small></a></span>
