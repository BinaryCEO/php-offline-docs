...
<head>
  ...
  <title>PHP: Imagick::rotationalBlurImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.rotationalblurimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.rotationalblurimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.rotationalblurimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.rotateimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.roundcorners.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.rotationalblurimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.rotationalblurimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.rotationalblurimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.rotationalblurimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.rotationalblurimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.rotationalblurimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.rotationalblurimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.rotationalblurimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.rotationalblurimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.rotationalblurimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.rotationalblurimage.php" hreflang="zh">
...
<meta name="Description" content="Rotational blurs an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::rotationalBlurImage - Manual" />
<meta name="twitter:description" content="Rotational blurs an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::rotationalBlurImage - Manual" />
<meta itemprop="description" content="Rotational blurs an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rotational blurs an image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.roundcorners.php">
          Imagick::roundCorners &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.rotateimage.php">
          &laquo; Imagick::rotateImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.rotationalblurimage.php' selected="selected">English</option>
            <option value='de/imagick.rotationalblurimage.php'>German</option>
            <option value='es/imagick.rotationalblurimage.php'>Spanish</option>
            <option value='fr/imagick.rotationalblurimage.php'>French</option>
            <option value='it/imagick.rotationalblurimage.php'>Italian</option>
            <option value='ja/imagick.rotationalblurimage.php'>Japanese</option>
            <option value='pt_BR/imagick.rotationalblurimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.rotationalblurimage.php'>Russian</option>
            <option value='tr/imagick.rotationalblurimage.php'>Turkish</option>
            <option value='uk/imagick.rotationalblurimage.php'>Ukrainian</option>
            <option value='zh/imagick.rotationalblurimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.rotationalblurimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::rotationalBlurImage</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::rotationalBlurImage</span> &mdash; <span class="dc-title">Rotational blurs an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.rotationalblurimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::rotationalBlurImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$angle</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.rotationalblurimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.rotationalblurimage-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.rotationalblurimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3082">
      <p><strong>Example #1  <span class="function"><strong>Imagick::rotationalBlurImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/rotationalblurimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.rotationalblurimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.rotationalblurimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.rotationalblurimage.php">＋<small>add a note</small></a></span>
