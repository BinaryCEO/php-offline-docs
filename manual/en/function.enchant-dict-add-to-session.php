...
<head>
  ...
  <title>PHP: enchant_dict_add_to_session - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.enchant-dict-add-to-session.php">
 <link rel="shorturl" href="https://www.php.net/enchant-dict-add-to-session">
 <link rel="alternate" href="https://www.php.net/enchant-dict-add-to-session" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.enchant.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.enchant-dict-add-to-personal.php">
 <link rel="next" href="https://www.php.net/manual/en/function.enchant-dict-check.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.enchant-dict-add-to-session.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.enchant-dict-add-to-session.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.enchant-dict-add-to-session.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.enchant-dict-add-to-session.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.enchant-dict-add-to-session.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.enchant-dict-add-to-session.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.enchant-dict-add-to-session.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.enchant-dict-add-to-session.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.enchant-dict-add-to-session.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.enchant-dict-add-to-session.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.enchant-dict-add-to-session.php" hreflang="zh">
...
<meta name="Description" content="Add 'word' to this spell-checking session" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: enchant_dict_add_to_session - Manual" />
<meta name="twitter:description" content="Add 'word' to this spell-checking session" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: enchant_dict_add_to_session - Manual" />
<meta itemprop="description" content="Add 'word' to this spell-checking session" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add 'word' to this spell-checking session" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.enchant-dict-check.php">
          enchant_dict_check &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.enchant-dict-add-to-personal.php">
          &laquo; enchant_dict_add_to_personal        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.enchant-dict-add-to-session.php' selected="selected">English</option>
            <option value='de/function.enchant-dict-add-to-session.php'>German</option>
            <option value='es/function.enchant-dict-add-to-session.php'>Spanish</option>
            <option value='fr/function.enchant-dict-add-to-session.php'>French</option>
            <option value='it/function.enchant-dict-add-to-session.php'>Italian</option>
            <option value='ja/function.enchant-dict-add-to-session.php'>Japanese</option>
            <option value='pt_BR/function.enchant-dict-add-to-session.php'>Brazilian Portuguese</option>
            <option value='ru/function.enchant-dict-add-to-session.php'>Russian</option>
            <option value='tr/function.enchant-dict-add-to-session.php'>Turkish</option>
            <option value='uk/function.enchant-dict-add-to-session.php'>Ukrainian</option>
            <option value='zh/function.enchant-dict-add-to-session.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.enchant-dict-add-to-session" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.enchant-broker-request-dict.php" class="function" rel="rdfs-seeAlso">enchant_broker_request_dict()</a> - Create a new dictionary using a tag</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/enchant/functions/enchant-dict-add-to-session.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.enchant-dict-add-to-session%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.enchant-dict-add-to-session&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.enchant-dict-add-to-session.php">＋<small>add a note</small></a></span>
