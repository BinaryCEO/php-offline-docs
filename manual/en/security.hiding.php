...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/security.hiding.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/security.hiding.php">
 <link rel="alternate" href="https://www.php.net/manual/en/security.hiding.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/security.php">
 <link rel="prev" href="https://www.php.net/manual/en/security.variables.php">
 <link rel="next" href="https://www.php.net/manual/en/security.current.php">

 <link rel="alternate" href="https://www.php.net/manual/en/security.hiding.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/security.hiding.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/security.hiding.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/security.hiding.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/security.hiding.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/security.hiding.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/security.hiding.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/security.hiding.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/security.hiding.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/security.hiding.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/security.hiding.php" hreflang="zh">
...
<meta name="Description" content="Hiding PHP" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Hiding PHP - Manual" />
<meta name="twitter:description" content="Hiding PHP" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Hiding PHP - Manual" />
<meta itemprop="description" content="Hiding PHP" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Hiding PHP" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/security.hiding.php'>Italian</option>
            ...
            <option value='uk/security.hiding.php'>Ukrainian</option>
...
AddType application/x-httpd-php .htm .html</pre>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/security/hiding.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsecurity.hiding%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=security.hiding&amp;repo=en&amp;redirect=https://www.php.net/manual/en/security.hiding.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">So far I haven't seen a working rewriter of /foo/bar into /foo/bar.php, so I created my own. It does work in top-level directory AND subdirectories and it doesn't need hardcoding the RewriteBase.<br /><br />.htaccess:<br /><br />RewriteEngine on<br /><br /># Rewrite /foo/bar to /foo/bar.php<br />RewriteRule ^([^.?]+)$ %{REQUEST_URI}.php [L]<br /><br /># Return 404 if original request is /foo/bar.php<br />RewriteCond %{THE_REQUEST} "^[^ ]* .*?\.php[? ].*$"<br />RewriteRule .* - [L,R=404]<br /><br /># NOTE! FOR APACHE ON WINDOWS: Add [NC] to RewriteCond like this:<br /># RewriteCond %{THE_REQUEST} "^[^ ]* .*?\.php[? ].*$" [NC]</span></code></div>
  ...
  <div class="note" id="113970">  <div class="votes">
    ...
    <div class="tally" id="V113970" title="56% like this...">
    26
    </div>
  </div>
  <a href="#113970" class="name">
  <strong class="user"><em>anon at example dot com</em></strong></a><a class="genanchor" href="#113970"> &para;</a><div class="date" title="2013-12-23 10:48"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113970">
<div class="phpcode"><code><span class="html">The session name defaults to PHPSESSID.  This is used as the name of the session cookie that is sent to the user's web browser / client. (Example: PHPSESSID=kqjqper294faui343o98ts8k77).<br /><br />To hide this, call session_name() with the $name parameter set to a generic name, before calling session_start().  Example:<br /><br />session_name("id");<br />session_start();<br /><br />Cheers.</span></code></div>
  </div>
 </div>
  <div class="note" id="128154">  <div class="votes">
    <div id="Vu128154">
    <a href="/manual/vote-note.php?id=128154&amp;page=security.hiding&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128154">
    <a href="/manual/vote-note.php?id=128154&amp;page=security.hiding&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128154" title="66% like this...">
    6
    </div>
  </div>
  <a href="#128154" class="name">
  <strong class="user"><em>Sajith Karunatilake @</em></strong></a><a class="genanchor" href="#128154"> &para;</a><div class="date" title="2023-01-26 09:24"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128154">
<div class="phpcode"><code><span class="html">Just hiding it doesn't look like good "security" if the code itself is flawed. At the end of the day the code has to run regardless of its file extension. There could be some advantages to this. But it does not prevent someone (who is not a script-kiddie or some kind of automated bot) from exploiting the flaws in the code.<br /><br />Just a thought.<br /><br />Just leaving this comment to prevent a beginner from using this as a legitimate security measure (assuming they read documentation). Cool feature though.</span></code></div>
  </div>
 </div>
  <div class="note" id="40772">  <div class="votes">
    ...
    <div class="tally" id="V40772" title="54% like this...">
    15
    </div>
  </div>
  <a href="#40772" class="name">
  <strong class="user"><em>mmj</em></strong></a><a class="genanchor" href="#40772"> &para;</a><div class="date" title="2004-03-14 05:58"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom40772">
<div class="phpcode"><code><span class="html">You can see if somebody's using PHP just by adding the following to the end of the URL:<br />?=PHPB8B5F2A0-3C92-11d3-A3A9-4C7B08C10000<br />If the page is using PHP, this will show the PHP credits.<br /><br />Setting expose_php to Off in php.ini prevents this.</span></code></div>
  </div>
 </div>
  <div class="note" id="28980">  <div class="votes">
    ...
    <div class="tally" id="V28980" title="57% like this...">
    10
    </div>
  </div>
  <a href="#28980" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#28980"> &para;</a><div class="date" title="2003-01-29 10:53"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom28980">
<div class="phpcode"><code><span class="html">PS. If you want to use pretty URLs (i.e. hide your .php extensions) AND you have safe-mode=on, the previous example (ForceType) won't work for you.  The problem is that safe-mode forces Apache to honor trailing characters in a requested URL.  This means that:
<br />
...
<br />Some people might question why we are overriding the trailing characters handling (with the AcceptPathInfo directive) instead of just turning safe-mode=off.  The reason is that safe mode sets global limitations on the entire server, which can then be turned on or left off for each specific virtual host.  This is the equivilent of blocking all connections on a firewall, and then opening up only the ones you want, which is a lot safer than leaving everything open globally, and assuming your programmers will never overlook a possible security hole.</span></code></div>
  ...
  <div class="note" id="86623">  <div class="votes">
    ...
    <div class="tally" id="V86623" title="55% like this...">
    10
    </div>
  </div>
  <a href="#86623" class="name">
  <strong class="user"><em>sandaimespaceman at gmail dot com</em></strong></a><a class="genanchor" href="#86623"> &para;</a><div class="date" title="2008-10-26 04:51"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86623">
<div class="phpcode"><code><span class="html">Set INI directive "expose_php" to "off" will also help.<br />You can spoof your PHP to ASP.NET by using:<br /><span class="default">&lt;?php<br />error_reporting</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"X-Powered-By: ASP.NET"</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">It's a good idea to "hide" PHP anyway so you can write a RESTful web application.<br /><br />Using Apache Mod Rewrite:<br /><br />RewriteEngine On<br />RewriteRule ^control/([^/]+)/(.*)$ sitecontroller.php?control=$1&amp;query=$2<br /><br />You then use a function like the following as a way to retrieve data (in a zero indexed fashion) from the $_GET superglobal.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">myGET</span><span class="keyword">() {<br />  </span><span class="default">$aGet </span><span class="keyword">= array();<br /><br />  if(isset(</span><span class="default">$_GET</span><span class="keyword">[</span><span class="string">'query'</span><span class="keyword">])) {<br />    </span><span class="default">$aGet </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">(</span><span class="string">'/'</span><span class="keyword">, </span><span class="default">$_GET</span><span class="keyword">[</span><span class="string">'query'</span><span class="keyword">]);<br />  }<br /><br />  return </span><span class="default">$aGet</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />This is only a really basic example of course - you can do a lot with Mod Rewrite and a custom 'GET' function.</span></code></div>
  ...
  <div class="note" id="86286">  <div class="votes">
    ...
    <div class="tally" id="V86286" title="54% like this...">
    8
    </div>
  </div>
  <a href="#86286" class="name">
  <strong class="user"><em>Pyornide</em></strong></a><a class="genanchor" href="#86286"> &para;</a><div class="date" title="2008-10-10 05:57"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86286">
<div class="phpcode"><code><span class="html">The idea of hiding the X-Powered-By in PHP is a flawed attempt at establishing security. As the manual indicates, obscurity is not security. If I were exploiting a site, I wouldn't check what scripting language the site runs on, because all that would matter to me is exploiting it. Hiding the fact that you use [x] language isn't going to prevent me from bypassing poor security.</span></code></div>
  </div>
 </div>
  <div class="note" id="53144">  <div class="votes">
    ...
    <div class="tally" id="V53144" title="55% like this...">
    7
    </div>
  </div>
  <a href="#53144" class="name">
  <strong class="user"><em>benjamin at sonntag dot fr</em></strong></a><a class="genanchor" href="#53144"> &para;</a><div class="date" title="2005-05-24 09:14"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom53144">
<div class="phpcode"><code><span class="html">In response to the previous messages, for apache, there is a easier way to set files without "." to be executed by PHP, just put this in a ".htaccess" file : <br /><br />DefaultType  application/x-httpd-php</span></code></div>
  </div>
 </div>
  <div class="note" id="18520">  <div class="votes">
    ...
    <div class="tally" id="V18520" title="54% like this...">
    8
    </div>
  </div>
  <a href="#18520" class="name">
  <strong class="user"><em>yasuo_ohgaki at yahoo dot com</em></strong></a><a class="genanchor" href="#18520"> &para;</a><div class="date" title="2002-01-26 03:59"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom18520">
<div class="phpcode"><code><span class="html">To hide PHP, you need following php.ini settings<br /><br />expose_php=Off <br />display_errors=Off<br /><br />and in httpd.conf<br /><br />ServerSignature Off<br />(min works, but I prefer off)</span></code></div>
  </div>
 </div>
  <div class="note" id="36936">  <div class="votes">
    ...
    <div class="tally" id="V36936" title="54% like this...">
    8
    </div>
  </div>
  <a href="#36936" class="name">
  <strong class="user"><em>ldemailly at qualysNOSPAM dot com</em></strong></a><a class="genanchor" href="#36936"> &para;</a><div class="date" title="2003-10-27 08:17"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom36936">
<div class="phpcode"><code><span class="html">adding MultiViews to your apache Options config<br />lets you hide/omit .php in the url without any rewriting, etc...</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">try this<br />RewriteEngine On<br /><br /># Unless directory, remove trailing slash<br />RewriteCond %{REQUEST_FILENAME} !-d<br />RewriteRule ^([^/]+)/$ <a href="http://example.com/folder/$1" rel="nofollow" target="_blank">http://example.com/folder/$1</a> [R=301,L]<br /><br /># Redirect external .php requests to extensionless url<br />RewriteCond %{THE_REQUEST} ^(.+)\.php([#?][^\ ]*)?\ HTTP/<br />RewriteRule ^(.+)\.php$ <a href="http://example.com/folder/$1" rel="nofollow" target="_blank">http://example.com/folder/$1</a> [R=301,L]<br /><br /># Resolve .php file for extensionless php urls<br />RewriteRule ^([^/.]+)$ $1.php [L]</span></code></div>
  ...
  <div class="note" id="54313">  <div class="votes">
    ...
    <div class="tally" id="V54313" title="54% like this...">
    5
    </div>
  </div>
  <a href="#54313" class="name">
  <strong class="user"><em>jtw90210</em></strong></a><a class="genanchor" href="#54313"> &para;</a><div class="date" title="2005-06-30 01:19"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom54313">
<div class="phpcode"><code><span class="html">In order to get the PATH_INFO to work in order to pass parameters using a hidden program/trailing slash/"pretty url" in more recent versions of PHP you MUST add "AcceptPathInfo On" to your httpd.conf. 
<br />
...
<br />ForceType application/x-httpd-php</span></code></div>
  </div>
 </div>
  <div class="note" id="42332">  <div class="votes">
    ...
    <div class="tally" id="V42332" title="53% like this...">
    6
    </div>
  </div>
  <a href="#42332" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#42332"> &para;</a><div class="date" title="2004-05-12 08:20"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom42332">
<div class="phpcode"><code><span class="html">Keep in mind, if your really freaked out over hiding PHP, GD will expose you.<br /><br />Go ahead - make an image with GD and open with a text editor.. Somewhere in there you'll see a comment with gd &amp; php all over it.</span></code></div>
  </div>
 </div>
  <div class="note" id="17872">  <div class="votes">
    ...
    <div class="tally" id="V17872" title="54% like this...">
    5
    </div>
  </div>
  <a href="#17872" class="name">
  <strong class="user"><em>istvan dot takacsNOSPAM at hungax dot com</em></strong></a><a class="genanchor" href="#17872"> &para;</a><div class="date" title="2001-12-30 09:42"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom17872">
<div class="phpcode"><code><span class="html">And use the
<br />ServerTokens min
<br />directive in your httpd.conf to hide installed PHP modules in apache.</span></code></div>
  </div>
 </div>
  <div class="note" id="34285">  <div class="votes">
    ...
    <div class="tally" id="V34285" title="53% like this...">
    5
    </div>
  </div>
  <a href="#34285" class="name">
  <strong class="user"><em>l0rdphi1 at liquefyr dot com</em></strong></a><a class="genanchor" href="#34285"> &para;</a><div class="date" title="2003-07-21 04:02"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom34285">
<div class="phpcode"><code><span class="html">More fun includes files without file extensions.
<br />
...
<br />Enjoy =)</span></code></div>
  ...
  <div class="note" id="23561">  <div class="votes">
    ...
    <div class="tally" id="V23561" title="52% like this...">
    4
    </div>
  </div>
  <a href="#23561" class="name">
  <strong class="user"><em>m1tk4 at hotmail dot com</em></strong></a><a class="genanchor" href="#23561"> &para;</a><div class="date" title="2002-07-22 05:53"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom23561">
<div class="phpcode"><code><span class="html">I usually do:<br /><br />&lt;code&gt;<br />RewriteEngine on&lt;br&gt;<br />RewriteOptions inherit&lt;br&gt;<br />RewriteRule (.*)\.htm[l]?(.*) $1.php$2 [nocase]&lt;br&gt;<br />&lt;/code&gt;<br /><br />in .htaccess. You'll need mod_rewrite installed for this .</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Using the .php extension for all your scripts is not necessary, and in fact can be harmful (by exposing too much information about your server, and by limiting what you can do in the future without breaking links). There are several ways to hide your .php script extension:<br /><br />(1) Don't hard code file types at all.  Don't specify any dots, and most web servers will automatically find your .php, .html, .pdf, .gif or other matching file. This is called canonical URL format:<br />     www.xxxxxx.com/page<br />    www.xxxxxx.com/directory/<br />This gives you great flexibility to change your mind in the future, and prevents Windows browsers from making improper assumptions about the file type.<br /><br />(2) In an Apache .htaccess file use:<br />    RewriteEngine on<br />    RewriteRule page.html page.php<br /><br />(3) Force the webserver to interpret ALL .html files as .php:<br />    AddType application/x-httpd-php .php3 .php .html</span></code></div>
  ...
  <div class="note" id="68777">  <div class="votes">
    ...
    <div class="tally" id="V68777" title="49% like this...">
    -1
    </div>
  </div>
  <a href="#68777" class="name">
  <strong class="user"><em>simon at carbontwelevedesign dot co dot uk</em></strong></a><a class="genanchor" href="#68777"> &para;</a><div class="date" title="2006-08-10 05:31"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom68777">
<div class="phpcode"><code><span class="html">I use the following in the .htaccess document<br /><br />&lt;IfModule mod_rewrite.c&gt;<br />RewriteEngine On<br />RewriteBase /<br />RewriteCond %{REQUEST_FILENAME} !-f<br />RewriteCond %{REQUEST_FILENAME} !-d<br />RewriteRule . /index.php [L]<br />&lt;/IfModule&gt;<br /><br />then the following simple code<br /><br /><span class="default">&lt;?php<br /><br />$permalinks </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">(</span><span class="string">"/"</span><span class="keyword">,</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'REQUEST_URI'</span><span class="keyword">]);<br /><br /></span><span class="default">$varone </span><span class="keyword">= </span><span class="default">$permalinks</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">];<br /></span><span class="default">$vartwo </span><span class="keyword">= </span><span class="default">$permalinks</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">];<br /><br />...<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="43240">  <div class="votes">
    ...
    <div class="tally" id="V43240" title="47% like this...">
    -4
    </div>
  </div>
  <a href="#43240" class="name">
  <strong class="user"><em>php at vfmedia dot de</em></strong></a><a class="genanchor" href="#43240"> &para;</a><div class="date" title="2004-06-15 06:21"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom43240">
<div class="phpcode"><code><span class="html">I?ve found an easy way to hide php code and the uri is searchable by google and others...(only for unix or linux)<br /><br />At first I have some rules in my hide.conf (i made an extra .conf for it (apache 2.0))<br /><br />For example when I want to mask the index.php<br /><br />&lt;Files index&gt;<br /> ForceType application/x-httpd-php<br /> &lt;/Files&gt;<br /><br />My problem is, that my code should be readable...<br /><br />so I made an extra folder for example srv/www/htdocs/static_output<br /><br />My phpcode is in the includefolder....(for ex. mnt/source/index.php)<br /><br />Then I made a link in the shell  &gt; ln mnt/source/index.php srv/www/htdocs/static_output/index<br /><br />So the code is readable (with .php extension) in my includefolder and there is only the link in the srv folder without extension(which is called by the browser...).</span></code></div>
  </div>
 </div>
  <div class="note" id="122229">  <div class="votes">
    <div id="Vu122229">
    <a href="/manual/vote-note.php?id=122229&amp;page=security.hiding&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122229">
    <a href="/manual/vote-note.php?id=122229&amp;page=security.hiding&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122229" title="40% like this...">
    -5
    </div>
  </div>
  <a href="#122229" class="name">
  <strong class="user"><em>omolewastephen at gmail dot com</em></strong></a><a class="genanchor" href="#122229"> &para;</a><div class="date" title="2018-01-04 10:03"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122229">
<div class="phpcode"><code><span class="html">I used this on my site and it works great for me<br /><br /># RewriteEngine on<br /><br /># Rewrite /foo/bar to /foo/bar.php<br /># RewriteRule ^([^.?]+)$ %{REQUEST_URI}.php [L]<br /><br /># Return 404 if original request is /foo/bar.php<br /># RewriteCond %{THE_REQUEST} "^[^ ]* .*?\.php[? ].*$"<br /># RewriteRule .* - [L,R=404]<br /><br /># NOTE! FOR APACHE ON WINDOWS: Add [NC] to RewriteCond like this:<br /># RewriteCond %{THE_REQUEST} "^[^ ]* .*?\.php[? ].*$" [NC]</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=security.hiding&amp;repo=en&amp;redirect=https://www.php.net/manual/en/security.hiding.php">＋<small>add a note</small></a></div>
