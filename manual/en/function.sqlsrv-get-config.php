...
<head>
  ...
  <title>PHP: sqlsrv_get_config - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sqlsrv-get-config.php">
 <link rel="shorturl" href="https://www.php.net/sqlsrv-get-config">
 <link rel="alternate" href="https://www.php.net/sqlsrv-get-config" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sqlsrv-free-stmt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sqlsrv-get-field.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sqlsrv-get-config.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sqlsrv-get-config.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sqlsrv-get-config.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sqlsrv-get-config.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sqlsrv-get-config.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sqlsrv-get-config.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sqlsrv-get-config.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sqlsrv-get-config.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sqlsrv-get-config.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sqlsrv-get-config.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sqlsrv-get-config.php" hreflang="zh">
...
<meta name="Description" content="Returns the value of the specified configuration setting" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sqlsrv_get_config - Manual" />
<meta name="twitter:description" content="Returns the value of the specified configuration setting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sqlsrv_get_config - Manual" />
<meta itemprop="description" content="Returns the value of the specified configuration setting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the value of the specified configuration setting" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sqlsrv-get-field.php">
          sqlsrv_get_field &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sqlsrv-free-stmt.php">
          &laquo; sqlsrv_free_stmt        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sqlsrv-get-config.php' selected="selected">English</option>
            <option value='de/function.sqlsrv-get-config.php'>German</option>
            <option value='es/function.sqlsrv-get-config.php'>Spanish</option>
            <option value='fr/function.sqlsrv-get-config.php'>French</option>
            <option value='it/function.sqlsrv-get-config.php'>Italian</option>
            <option value='ja/function.sqlsrv-get-config.php'>Japanese</option>
            <option value='pt_BR/function.sqlsrv-get-config.php'>Brazilian Portuguese</option>
            <option value='ru/function.sqlsrv-get-config.php'>Russian</option>
            <option value='tr/function.sqlsrv-get-config.php'>Turkish</option>
            <option value='uk/function.sqlsrv-get-config.php'>Ukrainian</option>
            <option value='zh/function.sqlsrv-get-config.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sqlsrv-get-config" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.sqlsrv-configure.php" class="function" rel="rdfs-seeAlso">sqlsrv_configure()</a> - Changes the driver error handling and logging configurations</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlsrv/functions/sqlsrv-get-config.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sqlsrv-get-config%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sqlsrv-get-config&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-get-config.php">＋<small>add a note</small></a></span>
