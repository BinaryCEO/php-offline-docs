...
<head>
  ...
  <title>PHP: imagecolormatch - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecolormatch.php">
 <link rel="shorturl" href="https://www.php.net/imagecolormatch">
 <link rel="alternate" href="https://www.php.net/imagecolormatch" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecolorexactalpha.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecolorresolve.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecolormatch.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecolormatch.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecolormatch.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecolormatch.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecolormatch.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecolormatch.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecolormatch.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecolormatch.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecolormatch.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecolormatch.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecolormatch.php" hreflang="zh">
...
<meta name="Description" content="Makes the colors of the palette version of an image more closely match the true color version" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagecolormatch - Manual" />
<meta name="twitter:description" content="Makes the colors of the palette version of an image more closely match the true color version" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecolormatch - Manual" />
<meta itemprop="description" content="Makes the colors of the palette version of an image more closely match the true color version" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Makes the colors of the palette version of an image more closely match the true color version" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imagecolorresolve.php">
          imagecolorresolve &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagecolorexactalpha.php">
          &laquo; imagecolorexactalpha        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecolormatch.php' selected="selected">English</option>
            <option value='de/function.imagecolormatch.php'>German</option>
            <option value='es/function.imagecolormatch.php'>Spanish</option>
            <option value='fr/function.imagecolormatch.php'>French</option>
            <option value='it/function.imagecolormatch.php'>Italian</option>
            <option value='ja/function.imagecolormatch.php'>Japanese</option>
            <option value='pt_BR/function.imagecolormatch.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecolormatch.php'>Russian</option>
            <option value='tr/function.imagecolormatch.php'>Turkish</option>
            <option value='uk/function.imagecolormatch.php'>Ukrainian</option>
            <option value='zh/function.imagecolormatch.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecolormatch" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.imagecolormatch-examples">
  ...
  <div class="example" id="example-2848">
   <p><strong>Example #1 <span class="function"><strong>imagecolormatch()</strong></span> example</strong></p>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagecreatetruecolor.php" class="function" rel="rdfs-seeAlso">imagecreatetruecolor()</a> - Create a new true color image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecolormatch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecolormatch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecolormatch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecolormatch.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="98634">  <div class="votes">
    <div id="Vu98634">
    <a href="/manual/vote-note.php?id=98634&amp;page=function.imagecolormatch&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98634">
    <a href="/manual/vote-note.php?id=98634&amp;page=function.imagecolormatch&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98634" title="75% like this...">
    2
    </div>
  </div>
  <a href="#98634" class="name">
  <strong class="user"><em>gk at karko dot net</em></strong></a><a class="genanchor" href="#98634"> &para;</a><div class="date" title="2010-06-28 09:42"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98634">
<div class="phpcode"><code><span class="html">Those that have Ubuntu servers note, that this function is added in PHP's GD library fork and is not available by default in Ubuntu php5-gd package.<br /><br />Here's how-to install the PHP GD version: <a href="http://preview.tinyurl.com/yel4r7t" rel="nofollow" target="_blank">http://preview.tinyurl.com/yel4r7t</a></span></code></div>
  </div>
 </div>
  <div class="note" id="59654">  <div class="votes">
    <div id="Vu59654">
    <a href="/manual/vote-note.php?id=59654&amp;page=function.imagecolormatch&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd59654">
    <a href="/manual/vote-note.php?id=59654&amp;page=function.imagecolormatch&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V59654" title="60% like this...">
    1
    </div>
  </div>
  <a href="#59654" class="name">
  <strong class="user"><em>albriNOght at anSPAMre dot net</em></strong></a><a class="genanchor" href="#59654"> &para;</a><div class="date" title="2005-12-12 09:22"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom59654">
<div class="phpcode"><code><span class="html">This function appears to work by changing the values of the colors of the paletted image -- no good if you're trying to force the resultant image to stick with certain pre-defined color values.</span></code></div>
  </div>
 </div>
  <div class="note" id="39726">  <div class="votes">
    <div id="Vu39726">
    <a href="/manual/vote-note.php?id=39726&amp;page=function.imagecolormatch&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd39726">
    <a href="/manual/vote-note.php?id=39726&amp;page=function.imagecolormatch&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V39726" title="50% like this...">
    0
    </div>
  </div>
  <a href="#39726" class="name">
  <strong class="user"><em>Samantha</em></strong></a><a class="genanchor" href="#39726"> &para;</a><div class="date" title="2004-02-08 07:14"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom39726">
<div class="phpcode"><code><span class="html">This function is a godsend! It works exactly as documented.<br /><br />I'm working on an application where I need to take a transparent GIF, matte the GIF on a user defined background color, and finally scale the GIF based on a user defined %.<br /><br />The only way I could get this to work so that the final image was high quality, ie: no jagged edges, and a smooth scale, was to convert the GIF to a JPG, and then copy the JPG into a new GIF image like this:<br /><br />// open transparent gif<br />$GIFimg = imagecreatefromgif($file_path);<br /><br />// create jpg image<br />$JPGimg = imagecreatetruecolor($width, $height);<br /><br />// copy GIF to JPG<br />imagecopy($JPGimg, $GIFimg, 0, 0, 0, 0, $width, $height); <br /><br />// create a true color image<br />$JPGscaled = imagecreatetruecolor($n_width, $n_height);<br /><br />// scale the new JPG using the truecolor image<br />imagecopyresampled($JPGscaled, $JPGimg, 0, 0, 0, 0, $new_width, $new_height, $width, $height);<br /><br />// create final GIF image<br />$GIFfinal = imagecreate($n_width, $n_height);<br /><br />// copy the scaled JPG back to a GIF<br />imagecopymerge($GIFfinal, $JPGscaled, 0, 0, 0, 0, $n_width, $n_height, 100);<br /><br />This worked great except the final step, copying the JPG to a GIF. If the JPG had too many colors, the function would index the colors to make it a palette image. So what would end up happening is the final image contained INCORRECT colors.<br /><br />Adding this one line at the bottom of the code fixed everything.<br /><br />imagecolormatch($JPGscaled, $GIFfinal);<br /><br />I hope this helps anyone who is converting images back and forth and dealing with palette issues and color correction. Also, be aware that the above code is a sample and will not work by copying and pasting.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagecolormatch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecolormatch.php">＋<small>add a note</small></a></div>
