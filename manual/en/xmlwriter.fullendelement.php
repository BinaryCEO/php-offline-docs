...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/xmlwriter.fullendelement.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/xmlwriter.fullendelement.php">
 <link rel="alternate" href="https://www.php.net/manual/en/xmlwriter.fullendelement.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.xmlwriter.php">
 <link rel="prev" href="https://www.php.net/manual/en/xmlwriter.flush.php">
 <link rel="next" href="https://www.php.net/manual/en/xmlwriter.openmemory.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/xmlwriter.fullendelement.php' selected="selected">English</option>
            ...
            <option value='pt_BR/xmlwriter.fullendelement.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8, PECL xmlwriter &gt;= 2.0.4)</p><p class="refpurpose"><span class="refname">XMLWriter::fullEndElement</span> -- <span class="refname">xmlwriter_full_end_element</span> &mdash; <span class="dc-title">End current element</span></p>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="xmlwriter.endelement.php" class="methodname" rel="rdfs-seeAlso">XMLWriter::endElement()</a> - End current element</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xmlwriter/xmlwriter/fullendelement.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fxmlwriter.fullendelement%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=xmlwriter.fullendelement&amp;repo=en&amp;redirect=https://www.php.net/manual/en/xmlwriter.fullendelement.php">＋<small>add a note</small></a></span>
