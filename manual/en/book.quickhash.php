...
<head>
  ...
  <title>PHP: Quickhash - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.quickhash.php">
 <link rel="shorturl" href="https://www.php.net/quickhash">
 <link rel="alternate" href="https://www.php.net/quickhash" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/refs.basic.vartype.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.unregister-tick-function.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.quickhash.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.quickhash.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.quickhash.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.quickhash.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.quickhash.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.quickhash.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.quickhash.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.quickhash.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.quickhash.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.quickhash.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.quickhash.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.quickhash.php" hreflang="zh">
...
<meta name="Description" content="Quickhash" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Quickhash - Manual" />
<meta name="twitter:description" content="Quickhash" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Quickhash - Manual" />
<meta itemprop="description" content="Quickhash" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Quickhash" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intro.quickhash.php">
          Introduction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.unregister-tick-function.php">
          &laquo; unregister_tick_function        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.quickhash.php' selected="selected">English</option>
            <option value='de/book.quickhash.php'>German</option>
            <option value='es/book.quickhash.php'>Spanish</option>
            <option value='fr/book.quickhash.php'>French</option>
            <option value='it/book.quickhash.php'>Italian</option>
            <option value='ja/book.quickhash.php'>Japanese</option>
            <option value='pt_BR/book.quickhash.php'>Brazilian Portuguese</option>
            <option value='ru/book.quickhash.php'>Russian</option>
            <option value='tr/book.quickhash.php'>Turkish</option>
            <option value='uk/book.quickhash.php'>Ukrainian</option>
            <option value='zh/book.quickhash.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.quickhash" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.quickhash.php">Introduction</a></li><li><a href="quickhash.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="quickhash.requirements.php">Requirements</a></li><li><a href="quickhash.installation.php">Installation</a></li></ul></li><li><a href="quickhash.examples.php">Examples</a></li><li><a href="class.quickhashintset.php">QuickHashIntSet</a> — The QuickHashIntSet class<ul class="chunklist chunklist_book chunklist_children"><li><a href="quickhashintset.add.php">QuickHashIntSet::add</a> — This method adds a new entry to the set</li><li><a href="quickhashintset.construct.php">QuickHashIntSet::__construct</a> — Creates a new QuickHashIntSet object</li><li><a href="quickhashintset.delete.php">QuickHashIntSet::delete</a> — This method deletes an entry from the set</li><li><a href="quickhashintset.exists.php">QuickHashIntSet::exists</a> — This method checks whether a key is part of the set</li><li><a href="quickhashintset.getsize.php">QuickHashIntSet::getSize</a> — Returns the number of elements in the set</li><li><a href="quickhashintset.loadfromfile.php">QuickHashIntSet::loadFromFile</a> — This factory method creates a set from a file</li><li><a href="quickhashintset.loadfromstring.php">QuickHashIntSet::loadFromString</a> — This factory method creates a set from a string</li><li><a href="quickhashintset.savetofile.php">QuickHashIntSet::saveToFile</a> — This method stores an in-memory set to disk</li><li><a href="quickhashintset.savetostring.php">QuickHashIntSet::saveToString</a> — This method returns a serialized version of the set</li></ul></li><li><a href="class.quickhashinthash.php">QuickHashIntHash</a> — The QuickHashIntHash class<ul class="chunklist chunklist_book chunklist_children"><li><a href="quickhashinthash.add.php">QuickHashIntHash::add</a> — This method adds a new entry to the hash</li><li><a href="quickhashinthash.construct.php">QuickHashIntHash::__construct</a> — Creates a new QuickHashIntHash object</li><li><a href="quickhashinthash.delete.php">QuickHashIntHash::delete</a> — This method deletes an entry from the hash</li><li><a href="quickhashinthash.exists.php">QuickHashIntHash::exists</a> — This method checks whether a key is part of the hash</li><li><a href="quickhashinthash.get.php">QuickHashIntHash::get</a> — This method retrieves a value from the hash by its key</li><li><a href="quickhashinthash.getsize.php">QuickHashIntHash::getSize</a> — Returns the number of elements in the hash</li><li><a href="quickhashinthash.loadfromfile.php">QuickHashIntHash::loadFromFile</a> — This factory method creates a hash from a file</li><li><a href="quickhashinthash.loadfromstring.php">QuickHashIntHash::loadFromString</a> — This factory method creates a hash from a string</li><li><a href="quickhashinthash.savetofile.php">QuickHashIntHash::saveToFile</a> — This method stores an in-memory hash to disk</li><li><a href="quickhashinthash.savetostring.php">QuickHashIntHash::saveToString</a> — This method returns a serialized version of the hash</li><li><a href="quickhashinthash.set.php">QuickHashIntHash::set</a> — This method updates an entry in the hash with a new value, or
  ...
  adds a new one if the entry doesn't exist</li><li><a href="quickhashintstringhash.update.php">QuickHashIntStringHash::update</a> — This method updates an entry in the hash with a new value</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/quickhash/book.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.quickhash%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.quickhash&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.quickhash.php">＋<small>add a note</small></a></span>
