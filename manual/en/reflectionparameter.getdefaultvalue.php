...
<head>
  ...
  <title>PHP: ReflectionParameter::getDefaultValue - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionparameter.getdefaultvalue.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionparameter.getdefaultvalue.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionparameter.getdefaultvalue.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionparameter.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionparameter.getdeclaringfunction.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionparameter.getdefaultvalueconstantname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionparameter.getdefaultvalue.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionparameter.getdefaultvalue.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionparameter.getdefaultvalue.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionparameter.getdefaultvalue.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionparameter.getdefaultvalue.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionparameter.getdefaultvalue.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionparameter.getdefaultvalue.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionparameter.getdefaultvalue.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionparameter.getdefaultvalue.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionparameter.getdefaultvalue.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionparameter.getdefaultvalue.php" hreflang="zh">
...
<meta name="Description" content="Gets default parameter value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionParameter::getDefaultValue - Manual" />
<meta name="twitter:description" content="Gets default parameter value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionParameter::getDefaultValue - Manual" />
<meta itemprop="description" content="Gets default parameter value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets default parameter value" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionparameter.getdefaultvalueconstantname.php">
          ReflectionParameter::getDefaultValueConstantName &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionparameter.getdeclaringfunction.php">
          &laquo; ReflectionParameter::getDeclaringFunction        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionparameter.getdefaultvalue.php' selected="selected">English</option>
            <option value='de/reflectionparameter.getdefaultvalue.php'>German</option>
            <option value='es/reflectionparameter.getdefaultvalue.php'>Spanish</option>
            <option value='fr/reflectionparameter.getdefaultvalue.php'>French</option>
            <option value='it/reflectionparameter.getdefaultvalue.php'>Italian</option>
            <option value='ja/reflectionparameter.getdefaultvalue.php'>Japanese</option>
            <option value='pt_BR/reflectionparameter.getdefaultvalue.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionparameter.getdefaultvalue.php'>Russian</option>
            <option value='tr/reflectionparameter.getdefaultvalue.php'>Turkish</option>
            <option value='uk/reflectionparameter.getdefaultvalue.php'>Ukrainian</option>
            <option value='zh/reflectionparameter.getdefaultvalue.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionparameter.getdefaultvalue" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionparameter.getdefaultvalue-examples">
  ...
  <p class="para">
   <div class="example" id="example-5584">
    <p><strong>Example #1 Getting default values of function parameters</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionparameter.ispassedbyreference.php" class="methodname" rel="rdfs-seeAlso">ReflectionParameter::isPassedByReference()</a> - Checks if passed by reference</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionparameter/getdefaultvalue.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionparameter.getdefaultvalue%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionparameter.getdefaultvalue&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionparameter.getdefaultvalue.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119337">  <div class="votes">
    <div id="Vu119337">
    <a href="/manual/vote-note.php?id=119337&amp;page=reflectionparameter.getdefaultvalue&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119337">
    <a href="/manual/vote-note.php?id=119337&amp;page=reflectionparameter.getdefaultvalue&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119337" title="66% like this...">
    3
    </div>
  </div>
  <a href="#119337" class="name">
  <strong class="user"><em>gmail@asmqb7</em></strong></a><a class="genanchor" href="#119337"> &para;</a><div class="date" title="2016-05-16 12:57"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119337">
<div class="phpcode"><code><span class="html">[Editor's note: fixed on user's request]
<br />
<br />Getting `Uncaught ReflectionException: Internal error: Failed to retrieve the default value`?
<br />
<br />You have to wrap this inside -&gt;isDefaultValueAvailable().</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionparameter.getdefaultvalue&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionparameter.getdefaultvalue.php">＋<small>add a note</small></a></div>
