...
<head>
  ...
  <title>PHP: streamWrapper::stream_metadata - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/streamwrapper.stream-metadata.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/streamwrapper.stream-metadata.php">
 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.stream-metadata.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.streamwrapper.php">
 <link rel="prev" href="https://www.php.net/manual/en/streamwrapper.stream-lock.php">
 <link rel="next" href="https://www.php.net/manual/en/streamwrapper.stream-open.php">

 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.stream-metadata.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/streamwrapper.stream-metadata.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/streamwrapper.stream-metadata.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/streamwrapper.stream-metadata.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/streamwrapper.stream-metadata.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/streamwrapper.stream-metadata.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/streamwrapper.stream-metadata.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/streamwrapper.stream-metadata.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/streamwrapper.stream-metadata.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/streamwrapper.stream-metadata.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/streamwrapper.stream-metadata.php" hreflang="zh">
...
<meta name="Description" content="Change stream metadata" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: streamWrapper::stream_metadata - Manual" />
<meta name="twitter:description" content="Change stream metadata" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: streamWrapper::stream_metadata - Manual" />
<meta itemprop="description" content="Change stream metadata" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Change stream metadata" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="streamwrapper.stream-open.php">
          streamWrapper::stream_open &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="streamwrapper.stream-lock.php">
          &laquo; streamWrapper::stream_lock        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/streamwrapper.stream-metadata.php' selected="selected">English</option>
            <option value='de/streamwrapper.stream-metadata.php'>German</option>
            <option value='es/streamwrapper.stream-metadata.php'>Spanish</option>
            <option value='fr/streamwrapper.stream-metadata.php'>French</option>
            <option value='it/streamwrapper.stream-metadata.php'>Italian</option>
            <option value='ja/streamwrapper.stream-metadata.php'>Japanese</option>
            <option value='pt_BR/streamwrapper.stream-metadata.php'>Brazilian Portuguese</option>
            <option value='ru/streamwrapper.stream-metadata.php'>Russian</option>
            <option value='tr/streamwrapper.stream-metadata.php'>Turkish</option>
            <option value='uk/streamwrapper.stream-metadata.php'>Ukrainian</option>
            <option value='zh/streamwrapper.stream-metadata.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="streamwrapper.stream-metadata" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.chgrp.php" class="function" rel="rdfs-seeAlso">chgrp()</a> - Changes file group</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/streamwrapper/stream-metadata.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fstreamwrapper.stream-metadata%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=streamwrapper.stream-metadata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/streamwrapper.stream-metadata.php">＋<small>add a note</small></a></span>
