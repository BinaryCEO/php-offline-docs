...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-open-memory-image.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-open-image-file.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-place-image.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-open-memory-image.php' selected="selected">English</option>
            ...
            <option value='tr/function.ps-open-memory-image.php'>Turkish</option>
   ...
   <dl>
     ...
     <dd>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-open-memory-image.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-open-memory-image%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-open-memory-image&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-open-memory-image.php">＋<small>add a note</small></a></span>
