...
<head>
  ...
  <title>PHP: openssl_x509_fingerprint - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-x509-fingerprint.php">
 <link rel="shorturl" href="https://www.php.net/openssl-x509-fingerprint">
 <link rel="alternate" href="https://www.php.net/openssl-x509-fingerprint" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-x509-export-to-file.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-x509-free.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-x509-fingerprint.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-x509-fingerprint.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-x509-fingerprint.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-x509-fingerprint.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-x509-fingerprint.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-x509-fingerprint.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-x509-fingerprint.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-x509-fingerprint.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-x509-fingerprint.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-x509-fingerprint.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-x509-fingerprint.php" hreflang="zh">
...
<meta name="Description" content="Calculates the fingerprint, or digest, of a given X.509 certificate" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_x509_fingerprint - Manual" />
<meta name="twitter:description" content="Calculates the fingerprint, or digest, of a given X.509 certificate" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_x509_fingerprint - Manual" />
<meta itemprop="description" content="Calculates the fingerprint, or digest, of a given X.509 certificate" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calculates the fingerprint, or digest, of a given X.509 certificate" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-x509-free.php">
          openssl_x509_free &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-x509-export-to-file.php">
          &laquo; openssl_x509_export_to_file        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-x509-fingerprint.php' selected="selected">English</option>
            <option value='de/function.openssl-x509-fingerprint.php'>German</option>
            <option value='es/function.openssl-x509-fingerprint.php'>Spanish</option>
            <option value='fr/function.openssl-x509-fingerprint.php'>French</option>
            <option value='it/function.openssl-x509-fingerprint.php'>Italian</option>
            <option value='ja/function.openssl-x509-fingerprint.php'>Japanese</option>
            <option value='pt_BR/function.openssl-x509-fingerprint.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-x509-fingerprint.php'>Russian</option>
            <option value='tr/function.openssl-x509-fingerprint.php'>Turkish</option>
            <option value='uk/function.openssl-x509-fingerprint.php'>Ukrainian</option>
            <option value='zh/function.openssl-x509-fingerprint.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-x509-fingerprint" class="refentry">
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-x509-fingerprint.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-x509-fingerprint%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-x509-fingerprint&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-x509-fingerprint.php">＋<small>add a note</small></a></span>
