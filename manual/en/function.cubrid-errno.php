...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-errno.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-db-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-error.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-errno.php' selected="selected">English</option>
            ...
            <option value='zh/function.cubrid-errno.php'>Chinese (Simplified)</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.cubrid-error-msg.php" class="function" rel="rdfs-seeAlso">cubrid_error_msg()</a> - Get last error message for the most recent function call</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/cubridmysql/cubrid-errno.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-errno%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-errno.php">＋<small>add a note</small></a></span>
