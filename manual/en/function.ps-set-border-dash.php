...
<head>
  ...
  <title>PHP: ps_set_border_dash - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-set-border-dash.php">
 <link rel="shorturl" href="https://www.php.net/ps-set-border-dash">
 <link rel="alternate" href="https://www.php.net/ps-set-border-dash" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-set-border-color.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-set-border-style.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-set-border-dash.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-set-border-dash.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-set-border-dash.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-set-border-dash.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-set-border-dash.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-set-border-dash.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-set-border-dash.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-set-border-dash.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-set-border-dash.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-set-border-dash.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-set-border-dash.php" hreflang="zh">
...
<meta name="Description" content="Sets length of dashes for border of annotations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_set_border_dash - Manual" />
<meta name="twitter:description" content="Sets length of dashes for border of annotations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_set_border_dash - Manual" />
<meta itemprop="description" content="Sets length of dashes for border of annotations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets length of dashes for border of annotations" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-set-border-style.php">
          ps_set_border_style &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-set-border-color.php">
          &laquo; ps_set_border_color        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-set-border-dash.php' selected="selected">English</option>
            <option value='de/function.ps-set-border-dash.php'>German</option>
            <option value='es/function.ps-set-border-dash.php'>Spanish</option>
            <option value='fr/function.ps-set-border-dash.php'>French</option>
            <option value='it/function.ps-set-border-dash.php'>Italian</option>
            <option value='ja/function.ps-set-border-dash.php'>Japanese</option>
            <option value='pt_BR/function.ps-set-border-dash.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-set-border-dash.php'>Russian</option>
            <option value='tr/function.ps-set-border-dash.php'>Turkish</option>
            <option value='uk/function.ps-set-border-dash.php'>Ukrainian</option>
            <option value='zh/function.ps-set-border-dash.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-set-border-dash" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_set_border_dash</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_set_border_dash</span> &mdash; <span class="dc-title">Sets length of dashes for border of annotations</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-set-border-dash-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_set_border_dash</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$black</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$white</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-set-border-dash-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">black</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">white</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-set-border-dash-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-set-border-dash-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-set-border-style.php" class="function" rel="rdfs-seeAlso">ps_set_border_style()</a> - Sets border style of annotations</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-set-border-dash.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-set-border-dash%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-set-border-dash&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-set-border-dash.php">＋<small>add a note</small></a></span>
