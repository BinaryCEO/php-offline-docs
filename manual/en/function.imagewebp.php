...
<head>
  ...
  <title>PHP: imagewebp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagewebp.php">
 <link rel="shorturl" href="https://www.php.net/imagewebp">
 <link rel="alternate" href="https://www.php.net/imagewebp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagewbmp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagexbm.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagewebp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagewebp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagewebp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagewebp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagewebp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagewebp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagewebp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagewebp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagewebp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagewebp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagewebp.php" hreflang="zh">
...
<meta name="Description" content="Output a WebP image to browser or file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagewebp - Manual" />
<meta name="twitter:description" content="Output a WebP image to browser or file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagewebp - Manual" />
<meta itemprop="description" content="Output a WebP image to browser or file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Output a WebP image to browser or file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagewebp.php' selected="selected">English</option>
            <option value='de/function.imagewebp.php'>German</option>
            <option value='es/function.imagewebp.php'>Spanish</option>
            <option value='fr/function.imagewebp.php'>French</option>
            <option value='it/function.imagewebp.php'>Italian</option>
            <option value='ja/function.imagewebp.php'>Japanese</option>
            <option value='pt_BR/function.imagewebp.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagewebp.php'>Russian</option>
            <option value='tr/function.imagewebp.php'>Turkish</option>
            <option value='uk/function.imagewebp.php'>Ukrainian</option>
            <option value='zh/function.imagewebp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagewebp" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagewebp</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagewebp</span> &mdash; <span class="dc-title">Output a WebP image to browser or file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.imagewebp-description">
  ...
  <p class="para rdfs-comment">
   Outputs or saves a WebP version of the given <code class="parameter">image</code>. 
  </p>
 </div>
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
     ...
     <dd>
      <p class="para">
       <code class="parameter">quality</code> ranges from 0 (worst
       quality, smaller file) to 100 (best quality, biggest file).
       If <code class="literal">-1</code> is provided, the default value <code class="literal">80</code> is used.
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.imagewebp-examples">
  ...
  <p class="para">
   <div class="example" id="example-2946">
    <p><strong>Example #1 Saving an WebP file</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Create a blank image and add some text<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatetruecolor</span><span style="color: #007700">(</span><span style="color: #0000BB">120</span><span style="color: #007700">, </span><span style="color: #0000BB">20</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$text_color </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecolorallocate</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">233</span><span style="color: #007700">, </span><span style="color: #0000BB">14</span><span style="color: #007700">, </span><span style="color: #0000BB">91</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">imagestring</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">,  </span><span style="color: #DD0000">'WebP with PHP'</span><span style="color: #007700">, </span><span style="color: #0000BB">$text_color</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Save the image<br /></span><span style="color: #0000BB">imagewebp</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #DD0000">'php.webp'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagewebp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagewebp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagewebp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagewebp.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">5 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123578">  <div class="votes">
    <div id="Vu123578">
    <a href="/manual/vote-note.php?id=123578&amp;page=function.imagewebp&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123578">
    <a href="/manual/vote-note.php?id=123578&amp;page=function.imagewebp&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123578" title="66% like this...">
    34
    </div>
  </div>
  <a href="#123578" class="name">
  <strong class="user"><em>Khalyomede</em></strong></a><a class="genanchor" href="#123578"> &para;</a><div class="date" title="2019-02-01 07:24"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123578">
<div class="phpcode"><code><span class="html">As of today (end of january 2019), WebP is now supported across all the major browsers (Edge, Chrome, Firefox, Opera).</span></code></div>
  </div>
 </div>
  <div class="note" id="124925">  <div class="votes">
    <div id="Vu124925">
    <a href="/manual/vote-note.php?id=124925&amp;page=function.imagewebp&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124925">
    <a href="/manual/vote-note.php?id=124925&amp;page=function.imagewebp&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124925" title="68% like this...">
    31
    </div>
  </div>
  <a href="#124925" class="name">
  <strong class="user"><em>vinicius dot sizilio at gmail dot com</em></strong></a><a class="genanchor" href="#124925"> &para;</a><div class="date" title="2020-04-18 01:07"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124925">
<div class="phpcode"><code><span class="html">To convert a PNG image to Webp, we can do this:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">// Image<br /></span><span class="default">$dir </span><span class="keyword">= </span><span class="string">'img/countries/'</span><span class="keyword">;<br /></span><span class="default">$name </span><span class="keyword">= </span><span class="string">'brazil.png'</span><span class="keyword">;<br /></span><span class="default">$newName </span><span class="keyword">= </span><span class="string">'brazil.webp'</span><span class="keyword">;<br /><br /></span><span class="comment">// Create and save<br /></span><span class="default">$img </span><span class="keyword">= </span><span class="default">imagecreatefrompng</span><span class="keyword">(</span><span class="default">$dir </span><span class="keyword">. </span><span class="default">$name</span><span class="keyword">);<br /></span><span class="default">imagepalettetotruecolor</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">);<br /></span><span class="default">imagealphablending</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">imagesavealpha</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">imagewebp</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">$dir </span><span class="keyword">. </span><span class="default">$newName</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">);<br /></span><span class="default">imagedestroy</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="126837">  <div class="votes">
    <div id="Vu126837">
    <a href="/manual/vote-note.php?id=126837&amp;page=function.imagewebp&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126837">
    <a href="/manual/vote-note.php?id=126837&amp;page=function.imagewebp&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126837" title="66% like this...">
    26
    </div>
  </div>
  <a href="#126837" class="name">
  <strong class="user"><em>JSix</em></strong></a><a class="genanchor" href="#126837"> &para;</a><div class="date" title="2022-02-09 04:18"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126837">
<div class="phpcode"><code><span class="html">Function to save any image to Webp<br /><br />public static function webpImage($source, $quality = 100, $removeOld = false)<br />    {<br />        $dir = pathinfo($source, PATHINFO_DIRNAME);<br />        $name = pathinfo($source, PATHINFO_FILENAME);<br />        $destination = $dir . DIRECTORY_SEPARATOR . $name . '.webp';<br />        $info = getimagesize($source);<br />        $isAlpha = false;<br />        if ($info['mime'] == 'image/jpeg')<br />            $image = imagecreatefromjpeg($source);<br />        elseif ($isAlpha = $info['mime'] == 'image/gif') {<br />            $image = imagecreatefromgif($source);<br />        } elseif ($isAlpha = $info['mime'] == 'image/png') {<br />            $image = imagecreatefrompng($source);<br />        } else {<br />            return $source;<br />        }<br />        if ($isAlpha) {<br />            imagepalettetotruecolor($image);<br />            imagealphablending($image, true);<br />            imagesavealpha($image, true);<br />        }<br />        imagewebp($image, $destination, $quality);<br /><br />        if ($removeOld)<br />            unlink($source);<br /><br />        return $destination;<br />    }</span></code></div>
  </div>
 </div>
  <div class="note" id="124393">  <div class="votes">
    <div id="Vu124393">
    <a href="/manual/vote-note.php?id=124393&amp;page=function.imagewebp&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124393">
    <a href="/manual/vote-note.php?id=124393&amp;page=function.imagewebp&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124393" title="55% like this...">
    4
    </div>
  </div>
  <a href="#124393" class="name">
  <strong class="user"><em>day4gerard</em></strong></a><a class="genanchor" href="#124393"> &para;</a><div class="date" title="2019-11-14 07:14"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124393">
<div class="phpcode"><code><span class="html">WebP is not yet supported by Safari, although they are experimenting with it.<br /><br />Check out <a href="https://caniuse.com/#search=webp" rel="nofollow" target="_blank">https://caniuse.com/#search=webp</a> for the latest support information.</span></code></div>
  </div>
 </div>
  <div class="note" id="126189">  <div class="votes">
    <div id="Vu126189">
    <a href="/manual/vote-note.php?id=126189&amp;page=function.imagewebp&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126189">
    <a href="/manual/vote-note.php?id=126189&amp;page=function.imagewebp&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126189" title="53% like this...">
    1
    </div>
  </div>
  <a href="#126189" class="name">
  <strong class="user"><em>Sam</em></strong></a><a class="genanchor" href="#126189"> &para;</a><div class="date" title="2021-06-24 08:47"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126189">
<div class="phpcode"><code><span class="html">Safari on mac now has limited support (limited to Safari 14+ on Big Sur or later)<br /><br />Safari on iOS 14.4 and higher has full support</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagewebp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagewebp.php">＋<small>add a note</small></a></div>
