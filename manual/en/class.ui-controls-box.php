...
<head>
  ...
  <title>PHP: UI\Controls\Box - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-controls-box.php">
 <link rel="shorturl" href="https://www.php.net/ui-controls-box">
 <link rel="alternate" href="https://www.php.net/ui-controls-box" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-controls-group.settitle.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-controls-box.append.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-controls-box.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-controls-box.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-controls-box.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-controls-box.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-controls-box.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-controls-box.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-controls-box.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-controls-box.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-controls-box.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-controls-box.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-controls-box.php" hreflang="zh">
...
<meta name="Description" content="Control Box (Arrangement)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Controls\Box - Manual" />
<meta name="twitter:description" content="Control Box (Arrangement)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Controls\Box - Manual" />
<meta itemprop="description" content="Control Box (Arrangement)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Control Box (Arrangement)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ui-controls-box.append.php">
          UI\Controls\Box::append &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-controls-group.settitle.php">
          &laquo; UI\Controls\Group::setTitle        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-controls-box.php' selected="selected">English</option>
            <option value='de/class.ui-controls-box.php'>German</option>
            <option value='es/class.ui-controls-box.php'>Spanish</option>
            <option value='fr/class.ui-controls-box.php'>French</option>
            <option value='it/class.ui-controls-box.php'>Italian</option>
            <option value='ja/class.ui-controls-box.php'>Japanese</option>
            <option value='pt_BR/class.ui-controls-box.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-controls-box.php'>Russian</option>
            <option value='tr/class.ui-controls-box.php'>Turkish</option>
            <option value='uk/class.ui-controls-box.php'>Ukrainian</option>
            <option value='zh/class.ui-controls-box.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-controls-box" class="reference">

 <h1 class="title">Control Box (Arrangement)</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-controls-box.intro">
  ...
  <div class="section" id="ui-controls-box.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Controls\Box</strong>
     </span>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-controls-box.php#ui-controls-box.constants.vertical"><var class="varname">Vertical</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-controls-box.php#ui-controls-box.constants.horizontal"><var class="varname">Horizontal</var></a></var>;</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Properties */</div>
    <div class="fieldsynopsis"><span class="modifier">protected</span>
      <var class="varname"><a href="class.ui-controls-box.php#ui-controls-box.props.controls">$<var class="varname">controls</var></a></var>;</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Constructor */</div>
    <div class="constructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><a href="ui-controls-box.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$orientation</code><span class="initializer"> = UI\Controls\Box::Horizontal</span></span>)</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-box.append.php" class="methodname">append</a></span>(<span class="methodparam"><span class="type">Control</span> <code class="parameter">$control</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$stretchy</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-box.delete.php" class="methodname">delete</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-box.getorientation.php" class="methodname">getOrientation</a></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-box.ispadded.php" class="methodname">isPadded</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-box.setpadded.php" class="methodname">setPadded</a></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$padded</code></span>)</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-control.show.php" class="methodname">UI\Control::show</a></span>()</div>
  ...
  <div class="section" id="ui-controls-box.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="ui-controls-box.props.controls"><var class="varname">controls</var></dt>
     <dd>
      <p class="para">
  ...
  <div class="section" id="ui-controls-box.constants">
   <h2 class="title">Predefined Constants</h2>
   <dl>

    
     <dt id="ui-controls-box.constants.vertical"><strong><code><a href="class.ui-controls-box.php#ui-controls-box.constants.vertical">UI\Controls\Box::Vertical</a></code></strong></dt>
     <dd>
      <p class="para"/>
     </dd>
     ...
     <dt id="ui-controls-box.constants.horizontal"><strong><code><a href="class.ui-controls-box.php#ui-controls-box.constants.horizontal">UI\Controls\Box::Horizontal</a></code></strong></dt>
     <dd>
      <p class="para"/>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-controls-box.append.php">UI\Controls\Box::append</a> — Append Control</li><li><a href="ui-controls-box.construct.php">UI\Controls\Box::__construct</a> — Construct a new Box</li><li><a href="ui-controls-box.delete.php">UI\Controls\Box::delete</a> — Delete Control</li><li><a href="ui-controls-box.getorientation.php">UI\Controls\Box::getOrientation</a> — Get Orientation</li><li><a href="ui-controls-box.ispadded.php">UI\Controls\Box::isPadded</a> — Padding Detection</li><li><a href="ui-controls-box.setpadded.php">UI\Controls\Box::setPadded</a> — Set Padding</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.controls.box.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-controls-box%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-controls-box&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-controls-box.php">＋<small>add a note</small></a></span>
