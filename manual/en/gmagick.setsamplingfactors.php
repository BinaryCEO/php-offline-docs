...
<head>
  ...
  <title>PHP: Gmagick::setsamplingfactors - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setsamplingfactors.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setsamplingfactors.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setsamplingfactors.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimagewhitepoint.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setsamplingfactors.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setsamplingfactors.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setsamplingfactors.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setsamplingfactors.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setsamplingfactors.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setsamplingfactors.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setsamplingfactors.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setsamplingfactors.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setsamplingfactors.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setsamplingfactors.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setsamplingfactors.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setsamplingfactors - Manual" />
<meta name="twitter:description" content="Sets the image sampling factors" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setsamplingfactors - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.setsize.php">
          Gmagick::setsize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimagewhitepoint.php">
          &laquo; Gmagick::setimagewhitepoint        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setsamplingfactors.php' selected="selected">English</option>
            <option value='de/gmagick.setsamplingfactors.php'>German</option>
            <option value='es/gmagick.setsamplingfactors.php'>Spanish</option>
            <option value='fr/gmagick.setsamplingfactors.php'>French</option>
            <option value='it/gmagick.setsamplingfactors.php'>Italian</option>
            <option value='ja/gmagick.setsamplingfactors.php'>Japanese</option>
            <option value='pt_BR/gmagick.setsamplingfactors.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setsamplingfactors.php'>Russian</option>
            <option value='tr/gmagick.setsamplingfactors.php'>Turkish</option>
            <option value='uk/gmagick.setsamplingfactors.php'>Ukrainian</option>
            <option value='zh/gmagick.setsamplingfactors.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setsamplingfactors" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setsamplingfactors</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setsamplingfactors</span> &mdash; <span class="dc-title">Sets the image sampling factors</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setsamplingfactors-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setsamplingfactors</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$factors</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setsamplingfactors-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       An array of <span class="type"><a href="language.types.float.php" class="type float">float</a></span>s representing the sampling factor for each color component (in RGB order).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setsamplingfactors-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setsamplingfactors-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setsamplingfactors.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setsamplingfactors%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setsamplingfactors&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setsamplingfactors.php">＋<small>add a note</small></a></span>
