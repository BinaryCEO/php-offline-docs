...
<head>
  ...
  <title>PHP: Gmagick::setimageinterlacescheme - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimageinterlacescheme.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimageinterlacescheme.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageinterlacescheme.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimageindex.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimageiterations.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageinterlacescheme.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimageinterlacescheme.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimageinterlacescheme.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimageinterlacescheme.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimageinterlacescheme.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimageinterlacescheme.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimageinterlacescheme.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimageinterlacescheme.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimageinterlacescheme.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimageinterlacescheme.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimageinterlacescheme.php" hreflang="zh">
...
<meta name="Description" content="Sets the interlace scheme of the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::setimageinterlacescheme - Manual" />
<meta name="twitter:description" content="Sets the interlace scheme of the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimageinterlacescheme - Manual" />
<meta itemprop="description" content="Sets the interlace scheme of the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the interlace scheme of the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.setimageiterations.php">
          Gmagick::setimageiterations &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimageindex.php">
          &laquo; Gmagick::setimageindex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimageinterlacescheme.php' selected="selected">English</option>
            <option value='de/gmagick.setimageinterlacescheme.php'>German</option>
            <option value='es/gmagick.setimageinterlacescheme.php'>Spanish</option>
            <option value='fr/gmagick.setimageinterlacescheme.php'>French</option>
            <option value='it/gmagick.setimageinterlacescheme.php'>Italian</option>
            <option value='ja/gmagick.setimageinterlacescheme.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimageinterlacescheme.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimageinterlacescheme.php'>Russian</option>
            <option value='tr/gmagick.setimageinterlacescheme.php'>Turkish</option>
            <option value='uk/gmagick.setimageinterlacescheme.php'>Ukrainian</option>
            <option value='zh/gmagick.setimageinterlacescheme.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimageinterlacescheme" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimageinterlacescheme</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimageinterlacescheme</span> &mdash; <span class="dc-title">Sets the interlace scheme of the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimageinterlacescheme-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimageinterlacescheme</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$interlace</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimageinterlacescheme-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       One of the <a href="gmagick.constants.php#gmagick.constants.interlace" class="link">Interlace</a> constant
       (<code class="literal">Gmagick::INTERLACE_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimageinterlacescheme-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimageinterlacescheme-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimageinterlacescheme.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimageinterlacescheme%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimageinterlacescheme&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimageinterlacescheme.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110985">  <div class="votes">
    <div id="Vu110985">
    <a href="/manual/vote-note.php?id=110985&amp;page=gmagick.setimageinterlacescheme&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110985">
    <a href="/manual/vote-note.php?id=110985&amp;page=gmagick.setimageinterlacescheme&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110985" title="100% like this...">
    4
    </div>
  </div>
  <a href="#110985" class="name">
  <strong class="user"><em>Isius</em></strong></a><a class="genanchor" href="#110985"> &para;</a><div class="date" title="2013-01-03 03:24"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110985">
<div class="phpcode"><code><span class="html">Just in case you're having trouble finding the constants for this like I was. They are as-of-yet unlisted on the predefined constants page.<br /><br />INTERLACE_UNDEFINED, UndefinedInterlace<br />INTERLACE_NO, NoInterlace<br />INTERLACE_LINE, LineInterlace<br />INTERLACE_PLANE, PlaneInterlace<br />INTERLACE_PARTITION, PartitionInterlace</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gmagick.setimageinterlacescheme&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimageinterlacescheme.php">＋<small>add a note</small></a></div>
