...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.uopz.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.runkit7-zval-inspect.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.uopz.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.uopz.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.uopz.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.uopz.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.uopz.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.uopz.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.uopz.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.uopz.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.uopz.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.uopz.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.uopz.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.uopz.php" hreflang="zh">
...
<meta name="Description" content="User Operations for Zend" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: uopz - Manual" />
<meta name="twitter:description" content="User Operations for Zend" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: uopz - Manual" />
<meta itemprop="description" content="User Operations for Zend" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="User Operations for Zend" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intro.uopz.php">
          Introduction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.runkit7-zval-inspect.php">
          &laquo; runkit7_zval_inspect        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.uopz.php' selected="selected">English</option>
            <option value='de/book.uopz.php'>German</option>
            <option value='es/book.uopz.php'>Spanish</option>
            <option value='fr/book.uopz.php'>French</option>
            <option value='it/book.uopz.php'>Italian</option>
            <option value='ja/book.uopz.php'>Japanese</option>
            <option value='pt_BR/book.uopz.php'>Brazilian Portuguese</option>
            <option value='ru/book.uopz.php'>Russian</option>
            <option value='tr/book.uopz.php'>Turkish</option>
            <option value='uk/book.uopz.php'>Ukrainian</option>
            <option value='zh/book.uopz.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.uopz" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.uopz.php">Introduction</a></li><li><a href="uopz.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="uopz.requirements.php">Requirements</a></li><li><a href="uopz.installation.php">Installation</a></li><li><a href="uopz.configuration.php">Runtime Configuration</a></li></ul></li><li><a href="uopz.constants.php">Predefined Constants</a></li><li><a href="ref.uopz.php">Uopz Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.uopz-add-function.php">uopz_add_function</a> — Adds non-existent function or method</li><li><a href="function.uopz-allow-exit.php">uopz_allow_exit</a> — Allows control over disabled exit opcode</li><li><a href="function.uopz-backup.php">uopz_backup</a> — Backup a function</li><li><a href="function.uopz-compose.php">uopz_compose</a> — Compose a class</li><li><a href="function.uopz-copy.php">uopz_copy</a> — Copy a function</li><li><a href="function.uopz-del-function.php">uopz_del_function</a> — Deletes previously added function or method</li><li><a href="function.uopz-delete.php">uopz_delete</a> — Delete a function</li><li><a href="function.uopz-extend.php">uopz_extend</a> — Extend a class at runtime</li><li><a href="function.uopz-flags.php">uopz_flags</a> — Get or set flags on function or class</li><li><a href="function.uopz-function.php">uopz_function</a> — Creates a function at runtime</li><li><a href="function.uopz-get-exit-status.php">uopz_get_exit_status</a> — Retrieve the last set exit status</li><li><a href="function.uopz-get-hook.php">uopz_get_hook</a> — Gets previously set hook on function or method</li><li><a href="function.uopz-get-mock.php">uopz_get_mock</a> — Get the current mock for a class</li><li><a href="function.uopz-get-property.php">uopz_get_property</a> — Gets value of class or instance property</li><li><a href="function.uopz-get-return.php">uopz_get_return</a> — Gets a previous set return value for a function</li><li><a href="function.uopz-get-static.php">uopz_get_static</a> — Gets the static variables from function or method scope</li><li><a href="function.uopz-implement.php">uopz_implement</a> — Implements an interface at runtime</li><li><a href="function.uopz-overload.php">uopz_overload</a> — Overload a VM opcode</li><li><a href="function.uopz-redefine.php">uopz_redefine</a> — Redefine a constant</li><li><a href="function.uopz-rename.php">uopz_rename</a> — Rename a function at runtime</li><li><a href="function.uopz-restore.php">uopz_restore</a> — Restore a previously backed up function</li><li><a href="function.uopz-set-hook.php">uopz_set_hook</a> — Sets hook to execute when entering a function or method</li><li><a href="function.uopz-set-mock.php">uopz_set_mock</a> — Use mock instead of class for new objects</li><li><a href="function.uopz-set-property.php">uopz_set_property</a> — Sets value of existing class or instance property</li><li><a href="function.uopz-set-return.php">uopz_set_return</a> — Provide a return value for an existing function</li><li><a href="function.uopz-set-static.php">uopz_set_static</a> — Sets the static variables in function or method scope</li><li><a href="function.uopz-undefine.php">uopz_undefine</a> — Undefine a constant</li><li><a href="function.uopz-unset-hook.php">uopz_unset_hook</a> — Removes previously set hook on function or method</li><li><a href="function.uopz-unset-mock.php">uopz_unset_mock</a> — Unset previously set mock</li><li><a href="function.uopz-unset-return.php">uopz_unset_return</a> — Unsets a previously set return value for a function</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uopz/book.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.uopz%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.uopz&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.uopz.php">＋<small>add a note</small></a></span>
