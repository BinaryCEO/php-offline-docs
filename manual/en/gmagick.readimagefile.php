...
<head>
  ...
  <title>PHP: Gmagick::readimagefile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.readimagefile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.readimagefile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.readimagefile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.readimageblob.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.reducenoiseimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.readimagefile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.readimagefile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.readimagefile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.readimagefile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.readimagefile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.readimagefile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.readimagefile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.readimagefile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.readimagefile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.readimagefile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.readimagefile.php" hreflang="zh">
...
<meta name="Description" content="The readimagefile purpose" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::readimagefile - Manual" />
<meta name="twitter:description" content="The readimagefile purpose" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::readimagefile - Manual" />
<meta itemprop="description" content="The readimagefile purpose" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The readimagefile purpose" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.reducenoiseimage.php">
          Gmagick::reducenoiseimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.readimageblob.php">
          &laquo; Gmagick::readimageblob        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.readimagefile.php' selected="selected">English</option>
            <option value='de/gmagick.readimagefile.php'>German</option>
            <option value='es/gmagick.readimagefile.php'>Spanish</option>
            <option value='fr/gmagick.readimagefile.php'>French</option>
            <option value='it/gmagick.readimagefile.php'>Italian</option>
            <option value='ja/gmagick.readimagefile.php'>Japanese</option>
            <option value='pt_BR/gmagick.readimagefile.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.readimagefile.php'>Russian</option>
            <option value='tr/gmagick.readimagefile.php'>Turkish</option>
            <option value='uk/gmagick.readimagefile.php'>Ukrainian</option>
            <option value='zh/gmagick.readimagefile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.readimagefile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::readimagefile</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::readimagefile</span> &mdash; <span class="dc-title">The readimagefile purpose</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.readimagefile-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::readimagefile</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$fp</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.readimagefile-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.readimagefile-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.readimagefile-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/readimagefile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.readimagefile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.readimagefile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.readimagefile.php">＋<small>add a note</small></a></span>
