...
<head>
  ...
  <title>PHP: svn_add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-add.php">
 <link rel="shorturl" href="https://www.php.net/svn-add">
 <link rel="alternate" href="https://www.php.net/svn-add" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-auth-get-parameter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-add.php" hreflang="zh">
...
<meta name="Description" content="Schedules the addition of an item in a working directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_add - Manual" />
<meta name="twitter:description" content="Schedules the addition of an item in a working directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_add - Manual" />
<meta itemprop="description" content="Schedules the addition of an item in a working directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Schedules the addition of an item in a working directory" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.svn-auth-get-parameter.php">
          svn_auth_get_parameter &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.svn.php">
          &laquo; SVN Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-add.php' selected="selected">English</option>
            <option value='de/function.svn-add.php'>German</option>
            <option value='es/function.svn-add.php'>Spanish</option>
            <option value='fr/function.svn-add.php'>French</option>
            <option value='it/function.svn-add.php'>Italian</option>
            <option value='ja/function.svn-add.php'>Japanese</option>
            <option value='pt_BR/function.svn-add.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-add.php'>Russian</option>
            <option value='tr/function.svn-add.php'>Turkish</option>
            <option value='uk/function.svn-add.php'>Ukrainian</option>
            <option value='zh/function.svn-add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-add" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.svn-add-examples">
  ...
  <p class="para">
   <div class="example" id="example-4863">
    <p><strong>Example #1 <span class="function"><strong>svn_add()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><a href="http://svnbook.red-bean.com/en/1.2/svn.ref.svn.c.add.html" class="link external">&raquo;&nbsp;SVN documentation on svn add</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-add.php">＋<small>add a note</small></a></span>
