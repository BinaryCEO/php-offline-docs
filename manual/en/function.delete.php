...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.delete.php">
 <link rel="shorturl" href="https://www.php.net/delete">
 <link rel="alternate" href="https://www.php.net/delete" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.copy.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dirname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.delete.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.delete.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.delete.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.delete.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.delete.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.delete.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.delete.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.delete.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.delete.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.delete.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.delete.php" hreflang="zh">
...
<meta name="Description" content="See unlink or unset" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: delete - Manual" />
<meta name="twitter:description" content="See unlink or unset" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: delete - Manual" />
<meta itemprop="description" content="See unlink or unset" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="See unlink or unset" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.delete.php' selected="selected">English</option>
            <option value='de/function.delete.php'>German</option>
            <option value='es/function.delete.php'>Spanish</option>
            <option value='fr/function.delete.php'>French</option>
            <option value='it/function.delete.php'>Italian</option>
            <option value='ja/function.delete.php'>Japanese</option>
            <option value='pt_BR/function.delete.php'>Brazilian Portuguese</option>
            <option value='ru/function.delete.php'>Russian</option>
            <option value='tr/function.delete.php'>Turkish</option>
            <option value='uk/function.delete.php'>Ukrainian</option>
            <option value='zh/function.delete.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.delete" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">delete</h1>
  <p class="refpurpose"><span class="refname">delete</span> &mdash; <span class="dc-title">See <span class="function"><a href="function.unlink.php" class="function">unlink()</a></span> or <span class="function"><a href="function.unset.php" class="function">unset()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.delete-description">
  <h3 class="title">Description</h3>
  <p class="para">
   There is no delete keyword or function in the PHP language.
   If you arrived at this page seeking to delete a file, try <span class="function"><a href="function.unlink.php" class="function">unlink()</a></span>.
   To delete a variable from the local scope, check out <span class="function"><a href="function.unset.php" class="function">unset()</a></span>.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.delete-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.unset.php" class="function" rel="rdfs-seeAlso">unset()</a> - unset a given variable</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/delete.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.delete%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.delete.php">＋<small>add a note</small></a></span>
