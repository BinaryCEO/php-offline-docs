...
<head>
  ...
  <title>PHP: simdjson_decode - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.simdjson-decode.php">
 <link rel="shorturl" href="https://www.php.net/simdjson-decode">
 <link rel="alternate" href="https://www.php.net/simdjson-decode" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.simdjson.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.simdjson.php">
 <link rel="next" href="https://www.php.net/manual/en/function.simdjson-is-valid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.simdjson-decode.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.simdjson-decode.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.simdjson-decode.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.simdjson-decode.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.simdjson-decode.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.simdjson-decode.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.simdjson-decode.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.simdjson-decode.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.simdjson-decode.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.simdjson-decode.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.simdjson-decode.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: simdjson_decode - Manual" />
<meta name="twitter:description" content="Decodes a JSON string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: simdjson_decode - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.simdjson-is-valid.php">
          simdjson_is_valid &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.simdjson.php">
          &laquo; Simdjson Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.simdjson-decode.php' selected="selected">English</option>
            <option value='de/function.simdjson-decode.php'>German</option>
            <option value='es/function.simdjson-decode.php'>Spanish</option>
            <option value='fr/function.simdjson-decode.php'>French</option>
            <option value='it/function.simdjson-decode.php'>Italian</option>
            <option value='ja/function.simdjson-decode.php'>Japanese</option>
            <option value='pt_BR/function.simdjson-decode.php'>Brazilian Portuguese</option>
            <option value='ru/function.simdjson-decode.php'>Russian</option>
            <option value='tr/function.simdjson-decode.php'>Turkish</option>
            <option value='uk/function.simdjson-decode.php'>Ukrainian</option>
            <option value='zh/function.simdjson-decode.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.simdjson-decode" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.json-decode.php" class="function" rel="rdfs-seeAlso">json_decode()</a> - Decodes a JSON string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/simdjson/functions/simdjson-decode.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.simdjson-decode%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.simdjson-decode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.simdjson-decode.php">＋<small>add a note</small></a></span>
