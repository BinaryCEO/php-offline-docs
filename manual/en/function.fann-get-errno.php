...
<head>
  ...
  <title>PHP: fann_get_errno - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-errno.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-errno">
 <link rel="alternate" href="https://www.php.net/fann-get-errno" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-connection-rate.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-errstr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-errno.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-errno.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-errno.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-errno.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-errno.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-errno.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-errno.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-errno.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-errno.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-errno.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-errno.php" hreflang="zh">
...
<meta name="Description" content="Returns the last error number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_errno - Manual" />
<meta name="twitter:description" content="Returns the last error number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_errno - Manual" />
<meta itemprop="description" content="Returns the last error number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the last error number" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-get-errstr.php">
          fann_get_errstr &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-connection-rate.php">
          &laquo; fann_get_connection_rate        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-errno.php' selected="selected">English</option>
            <option value='de/function.fann-get-errno.php'>German</option>
            <option value='es/function.fann-get-errno.php'>Spanish</option>
            <option value='fr/function.fann-get-errno.php'>French</option>
            <option value='it/function.fann-get-errno.php'>Italian</option>
            <option value='ja/function.fann-get-errno.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-errno.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-errno.php'>Russian</option>
            <option value='tr/function.fann-get-errno.php'>Turkish</option>
            <option value='uk/function.fann-get-errno.php'>Ukrainian</option>
            <option value='zh/function.fann-get-errno.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-errno" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_get_errno</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_get_errno</span> &mdash; <span class="dc-title">Returns the last error number</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-errno-returnvalues">
  ...
  <p class="para">
   The error number, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-get-errstr.php" class="function" rel="rdfs-seeAlso">fann_get_errstr()</a> - Returns the last errstr</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-errno.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-errno%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-errno.php">＋<small>add a note</small></a></span>
