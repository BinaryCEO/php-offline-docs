...
<head>
  ...
  <title>PHP: cubrid_num_rows - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-num-rows.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-num-rows">
 <link rel="alternate" href="https://www.php.net/cubrid-num-rows" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-num-cols.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-pconnect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-num-rows.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-num-rows.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-num-rows.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-num-rows.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-num-rows.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-num-rows.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-num-rows.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-num-rows.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-num-rows.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-num-rows.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-num-rows.php" hreflang="zh">
...
<meta name="Description" content="Get the number of rows in the result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_num_rows - Manual" />
<meta name="twitter:description" content="Get the number of rows in the result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_num_rows - Manual" />
<meta itemprop="description" content="Get the number of rows in the result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the number of rows in the result set" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-pconnect.php">
          cubrid_pconnect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-num-cols.php">
          &laquo; cubrid_num_cols        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-num-rows.php' selected="selected">English</option>
            <option value='de/function.cubrid-num-rows.php'>German</option>
            <option value='es/function.cubrid-num-rows.php'>Spanish</option>
            <option value='fr/function.cubrid-num-rows.php'>French</option>
            <option value='it/function.cubrid-num-rows.php'>Italian</option>
            <option value='ja/function.cubrid-num-rows.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-num-rows.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-num-rows.php'>Russian</option>
            <option value='tr/function.cubrid-num-rows.php'>Turkish</option>
            <option value='uk/function.cubrid-num-rows.php'>Ukrainian</option>
            <option value='zh/function.cubrid-num-rows.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-num-rows" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-num-rows-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_num_rows</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   It can be used for <code class="literal">SELECT</code> statements.
   For <code class="literal">INSERT</code>, <code class="literal">UPDATE</code>, or <code class="literal">DELETE</code> queries,
   use the <span class="function"><a href="function.cubrid-affected-rows.php" class="function">cubrid_affected_rows()</a></span> function.
  </p>
  <p class="para">
 ...
 <div class="refsect1 parameters" id="refsect1-function.cubrid-num-rows-parameters">
  ...
  <dd><p class="para"><code class="parameter">result</code> comes from a call to
    <span class="function"><a href="function.cubrid-execute.php" class="function">cubrid_execute()</a></span>, <span class="function"><a href="function.cubrid-query.php" class="function">cubrid_query()</a></span> and
...
Column Num: 2</pre>
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.cubrid-num-cols.php" class="function" rel="rdfs-seeAlso">cubrid_num_cols()</a> - Return the number of columns in the result set</span></li>  
    <li><span class="function"><a href="function.cubrid-affected-rows.php" class="function" rel="rdfs-seeAlso">cubrid_affected_rows()</a> - Return the number of rows affected by the last SQL statement</span></li>  
   </ul>
  </p>
  </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-num-rows.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-num-rows%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-num-rows&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-num-rows.php">＋<small>add a note</small></a></span>
