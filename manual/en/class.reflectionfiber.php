...
<head>
 ...
 <link rel="prev" href="https://www.php.net/manual/en/reflectiongenerator.isclosed.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionfiber.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.reflectionfiber.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.reflectionfiber.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.reflectionfiber.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.reflectionfiber.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.reflectionfiber.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.reflectionfiber.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.reflectionfiber.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.reflectionfiber.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.reflectionfiber.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.reflectionfiber.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.reflectionfiber.php" hreflang="zh">
...
<meta name="Description" content="The ReflectionFiber class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionFiber - Manual" />
<meta name="twitter:description" content="The ReflectionFiber class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionFiber - Manual" />
<meta itemprop="description" content="The ReflectionFiber class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ReflectionFiber class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectiongenerator.isclosed.php">
          &laquo; ReflectionGenerator::isClosed        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/class.reflectionfiber.php'>Italian</option>
            ...
            <option value='uk/class.reflectionfiber.php'>Ukrainian</option>
 ...
 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.1.0)</p>
  ...
  <div class="section" id="reflectionfiber.synopsis">
   ...
   <div class="classsynopsis"><div class="classsynopsisinfo">
     ...
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">ReflectionFiber</strong></strong>
     {</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="reflectionfiber.getexecutingfile.php" class="methodname">getExecutingFile</a></span>(): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="reflectionfiber.getexecutingline.php" class="methodname">getExecutingLine</a></span>(): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span></div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="reflectionfiber.construct.php">ReflectionFiber::__construct</a> — Constructs a ReflectionFiber object</li><li><a href="reflectionfiber.getcallable.php">ReflectionFiber::getCallable</a> — Gets the callable used to create the Fiber</li><li><a href="reflectionfiber.getexecutingfile.php">ReflectionFiber::getExecutingFile</a> — Get the file name of the current execution point</li><li><a href="reflectionfiber.getexecutingline.php">ReflectionFiber::getExecutingLine</a> — Get the line number of the current execution point</li><li><a href="reflectionfiber.getfiber.php">ReflectionFiber::getFiber</a> — Get the reflected Fiber instance</li><li><a href="reflectionfiber.gettrace.php">ReflectionFiber::getTrace</a> — Get the backtrace of the current execution point</li></ul>
 ...
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.reflectionfiber&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionfiber.php">＋<small>add a note</small></a></span>
