...
<head>
  ...
  <title>PHP: SolrQuery::setHighlight - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlight.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlight.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlight.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setgrouptruncate.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightalternatefield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlight.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlight.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlight.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlight.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlight.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlight.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlight.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlight.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlight.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlight.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlight.php" hreflang="zh">
...
<meta name="Description" content="Enables or disables highlighting" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlight - Manual" />
<meta name="twitter:description" content="Enables or disables highlighting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlight - Manual" />
<meta itemprop="description" content="Enables or disables highlighting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enables or disables highlighting" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.sethighlightalternatefield.php">
          SolrQuery::setHighlightAlternateField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setgrouptruncate.php">
          &laquo; SolrQuery::setGroupTruncate        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlight.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlight.php'>German</option>
            <option value='es/solrquery.sethighlight.php'>Spanish</option>
            <option value='fr/solrquery.sethighlight.php'>French</option>
            <option value='it/solrquery.sethighlight.php'>Italian</option>
            <option value='ja/solrquery.sethighlight.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlight.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlight.php'>Russian</option>
            <option value='tr/solrquery.sethighlight.php'>Turkish</option>
            <option value='uk/solrquery.sethighlight.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlight.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlight" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlight</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlight</span> &mdash; <span class="dc-title">Enables or disables highlighting</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlight-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlight</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>

  <p class="para rdfs-comment">
   Setting it to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> enables highlighted snippets to be generated in the query response.
  </p>

  <p class="para">Setting it to <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> disables highlighting</p>
 </div>


 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlight-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlight-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlight.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlight%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlight&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlight.php">＋<small>add a note</small></a></span>
