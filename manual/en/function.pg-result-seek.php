...
<head>
  ...
  <title>PHP: pg_result_seek - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-result-seek.php">
 <link rel="shorturl" href="https://www.php.net/pg-result-seek">
 <link rel="alternate" href="https://www.php.net/pg-result-seek" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-result-memory-size.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-result-status.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-result-seek.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-result-seek.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-result-seek.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-result-seek.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-result-seek.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-result-seek.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-result-seek.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-result-seek.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-result-seek.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-result-seek.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-result-seek.php" hreflang="zh">
...
<meta name="Description" content="Set internal row offset in result instance" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_result_seek - Manual" />
<meta name="twitter:description" content="Set internal row offset in result instance" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_result_seek - Manual" />
<meta itemprop="description" content="Set internal row offset in result instance" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set internal row offset in result instance" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-result-status.php">
          pg_result_status &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-result-memory-size.php">
          &laquo; pg_result_memory_size        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-result-seek.php' selected="selected">English</option>
            <option value='de/function.pg-result-seek.php'>German</option>
            <option value='es/function.pg-result-seek.php'>Spanish</option>
            <option value='fr/function.pg-result-seek.php'>French</option>
            <option value='it/function.pg-result-seek.php'>Italian</option>
            <option value='ja/function.pg-result-seek.php'>Japanese</option>
            <option value='pt_BR/function.pg-result-seek.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-result-seek.php'>Russian</option>
            <option value='tr/function.pg-result-seek.php'>Turkish</option>
            <option value='uk/function.pg-result-seek.php'>Ukrainian</option>
            <option value='zh/function.pg-result-seek.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-result-seek" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_result_seek</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_result_seek</span> &mdash; <span class="dc-title">Set internal row offset in result instance</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-result-seek-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_result_seek</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-result.php" class="type PgSql\Result">PgSql\Result</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$row</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_result_seek()</strong></span> sets the internal row offset in
   the <code class="parameter">result</code> instance.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.pg-result-seek-parameters">
...
<span class="function"><a href="function.pg-query-params.php" class="function">pg_query_params()</a></span> or <span class="function"><a href="function.pg-execute.php" class="function">pg_execute()</a></span>(among others).</p>
     ...
     <dd>
      <p class="para">
       Row to move the internal offset to in the <span class="classname"><a href="class.pgsql-result.php" class="classname">PgSql\Result</a></span> instance.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-result-seek-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.pg-result-seek-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-result-seek-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2109">
    <p><strong>Example #1 <span class="function"><strong>pg_result_seek()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// Connect to the database<br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_pconnect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=publisher"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Execute a query<br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"SELECT author, email FROM authors"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Seek to the 3rd row (assuming there are 3 rows)<br /></span><span style="color: #0000BB">pg_result_seek</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Fetch the 3rd row<br /></span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_fetch_row</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">);<br /> <br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-result-seek-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-fetch-result.php" class="function" rel="rdfs-seeAlso">pg_fetch_result()</a> - Returns values from a result instance</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-result-seek.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-result-seek%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-result-seek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-result-seek.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="45774">  <div class="votes">
    <div id="Vu45774">
    <a href="/manual/vote-note.php?id=45774&amp;page=function.pg-result-seek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd45774">
    <a href="/manual/vote-note.php?id=45774&amp;page=function.pg-result-seek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V45774" title="85% like this...">
    5
    </div>
  </div>
  <a href="#45774" class="name">
  <strong class="user"><em>andrew-php dot net at andrew dot net dot au</em></strong></a><a class="genanchor" href="#45774"> &para;</a><div class="date" title="2004-09-17 08:01"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom45774">
<div class="phpcode"><code><span class="html">Ah, this is a handy feature for resetting the record index, for example, if you're used pg_fetch_{row,array,assoc} to iterate over the result set, and you want to do it again later on, without reexecuting your query. Something like:<br /><br /><span class="default">&lt;?php pg_result_seek</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">); </span><span class="default">?&gt;<br /></span><br />will allow you to iterate over the result set all over again...</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-result-seek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-result-seek.php">＋<small>add a note</small></a></div>
