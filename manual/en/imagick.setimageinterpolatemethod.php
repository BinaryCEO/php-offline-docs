...
<head>
  ...
  <title>PHP: Imagick::setImageInterpolateMethod - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageinterpolatemethod.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageinterpolatemethod.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageinterpolatemethod.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageinterlacescheme.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageiterations.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageinterpolatemethod.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageinterpolatemethod.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageinterpolatemethod.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageinterpolatemethod.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageinterpolatemethod.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageinterpolatemethod.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageinterpolatemethod.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageinterpolatemethod.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageinterpolatemethod.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageinterpolatemethod.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageinterpolatemethod.php" hreflang="zh">
...
<meta name="Description" content="Sets the image interpolate pixel method" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageInterpolateMethod - Manual" />
<meta name="twitter:description" content="Sets the image interpolate pixel method" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageInterpolateMethod - Manual" />
<meta itemprop="description" content="Sets the image interpolate pixel method" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image interpolate pixel method" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimageiterations.php">
          Imagick::setImageIterations &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageinterlacescheme.php">
          &laquo; Imagick::setImageInterlaceScheme        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageinterpolatemethod.php' selected="selected">English</option>
            <option value='de/imagick.setimageinterpolatemethod.php'>German</option>
            <option value='es/imagick.setimageinterpolatemethod.php'>Spanish</option>
            <option value='fr/imagick.setimageinterpolatemethod.php'>French</option>
            <option value='it/imagick.setimageinterpolatemethod.php'>Italian</option>
            <option value='ja/imagick.setimageinterpolatemethod.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageinterpolatemethod.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageinterpolatemethod.php'>Russian</option>
            <option value='tr/imagick.setimageinterpolatemethod.php'>Turkish</option>
            <option value='uk/imagick.setimageinterpolatemethod.php'>Ukrainian</option>
            <option value='zh/imagick.setimageinterpolatemethod.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageinterpolatemethod" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageInterpolateMethod</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageInterpolateMethod</span> &mdash; <span class="dc-title">Sets the image interpolate pixel method</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimageinterpolatemethod-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageInterpolateMethod</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$method</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageinterpolatemethod-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The method is one of the <strong><code><a href="imagick.constants.php#imagick.constants.interpolate-undefined">Imagick::INTERPOLATE_<span class="replaceable">*</span></a></code></strong> constants
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageinterpolatemethod-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageinterpolatemethod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageinterpolatemethod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageinterpolatemethod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageinterpolatemethod.php">＋<small>add a note</small></a></span>
