...
<head>
  ...
  <title>PHP: Imagick::getImageBlob - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageblob.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageblob.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageblob.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagebackgroundcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageblueprimary.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageblob.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageblob.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageblob.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageblob.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageblob.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageblob.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageblob.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageblob.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageblob.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageblob.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageblob.php" hreflang="zh">
...
<meta name="Description" content="Returns the image sequence as a blob" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageBlob - Manual" />
<meta name="twitter:description" content="Returns the image sequence as a blob" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageBlob - Manual" />
<meta itemprop="description" content="Returns the image sequence as a blob" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the image sequence as a blob" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimageblueprimary.php">
          Imagick::getImageBluePrimary &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagebackgroundcolor.php">
          &laquo; Imagick::getImageBackgroundColor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageblob.php' selected="selected">English</option>
            <option value='de/imagick.getimageblob.php'>German</option>
            <option value='es/imagick.getimageblob.php'>Spanish</option>
            <option value='fr/imagick.getimageblob.php'>French</option>
            <option value='it/imagick.getimageblob.php'>Italian</option>
            <option value='ja/imagick.getimageblob.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageblob.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageblob.php'>Russian</option>
            <option value='tr/imagick.getimageblob.php'>Turkish</option>
            <option value='uk/imagick.getimageblob.php'>Ukrainian</option>
            <option value='zh/imagick.getimageblob.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageblob" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageBlob</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageBlob</span> &mdash; <span class="dc-title">Returns the image sequence as a blob</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimageblob-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageBlob</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimageblob-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageblob-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimageblob-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageblob.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageblob%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageblob&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageblob.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119203">  <div class="votes">
    <div id="Vu119203">
    <a href="/manual/vote-note.php?id=119203&amp;page=imagick.getimageblob&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119203">
    <a href="/manual/vote-note.php?id=119203&amp;page=imagick.getimageblob&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119203" title="65% like this...">
    7
    </div>
  </div>
  <a href="#119203" class="name">
  <strong class="user"><em>Vee W</em></strong></a><a class="genanchor" href="#119203"> &para;</a><div class="date" title="2016-04-19 06:29"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119203">
<div class="phpcode"><code><span class="html">For who want to show "animated" gif. This getImageBlob() will showing only one frame of image.<br />Use getImagesBlob() instead.<br /><br />Example:<br /><br /><span class="default">&lt;?php<br />$Imagick </span><span class="keyword">= new </span><span class="default">\Imagick</span><span class="keyword">(</span><span class="default">$real_source_image_path_animated_gif</span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: image/gif"</span><span class="keyword">);<br />echo </span><span class="default">$Imagick</span><span class="keyword">-&gt;</span><span class="default">getImagesBlob</span><span class="keyword">();<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="129414">  <div class="votes">
    <div id="Vu129414">
    <a href="/manual/vote-note.php?id=129414&amp;page=imagick.getimageblob&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129414">
    <a href="/manual/vote-note.php?id=129414&amp;page=imagick.getimageblob&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129414" title="75% like this...">
    2
    </div>
  </div>
  <a href="#129414" class="name">
  <strong class="user"><em>anonymous at internet dot domain</em></strong></a><a class="genanchor" href="#129414"> &para;</a><div class="date" title="2024-04-19 10:57"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129414">
<div class="phpcode"><code><span class="html">Function returns NULL without any error if ImageMagick policy.xml blocks handling the file format, i.e. PDF.<br />For PDF output edit /etc/ImageMagick-6/policy.xml and remove the line which disables rights for PDF.<br />If you use other functions, e.g. readImage() for PDF, ImageMagick nags about it and outputs the error message but this function fails silently.</span></code></div>
  </div>
 </div>
  <div class="note" id="106725">  <div class="votes">
    <div id="Vu106725">
    <a href="/manual/vote-note.php?id=106725&amp;page=imagick.getimageblob&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106725">
    <a href="/manual/vote-note.php?id=106725&amp;page=imagick.getimageblob&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106725" title="50% like this...">
    0
    </div>
  </div>
  <a href="#106725" class="name">
  <strong class="user"><em>Trevor</em></strong></a><a class="genanchor" href="#106725"> &para;</a><div class="date" title="2011-12-01 03:41"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106725">
<div class="phpcode"><code><span class="html">It seems that this method can return a zero-length string if faced with large-ish data.  No exceptions are thrown.<br /><br /><span class="default">&lt;?php<br />  $image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />  if (!</span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">1000</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">,</span><span class="string">'white'</span><span class="keyword">)) throw new </span><span class="default">Exception</span><span class="keyword">();<br />  if (!</span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">200</span><span class="keyword">)) throw new </span><span class="default">Exception</span><span class="keyword">();<br />  print </span><span class="string">"Image size: </span><span class="keyword">{</span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getImageWidth</span><span class="keyword">()}</span><span class="string">,</span><span class="keyword">{</span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getImageHeight</span><span class="keyword">()}</span><span class="string">\n"</span><span class="keyword">;<br />  if (!</span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">"jpeg"</span><span class="keyword">)) throw new </span><span class="default">Exception</span><span class="keyword">();<br />  </span><span class="default">$a </span><span class="keyword">= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getImageBlob</span><span class="keyword">();<br />  print </span><span class="string">"Rendered to "</span><span class="keyword">.</span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">).</span><span class="string">" bytes\n"</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Restrict your output image size, or ensure that the blob you get back isn't empty.  (Note that IM seems to be doing the work, it delays for some time.  But there's no indication of any error anywhere.)</span></code></div>
  </div>
 </div>
  <div class="note" id="126289">  <div class="votes">
    <div id="Vu126289">
    <a href="/manual/vote-note.php?id=126289&amp;page=imagick.getimageblob&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126289">
    <a href="/manual/vote-note.php?id=126289&amp;page=imagick.getimageblob&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126289" title="42% like this...">
    -1
    </div>
  </div>
  <a href="#126289" class="name">
  <strong class="user"><em>jim at jimohalloran dot com</em></strong></a><a class="genanchor" href="#126289"> &para;</a><div class="date" title="2021-07-30 06:00"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126289">
<div class="phpcode"><code><span class="html">Further to Trevor's note above about getImageBlob potentially returning an empty string for large images.  <br /><br />This seems image format dependent.  I have a large (12046x8363) image which is returned ok.  But if I call setImageFormat('pdf') and then call getImageBlob() again.  Example:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Image Manipulation here.<br /></span><span class="default">$pngData </span><span class="keyword">= </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">getImageBlob</span><span class="keyword">();  </span><span class="comment">// Returns a large PNG.<br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'pdf'</span><span class="keyword">);<br /></span><span class="default">$pdfData </span><span class="keyword">= </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">getImageBlob</span><span class="keyword">(); </span><span class="comment">// Returns empty string immediately<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimageblob&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageblob.php">＋<small>add a note</small></a></div>
