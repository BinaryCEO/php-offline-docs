...
<head>
  ...
  <title>PHP: imageavif - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imageavif.php">
 <link rel="shorturl" href="https://www.php.net/imageavif">
 <link rel="alternate" href="https://www.php.net/imageavif" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagearc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagebmp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imageavif.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imageavif.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imageavif.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imageavif.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imageavif.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imageavif.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imageavif.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imageavif.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imageavif.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imageavif.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imageavif.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: imageavif - Manual" />
<meta name="twitter:description" content="Output image to browser or file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imageavif - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imageavif.php' selected="selected">English</option>
            <option value='de/function.imageavif.php'>German</option>
            <option value='es/function.imageavif.php'>Spanish</option>
            <option value='fr/function.imageavif.php'>French</option>
            <option value='it/function.imageavif.php'>Italian</option>
            <option value='ja/function.imageavif.php'>Japanese</option>
            <option value='pt_BR/function.imageavif.php'>Brazilian Portuguese</option>
            <option value='ru/function.imageavif.php'>Russian</option>
            <option value='tr/function.imageavif.php'>Turkish</option>
            <option value='uk/function.imageavif.php'>Ukrainian</option>
            <option value='zh/function.imageavif.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imageavif" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imageavif</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.1.0)</p><p class="refpurpose"><span class="refname">imageavif</span> &mdash; <span class="dc-title">Output image to browser or file</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.imageavif-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imageavif</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span></span> <code class="parameter">$file</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$quality</code><span class="initializer"> = -1</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$speed</code><span class="initializer"> = -1</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  
  <p class="para rdfs-comment">
   Outputs or saves a <abbr>AVIF</abbr> Raster image from the given <code class="parameter">image</code>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imageavif-parameters">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
     ...
     <dd>
      <p class="para">
       The path or an open stream resource (which is automatically closed after this function returns) to save the file to. If not set or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>, the raw image stream will be output directly.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       <code class="parameter">quality</code> is optional, and ranges from 0 (worst quality, smaller file)
       to 100 (best quality, larger file).
       If <code class="literal">-1</code> is provided, the default value <code class="literal">52</code> is used.
      </p>
     </dd>
    
    
     <dt><code class="parameter">speed</code></dt>
     <dd>
      <p class="para">
       <code class="parameter">speed</code> is optional, and ranges from 0 (slow, smaller file)
       to 10 (fast, larger file).
       If <code class="literal">-1</code> is provided, the default value <code class="literal">6</code> is used.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imageavif-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-function.imageavif-errors">
  <h3 class="title">Errors/Exceptions</h3>
  <p class="simpara">
   Throws a <span class="classname"><a href="class.valueerror.php" class="classname">ValueError</a></span> if <code class="parameter">quality</code>
   or <code class="parameter">speed</code> is invalid.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.imageavif-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.4.0</td>
      <td>
       Now throws a <span class="classname"><a href="class.valueerror.php" class="classname">ValueError</a></span> if <code class="parameter">quality</code>
       or <code class="parameter">speed</code> is invalid.
      </td>
     </tr>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imageavif-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imagetypes.php" class="function" rel="rdfs-seeAlso">imagetypes()</a> - Return the image types supported by this PHP build</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imageavif.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imageavif%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imageavif&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imageavif.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="127870">  <div class="votes">
    <div id="Vu127870">
    <a href="/manual/vote-note.php?id=127870&amp;page=function.imageavif&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127870">
    <a href="/manual/vote-note.php?id=127870&amp;page=function.imageavif&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127870" title="50% like this...">
    0
    </div>
  </div>
  <a href="#127870" class="name">
  <strong class="user"><em>avi at orons dot pro</em></strong></a><a class="genanchor" href="#127870"> &para;</a><div class="date" title="2022-10-28 06:31"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom127870">
<div class="phpcode"><code><span class="html">Usage example:<br />$image = imagecreatefromjpeg('test.jpg');  //read a jpg file<br />imageavif($image, 'test.avif');  //save an avif file</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imageavif&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imageavif.php">＋<small>add a note</small></a></div>
