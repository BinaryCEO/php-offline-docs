...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/xmlreader.lookupnamespace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/xmlreader.lookupnamespace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/xmlreader.lookupnamespace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.xmlreader.php">
 <link rel="prev" href="https://www.php.net/manual/en/xmlreader.isvalid.php">
 <link rel="next" href="https://www.php.net/manual/en/xmlreader.movetoattribute.php">
...
<meta name="Description" content="Lookup namespace for a prefix" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: XMLReader::lookupNamespace - Manual" />
<meta name="twitter:description" content="Lookup namespace for a prefix" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: XMLReader::lookupNamespace - Manual" />
<meta itemprop="description" content="Lookup namespace for a prefix" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Lookup namespace for a prefix" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/xmlreader.lookupnamespace.php' selected="selected">English</option>
            ...
            <option value='ja/xmlreader.lookupnamespace.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">XMLReader::lookupNamespace</span> &mdash; <span class="dc-title">Lookup namespace for a prefix</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-xmlreader.lookupnamespace-returnvalues">
  ...
  <p class="para">
   The value of the namespace, or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if no namespace exists.
  </p>
 </div>
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xmlreader/xmlreader/lookupnamespace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fxmlreader.lookupnamespace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=xmlreader.lookupnamespace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/xmlreader.lookupnamespace.php">＋<small>add a note</small></a></span>
