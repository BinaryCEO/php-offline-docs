...
<head>
  ...
  <title>PHP: pg_dbname - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-dbname.php">
 <link rel="shorturl" href="https://www.php.net/pg-dbname">
 <link rel="alternate" href="https://www.php.net/pg-dbname" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-copy-to.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-delete.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-dbname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-dbname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-dbname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-dbname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-dbname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-dbname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-dbname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-dbname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-dbname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-dbname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-dbname.php" hreflang="zh">
...
<meta name="Description" content="Get the database name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_dbname - Manual" />
<meta name="twitter:description" content="Get the database name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_dbname - Manual" />
<meta itemprop="description" content="Get the database name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the database name" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-dbname.php' selected="selected">English</option>
            <option value='de/function.pg-dbname.php'>German</option>
            <option value='es/function.pg-dbname.php'>Spanish</option>
            <option value='fr/function.pg-dbname.php'>French</option>
            <option value='it/function.pg-dbname.php'>Italian</option>
            <option value='ja/function.pg-dbname.php'>Japanese</option>
            <option value='pt_BR/function.pg-dbname.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-dbname.php'>Russian</option>
            <option value='tr/function.pg-dbname.php'>Turkish</option>
            <option value='uk/function.pg-dbname.php'>Ukrainian</option>
            <option value='zh/function.pg-dbname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-dbname" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_dbname</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_dbname</span> &mdash; <span class="dc-title">Get the database name</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-dbname-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_dbname</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span></span> <code class="parameter">$connection</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_dbname()</strong></span> returns the name of the database
   that the given PostgreSQL <code class="parameter">connection</code> instance.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.pg-dbname-parameters">
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-dbname-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   A <span class="type"><a href="language.types.string.php" class="type string">string</a></span> containing the name of the database the 
   <code class="parameter">connection</code> is to.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.pg-dbname-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-dbname-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2049">
    <p><strong>Example #1 <span class="function"><strong>pg_dbname()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />  error_reporting</span><span style="color: #007700">(</span><span style="color: #0000BB">E_ALL</span><span style="color: #007700">);<br /><br />  </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"host=localhost port=5432 dbname=mary"</span><span style="color: #007700">);<br />  echo </span><span style="color: #0000BB">pg_dbname</span><span style="color: #007700">(); </span><span style="color: #FF8000">// mary<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-dbname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-dbname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-dbname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-dbname.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="30640">  <div class="votes">
    <div id="Vu30640">
    <a href="/manual/vote-note.php?id=30640&amp;page=function.pg-dbname&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd30640">
    <a href="/manual/vote-note.php?id=30640&amp;page=function.pg-dbname&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V30640" title="50% like this...">
    0
    </div>
  </div>
  <a href="#30640" class="name">
  <strong class="user"><em>mark at redbrick dot dcu dot ie</em></strong></a><a class="genanchor" href="#30640"> &para;</a><div class="date" title="2003-03-24 12:37"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom30640">
<div class="phpcode"><code><span class="html">This function is as simple as it sounds, it returns the name of the database your are currently connected to on the handle retrieved from a pg_connect() call.<br /><br /><span class="default">&lt;?php<br />    $pgsql_conn </span><span class="keyword">= </span><span class="default">pg_connect</span><span class="keyword">(</span><span class="string">"dbname=mark host=localhost"</span><span class="keyword">);<br /><br />    if (</span><span class="default">$pgsql_conn</span><span class="keyword">) {<br />        print </span><span class="string">"Successfully connected to database: " </span><span class="keyword">. </span><span class="default">pg_dbname</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">) .<br />         </span><span class="string">" on " </span><span class="keyword">.  </span><span class="default">pg_host</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">) . </span><span class="string">"&lt;br/&gt;\n"</span><span class="keyword">;<br />    } else {<br />        print </span><span class="default">pg_last_error</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">);<br />        exit;<br />    }<br /></span><span class="default">?&gt;<br /></span><br />[mark@prodigy][*][~/public_html/php]&gt;&gt;&gt;php pg_dbname.php<br />Content-type: text/html<br />X-Powered-By: PHP/4.3.1<br /><br />Successfully connected to database: mark on localhost&lt;br/&gt;<br /><br />Again this function is much more useful when you are changing which database you are connected to in your program.<br /><br />Regards,  --mark</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-dbname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-dbname.php">＋<small>add a note</small></a></div>
