...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/yaf-route-supervar.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/yaf-route-supervar.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/yaf-route-supervar.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.yaf-route-supervar.php">
 <link rel="prev" href="https://www.php.net/manual/en/yaf-route-supervar.assemble.php">
 <link rel="next" href="https://www.php.net/manual/en/yaf-route-supervar.route.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/yaf-route-supervar.construct.php' selected="selected">English</option>
            ...
            <option value='pt_BR/yaf-route-supervar.construct.php'>Brazilian Portuguese</option>
 ...
 <div class="refsect1 description" id="refsect1-yaf-route-supervar.construct-description">
  ...
  <p class="para rdfs-comment">
   <span class="classname"><a href="class.yaf-route-supervar.php" class="classname">Yaf_Route_Supervar</a></span> is similar with
   <span class="classname"><a href="class.yaf-route-static.php" class="classname">Yaf_Route_Static</a></span>, the difference is
   <span class="classname"><a href="class.yaf-route-supervar.php" class="classname">Yaf_Route_Supervar</a></span> will look for path info in query
   string, and the parameter <var class="varname">supervar_name</var> is the key.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-yaf-route-supervar.construct-examples">
  ...
  <div class="example" id="example-4240">
   <p><strong>Example #1 <span class="classname"><a href="class.yaf-route-supervar.php" class="classname">Yaf_Route_Supervar</a></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">/** for request: http://yourdomain.com/xx/oo/?r=/ctr/act/var/value
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.yaf-route-map.php" class="classname">Yaf_Route_Map</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaf/yaf_route_supervar/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fyaf-route-supervar.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=yaf-route-supervar.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/yaf-route-supervar.construct.php">＋<small>add a note</small></a></span>
