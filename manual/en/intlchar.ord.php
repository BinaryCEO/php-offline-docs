...
<head>
  ...
  <title>PHP: IntlChar::ord - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.ord.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.ord.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.ord.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.isxdigit.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.tolower.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.ord.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.ord.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.ord.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.ord.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.ord.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.ord.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.ord.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.ord.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.ord.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.ord.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.ord.php" hreflang="zh">
...
<meta name="Description" content="Return Unicode code point value of character" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::ord - Manual" />
<meta name="twitter:description" content="Return Unicode code point value of character" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::ord - Manual" />
<meta itemprop="description" content="Return Unicode code point value of character" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return Unicode code point value of character" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.tolower.php">
          IntlChar::tolower &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.isxdigit.php">
          &laquo; IntlChar::isxdigit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.ord.php' selected="selected">English</option>
            <option value='de/intlchar.ord.php'>German</option>
            <option value='es/intlchar.ord.php'>Spanish</option>
            <option value='fr/intlchar.ord.php'>French</option>
            <option value='it/intlchar.ord.php'>Italian</option>
            <option value='ja/intlchar.ord.php'>Japanese</option>
            <option value='pt_BR/intlchar.ord.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.ord.php'>Russian</option>
            <option value='tr/intlchar.ord.php'>Turkish</option>
            <option value='uk/intlchar.ord.php'>Ukrainian</option>
            <option value='zh/intlchar.ord.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.ord" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::ord</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::ord</span> &mdash; <span class="dc-title">Return Unicode code point value of character</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlchar.ord-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::ord</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$character</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span></div>

  <p class="para rdfs-comment">
   Returns the Unicode code point value of the given character.
  </p>
  <p class="para">
   This function complements <span class="function"><a href="intlchar.chr.php" class="function">IntlChar::chr()</a></span>.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ord.php" class="function" rel="rdfs-seeAlso">ord()</a> - Convert the first byte of a string to a value between 0 and 255</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/ord.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.ord%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.ord&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.ord.php">＋<small>add a note</small></a></span>
