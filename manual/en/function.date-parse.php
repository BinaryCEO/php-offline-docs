...
<head>
  ...
  <title>PHP: date_parse - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-parse.php">
 <link rel="shorturl" href="https://www.php.net/date-parse">
 <link rel="alternate" href="https://www.php.net/date-parse" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-offset-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-parse-from-format.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-parse.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-parse.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-parse.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-parse.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-parse.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-parse.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-parse.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-parse.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-parse.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-parse.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-parse.php" hreflang="zh">
...
<meta name="Description" content="Returns associative array with detailed info about given date/time" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_parse - Manual" />
<meta name="twitter:description" content="Returns associative array with detailed info about given date/time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_parse - Manual" />
<meta itemprop="description" content="Returns associative array with detailed info about given date/time" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns associative array with detailed info about given date/time" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.date-parse-from-format.php">
          date_parse_from_format &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.date-offset-get.php">
          &laquo; date_offset_get        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-parse.php' selected="selected">English</option>
            <option value='de/function.date-parse.php'>German</option>
            <option value='es/function.date-parse.php'>Spanish</option>
            <option value='fr/function.date-parse.php'>French</option>
            <option value='it/function.date-parse.php'>Italian</option>
            <option value='ja/function.date-parse.php'>Japanese</option>
            <option value='pt_BR/function.date-parse.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-parse.php'>Russian</option>
            <option value='tr/function.date-parse.php'>Turkish</option>
            <option value='uk/function.date-parse.php'>Ukrainian</option>
            <option value='zh/function.date-parse.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-parse" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">date_parse</span><span style="color: #007700">(</span><span style="color: #DD0000">"June 2nd, 2022, 10:28:17 BST"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="example-contents"><p>The above example will output:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">array(16) {
  [&quot;year&quot;]=&gt;
  int(2022)
  [&quot;month&quot;]=&gt;
  int(6)
  ...
  string(3) &quot;BST&quot;
   ...
   <div class="example" id="example-2276">
    ...
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">date_parse</span><span style="color: #007700">(</span><span style="color: #DD0000">"June 2nd, 2022, 10:28:17 Europe/London"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
<div class="examplescode"><pre class="examplescode">array(14) {
  ...
  <p class="para">
   ...
   <div class="example" id="example-2277">
    ...
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">date_parse</span><span style="color: #007700">(</span><span style="color: #DD0000">"June 2nd, 2022"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
<div class="examplescode"><pre class="examplescode">array(12) {
  ...
  <p class="para">
   ...
   <div class="example" id="example-2278">
    ...
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">date_parse</span><span style="color: #007700">(</span><span style="color: #DD0000">"2006-12-12 10:00:00.5 +1 week +1 hour"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.date-parse-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.checkdate.php" class="function" rel="rdfs-seeAlso">checkdate()</a> - Validate a Gregorian date</span> for Gregorian date validation</li>
    <li><span class="function"><a href="function.getdate.php" class="function" rel="rdfs-seeAlso">getdate()</a> - Get date/time information</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-parse.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-parse%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-parse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-parse.php">＋<small>add a note</small></a></span>
