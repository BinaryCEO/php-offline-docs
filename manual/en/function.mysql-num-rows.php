...
<head>
  ...
  <title>PHP: mysql_num_rows - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-num-rows.php">
 <link rel="shorturl" href="https://www.php.net/mysql-num-rows">
 <link rel="alternate" href="https://www.php.net/mysql-num-rows" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-num-fields.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-pconnect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-num-rows.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-num-rows.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-num-rows.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-num-rows.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-num-rows.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-num-rows.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-num-rows.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-num-rows.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-num-rows.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-num-rows.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-num-rows.php" hreflang="zh">
...
<meta name="Description" content="Get number of rows in result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_num_rows - Manual" />
<meta name="twitter:description" content="Get number of rows in result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_num_rows - Manual" />
<meta itemprop="description" content="Get number of rows in result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get number of rows in result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-pconnect.php">
          mysql_pconnect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-num-fields.php">
          &laquo; mysql_num_fields        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-num-rows.php' selected="selected">English</option>
            <option value='de/function.mysql-num-rows.php'>German</option>
            <option value='es/function.mysql-num-rows.php'>Spanish</option>
            <option value='fr/function.mysql-num-rows.php'>French</option>
            <option value='it/function.mysql-num-rows.php'>Italian</option>
            <option value='ja/function.mysql-num-rows.php'>Japanese</option>
            <option value='pt_BR/function.mysql-num-rows.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-num-rows.php'>Russian</option>
            <option value='tr/function.mysql-num-rows.php'>Turkish</option>
            <option value='uk/function.mysql-num-rows.php'>Ukrainian</option>
            <option value='zh/function.mysql-num-rows.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-num-rows" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_num_rows</h1>
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_num_rows</span> &mdash; <span class="dc-title">Get number of rows in result</span></p>
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli-result.num-rows.php" class="function">mysqli_num_rows()</a></span></li>
    <li><span class="function"><a href="mysqli-stmt.num-rows.php" class="function">mysqli_stmt_num_rows()</a></span></li>
 ...
 <div class="refsect1 description" id="refsect1-function.mysql-num-rows-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_num_rows</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   DELETE query, use <span class="function"><a href="function.mysql-affected-rows.php" class="function">mysql_affected_rows()</a></span>.
  </p>
 </div>
...
<span class="function"><a href="function.mysql-query.php" class="function">mysql_query()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-num-rows-returnvalues">
  ...
  <p class="para">
   The number of rows in a result set on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$link </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #DD0000">"mysql_user"</span><span style="color: #007700">, </span><span style="color: #DD0000">"mysql_password"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">mysql_select_db</span><span style="color: #007700">(</span><span style="color: #DD0000">"database"</span><span style="color: #007700">, </span><span style="color: #0000BB">$link</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_query</span><span style="color: #007700">(</span><span style="color: #DD0000">"SELECT * FROM table1"</span><span style="color: #007700">, </span><span style="color: #0000BB">$link</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$num_rows </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_num_rows</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">);<br /><br />echo </span><span style="color: #DD0000">"</span><span style="color: #0000BB">$num_rows</span><span style="color: #DD0000"> Rows\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.mysql-num-rows-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    If you use <span class="function"><a href="function.mysql-unbuffered-query.php" class="function">mysql_unbuffered_query()</a></span>, 
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-query.php" class="function" rel="rdfs-seeAlso">mysql_query()</a> - Send a MySQL query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-num-rows.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-num-rows%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-num-rows&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-num-rows.php">＋<small>add a note</small></a></span>
