...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/datetime.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/datetime.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/datetime.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/datetime.configuration.php">
 <link rel="next" href="https://www.php.net/manual/en/datetime.examples.php">

 <link rel="alternate" href="https://www.php.net/manual/en/datetime.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/datetime.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/datetime.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/datetime.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/datetime.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/datetime.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/datetime.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/datetime.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/datetime.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/datetime.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/datetime.constants.php" hreflang="zh">
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="datetime.examples.php">
          Examples &raquo;
              ...
              <div class="prev">
        <a href="datetime.configuration.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/datetime.constants.php' selected="selected">English</option>
            <option value='de/datetime.constants.php'>German</option>
            <option value='es/datetime.constants.php'>Spanish</option>
            <option value='fr/datetime.constants.php'>French</option>
            <option value='it/datetime.constants.php'>Italian</option>
            <option value='ja/datetime.constants.php'>Japanese</option>
            <option value='pt_BR/datetime.constants.php'>Brazilian Portuguese</option>
            <option value='ru/datetime.constants.php'>Russian</option>
            <option value='tr/datetime.constants.php'>Turkish</option>
            <option value='uk/datetime.constants.php'>Ukrainian</option>
            <option value='zh/datetime.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="datetime.constants" class="appendix">
 <h1 class="title">Predefined Constants</h1>

 <p class="para">
  The <strong><code><a href="datetime.constants.php#constant.date-atom">DATE_<span class="replaceable">*</span></a></code></strong>
  constants are defined and offer standard
  date representations, which can be used along with the date format functions
  (like <span class="function"><a href="function.date.php" class="function">date()</a></span>).
 </p>

 <dl>
  <strong class="title">
   Available <code class="parameter">returnFormat</code> for
   <span class="function"><a href="function.date-sunrise.php" class="function">date_sunrise()</a></span> and
  ...
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="simpara">
    ...
    The corresponding <span class="function"><a href="function.date-sunrise.php" class="function">date_sunrise()</a></span> and
    <span class="function"><a href="function.date-sunset.php" class="function">date_sunset()</a></span> functions are deprecated as of PHP 8.1.0.
   </p>
  </div>
   ...
   <dd>
    <span class="simpara">
     Hours:minutes (example: <code class="literal">08:02</code>)
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     Hours as floating point number (example <code class="literal">8.75</code>)
    </span>
   </dd>
 ...
 <dl>
  <strong class="title"><strong><code><a href="datetime.constants.php#constant.date-atom">DATE_<span class="replaceable">*</span></a></code></strong> constants</strong>
   ...
   <dd>
    <span class="simpara">
     Atom (example: <code class="literal">2005-08-15T15:52:01+00:00</code>)
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     HTTP Cookies (example: <code class="literal">Monday, 15-Aug-2005 15:52:01 UTC</code>)
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     ISO-8601 (example: <code class="literal">2005-08-15T15:52:01+0000</code>)
    </span>
    <blockquote class="note"><p><strong class="note">Note</strong>: 
     <span class="simpara">
      ...
      <strong><code><a href="datetime.constants.php#constant.date-atom">DATE_ATOM</a></code></strong> for compatibility with ISO-8601
   ...
   <dd>
    <span class="simpara">
     ISO-8601 Expanded (example: <code class="literal">+10191-07-26T08:59:52+01:00</code>)
    </span>
    <blockquote class="note"><p><strong class="note">Note</strong>: 
     <span class="simpara">
   ...
   <dd>
    <span class="simpara">
     RFC 822 (example: <code class="literal">Mon, 15 Aug 05 15:52:01 +0000</code>)
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     RFC 850 (example: <code class="literal">Monday, 15-Aug-05 15:52:01 UTC</code>)
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     RFC 1036 (example: <code class="literal">Mon, 15 Aug 05 15:52:01 +0000</code>)
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     RFC 1123 (example: <code class="literal">Mon, 15 Aug 2005 15:52:01 +0000</code>)
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     ...
     (example: <code class="literal">Sat, 30 Apr 2016 17:52:13 GMT</code>)
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     RFC 2822 (example: <code class="literal">Mon, 15 Aug 2005 15:52:01 +0000</code>)
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     ...
     (example: <code class="literal">2005-08-15T15:52:01.000+00:00</code>)
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     RSS (example: <code class="literal">Mon, 15 Aug 2005 15:52:01 +0000</code>).
     Alias of <strong><code><a href="datetime.constants.php#constant.date-rfc1123">DATE_RFC1123</a></code></strong>.
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     World Wide Web Consortium (example: <code class="literal">2005-08-15T15:52:01+00:00</code>).
     Alias of <strong><code><a href="datetime.constants.php#constant.date-rfc3339">DATE_RFC3339</a></code></strong>.
    </span>
   </dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdatetime.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=datetime.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/datetime.constants.php">＋<small>add a note</small></a></span>
