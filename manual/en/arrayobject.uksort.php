...
<head>
  ...
  <title>PHP: ArrayObject::uksort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/arrayobject.uksort.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/arrayobject.uksort.php">
 <link rel="alternate" href="https://www.php.net/manual/en/arrayobject.uksort.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.arrayobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/arrayobject.uasort.php">
 <link rel="next" href="https://www.php.net/manual/en/arrayobject.unserialize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/arrayobject.uksort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/arrayobject.uksort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/arrayobject.uksort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/arrayobject.uksort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/arrayobject.uksort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/arrayobject.uksort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/arrayobject.uksort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/arrayobject.uksort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/arrayobject.uksort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/arrayobject.uksort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/arrayobject.uksort.php" hreflang="zh">
...
<meta name="Description" content="Sort the entries by keys using a user-defined comparison function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ArrayObject::uksort - Manual" />
<meta name="twitter:description" content="Sort the entries by keys using a user-defined comparison function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ArrayObject::uksort - Manual" />
<meta itemprop="description" content="Sort the entries by keys using a user-defined comparison function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sort the entries by keys using a user-defined comparison function" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="arrayobject.unserialize.php">
          ArrayObject::unserialize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="arrayobject.uasort.php">
          &laquo; ArrayObject::uasort        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/arrayobject.uksort.php' selected="selected">English</option>
            <option value='de/arrayobject.uksort.php'>German</option>
            <option value='es/arrayobject.uksort.php'>Spanish</option>
            <option value='fr/arrayobject.uksort.php'>French</option>
            <option value='it/arrayobject.uksort.php'>Italian</option>
            <option value='ja/arrayobject.uksort.php'>Japanese</option>
            <option value='pt_BR/arrayobject.uksort.php'>Brazilian Portuguese</option>
            <option value='ru/arrayobject.uksort.php'>Russian</option>
            <option value='tr/arrayobject.uksort.php'>Turkish</option>
            <option value='uk/arrayobject.uksort.php'>Ukrainian</option>
            <option value='zh/arrayobject.uksort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="arrayobject.uksort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ArrayObject::uksort</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ArrayObject::uksort</span> &mdash; <span class="dc-title">Sort the entries by keys using a user-defined comparison function</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-arrayobject.uksort-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ArrayObject::uksort</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-arrayobject.uksort-parameters">
...
<div class="caution"><strong class="caution">Caution</strong>
 ...
 <div class="refsect1 returnvalues" id="refsect1-arrayobject.uksort-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-arrayobject.uksort-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-arrayobject.uksort-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3876">
    <p><strong>Example #1 <span class="function"><strong>ArrayObject::uksort()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">an apple: 3
a banana: 4
the Earth: 2
John: 1</pre>
</div>
 ...
 <div class="refsect1 seealso" id="refsect1-arrayobject.uksort-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.uksort.php" class="function" rel="rdfs-seeAlso">uksort()</a> - Sort an array by keys using a user-defined comparison function</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/arrayobject/uksort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Farrayobject.uksort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=arrayobject.uksort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/arrayobject.uksort.php">＋<small>add a note</small></a></span>
