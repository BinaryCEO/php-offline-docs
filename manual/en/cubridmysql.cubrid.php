...
<head>
  ...
  <title>PHP: CUBRID MySQL Compatibility Functions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/cubridmysql.cubrid.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/cubridmysql.cubrid.php">
 <link rel="alternate" href="https://www.php.net/manual/en/cubridmysql.cubrid.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-version.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-affected-rows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/cubridmysql.cubrid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/cubridmysql.cubrid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/cubridmysql.cubrid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/cubridmysql.cubrid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/cubridmysql.cubrid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/cubridmysql.cubrid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/cubridmysql.cubrid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/cubridmysql.cubrid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/cubridmysql.cubrid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/cubridmysql.cubrid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/cubridmysql.cubrid.php" hreflang="zh">
...
<meta name="Description" content="CUBRID MySQL Compatibility Functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CUBRID MySQL Compatibility Functions - Manual" />
<meta name="twitter:description" content="CUBRID MySQL Compatibility Functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CUBRID MySQL Compatibility Functions - Manual" />
<meta itemprop="description" content="CUBRID MySQL Compatibility Functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="CUBRID MySQL Compatibility Functions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-affected-rows.php">
          cubrid_affected_rows &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-version.php">
          &laquo; cubrid_version        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/cubridmysql.cubrid.php' selected="selected">English</option>
            <option value='de/cubridmysql.cubrid.php'>German</option>
            <option value='es/cubridmysql.cubrid.php'>Spanish</option>
            <option value='fr/cubridmysql.cubrid.php'>French</option>
            <option value='it/cubridmysql.cubrid.php'>Italian</option>
            <option value='ja/cubridmysql.cubrid.php'>Japanese</option>
            <option value='pt_BR/cubridmysql.cubrid.php'>Brazilian Portuguese</option>
            <option value='ru/cubridmysql.cubrid.php'>Russian</option>
            <option value='tr/cubridmysql.cubrid.php'>Turkish</option>
            <option value='uk/cubridmysql.cubrid.php'>Ukrainian</option>
            <option value='zh/cubridmysql.cubrid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="cubridmysql.cubrid" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="function.cubrid-affected-rows.php">cubrid_affected_rows</a> — Return the number of rows affected by the last SQL statement</li><li><a href="function.cubrid-client-encoding.php">cubrid_client_encoding</a> — Return the current CUBRID connection charset</li><li><a href="function.cubrid-close.php">cubrid_close</a> — Close CUBRID connection</li><li><a href="function.cubrid-data-seek.php">cubrid_data_seek</a> — Move the internal row pointer of the CUBRID result</li><li><a href="function.cubrid-db-name.php">cubrid_db_name</a> — Get db name from results of cubrid_list_dbs</li><li><a href="function.cubrid-errno.php">cubrid_errno</a> — Return the numerical value of the error message from previous CUBRID operation</li><li><a href="function.cubrid-error.php">cubrid_error</a> — Get the error message</li><li><a href="function.cubrid-fetch-array.php">cubrid_fetch_array</a> — Fetch a result row as an associative array, a numeric array, or both</li><li><a href="function.cubrid-fetch-assoc.php">cubrid_fetch_assoc</a> — Return the associative array that corresponds to the fetched row</li><li><a href="function.cubrid-fetch-field.php">cubrid_fetch_field</a> — Get column information from a result and return as an object</li><li><a href="function.cubrid-fetch-lengths.php">cubrid_fetch_lengths</a> — Return an array with the lengths of the values of each field from the current row</li><li><a href="function.cubrid-fetch-object.php">cubrid_fetch_object</a> — Fetch the next row and return it as an object</li><li><a href="function.cubrid-fetch-row.php">cubrid_fetch_row</a> — Return a numerical array with the values of the current row</li><li><a href="function.cubrid-field-flags.php">cubrid_field_flags</a> — Return a string with the flags of the given field offset</li><li><a href="function.cubrid-field-len.php">cubrid_field_len</a> — Get the maximum length of the specified field</li><li><a href="function.cubrid-field-name.php">cubrid_field_name</a> — Return the name of the specified field index</li><li><a href="function.cubrid-field-seek.php">cubrid_field_seek</a> — Move the result set cursor to the specified field offset</li><li><a href="function.cubrid-field-table.php">cubrid_field_table</a> — Return the name of the table of the specified field</li><li><a href="function.cubrid-field-type.php">cubrid_field_type</a> — Return the type of the column corresponding to the given field offset</li><li><a href="function.cubrid-list-dbs.php">cubrid_list_dbs</a> — Return an array with the list of all existing CUBRID databases</li><li><a href="function.cubrid-num-fields.php">cubrid_num_fields</a> — Return the number of columns in the result set</li><li><a href="function.cubrid-ping.php">cubrid_ping</a> — Ping a server connection or reconnect if there is no connection</li><li><a href="function.cubrid-query.php">cubrid_query</a> — Send a CUBRID query</li><li><a href="function.cubrid-real-escape-string.php">cubrid_real_escape_string</a> — Escape special characters in a string for use in an SQL statement</li><li><a href="function.cubrid-result.php">cubrid_result</a> — Return the value of a specific field in a specific row</li><li><a href="function.cubrid-unbuffered-query.php">cubrid_unbuffered_query</a> — Perform a query without fetching the results into memory</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/cubridmysql.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcubridmysql.cubrid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=cubridmysql.cubrid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/cubridmysql.cubrid.php">＋<small>add a note</small></a></span>
