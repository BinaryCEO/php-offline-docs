...
<head>
  ...
  <title>PHP: get_resources - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.get-resources.php">
 <link rel="shorturl" href="https://www.php.net/get-resources">
 <link rel="alternate" href="https://www.php.net/get-resources" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.get-required-files.php">
 <link rel="next" href="https://www.php.net/manual/en/function.getenv.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.get-resources.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.get-resources.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.get-resources.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.get-resources.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.get-resources.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.get-resources.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.get-resources.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.get-resources.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.get-resources.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.get-resources.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.get-resources.php" hreflang="zh">
...
<meta name="Description" content="Returns active resources" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: get_resources - Manual" />
<meta name="twitter:description" content="Returns active resources" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: get_resources - Manual" />
<meta itemprop="description" content="Returns active resources" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns active resources" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.get-resources.php' selected="selected">English</option>
            <option value='de/function.get-resources.php'>German</option>
            <option value='es/function.get-resources.php'>Spanish</option>
            <option value='fr/function.get-resources.php'>French</option>
            <option value='it/function.get-resources.php'>Italian</option>
            <option value='ja/function.get-resources.php'>Japanese</option>
            <option value='pt_BR/function.get-resources.php'>Brazilian Portuguese</option>
            <option value='ru/function.get-resources.php'>Russian</option>
            <option value='tr/function.get-resources.php'>Turkish</option>
            <option value='uk/function.get-resources.php'>Ukrainian</option>
            <option value='zh/function.get-resources.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.get-resources" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.get-resources-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>get_resources</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$type</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   Returns an array of all currently active <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>s, optionally
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <span class="simpara">
    ...
    of <span class="classname"><a href="class.splfileobject.php" class="classname">SplFileObject</a></span> instances).
   </span>
  </p></blockquote>
 </div>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <a href="resource.php" class="link">A list of resource types is available.</a>
      </p>
      <p class="para">
       If the <span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="literal">Unknown</code> is provided as
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.get-resources-returnvalues">
  ...
  <p class="para">
   Returns an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> of currently active resources, indexed by
   resource number.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.get-defined-vars.php" class="function" rel="rdfs-seeAlso">get_defined_vars()</a> - Returns an array of all defined variables</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/get-resources.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.get-resources%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.get-resources&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-resources.php">＋<small>add a note</small></a></span>
