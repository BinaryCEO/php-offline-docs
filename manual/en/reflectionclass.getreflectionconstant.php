...
<head>
  ...
  <title>PHP: ReflectionClass::getReflectionConstant - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getreflectionconstant.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getreflectionconstant.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getreflectionconstant.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getproperty.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getreflectionconstants.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getreflectionconstant.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getreflectionconstant.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getreflectionconstant.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getreflectionconstant.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getreflectionconstant.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getreflectionconstant.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getreflectionconstant.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getreflectionconstant.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getreflectionconstant.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getreflectionconstant.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getreflectionconstant.php" hreflang="zh">
...
<meta name="Description" content="Gets a ReflectionClassConstant for a class's constant" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getReflectionConstant - Manual" />
<meta name="twitter:description" content="Gets a ReflectionClassConstant for a class's constant" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getReflectionConstant - Manual" />
<meta itemprop="description" content="Gets a ReflectionClassConstant for a class's constant" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets a ReflectionClassConstant for a class's constant" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionclass.getreflectionconstants.php">
          ReflectionClass::getReflectionConstants &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getproperty.php">
          &laquo; ReflectionClass::getProperty        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getreflectionconstant.php' selected="selected">English</option>
            <option value='de/reflectionclass.getreflectionconstant.php'>German</option>
            <option value='es/reflectionclass.getreflectionconstant.php'>Spanish</option>
            <option value='fr/reflectionclass.getreflectionconstant.php'>French</option>
            <option value='it/reflectionclass.getreflectionconstant.php'>Italian</option>
            <option value='ja/reflectionclass.getreflectionconstant.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getreflectionconstant.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getreflectionconstant.php'>Russian</option>
            <option value='tr/reflectionclass.getreflectionconstant.php'>Turkish</option>
            <option value='uk/reflectionclass.getreflectionconstant.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getreflectionconstant.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getreflectionconstant" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::getReflectionConstant</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.1.0, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getReflectionConstant</span> &mdash; <span class="dc-title">Gets a <span class="classname"><a href="class.reflectionclassconstant.php" class="classname">ReflectionClassConstant</a></span> for a class&#039;s constant</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.getreflectionconstant-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::getReflectionConstant</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>): <span class="type"><span class="type"><a href="class.reflectionclassconstant.php" class="type ReflectionClassConstant">ReflectionClassConstant</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Gets a <span class="classname"><a href="class.reflectionclassconstant.php" class="classname">ReflectionClassConstant</a></span> for a class&#039;s constant.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-reflectionclass.getreflectionconstant-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.getreflectionconstant-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   A <span class="classname"><a href="class.reflectionclassconstant.php" class="classname">ReflectionClassConstant</a></span>,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>

 
 <div class="refsect1 seealso" id="refsect1-reflectionclass.getreflectionconstant-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.getreflectionconstants.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getReflectionConstants()</a> - Gets class constants</span></li>
    <li><span class="classname"><a href="class.reflectionclassconstant.php" class="classname">ReflectionClassConstant</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getreflectionconstant.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getreflectionconstant%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getreflectionconstant&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getreflectionconstant.php">＋<small>add a note</small></a></span>
