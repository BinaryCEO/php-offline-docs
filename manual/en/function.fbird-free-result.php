...
<head>
  ...
  <title>PHP: fbird_free_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-free-result.php">
 <link rel="shorturl" href="https://www.php.net/fbird-free-result">
 <link rel="alternate" href="https://www.php.net/fbird-free-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-free-query.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-gen-id.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-free-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-free-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-free-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-free-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-free-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-free-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-free-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-free-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-free-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-free-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-free-result.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_free_result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_free_result - Manual" />
<meta name="twitter:description" content="Alias of ibase_free_result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_free_result - Manual" />
<meta itemprop="description" content="Alias of ibase_free_result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_free_result" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-free-result.php' selected="selected">English</option>
            <option value='de/function.fbird-free-result.php'>German</option>
            <option value='es/function.fbird-free-result.php'>Spanish</option>
            <option value='fr/function.fbird-free-result.php'>French</option>
            <option value='it/function.fbird-free-result.php'>Italian</option>
            <option value='ja/function.fbird-free-result.php'>Japanese</option>
            <option value='pt_BR/function.fbird-free-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-free-result.php'>Russian</option>
            <option value='tr/function.fbird-free-result.php'>Turkish</option>
            <option value='uk/function.fbird-free-result.php'>Ukrainian</option>
            <option value='zh/function.fbird-free-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-free-result" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_free_result</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_free_result</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-free-result.php" class="function">ibase_free_result()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-free-result-description">
  ...
  <p class="simpara">
   ...
   <span class="function"><a href="function.ibase-free-result.php" class="function">ibase_free_result()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-free-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-free-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-free-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-free-result.php">＋<small>add a note</small></a></span>
