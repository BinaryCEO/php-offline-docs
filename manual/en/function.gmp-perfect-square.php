...
<head>
  ...
  <title>PHP: gmp_perfect_square - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-perfect-square.php">
 <link rel="shorturl" href="https://www.php.net/gmp-perfect-square">
 <link rel="alternate" href="https://www.php.net/gmp-perfect-square" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-perfect-power.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-popcount.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-perfect-square.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-perfect-square.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-perfect-square.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-perfect-square.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-perfect-square.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-perfect-square.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-perfect-square.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-perfect-square.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-perfect-square.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-perfect-square.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-perfect-square.php" hreflang="zh">
...
<meta name="Description" content="Perfect square check" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_perfect_square - Manual" />
<meta name="twitter:description" content="Perfect square check" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_perfect_square - Manual" />
<meta itemprop="description" content="Perfect square check" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Perfect square check" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.gmp-popcount.php">
          gmp_popcount &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.gmp-perfect-power.php">
          &laquo; gmp_perfect_power        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-perfect-square.php' selected="selected">English</option>
            <option value='de/function.gmp-perfect-square.php'>German</option>
            <option value='es/function.gmp-perfect-square.php'>Spanish</option>
            <option value='fr/function.gmp-perfect-square.php'>French</option>
            <option value='it/function.gmp-perfect-square.php'>Italian</option>
            <option value='ja/function.gmp-perfect-square.php'>Japanese</option>
            <option value='pt_BR/function.gmp-perfect-square.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-perfect-square.php'>Russian</option>
            <option value='tr/function.gmp-perfect-square.php'>Turkish</option>
            <option value='uk/function.gmp-perfect-square.php'>Ukrainian</option>
            <option value='zh/function.gmp-perfect-square.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-perfect-square" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_perfect_square</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_perfect_square</span> &mdash; <span class="dc-title">Perfect square check</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-perfect-square-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_perfect_square</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gmp-perfect-square-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-perfect-square-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if <code class="parameter">num</code> is a perfect square,
   <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.gmp-perfect-square-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3338">
    <p><strong>Example #1 <span class="function"><strong>gmp_perfect_square()</strong></span> example</strong></p>
...
bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.gmp-perfect-square-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.gmp-perfect-power.php" class="function" rel="rdfs-seeAlso">gmp_perfect_power()</a> - Perfect power check</span></li>
    <li><span class="function"><a href="function.gmp-sqrt.php" class="function" rel="rdfs-seeAlso">gmp_sqrt()</a> - Calculate square root</span></li>
    <li><span class="function"><a href="function.gmp-sqrtrem.php" class="function" rel="rdfs-seeAlso">gmp_sqrtrem()</a> - Square root with remainder</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-perfect-square.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-perfect-square%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-perfect-square&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-perfect-square.php">＋<small>add a note</small></a></span>
