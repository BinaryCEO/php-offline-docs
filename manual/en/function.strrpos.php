...
function.</p></div>
 ...
 <div class="refsect1 examples" id="refsect1-function.strrpos-examples">
  ...
  <p class="para">
   <div class="example" id="example-5169">
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$mystring </span><span style="color: #007700">= </span><span style="color: #DD0000">'Elephpant'</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">$pos </span><span style="color: #007700">= </span><span style="color: #0000BB">strrpos</span><span style="color: #007700">(</span><span style="color: #0000BB">$mystring</span><span style="color: #007700">, </span><span style="color: #DD0000">"b"</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">$pos </span><span style="color: #007700">=== </span><span style="color: #0000BB">false</span><span style="color: #007700">) { </span><span style="color: #FF8000">// note: three equal signs<br />    // not found...<br /></span><span style="color: #007700">}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-5170">
...
<div class="phpcode"><code><span class="html">Ten years on, Brian's note is still a good overview of how offsets work, but a shorter and simpler summary is:<br /><br />    strrpos($x, $y, 50);  // 1: this tells strrpos() when to STOP, counting from the START of $x<br />    strrpos($x, $y, -50); // 2: this tells strrpos() when to START, counting from the END of $x<br /><br />Or to put it another way, a positive number lets you search the rightmost section of the string, while a negative number lets you search the leftmost section of the string.<br /><br />Both these variations are useful, but picking the wrong one can cause some highly confusing results!</span></code></div>
  ...
  <strong class="user"><em>Daniel Brinca</em></strong></a><a class="genanchor" href="#78499"> &para;</a><div class="date" title="2007-10-15 05:41"><strong>17 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">Here is a simple function to find the position of the next occurrence of needle in haystack, but searching backwards  (lastIndexOf type function):<br /><br />//search backwards for needle in haystack, and return its position<br />function rstrpos ($haystack, $needle, $offset){<br />    $size = strlen ($haystack);<br />    $pos = strpos (strrev($haystack), $needle, $size - $offset);<br />    <br />    if ($pos === false)<br />        return false;<br />    <br />    return $size - $pos;<br />}<br /><br />Note: supports full strings as needle</span></code></div>
  ...
  <div class="note" id="130438">  <div class="votes">
    <div id="Vu130438">
    <a href="/manual/vote-note.php?id=130438&amp;page=function.strrpos&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130438">
    <a href="/manual/vote-note.php?id=130438&amp;page=function.strrpos&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130438" title="no votes...">
    0
    </div>
  </div>
  <a href="#130438" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#130438"> &para;</a><div class="date" title="2025-08-01 05:34"><strong>1 month ago</strong></div>
  <div class="text" id="Hcom130438">
<div class="phpcode"><code><span class="html">I just found out the hard way, that PHP 8.1 and 8.2 throw fatal errors if the offset is negative, and the string is too short.  Maybe ? also if the offset is positive and the string is too short?<br /><br />I don't have complete documentation, but I believe the source string was either a null-string "" or "/" (representing the document's root).  The offset was (-2).  That threw a fatal error, but not using PHP 5.3 on my other server (old software there that's not getting updated).<br /><br />So at what version does PHP start throwing fatal errors and shutting down your website?  When does PHP start forcing you to perform manual checks and write additional code to work?  I don't know.  Anybody else have a clue?</span></code></div>
  </div>
 </div></div>
