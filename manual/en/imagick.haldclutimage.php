...
<head>
  ...
  <title>PHP: Imagick::haldClutImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.haldclutimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.haldclutimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.haldclutimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getversion.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.hasnextimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.haldclutimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.haldclutimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.haldclutimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.haldclutimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.haldclutimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.haldclutimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.haldclutimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.haldclutimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.haldclutimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.haldclutimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.haldclutimage.php" hreflang="zh">
...
<meta name="Description" content="Replaces colors in the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::haldClutImage - Manual" />
<meta name="twitter:description" content="Replaces colors in the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::haldClutImage - Manual" />
<meta itemprop="description" content="Replaces colors in the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Replaces colors in the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.hasnextimage.php">
          Imagick::hasNextImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getversion.php">
          &laquo; Imagick::getVersion        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.haldclutimage.php' selected="selected">English</option>
            <option value='de/imagick.haldclutimage.php'>German</option>
            <option value='es/imagick.haldclutimage.php'>Spanish</option>
            <option value='fr/imagick.haldclutimage.php'>French</option>
            <option value='it/imagick.haldclutimage.php'>Italian</option>
            <option value='ja/imagick.haldclutimage.php'>Japanese</option>
            <option value='pt_BR/imagick.haldclutimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.haldclutimage.php'>Russian</option>
            <option value='tr/imagick.haldclutimage.php'>Turkish</option>
            <option value='uk/imagick.haldclutimage.php'>Ukrainian</option>
            <option value='zh/imagick.haldclutimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.haldclutimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::haldClutImage</h1>
  <p class="verinfo">(PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::haldClutImage</span> &mdash; <span class="dc-title">Replaces colors in the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.haldclutimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::haldClutImage</strong></span>(<span class="methodparam"><span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span> <code class="parameter">$clut</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.haldclutimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">clut</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.haldclutimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.haldclutimage-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.haldclutimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3019">
      <p><strong>Example #1  <span class="function"><strong>Imagick::haldClutImage()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">haldClutImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">));<br />    </span><span style="color: #0000BB">$imagickPalette </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #DD0000">"images/hald/hald_8.png"</span><span style="color: #007700">));<br />    </span><span style="color: #0000BB">$imagickPalette</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">sepiatoneImage</span><span style="color: #007700">(</span><span style="color: #0000BB">55</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">haldClutImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagickPalette</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/jpg"</span><span style="color: #007700">);<br />    echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/haldclutimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.haldclutimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.haldclutimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.haldclutimage.php">＋<small>add a note</small></a></span>
