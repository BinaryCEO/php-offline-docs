...
<head>
  ...
  <title>PHP: IntlChar::charAge - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.charage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.charage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.charage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.chardigitvalue.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.charage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.charage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.charage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.charage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.charage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.charage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.charage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.charage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.charage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.charage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.charage.php" hreflang="zh">
...
<meta name="Description" content="Get the &quot;age&quot; of the code point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::charAge - Manual" />
<meta name="twitter:description" content="Get the &quot;age&quot; of the code point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::charAge - Manual" />
<meta itemprop="description" content="Get the &quot;age&quot; of the code point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the &quot;age&quot; of the code point" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.charage.php' selected="selected">English</option>
            <option value='de/intlchar.charage.php'>German</option>
            <option value='es/intlchar.charage.php'>Spanish</option>
            <option value='fr/intlchar.charage.php'>French</option>
            <option value='it/intlchar.charage.php'>Italian</option>
            <option value='ja/intlchar.charage.php'>Japanese</option>
            <option value='pt_BR/intlchar.charage.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.charage.php'>Russian</option>
            <option value='tr/intlchar.charage.php'>Turkish</option>
            <option value='uk/intlchar.charage.php'>Ukrainian</option>
            <option value='zh/intlchar.charage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.charage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::charAge</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::charAge</span> &mdash; <span class="dc-title">Get the &quot;age&quot; of the code point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-intlchar.charage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::charAge</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$codepoint</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.array.php" class="type array">array</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-intlchar.charage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.charage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The Unicode version number, as an <span class="type"><a href="language.types.array.php" class="type array">array</a></span>.
   For example, version <em>1.3.31.2</em> would be represented as <code class="literal">[1, 3, 31, 2]</code>.
   Returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-intlchar.charage-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-2694">
   <p><strong>Example #1 Testing different code points</strong></p>
   <div class="example-contents">
    <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">charage</span><span style="color: #007700">(</span><span style="color: #DD0000">"\u{2603}"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">charage</span><span style="color: #007700">(</span><span style="color: #DD0000">"\u{1F576}"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>
...
array(4) {
 ...
 <div class="refsect1 seealso" id="refsect1-intlchar.charage-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.getintpropertyvalue.php" class="function" rel="rdfs-seeAlso">IntlChar::getIntPropertyValue()</a> - Get the value for a Unicode property for a code point</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/charage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.charage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.charage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.charage.php">＋<small>add a note</small></a></span>
