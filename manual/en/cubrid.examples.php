...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/cubrid.examples.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/cubrid.examples.php">
 <link rel="alternate" href="https://www.php.net/manual/en/cubrid.examples.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/cubrid.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.cubrid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/cubrid.examples.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/cubrid.examples.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/cubrid.examples.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/cubrid.examples.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/cubrid.examples.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/cubrid.examples.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/cubrid.examples.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/cubrid.examples.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/cubrid.examples.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/cubrid.examples.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/cubrid.examples.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/cubrid.examples.php' selected="selected">English</option>
            <option value='de/cubrid.examples.php'>German</option>
            <option value='es/cubrid.examples.php'>Spanish</option>
            <option value='fr/cubrid.examples.php'>French</option>
            <option value='it/cubrid.examples.php'>Italian</option>
            <option value='ja/cubrid.examples.php'>Japanese</option>
            <option value='pt_BR/cubrid.examples.php'>Brazilian Portuguese</option>
            <option value='ru/cubrid.examples.php'>Russian</option>
            <option value='tr/cubrid.examples.php'>Turkish</option>
            <option value='uk/cubrid.examples.php'>Ukrainian</option>
            <option value='zh/cubrid.examples.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="cubrid.examples" class="chapter">
   ...
   <div class="example-contents">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcubrid.examples%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=cubrid.examples&amp;repo=en&amp;redirect=https://www.php.net/manual/en/cubrid.examples.php">＋<small>add a note</small></a></span>
