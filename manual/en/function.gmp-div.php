...
<head>
  ...
  <title>PHP: gmp_div - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-div.php">
 <link rel="shorturl" href="https://www.php.net/gmp-div">
 <link rel="alternate" href="https://www.php.net/gmp-div" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-com.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-div-q.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-div.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-div.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-div.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-div.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-div.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-div.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-div.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-div.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-div.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-div.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-div.php" hreflang="zh">
...
<meta name="Description" content="Alias of gmp_div_q" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_div - Manual" />
<meta name="twitter:description" content="Alias of gmp_div_q" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_div - Manual" />
<meta itemprop="description" content="Alias of gmp_div_q" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of gmp_div_q" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-div.php' selected="selected">English</option>
            <option value='de/function.gmp-div.php'>German</option>
            <option value='es/function.gmp-div.php'>Spanish</option>
            <option value='fr/function.gmp-div.php'>French</option>
            <option value='it/function.gmp-div.php'>Italian</option>
            <option value='ja/function.gmp-div.php'>Japanese</option>
            <option value='pt_BR/function.gmp-div.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-div.php'>Russian</option>
            <option value='tr/function.gmp-div.php'>Turkish</option>
            <option value='uk/function.gmp-div.php'>Ukrainian</option>
            <option value='zh/function.gmp-div.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-div" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_div</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_div</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.gmp-div-q.php" class="function">gmp_div_q()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.gmp-div-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.gmp-div-q.php" class="function">gmp_div_q()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-div.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-div%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-div&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-div.php">＋<small>add a note</small></a></span>
