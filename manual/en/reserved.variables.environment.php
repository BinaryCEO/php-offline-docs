...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reserved.variables.environment.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reserved.variables.environment.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reserved.variables.environment.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.variables.php">
 <link rel="prev" href="https://www.php.net/manual/en/reserved.variables.session.php">
 <link rel="next" href="https://www.php.net/manual/en/reserved.variables.cookies.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reserved.variables.environment.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reserved.variables.environment.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reserved.variables.environment.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reserved.variables.environment.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reserved.variables.environment.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reserved.variables.environment.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reserved.variables.environment.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reserved.variables.environment.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reserved.variables.environment.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reserved.variables.environment.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reserved.variables.environment.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: $_ENV - Manual" />
<meta name="twitter:description" content="Environment variables" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: $_ENV - Manual" />
<meta itemprop="description" content="Environment variables" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reserved.variables.cookies.php">
          $_COOKIE &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reserved.variables.environment.php' selected="selected">English</option>
            ...
            <option value='it/reserved.variables.environment.php'>Italian</option>
            ...
            <option value='uk/reserved.variables.environment.php'>Ukrainian</option>
  ...
  </div><div id="reserved.variables.environment" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="book.filter.php" class="link">The filter extension</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/variables/env.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freserved.variables.environment%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reserved.variables.environment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reserved.variables.environment.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="98113">  <div class="votes">
    <div id="Vu98113">
    <a href="/manual/vote-note.php?id=98113&amp;page=reserved.variables.environment&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98113">
    <a href="/manual/vote-note.php?id=98113&amp;page=reserved.variables.environment&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98113" title="78% like this...">
    176
    </div>
  </div>
  <a href="#98113" class="name">
  <strong class="user"><em>gabe-php at mudbugmedia dot com</em></strong></a><a class="genanchor" href="#98113"> &para;</a><div class="date" title="2010-05-26 09:11"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98113">
<div class="phpcode"><code><span class="html">If your $_ENV array is mysteriously empty, but you still see the variables when calling getenv() or in your phpinfo(), check your <a href="http://us.php.net/manual/en/ini.core.php#ini.variables-order" rel="nofollow" target="_blank">http://us.php.net/manual/en/ini.core.php#ini.variables-order</a> ini setting to ensure it includes "E" in the string.</span></code></div>
  </div>
 </div>
  <div class="note" id="114811">  <div class="votes">
    <div id="Vu114811">
    <a href="/manual/vote-note.php?id=114811&amp;page=reserved.variables.environment&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114811">
    <a href="/manual/vote-note.php?id=114811&amp;page=reserved.variables.environment&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114811" title="55% like this...">
    12
    </div>
  </div>
  <a href="#114811" class="name">
  <strong class="user"><em>aasasdasdf at yandex dot ru</em></strong></a><a class="genanchor" href="#114811"> &para;</a><div class="date" title="2014-04-08 02:25"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114811">
<div class="phpcode"><code><span class="html">Please note that writing to $_ENV does not actually set an environment variable, i.e. the variable will not propagate to any child processes you launch (except forked script processes, in which case it's just a variable in the script's memory). To set real environment variables, you must use putenv().<br /><br />Basically, setting a variable in $_ENV does not have any meaning besides setting or overriding a script-wide global variable. Thus, one should never modify $_ENV except for testing purposes (and then be careful to use putenv() too, if appropriate).<br /><br />PHP  will not trigger any kind of error or notice when writing to $_ENV.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reserved.variables.environment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reserved.variables.environment.php">＋<small>add a note</small></a></div>
