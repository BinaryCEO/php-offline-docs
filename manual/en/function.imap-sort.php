...
<head>
  ...
  <title>PHP: imap_sort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-sort.php">
 <link rel="shorturl" href="https://www.php.net/imap-sort">
 <link rel="alternate" href="https://www.php.net/imap-sort" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-setflag-full.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-status.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-sort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-sort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-sort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-sort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-sort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-sort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-sort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-sort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-sort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-sort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-sort.php" hreflang="zh">
...
<meta name="Description" content="Gets and sort messages" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_sort - Manual" />
<meta name="twitter:description" content="Gets and sort messages" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_sort - Manual" />
<meta itemprop="description" content="Gets and sort messages" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets and sort messages" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-status.php">
          imap_status &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-setflag-full.php">
          &laquo; imap_setflag_full        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-sort.php' selected="selected">English</option>
            <option value='de/function.imap-sort.php'>German</option>
            <option value='es/function.imap-sort.php'>Spanish</option>
            <option value='fr/function.imap-sort.php'>French</option>
            <option value='it/function.imap-sort.php'>Italian</option>
            <option value='ja/function.imap-sort.php'>Japanese</option>
            <option value='pt_BR/function.imap-sort.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-sort.php'>Russian</option>
            <option value='tr/function.imap-sort.php'>Turkish</option>
            <option value='uk/function.imap-sort.php'>Ukrainian</option>
            <option value='zh/function.imap-sort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-sort" class="refentry">
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-sort-returnvalues">
  ...
  <p class="para">
   ...
   parameters,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
  ...
  instance now; previously, a valid <code class="literal">imap</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
     ...
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-sort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-sort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-sort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-sort.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="61688">  <div class="votes">
    <div id="Vu61688">
    <a href="/manual/vote-note.php?id=61688&amp;page=function.imap-sort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd61688">
    <a href="/manual/vote-note.php?id=61688&amp;page=function.imap-sort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V61688" title="73% like this...">
    9
    </div>
  </div>
  <a href="#61688" class="name">
  <strong class="user"><em>antoine dot spam-nono at maxg dot info</em></strong></a><a class="genanchor" href="#61688"> &para;</a><div class="date" title="2006-02-09 07:42"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom61688">
<div class="phpcode"><code><span class="html">I worked a lot with IMAP functions since I wrote a complete webmail and I've got a little tip about the imap_sort function :<br /><br />There is a big difference between :<br /><br /><span class="default">&lt;?php<br /> imap_sort</span><span class="keyword">(</span><span class="default">$imap</span><span class="keyword">, </span><span class="default">SORTDATE</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br /></span><span class="comment">// and <br /> </span><span class="default">imap_sort</span><span class="keyword">(</span><span class="default">$imap</span><span class="keyword">, </span><span class="default">SORTARRIVAL</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />The first command will issue a<br /> &gt;&gt; FETCH 1:last (UID ENVELOPE BODY.PEEK[HEADER.FIELDS (Newsgroups Content-MD5 Content-Disposition Content-Language Content-Location Followup-To References)] INTERNALDATE RFC822.SIZE FLAGS)<br /><br />While the second resulted in<br /> &gt;&gt; FETCH 1:last (UID INTERNALDATE RFC822.SIZE FLAGS)<br /><br />As a result, using SORTDATE took 3 seconds longer to complete on a 800-emails mailbox, while the results are quite the same (except if you have to deal with forged dates or timezones, but the arrival order is far more logical)<br /><br />My advice if you sort your emails by arrival is to actually use SORTARRIVAL, or better don't use imap_sort and go straight with message numbers (not UIDs). On large mailboxes, if you display messages per page, you will have significant performance increases (by avoiding 5 seconds of sorting).</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-sort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-sort.php">＋<small>add a note</small></a></div>
