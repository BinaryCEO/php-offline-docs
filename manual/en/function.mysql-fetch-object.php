...
<head>
  ...
  <title>PHP: mysql_fetch_object - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-fetch-object.php">
 <link rel="shorturl" href="https://www.php.net/mysql-fetch-object">
 <link rel="alternate" href="https://www.php.net/mysql-fetch-object" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-fetch-lengths.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-fetch-row.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-fetch-object.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-fetch-object.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-fetch-object.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-fetch-object.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-fetch-object.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-fetch-object.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-fetch-object.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-fetch-object.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-fetch-object.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-fetch-object.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-fetch-object.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mysql_fetch_object - Manual" />
<meta name="twitter:description" content="Fetch a result row as an object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_fetch_object - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-fetch-row.php">
          mysql_fetch_row &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-fetch-lengths.php">
          &laquo; mysql_fetch_lengths        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-fetch-object.php' selected="selected">English</option>
            <option value='de/function.mysql-fetch-object.php'>German</option>
            <option value='es/function.mysql-fetch-object.php'>Spanish</option>
            <option value='fr/function.mysql-fetch-object.php'>French</option>
            <option value='it/function.mysql-fetch-object.php'>Italian</option>
            <option value='ja/function.mysql-fetch-object.php'>Japanese</option>
            <option value='pt_BR/function.mysql-fetch-object.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-fetch-object.php'>Russian</option>
            <option value='tr/function.mysql-fetch-object.php'>Turkish</option>
            <option value='uk/function.mysql-fetch-object.php'>Ukrainian</option>
            <option value='zh/function.mysql-fetch-object.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-fetch-object" class="refentry">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    ...
    <li>
     ...
     with <code class="parameter">mode</code> as <strong><code><a href="pdo.constants.php#pdo.constants.fetch-obj">PDO::FETCH_OBJ</a></code></strong>
    </li>
   </ul>
  </div>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-query.php" class="function" rel="rdfs-seeAlso">mysql_query()</a> - Send a MySQL query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-fetch-object.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-fetch-object%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-fetch-object&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-fetch-object.php">＋<small>add a note</small></a></span>
