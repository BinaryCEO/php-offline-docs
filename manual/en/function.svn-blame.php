...
<head>
  ...
  <title>PHP: svn_blame - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-blame.php">
 <link rel="shorturl" href="https://www.php.net/svn-blame">
 <link rel="alternate" href="https://www.php.net/svn-blame" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-auth-set-parameter.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-cat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-blame.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-blame.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-blame.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-blame.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-blame.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-blame.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-blame.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-blame.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-blame.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-blame.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-blame.php" hreflang="zh">
...
<meta name="Description" content="Get the SVN blame for a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_blame - Manual" />
<meta name="twitter:description" content="Get the SVN blame for a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_blame - Manual" />
<meta itemprop="description" content="Get the SVN blame for a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the SVN blame for a file" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.svn-cat.php">
          svn_cat &raquo;
              ...
              <div class="prev">
        <a href="function.svn-auth-set-parameter.php">
          &laquo; svn_auth_set_parameter        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-blame.php' selected="selected">English</option>
            <option value='de/function.svn-blame.php'>German</option>
            <option value='es/function.svn-blame.php'>Spanish</option>
            <option value='fr/function.svn-blame.php'>French</option>
            <option value='it/function.svn-blame.php'>Italian</option>
            <option value='ja/function.svn-blame.php'>Japanese</option>
            <option value='pt_BR/function.svn-blame.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-blame.php'>Russian</option>
            <option value='tr/function.svn-blame.php'>Turkish</option>
            <option value='uk/function.svn-blame.php'>Ukrainian</option>
            <option value='zh/function.svn-blame.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-blame" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.svn-blame-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>svn_blame</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$repository_url</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$revision_no</code><span class="initializer"> = SVN_REVISION_HEAD</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.svn-blame-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">repository_url</code></dt>
     <dd>
      <p class="para">
       The repository URL.
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.svn-blame-returnvalues">
  ...
  <p class="para">
   An <span class="type"><a href="language.types.array.php" class="type array">array</a></span> of SVN blame information separated by line
 ...
 <div class="refsect1 examples" id="refsect1-function.svn-blame-examples">
  ...
  <p class="para">
   <div class="example" id="example-4865">
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.svn-blame-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.svn-diff.php" class="function" rel="rdfs-seeAlso">svn_diff()</a> - Recursively diffs two paths</span></li>
    <li><span class="function"><strong>svn_logs()</strong></span></li>
    <li><span class="function"><a href="function.svn-status.php" class="function" rel="rdfs-seeAlso">svn_status()</a> - Returns the status of working copy files and directories</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-blame.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-blame%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-blame&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-blame.php">＋<small>add a note</small></a></span>
