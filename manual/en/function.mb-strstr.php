...
<head>
  ...
  <title>PHP: mb_strstr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-strstr.php">
 <link rel="shorturl" href="https://www.php.net/mb-strstr">
 <link rel="alternate" href="https://www.php.net/mb-strstr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-strrpos.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-strtolower.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-strstr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-strstr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-strstr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-strstr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-strstr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-strstr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-strstr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-strstr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-strstr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-strstr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-strstr.php" hreflang="zh">
...
<meta name="Description" content="Finds first occurrence of a string within another" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_strstr - Manual" />
<meta name="twitter:description" content="Finds first occurrence of a string within another" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_strstr - Manual" />
<meta itemprop="description" content="Finds first occurrence of a string within another" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Finds first occurrence of a string within another" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-strstr.php' selected="selected">English</option>
            <option value='de/function.mb-strstr.php'>German</option>
            <option value='es/function.mb-strstr.php'>Spanish</option>
            <option value='fr/function.mb-strstr.php'>French</option>
            <option value='it/function.mb-strstr.php'>Italian</option>
            <option value='ja/function.mb-strstr.php'>Japanese</option>
            <option value='pt_BR/function.mb-strstr.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-strstr.php'>Russian</option>
            <option value='tr/function.mb-strstr.php'>Turkish</option>
            <option value='uk/function.mb-strstr.php'>Ukrainian</option>
            <option value='zh/function.mb-strstr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-strstr" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_strstr</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_strstr</span> &mdash; <span class="dc-title">Finds first occurrence of a string within another</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-strstr-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>mb_strstr()</strong></span> finds the first occurrence of
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-stristr.php" class="function" rel="rdfs-seeAlso">mb_stristr()</a> - Finds first occurrence of a string within another, case insensitive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-strstr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-strstr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-strstr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-strstr.php">＋<small>add a note</small></a></span>
