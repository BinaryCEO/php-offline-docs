...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.pdo.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.pdo.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.pdo.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.pdo.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.pdo.php">
 <link rel="next" href="https://www.php.net/manual/en/pdo.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.pdo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.pdo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.pdo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.pdo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.pdo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.pdo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.pdo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.pdo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.pdo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.pdo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.pdo.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.pdo.php' selected="selected">English</option>
            <option value='de/intro.pdo.php'>German</option>
            <option value='es/intro.pdo.php'>Spanish</option>
            <option value='fr/intro.pdo.php'>French</option>
            <option value='it/intro.pdo.php'>Italian</option>
            <option value='ja/intro.pdo.php'>Japanese</option>
            <option value='pt_BR/intro.pdo.php'>Brazilian Portuguese</option>
            <option value='ru/intro.pdo.php'>Russian</option>
            <option value='tr/intro.pdo.php'>Turkish</option>
            <option value='uk/intro.pdo.php'>Ukrainian</option>
            <option value='zh/intro.pdo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.pdo" class="preface">
  ...
  <p class="para">
   PDO ships with PHP.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.pdo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.pdo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.pdo.php">＋<small>add a note</small></a></span>
