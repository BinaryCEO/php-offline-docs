...
<head>
  ...
  <title>PHP: PDOStatement::columnCount - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/pdostatement.columncount.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/pdostatement.columncount.php">
 <link rel="alternate" href="https://www.php.net/manual/en/pdostatement.columncount.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.pdostatement.php">
 <link rel="prev" href="https://www.php.net/manual/en/pdostatement.closecursor.php">
 <link rel="next" href="https://www.php.net/manual/en/pdostatement.debugdumpparams.php">

 <link rel="alternate" href="https://www.php.net/manual/en/pdostatement.columncount.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/pdostatement.columncount.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/pdostatement.columncount.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/pdostatement.columncount.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/pdostatement.columncount.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/pdostatement.columncount.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/pdostatement.columncount.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/pdostatement.columncount.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/pdostatement.columncount.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/pdostatement.columncount.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/pdostatement.columncount.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: PDOStatement::columnCount - Manual" />
<meta name="twitter:description" content="Returns the number of columns in the result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PDOStatement::columnCount - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="pdostatement.debugdumpparams.php">
          PDOStatement::debugDumpParams &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="pdostatement.closecursor.php">
          &laquo; PDOStatement::closeCursor        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/pdostatement.columncount.php' selected="selected">English</option>
            <option value='de/pdostatement.columncount.php'>German</option>
            <option value='es/pdostatement.columncount.php'>Spanish</option>
            <option value='fr/pdostatement.columncount.php'>French</option>
            <option value='it/pdostatement.columncount.php'>Italian</option>
            <option value='ja/pdostatement.columncount.php'>Japanese</option>
            <option value='pt_BR/pdostatement.columncount.php'>Brazilian Portuguese</option>
            <option value='ru/pdostatement.columncount.php'>Russian</option>
            <option value='tr/pdostatement.columncount.php'>Turkish</option>
            <option value='uk/pdostatement.columncount.php'>Ukrainian</option>
            <option value='zh/pdostatement.columncount.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="pdostatement.columncount" class="refentry">
...
is set to <strong><code><a href="pdo.constants.php#pdo.constants.errmode-exception">PDO::ERRMODE_EXCEPTION</a></code></strong>.
 ...
 <div class="refsect1 examples" id="refsect1-pdostatement.columncount-examples">
  ...
  <p class="para">
   <div class="example" id="example-1154">
    <p><strong>Example #1 Counting columns</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="pdostatement.rowcount.php" class="methodname" rel="rdfs-seeAlso">PDOStatement::rowCount()</a> - Returns the number of rows affected by the last SQL statement</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pdo/pdostatement/columncount.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fpdostatement.columncount%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=pdostatement.columncount&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pdostatement.columncount.php">＋<small>add a note</small></a></span>
