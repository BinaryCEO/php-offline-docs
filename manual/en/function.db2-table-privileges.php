...
<head>
  ...
  <title>PHP: db2_table_privileges - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-table-privileges.php">
 <link rel="shorturl" href="https://www.php.net/db2-table-privileges">
 <link rel="alternate" href="https://www.php.net/db2-table-privileges" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-stmt-errormsg.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-tables.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-table-privileges.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-table-privileges.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-table-privileges.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-table-privileges.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-table-privileges.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-table-privileges.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-table-privileges.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-table-privileges.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-table-privileges.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-table-privileges.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-table-privileges.php" hreflang="zh">
...
<meta name="Description" content="Returns a result set listing the tables and associated privileges in a database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_table_privileges - Manual" />
<meta name="twitter:description" content="Returns a result set listing the tables and associated privileges in a database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_table_privileges - Manual" />
<meta itemprop="description" content="Returns a result set listing the tables and associated privileges in a database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a result set listing the tables and associated privileges in a database" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-table-privileges.php' selected="selected">English</option>
            <option value='de/function.db2-table-privileges.php'>German</option>
            <option value='es/function.db2-table-privileges.php'>Spanish</option>
            <option value='fr/function.db2-table-privileges.php'>French</option>
            <option value='it/function.db2-table-privileges.php'>Italian</option>
            <option value='ja/function.db2-table-privileges.php'>Japanese</option>
            <option value='pt_BR/function.db2-table-privileges.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-table-privileges.php'>Russian</option>
            <option value='tr/function.db2-table-privileges.php'>Turkish</option>
            <option value='uk/function.db2-table-privileges.php'>Ukrainian</option>
            <option value='zh/function.db2-table-privileges.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-table-privileges" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">db2_table_privileges</h1>
  <p class="verinfo">(PECL ibm_db2 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">db2_table_privileges</span> &mdash; <span class="dc-title">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       search pattern containing <code class="literal">_</code> and <code class="literal">%</code>
       as wildcards.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       ...
       containing <code class="literal">_</code> and <code class="literal">%</code> as wildcards.
      </p>
     </dd>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-tables.php" class="function" rel="rdfs-seeAlso">db2_tables()</a> - Returns a result set listing the tables and associated metadata in a database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-table-privileges.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-table-privileges%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-table-privileges&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-table-privileges.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="109231">  <div class="votes">
    <div id="Vu109231">
    <a href="/manual/vote-note.php?id=109231&amp;page=function.db2-table-privileges&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd109231">
    <a href="/manual/vote-note.php?id=109231&amp;page=function.db2-table-privileges&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V109231" title="no votes...">
    0
    </div>
  </div>
  <a href="#109231" class="name">
  <strong class="user"><em>andryzulfikar at gmail dot com</em></strong></a><a class="genanchor" href="#109231"> &para;</a><div class="date" title="2012-06-28 07:52"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109231">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /></span><span class="comment">// using db2_table_privileges example:<br /><br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">db2_table_privileges</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">,</span><span class="default">NULL</span><span class="keyword">,</span><span class="string">'DB2ADMIN'</span><span class="keyword">);<br /><br />while(</span><span class="default">$obj </span><span class="keyword">= </span><span class="default">db2_fetch_object</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">)){<br />       </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$obj</span><span class="keyword">)<br />}<br /><br /></span><span class="comment">/* output<br /><br />stdClass Object<br />(<br />    [TABLE_CAT] =&gt; <br />    [TABLE_SCHEM] =&gt; DB2ADMIN<br />    [TABLE_NAME] =&gt; SALARY<br />    [GRANTOR] =&gt; SYSIBM<br />    [GRANTEE] =&gt; DB2ADMIN<br />    [PRIVILEGE] =&gt; ALTER<br />    [IS_GRANTABLE] =&gt; YES<br />)<br />stdClass Object<br />(<br />    [TABLE_CAT] =&gt; <br />    [TABLE_SCHEM] =&gt; DB2ADMIN<br />    [TABLE_NAME] =&gt; SALARY<br />    [GRANTOR] =&gt; SYSIBM<br />    [GRANTEE] =&gt; DB2ADMIN<br />    [PRIVILEGE] =&gt; CONTROL<br />    [IS_GRANTABLE] =&gt; NO<br />)<br />stdClass Object<br />(<br />    [TABLE_CAT] =&gt; <br />    [TABLE_SCHEM] =&gt; DB2ADMIN<br />    [TABLE_NAME] =&gt; SALARY<br />    [GRANTOR] =&gt; SYSIBM<br />    [GRANTEE] =&gt; DB2ADMIN<br />    [PRIVILEGE] =&gt; DELETE<br />    [IS_GRANTABLE] =&gt; YES<br />)<br />*/<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-table-privileges&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-table-privileges.php">＋<small>add a note</small></a></div>
