...
<head>
  ...
  <title>PHP: EvCheck - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.evcheck.php">
 <link rel="shorturl" href="https://www.php.net/evcheck">
 <link rel="alternate" href="https://www.php.net/evcheck" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ev.php">
 <link rel="prev" href="https://www.php.net/manual/en/ev.verify.php">
 <link rel="next" href="https://www.php.net/manual/en/evcheck.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.evcheck.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.evcheck.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.evcheck.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.evcheck.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.evcheck.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.evcheck.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.evcheck.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.evcheck.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.evcheck.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.evcheck.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.evcheck.php" hreflang="zh">
...
<meta name="Description" content="The EvCheck class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EvCheck - Manual" />
<meta name="twitter:description" content="The EvCheck class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EvCheck - Manual" />
<meta itemprop="description" content="The EvCheck class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The EvCheck class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.evcheck.php' selected="selected">English</option>
            <option value='de/class.evcheck.php'>German</option>
            <option value='es/class.evcheck.php'>Spanish</option>
            <option value='fr/class.evcheck.php'>French</option>
            <option value='it/class.evcheck.php'>Italian</option>
            <option value='ja/class.evcheck.php'>Japanese</option>
            <option value='pt_BR/class.evcheck.php'>Brazilian Portuguese</option>
            <option value='ru/class.evcheck.php'>Russian</option>
            <option value='tr/class.evcheck.php'>Turkish</option>
            <option value='uk/class.evcheck.php'>Ukrainian</option>
            <option value='zh/class.evcheck.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.evcheck" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(PECL ev &gt;= 0.2.0)</p>
  ...
  <div class="section" id="evcheck.intro">
   ...
   <p class="para">
    ...
    and
    <span class="classname"><strong class="classname">EvCheck</strong></span>
  ...
  <div class="section" id="evcheck.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">EvCheck</strong>
     </span>
     <span class="ooclass">
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span>
   <span class="methodname"><a href="evcheck.construct.php" class="methodname">__construct</a></span>(<span class="methodparam">
   ...
   <span class="methodname"><a href="evcheck.createstopped.php" class="methodname">createStopped</a></span>(<span class="methodparam">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="evcheck.construct.php">EvCheck::__construct</a> — Constructs the EvCheck watcher object</li><li><a href="evcheck.createstopped.php">EvCheck::createStopped</a> — Create instance of a stopped EvCheck watcher</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ev/evcheck.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.evcheck%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.evcheck&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.evcheck.php">＋<small>add a note</small></a></span>
