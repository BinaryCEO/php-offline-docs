...
<head>
  ...
  <title>PHP: ps_stroke - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-stroke.php">
 <link rel="shorturl" href="https://www.php.net/ps-stroke">
 <link rel="alternate" href="https://www.php.net/ps-stroke" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-stringwidth.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-symbol.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-stroke.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-stroke.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-stroke.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-stroke.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-stroke.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-stroke.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-stroke.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-stroke.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-stroke.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-stroke.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-stroke.php" hreflang="zh">
...
<meta name="Description" content="Draws the current path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_stroke - Manual" />
<meta name="twitter:description" content="Draws the current path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_stroke - Manual" />
<meta itemprop="description" content="Draws the current path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws the current path" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-symbol.php">
          ps_symbol &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-stringwidth.php">
          &laquo; ps_stringwidth        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-stroke.php' selected="selected">English</option>
            <option value='de/function.ps-stroke.php'>German</option>
            <option value='es/function.ps-stroke.php'>Spanish</option>
            <option value='fr/function.ps-stroke.php'>French</option>
            <option value='it/function.ps-stroke.php'>Italian</option>
            <option value='ja/function.ps-stroke.php'>Japanese</option>
            <option value='pt_BR/function.ps-stroke.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-stroke.php'>Russian</option>
            <option value='tr/function.ps-stroke.php'>Turkish</option>
            <option value='uk/function.ps-stroke.php'>Ukrainian</option>
            <option value='zh/function.ps-stroke.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-stroke" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_stroke</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_stroke</span> &mdash; <span class="dc-title">Draws the current path</span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-fill-stroke.php" class="function" rel="rdfs-seeAlso">ps_fill_stroke()</a> - Fills and strokes the current path</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-stroke.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-stroke%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-stroke&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-stroke.php">＋<small>add a note</small></a></span>
