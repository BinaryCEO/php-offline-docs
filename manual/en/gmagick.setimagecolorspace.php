...
<head>
  ...
  <title>PHP: Gmagick::setimagecolorspace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagecolorspace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagecolorspace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagecolorspace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimagechanneldepth.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagecompose.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagecolorspace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimagecolorspace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimagecolorspace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimagecolorspace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimagecolorspace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimagecolorspace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimagecolorspace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimagecolorspace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimagecolorspace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimagecolorspace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimagecolorspace.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimagecolorspace - Manual" />
<meta name="twitter:description" content="Sets the image colorspace" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimagecolorspace - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.setimagecompose.php">
          Gmagick::setimagecompose &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimagechanneldepth.php">
          &laquo; Gmagick::setimagechanneldepth        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagecolorspace.php' selected="selected">English</option>
            <option value='de/gmagick.setimagecolorspace.php'>German</option>
            <option value='es/gmagick.setimagecolorspace.php'>Spanish</option>
            <option value='fr/gmagick.setimagecolorspace.php'>French</option>
            <option value='it/gmagick.setimagecolorspace.php'>Italian</option>
            <option value='ja/gmagick.setimagecolorspace.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimagecolorspace.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimagecolorspace.php'>Russian</option>
            <option value='tr/gmagick.setimagecolorspace.php'>Turkish</option>
            <option value='uk/gmagick.setimagecolorspace.php'>Ukrainian</option>
            <option value='zh/gmagick.setimagecolorspace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimagecolorspace" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimagecolorspace</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimagecolorspace</span> &mdash; <span class="dc-title">Sets the image colorspace</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimagecolorspace-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimagecolorspace</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$colorspace</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimagecolorspace-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       One of the <a href="gmagick.constants.php#gmagick.constants.colorspace" class="link">Colorspace</a> constant
       (<code class="literal">Gmagick::COLORSPACE_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimagecolorspace-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimagecolorspace-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagecolorspace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagecolorspace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagecolorspace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagecolorspace.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="98638">  <div class="votes">
    <div id="Vu98638">
    <a href="/manual/vote-note.php?id=98638&amp;page=gmagick.setimagecolorspace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98638">
    <a href="/manual/vote-note.php?id=98638&amp;page=gmagick.setimagecolorspace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98638" title="no votes...">
    0
    </div>
  </div>
  <a href="#98638" class="name">
  <strong class="user"><em>MPLong</em></strong></a><a class="genanchor" href="#98638"> &para;</a><div class="date" title="2010-06-28 11:24"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98638">
<div class="phpcode"><code><span class="html">Convert CMYK to RGB:
<br />
<br /><span class="default">&lt;?php
<br />$cs </span><span class="keyword">= </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getimagecolorspace</span><span class="keyword">();
<br />if (</span><span class="default">$cs </span><span class="keyword">== </span><span class="default">Gmagick</span><span class="keyword">::</span><span class="default">COLORSPACE_CMYK</span><span class="keyword">) 
<br />{
<br />     </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageColorspace</span><span class="keyword">(</span><span class="default">Gmagick</span><span class="keyword">::</span><span class="default">COLORSPACE_SRGB</span><span class="keyword">);
<br />}
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gmagick.setimagecolorspace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagecolorspace.php">＋<small>add a note</small></a></div>
