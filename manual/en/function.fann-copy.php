...
<head>
  ...
  <title>PHP: fann_copy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-copy.php">
 <link rel="shorturl" href="https://www.php.net/fann-copy">
 <link rel="alternate" href="https://www.php.net/fann-copy" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-clear-scaling-params.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-create-from-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-copy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-copy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-copy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-copy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-copy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-copy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-copy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-copy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-copy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-copy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-copy.php" hreflang="zh">
...
<meta name="Description" content="Creates a copy of a fann structure" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_copy - Manual" />
<meta name="twitter:description" content="Creates a copy of a fann structure" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_copy - Manual" />
<meta itemprop="description" content="Creates a copy of a fann structure" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a copy of a fann structure" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-create-from-file.php">
          fann_create_from_file &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-clear-scaling-params.php">
          &laquo; fann_clear_scaling_params        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-copy.php' selected="selected">English</option>
            <option value='de/function.fann-copy.php'>German</option>
            <option value='es/function.fann-copy.php'>Spanish</option>
            <option value='fr/function.fann-copy.php'>French</option>
            <option value='it/function.fann-copy.php'>Italian</option>
            <option value='ja/function.fann-copy.php'>Japanese</option>
            <option value='pt_BR/function.fann-copy.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-copy.php'>Russian</option>
            <option value='tr/function.fann-copy.php'>Turkish</option>
            <option value='uk/function.fann-copy.php'>Ukrainian</option>
            <option value='zh/function.fann-copy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-copy" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-test.php" class="function" rel="rdfs-seeAlso">fann_test()</a> - Test with a set of inputs, and a set of desired outputs</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-copy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-copy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-copy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-copy.php">＋<small>add a note</small></a></span>
