...
<head>
  ...
  <title>PHP: Imagick::mergeImageLayers - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.mergeimagelayers.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.mergeimagelayers.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.mergeimagelayers.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.medianfilterimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.minifyimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.mergeimagelayers.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.mergeimagelayers.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.mergeimagelayers.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.mergeimagelayers.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.mergeimagelayers.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.mergeimagelayers.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.mergeimagelayers.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.mergeimagelayers.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.mergeimagelayers.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.mergeimagelayers.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.mergeimagelayers.php" hreflang="zh">
...
<meta name="Description" content="Merges image layers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::mergeImageLayers - Manual" />
<meta name="twitter:description" content="Merges image layers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::mergeImageLayers - Manual" />
<meta itemprop="description" content="Merges image layers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Merges image layers" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.minifyimage.php">
          Imagick::minifyImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.medianfilterimage.php">
          &laquo; Imagick::medianFilterImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.mergeimagelayers.php' selected="selected">English</option>
            <option value='de/imagick.mergeimagelayers.php'>German</option>
            <option value='es/imagick.mergeimagelayers.php'>Spanish</option>
            <option value='fr/imagick.mergeimagelayers.php'>French</option>
            <option value='it/imagick.mergeimagelayers.php'>Italian</option>
            <option value='ja/imagick.mergeimagelayers.php'>Japanese</option>
            <option value='pt_BR/imagick.mergeimagelayers.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.mergeimagelayers.php'>Russian</option>
            <option value='tr/imagick.mergeimagelayers.php'>Turkish</option>
            <option value='uk/imagick.mergeimagelayers.php'>Ukrainian</option>
            <option value='zh/imagick.mergeimagelayers.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.mergeimagelayers" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::mergeImageLayers</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.1.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::mergeImageLayers</span> &mdash; <span class="dc-title">Merges image layers</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.mergeimagelayers-description">
  ...
  <p class="para rdfs-comment">
   ...
   the <code class="parameter">layer_method</code> which defines how the layers are merged.
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.mergeimagelayers-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       One of the <strong><code><a href="imagick.constants.php#imagick.constants.layermethod-undefined">Imagick::LAYERMETHOD_<span class="replaceable">*</span></a></code></strong> constants
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.mergeimagelayers-examples">
  ...
  <p class="para">
    <div class="example" id="example-3028">
      <p><strong>Example #1  <span class="function"><strong>Imagick::mergeImageLayers()</strong></span></strong></p>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.mergeimagelayers-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.flattenimages.php" class="function" rel="rdfs-seeAlso">Imagick::flattenImages()</a> - Merges a sequence of images</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/mergeimagelayers.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.mergeimagelayers%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.mergeimagelayers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.mergeimagelayers.php">＋<small>add a note</small></a></span>
