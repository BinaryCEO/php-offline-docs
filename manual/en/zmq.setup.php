...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/zmq.setup.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/zmq.setup.php">
 <link rel="alternate" href="https://www.php.net/manual/en/zmq.setup.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.zmq.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.zmq.php">
 <link rel="next" href="https://www.php.net/manual/en/zmq.requirements.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/zmq.setup.php' selected="selected">English</option>
            <option value='de/zmq.setup.php'>German</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="zmq.requirements.php">Requirements</a></li><li><a href="zmq.installation.php">Installation</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zmq/setup.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fzmq.setup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=zmq.setup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zmq.setup.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Installing and configuring ZMQ:<br /><br />The following exemples is based on Debian Linux  but it should work in other OS.<br /><br />First:<br />Installing 0MQ:<br />Go to <a href="http://zeromq.org/area:download" rel="nofollow" target="_blank">http://zeromq.org/area:download</a> and choose a package according your OS, in my case I've choosed<br />POSIX tarball Stable Release 4.0.4.<br /><br />    ~$ tar -xvf zeromq-4.0.4.tar<br />    ~$ cd zeromq-4.0.4<br />    ~$ ./configure<br />    ~$ make<br />    ~$ sudo make install<br /><br /> <br />Ok, we just have installed ZMQ now need install zmq php binding...<br />Make sure you having php-dev and php pear installed. If no:<br /><br />    ~$ sudo apt-get install php5-dev php-pear<br />    ~$ sudo pecl install zmq-beta<br /><br />Ok, we have now ZMQ and php binding (ext-php) installed but we should add "extension=zmq.so" (Or extension=php_zmq.dll on windows) to php.ini:<br />In my case:<br /><br />    ~$ sudo nano /etc/php5/apache2/php.ini<br /><br />**NOTE:** If PHP version is 5.4.x you will need to add a zmq.ini file in /etc/php5/conf.d and put "extension=zmq.so":<br /><br />    ~$ sudo nano /etc/php5/conf.d/20-zmq.ini<br /><br />Reloadind HTTP server (in my case apache): <br /><br />    ~$  sudo service apache2 reload</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">php-zmq is conveniently installable over package managers for linux derivates:<br />as of February 2020<br /><br />Debian from version 9 up<br /><a href="https://packages.debian.org/stretch/php/php-zmq" rel="nofollow" target="_blank">https://packages.debian.org/stretch/php/php-zmq</a><br /><br />Ubuntu from version 16.04 up<br /><a href="https://packages.ubuntu.com/xenial/php/php-zmq" rel="nofollow" target="_blank">https://packages.ubuntu.com/xenial/php/php-zmq</a><br /><br />Fedora 29 and up:<br /><a href="https://rpmfind.net/linux/rpm2html/search.php?query=php-zmq" rel="nofollow" target="_blank">https://rpmfind.net/linux/rpm2html/search.php?query=php-zmq</a><br /><br />Thanks to the maintainers, i just tried successfully some examples on Fedora 29 Workstation which worked out of the box.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#118624"> &para;</a><div class="date" title="2016-01-11 11:35"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118624">
<div class="phpcode"><code><span class="html">I have created a gist with the updated procedure to install the ZeroMQ PHP extension on Ubuntu 14.04 with support for CurveZMQ encryption. Here is the link:<br /><a href="https://gist.github.com/Kamisama666/da9ef33b1adf4c6d39ca" rel="nofollow" target="_blank">https://gist.github.com/Kamisama666/da9ef33b1adf4c6d39ca</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=zmq.setup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zmq.setup.php">＋<small>add a note</small></a></div>
