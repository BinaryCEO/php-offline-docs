...
<head>
  ...
  <title>PHP: eio_fallocate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-fallocate.php">
 <link rel="shorturl" href="https://www.php.net/eio-fallocate">
 <link rel="alternate" href="https://www.php.net/eio-fallocate" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-event-loop.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-fchmod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-fallocate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-fallocate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-fallocate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-fallocate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-fallocate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-fallocate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-fallocate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-fallocate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-fallocate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-fallocate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-fallocate.php" hreflang="zh">
...
<meta name="Description" content="Allows the caller to directly manipulate the allocated disk
  space for a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_fallocate - Manual" />
<meta name="twitter:description" content="Allows the caller to directly manipulate the allocated disk
  space for a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_fallocate - Manual" />
<meta itemprop="description" content="Allows the caller to directly manipulate the allocated disk
  space for a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Allows the caller to directly manipulate the allocated disk
  space for a file" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.eio-fchmod.php">
          eio_fchmod &raquo;
              ...
              <div class="prev">
        <a href="function.eio-event-loop.php">
          &laquo; eio_event_loop        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-fallocate.php' selected="selected">English</option>
            <option value='de/function.eio-fallocate.php'>German</option>
            <option value='es/function.eio-fallocate.php'>Spanish</option>
            <option value='fr/function.eio-fallocate.php'>French</option>
            <option value='it/function.eio-fallocate.php'>Italian</option>
            <option value='ja/function.eio-fallocate.php'>Japanese</option>
            <option value='pt_BR/function.eio-fallocate.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-fallocate.php'>Russian</option>
            <option value='tr/function.eio-fallocate.php'>Turkish</option>
            <option value='uk/function.eio-fallocate.php'>Ukrainian</option>
            <option value='zh/function.eio-fallocate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-fallocate" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-fallocate-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_fallocate</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mode</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
  ...
  <p class="para"><strong><code><a href="eio.constants.php#constant.eio-o-creat">EIO_O_CREAT</a></code></strong> should be logically
      <em>OR</em>&#039;d with <strong><code><a href="eio.constants.php#constant.eio-o-wronly">EIO_O_WRONLY</a></code></strong>, or
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-fallocate-parameters">
  ...
  <dl>
    ...
    <dd>
     ...
     <strong><code><a href="eio.constants.php#constant.eio-falloc-fl-keep-size">EIO_FALLOC_FL_KEEP_SIZE</a></code></strong> (the same as POSIX constant
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-fallocate-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>eio_fallocate()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-fallocate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-fallocate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-fallocate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-fallocate.php">＋<small>add a note</small></a></span>
