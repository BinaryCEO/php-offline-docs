...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/spl.iterators.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/spl.iterators.php">
 <link rel="alternate" href="https://www.php.net/manual/en/spl.iterators.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.spl.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.unexpectedvalueexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.appenditerator.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/spl.iterators.php' selected="selected">English</option>
            ...
            <option value='tr/spl.iterators.php'>Turkish</option>
   ...
   <ul class="itemizedlist">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/iterators.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fspl.iterators%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=spl.iterators&amp;repo=en&amp;redirect=https://www.php.net/manual/en/spl.iterators.php">＋<small>add a note</small></a></span>
