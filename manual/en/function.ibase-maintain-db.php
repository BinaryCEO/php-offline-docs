...
<head>
  ...
  <title>PHP: ibase_maintain_db - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-maintain-db.php">
 <link rel="shorturl" href="https://www.php.net/ibase-maintain-db">
 <link rel="alternate" href="https://www.php.net/ibase-maintain-db" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-gen-id.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-modify-user.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-maintain-db.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-maintain-db.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-maintain-db.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-maintain-db.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-maintain-db.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-maintain-db.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-maintain-db.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-maintain-db.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-maintain-db.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-maintain-db.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-maintain-db.php" hreflang="zh">
...
<meta name="Description" content="Execute a maintenance command on the database server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_maintain_db - Manual" />
<meta name="twitter:description" content="Execute a maintenance command on the database server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_maintain_db - Manual" />
<meta itemprop="description" content="Execute a maintenance command on the database server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Execute a maintenance command on the database server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-modify-user.php">
          ibase_modify_user &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-gen-id.php">
          &laquo; ibase_gen_id        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-maintain-db.php' selected="selected">English</option>
            <option value='de/function.ibase-maintain-db.php'>German</option>
            <option value='es/function.ibase-maintain-db.php'>Spanish</option>
            <option value='fr/function.ibase-maintain-db.php'>French</option>
            <option value='it/function.ibase-maintain-db.php'>Italian</option>
            <option value='ja/function.ibase-maintain-db.php'>Japanese</option>
            <option value='pt_BR/function.ibase-maintain-db.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-maintain-db.php'>Russian</option>
            <option value='tr/function.ibase-maintain-db.php'>Turkish</option>
            <option value='uk/function.ibase-maintain-db.php'>Ukrainian</option>
            <option value='zh/function.ibase-maintain-db.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-maintain-db" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_maintain_db</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_maintain_db</span> &mdash; <span class="dc-title">Execute a maintenance command on the database server</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ibase-maintain-db-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_maintain_db</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$service_handle</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$db</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$action</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$argument</code><span class="initializer"> = 0</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-maintain-db.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-maintain-db%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-maintain-db&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-maintain-db.php">＋<small>add a note</small></a></span>
