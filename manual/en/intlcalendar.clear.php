...
<head>
  ...
  <title>PHP: IntlCalendar::clear - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.clear.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.clear.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.clear.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.before.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.clear.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlcalendar.clear.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlcalendar.clear.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlcalendar.clear.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlcalendar.clear.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlcalendar.clear.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlcalendar.clear.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlcalendar.clear.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlcalendar.clear.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlcalendar.clear.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlcalendar.clear.php" hreflang="zh">
...
<meta name="Description" content="Clear a field or all fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::clear - Manual" />
<meta name="twitter:description" content="Clear a field or all fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::clear - Manual" />
<meta itemprop="description" content="Clear a field or all fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clear a field or all fields" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlcalendar.construct.php">
          IntlCalendar::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlcalendar.before.php">
          &laquo; IntlCalendar::before        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.clear.php' selected="selected">English</option>
            <option value='de/intlcalendar.clear.php'>German</option>
            <option value='es/intlcalendar.clear.php'>Spanish</option>
            <option value='fr/intlcalendar.clear.php'>French</option>
            <option value='it/intlcalendar.clear.php'>Italian</option>
            <option value='ja/intlcalendar.clear.php'>Japanese</option>
            <option value='pt_BR/intlcalendar.clear.php'>Brazilian Portuguese</option>
            <option value='ru/intlcalendar.clear.php'>Russian</option>
            <option value='tr/intlcalendar.clear.php'>Turkish</option>
            <option value='uk/intlcalendar.clear.php'>Ukrainian</option>
            <option value='zh/intlcalendar.clear.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlcalendar.clear" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlCalendar::clear</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlCalendar::clear</span> &mdash; <span class="dc-title">Clear a field or all fields</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlcalendar.clear-description">
  ...
  <p class="para rdfs-comment">
   ...
   to <code class="literal">0</code>, though given the fieldʼs low priority, its value may
...
<p class="para">
 ...
 <div class="refsect1 examples" id="refsect1-intlcalendar.clear-examples">
  ...
  <p class="para">
   ...
   <p><strong>Example #1 <span class="function"><strong>IntlCalendar::clear()</strong></span> examples</strong></p>
...
<div class="examplescode"><pre class="examplescode">After GregorianCalendar creation
Array
(
    [0] =&gt; FIELD_ERA
    [1] =&gt; FIELD_YEAR
...
01/01/1970 00:00:00</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/clear.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.clear%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.clear&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.clear.php">＋<small>add a note</small></a></span>
