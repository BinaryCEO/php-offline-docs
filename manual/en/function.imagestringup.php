...
<head>
  ...
  <title>PHP: imagestringup - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagestringup.php">
 <link rel="shorturl" href="https://www.php.net/imagestringup">
 <link rel="alternate" href="https://www.php.net/imagestringup" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagestring.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagesx.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagestringup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagestringup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagestringup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagestringup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagestringup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagestringup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagestringup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagestringup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagestringup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagestringup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagestringup.php" hreflang="zh">
...
<meta name="Description" content="Draw a string vertically" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagestringup - Manual" />
<meta name="twitter:description" content="Draw a string vertically" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagestringup - Manual" />
<meta itemprop="description" content="Draw a string vertically" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draw a string vertically" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagestringup.php' selected="selected">English</option>
            <option value='de/function.imagestringup.php'>German</option>
            <option value='es/function.imagestringup.php'>Spanish</option>
            <option value='fr/function.imagestringup.php'>French</option>
            <option value='it/function.imagestringup.php'>Italian</option>
            <option value='ja/function.imagestringup.php'>Japanese</option>
            <option value='pt_BR/function.imagestringup.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagestringup.php'>Russian</option>
            <option value='tr/function.imagestringup.php'>Turkish</option>
            <option value='uk/function.imagestringup.php'>Ukrainian</option>
            <option value='zh/function.imagestringup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagestringup" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagestringup</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagestringup</span> &mdash; <span class="dc-title">Draw a string vertically</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagestringup-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagestringup</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="class.gdfont.php" class="type GdFont">GdFont</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span> <code class="parameter">$font</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$color</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Draws a <code class="parameter">string</code> vertically at the given
   coordinates.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imagestringup-parameters">
...
returned by <span class="function"><a href="function.imageloadfont.php" class="function">imageloadfont()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagestringup-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagestringup-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.imagestringup-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2936">
    <p><strong>Example #1 <span class="function"><strong>imagestringup()</strong></span> example</strong></p>
...
something similar to:</p></div>
    <div class="mediaobject">
     ...
     <div class="imageobject">
      <img src="images/21009b70229598c6a80eef8b45bf282b-imagestringup.png" alt="Output of example : imagestringup()" width="100" height="100" />
     </div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagestringup-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imageloadfont.php" class="function" rel="rdfs-seeAlso">imageloadfont()</a> - Load a new font</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagestringup.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagestringup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagestringup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagestringup.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="27626">  <div class="votes">
    <div id="Vu27626">
    <a href="/manual/vote-note.php?id=27626&amp;page=function.imagestringup&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd27626">
    <a href="/manual/vote-note.php?id=27626&amp;page=function.imagestringup&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V27626" title="52% like this...">
    1
    </div>
  </div>
  <a href="#27626" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#27626"> &para;</a><div class="date" title="2002-12-13 05:19"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom27626">
<div class="phpcode"><code><span class="html">function imagestringdown(&amp;$image, $font, $x, $y, $s, $col)<br />{<br />    $width = imagesx($image);<br />   $height = imagesy($image);<br />    <br />    $text_image = imagecreate($width, $height);<br /><br />   $white = imagecolorallocate ($text_image, 255, 255, 255);<br />   $black = imagecolorallocate ($text_image, 0, 0, 0);  <br /><br />    $transparent_colour = $white;<br />   if ($col == $white)<br />      $transparent_color = $black;<br />  <br />   imagefill($text_image, $width, $height, $transparent_colour);<br />   imagecolortransparent($text_image, $transparent_colour);<br />  <br />   imagestringup($text_image, $font, ($width - $x), ($height - $y), $s, $col);<br />   imagerotate($text_image, 180.0, $transparent_colour);<br />  <br />   imagecopy($image, $text_image, 0, 0, 0, 0, $width, $height);<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagestringup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagestringup.php">＋<small>add a note</small></a></div>
