...
<head>
  ...
  <title>PHP: Gmagick::scaleimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.scaleimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.scaleimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.scaleimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.rotateimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.separateimagechannel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.scaleimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.scaleimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.scaleimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.scaleimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.scaleimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.scaleimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.scaleimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.scaleimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.scaleimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.scaleimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.scaleimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::scaleimage - Manual" />
<meta name="twitter:description" content="Scales the size of an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::scaleimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.separateimagechannel.php">
          Gmagick::separateimagechannel &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.rotateimage.php">
          &laquo; Gmagick::rotateimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.scaleimage.php' selected="selected">English</option>
            <option value='de/gmagick.scaleimage.php'>German</option>
            <option value='es/gmagick.scaleimage.php'>Spanish</option>
            <option value='fr/gmagick.scaleimage.php'>French</option>
            <option value='it/gmagick.scaleimage.php'>Italian</option>
            <option value='ja/gmagick.scaleimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.scaleimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.scaleimage.php'>Russian</option>
            <option value='tr/gmagick.scaleimage.php'>Turkish</option>
            <option value='uk/gmagick.scaleimage.php'>Ukrainian</option>
            <option value='zh/gmagick.scaleimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.scaleimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::scaleimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::scaleimage</span> &mdash; <span class="dc-title">Scales the size of an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.scaleimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::scaleimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$fit</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.scaleimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.scaleimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.scaleimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/scaleimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.scaleimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.scaleimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.scaleimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128054">  <div class="votes">
    <div id="Vu128054">
    <a href="/manual/vote-note.php?id=128054&amp;page=gmagick.scaleimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128054">
    <a href="/manual/vote-note.php?id=128054&amp;page=gmagick.scaleimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128054" title="no votes...">
    0
    </div>
  </div>
  <a href="#128054" class="name">
  <strong class="user"><em>richard at computertech dot systems</em></strong></a><a class="genanchor" href="#128054"> &para;</a><div class="date" title="2022-12-26 09:45"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128054">
<div class="phpcode"><code><span class="html">Its important to understand that the boolean flag : $FIT is used as a MAXIMUM boundary of either X or Y<br /><br />If you use a physical image with a size of 128x256<br /> <br /> scaleImage(200, 100, true);  Will scale Y to 100 and X will be calculated<br /> scaleImage(100, 120, true);  Will scale X to 100 and Y will be calculated<br /><br />$FIT is a LIMITER which is why it requires both an X and a Y for $FIT=true</span></code></div>
  </div>
 </div>
  <div class="note" id="124485">  <div class="votes">
    <div id="Vu124485">
    <a href="/manual/vote-note.php?id=124485&amp;page=gmagick.scaleimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124485">
    <a href="/manual/vote-note.php?id=124485&amp;page=gmagick.scaleimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124485" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#124485" class="name">
  <strong class="user"><em>support at yourmob dot net</em></strong></a><a class="genanchor" href="#124485"> &para;</a><div class="date" title="2019-12-07 02:52"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124485">
<div class="phpcode"><code><span class="html">CORRECTION<br /><br />Replace<br /><br />echo 'img src="data:image/jpeg:base64,'.base64_encode($image).'"&gt;';<br /><br />With <br /><br />echo '&lt;img src="data:image/jpeg:base64,'.base64_encode($image).'"&gt;';</span></code></div>
  </div>
 </div>
  <div class="note" id="124484">  <div class="votes">
    <div id="Vu124484">
    <a href="/manual/vote-note.php?id=124484&amp;page=gmagick.scaleimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124484">
    <a href="/manual/vote-note.php?id=124484&amp;page=gmagick.scaleimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124484" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#124484" class="name">
  <strong class="user"><em>support at yourmob dot net</em></strong></a><a class="genanchor" href="#124484"> &para;</a><div class="date" title="2019-12-07 02:32"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124484">
<div class="phpcode"><code><span class="html">Simple method to load an image from file, resize and display without writing to disk.<br />tested on jpg, gif and bmp<br /><span class="default">&lt;?php<br />$image</span><span class="keyword">= new </span><span class="default">Gmagick</span><span class="keyword">( </span><span class="string">"yourimage.jpg"</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">scaleimage</span><span class="keyword">(</span><span class="default">300</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">);<br />echo </span><span class="string">'img src="data:image/jpeg:base64,'</span><span class="keyword">.</span><span class="default">base64_encode</span><span class="keyword">(</span><span class="default">$image</span><span class="keyword">).</span><span class="string">'"&gt;'</span><span class="keyword">;<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">();<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gmagick.scaleimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.scaleimage.php">＋<small>add a note</small></a></div>
