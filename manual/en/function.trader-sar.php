...
<head>
  ...
  <title>PHP: trader_sar - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-sar.php">
 <link rel="shorturl" href="https://www.php.net/trader-sar">
 <link rel="alternate" href="https://www.php.net/trader-sar" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-rsi.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-sarext.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-sar.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-sar.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-sar.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-sar.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-sar.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-sar.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-sar.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-sar.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-sar.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-sar.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-sar.php" hreflang="zh">
...
<meta name="Description" content="Parabolic SAR" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_sar - Manual" />
<meta name="twitter:description" content="Parabolic SAR" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_sar - Manual" />
<meta itemprop="description" content="Parabolic SAR" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Parabolic SAR" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-sarext.php">
          trader_sarext &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-sar.php' selected="selected">English</option>
            <option value='de/function.trader-sar.php'>German</option>
            <option value='es/function.trader-sar.php'>Spanish</option>
            <option value='fr/function.trader-sar.php'>French</option>
            <option value='it/function.trader-sar.php'>Italian</option>
            <option value='ja/function.trader-sar.php'>Japanese</option>
            <option value='pt_BR/function.trader-sar.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-sar.php'>Russian</option>
            <option value='tr/function.trader-sar.php'>Turkish</option>
            <option value='uk/function.trader-sar.php'>Ukrainian</option>
            <option value='zh/function.trader-sar.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-sar" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_sar</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_sar</span> &mdash; <span class="dc-title">Parabolic SAR</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-sar-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_sar</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$acceleration</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$maximum</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-sar-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">acceleration</code></dt>
    <dd>
     <p class="para">
      Acceleration Factor used up to the Maximum value. Valid range from 0 to <a href="trader.constants.php#constant.trader-real-max" class="link">TRADER_REAL_MAX</a>.
     </p>
    </dd>
   
   
    <dt><code class="parameter">maximum</code></dt>
    <dd>
     <p class="para">
      Acceleration Factor Maximum value. Valid range from 0 to <a href="trader.constants.php#constant.trader-real-max" class="link">TRADER_REAL_MAX</a>.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-sar-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-sar.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-sar%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-sar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-sar.php">＋<small>add a note</small></a></span>
