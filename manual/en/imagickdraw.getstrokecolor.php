...
<head>
  ...
  <title>PHP: ImagickDraw::getStrokeColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getstrokecolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getstrokecolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokecolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getstrokeantialias.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getstrokedasharray.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokecolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getstrokecolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getstrokecolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getstrokecolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getstrokecolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getstrokecolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getstrokecolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getstrokecolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getstrokecolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getstrokecolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getstrokecolor.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::getStrokeColor - Manual" />
<meta name="twitter:description" content="Returns the color used for stroking object outlines" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getStrokeColor - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.getstrokedasharray.php">
          ImagickDraw::getStrokeDashArray &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getstrokeantialias.php">
          &laquo; ImagickDraw::getStrokeAntialias        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getstrokecolor.php' selected="selected">English</option>
            <option value='de/imagickdraw.getstrokecolor.php'>German</option>
            <option value='es/imagickdraw.getstrokecolor.php'>Spanish</option>
            <option value='fr/imagickdraw.getstrokecolor.php'>French</option>
            <option value='it/imagickdraw.getstrokecolor.php'>Italian</option>
            <option value='ja/imagickdraw.getstrokecolor.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getstrokecolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getstrokecolor.php'>Russian</option>
            <option value='tr/imagickdraw.getstrokecolor.php'>Turkish</option>
            <option value='uk/imagickdraw.getstrokecolor.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getstrokecolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getstrokecolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getStrokeColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getStrokeColor</span> &mdash; <span class="dc-title">Returns the color used for stroking object outlines</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getstrokecolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getStrokeColor</strong></span>(): <span class="type"><a href="class.imagickpixel.php" class="type ImagickPixel">ImagickPixel</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.getstrokecolor-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">stroke_color</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getstrokecolor-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an <span class="classname"><a href="class.imagickpixel.php" class="classname">ImagickPixel</a></span> object which describes the color.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getstrokecolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getstrokecolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getstrokecolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getstrokecolor.php">＋<small>add a note</small></a></span>
