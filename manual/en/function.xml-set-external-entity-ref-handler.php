...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xml-set-external-entity-ref-handler.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.xml-set-end-namespace-decl-handler.php">
 <link rel="next" href="https://www.php.net/manual/en/function.xml-set-notation-decl-handler.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xml-set-external-entity-ref-handler.php' selected="selected">English</option>
            <option value='de/function.xml-set-external-entity-ref-handler.php'>German</option>
  ...
  instance now; previously, a valid <code class="literal">xml</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
     ...
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xml/functions/xml-set-external-entity-ref-handler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xml-set-external-entity-ref-handler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xml-set-external-entity-ref-handler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xml-set-external-entity-ref-handler.php">＋<small>add a note</small></a></span>
