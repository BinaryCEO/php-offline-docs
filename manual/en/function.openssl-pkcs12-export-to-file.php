...
<head>
  ...
  <title>PHP: openssl_pkcs12_export_to_file - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-pkcs12-export-to-file.php">
 <link rel="shorturl" href="https://www.php.net/openssl-pkcs12-export-to-file">
 <link rel="alternate" href="https://www.php.net/openssl-pkcs12-export-to-file" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-pkcs12-export.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-pkcs12-read.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-pkcs12-export-to-file.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-pkcs12-export-to-file.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-pkcs12-export-to-file.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-pkcs12-export-to-file.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-pkcs12-export-to-file.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-pkcs12-export-to-file.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-pkcs12-export-to-file.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-pkcs12-export-to-file.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-pkcs12-export-to-file.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-pkcs12-export-to-file.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-pkcs12-export-to-file.php" hreflang="zh">
...
<meta name="Description" content="Exports a PKCS#12 Compatible Certificate Store File" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_pkcs12_export_to_file - Manual" />
<meta name="twitter:description" content="Exports a PKCS#12 Compatible Certificate Store File" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_pkcs12_export_to_file - Manual" />
<meta itemprop="description" content="Exports a PKCS#12 Compatible Certificate Store File" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exports a PKCS#12 Compatible Certificate Store File" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-pkcs12-read.php">
          openssl_pkcs12_read &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-pkcs12-export.php">
          &laquo; openssl_pkcs12_export        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-pkcs12-export-to-file.php' selected="selected">English</option>
            <option value='de/function.openssl-pkcs12-export-to-file.php'>German</option>
            <option value='es/function.openssl-pkcs12-export-to-file.php'>Spanish</option>
            <option value='fr/function.openssl-pkcs12-export-to-file.php'>French</option>
            <option value='it/function.openssl-pkcs12-export-to-file.php'>Italian</option>
            <option value='ja/function.openssl-pkcs12-export-to-file.php'>Japanese</option>
            <option value='pt_BR/function.openssl-pkcs12-export-to-file.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-pkcs12-export-to-file.php'>Russian</option>
            <option value='tr/function.openssl-pkcs12-export-to-file.php'>Turkish</option>
            <option value='uk/function.openssl-pkcs12-export-to-file.php'>Ukrainian</option>
            <option value='zh/function.openssl-pkcs12-export-to-file.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-pkcs12-export-to-file" class="refentry">
    ...
    <tbody class="tbody">
     ...
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-pkcs12-export-to-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-pkcs12-export-to-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-pkcs12-export-to-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkcs12-export-to-file.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123555">  <div class="votes">
    <div id="Vu123555">
    <a href="/manual/vote-note.php?id=123555&amp;page=function.openssl-pkcs12-export-to-file&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123555">
    <a href="/manual/vote-note.php?id=123555&amp;page=function.openssl-pkcs12-export-to-file&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123555" title="50% like this...">
    0
    </div>
  </div>
  <a href="#123555" class="name">
  <strong class="user"><em>greejd</em></strong></a><a class="genanchor" href="#123555"> &para;</a><div class="date" title="2019-01-27 06:51"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123555">
<div class="phpcode"><code><span class="html">please note<br />the key 'friendlyname' should be 'friendly_name' in args<br /><br />$args = array(<br />        'friendly_name'=&gt; 'www.example.com'<br />);</span></code></div>
  </div>
 </div>
  <div class="note" id="91932">  <div class="votes">
    <div id="Vu91932">
    <a href="/manual/vote-note.php?id=91932&amp;page=function.openssl-pkcs12-export-to-file&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91932">
    <a href="/manual/vote-note.php?id=91932&amp;page=function.openssl-pkcs12-export-to-file&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91932" title="45% like this...">
    -1
    </div>
  </div>
  <a href="#91932" class="name">
  <strong class="user"><em>lampacz at gmail dot com</em></strong></a><a class="genanchor" href="#91932"> &para;</a><div class="date" title="2009-07-02 01:13"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91932">
<div class="phpcode"><code><span class="html">[, array $args ]  can contain only: extracerts, friendly_name<br /><br />extracerts - additional certificates (can be file or string)<br />friendly_name - "friendly name" for the certificate and private key. This name is typically displayed in list boxes by software importing the file.<br /><br />based on source code version 5.2.8 and pkcs12 man page</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-pkcs12-export-to-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkcs12-export-to-file.php">＋<small>add a note</small></a></div>
