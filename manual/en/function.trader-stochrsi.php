...
<head>
  ...
  <title>PHP: trader_stochrsi - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-stochrsi.php">
 <link rel="shorturl" href="https://www.php.net/trader-stochrsi">
 <link rel="alternate" href="https://www.php.net/trader-stochrsi" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-stochf.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-sub.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-stochrsi.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-stochrsi.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-stochrsi.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-stochrsi.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-stochrsi.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-stochrsi.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-stochrsi.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-stochrsi.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-stochrsi.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-stochrsi.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-stochrsi.php" hreflang="zh">
...
<meta name="Description" content="Stochastic Relative Strength Index" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_stochrsi - Manual" />
<meta name="twitter:description" content="Stochastic Relative Strength Index" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_stochrsi - Manual" />
<meta itemprop="description" content="Stochastic Relative Strength Index" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Stochastic Relative Strength Index" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-sub.php">
          trader_sub &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-stochf.php">
          &laquo; trader_stochf        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-stochrsi.php' selected="selected">English</option>
            <option value='de/function.trader-stochrsi.php'>German</option>
            <option value='es/function.trader-stochrsi.php'>Spanish</option>
            <option value='fr/function.trader-stochrsi.php'>French</option>
            <option value='it/function.trader-stochrsi.php'>Italian</option>
            <option value='ja/function.trader-stochrsi.php'>Japanese</option>
            <option value='pt_BR/function.trader-stochrsi.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-stochrsi.php'>Russian</option>
            <option value='tr/function.trader-stochrsi.php'>Turkish</option>
            <option value='uk/function.trader-stochrsi.php'>Ukrainian</option>
            <option value='zh/function.trader-stochrsi.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-stochrsi" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_stochrsi</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_stochrsi</span> &mdash; <span class="dc-title">Stochastic Relative Strength Index</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-stochrsi-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_stochrsi</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fastK_Period</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fastD_Period</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fastD_MAType</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-stochrsi-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">fastD_Period</code></dt>
    <dd>
     <p class="para">
    ...
    <dt><code class="parameter">fastD_MAType</code></dt>
    <dd>
     <p class="para">
      Type of Moving Average for Fast-D. <a href="trader.constants.php" class="link">TRADER_MA_TYPE_*</a> series of constants should be used.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-stochrsi-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-stochrsi.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-stochrsi%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-stochrsi&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-stochrsi.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126008">  <div class="votes">
    <div id="Vu126008">
    <a href="/manual/vote-note.php?id=126008&amp;page=function.trader-stochrsi&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126008">
    <a href="/manual/vote-note.php?id=126008&amp;page=function.trader-stochrsi&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126008" title="57% like this...">
    6
    </div>
  </div>
  <a href="#126008" class="name">
  <strong class="user"><em>Ali</em></strong></a><a class="genanchor" href="#126008"> &para;</a><div class="date" title="2021-04-14 08:43"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126008">
<div class="phpcode"><code><span class="html">this function use FAST stoch if you need results like Tradingview use this:<br /><br />$rsi = trader_rsi($dataclose,14);<br />$stochrsi = trader_stoch($rsi,$rsi,$rsi,14,3,TRADER_MA_TYPE_SMA,3,TRADER_MA_TYPE_SMA);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-stochrsi&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-stochrsi.php">＋<small>add a note</small></a></div>
