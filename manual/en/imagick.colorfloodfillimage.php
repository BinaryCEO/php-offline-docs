...
<head>
  ...
  <title>PHP: Imagick::colorFloodfillImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.colorfloodfillimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.colorfloodfillimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.colorfloodfillimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.coalesceimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.colorizeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.colorfloodfillimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.colorfloodfillimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.colorfloodfillimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.colorfloodfillimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.colorfloodfillimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.colorfloodfillimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.colorfloodfillimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.colorfloodfillimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.colorfloodfillimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.colorfloodfillimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.colorfloodfillimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::colorFloodfillImage - Manual" />
<meta name="twitter:description" content="Changes the color value of any pixel that matches target" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::colorFloodfillImage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.colorizeimage.php">
          Imagick::colorizeImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.coalesceimages.php">
          &laquo; Imagick::coalesceImages        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.colorfloodfillimage.php' selected="selected">English</option>
            <option value='de/imagick.colorfloodfillimage.php'>German</option>
            <option value='es/imagick.colorfloodfillimage.php'>Spanish</option>
            <option value='fr/imagick.colorfloodfillimage.php'>French</option>
            <option value='it/imagick.colorfloodfillimage.php'>Italian</option>
            <option value='ja/imagick.colorfloodfillimage.php'>Japanese</option>
            <option value='pt_BR/imagick.colorfloodfillimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.colorfloodfillimage.php'>Russian</option>
            <option value='tr/imagick.colorfloodfillimage.php'>Turkish</option>
            <option value='uk/imagick.colorfloodfillimage.php'>Ukrainian</option>
            <option value='zh/imagick.colorfloodfillimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.colorfloodfillimage" class="refentry">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/colorfloodfillimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.colorfloodfillimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.colorfloodfillimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.colorfloodfillimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114930">  <div class="votes">
    <div id="Vu114930">
    <a href="/manual/vote-note.php?id=114930&amp;page=imagick.colorfloodfillimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114930">
    <a href="/manual/vote-note.php?id=114930&amp;page=imagick.colorfloodfillimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114930" title="62% like this...">
    2
    </div>
  </div>
  <a href="#114930" class="name">
  <strong class="user"><em>memmie at lenglet dot name</em></strong></a><a class="genanchor" href="#114930"> &para;</a><div class="date" title="2014-04-29 09:39"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114930">
<div class="phpcode"><code><span class="html">Imagick::colorFloodFillImage is depreciated. You should use Imagick::paintFloodfillImage (replaced by Imagick::floodFillPaintImage in ImageMagick 6.3.8)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.colorfloodfillimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.colorfloodfillimage.php">＋<small>add a note</small></a></div>
