...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.getresultmessage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.getresultmessage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.getresultmessage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.getresultcode.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.getserverbykey.php">
...
<meta name="Description" content="Return the message describing the result of the last operation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::getResultMessage - Manual" />
<meta name="twitter:description" content="Return the message describing the result of the last operation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::getResultMessage - Manual" />
<meta itemprop="description" content="Return the message describing the result of the last operation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the message describing the result of the last operation" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.getresultmessage.php' selected="selected">English</option>
            ...
            <option value='fr/memcached.getresultmessage.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL memcached &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">Memcached::getResultMessage</span> &mdash; <span class="dc-title">Return the message describing the result of the last operation</span></p>
 ...
 <div class="refsect1 description" id="refsect1-memcached.getresultmessage-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::getResultMessage()</strong></span> returns a string that
...
<div class="examplescode"><pre class="examplescode">NOT STORED</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/getresultmessage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.getresultmessage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.getresultmessage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.getresultmessage.php">＋<small>add a note</small></a></span>
