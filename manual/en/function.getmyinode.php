...
<head>
  ...
  <title>PHP: getmyinode - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.getmyinode.php">
 <link rel="shorturl" href="https://www.php.net/getmyinode">
 <link rel="alternate" href="https://www.php.net/getmyinode" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.getmygid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.getmypid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.getmyinode.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.getmyinode.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.getmyinode.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.getmyinode.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.getmyinode.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.getmyinode.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.getmyinode.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.getmyinode.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.getmyinode.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.getmyinode.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.getmyinode.php" hreflang="zh">
...
<meta name="Description" content="Gets the inode of the current script" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: getmyinode - Manual" />
<meta name="twitter:description" content="Gets the inode of the current script" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: getmyinode - Manual" />
<meta itemprop="description" content="Gets the inode of the current script" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the inode of the current script" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.getmyinode.php' selected="selected">English</option>
            <option value='de/function.getmyinode.php'>German</option>
            <option value='es/function.getmyinode.php'>Spanish</option>
            <option value='fr/function.getmyinode.php'>French</option>
            <option value='it/function.getmyinode.php'>Italian</option>
            <option value='ja/function.getmyinode.php'>Japanese</option>
            <option value='pt_BR/function.getmyinode.php'>Brazilian Portuguese</option>
            <option value='ru/function.getmyinode.php'>Russian</option>
            <option value='tr/function.getmyinode.php'>Turkish</option>
            <option value='uk/function.getmyinode.php'>Ukrainian</option>
            <option value='zh/function.getmyinode.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.getmyinode" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">getmyinode</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">getmyinode</span> &mdash; <span class="dc-title">Gets the inode of the current script</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.getmyinode-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>getmyinode</strong></span>(): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.getmyinode-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.getmyinode-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the current script&#039;s inode as an integer, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.getmyinode-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.getlastmod.php" class="function" rel="rdfs-seeAlso">getlastmod()</a> - Gets time of last page modification</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/getmyinode.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.getmyinode%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.getmyinode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getmyinode.php">＋<small>add a note</small></a></span>
