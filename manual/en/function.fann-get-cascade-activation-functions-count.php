...
<head>
  ...
  <title>PHP: fann_get_cascade_activation_functions_count - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-cascade-activation-functions-count.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-cascade-activation-functions-count">
 <link rel="alternate" href="https://www.php.net/fann-get-cascade-activation-functions-count" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-cascade-activation-functions.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-cascade-activation-steepnesses.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-cascade-activation-functions-count.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-cascade-activation-functions-count.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-cascade-activation-functions-count.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-cascade-activation-functions-count.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-cascade-activation-functions-count.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-cascade-activation-functions-count.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-cascade-activation-functions-count.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-cascade-activation-functions-count.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-cascade-activation-functions-count.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-cascade-activation-functions-count.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-cascade-activation-functions-count.php" hreflang="zh">
...
<meta name="Description" content="Returns the number of cascade activation functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_cascade_activation_functions_count - Manual" />
<meta name="twitter:description" content="Returns the number of cascade activation functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_cascade_activation_functions_count - Manual" />
<meta itemprop="description" content="Returns the number of cascade activation functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the number of cascade activation functions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-get-cascade-activation-steepnesses.php">
          fann_get_cascade_activation_steepnesses &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-cascade-activation-functions.php">
          &laquo; fann_get_cascade_activation_functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-cascade-activation-functions-count.php' selected="selected">English</option>
            <option value='de/function.fann-get-cascade-activation-functions-count.php'>German</option>
            <option value='es/function.fann-get-cascade-activation-functions-count.php'>Spanish</option>
            <option value='fr/function.fann-get-cascade-activation-functions-count.php'>French</option>
            <option value='it/function.fann-get-cascade-activation-functions-count.php'>Italian</option>
            <option value='ja/function.fann-get-cascade-activation-functions-count.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-cascade-activation-functions-count.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-cascade-activation-functions-count.php'>Russian</option>
            <option value='tr/function.fann-get-cascade-activation-functions-count.php'>Turkish</option>
            <option value='uk/function.fann-get-cascade-activation-functions-count.php'>Ukrainian</option>
            <option value='zh/function.fann-get-cascade-activation-functions-count.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-cascade-activation-functions-count" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_get_cascade_activation_functions_count</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_get_cascade_activation_functions_count</span> &mdash; <span class="dc-title">Returns the number of cascade activation functions</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-get-cascade-activation-functions-count-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_get_cascade_activation_functions_count</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   The number of activation functions in the <span class="function"><a href="function.fann-get-cascade-activation-functions.php" class="function">fann_get_cascade_activation_functions()</a></span> array.
  </p>
  <p class="para">
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-get-cascade-activation-functions-count-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-cascade-activation-functions-count-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The number of cascade activation functions, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fann-get-cascade-activation-functions-count-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-set-cascade-activation-functions.php" class="function" rel="rdfs-seeAlso">fann_set_cascade_activation_functions()</a> - Sets the array of cascade candidate activation functions</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-cascade-activation-functions-count.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-cascade-activation-functions-count%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-cascade-activation-functions-count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-cascade-activation-functions-count.php">＋<small>add a note</small></a></span>
