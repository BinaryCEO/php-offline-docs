...
<head>
  ...
  <title>PHP: CommonMark\Node\Text\Strong - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.commonmark-node-text-strong.php">
 <link rel="shorturl" href="https://www.php.net/commonmark-node-text-strong">
 <link rel="alternate" href="https://www.php.net/commonmark-node-text-strong" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.cmark.php">
 <link rel="prev" href="https://www.php.net/manual/en/commonmark-node-text.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/class.commonmark-node-text-emphasis.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.commonmark-node-text-strong.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.commonmark-node-text-strong.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.commonmark-node-text-strong.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.commonmark-node-text-strong.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.commonmark-node-text-strong.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.commonmark-node-text-strong.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.commonmark-node-text-strong.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.commonmark-node-text-strong.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.commonmark-node-text-strong.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.commonmark-node-text-strong.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.commonmark-node-text-strong.php" hreflang="zh">
...
<meta name="Description" content="Strong concrete CommonMark\Node" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CommonMark\Node\Text\Strong - Manual" />
<meta name="twitter:description" content="Strong concrete CommonMark\Node" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CommonMark\Node\Text\Strong - Manual" />
<meta itemprop="description" content="Strong concrete CommonMark\Node" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Strong concrete CommonMark\Node" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.commonmark-node-text-emphasis.php">
          CommonMark\Node\Text\Emphasis &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="commonmark-node-text.construct.php">
          &laquo; CommonMark\Node\Text::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.commonmark-node-text-strong.php' selected="selected">English</option>
            <option value='de/class.commonmark-node-text-strong.php'>German</option>
            <option value='es/class.commonmark-node-text-strong.php'>Spanish</option>
            <option value='fr/class.commonmark-node-text-strong.php'>French</option>
            <option value='it/class.commonmark-node-text-strong.php'>Italian</option>
            <option value='ja/class.commonmark-node-text-strong.php'>Japanese</option>
            <option value='pt_BR/class.commonmark-node-text-strong.php'>Brazilian Portuguese</option>
            <option value='ru/class.commonmark-node-text-strong.php'>Russian</option>
            <option value='tr/class.commonmark-node-text-strong.php'>Turkish</option>
            <option value='uk/class.commonmark-node-text-strong.php'>Ukrainian</option>
            <option value='zh/class.commonmark-node-text-strong.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.commonmark-node-text-strong" class="reference">

 <h1 class="title">Strong concrete CommonMark\Node</h1>
 

 <div class="partintro"><p class="verinfo">(cmark &gt;= 1.0.0)</p>

  <div class="section" id="commonmark-node-text-strong.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      ...
      <span class="modifier">class</span> <strong class="classname">CommonMark\Node\Text\Strong</strong>
     </span>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="commonmark-node.accept.php" class="methodname">CommonMark\Node::accept</a></span>(<span class="methodparam"><span class="type"><a href="class.commonmark-interfaces-ivisitor.php" class="type CommonMark\Interfaces\IVisitor">CommonMark\Interfaces\IVisitor</a></span> <code class="parameter">$visitor</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cmark/commonmark.node.text.strong.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.commonmark-node-text-strong%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.commonmark-node-text-strong&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.commonmark-node-text-strong.php">＋<small>add a note</small></a></span>
