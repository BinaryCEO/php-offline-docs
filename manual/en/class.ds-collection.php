...
<head>
  ...
  <title>PHP: Ds\Collection - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ds-collection.php">
 <link rel="shorturl" href="https://www.php.net/ds-collection">
 <link rel="alternate" href="https://www.php.net/ds-collection" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ds.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds.examples.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-collection.clear.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ds-collection.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ds-collection.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ds-collection.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ds-collection.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ds-collection.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ds-collection.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ds-collection.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ds-collection.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ds-collection.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ds-collection.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ds-collection.php" hreflang="zh">
...
<meta name="Description" content="The Collection interface" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Ds\Collection - Manual" />
<meta name="twitter:description" content="The Collection interface" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Ds\Collection - Manual" />
<meta itemprop="description" content="The Collection interface" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Collection interface" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ds-collection.clear.php">
          Ds\Collection::clear &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ds.examples.php">
          &laquo; Examples        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ds-collection.php' selected="selected">English</option>
            <option value='de/class.ds-collection.php'>German</option>
            <option value='es/class.ds-collection.php'>Spanish</option>
            <option value='fr/class.ds-collection.php'>French</option>
            <option value='it/class.ds-collection.php'>Italian</option>
            <option value='ja/class.ds-collection.php'>Japanese</option>
            <option value='pt_BR/class.ds-collection.php'>Brazilian Portuguese</option>
            <option value='ru/class.ds-collection.php'>Russian</option>
            <option value='tr/class.ds-collection.php'>Turkish</option>
            <option value='uk/class.ds-collection.php'>Ukrainian</option>
            <option value='zh/class.ds-collection.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ds-collection" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ds-collection.clear.php">Ds\Collection::clear</a> — Removes all values</li><li><a href="ds-collection.copy.php">Ds\Collection::copy</a> — Returns a shallow copy of the collection</li><li><a href="ds-collection.isempty.php">Ds\Collection::isEmpty</a> — Returns whether the collection is empty</li><li><a href="ds-collection.toarray.php">Ds\Collection::toArray</a> — Converts the collection to an array</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds.collection.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ds-collection%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ds-collection&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ds-collection.php">＋<small>add a note</small></a></span>
