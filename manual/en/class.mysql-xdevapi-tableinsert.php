...
<head>
  ...
  <title>PHP: mysql_xdevapi\TableInsert - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mysql-xdevapi-tableinsert.php">
 <link rel="shorturl" href="https://www.php.net/mysql-xdevapi-tableinsert">
 <link rel="alternate" href="https://www.php.net/mysql-xdevapi-tableinsert" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mysql-xdevapi.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-tabledelete.where.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-tableinsert.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mysql-xdevapi-tableinsert.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mysql-xdevapi-tableinsert.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mysql-xdevapi-tableinsert.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mysql-xdevapi-tableinsert.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mysql-xdevapi-tableinsert.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mysql-xdevapi-tableinsert.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mysql-xdevapi-tableinsert.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mysql-xdevapi-tableinsert.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mysql-xdevapi-tableinsert.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mysql-xdevapi-tableinsert.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mysql-xdevapi-tableinsert.php" hreflang="zh">
...
<meta name="Description" content="TableInsert class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_xdevapi\TableInsert - Manual" />
<meta name="twitter:description" content="TableInsert class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_xdevapi\TableInsert - Manual" />
<meta itemprop="description" content="TableInsert class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="TableInsert class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysql-xdevapi-tableinsert.construct.php">
          TableInsert::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysql-xdevapi-tabledelete.where.php">
          &laquo; TableDelete::where        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mysql-xdevapi-tableinsert.php' selected="selected">English</option>
            <option value='de/class.mysql-xdevapi-tableinsert.php'>German</option>
            <option value='es/class.mysql-xdevapi-tableinsert.php'>Spanish</option>
            <option value='fr/class.mysql-xdevapi-tableinsert.php'>French</option>
            <option value='it/class.mysql-xdevapi-tableinsert.php'>Italian</option>
            <option value='ja/class.mysql-xdevapi-tableinsert.php'>Japanese</option>
            <option value='pt_BR/class.mysql-xdevapi-tableinsert.php'>Brazilian Portuguese</option>
            <option value='ru/class.mysql-xdevapi-tableinsert.php'>Russian</option>
            <option value='tr/class.mysql-xdevapi-tableinsert.php'>Turkish</option>
            <option value='uk/class.mysql-xdevapi-tableinsert.php'>Ukrainian</option>
            <option value='zh/class.mysql-xdevapi-tableinsert.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mysql-xdevapi-tableinsert" class="reference">

 <h1 class="title">TableInsert class</h1>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mysql-xdevapi-tableinsert.construct.php">TableInsert::__construct</a> — TableInsert constructor</li><li><a href="mysql-xdevapi-tableinsert.execute.php">TableInsert::execute</a> — Execute insert query</li><li><a href="mysql-xdevapi-tableinsert.values.php">TableInsert::values</a> — Add insert row values</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql-xdevapi.tableinsert.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mysql-xdevapi-tableinsert%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mysql-xdevapi-tableinsert&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mysql-xdevapi-tableinsert.php">＋<small>add a note</small></a></span>
