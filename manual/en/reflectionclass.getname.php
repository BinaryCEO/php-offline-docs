...
<head>
  ...
  <title>PHP: ReflectionClass::getName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getname.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getname.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getname.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getmodifiers.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getnamespacename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getname.php" hreflang="zh">
...
<meta name="Description" content="Gets class name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getName - Manual" />
<meta name="twitter:description" content="Gets class name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getName - Manual" />
<meta itemprop="description" content="Gets class name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets class name" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.getnamespacename.php">
          ReflectionClass::getNamespaceName &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getmodifiers.php">
          &laquo; ReflectionClass::getModifiers        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getname.php' selected="selected">English</option>
            <option value='de/reflectionclass.getname.php'>German</option>
            <option value='es/reflectionclass.getname.php'>Spanish</option>
            <option value='fr/reflectionclass.getname.php'>French</option>
            <option value='it/reflectionclass.getname.php'>Italian</option>
            <option value='ja/reflectionclass.getname.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getname.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getname.php'>Russian</option>
            <option value='tr/reflectionclass.getname.php'>Turkish</option>
            <option value='uk/reflectionclass.getname.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getname" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::getName</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getName</span> &mdash; <span class="dc-title">Gets class name</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.getname-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::getName</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.getname-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.getname-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.getname-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-5484">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionClass::getName()</strong></span> example</strong></p>
...
string(3) &quot;Foo&quot;</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.getname-seealso">
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.getnamespacename.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getNamespaceName()</a> - Gets namespace name</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getname.php">＋<small>add a note</small></a></span>
