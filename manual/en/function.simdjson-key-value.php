...
<head>
  ...
  <title>PHP: simdjson_key_value - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.simdjson-key-value.php">
 <link rel="shorturl" href="https://www.php.net/simdjson-key-value">
 <link rel="alternate" href="https://www.php.net/simdjson-key-value" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.simdjson.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.simdjson-key-exists.php">
 <link rel="next" href="https://www.php.net/manual/en/class.simdjsonexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.simdjson-key-value.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.simdjson-key-value.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.simdjson-key-value.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.simdjson-key-value.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.simdjson-key-value.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.simdjson-key-value.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.simdjson-key-value.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.simdjson-key-value.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.simdjson-key-value.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.simdjson-key-value.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.simdjson-key-value.php" hreflang="zh">
...
<meta name="Description" content="Decodes the value of a JSON string located at the requested JSON pointer." />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: simdjson_key_value - Manual" />
<meta name="twitter:description" content="Decodes the value of a JSON string located at the requested JSON pointer." />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: simdjson_key_value - Manual" />
<meta itemprop="description" content="Decodes the value of a JSON string located at the requested JSON pointer." />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decodes the value of a JSON string located at the requested JSON pointer." />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.simdjsonexception.php">
          SimdJsonException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.simdjson-key-exists.php">
          &laquo; simdjson_key_exists        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.simdjson-key-value.php' selected="selected">English</option>
            <option value='de/function.simdjson-key-value.php'>German</option>
            <option value='es/function.simdjson-key-value.php'>Spanish</option>
            <option value='fr/function.simdjson-key-value.php'>French</option>
            <option value='it/function.simdjson-key-value.php'>Italian</option>
            <option value='ja/function.simdjson-key-value.php'>Japanese</option>
            <option value='pt_BR/function.simdjson-key-value.php'>Brazilian Portuguese</option>
            <option value='ru/function.simdjson-key-value.php'>Russian</option>
            <option value='tr/function.simdjson-key-value.php'>Turkish</option>
            <option value='uk/function.simdjson-key-value.php'>Ukrainian</option>
            <option value='zh/function.simdjson-key-value.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.simdjson-key-value" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.simdjson-decode.php" class="function" rel="rdfs-seeAlso">simdjson_decode()</a> - Decodes a JSON string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/simdjson/functions/simdjson-key-value.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.simdjson-key-value%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.simdjson-key-value&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.simdjson-key-value.php">＋<small>add a note</small></a></span>
