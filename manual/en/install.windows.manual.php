...
<head>
  ...
  <title>PHP: Manual installation of pre-built binaries - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/install.windows.manual.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/install.windows.manual.php">
 <link rel="alternate" href="https://www.php.net/manual/en/install.windows.manual.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/install.windows.php">
 <link rel="prev" href="https://www.php.net/manual/en/install.windows.recommended.php">
 <link rel="next" href="https://www.php.net/manual/en/install.windows.apache2.php">

 <link rel="alternate" href="https://www.php.net/manual/en/install.windows.manual.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/install.windows.manual.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/install.windows.manual.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/install.windows.manual.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/install.windows.manual.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/install.windows.manual.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/install.windows.manual.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/install.windows.manual.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/install.windows.manual.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/install.windows.manual.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/install.windows.manual.php" hreflang="zh">
...
<meta name="Description" content="Manual installation of pre-built binaries" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Manual installation of pre-built binaries - Manual" />
<meta name="twitter:description" content="Manual installation of pre-built binaries" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Manual installation of pre-built binaries - Manual" />
<meta itemprop="description" content="Manual installation of pre-built binaries" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Manual installation of pre-built binaries" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="install.windows.apache2.php">
          Installation for Apache 2.x on Windows systems &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="install.windows.recommended.php">
          &laquo; Recommended configuration on Windows systems        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/install.windows.manual.php' selected="selected">English</option>
            <option value='de/install.windows.manual.php'>German</option>
            <option value='es/install.windows.manual.php'>Spanish</option>
            <option value='fr/install.windows.manual.php'>French</option>
            <option value='it/install.windows.manual.php'>Italian</option>
            <option value='ja/install.windows.manual.php'>Japanese</option>
            <option value='pt_BR/install.windows.manual.php'>Brazilian Portuguese</option>
            <option value='ru/install.windows.manual.php'>Russian</option>
            <option value='tr/install.windows.manual.php'>Turkish</option>
            <option value='uk/install.windows.manual.php'>Ukrainian</option>
            <option value='zh/install.windows.manual.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="install.windows.manual" class="sect1">
    ...
    <li class="listitem">
     <p class="para">x64 - for 64-bit systems.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/install/windows/manual.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Finstall.windows.manual%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=install.windows.manual&amp;repo=en&amp;redirect=https://www.php.net/manual/en/install.windows.manual.php">＋<small>add a note</small></a></span>
