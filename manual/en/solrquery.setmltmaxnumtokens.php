...
<head>
  ...
  <title>PHP: SolrQuery::setMltMaxNumTokens - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setmltmaxnumtokens.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setmltmaxnumtokens.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltmaxnumtokens.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setmltmaxnumqueryterms.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setmltmaxwordlength.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltmaxnumtokens.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setmltmaxnumtokens.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setmltmaxnumtokens.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setmltmaxnumtokens.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setmltmaxnumtokens.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setmltmaxnumtokens.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setmltmaxnumtokens.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setmltmaxnumtokens.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setmltmaxnumtokens.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setmltmaxnumtokens.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setmltmaxnumtokens.php" hreflang="zh">
...
<meta name="Description" content="Specifies the maximum number of tokens to parse" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setMltMaxNumTokens - Manual" />
<meta name="twitter:description" content="Specifies the maximum number of tokens to parse" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setMltMaxNumTokens - Manual" />
<meta itemprop="description" content="Specifies the maximum number of tokens to parse" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the maximum number of tokens to parse" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setmltmaxwordlength.php">
          SolrQuery::setMltMaxWordLength &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setmltmaxnumqueryterms.php">
          &laquo; SolrQuery::setMltMaxNumQueryTerms        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setmltmaxnumtokens.php' selected="selected">English</option>
            <option value='de/solrquery.setmltmaxnumtokens.php'>German</option>
            <option value='es/solrquery.setmltmaxnumtokens.php'>Spanish</option>
            <option value='fr/solrquery.setmltmaxnumtokens.php'>French</option>
            <option value='it/solrquery.setmltmaxnumtokens.php'>Italian</option>
            <option value='ja/solrquery.setmltmaxnumtokens.php'>Japanese</option>
            <option value='pt_BR/solrquery.setmltmaxnumtokens.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setmltmaxnumtokens.php'>Russian</option>
            <option value='tr/solrquery.setmltmaxnumtokens.php'>Turkish</option>
            <option value='uk/solrquery.setmltmaxnumtokens.php'>Ukrainian</option>
            <option value='zh/solrquery.setmltmaxnumtokens.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setmltmaxnumtokens" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setMltMaxNumTokens</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setMltMaxNumTokens</span> &mdash; <span class="dc-title">Specifies the maximum number of tokens to parse</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setmltmaxnumtokens-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setMltMaxNumTokens</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setmltmaxnumtokens-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setmltmaxnumtokens-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setmltmaxnumtokens.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setmltmaxnumtokens%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setmltmaxnumtokens&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setmltmaxnumtokens.php">＋<small>add a note</small></a></span>
