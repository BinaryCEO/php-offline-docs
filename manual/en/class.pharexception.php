...
<head>
  ...
  <title>PHP: PharException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.pharexception.php">
 <link rel="shorturl" href="https://www.php.net/pharexception">
 <link rel="alternate" href="https://www.php.net/pharexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/pharfileinfo.setmetadata.php">
 <link rel="next" href="https://www.php.net/manual/en/book.rar.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.pharexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.pharexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.pharexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.pharexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.pharexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.pharexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.pharexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.pharexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.pharexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.pharexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.pharexception.php" hreflang="zh">
...
<meta name="Description" content="The PharException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PharException - Manual" />
<meta name="twitter:description" content="The PharException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PharException - Manual" />
<meta itemprop="description" content="The PharException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The PharException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="pharfileinfo.setmetadata.php">
          &laquo; PharFileInfo::setMetadata        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.pharexception.php' selected="selected">English</option>
            <option value='de/class.pharexception.php'>German</option>
            <option value='es/class.pharexception.php'>Spanish</option>
            <option value='fr/class.pharexception.php'>French</option>
            <option value='it/class.pharexception.php'>Italian</option>
            <option value='ja/class.pharexception.php'>Japanese</option>
            <option value='pt_BR/class.pharexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.pharexception.php'>Russian</option>
            <option value='tr/class.pharexception.php'>Turkish</option>
            <option value='uk/class.pharexception.php'>Ukrainian</option>
            <option value='zh/class.pharexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.pharexception" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 1.0.0)</p>
  ...
  <div class="section" id="pharexception.intro">
  ...
  <div class="section" id="pharexception.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">PharException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/PharException.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.pharexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.pharexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.pharexception.php">＋<small>add a note</small></a></span>
