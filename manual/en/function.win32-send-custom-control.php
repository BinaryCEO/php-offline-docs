...
<head>
  ...
  <title>PHP: win32_send_custom_control - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.win32-send-custom-control.php">
 <link rel="shorturl" href="https://www.php.net/win32-send-custom-control">
 <link rel="alternate" href="https://www.php.net/win32-send-custom-control" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.win32service.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.win32-remove-service-env-var.php">
 <link rel="next" href="https://www.php.net/manual/en/function.win32-set-service-exit-code.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.win32-send-custom-control.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.win32-send-custom-control.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.win32-send-custom-control.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.win32-send-custom-control.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.win32-send-custom-control.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.win32-send-custom-control.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.win32-send-custom-control.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.win32-send-custom-control.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.win32-send-custom-control.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.win32-send-custom-control.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.win32-send-custom-control.php" hreflang="zh">
...
<meta name="Description" content="Send a custom control to the service" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: win32_send_custom_control - Manual" />
<meta name="twitter:description" content="Send a custom control to the service" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: win32_send_custom_control - Manual" />
<meta itemprop="description" content="Send a custom control to the service" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Send a custom control to the service" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.win32-set-service-exit-code.php">
          win32_set_service_exit_code &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.win32-remove-service-env-var.php">
          &laquo; win32_remove_service_env_var        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.win32-send-custom-control.php' selected="selected">English</option>
            <option value='de/function.win32-send-custom-control.php'>German</option>
            <option value='es/function.win32-send-custom-control.php'>Spanish</option>
            <option value='fr/function.win32-send-custom-control.php'>French</option>
            <option value='it/function.win32-send-custom-control.php'>Italian</option>
            <option value='ja/function.win32-send-custom-control.php'>Japanese</option>
            <option value='pt_BR/function.win32-send-custom-control.php'>Brazilian Portuguese</option>
            <option value='ru/function.win32-send-custom-control.php'>Russian</option>
            <option value='tr/function.win32-send-custom-control.php'>Turkish</option>
            <option value='uk/function.win32-send-custom-control.php'>Ukrainian</option>
            <option value='zh/function.win32-send-custom-control.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.win32-send-custom-control" class="refentry">
  ...
  <ul class="simplelist">
    ...
    <li><a href="win32service.constants.php#win32service.constants.errors" class="link">Win32 Error Codes</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/win32service/functions/win32-send-custom-control.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.win32-send-custom-control%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.win32-send-custom-control&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.win32-send-custom-control.php">＋<small>add a note</small></a></span>
