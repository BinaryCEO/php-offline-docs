...
<head>
  ...
  <title>PHP: ldap_modify_batch - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-modify-batch.php">
 <link rel="shorturl" href="https://www.php.net/ldap-modify-batch">
 <link rel="alternate" href="https://www.php.net/ldap-modify-batch" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-modify.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-next-attribute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-modify-batch.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-modify-batch.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-modify-batch.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-modify-batch.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-modify-batch.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-modify-batch.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-modify-batch.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-modify-batch.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-modify-batch.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-modify-batch.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-modify-batch.php" hreflang="zh">
...
<meta name="Description" content="Batch and execute modifications on an LDAP entry" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_modify_batch - Manual" />
<meta name="twitter:description" content="Batch and execute modifications on an LDAP entry" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_modify_batch - Manual" />
<meta itemprop="description" content="Batch and execute modifications on an LDAP entry" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Batch and execute modifications on an LDAP entry" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-modify-batch.php' selected="selected">English</option>
            <option value='de/function.ldap-modify-batch.php'>German</option>
            <option value='es/function.ldap-modify-batch.php'>Spanish</option>
            <option value='fr/function.ldap-modify-batch.php'>French</option>
            <option value='it/function.ldap-modify-batch.php'>Italian</option>
            <option value='ja/function.ldap-modify-batch.php'>Japanese</option>
            <option value='pt_BR/function.ldap-modify-batch.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-modify-batch.php'>Russian</option>
            <option value='tr/function.ldap-modify-batch.php'>Turkish</option>
            <option value='uk/function.ldap-modify-batch.php'>Ukrainian</option>
            <option value='zh/function.ldap-modify-batch.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-modify-batch" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-modify-batch-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_modify_batch</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$dn</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$modifications_info</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.array.php" class="type array">array</a></span></span> <code class="parameter">$controls</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
     ...
     <dd>
      ...
      <p class="para">
       ...
       <dl>
         ...
         <dt><strong><code><a href="ldap.constants.php#constant.ldap-modify-batch-add">LDAP_MODIFY_BATCH_ADD</a></code></strong></dt>
         <dd>
          <p class="para">
         ...
         <dt><strong><code><a href="ldap.constants.php#constant.ldap-modify-batch-remove">LDAP_MODIFY_BATCH_REMOVE</a></code></strong></dt>
         <dd>
          <p class="para">
         ...
         <dt><strong><code><a href="ldap.constants.php#constant.ldap-modify-batch-remove-all">LDAP_MODIFY_BATCH_REMOVE_ALL</a></code></strong></dt>
         <dd>
          <p class="para">
         ...
         <dt><strong><code><a href="ldap.constants.php#constant.ldap-modify-batch-replace">LDAP_MODIFY_BATCH_REPLACE</a></code></strong></dt>
         <dd>
          <p class="para">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$dn </span><span style="color: #007700">= </span><span style="color: #DD0000">"cn=Jack Smith-Jones,ou=Wizards,dc=example,dc=com"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$modifs </span><span style="color: #007700">= [<br />    [<br />        </span><span style="color: #DD0000">"attrib"  </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">"userPassword"</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">"modtype" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">LDAP_MODIFY_BATCH_REMOVE</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">"values"  </span><span style="color: #007700">=&gt; [</span><span style="color: #DD0000">"Tr0ub4dor&amp;3"</span><span style="color: #007700">],<br />    ],<br />    [<br />        </span><span style="color: #DD0000">"attrib"  </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">"userPassword"</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">"modtype" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">LDAP_MODIFY_BATCH_ADD</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">"values"  </span><span style="color: #007700">=&gt; [</span><span style="color: #DD0000">"correct horse battery staple"</span><span style="color: #007700">],<br />    ],<br />];<br /></span><span style="color: #0000BB">ldap_modify_batch</span><span style="color: #007700">(</span><span style="color: #0000BB">$connection</span><span style="color: #007700">, </span><span style="color: #0000BB">$dn</span><span style="color: #007700">, </span><span style="color: #0000BB">$modifs</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   ...
   <div class="example" id="example-4643">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">adifyPw</span><span style="color: #007700">(</span><span style="color: #0000BB">$pw</span><span style="color: #007700">)<br />{<br />    return </span><span style="color: #0000BB">iconv</span><span style="color: #007700">(</span><span style="color: #DD0000">"UTF-8"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UTF-16LE"</span><span style="color: #007700">, </span><span style="color: #DD0000">'"' </span><span style="color: #007700">. </span><span style="color: #0000BB">$pw </span><span style="color: #007700">. </span><span style="color: #DD0000">'"'</span><span style="color: #007700">);<br />}<br /><br /></span><span style="color: #0000BB">$dn </span><span style="color: #007700">= </span><span style="color: #DD0000">"cn=Jack Smith-Jones,ou=Wizards,dc=ad,dc=example,dc=com"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$modifs </span><span style="color: #007700">= [<br />    [<br />        </span><span style="color: #DD0000">"attrib"  </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">"unicodePwd"</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">"modtype" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">LDAP_MODIFY_BATCH_REMOVE</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">"values"  </span><span style="color: #007700">=&gt; [</span><span style="color: #0000BB">adifyPw</span><span style="color: #007700">(</span><span style="color: #DD0000">"Tr0ub4dor&amp;3"</span><span style="color: #007700">)],<br />    ],<br />    [<br />        </span><span style="color: #DD0000">"attrib"  </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">"unicodePwd"</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">"modtype" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">LDAP_MODIFY_BATCH_ADD</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">"values"  </span><span style="color: #007700">=&gt; [</span><span style="color: #0000BB">adifyPw</span><span style="color: #007700">(</span><span style="color: #DD0000">"correct horse battery staple"</span><span style="color: #007700">)],<br />    ],<br />];<br /></span><span style="color: #0000BB">ldap_modify_batch</span><span style="color: #007700">(</span><span style="color: #0000BB">$connection</span><span style="color: #007700">, </span><span style="color: #0000BB">$dn</span><span style="color: #007700">, </span><span style="color: #0000BB">$modifs</span><span style="color: #007700">);</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-modify-batch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-modify-batch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-modify-batch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-modify-batch.php">＋<small>add a note</small></a></span>
