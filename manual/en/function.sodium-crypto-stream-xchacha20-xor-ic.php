...
<head>
  ...
  <title>PHP: sodium_crypto_stream_xchacha20_xor_ic - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20-xor-ic.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-stream-xchacha20-xor-ic">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-stream-xchacha20-xor-ic" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20-xor.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20-xor-ic.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-stream-xchacha20-xor-ic.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-stream-xchacha20-xor-ic.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-stream-xchacha20-xor-ic.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-stream-xchacha20-xor-ic.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-stream-xchacha20-xor-ic.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-stream-xchacha20-xor-ic.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-stream-xchacha20-xor-ic.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-stream-xchacha20-xor-ic.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-stream-xchacha20-xor-ic.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-stream-xchacha20-xor-ic.php" hreflang="zh">
...
<meta name="Description" content="Encrypts a message using a nonce and a secret key (no authentication)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_stream_xchacha20_xor_ic - Manual" />
<meta name="twitter:description" content="Encrypts a message using a nonce and a secret key (no authentication)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_stream_xchacha20_xor_ic - Manual" />
<meta itemprop="description" content="Encrypts a message using a nonce and a secret key (no authentication)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Encrypts a message using a nonce and a secret key (no authentication)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-stream-xor.php">
          sodium_crypto_stream_xor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-stream-xchacha20-xor.php">
          &laquo; sodium_crypto_stream_xchacha20_xor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-stream-xchacha20-xor-ic.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-stream-xchacha20-xor-ic.php'>German</option>
            <option value='es/function.sodium-crypto-stream-xchacha20-xor-ic.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-stream-xchacha20-xor-ic.php'>French</option>
            <option value='it/function.sodium-crypto-stream-xchacha20-xor-ic.php'>Italian</option>
            <option value='ja/function.sodium-crypto-stream-xchacha20-xor-ic.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-stream-xchacha20-xor-ic.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-stream-xchacha20-xor-ic.php'>Russian</option>
            <option value='tr/function.sodium-crypto-stream-xchacha20-xor-ic.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-stream-xchacha20-xor-ic.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-stream-xchacha20-xor-ic.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-stream-xchacha20-xor-ic" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-stream-xchacha20-xor-ic-returnvalues">
  ...
  <p class="para">
   Encrypted message,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.sodium-crypto-stream-xchacha20-xor-ic-examples">
  ...
  <div class="example" id="example-1086">
   <p><strong>Example #1 <span class="function"><strong>sodium_crypto_stream_xchacha20_xor_ic()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.sodium-crypto-stream-xchacha20-xor.php" class="function" rel="rdfs-seeAlso">sodium_crypto_stream_xchacha20_xor()</a> - Encrypts a message using a nonce and a secret key (no authentication)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-stream-xchacha20-xor-ic.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-stream-xchacha20-xor-ic%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-stream-xchacha20-xor-ic&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20-xor-ic.php">＋<small>add a note</small></a></span>
