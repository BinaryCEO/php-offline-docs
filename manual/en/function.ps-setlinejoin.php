...
<head>
  ...
  <title>PHP: ps_setlinejoin - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-setlinejoin.php">
 <link rel="shorturl" href="https://www.php.net/ps-setlinejoin">
 <link rel="alternate" href="https://www.php.net/ps-setlinejoin" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-setlinecap.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-setlinewidth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-setlinejoin.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-setlinejoin.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-setlinejoin.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-setlinejoin.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-setlinejoin.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-setlinejoin.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-setlinejoin.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-setlinejoin.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-setlinejoin.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-setlinejoin.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-setlinejoin.php" hreflang="zh">
...
<meta name="Description" content="Sets how contected lines are joined" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_setlinejoin - Manual" />
<meta name="twitter:description" content="Sets how contected lines are joined" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_setlinejoin - Manual" />
<meta itemprop="description" content="Sets how contected lines are joined" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets how contected lines are joined" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-setlinewidth.php">
          ps_setlinewidth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-setlinecap.php">
          &laquo; ps_setlinecap        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-setlinejoin.php' selected="selected">English</option>
            <option value='de/function.ps-setlinejoin.php'>German</option>
            <option value='es/function.ps-setlinejoin.php'>Spanish</option>
            <option value='fr/function.ps-setlinejoin.php'>French</option>
            <option value='it/function.ps-setlinejoin.php'>Italian</option>
            <option value='ja/function.ps-setlinejoin.php'>Japanese</option>
            <option value='pt_BR/function.ps-setlinejoin.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-setlinejoin.php'>Russian</option>
            <option value='tr/function.ps-setlinejoin.php'>Turkish</option>
            <option value='uk/function.ps-setlinejoin.php'>Ukrainian</option>
            <option value='zh/function.ps-setlinejoin.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-setlinejoin" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_setlinejoin</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_setlinejoin</span> &mdash; <span class="dc-title">Sets how contected lines are joined</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-setlinejoin-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_setlinejoin</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-setlinejoin-parameters">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <code class="literal">PS_LINEJOIN_MITER</code>,
       <code class="literal">PS_LINEJOIN_ROUND</code>, or
       <code class="literal">PS_LINEJOIN_BEVEL</code>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-setlinejoin-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-setlinejoin-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-setmiterlimit.php" class="function" rel="rdfs-seeAlso">ps_setmiterlimit()</a> - Sets the miter limit</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-setlinejoin.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-setlinejoin%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-setlinejoin&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-setlinejoin.php">＋<small>add a note</small></a></span>
