...
<head>
  ...
  <title>PHP: Gmagick::queryformats - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.queryformats.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.queryformats.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.queryformats.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.queryfonts.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.radialblurimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.queryformats.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.queryformats.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.queryformats.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.queryformats.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.queryformats.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.queryformats.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.queryformats.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.queryformats.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.queryformats.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.queryformats.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.queryformats.php" hreflang="zh">
...
<meta name="Description" content="Returns formats supported by Gmagick" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::queryformats - Manual" />
<meta name="twitter:description" content="Returns formats supported by Gmagick" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::queryformats - Manual" />
<meta itemprop="description" content="Returns formats supported by Gmagick" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns formats supported by Gmagick" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.radialblurimage.php">
          Gmagick::radialblurimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.queryfonts.php">
          &laquo; Gmagick::queryfonts        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.queryformats.php' selected="selected">English</option>
            <option value='de/gmagick.queryformats.php'>German</option>
            <option value='es/gmagick.queryformats.php'>Spanish</option>
            <option value='fr/gmagick.queryformats.php'>French</option>
            <option value='it/gmagick.queryformats.php'>Italian</option>
            <option value='ja/gmagick.queryformats.php'>Japanese</option>
            <option value='pt_BR/gmagick.queryformats.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.queryformats.php'>Russian</option>
            <option value='tr/gmagick.queryformats.php'>Turkish</option>
            <option value='uk/gmagick.queryformats.php'>Ukrainian</option>
            <option value='zh/gmagick.queryformats.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.queryformats" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::queryformats</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::queryformats</span> &mdash; <span class="dc-title">Returns formats supported by Gmagick</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.queryformats-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::queryformats</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pattern</code><span class="initializer"> = &quot;*&quot;</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   Returns formats supported by <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-gmagick.queryformats-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Specifies a <span class="type"><a href="language.types.string.php" class="type string">string</a></span> containing a pattern.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.queryformats-returnvalues">
  ...
  <div class="refsect1 errors" id="refsect1-gmagick.queryformats-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/queryformats.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.queryformats%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.queryformats&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.queryformats.php">＋<small>add a note</small></a></span>
