...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-last-notice.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-last-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-last-oid.php">
...
<meta name="Description" content="Returns the last notice message from PostgreSQL server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_last_notice - Manual" />
<meta name="twitter:description" content="Returns the last notice message from PostgreSQL server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_last_notice - Manual" />
<meta itemprop="description" content="Returns the last notice message from PostgreSQL server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the last notice message from PostgreSQL server" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-last-notice.php' selected="selected">English</option>
            <option value='de/function.pg-last-notice.php'>German</option>
            <option value='es/function.pg-last-notice.php'>Spanish</option>
            <option value='fr/function.pg-last-notice.php'>French</option>
 ...
 <div class="refsect1 parameters" id="refsect1-function.pg-last-notice-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       One of <strong><code><a href="pgsql.constants.php#constant.pgsql-notice-last">PGSQL_NOTICE_LAST</a></code></strong> (to return last notice),
       <strong><code><a href="pgsql.constants.php#constant.pgsql-notice-all">PGSQL_NOTICE_ALL</a></code></strong> (to return all notices),
       or <strong><code><a href="pgsql.constants.php#constant.pgsql-notice-clear">PGSQL_NOTICE_CLEAR</a></code></strong> (to clear notices).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-last-notice-returnvalues">
  ...
  <p class="para">
   A <span class="type"><a href="language.types.string.php" class="type string">string</a></span> containing the last notice on the 
   ...
   an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> with <strong><code><a href="pgsql.constants.php#constant.pgsql-notice-all">PGSQL_NOTICE_ALL</a></code></strong>,
   a <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> with <strong><code><a href="pgsql.constants.php#constant.pgsql-notice-clear">PGSQL_NOTICE_CLEAR</a></code></strong>.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-last-error.php" class="function" rel="rdfs-seeAlso">pg_last_error()</a> - Get the last error message string of a connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-last-notice.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-last-notice%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-last-notice&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-last-notice.php">＋<small>add a note</small></a></span>
