...
<head>
  ...
  <title>PHP: ZipArchive::isEncryptionMethodSupported - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.isencryptionmethoddupported.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.isencryptionmethoddupported.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.isencryptionmethoddupported.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.iscompressionmethoddupported.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.locatename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.isencryptionmethoddupported.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.isencryptionmethoddupported.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.isencryptionmethoddupported.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.isencryptionmethoddupported.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.isencryptionmethoddupported.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.isencryptionmethoddupported.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.isencryptionmethoddupported.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.isencryptionmethoddupported.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.isencryptionmethoddupported.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.isencryptionmethoddupported.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.isencryptionmethoddupported.php" hreflang="zh">
...
<meta name="Description" content="Check if a encryption method is supported by libzip" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::isEncryptionMethodSupported - Manual" />
<meta name="twitter:description" content="Check if a encryption method is supported by libzip" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::isEncryptionMethodSupported - Manual" />
<meta itemprop="description" content="Check if a encryption method is supported by libzip" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if a encryption method is supported by libzip" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.locatename.php">
          ZipArchive::locateName &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.iscompressionmethoddupported.php">
          &laquo; ZipArchive::isCompressionMethodSupported        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.isencryptionmethoddupported.php' selected="selected">English</option>
            <option value='de/ziparchive.isencryptionmethoddupported.php'>German</option>
            <option value='es/ziparchive.isencryptionmethoddupported.php'>Spanish</option>
            <option value='fr/ziparchive.isencryptionmethoddupported.php'>French</option>
            <option value='it/ziparchive.isencryptionmethoddupported.php'>Italian</option>
            <option value='ja/ziparchive.isencryptionmethoddupported.php'>Japanese</option>
            <option value='pt_BR/ziparchive.isencryptionmethoddupported.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.isencryptionmethoddupported.php'>Russian</option>
            <option value='tr/ziparchive.isencryptionmethoddupported.php'>Turkish</option>
            <option value='uk/ziparchive.isencryptionmethoddupported.php'>Ukrainian</option>
            <option value='zh/ziparchive.isencryptionmethoddupported.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.isencryptionmethoddupported" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="ziparchive.setencryptionname.php" class="methodname" rel="rdfs-seeAlso">ZipArchive::setEncryptionName()</a> - Set the encryption method of an entry defined by its name</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/isencryptionmethoddupported.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.isencryptionmethoddupported%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.isencryptionmethoddupported&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.isencryptionmethoddupported.php">＋<small>add a note</small></a></span>
