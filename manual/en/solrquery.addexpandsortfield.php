...
<head>
  ...
  <title>PHP: SolrQuery::addExpandSortField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addexpandsortfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addexpandsortfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addexpandsortfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addexpandfilterquery.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addfacetdatefield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addexpandsortfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addexpandsortfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addexpandsortfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addexpandsortfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addexpandsortfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addexpandsortfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addexpandsortfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addexpandsortfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addexpandsortfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addexpandsortfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addexpandsortfield.php" hreflang="zh">
...
<meta name="Description" content="Orders the documents within the expanded groups (expand.sort parameter)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addExpandSortField - Manual" />
<meta name="twitter:description" content="Orders the documents within the expanded groups (expand.sort parameter)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addExpandSortField - Manual" />
<meta itemprop="description" content="Orders the documents within the expanded groups (expand.sort parameter)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Orders the documents within the expanded groups (expand.sort parameter)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.addfacetdatefield.php">
          SolrQuery::addFacetDateField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addexpandfilterquery.php">
          &laquo; SolrQuery::addExpandFilterQuery        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addexpandsortfield.php' selected="selected">English</option>
            <option value='de/solrquery.addexpandsortfield.php'>German</option>
            <option value='es/solrquery.addexpandsortfield.php'>Spanish</option>
            <option value='fr/solrquery.addexpandsortfield.php'>French</option>
            <option value='it/solrquery.addexpandsortfield.php'>Italian</option>
            <option value='ja/solrquery.addexpandsortfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.addexpandsortfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addexpandsortfield.php'>Russian</option>
            <option value='tr/solrquery.addexpandsortfield.php'>Turkish</option>
            <option value='uk/solrquery.addexpandsortfield.php'>Ukrainian</option>
            <option value='zh/solrquery.addexpandsortfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addexpandsortfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addExpandSortField</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::addExpandSortField</span> &mdash; <span class="dc-title">Orders the documents within the expanded groups (expand.sort parameter)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addexpandsortfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addExpandSortField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$order</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.addexpandsortfield-parameters">
  ...
  <dl>
    ...
    <dd>
     ...
     <p class="para">
         Default: <span class="type">SolrQuery::ORDER_DESC</span>
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addexpandsortfield-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.addexpandsortfield-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.setexpandquery.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setExpandQuery()</a> - Sets the expand.q parameter</span></li>
   ...
   <li><span class="methodname"><a href="solrquery.removeexpandfilterquery.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::removeExpandFilterQuery()</a> - Removes an expand filter query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addexpandsortfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addexpandsortfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addexpandsortfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addexpandsortfield.php">＋<small>add a note</small></a></span>
