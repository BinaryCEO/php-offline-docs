...
<head>
  ...
  <title>PHP: UI\Controls\Picker - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-controls-picker.php">
 <link rel="shorturl" href="https://www.php.net/ui-controls-picker">
 <link rel="alternate" href="https://www.php.net/ui-controls-picker" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-controls-radio.setselected.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-controls-picker.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-controls-picker.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-controls-picker.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-controls-picker.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-controls-picker.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-controls-picker.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-controls-picker.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-controls-picker.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-controls-picker.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-controls-picker.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-controls-picker.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-controls-picker.php" hreflang="zh">
...
<meta name="Description" content="Picker Control" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Controls\Picker - Manual" />
<meta name="twitter:description" content="Picker Control" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Controls\Picker - Manual" />
<meta itemprop="description" content="Picker Control" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Picker Control" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ui-controls-picker.construct.php">
          UI\Controls\Picker::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-controls-radio.setselected.php">
          &laquo; UI\Controls\Radio::setSelected        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-controls-picker.php' selected="selected">English</option>
            <option value='de/class.ui-controls-picker.php'>German</option>
            <option value='es/class.ui-controls-picker.php'>Spanish</option>
            <option value='fr/class.ui-controls-picker.php'>French</option>
            <option value='it/class.ui-controls-picker.php'>Italian</option>
            <option value='ja/class.ui-controls-picker.php'>Japanese</option>
            <option value='pt_BR/class.ui-controls-picker.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-controls-picker.php'>Russian</option>
            <option value='tr/class.ui-controls-picker.php'>Turkish</option>
            <option value='uk/class.ui-controls-picker.php'>Ukrainian</option>
            <option value='zh/class.ui-controls-picker.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-controls-picker" class="reference">

 <h1 class="title">Picker Control</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-controls-picker.intro">
  ...
  <div class="section" id="ui-controls-picker.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Controls\Picker</strong>
     </span>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-controls-picker.php#ui-controls-picker.constants.date"><var class="varname">Date</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-controls-picker.php#ui-controls-picker.constants.time"><var class="varname">Time</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-controls-picker.php#ui-controls-picker.constants.datetime"><var class="varname">DateTime</var></a></var>;</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Constructor */</div>
    <div class="constructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><a href="ui-controls-picker.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code><span class="initializer"> = UI\Controls\Picker::Date</span></span>)</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-control.show.php" class="methodname">UI\Control::show</a></span>()</div>
  ...
  <div class="section" id="ui-controls-picker.constants">
   <h2 class="title">Predefined Constants</h2>
   <dl>

    
     <dt id="ui-controls-picker.constants.date"><strong><code><a href="class.ui-controls-picker.php#ui-controls-picker.constants.date">UI\Controls\Picker::Date</a></code></strong></dt>
     <dd>
      <p class="para">A Date Picker</p>
     </dd>
    

    
     <dt id="ui-controls-picker.constants.time"><strong><code><a href="class.ui-controls-picker.php#ui-controls-picker.constants.time">UI\Controls\Picker::Time</a></code></strong></dt>
     <dd>
      <p class="para">A Time Picker</p>
     </dd>
    

    
     <dt id="ui-controls-picker.constants.datetime"><strong><code><a href="class.ui-controls-picker.php#ui-controls-picker.constants.datetime">UI\Controls\Picker::DateTime</a></code></strong></dt>
     <dd>
      <p class="para">A Date and Time Picker</p>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-controls-picker.construct.php">UI\Controls\Picker::__construct</a> — Construct a new Picker</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.controls.picker.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-controls-picker%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-controls-picker&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-controls-picker.php">＋<small>add a note</small></a></span>
