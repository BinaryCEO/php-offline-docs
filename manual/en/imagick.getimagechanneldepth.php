...
<head>
  ...
  <title>PHP: Imagick::getImageChannelDepth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagechanneldepth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagechanneldepth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagechanneldepth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagebordercolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagechanneldistortion.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagechanneldepth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagechanneldepth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagechanneldepth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagechanneldepth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagechanneldepth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagechanneldepth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagechanneldepth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagechanneldepth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagechanneldepth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagechanneldepth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagechanneldepth.php" hreflang="zh">
...
<meta name="Description" content="Gets the depth for a particular image channel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageChannelDepth - Manual" />
<meta name="twitter:description" content="Gets the depth for a particular image channel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageChannelDepth - Manual" />
<meta itemprop="description" content="Gets the depth for a particular image channel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the depth for a particular image channel" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagechanneldistortion.php">
          Imagick::getImageChannelDistortion &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagebordercolor.php">
          &laquo; Imagick::getImageBorderColor        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagechanneldepth.php' selected="selected">English</option>
            <option value='de/imagick.getimagechanneldepth.php'>German</option>
            <option value='es/imagick.getimagechanneldepth.php'>Spanish</option>
            <option value='fr/imagick.getimagechanneldepth.php'>French</option>
            <option value='it/imagick.getimagechanneldepth.php'>Italian</option>
            <option value='ja/imagick.getimagechanneldepth.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagechanneldepth.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagechanneldepth.php'>Russian</option>
            <option value='tr/imagick.getimagechanneldepth.php'>Turkish</option>
            <option value='uk/imagick.getimagechanneldepth.php'>Ukrainian</option>
            <option value='zh/imagick.getimagechanneldepth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagechanneldepth" class="refentry">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagechanneldepth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagechanneldepth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagechanneldepth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagechanneldepth.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108556">  <div class="votes">
    <div id="Vu108556">
    <a href="/manual/vote-note.php?id=108556&amp;page=imagick.getimagechanneldepth&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108556">
    <a href="/manual/vote-note.php?id=108556&amp;page=imagick.getimagechanneldepth&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108556" title="100% like this...">
    1
    </div>
  </div>
  <a href="#108556" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108556"> &para;</a><div class="date" title="2012-05-06 11:48"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108556">
<div class="phpcode"><code><span class="html">For undocumented functions, this is a particular oddity.  For me, this function has so far returned only two values for any particular image: 1 and 8.  And, after experimenting with it about forty or fifty times, I think I understand how it works, based simply on my experience.<br /><br />The value returned is the number of bits used for the particular color channel within an image.  That means how variable a particular color is within an image.  While I received 1 and 8, it could theoretically be as much as 16 or 32, depending on how the technology evolves over, say, the next decade or so.<br /><br />To best understand this function, you should probably also understand the ImageMagick function getColorValue.  In terms of the ImageMagick class, a color can be measured between 0 and 1, in terms in of a particular pixel.  Red, Green, Blue, or, any particular color of any color scheme, can be something like 0.501960784314.  But, since each pixel is a combination of the three colors, you can have 0.845 for red, 0.254 for green, and 0.11 for blue.<br /><br />How does this all tie in with the getChannelDepth function?  Easy.  If all of the pixels in an image are either values 1 or values 0 for the particular Red/Green/Blue values, then this function will return a 1 for 1 bits per pixel for that color channel.  If, however, any single pixel in the image for the inputted channel parameter isn't exactly 1 or 0 for the particular color channel, then this function will return an 8 for 8-bit colors per pixel for that color channel.<br /><br />If you receive back a 1 for every single color channel put in the parameter, that means you're dealing with an image that's 16-bit -- you know, like those computer games published in 1982, or the Atari console games.  You won't ever forget a 16-bit color green, trust me.  If you get back an 8 for every single color channel put in the parameter, that means you're dealing with any standard, modern image.<br /><br />You can input any color channel, based on the channel constants available within the ImageMagick class.  See them here: <a href="http://www.php.net/manual/en/imagick.constants.php#imagick.constants.channel" rel="nofollow" target="_blank">http://www.php.net/manual/en/imagick.constants.php#imagick.constants.channel</a> .  That means a format like imagick::CHANNEL_UNDEFINED, but with the "_UNDEFINED" value being anything here: undefined, red, gray, cyan, green, magenta, blue, yellow, alpha, opacity, matte, black, index, all, and default.<br /><br />For any image with one pixel color of RGB value 1 / 0.501960784314 / 0.501960784314 (#FF8080), you get this result:<br /><br />Channel - 'Undefined' :        1<br />Channel - 'Red' :     1<br />Channel - 'Gray' :     1<br />Channel - 'Cyan' :     1<br />Channel - 'Green' :     8<br />Channel - 'Magenta' :     8<br />Channel - 'Blue' :     8<br />Channel - 'Yellow' :     8<br />Channel - 'Alpha' :     1<br />Channel - 'Opacity' :     1<br />Channel - 'Matte' :     1<br />Channel - 'Black' :     1<br />Channel - 'Index' :     1<br />Channel - 'All' :     8<br />Channel - 'Default' :     8<br /><br />If all colors are between 0 and 1 with getColorValue function, each of these results with be 1.  If you're dealing with an image that has full color spectrum depth (almost any given photograph), you'll get 8 for red, gray, cyan, green, magenta, blue, yellow, all, and default, with a 1 for the other remaining channels.  Perhaps some use for automated image editing, like use with posterize or oilpaint functions.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagechanneldepth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagechanneldepth.php">＋<small>add a note</small></a></div>
