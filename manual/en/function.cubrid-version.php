...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-version.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-set-query-timeout.php">
 <link rel="next" href="https://www.php.net/manual/en/cubridmysql.cubrid.php">
...
<meta name="Description" content="Get the CUBRID PHP module's version" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_version - Manual" />
<meta name="twitter:description" content="Get the CUBRID PHP module's version" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_version - Manual" />
<meta itemprop="description" content="Get the CUBRID PHP module's version" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the CUBRID PHP module's version" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="cubridmysql.cubrid.php">
          CUBRID MySQL Compatibility Functions &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-version.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.cubrid-version.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_version</span> &mdash; <span class="dc-title">Get the CUBRID PHP module&#039;s version</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-version-description">
  ...
  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_version()</strong></span> function is used to get the CUBRID
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-version-examples">
  ...
  <div class="example" id="example-1279">
   <p><strong>Example #1 <span class="function"><strong>cubrid_version()</strong></span> example</strong></p>
   ...
   <ul class="simplelist"> 
    ...
    <li><span class="function"><a href="function.cubrid-error-code-facility.php" class="function" rel="rdfs-seeAlso">cubrid_error_code_facility()</a> - Get the facility code of error</span></li>     
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-version.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-version%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-version&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-version.php">＋<small>add a note</small></a></span>
