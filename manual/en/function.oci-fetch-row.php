...
<head>
  ...
  <title>PHP: oci_fetch_row - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-fetch-row.php">
 <link rel="shorturl" href="https://www.php.net/oci-fetch-row">
 <link rel="alternate" href="https://www.php.net/oci-fetch-row" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-fetch-object.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-field-is-null.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-fetch-row.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-fetch-row.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-fetch-row.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-fetch-row.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-fetch-row.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-fetch-row.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-fetch-row.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-fetch-row.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-fetch-row.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-fetch-row.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-fetch-row.php" hreflang="zh">
...
<meta name="Description" content="Returns the next row from a query as a numeric array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_fetch_row - Manual" />
<meta name="twitter:description" content="Returns the next row from a query as a numeric array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_fetch_row - Manual" />
<meta itemprop="description" content="Returns the next row from a query as a numeric array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the next row from a query as a numeric array" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.oci-field-is-null.php">
          oci_field_is_null &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-fetch-object.php">
          &laquo; oci_fetch_object        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-fetch-row.php' selected="selected">English</option>
            <option value='de/function.oci-fetch-row.php'>German</option>
            <option value='es/function.oci-fetch-row.php'>Spanish</option>
            <option value='fr/function.oci-fetch-row.php'>French</option>
            <option value='it/function.oci-fetch-row.php'>Italian</option>
            <option value='ja/function.oci-fetch-row.php'>Japanese</option>
            <option value='pt_BR/function.oci-fetch-row.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-fetch-row.php'>Russian</option>
            <option value='tr/function.oci-fetch-row.php'>Turkish</option>
            <option value='uk/function.oci-fetch-row.php'>Ukrainian</option>
            <option value='zh/function.oci-fetch-row.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-fetch-row" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">oci_fetch_row</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">oci_fetch_row</span> &mdash; <span class="dc-title">Returns the next row from a query as a numeric array</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.oci-fetch-row-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>oci_fetch_row</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$statement</code></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  <p class="para">
   ...
   with <strong><code><a href="oci8.constants.php#constant.oci-num">OCI_NUM</a></code></strong>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.oci-fetch-object.php" class="function" rel="rdfs-seeAlso">oci_fetch_object()</a> - Returns the next row from a query as an object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-fetch-row.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-fetch-row%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-fetch-row&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-fetch-row.php">＋<small>add a note</small></a></span>
