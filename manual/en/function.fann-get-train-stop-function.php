...
<head>
  ...
  <title>PHP: fann_get_train_stop_function - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-train-stop-function.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-train-stop-function">
 <link rel="alternate" href="https://www.php.net/fann-get-train-stop-function" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-train-error-function.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-training-algorithm.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-train-stop-function.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-train-stop-function.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-train-stop-function.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-train-stop-function.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-train-stop-function.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-train-stop-function.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-train-stop-function.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-train-stop-function.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-train-stop-function.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-train-stop-function.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-train-stop-function.php" hreflang="zh">
...
<meta name="Description" content="Returns the stop function used during training" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_train_stop_function - Manual" />
<meta name="twitter:description" content="Returns the stop function used during training" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_train_stop_function - Manual" />
<meta itemprop="description" content="Returns the stop function used during training" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the stop function used during training" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-get-training-algorithm.php">
          fann_get_training_algorithm &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-train-error-function.php">
          &laquo; fann_get_train_error_function        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-train-stop-function.php' selected="selected">English</option>
            <option value='de/function.fann-get-train-stop-function.php'>German</option>
            <option value='es/function.fann-get-train-stop-function.php'>Spanish</option>
            <option value='fr/function.fann-get-train-stop-function.php'>French</option>
            <option value='it/function.fann-get-train-stop-function.php'>Italian</option>
            <option value='ja/function.fann-get-train-stop-function.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-train-stop-function.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-train-stop-function.php'>Russian</option>
            <option value='tr/function.fann-get-train-stop-function.php'>Turkish</option>
            <option value='uk/function.fann-get-train-stop-function.php'>Ukrainian</option>
            <option value='zh/function.fann-get-train-stop-function.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-train-stop-function" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_get_train_stop_function</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_get_train_stop_function</span> &mdash; <span class="dc-title">Returns the stop function used during training</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-get-train-stop-function-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_get_train_stop_function</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
  ...
  <p class="para">
   The default stop function is <strong><code><a href="fann.constants.php#constant.fann-stopfunc-mse">FANN_STOPFUNC_MSE</a></code></strong>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fann-get-train-stop-function-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-train-stop-function-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The <a href="fann.constants.php#constants.fann-stopfunc" class="link">stop function</a> constant, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fann-get-train-stop-function-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-set-train-stop-function.php" class="function" rel="rdfs-seeAlso">fann_set_train_stop_function()</a> - Sets the stop function used during training</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-train-stop-function.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-train-stop-function%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-train-stop-function&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-train-stop-function.php">＋<small>add a note</small></a></span>
