...
<head>
  ...
  <title>PHP: ImagickDraw::pathLineToAbsolute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pathlinetoabsolute.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pathlinetoabsolute.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathlinetoabsolute.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pathfinish.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pathlinetohorizontalabsolute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathlinetoabsolute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pathlinetoabsolute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pathlinetoabsolute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pathlinetoabsolute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pathlinetoabsolute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pathlinetoabsolute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pathlinetoabsolute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pathlinetoabsolute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pathlinetoabsolute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pathlinetoabsolute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pathlinetoabsolute.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::pathLineToAbsolute - Manual" />
<meta name="twitter:description" content="Draws a line path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pathLineToAbsolute - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.pathlinetohorizontalabsolute.php">
          ImagickDraw::pathLineToHorizontalAbsolute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pathfinish.php">
          &laquo; ImagickDraw::pathFinish        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pathlinetoabsolute.php' selected="selected">English</option>
            <option value='de/imagickdraw.pathlinetoabsolute.php'>German</option>
            <option value='es/imagickdraw.pathlinetoabsolute.php'>Spanish</option>
            <option value='fr/imagickdraw.pathlinetoabsolute.php'>French</option>
            <option value='it/imagickdraw.pathlinetoabsolute.php'>Italian</option>
            <option value='ja/imagickdraw.pathlinetoabsolute.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pathlinetoabsolute.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pathlinetoabsolute.php'>Russian</option>
            <option value='tr/imagickdraw.pathlinetoabsolute.php'>Turkish</option>
            <option value='uk/imagickdraw.pathlinetoabsolute.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pathlinetoabsolute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pathlinetoabsolute" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pathLineToAbsolute</h1>
  <p class="verinfo">(PECL imagick 2)</p><p class="refpurpose"><span class="refname">ImagickDraw::pathLineToAbsolute</span> &mdash; <span class="dc-title">Draws a line path</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.pathlinetoabsolute-description">
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.pathlinetoabsolute-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.pathlinetoabsolute-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pathlinetoabsolute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pathlinetoabsolute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pathlinetoabsolute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pathlinetoabsolute.php">＋<small>add a note</small></a></span>
