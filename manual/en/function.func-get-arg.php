...
<head>
  ...
  <title>PHP: func_get_arg - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.func-get-arg.php">
 <link rel="shorturl" href="https://www.php.net/func-get-arg">
 <link rel="alternate" href="https://www.php.net/func-get-arg" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.funchand.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.forward-static-call-array.php">
 <link rel="next" href="https://www.php.net/manual/en/function.func-get-args.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.func-get-arg.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.func-get-arg.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.func-get-arg.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.func-get-arg.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.func-get-arg.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.func-get-arg.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.func-get-arg.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.func-get-arg.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.func-get-arg.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.func-get-arg.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.func-get-arg.php" hreflang="zh">
...
<meta name="Description" content="Return an item from the argument list" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: func_get_arg - Manual" />
<meta name="twitter:description" content="Return an item from the argument list" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: func_get_arg - Manual" />
<meta itemprop="description" content="Return an item from the argument list" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return an item from the argument list" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.forward-static-call-array.php">
          &laquo; forward_static_call_array        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.func-get-arg.php' selected="selected">English</option>
            <option value='de/function.func-get-arg.php'>German</option>
            <option value='es/function.func-get-arg.php'>Spanish</option>
            <option value='fr/function.func-get-arg.php'>French</option>
            <option value='it/function.func-get-arg.php'>Italian</option>
            <option value='ja/function.func-get-arg.php'>Japanese</option>
            <option value='pt_BR/function.func-get-arg.php'>Brazilian Portuguese</option>
            <option value='ru/function.func-get-arg.php'>Russian</option>
            <option value='tr/function.func-get-arg.php'>Turkish</option>
            <option value='uk/function.func-get-arg.php'>Ukrainian</option>
            <option value='zh/function.func-get-arg.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.func-get-arg" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.func-num-args.php" class="function" rel="rdfs-seeAlso">func_num_args()</a> - Returns the number of arguments passed to the function</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/funchand/functions/func-get-arg.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.func-get-arg%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.func-get-arg&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.func-get-arg.php">＋<small>add a note</small></a></span>
