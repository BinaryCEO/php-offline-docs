...
<head>
  ...
  <title>PHP: stream_get_transports - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-get-transports.php">
 <link rel="shorturl" href="https://www.php.net/stream-get-transports">
 <link rel="alternate" href="https://www.php.net/stream-get-transports" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-get-meta-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-get-wrappers.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-get-transports.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-get-transports.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-get-transports.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-get-transports.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-get-transports.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-get-transports.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-get-transports.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-get-transports.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-get-transports.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-get-transports.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-get-transports.php" hreflang="zh">
...
<meta name="Description" content="Retrieve list of registered socket transports" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_get_transports - Manual" />
<meta name="twitter:description" content="Retrieve list of registered socket transports" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_get_transports - Manual" />
<meta itemprop="description" content="Retrieve list of registered socket transports" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve list of registered socket transports" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stream-get-wrappers.php">
          stream_get_wrappers &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-get-meta-data.php">
          &laquo; stream_get_meta_data        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-get-transports.php' selected="selected">English</option>
            <option value='de/function.stream-get-transports.php'>German</option>
            <option value='es/function.stream-get-transports.php'>Spanish</option>
            <option value='fr/function.stream-get-transports.php'>French</option>
            <option value='it/function.stream-get-transports.php'>Italian</option>
            <option value='ja/function.stream-get-transports.php'>Japanese</option>
            <option value='pt_BR/function.stream-get-transports.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-get-transports.php'>Russian</option>
            <option value='tr/function.stream-get-transports.php'>Turkish</option>
            <option value='uk/function.stream-get-transports.php'>Ukrainian</option>
            <option value='zh/function.stream-get-transports.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-get-transports" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stream_get_transports</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_get_transports</span> &mdash; <span class="dc-title">Retrieve list of registered socket transports</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stream-get-transports-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stream_get_transports</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stream-get-transports-parameters">
 ...
 <div class="refsect1 examples" id="refsect1-function.stream-get-transports-examples">
  ...
  <p class="para">
   <div class="example" id="example-4059">
    <p><strong>Example #1 Using <span class="function"><strong>stream_get_transports()</strong></span></strong></p>
...
<div class="examplescode"><pre class="examplescode">Array (
 ...
 <div class="refsect1 seealso" id="refsect1-function.stream-get-transports-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.stream-get-wrappers.php" class="function" rel="rdfs-seeAlso">stream_get_wrappers()</a> - Retrieve list of registered streams</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-get-transports.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-get-transports%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-get-transports&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-get-transports.php">＋<small>add a note</small></a></span>
