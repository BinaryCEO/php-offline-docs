...
<head>
  ...
  <title>PHP: ocifetch - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocifetch.php">
 <link rel="shorturl" href="https://www.php.net/ocifetch">
 <link rel="alternate" href="https://www.php.net/ocifetch" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ociexecute.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocifetchinto.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocifetch.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocifetch.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocifetch.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocifetch.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocifetch.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocifetch.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocifetch.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocifetch.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocifetch.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocifetch.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocifetch.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_fetch" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocifetch - Manual" />
<meta name="twitter:description" content="Alias of oci_fetch" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocifetch - Manual" />
<meta itemprop="description" content="Alias of oci_fetch" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_fetch" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocifetch.php' selected="selected">English</option>
            <option value='de/function.ocifetch.php'>German</option>
            <option value='es/function.ocifetch.php'>Spanish</option>
            <option value='fr/function.ocifetch.php'>French</option>
            <option value='it/function.ocifetch.php'>Italian</option>
            <option value='ja/function.ocifetch.php'>Japanese</option>
            <option value='pt_BR/function.ocifetch.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocifetch.php'>Russian</option>
            <option value='tr/function.ocifetch.php'>Turkish</option>
            <option value='uk/function.ocifetch.php'>Ukrainian</option>
            <option value='zh/function.ocifetch.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocifetch" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocifetch</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocifetch</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-fetch.php" class="function">oci_fetch()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocifetch-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-fetch.php" class="function">oci_fetch()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocifetch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocifetch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocifetch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocifetch.php">＋<small>add a note</small></a></span>
