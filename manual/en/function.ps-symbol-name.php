...
<head>
  ...
  <title>PHP: ps_symbol_name - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-symbol-name.php">
 <link rel="shorturl" href="https://www.php.net/ps-symbol-name">
 <link rel="alternate" href="https://www.php.net/ps-symbol-name" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-symbol.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-symbol-width.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-symbol-name.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-symbol-name.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-symbol-name.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-symbol-name.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-symbol-name.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-symbol-name.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-symbol-name.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-symbol-name.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-symbol-name.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-symbol-name.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-symbol-name.php" hreflang="zh">
...
<meta name="Description" content="Gets name of a glyph" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_symbol_name - Manual" />
<meta name="twitter:description" content="Gets name of a glyph" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_symbol_name - Manual" />
<meta itemprop="description" content="Gets name of a glyph" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets name of a glyph" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-symbol-name.php' selected="selected">English</option>
            <option value='de/function.ps-symbol-name.php'>German</option>
            <option value='es/function.ps-symbol-name.php'>Spanish</option>
            <option value='fr/function.ps-symbol-name.php'>French</option>
            <option value='it/function.ps-symbol-name.php'>Italian</option>
            <option value='ja/function.ps-symbol-name.php'>Japanese</option>
            <option value='pt_BR/function.ps-symbol-name.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-symbol-name.php'>Russian</option>
            <option value='tr/function.ps-symbol-name.php'>Turkish</option>
            <option value='uk/function.ps-symbol-name.php'>Ukrainian</option>
            <option value='zh/function.ps-symbol-name.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-symbol-name" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-symbol-width.php" class="function" rel="rdfs-seeAlso">ps_symbol_width()</a> - Gets width of a glyph</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-symbol-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-symbol-name%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-symbol-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-symbol-name.php">＋<small>add a note</small></a></span>
