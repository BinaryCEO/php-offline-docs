...
<head>
  ...
  <title>PHP: ImagickDraw::getStrokeDashArray - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getstrokedasharray.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getstrokedasharray.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokedasharray.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getstrokecolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getstrokedashoffset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokedasharray.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getstrokedasharray.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getstrokedasharray.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getstrokedasharray.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getstrokedasharray.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getstrokedasharray.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getstrokedasharray.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getstrokedasharray.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getstrokedasharray.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getstrokedasharray.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getstrokedasharray.php" hreflang="zh">
...
<meta name="Description" content="Returns an array representing the pattern of dashes and gaps used to stroke paths" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getStrokeDashArray - Manual" />
<meta name="twitter:description" content="Returns an array representing the pattern of dashes and gaps used to stroke paths" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getStrokeDashArray - Manual" />
<meta itemprop="description" content="Returns an array representing the pattern of dashes and gaps used to stroke paths" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array representing the pattern of dashes and gaps used to stroke paths" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.getstrokedashoffset.php">
          ImagickDraw::getStrokeDashOffset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getstrokecolor.php">
          &laquo; ImagickDraw::getStrokeColor        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getstrokedasharray.php' selected="selected">English</option>
            <option value='de/imagickdraw.getstrokedasharray.php'>German</option>
            <option value='es/imagickdraw.getstrokedasharray.php'>Spanish</option>
            <option value='fr/imagickdraw.getstrokedasharray.php'>French</option>
            <option value='it/imagickdraw.getstrokedasharray.php'>Italian</option>
            <option value='ja/imagickdraw.getstrokedasharray.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getstrokedasharray.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getstrokedasharray.php'>Russian</option>
            <option value='tr/imagickdraw.getstrokedasharray.php'>Turkish</option>
            <option value='uk/imagickdraw.getstrokedasharray.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getstrokedasharray.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getstrokedasharray" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getStrokeDashArray</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getStrokeDashArray</span> &mdash; <span class="dc-title">Returns an array representing the pattern of dashes and gaps used to stroke paths</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getstrokedasharray-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getStrokeDashArray</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getstrokedasharray-returnvalues">
  ...
  <p class="para">
   Returns an array on success and empty array if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getstrokedasharray.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getstrokedasharray%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getstrokedasharray&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getstrokedasharray.php">＋<small>add a note</small></a></span>
