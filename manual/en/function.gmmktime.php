...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmmktime.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.gmdate.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmstrftime.php">
...
<meta name="Description" content="Get Unix timestamp for a GMT date" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmmktime - Manual" />
<meta name="twitter:description" content="Get Unix timestamp for a GMT date" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmmktime - Manual" />
<meta itemprop="description" content="Get Unix timestamp for a GMT date" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get Unix timestamp for a GMT date" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmmktime.php' selected="selected">English</option>
            <option value='de/function.gmmktime.php'>German</option>
            <option value='es/function.gmmktime.php'>Spanish</option>
            <option value='fr/function.gmmktime.php'>French</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.time.php" class="function" rel="rdfs-seeAlso">time()</a> - Return current Unix timestamp</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/gmmktime.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmmktime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmmktime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmmktime.php">＋<small>add a note</small></a></span>
