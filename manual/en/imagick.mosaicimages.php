...
<head>
  ...
  <title>PHP: Imagick::mosaicImages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.mosaicimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.mosaicimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.mosaicimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.morphology.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.motionblurimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.mosaicimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.mosaicimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.mosaicimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.mosaicimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.mosaicimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.mosaicimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.mosaicimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.mosaicimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.mosaicimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.mosaicimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.mosaicimages.php" hreflang="zh">
...
<meta name="Description" content="Forms a mosaic from images" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::mosaicImages - Manual" />
<meta name="twitter:description" content="Forms a mosaic from images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::mosaicImages - Manual" />
<meta itemprop="description" content="Forms a mosaic from images" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Forms a mosaic from images" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.motionblurimage.php">
          Imagick::motionBlurImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.morphology.php">
          &laquo; Imagick::morphology        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.mosaicimages.php' selected="selected">English</option>
            <option value='de/imagick.mosaicimages.php'>German</option>
            <option value='es/imagick.mosaicimages.php'>Spanish</option>
            <option value='fr/imagick.mosaicimages.php'>French</option>
            <option value='it/imagick.mosaicimages.php'>Italian</option>
            <option value='ja/imagick.mosaicimages.php'>Japanese</option>
            <option value='pt_BR/imagick.mosaicimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.mosaicimages.php'>Russian</option>
            <option value='tr/imagick.mosaicimages.php'>Turkish</option>
            <option value='uk/imagick.mosaicimages.php'>Ukrainian</option>
            <option value='zh/imagick.mosaicimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.mosaicimages" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::mosaicImages</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::mosaicImages</span> &mdash; <span class="dc-title">Forms a mosaic from images</span></p>

 </div>

 <div id="imagick.mosaicimages-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.mosaicimages-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::mosaicImages</strong></span>(): <span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.mosaicimages-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.mosaicimages-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/mosaicimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.mosaicimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.mosaicimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.mosaicimages.php">＋<small>add a note</small></a></span>
