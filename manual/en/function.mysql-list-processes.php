...
<head>
  ...
  <title>PHP: mysql_list_processes - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-list-processes.php">
 <link rel="shorturl" href="https://www.php.net/mysql-list-processes">
 <link rel="alternate" href="https://www.php.net/mysql-list-processes" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-list-fields.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-list-tables.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-list-processes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-list-processes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-list-processes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-list-processes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-list-processes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-list-processes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-list-processes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-list-processes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-list-processes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-list-processes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-list-processes.php" hreflang="zh">
...
<meta name="Description" content="List MySQL processes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_list_processes - Manual" />
<meta name="twitter:description" content="List MySQL processes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_list_processes - Manual" />
<meta itemprop="description" content="List MySQL processes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="List MySQL processes" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-list-tables.php">
          mysql_list_tables &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-list-fields.php">
          &laquo; mysql_list_fields        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-list-processes.php' selected="selected">English</option>
            <option value='de/function.mysql-list-processes.php'>German</option>
            <option value='es/function.mysql-list-processes.php'>Spanish</option>
            <option value='fr/function.mysql-list-processes.php'>French</option>
            <option value='it/function.mysql-list-processes.php'>Italian</option>
            <option value='ja/function.mysql-list-processes.php'>Japanese</option>
            <option value='pt_BR/function.mysql-list-processes.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-list-processes.php'>Russian</option>
            <option value='tr/function.mysql-list-processes.php'>Turkish</option>
            <option value='uk/function.mysql-list-processes.php'>Ukrainian</option>
            <option value='zh/function.mysql-list-processes.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-list-processes" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_list_processes</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_list_processes</span> &mdash; <span class="dc-title">List MySQL processes</span></p>

 </div>

 <div id="function.mysql-list-processes-refsynopsisdiv">
...
Alternatives to this function include:</p>
 ...
 <div class="refsect1 description" id="refsect1-function.mysql-list-processes-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_list_processes</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$link_identifier</code><span class="initializer"> = NULL</span></span>): <span class="type"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mysql-list-processes-parameters">
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> level error is generated.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-list-processes-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-list-processes-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1913">
    <p><strong>Example #1 <span class="function"><strong>mysql_list_processes()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">1 localhost test Processlist 0
4 localhost mysql sleep 5</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mysql-list-processes-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-stat.php" class="function" rel="rdfs-seeAlso">mysql_stat()</a> - Get current system status</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-list-processes.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-list-processes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-list-processes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-list-processes.php">＋<small>add a note</small></a></span>
