...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagebackgroundcolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagebackgroundcolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagebackgroundcolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setfilename.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimageblueprimary.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagebackgroundcolor.php' selected="selected">English</option>
            <option value='de/gmagick.setimagebackgroundcolor.php'>German</option>
            <option value='es/gmagick.setimagebackgroundcolor.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimagebackgroundcolor</span> &mdash; <span class="dc-title">Sets the image background color</span></p>
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagebackgroundcolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagebackgroundcolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagebackgroundcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagebackgroundcolor.php">＋<small>add a note</small></a></span>
