...
<head>
  ...
  <title>PHP: db2_stmt_errormsg - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-stmt-errormsg.php">
 <link rel="shorturl" href="https://www.php.net/db2-stmt-errormsg">
 <link rel="alternate" href="https://www.php.net/db2-stmt-errormsg" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-stmt-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-table-privileges.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-stmt-errormsg.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-stmt-errormsg.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-stmt-errormsg.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-stmt-errormsg.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-stmt-errormsg.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-stmt-errormsg.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-stmt-errormsg.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-stmt-errormsg.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-stmt-errormsg.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-stmt-errormsg.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-stmt-errormsg.php" hreflang="zh">
...
<meta name="Description" content="Returns a string containing the last SQL statement error message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_stmt_errormsg - Manual" />
<meta name="twitter:description" content="Returns a string containing the last SQL statement error message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_stmt_errormsg - Manual" />
<meta itemprop="description" content="Returns a string containing the last SQL statement error message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a string containing the last SQL statement error message" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.db2-table-privileges.php">
          db2_table_privileges &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-stmt-error.php">
          &laquo; db2_stmt_error        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-stmt-errormsg.php' selected="selected">English</option>
            <option value='de/function.db2-stmt-errormsg.php'>German</option>
            <option value='es/function.db2-stmt-errormsg.php'>Spanish</option>
            <option value='fr/function.db2-stmt-errormsg.php'>French</option>
            <option value='it/function.db2-stmt-errormsg.php'>Italian</option>
            <option value='ja/function.db2-stmt-errormsg.php'>Japanese</option>
            <option value='pt_BR/function.db2-stmt-errormsg.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-stmt-errormsg.php'>Russian</option>
            <option value='tr/function.db2-stmt-errormsg.php'>Turkish</option>
            <option value='uk/function.db2-stmt-errormsg.php'>Ukrainian</option>
            <option value='zh/function.db2-stmt-errormsg.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-stmt-errormsg" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">db2_stmt_errormsg</h1>
  <p class="verinfo">(PECL ibm_db2 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">db2_stmt_errormsg</span> &mdash; <span class="dc-title">
   Returns a string containing the last SQL statement error message
  </span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.db2-stmt-errormsg-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_stmt_errormsg</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></span> <code class="parameter">$stmt</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
  ...
  <p class="para">
   ...
   <span class="function"><strong>db2_stmt_errormsg()</strong></span>, the driver returns the error
   message associated with the last attempt to return a statement resource,
   for example, from <span class="function"><a href="function.db2-prepare.php" class="function">db2_prepare()</a></span> or
   <span class="function"><a href="function.db2-exec.php" class="function">db2_exec()</a></span>.
  </p>

 </div>

 <div class="refsect1 parameters" id="refsect1-function.db2-stmt-errormsg-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-stmt-errormsg-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.db2-stmt-errormsg-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-stmt-error.php" class="function" rel="rdfs-seeAlso">db2_stmt_error()</a> - Returns a string containing the SQLSTATE returned by an SQL statement</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-stmt-errormsg.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-stmt-errormsg%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-stmt-errormsg&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-stmt-errormsg.php">＋<small>add a note</small></a></span>
