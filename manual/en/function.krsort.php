...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.krsort.php">
 <link rel="shorturl" href="https://www.php.net/krsort">
 <link rel="alternate" href="https://www.php.net/krsort" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.key-exists.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ksort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.krsort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.krsort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.krsort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.krsort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.krsort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.krsort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.krsort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.krsort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.krsort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.krsort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.krsort.php" hreflang="zh">
...
<meta name="Description" content="Sort an array by key in descending order" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: krsort - Manual" />
<meta name="twitter:description" content="Sort an array by key in descending order" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: krsort - Manual" />
<meta itemprop="description" content="Sort an array by key in descending order" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sort an array by key in descending order" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ksort.php">
          ksort &raquo;
              ...
              <div class="prev">
        <a href="function.key-exists.php">
          &laquo; key_exists        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.krsort.php' selected="selected">English</option>
            <option value='de/function.krsort.php'>German</option>
            <option value='es/function.krsort.php'>Spanish</option>
            <option value='fr/function.krsort.php'>French</option>
            <option value='it/function.krsort.php'>Italian</option>
            <option value='ja/function.krsort.php'>Japanese</option>
            <option value='pt_BR/function.krsort.php'>Brazilian Portuguese</option>
            <option value='ru/function.krsort.php'>Russian</option>
            <option value='tr/function.krsort.php'>Turkish</option>
            <option value='uk/function.krsort.php'>Ukrainian</option>
            <option value='zh/function.krsort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.krsort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">krsort</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">krsort</span> &mdash; <span class="dc-title">Sort an array by key in descending order</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.krsort-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>krsort</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter reference">&$array</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = <strong><code><a href="array.constants.php#constant.sort-regular">SORT_REGULAR</a></code></strong></span></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.krsort-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.krsort-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.krsort-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.krsort-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-5310">
    <p><strong>Example #1 <span class="function"><strong>krsort()</strong></span> example</strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">d = lemon
c = apple
b = banana
a = orange</pre>
</div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.krsort-seealso">
  ...
  <ul class="simplelist">
   ...
   <li>The <a href="array.sorting.php" class="link">comparison of array sorting functions</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/krsort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.krsort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.krsort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.krsort.php">＋<small>add a note</small></a></span>
