...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-schema.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-rollback.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-seq-drop.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-schema.php' selected="selected">English</option>
            ...
            <option value='zh/function.cubrid-schema.php'>Chinese (Simplified)</option>
...
<div class="refsect1 parameters" id="refsect1-function.cubrid-schema-parameters">
  ...
  <dd><p class="para">Schema data that you want to know.</p></dd>
   
   
  <dt><code class="parameter">class_name</code></dt>
  <dd><p class="para">Class you want to know the schema of.</p></dd>
   
   
  <dt><code class="parameter">attr_name</code></dt>
  <dd><p class="para">Attribute you want to know the schema of.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-schema-returnvalues">
  ...
  <p class="para">
    Array containing the schema information, when process is successful, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
  ...
  array(13) {
    ...
    string(1) &quot;0&quot;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-schema.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-schema%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-schema&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-schema.php">＋<small>add a note</small></a></span>
