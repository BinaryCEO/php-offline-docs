...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.session-gc.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.session-encode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.session-get-cookie-params.php">
...
<meta name="Description" content="Perform session data garbage collection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: session_gc - Manual" />
<meta name="twitter:description" content="Perform session data garbage collection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: session_gc - Manual" />
<meta itemprop="description" content="Perform session data garbage collection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Perform session data garbage collection" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.session-gc.php' selected="selected">English</option>
            <option value='de/function.session-gc.php'>German</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.session-gc-returnvalues">
  ...
  <p class="para">
   ...
   data for success, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> for failure.
  </p>
  <p class="para">
   ...
   <ul class="simplelist">
    ...
    <li><a href="session.configuration.php#ini.session.gc-probability" class="link">session.gc_probability</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/session/functions/session-gc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.session-gc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.session-gc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.session-gc.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>i dot carvallo at gmail dot com</em></strong></a><a class="genanchor" href="#129902"> &para;</a><div class="date" title="2024-12-06 09:12"><strong>9 months ago</strong></div>
  <div class="text" id="Hcom129902">
<div class="phpcode"><code><span class="html">Do not use:<br /><br />if (session_gc() == false)<br />OR<br />if (!session_gc())<br /><br />to evaluate if the garbage collector was triggered successfully since it also returns how many sessions it deleted, which can be 0 (and that evaluates to false with loose operators).<br /><br />Sounds dumb, but it's a pitfall i fell into and it generated some confusion. Instead, use strict operator "===":<br /><br />if (session_gc() === false)</span></code></div>
  </div>
 </div>
  <div class="note" id="129834">  <div class="votes">
    ...
    <div class="tally" id="V129834" title="50% like this...">
    0
    </div>
  </div>
  <a href="#129834" class="name">
  <strong class="user"><em>ridaelkouri at gmail dot com</em></strong></a><a class="genanchor" href="#129834"> &para;</a><div class="date" title="2024-11-04 01:29"><strong>10 months ago</strong></div>
  <div class="text" id="Hcom129834">
<div class="phpcode"><code><span class="html">The session.gc() function does not seem to work alone. it deletes the data on the server but the data remains on the browser in the form of the cookie. the following code deletes the session files on the server but not on the browser. <br /><br />ini_set('session.gc_maxlifetime', 10);<br />ini_set('session.gc_probability', 1);<br />ini_set('session.gc_divisor', 1);<br /><br />// Start the session<br />session_start();<br />$_SESSION['test'] = 'temporary data';<br /><br />session_write_close();<br /><br />// Wait for 15 seconds to ensure the session expires<br />sleep(15);<br /><br />// Manually start the session again to trigger session handling<br />session_start();<br /><br />session_gc();<br /><br />// Check if the session data is still available<br />if (isset($_SESSION['test'])) {<br />    echo "Session is still active.";<br />} else {<br />    echo "Session expired and file deleted.";<br />}<br /><br />but this code delete the session files on the server and also deletes the cookie as well as making the super global empty:<br /><br />session_start();<br />$_SESSION['test'] = 'temporary data';<br /><br />session_write_close();<br /><br />// Wait for 15 seconds to ensure the session expires<br />sleep(15);<br /><br />session_start();<br /><br />// Manually trigger garbage collection<br />setcookie(session_name(), '', time() - 10);<br />$_SESSION = [];<br />session_gc();<br /><br />// Check if the session data is still available<br />if (isset($_SESSION['test'])) {<br />    echo "Session is still active.";<br />} else {<br />    echo "Session expired and file deleted.";<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.session-gc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.session-gc.php">＋<small>add a note</small></a></div>
