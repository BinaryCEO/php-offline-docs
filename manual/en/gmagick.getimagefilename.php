...
<head>
  ...
  <title>PHP: Gmagick::getimagefilename - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagefilename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagefilename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagefilename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimageextrema.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimageformat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagefilename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagefilename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagefilename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagefilename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagefilename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagefilename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagefilename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagefilename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagefilename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagefilename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagefilename.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimagefilename - Manual" />
<meta name="twitter:description" content="Returns the filename of a particular image in a sequence" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagefilename - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.getimageformat.php">
          Gmagick::getimageformat &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimageextrema.php">
          &laquo; Gmagick::getimageextrema        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagefilename.php' selected="selected">English</option>
            <option value='de/gmagick.getimagefilename.php'>German</option>
            <option value='es/gmagick.getimagefilename.php'>Spanish</option>
            <option value='fr/gmagick.getimagefilename.php'>French</option>
            <option value='it/gmagick.getimagefilename.php'>Italian</option>
            <option value='ja/gmagick.getimagefilename.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagefilename.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagefilename.php'>Russian</option>
            <option value='tr/gmagick.getimagefilename.php'>Turkish</option>
            <option value='uk/gmagick.getimagefilename.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagefilename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagefilename" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagefilename</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagefilename</span> &mdash; <span class="dc-title">Returns the filename of a particular image in a sequence</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagefilename-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagefilename</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagefilename-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagefilename-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagefilename-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagefilename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagefilename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagefilename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagefilename.php">＋<small>add a note</small></a></span>
