...
<head>
  ...
  <title>PHP: ctype_xdigit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ctype-xdigit.php">
 <link rel="shorturl" href="https://www.php.net/ctype-xdigit">
 <link rel="alternate" href="https://www.php.net/ctype-xdigit" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ctype.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ctype-upper.php">
 <link rel="next" href="https://www.php.net/manual/en/book.filter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ctype-xdigit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ctype-xdigit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ctype-xdigit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ctype-xdigit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ctype-xdigit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ctype-xdigit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ctype-xdigit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ctype-xdigit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ctype-xdigit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ctype-xdigit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ctype-xdigit.php" hreflang="zh">
...
<meta name="Description" content="Check for character(s) representing a hexadecimal digit" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ctype_xdigit - Manual" />
<meta name="twitter:description" content="Check for character(s) representing a hexadecimal digit" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ctype_xdigit - Manual" />
<meta itemprop="description" content="Check for character(s) representing a hexadecimal digit" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check for character(s) representing a hexadecimal digit" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ctype-xdigit.php' selected="selected">English</option>
            <option value='de/function.ctype-xdigit.php'>German</option>
            <option value='es/function.ctype-xdigit.php'>Spanish</option>
            <option value='fr/function.ctype-xdigit.php'>French</option>
            <option value='it/function.ctype-xdigit.php'>Italian</option>
            <option value='ja/function.ctype-xdigit.php'>Japanese</option>
            <option value='pt_BR/function.ctype-xdigit.php'>Brazilian Portuguese</option>
            <option value='ru/function.ctype-xdigit.php'>Russian</option>
            <option value='tr/function.ctype-xdigit.php'>Turkish</option>
            <option value='uk/function.ctype-xdigit.php'>Ukrainian</option>
            <option value='zh/function.ctype-xdigit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ctype-xdigit" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ctype-xdigit-description">
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">text</code>, are hexadecimal &#039;digits&#039;.
  </p>
 </div>
...
or an explicit call to <span class="function"><a href="function.chr.php" class="function">chr()</a></span> should be made.</p></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ctype-xdigit-returnvalues">
  ...
  <p class="para">
   ...
   <code class="literal">[A-Fa-f]</code> , <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
 ...
 <div class="refsect1 examples" id="refsect1-function.ctype-xdigit-examples">
  ...
  <p class="para">
   <div class="example" id="example-5373">
    <p><strong>Example #1 A <span class="function"><strong>ctype_xdigit()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.isxdigit.php" class="function" rel="rdfs-seeAlso">IntlChar::isxdigit()</a> - Check if code point is a hexadecimal digit</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ctype/functions/ctype-xdigit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ctype-xdigit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ctype-xdigit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ctype-xdigit.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="60707">  <div class="votes">
    <div id="Vu60707">
    <a href="/manual/vote-note.php?id=60707&amp;page=function.ctype-xdigit&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd60707">
    <a href="/manual/vote-note.php?id=60707&amp;page=function.ctype-xdigit&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V60707" title="82% like this...">
    23
    </div>
  </div>
  <a href="#60707" class="name">
  <strong class="user"><em>tom at hgmail dot com</em></strong></a><a class="genanchor" href="#60707"> &para;</a><div class="date" title="2006-01-14 12:36"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom60707">
<div class="phpcode"><code><span class="html">This function shows its usefulness on a web site where a user is asked to entered a hexidecimal color code for a color. To prevent breaking W3C standard and having them enter in "neon-green" or the wrong type of code like 355511235.<br /><br />In conjunction with strlen()  you could create a function like this:<br /><br />function check_valid_colorhex($colorCode) {<br />    // If user accidentally passed along the # sign, strip it off<br />    $colorCode = ltrim($colorCode, '#');<br /><br />    if (<br />          ctype_xdigit($colorCode) &amp;&amp;<br />          (strlen($colorCode) == 6 || strlen($colorCode) == 3))<br />               return true;<br /><br />    else return false;<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ctype-xdigit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ctype-xdigit.php">＋<small>add a note</small></a></div>
