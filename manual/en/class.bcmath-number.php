...
<head>
  ...
  <title>PHP: BcMath\Number - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.bcmath-number.php">
 <link rel="shorturl" href="https://www.php.net/bcmath-number">
 <link rel="alternate" href="https://www.php.net/bcmath-number" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.bc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.bcsub.php">
 <link rel="next" href="https://www.php.net/manual/en/bcmath-number.add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.bcmath-number.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.bcmath-number.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.bcmath-number.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.bcmath-number.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.bcmath-number.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.bcmath-number.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.bcmath-number.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.bcmath-number.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.bcmath-number.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.bcmath-number.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.bcmath-number.php" hreflang="zh">
...
<meta name="Description" content="The BcMath\Number class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: BcMath\Number - Manual" />
<meta name="twitter:description" content="The BcMath\Number class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: BcMath\Number - Manual" />
<meta itemprop="description" content="The BcMath\Number class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The BcMath\Number class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.bcmath-number.php' selected="selected">English</option>
            <option value='de/class.bcmath-number.php'>German</option>
            <option value='es/class.bcmath-number.php'>Spanish</option>
            <option value='fr/class.bcmath-number.php'>French</option>
            <option value='it/class.bcmath-number.php'>Italian</option>
            <option value='ja/class.bcmath-number.php'>Japanese</option>
            <option value='pt_BR/class.bcmath-number.php'>Brazilian Portuguese</option>
            <option value='ru/class.bcmath-number.php'>Russian</option>
            <option value='tr/class.bcmath-number.php'>Turkish</option>
            <option value='uk/class.bcmath-number.php'>Ukrainian</option>
            <option value='zh/class.bcmath-number.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.bcmath-number" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>
  ...
  <div class="section" id="bcmath-number.synopsis">
   ...
   <div class="classsynopsis"><div class="classsynopsisinfo">
     ...
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">BcMath\Number</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="bcmath-number.round.php" class="methodname">round</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$precision</code><span class="initializer"> = 0</span></span>, <span class="methodparam"><span class="type"><a href="enum.roundingmode.php" class="type RoundingMode">RoundingMode</a></span> <code class="parameter">$mode</code><span class="initializer"> = RoundingMode::HalfAwayFromZero</span></span>): <span class="type"><a href="class.bcmath-number.php" class="type BcMath\Number">BcMath\Number</a></span></div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="bcmath-number.add.php">BcMath\Number::add</a> — Adds an arbitrary precision number</li><li><a href="bcmath-number.ceil.php">BcMath\Number::ceil</a> — Rounds up an arbitrary precision number</li><li><a href="bcmath-number.compare.php">BcMath\Number::compare</a> — Compares two arbitrary precision numbers</li><li><a href="bcmath-number.construct.php">BcMath\Number::__construct</a> — Creates a BcMath\Number object</li><li><a href="bcmath-number.div.php">BcMath\Number::div</a> — Divides by an arbitrary precision number</li><li><a href="bcmath-number.divmod.php">BcMath\Number::divmod</a> — Gets the quotient and modulus of an arbitrary precision number</li><li><a href="bcmath-number.floor.php">BcMath\Number::floor</a> — Rounds down an arbitrary precision number</li><li><a href="bcmath-number.mod.php">BcMath\Number::mod</a> — Gets the modulus of an arbitrary precision number</li><li><a href="bcmath-number.mul.php">BcMath\Number::mul</a> — Multiplies an arbitrary precision number</li><li><a href="bcmath-number.pow.php">BcMath\Number::pow</a> — Raises an arbitrary precision number</li><li><a href="bcmath-number.powmod.php">BcMath\Number::powmod</a> — Raises an arbitrary precision number, reduced by a specified modulus</li><li><a href="bcmath-number.round.php">BcMath\Number::round</a> — Rounds an arbitrary precision number</li><li><a href="bcmath-number.serialize.php">BcMath\Number::__serialize</a> — Serializes a BcMath\Number object</li><li><a href="bcmath-number.sqrt.php">BcMath\Number::sqrt</a> — Gets the square root of an arbitrary precision number</li><li><a href="bcmath-number.sub.php">BcMath\Number::sub</a> — Subtracts an arbitrary precision number</li><li><a href="bcmath-number.tostring.php">BcMath\Number::__toString</a> — Converts BcMath\Number to string</li><li><a href="bcmath-number.unserialize.php">BcMath\Number::__unserialize</a> — Deserializes a data parameter into a BcMath\Number object</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/bc/bcmath.number.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.bcmath-number%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.bcmath-number&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.bcmath-number.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="130182">  <div class="votes">
    <div id="Vu130182">
    <a href="/manual/vote-note.php?id=130182&amp;page=class.bcmath-number&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130182">
    <a href="/manual/vote-note.php?id=130182&amp;page=class.bcmath-number&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130182" title="100% like this...">
    2
    </div>
  </div>
  <a href="#130182" class="name">
  <strong class="user"><em>harl at gmail dot com</em></strong></a><a class="genanchor" href="#130182"> &para;</a><div class="date" title="2025-03-23 03:49"><strong>6 months ago</strong></div>
  <div class="text" id="Hcom130182">
<div class="phpcode"><code><span class="html">BcMath\Number is one of those classes that overloads boolean casting.<br />If $z = new BcMath\Number(0) then $z is considered falsy (and hence, for example, empty($z)==true) even though it is a genuine Number object.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.bcmath-number&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.bcmath-number.php">＋<small>add a note</small></a></div>
