...
<head>
  ...
  <title>PHP: header_register_callback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.header-register-callback.php">
 <link rel="shorturl" href="https://www.php.net/header-register-callback">
 <link rel="alternate" href="https://www.php.net/header-register-callback" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.network.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.header.php">
 <link rel="next" href="https://www.php.net/manual/en/function.header-remove.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.header-register-callback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.header-register-callback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.header-register-callback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.header-register-callback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.header-register-callback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.header-register-callback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.header-register-callback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.header-register-callback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.header-register-callback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.header-register-callback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.header-register-callback.php" hreflang="zh">
...
<meta name="Description" content="Call a header function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: header_register_callback - Manual" />
<meta name="twitter:description" content="Call a header function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: header_register_callback - Manual" />
<meta itemprop="description" content="Call a header function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Call a header function" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.header-remove.php">
          header_remove &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.header-register-callback.php' selected="selected">English</option>
            <option value='de/function.header-register-callback.php'>German</option>
            <option value='es/function.header-register-callback.php'>Spanish</option>
            <option value='fr/function.header-register-callback.php'>French</option>
            <option value='it/function.header-register-callback.php'>Italian</option>
            <option value='ja/function.header-register-callback.php'>Japanese</option>
            <option value='pt_BR/function.header-register-callback.php'>Brazilian Portuguese</option>
            <option value='ru/function.header-register-callback.php'>Russian</option>
            <option value='tr/function.header-register-callback.php'>Turkish</option>
            <option value='uk/function.header-register-callback.php'>Ukrainian</option>
            <option value='zh/function.header-register-callback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.header-register-callback" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.header.php" class="function" rel="rdfs-seeAlso">header()</a> - Send a raw HTTP header</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/network/functions/header-register-callback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.header-register-callback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.header-register-callback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.header-register-callback.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="111498">  <div class="votes">
    <div id="Vu111498">
    <a href="/manual/vote-note.php?id=111498&amp;page=function.header-register-callback&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111498">
    <a href="/manual/vote-note.php?id=111498&amp;page=function.header-register-callback&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111498" title="80% like this...">
    13
    </div>
  </div>
  <a href="#111498" class="name">
  <strong class="user"><em>matt@kafene</em></strong></a><a class="genanchor" href="#111498"> &para;</a><div class="date" title="2013-02-26 10:26"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111498">
<div class="phpcode"><code><span class="html">Note that this function only registers a single callback as of php 5.4. The most recent callback set is the one that will be executed, they will not be executed in order like with register_shutdown_function(), just overwritten.<br /><br />Here is my test:<br /><br /><span class="default">&lt;?php<br /><br />$i </span><span class="keyword">= </span><span class="default">$j </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br /></span><span class="default">header_register_callback</span><span class="keyword">(function() use(&amp;</span><span class="default">$i</span><span class="keyword">){ </span><span class="default">$i</span><span class="keyword">+=</span><span class="default">2</span><span class="keyword">; });<br /></span><span class="default">header_register_callback</span><span class="keyword">(function() use(&amp;</span><span class="default">$i</span><span class="keyword">){ </span><span class="default">$i</span><span class="keyword">+=</span><span class="default">3</span><span class="keyword">; });<br /></span><span class="default">register_shutdown_function</span><span class="keyword">(function() use(&amp;</span><span class="default">$j</span><span class="keyword">){ </span><span class="default">$j</span><span class="keyword">+=</span><span class="default">2</span><span class="keyword">; });<br /></span><span class="default">register_shutdown_function</span><span class="keyword">(function() use(&amp;</span><span class="default">$j</span><span class="keyword">){ </span><span class="default">$j</span><span class="keyword">+=</span><span class="default">3</span><span class="keyword">; });<br /></span><span class="default">register_shutdown_function</span><span class="keyword">(function() use(&amp;</span><span class="default">$j</span><span class="keyword">){ </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$j</span><span class="keyword">); });<br />while(!</span><span class="default">headers_sent</span><span class="keyword">()) { echo </span><span class="string">"&lt;!-- ... flushing ... --&gt;"</span><span class="keyword">; }<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">headers_sent</span><span class="keyword">(), </span><span class="default">$i</span><span class="keyword">);<br />exit;<br /><br /></span><span class="default">?&gt;<br /></span><br />Results:<br /><br />headers_sent() - true<br />$i = 3<br />$j = 5</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.header-register-callback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.header-register-callback.php">＋<small>add a note</small></a></div>
