...
<head>
  ...
  <title>PHP: mb_ereg_search_init - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-ereg-search-init.php">
 <link rel="shorturl" href="https://www.php.net/mb-ereg-search-init">
 <link rel="alternate" href="https://www.php.net/mb-ereg-search-init" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-ereg-search-getregs.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-ereg-search-pos.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-ereg-search-init.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-ereg-search-init.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-ereg-search-init.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-ereg-search-init.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-ereg-search-init.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-ereg-search-init.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-ereg-search-init.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-ereg-search-init.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-ereg-search-init.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-ereg-search-init.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-ereg-search-init.php" hreflang="zh">
...
<meta name="Description" content="Setup string and regular expression for a multibyte regular expression match" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_ereg_search_init - Manual" />
<meta name="twitter:description" content="Setup string and regular expression for a multibyte regular expression match" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_ereg_search_init - Manual" />
<meta itemprop="description" content="Setup string and regular expression for a multibyte regular expression match" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Setup string and regular expression for a multibyte regular expression match" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mb-ereg-search-pos.php">
          mb_ereg_search_pos &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mb-ereg-search-getregs.php">
          &laquo; mb_ereg_search_getregs        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-ereg-search-init.php' selected="selected">English</option>
            <option value='de/function.mb-ereg-search-init.php'>German</option>
            <option value='es/function.mb-ereg-search-init.php'>Spanish</option>
            <option value='fr/function.mb-ereg-search-init.php'>French</option>
            <option value='it/function.mb-ereg-search-init.php'>Italian</option>
            <option value='ja/function.mb-ereg-search-init.php'>Japanese</option>
            <option value='pt_BR/function.mb-ereg-search-init.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-ereg-search-init.php'>Russian</option>
            <option value='tr/function.mb-ereg-search-init.php'>Turkish</option>
            <option value='uk/function.mb-ereg-search-init.php'>Ukrainian</option>
            <option value='zh/function.mb-ereg-search-init.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-ereg-search-init" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_ereg_search_init</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_ereg_search_init</span> &mdash; <span class="dc-title">Setup string and regular expression for a multibyte regular expression match</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-ereg-search-init-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_ereg_search_init</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$pattern</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$options</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.mb-ereg-search-pos.php" class="function">mb_ereg_search_pos()</a></span>, and
   <span class="function"><a href="function.mb-ereg-search-regs.php" class="function">mb_ereg_search_regs()</a></span>. 
  </p>
 </div>
 ...
 <div class="refsect1 changelog" id="refsect1-function.mb-ereg-search-init-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.mb-ereg-search-init-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-ereg-search-regs.php" class="function" rel="rdfs-seeAlso">mb_ereg_search_regs()</a> - Returns the matched part of a multibyte regular expression</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-ereg-search-init.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-ereg-search-init%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-ereg-search-init&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-ereg-search-init.php">＋<small>add a note</small></a></span>
