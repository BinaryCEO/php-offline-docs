...
<head>
  ...
  <title>PHP: mysqli_stmt::$sqlstate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-stmt.sqlstate.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-stmt.sqlstate.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-stmt.sqlstate.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-stmt.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-stmt.send-long-data.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-stmt.store-result.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-stmt.sqlstate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli-stmt.sqlstate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli-stmt.sqlstate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli-stmt.sqlstate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli-stmt.sqlstate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli-stmt.sqlstate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli-stmt.sqlstate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli-stmt.sqlstate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli-stmt.sqlstate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli-stmt.sqlstate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli-stmt.sqlstate.php" hreflang="zh">
...
<meta name="Description" content="Returns SQLSTATE error from previous statement operation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_stmt::$sqlstate - Manual" />
<meta name="twitter:description" content="Returns SQLSTATE error from previous statement operation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_stmt::$sqlstate - Manual" />
<meta itemprop="description" content="Returns SQLSTATE error from previous statement operation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns SQLSTATE error from previous statement operation" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli-stmt.store-result.php">
          mysqli_stmt::store_result &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli-stmt.send-long-data.php">
          &laquo; mysqli_stmt::send_long_data        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-stmt.sqlstate.php' selected="selected">English</option>
            <option value='de/mysqli-stmt.sqlstate.php'>German</option>
            <option value='es/mysqli-stmt.sqlstate.php'>Spanish</option>
            <option value='fr/mysqli-stmt.sqlstate.php'>French</option>
            <option value='it/mysqli-stmt.sqlstate.php'>Italian</option>
            <option value='ja/mysqli-stmt.sqlstate.php'>Japanese</option>
            <option value='pt_BR/mysqli-stmt.sqlstate.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli-stmt.sqlstate.php'>Russian</option>
            <option value='tr/mysqli-stmt.sqlstate.php'>Turkish</option>
            <option value='uk/mysqli-stmt.sqlstate.php'>Ukrainian</option>
            <option value='zh/mysqli-stmt.sqlstate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli-stmt.sqlstate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli_stmt::$sqlstate</h1>
  <h1 class="refname">mysqli_stmt_sqlstate</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli_stmt::$sqlstate</span> -- <span class="refname">mysqli_stmt_sqlstate</span> &mdash; <span class="dc-title">Returns SQLSTATE error from previous statement operation</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-mysqli-stmt.sqlstate-description">
  <h3 class="title">Description</h3>
  <p class="para">Object-oriented style</p>
  <div class="fieldsynopsis"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <var class="varname"><a href="mysqli-stmt.sqlstate.php">$mysqli_stmt-&gt;sqlstate</a></var>;</div>

  <p class="para">Procedural style</p>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysqli_stmt_sqlstate</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli-stmt.php" class="type mysqli_stmt">mysqli_stmt</a></span> <code class="parameter">$statement</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-mysqli-stmt.sqlstate-parameters">
...
returned by <span class="function"><a href="mysqli.stmt-init.php" class="function">mysqli_stmt_init()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli-stmt.sqlstate-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-mysqli-stmt.sqlstate-examples">
...
<div class="examplescode"><pre class="examplescode">Error: 42S02.</pre>
</div>
   </div>
  </div>
 </div>
 ...
 <div class="refsect1 notes" id="refsect1-mysqli-stmt.sqlstate-notes">
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli-stmt.sqlstate-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli-stmt.error.php" class="function" rel="rdfs-seeAlso">mysqli_stmt_error()</a> - Returns a string description for last statement error</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_stmt/sqlstate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli-stmt.sqlstate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli-stmt.sqlstate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-stmt.sqlstate.php">＋<small>add a note</small></a></span>
