...
<head>
  ...
  <title>PHP: DOMXPath::quote - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/domxpath.quote.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/domxpath.quote.php">
 <link rel="alternate" href="https://www.php.net/manual/en/domxpath.quote.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.domxpath.php">
 <link rel="prev" href="https://www.php.net/manual/en/domxpath.query.php">
 <link rel="next" href="https://www.php.net/manual/en/domxpath.registernamespace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/domxpath.quote.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/domxpath.quote.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/domxpath.quote.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/domxpath.quote.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/domxpath.quote.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/domxpath.quote.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/domxpath.quote.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/domxpath.quote.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/domxpath.quote.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/domxpath.quote.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/domxpath.quote.php" hreflang="zh">
...
<meta name="Description" content="Quotes a string for use in an XPath expression" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMXPath::quote - Manual" />
<meta name="twitter:description" content="Quotes a string for use in an XPath expression" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMXPath::quote - Manual" />
<meta itemprop="description" content="Quotes a string for use in an XPath expression" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Quotes a string for use in an XPath expression" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/domxpath.quote.php' selected="selected">English</option>
            <option value='de/domxpath.quote.php'>German</option>
            <option value='es/domxpath.quote.php'>Spanish</option>
            <option value='fr/domxpath.quote.php'>French</option>
            <option value='it/domxpath.quote.php'>Italian</option>
            <option value='ja/domxpath.quote.php'>Japanese</option>
            <option value='pt_BR/domxpath.quote.php'>Brazilian Portuguese</option>
            <option value='ru/domxpath.quote.php'>Russian</option>
            <option value='tr/domxpath.quote.php'>Turkish</option>
            <option value='uk/domxpath.quote.php'>Ukrainian</option>
            <option value='zh/domxpath.quote.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="domxpath.quote" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-domxpath.quote-examples">
  ...
  <div class="example" id="example-5831">
   <p><strong>Example #1 Matching attribute value with quotes</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="domxpath.query.php" class="methodname" rel="rdfs-seeAlso">DOMXPath::query()</a> - Evaluates the given XPath expression</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domxpath/quote.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdomxpath.quote%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=domxpath.quote&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domxpath.quote.php">＋<small>add a note</small></a></span>
