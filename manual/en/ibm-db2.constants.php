...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ibm-db2.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ibm-db2.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ibm-db2.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/ibm-db2.resources.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.ibm-db2.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ibm-db2.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ibm-db2.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ibm-db2.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ibm-db2.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ibm-db2.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ibm-db2.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ibm-db2.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ibm-db2.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ibm-db2.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ibm-db2.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ibm-db2.constants.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ibm-db2.constants.php' selected="selected">English</option>
            <option value='de/ibm-db2.constants.php'>German</option>
            <option value='es/ibm-db2.constants.php'>Spanish</option>
            <option value='fr/ibm-db2.constants.php'>French</option>
            <option value='it/ibm-db2.constants.php'>Italian</option>
            <option value='ja/ibm-db2.constants.php'>Japanese</option>
            <option value='pt_BR/ibm-db2.constants.php'>Brazilian Portuguese</option>
            <option value='ru/ibm-db2.constants.php'>Russian</option>
            <option value='tr/ibm-db2.constants.php'>Turkish</option>
            <option value='uk/ibm-db2.constants.php'>Ukrainian</option>
            <option value='zh/ibm-db2.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ibm-db2.constants" class="appendix">
   ...
   <dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fibm-db2.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ibm-db2.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ibm-db2.constants.php">＋<small>add a note</small></a></span>
