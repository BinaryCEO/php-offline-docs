...
<head>
  ...
  <title>PHP: Imagick::floodFillPaintImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.floodfillpaintimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.floodfillpaintimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.floodfillpaintimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.flipimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.flopimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.floodfillpaintimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.floodfillpaintimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.floodfillpaintimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.floodfillpaintimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.floodfillpaintimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.floodfillpaintimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.floodfillpaintimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.floodfillpaintimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.floodfillpaintimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.floodfillpaintimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.floodfillpaintimage.php" hreflang="zh">
...
<meta name="Description" content="Changes the color value of any pixel that matches target" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::floodFillPaintImage - Manual" />
<meta name="twitter:description" content="Changes the color value of any pixel that matches target" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::floodFillPaintImage - Manual" />
<meta itemprop="description" content="Changes the color value of any pixel that matches target" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Changes the color value of any pixel that matches target" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.flopimage.php">
          Imagick::flopImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.flipimage.php">
          &laquo; Imagick::flipImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.floodfillpaintimage.php' selected="selected">English</option>
            <option value='de/imagick.floodfillpaintimage.php'>German</option>
            <option value='es/imagick.floodfillpaintimage.php'>Spanish</option>
            <option value='fr/imagick.floodfillpaintimage.php'>French</option>
            <option value='it/imagick.floodfillpaintimage.php'>Italian</option>
            <option value='ja/imagick.floodfillpaintimage.php'>Japanese</option>
            <option value='pt_BR/imagick.floodfillpaintimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.floodfillpaintimage.php'>Russian</option>
            <option value='tr/imagick.floodfillpaintimage.php'>Turkish</option>
            <option value='uk/imagick.floodfillpaintimage.php'>Ukrainian</option>
            <option value='zh/imagick.floodfillpaintimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.floodfillpaintimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::floodFillPaintImage</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::floodFillPaintImage</span> &mdash; <span class="dc-title">Changes the color value of any pixel that matches target</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.floodfillpaintimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::floodFillPaintImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fill</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$fuzz</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$target</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$invert</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="imagick.paintfloodfillimage.php" class="function">Imagick::paintFloodFillImage()</a></span>.
   This method is available if Imagick has been compiled against ImageMagick version 6.3.8 or newer.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.floodfillpaintimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">invert</code></dt>
     <dd>
      <p class="para">
       If <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> paints any pixel that does not match the target color.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.floodfillpaintimage-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.floodfillpaintimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3000">
    <p><strong>Example #1 <span class="methodname"><strong>Imagick::floodfillPaintImage()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">/* Create new imagick object */<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /><br /></span><span style="color: #FF8000">/* create red, green and blue images */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #DD0000">"red"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #DD0000">"green"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #DD0000">"blue"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Append the images into one */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">resetIterator</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$combined </span><span style="color: #007700">= </span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">appendImages</span><span style="color: #007700">(</span><span style="color: #0000BB">true</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Save the intermediate image for comparison */<br /></span><span style="color: #0000BB">$combined</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">writeImage</span><span style="color: #007700">(</span><span style="color: #DD0000">"floodfillpaint_intermediate.png"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* The target pixel to paint */<br /></span><span style="color: #0000BB">$x </span><span style="color: #007700">= </span><span style="color: #0000BB">1</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$y </span><span style="color: #007700">= </span><span style="color: #0000BB">1</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">/* Get the color we are painting */<br /></span><span style="color: #0000BB">$target </span><span style="color: #007700">= </span><span style="color: #0000BB">$combined</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImagePixelColor</span><span style="color: #007700">(</span><span style="color: #0000BB">$x</span><span style="color: #007700">, </span><span style="color: #0000BB">$y</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Paints pixel in position 1,1 black and all neighboring <br />   pixels that match the target color */<br /></span><span style="color: #0000BB">$combined</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">floodfillPaintImage</span><span style="color: #007700">(</span><span style="color: #DD0000">"black"</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$target</span><span style="color: #007700">, </span><span style="color: #0000BB">$x</span><span style="color: #007700">, </span><span style="color: #0000BB">$y</span><span style="color: #007700">, </span><span style="color: #0000BB">false</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Save the result */<br /></span><span style="color: #0000BB">$combined</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">writeImage</span><span style="color: #007700">(</span><span style="color: #DD0000">"floodfillpaint_result.png"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
something similar to:</p></div>
    <div class="mediaobject">
     ...
     <div class="imageobject">
      <img src="images/c0d23d2d6769e53e24a1b3136c064577-floodfillpaint_intermediate.png" alt="Output of example : Imagick::floodfillPaintImage()" width="100" height="150" />
     </div>
     <div class="imageobject">
      <img src="images/c0d23d2d6769e53e24a1b3136c064577-floodfillpaint_result.png" alt="Output of example : Imagick::floodfillPaintImage()" width="100" height="150" />
     </div>
    </div>
   </div>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/floodfillpaintimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.floodfillpaintimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.floodfillpaintimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.floodfillpaintimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123174">  <div class="votes">
    <div id="Vu123174">
    <a href="/manual/vote-note.php?id=123174&amp;page=imagick.floodfillpaintimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123174">
    <a href="/manual/vote-note.php?id=123174&amp;page=imagick.floodfillpaintimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123174" title="50% like this...">
    0
    </div>
  </div>
  <a href="#123174" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#123174"> &para;</a><div class="date" title="2018-09-29 03:05"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom123174">
<div class="phpcode"><code><span class="html">For fuzz, percentage or float values do not seem to work. The value is based on the intensity of the image colors. <br /><br />The documentation states: "The amount of fuzz. For example, set fuzz to 10 and the color red at intensities of 100 and 102 respectively are now interpreted as the same color." <br /><br />For those of us who are not graphics geeks, your color intensity might be something like 65535. In which case, to get just 10% fuzz, you need to set it to 6550. <br /><br />You likely will not see any effect if you are using low numbers or floats, like 100, 20, or 0.8. <br /><br />For example: <br />$im = new Imagick();<br />$transparentColor = new ImagickPixel('transparent');<br />$greenscreen = '#00FF08';    // Super bright green<br /><br />$im-&gt;readImage("cartoon_dog.png");    // Cartoony dog with a black outline and a #00FF08 (super bright green) background. <br /><br />// Replace the green background with transparent.<br /><br />// Leaves significant green lines around the outline of the dog, which is unacceptable.<br />$im-&gt;floodFillPaintImage($transparentColor, 30, $greenscreen, 0, 0, false, Imagick::CHANNEL_ALPHA);<br /><br />// Works as intended - removes all of the green background. <br />$im-&gt;floodFillPaintImage($transparentColor, 30000, $greenscreen, 0, 0, false, Imagick::CHANNEL_ALPHA);<br /><br />Credit to the discussion here: <br /><a href="https://php5.kiev.ua/php7/imagick.painttransparentimage.html" rel="nofollow" target="_blank">https://php5.kiev.ua/php7/imagick.painttransparentimage.html</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.floodfillpaintimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.floodfillpaintimage.php">＋<small>add a note</small></a></div>
