...
<head>
  ...
  <title>PHP: fbird_query - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-query.php">
 <link rel="shorturl" href="https://www.php.net/fbird-query">
 <link rel="alternate" href="https://www.php.net/fbird-query" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-prepare.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-restore.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-query.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-query.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-query.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-query.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-query.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-query.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-query.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-query.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-query.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-query.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-query.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_query - Manual" />
<meta name="twitter:description" content="Alias of ibase_query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_query - Manual" />
<meta itemprop="description" content="Alias of ibase_query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_query" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fbird-restore.php">
          fbird_restore &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-prepare.php">
          &laquo; fbird_prepare        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-query.php' selected="selected">English</option>
            <option value='de/function.fbird-query.php'>German</option>
            <option value='es/function.fbird-query.php'>Spanish</option>
            <option value='fr/function.fbird-query.php'>French</option>
            <option value='it/function.fbird-query.php'>Italian</option>
            <option value='ja/function.fbird-query.php'>Japanese</option>
            <option value='pt_BR/function.fbird-query.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-query.php'>Russian</option>
            <option value='tr/function.fbird-query.php'>Turkish</option>
            <option value='uk/function.fbird-query.php'>Ukrainian</option>
            <option value='zh/function.fbird-query.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-query" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_query</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_query</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-query.php" class="function">ibase_query()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-query-description">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fbird-query-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-errmsg.php" class="function" rel="rdfs-seeAlso">fbird_errmsg()</a> - Alias of ibase_errmsg</span></li>
    ...
    <li><span class="function"><a href="function.fbird-free-result.php" class="function" rel="rdfs-seeAlso">fbird_free_result()</a> - Alias of ibase_free_result</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-query.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-query%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-query&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-query.php">＋<small>add a note</small></a></span>
