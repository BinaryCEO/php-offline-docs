...
<head>
  ...
  <title>PHP: CommonMark\Node\OrderedList - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.commonmark-node-orderedlist.php">
 <link rel="shorturl" href="https://www.php.net/commonmark-node-orderedlist">
 <link rel="alternate" href="https://www.php.net/commonmark-node-orderedlist" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.cmark.php">
 <link rel="prev" href="https://www.php.net/manual/en/commonmark-node-bulletlist.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/commonmark-node-orderedlist.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.commonmark-node-orderedlist.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.commonmark-node-orderedlist.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.commonmark-node-orderedlist.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.commonmark-node-orderedlist.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.commonmark-node-orderedlist.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.commonmark-node-orderedlist.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.commonmark-node-orderedlist.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.commonmark-node-orderedlist.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.commonmark-node-orderedlist.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.commonmark-node-orderedlist.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.commonmark-node-orderedlist.php" hreflang="zh">
...
<meta name="Description" content="OrderedList concrete CommonMark\Node" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CommonMark\Node\OrderedList - Manual" />
<meta name="twitter:description" content="OrderedList concrete CommonMark\Node" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CommonMark\Node\OrderedList - Manual" />
<meta itemprop="description" content="OrderedList concrete CommonMark\Node" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="OrderedList concrete CommonMark\Node" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="commonmark-node-orderedlist.construct.php">
          CommonMark\Node\OrderedList::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="commonmark-node-bulletlist.construct.php">
          &laquo; CommonMark\Node\BulletList::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.commonmark-node-orderedlist.php' selected="selected">English</option>
            <option value='de/class.commonmark-node-orderedlist.php'>German</option>
            <option value='es/class.commonmark-node-orderedlist.php'>Spanish</option>
            <option value='fr/class.commonmark-node-orderedlist.php'>French</option>
            <option value='it/class.commonmark-node-orderedlist.php'>Italian</option>
            <option value='ja/class.commonmark-node-orderedlist.php'>Japanese</option>
            <option value='pt_BR/class.commonmark-node-orderedlist.php'>Brazilian Portuguese</option>
            <option value='ru/class.commonmark-node-orderedlist.php'>Russian</option>
            <option value='tr/class.commonmark-node-orderedlist.php'>Turkish</option>
            <option value='uk/class.commonmark-node-orderedlist.php'>Ukrainian</option>
            <option value='zh/class.commonmark-node-orderedlist.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.commonmark-node-orderedlist" class="reference">

 <h1 class="title">OrderedList concrete CommonMark\Node</h1>
 

 <div class="partintro"><p class="verinfo">(cmark &gt;= 1.0.0)</p>

  <div class="section" id="commonmark-node-orderedlist.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      ...
      <span class="modifier">class</span> <strong class="classname">CommonMark\Node\OrderedList</strong>
     </span>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="varname">$<var class="varname">start</var></var>;</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Constructor */</div>
    <div class="constructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><a href="commonmark-node-orderedlist.construct.php" class="methodname">__construct</a></span>()</div>
<div class="constructorsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="commonmark-node-orderedlist.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$tight</code></span>)</div>
<div class="constructorsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="commonmark-node-orderedlist.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$tight</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$delimiter</code></span>)</div>
<div class="constructorsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="commonmark-node-orderedlist.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$tight</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$delimiter</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$start</code></span>)</div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="commonmark-node-orderedlist.construct.php">CommonMark\Node\OrderedList::__construct</a> — OrderedList Construction</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cmark/commonmark.node.orderedlist.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.commonmark-node-orderedlist%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.commonmark-node-orderedlist&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.commonmark-node-orderedlist.php">＋<small>add a note</small></a></span>
