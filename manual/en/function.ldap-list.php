...
<head>
  ...
  <title>PHP: ldap_list - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-list.php">
 <link rel="shorturl" href="https://www.php.net/ldap-list">
 <link rel="alternate" href="https://www.php.net/ldap-list" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-get-values-len.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-mod-add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-list.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-list.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-list.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-list.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-list.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-list.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-list.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-list.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-list.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-list.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-list.php" hreflang="zh">
...
<meta name="Description" content="Single-level search" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_list - Manual" />
<meta name="twitter:description" content="Single-level search" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_list - Manual" />
<meta itemprop="description" content="Single-level search" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Single-level search" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-list.php' selected="selected">English</option>
            <option value='de/function.ldap-list.php'>German</option>
            <option value='es/function.ldap-list.php'>Spanish</option>
            <option value='fr/function.ldap-list.php'>French</option>
            <option value='it/function.ldap-list.php'>Italian</option>
            <option value='ja/function.ldap-list.php'>Japanese</option>
            <option value='pt_BR/function.ldap-list.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-list.php'>Russian</option>
            <option value='tr/function.ldap-list.php'>Turkish</option>
            <option value='uk/function.ldap-list.php'>Ukrainian</option>
            <option value='zh/function.ldap-list.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-list" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_list</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_list</span> &mdash; <span class="dc-title">Single-level search</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-list-description">
  ...
  <p class="para">
   ...
   <code class="parameter">base</code> given in the call.
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// $ds is a valid LDAP\Connection instance for a directory server<br /><br /></span><span style="color: #0000BB">$basedn </span><span style="color: #007700">= </span><span style="color: #DD0000">"o=My Company, c=US"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$justthese </span><span style="color: #007700">= array(</span><span style="color: #DD0000">"ou"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$sr </span><span style="color: #007700">= </span><span style="color: #0000BB">ldap_list</span><span style="color: #007700">(</span><span style="color: #0000BB">$ds</span><span style="color: #007700">, </span><span style="color: #0000BB">$basedn</span><span style="color: #007700">, </span><span style="color: #DD0000">"ou=*"</span><span style="color: #007700">, </span><span style="color: #0000BB">$justthese</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$info </span><span style="color: #007700">= </span><span style="color: #0000BB">ldap_get_entries</span><span style="color: #007700">(</span><span style="color: #0000BB">$ds</span><span style="color: #007700">, </span><span style="color: #0000BB">$sr</span><span style="color: #007700">);<br /><br />for (</span><span style="color: #0000BB">$i</span><span style="color: #007700">=</span><span style="color: #0000BB">0</span><span style="color: #007700">; </span><span style="color: #0000BB">$i </span><span style="color: #007700">&lt; </span><span style="color: #0000BB">$info</span><span style="color: #007700">[</span><span style="color: #DD0000">"count"</span><span style="color: #007700">]; </span><span style="color: #0000BB">$i</span><span style="color: #007700">++) {<br />    echo </span><span style="color: #0000BB">$info</span><span style="color: #007700">[</span><span style="color: #0000BB">$i</span><span style="color: #007700">][</span><span style="color: #DD0000">"ou"</span><span style="color: #007700">][</span><span style="color: #0000BB">0</span><span style="color: #007700">];<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ldap-list-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-search.php" class="function" rel="rdfs-seeAlso">ldap_search()</a> - Search LDAP tree</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-list.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-list%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-list&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-list.php">＋<small>add a note</small></a></span>
