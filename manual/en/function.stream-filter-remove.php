...
<head>
  ...
  <title>PHP: stream_filter_remove - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-filter-remove.php">
 <link rel="shorturl" href="https://www.php.net/stream-filter-remove">
 <link rel="alternate" href="https://www.php.net/stream-filter-remove" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-filter-register.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-get-contents.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-filter-remove.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-filter-remove.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-filter-remove.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-filter-remove.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-filter-remove.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-filter-remove.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-filter-remove.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-filter-remove.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-filter-remove.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-filter-remove.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-filter-remove.php" hreflang="zh">
...
<meta name="Description" content="Remove a filter from a stream" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_filter_remove - Manual" />
<meta name="twitter:description" content="Remove a filter from a stream" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_filter_remove - Manual" />
<meta itemprop="description" content="Remove a filter from a stream" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Remove a filter from a stream" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-get-contents.php">
          stream_get_contents &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-filter-register.php">
          &laquo; stream_filter_register        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-filter-remove.php' selected="selected">English</option>
            <option value='de/function.stream-filter-remove.php'>German</option>
            <option value='es/function.stream-filter-remove.php'>Spanish</option>
            <option value='fr/function.stream-filter-remove.php'>French</option>
            <option value='it/function.stream-filter-remove.php'>Italian</option>
            <option value='ja/function.stream-filter-remove.php'>Japanese</option>
            <option value='pt_BR/function.stream-filter-remove.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-filter-remove.php'>Russian</option>
            <option value='tr/function.stream-filter-remove.php'>Turkish</option>
            <option value='uk/function.stream-filter-remove.php'>Ukrainian</option>
            <option value='zh/function.stream-filter-remove.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-filter-remove" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.stream-filter-remove-description">
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.stream-filter-prepend.php" class="function">stream_filter_prepend()</a></span> or
   <span class="function"><a href="function.stream-filter-append.php" class="function">stream_filter_append()</a></span>.  Any data remaining in the
 ...
 <div class="refsect1 examples" id="refsect1-function.stream-filter-remove-examples">
  ...
  <p class="para">
   <div class="example" id="example-4054">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.stream-filter-prepend.php" class="function" rel="rdfs-seeAlso">stream_filter_prepend()</a> - Attach a filter to a stream</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-filter-remove.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-filter-remove%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-filter-remove&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-filter-remove.php">＋<small>add a note</small></a></span>
