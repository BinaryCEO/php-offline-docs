...
<head>
  ...
  <title>PHP: MongoDB\Driver\CursorInterface - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-cursorinterface.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-cursorinterface">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-cursorinterface" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.mongodb.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-cursorid.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-cursorinterface.getid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-cursorinterface.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-cursorinterface.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-cursorinterface.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-cursorinterface.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-cursorinterface.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-cursorinterface.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-cursorinterface.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-cursorinterface.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-cursorinterface.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-cursorinterface.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-cursorinterface.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\CursorInterface interface" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\CursorInterface - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\CursorInterface interface" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\CursorInterface - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\CursorInterface interface" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\CursorInterface interface" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-cursorinterface.getid.php">
          MongoDB\Driver\CursorInterface::getId &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-cursorid.tostring.php">
          &laquo; MongoDB\Driver\CursorId::__toString        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-cursorinterface.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-cursorinterface.php'>German</option>
            <option value='es/class.mongodb-driver-cursorinterface.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-cursorinterface.php'>French</option>
            <option value='it/class.mongodb-driver-cursorinterface.php'>Italian</option>
            <option value='ja/class.mongodb-driver-cursorinterface.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-cursorinterface.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-cursorinterface.php'>Russian</option>
            <option value='tr/class.mongodb-driver-cursorinterface.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-cursorinterface.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-cursorinterface.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-cursorinterface" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-cursorinterface.getid.php">MongoDB\Driver\CursorInterface::getId</a> — Returns the ID for this cursor</li><li><a href="mongodb-driver-cursorinterface.getserver.php">MongoDB\Driver\CursorInterface::getServer</a> — Returns the server associated with this cursor</li><li><a href="mongodb-driver-cursorinterface.isdead.php">MongoDB\Driver\CursorInterface::isDead</a> — Checks if the cursor may have additional results</li><li><a href="mongodb-driver-cursorinterface.settypemap.php">MongoDB\Driver\CursorInterface::setTypeMap</a> — Sets a type map to use for BSON unserialization</li><li><a href="mongodb-driver-cursorinterface.toarray.php">MongoDB\Driver\CursorInterface::toArray</a> — Returns an array containing all results for this cursor</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/cursorinterface.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-cursorinterface%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-cursorinterface&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-cursorinterface.php">＋<small>add a note</small></a></span>
