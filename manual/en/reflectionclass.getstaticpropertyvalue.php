...
<head>
  ...
  <title>PHP: ReflectionClass::getStaticPropertyValue - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getstaticpropertyvalue.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getstaticpropertyvalue.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getstaticpropertyvalue.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getstaticproperties.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.gettraitaliases.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getstaticpropertyvalue.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getstaticpropertyvalue.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getstaticpropertyvalue.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getstaticpropertyvalue.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getstaticpropertyvalue.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getstaticpropertyvalue.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getstaticpropertyvalue.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getstaticpropertyvalue.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getstaticpropertyvalue.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getstaticpropertyvalue.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getstaticpropertyvalue.php" hreflang="zh">
...
<meta name="Description" content="Gets static property value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getStaticPropertyValue - Manual" />
<meta name="twitter:description" content="Gets static property value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getStaticPropertyValue - Manual" />
<meta itemprop="description" content="Gets static property value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets static property value" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionclass.gettraitaliases.php">
          ReflectionClass::getTraitAliases &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getstaticproperties.php">
          &laquo; ReflectionClass::getStaticProperties        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getstaticpropertyvalue.php' selected="selected">English</option>
            <option value='de/reflectionclass.getstaticpropertyvalue.php'>German</option>
            <option value='es/reflectionclass.getstaticpropertyvalue.php'>Spanish</option>
            <option value='fr/reflectionclass.getstaticpropertyvalue.php'>French</option>
            <option value='it/reflectionclass.getstaticpropertyvalue.php'>Italian</option>
            <option value='ja/reflectionclass.getstaticpropertyvalue.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getstaticpropertyvalue.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getstaticpropertyvalue.php'>Russian</option>
            <option value='tr/reflectionclass.getstaticpropertyvalue.php'>Turkish</option>
            <option value='uk/reflectionclass.getstaticpropertyvalue.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getstaticpropertyvalue.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getstaticpropertyvalue" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.getstaticpropertyvalue-examples">
  ...
  <p class="para">
   <div class="example" id="example-5490">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionclass.setstaticpropertyvalue.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::setStaticPropertyValue()</a> - Sets public static property value</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getstaticpropertyvalue.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getstaticpropertyvalue%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getstaticpropertyvalue&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getstaticpropertyvalue.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="105417">  <div class="votes">
    <div id="Vu105417">
    <a href="/manual/vote-note.php?id=105417&amp;page=reflectionclass.getstaticpropertyvalue&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105417">
    <a href="/manual/vote-note.php?id=105417&amp;page=reflectionclass.getstaticpropertyvalue&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105417" title="100% like this...">
    7
    </div>
  </div>
  <a href="#105417" class="name">
  <strong class="user"><em>Antares</em></strong></a><a class="genanchor" href="#105417"> &para;</a><div class="date" title="2011-08-16 07:11"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105417">
<div class="phpcode"><code><span class="html">It seems this method has a security level different from the getStaticProperties method.
<br />
<br />If you make two classes A and B looking like
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">class </span><span class="default">A</span><span class="keyword">{
<br />        protected static </span><span class="default">$static_var</span><span class="keyword">=</span><span class="string">'foo'</span><span class="keyword">;
<br />
<br />        public function </span><span class="default">getStatic</span><span class="keyword">(){
<br />           </span><span class="default">$class</span><span class="keyword">=new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">);
<br />           return </span><span class="default">$class</span><span class="keyword">-&gt;</span><span class="default">getStaticPropertyValue</span><span class="keyword">(</span><span class="string">'static_var'</span><span class="keyword">);
<br />        }
<br />
<br />        public function </span><span class="default">getStatic2</span><span class="keyword">(){
<br />            </span><span class="default">$class</span><span class="keyword">=new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">);
<br />            </span><span class="default">$staticProps</span><span class="keyword">=</span><span class="default">$class</span><span class="keyword">-&gt;</span><span class="default">getStaticProperties</span><span class="keyword">();
<br />            return </span><span class="default">$staticProps</span><span class="keyword">[</span><span class="string">'static_var'</span><span class="keyword">];
<br />        }
<br />
<br />        public function </span><span class="default">__construct</span><span class="keyword">(){
<br />              echo </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">getStatic2</span><span class="keyword">();
<br />              echo </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">getStatic</span><span class="keyword">();
<br />        }
<br />}
<br />
<br />class </span><span class="default">B </span><span class="keyword">extends </span><span class="default">A</span><span class="keyword">{
<br />        protected static </span><span class="default">$static_var</span><span class="keyword">=</span><span class="string">'foo2'</span><span class="keyword">;
<br />
<br />}
<br /></span><span class="default">?&gt;
<br /></span>
<br />Then the output will be an exception for the getStatic() call, when the getStatic2() will correctly return 'foo2';</span></code></div>
  </div>
 </div>
  <div class="note" id="129908">  <div class="votes">
    <div id="Vu129908">
    <a href="/manual/vote-note.php?id=129908&amp;page=reflectionclass.getstaticpropertyvalue&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129908">
    <a href="/manual/vote-note.php?id=129908&amp;page=reflectionclass.getstaticpropertyvalue&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129908" title="no votes...">
    0
    </div>
  </div>
  <a href="#129908" class="name">
  <strong class="user"><em>tracid2008 at atgmail dot com</em></strong></a><a class="genanchor" href="#129908"> &para;</a><div class="date" title="2024-12-12 01:40"><strong>9 months ago</strong></div>
  <div class="text" id="Hcom129908">
<div class="phpcode"><code><span class="html">Note that ReflectionClass::getStaticPropertyValue() can also return values from private or protected properties.</span></code></div>
  </div>
 </div>
  <div class="note" id="95783">  <div class="votes">
    <div id="Vu95783">
    <a href="/manual/vote-note.php?id=95783&amp;page=reflectionclass.getstaticpropertyvalue&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd95783">
    <a href="/manual/vote-note.php?id=95783&amp;page=reflectionclass.getstaticpropertyvalue&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V95783" title="25% like this...">
    -2
    </div>
  </div>
  <a href="#95783" class="name">
  <strong class="user"><em>Mauro Gabriel Titimoli</em></strong></a><a class="genanchor" href="#95783"> &para;</a><div class="date" title="2010-01-21 12:05"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95783">
<div class="phpcode"><code><span class="html">If you want to change a static property of a variable class...<br /><br />PHP 5.2<br /><span class="default">&lt;?php<br />$reflection </span><span class="keyword">= new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">);<br /></span><span class="default">$staticPropertyReference </span><span class="keyword">= &amp; </span><span class="default">$reflection</span><span class="keyword">-&gt;</span><span class="default">getStaticPropertyValue</span><span class="keyword">(</span><span class="default">$staticPropertyName</span><span class="keyword">);<br /><br /></span><span class="default">$staticPropertyReference </span><span class="keyword">= </span><span class="string">'new value'</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />PHP 5.3<br /><span class="default">&lt;?php<br />$className</span><span class="keyword">::$</span><span class="default">$classProperty<br />?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.getstaticpropertyvalue&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getstaticpropertyvalue.php">＋<small>add a note</small></a></div>
