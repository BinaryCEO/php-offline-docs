...
<head>
  ...
  <title>PHP: Imagick::setImageProperty - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageproperty.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageproperty.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageproperty.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageprofile.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageredprimary.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageproperty.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageproperty.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageproperty.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageproperty.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageproperty.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageproperty.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageproperty.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageproperty.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageproperty.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageproperty.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageproperty.php" hreflang="zh">
...
<meta name="Description" content="Sets an image property" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageProperty - Manual" />
<meta name="twitter:description" content="Sets an image property" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageProperty - Manual" />
<meta itemprop="description" content="Sets an image property" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets an image property" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimageredprimary.php">
          Imagick::setImageRedPrimary &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageprofile.php">
          &laquo; Imagick::setImageProfile        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageproperty.php' selected="selected">English</option>
            <option value='de/imagick.setimageproperty.php'>German</option>
            <option value='es/imagick.setimageproperty.php'>Spanish</option>
            <option value='fr/imagick.setimageproperty.php'>French</option>
            <option value='it/imagick.setimageproperty.php'>Italian</option>
            <option value='ja/imagick.setimageproperty.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageproperty.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageproperty.php'>Russian</option>
            <option value='tr/imagick.setimageproperty.php'>Turkish</option>
            <option value='uk/imagick.setimageproperty.php'>Ukrainian</option>
            <option value='zh/imagick.setimageproperty.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageproperty" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageProperty</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageProperty</span> &mdash; <span class="dc-title">Sets an image property</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimageproperty-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageProperty</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageproperty-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageproperty-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.setimageproperty-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3100">
    <p><strong>Example #1 Using <span class="function"><strong>Imagick::setImageProperty()</strong></span>:</strong></p>
    <div class="example-contents"><p>
     Setting and getting image properties
    </p></div>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$image </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">300</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #DD0000">"black"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageProperty</span><span style="color: #007700">(</span><span style="color: #DD0000">'Exif:Make'</span><span style="color: #007700">, </span><span style="color: #DD0000">'Imagick'</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageProperty</span><span style="color: #007700">(</span><span style="color: #DD0000">'Exif:Make'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.setimageproperty-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.getimageproperty.php" class="function" rel="rdfs-seeAlso">Imagick::getImageProperty()</a> - Returns the named image property</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageproperty.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageproperty%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageproperty&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageproperty.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123346">  <div class="votes">
    <div id="Vu123346">
    <a href="/manual/vote-note.php?id=123346&amp;page=imagick.setimageproperty&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123346">
    <a href="/manual/vote-note.php?id=123346&amp;page=imagick.setimageproperty&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123346" title="75% like this...">
    12
    </div>
  </div>
  <a href="#123346" class="name">
  <strong class="user"><em>Jocke Selin</em></strong></a><a class="genanchor" href="#123346"> &para;</a><div class="date" title="2018-11-15 06:23"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123346">
<div class="phpcode"><code><span class="html">Please be aware that only 'comment' values are written to the file if it's a JPEG. This means that any other data, such as GPS data or Exif data can be 'modified' but will not be written to the file.  This might change in the future, but it hasn't change in 2 years. <br /><br />For reference.<br /><a href="https://github.com/mkoppanen/imagick/issues/124" rel="nofollow" target="_blank">https://github.com/mkoppanen/imagick/issues/124</a> <br /><a href="https://github.com/ImageMagick/ImageMagick/issues/55" rel="nofollow" target="_blank">https://github.com/ImageMagick/ImageMagick/issues/55</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimageproperty&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageproperty.php">＋<small>add a note</small></a></div>
