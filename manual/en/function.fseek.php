...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fseek.php">
 <link rel="shorturl" href="https://www.php.net/fseek">
 <link rel="alternate" href="https://www.php.net/fseek" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fscanf.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fstat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fseek.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fseek.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fseek.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fseek.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fseek.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fseek.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fseek.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fseek.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fseek.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fseek.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fseek.php" hreflang="zh">
...
<meta name="Description" content="Seeks on a file pointer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fseek - Manual" />
<meta name="twitter:description" content="Seeks on a file pointer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fseek - Manual" />
<meta itemprop="description" content="Seeks on a file pointer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Seeks on a file pointer" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fseek.php' selected="selected">English</option>
            <option value='de/function.fseek.php'>German</option>
            <option value='es/function.fseek.php'>Spanish</option>
            <option value='fr/function.fseek.php'>French</option>
            <option value='it/function.fseek.php'>Italian</option>
            <option value='ja/function.fseek.php'>Japanese</option>
            <option value='pt_BR/function.fseek.php'>Brazilian Portuguese</option>
            <option value='ru/function.fseek.php'>Russian</option>
            <option value='tr/function.fseek.php'>Turkish</option>
            <option value='uk/function.fseek.php'>Ukrainian</option>
            <option value='zh/function.fseek.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fseek" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.rewind.php" class="function" rel="rdfs-seeAlso">rewind()</a> - Rewind the position of a file pointer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/fseek.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fseek%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fseek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fseek.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">26 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="81450">  <div class="votes">
    <div id="Vu81450">
    <a href="/manual/vote-note.php?id=81450&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd81450">
    <a href="/manual/vote-note.php?id=81450&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V81450" title="79% like this...">
    83
    </div>
  </div>
  <a href="#81450" class="name">
  <strong class="user"><em>seeker at example com</em></strong></a><a class="genanchor" href="#81450"> &para;</a><div class="date" title="2008-02-28 08:40"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom81450">
<div class="phpcode"><code><span class="html">JUST TO QUOTE AND POINT THIS OUT:<br /><br />!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!<br />3. if you're using fseek() to write data to a file, remember to open the file in "r+" <br />mode, example:<br /><br />  $fp=fopen($filename,"r+");<br /><br />DON'T open the file in mode "a" (for append), because it puts<br /> the file pointer at the end of the file and doesn't let you <br />fseek earlier positions in the file (it didn't for me!). Also, <br />don't open the file in mode "w" -- although this puts you at <br />the beginning of the file -- because it wipes out all data in <br />the file. <br /><br />!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!<br /><br />Took me half a day to figure :/</span></code></div>
  </div>
 </div>
  <div class="note" id="102994">  <div class="votes">
    <div id="Vu102994">
    <a href="/manual/vote-note.php?id=102994&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102994">
    <a href="/manual/vote-note.php?id=102994&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102994" title="80% like this...">
    19
    </div>
  </div>
  <a href="#102994" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#102994"> &para;</a><div class="date" title="2011-03-18 06:56"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102994">
<div class="phpcode"><code><span class="html">The official docs indicate that not all streams are seekable.<br />You can try to seek anyway and handle failure:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">if (</span><span class="default">fseek</span><span class="keyword">(</span><span class="default">$stream</span><span class="keyword">, </span><span class="default">$offset</span><span class="keyword">, </span><span class="default">SEEK_CUR</span><span class="keyword">) === -</span><span class="default">1</span><span class="keyword">) {<br />  </span><span class="comment">// whatever<br /></span><span class="keyword">} <br /></span><span class="default">?&gt;<br /></span><br />Or, you can use the stream_get_meta_data function:<br /><a href="http://php.net/stream_get_meta_data" rel="nofollow" target="_blank">http://php.net/stream_get_meta_data</a><br /><br /><span class="default">&lt;?php <br /></span><span class="keyword">function </span><span class="default">fseekable</span><span class="keyword">(</span><span class="default">$stream</span><span class="keyword">) {<br />  </span><span class="default">$meta </span><span class="keyword">= </span><span class="default">stream_get_meta_data</span><span class="keyword">(</span><span class="default">$stream</span><span class="keyword">);<br />  return </span><span class="default">$meta</span><span class="keyword">[</span><span class="string">'seekable'</span><span class="keyword">];<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="111690">  <div class="votes">
    <div id="Vu111690">
    <a href="/manual/vote-note.php?id=111690&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111690">
    <a href="/manual/vote-note.php?id=111690&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111690" title="80% like this...">
    16
    </div>
  </div>
  <a href="#111690" class="name">
  <strong class="user"><em>lorenzo dot stanco at gmail dot com</em></strong></a><a class="genanchor" href="#111690"> &para;</a><div class="date" title="2013-03-17 06:38"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111690">
<div class="phpcode"><code><span class="html">I want to give my contribution about the "read last lines from a file" topic. I've done some researches (starting from here, really) and run many tests for different algorithms and scenarios, and came up with this:<br /><br />What is the best way in PHP to read last lines from a file?<br /><a href="http://stackoverflow.com/a/15025877/995958" rel="nofollow" target="_blank">http://stackoverflow.com/a/15025877/995958</a><br /><br />In that mini-article I tried to analyze all different methods and their performance over different files.<br /><br />Hope it helps.</span></code></div>
  </div>
 </div>
  <div class="note" id="69008">  <div class="votes">
    <div id="Vu69008">
    <a href="/manual/vote-note.php?id=69008&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd69008">
    <a href="/manual/vote-note.php?id=69008&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V69008" title="80% like this...">
    6
    </div>
  </div>
  <a href="#69008" class="name">
  <strong class="user"><em>marc dot roe at gmail dot com</em></strong></a><a class="genanchor" href="#69008"> &para;</a><div class="date" title="2006-08-19 09:38"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom69008">
<div class="phpcode"><code><span class="html">I tried to improve and modify (mail at ulf-kosack dot de)'s function. Actually it is very fast, i.e. requires much less time than to get the last five, ten or whatever lines of a file using file() ore file_get_contents().<br /><br />function read_file($file, $lines)<br />{<br />       $handle = fopen($file, "r");<br />       $linecounter = $lines;<br />       $pos = -2;<br />       $beginning = false;<br />       $text = array();<br />       while ($linecounter &gt; 0) {<br />         $t = " ";<br />         while ($t != "\n") {<br />           if(fseek($handle, $pos, SEEK_END) == -1) {<br />$beginning = true; break; }<br />           $t = fgetc($handle);<br />           $pos --;<br />         }<br />         $linecounter --;<br />         if($beginning) rewind($handle);<br />         $text[$lines-$linecounter-1] = fgets($handle);<br />         if($beginning break;<br />       }<br />       fclose ($handle);<br />       return array_reverse($text); // array_reverse is optional: you can also just return the $text array which consists of the file's lines. <br />}<br /><br />The good thing now is, that you don't get an error when your requesting more lines than the file contains. In this case the function will just return the whole file content.</span></code></div>
  </div>
 </div>
  <div class="note" id="115516">  <div class="votes">
    <div id="Vu115516">
    <a href="/manual/vote-note.php?id=115516&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115516">
    <a href="/manual/vote-note.php?id=115516&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115516" title="73% like this...">
    11
    </div>
  </div>
  <a href="#115516" class="name">
  <strong class="user"><em>synnus at gmail dot com</em></strong></a><a class="genanchor" href="#115516"> &para;</a><div class="date" title="2014-08-07 03:54"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115516">
<div class="phpcode"><code><span class="html">Write Dummy File 4GB in Php 32bits (X86)<br />if you want write more GB File (&gt;4GB), use Php(X64) .<br />this file is created in 0.0041329860687256 second<br /><br />CreatFileDummy('data_test.txt',4294967296);<br /><br />FUNCTION CreatFileDummy($file_name,$size) {    <br />// 32bits 4 294 967 296 bytes MAX Size <br />    $f = fopen($file_name, 'wb');<br />    if($size &gt;= 1000000000)  {<br />        $z = ($size / 1000000000);        <br />        if (is_float($z))  { <br />            $z = round($z,0);<br />            fseek($f, ( $size - ($z * 1000000000) -1 ), SEEK_END);<br />            fwrite($f, "\0");<br />        }        <br />        while(--$z &gt; -1) {<br />            fseek($f, 999999999, SEEK_END);<br />            fwrite($f, "\0");<br />        }<br />    } <br />    else {<br />        fseek($f, $size - 1, SEEK_END);<br />        fwrite($f, "\0");<br />    }<br />    fclose($f);<br /><br />Return true;<br />}<br /><br />Synx</span></code></div>
  </div>
 </div>
  <div class="note" id="82469">  <div class="votes">
    <div id="Vu82469">
    <a href="/manual/vote-note.php?id=82469&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd82469">
    <a href="/manual/vote-note.php?id=82469&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V82469" title="76% like this...">
    7
    </div>
  </div>
  <a href="#82469" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#82469"> &para;</a><div class="date" title="2008-04-11 10:45"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom82469">
<div class="phpcode"><code><span class="html">To:seeker at example com<br />Be careful, though. <br />You can freely position you pointer if you open a file in (r+) mode, but it will "overwrite" the data, not "append it".<br /><br />Tested this:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// file.txt content:<br />// "You can contribute your notes to the PHP manual from the comfort of your browser!"<br /><br /></span><span class="default">$handler </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">"file.txt"</span><span class="keyword">, </span><span class="string">"r+"</span><span class="keyword">);<br /></span><span class="default">fseek</span><span class="keyword">(</span><span class="default">$handler</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">$handler</span><span class="keyword">, </span><span class="string">"want to add this"</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span>New contents of the file.txt will be like this:<br />"want to add thiste your notes to the PHP manual from the comfort of your browser!".<br /><br />If you really want to append at the beginning, you have to first get all the contents, save it, clear the file, put the new contents and append the saved contents at the end.</span></code></div>
  </div>
 </div>
  <div class="note" id="49992">  <div class="votes">
    <div id="Vu49992">
    <a href="/manual/vote-note.php?id=49992&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd49992">
    <a href="/manual/vote-note.php?id=49992&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V49992" title="70% like this...">
    4
    </div>
  </div>
  <a href="#49992" class="name">
  <strong class="user"><em>Lutz ( l_broedel at gmx dot net )</em></strong></a><a class="genanchor" href="#49992"> &para;</a><div class="date" title="2005-02-14 02:25"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom49992">
<div class="phpcode"><code><span class="html">Based on the function below, provided by info at o08 dot com (thanks), the following should enable you to read a single line from a file, identified by the line number (starting with 1):<br /><br />&lt;?<br />    function readLine ($linenum,$fh) {<br />        $line = fgets ($fh, 4096);<br />        $pos = -1;<br />        $i = 0;<br /><br />        while (!feof($fh) &amp;&amp; $i&lt;($linenum-1)) {<br />            $char = fgetc($fh);<br />            if ($char != "\n" &amp;&amp; $char != "\r") {<br />                fseek($fh, $pos, SEEK_SET);<br />                $pos ++;<br />            }<br />            else $i ++; <br />        }<br />        $line = fgets($fh);<br />        return $line;<br />    } //readLine()<br />?&gt;</span></code></div>
  </div>
 </div>
  <div class="note" id="25250">  <div class="votes">
    <div id="Vu25250">
    <a href="/manual/vote-note.php?id=25250&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd25250">
    <a href="/manual/vote-note.php?id=25250&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V25250" title="70% like this...">
    4
    </div>
  </div>
  <a href="#25250" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#25250"> &para;</a><div class="date" title="2002-09-16 01:25"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom25250">
<div class="phpcode"><code><span class="html">Don't use filesize() on files that may be accessed and updated by parallel processes or threads (as the filesize() return value is maintained in a cache).<br />Instead lock the opened file and use fseek($fp,0,SEEK_END) and ftell($fp) to get the actual filesize if you need to perform a fread() call to read the whole file...</span></code></div>
  </div>
 </div>
  <div class="note" id="112647">  <div class="votes">
    <div id="Vu112647">
    <a href="/manual/vote-note.php?id=112647&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112647">
    <a href="/manual/vote-note.php?id=112647&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112647" title="58% like this...">
    5
    </div>
  </div>
  <a href="#112647" class="name">
  <strong class="user"><em>me at php dot net</em></strong></a><a class="genanchor" href="#112647"> &para;</a><div class="date" title="2013-07-09 09:14"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112647">
<div class="phpcode"><code><span class="html">how to read BIG files using fseek (above 2GB+, upto any size like 4GB+, 100GB+, 100 terabyes+, any file size, 100 petabytes, max limit is php_float_max ) ?<br /><br />// seek / set file pointer to 50 GB<br />my_fseek($fp, floatval(50000000000),1);<br /><br />function my_fseek($fp,$pos,$first=0) {<br /><br />// set to 0 pos initially, one-time<br />if($first) fseek($fp,0,SEEK_SET);<br /><br />// get pos float value<br />$pos=floatval($pos);<br /><br /> // within limits, use normal fseek<br />if($pos&lt;=PHP_INT_MAX)<br />  fseek($fp,$pos,SEEK_CUR);<br /> // out of limits, use recursive fseek<br />else {<br />  fseek($fp,PHP_INT_MAX,SEEK_CUR);<br />  $pos -= PHP_INT_MAX;<br />  my_fseek($fp,$pos);<br />}<br /><br />}<br /><br />hope this helps.</span></code></div>
  </div>
 </div>
  <div class="note" id="90450">  <div class="votes">
    <div id="Vu90450">
    <a href="/manual/vote-note.php?id=90450&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd90450">
    <a href="/manual/vote-note.php?id=90450&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V90450" title="57% like this...">
    1
    </div>
  </div>
  <a href="#90450" class="name">
  <strong class="user"><em>Tom Pittlik</em></strong></a><a class="genanchor" href="#90450"> &para;</a><div class="date" title="2009-04-23 12:32"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom90450">
<div class="phpcode"><code><span class="html">The tail example functions below will return a PHP memory limit error when trying to open large files. Since tail is convenient for opening large logs, here is a function that lets you (provided you have permission):
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="106336">  <div class="votes">
    <div id="Vu106336">
    <a href="/manual/vote-note.php?id=106336&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106336">
    <a href="/manual/vote-note.php?id=106336&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106336" title="54% like this...">
    1
    </div>
  </div>
  <a href="#106336" class="name">
  <strong class="user"><em>kavoshgar3 at gmail dot com</em></strong></a><a class="genanchor" href="#106336"> &para;</a><div class="date" title="2011-10-28 09:06"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106336">
<div class="phpcode"><code><span class="html">sometimes we want read file from last line to beginning of file.I use the following.<br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">read_backward_line</span><span class="keyword">(</span><span class="default">$filename</span><span class="keyword">, </span><span class="default">$lines</span><span class="keyword">, </span><span class="default">$revers </span><span class="keyword">= </span><span class="default">false</span><span class="keyword">)<br />{<br />    </span><span class="default">$offset </span><span class="keyword">= -</span><span class="default">1</span><span class="keyword">;<br />    </span><span class="default">$c </span><span class="keyword">= </span><span class="string">''</span><span class="keyword">;<br />    </span><span class="default">$read </span><span class="keyword">= </span><span class="string">''</span><span class="keyword">;<br />    </span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />    </span><span class="default">$fp </span><span class="keyword">= @</span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$filename</span><span class="keyword">, </span><span class="string">"r"</span><span class="keyword">);<br />    while( </span><span class="default">$lines </span><span class="keyword">&amp;&amp; </span><span class="default">fseek</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">, </span><span class="default">$offset</span><span class="keyword">, </span><span class="default">SEEK_END</span><span class="keyword">) &gt;= </span><span class="default">0 </span><span class="keyword">) {<br />        </span><span class="default">$c </span><span class="keyword">= </span><span class="default">fgetc</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">);<br />        if(</span><span class="default">$c </span><span class="keyword">== </span><span class="string">"\n" </span><span class="keyword">|| </span><span class="default">$c </span><span class="keyword">== </span><span class="string">"\r"</span><span class="keyword">){<br />            </span><span class="default">$lines</span><span class="keyword">--;<br />            if( </span><span class="default">$revers </span><span class="keyword">){<br />                </span><span class="default">$read</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">] = </span><span class="default">strrev</span><span class="keyword">(</span><span class="default">$read</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]);<br />                </span><span class="default">$i</span><span class="keyword">++;<br />            }<br />        }<br />        if( </span><span class="default">$revers </span><span class="keyword">) </span><span class="default">$read</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">] .= </span><span class="default">$c</span><span class="keyword">;<br />        else </span><span class="default">$read </span><span class="keyword">.= </span><span class="default">$c</span><span class="keyword">;<br />        </span><span class="default">$offset</span><span class="keyword">--;<br />    }<br />    </span><span class="default">fclose </span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">);<br />    if( </span><span class="default">$revers </span><span class="keyword">){<br />        if(</span><span class="default">$read</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">] == </span><span class="string">"\n" </span><span class="keyword">|| </span><span class="default">$read</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">] == </span><span class="string">"\r"</span><span class="keyword">)<br />            </span><span class="default">array_pop</span><span class="keyword">(</span><span class="default">$read</span><span class="keyword">);<br />        else </span><span class="default">$read</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">] = </span><span class="default">strrev</span><span class="keyword">(</span><span class="default">$read</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]);<br />        return </span><span class="default">implode</span><span class="keyword">(</span><span class="string">''</span><span class="keyword">,</span><span class="default">$read</span><span class="keyword">);<br />    }<br />    return </span><span class="default">strrev</span><span class="keyword">(</span><span class="default">rtrim</span><span class="keyword">(</span><span class="default">$read</span><span class="keyword">,</span><span class="string">"\n\r"</span><span class="keyword">));<br />}<br /></span><span class="comment">//if $revers=false function return-&gt;<br />//line 1000: i am line of 1000<br />//line 1001: and i am line of 1001<br />//line 1002: and i am last line<br />//but if $revers=true function return-&gt;<br />//line 1002: and i am last line<br />//line 1001: and i am line of 1001<br />//line 1000: i am line of 1000<br /></span><span class="default">?&gt;<br /></span>Enjoy! Mail me if it works!  ;-)</span></code></div>
  </div>
 </div>
  <div class="note" id="129900">  <div class="votes">
    <div id="Vu129900">
    <a href="/manual/vote-note.php?id=129900&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129900">
    <a href="/manual/vote-note.php?id=129900&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129900" title="100% like this...">
    1
    </div>
  </div>
  <a href="#129900" class="name">
  <strong class="user"><em>Raven dot Singularity at NOSPAM dot gmail dot com</em></strong></a><a class="genanchor" href="#129900"> &para;</a><div class="date" title="2024-12-06 07:07"><strong>9 months ago</strong></div>
  <div class="text" id="Hcom129900">
<div class="phpcode"><code><span class="html">WARNING: The return values for this function are backwards from what is expected in PHP!<br /><br /><span class="default">&lt;?php<br /><br />   </span><span class="keyword">if (!</span><span class="default">fseek</span><span class="keyword">(</span><span class="default">$File_Handle</span><span class="keyword">, </span><span class="default">$Position</span><span class="keyword">)) {<br />      die(</span><span class="string">"Could not seek in file."</span><span class="keyword">);<br />   }<br /><br /></span><span class="default">?&gt;<br /></span><br />This will die when it succeeds, and continue when it fails.  This is because the return values for fseek() are backwards from other PHP functions.  This function returns 0 (FALSE) on success, and -1 (TRUE) on failure.<br /><br />This needs a big red warning box similar to other functions that return FALSE on failure and 0 or above on success.  I submitted a documentation issue.<br /><br />This works for checking for errors:<br /><br /><span class="default">&lt;?php<br /><br />   </span><span class="keyword">if (</span><span class="default">fseek</span><span class="keyword">(</span><span class="default">$File_Handle</span><span class="keyword">, </span><span class="default">$Position</span><span class="keyword">) === -</span><span class="default">1</span><span class="keyword">) {<br />      die(</span><span class="string">"Could not seek in file."</span><span class="keyword">);<br />   }<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="119511">  <div class="votes">
    <div id="Vu119511">
    <a href="/manual/vote-note.php?id=119511&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119511">
    <a href="/manual/vote-note.php?id=119511&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119511" title="50% like this...">
    0
    </div>
  </div>
  <a href="#119511" class="name">
  <strong class="user"><em>marin at sagovac dot com</em></strong></a><a class="genanchor" href="#119511"> &para;</a><div class="date" title="2016-06-26 01:33"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119511">
<div class="phpcode"><code><span class="html">Seek to a line of code than break from while to improve performance. Seek to specific line using SEEK_SET and get a specific line. If $range is '0' than will show seeked line. If set to '2' it will show current line + 2 lines above + 2 lines below.<br /><br />Useful for get a content of a file in very huge file to get lines range. To improve performance a while loop breaks from iteration than go for seeking.<br /><br />I've created a function that read a file and count lines and store into arrays each lines bytes to seek. If maximum specified by `linenum` is set, it will break from while to keep performance than in a new loop function to seek a position in bytes to get a content of file.<br /><br />    function readFileSeek($source, $linenum = 0, $range = 0)<br />    {<br />        $fh = fopen($source, 'r');<br />        $meta = stream_get_meta_data($fh);<br />        <br />        if (!$meta['seekable']) {<br />            throw new Exception(sprintf("A source is not seekable: %s", print_r($source, true)));<br />        }<br />        <br />        $pos = 2;<br />        $result = null;<br />        <br />        if ($linenum) {<br />            $minline = $linenum - $range - 1;<br />            $maxline = $minline+$range+$range;<br />        }<br />        <br />        $totalLines = 0;<br />        while (!feof($fh)) {<br />        <br />            $char = fgetc($fh);<br />            <br />            if ($char == "\n" || $char == "\r") {<br />                ++$totalLines;<br />            } else {<br />                $result[$totalLines] = $pos;   <br />            }<br />            $pos++;<br />            <br />            if ($maxline+1 == $totalLines) {<br />                // break from while to not read entire file<br />                break;<br />            }<br />        }<br />        <br />        $buffer = '';<br />        <br />        for ($nr=$minline; $nr&lt;=$maxline; $nr++) {<br />            <br />            if (isset($result[$nr])) {<br />            <br />                fseek($fh, $result[$nr], SEEK_SET);<br /><br />                while (!feof($fh)) {<br />                    $char = fgetc($fh);<br /><br />                    if ($char == "\n" || $char == "\r") {<br />                        $buffer .= $char;<br />                        break;<br />                    } else {<br />                        $buffer .= $char;<br />                    }<br />                }<br />            <br />            }<br />        }<br />        <br />        return $buffer;<br />    }<br /><br />Test results (1.3 GB file, 100000000 lines of codes, seek to 300000 line a code):<br /><br />    string(55) "299998_abc<br />    299999_abc<br />    300000_abc<br />    300001_abc<br />    300002_abc<br />    "<br />    <br />    Time: 612 ms, Memory: 20.00Mb<br />    <br />    $ ll -h /tmp/testfile<br />    -rw-rw-r-- 1  1,3G /tmp/testfile</span></code></div>
  </div>
 </div>
  <div class="note" id="54199">  <div class="votes">
    <div id="Vu54199">
    <a href="/manual/vote-note.php?id=54199&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd54199">
    <a href="/manual/vote-note.php?id=54199&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V54199" title="100% like this...">
    2
    </div>
  </div>
  <a href="#54199" class="name">
  <strong class="user"><em>chenganeyou at eyou dot com</em></strong></a><a class="genanchor" href="#54199"> &para;</a><div class="date" title="2005-06-27 01:35"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom54199">
<div class="phpcode"><code><span class="html">I use the following codes to read the last line of a file.<br />Compared to jim at lfchosting dot com, it should be more efficient.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">readlastline</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">)<br />{<br />       </span><span class="default">$linecontent </span><span class="keyword">= </span><span class="string">" "</span><span class="keyword">;<br />       </span><span class="default">$contents </span><span class="keyword">= </span><span class="default">file</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">);<br />       </span><span class="default">$linenumber </span><span class="keyword">= </span><span class="default">sizeof</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">)-</span><span class="default">1</span><span class="keyword">;<br />       </span><span class="default">$linecontet </span><span class="keyword">= </span><span class="default">$contents</span><span class="keyword">[</span><span class="default">$linenumber</span><span class="keyword">];<br />       unset(</span><span class="default">$contents</span><span class="keyword">,</span><span class="default">$linenumber</span><span class="keyword">);<br />       return </span><span class="default">$linecontent</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="86517">  <div class="votes">
    <div id="Vu86517">
    <a href="/manual/vote-note.php?id=86517&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd86517">
    <a href="/manual/vote-note.php?id=86517&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V86517" title="50% like this...">
    0
    </div>
  </div>
  <a href="#86517" class="name">
  <strong class="user"><em>ben at nullcreations dot net</em></strong></a><a class="genanchor" href="#86517"> &para;</a><div class="date" title="2008-10-22 02:38"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86517">
<div class="phpcode"><code><span class="html">easier tail() function for php:
<br />
<br /><span class="default">&lt;?php
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="59619">  <div class="votes">
    <div id="Vu59619">
    <a href="/manual/vote-note.php?id=59619&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd59619">
    <a href="/manual/vote-note.php?id=59619&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V59619" title="50% like this...">
    0
    </div>
  </div>
  <a href="#59619" class="name">
  <strong class="user"><em>ekow[at]te.ugm.ac.id</em></strong></a><a class="genanchor" href="#59619"> &para;</a><div class="date" title="2005-12-11 05:22"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom59619">
<div class="phpcode"><code><span class="html">A little correction for code to read last line from chenganeyou at eyou dot com.<br />$linenumber = sizeof($file)-1;<br />should be<br />$linenumber = sizeof($contents)-1;<br />because sizeof will count array element, not file size.<br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">readlastline</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">)<br />{<br />       </span><span class="default">$linecontent </span><span class="keyword">= </span><span class="string">" "</span><span class="keyword">;<br />       </span><span class="default">$contents </span><span class="keyword">= </span><span class="default">file</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">);<br />       </span><span class="default">$linenumber </span><span class="keyword">= </span><span class="default">sizeof</span><span class="keyword">(</span><span class="default">$contents</span><span class="keyword">)-</span><span class="default">1</span><span class="keyword">;<br />       </span><span class="default">$linecontet </span><span class="keyword">= </span><span class="default">$contents</span><span class="keyword">[</span><span class="default">$linenumber</span><span class="keyword">];<br />       unset(</span><span class="default">$contents</span><span class="keyword">,</span><span class="default">$linenumber</span><span class="keyword">);<br />       return </span><span class="default">$linecontent</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="53220">  <div class="votes">
    <div id="Vu53220">
    <a href="/manual/vote-note.php?id=53220&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd53220">
    <a href="/manual/vote-note.php?id=53220&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V53220" title="50% like this...">
    0
    </div>
  </div>
  <a href="#53220" class="name">
  <strong class="user"><em>phil at NOSPAM dot blisswebhosting dot com</em></strong></a><a class="genanchor" href="#53220"> &para;</a><div class="date" title="2005-05-25 08:43"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom53220">
<div class="phpcode"><code><span class="html">In order to read a text file from end-&gt;beginning e.g display the most recent contents of a log file first.  I use the following.<br /><br />It basically just uses fseek to find the end of the file, ftell to find the byte count for a counter, then iterates backwards through the file using fgetc to test for the newline charater.<br /><br />$i=0 ;<br />$lines=500 ;<br />$fp = fopen($log,"r") ;<br />if(is_resource($fp)){<br />    fseek($fp,0,SEEK_END) ;<br />    $a = ftell($fp) ;<br />    while($i &lt;= $lines){<br />        if(fgetc($fp) == "\n"){<br />            echo (fgets($fp));<br />            $i++ ;<br />        }<br />    fseek($fp,$a) ;<br />    $a-- ;<br />    }<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="52929">  <div class="votes">
    <div id="Vu52929">
    <a href="/manual/vote-note.php?id=52929&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd52929">
    <a href="/manual/vote-note.php?id=52929&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V52929" title="50% like this...">
    0
    </div>
  </div>
  <a href="#52929" class="name">
  <strong class="user"><em>alan at peaceconstitution.com</em></strong></a><a class="genanchor" href="#52929"> &para;</a><div class="date" title="2005-05-17 06:03"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom52929">
<div class="phpcode"><code><span class="html">Thanks to Dan, whose above comment provided a key to solve the issue of how to append to a file. <br />     After, using phpinfo(); I made sure my installation of PHP had the requisite settings mentioned in the text to the manual entry for fopen(), I was puzzled as to why my use of fopen() with the append option 'a' (append option) didn't work. Then I  read a comment contributed to Appendix L (<a href="http://us2.php.net/manual/en/wrappers.php" rel="nofollow" target="_blank">http://us2.php.net/manual/en/wrappers.php</a>) that the append option 'a' for fopen() doesn't work as expected. The writer suggested using the 'w' option instead, which I found did work. But the 'w' option (write option) overwrites everything in the file.<br />     The question remained how to accomplish appending. Following Dan's suggestion about the 'r+' option, I tried this, which works fine:<br />       $string = "Message to write to log";<br />       $filehandle = fopen ("/home/name/sqllogs/phpsqlerr.txt", 'r+');<br />    fseek ( $filehandle,0, SEEK_END);<br />    fwrite ( $filehandle, $string."\n" );<br />    fclose ($filehandle);</span></code></div>
  </div>
 </div>
  <div class="note" id="37147">  <div class="votes">
    <div id="Vu37147">
    <a href="/manual/vote-note.php?id=37147&amp;page=function.fseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd37147">
    <a href="/manual/vote-note.php?id=37147&amp;page=function.fseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V37147" title="50% like this...">
    0
    </div>
  </div>
  <a href="#37147" class="name">
  <strong class="user"><em>jim at lfchosting dot com</em></strong></a><a class="genanchor" href="#37147"> &para;</a><div class="date" title="2003-11-04 06:03"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom37147">
<div class="phpcode"><code><span class="html">Here is a function that returns the last line of a file.  This should be quicker than reading the whole file till you get to the last line.  If you want to speed it up a bit, you can set the $pos = some number that is just greater than the line length.  The files I was dealing with were various lengths, so this worked for me.
<br />
<br /><span class="default">&lt;?php
