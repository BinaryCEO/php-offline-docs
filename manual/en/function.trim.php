...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trim.php">
 <link rel="shorturl" href="https://www.php.net/trim">
 <link rel="alternate" href="https://www.php.net/trim" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.strings.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.substr-replace.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ucfirst.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trim.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trim.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trim.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trim.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trim.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trim.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trim.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trim.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trim.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trim.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trim.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: trim - Manual" />
...
<meta itemprop="name" content="PHP: trim - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trim.php' selected="selected">English</option>
            <option value='de/function.trim.php'>German</option>
            <option value='es/function.trim.php'>Spanish</option>
            <option value='fr/function.trim.php'>French</option>
            <option value='it/function.trim.php'>Italian</option>
            <option value='ja/function.trim.php'>Japanese</option>
            <option value='pt_BR/function.trim.php'>Brazilian Portuguese</option>
            <option value='ru/function.trim.php'>Russian</option>
            <option value='tr/function.trim.php'>Turkish</option>
            <option value='uk/function.trim.php'>Ukrainian</option>
            <option value='zh/function.trim.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trim" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.str-replace.php" class="function" rel="rdfs-seeAlso">str_replace()</a> - Replace all occurrences of the search string with the replacement string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/trim.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trim%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trim&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trim.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128441">  <div class="votes">
    <div id="Vu128441">
    <a href="/manual/vote-note.php?id=128441&amp;page=function.trim&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128441">
    <a href="/manual/vote-note.php?id=128441&amp;page=function.trim&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128441" title="62% like this...">
    14
    </div>
  </div>
  <a href="#128441" class="name">
  <strong class="user"><em>pcoates at yukon1000 dot com</em></strong></a><a class="genanchor" href="#128441"> &para;</a><div class="date" title="2023-05-01 07:23"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128441">
<div class="phpcode"><code><span class="html">note there is a behaviour change in php 8<br /><br />You used to be able to say:<br />$p1 = trim($_POST['p1']);<br />This will now throw deprecated warnings if parameter p1 is not set. It is better to say:<br />$p1 = trim($_POST['p1']??'');<br />or <br />$p1 = isset($_POST['p1']) ? trim($_POST['p1']) : null;<br />or<br />$p1 = isset($_POST['p1']) ? trim($_POST['p1']) : '';</span></code></div>
  </div>
 </div>
  <div class="note" id="128656">  <div class="votes">
    <div id="Vu128656">
    <a href="/manual/vote-note.php?id=128656&amp;page=function.trim&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128656">
    <a href="/manual/vote-note.php?id=128656&amp;page=function.trim&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128656" title="53% like this...">
    2
    </div>
  </div>
  <a href="#128656" class="name">
  <strong class="user"><em>gwyneth dot llewelyn at gwynethllewelyn dot net</em></strong></a><a class="genanchor" href="#128656"> &para;</a><div class="date" title="2023-07-03 07:04"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128656">
<div class="phpcode"><code><span class="html">Note that trim() is not aware of Unicode points that represent whitespace (e.g., in the General Punctuation block), except, of course, for the ones mentioned in this page.<br /><br />There is no Unicode-specific trim function in PHP at the time of writing (July 2023), but you can try some examples of trims using multibyte strings posted on the comments for the mbstring extension: <a href="https://www.php.net/manual/en/ref.mbstring.php" rel="nofollow" target="_blank">https://www.php.net/manual/en/ref.mbstring.php</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trim&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trim.php">＋<small>add a note</small></a></div>
