...
<head>
  ...
  <title>PHP: mysql_error - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-error.php">
 <link rel="shorturl" href="https://www.php.net/mysql-error">
 <link rel="alternate" href="https://www.php.net/mysql-error" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-errno.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-escape-string.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-error.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-error.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-error.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-error.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-error.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-error.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-error.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-error.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-error.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-error.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-error.php" hreflang="zh">
...
<meta name="Description" content="Returns the text of the error message from previous MySQL operation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_error - Manual" />
<meta name="twitter:description" content="Returns the text of the error message from previous MySQL operation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_error - Manual" />
<meta itemprop="description" content="Returns the text of the error message from previous MySQL operation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the text of the error message from previous MySQL operation" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-escape-string.php">
          mysql_escape_string &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-errno.php">
          &laquo; mysql_errno        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-error.php' selected="selected">English</option>
            <option value='de/function.mysql-error.php'>German</option>
            <option value='es/function.mysql-error.php'>Spanish</option>
            <option value='fr/function.mysql-error.php'>French</option>
            <option value='it/function.mysql-error.php'>Italian</option>
            <option value='ja/function.mysql-error.php'>Japanese</option>
            <option value='pt_BR/function.mysql-error.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-error.php'>Russian</option>
            <option value='tr/function.mysql-error.php'>Turkish</option>
            <option value='uk/function.mysql-error.php'>Ukrainian</option>
            <option value='zh/function.mysql-error.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-error" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_error</h1>
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_error</span> &mdash; <span class="dc-title">Returns the text of the error message from previous MySQL operation</span></p>

 </div>

 <div id="function.mysql-error-refsynopsisdiv">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli.error.php" class="function">mysqli_error()</a></span></li>
    <li><span class="methodname"><a href="pdo.errorinfo.php" class="methodname">PDO::errorInfo()</a></span></li>
   </ul>
  </div>
 </div>

 <div class="refsect1 description" id="refsect1-function.mysql-error-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_error</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$link_identifier</code><span class="initializer"> = NULL</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   Returns the error text from the last MySQL function.
   Errors coming back from the MySQL database backend no longer
   issue warnings. Instead, use <span class="function"><strong>mysql_error()</strong></span> to
   ...
   including <span class="function"><strong>mysql_error()</strong></span> and
   <span class="function"><a href="function.mysql-errno.php" class="function">mysql_errno()</a></span>), so if you want to use it, make
   sure you check the value before calling another MySQL function.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.mysql-error-parameters">
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> level error is generated.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-error-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the error text from the last MySQL function, or
   <code class="literal">&#039;&#039;</code> (empty string) if no error occurred.
  </p>
 </div>


  <div class="refsect1 examples" id="refsect1-function.mysql-error-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1887">
    <p><strong>Example #1 <span class="function"><strong>mysql_error()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">1049: Unknown database &#039;nonexistentdb&#039;
1146: Table &#039;kossu.nonexistenttable&#039; doesn&#039;t exist</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mysql-error-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.mysql-errno.php" class="function" rel="rdfs-seeAlso">mysql_errno()</a> - Returns the numerical value of the error message from previous MySQL operation</span></li>
    <li><a href="http://dev.mysql.com/doc/mysql/en/error-handling.html" class="link external">&raquo;&nbsp;MySQL error codes</a></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-error.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-error%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-error&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-error.php">＋<small>add a note</small></a></span>
