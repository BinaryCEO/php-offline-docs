...
<head>
  ...
  <title>PHP: Imagick::identifyFormat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.identifyformat.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.identifyformat.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.identifyformat.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.haspreviousimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.identifyimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.identifyformat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.identifyformat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.identifyformat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.identifyformat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.identifyformat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.identifyformat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.identifyformat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.identifyformat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.identifyformat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.identifyformat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.identifyformat.php" hreflang="zh">
...
<meta name="Description" content="Formats a string with image details" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::identifyFormat - Manual" />
<meta name="twitter:description" content="Formats a string with image details" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::identifyFormat - Manual" />
<meta itemprop="description" content="Formats a string with image details" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Formats a string with image details" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.identifyimage.php">
          Imagick::identifyImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.haspreviousimage.php">
          &laquo; Imagick::hasPreviousImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.identifyformat.php' selected="selected">English</option>
            <option value='de/imagick.identifyformat.php'>German</option>
            <option value='es/imagick.identifyformat.php'>Spanish</option>
            <option value='fr/imagick.identifyformat.php'>French</option>
            <option value='it/imagick.identifyformat.php'>Italian</option>
            <option value='ja/imagick.identifyformat.php'>Japanese</option>
            <option value='pt_BR/imagick.identifyformat.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.identifyformat.php'>Russian</option>
            <option value='tr/imagick.identifyformat.php'>Turkish</option>
            <option value='uk/imagick.identifyformat.php'>Ukrainian</option>
            <option value='zh/imagick.identifyformat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.identifyformat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::identifyFormat</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::identifyFormat</span> &mdash; <span class="dc-title">Formats a string with image details</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.identifyformat-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::identifyFormat</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$embedText</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.identifyformat-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">embedText</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.identifyformat-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns format or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.identifyformat-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3020">
      <p><strong>Example #1  <span class="function"><strong>Imagick::identifyFormat()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $output </span><span style="color: #007700">= </span><span style="color: #DD0000">"Output of 'Trim box: %@ number of unique colors: %k' is: &lt;br/&gt;"</span><span style="color: #007700">;<br />        </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #DD0000">"./images/artifact/mask.png"</span><span style="color: #007700">));<br />        </span><span style="color: #0000BB">$output </span><span style="color: #007700">.= </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">identifyFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">"Trim box: %@ number of unique colors: %k"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/identifyformat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.identifyformat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.identifyformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.identifyformat.php">＋<small>add a note</small></a></span>
