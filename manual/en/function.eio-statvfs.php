...
<head>
  ...
  <title>PHP: eio_statvfs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-statvfs.php">
 <link rel="shorturl" href="https://www.php.net/eio-statvfs">
 <link rel="alternate" href="https://www.php.net/eio-statvfs" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-stat.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-symlink.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-statvfs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-statvfs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-statvfs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-statvfs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-statvfs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-statvfs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-statvfs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-statvfs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-statvfs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-statvfs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-statvfs.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: eio_statvfs - Manual" />
<meta name="twitter:description" content="Get file system statistics" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_statvfs - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-symlink.php">
          eio_symlink &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-statvfs.php' selected="selected">English</option>
            <option value='de/function.eio-statvfs.php'>German</option>
            <option value='es/function.eio-statvfs.php'>Spanish</option>
            <option value='fr/function.eio-statvfs.php'>French</option>
            <option value='it/function.eio-statvfs.php'>Italian</option>
            <option value='ja/function.eio-statvfs.php'>Japanese</option>
            <option value='pt_BR/function.eio-statvfs.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-statvfs.php'>Russian</option>
            <option value='tr/function.eio-statvfs.php'>Turkish</option>
            <option value='uk/function.eio-statvfs.php'>Ukrainian</option>
            <option value='zh/function.eio-statvfs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-statvfs" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-statvfs-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_statvfs</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-statvfs-returnvalues">
  ...
  <p class="para">
  <span class="function"><strong>eio_statvfs()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure. 
   On success assigns <code class="parameter">result</code> argument of
...
<div class="examplescode"><pre class="examplescode">string(17) &quot;/tmp/eio-file.tmp&quot;
array(11) {
  [&quot;f_bsize&quot;]=&gt;
  int(4096)
  [&quot;f_frsize&quot;]=&gt;
  ...
  int(255)
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-statvfs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-statvfs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-statvfs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-statvfs.php">＋<small>add a note</small></a></span>
