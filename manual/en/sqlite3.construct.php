...
<head>
  ...
  <title>PHP: SQLite3::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/sqlite3.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/sqlite3.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/sqlite3.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.sqlite3.php">
 <link rel="prev" href="https://www.php.net/manual/en/sqlite3.close.php">
 <link rel="next" href="https://www.php.net/manual/en/sqlite3.createaggregate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/sqlite3.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/sqlite3.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/sqlite3.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/sqlite3.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/sqlite3.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/sqlite3.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/sqlite3.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/sqlite3.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/sqlite3.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/sqlite3.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/sqlite3.construct.php" hreflang="zh">
...
<meta name="Description" content="Instantiates an SQLite3 object and opens an SQLite 3 database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SQLite3::__construct - Manual" />
<meta name="twitter:description" content="Instantiates an SQLite3 object and opens an SQLite 3 database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SQLite3::__construct - Manual" />
<meta itemprop="description" content="Instantiates an SQLite3 object and opens an SQLite 3 database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Instantiates an SQLite3 object and opens an SQLite 3 database" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="sqlite3.createaggregate.php">
          SQLite3::createAggregate &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="sqlite3.close.php">
          &laquo; SQLite3::close        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/sqlite3.construct.php' selected="selected">English</option>
            <option value='de/sqlite3.construct.php'>German</option>
            <option value='es/sqlite3.construct.php'>Spanish</option>
            <option value='fr/sqlite3.construct.php'>French</option>
            <option value='it/sqlite3.construct.php'>Italian</option>
            <option value='ja/sqlite3.construct.php'>Japanese</option>
            <option value='pt_BR/sqlite3.construct.php'>Brazilian Portuguese</option>
            <option value='ru/sqlite3.construct.php'>Russian</option>
            <option value='tr/sqlite3.construct.php'>Turkish</option>
            <option value='uk/sqlite3.construct.php'>Ukrainian</option>
            <option value='zh/sqlite3.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="sqlite3.construct" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$db </span><span style="color: #007700">= new </span><span style="color: #0000BB">SQLite3</span><span style="color: #007700">(</span><span style="color: #DD0000">'mysqlitedb.db'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$db</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">exec</span><span style="color: #007700">(</span><span style="color: #DD0000">'CREATE TABLE foo (bar TEXT)'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$db</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">exec</span><span style="color: #007700">(</span><span style="color: #DD0000">"INSERT INTO foo (bar) VALUES ('This is a test')"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">$db</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">query</span><span style="color: #007700">(</span><span style="color: #DD0000">'SELECT bar FROM foo'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">fetchArray</span><span style="color: #007700">());<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlite3/sqlite3/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsqlite3.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=sqlite3.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/sqlite3.construct.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="104000">  <div class="votes">
    <div id="Vu104000">
    <a href="/manual/vote-note.php?id=104000&amp;page=sqlite3.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104000">
    <a href="/manual/vote-note.php?id=104000&amp;page=sqlite3.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104000" title="58% like this...">
    13
    </div>
  </div>
  <a href="#104000" class="name">
  <strong class="user"><em>bohwaz</em></strong></a><a class="genanchor" href="#104000"> &para;</a><div class="date" title="2011-05-16 10:59"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104000">
<div class="phpcode"><code><span class="html">$encryption_key and all encryption features will be enabled only if the SQLite encryption module is installed. It's a proprietary, costly module. So if it's not present, supplying an encryption key will have absolutely no effect.</span></code></div>
  </div>
 </div>
  <div class="note" id="121337">  <div class="votes">
    <div id="Vu121337">
    <a href="/manual/vote-note.php?id=121337&amp;page=sqlite3.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121337">
    <a href="/manual/vote-note.php?id=121337&amp;page=sqlite3.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121337" title="71% like this...">
    9
    </div>
  </div>
  <a href="#121337" class="name">
  <strong class="user"><em>jtreurniet at example dot com</em></strong></a><a class="genanchor" href="#121337"> &para;</a><div class="date" title="2017-07-08 08:26"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121337">
...
<div class="foot"><a href="/manual/add-note.php?sect=sqlite3.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/sqlite3.construct.php">＋<small>add a note</small></a></div>
