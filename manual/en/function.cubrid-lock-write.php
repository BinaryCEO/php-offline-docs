...
<head>
  ...
  <title>PHP: cubrid_lock_write - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lock-write.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-lock-write">
 <link rel="alternate" href="https://www.php.net/cubrid-lock-write" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lock-read.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-move-cursor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-lock-write.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-lock-write.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-lock-write.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-lock-write.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-lock-write.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-lock-write.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-lock-write.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-lock-write.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-lock-write.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-lock-write.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-lock-write.php" hreflang="zh">
...
<meta name="Description" content="Set a write lock on the given OID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lock_write - Manual" />
<meta name="twitter:description" content="Set a write lock on the given OID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lock_write - Manual" />
<meta itemprop="description" content="Set a write lock on the given OID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set a write lock on the given OID" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-move-cursor.php">
          cubrid_move_cursor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-lock-read.php">
          &laquo; cubrid_lock_read        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lock-write.php' selected="selected">English</option>
            <option value='de/function.cubrid-lock-write.php'>German</option>
            <option value='es/function.cubrid-lock-write.php'>Spanish</option>
            <option value='fr/function.cubrid-lock-write.php'>French</option>
            <option value='it/function.cubrid-lock-write.php'>Italian</option>
            <option value='ja/function.cubrid-lock-write.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-lock-write.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-lock-write.php'>Russian</option>
            <option value='tr/function.cubrid-lock-write.php'>Turkish</option>
            <option value='uk/function.cubrid-lock-write.php'>Ukrainian</option>
            <option value='zh/function.cubrid-lock-write.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-lock-write" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_lock_write</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_lock_write</span> &mdash; <span class="dc-title">Set a write lock on the given OID</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-lock-write-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_lock_write</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$oid</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_lock_write()</strong></span> function is used to put write
    lock on the instance pointed by the given <code class="parameter">oid</code>.
  </p>
</div>


 <div class="refsect1 parameters" id="refsect1-function.cubrid-lock-write-parameters">
  ...
  <dd><p class="para">OID of the instance that you want to put write lock on.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-lock-write-returnvalues">
...
array(3) {
  ...
  <div class="refsect1 seealso" id="refsect1-function.cubrid-lock-write-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
   <li><span class="function"><a href="function.cubrid-lock-read.php" class="function" rel="rdfs-seeAlso">cubrid_lock_read()</a> - Set a read lock on the given OID</span></li>   
   </ul>
  </p>
  </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lock-write.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lock-write%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lock-write&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lock-write.php">＋<small>add a note</small></a></span>
