...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-delete-user.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-db-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-drop-db.php">
...
<meta name="Description" content="Alias of ibase_delete_user" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_delete_user - Manual" />
<meta name="twitter:description" content="Alias of ibase_delete_user" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_delete_user - Manual" />
<meta itemprop="description" content="Alias of ibase_delete_user" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_delete_user" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-delete-user.php' selected="selected">English</option>
            ...
            <option value='ru/function.fbird-delete-user.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_delete_user</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-delete-user.php" class="function">ibase_delete_user()</a></span></span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fbird-modify-user.php" class="function" rel="rdfs-seeAlso">fbird_modify_user()</a> - Alias of ibase_modify_user</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-delete-user.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-delete-user%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-delete-user&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-delete-user.php">＋<small>add a note</small></a></span>
