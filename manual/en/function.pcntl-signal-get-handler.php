...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pcntl-signal-get-handler.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pcntl-signal-dispatch.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pcntl-sigprocmask.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pcntl-signal-get-handler.php' selected="selected">English</option>
            ...
            <option value='zh/function.pcntl-signal-get-handler.php'>Chinese (Simplified)</option>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.pcntl-signal.php" class="function" rel="rdfs-seeAlso">pcntl_signal()</a> - Installs a signal handler</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pcntl/functions/pcntl-signal-get-handler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pcntl-signal-get-handler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pcntl-signal-get-handler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pcntl-signal-get-handler.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>jrdbrndt at gmail dot com</em></strong></a><a class="genanchor" href="#122268"> &para;</a><div class="date" title="2018-01-13 02:06"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122268">
<div class="phpcode"><code><span class="html">It is worth noting that supplying an invalid signal number will trigger a warning and return false.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">If the signal handler is a Closure, the function itself is returned:<br /><br />pcntl_signal(SIGHUP, function ($signo, $siginfo) {<br />    echo SIGHUP;<br />});<br /><br />var_dump(pcntl_signal_get_handler(SIGHUP)); // Outputs: string(6) "SIGHUP"</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pcntl-signal-get-handler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pcntl-signal-get-handler.php">＋<small>add a note</small></a></div>
