...
<head>
  ...
  <title>PHP: libxml_set_external_entity_loader - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.libxml-set-external-entity-loader.php">
 <link rel="shorturl" href="https://www.php.net/libxml-set-external-entity-loader">
 <link rel="alternate" href="https://www.php.net/libxml-set-external-entity-loader" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.libxml.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.libxml-get-last-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.libxml-set-streams-context.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.libxml-set-external-entity-loader.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.libxml-set-external-entity-loader.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.libxml-set-external-entity-loader.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.libxml-set-external-entity-loader.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.libxml-set-external-entity-loader.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.libxml-set-external-entity-loader.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.libxml-set-external-entity-loader.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.libxml-set-external-entity-loader.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.libxml-set-external-entity-loader.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.libxml-set-external-entity-loader.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.libxml-set-external-entity-loader.php" hreflang="zh">
...
<meta name="Description" content="Changes the default external entity loader" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: libxml_set_external_entity_loader - Manual" />
<meta name="twitter:description" content="Changes the default external entity loader" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: libxml_set_external_entity_loader - Manual" />
<meta itemprop="description" content="Changes the default external entity loader" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Changes the default external entity loader" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.libxml-set-streams-context.php">
          libxml_set_streams_context &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.libxml-get-last-error.php">
          &laquo; libxml_get_last_error        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.libxml-set-external-entity-loader.php' selected="selected">English</option>
            <option value='de/function.libxml-set-external-entity-loader.php'>German</option>
            <option value='es/function.libxml-set-external-entity-loader.php'>Spanish</option>
            <option value='fr/function.libxml-set-external-entity-loader.php'>French</option>
            <option value='it/function.libxml-set-external-entity-loader.php'>Italian</option>
            <option value='ja/function.libxml-set-external-entity-loader.php'>Japanese</option>
            <option value='pt_BR/function.libxml-set-external-entity-loader.php'>Brazilian Portuguese</option>
            <option value='ru/function.libxml-set-external-entity-loader.php'>Russian</option>
            <option value='tr/function.libxml-set-external-entity-loader.php'>Turkish</option>
            <option value='uk/function.libxml-set-external-entity-loader.php'>Ukrainian</option>
            <option value='zh/function.libxml-set-external-entity-loader.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.libxml-set-external-entity-loader" class="refentry">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      ...
      This callable should return a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>, a <span class="type"><a href="language.types.string.php" class="type string">string</a></span> from which a resource can be
 ...
 <div class="refsect1 examples" id="refsect1-function.libxml-set-external-entity-loader-examples">
  ...
  <p class="para">
   <div class="example" id="example-5857">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.libxml-get-external-entity-loader.php" class="function" rel="rdfs-seeAlso">libxml_get_external_entity_loader()</a> - Get the current external entity loader</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/libxml/functions/libxml-set-external-entity-loader.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.libxml-set-external-entity-loader%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.libxml-set-external-entity-loader&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.libxml-set-external-entity-loader.php">＋<small>add a note</small></a></span>
