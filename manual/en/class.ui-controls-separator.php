...
<head>
  ...
  <title>PHP: UI\Controls\Separator - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-controls-separator.php">
 <link rel="shorturl" href="https://www.php.net/ui-controls-separator">
 <link rel="alternate" href="https://www.php.net/ui-controls-separator" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-controls-progress.setvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-controls-separator.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-controls-separator.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-controls-separator.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-controls-separator.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-controls-separator.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-controls-separator.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-controls-separator.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-controls-separator.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-controls-separator.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-controls-separator.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-controls-separator.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-controls-separator.php" hreflang="zh">
...
<meta name="Description" content="Control Separator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Controls\Separator - Manual" />
<meta name="twitter:description" content="Control Separator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Controls\Separator - Manual" />
<meta itemprop="description" content="Control Separator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Control Separator" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ui-controls-separator.construct.php">
          UI\Controls\Separator::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-controls-progress.setvalue.php">
          &laquo; UI\Controls\Progress::setValue        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-controls-separator.php' selected="selected">English</option>
            <option value='de/class.ui-controls-separator.php'>German</option>
            <option value='es/class.ui-controls-separator.php'>Spanish</option>
            <option value='fr/class.ui-controls-separator.php'>French</option>
            <option value='it/class.ui-controls-separator.php'>Italian</option>
            <option value='ja/class.ui-controls-separator.php'>Japanese</option>
            <option value='pt_BR/class.ui-controls-separator.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-controls-separator.php'>Russian</option>
            <option value='tr/class.ui-controls-separator.php'>Turkish</option>
            <option value='uk/class.ui-controls-separator.php'>Ukrainian</option>
            <option value='zh/class.ui-controls-separator.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-controls-separator" class="reference">

 <h1 class="title">Control Separator</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-controls-separator.intro">
  ...
  <div class="section" id="ui-controls-separator.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Controls\Separator</strong>
     </span>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-controls-separator.php#ui-controls-separator.constants.horizontal"><var class="varname">Horizontal</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-controls-separator.php#ui-controls-separator.constants.vertical"><var class="varname">Vertical</var></a></var>;</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Constructor */</div>
    <div class="constructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><a href="ui-controls-separator.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code><span class="initializer"> = UI\Controls\Separator::Horizontal</span></span>)</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-control.show.php" class="methodname">UI\Control::show</a></span>()</div>
  ...
  <div class="section" id="ui-controls-separator.constants">
   <h2 class="title">Predefined Constants</h2>
   <dl>

    
     <dt id="ui-controls-separator.constants.horizontal"><strong><code><a href="class.ui-controls-separator.php#ui-controls-separator.constants.horizontal">UI\Controls\Separator::Horizontal</a></code></strong></dt>
     <dd>
      <p class="para">A Horizontal Separator</p>
     </dd>
    

    
     <dt id="ui-controls-separator.constants.vertical"><strong><code><a href="class.ui-controls-separator.php#ui-controls-separator.constants.vertical">UI\Controls\Separator::Vertical</a></code></strong></dt>
     <dd>
      <p class="para">A Vertical Separator</p>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-controls-separator.construct.php">UI\Controls\Separator::__construct</a> — Construct a new Separator</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.controls.separator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-controls-separator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-controls-separator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-controls-separator.php">＋<small>add a note</small></a></span>
