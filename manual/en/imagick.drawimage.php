...
<head>
  ...
  <title>PHP: Imagick::drawImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.drawimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.drawimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.drawimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.distortimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.edgeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.drawimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.drawimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.drawimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.drawimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.drawimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.drawimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.drawimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.drawimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.drawimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.drawimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.drawimage.php" hreflang="zh">
...
<meta name="Description" content="Renders the ImagickDraw object on the current image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::drawImage - Manual" />
<meta name="twitter:description" content="Renders the ImagickDraw object on the current image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::drawImage - Manual" />
<meta itemprop="description" content="Renders the ImagickDraw object on the current image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Renders the ImagickDraw object on the current image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.edgeimage.php">
          Imagick::edgeImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.distortimage.php">
          &laquo; Imagick::distortImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.drawimage.php' selected="selected">English</option>
            <option value='de/imagick.drawimage.php'>German</option>
            <option value='es/imagick.drawimage.php'>Spanish</option>
            <option value='fr/imagick.drawimage.php'>French</option>
            <option value='it/imagick.drawimage.php'>Italian</option>
            <option value='ja/imagick.drawimage.php'>Japanese</option>
            <option value='pt_BR/imagick.drawimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.drawimage.php'>Russian</option>
            <option value='tr/imagick.drawimage.php'>Turkish</option>
            <option value='uk/imagick.drawimage.php'>Ukrainian</option>
            <option value='zh/imagick.drawimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.drawimage" class="refentry">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/drawimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.drawimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.drawimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.drawimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="93116">  <div class="votes">
    <div id="Vu93116">
    <a href="/manual/vote-note.php?id=93116&amp;page=imagick.drawimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd93116">
    <a href="/manual/vote-note.php?id=93116&amp;page=imagick.drawimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V93116" title="75% like this...">
    6
    </div>
  </div>
  <a href="#93116" class="name">
  <strong class="user"><em>blah at blub dot com</em></strong></a><a class="genanchor" href="#93116"> &para;</a><div class="date" title="2009-08-24 06:21"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom93116">
<div class="phpcode"><code><span class="html">If your imagick lib begins to say: "Non-conforming drawing primitive...", it could be that your locale are not correctly set. please locate all your setlocale and kill them temporary so you could check it that would solve the problem.</span></code></div>
  </div>
 </div>
  <div class="note" id="86035">  <div class="votes">
    <div id="Vu86035">
    <a href="/manual/vote-note.php?id=86035&amp;page=imagick.drawimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd86035">
    <a href="/manual/vote-note.php?id=86035&amp;page=imagick.drawimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V86035" title="33% like this...">
    -2
    </div>
  </div>
  <a href="#86035" class="name">
  <strong class="user"><em>sualk at lednew dot de</em></strong></a><a class="genanchor" href="#86035"> &para;</a><div class="date" title="2008-09-30 04:34"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom86035">
<div class="phpcode"><code><span class="html">the ImagickDraw (v 2.2.0) seems to disharmonise with PHP-GTK2 (v 2.0.1).
<br />
<br />The rendering of an ImagickDraw object on the current image fails (resp. results in a flat image without drawings), if php_gtk2.so is loaded.
<br />
<br />Code to reproduce the failure:
<br />
<br />#!/usr/bin/php5
<br /><span class="default">&lt;?php
<br />dl</span><span class="keyword">(</span><span class="string">"php_gtk2.so"</span><span class="keyword">); </span><span class="comment">// comment this for a second try
<br />
<br /></span><span class="default">$string </span><span class="keyword">= </span><span class="string">"Hello world!"</span><span class="keyword">;
<br />
...
<br />
<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'blue'</span><span class="keyword">));
<br />
<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFontSize</span><span class="keyword">(</span><span class="default">28</span><span class="keyword">);
<br />
<br /></span><span class="default">$metrix </span><span class="keyword">= </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">queryFontMetrics</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">, </span><span class="default">$string</span><span class="keyword">);
<br />
<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">annotation</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">25</span><span class="keyword">,</span><span class="default">$string</span><span class="keyword">);
<br />
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">$metrix</span><span class="keyword">[</span><span class="string">'textWidth'</span><span class="keyword">],</span><span class="default">$metrix</span><span class="keyword">[</span><span class="string">'textHeight'</span><span class="keyword">], new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'white'</span><span class="keyword">));
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">);
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">borderImage</span><span class="keyword">(new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'black'</span><span class="keyword">), </span><span class="default">1</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'png'</span><span class="keyword">);
<br />
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">"./test.png"</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.drawimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.drawimage.php">＋<small>add a note</small></a></div>
