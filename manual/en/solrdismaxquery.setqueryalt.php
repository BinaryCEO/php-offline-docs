...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrdismaxquery.setqueryalt.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrdismaxquery.setqueryalt.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrdismaxquery.setqueryalt.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrdismaxquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrdismaxquery.setphraseslop.php">
 <link rel="next" href="https://www.php.net/manual/en/solrdismaxquery.setqueryphraseslop.php">
...
<meta name="Description" content="Set Query Alternate (q.alt parameter)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrDisMaxQuery::setQueryAlt - Manual" />
<meta name="twitter:description" content="Set Query Alternate (q.alt parameter)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrDisMaxQuery::setQueryAlt - Manual" />
<meta itemprop="description" content="Set Query Alternate (q.alt parameter)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set Query Alternate (q.alt parameter)" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrdismaxquery.setqueryalt.php' selected="selected">English</option>
            ...
            <option value='fr/solrdismaxquery.setqueryalt.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">SolrDisMaxQuery::setQueryAlt</span> &mdash; <span class="dc-title">Set Query Alternate (q.alt parameter)</span></p>
 ...
 <div class="refsect1 description" id="refsect1-solrdismaxquery.setqueryalt-description">
  ...
  <p class="para">
    When the main <em>q</em> parameter is not specified or is blank. The <em>q.alt</em> parameter is used
  </p>
 ...
 <div class="refsect1 examples" id="refsect1-solrdismaxquery.setqueryalt-examples">
  ...
  <div class="example" id="example-4975">
   <p><strong>Example #1 <span class="function"><strong>SolrDisMaxQuery::setQueryAlt()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">defType=edismax&amp;q.alt=*:*&amp;q=</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrdismaxquery/setqueryalt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrdismaxquery.setqueryalt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrdismaxquery.setqueryalt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrdismaxquery.setqueryalt.php">＋<small>add a note</small></a></span>
