...
<head>
  ...
  <title>PHP: imagechar - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagechar.php">
 <link rel="shorturl" href="https://www.php.net/imagechar">
 <link rel="alternate" href="https://www.php.net/imagechar" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagebmp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecharup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagechar.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagechar.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagechar.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagechar.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagechar.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagechar.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagechar.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagechar.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagechar.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagechar.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagechar.php" hreflang="zh">
...
<meta name="Description" content="Draw a character horizontally" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagechar - Manual" />
<meta name="twitter:description" content="Draw a character horizontally" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagechar - Manual" />
<meta itemprop="description" content="Draw a character horizontally" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draw a character horizontally" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagechar.php' selected="selected">English</option>
            <option value='de/function.imagechar.php'>German</option>
            <option value='es/function.imagechar.php'>Spanish</option>
            <option value='fr/function.imagechar.php'>French</option>
            <option value='it/function.imagechar.php'>Italian</option>
            <option value='ja/function.imagechar.php'>Japanese</option>
            <option value='pt_BR/function.imagechar.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagechar.php'>Russian</option>
            <option value='tr/function.imagechar.php'>Turkish</option>
            <option value='uk/function.imagechar.php'>Ukrainian</option>
            <option value='zh/function.imagechar.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagechar" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagechar</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagechar</span> &mdash; <span class="dc-title">Draw a character horizontally</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagechar-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagechar</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="class.gdfont.php" class="type GdFont">GdFont</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span> <code class="parameter">$font</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$char</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$color</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>imagechar()</strong></span> draws the first character of
   <code class="parameter">char</code> in the image identified by
   <code class="parameter">image</code> with its upper-left at
   <code class="parameter">x</code>,<code class="parameter">y</code> (top left is 0,
   0) with the color <code class="parameter">color</code>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imagechar-parameters">
...
returned by <span class="function"><a href="function.imageloadfont.php" class="function">imageloadfont()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagechar-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagechar-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.imagechar-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2835">
    <p><strong>Example #1 <span class="function"><strong>imagechar()</strong></span> example</strong></p>
...
something similar to:</p></div>
    <div class="mediaobject">
     ...
     <div class="imageobject">
      <img src="images/21009b70229598c6a80eef8b45bf282b-imagechar.png" alt="Output of example : imagechar()" width="100" height="100" />
     </div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagechar-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagecharup.php" class="function" rel="rdfs-seeAlso">imagecharup()</a> - Draw a character vertically</span></li>
   <li><span class="function"><a href="function.imageloadfont.php" class="function" rel="rdfs-seeAlso">imageloadfont()</a> - Load a new font</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagechar.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagechar%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagechar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagechar.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="54000">  <div class="votes">
    <div id="Vu54000">
    <a href="/manual/vote-note.php?id=54000&amp;page=function.imagechar&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd54000">
    <a href="/manual/vote-note.php?id=54000&amp;page=function.imagechar&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V54000" title="80% like this...">
    3
    </div>
  </div>
  <a href="#54000" class="name">
  <strong class="user"><em>sw at profilschmiede dot de</em></strong></a><a class="genanchor" href="#54000"> &para;</a><div class="date" title="2005-06-20 08:35"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom54000">
<div class="phpcode"><code><span class="html">For the sake of completeness, here is an example for imagechar. <br />The base-image automatically adjusts to the size and the height of the given string. Using the rand()-function the y-position of each char is slightly varied with every loop-run. You can easily rewrite the script to use a randomly generated string - the one given here just serves as an example.<br /><br /><span class="default">&lt;?php<br /><br />$string </span><span class="keyword">= </span><span class="string">'1 2 3 4 5 6 7 8 9 A B C D E F G'</span><span class="keyword">;<br /></span><span class="default">$font_size </span><span class="keyword">= </span><span class="default">5</span><span class="keyword">;<br /></span><span class="default">$width</span><span class="keyword">=</span><span class="default">imagefontwidth</span><span class="keyword">(</span><span class="default">$font_size</span><span class="keyword">)*</span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">);<br /></span><span class="default">$height</span><span class="keyword">=</span><span class="default">imagefontheight</span><span class="keyword">(</span><span class="default">$font_size</span><span class="keyword">)*</span><span class="default">2</span><span class="keyword">;<br /></span><span class="default">$img </span><span class="keyword">= </span><span class="default">imagecreate</span><span class="keyword">(</span><span class="default">$width</span><span class="keyword">,</span><span class="default">$height</span><span class="keyword">);<br /></span><span class="default">$bg </span><span class="keyword">= </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">,</span><span class="default">225</span><span class="keyword">,</span><span class="default">225</span><span class="keyword">,</span><span class="default">225</span><span class="keyword">);<br /></span><span class="default">$black </span><span class="keyword">= </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">$len</span><span class="keyword">=</span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">);<br /><br />for(</span><span class="default">$i</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">;</span><span class="default">$i</span><span class="keyword">&lt;</span><span class="default">$len</span><span class="keyword">;</span><span class="default">$i</span><span class="keyword">++)<br />{<br />    </span><span class="default">$xpos</span><span class="keyword">=</span><span class="default">$i</span><span class="keyword">*</span><span class="default">imagefontwidth</span><span class="keyword">(</span><span class="default">$font_size</span><span class="keyword">);<br />    </span><span class="default">$ypos</span><span class="keyword">=</span><span class="default">rand</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">imagefontheight</span><span class="keyword">(</span><span class="default">$font_size</span><span class="keyword">));<br />    </span><span class="default">imagechar</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">,</span><span class="default">$font_size</span><span class="keyword">,</span><span class="default">$xpos</span><span class="keyword">,</span><span class="default">$ypos</span><span class="keyword">,</span><span class="default">$string</span><span class="keyword">,</span><span class="default">$black</span><span class="keyword">);<br />    </span><span class="default">$string </span><span class="keyword">= </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">);    <br />    <br />}<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: image/gif"</span><span class="keyword">);<br /></span><span class="default">imagegif</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">); <br /></span><span class="default">imagedestroy</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="89932">  <div class="votes">
    <div id="Vu89932">
    <a href="/manual/vote-note.php?id=89932&amp;page=function.imagechar&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd89932">
    <a href="/manual/vote-note.php?id=89932&amp;page=function.imagechar&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V89932" title="36% like this...">
    -3
    </div>
  </div>
  <a href="#89932" class="name">
  <strong class="user"><em>liam dot wiltshire at lineone dot net</em></strong></a><a class="genanchor" href="#89932"> &para;</a><div class="date" title="2009-03-29 03:11"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom89932">
<div class="phpcode"><code><span class="html">A quick function to automatically generate a multi line image from a string, with the image size automatically calculated from the string itself.
<br />
<br /><span class="default">&lt;?php
<br />
<br /></span><span class="keyword">function </span><span class="default">multilineimage</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">){
<br />
<br />    </span><span class="comment">// Probably not the best way of handling newlines, but bar OS9, doesn't really cause a problem
<br />    </span><span class="default">$string </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">"\r"</span><span class="keyword">,</span><span class="string">""</span><span class="keyword">,</span><span class="default">$string</span><span class="keyword">);
<br />    </span><span class="default">$string </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">(</span><span class="string">"\n"</span><span class="keyword">,</span><span class="default">$string</span><span class="keyword">);
<br />
<br />    </span><span class="default">$maxlen </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;
<br />    foreach (</span><span class="default">$string </span><span class="keyword">as </span><span class="default">$str</span><span class="keyword">){
<br />        if (</span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">) &gt; </span><span class="default">$maxlen</span><span class="keyword">){
<br />            </span><span class="default">$maxlen </span><span class="keyword">= </span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">);
<br />        }
<br />    }
<br />
...
<br />    </span><span class="default">$width  </span><span class="keyword">= </span><span class="default">imagefontwidth</span><span class="keyword">(</span><span class="default">$font_size</span><span class="keyword">)*</span><span class="default">$maxlen</span><span class="keyword">;
<br />    </span><span class="comment">// Set height to that of the font
<br />    </span><span class="default">$height </span><span class="keyword">= </span><span class="default">imagefontheight</span><span class="keyword">(</span><span class="default">$font_size</span><span class="keyword">) * </span><span class="default">count</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">);
...
<br />    </span><span class="default">$bg    </span><span class="keyword">= </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">205</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">);
<br />    </span><span class="comment">// White font color
<br />    </span><span class="default">$color </span><span class="keyword">= </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);
<br />
...
<br />            </span><span class="default">imagechar</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">$font_size</span><span class="keyword">, </span><span class="default">$xpos</span><span class="keyword">, </span><span class="default">$ypos</span><span class="keyword">, </span><span class="default">$str</span><span class="keyword">, </span><span class="default">$color</span><span class="keyword">);
<br />            </span><span class="comment">// Remove character from string
<br />            </span><span class="default">$str </span><span class="keyword">= </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);   
<br />        }
<br />        </span><span class="default">$ypos </span><span class="keyword">= </span><span class="default">$ypos </span><span class="keyword">+ </span><span class="default">imagefontheight</span><span class="keyword">(</span><span class="default">$font_size</span><span class="keyword">);   
<br />    }
<br />
...
<br />}
<br />
<br /></span><span class="default">multilineimage</span><span class="keyword">(</span><span class="string">"This is an image
<br />This is line 2\nLine 3
<br />Line 4"</span><span class="keyword">);
<br />
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagechar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagechar.php">＋<small>add a note</small></a></div>
