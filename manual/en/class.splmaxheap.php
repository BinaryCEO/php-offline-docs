...
<head>
  ...
  <title>PHP: SplMaxHeap - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.splmaxheap.php">
 <link rel="shorturl" href="https://www.php.net/splmaxheap">
 <link rel="alternate" href="https://www.php.net/splmaxheap" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/spl.datastructures.php">
 <link rel="prev" href="https://www.php.net/manual/en/splheap.valid.php">
 <link rel="next" href="https://www.php.net/manual/en/splmaxheap.compare.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.splmaxheap.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.splmaxheap.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.splmaxheap.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.splmaxheap.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.splmaxheap.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.splmaxheap.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.splmaxheap.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.splmaxheap.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.splmaxheap.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.splmaxheap.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.splmaxheap.php" hreflang="zh">
...
<meta name="Description" content="The SplMaxHeap class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplMaxHeap - Manual" />
<meta name="twitter:description" content="The SplMaxHeap class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplMaxHeap - Manual" />
<meta itemprop="description" content="The SplMaxHeap class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SplMaxHeap class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="splmaxheap.compare.php">
          SplMaxHeap::compare &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="splheap.valid.php">
          &laquo; SplHeap::valid        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.splmaxheap.php' selected="selected">English</option>
            <option value='de/class.splmaxheap.php'>German</option>
            <option value='es/class.splmaxheap.php'>Spanish</option>
            <option value='fr/class.splmaxheap.php'>French</option>
            <option value='it/class.splmaxheap.php'>Italian</option>
            <option value='ja/class.splmaxheap.php'>Japanese</option>
            <option value='pt_BR/class.splmaxheap.php'>Brazilian Portuguese</option>
            <option value='ru/class.splmaxheap.php'>Russian</option>
            <option value='tr/class.splmaxheap.php'>Turkish</option>
            <option value='uk/class.splmaxheap.php'>Ukrainian</option>
            <option value='zh/class.splmaxheap.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.splmaxheap" class="reference">
 <h1 class="title">The SplMaxHeap class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p>
 

  <div class="section" id="splmaxheap.intro">
  ...
  <div class="section" id="splmaxheap.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">SplMaxHeap</strong></strong>
   ...
   <span class="modifier">protected</span> <span class="methodname"><a href="splmaxheap.compare.php" class="methodname">compare</a></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$value1</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$value2</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="splmaxheap.compare.php">SplMaxHeap::compare</a> — Compare elements in order to place them correctly in the heap while sifting up</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splmaxheap.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.splmaxheap%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.splmaxheap&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.splmaxheap.php">＋<small>add a note</small></a></span>
