...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.session.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.session.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.session.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.session.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.session.php">
 <link rel="next" href="https://www.php.net/manual/en/session.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.session.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.session.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.session.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.session.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.session.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.session.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.session.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.session.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.session.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.session.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.session.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.session.php' selected="selected">English</option>
            <option value='de/intro.session.php'>German</option>
            <option value='es/intro.session.php'>Spanish</option>
            <option value='fr/intro.session.php'>French</option>
            <option value='it/intro.session.php'>Italian</option>
            <option value='ja/intro.session.php'>Japanese</option>
            <option value='pt_BR/intro.session.php'>Brazilian Portuguese</option>
            <option value='ru/intro.session.php'>Russian</option>
            <option value='tr/intro.session.php'>Turkish</option>
            <option value='uk/intro.session.php'>Ukrainian</option>
            <option value='zh/intro.session.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.session" class="preface">
   ...
   <p class="para">
    ...
    <span class="function"><a href="function.session-start.php" class="function">session_start()</a></span> function.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.session%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.session&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.session.php">＋<small>add a note</small></a></span>
