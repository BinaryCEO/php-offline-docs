...
<head>
  ...
  <title>PHP: ImagickDraw::popClipPath - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.popclippath.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.popclippath.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.popclippath.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pop.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.popdefs.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.popclippath.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.popclippath.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.popclippath.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.popclippath.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.popclippath.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.popclippath.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.popclippath.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.popclippath.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.popclippath.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.popclippath.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.popclippath.php" hreflang="zh">
...
<meta name="Description" content="Terminates a clip path definition" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::popClipPath - Manual" />
<meta name="twitter:description" content="Terminates a clip path definition" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::popClipPath - Manual" />
<meta itemprop="description" content="Terminates a clip path definition" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Terminates a clip path definition" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.popdefs.php">
          ImagickDraw::popDefs &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pop.php">
          &laquo; ImagickDraw::pop        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.popclippath.php' selected="selected">English</option>
            <option value='de/imagickdraw.popclippath.php'>German</option>
            <option value='es/imagickdraw.popclippath.php'>Spanish</option>
            <option value='fr/imagickdraw.popclippath.php'>French</option>
            <option value='it/imagickdraw.popclippath.php'>Italian</option>
            <option value='ja/imagickdraw.popclippath.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.popclippath.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.popclippath.php'>Russian</option>
            <option value='tr/imagickdraw.popclippath.php'>Turkish</option>
            <option value='uk/imagickdraw.popclippath.php'>Ukrainian</option>
            <option value='zh/imagickdraw.popclippath.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.popclippath" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::popClipPath</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::popClipPath</span> &mdash; <span class="dc-title">Terminates a clip path definition</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.popclippath-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::popClipPath</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.popclippath-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/popclippath.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.popclippath%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.popclippath&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.popclippath.php">＋<small>add a note</small></a></span>
