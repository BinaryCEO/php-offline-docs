...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/zookeeper.getrecvtimeout.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/zookeeper.getrecvtimeout.php">
 <link rel="alternate" href="https://www.php.net/manual/en/zookeeper.getrecvtimeout.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.zookeeper.php">
 <link rel="prev" href="https://www.php.net/manual/en/zookeeper.getconfig.php">
 <link rel="next" href="https://www.php.net/manual/en/zookeeper.getstate.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/zookeeper.getrecvtimeout.php' selected="selected">English</option>
            <option value='de/zookeeper.getrecvtimeout.php'>German</option>
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.zookeeperexception.php" class="classname">ZookeeperException</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeeper/getrecvtimeout.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fzookeeper.getrecvtimeout%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=zookeeper.getrecvtimeout&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zookeeper.getrecvtimeout.php">＋<small>add a note</small></a></span>
