...
<head>
  ...
  <title>PHP: ReflectionProperty::isInitialized - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.isinitialized.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.isinitialized.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.isinitialized.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.isfinal.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.islazy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.isinitialized.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.isinitialized.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.isinitialized.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.isinitialized.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.isinitialized.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.isinitialized.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.isinitialized.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.isinitialized.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.isinitialized.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.isinitialized.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.isinitialized.php" hreflang="zh">
...
<meta name="Description" content="Checks whether a property is initialized" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::isInitialized - Manual" />
<meta name="twitter:description" content="Checks whether a property is initialized" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::isInitialized - Manual" />
<meta itemprop="description" content="Checks whether a property is initialized" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks whether a property is initialized" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionproperty.islazy.php">
          ReflectionProperty::isLazy &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.isfinal.php">
          &laquo; ReflectionProperty::isFinal        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.isinitialized.php' selected="selected">English</option>
            <option value='de/reflectionproperty.isinitialized.php'>German</option>
            <option value='es/reflectionproperty.isinitialized.php'>Spanish</option>
            <option value='fr/reflectionproperty.isinitialized.php'>French</option>
            <option value='it/reflectionproperty.isinitialized.php'>Italian</option>
            <option value='ja/reflectionproperty.isinitialized.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.isinitialized.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.isinitialized.php'>Russian</option>
            <option value='tr/reflectionproperty.isinitialized.php'>Turkish</option>
            <option value='uk/reflectionproperty.isinitialized.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.isinitialized.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.isinitialized" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionproperty.isinitialized-examples">
  ...
  <div class="example" id="reflectionproperty.isinitialized.example.basic">
   <p><strong>Example #1 <span class="methodname"><strong>ReflectionProperty::isInitialized()</strong></span> example</strong></p>
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="reflectionproperty.hastype.php" class="methodname" rel="rdfs-seeAlso">ReflectionProperty::hasType()</a> - Checks if property has a type</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/isinitialized.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.isinitialized%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.isinitialized&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.isinitialized.php">＋<small>add a note</small></a></span>
