...
<head>
  ...
  <title>PHP: ps_get_value - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-get-value.php">
 <link rel="shorturl" href="https://www.php.net/ps-get-value">
 <link rel="alternate" href="https://www.php.net/ps-get-value" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-get-parameter.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-hyphenate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-get-value.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-get-value.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-get-value.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-get-value.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-get-value.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-get-value.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-get-value.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-get-value.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-get-value.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-get-value.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-get-value.php" hreflang="zh">
...
<meta name="Description" content="Gets certain values" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_get_value - Manual" />
<meta name="twitter:description" content="Gets certain values" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_get_value - Manual" />
<meta itemprop="description" content="Gets certain values" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets certain values" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-hyphenate.php">
          ps_hyphenate &raquo;
              ...
              <div class="prev">
        <a href="function.ps-get-parameter.php">
          &laquo; ps_get_parameter        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-get-value.php' selected="selected">English</option>
            <option value='de/function.ps-get-value.php'>German</option>
            <option value='es/function.ps-get-value.php'>Spanish</option>
            <option value='fr/function.ps-get-value.php'>French</option>
            <option value='it/function.ps-get-value.php'>Italian</option>
            <option value='ja/function.ps-get-value.php'>Japanese</option>
            <option value='pt_BR/function.ps-get-value.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-get-value.php'>Russian</option>
            <option value='tr/function.ps-get-value.php'>Turkish</option>
            <option value='uk/function.ps-get-value.php'>Ukrainian</option>
            <option value='zh/function.ps-get-value.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-get-value" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-set-value.php" class="function" rel="rdfs-seeAlso">ps_set_value()</a> - Sets certain values</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-get-value.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-get-value%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-get-value&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-get-value.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="72061">  <div class="votes">
    <div id="Vu72061">
    <a href="/manual/vote-note.php?id=72061&amp;page=function.ps-get-value&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd72061">
    <a href="/manual/vote-note.php?id=72061&amp;page=function.ps-get-value&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V72061" title="50% like this...">
    0
    </div>
  </div>
  <a href="#72061" class="name">
  <strong class="user"><em>tilman dot schroeder at gmx dot de</em></strong></a><a class="genanchor" href="#72061"> &para;</a><div class="date" title="2006-12-31 09:32"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom72061">
<div class="phpcode"><code><span class="html">Note that the modifier parameter is REQUIRED in some (perhaps all) cases where you would not believe it to be required but optional:<br /><br /><span class="default">&lt;?php<br />$texty</span><span class="keyword">=</span><span class="default">ps_get_value</span><span class="keyword">(</span><span class="default">$ps</span><span class="keyword">,</span><span class="string">'texty'</span><span class="keyword">); </span><span class="comment">// does NOT work!<br /><br />// but this works, however:<br /><br /></span><span class="default">$foo</span><span class="keyword">=</span><span class="default">NULL</span><span class="keyword">;<br /></span><span class="default">$texty</span><span class="keyword">=</span><span class="default">ps_get_value</span><span class="keyword">(</span><span class="default">$ps</span><span class="keyword">,</span><span class="string">'texty'</span><span class="keyword">,</span><span class="default">$foo</span><span class="keyword">); </span><span class="comment">// DOES work!<br /><br />// this works too:<br /></span><span class="default">$texty</span><span class="keyword">=</span><span class="default">ps_get_value</span><span class="keyword">(</span><span class="default">$ps</span><span class="keyword">,</span><span class="string">'texty'</span><span class="keyword">,</span><span class="default">NULL</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />if your script just fails and sends a file with zero length to your browser just try the workaround above. saves time and you will not get upset ;)<br /><br />would be nice if somebody would be able to tell why pslib behaves this way ...<br /><br />PHP version 4.4.4-8, pslib verision 0.2.7-1 (Debian etch)<br /><br />Bye and a happy new year!<br />Tilman</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ps-get-value&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-get-value.php">＋<small>add a note</small></a></div>
