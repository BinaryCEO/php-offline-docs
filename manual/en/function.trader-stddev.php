...
<head>
  ...
  <title>PHP: trader_stddev - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-stddev.php">
 <link rel="shorturl" href="https://www.php.net/trader-stddev">
 <link rel="alternate" href="https://www.php.net/trader-stddev" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-sqrt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-stoch.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-stddev.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-stddev.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-stddev.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-stddev.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-stddev.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-stddev.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-stddev.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-stddev.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-stddev.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-stddev.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-stddev.php" hreflang="zh">
...
<meta name="Description" content="Standard Deviation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_stddev - Manual" />
<meta name="twitter:description" content="Standard Deviation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_stddev - Manual" />
<meta itemprop="description" content="Standard Deviation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Standard Deviation" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-stoch.php">
          trader_stoch &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-sqrt.php">
          &laquo; trader_sqrt        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-stddev.php' selected="selected">English</option>
            <option value='de/function.trader-stddev.php'>German</option>
            <option value='es/function.trader-stddev.php'>Spanish</option>
            <option value='fr/function.trader-stddev.php'>French</option>
            <option value='it/function.trader-stddev.php'>Italian</option>
            <option value='ja/function.trader-stddev.php'>Japanese</option>
            <option value='pt_BR/function.trader-stddev.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-stddev.php'>Russian</option>
            <option value='tr/function.trader-stddev.php'>Turkish</option>
            <option value='uk/function.trader-stddev.php'>Ukrainian</option>
            <option value='zh/function.trader-stddev.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-stddev" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.trader-stddev-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_stddev</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$nbDev</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-stddev-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">nbDev</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-stddev-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-stddev.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-stddev%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-stddev&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-stddev.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123545">  <div class="votes">
    <div id="Vu123545">
    <a href="/manual/vote-note.php?id=123545&amp;page=function.trader-stddev&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123545">
    <a href="/manual/vote-note.php?id=123545&amp;page=function.trader-stddev&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123545" title="66% like this...">
    4
    </div>
  </div>
  <a href="#123545" class="name">
  <strong class="user"><em>nijatasadov at gmail dot com</em></strong></a><a class="genanchor" href="#123545"> &para;</a><div class="date" title="2019-01-25 09:40"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123545">
<div class="phpcode"><code><span class="html">trader_stddev doesn't work. This is why trader_bbands doesn't work as well. <br /><br />function standard_deviation(array $a, $sample = false)<br />    {<br />        $n = count($a);<br />        if ($n === 0) {<br />            trigger_error("The array has zero elements", E_USER_WARNING);<br /><br />            return false;<br />        }<br />        if ($sample &amp;&amp; $n === 1) {<br />            trigger_error("The array has only 1 element", E_USER_WARNING);<br /><br />            return false;<br />        }<br />        $mean = array_sum($a) / $n;<br />        $carry = 0.0;<br />        foreach ($a as $val) {<br />            $d = ((double) $val) - $mean;<br />            $carry += $d * $d;<br />        };<br />        if ($sample) {<br />            --$n;<br />        }<br /><br />        return sqrt($carry / $n);<br />    }<br /><br />trader_stddev($data, $period) {<br />       $stds = [];<br />        $current = [];<br /><br />        foreach ($data as $i =&gt; $close) {<br />            $current[] = $close;<br />            if ($i &lt; $period) {<br />                $stds[$i] = false;<br />            } else {<br />                $stds[$i] = standard_deviation($current);<br />                array_shift($current);<br />            }<br />        }<br /><br />        return $stds;<br /><br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-stddev&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-stddev.php">＋<small>add a note</small></a></div>
