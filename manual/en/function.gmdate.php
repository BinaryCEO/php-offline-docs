...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmdate.php">
 <link rel="shorturl" href="https://www.php.net/gmdate">
 <link rel="alternate" href="https://www.php.net/gmdate" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gettimeofday.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmmktime.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmdate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmdate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmdate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmdate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmdate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmdate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmdate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmdate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmdate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmdate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmdate.php" hreflang="zh">
...
<meta name="Description" content="Format a GMT/UTC date/time" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmdate - Manual" />
<meta name="twitter:description" content="Format a GMT/UTC date/time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmdate - Manual" />
<meta itemprop="description" content="Format a GMT/UTC date/time" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Format a GMT/UTC date/time" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.gmmktime.php">
          gmmktime &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.gettimeofday.php">
          &laquo; gettimeofday        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmdate.php' selected="selected">English</option>
            <option value='de/function.gmdate.php'>German</option>
            <option value='es/function.gmdate.php'>Spanish</option>
            <option value='fr/function.gmdate.php'>French</option>
            <option value='it/function.gmdate.php'>Italian</option>
            <option value='ja/function.gmdate.php'>Japanese</option>
            <option value='pt_BR/function.gmdate.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmdate.php'>Russian</option>
            <option value='tr/function.gmdate.php'>Turkish</option>
            <option value='uk/function.gmdate.php'>Ukrainian</option>
            <option value='zh/function.gmdate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmdate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmdate</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmdate</span> &mdash; <span class="dc-title">Format a GMT/UTC date/time</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.gmdate-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmdate</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$format</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span> <code class="parameter">$timestamp</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   Identical to the <span class="function"><a href="function.date.php" class="function">date()</a></span> function except that
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       options for the <span class="function"><a href="function.date.php" class="function">date()</a></span> function.
      </p>
     </dd>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="intldateformatter.format.php" class="methodname" rel="rdfs-seeAlso">IntlDateFormatter::format()</a> - Format the date/time value as a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/gmdate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmdate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmdate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmdate.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="130212">  <div class="votes">
    <div id="Vu130212">
    <a href="/manual/vote-note.php?id=130212&amp;page=function.gmdate&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130212">
    <a href="/manual/vote-note.php?id=130212&amp;page=function.gmdate&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130212" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#130212" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#130212"> &para;</a><div class="date" title="2025-03-31 03:11"><strong>5 months ago</strong></div>
  <div class="text" id="Hcom130212">
<div class="phpcode"><code><span class="html">ATTN! The following code produces different result in PHP 7 and PHP 8!<br /><br />gmdate('Y-m-d\TH:i:s', null);<br /><br />In PHP 7 null in gmdate('Y-m-d\TH:i:s', null) translated as 0, although gmdate('Y-m-d\TH:i:s'); (w/o 2nd parameter specified) works as it should.<br /><br />This issue is fixed in PHP 8.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.gmdate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmdate.php">＋<small>add a note</small></a></div>
