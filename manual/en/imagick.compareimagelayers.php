...
<head>
  ...
  <title>PHP: Imagick::compareImageLayers - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.compareimagelayers.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.compareimagelayers.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.compareimagelayers.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.compareimagechannels.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.compareimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.compareimagelayers.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.compareimagelayers.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.compareimagelayers.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.compareimagelayers.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.compareimagelayers.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.compareimagelayers.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.compareimagelayers.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.compareimagelayers.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.compareimagelayers.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.compareimagelayers.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.compareimagelayers.php" hreflang="zh">
...
<meta name="Description" content="Returns the maximum bounding region between images" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::compareImageLayers - Manual" />
<meta name="twitter:description" content="Returns the maximum bounding region between images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::compareImageLayers - Manual" />
<meta itemprop="description" content="Returns the maximum bounding region between images" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the maximum bounding region between images" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.compareimages.php">
          Imagick::compareImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.compareimagechannels.php">
          &laquo; Imagick::compareImageChannels        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.compareimagelayers.php' selected="selected">English</option>
            <option value='de/imagick.compareimagelayers.php'>German</option>
            <option value='es/imagick.compareimagelayers.php'>Spanish</option>
            <option value='fr/imagick.compareimagelayers.php'>French</option>
            <option value='it/imagick.compareimagelayers.php'>Italian</option>
            <option value='ja/imagick.compareimagelayers.php'>Japanese</option>
            <option value='pt_BR/imagick.compareimagelayers.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.compareimagelayers.php'>Russian</option>
            <option value='tr/imagick.compareimagelayers.php'>Turkish</option>
            <option value='uk/imagick.compareimagelayers.php'>Ukrainian</option>
            <option value='zh/imagick.compareimagelayers.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.compareimagelayers" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="imagick.writeimage.php" class="function" rel="rdfs-seeAlso">Imagick::writeImage()</a> - Writes an image to the specified filename</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/compareimagelayers.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.compareimagelayers%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.compareimagelayers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.compareimagelayers.php">＋<small>add a note</small></a></span>
