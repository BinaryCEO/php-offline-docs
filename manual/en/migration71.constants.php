...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration71.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration71.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration71.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration71.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration71.new-functions.php">
 <link rel="next" href="https://www.php.net/manual/en/migration71.incompatible.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration71.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration71.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration71.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration71.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration71.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration71.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration71.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration71.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration71.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration71.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration71.constants.php" hreflang="zh">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration71.constants.php' selected="selected">English</option>
            <option value='de/migration71.constants.php'>German</option>
            <option value='es/migration71.constants.php'>Spanish</option>
            <option value='fr/migration71.constants.php'>French</option>
            <option value='it/migration71.constants.php'>Italian</option>
            <option value='ja/migration71.constants.php'>Japanese</option>
            <option value='pt_BR/migration71.constants.php'>Brazilian Portuguese</option>
            <option value='ru/migration71.constants.php'>Russian</option>
            <option value='tr/migration71.constants.php'>Turkish</option>
            <option value='uk/migration71.constants.php'>Ukrainian</option>
            <option value='zh/migration71.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration71.constants" class="sect1">
 <h2 class="title">New global constants</h2>

 <div class="sect2" id="migration71.constants.core">
 ...
 <div class="sect2" id="migration71.constants.curl">
 ...
 <div class="sect2" id="migration71.constants.filter">
  <h3 class="title"><a href="book.filter.php" class="link">Data Filtering</a></h3>
 ...
 <div class="sect2" id="migration71.constants.image">
  <h3 class="title"><a href="book.image.php" class="link">Image Processing and GD</a></h3>
 ...
 <div class="sect2" id="migration71.constants.json">
 ...
 <div class="sect2" id="migration71.constants.ldap">
 ...
 <div class="sect2" id="migration71.constants.pgsql">
 ...
 <div class="sect2" id="migration71.constants.spl">
    ...
    <span class="simpara">
     <strong><code><a href="random.constants.php#constant.mt-rand-php">MT_RAND_PHP</a></code></strong>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration71/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration71.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration71.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration71.constants.php">＋<small>add a note</small></a></span>
