...
<head>
  ...
  <title>PHP: SolrQuery::removeMltQueryField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.removemltqueryfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.removemltqueryfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removemltqueryfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.removemltfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.removesortfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removemltqueryfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.removemltqueryfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.removemltqueryfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.removemltqueryfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.removemltqueryfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.removemltqueryfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.removemltqueryfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.removemltqueryfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.removemltqueryfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.removemltqueryfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.removemltqueryfield.php" hreflang="zh">
...
<meta name="Description" content="Removes one of the moreLikeThis query fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::removeMltQueryField - Manual" />
<meta name="twitter:description" content="Removes one of the moreLikeThis query fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::removeMltQueryField - Manual" />
<meta itemprop="description" content="Removes one of the moreLikeThis query fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes one of the moreLikeThis query fields" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.removesortfield.php">
          SolrQuery::removeSortField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.removemltfield.php">
          &laquo; SolrQuery::removeMltField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.removemltqueryfield.php' selected="selected">English</option>
            <option value='de/solrquery.removemltqueryfield.php'>German</option>
            <option value='es/solrquery.removemltqueryfield.php'>Spanish</option>
            <option value='fr/solrquery.removemltqueryfield.php'>French</option>
            <option value='it/solrquery.removemltqueryfield.php'>Italian</option>
            <option value='ja/solrquery.removemltqueryfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.removemltqueryfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.removemltqueryfield.php'>Russian</option>
            <option value='tr/solrquery.removemltqueryfield.php'>Turkish</option>
            <option value='uk/solrquery.removemltqueryfield.php'>Ukrainian</option>
            <option value='zh/solrquery.removemltqueryfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.removemltqueryfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::removeMltQueryField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::removeMltQueryField</span> &mdash; <span class="dc-title">Removes one of the moreLikeThis query fields</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.removemltqueryfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::removeMltQueryField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$queryField</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.removemltqueryfield-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">queryField</code></dt>
     <dd>
      <p class="para">
       The query field
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.removemltqueryfield-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/removemltqueryfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.removemltqueryfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.removemltqueryfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.removemltqueryfield.php">＋<small>add a note</small></a></span>
