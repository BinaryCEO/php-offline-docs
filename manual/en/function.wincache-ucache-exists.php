...
<head>
  ...
  <title>PHP: wincache_ucache_exists - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-ucache-exists.php">
 <link rel="shorturl" href="https://www.php.net/wincache-ucache-exists">
 <link rel="alternate" href="https://www.php.net/wincache-ucache-exists" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-ucache-delete.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-ucache-get.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-ucache-exists.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-ucache-exists.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-ucache-exists.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-ucache-exists.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-ucache-exists.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-ucache-exists.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-ucache-exists.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-ucache-exists.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-ucache-exists.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-ucache-exists.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-ucache-exists.php" hreflang="zh">
...
<meta name="Description" content="Checks if a variable exists in the user cache" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_ucache_exists - Manual" />
<meta name="twitter:description" content="Checks if a variable exists in the user cache" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_ucache_exists - Manual" />
<meta itemprop="description" content="Checks if a variable exists in the user cache" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if a variable exists in the user cache" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.wincache-ucache-get.php">
          wincache_ucache_get &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-ucache-delete.php">
          &laquo; wincache_ucache_delete        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-ucache-exists.php' selected="selected">English</option>
            <option value='de/function.wincache-ucache-exists.php'>German</option>
            <option value='es/function.wincache-ucache-exists.php'>Spanish</option>
            <option value='fr/function.wincache-ucache-exists.php'>French</option>
            <option value='it/function.wincache-ucache-exists.php'>Italian</option>
            <option value='ja/function.wincache-ucache-exists.php'>Japanese</option>
            <option value='pt_BR/function.wincache-ucache-exists.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-ucache-exists.php'>Russian</option>
            <option value='tr/function.wincache-ucache-exists.php'>Turkish</option>
            <option value='uk/function.wincache-ucache-exists.php'>Ukrainian</option>
            <option value='zh/function.wincache-ucache-exists.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-ucache-exists" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.wincache-ucache-exists-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>wincache_ucache_exists</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.wincache-ucache-exists-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if variable with the <code class="parameter">key</code> exitsts, 
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.wincache-ucache-info.php" class="function" rel="rdfs-seeAlso">wincache_ucache_info()</a> - Retrieves information about data stored in the user cache</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-ucache-exists.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-ucache-exists%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-ucache-exists&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-ucache-exists.php">＋<small>add a note</small></a></span>
