...
<head>
  ...
  <title>PHP: sodium_crypto_pwhash_scryptsalsa208sha256_str - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-pwhash-scryptsalsa208sha256-str">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-pwhash-scryptsalsa208sha256-str" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-pwhash-scryptsalsa208sha256.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-pwhash-scryptsalsa208sha256-str-verify.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: sodium_crypto_pwhash_scryptsalsa208sha256_str - Manual" />
<meta name="twitter:description" content="Get an ASCII encoded hash" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_pwhash_scryptsalsa208sha256_str - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-pwhash-scryptsalsa208sha256-str-verify.php">
          sodium_crypto_pwhash_scryptsalsa208sha256_str_verify &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-pwhash-scryptsalsa208sha256.php">
          &laquo; sodium_crypto_pwhash_scryptsalsa208sha256        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php'>German</option>
            <option value='es/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php'>French</option>
            <option value='it/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php'>Italian</option>
            <option value='ja/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php'>Russian</option>
            <option value='tr/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-pwhash-scryptsalsa208sha256-str" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_pwhash_scryptsalsa208sha256_str</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_pwhash_scryptsalsa208sha256_str</span> &mdash; <span class="dc-title">Get an ASCII encoded hash</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-pwhash-scryptsalsa208sha256-str-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_pwhash_scryptsalsa208sha256_str</strong></span>(<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$password</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$opslimit</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$memlimit</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-pwhash-scryptsalsa208sha256-str-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-pwhash-scryptsalsa208sha256-str-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-pwhash-scryptsalsa208sha256-str.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-pwhash-scryptsalsa208sha256-str%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-pwhash-scryptsalsa208sha256-str&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122735">  <div class="votes">
    <div id="Vu122735">
    <a href="/manual/vote-note.php?id=122735&amp;page=function.sodium-crypto-pwhash-scryptsalsa208sha256-str&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122735">
    <a href="/manual/vote-note.php?id=122735&amp;page=function.sodium-crypto-pwhash-scryptsalsa208sha256-str&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122735" title="50% like this...">
    0
    </div>
  </div>
  <a href="#122735" class="name">
  <strong class="user"><em>spam at tonycast dot com</em></strong></a><a class="genanchor" href="#122735"> &para;</a><div class="date" title="2018-05-15 06:47"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122735">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /></span><span class="comment">/* Example Hash Generation */<br /><br />    </span><span class="keyword">const </span><span class="default">PWHASH_SCRYPTSALSA208SHA256_OPSLIMIT_INTERACTIVE </span><span class="keyword">= </span><span class="default">534288</span><span class="keyword">;<br />    const </span><span class="default">PWHASH_SCRYPTSALSA208SHA256_MEMLIMIT_INTERACTIVE </span><span class="keyword">= </span><span class="default">16777216</span><span class="keyword">;<br />    const </span><span class="default">PWHASH_SCRYPTSALSA208SHA256_OPSLIMIT_SENSITIVE </span><span class="keyword">= </span><span class="default">33554432</span><span class="keyword">;<br />    const </span><span class="default">PWHASH_SCRYPTSALSA208SHA256_MEMLIMIT_SENSITIVE </span><span class="keyword">= </span><span class="default">1073741824</span><span class="keyword">;<br /><br /></span><span class="default">$hash_str </span><span class="keyword">= </span><span class="default">sodium_crypto_pwhash_scryptsalsa208sha256_str</span><span class="keyword">(</span><span class="string">'password123'</span><span class="keyword">, </span><span class="default">PWHASH_SCRYPTSALSA208SHA256_OPSLIMIT_INTERACTIVE</span><span class="keyword">, </span><span class="default">PWHASH_SCRYPTSALSA208SHA256_MEMLIMIT_INTERACTIVE</span><span class="keyword">);<br /><br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$hash_str</span><span class="keyword">);<br /><br /></span><span class="comment">//outputs:  $7$C6..../....ZwhNJoHcE/5yzM05gk67R2IOAp9XjD3X2gTNRpUlg92$YBwEfrN19OUo9dZG7LPSanCmjwYg.JgOEN4E75qrXG6</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-pwhash-scryptsalsa208sha256-str&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php">＋<small>add a note</small></a></div>
