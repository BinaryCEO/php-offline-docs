...
<head>
  ...
  <title>PHP: ReflectionParameter::isArray - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionparameter.isarray.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionparameter.isarray.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionparameter.isarray.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionparameter.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionparameter.hastype.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionparameter.iscallable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionparameter.isarray.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionparameter.isarray.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionparameter.isarray.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionparameter.isarray.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionparameter.isarray.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionparameter.isarray.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionparameter.isarray.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionparameter.isarray.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionparameter.isarray.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionparameter.isarray.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionparameter.isarray.php" hreflang="zh">
...
<meta name="Description" content="Checks if parameter expects an array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionParameter::isArray - Manual" />
<meta name="twitter:description" content="Checks if parameter expects an array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionParameter::isArray - Manual" />
<meta itemprop="description" content="Checks if parameter expects an array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if parameter expects an array" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionparameter.iscallable.php">
          ReflectionParameter::isCallable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionparameter.hastype.php">
          &laquo; ReflectionParameter::hasType        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionparameter.isarray.php' selected="selected">English</option>
            <option value='de/reflectionparameter.isarray.php'>German</option>
            <option value='es/reflectionparameter.isarray.php'>Spanish</option>
            <option value='fr/reflectionparameter.isarray.php'>French</option>
            <option value='it/reflectionparameter.isarray.php'>Italian</option>
            <option value='ja/reflectionparameter.isarray.php'>Japanese</option>
            <option value='pt_BR/reflectionparameter.isarray.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionparameter.isarray.php'>Russian</option>
            <option value='tr/reflectionparameter.isarray.php'>Turkish</option>
            <option value='uk/reflectionparameter.isarray.php'>Ukrainian</option>
            <option value='zh/reflectionparameter.isarray.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionparameter.isarray" class="refentry">
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionparameter.isarray-examples">
  ...
  <p class="para">
   <div class="example" id="example-5590">
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionparameter.isoptional.php" class="methodname" rel="rdfs-seeAlso">ReflectionParameter::isOptional()</a> - Checks if optional</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionparameter/isarray.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionparameter.isarray%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionparameter.isarray&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionparameter.isarray.php">＋<small>add a note</small></a></span>
