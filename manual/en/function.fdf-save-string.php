...
<head>
  ...
  <title>PHP: fdf_save_string - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-save-string.php">
 <link rel="shorturl" href="https://www.php.net/fdf-save-string">
 <link rel="alternate" href="https://www.php.net/fdf-save-string" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-save.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-set-ap.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdf-save-string.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdf-save-string.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdf-save-string.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdf-save-string.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdf-save-string.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdf-save-string.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdf-save-string.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdf-save-string.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdf-save-string.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdf-save-string.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdf-save-string.php" hreflang="zh">
...
<meta name="Description" content="Returns the FDF document as a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_save_string - Manual" />
<meta name="twitter:description" content="Returns the FDF document as a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_save_string - Manual" />
<meta itemprop="description" content="Returns the FDF document as a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the FDF document as a string" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-save-string.php' selected="selected">English</option>
            <option value='de/function.fdf-save-string.php'>German</option>
            <option value='es/function.fdf-save-string.php'>Spanish</option>
            <option value='fr/function.fdf-save-string.php'>French</option>
            <option value='it/function.fdf-save-string.php'>Italian</option>
            <option value='ja/function.fdf-save-string.php'>Japanese</option>
            <option value='pt_BR/function.fdf-save-string.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdf-save-string.php'>Russian</option>
            <option value='tr/function.fdf-save-string.php'>Turkish</option>
            <option value='uk/function.fdf-save-string.php'>Ukrainian</option>
            <option value='zh/function.fdf-save-string.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdf-save-string" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fdf_save_string</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5 &lt; 5.3.0, PECL fdf SVN)</p><p class="refpurpose"><span class="refname">fdf_save_string</span> &mdash; <span class="dc-title">Returns the FDF document as a string</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fdf-save-string-returnvalues">
  ...
  <p class="para">
   Returns the document as a string, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fdf-save.php" class="function" rel="rdfs-seeAlso">fdf_save()</a> - Save a FDF document</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-save-string.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-save-string%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-save-string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-save-string.php">＋<small>add a note</small></a></span>
