...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.addtasklowbackground.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.addtasklowbackground.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.addtasklowbackground.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.addtasklow.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.addtaskstatus.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.addtasklowbackground.php' selected="selected">English</option>
            ...
            <option value='ja/gearmanclient.addtasklowbackground.php'>Japanese</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.runtasks.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::runTasks()</a> - Run a list of tasks in parallel</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/addtasklowbackground.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.addtasklowbackground%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.addtasklowbackground&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.addtasklowbackground.php">＋<small>add a note</small></a></span>
