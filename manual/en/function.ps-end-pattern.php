...
<head>
  ...
  <title>PHP: ps_end_pattern - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-end-pattern.php">
 <link rel="shorturl" href="https://www.php.net/ps-end-pattern">
 <link rel="alternate" href="https://www.php.net/ps-end-pattern" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-end-page.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-end-template.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-end-pattern.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-end-pattern.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-end-pattern.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-end-pattern.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-end-pattern.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-end-pattern.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-end-pattern.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-end-pattern.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-end-pattern.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-end-pattern.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-end-pattern.php" hreflang="zh">
...
<meta name="Description" content="End a pattern" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_end_pattern - Manual" />
<meta name="twitter:description" content="End a pattern" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_end_pattern - Manual" />
<meta itemprop="description" content="End a pattern" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="End a pattern" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-end-template.php">
          ps_end_template &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-end-pattern.php' selected="selected">English</option>
            <option value='de/function.ps-end-pattern.php'>German</option>
            <option value='es/function.ps-end-pattern.php'>Spanish</option>
            <option value='fr/function.ps-end-pattern.php'>French</option>
            <option value='it/function.ps-end-pattern.php'>Italian</option>
            <option value='ja/function.ps-end-pattern.php'>Japanese</option>
            <option value='pt_BR/function.ps-end-pattern.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-end-pattern.php'>Russian</option>
            <option value='tr/function.ps-end-pattern.php'>Turkish</option>
            <option value='uk/function.ps-end-pattern.php'>Ukrainian</option>
            <option value='zh/function.ps-end-pattern.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-end-pattern" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_end_pattern</h1>
  <p class="verinfo">(PECL ps &gt;= 1.2.0)</p><p class="refpurpose"><span class="refname">ps_end_pattern</span> &mdash; <span class="dc-title">End a pattern</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-end-pattern-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_end_pattern</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Ends a pattern which was started with <span class="function"><a href="function.ps-begin-pattern.php" class="function">ps_begin_pattern()</a></span>.
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-end-pattern-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-end-pattern-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-end-pattern-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-begin-pattern.php" class="function" rel="rdfs-seeAlso">ps_begin_pattern()</a> - Start a new pattern</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-end-pattern.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-end-pattern%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-end-pattern&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-end-pattern.php">＋<small>add a note</small></a></span>
