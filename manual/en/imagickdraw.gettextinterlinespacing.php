...
<head>
  ...
  <title>PHP: ImagickDraw::getTextInterlineSpacing - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.gettextinterlinespacing.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.gettextinterlinespacing.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextinterlinespacing.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.gettextencoding.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.gettextinterwordspacing.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextinterlinespacing.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.gettextinterlinespacing.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.gettextinterlinespacing.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.gettextinterlinespacing.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.gettextinterlinespacing.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.gettextinterlinespacing.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.gettextinterlinespacing.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.gettextinterlinespacing.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.gettextinterlinespacing.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.gettextinterlinespacing.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.gettextinterlinespacing.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::getTextInterlineSpacing - Manual" />
<meta name="twitter:description" content="Gets the text interword spacing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getTextInterlineSpacing - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.gettextinterwordspacing.php">
          ImagickDraw::getTextInterwordSpacing &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.gettextencoding.php">
          &laquo; ImagickDraw::getTextEncoding        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.gettextinterlinespacing.php' selected="selected">English</option>
            <option value='de/imagickdraw.gettextinterlinespacing.php'>German</option>
            <option value='es/imagickdraw.gettextinterlinespacing.php'>Spanish</option>
            <option value='fr/imagickdraw.gettextinterlinespacing.php'>French</option>
            <option value='it/imagickdraw.gettextinterlinespacing.php'>Italian</option>
            <option value='ja/imagickdraw.gettextinterlinespacing.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.gettextinterlinespacing.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.gettextinterlinespacing.php'>Russian</option>
            <option value='tr/imagickdraw.gettextinterlinespacing.php'>Turkish</option>
            <option value='uk/imagickdraw.gettextinterlinespacing.php'>Ukrainian</option>
            <option value='zh/imagickdraw.gettextinterlinespacing.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.gettextinterlinespacing" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getTextInterlineSpacing</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.1.0)</p><p class="refpurpose"><span class="refname">ImagickDraw::getTextInterlineSpacing</span> &mdash; <span class="dc-title">Gets the text interword spacing</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.gettextinterlinespacing-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getTextInterlineSpacing</strong></span>(): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.gettextinterlinespacing-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.gettextinterlinespacing-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/gettextinterlinespacing.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.gettextinterlinespacing%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.gettextinterlinespacing&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.gettextinterlinespacing.php">＋<small>add a note</small></a></span>
