...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.affected-rows.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.affected-rows.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.affected-rows.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.autocommit.php">
...
<meta name="Description" content="Gets the number of affected rows in a previous MySQL operation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::$affected_rows - Manual" />
<meta name="twitter:description" content="Gets the number of affected rows in a previous MySQL operation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::$affected_rows - Manual" />
<meta itemprop="description" content="Gets the number of affected rows in a previous MySQL operation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the number of affected rows in a previous MySQL operation" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.affected-rows.php' selected="selected">English</option>
            <option value='de/mysqli.affected-rows.php'>German</option>
            <option value='es/mysqli.affected-rows.php'>Spanish</option>
            <option value='fr/mysqli.affected-rows.php'>French</option>
 ...
 <div class="refsect1 description" id="refsect1-mysqli.affected-rows-description">
  ...
  <p class="para rdfs-comment">
   ...
   Works like <span class="function"><a href="mysqli-result.num-rows.php" class="function">mysqli_num_rows()</a></span> for
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli.affected-rows-returnvalues">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    (<strong><code><a href="reserved.constants.php#constant.php-int-max">PHP_INT_MAX</a></code></strong>), the number of affected rows will be
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli.affected-rows-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli.info.php" class="function" rel="rdfs-seeAlso">mysqli_info()</a> - Retrieves information about the most recently executed query</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/affected-rows.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.affected-rows%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.affected-rows&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.affected-rows.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">While using prepared statements, even if there is no result set (Like in an UPDATE or DELETE), you still need to store the results before affected_rows returns the actual number:<br /><br /><span class="default">&lt;?php<br />$del_stmt</span><span class="keyword">-&gt;</span><span class="default">execute</span><span class="keyword">();<br /></span><span class="default">$del_stmt</span><span class="keyword">-&gt;</span><span class="default">store_result</span><span class="keyword">();<br /></span><span class="default">$count </span><span class="keyword">= </span><span class="default">$del_stmt</span><span class="keyword">-&gt;</span><span class="default">affected_rows</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Otherwise things will just be frustrating ..</span></code></div>
  </div>
 </div>
