...
<head>
  ...
  <title>PHP: ldap_get_values_len - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-get-values-len.php">
 <link rel="shorturl" href="https://www.php.net/ldap-get-values-len">
 <link rel="alternate" href="https://www.php.net/ldap-get-values-len" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-get-values.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-list.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-get-values-len.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-get-values-len.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-get-values-len.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-get-values-len.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-get-values-len.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-get-values-len.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-get-values-len.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-get-values-len.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-get-values-len.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-get-values-len.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-get-values-len.php" hreflang="zh">
...
<meta name="Description" content="Get all binary values from a result entry" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_get_values_len - Manual" />
<meta name="twitter:description" content="Get all binary values from a result entry" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_get_values_len - Manual" />
<meta itemprop="description" content="Get all binary values from a result entry" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get all binary values from a result entry" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ldap-list.php">
          ldap_list &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-get-values.php">
          &laquo; ldap_get_values        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-get-values-len.php' selected="selected">English</option>
            <option value='de/function.ldap-get-values-len.php'>German</option>
            <option value='es/function.ldap-get-values-len.php'>Spanish</option>
            <option value='fr/function.ldap-get-values-len.php'>French</option>
            <option value='it/function.ldap-get-values-len.php'>Italian</option>
            <option value='ja/function.ldap-get-values-len.php'>Japanese</option>
            <option value='pt_BR/function.ldap-get-values-len.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-get-values-len.php'>Russian</option>
            <option value='tr/function.ldap-get-values-len.php'>Turkish</option>
            <option value='uk/function.ldap-get-values-len.php'>Ukrainian</option>
            <option value='zh/function.ldap-get-values-len.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-get-values-len" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-get-values-len-description">
  ...
  <p class="para">
   This function is used exactly like <span class="function"><a href="function.ldap-get-values.php" class="function">ldap_get_values()</a></span>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ldap-get-values-len-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-get-values.php" class="function" rel="rdfs-seeAlso">ldap_get_values()</a> - Get all values from a result entry</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-get-values-len.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-get-values-len%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-get-values-len&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-get-values-len.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">9 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117700">  <div class="votes">
    <div id="Vu117700">
    <a href="/manual/vote-note.php?id=117700&amp;page=function.ldap-get-values-len&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117700">
    <a href="/manual/vote-note.php?id=117700&amp;page=function.ldap-get-values-len&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117700" title="94% like this...">
    15
    </div>
  </div>
  <a href="#117700" class="name">
  <strong class="user"><em>gizmotronic at gmail dot com</em></strong></a><a class="genanchor" href="#117700"> &para;</a><div class="date" title="2015-07-24 04:30"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117700">
<div class="phpcode"><code><span class="html">Revisiting the question of converting a binary objectGUID to a string, there's a simpler method that doesn't involve a lot of string manipulation:<br /><br />function GUIDtoStr($binary_guid) {<br />  $unpacked = unpack('Va/v2b/n2c/Nd', $binary_guid);<br />  return sprintf('%08X-%04X-%04X-%04X-%04X%08X', $unpacked['a'], $unpacked['b1'], $unpacked['b2'], $unpacked['c1'], $unpacked['c2'], $unpacked['d']);<br />}<br /><br />You can of course replace "X" with "x" in the sprintf format string if you prefer lower-case hex digits.</span></code></div>
  </div>
 </div>
  <div class="note" id="111899">  <div class="votes">
    <div id="Vu111899">
    <a href="/manual/vote-note.php?id=111899&amp;page=function.ldap-get-values-len&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111899">
    <a href="/manual/vote-note.php?id=111899&amp;page=function.ldap-get-values-len&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111899" title="80% like this...">
    6
    </div>
  </div>
  <a href="#111899" class="name">
  <strong class="user"><em>ashwini at majestik dot net</em></strong></a><a class="genanchor" href="#111899"> &para;</a><div class="date" title="2013-04-09 10:52"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111899">
<div class="phpcode"><code><span class="html">Just a minor update to the note below from "jhgustafsson" regarding the "objectGUID" field... <br /><br />Going a step further, sometimes its useful to display this GUID as a String, and Microsoft has a support article and script detailing how to convert objectGUID from Hex to String. That article is here: <a href="http://support.microsoft.com/default.aspx?scid=kb%3Ben-us%3B325649" rel="nofollow" target="_blank">http://support.microsoft.com/default.aspx?scid=kb%3Ben-us%3B325649</a><br /><br />Below is a PHP function that does the same thing as Microsoft's VB script, it takes input of objectGUID in binary format and returns it formatted as a string (after converting it to Hex as a middle step). This will return the exact "objectGUID" value that is displayed for any Active Directory object in ADUC.<br /><br />Example output: 3f79048f-42cd-4c77-8426-835cd9f8a3ad<br /><br />function GUIDtoStr($binary_guid) {<br />  $hex_guid = unpack("H*hex", $binary_guid); <br />  $hex = $hex_guid["hex"];<br />  <br />  $hex1 = substr($hex, -26, 2) . substr($hex, -28, 2) . substr($hex, -30, 2) . substr($hex, -32, 2);<br />  $hex2 = substr($hex, -22, 2) . substr($hex, -24, 2);<br />  $hex3 = substr($hex, -18, 2) . substr($hex, -20, 2);<br />  $hex4 = substr($hex, -16, 4);<br />  $hex5 = substr($hex, -12, 12);<br /><br />  $guid_str = $hex1 . "-" . $hex2 . "-" . $hex3 . "-" . $hex4 . "-" . $hex5;<br /><br />  return $guid_str;<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="103586">  <div class="votes">
    <div id="Vu103586">
    <a href="/manual/vote-note.php?id=103586&amp;page=function.ldap-get-values-len&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103586">
    <a href="/manual/vote-note.php?id=103586&amp;page=function.ldap-get-values-len&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103586" title="80% like this...">
    3
    </div>
  </div>
  <a href="#103586" class="name">
  <strong class="user"><em>Stav</em></strong></a><a class="genanchor" href="#103586"> &para;</a><div class="date" title="2011-04-21 05:38"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103586">
<div class="phpcode"><code><span class="html">I had a lot of issues with decoding errors using ldap_get_values_len() and found a of unanswered calls for help on a lot of forums.
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="119809">  <div class="votes">
    <div id="Vu119809">
    <a href="/manual/vote-note.php?id=119809&amp;page=function.ldap-get-values-len&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119809">
    <a href="/manual/vote-note.php?id=119809&amp;page=function.ldap-get-values-len&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119809" title="no votes...">
    0
    </div>
  </div>
  <a href="#119809" class="name">
  <strong class="user"><em>m1tk0123123 at abv dot bg</em></strong></a><a class="genanchor" href="#119809"> &para;</a><div class="date" title="2016-08-30 11:52"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119809">
<div class="phpcode"><code><span class="html">Hi<br />Here solution for WINDOWS objectsid:<br />// LIB .............................<br />class LDAP_OBJECT_SID {<br />    <br />    public function toString($SID_BINARY) {<br />        <br />        $split = str_split($SID_BINARY, 8);<br />        $hexArray = array();<br />        foreach ($split as $key =&gt; $byte) { <br />           $hexArray[$key] = strToUpper(substr('0'.dechex(bindec($byte)), -2));  <br />        }<br />        <br />        $BLOCK_COUNT = hexdec($hexArray[1]);<br />        $DEC_GROUP['SUB-ID-BLOCKS'] = array();<br />        for ($i=0; $i&lt;$BLOCK_COUNT; $i++) {<br />            $offset = 8 + (4 * $i);<br />            $DEC_GROUP['SUB-ID-BLOCKS'][$i] = array();<br />            $DEC_GROUP['SUB-ID-BLOCKS'][$i][1] = hexdec($hexArray[$offset+3]);<br />            $DEC_GROUP['SUB-ID-BLOCKS'][$i][2] = hexdec($hexArray[$offset+2]);<br />            $DEC_GROUP['SUB-ID-BLOCKS'][$i][3] = hexdec($hexArray[$offset+1]);<br />            $DEC_GROUP['SUB-ID-BLOCKS'][$i][4] = hexdec($hexArray[$offset]);<br />            <br />        }<br />        $SID = 'S-'.hexdec($hexArray[0]).'-'.$this-&gt;byte6ToLong(<br />            hexdec($hexArray[2]), <br />            hexdec($hexArray[3]), <br />            hexdec($hexArray[4]), <br />            hexdec($hexArray[5]), <br />            hexdec($hexArray[6]), <br />            hexdec($hexArray[7])<br />        );<br />        foreach ($DEC_GROUP['SUB-ID-BLOCKS'] as $BLOCK) {<br />            $SID .= '-'.$this-&gt;byte4ToLong(<br />                $BLOCK[1], <br />                $BLOCK[2], <br />                $BLOCK[3], <br />                $BLOCK[4]<br />            );<br />        }<br />        return $SID;<br />        <br />    }<br />    <br />    private function byte6ToLong($b1, $b2, $b3, $b4, $b5, $b6) {<br />        $byte6ToLong = $b1;<br />        $byte6ToLong = $byte6ToLong*256 + $b2;<br />        $byte6ToLong = $byte6ToLong*256 + $b3;<br />        $byte6ToLong = $byte6ToLong*256 + $b4;<br />        $byte6ToLong = $byte6ToLong*256 + $b5;<br />        $byte6ToLong = $byte6ToLong*256 + $b6;<br />        return $byte6ToLong;<br />    }  <br />    <br />    private function byte4ToLong($b1, $b2, $b3, $b4) {<br />        $byte4ToLong = $b1;<br />        $byte4ToLong = $byte4ToLong*256 + $b2;<br />        $byte4ToLong = $byte4ToLong*256 + $b3;<br />        $byte4ToLong = $byte4ToLong*256 + $b4;<br />        return $byte4ToLong;<br />    }   <br /><br />}<br /><br />TEST:<br /><br />$sr=ldap_search($conn, $base_dn, $filter,$fields);<br />$entry = ldap_first_entry($conn, $sr);<br />$objectsid_binary = ldap_get_values_len($conn, $entry, "objectsid");<br /><br />$Obj = new LDAP_OBJECT_SID();<br />echo $Obj-&gt;toString($objectsid_binary[0]);</span></code></div>
  </div>
 </div>
  <div class="note" id="90032">  <div class="votes">
    <div id="Vu90032">
    <a href="/manual/vote-note.php?id=90032&amp;page=function.ldap-get-values-len&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd90032">
    <a href="/manual/vote-note.php?id=90032&amp;page=function.ldap-get-values-len&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V90032" title="no votes...">
    0
    </div>
  </div>
  <a href="#90032" class="name">
  <strong class="user"><em>alexey_baranov at inbox dot ru</em></strong></a><a class="genanchor" href="#90032"> &para;</a><div class="date" title="2009-04-02 04:26"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom90032">
<div class="phpcode"><code><span class="html">no more need to use ldap_get_values_len (). ldap_get_attributes() works well now.
<br />
<br /><span class="default">&lt;?php
