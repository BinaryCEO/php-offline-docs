...
<head>
  ...
  <title>PHP: pg_send_query_params - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-send-query-params.php">
 <link rel="shorturl" href="https://www.php.net/pg-send-query-params">
 <link rel="alternate" href="https://www.php.net/pg-send-query-params" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-send-query.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-set-chunked-rows-size.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-send-query-params.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-send-query-params.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-send-query-params.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-send-query-params.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-send-query-params.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-send-query-params.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-send-query-params.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-send-query-params.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-send-query-params.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-send-query-params.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-send-query-params.php" hreflang="zh">
...
<meta name="Description" content="Submits a command and separate parameters to the server without waiting for the result(s)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_send_query_params - Manual" />
<meta name="twitter:description" content="Submits a command and separate parameters to the server without waiting for the result(s)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_send_query_params - Manual" />
<meta itemprop="description" content="Submits a command and separate parameters to the server without waiting for the result(s)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Submits a command and separate parameters to the server without waiting for the result(s)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-set-chunked-rows-size.php">
          pg_set_chunked_rows_size &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-send-query.php">
          &laquo; pg_send_query        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-send-query-params.php' selected="selected">English</option>
            <option value='de/function.pg-send-query-params.php'>German</option>
            <option value='es/function.pg-send-query-params.php'>Spanish</option>
            <option value='fr/function.pg-send-query-params.php'>French</option>
            <option value='it/function.pg-send-query-params.php'>Italian</option>
            <option value='ja/function.pg-send-query-params.php'>Japanese</option>
            <option value='pt_BR/function.pg-send-query-params.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-send-query-params.php'>Russian</option>
            <option value='tr/function.pg-send-query-params.php'>Turkish</option>
            <option value='uk/function.pg-send-query-params.php'>Ukrainian</option>
            <option value='zh/function.pg-send-query-params.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-send-query-params" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_send_query_params</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_send_query_params</span> &mdash; <span class="dc-title">Submits a command and separate parameters to the server without waiting for the result(s)</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-send-query-params-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_send_query_params</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$query</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$params</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>
  ...
  <p class="para">
    This is equivalent to <span class="function"><a href="function.pg-send-query.php" class="function">pg_send_query()</a></span> except that query 
    parameters can be specified separately from the 
    <code class="parameter">query</code> string. The function&#039;s parameters are 
    handled identically to <span class="function"><a href="function.pg-query-params.php" class="function">pg_query_params()</a></span>. Like 
    <span class="function"><a href="function.pg-query-params.php" class="function">pg_query_params()</a></span>, it will not work on pre-7.4 PostgreSQL 
 ...
 <div class="refsect1 changelog" id="refsect1-function.pg-send-query-params-changelog">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-send-query.php" class="function" rel="rdfs-seeAlso">pg_send_query()</a> - Sends asynchronous query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-send-query-params.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-send-query-params%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-send-query-params&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-send-query-params.php">＋<small>add a note</small></a></span>
