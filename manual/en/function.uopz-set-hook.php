...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.uopz-set-hook.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.uopz-restore.php">
 <link rel="next" href="https://www.php.net/manual/en/function.uopz-set-mock.php">
...
<meta name="Description" content="Sets hook to execute when entering a function or method" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: uopz_set_hook - Manual" />
<meta name="twitter:description" content="Sets hook to execute when entering a function or method" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: uopz_set_hook - Manual" />
<meta itemprop="description" content="Sets hook to execute when entering a function or method" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets hook to execute when entering a function or method" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.uopz-set-hook.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.uopz-set-hook.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL uopz 5, PECL uopz 6, PECL uopz 7)</p><p class="refpurpose"><span class="refname">uopz_set_hook</span> &mdash; <span class="dc-title">Sets hook to execute when entering a function or method</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-function.uopz-set-hook-examples">
  ...
  <div class="example" id="uopz-set-hook.example.basic">
   <p><strong>Example #1 Basic <span class="function"><strong>uopz_set_hook()</strong></span> Usage</strong></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.uopz-unset-hook.php" class="function" rel="rdfs-seeAlso">uopz_unset_hook()</a> - Removes previously set hook on function or method</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uopz/functions/uopz-set-hook.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.uopz-set-hook%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.uopz-set-hook&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.uopz-set-hook.php">＋<small>add a note</small></a></span>
