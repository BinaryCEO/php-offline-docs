...
<head>
  ...
  <title>PHP: imap_is_open - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-is-open.php">
 <link rel="shorturl" href="https://www.php.net/imap-is-open">
 <link rel="alternate" href="https://www.php.net/imap-is-open" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-headers.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-last-error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-is-open.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-is-open.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-is-open.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-is-open.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-is-open.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-is-open.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-is-open.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-is-open.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-is-open.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-is-open.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-is-open.php" hreflang="zh">
...
<meta name="Description" content="Check if the IMAP stream is still valid" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_is_open - Manual" />
<meta name="twitter:description" content="Check if the IMAP stream is still valid" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_is_open - Manual" />
<meta itemprop="description" content="Check if the IMAP stream is still valid" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if the IMAP stream is still valid" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-last-error.php">
          imap_last_error &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-headers.php">
          &laquo; imap_headers        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-is-open.php' selected="selected">English</option>
            <option value='de/function.imap-is-open.php'>German</option>
            <option value='es/function.imap-is-open.php'>Spanish</option>
            <option value='fr/function.imap-is-open.php'>French</option>
            <option value='it/function.imap-is-open.php'>Italian</option>
            <option value='ja/function.imap-is-open.php'>Japanese</option>
            <option value='pt_BR/function.imap-is-open.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-is-open.php'>Russian</option>
            <option value='tr/function.imap-is-open.php'>Turkish</option>
            <option value='uk/function.imap-is-open.php'>Ukrainian</option>
            <option value='zh/function.imap-is-open.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-is-open" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_is_open</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.2.1)</p><p class="refpurpose"><span class="refname">imap_is_open</span> &mdash; <span class="dc-title">Check if the <abbr title="Internet Message Access Protocol">IMAP</abbr> stream is still valid</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-is-open-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_is_open</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Check if the <abbr title="Internet Message Access Protocol">IMAP</abbr> stream is still valid.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imap-is-open-parameters">
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-is-open-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the stream is still valid, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.imap-is-open-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3236">
    <p><strong>Example #1 <span class="function"><strong>imap_is_open()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$mbox </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_open</span><span style="color: #007700">(</span><span style="color: #DD0000">"{imap.example.org:143}INBOX"</span><span style="color: #007700">, </span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"password"</span><span style="color: #007700">) or die(</span><span style="color: #0000BB">implode</span><span style="color: #007700">(</span><span style="color: #DD0000">", "</span><span style="color: #007700">, </span><span style="color: #0000BB">imap_errors</span><span style="color: #007700">()));<br /></span><span style="color: #0000BB">imap_is_open</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">// ...<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-is-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-is-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-is-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-is-open.php">＋<small>add a note</small></a></span>
