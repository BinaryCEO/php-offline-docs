...
<head>
  ...
  <title>PHP: timezone_abbreviations_list - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.timezone-abbreviations-list.php">
 <link rel="shorturl" href="https://www.php.net/timezone-abbreviations-list">
 <link rel="alternate" href="https://www.php.net/timezone-abbreviations-list" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.time.php">
 <link rel="next" href="https://www.php.net/manual/en/function.timezone-identifiers-list.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.timezone-abbreviations-list.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.timezone-abbreviations-list.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.timezone-abbreviations-list.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.timezone-abbreviations-list.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.timezone-abbreviations-list.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.timezone-abbreviations-list.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.timezone-abbreviations-list.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.timezone-abbreviations-list.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.timezone-abbreviations-list.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.timezone-abbreviations-list.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.timezone-abbreviations-list.php" hreflang="zh">
...
<meta name="Description" content="Alias of DateTimeZone::listAbbreviations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: timezone_abbreviations_list - Manual" />
<meta name="twitter:description" content="Alias of DateTimeZone::listAbbreviations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: timezone_abbreviations_list - Manual" />
<meta itemprop="description" content="Alias of DateTimeZone::listAbbreviations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTimeZone::listAbbreviations" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.timezone-identifiers-list.php">
          timezone_identifiers_list &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.timezone-abbreviations-list.php' selected="selected">English</option>
            <option value='de/function.timezone-abbreviations-list.php'>German</option>
            <option value='es/function.timezone-abbreviations-list.php'>Spanish</option>
            <option value='fr/function.timezone-abbreviations-list.php'>French</option>
            <option value='it/function.timezone-abbreviations-list.php'>Italian</option>
            <option value='ja/function.timezone-abbreviations-list.php'>Japanese</option>
            <option value='pt_BR/function.timezone-abbreviations-list.php'>Brazilian Portuguese</option>
            <option value='ru/function.timezone-abbreviations-list.php'>Russian</option>
            <option value='tr/function.timezone-abbreviations-list.php'>Turkish</option>
            <option value='uk/function.timezone-abbreviations-list.php'>Ukrainian</option>
            <option value='zh/function.timezone-abbreviations-list.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.timezone-abbreviations-list" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">timezone_abbreviations_list</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">timezone_abbreviations_list</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetimezone.listabbreviations.php" class="methodname">DateTimeZone::listAbbreviations()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.timezone-abbreviations-list-description">
  <h3 class="title">Description</h3>
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetimezone.listabbreviations.php" class="methodname">DateTimeZone::listAbbreviations()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/timezone-abbreviations-list.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.timezone-abbreviations-list%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.timezone-abbreviations-list&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.timezone-abbreviations-list.php">＋<small>add a note</small></a></span>
