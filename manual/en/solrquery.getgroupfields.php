...
<head>
  ...
  <title>PHP: SolrQuery::getGroupFields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getgroupfields.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getgroupfields.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupfields.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getgroupfacet.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getgroupformat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupfields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getgroupfields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getgroupfields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getgroupfields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getgroupfields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getgroupfields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getgroupfields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getgroupfields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getgroupfields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getgroupfields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getgroupfields.php" hreflang="zh">
...
<meta name="Description" content="Returns group fields (group.field parameter values)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getGroupFields - Manual" />
<meta name="twitter:description" content="Returns group fields (group.field parameter values)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getGroupFields - Manual" />
<meta itemprop="description" content="Returns group fields (group.field parameter values)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns group fields (group.field parameter values)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getgroupformat.php">
          SolrQuery::getGroupFormat &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getgroupfacet.php">
          &laquo; SolrQuery::getGroupFacet        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getgroupfields.php' selected="selected">English</option>
            <option value='de/solrquery.getgroupfields.php'>German</option>
            <option value='es/solrquery.getgroupfields.php'>Spanish</option>
            <option value='fr/solrquery.getgroupfields.php'>French</option>
            <option value='it/solrquery.getgroupfields.php'>Italian</option>
            <option value='ja/solrquery.getgroupfields.php'>Japanese</option>
            <option value='pt_BR/solrquery.getgroupfields.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getgroupfields.php'>Russian</option>
            <option value='tr/solrquery.getgroupfields.php'>Turkish</option>
            <option value='uk/solrquery.getgroupfields.php'>Ukrainian</option>
            <option value='zh/solrquery.getgroupfields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getgroupfields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getGroupFields</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getGroupFields</span> &mdash; <span class="dc-title">Returns group fields (group.field parameter values)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getgroupfields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getGroupFields</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getgroupfields-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getgroupfields-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.getgroupfields-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.addgroupfield.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::addGroupField()</a> - Add a field to be used to group results</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getgroupfields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getgroupfields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getgroupfields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getgroupfields.php">＋<small>add a note</small></a></span>
