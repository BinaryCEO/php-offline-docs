...
<head>
  ...
  <title>PHP: ZMQContext::getSocket - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/zmqcontext.getsocket.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/zmqcontext.getsocket.php">
 <link rel="alternate" href="https://www.php.net/manual/en/zmqcontext.getsocket.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.zmqcontext.php">
 <link rel="prev" href="https://www.php.net/manual/en/zmqcontext.getopt.php">
 <link rel="next" href="https://www.php.net/manual/en/zmqcontext.ispersistent.php">

 <link rel="alternate" href="https://www.php.net/manual/en/zmqcontext.getsocket.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/zmqcontext.getsocket.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/zmqcontext.getsocket.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/zmqcontext.getsocket.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/zmqcontext.getsocket.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/zmqcontext.getsocket.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/zmqcontext.getsocket.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/zmqcontext.getsocket.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/zmqcontext.getsocket.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/zmqcontext.getsocket.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/zmqcontext.getsocket.php" hreflang="zh">
...
<meta name="Description" content="Create a new socket" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZMQContext::getSocket - Manual" />
<meta name="twitter:description" content="Create a new socket" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZMQContext::getSocket - Manual" />
<meta itemprop="description" content="Create a new socket" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a new socket" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="zmqcontext.ispersistent.php">
          ZMQContext::isPersistent &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="zmqcontext.getopt.php">
          &laquo; ZMQContext::getOpt        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/zmqcontext.getsocket.php' selected="selected">English</option>
            <option value='de/zmqcontext.getsocket.php'>German</option>
            <option value='es/zmqcontext.getsocket.php'>Spanish</option>
            <option value='fr/zmqcontext.getsocket.php'>French</option>
            <option value='it/zmqcontext.getsocket.php'>Italian</option>
            <option value='ja/zmqcontext.getsocket.php'>Japanese</option>
            <option value='pt_BR/zmqcontext.getsocket.php'>Brazilian Portuguese</option>
            <option value='ru/zmqcontext.getsocket.php'>Russian</option>
            <option value='tr/zmqcontext.getsocket.php'>Turkish</option>
            <option value='uk/zmqcontext.getsocket.php'>Ukrainian</option>
            <option value='zh/zmqcontext.getsocket.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="zmqcontext.getsocket" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Allocate a new context */<br /></span><span style="color: #0000BB">$context </span><span style="color: #007700">= new </span><span style="color: #0000BB">ZMQContext</span><span style="color: #007700">();<br /><br /></span><span style="color: #FF8000">/* Create a new socket */<br /></span><span style="color: #0000BB">$socket </span><span style="color: #007700">= </span><span style="color: #0000BB">$context</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getSocket</span><span style="color: #007700">(</span><span style="color: #0000BB">ZMQ</span><span style="color: #007700">::</span><span style="color: #0000BB">SOCKET_REQ</span><span style="color: #007700">, </span><span style="color: #DD0000">'my sock'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Connect the socket */<br /></span><span style="color: #0000BB">$socket</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"tcp://example.com:1234"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Send a request */<br /></span><span style="color: #0000BB">$socket</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">send</span><span style="color: #007700">(</span><span style="color: #DD0000">"Hello there"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Receive back the response */<br /></span><span style="color: #0000BB">$message </span><span style="color: #007700">= </span><span style="color: #0000BB">$socket</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">recv</span><span style="color: #007700">();<br />echo </span><span style="color: #DD0000">"Received message: </span><span style="color: #007700">{</span><span style="color: #0000BB">$message</span><span style="color: #007700">}</span><span style="color: #DD0000">\n"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zmq/zmqcontext/getsocket.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fzmqcontext.getsocket%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=zmqcontext.getsocket&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zmqcontext.getsocket.php">＋<small>add a note</small></a></span>
