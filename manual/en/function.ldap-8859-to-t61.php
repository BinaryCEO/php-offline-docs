...
<div class="phpcode"><code><span class="html">Description:<br /><br />ldap_8859_to_t61() assists in the conversion of strings between ISO 8859-1 and t61 encodings. If the string cannot be converted successfully, the function returns FALSE. <br /><br />Example:<br /><br />$converted = ldap_8859_to_t61($data);<br />echo $converted;</span></code></div>
  </div>
 </div></div>
