...
<head>
  ...
  <title>PHP: date_create_from_format - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-create-from-format.php">
 <link rel="shorturl" href="https://www.php.net/date-create-from-format">
 <link rel="alternate" href="https://www.php.net/date-create-from-format" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-create.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-create-immutable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-create-from-format.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-create-from-format.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-create-from-format.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-create-from-format.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-create-from-format.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-create-from-format.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-create-from-format.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-create-from-format.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-create-from-format.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-create-from-format.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-create-from-format.php" hreflang="zh">
...
<meta name="Description" content="Alias of DateTime::createFromFormat" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_create_from_format - Manual" />
<meta name="twitter:description" content="Alias of DateTime::createFromFormat" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_create_from_format - Manual" />
<meta itemprop="description" content="Alias of DateTime::createFromFormat" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTime::createFromFormat" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.date-create-immutable.php">
          date_create_immutable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.date-create.php">
          &laquo; date_create        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-create-from-format.php' selected="selected">English</option>
            <option value='de/function.date-create-from-format.php'>German</option>
            <option value='es/function.date-create-from-format.php'>Spanish</option>
            <option value='fr/function.date-create-from-format.php'>French</option>
            <option value='it/function.date-create-from-format.php'>Italian</option>
            <option value='ja/function.date-create-from-format.php'>Japanese</option>
            <option value='pt_BR/function.date-create-from-format.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-create-from-format.php'>Russian</option>
            <option value='tr/function.date-create-from-format.php'>Turkish</option>
            <option value='uk/function.date-create-from-format.php'>Ukrainian</option>
            <option value='zh/function.date-create-from-format.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-create-from-format" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">date_create_from_format</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">date_create_from_format</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetime.createfromformat.php" class="methodname">DateTime::createFromFormat()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.date-create-from-format-description">
  <h3 class="title">Description</h3>
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetime.createfromformat.php" class="methodname">DateTime::createFromFormat()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-create-from-format.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-create-from-format%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-create-from-format&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-create-from-format.php">＋<small>add a note</small></a></span>
