...
<head>
  ...
  <title>PHP: pg_socket - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-socket.php">
 <link rel="shorturl" href="https://www.php.net/pg-socket">
 <link rel="alternate" href="https://www.php.net/pg-socket" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-set-error-verbosity.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-trace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-socket.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-socket.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-socket.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-socket.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-socket.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-socket.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-socket.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-socket.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-socket.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-socket.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-socket.php" hreflang="zh">
...
<meta name="Description" content="Get a read only handle to the socket underlying a PostgreSQL connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_socket - Manual" />
<meta name="twitter:description" content="Get a read only handle to the socket underlying a PostgreSQL connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_socket - Manual" />
<meta itemprop="description" content="Get a read only handle to the socket underlying a PostgreSQL connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get a read only handle to the socket underlying a PostgreSQL connection" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-set-error-verbosity.php">
          &laquo; pg_set_error_verbosity        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-socket.php' selected="selected">English</option>
            <option value='de/function.pg-socket.php'>German</option>
            <option value='es/function.pg-socket.php'>Spanish</option>
            <option value='fr/function.pg-socket.php'>French</option>
            <option value='it/function.pg-socket.php'>Italian</option>
            <option value='ja/function.pg-socket.php'>Japanese</option>
            <option value='pt_BR/function.pg-socket.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-socket.php'>Russian</option>
            <option value='tr/function.pg-socket.php'>Turkish</option>
            <option value='uk/function.pg-socket.php'>Ukrainian</option>
            <option value='zh/function.pg-socket.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-socket" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_socket</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.6.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_socket</span> &mdash; <span class="dc-title">
   Get a read only handle to the socket underlying a PostgreSQL connection
  </span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-socket-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_socket</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code></span>): <span class="type"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_socket()</strong></span> returns a read only <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.pg-socket-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-socket-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   A socket resource on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.pg-socket-changelog">
 ...
 <td>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-socket.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-socket%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-socket&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-socket.php">＋<small>add a note</small></a></span>
