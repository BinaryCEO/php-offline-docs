...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightRegexSlop - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightregexslop.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightregexslop.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightregexslop.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightregexpattern.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightrequirefieldmatch.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightregexslop.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightregexslop.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightregexslop.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightregexslop.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightregexslop.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightregexslop.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightregexslop.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightregexslop.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightregexslop.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightregexslop.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightregexslop.php" hreflang="zh">
...
<meta name="Description" content="Returns the deviation factor from the ideal fragment size" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightRegexSlop - Manual" />
<meta name="twitter:description" content="Returns the deviation factor from the ideal fragment size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightRegexSlop - Manual" />
<meta itemprop="description" content="Returns the deviation factor from the ideal fragment size" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the deviation factor from the ideal fragment size" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gethighlightrequirefieldmatch.php">
          SolrQuery::getHighlightRequireFieldMatch &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightregexpattern.php">
          &laquo; SolrQuery::getHighlightRegexPattern        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightregexslop.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightregexslop.php'>German</option>
            <option value='es/solrquery.gethighlightregexslop.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightregexslop.php'>French</option>
            <option value='it/solrquery.gethighlightregexslop.php'>Italian</option>
            <option value='ja/solrquery.gethighlightregexslop.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightregexslop.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightregexslop.php'>Russian</option>
            <option value='tr/solrquery.gethighlightregexslop.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightregexslop.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightregexslop.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightregexslop" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightRegexSlop</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightRegexSlop</span> &mdash; <span class="dc-title">Returns the deviation factor from the ideal fragment size</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightregexslop-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightRegexSlop</strong></span>(): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightregexslop-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightregexslop-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a <span class="type"><a href="language.types.float.php" class="type float">float</a></span> on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightregexslop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightregexslop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightregexslop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightregexslop.php">＋<small>add a note</small></a></span>
