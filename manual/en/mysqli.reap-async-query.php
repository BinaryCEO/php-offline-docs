...
<head>
  ...
  <title>PHP: mysqli::reap_async_query - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.reap-async-query.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.reap-async-query.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.reap-async-query.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.real-query.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.refresh.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.reap-async-query.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.reap-async-query.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.reap-async-query.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.reap-async-query.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.reap-async-query.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.reap-async-query.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.reap-async-query.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.reap-async-query.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.reap-async-query.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.reap-async-query.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.reap-async-query.php" hreflang="zh">
...
<meta name="Description" content="Get result from async query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::reap_async_query - Manual" />
<meta name="twitter:description" content="Get result from async query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::reap_async_query - Manual" />
<meta itemprop="description" content="Get result from async query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get result from async query" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli.refresh.php">
          mysqli::refresh &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.real-query.php">
          &laquo; mysqli::real_query        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.reap-async-query.php' selected="selected">English</option>
            <option value='de/mysqli.reap-async-query.php'>German</option>
            <option value='es/mysqli.reap-async-query.php'>Spanish</option>
            <option value='fr/mysqli.reap-async-query.php'>French</option>
            <option value='it/mysqli.reap-async-query.php'>Italian</option>
            <option value='ja/mysqli.reap-async-query.php'>Japanese</option>
            <option value='pt_BR/mysqli.reap-async-query.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.reap-async-query.php'>Russian</option>
            <option value='tr/mysqli.reap-async-query.php'>Turkish</option>
            <option value='uk/mysqli.reap-async-query.php'>Ukrainian</option>
            <option value='zh/mysqli.reap-async-query.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.reap-async-query" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli.poll.php" class="function" rel="rdfs-seeAlso">mysqli_poll()</a> - Poll connections</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/reap-async-query.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.reap-async-query%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.reap-async-query&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.reap-async-query.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="97773">  <div class="votes">
    <div id="Vu97773">
    <a href="/manual/vote-note.php?id=97773&amp;page=mysqli.reap-async-query&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd97773">
    <a href="/manual/vote-note.php?id=97773&amp;page=mysqli.reap-async-query&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V97773" title="65% like this...">
    6
    </div>
  </div>
  <a href="#97773" class="name">
  <strong class="user"><em>eric dot caron at gmail dot com</em></strong></a><a class="genanchor" href="#97773"> &para;</a><div class="date" title="2010-05-06 11:05"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97773">
<div class="phpcode"><code><span class="html">Keep in mind that mysqli::reap_async_query only returns mysqli_result on queries like SELECT. For queries where you may be interested in things like affected_rows or insert_id, you can't work off of the result of mysqli::reap_async_query as the example in mysqli::poll leads you to believe. For INSERT/UPDATE/DELETE queries, the data corresponding to the query can be accessed through the associated key to the first array in the mysqli::poll function.<br /><br />So instead of<br /><span class="default">&lt;?php<br />    </span><span class="keyword">foreach (</span><span class="default">$links </span><span class="keyword">as </span><span class="default">$link</span><span class="keyword">) {<br />        if (</span><span class="default">$result </span><span class="keyword">= </span><span class="default">$link</span><span class="keyword">-&gt;</span><span class="default">reap_async_query</span><span class="keyword">()) {<br />            </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">-&gt;</span><span class="default">fetch_row</span><span class="keyword">());<br />            </span><span class="default">mysqli_free_result</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">);<br />            </span><span class="default">$processed</span><span class="keyword">++;<br />        }<br />    }<br /></span><span class="default">?&gt;<br /></span><br />The data is accessible via:<br /><span class="default">&lt;?php<br />    </span><span class="keyword">foreach (</span><span class="default">$links </span><span class="keyword">as </span><span class="default">$link</span><span class="keyword">) {<br />        if (</span><span class="default">$result </span><span class="keyword">= </span><span class="default">$link</span><span class="keyword">-&gt;</span><span class="default">reap_async_query</span><span class="keyword">()) {<br />            </span><span class="comment">//This works for SELECT<br />            </span><span class="keyword">if(</span><span class="default">is_object</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">)){<br />                </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">-&gt;</span><span class="default">fetch_row</span><span class="keyword">());<br />                </span><span class="default">mysqli_free_result</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">);<br />            }<br />            </span><span class="comment">//This works for INSERT/UPDATE/DELETE<br />            </span><span class="keyword">else {<br />                </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$link</span><span class="keyword">);<br />            }<br />            </span><span class="default">$processed</span><span class="keyword">++;<br />        }<br />    }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli.reap-async-query&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.reap-async-query.php">＋<small>add a note</small></a></div>
