...
<head>
  ...
  <title>PHP: curl_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.curl-close.php">
 <link rel="shorturl" href="https://www.php.net/curl-close">
 <link rel="alternate" href="https://www.php.net/curl-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.curl.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.curl.php">
 <link rel="next" href="https://www.php.net/manual/en/function.curl-copy-handle.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.curl-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.curl-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.curl-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.curl-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.curl-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.curl-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.curl-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.curl-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.curl-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.curl-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.curl-close.php" hreflang="zh">
...
<meta name="Description" content="Close a cURL session" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: curl_close - Manual" />
<meta name="twitter:description" content="Close a cURL session" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: curl_close - Manual" />
<meta itemprop="description" content="Close a cURL session" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close a cURL session" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.curl-copy-handle.php">
          curl_copy_handle &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.curl.php">
          &laquo; cURL Functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.curl-close.php' selected="selected">English</option>
            <option value='de/function.curl-close.php'>German</option>
            <option value='es/function.curl-close.php'>Spanish</option>
            <option value='fr/function.curl-close.php'>French</option>
            <option value='it/function.curl-close.php'>Italian</option>
            <option value='ja/function.curl-close.php'>Japanese</option>
            <option value='pt_BR/function.curl-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.curl-close.php'>Russian</option>
            <option value='tr/function.curl-close.php'>Turkish</option>
            <option value='uk/function.curl-close.php'>Ukrainian</option>
            <option value='zh/function.curl-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.curl-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">curl_close</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">curl_close</span> &mdash; <span class="dc-title">Close a cURL session</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.curl-close-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>curl_close</strong></span>(<span class="methodparam"><span class="type"><a href="class.curlhandle.php" class="type CurlHandle">CurlHandle</a></span> <code class="parameter">$handle</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
 ...
 <p class="para">
  ...
  <p class="para">
   ...
   <code class="parameter">handle</code>, is also deleted.
  </p>
 </div>
...
<span class="function"><a href="function.curl-init.php" class="function">curl_init()</a></span>.</p></dd>
 ...
 <div class="refsect1 changelog" id="refsect1-function.curl-close-changelog">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.curl-multi-close.php" class="function" rel="rdfs-seeAlso">curl_multi_close()</a> - Remove all cURL handles from a multi handle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/curl/functions/curl-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.curl-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.curl-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-close.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128829">  <div class="votes">
    <div id="Vu128829">
    <a href="/manual/vote-note.php?id=128829&amp;page=function.curl-close&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128829">
    <a href="/manual/vote-note.php?id=128829&amp;page=function.curl-close&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128829" title="45% like this...">
    -2
    </div>
  </div>
  <a href="#128829" class="name">
  <strong class="user"><em>JS</em></strong></a><a class="genanchor" href="#128829"> &para;</a><div class="date" title="2023-08-24 02:56"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128829">
<div class="phpcode"><code><span class="html">Although the Note for this call says "Prior to PHP 8.0.0, this function was used to close the resource", I found that PHP 7.4.33 on CentOS is not closing the connection on curl_close.<br /><br />The workaround if you want to make sure the connection closes immediately after the request is to set the curl option to forbid reuse:<br /><br />curl_setopt($curl, CURLOPT_FORBID_REUSE, TRUE);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.curl-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-close.php">＋<small>add a note</small></a></div>
