...
<head>
  ...
  <title>PHP: ReflectionClass::isAnonymous - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.isanonymous.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.isanonymous.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isanonymous.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.isabstract.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.iscloneable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isanonymous.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.isanonymous.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.isanonymous.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.isanonymous.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.isanonymous.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.isanonymous.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.isanonymous.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.isanonymous.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.isanonymous.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.isanonymous.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.isanonymous.php" hreflang="zh">
...
<meta name="Description" content="Checks if class is anonymous" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::isAnonymous - Manual" />
<meta name="twitter:description" content="Checks if class is anonymous" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::isAnonymous - Manual" />
<meta itemprop="description" content="Checks if class is anonymous" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if class is anonymous" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionclass.iscloneable.php">
          ReflectionClass::isCloneable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.isabstract.php">
          &laquo; ReflectionClass::isAbstract        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.isanonymous.php' selected="selected">English</option>
            <option value='de/reflectionclass.isanonymous.php'>German</option>
            <option value='es/reflectionclass.isanonymous.php'>Spanish</option>
            <option value='fr/reflectionclass.isanonymous.php'>French</option>
            <option value='it/reflectionclass.isanonymous.php'>Italian</option>
            <option value='ja/reflectionclass.isanonymous.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.isanonymous.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.isanonymous.php'>Russian</option>
            <option value='tr/reflectionclass.isanonymous.php'>Turkish</option>
            <option value='uk/reflectionclass.isanonymous.php'>Ukrainian</option>
            <option value='zh/reflectionclass.isanonymous.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.isanonymous" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::isAnonymous</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::isAnonymous</span> &mdash; <span class="dc-title">Checks if class is anonymous</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.isanonymous-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::isAnonymous</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.isanonymous-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.isanonymous-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.isanonymous-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-5497">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionClass::isAnonymous()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">class </span><span style="color: #0000BB">TestClass </span><span style="color: #007700">{}<br /></span><span style="color: #0000BB">$anonClass </span><span style="color: #007700">= new class {};<br /><br /></span><span style="color: #0000BB">$normalClass </span><span style="color: #007700">= new </span><span style="color: #0000BB">ReflectionClass</span><span style="color: #007700">(</span><span style="color: #DD0000">'TestClass'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$anonClass  </span><span style="color: #007700">= new </span><span style="color: #0000BB">ReflectionClass</span><span style="color: #007700">(</span><span style="color: #0000BB">$anonClass</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$normalClass</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">isAnonymous</span><span style="color: #007700">());<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$anonClass</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">isAnonymous</span><span style="color: #007700">());<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.isanonymous-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.isfinal.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::isFinal()</a> - Checks if class is final</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/isanonymous.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.isanonymous%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.isanonymous&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isanonymous.php">＋<small>add a note</small></a></span>
