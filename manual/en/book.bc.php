...
<head>
  ...
  <title>PHP: BC Math - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.bc.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/refs.math.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.bc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.bc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.bc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.bc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.bc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.bc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.bc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.bc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.bc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.bc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.bc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.bc.php" hreflang="zh">
...
<meta name="Description" content="BCMath Arbitrary Precision Mathematics" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: BC Math - Manual" />
<meta name="twitter:description" content="BCMath Arbitrary Precision Mathematics" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: BC Math - Manual" />
<meta itemprop="description" content="BCMath Arbitrary Precision Mathematics" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="BCMath Arbitrary Precision Mathematics" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="intro.bc.php">
          Introduction &raquo;
              ...
              <div class="prev">
        <a href="refs.math.php">
          &laquo; Mathematical Extensions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.bc.php' selected="selected">English</option>
            <option value='de/book.bc.php'>German</option>
            <option value='es/book.bc.php'>Spanish</option>
            <option value='fr/book.bc.php'>French</option>
            <option value='it/book.bc.php'>Italian</option>
            <option value='ja/book.bc.php'>Japanese</option>
            <option value='pt_BR/book.bc.php'>Brazilian Portuguese</option>
            <option value='ru/book.bc.php'>Russian</option>
            <option value='tr/book.bc.php'>Turkish</option>
            <option value='uk/book.bc.php'>Ukrainian</option>
            <option value='zh/book.bc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.bc" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.bc.php">Introduction</a></li><li><a href="bc.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="bc.installation.php">Installation</a></li><li><a href="bc.configuration.php">Runtime Configuration</a></li></ul></li><li><a href="ref.bc.php">BC Math Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.bcadd.php">bcadd</a> — Add two arbitrary precision numbers</li><li><a href="function.bcceil.php">bcceil</a> — Round up arbitrary precision number</li><li><a href="function.bccomp.php">bccomp</a> — Compare two arbitrary precision numbers</li><li><a href="function.bcdiv.php">bcdiv</a> — Divide two arbitrary precision numbers</li><li><a href="function.bcdivmod.php">bcdivmod</a> — Get the quotient and modulus of an arbitrary precision number</li><li><a href="function.bcfloor.php">bcfloor</a> — Round down arbitrary precision number</li><li><a href="function.bcmod.php">bcmod</a> — Get modulus of an arbitrary precision number</li><li><a href="function.bcmul.php">bcmul</a> — Multiply two arbitrary precision numbers</li><li><a href="function.bcpow.php">bcpow</a> — Raise an arbitrary precision number to another</li><li><a href="function.bcpowmod.php">bcpowmod</a> — Raise an arbitrary precision number to another, reduced by a specified modulus</li><li><a href="function.bcround.php">bcround</a> — Round arbitrary precision number</li><li><a href="function.bcscale.php">bcscale</a> — Set or get default scale parameter for all bc math functions</li><li><a href="function.bcsqrt.php">bcsqrt</a> — Get the square root of an arbitrary precision number</li><li><a href="function.bcsub.php">bcsub</a> — Subtract one arbitrary precision number from another</li></ul></li><li><a href="class.bcmath-number.php">BcMath\Number</a> — The BcMath\Number class<ul class="chunklist chunklist_book chunklist_children"><li><a href="bcmath-number.add.php">BcMath\Number::add</a> — Adds an arbitrary precision number</li><li><a href="bcmath-number.ceil.php">BcMath\Number::ceil</a> — Rounds up an arbitrary precision number</li><li><a href="bcmath-number.compare.php">BcMath\Number::compare</a> — Compares two arbitrary precision numbers</li><li><a href="bcmath-number.construct.php">BcMath\Number::__construct</a> — Creates a BcMath\Number object</li><li><a href="bcmath-number.div.php">BcMath\Number::div</a> — Divides by an arbitrary precision number</li><li><a href="bcmath-number.divmod.php">BcMath\Number::divmod</a> — Gets the quotient and modulus of an arbitrary precision number</li><li><a href="bcmath-number.floor.php">BcMath\Number::floor</a> — Rounds down an arbitrary precision number</li><li><a href="bcmath-number.mod.php">BcMath\Number::mod</a> — Gets the modulus of an arbitrary precision number</li><li><a href="bcmath-number.mul.php">BcMath\Number::mul</a> — Multiplies an arbitrary precision number</li><li><a href="bcmath-number.pow.php">BcMath\Number::pow</a> — Raises an arbitrary precision number</li><li><a href="bcmath-number.powmod.php">BcMath\Number::powmod</a> — Raises an arbitrary precision number, reduced by a specified modulus</li><li><a href="bcmath-number.round.php">BcMath\Number::round</a> — Rounds an arbitrary precision number</li><li><a href="bcmath-number.serialize.php">BcMath\Number::__serialize</a> — Serializes a BcMath\Number object</li><li><a href="bcmath-number.sqrt.php">BcMath\Number::sqrt</a> — Gets the square root of an arbitrary precision number</li><li><a href="bcmath-number.sub.php">BcMath\Number::sub</a> — Subtracts an arbitrary precision number</li><li><a href="bcmath-number.tostring.php">BcMath\Number::__toString</a> — Converts BcMath\Number to string</li><li><a href="bcmath-number.unserialize.php">BcMath\Number::__unserialize</a> — Deserializes a data parameter into a BcMath\Number object</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/bc/book.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.bc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.bc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.bc.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118203">  <div class="votes">
    <div id="Vu118203">
    <a href="/manual/vote-note.php?id=118203&amp;page=book.bc&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118203">
    <a href="/manual/vote-note.php?id=118203&amp;page=book.bc&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118203" title="73% like this...">
    75
    </div>
  </div>
  <a href="#118203" class="name">
  <strong class="user"><em>Hayley Watson</em></strong></a><a class="genanchor" href="#118203"> &para;</a><div class="date" title="2015-10-26 01:30"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118203">
<div class="phpcode"><code><span class="html">This extension is an interface to the GNU implementation as a library of the Basic Calculator utility by Philip Nelson; hence the name.</span></code></div>
  </div>
 </div>
  <div class="note" id="116510">  <div class="votes">
    <div id="Vu116510">
    <a href="/manual/vote-note.php?id=116510&amp;page=book.bc&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116510">
    <a href="/manual/vote-note.php?id=116510&amp;page=book.bc&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116510" title="64% like this...">
    21
    </div>
  </div>
  <a href="#116510" class="name">
  <strong class="user"><em>volek at adamv dot cz</em></strong></a><a class="genanchor" href="#116510"> &para;</a><div class="date" title="2015-01-15 01:44"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116510">
<div class="phpcode"><code><span class="html">Note that when you use implementation of factorial that ClaudiuS made, you get results even if you try to calculate factorial of number that you normally can't, e.g. 2.5, -2, etc. Here is safer implementation:<br /><span class="default">&lt;?php<br /></span><span class="comment">/**<br /> * Calculates a factorial of given number.<br /> * @param string|int $num<br /> * @throws InvalidArgumentException<br /> * @return string<br /> */<br /></span><span class="keyword">function </span><span class="default">bcfact</span><span class="keyword">(</span><span class="default">$num</span><span class="keyword">)<br />{<br />    if (!</span><span class="default">filter_var</span><span class="keyword">(</span><span class="default">$num</span><span class="keyword">, </span><span class="default">FILTER_VALIDATE_INT</span><span class="keyword">) || </span><span class="default">$num </span><span class="keyword">&lt;= </span><span class="default">0</span><span class="keyword">) {<br />        throw new </span><span class="default">InvalidArgumentException</span><span class="keyword">(</span><span class="default">sprintf</span><span class="keyword">(</span><span class="string">'Argument must be natural number, "%s" given.'</span><span class="keyword">, </span><span class="default">$num</span><span class="keyword">));<br />    }<br /><br />    for (</span><span class="default">$result </span><span class="keyword">= </span><span class="string">'1'</span><span class="keyword">; </span><span class="default">$num </span><span class="keyword">&gt; </span><span class="default">0</span><span class="keyword">; </span><span class="default">$num</span><span class="keyword">--) {<br />        </span><span class="default">$result </span><span class="keyword">= </span><span class="default">bcmul</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">, </span><span class="default">$num</span><span class="keyword">);<br />    }<br /><br />    return </span><span class="default">$result</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="111432">  <div class="votes">
    <div id="Vu111432">
    <a href="/manual/vote-note.php?id=111432&amp;page=book.bc&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111432">
    <a href="/manual/vote-note.php?id=111432&amp;page=book.bc&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111432" title="59% like this...">
    19
    </div>
  </div>
  <a href="#111432" class="name">
  <strong class="user"><em>ClaudiuS</em></strong></a><a class="genanchor" href="#111432"> &para;</a><div class="date" title="2013-02-19 02:25"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111432">
<div class="phpcode"><code><span class="html">Needed to compute some permutations and found the BC extension great but poor on functions, so untill this gets implemented here's the factorial function:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">/* BC FACTORIAL<br /> * n! = n * (n-1) * (n-2) .. 1 [eg. 5! = 5 * 4 * 3 * 2 * 1 = 120]<br /> */<br /></span><span class="keyword">function </span><span class="default">bcfact</span><span class="keyword">(</span><span class="default">$n</span><span class="keyword">){<br />    </span><span class="default">$factorial</span><span class="keyword">=</span><span class="default">$n</span><span class="keyword">;<br />    while (--</span><span class="default">$n</span><span class="keyword">&gt;</span><span class="default">1</span><span class="keyword">) </span><span class="default">$factorial</span><span class="keyword">=</span><span class="default">bcmul</span><span class="keyword">(</span><span class="default">$factorial</span><span class="keyword">,</span><span class="default">$n</span><span class="keyword">);<br />    return </span><span class="default">$factorial</span><span class="keyword">;<br />}<br /><br />print </span><span class="default">bcfact</span><span class="keyword">(</span><span class="default">50</span><span class="keyword">); <br /></span><span class="comment">//30414093201713378043612608166064768844377641568960512000000000000<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=book.bc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.bc.php">＋<small>add a note</small></a></div>
