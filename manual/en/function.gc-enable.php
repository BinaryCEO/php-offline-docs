...
<head>
  ...
  <title>PHP: gc_enable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gc-enable.php">
 <link rel="shorturl" href="https://www.php.net/gc-enable">
 <link rel="alternate" href="https://www.php.net/gc-enable" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gc-disable.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gc-enabled.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gc-enable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gc-enable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gc-enable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gc-enable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gc-enable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gc-enable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gc-enable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gc-enable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gc-enable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gc-enable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gc-enable.php" hreflang="zh">
...
<meta name="Description" content="Activates the circular reference collector" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gc_enable - Manual" />
<meta name="twitter:description" content="Activates the circular reference collector" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gc_enable - Manual" />
<meta itemprop="description" content="Activates the circular reference collector" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Activates the circular reference collector" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gc-enable.php' selected="selected">English</option>
            <option value='de/function.gc-enable.php'>German</option>
            <option value='es/function.gc-enable.php'>Spanish</option>
            <option value='fr/function.gc-enable.php'>French</option>
            <option value='it/function.gc-enable.php'>Italian</option>
            <option value='ja/function.gc-enable.php'>Japanese</option>
            <option value='pt_BR/function.gc-enable.php'>Brazilian Portuguese</option>
            <option value='ru/function.gc-enable.php'>Russian</option>
            <option value='tr/function.gc-enable.php'>Turkish</option>
            <option value='uk/function.gc-enable.php'>Ukrainian</option>
            <option value='zh/function.gc-enable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gc-enable" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gc_enable</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gc_enable</span> &mdash; <span class="dc-title">Activates the circular reference collector</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.gc-enable-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gc_enable</strong></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>

  <p class="para rdfs-comment">
   Activates the circular reference collector, setting
   <a href="info.configuration.php#ini.zend.enable-gc" class="link">zend.enable_gc</a> to <code class="literal">1</code>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.gc-enable-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>

 
 <div class="refsect1 returnvalues" id="refsect1-function.gc-enable-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.gc-enable-seealso">
   ...
   <ul class="simplelist">
    <li><a href="features.gc.php" class="link">Garbage Collection</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/gc-enable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gc-enable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gc-enable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gc-enable.php">＋<small>add a note</small></a></span>
