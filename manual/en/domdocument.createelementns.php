...
<head>
  ...
  <title>PHP: DOMDocument::createElementNS - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/domdocument.createelementns.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/domdocument.createelementns.php">
 <link rel="alternate" href="https://www.php.net/manual/en/domdocument.createelementns.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.domdocument.php">
 <link rel="prev" href="https://www.php.net/manual/en/domdocument.createelement.php">
 <link rel="next" href="https://www.php.net/manual/en/domdocument.createentityreference.php">

 <link rel="alternate" href="https://www.php.net/manual/en/domdocument.createelementns.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/domdocument.createelementns.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/domdocument.createelementns.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/domdocument.createelementns.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/domdocument.createelementns.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/domdocument.createelementns.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/domdocument.createelementns.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/domdocument.createelementns.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/domdocument.createelementns.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/domdocument.createelementns.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/domdocument.createelementns.php" hreflang="zh">
...
<meta name="Description" content="Create new element node with an associated namespace" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMDocument::createElementNS - Manual" />
<meta name="twitter:description" content="Create new element node with an associated namespace" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMDocument::createElementNS - Manual" />
<meta itemprop="description" content="Create new element node with an associated namespace" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create new element node with an associated namespace" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="domdocument.createentityreference.php">
          DOMDocument::createEntityReference &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domdocument.createelement.php">
          &laquo; DOMDocument::createElement        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/domdocument.createelementns.php' selected="selected">English</option>
            <option value='de/domdocument.createelementns.php'>German</option>
            <option value='es/domdocument.createelementns.php'>Spanish</option>
            <option value='fr/domdocument.createelementns.php'>French</option>
            <option value='it/domdocument.createelementns.php'>Italian</option>
            <option value='ja/domdocument.createelementns.php'>Japanese</option>
            <option value='pt_BR/domdocument.createelementns.php'>Brazilian Portuguese</option>
            <option value='ru/domdocument.createelementns.php'>Russian</option>
            <option value='tr/domdocument.createelementns.php'>Turkish</option>
            <option value='uk/domdocument.createelementns.php'>Ukrainian</option>
            <option value='zh/domdocument.createelementns.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="domdocument.createelementns" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">DOMDocument::createElementNS</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">DOMDocument::createElementNS</span> &mdash; <span class="dc-title">
   Create new element node with an associated namespace
  </span></p>

 </div>
 <div class="refsect1 description" id="refsect1-domdocument.createelementns-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>DOMDocument::createElementNS</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$namespace</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$qualifiedName</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code><span class="initializer"> = &quot;&quot;</span></span>): <span class="type"><span class="type"><a href="class.domelement.php" class="type DOMElement">DOMElement</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
it is inserted with (e.g.) <span class="function"><a href="domnode.appendchild.php" class="function">DOMNode::appendChild()</a></span>.
 ...
 <div class="refsect1 parameters" id="refsect1-domdocument.createelementns-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The qualified name of the element, as <code class="literal">prefix:tagname</code>.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       ...
       You can also set the value later with <a href="class.domnode.php#domnode.props.nodevalue" class="link">DOMElement::$nodeValue</a>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-domdocument.createelementns-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The new <span class="classname"><a href="class.domelement.php" class="classname">DOMElement</a></span> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if an error occurred.
  </p>
 </div>

 <div class="refsect1 errors" id="refsect1-domdocument.createelementns-errors">
 ...
 <div class="refsect1 examples" id="refsect1-domdocument.createelementns-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-5769">
...
item_type</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-domdocument.createelementns-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="domdocument.createtextnode.php" class="methodname" rel="rdfs-seeAlso">DOMDocument::createTextNode()</a> - Create new text node</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domdocument/createelementns.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdomdocument.createelementns%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=domdocument.createelementns&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domdocument.createelementns.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="107007">  <div class="votes">
    <div id="Vu107007">
    <a href="/manual/vote-note.php?id=107007&amp;page=domdocument.createelementns&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd107007">
    <a href="/manual/vote-note.php?id=107007&amp;page=domdocument.createelementns&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V107007" title="57% like this...">
    2
    </div>
  </div>
  <a href="#107007" class="name">
  <strong class="user"><em>Martin</em></strong></a><a class="genanchor" href="#107007"> &para;</a><div class="date" title="2011-12-27 09:39"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom107007">
<div class="phpcode"><code><span class="html">To avoid multiple xmlns re-declaration, make sure you appending ElementNS into actual DOMDocument tree (not into some currently-assembed derelict element).</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=domdocument.createelementns&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domdocument.createelementns.php">＋<small>add a note</small></a></div>
