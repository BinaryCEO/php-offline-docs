...
<head>
  ...
  <title>PHP: MongoDB\Driver\Exception\CommandException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-exception-commandexception.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-exception-commandexception">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-exception-commandexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-bulkwritecommandexception.getwriteerrors.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-commandexception.getresultdocument.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-exception-commandexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-exception-commandexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-exception-commandexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-exception-commandexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-exception-commandexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-exception-commandexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-exception-commandexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-exception-commandexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-exception-commandexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-exception-commandexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-exception-commandexception.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\Exception\CommandException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Exception\CommandException - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\Exception\CommandException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Exception\CommandException - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\Exception\CommandException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\Exception\CommandException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-commandexception.getresultdocument.php">
          MongoDB\Driver\Exception\CommandException::getResultDocument &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-bulkwritecommandexception.getwriteerrors.php">
          &laquo; MongoDB\Driver\Exception\BulkWriteCommandException::getWriteErrors        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-exception-commandexception.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-exception-commandexception.php'>German</option>
            <option value='es/class.mongodb-driver-exception-commandexception.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-exception-commandexception.php'>French</option>
            <option value='it/class.mongodb-driver-exception-commandexception.php'>Italian</option>
            <option value='ja/class.mongodb-driver-exception-commandexception.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-exception-commandexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-exception-commandexception.php'>Russian</option>
            <option value='tr/class.mongodb-driver-exception-commandexception.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-exception-commandexception.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-exception-commandexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-exception-commandexception" class="reference">
  ...
  <div class="section" id="mongodb-driver-exception-commandexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">MongoDB\Driver\Exception\CommandException</strong>
     </span>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.object.php" class="type object">object</a></span>
      <var class="varname"><a href="class.mongodb-driver-exception-commandexception.php#mongodb-driver-exception-commandexception.props.resultdocument">$<var class="varname">resultDocument</var></a></var>;</div>
...
<div class="fieldsynopsis"><span class="modifier">private</span>
   ...
   <span class="modifier">final</span> <span class="modifier">public</span> <span class="methodname"><a href="mongodb-driver-commandexception.getresultdocument.php" class="methodname">getResultDocument</a></span>(): <span class="type"><a href="language.types.object.php" class="type object">object</a></span></div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-commandexception.getresultdocument.php">MongoDB\Driver\Exception\CommandException::getResultDocument</a> — Returns the result document for the failed command</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/exception/commandexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-exception-commandexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-exception-commandexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-exception-commandexception.php">＋<small>add a note</small></a></span>
