...
<head>
  ...
  <title>PHP: Imagick::setImageAttribute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageattribute.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageattribute.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageattribute.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageartifact.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagebackgroundcolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageattribute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageattribute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageattribute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageattribute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageattribute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageattribute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageattribute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageattribute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageattribute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageattribute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageattribute.php" hreflang="zh">
...
<meta name="Description" content="Sets an image attribute" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageAttribute - Manual" />
<meta name="twitter:description" content="Sets an image attribute" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageAttribute - Manual" />
<meta itemprop="description" content="Sets an image attribute" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets an image attribute" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagebackgroundcolor.php">
          Imagick::setImageBackgroundColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageartifact.php">
          &laquo; Imagick::setImageArtifact        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageattribute.php' selected="selected">English</option>
            <option value='de/imagick.setimageattribute.php'>German</option>
            <option value='es/imagick.setimageattribute.php'>Spanish</option>
            <option value='fr/imagick.setimageattribute.php'>French</option>
            <option value='it/imagick.setimageattribute.php'>Italian</option>
            <option value='ja/imagick.setimageattribute.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageattribute.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageattribute.php'>Russian</option>
            <option value='tr/imagick.setimageattribute.php'>Turkish</option>
            <option value='uk/imagick.setimageattribute.php'>Ukrainian</option>
            <option value='zh/imagick.setimageattribute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageattribute" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageAttribute</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageAttribute</span> &mdash; <span class="dc-title">Sets an image attribute</span></p>

 </div>

 <div id="imagick.setimageattribute-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.setimageattribute-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageAttribute</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageattribute-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageattribute-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageattribute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageattribute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageattribute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageattribute.php">＋<small>add a note</small></a></span>
