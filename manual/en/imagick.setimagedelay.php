...
<head>
  ...
  <title>PHP: Imagick::setImageDelay - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagedelay.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagedelay.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagedelay.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagecompressionquality.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagedepth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagedelay.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagedelay.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagedelay.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagedelay.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagedelay.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagedelay.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagedelay.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagedelay.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagedelay.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagedelay.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagedelay.php" hreflang="zh">
...
<meta name="Description" content="Sets the image delay" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageDelay - Manual" />
<meta name="twitter:description" content="Sets the image delay" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageDelay - Manual" />
<meta itemprop="description" content="Sets the image delay" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image delay" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagedepth.php">
          Imagick::setImageDepth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagecompressionquality.php">
          &laquo; Imagick::setImageCompressionQuality        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagedelay.php' selected="selected">English</option>
            <option value='de/imagick.setimagedelay.php'>German</option>
            <option value='es/imagick.setimagedelay.php'>Spanish</option>
            <option value='fr/imagick.setimagedelay.php'>French</option>
            <option value='it/imagick.setimagedelay.php'>Italian</option>
            <option value='ja/imagick.setimagedelay.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagedelay.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagedelay.php'>Russian</option>
            <option value='tr/imagick.setimagedelay.php'>Turkish</option>
            <option value='uk/imagick.setimagedelay.php'>Ukrainian</option>
            <option value='zh/imagick.setimagedelay.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagedelay" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageDelay</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageDelay</span> &mdash; <span class="dc-title">Sets the image delay</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagedelay-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageDelay</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$delay</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagedelay-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagedelay-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagedelay-errors">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// Modify an animated Gif so that it's frames are played at a variable speed,<br />// varying between being shown for 50ms down to 0ms, which will cause the frame<br />// to be skipped in most browsers.<br /></span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #DD0000">"Test.gif"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">coalesceImages</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$frameCount </span><span style="color: #007700">= </span><span style="color: #0000BB">0</span><span style="color: #007700">;<br /><br />foreach (</span><span style="color: #0000BB">$imagick </span><span style="color: #007700">as </span><span style="color: #0000BB">$frame</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageDelay</span><span style="color: #007700">(((</span><span style="color: #0000BB">$frameCount </span><span style="color: #007700">% </span><span style="color: #0000BB">11</span><span style="color: #007700">) * </span><span style="color: #0000BB">5</span><span style="color: #007700">));<br />    </span><span style="color: #0000BB">$frameCount</span><span style="color: #007700">++;<br />}<br /><br /></span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">deconstructImages</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">writeImages</span><span style="color: #007700">(</span><span style="color: #DD0000">"/path/to/save/output.gif"</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagedelay.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagedelay%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagedelay&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagedelay.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="98252">  <div class="votes">
    <div id="Vu98252">
    <a href="/manual/vote-note.php?id=98252&amp;page=imagick.setimagedelay&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98252">
    <a href="/manual/vote-note.php?id=98252&amp;page=imagick.setimagedelay&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98252" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#98252" class="name">
  <strong class="user"><em>fortruth at mabang dot net</em></strong></a><a class="genanchor" href="#98252"> &para;</a><div class="date" title="2010-06-03 08:02"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98252">
<div class="phpcode"><code><span class="html">the delay time unit is micro-second  when 100  is  1s</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimagedelay&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagedelay.php">＋<small>add a note</small></a></div>
