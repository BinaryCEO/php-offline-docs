...
<head>
  ...
  <title>PHP: Imagick::valid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.valid.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.valid.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.valid.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.unsharpmaskimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.vignetteimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.valid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.valid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.valid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.valid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.valid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.valid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.valid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.valid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.valid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.valid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.valid.php" hreflang="zh">
...
<meta name="Description" content="Checks if the current item is valid" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::valid - Manual" />
<meta name="twitter:description" content="Checks if the current item is valid" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::valid - Manual" />
<meta itemprop="description" content="Checks if the current item is valid" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if the current item is valid" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.vignetteimage.php">
          Imagick::vignetteImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.unsharpmaskimage.php">
          &laquo; Imagick::unsharpMaskImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.valid.php' selected="selected">English</option>
            <option value='de/imagick.valid.php'>German</option>
            <option value='es/imagick.valid.php'>Spanish</option>
            <option value='fr/imagick.valid.php'>French</option>
            <option value='it/imagick.valid.php'>Italian</option>
            <option value='ja/imagick.valid.php'>Japanese</option>
            <option value='pt_BR/imagick.valid.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.valid.php'>Russian</option>
            <option value='tr/imagick.valid.php'>Turkish</option>
            <option value='uk/imagick.valid.php'>Ukrainian</option>
            <option value='zh/imagick.valid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.valid" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::valid</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::valid</span> &mdash; <span class="dc-title">Checks if the current item is valid</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.valid-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::valid</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.valid-parameters">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/valid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.valid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.valid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.valid.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96162">  <div class="votes">
    <div id="Vu96162">
    <a href="/manual/vote-note.php?id=96162&amp;page=imagick.valid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96162">
    <a href="/manual/vote-note.php?id=96162&amp;page=imagick.valid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96162" title="50% like this...">
    0
    </div>
  </div>
  <a href="#96162" class="name">
  <strong class="user"><em>hyrumt at mediarain dot com</em></strong></a><a class="genanchor" href="#96162"> &para;</a><div class="date" title="2010-02-11 11:01"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96162">
<div class="phpcode"><code><span class="html">We found this method to be of value when checking most image file types. However, it does not appear to be rigorous enough to detect corrupt jpg files. We use the following for jpgs and validate() for everything else.<br /><br /><span class="default">&lt;?php<br />    </span><span class="comment">// check for the existence of the EOI segment header at the end of the file<br />    </span><span class="keyword">if (</span><span class="default">0 </span><span class="keyword">!== </span><span class="default">fseek</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">, -</span><span class="default">2</span><span class="keyword">, </span><span class="default">SEEK_END</span><span class="keyword">) || </span><span class="string">"\xFF\xD9" </span><span class="keyword">!== </span><span class="default">fread</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">)) {<br />        </span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">);<br />        return </span><span class="default">FALSE</span><span class="keyword">;<br />    }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.valid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.valid.php">＋<small>add a note</small></a></div>
