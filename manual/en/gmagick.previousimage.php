...
<head>
  ...
  <title>PHP: Gmagick::previousimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.previousimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.previousimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.previousimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.oilpaintimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.profileimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.previousimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.previousimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.previousimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.previousimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.previousimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.previousimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.previousimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.previousimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.previousimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.previousimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.previousimage.php" hreflang="zh">
...
<meta name="Description" content="Move to the previous image in the object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::previousimage - Manual" />
<meta name="twitter:description" content="Move to the previous image in the object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::previousimage - Manual" />
<meta itemprop="description" content="Move to the previous image in the object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Move to the previous image in the object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.profileimage.php">
          Gmagick::profileimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.oilpaintimage.php">
          &laquo; Gmagick::oilpaintimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.previousimage.php' selected="selected">English</option>
            <option value='de/gmagick.previousimage.php'>German</option>
            <option value='es/gmagick.previousimage.php'>Spanish</option>
            <option value='fr/gmagick.previousimage.php'>French</option>
            <option value='it/gmagick.previousimage.php'>Italian</option>
            <option value='ja/gmagick.previousimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.previousimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.previousimage.php'>Russian</option>
            <option value='tr/gmagick.previousimage.php'>Turkish</option>
            <option value='uk/gmagick.previousimage.php'>Ukrainian</option>
            <option value='zh/gmagick.previousimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.previousimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::previousimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::previousimage</span> &mdash; <span class="dc-title">Move to the previous image in the object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.previousimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::previousimage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.previousimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.previousimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.previousimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/previousimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.previousimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.previousimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.previousimage.php">＋<small>add a note</small></a></span>
