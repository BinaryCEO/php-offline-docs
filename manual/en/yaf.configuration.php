...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/yaf.configuration.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/yaf.configuration.php">
 <link rel="alternate" href="https://www.php.net/manual/en/yaf.configuration.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/yaf.setup.php">
 <link rel="prev" href="https://www.php.net/manual/en/yaf.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/yaf.constants.php">

 <link rel="alternate" href="https://www.php.net/manual/en/yaf.configuration.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/yaf.configuration.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/yaf.configuration.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/yaf.configuration.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/yaf.configuration.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/yaf.configuration.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/yaf.configuration.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/yaf.configuration.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/yaf.configuration.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/yaf.configuration.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/yaf.configuration.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="yaf.installation.php">
          ...
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.basic.other.php'>Other Basic Extensions</a></li>      <li><a href='book.yaf.php'>Yaf</a></li>      <li><a href='yaf.setup.php'>Installing/Configuring</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/yaf.configuration.php' selected="selected">English</option>
            <option value='de/yaf.configuration.php'>German</option>
            <option value='es/yaf.configuration.php'>Spanish</option>
            <option value='fr/yaf.configuration.php'>French</option>
            <option value='it/yaf.configuration.php'>Italian</option>
            <option value='ja/yaf.configuration.php'>Japanese</option>
            <option value='pt_BR/yaf.configuration.php'>Brazilian Portuguese</option>
            <option value='ru/yaf.configuration.php'>Russian</option>
            <option value='tr/yaf.configuration.php'>Turkish</option>
            <option value='uk/yaf.configuration.php'>Ukrainian</option>
            <option value='zh/yaf.configuration.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="yaf.configuration" class="section">
...
the configuration directives.</p>
 ...
 <p class="para">
  <dl>
     ...
     <dd>
      <p class="para">
        When this value is On, if <span class="classname"><a href="class.yaf-loader.php" class="classname">Yaf_Loader</a></span> can not
        find a class, it will return <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>, then give chance to other auto
        load function to be called.      
      </p>
      <p class="para">
        When this value is Off, if <span class="classname"><a href="class.yaf-loader.php" class="classname">Yaf_Loader</a></span> can not
        find a class, it will return <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, and make the class autoloading
        failed immediately.
      </p>
      <blockquote class="note"><p><strong class="note">Note</strong>: 
       <p class="para">
        Yaf will register its loader during a instantiation of  
        <span class="classname"><a href="class.yaf-application.php" class="classname">Yaf_Application</a></span>, so any other auto loaders
     ...
     <dd>
      <p class="para">
       ...
       <p class="para">
        ...
        <span class="classname"><a href="class.yaf-application.php" class="classname">Yaf_Application</a></span>) as the final config of the
...
Yaf_Route_Static =&gt; \Yaf\Route_Static
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaf/ini.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fyaf.configuration%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=yaf.configuration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/yaf.configuration.php">＋<small>add a note</small></a></span>
 ...
 <div class="note">There are no user contributed notes for this page.</div></section>    </section><!-- layout-content -->
        ...
        <ul class='parent-menu-list'>
                                    <li>
                <a href="yaf.setup.php">Installing/Configuring</a>

                                    <ul class='child-menu-list'>

                                                <li class="">
                            <a href="yaf.installation.php" title="Installation">Installation</a>
                        </li>
                                                <li class="current">
                            <a href="yaf.configuration.php" title="Runtime Configuration">Runtime Configuration</a>
                        </li>
