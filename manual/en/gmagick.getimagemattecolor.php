...
<head>
  ...
  <title>PHP: Gmagick::getimagemattecolor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagemattecolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagemattecolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagemattecolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagematte.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimageprofile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagemattecolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagemattecolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagemattecolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagemattecolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagemattecolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagemattecolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagemattecolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagemattecolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagemattecolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagemattecolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagemattecolor.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimagemattecolor - Manual" />
<meta name="twitter:description" content="Returns the image matte color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagemattecolor - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimageprofile.php">
          Gmagick::getimageprofile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagematte.php">
          &laquo; Gmagick::getimagematte        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagemattecolor.php' selected="selected">English</option>
            <option value='de/gmagick.getimagemattecolor.php'>German</option>
            <option value='es/gmagick.getimagemattecolor.php'>Spanish</option>
            <option value='fr/gmagick.getimagemattecolor.php'>French</option>
            <option value='it/gmagick.getimagemattecolor.php'>Italian</option>
            <option value='ja/gmagick.getimagemattecolor.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagemattecolor.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagemattecolor.php'>Russian</option>
            <option value='tr/gmagick.getimagemattecolor.php'>Turkish</option>
            <option value='uk/gmagick.getimagemattecolor.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagemattecolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagemattecolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagemattecolor</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagemattecolor</span> &mdash; <span class="dc-title">Returns the image matte color</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagemattecolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagemattecolor</strong></span>(): <span class="type"><a href="class.gmagickpixel.php" class="type GmagickPixel">GmagickPixel</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagemattecolor-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagemattecolor-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagemattecolor-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagemattecolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagemattecolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagemattecolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagemattecolor.php">＋<small>add a note</small></a></span>
