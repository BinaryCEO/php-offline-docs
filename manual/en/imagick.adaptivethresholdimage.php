...
<head>
  ...
  <title>PHP: Imagick::adaptiveThresholdImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.adaptivethresholdimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.adaptivethresholdimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.adaptivethresholdimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.adaptivesharpenimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.addimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.adaptivethresholdimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.adaptivethresholdimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.adaptivethresholdimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.adaptivethresholdimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.adaptivethresholdimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.adaptivethresholdimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.adaptivethresholdimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.adaptivethresholdimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.adaptivethresholdimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.adaptivethresholdimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.adaptivethresholdimage.php" hreflang="zh">
...
<meta name="Description" content="Selects a threshold for each pixel based on a range of intensity" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::adaptiveThresholdImage - Manual" />
<meta name="twitter:description" content="Selects a threshold for each pixel based on a range of intensity" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::adaptiveThresholdImage - Manual" />
<meta itemprop="description" content="Selects a threshold for each pixel based on a range of intensity" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Selects a threshold for each pixel based on a range of intensity" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.addimage.php">
          Imagick::addImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.adaptivesharpenimage.php">
          &laquo; Imagick::adaptiveSharpenImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.adaptivethresholdimage.php' selected="selected">English</option>
            <option value='de/imagick.adaptivethresholdimage.php'>German</option>
            <option value='es/imagick.adaptivethresholdimage.php'>Spanish</option>
            <option value='fr/imagick.adaptivethresholdimage.php'>French</option>
            <option value='it/imagick.adaptivethresholdimage.php'>Italian</option>
            <option value='ja/imagick.adaptivethresholdimage.php'>Japanese</option>
            <option value='pt_BR/imagick.adaptivethresholdimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.adaptivethresholdimage.php'>Russian</option>
            <option value='tr/imagick.adaptivethresholdimage.php'>Turkish</option>
            <option value='uk/imagick.adaptivethresholdimage.php'>Ukrainian</option>
            <option value='zh/imagick.adaptivethresholdimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.adaptivethresholdimage" class="refentry">
  ...
  <p class="para">
    <div class="example" id="example-2965">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/adaptivethresholdimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.adaptivethresholdimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.adaptivethresholdimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.adaptivethresholdimage.php">＋<small>add a note</small></a></span>
