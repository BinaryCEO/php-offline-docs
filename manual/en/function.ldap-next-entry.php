...
<head>
  ...
  <title>PHP: ldap_next_entry - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-next-entry.php">
 <link rel="shorturl" href="https://www.php.net/ldap-next-entry">
 <link rel="alternate" href="https://www.php.net/ldap-next-entry" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-next-attribute.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-next-reference.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-next-entry.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-next-entry.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-next-entry.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-next-entry.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-next-entry.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-next-entry.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-next-entry.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-next-entry.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-next-entry.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-next-entry.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-next-entry.php" hreflang="zh">
...
<meta name="Description" content="Get next result entry" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_next_entry - Manual" />
<meta name="twitter:description" content="Get next result entry" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_next_entry - Manual" />
<meta itemprop="description" content="Get next result entry" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get next result entry" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ldap-next-reference.php">
          ldap_next_reference &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-next-attribute.php">
          &laquo; ldap_next_attribute        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-next-entry.php' selected="selected">English</option>
            <option value='de/function.ldap-next-entry.php'>German</option>
            <option value='es/function.ldap-next-entry.php'>Spanish</option>
            <option value='fr/function.ldap-next-entry.php'>French</option>
            <option value='it/function.ldap-next-entry.php'>Italian</option>
            <option value='ja/function.ldap-next-entry.php'>Japanese</option>
            <option value='pt_BR/function.ldap-next-entry.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-next-entry.php'>Russian</option>
            <option value='tr/function.ldap-next-entry.php'>Turkish</option>
            <option value='uk/function.ldap-next-entry.php'>Ukrainian</option>
            <option value='zh/function.ldap-next-entry.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-next-entry" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-get-entries.php" class="function" rel="rdfs-seeAlso">ldap_get_entries()</a> - Get all result entries</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-next-entry.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-next-entry%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-next-entry&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-next-entry.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115393">  <div class="votes">
    <div id="Vu115393">
    <a href="/manual/vote-note.php?id=115393&amp;page=function.ldap-next-entry&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115393">
    <a href="/manual/vote-note.php?id=115393&amp;page=function.ldap-next-entry&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115393" title="55% like this...">
    1
    </div>
  </div>
  <a href="#115393" class="name">
  <strong class="user"><em>me at xbug dot de</em></strong></a><a class="genanchor" href="#115393"> &para;</a><div class="date" title="2014-07-17 10:13"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115393">
<div class="phpcode"><code><span class="html">This is working for me in php 5.5:<br /><br /><span class="default">&lt;?php<br />$ldap_host </span><span class="keyword">= </span><span class="string">'ldap://ldap.example.com'</span><span class="keyword">;<br /></span><span class="default">$base_dn </span><span class="keyword">= </span><span class="string">"ou=users,dc=example,dc=com"</span><span class="keyword">;<br /></span><span class="default">$connect </span><span class="keyword">= </span><span class="default">ldap_connect</span><span class="keyword">(</span><span class="default">$ldap_host</span><span class="keyword">);<br /><br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">ldap_search</span><span class="keyword">(</span><span class="default">$connect</span><span class="keyword">, </span><span class="default">$base_dn</span><span class="keyword">, </span><span class="string">"(cn=*)"</span><span class="keyword">);<br /><br /></span><span class="default">$entry </span><span class="keyword">= </span><span class="default">ldap_first_entry</span><span class="keyword">(</span><span class="default">$connect</span><span class="keyword">, </span><span class="default">$result</span><span class="keyword">);<br /><br />do {<br />    </span><span class="default">$dn </span><span class="keyword">= </span><span class="default">ldap_get_dn</span><span class="keyword">(</span><span class="default">$connect</span><span class="keyword">, </span><span class="default">$entry</span><span class="keyword">);<br />    echo </span><span class="string">"DN is </span><span class="default">$dn</span><span class="string">\n"</span><span class="keyword">;<br />} while (</span><span class="default">$entry </span><span class="keyword">= </span><span class="default">ldap_next_entry</span><span class="keyword">(</span><span class="default">$connect</span><span class="keyword">, </span><span class="default">$entry</span><span class="keyword">));<br /><br /></span><span class="default">ldap_close</span><span class="keyword">(</span><span class="default">$connect</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-next-entry&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-next-entry.php">＋<small>add a note</small></a></div>
