...
<head>
  ...
  <title>PHP: class_parents - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.class-parents.php">
 <link rel="shorturl" href="https://www.php.net/class-parents">
 <link rel="alternate" href="https://www.php.net/class-parents" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.spl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.class-implements.php">
 <link rel="next" href="https://www.php.net/manual/en/function.class-uses.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.class-parents.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.class-parents.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.class-parents.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.class-parents.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.class-parents.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.class-parents.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.class-parents.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.class-parents.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.class-parents.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.class-parents.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.class-parents.php" hreflang="zh">
...
<meta name="Description" content="Return the parent classes of the given class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: class_parents - Manual" />
<meta name="twitter:description" content="Return the parent classes of the given class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: class_parents - Manual" />
<meta itemprop="description" content="Return the parent classes of the given class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the parent classes of the given class" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.class-parents.php' selected="selected">English</option>
            <option value='de/function.class-parents.php'>German</option>
            <option value='es/function.class-parents.php'>Spanish</option>
            <option value='fr/function.class-parents.php'>French</option>
            <option value='it/function.class-parents.php'>Italian</option>
            <option value='ja/function.class-parents.php'>Japanese</option>
            <option value='pt_BR/function.class-parents.php'>Brazilian Portuguese</option>
            <option value='ru/function.class-parents.php'>Russian</option>
            <option value='tr/function.class-parents.php'>Turkish</option>
            <option value='uk/function.class-parents.php'>Ukrainian</option>
            <option value='zh/function.class-parents.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.class-parents" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.class-parents-description">
  ...
  <p class="para rdfs-comment">
   ...
   the given <code class="parameter">object_or_class</code>.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.class-parents-examples">
  ...
  <p class="para">
   <div class="example" id="example-4024">
    <p><strong>Example #1 <span class="function"><strong>class_parents()</strong></span> example</strong></p>
...
(
 ...
 <div class="refsect1 notes" id="refsect1-function.class-parents-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <span class="simpara">
    To check that an object extends a class, <a href="language.operators.type.php" class="link"><code class="literal">instanceof</code></a>
   ...
   <ul class="simplelist">
    ...
    <li><a href="language.operators.type.php" class="link"><code class="literal">instanceof</code></a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/functions/class-parents.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.class-parents%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.class-parents&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.class-parents.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110223">  <div class="votes">
    <div id="Vu110223">
    <a href="/manual/vote-note.php?id=110223&amp;page=function.class-parents&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110223">
    <a href="/manual/vote-note.php?id=110223&amp;page=function.class-parents&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110223" title="85% like this...">
    35
    </div>
  </div>
  <a href="#110223" class="name">
  <strong class="user"><em>sergei dot solomonov at gmail dot com</em></strong></a><a class="genanchor" href="#110223"> &para;</a><div class="date" title="2012-10-02 02:57"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110223">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /></span><span class="keyword">class </span><span class="default">foo </span><span class="keyword">{}<br />class </span><span class="default">bar </span><span class="keyword">extends </span><span class="default">foo </span><span class="keyword">{}<br />class </span><span class="default">baz </span><span class="keyword">extends </span><span class="default">bar </span><span class="keyword">{}<br /><br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">class_parents</span><span class="keyword">(new </span><span class="default">baz</span><span class="keyword">));<br /></span><span class="default">?&gt;<br /></span><br />Will output:<br />Array<br />(<br />    [bar] =&gt; bar<br />    [foo] =&gt; foo<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.class-parents&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.class-parents.php">＋<small>add a note</small></a></div>
