...
<head>
  ...
  <title>PHP: SolrQuery::setRows - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setrows.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setrows.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setrows.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setquery.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setshowdebuginfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setrows.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setrows.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setrows.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setrows.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setrows.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setrows.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setrows.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setrows.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setrows.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setrows.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setrows.php" hreflang="zh">
...
<meta name="Description" content="Specifies the maximum number of rows to return in the result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setRows - Manual" />
<meta name="twitter:description" content="Specifies the maximum number of rows to return in the result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setRows - Manual" />
<meta itemprop="description" content="Specifies the maximum number of rows to return in the result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the maximum number of rows to return in the result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setshowdebuginfo.php">
          SolrQuery::setShowDebugInfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setquery.php">
          &laquo; SolrQuery::setQuery        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setrows.php' selected="selected">English</option>
            <option value='de/solrquery.setrows.php'>German</option>
            <option value='es/solrquery.setrows.php'>Spanish</option>
            <option value='fr/solrquery.setrows.php'>French</option>
            <option value='it/solrquery.setrows.php'>Italian</option>
            <option value='ja/solrquery.setrows.php'>Japanese</option>
            <option value='pt_BR/solrquery.setrows.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setrows.php'>Russian</option>
            <option value='tr/solrquery.setrows.php'>Turkish</option>
            <option value='uk/solrquery.setrows.php'>Ukrainian</option>
            <option value='zh/solrquery.setrows.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setrows" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setRows</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setRows</span> &mdash; <span class="dc-title">Specifies the maximum number of rows to return in the result</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setrows-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setRows</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rows</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setrows-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setrows-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setrows.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setrows%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setrows&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setrows.php">＋<small>add a note</small></a></span>
