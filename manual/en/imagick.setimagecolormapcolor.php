...
<head>
  ...
  <title>PHP: Imagick::setImageColormapColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagecolormapcolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagecolormapcolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagecolormapcolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageclipmask.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagecolorspace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagecolormapcolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagecolormapcolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagecolormapcolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagecolormapcolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagecolormapcolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagecolormapcolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagecolormapcolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagecolormapcolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagecolormapcolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagecolormapcolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagecolormapcolor.php" hreflang="zh">
...
<meta name="Description" content="Sets the color of the specified colormap index" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageColormapColor - Manual" />
<meta name="twitter:description" content="Sets the color of the specified colormap index" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageColormapColor - Manual" />
<meta itemprop="description" content="Sets the color of the specified colormap index" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the color of the specified colormap index" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimagecolorspace.php">
          Imagick::setImageColorspace &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageclipmask.php">
          &laquo; Imagick::setImageClipMask        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagecolormapcolor.php' selected="selected">English</option>
            <option value='de/imagick.setimagecolormapcolor.php'>German</option>
            <option value='es/imagick.setimagecolormapcolor.php'>Spanish</option>
            <option value='fr/imagick.setimagecolormapcolor.php'>French</option>
            <option value='it/imagick.setimagecolormapcolor.php'>Italian</option>
            <option value='ja/imagick.setimagecolormapcolor.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagecolormapcolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagecolormapcolor.php'>Russian</option>
            <option value='tr/imagick.setimagecolormapcolor.php'>Turkish</option>
            <option value='uk/imagick.setimagecolormapcolor.php'>Ukrainian</option>
            <option value='zh/imagick.setimagecolormapcolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagecolormapcolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageColormapColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageColormapColor</span> &mdash; <span class="dc-title">Sets the color of the specified colormap index</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagecolormapcolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageColormapColor</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>, <span class="methodparam"><span class="type"><a href="class.imagickpixel.php" class="type ImagickPixel">ImagickPixel</a></span> <code class="parameter">$color</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagecolormapcolor-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagecolormapcolor-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagecolormapcolor-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagecolormapcolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagecolormapcolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagecolormapcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagecolormapcolor.php">＋<small>add a note</small></a></span>
