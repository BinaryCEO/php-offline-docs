...
<head>
  ...
  <title>PHP: Changed functions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration71.changed-functions.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration71.changed-functions.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration71.changed-functions.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration71.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration71.deprecated.php">
 <link rel="next" href="https://www.php.net/manual/en/migration71.other-changes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration71.changed-functions.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration71.changed-functions.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration71.changed-functions.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration71.changed-functions.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration71.changed-functions.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration71.changed-functions.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration71.changed-functions.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration71.changed-functions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration71.changed-functions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration71.changed-functions.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration71.changed-functions.php" hreflang="zh">
...
<meta name="Description" content="Changed functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Changed functions - Manual" />
<meta name="twitter:description" content="Changed functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Changed functions - Manual" />
<meta itemprop="description" content="Changed functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Changed functions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="migration71.deprecated.php">
          &laquo; Deprecated features in PHP 7.1.x        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration71.changed-functions.php' selected="selected">English</option>
            <option value='de/migration71.changed-functions.php'>German</option>
            <option value='es/migration71.changed-functions.php'>Spanish</option>
            <option value='fr/migration71.changed-functions.php'>French</option>
            <option value='it/migration71.changed-functions.php'>Italian</option>
            <option value='ja/migration71.changed-functions.php'>Japanese</option>
            <option value='pt_BR/migration71.changed-functions.php'>Brazilian Portuguese</option>
            <option value='ru/migration71.changed-functions.php'>Russian</option>
            <option value='tr/migration71.changed-functions.php'>Turkish</option>
            <option value='uk/migration71.changed-functions.php'>Ukrainian</option>
            <option value='zh/migration71.changed-functions.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration71.changed-functions" class="sect1">
    ...
    <span class="simpara">
     ...
     session.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration71/changed-functions.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration71.changed-functions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration71.changed-functions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration71.changed-functions.php">＋<small>add a note</small></a></span>
