...
<head>
  ...
  <title>PHP: XSLTProcessor::registerPHPFunctionNS - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/xsltprocessor.registerphpfunctionns.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/xsltprocessor.registerphpfunctionns.php">
 <link rel="alternate" href="https://www.php.net/manual/en/xsltprocessor.registerphpfunctionns.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.xsltprocessor.php">
 <link rel="prev" href="https://www.php.net/manual/en/xsltprocessor.importstylesheet.php">
 <link rel="next" href="https://www.php.net/manual/en/xsltprocessor.registerphpfunctions.php">

 <link rel="alternate" href="https://www.php.net/manual/en/xsltprocessor.registerphpfunctionns.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/xsltprocessor.registerphpfunctionns.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/xsltprocessor.registerphpfunctionns.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/xsltprocessor.registerphpfunctionns.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/xsltprocessor.registerphpfunctionns.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/xsltprocessor.registerphpfunctionns.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/xsltprocessor.registerphpfunctionns.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/xsltprocessor.registerphpfunctionns.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/xsltprocessor.registerphpfunctionns.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/xsltprocessor.registerphpfunctionns.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/xsltprocessor.registerphpfunctionns.php" hreflang="zh">
...
<meta name="Description" content="Register a PHP function as namespaced XSLT function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: XSLTProcessor::registerPHPFunctionNS - Manual" />
<meta name="twitter:description" content="Register a PHP function as namespaced XSLT function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: XSLTProcessor::registerPHPFunctionNS - Manual" />
<meta itemprop="description" content="Register a PHP function as namespaced XSLT function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Register a PHP function as namespaced XSLT function" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="xsltprocessor.registerphpfunctions.php">
          XSLTProcessor::registerPHPFunctions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="xsltprocessor.importstylesheet.php">
          &laquo; XSLTProcessor::importStylesheet        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/xsltprocessor.registerphpfunctionns.php' selected="selected">English</option>
            <option value='de/xsltprocessor.registerphpfunctionns.php'>German</option>
            <option value='es/xsltprocessor.registerphpfunctionns.php'>Spanish</option>
            <option value='fr/xsltprocessor.registerphpfunctionns.php'>French</option>
            <option value='it/xsltprocessor.registerphpfunctionns.php'>Italian</option>
            <option value='ja/xsltprocessor.registerphpfunctionns.php'>Japanese</option>
            <option value='pt_BR/xsltprocessor.registerphpfunctionns.php'>Brazilian Portuguese</option>
            <option value='ru/xsltprocessor.registerphpfunctionns.php'>Russian</option>
            <option value='tr/xsltprocessor.registerphpfunctionns.php'>Turkish</option>
            <option value='uk/xsltprocessor.registerphpfunctionns.php'>Ukrainian</option>
            <option value='zh/xsltprocessor.registerphpfunctionns.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="xsltprocessor.registerphpfunctionns" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-xsltprocessor.registerphpfunctionns-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>XSLTProcessor::registerPHPFunctionNS</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$namespaceURI</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callable</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$xml </span><span style="color: #007700">= &lt;&lt;&lt;EOB<br /></span><span style="color: #DD0000">&lt;allusers&gt;<br />&lt;user&gt;<br /> &lt;uid&gt;bob&lt;/uid&gt;<br />&lt;/user&gt;<br />&lt;user&gt;<br /> &lt;uid&gt;joe&lt;/uid&gt;<br />&lt;/user&gt;<br />&lt;/allusers&gt;<br /></span><span style="color: #007700">EOB;<br /></span><span style="color: #0000BB">$xsl </span><span style="color: #007700">= &lt;&lt;&lt;EOB<br /></span><span style="color: #DD0000">&lt;?xml version="1.0" encoding="UTF-8"?&gt;<br />&lt;xsl:stylesheet version="1.0"<br />    xmlns:xsl="http://www.w3.org/1999/XSL/Transform"<br />    xmlns:my="urn:my.ns"&gt;<br />&lt;xsl:output method="html" encoding="utf-8" indent="yes"/&gt;<br />&lt;xsl:template match="allusers"&gt;<br /> &lt;html&gt;&lt;body&gt;<br />   &lt;h2&gt;&lt;xsl:value-of select="my:count(user/uid)" /&gt; users&lt;/h2&gt;<br />   &lt;table&gt;<br />   &lt;xsl:for-each select="user"&gt;<br />     &lt;tr&gt;<br />      &lt;td&gt;<br />       &lt;xsl:value-of select="my:uppercase(string(uid))"/&gt;<br />      &lt;/td&gt;<br />     &lt;/tr&gt;<br />   &lt;/xsl:for-each&gt;<br />   &lt;/table&gt;<br /> &lt;/body&gt;&lt;/html&gt;<br />&lt;/xsl:template&gt;<br />&lt;/xsl:stylesheet&gt;<br /></span><span style="color: #007700">EOB;<br /></span><span style="color: #0000BB">$xmldoc </span><span style="color: #007700">= new </span><span style="color: #0000BB">DOMDocument</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$xmldoc</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">loadXML</span><span style="color: #007700">(</span><span style="color: #0000BB">$xml</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$xsldoc </span><span style="color: #007700">= new </span><span style="color: #0000BB">DOMDocument</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$xsldoc</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">loadXML</span><span style="color: #007700">(</span><span style="color: #0000BB">$xsl</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$proc </span><span style="color: #007700">= new </span><span style="color: #0000BB">XSLTProcessor</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$proc</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerPHPFunctionNS</span><span style="color: #007700">(</span><span style="color: #DD0000">'urn:my.ns'</span><span style="color: #007700">, </span><span style="color: #DD0000">'uppercase'</span><span style="color: #007700">, </span><span style="color: #0000BB">strtoupper</span><span style="color: #007700">(...));<br /></span><span style="color: #0000BB">$proc</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerPHPFunctionNS</span><span style="color: #007700">(</span><span style="color: #DD0000">'urn:my.ns'</span><span style="color: #007700">, </span><span style="color: #DD0000">'count'</span><span style="color: #007700">, fn (array </span><span style="color: #0000BB">$arg1</span><span style="color: #007700">) =&gt; </span><span style="color: #0000BB">count</span><span style="color: #007700">(</span><span style="color: #0000BB">$arg1</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">$proc</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">importStyleSheet</span><span style="color: #007700">(</span><span style="color: #0000BB">$xsldoc</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$proc</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">transformToXML</span><span style="color: #007700">(</span><span style="color: #0000BB">$xmldoc</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-xsltprocessor.registerphpfunctionns-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="domxpath.registerphpfunctionns.php" class="methodname" rel="rdfs-seeAlso">DOMXPath::registerPhpFunctionNS()</a> - Register a PHP functions as namespaced XPath function</span></li>
   ...
   <li><span class="methodname"><a href="xsltprocessor.registerphpfunctions.php" class="methodname" rel="rdfs-seeAlso">XSLTProcessor::registerPhpFunctions()</a> - Enables the ability to use PHP functions as XSLT functions</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xsl/xsltprocessor/registerphpfunctionns.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fxsltprocessor.registerphpfunctionns%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=xsltprocessor.registerphpfunctionns&amp;repo=en&amp;redirect=https://www.php.net/manual/en/xsltprocessor.registerphpfunctionns.php">＋<small>add a note</small></a></span>
