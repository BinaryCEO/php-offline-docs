...
<head>
  ...
  <title>PHP: enchant_dict_get_error - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.enchant-dict-get-error.php">
 <link rel="shorturl" href="https://www.php.net/enchant-dict-get-error">
 <link rel="alternate" href="https://www.php.net/enchant-dict-get-error" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.enchant.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.enchant-dict-describe.php">
 <link rel="next" href="https://www.php.net/manual/en/function.enchant-dict-is-added.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.enchant-dict-get-error.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.enchant-dict-get-error.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.enchant-dict-get-error.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.enchant-dict-get-error.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.enchant-dict-get-error.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.enchant-dict-get-error.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.enchant-dict-get-error.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.enchant-dict-get-error.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.enchant-dict-get-error.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.enchant-dict-get-error.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.enchant-dict-get-error.php" hreflang="zh">
...
<meta name="Description" content="Returns the last error of the current spelling-session" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: enchant_dict_get_error - Manual" />
<meta name="twitter:description" content="Returns the last error of the current spelling-session" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: enchant_dict_get_error - Manual" />
<meta itemprop="description" content="Returns the last error of the current spelling-session" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the last error of the current spelling-session" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.enchant-dict-is-added.php">
          enchant_dict_is_added &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.enchant-dict-describe.php">
          &laquo; enchant_dict_describe        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.enchant-dict-get-error.php' selected="selected">English</option>
            <option value='de/function.enchant-dict-get-error.php'>German</option>
            <option value='es/function.enchant-dict-get-error.php'>Spanish</option>
            <option value='fr/function.enchant-dict-get-error.php'>French</option>
            <option value='it/function.enchant-dict-get-error.php'>Italian</option>
            <option value='ja/function.enchant-dict-get-error.php'>Japanese</option>
            <option value='pt_BR/function.enchant-dict-get-error.php'>Brazilian Portuguese</option>
            <option value='ru/function.enchant-dict-get-error.php'>Russian</option>
            <option value='tr/function.enchant-dict-get-error.php'>Turkish</option>
            <option value='uk/function.enchant-dict-get-error.php'>Ukrainian</option>
            <option value='zh/function.enchant-dict-get-error.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.enchant-dict-get-error" class="refentry">
 ...
 <td>
  ...
  previoulsy, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/enchant/functions/enchant-dict-get-error.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.enchant-dict-get-error%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.enchant-dict-get-error&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.enchant-dict-get-error.php">＋<small>add a note</small></a></span>
