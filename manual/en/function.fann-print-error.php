...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-print-error.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-num-output-train-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-randomize-weights.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-print-error.php' selected="selected">English</option>
            <option value='de/function.fann-print-error.php'>German</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-get-errstr.php" class="function" rel="rdfs-seeAlso">fann_get_errstr()</a> - Returns the last errstr</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-print-error.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-print-error%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-print-error&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-print-error.php">＋<small>add a note</small></a></span>
