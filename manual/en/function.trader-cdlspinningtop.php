...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-cdlspinningtop.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-cdlshortline.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-cdlstalledpattern.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-cdlspinningtop.php' selected="selected">English</option>
            <option value='de/function.trader-cdlspinningtop.php'>German</option>
            <option value='es/function.trader-cdlspinningtop.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_cdlspinningtop</span> &mdash; <span class="dc-title">Spinning Top</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-cdlspinningtop-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-cdlspinningtop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-cdlspinningtop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-cdlspinningtop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-cdlspinningtop.php">＋<small>add a note</small></a></span>
