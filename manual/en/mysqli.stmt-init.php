...
<head>
  ...
  <title>PHP: mysqli::stmt_init - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.stmt-init.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.stmt-init.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.stmt-init.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.stat.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.store-result.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.stmt-init.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.stmt-init.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.stmt-init.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.stmt-init.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.stmt-init.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.stmt-init.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.stmt-init.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.stmt-init.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.stmt-init.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.stmt-init.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.stmt-init.php" hreflang="zh">
...
<meta name="Description" content="Initializes a statement and returns an object for use with mysqli_stmt_prepare" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::stmt_init - Manual" />
<meta name="twitter:description" content="Initializes a statement and returns an object for use with mysqli_stmt_prepare" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::stmt_init - Manual" />
<meta itemprop="description" content="Initializes a statement and returns an object for use with mysqli_stmt_prepare" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Initializes a statement and returns an object for use with mysqli_stmt_prepare" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli.store-result.php">
          mysqli::store_result &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.stmt-init.php' selected="selected">English</option>
            <option value='de/mysqli.stmt-init.php'>German</option>
            <option value='es/mysqli.stmt-init.php'>Spanish</option>
            <option value='fr/mysqli.stmt-init.php'>French</option>
            <option value='it/mysqli.stmt-init.php'>Italian</option>
            <option value='ja/mysqli.stmt-init.php'>Japanese</option>
            <option value='pt_BR/mysqli.stmt-init.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.stmt-init.php'>Russian</option>
            <option value='tr/mysqli.stmt-init.php'>Turkish</option>
            <option value='uk/mysqli.stmt-init.php'>Ukrainian</option>
            <option value='zh/mysqli.stmt-init.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.stmt-init" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli-stmt.prepare.php" class="function" rel="rdfs-seeAlso">mysqli_stmt_prepare()</a> - Prepares an SQL statement for execution</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/stmt-init.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.stmt-init%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.stmt-init&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.stmt-init.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119819">  <div class="votes">
    <div id="Vu119819">
    <a href="/manual/vote-note.php?id=119819&amp;page=mysqli.stmt-init&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119819">
    <a href="/manual/vote-note.php?id=119819&amp;page=mysqli.stmt-init&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119819" title="76% like this...">
    18
    </div>
  </div>
  <a href="#119819" class="name">
  <strong class="user"><em>Jeff C</em></strong></a><a class="genanchor" href="#119819"> &para;</a><div class="date" title="2016-08-31 09:32"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119819">
<div class="phpcode"><code><span class="html">stmt_init() seems to clear previous (possibly erroneous) results on the DB connection, which means you don't necessarily need to use it but it could make the code more robust.<br /><br />In a PHPUnit test, I had a sequence of prepared queries on the same connection. One of them fetched a row from a SELECT but didn't keep fetching until it drained the connection, so it left some stale results. When the next query did this:<br /><br /><span class="default">&lt;?php<br />$db </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">getConnection</span><span class="keyword">()-&gt;</span><span class="default">getDbConnection</span><span class="keyword">();<br /></span><span class="default">$preparedQuery </span><span class="keyword">= </span><span class="default">$db</span><span class="keyword">-&gt;</span><span class="default">prepare </span><span class="keyword">(</span><span class="default">$query</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />the prepare() call generated an error: "Could not prepare query: Commands out of sync; you can't run this command now." Changing to this:<br /><br /><span class="default">&lt;?php<br />$db </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">getConnection</span><span class="keyword">()-&gt;</span><span class="default">getDbConnection</span><span class="keyword">();<br /></span><span class="default">$preparedQuery </span><span class="keyword">= </span><span class="default">$db</span><span class="keyword">-&gt;</span><span class="default">stmt_init</span><span class="keyword">();<br /></span><span class="default">$preparedQuery</span><span class="keyword">-&gt;</span><span class="default">prepare </span><span class="keyword">(</span><span class="default">$query</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />resolved the problem.</span></code></div>
  </div>
 </div>
  <div class="note" id="115171">  <div class="votes">
    <div id="Vu115171">
    <a href="/manual/vote-note.php?id=115171&amp;page=mysqli.stmt-init&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115171">
    <a href="/manual/vote-note.php?id=115171&amp;page=mysqli.stmt-init&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115171" title="52% like this...">
    5
    </div>
  </div>
  <a href="#115171" class="name">
  <strong class="user"><em>mamdo7 at hotmail dot com</em></strong></a><a class="genanchor" href="#115171"> &para;</a><div class="date" title="2014-06-07 11:58"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115171">
<div class="phpcode"><code><span class="html">you can use $stmt = $mysqli-&gt;prepare(); directly without stmt-init() . i think there is no need for stmt-init .</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli.stmt-init&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.stmt-init.php">＋<small>add a note</small></a></div>
