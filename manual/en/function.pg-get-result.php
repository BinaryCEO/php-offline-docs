...
<head>
  ...
  <title>PHP: pg_get_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-get-result.php">
 <link rel="shorturl" href="https://www.php.net/pg-get-result">
 <link rel="alternate" href="https://www.php.net/pg-get-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-get-pid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-host.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-get-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-get-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-get-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-get-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-get-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-get-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-get-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-get-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-get-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-get-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-get-result.php" hreflang="zh">
...
<meta name="Description" content="Get asynchronous query result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_get_result - Manual" />
<meta name="twitter:description" content="Get asynchronous query result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_get_result - Manual" />
<meta itemprop="description" content="Get asynchronous query result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get asynchronous query result" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-host.php">
          pg_host &raquo;
              ...
              <div class="prev">
        <a href="function.pg-get-pid.php">
          &laquo; pg_get_pid        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-get-result.php' selected="selected">English</option>
            <option value='de/function.pg-get-result.php'>German</option>
            <option value='es/function.pg-get-result.php'>Spanish</option>
            <option value='fr/function.pg-get-result.php'>French</option>
            <option value='it/function.pg-get-result.php'>Italian</option>
            <option value='ja/function.pg-get-result.php'>Japanese</option>
            <option value='pt_BR/function.pg-get-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-get-result.php'>Russian</option>
            <option value='tr/function.pg-get-result.php'>Turkish</option>
            <option value='uk/function.pg-get-result.php'>Ukrainian</option>
            <option value='zh/function.pg-get-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-get-result" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-send-query.php" class="function" rel="rdfs-seeAlso">pg_send_query()</a> - Sends asynchronous query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-get-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-get-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-get-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-get-result.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="49439">  <div class="votes">
    <div id="Vu49439">
    <a href="/manual/vote-note.php?id=49439&amp;page=function.pg-get-result&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd49439">
    <a href="/manual/vote-note.php?id=49439&amp;page=function.pg-get-result&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V49439" title="81% like this...">
    7
    </div>
  </div>
  <a href="#49439" class="name">
  <strong class="user"><em>william at 25thandClement dot com</em></strong></a><a class="genanchor" href="#49439"> &para;</a><div class="date" title="2005-01-27 03:03"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom49439">
<div class="phpcode"><code><span class="html">There is no way to poll/wait for a notification to come in. You either have to enter a busy loop or sleep. Both options are horrible. It would be nice for PHP to provide access to PQsocket so one could select() on the socket connection. This is how it's done from C or Perl.</span></code></div>
  </div>
 </div>
  <div class="note" id="117984">  <div class="votes">
    <div id="Vu117984">
    <a href="/manual/vote-note.php?id=117984&amp;page=function.pg-get-result&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117984">
    <a href="/manual/vote-note.php?id=117984&amp;page=function.pg-get-result&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117984" title="no votes...">
    0
    </div>
  </div>
  <a href="#117984" class="name">
  <strong class="user"><em>Ondej Bouda</em></strong></a><a class="genanchor" href="#117984"> &para;</a><div class="date" title="2015-09-14 10:04"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117984">
<div class="phpcode"><code><span class="html">It might seem that after calling pg_get_result() upon sending just a single query, the connection will not be busy. The correct way is, though, to call extra pg_get_result() in a loop until it returns false [1].<br /><br /><span class="default">&lt;?php<br />$conn </span><span class="keyword">= </span><span class="default">pg_connect</span><span class="keyword">(</span><span class="string">'...'</span><span class="keyword">, </span><span class="default">PGSQL_CONNECT_FORCE_NEW</span><span class="keyword">);<br />for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">10000</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++) {<br />    </span><span class="default">$query </span><span class="keyword">= </span><span class="string">'erroneous query'</span><span class="keyword">;<br />    if (</span><span class="default">pg_connection_busy</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">)) {<br />        </span><span class="default">fprintf</span><span class="keyword">(</span><span class="default">STDERR</span><span class="keyword">, </span><span class="string">"Connection is busy\n"</span><span class="keyword">);<br />        exit(</span><span class="default">1</span><span class="keyword">);<br />    }<br />    </span><span class="default">pg_send_query</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="default">$query</span><span class="keyword">);<br />    </span><span class="default">$res </span><span class="keyword">= </span><span class="default">pg_get_result</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">);<br />    if (</span><span class="default">$res </span><span class="keyword">=== </span><span class="default">false</span><span class="keyword">) {<br />        </span><span class="default">fprintf</span><span class="keyword">(</span><span class="default">STDERR</span><span class="keyword">, </span><span class="string">"A result was expected\n"</span><span class="keyword">);<br />        exit(</span><span class="default">1</span><span class="keyword">);<br />    }<br /><br />    </span><span class="comment">/* The following does not seem necessary for good queries, but is vital for erroneous queries.<br />       Commenting the loop out leads to this script fail with the "Connection is busy" error. */<br />    </span><span class="keyword">while (</span><span class="default">pg_get_result</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">));<br /><br />    </span><span class="comment">// result processing...<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;<br /></span><br />See <a href="http://www.postgresql.org/message-id/flat/gtitqq$26l3$1@news.hub.org#gtitqq$26l3$1@news.hub.org" rel="nofollow" target="_blank">http://www.postgresql.org/message-id/flat/gtitqq$26l3$1@news.hub.org#gtitqq$26l3$1@news.hub.org</a> and <a href="https://bugs.php.net/bug.php?id=52750" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=52750</a> for detailed information.<br /><br />[1] Or, even better, use an asynchronous connection since PHP 5.6.</span></code></div>
  </div>
 </div>
  <div class="note" id="113437">  <div class="votes">
    <div id="Vu113437">
    <a href="/manual/vote-note.php?id=113437&amp;page=function.pg-get-result&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113437">
    <a href="/manual/vote-note.php?id=113437&amp;page=function.pg-get-result&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113437" title="50% like this...">
    0
    </div>
  </div>
  <a href="#113437" class="name">
  <strong class="user"><em>gullevek at gullevek dot org</em></strong></a><a class="genanchor" href="#113437"> &para;</a><div class="date" title="2013-10-10 06:28"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113437">
<div class="phpcode"><code><span class="html">To have a a simple wait output with async queries you can use the pg_connection_busy command:<br /><br /><span class="default">&lt;?php<br />$dbh </span><span class="keyword">= </span><span class="default">pg_connect</span><span class="keyword">(</span><span class="string">"host=XXX user=XXX password=XXX dbname=XXX"</span><span class="keyword">);<br />if (!</span><span class="default">$dbh</span><span class="keyword">)<br />{<br />    print </span><span class="string">"Failed to connect"</span><span class="keyword">;<br />    exit;<br />}<br /><br /></span><span class="default">$query </span><span class="keyword">= </span><span class="string">"SELECT pg_sleep(10)"</span><span class="keyword">;<br />if (!</span><span class="default">pg_connection_busy</span><span class="keyword">(</span><span class="default">$dbh</span><span class="keyword">))<br />{<br />    </span><span class="default">$sent </span><span class="keyword">= </span><span class="default">pg_send_query</span><span class="keyword">(</span><span class="default">$dbh</span><span class="keyword">, </span><span class="default">$query</span><span class="keyword">);<br />    print </span><span class="string">"Sent query, waiting: "</span><span class="keyword">;<br />    while (</span><span class="default">pg_connection_busy</span><span class="keyword">(</span><span class="default">$dbh</span><span class="keyword">)<br />    {<br />        print </span><span class="string">"."</span><span class="keyword">;<br />        </span><span class="default">flush</span><span class="keyword">();<br />    }<br />    </span><span class="default">$res </span><span class="keyword">= </span><span class="default">pg_get_result</span><span class="keyword">(</span><span class="default">$dbh</span><span class="keyword">);<br />    print </span><span class="string">"&lt;br&gt;"</span><span class="keyword">; </span><span class="comment">// or \n<br />    </span><span class="keyword">print </span><span class="string">"Result is: </span><span class="default">$res</span><span class="string">"</span><span class="keyword">;<br />}<br /><br /></span><span class="default">pg_close</span><span class="keyword">(</span><span class="default">$dbh</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="86610">  <div class="votes">
    <div id="Vu86610">
    <a href="/manual/vote-note.php?id=86610&amp;page=function.pg-get-result&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd86610">
    <a href="/manual/vote-note.php?id=86610&amp;page=function.pg-get-result&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V86610" title="30% like this...">
    -4
    </div>
  </div>
  <a href="#86610" class="name">
  <strong class="user"><em>Marko Tiikkaja</em></strong></a><a class="genanchor" href="#86610"> &para;</a><div class="date" title="2008-10-25 05:14"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86610">
<div class="phpcode"><code><span class="html">william at 25thandClement dot com said: "There is no way to poll/wait for a notification to come in. .."<br />Yes, there is. If there is a query in progress, pg_get_result() will block and return the result of that query when it's complete.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-get-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-get-result.php">＋<small>add a note</small></a></div>
