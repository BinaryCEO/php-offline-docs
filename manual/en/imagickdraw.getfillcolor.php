...
<head>
  ...
  <title>PHP: ImagickDraw::getFillColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getfillcolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getfillcolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfillcolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getclipunits.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getfillopacity.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfillcolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getfillcolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getfillcolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getfillcolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getfillcolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getfillcolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getfillcolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getfillcolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getfillcolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getfillcolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getfillcolor.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::getFillColor - Manual" />
<meta name="twitter:description" content="Returns the fill color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getFillColor - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.getfillopacity.php">
          ImagickDraw::getFillOpacity &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getclipunits.php">
          &laquo; ImagickDraw::getClipUnits        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getfillcolor.php' selected="selected">English</option>
            <option value='de/imagickdraw.getfillcolor.php'>German</option>
            <option value='es/imagickdraw.getfillcolor.php'>Spanish</option>
            <option value='fr/imagickdraw.getfillcolor.php'>French</option>
            <option value='it/imagickdraw.getfillcolor.php'>Italian</option>
            <option value='ja/imagickdraw.getfillcolor.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getfillcolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getfillcolor.php'>Russian</option>
            <option value='tr/imagickdraw.getfillcolor.php'>Turkish</option>
            <option value='uk/imagickdraw.getfillcolor.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getfillcolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getfillcolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getFillColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getFillColor</span> &mdash; <span class="dc-title">Returns the fill color</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getfillcolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getFillColor</strong></span>(): <span class="type"><a href="class.imagickpixel.php" class="type ImagickPixel">ImagickPixel</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getfillcolor-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an <span class="classname"><a href="class.imagickpixel.php" class="classname">ImagickPixel</a></span> object.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getfillcolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getfillcolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getfillcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getfillcolor.php">＋<small>add a note</small></a></span>
