...
<head>
  ...
  <title>PHP: Gmagick::implodeimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.implodeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.implodeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.implodeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.haspreviousimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.labelimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.implodeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.implodeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.implodeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.implodeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.implodeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.implodeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.implodeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.implodeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.implodeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.implodeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.implodeimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::implodeimage - Manual" />
<meta name="twitter:description" content="Creates a new image as a copy" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::implodeimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.labelimage.php">
          Gmagick::labelimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.haspreviousimage.php">
          &laquo; Gmagick::haspreviousimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.implodeimage.php' selected="selected">English</option>
            <option value='de/gmagick.implodeimage.php'>German</option>
            <option value='es/gmagick.implodeimage.php'>Spanish</option>
            <option value='fr/gmagick.implodeimage.php'>French</option>
            <option value='it/gmagick.implodeimage.php'>Italian</option>
            <option value='ja/gmagick.implodeimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.implodeimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.implodeimage.php'>Russian</option>
            <option value='tr/gmagick.implodeimage.php'>Turkish</option>
            <option value='uk/gmagick.implodeimage.php'>Ukrainian</option>
            <option value='zh/gmagick.implodeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.implodeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::implodeimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::implodeimage</span> &mdash; <span class="dc-title">Creates a new image as a copy</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.implodeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::implodeimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.implodeimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.implodeimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns imploded <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.implodeimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/implodeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.implodeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.implodeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.implodeimage.php">＋<small>add a note</small></a></span>
