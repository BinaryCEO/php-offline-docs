...
<head>
  ...
  <title>PHP: pg_escape_identifier - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-escape-identifier.php">
 <link rel="shorturl" href="https://www.php.net/pg-escape-identifier">
 <link rel="alternate" href="https://www.php.net/pg-escape-identifier" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-escape-bytea.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-escape-literal.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-escape-identifier.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-escape-identifier.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-escape-identifier.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-escape-identifier.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-escape-identifier.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-escape-identifier.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-escape-identifier.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-escape-identifier.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-escape-identifier.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-escape-identifier.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-escape-identifier.php" hreflang="zh">
...
<meta name="Description" content="Escape a identifier for insertion into a text field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_escape_identifier - Manual" />
<meta name="twitter:description" content="Escape a identifier for insertion into a text field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_escape_identifier - Manual" />
<meta itemprop="description" content="Escape a identifier for insertion into a text field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Escape a identifier for insertion into a text field" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-escape-literal.php">
          pg_escape_literal &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-escape-bytea.php">
          &laquo; pg_escape_bytea        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-escape-identifier.php' selected="selected">English</option>
            <option value='de/function.pg-escape-identifier.php'>German</option>
            <option value='es/function.pg-escape-identifier.php'>Spanish</option>
            <option value='fr/function.pg-escape-identifier.php'>French</option>
            <option value='it/function.pg-escape-identifier.php'>Italian</option>
            <option value='ja/function.pg-escape-identifier.php'>Japanese</option>
            <option value='pt_BR/function.pg-escape-identifier.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-escape-identifier.php'>Russian</option>
            <option value='tr/function.pg-escape-identifier.php'>Turkish</option>
            <option value='uk/function.pg-escape-identifier.php'>Ukrainian</option>
            <option value='zh/function.pg-escape-identifier.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-escape-identifier" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.pg-escape-identifier-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_escape_identifier</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code><span class="initializer"> = ?</span></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-escape-string.php" class="function" rel="rdfs-seeAlso">pg_escape_string()</a> - Escape a string for query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-escape-identifier.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-escape-identifier%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-escape-identifier&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-escape-identifier.php">＋<small>add a note</small></a></span>
