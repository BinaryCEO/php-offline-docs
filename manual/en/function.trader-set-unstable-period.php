...
<head>
  ...
  <title>PHP: trader_set_unstable_period - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-set-unstable-period.php">
 <link rel="shorturl" href="https://www.php.net/trader-set-unstable-period">
 <link rel="alternate" href="https://www.php.net/trader-set-unstable-period" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-set-compat.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-sin.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-set-unstable-period.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-set-unstable-period.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-set-unstable-period.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-set-unstable-period.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-set-unstable-period.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-set-unstable-period.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-set-unstable-period.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-set-unstable-period.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-set-unstable-period.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-set-unstable-period.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-set-unstable-period.php" hreflang="zh">
...
<meta name="Description" content="Set unstable period" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_set_unstable_period - Manual" />
<meta name="twitter:description" content="Set unstable period" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_set_unstable_period - Manual" />
<meta itemprop="description" content="Set unstable period" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set unstable period" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-sin.php">
          trader_sin &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-set-compat.php">
          &laquo; trader_set_compat        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-set-unstable-period.php' selected="selected">English</option>
            <option value='de/function.trader-set-unstable-period.php'>German</option>
            <option value='es/function.trader-set-unstable-period.php'>Spanish</option>
            <option value='fr/function.trader-set-unstable-period.php'>French</option>
            <option value='it/function.trader-set-unstable-period.php'>Italian</option>
            <option value='ja/function.trader-set-unstable-period.php'>Japanese</option>
            <option value='pt_BR/function.trader-set-unstable-period.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-set-unstable-period.php'>Russian</option>
            <option value='tr/function.trader-set-unstable-period.php'>Turkish</option>
            <option value='uk/function.trader-set-unstable-period.php'>Ukrainian</option>
            <option value='zh/function.trader-set-unstable-period.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-set-unstable-period" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.trader-set-unstable-period-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_set_unstable_period</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$functionId</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>

  <p class="para rdfs-comment">
   Influences unstable period factor for functions, which are sensible to it. More information about unstable periods can be found on the <a href="https://ta-lib.org/api/?h=unstable#Unstable+Period" class="link external">&raquo;&nbsp;TA-Lib</a> API documentation page. 
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-set-unstable-period-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      Function ID the factor should be set for. <a href="trader.constants.php" class="link">TRADER_FUNC_UNST_*</a> constant series can be used to affect the corresponding function. 
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-set-unstable-period-returnvalues">
  ...
  <p class="para">No value is returned.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-set-unstable-period.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-set-unstable-period%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-set-unstable-period&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-set-unstable-period.php">＋<small>add a note</small></a></span>
