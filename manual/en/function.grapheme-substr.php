...
<head>
  ...
  <title>PHP: grapheme_substr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.grapheme-substr.php">
 <link rel="shorturl" href="https://www.php.net/grapheme-substr">
 <link rel="alternate" href="https://www.php.net/grapheme-substr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.intl.grapheme.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.grapheme-strstr.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.intl.idn.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.grapheme-substr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.grapheme-substr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.grapheme-substr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.grapheme-substr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.grapheme-substr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.grapheme-substr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.grapheme-substr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.grapheme-substr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.grapheme-substr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.grapheme-substr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.grapheme-substr.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: grapheme_substr - Manual" />
<meta name="twitter:description" content="Return part of a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: grapheme_substr - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.grapheme-substr.php' selected="selected">English</option>
            <option value='de/function.grapheme-substr.php'>German</option>
            <option value='es/function.grapheme-substr.php'>Spanish</option>
            <option value='fr/function.grapheme-substr.php'>French</option>
            <option value='it/function.grapheme-substr.php'>Italian</option>
            <option value='ja/function.grapheme-substr.php'>Japanese</option>
            <option value='pt_BR/function.grapheme-substr.php'>Brazilian Portuguese</option>
            <option value='ru/function.grapheme-substr.php'>Russian</option>
            <option value='tr/function.grapheme-substr.php'>Turkish</option>
            <option value='uk/function.grapheme-substr.php'>Ukrainian</option>
            <option value='zh/function.grapheme-substr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.grapheme-substr" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.grapheme-substr-returnvalues">
  ...
  <p class="para">
   Returns the extracted part of <code class="parameter">string</code>,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
    ...
    <li>
     <a href="http://unicode.org/reports/tr29/#Grapheme_Cluster_Boundaries" class="link external">&raquo;&nbsp;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/grapheme/grapheme-substr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.grapheme-substr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.grapheme-substr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.grapheme-substr.php">＋<small>add a note</small></a></span>
