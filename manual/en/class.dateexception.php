...
<head>
  ...
  <title>PHP: DateException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dateexception.php">
 <link rel="shorturl" href="https://www.php.net/dateexception">
 <link rel="alternate" href="https://www.php.net/dateexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.daterangeerror.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dateinvalidoperationexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dateexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dateexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dateexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dateexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dateexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dateexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dateexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dateexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dateexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dateexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dateexception.php" hreflang="zh">
...
<meta name="Description" content="The DateException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateException - Manual" />
<meta name="twitter:description" content="The DateException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateException - Manual" />
<meta itemprop="description" content="The DateException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DateException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.dateinvalidoperationexception.php">
          DateInvalidOperationException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.daterangeerror.php">
          &laquo; DateRangeError        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dateexception.php' selected="selected">English</option>
            <option value='de/class.dateexception.php'>German</option>
            <option value='es/class.dateexception.php'>Spanish</option>
            <option value='fr/class.dateexception.php'>French</option>
            <option value='it/class.dateexception.php'>Italian</option>
            <option value='ja/class.dateexception.php'>Japanese</option>
            <option value='pt_BR/class.dateexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.dateexception.php'>Russian</option>
            <option value='tr/class.dateexception.php'>Turkish</option>
            <option value='uk/class.dateexception.php'>Ukrainian</option>
            <option value='zh/class.dateexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dateexception" class="reference">
 <h1 class="title">The DateException class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.3.0)</p>


  <div class="section" id="dateexception.intro">
  ...
  <div class="section" id="dateexception.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">DateException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/dateexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dateexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dateexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dateexception.php">＋<small>add a note</small></a></span>
