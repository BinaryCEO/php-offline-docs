...
<div id="layout" class="clearfix">
 ...
 <div class="head">
  ...
  <strong class="user"><em>per at computer dot org</em></strong></a><a class="genanchor" href="#46718"> &para;</a><div class="date" title="2004-10-21 01:09"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom46718">
<div class="phpcode"><code><span class="html">mailparse_msg_extract_part_file() does not support file-wrappers as it needs to be able to use seek() on the file.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Be aware of "corporate mails" or users who do not understand character encoding too deeply (or do not care). You may (as we did) face mail where the whole mail body is encoded used i.e. Latin2 (and iso-8859-2 is given in multipart's charset header) but at the same time the body also contains text footer with UTF-8 characters in it... Yes, fu*g Microsoft Exchange V6.5 frontent will show that fine on the screen, but if when receive it:<br /><br />mailparse_msg_extract_part_file() - filter conversion failed. Input message is probably incorrectly encoded in ....<br /><br />so be extra careful and deal with all the possible errors to avoid mail loss.</span></code></div>
  </div>
 </div></div>
