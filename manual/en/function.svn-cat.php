...
<head>
  ...
  <title>PHP: svn_cat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-cat.php">
 <link rel="shorturl" href="https://www.php.net/svn-cat">
 <link rel="alternate" href="https://www.php.net/svn-cat" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-blame.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-checkout.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-cat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-cat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-cat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-cat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-cat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-cat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-cat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-cat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-cat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-cat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-cat.php" hreflang="zh">
...
<meta name="Description" content="Returns the contents of a file in a repository" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_cat - Manual" />
<meta name="twitter:description" content="Returns the contents of a file in a repository" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_cat - Manual" />
<meta itemprop="description" content="Returns the contents of a file in a repository" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the contents of a file in a repository" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.svn-checkout.php">
          svn_checkout &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-cat.php' selected="selected">English</option>
            <option value='de/function.svn-cat.php'>German</option>
            <option value='es/function.svn-cat.php'>Spanish</option>
            <option value='fr/function.svn-cat.php'>French</option>
            <option value='it/function.svn-cat.php'>Italian</option>
            <option value='ja/function.svn-cat.php'>Japanese</option>
            <option value='pt_BR/function.svn-cat.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-cat.php'>Russian</option>
            <option value='tr/function.svn-cat.php'>Turkish</option>
            <option value='uk/function.svn-cat.php'>Ukrainian</option>
            <option value='zh/function.svn-cat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-cat" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="http://svnbook.red-bean.com/en/1.2/svn.ref.svn.c.cat.html" class="link external">&raquo;&nbsp;SVN documentation on svn cat</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-cat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-cat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-cat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-cat.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="111777">  <div class="votes">
    <div id="Vu111777">
    <a href="/manual/vote-note.php?id=111777&amp;page=function.svn-cat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111777">
    <a href="/manual/vote-note.php?id=111777&amp;page=function.svn-cat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111777" title="100% like this...">
    1
    </div>
  </div>
  <a href="#111777" class="name">
  <strong class="user"><em>Adam</em></strong></a><a class="genanchor" href="#111777"> &para;</a><div class="date" title="2013-03-27 02:16"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111777">
<div class="phpcode"><code><span class="html">There is a difference how svn cat works for deleted files. For deleted file commandline `svn cat -r xxx &lt;full_url&gt;` will give error, but 'svn cat &lt;full_url&gt;@xxx` will cat file from the past.<br />Unfortunately this method will not cat deleted file.</span></code></div>
  </div>
 </div>
  <div class="note" id="114446">  <div class="votes">
    <div id="Vu114446">
    <a href="/manual/vote-note.php?id=114446&amp;page=function.svn-cat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114446">
    <a href="/manual/vote-note.php?id=114446&amp;page=function.svn-cat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114446" title="50% like this...">
    0
    </div>
  </div>
  <a href="#114446" class="name">
  <strong class="user"><em>colm</em></strong></a><a class="genanchor" href="#114446"> &para;</a><div class="date" title="2014-02-21 10:16"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114446">
<div class="phpcode"><code><span class="html">Just to add to Adam's comment, when retrieving a file contents I found I got the best results using the same revision in both places every time; ie. as follows:<br /><br /><span class="default">&lt;?php<br />svn_cat </span><span class="keyword">(</span><span class="default">$url</span><span class="keyword">.</span><span class="string">'@'</span><span class="keyword">.</span><span class="default">$revision</span><span class="keyword">, </span><span class="default">$revision</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />The one appended to the URL is the peg revision, and the one in the second paramer is the operative revision.<br /><br />This seems to cover all the bases.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.svn-cat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-cat.php">＋<small>add a note</small></a></div>
