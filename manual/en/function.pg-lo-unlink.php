...
<head>
  ...
  <title>PHP: pg_lo_unlink - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-lo-unlink.php">
 <link rel="shorturl" href="https://www.php.net/pg-lo-unlink">
 <link rel="alternate" href="https://www.php.net/pg-lo-unlink" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-lo-truncate.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-lo-write.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-lo-unlink.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-lo-unlink.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-lo-unlink.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-lo-unlink.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-lo-unlink.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-lo-unlink.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-lo-unlink.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-lo-unlink.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-lo-unlink.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-lo-unlink.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-lo-unlink.php" hreflang="zh">
...
<meta name="Description" content="Delete a large object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_lo_unlink - Manual" />
<meta name="twitter:description" content="Delete a large object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_lo_unlink - Manual" />
<meta itemprop="description" content="Delete a large object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete a large object" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-lo-unlink.php' selected="selected">English</option>
            <option value='de/function.pg-lo-unlink.php'>German</option>
            <option value='es/function.pg-lo-unlink.php'>Spanish</option>
            <option value='fr/function.pg-lo-unlink.php'>French</option>
            <option value='it/function.pg-lo-unlink.php'>Italian</option>
            <option value='ja/function.pg-lo-unlink.php'>Japanese</option>
            <option value='pt_BR/function.pg-lo-unlink.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-lo-unlink.php'>Russian</option>
            <option value='tr/function.pg-lo-unlink.php'>Turkish</option>
            <option value='uk/function.pg-lo-unlink.php'>Ukrainian</option>
            <option value='zh/function.pg-lo-unlink.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-lo-unlink" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_lo_unlink</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_lo_unlink</span> &mdash; <span class="dc-title">Delete a large object</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-lo-unlink-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>pg_lo_unlink()</strong></span> deletes a large object with the
   <code class="parameter">oid</code>. Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
  <p class="para">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    This function used to be called <span class="function"><strong>pg_lounlink()</strong></span>.
   </p>
  </p></blockquote>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-lo-unlink-examples">
  ...
  <p class="para">
   <div class="example" id="example-2091">
    <p><strong>Example #1 <span class="function"><strong>pg_lo_unlink()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-lo-import.php" class="function" rel="rdfs-seeAlso">pg_lo_import()</a> - Import a large object from file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-lo-unlink.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-lo-unlink%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-lo-unlink&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-unlink.php">＋<small>add a note</small></a></span>
