...
<head>
  ...
  <title>PHP: wincache_ucache_get - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-ucache-get.php">
 <link rel="shorturl" href="https://www.php.net/wincache-ucache-get">
 <link rel="alternate" href="https://www.php.net/wincache-ucache-get" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-ucache-exists.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-ucache-inc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-ucache-get.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-ucache-get.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-ucache-get.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-ucache-get.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-ucache-get.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-ucache-get.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-ucache-get.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-ucache-get.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-ucache-get.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-ucache-get.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-ucache-get.php" hreflang="zh">
...
<meta name="Description" content="Gets a variable stored in the user cache" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_ucache_get - Manual" />
<meta name="twitter:description" content="Gets a variable stored in the user cache" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_ucache_get - Manual" />
<meta itemprop="description" content="Gets a variable stored in the user cache" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets a variable stored in the user cache" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.wincache-ucache-inc.php">
          wincache_ucache_inc &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-ucache-exists.php">
          &laquo; wincache_ucache_exists        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-ucache-get.php' selected="selected">English</option>
            <option value='de/function.wincache-ucache-get.php'>German</option>
            <option value='es/function.wincache-ucache-get.php'>Spanish</option>
            <option value='fr/function.wincache-ucache-get.php'>French</option>
            <option value='it/function.wincache-ucache-get.php'>Italian</option>
            <option value='ja/function.wincache-ucache-get.php'>Japanese</option>
            <option value='pt_BR/function.wincache-ucache-get.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-ucache-get.php'>Russian</option>
            <option value='tr/function.wincache-ucache-get.php'>Turkish</option>
            <option value='uk/function.wincache-ucache-get.php'>Ukrainian</option>
            <option value='zh/function.wincache-ucache-get.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-ucache-get" class="refentry">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       in the <code class="parameter">key</code> array. If an object, or an array containing objects,
       is returned, then the objects will be unserialized. See
       <a href="language.oop5.magic.php#object.wakeup" class="link">__wakeup()</a> for details on unserializing objects.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.wincache-ucache-get-returnvalues">
  ...
  <p class="simpara">
   If <code class="parameter">key</code> is a string, the function returns the value of the variable stored with that key. 
   The <code class="parameter">success</code> is set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success and 
   to <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
  <p class="simpara">
   The <code class="parameter">key</code> is an array, the parameter <code class="parameter">success</code> 
   is always set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>. The returned array (name =&gt; value pairs) will 
 ...
 <div class="refsect1 examples" id="refsect1-function.wincache-ucache-get-examples">
  ...
  <p class="para">
   <div class="example" id="example-755">
    <p><strong>Example #1 <span class="function"><strong>wincache_ucache_get()</strong></span> with <code class="parameter">key</code> as a string</strong></p>
...
bool(true)</pre>
  ...
  <p class="para">
   <div class="example" id="example-756">
    <p><strong>Example #2 <span class="function"><strong>wincache_ucache_get()</strong></span> with <code class="parameter">key</code> as an array</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    ...
    <li><a href="language.oop5.magic.php#object.wakeup" class="link">__wakeup()</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-ucache-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-ucache-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-ucache-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-ucache-get.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96645">  <div class="votes">
    <div id="Vu96645">
    <a href="/manual/vote-note.php?id=96645&amp;page=function.wincache-ucache-get&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96645">
    <a href="/manual/vote-note.php?id=96645&amp;page=function.wincache-ucache-get&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96645" title="no votes...">
    0
    </div>
  </div>
  <a href="#96645" class="name">
  <strong class="user"><em>don dot raman at microsoft dot com</em></strong></a><a class="genanchor" href="#96645"> &para;</a><div class="date" title="2010-03-09 11:12"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96645">
<div class="phpcode"><code><span class="html">As per documentation PHP 5.2 doesn't support serialization of PHP internal classes. This means code below will not work:<br /><br /><span class="default">&lt;?php<br />$d </span><span class="keyword">= new </span><span class="default">DateTime</span><span class="keyword">();<br /></span><span class="default">$d</span><span class="keyword">-&gt;</span><span class="default">format</span><span class="keyword">(</span><span class="default">DateTime</span><span class="keyword">::</span><span class="default">W3C</span><span class="keyword">);<br /></span><span class="default">wincache_ucache_set</span><span class="keyword">( </span><span class="string">'q1'</span><span class="keyword">, </span><span class="default">$d </span><span class="keyword">);<br /></span><span class="default">var_dump</span><span class="keyword">( </span><span class="default">wincache_ucache_get</span><span class="keyword">( </span><span class="string">'q1' </span><span class="keyword">)-&gt;</span><span class="default">format</span><span class="keyword">(</span><span class="default">DATE_ATOM</span><span class="keyword">));<br /></span><span class="default">?&gt;<br /></span><br />The output of above code will be (as of PHP5.2.13):<br />[11-Feb-2010 08:35:29] PHP Warning:  DateTime::format() [&lt;a href='datetime.format'&gt;datetime.format&lt;/a&gt;]: The DateTime object has not been correctly initialized by its constructor in C:\inetpub\wwwroot\phptest\tests\ucache\wincache8.php on line 5<br />And last var_dump will return bool(false).</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.wincache-ucache-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-ucache-get.php">＋<small>add a note</small></a></div>
