...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ibase.configuration.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ibase.configuration.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ibase.configuration.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ibase.setup.php">
 <link rel="prev" href="https://www.php.net/manual/en/ibase.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/ibase.constants.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ibase.configuration.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ibase.configuration.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ibase.configuration.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ibase.configuration.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ibase.configuration.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ibase.configuration.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ibase.configuration.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ibase.configuration.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ibase.configuration.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ibase.configuration.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ibase.configuration.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ibase.configuration.php' selected="selected">English</option>
            <option value='de/ibase.configuration.php'>German</option>
            <option value='es/ibase.configuration.php'>Spanish</option>
            <option value='fr/ibase.configuration.php'>French</option>
            <option value='it/ibase.configuration.php'>Italian</option>
            <option value='ja/ibase.configuration.php'>Japanese</option>
            <option value='pt_BR/ibase.configuration.php'>Brazilian Portuguese</option>
            <option value='ru/ibase.configuration.php'>Russian</option>
            <option value='tr/ibase.configuration.php'>Turkish</option>
            <option value='uk/ibase.configuration.php'>Ukrainian</option>
            <option value='zh/ibase.configuration.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ibase.configuration" class="section">
...
<p class="para">
   ...
   <dd>
    ...
    or when binding arguments to date and time parameters. 
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/ini.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fibase.configuration%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ibase.configuration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ibase.configuration.php">＋<small>add a note</small></a></span>
 ...
 <div class="note">There are no user contributed notes for this page.</div></section>    </section><!-- layout-content -->
        ...
        <ul class='parent-menu-list'>
                                    <li>
                <a href="ibase.setup.php">Installing/Configuring</a>

                                    <ul class='child-menu-list'>

                                                <li class="">
                            <a href="ibase.installation.php" title="Installation">Installation</a>
                        </li>
                                                <li class="current">
                            <a href="ibase.configuration.php" title="Runtime Configuration">Runtime Configuration</a>
                        </li>
