...
<head>
  ...
  <title>PHP: Imagick::getImageAlphaChannel - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagealphachannel.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagealphachannel.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagealphachannel.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageartifact.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagealphachannel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagealphachannel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagealphachannel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagealphachannel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagealphachannel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagealphachannel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagealphachannel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagealphachannel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagealphachannel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagealphachannel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagealphachannel.php" hreflang="zh">
...
<meta name="Description" content="Checks if the image has an alpha channel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageAlphaChannel - Manual" />
<meta name="twitter:description" content="Checks if the image has an alpha channel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageAlphaChannel - Manual" />
<meta itemprop="description" content="Checks if the image has an alpha channel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if the image has an alpha channel" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimageartifact.php">
          Imagick::getImageArtifact &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimage.php">
          &laquo; Imagick::getImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagealphachannel.php' selected="selected">English</option>
            <option value='de/imagick.getimagealphachannel.php'>German</option>
            <option value='es/imagick.getimagealphachannel.php'>Spanish</option>
            <option value='fr/imagick.getimagealphachannel.php'>French</option>
            <option value='it/imagick.getimagealphachannel.php'>Italian</option>
            <option value='ja/imagick.getimagealphachannel.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagealphachannel.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagealphachannel.php'>Russian</option>
            <option value='tr/imagick.getimagealphachannel.php'>Turkish</option>
            <option value='uk/imagick.getimagealphachannel.php'>Ukrainian</option>
            <option value='zh/imagick.getimagealphachannel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagealphachannel" class="refentry">
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagealphachannel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagealphachannel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagealphachannel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagealphachannel.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126859">  <div class="votes">
    <div id="Vu126859">
    <a href="/manual/vote-note.php?id=126859&amp;page=imagick.getimagealphachannel&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126859">
    <a href="/manual/vote-note.php?id=126859&amp;page=imagick.getimagealphachannel&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126859" title="50% like this...">
    0
    </div>
  </div>
  <a href="#126859" class="name">
  <strong class="user"><em>phroggar</em></strong></a><a class="genanchor" href="#126859"> &para;</a><div class="date" title="2022-02-17 08:54"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126859">
<div class="phpcode"><code><span class="html">You want to check wether an image has an alpha channel? But you have no control which Imagick Version is used?<br /><br />Background: <br /><br />Method available since ImageMagick 6.4.0<br />Method returns boolean instead of int since 6.9.x<br /><br />Example:<br /><br />$image= new Imagick();<br />$image-&gt;readImage($source_file);<br /><br />$imageHasAlphaChannel = (method_exists($image, 'getImageAlphaChannel') &amp;&amp; ($document-&gt;getImageAlphaChannel() === \Imagick::ALPHACHANNEL_ACTIVATE || $document-&gt;getImageAlphaChannel()  === true));</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagealphachannel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagealphachannel.php">＋<small>add a note</small></a></div>
