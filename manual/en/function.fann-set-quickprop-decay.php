...
<head>
  ...
  <title>PHP: fann_set_quickprop_decay - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-quickprop-decay.php">
 <link rel="shorturl" href="https://www.php.net/fann-set-quickprop-decay">
 <link rel="alternate" href="https://www.php.net/fann-set-quickprop-decay" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-output-scaling-params.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-quickprop-mu.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-set-quickprop-decay.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-set-quickprop-decay.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-set-quickprop-decay.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-set-quickprop-decay.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-set-quickprop-decay.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-set-quickprop-decay.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-set-quickprop-decay.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-set-quickprop-decay.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-set-quickprop-decay.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-set-quickprop-decay.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-set-quickprop-decay.php" hreflang="zh">
...
<meta name="Description" content="Sets the quickprop decay factor" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_quickprop_decay - Manual" />
<meta name="twitter:description" content="Sets the quickprop decay factor" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_quickprop_decay - Manual" />
<meta itemprop="description" content="Sets the quickprop decay factor" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the quickprop decay factor" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-set-quickprop-mu.php">
          fann_set_quickprop_mu &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-set-output-scaling-params.php">
          &laquo; fann_set_output_scaling_params        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-quickprop-decay.php' selected="selected">English</option>
            <option value='de/function.fann-set-quickprop-decay.php'>German</option>
            <option value='es/function.fann-set-quickprop-decay.php'>Spanish</option>
            <option value='fr/function.fann-set-quickprop-decay.php'>French</option>
            <option value='it/function.fann-set-quickprop-decay.php'>Italian</option>
            <option value='ja/function.fann-set-quickprop-decay.php'>Japanese</option>
            <option value='pt_BR/function.fann-set-quickprop-decay.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-set-quickprop-decay.php'>Russian</option>
            <option value='tr/function.fann-set-quickprop-decay.php'>Turkish</option>
            <option value='uk/function.fann-set-quickprop-decay.php'>Ukrainian</option>
            <option value='zh/function.fann-set-quickprop-decay.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-set-quickprop-decay" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-get-quickprop-decay.php" class="function" rel="rdfs-seeAlso">fann_get_quickprop_decay()</a> - Returns the decay which is a factor that weights should decrease in each iteration during quickprop training</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-quickprop-decay.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-quickprop-decay%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-quickprop-decay&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-quickprop-decay.php">＋<small>add a note</small></a></span>
