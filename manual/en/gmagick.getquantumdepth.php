...
<head>
  ...
  <title>PHP: Gmagick::getquantumdepth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getquantumdepth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getquantumdepth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getquantumdepth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getpackagename.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getreleasedate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getquantumdepth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getquantumdepth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getquantumdepth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getquantumdepth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getquantumdepth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getquantumdepth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getquantumdepth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getquantumdepth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getquantumdepth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getquantumdepth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getquantumdepth.php" hreflang="zh">
...
<meta name="Description" content="Returns the Gmagick quantum depth as a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::getquantumdepth - Manual" />
<meta name="twitter:description" content="Returns the Gmagick quantum depth as a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getquantumdepth - Manual" />
<meta itemprop="description" content="Returns the Gmagick quantum depth as a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the Gmagick quantum depth as a string" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getreleasedate.php">
          Gmagick::getreleasedate &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getpackagename.php">
          &laquo; Gmagick::getpackagename        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getquantumdepth.php' selected="selected">English</option>
            <option value='de/gmagick.getquantumdepth.php'>German</option>
            <option value='es/gmagick.getquantumdepth.php'>Spanish</option>
            <option value='fr/gmagick.getquantumdepth.php'>French</option>
            <option value='it/gmagick.getquantumdepth.php'>Italian</option>
            <option value='ja/gmagick.getquantumdepth.php'>Japanese</option>
            <option value='pt_BR/gmagick.getquantumdepth.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getquantumdepth.php'>Russian</option>
            <option value='tr/gmagick.getquantumdepth.php'>Turkish</option>
            <option value='uk/gmagick.getquantumdepth.php'>Ukrainian</option>
            <option value='zh/gmagick.getquantumdepth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getquantumdepth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getquantumdepth</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getquantumdepth</span> &mdash; <span class="dc-title">Returns the Gmagick quantum depth as a string</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getquantumdepth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getquantumdepth</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   Returns the <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> quantum depth as a string.
  </p>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getquantumdepth-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getquantumdepth-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getquantumdepth-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getquantumdepth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getquantumdepth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getquantumdepth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getquantumdepth.php">＋<small>add a note</small></a></span>
