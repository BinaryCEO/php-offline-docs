...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-set-opt.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-set-on-import-javascript.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-set-status.php">
...
<meta name="Description" content="Sets an option of a field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_set_opt - Manual" />
<meta name="twitter:description" content="Sets an option of a field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_set_opt - Manual" />
<meta itemprop="description" content="Sets an option of a field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets an option of a field" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-set-opt.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.fdf-set-opt.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5 &lt; 5.3.0, PECL fdf SVN)</p><p class="refpurpose"><span class="refname">fdf_set_opt</span> &mdash; <span class="dc-title">Sets an option of a field</span></p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.fdf-set-opt-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fdf-set-flags.php" class="function" rel="rdfs-seeAlso">fdf_set_flags()</a> - Sets a flag of a field</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-set-opt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-set-opt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-set-opt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-set-opt.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">For a nice example of how this works to populate a list box dynamically, see this URL:<br /><br /><a href="http://www.fooassociates.com/phpfer/html/rn20re282.html" rel="nofollow" target="_blank">http://www.fooassociates.com/phpfer/html/rn20re282.html</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fdf-set-opt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-set-opt.php">＋<small>add a note</small></a></div>
