...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightFormatter - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightformatter.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightformatter.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightformatter.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightfields.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightfragmenter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightformatter.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightformatter.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightformatter.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightformatter.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightformatter.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightformatter.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightformatter.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightformatter.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightformatter.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightformatter.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightformatter.php" hreflang="zh">
...
<meta name="Description" content="Returns the formatter for the highlighted output" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightFormatter - Manual" />
<meta name="twitter:description" content="Returns the formatter for the highlighted output" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightFormatter - Manual" />
<meta itemprop="description" content="Returns the formatter for the highlighted output" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the formatter for the highlighted output" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gethighlightfragmenter.php">
          SolrQuery::getHighlightFragmenter &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightfields.php">
          &laquo; SolrQuery::getHighlightFields        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightformatter.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightformatter.php'>German</option>
            <option value='es/solrquery.gethighlightformatter.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightformatter.php'>French</option>
            <option value='it/solrquery.gethighlightformatter.php'>Italian</option>
            <option value='ja/solrquery.gethighlightformatter.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightformatter.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightformatter.php'>Russian</option>
            <option value='tr/solrquery.gethighlightformatter.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightformatter.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightformatter.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightformatter" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightFormatter</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightFormatter</span> &mdash; <span class="dc-title">Returns the formatter for the highlighted output</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightformatter-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightFormatter</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightformatter-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightformatter-returnvalues">
...
Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightformatter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightformatter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightformatter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightformatter.php">＋<small>add a note</small></a></span>
