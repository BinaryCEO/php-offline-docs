...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.uopz-get-return.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.uopz-get-property.php">
 <link rel="next" href="https://www.php.net/manual/en/function.uopz-get-static.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.uopz-get-return.php' selected="selected">English</option>
            <option value='de/function.uopz-get-return.php'>German</option>
 ...
 <div class="refsect1 examples" id="refsect1-function.uopz-get-return-examples">
  ...
  <div class="example" id="example-710">
   <p><strong>Example #1 <span class="function"><strong>uopz_get_return()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">42</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uopz/functions/uopz-get-return.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.uopz-get-return%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.uopz-get-return&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.uopz-get-return.php">＋<small>add a note</small></a></span>
