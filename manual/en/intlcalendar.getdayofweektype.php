...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.getdayofweektype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.getdayofweektype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getdayofweektype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.getavailablelocales.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.geterrorcode.php">
...
<meta name="Description" content="Tell whether a day is a weekday, weekend or a day that has a transition between the two" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::getDayOfWeekType - Manual" />
<meta name="twitter:description" content="Tell whether a day is a weekday, weekend or a day that has a transition between the two" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::getDayOfWeekType - Manual" />
<meta itemprop="description" content="Tell whether a day is a weekday, weekend or a day that has a transition between the two" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Tell whether a day is a weekday, weekend or a day that has a transition between the two" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.getdayofweektype.php' selected="selected">English</option>
            ...
            <option value='ru/intlcalendar.getdayofweektype.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlCalendar::getDayOfWeekType</span> &mdash; <span class="dc-title">Tell whether a day is a weekday, weekend or a day that has a transition between the two</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlcalendar.getdayofweektype-description">
  ...
  <p class="para rdfs-comment">
   ...
   (<strong><code><a href="class.intlcalendar.php#intlcalendar.constants.dow-type-weekday">IntlCalendar::DOW_TYPE_WEEKDAY</a></code></strong>), a weekend day
   (<strong><code><a href="class.intlcalendar.php#intlcalendar.constants.dow-type-weekend">IntlCalendar::DOW_TYPE_WEEKEND</a></code></strong>), a day during which a
   transition occurs into the weekend
   (<strong><code><a href="class.intlcalendar.php#intlcalendar.constants.dow-type-weekend-offset">IntlCalendar::DOW_TYPE_WEEKEND_OFFSET</a></code></strong>) or a day during
  ...
  <p class="para">
   ...
   <strong><code><a href="class.intlcalendar.php#intlcalendar.constants.dow-type-weekend-cease">IntlCalendar::DOW_TYPE_WEEKEND_CEASE</a></code></strong>, then
   <span class="function"><a href="intlcalendar.getweekendtransition.php" class="function">IntlCalendar::getWeekendTransition()</a></span> can be called to
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlcalendar.getdayofweektype-returnvalues">
  ...
  <p class="para">
   ...
   <strong><code><a href="class.intlcalendar.php#intlcalendar.constants.dow-type-weekend-offset">IntlCalendar::DOW_TYPE_WEEKEND_OFFSET</a></code></strong> or
   <strong><code><a href="class.intlcalendar.php#intlcalendar.constants.dow-type-weekend-cease">IntlCalendar::DOW_TYPE_WEEKEND_CEASE</a></code></strong> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
7 1 86400000</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/getdayofweektype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.getdayofweektype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.getdayofweektype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.getdayofweektype.php">＋<small>add a note</small></a></span>
