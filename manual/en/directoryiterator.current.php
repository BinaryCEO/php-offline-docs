...
<head>
  ...
  <title>PHP: DirectoryIterator::current - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/directoryiterator.current.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/directoryiterator.current.php">
 <link rel="alternate" href="https://www.php.net/manual/en/directoryiterator.current.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.directoryiterator.php">
 <link rel="prev" href="https://www.php.net/manual/en/directoryiterator.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/directoryiterator.getbasename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/directoryiterator.current.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/directoryiterator.current.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/directoryiterator.current.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/directoryiterator.current.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/directoryiterator.current.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/directoryiterator.current.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/directoryiterator.current.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/directoryiterator.current.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/directoryiterator.current.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/directoryiterator.current.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/directoryiterator.current.php" hreflang="zh">
...
<meta name="Description" content="Return the current DirectoryIterator item" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DirectoryIterator::current - Manual" />
<meta name="twitter:description" content="Return the current DirectoryIterator item" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DirectoryIterator::current - Manual" />
<meta itemprop="description" content="Return the current DirectoryIterator item" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the current DirectoryIterator item" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="directoryiterator.getbasename.php">
          DirectoryIterator::getBasename &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="directoryiterator.construct.php">
          &laquo; DirectoryIterator::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/directoryiterator.current.php' selected="selected">English</option>
            <option value='de/directoryiterator.current.php'>German</option>
            <option value='es/directoryiterator.current.php'>Spanish</option>
            <option value='fr/directoryiterator.current.php'>French</option>
            <option value='it/directoryiterator.current.php'>Italian</option>
            <option value='ja/directoryiterator.current.php'>Japanese</option>
            <option value='pt_BR/directoryiterator.current.php'>Brazilian Portuguese</option>
            <option value='ru/directoryiterator.current.php'>Russian</option>
            <option value='tr/directoryiterator.current.php'>Turkish</option>
            <option value='uk/directoryiterator.current.php'>Ukrainian</option>
            <option value='zh/directoryiterator.current.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="directoryiterator.current" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="iterator.current.php" class="methodname" rel="rdfs-seeAlso">Iterator::current()</a> - Return the current element</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/directoryiterator/current.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdirectoryiterator.current%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=directoryiterator.current&amp;repo=en&amp;redirect=https://www.php.net/manual/en/directoryiterator.current.php">＋<small>add a note</small></a></span>
