...
<head>
  ...
  <title>PHP: db2_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-result.php">
 <link rel="shorturl" href="https://www.php.net/db2-result">
 <link rel="alternate" href="https://www.php.net/db2-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-procedures.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-rollback.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-result.php" hreflang="zh">
...
<meta name="Description" content="Returns a single column from a row in the result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_result - Manual" />
<meta name="twitter:description" content="Returns a single column from a row in the result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_result - Manual" />
<meta itemprop="description" content="Returns a single column from a row in the result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a single column from a row in the result set" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.db2-rollback.php">
          db2_rollback &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-procedures.php">
          &laquo; db2_procedures        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-result.php' selected="selected">English</option>
            <option value='de/function.db2-result.php'>German</option>
            <option value='es/function.db2-result.php'>Spanish</option>
            <option value='fr/function.db2-result.php'>French</option>
            <option value='it/function.db2-result.php'>Italian</option>
            <option value='ja/function.db2-result.php'>Japanese</option>
            <option value='pt_BR/function.db2-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-result.php'>Russian</option>
            <option value='tr/function.db2-result.php'>Turkish</option>
            <option value='uk/function.db2-result.php'>Ukrainian</option>
            <option value='zh/function.db2-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-result" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-fetch-row.php" class="function" rel="rdfs-seeAlso">db2_fetch_row()</a> - Sets the result set pointer to the next row or requested row</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-result.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116287">  <div class="votes">
    <div id="Vu116287">
    <a href="/manual/vote-note.php?id=116287&amp;page=function.db2-result&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116287">
    <a href="/manual/vote-note.php?id=116287&amp;page=function.db2-result&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116287" title="50% like this...">
    0
    </div>
  </div>
  <a href="#116287" class="name">
  <strong class="user"><em>jay+nospam at toxicedge dot com</em></strong></a><a class="genanchor" href="#116287"> &para;</a><div class="date" title="2014-12-05 09:30"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116287">
<div class="phpcode"><code><span class="html">It's worth noting that this function consumes the value (the first call will return a result, and any subsequent calls will return NULL).</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-result.php">＋<small>add a note</small></a></div>
