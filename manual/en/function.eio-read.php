...
<head>
  ...
  <title>PHP: eio_read - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-read.php">
 <link rel="shorturl" href="https://www.php.net/eio-read">
 <link rel="alternate" href="https://www.php.net/eio-read" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-poll.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-readahead.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-read.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-read.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-read.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-read.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-read.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-read.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-read.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-read.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-read.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-read.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-read.php" hreflang="zh">
...
<meta name="Description" content="Read from a file descriptor at given offset" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_read - Manual" />
<meta name="twitter:description" content="Read from a file descriptor at given offset" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_read - Manual" />
<meta itemprop="description" content="Read from a file descriptor at given offset" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Read from a file descriptor at given offset" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-readahead.php">
          eio_readahead &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-poll.php">
          &laquo; eio_poll        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-read.php' selected="selected">English</option>
            <option value='de/function.eio-read.php'>German</option>
            <option value='es/function.eio-read.php'>Spanish</option>
            <option value='fr/function.eio-read.php'>French</option>
            <option value='it/function.eio-read.php'>Italian</option>
            <option value='ja/function.eio-read.php'>Japanese</option>
            <option value='pt_BR/function.eio-read.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-read.php'>Russian</option>
            <option value='tr/function.eio-read.php'>Turkish</option>
            <option value='uk/function.eio-read.php'>Ukrainian</option>
            <option value='zh/function.eio-read.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-read" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-read-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_read</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>eio_read()</strong></span> reads up to <code class="parameter">length</code>
   bytes from <code class="parameter">fd</code> file descriptor at
   <code class="parameter">offset</code>. The read bytes are stored in
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-read-returnvalues">
  ...
  <p class="para">
  <span class="function"><strong>eio_read()</strong></span> stores read bytes in
  <code class="parameter">result</code> argument of <code class="parameter">callback</code>
  function.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.eio-read-examples">
  ...
  <div class="example" id="example-3521">
   <p><strong>Example #1 <span class="function"><strong>eio_read()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">string(5) &quot;34567&quot;</pre>
</div>
   </div>
  </div>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-read-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.eio-write.php" class="function" rel="rdfs-seeAlso">eio_write()</a> - Write to file</span></li>
   <li><span class="function"><a href="function.eio-close.php" class="function" rel="rdfs-seeAlso">eio_close()</a> - Close file</span></li>
   <li><span class="function"><a href="function.eio-event-loop.php" class="function" rel="rdfs-seeAlso">eio_event_loop()</a> - Polls libeio until all requests proceeded</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-read.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-read%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-read&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-read.php">＋<small>add a note</small></a></span>
