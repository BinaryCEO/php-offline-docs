...
<head>
  ...
  <title>PHP: GearmanClient::setWorkloadCallback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.setworkloadcallback.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.setworkloadcallback.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.setworkloadcallback.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.setwarningcallback.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.timeout.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.setworkloadcallback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.setworkloadcallback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.setworkloadcallback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.setworkloadcallback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.setworkloadcallback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.setworkloadcallback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.setworkloadcallback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.setworkloadcallback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.setworkloadcallback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.setworkloadcallback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.setworkloadcallback.php" hreflang="zh">
...
<meta name="Description" content="Set a callback for accepting incremental data updates" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::setWorkloadCallback - Manual" />
<meta name="twitter:description" content="Set a callback for accepting incremental data updates" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::setWorkloadCallback - Manual" />
<meta itemprop="description" content="Set a callback for accepting incremental data updates" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set a callback for accepting incremental data updates" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearmanclient.timeout.php">
          GearmanClient::timeout &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.setwarningcallback.php">
          &laquo; GearmanClient::setWarningCallback        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.setworkloadcallback.php' selected="selected">English</option>
            <option value='de/gearmanclient.setworkloadcallback.php'>German</option>
            <option value='es/gearmanclient.setworkloadcallback.php'>Spanish</option>
            <option value='fr/gearmanclient.setworkloadcallback.php'>French</option>
            <option value='it/gearmanclient.setworkloadcallback.php'>Italian</option>
            <option value='ja/gearmanclient.setworkloadcallback.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.setworkloadcallback.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.setworkloadcallback.php'>Russian</option>
            <option value='tr/gearmanclient.setworkloadcallback.php'>Turkish</option>
            <option value='uk/gearmanclient.setworkloadcallback.php'>Ukrainian</option>
            <option value='zh/gearmanclient.setworkloadcallback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.setworkloadcallback" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">GearmanClient::setWorkloadCallback</h1>
  <p class="verinfo">(PECL gearman &gt;= 0.5.0)</p><p class="refpurpose"><span class="refname">GearmanClient::setWorkloadCallback</span> &mdash; <span class="dc-title">Set a callback for accepting incremental data updates</span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.setwarningcallback.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::setWarningCallback()</a> - Set a callback for worker warnings</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/setworkloadcallback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.setworkloadcallback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.setworkloadcallback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.setworkloadcallback.php">＋<small>add a note</small></a></span>
