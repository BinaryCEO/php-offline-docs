...
<head>
  ...
  <title>PHP: ps_get_buffer - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-get-buffer.php">
 <link rel="shorturl" href="https://www.php.net/ps-get-buffer">
 <link rel="alternate" href="https://www.php.net/ps-get-buffer" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-findfont.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-get-parameter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-get-buffer.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-get-buffer.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-get-buffer.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-get-buffer.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-get-buffer.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-get-buffer.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-get-buffer.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-get-buffer.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-get-buffer.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-get-buffer.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-get-buffer.php" hreflang="zh">
...
<meta name="Description" content="Fetches the full buffer containig the generated PS data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_get_buffer - Manual" />
<meta name="twitter:description" content="Fetches the full buffer containig the generated PS data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_get_buffer - Manual" />
<meta itemprop="description" content="Fetches the full buffer containig the generated PS data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetches the full buffer containig the generated PS data" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-get-buffer.php' selected="selected">English</option>
            <option value='de/function.ps-get-buffer.php'>German</option>
            <option value='es/function.ps-get-buffer.php'>Spanish</option>
            <option value='fr/function.ps-get-buffer.php'>French</option>
            <option value='it/function.ps-get-buffer.php'>Italian</option>
            <option value='ja/function.ps-get-buffer.php'>Japanese</option>
            <option value='pt_BR/function.ps-get-buffer.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-get-buffer.php'>Russian</option>
            <option value='tr/function.ps-get-buffer.php'>Turkish</option>
            <option value='uk/function.ps-get-buffer.php'>Ukrainian</option>
            <option value='zh/function.ps-get-buffer.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-get-buffer" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-open-file.php" class="function" rel="rdfs-seeAlso">ps_open_file()</a> - Opens a file for output</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-get-buffer.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-get-buffer%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-get-buffer&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-get-buffer.php">＋<small>add a note</small></a></span>
