...
<head>
  ...
  <title>PHP: DOMComment - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.domcomment.php">
 <link rel="shorturl" href="https://www.php.net/domcomment">
 <link rel="alternate" href="https://www.php.net/domcomment" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/domchildnode.replacewith.php">
 <link rel="next" href="https://www.php.net/manual/en/domcomment.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.domcomment.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.domcomment.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.domcomment.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.domcomment.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.domcomment.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.domcomment.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.domcomment.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.domcomment.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.domcomment.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.domcomment.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.domcomment.php" hreflang="zh">
...
<meta name="Description" content="The DOMComment class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMComment - Manual" />
<meta name="twitter:description" content="The DOMComment class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMComment - Manual" />
<meta itemprop="description" content="The DOMComment class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DOMComment class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="domcomment.construct.php">
          DOMComment::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domchildnode.replacewith.php">
          &laquo; DOMChildNode::replaceWith        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.domcomment.php' selected="selected">English</option>
            <option value='de/class.domcomment.php'>German</option>
            <option value='es/class.domcomment.php'>Spanish</option>
            <option value='fr/class.domcomment.php'>French</option>
            <option value='it/class.domcomment.php'>Italian</option>
            <option value='ja/class.domcomment.php'>Japanese</option>
            <option value='pt_BR/class.domcomment.php'>Brazilian Portuguese</option>
            <option value='ru/class.domcomment.php'>Russian</option>
            <option value='tr/class.domcomment.php'>Turkish</option>
            <option value='uk/class.domcomment.php'>Ukrainian</option>
            <option value='zh/class.domcomment.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.domcomment" class="reference">
 <h1 class="title">The DOMComment class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>
 

  <div class="section" id="domcomment.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    Represents comment nodes, characters delimited by <code class="code">&lt;!--</code>
    and <code class="code">--&gt;</code>.
   </p>
  </div>

 
  <div class="section" id="domcomment.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">DOMComment</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="domcomment.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code><span class="initializer"> = &quot;&quot;</span></span>)</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domnode.wakeup.php" class="methodname">DOMNode::__wakeup</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section">
   ...
   <p class="para">
    <ul class="simplelist">
     <li><a href="http://www.w3.org/TR/2003/WD-DOM-Level-3-Core-20030226/DOM3-Core.html#core-ID-1728279322" class="link external">&raquo;&nbsp;W3C specification of Comment</a></li>
    </ul>
   </p>
  </div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="domcomment.construct.php">DOMComment::__construct</a> — Creates a new DOMComment object</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domcomment.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.domcomment%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.domcomment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.domcomment.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126408">  <div class="votes">
    <div id="Vu126408">
    <a href="/manual/vote-note.php?id=126408&amp;page=class.domcomment&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126408">
    <a href="/manual/vote-note.php?id=126408&amp;page=class.domcomment&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126408" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#126408" class="name">
  <strong class="user"><em>npelov at croler dot net</em></strong></a><a class="genanchor" href="#126408"> &para;</a><div class="date" title="2021-09-09 04:41"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126408">
<div class="phpcode"><code><span class="html">Note that textContent property of a comment is not entity decoded, it is decoded in DOMElement::textContent :<br /><br /><span class="default">&lt;?php <br /><br />   $xml </span><span class="keyword">= new </span><span class="default">DOMDocument</span><span class="keyword">();<br />    </span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">loadXML</span><span class="keyword">(</span><span class="string">'&lt;?xml version="1.0" encoding="utf-8"?&gt;<br />      &lt;configuration version="2"&gt;<br />      &lt;!-- test &amp;#45;&amp;#45;&amp;gt; --&gt;<br />      test &amp;#45;&amp;#45;&amp;gt;<br />      &lt;/configuration&gt;'<br />    </span><span class="keyword">);<br /></span><span class="default">$xpath </span><span class="keyword">= new </span><span class="default">DOMXPath</span><span class="keyword">(</span><span class="default">$xml</span><span class="keyword">);<br /></span><span class="default">$comments </span><span class="keyword">= </span><span class="default">$xpath</span><span class="keyword">-&gt;</span><span class="default">query</span><span class="keyword">(</span><span class="string">'//comment()'</span><span class="keyword">);<br /></span><span class="default">$elements </span><span class="keyword">= </span><span class="default">$xpath</span><span class="keyword">-&gt;</span><span class="default">query</span><span class="keyword">(</span><span class="string">'//configuration'</span><span class="keyword">);<br /><br />echo </span><span class="default">$comments</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">]-&gt;</span><span class="default">textContent</span><span class="keyword">;<br /></span><span class="comment">// result: test &amp;#45;&amp;#45;&amp;gt;<br /><br /></span><span class="keyword">echo </span><span class="default">$elements</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">]-&gt;</span><span class="default">textContent</span><span class="keyword">;<br /></span><span class="comment">// result: test --&gt;<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.domcomment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.domcomment.php">＋<small>add a note</small></a></div>
