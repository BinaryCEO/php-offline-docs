...
<head>
  ...
  <title>PHP: ps_show - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-show.php">
 <link rel="shorturl" href="https://www.php.net/ps-show">
 <link rel="alternate" href="https://www.php.net/ps-show" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-shfill.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-show-boxed.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-show.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-show.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-show.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-show.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-show.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-show.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-show.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-show.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-show.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-show.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-show.php" hreflang="zh">
...
<meta name="Description" content="Output text" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_show - Manual" />
<meta name="twitter:description" content="Output text" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_show - Manual" />
<meta itemprop="description" content="Output text" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Output text" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-show-boxed.php">
          ps_show_boxed &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-shfill.php">
          &laquo; ps_shfill        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-show.php' selected="selected">English</option>
            <option value='de/function.ps-show.php'>German</option>
            <option value='es/function.ps-show.php'>Spanish</option>
            <option value='fr/function.ps-show.php'>French</option>
            <option value='it/function.ps-show.php'>Italian</option>
            <option value='ja/function.ps-show.php'>Japanese</option>
            <option value='pt_BR/function.ps-show.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-show.php'>Russian</option>
            <option value='tr/function.ps-show.php'>Turkish</option>
            <option value='uk/function.ps-show.php'>Ukrainian</option>
            <option value='zh/function.ps-show.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-show" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ps-show-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_show</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$text</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Output a text at the current text position. The text position can be set
   by storing the x and y coordinates into the values <code class="literal">textx</code>
   and <code class="literal">texty</code> with the function
   <span class="function"><a href="function.ps-set-value.php" class="function">ps_set_value()</a></span>. The function will issue an
   error if a font was not set before with <span class="function"><a href="function.ps-setfont.php" class="function">ps_setfont()</a></span>.
  </p>
  <p class="para">
   <span class="function"><strong>ps_show()</strong></span> evaluates the following parameters and values
   as set by <span class="function"><a href="function.ps-set-parameter.php" class="function">ps_set_parameter()</a></span> and
   <span class="function"><a href="function.ps-set-value.php" class="function">ps_set_value()</a></span>.
  </p>
  <dl>
   
    <dt>charspacing (value)</dt>
    <dd>
     <p class="para">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-setfont.php" class="function" rel="rdfs-seeAlso">ps_setfont()</a> - Sets font to use for following output</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-show.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-show%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-show&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-show.php">＋<small>add a note</small></a></span>
