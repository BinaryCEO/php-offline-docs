...
<head>
  ...
  <title>PHP: pspell_save_wordlist - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pspell-save-wordlist.php">
 <link rel="shorturl" href="https://www.php.net/pspell-save-wordlist">
 <link rel="alternate" href="https://www.php.net/pspell-save-wordlist" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pspell.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pspell-new-personal.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pspell-store-replacement.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pspell-save-wordlist.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pspell-save-wordlist.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pspell-save-wordlist.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pspell-save-wordlist.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pspell-save-wordlist.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pspell-save-wordlist.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pspell-save-wordlist.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pspell-save-wordlist.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pspell-save-wordlist.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pspell-save-wordlist.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pspell-save-wordlist.php" hreflang="zh">
...
<meta name="Description" content="Save the personal wordlist to a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pspell_save_wordlist - Manual" />
<meta name="twitter:description" content="Save the personal wordlist to a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pspell_save_wordlist - Manual" />
<meta itemprop="description" content="Save the personal wordlist to a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Save the personal wordlist to a file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pspell-store-replacement.php">
          pspell_store_replacement &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pspell-new-personal.php">
          &laquo; pspell_new_personal        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pspell-save-wordlist.php' selected="selected">English</option>
            <option value='de/function.pspell-save-wordlist.php'>German</option>
            <option value='es/function.pspell-save-wordlist.php'>Spanish</option>
            <option value='fr/function.pspell-save-wordlist.php'>French</option>
            <option value='it/function.pspell-save-wordlist.php'>Italian</option>
            <option value='ja/function.pspell-save-wordlist.php'>Japanese</option>
            <option value='pt_BR/function.pspell-save-wordlist.php'>Brazilian Portuguese</option>
            <option value='ru/function.pspell-save-wordlist.php'>Russian</option>
            <option value='tr/function.pspell-save-wordlist.php'>Turkish</option>
            <option value='uk/function.pspell-save-wordlist.php'>Ukrainian</option>
            <option value='zh/function.pspell-save-wordlist.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pspell-save-wordlist" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pspell_save_wordlist</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pspell_save_wordlist</span> &mdash; <span class="dc-title">Save the personal wordlist to a file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pspell-save-wordlist-description">
  ...
  <p class="simpara">
   ...
   <span class="function"><a href="function.pspell-config-personal.php" class="function">pspell_config_personal()</a></span> and (optionally)
 ...
 <div class="refsect1 changelog" id="refsect1-function.pspell-save-wordlist-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pspell-save-wordlist-examples">
  ...
  <p class="para">
   <div class="example" id="example-2807">
    <p><strong>Example #1 <span class="function"><a href="function.pspell-add-to-personal.php" class="function">pspell_add_to_personal()</a></span></strong></p>
   ...
   <p class="para">
    ...
    or later.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pspell/functions/pspell-save-wordlist.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pspell-save-wordlist%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pspell-save-wordlist&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pspell-save-wordlist.php">＋<small>add a note</small></a></span>
