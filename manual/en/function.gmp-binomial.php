...
<head>
  ...
  <title>PHP: gmp_binomial - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-binomial.php">
 <link rel="shorturl" href="https://www.php.net/gmp-binomial">
 <link rel="alternate" href="https://www.php.net/gmp-binomial" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-and.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-clrbit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-binomial.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-binomial.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-binomial.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-binomial.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-binomial.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-binomial.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-binomial.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-binomial.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-binomial.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-binomial.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-binomial.php" hreflang="zh">
...
<meta name="Description" content="Calculates binomial coefficient" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_binomial - Manual" />
<meta name="twitter:description" content="Calculates binomial coefficient" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_binomial - Manual" />
<meta itemprop="description" content="Calculates binomial coefficient" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calculates binomial coefficient" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-binomial.php' selected="selected">English</option>
            <option value='de/function.gmp-binomial.php'>German</option>
            <option value='es/function.gmp-binomial.php'>Spanish</option>
            <option value='fr/function.gmp-binomial.php'>French</option>
            <option value='it/function.gmp-binomial.php'>Italian</option>
            <option value='ja/function.gmp-binomial.php'>Japanese</option>
            <option value='pt_BR/function.gmp-binomial.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-binomial.php'>Russian</option>
            <option value='tr/function.gmp-binomial.php'>Turkish</option>
            <option value='uk/function.gmp-binomial.php'>Ukrainian</option>
            <option value='zh/function.gmp-binomial.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-binomial" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_binomial</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.3.0, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_binomial</span> &mdash; <span class="dc-title">Calculates binomial coefficient</span></p>
 ...
 <div class="refsect1 errors" id="refsect1-function.gmp-binomial-errors">
  ...
  <p class="para">
   Throws <span class="classname"><a href="class.valueerror.php" class="classname">ValueError</a></span> if <code class="parameter">k</code> is negative.
   Prior to PHP 8.0.0, <strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> was issued instead.
  </p>
 </div>
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-binomial.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-binomial%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-binomial&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-binomial.php">＋<small>add a note</small></a></span>
