...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pclose.php">
 <link rel="shorturl" href="https://www.php.net/pclose">
 <link rel="alternate" href="https://www.php.net/pclose" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pathinfo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.popen.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pclose.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pclose.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pclose.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pclose.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pclose.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pclose.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pclose.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pclose.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pclose.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pclose.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pclose.php" hreflang="zh">
...
<meta name="Description" content="Closes process file pointer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pclose - Manual" />
<meta name="twitter:description" content="Closes process file pointer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pclose - Manual" />
<meta itemprop="description" content="Closes process file pointer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Closes process file pointer" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pclose.php' selected="selected">English</option>
            <option value='de/function.pclose.php'>German</option>
            <option value='es/function.pclose.php'>Spanish</option>
            <option value='fr/function.pclose.php'>French</option>
            <option value='it/function.pclose.php'>Italian</option>
            <option value='ja/function.pclose.php'>Japanese</option>
            <option value='pt_BR/function.pclose.php'>Brazilian Portuguese</option>
            <option value='ru/function.pclose.php'>Russian</option>
            <option value='tr/function.pclose.php'>Turkish</option>
            <option value='uk/function.pclose.php'>Ukrainian</option>
            <option value='zh/function.pclose.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pclose" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.pclose-examples">
  ...
  <p class="para">
   <div class="example" id="example-2411">
    <p><strong>Example #1 <span class="function"><strong>pclose()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.popen.php" class="function" rel="rdfs-seeAlso">popen()</a> - Opens process file pointer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/pclose.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pclose%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pclose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pclose.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117935">  <div class="votes">
    <div id="Vu117935">
    <a href="/manual/vote-note.php?id=117935&amp;page=function.pclose&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117935">
    <a href="/manual/vote-note.php?id=117935&amp;page=function.pclose&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117935" title="88% like this...">
    13
    </div>
  </div>
  <a href="#117935" class="name">
  <strong class="user"><em>Uwe Ohse</em></strong></a><a class="genanchor" href="#117935"> &para;</a><div class="date" title="2015-09-03 11:17"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117935">
<div class="phpcode"><code><span class="html">Regarding the return value:<br />"Returns the termination status of the process that was run. In case of an error then -1 is returned. "<br />and the note about the exit status: "pclose() is internally implemented using the waitpid(3) system call. To obtain the real exit status code the pcntl_wexitstatus() function should be used."<br /><br />The documentation of the return value is, at best, misleading. The function returns, as does proc_close():<br />* -1 on error,<br />* WEXITSTATUS(status) if WIFEXITED(status) is true, or <br />* status if WIFEXITED(status) is false,<br />where status is the status parameter of waitpid().<br /><br />This makes it impossible to differentiate between a relatively normal exit or a termination by signal, and reduces the value of the proc_close return code to a binary one (ok / something broke).<br /><br />This can be seen in proc_open_rsrc_dtor() in ext/standard/proc_open.c (PHP 5.4.44, 5.6.12). <br /><br />The note advising the use of pcntl_wexitstatus is plain wrong. One cannot use pcntl_wexitstatus because it already has been used.</span></code></div>
  </div>
 </div>
  <div class="note" id="34125">  <div class="votes">
    <div id="Vu34125">
    <a href="/manual/vote-note.php?id=34125&amp;page=function.pclose&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd34125">
    <a href="/manual/vote-note.php?id=34125&amp;page=function.pclose&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V34125" title="71% like this...">
    3
    </div>
  </div>
  <a href="#34125" class="name">
  <strong class="user"><em>kcross at nssolutions dot com</em></strong></a><a class="genanchor" href="#34125"> &para;</a><div class="date" title="2003-07-16 02:08"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom34125">
<div class="phpcode"><code><span class="html">Somewhere between 4.1.1 and 4.2.3, the return value from pclose changed.<br /><br />The exit status used to be in the second byte, so that the status would be (pclose($fp)/256).<br /><br />It is now in the low-order byte, so the status is just pclose($fp).<br /><br />Be careful.</span></code></div>
  </div>
 </div>
  <div class="note" id="30258">  <div class="votes">
    <div id="Vu30258">
    <a href="/manual/vote-note.php?id=30258&amp;page=function.pclose&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd30258">
    <a href="/manual/vote-note.php?id=30258&amp;page=function.pclose&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V30258" title="66% like this...">
    2
    </div>
  </div>
  <a href="#30258" class="name">
  <strong class="user"><em>vdweij at mailsurf dot com</em></strong></a><a class="genanchor" href="#30258"> &para;</a><div class="date" title="2003-03-12 07:18"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom30258">
<div class="phpcode"><code><span class="html">As I understand pclose will return 0 (on every platform) in case popen could not execute the specified command.<br /><br />Since popen only returns the status wether it was able to send a command and not wether it was succesfully executed. Only the returned value of pclose can be used to check wether a command could be executed.</span></code></div>
  </div>
 </div>
  <div class="note" id="82342">  <div class="votes">
    <div id="Vu82342">
    <a href="/manual/vote-note.php?id=82342&amp;page=function.pclose&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd82342">
    <a href="/manual/vote-note.php?id=82342&amp;page=function.pclose&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V82342" title="50% like this...">
    0
    </div>
  </div>
  <a href="#82342" class="name">
  <strong class="user"><em>Mike</em></strong></a><a class="genanchor" href="#82342"> &para;</a><div class="date" title="2008-04-06 11:55"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom82342">
<div class="phpcode"><code><span class="html">The termination status, as pointed out in another note, is not the same as the exit status from the process. However, something like "pclose($fp)/256" is not the correct way to extract the exit status, since this uses system- and version-specific knowledge of where in the termination status the exit status is stored. (Also, the process may not even have exited normally, so it may not have an exit status at all.)<br /><br />Instead, the functions pcntl_wifexited() and pcntl_wexitstatus() should be used. They are wrappers for the C macros WIFEXITED() and WEXITSTATUS() that are designed for determining whether the process had an exit status and what that status was, respectively.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pclose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pclose.php">＋<small>add a note</small></a></div>
