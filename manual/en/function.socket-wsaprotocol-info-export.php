...
<head>
  ...
  <title>PHP: socket_wsaprotocol_info_export - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-wsaprotocol-info-export.php">
 <link rel="shorturl" href="https://www.php.net/socket-wsaprotocol-info-export">
 <link rel="alternate" href="https://www.php.net/socket-wsaprotocol-info-export" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-write.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-wsaprotocol-info-import.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-wsaprotocol-info-export.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-wsaprotocol-info-export.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-wsaprotocol-info-export.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-wsaprotocol-info-export.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-wsaprotocol-info-export.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-wsaprotocol-info-export.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-wsaprotocol-info-export.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-wsaprotocol-info-export.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-wsaprotocol-info-export.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-wsaprotocol-info-export.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-wsaprotocol-info-export.php" hreflang="zh">
...
<meta name="Description" content="Exports the WSAPROTOCOL_INFO Structure" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_wsaprotocol_info_export - Manual" />
<meta name="twitter:description" content="Exports the WSAPROTOCOL_INFO Structure" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_wsaprotocol_info_export - Manual" />
<meta itemprop="description" content="Exports the WSAPROTOCOL_INFO Structure" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exports the WSAPROTOCOL_INFO Structure" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.socket-wsaprotocol-info-import.php">
          socket_wsaprotocol_info_import &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-write.php">
          &laquo; socket_write        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-wsaprotocol-info-export.php' selected="selected">English</option>
            <option value='de/function.socket-wsaprotocol-info-export.php'>German</option>
            <option value='es/function.socket-wsaprotocol-info-export.php'>Spanish</option>
            <option value='fr/function.socket-wsaprotocol-info-export.php'>French</option>
            <option value='it/function.socket-wsaprotocol-info-export.php'>Italian</option>
            <option value='ja/function.socket-wsaprotocol-info-export.php'>Japanese</option>
            <option value='pt_BR/function.socket-wsaprotocol-info-export.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-wsaprotocol-info-export.php'>Russian</option>
            <option value='tr/function.socket-wsaprotocol-info-export.php'>Turkish</option>
            <option value='uk/function.socket-wsaprotocol-info-export.php'>Ukrainian</option>
            <option value='zh/function.socket-wsaprotocol-info-export.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-wsaprotocol-info-export" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.socket-wsaprotocol-info-export-returnvalues">
  ...
  <p class="para">
   Returns an identifier to be used for the import,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure
  </p>
 </div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.socket-wsaprotocol-info-release.php" class="function" rel="rdfs-seeAlso">socket_wsaprotocol_info_release()</a> - Releases an exported WSAPROTOCOL_INFO Structure</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-wsaprotocol-info-export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-wsaprotocol-info-export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-wsaprotocol-info-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-wsaprotocol-info-export.php">＋<small>add a note</small></a></span>
