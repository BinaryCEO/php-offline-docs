...
<head>
  ...
  <title>PHP: The mysqlnd plugin API - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqlnd.plugin.api.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqlnd.plugin.api.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqlnd.plugin.api.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mysqlnd.plugin.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqlnd.plugin.architecture.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqlnd.plugin.developing.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqlnd.plugin.api.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/mysqlnd.plugin.api.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqlnd.plugin.api.php" hreflang="uk">
...
<meta name="Description" content="The mysqlnd plugin API" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: The mysqlnd plugin API - Manual" />
<meta name="twitter:description" content="The mysqlnd plugin API" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: The mysqlnd plugin API - Manual" />
<meta itemprop="description" content="The mysqlnd plugin API" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The mysqlnd plugin API" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqlnd.plugin.developing.php">
          Getting started building a mysqlnd plugin &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqlnd.plugin.architecture.php">
          &laquo; MySQL Native Driver Plugin Architecture        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqlnd.plugin.api.php' selected="selected">English</option>
            <option value='de/mysqlnd.plugin.api.php'>German</option>
            <option value='es/mysqlnd.plugin.api.php'>Spanish</option>
            <option value='fr/mysqlnd.plugin.api.php'>French</option>
            <option value='it/mysqlnd.plugin.api.php'>Italian</option>
            <option value='ja/mysqlnd.plugin.api.php'>Japanese</option>
            <option value='pt_BR/mysqlnd.plugin.api.php'>Brazilian Portuguese</option>
            <option value='ru/mysqlnd.plugin.api.php'>Russian</option>
            <option value='tr/mysqlnd.plugin.api.php'>Turkish</option>
            <option value='uk/mysqlnd.plugin.api.php'>Ukrainian</option>
            <option value='zh/mysqlnd.plugin.api.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqlnd.plugin.api" class="section">
    ...
    <p class="para">
     ...
     returns to the PHP application. The circle is closed.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqlnd.plugin.api%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqlnd.plugin.api&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqlnd.plugin.api.php">＋<small>add a note</small></a></span>
