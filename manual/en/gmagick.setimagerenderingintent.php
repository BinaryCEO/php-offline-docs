...
<head>
  ...
  <title>PHP: Gmagick::setimagerenderingintent - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagerenderingintent.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagerenderingintent.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagerenderingintent.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimageredprimary.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimageresolution.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagerenderingintent.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimagerenderingintent.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimagerenderingintent.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimagerenderingintent.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimagerenderingintent.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimagerenderingintent.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimagerenderingintent.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimagerenderingintent.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimagerenderingintent.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimagerenderingintent.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimagerenderingintent.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimagerenderingintent - Manual" />
<meta name="twitter:description" content="Sets the image rendering intent" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimagerenderingintent - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.setimageresolution.php">
          Gmagick::setimageresolution &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimageredprimary.php">
          &laquo; Gmagick::setimageredprimary        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagerenderingintent.php' selected="selected">English</option>
            <option value='de/gmagick.setimagerenderingintent.php'>German</option>
            <option value='es/gmagick.setimagerenderingintent.php'>Spanish</option>
            <option value='fr/gmagick.setimagerenderingintent.php'>French</option>
            <option value='it/gmagick.setimagerenderingintent.php'>Italian</option>
            <option value='ja/gmagick.setimagerenderingintent.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimagerenderingintent.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimagerenderingintent.php'>Russian</option>
            <option value='tr/gmagick.setimagerenderingintent.php'>Turkish</option>
            <option value='uk/gmagick.setimagerenderingintent.php'>Ukrainian</option>
            <option value='zh/gmagick.setimagerenderingintent.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimagerenderingintent" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-gmagick.setimagerenderingintent-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimagerenderingintent</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rendering_intent</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimagerenderingintent-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       One of the <a href="gmagick.constants.php#gmagick.constants.renderingintent" class="link">Rendering Intent</a> constant
       (<code class="literal">Gmagick::RENDERINGINTENT_*</code>).
      </p>
     </dd>
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagerenderingintent.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagerenderingintent%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagerenderingintent&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagerenderingintent.php">＋<small>add a note</small></a></span>
