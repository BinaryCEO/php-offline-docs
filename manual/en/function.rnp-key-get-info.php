...
<head>
  ...
  <title>PHP: rnp_key_get_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rnp-key-get-info.php">
 <link rel="shorturl" href="https://www.php.net/rnp-key-get-info">
 <link rel="alternate" href="https://www.php.net/rnp-key-get-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.rnp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.rnp-key-export-revocation.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rnp-key-remove.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rnp-key-get-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rnp-key-get-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rnp-key-get-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rnp-key-get-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rnp-key-get-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rnp-key-get-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rnp-key-get-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rnp-key-get-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rnp-key-get-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rnp-key-get-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rnp-key-get-info.php" hreflang="zh">
...
<meta name="Description" content="Get information about the key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rnp_key_get_info - Manual" />
<meta name="twitter:description" content="Get information about the key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rnp_key_get_info - Manual" />
<meta itemprop="description" content="Get information about the key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get information about the key" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.rnp-key-remove.php">
          rnp_key_remove &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.rnp-key-export-revocation.php">
          &laquo; rnp_key_export_revocation        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rnp-key-get-info.php' selected="selected">English</option>
            <option value='de/function.rnp-key-get-info.php'>German</option>
            <option value='es/function.rnp-key-get-info.php'>Spanish</option>
            <option value='fr/function.rnp-key-get-info.php'>French</option>
            <option value='it/function.rnp-key-get-info.php'>Italian</option>
            <option value='ja/function.rnp-key-get-info.php'>Japanese</option>
            <option value='pt_BR/function.rnp-key-get-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.rnp-key-get-info.php'>Russian</option>
            <option value='tr/function.rnp-key-get-info.php'>Turkish</option>
            <option value='uk/function.rnp-key-get-info.php'>Ukrainian</option>
            <option value='zh/function.rnp-key-get-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rnp-key-get-info" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.rnp-key-get-info-returnvalues">
  ...
  <p class="para">
   An associative array with information about the key or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
    ...
    <tbody class="tbody">
     ...
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/functions/rnp-key-get-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rnp-key-get-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rnp-key-get-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rnp-key-get-info.php">＋<small>add a note</small></a></span>
