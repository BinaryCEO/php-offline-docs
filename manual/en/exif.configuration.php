...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/exif.configuration.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/exif.configuration.php">
 <link rel="alternate" href="https://www.php.net/manual/en/exif.configuration.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/exif.setup.php">
 <link rel="prev" href="https://www.php.net/manual/en/exif.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/exif.constants.php">

 <link rel="alternate" href="https://www.php.net/manual/en/exif.configuration.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/exif.configuration.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/exif.configuration.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/exif.configuration.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/exif.configuration.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/exif.configuration.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/exif.configuration.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/exif.configuration.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/exif.configuration.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/exif.configuration.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/exif.configuration.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/exif.configuration.php' selected="selected">English</option>
            <option value='de/exif.configuration.php'>German</option>
            <option value='es/exif.configuration.php'>Spanish</option>
            <option value='fr/exif.configuration.php'>French</option>
            <option value='it/exif.configuration.php'>Italian</option>
            <option value='ja/exif.configuration.php'>Japanese</option>
            <option value='pt_BR/exif.configuration.php'>Brazilian Portuguese</option>
            <option value='ru/exif.configuration.php'>Russian</option>
            <option value='tr/exif.configuration.php'>Turkish</option>
            <option value='uk/exif.configuration.php'>Ukrainian</option>
            <option value='zh/exif.configuration.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="exif.configuration" class="section">
    ...
    <dd>
     <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/exif/ini.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fexif.configuration%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=exif.configuration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/exif.configuration.php">＋<small>add a note</small></a></span>
