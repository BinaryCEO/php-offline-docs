...
<head>
  ...
  <title>PHP: gnupg_setsignmode - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gnupg-setsignmode.php">
 <link rel="shorturl" href="https://www.php.net/gnupg-setsignmode">
 <link rel="alternate" href="https://www.php.net/gnupg-setsignmode" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gnupg.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gnupg-seterrormode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gnupg-sign.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gnupg-setsignmode.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gnupg-setsignmode.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gnupg-setsignmode.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gnupg-setsignmode.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gnupg-setsignmode.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gnupg-setsignmode.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gnupg-setsignmode.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gnupg-setsignmode.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gnupg-setsignmode.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gnupg-setsignmode.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gnupg-setsignmode.php" hreflang="zh">
...
<meta name="Description" content="Sets the mode for signing" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gnupg_setsignmode - Manual" />
<meta name="twitter:description" content="Sets the mode for signing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gnupg_setsignmode - Manual" />
<meta itemprop="description" content="Sets the mode for signing" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the mode for signing" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gnupg-setsignmode.php' selected="selected">English</option>
            <option value='de/function.gnupg-setsignmode.php'>German</option>
            <option value='es/function.gnupg-setsignmode.php'>Spanish</option>
            <option value='fr/function.gnupg-setsignmode.php'>French</option>
            <option value='it/function.gnupg-setsignmode.php'>Italian</option>
            <option value='ja/function.gnupg-setsignmode.php'>Japanese</option>
            <option value='pt_BR/function.gnupg-setsignmode.php'>Brazilian Portuguese</option>
            <option value='ru/function.gnupg-setsignmode.php'>Russian</option>
            <option value='tr/function.gnupg-setsignmode.php'>Turkish</option>
            <option value='uk/function.gnupg-setsignmode.php'>Ukrainian</option>
            <option value='zh/function.gnupg-setsignmode.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gnupg-setsignmode" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.gnupg-setsignmode-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gnupg_setsignmode</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$signmode</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
<span class="function"><a href="function.gnupg-init.php" class="function">gnupg_init()</a></span> or <span class="classname"><strong class="classname">gnupg</strong></span>.</p>
     ...
     <dt><code class="parameter">sigmode</code></dt>
     <dd>
      <p class="para">
      ...
      <p class="para">
       ...
       <strong><code><a href="gnupg.constants.php#constant.gnupg-sig-mode-detach">GNUPG_SIG_MODE_DETACH</a></code></strong> and
       <strong><code><a href="gnupg.constants.php#constant.gnupg-sig-mode-clear">GNUPG_SIG_MODE_CLEAR</a></code></strong>.
       By default <strong><code><a href="gnupg.constants.php#constant.gnupg-sig-mode-clear">GNUPG_SIG_MODE_CLEAR</a></code></strong> is used.
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.gnupg-setsignmode-examples">
  ...
  <p class="para">
   <div class="example" id="example-3457">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$gpg </span><span style="color: #007700">= new </span><span style="color: #0000BB">gnupg</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$gpg</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setsignmode</span><span style="color: #007700">(</span><span style="color: #0000BB">gnupg</span><span style="color: #007700">::</span><span style="color: #0000BB">SIG_MODE_DETACH</span><span style="color: #007700">); </span><span style="color: #FF8000">// produce a detached signature<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gnupg/functions/gnupg-setsignmode.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gnupg-setsignmode%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gnupg-setsignmode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gnupg-setsignmode.php">＋<small>add a note</small></a></span>
