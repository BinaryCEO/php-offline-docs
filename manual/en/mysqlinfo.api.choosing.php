...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqlinfo.api.choosing.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqlinfo.api.choosing.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqlinfo.api.choosing.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqlinfo.terminology.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqlinfo.library.choosing.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqlinfo.api.choosing.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqlinfo.api.choosing.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqlinfo.api.choosing.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqlinfo.api.choosing.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqlinfo.api.choosing.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqlinfo.api.choosing.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqlinfo.api.choosing.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqlinfo.api.choosing.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqlinfo.api.choosing.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqlinfo.api.choosing.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqlinfo.api.choosing.php" hreflang="zh">
...
<meta name="Description" content="Choosing an API" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Choosing an API - Manual" />
<meta name="twitter:description" content="Choosing an API" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Choosing an API - Manual" />
<meta itemprop="description" content="Choosing an API" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Choosing an API" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/mysqlinfo.api.choosing.php'>Italian</option>
            ...
            <option value='uk/mysqlinfo.api.choosing.php'>Ukrainian</option>
   ...
   <table id="mysqlinfo.api.choosing.changelog" class="doctable informaltable">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqlinfo.api.choosing%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqlinfo.api.choosing&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqlinfo.api.choosing.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="109113">  <div class="votes">
    ...
    <div class="tally" id="V109113" title="52% like this...">
    23
    </div>
  </div>
  <a href="#109113" class="name">
  <strong class="user"><em>alvaro at demogracia dot com</em></strong></a><a class="genanchor" href="#109113"> &para;</a><div class="date" title="2012-06-21 09:29"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109113">
<div class="phpcode"><code><span class="html">Apart from the feature list, I suggest you try out both MySQLi and PDO and find out what API design you like most. MySQLi is more powerful and probably more complex to learn. PDO is more elegant and has the advantage that you only need to learn one PHP API if you need to work with different DBMS in the future.</span></code></div>
  </div>
 </div>
  <div class="note" id="123630">  <div class="votes">
    <div id="Vu123630">
    <a href="/manual/vote-note.php?id=123630&amp;page=mysqlinfo.api.choosing&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123630">
    <a href="/manual/vote-note.php?id=123630&amp;page=mysqlinfo.api.choosing&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123630" title="48% like this...">
    -4
    </div>
  </div>
  <a href="#123630" class="name">
  <strong class="user"><em>rellect at gmail dot com</em></strong></a><a class="genanchor" href="#123630"> &para;</a><div class="date" title="2019-02-20 11:37"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123630">
<div class="phpcode"><code><span class="html">Another point to consider and one of the advantages of PDO is that it's not limited to mysql and supports other database engines such as PostgreSQL, SQLite, etc.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqlinfo.api.choosing&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqlinfo.api.choosing.php">＋<small>add a note</small></a></div>
        ...
        <ul class='parent-menu-list'>
                ...
                <a href="mysql.php">Overview of the MySQL PHP drivers</a>
                                    ...
                                    <ul class='child-menu-list'>
                                                ...
                                                <li class="">
                            <a href="mysqlinfo.intro.php" title="Introduction">Introduction</a>
                        </li>
                                                <li class="">
