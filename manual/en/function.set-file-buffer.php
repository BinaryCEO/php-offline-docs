...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.set-file-buffer.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.rmdir.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stat.php">
...
<meta name="Description" content="Alias of stream_set_write_buffer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: set_file_buffer - Manual" />
<meta name="twitter:description" content="Alias of stream_set_write_buffer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: set_file_buffer - Manual" />
<meta itemprop="description" content="Alias of stream_set_write_buffer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of stream_set_write_buffer" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.set-file-buffer.php' selected="selected">English</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">set_file_buffer</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.stream-set-write-buffer.php" class="function">stream_set_write_buffer()</a></span></span></p>
  ...
  <p class="simpara">
   ...
   <span class="function"><a href="function.stream-set-write-buffer.php" class="function">stream_set_write_buffer()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/set-file-buffer.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.set-file-buffer%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.set-file-buffer&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.set-file-buffer.php">＋<small>add a note</small></a></span>
