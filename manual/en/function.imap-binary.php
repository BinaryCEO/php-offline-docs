...
<head>
  ...
  <title>PHP: imap_binary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-binary.php">
 <link rel="shorturl" href="https://www.php.net/imap-binary">
 <link rel="alternate" href="https://www.php.net/imap-binary" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-base64.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-body.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-binary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-binary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-binary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-binary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-binary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-binary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-binary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-binary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-binary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-binary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-binary.php" hreflang="zh">
...
<meta name="Description" content="Convert an 8bit string to a base64 string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_binary - Manual" />
<meta name="twitter:description" content="Convert an 8bit string to a base64 string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_binary - Manual" />
<meta itemprop="description" content="Convert an 8bit string to a base64 string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Convert an 8bit string to a base64 string" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-binary.php' selected="selected">English</option>
            <option value='de/function.imap-binary.php'>German</option>
            <option value='es/function.imap-binary.php'>Spanish</option>
            <option value='fr/function.imap-binary.php'>French</option>
            <option value='it/function.imap-binary.php'>Italian</option>
            <option value='ja/function.imap-binary.php'>Japanese</option>
            <option value='pt_BR/function.imap-binary.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-binary.php'>Russian</option>
            <option value='tr/function.imap-binary.php'>Turkish</option>
            <option value='uk/function.imap-binary.php'>Ukrainian</option>
            <option value='zh/function.imap-binary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-binary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_binary</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_binary</span> &mdash; <span class="dc-title">Convert an 8bit string to a base64 string</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-binary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_binary</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Convert an 8bit string to a base64 string according to <a href="https://datatracker.ietf.org/doc/html/rfc2045" class="link external">&raquo;&nbsp;RFC2045</a>, Section 6.8.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imap-binary-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-binary-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a base64 encoded string,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>

 <div class="refsect1 seealso" id="refsect1-function.imap-binary-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-base64.php" class="function" rel="rdfs-seeAlso">imap_base64()</a> - Decode BASE64 encoded text</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-binary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-binary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-binary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-binary.php">＋<small>add a note</small></a></span>
