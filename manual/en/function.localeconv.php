...
<head>
  ...
  <title>PHP: localeconv - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.localeconv.php">
 <link rel="shorturl" href="https://www.php.net/localeconv">
 <link rel="alternate" href="https://www.php.net/localeconv" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.strings.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.levenshtein.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ltrim.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.localeconv.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.localeconv.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.localeconv.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.localeconv.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.localeconv.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.localeconv.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.localeconv.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.localeconv.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.localeconv.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.localeconv.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.localeconv.php" hreflang="zh">
...
<meta name="Description" content="Get numeric formatting information" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: localeconv - Manual" />
<meta name="twitter:description" content="Get numeric formatting information" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: localeconv - Manual" />
<meta itemprop="description" content="Get numeric formatting information" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get numeric formatting information" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.localeconv.php' selected="selected">English</option>
            <option value='de/function.localeconv.php'>German</option>
            <option value='es/function.localeconv.php'>Spanish</option>
            <option value='fr/function.localeconv.php'>French</option>
            <option value='it/function.localeconv.php'>Italian</option>
            <option value='ja/function.localeconv.php'>Japanese</option>
            <option value='pt_BR/function.localeconv.php'>Brazilian Portuguese</option>
            <option value='ru/function.localeconv.php'>Russian</option>
            <option value='tr/function.localeconv.php'>Turkish</option>
            <option value='uk/function.localeconv.php'>Ukrainian</option>
            <option value='zh/function.localeconv.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.localeconv" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.setlocale.php" class="function" rel="rdfs-seeAlso">setlocale()</a> - Set locale information</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/localeconv.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.localeconv%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.localeconv&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.localeconv.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="14216">  <div class="votes">
    <div id="Vu14216">
    <a href="/manual/vote-note.php?id=14216&amp;page=function.localeconv&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd14216">
    <a href="/manual/vote-note.php?id=14216&amp;page=function.localeconv&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V14216" title="54% like this...">
    2
    </div>
  </div>
  <a href="#14216" class="name">
  <strong class="user"><em>verdy_p at wanadoo dot fr</em></strong></a><a class="genanchor" href="#14216"> &para;</a><div class="date" title="2001-07-22 07:13"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom14216">
<div class="phpcode"><code><span class="html">The C99 standard modified slightly the definition of the international currency symbol, which is now 4 characters long instead of 3 in previous definitions. The fourth character will most often be an ASCII space, but its effective value is the locale-specific spacing character used for numeric grouping (i.e. the one refered by [sep_by_space] and [grouping])...</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.localeconv&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.localeconv.php">＋<small>add a note</small></a></div>
