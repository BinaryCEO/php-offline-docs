...
<head>
  ...
  <title>PHP: Memcached::prepend - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.prepend.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.prepend.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.prepend.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.ispristine.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.prependbykey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.prepend.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.prepend.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.prepend.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.prepend.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.prepend.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.prepend.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.prepend.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.prepend.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.prepend.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.prepend.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.prepend.php" hreflang="zh">
...
<meta name="Description" content="Prepend data to an existing item" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::prepend - Manual" />
<meta name="twitter:description" content="Prepend data to an existing item" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::prepend - Manual" />
<meta itemprop="description" content="Prepend data to an existing item" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Prepend data to an existing item" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="memcached.prependbykey.php">
          Memcached::prependByKey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.ispristine.php">
          &laquo; Memcached::isPristine        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.prepend.php' selected="selected">English</option>
            <option value='de/memcached.prepend.php'>German</option>
            <option value='es/memcached.prepend.php'>Spanish</option>
            <option value='fr/memcached.prepend.php'>French</option>
            <option value='it/memcached.prepend.php'>Italian</option>
            <option value='ja/memcached.prepend.php'>Japanese</option>
            <option value='pt_BR/memcached.prepend.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.prepend.php'>Russian</option>
            <option value='tr/memcached.prepend.php'>Turkish</option>
            <option value='uk/memcached.prepend.php'>Ukrainian</option>
            <option value='zh/memcached.prepend.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.prepend" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-memcached.prepend-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Memcached::prepend</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::prepend()</strong></span> prepends the given
 ...
 <div class="refsect1 errors" id="refsect1-memcached.prepend-errors">
 ...
 <div class="refsect1 examples" id="refsect1-memcached.prepend-examples">
  ...
  <p class="para">
   <div class="example" id="example-4696">
    <p><strong>Example #1 <span class="function"><strong>Memcached::prepend()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">string(6) &quot;defabc&quot;</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-memcached.prepend-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="memcached.prependbykey.php" class="methodname" rel="rdfs-seeAlso">Memcached::prependByKey()</a> - Prepend data to an existing item on a specific server</span></li>
    <li><span class="methodname"><a href="memcached.append.php" class="methodname" rel="rdfs-seeAlso">Memcached::append()</a> - Append data to an existing item</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/prepend.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.prepend%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.prepend&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.prepend.php">＋<small>add a note</small></a></span>
