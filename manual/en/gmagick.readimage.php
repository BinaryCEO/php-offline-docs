...
<head>
  ...
  <title>PHP: Gmagick::readimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.readimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.readimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.readimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.read.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.readimageblob.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.readimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.readimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.readimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.readimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.readimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.readimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.readimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.readimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.readimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.readimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.readimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::readimage - Manual" />
<meta name="twitter:description" content="Reads image from filename" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::readimage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.readimageblob.php">
          Gmagick::readimageblob &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.read.php">
          &laquo; Gmagick::read        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.readimage.php' selected="selected">English</option>
            <option value='de/gmagick.readimage.php'>German</option>
            <option value='es/gmagick.readimage.php'>Spanish</option>
            <option value='fr/gmagick.readimage.php'>French</option>
            <option value='it/gmagick.readimage.php'>Italian</option>
            <option value='ja/gmagick.readimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.readimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.readimage.php'>Russian</option>
            <option value='tr/gmagick.readimage.php'>Turkish</option>
            <option value='uk/gmagick.readimage.php'>Ukrainian</option>
            <option value='zh/gmagick.readimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.readimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::readimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::readimage</span> &mdash; <span class="dc-title">Reads image from filename</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.readimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::readimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.readimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.readimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.readimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/readimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.readimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.readimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.readimage.php">＋<small>add a note</small></a></span>
