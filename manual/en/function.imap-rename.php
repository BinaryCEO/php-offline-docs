...
<head>
  ...
  <title>PHP: imap_rename - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-rename.php">
 <link rel="shorturl" href="https://www.php.net/imap-rename">
 <link rel="alternate" href="https://www.php.net/imap-rename" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-qprint.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-renamemailbox.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-rename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-rename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-rename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-rename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-rename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-rename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-rename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-rename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-rename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-rename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-rename.php" hreflang="zh">
...
<meta name="Description" content="Alias of imap_renamemailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_rename - Manual" />
<meta name="twitter:description" content="Alias of imap_renamemailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_rename - Manual" />
<meta itemprop="description" content="Alias of imap_renamemailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of imap_renamemailbox" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-rename.php' selected="selected">English</option>
            <option value='de/function.imap-rename.php'>German</option>
            <option value='es/function.imap-rename.php'>Spanish</option>
            <option value='fr/function.imap-rename.php'>French</option>
            <option value='it/function.imap-rename.php'>Italian</option>
            <option value='ja/function.imap-rename.php'>Japanese</option>
            <option value='pt_BR/function.imap-rename.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-rename.php'>Russian</option>
            <option value='tr/function.imap-rename.php'>Turkish</option>
            <option value='uk/function.imap-rename.php'>Ukrainian</option>
            <option value='zh/function.imap-rename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-rename" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_rename</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_rename</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.imap-renamemailbox.php" class="function">imap_renamemailbox()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.imap-rename-description">
  ...
  <p class="simpara">
   ...
   <span class="function"><a href="function.imap-renamemailbox.php" class="function">imap_renamemailbox()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-rename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-rename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-rename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-rename.php">＋<small>add a note</small></a></span>
