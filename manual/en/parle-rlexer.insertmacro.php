...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/parle-rlexer.insertmacro.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/parle-rlexer.insertmacro.php">
 <link rel="alternate" href="https://www.php.net/manual/en/parle-rlexer.insertmacro.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.parle-rlexer.php">
 <link rel="prev" href="https://www.php.net/manual/en/parle-rlexer.gettoken.php">
 <link rel="next" href="https://www.php.net/manual/en/parle-rlexer.push.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/parle-rlexer.insertmacro.php' selected="selected">English</option>
            ...
            <option value='pt_BR/parle-rlexer.insertmacro.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL parle &gt;= 0.5.1)</p><p class="refpurpose"><span class="refname">Parle\RLexer::insertMacro</span> &mdash; <span class="dc-title">Insert regex macro</span></p>
  ...
  <p class="para">
   No value is returned.   
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/parle/parle/rlexer/insertmacro.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fparle-rlexer.insertmacro%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=parle-rlexer.insertmacro&amp;repo=en&amp;redirect=https://www.php.net/manual/en/parle-rlexer.insertmacro.php">＋<small>add a note</small></a></span>
