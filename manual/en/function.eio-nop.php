...
<head>
  ...
  <title>PHP: eio_nop - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-nop.php">
 <link rel="shorturl" href="https://www.php.net/eio-nop">
 <link rel="alternate" href="https://www.php.net/eio-nop" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-mknod.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-npending.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-nop.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-nop.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-nop.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-nop.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-nop.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-nop.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-nop.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-nop.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-nop.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-nop.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-nop.php" hreflang="zh">
...
<meta name="Description" content="Does nothing, except go through the whole request cycle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_nop - Manual" />
<meta name="twitter:description" content="Does nothing, except go through the whole request cycle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_nop - Manual" />
<meta itemprop="description" content="Does nothing, except go through the whole request cycle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Does nothing, except go through the whole request cycle" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-npending.php">
          eio_npending &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-nop.php' selected="selected">English</option>
            <option value='de/function.eio-nop.php'>German</option>
            <option value='es/function.eio-nop.php'>Spanish</option>
            <option value='fr/function.eio-nop.php'>French</option>
            <option value='it/function.eio-nop.php'>Italian</option>
            <option value='ja/function.eio-nop.php'>Japanese</option>
            <option value='pt_BR/function.eio-nop.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-nop.php'>Russian</option>
            <option value='tr/function.eio-nop.php'>Turkish</option>
            <option value='uk/function.eio-nop.php'>Ukrainian</option>
            <option value='zh/function.eio-nop.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-nop" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_nop</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_nop</span> &mdash; <span class="dc-title">Does nothing, except go through the whole request cycle</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-nop-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_nop</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>, <span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>eio_nop()</strong></span> does nothing, except go through the whole
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-nop-parameters">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-nop-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_nop()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>



 <div class="refsect1 seealso" id="refsect1-function.eio-nop-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-busy.php" class="function" rel="rdfs-seeAlso">eio_busy()</a> - Artificially increase load. Could be useful in tests,
  benchmarking</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-nop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-nop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-nop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-nop.php">＋<small>add a note</small></a></span>
