...
<head>
  ...
  <title>PHP: PharData::buildFromDirectory - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phardata.buildfromdirectory.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phardata.buildfromdirectory.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phardata.buildfromdirectory.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phardata.php">
 <link rel="prev" href="https://www.php.net/manual/en/phardata.addfromstring.php">
 <link rel="next" href="https://www.php.net/manual/en/phardata.buildfromiterator.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phardata.buildfromdirectory.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phardata.buildfromdirectory.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phardata.buildfromdirectory.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phardata.buildfromdirectory.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phardata.buildfromdirectory.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phardata.buildfromdirectory.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phardata.buildfromdirectory.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phardata.buildfromdirectory.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phardata.buildfromdirectory.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phardata.buildfromdirectory.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phardata.buildfromdirectory.php" hreflang="zh">
...
<meta name="Description" content="Construct a tar/zip archive from the files within a directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PharData::buildFromDirectory - Manual" />
<meta name="twitter:description" content="Construct a tar/zip archive from the files within a directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PharData::buildFromDirectory - Manual" />
<meta itemprop="description" content="Construct a tar/zip archive from the files within a directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Construct a tar/zip archive from the files within a directory" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phardata.buildfromiterator.php">
          PharData::buildFromIterator &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phardata.addfromstring.php">
          &laquo; PharData::addFromString        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phardata.buildfromdirectory.php' selected="selected">English</option>
            <option value='de/phardata.buildfromdirectory.php'>German</option>
            <option value='es/phardata.buildfromdirectory.php'>Spanish</option>
            <option value='fr/phardata.buildfromdirectory.php'>French</option>
            <option value='it/phardata.buildfromdirectory.php'>Italian</option>
            <option value='ja/phardata.buildfromdirectory.php'>Japanese</option>
            <option value='pt_BR/phardata.buildfromdirectory.php'>Brazilian Portuguese</option>
            <option value='ru/phardata.buildfromdirectory.php'>Russian</option>
            <option value='tr/phardata.buildfromdirectory.php'>Turkish</option>
            <option value='uk/phardata.buildfromdirectory.php'>Ukrainian</option>
            <option value='zh/phardata.buildfromdirectory.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phardata.buildfromdirectory" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-phardata.buildfromdirectory-returnvalues">
  ...
  <p class="para">
   ...
   filesystem,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phardata.buildfromiterator.php" class="function" rel="rdfs-seeAlso">PharData::buildFromIterator()</a> - Construct a tar or zip archive from an iterator</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/PharData/buildFromDirectory.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphardata.buildfromdirectory%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phardata.buildfromdirectory&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.buildfromdirectory.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124287">  <div class="votes">
    <div id="Vu124287">
    <a href="/manual/vote-note.php?id=124287&amp;page=phardata.buildfromdirectory&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124287">
    <a href="/manual/vote-note.php?id=124287&amp;page=phardata.buildfromdirectory&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124287" title="50% like this...">
    0
    </div>
  </div>
  <a href="#124287" class="name">
  <strong class="user"><em>dan</em></strong></a><a class="genanchor" href="#124287"> &para;</a><div class="date" title="2019-10-11 04:43"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124287">
<div class="phpcode"><code><span class="html">buildFromDirectory won't add empty subdirectories on 7.2</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phardata.buildfromdirectory&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.buildfromdirectory.php">＋<small>add a note</small></a></div>
