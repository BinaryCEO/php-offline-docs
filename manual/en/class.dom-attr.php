...
<head>
  ...
  <title>PHP: Dom\Attr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-attr.php">
 <link rel="shorturl" href="https://www.php.net/dom-attr">
 <link rel="alternate" href="https://www.php.net/dom-attr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/enum.dom-adjacentposition.php">
 <link rel="next" href="https://www.php.net/manual/en/dom-attr.isid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-attr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-attr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-attr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-attr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-attr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-attr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-attr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-attr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-attr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-attr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-attr.php" hreflang="zh">
...
<meta name="Description" content="The Dom\Attr class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\Attr - Manual" />
<meta name="twitter:description" content="The Dom\Attr class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\Attr - Manual" />
<meta itemprop="description" content="The Dom\Attr class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\Attr class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-attr.php' selected="selected">English</option>
            <option value='de/class.dom-attr.php'>German</option>
            <option value='es/class.dom-attr.php'>Spanish</option>
            <option value='fr/class.dom-attr.php'>French</option>
            <option value='it/class.dom-attr.php'>Italian</option>
            <option value='ja/class.dom-attr.php'>Japanese</option>
            <option value='pt_BR/class.dom-attr.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-attr.php'>Russian</option>
            <option value='tr/class.dom-attr.php'>Turkish</option>
            <option value='uk/class.dom-attr.php'>Ukrainian</option>
            <option value='zh/class.dom-attr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-attr" class="reference">
 <h1 class="title">The <span class="classname"><a href="class.dom-attr.php" class="classname">Dom\Attr</a></span> class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-attr.intro">
   <h2 class="title">Introduction</h2>
   <p class="simpara">
    <span class="classname"><strong class="classname">Dom\Attr</strong></span> represents an attribute in the
    <span class="classname"><a href="class.dom-element.php" class="classname">Dom\Element</a></span> object.
   </p>
   <p class="simpara">
  ...
  <div class="section" id="dom-attr.synopsis">
   <h2 class="title">Class synopsis</h2>
   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\Attr</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-attr.php#dom-attr.props.namespaceuri">$<var class="varname">namespaceURI</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-attr.php#dom-attr.props.prefix">$<var class="varname">prefix</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-attr.php#dom-attr.props.localname">$<var class="varname">localName</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-attr.php#dom-attr.props.name">$<var class="varname">name</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-attr.php#dom-attr.props.value">$<var class="varname">value</var></a></var>;</div>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type">?</span><span class="type"><span class="type"><a href="class.dom-element.php" class="type Dom\Element">Dom\Element</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-attr.php#dom-attr.props.ownerelement">$<var class="varname">ownerElement</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span>
      <var class="varname"><a href="class.dom-attr.php#dom-attr.props.specified">$<var class="varname">specified</var></a></var>;</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="dom-attr.isid.php" class="methodname">isId</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="dom-attr.rename.php" class="methodname">rename</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$namespaceURI</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$qualifiedName</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="dom-attr.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-attr.props.namespaceuri"><var class="varname">namespaceURI</var></dt>
     <dd>
      <span class="simpara">The namespace <abbr title="Uniform Resource Identifier">URI</abbr> of the attribute.</span>
     </dd>
    
    
     <dt id="dom-attr.props.prefix"><var class="varname">prefix</var></dt>
     <dd>
      <span class="simpara">The namespace prefix of the attribute.</span>
     </dd>
    
    
     <dt id="dom-attr.props.localname"><var class="varname">localName</var></dt>
     <dd>
      <span class="simpara">The local name of the attribute.</span>
     </dd>
    
    
     <dt id="dom-attr.props.name"><var class="varname">name</var></dt>
     <dd>
      <span class="simpara">The qualified name of the attribute.</span>
     </dd>
    
    
     <dt id="dom-attr.props.value"><var class="varname">value</var></dt>
     <dd>
      <span class="simpara">The value of the attribute.</span>
      <blockquote class="note"><p><strong class="note">Note</strong>: 
       <span class="simpara">
        Unlike the equivalent property in <span class="classname"><a href="class.domattr.php" class="classname">DOMAttr</a></span>,
     ...
     <dt id="dom-attr.props.ownerelement"><var class="varname">ownerElement</var></dt>
     <dd>
      <span class="simpara">The element that contains the attribute or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.</span>
     </dd>
    
    
     <dt id="dom-attr.props.specified"><var class="varname">specified</var></dt>
     <dd>
      <span class="simpara">Legacy option, always is <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>.</span>
     </dd>
  ...
  <div class="section">
   ...
   <ul class="simplelist">
    <li><a href="https://dom.spec.whatwg.org/#interface-attr" class="link external">&raquo;&nbsp;WHATWG specification of Attr</a></li>
   </ul>
  </div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="dom-attr.isid.php">Dom\Attr::isId</a> — Checks if attribute is a defined ID</li><li><a href="dom-attr.rename.php">Dom\Attr::rename</a> — Changes the qualified name or namespace of an attribute</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-attr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-attr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-attr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-attr.php">＋<small>add a note</small></a></span>
