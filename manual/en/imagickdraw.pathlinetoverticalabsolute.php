...
<head>
  ...
  <title>PHP: ImagickDraw::pathLineToVerticalAbsolute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pathlinetoverticalabsolute.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pathlinetoverticalabsolute.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathlinetoverticalabsolute.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pathlinetorelative.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pathlinetoverticalrelative.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathlinetoverticalabsolute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pathlinetoverticalabsolute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pathlinetoverticalabsolute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pathlinetoverticalabsolute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pathlinetoverticalabsolute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pathlinetoverticalabsolute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pathlinetoverticalabsolute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pathlinetoverticalabsolute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pathlinetoverticalabsolute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pathlinetoverticalabsolute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pathlinetoverticalabsolute.php" hreflang="zh">
...
<meta name="Description" content="Draws a vertical line" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::pathLineToVerticalAbsolute - Manual" />
<meta name="twitter:description" content="Draws a vertical line" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pathLineToVerticalAbsolute - Manual" />
<meta itemprop="description" content="Draws a vertical line" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws a vertical line" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.pathlinetoverticalrelative.php">
          ImagickDraw::pathLineToVerticalRelative &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pathlinetorelative.php">
          &laquo; ImagickDraw::pathLineToRelative        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pathlinetoverticalabsolute.php' selected="selected">English</option>
            <option value='de/imagickdraw.pathlinetoverticalabsolute.php'>German</option>
            <option value='es/imagickdraw.pathlinetoverticalabsolute.php'>Spanish</option>
            <option value='fr/imagickdraw.pathlinetoverticalabsolute.php'>French</option>
            <option value='it/imagickdraw.pathlinetoverticalabsolute.php'>Italian</option>
            <option value='ja/imagickdraw.pathlinetoverticalabsolute.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pathlinetoverticalabsolute.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pathlinetoverticalabsolute.php'>Russian</option>
            <option value='tr/imagickdraw.pathlinetoverticalabsolute.php'>Turkish</option>
            <option value='uk/imagickdraw.pathlinetoverticalabsolute.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pathlinetoverticalabsolute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pathlinetoverticalabsolute" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pathLineToVerticalAbsolute</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::pathLineToVerticalAbsolute</span> &mdash; <span class="dc-title">Draws a vertical line</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.pathlinetoverticalabsolute-description">
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.pathlinetoverticalabsolute-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.pathlinetoverticalabsolute-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pathlinetoverticalabsolute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pathlinetoverticalabsolute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pathlinetoverticalabsolute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pathlinetoverticalabsolute.php">＋<small>add a note</small></a></span>
