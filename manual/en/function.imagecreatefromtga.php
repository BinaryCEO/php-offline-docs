...
<head>
  ...
  <title>PHP: imagecreatefromtga - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecreatefromtga.php">
 <link rel="shorturl" href="https://www.php.net/imagecreatefromtga">
 <link rel="alternate" href="https://www.php.net/imagecreatefromtga" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecreatefromstring.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecreatefromwbmp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecreatefromtga.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecreatefromtga.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecreatefromtga.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecreatefromtga.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecreatefromtga.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecreatefromtga.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecreatefromtga.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecreatefromtga.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecreatefromtga.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecreatefromtga.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecreatefromtga.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: imagecreatefromtga - Manual" />
<meta name="twitter:description" content="Create a new image from file or URL" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecreatefromtga - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagecreatefromwbmp.php">
          imagecreatefromwbmp &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagecreatefromstring.php">
          &laquo; imagecreatefromstring        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecreatefromtga.php' selected="selected">English</option>
            <option value='de/function.imagecreatefromtga.php'>German</option>
            <option value='es/function.imagecreatefromtga.php'>Spanish</option>
            <option value='fr/function.imagecreatefromtga.php'>French</option>
            <option value='it/function.imagecreatefromtga.php'>Italian</option>
            <option value='ja/function.imagecreatefromtga.php'>Japanese</option>
            <option value='pt_BR/function.imagecreatefromtga.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecreatefromtga.php'>Russian</option>
            <option value='tr/function.imagecreatefromtga.php'>Turkish</option>
            <option value='uk/function.imagecreatefromtga.php'>Ukrainian</option>
            <option value='zh/function.imagecreatefromtga.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecreatefromtga" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagecreatefromtga</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.4.0, PHP 8)</p><p class="refpurpose"><span class="refname">imagecreatefromtga</span> &mdash; <span class="dc-title">Create a new image from file or URL</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagecreatefromtga-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagecreatefromtga</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>): <span class="type"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>imagecreatefromtga()</strong></span> returns an image object
   representing the image obtained from the given filename.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imagecreatefromtga-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagecreatefromtga-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an image object on success, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on errors.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.imagecreatefromtga-changelog">
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecreatefromtga.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecreatefromtga%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecreatefromtga&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecreatefromtga.php">＋<small>add a note</small></a></span>
