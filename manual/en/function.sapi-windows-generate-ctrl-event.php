...
<head>
  ...
  <title>PHP: sapi_windows_generate_ctrl_event - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sapi-windows-generate-ctrl-event.php">
 <link rel="shorturl" href="https://www.php.net/sapi-windows-generate-ctrl-event">
 <link rel="alternate" href="https://www.php.net/sapi-windows-generate-ctrl-event" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.misc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sapi-windows-cp-set.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sapi-windows-set-ctrl-handler.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sapi-windows-generate-ctrl-event.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sapi-windows-generate-ctrl-event.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sapi-windows-generate-ctrl-event.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sapi-windows-generate-ctrl-event.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sapi-windows-generate-ctrl-event.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sapi-windows-generate-ctrl-event.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sapi-windows-generate-ctrl-event.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sapi-windows-generate-ctrl-event.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sapi-windows-generate-ctrl-event.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sapi-windows-generate-ctrl-event.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sapi-windows-generate-ctrl-event.php" hreflang="zh">
...
<meta name="Description" content="Send a CTRL event to another process" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sapi_windows_generate_ctrl_event - Manual" />
<meta name="twitter:description" content="Send a CTRL event to another process" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sapi_windows_generate_ctrl_event - Manual" />
<meta itemprop="description" content="Send a CTRL event to another process" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Send a CTRL event to another process" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sapi-windows-set-ctrl-handler.php">
          sapi_windows_set_ctrl_handler &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sapi-windows-cp-set.php">
          &laquo; sapi_windows_cp_set        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sapi-windows-generate-ctrl-event.php' selected="selected">English</option>
            <option value='de/function.sapi-windows-generate-ctrl-event.php'>German</option>
            <option value='es/function.sapi-windows-generate-ctrl-event.php'>Spanish</option>
            <option value='fr/function.sapi-windows-generate-ctrl-event.php'>French</option>
            <option value='it/function.sapi-windows-generate-ctrl-event.php'>Italian</option>
            <option value='ja/function.sapi-windows-generate-ctrl-event.php'>Japanese</option>
            <option value='pt_BR/function.sapi-windows-generate-ctrl-event.php'>Brazilian Portuguese</option>
            <option value='ru/function.sapi-windows-generate-ctrl-event.php'>Russian</option>
            <option value='tr/function.sapi-windows-generate-ctrl-event.php'>Turkish</option>
            <option value='uk/function.sapi-windows-generate-ctrl-event.php'>Ukrainian</option>
            <option value='zh/function.sapi-windows-generate-ctrl-event.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sapi-windows-generate-ctrl-event" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.sapi-windows-generate-ctrl-event-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sapi_windows_generate_ctrl_event</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$event</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pid</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// forward CTRL+BREAK events to the child process<br /></span><span style="color: #0000BB">sapi_windows_set_ctrl_handler</span><span style="color: #007700">(</span><span style="color: #DD0000">'sapi_windows_generate_ctrl_event'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// create a child process which echoes every second<br /></span><span style="color: #0000BB">$cmd </span><span style="color: #007700">= [</span><span style="color: #DD0000">'php'</span><span style="color: #007700">, </span><span style="color: #DD0000">'-r'</span><span style="color: #007700">, </span><span style="color: #DD0000">'while (true) { echo "I\'m still alive\n"; sleep(1); }'</span><span style="color: #007700">];<br /></span><span style="color: #0000BB">$descspec </span><span style="color: #007700">= array([</span><span style="color: #DD0000">'pipe'</span><span style="color: #007700">, </span><span style="color: #DD0000">'r'</span><span style="color: #007700">], [</span><span style="color: #DD0000">'pipe'</span><span style="color: #007700">, </span><span style="color: #DD0000">'w'</span><span style="color: #007700">], [</span><span style="color: #DD0000">'pipe'</span><span style="color: #007700">, </span><span style="color: #DD0000">'w'</span><span style="color: #007700">]);<br /></span><span style="color: #0000BB">$options </span><span style="color: #007700">= [</span><span style="color: #DD0000">'create_process_group' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">true</span><span style="color: #007700">];<br /></span><span style="color: #0000BB">$proc </span><span style="color: #007700">= </span><span style="color: #0000BB">proc_open</span><span style="color: #007700">(</span><span style="color: #0000BB">$cmd</span><span style="color: #007700">, </span><span style="color: #0000BB">$descspec</span><span style="color: #007700">, </span><span style="color: #0000BB">$pipes</span><span style="color: #007700">, </span><span style="color: #0000BB">null</span><span style="color: #007700">, </span><span style="color: #0000BB">null</span><span style="color: #007700">, </span><span style="color: #0000BB">$options</span><span style="color: #007700">);<br />while (</span><span style="color: #0000BB">true</span><span style="color: #007700">) {<br />    echo </span><span style="color: #0000BB">fgets</span><span style="color: #007700">(</span><span style="color: #0000BB">$pipes</span><span style="color: #007700">[</span><span style="color: #0000BB">1</span><span style="color: #007700">]);<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.sapi-windows-generate-ctrl-event-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.sapi-windows-set-ctrl-handler.php" class="function" rel="rdfs-seeAlso">sapi_windows_set_ctrl_handler()</a> - Set or remove a CTRL event handler</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/misc/functions/sapi-windows-generate-ctrl-event.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sapi-windows-generate-ctrl-event%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sapi-windows-generate-ctrl-event&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sapi-windows-generate-ctrl-event.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125948">  <div class="votes">
    <div id="Vu125948">
    <a href="/manual/vote-note.php?id=125948&amp;page=function.sapi-windows-generate-ctrl-event&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125948">
    <a href="/manual/vote-note.php?id=125948&amp;page=function.sapi-windows-generate-ctrl-event&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125948" title="100% like this...">
    1
    </div>
  </div>
  <a href="#125948" class="name">
  <strong class="user"><em>Michael Q</em></strong></a><a class="genanchor" href="#125948"> &para;</a><div class="date" title="2021-03-22 12:05"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125948">
<div class="phpcode"><code><span class="html">This function may produce a Warning:<br /><br />sapi_windows_set_ctrl_handler(): CTRL events trapping is only supported on console in script.php..<br /><br />It happens when script is started by "php-cgi.exe", so "php.exe -q" should be used instead.<br /><br />While pressing CTRL+C don't expect the handler to run instantly, i've ran some curl request in a loop and found that handler runs when either response arrives or request finishes by timeout.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sapi-windows-generate-ctrl-event&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sapi-windows-generate-ctrl-event.php">＋<small>add a note</small></a></div>
