...
<head>
  ...
  <title>PHP: date_get_last_errors - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-get-last-errors.php">
 <link rel="shorturl" href="https://www.php.net/date-get-last-errors">
 <link rel="alternate" href="https://www.php.net/date-get-last-errors" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-format.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-interval-create-from-date-string.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-get-last-errors.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-get-last-errors.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-get-last-errors.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-get-last-errors.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-get-last-errors.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-get-last-errors.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-get-last-errors.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-get-last-errors.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-get-last-errors.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-get-last-errors.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-get-last-errors.php" hreflang="zh">
...
<meta name="Description" content="Alias of DateTimeImmutable::getLastErrors" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_get_last_errors - Manual" />
<meta name="twitter:description" content="Alias of DateTimeImmutable::getLastErrors" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_get_last_errors - Manual" />
<meta itemprop="description" content="Alias of DateTimeImmutable::getLastErrors" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTimeImmutable::getLastErrors" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.date-interval-create-from-date-string.php">
          date_interval_create_from_date_string &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.date-format.php">
          &laquo; date_format        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-get-last-errors.php' selected="selected">English</option>
            <option value='de/function.date-get-last-errors.php'>German</option>
            <option value='es/function.date-get-last-errors.php'>Spanish</option>
            <option value='fr/function.date-get-last-errors.php'>French</option>
            <option value='it/function.date-get-last-errors.php'>Italian</option>
            <option value='ja/function.date-get-last-errors.php'>Japanese</option>
            <option value='pt_BR/function.date-get-last-errors.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-get-last-errors.php'>Russian</option>
            <option value='tr/function.date-get-last-errors.php'>Turkish</option>
            <option value='uk/function.date-get-last-errors.php'>Ukrainian</option>
            <option value='zh/function.date-get-last-errors.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-get-last-errors" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">date_get_last_errors</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">date_get_last_errors</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetimeimmutable.getlasterrors.php" class="methodname">DateTimeImmutable::getLastErrors()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.date-get-last-errors-description">
  <h3 class="title">Description</h3>
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetimeimmutable.getlasterrors.php" class="methodname">DateTimeImmutable::getLastErrors()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-get-last-errors.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-get-last-errors%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-get-last-errors&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-get-last-errors.php">＋<small>add a note</small></a></span>
