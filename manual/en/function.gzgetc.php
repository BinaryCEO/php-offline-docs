...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gzgetc.php">
 <link rel="shorturl" href="https://www.php.net/gzgetc">
 <link rel="alternate" href="https://www.php.net/gzgetc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.zlib.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gzfile.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gzgets.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gzgetc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gzgetc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gzgetc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gzgetc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gzgetc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gzgetc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gzgetc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gzgetc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gzgetc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gzgetc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gzgetc.php" hreflang="zh">
...
<meta name="Description" content="Get character from gz-file pointer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gzgetc - Manual" />
<meta name="twitter:description" content="Get character from gz-file pointer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gzgetc - Manual" />
<meta itemprop="description" content="Get character from gz-file pointer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get character from gz-file pointer" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gzgetc.php' selected="selected">English</option>
            <option value='de/function.gzgetc.php'>German</option>
            <option value='es/function.gzgetc.php'>Spanish</option>
            <option value='fr/function.gzgetc.php'>French</option>
            <option value='it/function.gzgetc.php'>Italian</option>
            <option value='ja/function.gzgetc.php'>Japanese</option>
            <option value='pt_BR/function.gzgetc.php'>Brazilian Portuguese</option>
            <option value='ru/function.gzgetc.php'>Russian</option>
            <option value='tr/function.gzgetc.php'>Turkish</option>
            <option value='uk/function.gzgetc.php'>Ukrainian</option>
            <option value='zh/function.gzgetc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gzgetc" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.gzgetc-examples">
  ...
  <p class="para">
   <div class="example" id="example-967">
    <p><strong>Example #1 <span class="function"><strong>gzgetc()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.gzgets.php" class="function" rel="rdfs-seeAlso">gzgets()</a> - Get line from file pointer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zlib/functions/gzgetc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gzgetc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gzgetc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gzgetc.php">＋<small>add a note</small></a></span>
