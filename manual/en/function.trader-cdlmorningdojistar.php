...
<head>
  ...
  <title>PHP: trader_cdlmorningdojistar - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-cdlmorningdojistar.php">
 <link rel="shorturl" href="https://www.php.net/trader-cdlmorningdojistar">
 <link rel="alternate" href="https://www.php.net/trader-cdlmorningdojistar" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-cdlmathold.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-cdlmorningstar.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-cdlmorningdojistar.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-cdlmorningdojistar.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-cdlmorningdojistar.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-cdlmorningdojistar.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-cdlmorningdojistar.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-cdlmorningdojistar.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-cdlmorningdojistar.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-cdlmorningdojistar.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-cdlmorningdojistar.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-cdlmorningdojistar.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-cdlmorningdojistar.php" hreflang="zh">
...
<meta name="Description" content="Morning Doji Star" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_cdlmorningdojistar - Manual" />
<meta name="twitter:description" content="Morning Doji Star" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_cdlmorningdojistar - Manual" />
<meta itemprop="description" content="Morning Doji Star" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Morning Doji Star" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-cdlmorningstar.php">
          trader_cdlmorningstar &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-cdlmathold.php">
          &laquo; trader_cdlmathold        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-cdlmorningdojistar.php' selected="selected">English</option>
            <option value='de/function.trader-cdlmorningdojistar.php'>German</option>
            <option value='es/function.trader-cdlmorningdojistar.php'>Spanish</option>
            <option value='fr/function.trader-cdlmorningdojistar.php'>French</option>
            <option value='it/function.trader-cdlmorningdojistar.php'>Italian</option>
            <option value='ja/function.trader-cdlmorningdojistar.php'>Japanese</option>
            <option value='pt_BR/function.trader-cdlmorningdojistar.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-cdlmorningdojistar.php'>Russian</option>
            <option value='tr/function.trader-cdlmorningdojistar.php'>Turkish</option>
            <option value='uk/function.trader-cdlmorningdojistar.php'>Ukrainian</option>
            <option value='zh/function.trader-cdlmorningdojistar.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-cdlmorningdojistar" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_cdlmorningdojistar</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_cdlmorningdojistar</span> &mdash; <span class="dc-title">Morning Doji Star</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-cdlmorningdojistar-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_cdlmorningdojistar</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$open</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$penetration</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-cdlmorningdojistar-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-cdlmorningdojistar-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-cdlmorningdojistar.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-cdlmorningdojistar%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-cdlmorningdojistar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-cdlmorningdojistar.php">＋<small>add a note</small></a></span>
