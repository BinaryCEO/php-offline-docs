...
<head>
  ...
  <title>PHP: imagecolorexactalpha - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecolorexactalpha.php">
 <link rel="shorturl" href="https://www.php.net/imagecolorexactalpha">
 <link rel="alternate" href="https://www.php.net/imagecolorexactalpha" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecolorexact.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecolormatch.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecolorexactalpha.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecolorexactalpha.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecolorexactalpha.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecolorexactalpha.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecolorexactalpha.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecolorexactalpha.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecolorexactalpha.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecolorexactalpha.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecolorexactalpha.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecolorexactalpha.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecolorexactalpha.php" hreflang="zh">
...
<meta name="Description" content="Get the index of the specified color + alpha" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagecolorexactalpha - Manual" />
<meta name="twitter:description" content="Get the index of the specified color + alpha" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecolorexactalpha - Manual" />
<meta itemprop="description" content="Get the index of the specified color + alpha" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the index of the specified color + alpha" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imagecolormatch.php">
          imagecolormatch &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagecolorexact.php">
          &laquo; imagecolorexact        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecolorexactalpha.php' selected="selected">English</option>
            <option value='de/function.imagecolorexactalpha.php'>German</option>
            <option value='es/function.imagecolorexactalpha.php'>Spanish</option>
            <option value='fr/function.imagecolorexactalpha.php'>French</option>
            <option value='it/function.imagecolorexactalpha.php'>Italian</option>
            <option value='ja/function.imagecolorexactalpha.php'>Japanese</option>
            <option value='pt_BR/function.imagecolorexactalpha.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecolorexactalpha.php'>Russian</option>
            <option value='tr/function.imagecolorexactalpha.php'>Turkish</option>
            <option value='uk/function.imagecolorexactalpha.php'>Ukrainian</option>
            <option value='zh/function.imagecolorexactalpha.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecolorexactalpha" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagecolorexactalpha</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagecolorexactalpha</span> &mdash; <span class="dc-title">Get the index of the specified color + alpha</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagecolorexactalpha-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagecolorexactalpha</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$red</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$green</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$blue</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$alpha</code></span><br>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imagecolorexactalpha-parameters">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagecolorexactalpha-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagecolorexactalpha-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.imagecolorexactalpha-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-2847">
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagecolorexactalpha-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagecolorclosestalpha.php" class="function" rel="rdfs-seeAlso">imagecolorclosestalpha()</a> - Get the index of the closest color to the specified color + alpha</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecolorexactalpha.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecolorexactalpha%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecolorexactalpha&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecolorexactalpha.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="54659">  <div class="votes">
    <div id="Vu54659">
    <a href="/manual/vote-note.php?id=54659&amp;page=function.imagecolorexactalpha&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd54659">
    <a href="/manual/vote-note.php?id=54659&amp;page=function.imagecolorexactalpha&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V54659" title="100% like this...">
    1
    </div>
  </div>
  <a href="#54659" class="name">
  <strong class="user"><em>matt at matt-darby dot com</em></strong></a><a class="genanchor" href="#54659"> &para;</a><div class="date" title="2005-07-11 06:09"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom54659">
<div class="phpcode"><code><span class="html">Note that a color allocated with imagecolorexactalpha won't show alpha (it will be opaque) when used with imageline(). Use imagerectangle() set to your normal start and end points instead.<br /><br />Ensure that the image is created via imagecreatetruecolor() as well!</span></code></div>
  </div>
 </div>
  <div class="note" id="26668">  <div class="votes">
    <div id="Vu26668">
    <a href="/manual/vote-note.php?id=26668&amp;page=function.imagecolorexactalpha&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd26668">
    <a href="/manual/vote-note.php?id=26668&amp;page=function.imagecolorexactalpha&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V26668" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#26668" class="name">
  <strong class="user"><em>phpdoc-comment at aditus dot nu</em></strong></a><a class="genanchor" href="#26668"> &para;</a><div class="date" title="2002-11-08 10:01"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom26668">
<div class="phpcode"><code><span class="html">What might be misleading in the docs is that if the specified color + alpha channel does not exist it will be created. So if you like to use an alpha channel in your image enable alpha blending and then create you color using this method.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagecolorexactalpha&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecolorexactalpha.php">＋<small>add a note</small></a></div>
