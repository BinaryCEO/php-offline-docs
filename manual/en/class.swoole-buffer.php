...
<head>
 ...
 <link rel="prev" href="https://www.php.net/manual/en/swoole-atomic.sub.php">
 <link rel="next" href="https://www.php.net/manual/en/swoole-buffer.append.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.swoole-buffer.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.swoole-buffer.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.swoole-buffer.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.swoole-buffer.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.swoole-buffer.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.swoole-buffer.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.swoole-buffer.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.swoole-buffer.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.swoole-buffer.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.swoole-buffer.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.swoole-buffer.php" hreflang="zh">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="swoole-buffer.append.php">Swoole\Buffer::append</a> — Append the string or binary data at the end of the memory buffer and return the new size of memory allocated.</li><li><a href="swoole-buffer.clear.php">Swoole\Buffer::clear</a> — Reset the memory buffer.</li><li><a href="swoole-buffer.construct.php">Swoole\Buffer::__construct</a> — Fixed size memory blocks allocation.</li><li><a href="swoole-buffer.destruct.php">Swoole\Buffer::__destruct</a> — Destruct the Swoole memory buffer.</li><li><a href="swoole-buffer.expand.php">Swoole\Buffer::expand</a> — Expand the size of memory buffer.</li><li><a href="swoole-buffer.read.php">Swoole\Buffer::read</a> — Read data from the memory buffer based on offset and length.</li><li><a href="swoole-buffer.recycle.php">Swoole\Buffer::recycle</a> — Release the memory to OS which is not used by the memory buffer.</li><li><a href="swoole-buffer.substr.php">Swoole\Buffer::substr</a> — Read data from the memory buffer based on offset and length. Or remove data from the memory buffer.</li><li><a href="swoole-buffer.tostring.php">Swoole\Buffer::__toString</a> — Get the string value of the memory buffer.</li><li><a href="swoole-buffer.write.php">Swoole\Buffer::write</a> — Write data to the memory buffer. The memory allocated for the buffer will not be changed.</li></ul>
 ...
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.swoole-buffer&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.swoole-buffer.php">＋<small>add a note</small></a></span>
