...
<head>
  ...
  <title>PHP: SimdJsonValueError - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.simdjsonvalueerror.php">
 <link rel="shorturl" href="https://www.php.net/simdjsonvalueerror">
 <link rel="alternate" href="https://www.php.net/simdjsonvalueerror" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.simdjson.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.simdjsonexception.php">
 <link rel="next" href="https://www.php.net/manual/en/book.lua.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.simdjsonvalueerror.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.simdjsonvalueerror.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.simdjsonvalueerror.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.simdjsonvalueerror.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.simdjsonvalueerror.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.simdjsonvalueerror.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.simdjsonvalueerror.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.simdjsonvalueerror.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.simdjsonvalueerror.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.simdjsonvalueerror.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.simdjsonvalueerror.php" hreflang="zh">
...
<meta name="Description" content="The SimdJsonValueError class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SimdJsonValueError - Manual" />
<meta name="twitter:description" content="The SimdJsonValueError class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SimdJsonValueError - Manual" />
<meta itemprop="description" content="The SimdJsonValueError class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SimdJsonValueError class" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.simdjsonvalueerror.php' selected="selected">English</option>
            <option value='de/class.simdjsonvalueerror.php'>German</option>
            <option value='es/class.simdjsonvalueerror.php'>Spanish</option>
            <option value='fr/class.simdjsonvalueerror.php'>French</option>
            <option value='it/class.simdjsonvalueerror.php'>Italian</option>
            <option value='ja/class.simdjsonvalueerror.php'>Japanese</option>
            <option value='pt_BR/class.simdjsonvalueerror.php'>Brazilian Portuguese</option>
            <option value='ru/class.simdjsonvalueerror.php'>Russian</option>
            <option value='tr/class.simdjsonvalueerror.php'>Turkish</option>
            <option value='uk/class.simdjsonvalueerror.php'>Ukrainian</option>
            <option value='zh/class.simdjsonvalueerror.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.simdjsonvalueerror" class="reference">
 <h1 class="title">The SimdJsonValueError class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PECL simdjson &gt;= 3.0.0)</p>
  ...
  <div class="section" id="simdjsonvalueerror.intro">
   ...
   <p class="para">
    A <span class="classname"><strong class="classname">SimdJsonValueError</strong></span> is thrown when the
    type of an argument to a function from simdjson is correct but the value
    of it is incorrect.
    E.g. when the JSON decoding <var class="varname">$depth</var> is not positive or the <var class="varname">$depth</var> is too large.
   </p>
  </div>
    ...
    <div class="classsynopsisinfo">
     ...
     <span class="ooclass">
      <span class="modifier">extends</span>
       <a href="class.valueerror.php" class="classname">ValueError</a>
     </span>
     {</div>
...
<div class="fieldsynopsis"><span class="modifier">private</span>
   ...
   <span class="modifier">final</span> <span class="modifier">public</span> <span class="methodname"><a href="error.getmessage.php" class="methodname">Error::getMessage</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      <tr>
       <td>PHP 8.0.0</td>
       <td>
        <span class="classname"><strong class="classname">SimdJsonValueError</strong></span> extends <span class="classname"><a href="class.valueerror.php" class="classname">ValueError</a></span>
        now instead of <span class="classname"><a href="class.error.php" class="classname">Error</a></span>.
       </td>
      </tr>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/simdjson/simdjsonvalueerror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.simdjsonvalueerror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.simdjsonvalueerror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.simdjsonvalueerror.php">＋<small>add a note</small></a></span>
