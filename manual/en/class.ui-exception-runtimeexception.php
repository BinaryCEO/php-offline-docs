...
<head>
  ...
  <title>PHP: UI\Exception\RuntimeException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-exception-runtimeexception.php">
 <link rel="shorturl" href="https://www.php.net/ui-exception-runtimeexception">
 <link rel="alternate" href="https://www.php.net/ui-exception-runtimeexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.ui-exception-invalidargumentexception.php">
 <link rel="next" href="https://www.php.net/manual/en/faq.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-exception-runtimeexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-exception-runtimeexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-exception-runtimeexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-exception-runtimeexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-exception-runtimeexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-exception-runtimeexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-exception-runtimeexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-exception-runtimeexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-exception-runtimeexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-exception-runtimeexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-exception-runtimeexception.php" hreflang="zh">
...
<meta name="Description" content="RuntimeException" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Exception\RuntimeException - Manual" />
<meta name="twitter:description" content="RuntimeException" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Exception\RuntimeException - Manual" />
<meta itemprop="description" content="RuntimeException" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="RuntimeException" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.ui-exception-invalidargumentexception.php">
          &laquo; UI\Exception\InvalidArgumentException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-exception-runtimeexception.php' selected="selected">English</option>
            <option value='de/class.ui-exception-runtimeexception.php'>German</option>
            <option value='es/class.ui-exception-runtimeexception.php'>Spanish</option>
            <option value='fr/class.ui-exception-runtimeexception.php'>French</option>
            <option value='it/class.ui-exception-runtimeexception.php'>Italian</option>
            <option value='ja/class.ui-exception-runtimeexception.php'>Japanese</option>
            <option value='pt_BR/class.ui-exception-runtimeexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-exception-runtimeexception.php'>Russian</option>
            <option value='tr/class.ui-exception-runtimeexception.php'>Turkish</option>
            <option value='uk/class.ui-exception-runtimeexception.php'>Ukrainian</option>
            <option value='zh/class.ui-exception-runtimeexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-exception-runtimeexception" class="reference">

 <h1 class="title">RuntimeException</h1>
 

 <div class="partintro"><p class="verinfo">(UI 1.0.3)</p>


  <div class="section" id="ui-exception-runtimeexception.intro">
  ...
  <div class="section" id="ui-exception-runtimeexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Exception\RuntimeException</strong>
     </span>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.exception.runtimeexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-exception-runtimeexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-exception-runtimeexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-exception-runtimeexception.php">＋<small>add a note</small></a></span>
