...
<head>
  ...
  <title>PHP: Imagick::getFont - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getfont.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getfont.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getfont.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getfilename.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getformat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getfont.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getfont.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getfont.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getfont.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getfont.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getfont.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getfont.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getfont.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getfont.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getfont.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getfont.php" hreflang="zh">
...
<meta name="Description" content="Gets font" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getFont - Manual" />
<meta name="twitter:description" content="Gets font" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getFont - Manual" />
<meta itemprop="description" content="Gets font" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets font" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getformat.php">
          Imagick::getFormat &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getfilename.php">
          &laquo; Imagick::getFilename        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getfont.php' selected="selected">English</option>
            <option value='de/imagick.getfont.php'>German</option>
            <option value='es/imagick.getfont.php'>Spanish</option>
            <option value='fr/imagick.getfont.php'>French</option>
            <option value='it/imagick.getfont.php'>Italian</option>
            <option value='ja/imagick.getfont.php'>Japanese</option>
            <option value='pt_BR/imagick.getfont.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getfont.php'>Russian</option>
            <option value='tr/imagick.getfont.php'>Turkish</option>
            <option value='uk/imagick.getfont.php'>Ukrainian</option>
            <option value='zh/imagick.getfont.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getfont" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getFont</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.1.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getFont</span> &mdash; <span class="dc-title">Gets font</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getfont-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getFont</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getfont-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getfont-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the string containing the font name or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not font is set.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-imagick.getfont-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.setfont.php" class="function" rel="rdfs-seeAlso">Imagick::setFont()</a> - Sets font</span></li>
    ...
    <li><span class="function"><a href="imagickdraw.getfont.php" class="function" rel="rdfs-seeAlso">ImagickDraw::getFont()</a> - Returns the font</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getfont.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getfont%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getfont&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getfont.php">＋<small>add a note</small></a></span>
