...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration83.deprecated.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration83.deprecated.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration83.deprecated.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration83.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration83.incompatible.php">
 <link rel="next" href="https://www.php.net/manual/en/migration83.other-changes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration83.deprecated.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration83.deprecated.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration83.deprecated.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration83.deprecated.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration83.deprecated.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration83.deprecated.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration83.deprecated.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration83.deprecated.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration83.deprecated.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration83.deprecated.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration83.deprecated.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration83.deprecated.php' selected="selected">English</option>
            <option value='de/migration83.deprecated.php'>German</option>
            <option value='es/migration83.deprecated.php'>Spanish</option>
            <option value='fr/migration83.deprecated.php'>French</option>
            <option value='it/migration83.deprecated.php'>Italian</option>
            <option value='ja/migration83.deprecated.php'>Japanese</option>
            <option value='pt_BR/migration83.deprecated.php'>Brazilian Portuguese</option>
            <option value='ru/migration83.deprecated.php'>Russian</option>
            <option value='tr/migration83.deprecated.php'>Turkish</option>
            <option value='uk/migration83.deprecated.php'>Ukrainian</option>
            <option value='zh/migration83.deprecated.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration83.deprecated" class="sect1">
  ...
  <p class="para">
   ...
   and will be removed in a future version of libzip.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration83/deprecated.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration83.deprecated%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration83.deprecated&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration83.deprecated.php">＋<small>add a note</small></a></span>
