...
<head>
  ...
  <title>PHP: gmp_scan0 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-scan0.php">
 <link rel="shorturl" href="https://www.php.net/gmp-scan0">
 <link rel="alternate" href="https://www.php.net/gmp-scan0" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-rootrem.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-scan1.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-scan0.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-scan0.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-scan0.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-scan0.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-scan0.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-scan0.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-scan0.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-scan0.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-scan0.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-scan0.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-scan0.php" hreflang="zh">
...
<meta name="Description" content="Scan for 0" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_scan0 - Manual" />
<meta name="twitter:description" content="Scan for 0" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_scan0 - Manual" />
<meta itemprop="description" content="Scan for 0" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Scan for 0" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.gmp-scan1.php">
          gmp_scan1 &raquo;
              ...
              <div class="prev">
        <a href="function.gmp-rootrem.php">
          &laquo; gmp_rootrem        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-scan0.php' selected="selected">English</option>
            <option value='de/function.gmp-scan0.php'>German</option>
            <option value='es/function.gmp-scan0.php'>Spanish</option>
            <option value='fr/function.gmp-scan0.php'>French</option>
            <option value='it/function.gmp-scan0.php'>Italian</option>
            <option value='ja/function.gmp-scan0.php'>Japanese</option>
            <option value='pt_BR/function.gmp-scan0.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-scan0.php'>Russian</option>
            <option value='tr/function.gmp-scan0.php'>Turkish</option>
            <option value='uk/function.gmp-scan0.php'>Ukrainian</option>
            <option value='zh/function.gmp-scan0.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-scan0" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_scan0</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_scan0</span> &mdash; <span class="dc-title">Scan for 0</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-scan0-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_scan0</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num1</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$start</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gmp-scan0-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-scan0-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the index of the found bit, as an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>. The
   index starts from 0.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.gmp-scan0-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3347">
    <p><strong>Example #1 <span class="function"><strong>gmp_scan0()</strong></span> example</strong></p>
...
7</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-scan0.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-scan0%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-scan0&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-scan0.php">＋<small>add a note</small></a></span>
