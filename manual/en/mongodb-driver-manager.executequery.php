...
<head>
  ...
  <title>PHP: MongoDB\Driver\Manager::executeQuery - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-manager.executequery.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-manager.executequery.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.executequery.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-manager.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-manager.executecommand.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-manager.executereadcommand.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.executequery.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-manager.executequery.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-manager.executequery.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-manager.executequery.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-manager.executequery.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-manager.executequery.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-manager.executequery.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-manager.executequery.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-manager.executequery.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-manager.executequery.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-manager.executequery.php" hreflang="zh">
...
<meta name="Description" content="Execute a database query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Manager::executeQuery - Manual" />
<meta name="twitter:description" content="Execute a database query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Manager::executeQuery - Manual" />
<meta itemprop="description" content="Execute a database query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Execute a database query" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mongodb-driver-manager.executereadcommand.php">
          MongoDB\Driver\Manager::executeReadCommand &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-manager.executecommand.php">
          &laquo; MongoDB\Driver\Manager::executeCommand        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-manager.executequery.php' selected="selected">English</option>
            <option value='de/mongodb-driver-manager.executequery.php'>German</option>
            <option value='es/mongodb-driver-manager.executequery.php'>Spanish</option>
            <option value='fr/mongodb-driver-manager.executequery.php'>French</option>
            <option value='it/mongodb-driver-manager.executequery.php'>Italian</option>
            <option value='ja/mongodb-driver-manager.executequery.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-manager.executequery.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-manager.executequery.php'>Russian</option>
            <option value='tr/mongodb-driver-manager.executequery.php'>Turkish</option>
            <option value='uk/mongodb-driver-manager.executequery.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-manager.executequery.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-manager.executequery" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-mongodb-driver-manager.executequery-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">final</span> <span class="modifier">public</span> <span class="methodname"><strong>MongoDB\Driver\Manager::executeQuery</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$namespace</code></span>, <span class="methodparam"><span class="type"><a href="class.mongodb-driver-query.php" class="type MongoDB\Driver\Query">MongoDB\Driver\Query</a></span> <code class="parameter">$query</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.array.php" class="type array">array</a></span></span> <code class="parameter">$options</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="class.mongodb-driver-cursor.php" class="type MongoDB\Driver\Cursor">MongoDB\Driver\Cursor</a></span></div>
  ...
  <p class="para">
   Default values for the <code class="literal">&quot;readPreference&quot;</code> option and Query&#039;s
   <code class="literal">&quot;readConcern&quot;</code> option will be inferred from an active
 ...
 <div class="refsect1 parameters" id="refsect1-mongodb-driver-manager.executequery-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">query</code> (<span class="classname"><a href="class.mongodb-driver-query.php" class="classname">MongoDB\Driver\Query</a></span>)</dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 errors" id="refsect1-mongodb-driver-manager.executequery-errors">
  ...
  <ul class="simplelist">
   ...
   <li>Throws <span class="classname"><a href="class.mongodb-driver-exception-runtimeexception.php" class="classname">MongoDB\Driver\Exception\RuntimeException</a></span> on other errors (e.g. invalid query operators).</li>
  </ul>
 </div>
...
<div class="examplescode"><pre class="examplescode">object(stdClass)#6 (1) {
  [&quot;x&quot;]=&gt;
  int(3)
}
object(stdClass)#7 (1) {
  ...
  <div class="example" id="example-1402">
   ...
   <div class="example-contents"><p>
    ...
    <span class="classname"><a href="class.mongodb-driver-query.php" class="classname">MongoDB\Driver\Query</a></span> option may be used to limit the
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$manager </span><span style="color: #007700">= new </span><span style="color: #0000BB">MongoDB\Driver\Manager</span><span style="color: #007700">(</span><span style="color: #DD0000">'mongodb://localhost:27017'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$filter </span><span style="color: #007700">= [</span><span style="color: #DD0000">'x' </span><span style="color: #007700">=&gt; [</span><span style="color: #DD0000">'$gt' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1</span><span style="color: #007700">]];<br /></span><span style="color: #0000BB">$options </span><span style="color: #007700">= [<br />    </span><span style="color: #DD0000">'maxTimeMS' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1000</span><span style="color: #007700">,<br />];<br /><br /></span><span style="color: #0000BB">$query </span><span style="color: #007700">= new </span><span style="color: #0000BB">MongoDB\Driver\Query</span><span style="color: #007700">(</span><span style="color: #0000BB">$filter</span><span style="color: #007700">, </span><span style="color: #0000BB">$options</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$cursor </span><span style="color: #007700">= </span><span style="color: #0000BB">$manager</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">executeQuery</span><span style="color: #007700">(</span><span style="color: #DD0000">'db.collection'</span><span style="color: #007700">, </span><span style="color: #0000BB">$query</span><span style="color: #007700">);<br /><br />foreach (</span><span style="color: #0000BB">$cursor </span><span style="color: #007700">as </span><span style="color: #0000BB">$document</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$document</span><span style="color: #007700">);<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-mongodb-driver-manager.executequery-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.mongodb-driver-query.php" class="classname">MongoDB\Driver\Query</a></span></li>
   <li><span class="classname"><a href="class.mongodb-driver-readpreference.php" class="classname">MongoDB\Driver\ReadPreference</a></span></li>
   <li><span class="function"><a href="mongodb-driver-server.executequery.php" class="function" rel="rdfs-seeAlso">MongoDB\Driver\Server::executeQuery()</a> - Execute a database query on this server</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/manager/executequery.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-manager.executequery%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-manager.executequery&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-manager.executequery.php">＋<small>add a note</small></a></span>
