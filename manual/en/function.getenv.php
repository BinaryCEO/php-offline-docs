...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.getenv.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.get-resources.php">
 <link rel="next" href="https://www.php.net/manual/en/function.getlastmod.php">
...
<meta name="Description" content="Gets the value of a single or all environment variables" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: getenv - Manual" />
<meta name="twitter:description" content="Gets the value of a single or all environment variables" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: getenv - Manual" />
<meta itemprop="description" content="Gets the value of a single or all environment variables" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the value of a single or all environment variables" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.getenv.php' selected="selected">English</option>
            <option value='de/function.getenv.php'>German</option>
            <option value='es/function.getenv.php'>Spanish</option>
   ...
   <ul class="simplelist">
    ...
    <li><a href="language.variables.superglobals.php" class="link">Superglobals</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/getenv.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.getenv%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.getenv&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getenv.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Contrary to what eng.mrkto.com said, getenv() isn't always case-insensitive. On Linux it is not:<br /><br /><span class="default">&lt;?php<br />var_dump</span><span class="keyword">(</span><span class="default">getenv</span><span class="keyword">(</span><span class="string">'path'</span><span class="keyword">)); </span><span class="comment">// bool(false)<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">getenv</span><span class="keyword">(</span><span class="string">'Path'</span><span class="keyword">)); </span><span class="comment">// bool(false)<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">getenv</span><span class="keyword">(</span><span class="string">'PATH'</span><span class="keyword">)); </span><span class="comment">// string(13) "/usr/bin:/bin"</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">As noted on httpoxy.org, getenv() can confuse you in having you believe that all variables come from a "safe" environment (not all of them do).<br /><br />In particular, $_SERVER['HTTP_PROXY'] (or its equivalent getenv('HTTP_PROXY')) can be manually set in the HTTP request header, so it should not be considered safe in a CGI environment.<br /><br />In short, try to avoid using getenv('HTTP_PROXY') without properly filtering it.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">All of the notes and examples so far have been strictly CGI.<br />It should not be understated the usefulness of getenv()/putenv() in CLI as well.<br /><br />You can pass a number of variables to a CLI script via environment variables, either in Unix/Linux bash/sh with the "VAR='foo'; export $VAR" paradigm, or in Windows with the "set VAR='foo'" paradigm. (Csh users, you're on your own!) getenv("VAR") will retrieve that value from the environment.<br /><br />We have a system by which we include a file full of putenv() statements storing configuration values that can apply to many different CLI PHP programs. But if we want to override these values, we can use the shell's (or calling application, such as ant) environment variable setting method to do so.<br /><br />This saves us from having to manage an unmanageable amount of one-off configuration changes per execution via command line arguments; instead we just set the appropriate env var first.</span></code></div>
  ...
  <div class="note" id="99134">  <div class="votes">
    ...
    <div class="tally" id="V99134" title="57% like this...">
    23
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">This function is useful (compared to $_SERVER, $_ENV) because it searches $varname key in those array case-insensitive manner.<br />For example on Windows $_SERVER['Path'] is like you see Capitalized, not 'PATH' as you expected.<br />So just: <span class="default">&lt;?php getenv</span><span class="keyword">(</span><span class="string">'path'</span><span class="keyword">) </span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>jcastromail at yahoo dot es</em></strong></a><a class="genanchor" href="#125403"> &para;</a><div class="date" title="2020-09-30 08:45"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125403">
<div class="phpcode"><code><span class="html">I did a benchmark about env.<br /><br />constants : <br />0.00067687034606934 ms<br />getenv : <br />0.056761026382446 ms<br /><br />(less is better)<br /><br /><a href="https://github.com/eftec/php-benchmarks#define--const--env" rel="nofollow" target="_blank">https://github.com/eftec/php-benchmarks#define--const--env</a><br /><br />And, in Windows at leat, reading the env value is considerably slow (in comparison with a constant), so PHP doesn't cache the information and asks to the OS the env value per call.<br /><br />So, if you are calling once per request, then there is not a problem. However, if you are calling it many times per request, then it could affects the performance.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">As you know, getenv('DOCUMENT_ROOT') is useful.<br />However, under CLI environment(I tend to do quick check<br />if it works or not), it doesn't work without modified php.ini<br />file. So I add "export DOCUMENT_ROOT=~" in my .bash_profile.</span></code></div>
  </div>
 </div>
  <div class="note" id="123833">  <div class="votes">
    ...
    <div class="tally" id="V123833" title="53% like this...">
    2
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">It is worth noting that since getenv('MY_VARIABLE') will return false when the variable given is not set, there is no direct way to distinguish between a variable that is unset and one that is explicitly set to the value bool(false) when using getenv().  <br />This makes it somewhat tricky to have boolean environment variables default to true if unset, which you can work around either by using "falsy" values such as 0 with the strict comparison operators or by using the superglobal arrays and isset().</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">for quick check of getenv() adding a new env variable -<br />if you add a new env variable, make sure not only apache but xampp is also restarted.<br />Otherwise getenv() will return false for the newly added env variable.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">SERVER_NAME is the name defined in the apache configuration.<br />HTTP_HOST is the host header sent by the client when using the more recent versions of the http protocol.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Beware that when using this function with PHP built-in server – i.e. php -S localhost:8000 – it will return boolean FALSE.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">From PHP 7.1 =&gt; getenv() no longer requires its parameter. If the parameter is omitted, then the current environment variables will be returned as an associative array.<br /><br />Source: <a href="http://php.net/manual/en/migration71.changed-functions.php" rel="nofollow" target="_blank">http://php.net/manual/en/migration71.changed-functions.php</a></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">When writing CLI applications, not that any environment variables that are set in your web server config will not be passed through.  PHP will pass through system environment variables that are prefixed based off the safe_mode_allowed_env_vars directive in your php.ini</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.getenv&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getenv.php">＋<small>add a note</small></a></div>
