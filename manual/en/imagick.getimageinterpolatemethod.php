...
<head>
  ...
  <title>PHP: Imagick::getImageInterpolateMethod - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageinterpolatemethod.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageinterpolatemethod.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageinterpolatemethod.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageinterlacescheme.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageiterations.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageinterpolatemethod.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageinterpolatemethod.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageinterpolatemethod.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageinterpolatemethod.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageinterpolatemethod.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageinterpolatemethod.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageinterpolatemethod.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageinterpolatemethod.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageinterpolatemethod.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageinterpolatemethod.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageinterpolatemethod.php" hreflang="zh">
...
<meta name="Description" content="Returns the interpolation method" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageInterpolateMethod - Manual" />
<meta name="twitter:description" content="Returns the interpolation method" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageInterpolateMethod - Manual" />
<meta itemprop="description" content="Returns the interpolation method" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the interpolation method" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimageiterations.php">
          Imagick::getImageIterations &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageinterlacescheme.php">
          &laquo; Imagick::getImageInterlaceScheme        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageinterpolatemethod.php' selected="selected">English</option>
            <option value='de/imagick.getimageinterpolatemethod.php'>German</option>
            <option value='es/imagick.getimageinterpolatemethod.php'>Spanish</option>
            <option value='fr/imagick.getimageinterpolatemethod.php'>French</option>
            <option value='it/imagick.getimageinterpolatemethod.php'>Italian</option>
            <option value='ja/imagick.getimageinterpolatemethod.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageinterpolatemethod.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageinterpolatemethod.php'>Russian</option>
            <option value='tr/imagick.getimageinterpolatemethod.php'>Turkish</option>
            <option value='uk/imagick.getimageinterpolatemethod.php'>Ukrainian</option>
            <option value='zh/imagick.getimageinterpolatemethod.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageinterpolatemethod" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageInterpolateMethod</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageInterpolateMethod</span> &mdash; <span class="dc-title">Returns the interpolation method</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimageinterpolatemethod-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageInterpolateMethod</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Returns the interpolation method for the specified image. The method is one of 
   the <strong><code><a href="imagick.constants.php#imagick.constants.interpolate-undefined">Imagick::INTERPOLATE_<span class="replaceable">*</span></a></code></strong> constants.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.getimageinterpolatemethod-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageinterpolatemethod-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimageinterpolatemethod-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageinterpolatemethod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageinterpolatemethod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageinterpolatemethod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageinterpolatemethod.php">＋<small>add a note</small></a></span>
