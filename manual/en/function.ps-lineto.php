...
<head>
  ...
  <title>PHP: ps_lineto - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-lineto.php">
 <link rel="shorturl" href="https://www.php.net/ps-lineto">
 <link rel="alternate" href="https://www.php.net/ps-lineto" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-include-file.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-makespotcolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-lineto.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-lineto.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-lineto.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-lineto.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-lineto.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-lineto.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-lineto.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-lineto.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-lineto.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-lineto.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-lineto.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ps_lineto - Manual" />
<meta name="twitter:description" content="Draws a line" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_lineto - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-makespotcolor.php">
          ps_makespotcolor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-include-file.php">
          &laquo; ps_include_file        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-lineto.php' selected="selected">English</option>
            <option value='de/function.ps-lineto.php'>German</option>
            <option value='es/function.ps-lineto.php'>Spanish</option>
            <option value='fr/function.ps-lineto.php'>French</option>
            <option value='it/function.ps-lineto.php'>Italian</option>
            <option value='ja/function.ps-lineto.php'>Japanese</option>
            <option value='pt_BR/function.ps-lineto.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-lineto.php'>Russian</option>
            <option value='tr/function.ps-lineto.php'>Turkish</option>
            <option value='uk/function.ps-lineto.php'>Ukrainian</option>
            <option value='zh/function.ps-lineto.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-lineto" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_lineto</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_lineto</span> &mdash; <span class="dc-title">Draws a line</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-lineto-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_lineto</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Adds a straight line from the current point to the given coordinates to the
   current path. Use <span class="function"><a href="function.ps-moveto.php" class="function">ps_moveto()</a></span> to set the starting point
   of the line.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-lineto-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-lineto-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$ps </span><span style="color: #007700">= </span><span style="color: #0000BB">ps_new</span><span style="color: #007700">();<br />if (!</span><span style="color: #0000BB">ps_open_file</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"rectangle.ps"</span><span style="color: #007700">)) {<br />  print </span><span style="color: #DD0000">"Cannot open PostScript file\n"</span><span style="color: #007700">;<br />  exit;<br />}<br /><br /></span><span style="color: #0000BB">ps_set_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Creator"</span><span style="color: #007700">, </span><span style="color: #DD0000">"rectangle.php"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_set_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Author"</span><span style="color: #007700">, </span><span style="color: #DD0000">"Uwe Steinmann"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_set_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Title"</span><span style="color: #007700">, </span><span style="color: #DD0000">"Lineto example"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">ps_begin_page</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">596</span><span style="color: #007700">, </span><span style="color: #0000BB">842</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_moveto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_lineto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_lineto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_lineto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_lineto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_stroke</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_end_page</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">ps_delete</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-lineto-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-moveto.php" class="function" rel="rdfs-seeAlso">ps_moveto()</a> - Sets current point</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-lineto.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-lineto%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-lineto&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-lineto.php">＋<small>add a note</small></a></span>
