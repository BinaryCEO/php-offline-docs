...
<head>
  ...
  <title>PHP: fann_create_standard - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-create-standard.php">
 <link rel="shorturl" href="https://www.php.net/fann-create-standard">
 <link rel="alternate" href="https://www.php.net/fann-create-standard" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-create-sparse-array.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-create-standard-array.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-create-standard.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-create-standard.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-create-standard.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-create-standard.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-create-standard.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-create-standard.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-create-standard.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-create-standard.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-create-standard.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-create-standard.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-create-standard.php" hreflang="zh">
...
<meta name="Description" content="Creates a standard fully connected backpropagation neural network" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_create_standard - Manual" />
<meta name="twitter:description" content="Creates a standard fully connected backpropagation neural network" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_create_standard - Manual" />
<meta itemprop="description" content="Creates a standard fully connected backpropagation neural network" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a standard fully connected backpropagation neural network" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-create-standard-array.php">
          fann_create_standard_array &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-create-sparse-array.php">
          &laquo; fann_create_sparse_array        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-create-standard.php' selected="selected">English</option>
            <option value='de/function.fann-create-standard.php'>German</option>
            <option value='es/function.fann-create-standard.php'>Spanish</option>
            <option value='fr/function.fann-create-standard.php'>French</option>
            <option value='it/function.fann-create-standard.php'>Italian</option>
            <option value='ja/function.fann-create-standard.php'>Japanese</option>
            <option value='pt_BR/function.fann-create-standard.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-create-standard.php'>Russian</option>
            <option value='tr/function.fann-create-standard.php'>Turkish</option>
            <option value='uk/function.fann-create-standard.php'>Ukrainian</option>
            <option value='zh/function.fann-create-standard.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-create-standard" class="refentry">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-create-standard-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-create-standard-array.php" class="function" rel="rdfs-seeAlso">fann_create_standard_array()</a> - Creates a standard fully connected backpropagation neural network using an array of layer sizes</span></li>
    ...
    <li><span class="function"><a href="function.fann-create-shortcut.php" class="function" rel="rdfs-seeAlso">fann_create_shortcut()</a> - Creates a standard backpropagation neural network which is not fully connectected and has shortcut connections</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-create-standard.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-create-standard%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-create-standard&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-create-standard.php">＋<small>add a note</small></a></span>
