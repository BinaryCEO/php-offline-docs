...
<head>
  ...
  <title>PHP: ImagickDraw::getClipRule - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getcliprule.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getcliprule.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getcliprule.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getclippath.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getclipunits.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getcliprule.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getcliprule.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getcliprule.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getcliprule.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getcliprule.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getcliprule.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getcliprule.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getcliprule.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getcliprule.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getcliprule.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getcliprule.php" hreflang="zh">
...
<meta name="Description" content="Returns the current polygon fill rule" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getClipRule - Manual" />
<meta name="twitter:description" content="Returns the current polygon fill rule" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getClipRule - Manual" />
<meta itemprop="description" content="Returns the current polygon fill rule" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the current polygon fill rule" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.getclipunits.php">
          ImagickDraw::getClipUnits &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getclippath.php">
          &laquo; ImagickDraw::getClipPath        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getcliprule.php' selected="selected">English</option>
            <option value='de/imagickdraw.getcliprule.php'>German</option>
            <option value='es/imagickdraw.getcliprule.php'>Spanish</option>
            <option value='fr/imagickdraw.getcliprule.php'>French</option>
            <option value='it/imagickdraw.getcliprule.php'>Italian</option>
            <option value='ja/imagickdraw.getcliprule.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getcliprule.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getcliprule.php'>Russian</option>
            <option value='tr/imagickdraw.getcliprule.php'>Turkish</option>
            <option value='uk/imagickdraw.getcliprule.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getcliprule.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getcliprule" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getClipRule</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getClipRule</span> &mdash; <span class="dc-title">Returns the current polygon fill rule</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getcliprule-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getClipRule</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getcliprule-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a <a href="imagick.constants.php#imagick.constants.fillrule" class="link">FILLRULE</a> constant
   (<code class="literal">imagick::FILLRULE_*</code>). 
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getcliprule.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getcliprule%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getcliprule&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getcliprule.php">＋<small>add a note</small></a></span>
