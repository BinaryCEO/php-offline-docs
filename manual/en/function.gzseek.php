...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gzseek.php">
 <link rel="shorturl" href="https://www.php.net/gzseek">
 <link rel="alternate" href="https://www.php.net/gzseek" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.zlib.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gzrewind.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gztell.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gzseek.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gzseek.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gzseek.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gzseek.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gzseek.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gzseek.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gzseek.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gzseek.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gzseek.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gzseek.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gzseek.php" hreflang="zh">
...
<meta name="Description" content="Seek on a gz-file pointer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gzseek - Manual" />
<meta name="twitter:description" content="Seek on a gz-file pointer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gzseek - Manual" />
<meta itemprop="description" content="Seek on a gz-file pointer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Seek on a gz-file pointer" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gzseek.php' selected="selected">English</option>
            <option value='de/function.gzseek.php'>German</option>
            <option value='es/function.gzseek.php'>Spanish</option>
            <option value='fr/function.gzseek.php'>French</option>
            <option value='it/function.gzseek.php'>Italian</option>
            <option value='ja/function.gzseek.php'>Japanese</option>
            <option value='pt_BR/function.gzseek.php'>Brazilian Portuguese</option>
            <option value='ru/function.gzseek.php'>Russian</option>
            <option value='tr/function.gzseek.php'>Turkish</option>
            <option value='uk/function.gzseek.php'>Ukrainian</option>
            <option value='zh/function.gzseek.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gzseek" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gzseek</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gzseek</span> &mdash; <span class="dc-title">Seek on a gz-file pointer</span></p>
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      ...
      <p class="para">
       If <code class="parameter">whence</code> is not specified, it is assumed to be
 ...
 <div class="refsect1 seealso" id="refsect1-function.gzseek-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.gzrewind.php" class="function" rel="rdfs-seeAlso">gzrewind()</a> - Rewind the position of a gz-file pointer</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zlib/functions/gzseek.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gzseek%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gzseek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gzseek.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110357">  <div class="votes">
    <div id="Vu110357">
    <a href="/manual/vote-note.php?id=110357&amp;page=function.gzseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110357">
    <a href="/manual/vote-note.php?id=110357&amp;page=function.gzseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110357" title="no votes...">
    0
    </div>
  </div>
  <a href="#110357" class="name">
  <strong class="user"><em>liuhaifeng at example dot com</em></strong></a><a class="genanchor" href="#110357"> &para;</a><div class="date" title="2012-10-15 05:43"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110357">
<div class="phpcode"><code><span class="html">Since seek after the end is not considered an error, I doubt that "while (gzseek ($fh, $eof) == 0) $eof += $d;" will get into infinite loop.</span></code></div>
  </div>
 </div>
  <div class="note" id="51831">  <div class="votes">
    <div id="Vu51831">
    <a href="/manual/vote-note.php?id=51831&amp;page=function.gzseek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd51831">
    <a href="/manual/vote-note.php?id=51831&amp;page=function.gzseek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V51831" title="no votes...">
    0
    </div>
  </div>
  <a href="#51831" class="name">
  <strong class="user"><em>dperham at wgate dot com</em></strong></a><a class="genanchor" href="#51831"> &para;</a><div class="date" title="2005-04-12 08:47"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom51831">
<div class="phpcode"><code><span class="html">PHP/4.3.9<br />contrary to the notes, gzseek() returns -1 if I try to seek past the end of the file.  here is a function that will return the last seekable position, and put the file pointer there.<br /><br />/** sets the file pointer at the end of the file<br /> *  and returns the number of bytes in the file.<br /> */<br />function gzend($fh)<br />{<br />   $d   = 1&lt;&lt;14;<br />   $eof = $d;<br />   while ( gzseek($fh, $eof) == 0 ) $eof += $d;<br />   while ( $d &gt; 1 )<br />   {<br />      $d &gt;&gt;= 1;<br />      $eof += $d * (gzseek($fh, $eof)? -1 : 1);<br />   }<br />   return $eof;<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.gzseek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gzseek.php">＋<small>add a note</small></a></div>
