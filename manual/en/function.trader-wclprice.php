...
<head>
  ...
  <title>PHP: trader_wclprice - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-wclprice.php">
 <link rel="shorturl" href="https://www.php.net/trader-wclprice">
 <link rel="alternate" href="https://www.php.net/trader-wclprice" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-var.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-willr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-wclprice.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-wclprice.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-wclprice.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-wclprice.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-wclprice.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-wclprice.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-wclprice.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-wclprice.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-wclprice.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-wclprice.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-wclprice.php" hreflang="zh">
...
<meta name="Description" content="Weighted Close Price" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_wclprice - Manual" />
<meta name="twitter:description" content="Weighted Close Price" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_wclprice - Manual" />
<meta itemprop="description" content="Weighted Close Price" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Weighted Close Price" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-willr.php">
          trader_willr &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-wclprice.php' selected="selected">English</option>
            <option value='de/function.trader-wclprice.php'>German</option>
            <option value='es/function.trader-wclprice.php'>Spanish</option>
            <option value='fr/function.trader-wclprice.php'>French</option>
            <option value='it/function.trader-wclprice.php'>Italian</option>
            <option value='ja/function.trader-wclprice.php'>Japanese</option>
            <option value='pt_BR/function.trader-wclprice.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-wclprice.php'>Russian</option>
            <option value='tr/function.trader-wclprice.php'>Turkish</option>
            <option value='uk/function.trader-wclprice.php'>Ukrainian</option>
            <option value='zh/function.trader-wclprice.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-wclprice" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_wclprice</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_wclprice</span> &mdash; <span class="dc-title">Weighted Close Price</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-wclprice-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_wclprice</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-wclprice-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-wclprice-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-wclprice.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-wclprice%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-wclprice&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-wclprice.php">＋<small>add a note</small></a></span>
