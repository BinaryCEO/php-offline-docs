...
<head>
  ...
  <title>PHP: socket_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-close.php">
 <link rel="shorturl" href="https://www.php.net/socket-close">
 <link rel="alternate" href="https://www.php.net/socket-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-clear-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-cmsg-space.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-close.php" hreflang="zh">
...
<meta name="Description" content="Closes a Socket instance" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_close - Manual" />
<meta name="twitter:description" content="Closes a Socket instance" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_close - Manual" />
<meta itemprop="description" content="Closes a Socket instance" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Closes a Socket instance" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.socket-cmsg-space.php">
          socket_cmsg_space &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-clear-error.php">
          &laquo; socket_clear_error        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-close.php' selected="selected">English</option>
            <option value='de/function.socket-close.php'>German</option>
            <option value='es/function.socket-close.php'>Spanish</option>
            <option value='fr/function.socket-close.php'>French</option>
            <option value='it/function.socket-close.php'>Italian</option>
            <option value='ja/function.socket-close.php'>Japanese</option>
            <option value='pt_BR/function.socket-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-close.php'>Russian</option>
            <option value='tr/function.socket-close.php'>Turkish</option>
            <option value='uk/function.socket-close.php'>Ukrainian</option>
            <option value='zh/function.socket-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">socket_close</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_close</span> &mdash; <span class="dc-title">Closes a <span class="classname"><a href="class.socket.php" class="classname">Socket</a></span> instance</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.socket-close-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>socket_close()</strong></span> closes the <span class="classname"><a href="class.socket.php" class="classname">Socket</a></span> instance
   given by <code class="parameter">socket</code>.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.socket-strerror.php" class="function" rel="rdfs-seeAlso">socket_strerror()</a> - Return a string describing a socket error</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-close.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120928">  <div class="votes">
    <div id="Vu120928">
    <a href="/manual/vote-note.php?id=120928&amp;page=function.socket-close&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120928">
    <a href="/manual/vote-note.php?id=120928&amp;page=function.socket-close&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120928" title="83% like this...">
    4
    </div>
  </div>
  <a href="#120928" class="name">
  <strong class="user"><em>yaBliznyk at gmail dot com</em></strong></a><a class="genanchor" href="#120928"> &para;</a><div class="date" title="2017-04-04 10:46"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120928">
<div class="phpcode"><code><span class="html">/* any code */<br />$linger = array ('l_linger' =&gt; 0, 'l_onoff' =&gt; 1);<br />socket_set_option($socket, SOL_SOCKET, SO_LINGER, $linger);<br />socket_close($sock);<br /><br />This is code to force close socket connection.</span></code></div>
  </div>
 </div>
  <div class="note" id="66810">  <div class="votes">
    <div id="Vu66810">
    <a href="/manual/vote-note.php?id=66810&amp;page=function.socket-close&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd66810">
    <a href="/manual/vote-note.php?id=66810&amp;page=function.socket-close&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V66810" title="58% like this...">
    2
    </div>
  </div>
  <a href="#66810" class="name">
  <strong class="user"><em>aeolianmeson at NOSPAM dot blitzeclipse dot com</em></strong></a><a class="genanchor" href="#66810"> &para;</a><div class="date" title="2006-05-29 10:24"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom66810">
<div class="phpcode"><code><span class="html">PHP: 5.1.4<br />Summary: close() does not relinquish socket immediately.<br /><br />With the BSD socket implementation (which is the socket interface used by PHP), a socket_close() may close the socket, but there may yet be data to send. Until the data is sent, the port will not be available. Therefore, all further bindings attempted on that port will not be acceptable due to the 'port can not be reused' (the approximate message, anyway) error. Ordinarily, if the REUSABLE socket option is set, the only thing that will raise such an error is a binding to a specific IP/PORT combination that is already bound.<br /><br />To avoid this problem, you must tell it to delay returning until the port either sends the rest of its data, or times-out in doing it. This is done via the SO_LINGER option. To set this option, it requires an array of two elements: the first indicates whether a linger is required on any data before the shutdown completes, and the second indicates whether we actually linger. If we set a nonzero to the first while setting a zero to the second, we would simply drop whatever data is waiting in the buffer, and close the socket. To tell it simply to wait on the data to be sent, you send a non-zero for both: array(1, 1).<br /><br />Note that if you have indicated not to block (socket_set_nonblock()), it will simply exit no matter what, much like it usually would. In this case it bursts an EWOULDWAIT flag, but since I don't think we have access to these socket flags in PHP, one should re-enable blocking right before they set the linger and quit.<br /><br />    // These commands get fed straight through to the Unix socket libraries.. That's why they're a little more C-like.<br />    $arrOpt = array('l_onoff' =&gt; 1, 'l_linger' =&gt; 1);<br />    socket_set_block($this-&gt;Socket);<br />    socket_set_option($this-&gt;Socket, SOL_SOCKET, SO_LINGER, $arrOpt);<br />    socket_close($this-&gt;Socket);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.socket-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-close.php">＋<small>add a note</small></a></div>
