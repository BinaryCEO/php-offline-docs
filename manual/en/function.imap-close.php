...
<head>
  ...
  <title>PHP: imap_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-close.php">
 <link rel="shorturl" href="https://www.php.net/imap-close">
 <link rel="alternate" href="https://www.php.net/imap-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-clearflag-full.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-create.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-close.php" hreflang="zh">
...
<meta name="Description" content="Close an IMAP stream" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_close - Manual" />
<meta name="twitter:description" content="Close an IMAP stream" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_close - Manual" />
<meta itemprop="description" content="Close an IMAP stream" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close an IMAP stream" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-close.php' selected="selected">English</option>
            <option value='de/function.imap-close.php'>German</option>
            <option value='es/function.imap-close.php'>Spanish</option>
            <option value='fr/function.imap-close.php'>French</option>
            <option value='it/function.imap-close.php'>Italian</option>
            <option value='ja/function.imap-close.php'>Japanese</option>
            <option value='pt_BR/function.imap-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-close.php'>Russian</option>
            <option value='tr/function.imap-close.php'>Turkish</option>
            <option value='uk/function.imap-close.php'>Ukrainian</option>
            <option value='zh/function.imap-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_close</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_close</span> &mdash; <span class="dc-title">Close an IMAP stream</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-close-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_close</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imap-close-parameters">
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
     ...
     <dd>
      <p class="para">
       If set to <strong><code><a href="imap.constants.php#constant.cl-expunge">CL_EXPUNGE</a></code></strong>, the function will silently
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-close-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-function.imap-close-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imap-close-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-close-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-open.php" class="function" rel="rdfs-seeAlso">imap_open()</a> - Open an IMAP stream to a mailbox</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-close.php">＋<small>add a note</small></a></span>
