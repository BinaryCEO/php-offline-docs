...
<head>
  ...
  <title>PHP: SolrQuery::setFacetEnumCacheMinDefaultFrequency - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setfacetenumcachemindefaultfrequency.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setfacetenumcachemindefaultfrequency.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetenumcachemindefaultfrequency.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setfacetdatestart.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setfacetlimit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetenumcachemindefaultfrequency.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setfacetenumcachemindefaultfrequency.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setfacetenumcachemindefaultfrequency.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setfacetenumcachemindefaultfrequency.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setfacetenumcachemindefaultfrequency.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setfacetenumcachemindefaultfrequency.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setfacetenumcachemindefaultfrequency.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setfacetenumcachemindefaultfrequency.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setfacetenumcachemindefaultfrequency.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setfacetenumcachemindefaultfrequency.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setfacetenumcachemindefaultfrequency.php" hreflang="zh">
...
<meta name="Description" content="Sets the minimum document frequency used for determining term count" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setFacetEnumCacheMinDefaultFrequency - Manual" />
<meta name="twitter:description" content="Sets the minimum document frequency used for determining term count" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setFacetEnumCacheMinDefaultFrequency - Manual" />
<meta itemprop="description" content="Sets the minimum document frequency used for determining term count" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the minimum document frequency used for determining term count" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setfacetlimit.php">
          SolrQuery::setFacetLimit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setfacetdatestart.php">
          &laquo; SolrQuery::setFacetDateStart        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setfacetenumcachemindefaultfrequency.php' selected="selected">English</option>
            <option value='de/solrquery.setfacetenumcachemindefaultfrequency.php'>German</option>
            <option value='es/solrquery.setfacetenumcachemindefaultfrequency.php'>Spanish</option>
            <option value='fr/solrquery.setfacetenumcachemindefaultfrequency.php'>French</option>
            <option value='it/solrquery.setfacetenumcachemindefaultfrequency.php'>Italian</option>
            <option value='ja/solrquery.setfacetenumcachemindefaultfrequency.php'>Japanese</option>
            <option value='pt_BR/solrquery.setfacetenumcachemindefaultfrequency.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setfacetenumcachemindefaultfrequency.php'>Russian</option>
            <option value='tr/solrquery.setfacetenumcachemindefaultfrequency.php'>Turkish</option>
            <option value='uk/solrquery.setfacetenumcachemindefaultfrequency.php'>Ukrainian</option>
            <option value='zh/solrquery.setfacetenumcachemindefaultfrequency.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setfacetenumcachemindefaultfrequency" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setFacetEnumCacheMinDefaultFrequency</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setFacetEnumCacheMinDefaultFrequency</span> &mdash; <span class="dc-title">Sets the minimum document frequency used for determining term count</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setfacetenumcachemindefaultfrequency-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setFacetEnumCacheMinDefaultFrequency</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$frequency</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setfacetenumcachemindefaultfrequency-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setfacetenumcachemindefaultfrequency-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setfacetenumcachemindefaultfrequency.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setfacetenumcachemindefaultfrequency%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setfacetenumcachemindefaultfrequency&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setfacetenumcachemindefaultfrequency.php">＋<small>add a note</small></a></span>
