...
<head>
  ...
  <title>PHP: ibase_blob_echo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-blob-echo.php">
 <link rel="shorturl" href="https://www.php.net/ibase-blob-echo">
 <link rel="alternate" href="https://www.php.net/ibase-blob-echo" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-blob-create.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-blob-get.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-blob-echo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-blob-echo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-blob-echo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-blob-echo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-blob-echo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-blob-echo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-blob-echo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-blob-echo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-blob-echo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-blob-echo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-blob-echo.php" hreflang="zh">
...
<meta name="Description" content="Output blob contents to browser" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_blob_echo - Manual" />
<meta name="twitter:description" content="Output blob contents to browser" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_blob_echo - Manual" />
<meta itemprop="description" content="Output blob contents to browser" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Output blob contents to browser" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-blob-get.php">
          ibase_blob_get &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-blob-create.php">
          &laquo; ibase_blob_create        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-blob-echo.php' selected="selected">English</option>
            <option value='de/function.ibase-blob-echo.php'>German</option>
            <option value='es/function.ibase-blob-echo.php'>Spanish</option>
            <option value='fr/function.ibase-blob-echo.php'>French</option>
            <option value='it/function.ibase-blob-echo.php'>Italian</option>
            <option value='ja/function.ibase-blob-echo.php'>Japanese</option>
            <option value='pt_BR/function.ibase-blob-echo.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-blob-echo.php'>Russian</option>
            <option value='tr/function.ibase-blob-echo.php'>Turkish</option>
            <option value='uk/function.ibase-blob-echo.php'>Ukrainian</option>
            <option value='zh/function.ibase-blob-echo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-blob-echo" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_blob_echo</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_blob_echo</span> &mdash; <span class="dc-title">Output blob contents to browser</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-blob-echo-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_blob_echo</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$blob_id</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <div class="methodsynopsis dc-description"><span class="methodname"><strong>ibase_blob_echo</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$link_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$blob_id</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ibase-blob-echo-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-blob-echo-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-blob-echo-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-blob-get.php" class="function" rel="rdfs-seeAlso">ibase_blob_get()</a> - Get len bytes data from open blob</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-blob-echo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-blob-echo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-blob-echo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-blob-echo.php">＋<small>add a note</small></a></span>
