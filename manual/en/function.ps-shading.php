...
<head>
  ...
  <title>PHP: ps_shading - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-shading.php">
 <link rel="shorturl" href="https://www.php.net/ps-shading">
 <link rel="alternate" href="https://www.php.net/ps-shading" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-setpolydash.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-shading-pattern.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-shading.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-shading.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-shading.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-shading.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-shading.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-shading.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-shading.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-shading.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-shading.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-shading.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-shading.php" hreflang="zh">
...
<meta name="Description" content="Creates a shading for later use" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_shading - Manual" />
<meta name="twitter:description" content="Creates a shading for later use" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_shading - Manual" />
<meta itemprop="description" content="Creates a shading for later use" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a shading for later use" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-shading-pattern.php">
          ps_shading_pattern &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-setpolydash.php">
          &laquo; ps_setpolydash        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-shading.php' selected="selected">English</option>
            <option value='de/function.ps-shading.php'>German</option>
            <option value='es/function.ps-shading.php'>Spanish</option>
            <option value='fr/function.ps-shading.php'>French</option>
            <option value='it/function.ps-shading.php'>Italian</option>
            <option value='ja/function.ps-shading.php'>Japanese</option>
            <option value='pt_BR/function.ps-shading.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-shading.php'>Russian</option>
            <option value='tr/function.ps-shading.php'>Turkish</option>
            <option value='uk/function.ps-shading.php'>Ukrainian</option>
            <option value='zh/function.ps-shading.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-shading" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ps-shading-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_shading</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$type</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x0</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y0</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$c1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$c2</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$c3</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$c4</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$optlist</code></span><br>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Creates a shading, which can be used by <span class="function"><a href="function.ps-shfill.php" class="function">ps_shfill()</a></span> or
   <span class="function"><a href="function.ps-shading-pattern.php" class="function">ps_shading_pattern()</a></span>.
  </p>
  <p class="para">
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-shading-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The type of shading can be either <code class="literal">radial</code> or
       <code class="literal">axial</code>. Each shading starts with the current fill
       ...
       (see <span class="function"><a href="function.ps-setcolor.php" class="function">ps_setcolor()</a></span> for their meaning).
      </p>
     </dd>
    
    
     <dt><code class="parameter">x0, x1, y0, y1</code></dt>
     <dd>
      <p class="para">
       ...
       <code class="literal">radial</code> the two points are the middle points of
       a starting and ending circle.
      </p>
     </dd>
    
    
     <dt><code class="parameter">c1, c2, c3, c4</code></dt>
     <dd>
      <p class="para">
       See <span class="function"><a href="function.ps-setcolor.php" class="function">ps_setcolor()</a></span> for their meaning.
      </p>
     ...
     <dd>
      <p class="para">
       If the shading is of type <code class="literal">radial</code> the
       <code class="parameter">optlist</code> must also contain the parameters
       <code class="literal">r0</code> and <code class="literal">r1</code> with the radius of the
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-shading-returnvalues">
  ...
  <p class="para">
   Returns the identifier of the pattern  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-shfill.php" class="function" rel="rdfs-seeAlso">ps_shfill()</a> - Fills an area with a shading</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-shading.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-shading%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-shading&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-shading.php">＋<small>add a note</small></a></span>
