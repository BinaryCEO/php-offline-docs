...
<head>
  ...
  <title>PHP: posix_getgroups - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-getgroups.php">
 <link rel="shorturl" href="https://www.php.net/posix-getgroups">
 <link rel="alternate" href="https://www.php.net/posix-getgroups" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-getgrnam.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-getlogin.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-getgroups.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-getgroups.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-getgroups.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-getgroups.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-getgroups.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-getgroups.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-getgroups.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-getgroups.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-getgroups.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-getgroups.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-getgroups.php" hreflang="zh">
...
<meta name="Description" content="Return the group set of the current process" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_getgroups - Manual" />
<meta name="twitter:description" content="Return the group set of the current process" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_getgroups - Manual" />
<meta itemprop="description" content="Return the group set of the current process" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the group set of the current process" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.posix-getlogin.php">
          posix_getlogin &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.posix-getgrnam.php">
          &laquo; posix_getgrnam        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-getgroups.php' selected="selected">English</option>
            <option value='de/function.posix-getgroups.php'>German</option>
            <option value='es/function.posix-getgroups.php'>Spanish</option>
            <option value='fr/function.posix-getgroups.php'>French</option>
            <option value='it/function.posix-getgroups.php'>Italian</option>
            <option value='ja/function.posix-getgroups.php'>Japanese</option>
            <option value='pt_BR/function.posix-getgroups.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-getgroups.php'>Russian</option>
            <option value='tr/function.posix-getgroups.php'>Turkish</option>
            <option value='uk/function.posix-getgroups.php'>Ukrainian</option>
            <option value='zh/function.posix-getgroups.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-getgroups" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">posix_getgroups</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_getgroups</span> &mdash; <span class="dc-title">Return the group set of the current process</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.posix-getgroups-returnvalues">
  ...
  <p class="para">
   ...
   set of the current process,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.posix-getgroups-examples">
  ...
  <p class="para">
   <div class="example" id="example-3581">
    <p><strong>Example #1 Example use of <span class="function"><strong>posix_getgroups()</strong></span></strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.posix-getgrgid.php" class="function" rel="rdfs-seeAlso">posix_getgrgid()</a> - Return info about a group by group id</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-getgroups.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-getgroups%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-getgroups&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getgroups.php">＋<small>add a note</small></a></span>
