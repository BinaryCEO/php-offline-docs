...
<head>
  ...
  <title>PHP: Imagick::setImageVirtualPixelMethod - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagevirtualpixelmethod.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagevirtualpixelmethod.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagevirtualpixelmethod.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageunits.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagewhitepoint.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagevirtualpixelmethod.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagevirtualpixelmethod.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagevirtualpixelmethod.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagevirtualpixelmethod.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagevirtualpixelmethod.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagevirtualpixelmethod.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagevirtualpixelmethod.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagevirtualpixelmethod.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagevirtualpixelmethod.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagevirtualpixelmethod.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagevirtualpixelmethod.php" hreflang="zh">
...
<meta name="Description" content="Sets the image virtual pixel method" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageVirtualPixelMethod - Manual" />
<meta name="twitter:description" content="Sets the image virtual pixel method" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageVirtualPixelMethod - Manual" />
<meta itemprop="description" content="Sets the image virtual pixel method" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image virtual pixel method" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimagewhitepoint.php">
          Imagick::setImageWhitePoint &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageunits.php">
          &laquo; Imagick::setImageUnits        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagevirtualpixelmethod.php' selected="selected">English</option>
            <option value='de/imagick.setimagevirtualpixelmethod.php'>German</option>
            <option value='es/imagick.setimagevirtualpixelmethod.php'>Spanish</option>
            <option value='fr/imagick.setimagevirtualpixelmethod.php'>French</option>
            <option value='it/imagick.setimagevirtualpixelmethod.php'>Italian</option>
            <option value='ja/imagick.setimagevirtualpixelmethod.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagevirtualpixelmethod.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagevirtualpixelmethod.php'>Russian</option>
            <option value='tr/imagick.setimagevirtualpixelmethod.php'>Turkish</option>
            <option value='uk/imagick.setimagevirtualpixelmethod.php'>Ukrainian</option>
            <option value='zh/imagick.setimagevirtualpixelmethod.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagevirtualpixelmethod" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageVirtualPixelMethod</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageVirtualPixelMethod</span> &mdash; <span class="dc-title">Sets the image virtual pixel method</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagevirtualpixelmethod-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageVirtualPixelMethod</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$method</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagevirtualpixelmethod-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagevirtualpixelmethod-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagevirtualpixelmethod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagevirtualpixelmethod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagevirtualpixelmethod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagevirtualpixelmethod.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121448">  <div class="votes">
    <div id="Vu121448">
    <a href="/manual/vote-note.php?id=121448&amp;page=imagick.setimagevirtualpixelmethod&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121448">
    <a href="/manual/vote-note.php?id=121448&amp;page=imagick.setimagevirtualpixelmethod&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121448" title="75% like this...">
    2
    </div>
  </div>
  <a href="#121448" class="name">
  <strong class="user"><em>m dot junaidahmad at outlook dot com</em></strong></a><a class="genanchor" href="#121448"> &para;</a><div class="date" title="2017-07-28 06:10"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121448">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br />  $im </span><span class="keyword">= new </span><span class="default">\Imagick</span><span class="keyword">();<br /><br />        </span><span class="comment">/* read image (914x784)*/<br />   <br />     </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'DOCUMENT_ROOT'</span><span class="keyword">].</span><span class="string">"/pathtoimage/"</span><span class="keyword">.</span><span class="default">$inputfront</span><span class="keyword">);<br />        <br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageBackgroundColor</span><span class="keyword">(new </span><span class="default">\ImagickPixel</span><span class="keyword">(</span><span class="string">'transparent'</span><span class="keyword">));  </span><span class="comment">/* sets backgound to none (transparent) */<br /><br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageVirtualPixelMethod</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">); </span><span class="comment">/* this is equal to -virtual-pixel background (in imagemagick) */<br />      <br /><br />   /* Control points for the distortion */<br /><br />        </span><span class="default">$controlPoints </span><span class="keyword">= array( </span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,<br />            </span><span class="default">280</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,<br /><br />            </span><span class="default">994</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,<br />            </span><span class="default">914</span><span class="keyword">,</span><span class="default">50</span><span class="keyword">,<br /><br />            </span><span class="default">994</span><span class="keyword">,</span><span class="default">862</span><span class="keyword">,<br />            </span><span class="default">784</span><span class="keyword">,</span><span class="default">842</span><span class="keyword">,<br /><br />            </span><span class="default">0</span><span class="keyword">,</span><span class="default">862</span><span class="keyword">,<br />            </span><span class="default">110</span><span class="keyword">,</span><span class="default">762</span><span class="keyword">);<br /><br />        </span><span class="comment">/* Perform the distortion */<br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">(</span><span class="default">\Imagick</span><span class="keyword">::</span><span class="default">DISTORTION_PERSPECTIVE</span><span class="keyword">, </span><span class="default">$controlPoints</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /><br />        </span><span class="comment">/* Ouput the image */<br />        </span><span class="default">$output_front_distort</span><span class="keyword">=</span><span class="string">"Projects/"</span><span class="keyword">.</span><span class="default">$userid</span><span class="keyword">.</span><span class="string">"/"</span><span class="keyword">.</span><span class="default">$projectid</span><span class="keyword">.</span><span class="string">"/distorted_book.png"</span><span class="keyword">;<br />    <br />       </span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: image/png"</span><span class="keyword">);<br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'DOCUMENT_ROOT'</span><span class="keyword">].</span><span class="string">"/designerr/public/"</span><span class="keyword">.</span><span class="default">$output_front_distort</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimagevirtualpixelmethod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagevirtualpixelmethod.php">＋<small>add a note</small></a></div>
