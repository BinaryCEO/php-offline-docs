...
<head>
  ...
  <title>PHP: ocicollmax - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocicollmax.php">
 <link rel="shorturl" href="https://www.php.net/ocicollmax">
 <link rel="alternate" href="https://www.php.net/ocicollmax" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocicollgetelem.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocicollsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocicollmax.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocicollmax.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocicollmax.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocicollmax.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocicollmax.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocicollmax.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocicollmax.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocicollmax.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocicollmax.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocicollmax.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocicollmax.php" hreflang="zh">
...
<meta name="Description" content="Alias of OCICollection::max" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocicollmax - Manual" />
<meta name="twitter:description" content="Alias of OCICollection::max" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocicollmax - Manual" />
<meta itemprop="description" content="Alias of OCICollection::max" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of OCICollection::max" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocicollmax.php' selected="selected">English</option>
            <option value='de/function.ocicollmax.php'>German</option>
            <option value='es/function.ocicollmax.php'>Spanish</option>
            <option value='fr/function.ocicollmax.php'>French</option>
            <option value='it/function.ocicollmax.php'>Italian</option>
            <option value='ja/function.ocicollmax.php'>Japanese</option>
            <option value='pt_BR/function.ocicollmax.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocicollmax.php'>Russian</option>
            <option value='tr/function.ocicollmax.php'>Turkish</option>
            <option value='uk/function.ocicollmax.php'>Ukrainian</option>
            <option value='zh/function.ocicollmax.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocicollmax" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocicollmax</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocicollmax</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="ocicollection.max.php" class="function">OCICollection::max()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocicollmax-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="ocicollection.max.php" class="function">OCICollection::max()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocicollmax.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocicollmax%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocicollmax&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocicollmax.php">＋<small>add a note</small></a></span>
