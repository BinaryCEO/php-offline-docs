...
<head>
  ...
  <title>PHP: Gmagick::chopimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.chopimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.chopimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.chopimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.charcoalimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.clear.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.chopimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.chopimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.chopimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.chopimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.chopimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.chopimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.chopimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.chopimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.chopimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.chopimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.chopimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::chopimage - Manual" />
<meta name="twitter:description" content="Removes a region of an image and trims" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::chopimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.clear.php">
          Gmagick::clear &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.charcoalimage.php">
          &laquo; Gmagick::charcoalimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.chopimage.php' selected="selected">English</option>
            <option value='de/gmagick.chopimage.php'>German</option>
            <option value='es/gmagick.chopimage.php'>Spanish</option>
            <option value='fr/gmagick.chopimage.php'>French</option>
            <option value='it/gmagick.chopimage.php'>Italian</option>
            <option value='ja/gmagick.chopimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.chopimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.chopimage.php'>Russian</option>
            <option value='tr/gmagick.chopimage.php'>Turkish</option>
            <option value='uk/gmagick.chopimage.php'>Ukrainian</option>
            <option value='zh/gmagick.chopimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.chopimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::chopimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::chopimage</span> &mdash; <span class="dc-title">Removes a region of an image and trims</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.chopimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::chopimage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.chopimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.chopimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The chopped <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.chopimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/chopimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.chopimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.chopimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.chopimage.php">＋<small>add a note</small></a></span>
