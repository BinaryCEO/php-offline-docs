...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightQuery - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightquery.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightquery.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightquery.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightmergecontiguous.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightregexmaxanalyzedchars.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightquery.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightquery.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightquery.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightquery.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightquery.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightquery.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightquery.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightquery.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightquery.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightquery.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightquery.php" hreflang="zh">
...
<meta name="Description" content="return the highlightquery (hl.q)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightQuery - Manual" />
<meta name="twitter:description" content="return the highlightquery (hl.q)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightQuery - Manual" />
<meta itemprop="description" content="return the highlightquery (hl.q)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="return the highlightquery (hl.q)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gethighlightregexmaxanalyzedchars.php">
          SolrQuery::getHighlightRegexMaxAnalyzedChars &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightmergecontiguous.php">
          &laquo; SolrQuery::getHighlightMergeContiguous        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightquery.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightquery.php'>German</option>
            <option value='es/solrquery.gethighlightquery.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightquery.php'>French</option>
            <option value='it/solrquery.gethighlightquery.php'>Italian</option>
            <option value='ja/solrquery.gethighlightquery.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightquery.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightquery.php'>Russian</option>
            <option value='tr/solrquery.gethighlightquery.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightquery.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightquery.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightquery" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightQuery</h1>
  <p class="verinfo">(PECL solr &gt;= 2.7.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightQuery</span> &mdash; <span class="dc-title">return the highlightquery (hl.q)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightquery-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightQuery</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightquery-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightquery-returnvalues">
  ...
  <p class="para">
   Returns the current SolrHighlightQuery string, or null if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightquery.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightquery%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightquery&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightquery.php">＋<small>add a note</small></a></span>
