...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.componere.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.componere.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.componere.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.componere.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.componere.php">
 <link rel="next" href="https://www.php.net/manual/en/componere.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.componere.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.componere.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.componere.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.componere.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.componere.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.componere.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.componere.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.componere.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.componere.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.componere.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.componere.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.componere.php' selected="selected">English</option>
            <option value='de/intro.componere.php'>German</option>
            <option value='es/intro.componere.php'>Spanish</option>
            <option value='fr/intro.componere.php'>French</option>
            <option value='it/intro.componere.php'>Italian</option>
            <option value='ja/intro.componere.php'>Japanese</option>
            <option value='pt_BR/intro.componere.php'>Brazilian Portuguese</option>
            <option value='ru/intro.componere.php'>Russian</option>
            <option value='tr/intro.componere.php'>Turkish</option>
            <option value='uk/intro.componere.php'>Ukrainian</option>
            <option value='zh/intro.componere.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.componere" class="preface">
    ...
    <p class="para">
     ...
     <div class="methodsynopsis dc-description"><span class="methodname"><a href="componere.cast_by_ref.php" class="methodname">Componere\cast_by_ref</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$type</code></span>, <span class="methodparam"><span class="type"><a href="language.types.object.php" class="type object">object</a></span> <code class="parameter">$object</code></span>): <span class="type"><a href="language.types.object.php" class="type object">object</a></span></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.componere%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.componere&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.componere.php">＋<small>add a note</small></a></span>
