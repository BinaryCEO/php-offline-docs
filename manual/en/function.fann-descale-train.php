...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-descale-train.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-descale-output.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-destroy.php">
...
<meta name="Description" content="Descale input and output data based on previously calculated parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_descale_train - Manual" />
<meta name="twitter:description" content="Descale input and output data based on previously calculated parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_descale_train - Manual" />
<meta itemprop="description" content="Descale input and output data based on previously calculated parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Descale input and output data based on previously calculated parameters" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-descale-train.php' selected="selected">English</option>
            <option value='de/function.fann-descale-train.php'>German</option>
            <option value='es/function.fann-descale-train.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_descale_train</span> &mdash; <span class="dc-title">Descale input and output data based on previously calculated parameters</span></p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-descale-train-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-scale-train.php" class="function" rel="rdfs-seeAlso">fann_scale_train()</a> - Scale input and output data based on previously calculated parameters</span></li>
    <li><span class="function"><a href="function.fann-set-scaling-params.php" class="function" rel="rdfs-seeAlso">fann_set_scaling_params()</a> - Calculate input and output scaling parameters for future use based on training data</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-descale-train.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-descale-train%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-descale-train&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-descale-train.php">＋<small>add a note</small></a></span>
