...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.yaf-controller-abstract.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/yaf-config-simple.valid.php">
 <link rel="next" href="https://www.php.net/manual/en/yaf-controller-abstract.construct.php">
...
<meta name="Description" content="The Yaf_Controller_Abstract class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Yaf_Controller_Abstract - Manual" />
<meta name="twitter:description" content="The Yaf_Controller_Abstract class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Yaf_Controller_Abstract - Manual" />
<meta itemprop="description" content="The Yaf_Controller_Abstract class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Yaf_Controller_Abstract class" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.yaf-controller-abstract.php' selected="selected">English</option>
            ...
            <option value='ja/class.yaf-controller-abstract.php'>Japanese</option>
 ...
 <div class="partintro"><p class="verinfo">(Yaf &gt;=1.0.0)</p>
  ...
  <div class="section" id="yaf-controller-abstract.intro">
   ...
   <p class="para">
    <span class="classname"><strong class="classname">Yaf_Controller_Abstract</strong></span> is the heart of Yaf&#039;s 
   ...
   <p class="para">
    ...
    <span class="classname"><strong class="classname">Yaf_Controller_Abstract</strong></span>.
   </p>
   <p class="para">
    You will find that you can not define __construct function for your custom
    controller, thus, <span class="classname"><strong class="classname">Yaf_Controller_Abstract</strong></span> provides
  ...
  <div class="section" id="yaf-controller-abstract.props">
   ...
   <dl>
     ...
     <dd>
      ...
      this property and <span class="classname"><a href="class.yaf-action-abstract.php" class="classname">Yaf_Action_Abstract</a></span>.
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="yaf-controller-abstract.construct.php">Yaf_Controller_Abstract::__construct</a> — Yaf_Controller_Abstract constructor</li><li><a href="yaf-controller-abstract.display.php">Yaf_Controller_Abstract::display</a> — The display purpose</li><li><a href="yaf-controller-abstract.forward.php">Yaf_Controller_Abstract::forward</a> — Forward to another action</li><li><a href="yaf-controller-abstract.getinvokearg.php">Yaf_Controller_Abstract::getInvokeArg</a> — The getInvokeArg purpose</li><li><a href="yaf-controller-abstract.getinvokeargs.php">Yaf_Controller_Abstract::getInvokeArgs</a> — The getInvokeArgs purpose</li><li><a href="yaf-controller-abstract.getmodulename.php">Yaf_Controller_Abstract::getModuleName</a> — Get module name</li><li><a href="yaf-controller-abstract.getname.php">Yaf_Controller_Abstract::getName</a> — Get self name</li><li><a href="yaf-controller-abstract.getrequest.php">Yaf_Controller_Abstract::getRequest</a> — Retrieve current request object</li><li><a href="yaf-controller-abstract.getresponse.php">Yaf_Controller_Abstract::getResponse</a> — Retrieve current response object</li><li><a href="yaf-controller-abstract.getview.php">Yaf_Controller_Abstract::getView</a> — Retrieve the view engine</li><li><a href="yaf-controller-abstract.getviewpath.php">Yaf_Controller_Abstract::getViewpath</a> — The getViewpath purpose</li><li><a href="yaf-controller-abstract.init.php">Yaf_Controller_Abstract::init</a> — Controller initializer</li><li><a href="yaf-controller-abstract.initview.php">Yaf_Controller_Abstract::initView</a> — The initView purpose</li><li><a href="yaf-controller-abstract.redirect.php">Yaf_Controller_Abstract::redirect</a> — Redirect to a URL</li><li><a href="yaf-controller-abstract.render.php">Yaf_Controller_Abstract::render</a> — Render view template</li><li><a href="yaf-controller-abstract.setviewpath.php">Yaf_Controller_Abstract::setViewpath</a> — The setViewpath purpose</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaf/yaf-controller-abstract.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.yaf-controller-abstract%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.yaf-controller-abstract&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.yaf-controller-abstract.php">＋<small>add a note</small></a></span>
