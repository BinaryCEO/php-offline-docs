...
<head>
  ...
  <title>PHP: MongoDB\Driver\ClientEncryption::rewrapManyDataKey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-clientencryption.rewrapmanydatakey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-clientencryption.rewrapmanydatakey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-clientencryption.rewrapmanydatakey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-clientencryption.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-clientencryption.removekeyaltname.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mongodb-driver-serverapi.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-clientencryption.rewrapmanydatakey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-clientencryption.rewrapmanydatakey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-clientencryption.rewrapmanydatakey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-clientencryption.rewrapmanydatakey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-clientencryption.rewrapmanydatakey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-clientencryption.rewrapmanydatakey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-clientencryption.rewrapmanydatakey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-clientencryption.rewrapmanydatakey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-clientencryption.rewrapmanydatakey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-clientencryption.rewrapmanydatakey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-clientencryption.rewrapmanydatakey.php" hreflang="zh">
...
<meta name="Description" content="Rewraps data keys" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\ClientEncryption::rewrapManyDataKey - Manual" />
<meta name="twitter:description" content="Rewraps data keys" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\ClientEncryption::rewrapManyDataKey - Manual" />
<meta itemprop="description" content="Rewraps data keys" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rewraps data keys" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.mongodb-driver-serverapi.php">
          MongoDB\Driver\ServerApi &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-clientencryption.removekeyaltname.php">
          &laquo; MongoDB\Driver\ClientEncryption::removeKeyAltName        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-clientencryption.rewrapmanydatakey.php' selected="selected">English</option>
            <option value='de/mongodb-driver-clientencryption.rewrapmanydatakey.php'>German</option>
            <option value='es/mongodb-driver-clientencryption.rewrapmanydatakey.php'>Spanish</option>
            <option value='fr/mongodb-driver-clientencryption.rewrapmanydatakey.php'>French</option>
            <option value='it/mongodb-driver-clientencryption.rewrapmanydatakey.php'>Italian</option>
            <option value='ja/mongodb-driver-clientencryption.rewrapmanydatakey.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-clientencryption.rewrapmanydatakey.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-clientencryption.rewrapmanydatakey.php'>Russian</option>
            <option value='tr/mongodb-driver-clientencryption.rewrapmanydatakey.php'>Turkish</option>
            <option value='uk/mongodb-driver-clientencryption.rewrapmanydatakey.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-clientencryption.rewrapmanydatakey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-clientencryption.rewrapmanydatakey" class="refentry">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/clientencryption/rewrapmanydatakey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-clientencryption.rewrapmanydatakey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-clientencryption.rewrapmanydatakey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-clientencryption.rewrapmanydatakey.php">＋<small>add a note</small></a></span>
