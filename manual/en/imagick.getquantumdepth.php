...
<head>
  ...
  <title>PHP: Imagick::getQuantumDepth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getquantumdepth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getquantumdepth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getquantumdepth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getquantum.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getquantumrange.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getquantumdepth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getquantumdepth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getquantumdepth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getquantumdepth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getquantumdepth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getquantumdepth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getquantumdepth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getquantumdepth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getquantumdepth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getquantumdepth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getquantumdepth.php" hreflang="zh">
...
<meta name="Description" content="Gets the quantum depth" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getQuantumDepth - Manual" />
<meta name="twitter:description" content="Gets the quantum depth" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getQuantumDepth - Manual" />
<meta itemprop="description" content="Gets the quantum depth" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the quantum depth" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getquantumrange.php">
          Imagick::getQuantumRange &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getquantum.php">
          &laquo; Imagick::getQuantum        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getquantumdepth.php' selected="selected">English</option>
            <option value='de/imagick.getquantumdepth.php'>German</option>
            <option value='es/imagick.getquantumdepth.php'>Spanish</option>
            <option value='fr/imagick.getquantumdepth.php'>French</option>
            <option value='it/imagick.getquantumdepth.php'>Italian</option>
            <option value='ja/imagick.getquantumdepth.php'>Japanese</option>
            <option value='pt_BR/imagick.getquantumdepth.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getquantumdepth.php'>Russian</option>
            <option value='tr/imagick.getquantumdepth.php'>Turkish</option>
            <option value='uk/imagick.getquantumdepth.php'>Ukrainian</option>
            <option value='zh/imagick.getquantumdepth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getquantumdepth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getQuantumDepth</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getQuantumDepth</span> &mdash; <span class="dc-title">Gets the quantum depth</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getquantumdepth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::getQuantumDepth</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getquantumdepth-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getquantumdepth-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an array with <code class="literal">&quot;quantumDepthLong&quot;</code> and <code class="literal">&quot;quantumDepthString&quot;</code>
   members.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-imagick.getquantumdepth-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getquantumdepth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getquantumdepth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getquantumdepth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getquantumdepth.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108635">  <div class="votes">
    <div id="Vu108635">
    <a href="/manual/vote-note.php?id=108635&amp;page=imagick.getquantumdepth&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108635">
    <a href="/manual/vote-note.php?id=108635&amp;page=imagick.getquantumdepth&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108635" title="66% like this...">
    1
    </div>
  </div>
  <a href="#108635" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108635"> &para;</a><div class="date" title="2012-05-12 10:10"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108635">
<div class="phpcode"><code><span class="html">The getQuantumDepth works much like the other "Depth" functions and much like the getQuantumRange function.  Like the Depth functions, it returns a value indicating the number of bits to store the unique color values -- 16-bit = 2^16 unique colors, which is 65,535 (counting starts at '0' in binary, as opposed to '1' in decimal).  Like the getQuantumRange function, it returns an array with two values, one being a long integer ('quantumDepthLong') and the other being a string ('quantumDepthLong').  The only difference, besides the variable types, is that the string version has a 'Q' prefixed to it.<br /><br />Here's some sample code and the results, given a color, BMP file photograph that is 600x450 pixels...<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.bmp"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get Quantum Depth<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$imagick_type_quantum_depth </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getQuantumDepth</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Print Results<br />        // ---------------------------------------------<br /><br />    </span><span class="keyword">print(</span><span class="string">"&lt;pre&gt;"</span><span class="keyword">);<br />    </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$imagick_type_quantum_depth</span><span class="keyword">);<br />    print(</span><span class="string">"&lt;/pre&gt;"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />Output:<br /><br />Array<br />(<br />    [quantumDepthLong] =&gt; 16<br />    [quantumDepthString] =&gt; Q16<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getquantumdepth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getquantumdepth.php">＋<small>add a note</small></a></div>
