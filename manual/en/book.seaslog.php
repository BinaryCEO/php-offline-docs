...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.seaslog.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/class.random-randomexception.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.seaslog.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.seaslog.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.seaslog.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.seaslog.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.seaslog.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.seaslog.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.seaslog.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.seaslog.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.seaslog.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.seaslog.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.seaslog.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.seaslog.php" hreflang="zh">
...
<meta name="Description" content="Seaslog" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Seaslog - Manual" />
<meta name="twitter:description" content="Seaslog" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Seaslog - Manual" />
<meta itemprop="description" content="Seaslog" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Seaslog" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intro.seaslog.php">
          Introduction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.random-randomexception.php">
          &laquo; Random\RandomException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.seaslog.php' selected="selected">English</option>
            <option value='de/book.seaslog.php'>German</option>
            <option value='es/book.seaslog.php'>Spanish</option>
            <option value='fr/book.seaslog.php'>French</option>
            <option value='it/book.seaslog.php'>Italian</option>
            <option value='ja/book.seaslog.php'>Japanese</option>
            <option value='pt_BR/book.seaslog.php'>Brazilian Portuguese</option>
            <option value='ru/book.seaslog.php'>Russian</option>
            <option value='tr/book.seaslog.php'>Turkish</option>
            <option value='uk/book.seaslog.php'>Ukrainian</option>
            <option value='zh/book.seaslog.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.seaslog" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.seaslog.php">Introduction</a></li><li><a href="seaslog.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="seaslog.requirements.php">Requirements</a></li><li><a href="seaslog.installation.php">Installation</a></li><li><a href="seaslog.configuration.php">Runtime Configuration</a></li><li><a href="seaslog.resources.php">Resource Types</a></li></ul></li><li><a href="seaslog.constants.php">Predefined Constants</a></li><li><a href="seaslog.examples.php">Examples</a></li><li><a href="ref.seaslog.php">Seaslog Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.seaslog-get-author.php">seaslog_get_author</a> — Get SeasLog author.</li><li><a href="function.seaslog-get-version.php">seaslog_get_version</a> — Get SeasLog version.</li></ul></li><li><a href="class.seaslog.php">SeasLog</a> — The SeasLog class<ul class="chunklist chunklist_book chunklist_children"><li><a href="seaslog.alert.php">SeasLog::alert</a> — Record alert log information</li><li><a href="seaslog.analyzercount.php">SeasLog::analyzerCount</a> — Get log count by level, log_path and key_word</li><li><a href="seaslog.analyzerdetail.php">SeasLog::analyzerDetail</a> — Get log detail by level, log_path, key_word, start, limit, order</li><li><a href="seaslog.closeloggerstream.php">SeasLog::closeLoggerStream</a> — Manually release stream flow from logger</li><li><a href="seaslog.construct.php">SeasLog::__construct</a> — Description</li><li><a href="seaslog.critical.php">SeasLog::critical</a> — Record critical log information</li><li><a href="seaslog.debug.php">SeasLog::debug</a> — Record debug log information</li><li><a href="seaslog.destruct.php">SeasLog::__destruct</a> — Description</li><li><a href="seaslog.emergency.php">SeasLog::emergency</a> — Record emergency log information</li><li><a href="seaslog.error.php">SeasLog::error</a> — Record error log information</li><li><a href="seaslog.flushbuffer.php">SeasLog::flushBuffer</a> — Flush logs buffer, dump to appender file, or send to remote api with tcp/udp</li><li><a href="seaslog.getbasepath.php">SeasLog::getBasePath</a> — Get SeasLog base path.</li><li><a href="seaslog.getbuffer.php">SeasLog::getBuffer</a> — Get the logs buffer in memory as array</li><li><a href="seaslog.getbufferenabled.php">SeasLog::getBufferEnabled</a> — Determin if buffer enabled</li><li><a href="seaslog.getdatetimeformat.php">SeasLog::getDatetimeFormat</a> — Get SeasLog datetime format style</li><li><a href="seaslog.getlastlogger.php">SeasLog::getLastLogger</a> — Get SeasLog last logger path</li><li><a href="seaslog.getrequestid.php">SeasLog::getRequestID</a> — Get SeasLog request_id differentiated requests</li><li><a href="seaslog.getrequestvariable.php">SeasLog::getRequestVariable</a> — Get SeasLog request variable</li><li><a href="seaslog.info.php">SeasLog::info</a> — Record info log information</li><li><a href="seaslog.log.php">SeasLog::log</a> — The Common Record Log Function</li><li><a href="seaslog.notice.php">SeasLog::notice</a> — Record notice log information</li><li><a href="seaslog.setbasepath.php">SeasLog::setBasePath</a> — Set SeasLog base path</li><li><a href="seaslog.setdatetimeformat.php">SeasLog::setDatetimeFormat</a> — Set SeasLog datetime format style</li><li><a href="seaslog.setlogger.php">SeasLog::setLogger</a> — Set SeasLog logger name</li><li><a href="seaslog.setrequestid.php">SeasLog::setRequestID</a> — Set SeasLog request_id differentiated requests</li><li><a href="seaslog.setrequestvariable.php">SeasLog::setRequestVariable</a> — Manually set SeasLog request variable</li><li><a href="seaslog.warning.php">SeasLog::warning</a> — Record warning log information</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/seaslog/book.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.seaslog%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.seaslog&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.seaslog.php">＋<small>add a note</small></a></span>
