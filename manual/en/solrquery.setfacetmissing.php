...
<head>
  ...
  <title>PHP: SolrQuery::setFacetMissing - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setfacetmissing.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setfacetmissing.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetmissing.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setfacetmincount.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setfacetoffset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetmissing.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setfacetmissing.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setfacetmissing.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setfacetmissing.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setfacetmissing.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setfacetmissing.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setfacetmissing.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setfacetmissing.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setfacetmissing.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setfacetmissing.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setfacetmissing.php" hreflang="zh">
...
<meta name="Description" content="Maps to facet.missing" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setFacetMissing - Manual" />
<meta name="twitter:description" content="Maps to facet.missing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setFacetMissing - Manual" />
<meta itemprop="description" content="Maps to facet.missing" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Maps to facet.missing" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setfacetoffset.php">
          SolrQuery::setFacetOffset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setfacetmincount.php">
          &laquo; SolrQuery::setFacetMinCount        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setfacetmissing.php' selected="selected">English</option>
            <option value='de/solrquery.setfacetmissing.php'>German</option>
            <option value='es/solrquery.setfacetmissing.php'>Spanish</option>
            <option value='fr/solrquery.setfacetmissing.php'>French</option>
            <option value='it/solrquery.setfacetmissing.php'>Italian</option>
            <option value='ja/solrquery.setfacetmissing.php'>Japanese</option>
            <option value='pt_BR/solrquery.setfacetmissing.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setfacetmissing.php'>Russian</option>
            <option value='tr/solrquery.setfacetmissing.php'>Turkish</option>
            <option value='uk/solrquery.setfacetmissing.php'>Ukrainian</option>
            <option value='zh/solrquery.setfacetmissing.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setfacetmissing" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setFacetMissing</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setFacetMissing</span> &mdash; <span class="dc-title">Maps to facet.missing</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setfacetmissing-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setFacetMissing</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setfacetmissing-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> turns this feature on. <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> disables it.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setfacetmissing-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setfacetmissing.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setfacetmissing%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setfacetmissing&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setfacetmissing.php">＋<small>add a note</small></a></span>
