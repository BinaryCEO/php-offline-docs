...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.queryfonts.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.queryfonts.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.queryfonts.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.queryfontmetrics.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.queryformats.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.queryfonts.php' selected="selected">English</option>
            ...
            <option value='ru/imagick.queryfonts.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::queryFonts</span> &mdash; <span class="dc-title">Returns the configured fonts</span></p>
  ...
  <p class="para">
    <div class="example" id="example-3070">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/queryfonts.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.queryfonts%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.queryfonts&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.queryfonts.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">If you want to create a graphical output of the  configured/embedded fonts<br /><br />function outputFont( $fontName = 'Courier' ) {<br />    $image = new Imagick();<br />    $draw = new ImagickDraw();<br /><br />    $draw-&gt;setGravity( Imagick::GRAVITY_CENTER );<br />    $draw-&gt;setFont( $fontName );<br />    $draw-&gt;setFontSize( 12 );<br />    $draw-&gt;setFillColor( 'black' );<br /><br />    $image-&gt;newImage( 300, 20, new ImagickPixel( 'lightblue' ) );<br />    $image-&gt;annotateImage( $draw, 0, 0, 0, $fontName );<br />    $image-&gt;setImageFormat( 'png' );<br /><br />    $src = 'data: ' . mime_content_type( $image ) . ';base64,' . base64_encode( $image );<br />    return '&lt;img src="' . $src . '"&gt; ' . $fontName . '&lt;br&gt;';<br />}<br /><br />echo '&lt;style&gt;img{vertical-align: middle; margin-bottom: 1px;}&lt;/style&gt;';<br />$fontList = \Imagick::queryFonts( '*' );<br />foreach ( $fontList as $fontName ) {<br />    echo outputFont( $fontName );<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.queryfonts&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.queryfonts.php">＋<small>add a note</small></a></div>
