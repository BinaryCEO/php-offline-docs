...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-fetch-object.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-fetch-assoc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-fetch-row.php">
...
<meta name="Description" content="Returns the next row from a query as an object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_fetch_object - Manual" />
<meta name="twitter:description" content="Returns the next row from a query as an object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_fetch_object - Manual" />
<meta itemprop="description" content="Returns the next row from a query as an object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the next row from a query as an object" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-fetch-object.php' selected="selected">English</option>
            ...
            <option value='ru/function.oci-fetch-object.php'>Russian</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.oci-fetch-row.php" class="function" rel="rdfs-seeAlso">oci_fetch_row()</a> - Returns the next row from a query as a numeric array</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-fetch-object.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-fetch-object%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-fetch-object&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-fetch-object.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Please note that you can still reference a column that has a very complex name by using the curly syntax as shown in this example:<br /><br /><span class="default">&lt;?php<br /><br />$queryStr </span><span class="keyword">= </span><span class="string">'SELECT COUNT(*) FROM FOOBAR'</span><span class="keyword">;  </span><span class="comment">//Complex name!<br />  // parse and exec...<br /></span><span class="default">$queryObj </span><span class="keyword">= </span><span class="default">oci_fetch_object</span><span class="keyword">(</span><span class="default">$quertStmt</span><span class="keyword">);<br /> <br />echo </span><span class="string">'Count: ' </span><span class="keyword">. </span><span class="default">$queryObj</span><span class="keyword">-&gt;{</span><span class="string">'COUNT(*)'</span><span class="keyword">};  </span><span class="comment">//Curly syntax reference<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.oci-fetch-object&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-fetch-object.php">＋<small>add a note</small></a></div>
