...
<head>
  ...
  <title>PHP: imap_mail_copy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-mail-copy.php">
 <link rel="shorturl" href="https://www.php.net/imap-mail-copy">
 <link rel="alternate" href="https://www.php.net/imap-mail-copy" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-mail-compose.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-mail-move.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-mail-copy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-mail-copy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-mail-copy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-mail-copy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-mail-copy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-mail-copy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-mail-copy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-mail-copy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-mail-copy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-mail-copy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-mail-copy.php" hreflang="zh">
...
<meta name="Description" content="Copy specified messages to a mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_mail_copy - Manual" />
<meta name="twitter:description" content="Copy specified messages to a mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_mail_copy - Manual" />
<meta itemprop="description" content="Copy specified messages to a mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Copy specified messages to a mailbox" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-mail-move.php">
          imap_mail_move &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-mail-compose.php">
          &laquo; imap_mail_compose        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-mail-copy.php' selected="selected">English</option>
            <option value='de/function.imap-mail-copy.php'>German</option>
            <option value='es/function.imap-mail-copy.php'>Spanish</option>
            <option value='fr/function.imap-mail-copy.php'>French</option>
            <option value='it/function.imap-mail-copy.php'>Italian</option>
            <option value='ja/function.imap-mail-copy.php'>Japanese</option>
            <option value='pt_BR/function.imap-mail-copy.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-mail-copy.php'>Russian</option>
            <option value='tr/function.imap-mail-copy.php'>Turkish</option>
            <option value='uk/function.imap-mail-copy.php'>Ukrainian</option>
            <option value='zh/function.imap-mail-copy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-mail-copy" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_mail_copy</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_mail_copy</span> &mdash; <span class="dc-title">Copy specified messages to a mailbox</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-mail-copy-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_mail_copy</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message_nums</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$mailbox</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Copies mail messages specified by <code class="parameter">message_nums</code>
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
     ...
     <dd>
      <p class="para">
       <code class="parameter">message_nums</code> is a range not just message
       numbers (as described in <a href="https://datatracker.ietf.org/doc/html/rfc2060" class="link external">&raquo;&nbsp;RFC2060</a>).
      </p>
     </dd>
...
<a href="imap.configuration.php#ini.imap.enable-insecure-rsh" class="link">imap.enable_insecure_rsh</a> is disabled.
     ...
     <dd>
      <p class="para">
       <code class="parameter">flags</code> is a bitmask of one or more of
       <ul class="itemizedlist">
        ...
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.cp-move">CP_MOVE</a></code></strong> - Delete the messages from
          the current mailbox after copying. If this flag is set, the function
          behaves identically to <span class="function"><a href="function.imap-mail-move.php" class="function">imap_mail_move()</a></span>.
         </span>
        </li>
       </ul>
      </p>
 ...
 <div class="refsect1 changelog" id="refsect1-function.imap-mail-copy-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-mail-copy-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-mail-move.php" class="function" rel="rdfs-seeAlso">imap_mail_move()</a> - Move specified messages to a mailbox</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-mail-copy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-mail-copy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-mail-copy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-mail-copy.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="23058">  <div class="votes">
    <div id="Vu23058">
    <a href="/manual/vote-note.php?id=23058&amp;page=function.imap-mail-copy&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd23058">
    <a href="/manual/vote-note.php?id=23058&amp;page=function.imap-mail-copy&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V23058" title="100% like this...">
    4
    </div>
  </div>
  <a href="#23058" class="name">
  <strong class="user"><em>marcus at names dot co dot uk</em></strong></a><a class="genanchor" href="#23058"> &para;</a><div class="date" title="2002-07-08 10:51"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom23058">
<div class="phpcode"><code><span class="html">If you are having problems getting imap_mail_copy and imap_mail_move to work, check you have installed imap_devel (the imap development libraries) as well as imap (the imap daemon). Without it, PHP appears to configure correctly --with-imap, but some functions do not work.<br /><br />It took me about 12 hours to figure this out!!</span></code></div>
  </div>
 </div>
  <div class="note" id="10455">  <div class="votes">
    <div id="Vu10455">
    <a href="/manual/vote-note.php?id=10455&amp;page=function.imap-mail-copy&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd10455">
    <a href="/manual/vote-note.php?id=10455&amp;page=function.imap-mail-copy&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V10455" title="100% like this...">
    4
    </div>
  </div>
  <a href="#10455" class="name">
  <strong class="user"><em>hxlvt at hotmail dot com</em></strong></a><a class="genanchor" href="#10455"> &para;</a><div class="date" title="2001-01-04 04:37"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom10455">
<div class="phpcode"><code><span class="html">After much fooling around, imap_mail_copy did work for me. One thing you might want to check, if you are having problems, is the new mailbox name. Make sure it is just a folder name, e.g. INBOX.haha without the server part.</span></code></div>
  </div>
 </div>
  <div class="note" id="118072">  <div class="votes">
    <div id="Vu118072">
    <a href="/manual/vote-note.php?id=118072&amp;page=function.imap-mail-copy&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118072">
    <a href="/manual/vote-note.php?id=118072&amp;page=function.imap-mail-copy&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118072" title="53% like this...">
    1
    </div>
  </div>
  <a href="#118072" class="name">
  <strong class="user"><em>jigar dot dhaduk79 at gmail dot com</em></strong></a><a class="genanchor" href="#118072"> &para;</a><div class="date" title="2015-09-29 11:11"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom118072">
<div class="phpcode"><code><span class="html">When we want to copy more than one mail, we can write '(string)' before msg_num. Like..<br /><br />$msg_num = "1,2,3,4,5,6,7";<br />$copy = imap_mail_copy($imap_stream, (string) $msg_num, '[Gmail]/Important', CP_UID);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-mail-copy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-mail-copy.php">＋<small>add a note</small></a></div>
