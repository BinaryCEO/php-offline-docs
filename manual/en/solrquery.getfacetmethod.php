...
<head>
  ...
  <title>PHP: SolrQuery::getFacetMethod - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfacetmethod.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfacetmethod.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetmethod.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfacetlimit.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfacetmincount.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetmethod.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfacetmethod.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfacetmethod.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfacetmethod.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfacetmethod.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfacetmethod.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfacetmethod.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfacetmethod.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfacetmethod.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfacetmethod.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfacetmethod.php" hreflang="zh">
...
<meta name="Description" content="Returns the value of the facet.method parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFacetMethod - Manual" />
<meta name="twitter:description" content="Returns the value of the facet.method parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFacetMethod - Manual" />
<meta itemprop="description" content="Returns the value of the facet.method parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the value of the facet.method parameter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getfacetmincount.php">
          SolrQuery::getFacetMinCount &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfacetlimit.php">
          &laquo; SolrQuery::getFacetLimit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfacetmethod.php' selected="selected">English</option>
            <option value='de/solrquery.getfacetmethod.php'>German</option>
            <option value='es/solrquery.getfacetmethod.php'>Spanish</option>
            <option value='fr/solrquery.getfacetmethod.php'>French</option>
            <option value='it/solrquery.getfacetmethod.php'>Italian</option>
            <option value='ja/solrquery.getfacetmethod.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfacetmethod.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfacetmethod.php'>Russian</option>
            <option value='tr/solrquery.getfacetmethod.php'>Turkish</option>
            <option value='uk/solrquery.getfacetmethod.php'>Ukrainian</option>
            <option value='zh/solrquery.getfacetmethod.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfacetmethod" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFacetMethod</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFacetMethod</span> &mdash; <span class="dc-title">Returns the value of the facet.method parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfacetmethod-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFacetMethod</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfacetmethod-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfacetmethod-returnvalues">
  ...
  <p class="para">
   Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfacetmethod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfacetmethod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfacetmethod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfacetmethod.php">＋<small>add a note</small></a></span>
