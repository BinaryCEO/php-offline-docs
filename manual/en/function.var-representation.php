...
<head>
  ...
  <title>PHP: var_representation - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.var-representation.php">
 <link rel="shorturl" href="https://www.php.net/var-representation">
 <link rel="alternate" href="https://www.php.net/var-representation" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.var-representation.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.var-representation.php">
 <link rel="next" href="https://www.php.net/manual/en/refs.remote.other.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.var-representation.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.var-representation.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.var-representation.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.var-representation.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.var-representation.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.var-representation.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.var-representation.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.var-representation.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.var-representation.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.var-representation.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.var-representation.php" hreflang="zh">
...
<meta name="Description" content="Returns a short, readable, parsable string representation of a variable" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: var_representation - Manual" />
<meta name="twitter:description" content="Returns a short, readable, parsable string representation of a variable" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: var_representation - Manual" />
<meta itemprop="description" content="Returns a short, readable, parsable string representation of a variable" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a short, readable, parsable string representation of a variable" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="refs.remote.other.php">
          Other Services &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.var-representation.php">
          &laquo; var_representation Functions        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.basic.other.php'>Other Basic Extensions</a></li>      <li><a href='book.var_representation.php'>var_representation</a></li>      <li><a href='ref.var-representation.php'>var_representation Functions</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.var-representation.php' selected="selected">English</option>
            <option value='de/function.var-representation.php'>German</option>
            <option value='es/function.var-representation.php'>Spanish</option>
            <option value='fr/function.var-representation.php'>French</option>
            <option value='it/function.var-representation.php'>Italian</option>
            <option value='ja/function.var-representation.php'>Japanese</option>
            <option value='pt_BR/function.var-representation.php'>Brazilian Portuguese</option>
            <option value='ru/function.var-representation.php'>Russian</option>
            <option value='tr/function.var-representation.php'>Turkish</option>
            <option value='uk/function.var-representation.php'>Ukrainian</option>
            <option value='zh/function.var-representation.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.var-representation" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.var-representation-examples">
  ...
  <p class="para">
   <div class="example" id="example-4480">
    <p><strong>Example #1 <span class="function"><strong>var_representation()</strong></span> Examples</strong></p>
...
[1, 2, [&#039;key&#039; =&gt; &#039;value&#039;]]</pre>
  ...
  <p class="para">
   <div class="example" id="example-4481">
    <p><strong>Example #2 Escaping control characters</strong></p>
    <div class="example-contents">
...
<div class="examplescode"><pre class="examplescode">&quot;Content-Length: 123\r\n&quot;</pre>
  ...
  <p class="para">
   <div class="example" id="example-4482">
    <p><strong>Example #3 Exporting <span class="classname"><a href="class.stdclass.php" class="classname">stdClass</a></span></strong></p>
    <div class="example-contents">
...
<div class="examplescode"><pre class="examplescode">(object) [
  ...
  <p class="para">
   <div class="example" id="example-4483">
    <p><strong>Example #4 Exporting classes</strong></p>
    <div class="example-contents">
...
<div class="examplescode"><pre class="examplescode">\A::__set_state([
  ...
  <p class="para">
   <div class="example" id="example-4484">
    <p><strong>Example #5 Using <a href="language.oop5.magic.php#object.set-state" class="link">__set_state()</a></strong></p>
    <div class="example-contents">
...
<div class="examplescode"><pre class="examplescode">object(A)#2 (2) {
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.var-export.php" class="function" rel="rdfs-seeAlso">var_export()</a> - Outputs or returns a parsable string representation of a variable</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/var_representation/functions/var-representation.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.var-representation%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.var-representation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.var-representation.php">＋<small>add a note</small></a></span>
 ...
 <div class="note">There are no user contributed notes for this page.</div></section>    </section><!-- layout-content -->
        ...
        <ul class='parent-menu-list'>
                                    <li>
                <a href="ref.var-representation.php">var_representation Functions</a>

                                    <ul class='child-menu-list'>

                                                <li class="current">
                            <a href="function.var-representation.php" title="var_&#8203;representation">var_&#8203;representation</a>
                        </li>
