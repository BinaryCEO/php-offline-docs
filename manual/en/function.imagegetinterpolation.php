...
<head>
  ...
  <title>PHP: imagegetinterpolation - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagegetinterpolation.php">
 <link rel="shorturl" href="https://www.php.net/imagegetinterpolation">
 <link rel="alternate" href="https://www.php.net/imagegetinterpolation" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagegetclip.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagegif.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagegetinterpolation.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagegetinterpolation.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagegetinterpolation.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagegetinterpolation.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagegetinterpolation.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagegetinterpolation.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagegetinterpolation.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagegetinterpolation.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagegetinterpolation.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagegetinterpolation.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagegetinterpolation.php" hreflang="zh">
...
<meta name="Description" content="Get the interpolation method" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagegetinterpolation - Manual" />
<meta name="twitter:description" content="Get the interpolation method" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagegetinterpolation - Manual" />
<meta itemprop="description" content="Get the interpolation method" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the interpolation method" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagegetinterpolation.php' selected="selected">English</option>
            <option value='de/function.imagegetinterpolation.php'>German</option>
            <option value='es/function.imagegetinterpolation.php'>Spanish</option>
            <option value='fr/function.imagegetinterpolation.php'>French</option>
            <option value='it/function.imagegetinterpolation.php'>Italian</option>
            <option value='ja/function.imagegetinterpolation.php'>Japanese</option>
            <option value='pt_BR/function.imagegetinterpolation.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagegetinterpolation.php'>Russian</option>
            <option value='tr/function.imagegetinterpolation.php'>Turkish</option>
            <option value='uk/function.imagegetinterpolation.php'>Ukrainian</option>
            <option value='zh/function.imagegetinterpolation.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagegetinterpolation" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagegetinterpolation</h1>
  <p class="verinfo">(PHP 8)</p><p class="refpurpose"><span class="refname">imagegetinterpolation</span> &mdash; <span class="dc-title">Get the interpolation method</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.imagegetinterpolation-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagegetinterpolation</strong></span>(<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Gets the currently set interpolation method of the <code class="parameter">image</code>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.imagegetinterpolation-parameters">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagegetinterpolation-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagegetinterpolation-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagegetinterpolation-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagesetinterpolation.php" class="function" rel="rdfs-seeAlso">imagesetinterpolation()</a> - Set the interpolation method</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagegetinterpolation.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagegetinterpolation%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagegetinterpolation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagegetinterpolation.php">＋<small>add a note</small></a></span>
