...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.end.php">
 <link rel="shorturl" href="https://www.php.net/end">
 <link rel="alternate" href="https://www.php.net/end" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.each.php">
 <link rel="next" href="https://www.php.net/manual/en/function.extract.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.end.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.end.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.end.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.end.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.end.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.end.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.end.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.end.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.end.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.end.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.end.php" hreflang="zh">
...
<meta name="Description" content="Set the internal pointer of an array to its last element" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: end - Manual" />
<meta name="twitter:description" content="Set the internal pointer of an array to its last element" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: end - Manual" />
<meta itemprop="description" content="Set the internal pointer of an array to its last element" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the internal pointer of an array to its last element" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.end.php' selected="selected">English</option>
            <option value='de/function.end.php'>German</option>
            <option value='es/function.end.php'>Spanish</option>
            <option value='fr/function.end.php'>French</option>
            <option value='it/function.end.php'>Italian</option>
            <option value='ja/function.end.php'>Japanese</option>
            <option value='pt_BR/function.end.php'>Brazilian Portuguese</option>
            <option value='ru/function.end.php'>Russian</option>
            <option value='tr/function.end.php'>Turkish</option>
            <option value='uk/function.end.php'>Ukrainian</option>
            <option value='zh/function.end.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.end" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">end</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">end</span> &mdash; <span class="dc-title">Set the internal pointer of an array to its last element</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.end-returnvalues">
  ...
  <p class="para">
   Returns the value of the last element or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> for empty array.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.array-key-last.php" class="function" rel="rdfs-seeAlso">array_key_last()</a> - Gets the last key of an array</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/end.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.end%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.end&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.end.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">5 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="101193">  <div class="votes">
    <div id="Vu101193">
    <a href="/manual/vote-note.php?id=101193&amp;page=function.end&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd101193">
    <a href="/manual/vote-note.php?id=101193&amp;page=function.end&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V101193" title="81% like this...">
    137
    </div>
  </div>
  <a href="#101193" class="name">
  <strong class="user"><em>franz at develophp dot org</em></strong></a><a class="genanchor" href="#101193"> &para;</a><div class="date" title="2010-12-01 03:06"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101193">
<div class="phpcode"><code><span class="html">It's interesting to note that when creating an array with numeric keys in no particular order, end() will still only return the value that was the last one to be created. So, if you have something like this:
<br />
...
<br /></span>
<br />This will print "0".</span></code></div>
  </div>
 </div>
  <div class="note" id="68052">  <div class="votes">
    <div id="Vu68052">
    <a href="/manual/vote-note.php?id=68052&amp;page=function.end&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd68052">
    <a href="/manual/vote-note.php?id=68052&amp;page=function.end&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V68052" title="72% like this...">
    37
    </div>
  </div>
  <a href="#68052" class="name">
  <strong class="user"><em>jasper at jtey dot com</em></strong></a><a class="genanchor" href="#68052"> &para;</a><div class="date" title="2006-07-11 12:48"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom68052">
<div class="phpcode"><code><span class="html">This function returns the value at the end of the array, but you may sometimes be interested in the key at the end of the array, particularly when working with non integer indexed arrays:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Returns the key at the end of the array<br /></span><span class="keyword">function </span><span class="default">endKey</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">){<br /> </span><span class="default">end</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">);<br /> return </span><span class="default">key</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;<br /></span><br />Usage example:<br /><span class="default">&lt;?php<br />$a </span><span class="keyword">= array(</span><span class="string">"one" </span><span class="keyword">=&gt; </span><span class="string">"apple"</span><span class="keyword">, </span><span class="string">"two" </span><span class="keyword">=&gt; </span><span class="string">"orange"</span><span class="keyword">, </span><span class="string">"three" </span><span class="keyword">=&gt; </span><span class="string">"pear"</span><span class="keyword">);<br />echo </span><span class="default">endKey</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">); </span><span class="comment">// will output "three"<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="107733">  <div class="votes">
    <div id="Vu107733">
    <a href="/manual/vote-note.php?id=107733&amp;page=function.end&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd107733">
    <a href="/manual/vote-note.php?id=107733&amp;page=function.end&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V107733" title="65% like this...">
    24
    </div>
  </div>
  <a href="#107733" class="name">
  <strong class="user"><em>jorge at REMOVETHIS-2upmedia dot com</em></strong></a><a class="genanchor" href="#107733"> &para;</a><div class="date" title="2012-03-01 01:20"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom107733">
<div class="phpcode"><code><span class="html">If all you want is the last item of the array without affecting the internal array pointer just do the following:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">endc</span><span class="keyword">( </span><span class="default">$array </span><span class="keyword">) { return </span><span class="default">end</span><span class="keyword">( </span><span class="default">$array </span><span class="keyword">); }<br /><br /></span><span class="default">$items </span><span class="keyword">= array( </span><span class="string">'one'</span><span class="keyword">, </span><span class="string">'two'</span><span class="keyword">, </span><span class="string">'three' </span><span class="keyword">);<br /></span><span class="default">$lastItem </span><span class="keyword">= </span><span class="default">endc</span><span class="keyword">( </span><span class="default">$items </span><span class="keyword">); </span><span class="comment">// three<br /></span><span class="default">$current </span><span class="keyword">= </span><span class="default">current</span><span class="keyword">( </span><span class="default">$items </span><span class="keyword">); </span><span class="comment">// one<br /></span><span class="default">?&gt;<br /></span><br />This works because the parameter to the function is being sent as a copy, not as a reference to the original variable.</span></code></div>
  </div>
 </div>
  <div class="note" id="24804">  <div class="votes">
    <div id="Vu24804">
    <a href="/manual/vote-note.php?id=24804&amp;page=function.end&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd24804">
    <a href="/manual/vote-note.php?id=24804&amp;page=function.end&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V24804" title="63% like this...">
    32
    </div>
  </div>
  <a href="#24804" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#24804"> &para;</a><div class="date" title="2002-08-28 06:34"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom24804">
<div class="phpcode"><code><span class="html">If you need to get a reference on the first or last element of an array, use these functions because reset() and end() only return you a copy that you cannot dereference directly:
<br />
<br /><span class="default">&lt;?php
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="114978">  <div class="votes">
    <div id="Vu114978">
    <a href="/manual/vote-note.php?id=114978&amp;page=function.end&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114978">
    <a href="/manual/vote-note.php?id=114978&amp;page=function.end&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114978" title="60% like this...">
    13
    </div>
  </div>
  <a href="#114978" class="name">
  <strong class="user"><em>ivijan dot stefan at gmail dot com</em></strong></a><a class="genanchor" href="#114978"> &para;</a><div class="date" title="2014-05-08 04:47"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114978">
<div class="phpcode"><code><span class="html">I found that the function end() is the best for finding extensions  on file name. This function cleans backslashes and takes the extension of a file.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">private function </span><span class="default">extension</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">){<br />    </span><span class="default">$str</span><span class="keyword">=</span><span class="default">implode</span><span class="keyword">(</span><span class="string">""</span><span class="keyword">,</span><span class="default">explode</span><span class="keyword">(</span><span class="string">"\\"</span><span class="keyword">,</span><span class="default">$str</span><span class="keyword">));<br />    </span><span class="default">$str</span><span class="keyword">=</span><span class="default">explode</span><span class="keyword">(</span><span class="string">"."</span><span class="keyword">,</span><span class="default">$str</span><span class="keyword">);<br />    </span><span class="default">$str</span><span class="keyword">=</span><span class="default">strtolower</span><span class="keyword">(</span><span class="default">end</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">));<br />     return </span><span class="default">$str</span><span class="keyword">;<br />}<br /><br /></span><span class="comment">// EXAMPLE:<br /></span><span class="default">$file</span><span class="keyword">=</span><span class="string">'name-Of_soMe.File.txt'</span><span class="keyword">;<br />echo </span><span class="default">extension</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">); </span><span class="comment">// txt<br /></span><span class="default">?&gt;<br /></span><br />Very simple.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.end&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.end.php">＋<small>add a note</small></a></div>
