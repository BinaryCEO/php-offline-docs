...
<head>
  ...
  <title>PHP: cubrid_get_charset - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-get-charset.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-get-charset">
 <link rel="alternate" href="https://www.php.net/cubrid-get-charset" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-get-autocommit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-get-class-name.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-get-charset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-get-charset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-get-charset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-get-charset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-get-charset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-get-charset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-get-charset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-get-charset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-get-charset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-get-charset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-get-charset.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: cubrid_get_charset - Manual" />
<meta name="twitter:description" content="Return the current CUBRID connection charset" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_get_charset - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-get-class-name.php">
          cubrid_get_class_name &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-get-autocommit.php">
          &laquo; cubrid_get_autocommit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-get-charset.php' selected="selected">English</option>
            <option value='de/function.cubrid-get-charset.php'>German</option>
            <option value='es/function.cubrid-get-charset.php'>Spanish</option>
            <option value='fr/function.cubrid-get-charset.php'>French</option>
            <option value='it/function.cubrid-get-charset.php'>Italian</option>
            <option value='ja/function.cubrid-get-charset.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-get-charset.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-get-charset.php'>Russian</option>
            <option value='tr/function.cubrid-get-charset.php'>Turkish</option>
            <option value='uk/function.cubrid-get-charset.php'>Ukrainian</option>
            <option value='zh/function.cubrid-get-charset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-get-charset" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-get-charset-returnvalues">
  ...
  <p class="para">
   A string that represents the CUBRID connection charset on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
<div class="examplescode"><pre class="examplescode">CUBRID current charset: iso8859-1</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.cubrid-get-charset-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.cubrid-client-encoding.php" class="function" rel="rdfs-seeAlso">cubrid_client_encoding()</a> - Return the current CUBRID connection charset</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-get-charset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-get-charset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-get-charset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-get-charset.php">＋<small>add a note</small></a></span>
