...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-col-size.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-col-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-column-names.php">
...
<meta name="Description" content="Get the number of elements in collection type column using OID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_col_size - Manual" />
<meta name="twitter:description" content="Get the number of elements in collection type column using OID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_col_size - Manual" />
<meta itemprop="description" content="Get the number of elements in collection type column using OID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the number of elements in collection type column using OID" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-col-size.php' selected="selected">English</option>
            ...
            <option value='ru/function.cubrid-col-size.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_col_size</span> &mdash; <span class="dc-title">Get the number of elements in collection type column using OID</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-col-size-description">
  ...
  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_col_size()</strong></span> function is used to get the
 ...
 <p class="para">
  ...
  <dd><p class="para">OID the instance that you want to work with.</p></dd>
  
   
  <dt><code class="parameter">attr_name</code></dt>
  <dd><p class="para">Name of the attribute that you want to work with.</p></dd>
  ...
  <p class="para">
    Number of elements, when process is successful, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
<div class="refsect1 changelog" id="refsect1-function.cubrid-col-size-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-col-size-examples">
  ...
  <div class="example" id="example-1221">
   <p><strong>Example #1 <span class="function"><strong>cubrid_col_size()</strong></span> example</strong></p>
...
int(3)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-col-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-col-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-col-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-col-size.php">＋<small>add a note</small></a></span>
