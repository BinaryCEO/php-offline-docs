...
<head>
  ...
  <title>PHP: Memcached::decrementByKey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.decrementbykey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.decrementbykey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.decrementbykey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.decrement.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.delete.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.decrementbykey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.decrementbykey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.decrementbykey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.decrementbykey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.decrementbykey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.decrementbykey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.decrementbykey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.decrementbykey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.decrementbykey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.decrementbykey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.decrementbykey.php" hreflang="zh">
...
<meta name="Description" content="Decrement numeric item's value, stored on a specific server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::decrementByKey - Manual" />
<meta name="twitter:description" content="Decrement numeric item's value, stored on a specific server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::decrementByKey - Manual" />
<meta itemprop="description" content="Decrement numeric item's value, stored on a specific server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decrement numeric item's value, stored on a specific server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="memcached.delete.php">
          Memcached::delete &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.decrement.php">
          &laquo; Memcached::decrement        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.decrementbykey.php' selected="selected">English</option>
            <option value='de/memcached.decrementbykey.php'>German</option>
            <option value='es/memcached.decrementbykey.php'>Spanish</option>
            <option value='fr/memcached.decrementbykey.php'>French</option>
            <option value='it/memcached.decrementbykey.php'>Italian</option>
            <option value='ja/memcached.decrementbykey.php'>Japanese</option>
            <option value='pt_BR/memcached.decrementbykey.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.decrementbykey.php'>Russian</option>
            <option value='tr/memcached.decrementbykey.php'>Turkish</option>
            <option value='uk/memcached.decrementbykey.php'>Ukrainian</option>
            <option value='zh/memcached.decrementbykey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.decrementbykey" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-memcached.decrementbykey-returnvalues">
  ...
  <p class="para">
   Returns item&#039;s new value on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="memcached.incrementbykey.php" class="methodname" rel="rdfs-seeAlso">Memcached::incrementByKey()</a> - Increment numeric item's value, stored on a specific server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/decrementbykey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.decrementbykey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.decrementbykey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.decrementbykey.php">＋<small>add a note</small></a></span>
