...
<head>
  ...
  <title>PHP: imagecolorstotal - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecolorstotal.php">
 <link rel="shorturl" href="https://www.php.net/imagecolorstotal">
 <link rel="alternate" href="https://www.php.net/imagecolorstotal" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecolorsforindex.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecolortransparent.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecolorstotal.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecolorstotal.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecolorstotal.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecolorstotal.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecolorstotal.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecolorstotal.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecolorstotal.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecolorstotal.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecolorstotal.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecolorstotal.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecolorstotal.php" hreflang="zh">
...
<meta name="Description" content="Find out the number of colors in an image's palette" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagecolorstotal - Manual" />
<meta name="twitter:description" content="Find out the number of colors in an image's palette" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecolorstotal - Manual" />
<meta itemprop="description" content="Find out the number of colors in an image's palette" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Find out the number of colors in an image's palette" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagecolortransparent.php">
          imagecolortransparent &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagecolorsforindex.php">
          &laquo; imagecolorsforindex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecolorstotal.php' selected="selected">English</option>
            <option value='de/function.imagecolorstotal.php'>German</option>
            <option value='es/function.imagecolorstotal.php'>Spanish</option>
            <option value='fr/function.imagecolorstotal.php'>French</option>
            <option value='it/function.imagecolorstotal.php'>Italian</option>
            <option value='ja/function.imagecolorstotal.php'>Japanese</option>
            <option value='pt_BR/function.imagecolorstotal.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecolorstotal.php'>Russian</option>
            <option value='tr/function.imagecolorstotal.php'>Turkish</option>
            <option value='uk/function.imagecolorstotal.php'>Ukrainian</option>
            <option value='zh/function.imagecolorstotal.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecolorstotal" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagecolorstotal</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagecolorstotal</span> &mdash; <span class="dc-title">Find out the number of colors in an image&#039;s palette</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagecolorstotal-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagecolorstotal</strong></span>(<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imagecolorstotal-parameters">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagecolorstotal-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagecolorstotal-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.imagecolorstotal-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2853">
    <p><strong>Example #1 Getting total number of colors in an image using <span class="function"><strong>imagecolorstotal()</strong></span></strong></p>
...
<div class="examplescode"><pre class="examplescode">Total colors in image: 128</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagecolorstotal-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imageistruecolor.php" class="function" rel="rdfs-seeAlso">imageistruecolor()</a> - Finds whether an image is a truecolor image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecolorstotal.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecolorstotal%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecolorstotal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecolorstotal.php">＋<small>add a note</small></a></span>
