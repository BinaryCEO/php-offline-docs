...
<head>
  ...
  <title>PHP: Gmagick::shearimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.shearimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.shearimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.shearimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setsize.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.solarizeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.shearimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.shearimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.shearimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.shearimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.shearimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.shearimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.shearimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.shearimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.shearimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.shearimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.shearimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::shearimage - Manual" />
<meta name="twitter:description" content="Creating a parallelogram" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::shearimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.solarizeimage.php">
          Gmagick::solarizeimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setsize.php">
          &laquo; Gmagick::setsize        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.shearimage.php' selected="selected">English</option>
            <option value='de/gmagick.shearimage.php'>German</option>
            <option value='es/gmagick.shearimage.php'>Spanish</option>
            <option value='fr/gmagick.shearimage.php'>French</option>
            <option value='it/gmagick.shearimage.php'>Italian</option>
            <option value='ja/gmagick.shearimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.shearimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.shearimage.php'>Russian</option>
            <option value='tr/gmagick.shearimage.php'>Turkish</option>
            <option value='uk/gmagick.shearimage.php'>Ukrainian</option>
            <option value='zh/gmagick.shearimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.shearimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::shearimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::shearimage</span> &mdash; <span class="dc-title">Creating a parallelogram</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.shearimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::shearimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$color</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$xShear</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$yShear</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
...
The amount of the shear is controlled by a shear angle. For X direction shears, x_shear is measured relative to the
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.shearimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">xShear</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">yShear</code></dt>
     <dd>
      <p class="para">
       The number of degrees to shear the image.
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.shearimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.shearimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/shearimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.shearimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.shearimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.shearimage.php">＋<small>add a note</small></a></span>
