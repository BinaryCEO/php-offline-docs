...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-connect.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-commit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-define-by-name.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-connect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-connect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-connect.php" hreflang="uk">
...
<meta name="Description" content="Connect to an Oracle database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_connect - Manual" />
<meta name="twitter:description" content="Connect to an Oracle database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_connect - Manual" />
<meta itemprop="description" content="Connect to an Oracle database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Connect to an Oracle database" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.oci-define-by-name.php">
          oci_define_by_name &raquo;
              ...
              <div class="prev">
        <a href="function.oci-commit.php">
          &laquo; oci_commit        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-connect.php' selected="selected">English</option>
            ...
            <option value='ru/function.oci-connect.php'>Russian</option>
            <option value='tr/function.oci-connect.php'>Turkish</option>
            <option value='uk/function.oci-connect.php'>Ukrainian</option>
 ...
 <div class="refsect1 seealso" id="refsect1-function.oci-connect-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.oci-close.php" class="function" rel="rdfs-seeAlso">oci_close()</a> - Closes an Oracle connection</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-connect.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">9 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="27061">  <div class="votes">
    <div id="Vu27061">
    <a href="/manual/vote-note.php?id=27061&amp;page=function.oci-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd27061">
    <a href="/manual/vote-note.php?id=27061&amp;page=function.oci-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V27061" title="53% like this...">
    8
    </div>
  </div>
  <a href="#27061" class="name">
  <strong class="user"><em>M0no at ethonfusino dot com</em></strong></a><a class="genanchor" href="#27061"> &para;</a><div class="date" title="2002-11-21 10:04"><strong>22 years ago</strong></div>
...
<br />Hope this helps someone.</span></code></div>
  ...
  <div class="note" id="90816">  <div class="votes">
    <div id="Vu90816">
    <a href="/manual/vote-note.php?id=90816&amp;page=function.oci-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd90816">
    <a href="/manual/vote-note.php?id=90816&amp;page=function.oci-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V90816" title="53% like this...">
    4
    </div>
  </div>
  <a href="#90816" class="name">
  <strong class="user"><em>Leandro da Cunha Campos</em></strong></a><a class="genanchor" href="#90816"> &para;</a><div class="date" title="2009-05-11 11:04"><strong>16 years ago</strong></div>
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="84144">  <div class="votes">
    <div id="Vu84144">
    <a href="/manual/vote-note.php?id=84144&amp;page=function.oci-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd84144">
    <a href="/manual/vote-note.php?id=84144&amp;page=function.oci-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V84144" title="56% like this...">
    3
    </div>
  </div>
  <a href="#84144" class="name">
  <strong class="user"><em>sixd at php dot net</em></strong></a><a class="genanchor" href="#84144"> &para;</a><div class="date" title="2008-06-30 04:33"><strong>17 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">If you want to specify a connection timeout in case there is network problem, you can edit the client side (e.g. PHP side) sqlnet.ora file and set SQLNET.OUTBOUND_CONNECT_TIMEOUT. This sets the upper time limit for establishing a connection right through to the DB, including the time for attempts to connect to other services.   It is available from Oracle 10.2.0.3 onwards.<br /><br />In Oracle 11.1, a slightly lighter-weight solution TCP.CONNECT_TIMEOUT was introduced.  It also is a sqlnet.ora parameter.  It bounds just the TCP connection establishment time, which is mostly where connection problem are seen.<br /><br />The client sqlnet.ora file should be put in the same directory as the tnsnames.ora file.</span></code></div>
  ...
  <div class="note" id="111614">  <div class="votes">
    <div id="Vu111614">
    <a href="/manual/vote-note.php?id=111614&amp;page=function.oci-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111614">
    <a href="/manual/vote-note.php?id=111614&amp;page=function.oci-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111614" title="56% like this...">
    2
    </div>
  </div>
  <a href="#111614" class="name">
  <strong class="user"><em>blake dot lewis at gmail dot com</em></strong></a><a class="genanchor" href="#111614"> &para;</a><div class="date" title="2013-03-08 03:10"><strong>12 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">Using ldap for Oracle name resolution:<br /><br />  The web server will need the environmental variable TNS_ADMIN='Directory of tnsname.ora' unless the default location is used. I use '/etc/tns_admin'. Confirm using the phpinfo().<br /><br />  There are three files needed in the TNS_ADMIN location: tnsnames.ora, sqlnet.ora and ldap.ora. If you are only using ldap, tnsnames.ora is not needed.<br /><br />  To sqlnet.ora add:<br />     NAMES.DIRECTORY_PATH=(TNSNAMES,LDAP)<br /><br />  To ldap.ora add:<br />     DIRECTORY_SERVERS=(ldap_server_fqdn:port)<br />     DEFAULT_ADMIN_CONTEXT=""<br />     DIRECTORY_SERVER_TYPE=OID<br /><br />  For a quick and dirty ldap tnsnames server use tnsManager by Dave Berry. Oracle OID or Openldap can used, but are complicated to setup. tnsManager is a no brainer. The quick part: give it a tnsnames.ora file and start it up. The dirty parts: I can't get Toad and SQLDeveloper to work with it, it ignores the domain and it is no longer being maintained.<br /><br />  The order of values in NAMES.DIRECTORY_PATH in sqlnet.ora determines which look up 'adapter' is used, in this case it is tnsnames.ora file and then ldap. I use ldap for general consumption and tnsnames.ora file to override ldap or entries that are not for general consumption.<br /><br />  If you have the full Oracle client you have tnsping. 'tnsping ORACLE_SID' will tell you what adapter you are using: 'Used LDAP adapter to resolve the alias'.<br /><br /><span class="default">&lt;?php<br />  </span><span class="keyword">echo </span><span class="default">system</span><span class="keyword">(</span><span class="string">"/PATH/tnsping "</span><span class="keyword">.</span><span class="default">$ORACLE_SID</span><span class="keyword">.</span><span class="string">" 2&gt;&amp;1"</span><span class="keyword">).</span><span class="string">"&lt;br /&gt;"</span><span class="keyword">;<br />  echo </span><span class="string">'TNS_ADMIN='</span><span class="keyword">.</span><span class="default">getenv</span><span class="keyword">(</span><span class="string">'TNS_ADMIN'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />ISSUE:<br />  If connecting with only ORACLE_SID and not ORACLE_SID.DB_DOMAIN, the value of NAMES.DEFAULT_DOMAIN from sqlnet.ora is appended, then for some reason PHP tries the HOSTNAME adapter, and if the database name resolves in DNS, it will fail connecting using the database name as the hostname, because neither SID nor SERVICE_NAME are defined.<br />  If using tnsManager append '.ANY_DOMAIN' to $ORACLE_SID to hack around the issue above.<br /><br />  I have tested with:<br />       11.1.0.7 full client and PHP 5.1.6<br />       11.2.0.2 full client and PHP 5.4.11<br /><br />  I have heard that LDAP lookup does not work with older instantclients.</span></code></div>
  ...
  <div class="note" id="69645">  <div class="votes">
    <div id="Vu69645">
    <a href="/manual/vote-note.php?id=69645&amp;page=function.oci-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd69645">
    <a href="/manual/vote-note.php?id=69645&amp;page=function.oci-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V69645" title="53% like this...">
    2
    </div>
  </div>
  <a href="#69645" class="name">
  <strong class="user"><em>sebastien.barbieri _at_ gmail dot com</em></strong></a><a class="genanchor" href="#69645"> &para;</a><div class="date" title="2006-09-13 09:42"><strong>19 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">When you are using Oracle 9.2+ I would say that you MUST use the CHARSET parameter.<br /><br />Of course, you will not notice it until there is accented character... so just specify it and you will avoid a big headache.<br /><br />So for example here is our Oracle internal conf:<br />select * from nls_database_parameters;<br /> <br />PARAMETER                      VALUE<br />------------------------------ ----------------------------------------<br />…<br />NLS_LANGUAGE                   AMERICAN<br />NLS_TERRITORY                  AMERICA<br />NLS_ISO_CURRENCY               AMERICA<br />NLS_CHARACTERSET               WE8ISO8859P15<br />…<br /> <br />And there our oci_connect call:<br /><br />$dbch=ocilogon($user,$pass,$connectString,"WE8ISO8859P15");<br /><br />Without that, you will get question mark (inversed), squares… instead of most accented character.<br /><br />Don’t forget to use that for writing as well as for reading.</span></code></div>
  ...
  <div class="note" id="98431">  <div class="votes">
    <div id="Vu98431">
    <a href="/manual/vote-note.php?id=98431&amp;page=function.oci-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98431">
    <a href="/manual/vote-note.php?id=98431&amp;page=function.oci-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98431" title="52% like this...">
    1
    </div>
  </div>
  <a href="#98431" class="name">
  <strong class="user"><em>Jonathon Robinson</em></strong></a><a class="genanchor" href="#98431"> &para;</a><div class="date" title="2010-06-15 11:12"><strong>15 years ago</strong></div>
...
<br />I originally logged this as a bug but apparently this is the expected behaviour, likely because oci_close($dbh) just calls unset($dbh).</span></code></div>
  ...
  <div class="note" id="91988">  <div class="votes">
    <div id="Vu91988">
    <a href="/manual/vote-note.php?id=91988&amp;page=function.oci-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91988">
    <a href="/manual/vote-note.php?id=91988&amp;page=function.oci-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91988" title="50% like this...">
    0
    </div>
  </div>
  <a href="#91988" class="name">
  <strong class="user"><em>drew dot carmichael at gmail dot com</em></strong></a><a class="genanchor" href="#91988"> &para;</a><div class="date" title="2009-07-03 01:55"><strong>16 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">When using the OCI_CRED_EXT in php <br />if the ENV $ORACLE_SID is set the DB does not need to be specified explicitly and the connection will fail unless you provide a NULL DB value when creating the connection. <br /><br />The $ORACLE_SID trumps the TNS name look up for the connection. So even a manual connection string in the DB parameter will fail.<br /><br />So when the $ORACLE_SID Env is set a NULL passed instead of the DB name connects successfully. <br /><br />Hope this saves some hair pulling when moving to %.3 and OS Authentications</span></code></div>
  ...
  <div class="note" id="54755">  <div class="votes">
    <div id="Vu54755">
    <a href="/manual/vote-note.php?id=54755&amp;page=function.oci-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd54755">
    <a href="/manual/vote-note.php?id=54755&amp;page=function.oci-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V54755" title="37% like this...">
    -4
    </div>
  </div>
  <a href="#54755" class="name">
  <strong class="user"><em>ben at onshop dot co dot uk</em></strong></a><a class="genanchor" href="#54755"> &para;</a><div class="date" title="2005-07-14 05:25"><strong>20 years ago</strong></div>
...
<br />SetEnvIf Request_URI "/path/to/my/directory/connection.oracle.php" ORACLE_PASS=5gHj790j</span></code></div>
  ...
  <div class="note" id="111400">  <div class="votes">
    <div id="Vu111400">
    <a href="/manual/vote-note.php?id=111400&amp;page=function.oci-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111400">
    <a href="/manual/vote-note.php?id=111400&amp;page=function.oci-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111400" title="35% like this...">
    -5
    </div>
  </div>
  <a href="#111400" class="name">
  <strong class="user"><em>blake dot lewis at gmail dot com</em></strong></a><a class="genanchor" href="#111400"> &para;</a><div class="date" title="2013-02-15 11:38"><strong>12 years ago</strong></div>
...
<div class="foot"><a href="/manual/add-note.php?sect=function.oci-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-connect.php">＋<small>add a note</small></a></div>
