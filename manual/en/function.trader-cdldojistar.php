...
<head>
  ...
  <title>PHP: trader_cdldojistar - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-cdldojistar.php">
 <link rel="shorturl" href="https://www.php.net/trader-cdldojistar">
 <link rel="alternate" href="https://www.php.net/trader-cdldojistar" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-cdldoji.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-cdldragonflydoji.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-cdldojistar.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-cdldojistar.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-cdldojistar.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-cdldojistar.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-cdldojistar.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-cdldojistar.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-cdldojistar.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-cdldojistar.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-cdldojistar.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-cdldojistar.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-cdldojistar.php" hreflang="zh">
...
<meta name="Description" content="Doji Star" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_cdldojistar - Manual" />
<meta name="twitter:description" content="Doji Star" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_cdldojistar - Manual" />
<meta itemprop="description" content="Doji Star" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Doji Star" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.trader-cdldragonflydoji.php">
          trader_cdldragonflydoji &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-cdldoji.php">
          &laquo; trader_cdldoji        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-cdldojistar.php' selected="selected">English</option>
            <option value='de/function.trader-cdldojistar.php'>German</option>
            <option value='es/function.trader-cdldojistar.php'>Spanish</option>
            <option value='fr/function.trader-cdldojistar.php'>French</option>
            <option value='it/function.trader-cdldojistar.php'>Italian</option>
            <option value='ja/function.trader-cdldojistar.php'>Japanese</option>
            <option value='pt_BR/function.trader-cdldojistar.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-cdldojistar.php'>Russian</option>
            <option value='tr/function.trader-cdldojistar.php'>Turkish</option>
            <option value='uk/function.trader-cdldojistar.php'>Ukrainian</option>
            <option value='zh/function.trader-cdldojistar.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-cdldojistar" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_cdldojistar</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_cdldojistar</span> &mdash; <span class="dc-title">Doji Star</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-cdldojistar-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_cdldojistar</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$open</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-cdldojistar-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-cdldojistar-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-cdldojistar.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-cdldojistar%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-cdldojistar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-cdldojistar.php">＋<small>add a note</small></a></span>
