...
<head>
  ...
  <title>PHP: Imagick::setImageUnits - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageunits.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageunits.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageunits.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagetype.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagevirtualpixelmethod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageunits.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageunits.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageunits.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageunits.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageunits.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageunits.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageunits.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageunits.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageunits.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageunits.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageunits.php" hreflang="zh">
...
<meta name="Description" content="Sets the image units of resolution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageUnits - Manual" />
<meta name="twitter:description" content="Sets the image units of resolution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageUnits - Manual" />
<meta itemprop="description" content="Sets the image units of resolution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image units of resolution" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimagevirtualpixelmethod.php">
          Imagick::setImageVirtualPixelMethod &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagetype.php">
          &laquo; Imagick::setImageType        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageunits.php' selected="selected">English</option>
            <option value='de/imagick.setimageunits.php'>German</option>
            <option value='es/imagick.setimageunits.php'>Spanish</option>
            <option value='fr/imagick.setimageunits.php'>French</option>
            <option value='it/imagick.setimageunits.php'>Italian</option>
            <option value='ja/imagick.setimageunits.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageunits.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageunits.php'>Russian</option>
            <option value='tr/imagick.setimageunits.php'>Turkish</option>
            <option value='uk/imagick.setimageunits.php'>Ukrainian</option>
            <option value='zh/imagick.setimageunits.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageunits" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageUnits</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageUnits</span> &mdash; <span class="dc-title">Sets the image units of resolution</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimageunits-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageUnits</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$units</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageunits-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageunits-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageunits.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageunits%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageunits&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageunits.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110559">  <div class="votes">
    <div id="Vu110559">
    <a href="/manual/vote-note.php?id=110559&amp;page=imagick.setimageunits&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110559">
    <a href="/manual/vote-note.php?id=110559&amp;page=imagick.setimageunits&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110559" title="100% like this...">
    4
    </div>
  </div>
  <a href="#110559" class="name">
  <strong class="user"><em>euperia at gmail dot com</em></strong></a><a class="genanchor" href="#110559"> &para;</a><div class="date" title="2012-11-07 08:20"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110559">
<div class="phpcode"><code><span class="html">You should use the PHP Imagick constants to correctly set the Image Units, as described here: <br /><br /><a href="http://www.php.net/manual/en/imagick.constants.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/imagick.constants.php</a><br /><br />RESOLUTION constants<br /><br />imagick::RESOLUTION_UNDEFINED (integer)<br />imagick::RESOLUTION_PIXELSPERINCH (integer)<br />imagick::RESOLUTION_PIXELSPERCENTIMETER (integer)</span></code></div>
  </div>
 </div>
  <div class="note" id="87520">  <div class="votes">
    <div id="Vu87520">
    <a href="/manual/vote-note.php?id=87520&amp;page=imagick.setimageunits&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd87520">
    <a href="/manual/vote-note.php?id=87520&amp;page=imagick.setimageunits&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V87520" title="no votes...">
    0
    </div>
  </div>
  <a href="#87520" class="name">
  <strong class="user"><em>salomonsanz at gmail dot com</em></strong></a><a class="genanchor" href="#87520"> &para;</a><div class="date" title="2008-12-08 12:56"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom87520">
<div class="phpcode"><code><span class="html">$source = 'miphoto.jpg';<br />$imagick = new Imagick($source);<br />$imagick -&gt; setImageUnits(2); <br />//0=undefined, 1=pixelsperInch, 2=PixelsPerCentimeter<br />$info = $imagick -&gt; identifyImage();<br />print_r($info);<br />//ouput<br />/*<br />Array <br />( <br />[units] =&gt; PixelsPerCentimeter<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimageunits&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageunits.php">＋<small>add a note</small></a></div>
