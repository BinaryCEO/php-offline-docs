...
<head>
  ...
  <title>PHP: mysql_tablename - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-tablename.php">
 <link rel="shorturl" href="https://www.php.net/mysql-tablename">
 <link rel="alternate" href="https://www.php.net/mysql-tablename" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-stat.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-thread-id.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-tablename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-tablename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-tablename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-tablename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-tablename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-tablename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-tablename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-tablename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-tablename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-tablename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-tablename.php" hreflang="zh">
...
<meta name="Description" content="Get table name of field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_tablename - Manual" />
<meta name="twitter:description" content="Get table name of field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_tablename - Manual" />
<meta itemprop="description" content="Get table name of field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get table name of field" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-thread-id.php">
          mysql_thread_id &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-stat.php">
          &laquo; mysql_stat        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-tablename.php' selected="selected">English</option>
            <option value='de/function.mysql-tablename.php'>German</option>
            <option value='es/function.mysql-tablename.php'>Spanish</option>
            <option value='fr/function.mysql-tablename.php'>French</option>
            <option value='it/function.mysql-tablename.php'>Italian</option>
            <option value='ja/function.mysql-tablename.php'>Japanese</option>
            <option value='pt_BR/function.mysql-tablename.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-tablename.php'>Russian</option>
            <option value='tr/function.mysql-tablename.php'>Turkish</option>
            <option value='uk/function.mysql-tablename.php'>Ukrainian</option>
            <option value='zh/function.mysql-tablename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-tablename" class="refentry">
...
Alternatives to this function include:</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-tablename-returnvalues">
  ...
  <p class="para">
   The name of the table on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
  <p class="para">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-db-name.php" class="function" rel="rdfs-seeAlso">mysql_db_name()</a> - Retrieves database name from the call to mysql_list_dbs</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-tablename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-tablename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-tablename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-tablename.php">＋<small>add a note</small></a></span>
