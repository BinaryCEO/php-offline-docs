...
<head>
  ...
  <title>PHP: ZipArchive::statName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.statname.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.statname.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.statname.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.statindex.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.unchangeall.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.statname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.statname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.statname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.statname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.statname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.statname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.statname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.statname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.statname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.statname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.statname.php" hreflang="zh">
...
<meta name="Description" content="Get the details of an entry defined by its name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::statName - Manual" />
<meta name="twitter:description" content="Get the details of an entry defined by its name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::statName - Manual" />
<meta itemprop="description" content="Get the details of an entry defined by its name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the details of an entry defined by its name" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ziparchive.unchangeall.php">
          ZipArchive::unchangeAll &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.statindex.php">
          &laquo; ZipArchive::statIndex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.statname.php' selected="selected">English</option>
            <option value='de/ziparchive.statname.php'>German</option>
            <option value='es/ziparchive.statname.php'>Spanish</option>
            <option value='fr/ziparchive.statname.php'>French</option>
            <option value='it/ziparchive.statname.php'>Italian</option>
            <option value='ja/ziparchive.statname.php'>Japanese</option>
            <option value='pt_BR/ziparchive.statname.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.statname.php'>Russian</option>
            <option value='tr/ziparchive.statname.php'>Turkish</option>
            <option value='uk/ziparchive.statname.php'>Ukrainian</option>
            <option value='zh/ziparchive.statname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.statname" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ZipArchive::statName</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8, PECL zip &gt;= 1.5.0)</p><p class="refpurpose"><span class="refname">ZipArchive::statName</span> &mdash; <span class="dc-title">Get the details of an entry defined by its name</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-ziparchive.statname-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ZipArchive::statName</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-ziparchive.statname-parameters">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       Also, <strong><code><a href="zip.constants.php#ziparchive.constants.fl-unchanged">ZipArchive::FL_UNCHANGED</a></code></strong> may be ORed to it to request
 ...
 <div class="refsect1 returnvalues" id="refsect1-ziparchive.statname-returnvalues">
...
(
    ...
    [comp_method] =&gt; 8
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/statname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.statname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.statname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.statname.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96991">  <div class="votes">
    <div id="Vu96991">
    <a href="/manual/vote-note.php?id=96991&amp;page=ziparchive.statname&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96991">
    <a href="/manual/vote-note.php?id=96991&amp;page=ziparchive.statname&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96991" title="44% like this...">
    -1
    </div>
  </div>
  <a href="#96991" class="name">
  <strong class="user"><em>Stewart Rice</em></strong></a><a class="genanchor" href="#96991"> &para;</a><div class="date" title="2010-03-26 04:18"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96991">
<div class="phpcode"><code><span class="html">Since a Unix Timestamp is measured in seconds, not milliseconds, I would have to assume that mtime is 'modified time' rather than 'millisecond time'... however it does not appear to work on a Linux system</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=ziparchive.statname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.statname.php">＋<small>add a note</small></a></div>
