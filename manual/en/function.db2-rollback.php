...
<head>
  ...
  <title>PHP: db2_rollback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-rollback.php">
 <link rel="shorturl" href="https://www.php.net/db2-rollback">
 <link rel="alternate" href="https://www.php.net/db2-rollback" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-server-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-rollback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-rollback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-rollback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-rollback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-rollback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-rollback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-rollback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-rollback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-rollback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-rollback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-rollback.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: db2_rollback - Manual" />
<meta name="twitter:description" content="Rolls back a transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_rollback - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-rollback.php' selected="selected">English</option>
            <option value='de/function.db2-rollback.php'>German</option>
            <option value='es/function.db2-rollback.php'>Spanish</option>
            <option value='fr/function.db2-rollback.php'>French</option>
            <option value='it/function.db2-rollback.php'>Italian</option>
            <option value='ja/function.db2-rollback.php'>Japanese</option>
            <option value='pt_BR/function.db2-rollback.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-rollback.php'>Russian</option>
            <option value='tr/function.db2-rollback.php'>Turkish</option>
            <option value='uk/function.db2-rollback.php'>Ukrainian</option>
            <option value='zh/function.db2-rollback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-rollback" class="refentry">
 ...
 <div class="refsect1 seealso" id="refsect1-function.db2-rollback-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-commit.php" class="function" rel="rdfs-seeAlso">db2_commit()</a> - Commits a transaction</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-rollback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-rollback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-rollback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-rollback.php">＋<small>add a note</small></a></span>
