...
<head>
  ...
  <title>PHP: ocicommit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocicommit.php">
 <link rel="shorturl" href="https://www.php.net/ocicommit">
 <link rel="alternate" href="https://www.php.net/ocicommit" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocicolumntyperaw.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocidefinebyname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocicommit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocicommit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocicommit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocicommit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocicommit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocicommit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocicommit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocicommit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocicommit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocicommit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocicommit.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_commit" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocicommit - Manual" />
<meta name="twitter:description" content="Alias of oci_commit" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocicommit - Manual" />
<meta itemprop="description" content="Alias of oci_commit" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_commit" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ocidefinebyname.php">
          ocidefinebyname &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocicolumntyperaw.php">
          &laquo; ocicolumntyperaw        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocicommit.php' selected="selected">English</option>
            <option value='de/function.ocicommit.php'>German</option>
            <option value='es/function.ocicommit.php'>Spanish</option>
            <option value='fr/function.ocicommit.php'>French</option>
            <option value='it/function.ocicommit.php'>Italian</option>
            <option value='ja/function.ocicommit.php'>Japanese</option>
            <option value='pt_BR/function.ocicommit.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocicommit.php'>Russian</option>
            <option value='tr/function.ocicommit.php'>Turkish</option>
            <option value='uk/function.ocicommit.php'>Ukrainian</option>
            <option value='zh/function.ocicommit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocicommit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocicommit</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocicommit</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-commit.php" class="function">oci_commit()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocicommit-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-commit.php" class="function">oci_commit()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocicommit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocicommit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocicommit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocicommit.php">＋<small>add a note</small></a></span>
