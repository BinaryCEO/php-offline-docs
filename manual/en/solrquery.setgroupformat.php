...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setgroupformat.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setgroupformat.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgroupformat.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setgroupfacet.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setgrouplimit.php">
...
<meta name="Description" content="Sets the group format, result structure (group.format parameter)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setGroupFormat - Manual" />
<meta name="twitter:description" content="Sets the group format, result structure (group.format parameter)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setGroupFormat - Manual" />
<meta itemprop="description" content="Sets the group format, result structure (group.format parameter)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the group format, result structure (group.format parameter)" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setgroupformat.php' selected="selected">English</option>
            <option value='de/solrquery.setgroupformat.php'>German</option>
            <option value='es/solrquery.setgroupformat.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::setGroupFormat</span> &mdash; <span class="dc-title">Sets the group format, result structure (group.format parameter)</span></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.setgroupcachepercent.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupCachePercent()</a> - Enables caching for result grouping</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setgroupformat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setgroupformat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setgroupformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setgroupformat.php">＋<small>add a note</small></a></span>
