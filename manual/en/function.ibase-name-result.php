...
<head>
  ...
  <title>PHP: ibase_name_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-name-result.php">
 <link rel="shorturl" href="https://www.php.net/ibase-name-result">
 <link rel="alternate" href="https://www.php.net/ibase-name-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-modify-user.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-num-fields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-name-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-name-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-name-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-name-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-name-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-name-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-name-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-name-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-name-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-name-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-name-result.php" hreflang="zh">
...
<meta name="Description" content="Assigns a name to a result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_name_result - Manual" />
<meta name="twitter:description" content="Assigns a name to a result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_name_result - Manual" />
<meta itemprop="description" content="Assigns a name to a result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Assigns a name to a result set" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-num-fields.php">
          ibase_num_fields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-modify-user.php">
          &laquo; ibase_modify_user        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-name-result.php' selected="selected">English</option>
            <option value='de/function.ibase-name-result.php'>German</option>
            <option value='es/function.ibase-name-result.php'>Spanish</option>
            <option value='fr/function.ibase-name-result.php'>French</option>
            <option value='it/function.ibase-name-result.php'>Italian</option>
            <option value='ja/function.ibase-name-result.php'>Japanese</option>
            <option value='pt_BR/function.ibase-name-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-name-result.php'>Russian</option>
            <option value='tr/function.ibase-name-result.php'>Turkish</option>
            <option value='uk/function.ibase-name-result.php'>Ukrainian</option>
            <option value='zh/function.ibase-name-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-name-result" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_name_result</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_name_result</span> &mdash; <span class="dc-title">Assigns a name to a result set</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-name-result-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_name_result</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   This function assigns a name to a result set. This name can be used later in
   UPDATE|DELETE ... WHERE CURRENT OF <code class="parameter">name</code> statements.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ibase-name-result-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-name-result-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.ibase-name-result-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1329">
    <p><strong>Example #1 <span class="function"><strong>ibase_name_result()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$result </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_query</span><span style="color: #007700">(</span><span style="color: #DD0000">"SELECT field1,field2 FROM table FOR UPDATE"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ibase_name_result</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">, </span><span style="color: #DD0000">"my_cursor"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$updateqry </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_prepare</span><span style="color: #007700">(</span><span style="color: #DD0000">"UPDATE table SET field2 = ? WHERE CURRENT OF my_cursor"</span><span style="color: #007700">);<br /><br />for (</span><span style="color: #0000BB">$i </span><span style="color: #007700">= </span><span style="color: #0000BB">0</span><span style="color: #007700">; </span><span style="color: #0000BB">ibase_fetch_row</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">); ++</span><span style="color: #0000BB">$i</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">ibase_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$updateqry</span><span style="color: #007700">, </span><span style="color: #0000BB">$i</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-name-result-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ibase-prepare.php" class="function" rel="rdfs-seeAlso">ibase_prepare()</a> - Prepare a query for later binding of parameter placeholders and execution</span></li>
    <li><span class="function"><a href="function.ibase-execute.php" class="function" rel="rdfs-seeAlso">ibase_execute()</a> - Execute a previously prepared query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-name-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-name-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-name-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-name-result.php">＋<small>add a note</small></a></span>
