...
<head>
  ...
  <title>PHP: imagecharup - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecharup.php">
 <link rel="shorturl" href="https://www.php.net/imagecharup">
 <link rel="alternate" href="https://www.php.net/imagecharup" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagechar.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecolorallocate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecharup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecharup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecharup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecharup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecharup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecharup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecharup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecharup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecharup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecharup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecharup.php" hreflang="zh">
...
<meta name="Description" content="Draw a character vertically" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagecharup - Manual" />
<meta name="twitter:description" content="Draw a character vertically" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecharup - Manual" />
<meta itemprop="description" content="Draw a character vertically" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draw a character vertically" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagecolorallocate.php">
          imagecolorallocate &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagechar.php">
          &laquo; imagechar        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecharup.php' selected="selected">English</option>
            <option value='de/function.imagecharup.php'>German</option>
            <option value='es/function.imagecharup.php'>Spanish</option>
            <option value='fr/function.imagecharup.php'>French</option>
            <option value='it/function.imagecharup.php'>Italian</option>
            <option value='ja/function.imagecharup.php'>Japanese</option>
            <option value='pt_BR/function.imagecharup.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecharup.php'>Russian</option>
            <option value='tr/function.imagecharup.php'>Turkish</option>
            <option value='uk/function.imagecharup.php'>Ukrainian</option>
            <option value='zh/function.imagecharup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecharup" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagecharup</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagecharup</span> &mdash; <span class="dc-title">Draw a character vertically</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.imagecharup-description">
  ...
  <p class="para rdfs-comment">
   Draws the character <code class="parameter">char</code> vertically at the specified
   coordinate on the given <code class="parameter">image</code>.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.imagecharup-examples">
  ...
  <p class="para">
   <div class="example" id="example-2836">
    <p><strong>Example #1 <span class="function"><strong>imagecharup()</strong></span> example</strong></p>
...
something similar to:</p></div>
    <div class="mediaobject">
     ...
     <div class="imageobject">
      <img src="images/21009b70229598c6a80eef8b45bf282b-imagecharup.png" alt="Output of example : imagecharup()" width="100" height="100" />
     </div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagecharup-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagechar.php" class="function" rel="rdfs-seeAlso">imagechar()</a> - Draw a character horizontally</span></li>
   <li><span class="function"><a href="function.imageloadfont.php" class="function" rel="rdfs-seeAlso">imageloadfont()</a> - Load a new font</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecharup.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecharup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecharup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecharup.php">＋<small>add a note</small></a></span>
