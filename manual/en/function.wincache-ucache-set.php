...
<head>
  ...
  <title>PHP: wincache_ucache_set - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-ucache-set.php">
 <link rel="shorturl" href="https://www.php.net/wincache-ucache-set">
 <link rel="alternate" href="https://www.php.net/wincache-ucache-set" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-ucache-meminfo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-unlock.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-ucache-set.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-ucache-set.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-ucache-set.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-ucache-set.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-ucache-set.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-ucache-set.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-ucache-set.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-ucache-set.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-ucache-set.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-ucache-set.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-ucache-set.php" hreflang="zh">
...
<meta name="Description" content="Adds a variable in user cache and overwrites a variable if it already exists in the cache" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_ucache_set - Manual" />
<meta name="twitter:description" content="Adds a variable in user cache and overwrites a variable if it already exists in the cache" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_ucache_set - Manual" />
<meta itemprop="description" content="Adds a variable in user cache and overwrites a variable if it already exists in the cache" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds a variable in user cache and overwrites a variable if it already exists in the cache" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.wincache-unlock.php">
          wincache_unlock &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-ucache-meminfo.php">
          &laquo; wincache_ucache_meminfo        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-ucache-set.php' selected="selected">English</option>
            <option value='de/function.wincache-ucache-set.php'>German</option>
            <option value='es/function.wincache-ucache-set.php'>Spanish</option>
            <option value='fr/function.wincache-ucache-set.php'>French</option>
            <option value='it/function.wincache-ucache-set.php'>Italian</option>
            <option value='ja/function.wincache-ucache-set.php'>Japanese</option>
            <option value='pt_BR/function.wincache-ucache-set.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-ucache-set.php'>Russian</option>
            <option value='tr/function.wincache-ucache-set.php'>Turkish</option>
            <option value='uk/function.wincache-ucache-set.php'>Ukrainian</option>
            <option value='zh/function.wincache-ucache-set.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-ucache-set" class="refentry">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       This paramter is ignored if first argument is an array. A general guidance is to pass <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> 
   ...
   <ul class="simplelist">
    ...
    <li><a href="language.oop5.magic.php#object.sleep" class="link">__sleep()</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-ucache-set.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-ucache-set%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-ucache-set&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-ucache-set.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96577">  <div class="votes">
    <div id="Vu96577">
    <a href="/manual/vote-note.php?id=96577&amp;page=function.wincache-ucache-set&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96577">
    <a href="/manual/vote-note.php?id=96577&amp;page=function.wincache-ucache-set&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96577" title="no votes...">
    0
    </div>
  </div>
  <a href="#96577" class="name">
  <strong class="user"><em>don dot raman at microsoft dot com</em></strong></a><a class="genanchor" href="#96577"> &para;</a><div class="date" title="2010-03-05 12:08"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96577">
<div class="phpcode"><code><span class="html">As of writing this note (PHP 5.3.1) serialization of closure is not allowed.<br /><br />This means a code like the one below:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">//Closure<br /></span><span class="default">$bar3 </span><span class="keyword">= function(</span><span class="default">$a</span><span class="keyword">) {<br />    return </span><span class="default">$a </span><span class="keyword">* </span><span class="default">2</span><span class="keyword">;<br />};<br /></span><span class="default">wincache_ucache_set</span><span class="keyword">(</span><span class="string">'foo3'</span><span class="keyword">, </span><span class="default">$bar3</span><span class="keyword">);<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">wincache_ucache_get</span><span class="keyword">(</span><span class="string">'foo3'</span><span class="keyword">));<br />echo </span><span class="string">"&lt;br&gt;"</span><span class="keyword">;<br /></span><span class="default">?&gt;</span> <br /><br />Will throw exception:<br />[11-Feb-2010 09:25:33] PHP Fatal error:  Uncaught exception 'Exception' with message 'Serialization of 'Closure' is not allowed' in C:\inetpub\wwwroot\phptest\tests\ucache\wincache15.php:6<br />Stack trace:<br />#0 C:\inetpub\wwwroot\phptest\tests\ucache\wincache15.php(6): wincache_ucache_set('foo3', Object(Closure))<br />#1 {main}<br />  thrown in C:\inetpub\wwwroot\phptest\tests\ucache\wincache15.php on line 6<br /><br />However one catch this exception like:<br /><span class="default">&lt;?php<br /></span><span class="comment">//Closure<br /></span><span class="default">$bar3 </span><span class="keyword">= function(</span><span class="default">$a</span><span class="keyword">) {<br />    return </span><span class="default">$a </span><span class="keyword">* </span><span class="default">2</span><span class="keyword">;<br />};<br />try<br />{<br />    </span><span class="default">wincache_ucache_set</span><span class="keyword">(</span><span class="string">'foo3'</span><span class="keyword">, </span><span class="default">$bar3</span><span class="keyword">);<br />}<br />catch (</span><span class="default">Exception $e</span><span class="keyword">)<br />{<br />    </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$e</span><span class="keyword">-&gt;</span><span class="default">getMessage</span><span class="keyword">());<br />}<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">wincache_ucache_get</span><span class="keyword">(</span><span class="string">'foo3'</span><span class="keyword">));<br />echo </span><span class="string">"&lt;br&gt;"</span><span class="keyword">;<br /></span><span class="default">?&gt;</span> <br /><br />This will generate output as shown beloe:<br />string(41) "Serialization of 'Closure' is not allowed" NULL</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.wincache-ucache-set&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-ucache-set.php">＋<small>add a note</small></a></div>
