...
<head>
  ...
  <title>PHP: Gmagick::getimagedispose - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagedispose.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagedispose.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagedispose.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagedepth.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimageextrema.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagedispose.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagedispose.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagedispose.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagedispose.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagedispose.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagedispose.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagedispose.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagedispose.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagedispose.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagedispose.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagedispose.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimagedispose - Manual" />
<meta name="twitter:description" content="Gets the image disposal method" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagedispose - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimageextrema.php">
          Gmagick::getimageextrema &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagedepth.php">
          &laquo; Gmagick::getimagedepth        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagedispose.php' selected="selected">English</option>
            <option value='de/gmagick.getimagedispose.php'>German</option>
            <option value='es/gmagick.getimagedispose.php'>Spanish</option>
            <option value='fr/gmagick.getimagedispose.php'>French</option>
            <option value='it/gmagick.getimagedispose.php'>Italian</option>
            <option value='ja/gmagick.getimagedispose.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagedispose.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagedispose.php'>Russian</option>
            <option value='tr/gmagick.getimagedispose.php'>Turkish</option>
            <option value='uk/gmagick.getimagedispose.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagedispose.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagedispose" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagedispose</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagedispose</span> &mdash; <span class="dc-title">Gets the image disposal method</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagedispose-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagedispose</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagedispose-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagedispose-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagedispose-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagedispose.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagedispose%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagedispose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagedispose.php">＋<small>add a note</small></a></span>
