...
<head>
  ...
  <title>PHP: Imagick::unsharpMaskImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.unsharpmaskimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.unsharpmaskimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.unsharpmaskimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.uniqueimagecolors.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.valid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.unsharpmaskimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.unsharpmaskimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.unsharpmaskimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.unsharpmaskimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.unsharpmaskimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.unsharpmaskimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.unsharpmaskimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.unsharpmaskimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.unsharpmaskimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.unsharpmaskimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.unsharpmaskimage.php" hreflang="zh">
...
<meta name="Description" content="Sharpens an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::unsharpMaskImage - Manual" />
<meta name="twitter:description" content="Sharpens an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::unsharpMaskImage - Manual" />
<meta itemprop="description" content="Sharpens an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sharpens an image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.valid.php">
          Imagick::valid &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.uniqueimagecolors.php">
          &laquo; Imagick::uniqueImageColors        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.unsharpmaskimage.php' selected="selected">English</option>
            <option value='de/imagick.unsharpmaskimage.php'>German</option>
            <option value='es/imagick.unsharpmaskimage.php'>Spanish</option>
            <option value='fr/imagick.unsharpmaskimage.php'>French</option>
            <option value='it/imagick.unsharpmaskimage.php'>Italian</option>
            <option value='ja/imagick.unsharpmaskimage.php'>Japanese</option>
            <option value='pt_BR/imagick.unsharpmaskimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.unsharpmaskimage.php'>Russian</option>
            <option value='tr/imagick.unsharpmaskimage.php'>Turkish</option>
            <option value='uk/imagick.unsharpmaskimage.php'>Ukrainian</option>
            <option value='zh/imagick.unsharpmaskimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.unsharpmaskimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::unsharpMaskImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::unsharpMaskImage</span> &mdash; <span class="dc-title">Sharpens an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.unsharpmaskimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::unsharpMaskImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$sigma</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$amount</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$threshold</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.unsharpmaskimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.unsharpmaskimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.unsharpmaskimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-3141">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/unsharpmaskimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.unsharpmaskimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.unsharpmaskimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.unsharpmaskimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="89160">  <div class="votes">
    <div id="Vu89160">
    <a href="/manual/vote-note.php?id=89160&amp;page=imagick.unsharpmaskimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd89160">
    <a href="/manual/vote-note.php?id=89160&amp;page=imagick.unsharpmaskimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V89160" title="66% like this...">
    1
    </div>
  </div>
  <a href="#89160" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#89160"> &para;</a><div class="date" title="2009-02-24 08:00"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom89160">
<div class="phpcode"><code><span class="html">Prepare photo for web
<br />
<br /><span class="default">&lt;?php
<br />$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$SrcFile</span><span class="keyword">);
<br />
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">resizeImage </span><span class="keyword">( </span><span class="default">$Width</span><span class="keyword">, </span><span class="default">$Height </span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">FILTER_QUADRATIC </span><span class="keyword">, </span><span class="default">1 </span><span class="keyword">);
<br />        
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">normalizeImage</span><span class="keyword">();
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">unsharpMaskImage</span><span class="keyword">(</span><span class="default">0 </span><span class="keyword">, </span><span class="default">0.5 </span><span class="keyword">, </span><span class="default">1 </span><span class="keyword">, </span><span class="default">0.05</span><span class="keyword">);
<br />        
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">( </span><span class="string">"jpg" </span><span class="keyword">);
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setCompressionQuality</span><span class="keyword">(</span><span class="default">75</span><span class="keyword">);
<br />
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">( </span><span class="default">$OutFile </span><span class="keyword">);
<br />        
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">removeImage</span><span class="keyword">();
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.unsharpmaskimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.unsharpmaskimage.php">＋<small>add a note</small></a></div>
