...
<head>
  ...
  <title>PHP: dio_seek - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.dio-seek.php">
 <link rel="shorturl" href="https://www.php.net/dio-seek">
 <link rel="alternate" href="https://www.php.net/dio-seek" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.dio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.dio-read.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dio-stat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.dio-seek.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.dio-seek.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.dio-seek.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.dio-seek.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.dio-seek.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.dio-seek.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.dio-seek.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.dio-seek.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.dio-seek.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.dio-seek.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.dio-seek.php" hreflang="zh">
...
<meta name="Description" content="Seeks to pos on fd from whence" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: dio_seek - Manual" />
<meta name="twitter:description" content="Seeks to pos on fd from whence" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: dio_seek - Manual" />
<meta itemprop="description" content="Seeks to pos on fd from whence" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Seeks to pos on fd from whence" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.dio-seek.php' selected="selected">English</option>
            <option value='de/function.dio-seek.php'>German</option>
            <option value='es/function.dio-seek.php'>Spanish</option>
            <option value='fr/function.dio-seek.php'>French</option>
            <option value='it/function.dio-seek.php'>Italian</option>
            <option value='ja/function.dio-seek.php'>Japanese</option>
            <option value='pt_BR/function.dio-seek.php'>Brazilian Portuguese</option>
            <option value='ru/function.dio-seek.php'>Russian</option>
            <option value='tr/function.dio-seek.php'>Turkish</option>
            <option value='uk/function.dio-seek.php'>Ukrainian</option>
            <option value='zh/function.dio-seek.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.dio-seek" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$fd </span><span style="color: #007700">= </span><span style="color: #0000BB">dio_open</span><span style="color: #007700">(</span><span style="color: #DD0000">'/dev/ttyS0'</span><span style="color: #007700">, </span><span style="color: #0000BB">O_RDWR</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">dio_seek</span><span style="color: #007700">(</span><span style="color: #0000BB">$fd</span><span style="color: #007700">, </span><span style="color: #0000BB">10</span><span style="color: #007700">, </span><span style="color: #0000BB">SEEK_SET</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">// position is now at 10 characters from the start of the file<br /><br /></span><span style="color: #0000BB">dio_seek</span><span style="color: #007700">(</span><span style="color: #0000BB">$fd</span><span style="color: #007700">, -</span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">SEEK_CUR</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">// position is now at 8 characters from the start of the file<br /><br /></span><span style="color: #0000BB">dio_seek</span><span style="color: #007700">(</span><span style="color: #0000BB">$fd</span><span style="color: #007700">, -</span><span style="color: #0000BB">5</span><span style="color: #007700">, </span><span style="color: #0000BB">SEEK_END</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">// position is now at 5 characters from the end of the file<br /><br /></span><span style="color: #0000BB">dio_seek</span><span style="color: #007700">(</span><span style="color: #0000BB">$fd</span><span style="color: #007700">, </span><span style="color: #0000BB">10</span><span style="color: #007700">, </span><span style="color: #0000BB">SEEK_END</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">// position is now at 10 characters past the end of the file. <br />// The 10 characters between the end of the file and the current<br />// position are filled with zeros.<br /><br /></span><span style="color: #0000BB">dio_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$fd</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dio/functions/dio-seek.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.dio-seek%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.dio-seek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dio-seek.php">＋<small>add a note</small></a></span>
