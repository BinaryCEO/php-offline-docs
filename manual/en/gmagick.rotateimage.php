...
<head>
  ...
  <title>PHP: Gmagick::rotateimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.rotateimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.rotateimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.rotateimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.rollimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.scaleimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.rotateimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.rotateimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.rotateimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.rotateimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.rotateimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.rotateimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.rotateimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.rotateimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.rotateimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.rotateimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.rotateimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::rotateimage - Manual" />
<meta name="twitter:description" content="Rotates an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::rotateimage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.scaleimage.php">
          Gmagick::scaleimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.rollimage.php">
          &laquo; Gmagick::rollimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.rotateimage.php' selected="selected">English</option>
            <option value='de/gmagick.rotateimage.php'>German</option>
            <option value='es/gmagick.rotateimage.php'>Spanish</option>
            <option value='fr/gmagick.rotateimage.php'>French</option>
            <option value='it/gmagick.rotateimage.php'>Italian</option>
            <option value='ja/gmagick.rotateimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.rotateimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.rotateimage.php'>Russian</option>
            <option value='tr/gmagick.rotateimage.php'>Turkish</option>
            <option value='uk/gmagick.rotateimage.php'>Ukrainian</option>
            <option value='zh/gmagick.rotateimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.rotateimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::rotateimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::rotateimage</span> &mdash; <span class="dc-title">Rotates an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.rotateimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::rotateimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$color</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$degrees</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.rotateimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.rotateimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.rotateimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/rotateimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.rotateimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.rotateimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.rotateimage.php">＋<small>add a note</small></a></span>
