...
<head>
  ...
  <title>PHP: Memcached::deleteMultiByKey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.deletemultibykey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.deletemultibykey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.deletemultibykey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.deletemulti.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.fetch.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.deletemultibykey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.deletemultibykey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.deletemultibykey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.deletemultibykey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.deletemultibykey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.deletemultibykey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.deletemultibykey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.deletemultibykey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.deletemultibykey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.deletemultibykey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.deletemultibykey.php" hreflang="zh">
...
<meta name="Description" content="Delete multiple items from a specific server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::deleteMultiByKey - Manual" />
<meta name="twitter:description" content="Delete multiple items from a specific server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::deleteMultiByKey - Manual" />
<meta itemprop="description" content="Delete multiple items from a specific server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete multiple items from a specific server" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="memcached.fetch.php">
          Memcached::fetch &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.deletemulti.php">
          &laquo; Memcached::deleteMulti        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.deletemultibykey.php' selected="selected">English</option>
            <option value='de/memcached.deletemultibykey.php'>German</option>
            <option value='es/memcached.deletemultibykey.php'>Spanish</option>
            <option value='fr/memcached.deletemultibykey.php'>French</option>
            <option value='it/memcached.deletemultibykey.php'>Italian</option>
            <option value='ja/memcached.deletemultibykey.php'>Japanese</option>
            <option value='pt_BR/memcached.deletemultibykey.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.deletemultibykey.php'>Russian</option>
            <option value='tr/memcached.deletemultibykey.php'>Turkish</option>
            <option value='uk/memcached.deletemultibykey.php'>Ukrainian</option>
            <option value='zh/memcached.deletemultibykey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.deletemultibykey" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Memcached::deleteMultiByKey</h1>
  <p class="verinfo">(PECL memcached &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">Memcached::deleteMultiByKey</span> &mdash; <span class="dc-title">Delete multiple items from a specific server</span></p>
 ...
 <div class="refsect1 description" id="refsect1-memcached.deletemultibykey-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::deleteMultiByKey()</strong></span> is functionally equivalent to
   <span class="methodname"><a href="memcached.deletemulti.php" class="methodname">Memcached::deleteMulti()</a></span>, except that the free-form
 ...
 <div class="refsect1 returnvalues" id="refsect1-memcached.deletemultibykey-returnvalues">
  ...
  <p class="para">
   Returns an array indexed by <code class="parameter">keys</code>. Each element
   is <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the corresponding key was deleted, or one of the
   <strong><code><a href="memcached.constants.php#memcached.constants.res-success">Memcached::RES_<span class="replaceable">*</span></a></code></strong> constants if the corresponding deletion
   failed.
   </p>
  <p class="para">
   ...
   operation for the last element of <code class="parameter">keys</code>.
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-memcached.deletemultibykey-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="memcached.delete.php" class="methodname" rel="rdfs-seeAlso">Memcached::delete()</a> - Delete an item</span></li>
    ...
    <li><span class="methodname"><a href="memcached.deletemulti.php" class="methodname" rel="rdfs-seeAlso">Memcached::deleteMulti()</a> - Delete multiple items</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/deletemultibykey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.deletemultibykey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.deletemultibykey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.deletemultibykey.php">＋<small>add a note</small></a></span>
