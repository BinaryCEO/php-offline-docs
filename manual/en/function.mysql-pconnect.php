...
<head>
  ...
  <title>PHP: mysql_pconnect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-pconnect.php">
 <link rel="shorturl" href="https://www.php.net/mysql-pconnect">
 <link rel="alternate" href="https://www.php.net/mysql-pconnect" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-num-rows.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-ping.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-pconnect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-pconnect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-pconnect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-pconnect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-pconnect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-pconnect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-pconnect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-pconnect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-pconnect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-pconnect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-pconnect.php" hreflang="zh">
...
<meta name="Description" content="Open a persistent connection to a MySQL server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_pconnect - Manual" />
<meta name="twitter:description" content="Open a persistent connection to a MySQL server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_pconnect - Manual" />
<meta itemprop="description" content="Open a persistent connection to a MySQL server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open a persistent connection to a MySQL server" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-ping.php">
          mysql_ping &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-num-rows.php">
          &laquo; mysql_num_rows        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-pconnect.php' selected="selected">English</option>
            <option value='de/function.mysql-pconnect.php'>German</option>
            <option value='es/function.mysql-pconnect.php'>Spanish</option>
            <option value='fr/function.mysql-pconnect.php'>French</option>
            <option value='it/function.mysql-pconnect.php'>Italian</option>
            <option value='ja/function.mysql-pconnect.php'>Japanese</option>
            <option value='pt_BR/function.mysql-pconnect.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-pconnect.php'>Russian</option>
            <option value='tr/function.mysql-pconnect.php'>Turkish</option>
            <option value='uk/function.mysql-pconnect.php'>Ukrainian</option>
            <option value='zh/function.mysql-pconnect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-pconnect" class="refentry">
   ...
   <ul class="simplelist">
    ...
    Database Connections</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-pconnect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-pconnect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-pconnect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-pconnect.php">＋<small>add a note</small></a></span>
