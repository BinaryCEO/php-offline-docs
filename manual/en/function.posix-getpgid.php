...
<head>
  ...
  <title>PHP: posix_getpgid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-getpgid.php">
 <link rel="shorturl" href="https://www.php.net/posix-getpgid">
 <link rel="alternate" href="https://www.php.net/posix-getpgid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-getlogin.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-getpgrp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-getpgid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-getpgid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-getpgid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-getpgid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-getpgid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-getpgid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-getpgid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-getpgid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-getpgid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-getpgid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-getpgid.php" hreflang="zh">
...
<meta name="Description" content="Get process group id for job control" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_getpgid - Manual" />
<meta name="twitter:description" content="Get process group id for job control" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_getpgid - Manual" />
<meta itemprop="description" content="Get process group id for job control" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get process group id for job control" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.posix-getpgrp.php">
          posix_getpgrp &raquo;
              ...
              <div class="prev">
        <a href="function.posix-getlogin.php">
          &laquo; posix_getlogin        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-getpgid.php' selected="selected">English</option>
            <option value='de/function.posix-getpgid.php'>German</option>
            <option value='es/function.posix-getpgid.php'>Spanish</option>
            <option value='fr/function.posix-getpgid.php'>French</option>
            <option value='it/function.posix-getpgid.php'>Italian</option>
            <option value='ja/function.posix-getpgid.php'>Japanese</option>
            <option value='pt_BR/function.posix-getpgid.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-getpgid.php'>Russian</option>
            <option value='tr/function.posix-getpgid.php'>Turkish</option>
            <option value='uk/function.posix-getpgid.php'>Ukrainian</option>
            <option value='zh/function.posix-getpgid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-getpgid" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">posix_getpgid</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_getpgid</span> &mdash; <span class="dc-title">Get process group id for job control</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.posix-getpgid-description">
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">process_id</code> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.posix-getpgid-examples">
  ...
  <p class="para">
   <div class="example" id="example-3583">
    <p><strong>Example #1 Example use of <span class="function"><strong>posix_getpgid()</strong></span></strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pid </span><span style="color: #007700">= </span><span style="color: #0000BB">posix_getppid</span><span style="color: #007700">();<br />echo </span><span style="color: #0000BB">posix_getpgid</span><span style="color: #007700">(</span><span style="color: #0000BB">$pid</span><span style="color: #007700">); </span><span style="color: #FF8000">//35<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.posix-getpgid-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.posix-getppid.php" class="function" rel="rdfs-seeAlso">posix_getppid()</a> - Return the parent process identifier</span></li>
    <li>man page SETPGID(2)</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-getpgid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-getpgid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-getpgid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getpgid.php">＋<small>add a note</small></a></span>
