...
<head>
  ...
  <title>PHP: wincache_ucache_add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-ucache-add.php">
 <link rel="shorturl" href="https://www.php.net/wincache-ucache-add">
 <link rel="alternate" href="https://www.php.net/wincache-ucache-add" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-scache-meminfo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-ucache-cas.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-ucache-add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-ucache-add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-ucache-add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-ucache-add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-ucache-add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-ucache-add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-ucache-add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-ucache-add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-ucache-add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-ucache-add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-ucache-add.php" hreflang="zh">
...
<meta name="Description" content="Adds a variable in user cache only if variable does not already exist in the cache" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_ucache_add - Manual" />
<meta name="twitter:description" content="Adds a variable in user cache only if variable does not already exist in the cache" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_ucache_add - Manual" />
<meta itemprop="description" content="Adds a variable in user cache only if variable does not already exist in the cache" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds a variable in user cache only if variable does not already exist in the cache" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.wincache-ucache-cas.php">
          wincache_ucache_cas &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-scache-meminfo.php">
          &laquo; wincache_scache_meminfo        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-ucache-add.php' selected="selected">English</option>
            <option value='de/function.wincache-ucache-add.php'>German</option>
            <option value='es/function.wincache-ucache-add.php'>Spanish</option>
            <option value='fr/function.wincache-ucache-add.php'>French</option>
            <option value='it/function.wincache-ucache-add.php'>Italian</option>
            <option value='ja/function.wincache-ucache-add.php'>Japanese</option>
            <option value='pt_BR/function.wincache-ucache-add.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-ucache-add.php'>Russian</option>
            <option value='tr/function.wincache-ucache-add.php'>Turkish</option>
            <option value='uk/function.wincache-ucache-add.php'>Ukrainian</option>
            <option value='zh/function.wincache-ucache-add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-ucache-add" class="refentry">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       will fail and return <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>. <code class="parameter">key</code> is case sensitive. To override the value even if 
       <code class="parameter">key</code> is present use <span class="function"><a href="function.wincache-ucache-set.php" class="function">wincache_ucache_set()</a></span> function instad. 
   ...
   <ul class="simplelist">
    ...
    <li><a href="language.oop5.magic.php#object.sleep" class="link">__sleep()</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-ucache-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-ucache-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-ucache-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-ucache-add.php">＋<small>add a note</small></a></span>
