...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.averageimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.averageimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.averageimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.autolevelimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.blackthresholdimage.php">
...
<meta name="Description" content="Average a set of images" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::averageImages - Manual" />
<meta name="twitter:description" content="Average a set of images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::averageImages - Manual" />
<meta itemprop="description" content="Average a set of images" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Average a set of images" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.averageimages.php' selected="selected">English</option>
            ...
            <option value='tr/imagick.averageimages.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::averageImages</span> &mdash; <span class="dc-title">Average a set of images</span></p>

 </div>

 <div id="imagick.averageimages-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.averageimages-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::averageImages</strong></span>(): <span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span></div>
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/averageimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.averageimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.averageimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.averageimages.php">＋<small>add a note</small></a></span>
