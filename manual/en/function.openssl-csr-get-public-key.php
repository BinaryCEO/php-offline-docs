...
<head>
  ...
  <title>PHP: openssl_csr_get_public_key - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-csr-get-public-key.php">
 <link rel="shorturl" href="https://www.php.net/openssl-csr-get-public-key">
 <link rel="alternate" href="https://www.php.net/openssl-csr-get-public-key" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-csr-export-to-file.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-csr-get-subject.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-csr-get-public-key.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-csr-get-public-key.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-csr-get-public-key.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-csr-get-public-key.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-csr-get-public-key.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-csr-get-public-key.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-csr-get-public-key.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-csr-get-public-key.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-csr-get-public-key.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-csr-get-public-key.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-csr-get-public-key.php" hreflang="zh">
...
<meta name="Description" content="Returns the public key of a CSR" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_csr_get_public_key - Manual" />
<meta name="twitter:description" content="Returns the public key of a CSR" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_csr_get_public_key - Manual" />
<meta itemprop="description" content="Returns the public key of a CSR" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the public key of a CSR" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-csr-get-subject.php">
          openssl_csr_get_subject &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-csr-export-to-file.php">
          &laquo; openssl_csr_export_to_file        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-csr-get-public-key.php' selected="selected">English</option>
            <option value='de/function.openssl-csr-get-public-key.php'>German</option>
            <option value='es/function.openssl-csr-get-public-key.php'>Spanish</option>
            <option value='fr/function.openssl-csr-get-public-key.php'>French</option>
            <option value='it/function.openssl-csr-get-public-key.php'>Italian</option>
            <option value='ja/function.openssl-csr-get-public-key.php'>Japanese</option>
            <option value='pt_BR/function.openssl-csr-get-public-key.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-csr-get-public-key.php'>Russian</option>
            <option value='tr/function.openssl-csr-get-public-key.php'>Turkish</option>
            <option value='uk/function.openssl-csr-get-public-key.php'>Ukrainian</option>
            <option value='zh/function.openssl-csr-get-public-key.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-csr-get-public-key" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.openssl-csr-get-public-key-examples">
  ...
  <p class="para">
   <div class="example" id="example-1015">
    <p><strong>Example #1 openssl_csr_get_public_key() example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.openssl-pkey-export.php" class="function" rel="rdfs-seeAlso">openssl_pkey_export()</a> - Gets an exportable representation of a key into a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-csr-get-public-key.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-csr-get-public-key%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-csr-get-public-key&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-csr-get-public-key.php">＋<small>add a note</small></a></span>
