...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-div-qr.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-div-q.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-div-r.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-div-qr.php' selected="selected">English</option>
            <option value='de/function.gmp-div-qr.php'>German</option>
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-div-qr-examples">
  ...
  <p class="para">
   <div class="example" id="example-3319">
    <p><strong>Example #1 Division of GMP numbers</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.gmp-div-r.php" class="function" rel="rdfs-seeAlso">gmp_div_r()</a> - Remainder of the division of numbers</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-div-qr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-div-qr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-div-qr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-div-qr.php">＋<small>add a note</small></a></span>
