...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.solrillegaloperationexception.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/solrillegalargumentexception.getinternalinfo.php">
 <link rel="next" href="https://www.php.net/manual/en/solrillegaloperationexception.getinternalinfo.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.solrillegaloperationexception.php' selected="selected">English</option>
            ...
            <option value='zh/class.solrillegaloperationexception.php'>Chinese (Simplified)</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="solrillegaloperationexception.getinternalinfo.php">SolrIllegalOperationException::getInternalInfo</a> — Returns internal information where the Exception was thrown</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrillegaloperationexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.solrillegaloperationexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.solrillegaloperationexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.solrillegaloperationexception.php">＋<small>add a note</small></a></span>
