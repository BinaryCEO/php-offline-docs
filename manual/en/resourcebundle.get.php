...
<head>
  ...
  <title>PHP: ResourceBundle::get - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/resourcebundle.get.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/resourcebundle.get.php">
 <link rel="alternate" href="https://www.php.net/manual/en/resourcebundle.get.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.resourcebundle.php">
 <link rel="prev" href="https://www.php.net/manual/en/resourcebundle.create.php">
 <link rel="next" href="https://www.php.net/manual/en/resourcebundle.geterrorcode.php">

 <link rel="alternate" href="https://www.php.net/manual/en/resourcebundle.get.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/resourcebundle.get.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/resourcebundle.get.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/resourcebundle.get.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/resourcebundle.get.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/resourcebundle.get.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/resourcebundle.get.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/resourcebundle.get.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/resourcebundle.get.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/resourcebundle.get.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/resourcebundle.get.php" hreflang="zh">
...
<meta name="Description" content="Get data from the bundle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ResourceBundle::get - Manual" />
<meta name="twitter:description" content="Get data from the bundle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ResourceBundle::get - Manual" />
<meta itemprop="description" content="Get data from the bundle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get data from the bundle" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="resourcebundle.geterrorcode.php">
          ResourceBundle::getErrorCode &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="resourcebundle.create.php">
          &laquo; ResourceBundle::create        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/resourcebundle.get.php' selected="selected">English</option>
            <option value='de/resourcebundle.get.php'>German</option>
            <option value='es/resourcebundle.get.php'>Spanish</option>
            <option value='fr/resourcebundle.get.php'>French</option>
            <option value='it/resourcebundle.get.php'>Italian</option>
            <option value='ja/resourcebundle.get.php'>Japanese</option>
            <option value='pt_BR/resourcebundle.get.php'>Brazilian Portuguese</option>
            <option value='ru/resourcebundle.get.php'>Russian</option>
            <option value='tr/resourcebundle.get.php'>Turkish</option>
            <option value='uk/resourcebundle.get.php'>Ukrainian</option>
            <option value='zh/resourcebundle.get.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="resourcebundle.get" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-resourcebundle.get-examples">
  ...
  <div class="example" id="example-2666">
   <p><strong>Example #1 <span class="function"><strong>resourcebundle_get()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$r </span><span style="color: #007700">= </span><span style="color: #0000BB">resourcebundle_create</span><span style="color: #007700">( </span><span style="color: #DD0000">'es'</span><span style="color: #007700">, </span><span style="color: #DD0000">"/usr/share/data/myapp"</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">resourcebundle_get</span><span style="color: #007700">(</span><span style="color: #0000BB">$r</span><span style="color: #007700">, </span><span style="color: #DD0000">'somestring'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <div class="example" id="example-2667">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="resourcebundle.count.php" class="function" rel="rdfs-seeAlso">resourcebundle_count()</a> - Get number of elements in the bundle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/resourcebundle/get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fresourcebundle.get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=resourcebundle.get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/resourcebundle.get.php">＋<small>add a note</small></a></span>
