...
<head>
  ...
  <title>PHP: sodium_crypto_sign_detached - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-sign-detached.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-sign-detached">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-sign-detached" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-sign.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-sign-detached.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-sign-detached.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-sign-detached.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-sign-detached.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-sign-detached.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-sign-detached.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-sign-detached.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-sign-detached.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-sign-detached.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-sign-detached.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-sign-detached.php" hreflang="zh">
...
<meta name="Description" content="Sign the message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_sign_detached - Manual" />
<meta name="twitter:description" content="Sign the message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_sign_detached - Manual" />
<meta itemprop="description" content="Sign the message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sign the message" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-sign-ed25519-pk-to-curve25519.php">
          sodium_crypto_sign_ed25519_pk_to_curve25519 &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-sign.php">
          &laquo; sodium_crypto_sign        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-sign-detached.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-sign-detached.php'>German</option>
            <option value='es/function.sodium-crypto-sign-detached.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-sign-detached.php'>French</option>
            <option value='it/function.sodium-crypto-sign-detached.php'>Italian</option>
            <option value='ja/function.sodium-crypto-sign-detached.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-sign-detached.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-sign-detached.php'>Russian</option>
            <option value='tr/function.sodium-crypto-sign-detached.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-sign-detached.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-sign-detached.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-sign-detached" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.sodium-crypto-sign-detached-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_sign_detached</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message</code></span>, <span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$secret_key</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-sign-detached-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      Secret key. See <span class="function"><a href="function.sodium-crypto-sign-secretkey.php" class="function">sodium_crypto_sign_secretkey()</a></span>
     </p>
    </dd>
  ...
  <p class="para">
   Cryptographic signature.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-sign-detached.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-sign-detached%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-sign-detached&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-sign-detached.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124998">  <div class="votes">
    <div id="Vu124998">
    <a href="/manual/vote-note.php?id=124998&amp;page=function.sodium-crypto-sign-detached&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124998">
    <a href="/manual/vote-note.php?id=124998&amp;page=function.sodium-crypto-sign-detached&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124998" title="no votes...">
    0
    </div>
  </div>
  <a href="#124998" class="name">
  <strong class="user"><em>cb at dialogs dot com</em></strong></a><a class="genanchor" href="#124998"> &para;</a><div class="date" title="2020-05-12 01:06"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124998">
<div class="phpcode"><code><span class="html">For those(like me) confused by sodium_crypto_sign() vs. sodium_crypto_sign_detached()<br /><br />From the libsodium docs <a href="https://libsodium.gitbook.io/doc/public-key_cryptography/public-key_signatures" rel="nofollow" target="_blank">https://libsodium.gitbook.io/doc/public-key_cryptography/public-key_signatures</a><br /><br />The crypto_sign() function prepends a signature to a message  "Combined mode"<br /><br />In "detached mode" the signature is stored without attaching a copy of the original message to it.</span></code></div>
  </div>
 </div>
  <div class="note" id="123078">  <div class="votes">
    <div id="Vu123078">
    <a href="/manual/vote-note.php?id=123078&amp;page=function.sodium-crypto-sign-detached&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123078">
    <a href="/manual/vote-note.php?id=123078&amp;page=function.sodium-crypto-sign-detached&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123078" title="50% like this...">
    0
    </div>
  </div>
  <a href="#123078" class="name">
  <strong class="user"><em>craig at craigfrancis dot co dot uk</em></strong></a><a class="genanchor" href="#123078"> &para;</a><div class="date" title="2018-08-25 07:33"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom123078">
<div class="phpcode"><code><span class="html">Here's a quick example on how to use sodium_crypto_sign_detached(); where you have a message that you want to sign, so anyone with the public key can confirm that the message hasn't been tampered with.<br /><br />This is similar to sodium_crypto_sign(), but the returned string does not contain the original message, it is just a signature.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">// $sign_seed = random_bytes(SODIUM_CRYPTO_SIGN_SEEDBYTES);<br />// $sign_pair = sodium_crypto_sign_seed_keypair($sign_seed);<br /><br /></span><span class="default">$sign_pair </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_keypair</span><span class="keyword">();<br /></span><span class="default">$sign_secret </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_secretkey</span><span class="keyword">(</span><span class="default">$sign_pair</span><span class="keyword">);<br /></span><span class="default">$sign_public </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_publickey</span><span class="keyword">(</span><span class="default">$sign_pair</span><span class="keyword">);<br /><br /></span><span class="comment">//--------------------------------------------------<br />// Person 1, signing<br /><br /></span><span class="default">$message </span><span class="keyword">= </span><span class="string">'Hello'</span><span class="keyword">;<br /><br /></span><span class="default">$signature </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_detached</span><span class="keyword">(</span><span class="default">$message</span><span class="keyword">, </span><span class="default">$sign_secret</span><span class="keyword">);<br /><br /></span><span class="comment">//--------------------------------------------------<br />// Person 2, verifying<br /><br /></span><span class="default">$message_valid </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_verify_detached</span><span class="keyword">(</span><span class="default">$signature</span><span class="keyword">, </span><span class="default">$message</span><span class="keyword">, </span><span class="default">$sign_public</span><span class="keyword">);<br /><br />if (!</span><span class="default">$message_valid</span><span class="keyword">) {<br />    exit(</span><span class="string">'Message has been changed.'</span><span class="keyword">);<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-sign-detached&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-sign-detached.php">＋<small>add a note</small></a></div>
