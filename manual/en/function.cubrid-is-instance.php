...
<head>
  ...
  <title>PHP: cubrid_is_instance - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-is-instance.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-is-instance">
 <link rel="alternate" href="https://www.php.net/cubrid-is-instance" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-insert-id.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lob-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-is-instance.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-is-instance.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-is-instance.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-is-instance.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-is-instance.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-is-instance.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-is-instance.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-is-instance.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-is-instance.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-is-instance.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-is-instance.php" hreflang="zh">
...
<meta name="Description" content="Check whether the instance pointed by OID exists" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_is_instance - Manual" />
<meta name="twitter:description" content="Check whether the instance pointed by OID exists" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_is_instance - Manual" />
<meta itemprop="description" content="Check whether the instance pointed by OID exists" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check whether the instance pointed by OID exists" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-lob-close.php">
          cubrid_lob_close &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-insert-id.php">
          &laquo; cubrid_insert_id        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-is-instance.php' selected="selected">English</option>
            <option value='de/function.cubrid-is-instance.php'>German</option>
            <option value='es/function.cubrid-is-instance.php'>Spanish</option>
            <option value='fr/function.cubrid-is-instance.php'>French</option>
            <option value='it/function.cubrid-is-instance.php'>Italian</option>
            <option value='ja/function.cubrid-is-instance.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-is-instance.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-is-instance.php'>Russian</option>
            <option value='tr/function.cubrid-is-instance.php'>Turkish</option>
            <option value='uk/function.cubrid-is-instance.php'>Ukrainian</option>
            <option value='zh/function.cubrid-is-instance.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-is-instance" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_is_instance</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_is_instance</span> &mdash; <span class="dc-title">Check whether the instance pointed by OID exists</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-is-instance-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_is_instance</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$oid</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_is_instance()</strong></span> function is used to check
    whether the instance pointed by the given <code class="parameter">oid</code>
    exists or not.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.cubrid-is-instance-parameters">
  ...
  <dd><p class="para">OID of the instance that you want to check the existence.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-is-instance-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-is-instance-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-1245">
   <p><strong>Example #1 <span class="function"><strong>cubrid_is_instance()</strong></span> example</strong></p>
   <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #0000BB">33000</span><span style="color: #007700">, </span><span style="color: #DD0000">"demodb"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$sql </span><span style="color: #007700">= &lt;&lt;&lt;EOD<br /></span><span style="color: #DD0000">SELECT host_year, medal, game_date <br />FROM game <br />WHERE athlete_code IN <br />    (SELECT code FROM athlete WHERE name='Thorpe Ian');<br /></span><span style="color: #007700">EOD;<br /><br /></span><span style="color: #0000BB">$req </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$sql</span><span style="color: #007700">, </span><span style="color: #0000BB">CUBRID_INCLUDE_OID</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$oid </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_current_oid</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$res </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_is_instance </span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$oid</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">$res </span><span style="color: #007700">== </span><span style="color: #0000BB">1</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">"Instance pointed by </span><span style="color: #0000BB">$oid</span><span style="color: #DD0000"> exists.\n"</span><span style="color: #007700">;<br />} else if (</span><span style="color: #0000BB">$res </span><span style="color: #007700">== </span><span style="color: #0000BB">0</span><span style="color: #007700">){<br />    echo </span><span style="color: #DD0000">"Instance pointed by </span><span style="color: #0000BB">$oid</span><span style="color: #DD0000"> doesn't exist.\n"</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">"error\n"</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #0000BB">cubrid_disconnect</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>

    <div class="example-contents"><p>The above example will output:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">Instance pointed by @0|0|0 doesn&#039;t exist.</pre>
</div>
   </div>
  </div>
 </div>
   ...
   <div class="refsect1 seealso" id="refsect1-function.cubrid-is-instance-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
   <li><span class="function"><a href="function.cubrid-drop.php" class="function" rel="rdfs-seeAlso">cubrid_drop()</a> - Delete an instance using OID</span></li>   
   <li><span class="function"><a href="function.cubrid-get-class-name.php" class="function" rel="rdfs-seeAlso">cubrid_get_class_name()</a> - Get the class name using OID</span></li>
   </ul>
  </p>
  </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-is-instance.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-is-instance%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-is-instance&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-is-instance.php">＋<small>add a note</small></a></span>
