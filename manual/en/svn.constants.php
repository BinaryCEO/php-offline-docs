...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/svn.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/svn.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/svn.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/svn.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.svn.php">

 <link rel="alternate" href="https://www.php.net/manual/en/svn.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/svn.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/svn.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/svn.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/svn.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/svn.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/svn.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/svn.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/svn.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/svn.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/svn.constants.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/svn.constants.php' selected="selected">English</option>
            <option value='de/svn.constants.php'>German</option>
            <option value='es/svn.constants.php'>Spanish</option>
            <option value='fr/svn.constants.php'>French</option>
            <option value='it/svn.constants.php'>Italian</option>
            <option value='ja/svn.constants.php'>Japanese</option>
            <option value='pt_BR/svn.constants.php'>Brazilian Portuguese</option>
            <option value='ru/svn.constants.php'>Russian</option>
            <option value='tr/svn.constants.php'>Turkish</option>
            <option value='uk/svn.constants.php'>Ukrainian</option>
            <option value='zh/svn.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="svn.constants" class="appendix">
   ...
   <dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsvn.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=svn.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/svn.constants.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120072">  <div class="votes">
    <div id="Vu120072">
    <a href="/manual/vote-note.php?id=120072&amp;page=svn.constants&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120072">
    <a href="/manual/vote-note.php?id=120072&amp;page=svn.constants&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120072" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#120072" class="name">
  <strong class="user"><em>daevid at daevid dot com</em></strong></a><a class="genanchor" href="#120072"> &para;</a><div class="date" title="2016-10-21 12:16"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120072">
<div class="phpcode"><code><span class="html">To get these constants so you can reverse lookup what all the integers mean, do this:<br /><br /><span class="default">&lt;?php <br /><br />   $constants </span><span class="keyword">= </span><span class="default">array_flip</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">getSvnConstants</span><span class="keyword">(</span><span class="string">'SVN_WC_STATUS'</span><span class="keyword">));<br />  <br />   </span><span class="default">$status </span><span class="keyword">= </span><span class="default">svn_status</span><span class="keyword">();<br /><br />   foreach(</span><span class="default">$status </span><span class="keyword">as &amp;</span><span class="default">$v</span><span class="keyword">)<br />   {<br />          </span><span class="default">$v</span><span class="keyword">[</span><span class="string">'text_status'</span><span class="keyword">]       = </span><span class="default">$constants</span><span class="keyword">[</span><span class="default">$v</span><span class="keyword">[</span><span class="string">'text_status'</span><span class="keyword">]];<br />          </span><span class="default">$v</span><span class="keyword">[</span><span class="string">'repos_text_status'</span><span class="keyword">] = </span><span class="default">$constants</span><span class="keyword">[</span><span class="default">$v</span><span class="keyword">[</span><span class="string">'repos_text_status'</span><span class="keyword">]];<br />          </span><span class="default">$v</span><span class="keyword">[</span><span class="string">'prop_status'</span><span class="keyword">]       = </span><span class="default">$constants</span><span class="keyword">[</span><span class="default">$v</span><span class="keyword">[</span><span class="string">'prop_status'</span><span class="keyword">]];<br />          </span><span class="default">$v</span><span class="keyword">[</span><span class="string">'repos_prop_status'</span><span class="keyword">] = </span><span class="default">$constants</span><span class="keyword">[</span><span class="default">$v</span><span class="keyword">[</span><span class="string">'repos_prop_status'</span><span class="keyword">]];<br />    }<br /><br />    public function </span><span class="default">getSvnConstants</span><span class="keyword">(</span><span class="default">$filter</span><span class="keyword">=</span><span class="string">'SVN_'</span><span class="keyword">)<br />    {<br />        </span><span class="default">$constants </span><span class="keyword">= array();<br />        foreach (</span><span class="default">get_defined_constants</span><span class="keyword">() as </span><span class="default">$key </span><span class="keyword">=&gt; </span><span class="default">$value</span><span class="keyword">)<br />            if (</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$key</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$filter</span><span class="keyword">)) == </span><span class="default">$filter</span><span class="keyword">)<br />                </span><span class="default">$constants</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] = </span><span class="default">$value</span><span class="keyword">;<br /><br />        return </span><span class="default">$constants</span><span class="keyword">;<br />    }<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=svn.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/svn.constants.php">＋<small>add a note</small></a></div>
