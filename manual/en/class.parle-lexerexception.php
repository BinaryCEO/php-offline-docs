...
<head>
  ...
  <title>PHP: Parle\LexerException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.parle-lexerexception.php">
 <link rel="shorturl" href="https://www.php.net/parle-lexerexception">
 <link rel="alternate" href="https://www.php.net/parle-lexerexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.parle.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.parle-errorinfo.php">
 <link rel="next" href="https://www.php.net/manual/en/class.parle-parserexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.parle-lexerexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.parle-lexerexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.parle-lexerexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.parle-lexerexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.parle-lexerexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.parle-lexerexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.parle-lexerexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.parle-lexerexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.parle-lexerexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.parle-lexerexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.parle-lexerexception.php" hreflang="zh">
...
<meta name="Description" content="The Parle\LexerException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Parle\LexerException - Manual" />
<meta name="twitter:description" content="The Parle\LexerException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Parle\LexerException - Manual" />
<meta itemprop="description" content="The Parle\LexerException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Parle\LexerException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.parle-parserexception.php">
          Parle\ParserException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.parle-errorinfo.php">
          &laquo; Parle\ErrorInfo        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.parle-lexerexception.php' selected="selected">English</option>
            <option value='de/class.parle-lexerexception.php'>German</option>
            <option value='es/class.parle-lexerexception.php'>Spanish</option>
            <option value='fr/class.parle-lexerexception.php'>French</option>
            <option value='it/class.parle-lexerexception.php'>Italian</option>
            <option value='ja/class.parle-lexerexception.php'>Japanese</option>
            <option value='pt_BR/class.parle-lexerexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.parle-lexerexception.php'>Russian</option>
            <option value='tr/class.parle-lexerexception.php'>Turkish</option>
            <option value='uk/class.parle-lexerexception.php'>Ukrainian</option>
            <option value='zh/class.parle-lexerexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.parle-lexerexception" class="reference">

 <h1 class="title">The Parle\LexerException class</h1>
 

 <div class="partintro"><p class="verinfo">(PECL parle &gt;= 0.5.1)</p>


  <div class="section" id="parle-lexerexception.intro">
  ...
  <div class="section" id="parle-lexerexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">Parle\LexerException</strong>
     </span>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/parle/parle.lexerexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.parle-lexerexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.parle-lexerexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.parle-lexerexception.php">＋<small>add a note</small></a></span>
