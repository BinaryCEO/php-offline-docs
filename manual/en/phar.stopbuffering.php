...
<head>
  ...
  <title>PHP: Phar::stopBuffering - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.stopbuffering.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.stopbuffering.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.stopbuffering.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.startbuffering.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.unlinkarchive.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.stopbuffering.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.stopbuffering.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.stopbuffering.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.stopbuffering.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.stopbuffering.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.stopbuffering.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.stopbuffering.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.stopbuffering.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.stopbuffering.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.stopbuffering.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.stopbuffering.php" hreflang="zh">
...
<meta name="Description" content="Stop buffering write requests to the Phar archive, and save changes to disk" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::stopBuffering - Manual" />
<meta name="twitter:description" content="Stop buffering write requests to the Phar archive, and save changes to disk" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::stopBuffering - Manual" />
<meta itemprop="description" content="Stop buffering write requests to the Phar archive, and save changes to disk" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Stop buffering write requests to the Phar archive, and save changes to disk" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.unlinkarchive.php">
          Phar::unlinkArchive &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.startbuffering.php">
          &laquo; Phar::startBuffering        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.stopbuffering.php' selected="selected">English</option>
            <option value='de/phar.stopbuffering.php'>German</option>
            <option value='es/phar.stopbuffering.php'>Spanish</option>
            <option value='fr/phar.stopbuffering.php'>French</option>
            <option value='it/phar.stopbuffering.php'>Italian</option>
            <option value='ja/phar.stopbuffering.php'>Japanese</option>
            <option value='pt_BR/phar.stopbuffering.php'>Brazilian Portuguese</option>
            <option value='ru/phar.stopbuffering.php'>Russian</option>
            <option value='tr/phar.stopbuffering.php'>Turkish</option>
            <option value='uk/phar.stopbuffering.php'>Ukrainian</option>
            <option value='zh/phar.stopbuffering.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.stopbuffering" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.isbuffering.php" class="function" rel="rdfs-seeAlso">Phar::isBuffering()</a> - Used to determine whether Phar write operations are being buffered, or are flushing directly to disk</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/stopBuffering.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.stopbuffering%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.stopbuffering&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.stopbuffering.php">＋<small>add a note</small></a></span>
