...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanworker.addfunction.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanworker.addfunction.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanworker.addfunction.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanworker.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.gearmanworker.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanworker.addoptions.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanworker.addfunction.php' selected="selected">English</option>
            ...
            <option value='ja/gearmanworker.addfunction.php'>Japanese</option>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="gearmanclient.do.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::do()</a> - Run a single task and return a result [deprecated]</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanworker/addfunction.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanworker.addfunction%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanworker.addfunction&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanworker.addfunction.php">＋<small>add a note</small></a></span>
