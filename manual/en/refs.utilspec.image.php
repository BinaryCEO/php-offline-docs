...
<head>
  ...
  <title>PHP: Image Processing and Generation - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/refs.utilspec.image.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/refs.utilspec.image.php">
 <link rel="alternate" href="https://www.php.net/manual/en/refs.utilspec.image.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/funcref.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.recode-string.php">
 <link rel="next" href="https://www.php.net/manual/en/book.exif.php">
...
<meta name="Description" content="Image Processing and Generation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Image Processing and Generation - Manual" />
<meta name="twitter:description" content="Image Processing and Generation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Image Processing and Generation - Manual" />
<meta itemprop="description" content="Image Processing and Generation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Image Processing and Generation" />
...
<div id="layout" class="clearfix">
  ...
  <div class="page-tools">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/refs.utilspec.image.php' selected="selected">English</option>
            ...
            <option value='zh/refs.utilspec.image.php'>Chinese (Simplified)</option>
   ...
   <h1 class="title">Image Processing and Generation</h1>
  ...
  <ul class="chunklist chunklist_set"><li><a href="book.exif.php">Exif</a> — Exchangeable image information<ul class="chunklist chunklist_set chunklist_children"><li><a href="intro.exif.php">Introduction</a></li><li><a href="exif.setup.php">Installing/Configuring</a></li><li><a href="exif.constants.php">Predefined Constants</a></li><li><a href="ref.exif.php">Exif Functions</a></li></ul></li><li><a href="book.image.php">GD</a> — Image Processing and GD<ul class="chunklist chunklist_set chunklist_children"><li><a href="intro.image.php">Introduction</a></li><li><a href="image.setup.php">Installing/Configuring</a></li><li><a href="image.constants.php">Predefined Constants</a></li><li><a href="image.examples.php">Examples</a></li><li><a href="ref.image.php">GD and Image Functions</a></li><li><a href="class.gdimage.php">GdImage</a> — The GdImage class</li><li><a href="class.gdfont.php">GdFont</a> — The GdFont class</li></ul></li><li><a href="book.gmagick.php">Gmagick</a><ul class="chunklist chunklist_set chunklist_children"><li><a href="intro.gmagick.php">Introduction</a></li><li><a href="gmagick.setup.php">Installing/Configuring</a></li><li><a href="gmagick.constants.php">Predefined Constants</a></li><li><a href="gmagick.examples.php">Examples</a></li><li><a href="class.gmagick.php">Gmagick</a> — The Gmagick class</li><li><a href="class.gmagickdraw.php">GmagickDraw</a> — The GmagickDraw class</li><li><a href="class.gmagickpixel.php">GmagickPixel</a> — The GmagickPixel class</li></ul></li><li><a href="book.imagick.php">ImageMagick</a> — Image Processing (ImageMagick)<ul class="chunklist chunklist_set chunklist_children"><li><a href="intro.imagick.php">Introduction</a></li><li><a href="imagick.setup.php">Installing/Configuring</a></li><li><a href="imagick.constants.php">Predefined Constants</a></li><li><a href="imagick.examples.php">Examples</a></li><li><a href="class.imagick.php">Imagick</a> — The Imagick class</li><li><a href="class.imagickdraw.php">ImagickDraw</a> — The ImagickDraw class</li><li><a href="class.imagickpixel.php">ImagickPixel</a> — The ImagickPixel class</li><li><a href="class.imagickpixeliterator.php">ImagickPixelIterator</a> — The ImagickPixelIterator class</li><li><a href="class.imagickkernel.php">ImagickKernel</a> — The ImagickKernel class</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Frefs.utilspec.image%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=refs.utilspec.image&amp;repo=en&amp;redirect=https://www.php.net/manual/en/refs.utilspec.image.php">＋<small>add a note</small></a></span>
