...
<head>
  ...
  <title>PHP: strncasecmp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.strncasecmp.php">
 <link rel="shorturl" href="https://www.php.net/strncasecmp">
 <link rel="alternate" href="https://www.php.net/strncasecmp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.strings.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.strnatcmp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.strncmp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.strncasecmp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.strncasecmp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.strncasecmp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.strncasecmp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.strncasecmp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.strncasecmp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.strncasecmp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.strncasecmp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.strncasecmp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.strncasecmp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.strncasecmp.php" hreflang="zh">
...
<meta name="Description" content="Binary safe case-insensitive string comparison of the first n characters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: strncasecmp - Manual" />
<meta name="twitter:description" content="Binary safe case-insensitive string comparison of the first n characters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: strncasecmp - Manual" />
<meta itemprop="description" content="Binary safe case-insensitive string comparison of the first n characters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Binary safe case-insensitive string comparison of the first n characters" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.strncasecmp.php' selected="selected">English</option>
            <option value='de/function.strncasecmp.php'>German</option>
            <option value='es/function.strncasecmp.php'>Spanish</option>
            <option value='fr/function.strncasecmp.php'>French</option>
            <option value='it/function.strncasecmp.php'>Italian</option>
            <option value='ja/function.strncasecmp.php'>Japanese</option>
            <option value='pt_BR/function.strncasecmp.php'>Brazilian Portuguese</option>
            <option value='ru/function.strncasecmp.php'>Russian</option>
            <option value='tr/function.strncasecmp.php'>Turkish</option>
            <option value='uk/function.strncasecmp.php'>Ukrainian</option>
            <option value='zh/function.strncasecmp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.strncasecmp" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.strncasecmp-examples">
  ...
  <p class="para">
   <div class="example" id="example-5160">
    <p><strong>Example #1 <span class="function"><strong>strncasecmp()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.substr.php" class="function" rel="rdfs-seeAlso">substr()</a> - Return part of a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/strncasecmp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.strncasecmp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.strncasecmp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.strncasecmp.php">＋<small>add a note</small></a></span>
