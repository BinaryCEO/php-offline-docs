...
<head>
  ...
  <title>PHP: ImagickDraw::setTextKerning - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.settextkerning.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.settextkerning.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextkerning.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.settextinterwordspacing.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.settextundercolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextkerning.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.settextkerning.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.settextkerning.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.settextkerning.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.settextkerning.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.settextkerning.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.settextkerning.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.settextkerning.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.settextkerning.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.settextkerning.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.settextkerning.php" hreflang="zh">
...
<meta name="Description" content="Sets the text kerning" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setTextKerning - Manual" />
<meta name="twitter:description" content="Sets the text kerning" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setTextKerning - Manual" />
<meta itemprop="description" content="Sets the text kerning" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the text kerning" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.settextundercolor.php">
          ImagickDraw::setTextUnderColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.settextinterwordspacing.php">
          &laquo; ImagickDraw::setTextInterwordSpacing        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.settextkerning.php' selected="selected">English</option>
            <option value='de/imagickdraw.settextkerning.php'>German</option>
            <option value='es/imagickdraw.settextkerning.php'>Spanish</option>
            <option value='fr/imagickdraw.settextkerning.php'>French</option>
            <option value='it/imagickdraw.settextkerning.php'>Italian</option>
            <option value='ja/imagickdraw.settextkerning.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.settextkerning.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.settextkerning.php'>Russian</option>
            <option value='tr/imagickdraw.settextkerning.php'>Turkish</option>
            <option value='uk/imagickdraw.settextkerning.php'>Ukrainian</option>
            <option value='zh/imagickdraw.settextkerning.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.settextkerning" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setTextKerning</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setTextKerning</span> &mdash; <span class="dc-title">Sets the text kerning</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.settextkerning-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setTextKerning</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$kerning</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.settextkerning-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">kerning</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.settextkerning-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/settextkerning.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.settextkerning%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.settextkerning&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.settextkerning.php">＋<small>add a note</small></a></span>
