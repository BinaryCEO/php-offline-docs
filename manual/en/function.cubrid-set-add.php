...
<head>
  ...
  <title>PHP: cubrid_set_add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-set-add.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-set-add">
 <link rel="alternate" href="https://www.php.net/cubrid-set-add" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-seq-put.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-set-autocommit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-set-add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-set-add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-set-add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-set-add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-set-add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-set-add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-set-add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-set-add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-set-add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-set-add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-set-add.php" hreflang="zh">
...
<meta name="Description" content="Insert a single element to set type column using OID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_set_add - Manual" />
<meta name="twitter:description" content="Insert a single element to set type column using OID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_set_add - Manual" />
<meta itemprop="description" content="Insert a single element to set type column using OID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Insert a single element to set type column using OID" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-set-autocommit.php">
          cubrid_set_autocommit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-seq-put.php">
          &laquo; cubrid_seq_put        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-set-add.php' selected="selected">English</option>
            <option value='de/function.cubrid-set-add.php'>German</option>
            <option value='es/function.cubrid-set-add.php'>Spanish</option>
            <option value='fr/function.cubrid-set-add.php'>French</option>
            <option value='it/function.cubrid-set-add.php'>Italian</option>
            <option value='ja/function.cubrid-set-add.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-set-add.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-set-add.php'>Russian</option>
            <option value='tr/function.cubrid-set-add.php'>Turkish</option>
            <option value='uk/function.cubrid-set-add.php'>Ukrainian</option>
            <option value='zh/function.cubrid-set-add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-set-add" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_set_add</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_set_add</span> &mdash; <span class="dc-title">Insert a single element to set type column using OID</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-set-add-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_set_add</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$oid</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$attr_name</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$set_element</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_set_add()</strong></span> function is used to insert a
...
<div class="refsect1 parameters" id="refsect1-function.cubrid-set-add-parameters">
  ...
  <dd><p class="para">Name of the attribute you want to insert an element.</p></dd>
   
  
  <dt><code class="parameter">set_element</code></dt>
  <dd><p class="para">Content of the element you want to insert.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-set-add-returnvalues">
...
array(4) {
 ...
 <div class="refsect1 seealso" id="refsect1-function.cubrid-set-add-seealso">
   ...
   <ul class="simplelist"> 
    <li><span class="function"><a href="function.cubrid-seq-drop.php" class="function" rel="rdfs-seeAlso">cubrid_seq_drop()</a> - Delete an element from sequence type column using OID</span></li>  
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-set-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-set-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-set-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-set-add.php">＋<small>add a note</small></a></span>
