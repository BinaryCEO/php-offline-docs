...
<head>
  ...
  <title>PHP: oci_num_fields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-num-fields.php">
 <link rel="shorturl" href="https://www.php.net/oci-num-fields">
 <link rel="alternate" href="https://www.php.net/oci-num-fields" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-new-descriptor.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-num-rows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-num-fields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-num-fields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-num-fields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-num-fields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-num-fields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-num-fields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-num-fields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-num-fields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-num-fields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-num-fields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-num-fields.php" hreflang="zh">
...
<meta name="Description" content="Returns the number of result columns in a statement" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_num_fields - Manual" />
<meta name="twitter:description" content="Returns the number of result columns in a statement" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_num_fields - Manual" />
<meta itemprop="description" content="Returns the number of result columns in a statement" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the number of result columns in a statement" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-num-fields.php' selected="selected">English</option>
            <option value='de/function.oci-num-fields.php'>German</option>
            <option value='es/function.oci-num-fields.php'>Spanish</option>
            <option value='fr/function.oci-num-fields.php'>French</option>
            <option value='it/function.oci-num-fields.php'>Italian</option>
            <option value='ja/function.oci-num-fields.php'>Japanese</option>
            <option value='pt_BR/function.oci-num-fields.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-num-fields.php'>Russian</option>
            <option value='tr/function.oci-num-fields.php'>Turkish</option>
            <option value='uk/function.oci-num-fields.php'>Ukrainian</option>
            <option value='zh/function.oci-num-fields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-num-fields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">oci_num_fields</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">oci_num_fields</span> &mdash; <span class="dc-title">Returns the number of result columns in a statement</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.oci-num-fields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>oci_num_fields</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$statement</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Gets the number of columns in the given <code class="parameter">statement</code>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.oci-num-fields-parameters">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// Create the table with:<br />//   CREATE TABLE mytab (id NUMBER, quantity NUMBER);<br /><br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"hr"</span><span style="color: #007700">, </span><span style="color: #DD0000">"hrpwd"</span><span style="color: #007700">, </span><span style="color: #DD0000">"localhost/XE"</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$conn</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$m </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_error</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">trigger_error</span><span style="color: #007700">(</span><span style="color: #0000BB">htmlentities</span><span style="color: #007700">(</span><span style="color: #0000BB">$m</span><span style="color: #007700">[</span><span style="color: #DD0000">'message'</span><span style="color: #007700">]), </span><span style="color: #0000BB">E_USER_ERROR</span><span style="color: #007700">);<br />}<br /><br /></span><span style="color: #0000BB">$stid </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_parse</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"SELECT * FROM mytab"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">oci_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">, </span><span style="color: #0000BB">OCI_DESCRIBE_ONLY</span><span style="color: #007700">); </span><span style="color: #FF8000">// Use OCI_DESCRIBE_ONLY if not fetching rows<br /><br /></span><span style="color: #0000BB">$ncols </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_num_fields</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">);<br />for (</span><span style="color: #0000BB">$i </span><span style="color: #007700">= </span><span style="color: #0000BB">1</span><span style="color: #007700">; </span><span style="color: #0000BB">$i </span><span style="color: #007700">&lt;= </span><span style="color: #0000BB">$ncols</span><span style="color: #007700">; </span><span style="color: #0000BB">$i</span><span style="color: #007700">++) {<br />    echo </span><span style="color: #0000BB">oci_field_name</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">, </span><span style="color: #0000BB">$i</span><span style="color: #007700">) . </span><span style="color: #DD0000">" " </span><span style="color: #007700">. </span><span style="color: #0000BB">oci_field_type</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">, </span><span style="color: #0000BB">$i</span><span style="color: #007700">) . </span><span style="color: #DD0000">"&lt;br&gt;\n"</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #FF8000">// Outputs:<br />//    ID NUMBER<br />//    QUANTITY NUMBER<br /><br /></span><span style="color: #0000BB">oci_free_statement</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">oci_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-num-fields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-num-fields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-num-fields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-num-fields.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="2338">  <div class="votes">
    <div id="Vu2338">
    <a href="/manual/vote-note.php?id=2338&amp;page=function.oci-num-fields&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd2338">
    <a href="/manual/vote-note.php?id=2338&amp;page=function.oci-num-fields&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V2338" title="66% like this...">
    1
    </div>
  </div>
  <a href="#2338" class="name">
  <strong class="user"><em>jnield at impole dot com</em></strong></a><a class="genanchor" href="#2338"> &para;</a><div class="date" title="1999-11-18 07:43"><strong>25 years ago</strong></div>
  <div class="text" id="Hcom2338">
<div class="phpcode"><code><span class="html">The following is not immediately obvious:
<br />
<br />If you need the number of columns in a REF CURSOR returned from a PL/SQL procedure, you need to use OCINumColumns() on the cursor handle returned by OCINewCursor after it is bound and executed, not the statement handle. Same applies for OCIColumnName() and friends.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.oci-num-fields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-num-fields.php">＋<small>add a note</small></a></div>
