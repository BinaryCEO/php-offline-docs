...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-strerror.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-shutdown.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-write.php">
...
<meta name="Description" content="Return a string describing a socket error" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_strerror - Manual" />
<meta name="twitter:description" content="Return a string describing a socket error" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_strerror - Manual" />
<meta itemprop="description" content="Return a string describing a socket error" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return a string describing a socket error" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-strerror.php' selected="selected">English</option>
            ...
            <option value='zh/function.socket-strerror.php'>Chinese (Simplified)</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_strerror</span> &mdash; <span class="dc-title">Return a string describing a socket error</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.socket-strerror-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>socket_strerror()</strong></span> takes as its
   <code class="parameter">error_code</code> parameter a socket error code as returned by
   <span class="function"><a href="function.socket-last-error.php" class="function">socket_last_error()</a></span> and returns the corresponding
   explanatory text.
  </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.socket-strerror-returnvalues">
  ...
  <p class="para">
   Returns the error message associated with the <code class="parameter">error_code</code>
   parameter.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.socket-strerror-examples">
  ...
  <p class="para">
   <div class="example" id="example-4811">
    <p><strong>Example #1 <span class="function"><strong>socket_strerror()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.socket-create.php" class="function" rel="rdfs-seeAlso">socket_create()</a> - Create a socket (endpoint for communication)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-strerror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-strerror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-strerror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-strerror.php">＋<small>add a note</small></a></span>
