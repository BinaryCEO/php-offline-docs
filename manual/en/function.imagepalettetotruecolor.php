...
<head>
  ...
  <title>PHP: imagepalettetotruecolor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagepalettetotruecolor.php">
 <link rel="shorturl" href="https://www.php.net/imagepalettetotruecolor">
 <link rel="alternate" href="https://www.php.net/imagepalettetotruecolor" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagepalettecopy.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagepng.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagepalettetotruecolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagepalettetotruecolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagepalettetotruecolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagepalettetotruecolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagepalettetotruecolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagepalettetotruecolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagepalettetotruecolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagepalettetotruecolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagepalettetotruecolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagepalettetotruecolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagepalettetotruecolor.php" hreflang="zh">
...
<meta name="Description" content="Converts a palette based image to true color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagepalettetotruecolor - Manual" />
<meta name="twitter:description" content="Converts a palette based image to true color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagepalettetotruecolor - Manual" />
<meta itemprop="description" content="Converts a palette based image to true color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Converts a palette based image to true color" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagepalettetotruecolor.php' selected="selected">English</option>
            <option value='de/function.imagepalettetotruecolor.php'>German</option>
            <option value='es/function.imagepalettetotruecolor.php'>Spanish</option>
            <option value='fr/function.imagepalettetotruecolor.php'>French</option>
            <option value='it/function.imagepalettetotruecolor.php'>Italian</option>
            <option value='ja/function.imagepalettetotruecolor.php'>Japanese</option>
            <option value='pt_BR/function.imagepalettetotruecolor.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagepalettetotruecolor.php'>Russian</option>
            <option value='tr/function.imagepalettetotruecolor.php'>Turkish</option>
            <option value='uk/function.imagepalettetotruecolor.php'>Ukrainian</option>
            <option value='zh/function.imagepalettetotruecolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagepalettetotruecolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagepalettetotruecolor</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagepalettetotruecolor</span> &mdash; <span class="dc-title">Converts a palette based image to true color</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagepalettetotruecolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagepalettetotruecolor</strong></span>(<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Converts a palette based image, created by functions like 
   <span class="function"><a href="function.imagecreate.php" class="function">imagecreate()</a></span> to a true color image, like 
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagepalettetotruecolor-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the convertion was complete, or if the source image already 
   is a true color image, otherwise <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> is returned.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.imagepalettetotruecolor-changelog">
...
typeof($im) = true color</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagepalettetotruecolor-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imageistruecolor.php" class="function" rel="rdfs-seeAlso">imageistruecolor()</a> - Finds whether an image is a truecolor image</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagepalettetotruecolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagepalettetotruecolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagepalettetotruecolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagepalettetotruecolor.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114937">  <div class="votes">
    <div id="Vu114937">
    <a href="/manual/vote-note.php?id=114937&amp;page=function.imagepalettetotruecolor&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114937">
    <a href="/manual/vote-note.php?id=114937&amp;page=function.imagepalettetotruecolor&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114937" title="60% like this...">
    1
    </div>
  </div>
  <a href="#114937" class="name">
  <strong class="user"><em>Polda18</em></strong></a><a class="genanchor" href="#114937"> &para;</a><div class="date" title="2014-04-30 02:44"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114937">
<div class="phpcode"><code><span class="html">PHP ver 5.4.24 does not support this function (it has not been defined). To get rid of this, you must copy image resource to new image created by function imagecreatetruecolor();<br /><br />Example with image loaded from GIF file:<br /><br />$image  = imagecreatefromgif("path/to/gif/file.gif");  //create an image from GIF<br />$width  = imagesx($image);                             //get width of source image<br />$height = imagesy($image);                             //get height of source image<br />$image2 = imagecreatetruecolor($width,$height);        //create new image of true colors with given width and height<br />imagecopy($image2,$image,0,0,0,0,$width,$height);      //copy source image to new one<br /><br />header("Content-Type: image/jpeg");                    //set header for JPG image<br />imagejpg($image2);                                     //render JPg image into browser<br /><br />imagedestroy($image);                                  //free up memory<br />imagedestroy($image2);</span></code></div>
  </div>
 </div>
  <div class="note" id="120831">  <div class="votes">
    <div id="Vu120831">
    <a href="/manual/vote-note.php?id=120831&amp;page=function.imagepalettetotruecolor&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120831">
    <a href="/manual/vote-note.php?id=120831&amp;page=function.imagepalettetotruecolor&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120831" title="no votes...">
    0
    </div>
  </div>
  <a href="#120831" class="name">
  <strong class="user"><em>walf - iftfy</em></strong></a><a class="genanchor" href="#120831"> &para;</a><div class="date" title="2017-03-17 03:46"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120831">
<div class="phpcode"><code><span class="html">here the working version of walf's solution<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Backwards compatiblity<br /></span><span class="keyword">if (!</span><span class="default">function_exists</span><span class="keyword">(</span><span class="string">'imagepalettetotruecolor'</span><span class="keyword">)) {<br />    function </span><span class="default">imagepalettetotruecolor</span><span class="keyword">(&amp;</span><span class="default">$src</span><span class="keyword">) {<br />        if (</span><span class="default">imageistruecolor</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">)) {<br />            return </span><span class="default">true</span><span class="keyword">;<br />        }<br /><br />        </span><span class="default">$dst </span><span class="keyword">= </span><span class="default">imagecreatetruecolor</span><span class="keyword">(</span><span class="default">imagesx</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">), </span><span class="default">imagesy</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">));<br />     <br />        </span><span class="default">imagealphablending</span><span class="keyword">(</span><span class="default">$dst</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">);</span><span class="comment">//prevent blending with default black<br />        </span><span class="default">$transparent </span><span class="keyword">= </span><span class="default">imagecolorallocatealpha</span><span class="keyword">(</span><span class="default">$dst</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">, </span><span class="default">127</span><span class="keyword">);</span><span class="comment">//change the RGB values if you need, but leave alpha at 127<br />        </span><span class="default">imagefilledrectangle</span><span class="keyword">(</span><span class="default">$dst</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">imagesx</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">), </span><span class="default">imagesy</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">), </span><span class="default">$transparent</span><span class="keyword">);</span><span class="comment">//simpler than flood fill<br />        </span><span class="default">imagealphablending</span><span class="keyword">(</span><span class="default">$dst</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);</span><span class="comment">//restore default blending<br /><br />        </span><span class="default">imagecopy</span><span class="keyword">(</span><span class="default">$dst</span><span class="keyword">, </span><span class="default">$src</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">imagesx</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">), </span><span class="default">imagesy</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">));<br />        </span><span class="default">imagedestroy</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">);<br /><br />        </span><span class="default">$src </span><span class="keyword">= </span><span class="default">$dst</span><span class="keyword">;<br />        return </span><span class="default">true</span><span class="keyword">;<br />    }<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="114675">  <div class="votes">
    <div id="Vu114675">
    <a href="/manual/vote-note.php?id=114675&amp;page=function.imagepalettetotruecolor&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114675">
    <a href="/manual/vote-note.php?id=114675&amp;page=function.imagepalettetotruecolor&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114675" title="25% like this...">
    -2
    </div>
  </div>
  <a href="#114675" class="name">
  <strong class="user"><em>walf</em></strong></a><a class="genanchor" href="#114675"> &para;</a><div class="date" title="2014-03-21 06:20"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114675">
<div class="phpcode"><code><span class="html">The backwards compatibility example does not preserve transparency. You must first wipe out the default black background on the new image:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Backwards compatiblity<br /></span><span class="keyword">if (!</span><span class="default">function_exists</span><span class="keyword">(</span><span class="string">'imagepalettetotruecolor'</span><span class="keyword">)) {<br />    function </span><span class="default">imagepalettetotruecolor</span><span class="keyword">(&amp;</span><span class="default">$src</span><span class="keyword">) {<br />        if (</span><span class="default">imageistruecolor</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">)) {<br />            return </span><span class="default">true</span><span class="keyword">;<br />        }<br /><br />        </span><span class="default">$dst </span><span class="keyword">= </span><span class="default">imagecreatetruecolor</span><span class="keyword">(</span><span class="default">imagesx</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">), </span><span class="default">imagesy</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">));<br />        <br />        </span><span class="default">imagealphablending</span><span class="keyword">(</span><span class="default">$dst</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">);</span><span class="comment">//prevent blending with default black<br />        </span><span class="default">$transparent </span><span class="keyword">= </span><span class="default">imagecolorallocatealpha</span><span class="keyword">(</span><span class="default">$new_image</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">, </span><span class="default">127</span><span class="keyword">);</span><span class="comment">//change the RGB values if you need, but leave alpha at 127<br />        </span><span class="default">imagefilledrectangle</span><span class="keyword">(</span><span class="default">$dst</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$imagesx</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">), </span><span class="default">imagesy</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">), </span><span class="default">$transparent</span><span class="keyword">);</span><span class="comment">//simpler than flood fill<br />        </span><span class="default">imagealphablending</span><span class="keyword">(</span><span class="default">$dst</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);</span><span class="comment">//restore default blending<br /><br />        </span><span class="default">imagecopy</span><span class="keyword">(</span><span class="default">$dst</span><span class="keyword">, </span><span class="default">$src</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">imagesx</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">), </span><span class="default">imagesy</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">));<br />        </span><span class="default">imagedestroy</span><span class="keyword">(</span><span class="default">$src</span><span class="keyword">);<br /><br />        </span><span class="default">$src </span><span class="keyword">= </span><span class="default">$dst</span><span class="keyword">;<br />        return </span><span class="default">true</span><span class="keyword">;<br />    }<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagepalettetotruecolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagepalettetotruecolor.php">＋<small>add a note</small></a></div>
