...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.setpassword.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.setpassword.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setpassword.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.setmtimename.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.statindex.php">
...
<meta name="Description" content="Set the password for the active archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::setPassword - Manual" />
<meta name="twitter:description" content="Set the password for the active archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::setPassword - Manual" />
<meta itemprop="description" content="Set the password for the active archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the password for the active archive" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.setpassword.php' selected="selected">English</option>
            <option value='de/ziparchive.setpassword.php'>German</option>
            <option value='es/ziparchive.setpassword.php'>Spanish</option>
            <option value='fr/ziparchive.setpassword.php'>French</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="ziparchive.setencryptionname.php" class="methodname" rel="rdfs-seeAlso">ZipArchive::setEncryptionName()</a> - Set the encryption method of an entry defined by its name</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/setpassword.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.setpassword%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.setpassword&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.setpassword.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">It seems that this function supports only decryption of password protected archives (see changelog: <a href="http://pecl.php.net/package-changelog.php?package=zip" rel="nofollow" target="_blank">http://pecl.php.net/package-changelog.php?package=zip</a>). Creation of password protected archives is not supported (they will be created simply as non-protected archives).<br /><br />Example code for extraction of files from password protected ZIP archives:<br /><br /><span class="default">&lt;?php<br />    $zip </span><span class="keyword">= new </span><span class="default">ZipArchive</span><span class="keyword">();<br />    </span><span class="default">$zip_status </span><span class="keyword">= </span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">open</span><span class="keyword">(</span><span class="string">"test.zip"</span><span class="keyword">);<br /><br />    if (</span><span class="default">$zip_status </span><span class="keyword">=== </span><span class="default">true</span><span class="keyword">)<br />    {<br />        if (</span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">setPassword</span><span class="keyword">(</span><span class="string">"MySecretPassword"</span><span class="keyword">))<br />        {<br />            if (!</span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">extractTo</span><span class="keyword">(</span><span class="default">__DIR__</span><span class="keyword">))<br />                echo </span><span class="string">"Extraction failed (wrong password?)"</span><span class="keyword">;<br />        }<br /><br />        </span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">close</span><span class="keyword">();<br />    }<br />    else<br />    {<br />        die(</span><span class="string">"Failed opening archive: "</span><span class="keyword">. @</span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">getStatusString</span><span class="keyword">() . </span><span class="string">" (code: "</span><span class="keyword">. </span><span class="default">$zip_status </span><span class="keyword">.</span><span class="string">")"</span><span class="keyword">);<br />    }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="122465">  <div class="votes">
    ...
    <div class="tally" id="V122465" title="53% like this...">
    2
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">To create password protected archive in PHP &gt;= 7.2 use:<br /><br /><span class="default">&lt;?php<br />    $zip</span><span class="keyword">-&gt;</span><span class="default">setEncryptionName</span><span class="keyword">(</span><span class="string">'test.txt'</span><span class="keyword">, </span><span class="default">ZipArchive</span><span class="keyword">::</span><span class="default">EM_AES_256</span><span class="keyword">, </span><span class="string">'test'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Based on example from the documentation:<br /><br /><span class="default">&lt;?php<br /><br />$zip </span><span class="keyword">= new </span><span class="default">ZipArchive</span><span class="keyword">;<br /></span><span class="default">$res </span><span class="keyword">= </span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">open</span><span class="keyword">(</span><span class="string">'test.zip'</span><span class="keyword">, </span><span class="default">ZipArchive</span><span class="keyword">::</span><span class="default">CREATE</span><span class="keyword">);<br />if (</span><span class="default">$res </span><span class="keyword">=== </span><span class="default">TRUE</span><span class="keyword">) {<br />    </span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">addFromString</span><span class="keyword">(</span><span class="string">'test.txt'</span><span class="keyword">, </span><span class="string">'file content goes here'</span><span class="keyword">);<br />    </span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">setEncryptionName</span><span class="keyword">(</span><span class="string">'test.txt'</span><span class="keyword">, </span><span class="default">ZipArchive</span><span class="keyword">::</span><span class="default">EM_AES_256</span><span class="keyword">, </span><span class="string">'passw0rd'</span><span class="keyword">);<br />    </span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">close</span><span class="keyword">();<br />    echo </span><span class="string">'ok'</span><span class="keyword">;<br />} else {<br />    echo </span><span class="string">'failed'</span><span class="keyword">;<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=ziparchive.setpassword&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.setpassword.php">＋<small>add a note</small></a></div>
