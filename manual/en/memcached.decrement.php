...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.decrement.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.decrement.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.decrement.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.decrementbykey.php">
...
<meta name="Description" content="Decrement numeric item's value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::decrement - Manual" />
<meta name="twitter:description" content="Decrement numeric item's value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::decrement - Manual" />
<meta itemprop="description" content="Decrement numeric item's value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decrement numeric item's value" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.decrement.php' selected="selected">English</option>
            ...
            <option value='pt_BR/memcached.decrement.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL memcached &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">Memcached::decrement</span> &mdash; <span class="dc-title">Decrement numeric item&#039;s value</span></p>
 ...
 <div class="refsect1 description" id="refsect1-memcached.decrement-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::decrement()</strong></span> decrements a numeric item&#039;s value
   ...
   <span class="function"><strong>Memcached::decrement()</strong></span> will set the item to the
 ...
 <div class="refsect1 examples" id="refsect1-memcached.decrement-examples">
  ...
  <p class="para">
   <div class="example" id="example-4676">
    <p><strong>Example #1 <span class="function"><strong>Memcached::decrement()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="memcached.decrementbykey.php" class="methodname" rel="rdfs-seeAlso">Memcached::decrementByKey()</a> - Decrement numeric item's value, stored on a specific server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/decrement.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.decrement%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.decrement&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.decrement.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">decrement will not change TTL of the stored key/value.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Found possible bug :<br />decrement fails and returns -1  when memcached::OPT_BINARY_PROTOCOL is set to true.<br /><br />tested on PECL Memcached 2.1.0 and libmemcached version 1.0.8</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>jbaginski</em></strong></a><a class="genanchor" href="#111132"> &para;</a><div class="date" title="2013-01-18 07:31"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111132">
<div class="phpcode"><code><span class="html">PECL memcached &lt; 0.2.0<br /><br />public int Memcached::decrement ( string $key [, int $offset = 1 ] )</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=memcached.decrement&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.decrement.php">＋<small>add a note</small></a></div>
