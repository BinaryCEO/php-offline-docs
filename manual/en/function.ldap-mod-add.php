...
<head>
  ...
  <title>PHP: ldap_mod_add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-mod-add.php">
 <link rel="shorturl" href="https://www.php.net/ldap-mod-add">
 <link rel="alternate" href="https://www.php.net/ldap-mod-add" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-list.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-mod_add-ext.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-mod-add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-mod-add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-mod-add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-mod-add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-mod-add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-mod-add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-mod-add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-mod-add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-mod-add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-mod-add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-mod-add.php" hreflang="zh">
...
<meta name="Description" content="Add attribute values to current attributes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_mod_add - Manual" />
<meta name="twitter:description" content="Add attribute values to current attributes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_mod_add - Manual" />
<meta itemprop="description" content="Add attribute values to current attributes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add attribute values to current attributes" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-mod-add.php' selected="selected">English</option>
            <option value='de/function.ldap-mod-add.php'>German</option>
            <option value='es/function.ldap-mod-add.php'>Spanish</option>
            <option value='fr/function.ldap-mod-add.php'>French</option>
            <option value='it/function.ldap-mod-add.php'>Italian</option>
            <option value='ja/function.ldap-mod-add.php'>Japanese</option>
            <option value='pt_BR/function.ldap-mod-add.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-mod-add.php'>Russian</option>
            <option value='tr/function.ldap-mod-add.php'>Turkish</option>
            <option value='uk/function.ldap-mod-add.php'>Ukrainian</option>
            <option value='zh/function.ldap-mod-add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-mod-add" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ldap-modify-batch.php" class="function" rel="rdfs-seeAlso">ldap_modify_batch()</a> - Batch and execute modifications on an LDAP entry</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-mod-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-mod-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-mod-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-mod-add.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="54821">  <div class="votes">
    <div id="Vu54821">
    <a href="/manual/vote-note.php?id=54821&amp;page=function.ldap-mod-add&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd54821">
    <a href="/manual/vote-note.php?id=54821&amp;page=function.ldap-mod-add&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V54821" title="67% like this...">
    11
    </div>
  </div>
  <a href="#54821" class="name">
  <strong class="user"><em>theiderich AT laweekly dot com</em></strong></a><a class="genanchor" href="#54821"> &para;</a><div class="date" title="2005-07-15 03:17"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom54821">
<div class="phpcode"><code><span class="html">When adding/editing attributes for a user, the 'memberof' attribute is a special case.  The memberOf attribute is not an accessible attribute of the user schema. To add someone to a group, you have to add the user in the group, and not the group in the user. You can do this by accessing the group attribute 'member':<br /><br /><span class="default">&lt;?php<br /><br />$group_name </span><span class="keyword">= </span><span class="string">"CN=MyGroup,OU=Groups,DC=example,DC=com"</span><span class="keyword">;<br /></span><span class="default">$group_info</span><span class="keyword">[</span><span class="string">'member'</span><span class="keyword">] = </span><span class="default">$dn</span><span class="keyword">; </span><span class="comment">// User's DN is added to group's 'member' array<br /></span><span class="default">ldap_mod_add</span><span class="keyword">(</span><span class="default">$connect</span><span class="keyword">,</span><span class="default">$group_name</span><span class="keyword">,</span><span class="default">$group_info</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="113619">  <div class="votes">
    <div id="Vu113619">
    <a href="/manual/vote-note.php?id=113619&amp;page=function.ldap-mod-add&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113619">
    <a href="/manual/vote-note.php?id=113619&amp;page=function.ldap-mod-add&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113619" title="69% like this...">
    5
    </div>
  </div>
  <a href="#113619" class="name">
  <strong class="user"><em>bart-holland at wedefo dot nl</em></strong></a><a class="genanchor" href="#113619"> &para;</a><div class="date" title="2013-11-06 03:44"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113619">
<div class="phpcode"><code><span class="html">Adding a user to a group in Apple's OpenDirectory goes as follows: <br /><br /><span class="default">&lt;?php<br /><br />$dn </span><span class="keyword">= </span><span class="string">"cn=groupname,cn=groups,dc=example,dc=com"</span><span class="keyword">;<br /></span><span class="default">$entry</span><span class="keyword">[</span><span class="string">'memberuid'</span><span class="keyword">] = </span><span class="string">"username"</span><span class="keyword">;<br /><br /></span><span class="default">ldap_mod_add</span><span class="keyword">(</span><span class="default">$connect</span><span class="keyword">, </span><span class="default">$dn</span><span class="keyword">, </span><span class="default">$entry</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="15189">  <div class="votes">
    <div id="Vu15189">
    <a href="/manual/vote-note.php?id=15189&amp;page=function.ldap-mod-add&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd15189">
    <a href="/manual/vote-note.php?id=15189&amp;page=function.ldap-mod-add&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V15189" title="61% like this...">
    3
    </div>
  </div>
  <a href="#15189" class="name">
  <strong class="user"><em>JoshuaStarr at aelana dot com</em></strong></a><a class="genanchor" href="#15189"> &para;</a><div class="date" title="2001-08-30 10:52"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom15189">
<div class="phpcode"><code><span class="html">To add a new attribute with a single value:
<br />
<br />$entry[mail] = "newmail@aelana.com";
<br />$results = ldap_mod_add($ldapConnID, $dn, $entry);
<br />
<br />To add a new attribute with multiple values:
<br />
<br />$entry[mail][] = "newmail@aelana.com";
...
<br />$results = ldap_mod_add($ldapConnID, $dn, $entry);</span></code></div>
  ...
  <div class="note" id="29852">  <div class="votes">
    <div id="Vu29852">
    <a href="/manual/vote-note.php?id=29852&amp;page=function.ldap-mod-add&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd29852">
    <a href="/manual/vote-note.php?id=29852&amp;page=function.ldap-mod-add&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V29852" title="33% like this...">
    -3
    </div>
  </div>
  <a href="#29852" class="name">
  <strong class="user"><em>Claudio Lente &lt;nelchael at ig dot com dot br&gt;</em></strong></a><a class="genanchor" href="#29852"> &para;</a><div class="date" title="2003-02-26 02:03"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom29852">
<div class="phpcode"><code><span class="html">Using PHP 4.2.3 with IIS 5 and Win2k Server. My confs are:<br /><br />$ldap_srvr = 'servername' ;<br />$ldap_port = 389;<br />$ldap_con = ldap_connect($ldap_srvr, $ldap_port);<br />$ldap_rdn  = "username";<br />$ldap_pwd = "__password__"; <br /><br />$ldap_vbind = ldap_bind($ldap_con, $ldap_rdn, $ldap_pwd);<br /><br />$base_dn= 'CN=username,CN=Users,DC=domain,DC=org,DC=us<br />' ;<br />$ldap_filter= 'objectClass=*';<br /><br />$info['mail']='username@domain.org.us';<br /><br />ldap_mod_add($ldap_con, $base_dn, $info);<br />ldap_add($ldap_con, $base_dn, $info);<br /><br />this generate an error: <br />- Warning: LDAP: modify operation could not be completed. in <br /><br />ldap_modify($ldap_con, $base_dn, $info);<br /><br />this function corretly.<br /><br />It?s all.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-mod-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-mod-add.php">＋<small>add a note</small></a></div>
