...
<head>
  ...
  <title>PHP: svn_auth_get_parameter - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-auth-get-parameter.php">
 <link rel="shorturl" href="https://www.php.net/svn-auth-get-parameter">
 <link rel="alternate" href="https://www.php.net/svn-auth-get-parameter" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-add.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-auth-set-parameter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-auth-get-parameter.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-auth-get-parameter.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-auth-get-parameter.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-auth-get-parameter.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-auth-get-parameter.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-auth-get-parameter.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-auth-get-parameter.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-auth-get-parameter.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-auth-get-parameter.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-auth-get-parameter.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-auth-get-parameter.php" hreflang="zh">
...
<meta name="Description" content="Retrieves authentication parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_auth_get_parameter - Manual" />
<meta name="twitter:description" content="Retrieves authentication parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_auth_get_parameter - Manual" />
<meta itemprop="description" content="Retrieves authentication parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieves authentication parameter" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-auth-get-parameter.php' selected="selected">English</option>
            <option value='de/function.svn-auth-get-parameter.php'>German</option>
            <option value='es/function.svn-auth-get-parameter.php'>Spanish</option>
            <option value='fr/function.svn-auth-get-parameter.php'>French</option>
            <option value='it/function.svn-auth-get-parameter.php'>Italian</option>
            <option value='ja/function.svn-auth-get-parameter.php'>Japanese</option>
            <option value='pt_BR/function.svn-auth-get-parameter.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-auth-get-parameter.php'>Russian</option>
            <option value='tr/function.svn-auth-get-parameter.php'>Turkish</option>
            <option value='uk/function.svn-auth-get-parameter.php'>Ukrainian</option>
            <option value='zh/function.svn-auth-get-parameter.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-auth-get-parameter" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="svn.constants.php#svn.constants.auth" class="link">Authentication constants</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-auth-get-parameter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-auth-get-parameter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-auth-get-parameter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-auth-get-parameter.php">＋<small>add a note</small></a></span>
