...
<head>
  ...
  <title>PHP: xml_parser_create - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xml-parser-create.php">
 <link rel="shorturl" href="https://www.php.net/xml-parser-create">
 <link rel="alternate" href="https://www.php.net/xml-parser-create" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.xml.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.xml-parse-into-struct.php">
 <link rel="next" href="https://www.php.net/manual/en/function.xml-parser-create-ns.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.xml-parser-create.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.xml-parser-create.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.xml-parser-create.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.xml-parser-create.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.xml-parser-create.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.xml-parser-create.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.xml-parser-create.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.xml-parser-create.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.xml-parser-create.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.xml-parser-create.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.xml-parser-create.php" hreflang="zh">
...
<meta name="Description" content="Create an XML parser" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: xml_parser_create - Manual" />
<meta name="twitter:description" content="Create an XML parser" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: xml_parser_create - Manual" />
<meta itemprop="description" content="Create an XML parser" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create an XML parser" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.xml-parser-create-ns.php">
          xml_parser_create_ns &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.xml-parse-into-struct.php">
          &laquo; xml_parse_into_struct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xml-parser-create.php' selected="selected">English</option>
            <option value='de/function.xml-parser-create.php'>German</option>
            <option value='es/function.xml-parser-create.php'>Spanish</option>
            <option value='fr/function.xml-parser-create.php'>French</option>
            <option value='it/function.xml-parser-create.php'>Italian</option>
            <option value='ja/function.xml-parser-create.php'>Japanese</option>
            <option value='pt_BR/function.xml-parser-create.php'>Brazilian Portuguese</option>
            <option value='ru/function.xml-parser-create.php'>Russian</option>
            <option value='tr/function.xml-parser-create.php'>Turkish</option>
            <option value='uk/function.xml-parser-create.php'>Ukrainian</option>
            <option value='zh/function.xml-parser-create.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.xml-parser-create" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.xml-parser-free.php" class="function" rel="rdfs-seeAlso">xml_parser_free()</a> - Free an XML parser</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xml/functions/xml-parser-create.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xml-parser-create%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xml-parser-create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xml-parser-create.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">5 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="100099">  <div class="votes">
    <div id="Vu100099">
    <a href="/manual/vote-note.php?id=100099&amp;page=function.xml-parser-create&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd100099">
    <a href="/manual/vote-note.php?id=100099&amp;page=function.xml-parser-create&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V100099" title="65% like this...">
    12
    </div>
  </div>
  <a href="#100099" class="name">
  <strong class="user"><em>marek995 at seznam dot cz</em></strong></a><a class="genanchor" href="#100099"> &para;</a><div class="date" title="2010-09-24 11:46"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom100099">
<div class="phpcode"><code><span class="html">I created a function, which combines xml_paresr_create and all functions around.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">html_parse</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">)<br />     {<br />      </span><span class="default">$array </span><span class="keyword">= </span><span class="default">str_split</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br />      </span><span class="default">$count </span><span class="keyword">= </span><span class="default">false</span><span class="keyword">;<br />      </span><span class="default">$text </span><span class="keyword">= </span><span class="string">""</span><span class="keyword">;<br />      </span><span class="default">$end </span><span class="keyword">= </span><span class="default">false</span><span class="keyword">;<br />      foreach(</span><span class="default">$array </span><span class="keyword">as </span><span class="default">$temp</span><span class="keyword">)<br />       {<br />        switch(</span><span class="default">$temp</span><span class="keyword">)<br />         {<br />          case </span><span class="string">"&lt;"</span><span class="keyword">:<br />           </span><span class="default">between</span><span class="keyword">(</span><span class="default">$text</span><span class="keyword">);<br />           </span><span class="default">$text </span><span class="keyword">= </span><span class="string">""</span><span class="keyword">;<br />           </span><span class="default">$count </span><span class="keyword">= </span><span class="default">true</span><span class="keyword">;<br />           </span><span class="default">$end </span><span class="keyword">= </span><span class="default">false</span><span class="keyword">;<br />           break;<br />          case </span><span class="string">"&gt;"</span><span class="keyword">:<br />           if(</span><span class="default">$end </span><span class="keyword">== </span><span class="default">true</span><span class="keyword">) {</span><span class="default">end_tag</span><span class="keyword">(</span><span class="default">$text</span><span class="keyword">);}<br />           else {</span><span class="default">start_tag</span><span class="keyword">(</span><span class="default">$text</span><span class="keyword">);}<br />           </span><span class="default">$text </span><span class="keyword">= </span><span class="string">""</span><span class="keyword">;<br />           break;<br />          case </span><span class="string">"/"</span><span class="keyword">:<br />           if(</span><span class="default">$count </span><span class="keyword">== </span><span class="default">true</span><span class="keyword">) {</span><span class="default">$end </span><span class="keyword">= </span><span class="default">true</span><span class="keyword">;}<br />           else {</span><span class="default">$text </span><span class="keyword">= </span><span class="default">$text </span><span class="keyword">. </span><span class="string">"/"</span><span class="keyword">;}<br />           break;<br />          default:<br />           </span><span class="default">$count </span><span class="keyword">= </span><span class="default">false</span><span class="keyword">;<br />           </span><span class="default">$text </span><span class="keyword">= </span><span class="default">$text </span><span class="keyword">. </span><span class="default">$temp</span><span class="keyword">;<br />         }<br />       }<br />     }<br /></span><span class="default">?&gt;<br /></span>The input value is a string.<br />It calls functions start_tag() , between() and end_tag() just like the original xml parser.<br /><br />But it has a few differences:<br />  - It does NOT check the code. Just resends values to that three functions, no matter, if they are right<br />  - It works with parameters. For example: from tag &lt;sth b="42"&gt; sends sth b="42"<br />  - It works wit diacritics. The original parser sometimes wrapped the text before the first diacritics appearance.<br />  - Works with all encoding. If the input is UTF-8, the output will be UTF-8 too<br />  - It works with strings. Not with file pointers.<br />  - No "Reserved XML name" error<br />  - No doctype needed<br />  - It does not work with commentaries, notes, programming instructions etc. Just the tags<br /><br />definition of the handling functions is:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">between</span><span class="keyword">(</span><span class="default">$stuff</span><span class="keyword">) {}<br /></span><span class="default">?&gt;<br /></span><br />No other attributes</span></code></div>
  </div>
 </div>
  <div class="note" id="41235">  <div class="votes">
    <div id="Vu41235">
    <a href="/manual/vote-note.php?id=41235&amp;page=function.xml-parser-create&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd41235">
    <a href="/manual/vote-note.php?id=41235&amp;page=function.xml-parser-create&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V41235" title="66% like this...">
    2
    </div>
  </div>
  <a href="#41235" class="name">
  <strong class="user"><em>jcalvert at gmx dot net</em></strong></a><a class="genanchor" href="#41235"> &para;</a><div class="date" title="2004-04-03 10:39"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom41235">
<div class="phpcode"><code><span class="html">To maintain compatibility between PHP4 and PHP5 you should always pass a string argument to this function. PHP4 autodetects the format of the input if you leave it out whereas PHP5 will assume the format to be ISO-8859-1 (and choke on the byte order marker of UTF-8 files).<br /><br />Calling the function as <span class="default">&lt;?php $res </span><span class="keyword">= </span><span class="default">xml_parser_create</span><span class="keyword">(</span><span class="string">''</span><span class="keyword">) </span><span class="default">?&gt;</span> will cause both versions of PHP to autodetect the format.</span></code></div>
  </div>
 </div>
  <div class="note" id="53188">  <div class="votes">
    <div id="Vu53188">
    <a href="/manual/vote-note.php?id=53188&amp;page=function.xml-parser-create&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd53188">
    <a href="/manual/vote-note.php?id=53188&amp;page=function.xml-parser-create&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V53188" title="52% like this...">
    1
    </div>
  </div>
  <a href="#53188" class="name">
  <strong class="user"><em>Tobbe</em></strong></a><a class="genanchor" href="#53188"> &para;</a><div class="date" title="2005-05-25 06:01"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom53188">
<div class="phpcode"><code><span class="html">The above "XML to array" code does not work properly if you have several tags on the same level and with the same name, example:<br /><br />&lt;currenterrors&gt;<br />&lt;error&gt;<br />&lt;description&gt;This is a real error...&lt;/description&gt;<br />&lt;/error&gt;<br />&lt;error&gt;<br />&lt;description&gt;This is a second error...&lt;/description&gt;<br />&lt;/error&gt;<br />&lt;error&gt;<br />&lt;description&gt;Lots of errors today...&lt;/description&gt;<br />&lt;/error&gt;<br />&lt;error&gt;<br />&lt;description&gt;This is the last error...&lt;/description&gt;<br />&lt;/error&gt;<br />&lt;/currenterrors&gt;<br /><br />It will then only display the first &lt;error&gt;-tag.<br />In this case you will need to number the tags automatically or maybe have several arrays for each new element.</span></code></div>
  </div>
 </div>
  <div class="note" id="50182">  <div class="votes">
    <div id="Vu50182">
    <a href="/manual/vote-note.php?id=50182&amp;page=function.xml-parser-create&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd50182">
    <a href="/manual/vote-note.php?id=50182&amp;page=function.xml-parser-create&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V50182" title="42% like this...">
    -1
    </div>
  </div>
  <a href="#50182" class="name">
  <strong class="user"><em>php at stock-consulting dot com</em></strong></a><a class="genanchor" href="#50182"> &para;</a><div class="date" title="2005-02-21 02:47"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom50182">
<div class="phpcode"><code><span class="html">Even though I passed "UTF-8" as encoding type PHP (Version 4.3.3) did *not* treat the input file as UTF-8. The input file was missing the BOM header bytes (which may indeed be omitted, according to RFC3629...but things are a bit unclear there. The RFC seems to make mere recommendations concering the BOM header). If you want to sure that PHP treats an UTF-8 encoded file correctly, make sure that it begins with the corresponding 3 byte BOM header (0xEF 0xBB 0xBF)</span></code></div>
  </div>
 </div>
  <div class="note" id="123621">  <div class="votes">
    <div id="Vu123621">
    <a href="/manual/vote-note.php?id=123621&amp;page=function.xml-parser-create&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123621">
    <a href="/manual/vote-note.php?id=123621&amp;page=function.xml-parser-create&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123621" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#123621" class="name">
  <strong class="user"><em>bishop at php dot net</em></strong></a><a class="genanchor" href="#123621"> &para;</a><div class="date" title="2019-02-17 04:23"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123621">
<div class="phpcode"><code><span class="html">Internals has proposed[1] changing this extension from resource-based to object-based. When this change is made, xml_parser_create will return an object, not a resource. Application developers are encouraged to replace any checks for explicit success, like:<br /><br /><span class="default">&lt;?php<br />$res </span><span class="keyword">= </span><span class="default">xml_parser_create</span><span class="keyword">(</span><span class="comment">/*...*/</span><span class="keyword">);<br />if (! </span><span class="default">is_resource</span><span class="keyword">(</span><span class="default">$res</span><span class="keyword">)) {<br />    </span><span class="comment">// ...<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;<br /></span><br />With a check for explicit failure:<br /><span class="default">&lt;?php<br />$res </span><span class="keyword">= </span><span class="default">xml_parser_create</span><span class="keyword">(</span><span class="comment">/*...*/</span><span class="keyword">);<br />if (</span><span class="default">false </span><span class="keyword">=== </span><span class="default">$res</span><span class="keyword">) {<br />    </span><span class="comment">// ...<br /></span><span class="keyword">}<br /><br />[</span><span class="default">1</span><span class="keyword">]: </span><span class="default">https</span><span class="keyword">:</span><span class="comment">//marc.info/?l=php-internals&amp;m=154998365013373&amp;w=2</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.xml-parser-create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xml-parser-create.php">＋<small>add a note</small></a></div>
