...
<head>
  ...
  <title>PHP: SolrQuery::setQuery - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setquery.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setquery.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setquery.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setomitheader.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setrows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setquery.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setquery.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setquery.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setquery.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setquery.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setquery.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setquery.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setquery.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setquery.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setquery.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setquery.php" hreflang="zh">
...
<meta name="Description" content="Sets the search query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setQuery - Manual" />
<meta name="twitter:description" content="Sets the search query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setQuery - Manual" />
<meta itemprop="description" content="Sets the search query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the search query" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setrows.php">
          SolrQuery::setRows &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setomitheader.php">
          &laquo; SolrQuery::setOmitHeader        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setquery.php' selected="selected">English</option>
            <option value='de/solrquery.setquery.php'>German</option>
            <option value='es/solrquery.setquery.php'>Spanish</option>
            <option value='fr/solrquery.setquery.php'>French</option>
            <option value='it/solrquery.setquery.php'>Italian</option>
            <option value='ja/solrquery.setquery.php'>Japanese</option>
            <option value='pt_BR/solrquery.setquery.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setquery.php'>Russian</option>
            <option value='tr/solrquery.setquery.php'>Turkish</option>
            <option value='uk/solrquery.setquery.php'>Ukrainian</option>
            <option value='zh/solrquery.setquery.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setquery" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setQuery</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setQuery</span> &mdash; <span class="dc-title">Sets the search query</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setquery-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setQuery</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$query</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setquery-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setquery-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setquery.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setquery%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setquery&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setquery.php">＋<small>add a note</small></a></span>
