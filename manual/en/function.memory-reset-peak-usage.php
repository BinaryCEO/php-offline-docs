...
<head>
  ...
  <title>PHP: memory_reset_peak_usage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.memory-reset-peak-usage.php">
 <link rel="shorturl" href="https://www.php.net/memory-reset-peak-usage">
 <link rel="alternate" href="https://www.php.net/memory-reset-peak-usage" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.memory-get-usage.php">
 <link rel="next" href="https://www.php.net/manual/en/function.php-ini-loaded-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.memory-reset-peak-usage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.memory-reset-peak-usage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.memory-reset-peak-usage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.memory-reset-peak-usage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.memory-reset-peak-usage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.memory-reset-peak-usage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.memory-reset-peak-usage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.memory-reset-peak-usage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.memory-reset-peak-usage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.memory-reset-peak-usage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.memory-reset-peak-usage.php" hreflang="zh">
...
<meta name="Description" content="Reset the peak memory usage" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: memory_reset_peak_usage - Manual" />
<meta name="twitter:description" content="Reset the peak memory usage" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: memory_reset_peak_usage - Manual" />
<meta itemprop="description" content="Reset the peak memory usage" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reset the peak memory usage" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.php-ini-loaded-file.php">
          php_ini_loaded_file &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.memory-get-usage.php">
          &laquo; memory_get_usage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.memory-reset-peak-usage.php' selected="selected">English</option>
            <option value='de/function.memory-reset-peak-usage.php'>German</option>
            <option value='es/function.memory-reset-peak-usage.php'>Spanish</option>
            <option value='fr/function.memory-reset-peak-usage.php'>French</option>
            <option value='it/function.memory-reset-peak-usage.php'>Italian</option>
            <option value='ja/function.memory-reset-peak-usage.php'>Japanese</option>
            <option value='pt_BR/function.memory-reset-peak-usage.php'>Brazilian Portuguese</option>
            <option value='ru/function.memory-reset-peak-usage.php'>Russian</option>
            <option value='tr/function.memory-reset-peak-usage.php'>Turkish</option>
            <option value='uk/function.memory-reset-peak-usage.php'>Ukrainian</option>
            <option value='zh/function.memory-reset-peak-usage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.memory-reset-peak-usage" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.memory-reset-peak-usage-examples">
  ...
  <p class="para">
   <div class="example" id="example-663">
    <p><strong>Example #1 <span class="function"><strong>memory_reset_peak_usage()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.memory-get-peak-usage.php" class="function" rel="rdfs-seeAlso">memory_get_peak_usage()</a> - Returns the peak of memory allocated by PHP</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/memory-reset-peak-usage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.memory-reset-peak-usage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.memory-reset-peak-usage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.memory-reset-peak-usage.php">＋<small>add a note</small></a></span>
