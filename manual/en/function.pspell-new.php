...
<head>
  ...
  <title>PHP: pspell_new - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pspell-new.php">
 <link rel="shorturl" href="https://www.php.net/pspell-new">
 <link rel="alternate" href="https://www.php.net/pspell-new" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pspell.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pspell-config-save-repl.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pspell-new-config.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pspell-new.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pspell-new.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pspell-new.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pspell-new.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pspell-new.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pspell-new.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pspell-new.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pspell-new.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pspell-new.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pspell-new.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pspell-new.php" hreflang="zh">
...
<meta name="Description" content="Load a new dictionary" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pspell_new - Manual" />
<meta name="twitter:description" content="Load a new dictionary" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pspell_new - Manual" />
<meta itemprop="description" content="Load a new dictionary" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Load a new dictionary" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pspell-new-config.php">
          pspell_new_config &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pspell-config-save-repl.php">
          &laquo; pspell_config_save_repl        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pspell-new.php' selected="selected">English</option>
            <option value='de/function.pspell-new.php'>German</option>
            <option value='es/function.pspell-new.php'>Spanish</option>
            <option value='fr/function.pspell-new.php'>French</option>
            <option value='it/function.pspell-new.php'>Italian</option>
            <option value='ja/function.pspell-new.php'>Japanese</option>
            <option value='pt_BR/function.pspell-new.php'>Brazilian Portuguese</option>
            <option value='ru/function.pspell-new.php'>Russian</option>
            <option value='tr/function.pspell-new.php'>Turkish</option>
            <option value='uk/function.pspell-new.php'>Ukrainian</option>
            <option value='zh/function.pspell-new.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pspell-new" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.pspell-new-examples">
  ...
  <p class="para">
   <div class="example" id="example-2804">
    <p><strong>Example #1 <span class="function"><strong>pspell_new()</strong></span></strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pspell </span><span style="color: #007700">= </span><span style="color: #0000BB">pspell_new</span><span style="color: #007700">(</span><span style="color: #DD0000">"en"</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">,<br />                     (</span><span style="color: #0000BB">PSPELL_FAST</span><span style="color: #007700">|</span><span style="color: #0000BB">PSPELL_RUN_TOGETHER</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pspell/functions/pspell-new.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pspell-new%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pspell-new&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pspell-new.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="86020">  <div class="votes">
    <div id="Vu86020">
    <a href="/manual/vote-note.php?id=86020&amp;page=function.pspell-new&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd86020">
    <a href="/manual/vote-note.php?id=86020&amp;page=function.pspell-new&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V86020" title="82% like this...">
    11
    </div>
  </div>
  <a href="#86020" class="name">
  <strong class="user"><em>wookie</em></strong></a><a class="genanchor" href="#86020"> &para;</a><div class="date" title="2008-09-29 11:52"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom86020">
<div class="phpcode"><code><span class="html">Just as a small tip, I noticed that when you call pspell_new multiple times, php does not free memory usage when the resource is destroyed, but only when your entire script has completely finished. So if you create a pspell_link resource and you intend to use it again somewhere else, instead of calling pspell_new again, keep track of your original pspell_link resource instantiation, and use it again, your script will run much more efficiently. <br /><br />I was switching between 16 dictionaries by just calling a new pspell_new everytime, my memory usage on the server grew until i hit a failure/php core dump. :-/ So i stored each pspell resource in an array keyed by language, and checked if the resource existed first, before creating one if needed.<br /><br />I hope that helps someone.</span></code></div>
  </div>
 </div>
  <div class="note" id="85231">  <div class="votes">
    <div id="Vu85231">
    <a href="/manual/vote-note.php?id=85231&amp;page=function.pspell-new&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd85231">
    <a href="/manual/vote-note.php?id=85231&amp;page=function.pspell-new&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V85231" title="60% like this...">
    1
    </div>
  </div>
  <a href="#85231" class="name">
  <strong class="user"><em>allan at wagawaga dot dk</em></strong></a><a class="genanchor" href="#85231"> &para;</a><div class="date" title="2008-08-21 05:00"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom85231">
<div class="phpcode"><code><span class="html">I think the language and spelling parameters differs on different PHP versions and/or aspell/UNIX distributions.<br /><br />My PHP 5.2.6 Debian ignores the spelling parameter. <br /><br />Instead:<br /><br />For Americans use en_US as language.<br />For British use en_GB (not en_UK)<br />For Canadian use en_CA</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pspell-new&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pspell-new.php">＋<small>add a note</small></a></div>
