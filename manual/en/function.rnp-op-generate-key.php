...
<head>
  ...
  <title>PHP: rnp_op_generate_key - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rnp-op-generate-key.php">
 <link rel="shorturl" href="https://www.php.net/rnp-op-generate-key">
 <link rel="alternate" href="https://www.php.net/rnp-op-generate-key" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.rnp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.rnp-op-encrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rnp-op-sign.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rnp-op-generate-key.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rnp-op-generate-key.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rnp-op-generate-key.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rnp-op-generate-key.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rnp-op-generate-key.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rnp-op-generate-key.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rnp-op-generate-key.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rnp-op-generate-key.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rnp-op-generate-key.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rnp-op-generate-key.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rnp-op-generate-key.php" hreflang="zh">
...
<meta name="Description" content="Generate key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rnp_op_generate_key - Manual" />
<meta name="twitter:description" content="Generate key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rnp_op_generate_key - Manual" />
<meta itemprop="description" content="Generate key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generate key" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rnp-op-generate-key.php' selected="selected">English</option>
            <option value='de/function.rnp-op-generate-key.php'>German</option>
            <option value='es/function.rnp-op-generate-key.php'>Spanish</option>
            <option value='fr/function.rnp-op-generate-key.php'>French</option>
            <option value='it/function.rnp-op-generate-key.php'>Italian</option>
            <option value='ja/function.rnp-op-generate-key.php'>Japanese</option>
            <option value='pt_BR/function.rnp-op-generate-key.php'>Brazilian Portuguese</option>
            <option value='ru/function.rnp-op-generate-key.php'>Russian</option>
            <option value='tr/function.rnp-op-generate-key.php'>Turkish</option>
            <option value='uk/function.rnp-op-generate-key.php'>Ukrainian</option>
            <option value='zh/function.rnp-op-generate-key.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rnp-op-generate-key" class="refentry">
  ...
  <p class="para">
   ...
   <span class="function"><a href="function.rnp-save-keys.php" class="function">rnp_save_keys()</a></span> or <span class="function"><a href="function.rnp-save-keys-to-path.php" class="function">rnp_save_keys_to_path()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/functions/rnp-op-generate-key.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rnp-op-generate-key%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rnp-op-generate-key&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rnp-op-generate-key.php">＋<small>add a note</small></a></span>
