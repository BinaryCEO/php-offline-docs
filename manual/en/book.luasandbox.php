...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.luasandbox.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/luaclosure.invoke.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.luasandbox.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.luasandbox.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.luasandbox.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.luasandbox.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.luasandbox.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.luasandbox.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.luasandbox.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.luasandbox.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.luasandbox.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.luasandbox.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.luasandbox.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.luasandbox.php" hreflang="zh">
...
<meta name="Description" content="LuaSandbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: LuaSandbox - Manual" />
<meta name="twitter:description" content="LuaSandbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: LuaSandbox - Manual" />
<meta itemprop="description" content="LuaSandbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="LuaSandbox" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.luasandbox.php' selected="selected">English</option>
            <option value='de/book.luasandbox.php'>German</option>
            <option value='es/book.luasandbox.php'>Spanish</option>
            <option value='fr/book.luasandbox.php'>French</option>
            <option value='it/book.luasandbox.php'>Italian</option>
            <option value='ja/book.luasandbox.php'>Japanese</option>
            <option value='pt_BR/book.luasandbox.php'>Brazilian Portuguese</option>
            <option value='ru/book.luasandbox.php'>Russian</option>
            <option value='tr/book.luasandbox.php'>Turkish</option>
            <option value='uk/book.luasandbox.php'>Ukrainian</option>
            <option value='zh/book.luasandbox.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.luasandbox" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.luasandbox.php">Introduction</a></li><li><a href="luasandbox.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="luasandbox.requirements.php">Requirements</a></li><li><a href="luasandbox.installation.php">Installation</a></li></ul></li><li><a href="reference.luasandbox.differences.php">Differences from Standard Lua</a></li><li><a href="luasandbox.examples.php">Examples</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="luasandbox.examples-basic.php">Basic usage for LuaSandbox</a></li></ul></li><li><a href="class.luasandbox.php">LuaSandbox</a> — The LuaSandbox class<ul class="chunklist chunklist_book chunklist_children"><li><a href="luasandbox.callfunction.php">LuaSandbox::callFunction</a> — Call a function in a Lua global variable</li><li><a href="luasandbox.disableprofiler.php">LuaSandbox::disableProfiler</a> — Disable the profiler</li><li><a href="luasandbox.enableprofiler.php">LuaSandbox::enableProfiler</a> — Enable the profiler.</li><li><a href="luasandbox.getcpuusage.php">LuaSandbox::getCPUUsage</a> — Fetch the current CPU time usage of the Lua environment</li><li><a href="luasandbox.getmemoryusage.php">LuaSandbox::getMemoryUsage</a> — Fetch the current memory usage of the Lua environment</li><li><a href="luasandbox.getpeakmemoryusage.php">LuaSandbox::getPeakMemoryUsage</a> — Fetch the peak memory usage of the Lua environment</li><li><a href="luasandbox.getprofilerfunctionreport.php">LuaSandbox::getProfilerFunctionReport</a> — Fetch profiler data</li><li><a href="luasandbox.getversioninfo.php">LuaSandbox::getVersionInfo</a> — Return the versions of LuaSandbox and Lua</li><li><a href="luasandbox.loadbinary.php">LuaSandbox::loadBinary</a> — Load a precompiled binary chunk into the Lua environment</li><li><a href="luasandbox.loadstring.php">LuaSandbox::loadString</a> — Load Lua code into the Lua environment</li><li><a href="luasandbox.pauseusagetimer.php">LuaSandbox::pauseUsageTimer</a> — Pause the CPU usage timer</li><li><a href="luasandbox.registerlibrary.php">LuaSandbox::registerLibrary</a> — Register a set of PHP functions as a Lua library</li><li><a href="luasandbox.setcpulimit.php">LuaSandbox::setCPULimit</a> — Set the CPU time limit for the Lua environment</li><li><a href="luasandbox.setmemorylimit.php">LuaSandbox::setMemoryLimit</a> — Set the memory limit for the Lua environment</li><li><a href="luasandbox.unpauseusagetimer.php">LuaSandbox::unpauseUsageTimer</a> — Unpause the timer paused by LuaSandbox::pauseUsageTimer</li><li><a href="luasandbox.wrapphpfunction.php">LuaSandbox::wrapPhpFunction</a> — Wrap a PHP callable in a LuaSandboxFunction</li></ul></li><li><a href="class.luasandboxfunction.php">LuaSandboxFunction</a> — The LuaSandboxFunction class<ul class="chunklist chunklist_book chunklist_children"><li><a href="luasandboxfunction.call.php">LuaSandboxFunction::call</a> — Call a Lua function</li><li><a href="luasandboxfunction.construct.php">LuaSandboxFunction::__construct</a> — Unused</li><li><a href="luasandboxfunction.dump.php">LuaSandboxFunction::dump</a> — Dump the function as a binary blob</li></ul></li><li><a href="class.luasandboxerror.php">LuaSandboxError</a> — The LuaSandboxError class</li><li><a href="class.luasandboxerrorerror.php">LuaSandboxErrorError</a> — The LuaSandboxErrorError class</li><li><a href="class.luasandboxfatalerror.php">LuaSandboxFatalError</a> — The LuaSandboxFatalError class</li><li><a href="class.luasandboxmemoryerror.php">LuaSandboxMemoryError</a> — The LuaSandboxMemoryError class</li><li><a href="class.luasandboxruntimeerror.php">LuaSandboxRuntimeError</a> — The LuaSandboxRuntimeError class</li><li><a href="class.luasandboxsyntaxerror.php">LuaSandboxSyntaxError</a> — The LuaSandboxSyntaxError class</li><li><a href="class.luasandboxtimeouterror.php">LuaSandboxTimeoutError</a> — The LuaSandboxTimeoutError class</li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.luasandbox%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.luasandbox&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.luasandbox.php">＋<small>add a note</small></a></span>
