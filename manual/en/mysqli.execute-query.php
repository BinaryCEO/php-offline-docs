...
<head>
  ...
  <title>PHP: mysqli::execute_query - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.execute-query.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.execute-query.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.execute-query.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.error-list.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.field-count.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.execute-query.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.execute-query.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.execute-query.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.execute-query.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.execute-query.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.execute-query.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.execute-query.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.execute-query.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.execute-query.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.execute-query.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.execute-query.php" hreflang="zh">
...
<meta name="Description" content="Prepares, binds parameters, and executes SQL statement" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::execute_query - Manual" />
<meta name="twitter:description" content="Prepares, binds parameters, and executes SQL statement" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::execute_query - Manual" />
<meta itemprop="description" content="Prepares, binds parameters, and executes SQL statement" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Prepares, binds parameters, and executes SQL statement" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli.field-count.php">
          mysqli::$field_count &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.error-list.php">
          &laquo; mysqli::$error_list        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.execute-query.php' selected="selected">English</option>
            <option value='de/mysqli.execute-query.php'>German</option>
            <option value='es/mysqli.execute-query.php'>Spanish</option>
            <option value='fr/mysqli.execute-query.php'>French</option>
            <option value='it/mysqli.execute-query.php'>Italian</option>
            <option value='ja/mysqli.execute-query.php'>Japanese</option>
            <option value='pt_BR/mysqli.execute-query.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.execute-query.php'>Russian</option>
            <option value='tr/mysqli.execute-query.php'>Turkish</option>
            <option value='uk/mysqli.execute-query.php'>Ukrainian</option>
            <option value='zh/mysqli.execute-query.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.execute-query" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-mysqli.execute-query-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>mysqli::execute_query</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$query</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.array.php" class="type array">array</a></span></span> <code class="parameter">$params</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="class.mysqli-result.php" class="type mysqli_result">mysqli_result</a></span>|<span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>

  <p class="para rdfs-comment">Procedural style</p>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>mysqli_execute_query</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli.php" class="type mysqli">mysqli</a></span> <code class="parameter">$mysql</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$query</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.array.php" class="type array">array</a></span></span> <code class="parameter">$params</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="class.mysqli-result.php" class="type mysqli_result">mysqli_result</a></span>|<span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <span class="methodname"><a href="mysqli.prepare.php" class="methodname">mysqli::prepare()</a></span>,
   <span class="methodname"><a href="mysqli-stmt.bind-param.php" class="methodname">mysqli_stmt::bind_param()</a></span>,
   <span class="methodname"><a href="mysqli-stmt.execute.php" class="methodname">mysqli_stmt::execute()</a></span>,
   and <span class="methodname"><a href="mysqli-stmt.get-result.php" class="methodname">mysqli_stmt::get_result()</a></span>.
  </p>
  <p class="para">
   ...
   The parameter values must be provided as an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> using
  ...
  <p class="para">
   ...
   statement as one would do with the <span class="classname"><a href="class.mysqli-stmt.php" class="classname">mysqli_stmt</a></span> object.
   Due to this limitation, the status information is copied to the
   <span class="classname"><a href="class.mysqli.php" class="classname">mysqli</a></span> object and is available using its methods, e.g.
   <span class="function"><a href="mysqli.affected-rows.php" class="function">mysqli_affected_rows()</a></span> or <span class="function"><a href="mysqli.error.php" class="function">mysqli_error()</a></span>.
  </p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli-stmt.get-result.php" class="function" rel="rdfs-seeAlso">mysqli_stmt_get_result()</a> - Gets a result set from a prepared statement as a mysqli_result object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/execute-query.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.execute-query%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.execute-query&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.execute-query.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="129110">  <div class="votes">
    <div id="Vu129110">
    <a href="/manual/vote-note.php?id=129110&amp;page=mysqli.execute-query&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129110">
    <a href="/manual/vote-note.php?id=129110&amp;page=mysqli.execute-query&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129110" title="83% like this...">
    4
    </div>
  </div>
  <a href="#129110" class="name">
  <strong class="user"><em>theking2(at)king(dot).co.</em></strong></a><a class="genanchor" href="#129110"> &para;</a><div class="date" title="2023-12-16 07:24"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129110">
<div class="phpcode"><code><span class="html">A function to call a stored procedure with an arbitrary number of IN parameters and one OUT parameter, for instance returning affected row count. The return value of yhe function is this value.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">/**<br /> * call_sp Call the specified stored procedure with the given parameters.<br /> * The first parameter is the name of the stored procedure.<br /> * The remaining parameters are the (in) parameters to the stored procedure.<br /> * the last (out) parameter should be an int, like state or number of affected rows.<br /> *<br /> * @param  mixed $sp_name The name of the stored procedure to call.<br /> * @param  mixed $params The parameters to pass to the stored procedure.<br /> * @return int The number of affected rows.<br /> */<br /></span><span class="keyword">function </span><span class="default">call_sp</span><span class="keyword">( </span><span class="default">\mysqli $db</span><span class="keyword">, </span><span class="default">string $sp_name</span><span class="keyword">, ...</span><span class="default">$params </span><span class="keyword">): </span><span class="default">int<br /></span><span class="keyword">{<br />  </span><span class="default">$sql </span><span class="keyword">= </span><span class="string">"CALL </span><span class="default">$sp_name</span><span class="string">( "</span><span class="keyword">;<br />  </span><span class="default">$sql </span><span class="keyword">.= </span><span class="default">implode</span><span class="keyword">( </span><span class="string">", "</span><span class="keyword">, </span><span class="default">array_fill</span><span class="keyword">( </span><span class="default">0</span><span class="keyword">, </span><span class="default">count</span><span class="keyword">( </span><span class="default">$params </span><span class="keyword">), </span><span class="string">"?" </span><span class="keyword">) );<br />  </span><span class="default">$sql </span><span class="keyword">.= </span><span class="string">", @__affected );"</span><span class="keyword">;<br /><br />  </span><span class="default">$result   </span><span class="keyword">= </span><span class="default">$db</span><span class="keyword">-&gt;</span><span class="default">execute_query</span><span class="keyword">( </span><span class="default">$sql</span><span class="keyword">, </span><span class="default">$params </span><span class="keyword">);<br />  </span><span class="default">$result   </span><span class="keyword">= </span><span class="default">$db</span><span class="keyword">-&gt;</span><span class="default">query</span><span class="keyword">( </span><span class="string">"select @__affected;" </span><span class="keyword">);<br />  </span><span class="default">$affected </span><span class="keyword">= (int) </span><span class="default">$result</span><span class="keyword">-&gt;</span><span class="default">fetch_column</span><span class="keyword">( </span><span class="default">0 </span><span class="keyword">);<br />  return </span><span class="default">$affected</span><span class="keyword">;<br />}</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli.execute-query&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.execute-query.php">＋<small>add a note</small></a></div>
