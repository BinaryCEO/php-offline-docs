...
<div class="phpcode"><code><span class="html">Note that from libxml 2.7.9+ there is a limit of 10MB for the XML-RPC response.<br /><br />If the response is larger, xmlrpc_decode will simply return NULL.<br /><br />There is currently no way to override this limit like we can with the other xml functions (LIBXML_PARSEHUGE)</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Make sure the server isn't returning a string with a space for the first character, this fails in version 5.3.3 and the function returns null (though seems to be ok in 5.2).  
<br />
<br />Easily sorted by  trimming the response data:
<br />
<br /><span class="default">&lt;?php xmlrpc_decode</span><span class="keyword">( </span><span class="default">trim</span><span class="keyword">(</span><span class="default">$response</span><span class="keyword">) ); </span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Use this with an XML-RPC client to decode a server response into native PHP variables. It will automatically translate the response XML-RPC data types into their PHP equivalents.<br /><br />This function will return only false is there is any problem with format of the XML it receives.<br /><br />The HTTP response header will need to be stripped off with something like;<br /><br /><span class="default">&lt;?php<br />$xml</span><span class="keyword">=(</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$response</span><span class="keyword">, </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$response</span><span class="keyword">, </span><span class="string">"\r\n\r\n"</span><span class="keyword">)+</span><span class="default">4</span><span class="keyword">));<br /><br /></span><span class="default">$phpvars </span><span class="keyword">= </span><span class="default">xmlrpc_decode </span><span class="keyword">(</span><span class="default">$xml</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">64 bit (i8) integers are not parsed by xmlrpc_decode().<br />Use a string replacement to work around this:<br /><br /><span class="default">&lt;?php<br /><br />$xml </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">'i8&gt;'</span><span class="keyword">, </span><span class="string">'i4&gt;'</span><span class="keyword">, </span><span class="default">$xml</span><span class="keyword">);<br /><br /></span><span class="default">$decoded_xml </span><span class="keyword">= </span><span class="default">xmlrpc_decode</span><span class="keyword">(</span><span class="default">$xml</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Be careful with encodings, the xmlrpc-decode function is rather strict. For example, the following response parse returns NULL :<br /><br />&lt;?xml version="1.0"?&gt;<br />&lt;methodResponse&gt;<br />   &lt;params&gt;<br />      &lt;param&gt;<br />         &lt;value&gt;&lt;string&gt;a &amp; b&lt;/string&gt;&lt;/value&gt;<br />         &lt;/param&gt;<br />      &lt;/params&gt;<br />   &lt;/methodResponse&gt;<br /><br />You should use entities : <br />&lt;?xml version="1.0"?&gt;<br />&lt;methodResponse&gt;<br />   &lt;params&gt;<br />      &lt;param&gt;<br />         &lt;value&gt;&lt;string&gt;a &amp;amp; b&lt;/string&gt;&lt;/value&gt;<br />         &lt;/param&gt;<br />      &lt;/params&gt;<br />   &lt;/methodResponse&gt;<br /><br />If your server does not encode responses properly, you may have to process responses before parse.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Apparently there is a slight problem with xmlrpc_decode (or php) which re-formats this input: &lt;value&gt;&lt;double&gt;0.000000&lt;/double&gt;&lt;/value&gt;<br /><br />As the double number 0.<br /><br />To get around it, use: number_format($val, 2);<br />Output would be 0.00</span></code></div>
  </div>
 </div></div>
