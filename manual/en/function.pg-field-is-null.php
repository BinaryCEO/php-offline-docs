...
<head>
  ...
  <title>PHP: pg_field_is_null - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-field-is-null.php">
 <link rel="shorturl" href="https://www.php.net/pg-field-is-null">
 <link rel="alternate" href="https://www.php.net/pg-field-is-null" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-fetch-row.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-field-name.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-field-is-null.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-field-is-null.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-field-is-null.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-field-is-null.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-field-is-null.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-field-is-null.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-field-is-null.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-field-is-null.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-field-is-null.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-field-is-null.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-field-is-null.php" hreflang="zh">
...
<meta name="Description" content="Test if a field is SQL NULL" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_field_is_null - Manual" />
<meta name="twitter:description" content="Test if a field is SQL NULL" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_field_is_null - Manual" />
<meta itemprop="description" content="Test if a field is SQL NULL" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Test if a field is SQL NULL" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-field-name.php">
          pg_field_name &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-fetch-row.php">
          &laquo; pg_fetch_row        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-field-is-null.php' selected="selected">English</option>
            <option value='de/function.pg-field-is-null.php'>German</option>
            <option value='es/function.pg-field-is-null.php'>Spanish</option>
            <option value='fr/function.pg-field-is-null.php'>French</option>
            <option value='it/function.pg-field-is-null.php'>Italian</option>
            <option value='ja/function.pg-field-is-null.php'>Japanese</option>
            <option value='pt_BR/function.pg-field-is-null.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-field-is-null.php'>Russian</option>
            <option value='tr/function.pg-field-is-null.php'>Turkish</option>
            <option value='uk/function.pg-field-is-null.php'>Ukrainian</option>
            <option value='zh/function.pg-field-is-null.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-field-is-null" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_field_is_null</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_field_is_null</span> &mdash; <span class="dc-title">Test if a field is SQL <code class="literal">NULL</code></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-field-is-null-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_field_is_null</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-result.php" class="type PgSql\Result">PgSql\Result</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span></span> <code class="parameter">$row</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <div class="methodsynopsis dc-description"><span class="methodname"><strong>pg_field_is_null</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-result.php" class="type PgSql\Result">PgSql\Result</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_field_is_null()</strong></span> tests if a field in an <span class="classname"><a href="class.pgsql-result.php" class="classname">PgSql\Result</a></span> instance
   is SQL <code class="literal">NULL</code> or not.
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    This function used to be called <span class="function"><strong>pg_fieldisnull()</strong></span>.
   </p>
  </p></blockquote>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.pg-field-is-null-parameters">
...
<span class="function"><a href="function.pg-query-params.php" class="function">pg_query_params()</a></span> or <span class="function"><a href="function.pg-execute.php" class="function">pg_execute()</a></span>(among others).</p>
     ...
     <dt><code class="parameter">field</code></dt>
      <dd>
       <p class="para">
        Field number (starting from 0) as an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> or 
        the field name as a <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.
       </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-field-is-null-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <code class="literal">1</code> if the field in the given row is SQL <code class="literal">NULL</code>, <code class="literal">0</code>
   if not.  <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> is returned if the row is out of range, or upon any other error.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.pg-field-is-null-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-field-is-null-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2064">
    <p><strong>Example #1 <span class="function"><strong>pg_field_is_null()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />  $dbconn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=publisher"</span><span style="color: #007700">) or die (</span><span style="color: #DD0000">"Could not connect"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">$res </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$dbconn</span><span style="color: #007700">, </span><span style="color: #DD0000">"select * from authors where author = 'Orwell'"</span><span style="color: #007700">);<br />  if (</span><span style="color: #0000BB">$res</span><span style="color: #007700">) {<br />      if (</span><span style="color: #0000BB">pg_field_is_null</span><span style="color: #007700">(</span><span style="color: #0000BB">$res</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"year"</span><span style="color: #007700">) == </span><span style="color: #0000BB">1</span><span style="color: #007700">) {<br />          echo </span><span style="color: #DD0000">"The value of the field year is null.\n"</span><span style="color: #007700">;<br />      }<br />      if (</span><span style="color: #0000BB">pg_field_is_null</span><span style="color: #007700">(</span><span style="color: #0000BB">$res</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"year"</span><span style="color: #007700">) == </span><span style="color: #0000BB">0</span><span style="color: #007700">) {<br />          echo </span><span style="color: #DD0000">"The value of the field year is not null.\n"</span><span style="color: #007700">;<br />    }<br /> }<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-field-is-null.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-field-is-null%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-field-is-null&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-field-is-null.php">＋<small>add a note</small></a></span>
