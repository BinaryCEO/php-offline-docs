...
<head>
  ...
  <title>PHP: Imagick::getHomeURL - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.gethomeurl.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.gethomeurl.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.gethomeurl.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getgravity.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.gethomeurl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.gethomeurl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.gethomeurl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.gethomeurl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.gethomeurl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.gethomeurl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.gethomeurl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.gethomeurl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.gethomeurl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.gethomeurl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.gethomeurl.php" hreflang="zh">
...
<meta name="Description" content="Returns the ImageMagick home URL" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getHomeURL - Manual" />
<meta name="twitter:description" content="Returns the ImageMagick home URL" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getHomeURL - Manual" />
<meta itemprop="description" content="Returns the ImageMagick home URL" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the ImageMagick home URL" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimage.php">
          Imagick::getImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getgravity.php">
          &laquo; Imagick::getGravity        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.gethomeurl.php' selected="selected">English</option>
            <option value='de/imagick.gethomeurl.php'>German</option>
            <option value='es/imagick.gethomeurl.php'>Spanish</option>
            <option value='fr/imagick.gethomeurl.php'>French</option>
            <option value='it/imagick.gethomeurl.php'>Italian</option>
            <option value='ja/imagick.gethomeurl.php'>Japanese</option>
            <option value='pt_BR/imagick.gethomeurl.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.gethomeurl.php'>Russian</option>
            <option value='tr/imagick.gethomeurl.php'>Turkish</option>
            <option value='uk/imagick.gethomeurl.php'>Ukrainian</option>
            <option value='zh/imagick.gethomeurl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.gethomeurl" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getHomeURL</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getHomeURL</span> &mdash; <span class="dc-title">Returns the ImageMagick home URL</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.gethomeurl-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::getHomeURL</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.gethomeurl-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.gethomeurl-returnvalues">
  ...
  <p class="para">
   Returns a link to the imagemagick homepage.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/gethomeurl.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.gethomeurl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.gethomeurl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.gethomeurl.php">＋<small>add a note</small></a></span>
