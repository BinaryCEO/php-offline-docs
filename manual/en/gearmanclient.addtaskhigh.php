...
<head>
  ...
  <title>PHP: GearmanClient::addTaskHigh - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.addtaskhigh.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.addtaskhigh.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.addtaskhigh.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.addtaskbackground.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.addtaskhighbackground.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.addtaskhigh.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.addtaskhigh.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.addtaskhigh.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.addtaskhigh.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.addtaskhigh.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.addtaskhigh.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.addtaskhigh.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.addtaskhigh.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.addtaskhigh.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.addtaskhigh.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.addtaskhigh.php" hreflang="zh">
...
<meta name="Description" content="Add a high priority task to run in parallel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::addTaskHigh - Manual" />
<meta name="twitter:description" content="Add a high priority task to run in parallel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::addTaskHigh - Manual" />
<meta itemprop="description" content="Add a high priority task to run in parallel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add a high priority task to run in parallel" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gearmanclient.addtaskhighbackground.php">
          GearmanClient::addTaskHighBackground &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.addtaskbackground.php">
          &laquo; GearmanClient::addTaskBackground        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.addtaskhigh.php' selected="selected">English</option>
            <option value='de/gearmanclient.addtaskhigh.php'>German</option>
            <option value='es/gearmanclient.addtaskhigh.php'>Spanish</option>
            <option value='fr/gearmanclient.addtaskhigh.php'>French</option>
            <option value='it/gearmanclient.addtaskhigh.php'>Italian</option>
            <option value='ja/gearmanclient.addtaskhigh.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.addtaskhigh.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.addtaskhigh.php'>Russian</option>
            <option value='tr/gearmanclient.addtaskhigh.php'>Turkish</option>
            <option value='uk/gearmanclient.addtaskhigh.php'>Ukrainian</option>
            <option value='zh/gearmanclient.addtaskhigh.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.addtaskhigh" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.runtasks.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::runTasks()</a> - Run a list of tasks in parallel</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/addtaskhigh.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.addtaskhigh%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.addtaskhigh&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.addtaskhigh.php">＋<small>add a note</small></a></span>
