...
<head>
  ...
  <title>PHP: mcrypt_enc_get_modes_name - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-enc-get-modes-name.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-enc-get-modes-name">
 <link rel="alternate" href="https://www.php.net/mcrypt-enc-get-modes-name" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-enc-get-key-size.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-enc-get-supported-key-sizes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-enc-get-modes-name.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-enc-get-modes-name.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-enc-get-modes-name.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-enc-get-modes-name.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-enc-get-modes-name.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-enc-get-modes-name.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-enc-get-modes-name.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-enc-get-modes-name.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-enc-get-modes-name.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-enc-get-modes-name.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-enc-get-modes-name.php" hreflang="zh">
...
<meta name="Description" content="Returns the name of the opened mode" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_enc_get_modes_name - Manual" />
<meta name="twitter:description" content="Returns the name of the opened mode" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_enc_get_modes_name - Manual" />
<meta itemprop="description" content="Returns the name of the opened mode" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the name of the opened mode" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mcrypt-enc-get-supported-key-sizes.php">
          mcrypt_enc_get_supported_key_sizes &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-enc-get-key-size.php">
          &laquo; mcrypt_enc_get_key_size        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-enc-get-modes-name.php' selected="selected">English</option>
            <option value='de/function.mcrypt-enc-get-modes-name.php'>German</option>
            <option value='es/function.mcrypt-enc-get-modes-name.php'>Spanish</option>
            <option value='fr/function.mcrypt-enc-get-modes-name.php'>French</option>
            <option value='it/function.mcrypt-enc-get-modes-name.php'>Italian</option>
            <option value='ja/function.mcrypt-enc-get-modes-name.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-enc-get-modes-name.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-enc-get-modes-name.php'>Russian</option>
            <option value='tr/function.mcrypt-enc-get-modes-name.php'>Turkish</option>
            <option value='uk/function.mcrypt-enc-get-modes-name.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-enc-get-modes-name.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-enc-get-modes-name" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mcrypt_enc_get_modes_name</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7 &lt; 7.2.0, PECL mcrypt &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">mcrypt_enc_get_modes_name</span> &mdash; <span class="dc-title">Returns the name of the opened mode</span></p>

 </div>
 <div id="function.mcrypt-enc-get-modes-name-refsynopsisdiv">
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 description" id="refsect1-function.mcrypt-enc-get-modes-name-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mcrypt_enc_get_modes_name</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$td</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mcrypt-enc-get-modes-name-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mcrypt-enc-get-modes-name-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.mcrypt-enc-get-modes-name-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-993">
    <p><strong>Example #1 <span class="function"><strong>mcrypt_enc_get_modes_name()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">CFB
ECB</pre>
</div>
    </div>
   </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-enc-get-modes-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-enc-get-modes-name%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-enc-get-modes-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-enc-get-modes-name.php">＋<small>add a note</small></a></span>
