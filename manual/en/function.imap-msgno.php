...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-msgno.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-mime-header-decode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-mutf7-to-utf8.php">
...
<meta name="Description" content="Gets the message sequence number for the given UID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_msgno - Manual" />
<meta name="twitter:description" content="Gets the message sequence number for the given UID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_msgno - Manual" />
<meta itemprop="description" content="Gets the message sequence number for the given UID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the message sequence number for the given UID" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-msgno.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.imap-msgno.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_msgno</span> &mdash; <span class="dc-title">Gets the message sequence number for the given UID</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.imap-msgno-description">
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">message_uid</code>.
  </p>
  <p class="para">
   This function is the inverse of <span class="function"><a href="function.imap-uid.php" class="function">imap_uid()</a></span>.
  </p>
 </div>
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-msgno-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-uid.php" class="function" rel="rdfs-seeAlso">imap_uid()</a> - This function returns the UID for the given message sequence number</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-msgno.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-msgno%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-msgno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-msgno.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Here is a simple working snippet to properly check the return value of imap_msgno():<br /><br />$id = imap_msgno($imapConnection, $mailUid); //convert to normal messagenumber in current context<br />$verifyUid = imap_uid($imapConnection, $id);<br />if ($verifyUid != $mailUid)<br />  throw new Exception("Attention: imap_msgno returned nonsense!  The mail was probably not found in the mailbox!");</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-msgno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-msgno.php">＋<small>add a note</small></a></div>
