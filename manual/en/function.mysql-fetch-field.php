...
<head>
  ...
  <title>PHP: mysql_fetch_field - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-fetch-field.php">
 <link rel="shorturl" href="https://www.php.net/mysql-fetch-field">
 <link rel="alternate" href="https://www.php.net/mysql-fetch-field" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-fetch-assoc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-fetch-lengths.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-fetch-field.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-fetch-field.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-fetch-field.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-fetch-field.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-fetch-field.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-fetch-field.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-fetch-field.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-fetch-field.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-fetch-field.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-fetch-field.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-fetch-field.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mysql_fetch_field - Manual" />
...
<meta itemprop="name" content="PHP: mysql_fetch_field - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-fetch-lengths.php">
          mysql_fetch_lengths &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-fetch-assoc.php">
          &laquo; mysql_fetch_assoc        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-fetch-field.php' selected="selected">English</option>
            <option value='de/function.mysql-fetch-field.php'>German</option>
            <option value='es/function.mysql-fetch-field.php'>Spanish</option>
            <option value='fr/function.mysql-fetch-field.php'>French</option>
            <option value='it/function.mysql-fetch-field.php'>Italian</option>
            <option value='ja/function.mysql-fetch-field.php'>Japanese</option>
            <option value='pt_BR/function.mysql-fetch-field.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-fetch-field.php'>Russian</option>
            <option value='tr/function.mysql-fetch-field.php'>Turkish</option>
            <option value='uk/function.mysql-fetch-field.php'>Ukrainian</option>
            <option value='zh/function.mysql-fetch-field.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-fetch-field" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_fetch_field</h1>
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_fetch_field</span> &mdash; <span class="dc-title">Get column information from a result and return as an object</span></p>

 </div>

 <div id="function.mysql-fetch-field-refsynopsisdiv">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli-result.fetch-field.php" class="function">mysqli_fetch_field()</a></span></li>
 ...
 <div class="refsect1 description" id="refsect1-function.mysql-fetch-field-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_fetch_field</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field_offset</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.object.php" class="type object">object</a></span></div>
...
<span class="function"><a href="function.mysql-query.php" class="function">mysql_query()</a></span>.</p></dd>
     ...
     <dd>
      <p class="para">
       ...
       The <code class="parameter">field_offset</code> starts at <code class="literal">0</code>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-fetch-field-returnvalues">
  ...
  <p class="para">
   Returns an <span class="type"><a href="language.types.object.php" class="type object">object</a></span> containing field information. The properties 
   of the object are:
  </p>
  <p class="para">
   <ul class="itemizedlist">
    ...
    <li class="listitem">
     <span class="simpara">
      not_null - 1 if the column cannot be <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-fetch-field-examples">
  ...
  <p class="para">
   <div class="example" id="example-1894">
    <p><strong>Example #1 <span class="function"><strong>mysql_fetch_field()</strong></span> example</strong></p>
...
are <em>case-sensitive</em>.</span></p></blockquote>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    <span class="methodname"><a href="mysqli-result.fetch-field.php" class="methodname">mysqli_result::fetch_field()</a></span>.
   </p>
  </p></blockquote>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mysql-fetch-field-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.mysql-field-seek.php" class="function" rel="rdfs-seeAlso">mysql_field_seek()</a> - Set result pointer to a specified field offset</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-fetch-field.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-fetch-field%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-fetch-field&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-fetch-field.php">＋<small>add a note</small></a></span>
