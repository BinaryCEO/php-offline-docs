...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.reflection.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.reflection.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.reflection.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.reflection.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.reflection.php">
 <link rel="next" href="https://www.php.net/manual/en/reflection.examples.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.reflection.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.reflection.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.reflection.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.reflection.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.reflection.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.reflection.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.reflection.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.reflection.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.reflection.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.reflection.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.reflection.php" hreflang="zh">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.reflection.php' selected="selected">English</option>
            <option value='de/intro.reflection.php'>German</option>
            <option value='es/intro.reflection.php'>Spanish</option>
            <option value='fr/intro.reflection.php'>French</option>
            <option value='it/intro.reflection.php'>Italian</option>
            <option value='ja/intro.reflection.php'>Japanese</option>
            <option value='pt_BR/intro.reflection.php'>Brazilian Portuguese</option>
            <option value='ru/intro.reflection.php'>Russian</option>
            <option value='tr/intro.reflection.php'>Turkish</option>
            <option value='uk/intro.reflection.php'>Ukrainian</option>
            <option value='zh/intro.reflection.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.reflection" class="preface">
  ...
  <p class="para">
   Please note that certain parts of the internal <abbr title="Application Programming Interface">API</abbr>
   ...
   should be discovered and fixed.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.reflection%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.reflection&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.reflection.php">＋<small>add a note</small></a></span>
