...
<head>
  ...
  <title>PHP: Basic Gearman client and worker, submitting tasks - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearman.examples-reverse-task.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearman.examples-reverse-task.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearman.examples-reverse-task.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/gearman.examples.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearman.examples-reverse-bg.php">
 <link rel="next" href="https://www.php.net/manual/en/class.gearmanclient.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearman.examples-reverse-task.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearman.examples-reverse-task.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearman.examples-reverse-task.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearman.examples-reverse-task.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearman.examples-reverse-task.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearman.examples-reverse-task.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearman.examples-reverse-task.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearman.examples-reverse-task.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearman.examples-reverse-task.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearman.examples-reverse-task.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearman.examples-reverse-task.php" hreflang="zh">
...
<meta name="Description" content="Basic Gearman client and worker, submitting tasks" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Basic Gearman client and worker, submitting tasks - Manual" />
<meta name="twitter:description" content="Basic Gearman client and worker, submitting tasks" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Basic Gearman client and worker, submitting tasks - Manual" />
<meta itemprop="description" content="Basic Gearman client and worker, submitting tasks" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Basic Gearman client and worker, submitting tasks" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="class.gearmanclient.php">
          GearmanClient &raquo;
              ...
              <div class="prev">
        <a href="gearman.examples-reverse-bg.php">
          &laquo; Basic Gearman client and worker, background        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.remote.other.php'>Other Services</a></li>      <li><a href='book.gearman.php'>Gearman</a></li>      <li><a href='gearman.examples.php'>Examples</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearman.examples-reverse-task.php' selected="selected">English</option>
            <option value='de/gearman.examples-reverse-task.php'>German</option>
            <option value='es/gearman.examples-reverse-task.php'>Spanish</option>
            <option value='fr/gearman.examples-reverse-task.php'>French</option>
            <option value='it/gearman.examples-reverse-task.php'>Italian</option>
            <option value='ja/gearman.examples-reverse-task.php'>Japanese</option>
            <option value='pt_BR/gearman.examples-reverse-task.php'>Brazilian Portuguese</option>
            <option value='ru/gearman.examples-reverse-task.php'>Russian</option>
            <option value='tr/gearman.examples-reverse-task.php'>Turkish</option>
            <option value='uk/gearman.examples-reverse-task.php'>Ukrainian</option>
            <option value='zh/gearman.examples-reverse-task.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearman.examples-reverse-task" class="section">
...
DONE
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearman.examples-reverse-task%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearman.examples-reverse-task&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearman.examples-reverse-task.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123123">  <div class="votes">
    <div id="Vu123123">
    <a href="/manual/vote-note.php?id=123123&amp;page=gearman.examples-reverse-task&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123123">
    <a href="/manual/vote-note.php?id=123123&amp;page=gearman.examples-reverse-task&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123123" title="100% like this...">
    1
    </div>
  </div>
  <a href="#123123" class="name">
  <strong class="user"><em>septerrianin at mail dot ru</em></strong></a><a class="genanchor" href="#123123"> &para;</a><div class="date" title="2018-09-11 07:03"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom123123">
<div class="phpcode"><code><span class="html">NOTE.<br />The register of the callback functions needs BEFORE add a task.<br /><br />This example NOT working correctly:<br /><span class="default">&lt;?php<br /></span><span class="comment"># add tasks<br /></span><span class="default">$task</span><span class="keyword">= </span><span class="default">$gmc</span><span class="keyword">-&gt;</span><span class="default">addTask</span><span class="keyword">(</span><span class="string">"reverse"</span><span class="keyword">, </span><span class="string">"foo"</span><span class="keyword">, </span><span class="default">$data</span><span class="keyword">);<br /><br /></span><span class="comment"># register some callbacks<br /></span><span class="default">$gmc</span><span class="keyword">-&gt;</span><span class="default">setCreatedCallback</span><span class="keyword">(</span><span class="string">"reverse_created"</span><span class="keyword">);<br /></span><span class="default">$gmc</span><span class="keyword">-&gt;</span><span class="default">setDataCallback</span><span class="keyword">(</span><span class="string">"reverse_data"</span><span class="keyword">);<br /></span><span class="default">$gmc</span><span class="keyword">-&gt;</span><span class="default">setStatusCallback</span><span class="keyword">(</span><span class="string">"reverse_status"</span><span class="keyword">);<br /></span><span class="default">$gmc</span><span class="keyword">-&gt;</span><span class="default">setCompleteCallback</span><span class="keyword">(</span><span class="string">"reverse_complete"</span><span class="keyword">);<br /></span><span class="default">$gmc</span><span class="keyword">-&gt;</span><span class="default">setFailCallback</span><span class="keyword">(</span><span class="string">"reverse_fail"</span><span class="keyword">);<br /><br /></span><span class="comment"># run the task<br /></span><span class="default">$gmc</span><span class="keyword">-&gt;</span><span class="default">runTasks</span><span class="keyword">();<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gearman.examples-reverse-task&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearman.examples-reverse-task.php">＋<small>add a note</small></a></div>
</section>    </section><!-- layout-content -->
        <aside class='layout-menu'>

        <ul class='parent-menu-list'>
                                    <li>
                <a href="gearman.examples.php">Examples</a>

                                    <ul class='child-menu-list'>

                                                <li class="">
                            <a href="gearman.examples-reverse.php" title="Basic usage">Basic usage</a>
                        </li>
                                                <li class="">
                            <a href="gearman.examples-reverse-bg.php" title="Basic Gearman client and worker, background">Basic Gearman client and worker, background</a>
                        </li>
                                                <li class="current">
                            <a href="gearman.examples-reverse-task.php" title="Basic Gearman client and worker, submitting tasks">Basic Gearman client and worker, submitting tasks</a>
                        </li>
