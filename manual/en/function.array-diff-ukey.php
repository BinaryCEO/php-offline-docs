...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.array-diff-ukey.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.array-diff-uassoc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.array-fill.php">
...
<meta name="Description" content="Computes the difference of arrays using a callback function on the keys for comparison" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: array_diff_ukey - Manual" />
<meta name="twitter:description" content="Computes the difference of arrays using a callback function on the keys for comparison" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: array_diff_ukey - Manual" />
<meta itemprop="description" content="Computes the difference of arrays using a callback function on the keys for comparison" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Computes the difference of arrays using a callback function on the keys for comparison" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.array-diff-ukey.php' selected="selected">English</option>
            <option value='de/function.array-diff-ukey.php'>German</option>
            <option value='es/function.array-diff-ukey.php'>Spanish</option>
            <option value='fr/function.array-diff-ukey.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">array_diff_ukey</span> &mdash; <span class="dc-title">Computes the difference of arrays using a callback function on the keys for comparison</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.array-diff-ukey-description">
  ...
  <p class="para">
   Unlike <span class="function"><a href="function.array-diff-key.php" class="function">array_diff_key()</a></span> a user supplied callback
 ...
 <div class="refsect1 examples" id="refsect1-function.array-diff-ukey-examples">
  ...
  <p class="para">
   <div class="example" id="example-5224">
    <p><strong>Example #1 <span class="function"><strong>array_diff_ukey()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.array-intersect-ukey.php" class="function" rel="rdfs-seeAlso">array_intersect_ukey()</a> - Computes the intersection of arrays using a callback function on the keys for comparison</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/array-diff-ukey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.array-diff-ukey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.array-diff-ukey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-diff-ukey.php">＋<small>add a note</small></a></span>
