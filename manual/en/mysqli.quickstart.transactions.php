...
<head>
  ...
  <title>PHP: API support for transactions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.quickstart.transactions.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.quickstart.transactions.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.quickstart.transactions.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mysqli.quickstart.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.quickstart.multiple-statement.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.quickstart.metadata.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.quickstart.transactions.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.quickstart.transactions.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.quickstart.transactions.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.quickstart.transactions.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.quickstart.transactions.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.quickstart.transactions.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.quickstart.transactions.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.quickstart.transactions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.quickstart.transactions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.quickstart.transactions.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.quickstart.transactions.php" hreflang="zh">
...
<meta name="Description" content="API support for transactions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: API support for transactions - Manual" />
<meta name="twitter:description" content="API support for transactions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: API support for transactions - Manual" />
<meta itemprop="description" content="API support for transactions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="API support for transactions" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli.quickstart.metadata.php">
          Metadata &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.quickstart.multiple-statement.php">
          &laquo; Multiple Statements        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.quickstart.transactions.php' selected="selected">English</option>
            <option value='de/mysqli.quickstart.transactions.php'>German</option>
            <option value='es/mysqli.quickstart.transactions.php'>Spanish</option>
            <option value='fr/mysqli.quickstart.transactions.php'>French</option>
            <option value='it/mysqli.quickstart.transactions.php'>Italian</option>
            <option value='ja/mysqli.quickstart.transactions.php'>Japanese</option>
            <option value='pt_BR/mysqli.quickstart.transactions.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.quickstart.transactions.php'>Russian</option>
            <option value='tr/mysqli.quickstart.transactions.php'>Turkish</option>
            <option value='uk/mysqli.quickstart.transactions.php'>Ukrainian</option>
            <option value='zh/mysqli.quickstart.transactions.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.quickstart.transactions" class="section">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="mysqli.rollback.php" class="methodname">mysqli::rollback()</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.quickstart.transactions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.quickstart.transactions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.quickstart.transactions.php">＋<small>add a note</small></a></span>
