...
<head>
  ...
  <title>PHP: mysqli::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.connect-error.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.debug.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.construct.php" hreflang="zh">
...
<meta name="Description" content="Open a new connection to the MySQL server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::__construct - Manual" />
<meta name="twitter:description" content="Open a new connection to the MySQL server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::__construct - Manual" />
<meta itemprop="description" content="Open a new connection to the MySQL server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open a new connection to the MySQL server" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli.debug.php">
          mysqli::debug &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.connect-error.php">
          &laquo; mysqli::$connect_error        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.construct.php' selected="selected">English</option>
            <option value='de/mysqli.construct.php'>German</option>
            <option value='es/mysqli.construct.php'>Spanish</option>
            <option value='fr/mysqli.construct.php'>French</option>
            <option value='it/mysqli.construct.php'>Italian</option>
            <option value='ja/mysqli.construct.php'>Japanese</option>
            <option value='pt_BR/mysqli.construct.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.construct.php'>Russian</option>
            <option value='tr/mysqli.construct.php'>Turkish</option>
            <option value='uk/mysqli.construct.php'>Ukrainian</option>
            <option value='zh/mysqli.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.construct" class="refentry">
   ...
   <dl>
     ...
     <dd>
      ...
      <p class="para">
       ...
       <span class="function"><a href="mysqli.change-user.php" class="function">mysqli_change_user()</a></span> is automatically called on
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli.construct-returnvalues">
  ...
  <p class="para">
   <span class="methodname"><strong>mysqli::__construct()</strong></span> always returns an object
   which represents the connection to a MySQL Server,
   regardless of it being successful or not.
  </p>
  <p class="para">
   <span class="function"><a href="function.mysqli-connect.php" class="function">mysqli_connect()</a></span> returns an object which represents the connection to a MySQL Server,
    or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
  <p class="para">
   <span class="methodname"><strong>mysqli::connect()</strong></span> returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
   Prior to PHP 8.1.0, returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on success.
  </p>
 </div>
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      <tr>
       <td>8.1.0</td>
       <td>
        <span class="methodname"><strong>mysqli::connect()</strong></span> now returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> instead of <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on success.
       </td>
      </tr>
...
<var class="filename">my.cnf</var> or by an explicit call to <span class="function"><a href="mysqli.options.php" class="function">mysqli_options()</a></span> prior to
calling <span class="function"><a href="mysqli.real-connect.php" class="function">mysqli_real_connect()</a></span>, but after <span class="function"><a href="mysqli.init.php" class="function">mysqli_init()</a></span>.</p></p></blockquote>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    Object-oriented style only: If the connection fails, an object is still returned. To check 
    whether the connection failed, use either the 
    <span class="function"><a href="mysqli.connect-error.php" class="function">mysqli_connect_error()</a></span> function or the <a href="mysqli.connect-error.php" class="link">mysqli-&gt;connect_error</a> property as in 
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    <span class="function"><a href="mysqli.real-connect.php" class="function">mysqli_real_connect()</a></span> must be used instead.
   </p>
  </p></blockquote>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli.close.php" class="function" rel="rdfs-seeAlso">mysqli_close()</a> - Closes a previously opened database connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.construct.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">5 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114749">  <div class="votes">
    <div id="Vu114749">
    <a href="/manual/vote-note.php?id=114749&amp;page=mysqli.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114749">
    <a href="/manual/vote-note.php?id=114749&amp;page=mysqli.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114749" title="70% like this...">
    29
    </div>
  </div>
  <a href="#114749" class="name">
  <strong class="user"><em>fugyl13 at gmail dot com</em></strong></a><a class="genanchor" href="#114749"> &para;</a><div class="date" title="2014-04-01 04:41"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114749">
<div class="phpcode"><code><span class="html">Note that on all &gt;=Windows 7 Servers, a host name "localhost" will create a very expensive lookup (~1 Second). <br /><br />That's because since Windows 7, the hosts file doesn't come with a preconfigured<br />127.0.0.1 localhost<br />anymore<br /><br />So, if you notice a long connection creation, try "127.0.0.1" instead.</span></code></div>
  </div>
 </div>
  <div class="note" id="115143">  <div class="votes">
    <div id="Vu115143">
    <a href="/manual/vote-note.php?id=115143&amp;page=mysqli.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115143">
    <a href="/manual/vote-note.php?id=115143&amp;page=mysqli.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115143" title="63% like this...">
    28
    </div>
  </div>
  <a href="#115143" class="name">
  <strong class="user"><em>andres at 21brains dot com</em></strong></a><a class="genanchor" href="#115143"> &para;</a><div class="date" title="2014-06-03 09:39"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115143">
<div class="phpcode"><code><span class="html">Please do use set_charset("utf8") after establishing the connection if you want to avoid weird string issues. I do not know why the documentation does not warn you about this kind of stuff.<br /><br />We had a hard time figuring out what was going on since we were using mb_detect_encoding and it said everything was UTF-8, but of course the display was wrong. If we used iconv from ISO-8859-1 to UTF-8 the strings looked fine, even though everything in the database had the right collation. So in the end, it was the connection that was the filter and although the notes for this function mention default charsets, it almost reads as a sidenote instead of a central issue when dealing with UTF and PHP/MySQL.</span></code></div>
  </div>
 </div>
  <div class="note" id="121002">  <div class="votes">
    <div id="Vu121002">
    <a href="/manual/vote-note.php?id=121002&amp;page=mysqli.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121002">
    <a href="/manual/vote-note.php?id=121002&amp;page=mysqli.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121002" title="64% like this...">
    9
    </div>
  </div>
  <a href="#121002" class="name">
  <strong class="user"><em>chris at ocproducts dot com</em></strong></a><a class="genanchor" href="#121002"> &para;</a><div class="date" title="2017-04-21 05:46"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121002">
<div class="phpcode"><code><span class="html">There's a separate port parameter, unlike mysql_connect. However, using host:port on the host parameter does actually work.<br /><br />There is a caveat. If the host is 'localhost' then the port is ignored, whether you use a port parameter or the implicit syntax I mentioned above. This is because 'localhost' will make it use unix sockets rather than TCP/IP.</span></code></div>
  </div>
 </div>
  <div class="note" id="121712">  <div class="votes">
    <div id="Vu121712">
    <a href="/manual/vote-note.php?id=121712&amp;page=mysqli.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121712">
    <a href="/manual/vote-note.php?id=121712&amp;page=mysqli.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121712" title="68% like this...">
    6
    </div>
  </div>
  <a href="#121712" class="name">
  <strong class="user"><em>php at haravikk dot me</em></strong></a><a class="genanchor" href="#121712"> &para;</a><div class="date" title="2017-10-01 06:58"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121712">
<div class="phpcode"><code><span class="html">Just wanted to add a note for anyone looking to use the MySQLi persistent connections feature; it's important to note that PHP opens and retains one connection per database user per process.<br /><br />What this means is that if you are hosting multiple applications, each with its own database user (as is good practice) then you will end up multiplying the number of connections that PHP may hold open.<br /><br />For example, if you have PHP configured with a maximum of eight worker processes, and you regularly use four different database users, then your MySQL server will need to accept at LEAST a maximum of 32 connections, or else it will run out.<br /><br />However, if you would like to minimise the number of connections, what you can do is instead is to open the connection using a "guest" user (with no privileges except logging in) and then use -&gt;change_user() to switch to a more privileged user, before switching back to the guest when you're done. Since all of the connections would therefore belong to the guest user, PHP should only maintain one per worker process.</span></code></div>
  </div>
 </div>
  <div class="note" id="112328">  <div class="votes">
    <div id="Vu112328">
    <a href="/manual/vote-note.php?id=112328&amp;page=mysqli.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112328">
    <a href="/manual/vote-note.php?id=112328&amp;page=mysqli.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112328" title="56% like this...">
    6
    </div>
  </div>
  <a href="#112328" class="name">
  <strong class="user"><em>paul at mtnlist dot com</em></strong></a><a class="genanchor" href="#112328"> &para;</a><div class="date" title="2013-06-02 08:19"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112328">
<div class="phpcode"><code><span class="html">If you want to connect via an alternate port (other than 3306), as you might when using an ssh tunnel to another host, using "localhost" as the hostname will not work. <br /><br />Using 127.0.0.1 will work.  Apparently, if you specify the host as "localhost", the constructor ignores the port specified as an argument to the constructor.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.construct.php">＋<small>add a note</small></a></div>
