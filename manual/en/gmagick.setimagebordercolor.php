...
<head>
  ...
  <title>PHP: Gmagick::setimagebordercolor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagebordercolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagebordercolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagebordercolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimageblueprimary.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagechanneldepth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagebordercolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimagebordercolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimagebordercolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimagebordercolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimagebordercolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimagebordercolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimagebordercolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimagebordercolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimagebordercolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimagebordercolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimagebordercolor.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimagebordercolor - Manual" />
<meta name="twitter:description" content="Sets the image border color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimagebordercolor - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.setimagechanneldepth.php">
          Gmagick::setimagechanneldepth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimageblueprimary.php">
          &laquo; Gmagick::setimageblueprimary        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagebordercolor.php' selected="selected">English</option>
            <option value='de/gmagick.setimagebordercolor.php'>German</option>
            <option value='es/gmagick.setimagebordercolor.php'>Spanish</option>
            <option value='fr/gmagick.setimagebordercolor.php'>French</option>
            <option value='it/gmagick.setimagebordercolor.php'>Italian</option>
            <option value='ja/gmagick.setimagebordercolor.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimagebordercolor.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimagebordercolor.php'>Russian</option>
            <option value='tr/gmagick.setimagebordercolor.php'>Turkish</option>
            <option value='uk/gmagick.setimagebordercolor.php'>Ukrainian</option>
            <option value='zh/gmagick.setimagebordercolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimagebordercolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimagebordercolor</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimagebordercolor</span> &mdash; <span class="dc-title">Sets the image border color</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimagebordercolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimagebordercolor</strong></span>(<span class="methodparam"><span class="type"><a href="class.gmagickpixel.php" class="type GmagickPixel">GmagickPixel</a></span> <code class="parameter">$color</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimagebordercolor-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimagebordercolor-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimagebordercolor-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagebordercolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagebordercolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagebordercolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagebordercolor.php">＋<small>add a note</small></a></span>
