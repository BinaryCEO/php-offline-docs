...
<head>
  ...
  <title>PHP: Imagick::getIteratorIndex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getiteratorindex.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getiteratorindex.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getiteratorindex.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getinterlacescheme.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getnumberimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getiteratorindex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getiteratorindex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getiteratorindex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getiteratorindex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getiteratorindex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getiteratorindex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getiteratorindex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getiteratorindex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getiteratorindex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getiteratorindex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getiteratorindex.php" hreflang="zh">
...
<meta name="Description" content="Gets the index of the current active image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getIteratorIndex - Manual" />
<meta name="twitter:description" content="Gets the index of the current active image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getIteratorIndex - Manual" />
<meta itemprop="description" content="Gets the index of the current active image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the index of the current active image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getnumberimages.php">
          Imagick::getNumberImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getinterlacescheme.php">
          &laquo; Imagick::getInterlaceScheme        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getiteratorindex.php' selected="selected">English</option>
            <option value='de/imagick.getiteratorindex.php'>German</option>
            <option value='es/imagick.getiteratorindex.php'>Spanish</option>
            <option value='fr/imagick.getiteratorindex.php'>French</option>
            <option value='it/imagick.getiteratorindex.php'>Italian</option>
            <option value='ja/imagick.getiteratorindex.php'>Japanese</option>
            <option value='pt_BR/imagick.getiteratorindex.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getiteratorindex.php'>Russian</option>
            <option value='tr/imagick.getiteratorindex.php'>Turkish</option>
            <option value='uk/imagick.getiteratorindex.php'>Ukrainian</option>
            <option value='zh/imagick.getiteratorindex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getiteratorindex" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getIteratorIndex</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getIteratorIndex</span> &mdash; <span class="dc-title">Gets the index of the current active image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getiteratorindex-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getIteratorIndex</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getiteratorindex-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getiteratorindex-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getiteratorindex-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.getiteratorindex-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3015">
    <p><strong>Example #1 Using <span class="function"><strong>Imagick::getIteratorIndex()</strong></span>:</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$im </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, new </span><span style="color: #0000BB">ImagickPixel</span><span style="color: #007700">(</span><span style="color: #DD0000">"red"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, new </span><span style="color: #0000BB">ImagickPixel</span><span style="color: #007700">(</span><span style="color: #DD0000">"green"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, new </span><span style="color: #0000BB">ImagickPixel</span><span style="color: #007700">(</span><span style="color: #DD0000">"blue"</span><span style="color: #007700">));<br /><br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setIteratorIndex</span><span style="color: #007700">(</span><span style="color: #0000BB">1</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getIteratorIndex</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.getiteratorindex-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.setiteratorindex.php" class="function" rel="rdfs-seeAlso">Imagick::setIteratorIndex()</a> - Set the iterator position</span></li>
    <li><span class="function"><a href="imagick.getimageindex.php" class="function" rel="rdfs-seeAlso">Imagick::getImageIndex()</a> - Gets the index of the current active image</span></li>
    <li><span class="function"><a href="imagick.setimageindex.php" class="function" rel="rdfs-seeAlso">Imagick::setImageIndex()</a> - Set the iterator position</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getiteratorindex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getiteratorindex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getiteratorindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getiteratorindex.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117896">  <div class="votes">
    <div id="Vu117896">
    <a href="/manual/vote-note.php?id=117896&amp;page=imagick.getiteratorindex&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117896">
    <a href="/manual/vote-note.php?id=117896&amp;page=imagick.getiteratorindex&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117896" title="100% like this...">
    1
    </div>
  </div>
  <a href="#117896" class="name">
  <strong class="user"><em>Michael O&amp;#39;Connell</em></strong></a><a class="genanchor" href="#117896"> &para;</a><div class="date" title="2015-08-27 02:36"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117896">
<div class="phpcode"><code><span class="html">This will also retrieve which page number of a multipage document (i.e. PDF, PS) file the Imagick instance is currently on.  By default for a PDF it seems to be set to the last page.</span></code></div>
  </div>
 </div>
  <div class="note" id="108749">  <div class="votes">
    <div id="Vu108749">
    <a href="/manual/vote-note.php?id=108749&amp;page=imagick.getiteratorindex&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108749">
    <a href="/manual/vote-note.php?id=108749&amp;page=imagick.getiteratorindex&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108749" title="no votes...">
    0
    </div>
  </div>
  <a href="#108749" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108749"> &para;</a><div class="date" title="2012-05-22 11:42"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108749">
<div class="phpcode"><code><span class="html">The getIteratorIndex function of the ImageMagick function works on any type of image, but it is built for measuring the number of frames in an animated .gif file.  For non-animated image files, like regular .bmp or .jpg files, this function will always return the number '0', meaning that there is only one frame.  Counting starts from zero with this function, so a .gif file with five different frames will return a value of '4' on this.  Highly repetitive, but psychedelic animated GIF's are often anywhere between 10 and 30 frames, but a .gif file that is nothing more than video footage converted to a datafile may have hundreds of frames.<br /><br />According to Wikipedia (in the article for "Graphics Interchange Format"), an animated GIf image is a uses the GIF standard "which allows various images (frames) in the file to be painted with time delays."  This function won't get you the amount of time that delays between each frame, but it will give you the number of unique frames in a .gif file.  This will tell you how complicated or simple the animation may be.<br /><br />Is the 'getIteratorIndex' function not working for you?  Try the 'getImageIndex' function, which produces the same exact result.<br /><br />Some sample code :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.gif"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get Image Type Value<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$image_iterator_index </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getIteratorIndex</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Print Image Type Value<br />        // ---------------------------------------------<br />        <br />    </span><span class="keyword">print(</span><span class="string">"Number of Unique Frames in the .GIF File: </span><span class="default">$image_iterator_index</span><span class="string">"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getiteratorindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getiteratorindex.php">＋<small>add a note</small></a></div>
