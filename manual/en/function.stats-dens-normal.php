...
<head>
  ...
  <title>PHP: stats_dens_normal - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-dens-normal.php">
 <link rel="shorturl" href="https://www.php.net/stats-dens-normal">
 <link rel="alternate" href="https://www.php.net/stats-dens-normal" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-dens-logistic.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-dens-pmf-binomial.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-dens-normal.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-dens-normal.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-dens-normal.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-dens-normal.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-dens-normal.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-dens-normal.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-dens-normal.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-dens-normal.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-dens-normal.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-dens-normal.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-dens-normal.php" hreflang="zh">
...
<meta name="Description" content="Probability density function of the normal distribution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_dens_normal - Manual" />
<meta name="twitter:description" content="Probability density function of the normal distribution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_dens_normal - Manual" />
<meta itemprop="description" content="Probability density function of the normal distribution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Probability density function of the normal distribution" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stats-dens-pmf-binomial.php">
          stats_dens_pmf_binomial &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-dens-logistic.php">
          &laquo; stats_dens_logistic        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-dens-normal.php' selected="selected">English</option>
            <option value='de/function.stats-dens-normal.php'>German</option>
            <option value='es/function.stats-dens-normal.php'>Spanish</option>
            <option value='fr/function.stats-dens-normal.php'>French</option>
            <option value='it/function.stats-dens-normal.php'>Italian</option>
            <option value='ja/function.stats-dens-normal.php'>Japanese</option>
            <option value='pt_BR/function.stats-dens-normal.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-dens-normal.php'>Russian</option>
            <option value='tr/function.stats-dens-normal.php'>Turkish</option>
            <option value='uk/function.stats-dens-normal.php'>Ukrainian</option>
            <option value='zh/function.stats-dens-normal.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-dens-normal" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_dens_normal</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_dens_normal</span> &mdash; <span class="dc-title">Probability density function of the normal distribution</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-dens-normal-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_dens_normal</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$ave</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$stdev</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">ave</code> and the standard deviation is
   <code class="parameter">stdev</code>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.stats-dens-normal-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">ave</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">stdev</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-dens-normal-returnvalues">
  ...
  <p class="para">
   The probability density at <code class="parameter">x</code> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> for failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-dens-normal.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-dens-normal%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-dens-normal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-dens-normal.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="89269">  <div class="votes">
    <div id="Vu89269">
    <a href="/manual/vote-note.php?id=89269&amp;page=function.stats-dens-normal&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd89269">
    <a href="/manual/vote-note.php?id=89269&amp;page=function.stats-dens-normal&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V89269" title="40% like this...">
    -1
    </div>
  </div>
  <a href="#89269" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#89269"> &para;</a><div class="date" title="2009-02-28 02:37"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom89269">
<div class="phpcode"><code><span class="html">I'm not certain that I've figured this one out correctly but it should return the value of a (Gaussian) normal distribution of the given properties at the given location.<br />$x - the X-Value to request<br />$ave - the 'expected value' (i.e. location of the peak) for the distribution. For most uses this will just be 0.<br />$stdev - the standard deviation of the distribution. For most uses this will be 1.</span></code></div>
  </div>
 </div>
  <div class="note" id="123940">  <div class="votes">
    <div id="Vu123940">
    <a href="/manual/vote-note.php?id=123940&amp;page=function.stats-dens-normal&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123940">
    <a href="/manual/vote-note.php?id=123940&amp;page=function.stats-dens-normal&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123940" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#123940" class="name">
  <strong class="user"><em>Hector</em></strong></a><a class="genanchor" href="#123940"> &para;</a><div class="date" title="2019-06-13 01:13"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123940">
<div class="phpcode"><code><span class="html">This functions will be the equivalent for "DISTR.NORM.N" on excel, like an other user said it's for Gaussian normal distribution.<br /><br />$x as value to analyze<br />$ave as average <br />$stdev as deviation</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stats-dens-normal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-dens-normal.php">＋<small>add a note</small></a></div>
