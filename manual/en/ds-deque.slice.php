...
<head>
  ...
  <title>PHP: Ds\Deque::slice - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-deque.slice.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-deque.slice.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-deque.slice.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-deque.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-deque.shift.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-deque.sort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ds-deque.slice.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ds-deque.slice.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ds-deque.slice.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ds-deque.slice.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ds-deque.slice.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ds-deque.slice.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ds-deque.slice.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ds-deque.slice.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ds-deque.slice.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ds-deque.slice.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ds-deque.slice.php" hreflang="zh">
...
<meta name="Description" content="Returns a sub-deque of a given range" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Ds\Deque::slice - Manual" />
<meta name="twitter:description" content="Returns a sub-deque of a given range" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Ds\Deque::slice - Manual" />
<meta itemprop="description" content="Returns a sub-deque of a given range" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a sub-deque of a given range" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-deque.slice.php' selected="selected">English</option>
            <option value='de/ds-deque.slice.php'>German</option>
            <option value='es/ds-deque.slice.php'>Spanish</option>
            <option value='fr/ds-deque.slice.php'>French</option>
            <option value='it/ds-deque.slice.php'>Italian</option>
            <option value='ja/ds-deque.slice.php'>Japanese</option>
            <option value='pt_BR/ds-deque.slice.php'>Brazilian Portuguese</option>
            <option value='ru/ds-deque.slice.php'>Russian</option>
            <option value='tr/ds-deque.slice.php'>Turkish</option>
            <option value='uk/ds-deque.slice.php'>Ukrainian</option>
            <option value='zh/ds-deque.slice.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ds-deque.slice" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-ds-deque.slice-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Ds\Deque::slice</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.ds-deque.php" class="type Ds\Deque">Ds\Deque</a></span></div>
...
(
    ...
    [2] =&gt; d
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/deque/slice.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-deque.slice%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-deque.slice&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-deque.slice.php">＋<small>add a note</small></a></span>
