...
<head>
  ...
  <title>PHP: ImagickDraw::scale - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.scale.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.scale.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.scale.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.roundrectangle.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setclippath.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.scale.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.scale.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.scale.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.scale.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.scale.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.scale.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.scale.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.scale.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.scale.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.scale.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.scale.php" hreflang="zh">
...
<meta name="Description" content="Adjusts the scaling factor" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::scale - Manual" />
<meta name="twitter:description" content="Adjusts the scaling factor" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::scale - Manual" />
<meta itemprop="description" content="Adjusts the scaling factor" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adjusts the scaling factor" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setclippath.php">
          ImagickDraw::setClipPath &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.roundrectangle.php">
          &laquo; ImagickDraw::roundRectangle        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.scale.php' selected="selected">English</option>
            <option value='de/imagickdraw.scale.php'>German</option>
            <option value='es/imagickdraw.scale.php'>Spanish</option>
            <option value='fr/imagickdraw.scale.php'>French</option>
            <option value='it/imagickdraw.scale.php'>Italian</option>
            <option value='ja/imagickdraw.scale.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.scale.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.scale.php'>Russian</option>
            <option value='tr/imagickdraw.scale.php'>Turkish</option>
            <option value='uk/imagickdraw.scale.php'>Ukrainian</option>
            <option value='zh/imagickdraw.scale.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.scale" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::scale</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::scale</span> &mdash; <span class="dc-title">Adjusts the scaling factor</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.scale-description">
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.scale-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.scale-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.scale-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3166">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::scale()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/scale.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.scale%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.scale&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.scale.php">＋<small>add a note</small></a></span>
