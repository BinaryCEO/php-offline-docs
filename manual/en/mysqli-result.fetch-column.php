...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-result.fetch-column.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-result.fetch-column.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-result.fetch-column.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-result.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-result.fetch-assoc.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-result.fetch-field.php">
...
<meta name="Description" content="Fetch a single column from the next row of a result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_result::fetch_column - Manual" />
<meta name="twitter:description" content="Fetch a single column from the next row of a result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_result::fetch_column - Manual" />
<meta itemprop="description" content="Fetch a single column from the next row of a result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetch a single column from the next row of a result set" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-result.fetch-column.php' selected="selected">English</option>
            ...
            <option value='ja/mysqli-result.fetch-column.php'>Japanese</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli-result.data-seek.php" class="function" rel="rdfs-seeAlso">mysqli_data_seek()</a> - Adjusts the result pointer to an arbitrary row in the result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_result/fetch-column.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli-result.fetch-column%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli-result.fetch-column&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-result.fetch-column.php">＋<small>add a note</small></a></span>
