...
<head>
  ...
  <title>PHP: uopz_set_mock - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.uopz-set-mock.php">
 <link rel="shorturl" href="https://www.php.net/uopz-set-mock">
 <link rel="alternate" href="https://www.php.net/uopz-set-mock" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uopz.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.uopz-set-hook.php">
 <link rel="next" href="https://www.php.net/manual/en/function.uopz-set-property.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.uopz-set-mock.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.uopz-set-mock.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.uopz-set-mock.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.uopz-set-mock.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.uopz-set-mock.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.uopz-set-mock.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.uopz-set-mock.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.uopz-set-mock.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.uopz-set-mock.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.uopz-set-mock.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.uopz-set-mock.php" hreflang="zh">
...
<meta name="Description" content="Use mock instead of class for new objects" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: uopz_set_mock - Manual" />
<meta name="twitter:description" content="Use mock instead of class for new objects" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: uopz_set_mock - Manual" />
<meta itemprop="description" content="Use mock instead of class for new objects" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Use mock instead of class for new objects" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.uopz-set-property.php">
          uopz_set_property &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.uopz-set-hook.php">
          &laquo; uopz_set_hook        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.uopz-set-mock.php' selected="selected">English</option>
            <option value='de/function.uopz-set-mock.php'>German</option>
            <option value='es/function.uopz-set-mock.php'>Spanish</option>
            <option value='fr/function.uopz-set-mock.php'>French</option>
            <option value='it/function.uopz-set-mock.php'>Italian</option>
            <option value='ja/function.uopz-set-mock.php'>Japanese</option>
            <option value='pt_BR/function.uopz-set-mock.php'>Brazilian Portuguese</option>
            <option value='ru/function.uopz-set-mock.php'>Russian</option>
            <option value='tr/function.uopz-set-mock.php'>Turkish</option>
            <option value='uk/function.uopz-set-mock.php'>Ukrainian</option>
            <option value='zh/function.uopz-set-mock.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.uopz-set-mock" class="refentry">
...
<div class="examplescode"><pre class="examplescode">mockA</pre>
  ...
  <div class="example" id="example-720">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.uopz-unset-mock.php" class="function" rel="rdfs-seeAlso">uopz_unset_mock()</a> - Unset previously set mock</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uopz/functions/uopz-set-mock.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.uopz-set-mock%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.uopz-set-mock&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.uopz-set-mock.php">＋<small>add a note</small></a></span>
