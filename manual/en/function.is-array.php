...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.is-array.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.intval.php">
 <link rel="next" href="https://www.php.net/manual/en/function.is-bool.php">
...
<meta name="Description" content="Finds whether a variable is an array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: is_array - Manual" />
<meta name="twitter:description" content="Finds whether a variable is an array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: is_array - Manual" />
<meta itemprop="description" content="Finds whether a variable is an array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Finds whether a variable is an array" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.is-array.php' selected="selected">English</option>
            <option value='de/function.is-array.php'>German</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">is_array</span> &mdash; <span class="dc-title">Finds whether a variable is an array</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.is-array-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if <code class="parameter">value</code> is an <span class="type"><a href="language.types.array.php" class="type array">array</a></span>,
 ...
 <div class="refsect1 examples" id="refsect1-function.is-array-examples">
  ...
  <p class="para">
   <div class="example" id="example-5646">
    <p><strong>Example #1 Check that variable is an array</strong></p>
...
not an Array</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.is-array-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.array-is-list.php" class="function" rel="rdfs-seeAlso">array_is_list()</a> - Checks whether a given array is a list</span></li>
    ...
    <li><span class="function"><a href="function.is-object.php" class="function" rel="rdfs-seeAlso">is_object()</a> - Finds whether a variable is an object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/var/functions/is-array.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.is-array%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.is-array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-array.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>Rob Thomas</em></strong></a><a class="genanchor" href="#119990"> &para;</a><div class="date" title="2016-10-05 10:40"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom119990">
<div class="phpcode"><code><span class="html">Please note that the 'cast to array' check is horrendously out of date.<br /><br />Running that code against PHP 5.6 results in this:<br /><br />is_array  :  0.93975400924683<br />cast, === :  1.2425191402435<br /><br />So, please use 'is_array', not the horrible casting hack.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Or you could make use of the array_diff_key and array_key function:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">is_assoc</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">)<br />{<br />        return </span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">) &amp;&amp; </span><span class="default">array_diff_key</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">,</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">)));<br />}<br /><br />function </span><span class="default">test</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">)<br />{<br />        echo </span><span class="default">is_assoc</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">) ? </span><span class="string">"I'm an assoc array.\n" </span><span class="keyword">: </span><span class="string">"I'm not an assoc array.\n"</span><span class="keyword">;<br />}<br /><br /></span><span class="comment">// an assoc array<br /></span><span class="default">$a </span><span class="keyword">= array(</span><span class="string">"a"</span><span class="keyword">=&gt;</span><span class="string">"aaa"</span><span class="keyword">,</span><span class="string">"b"</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">,</span><span class="string">"c"</span><span class="keyword">=&gt;</span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">test</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">);<br /><br /></span><span class="comment">// an array<br /></span><span class="default">$b </span><span class="keyword">= </span><span class="default">array_values</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">);<br /></span><span class="default">test</span><span class="keyword">(</span><span class="default">$b</span><span class="keyword">);<br /><br /></span><span class="comment">// an object<br /></span><span class="default">$c </span><span class="keyword">= (object)</span><span class="default">$a</span><span class="keyword">;<br /></span><span class="default">test</span><span class="keyword">(</span><span class="default">$c</span><span class="keyword">);<br /><br /></span><span class="comment">// other types<br /></span><span class="default">test</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">-&gt;</span><span class="default">a</span><span class="keyword">);<br /></span><span class="default">test</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">-&gt;</span><span class="default">b</span><span class="keyword">);<br /></span><span class="default">test</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">-&gt;</span><span class="default">c</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />The above code outputs:<br />I'm an assoc array.<br />I'm not an assoc array.<br />I'm not an assoc array.<br />I'm not an assoc array.<br />I'm not an assoc array.<br />I'm not an assoc array.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">hperrin's results have indeed changed in PHP 7. The opposite is now true, is_array is faster than comparison:<br /><br />is_array  :  0.52148389816284<br />cast, === :  0.84179711341858<br /><br />Tested 1000000 iterations.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Yet another simpler, faster is_assoc():<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">is_assoc</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) {<br />  foreach (</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) as </span><span class="default">$k </span><span class="keyword">=&gt; </span><span class="default">$v</span><span class="keyword">) {<br />    if (</span><span class="default">$k </span><span class="keyword">!== </span><span class="default">$v</span><span class="keyword">)<br />      return </span><span class="default">true</span><span class="keyword">;<br />  }<br />  return </span><span class="default">false</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />In my tests it runs about twice as fast as Michael/Gabriel's array_reduce() method.<br /><br />(Speaking of which: Gabriel's version doesn't work as written; it reports associative arrays as numeric if only the first key is non-numeric, or if the keys are numeric but ordered backwards.  Michael solves this problem by comparing array_reduce() to count(), but that costs another function call; it also works to just compare to -1 instead of 0, and therefore return -1 as the ternary else from the callback).</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>yousuf at philipz dot com</em></strong></a><a class="genanchor" href="#86407"> &para;</a><div class="date" title="2008-10-16 03:41"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86407">
<div class="phpcode"><code><span class="html">alex frase's example is fast but elanthis at awesomeplay dot com's example is faster and Ilgar's modification of alex's code is faulty (the part " || $_array[$k] !== $v"). Also, Ilgar's suggestion of giving a false return value when the variable isnt an array is not suitable in my opinion and i think checking if the array is empty would also be a suitable check before the rest of the code runs.
<br />
...
<div class="phpcode"><code><span class="html">I've found a faster way of determining an array. If you use is_array() millions of times, you will notice a *huge* difference. On my machine, this method takes about 1/4 the time of using is_array().
<br />
...
<br />
<br />Tested 1000000 iterations.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>jim at akubo dot net</em></strong></a><a class="genanchor" href="#86658"> &para;</a><div class="date" title="2008-10-28 11:02"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86658">
<div class="phpcode"><code><span class="html">yousef's example was wrong because is_vector returned true instead of false if the key was found<br />here is the fixed version (only 2 lines differ)<br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">is_vector</span><span class="keyword">( &amp;</span><span class="default">$array </span><span class="keyword">) {<br />   if ( !</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) || empty(</span><span class="default">$array</span><span class="keyword">) ) {<br />      return -</span><span class="default">1</span><span class="keyword">;<br />   }<br />   </span><span class="default">$next </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />   foreach ( </span><span class="default">$array </span><span class="keyword">as </span><span class="default">$k </span><span class="keyword">=&gt; </span><span class="default">$v </span><span class="keyword">) {<br />      if ( </span><span class="default">$k </span><span class="keyword">!== </span><span class="default">$next </span><span class="keyword">) return </span><span class="default">false</span><span class="keyword">;<br />      </span><span class="default">$next</span><span class="keyword">++;<br />   }<br />   return </span><span class="default">true</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>dmitry dot sushilov at gmail dot com</em></strong></a><a class="genanchor" href="#115901"> &para;</a><div class="date" title="2014-10-12 12:49"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom115901">
<div class="phpcode"><code><span class="html">function is_associate_array($array)<br />{<br />    return $array === array_values($array);<br />}<br /><br />or you can add check is_array in functions</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">A slight modification of what's below:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">is_assoc</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">)<br />{<br />    return </span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) &amp;&amp; </span><span class="default">count</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) !== </span><span class="default">array_reduce</span><span class="keyword">(</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">), </span><span class="string">'is_assoc_callback'</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br />}<br /><br />function </span><span class="default">is_assoc_callback</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">, </span><span class="default">$b</span><span class="keyword">)<br />{<br />    return </span><span class="default">$a </span><span class="keyword">=== </span><span class="default">$b </span><span class="keyword">? </span><span class="default">$a </span><span class="keyword">+ </span><span class="default">1 </span><span class="keyword">: </span><span class="default">0</span><span class="keyword">;<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I would change the order of the comparison, because if it is really an empty array, it is better to stop at that point before doing several 'cpu &amp; memory intensive' function calls.<br /><br />In the end on a ratio of 3 not empty arrays to 1 empty array computed for 1000000 iterations it needed 10% less time.<br />Or the other way round:<br />It needed approx 3% to 4% more time if the array is not empty, but was at least 4 times faster on empty arrays.<br /><br />Additionally the memory consumption veritably lesser.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">is_assoc</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) {<br />    return (</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) &amp;&amp; (</span><span class="default">count</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">)==</span><span class="default">0 </span><span class="keyword">|| </span><span class="default">0 </span><span class="keyword">!== </span><span class="default">count</span><span class="keyword">(</span><span class="default">array_diff_key</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">, </span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">))) )));<br />} <br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">An error will be thrown If is_array() is applied to a nonexisting varble.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">And here is another variation for a function to test if an array is associative. Based on the idea by mot4h.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">is_associative</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">)<br />{<br />  if (!</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) || empty(</span><span class="default">$array</span><span class="keyword">))<br />    return </span><span class="default">false</span><span class="keyword">;<br /><br />  </span><span class="default">$keys </span><span class="keyword">= </span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">);<br />  return </span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$keys</span><span class="keyword">) !== </span><span class="default">$keys</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">The next post is not correct because has problems with blank array index:<br /><a href="https://www.php.net/manual/es/function.is-array.php#89332" rel="nofollow" target="_blank">https://www.php.net/manual/es/function.is-array.php#89332</a><br /><br />The next code use the above link php code<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">is_assoc</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">)<br />{<br />        return </span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">) &amp;&amp; </span><span class="default">array_diff_key</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">,</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">)));<br />}<br /><br />function </span><span class="default">test</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">)<br />{<br />        echo </span><span class="default">is_assoc</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">) ? </span><span class="string">"I'm an assoc array.\n" </span><span class="keyword">: </span><span class="string">"I'm not an assoc array.\n"</span><span class="keyword">;<br />}<br /><br /></span><span class="comment">// an assoc array<br /></span><span class="default">$a </span><span class="keyword">= array(</span><span class="string">"a"</span><span class="keyword">=&gt;</span><span class="string">"aaa"</span><span class="keyword">,</span><span class="string">"b"</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">,</span><span class="string">"c"</span><span class="keyword">=&gt;</span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">test</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">);<br /><br /></span><span class="comment">// maybe assoc array?<br /></span><span class="default">$b </span><span class="keyword">= array(</span><span class="default">0 </span><span class="keyword">=&gt; </span><span class="string">"aaa"</span><span class="keyword">, </span><span class="default">1 </span><span class="keyword">=&gt; </span><span class="default">1</span><span class="keyword">, </span><span class="default">3 </span><span class="keyword">=&gt; </span><span class="default">true</span><span class="keyword">); </span><span class="comment">// Index 2 not exist<br /></span><span class="default">test</span><span class="keyword">(</span><span class="default">$b</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br /># Output<br />I'm an assoc array.<br />I'm an assoc array.<br /><br />"Associative arrays are arrays that use named keys that you assign to them."<br /><a href="https://www.w3schools.com/php/php_arrays.asp" rel="nofollow" target="_blank">https://www.w3schools.com/php/php_arrays.asp</a><br /><br />Solution:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">is_assoc</span><span class="keyword">(array </span><span class="default">$array</span><span class="keyword">)<br />{<br />    return </span><span class="default">count</span><span class="keyword">(</span><span class="default">array_filter</span><span class="keyword">(</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">), </span><span class="string">'is_string'</span><span class="keyword">)) &gt; </span><span class="default">0</span><span class="keyword">;<br />}<br />function </span><span class="default">test</span><span class="keyword">(array </span><span class="default">$array</span><span class="keyword">)<br />{<br />    echo </span><span class="default">is_assoc</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) ? </span><span class="string">"I'm an assoc array.\n" </span><span class="keyword">: </span><span class="string">"I'm not an assoc array.\n"</span><span class="keyword">;<br />}<br /></span><span class="comment">// an assoc array<br /></span><span class="default">$a </span><span class="keyword">= array(</span><span class="string">"a"</span><span class="keyword">=&gt;</span><span class="string">"aaa"</span><span class="keyword">,</span><span class="string">"b"</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">,</span><span class="string">"c"</span><span class="keyword">=&gt;</span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">test</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">);<br /></span><span class="comment">// an array<br /></span><span class="default">$b </span><span class="keyword">= array(</span><span class="default">0</span><span class="keyword">=&gt;</span><span class="string">"aaa"</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">,</span><span class="default">3</span><span class="keyword">=&gt;</span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">test</span><span class="keyword">(</span><span class="default">$b</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br /># Output<br />I'm an assoc array.<br />I'm not an assoc array.<br /><br />If you want check pure assoc. array replace &gt; 0 by === count($array)</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Notice that the benchmark results from hperrin at gmail dot com have changed in the meantime:<br /><br />is_array  :  0.31888604164124<br />cast, === :  0.58448791503906<br /><br />(Using PHP 5.6.24, I expect other results with PHP 7)</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Using empty() in the previous example posted by Anonymous will result in a "Fatal error: Can't use function return value in write context".  I suggest using count() instead:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">is_assoc</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) {<br />    return (</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) &amp;&amp; </span><span class="default">0 </span><span class="keyword">!== </span><span class="default">count</span><span class="keyword">(</span><span class="default">array_diff_key</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">, </span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">)))));<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
