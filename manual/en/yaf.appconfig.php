...
<head>
  ...
  <title>PHP: Application Configuration - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/yaf.appconfig.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/yaf.appconfig.php">
 <link rel="alternate" href="https://www.php.net/manual/en/yaf.appconfig.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.yaf.php">
 <link rel="prev" href="https://www.php.net/manual/en/yaf.tutorials.php">
 <link rel="next" href="https://www.php.net/manual/en/class.yaf-application.php">

 <link rel="alternate" href="https://www.php.net/manual/en/yaf.appconfig.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/yaf.appconfig.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/yaf.appconfig.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/yaf.appconfig.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/yaf.appconfig.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/yaf.appconfig.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/yaf.appconfig.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/yaf.appconfig.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/yaf.appconfig.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/yaf.appconfig.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/yaf.appconfig.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Application Configuration - Manual" />
<meta name="twitter:description" content="Application Configuration" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Application Configuration - Manual" />
<meta itemprop="description" content="Application Configuration" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Application Configuration" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/yaf.appconfig.php' selected="selected">English</option>
            <option value='de/yaf.appconfig.php'>German</option>
            <option value='es/yaf.appconfig.php'>Spanish</option>
            <option value='fr/yaf.appconfig.php'>French</option>
            <option value='it/yaf.appconfig.php'>Italian</option>
            <option value='ja/yaf.appconfig.php'>Japanese</option>
            <option value='pt_BR/yaf.appconfig.php'>Brazilian Portuguese</option>
            <option value='ru/yaf.appconfig.php'>Russian</option>
            <option value='tr/yaf.appconfig.php'>Turkish</option>
            <option value='uk/yaf.appconfig.php'>Ukrainian</option>
            <option value='zh/yaf.appconfig.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="yaf.appconfig" class="chapter">
 <h1 class="title">Application Configuration</h1>

 <p class="para">
  You should give an array of config or an ini config file(see
  <span class="classname"><a href="class.yaf-config-ini.php" class="classname">Yaf_Config_Ini</a></span>) path to
...
the configuration directives.</p>
 ...
 <p class="para">
  <dl>
     ...
     <dd>
      <p class="para">
       The local library directory, see <span class="classname"><a href="class.yaf-loader.php" class="classname">Yaf_Loader</a></span> and
     ...
     <dd>
      <p class="para">
       ...
       <blockquote class="note"><p><strong class="note">Note</strong>: 
        <p class="para">
        only those <strong><code><a href="info.constants.php#constant.ini-all">INI_ALL</a></code></strong> configures can be set in this way
       </p>
       </p></blockquote>
      </p>
     </dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaf/appconfig.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fyaf.appconfig%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=yaf.appconfig&amp;repo=en&amp;redirect=https://www.php.net/manual/en/yaf.appconfig.php">＋<small>add a note</small></a></span>
