...
<head>
  ...
  <title>PHP: Throwable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.throwable.php">
 <link rel="shorturl" href="https://www.php.net/throwable">
 <link rel="alternate" href="https://www.php.net/throwable" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.interfaces.php">
 <link rel="prev" href="https://www.php.net/manual/en/internaliterator.valid.php">
 <link rel="next" href="https://www.php.net/manual/en/throwable.getmessage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.throwable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.throwable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.throwable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.throwable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.throwable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.throwable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.throwable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.throwable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.throwable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.throwable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.throwable.php" hreflang="zh">
...
<meta name="Description" content="Throwable" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Throwable - Manual" />
<meta name="twitter:description" content="Throwable" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Throwable - Manual" />
<meta itemprop="description" content="Throwable" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Throwable" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="throwable.getmessage.php">
          Throwable::getMessage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="internaliterator.valid.php">
          &laquo; InternalIterator::valid        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.throwable.php' selected="selected">English</option>
            <option value='de/class.throwable.php'>German</option>
            <option value='es/class.throwable.php'>Spanish</option>
            <option value='fr/class.throwable.php'>French</option>
            <option value='it/class.throwable.php'>Italian</option>
            <option value='ja/class.throwable.php'>Japanese</option>
            <option value='pt_BR/class.throwable.php'>Brazilian Portuguese</option>
            <option value='ru/class.throwable.php'>Russian</option>
            <option value='tr/class.throwable.php'>Turkish</option>
            <option value='uk/class.throwable.php'>Ukrainian</option>
            <option value='zh/class.throwable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.throwable" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="throwable.getmessage.php">Throwable::getMessage</a> — Gets the message</li><li><a href="throwable.getcode.php">Throwable::getCode</a> — Gets the exception code</li><li><a href="throwable.getfile.php">Throwable::getFile</a> — Gets the file in which the object was created</li><li><a href="throwable.getline.php">Throwable::getLine</a> — Gets the line on which the object was instantiated</li><li><a href="throwable.gettrace.php">Throwable::getTrace</a> — Gets the stack trace</li><li><a href="throwable.gettraceasstring.php">Throwable::getTraceAsString</a> — Gets the stack trace as a string</li><li><a href="throwable.getprevious.php">Throwable::getPrevious</a> — Returns the previous Throwable</li><li><a href="throwable.tostring.php">Throwable::__toString</a> — Gets a string representation of the thrown object</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/throwable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.throwable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.throwable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.throwable.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120776">  <div class="votes">
    <div id="Vu120776">
    <a href="/manual/vote-note.php?id=120776&amp;page=class.throwable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120776">
    <a href="/manual/vote-note.php?id=120776&amp;page=class.throwable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120776" title="79% like this...">
    110
    </div>
  </div>
  <a href="#120776" class="name">
  <strong class="user"><em>mlocati at gmail dot com</em></strong></a><a class="genanchor" href="#120776"> &para;</a><div class="date" title="2017-03-09 10:59"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120776">
<div class="phpcode"><code><span class="html">I wrote a simple script that prints out the Throwable and Exception tree for every PHP version.<br /><br />You can find this script here:<br /><a href="https://gist.github.com/mlocati/249f07b074a0de339d4d1ca980848e6a" rel="nofollow" target="_blank">https://gist.github.com/mlocati/249f07b074a0de339d4d1ca980848e6a</a><br /><br />And its output is here:<br /><a href="https://3v4l.org/sDMsv" rel="nofollow" target="_blank">https://3v4l.org/sDMsv</a></span></code></div>
  </div>
 </div>
  <div class="note" id="124604">  <div class="votes">
    <div id="Vu124604">
    <a href="/manual/vote-note.php?id=124604&amp;page=class.throwable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124604">
    <a href="/manual/vote-note.php?id=124604&amp;page=class.throwable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124604" title="54% like this...">
    7
    </div>
  </div>
  <a href="#124604" class="name">
  <strong class="user"><em>thisbug at foxmail dot com</em></strong></a><a class="genanchor" href="#124604"> &para;</a><div class="date" title="2020-01-13 02:57"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124604">
<div class="phpcode"><code><span class="html">try {<br />// Code that may throw an Exception or Error.<br />} catch (Throwable $t) {<br />// Executed only in PHP 7, will not match in PHP 5.x<br />} catch (Exception $e) {<br />// Executed only in PHP 5.x, will not be reached in PHP 7<br />}<br /><br />interface MyPackageThrowable extends Throwable {}<br /><br />class MyPackageException extends Exception implements MyPackageThrowable {}<br /><br />throw new MyPackageException();</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.throwable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.throwable.php">＋<small>add a note</small></a></div>
