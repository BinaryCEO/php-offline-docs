...
<head>
  ...
  <title>PHP: SolrQuery::addFacetDateOther - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addfacetdateother.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addfacetdateother.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addfacetdateother.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addfacetdatefield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addfacetfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addfacetdateother.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addfacetdateother.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addfacetdateother.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addfacetdateother.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addfacetdateother.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addfacetdateother.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addfacetdateother.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addfacetdateother.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addfacetdateother.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addfacetdateother.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addfacetdateother.php" hreflang="zh">
...
<meta name="Description" content="Adds another facet.date.other parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addFacetDateOther - Manual" />
<meta name="twitter:description" content="Adds another facet.date.other parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addFacetDateOther - Manual" />
<meta itemprop="description" content="Adds another facet.date.other parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds another facet.date.other parameter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.addfacetfield.php">
          SolrQuery::addFacetField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addfacetdatefield.php">
          &laquo; SolrQuery::addFacetDateField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addfacetdateother.php' selected="selected">English</option>
            <option value='de/solrquery.addfacetdateother.php'>German</option>
            <option value='es/solrquery.addfacetdateother.php'>Spanish</option>
            <option value='fr/solrquery.addfacetdateother.php'>French</option>
            <option value='it/solrquery.addfacetdateother.php'>Italian</option>
            <option value='ja/solrquery.addfacetdateother.php'>Japanese</option>
            <option value='pt_BR/solrquery.addfacetdateother.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addfacetdateother.php'>Russian</option>
            <option value='tr/solrquery.addfacetdateother.php'>Turkish</option>
            <option value='uk/solrquery.addfacetdateother.php'>Ukrainian</option>
            <option value='zh/solrquery.addfacetdateother.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addfacetdateother" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-solrquery.addfacetdateother-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addFacetDateOther</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addfacetdateother.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addfacetdateother%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addfacetdateother&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addfacetdateother.php">＋<small>add a note</small></a></span>
