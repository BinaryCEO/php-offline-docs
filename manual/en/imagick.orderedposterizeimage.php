...
<head>
  ...
  <title>PHP: Imagick::orderedPosterizeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.orderedposterizeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.orderedposterizeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.orderedposterizeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.optimizeimagelayers.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.paintfloodfillimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.orderedposterizeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.orderedposterizeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.orderedposterizeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.orderedposterizeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.orderedposterizeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.orderedposterizeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.orderedposterizeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.orderedposterizeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.orderedposterizeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.orderedposterizeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.orderedposterizeimage.php" hreflang="zh">
...
<meta name="Description" content="Performs an ordered dither" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::orderedPosterizeImage - Manual" />
<meta name="twitter:description" content="Performs an ordered dither" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::orderedPosterizeImage - Manual" />
<meta itemprop="description" content="Performs an ordered dither" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Performs an ordered dither" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.paintfloodfillimage.php">
          Imagick::paintFloodfillImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.optimizeimagelayers.php">
          &laquo; Imagick::optimizeImageLayers        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.orderedposterizeimage.php' selected="selected">English</option>
            <option value='de/imagick.orderedposterizeimage.php'>German</option>
            <option value='es/imagick.orderedposterizeimage.php'>Spanish</option>
            <option value='fr/imagick.orderedposterizeimage.php'>French</option>
            <option value='it/imagick.orderedposterizeimage.php'>Italian</option>
            <option value='ja/imagick.orderedposterizeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.orderedposterizeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.orderedposterizeimage.php'>Russian</option>
            <option value='tr/imagick.orderedposterizeimage.php'>Turkish</option>
            <option value='uk/imagick.orderedposterizeimage.php'>Ukrainian</option>
            <option value='zh/imagick.orderedposterizeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.orderedposterizeimage" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-imagick.orderedposterizeimage-description">
  ...
  <p class="para rdfs-comment">
    ...
    according to the input arguments. This method is available if Imagick has been compiled against ImageMagick version 6.3.1 or newer.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.orderedposterizeimage-examples">
  ...
  <p class="para">
    <div class="example" id="example-3063">
      <p><strong>Example #1  <span class="function"><strong>Imagick::orderedPosterizeImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/orderedposterizeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.orderedposterizeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.orderedposterizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.orderedposterizeimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108404">  <div class="votes">
    <div id="Vu108404">
    <a href="/manual/vote-note.php?id=108404&amp;page=imagick.orderedposterizeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108404">
    <a href="/manual/vote-note.php?id=108404&amp;page=imagick.orderedposterizeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108404" title="50% like this...">
    0
    </div>
  </div>
  <a href="#108404" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108404"> &para;</a><div class="date" title="2012-04-24 12:39"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108404">
<div class="phpcode"><code><span class="html">Originally, I thought this function would be similar to the Posterize function, or at least, any one of the Imagick class functions that produces an artistic effect (like the oilPaintImage function).  This function can be used for those purposes, but it is mostly geared toward print production.  The OrderedPosterize is simply a highly flexible dithering tool.  The intention essentially is to produce high-resolution imagery by means of using constant dots across a medium that vary in size according to the detail of the imagery.  Everyone has seen a dithered photograph inside of a newspaper, but the wiki page provides better examples: <a href="http://en.wikipedia.org/wiki/Dither" rel="nofollow" target="_blank">http://en.wikipedia.org/wiki/Dither</a> .<br /><br />The two parameters are unusual to someone who simply wants to get the use of this function without fussing too much about the Imagick class.<br /><br />First parameter: The threshold_map is a set of "brushes" predefined by a very simple xml file.  They are: threshold, checks, o2x2, o3x3, o4x4, o8x8, h4x4a, h6x6a, h8x8a, h4x4o, h6x6o, h8x8o, h16x16o, c5x5b, c5x5w, c6x6b, c6x6w, c7x7b, and c7x7w.  These are the values you are expected to input as parameters for the Thershold_Map value.  Much better descriptions of these brush shapes available at the Imagick site: <a href="http://www.imagemagick.org/Usage/quantize/tmaps_list.txt" rel="nofollow" target="_blank">http://www.imagemagick.org/Usage/quantize/tmaps_list.txt</a> .<br /><br />Second parameter: The channel is any of the constants as predefined by the Imagick class.  In the code, the value looks like "imagick::CHANNEL_RED", but you have the "_value" options of: red, undefined, gray, cyan, green, magenta, blue, yellow, alpha, opacity, matte, black, index, all, and default.  More info here: <a href="http://www.php.net/manual/en/imagick.constants.php#imagick.constants.channel" rel="nofollow" target="_blank">http://www.php.net/manual/en/imagick.constants.php#imagick.constants.channel</a> .<br /><br />Finally, don't forget you can use bitwise operators on the second parameter.  That means you can use &amp; to AND them, | to OR them, &amp; to XOR them, and ~ to NEGATE them.  A valid parameter for the second parameter would be: "((~imagick::CHANNEL_GREEN) ^ imagick::CHANNEL_YELLOW) | imagick::CHANNEL_MAGENTA)".  You can get extremely creative in this particular parameter.  And if you want to define your own brushes using simple XML, then that's also true of the first parameter, too.<br /><br />Note:  You can use this function artistically.  How?  Use the orderedPosterizeImage to give the image some texture (a photo of a vase, for instance), and then use your OilPoint, Sketch, or Standard Posterize to give the image a cool effect.  Alone, though, seems pretty boring.<br /><br />And now, a very simple demonstration :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Filename<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$file_to_grab_with_location </span><span class="keyword">= </span><span class="string">"graphics_engine/image_workshop_directory/ordered_posterize_source.bmp"<br />    <br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab_with_location</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Perform Function<br />        // ---------------------------------------------<br />    <br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">orderedPosterizeImage</span><span class="keyword">(</span><span class="string">"o2x2"</span><span class="keyword">, </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">CHANNEL_GREEN</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Save File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$file_to_save_with_location </span><span class="keyword">= </span><span class="string">"graphics_engine/image_workshop_directory/ordered_posterize_result.bmp"<br />    <br />    </span><span class="default">$file_handle_for_saving_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_save_with_location</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">writeImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_saving_image_file</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.orderedposterizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.orderedposterizeimage.php">＋<small>add a note</small></a></div>
