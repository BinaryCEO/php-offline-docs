...
<head>
  ...
  <title>PHP: wincache_unlock - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-unlock.php">
 <link rel="shorturl" href="https://www.php.net/wincache-unlock">
 <link rel="alternate" href="https://www.php.net/wincache-unlock" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-ucache-set.php">
 <link rel="next" href="https://www.php.net/manual/en/wincache.win32build.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-unlock.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-unlock.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-unlock.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-unlock.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-unlock.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-unlock.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-unlock.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-unlock.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-unlock.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-unlock.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-unlock.php" hreflang="zh">
...
<meta name="Description" content="Releases an exclusive lock on a given key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_unlock - Manual" />
<meta name="twitter:description" content="Releases an exclusive lock on a given key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_unlock - Manual" />
<meta itemprop="description" content="Releases an exclusive lock on a given key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Releases an exclusive lock on a given key" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="wincache.win32build.php">
          Building for Windows &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-ucache-set.php">
          &laquo; wincache_ucache_set        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-unlock.php' selected="selected">English</option>
            <option value='de/function.wincache-unlock.php'>German</option>
            <option value='es/function.wincache-unlock.php'>Spanish</option>
            <option value='fr/function.wincache-unlock.php'>French</option>
            <option value='it/function.wincache-unlock.php'>Italian</option>
            <option value='ja/function.wincache-unlock.php'>Japanese</option>
            <option value='pt_BR/function.wincache-unlock.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-unlock.php'>Russian</option>
            <option value='tr/function.wincache-unlock.php'>Turkish</option>
            <option value='uk/function.wincache-unlock.php'>Ukrainian</option>
            <option value='zh/function.wincache-unlock.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-unlock" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.wincache-unlock-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>wincache_unlock</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Releases an exclusive lock that was obtained on a given key by using <span class="function"><a href="function.wincache-lock.php" class="function">wincache_lock()</a></span>. 
   If any other process was blocked waiting for the lock on this key, that process will be able to obtain 
   the lock.
  </p>
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="simpara">
    Using of the <span class="function"><a href="function.wincache-lock.php" class="function">wincache_lock()</a></span> and <span class="function"><strong>wincache_unlock()</strong></span> can cause deadlocks when 
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$fp </span><span style="color: #007700">= </span><span style="color: #0000BB">fopen</span><span style="color: #007700">(</span><span style="color: #DD0000">"/tmp/lock.txt"</span><span style="color: #007700">, </span><span style="color: #DD0000">"r+"</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">wincache_lock</span><span style="color: #007700">(</span><span style="color: #0000BB">“lock_txt_lock”</span><span style="color: #007700">)) { </span><span style="color: #FF8000">// do an exclusive lock<br />    </span><span style="color: #0000BB">ftruncate</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">); </span><span style="color: #FF8000">// truncate file<br />    </span><span style="color: #0000BB">fwrite</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">, </span><span style="color: #DD0000">"Write something here\n"</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">wincache_unlock</span><span style="color: #007700">(</span><span style="color: #0000BB">“lock_txt_lock”</span><span style="color: #007700">); </span><span style="color: #FF8000">// release the lock<br /></span><span style="color: #007700">} else {<br />    echo </span><span style="color: #DD0000">"Couldn't get the lock!"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.wincache-unlock-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.wincache-lock.php" class="function" rel="rdfs-seeAlso">wincache_lock()</a> - Acquires an exclusive lock on a given key</span></li>
    ...
    <li><span class="function"><a href="function.wincache-scache-info.php" class="function" rel="rdfs-seeAlso">wincache_scache_info()</a> - Retrieves information about files cached in the session cache</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-unlock.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-unlock%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-unlock&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-unlock.php">＋<small>add a note</small></a></span>
