...
<head>
  ...
  <title>PHP: pg_select - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-select.php">
 <link rel="shorturl" href="https://www.php.net/pg-select">
 <link rel="alternate" href="https://www.php.net/pg-select" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-result-status.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-send-execute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-select.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-select.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-select.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-select.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-select.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-select.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-select.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-select.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-select.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-select.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-select.php" hreflang="zh">
...
<meta name="Description" content="Select records" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_select - Manual" />
<meta name="twitter:description" content="Select records" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_select - Manual" />
<meta itemprop="description" content="Select records" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Select records" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-send-execute.php">
          pg_send_execute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-result-status.php">
          &laquo; pg_result_status        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-select.php' selected="selected">English</option>
            <option value='de/function.pg-select.php'>German</option>
            <option value='es/function.pg-select.php'>Spanish</option>
            <option value='fr/function.pg-select.php'>French</option>
            <option value='it/function.pg-select.php'>Italian</option>
            <option value='ja/function.pg-select.php'>Japanese</option>
            <option value='pt_BR/function.pg-select.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-select.php'>Russian</option>
            <option value='tr/function.pg-select.php'>Turkish</option>
            <option value='uk/function.pg-select.php'>Ukrainian</option>
            <option value='zh/function.pg-select.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-select" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-select-returnvalues">
  ...
  <p class="para">
   ...
   via <code class="parameter">flags</code>, otherwise it returns an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> on success,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-convert.php" class="function" rel="rdfs-seeAlso">pg_convert()</a> - Convert associative array values into forms suitable for SQL statements</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-select.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-select%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-select&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-select.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="52891">  <div class="votes">
    <div id="Vu52891">
    <a href="/manual/vote-note.php?id=52891&amp;page=function.pg-select&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd52891">
    <a href="/manual/vote-note.php?id=52891&amp;page=function.pg-select&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V52891" title="77% like this...">
    5
    </div>
  </div>
  <a href="#52891" class="name">
  <strong class="user"><em>david dot tulloh at infaze dot com dot au</em></strong></a><a class="genanchor" href="#52891"> &para;</a><div class="date" title="2005-05-16 09:46"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom52891">
<div class="phpcode"><code><span class="html">Valid options are PGSQL_DML_NO_CONV, PGSQL_DML_EXEC, PGSQL_DMP_ASYNC, PGSQL_DML_STRING (pulled out of source code).<br /><br />This function does not support selecting from multiple tables.  You can get around this by setting the PGSQL_DML_NO_CONV option.  This prevents the error which occurs when the function tries to convert the condition array.<br /><br />I think it is also important to point out that the table_name field is not safe, particularily with the PGSQL_DML_NO_CONV option.<br /><br />The arguements array field is compulsory, as documented.  What isn't so clear is that the array has to actually have some values in it, you can't do a select all.<br /><br />In summary, this function is good for a very small subset of basic queries.  If you are after anything more complex you are better off with pg_query.</span></code></div>
  </div>
 </div>
  <div class="note" id="62387">  <div class="votes">
    <div id="Vu62387">
    <a href="/manual/vote-note.php?id=62387&amp;page=function.pg-select&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd62387">
    <a href="/manual/vote-note.php?id=62387&amp;page=function.pg-select&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V62387" title="40% like this...">
    -4
    </div>
  </div>
  <a href="#62387" class="name">
  <strong class="user"><em>wietse at cj2 dot nl</em></strong></a><a class="genanchor" href="#62387"> &para;</a><div class="date" title="2006-02-27 08:20"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom62387">
<div class="phpcode"><code><span class="html">David mentioned that you can't do a Select all.<br />However, when executing this script:<br /><span class="default">&lt;?php<br />    $conn_string </span><span class="keyword">= </span><span class="string">"dbname=mydb"</span><span class="keyword">;<br />    </span><span class="default">$db </span><span class="keyword">= </span><span class="default">pg_connect</span><span class="keyword">(</span><span class="default">$conn_string</span><span class="keyword">);<br />    </span><span class="default">$selectfields </span><span class="keyword">= array(</span><span class="string">"imgid" </span><span class="keyword">=&gt; </span><span class="string">""</span><span class="keyword">);<br />    </span><span class="default">$records </span><span class="keyword">= </span><span class="default">pg_select</span><span class="keyword">(</span><span class="default">$db</span><span class="keyword">,</span><span class="string">"mmsfiles"</span><span class="keyword">,</span><span class="default">$selectfields</span><span class="keyword">);<br />    </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$records</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span>...I get this result:<br />Array<br />(<br />    [0] =&gt; Array<br />        (<br />            [imgid] =&gt; 1<br />            [file] =&gt; /home/wietse/public_html/mms/images/1.gif<br />            [thumb] =&gt; <br />        )<br />    [1] =&gt; Array<br />        (<br />            [imgid] =&gt; 2<br />            [file] =&gt; /home/wietse/public_html/mms/images/2.gif<br />            [thumb] =&gt; <br />        )<br />    [2] =&gt; Array<br />        (<br />            [imgid] =&gt; 3<br />            [file] =&gt; /home/wietse/public_html/mms/images/3.gif<br />            [thumb] =&gt; <br />        )<br />    [3] =&gt; Array<br />        (<br />            [imgid] =&gt; 4<br />            [file] =&gt; /home/wietse/public_html/mms/images/4.gif<br />            [thumb] =&gt; <br />        )<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-select&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-select.php">＋<small>add a note</small></a></div>
