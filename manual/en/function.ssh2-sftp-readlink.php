...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ssh2-sftp-readlink.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ssh2-sftp-mkdir.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ssh2-sftp-realpath.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ssh2-sftp-readlink.php' selected="selected">English</option>
            <option value='de/function.ssh2-sftp-readlink.php'>German</option>
 ...
 <div class="refsect1 examples" id="refsect1-function.ssh2-sftp-readlink-examples">
  ...
  <p class="para">
   <div class="example" id="example-4830">
    <p><strong>Example #1 Reading a symbolic link</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ssh2-sftp-symlink.php" class="function" rel="rdfs-seeAlso">ssh2_sftp_symlink()</a> - Create a symlink</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ssh2/functions/ssh2-sftp-readlink.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ssh2-sftp-readlink%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ssh2-sftp-readlink&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ssh2-sftp-readlink.php">＋<small>add a note</small></a></span>
