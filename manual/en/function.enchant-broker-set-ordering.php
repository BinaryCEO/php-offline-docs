...
<head>
  ...
  <title>PHP: enchant_broker_set_ordering - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.enchant-broker-set-ordering.php">
 <link rel="shorturl" href="https://www.php.net/enchant-broker-set-ordering">
 <link rel="alternate" href="https://www.php.net/enchant-broker-set-ordering" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.enchant.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.enchant-broker-set-dict-path.php">
 <link rel="next" href="https://www.php.net/manual/en/function.enchant-dict-add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.enchant-broker-set-ordering.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.enchant-broker-set-ordering.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.enchant-broker-set-ordering.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.enchant-broker-set-ordering.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.enchant-broker-set-ordering.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.enchant-broker-set-ordering.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.enchant-broker-set-ordering.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.enchant-broker-set-ordering.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.enchant-broker-set-ordering.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.enchant-broker-set-ordering.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.enchant-broker-set-ordering.php" hreflang="zh">
...
<meta name="Description" content="Declares a preference of dictionaries to use for the language" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: enchant_broker_set_ordering - Manual" />
<meta name="twitter:description" content="Declares a preference of dictionaries to use for the language" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: enchant_broker_set_ordering - Manual" />
<meta itemprop="description" content="Declares a preference of dictionaries to use for the language" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Declares a preference of dictionaries to use for the language" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.enchant-dict-add.php">
          enchant_dict_add &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.enchant-broker-set-dict-path.php">
          &laquo; enchant_broker_set_dict_path        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.enchant-broker-set-ordering.php' selected="selected">English</option>
            <option value='de/function.enchant-broker-set-ordering.php'>German</option>
            <option value='es/function.enchant-broker-set-ordering.php'>Spanish</option>
            <option value='fr/function.enchant-broker-set-ordering.php'>French</option>
            <option value='it/function.enchant-broker-set-ordering.php'>Italian</option>
            <option value='ja/function.enchant-broker-set-ordering.php'>Japanese</option>
            <option value='pt_BR/function.enchant-broker-set-ordering.php'>Brazilian Portuguese</option>
            <option value='ru/function.enchant-broker-set-ordering.php'>Russian</option>
            <option value='tr/function.enchant-broker-set-ordering.php'>Turkish</option>
            <option value='uk/function.enchant-broker-set-ordering.php'>Ukrainian</option>
            <option value='zh/function.enchant-broker-set-ordering.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.enchant-broker-set-ordering" class="refentry">
 ...
 <td>
  ...
  previoulsy, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/enchant/functions/enchant-broker-set-ordering.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.enchant-broker-set-ordering%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.enchant-broker-set-ordering&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.enchant-broker-set-ordering.php">＋<small>add a note</small></a></span>
