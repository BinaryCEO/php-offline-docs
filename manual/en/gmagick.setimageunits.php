...
<head>
  ...
  <title>PHP: Gmagick::setimageunits - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimageunits.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimageunits.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageunits.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimagetype.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagewhitepoint.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageunits.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimageunits.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimageunits.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimageunits.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimageunits.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimageunits.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimageunits.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimageunits.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimageunits.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimageunits.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimageunits.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimageunits - Manual" />
<meta name="twitter:description" content="Sets the image units of resolution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimageunits - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.setimagewhitepoint.php">
          Gmagick::setimagewhitepoint &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimagetype.php">
          &laquo; Gmagick::setimagetype        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimageunits.php' selected="selected">English</option>
            <option value='de/gmagick.setimageunits.php'>German</option>
            <option value='es/gmagick.setimageunits.php'>Spanish</option>
            <option value='fr/gmagick.setimageunits.php'>French</option>
            <option value='it/gmagick.setimageunits.php'>Italian</option>
            <option value='ja/gmagick.setimageunits.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimageunits.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimageunits.php'>Russian</option>
            <option value='tr/gmagick.setimageunits.php'>Turkish</option>
            <option value='uk/gmagick.setimageunits.php'>Ukrainian</option>
            <option value='zh/gmagick.setimageunits.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimageunits" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimageunits</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimageunits</span> &mdash; <span class="dc-title">Sets the image units of resolution</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimageunits-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimageunits</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$resolution</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimageunits-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">resolution</code></dt>
     <dd>
      <p class="para">
       One of the <a href="gmagick.constants.php#gmagick.constants.resolution" class="link">Resolution</a> constant
       (<code class="literal">Gmagick::RESOLUTION_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimageunits-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimageunits-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimageunits.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimageunits%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimageunits&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimageunits.php">＋<small>add a note</small></a></span>
