...
<head>
  ...
  <title>PHP: Zookeeper::isRecoverable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/zookeeper.isrecoverable.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/zookeeper.isrecoverable.php">
 <link rel="alternate" href="https://www.php.net/manual/en/zookeeper.isrecoverable.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.zookeeper.php">
 <link rel="prev" href="https://www.php.net/manual/en/zookeeper.getstate.php">
 <link rel="next" href="https://www.php.net/manual/en/zookeeper.set.php">

 <link rel="alternate" href="https://www.php.net/manual/en/zookeeper.isrecoverable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/zookeeper.isrecoverable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/zookeeper.isrecoverable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/zookeeper.isrecoverable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/zookeeper.isrecoverable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/zookeeper.isrecoverable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/zookeeper.isrecoverable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/zookeeper.isrecoverable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/zookeeper.isrecoverable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/zookeeper.isrecoverable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/zookeeper.isrecoverable.php" hreflang="zh">
...
<meta name="Description" content="Checks if the current zookeeper connection state can be recovered" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Zookeeper::isRecoverable - Manual" />
<meta name="twitter:description" content="Checks if the current zookeeper connection state can be recovered" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Zookeeper::isRecoverable - Manual" />
<meta itemprop="description" content="Checks if the current zookeeper connection state can be recovered" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if the current zookeeper connection state can be recovered" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/zookeeper.isrecoverable.php' selected="selected">English</option>
            <option value='de/zookeeper.isrecoverable.php'>German</option>
            <option value='es/zookeeper.isrecoverable.php'>Spanish</option>
            <option value='fr/zookeeper.isrecoverable.php'>French</option>
            <option value='it/zookeeper.isrecoverable.php'>Italian</option>
            <option value='ja/zookeeper.isrecoverable.php'>Japanese</option>
            <option value='pt_BR/zookeeper.isrecoverable.php'>Brazilian Portuguese</option>
            <option value='ru/zookeeper.isrecoverable.php'>Russian</option>
            <option value='tr/zookeeper.isrecoverable.php'>Turkish</option>
            <option value='uk/zookeeper.isrecoverable.php'>Ukrainian</option>
            <option value='zh/zookeeper.isrecoverable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="zookeeper.isrecoverable" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.zookeeperexception.php" class="classname">ZookeeperException</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeeper/isrecoverable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fzookeeper.isrecoverable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=zookeeper.isrecoverable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zookeeper.isrecoverable.php">＋<small>add a note</small></a></span>
