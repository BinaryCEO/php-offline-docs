...
<head>
  ...
  <title>PHP: imagegrabscreen - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagegrabscreen.php">
 <link rel="shorturl" href="https://www.php.net/imagegrabscreen">
 <link rel="alternate" href="https://www.php.net/imagegrabscreen" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagegif.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagegrabwindow.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagegrabscreen.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagegrabscreen.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagegrabscreen.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagegrabscreen.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagegrabscreen.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagegrabscreen.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagegrabscreen.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagegrabscreen.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagegrabscreen.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagegrabscreen.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagegrabscreen.php" hreflang="zh">
...
<meta name="Description" content="Captures the whole screen" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagegrabscreen - Manual" />
<meta name="twitter:description" content="Captures the whole screen" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagegrabscreen - Manual" />
<meta itemprop="description" content="Captures the whole screen" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Captures the whole screen" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagegrabwindow.php">
          imagegrabwindow &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagegif.php">
          &laquo; imagegif        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagegrabscreen.php' selected="selected">English</option>
            <option value='de/function.imagegrabscreen.php'>German</option>
            <option value='es/function.imagegrabscreen.php'>Spanish</option>
            <option value='fr/function.imagegrabscreen.php'>French</option>
            <option value='it/function.imagegrabscreen.php'>Italian</option>
            <option value='ja/function.imagegrabscreen.php'>Japanese</option>
            <option value='pt_BR/function.imagegrabscreen.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagegrabscreen.php'>Russian</option>
            <option value='tr/function.imagegrabscreen.php'>Turkish</option>
            <option value='uk/function.imagegrabscreen.php'>Ukrainian</option>
            <option value='zh/function.imagegrabscreen.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagegrabscreen" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagegrabscreen</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.2, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagegrabscreen</span> &mdash; <span class="dc-title">Captures the whole screen</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.imagegrabscreen-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagegrabscreen</strong></span>(): <span class="type"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imagegrabscreen-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.imagegrabscreen-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagegrabscreen-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.imagegrabscreen-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2911">
    <p><strong>Example #1 <span class="function"><strong>imagegrabscreen()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$im </span><span style="color: #007700">= </span><span style="color: #0000BB">imagegrabscreen</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">imagepng</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #DD0000">"myscreenshot.png"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagegrabscreen-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagegrabwindow.php" class="function" rel="rdfs-seeAlso">imagegrabwindow()</a> - Captures a window</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagegrabscreen.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagegrabscreen%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagegrabscreen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagegrabscreen.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="95079">  <div class="votes">
    <div id="Vu95079">
    <a href="/manual/vote-note.php?id=95079&amp;page=function.imagegrabscreen&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd95079">
    <a href="/manual/vote-note.php?id=95079&amp;page=function.imagegrabscreen&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V95079" title="50% like this...">
    0
    </div>
  </div>
  <a href="#95079" class="name">
  <strong class="user"><em>Nitrogen</em></strong></a><a class="genanchor" href="#95079"> &para;</a><div class="date" title="2009-12-12 07:22"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95079">
<div class="phpcode"><code><span class="html">If you have multiple displays set up, this function will only grab the primary display; not all of them like you would with the 'Print Screen' key.<br /><br />Also, this should be pretty obvious but I'll mention it anyway, if you're running GPU-intensive applications (not CPU), calling this function will cause quite some significant lag to your machine and server response until the request is complete.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagegrabscreen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagegrabscreen.php">＋<small>add a note</small></a></div>
