...
<head>
  ...
  <title>PHP: ZookeeperConfig::remove - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/zookeeperconfig.remove.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/zookeeperconfig.remove.php">
 <link rel="alternate" href="https://www.php.net/manual/en/zookeeperconfig.remove.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.zookeeperconfig.php">
 <link rel="prev" href="https://www.php.net/manual/en/zookeeperconfig.get.php">
 <link rel="next" href="https://www.php.net/manual/en/zookeeperconfig.set.php">

 <link rel="alternate" href="https://www.php.net/manual/en/zookeeperconfig.remove.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/zookeeperconfig.remove.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/zookeeperconfig.remove.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/zookeeperconfig.remove.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/zookeeperconfig.remove.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/zookeeperconfig.remove.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/zookeeperconfig.remove.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/zookeeperconfig.remove.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/zookeeperconfig.remove.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/zookeeperconfig.remove.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/zookeeperconfig.remove.php" hreflang="zh">
...
<meta name="Description" content="Remove servers from the ensemble" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZookeeperConfig::remove - Manual" />
<meta name="twitter:description" content="Remove servers from the ensemble" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZookeeperConfig::remove - Manual" />
<meta itemprop="description" content="Remove servers from the ensemble" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Remove servers from the ensemble" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="zookeeperconfig.set.php">
          ZookeeperConfig::set &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="zookeeperconfig.get.php">
          &laquo; ZookeeperConfig::get        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/zookeeperconfig.remove.php' selected="selected">English</option>
            <option value='de/zookeeperconfig.remove.php'>German</option>
            <option value='es/zookeeperconfig.remove.php'>Spanish</option>
            <option value='fr/zookeeperconfig.remove.php'>French</option>
            <option value='it/zookeeperconfig.remove.php'>Italian</option>
            <option value='ja/zookeeperconfig.remove.php'>Japanese</option>
            <option value='pt_BR/zookeeperconfig.remove.php'>Brazilian Portuguese</option>
            <option value='ru/zookeeperconfig.remove.php'>Russian</option>
            <option value='tr/zookeeperconfig.remove.php'>Turkish</option>
            <option value='uk/zookeeperconfig.remove.php'>Ukrainian</option>
            <option value='zh/zookeeperconfig.remove.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="zookeeperconfig.remove" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-zookeeperconfig.remove-examples">
  ...
  <div class="example" id="zookeeperconfig.remove.example.basic">
   <p><strong>Example #1 <span class="methodname"><strong>ZookeeperConfig::remove()</strong></span> example</strong></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.zookeeperexception.php" class="classname">ZookeeperException</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeeperconfig/remove.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fzookeeperconfig.remove%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=zookeeperconfig.remove&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zookeeperconfig.remove.php">＋<small>add a note</small></a></span>
