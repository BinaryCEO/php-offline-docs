...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-cascade-candidate-stagnation-epochs.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-cascade-candidate-limit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-cascade-max-cand-epochs.php">
...
<meta name="Description" content="Sets the number of cascade candidate stagnation epochs" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_cascade_candidate_stagnation_epochs - Manual" />
<meta name="twitter:description" content="Sets the number of cascade candidate stagnation epochs" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_cascade_candidate_stagnation_epochs - Manual" />
<meta itemprop="description" content="Sets the number of cascade candidate stagnation epochs" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the number of cascade candidate stagnation epochs" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-cascade-candidate-stagnation-epochs.php' selected="selected">English</option>
            ...
            <option value='zh/function.fann-set-cascade-candidate-stagnation-epochs.php'>Chinese (Simplified)</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_set_cascade_candidate_stagnation_epochs</span> &mdash; <span class="dc-title">Sets the number of cascade candidate stagnation epochs</span></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-get-cascade-candidate-stagnation-epochs.php" class="function" rel="rdfs-seeAlso">fann_get_cascade_candidate_stagnation_epochs()</a> - Returns the number of cascade candidate stagnation epochs</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-cascade-candidate-stagnation-epochs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-cascade-candidate-stagnation-epochs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-cascade-candidate-stagnation-epochs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-cascade-candidate-stagnation-epochs.php">＋<small>add a note</small></a></span>
