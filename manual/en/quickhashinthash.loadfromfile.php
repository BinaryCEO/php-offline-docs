...
<head>
  ...
  <title>PHP: QuickHashIntHash::loadFromFile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/quickhashinthash.loadfromfile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/quickhashinthash.loadfromfile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/quickhashinthash.loadfromfile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.quickhashinthash.php">
 <link rel="prev" href="https://www.php.net/manual/en/quickhashinthash.getsize.php">
 <link rel="next" href="https://www.php.net/manual/en/quickhashinthash.loadfromstring.php">

 <link rel="alternate" href="https://www.php.net/manual/en/quickhashinthash.loadfromfile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/quickhashinthash.loadfromfile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/quickhashinthash.loadfromfile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/quickhashinthash.loadfromfile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/quickhashinthash.loadfromfile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/quickhashinthash.loadfromfile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/quickhashinthash.loadfromfile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/quickhashinthash.loadfromfile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/quickhashinthash.loadfromfile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/quickhashinthash.loadfromfile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/quickhashinthash.loadfromfile.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: QuickHashIntHash::loadFromFile - Manual" />
<meta name="twitter:description" content="This factory method creates a hash from a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: QuickHashIntHash::loadFromFile - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="quickhashinthash.loadfromstring.php">
          QuickHashIntHash::loadFromString &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="quickhashinthash.getsize.php">
          &laquo; QuickHashIntHash::getSize        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/quickhashinthash.loadfromfile.php' selected="selected">English</option>
            <option value='de/quickhashinthash.loadfromfile.php'>German</option>
            <option value='es/quickhashinthash.loadfromfile.php'>Spanish</option>
            <option value='fr/quickhashinthash.loadfromfile.php'>French</option>
            <option value='it/quickhashinthash.loadfromfile.php'>Italian</option>
            <option value='ja/quickhashinthash.loadfromfile.php'>Japanese</option>
            <option value='pt_BR/quickhashinthash.loadfromfile.php'>Brazilian Portuguese</option>
            <option value='ru/quickhashinthash.loadfromfile.php'>Russian</option>
            <option value='tr/quickhashinthash.loadfromfile.php'>Turkish</option>
            <option value='uk/quickhashinthash.loadfromfile.php'>Ukrainian</option>
            <option value='zh/quickhashinthash.loadfromfile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="quickhashinthash.loadfromfile" class="refentry">
...
03 00 00 00  09 00 00 00</pre>
 ...
 <div class="refsect1 examples" id="refsect1-quickhashinthash.loadfromfile-examples">
  ...
  <p class="para">
   <div class="example" id="example-5432">
...
Key  15 ( f) is unset</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/quickhash/quickhashinthash/loadfromfile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fquickhashinthash.loadfromfile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=quickhashinthash.loadfromfile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/quickhashinthash.loadfromfile.php">＋<small>add a note</small></a></span>
