...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getgroupsortfields.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getgroupsortfields.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupsortfields.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getgroupqueries.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getgrouptruncate.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getgroupsortfields.php' selected="selected">English</option>
            ...
            <option value='zh/solrquery.getgroupsortfields.php'>Chinese (Simplified)</option>
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.addgroupsortfield.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::addGroupSortField()</a> - Add a group sort field (group.sort parameter)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getgroupsortfields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getgroupsortfields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getgroupsortfields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getgroupsortfields.php">＋<small>add a note</small></a></span>
