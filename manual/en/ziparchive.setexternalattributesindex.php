...
<head>
  ...
  <title>PHP: ZipArchive::setExternalAttributesIndex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.setexternalattributesindex.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.setexternalattributesindex.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setexternalattributesindex.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.setencryptionname.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.setexternalattributesname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setexternalattributesindex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.setexternalattributesindex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.setexternalattributesindex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.setexternalattributesindex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.setexternalattributesindex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.setexternalattributesindex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.setexternalattributesindex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.setexternalattributesindex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.setexternalattributesindex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.setexternalattributesindex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.setexternalattributesindex.php" hreflang="zh">
...
<meta name="Description" content="Set the external attributes of an entry defined by its index" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::setExternalAttributesIndex - Manual" />
<meta name="twitter:description" content="Set the external attributes of an entry defined by its index" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::setExternalAttributesIndex - Manual" />
<meta itemprop="description" content="Set the external attributes of an entry defined by its index" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the external attributes of an entry defined by its index" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.setexternalattributesname.php">
          ZipArchive::setExternalAttributesName &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.setencryptionname.php">
          &laquo; ZipArchive::setEncryptionName        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.setexternalattributesindex.php' selected="selected">English</option>
            <option value='de/ziparchive.setexternalattributesindex.php'>German</option>
            <option value='es/ziparchive.setexternalattributesindex.php'>Spanish</option>
            <option value='fr/ziparchive.setexternalattributesindex.php'>French</option>
            <option value='it/ziparchive.setexternalattributesindex.php'>Italian</option>
            <option value='ja/ziparchive.setexternalattributesindex.php'>Japanese</option>
            <option value='pt_BR/ziparchive.setexternalattributesindex.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.setexternalattributesindex.php'>Russian</option>
            <option value='tr/ziparchive.setexternalattributesindex.php'>Turkish</option>
            <option value='uk/ziparchive.setexternalattributesindex.php'>Ukrainian</option>
            <option value='zh/ziparchive.setexternalattributesindex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.setexternalattributesindex" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ZipArchive::setExternalAttributesIndex</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.6.0, PHP 7, PHP 8, PECL zip &gt;= 1.12.4)</p><p class="refpurpose"><span class="refname">ZipArchive::setExternalAttributesIndex</span> &mdash; <span class="dc-title">Set the external attributes of an entry defined by its index</span></p>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/setexternalattributesindex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.setexternalattributesindex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.setexternalattributesindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.setexternalattributesindex.php">＋<small>add a note</small></a></span>
