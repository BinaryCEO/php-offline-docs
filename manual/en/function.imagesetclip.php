...
<head>
  ...
  <title>PHP: imagesetclip - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagesetclip.php">
 <link rel="shorturl" href="https://www.php.net/imagesetclip">
 <link rel="alternate" href="https://www.php.net/imagesetclip" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagesetbrush.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagesetinterpolation.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagesetclip.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagesetclip.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagesetclip.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagesetclip.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagesetclip.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagesetclip.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagesetclip.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagesetclip.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagesetclip.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagesetclip.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagesetclip.php" hreflang="zh">
...
<meta name="Description" content="Set the clipping rectangle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagesetclip - Manual" />
<meta name="twitter:description" content="Set the clipping rectangle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagesetclip - Manual" />
<meta itemprop="description" content="Set the clipping rectangle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the clipping rectangle" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagesetinterpolation.php">
          imagesetinterpolation &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagesetbrush.php">
          &laquo; imagesetbrush        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagesetclip.php' selected="selected">English</option>
            <option value='de/function.imagesetclip.php'>German</option>
            <option value='es/function.imagesetclip.php'>Spanish</option>
            <option value='fr/function.imagesetclip.php'>French</option>
            <option value='it/function.imagesetclip.php'>Italian</option>
            <option value='ja/function.imagesetclip.php'>Japanese</option>
            <option value='pt_BR/function.imagesetclip.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagesetclip.php'>Russian</option>
            <option value='tr/function.imagesetclip.php'>Turkish</option>
            <option value='uk/function.imagesetclip.php'>Ukrainian</option>
            <option value='zh/function.imagesetclip.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagesetclip" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.imagesetclip-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagesetclip</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x2</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y2</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagegetclip.php" class="function" rel="rdfs-seeAlso">imagegetclip()</a> - Get the clipping rectangle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagesetclip.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagesetclip%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagesetclip&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagesetclip.php">＋<small>add a note</small></a></span>
