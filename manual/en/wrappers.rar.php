...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/wrappers.rar.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/wrappers.rar.php">
 <link rel="alternate" href="https://www.php.net/manual/en/wrappers.rar.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/wrappers.php">
 <link rel="prev" href="https://www.php.net/manual/en/wrappers.ssh2.php">
 <link rel="next" href="https://www.php.net/manual/en/wrappers.audio.php">

 <link rel="alternate" href="https://www.php.net/manual/en/wrappers.rar.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/wrappers.rar.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/wrappers.rar.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/wrappers.rar.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/wrappers.rar.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/wrappers.rar.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/wrappers.rar.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/wrappers.rar.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/wrappers.rar.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/wrappers.rar.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/wrappers.rar.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: rar:// - Manual" />
<meta name="twitter:description" content="RAR" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rar:// - Manual" />
<meta itemprop="description" content="RAR" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="RAR" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="wrappers.audio.php">
          ogg:// &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="wrappers.ssh2.php">
          &laquo; ssh2://        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/wrappers.rar.php' selected="selected">English</option>
            <option value='de/wrappers.rar.php'>German</option>
            <option value='es/wrappers.rar.php'>Spanish</option>
            <option value='fr/wrappers.rar.php'>French</option>
            <option value='it/wrappers.rar.php'>Italian</option>
            <option value='ja/wrappers.rar.php'>Japanese</option>
            <option value='pt_BR/wrappers.rar.php'>Brazilian Portuguese</option>
            <option value='ru/wrappers.rar.php'>Russian</option>
            <option value='tr/wrappers.rar.php'>Turkish</option>
            <option value='uk/wrappers.rar.php'>Ukrainian</option>
            <option value='zh/wrappers.rar.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="wrappers.rar" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-wrappers.rar-description">
  ...
  <p class="para">
   ...
   an optional asterisk (<code class="literal">*</code>), an optional number sign
  ...
  <p class="simpara">
   ...
   <span class="classname"><a href="class.recursivedirectoryiterator.php" class="classname">RecursiveDirectoryIterator</a></span> in the presence of file names that seem like
   url encoded data.
  </p>
  ...
  <p class="simpara">
   ...
   The usage of the wrapper with <span class="classname"><a href="class.recursivedirectoryiterator.php" class="classname">RecursiveDirectoryIterator</a></span> requires
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   ...
   <span class="simpara">
    In order to use the <var class="filename">rar://</var> wrapper,
    the
     ...
     <tbody class="tbody">
      ...
      <tr>
       ...
       <td>A callback to determine the path of missing volumes. See
        <span class="methodname"><a href="rararchive.open.php" class="methodname">RarArchive::open()</a></span> for more information.
       </td>
       <td class="empty">&nbsp;</td>
      </tr>
...
(
    ...
    [blocks] =&gt; -1
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/wrappers/rar.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fwrappers.rar%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=wrappers.rar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/wrappers.rar.php">＋<small>add a note</small></a></span>
