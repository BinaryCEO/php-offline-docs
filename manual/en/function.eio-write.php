...
<head>
  ...
  <title>PHP: eio_write - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-write.php">
 <link rel="shorturl" href="https://www.php.net/eio-write">
 <link rel="alternate" href="https://www.php.net/eio-write" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-utime.php">
 <link rel="next" href="https://www.php.net/manual/en/book.ev.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-write.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-write.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-write.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-write.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-write.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-write.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-write.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-write.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-write.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-write.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-write.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: eio_write - Manual" />
<meta name="twitter:description" content="Write to file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_write - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-write.php' selected="selected">English</option>
            <option value='de/function.eio-write.php'>German</option>
            <option value='es/function.eio-write.php'>Spanish</option>
            <option value='fr/function.eio-write.php'>French</option>
            <option value='it/function.eio-write.php'>Italian</option>
            <option value='ja/function.eio-write.php'>Japanese</option>
            <option value='pt_BR/function.eio-write.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-write.php'>Russian</option>
            <option value='tr/function.eio-write.php'>Turkish</option>
            <option value='uk/function.eio-write.php'>Ukrainian</option>
            <option value='zh/function.eio-write.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-write" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_write</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_write</span> &mdash; <span class="dc-title">Write to file</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-write-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_write</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$str</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
  <span class="function"><strong>eio_write()</strong></span> writes up to <code class="parameter">length</code>
  bytes from <code class="parameter">str</code> at <code class="parameter">offset</code>
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-write-parameters">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-write-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_write()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.eio-write-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-open.php" class="function" rel="rdfs-seeAlso">eio_open()</a> - Opens a file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-write.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-write%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-write&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-write.php">＋<small>add a note</small></a></span>
