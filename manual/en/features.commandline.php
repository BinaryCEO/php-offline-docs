...
<div class="phpcode"><code><span class="html">use " instead of ' on windows when using the cli version with -r<br /><br />php -r "echo 1" <br />-- correct<br /><br />php -r 'echo 1'<br />  PHP Parse error:  syntax error, unexpected ''echo' (T_ENCAPSED_AND_WHITESPACE), expecting end of file in Command line code on line 1</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">If you edit a php file in windows, upload and run it on linux with command line method. You may encounter a running problem probably like that:<br /><br />[root@ItsCloud02 wsdl]# ./lnxcli.php<br />Extension './lnxcli.php' not present.<br /><br />Or you may encounter some other strange problem.<br />Care the enter key. In windows environment, enter key generate two binary characters '0D0A'. But in Linux, enter key generate just only a 'OA'.<br />I wish it can help someone if you are using windows to code php and run it as a command line program on linux.</span></code></div>
  </div>
 </div>
  <div class="note" id="121914">  <div class="votes">
    ...
    <div class="tally" id="V121914" title="61% like this...">
    25
    </div>
  </div>
  <a href="#121914" class="name">
  <strong class="user"><em>apmuthu at usa dot net</em></strong></a><a class="genanchor" href="#121914"> &para;</a><div class="date" title="2017-11-26 05:17"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121914">
<div class="phpcode"><code><span class="html">Adding a pause() function to PHP waiting for any user input returning it:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">pause</span><span class="keyword">() {<br />    </span><span class="default">$handle </span><span class="keyword">= </span><span class="default">fopen </span><span class="keyword">(</span><span class="string">"php://stdin"</span><span class="keyword">,</span><span class="string">"r"</span><span class="keyword">);<br />    do { </span><span class="default">$line </span><span class="keyword">= </span><span class="default">fgets</span><span class="keyword">(</span><span class="default">$handle</span><span class="keyword">); } while (</span><span class="default">$line </span><span class="keyword">== </span><span class="string">''</span><span class="keyword">);<br />    </span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$handle</span><span class="keyword">);<br />    return </span><span class="default">$line</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="125955">  <div class="votes">
    ...
    <div class="tally" id="V125955" title="59% like this...">
    23
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">We can pass many arguments directly into the hashbang line.<br />As example many ini setting via the -d parameter of php.<br />---<br />#!/usr/bin/php -d memory_limit=2048M -d post_max_size=0<br />phpinfo();<br />exit;<br />---<br />./script | grep memory<br />memory_limit =&gt; 2048M =&gt; 2048M<br />---<br />But we can also use this behaviour into a second script, so it call the first as an interpreter, via the hashbang:<br />---<br />#!./script arg1 arg2 arg3 <br />---<br />However the parameters are dispatched in a different way into $argv<br /><br />All the parameters are in $argv[1], $argv[0] is the interpreter script name, and $argv[1] is the caller script name.<br /><br />To get back the parameters into $argv, we can simply test if $argv[1] contains spaces, and then dispatch again as normal: <br /><br />#!/usr/bin/php -d memory_limit=2048M -d post_max_size=0<br /><span class="default">&lt;?php<br />var_dump</span><span class="keyword">(</span><span class="default">$argv</span><span class="keyword">);<br />if (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$argv</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">], </span><span class="string">' '</span><span class="keyword">) !== </span><span class="default">false</span><span class="keyword">){<br />  </span><span class="default">$argw </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">(</span><span class="string">" "</span><span class="keyword">, </span><span class="default">$argv</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">]);<br />  </span><span class="default">array_unshift</span><span class="keyword">(</span><span class="default">$argw</span><span class="keyword">, </span><span class="default">$argv</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">]);<br />  </span><span class="default">$argv </span><span class="keyword">= </span><span class="default">$argw</span><span class="keyword">;<br />}<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$argv</span><span class="keyword">); </span><span class="default">?&gt;<br /></span>---<br />array(3) {<br />  [0]=&gt;<br />  string(8) "./script"<br />  [1]=&gt;<br />  string(15) "arg1 arg2 arg3 "<br />  [2]=&gt;<br />  string(14) "./other_script"<br />}<br />array(4) {<br />  [0]=&gt;<br />  string(8) "./other_script"<br />  [1]=&gt;<br />  string(4) "arg1"<br />  [2]=&gt;<br />  string(4) "arg2"<br />  [3]=&gt;<br />  string(4) "arg3"<br />}<br />---<br />This will maintain the same behaviour in all cases and allow to even double click a script to call both parameters of another script, and even make a full interpreter language layer.  The other script doesn't has to be php. Take care of paths.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>frankNospamwanted at. toppoint dot. de</em></strong></a><a class="genanchor" href="#116023"> &para;</a><div class="date" title="2014-10-30 03:37"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116023">
<div class="phpcode"><code><span class="html">Parsing commandline argument GET String without changing the PHP script (linux shell):<br />URL: index.php?a=1&amp;b=2<br />Result: output.html<br /><br />echo "" | php -R 'include("index.php");' -B 'parse_str($argv[1], $_GET);' 'a=1&amp;b=2' &gt;output.html<br /><br />(no need to change php.ini)<br /><br />You can put this <br />  echo "" | php -R 'include("'$1'");' -B 'parse_str($argv[1], $_GET);' "$2"<br />in a bash script "php_get" to use it like this:<br />  php_get index.php 'a=1&amp;b=2' &gt;output.html<br />or directed to text browser...<br />  php_get index.php 'a=1&amp;b=2' |w3m -T text/html</span></code></div>
  </div>
 </div>
  <div class="note" id="57143">  <div class="votes">
    ...
    <div class="tally" id="V57143" title="60% like this...">
    24
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">When you're writing one line php scripts remember that 'php://stdin' is your friend. Here's a simple program I use to format PHP code for inclusion on my blog:<br /><br />UNIX:<br />  cat test.php | php -r "print htmlentities(file_get_contents('php://stdin'));"<br /><br />DOS/Windows:<br />  type test.php | php -r "print htmlentities(file_get_contents('php://stdin'));"</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>ben at slax0rnet dot com</em></strong></a><a class="genanchor" href="#39576"> &para;</a><div class="date" title="2004-02-02 07:34"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom39576">
<div class="phpcode"><code><span class="html">Just a note for people trying to use interactive mode from the commandline.<br /><br />The purpose of interactive mode is to parse code snippits without actually leaving php, and it works like this:<br /><br />[root@localhost php-4.3.4]# php -a<br />Interactive mode enabled<br /><br /><span class="default">&lt;?php </span><span class="keyword">echo </span><span class="string">"hi!"</span><span class="keyword">; </span><span class="default">?&gt;<br /></span>&lt;note, here we would press CTRL-D to parse everything we've entered so far&gt;<br />hi!<br /><span class="default">&lt;?php </span><span class="keyword">exit(); </span><span class="default">?&gt;<br /></span>&lt;ctrl-d here again&gt;<br />[root@localhost php-4.3.4]#<br /><br />I noticed this somehow got ommited from the docs, hope it helps someone!</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Check directly without calling functions:
...
<div class="phpcode"><code><span class="html">If you want to be interactive with the user and accept user input, all you need to do is read from stdin.  <br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">echo </span><span class="string">"Are you sure you want to do this?  Type 'yes' to continue: "</span><span class="keyword">;<br /></span><span class="default">$handle </span><span class="keyword">= </span><span class="default">fopen </span><span class="keyword">(</span><span class="string">"php://stdin"</span><span class="keyword">,</span><span class="string">"r"</span><span class="keyword">);<br /></span><span class="default">$line </span><span class="keyword">= </span><span class="default">fgets</span><span class="keyword">(</span><span class="default">$handle</span><span class="keyword">);<br />if(</span><span class="default">trim</span><span class="keyword">(</span><span class="default">$line</span><span class="keyword">) != </span><span class="string">'yes'</span><span class="keyword">){<br />    echo </span><span class="string">"ABORTING!\n"</span><span class="keyword">;<br />    exit;<br />}<br />echo </span><span class="string">"\n"</span><span class="keyword">;<br />echo </span><span class="string">"Thank you, continuing...\n"</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <strong class="user"><em>phpnotes at ssilk dot de</em></strong></a><a class="genanchor" href="#26201"> &para;</a><div class="date" title="2002-10-22 03:36"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom26201">
<div class="phpcode"><code><span class="html">To hand over the GET-variables in interactive mode like in HTTP-Mode (e.g. your URI is myprog.html?hugo=bla&amp;bla=hugo), you have to call<br /><br />php myprog.html '&amp;hugo=bla&amp;bla=hugo'<br /><br />(two &amp; instead of ? and &amp;!)<br /><br />There just a little difference in the $ARGC, $ARGV values, but I think this is in those cases not relevant.</span></code></div>
  </div>
 </div>
  <div class="note" id="56928">  <div class="votes">
    ...
    <div class="tally" id="V56928" title="58% like this...">
    20
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">I needed this, you proly wont tho.
...
<div class="phpcode"><code><span class="html">Just another variant of previous script that group arguments doesn't starts with '-' or '--'
<br />
<br /><span class="default">&lt;?php
...
<br />)</span></code></div>
  ...
  <div class="note" id="53252">  <div class="votes">
    ...
    <div class="tally" id="V53252" title="60% like this...">
    15
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">You can also call the script from the command line after chmod'ing the file (ie: chmod 755 file.php).<br /><br />On your first line of the file, enter "#!/usr/bin/php" (or to wherever your php executable is located).  If you want to suppress the PHP headers, use the line of "#!/usr/bin/php -q" for your path.</span></code></div>
  </div>
 </div>
  <div class="note" id="98647">  <div class="votes">
    ...
    <div class="tally" id="V98647" title="58% like this...">
    16
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">I had a problem with the $argv values getting split up when they contained plus (+) signs. Be sure to use the CLI version, not CGI to get around it.<br /><br />Monte</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">For those of you who want the old CGI behaviour that changes to the actual directory of the script use:<br />chdir(dirname($_SERVER['argv'][0]));<br /><br />at the beginning of your scripts.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>goalain eat gmail dont com</em></strong></a><a class="genanchor" href="#71154"> &para;</a><div class="date" title="2006-11-14 12:57"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom71154">
<div class="phpcode"><code><span class="html">If your php script doesn't run with shebang (#!/usr/bin/php),
...
<br />\Alon</span></code></div>
  ...
  <div class="note" id="74088">  <div class="votes">
    ...
    <div class="tally" id="V74088" title="57% like this...">
    16
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">i use emacs in c-mode for editing.  in 4.3, starting a cli script like so:<br /><br />#!/usr/bin/php -q /* -*- c -*- */<br /><span class="default">&lt;?php<br /><br />told emacs to drop into c</span><span class="keyword">-</span><span class="default">mode automatically when i loaded the file </span><span class="keyword">for </span><span class="default">editing</span><span class="keyword">.  </span><span class="default">the </span><span class="string">'-q' </span><span class="default">flag didn</span><span class="string">'t actually do anything (in the older cgi versions, it suppressed html output when the script was run) but it caused the commented mode line to be ignored by php.<br /><br />in 5.2, '</span><span class="keyword">-</span><span class="default">q</span><span class="string">' has apparently been deprecated.  replace it with '</span><span class="keyword">--</span><span class="string">' to achieve the 4.3 invocation-with-emacs-mode-line behavior:<br /><br />#!/usr/bin/php -- /* -*- c -*- */<br />&lt;?php<br /><br />don'</span><span class="default">t go back to your 4.3 system </span><span class="keyword">and </span><span class="default">replace </span><span class="string">'-q' </span><span class="default">with </span><span class="string">'--'</span><span class="keyword">; </span><span class="default">it seems to cause php to hang waiting on STDIN</span><span class="keyword">...</span></span></code></div>
  </div>
 </div>
  <div class="note" id="123606">  <div class="votes">
    ...
    <div class="tally" id="V123606" title="57% like this...">
    9
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">When using the -R flag, the name of the variable containing the content of the current line (not including the LF) is $argn.<br /><br />For example you can do this code:<br /><br />cat file.txt | php -R 'echo $argn . "\n";'<br /><br />This will just output each line of the input file without doing anything to it.</span></code></div>
  </div>
 </div>
  <div class="note" id="75532">  <div class="votes">
    ...
    <div class="tally" id="V75532" title="56% like this...">
    16
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">dunno if this is on linux the same but on windows evertime<br />you send somthing to the console screen php is waiting for<br />the console to return. therefor if you send a lot of small <br />short amounts of text, the console is starting to be using <br />more cpu-cycles then php and thus slowing the script.<br /><br />take a look at this sheme:<br />cpu-cycle:1 -&gt;php: print("a");<br />cpu-cycle:2 -&gt;cmd: output("a");<br />cpu-cycle:3 -&gt;php: print("b");<br />cpu-cycle:4 -&gt;cmd: output("b");<br />cpu-cycle:5 -&gt;php: print("c");<br />cpu-cycle:6 -&gt;cmd: output("c"); <br />cpu-cylce:7 -&gt;php: print("d");<br />cpu-cycle:8 -&gt;cmd: output("d"); <br />cpu-cylce:9 -&gt;php: print("e");<br />cpu-cycle:0 -&gt;cmd: output("e"); <br /><br />on the screen just appears "abcde". but if you write <br />your script this way it will be far more faster:<br />cpu-cycle:1 -&gt;php: ob_start();<br />cpu-cycle:2 -&gt;php: print("abc");<br />cpu-cycle:3 -&gt;php: print("de");<br />cpu-cycle:4 -&gt;php: $data = ob_get_contents();<br />cpu-cycle:5 -&gt;php: ob_end_clean();<br />cpu-cycle:6 -&gt;php: print($data);<br />cpu-cycle:7 -&gt;cmd: output("abcde");<br /><br />now this is just a small example but if you are writing an<br />app that is outputting a lot to the console, i.e. a text<br />based screen with frequent updates, then its much better <br />to first cach all output, and output is as one big chunk of<br />text instead of one char a the time. <br /><br />ouput buffering is ideal for this. in my script i outputted<br />almost 4000chars of info and just by caching it first, it<br />speeded up by almost 400% and dropped cpu-usage.<br /><br />because what is being displayed doesn't matter, be it 2<br />chars or 40.0000 chars, just the call to output takes a <br />great deal of time. remeber that.<br /><br />maybe someone can test if this is the same on unix-based<br />systems. it seems that the STDOUT stream just waits for <br />the console to report ready, before continueing execution.</span></code></div>
  ...
  <div class="note" id="75985">  <div class="votes">
    ...
    <div class="tally" id="V75985" title="57% like this...">
    9
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">In 5.1.2 (and others, I assume), the -f form silently drops the first argument after the script name from $_SERVER['argv']. I'd suggest avoiding it unless you need it for a special case.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">In *nix systems, use the WHICH command to show the location of the php binary executable. This is the path to use as the first line in your php shell script file. (#!/path/to/php -q) And execute php from the command line with the -v switch to see what version you are running.<br /><br />example:<br /><br /># which php<br />/usr/local/bin/php<br /># php -v<br />PHP 4.3.1 (cli) (built: Mar 27 2003 14:41:51)<br />Copyright (c) 1997-2002 The PHP Group<br />Zend Engine v1.3.0, Copyright (c) 1998-2002 Zend Technologies<br /><br />In the above example, you would use: #!/usr/local/bin/php<br /><br />Also note that, if you do not have the current/default directory in your PATH (.), you will have to use ./scriptfilename to execute your script file from the command line (or you will receive a "command not found" error). Use the ENV command to show your PATH environment variable value.</span></code></div>
  ...
  <div class="note" id="62162">  <div class="votes">
    ...
    <div class="tally" id="V62162" title="55% like this...">
    10
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Spawning php-win.exe as a child process to handle scripting in Windows applications has a few quirks (all having to do with pipes between Windows apps and console apps).<br /><br />To do this in C++:<br /><br />// We will run php.exe as a child process after creating<br />// two pipes and attaching them to stdin and stdout<br />// of the child process<br />// Define sa struct such that child inherits our handles<br /><br />SECURITY_ATTRIBUTES sa = { sizeof(SECURITY_ATTRIBUTES) };<br />sa.bInheritHandle = TRUE;<br />sa.lpSecurityDescriptor = NULL;<br /><br />// Create the handles for our two pipes (two handles per pipe, one for each end)<br />// We will have one pipe for stdin, and one for stdout, each with a READ and WRITE end<br />HANDLE hStdoutRd, hStdoutWr, hStdinRd, hStdinWr;<br /><br />// Now create the pipes, and make them inheritable<br />CreatePipe (&amp;hStdoutRd, &amp;hStdoutWr, &amp;sa, 0))<br />SetHandleInformation(hStdoutRd, HANDLE_FLAG_INHERIT, 0);<br />CreatePipe (&amp;hStdinRd, &amp;hStdinWr, &amp;sa, 0)<br />SetHandleInformation(hStdinWr, HANDLE_FLAG_INHERIT, 0);<br /><br />// Now we have two pipes, we can create the process<br />// First, fill out the usage structs<br />STARTUPINFO si = { sizeof(STARTUPINFO) };<br />PROCESS_INFORMATION pi;<br />si.dwFlags = STARTF_USESTDHANDLES;<br />si.hStdOutput = hStdoutWr;<br />si.hStdInput  = hStdinRd;<br /><br />// And finally, create the process<br />CreateProcess (NULL, "c:\\php\\php-win.exe", NULL, NULL, TRUE, NORMAL_PRIORITY_CLASS, NULL, NULL, &amp;si, &amp;pi);<br /><br />// Close the handles we aren't using<br />CloseHandle(hStdoutWr);<br />CloseHandle(hStdinRd);<br /><br />// Now that we have the process running, we can start pushing PHP at it<br />WriteFile(hStdinWr, "<span class="default">&lt;?php </span><span class="keyword">echo </span><span class="string">'test'</span><span class="keyword">; </span><span class="default">?&gt;</span>", 9, &amp;dwWritten, NULL);<br /><br />// When we're done writing to stdin, we close that pipe<br />CloseHandle(hStdinWr);<br /><br />// Reading from stdout is only slightly more complicated<br />int i;<br /><br />std::string processed("");<br />char buf[128];<br /><br />while ( (ReadFile(hStdoutRd, buf, 128, &amp;dwRead, NULL) &amp;&amp; (dwRead != 0)) ) {<br />    for (i = 0; i &lt; dwRead; i++)<br />        processed += buf[i];<br />}    <br /><br />// Done reading, so close this handle too<br />CloseHandle(hStdoutRd);<br /><br />A full implementation (implemented as a C++ class) is available at <a href="http://www.stromcode.com" rel="nofollow" target="_blank">http://www.stromcode.com</a></span></code></div>
  ...
  <div class="note" id="78093">  <div class="votes">
    ...
    <div class="tally" id="V78093" title="55% like this...">
    8
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">an another "another variant" :<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">arguments</span><span class="keyword">(</span><span class="default">$argv</span><span class="keyword">)<br />{<br />  </span><span class="default">$_ARG </span><span class="keyword">= array();<br />  foreach (</span><span class="default">$argv </span><span class="keyword">as </span><span class="default">$arg</span><span class="keyword">)<br />  {<br />    if (</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'#^-{1,2}([a-zA-Z0-9]*)=?(.*)$#'</span><span class="keyword">, </span><span class="default">$arg</span><span class="keyword">, </span><span class="default">$matches</span><span class="keyword">))<br />    {<br />      </span><span class="default">$key </span><span class="keyword">= </span><span class="default">$matches</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">];<br />      switch (</span><span class="default">$matches</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">])<br />      {<br />        case </span><span class="string">''</span><span class="keyword">:<br />        case </span><span class="string">'true'</span><span class="keyword">:<br />          </span><span class="default">$arg </span><span class="keyword">= </span><span class="default">true</span><span class="keyword">;<br />          break;<br />        case </span><span class="string">'false'</span><span class="keyword">:<br />          </span><span class="default">$arg </span><span class="keyword">= </span><span class="default">false</span><span class="keyword">;<br />          break;<br />        default:<br />          </span><span class="default">$arg </span><span class="keyword">= </span><span class="default">$matches</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">];<br />      }<br />      </span><span class="default">$_ARG</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] = </span><span class="default">$arg</span><span class="keyword">;<br />    }<br />    else<br />    {<br />      </span><span class="default">$_ARG</span><span class="keyword">[</span><span class="string">'input'</span><span class="keyword">][] = </span><span class="default">$arg</span><span class="keyword">;<br />    }<br />  }<br />  return </span><span class="default">$_ARG</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />$php myscript.php arg1 -arg2=val2 --arg3=arg3 -arg4 --arg5 -arg6=false<br /><br />Array<br />(<br />    [input] =&gt; Array<br />        (<br />            [0] =&gt; myscript.php<br />            [1] =&gt; arg1<br />        )<br /><br />    [arg2] =&gt; val2<br />    [arg3] =&gt; arg3<br />    [arg4] =&gt; true<br />    [arg5] =&gt; true<br />    [arg5] =&gt; false<br />)</span></code></div>
  </div>
 </div>
  <div class="note" id="29468">  <div class="votes">
    ...
    <div class="tally" id="V29468" title="56% like this...">
    8
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">How to change current directory in PHP script to script's directory when running it from command line using PHP 4.3.0?<br />(you'll probably need to add this to older scripts when running them under PHP 4.3.0 for backwards compatibility)<br /><br />Here's what I am using:<br />chdir(preg_replace('/\\/[^\\/]+$/',"",$PHP_SELF));<br /><br />Note: documentation says that "PHP_SELF" is not available in command-line PHP scripts. Though, it IS available. Probably this will be changed in future version, so don't rely on this line of code...<br /><br />Use $_SERVER['PHP_SELF'] instead of just $PHP_SELF if you have register_globals=Off</span></code></div>
  ...
  <div class="note" id="19167">  <div class="votes">
    ...
    <div class="tally" id="V19167" title="56% like this...">
    6
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Assuming --prefix=/usr/local/php, it's better to create a symlink from /usr/bin/php or /usr/local/bin/php to target /usr/local/php/bin/php so that it's both in your path and automatically correct every time you rebuild.  If you forgot to do that copy of the binary after a rebuild, you can do all kinds of wild goose chasing when things break.</span></code></div>
  </div>
 </div>
  <div class="note" id="78672">  <div class="votes">
    ...
    <div class="tally" id="V78672" title="53% like this...">
    5
    </div>
  </div>
  <a href="#78672" class="name">
  <strong class="user"><em>james_s2010 at NOSPAM dot hotmail dot com</em></strong></a><a class="genanchor" href="#78672"> &para;</a><div class="date" title="2007-10-22 02:11"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom78672">
<div class="phpcode"><code><span class="html">I was looking for a way to interactively get a single character response from user. Using STDIN with fread, fgets and such will only work after pressing enter. So I came up with this instead:
<br />
<br />#!/usr/bin/php -q
<br /><span class="default">&lt;?php
