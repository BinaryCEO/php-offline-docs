...
<head>
  ...
  <title>PHP: cubrid_set_query_timeout - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-set-query-timeout.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-set-query-timeout">
 <link rel="alternate" href="https://www.php.net/cubrid-set-query-timeout" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-set-drop.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-version.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-set-query-timeout.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-set-query-timeout.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-set-query-timeout.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-set-query-timeout.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-set-query-timeout.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-set-query-timeout.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-set-query-timeout.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-set-query-timeout.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-set-query-timeout.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-set-query-timeout.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-set-query-timeout.php" hreflang="zh">
...
<meta name="Description" content="Set the timeout time of query execution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_set_query_timeout - Manual" />
<meta name="twitter:description" content="Set the timeout time of query execution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_set_query_timeout - Manual" />
<meta itemprop="description" content="Set the timeout time of query execution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the timeout time of query execution" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-version.php">
          cubrid_version &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-set-drop.php">
          &laquo; cubrid_set_drop        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-set-query-timeout.php' selected="selected">English</option>
            <option value='de/function.cubrid-set-query-timeout.php'>German</option>
            <option value='es/function.cubrid-set-query-timeout.php'>Spanish</option>
            <option value='fr/function.cubrid-set-query-timeout.php'>French</option>
            <option value='it/function.cubrid-set-query-timeout.php'>Italian</option>
            <option value='ja/function.cubrid-set-query-timeout.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-set-query-timeout.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-set-query-timeout.php'>Russian</option>
            <option value='tr/function.cubrid-set-query-timeout.php'>Turkish</option>
            <option value='uk/function.cubrid-set-query-timeout.php'>Ukrainian</option>
            <option value='zh/function.cubrid-set-query-timeout.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-set-query-timeout" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_set_query_timeout</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.4.1)</p><p class="refpurpose"><span class="refname">cubrid_set_query_timeout</span> &mdash; <span class="dc-title">Set the timeout time of query execution</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-set-query-timeout-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_set_query_timeout</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$req_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timeout</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   The <span class="function"><strong>cubrid_set_query_timeout()</strong></span> function is used to set
   the timeout time of query execution.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.cubrid-set-query-timeout-parameters">
 ...
 <p class="para">
  <dl>
    ...
    <dd>
     <p class="para">Timeout time in milliseconds.</p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-set-query-timeout-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.cubrid-set-query-timeout-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
   <li><span class="function"><a href="function.cubrid-get-query-timeout.php" class="function" rel="rdfs-seeAlso">cubrid_get_query_timeout()</a> - Get the query timeout value of the request</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-set-query-timeout.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-set-query-timeout%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-set-query-timeout&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-set-query-timeout.php">＋<small>add a note</small></a></span>
