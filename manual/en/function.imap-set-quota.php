...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-set-quota.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-search.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-setacl.php">
...
<meta name="Description" content="Sets a quota for a given mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_set_quota - Manual" />
<meta name="twitter:description" content="Sets a quota for a given mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_set_quota - Manual" />
<meta itemprop="description" content="Sets a quota for a given mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets a quota for a given mailbox" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-set-quota.php' selected="selected">English</option>
            <option value='de/function.imap-set-quota.php'>German</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_set_quota</span> &mdash; <span class="dc-title">Sets a quota for a given mailbox</span></p>
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
     ...
     <dd>
      <p class="para">
       ...
       format for a mailbox: <code class="literal">user.name</code>.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       The maximum size (in KB) for the <code class="parameter">quota_root</code>
      </p>
     </dd>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.imap-get-quota.php" class="function" rel="rdfs-seeAlso">imap_get_quota()</a> - Retrieve the quota level settings, and usage statics per mailbox</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-set-quota.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-set-quota%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-set-quota&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-set-quota.php">＋<small>add a note</small></a></span>
