...
<head>
  ...
  <title>PHP: odbc_longreadlen - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-longreadlen.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-gettypeinfo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-next-result.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-longreadlen.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-longreadlen.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-longreadlen.php" hreflang="uk">
...
<meta name="Description" content="Handling of LONG columns" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_longreadlen - Manual" />
<meta name="twitter:description" content="Handling of LONG columns" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_longreadlen - Manual" />
<meta itemprop="description" content="Handling of LONG columns" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Handling of LONG columns" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.odbc-next-result.php">
          odbc_next_result &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-gettypeinfo.php">
          &laquo; odbc_gettypeinfo        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-longreadlen.php' selected="selected">English</option>
            <option value='de/function.odbc-longreadlen.php'>German</option>
            <option value='es/function.odbc-longreadlen.php'>Spanish</option>
            <option value='fr/function.odbc-longreadlen.php'>French</option>
            <option value='it/function.odbc-longreadlen.php'>Italian</option>
            <option value='ja/function.odbc-longreadlen.php'>Japanese</option>
            <option value='pt_BR/function.odbc-longreadlen.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-longreadlen.php'>Russian</option>
            <option value='tr/function.odbc-longreadlen.php'>Turkish</option>
            <option value='uk/function.odbc-longreadlen.php'>Ukrainian</option>
            <option value='zh/function.odbc-longreadlen.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-longreadlen" class="refentry">
   ...
   <p class="para">
    ...
    <span class="function"><a href="function.odbc-binmode.php" class="function">odbc_binmode()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-longreadlen.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-longreadlen%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-longreadlen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-longreadlen.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">6 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="55538">  <div class="votes">
    <div id="Vu55538">
    <a href="/manual/vote-note.php?id=55538&amp;page=function.odbc-longreadlen&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd55538">
    <a href="/manual/vote-note.php?id=55538&amp;page=function.odbc-longreadlen&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V55538" title="80% like this...">
    3
    </div>
  </div>
  <a href="#55538" class="name">
  <strong class="user"><em>php dot net dot notes at webqs dot com</em></strong></a><a class="genanchor" href="#55538"> &para;</a><div class="date" title="2005-08-06 06:12"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom55538">
<div class="phpcode"><code><span class="html">Hi<br /><br />If you are experiencing troubles with truncated and/or strangely encoded data when using PHP with MS SQL via ODBC try setting odbc.defaultlrl ( in php.ini or via ini_set() ) to a largish number, say 65536, as stated in the other notes here. <br />The trick is to know how long your data is going to be, so you may want to provide some overhead. Unfortunately you have to know how long your piece of string is before you cut it.<br /><br />Doing this will allow your app to read up to this amount in one go. I'm sure there is a reason for this behaviour but I hadn't experienced anything like it in 5 years of MySQL and Postgres development.<br /><br />If you still experience problems AND are using unicode data in the long column of your table, make sure it is set to type "ntext", if it is "text". MSDN has some info on data types for Unicode data.<br />This caused about 3 days of headaches for me, "binary" data crashing browsers and cyclical result sets (i.e repeating data after odbc.defaultlrl bytes). <br /><br />This fix was only found by poking things with sticks.<br /><br />HTH</span></code></div>
  </div>
 </div>
  <div class="note" id="118857">  <div class="votes">
    <div id="Vu118857">
    <a href="/manual/vote-note.php?id=118857&amp;page=function.odbc-longreadlen&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118857">
    <a href="/manual/vote-note.php?id=118857&amp;page=function.odbc-longreadlen&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118857" title="100% like this...">
    2
    </div>
  </div>
  <a href="#118857" class="name">
  <strong class="user"><em>Eion Robb</em></strong></a><a class="genanchor" href="#118857"> &para;</a><div class="date" title="2016-02-17 10:26"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118857">
<div class="phpcode"><code><span class="html">It's not mentioned in the notes here, but odbc_longreadlen($result, 0); only affects the output from odbc_result().  Setting the read length to 0 (or less than zero) will just output a blank string in the odbc_fetch_object(), odbc_fetch_array() and odbc_result_all() functions</span></code></div>
  </div>
 </div>
  <div class="note" id="92380">  <div class="votes">
    <div id="Vu92380">
    <a href="/manual/vote-note.php?id=92380&amp;page=function.odbc-longreadlen&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92380">
    <a href="/manual/vote-note.php?id=92380&amp;page=function.odbc-longreadlen&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92380" title="50% like this...">
    0
    </div>
  </div>
  <a href="#92380" class="name">
  <strong class="user"><em>egil at wp dot pl</em></strong></a><a class="genanchor" href="#92380"> &para;</a><div class="date" title="2009-07-22 02:06"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92380">
<div class="phpcode"><code><span class="html">I've tried to use a suggestion in the first comment but that didn't actually worked as I would expect... I wanted to get all data no matter how big it is, but strange things happened and I finally found this solution (works fine at least for MS SQL 2000 for at least few MB of binary data):<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// connection<br /></span><span class="default">$link </span><span class="keyword">= </span><span class="default">odbc_connect</span><span class="keyword">(</span><span class="default">$odbc_source_name</span><span class="keyword">, </span><span class="default">$user</span><span class="keyword">, </span><span class="default">$pass</span><span class="keyword">);<br /><br /></span><span class="comment">// query (note - one row in this example)<br /></span><span class="default">$sql </span><span class="keyword">= </span><span class="string">'SELECT image_data_column FROM some_table WHERE record_id=1'</span><span class="keyword">;<br /><br /></span><span class="comment">// run<br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">odbc_exec </span><span class="keyword">(</span><span class="default">$link</span><span class="keyword">, </span><span class="default">$sql</span><span class="keyword">)<br />if (!</span><span class="default">$result</span><span class="keyword">)<br />{<br />    </span><span class="default">trigger_error </span><span class="keyword">(</span><span class="string">'[sql] exec: '</span><span class="keyword">.</span><span class="default">$sql</span><span class="keyword">, </span><span class="default">E_USER_ERROR</span><span class="keyword">);<br />}<br /><br /></span><span class="comment">// fetch settings<br /></span><span class="default">odbc_binmode </span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">, </span><span class="default">ODBC_BINMODE_PASSTHRU</span><span class="keyword">); <br /></span><span class="default">odbc_longreadlen </span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /><br /></span><span class="comment">// get contents<br /></span><span class="default">ob_start</span><span class="keyword">(); </span><span class="comment">// you would probably need to move this inside if you expect more rows<br /></span><span class="keyword">while (</span><span class="default">odbc_fetch_row</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">))<br />{<br />    </span><span class="default">odbc_result</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">); </span><span class="comment">// this actually echos all of the contents of the image_data_column<br /></span><span class="keyword">}<br /></span><span class="default">odbc_free_result</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">);<br /></span><span class="default">$contents </span><span class="keyword">= </span><span class="default">ob_get_clean</span><span class="keyword">();<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="48015">  <div class="votes">
    <div id="Vu48015">
    <a href="/manual/vote-note.php?id=48015&amp;page=function.odbc-longreadlen&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd48015">
    <a href="/manual/vote-note.php?id=48015&amp;page=function.odbc-longreadlen&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V48015" title="no votes...">
    0
    </div>
  </div>
  <a href="#48015" class="name">
  <strong class="user"><em>jdcard at inreach dot com</em></strong></a><a class="genanchor" href="#48015"> &para;</a><div class="date" title="2004-12-08 09:37"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom48015">
<div class="phpcode"><code><span class="html">I was reading from a MEMO field (long varchar) in MSAccess, but the data was consistently truncated at 255 characters. I tried all the combinations of odbc_longreadlen() and odbc_binmode()  (and odbc.defaultlrl) that I could think of but none of them resolved the problem.<br /><br />The only fix that worked was to modify my query from "SELECT Field1, Field2 FROM TableName" to "SELECT * FROM TableName".<br /><br />I suspect that you could cast the field to force the appropriate data type, but when it finally worked after three days of struggle I didn't even try.</span></code></div>
  </div>
 </div>
  <div class="note" id="25495">  <div class="votes">
    <div id="Vu25495">
    <a href="/manual/vote-note.php?id=25495&amp;page=function.odbc-longreadlen&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd25495">
    <a href="/manual/vote-note.php?id=25495&amp;page=function.odbc-longreadlen&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V25495" title="50% like this...">
    0
    </div>
  </div>
  <a href="#25495" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#25495"> &para;</a><div class="date" title="2002-09-25 05:00"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom25495">
<div class="phpcode"><code><span class="html">An alternative is to adjust your php.ini file and set:<br />odbc.defaultlrl=65536<br />Or something else sufficiently large.<br />lrl = long read length</span></code></div>
  </div>
 </div>
  <div class="note" id="10103">  <div class="votes">
    <div id="Vu10103">
    <a href="/manual/vote-note.php?id=10103&amp;page=function.odbc-longreadlen&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd10103">
    <a href="/manual/vote-note.php?id=10103&amp;page=function.odbc-longreadlen&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V10103" title="no votes...">
    0
    </div>
  </div>
  <a href="#10103" class="name">
  <strong class="user"><em>jasendorf at lcounty dot com</em></strong></a><a class="genanchor" href="#10103"> &para;</a><div class="date" title="2000-12-13 04:26"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom10103">
<div class="phpcode"><code><span class="html">I had a heck of a time figuring out what to do with this function.  Here's a little piece of code from Jason Lee which I found that might help someone else...
<br />
...
<br />/* etc... */ 
<br />
<br />Hope this helps someone, John</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.odbc-longreadlen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-longreadlen.php">＋<small>add a note</small></a></div>
