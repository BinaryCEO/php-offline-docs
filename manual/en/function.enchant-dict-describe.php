...
<head>
  ...
  <title>PHP: enchant_dict_describe - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.enchant-dict-describe.php">
 <link rel="shorturl" href="https://www.php.net/enchant-dict-describe">
 <link rel="alternate" href="https://www.php.net/enchant-dict-describe" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.enchant.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.enchant-dict-check.php">
 <link rel="next" href="https://www.php.net/manual/en/function.enchant-dict-get-error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.enchant-dict-describe.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.enchant-dict-describe.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.enchant-dict-describe.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.enchant-dict-describe.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.enchant-dict-describe.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.enchant-dict-describe.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.enchant-dict-describe.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.enchant-dict-describe.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.enchant-dict-describe.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.enchant-dict-describe.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.enchant-dict-describe.php" hreflang="zh">
...
<meta name="Description" content="Describes an individual dictionary" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: enchant_dict_describe - Manual" />
<meta name="twitter:description" content="Describes an individual dictionary" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: enchant_dict_describe - Manual" />
<meta itemprop="description" content="Describes an individual dictionary" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Describes an individual dictionary" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.enchant-dict-get-error.php">
          enchant_dict_get_error &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.enchant-dict-check.php">
          &laquo; enchant_dict_check        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.enchant-dict-describe.php' selected="selected">English</option>
            <option value='de/function.enchant-dict-describe.php'>German</option>
            <option value='es/function.enchant-dict-describe.php'>Spanish</option>
            <option value='fr/function.enchant-dict-describe.php'>French</option>
            <option value='it/function.enchant-dict-describe.php'>Italian</option>
            <option value='ja/function.enchant-dict-describe.php'>Japanese</option>
            <option value='pt_BR/function.enchant-dict-describe.php'>Brazilian Portuguese</option>
            <option value='ru/function.enchant-dict-describe.php'>Russian</option>
            <option value='tr/function.enchant-dict-describe.php'>Turkish</option>
            <option value='uk/function.enchant-dict-describe.php'>Ukrainian</option>
            <option value='zh/function.enchant-dict-describe.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.enchant-dict-describe" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">enchant_dict_describe</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL enchant &gt;= 0.1.0 )</p><p class="refpurpose"><span class="refname">enchant_dict_describe</span> &mdash; <span class="dc-title">Describes an individual dictionary</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.enchant-dict-describe-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>enchant_dict_describe</strong></span>(<span class="methodparam"><span class="type"><a href="class.enchantdictionary.php" class="type EnchantDictionary">EnchantDictionary</a></span> <code class="parameter">$dictionary</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 changelog" id="refsect1-function.enchant-dict-describe-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.enchant-dict-describe-examples">
  ...
  <div class="example" id="example-2457">
   ...
   <div class="example-contents"><p>
    ...
    <span class="function"><a href="function.enchant-broker-dict-exists.php" class="function">enchant_broker_dict_exists()</a></span> and show the detail of it.
   </p></div>
...
(
    ...
    [file] =&gt; /usr/lib/enchant/libenchant_aspell.so
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/enchant/functions/enchant-dict-describe.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.enchant-dict-describe%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.enchant-dict-describe&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.enchant-dict-describe.php">＋<small>add a note</small></a></span>
