...
<head>
  ...
  <title>PHP: ps_hyphenate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-hyphenate.php">
 <link rel="shorturl" href="https://www.php.net/ps-hyphenate">
 <link rel="alternate" href="https://www.php.net/ps-hyphenate" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-get-value.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-include-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-hyphenate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-hyphenate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-hyphenate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-hyphenate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-hyphenate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-hyphenate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-hyphenate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-hyphenate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-hyphenate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-hyphenate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-hyphenate.php" hreflang="zh">
...
<meta name="Description" content="Hyphenates a word" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_hyphenate - Manual" />
<meta name="twitter:description" content="Hyphenates a word" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_hyphenate - Manual" />
<meta itemprop="description" content="Hyphenates a word" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Hyphenates a word" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-include-file.php">
          ps_include_file &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-get-value.php">
          &laquo; ps_get_value        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-hyphenate.php' selected="selected">English</option>
            <option value='de/function.ps-hyphenate.php'>German</option>
            <option value='es/function.ps-hyphenate.php'>Spanish</option>
            <option value='fr/function.ps-hyphenate.php'>French</option>
            <option value='it/function.ps-hyphenate.php'>Italian</option>
            <option value='ja/function.ps-hyphenate.php'>Japanese</option>
            <option value='pt_BR/function.ps-hyphenate.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-hyphenate.php'>Russian</option>
            <option value='tr/function.ps-hyphenate.php'>Turkish</option>
            <option value='uk/function.ps-hyphenate.php'>Ukrainian</option>
            <option value='zh/function.ps-hyphenate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-hyphenate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_hyphenate</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.1)</p><p class="refpurpose"><span class="refname">ps_hyphenate</span> &mdash; <span class="dc-title">Hyphenates a word</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ps-hyphenate-description">
  ...
  <p class="para rdfs-comment">
   ...
   value hyphenminchars (set by <span class="function"><a href="function.ps-set-value.php" class="function">ps_set_value()</a></span>) and
   the parameter hyphendict (set by <span class="function"><a href="function.ps-set-parameter.php" class="function">ps_set_parameter()</a></span>).
   hyphendict must be set before calling this function.
  </p>
  <p class="para">
   This function requires the locale category <strong><code><a href="string.constants.php#constant.lc-ctype">LC_CTYPE</a></code></strong> to be set properly.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-hyphenate-returnvalues">
  ...
  <p class="para">
   ...
   the text  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.ps-hyphenate-examples">
  ...
  <p class="para">
   <div class="example" id="example-3465">
   ...
   <ul class="simplelist">
    ...
    <li>locale(1)</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-hyphenate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-hyphenate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-hyphenate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-hyphenate.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120188">  <div class="votes">
    <div id="Vu120188">
    <a href="/manual/vote-note.php?id=120188&amp;page=function.ps-hyphenate&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120188">
    <a href="/manual/vote-note.php?id=120188&amp;page=function.ps-hyphenate&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120188" title="100% like this...">
    1
    </div>
  </div>
  <a href="#120188" class="name">
  <strong class="user"><em>1manfactory at gmail dot com</em></strong></a><a class="genanchor" href="#120188"> &para;</a><div class="date" title="2016-11-19 05:28"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120188">
<div class="phpcode"><code><span class="html">The above example does NOT work with German Umlauts (äöü) properly.<br /><br />I had to do the following to make it work.<br /><br />setlocale (LC_CTYPE , "de_DE.iso88591"); # it does not work with "de_DE.utf8" and of course your system should run this locale setting<br /><br />$hyphens = ps_hyphenate($psdoc, utf8_decode($word)); # only our couse if your source code is UTF8 coded<br /><br />for($i=0; $i&lt;mb_strlen($word); $i++) { # to be on the safe side<br /><br />echo utf8_encode($word[$i]); # again only if your code is UTF8</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ps-hyphenate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-hyphenate.php">＋<small>add a note</small></a></div>
