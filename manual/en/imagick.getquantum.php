...
<head>
  ...
  <title>PHP: Imagick::getQuantum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getquantum.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getquantum.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getquantum.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getpointsize.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getquantumdepth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getquantum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getquantum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getquantum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getquantum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getquantum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getquantum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getquantum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getquantum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getquantum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getquantum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getquantum.php" hreflang="zh">
...
<meta name="Description" content="Returns the ImageMagick quantum range" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getQuantum - Manual" />
<meta name="twitter:description" content="Returns the ImageMagick quantum range" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getQuantum - Manual" />
<meta itemprop="description" content="Returns the ImageMagick quantum range" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the ImageMagick quantum range" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getquantumdepth.php">
          Imagick::getQuantumDepth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getpointsize.php">
          &laquo; Imagick::getPointSize        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getquantum.php' selected="selected">English</option>
            <option value='de/imagick.getquantum.php'>German</option>
            <option value='es/imagick.getquantum.php'>Spanish</option>
            <option value='fr/imagick.getquantum.php'>French</option>
            <option value='it/imagick.getquantum.php'>Italian</option>
            <option value='ja/imagick.getquantum.php'>Japanese</option>
            <option value='pt_BR/imagick.getquantum.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getquantum.php'>Russian</option>
            <option value='tr/imagick.getquantum.php'>Turkish</option>
            <option value='uk/imagick.getquantum.php'>Ukrainian</option>
            <option value='zh/imagick.getquantum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getquantum" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getQuantum</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::getQuantum</span> &mdash; <span class="dc-title">Returns the ImageMagick quantum range</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getquantum-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::getQuantum</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getquantum-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getquantum-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getquantum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getquantum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getquantum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getquantum.php">＋<small>add a note</small></a></span>
