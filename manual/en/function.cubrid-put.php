...
<head>
  ...
  <title>PHP: cubrid_put - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-put.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-put">
 <link rel="alternate" href="https://www.php.net/cubrid-put" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-prepare.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-rollback.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-put.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-put.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-put.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-put.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-put.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-put.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-put.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-put.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-put.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-put.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-put.php" hreflang="zh">
...
<meta name="Description" content="Update a column using OID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_put - Manual" />
<meta name="twitter:description" content="Update a column using OID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_put - Manual" />
<meta itemprop="description" content="Update a column using OID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Update a column using OID" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-rollback.php">
          cubrid_rollback &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-prepare.php">
          &laquo; cubrid_prepare        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-put.php' selected="selected">English</option>
            <option value='de/function.cubrid-put.php'>German</option>
            <option value='es/function.cubrid-put.php'>Spanish</option>
            <option value='fr/function.cubrid-put.php'>French</option>
            <option value='it/function.cubrid-put.php'>Italian</option>
            <option value='ja/function.cubrid-put.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-put.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-put.php'>Russian</option>
            <option value='tr/function.cubrid-put.php'>Turkish</option>
            <option value='uk/function.cubrid-put.php'>Ukrainian</option>
            <option value='zh/function.cubrid-put.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-put" class="refentry">
...
<div class="refsect1 parameters" id="refsect1-function.cubrid-put-parameters">
  ...
  <dl>
    ...
    <dd><p class="para">OID of the instance that you want to update.</p></dd>
   
   
    <dt><code class="parameter">attr</code></dt>
    <dd><p class="para">Name of the attribute that you want to update.</p></dd>
   
   
    <dt><code class="parameter">value</code></dt>
    <dd><p class="para">New value that you want to assign to the attribute.</p></dd>
   ...
   <ul class="simplelist"> 
    ...
    <li><span class="function"><a href="function.cubrid-seq-put.php" class="function" rel="rdfs-seeAlso">cubrid_seq_put()</a> - Update the element value of sequence type column using OID</span></li>  
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-put.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-put%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-put&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-put.php">＋<small>add a note</small></a></span>
