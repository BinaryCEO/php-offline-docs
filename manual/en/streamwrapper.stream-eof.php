...
<head>
  ...
  <title>PHP: streamWrapper::stream_eof - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/streamwrapper.stream-eof.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/streamwrapper.stream-eof.php">
 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.stream-eof.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.streamwrapper.php">
 <link rel="prev" href="https://www.php.net/manual/en/streamwrapper.stream-close.php">
 <link rel="next" href="https://www.php.net/manual/en/streamwrapper.stream-flush.php">

 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.stream-eof.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/streamwrapper.stream-eof.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/streamwrapper.stream-eof.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/streamwrapper.stream-eof.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/streamwrapper.stream-eof.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/streamwrapper.stream-eof.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/streamwrapper.stream-eof.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/streamwrapper.stream-eof.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/streamwrapper.stream-eof.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/streamwrapper.stream-eof.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/streamwrapper.stream-eof.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: streamWrapper::stream_eof - Manual" />
<meta name="twitter:description" content="Tests for end-of-file on a file pointer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: streamWrapper::stream_eof - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="streamwrapper.stream-flush.php">
          streamWrapper::stream_flush &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="streamwrapper.stream-close.php">
          &laquo; streamWrapper::stream_close        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/streamwrapper.stream-eof.php' selected="selected">English</option>
            <option value='de/streamwrapper.stream-eof.php'>German</option>
            <option value='es/streamwrapper.stream-eof.php'>Spanish</option>
            <option value='fr/streamwrapper.stream-eof.php'>French</option>
            <option value='it/streamwrapper.stream-eof.php'>Italian</option>
            <option value='ja/streamwrapper.stream-eof.php'>Japanese</option>
            <option value='pt_BR/streamwrapper.stream-eof.php'>Brazilian Portuguese</option>
            <option value='ru/streamwrapper.stream-eof.php'>Russian</option>
            <option value='tr/streamwrapper.stream-eof.php'>Turkish</option>
            <option value='uk/streamwrapper.stream-eof.php'>Ukrainian</option>
            <option value='zh/streamwrapper.stream-eof.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="streamwrapper.stream-eof" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.feof.php" class="function" rel="rdfs-seeAlso">feof()</a> - Tests for end-of-file on a file pointer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/streamwrapper/stream-eof.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fstreamwrapper.stream-eof%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=streamwrapper.stream-eof&amp;repo=en&amp;redirect=https://www.php.net/manual/en/streamwrapper.stream-eof.php">＋<small>add a note</small></a></span>
