...
<head>
  ...
  <title>PHP: XML Element Structure Example - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/example.xml-structure.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/example.xml-structure.php">
 <link rel="alternate" href="https://www.php.net/manual/en/example.xml-structure.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/xml.examples.php">
 <link rel="prev" href="https://www.php.net/manual/en/xml.examples.php">
 <link rel="next" href="https://www.php.net/manual/en/example.xml-map-tags.php">

 <link rel="alternate" href="https://www.php.net/manual/en/example.xml-structure.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/example.xml-structure.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/example.xml-structure.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/example.xml-structure.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/example.xml-structure.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/example.xml-structure.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/example.xml-structure.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/example.xml-structure.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/example.xml-structure.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/example.xml-structure.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/example.xml-structure.php" hreflang="zh">
...
<meta name="Description" content="XML Element Structure Example" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: XML Element Structure Example - Manual" />
<meta name="twitter:description" content="XML Element Structure Example" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: XML Element Structure Example - Manual" />
<meta itemprop="description" content="XML Element Structure Example" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="XML Element Structure Example" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/example.xml-structure.php' selected="selected">English</option>
            <option value='de/example.xml-structure.php'>German</option>
            <option value='es/example.xml-structure.php'>Spanish</option>
            <option value='fr/example.xml-structure.php'>French</option>
            <option value='it/example.xml-structure.php'>Italian</option>
            <option value='ja/example.xml-structure.php'>Japanese</option>
            <option value='pt_BR/example.xml-structure.php'>Brazilian Portuguese</option>
            <option value='ru/example.xml-structure.php'>Russian</option>
            <option value='tr/example.xml-structure.php'>Turkish</option>
            <option value='uk/example.xml-structure.php'>Ukrainian</option>
            <option value='zh/example.xml-structure.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="example.xml-structure" class="section">
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$file </span><span style="color: #007700">= </span><span style="color: #DD0000">"examples/book.xml"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$depth </span><span style="color: #007700">= </span><span style="color: #0000BB">0</span><span style="color: #007700">;<br /><br />function </span><span style="color: #0000BB">startElement</span><span style="color: #007700">(</span><span style="color: #0000BB">$parser</span><span style="color: #007700">, </span><span style="color: #0000BB">$name</span><span style="color: #007700">, </span><span style="color: #0000BB">$attrs</span><span style="color: #007700">)<br />{<br />    global </span><span style="color: #0000BB">$depth</span><span style="color: #007700">;<br /><br />    for (</span><span style="color: #0000BB">$i </span><span style="color: #007700">= </span><span style="color: #0000BB">0</span><span style="color: #007700">; </span><span style="color: #0000BB">$i </span><span style="color: #007700">&lt; </span><span style="color: #0000BB">$depth</span><span style="color: #007700">; </span><span style="color: #0000BB">$i</span><span style="color: #007700">++) {<br />        echo </span><span style="color: #DD0000">"  "</span><span style="color: #007700">;<br />    }<br />    echo </span><span style="color: #DD0000">"</span><span style="color: #0000BB">$name</span><span style="color: #DD0000">\n"</span><span style="color: #007700">;<br />    </span><span style="color: #0000BB">$depth</span><span style="color: #007700">++;<br />}<br /><br />function </span><span style="color: #0000BB">endElement</span><span style="color: #007700">(</span><span style="color: #0000BB">$parser</span><span style="color: #007700">, </span><span style="color: #0000BB">$name</span><span style="color: #007700">)<br />{<br />    global </span><span style="color: #0000BB">$depth</span><span style="color: #007700">;<br />    </span><span style="color: #0000BB">$depth</span><span style="color: #007700">--;<br />}<br /><br /></span><span style="color: #0000BB">$xml_parser </span><span style="color: #007700">= </span><span style="color: #0000BB">xml_parser_create</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">xml_set_element_handler</span><span style="color: #007700">(</span><span style="color: #0000BB">$xml_parser</span><span style="color: #007700">, </span><span style="color: #DD0000">"startElement"</span><span style="color: #007700">, </span><span style="color: #DD0000">"endElement"</span><span style="color: #007700">);<br />if (!(</span><span style="color: #0000BB">$fp </span><span style="color: #007700">= </span><span style="color: #0000BB">fopen</span><span style="color: #007700">(</span><span style="color: #0000BB">$file</span><span style="color: #007700">, </span><span style="color: #DD0000">"r"</span><span style="color: #007700">))) {<br />    die(</span><span style="color: #DD0000">"could not open XML input"</span><span style="color: #007700">);<br />}<br /><br />while (</span><span style="color: #0000BB">$data </span><span style="color: #007700">= </span><span style="color: #0000BB">fread</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">, </span><span style="color: #0000BB">4096</span><span style="color: #007700">)) {<br />    if (!</span><span style="color: #0000BB">xml_parse</span><span style="color: #007700">(</span><span style="color: #0000BB">$xml_parser</span><span style="color: #007700">, </span><span style="color: #0000BB">$data</span><span style="color: #007700">, </span><span style="color: #0000BB">feof</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">))) {<br />        die(</span><span style="color: #0000BB">sprintf</span><span style="color: #007700">(</span><span style="color: #DD0000">"XML error: %s at line %d"</span><span style="color: #007700">,<br />                    </span><span style="color: #0000BB">xml_error_string</span><span style="color: #007700">(</span><span style="color: #0000BB">xml_get_error_code</span><span style="color: #007700">(</span><span style="color: #0000BB">$xml_parser</span><span style="color: #007700">)),<br />                    </span><span style="color: #0000BB">xml_get_current_line_number</span><span style="color: #007700">(</span><span style="color: #0000BB">$xml_parser</span><span style="color: #007700">)));<br />    }<br />}<br /></span><span style="color: #0000BB">xml_parser_free</span><span style="color: #007700">(</span><span style="color: #0000BB">$xml_parser</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fexample.xml-structure%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=example.xml-structure&amp;repo=en&amp;redirect=https://www.php.net/manual/en/example.xml-structure.php">＋<small>add a note</small></a></span>
