...
<div class="phpcode"><code><span class="html">Don't forget that fromDateTime() doesn't set any locale and that the default one will be set. In my case it was en_US_POSIX.<br /><br />If you wan't to create a IntlCalendar object containing the values of a DateTime object with your locale, use createInstance() instead and do a <br /><br /><span class="default">&lt;?php<br />$intlCalendar</span><span class="keyword">-&gt;</span><span class="default">setTime</span><span class="keyword">(</span><span class="default">$dateTime</span><span class="keyword">-&gt;</span><span class="default">getTimestamp</span><span class="keyword">() * </span><span class="default">1000</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />IntlCalendar works with milliseconds so you need to multiply the timestamp with 1000.<br /><br />Using fromDateTime() can cause unwanted behaviour like getFirstDayOfWeek() returning a wrong integer.</span></code></div>
  </div>
 </div></div>
