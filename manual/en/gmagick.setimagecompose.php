...
<head>
  ...
  <title>PHP: Gmagick::setimagecompose - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagecompose.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagecompose.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagecompose.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimagecolorspace.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagedelay.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagecompose.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimagecompose.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimagecompose.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimagecompose.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimagecompose.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimagecompose.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimagecompose.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimagecompose.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimagecompose.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimagecompose.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimagecompose.php" hreflang="zh">
...
<meta name="Description" content="Sets the image composite operator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::setimagecompose - Manual" />
<meta name="twitter:description" content="Sets the image composite operator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimagecompose - Manual" />
<meta itemprop="description" content="Sets the image composite operator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image composite operator" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.setimagedelay.php">
          Gmagick::setimagedelay &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimagecolorspace.php">
          &laquo; Gmagick::setimagecolorspace        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagecompose.php' selected="selected">English</option>
            <option value='de/gmagick.setimagecompose.php'>German</option>
            <option value='es/gmagick.setimagecompose.php'>Spanish</option>
            <option value='fr/gmagick.setimagecompose.php'>French</option>
            <option value='it/gmagick.setimagecompose.php'>Italian</option>
            <option value='ja/gmagick.setimagecompose.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimagecompose.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimagecompose.php'>Russian</option>
            <option value='tr/gmagick.setimagecompose.php'>Turkish</option>
            <option value='uk/gmagick.setimagecompose.php'>Ukrainian</option>
            <option value='zh/gmagick.setimagecompose.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimagecompose" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimagecompose</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimagecompose</span> &mdash; <span class="dc-title">Sets the image composite operator</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimagecompose-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimagecompose</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$composite</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimagecompose-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimagecompose-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimagecompose-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagecompose.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagecompose%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagecompose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagecompose.php">＋<small>add a note</small></a></span>
