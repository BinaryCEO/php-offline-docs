...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getstatsfacets.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getstatsfacets.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getstatsfacets.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getstats.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getstatsfields.php">
...
<meta name="Description" content="Returns all the stats facets that were set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getStatsFacets - Manual" />
<meta name="twitter:description" content="Returns all the stats facets that were set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getStatsFacets - Manual" />
<meta itemprop="description" content="Returns all the stats facets that were set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns all the stats facets that were set" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getstatsfacets.php' selected="selected">English</option>
            ...
            <option value='ru/solrquery.getstatsfacets.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getStatsFacets</span> &mdash; <span class="dc-title">Returns all the stats facets that were set</span></p>
...
Returns an array on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getstatsfacets.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getstatsfacets%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getstatsfacets&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getstatsfacets.php">＋<small>add a note</small></a></span>
