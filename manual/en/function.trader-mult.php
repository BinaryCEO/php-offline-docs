...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-mult.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-mom.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-natr.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-mult.php' selected="selected">English</option>
            ...
            <option value='tr/function.trader-mult.php'>Turkish</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-mult-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-mult.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-mult%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-mult&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-mult.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php <br /><br />$result </span><span class="keyword">= </span><span class="default">trader_mult</span><span class="keyword">([</span><span class="default">1</span><span class="keyword">,</span><span class="default">2</span><span class="keyword">,</span><span class="default">3</span><span class="keyword">,</span><span class="default">4</span><span class="keyword">,</span><span class="default">5</span><span class="keyword">], [</span><span class="default">6</span><span class="keyword">,</span><span class="default">7</span><span class="keyword">,</span><span class="default">8</span><span class="keyword">,</span><span class="default">9</span><span class="keyword">,</span><span class="default">10</span><span class="keyword">]);<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">);<br /></span><span class="comment">/*<br />array(5) {<br />  [0]=&gt;<br />  float(6)  // 1 * 6<br />  [1]=&gt;<br />  float(14) // 2 * 7<br />  [2]=&gt;<br />  float(24) // 3 * 8<br />  [3]=&gt;<br />  float(36) // 4 * 9<br />  [4]=&gt;<br />  float(50) // 5 * 10<br />}<br />*/</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-mult&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-mult.php">＋<small>add a note</small></a></div>
