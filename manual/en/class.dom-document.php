...
<head>
  ...
  <title>PHP: Dom\Document - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-document.php">
 <link rel="shorturl" href="https://www.php.net/dom-document">
 <link rel="alternate" href="https://www.php.net/dom-document" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-comment.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-documentfragment.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-document.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-document.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-document.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-document.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-document.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-document.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-document.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-document.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-document.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-document.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-document.php" hreflang="zh">
...
<meta name="Description" content="The Dom\Document class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\Document - Manual" />
<meta name="twitter:description" content="The Dom\Document class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\Document - Manual" />
<meta itemprop="description" content="The Dom\Document class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\Document class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.dom-documentfragment.php">
          Dom\DocumentFragment &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dom-comment.php">
          &laquo; Dom\Comment        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-document.php' selected="selected">English</option>
            <option value='de/class.dom-document.php'>German</option>
            <option value='es/class.dom-document.php'>Spanish</option>
            <option value='fr/class.dom-document.php'>French</option>
            <option value='it/class.dom-document.php'>Italian</option>
            <option value='ja/class.dom-document.php'>Japanese</option>
            <option value='pt_BR/class.dom-document.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-document.php'>Russian</option>
            <option value='tr/class.dom-document.php'>Turkish</option>
            <option value='uk/class.dom-document.php'>Ukrainian</option>
            <option value='zh/class.dom-document.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-document" class="reference">
 <h1 class="title">The Dom\Document class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-document.intro">
   ...
   <p class="simpara">
    ...
    It is the base class for <span class="classname"><a href="class.dom-xmldocument.php" class="classname">Dom\XMLDocument</a></span>
    and <span class="classname"><a href="class.dom-htmldocument.php" class="classname">Dom\HTMLDocument</a></span>.
   </p>
  </div>

  <div class="section" id="dom-document.synopsis">
   <h2 class="title">Class synopsis</h2>

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">abstract</span>
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\Document</strong></strong>
     ...
     <span class="modifier">implements</span>
      <a href="class.dom-parentnode.php" class="interfacename">Dom\ParentNode</a> {</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
  ...
  <div class="section" id="dom-document.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-document.props.implementation"><var class="varname">implementation</var></dt><dd>
      <p class="para">
     ...
     <dt id="dom-document.props.doctype"><var class="varname">doctype</var></dt><dd>
      <p class="para">The Document Type Declaration associated with this document.</p>
     </dd>
    
    
     <dt id="dom-document.props.url"><var class="varname">URL</var></dt>
     <dd>
      <span class="simpara">Equivalent to <var class="varname">documentURI</var>.</span>
     </dd>
    
    
     <dt id="dom-document.props.characterset"><var class="varname">characterSet</var></dt>
     <dd>
      <span class="simpara">
     ...
     <dt id="dom-document.props.inputencoding"><var class="varname">inputEncoding</var></dt>
     <dd>
      <span class="simpara">Legacy alias for <var class="varname">characterSet</var>.</span>
     </dd>
    
    
     <dt id="dom-document.props.charset"><var class="varname">charset</var></dt>
     <dd>
      <span class="simpara">Legacy alias for <var class="varname">characterSet</var>.</span>
     </dd>
    
    
     <dt id="dom-document.props.documenturi"><var class="varname">documentURI</var></dt><dd>
     ...
     <dt id="dom-document.props.documentelement"><var class="varname">documentElement</var></dt>
     <dd>
      <span class="simpara">
       The <span class="classname"><a href="class.dom-element.php" class="classname">Dom\Element</a></span> that is the document element.
       This evaluates to <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> for document without elements.
      </span>
     </dd>
    
    
     <dt id="dom-document.props.firstelementchild"><var class="varname">firstElementChild</var></dt><dd>
      <p class="para">First child element or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.</p>
     </dd>
    
    
     <dt id="dom-document.props.lastelementchild"><var class="varname">lastElementChild</var></dt><dd>
      <p class="para">Last child element or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.</p>
     </dd>
    
    
     <dt id="dom-document.props.childelementcount"><var class="varname">childElementCount</var></dt><dd>
      <p class="para">The number of child elements.</p>
     </dd>
    
    
     <dt id="dom-document.props.body"><var class="varname">body</var></dt>
     <dd>
      <span class="simpara">
       The first child of the <code class="literal">html</code> element that is either a
       <code class="literal">body</code> tag or a <code class="literal">frameset</code> tag.
       These need to be in the HTML namespace.
       If no element matches, this evaluates to <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.
      </span>
     </dd>
    
    
     <dt id="dom-document.props.head"><var class="varname">head</var></dt>
     <dd>
      <span class="simpara">
       The first <code class="literal">head</code> element that is a child of the
       <code class="literal">html</code> element.
       These need to be in the HTML namespace.
       If no element matches, this evaluates to <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.
      </span>
     </dd>
     ...
     <dt id="dom-document.props.title"><var class="varname">title</var></dt>
     <dd>
      <span class="simpara">
       The title of the document as set by the <code class="literal">title</code>
       element for HTML or the SVG <code class="literal">title</code> element for SVG.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-document.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-document%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-document&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-document.php">＋<small>add a note</small></a></span>
