...
<head>
  ...
  <title>PHP: stream_context_get_params - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-context-get-params.php">
 <link rel="shorturl" href="https://www.php.net/stream-context-get-params">
 <link rel="alternate" href="https://www.php.net/stream-context-get-params" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-context-get-options.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-context-set-default.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-context-get-params.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-context-get-params.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-context-get-params.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-context-get-params.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-context-get-params.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-context-get-params.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-context-get-params.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-context-get-params.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-context-get-params.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-context-get-params.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-context-get-params.php" hreflang="zh">
...
<meta name="Description" content="Retrieves parameters from a context" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_context_get_params - Manual" />
<meta name="twitter:description" content="Retrieves parameters from a context" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_context_get_params - Manual" />
<meta itemprop="description" content="Retrieves parameters from a context" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieves parameters from a context" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stream-context-set-default.php">
          stream_context_set_default &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-context-get-options.php">
          &laquo; stream_context_get_options        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-context-get-params.php' selected="selected">English</option>
            <option value='de/function.stream-context-get-params.php'>German</option>
            <option value='es/function.stream-context-get-params.php'>Spanish</option>
            <option value='fr/function.stream-context-get-params.php'>French</option>
            <option value='it/function.stream-context-get-params.php'>Italian</option>
            <option value='ja/function.stream-context-get-params.php'>Japanese</option>
            <option value='pt_BR/function.stream-context-get-params.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-context-get-params.php'>Russian</option>
            <option value='tr/function.stream-context-get-params.php'>Turkish</option>
            <option value='uk/function.stream-context-get-params.php'>Ukrainian</option>
            <option value='zh/function.stream-context-get-params.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-context-get-params" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stream_context_get_params</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_context_get_params</span> &mdash; <span class="dc-title">Retrieves parameters from a context</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.stream-context-get-params-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stream_context_get_params</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$context</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stream-context-get-params-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       A stream <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> or a
       <a href="context.php" class="link">context</a> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>
      </p>
     </dd>
 ...
 <div class="refsect1 seealso" id="refsect1-function.stream-context-get-params-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.stream-context-set-params.php" class="function" rel="rdfs-seeAlso">stream_context_set_params()</a> - Set parameters for a stream/wrapper/context</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-context-get-params.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-context-get-params%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-context-get-params&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-context-get-params.php">＋<small>add a note</small></a></span>
