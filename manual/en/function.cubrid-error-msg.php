...
<head>
  ...
  <title>PHP: cubrid_error_msg - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-error-msg.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-error-msg">
 <link rel="alternate" href="https://www.php.net/cubrid-error-msg" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-error-code-facility.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-execute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-error-msg.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-error-msg.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-error-msg.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-error-msg.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-error-msg.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-error-msg.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-error-msg.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-error-msg.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-error-msg.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-error-msg.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-error-msg.php" hreflang="zh">
...
<meta name="Description" content="Get last error message for the most recent function call" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_error_msg - Manual" />
<meta name="twitter:description" content="Get last error message for the most recent function call" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_error_msg - Manual" />
<meta itemprop="description" content="Get last error message for the most recent function call" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get last error message for the most recent function call" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-execute.php">
          cubrid_execute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-error-code-facility.php">
          &laquo; cubrid_error_code_facility        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-error-msg.php' selected="selected">English</option>
            <option value='de/function.cubrid-error-msg.php'>German</option>
            <option value='es/function.cubrid-error-msg.php'>Spanish</option>
            <option value='fr/function.cubrid-error-msg.php'>French</option>
            <option value='it/function.cubrid-error-msg.php'>Italian</option>
            <option value='ja/function.cubrid-error-msg.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-error-msg.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-error-msg.php'>Russian</option>
            <option value='tr/function.cubrid-error-msg.php'>Turkish</option>
            <option value='uk/function.cubrid-error-msg.php'>Ukrainian</option>
            <option value='zh/function.cubrid-error-msg.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-error-msg" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_error_msg</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_error_msg</span> &mdash; <span class="dc-title">Get last error message for the most recent function call</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-error-msg-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_error_msg</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_error_msg()</strong></span> function is used to get the
 ...
 <div class="refsect1 parameters" id="refsect1-function.cubrid-error-msg-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-error-msg-returnvalues">
...
Error msg: Invalid T_CCI_SCH_TYPE value</pre>
  ...
  <div class="refsect1 seealso" id="refsect1-function.cubrid-error-msg-seealso">
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-error-code-facility.php" class="function" rel="rdfs-seeAlso">cubrid_error_code_facility()</a> - Get the facility code of error</span></li>
   </ul>
  </p>
  </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-error-msg.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-error-msg%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-error-msg&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-error-msg.php">＋<small>add a note</small></a></span>
