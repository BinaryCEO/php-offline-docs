...
<head>
  ...
  <title>PHP: Imagick::getGravity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getgravity.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getgravity.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getgravity.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getformat.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.gethomeurl.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getgravity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getgravity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getgravity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getgravity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getgravity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getgravity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getgravity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getgravity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getgravity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getgravity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getgravity.php" hreflang="zh">
...
<meta name="Description" content="Gets the gravity" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getGravity - Manual" />
<meta name="twitter:description" content="Gets the gravity" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getGravity - Manual" />
<meta itemprop="description" content="Gets the gravity" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the gravity" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.gethomeurl.php">
          Imagick::getHomeURL &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getformat.php">
          &laquo; Imagick::getFormat        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getgravity.php' selected="selected">English</option>
            <option value='de/imagick.getgravity.php'>German</option>
            <option value='es/imagick.getgravity.php'>Spanish</option>
            <option value='fr/imagick.getgravity.php'>French</option>
            <option value='it/imagick.getgravity.php'>Italian</option>
            <option value='ja/imagick.getgravity.php'>Japanese</option>
            <option value='pt_BR/imagick.getgravity.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getgravity.php'>Russian</option>
            <option value='tr/imagick.getgravity.php'>Turkish</option>
            <option value='uk/imagick.getgravity.php'>Ukrainian</option>
            <option value='zh/imagick.getgravity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getgravity" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getGravity</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getGravity</span> &mdash; <span class="dc-title">Gets the gravity</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getgravity-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getGravity</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getgravity-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getgravity-returnvalues">
  ...
  <p class="para">
   ...
   <a href="imagick.constants.php#imagick.constants.gravity" class="link">gravity constants</a>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getgravity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getgravity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getgravity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getgravity.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128471">  <div class="votes">
    <div id="Vu128471">
    <a href="/manual/vote-note.php?id=128471&amp;page=imagick.getgravity&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128471">
    <a href="/manual/vote-note.php?id=128471&amp;page=imagick.getgravity&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128471" title="no votes...">
    0
    </div>
  </div>
  <a href="#128471" class="name">
  <strong class="user"><em>Ahmad</em></strong></a><a class="genanchor" href="#128471"> &para;</a><div class="date" title="2023-05-10 10:50"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128471">
...
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getgravity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getgravity.php">＋<small>add a note</small></a></div>
