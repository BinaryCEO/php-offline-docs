...
<head>
  ...
  <title>PHP: mcrypt_module_get_algo_block_size - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-module-get-algo-block-size.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-module-get-algo-block-size">
 <link rel="alternate" href="https://www.php.net/mcrypt-module-get-algo-block-size" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-module-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-module-get-algo-key-size.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-module-get-algo-block-size.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-module-get-algo-block-size.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-module-get-algo-block-size.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-module-get-algo-block-size.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-module-get-algo-block-size.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-module-get-algo-block-size.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-module-get-algo-block-size.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-module-get-algo-block-size.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-module-get-algo-block-size.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-module-get-algo-block-size.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-module-get-algo-block-size.php" hreflang="zh">
...
<meta name="Description" content="Returns the blocksize of the specified algorithm" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_module_get_algo_block_size - Manual" />
<meta name="twitter:description" content="Returns the blocksize of the specified algorithm" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_module_get_algo_block_size - Manual" />
<meta itemprop="description" content="Returns the blocksize of the specified algorithm" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the blocksize of the specified algorithm" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mcrypt-module-get-algo-key-size.php">
          mcrypt_module_get_algo_key_size &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-module-close.php">
          &laquo; mcrypt_module_close        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-module-get-algo-block-size.php' selected="selected">English</option>
            <option value='de/function.mcrypt-module-get-algo-block-size.php'>German</option>
            <option value='es/function.mcrypt-module-get-algo-block-size.php'>Spanish</option>
            <option value='fr/function.mcrypt-module-get-algo-block-size.php'>French</option>
            <option value='it/function.mcrypt-module-get-algo-block-size.php'>Italian</option>
            <option value='ja/function.mcrypt-module-get-algo-block-size.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-module-get-algo-block-size.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-module-get-algo-block-size.php'>Russian</option>
            <option value='tr/function.mcrypt-module-get-algo-block-size.php'>Turkish</option>
            <option value='uk/function.mcrypt-module-get-algo-block-size.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-module-get-algo-block-size.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-module-get-algo-block-size" class="refentry">
  ...
  <p class="para">
   Returns the block size of the algorithm specified in bytes.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-module-get-algo-block-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-module-get-algo-block-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-module-get-algo-block-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-module-get-algo-block-size.php">＋<small>add a note</small></a></span>
