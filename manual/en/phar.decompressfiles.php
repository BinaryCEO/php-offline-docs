...
<head>
  ...
  <title>PHP: Phar::decompressFiles - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.decompressfiles.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.decompressfiles.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.decompressfiles.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.decompress.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.delmetadata.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.decompressfiles.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.decompressfiles.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.decompressfiles.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.decompressfiles.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.decompressfiles.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.decompressfiles.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.decompressfiles.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.decompressfiles.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.decompressfiles.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.decompressfiles.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.decompressfiles.php" hreflang="zh">
...
<meta name="Description" content="Decompresses all files in the current Phar archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::decompressFiles - Manual" />
<meta name="twitter:description" content="Decompresses all files in the current Phar archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::decompressFiles - Manual" />
<meta itemprop="description" content="Decompresses all files in the current Phar archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decompresses all files in the current Phar archive" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.delmetadata.php">
          Phar::delMetadata &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.decompress.php">
          &laquo; Phar::decompress        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.decompressfiles.php' selected="selected">English</option>
            <option value='de/phar.decompressfiles.php'>German</option>
            <option value='es/phar.decompressfiles.php'>Spanish</option>
            <option value='fr/phar.decompressfiles.php'>French</option>
            <option value='it/phar.decompressfiles.php'>Italian</option>
            <option value='ja/phar.decompressfiles.php'>Japanese</option>
            <option value='pt_BR/phar.decompressfiles.php'>Brazilian Portuguese</option>
            <option value='ru/phar.decompressfiles.php'>Russian</option>
            <option value='tr/phar.decompressfiles.php'>Turkish</option>
            <option value='uk/phar.decompressfiles.php'>Ukrainian</option>
            <option value='zh/phar.decompressfiles.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.decompressfiles" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::decompressFiles</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">Phar::decompressFiles</span> &mdash; <span class="dc-title">Decompresses all files in the current Phar archive</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-phar.decompressfiles-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::decompressFiles</strong></span>(): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
 ...
 <div class="refsect1 parameters" id="refsect1-phar.decompressfiles-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-phar.decompressfiles-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-phar.decompressfiles-errors">
 ...
 <div class="refsect1 examples" id="refsect1-phar.decompressfiles-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-815">
    <p><strong>Example #1 A <span class="function"><strong>Phar::decompressFiles()</strong></span> example</strong></p>
...
bool(false)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-phar.decompressfiles-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.decompress.php" class="function" rel="rdfs-seeAlso">Phar::decompress()</a> - Decompresses the entire Phar archive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/decompressFiles.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.decompressfiles%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.decompressfiles&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.decompressfiles.php">＋<small>add a note</small></a></span>
