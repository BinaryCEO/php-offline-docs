...
<head>
  ...
  <title>PHP: IntlChar::isblank - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.isblank.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.isblank.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isblank.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.isbase.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.iscntrl.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isblank.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.isblank.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.isblank.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.isblank.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.isblank.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.isblank.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.isblank.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.isblank.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.isblank.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.isblank.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.isblank.php" hreflang="zh">
...
<meta name="Description" content="Check if code point is a &quot;blank&quot; or &quot;horizontal space&quot; character" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::isblank - Manual" />
<meta name="twitter:description" content="Check if code point is a &quot;blank&quot; or &quot;horizontal space&quot; character" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::isblank - Manual" />
<meta itemprop="description" content="Check if code point is a &quot;blank&quot; or &quot;horizontal space&quot; character" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if code point is a &quot;blank&quot; or &quot;horizontal space&quot; character" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.iscntrl.php">
          IntlChar::iscntrl &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.isbase.php">
          &laquo; IntlChar::isbase        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.isblank.php' selected="selected">English</option>
            <option value='de/intlchar.isblank.php'>German</option>
            <option value='es/intlchar.isblank.php'>Spanish</option>
            <option value='fr/intlchar.isblank.php'>French</option>
            <option value='it/intlchar.isblank.php'>Italian</option>
            <option value='ja/intlchar.isblank.php'>Japanese</option>
            <option value='pt_BR/intlchar.isblank.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.isblank.php'>Russian</option>
            <option value='tr/intlchar.isblank.php'>Turkish</option>
            <option value='uk/intlchar.isblank.php'>Ukrainian</option>
            <option value='zh/intlchar.isblank.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.isblank" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::isblank</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::isblank</span> &mdash; <span class="dc-title">Check if code point is a &quot;blank&quot; or &quot;horizontal space&quot; character</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlchar.isblank-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::isblank</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$codepoint</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>
  ...
  <p class="para">
   ...
   <ul class="simplelist">
    <li>
     <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> for Unicode White_Space characters except for "vertical space controls" where "vertical space controls" are
     the following characters: U+000A (LF) U+000B (VT) U+000C (FF) U+000D (CR) U+0085 (NEL) U+2028 (LS) U+2029 (PS)
    </li>
    <li>
     <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> for U+0009 (TAB) and characters with general category "Zs" (space separators) except Zero Width Space (ZWSP, U+200B).
    </li>
   </ul>
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.isblank-returnvalues">
  ...
  <p class="para">
   ...
   <code class="parameter">codepoint</code> is either a &quot;blank&quot; or &quot;horizontal space&quot; character, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not. Returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.iswhitespace.php" class="function" rel="rdfs-seeAlso">IntlChar::isWhitespace()</a> - Check if code point is a whitespace character according to ICU</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/isblank.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.isblank%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.isblank&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.isblank.php">＋<small>add a note</small></a></span>
