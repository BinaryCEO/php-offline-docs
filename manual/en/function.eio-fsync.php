...
<head>
  ...
  <title>PHP: eio_fsync - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-fsync.php">
 <link rel="shorturl" href="https://www.php.net/eio-fsync">
 <link rel="alternate" href="https://www.php.net/eio-fsync" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-fstatvfs.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-ftruncate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-fsync.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-fsync.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-fsync.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-fsync.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-fsync.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-fsync.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-fsync.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-fsync.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-fsync.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-fsync.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-fsync.php" hreflang="zh">
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.eio-ftruncate.php">
          eio_ftruncate &raquo;
              ...
              <div class="prev">
        <a href="function.eio-fstatvfs.php">
          &laquo; eio_fstatvfs        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-fsync.php' selected="selected">English</option>
            <option value='de/function.eio-fsync.php'>German</option>
            <option value='es/function.eio-fsync.php'>Spanish</option>
            <option value='fr/function.eio-fsync.php'>French</option>
            <option value='it/function.eio-fsync.php'>Italian</option>
            <option value='ja/function.eio-fsync.php'>Japanese</option>
            <option value='pt_BR/function.eio-fsync.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-fsync.php'>Russian</option>
            <option value='tr/function.eio-fsync.php'>Turkish</option>
            <option value='uk/function.eio-fsync.php'>Ukrainian</option>
            <option value='zh/function.eio-fsync.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-fsync" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_fsync</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_fsync</span> &mdash; <span class="dc-title">Synchronize a file&#039;s in-core state with storage device</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-fsync-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_fsync</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-fsync-parameters">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-fsync-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_fsync()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>



 <div class="refsect1 seealso" id="refsect1-function.eio-fsync-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-sync.php" class="function" rel="rdfs-seeAlso">eio_sync()</a> - Commit buffer cache to disk</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-fsync.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-fsync%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-fsync&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-fsync.php">＋<small>add a note</small></a></span>
