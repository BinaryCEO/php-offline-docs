...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sizeof.php">
 <link rel="shorturl" href="https://www.php.net/sizeof">
 <link rel="alternate" href="https://www.php.net/sizeof" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.shuffle.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sizeof.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sizeof.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sizeof.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sizeof.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sizeof.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sizeof.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sizeof.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sizeof.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sizeof.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sizeof.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sizeof.php" hreflang="zh">
...
<meta name="Description" content="Alias of count" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sizeof - Manual" />
<meta name="twitter:description" content="Alias of count" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sizeof - Manual" />
<meta itemprop="description" content="Alias of count" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of count" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sizeof.php' selected="selected">English</option>
            <option value='de/function.sizeof.php'>German</option>
            <option value='es/function.sizeof.php'>Spanish</option>
            <option value='fr/function.sizeof.php'>French</option>
            <option value='it/function.sizeof.php'>Italian</option>
            <option value='ja/function.sizeof.php'>Japanese</option>
            <option value='pt_BR/function.sizeof.php'>Brazilian Portuguese</option>
            <option value='ru/function.sizeof.php'>Russian</option>
            <option value='tr/function.sizeof.php'>Turkish</option>
            <option value='uk/function.sizeof.php'>Ukrainian</option>
            <option value='zh/function.sizeof.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sizeof" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sizeof</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">sizeof</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.count.php" class="function">count()</a></span></span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.sizeof-description">
  ...
  <p class="simpara">
   ...
   <span class="function"><a href="function.count.php" class="function">count()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/sizeof.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sizeof%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sizeof&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sizeof.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="85892">  <div class="votes">
    <div id="Vu85892">
    <a href="/manual/vote-note.php?id=85892&amp;page=function.sizeof&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd85892">
    <a href="/manual/vote-note.php?id=85892&amp;page=function.sizeof&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V85892" title="63% like this...">
    120
    </div>
  </div>
  <a href="#85892" class="name">
  <strong class="user"><em>PixEye</em></strong></a><a class="genanchor" href="#85892"> &para;</a><div class="date" title="2008-09-23 09:09"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom85892">
<div class="phpcode"><code><span class="html">I am quite surprised about previous posts. Here are my advices:<br /><br />1/ prefer the count() function instead of sizeOf() as sizeOf() is only an alias of count() and does not mean the same in many other languages based on C (avoid ambiguity).<br /><br />2/ prefer the powerful forEach() function to iterate over arrays.</span></code></div>
  </div>
 </div>
  <div class="note" id="113124">  <div class="votes">
    <div id="Vu113124">
    <a href="/manual/vote-note.php?id=113124&amp;page=function.sizeof&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113124">
    <a href="/manual/vote-note.php?id=113124&amp;page=function.sizeof&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113124" title="64% like this...">
    73
    </div>
  </div>
  <a href="#113124" class="name">
  <strong class="user"><em>chris at amis dot nl</em></strong></a><a class="genanchor" href="#113124"> &para;</a><div class="date" title="2013-09-02 09:15"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom113124">
<div class="phpcode"><code><span class="html">I would recommend not using sizeof(). Many programmers expect sizeof() to return the amount of memory allocated. Instead sizeof() -as described above- is an alias for count().<br /><br />Prevent misinterpretation and use count() instead.</span></code></div>
  </div>
 </div>
  <div class="note" id="82430">  <div class="votes">
    <div id="Vu82430">
    <a href="/manual/vote-note.php?id=82430&amp;page=function.sizeof&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd82430">
    <a href="/manual/vote-note.php?id=82430&amp;page=function.sizeof&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V82430" title="57% like this...">
    42
    </div>
  </div>
  <a href="#82430" class="name">
  <strong class="user"><em>communiti.ch</em></strong></a><a class="genanchor" href="#82430"> &para;</a><div class="date" title="2008-04-10 06:55"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom82430">
<div class="phpcode"><code><span class="html">If your array is "huge"<br /><br />It is reccomended to set a variable first for this case:<br /><br />THIS-&gt;<br /><br />$max = sizeof($huge_array);<br />for($i = 0; $i &lt; $max;$i++)<br />{<br />code...<br />}<br /><br />IS QUICKER THEN-&gt;<br /><br />for($i = 0; $i &lt; sizeof($huge_array);$i++)<br />{<br />code...<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="85899">  <div class="votes">
    <div id="Vu85899">
    <a href="/manual/vote-note.php?id=85899&amp;page=function.sizeof&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd85899">
    <a href="/manual/vote-note.php?id=85899&amp;page=function.sizeof&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V85899" title="57% like this...">
    20
    </div>
  </div>
  <a href="#85899" class="name">
  <strong class="user"><em>umopdn [at] msn [dawt] com</em></strong></a><a class="genanchor" href="#85899"> &para;</a><div class="date" title="2008-09-23 02:38"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom85899">
<div class="phpcode"><code><span class="html">a) Always try and use PHP's internal routines to iterate through objects of various types (arrays in most examples below).<br /><br />Instead of interpreting your code to loop through them, they use their own internal routines which are much faster.<br /><br />(This is why foreach () will run faster than manual interation)<br /><br />b) It is _always_ good practice to leave as many static resulting functions outside of loops, having operations that return the exact same piece of data every iteration of the loop is not pretty on resources.<br /><br />c) I agree with PixEye's remarks on sizeof().  In PHP it is just an alias for the true function count().  It has other meanings logically in other languages rather than the number of elements in an object.  This should be avoided as it may confuse developers transitioning to PHP from other languages.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sizeof&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sizeof.php">＋<small>add a note</small></a></div>
