...
<head>
  ...
  <title>PHP: SplFileObject::fstat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileobject.fstat.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileobject.fstat.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.fstat.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileobject.fseek.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileobject.ftell.php">

 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.fstat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/splfileobject.fstat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/splfileobject.fstat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/splfileobject.fstat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/splfileobject.fstat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/splfileobject.fstat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/splfileobject.fstat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/splfileobject.fstat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/splfileobject.fstat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/splfileobject.fstat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/splfileobject.fstat.php" hreflang="zh">
...
<meta name="Description" content="Gets information about the file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplFileObject::fstat - Manual" />
<meta name="twitter:description" content="Gets information about the file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplFileObject::fstat - Manual" />
<meta itemprop="description" content="Gets information about the file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets information about the file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="splfileobject.ftell.php">
          SplFileObject::ftell &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="splfileobject.fseek.php">
          &laquo; SplFileObject::fseek        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileobject.fstat.php' selected="selected">English</option>
            <option value='de/splfileobject.fstat.php'>German</option>
            <option value='es/splfileobject.fstat.php'>Spanish</option>
            <option value='fr/splfileobject.fstat.php'>French</option>
            <option value='it/splfileobject.fstat.php'>Italian</option>
            <option value='ja/splfileobject.fstat.php'>Japanese</option>
            <option value='pt_BR/splfileobject.fstat.php'>Brazilian Portuguese</option>
            <option value='ru/splfileobject.fstat.php'>Russian</option>
            <option value='tr/splfileobject.fstat.php'>Turkish</option>
            <option value='uk/splfileobject.fstat.php'>Ukrainian</option>
            <option value='zh/splfileobject.fstat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="splfileobject.fstat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SplFileObject::fstat</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">SplFileObject::fstat</span> &mdash; <span class="dc-title">Gets information about the file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-splfileobject.fstat-description">
  ...
  <p class="para rdfs-comment">
   Gathers the statistics of the file. Behaves identically to <span class="function"><a href="function.fstat.php" class="function">fstat()</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-splfileobject.fstat-returnvalues">
  ...
  <p class="para">
   ...
   is described in detail on the <span class="function"><a href="function.stat.php" class="function">stat()</a></span> manual page.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-splfileobject.fstat-examples">
  ...
  <p class="para">
   <div class="example" id="example-4006">
    <p><strong>Example #1 <span class="methodname"><strong>SplFileObject::fstat()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.stat.php" class="function" rel="rdfs-seeAlso">stat()</a> - Gives information about a file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileobject/fstat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileobject.fstat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileobject.fstat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileobject.fstat.php">＋<small>add a note</small></a></span>
