...
<head>
  ...
  <title>PHP: pg_end_copy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-end-copy.php">
 <link rel="shorturl" href="https://www.php.net/pg-end-copy">
 <link rel="alternate" href="https://www.php.net/pg-end-copy" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-delete.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-escape-bytea.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-end-copy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-end-copy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-end-copy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-end-copy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-end-copy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-end-copy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-end-copy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-end-copy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-end-copy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-end-copy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-end-copy.php" hreflang="zh">
...
<meta name="Description" content="Sync with PostgreSQL backend" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_end_copy - Manual" />
<meta name="twitter:description" content="Sync with PostgreSQL backend" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_end_copy - Manual" />
<meta itemprop="description" content="Sync with PostgreSQL backend" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sync with PostgreSQL backend" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-end-copy.php' selected="selected">English</option>
            <option value='de/function.pg-end-copy.php'>German</option>
            <option value='es/function.pg-end-copy.php'>Spanish</option>
            <option value='fr/function.pg-end-copy.php'>French</option>
            <option value='it/function.pg-end-copy.php'>Italian</option>
            <option value='ja/function.pg-end-copy.php'>Japanese</option>
            <option value='pt_BR/function.pg-end-copy.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-end-copy.php'>Russian</option>
            <option value='tr/function.pg-end-copy.php'>Turkish</option>
            <option value='uk/function.pg-end-copy.php'>Ukrainian</option>
            <option value='zh/function.pg-end-copy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-end-copy" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.pg-end-copy-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_end_copy</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span></span> <code class="parameter">$connection</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.pg-put-line.php" class="function">pg_put_line()</a></span>. <span class="function"><strong>pg_end_copy()</strong></span>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php <br />  $conn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_pconnect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=foo"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"create table bar (a int4, b char(16), d float8)"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"copy bar from stdin"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">pg_put_line</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"3\thello world\t4.5\n"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">pg_put_line</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"4\tgoodbye world\t7.11\n"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">pg_put_line</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"\\.\n"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">pg_end_copy</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-end-copy-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-put-line.php" class="function" rel="rdfs-seeAlso">pg_put_line()</a> - Send a NULL-terminated string to PostgreSQL backend</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-end-copy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-end-copy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-end-copy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-end-copy.php">＋<small>add a note</small></a></span>
