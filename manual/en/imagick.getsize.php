...
<head>
  ...
  <title>PHP: Imagick::getSize - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getsize.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getsize.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getsize.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getsamplingfactors.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getsizeoffset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getsize.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getsize.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getsize.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getsize.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getsize.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getsize.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getsize.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getsize.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getsize.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getsize.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getsize.php" hreflang="zh">
...
<meta name="Description" content="Returns the size associated with the Imagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getSize - Manual" />
<meta name="twitter:description" content="Returns the size associated with the Imagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getSize - Manual" />
<meta itemprop="description" content="Returns the size associated with the Imagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the size associated with the Imagick object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getsizeoffset.php">
          Imagick::getSizeOffset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getsamplingfactors.php">
          &laquo; Imagick::getSamplingFactors        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getsize.php' selected="selected">English</option>
            <option value='de/imagick.getsize.php'>German</option>
            <option value='es/imagick.getsize.php'>Spanish</option>
            <option value='fr/imagick.getsize.php'>French</option>
            <option value='it/imagick.getsize.php'>Italian</option>
            <option value='ja/imagick.getsize.php'>Japanese</option>
            <option value='pt_BR/imagick.getsize.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getsize.php'>Russian</option>
            <option value='tr/imagick.getsize.php'>Turkish</option>
            <option value='uk/imagick.getsize.php'>Ukrainian</option>
            <option value='zh/imagick.getsize.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getsize" class="refentry">
...
400x800</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getsize.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getsize%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getsize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getsize.php">＋<small>add a note</small></a></span>
