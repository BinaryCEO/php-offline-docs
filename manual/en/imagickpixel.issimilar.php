...
<head>
  ...
  <title>PHP: ImagickPixel::isSimilar - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickpixel.issimilar.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickpixel.issimilar.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickpixel.issimilar.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickpixel.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickpixel.ispixelsimilarquantum.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickpixel.setcolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickpixel.issimilar.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickpixel.issimilar.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickpixel.issimilar.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickpixel.issimilar.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickpixel.issimilar.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickpixel.issimilar.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickpixel.issimilar.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickpixel.issimilar.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickpixel.issimilar.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickpixel.issimilar.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickpixel.issimilar.php" hreflang="zh">
...
<meta name="Description" content="Check the distance between this color and another" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickPixel::isSimilar - Manual" />
<meta name="twitter:description" content="Check the distance between this color and another" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickPixel::isSimilar - Manual" />
<meta itemprop="description" content="Check the distance between this color and another" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check the distance between this color and another" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickpixel.setcolor.php">
          ImagickPixel::setColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickpixel.ispixelsimilarquantum.php">
          &laquo; ImagickPixel::isPixelSimilarQuantum        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickpixel.issimilar.php' selected="selected">English</option>
            <option value='de/imagickpixel.issimilar.php'>German</option>
            <option value='es/imagickpixel.issimilar.php'>Spanish</option>
            <option value='fr/imagickpixel.issimilar.php'>French</option>
            <option value='it/imagickpixel.issimilar.php'>Italian</option>
            <option value='ja/imagickpixel.issimilar.php'>Japanese</option>
            <option value='pt_BR/imagickpixel.issimilar.php'>Brazilian Portuguese</option>
            <option value='ru/imagickpixel.issimilar.php'>Russian</option>
            <option value='tr/imagickpixel.issimilar.php'>Turkish</option>
            <option value='uk/imagickpixel.issimilar.php'>Ukrainian</option>
            <option value='zh/imagickpixel.issimilar.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickpixel.issimilar" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickPixel::isSimilar</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickPixel::isSimilar</span> &mdash; <span class="dc-title">Check the distance between this color and another</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagickpixel.issimilar-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickPixel::isSimilar</strong></span>(<span class="methodparam"><span class="type"><a href="class.imagickpixel.php" class="type ImagickPixel">ImagickPixel</a></span> <code class="parameter">$color</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$fuzz</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
  ...
  <p class="para">
   ...
   Deprecated in favour of <a href="imagickpixel.ispixelsimilar.php" class="link">ImagickPixel::isPixelSimilar()</a>.
  </p>
 </div>
  ...
  <p class="para">
    <div class="example" id="example-3207">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickpixel/issimilar.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickpixel.issimilar%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickpixel.issimilar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickpixel.issimilar.php">＋<small>add a note</small></a></span>
