...
<head>
  ...
  <title>PHP: sodium_crypto_auth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-auth.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-auth">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-auth" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-aead-xchacha20poly1305-ietf-keygen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-auth-keygen.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-auth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-auth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-auth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-auth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-auth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-auth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-auth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-auth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-auth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-auth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-auth.php" hreflang="zh">
...
<meta name="Description" content="Compute a tag for the message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_auth - Manual" />
<meta name="twitter:description" content="Compute a tag for the message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_auth - Manual" />
<meta itemprop="description" content="Compute a tag for the message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Compute a tag for the message" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-auth-keygen.php">
          sodium_crypto_auth_keygen &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-aead-xchacha20poly1305-ietf-keygen.php">
          &laquo; sodium_crypto_aead_xchacha20poly1305_ietf_keygen        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-auth.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-auth.php'>German</option>
            <option value='es/function.sodium-crypto-auth.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-auth.php'>French</option>
            <option value='it/function.sodium-crypto-auth.php'>Italian</option>
            <option value='ja/function.sodium-crypto-auth.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-auth.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-auth.php'>Russian</option>
            <option value='tr/function.sodium-crypto-auth.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-auth.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-auth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-auth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_auth</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_auth</span> &mdash; <span class="dc-title">Compute a tag for the message</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-auth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_auth</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message</code></span>, <span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   Symmetric message authentication via <span class="function"><strong>sodium_crypto_auth()</strong></span> provides
   integrity, but not confidentiality.
  </p>
  <p class="para">
   Unlike with digital signatures (e.g. <span class="function"><a href="function.sodium-crypto-sign-detached.php" class="function">sodium_crypto_sign_detached()</a></span>),
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-auth-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-auth-returnvalues">
  ...
  <p class="para">
   Authentication tag
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-auth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-auth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-auth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-auth.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123080">  <div class="votes">
    <div id="Vu123080">
    <a href="/manual/vote-note.php?id=123080&amp;page=function.sodium-crypto-auth&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123080">
    <a href="/manual/vote-note.php?id=123080&amp;page=function.sodium-crypto-auth&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123080" title="100% like this...">
    1
    </div>
  </div>
  <a href="#123080" class="name">
  <strong class="user"><em>craig at craigfrancis dot co dot uk</em></strong></a><a class="genanchor" href="#123080"> &para;</a><div class="date" title="2018-08-25 08:08"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom123080">
<div class="phpcode"><code><span class="html">Here's a quick example on how to use sodium_crypto_auth(); where you have a message that you want to sign, so anyone who can access the *shared* key can confirm that the message hasn't been tampered with.<br /><br />This is similar to sodium_crypto_sign_detached(), but both signer and verifier have access to the same key.<br /><br /><span class="default">&lt;?php<br /><br />$key </span><span class="keyword">= </span><span class="default">sodium_crypto_auth_keygen</span><span class="keyword">();<br /><br /></span><span class="comment">//--------------------------------------------------<br />// Person 1, signing<br /><br /></span><span class="default">$message </span><span class="keyword">= </span><span class="string">'Hello'</span><span class="keyword">;<br /><br /></span><span class="default">$signature </span><span class="keyword">= </span><span class="default">sodium_crypto_auth</span><span class="keyword">(</span><span class="default">$message</span><span class="keyword">, </span><span class="default">$key</span><span class="keyword">);<br /><br /></span><span class="comment">//--------------------------------------------------<br />// Person 2, verifying<br /><br /></span><span class="default">$message_valid </span><span class="keyword">= </span><span class="default">sodium_crypto_auth_verify</span><span class="keyword">(</span><span class="default">$signature</span><span class="keyword">, </span><span class="default">$message</span><span class="keyword">, </span><span class="default">$key</span><span class="keyword">);<br /><br />if (!</span><span class="default">$message_valid</span><span class="keyword">) {<br />    exit(</span><span class="string">'Message has been changed.'</span><span class="keyword">);<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-auth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-auth.php">＋<small>add a note</small></a></div>
