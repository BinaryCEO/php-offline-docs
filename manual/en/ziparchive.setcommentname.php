...
<head>
  ...
  <title>PHP: ZipArchive::setCommentName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.setcommentname.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.setcommentname.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setcommentname.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.setcommentindex.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.setcompressionindex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setcommentname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.setcommentname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.setcommentname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.setcommentname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.setcommentname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.setcommentname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.setcommentname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.setcommentname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.setcommentname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.setcommentname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.setcommentname.php" hreflang="zh">
...
<meta name="Description" content="Set the comment of an entry defined by its name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::setCommentName - Manual" />
<meta name="twitter:description" content="Set the comment of an entry defined by its name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::setCommentName - Manual" />
<meta itemprop="description" content="Set the comment of an entry defined by its name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the comment of an entry defined by its name" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.setcompressionindex.php">
          ZipArchive::setCompressionIndex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.setcommentindex.php">
          &laquo; ZipArchive::setCommentIndex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.setcommentname.php' selected="selected">English</option>
            <option value='de/ziparchive.setcommentname.php'>German</option>
            <option value='es/ziparchive.setcommentname.php'>Spanish</option>
            <option value='fr/ziparchive.setcommentname.php'>French</option>
            <option value='it/ziparchive.setcommentname.php'>Italian</option>
            <option value='ja/ziparchive.setcommentname.php'>Japanese</option>
            <option value='pt_BR/ziparchive.setcommentname.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.setcommentname.php'>Russian</option>
            <option value='tr/ziparchive.setcommentname.php'>Turkish</option>
            <option value='uk/ziparchive.setcommentname.php'>Ukrainian</option>
            <option value='zh/ziparchive.setcommentname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.setcommentname" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ZipArchive::setCommentName</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8, PECL zip &gt;= 1.4.0)</p><p class="refpurpose"><span class="refname">ZipArchive::setCommentName</span> &mdash; <span class="dc-title">Set the comment of an entry defined by its name</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-ziparchive.setcommentname-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ZipArchive::setCommentName</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$comment</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-ziparchive.setcommentname-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-ziparchive.setcommentname-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$zip </span><span style="color: #007700">= new </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$res </span><span style="color: #007700">= </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">open</span><span style="color: #007700">(</span><span style="color: #DD0000">'test.zip'</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">$res </span><span style="color: #007700">=== </span><span style="color: #0000BB">TRUE</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setCommentName</span><span style="color: #007700">(</span><span style="color: #DD0000">'entry1.txt'</span><span style="color: #007700">, </span><span style="color: #DD0000">'new entry comment'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">close</span><span style="color: #007700">();<br />    echo </span><span style="color: #DD0000">'ok'</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">'failed'</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/setcommentname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.setcommentname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.setcommentname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.setcommentname.php">＋<small>add a note</small></a></span>
