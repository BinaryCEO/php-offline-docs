...
<head>
  ...
  <title>PHP: MongoDB\Driver\Manager::startSession - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-manager.startsession.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-manager.startsession.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.startsession.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-manager.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-manager.selectserver.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mongodb-driver-command.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.startsession.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-manager.startsession.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-manager.startsession.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-manager.startsession.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-manager.startsession.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-manager.startsession.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-manager.startsession.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-manager.startsession.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-manager.startsession.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-manager.startsession.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-manager.startsession.php" hreflang="zh">
...
<meta name="Description" content="Start a new client session for use with this client" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Manager::startSession - Manual" />
<meta name="twitter:description" content="Start a new client session for use with this client" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Manager::startSession - Manual" />
<meta itemprop="description" content="Start a new client session for use with this client" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Start a new client session for use with this client" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.mongodb-driver-command.php">
          MongoDB\Driver\Command &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-manager.selectserver.php">
          &laquo; MongoDB\Driver\Manager::selectServer        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-manager.startsession.php' selected="selected">English</option>
            <option value='de/mongodb-driver-manager.startsession.php'>German</option>
            <option value='es/mongodb-driver-manager.startsession.php'>Spanish</option>
            <option value='fr/mongodb-driver-manager.startsession.php'>French</option>
            <option value='it/mongodb-driver-manager.startsession.php'>Italian</option>
            <option value='ja/mongodb-driver-manager.startsession.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-manager.startsession.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-manager.startsession.php'>Russian</option>
            <option value='tr/mongodb-driver-manager.startsession.php'>Turkish</option>
            <option value='uk/mongodb-driver-manager.startsession.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-manager.startsession.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-manager.startsession" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><a href="https://www.mongodb.com/docs/manual/core/read-isolation-consistency-recency/#causal-consistency" class="link external">&raquo;&nbsp;Casual Consistency</a> in the MongoDB manual</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/manager/startsession.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-manager.startsession%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-manager.startsession&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-manager.startsession.php">＋<small>add a note</small></a></span>
