...
<head>
  ...
  <title>PHP: ps_add_weblink - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-add-weblink.php">
 <link rel="shorturl" href="https://www.php.net/ps-add-weblink">
 <link rel="alternate" href="https://www.php.net/ps-add-weblink" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-add-pdflink.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-arc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-add-weblink.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-add-weblink.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-add-weblink.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-add-weblink.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-add-weblink.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-add-weblink.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-add-weblink.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-add-weblink.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-add-weblink.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-add-weblink.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-add-weblink.php" hreflang="zh">
...
<meta name="Description" content="Adds link to a web location" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_add_weblink - Manual" />
<meta name="twitter:description" content="Adds link to a web location" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_add_weblink - Manual" />
<meta itemprop="description" content="Adds link to a web location" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds link to a web location" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-arc.php">
          ps_arc &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-add-pdflink.php">
          &laquo; ps_add_pdflink        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-add-weblink.php' selected="selected">English</option>
            <option value='de/function.ps-add-weblink.php'>German</option>
            <option value='es/function.ps-add-weblink.php'>Spanish</option>
            <option value='fr/function.ps-add-weblink.php'>French</option>
            <option value='it/function.ps-add-weblink.php'>Italian</option>
            <option value='ja/function.ps-add-weblink.php'>Japanese</option>
            <option value='pt_BR/function.ps-add-weblink.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-add-weblink.php'>Russian</option>
            <option value='tr/function.ps-add-weblink.php'>Turkish</option>
            <option value='uk/function.ps-add-weblink.php'>Ukrainian</option>
            <option value='zh/function.ps-add-weblink.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-add-weblink" class="refentry">
  <div class="refnamediv">
  <h1 class="refname">ps_add_weblink</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_add_weblink</span> &mdash; <span class="dc-title">Adds link to a web location</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-add-weblink-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_add_weblink</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$llx</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$lly</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$urx</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$ury</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$url</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   (<code class="parameter">llx</code>, <code class="parameter">lly</code>) and
   its upper right corner at (<code class="parameter">urx</code>,
   <code class="parameter">ury</code>). The rectangle has by default a thin
   blue border.
  </p>
...
pdf by either Acrobat Distiller™ or Ghostview.</p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-add-weblink-parameters">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       this link, e.g. <code class="literal">http://www.php.net</code>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-add-weblink-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-add-weblink-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-add-pdflink.php" class="function" rel="rdfs-seeAlso">ps_add_pdflink()</a> - Adds link to a page in a second pdf document</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-add-weblink.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-add-weblink%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-add-weblink&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-add-weblink.php">＋<small>add a note</small></a></span>
