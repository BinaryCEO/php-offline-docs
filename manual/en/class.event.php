...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.event.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/event.constructing.signal.events.php">
 <link rel="next" href="https://www.php.net/manual/en/event.add.php">
...
<meta name="Description" content="The Event class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Event - Manual" />
<meta name="twitter:description" content="The Event class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Event - Manual" />
<meta itemprop="description" content="The Event class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Event class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="event.constructing.signal.events.php">
          &laquo; Constructing signal events        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.event.php' selected="selected">English</option>
            ...
            <option value='pt_BR/class.event.php'>Brazilian Portuguese</option>
  ...
  event</li><li><a href="event.getsupportedmethods.php">Event::getSupportedMethods</a> — Returns array with of the names of the methods supported in this version of Libevent</li><li><a href="event.pending.php">Event::pending</a> — Detects whether event is pending or scheduled</li><li><a href="event.set.php">Event::set</a> — Re-configures event</li><li><a href="event.setpriority.php">Event::setPriority</a> — Set event priority</li><li><a href="event.settimer.php">Event::setTimer</a> — Re-configures timer event</li><li><a href="event.signal.php">Event::signal</a> — Constructs signal event object</li><li><a href="event.timer.php">Event::timer</a> — Constructs timer event object</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/event.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.event%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.event&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.event.php">＋<small>add a note</small></a></span>
