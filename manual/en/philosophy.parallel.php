...
<head>
  ...
  <title>PHP: Philosophy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/philosophy.parallel.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/philosophy.parallel.php">
 <link rel="alternate" href="https://www.php.net/manual/en/philosophy.parallel.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.parallel.php">
 <link rel="prev" href="https://www.php.net/manual/en/parallel.setup.php">
 <link rel="next" href="https://www.php.net/manual/en/functional.parallel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/philosophy.parallel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/philosophy.parallel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/philosophy.parallel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/philosophy.parallel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/philosophy.parallel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/philosophy.parallel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/philosophy.parallel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/philosophy.parallel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/philosophy.parallel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/philosophy.parallel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/philosophy.parallel.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Philosophy - Manual" />
<meta name="twitter:description" content="Philosophy" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Philosophy - Manual" />
<meta itemprop="description" content="Philosophy" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/philosophy.parallel.php' selected="selected">English</option>
            <option value='de/philosophy.parallel.php'>German</option>
            <option value='es/philosophy.parallel.php'>Spanish</option>
            <option value='fr/philosophy.parallel.php'>French</option>
            <option value='it/philosophy.parallel.php'>Italian</option>
            <option value='ja/philosophy.parallel.php'>Japanese</option>
            <option value='pt_BR/philosophy.parallel.php'>Brazilian Portuguese</option>
            <option value='ru/philosophy.parallel.php'>Russian</option>
            <option value='tr/philosophy.parallel.php'>Turkish</option>
            <option value='uk/philosophy.parallel.php'>Ukrainian</option>
            <option value='zh/philosophy.parallel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="philosophy.parallel" class="chapter">
   ...
   only ever as a result of communication.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/parallel/philosophy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphilosophy.parallel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=philosophy.parallel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/philosophy.parallel.php">＋<small>add a note</small></a></span>
