...
<head>
  ...
  <title>PHP: ReflectionGenerator - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.reflectiongenerator.php">
 <link rel="shorturl" href="https://www.php.net/reflectiongenerator">
 <link rel="alternate" href="https://www.php.net/reflectiongenerator" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.reflection.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionuniontype.gettypes.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectiongenerator.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.reflectiongenerator.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.reflectiongenerator.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.reflectiongenerator.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.reflectiongenerator.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.reflectiongenerator.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.reflectiongenerator.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.reflectiongenerator.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.reflectiongenerator.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.reflectiongenerator.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.reflectiongenerator.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.reflectiongenerator.php" hreflang="zh">
...
<meta name="Description" content="The ReflectionGenerator class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionGenerator - Manual" />
<meta name="twitter:description" content="The ReflectionGenerator class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionGenerator - Manual" />
<meta itemprop="description" content="The ReflectionGenerator class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ReflectionGenerator class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectiongenerator.construct.php">
          ReflectionGenerator::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionuniontype.gettypes.php">
          &laquo; ReflectionUnionType::getTypes        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.reflectiongenerator.php' selected="selected">English</option>
            <option value='de/class.reflectiongenerator.php'>German</option>
            <option value='es/class.reflectiongenerator.php'>Spanish</option>
            <option value='fr/class.reflectiongenerator.php'>French</option>
            <option value='it/class.reflectiongenerator.php'>Italian</option>
            <option value='ja/class.reflectiongenerator.php'>Japanese</option>
            <option value='pt_BR/class.reflectiongenerator.php'>Brazilian Portuguese</option>
            <option value='ru/class.reflectiongenerator.php'>Russian</option>
            <option value='tr/class.reflectiongenerator.php'>Turkish</option>
            <option value='uk/class.reflectiongenerator.php'>Ukrainian</option>
            <option value='zh/class.reflectiongenerator.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.reflectiongenerator" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="reflectiongenerator.construct.php">ReflectionGenerator::__construct</a> — Constructs a ReflectionGenerator object</li><li><a href="reflectiongenerator.getexecutingfile.php">ReflectionGenerator::getExecutingFile</a> — Gets the file name of the currently executing generator</li><li><a href="reflectiongenerator.getexecutinggenerator.php">ReflectionGenerator::getExecutingGenerator</a> — Gets the executing Generator object</li><li><a href="reflectiongenerator.getexecutingline.php">ReflectionGenerator::getExecutingLine</a> — Gets the currently executing line of the generator</li><li><a href="reflectiongenerator.getfunction.php">ReflectionGenerator::getFunction</a> — Gets the function name of the generator</li><li><a href="reflectiongenerator.getthis.php">ReflectionGenerator::getThis</a> — Gets the $this value of the generator</li><li><a href="reflectiongenerator.gettrace.php">ReflectionGenerator::getTrace</a> — Gets the trace of the executing generator</li><li><a href="reflectiongenerator.isclosed.php">ReflectionGenerator::isClosed</a> — Checks if execution finished</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectiongenerator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.reflectiongenerator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.reflectiongenerator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectiongenerator.php">＋<small>add a note</small></a></span>
