...
<head>
  ...
  <title>PHP: Gmagick::getpackagename - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getpackagename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getpackagename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getpackagename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagewidth.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getquantumdepth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getpackagename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getpackagename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getpackagename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getpackagename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getpackagename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getpackagename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getpackagename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getpackagename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getpackagename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getpackagename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getpackagename.php" hreflang="zh">
...
<meta name="Description" content="Returns the GraphicsMagick package name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::getpackagename - Manual" />
<meta name="twitter:description" content="Returns the GraphicsMagick package name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getpackagename - Manual" />
<meta itemprop="description" content="Returns the GraphicsMagick package name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the GraphicsMagick package name" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getquantumdepth.php">
          Gmagick::getquantumdepth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagewidth.php">
          &laquo; Gmagick::getimagewidth        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getpackagename.php' selected="selected">English</option>
            <option value='de/gmagick.getpackagename.php'>German</option>
            <option value='es/gmagick.getpackagename.php'>Spanish</option>
            <option value='fr/gmagick.getpackagename.php'>French</option>
            <option value='it/gmagick.getpackagename.php'>Italian</option>
            <option value='ja/gmagick.getpackagename.php'>Japanese</option>
            <option value='pt_BR/gmagick.getpackagename.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getpackagename.php'>Russian</option>
            <option value='tr/gmagick.getpackagename.php'>Turkish</option>
            <option value='uk/gmagick.getpackagename.php'>Ukrainian</option>
            <option value='zh/gmagick.getpackagename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getpackagename" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getpackagename</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getpackagename</span> &mdash; <span class="dc-title">Returns the GraphicsMagick package name</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getpackagename-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getpackagename</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getpackagename-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getpackagename-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getpackagename-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getpackagename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getpackagename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getpackagename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getpackagename.php">＋<small>add a note</small></a></span>
