...
<head>
  ...
  <title>PHP: Memcached::appendByKey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.appendbykey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.appendbykey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.appendbykey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.append.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.cas.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.appendbykey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.appendbykey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.appendbykey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.appendbykey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.appendbykey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.appendbykey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.appendbykey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.appendbykey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.appendbykey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.appendbykey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.appendbykey.php" hreflang="zh">
...
<meta name="Description" content="Append data to an existing item on a specific server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::appendByKey - Manual" />
<meta name="twitter:description" content="Append data to an existing item on a specific server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::appendByKey - Manual" />
<meta itemprop="description" content="Append data to an existing item on a specific server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Append data to an existing item on a specific server" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="memcached.cas.php">
          Memcached::cas &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.append.php">
          &laquo; Memcached::append        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.appendbykey.php' selected="selected">English</option>
            <option value='de/memcached.appendbykey.php'>German</option>
            <option value='es/memcached.appendbykey.php'>Spanish</option>
            <option value='fr/memcached.appendbykey.php'>French</option>
            <option value='it/memcached.appendbykey.php'>Italian</option>
            <option value='ja/memcached.appendbykey.php'>Japanese</option>
            <option value='pt_BR/memcached.appendbykey.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.appendbykey.php'>Russian</option>
            <option value='tr/memcached.appendbykey.php'>Turkish</option>
            <option value='uk/memcached.appendbykey.php'>Ukrainian</option>
            <option value='zh/memcached.appendbykey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.appendbykey" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Memcached::appendByKey</h1>
  <p class="verinfo">(PECL memcached &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">Memcached::appendByKey</span> &mdash; <span class="dc-title">Append data to an existing item on a specific server</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-memcached.appendbykey-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Memcached::appendByKey</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$server_key</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::appendByKey()</strong></span> is functionally equivalent to
   <span class="methodname"><a href="memcached.append.php" class="methodname">Memcached::append()</a></span>, except that the free-form
 ...
 <div class="refsect1 parameters" id="refsect1-memcached.appendbykey-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-memcached.appendbykey-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-memcached.appendbykey-errors">
 ...
 <div class="refsect1 seealso" id="refsect1-memcached.appendbykey-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="memcached.prepend.php" class="methodname" rel="rdfs-seeAlso">Memcached::prepend()</a> - Prepend data to an existing item</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/appendbykey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.appendbykey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.appendbykey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.appendbykey.php">＋<small>add a note</small></a></span>
