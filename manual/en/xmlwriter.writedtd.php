...
<head>
  ...
  <title>PHP: XMLWriter::writeDtd - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/xmlwriter.writedtd.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/xmlwriter.writedtd.php">
 <link rel="alternate" href="https://www.php.net/manual/en/xmlwriter.writedtd.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.xmlwriter.php">
 <link rel="prev" href="https://www.php.net/manual/en/xmlwriter.writecomment.php">
 <link rel="next" href="https://www.php.net/manual/en/xmlwriter.writedtdattlist.php">

 <link rel="alternate" href="https://www.php.net/manual/en/xmlwriter.writedtd.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/xmlwriter.writedtd.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/xmlwriter.writedtd.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/xmlwriter.writedtd.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/xmlwriter.writedtd.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/xmlwriter.writedtd.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/xmlwriter.writedtd.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/xmlwriter.writedtd.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/xmlwriter.writedtd.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/xmlwriter.writedtd.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/xmlwriter.writedtd.php" hreflang="zh">
...
<meta name="Description" content="Write full DTD tag" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: XMLWriter::writeDtd - Manual" />
<meta name="twitter:description" content="Write full DTD tag" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: XMLWriter::writeDtd - Manual" />
<meta itemprop="description" content="Write full DTD tag" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Write full DTD tag" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="xmlwriter.writedtdattlist.php">
          XMLWriter::writeDtdAttlist &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="xmlwriter.writecomment.php">
          &laquo; XMLWriter::writeComment        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/xmlwriter.writedtd.php' selected="selected">English</option>
            <option value='de/xmlwriter.writedtd.php'>German</option>
            <option value='es/xmlwriter.writedtd.php'>Spanish</option>
            <option value='fr/xmlwriter.writedtd.php'>French</option>
            <option value='it/xmlwriter.writedtd.php'>Italian</option>
            <option value='ja/xmlwriter.writedtd.php'>Japanese</option>
            <option value='pt_BR/xmlwriter.writedtd.php'>Brazilian Portuguese</option>
            <option value='ru/xmlwriter.writedtd.php'>Russian</option>
            <option value='tr/xmlwriter.writedtd.php'>Turkish</option>
            <option value='uk/xmlwriter.writedtd.php'>Ukrainian</option>
            <option value='zh/xmlwriter.writedtd.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="xmlwriter.writedtd" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">XMLWriter::writeDtd</h1>
  <h1 class="refname">xmlwriter_write_dtd</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.1.2, PHP 7, PHP 8, PECL xmlwriter &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">XMLWriter::writeDtd</span> -- <span class="refname">xmlwriter_write_dtd</span> &mdash; <span class="dc-title">Write full DTD tag</span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="xmlwriter.enddtd.php" class="methodname" rel="rdfs-seeAlso">XMLWriter::endDtd()</a> - End current DTD</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xmlwriter/xmlwriter/writedtd.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fxmlwriter.writedtd%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=xmlwriter.writedtd&amp;repo=en&amp;redirect=https://www.php.net/manual/en/xmlwriter.writedtd.php">＋<small>add a note</small></a></span>
