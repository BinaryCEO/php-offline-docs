...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.log.php">
 <link rel="shorturl" href="https://www.php.net/log">
 <link rel="alternate" href="https://www.php.net/log" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.math.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.is-nan.php">
 <link rel="next" href="https://www.php.net/manual/en/function.log10.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.log.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.log.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.log.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.log.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.log.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.log.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.log.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.log.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.log.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.log.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.log.php" hreflang="zh">
...
<meta name="Description" content="Natural logarithm" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: log - Manual" />
<meta name="twitter:description" content="Natural logarithm" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: log - Manual" />
<meta itemprop="description" content="Natural logarithm" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Natural logarithm" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.log.php' selected="selected">English</option>
            <option value='de/function.log.php'>German</option>
            <option value='es/function.log.php'>Spanish</option>
            <option value='fr/function.log.php'>French</option>
            <option value='it/function.log.php'>Italian</option>
            <option value='ja/function.log.php'>Japanese</option>
            <option value='pt_BR/function.log.php'>Brazilian Portuguese</option>
            <option value='ru/function.log.php'>Russian</option>
            <option value='tr/function.log.php'>Turkish</option>
            <option value='uk/function.log.php'>Ukrainian</option>
            <option value='zh/function.log.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.log" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">log</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">log</span> &mdash; <span class="dc-title">Natural logarithm</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.log-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>log</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$num</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$base</code><span class="initializer"> = <strong><code><a href="math.constants.php#constant.m-e">M_E</a></code></strong></span></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">num</code>, otherwise <span class="function"><strong>log()</strong></span> 
   returns the natural logarithm of <code class="parameter">num</code>.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.log-returnvalues">
  ...
  <p class="para">
   The logarithm of <code class="parameter">num</code> to 
 ...
 <div class="refsect1 seealso" id="refsect1-function.log-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.error-log.php" class="function" rel="rdfs-seeAlso">error_log()</a> - Send an error message to the defined error handling routines</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/math/functions/log.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.log%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.log&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.log.php">＋<small>add a note</small></a></span>
