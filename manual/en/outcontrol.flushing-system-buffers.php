...
<head>
  ...
  <title>PHP: Flushing System Buffers - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/outcontrol.flushing-system-buffers.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/outcontrol.flushing-system-buffers.php">
 <link rel="alternate" href="https://www.php.net/manual/en/outcontrol.flushing-system-buffers.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.outcontrol.php">
 <link rel="prev" href="https://www.php.net/manual/en/outcontrol.output-buffering.php">
 <link rel="next" href="https://www.php.net/manual/en/outcontrol.user-level-output-buffers.php">

 <link rel="alternate" href="https://www.php.net/manual/en/outcontrol.flushing-system-buffers.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/outcontrol.flushing-system-buffers.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/outcontrol.flushing-system-buffers.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/outcontrol.flushing-system-buffers.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/outcontrol.flushing-system-buffers.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/outcontrol.flushing-system-buffers.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/outcontrol.flushing-system-buffers.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/outcontrol.flushing-system-buffers.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/outcontrol.flushing-system-buffers.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/outcontrol.flushing-system-buffers.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/outcontrol.flushing-system-buffers.php" hreflang="zh">
...
<meta name="Description" content="Flushing System Buffers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Flushing System Buffers - Manual" />
<meta name="twitter:description" content="Flushing System Buffers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Flushing System Buffers - Manual" />
<meta itemprop="description" content="Flushing System Buffers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Flushing System Buffers" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="outcontrol.user-level-output-buffers.php">
          User-Level Output Buffers &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="outcontrol.output-buffering.php">
          &laquo; Output Buffering        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/outcontrol.flushing-system-buffers.php' selected="selected">English</option>
            <option value='de/outcontrol.flushing-system-buffers.php'>German</option>
            <option value='es/outcontrol.flushing-system-buffers.php'>Spanish</option>
            <option value='fr/outcontrol.flushing-system-buffers.php'>French</option>
            <option value='it/outcontrol.flushing-system-buffers.php'>Italian</option>
            <option value='ja/outcontrol.flushing-system-buffers.php'>Japanese</option>
            <option value='pt_BR/outcontrol.flushing-system-buffers.php'>Brazilian Portuguese</option>
            <option value='ru/outcontrol.flushing-system-buffers.php'>Russian</option>
            <option value='tr/outcontrol.flushing-system-buffers.php'>Turkish</option>
            <option value='uk/outcontrol.flushing-system-buffers.php'>Ukrainian</option>
            <option value='zh/outcontrol.flushing-system-buffers.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="outcontrol.flushing-system-buffers" class="chapter">
   ...
   <ul class="itemizedlist">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/outcontrol/flushing-system-buffers.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Foutcontrol.flushing-system-buffers%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=outcontrol.flushing-system-buffers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/outcontrol.flushing-system-buffers.php">＋<small>add a note</small></a></span>
