...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-internal-debug.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocibindbyname.php">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="oldaliases.oci8.php">
          &laquo; OCI8 Obsolete Aliases and Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-internal-debug.php' selected="selected">English</option>
            <option value='de/function.oci-internal-debug.php'>German</option>
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
    <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/oci-internal-debug.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-internal-debug%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-internal-debug&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-internal-debug.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>Rainer Perske</em></strong></a><a class="genanchor" href="#118190"> &para;</a><div class="date" title="2015-10-23 11:10"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118190">
<div class="phpcode"><code><span class="html">With PHP 5.6, oci_internal_debug() is a no-op, as documented on <a href="http://php.net/manual/de/migration56.extensions.php" rel="nofollow" target="_blank">http://php.net/manual/de/migration56.extensions.php</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.oci-internal-debug&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-internal-debug.php">＋<small>add a note</small></a></div>
