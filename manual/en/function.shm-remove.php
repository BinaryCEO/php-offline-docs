...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.shm-remove.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.shm-put-var.php">
 <link rel="next" href="https://www.php.net/manual/en/function.shm-remove-var.php">
...
<meta name="Description" content="Removes shared memory from Unix systems" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: shm_remove - Manual" />
<meta name="twitter:description" content="Removes shared memory from Unix systems" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: shm_remove - Manual" />
<meta itemprop="description" content="Removes shared memory from Unix systems" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes shared memory from Unix systems" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.shm-remove.php' selected="selected">English</option>
            <option value='de/function.shm-remove.php'>German</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">shm_remove</span> &mdash; <span class="dc-title">Removes shared memory from Unix systems</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.shm-remove-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>shm_remove()</strong></span> removes the shared memory
   <code class="parameter">shm</code>. All data will be destroyed.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.shm-remove-var.php" class="function" rel="rdfs-seeAlso">shm_remove_var()</a> - Removes a variable from shared memory</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sem/functions/shm-remove.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.shm-remove%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.shm-remove&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.shm-remove.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">WARNING: this function WILL NOT destroy the memory segment if there are other processes attached to it, but it will return TRUE anyways!<br /><br />You will have to try to access the segment again after destroying it to make sure it was relly destroyed.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">It appears that you must be connected to the shm segment in order to remove it.<br /><br /><span class="default">&lt;?php<br />shm_remove</span><span class="keyword">(</span><span class="default">$shm</span><span class="keyword">);<br /></span><span class="default">shm_detach</span><span class="keyword">(</span><span class="default">$shm</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />works, while<br /><br /><span class="default">&lt;?php<br />shm_detach</span><span class="keyword">(</span><span class="default">$shm</span><span class="keyword">);<br /></span><span class="default">shm_remove</span><span class="keyword">(</span><span class="default">$shm</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />produces "Warning: shm_remove(): The parameter is not a valid shm_identifier ..."</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>cu at ulakbim dot gov dot tr</em></strong></a><a class="genanchor" href="#2956"> &para;</a><div class="date" title="1999-12-29 08:30"><strong>25 years ago</strong></div>
  <div class="text" id="Hcom2956">
<div class="phpcode"><code><span class="html">Though it says **shm_identifier** in
<br />  int shm_remove(int shm_identifier);
<br />and
<br />  shm_attach() returns an **id** that that can be used to access the System V...
<br />
<br />a snippet like this:
<br /><span class="default">&lt;?php
<br />  $key </span><span class="keyword">= </span><span class="default">1234</span><span class="keyword">;
<br />  </span><span class="default">$shm</span><span class="keyword">=</span><span class="default">shm_attach</span><span class="keyword">(</span><span class="default">$key</span><span class="keyword">);
<br />  </span><span class="comment">// do whatever...
<br />  </span><span class="default">shm_remove</span><span class="keyword">(</span><span class="default">$shm</span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>
<br />produces an error like
<br />Warning: 2(which is the value of $shm) is not a existing SysV shared memory key in /usr/cu/web/sema.php on line 44...
<br />
<br />The documentation confused me a bit. I thought shm_remove would get the shm handle/id that returns from shm_attach, not the key given to shm_attach. So, use instead:
<br />  shm_remove($key);
<br />
<br />which is what is intended indeed.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.shm-remove&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.shm-remove.php">＋<small>add a note</small></a></div>
