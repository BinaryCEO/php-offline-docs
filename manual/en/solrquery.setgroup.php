...
<head>
  ...
  <title>PHP: SolrQuery::setGroup - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setgroup.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setgroup.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgroup.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setfacetsort.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setgroupcachepercent.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgroup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setgroup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setgroup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setgroup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setgroup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setgroup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setgroup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setgroup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setgroup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setgroup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setgroup.php" hreflang="zh">
...
<meta name="Description" content="Enable/Disable result grouping (group parameter)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setGroup - Manual" />
<meta name="twitter:description" content="Enable/Disable result grouping (group parameter)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setGroup - Manual" />
<meta itemprop="description" content="Enable/Disable result grouping (group parameter)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enable/Disable result grouping (group parameter)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setgroupcachepercent.php">
          SolrQuery::setGroupCachePercent &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setfacetsort.php">
          &laquo; SolrQuery::setFacetSort        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setgroup.php' selected="selected">English</option>
            <option value='de/solrquery.setgroup.php'>German</option>
            <option value='es/solrquery.setgroup.php'>Spanish</option>
            <option value='fr/solrquery.setgroup.php'>French</option>
            <option value='it/solrquery.setgroup.php'>Italian</option>
            <option value='ja/solrquery.setgroup.php'>Japanese</option>
            <option value='pt_BR/solrquery.setgroup.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setgroup.php'>Russian</option>
            <option value='tr/solrquery.setgroup.php'>Turkish</option>
            <option value='uk/solrquery.setgroup.php'>Ukrainian</option>
            <option value='zh/solrquery.setgroup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setgroup" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setGroup</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::setGroup</span> &mdash; <span class="dc-title">Enable/Disable result grouping (group parameter)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setgroup-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setGroup</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setgroup-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setgroup-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.setgroup-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.getgroup.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::getGroup()</a> - Returns true if grouping is enabled</span></li>
   ...
   <li><span class="methodname"><a href="solrquery.setgroupcachepercent.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupCachePercent()</a> - Enables caching for result grouping</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setgroup.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setgroup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setgroup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setgroup.php">＋<small>add a note</small></a></span>
