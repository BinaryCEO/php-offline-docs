...
<head>
  ...
  <title>PHP: Gmagick::drawimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.drawimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.drawimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.drawimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.destroy.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.edgeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.drawimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.drawimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.drawimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.drawimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.drawimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.drawimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.drawimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.drawimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.drawimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.drawimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.drawimage.php" hreflang="zh">
...
<meta name="Description" content="Renders the GmagickDraw object on the current image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::drawimage - Manual" />
<meta name="twitter:description" content="Renders the GmagickDraw object on the current image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::drawimage - Manual" />
<meta itemprop="description" content="Renders the GmagickDraw object on the current image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Renders the GmagickDraw object on the current image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.edgeimage.php">
          Gmagick::edgeimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.destroy.php">
          &laquo; Gmagick::destroy        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.drawimage.php' selected="selected">English</option>
            <option value='de/gmagick.drawimage.php'>German</option>
            <option value='es/gmagick.drawimage.php'>Spanish</option>
            <option value='fr/gmagick.drawimage.php'>French</option>
            <option value='it/gmagick.drawimage.php'>Italian</option>
            <option value='ja/gmagick.drawimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.drawimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.drawimage.php'>Russian</option>
            <option value='tr/gmagick.drawimage.php'>Turkish</option>
            <option value='uk/gmagick.drawimage.php'>Ukrainian</option>
            <option value='zh/gmagick.drawimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.drawimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::drawimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::drawimage</span> &mdash; <span class="dc-title">Renders the GmagickDraw object on the current image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.drawimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::drawimage</strong></span>(<span class="methodparam"><span class="type"><a href="class.gmagickdraw.php" class="type GmagickDraw">GmagickDraw</a></span> <code class="parameter">$GmagickDraw</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>

  <p class="para rdfs-comment">
    Renders the <span class="classname"><a href="class.gmagickdraw.php" class="classname">GmagickDraw</a></span> object on the current image.
  </p>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.drawimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.drawimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The drawn <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.drawimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/drawimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.drawimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.drawimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.drawimage.php">＋<small>add a note</small></a></span>
