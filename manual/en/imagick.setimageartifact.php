...
<head>
  ...
  <title>PHP: Imagick::setImageArtifact - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageartifact.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageartifact.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageartifact.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagealphachannel.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageattribute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageartifact.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageartifact.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageartifact.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageartifact.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageartifact.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageartifact.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageartifact.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageartifact.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageartifact.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageartifact.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageartifact.php" hreflang="zh">
...
<meta name="Description" content="Set image artifact" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageArtifact - Manual" />
<meta name="twitter:description" content="Set image artifact" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageArtifact - Manual" />
<meta itemprop="description" content="Set image artifact" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set image artifact" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimageattribute.php">
          Imagick::setImageAttribute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagealphachannel.php">
          &laquo; Imagick::setImageAlphaChannel        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageartifact.php' selected="selected">English</option>
            <option value='de/imagick.setimageartifact.php'>German</option>
            <option value='es/imagick.setimageartifact.php'>Spanish</option>
            <option value='fr/imagick.setimageartifact.php'>French</option>
            <option value='it/imagick.setimageartifact.php'>Italian</option>
            <option value='ja/imagick.setimageartifact.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageartifact.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageartifact.php'>Russian</option>
            <option value='tr/imagick.setimageartifact.php'>Turkish</option>
            <option value='uk/imagick.setimageartifact.php'>Ukrainian</option>
            <option value='zh/imagick.setimageartifact.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageartifact" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageArtifact</h1>
  <p class="verinfo">(PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageArtifact</span> &mdash; <span class="dc-title">Set image artifact</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimageartifact-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageArtifact</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$artifact</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Associates an artifact with the image. The difference between image properties and 
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageartifact-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageartifact-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimageartifact-errors">
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.setimageartifact-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="imagick.deleteimageartifact.php" class="function" rel="rdfs-seeAlso">Imagick::deleteImageArtifact()</a> - Delete image artifact</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageartifact.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageartifact%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageartifact&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageartifact.php">＋<small>add a note</small></a></span>
