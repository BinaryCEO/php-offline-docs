...
<head>
  ...
  <title>PHP: pspell_config_mode - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pspell-config-mode.php">
 <link rel="shorturl" href="https://www.php.net/pspell-config-mode">
 <link rel="alternate" href="https://www.php.net/pspell-config-mode" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pspell.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pspell-config-ignore.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pspell-config-personal.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pspell-config-mode.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pspell-config-mode.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pspell-config-mode.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pspell-config-mode.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pspell-config-mode.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pspell-config-mode.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pspell-config-mode.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pspell-config-mode.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pspell-config-mode.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pspell-config-mode.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pspell-config-mode.php" hreflang="zh">
...
<meta name="Description" content="Change the mode number of suggestions returned" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pspell_config_mode - Manual" />
<meta name="twitter:description" content="Change the mode number of suggestions returned" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pspell_config_mode - Manual" />
<meta itemprop="description" content="Change the mode number of suggestions returned" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Change the mode number of suggestions returned" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pspell-config-personal.php">
          pspell_config_personal &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pspell-config-ignore.php">
          &laquo; pspell_config_ignore        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pspell-config-mode.php' selected="selected">English</option>
            <option value='de/function.pspell-config-mode.php'>German</option>
            <option value='es/function.pspell-config-mode.php'>Spanish</option>
            <option value='fr/function.pspell-config-mode.php'>French</option>
            <option value='it/function.pspell-config-mode.php'>Italian</option>
            <option value='ja/function.pspell-config-mode.php'>Japanese</option>
            <option value='pt_BR/function.pspell-config-mode.php'>Brazilian Portuguese</option>
            <option value='ru/function.pspell-config-mode.php'>Russian</option>
            <option value='tr/function.pspell-config-mode.php'>Turkish</option>
            <option value='uk/function.pspell-config-mode.php'>Ukrainian</option>
            <option value='zh/function.pspell-config-mode.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pspell-config-mode" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pspell_config </span><span style="color: #007700">= </span><span style="color: #0000BB">pspell_config_create</span><span style="color: #007700">(</span><span style="color: #DD0000">"en"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">pspell_config_mode</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell_config</span><span style="color: #007700">, </span><span style="color: #0000BB">PSPELL_FAST</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$pspell </span><span style="color: #007700">= </span><span style="color: #0000BB">pspell_new_config</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell_config</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">pspell_check</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell</span><span style="color: #007700">, </span><span style="color: #DD0000">"thecat"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pspell/functions/pspell-config-mode.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pspell-config-mode%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pspell-config-mode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pspell-config-mode.php">＋<small>add a note</small></a></span>
