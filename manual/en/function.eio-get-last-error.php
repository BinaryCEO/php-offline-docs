...
<head>
  ...
  <title>PHP: eio_get_last_error - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-get-last-error.php">
 <link rel="shorturl" href="https://www.php.net/eio-get-last-error">
 <link rel="alternate" href="https://www.php.net/eio-get-last-error" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-get-event-stream.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-grp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-get-last-error.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-get-last-error.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-get-last-error.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-get-last-error.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-get-last-error.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-get-last-error.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-get-last-error.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-get-last-error.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-get-last-error.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-get-last-error.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-get-last-error.php" hreflang="zh">
...
<meta name="Description" content="Returns string describing the last error associated with a request resource" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_get_last_error - Manual" />
<meta name="twitter:description" content="Returns string describing the last error associated with a request resource" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_get_last_error - Manual" />
<meta itemprop="description" content="Returns string describing the last error associated with a request resource" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns string describing the last error associated with a request resource" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-get-last-error.php' selected="selected">English</option>
            <option value='de/function.eio-get-last-error.php'>German</option>
            <option value='es/function.eio-get-last-error.php'>Spanish</option>
            <option value='fr/function.eio-get-last-error.php'>French</option>
            <option value='it/function.eio-get-last-error.php'>Italian</option>
            <option value='ja/function.eio-get-last-error.php'>Japanese</option>
            <option value='pt_BR/function.eio-get-last-error.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-get-last-error.php'>Russian</option>
            <option value='tr/function.eio-get-last-error.php'>Turkish</option>
            <option value='uk/function.eio-get-last-error.php'>Ukrainian</option>
            <option value='zh/function.eio-get-last-error.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-get-last-error" class="refentry">
...
This function should be used at your own risk.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-get-last-error.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-get-last-error%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-get-last-error&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-get-last-error.php">＋<small>add a note</small></a></span>
