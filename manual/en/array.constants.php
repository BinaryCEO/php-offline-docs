...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/array.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/array.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/array.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.array.php">
 <link rel="next" href="https://www.php.net/manual/en/array.sorting.php">

 <link rel="alternate" href="https://www.php.net/manual/en/array.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/array.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/array.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/array.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/array.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/array.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/array.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/array.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/array.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/array.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/array.constants.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/array.constants.php' selected="selected">English</option>
            <option value='de/array.constants.php'>German</option>
            <option value='es/array.constants.php'>Spanish</option>
            <option value='fr/array.constants.php'>French</option>
            <option value='it/array.constants.php'>Italian</option>
            <option value='ja/array.constants.php'>Japanese</option>
            <option value='pt_BR/array.constants.php'>Brazilian Portuguese</option>
            <option value='ru/array.constants.php'>Russian</option>
            <option value='tr/array.constants.php'>Turkish</option>
            <option value='uk/array.constants.php'>Ukrainian</option>
            <option value='zh/array.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="array.constants" class="appendix">
   ...
   <dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Farray.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=array.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/array.constants.php">＋<small>add a note</small></a></span>
