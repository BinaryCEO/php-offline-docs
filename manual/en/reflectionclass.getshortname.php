...
<head>
  ...
  <title>PHP: ReflectionClass::getShortName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getshortname.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getshortname.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getshortname.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getreflectionconstants.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getstartline.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getshortname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getshortname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getshortname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getshortname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getshortname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getshortname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getshortname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getshortname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getshortname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getshortname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getshortname.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ReflectionClass::getShortName - Manual" />
<meta name="twitter:description" content="Gets short name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getShortName - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.getstartline.php">
          ReflectionClass::getStartLine &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getreflectionconstants.php">
          &laquo; ReflectionClass::getReflectionConstants        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getshortname.php' selected="selected">English</option>
            <option value='de/reflectionclass.getshortname.php'>German</option>
            <option value='es/reflectionclass.getshortname.php'>Spanish</option>
            <option value='fr/reflectionclass.getshortname.php'>French</option>
            <option value='it/reflectionclass.getshortname.php'>Italian</option>
            <option value='ja/reflectionclass.getshortname.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getshortname.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getshortname.php'>Russian</option>
            <option value='tr/reflectionclass.getshortname.php'>Turkish</option>
            <option value='uk/reflectionclass.getshortname.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getshortname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getshortname" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::getShortName</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getShortName</span> &mdash; <span class="dc-title">Gets short name</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.getshortname-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::getShortName</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.getshortname-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.getshortname-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.getshortname-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-5489">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionClass::getShortName()</strong></span> example</strong></p>
...
string(3) &quot;Foo&quot;</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.getshortname-seealso">
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.getname.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getName()</a> - Gets class name</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getshortname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getshortname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getshortname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getshortname.php">＋<small>add a note</small></a></span>
