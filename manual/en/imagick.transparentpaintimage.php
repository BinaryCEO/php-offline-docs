...
<head>
  ...
  <title>PHP: Imagick::transparentPaintImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.transparentpaintimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.transparentpaintimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.transparentpaintimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.transformimagecolorspace.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.transposeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.transparentpaintimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.transparentpaintimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.transparentpaintimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.transparentpaintimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.transparentpaintimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.transparentpaintimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.transparentpaintimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.transparentpaintimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.transparentpaintimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.transparentpaintimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.transparentpaintimage.php" hreflang="zh">
...
<meta name="Description" content="Paints pixels transparent" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::transparentPaintImage - Manual" />
<meta name="twitter:description" content="Paints pixels transparent" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::transparentPaintImage - Manual" />
<meta itemprop="description" content="Paints pixels transparent" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Paints pixels transparent" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.transposeimage.php">
          Imagick::transposeImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.transformimagecolorspace.php">
          &laquo; Imagick::transformImageColorspace        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.transparentpaintimage.php' selected="selected">English</option>
            <option value='de/imagick.transparentpaintimage.php'>German</option>
            <option value='es/imagick.transparentpaintimage.php'>Spanish</option>
            <option value='fr/imagick.transparentpaintimage.php'>French</option>
            <option value='it/imagick.transparentpaintimage.php'>Italian</option>
            <option value='ja/imagick.transparentpaintimage.php'>Japanese</option>
            <option value='pt_BR/imagick.transparentpaintimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.transparentpaintimage.php'>Russian</option>
            <option value='tr/imagick.transparentpaintimage.php'>Turkish</option>
            <option value='uk/imagick.transparentpaintimage.php'>Ukrainian</option>
            <option value='zh/imagick.transparentpaintimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.transparentpaintimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::transparentPaintImage</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::transparentPaintImage</span> &mdash; <span class="dc-title">Paints pixels transparent</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.transparentpaintimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::transparentPaintImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$target</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$alpha</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$fuzz</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$invert</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.transparentpaintimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.transparentpaintimage-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.transparentpaintimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3136">
      <p><strong>Example #1  <span class="function"><strong>Imagick::transparentPaintImage()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">transparentPaintImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$color</span><span style="color: #007700">, </span><span style="color: #0000BB">$alpha</span><span style="color: #007700">, </span><span style="color: #0000BB">$fuzz</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #DD0000">"images/BlueScreen.jpg"</span><span style="color: #007700">));<br /><br />    </span><span style="color: #FF8000">//Need to be in a format that supports transparency<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setimageformat</span><span style="color: #007700">(</span><span style="color: #DD0000">'png'</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">transparentPaintImage</span><span style="color: #007700">(<br />        </span><span style="color: #0000BB">$color</span><span style="color: #007700">, </span><span style="color: #0000BB">$alpha</span><span style="color: #007700">, </span><span style="color: #0000BB">$fuzz </span><span style="color: #007700">* </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">getQuantum</span><span style="color: #007700">(), </span><span style="color: #0000BB">false<br />    </span><span style="color: #007700">);<br /><br />    </span><span style="color: #FF8000">//Not required, but helps tidy up left over pixels<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">despeckleimage</span><span style="color: #007700">();<br /><br />    </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />    echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/transparentpaintimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.transparentpaintimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.transparentpaintimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.transparentpaintimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="129267">  <div class="votes">
    <div id="Vu129267">
    <a href="/manual/vote-note.php?id=129267&amp;page=imagick.transparentpaintimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129267">
    <a href="/manual/vote-note.php?id=129267&amp;page=imagick.transparentpaintimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129267" title="100% like this...">
    1
    </div>
  </div>
  <a href="#129267" class="name">
  <strong class="user"><em>josecarlosphp</em></strong></a><a class="genanchor" href="#129267"> &para;</a><div class="date" title="2024-02-21 12:14"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129267">
<div class="phpcode"><code><span class="html">The $color parameter can be a string like this:<br /><br />"rgb(255, 255, 255)"<br /><br />As you can guess, that example represents white color.<br />"rgb" indicates red-green-blue, and numeric values are amounts for each, from 0 to 255.<br /><br />Black color it will be "rgb(0, 0, 0)".<br />Full red color it will be "rgb(255, 0, 0)".</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.transparentpaintimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.transparentpaintimage.php">＋<small>add a note</small></a></div>
