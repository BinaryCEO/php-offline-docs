...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.getarchiveflag.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.getarchiveflag.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.getarchiveflag.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.getarchivecomment.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.getcommentindex.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.getarchiveflag.php' selected="selected">English</option>
            <option value='de/ziparchive.getarchiveflag.php'>German</option>
 ...
 <div class="refsect1 examples" id="refsect1-ziparchive.getarchiveflag-examples">
  ...
  <div class="example" id="example-924">
   <p><strong>Example #1 Test if archive is a torrentzip format</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="ziparchive.setarchiveflag.php" class="methodname" rel="rdfs-seeAlso">ZipArchive::setArchiveFlag()</a> - Set a global flag of a ZIP archive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/getarchiveflag.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.getarchiveflag%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.getarchiveflag&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.getarchiveflag.php">＋<small>add a note</small></a></span>
