...
<head>
  ...
  <title>PHP: ImagickDraw::polyline - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.polyline.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.polyline.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.polyline.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.polygon.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pop.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.polyline.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.polyline.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.polyline.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.polyline.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.polyline.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.polyline.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.polyline.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.polyline.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.polyline.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.polyline.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.polyline.php" hreflang="zh">
...
<meta name="Description" content="Draws a polyline" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::polyline - Manual" />
<meta name="twitter:description" content="Draws a polyline" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::polyline - Manual" />
<meta itemprop="description" content="Draws a polyline" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws a polyline" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.pop.php">
          ImagickDraw::pop &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.polygon.php">
          &laquo; ImagickDraw::polygon        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.polyline.php' selected="selected">English</option>
            <option value='de/imagickdraw.polyline.php'>German</option>
            <option value='es/imagickdraw.polyline.php'>Spanish</option>
            <option value='fr/imagickdraw.polyline.php'>French</option>
            <option value='it/imagickdraw.polyline.php'>Italian</option>
            <option value='ja/imagickdraw.polyline.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.polyline.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.polyline.php'>Russian</option>
            <option value='tr/imagickdraw.polyline.php'>Turkish</option>
            <option value='uk/imagickdraw.polyline.php'>Ukrainian</option>
            <option value='zh/imagickdraw.polyline.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.polyline" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::polyline</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::polyline</span> &mdash; <span class="dc-title">Draws a polyline</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.polyline-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::polyline</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$coordinates</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.polyline-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.polyline-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3159">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/polyline.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.polyline%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.polyline&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.polyline.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="98368">  <div class="votes">
    <div id="Vu98368">
    <a href="/manual/vote-note.php?id=98368&amp;page=imagickdraw.polyline&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98368">
    <a href="/manual/vote-note.php?id=98368&amp;page=imagickdraw.polyline&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98368" title="100% like this...">
    1
    </div>
  </div>
  <a href="#98368" class="name">
  <strong class="user"><em>kris at blackpepper dot co dot nz</em></strong></a><a class="genanchor" href="#98368"> &para;</a><div class="date" title="2010-06-10 08:51"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98368">
<div class="phpcode"><code><span class="html">draw a filled Isosceles Triangle
<br />
<br /><span class="default">&lt;?php
<br />$width </span><span class="keyword">=  </span><span class="default">601</span><span class="keyword">;
<br /></span><span class="default">$height </span><span class="keyword">= </span><span class="default">601</span><span class="keyword">;
<br />
<br /></span><span class="default">$max_x </span><span class="keyword">= </span><span class="default">$width  </span><span class="keyword">- </span><span class="default">1</span><span class="keyword">;
<br /></span><span class="default">$max_y </span><span class="keyword">= </span><span class="default">$height </span><span class="keyword">- </span><span class="default">1</span><span class="keyword">;
<br /></span><span class="default">$mid_y </span><span class="keyword">= </span><span class="default">$max_y </span><span class="keyword">/ </span><span class="default">2</span><span class="keyword">;
<br /></span><span class="default">$mid_x </span><span class="keyword">= </span><span class="default">$max_x </span><span class="keyword">/ </span><span class="default">2</span><span class="keyword">;
<br />
<br /></span><span class="default">$fillcolor </span><span class="keyword">= </span><span class="string">'#F00F00'</span><span class="keyword">;
<br />
<br />try {
<br />        </span><span class="default">$lo_img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();
<br />        </span><span class="default">$lo_img</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">( </span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'transparent'</span><span class="keyword">));
<br />        
<br />        </span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();
<br />        
<br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="default">$fillcolor</span><span class="keyword">);
...
<br />        
<br />        
<br />                            </span><span class="comment">//start point                  //end point    
<br />        </span><span class="default">$co_ords </span><span class="keyword">= array( array( </span><span class="string">'x' </span><span class="keyword">=&gt; </span><span class="default">$mid_x</span><span class="keyword">, </span><span class="string">'y' </span><span class="keyword">=&gt; </span><span class="default">0 </span><span class="keyword">),array(</span><span class="string">'x'</span><span class="keyword">=&gt;</span><span class="default">0</span><span class="keyword">,</span><span class="string">'y'</span><span class="keyword">=&gt;</span><span class="default">$max_y</span><span class="keyword">)
<br />                ,array( </span><span class="string">'x' </span><span class="keyword">=&gt; </span><span class="default">0</span><span class="keyword">, </span><span class="string">'y' </span><span class="keyword">=&gt; </span><span class="default">$max_y </span><span class="keyword">),array(</span><span class="string">'x'</span><span class="keyword">=&gt;</span><span class="default">$max_x</span><span class="keyword">,</span><span class="string">'y'</span><span class="keyword">=&gt;</span><span class="default">$max_y</span><span class="keyword">)
<br />                 ,array( </span><span class="string">'x' </span><span class="keyword">=&gt; </span><span class="default">$mid_x</span><span class="keyword">, </span><span class="string">'y' </span><span class="keyword">=&gt; </span><span class="default">0 </span><span class="keyword">),array(</span><span class="string">'x'</span><span class="keyword">=&gt;</span><span class="default">$max_x</span><span class="keyword">,</span><span class="string">'y'</span><span class="keyword">=&gt;</span><span class="default">$max_y</span><span class="keyword">)
<br />                );
<br />        
<br />        
<br />        
<br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">polyline</span><span class="keyword">(</span><span class="default">$co_ords</span><span class="keyword">);
<br />
<br />        </span><span class="default">$lo_img</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">( </span><span class="default">$draw </span><span class="keyword">);
<br />        
<br />        </span><span class="default">$lo_img</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">( </span><span class="string">"png" </span><span class="keyword">);
<br />        
<br />        
...
<br />        echo </span><span class="default">$lo_img</span><span class="keyword">;
<br />        
<br />        </span><span class="default">$lo_img</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">();
<br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">();
<br />        exit;
<br />        
<br />    } catch (</span><span class="default">Exception $ex</span><span class="keyword">) {
<br />        </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$ex</span><span class="keyword">);
<br />        return;
<br />    }
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.polyline&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.polyline.php">＋<small>add a note</small></a></div>
