...
<head>
  ...
  <title>PHP: odbc_next_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-next-result.php">
 <link rel="shorturl" href="https://www.php.net/odbc-next-result">
 <link rel="alternate" href="https://www.php.net/odbc-next-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-longreadlen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-num-fields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-next-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-next-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-next-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-next-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-next-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-next-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-next-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-next-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-next-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-next-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-next-result.php" hreflang="zh">
...
<meta name="Description" content="Checks if multiple results are available" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_next_result - Manual" />
<meta name="twitter:description" content="Checks if multiple results are available" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_next_result - Manual" />
<meta itemprop="description" content="Checks if multiple results are available" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if multiple results are available" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.odbc-num-fields.php">
          odbc_num_fields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-longreadlen.php">
          &laquo; odbc_longreadlen        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-next-result.php' selected="selected">English</option>
            <option value='de/function.odbc-next-result.php'>German</option>
            <option value='es/function.odbc-next-result.php'>Spanish</option>
            <option value='fr/function.odbc-next-result.php'>French</option>
            <option value='it/function.odbc-next-result.php'>Italian</option>
            <option value='ja/function.odbc-next-result.php'>Japanese</option>
            <option value='pt_BR/function.odbc-next-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-next-result.php'>Russian</option>
            <option value='tr/function.odbc-next-result.php'>Turkish</option>
            <option value='uk/function.odbc-next-result.php'>Ukrainian</option>
            <option value='zh/function.odbc-next-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-next-result" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">odbc_next_result</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">odbc_next_result</span> &mdash; <span class="dc-title">Checks if multiple results are available</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.odbc-next-result-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>odbc_next_result</strong></span>(<span class="methodparam"><span class="type">Odbc\Result</span> <code class="parameter">$statement</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Checks if there are more result sets available as well as allowing access
   to the next result set via <span class="function"><a href="function.odbc-fetch-array.php" class="function">odbc_fetch_array()</a></span>,
   <span class="function"><a href="function.odbc-fetch-row.php" class="function">odbc_fetch_row()</a></span>, <span class="function"><a href="function.odbc-result.php" class="function">odbc_result()</a></span>, etc.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-next-result-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if there are more result sets, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.odbc-next-result-changelog">
...
<div class="examplescode"><pre class="examplescode">Dump first result set array(1) {
  [&quot;A&quot;]=&gt;
  string(1) &quot;A&quot;
}
bool(false)
...
bool(false)
Try for a fourth result set bool(false)</pre>
</div>
    </div>
   </div>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-next-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-next-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-next-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-next-result.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="66761">  <div class="votes">
    <div id="Vu66761">
    <a href="/manual/vote-note.php?id=66761&amp;page=function.odbc-next-result&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd66761">
    <a href="/manual/vote-note.php?id=66761&amp;page=function.odbc-next-result&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V66761" title="100% like this...">
    2
    </div>
  </div>
  <a href="#66761" class="name">
  <strong class="user"><em>mypsuedoemail at yahoo dot com</em></strong></a><a class="genanchor" href="#66761"> &para;</a><div class="date" title="2006-05-28 05:06"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom66761">
<div class="phpcode"><code><span class="html">This function works exactly like its equivalent Microsoft SQL Server function: mssql_next_result(). The information above is rather vague and a bit misleading, so refer to the mssql version of this function for details on to use it properly.<br /><br />P.S. It works with stored procedures.</span></code></div>
  </div>
 </div>
  <div class="note" id="112080">  <div class="votes">
    <div id="Vu112080">
    <a href="/manual/vote-note.php?id=112080&amp;page=function.odbc-next-result&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112080">
    <a href="/manual/vote-note.php?id=112080&amp;page=function.odbc-next-result&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112080" title="57% like this...">
    1
    </div>
  </div>
  <a href="#112080" class="name">
  <strong class="user"><em>carlosgoce AT gmail DOT com</em></strong></a><a class="genanchor" href="#112080"> &para;</a><div class="date" title="2013-04-30 04:27"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112080">
<div class="phpcode"><code><span class="html">Using dbase always returns false or -1. It won't work. Just like odbc_num_rows.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.odbc-next-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-next-result.php">＋<small>add a note</small></a></div>
