...
<head>
  ...
  <title>PHP: imap_undelete - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-undelete.php">
 <link rel="shorturl" href="https://www.php.net/imap-undelete">
 <link rel="alternate" href="https://www.php.net/imap-undelete" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-uid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-unsubscribe.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-undelete.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-undelete.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-undelete.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-undelete.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-undelete.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-undelete.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-undelete.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-undelete.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-undelete.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-undelete.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-undelete.php" hreflang="zh">
...
<meta name="Description" content="Unmark the message which is marked deleted" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_undelete - Manual" />
<meta name="twitter:description" content="Unmark the message which is marked deleted" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_undelete - Manual" />
<meta itemprop="description" content="Unmark the message which is marked deleted" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Unmark the message which is marked deleted" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-unsubscribe.php">
          imap_unsubscribe &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-uid.php">
          &laquo; imap_uid        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-undelete.php' selected="selected">English</option>
            <option value='de/function.imap-undelete.php'>German</option>
            <option value='es/function.imap-undelete.php'>Spanish</option>
            <option value='fr/function.imap-undelete.php'>French</option>
            <option value='it/function.imap-undelete.php'>Italian</option>
            <option value='ja/function.imap-undelete.php'>Japanese</option>
            <option value='pt_BR/function.imap-undelete.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-undelete.php'>Russian</option>
            <option value='tr/function.imap-undelete.php'>Turkish</option>
            <option value='uk/function.imap-undelete.php'>Ukrainian</option>
            <option value='zh/function.imap-undelete.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-undelete" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_undelete</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_undelete</span> &mdash; <span class="dc-title">Unmark the message which is marked deleted</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-undelete-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_undelete</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message_nums</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>

  <p class="para rdfs-comment">
   Removes the deletion flag for a specified message, which is set by
   <span class="function"><a href="function.imap-delete.php" class="function">imap_delete()</a></span> or <span class="function"><a href="function.imap-mail-move.php" class="function">imap_mail_move()</a></span>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imap-undelete-parameters">
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-undelete-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imap-undelete-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-undelete-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-delete.php" class="function" rel="rdfs-seeAlso">imap_delete()</a> - Mark a message for deletion from current mailbox</span></li>
    <li><span class="function"><a href="function.imap-mail-move.php" class="function" rel="rdfs-seeAlso">imap_mail_move()</a> - Move specified messages to a mailbox</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-undelete.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-undelete%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-undelete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-undelete.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="80109">  <div class="votes">
    <div id="Vu80109">
    <a href="/manual/vote-note.php?id=80109&amp;page=function.imap-undelete&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd80109">
    <a href="/manual/vote-note.php?id=80109&amp;page=function.imap-undelete&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V80109" title="50% like this...">
    0
    </div>
  </div>
  <a href="#80109" class="name">
  <strong class="user"><em>phrank</em></strong></a><a class="genanchor" href="#80109"> &para;</a><div class="date" title="2007-12-29 03:47"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom80109">
<div class="phpcode"><code><span class="html">If you need to use the uid instead of msgno use<br /><br />imap_clearflag_full($stream, implode(',', $flags), '\\DELETED', ST_UID);</span></code></div>
  </div>
 </div>
  <div class="note" id="79264">  <div class="votes">
    <div id="Vu79264">
    <a href="/manual/vote-note.php?id=79264&amp;page=function.imap-undelete&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd79264">
    <a href="/manual/vote-note.php?id=79264&amp;page=function.imap-undelete&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V79264" title="no votes...">
    0
    </div>
  </div>
  <a href="#79264" class="name">
  <strong class="user"><em>rdi at nospam dot donireland dot com</em></strong></a><a class="genanchor" href="#79264"> &para;</a><div class="date" title="2007-11-18 07:18"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom79264">
<div class="phpcode"><code><span class="html">The imap_delete function allows the option to use a UID for the message number but the imap_undelete function does not.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-undelete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-undelete.php">＋<small>add a note</small></a></div>
