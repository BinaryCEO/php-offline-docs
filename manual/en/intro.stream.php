...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.stream.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.stream.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.stream.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.stream.php">
 <link rel="next" href="https://www.php.net/manual/en/stream.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.stream.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.stream.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.stream.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.stream.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.stream.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.stream.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.stream.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.stream.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.stream.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.stream.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.stream.php" hreflang="zh">
...
<div id="layout" class="clearfix">
  ...
  <div class="page-tools">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.stream.php' selected="selected">English</option>
            <option value='de/intro.stream.php'>German</option>
            <option value='es/intro.stream.php'>Spanish</option>
            <option value='fr/intro.stream.php'>French</option>
            <option value='it/intro.stream.php'>Italian</option>
            <option value='ja/intro.stream.php'>Japanese</option>
            <option value='pt_BR/intro.stream.php'>Brazilian Portuguese</option>
            <option value='ru/intro.stream.php'>Russian</option>
            <option value='tr/intro.stream.php'>Turkish</option>
            <option value='uk/intro.stream.php'>Ukrainian</option>
            <option value='zh/intro.stream.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.stream" class="preface">
   ...
   <p class="simpara">
    ...
    built into PHP by default (See <a href="wrappers.php" class="xref">Supported Protocols and Wrappers</a>),
    ...
    <ul class="itemizedlist">
     <li class="listitem">
      <span class="simpara">
       ...
       <a href="wrappers.php" class="xref">Supported Protocols and Wrappers</a> for a list of PHP built-in wrappers.  If
     ...
     <li class="listitem">
      <span class="simpara">
       ...
       <a href="wrappers.php" class="xref">Supported Protocols and Wrappers</a> for a description of targets for built-in streams.
      </span>
     </li>
    </ul>
   </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.stream%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.stream&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.stream.php">＋<small>add a note</small></a></span>
