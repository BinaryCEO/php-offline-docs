...
<head>
  ...
  <title>PHP: stats_rand_gen_normal - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-rand-gen-normal.php">
 <link rel="shorturl" href="https://www.php.net/stats-rand-gen-normal">
 <link rel="alternate" href="https://www.php.net/stats-rand-gen-normal" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-rand-gen-noncentral-t.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-rand-gen-t.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-rand-gen-normal.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-rand-gen-normal.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-rand-gen-normal.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-rand-gen-normal.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-rand-gen-normal.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-rand-gen-normal.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-rand-gen-normal.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-rand-gen-normal.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-rand-gen-normal.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-rand-gen-normal.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-rand-gen-normal.php" hreflang="zh">
...
<meta name="Description" content="Generates a single random deviate from a normal distribution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_rand_gen_normal - Manual" />
<meta name="twitter:description" content="Generates a single random deviate from a normal distribution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_rand_gen_normal - Manual" />
<meta itemprop="description" content="Generates a single random deviate from a normal distribution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generates a single random deviate from a normal distribution" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stats-rand-gen-t.php">
          stats_rand_gen_t &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-rand-gen-noncentral-t.php">
          &laquo; stats_rand_gen_noncentral_t        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-rand-gen-normal.php' selected="selected">English</option>
            <option value='de/function.stats-rand-gen-normal.php'>German</option>
            <option value='es/function.stats-rand-gen-normal.php'>Spanish</option>
            <option value='fr/function.stats-rand-gen-normal.php'>French</option>
            <option value='it/function.stats-rand-gen-normal.php'>Italian</option>
            <option value='ja/function.stats-rand-gen-normal.php'>Japanese</option>
            <option value='pt_BR/function.stats-rand-gen-normal.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-rand-gen-normal.php'>Russian</option>
            <option value='tr/function.stats-rand-gen-normal.php'>Turkish</option>
            <option value='uk/function.stats-rand-gen-normal.php'>Ukrainian</option>
            <option value='zh/function.stats-rand-gen-normal.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-rand-gen-normal" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_rand_gen_normal</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_rand_gen_normal</span> &mdash; <span class="dc-title">Generates a single random deviate from a normal distribution</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-rand-gen-normal-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_rand_gen_normal</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$av</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$sd</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>

  <p class="para rdfs-comment">
   Returns a random deviate from the normal distribution with mean, <code class="parameter">av</code>, and standard deviation,
   <code class="parameter">sd</code>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.stats-rand-gen-normal-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-rand-gen-normal-returnvalues">
  ...
  <p class="para">
   A random deviate
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-rand-gen-normal.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-rand-gen-normal%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-rand-gen-normal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-rand-gen-normal.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125061">  <div class="votes">
    <div id="Vu125061">
    <a href="/manual/vote-note.php?id=125061&amp;page=function.stats-rand-gen-normal&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125061">
    <a href="/manual/vote-note.php?id=125061&amp;page=function.stats-rand-gen-normal&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125061" title="85% like this...">
    5
    </div>
  </div>
  <a href="#125061" class="name">
  <strong class="user"><em>KEINOS</em></strong></a><a class="genanchor" href="#125061"> &para;</a><div class="date" title="2020-05-31 04:33"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125061">
<div class="phpcode"><code><span class="html">Alternative of "stats_rand_gen_normal()".<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">/**<br /> * "Box–Muller transform" based random deviate generator.<br /> *<br /> * @ref <a href="https://en.wikipedia.org/wiki/Box%E2%80%93Muller_transform" rel="nofollow" target="_blank">https://en.wikipedia.org/wiki/Box%E2%80%93Muller_transform</a><br /> * <br /> * @param  float|int $av Average/Mean<br /> * @param  float|int $sd Standard deviation<br /> * @return float<br /> */<br /></span><span class="keyword">if (! </span><span class="default">function_exists</span><span class="keyword">(</span><span class="string">'stats_rand_gen_normal'</span><span class="keyword">)) {<br />    function </span><span class="default">stats_rand_gen_normal</span><span class="keyword">(</span><span class="default">$av</span><span class="keyword">, </span><span class="default">$sd</span><span class="keyword">): </span><span class="default">float<br />    </span><span class="keyword">{<br />        </span><span class="default">$x </span><span class="keyword">= </span><span class="default">mt_rand</span><span class="keyword">() / </span><span class="default">mt_getrandmax</span><span class="keyword">();<br />        </span><span class="default">$y </span><span class="keyword">= </span><span class="default">mt_rand</span><span class="keyword">() / </span><span class="default">mt_getrandmax</span><span class="keyword">();<br />    <br />        return </span><span class="default">sqrt</span><span class="keyword">(-</span><span class="default">2 </span><span class="keyword">* </span><span class="default">log</span><span class="keyword">(</span><span class="default">$x</span><span class="keyword">)) * </span><span class="default">cos</span><span class="keyword">(</span><span class="default">2 </span><span class="keyword">* </span><span class="default">pi</span><span class="keyword">() * </span><span class="default">$y</span><span class="keyword">) * </span><span class="default">$sd </span><span class="keyword">+ </span><span class="default">$av</span><span class="keyword">;<br />    }<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stats-rand-gen-normal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-rand-gen-normal.php">＋<small>add a note</small></a></div>
