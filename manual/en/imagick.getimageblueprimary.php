...
<head>
  ...
  <title>PHP: Imagick::getImageBluePrimary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageblueprimary.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageblueprimary.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageblueprimary.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageblob.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagebordercolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageblueprimary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageblueprimary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageblueprimary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageblueprimary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageblueprimary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageblueprimary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageblueprimary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageblueprimary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageblueprimary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageblueprimary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageblueprimary.php" hreflang="zh">
...
<meta name="Description" content="Returns the chromaticy blue primary point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageBluePrimary - Manual" />
<meta name="twitter:description" content="Returns the chromaticy blue primary point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageBluePrimary - Manual" />
<meta itemprop="description" content="Returns the chromaticy blue primary point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the chromaticy blue primary point" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagebordercolor.php">
          Imagick::getImageBorderColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageblob.php">
          &laquo; Imagick::getImageBlob        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageblueprimary.php' selected="selected">English</option>
            <option value='de/imagick.getimageblueprimary.php'>German</option>
            <option value='es/imagick.getimageblueprimary.php'>Spanish</option>
            <option value='fr/imagick.getimageblueprimary.php'>French</option>
            <option value='it/imagick.getimageblueprimary.php'>Italian</option>
            <option value='ja/imagick.getimageblueprimary.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageblueprimary.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageblueprimary.php'>Russian</option>
            <option value='tr/imagick.getimageblueprimary.php'>Turkish</option>
            <option value='uk/imagick.getimageblueprimary.php'>Ukrainian</option>
            <option value='zh/imagick.getimageblueprimary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageblueprimary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageBluePrimary</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageBluePrimary</span> &mdash; <span class="dc-title">Returns the chromaticy blue primary point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimageblueprimary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageBluePrimary</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimageblueprimary-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageblueprimary-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimageblueprimary-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageblueprimary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageblueprimary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageblueprimary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageblueprimary.php">＋<small>add a note</small></a></span>
