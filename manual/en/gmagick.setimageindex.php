...
<head>
  ...
  <title>PHP: Gmagick::setimageindex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimageindex.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimageindex.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageindex.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimagegreenprimary.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimageinterlacescheme.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageindex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimageindex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimageindex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimageindex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimageindex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimageindex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimageindex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimageindex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimageindex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimageindex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimageindex.php" hreflang="zh">
...
<meta name="Description" content="Set the iterator to the position in the image list specified with the index parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::setimageindex - Manual" />
<meta name="twitter:description" content="Set the iterator to the position in the image list specified with the index parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimageindex - Manual" />
<meta itemprop="description" content="Set the iterator to the position in the image list specified with the index parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the iterator to the position in the image list specified with the index parameter" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.setimageinterlacescheme.php">
          Gmagick::setimageinterlacescheme &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimagegreenprimary.php">
          &laquo; Gmagick::setimagegreenprimary        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimageindex.php' selected="selected">English</option>
            <option value='de/gmagick.setimageindex.php'>German</option>
            <option value='es/gmagick.setimageindex.php'>Spanish</option>
            <option value='fr/gmagick.setimageindex.php'>French</option>
            <option value='it/gmagick.setimageindex.php'>Italian</option>
            <option value='ja/gmagick.setimageindex.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimageindex.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimageindex.php'>Russian</option>
            <option value='tr/gmagick.setimageindex.php'>Turkish</option>
            <option value='uk/gmagick.setimageindex.php'>Ukrainian</option>
            <option value='zh/gmagick.setimageindex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimageindex" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimageindex</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimageindex</span> &mdash; <span class="dc-title">Set the iterator to the position in the image list specified with the index parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimageindex-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimageindex</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimageindex-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimageindex-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimageindex-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimageindex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimageindex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimageindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimageindex.php">＋<small>add a note</small></a></span>
