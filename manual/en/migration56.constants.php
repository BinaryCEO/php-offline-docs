...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration56.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration56.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration56.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration56.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration56.extensions.php">
 <link rel="next" href="https://www.php.net/manual/en/debugger.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration56.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration56.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration56.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration56.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration56.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration56.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration56.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration56.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration56.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration56.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration56.constants.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="debugger.php">
          Debugging in PHP &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="migration56.extensions.php">
          &laquo; Other changes to extensions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration56.constants.php' selected="selected">English</option>
            <option value='de/migration56.constants.php'>German</option>
            <option value='es/migration56.constants.php'>Spanish</option>
            <option value='fr/migration56.constants.php'>French</option>
            <option value='it/migration56.constants.php'>Italian</option>
            <option value='ja/migration56.constants.php'>Japanese</option>
            <option value='pt_BR/migration56.constants.php'>Brazilian Portuguese</option>
            <option value='ru/migration56.constants.php'>Russian</option>
            <option value='tr/migration56.constants.php'>Turkish</option>
            <option value='uk/migration56.constants.php'>Ukrainian</option>
            <option value='zh/migration56.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration56.constants" class="sect1">
 <h2 class="title">New global constants</h2>

 <div class="sect2" id="migration56.constants.gd">
  <h3 class="title"><a href="book.image.php" class="link">GD</a></h3>

  <ul class="itemizedlist">
   <li class="listitem">
    <span class="simpara">
     <strong><code><a href="image.constants.php#constant.img-webp">IMG_WEBP</a></code></strong> (as of PHP 5.6.25)
    </span>
   </li>
  </ul>
 </div>

 <div class="sect2" id="migration56.constants.ldap">
 ...
 <div class="sect2" id="migration56.constants.openssl">
 ...
 <div class="sect2" id="migration56.constants.pgsql">
    ...
    <span class="simpara">
     <strong><code><a href="pgsql.constants.php#constant.pgsql-polling-writing">PGSQL_POLLING_WRITING</a></code></strong>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration56/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration56.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration56.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration56.constants.php">＋<small>add a note</small></a></span>
