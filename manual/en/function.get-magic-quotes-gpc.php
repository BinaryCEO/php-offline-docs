...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.get-magic-quotes-gpc.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.get-loaded-extensions.php">
 <link rel="next" href="https://www.php.net/manual/en/function.get-magic-quotes-runtime.php">
...
<meta name="Description" content="Gets the current configuration setting of magic_quotes_gpc" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: get_magic_quotes_gpc - Manual" />
<meta name="twitter:description" content="Gets the current configuration setting of magic_quotes_gpc" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: get_magic_quotes_gpc - Manual" />
<meta itemprop="description" content="Gets the current configuration setting of magic_quotes_gpc" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the current configuration setting of magic_quotes_gpc" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.get-magic-quotes-gpc.php' selected="selected">English</option>
            <option value='de/function.get-magic-quotes-gpc.php'>German</option>
            <option value='es/function.get-magic-quotes-gpc.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7)</p><p class="refpurpose"><span class="refname">get_magic_quotes_gpc</span> &mdash; <span class="dc-title">Gets the current configuration setting of magic_quotes_gpc</span></p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.get-magic-quotes-gpc-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.get-magic-quotes-runtime.php" class="function" rel="rdfs-seeAlso">get_magic_quotes_runtime()</a> - Gets the current active configuration setting of magic_quotes_runtime</span></li>
    <li><span class="function"><a href="function.ini-get.php" class="function" rel="rdfs-seeAlso">ini_get()</a> - Gets the value of a configuration option</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/get-magic-quotes-gpc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.get-magic-quotes-gpc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.get-magic-quotes-gpc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-magic-quotes-gpc.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>eltehaem at poczta dot onet dot pl</em></strong></a><a class="genanchor" href="#47733"> &para;</a><div class="date" title="2004-11-26 02:58"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom47733">
<div class="phpcode"><code><span class="html">Please note, that when magic_quotes_gpc is set not only $_POST, $_GET, $_REQUEST, $_COOKIE arrays values are slashed. Actually every string value in $GLOBALS array is slashed, ie. $GLOBALS['_SERVER']['PATH_INFO'] (or $_SERVER['PATH_INFO']).</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>slonmron_no_spam_please_ at yahoo dot com</em></strong></a><a class="genanchor" href="#71573"> &para;</a><div class="date" title="2006-12-06 06:32"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom71573">
<div class="phpcode"><code><span class="html">Re: php at kaiundina dot de (03-Feb-2005 02:18)<br /><br />1. magic_quotes_gpc=on/off and magic_quotes_sybase=on/off<br /><br />I made test and your function worked right. <br />These were the &lt;input ... /&gt; names I used:<br />name="a"<br />name="b.b b\b"<br />name="c[c.1]"<br />name="c[c 2]"<br />name="c[c\3]"<br />name="c.c c[c.' 4]"<br />name="c ' c[c&amp;quot;4]"<br />name="d&amp;quot;[d&amp;quot;1]"<br /><br />(I used &amp;quot; because I don't know other way to put " into the name)<br /><br />and the user-input value:<br />a ' " \ \' \" \\ a<br /><br />2. &gt; 17) The chars '.', ' ' are always replaced by '_' when used in keys.<br /><br />This is true only for the top-level keys, such as "b.b b\b", "c.c c" and "c ' c" above. The second-level key "[c.' 4]" was not changed to [c_'_4] but was escaped acording to how magic_quites_XXX are set.<br /><br />Tested on PHP 4.4.0.<br /><br />These magic_quotes are really black magic :(<br /><br />It'll be good to make test against $_SESSION, but I can't do it today.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Here's what I came up with to remove magic quotes from request data.<br /><br />Replaces two single-quotes with one if magic_quotes_sybase are on, otherwise it just strips slashes.<br /><br />Note that the `foreach` style makes this work only with PHP 5 and above.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">// Strip magic quotes from request data.<br /></span><span class="keyword">if (</span><span class="default">function_exists</span><span class="keyword">(</span><span class="string">'get_magic_quotes_gpc'</span><span class="keyword">) &amp;&amp; </span><span class="default">get_magic_quotes_gpc</span><span class="keyword">()) {<br />    </span><span class="comment">// Create lamba style unescaping function (for portability)<br />    </span><span class="default">$quotes_sybase </span><span class="keyword">= </span><span class="default">strtolower</span><span class="keyword">(</span><span class="default">ini_get</span><span class="keyword">(</span><span class="string">'magic_quotes_sybase'</span><span class="keyword">));<br />    </span><span class="default">$unescape_function </span><span class="keyword">= (empty(</span><span class="default">$quotes_sybase</span><span class="keyword">) || </span><span class="default">$quotes_sybase </span><span class="keyword">=== </span><span class="string">'off'</span><span class="keyword">) ? </span><span class="string">'stripslashes($value)' </span><span class="keyword">: </span><span class="string">'str_replace("\'\'","\'",$value)'</span><span class="keyword">;<br />    </span><span class="default">$stripslashes_deep </span><span class="keyword">= </span><span class="default">create_function</span><span class="keyword">(</span><span class="string">'&amp;$value, $fn'</span><span class="keyword">, </span><span class="string">'<br />        if (is_string($value)) {<br />            $value = ' </span><span class="keyword">. </span><span class="default">$unescape_function </span><span class="keyword">. </span><span class="string">';<br />        } else if (is_array($value)) {<br />            foreach ($value as &amp;$v) $fn($v, $fn);<br />        }<br />    '</span><span class="keyword">);<br />    <br />    </span><span class="comment">// Unescape data<br />    </span><span class="default">$stripslashes_deep</span><span class="keyword">(</span><span class="default">$_POST</span><span class="keyword">, </span><span class="default">$stripslashes_deep</span><span class="keyword">);<br />    </span><span class="default">$stripslashes_deep</span><span class="keyword">(</span><span class="default">$_GET</span><span class="keyword">, </span><span class="default">$stripslashes_deep</span><span class="keyword">);<br />    </span><span class="default">$stripslashes_deep</span><span class="keyword">(</span><span class="default">$_COOKIE</span><span class="keyword">, </span><span class="default">$stripslashes_deep</span><span class="keyword">);<br />    </span><span class="default">$stripslashes_deep</span><span class="keyword">(</span><span class="default">$_REQUEST</span><span class="keyword">, </span><span class="default">$stripslashes_deep</span><span class="keyword">);<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<br /></span><span class="keyword">function </span><span class="default">stripper</span><span class="keyword">(</span><span class="default">$stringvar</span><span class="keyword">){
<br />    if (</span><span class="default">1 </span><span class="keyword">== </span><span class="default">get_magic_quotes_gpc</span><span class="keyword">()){
<br />        </span><span class="default">$stringvar </span><span class="keyword">= </span><span class="default">stripslashes</span><span class="keyword">(</span><span class="default">$stringvar</span><span class="keyword">);
<br />    }
<br />    return </span><span class="default">$stringvar</span><span class="keyword">;
<br />}
...
<br />$Body </span><span class="keyword">= </span><span class="default">stripper</span><span class="keyword">(</span><span class="default">$rs</span><span class="keyword">-&gt;</span><span class="default">fields</span><span class="keyword">(</span><span class="string">'Body'</span><span class="keyword">));
<br />echo(</span><span class="default">$Body</span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>
<br />This checks if get_magic_quotes_gpc() is on and strips a string variable for output if its on. Useful if the dev server and live server are set up different.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">@ dot dot dot dot dot alexander at gmail dot com
<br />
...
<div class="phpcode"><code><span class="html">When you work with forms and databases you should use this concept:<br /><br />1.When inserting the user input in DB escape $_POST/$_GET with add_slashes() or similar (to match the speciffic database escape rules)<br /><br />$query='INSERT INTO users SET fullname="'.add_slashes($_POST['fullname']).'"';<br />insert_into_db($query);<br /><br />2.When reading a previously submitted input from DB use html_special_chars to display an escaped result!<br /><br />read_db_row('SELECT fullname FROM users');<br />echo '&lt;input type="text" name="fullname" value="'.html_special_chars($db_row['fullname']).'" /&gt;<br /><br />this way you safely store and work with the original(unescaped) data.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Escaping of key-strings in GPC-arrays behave different to the escaping of their values.
<br />
<br />First I expected that keys in submitted gpc-arrays are never escaped.
<br />Anyway. After I saw escaped keys, I assumed they're escaped according to the settings of magic quotes.
<br />... it's even worse...
<br />
<br />It took me over 2 days of testing to figure out the exact behavior and creating two functions (one for each php-version) that strips slashes reliably from any array submitted to a script. Hope this saves someones time and nerves.
<br />
<br />The following is true for $_GET- and $_POST-arrays. I hope other arrays affected by magic quotes behave equally.
<br />I did not test the behavior for cases where magic_quotes_sybase is set.
<br />
<br />== legend for possible case combinations ==
<br />Px = php version we're using
<br />    P4 = php 4.3.9
<br />    P5 = php 5.0.2
<br />
<br />MQ = MagicQuotes GPC
<br />    +MQ = magic quotes enabled
<br />    -MQ = magic quotes disabled
<br />
<br />TL = TopLevel key
<br />    +TL = key is on top level (i.e. $_GET['myKey'])
<br />    -TL = key is nested within another array (i.e. $_GET['myList']['myKey'])
<br />
<br />AK = ArrayKey
<br />    +AK = the value of the key is another array (i.e. is_array($_GET['myKey']) == true)
<br />    -AK = the value is a normal string (i.e. is_string($_GET['myKey']) == true)
<br />
<br />== legend for possible results ==
<br />KE = KeyEscaping
<br />    +KE = control chars are prefixed with a backslash
<br />    -KE = key is returned as submitted and needn't to be stripped
<br />
<br />VE = ValueEscaping (doesn't apply for array as value)
<br />    +VE = control chars are prefixed with a backslash
<br />    -VE = value is returned as submitted and needn't to be stripped
<br />
<br />== here we go - the following rules apply ==
<br /> 1) P4 +MQ +AK +TL --&gt; -KE
<br /> 2) P4 +MQ +AK -TL --&gt; +KE
<br /> 3) P4 +MQ -AK +TL --&gt; -KE +VE
<br /> 4) P4 +MQ -AK -TL --&gt; +KE +VE
<br /> 5) P4 -MQ +AK +TL --&gt; -KE
<br /> 6) P4 -MQ +AK -TL --&gt; -KE
<br /> 7) P4 -MQ -AK +TL --&gt; -KE -VE
<br /> 8) P4 -MQ -AK -TL --&gt; -KE -VE
<br /> 9) P5 +MQ +AK +TL --&gt; -KE
<br />10) P5 +MQ +AK -TL --&gt; +KE
<br />11) P5 +MQ -AK +TL --&gt; +KE +VE
<br />12) P5 +MQ -AK -TL --&gt; +KE +VE
<br />13) P5 -MQ +AK +TL --&gt; -KE
<br />14) P5 -MQ +AK -TL --&gt; -KE
<br />15) P5 -MQ -AK +TL --&gt; +KE -VE
<br />16) P5 -MQ -AK -TL --&gt; +KE -VE
<br />17) The chars '.', ' ' are always replaced by '_' when used in keys.
<br />
<br />Example (rule 15):
<br />When running under php 5.0.2 having magic quotes disabled, gpc-keys on top level containing strings are escaped while their associated values are not.
<br />
<br />== The following function will strip GPC-arrays for php 4.3.9 ==
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">function </span><span class="default">transcribe</span><span class="keyword">(</span><span class="default">$aList</span><span class="keyword">, </span><span class="default">$aIsTopLevel </span><span class="keyword">= </span><span class="default">true</span><span class="keyword">) {
<br />    </span><span class="default">$gpcList </span><span class="keyword">= array();
<br />    </span><span class="default">$isMagic </span><span class="keyword">= </span><span class="default">get_magic_quotes_gpc</span><span class="keyword">();
<br />    
<br />    foreach (</span><span class="default">$aList </span><span class="keyword">as </span><span class="default">$key </span><span class="keyword">=&gt; </span><span class="default">$value</span><span class="keyword">) {
<br />        </span><span class="default">$decodedKey </span><span class="keyword">= (</span><span class="default">$isMagic </span><span class="keyword">&amp;&amp; !</span><span class="default">$aIsTopLevel</span><span class="keyword">)?</span><span class="default">stripslashes</span><span class="keyword">(</span><span class="default">$key</span><span class="keyword">):</span><span class="default">$key</span><span class="keyword">;
<br />        if (</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">)) {
<br />            </span><span class="default">$decodedValue </span><span class="keyword">= </span><span class="default">transcribe</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">);
<br />        } else {
<br />            </span><span class="default">$decodedValue </span><span class="keyword">= (</span><span class="default">$isMagic</span><span class="keyword">)?</span><span class="default">stripslashes</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">):</span><span class="default">$value</span><span class="keyword">;
<br />        }
<br />        </span><span class="default">$gpcList</span><span class="keyword">[</span><span class="default">$decodedKey</span><span class="keyword">] = </span><span class="default">$decodedValue</span><span class="keyword">;
<br />    }
<br />    return </span><span class="default">$gpcList</span><span class="keyword">;
<br />}
<br /></span><span class="default">?&gt;
<br /></span>
<br />
<br />== The following function will strip GPC-arrays for php 5.0.2 ==
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">function </span><span class="default">transcribe</span><span class="keyword">(</span><span class="default">$aList</span><span class="keyword">, </span><span class="default">$aIsTopLevel </span><span class="keyword">= </span><span class="default">true</span><span class="keyword">) {
<br />    </span><span class="default">$gpcList </span><span class="keyword">= array();
<br />    </span><span class="default">$isMagic </span><span class="keyword">= </span><span class="default">get_magic_quotes_gpc</span><span class="keyword">();
...
<br />            </span><span class="default">$decodedValue </span><span class="keyword">= </span><span class="default">transcribe</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">);
<br />        } else {
<br />            </span><span class="default">$decodedKey </span><span class="keyword">= </span><span class="default">stripslashes</span><span class="keyword">(</span><span class="default">$key</span><span class="keyword">);
<br />            </span><span class="default">$decodedValue </span><span class="keyword">= (</span><span class="default">$isMagic</span><span class="keyword">)?</span><span class="default">stripslashes</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">):</span><span class="default">$value</span><span class="keyword">;
<br />        }
<br />        </span><span class="default">$gpcList</span><span class="keyword">[</span><span class="default">$decodedKey</span><span class="keyword">] = </span><span class="default">$decodedValue</span><span class="keyword">;
<br />    }
...
<br />
<br /><span class="default">&lt;?php
<br />$unstrippedGET </span><span class="keyword">= </span><span class="default">transcribe</span><span class="keyword">(</span><span class="default">$_GET</span><span class="keyword">);
<br /></span><span class="default">$unstrippedPOST </span><span class="keyword">= </span><span class="default">transcribe</span><span class="keyword">(</span><span class="default">$_POST</span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>
<br />Maybe someone is willing to test those combinations for other php-versions and with magic_quotes_sybase set to 'on' - let me know.
<br />Sorry for this huge amount of text, but it's complete. I was unable to compress the decision table more than this.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Just a little correction:<br />( Because of the ini_get function that may return a string value of "off" that evaluates to TRUE )<br /><span class="default">&lt;?php<br />        </span><span class="keyword">if(   <br />            (  </span><span class="default">function_exists</span><span class="keyword">(</span><span class="string">"get_magic_quotes_gpc"</span><span class="keyword">) &amp;&amp; </span><span class="default">get_magic_quotes_gpc</span><span class="keyword">()  )<br />             || (  </span><span class="default">ini_get</span><span class="keyword">(</span><span class="string">'magic_quotes_sybase'</span><span class="keyword">) &amp;&amp; ( </span><span class="default">strtolower</span><span class="keyword">(</span><span class="default">ini_get</span><span class="keyword">(</span><span class="string">'magic_quotes_sybase'</span><span class="keyword">)) != </span><span class="string">"off" </span><span class="keyword">)  )<br />           ){<br />            foreach(</span><span class="default">$_GET </span><span class="keyword">as </span><span class="default">$k </span><span class="keyword">=&gt; </span><span class="default">$v</span><span class="keyword">) </span><span class="default">$_GET</span><span class="keyword">[</span><span class="default">$k</span><span class="keyword">] = </span><span class="default">stripslashes</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">);<br />            foreach(</span><span class="default">$_POST </span><span class="keyword">as </span><span class="default">$k </span><span class="keyword">=&gt; </span><span class="default">$v</span><span class="keyword">) </span><span class="default">$_POST</span><span class="keyword">[</span><span class="default">$k</span><span class="keyword">] = </span><span class="default">stripslashes</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">);<br />            foreach(</span><span class="default">$_COOKIE </span><span class="keyword">as </span><span class="default">$k </span><span class="keyword">=&gt; </span><span class="default">$v</span><span class="keyword">) </span><span class="default">$_COOKIE</span><span class="keyword">[</span><span class="default">$k</span><span class="keyword">] = </span><span class="default">stripslashes</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">);<br />        }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">&gt; "If the directive magic_quotes_sybase is ON it will completely override magic_quotes_gpc."<br /><br />This "note" is a bit misleading. magic_quotes_sybase will only override the escaping method used on Get/Post/Cookie data if magic_quotes_gpc is already enabled. If magic_quotes_gpc is not enabled then magic_quotes_sybase will have no effect here.<br /><br />A few of the other comments are therefore incorrect in determining when to "stripslashes" from the input, by "stripping slashes" when either magic_quotes_gpc OR magic_quotes_sybase is enabled. You should only stripslashes() when magic_quotes_gpc is enabled since that is the only time when slashes are automatically added.<br /><br />stripslashes() is also magic_quotes_sybase aware, so you don't need to do anything special (ie. write a custom function to handle this situation as another comment suggests) when magic_quotes_sybase is enabled. When magic_quotes_sybase is enabled, stripslashes() does not actually strip any slashes, but instead unescapes single-quotes that are escaped with single-quotes only.<br /><br />magic_quotes_sybase does however influence the escaping (and unescaping) method used by addslashes() and stripslashes() respectively, regardless of whether magic_quotes_gpc (or magic_quotes_runtime) is enabled.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.get-magic-quotes-gpc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-magic-quotes-gpc.php">＋<small>add a note</small></a></div>
