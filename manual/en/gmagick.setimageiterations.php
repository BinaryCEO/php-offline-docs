...
<head>
  ...
  <title>PHP: Gmagick::setimageiterations - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimageiterations.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimageiterations.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageiterations.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimageinterlacescheme.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimageprofile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageiterations.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimageiterations.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimageiterations.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimageiterations.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimageiterations.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimageiterations.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimageiterations.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimageiterations.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimageiterations.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimageiterations.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimageiterations.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimageiterations - Manual" />
<meta name="twitter:description" content="Sets the image iterations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimageiterations - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.setimageprofile.php">
          Gmagick::setimageprofile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimageinterlacescheme.php">
          &laquo; Gmagick::setimageinterlacescheme        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimageiterations.php' selected="selected">English</option>
            <option value='de/gmagick.setimageiterations.php'>German</option>
            <option value='es/gmagick.setimageiterations.php'>Spanish</option>
            <option value='fr/gmagick.setimageiterations.php'>French</option>
            <option value='it/gmagick.setimageiterations.php'>Italian</option>
            <option value='ja/gmagick.setimageiterations.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimageiterations.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimageiterations.php'>Russian</option>
            <option value='tr/gmagick.setimageiterations.php'>Turkish</option>
            <option value='uk/gmagick.setimageiterations.php'>Ukrainian</option>
            <option value='zh/gmagick.setimageiterations.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimageiterations" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimageiterations</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimageiterations</span> &mdash; <span class="dc-title">Sets the image iterations</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimageiterations-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimageiterations</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$iterations</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimageiterations-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimageiterations-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimageiterations-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimageiterations.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimageiterations%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimageiterations&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimageiterations.php">＋<small>add a note</small></a></span>
