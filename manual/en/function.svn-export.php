...
<head>
  ...
  <title>PHP: svn_export - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-export.php">
 <link rel="shorturl" href="https://www.php.net/svn-export">
 <link rel="alternate" href="https://www.php.net/svn-export" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-diff.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-fs-abort-txn.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-export.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-export.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-export.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-export.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-export.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-export.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-export.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-export.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-export.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-export.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-export.php" hreflang="zh">
...
<meta name="Description" content="Export the contents of a SVN directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_export - Manual" />
<meta name="twitter:description" content="Export the contents of a SVN directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_export - Manual" />
<meta itemprop="description" content="Export the contents of a SVN directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Export the contents of a SVN directory" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.svn-fs-abort-txn.php">
          svn_fs_abort_txn &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.svn-diff.php">
          &laquo; svn_diff        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-export.php' selected="selected">English</option>
            <option value='de/function.svn-export.php'>German</option>
            <option value='es/function.svn-export.php'>Spanish</option>
            <option value='fr/function.svn-export.php'>French</option>
            <option value='it/function.svn-export.php'>Italian</option>
            <option value='ja/function.svn-export.php'>Japanese</option>
            <option value='pt_BR/function.svn-export.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-export.php'>Russian</option>
            <option value='tr/function.svn-export.php'>Turkish</option>
            <option value='uk/function.svn-export.php'>Ukrainian</option>
            <option value='zh/function.svn-export.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-export" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.svn-import.php" class="function" rel="rdfs-seeAlso">svn_import()</a> - Imports an unversioned path into a repository</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-export.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="104199">  <div class="votes">
    <div id="Vu104199">
    <a href="/manual/vote-note.php?id=104199&amp;page=function.svn-export&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104199">
    <a href="/manual/vote-note.php?id=104199&amp;page=function.svn-export&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104199" title="100% like this...">
    1
    </div>
  </div>
  <a href="#104199" class="name">
  <strong class="user"><em>cleung at draper dot com</em></strong></a><a class="genanchor" href="#104199"> &para;</a><div class="date" title="2011-05-31 08:15"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104199">
<div class="phpcode"><code><span class="html">This functionality is very different from the actual command line svn export url [-rRevision]<br /><br />If you are thinking about checkout out a single file at a particular version, keep looking because this export can not perform that functionality.</span></code></div>
  </div>
 </div>
  <div class="note" id="115780">  <div class="votes">
    <div id="Vu115780">
    <a href="/manual/vote-note.php?id=115780&amp;page=function.svn-export&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115780">
    <a href="/manual/vote-note.php?id=115780&amp;page=function.svn-export&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115780" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#115780" class="name">
  <strong class="user"><em>Magnum</em></strong></a><a class="genanchor" href="#115780"> &para;</a><div class="date" title="2014-09-22 09:56"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115780">
<div class="phpcode"><code><span class="html">To checkout a single file at a particular version use svn_cat .</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.svn-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-export.php">＋<small>add a note</small></a></div>
