...
<head>
  ...
  <title>PHP: SolrQuery::getMltMaxWordLength - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getmltmaxwordlength.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getmltmaxwordlength.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltmaxwordlength.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getmltmaxnumtokens.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getmltmindocfrequency.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltmaxwordlength.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getmltmaxwordlength.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getmltmaxwordlength.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getmltmaxwordlength.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getmltmaxwordlength.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getmltmaxwordlength.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getmltmaxwordlength.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getmltmaxwordlength.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getmltmaxwordlength.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getmltmaxwordlength.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getmltmaxwordlength.php" hreflang="zh">
...
<meta name="Description" content="Returns the maximum word length above which words will be ignored" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getMltMaxWordLength - Manual" />
<meta name="twitter:description" content="Returns the maximum word length above which words will be ignored" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getMltMaxWordLength - Manual" />
<meta itemprop="description" content="Returns the maximum word length above which words will be ignored" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the maximum word length above which words will be ignored" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getmltmindocfrequency.php">
          SolrQuery::getMltMinDocFrequency &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getmltmaxnumtokens.php">
          &laquo; SolrQuery::getMltMaxNumTokens        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getmltmaxwordlength.php' selected="selected">English</option>
            <option value='de/solrquery.getmltmaxwordlength.php'>German</option>
            <option value='es/solrquery.getmltmaxwordlength.php'>Spanish</option>
            <option value='fr/solrquery.getmltmaxwordlength.php'>French</option>
            <option value='it/solrquery.getmltmaxwordlength.php'>Italian</option>
            <option value='ja/solrquery.getmltmaxwordlength.php'>Japanese</option>
            <option value='pt_BR/solrquery.getmltmaxwordlength.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getmltmaxwordlength.php'>Russian</option>
            <option value='tr/solrquery.getmltmaxwordlength.php'>Turkish</option>
            <option value='uk/solrquery.getmltmaxwordlength.php'>Ukrainian</option>
            <option value='zh/solrquery.getmltmaxwordlength.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getmltmaxwordlength" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getMltMaxWordLength</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getMltMaxWordLength</span> &mdash; <span class="dc-title">Returns the maximum word length above which words will be ignored</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getmltmaxwordlength-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getMltMaxWordLength</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getmltmaxwordlength-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getmltmaxwordlength-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getmltmaxwordlength.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getmltmaxwordlength%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getmltmaxwordlength&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getmltmaxwordlength.php">＋<small>add a note</small></a></span>
