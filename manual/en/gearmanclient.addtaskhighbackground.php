...
<head>
  ...
  <title>PHP: GearmanClient::addTaskHighBackground - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.addtaskhighbackground.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.addtaskhighbackground.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.addtaskhighbackground.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.addtaskhigh.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.addtasklow.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.addtaskhighbackground.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.addtaskhighbackground.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.addtaskhighbackground.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.addtaskhighbackground.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.addtaskhighbackground.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.addtaskhighbackground.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.addtaskhighbackground.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.addtaskhighbackground.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.addtaskhighbackground.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.addtaskhighbackground.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.addtaskhighbackground.php" hreflang="zh">
...
<meta name="Description" content="Add a high priority background task to be run in parallel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::addTaskHighBackground - Manual" />
<meta name="twitter:description" content="Add a high priority background task to be run in parallel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::addTaskHighBackground - Manual" />
<meta itemprop="description" content="Add a high priority background task to be run in parallel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add a high priority background task to be run in parallel" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearmanclient.addtasklow.php">
          GearmanClient::addTaskLow &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.addtaskhigh.php">
          &laquo; GearmanClient::addTaskHigh        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.addtaskhighbackground.php' selected="selected">English</option>
            <option value='de/gearmanclient.addtaskhighbackground.php'>German</option>
            <option value='es/gearmanclient.addtaskhighbackground.php'>Spanish</option>
            <option value='fr/gearmanclient.addtaskhighbackground.php'>French</option>
            <option value='it/gearmanclient.addtaskhighbackground.php'>Italian</option>
            <option value='ja/gearmanclient.addtaskhighbackground.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.addtaskhighbackground.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.addtaskhighbackground.php'>Russian</option>
            <option value='tr/gearmanclient.addtaskhighbackground.php'>Turkish</option>
            <option value='uk/gearmanclient.addtaskhighbackground.php'>Ukrainian</option>
            <option value='zh/gearmanclient.addtaskhighbackground.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.addtaskhighbackground" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.runtasks.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::runTasks()</a> - Run a list of tasks in parallel</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/addtaskhighbackground.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.addtaskhighbackground%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.addtaskhighbackground&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.addtaskhighbackground.php">＋<small>add a note</small></a></span>
