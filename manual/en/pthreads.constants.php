...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/pthreads.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/pthreads.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/pthreads.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.pthreads.php">
 <link rel="prev" href="https://www.php.net/manual/en/pthreads.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/class.threaded.php">

 <link rel="alternate" href="https://www.php.net/manual/en/pthreads.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/pthreads.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/pthreads.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/pthreads.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/pthreads.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/pthreads.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/pthreads.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/pthreads.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/pthreads.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/pthreads.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/pthreads.constants.php" hreflang="zh">
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="class.threaded.php">
          Threaded &raquo;
              ...
              <div class="prev">
        <a href="pthreads.installation.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/pthreads.constants.php' selected="selected">English</option>
            <option value='de/pthreads.constants.php'>German</option>
            <option value='es/pthreads.constants.php'>Spanish</option>
            <option value='fr/pthreads.constants.php'>French</option>
            <option value='it/pthreads.constants.php'>Italian</option>
            <option value='ja/pthreads.constants.php'>Japanese</option>
            <option value='pt_BR/pthreads.constants.php'>Brazilian Portuguese</option>
            <option value='ru/pthreads.constants.php'>Russian</option>
            <option value='tr/pthreads.constants.php'>Turkish</option>
            <option value='uk/pthreads.constants.php'>Ukrainian</option>
            <option value='zh/pthreads.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="pthreads.constants" class="appendix">
  ...
  <dl>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pthreads/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fpthreads.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=pthreads.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pthreads.constants.php">＋<small>add a note</small></a></span>
