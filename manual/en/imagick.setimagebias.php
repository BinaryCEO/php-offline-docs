...
<head>
  ...
  <title>PHP: Imagick::setImageBias - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagebias.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagebias.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagebias.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagebackgroundcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagebiasquantum.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagebias.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagebias.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagebias.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagebias.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagebias.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagebias.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagebias.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagebias.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagebias.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagebias.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagebias.php" hreflang="zh">
...
<meta name="Description" content="Sets the image bias for any method that convolves an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageBias - Manual" />
<meta name="twitter:description" content="Sets the image bias for any method that convolves an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageBias - Manual" />
<meta itemprop="description" content="Sets the image bias for any method that convolves an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image bias for any method that convolves an image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimagebiasquantum.php">
          Imagick::setImageBiasQuantum &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagebackgroundcolor.php">
          &laquo; Imagick::setImageBackgroundColor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagebias.php' selected="selected">English</option>
            <option value='de/imagick.setimagebias.php'>German</option>
            <option value='es/imagick.setimagebias.php'>Spanish</option>
            <option value='fr/imagick.setimagebias.php'>French</option>
            <option value='it/imagick.setimagebias.php'>Italian</option>
            <option value='ja/imagick.setimagebias.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagebias.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagebias.php'>Russian</option>
            <option value='tr/imagick.setimagebias.php'>Turkish</option>
            <option value='uk/imagick.setimagebias.php'>Ukrainian</option>
            <option value='zh/imagick.setimagebias.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagebias" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageBias</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageBias</span> &mdash; <span class="dc-title">Sets the image bias for any method that convolves an image</span></p>

 </div>

 <div id="imagick.setimagebias-refsynopsisdiv">
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagebias-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">bias</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagebias-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagebias-errors">
  ...
  <p class="para">
    <div class="example" id="example-3093">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagebias.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagebias%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagebias&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagebias.php">＋<small>add a note</small></a></span>
