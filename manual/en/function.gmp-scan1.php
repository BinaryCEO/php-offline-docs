...
<head>
  ...
  <title>PHP: gmp_scan1 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-scan1.php">
 <link rel="shorturl" href="https://www.php.net/gmp-scan1">
 <link rel="alternate" href="https://www.php.net/gmp-scan1" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-scan0.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-setbit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-scan1.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-scan1.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-scan1.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-scan1.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-scan1.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-scan1.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-scan1.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-scan1.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-scan1.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-scan1.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-scan1.php" hreflang="zh">
...
<meta name="Description" content="Scan for 1" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_scan1 - Manual" />
<meta name="twitter:description" content="Scan for 1" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_scan1 - Manual" />
<meta itemprop="description" content="Scan for 1" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Scan for 1" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-scan1.php' selected="selected">English</option>
            <option value='de/function.gmp-scan1.php'>German</option>
            <option value='es/function.gmp-scan1.php'>Spanish</option>
            <option value='fr/function.gmp-scan1.php'>French</option>
            <option value='it/function.gmp-scan1.php'>Italian</option>
            <option value='ja/function.gmp-scan1.php'>Japanese</option>
            <option value='pt_BR/function.gmp-scan1.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-scan1.php'>Russian</option>
            <option value='tr/function.gmp-scan1.php'>Turkish</option>
            <option value='uk/function.gmp-scan1.php'>Ukrainian</option>
            <option value='zh/function.gmp-scan1.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-scan1" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-scan1-examples">
  ...
  <p class="para">
   <div class="example" id="example-3348">
    <p><strong>Example #1 <span class="function"><strong>gmp_scan1()</strong></span> example</strong></p>
...
9</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-scan1.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-scan1%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-scan1&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-scan1.php">＋<small>add a note</small></a></span>
