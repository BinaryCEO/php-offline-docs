...
<head>
  ...
  <title>PHP: enchant_broker_describe - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.enchant-broker-describe.php">
 <link rel="shorturl" href="https://www.php.net/enchant-broker-describe">
 <link rel="alternate" href="https://www.php.net/enchant-broker-describe" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.enchant.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.enchant.php">
 <link rel="next" href="https://www.php.net/manual/en/function.enchant-broker-dict-exists.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.enchant-broker-describe.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.enchant-broker-describe.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.enchant-broker-describe.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.enchant-broker-describe.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.enchant-broker-describe.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.enchant-broker-describe.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.enchant-broker-describe.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.enchant-broker-describe.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.enchant-broker-describe.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.enchant-broker-describe.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.enchant-broker-describe.php" hreflang="zh">
...
<meta name="Description" content="Enumerates the Enchant providers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: enchant_broker_describe - Manual" />
<meta name="twitter:description" content="Enumerates the Enchant providers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: enchant_broker_describe - Manual" />
<meta itemprop="description" content="Enumerates the Enchant providers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enumerates the Enchant providers" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.enchant-broker-dict-exists.php">
          enchant_broker_dict_exists &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.enchant.php">
          &laquo; Enchant Functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.enchant-broker-describe.php' selected="selected">English</option>
            <option value='de/function.enchant-broker-describe.php'>German</option>
            <option value='es/function.enchant-broker-describe.php'>Spanish</option>
            <option value='fr/function.enchant-broker-describe.php'>French</option>
            <option value='it/function.enchant-broker-describe.php'>Italian</option>
            <option value='ja/function.enchant-broker-describe.php'>Japanese</option>
            <option value='pt_BR/function.enchant-broker-describe.php'>Brazilian Portuguese</option>
            <option value='ru/function.enchant-broker-describe.php'>Russian</option>
            <option value='tr/function.enchant-broker-describe.php'>Turkish</option>
            <option value='uk/function.enchant-broker-describe.php'>Ukrainian</option>
            <option value='zh/function.enchant-broker-describe.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.enchant-broker-describe" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">enchant_broker_describe</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL enchant &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">enchant_broker_describe</span> &mdash; <span class="dc-title">Enumerates the Enchant providers</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.enchant-broker-describe-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>enchant_broker_describe</strong></span>(<span class="methodparam"><span class="type"><a href="class.enchantbroker.php" class="type EnchantBroker">EnchantBroker</a></span> <code class="parameter">$broker</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.enchant-broker-describe-returnvalues">
  ...
  <p class="para">
   Returns an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> of available Enchant providers with their details.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.enchant-broker-describe-changelog">
...
(
    ...
    [3] =&gt; Array
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/enchant/functions/enchant-broker-describe.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.enchant-broker-describe%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.enchant-broker-describe&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.enchant-broker-describe.php">＋<small>add a note</small></a></span>
