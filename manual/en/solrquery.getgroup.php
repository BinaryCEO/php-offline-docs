...
<head>
  ...
  <title>PHP: SolrQuery::getGroup - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getgroup.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getgroup.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroup.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfilterqueries.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getgroupcachepercent.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getgroup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getgroup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getgroup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getgroup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getgroup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getgroup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getgroup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getgroup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getgroup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getgroup.php" hreflang="zh">
...
<meta name="Description" content="Returns true if grouping is enabled" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getGroup - Manual" />
<meta name="twitter:description" content="Returns true if grouping is enabled" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getGroup - Manual" />
<meta itemprop="description" content="Returns true if grouping is enabled" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns true if grouping is enabled" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getgroupcachepercent.php">
          SolrQuery::getGroupCachePercent &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfilterqueries.php">
          &laquo; SolrQuery::getFilterQueries        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getgroup.php' selected="selected">English</option>
            <option value='de/solrquery.getgroup.php'>German</option>
            <option value='es/solrquery.getgroup.php'>Spanish</option>
            <option value='fr/solrquery.getgroup.php'>French</option>
            <option value='it/solrquery.getgroup.php'>Italian</option>
            <option value='ja/solrquery.getgroup.php'>Japanese</option>
            <option value='pt_BR/solrquery.getgroup.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getgroup.php'>Russian</option>
            <option value='tr/solrquery.getgroup.php'>Turkish</option>
            <option value='uk/solrquery.getgroup.php'>Ukrainian</option>
            <option value='zh/solrquery.getgroup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getgroup" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getGroup</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getGroup</span> &mdash; <span class="dc-title">Returns true if grouping is enabled</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getgroup-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getGroup</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getgroup-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getgroup-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.getgroup-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.setgroup.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroup()</a> - Enable/Disable result grouping (group parameter)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getgroup.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getgroup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getgroup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getgroup.php">＋<small>add a note</small></a></span>
