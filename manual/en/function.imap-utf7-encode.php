...
<head>
  ...
  <title>PHP: imap_utf7_encode - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-utf7-encode.php">
 <link rel="shorturl" href="https://www.php.net/imap-utf7-encode">
 <link rel="alternate" href="https://www.php.net/imap-utf7-encode" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-utf7-decode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-utf8.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-utf7-encode.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-utf7-encode.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-utf7-encode.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-utf7-encode.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-utf7-encode.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-utf7-encode.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-utf7-encode.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-utf7-encode.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-utf7-encode.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-utf7-encode.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-utf7-encode.php" hreflang="zh">
...
<meta name="Description" content="Converts ISO-8859-1 string to modified UTF-7 text" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_utf7_encode - Manual" />
<meta name="twitter:description" content="Converts ISO-8859-1 string to modified UTF-7 text" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_utf7_encode - Manual" />
<meta itemprop="description" content="Converts ISO-8859-1 string to modified UTF-7 text" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Converts ISO-8859-1 string to modified UTF-7 text" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-utf8.php">
          imap_utf8 &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-utf7-decode.php">
          &laquo; imap_utf7_decode        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-utf7-encode.php' selected="selected">English</option>
            <option value='de/function.imap-utf7-encode.php'>German</option>
            <option value='es/function.imap-utf7-encode.php'>Spanish</option>
            <option value='fr/function.imap-utf7-encode.php'>French</option>
            <option value='it/function.imap-utf7-encode.php'>Italian</option>
            <option value='ja/function.imap-utf7-encode.php'>Japanese</option>
            <option value='pt_BR/function.imap-utf7-encode.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-utf7-encode.php'>Russian</option>
            <option value='tr/function.imap-utf7-encode.php'>Turkish</option>
            <option value='uk/function.imap-utf7-encode.php'>Ukrainian</option>
            <option value='zh/function.imap-utf7-encode.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-utf7-encode" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_utf7_encode</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_utf7_encode</span> &mdash; <span class="dc-title">Converts ISO-8859-1 string to modified UTF-7 text</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.imap-utf7-encode-description">
  ...
  <p class="para rdfs-comment">
   Converts <code class="parameter">string</code> to modified UTF-7 text.
  </p>
  <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-utf7-encode-returnvalues">
  ...
  <p class="para">
   Returns <code class="parameter">string</code> encoded with the modified UTF-7
   encoding as defined in <a href="https://datatracker.ietf.org/doc/html/rfc2060" class="link external">&raquo;&nbsp;RFC 2060</a>, 
   section 5.1.3.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-utf7-encode-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-utf7-decode.php" class="function" rel="rdfs-seeAlso">imap_utf7_decode()</a> - Decodes a modified UTF-7 encoded string</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-utf7-encode.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-utf7-encode%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-utf7-encode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-utf7-encode.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123496">  <div class="votes">
    <div id="Vu123496">
    <a href="/manual/vote-note.php?id=123496&amp;page=function.imap-utf7-encode&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123496">
    <a href="/manual/vote-note.php?id=123496&amp;page=function.imap-utf7-encode&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123496" title="50% like this...">
    0
    </div>
  </div>
  <a href="#123496" class="name">
  <strong class="user"><em>Olivier</em></strong></a><a class="genanchor" href="#123496"> &para;</a><div class="date" title="2019-01-07 02:34"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123496">
<div class="phpcode"><code><span class="html">For those who search for a good implementation of modified UTF-7 encoding for IMAP, you can find a code that works on :<br /><a href="http://tananyag.ntszki.hu/mail/functions/imap_utf7_local.php" rel="nofollow" target="_blank">http://tananyag.ntszki.hu/mail/functions/imap_utf7_local.php</a><br />The result is different from imap-utf7-encode() function and is identical to mailbox name generated by Thunderbird.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-utf7-encode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-utf7-encode.php">＋<small>add a note</small></a></div>
