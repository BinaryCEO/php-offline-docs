...
<head>
  ...
  <title>PHP: ldap_get_dn - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-get-dn.php">
 <link rel="shorturl" href="https://www.php.net/ldap-get-dn">
 <link rel="alternate" href="https://www.php.net/ldap-get-dn" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-get-attributes.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-get-entries.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-get-dn.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-get-dn.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-get-dn.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-get-dn.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-get-dn.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-get-dn.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-get-dn.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-get-dn.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-get-dn.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-get-dn.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-get-dn.php" hreflang="zh">
...
<meta name="Description" content="Get the DN of a result entry" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_get_dn - Manual" />
<meta name="twitter:description" content="Get the DN of a result entry" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_get_dn - Manual" />
<meta itemprop="description" content="Get the DN of a result entry" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the DN of a result entry" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ldap-get-entries.php">
          ldap_get_entries &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-get-attributes.php">
          &laquo; ldap_get_attributes        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-get-dn.php' selected="selected">English</option>
            <option value='de/function.ldap-get-dn.php'>German</option>
            <option value='es/function.ldap-get-dn.php'>Spanish</option>
            <option value='fr/function.ldap-get-dn.php'>French</option>
            <option value='it/function.ldap-get-dn.php'>Italian</option>
            <option value='ja/function.ldap-get-dn.php'>Japanese</option>
            <option value='pt_BR/function.ldap-get-dn.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-get-dn.php'>Russian</option>
            <option value='tr/function.ldap-get-dn.php'>Turkish</option>
            <option value='uk/function.ldap-get-dn.php'>Ukrainian</option>
            <option value='zh/function.ldap-get-dn.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-get-dn" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-get-dn-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_get_dn</strong></span>(<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>, <span class="methodparam"><span class="type">LDAP\ResultEntry</span> <code class="parameter">$entry</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ldap-get-dn-returnvalues">
  ...
  <p class="para">
   Returns the DN of the result entry and <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
 ...
 <td>
  ...
  instance now; previously, a valid <code class="literal">ldap result entry</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-get-dn.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-get-dn%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-get-dn&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-get-dn.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118070">  <div class="votes">
    <div id="Vu118070">
    <a href="/manual/vote-note.php?id=118070&amp;page=function.ldap-get-dn&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118070">
    <a href="/manual/vote-note.php?id=118070&amp;page=function.ldap-get-dn&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118070" title="50% like this...">
    0
    </div>
  </div>
  <a href="#118070" class="name">
  <strong class="user"><em>radulescuiuliamaria at yahoo dot com</em></strong></a><a class="genanchor" href="#118070"> &para;</a><div class="date" title="2015-09-29 08:50"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom118070">
<div class="phpcode"><code><span class="html">How to get the DN for a given samaccountname:<br /><br />/*the connecting part*/<br />$ldap_conn = ldap_connect($hostname, $port);<br />$bind = ldap_bind($ldap_conn, $username, $password);<br />/*the connecting part*/<br /><br />$samaccountname = john.doe;<br /><br />$filter="(samaccountname=$samaccountname)";<br />$dn="OU=PEOPLE, DC=example, DC=com"; //even if it seems obvious I note here that the dn is just an example, you'll have to provide an OU and DC of your own<br /><br />$res = ldap_search($ldap_conn, $dn, $filter);<br />$first = ldap_first_entry($ldap_conn, $res);<br />$data = ldap_get_dn($ldap_conn, $first);<br /><br />echo "The desired DN is: ".$data;</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-get-dn&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-get-dn.php">＋<small>add a note</small></a></div>
