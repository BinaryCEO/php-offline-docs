...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.errors.basics.php">
 <link rel="shorturl" href="https://www.php.net/errors.basics">
 <link rel="alternate" href="https://www.php.net/errors.basics" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.errors.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.errors.php">
 <link rel="next" href="https://www.php.net/manual/en/language.errors.php7.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.errors.basics.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.errors.basics.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.errors.basics.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.errors.basics.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.errors.basics.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.errors.basics.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.errors.basics.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.errors.basics.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.errors.basics.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.errors.basics.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.errors.basics.php" hreflang="zh">
...
<meta itemprop="description" content="Basics" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.errors.basics.php' selected="selected">English</option>
            <option value='de/language.errors.basics.php'>German</option>
            <option value='es/language.errors.basics.php'>Spanish</option>
            <option value='fr/language.errors.basics.php'>French</option>
            <option value='it/language.errors.basics.php'>Italian</option>
            <option value='ja/language.errors.basics.php'>Japanese</option>
            <option value='pt_BR/language.errors.basics.php'>Brazilian Portuguese</option>
            <option value='ru/language.errors.basics.php'>Russian</option>
            <option value='tr/language.errors.basics.php'>Turkish</option>
            <option value='uk/language.errors.basics.php'>Ukrainian</option>
            <option value='zh/language.errors.basics.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="language.errors.basics" class="sect1">
  ...
  <p class="para">
   ...
   as by sending an e-mail.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/errors/basics.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.errors.basics%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.errors.basics&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.errors.basics.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="130492">  <div class="votes">
    <div id="Vu130492">
    <a href="/manual/vote-note.php?id=130492&amp;page=language.errors.basics&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130492">
    <a href="/manual/vote-note.php?id=130492&amp;page=language.errors.basics&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130492" title="no votes...">
    0
    </div>
  </div>
  <a href="#130492" class="name">
  <strong class="user"><em>greg at it-all dot com</em></strong></a><a class="genanchor" href="#130492"> &para;</a><div class="date" title="2025-09-24 10:27"><strong>5 days ago</strong></div>
  <div class="text" id="Hcom130492">
<div class="phpcode"><code><span class="html">Be careful emailing errors from a custom handler, as emailing on every page view can crush your system.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=language.errors.basics&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.errors.basics.php">＋<small>add a note</small></a></div>
