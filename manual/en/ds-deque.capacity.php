...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-deque.capacity.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-deque.capacity.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-deque.capacity.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-deque.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-deque.apply.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-deque.clear.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-deque.capacity.php' selected="selected">English</option>
            ...
            <option value='ru/ds-deque.capacity.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL ds &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">Ds\Deque::capacity</span> &mdash; <span class="dc-title">Returns the current capacity</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-ds-deque.capacity-examples">
  ...
  <div class="example" id="example-4329">
   <p><strong>Example #1 <span class="function"><strong>Ds\Deque::capacity()</strong></span> example</strong></p>
...
int(64)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/deque/capacity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-deque.capacity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-deque.capacity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-deque.capacity.php">＋<small>add a note</small></a></span>
