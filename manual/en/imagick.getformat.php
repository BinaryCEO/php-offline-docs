...
<head>
  ...
  <title>PHP: Imagick::getFormat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getformat.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getformat.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getformat.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getfont.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getgravity.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getformat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getformat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getformat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getformat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getformat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getformat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getformat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getformat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getformat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getformat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getformat.php" hreflang="zh">
...
<meta name="Description" content="Returns the format of the Imagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getFormat - Manual" />
<meta name="twitter:description" content="Returns the format of the Imagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getFormat - Manual" />
<meta itemprop="description" content="Returns the format of the Imagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the format of the Imagick object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getgravity.php">
          Imagick::getGravity &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getfont.php">
          &laquo; Imagick::getFont        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getformat.php' selected="selected">English</option>
            <option value='de/imagick.getformat.php'>German</option>
            <option value='es/imagick.getformat.php'>Spanish</option>
            <option value='fr/imagick.getformat.php'>French</option>
            <option value='it/imagick.getformat.php'>Italian</option>
            <option value='ja/imagick.getformat.php'>Japanese</option>
            <option value='pt_BR/imagick.getformat.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getformat.php'>Russian</option>
            <option value='tr/imagick.getformat.php'>Turkish</option>
            <option value='uk/imagick.getformat.php'>Ukrainian</option>
            <option value='zh/imagick.getformat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getformat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getFormat</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getFormat</span> &mdash; <span class="dc-title">Returns the format of the Imagick object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getformat-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getFormat</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getformat-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getformat-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getformat-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getformat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getformat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getformat.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108695">  <div class="votes">
    <div id="Vu108695">
    <a href="/manual/vote-note.php?id=108695&amp;page=imagick.getformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108695">
    <a href="/manual/vote-note.php?id=108695&amp;page=imagick.getformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108695" title="72% like this...">
    5
    </div>
  </div>
  <a href="#108695" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108695"> &para;</a><div class="date" title="2012-05-17 11:02"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108695">
<div class="phpcode"><code><span class="html">The getFormat function merely returns the value of the image format, which is not automatically loaded when you read an image.  The value you're getting back, then, is merely the value that you set the format to using the setFormat function.  That function takes pretty much any string that matches a popular or well-known image filename.  It accepts "jpeg" and "gif", but errors out on anything that is not an image filename, like "xyz123" or "zip".  How do you know what filetypes you can enter?  Use the PHP ImageMagick function 'queryFormats'.  If you want to know what type of file you have, you should try using the PHP page for the function 'filetype'.  Or, on the other hand, you can use the ImageMagick function getImageFormat (as opposed to the ImageMagick function getFormat).  The difference is that getImageFormat actually returns the format of the inputted image.<br /><br />And now, a simple demonstration of the set/get activity in the Format :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.bmp"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Set/Get Format<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">setFormat</span><span class="keyword">(</span><span class="string">"bmp"</span><span class="keyword">);<br />    </span><span class="default">$imagick_type_format </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getFormat</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Print Results<br />        // ---------------------------------------------<br /><br />    </span><span class="keyword">print(</span><span class="string">"&lt;pre&gt;"</span><span class="keyword">);<br />    print(</span><span class="default">$imagick_type_format</span><span class="keyword">);<br />    print(</span><span class="string">"&lt;/pre&gt;"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="123812">  <div class="votes">
    <div id="Vu123812">
    <a href="/manual/vote-note.php?id=123812&amp;page=imagick.getformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123812">
    <a href="/manual/vote-note.php?id=123812&amp;page=imagick.getformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123812" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#123812" class="name">
  <strong class="user"><em>Test</em></strong></a><a class="genanchor" href="#123812"> &para;</a><div class="date" title="2019-05-01 01:08"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123812">
<div class="phpcode"><code><span class="html">This example doesn't work for the files that have been incorrectly saved or corrupted and have (jpg extension but the image is png)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getformat.php">＋<small>add a note</small></a></div>
