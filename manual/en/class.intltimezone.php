...
<head>
  ...
  <title>PHP: IntlTimeZone - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.intltimezone.php">
 <link rel="shorturl" href="https://www.php.net/intltimezone">
 <link rel="alternate" href="https://www.php.net/intltimezone" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.intl.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlgregoriancalendar.setgregorianchange.php">
 <link rel="next" href="https://www.php.net/manual/en/intltimezone.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.intltimezone.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.intltimezone.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.intltimezone.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.intltimezone.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.intltimezone.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.intltimezone.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.intltimezone.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.intltimezone.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.intltimezone.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.intltimezone.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.intltimezone.php" hreflang="zh">
...
<meta name="Description" content="The IntlTimeZone class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlTimeZone - Manual" />
<meta name="twitter:description" content="The IntlTimeZone class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlTimeZone - Manual" />
<meta itemprop="description" content="The IntlTimeZone class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The IntlTimeZone class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intltimezone.construct.php">
          IntlTimeZone::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlgregoriancalendar.setgregorianchange.php">
          &laquo; IntlGregorianCalendar::setGregorianChange        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.intltimezone.php' selected="selected">English</option>
            <option value='de/class.intltimezone.php'>German</option>
            <option value='es/class.intltimezone.php'>Spanish</option>
            <option value='fr/class.intltimezone.php'>French</option>
            <option value='it/class.intltimezone.php'>Italian</option>
            <option value='ja/class.intltimezone.php'>Japanese</option>
            <option value='pt_BR/class.intltimezone.php'>Brazilian Portuguese</option>
            <option value='ru/class.intltimezone.php'>Russian</option>
            <option value='tr/class.intltimezone.php'>Turkish</option>
            <option value='uk/class.intltimezone.php'>Ukrainian</option>
            <option value='zh/class.intltimezone.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.intltimezone" class="reference">
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="intltimezone.getdisplayname.php" class="methodname">getDisplayName</a></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$dst</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$style</code><span class="initializer"> = IntlTimeZone::DISPLAY_LONG</span></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$locale</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  given country or offset</li><li><a href="intltimezone.createtimezone.php">IntlTimeZone::createTimeZone</a> — Create a timezone object for the given ID</li><li><a href="intltimezone.createtimezoneidenumeration.php">IntlTimeZone::createTimeZoneIDEnumeration</a> — Get an enumeration over system time zone IDs with the given filter conditions</li><li><a href="intltimezone.fromdatetimezone.php">IntlTimeZone::fromDateTimeZone</a> — Create a timezone object from DateTimeZone</li><li><a href="intltimezone.getcanonicalid.php">IntlTimeZone::getCanonicalID</a> — Get the canonical system timezone ID or the normalized custom time zone ID for the given time zone ID</li><li><a href="intltimezone.getdisplayname.php">IntlTimeZone::getDisplayName</a> — Get a name of this time zone suitable for presentation to the user</li><li><a href="intltimezone.getdstsavings.php">IntlTimeZone::getDSTSavings</a> — Get the amount of time to be added to local standard time to get local wall clock time</li><li><a href="intltimezone.getequivalentid.php">IntlTimeZone::getEquivalentID</a> — Get an ID in the equivalency group that includes the given ID</li><li><a href="intltimezone.geterrorcode.php">IntlTimeZone::getErrorCode</a> — Get last error code on the object</li><li><a href="intltimezone.geterrormessage.php">IntlTimeZone::getErrorMessage</a> — Get last error message on the object</li><li><a href="intltimezone.getgmt.php">IntlTimeZone::getGMT</a> — Create GMT (UTC) timezone</li><li><a href="intltimezone.getid.php">IntlTimeZone::getID</a> — Get timezone ID</li><li><a href="intltimezone.getidforwindowsid.php">IntlTimeZone::getIDForWindowsID</a> — Translate a Windows timezone into a system timezone</li><li><a href="intltimezone.getoffset.php">IntlTimeZone::getOffset</a> — Get the time zone raw and GMT offset for the given moment in time</li><li><a href="intltimezone.getrawoffset.php">IntlTimeZone::getRawOffset</a> — Get the raw GMT offset (before taking daylight savings time into account</li><li><a href="intltimezone.getregion.php">IntlTimeZone::getRegion</a> — Get the region code associated with the given system time zone ID</li><li><a href="intltimezone.gettzdataversion.php">IntlTimeZone::getTZDataVersion</a> — Get the timezone data version currently used by ICU</li><li><a href="intltimezone.getunknown.php">IntlTimeZone::getUnknown</a> — Get the &quot;unknown&quot; time zone</li><li><a href="intltimezone.getwindowsid.php">IntlTimeZone::getWindowsID</a> — Translate a system timezone into a Windows timezone</li><li><a href="intltimezone.hassamerules.php">IntlTimeZone::hasSameRules</a> — Check if this zone has the same rules and offset as another zone</li><li><a href="intltimezone.todatetimezone.php">IntlTimeZone::toDateTimeZone</a> — Convert to DateTimeZone object</li><li><a href="intltimezone.usedaylighttime.php">IntlTimeZone::useDaylightTime</a> — Check if this time zone uses daylight savings time</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intltimezone.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.intltimezone%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.intltimezone&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.intltimezone.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122938">  <div class="votes">
    <div id="Vu122938">
    <a href="/manual/vote-note.php?id=122938&amp;page=class.intltimezone&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122938">
    <a href="/manual/vote-note.php?id=122938&amp;page=class.intltimezone&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122938" title="60% like this...">
    1
    </div>
  </div>
  <a href="#122938" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#122938"> &para;</a><div class="date" title="2018-07-13 08:40"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122938">
<div class="phpcode"><code><span class="html">Currently there is no documentation available for IntlTimeZone::parse(), so it took some while to figure out a working example:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Example for 32-bit PHP 7.0.30 with Intl version 1.1, ICU version 56.1<br />// To get the offset of a date including daylight saving time, getRawOffset() is<br />// not sufficient, getOffset() is needed. And a date is needed to take history<br />// in to account.<br /><br /></span><span class="default">\Locale</span><span class="keyword">::</span><span class="default">setDefault</span><span class="keyword">(</span><span class="string">'nl-NL'</span><span class="keyword">);<br /></span><span class="default">$date </span><span class="keyword">= </span><span class="string">'25-03-2018 12:34:56.123456 CEST'</span><span class="keyword">;  </span><span class="comment">// 3rd of Februari<br /></span><span class="default">$timezone </span><span class="keyword">= </span><span class="default">\IntlTimeZone</span><span class="keyword">::</span><span class="default">createDefault</span><span class="keyword">();  </span><span class="comment">// = CEST = GMT +02:00<br /></span><span class="keyword">print </span><span class="string">'Time zone: ' </span><span class="keyword">. </span><span class="default">$timezone</span><span class="keyword">-&gt;</span><span class="default">getDisplayName</span><span class="keyword">() . </span><span class="default">PHP_EOL</span><span class="keyword">;<br />print </span><span class="string">'DST: ' </span><span class="keyword">. (</span><span class="default">$timezone</span><span class="keyword">-&gt;</span><span class="default">useDaylightTime</span><span class="keyword">() ? </span><span class="string">'DOES' </span><span class="keyword">: </span><span class="string">'DOES NOT'</span><span class="keyword">)<br />  . </span><span class="string">' happen to this timezone' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br />print </span><span class="string">'Possible DST difference (usec): ' </span><span class="keyword">. </span><span class="default">$timezone</span><span class="keyword">-&gt;</span><span class="default">getDSTSavings</span><span class="keyword">() . </span><span class="default">PHP_EOL</span><span class="keyword">;<br /><br /></span><span class="default">$formatter </span><span class="keyword">= new </span><span class="default">\IntlDateFormatter</span><span class="keyword">(<br />  </span><span class="default">\Locale</span><span class="keyword">::</span><span class="default">getDefault</span><span class="keyword">(),<br />  </span><span class="default">\IntlDateFormatter</span><span class="keyword">::</span><span class="default">MEDIUM</span><span class="keyword">,<br />  </span><span class="default">\IntlDateFormatter</span><span class="keyword">::</span><span class="default">MEDIUM</span><span class="keyword">,<br />  </span><span class="default">$timezone<br /></span><span class="keyword">);<br /></span><span class="default">$timestamp </span><span class="keyword">= </span><span class="default">$formatter</span><span class="keyword">-&gt;</span><span class="default">parse</span><span class="keyword">(</span><span class="default">$date</span><span class="keyword">);<br />if (</span><span class="default">FALSE </span><span class="keyword">=== </span><span class="default">$timestamp</span><span class="keyword">) {<br />  throw new </span><span class="default">\Exception</span><span class="keyword">(</span><span class="string">'Can not parse date'</span><span class="keyword">);<br />}<br />elseif (</span><span class="default">is_float</span><span class="keyword">(</span><span class="default">$timestamp</span><span class="keyword">)) {<br />  throw new </span><span class="default">\Exception</span><span class="keyword">(</span><span class="string">'Y2K38 bug @ 32 bit, please use 64 bit'</span><span class="keyword">);<br />}<br />print </span><span class="string">'Date parsed by IntlFormatter::parse(): ' </span><span class="keyword">. </span><span class="default">date</span><span class="keyword">(</span><span class="string">'c'</span><span class="keyword">, </span><span class="default">$timestamp</span><span class="keyword">)<br />  . </span><span class="default">PHP_EOL</span><span class="keyword">;<br /><br /></span><span class="default">$cal </span><span class="keyword">= </span><span class="default">\IntlCalendar</span><span class="keyword">::</span><span class="default">createInstance</span><span class="keyword">();<br /></span><span class="default">$cal</span><span class="keyword">-&gt;</span><span class="default">setTimeZone</span><span class="keyword">(</span><span class="default">$timezone</span><span class="keyword">);<br /></span><span class="default">$cal</span><span class="keyword">-&gt;</span><span class="default">setLenient</span><span class="keyword">(</span><span class="default">FALSE</span><span class="keyword">);<br /></span><span class="comment">// set UNIX timestamp offset (1970-01-01 00:00:00.000000) and add the timestamp<br /></span><span class="default">$cal</span><span class="keyword">-&gt;</span><span class="default">set</span><span class="keyword">(</span><span class="default">1970</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">$cal</span><span class="keyword">-&gt;</span><span class="default">set</span><span class="keyword">(</span><span class="default">\IntlCalendar</span><span class="keyword">::</span><span class="default">FIELD_MILLISECOND</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">); </span><span class="comment">// note: msec, not usec<br /></span><span class="default">$cal</span><span class="keyword">-&gt;</span><span class="default">add</span><span class="keyword">(</span><span class="default">\IntlCalendar</span><span class="keyword">::</span><span class="default">FIELD_SECOND</span><span class="keyword">, </span><span class="default">$timestamp</span><span class="keyword">); </span><span class="comment">// note: no milliseconds<br /></span><span class="default">$cal</span><span class="keyword">-&gt;</span><span class="default">add</span><span class="keyword">(</span><span class="default">\IntlCalendar</span><span class="keyword">::</span><span class="default">FIELD_MILLISECOND</span><span class="keyword">, </span><span class="default">124</span><span class="keyword">);  </span><span class="comment">// hardcode for simplicity<br /><br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'Content-type: text/plain'</span><span class="keyword">);<br />print </span><span class="string">'Date constructed with IntlCalendar: ' </span><span class="keyword">. </span><span class="default">$formatter</span><span class="keyword">-&gt;</span><span class="default">format</span><span class="keyword">(</span><span class="default">$cal</span><span class="keyword">)<br />  . </span><span class="default">PHP_EOL</span><span class="keyword">;<br />print </span><span class="string">'Raw offset by getRawOffset(): ' </span><span class="keyword">. </span><span class="default">$timezone</span><span class="keyword">-&gt;</span><span class="default">getRawOffset</span><span class="keyword">() . </span><span class="default">PHP_EOL</span><span class="keyword">;<br /><br /></span><span class="comment">/**<br /> * Function IntlTimeZone::getOffset()<br /> * @link <a href="http://icu-project.org/apiref/icu4c/classicu_1_1TimeZone.html#afcbc1c48bf0b453b0123c4cb75d20e96" rel="nofollow" target="_blank">http://icu-project.org/apiref/icu4c/classicu_1_1TimeZone.html#afcbc1c48bf0b453b0123c4cb75d20e96</a><br /> * @param float $date<br /> *   moment in time for which to return offsets, in units of milliseconds from<br /> *   January 1, 1970 0:00 GMT, either GMT time or local wall time, depending on<br /> *   `local'.<br /> * @param bool $local<br /> *   if true, `date' is local wall time; otherwise it is in GMT time.<br /> * @param int &amp;$rawOffset<br /> *   output parameter to receive the raw offset, that is, the offset not<br /> *   including DST adjustments<br /> * @param int &amp;$dstOffset<br /> *   output parameter to receive the DST offset, that is, the offset to be added<br /> *   to `rawOffset' to obtain the total offset between local and GMT time. If<br /> *   DST is not in effect, this value is zero; otherwise it is a positive value,<br /> *   typically one hour.<br /> */<br /><br /></span><span class="default">$rawOffset </span><span class="keyword">= </span><span class="default">NULL</span><span class="keyword">;<br /></span><span class="default">$dstOffset </span><span class="keyword">= </span><span class="default">NULL</span><span class="keyword">;<br /></span><span class="default">$timestamp </span><span class="keyword">*= </span><span class="default">1000.0</span><span class="keyword">; </span><span class="comment">// convert unix timestamp from secs to msecs<br /></span><span class="default">$timezone</span><span class="keyword">-&gt;</span><span class="default">getOffset</span><span class="keyword">(</span><span class="default">$timestamp</span><span class="keyword">, </span><span class="default">$local </span><span class="keyword">= </span><span class="default">FALSE</span><span class="keyword">, </span><span class="default">$rawOffset</span><span class="keyword">, </span><span class="default">$dstOffset</span><span class="keyword">);<br />print </span><span class="string">'Output of getOffset():' </span><span class="keyword">. </span><span class="default">PHP_EOL </span><span class="keyword">. </span><span class="default">json_encode</span><span class="keyword">([<br />  </span><span class="string">'rawOffset' </span><span class="keyword">=&gt; </span><span class="default">$rawOffset</span><span class="keyword">,<br />  </span><span class="string">'dstOffset' </span><span class="keyword">=&gt; </span><span class="default">$dstOffset<br /></span><span class="keyword">], </span><span class="default">JSON_PRETTY_PRINT</span><span class="keyword">) . </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.intltimezone&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.intltimezone.php">＋<small>add a note</small></a></div>
