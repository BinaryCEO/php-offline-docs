...
<head>
  ...
  <title>PHP: ReflectionProperty::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.clone.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.export.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.construct.php" hreflang="zh">
...
<meta name="Description" content="Construct a ReflectionProperty object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::__construct - Manual" />
<meta name="twitter:description" content="Construct a ReflectionProperty object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::__construct - Manual" />
<meta itemprop="description" content="Construct a ReflectionProperty object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Construct a ReflectionProperty object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionproperty.export.php">
          ReflectionProperty::export &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.clone.php">
          &laquo; ReflectionProperty::__clone        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.construct.php' selected="selected">English</option>
            <option value='de/reflectionproperty.construct.php'>German</option>
            <option value='es/reflectionproperty.construct.php'>Spanish</option>
            <option value='fr/reflectionproperty.construct.php'>French</option>
            <option value='it/reflectionproperty.construct.php'>Italian</option>
            <option value='ja/reflectionproperty.construct.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.construct.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.construct.php'>Russian</option>
            <option value='tr/reflectionproperty.construct.php'>Turkish</option>
            <option value='uk/reflectionproperty.construct.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.construct" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionProperty::__construct</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionProperty::__construct</span> &mdash; <span class="dc-title">Construct a ReflectionProperty object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionproperty.construct-description">
  <h3 class="title">Description</h3>
  <div class="constructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionProperty::__construct</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.object.php" class="type object">object</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$class</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$property</code></span>)</div>

 </div>


 <div class="refsect1 parameters" id="refsect1-reflectionproperty.construct-parameters">
 ...
 <div class="refsect1 errors" id="refsect1-reflectionproperty.construct-errors">
...
object(Str)#2 (1) {
  ...
  int(10)
   ...
   <div class="example" id="example-5594">
    <p><strong>Example #2 Getting value from private and protected properties using <span class="classname"><a href="class.reflectionproperty.php" class="classname">ReflectionProperty</a></span> class</strong></p>
    <div class="example-contents">
...
something similar to:</p></div>
    <div class="example-contents screen">
<div class="annotation-interactive examplescode"><pre class="examplescode">int(2)
int(3)</pre>
</div>
    </div>
   </div>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionproperty.construct-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><a href="language.oop5.decon.php#language.oop5.decon.constructor" class="link">Constructors</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.construct.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121322">  <div class="votes">
    <div id="Vu121322">
    <a href="/manual/vote-note.php?id=121322&amp;page=reflectionproperty.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121322">
    <a href="/manual/vote-note.php?id=121322&amp;page=reflectionproperty.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121322" title="100% like this...">
    6
    </div>
  </div>
  <a href="#121322" class="name">
  <strong class="user"><em>geoffsmiths at hotmail dot com</em></strong></a><a class="genanchor" href="#121322"> &para;</a><div class="date" title="2017-07-05 12:20"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121322">
<div class="phpcode"><code><span class="html">At example #2: the comment // int(2) is stated while the value for the private property is actually 3. (private $z = 3;)<br /><br />var_dump($prop-&gt;getValue($obj)); // This should be int(3)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionproperty.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.construct.php">＋<small>add a note</small></a></div>
