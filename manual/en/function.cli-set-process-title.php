...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cli-set-process-title.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cli-get-process-title.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dl.php">
...
<meta name="Description" content="Sets the process title" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cli_set_process_title - Manual" />
<meta name="twitter:description" content="Sets the process title" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cli_set_process_title - Manual" />
<meta itemprop="description" content="Sets the process title" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the process title" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cli-set-process-title.php' selected="selected">English</option>
            ...
            <option value='fr/function.cli-set-process-title.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">cli_set_process_title</span> &mdash; <span class="dc-title">Sets the process title</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.cli-set-process-title-description">
  ...
  <p class="para rdfs-comment">
   ...
   <a href="features.commandline.php" class="link">CLI</a> mode.
  </p>
 ...
 <div class="refsect1 errors" id="refsect1-function.cli-set-process-title-errors">
  ...
  <p class="para">
   An <strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> will be generated if the operating system
   is unsupported.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$title </span><span style="color: #007700">= </span><span style="color: #DD0000">"My Amazing PHP Script"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$pid </span><span style="color: #007700">= </span><span style="color: #0000BB">getmypid</span><span style="color: #007700">(); </span><span style="color: #FF8000">// you can use this to see your process title in ps<br /><br /></span><span style="color: #007700">if (!</span><span style="color: #0000BB">cli_set_process_title</span><span style="color: #007700">(</span><span style="color: #0000BB">$title</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">"Unable to set process title for PID </span><span style="color: #0000BB">$pid</span><span style="color: #DD0000">...\n"</span><span style="color: #007700">;<br />    exit(</span><span style="color: #0000BB">1</span><span style="color: #007700">);<br />} else {<br />    echo </span><span style="color: #DD0000">"The process title '</span><span style="color: #0000BB">$title</span><span style="color: #DD0000">' for PID </span><span style="color: #0000BB">$pid</span><span style="color: #DD0000"> has been set for your process!\n"</span><span style="color: #007700">;<br />    </span><span style="color: #0000BB">sleep</span><span style="color: #007700">(</span><span style="color: #0000BB">5</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.cli-set-process-title-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.cli-get-process-title.php" class="function" rel="rdfs-seeAlso">cli_get_process_title()</a> - Returns the current process title</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/cli-set-process-title.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cli-set-process-title%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cli-set-process-title&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cli-set-process-title.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Setting proc title on PHP based daemons is pretty sweet.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">In Linux this command changes the title for commands like 'ps -a' it doesn't seem to work with 'top' or 'pkill'<br /><br />To change the short name (eg PHP) to something else you can use the below:<br /><br /><span class="default">&lt;?php<br /><br />$strNewName</span><span class="keyword">=</span><span class="string">'myscript'</span><span class="keyword">;<br /><br /></span><span class="default">cli_set_process_name</span><span class="keyword">(</span><span class="default">$strNewName</span><span class="keyword">);<br /></span><span class="default">cli_set_process_title</span><span class="keyword">(</span><span class="default">$strNewName</span><span class="keyword">);<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">cli_get_process_name</span><span class="keyword">());<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">cli_get_process_title</span><span class="keyword">());<br /><br />function </span><span class="default">cli_set_process_name</span><span class="keyword">(</span><span class="default">$strName</span><span class="keyword">)<br />{<br />   </span><span class="default">file_put_contents</span><span class="keyword">(</span><span class="string">"/proc/"</span><span class="keyword">.</span><span class="default">getmypid</span><span class="keyword">().</span><span class="string">"/comm"</span><span class="keyword">,</span><span class="default">$strName</span><span class="keyword">);<br />}<br /><br />function </span><span class="default">cli_get_process_name</span><span class="keyword">()<br />{<br />  return(</span><span class="default">trim</span><span class="keyword">(</span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="string">"/proc/"</span><span class="keyword">.</span><span class="default">getmypid</span><span class="keyword">().</span><span class="string">"/comm"</span><span class="keyword">),</span><span class="string">"\r\n"</span><span class="keyword">));<br />}<br /><br /></span><span class="default">Note</span><span class="keyword">: </span><span class="default">The above will NOT work in Windows </span><span class="keyword">and </span><span class="default">may not work in all flavours of linux </span><span class="keyword">(</span><span class="default">I </span><span class="keyword">use </span><span class="default">Debian</span><span class="keyword">).</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.cli-set-process-title&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cli-set-process-title.php">＋<small>add a note</small></a></div>
