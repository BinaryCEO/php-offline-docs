...
<head>
  ...
  <title>PHP: Gmagick::cropimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.cropimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.cropimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.cropimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.cropthumbnailimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.cropimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.cropimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.cropimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.cropimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.cropimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.cropimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.cropimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.cropimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.cropimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.cropimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.cropimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::cropimage - Manual" />
<meta name="twitter:description" content="Extracts a region of the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::cropimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.cropthumbnailimage.php">
          Gmagick::cropthumbnailimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.construct.php">
          &laquo; Gmagick::__construct        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.cropimage.php' selected="selected">English</option>
            <option value='de/gmagick.cropimage.php'>German</option>
            <option value='es/gmagick.cropimage.php'>Spanish</option>
            <option value='fr/gmagick.cropimage.php'>French</option>
            <option value='it/gmagick.cropimage.php'>Italian</option>
            <option value='ja/gmagick.cropimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.cropimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.cropimage.php'>Russian</option>
            <option value='tr/gmagick.cropimage.php'>Turkish</option>
            <option value='uk/gmagick.cropimage.php'>Ukrainian</option>
            <option value='zh/gmagick.cropimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.cropimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::cropimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::cropimage</span> &mdash; <span class="dc-title">Extracts a region of the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.cropimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::cropimage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam">
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.cropimage-parameters">
  ...
  <p class="para">
   <dl>
       ...
       <dt>
         <code class="parameter">width</code>
       </dt>
       <dd>
         <p class="para">
       ...
       <dt>
         <code class="parameter">height</code>
       </dt>
       <dd>
         <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.cropimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The cropped <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.cropimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/cropimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.cropimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.cropimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.cropimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="104540">  <div class="votes">
    <div id="Vu104540">
    <a href="/manual/vote-note.php?id=104540&amp;page=gmagick.cropimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104540">
    <a href="/manual/vote-note.php?id=104540&amp;page=gmagick.cropimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104540" title="0% like this...">
    -5
    </div>
  </div>
  <a href="#104540" class="name">
  <strong class="user"><em>martin at arp242 dot net</em></strong></a><a class="genanchor" href="#104540"> &para;</a><div class="date" title="2011-06-22 12:52"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104540">
<div class="phpcode"><code><span class="html">A slight note since this is not immediately obvious:<br />Just as the C CropImage() function, you can specify all zero parameters to get an "autocrop" effect, meaning it will remove all single-color "edges" of an image.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gmagick.cropimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.cropimage.php">＋<small>add a note</small></a></div>
