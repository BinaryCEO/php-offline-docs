...
<head>
  ...
  <title>PHP: Mysql_xdevapi Functions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.mysql-xdevapi.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi.examples.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-xdevapi-expression.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ref.mysql-xdevapi.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ref.mysql-xdevapi.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ref.mysql-xdevapi.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ref.mysql-xdevapi.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ref.mysql-xdevapi.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ref.mysql-xdevapi.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ref.mysql-xdevapi.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ref.mysql-xdevapi.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ref.mysql-xdevapi.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ref.mysql-xdevapi.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ref.mysql-xdevapi.php" hreflang="zh">
...
<meta name="Description" content="Mysql_xdevapi Functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Mysql_xdevapi Functions - Manual" />
<meta name="twitter:description" content="Mysql_xdevapi Functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Mysql_xdevapi Functions - Manual" />
<meta itemprop="description" content="Mysql_xdevapi Functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Mysql_xdevapi Functions" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-xdevapi-expression.php">
          expression &raquo;
              ...
              <div class="prev">
        <a href="mysql-xdevapi.examples.php">
          &laquo; Examples        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.mysql-xdevapi.php' selected="selected">English</option>
            <option value='de/ref.mysql-xdevapi.php'>German</option>
            <option value='es/ref.mysql-xdevapi.php'>Spanish</option>
            <option value='fr/ref.mysql-xdevapi.php'>French</option>
            <option value='it/ref.mysql-xdevapi.php'>Italian</option>
            <option value='ja/ref.mysql-xdevapi.php'>Japanese</option>
            <option value='pt_BR/ref.mysql-xdevapi.php'>Brazilian Portuguese</option>
            <option value='ru/ref.mysql-xdevapi.php'>Russian</option>
            <option value='tr/ref.mysql-xdevapi.php'>Turkish</option>
            <option value='uk/ref.mysql-xdevapi.php'>Ukrainian</option>
            <option value='zh/ref.mysql-xdevapi.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ref.mysql-xdevapi" class="reference">
 <h1 class="title">Mysql_xdevapi Functions</h1>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="function.mysql-xdevapi-expression.php">expression</a> — Bind prepared statement variables as parameters</li><li><a href="function.mysql-xdevapi-getsession.php">getSession</a> — Connect to a MySQL server</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/reference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fref.mysql-xdevapi%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ref.mysql-xdevapi&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.mysql-xdevapi.php">＋<small>add a note</small></a></span>
