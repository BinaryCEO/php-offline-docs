...
<head>
  ...
  <title>PHP: imagewbmp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagewbmp.php">
 <link rel="shorturl" href="https://www.php.net/imagewbmp">
 <link rel="alternate" href="https://www.php.net/imagewbmp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagetypes.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagewebp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagewbmp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagewbmp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagewbmp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagewbmp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagewbmp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagewbmp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagewbmp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagewbmp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagewbmp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagewbmp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagewbmp.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: imagewbmp - Manual" />
<meta name="twitter:description" content="Output image to browser or file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagewbmp - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagewbmp.php' selected="selected">English</option>
            <option value='de/function.imagewbmp.php'>German</option>
            <option value='es/function.imagewbmp.php'>Spanish</option>
            <option value='fr/function.imagewbmp.php'>French</option>
            <option value='it/function.imagewbmp.php'>Italian</option>
            <option value='ja/function.imagewbmp.php'>Japanese</option>
            <option value='pt_BR/function.imagewbmp.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagewbmp.php'>Russian</option>
            <option value='tr/function.imagewbmp.php'>Turkish</option>
            <option value='uk/function.imagewbmp.php'>Ukrainian</option>
            <option value='zh/function.imagewbmp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagewbmp" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagewbmp</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.1, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagewbmp</span> &mdash; <span class="dc-title">Output image to browser or file</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagewbmp-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagewbmp</strong></span>(<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span></span> <code class="parameter">$file</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span> <code class="parameter">$foreground_color</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>imagewbmp()</strong></span> outputs or save a <abbr title="Wireless Bitmap">WBMP</abbr>
   version of the given <code class="parameter">image</code>. 
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imagewbmp-parameters">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagewbmp-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagewbmp-changelog">
 ...
 <td>
  ...
  instance now; previously, a valid <code class="literal">gd</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">foreground_color</code> is nullable now.
      </td>
     </tr>
 ...
 <div class="refsect1 examples" id="refsect1-function.imagewbmp-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2943">
    <p><strong>Example #1 Outputting a WBMP image</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Create a blank image and add some text<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatetruecolor</span><span style="color: #007700">(</span><span style="color: #0000BB">120</span><span style="color: #007700">, </span><span style="color: #0000BB">20</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$text_color </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecolorallocate</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">233</span><span style="color: #007700">, </span><span style="color: #0000BB">14</span><span style="color: #007700">, </span><span style="color: #0000BB">91</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">imagestring</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">,  </span><span style="color: #DD0000">'A Simple Text String'</span><span style="color: #007700">, </span><span style="color: #0000BB">$text_color</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Set the content type header - in this case image/vnd.wap.wbmp<br />// Hint: see image_type_to_mime_type() for content-types<br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">'Content-Type: image/vnd.wap.wbmp'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Output the image<br /></span><span style="color: #0000BB">imagewbmp</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-2944">
    <p><strong>Example #2 Saving the WBMP image</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Create a blank image and add some text<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatetruecolor</span><span style="color: #007700">(</span><span style="color: #0000BB">120</span><span style="color: #007700">, </span><span style="color: #0000BB">20</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$text_color </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecolorallocate</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">233</span><span style="color: #007700">, </span><span style="color: #0000BB">14</span><span style="color: #007700">, </span><span style="color: #0000BB">91</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">imagestring</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">,  </span><span style="color: #DD0000">'A Simple Text String'</span><span style="color: #007700">, </span><span style="color: #0000BB">$text_color</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Save the image<br /></span><span style="color: #0000BB">imagewbmp</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #DD0000">'simpletext.wbmp'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>

   </div>
  </p>
  <p class="para">
   <div class="example" id="example-2945">
    <p><strong>Example #3 Outputting the image with a different foreground</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Create a blank image and add some text<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatetruecolor</span><span style="color: #007700">(</span><span style="color: #0000BB">120</span><span style="color: #007700">, </span><span style="color: #0000BB">20</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$text_color </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecolorallocate</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">233</span><span style="color: #007700">, </span><span style="color: #0000BB">14</span><span style="color: #007700">, </span><span style="color: #0000BB">91</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">imagestring</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">,  </span><span style="color: #DD0000">'A Simple Text String'</span><span style="color: #007700">, </span><span style="color: #0000BB">$text_color</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Set the content type header - in this case image/vnd.wap.wbmp<br />// Hint: see image_type_to_mime_type() for content-types<br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">'Content-Type: image/vnd.wap.wbmp'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Set a replacement foreground color<br /></span><span style="color: #0000BB">$foreground_color </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecolorallocate</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">255</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">imagewbmp</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">NULL</span><span style="color: #007700">, </span><span style="color: #0000BB">$foreground_color</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagewbmp-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.image2wbmp.php" class="function" rel="rdfs-seeAlso">image2wbmp()</a> - Output image to browser or file</span></li>
   ...
   <li><span class="function"><a href="function.imagetypes.php" class="function" rel="rdfs-seeAlso">imagetypes()</a> - Return the image types supported by this PHP build</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagewbmp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagewbmp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagewbmp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagewbmp.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="79910">  <div class="votes">
    <div id="Vu79910">
    <a href="/manual/vote-note.php?id=79910&amp;page=function.imagewbmp&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd79910">
    <a href="/manual/vote-note.php?id=79910&amp;page=function.imagewbmp&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V79910" title="75% like this...">
    2
    </div>
  </div>
  <a href="#79910" class="name">
  <strong class="user"><em>andre at bynetworld dot com</em></strong></a><a class="genanchor" href="#79910"> &para;</a><div class="date" title="2007-12-19 05:31"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom79910">
<div class="phpcode"><code><span class="html">In the previous note by -&gt; lukeross at sys3175 dot co dot uk &lt;- there is a coding error in the for() loops. After correcting the error, I found that this function did a great job of  converting color images to 2 colors.<br />The following is the corrected function code:<br /><br />function ImageColorFloydSteinberg($dst_img, $src_img) {<br />    ImageColorAllocate($dst_img, 0,0,0);<br />    ImageColorAllocate($dst_img, 255,255,255);<br />    $isx = ImageSX($src_img);<br />    $isy = ImageSY($src_img);<br />    $grey_img = ImageCreate($isx, $isy);<br />    for ($a = 0; $a &lt;= 255; $a++) ImageColorAllocate($grey_img, $a,$a,$a);<br />    $isx -= 1; // To correct pixel count in source image width starting from 0<br />    $isy -= 1; // Correcting pixel count in source image height starting from 0<br />    for($x = 0; $x &lt;= $isx; $x++) {<br />        for($y = 0; $y &lt;= $isy; $y++) {<br />            $color = ImageColorsForIndex($src_img, ImageColorAt($src_img, $x, $y));<br />            $greyscale = .299 * $color["red"] + .587 * $color["green"] + .114 * $color["blue"];<br />            ImageSetPixel($grey_img, $x, $y, ImageColorClosest($grey_img, $greyscale, $greyscale, $greyscale));<br />        }<br />    }<br />    for($x = 0; $x &lt;= $isx; $x++) {<br />        for($y = 0; $y &lt;= $isy; $y++) {<br />            $color = ImageColorsForIndex($grey_img, ImageColorAt($grey_img, $x, $y));<br />            if ($color["red"] &gt; 128) {<br />                ImageSetPixel($dst_img, $x, $y, ImageColorClosest($dst_img,255,255,255));<br />                $err = $color["red"] - 255;<br />            } else {<br />                ImageSetPixel($dst_img, $x, $y, ImageColorClosest($dst_img,0,0,0));<br />                $err = $color["red"];<br />            }<br />            if ($x != $isx) {<br />                $color2 = ImageColorsForIndex($grey_img, ImageColorAt($grey_img, $x+1, $y));<br />                $newgrey = $color2["red"] + $err * 7 / 16;<br />                ImageSetPixel($grey_img, $x+1, $y, ImageColorClosest($grey_img,$newgrey, $newgrey, $newgrey));<br />            }<br />            if ($x != 0) {<br />                $color2 = ImageColorsForIndex($grey_img, ImageColorAt($grey_img, $x-1, $y));<br />                $newgrey = $color2["red"] + $err * 3 / 16;<br />                ImageSetPixel($grey_img, $x-1, $y, ImageColorClosest($grey_img,$newgrey, $newgrey, $newgrey));<br />            }<br />            if ($y != $isy) {<br />                $color2 = ImageColorsForIndex($grey_img, ImageColorAt($grey_img, $x, $y+1));<br />                $newgrey = $color2["red"] + $err * 5 / 16;<br />                ImageSetPixel($grey_img, $x, $y+1, ImageColorClosest($grey_img,$newgrey, $newgrey, $newgrey));<br />            }<br />            if ($x != $isx &amp;&amp; $y != $isy) {<br />                $color2 = ImageColorsForIndex($grey_img, ImageColorAt($grey_img, $x+1, $y+1));<br />                $newgrey = $color2["red"] + $err / 16;<br />                ImageSetPixel($grey_img, $x+1, $y+1, ImageColorClosest($grey_img,$newgrey, $newgrey, $newgrey));<br />            }<br />           <br />        }<br />    }<br />    imagedestroy($grey_img);<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="19484">  <div class="votes">
    <div id="Vu19484">
    <a href="/manual/vote-note.php?id=19484&amp;page=function.imagewbmp&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd19484">
    <a href="/manual/vote-note.php?id=19484&amp;page=function.imagewbmp&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V19484" title="66% like this...">
    1
    </div>
  </div>
  <a href="#19484" class="name">
  <strong class="user"><em>lukeross at sys3175 dot co dot uk</em></strong></a><a class="genanchor" href="#19484"> &para;</a><div class="date" title="2002-02-28 01:57"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom19484">
<div class="phpcode"><code><span class="html">As has been commented before, GD doesnt do a very good translation to 2-colours, especially for photos.  The following routine converts to two colours, I believe using error diffusion (the algorithm's nicked off news).  It's slow, but just about adequate for small images and low load.  I suspect it can be made much more efficient :-)<br /><br />function ImageColorFloydSteinberg($dst_img, $src_img) {<br />    ImageColorAllocate($dst_img, 0,0,0);<br />    ImageColorAllocate($dst_img, 255,255,255);<br />    $grey_img = ImageCreate(ImageSX($src_img), ImageSY($src_img));<br />    for ($a = 0; $a &lt;= 255; $a++) ImageColorAllocate($grey_img, $a,$a,$a);<br />    for($x = 0; $x &lt;= ImageSX($src_img); $x++) {<br />        for($y = 0; $y &lt;= ImageSY($src_img); $y++) {<br />            $color = ImageColorsForIndex($src_img, ImageColorAt($src_img, $x, $y));<br />            $greyscale = .299 * $color["red"] + .587 * $color["green"] + .114 * $color["blue"];<br />            ImageSetPixel($grey_img, $x, $y, ImageColorClosest($grey_img, $greyscale, $greyscale, $greyscale));<br />        }<br />    }<br />    for($x = 0; $x &lt;= ImageSX($src_img); $x++) {<br />        for($y = 0; $y &lt;= ImageSY($src_img); $y++) {<br />            $color = ImageColorsForIndex($grey_img, ImageColorAt($grey_img, $x, $y));<br />            if ($color["red"] &gt; 128) {<br />                ImageSetPixel($dst_img, $x, $y, ImageColorClosest($dst_img,255,255,255));<br />                $err = $color["red"] - 255;<br />            } else {<br />                ImageSetPixel($dst_img, $x, $y, ImageColorClosest($dst_img,0,0,0));<br />                $err = $color["red"];<br />            }<br />            if ($x != ImageSx($src_img)) {<br />                $color2 = ImageColorsForIndex($grey_img, ImageColorAt($grey_img, $x+1, $y));<br />                $newgrey = $color2["red"] + $err * 7 / 16;<br />                ImageSetPixel($grey_img, $x+1, $y, ImageColorClosest($grey_img,$newgrey, $newgrey, $newgrey));<br />            }<br />            if ($x != 0) {<br />                $color2 = ImageColorsForIndex($grey_img, ImageColorAt($grey_img, $x-1, $y));<br />                $newgrey = $color2["red"] + $err * 3 / 16;<br />                ImageSetPixel($grey_img, $x-1, $y, ImageColorClosest($grey_img,$newgrey, $newgrey, $newgrey));<br />            }<br />            if ($y != ImageSy($src_img)) {<br />                $color2 = ImageColorsForIndex($grey_img, ImageColorAt($grey_img, $x, $y+1));<br />                $newgrey = $color2["red"] + $err * 5 / 16;<br />                ImageSetPixel($grey_img, $x, $y+1, ImageColorClosest($grey_img,$newgrey, $newgrey, $newgrey));<br />            }<br />            if ($x != ImageSx($src_img) &amp;&amp; $y != ImageSy($src_img)) {<br />                $color2 = ImageColorsForIndex($grey_img, ImageColorAt($grey_img, $x+1, $y+1));<br />                $newgrey = $color2["red"] + $err / 16;<br />                ImageSetPixel($grey_img, $x+1, $y+1, ImageColorClosest($grey_img,$newgrey, $newgrey, $newgrey));<br />            }<br />            <br />        }<br />    }<br />    imagedestroy($grey_img);<br />}<br /><br />To output your WBMP, use<br /><br />ImageWBMP($final_img, "", ImageColorClosest(255,255,255));</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagewbmp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagewbmp.php">＋<small>add a note</small></a></div>
