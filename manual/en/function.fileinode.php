...
<span class="function"><a href="function.stat.php" class="function">stat()</a></span> family of functionality.</p></div>
 ...
 <div class="head">
  ...
  <div class="note" id="125196">  <div class="votes">
    ...
    <div class="tally" id="V125196" title="60% like this...">
    1
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">As documented in <a href="https://www.php.net/manual/en/function.stat.php#refsect1-function.stat-returnvalues:" rel="nofollow" target="_blank">https://www.php.net/manual/en/function.stat.php#refsect1-function.stat-returnvalues:</a><br />&gt; On Windows, as of PHP 7.4.0, this is the identifier associated with the file, which is a 64-bit unsigned integer, so may overflow. Previously, it was always 0.<br /><br />It appears that fileinode shares the same underlying implementation.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">On the linux kernel, COW filesystems like BTRFS, BcacheFS, etc Inode numbers are not usable to determine if something is the same file.<br />This is intentional.</span></code></div>
  </div>
 </div></div>
