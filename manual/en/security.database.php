...
<head>
 ...
 <link rel="prev" href="https://www.php.net/manual/en/security.filesystem.nullbytes.php">
 <link rel="next" href="https://www.php.net/manual/en/security.database.design.php">

 <link rel="alternate" href="https://www.php.net/manual/en/security.database.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/security.database.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/security.database.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/security.database.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/security.database.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/security.database.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/security.database.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/security.database.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/security.database.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/security.database.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/security.database.php" hreflang="zh">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="security.database.design.php">Designing Databases</a></li><li><a href="security.database.connection.php">Connecting to Database</a></li><li><a href="security.database.storage.php">Encrypted Storage Model</a></li><li><a href="security.database.sql-injection.php">SQL Injection</a></li></ul>
 ...
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=security.database&amp;repo=en&amp;redirect=https://www.php.net/manual/en/security.database.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="129917">  <div class="votes">
    ...
    <div class="tally" id="V129917" title="51% like this...">
    1
    </div>
  </div>
  <a href="#129917" class="name">
  <strong class="user"><em>gabe dot aust at gmail dot com</em></strong></a><a class="genanchor" href="#129917"> &para;</a><div class="date" title="2024-12-15 11:05"><strong>9 months ago</strong></div>
  <div class="text" id="Hcom129917">
<div class="phpcode"><code><span class="html">The most significant way to protect databases is to simply use authentication! There are production systems online with null and default administrator credentials. See the recent  "The Real World" hack...<br />Rule 1: Simply use authentication instead of not using it... Obviously do not save the credentials in a public-readable file.<br />Rule 2: Create a subsidiary account with access only to the live schema being used by your PHP app, i.e. never use the global DBMS admin account as a service login.<br />Rule 3: Block access at the DBMS end to only allow the web server to access the API. Most access is network based so that will involve filtering by IP.<br />Rule 4: You can obfuscate a bit more by setting a non-standard port but this may require code changes in the API calls you coded.<br />The above are some simple steps anyone can perform. More serious securing would likely involve setting up SSL connectivity.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=security.database&amp;repo=en&amp;redirect=https://www.php.net/manual/en/security.database.php">＋<small>add a note</small></a></div>
