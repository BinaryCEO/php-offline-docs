...
<head>
  ...
  <title>PHP: ReflectionClass::isUninitializedLazyObject - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.isuninitializedlazyobject.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.isuninitializedlazyobject.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isuninitializedlazyobject.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.istrait.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.isuserdefined.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isuninitializedlazyobject.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.isuninitializedlazyobject.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.isuninitializedlazyobject.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.isuninitializedlazyobject.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.isuninitializedlazyobject.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.isuninitializedlazyobject.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.isuninitializedlazyobject.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.isuninitializedlazyobject.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.isuninitializedlazyobject.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.isuninitializedlazyobject.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.isuninitializedlazyobject.php" hreflang="zh">
...
<meta name="Description" content="Checks if an object is lazy and uninitialized" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::isUninitializedLazyObject - Manual" />
<meta name="twitter:description" content="Checks if an object is lazy and uninitialized" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::isUninitializedLazyObject - Manual" />
<meta itemprop="description" content="Checks if an object is lazy and uninitialized" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if an object is lazy and uninitialized" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionclass.isuserdefined.php">
          ReflectionClass::isUserDefined &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.istrait.php">
          &laquo; ReflectionClass::isTrait        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.isuninitializedlazyobject.php' selected="selected">English</option>
            <option value='de/reflectionclass.isuninitializedlazyobject.php'>German</option>
            <option value='es/reflectionclass.isuninitializedlazyobject.php'>Spanish</option>
            <option value='fr/reflectionclass.isuninitializedlazyobject.php'>French</option>
            <option value='it/reflectionclass.isuninitializedlazyobject.php'>Italian</option>
            <option value='ja/reflectionclass.isuninitializedlazyobject.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.isuninitializedlazyobject.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.isuninitializedlazyobject.php'>Russian</option>
            <option value='tr/reflectionclass.isuninitializedlazyobject.php'>Turkish</option>
            <option value='uk/reflectionclass.isuninitializedlazyobject.php'>Ukrainian</option>
            <option value='zh/reflectionclass.isuninitializedlazyobject.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.isuninitializedlazyobject" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::isUninitializedLazyObject</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.4.0)</p><p class="refpurpose"><span class="refname">ReflectionClass::isUninitializedLazyObject</span> &mdash; <span class="dc-title">Checks if an object is lazy and uninitialized</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.isuninitializedlazyobject-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::isUninitializedLazyObject</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.object.php" class="type object">object</a></span> <code class="parameter">$object</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.isuninitializedlazyobject-parameters">
...
bool(false)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.isuninitializedlazyobject-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="reflectionclass.initializelazyobject.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::initializeLazyObject()</a> - Forces initialization of a lazy object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/isuninitializedlazyobject.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.isuninitializedlazyobject%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.isuninitializedlazyobject&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isuninitializedlazyobject.php">＋<small>add a note</small></a></span>
