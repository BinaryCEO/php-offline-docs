...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-monitoring-commandsucceededevent.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-monitoring-commandstartedevent.getserviceid.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-monitoring-commandsucceededevent.getcommandname.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-monitoring-commandsucceededevent.php' selected="selected">English</option>
            ...
            <option value='zh/class.mongodb-driver-monitoring-commandsucceededevent.php'>Chinese (Simplified)</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-monitoring-commandsucceededevent.getcommandname.php">MongoDB\Driver\Monitoring\CommandSucceededEvent::getCommandName</a> — Returns the command name</li><li><a href="mongodb-driver-monitoring-commandsucceededevent.getdatabasename.php">MongoDB\Driver\Monitoring\CommandSucceededEvent::getDatabaseName</a> — Returns the database on which the command was executed</li><li><a href="mongodb-driver-monitoring-commandsucceededevent.getdurationmicros.php">MongoDB\Driver\Monitoring\CommandSucceededEvent::getDurationMicros</a> — Returns the command's duration in microseconds</li><li><a href="mongodb-driver-monitoring-commandsucceededevent.gethost.php">MongoDB\Driver\Monitoring\CommandSucceededEvent::getHost</a> — Returns the server hostname for the command</li><li><a href="mongodb-driver-monitoring-commandsucceededevent.getoperationid.php">MongoDB\Driver\Monitoring\CommandSucceededEvent::getOperationId</a> — Returns the command's operation ID</li><li><a href="mongodb-driver-monitoring-commandsucceededevent.getport.php">MongoDB\Driver\Monitoring\CommandSucceededEvent::getPort</a> — Returns the server port for the command</li><li><a href="mongodb-driver-monitoring-commandsucceededevent.getreply.php">MongoDB\Driver\Monitoring\CommandSucceededEvent::getReply</a> — Returns the command reply document</li><li><a href="mongodb-driver-monitoring-commandsucceededevent.getrequestid.php">MongoDB\Driver\Monitoring\CommandSucceededEvent::getRequestId</a> — Returns the command's request ID</li><li><a href="mongodb-driver-monitoring-commandsucceededevent.getserver.php">MongoDB\Driver\Monitoring\CommandSucceededEvent::getServer</a> — Returns the Server on which the command was executed</li><li><a href="mongodb-driver-monitoring-commandsucceededevent.getserverconnectionid.php">MongoDB\Driver\Monitoring\CommandSucceededEvent::getServerConnectionId</a> — Returns the server connection ID for the command</li><li><a href="mongodb-driver-monitoring-commandsucceededevent.getserviceid.php">MongoDB\Driver\Monitoring\CommandSucceededEvent::getServiceId</a> — Returns the load balancer service ID for the command</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/monitoring/commandsucceededevent.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-monitoring-commandsucceededevent%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-monitoring-commandsucceededevent&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-monitoring-commandsucceededevent.php">＋<small>add a note</small></a></span>
