...
<head>
  ...
  <title>PHP: mysql_field_flags - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-field-flags.php">
 <link rel="shorturl" href="https://www.php.net/mysql-field-flags">
 <link rel="alternate" href="https://www.php.net/mysql-field-flags" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-fetch-row.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-field-len.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-field-flags.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-field-flags.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-field-flags.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-field-flags.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-field-flags.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-field-flags.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-field-flags.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-field-flags.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-field-flags.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-field-flags.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-field-flags.php" hreflang="zh">
...
<meta name="Description" content="Get the flags associated with the specified field in a result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_field_flags - Manual" />
<meta name="twitter:description" content="Get the flags associated with the specified field in a result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_field_flags - Manual" />
<meta itemprop="description" content="Get the flags associated with the specified field in a result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the flags associated with the specified field in a result" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-field-len.php">
          mysql_field_len &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-fetch-row.php">
          &laquo; mysql_fetch_row        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-field-flags.php' selected="selected">English</option>
            <option value='de/function.mysql-field-flags.php'>German</option>
            <option value='es/function.mysql-field-flags.php'>Spanish</option>
            <option value='fr/function.mysql-field-flags.php'>French</option>
            <option value='it/function.mysql-field-flags.php'>Italian</option>
            <option value='ja/function.mysql-field-flags.php'>Japanese</option>
            <option value='pt_BR/function.mysql-field-flags.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-field-flags.php'>Russian</option>
            <option value='tr/function.mysql-field-flags.php'>Turkish</option>
            <option value='uk/function.mysql-field-flags.php'>Ukrainian</option>
            <option value='zh/function.mysql-field-flags.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-field-flags" class="refentry">
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> is also issued.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-field-flags-returnvalues">
  ...
  <p class="para">
   Returns a string of flags associated with the result or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
  <p class="para">
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-field-flags-examples">
  ...
  <p class="para">
   <div class="example" id="example-1899">
    <p><strong>Example #1 A <span class="function"><strong>mysql_field_flags()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-field-len.php" class="function" rel="rdfs-seeAlso">mysql_field_len()</a> - Returns the length of the specified field</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-field-flags.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-field-flags%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-field-flags&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-field-flags.php">＋<small>add a note</small></a></span>
