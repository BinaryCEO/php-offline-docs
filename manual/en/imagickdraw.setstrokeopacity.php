...
<head>
  ...
  <title>PHP: ImagickDraw::setStrokeOpacity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setstrokeopacity.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setstrokeopacity.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokeopacity.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setstrokemiterlimit.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setstrokepatternurl.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokeopacity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setstrokeopacity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setstrokeopacity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setstrokeopacity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setstrokeopacity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setstrokeopacity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setstrokeopacity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setstrokeopacity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setstrokeopacity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setstrokeopacity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setstrokeopacity.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::setStrokeOpacity - Manual" />
<meta name="twitter:description" content="Specifies the opacity of stroked object outlines" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setStrokeOpacity - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setstrokepatternurl.php">
          ImagickDraw::setStrokePatternURL &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setstrokemiterlimit.php">
          &laquo; ImagickDraw::setStrokeMiterLimit        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setstrokeopacity.php' selected="selected">English</option>
            <option value='de/imagickdraw.setstrokeopacity.php'>German</option>
            <option value='es/imagickdraw.setstrokeopacity.php'>Spanish</option>
            <option value='fr/imagickdraw.setstrokeopacity.php'>French</option>
            <option value='it/imagickdraw.setstrokeopacity.php'>Italian</option>
            <option value='ja/imagickdraw.setstrokeopacity.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setstrokeopacity.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setstrokeopacity.php'>Russian</option>
            <option value='tr/imagickdraw.setstrokeopacity.php'>Turkish</option>
            <option value='uk/imagickdraw.setstrokeopacity.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setstrokeopacity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setstrokeopacity" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setStrokeOpacity</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setStrokeOpacity</span> &mdash; <span class="dc-title">Specifies the opacity of stroked object outlines</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setstrokeopacity-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setStrokeOpacity</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$opacity</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setstrokeopacity-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setstrokeopacity-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3189">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setstrokeopacity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setstrokeopacity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setstrokeopacity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokeopacity.php">＋<small>add a note</small></a></span>
