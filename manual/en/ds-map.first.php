...
<head>
  ...
  <title>PHP: Ds\Map::first - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-map.first.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-map.first.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-map.first.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-map.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-map.filter.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-map.get.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ds-map.first.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ds-map.first.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ds-map.first.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ds-map.first.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ds-map.first.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ds-map.first.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ds-map.first.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ds-map.first.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ds-map.first.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ds-map.first.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ds-map.first.php" hreflang="zh">
...
<meta name="Description" content="Returns the first pair in the map" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Ds\Map::first - Manual" />
<meta name="twitter:description" content="Returns the first pair in the map" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Ds\Map::first - Manual" />
<meta itemprop="description" content="Returns the first pair in the map" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the first pair in the map" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-map.first.php' selected="selected">English</option>
            <option value='de/ds-map.first.php'>German</option>
            <option value='es/ds-map.first.php'>Spanish</option>
            <option value='fr/ds-map.first.php'>French</option>
            <option value='it/ds-map.first.php'>Italian</option>
            <option value='ja/ds-map.first.php'>Japanese</option>
            <option value='pt_BR/ds-map.first.php'>Brazilian Portuguese</option>
            <option value='ru/ds-map.first.php'>Russian</option>
            <option value='tr/ds-map.first.php'>Turkish</option>
            <option value='uk/ds-map.first.php'>Ukrainian</option>
            <option value='zh/ds-map.first.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ds-map.first" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-ds-map.first-examples">
  ...
  <div class="example" id="example-4376">
   <p><strong>Example #1 <span class="function"><strong>Ds\Map::first()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">object(Ds\Pair)#2 (2) {
  ...
  int(1)
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/map/first.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-map.first%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-map.first&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-map.first.php">＋<small>add a note</small></a></span>
