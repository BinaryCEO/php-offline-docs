...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.mysqli.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.mysqli.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.mysqli.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.mysqli.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.overview.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.mysqli.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.mysqli.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.mysqli.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.mysqli.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.mysqli.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.mysqli.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.mysqli.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.mysqli.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.mysqli.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.mysqli.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.mysqli.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.mysqli.php' selected="selected">English</option>
            <option value='de/intro.mysqli.php'>German</option>
            <option value='es/intro.mysqli.php'>Spanish</option>
            <option value='fr/intro.mysqli.php'>French</option>
            <option value='it/intro.mysqli.php'>Italian</option>
            <option value='ja/intro.mysqli.php'>Japanese</option>
            <option value='pt_BR/intro.mysqli.php'>Brazilian Portuguese</option>
            <option value='ru/intro.mysqli.php'>Russian</option>
            <option value='tr/intro.mysqli.php'>Turkish</option>
            <option value='uk/intro.mysqli.php'>Ukrainian</option>
            <option value='zh/intro.mysqli.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.mysqli" class="preface">
  ...
  <p class="para">
   ...
   freely available.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.mysqli%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.mysqli&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.mysqli.php">＋<small>add a note</small></a></span>
