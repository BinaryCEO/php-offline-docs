...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileinfo.isdir.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileinfo.isdir.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileinfo.isdir.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileinfo.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileinfo.gettype.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileinfo.isexecutable.php">
...
<meta name="Description" content="Tells if the file is a directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplFileInfo::isDir - Manual" />
<meta name="twitter:description" content="Tells if the file is a directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplFileInfo::isDir - Manual" />
<meta itemprop="description" content="Tells if the file is a directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Tells if the file is a directory" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileinfo.isdir.php' selected="selected">English</option>
            ...
            <option value='pt_BR/splfileinfo.isdir.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.2, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">SplFileInfo::isDir</span> &mdash; <span class="dc-title">Tells if the file is a directory</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-splfileinfo.isdir-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if a directory, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-splfileinfo.isdir-examples">
  ...
  <p class="para">
   <div class="example" id="example-3981">
    <p><strong>Example #1 <span class="function"><strong>SplFileInfo::isDir()</strong></span> example</strong></p>
...
bool(false)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileinfo/isdir.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileinfo.isdir%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileinfo.isdir&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileinfo.isdir.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Documentation is a bit misleading.<br /><br />SplFileInfo-&gt;isDir() and other classes (e.g. DirectoryIterator-&gt;isDir()) return TRUE for symlinks of directories. Better use getType() method instead, which returns 'link' for symlinks.<br /><br />This was reported long time ago - <a href="https://bugs.php.net/bug.php?id=72364" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=72364</a> , but docs are still not fixed.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=splfileinfo.isdir&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileinfo.isdir.php">＋<small>add a note</small></a></div>
