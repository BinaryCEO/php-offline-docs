...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileinfo.gettype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileinfo.gettype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileinfo.gettype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileinfo.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileinfo.getsize.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileinfo.isdir.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileinfo.gettype.php' selected="selected">English</option>
            ...
            <option value='pt_BR/splfileinfo.gettype.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.2, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">SplFileInfo::getType</span> &mdash; <span class="dc-title">Gets file type</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-splfileinfo.gettype-returnvalues">
  ...
  <p class="para">
   A <span class="type"><a href="language.types.string.php" class="type string">string</a></span> representing the type of the entry.
   May be one of <code class="literal">file</code>, <code class="literal">link</code>,
   <code class="literal">dir</code>, <code class="literal">block</code>, <code class="literal">fifo</code>,
   <code class="literal">char</code>, <code class="literal">socket</code>, or <code class="literal">unknown</code>, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 errors" id="refsect1-splfileinfo.gettype-errors">
  ...
  <p class="para">
   Throws a <span class="classname"><a href="class.runtimeexception.php" class="classname">RuntimeException</a></span> on error.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-splfileinfo.gettype-examples">
  ...
  <p class="para">
   <div class="example" id="example-3980">
    <p><strong>Example #1 <span class="function"><strong>SplFileInfo::getType()</strong></span> example</strong></p>
...
dir</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileinfo/gettype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileinfo.gettype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileinfo.gettype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileinfo.gettype.php">＋<small>add a note</small></a></span>
