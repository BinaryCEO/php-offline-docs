...
<head>
  ...
  <title>PHP: svn_repos_fs_commit_txn - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-repos-fs-commit-txn.php">
 <link rel="shorturl" href="https://www.php.net/svn-repos-fs-commit-txn">
 <link rel="alternate" href="https://www.php.net/svn-repos-fs-commit-txn" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-repos-fs-begin-txn-for-commit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-repos-hotcopy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-repos-fs-commit-txn.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-repos-fs-commit-txn.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-repos-fs-commit-txn.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-repos-fs-commit-txn.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-repos-fs-commit-txn.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-repos-fs-commit-txn.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-repos-fs-commit-txn.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-repos-fs-commit-txn.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-repos-fs-commit-txn.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-repos-fs-commit-txn.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-repos-fs-commit-txn.php" hreflang="zh">
...
<meta name="Description" content="Commits a transaction and returns the new revision" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_repos_fs_commit_txn - Manual" />
<meta name="twitter:description" content="Commits a transaction and returns the new revision" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_repos_fs_commit_txn - Manual" />
<meta itemprop="description" content="Commits a transaction and returns the new revision" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Commits a transaction and returns the new revision" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.svn-repos-hotcopy.php">
          svn_repos_hotcopy &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.svn-repos-fs-begin-txn-for-commit.php">
          &laquo; svn_repos_fs_begin_txn_for_commit        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-repos-fs-commit-txn.php' selected="selected">English</option>
            <option value='de/function.svn-repos-fs-commit-txn.php'>German</option>
            <option value='es/function.svn-repos-fs-commit-txn.php'>Spanish</option>
            <option value='fr/function.svn-repos-fs-commit-txn.php'>French</option>
            <option value='it/function.svn-repos-fs-commit-txn.php'>Italian</option>
            <option value='ja/function.svn-repos-fs-commit-txn.php'>Japanese</option>
            <option value='pt_BR/function.svn-repos-fs-commit-txn.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-repos-fs-commit-txn.php'>Russian</option>
            <option value='tr/function.svn-repos-fs-commit-txn.php'>Turkish</option>
            <option value='uk/function.svn-repos-fs-commit-txn.php'>Ukrainian</option>
            <option value='zh/function.svn-repos-fs-commit-txn.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-repos-fs-commit-txn" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">svn_repos_fs_commit_txn</h1>
  <p class="verinfo">(PECL svn &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">svn_repos_fs_commit_txn</span> &mdash; <span class="dc-title">Commits a transaction and returns the new revision</span></p>
...
This function should be used at your own risk.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-repos-fs-commit-txn.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-repos-fs-commit-txn%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-repos-fs-commit-txn&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-repos-fs-commit-txn.php">＋<small>add a note</small></a></span>
