...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/curl.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/curl.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/curl.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.curl.php">
 <link rel="prev" href="https://www.php.net/manual/en/curl.resources.php">
 <link rel="next" href="https://www.php.net/manual/en/curl.examples.php">

 <link rel="alternate" href="https://www.php.net/manual/en/curl.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/curl.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/curl.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/curl.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/curl.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/curl.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/curl.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/curl.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/curl.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/curl.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/curl.constants.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/curl.constants.php' selected="selected">English</option>
            <option value='de/curl.constants.php'>German</option>
            <option value='es/curl.constants.php'>Spanish</option>
            <option value='fr/curl.constants.php'>French</option>
            <option value='it/curl.constants.php'>Italian</option>
            <option value='ja/curl.constants.php'>Japanese</option>
            <option value='pt_BR/curl.constants.php'>Brazilian Portuguese</option>
            <option value='ru/curl.constants.php'>Russian</option>
            <option value='tr/curl.constants.php'>Turkish</option>
            <option value='uk/curl.constants.php'>Ukrainian</option>
            <option value='zh/curl.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="curl.constants" class="appendix">
    ...
    <p class="para">
     ...
     <div class="warning"><strong class="warning">Warning</strong>
      <p class="simpara">
       ...
       destroyed, call <span class="function"><a href="function.unset.php" class="function">unset()</a></span> on the handle.
      </p>
     </div>
    </p>
   </td>
...
<br />*/
<br />
<br />$url = '<a href="http://www.ericgiguere.com/tools/http-header-viewer.html" rel="nofollow" target="_blank">http://www.ericgiguere.com/tools/http-header-viewer.html</a>';
<br />
<br />// disguises the curl using fake headers and a fake user agent.
<br />function disguise_curl($url)
<br />{
<br />  $curl = curl_init();
<br />
<br />  // Setup headers - I used the same headers from Firefox version 2.0.0.6
<br />  // below was split up because php.net said the line was too long. :/
<br />  $header[0] = "Accept: text/xml,application/xml,application/xhtml+xml,";
<br />  $header[0] .= "text/html;q=0.9,text/plain;q=0.8,image/png,*/*;q=0.5";
<br />  $header[] = "Cache-Control: max-age=0";
...
<br />  $header[] = "Pragma: "; // browsers keep this blank.
<br />
<br />  curl_setopt($curl, CURLOPT_URL, $url);
<br />  curl_setopt($curl, CURLOPT_USERAGENT, 'Googlebot/2.1 (+<a href="http://www.google.com/bot.html" rel="nofollow" target="_blank">http://www.google.com/bot.html</a>)');
<br />  curl_setopt($curl, CURLOPT_HTTPHEADER, $header);
<br />  curl_setopt($curl, CURLOPT_REFERER, '<a href="http://www.google.com" rel="nofollow" target="_blank">http://www.google.com</a>');
<br />  curl_setopt($curl, CURLOPT_ENCODING, 'gzip,deflate');
<br />  curl_setopt($curl, CURLOPT_AUTOREFERER, true);
<br />  curl_setopt($curl, CURLOPT_RETURNTRANSFER, 1);
<br />  curl_setopt($curl, CURLOPT_TIMEOUT, 10);
<br />
<br />  $html = curl_exec($curl); // execute the curl command
<br />  curl_close($curl); // close the connection
<br />
<br />  return $html; // and finally, return $html
<br />}
<br />
<br />// uses the function and displays the text off the website
<br />$text = disguise_curl($url);
<br />echo $text;
<br />?&gt;
<br />
<br />~Ron</span></code></div>
  </div>
 </div>
  <div class="note" id="130030">  <div class="votes">
    <div id="Vu130030">
    <a href="/manual/vote-note.php?id=130030&amp;page=curl.constants&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130030">
    <a href="/manual/vote-note.php?id=130030&amp;page=curl.constants&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130030" title="100% like this...">
    1
    </div>
  </div>
  <a href="#130030" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#130030"> &para;</a><div class="date" title="2025-02-16 03:33"><strong>7 months ago</strong></div>
  <div class="text" id="Hcom130030">
<div class="phpcode"><code><span class="html">If CURLINFO_HEADER_OUT  is true and CURLOPT_VERBOSE is true, Verbose will not work! CURLINFO_HEADER_OUT  must be false for CURLOPT_VERBOSE to work!</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=curl.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/curl.constants.php">＋<small>add a note</small></a></div>
