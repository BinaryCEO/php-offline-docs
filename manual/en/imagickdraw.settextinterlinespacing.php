...
<head>
  ...
  <title>PHP: ImagickDraw::setTextInterlineSpacing - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.settextinterlinespacing.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.settextinterlinespacing.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextinterlinespacing.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.settextencoding.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.settextinterwordspacing.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextinterlinespacing.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.settextinterlinespacing.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.settextinterlinespacing.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.settextinterlinespacing.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.settextinterlinespacing.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.settextinterlinespacing.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.settextinterlinespacing.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.settextinterlinespacing.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.settextinterlinespacing.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.settextinterlinespacing.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.settextinterlinespacing.php" hreflang="zh">
...
<meta name="Description" content="Sets the text interline spacing" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setTextInterlineSpacing - Manual" />
<meta name="twitter:description" content="Sets the text interline spacing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setTextInterlineSpacing - Manual" />
<meta itemprop="description" content="Sets the text interline spacing" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the text interline spacing" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.settextinterwordspacing.php">
          ImagickDraw::setTextInterwordSpacing &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.settextencoding.php">
          &laquo; ImagickDraw::setTextEncoding        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.settextinterlinespacing.php' selected="selected">English</option>
            <option value='de/imagickdraw.settextinterlinespacing.php'>German</option>
            <option value='es/imagickdraw.settextinterlinespacing.php'>Spanish</option>
            <option value='fr/imagickdraw.settextinterlinespacing.php'>French</option>
            <option value='it/imagickdraw.settextinterlinespacing.php'>Italian</option>
            <option value='ja/imagickdraw.settextinterlinespacing.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.settextinterlinespacing.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.settextinterlinespacing.php'>Russian</option>
            <option value='tr/imagickdraw.settextinterlinespacing.php'>Turkish</option>
            <option value='uk/imagickdraw.settextinterlinespacing.php'>Ukrainian</option>
            <option value='zh/imagickdraw.settextinterlinespacing.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.settextinterlinespacing" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setTextInterlineSpacing</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.1.0)</p><p class="refpurpose"><span class="refname">ImagickDraw::setTextInterlineSpacing</span> &mdash; <span class="dc-title">Sets the text interline spacing</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.settextinterlinespacing-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setTextInterlineSpacing</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$spacing</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.settextinterlinespacing-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.settextinterlinespacing-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/settextinterlinespacing.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.settextinterlinespacing%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.settextinterlinespacing&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.settextinterlinespacing.php">＋<small>add a note</small></a></span>
