...
<head>
  ...
  <title>PHP: Imagick::tintImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.tintimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.tintimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.tintimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.thumbnailimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.tostring.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.tintimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.tintimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.tintimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.tintimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.tintimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.tintimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.tintimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.tintimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.tintimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.tintimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.tintimage.php" hreflang="zh">
...
<meta name="Description" content="Applies a color vector to each pixel in the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::tintImage - Manual" />
<meta name="twitter:description" content="Applies a color vector to each pixel in the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::tintImage - Manual" />
<meta itemprop="description" content="Applies a color vector to each pixel in the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Applies a color vector to each pixel in the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.tostring.php">
          Imagick::__toString &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.thumbnailimage.php">
          &laquo; Imagick::thumbnailImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.tintimage.php' selected="selected">English</option>
            <option value='de/imagick.tintimage.php'>German</option>
            <option value='es/imagick.tintimage.php'>Spanish</option>
            <option value='fr/imagick.tintimage.php'>French</option>
            <option value='it/imagick.tintimage.php'>Italian</option>
            <option value='ja/imagick.tintimage.php'>Japanese</option>
            <option value='pt_BR/imagick.tintimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.tintimage.php'>Russian</option>
            <option value='tr/imagick.tintimage.php'>Turkish</option>
            <option value='uk/imagick.tintimage.php'>Ukrainian</option>
            <option value='zh/imagick.tintimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.tintimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::tintImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::tintImage</span> &mdash; <span class="dc-title">Applies a color vector to each pixel in the image</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.tintimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::tintImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$tint</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$opacity</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$legacy</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.tintimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">tint</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
  ...
  <p class="para">
    <div class="example" id="example-3133">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/tintimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.tintimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.tintimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.tintimage.php">＋<small>add a note</small></a></span>
