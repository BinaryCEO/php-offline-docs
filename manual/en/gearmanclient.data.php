...
<head>
  ...
  <title>PHP: GearmanClient::data - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.data.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.data.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.data.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.context.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.do.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.data.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.data.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.data.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.data.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.data.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.data.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.data.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.data.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.data.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.data.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.data.php" hreflang="zh">
...
<meta name="Description" content="Get the application data (deprecated)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::data - Manual" />
<meta name="twitter:description" content="Get the application data (deprecated)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::data - Manual" />
<meta itemprop="description" content="Get the application data (deprecated)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the application data (deprecated)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearmanclient.do.php">
          GearmanClient::do &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.context.php">
          &laquo; GearmanClient::context        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.data.php' selected="selected">English</option>
            <option value='de/gearmanclient.data.php'>German</option>
            <option value='es/gearmanclient.data.php'>Spanish</option>
            <option value='fr/gearmanclient.data.php'>French</option>
            <option value='it/gearmanclient.data.php'>Italian</option>
            <option value='ja/gearmanclient.data.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.data.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.data.php'>Russian</option>
            <option value='tr/gearmanclient.data.php'>Turkish</option>
            <option value='uk/gearmanclient.data.php'>Ukrainian</option>
            <option value='zh/gearmanclient.data.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.data" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="gearmanclient.setdata.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::setData()</a> - Set application data (deprecated)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/data.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.data%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.data.php">＋<small>add a note</small></a></span>
