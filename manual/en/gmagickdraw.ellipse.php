...
<head>
  ...
  <title>PHP: GmagickDraw::ellipse - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagickdraw.ellipse.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagickdraw.ellipse.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagickdraw.ellipse.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagickdraw.bezier.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagickdraw.getfillcolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagickdraw.ellipse.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagickdraw.ellipse.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagickdraw.ellipse.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagickdraw.ellipse.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagickdraw.ellipse.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagickdraw.ellipse.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagickdraw.ellipse.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagickdraw.ellipse.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagickdraw.ellipse.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagickdraw.ellipse.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagickdraw.ellipse.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: GmagickDraw::ellipse - Manual" />
<meta name="twitter:description" content="Draws an ellipse on the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GmagickDraw::ellipse - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagickdraw.getfillcolor.php">
          GmagickDraw::getfillcolor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagickdraw.bezier.php">
          &laquo; GmagickDraw::bezier        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagickdraw.ellipse.php' selected="selected">English</option>
            <option value='de/gmagickdraw.ellipse.php'>German</option>
            <option value='es/gmagickdraw.ellipse.php'>Spanish</option>
            <option value='fr/gmagickdraw.ellipse.php'>French</option>
            <option value='it/gmagickdraw.ellipse.php'>Italian</option>
            <option value='ja/gmagickdraw.ellipse.php'>Japanese</option>
            <option value='pt_BR/gmagickdraw.ellipse.php'>Brazilian Portuguese</option>
            <option value='ru/gmagickdraw.ellipse.php'>Russian</option>
            <option value='tr/gmagickdraw.ellipse.php'>Turkish</option>
            <option value='uk/gmagickdraw.ellipse.php'>Ukrainian</option>
            <option value='zh/gmagickdraw.ellipse.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagickdraw.ellipse" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">GmagickDraw::ellipse</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">GmagickDraw::ellipse</span> &mdash; <span class="dc-title">Draws an ellipse on the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagickdraw.ellipse-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GmagickDraw::ellipse</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$ox</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$oy</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$rx</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$ry</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$start</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$end</code></span><br>): <span class="type"><a href="class.gmagickdraw.php" class="type GmagickDraw">GmagickDraw</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagickdraw.ellipse-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagickdraw.ellipse-returnvalues">
  ...
  <p class="para">
   The <span class="classname"><a href="class.gmagickdraw.php" class="classname">GmagickDraw</a></span> object.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagickdraw/ellipse.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagickdraw.ellipse%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagickdraw.ellipse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagickdraw.ellipse.php">＋<small>add a note</small></a></span>
