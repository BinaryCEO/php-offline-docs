...
<head>
  ...
  <title>PHP: pg_transaction_status - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-transaction-status.php">
 <link rel="shorturl" href="https://www.php.net/pg-transaction-status">
 <link rel="alternate" href="https://www.php.net/pg-transaction-status" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-trace.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-tty.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-transaction-status.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-transaction-status.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-transaction-status.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-transaction-status.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-transaction-status.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-transaction-status.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-transaction-status.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-transaction-status.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-transaction-status.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-transaction-status.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-transaction-status.php" hreflang="zh">
...
<meta name="Description" content="Returns the current in-transaction status of the server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_transaction_status - Manual" />
<meta name="twitter:description" content="Returns the current in-transaction status of the server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_transaction_status - Manual" />
<meta itemprop="description" content="Returns the current in-transaction status of the server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the current in-transaction status of the server" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-tty.php">
          pg_tty &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-trace.php">
          &laquo; pg_trace        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-transaction-status.php' selected="selected">English</option>
            <option value='de/function.pg-transaction-status.php'>German</option>
            <option value='es/function.pg-transaction-status.php'>Spanish</option>
            <option value='fr/function.pg-transaction-status.php'>French</option>
            <option value='it/function.pg-transaction-status.php'>Italian</option>
            <option value='ja/function.pg-transaction-status.php'>Japanese</option>
            <option value='pt_BR/function.pg-transaction-status.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-transaction-status.php'>Russian</option>
            <option value='tr/function.pg-transaction-status.php'>Turkish</option>
            <option value='uk/function.pg-transaction-status.php'>Ukrainian</option>
            <option value='zh/function.pg-transaction-status.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-transaction-status" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />  $dbconn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=publisher"</span><span style="color: #007700">) or die(</span><span style="color: #DD0000">"Could not connect"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">$stat </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_transaction_status</span><span style="color: #007700">(</span><span style="color: #0000BB">$dbconn</span><span style="color: #007700">);<br />  if (</span><span style="color: #0000BB">$stat </span><span style="color: #007700">=== </span><span style="color: #0000BB">PGSQL_TRANSACTION_UNKNOWN</span><span style="color: #007700">) {<br />      echo </span><span style="color: #DD0000">'Connection is bad'</span><span style="color: #007700">;<br />  } else if (</span><span style="color: #0000BB">$stat </span><span style="color: #007700">=== </span><span style="color: #0000BB">PGSQL_TRANSACTION_IDLE</span><span style="color: #007700">) {<br />      echo </span><span style="color: #DD0000">'Connection is currently idle'</span><span style="color: #007700">;<br />  } else {<br />      echo </span><span style="color: #DD0000">'Connection is in a transaction state'</span><span style="color: #007700">;<br />  }    <br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-transaction-status.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-transaction-status%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-transaction-status&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-transaction-status.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126528">  <div class="votes">
    <div id="Vu126528">
    <a href="/manual/vote-note.php?id=126528&amp;page=function.pg-transaction-status&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126528">
    <a href="/manual/vote-note.php?id=126528&amp;page=function.pg-transaction-status&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126528" title="no votes...">
    0
    </div>
  </div>
  <a href="#126528" class="name">
  <strong class="user"><em>r dot grellmann at agentmulder dot de</em></strong></a><a class="genanchor" href="#126528"> &para;</a><div class="date" title="2021-10-23 02:17"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126528">
<div class="phpcode"><code><span class="html">After one of the asynchronous functions (pg_send_query(), pg_send_query_params()...) has been used, pg_transaction_status() will always report PGSQL_TRANSACTION_ACTIVE, no matter if a transaction was started or not.<br />Even after the first call (or all valid calls) to pg_get_result() the transaction status will stay PGSQL_TRANSACTION_ACTIVE, until either<br />- a synchronous function like pq_query() was used, or<br />- another call to pg_get_result() was made, which returns false.<br />Note: calling pg_free_result() does not change anything.<br /><br /><span class="default">&lt;?php<br />  $conn </span><span class="keyword">= </span><span class="default">pg_connect</span><span class="keyword">(</span><span class="string">"dbname=publisher"</span><span class="keyword">) or die(</span><span class="string">"Could not connect"</span><span class="keyword">);<br />  </span><span class="default">$status </span><span class="keyword">= </span><span class="default">pg_transaction_status</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">); </span><span class="comment">// PGSQL_TRANSACTION_IDLE<br />  </span><span class="default">pg_send_query</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="string">'SELECT 1'</span><span class="keyword">);<br />  </span><span class="default">$status </span><span class="keyword">= </span><span class="default">pg_transaction_status</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">); </span><span class="comment">// PGSQL_TRANSACTION_ACTIVE<br />  </span><span class="default">$res </span><span class="keyword">= </span><span class="default">pg_get_result</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">);<br />  </span><span class="default">$status </span><span class="keyword">= </span><span class="default">pg_transaction_status</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">); </span><span class="comment">// PGSQL_TRANSACTION_ACTIVE<br />  </span><span class="default">$res </span><span class="keyword">= </span><span class="default">pg_get_result</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">); </span><span class="comment">// false<br />  </span><span class="default">$status </span><span class="keyword">= </span><span class="default">pg_transaction_status</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">); </span><span class="comment">// PGSQL_TRANSACTION_IDLE<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="68199">  <div class="votes">
    <div id="Vu68199">
    <a href="/manual/vote-note.php?id=68199&amp;page=function.pg-transaction-status&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd68199">
    <a href="/manual/vote-note.php?id=68199&amp;page=function.pg-transaction-status&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V68199" title="no votes...">
    0
    </div>
  </div>
  <a href="#68199" class="name">
  <strong class="user"><em>btherl at yahoo dot com dot au</em></strong></a><a class="genanchor" href="#68199"> &para;</a><div class="date" title="2006-07-17 07:27"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom68199">
<div class="phpcode"><code><span class="html">This function is implemented in C, so there's no way to mimic it in SQL for older versions of PHP.  But you can mimic some of the functionality by using a wrapper which keeps track of when you begin and commit/rollback transactions.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-transaction-status&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-transaction-status.php">＋<small>add a note</small></a></div>
