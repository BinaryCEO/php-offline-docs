...
<head>
  ...
  <title>PHP: Phar::convertToExecutable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.converttoexecutable.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.converttoexecutable.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.converttoexecutable.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.converttodata.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.copy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.converttoexecutable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.converttoexecutable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.converttoexecutable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.converttoexecutable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.converttoexecutable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.converttoexecutable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.converttoexecutable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.converttoexecutable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.converttoexecutable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.converttoexecutable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.converttoexecutable.php" hreflang="zh">
...
<meta name="Description" content="Convert a phar archive to another executable phar archive file format" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::convertToExecutable - Manual" />
<meta name="twitter:description" content="Convert a phar archive to another executable phar archive file format" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::convertToExecutable - Manual" />
<meta itemprop="description" content="Convert a phar archive to another executable phar archive file format" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Convert a phar archive to another executable phar archive file format" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.copy.php">
          Phar::copy &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.converttodata.php">
          &laquo; Phar::convertToData        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.converttoexecutable.php' selected="selected">English</option>
            <option value='de/phar.converttoexecutable.php'>German</option>
            <option value='es/phar.converttoexecutable.php'>Spanish</option>
            <option value='fr/phar.converttoexecutable.php'>French</option>
            <option value='it/phar.converttoexecutable.php'>Italian</option>
            <option value='ja/phar.converttoexecutable.php'>Japanese</option>
            <option value='pt_BR/phar.converttoexecutable.php'>Brazilian Portuguese</option>
            <option value='ru/phar.converttoexecutable.php'>Russian</option>
            <option value='tr/phar.converttoexecutable.php'>Turkish</option>
            <option value='uk/phar.converttoexecutable.php'>Ukrainian</option>
            <option value='zh/phar.converttoexecutable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.converttoexecutable" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::convertToExecutable</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">Phar::convertToExecutable</span> &mdash; <span class="dc-title">Convert a phar archive to another executable phar archive file format</span></p>
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
  ...
  <p class="para">
   If successful, the method creates a new archive on disk and returns a <span class="classname"><a href="class.phar.php" class="classname">Phar</a></span>
 ...
 <div class="refsect1 parameters" id="refsect1-phar.converttoexecutable-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       This should be one of <code class="literal">Phar::PHAR</code>, <code class="literal">Phar::TAR</code>,
     ...
     <dd>
      <p class="para">
       ...
       <code class="literal">.phar</code> in their file extension in order to be processed as a
       phar archive.
      </p>
      <p class="para">
       If converting to a phar-based archive, the default extensions are
       <code class="literal">.phar</code>, <code class="literal">.phar.gz</code>, or <code class="literal">.phar.bz2</code>
       depending on the specified compression.  For tar-based phar archives, the
       default extensions are <code class="literal">.phar.tar</code>, <code class="literal">.phar.tar.gz</code>,
       and <code class="literal">.phar.tar.bz2</code>.  For zip-based phar archives, the
       default extension is <code class="literal">.phar.zip</code>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-phar.converttoexecutable-returnvalues">
  ...
  <p class="para">
   The method returns a <span class="classname"><a href="class.phar.php" class="classname">Phar</a></span> object on success,
 ...
 <div class="refsect1 errors" id="refsect1-phar.converttoexecutable-errors">
  ...
  <p class="para">
   ...
   has not concluded with <span class="function"><a href="phar.stopbuffering.php" class="function">Phar::stopBuffering()</a></span>, an
   <span class="classname"><a href="class.unexpectedvalueexception.php" class="classname">UnexpectedValueException</a></span> if write support is disabled,
 ...
 <div class="refsect1 examples" id="refsect1-phar.converttoexecutable-examples">
  ...
  <p class="para">
   <div class="example" id="example-810">
    <p><strong>Example #1 A <span class="function"><strong>Phar::convertToExecutable()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phardata.converttodata.php" class="function" rel="rdfs-seeAlso">PharData::convertToData()</a> - Convert a phar archive to a non-executable tar or zip file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/convertToExecutable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.converttoexecutable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.converttoexecutable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.converttoexecutable.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="103733">  <div class="votes">
    <div id="Vu103733">
    <a href="/manual/vote-note.php?id=103733&amp;page=phar.converttoexecutable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103733">
    <a href="/manual/vote-note.php?id=103733&amp;page=phar.converttoexecutable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103733" title="50% like this...">
    0
    </div>
  </div>
  <a href="#103733" class="name">
  <strong class="user"><em>alex at phpguide dot co dot il</em></strong></a><a class="genanchor" href="#103733"> &para;</a><div class="date" title="2011-04-30 12:52"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103733">
<div class="phpcode"><code><span class="html">Convert to executable and compress methods override any stub you have created with their own stub which is responsible for extracting/executing self's content.<br /><br />calling setStub() after convertingToExecutable doesn't help either. As far of php 5.3.6 (phar     2.0.1 ) if you want to have a phar archive accessible threw the web, you'll have to create your own <br />index.php which will include a nonexecutable phar and act as the bootstrap.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phar.converttoexecutable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.converttoexecutable.php">＋<small>add a note</small></a></div>
