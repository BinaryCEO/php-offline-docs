...
<head>
  ...
  <title>PHP: fbird_add_user - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-add-user.php">
 <link rel="shorturl" href="https://www.php.net/fbird-add-user">
 <link rel="alternate" href="https://www.php.net/fbird-add-user" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-affected-rows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-add-user.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-add-user.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-add-user.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-add-user.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-add-user.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-add-user.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-add-user.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-add-user.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-add-user.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-add-user.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-add-user.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_add_user" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_add_user - Manual" />
<meta name="twitter:description" content="Alias of ibase_add_user" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_add_user - Manual" />
<meta itemprop="description" content="Alias of ibase_add_user" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_add_user" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fbird-affected-rows.php">
          fbird_affected_rows &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.ibase.php">
          &laquo; Firebird/InterBase Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-add-user.php' selected="selected">English</option>
            <option value='de/function.fbird-add-user.php'>German</option>
            <option value='es/function.fbird-add-user.php'>Spanish</option>
            <option value='fr/function.fbird-add-user.php'>French</option>
            <option value='it/function.fbird-add-user.php'>Italian</option>
            <option value='ja/function.fbird-add-user.php'>Japanese</option>
            <option value='pt_BR/function.fbird-add-user.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-add-user.php'>Russian</option>
            <option value='tr/function.fbird-add-user.php'>Turkish</option>
            <option value='uk/function.fbird-add-user.php'>Ukrainian</option>
            <option value='zh/function.fbird-add-user.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-add-user" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_add_user</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_add_user</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-add-user.php" class="function">ibase_add_user()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-add-user-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.ibase-add-user.php" class="function">ibase_add_user()</a></span>.
  </p>
 </div>

 
 <div class="refsect1 seealso" id="refsect1-function.fbird-add-user-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-modify-user.php" class="function" rel="rdfs-seeAlso">fbird_modify_user()</a> - Alias of ibase_modify_user</span></li>
    <li><span class="function"><a href="function.fbird-delete-user.php" class="function" rel="rdfs-seeAlso">fbird_delete_user()</a> - Alias of ibase_delete_user</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-add-user.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-add-user%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-add-user&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-add-user.php">＋<small>add a note</small></a></span>
