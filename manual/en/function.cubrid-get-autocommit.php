...
<head>
  ...
  <title>PHP: cubrid_get_autocommit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-get-autocommit.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-get-autocommit">
 <link rel="alternate" href="https://www.php.net/cubrid-get-autocommit" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-get-charset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-get-autocommit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-get-autocommit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-get-autocommit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-get-autocommit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-get-autocommit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-get-autocommit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-get-autocommit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-get-autocommit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-get-autocommit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-get-autocommit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-get-autocommit.php" hreflang="zh">
...
<meta name="Description" content="Get auto-commit mode of the connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_get_autocommit - Manual" />
<meta name="twitter:description" content="Get auto-commit mode of the connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_get_autocommit - Manual" />
<meta itemprop="description" content="Get auto-commit mode of the connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get auto-commit mode of the connection" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-get-charset.php">
          cubrid_get_charset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-get.php">
          &laquo; cubrid_get        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-get-autocommit.php' selected="selected">English</option>
            <option value='de/function.cubrid-get-autocommit.php'>German</option>
            <option value='es/function.cubrid-get-autocommit.php'>Spanish</option>
            <option value='fr/function.cubrid-get-autocommit.php'>French</option>
            <option value='it/function.cubrid-get-autocommit.php'>Italian</option>
            <option value='ja/function.cubrid-get-autocommit.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-get-autocommit.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-get-autocommit.php'>Russian</option>
            <option value='tr/function.cubrid-get-autocommit.php'>Turkish</option>
            <option value='uk/function.cubrid-get-autocommit.php'>Ukrainian</option>
            <option value='zh/function.cubrid-get-autocommit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-get-autocommit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_get_autocommit</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.4.0)</p><p class="refpurpose"><span class="refname">cubrid_get_autocommit</span> &mdash; <span class="dc-title">Get auto-commit mode of the connection</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-get-autocommit-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_get_autocommit</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   The <span class="function"><strong>cubrid_get_autocommit()</strong></span> function is used to get the status of CUBRID
 ...
 <div class="refsect1 parameters" id="refsect1-function.cubrid-get-autocommit-parameters">
 ...
 <p class="para">
  ...
  <div class="refsect1 returnvalues" id="refsect1-function.cubrid-get-autocommit-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
    <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, when auto-commit is on.
  </p>
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>, when auto-commit is off.
  </p>
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.cubrid-get-autocommit-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
   <li><span class="function"><a href="function.cubrid-set-autocommit.php" class="function" rel="rdfs-seeAlso">cubrid_set_autocommit()</a> - Set autocommit mode of the connection</span></li>
   <li><span class="function"><a href="function.cubrid-commit.php" class="function" rel="rdfs-seeAlso">cubrid_commit()</a> - Commit a transaction</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-get-autocommit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-get-autocommit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-get-autocommit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-get-autocommit.php">＋<small>add a note</small></a></span>
