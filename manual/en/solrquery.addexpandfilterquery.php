...
<head>
  ...
  <title>PHP: SolrQuery::addExpandFilterQuery - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addexpandfilterquery.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addexpandfilterquery.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addexpandfilterquery.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addexpandsortfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addexpandfilterquery.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addexpandfilterquery.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addexpandfilterquery.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addexpandfilterquery.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addexpandfilterquery.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addexpandfilterquery.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addexpandfilterquery.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addexpandfilterquery.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addexpandfilterquery.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addexpandfilterquery.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addexpandfilterquery.php" hreflang="zh">
...
<meta name="Description" content="Overrides main filter query, determines which documents to include in the main group" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addExpandFilterQuery - Manual" />
<meta name="twitter:description" content="Overrides main filter query, determines which documents to include in the main group" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addExpandFilterQuery - Manual" />
<meta itemprop="description" content="Overrides main filter query, determines which documents to include in the main group" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Overrides main filter query, determines which documents to include in the main group" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.addexpandsortfield.php">
          SolrQuery::addExpandSortField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.solrquery.php">
          &laquo; SolrQuery        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addexpandfilterquery.php' selected="selected">English</option>
            <option value='de/solrquery.addexpandfilterquery.php'>German</option>
            <option value='es/solrquery.addexpandfilterquery.php'>Spanish</option>
            <option value='fr/solrquery.addexpandfilterquery.php'>French</option>
            <option value='it/solrquery.addexpandfilterquery.php'>Italian</option>
            <option value='ja/solrquery.addexpandfilterquery.php'>Japanese</option>
            <option value='pt_BR/solrquery.addexpandfilterquery.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addexpandfilterquery.php'>Russian</option>
            <option value='tr/solrquery.addexpandfilterquery.php'>Turkish</option>
            <option value='uk/solrquery.addexpandfilterquery.php'>Ukrainian</option>
            <option value='zh/solrquery.addexpandfilterquery.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addexpandfilterquery" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addExpandFilterQuery</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::addExpandFilterQuery</span> &mdash; <span class="dc-title">Overrides main filter query, determines which documents to include in the main group</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addexpandfilterquery-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addExpandFilterQuery</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$fq</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.addexpandfilterquery-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">fq</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addexpandfilterquery-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.addexpandfilterquery-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.removeexpandfilterquery.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::removeExpandFilterQuery()</a> - Removes an expand filter query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addexpandfilterquery.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addexpandfilterquery%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addexpandfilterquery&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addexpandfilterquery.php">＋<small>add a note</small></a></span>
