...
<head>
  ...
  <title>PHP: variant_cmp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-cmp.php">
 <link rel="shorturl" href="https://www.php.net/variant-cmp">
 <link rel="alternate" href="https://www.php.net/variant-cmp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-cat.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-date-from-timestamp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.variant-cmp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.variant-cmp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.variant-cmp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.variant-cmp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.variant-cmp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.variant-cmp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.variant-cmp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.variant-cmp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.variant-cmp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.variant-cmp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.variant-cmp.php" hreflang="zh">
...
<meta name="Description" content="Compares two variants" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant_cmp - Manual" />
<meta name="twitter:description" content="Compares two variants" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant_cmp - Manual" />
<meta itemprop="description" content="Compares two variants" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Compares two variants" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.variant-date-from-timestamp.php">
          variant_date_from_timestamp &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-cmp.php' selected="selected">English</option>
            <option value='de/function.variant-cmp.php'>German</option>
            <option value='es/function.variant-cmp.php'>Spanish</option>
            <option value='fr/function.variant-cmp.php'>French</option>
            <option value='it/function.variant-cmp.php'>Italian</option>
            <option value='ja/function.variant-cmp.php'>Japanese</option>
            <option value='pt_BR/function.variant-cmp.php'>Brazilian Portuguese</option>
            <option value='ru/function.variant-cmp.php'>Russian</option>
            <option value='tr/function.variant-cmp.php'>Turkish</option>
            <option value='uk/function.variant-cmp.php'>Ukrainian</option>
            <option value='zh/function.variant-cmp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.variant-cmp" class="refentry">
    ...
    <caption><strong>Variant Comparision Results</strong></caption>
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-cmp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-cmp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-cmp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-cmp.php">＋<small>add a note</small></a></span>
