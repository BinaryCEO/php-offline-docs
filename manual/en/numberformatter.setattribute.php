...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/numberformatter.setattribute.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/numberformatter.setattribute.php">
 <link rel="alternate" href="https://www.php.net/manual/en/numberformatter.setattribute.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.numberformatter.php">
 <link rel="prev" href="https://www.php.net/manual/en/numberformatter.parsecurrency.php">
 <link rel="next" href="https://www.php.net/manual/en/numberformatter.setpattern.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/numberformatter.setattribute.php' selected="selected">English</option>
            ...
            <option value='ja/numberformatter.setattribute.php'>Japanese</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="numberformatter.settextattribute.php" class="function" rel="rdfs-seeAlso">numfmt_set_text_attribute()</a> - Set a text attribute</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/numberformatter/set-attribute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fnumberformatter.setattribute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=numberformatter.setattribute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/numberformatter.setattribute.php">＋<small>add a note</small></a></span>
