...
<head>
  ...
  <title>PHP: mysql_escape_string - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-escape-string.php">
 <link rel="shorturl" href="https://www.php.net/mysql-escape-string">
 <link rel="alternate" href="https://www.php.net/mysql-escape-string" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-fetch-array.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-escape-string.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-escape-string.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-escape-string.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-escape-string.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-escape-string.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-escape-string.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-escape-string.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-escape-string.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-escape-string.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-escape-string.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-escape-string.php" hreflang="zh">
...
<meta name="Description" content="Escapes a string for use in a mysql_query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_escape_string - Manual" />
<meta name="twitter:description" content="Escapes a string for use in a mysql_query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_escape_string - Manual" />
<meta itemprop="description" content="Escapes a string for use in a mysql_query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Escapes a string for use in a mysql_query" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-fetch-array.php">
          mysql_fetch_array &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-escape-string.php' selected="selected">English</option>
            <option value='de/function.mysql-escape-string.php'>German</option>
            <option value='es/function.mysql-escape-string.php'>Spanish</option>
            <option value='fr/function.mysql-escape-string.php'>French</option>
            <option value='it/function.mysql-escape-string.php'>Italian</option>
            <option value='ja/function.mysql-escape-string.php'>Japanese</option>
            <option value='pt_BR/function.mysql-escape-string.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-escape-string.php'>Russian</option>
            <option value='tr/function.mysql-escape-string.php'>Turkish</option>
            <option value='uk/function.mysql-escape-string.php'>Ukrainian</option>
            <option value='zh/function.mysql-escape-string.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-escape-string" class="refentry">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="function.mysqli-escape-string.php" class="function">mysqli_escape_string()</a></span></li>
 ...
 <div class="refsect1 description" id="refsect1-function.mysql-escape-string-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_escape_string</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$unescaped_string</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   This function will escape the <code class="parameter">unescaped_string</code>,
   so that it is safe to place it in a <span class="function"><a href="function.mysql-query.php" class="function">mysql_query()</a></span>.
   This function is deprecated.
  </p>
  <p class="para">
   This function is identical to <span class="function"><a href="function.mysql-real-escape-string.php" class="function">mysql_real_escape_string()</a></span> 
   except that <span class="function"><a href="function.mysql-real-escape-string.php" class="function">mysql_real_escape_string()</a></span> takes a 
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mysql-real-escape-string.php" class="function" rel="rdfs-seeAlso">mysql_real_escape_string()</a> - Escapes special characters in a string for use in an SQL statement</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-escape-string.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-escape-string%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-escape-string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-escape-string.php">＋<small>add a note</small></a></span>
