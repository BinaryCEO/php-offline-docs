...
<head>
  ...
  <title>PHP: ImagickDraw::comment - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.comment.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.comment.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.comment.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.color.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.composite.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.comment.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.comment.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.comment.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.comment.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.comment.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.comment.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.comment.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.comment.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.comment.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.comment.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.comment.php" hreflang="zh">
...
<meta name="Description" content="Adds a comment" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::comment - Manual" />
<meta name="twitter:description" content="Adds a comment" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::comment - Manual" />
<meta itemprop="description" content="Adds a comment" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds a comment" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.composite.php">
          ImagickDraw::composite &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.color.php">
          &laquo; ImagickDraw::color        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.comment.php' selected="selected">English</option>
            <option value='de/imagickdraw.comment.php'>German</option>
            <option value='es/imagickdraw.comment.php'>Spanish</option>
            <option value='fr/imagickdraw.comment.php'>French</option>
            <option value='it/imagickdraw.comment.php'>Italian</option>
            <option value='ja/imagickdraw.comment.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.comment.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.comment.php'>Russian</option>
            <option value='tr/imagickdraw.comment.php'>Turkish</option>
            <option value='uk/imagickdraw.comment.php'>Ukrainian</option>
            <option value='zh/imagickdraw.comment.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.comment" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::comment</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::comment</span> &mdash; <span class="dc-title">Adds a comment</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.comment-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::comment</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$comment</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.comment-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.comment-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/comment.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.comment%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.comment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.comment.php">＋<small>add a note</small></a></span>
