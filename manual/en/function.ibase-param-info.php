...
<head>
  ...
  <title>PHP: ibase_param_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-param-info.php">
 <link rel="shorturl" href="https://www.php.net/ibase-param-info">
 <link rel="alternate" href="https://www.php.net/ibase-param-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-num-params.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-pconnect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-param-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-param-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-param-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-param-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-param-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-param-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-param-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-param-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-param-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-param-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-param-info.php" hreflang="zh">
...
<meta name="Description" content="Return information about a parameter in a prepared query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_param_info - Manual" />
<meta name="twitter:description" content="Return information about a parameter in a prepared query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_param_info - Manual" />
<meta itemprop="description" content="Return information about a parameter in a prepared query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return information about a parameter in a prepared query" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-pconnect.php">
          ibase_pconnect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-num-params.php">
          &laquo; ibase_num_params        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-param-info.php' selected="selected">English</option>
            <option value='de/function.ibase-param-info.php'>German</option>
            <option value='es/function.ibase-param-info.php'>Spanish</option>
            <option value='fr/function.ibase-param-info.php'>French</option>
            <option value='it/function.ibase-param-info.php'>Italian</option>
            <option value='ja/function.ibase-param-info.php'>Japanese</option>
            <option value='pt_BR/function.ibase-param-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-param-info.php'>Russian</option>
            <option value='tr/function.ibase-param-info.php'>Turkish</option>
            <option value='uk/function.ibase-param-info.php'>Ukrainian</option>
            <option value='zh/function.ibase-param-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-param-info" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_param_info</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_param_info</span> &mdash; <span class="dc-title">Return information about a parameter in a prepared query</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ibase-param-info-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_param_info</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$query</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$param_number</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ibase-param-info-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">param_number</code></dt>
     <dd>
      <p class="para">
       Parameter offset.
      </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-param-info-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-num-params.php" class="function" rel="rdfs-seeAlso">ibase_num_params()</a> - Return the number of parameters in a prepared query</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-param-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-param-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-param-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-param-info.php">＋<small>add a note</small></a></span>
