...
<head>
  ...
  <title>PHP: MongoDB\Driver\Cursor::isDead - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-cursor.isdead.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-cursor.isdead.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-cursor.isdead.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-cursor.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-cursor.getserver.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-cursor.key.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-cursor.isdead.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-cursor.isdead.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-cursor.isdead.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-cursor.isdead.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-cursor.isdead.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-cursor.isdead.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-cursor.isdead.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-cursor.isdead.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-cursor.isdead.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-cursor.isdead.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-cursor.isdead.php" hreflang="zh">
...
<meta name="Description" content="Checks if the cursor is exhausted or may have additional results" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Cursor::isDead - Manual" />
<meta name="twitter:description" content="Checks if the cursor is exhausted or may have additional results" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Cursor::isDead - Manual" />
<meta itemprop="description" content="Checks if the cursor is exhausted or may have additional results" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if the cursor is exhausted or may have additional results" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mongodb-driver-cursor.key.php">
          MongoDB\Driver\Cursor::key &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-cursor.getserver.php">
          &laquo; MongoDB\Driver\Cursor::getServer        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-cursor.isdead.php' selected="selected">English</option>
            <option value='de/mongodb-driver-cursor.isdead.php'>German</option>
            <option value='es/mongodb-driver-cursor.isdead.php'>Spanish</option>
            <option value='fr/mongodb-driver-cursor.isdead.php'>French</option>
            <option value='it/mongodb-driver-cursor.isdead.php'>Italian</option>
            <option value='ja/mongodb-driver-cursor.isdead.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-cursor.isdead.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-cursor.isdead.php'>Russian</option>
            <option value='tr/mongodb-driver-cursor.isdead.php'>Turkish</option>
            <option value='uk/mongodb-driver-cursor.isdead.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-cursor.isdead.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-cursor.isdead" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><a href="https://www.mongodb.com/docs/manual/reference/method/cursor.isExhausted/" class="link external">&raquo;&nbsp;cursor.isExhausted()</a> in the MongoDB manual</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/cursor/isdead.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-cursor.isdead%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-cursor.isdead&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-cursor.isdead.php">＋<small>add a note</small></a></span>
