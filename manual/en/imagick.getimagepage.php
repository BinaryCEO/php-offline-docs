...
<head>
  ...
  <title>PHP: Imagick::getImagePage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagepage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagepage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagepage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageorientation.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagepixelcolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagepage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagepage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagepage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagepage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagepage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagepage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagepage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagepage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagepage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagepage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagepage.php" hreflang="zh">
...
<meta name="Description" content="Returns the page geometry" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImagePage - Manual" />
<meta name="twitter:description" content="Returns the page geometry" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImagePage - Manual" />
<meta itemprop="description" content="Returns the page geometry" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the page geometry" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagepixelcolor.php">
          Imagick::getImagePixelColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageorientation.php">
          &laquo; Imagick::getImageOrientation        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagepage.php' selected="selected">English</option>
            <option value='de/imagick.getimagepage.php'>German</option>
            <option value='es/imagick.getimagepage.php'>Spanish</option>
            <option value='fr/imagick.getimagepage.php'>French</option>
            <option value='it/imagick.getimagepage.php'>Italian</option>
            <option value='ja/imagick.getimagepage.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagepage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagepage.php'>Russian</option>
            <option value='tr/imagick.getimagepage.php'>Turkish</option>
            <option value='uk/imagick.getimagepage.php'>Ukrainian</option>
            <option value='zh/imagick.getimagepage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagepage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImagePage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImagePage</span> &mdash; <span class="dc-title">Returns the page geometry</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagepage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImagePage</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagepage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagepage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagepage-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagepage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagepage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagepage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagepage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108832">  <div class="votes">
    <div id="Vu108832">
    <a href="/manual/vote-note.php?id=108832&amp;page=imagick.getimagepage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108832">
    <a href="/manual/vote-note.php?id=108832&amp;page=imagick.getimagepage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108832" title="no votes...">
    0
    </div>
  </div>
  <a href="#108832" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108832"> &para;</a><div class="date" title="2012-05-28 10:53"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108832">
<div class="phpcode"><code><span class="html">The PHP function 'getImagePage' will return values indicating the height and width of an image, just like the getHeight and getWidth, except these values are returned as an array.  There's also two other values returned in the array with the key values of 'x' and 'y'.  After running this function on animated .Gif's, super-compressed jpeg's, bmp's, png's, and every type of awkward file format you could think of, I kept getting back the result of '0' for both the 'x' and 'y' associated values in the returned array.  It's likely that these indicate the "start-positions" of the width and height, compared to the "end-values" you receive for accessing the values associated with the keys 'width' and 'height'.<br /><br />Oddly enough, the PHP function 'getPage' will return an array with the same exact keys, except the values all default to '0', making it much less useful than the function 'getImagePage'.<br /><br />And some sample code :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.gif"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get Image Page<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$image_page </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImagePage</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Print Iteration Value Interpreted<br />        // ---------------------------------------------<br /><br />    </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$image_page</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />Expected Result :<br /><br />Array<br />(<br />    [width] =&gt; 600<br />    [height] =&gt; 450<br />    [x] =&gt; 0<br />    [y] =&gt; 0<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagepage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagepage.php">＋<small>add a note</small></a></div>
