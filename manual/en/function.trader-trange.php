...
<head>
  ...
  <title>PHP: trader_trange - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-trange.php">
 <link rel="shorturl" href="https://www.php.net/trader-trange">
 <link rel="alternate" href="https://www.php.net/trader-trange" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-tema.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-trima.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-trange.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-trange.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-trange.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-trange.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-trange.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-trange.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-trange.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-trange.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-trange.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-trange.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-trange.php" hreflang="zh">
...
<meta name="Description" content="True Range" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_trange - Manual" />
<meta name="twitter:description" content="True Range" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_trange - Manual" />
<meta itemprop="description" content="True Range" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="True Range" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-trima.php">
          trader_trima &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-tema.php">
          &laquo; trader_tema        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-trange.php' selected="selected">English</option>
            <option value='de/function.trader-trange.php'>German</option>
            <option value='es/function.trader-trange.php'>Spanish</option>
            <option value='fr/function.trader-trange.php'>French</option>
            <option value='it/function.trader-trange.php'>Italian</option>
            <option value='ja/function.trader-trange.php'>Japanese</option>
            <option value='pt_BR/function.trader-trange.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-trange.php'>Russian</option>
            <option value='tr/function.trader-trange.php'>Turkish</option>
            <option value='uk/function.trader-trange.php'>Ukrainian</option>
            <option value='zh/function.trader-trange.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-trange" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_trange</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_trange</span> &mdash; <span class="dc-title">True Range</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-trange-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_trange</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-trange-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-trange-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-trange.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-trange%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-trange&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-trange.php">＋<small>add a note</small></a></span>
