...
<head>
  ...
  <title>PHP: stream_filter_register - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-filter-register.php">
 <link rel="shorturl" href="https://www.php.net/stream-filter-register">
 <link rel="alternate" href="https://www.php.net/stream-filter-register" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-filter-prepend.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-filter-remove.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-filter-register.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-filter-register.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-filter-register.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-filter-register.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-filter-register.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-filter-register.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-filter-register.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-filter-register.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-filter-register.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-filter-register.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-filter-register.php" hreflang="zh">
...
<meta name="Description" content="Register a user defined stream filter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_filter_register - Manual" />
<meta name="twitter:description" content="Register a user defined stream filter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_filter_register - Manual" />
<meta itemprop="description" content="Register a user defined stream filter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Register a user defined stream filter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-filter-remove.php">
          stream_filter_remove &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-filter-prepend.php">
          &laquo; stream_filter_prepend        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-filter-register.php' selected="selected">English</option>
            <option value='de/function.stream-filter-register.php'>German</option>
            <option value='es/function.stream-filter-register.php'>Spanish</option>
            <option value='fr/function.stream-filter-register.php'>French</option>
            <option value='it/function.stream-filter-register.php'>Italian</option>
            <option value='ja/function.stream-filter-register.php'>Japanese</option>
            <option value='pt_BR/function.stream-filter-register.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-filter-register.php'>Russian</option>
            <option value='tr/function.stream-filter-register.php'>Turkish</option>
            <option value='uk/function.stream-filter-register.php'>Ukrainian</option>
            <option value='zh/function.stream-filter-register.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-filter-register" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.stream-filter-prepend.php" class="function" rel="rdfs-seeAlso">stream_filter_prepend()</a> - Attach a filter to a stream</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-filter-register.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-filter-register%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-filter-register&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-filter-register.php">＋<small>add a note</small></a></span>
