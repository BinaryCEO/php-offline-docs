...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-query.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-ping.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-real-escape-string.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-query.php" hreflang="uk">
...
<meta name="Description" content="Send a MySQL query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_query - Manual" />
<meta name="twitter:description" content="Send a MySQL query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_query - Manual" />
<meta itemprop="description" content="Send a MySQL query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Send a MySQL query" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-query.php' selected="selected">English</option>
            ...
            <option value='ru/function.mysql-query.php'>Russian</option>
            <option value='tr/function.mysql-query.php'>Turkish</option>
            <option value='uk/function.mysql-query.php'>Ukrainian</option>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mysql-query-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-unbuffered-query.php" class="function" rel="rdfs-seeAlso">mysql_unbuffered_query()</a> - Send an SQL query to MySQL without fetching and buffering the result rows</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-query.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-query%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-query&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-query.php">＋<small>add a note</small></a></span>
