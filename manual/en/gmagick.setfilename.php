...
<head>
  ...
  <title>PHP: Gmagick::setfilename - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setfilename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setfilename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setfilename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setcompressionquality.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagebackgroundcolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setfilename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setfilename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setfilename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setfilename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setfilename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setfilename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setfilename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setfilename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setfilename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setfilename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setfilename.php" hreflang="zh">
...
<meta name="Description" content="Sets the filename before you read or write the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::setfilename - Manual" />
<meta name="twitter:description" content="Sets the filename before you read or write the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setfilename - Manual" />
<meta itemprop="description" content="Sets the filename before you read or write the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the filename before you read or write the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.setimagebackgroundcolor.php">
          Gmagick::setimagebackgroundcolor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setcompressionquality.php">
          &laquo; Gmagick::setCompressionQuality        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setfilename.php' selected="selected">English</option>
            <option value='de/gmagick.setfilename.php'>German</option>
            <option value='es/gmagick.setfilename.php'>Spanish</option>
            <option value='fr/gmagick.setfilename.php'>French</option>
            <option value='it/gmagick.setfilename.php'>Italian</option>
            <option value='ja/gmagick.setfilename.php'>Japanese</option>
            <option value='pt_BR/gmagick.setfilename.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setfilename.php'>Russian</option>
            <option value='tr/gmagick.setfilename.php'>Turkish</option>
            <option value='uk/gmagick.setfilename.php'>Ukrainian</option>
            <option value='zh/gmagick.setfilename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setfilename" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setfilename</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setfilename</span> &mdash; <span class="dc-title">Sets the filename before you read or write the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setfilename-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setfilename</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setfilename-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setfilename-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setfilename-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setfilename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setfilename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setfilename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setfilename.php">＋<small>add a note</small></a></span>
