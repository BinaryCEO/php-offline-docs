...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-ls.php">
 <link rel="shorturl" href="https://www.php.net/svn-ls">
 <link rel="alternate" href="https://www.php.net/svn-ls" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-log.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-mkdir.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-ls.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-ls.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-ls.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-ls.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-ls.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-ls.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-ls.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-ls.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-ls.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-ls.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-ls.php" hreflang="zh">
...
<meta name="Description" content="Returns list of directory contents in repository URL, optionally at revision number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_ls - Manual" />
<meta name="twitter:description" content="Returns list of directory contents in repository URL, optionally at revision number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_ls - Manual" />
<meta itemprop="description" content="Returns list of directory contents in repository URL, optionally at revision number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns list of directory contents in repository URL, optionally at revision number" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.svn-mkdir.php">
          svn_mkdir &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.svn-log.php">
          &laquo; svn_log        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-ls.php' selected="selected">English</option>
            <option value='de/function.svn-ls.php'>German</option>
            <option value='es/function.svn-ls.php'>Spanish</option>
            <option value='fr/function.svn-ls.php'>French</option>
            <option value='it/function.svn-ls.php'>Italian</option>
            <option value='ja/function.svn-ls.php'>Japanese</option>
            <option value='pt_BR/function.svn-ls.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-ls.php'>Russian</option>
            <option value='tr/function.svn-ls.php'>Turkish</option>
            <option value='uk/function.svn-ls.php'>Ukrainian</option>
            <option value='zh/function.svn-ls.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-ls" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.svn-ls-examples">
  ...
  <p class="para">
   <div class="example" id="example-4877">
    <p><strong>Example #1 <span class="function"><strong>svn_ls()</strong></span> example</strong></p>
    ...
    <li>
     <a href="http://svnbook.red-bean.com/en/1.2/svn.ref.svn.c.list.html" class="link external">&raquo;&nbsp;SVN documentation on svn list</a>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-ls.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-ls%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-ls&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-ls.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108629">  <div class="votes">
    <div id="Vu108629">
    <a href="/manual/vote-note.php?id=108629&amp;page=function.svn-ls&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108629">
    <a href="/manual/vote-note.php?id=108629&amp;page=function.svn-ls&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108629" title="50% like this...">
    0
    </div>
  </div>
  <a href="#108629" class="name">
  <strong class="user"><em>php thereatthe bluedream dotty tv</em></strong></a><a class="genanchor" href="#108629"> &para;</a><div class="date" title="2012-05-11 11:31"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108629">
<div class="phpcode"><code><span class="html">Be aware that the function will condition the path for you; do not do it yourself or you will have resulting errors.<br /><br />Ex: that paths with spaces in them do NOT need the escaping slash<br /><span class="default">&lt;?php<br />svn_ls</span><span class="keyword">(</span><span class="string">'file:///var/svn/myrepo/dirA/another dir'</span><span class="keyword">); </span><span class="comment">//will work-&gt;happiness<br /></span><span class="default">svn_ls</span><span class="keyword">(</span><span class="string">'file:///var/svn/myrepo/dirA/another\ dir'</span><span class="keyword">); </span><span class="comment">//will fail<br /></span><span class="default">?&gt;<br /></span>Warning: svn_ls(): svn error(s) occured 160013 (Filesystem has no item) URL 'file:///var/svn/myrepo/dirA/another\ dir' non-existent in that revision in file.php on line 42</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.svn-ls&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-ls.php">＋<small>add a note</small></a></div>
