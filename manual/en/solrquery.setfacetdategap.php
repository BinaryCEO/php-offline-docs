...
<head>
  ...
  <title>PHP: SolrQuery::setFacetDateGap - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setfacetdategap.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setfacetdategap.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetdategap.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setfacetdateend.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setfacetdatehardend.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetdategap.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setfacetdategap.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setfacetdategap.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setfacetdategap.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setfacetdategap.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setfacetdategap.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setfacetdategap.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setfacetdategap.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setfacetdategap.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setfacetdategap.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setfacetdategap.php" hreflang="zh">
...
<meta name="Description" content="Maps to facet.date.gap" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setFacetDateGap - Manual" />
<meta name="twitter:description" content="Maps to facet.date.gap" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setFacetDateGap - Manual" />
<meta itemprop="description" content="Maps to facet.date.gap" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Maps to facet.date.gap" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setfacetdatehardend.php">
          SolrQuery::setFacetDateHardEnd &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setfacetdateend.php">
          &laquo; SolrQuery::setFacetDateEnd        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setfacetdategap.php' selected="selected">English</option>
            <option value='de/solrquery.setfacetdategap.php'>German</option>
            <option value='es/solrquery.setfacetdategap.php'>Spanish</option>
            <option value='fr/solrquery.setfacetdategap.php'>French</option>
            <option value='it/solrquery.setfacetdategap.php'>Italian</option>
            <option value='ja/solrquery.setfacetdategap.php'>Japanese</option>
            <option value='pt_BR/solrquery.setfacetdategap.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setfacetdategap.php'>Russian</option>
            <option value='tr/solrquery.setfacetdategap.php'>Turkish</option>
            <option value='uk/solrquery.setfacetdategap.php'>Ukrainian</option>
            <option value='zh/solrquery.setfacetdategap.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setfacetdategap" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setFacetDateGap</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setFacetDateGap</span> &mdash; <span class="dc-title">Maps to facet.date.gap</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setfacetdategap-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setFacetDateGap</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setfacetdategap-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setfacetdategap-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setfacetdategap.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setfacetdategap%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setfacetdategap&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setfacetdategap.php">＋<small>add a note</small></a></span>
