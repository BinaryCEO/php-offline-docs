...
<head>
  ...
  <title>PHP: SolrQuery::setTermsMinCount - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.settermsmincount.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.settermsmincount.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsmincount.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.settermsmaxcount.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.settermsprefix.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsmincount.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.settermsmincount.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.settermsmincount.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.settermsmincount.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.settermsmincount.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.settermsmincount.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.settermsmincount.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.settermsmincount.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.settermsmincount.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.settermsmincount.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.settermsmincount.php" hreflang="zh">
...
<meta name="Description" content="Sets the minimum document frequency" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setTermsMinCount - Manual" />
<meta name="twitter:description" content="Sets the minimum document frequency" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setTermsMinCount - Manual" />
<meta itemprop="description" content="Sets the minimum document frequency" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the minimum document frequency" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.settermsprefix.php">
          SolrQuery::setTermsPrefix &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.settermsmaxcount.php">
          &laquo; SolrQuery::setTermsMaxCount        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.settermsmincount.php' selected="selected">English</option>
            <option value='de/solrquery.settermsmincount.php'>German</option>
            <option value='es/solrquery.settermsmincount.php'>Spanish</option>
            <option value='fr/solrquery.settermsmincount.php'>French</option>
            <option value='it/solrquery.settermsmincount.php'>Italian</option>
            <option value='ja/solrquery.settermsmincount.php'>Japanese</option>
            <option value='pt_BR/solrquery.settermsmincount.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.settermsmincount.php'>Russian</option>
            <option value='tr/solrquery.settermsmincount.php'>Turkish</option>
            <option value='uk/solrquery.settermsmincount.php'>Ukrainian</option>
            <option value='zh/solrquery.settermsmincount.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.settermsmincount" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setTermsMinCount</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setTermsMinCount</span> &mdash; <span class="dc-title">Sets the minimum document frequency</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.settermsmincount-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setTermsMinCount</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$frequency</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.settermsmincount-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.settermsmincount-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/settermsmincount.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.settermsmincount%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.settermsmincount&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.settermsmincount.php">＋<small>add a note</small></a></span>
