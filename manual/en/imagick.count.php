...
<head>
  ...
  <title>PHP: Imagick::count - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.count.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.count.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.count.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.convolveimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.cropimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.count.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.count.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.count.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.count.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.count.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.count.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.count.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.count.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.count.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.count.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.count.php" hreflang="zh">
...
<meta name="Description" content="Get the number of images" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::count - Manual" />
<meta name="twitter:description" content="Get the number of images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::count - Manual" />
<meta itemprop="description" content="Get the number of images" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the number of images" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.cropimage.php">
          Imagick::cropImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.convolveimage.php">
          &laquo; Imagick::convolveImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.count.php' selected="selected">English</option>
            <option value='de/imagick.count.php'>German</option>
            <option value='es/imagick.count.php'>Spanish</option>
            <option value='fr/imagick.count.php'>French</option>
            <option value='it/imagick.count.php'>Italian</option>
            <option value='ja/imagick.count.php'>Japanese</option>
            <option value='pt_BR/imagick.count.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.count.php'>Russian</option>
            <option value='tr/imagick.count.php'>Turkish</option>
            <option value='uk/imagick.count.php'>Ukrainian</option>
            <option value='zh/imagick.count.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.count" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::count</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::count</span> &mdash; <span class="dc-title">Get the number of images</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.count-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::count</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mode</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
  ...
  <p class="para">
   Returns the number of images.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/count.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.count%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.count.php">＋<small>add a note</small></a></span>
