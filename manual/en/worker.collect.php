...
<head>
  ...
  <title>PHP: Worker::collect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/worker.collect.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/worker.collect.php">
 <link rel="alternate" href="https://www.php.net/manual/en/worker.collect.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.worker.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.worker.php">
 <link rel="next" href="https://www.php.net/manual/en/worker.getstacked.php">

 <link rel="alternate" href="https://www.php.net/manual/en/worker.collect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/worker.collect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/worker.collect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/worker.collect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/worker.collect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/worker.collect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/worker.collect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/worker.collect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/worker.collect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/worker.collect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/worker.collect.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Worker::collect - Manual" />
<meta name="twitter:description" content="Collect references to completed tasks" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Worker::collect - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/worker.collect.php' selected="selected">English</option>
            <option value='de/worker.collect.php'>German</option>
            <option value='es/worker.collect.php'>Spanish</option>
            <option value='fr/worker.collect.php'>French</option>
            <option value='it/worker.collect.php'>Italian</option>
            <option value='ja/worker.collect.php'>Japanese</option>
            <option value='pt_BR/worker.collect.php'>Brazilian Portuguese</option>
            <option value='ru/worker.collect.php'>Russian</option>
            <option value='tr/worker.collect.php'>Turkish</option>
            <option value='uk/worker.collect.php'>Ukrainian</option>
            <option value='zh/worker.collect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="worker.collect" class="refentry">
...
There are now 0 tasks on the stack to be collected</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pthreads/worker/collect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fworker.collect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=worker.collect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/worker.collect.php">＋<small>add a note</small></a></span>
