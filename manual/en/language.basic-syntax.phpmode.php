...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.basic-syntax.phpmode.php">
 <link rel="shorturl" href="https://www.php.net/basic-syntax.phpmode">
 <link rel="alternate" href="https://www.php.net/basic-syntax.phpmode" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.basic-syntax.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.basic-syntax.phptags.php">
 <link rel="next" href="https://www.php.net/manual/en/language.basic-syntax.instruction-separation.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.basic-syntax.phpmode.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.basic-syntax.phpmode.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.basic-syntax.phpmode.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.basic-syntax.phpmode.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.basic-syntax.phpmode.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.basic-syntax.phpmode.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.basic-syntax.phpmode.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.basic-syntax.phpmode.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.basic-syntax.phpmode.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.basic-syntax.phpmode.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.basic-syntax.phpmode.php" hreflang="zh">
...
<meta name="Description" content="Escaping from HTML" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Escaping from HTML - Manual" />
<meta name="twitter:description" content="Escaping from HTML" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Escaping from HTML - Manual" />
<meta itemprop="description" content="Escaping from HTML" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Escaping from HTML" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.basic-syntax.phpmode.php' selected="selected">English</option>
            ...
            <option value='it/language.basic-syntax.phpmode.php'>Italian</option>
            ...
            <option value='uk/language.basic-syntax.phpmode.php'>Ukrainian</option>
  ...
  </div><div id="language.basic-syntax.phpmode" class="sect1">
    ...
    <blockquote class="note"><p><strong class="note">Note</strong>: 
     <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.basic-syntax.phpmode%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.basic-syntax.phpmode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.basic-syntax.phpmode.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="99083">  <div class="votes">
    <div id="Vu99083">
    <a href="/manual/vote-note.php?id=99083&amp;page=language.basic-syntax.phpmode&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd99083">
    <a href="/manual/vote-note.php?id=99083&amp;page=language.basic-syntax.phpmode&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V99083" title="58% like this...">
    381
    </div>
  </div>
  <a href="#99083" class="name">
  <strong class="user"><em>quickfur at quickfur dot ath dot cx</em></strong></a><a class="genanchor" href="#99083"> &para;</a><div class="date" title="2010-07-26 02:40"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom99083">
<div class="phpcode"><code><span class="html">When the documentation says that the PHP parser ignores everything outside the <span class="default">&lt;?php </span><span class="keyword">... </span><span class="default">?&gt;</span> tags, it means literally EVERYTHING. Including things you normally wouldn't consider "valid", such as the following:<br /><br />&lt;html&gt;&lt;body&gt;<br />&lt;p<span class="default">&lt;?php </span><span class="keyword">if (</span><span class="default">$highlight</span><span class="keyword">): </span><span class="default">?&gt;</span> class="highlight"<span class="default">&lt;?php </span><span class="keyword">endif;</span><span class="default">?&gt;</span>&gt;This is a paragraph.&lt;/p&gt;<br />&lt;/body&gt;&lt;/html&gt;<br /><br />Notice how the PHP code is embedded in the middle of an HTML opening tag. The PHP parser doesn't care that it's in the middle of an opening tag, and doesn't require that it be closed. It also doesn't care that after the closing ?&gt; tag is the end of the HTML opening tag. So, if $highlight is true, then the output will be:<br /><br />&lt;html&gt;&lt;body&gt;<br />&lt;p class="highlight"&gt;This is a paragraph.&lt;/p&gt;<br />&lt;/body&gt;&lt;/html&gt;<br /><br />Otherwise, it will be:<br /><br />&lt;html&gt;&lt;body&gt;<br />&lt;p&gt;This is a paragraph.&lt;/p&gt;<br />&lt;/body&gt;&lt;/html&gt;<br /><br />Using this method, you can have HTML tags with optional attributes, depending on some PHP condition. Extremely flexible and useful!</span></code></div>
  </div>
 </div>
  <div class="note" id="92643">  <div class="votes">
    <div id="Vu92643">
    <a href="/manual/vote-note.php?id=92643&amp;page=language.basic-syntax.phpmode&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92643">
    <a href="/manual/vote-note.php?id=92643&amp;page=language.basic-syntax.phpmode&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92643" title="52% like this...">
    66
    </div>
  </div>
  <a href="#92643" class="name">
  <strong class="user"><em>ravenswd at gmail dot com</em></strong></a><a class="genanchor" href="#92643"> &para;</a><div class="date" title="2009-08-01 05:08"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92643">
<div class="phpcode"><code><span class="html">One aspect of PHP that you need to be careful of, is that ?&gt; will drop you out of PHP code and into HTML even if it appears inside a // comment. (This does not apply to /* */ comments.) This can lead to unexpected results. For example, take this line:<br /><br /><span class="default">&lt;?php<br />  $file_contents  </span><span class="keyword">= </span><span class="string">'&lt;?php die(); ?&gt;' </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />If you try to remove it by turning it into a comment, you get this:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">//  $file_contents  = '&lt;?php die(); </span><span class="default">?&gt;</span>' . "\n";<br />?&gt;<br /><br />Which results in ' . "\n"; (and whatever is in the lines following it) to be output to your HTML page.<br /><br />The cure is to either comment it out using /* */ tags, or re-write the line as:<br /><br /><span class="default">&lt;?php<br />  $file_contents  </span><span class="keyword">= </span><span class="string">'&lt;' </span><span class="keyword">. </span><span class="string">'?php die(); ?' </span><span class="keyword">. </span><span class="string">'&gt;' </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="114589">  <div class="votes">
    <div id="Vu114589">
    <a href="/manual/vote-note.php?id=114589&amp;page=language.basic-syntax.phpmode&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114589">
    <a href="/manual/vote-note.php?id=114589&amp;page=language.basic-syntax.phpmode&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114589" title="50% like this...">
    10
    </div>
  </div>
  <a href="#114589" class="name">
  <strong class="user"><em>sgurukrupa at gmail dot com</em></strong></a><a class="genanchor" href="#114589"> &para;</a><div class="date" title="2014-03-10 07:01"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114589">
<div class="phpcode"><code><span class="html">Although not specifically pointed out in the main text, escaping from HTML also applies to other control statements:<br /><br /><span class="default">&lt;?php </span><span class="keyword">for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">5</span><span class="keyword">; ++</span><span class="default">$i</span><span class="keyword">): </span><span class="default">?&gt;<br /></span>Hello, there!<br /><span class="default">&lt;?php </span><span class="keyword">endfor; </span><span class="default">?&gt;<br /></span><br />When the above code snippet is executed we get the following output:<br /><br />Hello, there!<br />Hello, there!<br />Hello, there!<br />Hello, there!</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=language.basic-syntax.phpmode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.basic-syntax.phpmode.php">＋<small>add a note</small></a></div>
