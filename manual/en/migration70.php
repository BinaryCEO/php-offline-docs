...
<head>
  ...
  <title>PHP: Migrating from PHP 5.6.x to PHP 7.0.x - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration70.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration70.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration70.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/appendices.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration71.windows-support.php">
 <link rel="next" href="https://www.php.net/manual/en/migration70.incompatible.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration70.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration70.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration70.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration70.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration70.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration70.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration70.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration70.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration70.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration70.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration70.php" hreflang="zh">
...
<meta name="Description" content="Migrating from PHP 5.6.x to PHP 7.0.x" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Migrating from PHP 5.6.x to PHP 7.0.x - Manual" />
<meta name="twitter:description" content="Migrating from PHP 5.6.x to PHP 7.0.x" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Migrating from PHP 5.6.x to PHP 7.0.x - Manual" />
<meta itemprop="description" content="Migrating from PHP 5.6.x to PHP 7.0.x" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Migrating from PHP 5.6.x to PHP 7.0.x" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration70.php' selected="selected">English</option>
            <option value='de/migration70.php'>German</option>
            <option value='es/migration70.php'>Spanish</option>
            <option value='fr/migration70.php'>French</option>
            <option value='it/migration70.php'>Italian</option>
            <option value='ja/migration70.php'>Japanese</option>
            <option value='pt_BR/migration70.php'>Brazilian Portuguese</option>
            <option value='ru/migration70.php'>Russian</option>
            <option value='tr/migration70.php'>Turkish</option>
            <option value='uk/migration70.php'>Ukrainian</option>
            <option value='zh/migration70.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration70" class="appendix">
 <h1 class="title">Migrating from PHP 5.6.x to PHP 7.0.x</h1>
<h2>Table of Contents</h2><ul class="chunklist chunklist_appendix"><li><a href="migration70.incompatible.php">Backward incompatible changes</a></li><li><a href="migration70.new-features.php">New features</a></li><li><a href="migration70.deprecated.php">Deprecated features in PHP 7.0.x</a></li><li><a href="migration70.changed-functions.php">Changed functions</a></li><li><a href="migration70.new-functions.php">New functions</a></li><li><a href="migration70.classes.php">New Classes and Interfaces</a></li><li><a href="migration70.constants.php">New Global Constants</a></li><li><a href="migration70.sapi-changes.php">Changes in SAPI Modules</a></li><li><a href="migration70.removed-exts-sapis.php">Removed Extensions and SAPIs</a></li><li><a href="migration70.other-changes.php">Other Changes</a></li></ul>
  ...
  production environments.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration70.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration70%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration70&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration70.php">＋<small>add a note</small></a></span>
