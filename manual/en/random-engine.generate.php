...
<head>
  ...
  <title>PHP: Random\Engine::generate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/random-engine.generate.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/random-engine.generate.php">
 <link rel="alternate" href="https://www.php.net/manual/en/random-engine.generate.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.random-engine.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.random-engine.php">
 <link rel="next" href="https://www.php.net/manual/en/class.random-cryptosafeengine.php">

 <link rel="alternate" href="https://www.php.net/manual/en/random-engine.generate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/random-engine.generate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/random-engine.generate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/random-engine.generate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/random-engine.generate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/random-engine.generate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/random-engine.generate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/random-engine.generate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/random-engine.generate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/random-engine.generate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/random-engine.generate.php" hreflang="zh">
...
<meta name="Description" content="Generates randomness" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Random\Engine::generate - Manual" />
<meta name="twitter:description" content="Generates randomness" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Random\Engine::generate - Manual" />
<meta itemprop="description" content="Generates randomness" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generates randomness" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.random-cryptosafeengine.php">
          Random\CryptoSafeEngine &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.random-engine.php">
          &laquo; Random\Engine        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.basic.other.php'>Other Basic Extensions</a></li>      <li><a href='book.random.php'>Random</a></li>      <li><a href='class.random-engine.php'>Random\Engine</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/random-engine.generate.php' selected="selected">English</option>
            <option value='de/random-engine.generate.php'>German</option>
            <option value='es/random-engine.generate.php'>Spanish</option>
            <option value='fr/random-engine.generate.php'>French</option>
            <option value='it/random-engine.generate.php'>Italian</option>
            <option value='ja/random-engine.generate.php'>Japanese</option>
            <option value='pt_BR/random-engine.generate.php'>Brazilian Portuguese</option>
            <option value='ru/random-engine.generate.php'>Russian</option>
            <option value='tr/random-engine.generate.php'>Turkish</option>
            <option value='uk/random-engine.generate.php'>Ukrainian</option>
            <option value='zh/random-engine.generate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="random-engine.generate" class="refentry">
...
<div class="annotation-interactive examplescode"><pre class="examplescode">Lucky Number: 4</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/random/random/engine/generate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Frandom-engine.generate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=random-engine.generate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/random-engine.generate.php">＋<small>add a note</small></a></span>
 ...
 <div class="note">There are no user contributed notes for this page.</div></section>    </section><!-- layout-content -->
        ...
        <ul class='parent-menu-list'>
                                    <li>
                <a href="class.random-engine.php">Random\Engine</a>

                                    <ul class='child-menu-list'>

                                                <li class="current">
                            <a href="random-engine.generate.php" title="generate">generate</a>
                        </li>
