...
<head>
  ...
  <title>PHP: mailparse_uudecode_all - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mailparse-uudecode-all.php">
 <link rel="shorturl" href="https://www.php.net/mailparse-uudecode-all">
 <link rel="alternate" href="https://www.php.net/mailparse-uudecode-all" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mailparse.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mailparse-stream-encode.php">
 <link rel="next" href="https://www.php.net/manual/en/refs.math.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mailparse-uudecode-all.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mailparse-uudecode-all.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mailparse-uudecode-all.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mailparse-uudecode-all.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mailparse-uudecode-all.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mailparse-uudecode-all.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mailparse-uudecode-all.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mailparse-uudecode-all.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mailparse-uudecode-all.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mailparse-uudecode-all.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mailparse-uudecode-all.php" hreflang="zh">
...
<meta name="Description" content="Scans the data from fp and extract each embedded uuencoded file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mailparse_uudecode_all - Manual" />
<meta name="twitter:description" content="Scans the data from fp and extract each embedded uuencoded file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mailparse_uudecode_all - Manual" />
<meta itemprop="description" content="Scans the data from fp and extract each embedded uuencoded file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Scans the data from fp and extract each embedded uuencoded file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="refs.math.php">
          Mathematical Extensions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mailparse-stream-encode.php">
          &laquo; mailparse_stream_encode        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mailparse-uudecode-all.php' selected="selected">English</option>
            <option value='de/function.mailparse-uudecode-all.php'>German</option>
            <option value='es/function.mailparse-uudecode-all.php'>Spanish</option>
            <option value='fr/function.mailparse-uudecode-all.php'>French</option>
            <option value='it/function.mailparse-uudecode-all.php'>Italian</option>
            <option value='ja/function.mailparse-uudecode-all.php'>Japanese</option>
            <option value='pt_BR/function.mailparse-uudecode-all.php'>Brazilian Portuguese</option>
            <option value='ru/function.mailparse-uudecode-all.php'>Russian</option>
            <option value='tr/function.mailparse-uudecode-all.php'>Turkish</option>
            <option value='uk/function.mailparse-uudecode-all.php'>Ukrainian</option>
            <option value='zh/function.mailparse-uudecode-all.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mailparse-uudecode-all" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.mailparse-uudecode-all-examples">
  ...
  <p class="para">
   <div class="example" id="example-3263">
...
this is a test</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mailparse/functions/mailparse-uudecode-all.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mailparse-uudecode-all%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mailparse-uudecode-all&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mailparse-uudecode-all.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="31529">  <div class="votes">
    <div id="Vu31529">
    <a href="/manual/vote-note.php?id=31529&amp;page=function.mailparse-uudecode-all&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd31529">
    <a href="/manual/vote-note.php?id=31529&amp;page=function.mailparse-uudecode-all&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V31529" title="50% like this...">
    0
    </div>
  </div>
  <a href="#31529" class="name">
  <strong class="user"><em>mat at phpconsulting dot com</em></strong></a><a class="genanchor" href="#31529"> &para;</a><div class="date" title="2003-04-24 10:04"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom31529">
<div class="phpcode"><code><span class="html">As an alternative,  uudecode() can be called as static function as follows:<br /><br />$file =&amp; Mail_mimeDecode::uudecode($some_text);<br /><br />This will return the following arrays:<br /> @param  string Input body to look for attachments in<br /> @return array  Decoded bodies, filenames and permissions</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mailparse-uudecode-all&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mailparse-uudecode-all.php">＋<small>add a note</small></a></div>
