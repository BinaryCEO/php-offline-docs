...
<head>
  ...
  <title>PHP: Gmagick::deconstructimages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.deconstructimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.deconstructimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.deconstructimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.cyclecolormapimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.despeckleimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.deconstructimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.deconstructimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.deconstructimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.deconstructimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.deconstructimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.deconstructimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.deconstructimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.deconstructimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.deconstructimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.deconstructimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.deconstructimages.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::deconstructimages - Manual" />
<meta name="twitter:description" content="Returns certain pixel differences between images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::deconstructimages - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.despeckleimage.php">
          Gmagick::despeckleimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.cyclecolormapimage.php">
          &laquo; Gmagick::cyclecolormapimage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.deconstructimages.php' selected="selected">English</option>
            <option value='de/gmagick.deconstructimages.php'>German</option>
            <option value='es/gmagick.deconstructimages.php'>Spanish</option>
            <option value='fr/gmagick.deconstructimages.php'>French</option>
            <option value='it/gmagick.deconstructimages.php'>Italian</option>
            <option value='ja/gmagick.deconstructimages.php'>Japanese</option>
            <option value='pt_BR/gmagick.deconstructimages.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.deconstructimages.php'>Russian</option>
            <option value='tr/gmagick.deconstructimages.php'>Turkish</option>
            <option value='uk/gmagick.deconstructimages.php'>Ukrainian</option>
            <option value='zh/gmagick.deconstructimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.deconstructimages" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::deconstructimages</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::deconstructimages</span> &mdash; <span class="dc-title">Returns certain pixel differences between images</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.deconstructimages-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::deconstructimages</strong></span>(): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
...
Compares each image with the next in a sequence and returns the maximum bounding region of any pixel differences it discovers. 
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.deconstructimages-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.deconstructimages-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a new <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.deconstructimages-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/deconstructimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.deconstructimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.deconstructimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.deconstructimages.php">＋<small>add a note</small></a></span>
