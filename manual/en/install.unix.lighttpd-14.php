...
<head>
  ...
  <title>PHP: Lighttpd 1.4 on Unix systems - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/install.unix.lighttpd-14.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/install.unix.lighttpd-14.php">
 <link rel="alternate" href="https://www.php.net/manual/en/install.unix.lighttpd-14.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/install.unix.php">
 <link rel="prev" href="https://www.php.net/manual/en/install.unix.nginx.php">
 <link rel="next" href="https://www.php.net/manual/en/install.unix.litespeed.php">

 <link rel="alternate" href="https://www.php.net/manual/en/install.unix.lighttpd-14.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/install.unix.lighttpd-14.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/install.unix.lighttpd-14.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/install.unix.lighttpd-14.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/install.unix.lighttpd-14.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/install.unix.lighttpd-14.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/install.unix.lighttpd-14.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/install.unix.lighttpd-14.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/install.unix.lighttpd-14.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/install.unix.lighttpd-14.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/install.unix.lighttpd-14.php" hreflang="zh">
...
<meta name="Description" content="Lighttpd 1.4 on Unix systems" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Lighttpd 1.4 on Unix systems - Manual" />
<meta name="twitter:description" content="Lighttpd 1.4 on Unix systems" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Lighttpd 1.4 on Unix systems - Manual" />
<meta itemprop="description" content="Lighttpd 1.4 on Unix systems" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Lighttpd 1.4 on Unix systems" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="install.unix.litespeed.php">
          LiteSpeed Web Server/OpenLiteSpeed Web Server on Unix systems &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="install.unix.nginx.php">
          &laquo; Nginx 1.4.x on Unix systems        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/install.unix.lighttpd-14.php' selected="selected">English</option>
            <option value='de/install.unix.lighttpd-14.php'>German</option>
            <option value='es/install.unix.lighttpd-14.php'>Spanish</option>
            <option value='fr/install.unix.lighttpd-14.php'>French</option>
            <option value='it/install.unix.lighttpd-14.php'>Italian</option>
            <option value='ja/install.unix.lighttpd-14.php'>Japanese</option>
            <option value='pt_BR/install.unix.lighttpd-14.php'>Brazilian Portuguese</option>
            <option value='ru/install.unix.lighttpd-14.php'>Russian</option>
            <option value='tr/install.unix.lighttpd-14.php'>Turkish</option>
            <option value='uk/install.unix.lighttpd-14.php'>Ukrainian</option>
            <option value='zh/install.unix.lighttpd-14.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="install.unix.lighttpd-14" class="sect1">
   ...
   (( &quot;host&quot; =&gt; &quot;10.0.0.2&quot;, &quot;port&quot; =&gt; 1030 ),
    ( &quot;host&quot; =&gt; &quot;10.0.0.3&quot;, &quot;port&quot; =&gt; 1030 ))
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/install/unix/lighttpd-14.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Finstall.unix.lighttpd-14%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=install.unix.lighttpd-14&amp;repo=en&amp;redirect=https://www.php.net/manual/en/install.unix.lighttpd-14.php">＋<small>add a note</small></a></span>
