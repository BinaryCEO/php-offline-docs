...
<head>
  ...
  <title>PHP: Windows Support - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration71.windows-support.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration71.windows-support.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration71.windows-support.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration71.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration71.other-changes.php">
 <link rel="next" href="https://www.php.net/manual/en/migration70.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration71.windows-support.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration71.windows-support.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration71.windows-support.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration71.windows-support.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration71.windows-support.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration71.windows-support.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration71.windows-support.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration71.windows-support.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration71.windows-support.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration71.windows-support.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration71.windows-support.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Windows Support - Manual" />
<meta name="twitter:description" content="Windows Support" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Windows Support - Manual" />
<meta itemprop="description" content="Windows Support" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="migration70.php">
          Migrating from PHP 5.6.x to PHP 7.0.x &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="migration71.other-changes.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration71.windows-support.php' selected="selected">English</option>
            <option value='de/migration71.windows-support.php'>German</option>
            <option value='es/migration71.windows-support.php'>Spanish</option>
            <option value='fr/migration71.windows-support.php'>French</option>
            <option value='it/migration71.windows-support.php'>Italian</option>
            <option value='ja/migration71.windows-support.php'>Japanese</option>
            <option value='pt_BR/migration71.windows-support.php'>Brazilian Portuguese</option>
            <option value='ru/migration71.windows-support.php'>Russian</option>
            <option value='tr/migration71.windows-support.php'>Turkish</option>
            <option value='uk/migration71.windows-support.php'>Ukrainian</option>
            <option value='zh/migration71.windows-support.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration71.windows-support" class="sect1">
 ...
 <div class="sect2" id="migration71.windows-support.long-and-utf8-path">
  ...
  <p class="para">
    ...
    using <span class="function"><a href="function.ini-set.php" class="function">ini_set()</a></span> is likely to cause display issues. The difference to the
    ...
    to avoid usage of <span class="function"><a href="function.ini-set.php" class="function">ini_set()</a></span> for the codepage change.
  </p>
  <p class="para">
 ...
 <div class="sect2" id="migration71.windows-support.readline">
  ...
  <p class="para">
   The <a href="book.readline.php" class="link">readline extension</a> is supported
 ...
 <div class="sect2" id="migration71.windows-support.ftok">
  ...
  <p class="para">
   Added support for <span class="function"><a href="function.ftok.php" class="function">ftok()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration71/windows-support.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration71.windows-support%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration71.windows-support&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration71.windows-support.php">＋<small>add a note</small></a></span>
