...
<head>
  ...
  <title>PHP: cubrid_execute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-execute.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-execute">
 <link rel="alternate" href="https://www.php.net/cubrid-execute" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-error-msg.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-fetch.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-execute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-execute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-execute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-execute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-execute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-execute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-execute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-execute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-execute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-execute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-execute.php" hreflang="zh">
...
<meta name="Description" content="Execute a prepared SQL statement" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_execute - Manual" />
<meta name="twitter:description" content="Execute a prepared SQL statement" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_execute - Manual" />
<meta itemprop="description" content="Execute a prepared SQL statement" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Execute a prepared SQL statement" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-execute.php' selected="selected">English</option>
            <option value='de/function.cubrid-execute.php'>German</option>
            <option value='es/function.cubrid-execute.php'>Spanish</option>
            <option value='fr/function.cubrid-execute.php'>French</option>
            <option value='it/function.cubrid-execute.php'>Italian</option>
            <option value='ja/function.cubrid-execute.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-execute.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-execute.php'>Russian</option>
            <option value='tr/function.cubrid-execute.php'>Turkish</option>
            <option value='uk/function.cubrid-execute.php'>Ukrainian</option>
            <option value='zh/function.cubrid-execute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-execute" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-execute-returnvalues">
  ...
  <p class="para">
    ...
    request_identifier, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-rollback.php" class="function" rel="rdfs-seeAlso">cubrid_rollback()</a> - Roll back a transaction</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-execute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-execute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-execute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-execute.php">＋<small>add a note</small></a></span>
