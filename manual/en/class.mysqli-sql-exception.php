...
<head>
  ...
  <title>PHP: mysqli_sql_exception - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mysqli-sql-exception.php">
 <link rel="shorturl" href="https://www.php.net/mysqli-sql-exception">
 <link rel="alternate" href="https://www.php.net/mysqli-sql-exception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-warning.next.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-sql-exception.getsqlstate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mysqli-sql-exception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mysqli-sql-exception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mysqli-sql-exception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mysqli-sql-exception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mysqli-sql-exception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mysqli-sql-exception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mysqli-sql-exception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mysqli-sql-exception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mysqli-sql-exception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mysqli-sql-exception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mysqli-sql-exception.php" hreflang="zh">
...
<meta name="Description" content="The mysqli_sql_exception class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_sql_exception - Manual" />
<meta name="twitter:description" content="The mysqli_sql_exception class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_sql_exception - Manual" />
<meta itemprop="description" content="The mysqli_sql_exception class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The mysqli_sql_exception class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli-sql-exception.getsqlstate.php">
          mysqli_sql_exception::getSqlState &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli-warning.next.php">
          &laquo; mysqli_warning::next        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mysqli-sql-exception.php' selected="selected">English</option>
            <option value='de/class.mysqli-sql-exception.php'>German</option>
            <option value='es/class.mysqli-sql-exception.php'>Spanish</option>
            <option value='fr/class.mysqli-sql-exception.php'>French</option>
            <option value='it/class.mysqli-sql-exception.php'>Italian</option>
            <option value='ja/class.mysqli-sql-exception.php'>Japanese</option>
            <option value='pt_BR/class.mysqli-sql-exception.php'>Brazilian Portuguese</option>
            <option value='ru/class.mysqli-sql-exception.php'>Russian</option>
            <option value='tr/class.mysqli-sql-exception.php'>Turkish</option>
            <option value='uk/class.mysqli-sql-exception.php'>Ukrainian</option>
            <option value='zh/class.mysqli-sql-exception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mysqli-sql-exception" class="reference">

 <h1 class="title">The mysqli_sql_exception class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>

  <div class="section" id="mysqli-sql-exception.intro">
  ...
  <div class="section" id="mysqli-sql-exception.synopsis">
   <h2 class="title">Class synopsis</h2>
   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">final</span>
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">mysqli_sql_exception</strong></strong>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.mysqli-sql-exception.php#mysqli-sql-exception.props.sqlstate">$<var class="varname">sqlstate</var></a></var><span class="initializer"> = &quot;00000&quot;</span>;</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="mysqli-sql-exception.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="mysqli-sql-exception.props.sqlstate"><var class="varname">sqlstate</var></dt>
     <dd>
      <p class="para">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mysqli-sql-exception.getsqlstate.php">mysqli_sql_exception::getSqlState</a> — Returns the SQLSTATE error code</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_sql_exception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mysqli-sql-exception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mysqli-sql-exception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mysqli-sql-exception.php">＋<small>add a note</small></a></span>
