...
<head>
 ...
 <link rel="prev" href="https://www.php.net/manual/en/splfileobject.haschildren.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileobject.next.php">
...
<div id="layout" class="clearfix">
 ...
 <div class="refsect1 examples" id="refsect1-splfileobject.key-examples">
  ...
  <p class="para">
   <div class="example" id="example-4013">
...
2. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</pre>
  ...
  <p class="para">
   <div class="example" id="example-4014">
...
9. r adipiscing elit.</pre>
 ...
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileobject.key&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileobject.key.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Another gotcha that is not mentioned: If you have flag SKIP_EMPTY set, then key() will not reflect actual line numbers as empty lines are not accounted.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=splfileobject.key&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileobject.key.php">＋<small>add a note</small></a></div>
