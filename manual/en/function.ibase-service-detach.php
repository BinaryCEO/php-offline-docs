...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-service-detach.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-service-attach.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-set-event-handler.php">
...
<meta name="Description" content="Disconnect from the service manager" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_service_detach - Manual" />
<meta name="twitter:description" content="Disconnect from the service manager" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_service_detach - Manual" />
<meta itemprop="description" content="Disconnect from the service manager" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Disconnect from the service manager" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-service-detach.php' selected="selected">English</option>
            ...
            <option value='ja/function.ibase-service-detach.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_service_detach</span> &mdash; <span class="dc-title">Disconnect from the service manager</span></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />    </span><span style="color: #FF8000">// Attach to the remote Firebird server by ip address<br />    </span><span style="color: #007700">if ((</span><span style="color: #0000BB">$service </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_service_attach</span><span style="color: #007700">(</span><span style="color: #DD0000">'10.1.1.199'</span><span style="color: #007700">, </span><span style="color: #DD0000">'sysdba'</span><span style="color: #007700">, </span><span style="color: #DD0000">'masterkey'</span><span style="color: #007700">)) != </span><span style="color: #0000BB">FALSE</span><span style="color: #007700">) {<br />        <br />        </span><span style="color: #FF8000">// Successfully attached. <br />        // Fetch server version (something like 'LI-V3.0.4.33054 Firebird 3.0')<br />        </span><span style="color: #0000BB">$server_version  </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_server_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_SVC_SERVER_VERSION</span><span style="color: #007700">);<br /><br />        </span><span style="color: #FF8000">// Fetch server implementation (something like 'Firebird/Linux/AMD/Intel/x64')<br />        </span><span style="color: #0000BB">$server_implementation </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_server_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_SVC_IMPLEMENTATION</span><span style="color: #007700">);<br /><br />        </span><span style="color: #FF8000">// Detach from server (disconnect)<br />        </span><span style="color: #007700">if(</span><span style="color: #0000BB">ibase_service_detach</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">) == </span><span style="color: #0000BB">FALSE</span><span style="color: #007700">) {<br />            echo </span><span style="color: #DD0000">"Error on service detach."</span><span style="color: #007700">;<br />        }<br />        else {<br />            echo </span><span style="color: #DD0000">"Successfully detached from service."</span><span style="color: #007700">;<br />        }<br /><br />    }<br />    else {<br />        </span><span style="color: #FF8000">// Output message on error<br />        </span><span style="color: #0000BB">$conn_error </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_errmsg</span><span style="color: #007700">();<br />        die(</span><span style="color: #0000BB">$conn_error</span><span style="color: #007700">);<br />    }<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-service-detach.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-service-detach%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-service-detach&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-service-detach.php">＋<small>add a note</small></a></span>
