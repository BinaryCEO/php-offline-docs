...
<head>
  ...
  <title>PHP: Gmagick::getimageindex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimageindex.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimageindex.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageindex.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagehistogram.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimageinterlacescheme.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageindex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimageindex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimageindex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimageindex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimageindex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimageindex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimageindex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimageindex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimageindex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimageindex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimageindex.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimageindex - Manual" />
<meta name="twitter:description" content="Gets the index of the current active image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimageindex - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.getimageinterlacescheme.php">
          Gmagick::getimageinterlacescheme &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagehistogram.php">
          &laquo; Gmagick::getimagehistogram        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimageindex.php' selected="selected">English</option>
            <option value='de/gmagick.getimageindex.php'>German</option>
            <option value='es/gmagick.getimageindex.php'>Spanish</option>
            <option value='fr/gmagick.getimageindex.php'>French</option>
            <option value='it/gmagick.getimageindex.php'>Italian</option>
            <option value='ja/gmagick.getimageindex.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimageindex.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimageindex.php'>Russian</option>
            <option value='tr/gmagick.getimageindex.php'>Turkish</option>
            <option value='uk/gmagick.getimageindex.php'>Ukrainian</option>
            <option value='zh/gmagick.getimageindex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimageindex" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimageindex</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimageindex</span> &mdash; <span class="dc-title">Gets the index of the current active image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimageindex-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimageindex</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Returns the index of the current active image within the <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object. 
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-gmagick.getimageindex-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimageindex-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimageindex-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimageindex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimageindex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimageindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimageindex.php">＋<small>add a note</small></a></span>
