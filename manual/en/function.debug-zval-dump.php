...
<head>
  ...
  <title>PHP: debug_zval_dump - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.debug-zval-dump.php">
 <link rel="shorturl" href="https://www.php.net/debug-zval-dump">
 <link rel="alternate" href="https://www.php.net/debug-zval-dump" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.var.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.boolval.php">
 <link rel="next" href="https://www.php.net/manual/en/function.doubleval.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.debug-zval-dump.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.debug-zval-dump.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.debug-zval-dump.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.debug-zval-dump.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.debug-zval-dump.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.debug-zval-dump.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.debug-zval-dump.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.debug-zval-dump.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.debug-zval-dump.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.debug-zval-dump.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.debug-zval-dump.php" hreflang="zh">
...
<meta name="Description" content="Dumps a string representation of an internal zval structure to output" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: debug_zval_dump - Manual" />
<meta name="twitter:description" content="Dumps a string representation of an internal zval structure to output" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: debug_zval_dump - Manual" />
<meta itemprop="description" content="Dumps a string representation of an internal zval structure to output" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Dumps a string representation of an internal zval structure to output" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.debug-zval-dump.php' selected="selected">English</option>
            <option value='de/function.debug-zval-dump.php'>German</option>
            <option value='es/function.debug-zval-dump.php'>Spanish</option>
            <option value='fr/function.debug-zval-dump.php'>French</option>
            <option value='it/function.debug-zval-dump.php'>Italian</option>
            <option value='ja/function.debug-zval-dump.php'>Japanese</option>
            <option value='pt_BR/function.debug-zval-dump.php'>Brazilian Portuguese</option>
            <option value='ru/function.debug-zval-dump.php'>Russian</option>
            <option value='tr/function.debug-zval-dump.php'>Turkish</option>
            <option value='uk/function.debug-zval-dump.php'>Ukrainian</option>
            <option value='zh/function.debug-zval-dump.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.debug-zval-dump" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="http://derickrethans.nl/php_references_article.php" class="link external">&raquo;&nbsp;References Explained (by Derick Rethans)</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/var/functions/debug-zval-dump.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.debug-zval-dump%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.debug-zval-dump&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.debug-zval-dump.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124028">  <div class="votes">
    <div id="Vu124028">
    <a href="/manual/vote-note.php?id=124028&amp;page=function.debug-zval-dump&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124028">
    <a href="/manual/vote-note.php?id=124028&amp;page=function.debug-zval-dump&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124028" title="75% like this...">
    4
    </div>
  </div>
  <a href="#124028" class="name">
  <strong class="user"><em>Hayley Watson</em></strong></a><a class="genanchor" href="#124028"> &para;</a><div class="date" title="2019-07-09 11:01"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom124028">
<div class="phpcode"><code><span class="html">If you're finding the interpretation of refcount confusing, the Xdebug extension offers a function similar to this one, but because the variable name is passed as a string, xdebug_debug_zval() doesn't scribble on the refcount with its own references to the zval.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.debug-zval-dump&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.debug-zval-dump.php">＋<small>add a note</small></a></div>
