...
<head>
  ...
  <title>PHP: deflate_init - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.deflate-init.php">
 <link rel="shorturl" href="https://www.php.net/deflate-init">
 <link rel="alternate" href="https://www.php.net/deflate-init" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.zlib.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.deflate-add.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gzclose.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.deflate-init.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.deflate-init.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.deflate-init.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.deflate-init.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.deflate-init.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.deflate-init.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.deflate-init.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.deflate-init.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.deflate-init.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.deflate-init.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.deflate-init.php" hreflang="zh">
...
<meta name="Description" content="Initialize an incremental deflate context" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: deflate_init - Manual" />
<meta name="twitter:description" content="Initialize an incremental deflate context" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: deflate_init - Manual" />
<meta itemprop="description" content="Initialize an incremental deflate context" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Initialize an incremental deflate context" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.deflate-init.php' selected="selected">English</option>
            <option value='de/function.deflate-init.php'>German</option>
            <option value='es/function.deflate-init.php'>Spanish</option>
            <option value='fr/function.deflate-init.php'>French</option>
            <option value='it/function.deflate-init.php'>Italian</option>
            <option value='ja/function.deflate-init.php'>Japanese</option>
            <option value='pt_BR/function.deflate-init.php'>Brazilian Portuguese</option>
            <option value='ru/function.deflate-init.php'>Russian</option>
            <option value='tr/function.deflate-init.php'>Turkish</option>
            <option value='uk/function.deflate-init.php'>Ukrainian</option>
            <option value='zh/function.deflate-init.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.deflate-init" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.deflate-init-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>deflate_init</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$encoding</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$options</code><span class="initializer"> = []</span></span>): <span class="type"><span class="type"><a href="class.deflatecontext.php" class="type DeflateContext">DeflateContext</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.inflate-init.php" class="function" rel="rdfs-seeAlso">inflate_init()</a> - Initialize an incremental inflate context</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zlib/functions/deflate_init.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.deflate-init%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.deflate-init&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.deflate-init.php">＋<small>add a note</small></a></span>
