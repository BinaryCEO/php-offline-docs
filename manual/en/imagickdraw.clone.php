...
<head>
  ...
  <title>PHP: ImagickDraw::clone - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.clone.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.clone.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.clone.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.clear.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.color.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.clone.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.clone.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.clone.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.clone.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.clone.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.clone.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.clone.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.clone.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.clone.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.clone.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.clone.php" hreflang="zh">
...
<meta name="Description" content="Makes an exact copy of the specified ImagickDraw object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::clone - Manual" />
<meta name="twitter:description" content="Makes an exact copy of the specified ImagickDraw object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::clone - Manual" />
<meta itemprop="description" content="Makes an exact copy of the specified ImagickDraw object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Makes an exact copy of the specified ImagickDraw object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.color.php">
          ImagickDraw::color &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.clear.php">
          &laquo; ImagickDraw::clear        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.clone.php' selected="selected">English</option>
            <option value='de/imagickdraw.clone.php'>German</option>
            <option value='es/imagickdraw.clone.php'>Spanish</option>
            <option value='fr/imagickdraw.clone.php'>French</option>
            <option value='it/imagickdraw.clone.php'>Italian</option>
            <option value='ja/imagickdraw.clone.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.clone.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.clone.php'>Russian</option>
            <option value='tr/imagickdraw.clone.php'>Turkish</option>
            <option value='uk/imagickdraw.clone.php'>Ukrainian</option>
            <option value='zh/imagickdraw.clone.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.clone" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::clone</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::clone</span> &mdash; <span class="dc-title">Makes an exact copy of the specified ImagickDraw object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.clone-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::clone</strong></span>(): <span class="type"><a href="class.imagickdraw.php" class="type ImagickDraw">ImagickDraw</a></span></div>

  <div class="warning"><strong class="warning">Warning</strong><p class="simpara">This function is
currently not documented; only its argument list is available.
</p></div>
  <p class="para">
   Makes an exact copy of the specified <span class="classname"><a href="class.imagickdraw.php" class="classname">ImagickDraw</a></span> object.
  </p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.clone-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   returns an exact copy of the specified <span class="classname"><a href="class.imagickdraw.php" class="classname">ImagickDraw</a></span> object.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/clone.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.clone%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.clone&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.clone.php">＋<small>add a note</small></a></span>
