...
<head>
  ...
  <title>PHP: SolrQuery::getTermsMaxCount - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gettermsmaxcount.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gettermsmaxcount.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermsmaxcount.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gettermslowerbound.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gettermsmincount.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermsmaxcount.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gettermsmaxcount.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gettermsmaxcount.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gettermsmaxcount.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gettermsmaxcount.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gettermsmaxcount.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gettermsmaxcount.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gettermsmaxcount.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gettermsmaxcount.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gettermsmaxcount.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gettermsmaxcount.php" hreflang="zh">
...
<meta name="Description" content="Returns the maximum document frequency" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getTermsMaxCount - Manual" />
<meta name="twitter:description" content="Returns the maximum document frequency" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getTermsMaxCount - Manual" />
<meta itemprop="description" content="Returns the maximum document frequency" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the maximum document frequency" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.gettermsmincount.php">
          SolrQuery::getTermsMinCount &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gettermslowerbound.php">
          &laquo; SolrQuery::getTermsLowerBound        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gettermsmaxcount.php' selected="selected">English</option>
            <option value='de/solrquery.gettermsmaxcount.php'>German</option>
            <option value='es/solrquery.gettermsmaxcount.php'>Spanish</option>
            <option value='fr/solrquery.gettermsmaxcount.php'>French</option>
            <option value='it/solrquery.gettermsmaxcount.php'>Italian</option>
            <option value='ja/solrquery.gettermsmaxcount.php'>Japanese</option>
            <option value='pt_BR/solrquery.gettermsmaxcount.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gettermsmaxcount.php'>Russian</option>
            <option value='tr/solrquery.gettermsmaxcount.php'>Turkish</option>
            <option value='uk/solrquery.gettermsmaxcount.php'>Ukrainian</option>
            <option value='zh/solrquery.gettermsmaxcount.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gettermsmaxcount" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getTermsMaxCount</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getTermsMaxCount</span> &mdash; <span class="dc-title">Returns the maximum document frequency</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gettermsmaxcount-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getTermsMaxCount</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gettermsmaxcount-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gettermsmaxcount-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gettermsmaxcount.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gettermsmaxcount%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gettermsmaxcount&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gettermsmaxcount.php">＋<small>add a note</small></a></span>
