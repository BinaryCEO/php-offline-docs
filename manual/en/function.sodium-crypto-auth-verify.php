...
<head>
  ...
  <title>PHP: sodium_crypto_auth_verify - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-auth-verify.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-auth-verify">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-auth-verify" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-auth-keygen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-box.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-auth-verify.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-auth-verify.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-auth-verify.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-auth-verify.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-auth-verify.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-auth-verify.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-auth-verify.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-auth-verify.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-auth-verify.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-auth-verify.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-auth-verify.php" hreflang="zh">
...
<meta name="Description" content="Verifies that the tag is valid for the message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_auth_verify - Manual" />
<meta name="twitter:description" content="Verifies that the tag is valid for the message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_auth_verify - Manual" />
<meta itemprop="description" content="Verifies that the tag is valid for the message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Verifies that the tag is valid for the message" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-box.php">
          sodium_crypto_box &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-auth-keygen.php">
          &laquo; sodium_crypto_auth_keygen        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-auth-verify.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-auth-verify.php'>German</option>
            <option value='es/function.sodium-crypto-auth-verify.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-auth-verify.php'>French</option>
            <option value='it/function.sodium-crypto-auth-verify.php'>Italian</option>
            <option value='ja/function.sodium-crypto-auth-verify.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-auth-verify.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-auth-verify.php'>Russian</option>
            <option value='tr/function.sodium-crypto-auth-verify.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-auth-verify.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-auth-verify.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-auth-verify" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_auth_verify</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_auth_verify</span> &mdash; <span class="dc-title">Verifies that the tag is valid for the message</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-auth-verify-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_auth_verify</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$mac</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message</code></span>, <span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Verify the authentication tag is valid for a given message and key.
  </p>
  <p class="para">
   Unlike with digital signatures (e.g. <span class="function"><a href="function.sodium-crypto-sign-verify-detached.php" class="function">sodium_crypto_sign_verify_detached()</a></span>),
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-auth-verify-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">mac</code></dt>
    <dd>
     <p class="para">
      Authentication tag produced by <span class="function"><a href="function.sodium-crypto-auth.php" class="function">sodium_crypto_auth()</a></span>
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-auth-verify-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-auth-verify.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-auth-verify%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-auth-verify&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-auth-verify.php">＋<small>add a note</small></a></span>
