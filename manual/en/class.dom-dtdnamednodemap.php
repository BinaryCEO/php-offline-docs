...
<head>
  ...
  <title>PHP: Dom\DtdNamedNodeMap - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-dtdnamednodemap.php">
 <link rel="shorturl" href="https://www.php.net/dom-dtdnamednodemap">
 <link rel="alternate" href="https://www.php.net/dom-dtdnamednodemap" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-documenttype.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-element.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-dtdnamednodemap.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-dtdnamednodemap.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-dtdnamednodemap.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-dtdnamednodemap.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-dtdnamednodemap.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-dtdnamednodemap.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-dtdnamednodemap.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-dtdnamednodemap.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-dtdnamednodemap.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-dtdnamednodemap.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-dtdnamednodemap.php" hreflang="zh">
...
<meta name="Description" content="The Dom\DtdNamedNodeMap class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\DtdNamedNodeMap - Manual" />
<meta name="twitter:description" content="The Dom\DtdNamedNodeMap class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\DtdNamedNodeMap - Manual" />
<meta itemprop="description" content="The Dom\DtdNamedNodeMap class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\DtdNamedNodeMap class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-dtdnamednodemap.php' selected="selected">English</option>
            <option value='de/class.dom-dtdnamednodemap.php'>German</option>
            <option value='es/class.dom-dtdnamednodemap.php'>Spanish</option>
            <option value='fr/class.dom-dtdnamednodemap.php'>French</option>
            <option value='it/class.dom-dtdnamednodemap.php'>Italian</option>
            <option value='ja/class.dom-dtdnamednodemap.php'>Japanese</option>
            <option value='pt_BR/class.dom-dtdnamednodemap.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-dtdnamednodemap.php'>Russian</option>
            <option value='tr/class.dom-dtdnamednodemap.php'>Turkish</option>
            <option value='uk/class.dom-dtdnamednodemap.php'>Ukrainian</option>
            <option value='zh/class.dom-dtdnamednodemap.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-dtdnamednodemap" class="reference">
 <h1 class="title">The Dom\DtdNamedNodeMap class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-dtdnamednodemap.intro">
  ...
  <div class="section" id="dom-dtdnamednodemap.synopsis">
   <h2 class="title">Class synopsis</h2>

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\DtdNamedNodeMap</strong></strong>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="varname"><a href="class.dom-dtdnamednodemap.php#dom-dtdnamednodemap.props.length">$<var class="varname">length</var></a></var>;</div>
  ...
  <div class="section" id="dom-dtdnamednodemap.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-dtdnamednodemap.props.length"><var class="varname">length</var></dt>
     <dd>
      <span class="simpara">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-dtdnamednodemap.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-dtdnamednodemap%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-dtdnamednodemap&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-dtdnamednodemap.php">＋<small>add a note</small></a></span>
