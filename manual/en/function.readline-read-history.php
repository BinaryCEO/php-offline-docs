...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.readline-read-history.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.readline-on-new-line.php">
 <link rel="next" href="https://www.php.net/manual/en/function.readline-redisplay.php">
...
<meta name="Description" content="Reads the history" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: readline_read_history - Manual" />
<meta name="twitter:description" content="Reads the history" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: readline_read_history - Manual" />
<meta itemprop="description" content="Reads the history" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads the history" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.readline-read-history.php' selected="selected">English</option>
            ...
            <option value='fr/function.readline-read-history.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">readline_read_history</span> &mdash; <span class="dc-title">Reads the history</span></p>
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/readline/functions/readline-read-history.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.readline-read-history%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.readline-read-history&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.readline-read-history.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="102097">  <div class="votes">
    ...
    <div class="tally" id="V102097" title="33% like this...">
    -4
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Note that the first line in the history file must contain the string: _HiStOrY_V2_<br /><br />Else it wont work.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.readline-read-history&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.readline-read-history.php">＋<small>add a note</small></a></div>
