...
<head>
  ...
  <title>PHP: Random\Randomizer::nextFloat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/random-randomizer.nextfloat.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/random-randomizer.nextfloat.php">
 <link rel="alternate" href="https://www.php.net/manual/en/random-randomizer.nextfloat.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.random-randomizer.php">
 <link rel="prev" href="https://www.php.net/manual/en/random-randomizer.getint.php">
 <link rel="next" href="https://www.php.net/manual/en/random-randomizer.nextint.php">

 <link rel="alternate" href="https://www.php.net/manual/en/random-randomizer.nextfloat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/random-randomizer.nextfloat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/random-randomizer.nextfloat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/random-randomizer.nextfloat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/random-randomizer.nextfloat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/random-randomizer.nextfloat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/random-randomizer.nextfloat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/random-randomizer.nextfloat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/random-randomizer.nextfloat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/random-randomizer.nextfloat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/random-randomizer.nextfloat.php" hreflang="zh">
...
<meta name="Description" content="Get a float from the right-open interval [0.0, 1.0)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Random\Randomizer::nextFloat - Manual" />
<meta name="twitter:description" content="Get a float from the right-open interval [0.0, 1.0)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Random\Randomizer::nextFloat - Manual" />
<meta itemprop="description" content="Get a float from the right-open interval [0.0, 1.0)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get a float from the right-open interval [0.0, 1.0)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="random-randomizer.nextint.php">
          Random\Randomizer::nextInt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="random-randomizer.getint.php">
          &laquo; Random\Randomizer::getInt        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/random-randomizer.nextfloat.php' selected="selected">English</option>
            <option value='de/random-randomizer.nextfloat.php'>German</option>
            <option value='es/random-randomizer.nextfloat.php'>Spanish</option>
            <option value='fr/random-randomizer.nextfloat.php'>French</option>
            <option value='it/random-randomizer.nextfloat.php'>Italian</option>
            <option value='ja/random-randomizer.nextfloat.php'>Japanese</option>
            <option value='pt_BR/random-randomizer.nextfloat.php'>Brazilian Portuguese</option>
            <option value='ru/random-randomizer.nextfloat.php'>Russian</option>
            <option value='tr/random-randomizer.nextfloat.php'>Turkish</option>
            <option value='uk/random-randomizer.nextfloat.php'>Ukrainian</option>
            <option value='zh/random-randomizer.nextfloat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="random-randomizer.nextfloat" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-random-randomizer.nextfloat-examples">
  ...
  <div class="example" id="example-3781">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="random-randomizer.getfloat.php" class="methodname" rel="rdfs-seeAlso">Random\Randomizer::getFloat()</a> - Get a uniformly selected float</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/random/random/randomizer/nextfloat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Frandom-randomizer.nextfloat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=random-randomizer.nextfloat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/random-randomizer.nextfloat.php">＋<small>add a note</small></a></span>
