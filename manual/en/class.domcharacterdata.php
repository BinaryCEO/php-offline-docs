...
<head>
  ...
  <title>PHP: DOMCharacterData - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.domcharacterdata.php">
 <link rel="shorturl" href="https://www.php.net/domcharacterdata">
 <link rel="alternate" href="https://www.php.net/domcharacterdata" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/domcdatasection.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/domcharacterdata.after.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.domcharacterdata.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.domcharacterdata.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.domcharacterdata.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.domcharacterdata.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.domcharacterdata.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.domcharacterdata.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.domcharacterdata.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.domcharacterdata.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.domcharacterdata.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.domcharacterdata.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.domcharacterdata.php" hreflang="zh">
...
<meta name="Description" content="The DOMCharacterData class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMCharacterData - Manual" />
<meta name="twitter:description" content="The DOMCharacterData class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMCharacterData - Manual" />
<meta itemprop="description" content="The DOMCharacterData class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DOMCharacterData class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="domcharacterdata.after.php">
          DOMCharacterData::after &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domcdatasection.construct.php">
          &laquo; DOMCdataSection::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.domcharacterdata.php' selected="selected">English</option>
            <option value='de/class.domcharacterdata.php'>German</option>
            <option value='es/class.domcharacterdata.php'>Spanish</option>
            <option value='fr/class.domcharacterdata.php'>French</option>
            <option value='it/class.domcharacterdata.php'>Italian</option>
            <option value='ja/class.domcharacterdata.php'>Japanese</option>
            <option value='pt_BR/class.domcharacterdata.php'>Brazilian Portuguese</option>
            <option value='ru/class.domcharacterdata.php'>Russian</option>
            <option value='tr/class.domcharacterdata.php'>Turkish</option>
            <option value='uk/class.domcharacterdata.php'>Ukrainian</option>
            <option value='zh/class.domcharacterdata.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.domcharacterdata" class="reference">
 <h1 class="title">The DOMCharacterData class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>
 

  <div class="section" id="domcharacterdata.intro">
  ...
  <div class="section" id="domcharacterdata.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">DOMCharacterData</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="domcharacterdata.after.php" class="methodname">after</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.domnode.php" class="type DOMNode">DOMNode</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">...$nodes</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domcharacterdata.appenddata.php" class="methodname">appendData</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domcharacterdata.before.php" class="methodname">before</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.domnode.php" class="type DOMNode">DOMNode</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">...$nodes</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domcharacterdata.deletedata.php" class="methodname">deleteData</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$count</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domcharacterdata.insertdata.php" class="methodname">insertData</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domcharacterdata.remove.php" class="methodname">remove</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domcharacterdata.replacedata.php" class="methodname">replaceData</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$count</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domcharacterdata.replacewith.php" class="methodname">replaceWith</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.domnode.php" class="type DOMNode">DOMNode</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">...$nodes</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domcharacterdata.substringdata.php" class="methodname">substringData</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$count</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domnode.wakeup.php" class="methodname">DOMNode::__wakeup</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="domcharacterdata.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="domcharacterdata.props.data"><var class="varname">data</var></dt>
     <dd>
      <p class="para">The contents of the node.</p>
     </dd>
    
    
     <dt id="domcharacterdata.props.length"><var class="varname">length</var></dt>
     <dd>
      <p class="para">The length of the contents.</p>
     </dd>
    
    
     <dt id="domcharacterdata.props.nextelementsibling"><var class="varname">nextElementSibling</var></dt>
     <dd>
      <p class="para">The next sibling element or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.</p>
     </dd>
    
    
     <dt id="domcharacterdata.props.previouselementsibling"><var class="varname">previousElementSibling</var></dt>
     <dd>
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      <tr>
       <td>8.0.0</td>
       <td>
        The <var class="varname">nextElementSibling</var> and
        <var class="varname">previousElementSibling</var> properties have been added.
       </td>
      </tr>
      ...
      <tr>
       <td>8.0.0</td>
       <td>
        <span class="classname"><strong class="classname">DOMCharacterData</strong></span> implements
  ...
  <div class="section">
   ...
   <p class="para">
    <ul class="simplelist">
     <li><a href="http://www.w3.org/TR/2003/WD-DOM-Level-3-Core-20030226/DOM3-Core.html#core-ID-FF21A306" class="link external">&raquo;&nbsp;W3C specification of CharacterData</a></li>
    </ul>
   </p>
  </div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="domcharacterdata.after.php">DOMCharacterData::after</a> — Adds nodes after the character data</li><li><a href="domcharacterdata.appenddata.php">DOMCharacterData::appendData</a> — Append the string to the end of the character data of the node</li><li><a href="domcharacterdata.before.php">DOMCharacterData::before</a> — Adds nodes before the character data</li><li><a href="domcharacterdata.deletedata.php">DOMCharacterData::deleteData</a> — Remove a range of characters from the character data</li><li><a href="domcharacterdata.insertdata.php">DOMCharacterData::insertData</a> — Insert a string at the specified UTF-8 codepoint offset</li><li><a href="domcharacterdata.remove.php">DOMCharacterData::remove</a> — Removes the character data node</li><li><a href="domcharacterdata.replacedata.php">DOMCharacterData::replaceData</a> — Replace a substring within the character data</li><li><a href="domcharacterdata.replacewith.php">DOMCharacterData::replaceWith</a> — Replaces the character data with new nodes</li><li><a href="domcharacterdata.substringdata.php">DOMCharacterData::substringData</a> — Extracts a range of data from the character data</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domcharacterdata.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.domcharacterdata%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.domcharacterdata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.domcharacterdata.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="98797">  <div class="votes">
    <div id="Vu98797">
    <a href="/manual/vote-note.php?id=98797&amp;page=class.domcharacterdata&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98797">
    <a href="/manual/vote-note.php?id=98797&amp;page=class.domcharacterdata&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98797" title="71% like this...">
    3
    </div>
  </div>
  <a href="#98797" class="name">
  <strong class="user"><em>jesdisciple dot FOO at gmail dot BAR dot com</em></strong></a><a class="genanchor" href="#98797"> &para;</a><div class="date" title="2010-07-08 04:35"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98797">
<div class="phpcode"><code><span class="html">In case you're looking for the CDATA class to which nodes /do/ correspond, it's called DOMCdataSection (per my PHP installation) and isn't documented on php.net.  Presumably, it doesn't add anything to this API.<br /><br />See also: <a href="http://www.php.net/manual/en/domdocument.createcdatasection.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/domdocument.createcdatasection.php</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.domcharacterdata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.domcharacterdata.php">＋<small>add a note</small></a></div>
