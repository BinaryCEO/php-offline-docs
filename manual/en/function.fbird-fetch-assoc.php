...
<head>
  ...
  <title>PHP: fbird_fetch_assoc - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-fetch-assoc.php">
 <link rel="shorturl" href="https://www.php.net/fbird-fetch-assoc">
 <link rel="alternate" href="https://www.php.net/fbird-fetch-assoc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-execute.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-fetch-object.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-fetch-assoc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-fetch-assoc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-fetch-assoc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-fetch-assoc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-fetch-assoc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-fetch-assoc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-fetch-assoc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-fetch-assoc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-fetch-assoc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-fetch-assoc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-fetch-assoc.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_fetch_assoc" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_fetch_assoc - Manual" />
<meta name="twitter:description" content="Alias of ibase_fetch_assoc" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_fetch_assoc - Manual" />
<meta itemprop="description" content="Alias of ibase_fetch_assoc" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_fetch_assoc" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fbird-fetch-object.php">
          fbird_fetch_object &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-execute.php">
          &laquo; fbird_execute        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-fetch-assoc.php' selected="selected">English</option>
            <option value='de/function.fbird-fetch-assoc.php'>German</option>
            <option value='es/function.fbird-fetch-assoc.php'>Spanish</option>
            <option value='fr/function.fbird-fetch-assoc.php'>French</option>
            <option value='it/function.fbird-fetch-assoc.php'>Italian</option>
            <option value='ja/function.fbird-fetch-assoc.php'>Japanese</option>
            <option value='pt_BR/function.fbird-fetch-assoc.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-fetch-assoc.php'>Russian</option>
            <option value='tr/function.fbird-fetch-assoc.php'>Turkish</option>
            <option value='uk/function.fbird-fetch-assoc.php'>Ukrainian</option>
            <option value='zh/function.fbird-fetch-assoc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-fetch-assoc" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_fetch_assoc</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_fetch_assoc</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-fetch-assoc.php" class="function">ibase_fetch_assoc()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-fetch-assoc-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.ibase-fetch-assoc.php" class="function">ibase_fetch_assoc()</a></span>.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fbird-fetch-assoc-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-fetch-row.php" class="function" rel="rdfs-seeAlso">fbird_fetch_row()</a> - Alias of ibase_fetch_row</span></li>
    <li><span class="function"><a href="function.fbird-fetch-object.php" class="function" rel="rdfs-seeAlso">fbird_fetch_object()</a> - Alias of ibase_fetch_object</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-fetch-assoc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-fetch-assoc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-fetch-assoc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-fetch-assoc.php">＋<small>add a note</small></a></span>
