...
<head>
  ...
  <title>PHP: imap_mail_move - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-mail-move.php">
 <link rel="shorturl" href="https://www.php.net/imap-mail-move">
 <link rel="alternate" href="https://www.php.net/imap-mail-move" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-mail-copy.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-mailboxmsginfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-mail-move.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-mail-move.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-mail-move.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-mail-move.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-mail-move.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-mail-move.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-mail-move.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-mail-move.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-mail-move.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-mail-move.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-mail-move.php" hreflang="zh">
...
<meta name="Description" content="Move specified messages to a mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_mail_move - Manual" />
<meta name="twitter:description" content="Move specified messages to a mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_mail_move - Manual" />
<meta itemprop="description" content="Move specified messages to a mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Move specified messages to a mailbox" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-mailboxmsginfo.php">
          imap_mailboxmsginfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-mail-copy.php">
          &laquo; imap_mail_copy        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-mail-move.php' selected="selected">English</option>
            <option value='de/function.imap-mail-move.php'>German</option>
            <option value='es/function.imap-mail-move.php'>Spanish</option>
            <option value='fr/function.imap-mail-move.php'>French</option>
            <option value='it/function.imap-mail-move.php'>Italian</option>
            <option value='ja/function.imap-mail-move.php'>Japanese</option>
            <option value='pt_BR/function.imap-mail-move.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-mail-move.php'>Russian</option>
            <option value='tr/function.imap-mail-move.php'>Turkish</option>
            <option value='uk/function.imap-mail-move.php'>Ukrainian</option>
            <option value='zh/function.imap-mail-move.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-mail-move" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-mail-copy.php" class="function" rel="rdfs-seeAlso">imap_mail_copy()</a> - Copy specified messages to a mailbox</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-mail-move.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-mail-move%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-mail-move&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-mail-move.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125406">  <div class="votes">
    <div id="Vu125406">
    <a href="/manual/vote-note.php?id=125406&amp;page=function.imap-mail-move&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125406">
    <a href="/manual/vote-note.php?id=125406&amp;page=function.imap-mail-move&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125406" title="88% like this...">
    7
    </div>
  </div>
  <a href="#125406" class="name">
  <strong class="user"><em>FredN</em></strong></a><a class="genanchor" href="#125406"> &para;</a><div class="date" title="2020-10-02 08:16"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125406">
<div class="phpcode"><code><span class="html">to get right the folders names for imap_mail_move/imap_mail_copy, do not guess, instead use imap_list</span></code></div>
  </div>
 </div>
  <div class="note" id="58929">  <div class="votes">
    <div id="Vu58929">
    <a href="/manual/vote-note.php?id=58929&amp;page=function.imap-mail-move&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd58929">
    <a href="/manual/vote-note.php?id=58929&amp;page=function.imap-mail-move&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V58929" title="72% like this...">
    8
    </div>
  </div>
  <a href="#58929" class="name">
  <strong class="user"><em>alex at bestgames dot ro</em></strong></a><a class="genanchor" href="#58929"> &para;</a><div class="date" title="2005-11-21 01:36"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom58929">
<div class="phpcode"><code><span class="html">After using imap_mail_move, imap_mail_copy or imap_delete it is necesary to call imap_expunge() function.</span></code></div>
  </div>
 </div>
  <div class="note" id="129893">  <div class="votes">
    <div id="Vu129893">
    <a href="/manual/vote-note.php?id=129893&amp;page=function.imap-mail-move&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129893">
    <a href="/manual/vote-note.php?id=129893&amp;page=function.imap-mail-move&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129893" title="100% like this...">
    4
    </div>
  </div>
  <a href="#129893" class="name">
  <strong class="user"><em>jab_creations at yahoo dot com</em></strong></a><a class="genanchor" href="#129893"> &para;</a><div class="date" title="2024-12-04 04:27"><strong>9 months ago</strong></div>
  <div class="text" id="Hcom129893">
<div class="phpcode"><code><span class="html">The imap_mail_move() function's second parameter (message_nums parameter) accept two valid values:<br /><br />Individual message number:<br />47<br /><br />or<br /><br />Array:<br />47,58,112<br /><br />Remember four key things in combination!<br /><br />1. This move function does not move anything, internally it creates a copy and then deletes the original!<br /><br />2. You should be tracking the Message-Id header (that should be set!) internally to confirm the unique IMAP id.<br /><br />3. Because when a message is pseudo-"moved" the original message and unique IMAP id are lost! That means after the internal copy (or to us, having been moved) is created you will then have to create a new connection to the second mailbox folder, list or search and verify by internal message identifiers to keep your mail shell synchronized with the external server. Which then in turn means...<br /><br />4. You will have to track the copied message after it is destroyed in the first mailbox folder. That gives you two logical approaches to use:<br /><br />4.1 Individually move the message then simply get an index of the destination folder (e.g. moving from inbox to trash), "move" the message using this command, getting the index of the trash mailbox folder and comparing the arrays to determine the oddball out.<br /><br />4.2 But in reality we're moving multiple messages in a single go so you can scan the mailbox folder for each message however this presumes that the header (e.g. Message-Id) exists.<br /><br />Example search:<br />$result = imap_search($mail_connection_folder_trash, "TEXT \"&lt;24322757.12578452.2416351620568@domain.tld&gt;\"", SE_UID);<br /><br />In my limited experience of a few thousand emails only spammers or devastatingly underpaid developers have not set the Message-Id. You can not presume however that the missing header implies spam as my original system never set it. Hence why it may be necessary to search by a secondary or tertiary means in more non-common scenarios with oddball messages. This may occur in one-in-several thousand instances.<br /><br />Hopefully this logic will spare a few people the time spent on conceptual work.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-mail-move&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-mail-move.php">＋<small>add a note</small></a></div>
