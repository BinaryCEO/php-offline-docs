...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.decoct.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.dechex.php">
 <link rel="next" href="https://www.php.net/manual/en/function.deg2rad.php">
...
<meta name="Description" content="Decimal to octal" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: decoct - Manual" />
<meta name="twitter:description" content="Decimal to octal" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: decoct - Manual" />
<meta itemprop="description" content="Decimal to octal" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decimal to octal" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.decoct.php' selected="selected">English</option>
            ...
            <option value='ja/function.decoct.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">decoct</span> &mdash; <span class="dc-title">Decimal to octal</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.decoct-description">
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">num</code> argument. The largest number that can be
   converted depends on the platform in use. For 32-bit platforms this is
   usually <code class="literal">4294967295</code> in decimal resulting in
   <code class="literal">37777777777</code>. For 64-bit platforms this is usually
   <code class="literal">9223372036854775807</code> in decimal resulting in
   <code class="literal">777777777777777777777</code>.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.decoct-returnvalues">
  ...
  <p class="para">
   Octal string representation of <code class="parameter">num</code>
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.decoct-examples">
  ...
  <p class="para">
   <div class="example" id="example-3368">
    <p><strong>Example #1 <span class="function"><strong>decoct()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.base-convert.php" class="function" rel="rdfs-seeAlso">base_convert()</a> - Convert a number between arbitrary bases</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/math/functions/decoct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.decoct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.decoct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.decoct.php">＋<small>add a note</small></a></span>
