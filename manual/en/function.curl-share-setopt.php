...
<head>
  ...
  <title>PHP: curl_share_setopt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.curl-share-setopt.php">
 <link rel="shorturl" href="https://www.php.net/curl-share-setopt">
 <link rel="alternate" href="https://www.php.net/curl-share-setopt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.curl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.curl-share-init-persistent.php">
 <link rel="next" href="https://www.php.net/manual/en/function.curl-share-strerror.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.curl-share-setopt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.curl-share-setopt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.curl-share-setopt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.curl-share-setopt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.curl-share-setopt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.curl-share-setopt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.curl-share-setopt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.curl-share-setopt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.curl-share-setopt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.curl-share-setopt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.curl-share-setopt.php" hreflang="zh">
...
<meta name="Description" content="Set an option for a cURL share handle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: curl_share_setopt - Manual" />
<meta name="twitter:description" content="Set an option for a cURL share handle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: curl_share_setopt - Manual" />
<meta itemprop="description" content="Set an option for a cURL share handle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set an option for a cURL share handle" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.curl-share-strerror.php">
          curl_share_strerror &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.curl-share-init-persistent.php">
          &laquo; curl_share_init_persistent        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.curl-share-setopt.php' selected="selected">English</option>
            <option value='de/function.curl-share-setopt.php'>German</option>
            <option value='es/function.curl-share-setopt.php'>Spanish</option>
            <option value='fr/function.curl-share-setopt.php'>French</option>
            <option value='it/function.curl-share-setopt.php'>Italian</option>
            <option value='ja/function.curl-share-setopt.php'>Japanese</option>
            <option value='pt_BR/function.curl-share-setopt.php'>Brazilian Portuguese</option>
            <option value='ru/function.curl-share-setopt.php'>Russian</option>
            <option value='tr/function.curl-share-setopt.php'>Turkish</option>
            <option value='uk/function.curl-share-setopt.php'>Ukrainian</option>
            <option value='zh/function.curl-share-setopt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.curl-share-setopt" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.curl-share-setopt-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>curl_share_setopt</strong></span>(<span class="methodparam"><span class="type"><a href="class.curlsharehandle.php" class="type CurlShareHandle">CurlShareHandle</a></span> <code class="parameter">$share_handle</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$option</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
<span class="function"><a href="function.curl-share-init.php" class="function">curl_share_init()</a></span>.</p></dd>
    ...
    <dd>
     <p class="para">
      One of the <strong><code><a href="curl.constants.php#constant.curlshopt-none">CURLSHOPT_<span class="replaceable">*</span></a></code></strong> constants.
     </p>
    </dd>
    ...
    <dd>
     <p class="para">
      One of the <strong><code><a href="curl.constants.php#constant.curl-lock-data-connect">CURL_LOCK_DATA_<span class="replaceable">*</span></a></code></strong> constants.
     </p>
    </dd>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Create cURL share handle and set it to share cookie data<br /></span><span style="color: #0000BB">$sh </span><span style="color: #007700">= </span><span style="color: #0000BB">curl_share_init</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">curl_share_setopt</span><span style="color: #007700">(</span><span style="color: #0000BB">$sh</span><span style="color: #007700">, </span><span style="color: #0000BB">CURLSHOPT_SHARE</span><span style="color: #007700">, </span><span style="color: #0000BB">CURL_LOCK_DATA_COOKIE</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Initialize the first cURL handle and assign the share handle to it<br /></span><span style="color: #0000BB">$ch1 </span><span style="color: #007700">= </span><span style="color: #0000BB">curl_init</span><span style="color: #007700">(</span><span style="color: #DD0000">"http://example.com/"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">curl_setopt</span><span style="color: #007700">(</span><span style="color: #0000BB">$ch1</span><span style="color: #007700">, </span><span style="color: #0000BB">CURLOPT_SHARE</span><span style="color: #007700">, </span><span style="color: #0000BB">$sh</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Execute the first cURL handle<br /></span><span style="color: #0000BB">curl_exec</span><span style="color: #007700">(</span><span style="color: #0000BB">$ch1</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Initialize the second cURL handle and assign the share handle to it<br /></span><span style="color: #0000BB">$ch2 </span><span style="color: #007700">= </span><span style="color: #0000BB">curl_init</span><span style="color: #007700">(</span><span style="color: #DD0000">"http://php.net/"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">curl_setopt</span><span style="color: #007700">(</span><span style="color: #0000BB">$ch2</span><span style="color: #007700">, </span><span style="color: #0000BB">CURLOPT_SHARE</span><span style="color: #007700">, </span><span style="color: #0000BB">$sh</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Execute the second cURL handle<br />//  all cookies from $ch1 handle are shared with $ch2 handle<br /></span><span style="color: #0000BB">curl_exec</span><span style="color: #007700">(</span><span style="color: #0000BB">$ch2</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Close the cURL share handle<br /></span><span style="color: #0000BB">curl_share_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$sh</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Close the cURL handles<br /></span><span style="color: #0000BB">curl_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$ch1</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">curl_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$ch2</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/curl/functions/curl-share-setopt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.curl-share-setopt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.curl-share-setopt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-share-setopt.php">＋<small>add a note</small></a></span>
