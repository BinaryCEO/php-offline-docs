...
<head>
  ...
  <title>PHP: eio_link - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-link.php">
 <link rel="shorturl" href="https://www.php.net/eio-link">
 <link rel="alternate" href="https://www.php.net/eio-link" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-init.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-lstat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-link.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-link.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-link.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-link.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-link.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-link.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-link.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-link.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-link.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-link.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-link.php" hreflang="zh">
...
<meta name="Description" content="Create a hardlink for file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_link - Manual" />
<meta name="twitter:description" content="Create a hardlink for file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_link - Manual" />
<meta itemprop="description" content="Create a hardlink for file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a hardlink for file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-link.php' selected="selected">English</option>
            <option value='de/function.eio-link.php'>German</option>
            <option value='es/function.eio-link.php'>Spanish</option>
            <option value='fr/function.eio-link.php'>French</option>
            <option value='it/function.eio-link.php'>Italian</option>
            <option value='ja/function.eio-link.php'>Japanese</option>
            <option value='pt_BR/function.eio-link.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-link.php'>Russian</option>
            <option value='tr/function.eio-link.php'>Turkish</option>
            <option value='uk/function.eio-link.php'>Ukrainian</option>
            <option value='zh/function.eio-link.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-link" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_link</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_link</span> &mdash; <span class="dc-title">Create a hardlink for file</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-link-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_link</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$new_path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
  <span class="function"><strong>eio_link()</strong></span> creates a hardlink
  <code class="parameter">new_path</code> for a file specified by
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-link-parameters">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-link-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.eio-link-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-3514">
   <p><strong>Example #1 <span class="function"><strong>eio_link()</strong></span> example</strong></p>
...
string(%d) &quot;%ssymlink.dat&quot;</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-link-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-symlink.php" class="function" rel="rdfs-seeAlso">eio_symlink()</a> - Create a symbolic link</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-link.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-link%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-link&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-link.php">＋<small>add a note</small></a></span>
