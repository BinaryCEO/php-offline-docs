...
<head>
  ...
  <title>PHP: stream_bucket_append - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-bucket-append.php">
 <link rel="shorturl" href="https://www.php.net/stream-bucket-append">
 <link rel="alternate" href="https://www.php.net/stream-bucket-append" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-bucket-make-writeable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-bucket-append.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-bucket-append.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-bucket-append.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-bucket-append.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-bucket-append.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-bucket-append.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-bucket-append.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-bucket-append.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-bucket-append.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-bucket-append.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-bucket-append.php" hreflang="zh">
...
<meta name="Description" content="Append bucket to brigade" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_bucket_append - Manual" />
<meta name="twitter:description" content="Append bucket to brigade" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_bucket_append - Manual" />
<meta itemprop="description" content="Append bucket to brigade" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Append bucket to brigade" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-bucket-make-writeable.php">
          stream_bucket_make_writeable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.stream.php">
          &laquo; Stream Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-bucket-append.php' selected="selected">English</option>
            <option value='de/function.stream-bucket-append.php'>German</option>
            <option value='es/function.stream-bucket-append.php'>Spanish</option>
            <option value='fr/function.stream-bucket-append.php'>French</option>
            <option value='it/function.stream-bucket-append.php'>Italian</option>
            <option value='ja/function.stream-bucket-append.php'>Japanese</option>
            <option value='pt_BR/function.stream-bucket-append.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-bucket-append.php'>Russian</option>
            <option value='tr/function.stream-bucket-append.php'>Turkish</option>
            <option value='uk/function.stream-bucket-append.php'>Ukrainian</option>
            <option value='zh/function.stream-bucket-append.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-bucket-append" class="refentry">
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-bucket-append.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-bucket-append%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-bucket-append&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-bucket-append.php">＋<small>add a note</small></a></span>
