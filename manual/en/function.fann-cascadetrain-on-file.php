...
<head>
  ...
  <title>PHP: fann_cascadetrain_on_file - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-cascadetrain-on-file.php">
 <link rel="shorturl" href="https://www.php.net/fann-cascadetrain-on-file">
 <link rel="alternate" href="https://www.php.net/fann-cascadetrain-on-file" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-cascadetrain-on-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-clear-scaling-params.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-cascadetrain-on-file.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-cascadetrain-on-file.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-cascadetrain-on-file.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-cascadetrain-on-file.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-cascadetrain-on-file.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-cascadetrain-on-file.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-cascadetrain-on-file.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-cascadetrain-on-file.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-cascadetrain-on-file.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-cascadetrain-on-file.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-cascadetrain-on-file.php" hreflang="zh">
...
<meta name="Description" content="Trains on an entire dataset read from file, for a period of time using the Cascade2 training algorithm" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_cascadetrain_on_file - Manual" />
<meta name="twitter:description" content="Trains on an entire dataset read from file, for a period of time using the Cascade2 training algorithm" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_cascadetrain_on_file - Manual" />
<meta itemprop="description" content="Trains on an entire dataset read from file, for a period of time using the Cascade2 training algorithm" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Trains on an entire dataset read from file, for a period of time using the Cascade2 training algorithm" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-clear-scaling-params.php">
          fann_clear_scaling_params &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-cascadetrain-on-data.php">
          &laquo; fann_cascadetrain_on_data        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-cascadetrain-on-file.php' selected="selected">English</option>
            <option value='de/function.fann-cascadetrain-on-file.php'>German</option>
            <option value='es/function.fann-cascadetrain-on-file.php'>Spanish</option>
            <option value='fr/function.fann-cascadetrain-on-file.php'>French</option>
            <option value='it/function.fann-cascadetrain-on-file.php'>Italian</option>
            <option value='ja/function.fann-cascadetrain-on-file.php'>Japanese</option>
            <option value='pt_BR/function.fann-cascadetrain-on-file.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-cascadetrain-on-file.php'>Russian</option>
            <option value='tr/function.fann-cascadetrain-on-file.php'>Turkish</option>
            <option value='uk/function.fann-cascadetrain-on-file.php'>Ukrainian</option>
            <option value='zh/function.fann-cascadetrain-on-file.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-cascadetrain-on-file" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_cascadetrain_on_file</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_cascadetrain_on_file</span> &mdash; <span class="dc-title">Trains on an entire dataset read from file, for a period of time using the Cascade2 training algorithm</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-cascadetrain-on-file-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_cascadetrain_on_file</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$max_neurons</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$neurons_between_reports</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$desired_error</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Does the same as <span class="function"><a href="function.fann-cascadetrain-on-data.php" class="function">fann_cascadetrain_on_data()</a></span>, but reads the training data directly from a file.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fann-cascadetrain-on-file-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-cascadetrain-on-file-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-cascadetrain-on-file-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-cascadetrain-on-data.php" class="function" rel="rdfs-seeAlso">fann_cascadetrain_on_data()</a> - Trains on an entire dataset, for a period of time using the Cascade2 training algorithm</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-cascadetrain-on-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-cascadetrain-on-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-cascadetrain-on-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-cascadetrain-on-file.php">＋<small>add a note</small></a></span>
