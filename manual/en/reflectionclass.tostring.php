...
<head>
  ...
  <title>PHP: ReflectionClass::__toString - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.tostring.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.tostring.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.tostring.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.setstaticpropertyvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/class.reflectionclassconstant.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.tostring.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.tostring.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.tostring.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.tostring.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.tostring.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.tostring.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.tostring.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.tostring.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.tostring.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.tostring.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.tostring.php" hreflang="zh">
...
<meta name="Description" content="Returns the string representation of the ReflectionClass object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::__toString - Manual" />
<meta name="twitter:description" content="Returns the string representation of the ReflectionClass object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::__toString - Manual" />
<meta itemprop="description" content="Returns the string representation of the ReflectionClass object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the string representation of the ReflectionClass object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.reflectionclassconstant.php">
          ReflectionClassConstant &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.setstaticpropertyvalue.php">
          &laquo; ReflectionClass::setStaticPropertyValue        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.tostring.php' selected="selected">English</option>
            <option value='de/reflectionclass.tostring.php'>German</option>
            <option value='es/reflectionclass.tostring.php'>Spanish</option>
            <option value='fr/reflectionclass.tostring.php'>French</option>
            <option value='it/reflectionclass.tostring.php'>Italian</option>
            <option value='ja/reflectionclass.tostring.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.tostring.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.tostring.php'>Russian</option>
            <option value='tr/reflectionclass.tostring.php'>Turkish</option>
            <option value='uk/reflectionclass.tostring.php'>Ukrainian</option>
            <option value='zh/reflectionclass.tostring.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.tostring" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::__toString</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::__toString</span> &mdash; <span class="dc-title">Returns the string representation of the ReflectionClass object</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.tostring-returnvalues">
  ...
  <p class="para">
   A string representation of this <span class="classname"><a href="class.reflectionclass.php" class="classname">ReflectionClass</a></span> instance.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.tostring-examples">
  ...
  <p class="para">
   <div class="example" id="example-5512">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionClass::__toString()</strong></span> example</strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">Class [ &lt;internal:Core&gt; class Exception ] {
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.tostring-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.export.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::export()</a> - Exports a class</span></li>
    <li><a href="language.oop5.magic.php#object.tostring" class="link">__toString()</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/tostring.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.tostring%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.tostring&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.tostring.php">＋<small>add a note</small></a></span>
