...
<head>
  ...
  <title>PHP: SolrQuery::setFacetMethod - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setfacetmethod.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setfacetmethod.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetmethod.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setfacetlimit.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setfacetmincount.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetmethod.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setfacetmethod.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setfacetmethod.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setfacetmethod.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setfacetmethod.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setfacetmethod.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setfacetmethod.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setfacetmethod.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setfacetmethod.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setfacetmethod.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setfacetmethod.php" hreflang="zh">
...
<meta name="Description" content="Specifies the type of algorithm to use when faceting a field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setFacetMethod - Manual" />
<meta name="twitter:description" content="Specifies the type of algorithm to use when faceting a field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setFacetMethod - Manual" />
<meta itemprop="description" content="Specifies the type of algorithm to use when faceting a field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the type of algorithm to use when faceting a field" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setfacetmincount.php">
          SolrQuery::setFacetMinCount &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setfacetlimit.php">
          &laquo; SolrQuery::setFacetLimit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setfacetmethod.php' selected="selected">English</option>
            <option value='de/solrquery.setfacetmethod.php'>German</option>
            <option value='es/solrquery.setfacetmethod.php'>Spanish</option>
            <option value='fr/solrquery.setfacetmethod.php'>French</option>
            <option value='it/solrquery.setfacetmethod.php'>Italian</option>
            <option value='ja/solrquery.setfacetmethod.php'>Japanese</option>
            <option value='pt_BR/solrquery.setfacetmethod.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setfacetmethod.php'>Russian</option>
            <option value='tr/solrquery.setfacetmethod.php'>Turkish</option>
            <option value='uk/solrquery.setfacetmethod.php'>Ukrainian</option>
            <option value='zh/solrquery.setfacetmethod.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setfacetmethod" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setFacetMethod</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setFacetMethod</span> &mdash; <span class="dc-title">Specifies the type of algorithm to use when faceting a field</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setfacetmethod-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setFacetMethod</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$method</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setfacetmethod-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setfacetmethod-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setfacetmethod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setfacetmethod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setfacetmethod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setfacetmethod.php">＋<small>add a note</small></a></span>
