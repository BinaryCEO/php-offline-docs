...
<head>
  ...
  <title>PHP: xml_set_processing_instruction_handler - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xml-set-processing-instruction-handler.php">
 <link rel="shorturl" href="https://www.php.net/xml-set-processing-instruction-handler">
 <link rel="alternate" href="https://www.php.net/xml-set-processing-instruction-handler" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.xml.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.xml-set-object.php">
 <link rel="next" href="https://www.php.net/manual/en/function.xml-set-start-namespace-decl-handler.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.xml-set-processing-instruction-handler.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.xml-set-processing-instruction-handler.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.xml-set-processing-instruction-handler.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.xml-set-processing-instruction-handler.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.xml-set-processing-instruction-handler.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.xml-set-processing-instruction-handler.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.xml-set-processing-instruction-handler.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.xml-set-processing-instruction-handler.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.xml-set-processing-instruction-handler.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.xml-set-processing-instruction-handler.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.xml-set-processing-instruction-handler.php" hreflang="zh">
...
<meta name="Description" content="Set up processing instruction (PI) handler" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: xml_set_processing_instruction_handler - Manual" />
<meta name="twitter:description" content="Set up processing instruction (PI) handler" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: xml_set_processing_instruction_handler - Manual" />
<meta itemprop="description" content="Set up processing instruction (PI) handler" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set up processing instruction (PI) handler" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.xml-set-start-namespace-decl-handler.php">
          xml_set_start_namespace_decl_handler &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.xml-set-object.php">
          &laquo; xml_set_object        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xml-set-processing-instruction-handler.php' selected="selected">English</option>
            <option value='de/function.xml-set-processing-instruction-handler.php'>German</option>
            <option value='es/function.xml-set-processing-instruction-handler.php'>Spanish</option>
            <option value='fr/function.xml-set-processing-instruction-handler.php'>French</option>
            <option value='it/function.xml-set-processing-instruction-handler.php'>Italian</option>
            <option value='ja/function.xml-set-processing-instruction-handler.php'>Japanese</option>
            <option value='pt_BR/function.xml-set-processing-instruction-handler.php'>Brazilian Portuguese</option>
            <option value='ru/function.xml-set-processing-instruction-handler.php'>Russian</option>
            <option value='tr/function.xml-set-processing-instruction-handler.php'>Turkish</option>
            <option value='uk/function.xml-set-processing-instruction-handler.php'>Ukrainian</option>
            <option value='zh/function.xml-set-processing-instruction-handler.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.xml-set-processing-instruction-handler" class="refentry">
 ...
 <td>
  ...
  instance now; previously, a valid <code class="literal">xml</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xml/functions/xml-set-processing-instruction-handler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xml-set-processing-instruction-handler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xml-set-processing-instruction-handler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xml-set-processing-instruction-handler.php">＋<small>add a note</small></a></span>
