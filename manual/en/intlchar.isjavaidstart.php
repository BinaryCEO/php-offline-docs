...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.isjavaidstart.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.isjavaidstart.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isjavaidstart.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.isjavaidpart.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.isjavaspacechar.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.isjavaidstart.php' selected="selected">English</option>
            ...
            <option value='tr/intlchar.isjavaidstart.php'>Turkish</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.isalpha.php" class="function" rel="rdfs-seeAlso">IntlChar::isalpha()</a> - Check if code point is a letter character</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/isjavaidstart.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.isjavaidstart%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.isjavaidstart&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.isjavaidstart.php">＋<small>add a note</small></a></span>
