...
<head>
  ...
  <title>PHP: stats_dens_pmf_hypergeometric - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-dens-pmf-hypergeometric.php">
 <link rel="shorturl" href="https://www.php.net/stats-dens-pmf-hypergeometric">
 <link rel="alternate" href="https://www.php.net/stats-dens-pmf-hypergeometric" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-dens-pmf-binomial.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-dens-pmf-negative-binomial.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-dens-pmf-hypergeometric.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-dens-pmf-hypergeometric.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-dens-pmf-hypergeometric.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-dens-pmf-hypergeometric.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-dens-pmf-hypergeometric.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-dens-pmf-hypergeometric.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-dens-pmf-hypergeometric.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-dens-pmf-hypergeometric.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-dens-pmf-hypergeometric.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-dens-pmf-hypergeometric.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-dens-pmf-hypergeometric.php" hreflang="zh">
...
<meta name="Description" content="Probability mass function of the hypergeometric distribution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_dens_pmf_hypergeometric - Manual" />
<meta name="twitter:description" content="Probability mass function of the hypergeometric distribution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_dens_pmf_hypergeometric - Manual" />
<meta itemprop="description" content="Probability mass function of the hypergeometric distribution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Probability mass function of the hypergeometric distribution" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stats-dens-pmf-negative-binomial.php">
          stats_dens_pmf_negative_binomial &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-dens-pmf-binomial.php">
          &laquo; stats_dens_pmf_binomial        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-dens-pmf-hypergeometric.php' selected="selected">English</option>
            <option value='de/function.stats-dens-pmf-hypergeometric.php'>German</option>
            <option value='es/function.stats-dens-pmf-hypergeometric.php'>Spanish</option>
            <option value='fr/function.stats-dens-pmf-hypergeometric.php'>French</option>
            <option value='it/function.stats-dens-pmf-hypergeometric.php'>Italian</option>
            <option value='ja/function.stats-dens-pmf-hypergeometric.php'>Japanese</option>
            <option value='pt_BR/function.stats-dens-pmf-hypergeometric.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-dens-pmf-hypergeometric.php'>Russian</option>
            <option value='tr/function.stats-dens-pmf-hypergeometric.php'>Turkish</option>
            <option value='uk/function.stats-dens-pmf-hypergeometric.php'>Ukrainian</option>
            <option value='zh/function.stats-dens-pmf-hypergeometric.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-dens-pmf-hypergeometric" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.stats-dens-pmf-hypergeometric-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_dens_pmf_hypergeometric</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$n1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$n2</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$N1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$N2</code></span><br>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stats-dens-pmf-hypergeometric-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">n1</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">n2</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-dens-pmf-hypergeometric-returnvalues">
  ...
  <p class="para">
   The probability mass at <code class="parameter">n1</code> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> for failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-dens-pmf-hypergeometric.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-dens-pmf-hypergeometric%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-dens-pmf-hypergeometric&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-dens-pmf-hypergeometric.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123960">  <div class="votes">
    <div id="Vu123960">
    <a href="/manual/vote-note.php?id=123960&amp;page=function.stats-dens-pmf-hypergeometric&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123960">
    <a href="/manual/vote-note.php?id=123960&amp;page=function.stats-dens-pmf-hypergeometric&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123960" title="no votes...">
    0
    </div>
  </div>
  <a href="#123960" class="name">
  <strong class="user"><em>brendan at gamblingtec dot com</em></strong></a><a class="genanchor" href="#123960"> &para;</a><div class="date" title="2019-06-19 01:11"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123960">
<div class="phpcode"><code><span class="html">You can use this method to work out lottery odds:<br /><br />/**<br />* N is the population size OR total balls in the lottery draw<br />* K is the number of success states in the population OR the number of correct balls drawn from the pool<br />* n is the number of draws OR the number of times we draw from the pool to get the winning numbers.<br />*/<br /><br />$N = 49; //Total balls in the pool<br />$K = 1; //Successful matches to win<br /><br />$method = new Hypergeometric($N, $K, $K);<br />$odds = $method-&gt;pmf($K);<br />        <br />return 1/$odds;<br /><br />//Will return 49</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stats-dens-pmf-hypergeometric&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-dens-pmf-hypergeometric.php">＋<small>add a note</small></a></div>
