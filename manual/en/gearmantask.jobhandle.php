...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmantask.jobhandle.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmantask.jobhandle.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmantask.jobhandle.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmantask.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmantask.isrunning.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmantask.recvdata.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmantask.jobhandle.php' selected="selected">English</option>
            ...
            <option value='tr/gearmantask.jobhandle.php'>Turkish</option>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="gearmanclient.dojobhandle.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::doJobHandle()</a> - Get the job handle for the running task</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmantask/jobhandle.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmantask.jobhandle%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmantask.jobhandle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmantask.jobhandle.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">The job handle is not assigned until the task is received and queued by the job server, so you will need to use one of the client callbacks to access the handle:<br /><br /><span class="default">&lt;?php<br />$client</span><span class="keyword">-&gt;</span><span class="default">setCreatedCallback</span><span class="keyword">(function (</span><span class="default">$task</span><span class="keyword">) {<br />    </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$task</span><span class="keyword">-&gt;</span><span class="default">jobHandle</span><span class="keyword">()); </span><span class="comment">// "H:server:1"<br /></span><span class="keyword">});<br /></span><span class="default">$task </span><span class="keyword">= </span><span class="default">$client</span><span class="keyword">-&gt;</span><span class="default">addTask</span><span class="keyword">(</span><span class="string">'function'</span><span class="keyword">, </span><span class="string">'workload'</span><span class="keyword">);<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$task</span><span class="keyword">-&gt;</span><span class="default">jobHandle</span><span class="keyword">()); </span><span class="comment">// ""</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gearmantask.jobhandle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmantask.jobhandle.php">＋<small>add a note</small></a></div>
