...
<head>
  ...
  <title>PHP: UI\Draw\Line\Join - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-draw-line-join.php">
 <link rel="shorturl" href="https://www.php.net/ui-draw-line-join">
 <link rel="alternate" href="https://www.php.net/ui-draw-line-join" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.ui-draw-line-cap.php">
 <link rel="next" href="https://www.php.net/manual/en/class.ui-key.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-draw-line-join.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-draw-line-join.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-draw-line-join.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-draw-line-join.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-draw-line-join.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-draw-line-join.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-draw-line-join.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-draw-line-join.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-draw-line-join.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-draw-line-join.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-draw-line-join.php" hreflang="zh">
...
<meta name="Description" content="Line Join Settings" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Draw\Line\Join - Manual" />
<meta name="twitter:description" content="Line Join Settings" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Draw\Line\Join - Manual" />
<meta itemprop="description" content="Line Join Settings" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Line Join Settings" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.ui-key.php">
          UI\Key &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.ui-draw-line-cap.php">
          &laquo; UI\Draw\Line\Cap        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-draw-line-join.php' selected="selected">English</option>
            <option value='de/class.ui-draw-line-join.php'>German</option>
            <option value='es/class.ui-draw-line-join.php'>Spanish</option>
            <option value='fr/class.ui-draw-line-join.php'>French</option>
            <option value='it/class.ui-draw-line-join.php'>Italian</option>
            <option value='ja/class.ui-draw-line-join.php'>Japanese</option>
            <option value='pt_BR/class.ui-draw-line-join.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-draw-line-join.php'>Russian</option>
            <option value='tr/class.ui-draw-line-join.php'>Turkish</option>
            <option value='uk/class.ui-draw-line-join.php'>Ukrainian</option>
            <option value='zh/class.ui-draw-line-join.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-draw-line-join" class="reference">

 <h1 class="title">Line Join Settings</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-draw-line-join.intro">
  ...
  <div class="section" id="ui-draw-line-join.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      ...
      <span class="modifier">class</span> <strong class="classname">UI\Draw\Line\Join</strong>
     </span>
     {</div>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-draw-line-join.php#ui-draw-line-join.constants.miter"><var class="varname">Miter</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-draw-line-join.php#ui-draw-line-join.constants.round"><var class="varname">Round</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-draw-line-join.php#ui-draw-line-join.constants.bevel"><var class="varname">Bevel</var></a></var>;</div>
  ...
  <div class="section" id="ui-draw-line-join.constants">
   <h2 class="title">Predefined Constants</h2>
   <dl>

    
     <dt id="ui-draw-line-join.constants.miter"><strong><code><a href="class.ui-draw-line-join.php#ui-draw-line-join.constants.miter">UI\Draw\Line\Join::Miter</a></code></strong></dt>
     <dd>
      <span class="simpara"/>
     </dd>
    
    
     <dt id="ui-draw-line-join.constants.round"><strong><code><a href="class.ui-draw-line-join.php#ui-draw-line-join.constants.round">UI\Draw\Line\Join::Round</a></code></strong></dt>
     <dd>
      <span class="simpara"/>
     </dd>
    
    
     <dt id="ui-draw-line-join.constants.bevel"><strong><code><a href="class.ui-draw-line-join.php#ui-draw-line-join.constants.bevel">UI\Draw\Line\Join::Bevel</a></code></strong></dt>
     <dd>
      <span class="simpara"/>
     </dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.draw.line.join.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-draw-line-join%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-draw-line-join&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-draw-line-join.php">＋<small>add a note</small></a></span>
