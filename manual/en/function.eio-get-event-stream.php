...
<head>
  ...
  <title>PHP: eio_get_event_stream - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-get-event-stream.php">
 <link rel="shorturl" href="https://www.php.net/eio-get-event-stream">
 <link rel="alternate" href="https://www.php.net/eio-get-event-stream" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-futime.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-get-last-error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-get-event-stream.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-get-event-stream.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-get-event-stream.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-get-event-stream.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-get-event-stream.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-get-event-stream.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-get-event-stream.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-get-event-stream.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-get-event-stream.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-get-event-stream.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-get-event-stream.php" hreflang="zh">
...
<meta name="Description" content="Get stream representing a variable used in internal communications with libeio" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_get_event_stream - Manual" />
<meta name="twitter:description" content="Get stream representing a variable used in internal communications with libeio" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_get_event_stream - Manual" />
<meta itemprop="description" content="Get stream representing a variable used in internal communications with libeio" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get stream representing a variable used in internal communications with libeio" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-get-event-stream.php' selected="selected">English</option>
            <option value='de/function.eio-get-event-stream.php'>German</option>
            <option value='es/function.eio-get-event-stream.php'>Spanish</option>
            <option value='fr/function.eio-get-event-stream.php'>French</option>
            <option value='it/function.eio-get-event-stream.php'>Italian</option>
            <option value='ja/function.eio-get-event-stream.php'>Japanese</option>
            <option value='pt_BR/function.eio-get-event-stream.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-get-event-stream.php'>Russian</option>
            <option value='tr/function.eio-get-event-stream.php'>Turkish</option>
            <option value='uk/function.eio-get-event-stream.php'>Ukrainian</option>
            <option value='zh/function.eio-get-event-stream.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-get-event-stream" class="refentry">
...
string(10) &quot;mkdir data&quot;</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-get-event-stream.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-get-event-stream%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-get-event-stream&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-get-event-stream.php">＋<small>add a note</small></a></span>
