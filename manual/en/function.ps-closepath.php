...
<head>
  ...
  <title>PHP: ps_closepath - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-closepath.php">
 <link rel="shorturl" href="https://www.php.net/ps-closepath">
 <link rel="alternate" href="https://www.php.net/ps-closepath" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-close-image.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-closepath-stroke.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-closepath.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-closepath.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-closepath.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-closepath.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-closepath.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-closepath.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-closepath.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-closepath.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-closepath.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-closepath.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-closepath.php" hreflang="zh">
...
<meta name="Description" content="Closes path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_closepath - Manual" />
<meta name="twitter:description" content="Closes path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_closepath - Manual" />
<meta itemprop="description" content="Closes path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Closes path" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-closepath-stroke.php">
          ps_closepath_stroke &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-close-image.php">
          &laquo; ps_close_image        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-closepath.php' selected="selected">English</option>
            <option value='de/function.ps-closepath.php'>German</option>
            <option value='es/function.ps-closepath.php'>Spanish</option>
            <option value='fr/function.ps-closepath.php'>French</option>
            <option value='it/function.ps-closepath.php'>Italian</option>
            <option value='ja/function.ps-closepath.php'>Japanese</option>
            <option value='pt_BR/function.ps-closepath.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-closepath.php'>Russian</option>
            <option value='tr/function.ps-closepath.php'>Turkish</option>
            <option value='uk/function.ps-closepath.php'>Ukrainian</option>
            <option value='zh/function.ps-closepath.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-closepath" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_closepath</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_closepath</span> &mdash; <span class="dc-title">Closes path</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-closepath-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_closepath</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-closepath-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-closepath-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-closepath-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-clip.php" class="function" rel="rdfs-seeAlso">ps_clip()</a> - Clips drawing to current path</span></li>
    <li><span class="function"><a href="function.ps-closepath-stroke.php" class="function" rel="rdfs-seeAlso">ps_closepath_stroke()</a> - Closes and strokes path</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-closepath.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-closepath%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-closepath&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-closepath.php">＋<small>add a note</small></a></span>
