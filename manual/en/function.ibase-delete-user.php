...
<head>
  ...
  <title>PHP: ibase_delete_user - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-delete-user.php">
 <link rel="shorturl" href="https://www.php.net/ibase-delete-user">
 <link rel="alternate" href="https://www.php.net/ibase-delete-user" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-db-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-drop-db.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-delete-user.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-delete-user.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-delete-user.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-delete-user.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-delete-user.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-delete-user.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-delete-user.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-delete-user.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-delete-user.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-delete-user.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-delete-user.php" hreflang="zh">
...
<meta name="Description" content="Delete a user from a security database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_delete_user - Manual" />
<meta name="twitter:description" content="Delete a user from a security database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_delete_user - Manual" />
<meta itemprop="description" content="Delete a user from a security database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete a user from a security database" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-drop-db.php">
          ibase_drop_db &raquo;
              ...
              <div class="prev">
        <a href="function.ibase-db-info.php">
          &laquo; ibase_db_info        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-delete-user.php' selected="selected">English</option>
            <option value='de/function.ibase-delete-user.php'>German</option>
            <option value='es/function.ibase-delete-user.php'>Spanish</option>
            <option value='fr/function.ibase-delete-user.php'>French</option>
            <option value='it/function.ibase-delete-user.php'>Italian</option>
            <option value='ja/function.ibase-delete-user.php'>Japanese</option>
            <option value='pt_BR/function.ibase-delete-user.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-delete-user.php'>Russian</option>
            <option value='tr/function.ibase-delete-user.php'>Turkish</option>
            <option value='uk/function.ibase-delete-user.php'>Ukrainian</option>
            <option value='zh/function.ibase-delete-user.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-delete-user" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_delete_user</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_delete_user</span> &mdash; <span class="dc-title">Delete a user from a security database</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ibase-delete-user-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_delete_user</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$service_handle</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$user_name</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>


 </div>


 <div class="refsect1 parameters" id="refsect1-function.ibase-delete-user-parameters">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-modify-user.php" class="function" rel="rdfs-seeAlso">ibase_modify_user()</a> - Modify a user to a security database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-delete-user.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-delete-user%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-delete-user&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-delete-user.php">＋<small>add a note</small></a></span>
