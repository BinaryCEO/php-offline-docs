...
<head>
  ...
  <title>PHP: wincache_scache_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-scache-info.php">
 <link rel="shorturl" href="https://www.php.net/wincache-scache-info">
 <link rel="alternate" href="https://www.php.net/wincache-scache-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-rplist-meminfo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-scache-meminfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-scache-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-scache-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-scache-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-scache-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-scache-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-scache-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-scache-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-scache-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-scache-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-scache-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-scache-info.php" hreflang="zh">
...
<meta name="Description" content="Retrieves information about files cached in the session cache" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_scache_info - Manual" />
<meta name="twitter:description" content="Retrieves information about files cached in the session cache" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_scache_info - Manual" />
<meta itemprop="description" content="Retrieves information about files cached in the session cache" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieves information about files cached in the session cache" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.wincache-scache-meminfo.php">
          wincache_scache_meminfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-rplist-meminfo.php">
          &laquo; wincache_rplist_meminfo        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-scache-info.php' selected="selected">English</option>
            <option value='de/function.wincache-scache-info.php'>German</option>
            <option value='es/function.wincache-scache-info.php'>Spanish</option>
            <option value='fr/function.wincache-scache-info.php'>French</option>
            <option value='it/function.wincache-scache-info.php'>Italian</option>
            <option value='ja/function.wincache-scache-info.php'>Japanese</option>
            <option value='pt_BR/function.wincache-scache-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-scache-info.php'>Russian</option>
            <option value='tr/function.wincache-scache-info.php'>Turkish</option>
            <option value='uk/function.wincache-scache-info.php'>Ukrainian</option>
            <option value='zh/function.wincache-scache-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-scache-info" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">wincache_scache_info</h1>
  <p class="verinfo">(PECL wincache &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">wincache_scache_info</span> &mdash; <span class="dc-title">
 ...
 <div class="refsect1 description" id="refsect1-function.wincache-scache-info-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>wincache_scache_info</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$summaryonly</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.wincache-scache-info-parameters">
  ...
  <p class="para">
   Array of meta data about session cache  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure
  </p>
    <p class="para">
   ...
   <ul class="itemizedlist">
    <li class="listitem">
     <span class="simpara">
      <code class="literal">total_cache_uptime</code> - total time in seconds that the session cache has been active
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
      <code class="literal">total_item_count</code> - total number of elements that are currently in the session cache
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
    ...
    <li class="listitem">
     <p class="para">
      <code class="literal">scache_entries</code> - an array that contains the information about all the cached items:
      <ul class="itemizedlist">
       <li class="listitem">
        <span class="simpara">
...
<div class="phpcode"><code><span style="color: #000000">&lt;pre&gt;<br /><span style="color: #0000BB">&lt;?php<br />print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">wincache_scache_info</span><span style="color: #007700">());<br /></span><span style="color: #0000BB">?&gt;<br /></span>&lt;/pre&gt;</span></code></div>
    </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.wincache-scache-meminfo.php" class="function" rel="rdfs-seeAlso">wincache_scache_meminfo()</a> - Retrieves information about session cache memory usage</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-scache-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-scache-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-scache-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-scache-info.php">＋<small>add a note</small></a></span>
