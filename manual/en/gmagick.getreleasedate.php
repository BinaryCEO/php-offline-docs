...
<head>
  ...
  <title>PHP: Gmagick::getreleasedate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getreleasedate.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getreleasedate.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getreleasedate.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getquantumdepth.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getsamplingfactors.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getreleasedate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getreleasedate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getreleasedate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getreleasedate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getreleasedate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getreleasedate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getreleasedate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getreleasedate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getreleasedate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getreleasedate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getreleasedate.php" hreflang="zh">
...
<meta name="Description" content="Returns the GraphicsMagick release date as a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::getreleasedate - Manual" />
<meta name="twitter:description" content="Returns the GraphicsMagick release date as a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getreleasedate - Manual" />
<meta itemprop="description" content="Returns the GraphicsMagick release date as a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the GraphicsMagick release date as a string" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.getsamplingfactors.php">
          Gmagick::getsamplingfactors &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getquantumdepth.php">
          &laquo; Gmagick::getquantumdepth        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getreleasedate.php' selected="selected">English</option>
            <option value='de/gmagick.getreleasedate.php'>German</option>
            <option value='es/gmagick.getreleasedate.php'>Spanish</option>
            <option value='fr/gmagick.getreleasedate.php'>French</option>
            <option value='it/gmagick.getreleasedate.php'>Italian</option>
            <option value='ja/gmagick.getreleasedate.php'>Japanese</option>
            <option value='pt_BR/gmagick.getreleasedate.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getreleasedate.php'>Russian</option>
            <option value='tr/gmagick.getreleasedate.php'>Turkish</option>
            <option value='uk/gmagick.getreleasedate.php'>Ukrainian</option>
            <option value='zh/gmagick.getreleasedate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getreleasedate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getreleasedate</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getreleasedate</span> &mdash; <span class="dc-title">Returns the GraphicsMagick release date as a string</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getreleasedate-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getreleasedate</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getreleasedate-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getreleasedate-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getreleasedate-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getreleasedate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getreleasedate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getreleasedate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getreleasedate.php">＋<small>add a note</small></a></span>
