...
<head>
  ...
  <title>PHP: imap_savebody - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-savebody.php">
 <link rel="shorturl" href="https://www.php.net/imap-savebody">
 <link rel="alternate" href="https://www.php.net/imap-savebody" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-rfc822-write-address.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-scan.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-savebody.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-savebody.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-savebody.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-savebody.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-savebody.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-savebody.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-savebody.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-savebody.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-savebody.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-savebody.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-savebody.php" hreflang="zh">
...
<meta name="Description" content="Save a specific body section to a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_savebody - Manual" />
<meta name="twitter:description" content="Save a specific body section to a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_savebody - Manual" />
<meta itemprop="description" content="Save a specific body section to a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Save a specific body section to a file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-rfc822-write-address.php">
          &laquo; imap_rfc822_write_address        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-savebody.php' selected="selected">English</option>
            <option value='de/function.imap-savebody.php'>German</option>
            <option value='es/function.imap-savebody.php'>Spanish</option>
            <option value='fr/function.imap-savebody.php'>French</option>
            <option value='it/function.imap-savebody.php'>Italian</option>
            <option value='ja/function.imap-savebody.php'>Japanese</option>
            <option value='pt_BR/function.imap-savebody.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-savebody.php'>Russian</option>
            <option value='tr/function.imap-savebody.php'>Turkish</option>
            <option value='uk/function.imap-savebody.php'>Ukrainian</option>
            <option value='zh/function.imap-savebody.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-savebody" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-fetchbody.php" class="function" rel="rdfs-seeAlso">imap_fetchbody()</a> - Fetch a particular section of the body of the message</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-savebody.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-savebody%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-savebody&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-savebody.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="109704">  <div class="votes">
    <div id="Vu109704">
    <a href="/manual/vote-note.php?id=109704&amp;page=function.imap-savebody&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd109704">
    <a href="/manual/vote-note.php?id=109704&amp;page=function.imap-savebody&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V109704" title="84% like this...">
    13
    </div>
  </div>
  <a href="#109704" class="name">
  <strong class="user"><em>anon</em></strong></a><a class="genanchor" href="#109704"> &para;</a><div class="date" title="2012-08-12 01:59"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109704">
<div class="phpcode"><code><span class="html">By using imap_fetchbody() you may run in trouble by using too much memory. Using imap_savebody() may prevent this. 
<br />
...
<br /></span>
<br />NOTE: To find the proper filter you need to check the encoding given by the structure of the body.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-savebody&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-savebody.php">＋<small>add a note</small></a></div>
