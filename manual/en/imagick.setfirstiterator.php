...
<head>
  ...
  <title>PHP: Imagick::setFirstIterator - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setfirstiterator.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setfirstiterator.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setfirstiterator.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setfilename.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setfont.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setfirstiterator.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setfirstiterator.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setfirstiterator.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setfirstiterator.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setfirstiterator.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setfirstiterator.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setfirstiterator.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setfirstiterator.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setfirstiterator.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setfirstiterator.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setfirstiterator.php" hreflang="zh">
...
<meta name="Description" content="Sets the Imagick iterator to the first image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setFirstIterator - Manual" />
<meta name="twitter:description" content="Sets the Imagick iterator to the first image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setFirstIterator - Manual" />
<meta itemprop="description" content="Sets the Imagick iterator to the first image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the Imagick iterator to the first image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setfont.php">
          Imagick::setFont &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setfilename.php">
          &laquo; Imagick::setFilename        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setfirstiterator.php' selected="selected">English</option>
            <option value='de/imagick.setfirstiterator.php'>German</option>
            <option value='es/imagick.setfirstiterator.php'>Spanish</option>
            <option value='fr/imagick.setfirstiterator.php'>French</option>
            <option value='it/imagick.setfirstiterator.php'>Italian</option>
            <option value='ja/imagick.setfirstiterator.php'>Japanese</option>
            <option value='pt_BR/imagick.setfirstiterator.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setfirstiterator.php'>Russian</option>
            <option value='tr/imagick.setfirstiterator.php'>Turkish</option>
            <option value='uk/imagick.setfirstiterator.php'>Ukrainian</option>
            <option value='zh/imagick.setfirstiterator.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setfirstiterator" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setFirstIterator</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setFirstIterator</span> &mdash; <span class="dc-title">Sets the Imagick iterator to the first image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setfirstiterator-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setFirstIterator</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setfirstiterator-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.setfirstiterator-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setfirstiterator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setfirstiterator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setfirstiterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setfirstiterator.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124852">  <div class="votes">
    <div id="Vu124852">
    <a href="/manual/vote-note.php?id=124852&amp;page=imagick.setfirstiterator&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124852">
    <a href="/manual/vote-note.php?id=124852&amp;page=imagick.setfirstiterator&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124852" title="100% like this...">
    2
    </div>
  </div>
  <a href="#124852" class="name">
  <strong class="user"><em>simonjjarrett at gmail dot com</em></strong></a><a class="genanchor" href="#124852"> &para;</a><div class="date" title="2020-03-24 01:03"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124852">
<div class="phpcode"><code><span class="html">The following function applies a callback to each image in an Imagick object.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">imagickMap</span><span class="keyword">(</span><span class="default">$callback</span><span class="keyword">, </span><span class="default">$im</span><span class="keyword">)<br />{<br />    </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setFirstIterator</span><span class="keyword">();<br /><br />    do<br />    {<br />        </span><span class="default">$callback</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">);<br />    }<br />    while ( </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">nextImage</span><span class="keyword">() );<br />}<br /></span><span class="default">?&gt;<br /></span><br />E.g. to convert a series of images to grayscale:<br /><br /><span class="default">&lt;?php<br />imagickMap</span><span class="keyword">(<br />    function(</span><span class="default">$im</span><span class="keyword">)<br />    {<br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageType</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_GRAYSCALEMATTE</span><span class="keyword">);<br />    },<br />    </span><span class="default">$im<br /></span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setfirstiterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setfirstiterator.php">＋<small>add a note</small></a></div>
