...
<head>
  ...
  <title>PHP: imap_rfc822_parse_adrlist - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-rfc822-parse-adrlist.php">
 <link rel="shorturl" href="https://www.php.net/imap-rfc822-parse-adrlist">
 <link rel="alternate" href="https://www.php.net/imap-rfc822-parse-adrlist" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-reopen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-rfc822-parse-headers.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-rfc822-parse-adrlist.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-rfc822-parse-adrlist.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-rfc822-parse-adrlist.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-rfc822-parse-adrlist.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-rfc822-parse-adrlist.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-rfc822-parse-adrlist.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-rfc822-parse-adrlist.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-rfc822-parse-adrlist.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-rfc822-parse-adrlist.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-rfc822-parse-adrlist.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-rfc822-parse-adrlist.php" hreflang="zh">
...
<meta name="Description" content="Parses an address string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_rfc822_parse_adrlist - Manual" />
<meta name="twitter:description" content="Parses an address string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_rfc822_parse_adrlist - Manual" />
<meta itemprop="description" content="Parses an address string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Parses an address string" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-rfc822-parse-headers.php">
          imap_rfc822_parse_headers &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-rfc822-parse-adrlist.php' selected="selected">English</option>
            <option value='de/function.imap-rfc822-parse-adrlist.php'>German</option>
            <option value='es/function.imap-rfc822-parse-adrlist.php'>Spanish</option>
            <option value='fr/function.imap-rfc822-parse-adrlist.php'>French</option>
            <option value='it/function.imap-rfc822-parse-adrlist.php'>Italian</option>
            <option value='ja/function.imap-rfc822-parse-adrlist.php'>Japanese</option>
            <option value='pt_BR/function.imap-rfc822-parse-adrlist.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-rfc822-parse-adrlist.php'>Russian</option>
            <option value='tr/function.imap-rfc822-parse-adrlist.php'>Turkish</option>
            <option value='uk/function.imap-rfc822-parse-adrlist.php'>Ukrainian</option>
            <option value='zh/function.imap-rfc822-parse-adrlist.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-rfc822-parse-adrlist" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_rfc822_parse_adrlist</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_rfc822_parse_adrlist</span> &mdash; <span class="dc-title">Parses an address string</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-rfc822-parse-adrlist-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_rfc822_parse_adrlist</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$default_hostname</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   Parses the address string as defined in <a href="https://datatracker.ietf.org/doc/html/rfc2822" class="link external">&raquo;&nbsp;RFC2822</a> and for each address.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imap-rfc822-parse-adrlist-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-rfc822-parse-adrlist-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.imap-rfc822-parse-adrlist-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3245">
    <p><strong>Example #1 <span class="function"><strong>imap_rfc822_parse_adrlist()</strong></span> example</strong></p>
...
# 2
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-rfc822-parse-adrlist-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-rfc822-parse-headers.php" class="function" rel="rdfs-seeAlso">imap_rfc822_parse_headers()</a> - Parse mail headers from a string</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-rfc822-parse-adrlist.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-rfc822-parse-adrlist%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-rfc822-parse-adrlist&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-rfc822-parse-adrlist.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="48678">  <div class="votes">
    <div id="Vu48678">
    <a href="/manual/vote-note.php?id=48678&amp;page=function.imap-rfc822-parse-adrlist&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd48678">
    <a href="/manual/vote-note.php?id=48678&amp;page=function.imap-rfc822-parse-adrlist&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V48678" title="66% like this...">
    1
    </div>
  </div>
  <a href="#48678" class="name">
  <strong class="user"><em>Rainer Perske</em></strong></a><a class="genanchor" href="#48678"> &para;</a><div class="date" title="2005-01-04 08:20"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom48678">
<div class="phpcode"><code><span class="html">Invalid addresses, if detected, set host to '.SYNTAX-ERROR.'; but not all invalid addresses get detected as such, e.g. &lt;.@host.do.main&gt; is considered<br />valid though a single dot is not a valid local part without using quotation marks.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-rfc822-parse-adrlist&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-rfc822-parse-adrlist.php">＋<small>add a note</small></a></div>
