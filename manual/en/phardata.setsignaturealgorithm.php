...
<head>
  ...
  <title>PHP: PharData::setSignatureAlgorithm - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phardata.setsignaturealgorithm.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phardata.setsignaturealgorithm.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phardata.setsignaturealgorithm.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phardata.php">
 <link rel="prev" href="https://www.php.net/manual/en/phardata.setmetadata.php">
 <link rel="next" href="https://www.php.net/manual/en/phardata.setstub.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phardata.setsignaturealgorithm.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phardata.setsignaturealgorithm.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phardata.setsignaturealgorithm.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phardata.setsignaturealgorithm.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phardata.setsignaturealgorithm.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phardata.setsignaturealgorithm.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phardata.setsignaturealgorithm.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phardata.setsignaturealgorithm.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phardata.setsignaturealgorithm.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phardata.setsignaturealgorithm.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phardata.setsignaturealgorithm.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: PharData::setSignatureAlgorithm - Manual" />
<meta name="twitter:description" content="Set the signature algorithm for a phar and apply it" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PharData::setSignatureAlgorithm - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phardata.setstub.php">
          PharData::setStub &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phardata.setmetadata.php">
          &laquo; PharData::setMetadata        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phardata.setsignaturealgorithm.php' selected="selected">English</option>
            <option value='de/phardata.setsignaturealgorithm.php'>German</option>
            <option value='es/phardata.setsignaturealgorithm.php'>Spanish</option>
            <option value='fr/phardata.setsignaturealgorithm.php'>French</option>
            <option value='it/phardata.setsignaturealgorithm.php'>Italian</option>
            <option value='ja/phardata.setsignaturealgorithm.php'>Japanese</option>
            <option value='pt_BR/phardata.setsignaturealgorithm.php'>Brazilian Portuguese</option>
            <option value='ru/phardata.setsignaturealgorithm.php'>Russian</option>
            <option value='tr/phardata.setsignaturealgorithm.php'>Turkish</option>
            <option value='uk/phardata.setsignaturealgorithm.php'>Ukrainian</option>
            <option value='zh/phardata.setsignaturealgorithm.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phardata.setsignaturealgorithm" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.getsignature.php" class="function" rel="rdfs-seeAlso">Phar::getSignature()</a> - Return MD5/SHA1/SHA256/SHA512/OpenSSL signature of a Phar archive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/PharData/setSignatureAlgorithm.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphardata.setsignaturealgorithm%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phardata.setsignaturealgorithm&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.setsignaturealgorithm.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="104424">  <div class="votes">
    <div id="Vu104424">
    <a href="/manual/vote-note.php?id=104424&amp;page=phardata.setsignaturealgorithm&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104424">
    <a href="/manual/vote-note.php?id=104424&amp;page=phardata.setsignaturealgorithm&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104424" title="100% like this...">
    3
    </div>
  </div>
  <a href="#104424" class="name">
  <strong class="user"><em>obsidian[at-nospam]codebite[dot]net</em></strong></a><a class="genanchor" href="#104424"> &para;</a><div class="date" title="2011-06-14 02:06"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104424">
<div class="phpcode"><code><span class="html">As a note, the docs don't show the (optional) second parameter nor mention the existence of the Phar::OPENSSL class constant also available for use with this method.<br /><br />To sign a phar with OpenSSL, for example...<br /><br /><span class="default">&lt;?php<br /><br />$phar </span><span class="keyword">= new </span><span class="default">Phar</span><span class="keyword">(</span><span class="string">'somephar.phar'</span><span class="keyword">);<br /></span><span class="comment">// ... add your files and such<br /></span><span class="default">$phar</span><span class="keyword">-&gt;</span><span class="default">setSignatureAlgorithm</span><span class="keyword">(</span><span class="default">Phar</span><span class="keyword">::</span><span class="default">OPENSSL</span><span class="keyword">, </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="string">'private_key_here.pem'</span><span class="keyword">));<br /></span><span class="comment">// ... do whatever else you want afterwards here ...<br /></span><span class="default">?&gt;<br /></span><br />Hope this proves useful to someone.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phardata.setsignaturealgorithm&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.setsignaturealgorithm.php">＋<small>add a note</small></a></div>
