...
<head>
  ...
  <title>PHP: SolrQuery::getExpandFilterQueries - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getexpandfilterqueries.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getexpandfilterqueries.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getexpandfilterqueries.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getexpand.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getexpandquery.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getexpandfilterqueries.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getexpandfilterqueries.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getexpandfilterqueries.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getexpandfilterqueries.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getexpandfilterqueries.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getexpandfilterqueries.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getexpandfilterqueries.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getexpandfilterqueries.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getexpandfilterqueries.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getexpandfilterqueries.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getexpandfilterqueries.php" hreflang="zh">
...
<meta name="Description" content="Returns the expand filter queries" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getExpandFilterQueries - Manual" />
<meta name="twitter:description" content="Returns the expand filter queries" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getExpandFilterQueries - Manual" />
<meta itemprop="description" content="Returns the expand filter queries" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the expand filter queries" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getexpandquery.php">
          SolrQuery::getExpandQuery &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getexpand.php">
          &laquo; SolrQuery::getExpand        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getexpandfilterqueries.php' selected="selected">English</option>
            <option value='de/solrquery.getexpandfilterqueries.php'>German</option>
            <option value='es/solrquery.getexpandfilterqueries.php'>Spanish</option>
            <option value='fr/solrquery.getexpandfilterqueries.php'>French</option>
            <option value='it/solrquery.getexpandfilterqueries.php'>Italian</option>
            <option value='ja/solrquery.getexpandfilterqueries.php'>Japanese</option>
            <option value='pt_BR/solrquery.getexpandfilterqueries.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getexpandfilterqueries.php'>Russian</option>
            <option value='tr/solrquery.getexpandfilterqueries.php'>Turkish</option>
            <option value='uk/solrquery.getexpandfilterqueries.php'>Ukrainian</option>
            <option value='zh/solrquery.getexpandfilterqueries.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getexpandfilterqueries" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getExpandFilterQueries</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getExpandFilterQueries</span> &mdash; <span class="dc-title">Returns the expand filter queries</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getexpandfilterqueries-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getExpandFilterQueries</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getexpandfilterqueries-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getexpandfilterqueries-returnvalues">
  ...
  <p class="para">
   Returns the expand filter queries.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getexpandfilterqueries.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getexpandfilterqueries%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getexpandfilterqueries&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getexpandfilterqueries.php">＋<small>add a note</small></a></span>
