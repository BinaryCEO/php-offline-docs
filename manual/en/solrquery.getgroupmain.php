...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getgroupmain.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getgroupmain.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupmain.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getgrouplimit.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getgroupngroups.php">
...
<meta name="Description" content="Returns the group.main value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getGroupMain - Manual" />
<meta name="twitter:description" content="Returns the group.main value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getGroupMain - Manual" />
<meta itemprop="description" content="Returns the group.main value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the group.main value" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getgroupmain.php' selected="selected">English</option>
            <option value='de/solrquery.getgroupmain.php'>German</option>
            <option value='es/solrquery.getgroupmain.php'>Spanish</option>
            <option value='fr/solrquery.getgroupmain.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getGroupMain</span> &mdash; <span class="dc-title">Returns the group.main value</span></p>
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.setgroupmain.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupMain()</a> - If true, the result of the first field grouping command is used as the main result list in the response, using group.format=simple</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getgroupmain.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getgroupmain%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getgroupmain&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getgroupmain.php">＋<small>add a note</small></a></span>
