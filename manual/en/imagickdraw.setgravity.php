...
<head>
  ...
  <title>PHP: ImagickDraw::setGravity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setgravity.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setgravity.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setgravity.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setfontweight.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setresolution.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setgravity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setgravity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setgravity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setgravity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setgravity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setgravity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setgravity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setgravity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setgravity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setgravity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setgravity.php" hreflang="zh">
...
<meta name="Description" content="Sets the text placement gravity" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setGravity - Manual" />
<meta name="twitter:description" content="Sets the text placement gravity" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setGravity - Manual" />
<meta itemprop="description" content="Sets the text placement gravity" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the text placement gravity" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.setresolution.php">
          ImagickDraw::setResolution &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setfontweight.php">
          &laquo; ImagickDraw::setFontWeight        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setgravity.php' selected="selected">English</option>
            <option value='de/imagickdraw.setgravity.php'>German</option>
            <option value='es/imagickdraw.setgravity.php'>Spanish</option>
            <option value='fr/imagickdraw.setgravity.php'>French</option>
            <option value='it/imagickdraw.setgravity.php'>Italian</option>
            <option value='ja/imagickdraw.setgravity.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setgravity.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setgravity.php'>Russian</option>
            <option value='tr/imagickdraw.setgravity.php'>Turkish</option>
            <option value='uk/imagickdraw.setgravity.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setgravity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setgravity" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setGravity</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setGravity</span> &mdash; <span class="dc-title">Sets the text placement gravity</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setgravity-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setGravity</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$gravity</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setgravity-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">gravity</code></dt>
     <dd>
      <p class="para">
       One of the <a href="imagick.constants.php#imagick.constants.gravity" class="link">GRAVITY</a> constant
       (<code class="literal">imagick::GRAVITY_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setgravity-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3180">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setgravity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setgravity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setgravity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setgravity.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="77404">  <div class="votes">
    <div id="Vu77404">
    <a href="/manual/vote-note.php?id=77404&amp;page=imagickdraw.setgravity&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd77404">
    <a href="/manual/vote-note.php?id=77404&amp;page=imagickdraw.setgravity&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V77404" title="100% like this...">
    5
    </div>
  </div>
  <a href="#77404" class="name">
  <strong class="user"><em>alan at ridersite dot org</em></strong></a><a class="genanchor" href="#77404"> &para;</a><div class="date" title="2007-08-28 07:51"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom77404">
<div class="phpcode"><code><span class="html">Gravity constants are very useful as they can save having to calculate the placement of variable text strings and font sizes.<br /><br />For example: <br />$draw-&gt;setGravity (Imagick::GRAVITY_CENTER);<br />$image-&gt;annotateImage($draw, 0, 0, 0, 'The quick brown fox jumps over the lazy dog');<br /><br />Will horizontally and vertically center the text string.<br /><br />Note, there are several gravity constants available. See, Constants — Imagick class constants</span></code></div>
  </div>
 </div>
  <div class="note" id="113218">  <div class="votes">
    <div id="Vu113218">
    <a href="/manual/vote-note.php?id=113218&amp;page=imagickdraw.setgravity&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113218">
    <a href="/manual/vote-note.php?id=113218&amp;page=imagickdraw.setgravity&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113218" title="33% like this...">
    -2
    </div>
  </div>
  <a href="#113218" class="name">
  <strong class="user"><em>bcre8ve at gmail dot com</em></strong></a><a class="genanchor" href="#113218"> &para;</a><div class="date" title="2013-09-13 02:15"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom113218">
<div class="phpcode"><code><span class="html">It appears that the GRAVITY constants have an integer equivalent:<br />NORTHWEST = 1<br />NORTH = 2<br />NORTHEAST = 3<br />WEST = 4 <br />CENTER = 5<br />EAST = 6<br />SOUTHWEST = 7<br />SOUTH = 8<br />SOUTHEAST = 9</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.setgravity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setgravity.php">＋<small>add a note</small></a></div>
