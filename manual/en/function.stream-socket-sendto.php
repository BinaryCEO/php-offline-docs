...
<head>
  ...
  <title>PHP: stream_socket_sendto - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-socket-sendto.php">
 <link rel="shorturl" href="https://www.php.net/stream-socket-sendto">
 <link rel="alternate" href="https://www.php.net/stream-socket-sendto" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-socket-recvfrom.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-socket-server.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-socket-sendto.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-socket-sendto.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-socket-sendto.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-socket-sendto.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-socket-sendto.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-socket-sendto.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-socket-sendto.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-socket-sendto.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-socket-sendto.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-socket-sendto.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-socket-sendto.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: stream_socket_sendto - Manual" />
<meta name="twitter:description" content="Sends a message to a socket, whether it is connected or not" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_socket_sendto - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-socket-server.php">
          stream_socket_server &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-socket-recvfrom.php">
          &laquo; stream_socket_recvfrom        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-socket-sendto.php' selected="selected">English</option>
            <option value='de/function.stream-socket-sendto.php'>German</option>
            <option value='es/function.stream-socket-sendto.php'>Spanish</option>
            <option value='fr/function.stream-socket-sendto.php'>French</option>
            <option value='it/function.stream-socket-sendto.php'>Italian</option>
            <option value='ja/function.stream-socket-sendto.php'>Japanese</option>
            <option value='pt_BR/function.stream-socket-sendto.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-socket-sendto.php'>Russian</option>
            <option value='tr/function.stream-socket-sendto.php'>Turkish</option>
            <option value='uk/function.stream-socket-sendto.php'>Ukrainian</option>
            <option value='zh/function.stream-socket-sendto.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-socket-sendto" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stream_socket_sendto</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_socket_sendto</span> &mdash; <span class="dc-title">Sends a message to a socket, whether it is connected or not</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stream-socket-sendto-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stream_socket_sendto</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$socket</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$address</code><span class="initializer"> = &quot;&quot;</span></span><br>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stream-socket-sendto-returnvalues">
  ...
  <p class="para">
   Returns a result code, as an integer, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Open a socket to port 1234 on localhost */<br /></span><span style="color: #0000BB">$socket </span><span style="color: #007700">= </span><span style="color: #0000BB">stream_socket_client</span><span style="color: #007700">(</span><span style="color: #DD0000">'tcp://127.0.0.1:1234'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Send ordinary data via ordinary channels. */<br /></span><span style="color: #0000BB">fwrite</span><span style="color: #007700">(</span><span style="color: #0000BB">$socket</span><span style="color: #007700">, </span><span style="color: #DD0000">"Normal data transmit."</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Send more data out of band. */<br /></span><span style="color: #0000BB">stream_socket_sendto</span><span style="color: #007700">(</span><span style="color: #0000BB">$socket</span><span style="color: #007700">, </span><span style="color: #DD0000">"Out of Band data."</span><span style="color: #007700">, </span><span style="color: #0000BB">STREAM_OOB</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Close it up */<br /></span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$socket</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.stream-socket-sendto-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.stream-socket-recvfrom.php" class="function" rel="rdfs-seeAlso">stream_socket_recvfrom()</a> - Receives data from a socket, connected or not</span></li>
   ...
   <li><span class="function"><a href="function.stream-socket-server.php" class="function" rel="rdfs-seeAlso">stream_socket_server()</a> - Create an Internet or Unix domain server socket</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-socket-sendto.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-socket-sendto%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-socket-sendto&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-socket-sendto.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="112664">  <div class="votes">
    <div id="Vu112664">
    <a href="/manual/vote-note.php?id=112664&amp;page=function.stream-socket-sendto&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112664">
    <a href="/manual/vote-note.php?id=112664&amp;page=function.stream-socket-sendto&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112664" title="71% like this...">
    9
    </div>
  </div>
  <a href="#112664" class="name">
  <strong class="user"><em>mrforsythexeter at googlemail dot com</em></strong></a><a class="genanchor" href="#112664"> &para;</a><div class="date" title="2013-07-10 04:07"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112664">
<div class="phpcode"><code><span class="html">The return appears to be the size in bytes of the data written to the socket, or -1 on failure (this could be because of non blocking)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stream-socket-sendto&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-socket-sendto.php">＋<small>add a note</small></a></div>
