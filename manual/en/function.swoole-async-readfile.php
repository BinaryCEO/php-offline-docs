...
<head>
  ...
  <title>PHP: swoole_async_readfile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.swoole-async-readfile.php">
 <link rel="shorturl" href="https://www.php.net/swoole-async-readfile">
 <link rel="alternate" href="https://www.php.net/swoole-async-readfile" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.swoole-funcs.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.swoole-async-read.php">
 <link rel="next" href="https://www.php.net/manual/en/function.swoole-async-set.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.swoole-async-readfile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.swoole-async-readfile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.swoole-async-readfile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.swoole-async-readfile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.swoole-async-readfile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.swoole-async-readfile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.swoole-async-readfile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.swoole-async-readfile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.swoole-async-readfile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.swoole-async-readfile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.swoole-async-readfile.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: swoole_async_readfile - Manual" />
<meta name="twitter:description" content="Read a file asynchronously" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: swoole_async_readfile - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.swoole-async-set.php">
          swoole_async_set &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.swoole-async-read.php">
          &laquo; swoole_async_read        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.swoole-async-readfile.php' selected="selected">English</option>
            <option value='de/function.swoole-async-readfile.php'>German</option>
            <option value='es/function.swoole-async-readfile.php'>Spanish</option>
            <option value='fr/function.swoole-async-readfile.php'>French</option>
            <option value='it/function.swoole-async-readfile.php'>Italian</option>
            <option value='ja/function.swoole-async-readfile.php'>Japanese</option>
            <option value='pt_BR/function.swoole-async-readfile.php'>Brazilian Portuguese</option>
            <option value='ru/function.swoole-async-readfile.php'>Russian</option>
            <option value='tr/function.swoole-async-readfile.php'>Turkish</option>
            <option value='uk/function.swoole-async-readfile.php'>Ukrainian</option>
            <option value='zh/function.swoole-async-readfile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.swoole-async-readfile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">swoole_async_readfile</h1>
  <p class="verinfo">(PECL swoole &gt;= 1.9.0)</p><p class="refpurpose"><span class="refname">swoole_async_readfile</span> &mdash; <span class="dc-title">Read a file asynchronously</span></p>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/swoole/functions/swoole-async-readfile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.swoole-async-readfile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.swoole-async-readfile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.swoole-async-readfile.php">＋<small>add a note</small></a></span>
