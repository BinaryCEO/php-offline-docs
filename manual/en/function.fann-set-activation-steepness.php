...
<head>
  ...
  <title>PHP: fann_set_activation_steepness - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-activation-steepness.php">
 <link rel="shorturl" href="https://www.php.net/fann-set-activation-steepness">
 <link rel="alternate" href="https://www.php.net/fann-set-activation-steepness" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-activation-function-output.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-activation-steepness-hidden.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-set-activation-steepness.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-set-activation-steepness.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-set-activation-steepness.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-set-activation-steepness.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-set-activation-steepness.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-set-activation-steepness.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-set-activation-steepness.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-set-activation-steepness.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-set-activation-steepness.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-set-activation-steepness.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-set-activation-steepness.php" hreflang="zh">
...
<meta name="Description" content="Sets the activation steepness for supplied neuron and layer number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_activation_steepness - Manual" />
<meta name="twitter:description" content="Sets the activation steepness for supplied neuron and layer number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_activation_steepness - Manual" />
<meta itemprop="description" content="Sets the activation steepness for supplied neuron and layer number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the activation steepness for supplied neuron and layer number" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-set-activation-steepness-hidden.php">
          fann_set_activation_steepness_hidden &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-set-activation-function-output.php">
          &laquo; fann_set_activation_function_output        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-activation-steepness.php' selected="selected">English</option>
            <option value='de/function.fann-set-activation-steepness.php'>German</option>
            <option value='es/function.fann-set-activation-steepness.php'>Spanish</option>
            <option value='fr/function.fann-set-activation-steepness.php'>French</option>
            <option value='it/function.fann-set-activation-steepness.php'>Italian</option>
            <option value='ja/function.fann-set-activation-steepness.php'>Japanese</option>
            <option value='pt_BR/function.fann-set-activation-steepness.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-set-activation-steepness.php'>Russian</option>
            <option value='tr/function.fann-set-activation-steepness.php'>Turkish</option>
            <option value='uk/function.fann-set-activation-steepness.php'>Ukrainian</option>
            <option value='zh/function.fann-set-activation-steepness.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-set-activation-steepness" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-set-activation-function.php" class="function" rel="rdfs-seeAlso">fann_set_activation_function()</a> - Sets the activation function for supplied neuron and layer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-activation-steepness.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-activation-steepness%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-activation-steepness&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-activation-steepness.php">＋<small>add a note</small></a></span>
