...
<head>
  ...
  <title>PHP: method_exists - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.method-exists.php">
 <link rel="shorturl" href="https://www.php.net/method-exists">
 <link rel="alternate" href="https://www.php.net/method-exists" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.classobj.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.is-subclass-of.php">
 <link rel="next" href="https://www.php.net/manual/en/function.property-exists.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.method-exists.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.method-exists.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.method-exists.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.method-exists.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.method-exists.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.method-exists.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.method-exists.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.method-exists.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.method-exists.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.method-exists.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.method-exists.php" hreflang="zh">
...
<meta name="Description" content="Checks if the class method exists" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: method_exists - Manual" />
<meta name="twitter:description" content="Checks if the class method exists" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: method_exists - Manual" />
<meta itemprop="description" content="Checks if the class method exists" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if the class method exists" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.property-exists.php">
          property_exists &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.is-subclass-of.php">
          &laquo; is_subclass_of        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.method-exists.php' selected="selected">English</option>
            <option value='de/function.method-exists.php'>German</option>
            <option value='es/function.method-exists.php'>Spanish</option>
            <option value='fr/function.method-exists.php'>French</option>
            <option value='it/function.method-exists.php'>Italian</option>
            <option value='ja/function.method-exists.php'>Japanese</option>
            <option value='pt_BR/function.method-exists.php'>Brazilian Portuguese</option>
            <option value='ru/function.method-exists.php'>Russian</option>
            <option value='tr/function.method-exists.php'>Turkish</option>
            <option value='uk/function.method-exists.php'>Ukrainian</option>
            <option value='zh/function.method-exists.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.method-exists" class="refentry">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>7.4.0</td>
      <td>
       Class checks against inherited private methods now return <code class="parameter">false</code>.
      </td>
     </tr>
 ...
 <div class="refsect1 examples" id="refsect1-function.method-exists-examples">
  ...
  <p class="para">
   <div class="example" id="example-5359">
...
<div class="examplescode"><pre class="examplescode">bool(true)</pre>
   ...
   <div class="example" id="example-5360">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.class-exists.php" class="function" rel="rdfs-seeAlso">class_exists()</a> - Checks if the class has been defined</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/classobj/functions/method-exists.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.method-exists%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.method-exists&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.method-exists.php">＋<small>add a note</small></a></span>
