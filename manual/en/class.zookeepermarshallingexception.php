...
<head>
  ...
  <title>PHP: ZookeeperMarshallingException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.zookeepermarshallingexception.php">
 <link rel="shorturl" href="https://www.php.net/zookeepermarshallingexception">
 <link rel="alternate" href="https://www.php.net/zookeepermarshallingexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.zookeeper.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.zookeeperconnectionexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.zookeepernonodeexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.zookeepermarshallingexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.zookeepermarshallingexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.zookeepermarshallingexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.zookeepermarshallingexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.zookeepermarshallingexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.zookeepermarshallingexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.zookeepermarshallingexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.zookeepermarshallingexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.zookeepermarshallingexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.zookeepermarshallingexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.zookeepermarshallingexception.php" hreflang="zh">
...
<meta name="Description" content="The ZookeeperMarshallingException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZookeeperMarshallingException - Manual" />
<meta name="twitter:description" content="The ZookeeperMarshallingException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZookeeperMarshallingException - Manual" />
<meta itemprop="description" content="The ZookeeperMarshallingException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ZookeeperMarshallingException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.zookeepernonodeexception.php">
          ZookeeperNoNodeException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.zookeeperconnectionexception.php">
          &laquo; ZookeeperConnectionException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.zookeepermarshallingexception.php' selected="selected">English</option>
            <option value='de/class.zookeepermarshallingexception.php'>German</option>
            <option value='es/class.zookeepermarshallingexception.php'>Spanish</option>
            <option value='fr/class.zookeepermarshallingexception.php'>French</option>
            <option value='it/class.zookeepermarshallingexception.php'>Italian</option>
            <option value='ja/class.zookeepermarshallingexception.php'>Japanese</option>
            <option value='pt_BR/class.zookeepermarshallingexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.zookeepermarshallingexception.php'>Russian</option>
            <option value='tr/class.zookeepermarshallingexception.php'>Turkish</option>
            <option value='uk/class.zookeepermarshallingexception.php'>Ukrainian</option>
            <option value='zh/class.zookeepermarshallingexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.zookeepermarshallingexception" class="reference">
 <h1 class="title">The ZookeeperMarshallingException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PECL zookeeper &gt;= 0.3.0)</p>
 

  <div class="section" id="zookeepermarshallingexception.intro">
  ...
  <div class="section" id="zookeepermarshallingexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">ZookeeperMarshallingException</strong>
     </span>
     <span class="ooclass">
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeepermarshallingexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.zookeepermarshallingexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.zookeepermarshallingexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.zookeepermarshallingexception.php">＋<small>add a note</small></a></span>
