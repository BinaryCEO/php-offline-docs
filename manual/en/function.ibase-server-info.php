...
<head>
  ...
  <title>PHP: ibase_server_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-server-info.php">
 <link rel="shorturl" href="https://www.php.net/ibase-server-info">
 <link rel="alternate" href="https://www.php.net/ibase-server-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-rollback-ret.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-service-attach.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-server-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-server-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-server-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-server-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-server-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-server-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-server-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-server-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-server-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-server-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-server-info.php" hreflang="zh">
...
<meta name="Description" content="Request information about a database server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_server_info - Manual" />
<meta name="twitter:description" content="Request information about a database server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_server_info - Manual" />
<meta itemprop="description" content="Request information about a database server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Request information about a database server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-service-attach.php">
          ibase_service_attach &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-rollback-ret.php">
          &laquo; ibase_rollback_ret        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-server-info.php' selected="selected">English</option>
            <option value='de/function.ibase-server-info.php'>German</option>
            <option value='es/function.ibase-server-info.php'>Spanish</option>
            <option value='fr/function.ibase-server-info.php'>French</option>
            <option value='it/function.ibase-server-info.php'>Italian</option>
            <option value='ja/function.ibase-server-info.php'>Japanese</option>
            <option value='pt_BR/function.ibase-server-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-server-info.php'>Russian</option>
            <option value='tr/function.ibase-server-info.php'>Turkish</option>
            <option value='uk/function.ibase-server-info.php'>Ukrainian</option>
            <option value='zh/function.ibase-server-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-server-info" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_server_info</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_server_info</span> &mdash; <span class="dc-title">Request information about a database server</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-server-info-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_server_info</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$service_handle</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$action</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

 </div>

 
 <div class="refsect1 parameters" id="refsect1-function.ibase-server-info-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-server-info-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.ibase-server-info-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1334">
    <p><strong>Example #1 <span class="function"><a href="function.ibase-service-attach.php" class="function">ibase_service_attach()</a></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />    </span><span style="color: #FF8000">// Attach to the remote Firebird server<br />    </span><span style="color: #007700">if ((</span><span style="color: #0000BB">$service </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_service_attach</span><span style="color: #007700">(</span><span style="color: #DD0000">'10.1.1.254/3050'</span><span style="color: #007700">, </span><span style="color: #DD0000">'sysdba'</span><span style="color: #007700">, </span><span style="color: #DD0000">'masterkey'</span><span style="color: #007700">)) != </span><span style="color: #0000BB">FALSE</span><span style="color: #007700">) {<br /><br />        </span><span style="color: #FF8000">// Successfully attached.<br /><br />        // Output the info<br />        </span><span style="color: #007700">echo </span><span style="color: #DD0000">"Server version: " </span><span style="color: #007700">. </span><span style="color: #0000BB">ibase_server_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_SVC_SERVER_VERSION</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Server implementation: " </span><span style="color: #007700">. </span><span style="color: #0000BB">ibase_server_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_SVC_IMPLEMENTATION</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Server users: " </span><span style="color: #007700">. </span><span style="color: #0000BB">print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">ibase_server_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_SVC_GET_USERS</span><span style="color: #007700">), </span><span style="color: #0000BB">true</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Server directory: " </span><span style="color: #007700">. </span><span style="color: #0000BB">ibase_server_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_SVC_GET_ENV</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Server lock path: " </span><span style="color: #007700">. </span><span style="color: #0000BB">ibase_server_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_SVC_GET_ENV_LOCK</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Server lib path: " </span><span style="color: #007700">. </span><span style="color: #0000BB">ibase_server_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_SVC_GET_ENV_MSG</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Path of user db: " </span><span style="color: #007700">. </span><span style="color: #0000BB">ibase_server_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_SVC_USER_DBPATH</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Established connections: " </span><span style="color: #007700">. </span><span style="color: #0000BB">print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">ibase_server_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_SVC_SVR_DB_INFO</span><span style="color: #007700">),</span><span style="color: #0000BB">true</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br />        </span><span style="color: #FF8000">// Detach from server (disconnect)<br />        </span><span style="color: #0000BB">ibase_service_detach</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">);<br /><br />    }<br />    else {<br />        </span><span style="color: #FF8000">// Output message on error<br />        </span><span style="color: #0000BB">$conn_error </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_errmsg</span><span style="color: #007700">();<br />        die(</span><span style="color: #0000BB">$conn_error</span><span style="color: #007700">);<br />    }<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>

    <div class="example-contents"><p>The above example will output:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">Server version: LI-V3.0.4.33054 Firebird 3.0
...
(
    ...
    [1] =&gt; /srv/firebird/employees.fdb
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-server-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-server-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-server-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-server-info.php">＋<small>add a note</small></a></span>
