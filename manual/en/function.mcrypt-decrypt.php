...
<head>
  ...
  <title>PHP: mcrypt_decrypt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-decrypt.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-create-iv.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-enc-get-algorithms-name.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-decrypt.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-decrypt.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-decrypt.php" hreflang="uk">
...
<meta name="Description" content="Decrypts crypttext with given parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_decrypt - Manual" />
<meta name="twitter:description" content="Decrypts crypttext with given parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_decrypt - Manual" />
<meta itemprop="description" content="Decrypts crypttext with given parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decrypts crypttext with given parameters" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mcrypt-enc-get-algorithms-name.php">
          mcrypt_enc_get_algorithms_name &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-create-iv.php">
          &laquo; mcrypt_create_iv        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-decrypt.php' selected="selected">English</option>
            <option value='de/function.mcrypt-decrypt.php'>German</option>
            <option value='es/function.mcrypt-decrypt.php'>Spanish</option>
            <option value='fr/function.mcrypt-decrypt.php'>French</option>
            <option value='it/function.mcrypt-decrypt.php'>Italian</option>
            <option value='ja/function.mcrypt-decrypt.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-decrypt.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-decrypt.php'>Russian</option>
            <option value='tr/function.mcrypt-decrypt.php'>Turkish</option>
            <option value='uk/function.mcrypt-decrypt.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-decrypt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-decrypt" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mcrypt-encrypt.php" class="function" rel="rdfs-seeAlso">mcrypt_encrypt()</a> - Encrypts plaintext with given parameters</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-decrypt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-decrypt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-decrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-decrypt.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="54734">  <div class="votes">
    <div id="Vu54734">
    <a href="/manual/vote-note.php?id=54734&amp;page=function.mcrypt-decrypt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd54734">
    <a href="/manual/vote-note.php?id=54734&amp;page=function.mcrypt-decrypt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V54734" title="64% like this...">
    31
    </div>
  </div>
  <a href="#54734" class="name">
  <strong class="user"><em>eddiec at stararcher dot com</em></strong></a><a class="genanchor" href="#54734"> &para;</a><div class="date" title="2005-07-13 06:26"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom54734">
<div class="phpcode"><code><span class="html">It appears that mcrypt_decrypt pads the *RETURN STRING* with nulls ('\0') to fill out to n * blocksize.  For old C-programmers, like myself, it is easy to believe the string ends at the first null.  In PHP it does not:
<br />
...
<div class="foot"><a href="/manual/add-note.php?sect=function.mcrypt-decrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-decrypt.php">＋<small>add a note</small></a></div>
