...
<head>
  ...
  <title>PHP: cubrid_seq_put - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-seq-put.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-seq-put">
 <link rel="alternate" href="https://www.php.net/cubrid-seq-put" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-seq-insert.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-set-add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-seq-put.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-seq-put.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-seq-put.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-seq-put.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-seq-put.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-seq-put.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-seq-put.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-seq-put.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-seq-put.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-seq-put.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-seq-put.php" hreflang="zh">
...
<meta name="Description" content="Update the element value of sequence type column using OID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_seq_put - Manual" />
<meta name="twitter:description" content="Update the element value of sequence type column using OID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_seq_put - Manual" />
<meta itemprop="description" content="Update the element value of sequence type column using OID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Update the element value of sequence type column using OID" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-set-add.php">
          cubrid_set_add &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-seq-insert.php">
          &laquo; cubrid_seq_insert        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-seq-put.php' selected="selected">English</option>
            <option value='de/function.cubrid-seq-put.php'>German</option>
            <option value='es/function.cubrid-seq-put.php'>Spanish</option>
            <option value='fr/function.cubrid-seq-put.php'>French</option>
            <option value='it/function.cubrid-seq-put.php'>Italian</option>
            <option value='ja/function.cubrid-seq-put.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-seq-put.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-seq-put.php'>Russian</option>
            <option value='tr/function.cubrid-seq-put.php'>Turkish</option>
            <option value='uk/function.cubrid-seq-put.php'>Ukrainian</option>
            <option value='zh/function.cubrid-seq-put.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-seq-put" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_seq_put</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_seq_put</span> &mdash; <span class="dc-title">Update the element value of sequence type column using OID</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-seq-put-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_seq_put</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$oid</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$attr_name</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$seq_element</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_seq_put()</strong></span> function is used to update the
    content of the requested element in a sequent type attribute using OID.
  </p>
 </div>


<div class="refsect1 parameters" id="refsect1-function.cubrid-seq-put-parameters">
  ...
  <dd><p class="para">Name of the attribute that you want to update an element.</p></dd>
   
   
  <dt><code class="parameter">index</code></dt>
  <dd><p class="para">Index (1-based) of the element that you want to update.</p></dd>
   
  
  <dt><code class="parameter">seq_element</code></dt>
  <dd><p class="para">New content that you want to use for the update.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-seq-put-returnvalues">
...
array(4) {
 ...
 <div class="refsect1 seealso" id="refsect1-function.cubrid-seq-put-seealso">
   ...
   <ul class="simplelist"> 
    ...
    <li><span class="function"><a href="function.cubrid-seq-insert.php" class="function" rel="rdfs-seeAlso">cubrid_seq_insert()</a> - Insert an element to a sequence type column using OID</span></li>   
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-seq-put.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-seq-put%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-seq-put&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-seq-put.php">＋<small>add a note</small></a></span>
