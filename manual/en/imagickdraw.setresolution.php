...
<head>
  ...
  <title>PHP: ImagickDraw::setResolution - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setresolution.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setresolution.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setresolution.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setgravity.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setstrokealpha.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setresolution.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setresolution.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setresolution.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setresolution.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setresolution.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setresolution.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setresolution.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setresolution.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setresolution.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setresolution.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setresolution.php" hreflang="zh">
...
<meta name="Description" content="Sets the resolution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setResolution - Manual" />
<meta name="twitter:description" content="Sets the resolution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setResolution - Manual" />
<meta itemprop="description" content="Sets the resolution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the resolution" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setstrokealpha.php">
          ImagickDraw::setStrokeAlpha &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setgravity.php">
          &laquo; ImagickDraw::setGravity        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setresolution.php' selected="selected">English</option>
            <option value='de/imagickdraw.setresolution.php'>German</option>
            <option value='es/imagickdraw.setresolution.php'>Spanish</option>
            <option value='fr/imagickdraw.setresolution.php'>French</option>
            <option value='it/imagickdraw.setresolution.php'>Italian</option>
            <option value='ja/imagickdraw.setresolution.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setresolution.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setresolution.php'>Russian</option>
            <option value='tr/imagickdraw.setresolution.php'>Turkish</option>
            <option value='uk/imagickdraw.setresolution.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setresolution.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setresolution" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setResolution</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.1.0)</p><p class="refpurpose"><span class="refname">ImagickDraw::setResolution</span> &mdash; <span class="dc-title">Sets the resolution</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setresolution-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setResolution</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$resolution_x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$resolution_y</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setresolution-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setresolution-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setresolution.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setresolution%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setresolution&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setresolution.php">＋<small>add a note</small></a></span>
