...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/pdostatement.fetchcolumn.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/pdostatement.fetchcolumn.php">
 <link rel="alternate" href="https://www.php.net/manual/en/pdostatement.fetchcolumn.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.pdostatement.php">
 <link rel="prev" href="https://www.php.net/manual/en/pdostatement.fetchall.php">
 <link rel="next" href="https://www.php.net/manual/en/pdostatement.fetchobject.php">
...
<meta name="Description" content="Returns a single column from the next row of a result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PDOStatement::fetchColumn - Manual" />
<meta name="twitter:description" content="Returns a single column from the next row of a result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PDOStatement::fetchColumn - Manual" />
<meta itemprop="description" content="Returns a single column from the next row of a result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a single column from the next row of a result set" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/pdostatement.fetchcolumn.php' selected="selected">English</option>
            <option value='de/pdostatement.fetchcolumn.php'>German</option>
            <option value='es/pdostatement.fetchcolumn.php'>Spanish</option>
            <option value='fr/pdostatement.fetchcolumn.php'>French</option>
 ...
 <div class="refsect1 description" id="refsect1-pdostatement.fetchcolumn-description">
  ...
  <p class="para rdfs-comment">
   Returns a single column from the next row of a result set or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if
   there are no more rows.
  </p>

  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    <span class="methodname"><strong>PDOStatement::fetchColumn()</strong></span> should not be used to
    retrieve boolean columns, as it is impossible to distinguish a value of
    <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> from there being no more rows to retrieve. Use
    <span class="methodname"><a href="pdostatement.fetch.php" class="methodname">PDOStatement::fetch()</a></span> instead.
   </p>
  </p></blockquote>
 </div>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       no value is supplied, <span class="methodname"><strong>PDOStatement::fetchColumn()</strong></span>
 ...
 <div class="refsect1 returnvalues" id="refsect1-pdostatement.fetchcolumn-returnvalues">
  ...
  <p class="para">
   <span class="methodname"><strong>PDOStatement::fetchColumn()</strong></span> returns a single column
  ...
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="para">
    ...
    use <span class="methodname"><strong>PDOStatement::fetchColumn()</strong></span> to retrieve data.
   </p>
  </div>
 </div>
...
is set to <strong><code><a href="pdo.constants.php#pdo.constants.errmode-exception">PDO::ERRMODE_EXCEPTION</a></code></strong>.
 ...
 <div class="refsect1 examples" id="refsect1-pdostatement.fetchcolumn-examples">
  ...
  <p class="para">
   <div class="example" id="example-1172"><p><strong>Example #1 Return first column of the next row</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="pdostatement.setfetchmode.php" class="methodname" rel="rdfs-seeAlso">PDOStatement::setFetchMode()</a> - Set the default fetch mode for this statement</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pdo/pdostatement/fetchcolumn.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fpdostatement.fetchcolumn%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=pdostatement.fetchcolumn&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pdostatement.fetchcolumn.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>PhoneixSegovia at GOOGLE_MAIL_SERVER dot com</em></strong></a><a class="genanchor" href="#100522"> &para;</a><div class="date" title="2010-10-21 02:13"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom100522">
<div class="phpcode"><code><span class="html">fetchColumn return boolean false when a row not is found or don't had more rows.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>seanferd at assmasterdonkeyranch dot com</em></strong></a><a class="genanchor" href="#72609"> &para;</a><div class="date" title="2007-01-25 03:04"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom72609">
<div class="phpcode"><code><span class="html">This is an excellent method for returning a column count. For example:
<br />
...
<br /></span>In my case $pics-&gt;fetchColumn() returns 641 because that is how many pictures I have in my db.</span></code></div>
  </div>
 </div>
  <div class="note" id="129145">  <div class="votes">
    ...
    <div class="tally" id="V129145" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#129145" class="name">
  <strong class="user"><em>theking2(at)king.ma</em></strong></a><a class="genanchor" href="#129145"> &para;</a><div class="date" title="2024-01-06 09:20"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129145">
<div class="phpcode"><code><span class="html">When migrating from mysqli it is important that while mysqli_result::fetch_column will iterate over subsequent rows  PDOStatement::fetchColumn will NOT!<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">while ( </span><span class="default">$row0 </span><span class="keyword">= </span><span class="default">$db</span><span class="keyword">-&gt;</span><span class="default">query</span><span class="keyword">(</span><span class="string">"SELECT `value` FROM `bool`"</span><span class="keyword">)-&gt;</span><span class="default">fetchColumn</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">) ) {<br />  </span><span class="default">var_dump</span><span class="keyword">( </span><span class="default">$row0 </span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;<br /></span><br />is an endless loop unless the first column in the first row of the table bool is "0".</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=pdostatement.fetchcolumn&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pdostatement.fetchcolumn.php">＋<small>add a note</small></a></div>
