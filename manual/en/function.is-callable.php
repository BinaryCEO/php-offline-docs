...
<head>
  ...
  <title>PHP: is_callable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.is-callable.php">
 <link rel="shorturl" href="https://www.php.net/is-callable">
 <link rel="alternate" href="https://www.php.net/is-callable" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.var.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.is-bool.php">
 <link rel="next" href="https://www.php.net/manual/en/function.is-countable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.is-callable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.is-callable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.is-callable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.is-callable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.is-callable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.is-callable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.is-callable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.is-callable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.is-callable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.is-callable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.is-callable.php" hreflang="zh">
...
<meta name="Description" content="Verify that a value can be called as a function from the current scope" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: is_callable - Manual" />
<meta name="twitter:description" content="Verify that a value can be called as a function from the current scope" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: is_callable - Manual" />
<meta itemprop="description" content="Verify that a value can be called as a function from the current scope" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Verify that a value can be called as a function from the current scope" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.is-countable.php">
          is_countable &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.is-callable.php' selected="selected">English</option>
            <option value='de/function.is-callable.php'>German</option>
            <option value='es/function.is-callable.php'>Spanish</option>
            <option value='fr/function.is-callable.php'>French</option>
            <option value='it/function.is-callable.php'>Italian</option>
            <option value='ja/function.is-callable.php'>Japanese</option>
            <option value='pt_BR/function.is-callable.php'>Brazilian Portuguese</option>
            <option value='ru/function.is-callable.php'>Russian</option>
            <option value='tr/function.is-callable.php'>Turkish</option>
            <option value='uk/function.is-callable.php'>Ukrainian</option>
            <option value='zh/function.is-callable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.is-callable" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.is-callable-examples">
  ...
  <p class="para">
   <div class="example" id="example-5648">
...
string(12) &quot;someFunction&quot;</pre>
   ...
   <div class="example" id="example-5649">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.method-exists.php" class="function" rel="rdfs-seeAlso">method_exists()</a> - Checks if the class method exists</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/var/functions/is-callable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.is-callable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.is-callable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-callable.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118623">  <div class="votes">
    <div id="Vu118623">
    <a href="/manual/vote-note.php?id=118623&amp;page=function.is-callable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118623">
    <a href="/manual/vote-note.php?id=118623&amp;page=function.is-callable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118623" title="80% like this...">
    37
    </div>
  </div>
  <a href="#118623" class="name">
  <strong class="user"><em>izharaazmi at gmail dot com</em></strong></a><a class="genanchor" href="#118623"> &para;</a><div class="date" title="2016-01-11 06:50"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118623">
<div class="phpcode"><code><span class="html">If the target class has __call() magic function implemented, then is_callable will ALWAYS return TRUE for whatever method you call it.<br />is_callable does not evaluate your internal logic inside __call() implementation (and this is for good).<br />Therefore every method name is callable for such classes.<br /><br />Hence it is WRONG to say (as someone said):<br />...is_callable will correctly determine the existence of methods made with __call...<br /><br />Example:<br /><span class="default">&lt;?php<br /></span><span class="keyword">class </span><span class="default">TestCallable<br /></span><span class="keyword">{<br />    public function </span><span class="default">testing</span><span class="keyword">()<br />    {<br />          return </span><span class="string">"I am called."</span><span class="keyword">;<br />    }<br /><br />    public function </span><span class="default">__call</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">, </span><span class="default">$args</span><span class="keyword">)<br />    {<br />        if(</span><span class="default">$name </span><span class="keyword">== </span><span class="string">'testingOther'</span><span class="keyword">) <br />        {<br />                return </span><span class="default">call_user_func_array</span><span class="keyword">(array(</span><span class="default">$this</span><span class="keyword">, </span><span class="string">'testing'</span><span class="keyword">), </span><span class="default">$args</span><span class="keyword">);<br />        }<br />    }<br />}<br /><br /></span><span class="default">$t </span><span class="keyword">= new </span><span class="default">TestCallable</span><span class="keyword">();<br />echo </span><span class="default">$t</span><span class="keyword">-&gt;</span><span class="default">testing</span><span class="keyword">();      </span><span class="comment">// Output: I am called.<br /></span><span class="keyword">echo </span><span class="default">$t</span><span class="keyword">-&gt;</span><span class="default">testingOther</span><span class="keyword">(); </span><span class="comment">// Output: I am called.<br /></span><span class="keyword">echo </span><span class="default">$t</span><span class="keyword">-&gt;</span><span class="default">working</span><span class="keyword">();      </span><span class="comment">// Output: (null)<br /><br /></span><span class="keyword">echo </span><span class="default">is_callable</span><span class="keyword">(array(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'testing'</span><span class="keyword">));       </span><span class="comment">// Output: TRUE<br /></span><span class="keyword">echo </span><span class="default">is_callable</span><span class="keyword">(array(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'testingOther'</span><span class="keyword">));  </span><span class="comment">// Output: TRUE<br /></span><span class="keyword">echo </span><span class="default">is_callable</span><span class="keyword">(array(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'working'</span><span class="keyword">));       </span><span class="comment">// Output: TRUE, expected: FALSE<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="126199">  <div class="votes">
    <div id="Vu126199">
    <a href="/manual/vote-note.php?id=126199&amp;page=function.is-callable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126199">
    <a href="/manual/vote-note.php?id=126199&amp;page=function.is-callable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126199" title="88% like this...">
    21
    </div>
  </div>
  <a href="#126199" class="name">
  <strong class="user"><em>mohamed dot elidrissi at protonmail dot com</em></strong></a><a class="genanchor" href="#126199"> &para;</a><div class="date" title="2021-06-28 12:26"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126199">
<div class="phpcode"><code><span class="html">Note that -- as mentioned in the migration guide-- starting from PHP 8.0, is_callable() will not work with non-static methods if you use a class name, instead an object of the class should be provided:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">class </span><span class="default">Test<br /></span><span class="keyword">{<br />    public function </span><span class="default">method1</span><span class="keyword">() { }<br />    public static function </span><span class="default">method2</span><span class="keyword">() { }<br />}<br /><br /></span><span class="comment">// Pre PHP 8<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">is_callable</span><span class="keyword">(array(</span><span class="string">'Test'</span><span class="keyword">, </span><span class="string">'method1'</span><span class="keyword">))); </span><span class="comment">// bool(true)<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">is_callable</span><span class="keyword">(array(</span><span class="string">'Test'</span><span class="keyword">, </span><span class="string">'method2'</span><span class="keyword">))); </span><span class="comment">// bool(true)<br /><br />// Post PHP 8<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">is_callable</span><span class="keyword">(array(</span><span class="string">'Test'</span><span class="keyword">, </span><span class="string">'method1'</span><span class="keyword">))); </span><span class="comment">// bool(false)<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">is_callable</span><span class="keyword">(array(</span><span class="string">'Test'</span><span class="keyword">, </span><span class="string">'method2'</span><span class="keyword">))); </span><span class="comment">// bool(true)<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">is_callable</span><span class="keyword">(array(new </span><span class="default">Test</span><span class="keyword">, </span><span class="string">'method1'</span><span class="keyword">))); </span><span class="comment">// bool(true)<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.is-callable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-callable.php">＋<small>add a note</small></a></div>
