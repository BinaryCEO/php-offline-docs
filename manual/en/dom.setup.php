...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/dom.setup.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/dom.setup.php">
 <link rel="alternate" href="https://www.php.net/manual/en/dom.setup.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.dom.php">
 <link rel="next" href="https://www.php.net/manual/en/dom.requirements.php">

 <link rel="alternate" href="https://www.php.net/manual/en/dom.setup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/dom.setup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/dom.setup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/dom.setup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/dom.setup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/dom.setup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/dom.setup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/dom.setup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/dom.setup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/dom.setup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/dom.setup.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/dom.setup.php' selected="selected">English</option>
            <option value='de/dom.setup.php'>German</option>
            <option value='es/dom.setup.php'>Spanish</option>
            <option value='fr/dom.setup.php'>French</option>
            <option value='it/dom.setup.php'>Italian</option>
            <option value='ja/dom.setup.php'>Japanese</option>
            <option value='pt_BR/dom.setup.php'>Brazilian Portuguese</option>
            <option value='ru/dom.setup.php'>Russian</option>
            <option value='tr/dom.setup.php'>Turkish</option>
            <option value='uk/dom.setup.php'>Ukrainian</option>
            <option value='zh/dom.setup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="dom.setup" class="chapter">
 <h1 class="title">Installing/Configuring</h1>
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="dom.requirements.php">Requirements</a></li><li><a href="dom.installation.php">Installation</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdom.setup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=dom.setup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/dom.setup.php">＋<small>add a note</small></a></span>
