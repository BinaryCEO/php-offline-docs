...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-box-publickey-from-secretkey.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-box-publickey.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-box-seal.php">
...
<meta name="Description" content="Calculate the public key from a secret key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_box_publickey_from_secretkey - Manual" />
<meta name="twitter:description" content="Calculate the public key from a secret key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_box_publickey_from_secretkey - Manual" />
<meta itemprop="description" content="Calculate the public key from a secret key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calculate the public key from a secret key" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-box-publickey-from-secretkey.php' selected="selected">English</option>
            ...
            <option value='ru/function.sodium-crypto-box-publickey-from-secretkey.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_box_publickey_from_secretkey</span> &mdash; <span class="dc-title">Calculate the public key from a secret key</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.sodium-crypto-box-publickey-from-secretkey-description">
  ...
  <p class="para">
   This only works with the type of keys intended for use with <span class="function"><strong>crypto_box()</strong></span>
   (which uses Elliptic Curve Diffie-Hellman over the Montgomery curve, Curve25519; abbreviated as X25519),
   not <span class="function"><strong>crypto_sign()</strong></span> (which uses Edwards Digital Signature Algorithm over the Edwards
  ...
  <p class="para">
   X25519 public key.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-box-publickey-from-secretkey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-box-publickey-from-secretkey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-box-publickey-from-secretkey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-box-publickey-from-secretkey.php">＋<small>add a note</small></a></span>
