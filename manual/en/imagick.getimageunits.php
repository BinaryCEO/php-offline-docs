...
<head>
  ...
  <title>PHP: Imagick::getImageUnits - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageunits.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageunits.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageunits.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagetype.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagevirtualpixelmethod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageunits.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageunits.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageunits.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageunits.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageunits.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageunits.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageunits.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageunits.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageunits.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageunits.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageunits.php" hreflang="zh">
...
<meta name="Description" content="Gets the image units of resolution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageUnits - Manual" />
<meta name="twitter:description" content="Gets the image units of resolution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageUnits - Manual" />
<meta itemprop="description" content="Gets the image units of resolution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image units of resolution" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagevirtualpixelmethod.php">
          Imagick::getImageVirtualPixelMethod &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagetype.php">
          &laquo; Imagick::getImageType        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageunits.php' selected="selected">English</option>
            <option value='de/imagick.getimageunits.php'>German</option>
            <option value='es/imagick.getimageunits.php'>Spanish</option>
            <option value='fr/imagick.getimageunits.php'>French</option>
            <option value='it/imagick.getimageunits.php'>Italian</option>
            <option value='ja/imagick.getimageunits.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageunits.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageunits.php'>Russian</option>
            <option value='tr/imagick.getimageunits.php'>Turkish</option>
            <option value='uk/imagick.getimageunits.php'>Ukrainian</option>
            <option value='zh/imagick.getimageunits.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageunits" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageUnits</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageUnits</span> &mdash; <span class="dc-title">Gets the image units of resolution</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimageunits-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageUnits</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimageunits-parameters">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageunits.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageunits%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageunits&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageunits.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122662">  <div class="votes">
    <div id="Vu122662">
    <a href="/manual/vote-note.php?id=122662&amp;page=imagick.getimageunits&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122662">
    <a href="/manual/vote-note.php?id=122662&amp;page=imagick.getimageunits&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122662" title="100% like this...">
    1
    </div>
  </div>
  <a href="#122662" class="name">
  <strong class="user"><em>Victor</em></strong></a><a class="genanchor" href="#122662"> &para;</a><div class="date" title="2018-04-25 09:06"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122662">
<div class="phpcode"><code><span class="html">Here's an example of how to interpret and use ImageResolution and ImageUnits:<br /><br />$i = new Imagick('some_image_file.png');<br /><br />$r = $i-&gt;getImageResolution();<br />$u = $i-&gt;getImageUnits();<br />if ($u == Imagick::RESOLUTION_PIXELSPERCENTIMETER) {<br />   $r[x] = (int)round($r[x] * 2.54);<br />   $r[y] = (int)round($r[y] * 2.54);<br />   $i-&gt;setImageUnits(Imagick::RESOLUTION_PIXELSPERINCH);<br />   $i-&gt;setImageResolution($r[x], $r[y]);<br /><br />  //note that the number type is double again<br />   $r = $i-&gt;getImageResolution();<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="109133">  <div class="votes">
    <div id="Vu109133">
    <a href="/manual/vote-note.php?id=109133&amp;page=imagick.getimageunits&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd109133">
    <a href="/manual/vote-note.php?id=109133&amp;page=imagick.getimageunits&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V109133" title="50% like this...">
    0
    </div>
  </div>
  <a href="#109133" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#109133"> &para;</a><div class="date" title="2012-06-22 02:15"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109133">
<div class="phpcode"><code><span class="html">By using the PHP function for getImageUnits, you get back an integer representing the evaluation of a predefined, PATHUNITS constant of the ImageMagick package.  You only have four values for this.  They look like "imagick::PATHUNITS_UNDEFINED", with _VALUE value's being: undefined, userspace, userspaceonuse, and objectboundingbox.  Undefined, if printed, is a 0, userspace is a 1, userspaceonuse is a 2, and objectboundingbox is a 3.<br /><br />What's the use of knowing the Clipping Path Unit default for an image?  According to the Wikipedia article for "Clipping Path", a Clipping Path is "a closed vector path, or shape, used to cut out a 2D image in image editing software. Anything inside the path will be included after the clipping path is applied; anything outside the path will be omitted from the output."<br /><br />The official ImageMagick documentation provides only two valid values coming into or out of the clipping path unit value, one being userSpaceOnUse and the other being ObjectBoundingBox.  The only definitions provided: "If userSpaceOnUse, the contents of the clipping path represent values in the current user coordinate system in place at the time when the clipping path is referenced. if objectBoundingBox, then the user coordinate system for the contents of the clipping path is established using the bounding box of the object to which the clipping path is applied. The default is userSpaceOnUse." <a href="http://www.imagemagick.org/RMagick/doc/rvgclip.html" rel="nofollow" target="_blank">http://www.imagemagick.org/RMagick/doc/rvgclip.html</a><br /><br />In personal experimentation, all JPEG and GIF files have provided '0' for "Undefined" on this function, and all BMP and PNG files have provided '2' for "UserSpaceOnUse" on this function.<br /><br />And some sample code :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.gif"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get Image Units<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$image_page </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageUnits</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Interpret Units Value<br />        // ---------------------------------------------<br /><br />    </span><span class="keyword">switch(</span><span class="default">$image_units</span><span class="keyword">)<br />    {<br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">PATHUNITS_UNDEFINED</span><span class="keyword">:<br />            </span><span class="default">$image_units_printable </span><span class="keyword">= </span><span class="string">"Undefined"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">PATHUNITS_USERSPACE</span><span class="keyword">:<br />            </span><span class="default">$image_units_printable </span><span class="keyword">= </span><span class="string">"User Space"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">PATHUNITS_USERSPACEONUSE</span><span class="keyword">:<br />            </span><span class="default">$image_units_printable </span><span class="keyword">= </span><span class="string">"User Space On Use"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">PATHUNITS_OBJECTBOUNDINGBOX</span><span class="keyword">:<br />            </span><span class="default">$image_units_printable </span><span class="keyword">= </span><span class="string">"Object Bounding Box"</span><span class="keyword">;<br />            break;<br />    }<br />    <br />        </span><span class="comment">// Print Units Value<br />        // ---------------------------------------------<br /><br />    </span><span class="keyword">print(</span><span class="string">" Image Units: # </span><span class="default">$image_units</span><span class="string"> -- </span><span class="default">$image_units_printable</span><span class="string"> ."</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimageunits&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageunits.php">＋<small>add a note</small></a></div>
