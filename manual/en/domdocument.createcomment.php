...
<head>
  ...
  <title>PHP: DOMDocument::createComment - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/domdocument.createcomment.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/domdocument.createcomment.php">
 <link rel="alternate" href="https://www.php.net/manual/en/domdocument.createcomment.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.domdocument.php">
 <link rel="prev" href="https://www.php.net/manual/en/domdocument.createcdatasection.php">
 <link rel="next" href="https://www.php.net/manual/en/domdocument.createdocumentfragment.php">

 <link rel="alternate" href="https://www.php.net/manual/en/domdocument.createcomment.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/domdocument.createcomment.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/domdocument.createcomment.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/domdocument.createcomment.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/domdocument.createcomment.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/domdocument.createcomment.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/domdocument.createcomment.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/domdocument.createcomment.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/domdocument.createcomment.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/domdocument.createcomment.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/domdocument.createcomment.php" hreflang="zh">
...
<meta name="Description" content="Create new comment node" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMDocument::createComment - Manual" />
<meta name="twitter:description" content="Create new comment node" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMDocument::createComment - Manual" />
<meta itemprop="description" content="Create new comment node" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create new comment node" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="domdocument.createdocumentfragment.php">
          DOMDocument::createDocumentFragment &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domdocument.createcdatasection.php">
          &laquo; DOMDocument::createCDATASection        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/domdocument.createcomment.php' selected="selected">English</option>
            <option value='de/domdocument.createcomment.php'>German</option>
            <option value='es/domdocument.createcomment.php'>Spanish</option>
            <option value='fr/domdocument.createcomment.php'>French</option>
            <option value='it/domdocument.createcomment.php'>Italian</option>
            <option value='ja/domdocument.createcomment.php'>Japanese</option>
            <option value='pt_BR/domdocument.createcomment.php'>Brazilian Portuguese</option>
            <option value='ru/domdocument.createcomment.php'>Russian</option>
            <option value='tr/domdocument.createcomment.php'>Turkish</option>
            <option value='uk/domdocument.createcomment.php'>Ukrainian</option>
            <option value='zh/domdocument.createcomment.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="domdocument.createcomment" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-domdocument.createcomment-description">
  ...
  <p class="para rdfs-comment">
   ...
   <span class="classname"><a href="class.domcomment.php" class="classname">DOMComment</a></span>. This node will not show up in the document unless
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="domdocument.createtextnode.php" class="methodname" rel="rdfs-seeAlso">DOMDocument::createTextNode()</a> - Create new text node</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domdocument/createcomment.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdomdocument.createcomment%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=domdocument.createcomment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domdocument.createcomment.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="94806">  <div class="votes">
    <div id="Vu94806">
    <a href="/manual/vote-note.php?id=94806&amp;page=domdocument.createcomment&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94806">
    <a href="/manual/vote-note.php?id=94806&amp;page=domdocument.createcomment&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94806" title="50% like this...">
    0
    </div>
  </div>
  <a href="#94806" class="name">
  <strong class="user"><em>php dot sirlancelot at spamgourmet dot com</em></strong></a><a class="genanchor" href="#94806"> &para;</a><div class="date" title="2009-11-25 12:10"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94806">
<div class="phpcode"><code><span class="html">To prevent a parser error when the comment string would contain the character sequence "--", do this:<br /><br /><span class="default">&lt;?php<br /><br />$CommentString </span><span class="keyword">= </span><span class="string">'This contains -- some weird -- characters.'</span><span class="keyword">;<br /><br /></span><span class="default">$CommentNode </span><span class="keyword">= </span><span class="default">$DomDocument</span><span class="keyword">-&gt;</span><span class="default">createComment</span><span class="keyword">(<br />        </span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">'--'</span><span class="keyword">, </span><span class="string">'-'</span><span class="keyword">.</span><span class="default">chr</span><span class="keyword">(</span><span class="default">194</span><span class="keyword">).</span><span class="default">chr</span><span class="keyword">(</span><span class="default">173</span><span class="keyword">).</span><span class="string">'-'</span><span class="keyword">, </span><span class="default">$CommentString</span><span class="keyword">)<br />);<br /></span><span class="default">?&gt;<br /></span><br />This will insert a Soft Hyphen in between the two hyphens which will not cause the parser to error out.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=domdocument.createcomment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domdocument.createcomment.php">＋<small>add a note</small></a></div>
