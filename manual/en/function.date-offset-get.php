...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-offset-get.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.date-modify.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-parse.php">
...
<meta name="Description" content="Alias of DateTime::getOffset" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_offset_get - Manual" />
<meta name="twitter:description" content="Alias of DateTime::getOffset" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_offset_get - Manual" />
<meta itemprop="description" content="Alias of DateTime::getOffset" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTime::getOffset" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-offset-get.php' selected="selected">English</option>
            <option value='de/function.date-offset-get.php'>German</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">date_offset_get</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetime.getoffset.php" class="methodname">DateTime::getOffset()</a></span></span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.date-offset-get-description">
  ...
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetime.getoffset.php" class="methodname">DateTime::getOffset()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-offset-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-offset-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-offset-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-offset-get.php">＋<small>add a note</small></a></span>
