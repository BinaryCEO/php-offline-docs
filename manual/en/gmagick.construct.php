...
<head>
  ...
  <title>PHP: Gmagick::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.compositeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.cropimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.construct.php" hreflang="zh">
...
<meta name="Description" content="The Gmagick constructor" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::__construct - Manual" />
<meta name="twitter:description" content="The Gmagick constructor" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::__construct - Manual" />
<meta itemprop="description" content="The Gmagick constructor" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Gmagick constructor" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.cropimage.php">
          Gmagick::cropimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.compositeimage.php">
          &laquo; Gmagick::compositeimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.construct.php' selected="selected">English</option>
            <option value='de/gmagick.construct.php'>German</option>
            <option value='es/gmagick.construct.php'>Spanish</option>
            <option value='fr/gmagick.construct.php'>French</option>
            <option value='it/gmagick.construct.php'>Italian</option>
            <option value='ja/gmagick.construct.php'>Japanese</option>
            <option value='pt_BR/gmagick.construct.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.construct.php'>Russian</option>
            <option value='tr/gmagick.construct.php'>Turkish</option>
            <option value='uk/gmagick.construct.php'>Ukrainian</option>
            <option value='zh/gmagick.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.construct" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::__construct</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::__construct</span> &mdash; <span class="dc-title">The Gmagick constructor</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.construct-description">
  <h3 class="title">Description</h3>
  <div class="constructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::__construct</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code><span class="initializer"> = ?</span></span>)</div>

  <p class="para rdfs-comment">
   The <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> constructor.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-gmagick.construct-parameters">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.construct-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.construct.php">＋<small>add a note</small></a></span>
