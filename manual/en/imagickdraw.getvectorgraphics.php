...
<head>
  ...
  <title>PHP: ImagickDraw::getVectorGraphics - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getvectorgraphics.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getvectorgraphics.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getvectorgraphics.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.gettextundercolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.line.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getvectorgraphics.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getvectorgraphics.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getvectorgraphics.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getvectorgraphics.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getvectorgraphics.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getvectorgraphics.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getvectorgraphics.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getvectorgraphics.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getvectorgraphics.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getvectorgraphics.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getvectorgraphics.php" hreflang="zh">
...
<meta name="Description" content="Returns a string containing vector graphics" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getVectorGraphics - Manual" />
<meta name="twitter:description" content="Returns a string containing vector graphics" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getVectorGraphics - Manual" />
<meta itemprop="description" content="Returns a string containing vector graphics" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a string containing vector graphics" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.line.php">
          ImagickDraw::line &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.gettextundercolor.php">
          &laquo; ImagickDraw::getTextUnderColor        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getvectorgraphics.php' selected="selected">English</option>
            <option value='de/imagickdraw.getvectorgraphics.php'>German</option>
            <option value='es/imagickdraw.getvectorgraphics.php'>Spanish</option>
            <option value='fr/imagickdraw.getvectorgraphics.php'>French</option>
            <option value='it/imagickdraw.getvectorgraphics.php'>Italian</option>
            <option value='ja/imagickdraw.getvectorgraphics.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getvectorgraphics.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getvectorgraphics.php'>Russian</option>
            <option value='tr/imagickdraw.getvectorgraphics.php'>Turkish</option>
            <option value='uk/imagickdraw.getvectorgraphics.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getvectorgraphics.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getvectorgraphics" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getVectorGraphics</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getVectorGraphics</span> &mdash; <span class="dc-title">Returns a string containing vector graphics</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getvectorgraphics-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getVectorGraphics</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
currently not documented; only its argument list is available.
  ...
  <p class="para">
   ...
   graphics calls made since the <span class="classname"><a href="class.imagickdraw.php" class="classname">ImagickDraw</a></span> object was instantiated.  
  </p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getvectorgraphics-returnvalues">
  ...
  <p class="para">
   Returns a string containing the vector graphics.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getvectorgraphics.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getvectorgraphics%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getvectorgraphics&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getvectorgraphics.php">＋<small>add a note</small></a></span>
