...
<head>
  ...
  <title>PHP: xml_parser_set_option - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xml-parser-set-option.php">
 <link rel="shorturl" href="https://www.php.net/xml-parser-set-option">
 <link rel="alternate" href="https://www.php.net/xml-parser-set-option" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.xml.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.xml-parser-get-option.php">
 <link rel="next" href="https://www.php.net/manual/en/function.xml-set-character-data-handler.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.xml-parser-set-option.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.xml-parser-set-option.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.xml-parser-set-option.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.xml-parser-set-option.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.xml-parser-set-option.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.xml-parser-set-option.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.xml-parser-set-option.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.xml-parser-set-option.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.xml-parser-set-option.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.xml-parser-set-option.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.xml-parser-set-option.php" hreflang="zh">
...
<meta name="Description" content="Set options in an XML parser" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: xml_parser_set_option - Manual" />
<meta name="twitter:description" content="Set options in an XML parser" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: xml_parser_set_option - Manual" />
<meta itemprop="description" content="Set options in an XML parser" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set options in an XML parser" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.xml-set-character-data-handler.php">
          xml_set_character_data_handler &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.xml-parser-get-option.php">
          &laquo; xml_parser_get_option        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xml-parser-set-option.php' selected="selected">English</option>
            <option value='de/function.xml-parser-set-option.php'>German</option>
            <option value='es/function.xml-parser-set-option.php'>Spanish</option>
            <option value='fr/function.xml-parser-set-option.php'>French</option>
            <option value='it/function.xml-parser-set-option.php'>Italian</option>
            <option value='ja/function.xml-parser-set-option.php'>Japanese</option>
            <option value='pt_BR/function.xml-parser-set-option.php'>Brazilian Portuguese</option>
            <option value='ru/function.xml-parser-set-option.php'>Russian</option>
            <option value='tr/function.xml-parser-set-option.php'>Turkish</option>
            <option value='uk/function.xml-parser-set-option.php'>Ukrainian</option>
            <option value='zh/function.xml-parser-set-option.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.xml-parser-set-option" class="refentry">
  ...
  instance now; previously, a valid <code class="literal">xml</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
     ...
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xml/functions/xml-parser-set-option.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xml-parser-set-option%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xml-parser-set-option&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xml-parser-set-option.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="84815">  <div class="votes">
    <div id="Vu84815">
    <a href="/manual/vote-note.php?id=84815&amp;page=function.xml-parser-set-option&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd84815">
    <a href="/manual/vote-note.php?id=84815&amp;page=function.xml-parser-set-option&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V84815" title="100% like this...">
    2
    </div>
  </div>
  <a href="#84815" class="name">
  <strong class="user"><em>www.thomaskoch.it</em></strong></a><a class="genanchor" href="#84815"> &para;</a><div class="date" title="2008-07-31 02:22"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom84815">
<div class="phpcode"><code><span class="html">The option XML_OPTION_SKIP_WHITE has no effect in my PHP 5.2.6 (with expat-1.95.8-5). To skip cdata composed of white space only, simply check for that at the beginning of your cdata callback function:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">callback_cdata</span><span class="keyword">(</span><span class="default">$parser</span><span class="keyword">, </span><span class="default">$cdata</span><span class="keyword">)<br />{<br /> if(!</span><span class="default">trim</span><span class="keyword">(</span><span class="default">$cdata</span><span class="keyword">))<br />  return;<br /><br /> </span><span class="comment">// ... continue processing ...<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="26889">  <div class="votes">
    <div id="Vu26889">
    <a href="/manual/vote-note.php?id=26889&amp;page=function.xml-parser-set-option&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd26889">
    <a href="/manual/vote-note.php?id=26889&amp;page=function.xml-parser-set-option&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V26889" title="66% like this...">
    1
    </div>
  </div>
  <a href="#26889" class="name">
  <strong class="user"><em>pupeno at pupeno dot com</em></strong></a><a class="genanchor" href="#26889"> &para;</a><div class="date" title="2002-11-16 01:14"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom26889">
<div class="phpcode"><code><span class="html">XML is case sensitive, then, from my point of view, disabling case folding doesn't goes against xml 1.0 specifications but the contrary, disabling case folding allow us to distiguish between diferent cases of the same letter ('a' and 'A') which of XML are two diferent things.<br />From my point of view, disabling case folding is a good practice and I think it should be disabled by default.<br />More information on:<br /><a href="http://www.isacat.net/2001/xml/case.htm" rel="nofollow" target="_blank">http://www.isacat.net/2001/xml/case.htm</a><br />and<br /><a href="http://www.w3.org/TR/REC-xml" rel="nofollow" target="_blank">http://www.w3.org/TR/REC-xml</a><br />Thank you.</span></code></div>
  </div>
 </div>
  <div class="note" id="73758">  <div class="votes">
    <div id="Vu73758">
    <a href="/manual/vote-note.php?id=73758&amp;page=function.xml-parser-set-option&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd73758">
    <a href="/manual/vote-note.php?id=73758&amp;page=function.xml-parser-set-option&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V73758" title="50% like this...">
    0
    </div>
  </div>
  <a href="#73758" class="name">
  <strong class="user"><em>j[no_spam_please] at [thx]jessepearson dot net</em></strong></a><a class="genanchor" href="#73758"> &para;</a><div class="date" title="2007-03-08 08:08"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom73758">
<div class="phpcode"><code><span class="html">In the function below, you need to update two lines if you don't want php to throw warnings. <br /><br />change these two:<br />           $elements[$index]['attributes'] = $tag['attributes'];<br />           $elements[$index]['content'] = $tag['value'];<br /><br />to this:<br />      $elements[$index]['attributes'] = empty($tag['attributes']) ? "" : $tag['attributes'];<br />      $elements[$index]['content']    = empty($tag['value']) ? "" : $tag['value'];</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.xml-parser-set-option&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xml-parser-set-option.php">＋<small>add a note</small></a></div>
