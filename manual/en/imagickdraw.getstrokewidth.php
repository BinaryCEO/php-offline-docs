...
<head>
  ...
  <title>PHP: ImagickDraw::getStrokeWidth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getstrokewidth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getstrokewidth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokewidth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getstrokeopacity.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.gettextalignment.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokewidth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getstrokewidth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getstrokewidth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getstrokewidth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getstrokewidth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getstrokewidth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getstrokewidth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getstrokewidth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getstrokewidth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getstrokewidth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getstrokewidth.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::getStrokeWidth - Manual" />
...
<meta itemprop="name" content="PHP: ImagickDraw::getStrokeWidth - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.gettextalignment.php">
          ImagickDraw::getTextAlignment &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getstrokeopacity.php">
          &laquo; ImagickDraw::getStrokeOpacity        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getstrokewidth.php' selected="selected">English</option>
            <option value='de/imagickdraw.getstrokewidth.php'>German</option>
            <option value='es/imagickdraw.getstrokewidth.php'>Spanish</option>
            <option value='fr/imagickdraw.getstrokewidth.php'>French</option>
            <option value='it/imagickdraw.getstrokewidth.php'>Italian</option>
            <option value='ja/imagickdraw.getstrokewidth.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getstrokewidth.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getstrokewidth.php'>Russian</option>
            <option value='tr/imagickdraw.getstrokewidth.php'>Turkish</option>
            <option value='uk/imagickdraw.getstrokewidth.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getstrokewidth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getstrokewidth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getStrokeWidth</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getStrokeWidth</span> &mdash; <span class="dc-title">Returns the width of the stroke used to draw object outlines</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getstrokewidth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getStrokeWidth</strong></span>(): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getstrokewidth-returnvalues">
  ...
  <p class="para">
   Returns a <span class="type"><a href="language.types.float.php" class="type float">float</a></span> describing the stroke width.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getstrokewidth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getstrokewidth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getstrokewidth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getstrokewidth.php">＋<small>add a note</small></a></span>
