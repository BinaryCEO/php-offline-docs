...
<head>
  ...
  <title>PHP: ldap_get_values - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-get-values.php">
 <link rel="shorturl" href="https://www.php.net/ldap-get-values">
 <link rel="alternate" href="https://www.php.net/ldap-get-values" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-get-option.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-get-values-len.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-get-values.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-get-values.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-get-values.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-get-values.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-get-values.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-get-values.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-get-values.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-get-values.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-get-values.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-get-values.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-get-values.php" hreflang="zh">
...
<meta name="Description" content="Get all values from a result entry" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_get_values - Manual" />
<meta name="twitter:description" content="Get all values from a result entry" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_get_values - Manual" />
<meta itemprop="description" content="Get all values from a result entry" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get all values from a result entry" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ldap-get-values-len.php">
          ldap_get_values_len &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-get-option.php">
          &laquo; ldap_get_option        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-get-values.php' selected="selected">English</option>
            <option value='de/function.ldap-get-values.php'>German</option>
            <option value='es/function.ldap-get-values.php'>Spanish</option>
            <option value='fr/function.ldap-get-values.php'>French</option>
            <option value='it/function.ldap-get-values.php'>Italian</option>
            <option value='ja/function.ldap-get-values.php'>Japanese</option>
            <option value='pt_BR/function.ldap-get-values.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-get-values.php'>Russian</option>
            <option value='tr/function.ldap-get-values.php'>Turkish</option>
            <option value='uk/function.ldap-get-values.php'>Ukrainian</option>
            <option value='zh/function.ldap-get-values.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-get-values" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.ldap-get-values-examples">
  ...
  <p class="para">
   <div class="example" id="example-4637">
    <p><strong>Example #1 List all values of the &quot;mail&quot; attribute for a directory entry</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-get-values-len.php" class="function" rel="rdfs-seeAlso">ldap_get_values_len()</a> - Get all binary values from a result entry</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-get-values.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-get-values%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-get-values&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-get-values.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="13553">  <div class="votes">
    <div id="Vu13553">
    <a href="/manual/vote-note.php?id=13553&amp;page=function.ldap-get-values&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd13553">
    <a href="/manual/vote-note.php?id=13553&amp;page=function.ldap-get-values&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V13553" title="100% like this...">
    2
    </div>
  </div>
  <a href="#13553" class="name">
  <strong class="user"><em>software at inebria dot com</em></strong></a><a class="genanchor" href="#13553"> &para;</a><div class="date" title="2001-06-21 10:34"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom13553">
<div class="phpcode"><code><span class="html">It wasn't immediately obvious to me that the ldap_get_values function does not work with binary data - only strings.  If you fetch binary data with ldap_get_values you don't get a warning - just some trash.  For binary data you have to use ldap_get_values_len.</span></code></div>
  </div>
 </div>
  <div class="note" id="30667">  <div class="votes">
    <div id="Vu30667">
    <a href="/manual/vote-note.php?id=30667&amp;page=function.ldap-get-values&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd30667">
    <a href="/manual/vote-note.php?id=30667&amp;page=function.ldap-get-values&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V30667" title="50% like this...">
    0
    </div>
  </div>
  <a href="#30667" class="name">
  <strong class="user"><em>viper_sb at IGETTOMUCHSPAMhotmail dot com</em></strong></a><a class="genanchor" href="#30667"> &para;</a><div class="date" title="2003-03-25 06:24"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom30667">
<div class="phpcode"><code><span class="html">Well this took me a while to find the problem, so I'm posting in case someone else runs in to this.<br /><br />$sr = ldap_search($ds, "cn=me", "(objectclass=*)");<br />$entry = ldap_first_entry($ds, $sr);<br />do {<br />  // do other stuff<br />  $sr = "something else now";<br />  $values = ldap_get_values($ds, $entry, "attirib1");<br />  // do other stuff<br />} while ($entry = ldap_next_entry($ds, $entry));<br /><br />If you change the search resource $sr to something else even though it's not used again it will kill the page it'll be a blank page and if you view the code you'll get different things depending on something no idea what.<br /><br />This kepted happening I had forgotten I had used $sr so I was using it again and it would just not show the page whenever I used ldap_get_values, if this is a feature it would be nice to know. I haven't seen it happen with other functions.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-get-values&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-get-values.php">＋<small>add a note</small></a></div>
