...
<head>
  ...
  <title>PHP: IntlCalendar::setFirstDayOfWeek - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.setfirstdayofweek.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.setfirstdayofweek.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.setfirstdayofweek.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.setdatetime.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.setlenient.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.setfirstdayofweek.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlcalendar.setfirstdayofweek.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlcalendar.setfirstdayofweek.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlcalendar.setfirstdayofweek.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlcalendar.setfirstdayofweek.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlcalendar.setfirstdayofweek.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlcalendar.setfirstdayofweek.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlcalendar.setfirstdayofweek.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlcalendar.setfirstdayofweek.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlcalendar.setfirstdayofweek.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlcalendar.setfirstdayofweek.php" hreflang="zh">
...
<meta name="Description" content="Set the day on which the week is deemed to start" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::setFirstDayOfWeek - Manual" />
<meta name="twitter:description" content="Set the day on which the week is deemed to start" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::setFirstDayOfWeek - Manual" />
<meta itemprop="description" content="Set the day on which the week is deemed to start" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the day on which the week is deemed to start" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intlcalendar.setlenient.php">
          IntlCalendar::setLenient &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlcalendar.setdatetime.php">
          &laquo; IntlCalendar::setDateTime        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.setfirstdayofweek.php' selected="selected">English</option>
            <option value='de/intlcalendar.setfirstdayofweek.php'>German</option>
            <option value='es/intlcalendar.setfirstdayofweek.php'>Spanish</option>
            <option value='fr/intlcalendar.setfirstdayofweek.php'>French</option>
            <option value='it/intlcalendar.setfirstdayofweek.php'>Italian</option>
            <option value='ja/intlcalendar.setfirstdayofweek.php'>Japanese</option>
            <option value='pt_BR/intlcalendar.setfirstdayofweek.php'>Brazilian Portuguese</option>
            <option value='ru/intlcalendar.setfirstdayofweek.php'>Russian</option>
            <option value='tr/intlcalendar.setfirstdayofweek.php'>Turkish</option>
            <option value='uk/intlcalendar.setfirstdayofweek.php'>Ukrainian</option>
            <option value='zh/intlcalendar.setfirstdayofweek.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlcalendar.setfirstdayofweek" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlCalendar::setFirstDayOfWeek</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlCalendar::setFirstDayOfWeek</span> &mdash; <span class="dc-title">Set the day on which the week is deemed to start</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlcalendar.setfirstdayofweek-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>IntlCalendar::setFirstDayOfWeek</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$dayOfWeek</code></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>

  <p class="para rdfs-comment">
   Procedural style
  </p>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>intlcal_set_first_day_of_week</strong></span>(<span class="methodparam"><span class="type"><a href="class.intlcalendar.php" class="type IntlCalendar">IntlCalendar</a></span> <code class="parameter">$calendar</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$dayOfWeek</code></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <strong><code><a href="class.intlcalendar.php#intlcalendar.constants.field-week-of-year">IntlCalendar::FIELD_WEEK_OF_YEAR</a></code></strong> and
 ...
 <div class="refsect1 changelog" id="refsect1-intlcalendar.setfirstdayofweek-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-intlcalendar.setfirstdayofweek-examples">
  ...
  <p class="para">
   <div class="example" id="example-2616">
...
week of year     : 27</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/setfirstdayofweek.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.setfirstdayofweek%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.setfirstdayofweek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.setfirstdayofweek.php">＋<small>add a note</small></a></span>
