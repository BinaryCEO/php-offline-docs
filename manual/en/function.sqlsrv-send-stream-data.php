...
<head>
  ...
  <title>PHP: sqlsrv_send_stream_data - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sqlsrv-send-stream-data.php">
 <link rel="shorturl" href="https://www.php.net/sqlsrv-send-stream-data">
 <link rel="alternate" href="https://www.php.net/sqlsrv-send-stream-data" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sqlsrv-rows-affected.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sqlsrv-server-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sqlsrv-send-stream-data.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sqlsrv-send-stream-data.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sqlsrv-send-stream-data.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sqlsrv-send-stream-data.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sqlsrv-send-stream-data.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sqlsrv-send-stream-data.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sqlsrv-send-stream-data.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sqlsrv-send-stream-data.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sqlsrv-send-stream-data.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sqlsrv-send-stream-data.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sqlsrv-send-stream-data.php" hreflang="zh">
...
<meta name="Description" content="Sends data from parameter streams to the server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sqlsrv_send_stream_data - Manual" />
<meta name="twitter:description" content="Sends data from parameter streams to the server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sqlsrv_send_stream_data - Manual" />
<meta itemprop="description" content="Sends data from parameter streams to the server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sends data from parameter streams to the server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sqlsrv-server-info.php">
          sqlsrv_server_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sqlsrv-rows-affected.php">
          &laquo; sqlsrv_rows_affected        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sqlsrv-send-stream-data.php' selected="selected">English</option>
            <option value='de/function.sqlsrv-send-stream-data.php'>German</option>
            <option value='es/function.sqlsrv-send-stream-data.php'>Spanish</option>
            <option value='fr/function.sqlsrv-send-stream-data.php'>French</option>
            <option value='it/function.sqlsrv-send-stream-data.php'>Italian</option>
            <option value='ja/function.sqlsrv-send-stream-data.php'>Japanese</option>
            <option value='pt_BR/function.sqlsrv-send-stream-data.php'>Brazilian Portuguese</option>
            <option value='ru/function.sqlsrv-send-stream-data.php'>Russian</option>
            <option value='tr/function.sqlsrv-send-stream-data.php'>Turkish</option>
            <option value='uk/function.sqlsrv-send-stream-data.php'>Ukrainian</option>
            <option value='zh/function.sqlsrv-send-stream-data.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sqlsrv-send-stream-data" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.sqlsrv-send-stream-data-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sqlsrv_send_stream_data</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stmt</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-send-stream-data-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if there is more data to send and <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if there is not.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.sqlsrv-query.php" class="function" rel="rdfs-seeAlso">sqlsrv_query()</a> - Prepares and executes a query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlsrv/functions/sqlsrv-send-stream-data.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sqlsrv-send-stream-data%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sqlsrv-send-stream-data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-send-stream-data.php">＋<small>add a note</small></a></span>
