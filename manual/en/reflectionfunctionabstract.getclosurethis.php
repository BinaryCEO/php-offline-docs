...
<head>
  ...
  <title>PHP: ReflectionFunctionAbstract::getClosureThis - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurethis.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurethis.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurethis.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionfunctionabstract.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurescopeclass.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosureusedvariables.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurethis.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionfunctionabstract.getclosurethis.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionfunctionabstract.getclosurethis.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionfunctionabstract.getclosurethis.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionfunctionabstract.getclosurethis.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionfunctionabstract.getclosurethis.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionfunctionabstract.getclosurethis.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionfunctionabstract.getclosurethis.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionfunctionabstract.getclosurethis.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionfunctionabstract.getclosurethis.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionfunctionabstract.getclosurethis.php" hreflang="zh">
...
<meta name="Description" content="Returns the object which corresponds to $this inside a closure" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionFunctionAbstract::getClosureThis - Manual" />
<meta name="twitter:description" content="Returns the object which corresponds to $this inside a closure" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionFunctionAbstract::getClosureThis - Manual" />
<meta itemprop="description" content="Returns the object which corresponds to $this inside a closure" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the object which corresponds to $this inside a closure" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionfunctionabstract.getclosureusedvariables.php">
          ReflectionFunctionAbstract::getClosureUsedVariables &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionfunctionabstract.getclosurescopeclass.php">
          &laquo; ReflectionFunctionAbstract::getClosureScopeClass        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionfunctionabstract.getclosurethis.php' selected="selected">English</option>
            <option value='de/reflectionfunctionabstract.getclosurethis.php'>German</option>
            <option value='es/reflectionfunctionabstract.getclosurethis.php'>Spanish</option>
            <option value='fr/reflectionfunctionabstract.getclosurethis.php'>French</option>
            <option value='it/reflectionfunctionabstract.getclosurethis.php'>Italian</option>
            <option value='ja/reflectionfunctionabstract.getclosurethis.php'>Japanese</option>
            <option value='pt_BR/reflectionfunctionabstract.getclosurethis.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionfunctionabstract.getclosurethis.php'>Russian</option>
            <option value='tr/reflectionfunctionabstract.getclosurethis.php'>Turkish</option>
            <option value='uk/reflectionfunctionabstract.getclosurethis.php'>Ukrainian</option>
            <option value='zh/reflectionfunctionabstract.getclosurethis.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionfunctionabstract.getclosurethis" class="refentry">
...
object(ReflectionClass)#4 (1) {
  ...
  <div class="example" id="example-5557">
   <p><strong>Example #2 
    Example showcasing difference between
    <span class="methodname"><a href="reflectionfunctionabstract.getclosurecalledclass.php" class="methodname">ReflectionFunctionAbstract::getClosureCalledClass()</a></span>,
    <span class="methodname"><a href="reflectionfunctionabstract.getclosurescopeclass.php" class="methodname">ReflectionFunctionAbstract::getClosureScopeClass()</a></span>,
  ...
  <ul class="simplelist">
   ...
   <li><a href="language.oop5.late-static-bindings.php" class="xref">Late Static Bindings</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionfunctionabstract/getclosurethis.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionfunctionabstract.getclosurethis%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionfunctionabstract.getclosurethis&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionfunctionabstract.getclosurethis.php">＋<small>add a note</small></a></span>
