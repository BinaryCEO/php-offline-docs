...
<head>
  ...
  <title>PHP: Dom\AdjacentPosition - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/enum.dom-adjacentposition.php">
 <link rel="shorturl" href="https://www.php.net/dom-adjacentposition">
 <link rel="alternate" href="https://www.php.net/dom-adjacentposition" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/domxpath.registerphpfunctions.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-attr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/enum.dom-adjacentposition.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/enum.dom-adjacentposition.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/enum.dom-adjacentposition.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/enum.dom-adjacentposition.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/enum.dom-adjacentposition.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/enum.dom-adjacentposition.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/enum.dom-adjacentposition.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/enum.dom-adjacentposition.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/enum.dom-adjacentposition.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/enum.dom-adjacentposition.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/enum.dom-adjacentposition.php" hreflang="zh">
...
<meta name="Description" content="The Dom\AdjacentPosition Enum" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\AdjacentPosition - Manual" />
<meta name="twitter:description" content="The Dom\AdjacentPosition Enum" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\AdjacentPosition - Manual" />
<meta itemprop="description" content="The Dom\AdjacentPosition Enum" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\AdjacentPosition Enum" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="domxpath.registerphpfunctions.php">
          &laquo; DOMXPath::registerPhpFunctions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/enum.dom-adjacentposition.php' selected="selected">English</option>
            <option value='de/enum.dom-adjacentposition.php'>German</option>
            <option value='es/enum.dom-adjacentposition.php'>Spanish</option>
            <option value='fr/enum.dom-adjacentposition.php'>French</option>
            <option value='it/enum.dom-adjacentposition.php'>Italian</option>
            <option value='ja/enum.dom-adjacentposition.php'>Japanese</option>
            <option value='pt_BR/enum.dom-adjacentposition.php'>Brazilian Portuguese</option>
            <option value='ru/enum.dom-adjacentposition.php'>Russian</option>
            <option value='tr/enum.dom-adjacentposition.php'>Turkish</option>
            <option value='uk/enum.dom-adjacentposition.php'>Ukrainian</option>
            <option value='zh/enum.dom-adjacentposition.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="enum.dom-adjacentposition" class="reference">
   ...
   <div class="classsynopsis"><div class="classsynopsisinfo">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-adjacentposition.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fenum.dom-adjacentposition%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=enum.dom-adjacentposition&amp;repo=en&amp;redirect=https://www.php.net/manual/en/enum.dom-adjacentposition.php">＋<small>add a note</small></a></span>
