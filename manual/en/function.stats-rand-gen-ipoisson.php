...
<head>
  ...
  <title>PHP: stats_rand_gen_ipoisson - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-rand-gen-ipoisson.php">
 <link rel="shorturl" href="https://www.php.net/stats-rand-gen-ipoisson">
 <link rel="alternate" href="https://www.php.net/stats-rand-gen-ipoisson" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-rand-gen-int.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-rand-gen-iuniform.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-rand-gen-ipoisson.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-rand-gen-ipoisson.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-rand-gen-ipoisson.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-rand-gen-ipoisson.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-rand-gen-ipoisson.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-rand-gen-ipoisson.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-rand-gen-ipoisson.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-rand-gen-ipoisson.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-rand-gen-ipoisson.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-rand-gen-ipoisson.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-rand-gen-ipoisson.php" hreflang="zh">
...
<meta name="Description" content="Generates a single random deviate from a Poisson distribution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_rand_gen_ipoisson - Manual" />
<meta name="twitter:description" content="Generates a single random deviate from a Poisson distribution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_rand_gen_ipoisson - Manual" />
<meta itemprop="description" content="Generates a single random deviate from a Poisson distribution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generates a single random deviate from a Poisson distribution" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stats-rand-gen-iuniform.php">
          stats_rand_gen_iuniform &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-rand-gen-int.php">
          &laquo; stats_rand_gen_int        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-rand-gen-ipoisson.php' selected="selected">English</option>
            <option value='de/function.stats-rand-gen-ipoisson.php'>German</option>
            <option value='es/function.stats-rand-gen-ipoisson.php'>Spanish</option>
            <option value='fr/function.stats-rand-gen-ipoisson.php'>French</option>
            <option value='it/function.stats-rand-gen-ipoisson.php'>Italian</option>
            <option value='ja/function.stats-rand-gen-ipoisson.php'>Japanese</option>
            <option value='pt_BR/function.stats-rand-gen-ipoisson.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-rand-gen-ipoisson.php'>Russian</option>
            <option value='tr/function.stats-rand-gen-ipoisson.php'>Turkish</option>
            <option value='uk/function.stats-rand-gen-ipoisson.php'>Ukrainian</option>
            <option value='zh/function.stats-rand-gen-ipoisson.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-rand-gen-ipoisson" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_rand_gen_ipoisson</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_rand_gen_ipoisson</span> &mdash; <span class="dc-title">Generates a single random deviate from a Poisson distribution</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-rand-gen-ipoisson-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>stats_rand_gen_ipoisson</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$mu</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Returns a random deviate from the Poisson distribution with parameter <code class="parameter">mu</code>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.stats-rand-gen-ipoisson-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">mu</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-rand-gen-ipoisson-returnvalues">
  ...
  <p class="para">
   A random deviate
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-rand-gen-ipoisson.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-rand-gen-ipoisson%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-rand-gen-ipoisson&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-rand-gen-ipoisson.php">＋<small>add a note</small></a></span>
