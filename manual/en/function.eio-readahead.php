...
<head>
  ...
  <title>PHP: eio_readahead - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-readahead.php">
 <link rel="shorturl" href="https://www.php.net/eio-readahead">
 <link rel="alternate" href="https://www.php.net/eio-readahead" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-read.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-readdir.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-readahead.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-readahead.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-readahead.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-readahead.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-readahead.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-readahead.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-readahead.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-readahead.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-readahead.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-readahead.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-readahead.php" hreflang="zh">
...
<meta name="Description" content="Perform file readahead into page cache" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_readahead - Manual" />
<meta name="twitter:description" content="Perform file readahead into page cache" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_readahead - Manual" />
<meta itemprop="description" content="Perform file readahead into page cache" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Perform file readahead into page cache" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-readdir.php">
          eio_readdir &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-read.php">
          &laquo; eio_read        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-readahead.php' selected="selected">English</option>
            <option value='de/function.eio-readahead.php'>German</option>
            <option value='es/function.eio-readahead.php'>Spanish</option>
            <option value='fr/function.eio-readahead.php'>French</option>
            <option value='it/function.eio-readahead.php'>Italian</option>
            <option value='ja/function.eio-readahead.php'>Japanese</option>
            <option value='pt_BR/function.eio-readahead.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-readahead.php'>Russian</option>
            <option value='tr/function.eio-readahead.php'>Turkish</option>
            <option value='uk/function.eio-readahead.php'>Ukrainian</option>
            <option value='zh/function.eio-readahead.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-readahead" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_readahead</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_readahead</span> &mdash; <span class="dc-title">Perform file readahead into page cache</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-readahead-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_readahead</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
  <span class="function"><strong>eio_readahead()</strong></span> populates the page cache with data from a file so that subsequent reads from
  that file will not block on disk I/O. See <code class="literal">READAHEAD(2)</code> man page for details.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.eio-readahead-parameters">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-readahead-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_readahead()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-readahead.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-readahead%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-readahead&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-readahead.php">＋<small>add a note</small></a></span>
