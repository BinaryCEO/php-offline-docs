...
<head>
  ...
  <title>PHP: Imagick::getVersion - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getversion.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getversion.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getversion.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getsizeoffset.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.haldclutimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getversion.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getversion.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getversion.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getversion.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getversion.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getversion.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getversion.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getversion.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getversion.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getversion.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getversion.php" hreflang="zh">
...
<meta name="Description" content="Returns the ImageMagick API version" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getVersion - Manual" />
<meta name="twitter:description" content="Returns the ImageMagick API version" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getVersion - Manual" />
<meta itemprop="description" content="Returns the ImageMagick API version" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the ImageMagick API version" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.haldclutimage.php">
          Imagick::haldClutImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getsizeoffset.php">
          &laquo; Imagick::getSizeOffset        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getversion.php' selected="selected">English</option>
            <option value='de/imagick.getversion.php'>German</option>
            <option value='es/imagick.getversion.php'>Spanish</option>
            <option value='fr/imagick.getversion.php'>French</option>
            <option value='it/imagick.getversion.php'>Italian</option>
            <option value='ja/imagick.getversion.php'>Japanese</option>
            <option value='pt_BR/imagick.getversion.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getversion.php'>Russian</option>
            <option value='tr/imagick.getversion.php'>Turkish</option>
            <option value='uk/imagick.getversion.php'>Ukrainian</option>
            <option value='zh/imagick.getversion.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getversion" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getVersion</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getVersion</span> &mdash; <span class="dc-title">Returns the ImageMagick API version</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getversion-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::getVersion</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getversion-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getversion-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getversion-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getversion.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getversion%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getversion&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getversion.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="113757">  <div class="votes">
    <div id="Vu113757">
    <a href="/manual/vote-note.php?id=113757&amp;page=imagick.getversion&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113757">
    <a href="/manual/vote-note.php?id=113757&amp;page=imagick.getversion&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113757" title="80% like this...">
    3
    </div>
  </div>
  <a href="#113757" class="name">
  <strong class="user"><em>pasel at blueend dot com</em></strong></a><a class="genanchor" href="#113757"> &para;</a><div class="date" title="2013-11-27 01:18"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113757">
<div class="phpcode"><code><span class="html">You may check your version like this:<br /><br /><span class="default">&lt;?php<br />$v </span><span class="keyword">= </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">getVersion</span><span class="keyword">();<br /></span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/ImageMagick ([0-9]+\.[0-9]+\.[0-9]+)/'</span><span class="keyword">, </span><span class="default">$v</span><span class="keyword">[</span><span class="string">'versionString'</span><span class="keyword">], </span><span class="default">$v</span><span class="keyword">);<br />if(</span><span class="default">version_compare</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">],</span><span class="string">'6.2.8'</span><span class="keyword">)&lt;=</span><span class="default">0</span><span class="keyword">){<br />   print </span><span class="string">"Your ImageMagick Version </span><span class="keyword">{</span><span class="default">$v</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">]}</span><span class="string"> is '6.2.8' or older, please upgrade!"</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="102578">  <div class="votes">
    <div id="Vu102578">
    <a href="/manual/vote-note.php?id=102578&amp;page=imagick.getversion&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102578">
    <a href="/manual/vote-note.php?id=102578&amp;page=imagick.getversion&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102578" title="75% like this...">
    2
    </div>
  </div>
  <a href="#102578" class="name">
  <strong class="user"><em>mwu at digitaltorque dot com</em></strong></a><a class="genanchor" href="#102578"> &para;</a><div class="date" title="2011-02-22 11:40"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102578">
<div class="phpcode"><code><span class="html">Since it's not clear from the documention what this function returns:<br /><br />print_r(imagick::getVersion());<br /><br />Array<br />(<br />    [versionNumber] =&gt; 1632<br />    [versionString] =&gt; ImageMagick 6.6.0-4 2010-11-16 Q16 <a href="http://www.imagemagick.org" rel="nofollow" target="_blank">http://www.imagemagick.org</a><br />)</span></code></div>
  </div>
 </div>
  <div class="note" id="108585">  <div class="votes">
    <div id="Vu108585">
    <a href="/manual/vote-note.php?id=108585&amp;page=imagick.getversion&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108585">
    <a href="/manual/vote-note.php?id=108585&amp;page=imagick.getversion&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108585" title="50% like this...">
    0
    </div>
  </div>
  <a href="#108585" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108585"> &para;</a><div class="date" title="2012-05-08 11:37"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108585">
<div class="phpcode"><code><span class="html">The getVersion function for the ImageMagick class returns an array, with two values, one linked to the key value of 'versionNumber' and another linked to the key value of 'versionString'.  The version number provides a simple integer, while the string provides the actual x.y.z version number, the release date, and the URL for the ImageMagick site.<br /><br />Today (May 8, 2012), when calling this function, the results are...<br /><br />Number: 1654<br />String: ImageMagick 6.7.6-8 2012-05-02 Q16 <a href="http://www.imagemagick.org" rel="nofollow" target="_blank">http://www.imagemagick.org</a><br /><br />Last month (around April 15, 2012), when calling this function, the results were...<br /><br />Number: 1654<br />String: ImageMagick 6.7.6-1 2012-04-09 Q16 <a href="http://www.imagemagick.org" rel="nofollow" target="_blank">http://www.imagemagick.org</a><br /><br />So, I'm not sure why the "Number" value has not changed, but the "String" value is definitely responding to changes in time.<br /><br />The code for producing these results:<br /><br /><span class="default">&lt;?php<br /><br />        </span><span class="comment">// Author: holdoffhunger@gmail.com<br /><br />    </span><span class="default">$imagick_version </span><span class="keyword">= </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">getVersion</span><span class="keyword">();<br />    <br />    </span><span class="default">$imagick_version_number </span><span class="keyword">= </span><span class="default">$imagick_version</span><span class="keyword">[</span><span class="string">'versionNumber'</span><span class="keyword">];<br />    </span><span class="default">$imagick_version_string </span><span class="keyword">= </span><span class="default">$imagick_version</span><span class="keyword">[</span><span class="string">'versionString'</span><span class="keyword">];<br /><br />    print(</span><span class="string">"Number: </span><span class="default">$imagick_version_number</span><span class="string">"</span><span class="keyword">);<br /><br />    print(</span><span class="string">"&lt;br&gt;"</span><span class="keyword">);<br /><br />    print(</span><span class="string">"String: </span><span class="default">$imagick_version_string</span><span class="string">"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getversion&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getversion.php">＋<small>add a note</small></a></div>
