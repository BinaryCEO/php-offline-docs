...
<head>
  ...
  <title>PHP: EventBufferEvent::sslSocket - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/eventbufferevent.sslsocket.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/eventbufferevent.sslsocket.php">
 <link rel="alternate" href="https://www.php.net/manual/en/eventbufferevent.sslsocket.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.eventbufferevent.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventbufferevent.sslrenegotiate.php">
 <link rel="next" href="https://www.php.net/manual/en/eventbufferevent.write.php">

 <link rel="alternate" href="https://www.php.net/manual/en/eventbufferevent.sslsocket.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/eventbufferevent.sslsocket.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/eventbufferevent.sslsocket.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/eventbufferevent.sslsocket.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/eventbufferevent.sslsocket.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/eventbufferevent.sslsocket.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/eventbufferevent.sslsocket.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/eventbufferevent.sslsocket.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/eventbufferevent.sslsocket.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/eventbufferevent.sslsocket.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/eventbufferevent.sslsocket.php" hreflang="zh">
...
<meta name="Description" content="Creates a new SSL buffer event to send its data over an SSL on a socket" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventBufferEvent::sslSocket - Manual" />
<meta name="twitter:description" content="Creates a new SSL buffer event to send its data over an SSL on a socket" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventBufferEvent::sslSocket - Manual" />
<meta itemprop="description" content="Creates a new SSL buffer event to send its data over an SSL on a socket" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a new SSL buffer event to send its data over an SSL on a socket" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="eventbufferevent.write.php">
          EventBufferEvent::write &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="eventbufferevent.sslrenegotiate.php">
          &laquo; EventBufferEvent::sslRenegotiate        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/eventbufferevent.sslsocket.php' selected="selected">English</option>
            <option value='de/eventbufferevent.sslsocket.php'>German</option>
            <option value='es/eventbufferevent.sslsocket.php'>Spanish</option>
            <option value='fr/eventbufferevent.sslsocket.php'>French</option>
            <option value='it/eventbufferevent.sslsocket.php'>Italian</option>
            <option value='ja/eventbufferevent.sslsocket.php'>Japanese</option>
            <option value='pt_BR/eventbufferevent.sslsocket.php'>Brazilian Portuguese</option>
            <option value='ru/eventbufferevent.sslsocket.php'>Russian</option>
            <option value='tr/eventbufferevent.sslsocket.php'>Turkish</option>
            <option value='uk/eventbufferevent.sslsocket.php'>Ukrainian</option>
            <option value='zh/eventbufferevent.sslsocket.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="eventbufferevent.sslsocket" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">EventBufferEvent::sslSocket</h1>
  <p class="verinfo">(PECL event &gt;= 1.2.6-beta)</p><p class="refpurpose"><span class="refname">EventBufferEvent::sslSocket</span> &mdash; <span class="dc-title">Creates a new SSL buffer event to send its data over an SSL on a socket</span></p>
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      ...
      file descriptor, or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>. If
      <code class="parameter">socket</code>
      is <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>, it is assumed that the file descriptor for the socket will be
   ...
   <li>
    <span class="methodname"><a href="eventbufferevent.sslfilter.php" class="methodname" rel="rdfs-seeAlso">EventBufferEvent::sslFilter()</a> - Create a new SSL buffer event to send its data over another buffer event</span>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventbufferevent/sslsocket.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Feventbufferevent.sslsocket%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=eventbufferevent.sslsocket&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eventbufferevent.sslsocket.php">＋<small>add a note</small></a></span>
