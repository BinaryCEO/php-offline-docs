...
<head>
  ...
  <title>PHP: IntlCalendar::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.clear.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.createinstance.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlcalendar.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlcalendar.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlcalendar.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlcalendar.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlcalendar.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlcalendar.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlcalendar.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlcalendar.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlcalendar.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlcalendar.construct.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: IntlCalendar::__construct - Manual" />
<meta name="twitter:description" content="Private constructor for disallowing instantiation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::__construct - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlcalendar.createinstance.php">
          IntlCalendar::createInstance &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlcalendar.clear.php">
          &laquo; IntlCalendar::clear        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.construct.php' selected="selected">English</option>
            <option value='de/intlcalendar.construct.php'>German</option>
            <option value='es/intlcalendar.construct.php'>Spanish</option>
            <option value='fr/intlcalendar.construct.php'>French</option>
            <option value='it/intlcalendar.construct.php'>Italian</option>
            <option value='ja/intlcalendar.construct.php'>Japanese</option>
            <option value='pt_BR/intlcalendar.construct.php'>Brazilian Portuguese</option>
            <option value='ru/intlcalendar.construct.php'>Russian</option>
            <option value='tr/intlcalendar.construct.php'>Turkish</option>
            <option value='uk/intlcalendar.construct.php'>Ukrainian</option>
            <option value='zh/intlcalendar.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlcalendar.construct" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlCalendar::__construct</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlCalendar::__construct</span> &mdash; <span class="dc-title">Private constructor for disallowing instantiation</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-intlcalendar.construct-description">
  <h3 class="title">Description</h3>
  <div class="constructorsynopsis dc-description">
   <span class="modifier">private</span> <span class="methodname"><strong>IntlCalendar::__construct</strong></span>()</div>

  <p class="para rdfs-comment">
   A private constructor for disallowing instantiation with the
   <a href="language.oop5.basic.php#language.oop5.basic.new" class="link">new</a> operator.
  </p>
  <p class="para">
   Call <span class="function"><a href="intlcalendar.createinstance.php" class="function">IntlCalendar::createInstance()</a></span> instead.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-intlcalendar.construct-parameters">
  ...
  <p class="para">This function has no parameters.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.construct.php">＋<small>add a note</small></a></span>
