...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.issubclassof.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.issubclassof.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.issubclassof.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.isreadonly.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.istrait.php">
...
<meta name="Description" content="Checks if a subclass" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::isSubclassOf - Manual" />
<meta name="twitter:description" content="Checks if a subclass" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::isSubclassOf - Manual" />
<meta itemprop="description" content="Checks if a subclass" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if a subclass" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.issubclassof.php' selected="selected">English</option>
            <option value='de/reflectionclass.issubclassof.php'>German</option>
            <option value='es/reflectionclass.issubclassof.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::isSubclassOf</span> &mdash; <span class="dc-title">Checks if a subclass</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.issubclassof-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Either the name of the class as <span class="type"><a href="language.types.string.php" class="type string">string</a></span> or
       a <span class="type"><a href="class.reflectionclass.php" class="type ReflectionClass">ReflectionClass</a></span> object of the class to check against.
      </p>
     </dd>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.issubclassof-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionclass.implementsinterface.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::implementsInterface()</a> - Implements interface</span></li>
    ...
    <li><span class="function"><a href="function.get-parent-class.php" class="function" rel="rdfs-seeAlso">get_parent_class()</a> - Retrieves the parent class name for object or class</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/issubclassof.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.issubclassof%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.issubclassof&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.issubclassof.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>voitcus at gmail dot com</em></strong></a><a class="genanchor" href="#124330"> &para;</a><div class="date" title="2019-10-23 06:02"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124330">
<div class="phpcode"><code><span class="html">Note, that this method is a bit different than the `instanceof` operator, which returns true, when it is a subclass or the very same class (interface). Here, only being a subclass results in true, eg.<br /><br />class A {}<br />class B extends A {}<br /><br />$a = new ReflectionClass('A');<br />$AA = new A;<br />$b = new ReflectionClass('B');<br />$BB = new B;<br /><br />var_dump($a-&gt;isSubclassOf($b)); // false<br />var_dump($AA instanceof $BB); // false<br /><br />var_dump($b-&gt;isSubclassOf($a)); // true<br />var_dump($BB instanceof $AA); // true<br /><br />var_dump($a-&gt;isSubclassOf($a)); // false<br />var_dump($AA instanceof $AA); // true</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">class A {}<br />class B {}<br />class C extends B {}<br /><br />$obj=new ReflectionClass('C');<br /><br />var_dump($obj-&gt;isSubclassOf ('A')); //boolean false<br />var_dump($obj-&gt;isSubclassOf ('B')); //boolean true</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.issubclassof&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.issubclassof.php">＋<small>add a note</small></a></div>
