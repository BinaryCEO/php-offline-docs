...
<head>
  ...
  <title>PHP: Basic FFI usage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ffi.examples-basic.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ffi.examples-basic.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ffi.examples-basic.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ffi.examples.php">
 <link rel="prev" href="https://www.php.net/manual/en/ffi.examples.php">
 <link rel="next" href="https://www.php.net/manual/en/ffi.examples-callback.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ffi.examples-basic.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ffi.examples-basic.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ffi.examples-basic.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ffi.examples-basic.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ffi.examples-basic.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ffi.examples-basic.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ffi.examples-basic.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ffi.examples-basic.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ffi.examples-basic.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ffi.examples-basic.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ffi.examples-basic.php" hreflang="zh">
...
<meta name="Description" content="Basic FFI usage" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Basic FFI usage - Manual" />
<meta name="twitter:description" content="Basic FFI usage" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Basic FFI usage - Manual" />
<meta itemprop="description" content="Basic FFI usage" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Basic FFI usage" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ffi.examples-callback.php">
          PHP Callbacks &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ffi.examples.php">
          &laquo; Examples        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.basic.php.php'>Affecting PHP's Behaviour</a></li>      <li><a href='book.ffi.php'>FFI</a></li>      <li><a href='ffi.examples.php'>Examples</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ffi.examples-basic.php' selected="selected">English</option>
            <option value='de/ffi.examples-basic.php'>German</option>
            <option value='es/ffi.examples-basic.php'>Spanish</option>
            <option value='fr/ffi.examples-basic.php'>French</option>
            <option value='it/ffi.examples-basic.php'>Italian</option>
            <option value='ja/ffi.examples-basic.php'>Japanese</option>
            <option value='pt_BR/ffi.examples-basic.php'>Brazilian Portuguese</option>
            <option value='ru/ffi.examples-basic.php'>Russian</option>
            <option value='tr/ffi.examples-basic.php'>Turkish</option>
            <option value='uk/ffi.examples-basic.php'>Ukrainian</option>
            <option value='zh/ffi.examples-basic.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ffi.examples-basic" class="section">
...
int(3)
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ffi/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fffi.examples-basic%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ffi.examples-basic&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ffi.examples-basic.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125593">  <div class="votes">
    <div id="Vu125593">
    <a href="/manual/vote-note.php?id=125593&amp;page=ffi.examples-basic&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125593">
    <a href="/manual/vote-note.php?id=125593&amp;page=ffi.examples-basic&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125593" title="64% like this...">
    4
    </div>
  </div>
  <a href="#125593" class="name">
  <strong class="user"><em>wowabbs+php at gmail dot com</em></strong></a><a class="genanchor" href="#125593"> &para;</a><div class="date" title="2020-12-11 07:42"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125593">
<div class="phpcode"><code><span class="html">&lt;?<br />  if(!dl("ffi")) // Load the extension<br />      throw new Exception('Cound not load the FFI extension.');<br /><br />  function setWindowsDesktop($bmpFilePath)<br />  {<br />    define('SPI_SETDESKWALLPAPER'  , 0x14);<br />    define('SPIF_UPDATEINIFILE'    ,  0x1);<br />    define('SPIF_SENDWININICHANGE' ,  0x2);<br />    assert(File_Exists($bmpFilePath));<br />    <br />    // declare the Win32 API function used to change desktop settings.<br />    $User32 = FFI::cdef(&lt;&lt;&lt;'IDL'<br />      int SystemParametersInfoA(int uAction, int uParam, char *lpvParam, int fuWinIni);<br />    IDL, 'User32.dll');<br />    $Kernel32 = FFI::cdef(&lt;&lt;&lt;'IDL'<br />      int GetLastError();<br />    IDL, 'Kernel32.dll');<br />    // call the Windows API to update the desktop background.<br />    $Ret = $User32-&gt;SystemParametersInfoA(SPI_SETDESKWALLPAPER, 0, $bmpFilePath, SPIF_UPDATEINIFILE || SPIF_SENDWININICHANGE);<br />    if ($Ret == 0)<br />    {<br />      $Error = $Kernel32-&gt;GetLastError();<br />      throw new Exception("The call to the Windows API failed (error {$Error}).");<br />    }<br />  }<br />  <br />  $Url='<a href="https://www.php.net//images/news/phpkonf_2015.png" rel="nofollow" target="_blank">https://www.php.net//images/news/phpkonf_2015.png</a>';<br />  $Img=File_Get_Contents($Url);<br />  File_Put_Contents($File=basename($Url), $Img);<br />  setWindowsDesktop(realpath($File));<br />?&gt;</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=ffi.examples-basic&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ffi.examples-basic.php">＋<small>add a note</small></a></div>
</section>    </section><!-- layout-content -->
        <aside class='layout-menu'>

        <ul class='parent-menu-list'>
                                    <li>
                <a href="ffi.examples.php">Examples</a>

                                    <ul class='child-menu-list'>

                                                <li class="current">
                            <a href="ffi.examples-basic.php" title="Basic FFI usage">Basic FFI usage</a>
                        </li>
                                                <li class="">
                            <a href="ffi.examples-callback.php" title="PHP Callbacks">PHP Callbacks</a>
                        </li>
                                                <li class="">
                            <a href="ffi.examples-complete.php" title="A Complete PHP/FFI/preloading Example">A Complete PHP/FFI/preloading Example</a>
                        </li>
