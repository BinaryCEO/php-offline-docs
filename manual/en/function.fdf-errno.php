...
<head>
  ...
  <title>PHP: fdf_errno - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-errno.php">
 <link rel="shorturl" href="https://www.php.net/fdf-errno">
 <link rel="alternate" href="https://www.php.net/fdf-errno" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-enum-values.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdf-errno.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdf-errno.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdf-errno.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdf-errno.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdf-errno.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdf-errno.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdf-errno.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdf-errno.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdf-errno.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdf-errno.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdf-errno.php" hreflang="zh">
...
<meta name="Description" content="Return error code for last fdf operation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_errno - Manual" />
<meta name="twitter:description" content="Return error code for last fdf operation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_errno - Manual" />
<meta itemprop="description" content="Return error code for last fdf operation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return error code for last fdf operation" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-errno.php' selected="selected">English</option>
            <option value='de/function.fdf-errno.php'>German</option>
            <option value='es/function.fdf-errno.php'>Spanish</option>
            <option value='fr/function.fdf-errno.php'>French</option>
            <option value='it/function.fdf-errno.php'>Italian</option>
            <option value='ja/function.fdf-errno.php'>Japanese</option>
            <option value='pt_BR/function.fdf-errno.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdf-errno.php'>Russian</option>
            <option value='tr/function.fdf-errno.php'>Turkish</option>
            <option value='uk/function.fdf-errno.php'>Ukrainian</option>
            <option value='zh/function.fdf-errno.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdf-errno" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fdf_errno</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5 &lt; 5.3.0, PECL fdf SVN)</p><p class="refpurpose"><span class="refname">fdf_errno</span> &mdash; <span class="dc-title">Return error code for last fdf operation</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.fdf-errno-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fdf_errno</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
  ...
  <p class="para">
   ...
   <span class="function"><a href="function.fdf-error.php" class="function">fdf_error()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fdf-errno-parameters">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fdf-errno-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fdf-error.php" class="function" rel="rdfs-seeAlso">fdf_error()</a> - Return error description for FDF error code</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-errno.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-errno%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-errno.php">＋<small>add a note</small></a></span>
