...
<head>
  ...
  <title>PHP: ps_add_note - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-add-note.php">
 <link rel="shorturl" href="https://www.php.net/ps-add-note">
 <link rel="alternate" href="https://www.php.net/ps-add-note" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-add-locallink.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-add-pdflink.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-add-note.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-add-note.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-add-note.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-add-note.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-add-note.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-add-note.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-add-note.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-add-note.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-add-note.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-add-note.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-add-note.php" hreflang="zh">
...
<meta name="Description" content="Adds note to current page" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_add_note - Manual" />
<meta name="twitter:description" content="Adds note to current page" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_add_note - Manual" />
<meta itemprop="description" content="Adds note to current page" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds note to current page" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-add-pdflink.php">
          ps_add_pdflink &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-add-locallink.php">
          &laquo; ps_add_locallink        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-add-note.php' selected="selected">English</option>
            <option value='de/function.ps-add-note.php'>German</option>
            <option value='es/function.ps-add-note.php'>Spanish</option>
            <option value='fr/function.ps-add-note.php'>French</option>
            <option value='it/function.ps-add-note.php'>Italian</option>
            <option value='ja/function.ps-add-note.php'>Japanese</option>
            <option value='pt_BR/function.ps-add-note.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-add-note.php'>Russian</option>
            <option value='tr/function.ps-add-note.php'>Turkish</option>
            <option value='uk/function.ps-add-note.php'>Ukrainian</option>
            <option value='zh/function.ps-add-note.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-add-note" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_add_note</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_add_note</span> &mdash; <span class="dc-title">Adds note to current page</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-add-note-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_add_note</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$llx</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$lly</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$urx</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$ury</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$contents</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$title</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$icon</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$open</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
pdf by either Acrobat Distiller™ or Ghostview.</p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-add-note-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">icon</code></dt>
     <dd>
      <p class="para">
       The icon shown if the note is folded. This parameter can be set
       to <code class="literal">comment</code>, <code class="literal">insert</code>,
       <code class="literal">note</code>, <code class="literal">paragraph</code>,
       <code class="literal">newparagraph</code>, <code class="literal">key</code>, or
     ...
     <dd>
      <p class="para">
       If <code class="parameter">open</code> is unequal to zero the note will
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-add-note-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-add-note-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-add-weblink.php" class="function" rel="rdfs-seeAlso">ps_add_weblink()</a> - Adds link to a web location</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-add-note.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-add-note%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-add-note&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-add-note.php">＋<small>add a note</small></a></span>
