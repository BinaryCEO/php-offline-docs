...
<head>
  ...
  <title>PHP: Imagick::getImageIndex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageindex.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageindex.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageindex.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagehistogram.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageinterlacescheme.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageindex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageindex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageindex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageindex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageindex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageindex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageindex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageindex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageindex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageindex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageindex.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::getImageIndex - Manual" />
<meta name="twitter:description" content="Gets the index of the current active image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageIndex - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimageinterlacescheme.php">
          Imagick::getImageInterlaceScheme &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagehistogram.php">
          &laquo; Imagick::getImageHistogram        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageindex.php' selected="selected">English</option>
            <option value='de/imagick.getimageindex.php'>German</option>
            <option value='es/imagick.getimageindex.php'>Spanish</option>
            <option value='fr/imagick.getimageindex.php'>French</option>
            <option value='it/imagick.getimageindex.php'>Italian</option>
            <option value='ja/imagick.getimageindex.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageindex.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageindex.php'>Russian</option>
            <option value='tr/imagick.getimageindex.php'>Turkish</option>
            <option value='uk/imagick.getimageindex.php'>Ukrainian</option>
            <option value='zh/imagick.getimageindex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageindex" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageIndex</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageIndex</span> &mdash; <span class="dc-title">Gets the index of the current active image</span></p>

 </div>

 <div id="imagick.getimageindex-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimageindex-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageIndex</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Returns the index of the current active image within the Imagick object.
   This method has been deprecated. See
   <span class="function"><a href="imagick.getiteratorindex.php" class="function">Imagick::getIteratorIndex()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.getimageindex-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageindex-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimageindex-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageindex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageindex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageindex.php">＋<small>add a note</small></a></span>
