...
<head>
  ...
  <title>PHP: ImagickDraw::setFillAlpha - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setfillalpha.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setfillalpha.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfillalpha.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setclipunits.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setfillcolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfillalpha.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setfillalpha.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setfillalpha.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setfillalpha.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setfillalpha.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setfillalpha.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setfillalpha.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setfillalpha.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setfillalpha.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setfillalpha.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setfillalpha.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::setFillAlpha - Manual" />
...
<meta itemprop="name" content="PHP: ImagickDraw::setFillAlpha - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setfillcolor.php">
          ImagickDraw::setFillColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setclipunits.php">
          &laquo; ImagickDraw::setClipUnits        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setfillalpha.php' selected="selected">English</option>
            <option value='de/imagickdraw.setfillalpha.php'>German</option>
            <option value='es/imagickdraw.setfillalpha.php'>Spanish</option>
            <option value='fr/imagickdraw.setfillalpha.php'>French</option>
            <option value='it/imagickdraw.setfillalpha.php'>Italian</option>
            <option value='ja/imagickdraw.setfillalpha.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setfillalpha.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setfillalpha.php'>Russian</option>
            <option value='tr/imagickdraw.setfillalpha.php'>Turkish</option>
            <option value='uk/imagickdraw.setfillalpha.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setfillalpha.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setfillalpha" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setFillAlpha</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setFillAlpha</span> &mdash; <span class="dc-title">Sets the opacity to use when drawing using the fill color or fill texture</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setfillalpha-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setFillAlpha</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$alpha</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setfillalpha-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setfillalpha-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3170">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setfillalpha.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setfillalpha%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setfillalpha&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfillalpha.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="79639">  <div class="votes">
    <div id="Vu79639">
    <a href="/manual/vote-note.php?id=79639&amp;page=imagickdraw.setfillalpha&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd79639">
    <a href="/manual/vote-note.php?id=79639&amp;page=imagickdraw.setfillalpha&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V79639" title="66% like this...">
    2
    </div>
  </div>
  <a href="#79639" class="name">
  <strong class="user"><em>Mark van der Velden</em></strong></a><a class="genanchor" href="#79639"> &para;</a><div class="date" title="2007-12-06 01:37"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom79639">
<div class="phpcode"><code><span class="html">setFillAlpha is deprecated use the replacement: setFillOpacity</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.setfillalpha&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfillalpha.php">＋<small>add a note</small></a></div>
