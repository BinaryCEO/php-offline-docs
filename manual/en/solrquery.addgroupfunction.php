...
<head>
  ...
  <title>PHP: SolrQuery::addGroupFunction - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addgroupfunction.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addgroupfunction.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addgroupfunction.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addgroupfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addgroupquery.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addgroupfunction.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addgroupfunction.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addgroupfunction.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addgroupfunction.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addgroupfunction.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addgroupfunction.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addgroupfunction.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addgroupfunction.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addgroupfunction.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addgroupfunction.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addgroupfunction.php" hreflang="zh">
...
<meta name="Description" content="Allows grouping results based on the unique values of a function query (group.func parameter)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addGroupFunction - Manual" />
<meta name="twitter:description" content="Allows grouping results based on the unique values of a function query (group.func parameter)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addGroupFunction - Manual" />
<meta itemprop="description" content="Allows grouping results based on the unique values of a function query (group.func parameter)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Allows grouping results based on the unique values of a function query (group.func parameter)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.addgroupquery.php">
          SolrQuery::addGroupQuery &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addgroupfield.php">
          &laquo; SolrQuery::addGroupField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addgroupfunction.php' selected="selected">English</option>
            <option value='de/solrquery.addgroupfunction.php'>German</option>
            <option value='es/solrquery.addgroupfunction.php'>Spanish</option>
            <option value='fr/solrquery.addgroupfunction.php'>French</option>
            <option value='it/solrquery.addgroupfunction.php'>Italian</option>
            <option value='ja/solrquery.addgroupfunction.php'>Japanese</option>
            <option value='pt_BR/solrquery.addgroupfunction.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addgroupfunction.php'>Russian</option>
            <option value='tr/solrquery.addgroupfunction.php'>Turkish</option>
            <option value='uk/solrquery.addgroupfunction.php'>Ukrainian</option>
            <option value='zh/solrquery.addgroupfunction.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addgroupfunction" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addGroupFunction</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::addGroupFunction</span> &mdash; <span class="dc-title">Allows grouping results based on the unique values of a function query (group.func parameter)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addgroupfunction-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addGroupFunction</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.addgroupfunction-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addgroupfunction-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.addgroupfunction-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.setgroupcachepercent.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupCachePercent()</a> - Enables caching for result grouping</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addgroupfunction.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addgroupfunction%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addgroupfunction&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addgroupfunction.php">＋<small>add a note</small></a></span>
