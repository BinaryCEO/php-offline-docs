...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-get-opt.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-get-flags.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-get-status.php">
...
<meta name="Description" content="Gets a value from the opt array of a field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_get_opt - Manual" />
<meta name="twitter:description" content="Gets a value from the opt array of a field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_get_opt - Manual" />
<meta itemprop="description" content="Gets a value from the opt array of a field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets a value from the opt array of a field" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-get-opt.php' selected="selected">English</option>
            ...
            <option value='ru/function.fdf-get-opt.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5 &lt; 5.3.0, PECLv)</p><p class="refpurpose"><span class="refname">fdf_get_opt</span> &mdash; <span class="dc-title">Gets a value from the opt array of a field</span></p>
...
currently not documented; only its argument list is available.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-get-opt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-get-opt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-get-opt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-get-opt.php">＋<small>add a note</small></a></span>
