...
<head>
  ...
  <title>PHP: random_bytes - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.random-bytes.php">
 <link rel="shorturl" href="https://www.php.net/random-bytes">
 <link rel="alternate" href="https://www.php.net/random-bytes" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.random.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.rand.php">
 <link rel="next" href="https://www.php.net/manual/en/function.random-int.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.random-bytes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.random-bytes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.random-bytes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.random-bytes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.random-bytes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.random-bytes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.random-bytes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.random-bytes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.random-bytes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.random-bytes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.random-bytes.php" hreflang="zh">
...
<meta name="Description" content="Get cryptographically secure random bytes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: random_bytes - Manual" />
<meta name="twitter:description" content="Get cryptographically secure random bytes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: random_bytes - Manual" />
<meta itemprop="description" content="Get cryptographically secure random bytes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get cryptographically secure random bytes" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.random-bytes.php' selected="selected">English</option>
            <option value='de/function.random-bytes.php'>German</option>
            <option value='es/function.random-bytes.php'>Spanish</option>
            <option value='fr/function.random-bytes.php'>French</option>
            <option value='it/function.random-bytes.php'>Italian</option>
            <option value='ja/function.random-bytes.php'>Japanese</option>
            <option value='pt_BR/function.random-bytes.php'>Brazilian Portuguese</option>
            <option value='ru/function.random-bytes.php'>Russian</option>
            <option value='tr/function.random-bytes.php'>Turkish</option>
            <option value='uk/function.random-bytes.php'>Ukrainian</option>
            <option value='zh/function.random-bytes.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.random-bytes" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.base64-encode.php" class="function" rel="rdfs-seeAlso">base64_encode()</a> - Encodes data with MIME base64</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/random/functions/random-bytes.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.random-bytes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.random-bytes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.random-bytes.php">＋<small>add a note</small></a></span>
