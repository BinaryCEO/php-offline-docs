...
<head>
  ...
  <title>PHP: mysqli_stmt::result_metadata - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-stmt.result-metadata.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-stmt.result-metadata.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-stmt.result-metadata.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-stmt.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-stmt.reset.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-stmt.send-long-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-stmt.result-metadata.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli-stmt.result-metadata.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli-stmt.result-metadata.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli-stmt.result-metadata.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli-stmt.result-metadata.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli-stmt.result-metadata.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli-stmt.result-metadata.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli-stmt.result-metadata.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli-stmt.result-metadata.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli-stmt.result-metadata.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli-stmt.result-metadata.php" hreflang="zh">
...
<meta name="Description" content="Returns result set metadata from a prepared statement" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_stmt::result_metadata - Manual" />
<meta name="twitter:description" content="Returns result set metadata from a prepared statement" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_stmt::result_metadata - Manual" />
<meta itemprop="description" content="Returns result set metadata from a prepared statement" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns result set metadata from a prepared statement" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli-stmt.send-long-data.php">
          mysqli_stmt::send_long_data &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli-stmt.reset.php">
          &laquo; mysqli_stmt::reset        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-stmt.result-metadata.php' selected="selected">English</option>
            <option value='de/mysqli-stmt.result-metadata.php'>German</option>
            <option value='es/mysqli-stmt.result-metadata.php'>Spanish</option>
            <option value='fr/mysqli-stmt.result-metadata.php'>French</option>
            <option value='it/mysqli-stmt.result-metadata.php'>Italian</option>
            <option value='ja/mysqli-stmt.result-metadata.php'>Japanese</option>
            <option value='pt_BR/mysqli-stmt.result-metadata.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli-stmt.result-metadata.php'>Russian</option>
            <option value='tr/mysqli-stmt.result-metadata.php'>Turkish</option>
            <option value='uk/mysqli-stmt.result-metadata.php'>Ukrainian</option>
            <option value='zh/mysqli-stmt.result-metadata.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli-stmt.result-metadata" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-mysqli-stmt.result-metadata-description">
  ...
  <p class="para">
   ...
   which you can do by passing it to <span class="function"><a href="mysqli-result.free.php" class="function">mysqli_free_result()</a></span>
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    The result set returned by <span class="function"><strong>mysqli_stmt_result_metadata()</strong></span> contains only
    metadata. It does not contain any row results. The rows are obtained by using the
    statement handle with <span class="function"><a href="mysqli-stmt.fetch.php" class="function">mysqli_stmt_fetch()</a></span>.
   </p>
  </p></blockquote>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli-result.free.php" class="function" rel="rdfs-seeAlso">mysqli_free_result()</a> - Frees the memory associated with a result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_stmt/result-metadata.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli-stmt.result-metadata%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli-stmt.result-metadata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-stmt.result-metadata.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="97338">  <div class="votes">
    <div id="Vu97338">
    <a href="/manual/vote-note.php?id=97338&amp;page=mysqli-stmt.result-metadata&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd97338">
    <a href="/manual/vote-note.php?id=97338&amp;page=mysqli-stmt.result-metadata&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V97338" title="87% like this...">
    24
    </div>
  </div>
  <a href="#97338" class="name">
  <strong class="user"><em>potherca at gmail dot com</em></strong></a><a class="genanchor" href="#97338"> &para;</a><div class="date" title="2010-04-15 12:52"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97338">
<div class="phpcode"><code><span class="html">If result_metadata() returns false but error/errno/sqlstate tells you no error occurred, this means your query is one that does not produce a result set, i.e. an INSERT/UPDATE/DELETE query instead of a SELECT query.<br /><br />This is stated in the documentation where it says "If a statement passed to mysqli_prepare() is one that produces a result set, mysqli_stmt_result_metadata() returns the result object", but it might not be clear to everyone what this entails exactly. <br /><br />Hope this helps.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli-stmt.result-metadata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-stmt.result-metadata.php">＋<small>add a note</small></a></div>
