...
<head>
  ...
  <title>PHP: openssl_digest - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-digest.php">
 <link rel="shorturl" href="https://www.php.net/openssl-digest">
 <link rel="alternate" href="https://www.php.net/openssl-digest" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-dh-compute-key.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-encrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-digest.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-digest.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-digest.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-digest.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-digest.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-digest.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-digest.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-digest.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-digest.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-digest.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-digest.php" hreflang="zh">
...
<meta name="Description" content="Computes a digest" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_digest - Manual" />
<meta name="twitter:description" content="Computes a digest" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_digest - Manual" />
<meta itemprop="description" content="Computes a digest" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Computes a digest" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-encrypt.php">
          openssl_encrypt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-dh-compute-key.php">
          &laquo; openssl_dh_compute_key        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-digest.php' selected="selected">English</option>
            <option value='de/function.openssl-digest.php'>German</option>
            <option value='es/function.openssl-digest.php'>Spanish</option>
            <option value='fr/function.openssl-digest.php'>French</option>
            <option value='it/function.openssl-digest.php'>Italian</option>
            <option value='ja/function.openssl-digest.php'>Japanese</option>
            <option value='pt_BR/function.openssl-digest.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-digest.php'>Russian</option>
            <option value='tr/function.openssl-digest.php'>Turkish</option>
            <option value='uk/function.openssl-digest.php'>Ukrainian</option>
            <option value='zh/function.openssl-digest.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-digest" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.openssl-digest-returnvalues">
  ...
  <p class="para">
   Returns the digested hash value on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.openssl-get-md-methods.php" class="function" rel="rdfs-seeAlso">openssl_get_md_methods()</a> - Gets available digest methods</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-digest.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-digest%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-digest&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-digest.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="112963">  <div class="votes">
    <div id="Vu112963">
    <a href="/manual/vote-note.php?id=112963&amp;page=function.openssl-digest&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112963">
    <a href="/manual/vote-note.php?id=112963&amp;page=function.openssl-digest&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112963" title="63% like this...">
    10
    </div>
  </div>
  <a href="#112963" class="name">
  <strong class="user"><em>mwgamera at gmail dot com</em></strong></a><a class="genanchor" href="#112963"> &para;</a><div class="date" title="2013-08-12 11:42"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112963">
<div class="phpcode"><code><span class="html">The second argument should be one of the values returned by openssl_get_md_methods() rather than hash_algos(). ‘Hash’ and ‘OpenSSL’ are independent extensions and support different selection of digest algorithms. Notably, Hash supports some non-cryptographic hashes like adler or crc.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-digest&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-digest.php">＋<small>add a note</small></a></div>
