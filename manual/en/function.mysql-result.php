...
<head>
  ...
  <title>PHP: mysql_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-result.php">
 <link rel="shorturl" href="https://www.php.net/mysql-result">
 <link rel="alternate" href="https://www.php.net/mysql-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-real-escape-string.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-select-db.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-result.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mysql_result - Manual" />
<meta name="twitter:description" content="Get result data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_result - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-select-db.php">
          mysql_select_db &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-real-escape-string.php">
          &laquo; mysql_real_escape_string        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-result.php' selected="selected">English</option>
            <option value='de/function.mysql-result.php'>German</option>
            <option value='es/function.mysql-result.php'>Spanish</option>
            <option value='fr/function.mysql-result.php'>French</option>
            <option value='it/function.mysql-result.php'>Italian</option>
            <option value='ja/function.mysql-result.php'>Japanese</option>
            <option value='pt_BR/function.mysql-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-result.php'>Russian</option>
            <option value='tr/function.mysql-result.php'>Turkish</option>
            <option value='uk/function.mysql-result.php'>Ukrainian</option>
            <option value='zh/function.mysql-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-result" class="refentry">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li>
     <span class="function"><a href="mysqli-result.data-seek.php" class="function">mysqli_data_seek()</a></span> in conjunction with
 ...
 <div class="refsect1 description" id="refsect1-function.mysql-result-description">
  ...
  <p class="para">
   ...
   <span class="function"><strong>mysql_result()</strong></span>.  Also, note that specifying a
...
<span class="function"><a href="function.mysql-query.php" class="function">mysql_query()</a></span>.</p></dd>
     ...
     <dd>
      <p class="para">
       ...
       start at <code class="literal">0</code>.
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-result-examples">
  ...
  <p class="para">
   <div class="example" id="example-1923">
    <p><strong>Example #1 <span class="function"><strong>mysql_result()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$link </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">, </span><span style="color: #DD0000">'mysql_user'</span><span style="color: #007700">, </span><span style="color: #DD0000">'mysql_password'</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$link</span><span style="color: #007700">) {<br />    die(</span><span style="color: #DD0000">'Could not connect: ' </span><span style="color: #007700">. </span><span style="color: #0000BB">mysql_error</span><span style="color: #007700">());<br />}<br />if (!</span><span style="color: #0000BB">mysql_select_db</span><span style="color: #007700">(</span><span style="color: #DD0000">'database_name'</span><span style="color: #007700">)) {<br />    die(</span><span style="color: #DD0000">'Could not select database: ' </span><span style="color: #007700">. </span><span style="color: #0000BB">mysql_error</span><span style="color: #007700">());<br />}<br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_query</span><span style="color: #007700">(</span><span style="color: #DD0000">'SELECT name FROM work.employee'</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$result</span><span style="color: #007700">) {<br />    die(</span><span style="color: #DD0000">'Could not query:' </span><span style="color: #007700">. </span><span style="color: #0000BB">mysql_error</span><span style="color: #007700">());<br />}<br />echo </span><span style="color: #0000BB">mysql_result</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">); </span><span style="color: #FF8000">// outputs third employee's name<br /><br /></span><span style="color: #0000BB">mysql_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$link</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.mysql-result-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    Calls to <span class="function"><strong>mysql_result()</strong></span> should not be mixed
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-fetch-object.php" class="function" rel="rdfs-seeAlso">mysql_fetch_object()</a> - Fetch a result row as an object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-result.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116670">  <div class="votes">
    <div id="Vu116670">
    <a href="/manual/vote-note.php?id=116670&amp;page=function.mysql-result&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116670">
    <a href="/manual/vote-note.php?id=116670&amp;page=function.mysql-result&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116670" title="55% like this...">
    17
    </div>
  </div>
  <a href="#116670" class="name">
  <strong class="user"><em>freedman at FreeFormIT dot com</em></strong></a><a class="genanchor" href="#116670"> &para;</a><div class="date" title="2015-02-08 10:08"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116670">
<div class="phpcode"><code><span class="html">here's a rough replacement using mysqli:<br /><br />if (!function_exists('mysql_result')) {<br />    function mysql_result($result, $number, $field=0) {<br />        mysqli_data_seek($result, $number);<br />        $row = mysqli_fetch_array($result);<br />        return $row[$field];<br />    }<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mysql-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-result.php">＋<small>add a note</small></a></div>
