...
<head>
  ...
  <title>PHP: Basic enumerations - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.enumerations.basics.php">
 <link rel="shorturl" href="https://www.php.net/enumerations.basics">
 <link rel="alternate" href="https://www.php.net/enumerations.basics" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.enumerations.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.enumerations.overview.php">
 <link rel="next" href="https://www.php.net/manual/en/language.enumerations.backed.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.enumerations.basics.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.enumerations.basics.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.enumerations.basics.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.enumerations.basics.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.enumerations.basics.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.enumerations.basics.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.enumerations.basics.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.enumerations.basics.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.enumerations.basics.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.enumerations.basics.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.enumerations.basics.php" hreflang="zh">
...
<meta name="Description" content="Basic enumerations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Basic enumerations - Manual" />
<meta name="twitter:description" content="Basic enumerations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Basic enumerations - Manual" />
<meta itemprop="description" content="Basic enumerations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Basic enumerations" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="language.enumerations.backed.php">
          Backed enumerations &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="language.enumerations.overview.php">
          &laquo; Enumerations overview        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.enumerations.basics.php' selected="selected">English</option>
            <option value='de/language.enumerations.basics.php'>German</option>
            <option value='es/language.enumerations.basics.php'>Spanish</option>
            <option value='fr/language.enumerations.basics.php'>French</option>
            <option value='it/language.enumerations.basics.php'>Italian</option>
            <option value='ja/language.enumerations.basics.php'>Japanese</option>
            <option value='pt_BR/language.enumerations.basics.php'>Brazilian Portuguese</option>
            <option value='ru/language.enumerations.basics.php'>Russian</option>
            <option value='tr/language.enumerations.basics.php'>Turkish</option>
            <option value='uk/language.enumerations.basics.php'>Ukrainian</option>
            <option value='zh/language.enumerations.basics.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="language.enumerations.basics" class="sect1">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #007700">function </span><span style="color: #0000BB">pick_a_card</span><span style="color: #007700">(</span><span style="color: #0000BB">Suit $suit</span><span style="color: #007700">)<br />{<br />    </span><span style="color: #FF8000">/* ... */<br /></span><span style="color: #007700">}<br /><br /></span><span style="color: #0000BB">$val </span><span style="color: #007700">= </span><span style="color: #0000BB">Suit</span><span style="color: #007700">::</span><span style="color: #0000BB">Diamonds</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">// OK<br /></span><span style="color: #0000BB">pick_a_card</span><span style="color: #007700">(</span><span style="color: #0000BB">$val</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// OK<br /></span><span style="color: #0000BB">pick_a_card</span><span style="color: #007700">(</span><span style="color: #0000BB">Suit</span><span style="color: #007700">::</span><span style="color: #0000BB">Clubs</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// TypeError: pick_a_card(): Argument #1 ($suit) must be of type Suit, string given<br /></span><span style="color: #0000BB">pick_a_card</span><span style="color: #007700">(</span><span style="color: #DD0000">'Spades'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   ...
   <p class="para">
    ...
    <a href="language.constants.php" class="link">Constants</a>.
   </p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$a </span><span style="color: #007700">= </span><span style="color: #0000BB">Suit</span><span style="color: #007700">::</span><span style="color: #0000BB">Spades</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$b </span><span style="color: #007700">= </span><span style="color: #0000BB">Suit</span><span style="color: #007700">::</span><span style="color: #0000BB">Spades</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">$a </span><span style="color: #007700">=== </span><span style="color: #0000BB">$b</span><span style="color: #007700">; </span><span style="color: #FF8000">// true<br /><br /></span><span style="color: #0000BB">$a </span><span style="color: #007700">instanceof </span><span style="color: #0000BB">Suit</span><span style="color: #007700">;  </span><span style="color: #FF8000">// true<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   ...
   <p class="para">
    ...
    <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> when working with enum values.
   </p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #007700">print </span><span style="color: #0000BB">Suit</span><span style="color: #007700">::</span><span style="color: #0000BB">Spades</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">name</span><span style="color: #007700">;<br /></span><span style="color: #FF8000">// prints "Spades"<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   ...
   <p class="para">
    It is also possible to use the <span class="function"><a href="function.defined.php" class="function">defined()</a></span> and <span class="function"><a href="function.constant.php" class="function">constant()</a></span>
    functions to check for the existence of or read an enum case if the name is obtained dynamically.
    This is, however, discouraged as using <a href="language.enumerations.backed.php" class="link">Backed enums</a>
    should work for most use cases.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.enumerations.basics%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.enumerations.basics&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.enumerations.basics.php">＋<small>add a note</small></a></span>
