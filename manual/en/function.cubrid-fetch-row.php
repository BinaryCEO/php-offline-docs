...
<head>
  ...
  <title>PHP: cubrid_fetch_row - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-fetch-row.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-fetch-row">
 <link rel="alternate" href="https://www.php.net/cubrid-fetch-row" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/cubridmysql.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-fetch-object.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-field-flags.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-fetch-row.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-fetch-row.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-fetch-row.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-fetch-row.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-fetch-row.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-fetch-row.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-fetch-row.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-fetch-row.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-fetch-row.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-fetch-row.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-fetch-row.php" hreflang="zh">
...
<meta name="Description" content="Return a numerical array with the values of the current row" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_fetch_row - Manual" />
<meta name="twitter:description" content="Return a numerical array with the values of the current row" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_fetch_row - Manual" />
<meta itemprop="description" content="Return a numerical array with the values of the current row" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return a numerical array with the values of the current row" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-field-flags.php">
          cubrid_field_flags &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-fetch-object.php">
          &laquo; cubrid_fetch_object        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-fetch-row.php' selected="selected">English</option>
            <option value='de/function.cubrid-fetch-row.php'>German</option>
            <option value='es/function.cubrid-fetch-row.php'>Spanish</option>
            <option value='fr/function.cubrid-fetch-row.php'>French</option>
            <option value='it/function.cubrid-fetch-row.php'>Italian</option>
            <option value='ja/function.cubrid-fetch-row.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-fetch-row.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-fetch-row.php'>Russian</option>
            <option value='tr/function.cubrid-fetch-row.php'>Turkish</option>
            <option value='uk/function.cubrid-fetch-row.php'>Ukrainian</option>
            <option value='zh/function.cubrid-fetch-row.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-fetch-row" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_fetch_row</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_fetch_row</span> &mdash; <span class="dc-title">Return a numerical array with the values of the current row</span></p>
 ...
 <p class="para">
  <dl>
    ...
    <dd><p class="para">Type can only be CUBRID_LOB, this parameter will be used
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-fetch-object.php" class="function" rel="rdfs-seeAlso">cubrid_fetch_object()</a> - Fetch the next row and return it as an object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/cubridmysql/cubrid-fetch-row.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-fetch-row%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-fetch-row&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-fetch-row.php">＋<small>add a note</small></a></span>
