...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-stmt-error.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-statistics.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-stmt-errormsg.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-stmt-error.php' selected="selected">English</option>
            ...
            <option value='tr/function.db2-stmt-error.php'>Turkish</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-stmt-errormsg.php" class="function" rel="rdfs-seeAlso">db2_stmt_errormsg()</a> - Returns a string containing the last SQL statement error message</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-stmt-error.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-stmt-error%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-stmt-error&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-stmt-error.php">＋<small>add a note</small></a></span>
