...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/zookeeper.getclientid.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/zookeeper.getclientid.php">
 <link rel="alternate" href="https://www.php.net/manual/en/zookeeper.getclientid.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.zookeeper.php">
 <link rel="prev" href="https://www.php.net/manual/en/zookeeper.getchildren.php">
 <link rel="next" href="https://www.php.net/manual/en/zookeeper.getconfig.php">
...
<meta name="Description" content="Return the client session id, only valid if the connections is currently connected (ie. last watcher state is ZOO_CONNECTED_STATE)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Zookeeper::getClientId - Manual" />
<meta name="twitter:description" content="Return the client session id, only valid if the connections is currently connected (ie. last watcher state is ZOO_CONNECTED_STATE)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Zookeeper::getClientId - Manual" />
<meta itemprop="description" content="Return the client session id, only valid if the connections is currently connected (ie. last watcher state is ZOO_CONNECTED_STATE)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the client session id, only valid if the connections is currently connected (ie. last watcher state is ZOO_CONNECTED_STATE)" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/zookeeper.getclientid.php' selected="selected">English</option>
            ...
            <option value='pt_BR/zookeeper.getclientid.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL zookeeper &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">Zookeeper::getClientId</span> &mdash; <span class="dc-title">Return the client session id, only valid if the connections is currently connected (ie. last watcher state is ZOO_CONNECTED_STATE)</span></p>
 ...
 <div class="refsect1 seealso" id="refsect1-zookeeper.getclientid-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="zookeeper.getstate.php" class="methodname" rel="rdfs-seeAlso">Zookeeper::getState()</a> - Get the state of the zookeeper connection</span></li>
   ...
   <li><span class="classname"><a href="class.zookeeperexception.php" class="classname">ZookeeperException</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeeper/getclientid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fzookeeper.getclientid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=zookeeper.getclientid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zookeeper.getclientid.php">＋<small>add a note</small></a></span>
