...
<head>
  ...
  <title>PHP: stream_register_wrapper - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-register-wrapper.php">
 <link rel="shorturl" href="https://www.php.net/stream-register-wrapper">
 <link rel="alternate" href="https://www.php.net/stream-register-wrapper" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-notification-callback.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-resolve-include-path.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-register-wrapper.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-register-wrapper.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-register-wrapper.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-register-wrapper.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-register-wrapper.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-register-wrapper.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-register-wrapper.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-register-wrapper.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-register-wrapper.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-register-wrapper.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-register-wrapper.php" hreflang="zh">
...
<meta name="Description" content="Alias of stream_wrapper_register" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_register_wrapper - Manual" />
<meta name="twitter:description" content="Alias of stream_wrapper_register" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_register_wrapper - Manual" />
<meta itemprop="description" content="Alias of stream_wrapper_register" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of stream_wrapper_register" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-resolve-include-path.php">
          stream_resolve_include_path &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-notification-callback.php">
          &laquo; stream_notification_callback        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-register-wrapper.php' selected="selected">English</option>
            <option value='de/function.stream-register-wrapper.php'>German</option>
            <option value='es/function.stream-register-wrapper.php'>Spanish</option>
            <option value='fr/function.stream-register-wrapper.php'>French</option>
            <option value='it/function.stream-register-wrapper.php'>Italian</option>
            <option value='ja/function.stream-register-wrapper.php'>Japanese</option>
            <option value='pt_BR/function.stream-register-wrapper.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-register-wrapper.php'>Russian</option>
            <option value='tr/function.stream-register-wrapper.php'>Turkish</option>
            <option value='uk/function.stream-register-wrapper.php'>Ukrainian</option>
            <option value='zh/function.stream-register-wrapper.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-register-wrapper" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stream_register_wrapper</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_register_wrapper</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.stream-wrapper-register.php" class="function">stream_wrapper_register()</a></span></span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stream-register-wrapper-description">
  <h3 class="title">Description</h3>
  <p class="para">
   This function is an alias of:  <span class="function"><a href="function.stream-wrapper-register.php" class="function">stream_wrapper_register()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-register-wrapper.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-register-wrapper%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-register-wrapper&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-register-wrapper.php">＋<small>add a note</small></a></span>
