...
<head>
  ...
  <title>PHP: cubrid_lob2_tell64 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lob2-tell64.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-lob2-tell64">
 <link rel="alternate" href="https://www.php.net/cubrid-lob2-tell64" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lob2-tell.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lob2-write.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-lob2-tell64.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-lob2-tell64.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-lob2-tell64.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-lob2-tell64.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-lob2-tell64.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-lob2-tell64.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-lob2-tell64.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-lob2-tell64.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-lob2-tell64.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-lob2-tell64.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-lob2-tell64.php" hreflang="zh">
...
<meta name="Description" content="Tell the cursor position of the LOB object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lob2_tell64 - Manual" />
<meta name="twitter:description" content="Tell the cursor position of the LOB object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lob2_tell64 - Manual" />
<meta itemprop="description" content="Tell the cursor position of the LOB object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Tell the cursor position of the LOB object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-lob2-write.php">
          cubrid_lob2_write &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-lob2-tell.php">
          &laquo; cubrid_lob2_tell        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lob2-tell64.php' selected="selected">English</option>
            <option value='de/function.cubrid-lob2-tell64.php'>German</option>
            <option value='es/function.cubrid-lob2-tell64.php'>Spanish</option>
            <option value='fr/function.cubrid-lob2-tell64.php'>French</option>
            <option value='it/function.cubrid-lob2-tell64.php'>Italian</option>
            <option value='ja/function.cubrid-lob2-tell64.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-lob2-tell64.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-lob2-tell64.php'>Russian</option>
            <option value='tr/function.cubrid-lob2-tell64.php'>Turkish</option>
            <option value='uk/function.cubrid-lob2-tell64.php'>Ukrainian</option>
            <option value='zh/function.cubrid-lob2-tell64.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-lob2-tell64" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_lob2_tell64</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.4.1)</p><p class="refpurpose"><span class="refname">cubrid_lob2_tell64</span> &mdash; <span class="dc-title">Tell the cursor position of the LOB object</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-lob2-tell64-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_lob2_tell64</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$lob_identifier</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-lob2-tell64-returnvalues">
  ...
  <p class="para">
    It will return the cursor position on the LOB object as a string when it processes successfully, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-lob2-size64.php" class="function" rel="rdfs-seeAlso">cubrid_lob2_size64()</a> - Get a lob object's size</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lob2-tell64.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lob2-tell64%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lob2-tell64&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lob2-tell64.php">＋<small>add a note</small></a></span>
