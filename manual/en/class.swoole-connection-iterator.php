...
<head>
  ...
  <title>PHP: Swoole\Connection\Iterator - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.swoole-connection-iterator.php">
 <link rel="shorturl" href="https://www.php.net/swoole-connection-iterator">
 <link rel="alternate" href="https://www.php.net/swoole-connection-iterator" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.swoole.php">
 <link rel="prev" href="https://www.php.net/manual/en/swoole-client.wakeup.php">
 <link rel="next" href="https://www.php.net/manual/en/swoole-connection-iterator.count.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.swoole-connection-iterator.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.swoole-connection-iterator.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.swoole-connection-iterator.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.swoole-connection-iterator.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.swoole-connection-iterator.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.swoole-connection-iterator.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.swoole-connection-iterator.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.swoole-connection-iterator.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.swoole-connection-iterator.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.swoole-connection-iterator.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.swoole-connection-iterator.php" hreflang="zh">
...
<meta name="Description" content="The Swoole\Connection\Iterator class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Swoole\Connection\Iterator - Manual" />
<meta name="twitter:description" content="The Swoole\Connection\Iterator class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Swoole\Connection\Iterator - Manual" />
<meta itemprop="description" content="The Swoole\Connection\Iterator class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Swoole\Connection\Iterator class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="swoole-connection-iterator.count.php">
          Swoole\Connection\Iterator::count &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="swoole-client.wakeup.php">
          &laquo; Swoole\Client::wakeup        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.swoole-connection-iterator.php' selected="selected">English</option>
            <option value='de/class.swoole-connection-iterator.php'>German</option>
            <option value='es/class.swoole-connection-iterator.php'>Spanish</option>
            <option value='fr/class.swoole-connection-iterator.php'>French</option>
            <option value='it/class.swoole-connection-iterator.php'>Italian</option>
            <option value='ja/class.swoole-connection-iterator.php'>Japanese</option>
            <option value='pt_BR/class.swoole-connection-iterator.php'>Brazilian Portuguese</option>
            <option value='ru/class.swoole-connection-iterator.php'>Russian</option>
            <option value='tr/class.swoole-connection-iterator.php'>Turkish</option>
            <option value='uk/class.swoole-connection-iterator.php'>Ukrainian</option>
            <option value='zh/class.swoole-connection-iterator.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.swoole-connection-iterator" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="swoole-connection-iterator.count.php">Swoole\Connection\Iterator::count</a> — Count connections.</li><li><a href="swoole-connection-iterator.current.php">Swoole\Connection\Iterator::current</a> — Return current connection entry.</li><li><a href="swoole-connection-iterator.key.php">Swoole\Connection\Iterator::key</a> — Return key of the current connection.</li><li><a href="swoole-connection-iterator.next.php">Swoole\Connection\Iterator::next</a> — Move to the next connection.</li><li><a href="swoole-connection-iterator.offsetexists.php">Swoole\Connection\Iterator::offsetExists</a> — Check if offset exists.</li><li><a href="swoole-connection-iterator.offsetget.php">Swoole\Connection\Iterator::offsetGet</a> — Offset to retrieve.</li><li><a href="swoole-connection-iterator.offsetset.php">Swoole\Connection\Iterator::offsetSet</a> — Assign a Connection to the specified offset.</li><li><a href="swoole-connection-iterator.offsetunset.php">Swoole\Connection\Iterator::offsetUnset</a> — Unset an offset.</li><li><a href="swoole-connection-iterator.rewind.php">Swoole\Connection\Iterator::rewind</a> — Rewinds iterator</li><li><a href="swoole-connection-iterator.valid.php">Swoole\Connection\Iterator::valid</a> — Check if current position is valid.</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/swoole/swoole.connection.iterator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.swoole-connection-iterator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.swoole-connection-iterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.swoole-connection-iterator.php">＋<small>add a note</small></a></span>
