...
<head>
  ...
  <title>PHP: win32_read_right_access_service - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.win32-read-right-access-service.php">
 <link rel="shorturl" href="https://www.php.net/win32-read-right-access-service">
 <link rel="alternate" href="https://www.php.net/win32-read-right-access-service" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.win32service.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.win32-read-all-rights-access-service.php">
 <link rel="next" href="https://www.php.net/manual/en/function.win32-remove-right-access-service.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.win32-read-right-access-service.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.win32-read-right-access-service.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.win32-read-right-access-service.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.win32-read-right-access-service.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.win32-read-right-access-service.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.win32-read-right-access-service.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.win32-read-right-access-service.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.win32-read-right-access-service.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.win32-read-right-access-service.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.win32-read-right-access-service.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.win32-read-right-access-service.php" hreflang="zh">
...
<meta name="Description" content="Read the service rights access for an username" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: win32_read_right_access_service - Manual" />
<meta name="twitter:description" content="Read the service rights access for an username" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: win32_read_right_access_service - Manual" />
<meta itemprop="description" content="Read the service rights access for an username" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Read the service rights access for an username" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.win32-remove-right-access-service.php">
          win32_remove_right_access_service &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.win32-read-all-rights-access-service.php">
          &laquo; win32_read_all_rights_access_service        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.win32-read-right-access-service.php' selected="selected">English</option>
            <option value='de/function.win32-read-right-access-service.php'>German</option>
            <option value='es/function.win32-read-right-access-service.php'>Spanish</option>
            <option value='fr/function.win32-read-right-access-service.php'>French</option>
            <option value='it/function.win32-read-right-access-service.php'>Italian</option>
            <option value='ja/function.win32-read-right-access-service.php'>Japanese</option>
            <option value='pt_BR/function.win32-read-right-access-service.php'>Brazilian Portuguese</option>
            <option value='ru/function.win32-read-right-access-service.php'>Russian</option>
            <option value='tr/function.win32-read-right-access-service.php'>Turkish</option>
            <option value='uk/function.win32-read-right-access-service.php'>Ukrainian</option>
            <option value='zh/function.win32-read-right-access-service.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.win32-read-right-access-service" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="win32service.constants.php#win32service.constants.rights" class="link">Win32 Rights constants</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/win32service/functions/win32-read-right-access-service.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.win32-read-right-access-service%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.win32-read-right-access-service&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.win32-read-right-access-service.php">＋<small>add a note</small></a></span>
