...
<head>
  ...
  <title>PHP: gmp_random - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-random.php">
 <link rel="shorturl" href="https://www.php.net/gmp-random">
 <link rel="alternate" href="https://www.php.net/gmp-random" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-prob-prime.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-random-bits.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-random.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-random.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-random.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-random.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-random.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-random.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-random.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-random.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-random.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-random.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-random.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: gmp_random - Manual" />
<meta name="twitter:description" content="Random number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_random - Manual" />
<meta itemprop="description" content="Random number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Random number" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.gmp-random-bits.php">
          gmp_random_bits &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.gmp-prob-prime.php">
          &laquo; gmp_prob_prime        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-random.php' selected="selected">English</option>
            <option value='de/function.gmp-random.php'>German</option>
            <option value='es/function.gmp-random.php'>Spanish</option>
            <option value='fr/function.gmp-random.php'>French</option>
            <option value='it/function.gmp-random.php'>Italian</option>
            <option value='ja/function.gmp-random.php'>Japanese</option>
            <option value='pt_BR/function.gmp-random.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-random.php'>Russian</option>
            <option value='tr/function.gmp-random.php'>Turkish</option>
            <option value='uk/function.gmp-random.php'>Ukrainian</option>
            <option value='zh/function.gmp-random.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-random" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_random</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7)</p><p class="refpurpose"><span class="refname">gmp_random</span> &mdash; <span class="dc-title">Random number</span></p>
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 description" id="refsect1-function.gmp-random-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_random</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$limiter</code><span class="initializer"> = 20</span></span>): <span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gmp-random-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">limiter</code></dt>
     <dd>
      <p class="para">
       The limiter.
      </p>
...
<div class="examplescode"><pre class="examplescode">1915834968
8642564075890328087</pre>
</div>
    </div>
   </div>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-random.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-random%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-random&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-random.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119064">  <div class="votes">
    <div id="Vu119064">
    <a href="/manual/vote-note.php?id=119064&amp;page=function.gmp-random&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119064">
    <a href="/manual/vote-note.php?id=119064&amp;page=function.gmp-random&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119064" title="57% like this...">
    1
    </div>
  </div>
  <a href="#119064" class="name">
  <strong class="user"><em>asphp at dsgml dot com</em></strong></a><a class="genanchor" href="#119064"> &para;</a><div class="date" title="2016-03-27 03:48"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119064">
<div class="phpcode"><code><span class="html">Warning: Do not use this function.<br /><br />Use gmp_random_bits() or gmp_random_range() instead.<br /><br />The documentation and the code for this function do NOT match, and in any case this function is quite useless.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.gmp-random&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-random.php">＋<small>add a note</small></a></div>
