...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-set-db-parameter.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-set-autocommit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-set-drop.php">
...
<meta name="Description" content="Sets the CUBRID database parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_set_db_parameter - Manual" />
<meta name="twitter:description" content="Sets the CUBRID database parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_set_db_parameter - Manual" />
<meta itemprop="description" content="Sets the CUBRID database parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the CUBRID database parameters" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-set-db-parameter.php' selected="selected">English</option>
            ...
            <option value='ru/function.cubrid-set-db-parameter.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL CUBRID &gt;= 8.4.0)</p><p class="refpurpose"><span class="refname">cubrid_set_db_parameter</span> &mdash; <span class="dc-title">Sets the CUBRID database parameters</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-set-db-parameter-description">
  ...
  <p class="para rdfs-comment">
   The <span class="function"><strong>cubrid_set_db_parameter()</strong></span> function is used to set
 ...
 <p class="para">
  <dl>
    ...
    <dd><p class="para">Database parameter type.</p></dd>
   
   
    <dt><code class="parameter">param_value</code></dt>
    <dd><p class="para">Isolation level value (1-6) or lock timeout (in seconds) value.</p></dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-set-db-parameter-examples">
  ...
  <div class="example" id="example-1277">
   <p><strong>Example #1 <span class="function"><a href="function.cubrid-get-db-parameter.php" class="function">cubrid_get_db_parameter()</a></span> example</strong></p>
...
array(4) {
 ...
 <div class="refsect1 seealso" id="refsect1-function.cubrid-set-db-parameter-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.cubrid-get-db-parameter.php" class="function" rel="rdfs-seeAlso">cubrid_get_db_parameter()</a> - Returns the CUBRID database parameters</span></li>
    <li><span class="function"><a href="function.cubrid-set-autocommit.php" class="function" rel="rdfs-seeAlso">cubrid_set_autocommit()</a> - Set autocommit mode of the connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-set-db-parameter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-set-db-parameter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-set-db-parameter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-set-db-parameter.php">＋<small>add a note</small></a></span>
