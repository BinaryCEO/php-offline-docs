...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/xmlwriter.startelementns.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/xmlwriter.startelementns.php">
 <link rel="alternate" href="https://www.php.net/manual/en/xmlwriter.startelementns.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.xmlwriter.php">
 <link rel="prev" href="https://www.php.net/manual/en/xmlwriter.startelement.php">
 <link rel="next" href="https://www.php.net/manual/en/xmlwriter.startpi.php">
...
<meta name="Description" content="Create start namespaced element tag" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: XMLWriter::startElementNs - Manual" />
<meta name="twitter:description" content="Create start namespaced element tag" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: XMLWriter::startElementNs - Manual" />
<meta itemprop="description" content="Create start namespaced element tag" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create start namespaced element tag" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/xmlwriter.startelementns.php' selected="selected">English</option>
            <option value='de/xmlwriter.startelementns.php'>German</option>
            <option value='es/xmlwriter.startelementns.php'>Spanish</option>
            <option value='fr/xmlwriter.startelementns.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.2, PHP 7, PHP 8, PECL xmlwriter &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">XMLWriter::startElementNs</span> -- <span class="refname">xmlwriter_start_element_ns</span> &mdash; <span class="dc-title">Create start namespaced element tag</span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="xmlwriter.writeelementns.php" class="methodname" rel="rdfs-seeAlso">XMLWriter::writeElementNs()</a> - Write full namespaced element tag</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xmlwriter/xmlwriter/startelementns.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fxmlwriter.startelementns%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=xmlwriter.startelementns&amp;repo=en&amp;redirect=https://www.php.net/manual/en/xmlwriter.startelementns.php">＋<small>add a note</small></a></span>
