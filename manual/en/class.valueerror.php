...
<head>
  ...
  <title>PHP: ValueError - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.valueerror.php">
 <link rel="shorturl" href="https://www.php.net/valueerror">
 <link rel="alternate" href="https://www.php.net/valueerror" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.typeerror.php">
 <link rel="next" href="https://www.php.net/manual/en/class.unhandledmatcherror.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.valueerror.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.valueerror.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.valueerror.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.valueerror.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.valueerror.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.valueerror.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.valueerror.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.valueerror.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.valueerror.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.valueerror.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.valueerror.php" hreflang="zh">
...
<meta name="Description" content="ValueError" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ValueError - Manual" />
<meta name="twitter:description" content="ValueError" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ValueError - Manual" />
<meta itemprop="description" content="ValueError" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="ValueError" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.valueerror.php' selected="selected">English</option>
            <option value='de/class.valueerror.php'>German</option>
            <option value='es/class.valueerror.php'>Spanish</option>
            <option value='fr/class.valueerror.php'>French</option>
            <option value='it/class.valueerror.php'>Italian</option>
            <option value='ja/class.valueerror.php'>Japanese</option>
            <option value='pt_BR/class.valueerror.php'>Brazilian Portuguese</option>
            <option value='ru/class.valueerror.php'>Russian</option>
            <option value='tr/class.valueerror.php'>Turkish</option>
            <option value='uk/class.valueerror.php'>Ukrainian</option>
            <option value='zh/class.valueerror.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.valueerror" class="reference">
 <h1 class="title">ValueError</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8)</p>


  <div class="section" id="valueerror.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    A <span class="classname"><strong class="classname">ValueError</strong></span> is thrown when the
  ...
  <div class="section" id="valueerror.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">ValueError</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="error.clone.php" class="methodname">Error::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/valueerror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.valueerror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.valueerror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.valueerror.php">＋<small>add a note</small></a></span>
