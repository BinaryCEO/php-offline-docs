...
<head>
  ...
  <title>PHP: ps_open_image - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-open-image.php">
 <link rel="shorturl" href="https://www.php.net/ps-open-image">
 <link rel="alternate" href="https://www.php.net/ps-open-image" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-open-file.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-open-image-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-open-image.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-open-image.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-open-image.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-open-image.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-open-image.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-open-image.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-open-image.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-open-image.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-open-image.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-open-image.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-open-image.php" hreflang="zh">
...
<meta name="Description" content="Reads an image for later placement" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_open_image - Manual" />
<meta name="twitter:description" content="Reads an image for later placement" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_open_image - Manual" />
<meta itemprop="description" content="Reads an image for later placement" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads an image for later placement" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-open-image-file.php">
          ps_open_image_file &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-open-file.php">
          &laquo; ps_open_file        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-open-image.php' selected="selected">English</option>
            <option value='de/function.ps-open-image.php'>German</option>
            <option value='es/function.ps-open-image.php'>Spanish</option>
            <option value='fr/function.ps-open-image.php'>French</option>
            <option value='it/function.ps-open-image.php'>Italian</option>
            <option value='ja/function.ps-open-image.php'>Japanese</option>
            <option value='pt_BR/function.ps-open-image.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-open-image.php'>Russian</option>
            <option value='tr/function.ps-open-image.php'>Turkish</option>
            <option value='uk/function.ps-open-image.php'>Ukrainian</option>
            <option value='zh/function.ps-open-image.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-open-image" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ps-open-image-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_open_image</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$type</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$source</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$lenght</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$components</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$bpc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$params</code></span><br>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-close-image.php" class="function" rel="rdfs-seeAlso">ps_close_image()</a> - Closes image and frees memory</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-open-image.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-open-image%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-open-image&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-open-image.php">＋<small>add a note</small></a></span>
