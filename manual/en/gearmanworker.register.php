...
<head>
  ...
  <title>PHP: GearmanWorker::register - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanworker.register.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanworker.register.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanworker.register.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanworker.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanworker.options.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanworker.removeoptions.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanworker.register.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanworker.register.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanworker.register.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanworker.register.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanworker.register.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanworker.register.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanworker.register.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanworker.register.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanworker.register.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanworker.register.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanworker.register.php" hreflang="zh">
...
<meta name="Description" content="Register a function with the job server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanWorker::register - Manual" />
<meta name="twitter:description" content="Register a function with the job server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanWorker::register - Manual" />
<meta itemprop="description" content="Register a function with the job server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Register a function with the job server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearmanworker.removeoptions.php">
          GearmanWorker::removeOptions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanworker.options.php">
          &laquo; GearmanWorker::options        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanworker.register.php' selected="selected">English</option>
            <option value='de/gearmanworker.register.php'>German</option>
            <option value='es/gearmanworker.register.php'>Spanish</option>
            <option value='fr/gearmanworker.register.php'>French</option>
            <option value='it/gearmanworker.register.php'>Italian</option>
            <option value='ja/gearmanworker.register.php'>Japanese</option>
            <option value='pt_BR/gearmanworker.register.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanworker.register.php'>Russian</option>
            <option value='tr/gearmanworker.register.php'>Turkish</option>
            <option value='uk/gearmanworker.register.php'>Ukrainian</option>
            <option value='zh/gearmanworker.register.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanworker.register" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanworker.unregisterall.php" class="methodname" rel="rdfs-seeAlso">GearmanWorker::unregisterAll()</a> - Unregister all function names with the job servers</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanworker/register.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanworker.register%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanworker.register&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanworker.register.php">＋<small>add a note</small></a></span>
