...
<head>
  ...
  <title>PHP: Installing from packages on GNU/Linux distributions that use DNF - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/install.unix.dnf.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/install.unix.dnf.php">
 <link rel="alternate" href="https://www.php.net/manual/en/install.unix.dnf.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/install.unix.php">
 <link rel="prev" href="https://www.php.net/manual/en/install.unix.debian.php">
 <link rel="next" href="https://www.php.net/manual/en/install.unix.openbsd.php">

 <link rel="alternate" href="https://www.php.net/manual/en/install.unix.dnf.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/install.unix.dnf.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/install.unix.dnf.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/install.unix.dnf.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/install.unix.dnf.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/install.unix.dnf.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/install.unix.dnf.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/install.unix.dnf.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/install.unix.dnf.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/install.unix.dnf.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/install.unix.dnf.php" hreflang="zh">
...
<meta name="Description" content="Installing from packages on GNU/Linux distributions that use DNF" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Installing from packages on GNU/Linux distributions that use DNF - Manual" />
<meta name="twitter:description" content="Installing from packages on GNU/Linux distributions that use DNF" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Installing from packages on GNU/Linux distributions that use DNF - Manual" />
<meta itemprop="description" content="Installing from packages on GNU/Linux distributions that use DNF" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Installing from packages on GNU/Linux distributions that use DNF" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="install.unix.openbsd.php">
          Installing from packages or ports on OpenBSD &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="install.unix.debian.php">
          &laquo; Installing from packages on Debian GNU/Linux and related distributions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/install.unix.dnf.php' selected="selected">English</option>
            <option value='de/install.unix.dnf.php'>German</option>
            <option value='es/install.unix.dnf.php'>Spanish</option>
            <option value='fr/install.unix.dnf.php'>French</option>
            <option value='it/install.unix.dnf.php'>Italian</option>
            <option value='ja/install.unix.dnf.php'>Japanese</option>
            <option value='pt_BR/install.unix.dnf.php'>Brazilian Portuguese</option>
            <option value='ru/install.unix.dnf.php'>Russian</option>
            <option value='tr/install.unix.dnf.php'>Turkish</option>
            <option value='uk/install.unix.dnf.php'>Ukrainian</option>
            <option value='zh/install.unix.dnf.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="install.unix.dnf" class="sect1">
 ...
 <div class="sect2" id="install.unix.dnf.packages">
  ...
  <div class="example" id="install.unix.dnf.example">
   <p><strong>Example #1 DNF Install Example</strong></p>
...
<div class="shellcode"><pre class="shellcode"># dnf install php php-common</pre>
  ...
  <div class="example" id="install.unix.dnf.example2">
   <p><strong>Example #2 Restarting Apache once PHP is installed</strong></p>
   <div class="example-contents">
...
<div class="shellcode"><pre class="shellcode"># dnf search php</pre>
  ...
  <div class="example" id="install.unix.dnf.config.example2">
   <p><strong>Example #4 Install PHP with MySQL, GD</strong></p>
   <div class="example-contents">
  ...
  <p class="simpara">
   ...
   changes take affect.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/install/unix/dnf.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Finstall.unix.dnf%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=install.unix.dnf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/install.unix.dnf.php">＋<small>add a note</small></a></span>
