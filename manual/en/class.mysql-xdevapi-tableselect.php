...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mysql-xdevapi-tableselect.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-tableinsert.values.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-tableselect.bind.php">
...
<meta name="Description" content="TableSelect class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_xdevapi\TableSelect - Manual" />
<meta name="twitter:description" content="TableSelect class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_xdevapi\TableSelect - Manual" />
<meta itemprop="description" content="TableSelect class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="TableSelect class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mysql-xdevapi-tableselect.php' selected="selected">English</option>
            ...
            <option value='ru/class.mysql-xdevapi-tableselect.php'>Russian</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mysql-xdevapi-tableselect.bind.php">TableSelect::bind</a> — Bind select query parameters</li><li><a href="mysql-xdevapi-tableselect.construct.php">TableSelect::__construct</a> — TableSelect constructor</li><li><a href="mysql-xdevapi-tableselect.execute.php">TableSelect::execute</a> — Execute select statement</li><li><a href="mysql-xdevapi-tableselect.groupby.php">TableSelect::groupBy</a> — Set select grouping criteria</li><li><a href="mysql-xdevapi-tableselect.having.php">TableSelect::having</a> — Set select having condition</li><li><a href="mysql-xdevapi-tableselect.limit.php">TableSelect::limit</a> — Limit selected rows</li><li><a href="mysql-xdevapi-tableselect.lockexclusive.php">TableSelect::lockExclusive</a> — Execute EXCLUSIVE LOCK</li><li><a href="mysql-xdevapi-tableselect.lockshared.php">TableSelect::lockShared</a> — Execute SHARED LOCK</li><li><a href="mysql-xdevapi-tableselect.offset.php">TableSelect::offset</a> — Set limit offset</li><li><a href="mysql-xdevapi-tableselect.orderby.php">TableSelect::orderby</a> — Set select sort criteria</li><li><a href="mysql-xdevapi-tableselect.where.php">TableSelect::where</a> — Set select search condition</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql-xdevapi.tableselect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mysql-xdevapi-tableselect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mysql-xdevapi-tableselect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mysql-xdevapi-tableselect.php">＋<small>add a note</small></a></span>
