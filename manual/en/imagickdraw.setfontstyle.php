...
<head>
  ...
  <title>PHP: ImagickDraw::setFontStyle - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setfontstyle.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setfontstyle.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfontstyle.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setfontstretch.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setfontweight.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfontstyle.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setfontstyle.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setfontstyle.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setfontstyle.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setfontstyle.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setfontstyle.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setfontstyle.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setfontstyle.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setfontstyle.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setfontstyle.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setfontstyle.php" hreflang="zh">
...
<meta name="Description" content="Sets the font style to use when annotating with text" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setFontStyle - Manual" />
<meta name="twitter:description" content="Sets the font style to use when annotating with text" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setFontStyle - Manual" />
<meta itemprop="description" content="Sets the font style to use when annotating with text" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the font style to use when annotating with text" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setfontweight.php">
          ImagickDraw::setFontWeight &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setfontstretch.php">
          &laquo; ImagickDraw::setFontStretch        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setfontstyle.php' selected="selected">English</option>
            <option value='de/imagickdraw.setfontstyle.php'>German</option>
            <option value='es/imagickdraw.setfontstyle.php'>Spanish</option>
            <option value='fr/imagickdraw.setfontstyle.php'>French</option>
            <option value='it/imagickdraw.setfontstyle.php'>Italian</option>
            <option value='ja/imagickdraw.setfontstyle.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setfontstyle.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setfontstyle.php'>Russian</option>
            <option value='tr/imagickdraw.setfontstyle.php'>Turkish</option>
            <option value='uk/imagickdraw.setfontstyle.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setfontstyle.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setfontstyle" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setFontStyle</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setFontStyle</span> &mdash; <span class="dc-title">Sets the font style to use when annotating with text</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setfontstyle-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setFontStyle</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$style</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setfontstyle-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       One of the <a href="imagick.constants.php#imagick.constants.styles" class="link">STYLE</a> constant
       (<code class="literal">imagick::STYLE_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setfontstyle-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3178">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setfontstyle.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setfontstyle%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setfontstyle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfontstyle.php">＋<small>add a note</small></a></span>
