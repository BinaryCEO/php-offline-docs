...
<head>
  ...
  <title>PHP: SolrQuery::getStart - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getstart.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getstart.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getstart.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getsortfields.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getstats.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getstart.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getstart.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getstart.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getstart.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getstart.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getstart.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getstart.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getstart.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getstart.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getstart.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getstart.php" hreflang="zh">
...
<meta name="Description" content="Returns the offset in the complete result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getStart - Manual" />
<meta name="twitter:description" content="Returns the offset in the complete result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getStart - Manual" />
<meta itemprop="description" content="Returns the offset in the complete result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the offset in the complete result set" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getstats.php">
          SolrQuery::getStats &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getsortfields.php">
          &laquo; SolrQuery::getSortFields        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getstart.php' selected="selected">English</option>
            <option value='de/solrquery.getstart.php'>German</option>
            <option value='es/solrquery.getstart.php'>Spanish</option>
            <option value='fr/solrquery.getstart.php'>French</option>
            <option value='it/solrquery.getstart.php'>Italian</option>
            <option value='ja/solrquery.getstart.php'>Japanese</option>
            <option value='pt_BR/solrquery.getstart.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getstart.php'>Russian</option>
            <option value='tr/solrquery.getstart.php'>Turkish</option>
            <option value='uk/solrquery.getstart.php'>Ukrainian</option>
            <option value='zh/solrquery.getstart.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getstart" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getStart</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getStart</span> &mdash; <span class="dc-title">Returns the offset in the complete result set</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getstart-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getStart</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getstart-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getstart-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getstart.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getstart%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getstart&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getstart.php">＋<small>add a note</small></a></span>
