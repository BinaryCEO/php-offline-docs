...
<head>
  ...
  <title>PHP: openssl_csr_export_to_file - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-csr-export-to-file.php">
 <link rel="shorturl" href="https://www.php.net/openssl-csr-export-to-file">
 <link rel="alternate" href="https://www.php.net/openssl-csr-export-to-file" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-csr-export.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-csr-get-public-key.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-csr-export-to-file.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-csr-export-to-file.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-csr-export-to-file.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-csr-export-to-file.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-csr-export-to-file.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-csr-export-to-file.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-csr-export-to-file.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-csr-export-to-file.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-csr-export-to-file.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-csr-export-to-file.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-csr-export-to-file.php" hreflang="zh">
...
<meta name="Description" content="Exports a CSR to a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_csr_export_to_file - Manual" />
<meta name="twitter:description" content="Exports a CSR to a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_csr_export_to_file - Manual" />
<meta itemprop="description" content="Exports a CSR to a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exports a CSR to a file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-csr-get-public-key.php">
          openssl_csr_get_public_key &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-csr-export.php">
          &laquo; openssl_csr_export        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-csr-export-to-file.php' selected="selected">English</option>
            <option value='de/function.openssl-csr-export-to-file.php'>German</option>
            <option value='es/function.openssl-csr-export-to-file.php'>Spanish</option>
            <option value='fr/function.openssl-csr-export-to-file.php'>French</option>
            <option value='it/function.openssl-csr-export-to-file.php'>Italian</option>
            <option value='ja/function.openssl-csr-export-to-file.php'>Japanese</option>
            <option value='pt_BR/function.openssl-csr-export-to-file.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-csr-export-to-file.php'>Russian</option>
            <option value='tr/function.openssl-csr-export-to-file.php'>Turkish</option>
            <option value='uk/function.openssl-csr-export-to-file.php'>Ukrainian</option>
            <option value='zh/function.openssl-csr-export-to-file.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-csr-export-to-file" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_csr_export_to_file</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_csr_export_to_file</span> &mdash; <span class="dc-title">Exports a <abbr title="Certificate Signing Request">CSR</abbr> to a file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-csr-export-to-file-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>openssl_csr_export_to_file()</strong></span> takes the Certificate
   Signing Request represented by <code class="parameter">csr</code> and saves it
   in <abbr title="Privacy-Enhanced Mail">PEM</abbr> format into the file named by
 ...
 <div class="refsect1 examples" id="refsect1-function.openssl-csr-export-to-file-examples">
  ...
  <p class="para">
   <div class="example" id="example-1014">
    <p><strong>Example #1 openssl_csr_export_to_file() example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$subject </span><span style="color: #007700">= array(<br />    </span><span style="color: #DD0000">"commonName" </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">"example.com"</span><span style="color: #007700">,<br />);<br /></span><span style="color: #0000BB">$private_key </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_pkey_new</span><span style="color: #007700">(array(<br />    </span><span style="color: #DD0000">"private_key_bits" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">2048</span><span style="color: #007700">,<br />    </span><span style="color: #DD0000">"private_key_type" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">OPENSSL_KEYTYPE_RSA</span><span style="color: #007700">,<br />));<br /></span><span style="color: #0000BB">$csr </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_csr_new</span><span style="color: #007700">(</span><span style="color: #0000BB">$subject</span><span style="color: #007700">, </span><span style="color: #0000BB">$private_key</span><span style="color: #007700">, array(</span><span style="color: #DD0000">'digest_alg' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'sha384'</span><span style="color: #007700">) );<br /></span><span style="color: #0000BB">openssl_pkey_export_to_file</span><span style="color: #007700">(</span><span style="color: #0000BB">$private_key</span><span style="color: #007700">, </span><span style="color: #DD0000">'example-priv.key'</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">// Along with the subject, the CSR contains the public key corresponding to the private key<br /></span><span style="color: #0000BB">openssl_csr_export_to_file</span><span style="color: #007700">(</span><span style="color: #0000BB">$csr</span><span style="color: #007700">, </span><span style="color: #DD0000">'example-csr.pem'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.openssl-csr-export-to-file-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.openssl-csr-export.php" class="function" rel="rdfs-seeAlso">openssl_csr_export()</a> - Exports a CSR as a string</span></li>
    ...
    <li><span class="function"><a href="function.openssl-csr-sign.php" class="function" rel="rdfs-seeAlso">openssl_csr_sign()</a> - Sign a CSR with another certificate (or itself) and generate a certificate</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-csr-export-to-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-csr-export-to-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-csr-export-to-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-csr-export-to-file.php">＋<small>add a note</small></a></span>
