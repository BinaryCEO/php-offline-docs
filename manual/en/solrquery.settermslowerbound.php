...
<head>
  ...
  <title>PHP: SolrQuery::setTermsLowerBound - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.settermslowerbound.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.settermslowerbound.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermslowerbound.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.settermslimit.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.settermsmaxcount.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermslowerbound.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.settermslowerbound.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.settermslowerbound.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.settermslowerbound.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.settermslowerbound.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.settermslowerbound.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.settermslowerbound.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.settermslowerbound.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.settermslowerbound.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.settermslowerbound.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.settermslowerbound.php" hreflang="zh">
...
<meta name="Description" content="Specifies the Term to start from" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setTermsLowerBound - Manual" />
<meta name="twitter:description" content="Specifies the Term to start from" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setTermsLowerBound - Manual" />
<meta itemprop="description" content="Specifies the Term to start from" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the Term to start from" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.settermsmaxcount.php">
          SolrQuery::setTermsMaxCount &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.settermslimit.php">
          &laquo; SolrQuery::setTermsLimit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.settermslowerbound.php' selected="selected">English</option>
            <option value='de/solrquery.settermslowerbound.php'>German</option>
            <option value='es/solrquery.settermslowerbound.php'>Spanish</option>
            <option value='fr/solrquery.settermslowerbound.php'>French</option>
            <option value='it/solrquery.settermslowerbound.php'>Italian</option>
            <option value='ja/solrquery.settermslowerbound.php'>Japanese</option>
            <option value='pt_BR/solrquery.settermslowerbound.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.settermslowerbound.php'>Russian</option>
            <option value='tr/solrquery.settermslowerbound.php'>Turkish</option>
            <option value='uk/solrquery.settermslowerbound.php'>Ukrainian</option>
            <option value='zh/solrquery.settermslowerbound.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.settermslowerbound" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setTermsLowerBound</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setTermsLowerBound</span> &mdash; <span class="dc-title">Specifies the Term to start from</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.settermslowerbound-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setTermsLowerBound</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$lowerBound</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.settermslowerbound-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">lowerBound</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.settermslowerbound-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/settermslowerbound.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.settermslowerbound%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.settermslowerbound&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.settermslowerbound.php">＋<small>add a note</small></a></span>
