...
<head>
  ...
  <title>PHP: odbc_setoption - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-setoption.php">
 <link rel="shorturl" href="https://www.php.net/odbc-setoption">
 <link rel="alternate" href="https://www.php.net/odbc-setoption" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-rollback.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-specialcolumns.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-setoption.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-setoption.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-setoption.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-setoption.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-setoption.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-setoption.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-setoption.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-setoption.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-setoption.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-setoption.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-setoption.php" hreflang="zh">
...
<meta name="Description" content="Adjust ODBC settings" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_setoption - Manual" />
<meta name="twitter:description" content="Adjust ODBC settings" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_setoption - Manual" />
<meta itemprop="description" content="Adjust ODBC settings" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adjust ODBC settings" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.odbc-specialcolumns.php">
          odbc_specialcolumns &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-rollback.php">
          &laquo; odbc_rollback        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-setoption.php' selected="selected">English</option>
            <option value='de/function.odbc-setoption.php'>German</option>
            <option value='es/function.odbc-setoption.php'>Spanish</option>
            <option value='fr/function.odbc-setoption.php'>French</option>
            <option value='it/function.odbc-setoption.php'>Italian</option>
            <option value='ja/function.odbc-setoption.php'>Japanese</option>
            <option value='pt_BR/function.odbc-setoption.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-setoption.php'>Russian</option>
            <option value='tr/function.odbc-setoption.php'>Turkish</option>
            <option value='uk/function.odbc-setoption.php'>Ukrainian</option>
            <option value='zh/function.odbc-setoption.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-setoption" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// 1. Option 102 of SQLSetConnectOption() is SQL_AUTOCOMMIT.<br />//    Value 1 of SQL_AUTOCOMMIT is SQL_AUTOCOMMIT_ON.<br />//    This example has the same effect as<br />//    odbc_autocommit($conn, true);<br /><br /></span><span style="color: #0000BB">odbc_setoption</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">102</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// 2. Option 0 of SQLSetStmtOption() is SQL_QUERY_TIMEOUT.<br />//    This example sets the query to timeout after 30 seconds.<br /><br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">odbc_prepare</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$sql</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">odbc_setoption</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">30</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">odbc_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-setoption.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-setoption%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-setoption&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-setoption.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="88295">  <div class="votes">
    <div id="Vu88295">
    <a href="/manual/vote-note.php?id=88295&amp;page=function.odbc-setoption&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd88295">
    <a href="/manual/vote-note.php?id=88295&amp;page=function.odbc-setoption&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V88295" title="44% like this...">
    -1
    </div>
  </div>
  <a href="#88295" class="name">
  <strong class="user"><em>egil at wp dot pl</em></strong></a><a class="genanchor" href="#88295"> &para;</a><div class="date" title="2009-01-19 07:42"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom88295">
<div class="phpcode"><code><span class="html">Some options for Microsoft SQL Server ODBC:<br />1 - (SQL_MAX_ROWS) show top x rows<br />6 - (SQL_CURSOR_TYPE) zmiana kursora - ma działać dopiero w PHP 5.3<br /><br />You can "translate" constant names (found on e.g. Microsoft website) to appropriate values using this page:<br /><a href="http://www.freepascal.org/docs-html/packages/odbcsql/index-2.html" rel="nofollow" target="_blank">http://www.freepascal.org/docs-html/packages/odbcsql/index-2.html</a><br /><br />BTW. If anyone is banging his head about "cursor type changed" warning while using execute with ORDER BY clause, then just use exec for now (remember to addslashes for yourself). In PHP 5.3 a Bug #43668 will be fixed and it will allow you to change a cursor type to SQL_CUR_USE_ODBC.<br /><br />Note that you could also try to select a cursor type in odbc_connect, but that didn't work for me (much more problems appeared then it solved).</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.odbc-setoption&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-setoption.php">＋<small>add a note</small></a></div>
