...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-version.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-update.php">
 <link rel="next" href="https://www.php.net/manual/en/class.pgsql-connection.php">
...
<meta name="Description" content="Returns an array with client, protocol and server version (when available)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_version - Manual" />
<meta name="twitter:description" content="Returns an array with client, protocol and server version (when available)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_version - Manual" />
<meta itemprop="description" content="Returns an array with client, protocol and server version (when available)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array with client, protocol and server version (when available)" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-version.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.pg-version.php'>Brazilian Portuguese</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-parameter-status.php" class="function" rel="rdfs-seeAlso">pg_parameter_status()</a> - Looks up a current parameter setting of the server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-version.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-version%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-version&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-version.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Complete output off this function for me is:<br /><br />array(13) {<br />  ["client"]=&gt;<br />  string(5) "9.6.9"<br />  ["protocol"]=&gt;<br />  int(3)<br />  ["server"]=&gt;<br />  string(4) "12.1"<br />  ["server_encoding"]=&gt;<br />  string(4) "UTF8"<br />  ["client_encoding"]=&gt;<br />  string(4) "UTF8"<br />  ["is_superuser"]=&gt;<br />  string(2) "on"<br />  ["session_authorization"]=&gt;<br />  string(8) "postgres"<br />  ["DateStyle"]=&gt;<br />  string(8) "ISO, MDY"<br />  ["IntervalStyle"]=&gt;<br />  string(8) "postgres"<br />  ["TimeZone"]=&gt;<br />  string(10) "US/Arizona"<br />  ["integer_datetimes"]=&gt;<br />  string(2) "on"<br />  ["standard_conforming_strings"]=&gt;<br />  string(2) "on"<br />  ["application_name"]=&gt;<br />  string(0) ""<br />}</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I note that the array element for "protocol" seemingly has no value, being reported as:<br /><br /> ["protocol"]=&gt; int(3)<br /><br />whereas the array element for e.g. "server" is reported as (in my particular case):<br /><br />["server"]=&gt; string(5) "10.12"<br /><br />A call to json_encode() however gives:<br /><br />"protocol":3 and "server":"10.12"</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-version&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-version.php">＋<small>add a note</small></a></div>
