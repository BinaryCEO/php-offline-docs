...
<head>
  ...
  <title>PHP: ps_shading_pattern - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-shading-pattern.php">
 <link rel="shorturl" href="https://www.php.net/ps-shading-pattern">
 <link rel="alternate" href="https://www.php.net/ps-shading-pattern" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-shading.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-shfill.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-shading-pattern.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-shading-pattern.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-shading-pattern.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-shading-pattern.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-shading-pattern.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-shading-pattern.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-shading-pattern.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-shading-pattern.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-shading-pattern.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-shading-pattern.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-shading-pattern.php" hreflang="zh">
...
<meta name="Description" content="Creates a pattern based on a shading" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_shading_pattern - Manual" />
<meta name="twitter:description" content="Creates a pattern based on a shading" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_shading_pattern - Manual" />
<meta itemprop="description" content="Creates a pattern based on a shading" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a pattern based on a shading" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-shfill.php">
          ps_shfill &raquo;
              ...
              <div class="prev">
        <a href="function.ps-shading.php">
          &laquo; ps_shading        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-shading-pattern.php' selected="selected">English</option>
            <option value='de/function.ps-shading-pattern.php'>German</option>
            <option value='es/function.ps-shading-pattern.php'>Spanish</option>
            <option value='fr/function.ps-shading-pattern.php'>French</option>
            <option value='it/function.ps-shading-pattern.php'>Italian</option>
            <option value='ja/function.ps-shading-pattern.php'>Japanese</option>
            <option value='pt_BR/function.ps-shading-pattern.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-shading-pattern.php'>Russian</option>
            <option value='tr/function.ps-shading-pattern.php'>Turkish</option>
            <option value='uk/function.ps-shading-pattern.php'>Ukrainian</option>
            <option value='zh/function.ps-shading-pattern.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-shading-pattern" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-shfill.php" class="function" rel="rdfs-seeAlso">ps_shfill()</a> - Fills an area with a shading</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-shading-pattern.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-shading-pattern%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-shading-pattern&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-shading-pattern.php">＋<small>add a note</small></a></span>
