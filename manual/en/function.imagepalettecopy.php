...
<head>
  ...
  <title>PHP: imagepalettecopy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagepalettecopy.php">
 <link rel="shorturl" href="https://www.php.net/imagepalettecopy">
 <link rel="alternate" href="https://www.php.net/imagepalettecopy" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imageopenpolygon.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagepalettetotruecolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagepalettecopy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagepalettecopy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagepalettecopy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagepalettecopy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagepalettecopy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagepalettecopy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagepalettecopy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagepalettecopy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagepalettecopy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagepalettecopy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagepalettecopy.php" hreflang="zh">
...
<meta name="Description" content="Copy the palette from one image to another" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagepalettecopy - Manual" />
<meta name="twitter:description" content="Copy the palette from one image to another" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagepalettecopy - Manual" />
<meta itemprop="description" content="Copy the palette from one image to another" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Copy the palette from one image to another" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagepalettetotruecolor.php">
          imagepalettetotruecolor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imageopenpolygon.php">
          &laquo; imageopenpolygon        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagepalettecopy.php' selected="selected">English</option>
            <option value='de/function.imagepalettecopy.php'>German</option>
            <option value='es/function.imagepalettecopy.php'>Spanish</option>
            <option value='fr/function.imagepalettecopy.php'>French</option>
            <option value='it/function.imagepalettecopy.php'>Italian</option>
            <option value='ja/function.imagepalettecopy.php'>Japanese</option>
            <option value='pt_BR/function.imagepalettecopy.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagepalettecopy.php'>Russian</option>
            <option value='tr/function.imagepalettecopy.php'>Turkish</option>
            <option value='uk/function.imagepalettecopy.php'>Ukrainian</option>
            <option value='zh/function.imagepalettecopy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagepalettecopy" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.imagepalettecopy-examples">
  ...
  <p class="para">
   <div class="example" id="example-2922">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Create two palette images<br /></span><span style="color: #0000BB">$palette1 </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreate</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$palette2 </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreate</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Allocate the background to be <br />// green in the first palette image<br /></span><span style="color: #0000BB">$green </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecolorallocate</span><span style="color: #007700">(</span><span style="color: #0000BB">$palette1</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">255</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Copy the palette from image 1 to image 2<br /></span><span style="color: #0000BB">imagepalettecopy</span><span style="color: #007700">(</span><span style="color: #0000BB">$palette2</span><span style="color: #007700">, </span><span style="color: #0000BB">$palette1</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Since the palette is now copied we can use the <br />// green color allocated to image 1 without using <br />// imagecolorallocate() twice<br /></span><span style="color: #0000BB">imagefilledrectangle</span><span style="color: #007700">(</span><span style="color: #0000BB">$palette2</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">99</span><span style="color: #007700">, </span><span style="color: #0000BB">99</span><span style="color: #007700">, </span><span style="color: #0000BB">$green</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Output image to the browser<br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">'Content-type: image/png'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">imagepng</span><span style="color: #007700">(</span><span style="color: #0000BB">$palette2</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagepalettecopy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagepalettecopy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagepalettecopy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagepalettecopy.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="57996">  <div class="votes">
    <div id="Vu57996">
    <a href="/manual/vote-note.php?id=57996&amp;page=function.imagepalettecopy&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd57996">
    <a href="/manual/vote-note.php?id=57996&amp;page=function.imagepalettecopy&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V57996" title="66% like this...">
    1
    </div>
  </div>
  <a href="#57996" class="name">
  <strong class="user"><em>buzz at nospam dot oska dot com</em></strong></a><a class="genanchor" href="#57996"> &para;</a><div class="date" title="2005-10-20 04:51"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom57996">
<div class="phpcode"><code><span class="html">actually it doesn't "copy" the palette exactly.  It copys the colors from the source palette to the destination image.   the palette you end up with in the destination image will be "same colors different order".   If you want an EXACT palette copy (at the expense of messing up your image if you aren't careful), then use this code: <br />&lt;?<br />// this is a drop-in replacement for imagepalettecopy, except that it make NO attempt to modifiy any of the <br />// colors in the dest image, just the palette.   The result?  if you're palette's aren't very similar, the image will look completely different, and likely terrible!<br />function imagepalettecopy_exact ( $dst_img, $src_img) {<br />    for( $c = 0 ; $c &lt; imagecolorstotal($src_img); $c++) {<br />        $col = imagecolorsforindex($src_img,$c);  //get color at index 'c' in the color table<br />        imagecolorset($dst_img,$c,$col[red],$col[green],$col[blue]); //set color at index 'c' to $col in the $dst_image<br />    }<br />}<br /><br />?&gt;</span></code></div>
  </div>
 </div>
  <div class="note" id="28340">  <div class="votes">
    <div id="Vu28340">
    <a href="/manual/vote-note.php?id=28340&amp;page=function.imagepalettecopy&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd28340">
    <a href="/manual/vote-note.php?id=28340&amp;page=function.imagepalettecopy&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V28340" title="50% like this...">
    0
    </div>
  </div>
  <a href="#28340" class="name">
  <strong class="user"><em>Los Olvidados</em></strong></a><a class="genanchor" href="#28340"> &para;</a><div class="date" title="2003-01-09 04:55"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom28340">
<div class="phpcode"><code><span class="html">To be precise, this function replaces the palette in the destination.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagepalettecopy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagepalettecopy.php">＋<small>add a note</small></a></div>
