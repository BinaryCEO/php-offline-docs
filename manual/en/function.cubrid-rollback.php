...
<head>
  ...
  <title>PHP: cubrid_rollback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-rollback.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-rollback">
 <link rel="alternate" href="https://www.php.net/cubrid-rollback" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-put.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-schema.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-rollback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-rollback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-rollback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-rollback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-rollback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-rollback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-rollback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-rollback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-rollback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-rollback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-rollback.php" hreflang="zh">
...
<meta name="Description" content="Roll back a transaction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_rollback - Manual" />
<meta name="twitter:description" content="Roll back a transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_rollback - Manual" />
<meta itemprop="description" content="Roll back a transaction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Roll back a transaction" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-rollback.php' selected="selected">English</option>
            <option value='de/function.cubrid-rollback.php'>German</option>
            <option value='es/function.cubrid-rollback.php'>Spanish</option>
            <option value='fr/function.cubrid-rollback.php'>French</option>
            <option value='it/function.cubrid-rollback.php'>Italian</option>
            <option value='ja/function.cubrid-rollback.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-rollback.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-rollback.php'>Russian</option>
            <option value='tr/function.cubrid-rollback.php'>Turkish</option>
            <option value='uk/function.cubrid-rollback.php'>Ukrainian</option>
            <option value='zh/function.cubrid-rollback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-rollback" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-rollback-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_rollback</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
   ...
   <ul class="simplelist"> 
    ...
    <li><span class="function"><a href="function.cubrid-disconnect.php" class="function" rel="rdfs-seeAlso">cubrid_disconnect()</a> - Close a database connection</span></li>     
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-rollback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-rollback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-rollback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-rollback.php">＋<small>add a note</small></a></span>
