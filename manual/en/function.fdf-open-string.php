...
<head>
  ...
  <title>PHP: fdf_open_string - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-open-string.php">
 <link rel="shorturl" href="https://www.php.net/fdf-open-string">
 <link rel="alternate" href="https://www.php.net/fdf-open-string" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-open.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-remove-item.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdf-open-string.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdf-open-string.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdf-open-string.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdf-open-string.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdf-open-string.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdf-open-string.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdf-open-string.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdf-open-string.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdf-open-string.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdf-open-string.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdf-open-string.php" hreflang="zh">
...
<meta name="Description" content="Read a FDF document from a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_open_string - Manual" />
<meta name="twitter:description" content="Read a FDF document from a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_open_string - Manual" />
<meta itemprop="description" content="Read a FDF document from a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Read a FDF document from a string" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-open-string.php' selected="selected">English</option>
            <option value='de/function.fdf-open-string.php'>German</option>
            <option value='es/function.fdf-open-string.php'>Spanish</option>
            <option value='fr/function.fdf-open-string.php'>French</option>
            <option value='it/function.fdf-open-string.php'>Italian</option>
            <option value='ja/function.fdf-open-string.php'>Japanese</option>
            <option value='pt_BR/function.fdf-open-string.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdf-open-string.php'>Russian</option>
            <option value='tr/function.fdf-open-string.php'>Turkish</option>
            <option value='uk/function.fdf-open-string.php'>Ukrainian</option>
            <option value='zh/function.fdf-open-string.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdf-open-string" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fdf_open_string</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5 &lt; 5.3.0, PECL fdf SVN)</p><p class="refpurpose"><span class="refname">fdf_open_string</span> &mdash; <span class="dc-title">Read a FDF document from a string</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.fdf-open-string-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fdf_open_string</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$fdf_data</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
  ...
  <p class="para">
   ...
   <var class="varname">$HTTP_FDF_DATA</var> to process FDF form input from a remote
   client.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fdf-open-string-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">fdf_data</code></dt>
     <dd>
      <p class="para">
       The data as returned from a PDF form or created using 
       <span class="function"><a href="function.fdf-create.php" class="function">fdf_create()</a></span> and 
       <span class="function"><a href="function.fdf-save-string.php" class="function">fdf_save_string()</a></span>.
      </p>
     </dd>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fdf-save-string.php" class="function" rel="rdfs-seeAlso">fdf_save_string()</a> - Returns the FDF document as a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-open-string.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-open-string%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-open-string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-open-string.php">＋<small>add a note</small></a></span>
