...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ob-get-clean.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ob-flush.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ob-get-contents.php">
...
<meta name="Description" content="Get the contents of the active output buffer and turn it off" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ob_get_clean - Manual" />
<meta name="twitter:description" content="Get the contents of the active output buffer and turn it off" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ob_get_clean - Manual" />
<meta itemprop="description" content="Get the contents of the active output buffer and turn it off" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the contents of the active output buffer and turn it off" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ob-get-clean.php' selected="selected">English</option>
            ...
            <option value='ja/function.ob-get-clean.php'>Japanese</option>
  ...
  <p class="para">
   ...
   return the contents of the active output buffer and turn it off</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/outcontrol/functions/ob-get-clean.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ob-get-clean%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ob-get-clean&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ob-get-clean.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">The definition should mention that the function also "turns off output buffering", not just cleans it.</span></code></div>
  </div>
 </div>
  <div class="note" id="102568">  <div class="votes">
    ...
    <div class="tally" id="V102568" title="69% like this...">
    32
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Also, don't forget that you will need to ob_start() again for any successive calls:
<br />
...
<br />Output: 12
<br />
<br />Without the second ob_start(), the output is 21 ...</span></code></div>
  </div>
 </div>
  <div class="note" id="113406">  <div class="votes">
    ...
    <div class="tally" id="V113406" title="56% like this...">
    7
    </div>
  </div>
  <a href="#113406" class="name">
  <strong class="user"><em>paul+phpnet at earth2me dot com</em></strong></a><a class="genanchor" href="#113406"> &para;</a><div class="date" title="2013-10-08 12:08"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113406">
<div class="phpcode"><code><span class="html">Keep in mind that output may be buffered by default, depending on how you are running PHP (CGI, CLI, etc.).   You can use ob_get_level() to determine if an output buffer has already been started.  On most web servers I've used, output buffering is already one level deep before my scripts start running.<br /><br />You should only end as many output buffers as you start.  Assuming that your buffer is always the first buffer, or otherwise closing pre-existing buffers, could lead to problems.  In PHP 5.5, you can ensure that output buffers are ended properly using a try-finally block.<br /><br />Something like this is almost guaranteed to break stuff:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Don't ever do this!<br /></span><span class="keyword">while (</span><span class="default">ob_get_level</span><span class="keyword">() &gt; </span><span class="default">1</span><span class="keyword">)<br />{<br />    </span><span class="default">ob_end_flush</span><span class="keyword">();<br />}<br /><br /></span><span class="default">$content </span><span class="keyword">= </span><span class="default">ob_get_clean</span><span class="keyword">();<br /></span><span class="default">?&gt;<br /></span><br />The problem is that number, "1".  Using a fixed number there is asking for trouble.  Instead, use ob_get_level() to get the number of output buffers applied when your code starts, and return to that number, if you really must use an unknown number of output buffers:<br /><br /><span class="default">&lt;?php<br />ob_start</span><span class="keyword">();<br /></span><span class="default">$saved_ob_level </span><span class="keyword">= </span><span class="default">ob_get_level</span><span class="keyword">();<br /><br /></span><span class="comment">// Do stuff here:<br /></span><span class="default">run_something</span><span class="keyword">();<br /><br /></span><span class="comment">// If you really must close all of your output buffers except one, this'll do it:<br /></span><span class="keyword">while (</span><span class="default">ob_get_level</span><span class="keyword">() &gt; </span><span class="default">$start_ob_level</span><span class="keyword">)<br />{<br />    </span><span class="default">ob_end_flush</span><span class="keyword">();<br />}<br /><br /></span><span class="comment">// And now, the final output buffer that belongs to us:<br /></span><span class="default">$content </span><span class="keyword">= </span><span class="default">ob_get_clean</span><span class="keyword">();<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ob-get-clean&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ob-get-clean.php">＋<small>add a note</small></a></div>
