...
<head>
  ...
  <title>PHP: trader_tema - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-tema.php">
 <link rel="shorturl" href="https://www.php.net/trader-tema">
 <link rel="alternate" href="https://www.php.net/trader-tema" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-tanh.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-trange.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-tema.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-tema.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-tema.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-tema.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-tema.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-tema.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-tema.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-tema.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-tema.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-tema.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-tema.php" hreflang="zh">
...
<meta name="Description" content="Triple Exponential Moving Average" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_tema - Manual" />
<meta name="twitter:description" content="Triple Exponential Moving Average" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_tema - Manual" />
<meta itemprop="description" content="Triple Exponential Moving Average" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Triple Exponential Moving Average" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.trader-trange.php">
          trader_trange &raquo;
              ...
              <div class="prev">
        <a href="function.trader-tanh.php">
          &laquo; trader_tanh        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-tema.php' selected="selected">English</option>
            <option value='de/function.trader-tema.php'>German</option>
            <option value='es/function.trader-tema.php'>Spanish</option>
            <option value='fr/function.trader-tema.php'>French</option>
            <option value='it/function.trader-tema.php'>Italian</option>
            <option value='ja/function.trader-tema.php'>Japanese</option>
            <option value='pt_BR/function.trader-tema.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-tema.php'>Russian</option>
            <option value='tr/function.trader-tema.php'>Turkish</option>
            <option value='uk/function.trader-tema.php'>Ukrainian</option>
            <option value='zh/function.trader-tema.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-tema" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_tema</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_tema</span> &mdash; <span class="dc-title">Triple Exponential Moving Average</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-tema-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_tema</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-tema-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-tema-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-tema.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-tema%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-tema&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-tema.php">＋<small>add a note</small></a></span>
