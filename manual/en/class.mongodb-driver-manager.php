...
<head>
  ...
  <title>PHP: MongoDB\Driver\Manager - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-manager.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-manager">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-manager" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.mongodb.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb.mongodb.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-manager.addsubscriber.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-manager.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-manager.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-manager.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-manager.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-manager.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-manager.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-manager.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-manager.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-manager.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-manager.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-manager.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\Manager class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Manager - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\Manager class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Manager - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\Manager class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\Manager class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-manager.addsubscriber.php">
          MongoDB\Driver\Manager::addSubscriber &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb.mongodb.php">
          &laquo; MongoDB\Driver        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-manager.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-manager.php'>German</option>
            <option value='es/class.mongodb-driver-manager.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-manager.php'>French</option>
            <option value='it/class.mongodb-driver-manager.php'>Italian</option>
            <option value='ja/class.mongodb-driver-manager.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-manager.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-manager.php'>Russian</option>
            <option value='tr/class.mongodb-driver-manager.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-manager.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-manager.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-manager" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-manager.addsubscriber.php">MongoDB\Driver\Manager::addSubscriber</a> — Registers a monitoring event subscriber with this Manager</li><li><a href="mongodb-driver-manager.construct.php">MongoDB\Driver\Manager::__construct</a> — Create new MongoDB Manager</li><li><a href="mongodb-driver-manager.createclientencryption.php">MongoDB\Driver\Manager::createClientEncryption</a> — Create a new ClientEncryption object</li><li><a href="mongodb-driver-manager.executebulkwrite.php">MongoDB\Driver\Manager::executeBulkWrite</a> — Execute one or more write operations</li><li><a href="mongodb-driver-manager.executebulkwritecommand.php">MongoDB\Driver\Manager::executeBulkWriteCommand</a> — Execute write operations using the bulkWrite command</li><li><a href="mongodb-driver-manager.executecommand.php">MongoDB\Driver\Manager::executeCommand</a> — Execute a database command</li><li><a href="mongodb-driver-manager.executequery.php">MongoDB\Driver\Manager::executeQuery</a> — Execute a database query</li><li><a href="mongodb-driver-manager.executereadcommand.php">MongoDB\Driver\Manager::executeReadCommand</a> — Execute a database command that reads</li><li><a href="mongodb-driver-manager.executereadwritecommand.php">MongoDB\Driver\Manager::executeReadWriteCommand</a> — Execute a database command that reads and writes</li><li><a href="mongodb-driver-manager.executewritecommand.php">MongoDB\Driver\Manager::executeWriteCommand</a> — Execute a database command that writes</li><li><a href="mongodb-driver-manager.getencryptedfieldsmap.php">MongoDB\Driver\Manager::getEncryptedFieldsMap</a> — Return the encryptedFieldsMap auto encryption option for the Manager</li><li><a href="mongodb-driver-manager.getreadconcern.php">MongoDB\Driver\Manager::getReadConcern</a> — Return the ReadConcern for the Manager</li><li><a href="mongodb-driver-manager.getreadpreference.php">MongoDB\Driver\Manager::getReadPreference</a> — Return the ReadPreference for the Manager</li><li><a href="mongodb-driver-manager.getservers.php">MongoDB\Driver\Manager::getServers</a> — Return the servers to which this manager is connected</li><li><a href="mongodb-driver-manager.getwriteconcern.php">MongoDB\Driver\Manager::getWriteConcern</a> — Return the WriteConcern for the Manager</li><li><a href="mongodb-driver-manager.removesubscriber.php">MongoDB\Driver\Manager::removeSubscriber</a> — Unregisters a monitoring event subscriber with this Manager</li><li><a href="mongodb-driver-manager.selectserver.php">MongoDB\Driver\Manager::selectServer</a> — Select a server matching a read preference</li><li><a href="mongodb-driver-manager.startsession.php">MongoDB\Driver\Manager::startSession</a> — Start a new client session for use with this client</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/manager.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-manager%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-manager&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-manager.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123060">  <div class="votes">
    <div id="Vu123060">
    <a href="/manual/vote-note.php?id=123060&amp;page=class.mongodb-driver-manager&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123060">
    <a href="/manual/vote-note.php?id=123060&amp;page=class.mongodb-driver-manager&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123060" title="69% like this...">
    9
    </div>
  </div>
  <a href="#123060" class="name">
  <strong class="user"><em>mike at eastghost dot com</em></strong></a><a class="genanchor" href="#123060"> &para;</a><div class="date" title="2018-08-21 11:37"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom123060">
<div class="phpcode"><code><span class="html">According to Mongo, this (i.e., MongoDB\Driver\Manager) is an "entry point" for the extension:<br /><br />"This class serves as an entry point for the MongoDB PHP Library. It is the preferred class for connecting to a MongoDB server or cluster of servers and acts as a gateway for accessing individual databases and collections. MongoDB\Client is analogous to the driver’s MongoDB\Driver\Manager class, which it composes."<br /><br />copied from here: <a href="https://docs.mongodb.com/php-library/master/reference/class/MongoDBClient/" rel="nofollow" target="_blank">https://docs.mongodb.com/php-library/master/reference/class/MongoDBClient/</a><br /><br />However, any comparison of the "mongodb" docs here on php.net versus the "mongodb driver" docs on mongo's site shows dramatic and ever-changing differences.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.mongodb-driver-manager&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-manager.php">＋<small>add a note</small></a></div>
