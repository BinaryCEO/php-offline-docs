...
<head>
  ...
  <title>PHP: ps_string_geometry - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-string-geometry.php">
 <link rel="shorturl" href="https://www.php.net/ps-string-geometry">
 <link rel="alternate" href="https://www.php.net/ps-string-geometry" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-show2.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-stringwidth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-string-geometry.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-string-geometry.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-string-geometry.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-string-geometry.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-string-geometry.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-string-geometry.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-string-geometry.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-string-geometry.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-string-geometry.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-string-geometry.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-string-geometry.php" hreflang="zh">
...
<meta name="Description" content="Gets geometry of a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_string_geometry - Manual" />
<meta name="twitter:description" content="Gets geometry of a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_string_geometry - Manual" />
<meta itemprop="description" content="Gets geometry of a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets geometry of a string" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-string-geometry.php' selected="selected">English</option>
            <option value='de/function.ps-string-geometry.php'>German</option>
            <option value='es/function.ps-string-geometry.php'>Spanish</option>
            <option value='fr/function.ps-string-geometry.php'>French</option>
            <option value='it/function.ps-string-geometry.php'>Italian</option>
            <option value='ja/function.ps-string-geometry.php'>Japanese</option>
            <option value='pt_BR/function.ps-string-geometry.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-string-geometry.php'>Russian</option>
            <option value='tr/function.ps-string-geometry.php'>Turkish</option>
            <option value='uk/function.ps-string-geometry.php'>Ukrainian</option>
            <option value='zh/function.ps-string-geometry.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-string-geometry" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-stringwidth.php" class="function" rel="rdfs-seeAlso">ps_stringwidth()</a> - Gets width of a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-string-geometry.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-string-geometry%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-string-geometry&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-string-geometry.php">＋<small>add a note</small></a></span>
