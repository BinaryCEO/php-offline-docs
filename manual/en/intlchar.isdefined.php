...
<head>
  ...
  <title>PHP: IntlChar::isdefined - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.isdefined.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.isdefined.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isdefined.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.iscntrl.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.isdigit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isdefined.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.isdefined.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.isdefined.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.isdefined.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.isdefined.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.isdefined.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.isdefined.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.isdefined.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.isdefined.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.isdefined.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.isdefined.php" hreflang="zh">
...
<meta name="Description" content="Check whether the code point is defined" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::isdefined - Manual" />
<meta name="twitter:description" content="Check whether the code point is defined" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::isdefined - Manual" />
<meta itemprop="description" content="Check whether the code point is defined" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check whether the code point is defined" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intlchar.isdigit.php">
          IntlChar::isdigit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.iscntrl.php">
          &laquo; IntlChar::iscntrl        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.isdefined.php' selected="selected">English</option>
            <option value='de/intlchar.isdefined.php'>German</option>
            <option value='es/intlchar.isdefined.php'>Spanish</option>
            <option value='fr/intlchar.isdefined.php'>French</option>
            <option value='it/intlchar.isdefined.php'>Italian</option>
            <option value='ja/intlchar.isdefined.php'>Japanese</option>
            <option value='pt_BR/intlchar.isdefined.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.isdefined.php'>Russian</option>
            <option value='tr/intlchar.isdefined.php'>Turkish</option>
            <option value='uk/intlchar.isdefined.php'>Ukrainian</option>
            <option value='zh/intlchar.isdefined.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.isdefined" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::isdefined</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::isdefined</span> &mdash; <span class="dc-title">Check whether the code point is defined</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-intlchar.isdefined-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::isdefined</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$codepoint</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>

  <p class="para rdfs-comment">
   Determines whether the specified code point is &quot;defined&quot;, which usually means that it is assigned a character.
  </p>
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> for general categories other than &quot;Cn&quot; (other, not assigned).
  </p>
 ...
 <div class="refsect1 parameters" id="refsect1-intlchar.isdefined-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.isdefined-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if
   <code class="parameter">codepoint</code> is a defined character, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not. Returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-intlchar.isdefined-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-2725">
   <p><strong>Example #1 Testing different code points</strong></p>
   <div class="example-contents">
    <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isdefined</span><span style="color: #007700">(</span><span style="color: #DD0000">"A"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isdefined</span><span style="color: #007700">(</span><span style="color: #DD0000">" "</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isdefined</span><span style="color: #007700">(</span><span style="color: #DD0000">"\u{FDD0}"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>
...
bool(false)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-intlchar.isdefined-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.istitle.php" class="function" rel="rdfs-seeAlso">IntlChar::istitle()</a> - Check if code point is a titlecase letter</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/isdefined.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.isdefined%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.isdefined&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.isdefined.php">＋<small>add a note</small></a></span>
