...
<head>
  ...
  <title>PHP: SolrQuery::getTermsReturnRaw - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gettermsreturnraw.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gettermsreturnraw.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermsreturnraw.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gettermsprefix.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gettermssort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermsreturnraw.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gettermsreturnraw.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gettermsreturnraw.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gettermsreturnraw.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gettermsreturnraw.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gettermsreturnraw.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gettermsreturnraw.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gettermsreturnraw.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gettermsreturnraw.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gettermsreturnraw.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gettermsreturnraw.php" hreflang="zh">
...
<meta name="Description" content="Whether or not to return raw characters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getTermsReturnRaw - Manual" />
<meta name="twitter:description" content="Whether or not to return raw characters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getTermsReturnRaw - Manual" />
<meta itemprop="description" content="Whether or not to return raw characters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Whether or not to return raw characters" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.gettermssort.php">
          SolrQuery::getTermsSort &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gettermsprefix.php">
          &laquo; SolrQuery::getTermsPrefix        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gettermsreturnraw.php' selected="selected">English</option>
            <option value='de/solrquery.gettermsreturnraw.php'>German</option>
            <option value='es/solrquery.gettermsreturnraw.php'>Spanish</option>
            <option value='fr/solrquery.gettermsreturnraw.php'>French</option>
            <option value='it/solrquery.gettermsreturnraw.php'>Italian</option>
            <option value='ja/solrquery.gettermsreturnraw.php'>Japanese</option>
            <option value='pt_BR/solrquery.gettermsreturnraw.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gettermsreturnraw.php'>Russian</option>
            <option value='tr/solrquery.gettermsreturnraw.php'>Turkish</option>
            <option value='uk/solrquery.gettermsreturnraw.php'>Ukrainian</option>
            <option value='zh/solrquery.gettermsreturnraw.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gettermsreturnraw" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getTermsReturnRaw</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getTermsReturnRaw</span> &mdash; <span class="dc-title">Whether or not to return raw characters</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gettermsreturnraw-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getTermsReturnRaw</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gettermsreturnraw-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gettermsreturnraw-returnvalues">
...
Returns a boolean on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gettermsreturnraw.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gettermsreturnraw%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gettermsreturnraw&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gettermsreturnraw.php">＋<small>add a note</small></a></span>
