...
<head>
  ...
  <title>PHP: ImagickDraw::setTextAlignment - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.settextalignment.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.settextalignment.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextalignment.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setstrokewidth.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.settextantialias.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextalignment.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.settextalignment.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.settextalignment.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.settextalignment.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.settextalignment.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.settextalignment.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.settextalignment.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.settextalignment.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.settextalignment.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.settextalignment.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.settextalignment.php" hreflang="zh">
...
<meta name="Description" content="Specifies a text alignment" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setTextAlignment - Manual" />
<meta name="twitter:description" content="Specifies a text alignment" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setTextAlignment - Manual" />
<meta itemprop="description" content="Specifies a text alignment" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies a text alignment" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.settextantialias.php">
          ImagickDraw::setTextAntialias &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setstrokewidth.php">
          &laquo; ImagickDraw::setStrokeWidth        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.settextalignment.php' selected="selected">English</option>
            <option value='de/imagickdraw.settextalignment.php'>German</option>
            <option value='es/imagickdraw.settextalignment.php'>Spanish</option>
            <option value='fr/imagickdraw.settextalignment.php'>French</option>
            <option value='it/imagickdraw.settextalignment.php'>Italian</option>
            <option value='ja/imagickdraw.settextalignment.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.settextalignment.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.settextalignment.php'>Russian</option>
            <option value='tr/imagickdraw.settextalignment.php'>Turkish</option>
            <option value='uk/imagickdraw.settextalignment.php'>Ukrainian</option>
            <option value='zh/imagickdraw.settextalignment.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.settextalignment" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setTextAlignment</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setTextAlignment</span> &mdash; <span class="dc-title">Specifies a text alignment</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.settextalignment-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setTextAlignment</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$align</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.settextalignment-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">align</code></dt>
     <dd>
      <p class="para">
       One of the <a href="imagick.constants.php#imagick.constants.align" class="link">ALIGN</a> constant
       (<code class="literal">imagick::ALIGN_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.settextalignment-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3191">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/settextalignment.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.settextalignment%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.settextalignment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.settextalignment.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="89215">  <div class="votes">
    <div id="Vu89215">
    <a href="/manual/vote-note.php?id=89215&amp;page=imagickdraw.settextalignment&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd89215">
    <a href="/manual/vote-note.php?id=89215&amp;page=imagickdraw.settextalignment&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V89215" title="40% like this...">
    -3
    </div>
  </div>
  <a href="#89215" class="name">
  <strong class="user"><em>sebastian dot mayer at maysoft dot de</em></strong></a><a class="genanchor" href="#89215"> &para;</a><div class="date" title="2009-02-26 08:33"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom89215">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br />   define</span><span class="keyword">(</span><span class="string">"LEFT"</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br />   </span><span class="default">define</span><span class="keyword">(</span><span class="string">"CENTER"</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">);<br />   </span><span class="default">define</span><span class="keyword">(</span><span class="string">"RIGHT"</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">);<br /><br />   </span><span class="default">$w </span><span class="keyword">= </span><span class="default">400</span><span class="keyword">;<br />   </span><span class="default">$h </span><span class="keyword">= </span><span class="default">200</span><span class="keyword">;<br />   </span><span class="default">$gradient </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />   </span><span class="default">$gradient</span><span class="keyword">-&gt;</span><span class="default">newPseudoImage</span><span class="keyword">(</span><span class="default">$w</span><span class="keyword">, </span><span class="default">$h</span><span class="keyword">, </span><span class="string">"gradient:red-black"</span><span class="keyword">);<br /><br />   </span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();<br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFontSize</span><span class="keyword">(</span><span class="default">12</span><span class="keyword">);<br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">"#ffffff"</span><span class="keyword">));<br /><br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setTextAlignment</span><span class="keyword">(</span><span class="default">LEFT</span><span class="keyword">);<br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">annotation</span><span class="keyword">(</span><span class="default">150</span><span class="keyword">, </span><span class="default">30</span><span class="keyword">, </span><span class="string">"Hello World1!"</span><span class="keyword">);<br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setTextAlignment</span><span class="keyword">(</span><span class="default">CENTER</span><span class="keyword">);<br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">annotation</span><span class="keyword">(</span><span class="default">150</span><span class="keyword">, </span><span class="default">50</span><span class="keyword">, </span><span class="string">"Hello World2!"</span><span class="keyword">);<br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setTextAlignment</span><span class="keyword">(</span><span class="default">RIGHT</span><span class="keyword">);<br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">annotation</span><span class="keyword">(</span><span class="default">150</span><span class="keyword">, </span><span class="default">70</span><span class="keyword">, </span><span class="string">"Hello World3!"</span><span class="keyword">);<br /><br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">"#0000aa"</span><span class="keyword">));<br />   </span><span class="default">$x1 </span><span class="keyword">= </span><span class="default">150</span><span class="keyword">;<br />   </span><span class="default">$x2 </span><span class="keyword">= </span><span class="default">150</span><span class="keyword">;<br />   </span><span class="default">$y1 </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />   </span><span class="default">$y2 </span><span class="keyword">= </span><span class="default">200</span><span class="keyword">;<br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">rectangle</span><span class="keyword">(</span><span class="default">$x1</span><span class="keyword">, </span><span class="default">$y1</span><span class="keyword">, </span><span class="default">$x2</span><span class="keyword">, </span><span class="default">$y2</span><span class="keyword">);<br /><br />   </span><span class="default">$gradient</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">);<br /><br />   </span><span class="default">$gradient</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">"png"</span><span class="keyword">);<br />   </span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: image/png"</span><span class="keyword">);<br />   echo </span><span class="default">$gradient</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.settextalignment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.settextalignment.php">＋<small>add a note</small></a></div>
