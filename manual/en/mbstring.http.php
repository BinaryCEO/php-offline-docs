...
<head>
  ...
  <title>PHP: HTTP Input and Output - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mbstring.http.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mbstring.http.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mbstring.http.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/mbstring.ja-basic.php">
 <link rel="next" href="https://www.php.net/manual/en/mbstring.supported-encodings.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mbstring.http.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mbstring.http.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mbstring.http.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mbstring.http.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mbstring.http.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mbstring.http.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mbstring.http.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mbstring.http.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mbstring.http.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mbstring.http.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mbstring.http.php" hreflang="zh">
...
<meta name="Description" content="HTTP Input and Output" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: HTTP Input and Output - Manual" />
<meta name="twitter:description" content="HTTP Input and Output" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: HTTP Input and Output - Manual" />
<meta itemprop="description" content="HTTP Input and Output" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="HTTP Input and Output" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mbstring.supported-encodings.php">
          Supported Character Encodings &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mbstring.ja-basic.php">
          &laquo; Basics of Japanese multi-byte encodings        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mbstring.http.php' selected="selected">English</option>
            <option value='de/mbstring.http.php'>German</option>
            <option value='es/mbstring.http.php'>Spanish</option>
            <option value='fr/mbstring.http.php'>French</option>
            <option value='it/mbstring.http.php'>Italian</option>
            <option value='ja/mbstring.http.php'>Japanese</option>
            <option value='pt_BR/mbstring.http.php'>Brazilian Portuguese</option>
            <option value='ru/mbstring.http.php'>Russian</option>
            <option value='tr/mbstring.http.php'>Turkish</option>
            <option value='uk/mbstring.http.php'>Ukrainian</option>
            <option value='zh/mbstring.http.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mbstring.http" class="chapter">
...
mbstring.encoding_translation = Off</pre>
 ...
 <p class="para">
  <div class="example" id="example-2760">
...
output_handler      = mb_output_handler
 ...
 <p class="para">
  <div class="example" id="example-2761">
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// Enable output character encoding conversion only for this page<br /><br />// Set HTTP output character encoding to SJIS<br /></span><span style="color: #0000BB">mb_http_output</span><span style="color: #007700">(</span><span style="color: #DD0000">'SJIS'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Start buffering and specify "mb_output_handler" as<br />// callback function<br /></span><span style="color: #0000BB">ob_start</span><span style="color: #007700">(</span><span style="color: #DD0000">'mb_output_handler'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/http-inout.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmbstring.http%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mbstring.http&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mbstring.http.php">＋<small>add a note</small></a></span>
