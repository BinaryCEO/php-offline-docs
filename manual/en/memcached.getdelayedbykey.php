...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.getdelayedbykey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.getdelayedbykey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.getdelayedbykey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.getdelayed.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.getmulti.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.getdelayedbykey.php' selected="selected">English</option>
            <option value='de/memcached.getdelayedbykey.php'>German</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="memcached.fetchall.php" class="methodname" rel="rdfs-seeAlso">Memcached::fetchAll()</a> - Fetch all the remaining results</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/getdelayedbykey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.getdelayedbykey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.getdelayedbykey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.getdelayedbykey.php">＋<small>add a note</small></a></span>
