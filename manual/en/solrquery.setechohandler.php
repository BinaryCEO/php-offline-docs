...
<head>
  ...
  <title>PHP: SolrQuery::setEchoHandler - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setechohandler.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setechohandler.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setechohandler.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.removestatsfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setechoparams.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setechohandler.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setechohandler.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setechohandler.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setechohandler.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setechohandler.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setechohandler.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setechohandler.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setechohandler.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setechohandler.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setechohandler.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setechohandler.php" hreflang="zh">
...
<meta name="Description" content="Toggles the echoHandler parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setEchoHandler - Manual" />
<meta name="twitter:description" content="Toggles the echoHandler parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setEchoHandler - Manual" />
<meta itemprop="description" content="Toggles the echoHandler parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Toggles the echoHandler parameter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setechoparams.php">
          SolrQuery::setEchoParams &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.removestatsfield.php">
          &laquo; SolrQuery::removeStatsField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setechohandler.php' selected="selected">English</option>
            <option value='de/solrquery.setechohandler.php'>German</option>
            <option value='es/solrquery.setechohandler.php'>Spanish</option>
            <option value='fr/solrquery.setechohandler.php'>French</option>
            <option value='it/solrquery.setechohandler.php'>Italian</option>
            <option value='ja/solrquery.setechohandler.php'>Japanese</option>
            <option value='pt_BR/solrquery.setechohandler.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setechohandler.php'>Russian</option>
            <option value='tr/solrquery.setechohandler.php'>Turkish</option>
            <option value='uk/solrquery.setechohandler.php'>Ukrainian</option>
            <option value='zh/solrquery.setechohandler.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setechohandler" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setEchoHandler</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setEchoHandler</span> &mdash; <span class="dc-title">Toggles the echoHandler parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setechohandler-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setEchoHandler</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setechohandler-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setechohandler-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setechohandler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setechohandler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setechohandler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setechohandler.php">＋<small>add a note</small></a></span>
