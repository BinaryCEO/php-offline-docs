...
<head>
  ...
  <title>PHP: ImagickDraw::pathCurveToQuadraticBezierRelative - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pathcurvetoquadraticbezierrelative.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pathcurvetoquadraticbezierrelative.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathcurvetoquadraticbezierrelative.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pathcurvetoquadraticbezierabsolute.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pathcurvetoquadraticbeziersmoothabsolute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathcurvetoquadraticbezierrelative.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pathcurvetoquadraticbezierrelative.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pathcurvetoquadraticbezierrelative.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pathcurvetoquadraticbezierrelative.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pathcurvetoquadraticbezierrelative.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pathcurvetoquadraticbezierrelative.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pathcurvetoquadraticbezierrelative.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pathcurvetoquadraticbezierrelative.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pathcurvetoquadraticbezierrelative.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pathcurvetoquadraticbezierrelative.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pathcurvetoquadraticbezierrelative.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::pathCurveToQuadraticBezierRelative - Manual" />
<meta name="twitter:description" content="Draws a quadratic Bezier curve" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pathCurveToQuadraticBezierRelative - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.pathcurvetoquadraticbeziersmoothabsolute.php">
          ImagickDraw::pathCurveToQuadraticBezierSmoothAbsolute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pathcurvetoquadraticbezierabsolute.php">
          &laquo; ImagickDraw::pathCurveToQuadraticBezierAbsolute        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pathcurvetoquadraticbezierrelative.php' selected="selected">English</option>
            <option value='de/imagickdraw.pathcurvetoquadraticbezierrelative.php'>German</option>
            <option value='es/imagickdraw.pathcurvetoquadraticbezierrelative.php'>Spanish</option>
            <option value='fr/imagickdraw.pathcurvetoquadraticbezierrelative.php'>French</option>
            <option value='it/imagickdraw.pathcurvetoquadraticbezierrelative.php'>Italian</option>
            <option value='ja/imagickdraw.pathcurvetoquadraticbezierrelative.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pathcurvetoquadraticbezierrelative.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pathcurvetoquadraticbezierrelative.php'>Russian</option>
            <option value='tr/imagickdraw.pathcurvetoquadraticbezierrelative.php'>Turkish</option>
            <option value='uk/imagickdraw.pathcurvetoquadraticbezierrelative.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pathcurvetoquadraticbezierrelative.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pathcurvetoquadraticbezierrelative" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pathCurveToQuadraticBezierRelative</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::pathCurveToQuadraticBezierRelative</span> &mdash; <span class="dc-title">Draws a quadratic Bezier curve</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.pathcurvetoquadraticbezierrelative-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::pathCurveToQuadraticBezierRelative</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x_end</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.pathcurvetoquadraticbezierrelative-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.pathcurvetoquadraticbezierrelative-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pathcurvetoquadraticbezierrelative.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pathcurvetoquadraticbezierrelative%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pathcurvetoquadraticbezierrelative&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pathcurvetoquadraticbezierrelative.php">＋<small>add a note</small></a></span>
