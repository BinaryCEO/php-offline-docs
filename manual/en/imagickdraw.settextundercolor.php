...
<head>
  ...
  <title>PHP: ImagickDraw::setTextUnderColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.settextundercolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.settextundercolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextundercolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.settextkerning.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setvectorgraphics.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextundercolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.settextundercolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.settextundercolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.settextundercolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.settextundercolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.settextundercolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.settextundercolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.settextundercolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.settextundercolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.settextundercolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.settextundercolor.php" hreflang="zh">
...
<meta name="Description" content="Specifies the color of a background rectangle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setTextUnderColor - Manual" />
<meta name="twitter:description" content="Specifies the color of a background rectangle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setTextUnderColor - Manual" />
<meta itemprop="description" content="Specifies the color of a background rectangle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the color of a background rectangle" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.setvectorgraphics.php">
          ImagickDraw::setVectorGraphics &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.settextkerning.php">
          &laquo; ImagickDraw::setTextKerning        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.settextundercolor.php' selected="selected">English</option>
            <option value='de/imagickdraw.settextundercolor.php'>German</option>
            <option value='es/imagickdraw.settextundercolor.php'>Spanish</option>
            <option value='fr/imagickdraw.settextundercolor.php'>French</option>
            <option value='it/imagickdraw.settextundercolor.php'>Italian</option>
            <option value='ja/imagickdraw.settextundercolor.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.settextundercolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.settextundercolor.php'>Russian</option>
            <option value='tr/imagickdraw.settextundercolor.php'>Turkish</option>
            <option value='uk/imagickdraw.settextundercolor.php'>Ukrainian</option>
            <option value='zh/imagickdraw.settextundercolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.settextundercolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setTextUnderColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setTextUnderColor</span> &mdash; <span class="dc-title">Specifies the color of a background rectangle</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.settextundercolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setTextUnderColor</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.imagickpixel.php" class="type ImagickPixel">ImagickPixel</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$under_color</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.settextundercolor-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">under_color</code></dt>
     <dd>
      <p class="para">
       the under color
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.settextundercolor-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3194">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/settextundercolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.settextundercolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.settextundercolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.settextundercolor.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="105711">  <div class="votes">
    <div id="Vu105711">
    <a href="/manual/vote-note.php?id=105711&amp;page=imagickdraw.settextundercolor&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105711">
    <a href="/manual/vote-note.php?id=105711&amp;page=imagickdraw.settextundercolor&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105711" title="no votes...">
    0
    </div>
  </div>
  <a href="#105711" class="name">
  <strong class="user"><em>www dot query at gmail dot com</em></strong></a><a class="genanchor" href="#105711"> &para;</a><div class="date" title="2011-09-08 09:01"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105711">
<div class="phpcode"><code><span class="html">When wishing to print some text on a photograph and make that text sufficiently contrasting to the background image, use a 4 byte code for colour and transparency.<br /><br />It is the same 4 byte code using by the parameter '-undercolor' in ImageMagick's command lime instruction 'convert'.<br /><br />The first 3 bytes are the RGB colour code and the fourth byte is the transparency byte.<br /><br /><span class="default">&lt;?php<br /><br />    $draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();<br />    </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">'#ffff00'</span><span class="keyword">);<br />    </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFont</span><span class="keyword">(</span><span class="string">'Eurostile'</span><span class="keyword">);<br />    </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFontSize</span><span class="keyword">(</span><span class="default">21</span><span class="keyword">);<br />    </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setTextUnderColor</span><span class="keyword">(</span><span class="string">'#ff000088'</span><span class="keyword">);<br />    </span><span class="default">$picin</span><span class="keyword">-&gt;</span><span class="default">annotateImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">,</span><span class="default">40</span><span class="keyword">,</span><span class="default">$height</span><span class="keyword">-</span><span class="default">10</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="string">"Hallo"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />The example code produces yellow text on a semi-transparent red background.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.settextundercolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.settextundercolor.php">＋<small>add a note</small></a></div>
