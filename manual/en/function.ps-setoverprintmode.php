...
<head>
  ...
  <title>PHP: ps_setoverprintmode - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-setoverprintmode.php">
 <link rel="shorturl" href="https://www.php.net/ps-setoverprintmode">
 <link rel="alternate" href="https://www.php.net/ps-setoverprintmode" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-setmiterlimit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-setpolydash.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-setoverprintmode.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-setoverprintmode.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-setoverprintmode.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-setoverprintmode.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-setoverprintmode.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-setoverprintmode.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-setoverprintmode.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-setoverprintmode.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-setoverprintmode.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-setoverprintmode.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-setoverprintmode.php" hreflang="zh">
...
<meta name="Description" content="Sets overprint mode" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_setoverprintmode - Manual" />
<meta name="twitter:description" content="Sets overprint mode" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_setoverprintmode - Manual" />
<meta itemprop="description" content="Sets overprint mode" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets overprint mode" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-setpolydash.php">
          ps_setpolydash &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-setmiterlimit.php">
          &laquo; ps_setmiterlimit        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-setoverprintmode.php' selected="selected">English</option>
            <option value='de/function.ps-setoverprintmode.php'>German</option>
            <option value='es/function.ps-setoverprintmode.php'>Spanish</option>
            <option value='fr/function.ps-setoverprintmode.php'>French</option>
            <option value='it/function.ps-setoverprintmode.php'>Italian</option>
            <option value='ja/function.ps-setoverprintmode.php'>Japanese</option>
            <option value='pt_BR/function.ps-setoverprintmode.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-setoverprintmode.php'>Russian</option>
            <option value='tr/function.ps-setoverprintmode.php'>Turkish</option>
            <option value='uk/function.ps-setoverprintmode.php'>Ukrainian</option>
            <option value='zh/function.ps-setoverprintmode.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-setoverprintmode" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_setoverprintmode</h1>
  <p class="verinfo">(PECL ps &gt;= 1.3.0)</p><p class="refpurpose"><span class="refname">ps_setoverprintmode</span> &mdash; <span class="dc-title">Sets overprint mode</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-setoverprintmode-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_setoverprintmode</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mode</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-setoverprintmode-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-setoverprintmode-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-setoverprintmode.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-setoverprintmode%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-setoverprintmode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-setoverprintmode.php">＋<small>add a note</small></a></span>
