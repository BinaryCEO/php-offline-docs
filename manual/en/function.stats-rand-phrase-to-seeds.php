...
<head>
  ...
  <title>PHP: stats_rand_phrase_to_seeds - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-rand-phrase-to-seeds.php">
 <link rel="shorturl" href="https://www.php.net/stats-rand-phrase-to-seeds">
 <link rel="alternate" href="https://www.php.net/stats-rand-phrase-to-seeds" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-rand-get-seeds.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-rand-ranf.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-rand-phrase-to-seeds.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-rand-phrase-to-seeds.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-rand-phrase-to-seeds.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-rand-phrase-to-seeds.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-rand-phrase-to-seeds.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-rand-phrase-to-seeds.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-rand-phrase-to-seeds.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-rand-phrase-to-seeds.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-rand-phrase-to-seeds.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-rand-phrase-to-seeds.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-rand-phrase-to-seeds.php" hreflang="zh">
...
<meta name="Description" content="Generate two seeds for the RGN random number generator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_rand_phrase_to_seeds - Manual" />
<meta name="twitter:description" content="Generate two seeds for the RGN random number generator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_rand_phrase_to_seeds - Manual" />
<meta itemprop="description" content="Generate two seeds for the RGN random number generator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generate two seeds for the RGN random number generator" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stats-rand-ranf.php">
          stats_rand_ranf &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-rand-get-seeds.php">
          &laquo; stats_rand_get_seeds        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-rand-phrase-to-seeds.php' selected="selected">English</option>
            <option value='de/function.stats-rand-phrase-to-seeds.php'>German</option>
            <option value='es/function.stats-rand-phrase-to-seeds.php'>Spanish</option>
            <option value='fr/function.stats-rand-phrase-to-seeds.php'>French</option>
            <option value='it/function.stats-rand-phrase-to-seeds.php'>Italian</option>
            <option value='ja/function.stats-rand-phrase-to-seeds.php'>Japanese</option>
            <option value='pt_BR/function.stats-rand-phrase-to-seeds.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-rand-phrase-to-seeds.php'>Russian</option>
            <option value='tr/function.stats-rand-phrase-to-seeds.php'>Turkish</option>
            <option value='uk/function.stats-rand-phrase-to-seeds.php'>Ukrainian</option>
            <option value='zh/function.stats-rand-phrase-to-seeds.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-rand-phrase-to-seeds" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_rand_phrase_to_seeds</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_rand_phrase_to_seeds</span> &mdash; <span class="dc-title">Generate two seeds for the RGN random number generator</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-rand-phrase-to-seeds-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>stats_rand_phrase_to_seeds</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$phrase</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   Generate two seeds for the random number generator from a <code class="parameter">phrase</code>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.stats-rand-phrase-to-seeds-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">phrase</code></dt>
     <dd>
      <p class="para">
       The input phrase
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-rand-phrase-to-seeds-returnvalues">
  ...
  <p class="para">
   Returns an array of two integers.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-rand-phrase-to-seeds.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-rand-phrase-to-seeds%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-rand-phrase-to-seeds&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-rand-phrase-to-seeds.php">＋<small>add a note</small></a></span>
