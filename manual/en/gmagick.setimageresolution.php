...
<head>
  ...
  <title>PHP: Gmagick::setimageresolution - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimageresolution.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimageresolution.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageresolution.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimagerenderingintent.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagescene.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageresolution.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimageresolution.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimageresolution.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimageresolution.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimageresolution.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimageresolution.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimageresolution.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimageresolution.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimageresolution.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimageresolution.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimageresolution.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimageresolution - Manual" />
<meta name="twitter:description" content="Sets the image resolution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimageresolution - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.setimagescene.php">
          Gmagick::setimagescene &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimagerenderingintent.php">
          &laquo; Gmagick::setimagerenderingintent        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimageresolution.php' selected="selected">English</option>
            <option value='de/gmagick.setimageresolution.php'>German</option>
            <option value='es/gmagick.setimageresolution.php'>Spanish</option>
            <option value='fr/gmagick.setimageresolution.php'>French</option>
            <option value='it/gmagick.setimageresolution.php'>Italian</option>
            <option value='ja/gmagick.setimageresolution.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimageresolution.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimageresolution.php'>Russian</option>
            <option value='tr/gmagick.setimageresolution.php'>Turkish</option>
            <option value='uk/gmagick.setimageresolution.php'>Ukrainian</option>
            <option value='zh/gmagick.setimageresolution.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimageresolution" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimageresolution</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimageresolution</span> &mdash; <span class="dc-title">Sets the image resolution</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimageresolution-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimageresolution</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$xResolution</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$yResolution</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimageresolution-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimageresolution-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimageresolution-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimageresolution.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimageresolution%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimageresolution&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimageresolution.php">＋<small>add a note</small></a></span>
