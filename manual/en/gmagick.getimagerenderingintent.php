...
<head>
  ...
  <title>PHP: Gmagick::getimagerenderingintent - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagerenderingintent.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagerenderingintent.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagerenderingintent.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimageredprimary.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimageresolution.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagerenderingintent.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagerenderingintent.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagerenderingintent.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagerenderingintent.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagerenderingintent.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagerenderingintent.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagerenderingintent.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagerenderingintent.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagerenderingintent.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagerenderingintent.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagerenderingintent.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimagerenderingintent - Manual" />
<meta name="twitter:description" content="Gets the image rendering intent" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagerenderingintent - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.getimageresolution.php">
          Gmagick::getimageresolution &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimageredprimary.php">
          &laquo; Gmagick::getimageredprimary        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagerenderingintent.php' selected="selected">English</option>
            <option value='de/gmagick.getimagerenderingintent.php'>German</option>
            <option value='es/gmagick.getimagerenderingintent.php'>Spanish</option>
            <option value='fr/gmagick.getimagerenderingintent.php'>French</option>
            <option value='it/gmagick.getimagerenderingintent.php'>Italian</option>
            <option value='ja/gmagick.getimagerenderingintent.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagerenderingintent.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagerenderingintent.php'>Russian</option>
            <option value='tr/gmagick.getimagerenderingintent.php'>Turkish</option>
            <option value='uk/gmagick.getimagerenderingintent.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagerenderingintent.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagerenderingintent" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagerenderingintent</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagerenderingintent</span> &mdash; <span class="dc-title">Gets the image rendering intent</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagerenderingintent-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagerenderingintent</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagerenderingintent-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagerenderingintent-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagerenderingintent-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagerenderingintent.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagerenderingintent%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagerenderingintent&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagerenderingintent.php">＋<small>add a note</small></a></span>
