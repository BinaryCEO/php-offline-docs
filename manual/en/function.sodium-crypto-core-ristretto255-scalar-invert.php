...
<head>
  ...
  <title>PHP: sodium_crypto_core_ristretto255_scalar_invert - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-scalar-invert.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-core-ristretto255-scalar-invert">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-core-ristretto255-scalar-invert" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-scalar-complement.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-scalar-mul.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-scalar-invert.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-core-ristretto255-scalar-invert.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-core-ristretto255-scalar-invert.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-core-ristretto255-scalar-invert.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-core-ristretto255-scalar-invert.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-core-ristretto255-scalar-invert.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-core-ristretto255-scalar-invert.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-core-ristretto255-scalar-invert.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-core-ristretto255-scalar-invert.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-core-ristretto255-scalar-invert.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-core-ristretto255-scalar-invert.php" hreflang="zh">
...
<meta name="Description" content="Inverts a scalar value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_core_ristretto255_scalar_invert - Manual" />
<meta name="twitter:description" content="Inverts a scalar value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_core_ristretto255_scalar_invert - Manual" />
<meta itemprop="description" content="Inverts a scalar value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Inverts a scalar value" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-core-ristretto255-scalar-mul.php">
          sodium_crypto_core_ristretto255_scalar_mul &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-core-ristretto255-scalar-complement.php">
          &laquo; sodium_crypto_core_ristretto255_scalar_complement        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-core-ristretto255-scalar-invert.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-core-ristretto255-scalar-invert.php'>German</option>
            <option value='es/function.sodium-crypto-core-ristretto255-scalar-invert.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-core-ristretto255-scalar-invert.php'>French</option>
            <option value='it/function.sodium-crypto-core-ristretto255-scalar-invert.php'>Italian</option>
            <option value='ja/function.sodium-crypto-core-ristretto255-scalar-invert.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-core-ristretto255-scalar-invert.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-core-ristretto255-scalar-invert.php'>Russian</option>
            <option value='tr/function.sodium-crypto-core-ristretto255-scalar-invert.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-core-ristretto255-scalar-invert.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-core-ristretto255-scalar-invert.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-core-ristretto255-scalar-invert" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_core_ristretto255_scalar_invert</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.1.0)</p><p class="refpurpose"><span class="refname">sodium_crypto_core_ristretto255_scalar_invert</span> &mdash; <span class="dc-title">Inverts a scalar value</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-core-ristretto255-scalar-invert-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_core_ristretto255_scalar_invert</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$s</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-core-ristretto255-scalar-invert-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-core-ristretto255-scalar-invert-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.sodium-crypto-core-ristretto255-scalar-invert-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1069">
    <p><strong>Example #1 <span class="function"><strong>sodium_crypto_core_ristretto255_scalar_invert()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$foo </span><span style="color: #007700">= </span><span style="color: #0000BB">sodium_crypto_core_ristretto255_scalar_random</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$inverted </span><span style="color: #007700">= </span><span style="color: #0000BB">sodium_crypto_core_ristretto255_scalar_invert</span><span style="color: #007700">(</span><span style="color: #0000BB">$foo</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$reInverted </span><span style="color: #007700">= </span><span style="color: #0000BB">sodium_crypto_core_ristretto255_scalar_invert</span><span style="color: #007700">(</span><span style="color: #0000BB">$inverted</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">hash_equals</span><span style="color: #007700">(</span><span style="color: #0000BB">$foo</span><span style="color: #007700">, </span><span style="color: #0000BB">$reInverted</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
<div class="examplescode"><pre class="examplescode">bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.sodium-crypto-core-ristretto255-scalar-invert-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.sodium-crypto-core-ristretto255-scalar-random.php" class="function" rel="rdfs-seeAlso">sodium_crypto_core_ristretto255_scalar_random()</a> - Generates a random key</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-core-ristretto255-scalar-invert.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-core-ristretto255-scalar-invert%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-core-ristretto255-scalar-invert&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-scalar-invert.php">＋<small>add a note</small></a></span>
