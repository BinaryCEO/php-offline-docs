...
<head>
  ...
  <title>PHP: SolrQuery::setShowDebugInfo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setshowdebuginfo.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setshowdebuginfo.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setshowdebuginfo.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setrows.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setstart.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setshowdebuginfo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setshowdebuginfo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setshowdebuginfo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setshowdebuginfo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setshowdebuginfo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setshowdebuginfo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setshowdebuginfo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setshowdebuginfo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setshowdebuginfo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setshowdebuginfo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setshowdebuginfo.php" hreflang="zh">
...
<meta name="Description" content="Flag to show debug information" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setShowDebugInfo - Manual" />
<meta name="twitter:description" content="Flag to show debug information" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setShowDebugInfo - Manual" />
<meta itemprop="description" content="Flag to show debug information" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Flag to show debug information" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setstart.php">
          SolrQuery::setStart &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setrows.php">
          &laquo; SolrQuery::setRows        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setshowdebuginfo.php' selected="selected">English</option>
            <option value='de/solrquery.setshowdebuginfo.php'>German</option>
            <option value='es/solrquery.setshowdebuginfo.php'>Spanish</option>
            <option value='fr/solrquery.setshowdebuginfo.php'>French</option>
            <option value='it/solrquery.setshowdebuginfo.php'>Italian</option>
            <option value='ja/solrquery.setshowdebuginfo.php'>Japanese</option>
            <option value='pt_BR/solrquery.setshowdebuginfo.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setshowdebuginfo.php'>Russian</option>
            <option value='tr/solrquery.setshowdebuginfo.php'>Turkish</option>
            <option value='uk/solrquery.setshowdebuginfo.php'>Ukrainian</option>
            <option value='zh/solrquery.setshowdebuginfo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setshowdebuginfo" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setShowDebugInfo</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setShowDebugInfo</span> &mdash; <span class="dc-title">Flag to show debug information</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setshowdebuginfo-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setShowDebugInfo</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setshowdebuginfo-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Whether to show debug info. <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setshowdebuginfo-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setshowdebuginfo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setshowdebuginfo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setshowdebuginfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setshowdebuginfo.php">＋<small>add a note</small></a></span>
