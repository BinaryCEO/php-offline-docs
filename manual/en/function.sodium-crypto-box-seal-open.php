...
<head>
  ...
  <title>PHP: sodium_crypto_box_seal_open - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-box-seal-open.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-box-seal-open">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-box-seal-open" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-box-seal.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-box-secretkey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-box-seal-open.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-box-seal-open.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-box-seal-open.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-box-seal-open.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-box-seal-open.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-box-seal-open.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-box-seal-open.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-box-seal-open.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-box-seal-open.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-box-seal-open.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-box-seal-open.php" hreflang="zh">
...
<meta name="Description" content="Anonymous public-key decryption" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_box_seal_open - Manual" />
<meta name="twitter:description" content="Anonymous public-key decryption" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_box_seal_open - Manual" />
<meta itemprop="description" content="Anonymous public-key decryption" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Anonymous public-key decryption" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-box-secretkey.php">
          sodium_crypto_box_secretkey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-box-seal.php">
          &laquo; sodium_crypto_box_seal        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-box-seal-open.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-box-seal-open.php'>German</option>
            <option value='es/function.sodium-crypto-box-seal-open.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-box-seal-open.php'>French</option>
            <option value='it/function.sodium-crypto-box-seal-open.php'>Italian</option>
            <option value='ja/function.sodium-crypto-box-seal-open.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-box-seal-open.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-box-seal-open.php'>Russian</option>
            <option value='tr/function.sodium-crypto-box-seal-open.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-box-seal-open.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-box-seal-open.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-box-seal-open" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_box_seal_open</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_box_seal_open</span> &mdash; <span class="dc-title">Anonymous public-key decryption</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-box-seal-open-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_box_seal_open</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$ciphertext</code></span>, <span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key_pair</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Decrypt a message that was encrypted with <span class="function"><a href="function.sodium-crypto-box-seal.php" class="function">sodium_crypto_box_seal()</a></span>
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-box-seal-open-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-box-seal-open-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The plaintext on success,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>



 <div class="refsect1 examples" id="refsect1-function.sodium-crypto-box-seal-open-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="sodium-crypto-box-seal-open.example.basic">
   <p><strong>Example #1 <span class="function"><strong>sodium_crypto_box_seal_open()</strong></span> example</strong></p>
   <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Ciphertext is not sensitive; base64_decode is fine<br /></span><span style="color: #0000BB">$sealed_b64 </span><span style="color: #007700">= </span><span style="color: #DD0000">"oRBXXAV4iQBrxlV4A21Bord8Yo/D8ZlrIIGNyaRCcGBfpz0map52I3xq6l+CST+1NSgQkbV+HiYyFjXWiWiaCGupGf+zl4bgWj/A9Adtem7Jt3h3emrMsLw="</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$sealed </span><span style="color: #007700">= </span><span style="color: #0000BB">base64_decode</span><span style="color: #007700">(</span><span style="color: #0000BB">$sealed_b64</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Keypair contains a cryptographic secret; use a timing-safe decoder<br /></span><span style="color: #0000BB">$keypair_b64 </span><span style="color: #007700">= </span><span style="color: #DD0000">"KZkF8wnB7bnC2aXB3lFOqCTc0Z6MllvaQb9ASVG8o2/MsewkuE4u1uaEgTzSakeiYyIW8DGj+02/L3cWIbs9bQ=="</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$keypair </span><span style="color: #007700">= </span><span style="color: #0000BB">sodium_base642bin</span><span style="color: #007700">(</span><span style="color: #0000BB">$keypair_b64</span><span style="color: #007700">, </span><span style="color: #0000BB">SODIUM_BASE64_VARIANT_ORIGINAL</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$opened </span><span style="color: #007700">= </span><span style="color: #0000BB">sodium_crypto_box_seal_open</span><span style="color: #007700">(</span><span style="color: #0000BB">$sealed</span><span style="color: #007700">, </span><span style="color: #0000BB">$keypair</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$opened</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>

   <div class="example-contents"><p>The above example will output
something similar to:</p></div>
   <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">string(41) &quot;Writing software in PHP can be a delight!&quot;</pre>
</div>
   </div>
  </div>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-box-seal-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-box-seal-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-box-seal-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-box-seal-open.php">＋<small>add a note</small></a></span>
