...
<head>
  ...
  <title>PHP: Memcached::getDelayed - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.getdelayed.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.getdelayed.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.getdelayed.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.getbykey.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.getdelayedbykey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.getdelayed.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.getdelayed.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.getdelayed.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.getdelayed.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.getdelayed.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.getdelayed.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.getdelayed.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.getdelayed.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.getdelayed.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.getdelayed.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.getdelayed.php" hreflang="zh">
...
<meta name="Description" content="Request multiple items" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::getDelayed - Manual" />
<meta name="twitter:description" content="Request multiple items" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::getDelayed - Manual" />
<meta itemprop="description" content="Request multiple items" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Request multiple items" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="memcached.getdelayedbykey.php">
          Memcached::getDelayedByKey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.getbykey.php">
          &laquo; Memcached::getByKey        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.getdelayed.php' selected="selected">English</option>
            <option value='de/memcached.getdelayed.php'>German</option>
            <option value='es/memcached.getdelayed.php'>Spanish</option>
            <option value='fr/memcached.getdelayed.php'>French</option>
            <option value='it/memcached.getdelayed.php'>Italian</option>
            <option value='ja/memcached.getdelayed.php'>Japanese</option>
            <option value='pt_BR/memcached.getdelayed.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.getdelayed.php'>Russian</option>
            <option value='tr/memcached.getdelayed.php'>Turkish</option>
            <option value='uk/memcached.getdelayed.php'>Ukrainian</option>
            <option value='zh/memcached.getdelayed.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.getdelayed" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Memcached::getDelayed</h1>
  <p class="verinfo">(PECL memcached &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">Memcached::getDelayed</span> &mdash; <span class="dc-title">Request multiple items</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-memcached.getdelayed-examples">
  ...
  <p class="para">
   <div class="example" id="example-4683">
    <p><strong>Example #1 <span class="function"><strong>Memcached::getDelayed()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">array(2) {
 ...
 <div class="refsect1 seealso" id="refsect1-memcached.getdelayed-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="memcached.getdelayedbykey.php" class="methodname" rel="rdfs-seeAlso">Memcached::getDelayedByKey()</a> - Request multiple items from a specific server</span></li>
    ...
    <li><span class="methodname"><a href="memcached.fetchall.php" class="methodname" rel="rdfs-seeAlso">Memcached::fetchAll()</a> - Fetch all the remaining results</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/getdelayed.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.getdelayed%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.getdelayed&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.getdelayed.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="102517">  <div class="votes">
    <div id="Vu102517">
    <a href="/manual/vote-note.php?id=102517&amp;page=memcached.getdelayed&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102517">
    <a href="/manual/vote-note.php?id=102517&amp;page=memcached.getdelayed&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102517" title="100% like this...">
    2
    </div>
  </div>
  <a href="#102517" class="name">
  <strong class="user"><em>antmat at mail dot ru</em></strong></a><a class="genanchor" href="#102517"> &para;</a><div class="date" title="2011-02-18 08:16"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102517">
<div class="phpcode"><code><span class="html">Actually, when you pass a callback, method doesn't return immediately, but waits for results and calls callback function.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=memcached.getdelayed&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.getdelayed.php">＋<small>add a note</small></a></div>
