...
<head>
  ...
  <title>PHP: pg_trace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-trace.php">
 <link rel="shorturl" href="https://www.php.net/pg-trace">
 <link rel="alternate" href="https://www.php.net/pg-trace" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-socket.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-transaction-status.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-trace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-trace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-trace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-trace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-trace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-trace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-trace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-trace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-trace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-trace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-trace.php" hreflang="zh">
...
<meta name="Description" content="Enable tracing a PostgreSQL connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_trace - Manual" />
<meta name="twitter:description" content="Enable tracing a PostgreSQL connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_trace - Manual" />
<meta itemprop="description" content="Enable tracing a PostgreSQL connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enable tracing a PostgreSQL connection" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-trace.php' selected="selected">English</option>
            <option value='de/function.pg-trace.php'>German</option>
            <option value='es/function.pg-trace.php'>Spanish</option>
            <option value='fr/function.pg-trace.php'>French</option>
            <option value='it/function.pg-trace.php'>Italian</option>
            <option value='ja/function.pg-trace.php'>Japanese</option>
            <option value='pt_BR/function.pg-trace.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-trace.php'>Russian</option>
            <option value='tr/function.pg-trace.php'>Turkish</option>
            <option value='uk/function.pg-trace.php'>Ukrainian</option>
            <option value='zh/function.pg-trace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-trace" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-untrace.php" class="function" rel="rdfs-seeAlso">pg_untrace()</a> - Disable tracing of a PostgreSQL connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-trace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-trace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-trace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-trace.php">＋<small>add a note</small></a></span>
