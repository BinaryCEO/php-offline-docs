...
<head>
  ...
  <title>PHP: get_required_files - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.get-required-files.php">
 <link rel="shorturl" href="https://www.php.net/get-required-files">
 <link rel="alternate" href="https://www.php.net/get-required-files" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.get-magic-quotes-runtime.php">
 <link rel="next" href="https://www.php.net/manual/en/function.get-resources.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.get-required-files.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.get-required-files.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.get-required-files.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.get-required-files.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.get-required-files.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.get-required-files.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.get-required-files.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.get-required-files.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.get-required-files.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.get-required-files.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.get-required-files.php" hreflang="zh">
...
<meta name="Description" content="Alias of get_included_files" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: get_required_files - Manual" />
<meta name="twitter:description" content="Alias of get_included_files" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: get_required_files - Manual" />
<meta itemprop="description" content="Alias of get_included_files" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of get_included_files" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.get-magic-quotes-runtime.php">
          &laquo; get_magic_quotes_runtime        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.get-required-files.php' selected="selected">English</option>
            <option value='de/function.get-required-files.php'>German</option>
            <option value='es/function.get-required-files.php'>Spanish</option>
            <option value='fr/function.get-required-files.php'>French</option>
            <option value='it/function.get-required-files.php'>Italian</option>
            <option value='ja/function.get-required-files.php'>Japanese</option>
            <option value='pt_BR/function.get-required-files.php'>Brazilian Portuguese</option>
            <option value='ru/function.get-required-files.php'>Russian</option>
            <option value='tr/function.get-required-files.php'>Turkish</option>
            <option value='uk/function.get-required-files.php'>Ukrainian</option>
            <option value='zh/function.get-required-files.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.get-required-files" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">get_required_files</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">get_required_files</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.get-included-files.php" class="function">get_included_files()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.get-required-files-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of:  <span class="function"><a href="function.get-included-files.php" class="function">get_included_files()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/get-required-files.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.get-required-files%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.get-required-files&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-required-files.php">＋<small>add a note</small></a></span>
