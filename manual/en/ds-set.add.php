...
<head>
  ...
  <title>PHP: Ds\Set::add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-set.add.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-set.add.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-set.add.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-set.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.ds-set.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-set.allocate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ds-set.add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ds-set.add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ds-set.add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ds-set.add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ds-set.add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ds-set.add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ds-set.add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ds-set.add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ds-set.add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ds-set.add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ds-set.add.php" hreflang="zh">
...
<meta name="Description" content="Adds values to the set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Ds\Set::add - Manual" />
<meta name="twitter:description" content="Adds values to the set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Ds\Set::add - Manual" />
<meta itemprop="description" content="Adds values to the set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds values to the set" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-set.add.php' selected="selected">English</option>
            <option value='de/ds-set.add.php'>German</option>
            <option value='es/ds-set.add.php'>Spanish</option>
            <option value='fr/ds-set.add.php'>French</option>
            <option value='it/ds-set.add.php'>Italian</option>
            <option value='ja/ds-set.add.php'>Japanese</option>
            <option value='pt_BR/ds-set.add.php'>Brazilian Portuguese</option>
            <option value='ru/ds-set.add.php'>Russian</option>
            <option value='tr/ds-set.add.php'>Turkish</option>
            <option value='uk/ds-set.add.php'>Ukrainian</option>
            <option value='zh/ds-set.add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ds-set.add" class="refentry">
  ...
  object(HashableObject)#6 (1) {
    ...
    int(2)
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/set/add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-set.add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-set.add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-set.add.php">＋<small>add a note</small></a></span>
