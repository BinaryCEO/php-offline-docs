...
<head>
  ...
  <title>PHP: stats_skew - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-skew.php">
 <link rel="shorturl" href="https://www.php.net/stats-skew">
 <link rel="alternate" href="https://www.php.net/stats-skew" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-rand-setall.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-standard-deviation.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-skew.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-skew.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-skew.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-skew.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-skew.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-skew.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-skew.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-skew.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-skew.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-skew.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-skew.php" hreflang="zh">
...
<meta name="Description" content="Computes the skewness of the data in the array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_skew - Manual" />
<meta name="twitter:description" content="Computes the skewness of the data in the array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_skew - Manual" />
<meta itemprop="description" content="Computes the skewness of the data in the array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Computes the skewness of the data in the array" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stats-standard-deviation.php">
          stats_standard_deviation &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-rand-setall.php">
          &laquo; stats_rand_setall        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-skew.php' selected="selected">English</option>
            <option value='de/function.stats-skew.php'>German</option>
            <option value='es/function.stats-skew.php'>Spanish</option>
            <option value='fr/function.stats-skew.php'>French</option>
            <option value='it/function.stats-skew.php'>Italian</option>
            <option value='ja/function.stats-skew.php'>Japanese</option>
            <option value='pt_BR/function.stats-skew.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-skew.php'>Russian</option>
            <option value='tr/function.stats-skew.php'>Turkish</option>
            <option value='uk/function.stats-skew.php'>Ukrainian</option>
            <option value='zh/function.stats-skew.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-skew" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_skew</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_skew</span> &mdash; <span class="dc-title">Computes the skewness of the data in the array</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.stats-skew-description">
  ...
  <p class="para rdfs-comment">
   Returns the skewness of the values in <code class="parameter">a</code>.
  </p>
 </div>
  ...
  <p class="para">
   ...
   or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if <code class="parameter">a</code> is empty or is not an array.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-skew.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-skew%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-skew&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-skew.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118471">  <div class="votes">
    <div id="Vu118471">
    <a href="/manual/vote-note.php?id=118471&amp;page=function.stats-skew&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118471">
    <a href="/manual/vote-note.php?id=118471&amp;page=function.stats-skew&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118471" title="40% like this...">
    -1
    </div>
  </div>
  <a href="#118471" class="name">
  <strong class="user"><em>Angel J. Salinas</em></strong></a><a class="genanchor" href="#118471"> &para;</a><div class="date" title="2015-12-11 08:35"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118471">
<div class="phpcode"><code><span class="html">If you don't have the php_stats library, you can use this implementation:<br /><br />  public static function getSkewness( $values )<br />  {<br />    $numValues = count( $values );<br />    if ( $numValues == 0 ) {<br />      return 0.0;<br />    }<br />    <br />    // Use function from php_stats library if available<br />    if ( function_exists( 'stats_skew' ) ) {<br />      return stats_skew( $values );<br />    }<br />    <br />    $mean = array_sum( $values ) / floatval( $numValues );<br />    <br />    $add2 = 0.0;<br />    $add3 = 0.0;<br />    foreach ( $values as $value ) {<br />      if ( ! is_numeric( $value ) ) {<br />        return false;<br />      }<br />    <br />      $dif = $value - $mean;<br />      $add2 += ( $dif * $dif );<br />      $add3 += ( $dif * $dif * $dif );<br />      <br />    } // foreach values<br />    <br />    $variance = $add2 / floatval( $numValues );<br />    <br />    return ( $add3 / floatval( $numValues ) ) / pow( $variance, 3 / 2.0  );<br />  }</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stats-skew&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-skew.php">＋<small>add a note</small></a></div>
