...
<head>
  ...
  <title>PHP: InvalidArgumentException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.invalidargumentexception.php">
 <link rel="shorturl" href="https://www.php.net/invalidargumentexception">
 <link rel="alternate" href="https://www.php.net/invalidargumentexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/spl.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.domainexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.lengthexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.invalidargumentexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.invalidargumentexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.invalidargumentexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.invalidargumentexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.invalidargumentexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.invalidargumentexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.invalidargumentexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.invalidargumentexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.invalidargumentexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.invalidargumentexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.invalidargumentexception.php" hreflang="zh">
...
<meta name="Description" content="The InvalidArgumentException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: InvalidArgumentException - Manual" />
<meta name="twitter:description" content="The InvalidArgumentException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: InvalidArgumentException - Manual" />
<meta itemprop="description" content="The InvalidArgumentException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The InvalidArgumentException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.lengthexception.php">
          LengthException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.domainexception.php">
          &laquo; DomainException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.invalidargumentexception.php' selected="selected">English</option>
            <option value='de/class.invalidargumentexception.php'>German</option>
            <option value='es/class.invalidargumentexception.php'>Spanish</option>
            <option value='fr/class.invalidargumentexception.php'>French</option>
            <option value='it/class.invalidargumentexception.php'>Italian</option>
            <option value='ja/class.invalidargumentexception.php'>Japanese</option>
            <option value='pt_BR/class.invalidargumentexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.invalidargumentexception.php'>Russian</option>
            <option value='tr/class.invalidargumentexception.php'>Turkish</option>
            <option value='uk/class.invalidargumentexception.php'>Ukrainian</option>
            <option value='zh/class.invalidargumentexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.invalidargumentexception" class="reference">
 <h1 class="title">The InvalidArgumentException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p>
 

  <div class="section" id="invalidargumentexception.intro">
  ...
  <div class="section" id="invalidargumentexception.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">InvalidArgumentException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/invalidargumentexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.invalidargumentexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.invalidargumentexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.invalidargumentexception.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="102218">  <div class="votes">
    <div id="Vu102218">
    <a href="/manual/vote-note.php?id=102218&amp;page=class.invalidargumentexception&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102218">
    <a href="/manual/vote-note.php?id=102218&amp;page=class.invalidargumentexception&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102218" title="53% like this...">
    11
    </div>
  </div>
  <a href="#102218" class="name">
  <strong class="user"><em>Joey at anti-culture dot net</em></strong></a><a class="genanchor" href="#102218"> &para;</a><div class="date" title="2011-02-02 09:08"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102218">
<div class="phpcode"><code><span class="html">In my opinion this exception is invaluable for validating arguments- for example providing strict typing a la C:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">tripleInteger</span><span class="keyword">(</span><span class="default">$int</span><span class="keyword">)<br />{<br />  if(!</span><span class="default">is_int</span><span class="keyword">(</span><span class="default">$int</span><span class="keyword">))<br />    throw new </span><span class="default">InvalidArgumentException</span><span class="keyword">(</span><span class="string">'tripleInteger function only accepts integers. Input was: '</span><span class="keyword">.</span><span class="default">$int</span><span class="keyword">);<br />  return </span><span class="default">$int </span><span class="keyword">* </span><span class="default">3</span><span class="keyword">;<br />}<br /><br /></span><span class="default">$x </span><span class="keyword">= </span><span class="default">tripleInteger</span><span class="keyword">(</span><span class="default">4</span><span class="keyword">); </span><span class="comment">//$x == 12<br /></span><span class="default">$x </span><span class="keyword">= </span><span class="default">tripleInteger</span><span class="keyword">(</span><span class="default">2.5</span><span class="keyword">); </span><span class="comment">//exception will be thrown as 2.5 is a float<br /></span><span class="default">$x </span><span class="keyword">= </span><span class="default">tripleInteger</span><span class="keyword">(</span><span class="string">'foo'</span><span class="keyword">); </span><span class="comment">//exception will be thrown as 'foo' is a string<br /></span><span class="default">$x </span><span class="keyword">= </span><span class="default">tripleInteger</span><span class="keyword">(</span><span class="string">'4'</span><span class="keyword">); </span><span class="comment">//exception will throw as '4' is also a string<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.invalidargumentexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.invalidargumentexception.php">＋<small>add a note</small></a></div>
