...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.asort.php">
 <link rel="shorturl" href="https://www.php.net/asort">
 <link rel="alternate" href="https://www.php.net/asort" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.arsort.php">
 <link rel="next" href="https://www.php.net/manual/en/function.compact.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.asort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.asort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.asort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.asort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.asort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.asort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.asort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.asort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.asort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.asort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.asort.php" hreflang="zh">
...
<meta name="Description" content="Sort an array in ascending order and maintain index association" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: asort - Manual" />
<meta name="twitter:description" content="Sort an array in ascending order and maintain index association" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: asort - Manual" />
<meta itemprop="description" content="Sort an array in ascending order and maintain index association" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sort an array in ascending order and maintain index association" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.asort.php' selected="selected">English</option>
            <option value='de/function.asort.php'>German</option>
            <option value='es/function.asort.php'>Spanish</option>
            <option value='fr/function.asort.php'>French</option>
            <option value='it/function.asort.php'>Italian</option>
            <option value='ja/function.asort.php'>Japanese</option>
            <option value='pt_BR/function.asort.php'>Brazilian Portuguese</option>
            <option value='ru/function.asort.php'>Russian</option>
            <option value='tr/function.asort.php'>Turkish</option>
            <option value='uk/function.asort.php'>Ukrainian</option>
            <option value='zh/function.asort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.asort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">asort</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">asort</span> &mdash; <span class="dc-title">Sort an array in ascending order and maintain index association</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.asort-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>asort</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter reference">&$array</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = <strong><code><a href="array.constants.php#constant.sort-regular">SORT_REGULAR</a></code></strong></span></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>

  <p class="para rdfs-comment">
   Sorts <code class="parameter">array</code> in place in ascending order,
 ...
 <div class="refsect1 changelog" id="refsect1-function.asort-changelog">
...
<div class="annotation-interactive examplescode"><pre class="examplescode">c = apple
b = banana
d = lemon
a = orange</pre>
</div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.asort-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.arsort.php" class="function" rel="rdfs-seeAlso">arsort()</a> - Sort an array in descending order and maintain index association</span></li>
   <li>The <a href="array.sorting.php" class="link">comparison of array sorting functions</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/asort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.asort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.asort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.asort.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">31 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="105797">  <div class="votes">
    <div id="Vu105797">
    <a href="/manual/vote-note.php?id=105797&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105797">
    <a href="/manual/vote-note.php?id=105797&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105797" title="72% like this...">
    107
    </div>
  </div>
  <a href="#105797" class="name">
  <strong class="user"><em>nick ([AT]) nickyost ([DOT]) com</em></strong></a><a class="genanchor" href="#105797"> &para;</a><div class="date" title="2011-09-15 03:32"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105797">
<div class="phpcode"><code><span class="html">This function can be used to sort multidimensional arrays with almost no work whatsoever by using the individual values within the custom sort function.<br /><br />This function passes the entire child element even if it is not a string. If it is an array, as would be the case in multidimensional arrays, it will pass the whole child array as one parameter.<br /><br />Therefore, do something elegant like this:<br /><br /><span class="default">&lt;?php<br />     </span><span class="comment">// Sort the multidimensional array<br />     </span><span class="default">usort</span><span class="keyword">(</span><span class="default">$results</span><span class="keyword">, </span><span class="string">"custom_sort"</span><span class="keyword">);<br />     </span><span class="comment">// Define the custom sort function<br />     </span><span class="keyword">function </span><span class="default">custom_sort</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">,</span><span class="default">$b</span><span class="keyword">) {<br />          return </span><span class="default">$a</span><span class="keyword">[</span><span class="string">'some_sub_var'</span><span class="keyword">]&gt;</span><span class="default">$b</span><span class="keyword">[</span><span class="string">'some_sub_var'</span><span class="keyword">];<br />     }<br /></span><span class="default">?&gt;<br /></span><br />This does in 4 lines what other functions took 40 to 50 lines to do. This does not require you to create temporary arrays or anything. This is, for me, a highly preferred solution.<br /><br />Hope it helps!</span></code></div>
  </div>
 </div>
  <div class="note" id="117778">  <div class="votes">
    <div id="Vu117778">
    <a href="/manual/vote-note.php?id=117778&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117778">
    <a href="/manual/vote-note.php?id=117778&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117778" title="69% like this...">
    24
    </div>
  </div>
  <a href="#117778" class="name">
  <strong class="user"><em>aditycse at gmail dot com</em></strong></a><a class="genanchor" href="#117778"> &para;</a><div class="date" title="2015-08-07 12:41"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117778">
<div class="phpcode"><code><span class="html">/*<br /> * Name : Aditya Mehrotra <br /> * Email: aditycse@gmail.com<br /> */<br />//Example for sorting by values for an alphanumeric array also having case-sensitive data<br />$exampleArray1 = $exampleArray2 = array(<br />    0 =&gt; 'example1',<br />    1 =&gt; 'Example10',<br />    2 =&gt; 'example12',<br />    3 =&gt; 'Example2',<br />    4 =&gt; 'example3',<br />    5 =&gt; 'EXAMPLE10',<br />    6 =&gt; 'example10'<br />);<br /><br />//default sorting<br />asort($exampleArray1);<br /><br />// alphanumeric with case-sensitive data sorting by values<br />asort($exampleArray2, SORT_STRING | SORT_FLAG_CASE | SORT_NATURAL);<br /><br />//output of defaut sorting<br />print_r($exampleArray1);<br />/*<br /> * output of default sorting<br />  Array<br />  (<br />  [5] =&gt; EXAMPLE10<br />  [1] =&gt; Example10<br />  [3] =&gt; Example2<br />  [0] =&gt; example1<br />  [6] =&gt; example10<br />  [2] =&gt; example12<br />  [4] =&gt; example3<br />  )<br /> */<br /><br />print_r($exampleArray2);<br />/*<br /> * output of alphanumeric with case-sensitive data sorting by values<br /> Array<br />(<br />    [0] =&gt; example1<br />    [3] =&gt; Example2<br />    [4] =&gt; example3<br />    [5] =&gt; EXAMPLE10<br />    [1] =&gt; Example10<br />    [6] =&gt; example10<br />    [2] =&gt; example12<br />)<br /> */</span></code></div>
  ...
  <div class="note" id="71318">  <div class="votes">
    <div id="Vu71318">
    <a href="/manual/vote-note.php?id=71318&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd71318">
    <a href="/manual/vote-note.php?id=71318&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V71318" title="67% like this...">
    21
    </div>
  </div>
  <a href="#71318" class="name">
  <strong class="user"><em>richard at happymango dot me dot uk</em></strong></a><a class="genanchor" href="#71318"> &para;</a><div class="date" title="2006-11-22 03:35"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom71318">
<div class="phpcode"><code><span class="html">This is a function to sort an indexed 2D array by a specified sub array key, either ascending or descending.<br /><br />It is usefull for sorting query results from a database by a particular field after the query has been returned<br /><br />This function can be quite greedy. It recreates the array as a hash to use ksort() then back again<br /><br />By default it will sort ascending but if you specify $reverse as true it will return the records sorted descending <br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">record_sort</span><span class="keyword">(</span><span class="default">$records</span><span class="keyword">, </span><span class="default">$field</span><span class="keyword">, </span><span class="default">$reverse</span><span class="keyword">=</span><span class="default">false</span><span class="keyword">)<br />{<br />    </span><span class="default">$hash </span><span class="keyword">= array();<br />    <br />    foreach(</span><span class="default">$records </span><span class="keyword">as </span><span class="default">$record</span><span class="keyword">)<br />    {<br />        </span><span class="default">$hash</span><span class="keyword">[</span><span class="default">$record</span><span class="keyword">[</span><span class="default">$field</span><span class="keyword">]] = </span><span class="default">$record</span><span class="keyword">;<br />    }<br />    <br />    (</span><span class="default">$reverse</span><span class="keyword">)? </span><span class="default">krsort</span><span class="keyword">(</span><span class="default">$hash</span><span class="keyword">) : </span><span class="default">ksort</span><span class="keyword">(</span><span class="default">$hash</span><span class="keyword">);<br />    <br />    </span><span class="default">$records </span><span class="keyword">= array();<br />    <br />    foreach(</span><span class="default">$hash </span><span class="keyword">as </span><span class="default">$record</span><span class="keyword">)<br />    {<br />        </span><span class="default">$records </span><span class="keyword">[]= </span><span class="default">$record</span><span class="keyword">;<br />    }<br />    <br />    return </span><span class="default">$records</span><span class="keyword">;<br />}<br /><br /></span><span class="comment">// Example below<br /><br /></span><span class="default">$airports </span><span class="keyword">= array<br />(<br />    array( </span><span class="string">"code" </span><span class="keyword">=&gt; </span><span class="string">"LHR"</span><span class="keyword">, </span><span class="string">"name" </span><span class="keyword">=&gt; </span><span class="string">"Heathrow" </span><span class="keyword">),<br />    array( </span><span class="string">"code" </span><span class="keyword">=&gt; </span><span class="string">"LGW"</span><span class="keyword">, </span><span class="string">"name" </span><span class="keyword">=&gt; </span><span class="string">"Gatwick" </span><span class="keyword">),<br />);<br /><br /></span><span class="default">printf</span><span class="keyword">(</span><span class="string">"Before: &lt;pre&gt;%s&lt;/pre&gt;"</span><span class="keyword">, </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$airports</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">));<br /><br /></span><span class="default">$airports </span><span class="keyword">= </span><span class="default">record_sort</span><span class="keyword">(</span><span class="default">$airports</span><span class="keyword">, </span><span class="string">"name"</span><span class="keyword">);<br /><br /></span><span class="default">printf</span><span class="keyword">(</span><span class="string">"After: &lt;pre&gt;%s&lt;/pre&gt;"</span><span class="keyword">, </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$airports</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">));<br /><br /></span><span class="default">?&gt;<br /></span><br />Example Outputs:<br /><br />Before: Array<br />(<br />    [0] =&gt; Array ( [code] =&gt; LHR, [name] =&gt; Heathrow )<br />    [1] =&gt; Array ( [code] =&gt; LGW, [name] =&gt; Gatwick )<br />)<br /><br />After: Array<br />(<br />    [0] =&gt; Array ( [code] =&gt; LGW, [name] =&gt; Gatwick )<br />    [1] =&gt; Array ( [code] =&gt; LHR, [name] =&gt; Heathrow )<br />)</span></code></div>
  </div>
 </div>
  <div class="note" id="80798">  <div class="votes">
    <div id="Vu80798">
    <a href="/manual/vote-note.php?id=80798&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd80798">
    <a href="/manual/vote-note.php?id=80798&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V80798" title="65% like this...">
    14
    </div>
  </div>
  <a href="#80798" class="name">
  <strong class="user"><em>mike at clear-link dot com</em></strong></a><a class="genanchor" href="#80798"> &para;</a><div class="date" title="2008-01-31 03:23"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom80798">
<div class="phpcode"><code><span class="html">For a recent project I needed to sort an associative array by value first, and then by key if a particular value appeared multiple times. I wrote this function to accomplish the task. Note that the parameters default to sort ascending on both keys and values, but allow granular control over each.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">aksort</span><span class="keyword">(&amp;</span><span class="default">$array</span><span class="keyword">,</span><span class="default">$valrev</span><span class="keyword">=</span><span class="default">false</span><span class="keyword">,</span><span class="default">$keyrev</span><span class="keyword">=</span><span class="default">false</span><span class="keyword">) {<br />  if (</span><span class="default">$valrev</span><span class="keyword">) { </span><span class="default">arsort</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">); } else { </span><span class="default">asort</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">); }<br />    </span><span class="default">$vals </span><span class="keyword">= </span><span class="default">array_count_values</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">);<br />    </span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />    foreach (</span><span class="default">$vals </span><span class="keyword">AS </span><span class="default">$val</span><span class="keyword">=&gt;</span><span class="default">$num</span><span class="keyword">) {<br />        </span><span class="default">$first </span><span class="keyword">= </span><span class="default">array_splice</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">$i</span><span class="keyword">);<br />        </span><span class="default">$tmp </span><span class="keyword">= </span><span class="default">array_splice</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">$num</span><span class="keyword">);<br />        if (</span><span class="default">$keyrev</span><span class="keyword">) { </span><span class="default">krsort</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">); } else { </span><span class="default">ksort</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">); }<br />        </span><span class="default">$array </span><span class="keyword">= </span><span class="default">array_merge</span><span class="keyword">(</span><span class="default">$first</span><span class="keyword">,</span><span class="default">$tmp</span><span class="keyword">,</span><span class="default">$array</span><span class="keyword">);<br />        unset(</span><span class="default">$tmp</span><span class="keyword">);<br />        </span><span class="default">$i </span><span class="keyword">= </span><span class="default">$num</span><span class="keyword">;<br />    }<br />}<br /><br /></span><span class="comment">// Example<br /></span><span class="default">$tmp </span><span class="keyword">= array(</span><span class="string">'ca'</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">,</span><span class="string">'cb'</span><span class="keyword">=&gt;</span><span class="default">2</span><span class="keyword">,</span><span class="string">'ce'</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">,</span><span class="string">'pa'</span><span class="keyword">=&gt;</span><span class="default">2</span><span class="keyword">,</span><span class="string">'pe'</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">);<br /><br /></span><span class="comment">// Standard asort<br /></span><span class="default">asort</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">);<br /><br /></span><span class="comment">// Sort value ASC, key ASC<br /></span><span class="default">aksort</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">);<br /><br /></span><span class="comment">// Sort value DESC, key ASC<br /></span><span class="default">aksort</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">,</span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">);<br /><br /></span><span class="comment">// Sort value DESC, key DESC<br /></span><span class="default">aksort</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">,</span><span class="default">true</span><span class="keyword">,</span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">);<br /><br /></span><span class="comment">// Results<br /></span><span class="keyword">Array<br />(<br />    [</span><span class="default">pe</span><span class="keyword">] =&gt; </span><span class="default">1<br />    </span><span class="keyword">[</span><span class="default">ca</span><span class="keyword">] =&gt; </span><span class="default">1<br />    </span><span class="keyword">[</span><span class="default">ce</span><span class="keyword">] =&gt; </span><span class="default">1<br />    </span><span class="keyword">[</span><span class="default">cb</span><span class="keyword">] =&gt; </span><span class="default">2<br />    </span><span class="keyword">[</span><span class="default">pa</span><span class="keyword">] =&gt; </span><span class="default">2<br /></span><span class="keyword">)<br />Array<br />(<br />    [</span><span class="default">ca</span><span class="keyword">] =&gt; </span><span class="default">1<br />    </span><span class="keyword">[</span><span class="default">ce</span><span class="keyword">] =&gt; </span><span class="default">1<br />    </span><span class="keyword">[</span><span class="default">pe</span><span class="keyword">] =&gt; </span><span class="default">1<br />    </span><span class="keyword">[</span><span class="default">cb</span><span class="keyword">] =&gt; </span><span class="default">2<br />    </span><span class="keyword">[</span><span class="default">pa</span><span class="keyword">] =&gt; </span><span class="default">2<br /></span><span class="keyword">)<br />Array<br />(<br />    [</span><span class="default">cb</span><span class="keyword">] =&gt; </span><span class="default">2<br />    </span><span class="keyword">[</span><span class="default">pa</span><span class="keyword">] =&gt; </span><span class="default">2<br />    </span><span class="keyword">[</span><span class="default">ca</span><span class="keyword">] =&gt; </span><span class="default">1<br />    </span><span class="keyword">[</span><span class="default">ce</span><span class="keyword">] =&gt; </span><span class="default">1<br />    </span><span class="keyword">[</span><span class="default">pe</span><span class="keyword">] =&gt; </span><span class="default">1<br /></span><span class="keyword">)<br />Array<br />(<br />    [</span><span class="default">pa</span><span class="keyword">] =&gt; </span><span class="default">2<br />    </span><span class="keyword">[</span><span class="default">cb</span><span class="keyword">] =&gt; </span><span class="default">2<br />    </span><span class="keyword">[</span><span class="default">pe</span><span class="keyword">] =&gt; </span><span class="default">1<br />    </span><span class="keyword">[</span><span class="default">ce</span><span class="keyword">] =&gt; </span><span class="default">1<br />    </span><span class="keyword">[</span><span class="default">ca</span><span class="keyword">] =&gt; </span><span class="default">1<br /></span><span class="keyword">)</span></span></code></div>
  </div>
 </div>
  <div class="note" id="7787">  <div class="votes">
    <div id="Vu7787">
    <a href="/manual/vote-note.php?id=7787&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd7787">
    <a href="/manual/vote-note.php?id=7787&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V7787" title="68% like this...">
    6
    </div>
  </div>
  <a href="#7787" class="name">
  <strong class="user"><em>sweetland at whoadammit dot com</em></strong></a><a class="genanchor" href="#7787"> &para;</a><div class="date" title="2000-08-15 12:02"><strong>25 years ago</strong></div>
  <div class="text" id="Hcom7787">
<div class="phpcode"><code><span class="html">Here's a little routine I whipped up to sort multi-dimensional arrays:
...
<br /></span>
<br />It's a bit long with all the comments, but I hope it helps.</span></code></div>
  </div>
 </div>
  <div class="note" id="80802">  <div class="votes">
    <div id="Vu80802">
    <a href="/manual/vote-note.php?id=80802&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd80802">
    <a href="/manual/vote-note.php?id=80802&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V80802" title="66% like this...">
    8
    </div>
  </div>
  <a href="#80802" class="name">
  <strong class="user"><em>mike at clear-link dot com</em></strong></a><a class="genanchor" href="#80802"> &para;</a><div class="date" title="2008-01-31 03:56"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom80802">
<div class="phpcode"><code><span class="html">Small typo in the aksort function I just submitted. Here's the entire thing again, with the correction noted:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">aksort</span><span class="keyword">(&amp;</span><span class="default">$array</span><span class="keyword">,</span><span class="default">$valrev</span><span class="keyword">=</span><span class="default">false</span><span class="keyword">,</span><span class="default">$keyrev</span><span class="keyword">=</span><span class="default">false</span><span class="keyword">) {<br />  if (</span><span class="default">$valrev</span><span class="keyword">) { </span><span class="default">arsort</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">); } else { </span><span class="default">asort</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">); }<br />  </span><span class="default">$vals </span><span class="keyword">= </span><span class="default">array_count_values</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">);<br />    </span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />    foreach (</span><span class="default">$vals </span><span class="keyword">AS </span><span class="default">$val</span><span class="keyword">=&gt;</span><span class="default">$num</span><span class="keyword">) {<br />        </span><span class="default">$first </span><span class="keyword">= </span><span class="default">array_splice</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">$i</span><span class="keyword">);<br />        </span><span class="default">$tmp </span><span class="keyword">= </span><span class="default">array_splice</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">$num</span><span class="keyword">);<br />        if (</span><span class="default">$keyrev</span><span class="keyword">) { </span><span class="default">krsort</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">); } else { </span><span class="default">ksort</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">); }<br />        </span><span class="default">$array </span><span class="keyword">= </span><span class="default">array_merge</span><span class="keyword">(</span><span class="default">$first</span><span class="keyword">,</span><span class="default">$tmp</span><span class="keyword">,</span><span class="default">$array</span><span class="keyword">);<br />        unset(</span><span class="default">$tmp</span><span class="keyword">);<br />        </span><span class="default">$i </span><span class="keyword">= </span><span class="default">$i</span><span class="keyword">+</span><span class="default">$num</span><span class="keyword">;<br />        </span><span class="comment">// Fixed from previous post: $i = $num;<br />    </span><span class="keyword">}<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="69425">  <div class="votes">
    <div id="Vu69425">
    <a href="/manual/vote-note.php?id=69425&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd69425">
    <a href="/manual/vote-note.php?id=69425&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V69425" title="66% like this...">
    4
    </div>
  </div>
  <a href="#69425" class="name">
  <strong class="user"><em>php at web-in-time dot com</em></strong></a><a class="genanchor" href="#69425"> &para;</a><div class="date" title="2006-09-05 02:47"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom69425">
<div class="phpcode"><code><span class="html">acecream's function works fine, especially with the spectre extension.<br /><br />nevertheless sometimes the index values have to be kept. To achieve this, just replace:<br /><br />$sorted_arr[] = $array[$arr_key];  <br /><br />with:<br /><br />$sorted_arr[$arr_key] = $array[$arr_key];</span></code></div>
  </div>
 </div>
  <div class="note" id="3984">  <div class="votes">
    <div id="Vu3984">
    <a href="/manual/vote-note.php?id=3984&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd3984">
    <a href="/manual/vote-note.php?id=3984&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V3984" title="66% like this...">
    2
    </div>
  </div>
  <a href="#3984" class="name">
  <strong class="user"><em>jacko at kring dot co dot uk</em></strong></a><a class="genanchor" href="#3984"> &para;</a><div class="date" title="2000-02-24 11:26"><strong>25 years ago</strong></div>
  <div class="text" id="Hcom3984">
<div class="phpcode"><code><span class="html">asort has one anoying feature, it ignores any default or implicit order in the data.  i.e. if two elements of an array contain "banana" then it is not garanteed that the first will still be the first after the sort.
<br />This makes the Burrows-Wheeler block sort a bit of a pain to impliment, with a trailing string having to be appended to all strings before sorting, and removed after sorting. To maintain the so called "banana" order.</span></code></div>
  </div>
 </div>
  <div class="note" id="71344">  <div class="votes">
    <div id="Vu71344">
    <a href="/manual/vote-note.php?id=71344&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd71344">
    <a href="/manual/vote-note.php?id=71344&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V71344" title="62% like this...">
    6
    </div>
  </div>
  <a href="#71344" class="name">
  <strong class="user"><em>richard at happymango dot me dot uk</em></strong></a><a class="genanchor" href="#71344"> &para;</a><div class="date" title="2006-11-23 03:52"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom71344">
<div class="phpcode"><code><span class="html">This is a fixed version of the same function I posted below. Now it will handle duplicate entries in the sorted field. EG: If there were two records that had the name Heathrow it would still work. <br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">record_sort</span><span class="keyword">(</span><span class="default">$records</span><span class="keyword">, </span><span class="default">$field</span><span class="keyword">, </span><span class="default">$reverse</span><span class="keyword">=</span><span class="default">false</span><span class="keyword">)<br />{<br />    </span><span class="default">$hash </span><span class="keyword">= array();<br />    <br />    foreach(</span><span class="default">$records </span><span class="keyword">as </span><span class="default">$key </span><span class="keyword">=&gt; </span><span class="default">$record</span><span class="keyword">)<br />    {<br />        </span><span class="default">$hash</span><span class="keyword">[</span><span class="default">$record</span><span class="keyword">[</span><span class="default">$field</span><span class="keyword">].</span><span class="default">$key</span><span class="keyword">] = </span><span class="default">$record</span><span class="keyword">;<br />    }<br />    <br />    (</span><span class="default">$reverse</span><span class="keyword">)? </span><span class="default">krsort</span><span class="keyword">(</span><span class="default">$hash</span><span class="keyword">) : </span><span class="default">ksort</span><span class="keyword">(</span><span class="default">$hash</span><span class="keyword">);<br />    <br />    </span><span class="default">$records </span><span class="keyword">= array();<br />    <br />    foreach(</span><span class="default">$hash </span><span class="keyword">as </span><span class="default">$record</span><span class="keyword">)<br />    {<br />        </span><span class="default">$records </span><span class="keyword">[]= </span><span class="default">$record</span><span class="keyword">;<br />    }<br />    <br />    return </span><span class="default">$records</span><span class="keyword">;<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="12757">  <div class="votes">
    <div id="Vu12757">
    <a href="/manual/vote-note.php?id=12757&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd12757">
    <a href="/manual/vote-note.php?id=12757&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V12757" title="63% like this...">
    3
    </div>
  </div>
  <a href="#12757" class="name">
  <strong class="user"><em>freeman at generalresources dot com</em></strong></a><a class="genanchor" href="#12757"> &para;</a><div class="date" title="2001-05-04 04:51"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom12757">
<div class="phpcode"><code><span class="html">The asortbyindex($sortarray, $index) looks like sort not asort. The key of the $sortarray was changed.</span></code></div>
  </div>
 </div>
  <div class="note" id="43513">  <div class="votes">
    <div id="Vu43513">
    <a href="/manual/vote-note.php?id=43513&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd43513">
    <a href="/manual/vote-note.php?id=43513&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V43513" title="61% like this...">
    5
    </div>
  </div>
  <a href="#43513" class="name">
  <strong class="user"><em>rojaro</em></strong></a><a class="genanchor" href="#43513"> &para;</a><div class="date" title="2004-06-23 07:38"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom43513">
<div class="phpcode"><code><span class="html">Advanced sort array by second index function, which produces ascending (default) or descending output and uses optionally natural case insensitive sorting (which can be optionally case sensitive as well).<br />Only the first two arguments are required.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">sabsi </span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">, </span><span class="default">$index</span><span class="keyword">, </span><span class="default">$order</span><span class="keyword">=</span><span class="string">'asc'</span><span class="keyword">, </span><span class="default">$natsort</span><span class="keyword">=</span><span class="default">FALSE</span><span class="keyword">, </span><span class="default">$case_sensitive</span><span class="keyword">=</span><span class="default">FALSE</span><span class="keyword">) {<br />  if(</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) &amp;&amp; </span><span class="default">count</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">)&gt;</span><span class="default">0</span><span class="keyword">) {<br />    foreach(</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">) as </span><span class="default">$key</span><span class="keyword">) </span><span class="default">$temp</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">]=</span><span class="default">$array</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">][</span><span class="default">$index</span><span class="keyword">];<br />    if(!</span><span class="default">$natsort</span><span class="keyword">) (</span><span class="default">$order</span><span class="keyword">==</span><span class="string">'asc'</span><span class="keyword">)? </span><span class="default">asort</span><span class="keyword">(</span><span class="default">$temp</span><span class="keyword">) : </span><span class="default">arsort</span><span class="keyword">(</span><span class="default">$temp</span><span class="keyword">);<br />    else {<br />      (</span><span class="default">$case_sensitive</span><span class="keyword">)? </span><span class="default">natsort</span><span class="keyword">(</span><span class="default">$temp</span><span class="keyword">) : </span><span class="default">natcasesort</span><span class="keyword">(</span><span class="default">$temp</span><span class="keyword">);<br />      if(</span><span class="default">$order</span><span class="keyword">!=</span><span class="string">'asc'</span><span class="keyword">) </span><span class="default">$temp</span><span class="keyword">=</span><span class="default">array_reverse</span><span class="keyword">(</span><span class="default">$temp</span><span class="keyword">,</span><span class="default">TRUE</span><span class="keyword">);<br />    }<br />    foreach(</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$temp</span><span class="keyword">) as </span><span class="default">$key</span><span class="keyword">) (</span><span class="default">is_numeric</span><span class="keyword">(</span><span class="default">$key</span><span class="keyword">))? </span><span class="default">$sorted</span><span class="keyword">[]=</span><span class="default">$array</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] : </span><span class="default">$sorted</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">]=</span><span class="default">$array</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">];<br />    return </span><span class="default">$sorted</span><span class="keyword">;<br />  }<br />  return </span><span class="default">$array</span><span class="keyword">;<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="103858">  <div class="votes">
    <div id="Vu103858">
    <a href="/manual/vote-note.php?id=103858&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103858">
    <a href="/manual/vote-note.php?id=103858&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103858" title="61% like this...">
    4
    </div>
  </div>
  <a href="#103858" class="name">
  <strong class="user"><em>Anon</em></strong></a><a class="genanchor" href="#103858"> &para;</a><div class="date" title="2011-05-06 05:37"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103858">
<div class="phpcode"><code><span class="html">Case insensitive sort in one line:<br /><br /><span class="default">&lt;?php<br /><br />array_multisort</span><span class="keyword">(</span><span class="default">array_map</span><span class="keyword">(</span><span class="string">'strtolower'</span><span class="keyword">, </span><span class="default">$array</span><span class="keyword">), </span><span class="default">$array</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="19545">  <div class="votes">
    <div id="Vu19545">
    <a href="/manual/vote-note.php?id=19545&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd19545">
    <a href="/manual/vote-note.php?id=19545&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V19545" title="62% like this...">
    4
    </div>
  </div>
  <a href="#19545" class="name">
  <strong class="user"><em>rcwang at cmu dot edu</em></strong></a><a class="genanchor" href="#19545"> &para;</a><div class="date" title="2002-03-02 05:42"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom19545">
<div class="phpcode"><code><span class="html">Here's my version of sorting multi-dimensional array by 2nd index.
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="20433">  <div class="votes">
    <div id="Vu20433">
    <a href="/manual/vote-note.php?id=20433&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd20433">
    <a href="/manual/vote-note.php?id=20433&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V20433" title="61% like this...">
    3
    </div>
  </div>
  <a href="#20433" class="name">
  <strong class="user"><em>salchicha at cable dot net dot co</em></strong></a><a class="genanchor" href="#20433"> &para;</a><div class="date" title="2002-04-03 01:23"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom20433">
<div class="phpcode"><code><span class="html">Here's one I whipped up to allow you to sort an array of a specific class by a member or function:
<br />
<br /><span class="default">&lt;?php
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />It works very well. For example, I have a Room class with members title, isActive(), date, etc. I can sort an array by casort($rooms, "title") or casort($rooms, "isActive()") and it'll work.</span></code></div>
  </div>
 </div>
  <div class="note" id="125314">  <div class="votes">
    <div id="Vu125314">
    <a href="/manual/vote-note.php?id=125314&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125314">
    <a href="/manual/vote-note.php?id=125314&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125314" title="100% like this...">
    2
    </div>
  </div>
  <a href="#125314" class="name">
  <strong class="user"><em>Jesse K</em></strong></a><a class="genanchor" href="#125314"> &para;</a><div class="date" title="2020-08-31 07:49"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125314">
<div class="phpcode"><code><span class="html">'asort' is fine for sorting arrays in English, but if accented characters exist in the array then it is better to use the 'asort' method of PHP's Collator class:<br /><a href="https://www.php.net/manual/en/class.collator.php" rel="nofollow" target="_blank">https://www.php.net/manual/en/class.collator.php</a><br /><br />$collator = new \Collator('fr_CA');<br />$collator-&gt;asort($french_list);<br /><br />There are options for using `setlocale()` to control `asort` behaviour, but it isn't reliable across systems.<br />For instance, in my development environment I only have access to the following locals:<br /><br />$ locale -a<br />C<br />C.UTF-8<br />POSIX</span></code></div>
  </div>
 </div>
  <div class="note" id="23920">  <div class="votes">
    <div id="Vu23920">
    <a href="/manual/vote-note.php?id=23920&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd23920">
    <a href="/manual/vote-note.php?id=23920&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V23920" title="52% like this...">
    1
    </div>
  </div>
  <a href="#23920" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#23920"> &para;</a><div class="date" title="2002-07-31 06:48"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom23920">
<div class="phpcode"><code><span class="html">Similar to above but for an array of arrays instead of an array of objects.
<br />
<br /><span class="default">&lt;?php
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="125418">  <div class="votes">
    <div id="Vu125418">
    <a href="/manual/vote-note.php?id=125418&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125418">
    <a href="/manual/vote-note.php?id=125418&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125418" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#125418" class="name">
  <strong class="user"><em>marty8zhang at gmail dot com</em></strong></a><a class="genanchor" href="#125418"> &para;</a><div class="date" title="2020-10-06 04:26"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125418">
<div class="phpcode"><code><span class="html">"This function sorts an array such that array indices maintain their correlation with the array elements they are associated with."<br /><br />Note this sentence in the description has a quite important implication especially when you're working with an originally non-indexed (or say integer-indexed) array and JSON encoding/decoding.<br />I'm not reporting this as a bug, because the end result does fit into the description.<br /><br /><span class="default">&lt;?php<br /><br />$myArray </span><span class="keyword">= [</span><span class="string">'small_image'</span><span class="keyword">, </span><span class="string">'image'</span><span class="keyword">];<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">json_encode</span><span class="keyword">(</span><span class="default">$myArray</span><span class="keyword">)); </span><span class="comment">// string(23) "["small_image","image"]"<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">is_object</span><span class="keyword">(</span><span class="default">$myArray</span><span class="keyword">)); </span><span class="comment">// bool(false)<br /><br /></span><span class="default">asort</span><span class="keyword">(</span><span class="default">$myArray</span><span class="keyword">);<br /></span><span class="default">$myJson </span><span class="keyword">= </span><span class="default">json_encode</span><span class="keyword">(</span><span class="default">$myArray</span><span class="keyword">);<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$myJson</span><span class="keyword">); </span><span class="comment">// string(31) "{"1":"image","0":"small_image"}"<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">is_object</span><span class="keyword">(</span><span class="default">$myArray</span><span class="keyword">)); </span><span class="comment">// bool(false)<br /><br />/*<br /> * class stdClass#1 (2) {<br /> *     public $1 =&gt;<br /> *     string(5) "image"<br /> *     public $0 =&gt;<br /> *     string(11) "small_image"<br /> * }<br /> */<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">json_decode</span><span class="keyword">(</span><span class="default">$myJson</span><span class="keyword">));<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="111537">  <div class="votes">
    <div id="Vu111537">
    <a href="/manual/vote-note.php?id=111537&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111537">
    <a href="/manual/vote-note.php?id=111537&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111537" title="50% like this...">
    0
    </div>
  </div>
  <a href="#111537" class="name">
  <strong class="user"><em>stephen [ at ] brooksie-net [ dot ] co [ dot ] uk</em></strong></a><a class="genanchor" href="#111537"> &para;</a><div class="date" title="2013-03-01 04:37"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111537">
<div class="phpcode"><code><span class="html">It is obviously necessary to log the keys used as so we don't overwrite previous entries in the array ;o)
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="78925">  <div class="votes">
    <div id="Vu78925">
    <a href="/manual/vote-note.php?id=78925&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd78925">
    <a href="/manual/vote-note.php?id=78925&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V78925" title="50% like this...">
    0
    </div>
  </div>
  <a href="#78925" class="name">
  <strong class="user"><em>przemekkus [at] interia [dot] pl</em></strong></a><a class="genanchor" href="#78925"> &para;</a><div class="date" title="2007-11-02 06:34"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom78925">
<div class="phpcode"><code><span class="html">Function written by a dot brandon at chello dot nl has an error  - wrong variable name. It should be:<br /><br />if($rev) arsort($named_hash,$flags=0) ;<br /><br />instead of<br /><br />if($reverse) arsort($named_hash,$flags=0) ;</span></code></div>
  </div>
 </div>
  <div class="note" id="75749">  <div class="votes">
    <div id="Vu75749">
    <a href="/manual/vote-note.php?id=75749&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd75749">
    <a href="/manual/vote-note.php?id=75749&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V75749" title="50% like this...">
    0
    </div>
  </div>
  <a href="#75749" class="name">
  <strong class="user"><em>gunnar at taljaren dot se</em></strong></a><a class="genanchor" href="#75749"> &para;</a><div class="date" title="2007-06-14 01:00"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom75749">
<div class="phpcode"><code><span class="html">for ($i=0;$i&lt;5;$i++)<br />   $values[] = $i;<br />asort($values);  <br /><br />works, but<br />for ($i=0;$i&lt;5;$i++)<br />   $values[$i] =$i;<br />asort($values);<br />doesn't!</span></code></div>
  </div>
 </div>
  <div class="note" id="72582">  <div class="votes">
    <div id="Vu72582">
    <a href="/manual/vote-note.php?id=72582&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd72582">
    <a href="/manual/vote-note.php?id=72582&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V72582" title="50% like this...">
    0
    </div>
  </div>
  <a href="#72582" class="name">
  <strong class="user"><em>smileaf at smileaf dot org</em></strong></a><a class="genanchor" href="#72582"> &para;</a><div class="date" title="2007-01-24 06:34"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom72582">
<div class="phpcode"><code><span class="html">Ok I was mistaken, after re-reading the previous post the ".$key" is important. What caused the sorting issue for me wasn't that at all. But rather something else.<br />doing an: asort($records, $flags); before returning fixes the sorting problems.<br />The sorting problem I was refearing to causes a character based sorting done on numeric data.<br />so instead of:<br />1<br />2<br />3<br />...<br />10<br />12<br />20<br />It was returned back as<br />1<br />10<br />12<br />2<br />20<br />3<br />...<br />basically what I was trying to fix in the first place.</span></code></div>
  </div>
 </div>
  <div class="note" id="27372">  <div class="votes">
    <div id="Vu27372">
    <a href="/manual/vote-note.php?id=27372&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd27372">
    <a href="/manual/vote-note.php?id=27372&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V27372" title="50% like this...">
    0
    </div>
  </div>
  <a href="#27372" class="name">
  <strong class="user"><em>mbevan at marginsoftware dot com</em></strong></a><a class="genanchor" href="#27372"> &para;</a><div class="date" title="2002-12-03 01:25"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom27372">
<div class="phpcode"><code><span class="html">Nevermind... use my last note as a quick tip: if you wish to keep the keys, use asort() and arsort() in place of sort() and rsort().</span></code></div>
  </div>
 </div>
  <div class="note" id="90425">  <div class="votes">
    <div id="Vu90425">
    <a href="/manual/vote-note.php?id=90425&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd90425">
    <a href="/manual/vote-note.php?id=90425&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V90425" title="47% like this...">
    -1
    </div>
  </div>
  <a href="#90425" class="name">
  <strong class="user"><em>Eran</em></strong></a><a class="genanchor" href="#90425"> &para;</a><div class="date" title="2009-04-21 05:15"><strong>16 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">i made this sample multi dimensional array sort to someone who needed to read lines from a text file instead of using sql - order by statement.<br /><br />the idea is to take the key and sort(order) the specific column and then order the entire of the array as the selected column asort returned.<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">/**<br /> * <br /> * This sample is reading text data<br /> * and perform a sort to a 2 dimensional array<br /> * just like a normal sql do to "order by asc" <br /> * <br /> */<br /><br /></span><span class="default">$foo </span><span class="keyword">= array();<br /><br /></span><span class="comment">/*<br /># SORT_REGULAR - compare items normally (don't change types)<br /># SORT_NUMERIC - compare items numerically<br /># SORT_STRING - compare items as strings<br />*/<br /></span><span class="default">$sort_by </span><span class="keyword">= </span><span class="default">SORT_REGULAR</span><span class="keyword">;<br /><br /></span><span class="comment">/*<br /># 0 - order by name column<br /># 1 - order by age column<br /># 2 - order by rank column<br /># 3 - order by color column<br />*/<br /></span><span class="default">$order_by </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;<br /><br /></span><span class="comment">// source file<br /></span><span class="default">$line_of_text</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">] = </span><span class="string">'a1name|f2age|h3rank|jcolor'</span><span class="keyword">;<br /></span><span class="default">$line_of_text</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">] = </span><span class="string">'b1name|d2age|i3rank|k4color'</span><span class="keyword">;<br /></span><span class="default">$line_of_text</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">] = </span><span class="string">'c1name|e2age|g3rank|l4color'</span><span class="keyword">;<br /><br /></span><span class="comment">// make array<br /></span><span class="keyword">for (</span><span class="default">$x</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">; </span><span class="default">$x</span><span class="keyword">&lt;=</span><span class="default">2</span><span class="keyword">; </span><span class="default">$x</span><span class="keyword">++)<br />{<br />    </span><span class="default">$line </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">(</span><span class="string">'|'</span><span class="keyword">,</span><span class="default">$line_of_text</span><span class="keyword">[</span><span class="default">$x</span><span class="keyword">]);<br /><br />    </span><span class="comment">// save it by coulmns otherwise it will saved like rows<br />    </span><span class="keyword">for (</span><span class="default">$i</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">&lt;=</span><span class="default">3</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++) {<br />          </span><span class="default">$foo</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">][</span><span class="default">$x</span><span class="keyword">] = </span><span class="default">$line</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">];<br />    }<br />}<br /><br /></span><span class="comment">// get the key order<br /></span><span class="default">$a </span><span class="keyword">= </span><span class="default">$foo</span><span class="keyword">[</span><span class="default">$order_by</span><span class="keyword">];<br /><br /></span><span class="comment">// sort<br /></span><span class="default">asort</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">, </span><span class="default">$sort_by</span><span class="keyword">);<br /><br /></span><span class="comment">// start print<br /></span><span class="keyword">echo </span><span class="string">"&lt;table cellpudding=0 cellspacing=0 border=1&gt;\n"</span><span class="keyword">;<br />        echo </span><span class="string">"&lt;tr&gt;\n"</span><span class="keyword">;<br />          echo </span><span class="string">"&lt;td&gt;key&lt;/td&gt;\n"</span><span class="keyword">;<br />          echo </span><span class="string">"&lt;td&gt;name&lt;/td&gt;\n"</span><span class="keyword">;<br />          echo </span><span class="string">"&lt;td&gt;age&lt;/td&gt;\n"</span><span class="keyword">;<br />          echo </span><span class="string">"&lt;td&gt;rank&lt;/td&gt;\n"</span><span class="keyword">;<br />          echo </span><span class="string">"&lt;td&gt;color&lt;/td&gt;\n"</span><span class="keyword">;<br />        echo </span><span class="string">"&lt;/tr&gt;\n"</span><span class="keyword">;<br /><br /></span><span class="comment">// print by key order<br /></span><span class="keyword">foreach (</span><span class="default">$a </span><span class="keyword">as </span><span class="default">$k </span><span class="keyword">=&gt; </span><span class="default">$v</span><span class="keyword">) {<br />    echo </span><span class="string">"&lt;tr&gt;\n"</span><span class="keyword">;<br />      echo </span><span class="string">"&lt;td&gt;</span><span class="default">$k</span><span class="string">&lt;/td&gt;\n"</span><span class="keyword">;<br />      </span><span class="comment">// you can print here a for loop (0 to num of columns[=3])<br />      </span><span class="keyword">echo </span><span class="string">"&lt;td&gt;"</span><span class="keyword">.</span><span class="default">$foo</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">][</span><span class="default">$k</span><span class="keyword">].</span><span class="string">"&lt;/td&gt;\n"</span><span class="keyword">;<br />      echo </span><span class="string">"&lt;td&gt;"</span><span class="keyword">.</span><span class="default">$foo</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">][</span><span class="default">$k</span><span class="keyword">].</span><span class="string">"&lt;/td&gt;\n"</span><span class="keyword">;<br />      echo </span><span class="string">"&lt;td&gt;"</span><span class="keyword">.</span><span class="default">$foo</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">][</span><span class="default">$k</span><span class="keyword">].</span><span class="string">"&lt;/td&gt;\n"</span><span class="keyword">;<br />      echo </span><span class="string">"&lt;td&gt;"</span><span class="keyword">.</span><span class="default">$foo</span><span class="keyword">[</span><span class="default">3</span><span class="keyword">][</span><span class="default">$k</span><span class="keyword">].</span><span class="string">"&lt;/td&gt;\n"</span><span class="keyword">;<br />    echo </span><span class="string">"&lt;/tr&gt;\n"</span><span class="keyword">;<br />}<br />echo </span><span class="string">"&lt;/table&gt;\n"</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="31628">  <div class="votes">
    <div id="Vu31628">
    <a href="/manual/vote-note.php?id=31628&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd31628">
    <a href="/manual/vote-note.php?id=31628&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V31628" title="45% like this...">
    -1
    </div>
  </div>
  <a href="#31628" class="name">
  <strong class="user"><em>spectre at hellfish dot NOSPAM dot org</em></strong></a><a class="genanchor" href="#31628"> &para;</a><div class="date" title="2003-04-28 09:54"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom31628">
<div class="phpcode"><code><span class="html">that works nicely, tho it breaks the result-array up if one or more of arrays indexes are deleted before sorting. this one should fix it up:<br /><br />change:<br />for ($i = 0; $i &lt; sizeof($array); $i++) {<br /><br />to:<br />foreach ($array as $i =&gt; $k) {</span></code></div>
  </div>
 </div>
  <div class="note" id="75991">  <div class="votes">
    <div id="Vu75991">
    <a href="/manual/vote-note.php?id=75991&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd75991">
    <a href="/manual/vote-note.php?id=75991&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V75991" title="44% like this...">
    -1
    </div>
  </div>
  <a href="#75991" class="name">
  <strong class="user"><em>a dot brandon at chello dot nl</em></strong></a><a class="genanchor" href="#75991"> &para;</a><div class="date" title="2007-06-25 07:18"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom75991">
<div class="phpcode"><code><span class="html">I use this for quasi-SQL orderby. Loosely based on smileaf. Any good for you nerds?<br /><br />&lt;?<br /><br />function named_records_sort($named_recs, $order_by, $rev=false, $flags=0)<br />{// Create 1-dimensional named array with just <br /> // sortfield (in stead of record) values<br />    $named_hash = array(); <br />     foreach($named_recs as $key=&gt;$fields) <br />             $named_hash["$key"] = $fields[$order_by];<br /> <br /> // Order 1-dimensional array, <br /> // maintaining key-value relations   <br />    if($reverse) arsort($named_hash,$flags=0) ;<br />    else asort($named_hash, $flags=0);<br />  <br /> // Create copy of named records array <br /> // in order of sortarray  <br />    $sorted_records = array(); <br />    foreach($named_hash as $key=&gt;$val) <br />           $sorted_records["$key"]= $named_recs[$key];<br />  <br />return $sorted_records;} // named_recs_sort()<br /><br />function show_sorted_records($named_recs, $order_by, $rev=false, $flags=0)<br />{$sorted_records=named_records_sort($named_recs, $order_by, $rev, $flags);<br />foreach($sorted_records as $name=&gt;$fields) <br />  {echo "&lt;b&gt;$name&lt;/b&gt;   "; <br />   foreach($fields as $field=&gt;$val) <br />          echo "$field = $val "; echo "&lt;br&gt;";}<br />} // show_sorted_records()<br /><br />$girl_friends=array();<br />$girl_friends["Anna"]=<br />array("born"=&gt;'1989-08-22',"cupsize"=&gt;'B-',"IQ"=&gt;105, "daddy"=&gt;'rich');<br />$girl_friends["Zoe"]<br />=array("born"=&gt;'1978-03-11',"cupsize"=&gt;'C#',"IQ"=&gt;130, "daddy"=&gt;'poor');<br />$girl_friends["Lilly"]<br />=array("born"=&gt;'1985-06-16',"cupsize"=&gt;'DD',"IQ"=&gt;90, "daddy"=&gt;'nasty');<br /><br />$order_by="cupsize"; echo "And the winners are: &lt;br&gt;";<br />show_sorted_records($girl_friends, $order_by, true);<br /><br />?&gt;</span></code></div>
  </div>
 </div>
  <div class="note" id="7386">  <div class="votes">
    <div id="Vu7386">
    <a href="/manual/vote-note.php?id=7386&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd7386">
    <a href="/manual/vote-note.php?id=7386&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V7386" title="41% like this...">
    -2
    </div>
  </div>
  <a href="#7386" class="name">
  <strong class="user"><em>bwuhlman at tallships dot ca</em></strong></a><a class="genanchor" href="#7386"> &para;</a><div class="date" title="2000-08-02 03:01"><strong>25 years ago</strong></div>
  <div class="text" id="Hcom7386">
<div class="phpcode"><code><span class="html">Well, actually, asort has *two* annoying features.
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="123145">  <div class="votes">
    <div id="Vu123145">
    <a href="/manual/vote-note.php?id=123145&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123145">
    <a href="/manual/vote-note.php?id=123145&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123145" title="28% like this...">
    -3
    </div>
  </div>
  <a href="#123145" class="name">
  <strong class="user"><em>elhanafi123 at gmail dot com</em></strong></a><a class="genanchor" href="#123145"> &para;</a><div class="date" title="2018-09-20 09:47"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom123145">
<div class="phpcode"><code><span class="html">I have written this function so its sort an multidimensional array with a specific key.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">sort_array</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">, </span><span class="default">$sort_value</span><span class="keyword">, </span><span class="default">$reverse </span><span class="keyword">= </span><span class="default">false</span><span class="keyword">){<br />    </span><span class="default">$value </span><span class="keyword">= </span><span class="default">$result </span><span class="keyword">= array();<br />    <br />    foreach(</span><span class="default">$array </span><span class="keyword">as </span><span class="default">$key </span><span class="keyword">=&gt; </span><span class="default">$rows</span><span class="keyword">){<br />        </span><span class="default">$value</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] = </span><span class="default">strtolower</span><span class="keyword">(</span><span class="default">$rows</span><span class="keyword">[</span><span class="default">$sort_value</span><span class="keyword">]);<br />    }<br />    <br />    if(</span><span class="default">$reverse </span><span class="keyword">== </span><span class="default">true</span><span class="keyword">){<br />        </span><span class="default">arsort</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">);<br />    }else{<br />        </span><span class="default">asort</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">);<br />    }<br />    <br />    foreach(</span><span class="default">$value </span><span class="keyword">as </span><span class="default">$keys </span><span class="keyword">=&gt; </span><span class="default">$null</span><span class="keyword">){<br />        </span><span class="default">$result</span><span class="keyword">[] = </span><span class="default">$array</span><span class="keyword">[</span><span class="default">$keys</span><span class="keyword">];<br />    }<br />    <br />    return </span><span class="default">$result</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />Examples<br /><br /><span class="default">&lt;?php<br /><br />$array </span><span class="keyword">= array(array(</span><span class="string">'a' </span><span class="keyword">=&gt; </span><span class="string">'foo'</span><span class="keyword">), array(</span><span class="string">'a' </span><span class="keyword">=&gt; </span><span class="string">'foo4'</span><span class="keyword">), array(</span><span class="string">'a' </span><span class="keyword">=&gt; </span><span class="string">'foo2'</span><span class="keyword">), array(</span><span class="string">'a' </span><span class="keyword">=&gt; </span><span class="string">'foo3'</span><span class="keyword">));<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">);<br /></span><span class="comment">//Array ( [0] =&gt; Array ( [a] =&gt; foo ) [1] =&gt; Array ( [a] =&gt; foo4 ) [2] =&gt; Array ( [a] =&gt; foo2 ) [3] =&gt; Array ( [a] =&gt; foo3 ) )<br /><br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">sort_array</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">, </span><span class="string">'a'</span><span class="keyword">));<br /></span><span class="comment">//Array ( [0] =&gt; Array ( [a] =&gt; foo ) [1] =&gt; Array ( [a] =&gt; foo2 ) [2] =&gt; Array ( [a] =&gt; foo3 ) [3] =&gt; Array ( [a] =&gt; foo4 ) )<br /><br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">sort_array</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">, </span><span class="string">'a'</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">));<br /></span><span class="comment">//Array ( [0] =&gt; Array ( [a] =&gt; foo4 ) [1] =&gt; Array ( [a] =&gt; foo3 ) [2] =&gt; Array ( [a] =&gt; foo2 ) [3] =&gt; Array ( [a] =&gt; foo ) ) <br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="81155">  <div class="votes">
    <div id="Vu81155">
    <a href="/manual/vote-note.php?id=81155&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd81155">
    <a href="/manual/vote-note.php?id=81155&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V81155" title="25% like this...">
    -4
    </div>
  </div>
  <a href="#81155" class="name">
  <strong class="user"><em>bakatamas at freemail dot hu</em></strong></a><a class="genanchor" href="#81155"> &para;</a><div class="date" title="2008-02-15 02:34"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom81155">
<div class="phpcode"><code><span class="html">Dear mike at clear-link dot com!<br /><br />I needed a case insensitive version of your function. It is still not perfect as I have to do something with country specific characters (öüóőúéáűíÖÜÓŐÚÉÁŰÍ)<br /><br />function akisort(&amp;$array,$valrev=false,$keyrev=false)<br />    {<br />    if ($valrev)<br />        {<br />        arsort($array);<br />        }<br />        else<br />        {<br />        asort($array);<br />        };<br />    $vals = array_count_values($array);<br />    $i = 0;<br />    foreach ($vals AS $val=&gt;$num)<br />        {<br />        $first = array_splice($array,0,$i);<br />        $tmp = array_splice($array,0,$num);<br />        $tmp2 = array();<br />        foreach($tmp as $key =&gt; $value)<br />            {<br />            $tmp2[] = $key;<br />            $number = $value;<br />            };<br />        natcasesort($tmp2);<br />        reset($tmp2);<br />        print_r($tmp2);<br />        unset($tmp);<br />        foreach($tmp2 as $key =&gt; $value)<br />            {<br />            $tmp[$value] = $number;<br />            };<br />        if($keyrev)<br />            {<br />            $tmp = array_reverse($tmp, true);<br />            };<br />        $array = array_merge($first,$tmp,$array);<br />        unset($tmp);<br />        $i = $i+$num;<br />        };<br />};</span></code></div>
  </div>
 </div>
  <div class="note" id="80450">  <div class="votes">
    <div id="Vu80450">
    <a href="/manual/vote-note.php?id=80450&amp;page=function.asort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd80450">
    <a href="/manual/vote-note.php?id=80450&amp;page=function.asort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V80450" title="20% like this...">
    -3
    </div>
  </div>
  <a href="#80450" class="name">
  <strong class="user"><em>mzvarik at gmail dot com</em></strong></a><a class="genanchor" href="#80450"> &para;</a><div class="date" title="2008-01-16 09:29"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom80450">
<div class="phpcode"><code><span class="html">I noticed that my function mentioned earlier is very misleading - somebody please delete that note!<br /><br />This is how you sort:<br /><span class="default">&lt;?php<br />setlocale </span><span class="keyword">(</span><span class="default">LC_ALL</span><span class="keyword">, </span><span class="string">'czech'</span><span class="keyword">);<br /></span><span class="default">$array </span><span class="keyword">= array(</span><span class="string">"a"</span><span class="keyword">, </span><span class="string">"č"</span><span class="keyword">, </span><span class="string">"c"</span><span class="keyword">);<br /></span><span class="default">usort </span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">, </span><span class="string">'strcoll'</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.asort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.asort.php">＋<small>add a note</small></a></div>
