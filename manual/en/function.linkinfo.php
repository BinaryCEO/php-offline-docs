...
<head>
  ...
  <title>PHP: linkinfo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.linkinfo.php">
 <link rel="shorturl" href="https://www.php.net/linkinfo">
 <link rel="alternate" href="https://www.php.net/linkinfo" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.link.php">
 <link rel="next" href="https://www.php.net/manual/en/function.lstat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.linkinfo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.linkinfo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.linkinfo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.linkinfo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.linkinfo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.linkinfo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.linkinfo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.linkinfo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.linkinfo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.linkinfo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.linkinfo.php" hreflang="zh">
...
<meta name="Description" content="Gets information about a link" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: linkinfo - Manual" />
<meta name="twitter:description" content="Gets information about a link" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: linkinfo - Manual" />
<meta itemprop="description" content="Gets information about a link" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets information about a link" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.linkinfo.php' selected="selected">English</option>
            <option value='de/function.linkinfo.php'>German</option>
            <option value='es/function.linkinfo.php'>Spanish</option>
            <option value='fr/function.linkinfo.php'>French</option>
            <option value='it/function.linkinfo.php'>Italian</option>
            <option value='ja/function.linkinfo.php'>Japanese</option>
            <option value='pt_BR/function.linkinfo.php'>Brazilian Portuguese</option>
            <option value='ru/function.linkinfo.php'>Russian</option>
            <option value='tr/function.linkinfo.php'>Turkish</option>
            <option value='uk/function.linkinfo.php'>Ukrainian</option>
            <option value='zh/function.linkinfo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.linkinfo" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">linkinfo</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">linkinfo</span> &mdash; <span class="dc-title">Gets information about a link</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.linkinfo-description">
  ...
  <p class="para">
   ...
   <code class="parameter">path</code>) really exists (using the same method as the
   S_ISLNK macro defined in <var class="filename">stat.h</var>).
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.linkinfo-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>linkinfo()</strong></span> returns the <code class="literal">st_dev</code> field
   of the Unix C stat structure returned by the <code class="literal">lstat</code>
   system call. Returns a non-negative integer on success, -1 in case the link was not found, 
   or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if an open.base_dir violation occurs.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.linkinfo-examples">
  ...
  <p class="para">
   <div class="example" id="example-2397">
    <p><strong>Example #1 <span class="function"><strong>linkinfo()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.readlink.php" class="function" rel="rdfs-seeAlso">readlink()</a> - Returns the target of a symbolic link</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/linkinfo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.linkinfo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.linkinfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.linkinfo.php">＋<small>add a note</small></a></span>
