...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-fetch-assoc.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-fetch-array.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-fetch-object.php">
...
<meta name="Description" content="Returns the next row from a query as an associative array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_fetch_assoc - Manual" />
<meta name="twitter:description" content="Returns the next row from a query as an associative array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_fetch_assoc - Manual" />
<meta itemprop="description" content="Returns the next row from a query as an associative array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the next row from a query as an associative array" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-fetch-assoc.php' selected="selected">English</option>
            ...
            <option value='ja/function.oci-fetch-assoc.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">oci_fetch_assoc</span> &mdash; <span class="dc-title">Returns the next row from a query as an associative array</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.oci-fetch-assoc-description">
  ...
  <p class="para">
   Calling <span class="function"><strong>oci_fetch_assoc()</strong></span> is identical to
   calling <span class="function"><a href="function.oci-fetch-array.php" class="function">oci_fetch_array()</a></span>
   with <strong><code><a href="oci8.constants.php#constant.oci-assoc">OCI_ASSOC</a></code></strong>
 ...
 <div class="refsect1 examples" id="refsect1-function.oci-fetch-assoc-examples">
  ...
  <p class="para">
   <div class="example" id="example-1993">
    <p><strong>Example #1 <span class="function"><strong>oci_fetch_assoc()</strong></span> Example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">'hr'</span><span style="color: #007700">, </span><span style="color: #DD0000">'welcome'</span><span style="color: #007700">, </span><span style="color: #DD0000">'localhost/XE'</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$conn</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$e </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_error</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">trigger_error</span><span style="color: #007700">(</span><span style="color: #0000BB">htmlentities</span><span style="color: #007700">(</span><span style="color: #0000BB">$e</span><span style="color: #007700">[</span><span style="color: #DD0000">'message'</span><span style="color: #007700">], </span><span style="color: #0000BB">ENT_QUOTES</span><span style="color: #007700">), </span><span style="color: #0000BB">E_USER_ERROR</span><span style="color: #007700">);<br />}<br /><br /></span><span style="color: #0000BB">$stid </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_parse</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">'SELECT department_id, department_name FROM departments'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">oci_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">);<br /><br />while ((</span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_fetch_assoc</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">)) != </span><span style="color: #0000BB">false</span><span style="color: #007700">) {<br />    echo </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #DD0000">'DEPARTMENT_ID'</span><span style="color: #007700">] . </span><span style="color: #DD0000">" " </span><span style="color: #007700">. </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #DD0000">'DEPARTMENT_NAME'</span><span style="color: #007700">] . </span><span style="color: #DD0000">"&lt;br&gt;\n"</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #0000BB">oci_free_statement</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">oci_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.oci-fetch-assoc-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    See <span class="function"><a href="function.oci-fetch-array.php" class="function">oci_fetch_array()</a></span> for more examples of fetching rows.
   </p>
  </p></blockquote>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.oci-fetch-row.php" class="function" rel="rdfs-seeAlso">oci_fetch_row()</a> - Returns the next row from a query as a numeric array</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-fetch-assoc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-fetch-assoc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-fetch-assoc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-fetch-assoc.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>dbernhardt129 at gmail dot com</em></strong></a><a class="genanchor" href="#100304"> &para;</a><div class="date" title="2010-10-06 02:11"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom100304">
<div class="phpcode"><code><span class="html">Here's a simple example of using the oci_fetch_assoc function for anyone who would like to see it.
<br />
<br /><span class="default">&lt;?php
<br />$oconn </span><span class="keyword">= </span><span class="default">oci_connect</span><span class="keyword">(</span><span class="string">'ora_user'</span><span class="keyword">,</span><span class="string">'ora_pass'</span><span class="keyword">,</span><span class="string">'ora_inst'</span><span class="keyword">);
<br />if (!</span><span class="default">$oconn</span><span class="keyword">){
<br />  </span><span class="default">$msg </span><span class="keyword">= </span><span class="string">"Cannot connect to Oracle "</span><span class="keyword">.</span><span class="default">oci_error</span><span class="keyword">();
<br />} else {
<br />  </span><span class="default">$msg </span><span class="keyword">= </span><span class="string">"Connected to Oracle"</span><span class="keyword">;
<br />}
<br />
<br /></span><span class="default">$select_stmt </span><span class="keyword">= </span><span class="string">"select username from user_table"</span><span class="keyword">;
<br />
<br /></span><span class="default">$stid </span><span class="keyword">= </span><span class="default">oci_parse</span><span class="keyword">(</span><span class="default">$oconn</span><span class="keyword">, </span><span class="default">$select_stmt</span><span class="keyword">);
<br /></span><span class="default">oci_execute</span><span class="keyword">(</span><span class="default">$stid</span><span class="keyword">);
<br />
<br />echo </span><span class="string">"&lt;table border='1'&gt;\n"</span><span class="keyword">;
<br />
<br />while (</span><span class="default">$row </span><span class="keyword">= </span><span class="default">oci_fetch_assoc</span><span class="keyword">(</span><span class="default">$stid</span><span class="keyword">)) {
<br />    echo </span><span class="string">"&lt;tr&gt;\n"</span><span class="keyword">;
<br />    echo </span><span class="string">"&lt;td&gt;"</span><span class="keyword">. </span><span class="default">$row</span><span class="keyword">[</span><span class="string">"USERNAME"</span><span class="keyword">] . </span><span class="string">"&lt;/td&gt;\n"</span><span class="keyword">;
<br />    echo </span><span class="string">"&lt;/tr&gt;\n"</span><span class="keyword">;
<br /> }
<br />
<br />echo </span><span class="string">"&lt;/table&gt;\n"</span><span class="keyword">;
<br />
<br /></span><span class="default">oci_free_statement</span><span class="keyword">(</span><span class="default">$stid</span><span class="keyword">);
<br /></span><span class="default">oci_close</span><span class="keyword">(</span><span class="default">$oconn</span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>
<br />Make sure you capitalize the column name for referencing the item in the associative array.  Of course, this is just a simple example and you might want to do some processing on the data prior to output, but you get the idea here.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>Dawid Krysiak</em></strong></a><a class="genanchor" href="#114031"> &para;</a><div class="date" title="2014-01-03 01:31"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114031">
<div class="phpcode"><code><span class="html">Unlike oci_fetch_all(), after using oci_fetch_assoc(), LOB columns (CLOB, BLOB) are NOT returned as strings but as Oci-Lob objects. You have to use Oci-Lob-&gt;read() or load() method in order to read column content.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.oci-fetch-assoc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-fetch-assoc.php">＋<small>add a note</small></a></div>
