...
<head>
  ...
  <title>PHP: odbc_free_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-free-result.php">
 <link rel="shorturl" href="https://www.php.net/odbc-free-result">
 <link rel="alternate" href="https://www.php.net/odbc-free-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-foreignkeys.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-gettypeinfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-free-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-free-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-free-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-free-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-free-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-free-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-free-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-free-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-free-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-free-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-free-result.php" hreflang="zh">
...
<meta name="Description" content="Free objects associated with a result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_free_result - Manual" />
<meta name="twitter:description" content="Free objects associated with a result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_free_result - Manual" />
<meta itemprop="description" content="Free objects associated with a result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Free objects associated with a result" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.odbc-gettypeinfo.php">
          odbc_gettypeinfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-foreignkeys.php">
          &laquo; odbc_foreignkeys        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-free-result.php' selected="selected">English</option>
            <option value='de/function.odbc-free-result.php'>German</option>
            <option value='es/function.odbc-free-result.php'>Spanish</option>
            <option value='fr/function.odbc-free-result.php'>French</option>
            <option value='it/function.odbc-free-result.php'>Italian</option>
            <option value='ja/function.odbc-free-result.php'>Japanese</option>
            <option value='pt_BR/function.odbc-free-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-free-result.php'>Russian</option>
            <option value='tr/function.odbc-free-result.php'>Turkish</option>
            <option value='uk/function.odbc-free-result.php'>Ukrainian</option>
            <option value='zh/function.odbc-free-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-free-result" class="refentry">
   ...
   <p class="para">
    ...
    pending transactions are rolled back.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-free-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-free-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-free-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-free-result.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122562">  <div class="votes">
    <div id="Vu122562">
    <a href="/manual/vote-note.php?id=122562&amp;page=function.odbc-free-result&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122562">
    <a href="/manual/vote-note.php?id=122562&amp;page=function.odbc-free-result&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122562" title="50% like this...">
    0
    </div>
  </div>
  <a href="#122562" class="name">
  <strong class="user"><em>sergio.deleon at techoblige</em></strong></a><a class="genanchor" href="#122562"> &para;</a><div class="date" title="2018-03-28 10:18"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122562">
<div class="phpcode"><code><span class="html">MDBTools driver needs you to properly free up a result_id before reusing a variable.<br />An odbc_fetch_array() over a overwritten variable with a new result will crash the script with a Segmentation fault if the previous resource wasn't free'd up.<br /><br />PHP 5.6</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.odbc-free-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-free-result.php">＋<small>add a note</small></a></div>
