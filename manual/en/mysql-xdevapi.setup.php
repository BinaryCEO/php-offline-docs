...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi.setup.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi.setup.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi.setup.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mysql-xdevapi.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.mysql-xdevapi.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi.requirements.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi.setup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysql-xdevapi.setup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysql-xdevapi.setup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysql-xdevapi.setup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysql-xdevapi.setup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysql-xdevapi.setup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysql-xdevapi.setup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysql-xdevapi.setup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysql-xdevapi.setup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysql-xdevapi.setup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysql-xdevapi.setup.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi.setup.php' selected="selected">English</option>
            <option value='de/mysql-xdevapi.setup.php'>German</option>
            <option value='es/mysql-xdevapi.setup.php'>Spanish</option>
            <option value='fr/mysql-xdevapi.setup.php'>French</option>
            <option value='it/mysql-xdevapi.setup.php'>Italian</option>
            <option value='ja/mysql-xdevapi.setup.php'>Japanese</option>
            <option value='pt_BR/mysql-xdevapi.setup.php'>Brazilian Portuguese</option>
            <option value='ru/mysql-xdevapi.setup.php'>Russian</option>
            <option value='tr/mysql-xdevapi.setup.php'>Turkish</option>
            <option value='uk/mysql-xdevapi.setup.php'>Ukrainian</option>
            <option value='zh/mysql-xdevapi.setup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysql-xdevapi.setup" class="chapter">
 <h1 class="title">Installing/Configuring</h1>
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="mysql-xdevapi.requirements.php">Requirements</a></li><li><a href="mysql-xdevapi.installation.php">Installation</a></li><li><a href="mysql-xdevapi.configuration.php">Runtime Configuration</a></li><li><a href="mysql-xdevapi.build.php">Building / Compiling From Source</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi.setup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi.setup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi.setup.php">＋<small>add a note</small></a></span>
