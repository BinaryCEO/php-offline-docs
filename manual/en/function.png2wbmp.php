...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.png2wbmp.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.jpeg2wbmp.php">
 <link rel="next" href="https://www.php.net/manual/en/class.gdimage.php">
...
<meta name="Description" content="Convert PNG image file to WBMP image file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: png2wbmp - Manual" />
<meta name="twitter:description" content="Convert PNG image file to WBMP image file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: png2wbmp - Manual" />
<meta itemprop="description" content="Convert PNG image file to WBMP image file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Convert PNG image file to WBMP image file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.png2wbmp.php' selected="selected">English</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PHP 5, PHP 7)</p><p class="refpurpose"><span class="refname">png2wbmp</span> &mdash; <span class="dc-title">Convert PNG image file to WBMP image file</span></p>
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 examples" id="refsect1-function.png2wbmp-examples">
  ...
  <p class="para">
   <div class="example" id="example-2952">
    <p><strong>Example #1 <span class="function"><strong>png2wbmp()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Path to the target png<br /></span><span style="color: #0000BB">$path </span><span style="color: #007700">= </span><span style="color: #DD0000">'./test.png'</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">// Get the image sizes<br /></span><span style="color: #0000BB">$image </span><span style="color: #007700">= </span><span style="color: #0000BB">getimagesize</span><span style="color: #007700">(</span><span style="color: #0000BB">$path</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Convert image<br /></span><span style="color: #0000BB">png2wbmp</span><span style="color: #007700">(</span><span style="color: #0000BB">$path</span><span style="color: #007700">, </span><span style="color: #DD0000">'./test.wbmp'</span><span style="color: #007700">, </span><span style="color: #0000BB">$image</span><span style="color: #007700">[</span><span style="color: #0000BB">1</span><span style="color: #007700">], </span><span style="color: #0000BB">$image</span><span style="color: #007700">[</span><span style="color: #0000BB">0</span><span style="color: #007700">], </span><span style="color: #0000BB">7</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.png2wbmp-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.jpeg2wbmp.php" class="function" rel="rdfs-seeAlso">jpeg2wbmp()</a> - Convert JPEG image file to WBMP image file</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/png2wbmp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.png2wbmp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.png2wbmp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.png2wbmp.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">WBMP is NOT windows bitmap, it is wireless bitmap. just to state that nice and clearly.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.png2wbmp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.png2wbmp.php">＋<small>add a note</small></a></div>
