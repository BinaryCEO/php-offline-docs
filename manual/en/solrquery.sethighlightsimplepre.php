...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightSimplePre - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightsimplepre.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightsimplepre.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightsimplepre.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightsimplepost.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightsnippets.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightsimplepre.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightsimplepre.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightsimplepre.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightsimplepre.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightsimplepre.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightsimplepre.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightsimplepre.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightsimplepre.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightsimplepre.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightsimplepre.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightsimplepre.php" hreflang="zh">
...
<meta name="Description" content="Sets the text which appears before a highlighted term" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightSimplePre - Manual" />
<meta name="twitter:description" content="Sets the text which appears before a highlighted term" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightSimplePre - Manual" />
<meta itemprop="description" content="Sets the text which appears before a highlighted term" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the text which appears before a highlighted term" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.sethighlightsnippets.php">
          SolrQuery::setHighlightSnippets &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightsimplepost.php">
          &laquo; SolrQuery::setHighlightSimplePost        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightsimplepre.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightsimplepre.php'>German</option>
            <option value='es/solrquery.sethighlightsimplepre.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightsimplepre.php'>French</option>
            <option value='it/solrquery.sethighlightsimplepre.php'>Italian</option>
            <option value='ja/solrquery.sethighlightsimplepre.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightsimplepre.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightsimplepre.php'>Russian</option>
            <option value='tr/solrquery.sethighlightsimplepre.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightsimplepre.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightsimplepre.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightsimplepre" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightSimplePre</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightSimplePre</span> &mdash; <span class="dc-title">Sets the text which appears before a highlighted term</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightsimplepre-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightSimplePre</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$simplePre</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>

  <p class="para rdfs-comment">
   Sets the text which appears before a highlighted term
  </p>
  <p class="para"><div class="descriptioncode"><pre class="descriptioncode">The default is &lt;em&gt;</pre>
</div></p>
 </div>


 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightsimplepre-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">simplePre</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightsimplepre-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightsimplepre.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightsimplepre%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightsimplepre&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightsimplepre.php">＋<small>add a note</small></a></span>
