...
<head>
  ...
  <title>PHP: Gmagick::addimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.addimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.addimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.addimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.addnoiseimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.addimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.addimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.addimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.addimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.addimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.addimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.addimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.addimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.addimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.addimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.addimage.php" hreflang="zh">
...
<meta name="Description" content="Adds new image to Gmagick object image list" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::addimage - Manual" />
<meta name="twitter:description" content="Adds new image to Gmagick object image list" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::addimage - Manual" />
<meta itemprop="description" content="Adds new image to Gmagick object image list" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds new image to Gmagick object image list" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.addnoiseimage.php">
          Gmagick::addnoiseimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.gmagick.php">
          &laquo; Gmagick        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.addimage.php' selected="selected">English</option>
            <option value='de/gmagick.addimage.php'>German</option>
            <option value='es/gmagick.addimage.php'>Spanish</option>
            <option value='fr/gmagick.addimage.php'>French</option>
            <option value='it/gmagick.addimage.php'>Italian</option>
            <option value='ja/gmagick.addimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.addimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.addimage.php'>Russian</option>
            <option value='tr/gmagick.addimage.php'>Turkish</option>
            <option value='uk/gmagick.addimage.php'>Ukrainian</option>
            <option value='zh/gmagick.addimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.addimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::addimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::addimage</span> &mdash; <span class="dc-title">Adds new image to Gmagick object image list</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.addimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::addimage</strong></span>(<span class="methodparam"><span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span> <code class="parameter">$source</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.addimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.addimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.addimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/addimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.addimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.addimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.addimage.php">＋<small>add a note</small></a></span>
