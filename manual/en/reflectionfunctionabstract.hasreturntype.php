...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionfunctionabstract.hasreturntype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionfunctionabstract.hasreturntype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionfunctionabstract.hasreturntype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionfunctionabstract.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionfunctionabstract.gettentativereturntype.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionfunctionabstract.hastentativereturntype.php">
...
<meta name="Description" content="Checks if the function has a specified return type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionFunctionAbstract::hasReturnType - Manual" />
<meta name="twitter:description" content="Checks if the function has a specified return type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionFunctionAbstract::hasReturnType - Manual" />
<meta itemprop="description" content="Checks if the function has a specified return type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if the function has a specified return type" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionfunctionabstract.hasreturntype.php' selected="selected">English</option>
            ...
            <option value='ja/reflectionfunctionabstract.hasreturntype.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionFunctionAbstract::hasReturnType</span> &mdash; <span class="dc-title">Checks if the function has a specified return type</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionfunctionabstract.hasreturntype-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the function is a specified return type, otherwise <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionfunctionabstract.hasreturntype-examples">
  ...
  <p class="para">
   <div class="example" id="example-5562">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionFunctionAbstract::hasReturnType()</strong></span> example</strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">bool(true)</pre>
   ...
   <div class="example" id="example-5563">
    <p><strong>Example #2 Usage on built-in functions</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionfunctionabstract.getreturntype.php" class="methodname" rel="rdfs-seeAlso">ReflectionFunctionAbstract::getReturnType()</a> - Gets the specified return type of a function</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionfunctionabstract/hasreturntype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionfunctionabstract.hasreturntype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionfunctionabstract.hasreturntype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionfunctionabstract.hasreturntype.php">＋<small>add a note</small></a></span>
