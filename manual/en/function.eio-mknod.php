...
<head>
  ...
  <title>PHP: eio_mknod - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-mknod.php">
 <link rel="shorturl" href="https://www.php.net/eio-mknod">
 <link rel="alternate" href="https://www.php.net/eio-mknod" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-mkdir.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-nop.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-mknod.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-mknod.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-mknod.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-mknod.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-mknod.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-mknod.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-mknod.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-mknod.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-mknod.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-mknod.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-mknod.php" hreflang="zh">
...
<meta name="Description" content="Create a special or ordinary file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_mknod - Manual" />
<meta name="twitter:description" content="Create a special or ordinary file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_mknod - Manual" />
<meta itemprop="description" content="Create a special or ordinary file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a special or ordinary file" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-mknod.php' selected="selected">English</option>
            <option value='de/function.eio-mknod.php'>German</option>
            <option value='es/function.eio-mknod.php'>Spanish</option>
            <option value='fr/function.eio-mknod.php'>French</option>
            <option value='it/function.eio-mknod.php'>Italian</option>
            <option value='ja/function.eio-mknod.php'>Japanese</option>
            <option value='pt_BR/function.eio-mknod.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-mknod.php'>Russian</option>
            <option value='tr/function.eio-mknod.php'>Turkish</option>
            <option value='uk/function.eio-mknod.php'>Ukrainian</option>
            <option value='zh/function.eio-mknod.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-mknod" class="refentry">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-mknod-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>eio_mknod()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-open.php" class="function" rel="rdfs-seeAlso">eio_open()</a> - Opens a file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-mknod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-mknod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-mknod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-mknod.php">＋<small>add a note</small></a></span>
