...
<head>
  ...
  <title>PHP: get_browser - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.get-browser.php">
 <link rel="shorturl" href="https://www.php.net/get-browser">
 <link rel="alternate" href="https://www.php.net/get-browser" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.misc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.exit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.halt-compiler.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.get-browser.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.get-browser.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.get-browser.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.get-browser.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.get-browser.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.get-browser.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.get-browser.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.get-browser.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.get-browser.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.get-browser.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.get-browser.php" hreflang="zh">
...
<meta name="Description" content="Tells what the user's browser is capable of" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: get_browser - Manual" />
<meta name="twitter:description" content="Tells what the user's browser is capable of" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: get_browser - Manual" />
<meta itemprop="description" content="Tells what the user's browser is capable of" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Tells what the user's browser is capable of" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.halt-compiler.php">
          __halt_compiler &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.exit.php">
          &laquo; exit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.get-browser.php' selected="selected">English</option>
            <option value='de/function.get-browser.php'>German</option>
            <option value='es/function.get-browser.php'>Spanish</option>
            <option value='fr/function.get-browser.php'>French</option>
            <option value='it/function.get-browser.php'>Italian</option>
            <option value='ja/function.get-browser.php'>Japanese</option>
            <option value='pt_BR/function.get-browser.php'>Brazilian Portuguese</option>
            <option value='ru/function.get-browser.php'>Russian</option>
            <option value='tr/function.get-browser.php'>Turkish</option>
            <option value='uk/function.get-browser.php'>Ukrainian</option>
            <option value='zh/function.get-browser.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.get-browser" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">get_browser</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">get_browser</span> &mdash; <span class="dc-title">Tells what the user&#039;s browser is capable of</span></p>
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      ...
      <p class="para">
       You can bypass this parameter with a <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> value.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       If set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, this function will return an <span class="type"><a href="language.types.array.php" class="type array">array</a></span>
       instead of an <span class="type"><a href="language.types.object.php" class="type object">object</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.get-browser-returnvalues">
  ...
  <p class="para">
   ...
   minor version numbers and ID string; <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>/<strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> values for features
   such as frames, JavaScript, and cookies; and so forth.
  </p>
  <p class="para">
   The <code class="literal">cookies</code> value simply means that the browser
   itself is capable of accepting cookies and does not mean the user has
   enabled the browser to accept cookies or not. The only way to test if
   cookies are accepted is to set one with <span class="function"><a href="function.setcookie.php" class="function">setcookie()</a></span>,
   reload, and check for the value.
  </p>
  <p class="para">
    Returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> when no information can be retrieved, such as when the
    <a href="misc.configuration.php#ini.browscap" class="link">browscap</a> configuration setting in 
    <var class="filename">php.ini</var> has not been set.
  </p>
 </div>
...
(
 ...
 <div class="refsect1 notes" id="refsect1-function.get-browser-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    In order for this to work, your <a href="misc.configuration.php#ini.browscap" class="link">browscap</a> configuration setting in 
   ...
   <p class="para">
    ...
    find an up-to-date <a href="http://browscap.org/" class="link external">&raquo;&nbsp;php_browscap.ini</a> file here.
   </p>
   <p class="para">
    ...
    current. The format of the file is fairly self-explanatory.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/misc/functions/get-browser.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.get-browser%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.get-browser&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-browser.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">17 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122177">  <div class="votes">
    <div id="Vu122177">
    <a href="/manual/vote-note.php?id=122177&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122177">
    <a href="/manual/vote-note.php?id=122177&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122177" title="81% like this...">
    60
    </div>
  </div>
  <a href="#122177" class="name">
  <strong class="user"><em>krozinov at gmail dot com</em></strong></a><a class="genanchor" href="#122177"> &para;</a><div class="date" title="2017-12-26 04:19"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122177">
<div class="phpcode"><code><span class="html">As of PHP 7.0.15 and 7.1.1 and higher, get_browser() now performs much better - reportedly 100x faster.  The Changelog, bug description, and solution are here:<br /><br /><a href="http://php.net/ChangeLog-7.php" rel="nofollow" target="_blank">http://php.net/ChangeLog-7.php</a> (search for get_browser())<br /><a href="https://bugs.php.net/bug.php?id=70490" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=70490</a><br /><a href="https://github.com/php/php-src/pull/2242" rel="nofollow" target="_blank">https://github.com/php/php-src/pull/2242</a></span></code></div>
  </div>
 </div>
  <div class="note" id="118632">  <div class="votes">
    <div id="Vu118632">
    <a href="/manual/vote-note.php?id=118632&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118632">
    <a href="/manual/vote-note.php?id=118632&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118632" title="64% like this...">
    67
    </div>
  </div>
  <a href="#118632" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#118632"> &para;</a><div class="date" title="2016-01-12 02:37"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118632">
<div class="phpcode"><code><span class="html">This function is too slow for todays needs.<br /><br />If you need browser / device / operating system detection, please try one of listed packages here: <a href="https://github.com/ThaDafinser/UserAgentParser" rel="nofollow" target="_blank">https://github.com/ThaDafinser/UserAgentParser</a></span></code></div>
  </div>
 </div>
  <div class="note" id="119332">  <div class="votes">
    <div id="Vu119332">
    <a href="/manual/vote-note.php?id=119332&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119332">
    <a href="/manual/vote-note.php?id=119332&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119332" title="65% like this...">
    40
    </div>
  </div>
  <a href="#119332" class="name">
  <strong class="user"><em>Francesco R</em></strong></a><a class="genanchor" href="#119332"> &para;</a><div class="date" title="2016-05-14 01:52"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119332">
<div class="phpcode"><code><span class="html">If you ONLY need a very fast and simple function to detect the browser name (update to May 2016):<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">get_browser_name</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">)<br />{<br />    if (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'Opera'</span><span class="keyword">) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'OPR/'</span><span class="keyword">)) return </span><span class="string">'Opera'</span><span class="keyword">;<br />    elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'Edge'</span><span class="keyword">)) return </span><span class="string">'Edge'</span><span class="keyword">;<br />    elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'Chrome'</span><span class="keyword">)) return </span><span class="string">'Chrome'</span><span class="keyword">;<br />    elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'Safari'</span><span class="keyword">)) return </span><span class="string">'Safari'</span><span class="keyword">;<br />    elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'Firefox'</span><span class="keyword">)) return </span><span class="string">'Firefox'</span><span class="keyword">;<br />    elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'MSIE'</span><span class="keyword">) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'Trident/7'</span><span class="keyword">)) return </span><span class="string">'Internet Explorer'</span><span class="keyword">;<br />    <br />    return </span><span class="string">'Other'</span><span class="keyword">;<br />}<br /><br /></span><span class="comment">// Usage:<br /><br /></span><span class="keyword">echo </span><span class="default">get_browser_name</span><span class="keyword">(</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'HTTP_USER_AGENT'</span><span class="keyword">]);<br /><br /></span><span class="default">?&gt;<br /></span><br />This function also resolves the trouble with Edge (that contains in the user agent the string "Safari" and "Chrome"), with Chrome (contains the string "Safari") and IE11 (that do not contains 'MSIE' like all other IE versions).<br /><br />Note that "strpos" is the fastest function to check a string (far better than "preg_match") and Opera + Edge + Chrome + Safari + Firefox + Internet Explorer are the most used browsers today (over 97%).</span></code></div>
  </div>
 </div>
  <div class="note" id="122181">  <div class="votes">
    <div id="Vu122181">
    <a href="/manual/vote-note.php?id=122181&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122181">
    <a href="/manual/vote-note.php?id=122181&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122181" title="75% like this...">
    22
    </div>
  </div>
  <a href="#122181" class="name">
  <strong class="user"><em>Konstantin Rozinov</em></strong></a><a class="genanchor" href="#122181"> &para;</a><div class="date" title="2017-12-26 05:18"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122181">
<div class="phpcode"><code><span class="html">Since browser detection can be tricky and very slow, I compared a few packages.<br /><br /><a href="http://thadafinser.github.io/UserAgentParserComparison/v5/index.html" rel="nofollow" target="_blank">http://thadafinser.github.io/UserAgentParserComparison/v5/index.html</a><br /><br /><a href="https://github.com/sinergi/php-browser-detector" rel="nofollow" target="_blank">https://github.com/sinergi/php-browser-detector</a><br /><a href="https://github.com/WhichBrowser/Parser-PHP" rel="nofollow" target="_blank">https://github.com/WhichBrowser/Parser-PHP</a><br /><a href="https://github.com/piwik/device-detector" rel="nofollow" target="_blank">https://github.com/piwik/device-detector</a><br /><a href="http://php.net/manual/en/function.get-browser.php" rel="nofollow" target="_blank">http://php.net/manual/en/function.get-browser.php</a><br /><br />Here are the results:<br /><br />User Agent: <br />Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.84 Safari/537.36<br /><br />Sinergi Package<br />---------------<br />Chrome 63.0.3239.84 on Windows 10.0<br />Took 0.0022480487823486 seconds.<br />---------------<br /><br />WhichBrowser Package<br />---------------<br />Chrome 63 on Windows 10<br />Took 0.021045207977295 seconds.<br />---------------<br /><br />Piwik Package<br />---------------<br />Chrome 63.0 on Windows 10<br />Took 0.079447031021118 seconds.<br />---------------<br /><br />get_browser Package<br />---------------<br />Chrome 63.0 on Windows 10<br />Took 0.09611701965332 seconds.<br />---------------<br /><br />User Agent: <br />Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:57.0) Gecko/20100101 Firefox/57.0<br /><br />Sinergi Package<br />---------------<br />Firefox 57.0 on Windows 10.0<br />Took 0.0023159980773926 seconds.<br />---------------<br /><br />WhichBrowser Package<br />---------------<br />Firefox 57.0 on Windows 10<br />Took 0.019663095474243 seconds.<br />---------------<br /><br />Piwik Package<br />---------------<br />Firefox 57.0 on Windows 10<br />Took 0.079678058624268 seconds.<br />---------------<br /><br />get_browser Package<br />---------------<br />Firefox 57.0 on Windows 10<br />Took 0.02236008644104 seconds.<br />---------------<br /><br />The consistent winner (by speed, not necessarily coverage) by far is:<br /><a href="https://github.com/sinergi/php-browser-detector" rel="nofollow" target="_blank">https://github.com/sinergi/php-browser-detector</a></span></code></div>
  </div>
 </div>
  <div class="note" id="101125">  <div class="votes">
    <div id="Vu101125">
    <a href="/manual/vote-note.php?id=101125&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd101125">
    <a href="/manual/vote-note.php?id=101125&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V101125" title="56% like this...">
    51
    </div>
  </div>
  <a href="#101125" class="name">
  <strong class="user"><em>ruudrp at live dot nl</em></strong></a><a class="genanchor" href="#101125"> &para;</a><div class="date" title="2010-11-28 03:31"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101125">
<div class="phpcode"><code><span class="html">To my surprise I found that none of the get_browser alternatives output the correct name / version combination that I was looking for using Opera or Chrome. They either give the wrong name eg Safari when in fact it should be Chrome and if the ua string includes a version number as with the latest versions of Chrome and Opera the wrong number is reported. So I took bits and pieces from the various examples and combined them and added a check for version. <br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">getBrowser</span><span class="keyword">() <br />{ <br />    </span><span class="default">$u_agent </span><span class="keyword">= </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'HTTP_USER_AGENT'</span><span class="keyword">]; <br />    </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Unknown'</span><span class="keyword">;<br />    </span><span class="default">$platform </span><span class="keyword">= </span><span class="string">'Unknown'</span><span class="keyword">;<br />    </span><span class="default">$version</span><span class="keyword">= </span><span class="string">""</span><span class="keyword">;<br /><br />    </span><span class="comment">//First get the platform?<br />    </span><span class="keyword">if (</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/linux/i'</span><span class="keyword">, </span><span class="default">$u_agent</span><span class="keyword">)) {<br />        </span><span class="default">$platform </span><span class="keyword">= </span><span class="string">'linux'</span><span class="keyword">;<br />    }<br />    elseif (</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/macintosh|mac os x/i'</span><span class="keyword">, </span><span class="default">$u_agent</span><span class="keyword">)) {<br />        </span><span class="default">$platform </span><span class="keyword">= </span><span class="string">'mac'</span><span class="keyword">;<br />    }<br />    elseif (</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/windows|win32/i'</span><span class="keyword">, </span><span class="default">$u_agent</span><span class="keyword">)) {<br />        </span><span class="default">$platform </span><span class="keyword">= </span><span class="string">'windows'</span><span class="keyword">;<br />    }<br />    <br />    </span><span class="comment">// Next get the name of the useragent yes seperately and for good reason<br />    </span><span class="keyword">if(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/MSIE/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">) &amp;&amp; !</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Opera/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { <br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Internet Explorer'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"MSIE"</span><span class="keyword">; <br />    } <br />    elseif(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Firefox/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { <br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Mozilla Firefox'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"Firefox"</span><span class="keyword">; <br />    } <br />    elseif(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Chrome/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { <br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Google Chrome'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"Chrome"</span><span class="keyword">; <br />    } <br />    elseif(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Safari/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { <br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Apple Safari'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"Safari"</span><span class="keyword">; <br />    } <br />    elseif(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Opera/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { <br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Opera'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"Opera"</span><span class="keyword">; <br />    } <br />    elseif(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Netscape/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { <br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Netscape'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"Netscape"</span><span class="keyword">; <br />    } <br />    <br />    </span><span class="comment">// finally get the correct version number<br />    </span><span class="default">$known </span><span class="keyword">= array(</span><span class="string">'Version'</span><span class="keyword">, </span><span class="default">$ub</span><span class="keyword">, </span><span class="string">'other'</span><span class="keyword">);<br />    </span><span class="default">$pattern </span><span class="keyword">= </span><span class="string">'#(?&lt;browser&gt;' </span><span class="keyword">. </span><span class="default">join</span><span class="keyword">(</span><span class="string">'|'</span><span class="keyword">, </span><span class="default">$known</span><span class="keyword">) .<br />    </span><span class="string">')[/ ]+(?&lt;version&gt;[0-9.|a-zA-Z.]*)#'</span><span class="keyword">;<br />    if (!</span><span class="default">preg_match_all</span><span class="keyword">(</span><span class="default">$pattern</span><span class="keyword">, </span><span class="default">$u_agent</span><span class="keyword">, </span><span class="default">$matches</span><span class="keyword">)) {<br />        </span><span class="comment">// we have no matching number just continue<br />    </span><span class="keyword">}<br />    <br />    </span><span class="comment">// see how many we have<br />    </span><span class="default">$i </span><span class="keyword">= </span><span class="default">count</span><span class="keyword">(</span><span class="default">$matches</span><span class="keyword">[</span><span class="string">'browser'</span><span class="keyword">]);<br />    if (</span><span class="default">$i </span><span class="keyword">!= </span><span class="default">1</span><span class="keyword">) {<br />        </span><span class="comment">//we will have two since we are not using 'other' argument yet<br />        //see if version is before or after the name<br />        </span><span class="keyword">if (</span><span class="default">strripos</span><span class="keyword">(</span><span class="default">$u_agent</span><span class="keyword">,</span><span class="string">"Version"</span><span class="keyword">) &lt; </span><span class="default">strripos</span><span class="keyword">(</span><span class="default">$u_agent</span><span class="keyword">,</span><span class="default">$ub</span><span class="keyword">)){<br />            </span><span class="default">$version</span><span class="keyword">= </span><span class="default">$matches</span><span class="keyword">[</span><span class="string">'version'</span><span class="keyword">][</span><span class="default">0</span><span class="keyword">];<br />        }<br />        else {<br />            </span><span class="default">$version</span><span class="keyword">= </span><span class="default">$matches</span><span class="keyword">[</span><span class="string">'version'</span><span class="keyword">][</span><span class="default">1</span><span class="keyword">];<br />        }<br />    }<br />    else {<br />        </span><span class="default">$version</span><span class="keyword">= </span><span class="default">$matches</span><span class="keyword">[</span><span class="string">'version'</span><span class="keyword">][</span><span class="default">0</span><span class="keyword">];<br />    }<br />    <br />    </span><span class="comment">// check if we have a number<br />    </span><span class="keyword">if (</span><span class="default">$version</span><span class="keyword">==</span><span class="default">null </span><span class="keyword">|| </span><span class="default">$version</span><span class="keyword">==</span><span class="string">""</span><span class="keyword">) {</span><span class="default">$version</span><span class="keyword">=</span><span class="string">"?"</span><span class="keyword">;}<br />    <br />    return array(<br />        </span><span class="string">'userAgent' </span><span class="keyword">=&gt; </span><span class="default">$u_agent</span><span class="keyword">,<br />        </span><span class="string">'name'      </span><span class="keyword">=&gt; </span><span class="default">$bname</span><span class="keyword">,<br />        </span><span class="string">'version'   </span><span class="keyword">=&gt; </span><span class="default">$version</span><span class="keyword">,<br />        </span><span class="string">'platform'  </span><span class="keyword">=&gt; </span><span class="default">$platform</span><span class="keyword">,<br />        </span><span class="string">'pattern'    </span><span class="keyword">=&gt; </span><span class="default">$pattern<br />    </span><span class="keyword">);<br />} <br /><br /></span><span class="comment">// now try it<br /></span><span class="default">$ua</span><span class="keyword">=</span><span class="default">getBrowser</span><span class="keyword">();<br /></span><span class="default">$yourbrowser</span><span class="keyword">= </span><span class="string">"Your browser: " </span><span class="keyword">. </span><span class="default">$ua</span><span class="keyword">[</span><span class="string">'name'</span><span class="keyword">] . </span><span class="string">" " </span><span class="keyword">. </span><span class="default">$ua</span><span class="keyword">[</span><span class="string">'version'</span><span class="keyword">] . </span><span class="string">" on " </span><span class="keyword">.</span><span class="default">$ua</span><span class="keyword">[</span><span class="string">'platform'</span><span class="keyword">] . </span><span class="string">" reports: &lt;br &gt;" </span><span class="keyword">. </span><span class="default">$ua</span><span class="keyword">[</span><span class="string">'userAgent'</span><span class="keyword">];<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$yourbrowser</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="123473">  <div class="votes">
    <div id="Vu123473">
    <a href="/manual/vote-note.php?id=123473&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123473">
    <a href="/manual/vote-note.php?id=123473&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123473" title="72% like this...">
    19
    </div>
  </div>
  <a href="#123473" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#123473"> &para;</a><div class="date" title="2018-12-28 12:45"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123473">
<div class="phpcode"><code><span class="html">Follow up to Francesco R's post from 2016.<br /><br />His function works for most human traffic; added a few lines to cover the most common bot traffic. Also fixed issue with function failing to detect strings at position 0 due to strpos behavior.<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Function written and tested December, 2018<br /></span><span class="keyword">function </span><span class="default">get_browser_name</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">)<br />{<br />        </span><span class="comment">// Make case insensitive.<br />        </span><span class="default">$t </span><span class="keyword">= </span><span class="default">strtolower</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">);<br /><br />        </span><span class="comment">// If the string *starts* with the string, strpos returns 0 (i.e., FALSE). Do a ghetto hack and start with a space.<br />        // "[strpos()] may return Boolean FALSE, but may also return a non-Boolean value which evaluates to FALSE."<br />        //     <a href="http://php.net/manual/en/function.strpos.php" rel="nofollow" target="_blank">http://php.net/manual/en/function.strpos.php</a><br />        </span><span class="default">$t </span><span class="keyword">= </span><span class="string">" " </span><span class="keyword">. </span><span class="default">$t</span><span class="keyword">;<br /><br />        </span><span class="comment">// Humans / Regular Users      <br />        </span><span class="keyword">if     (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'opera'     </span><span class="keyword">) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'opr/'</span><span class="keyword">)     ) return </span><span class="string">'Opera'            </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'edge'      </span><span class="keyword">)                           ) return </span><span class="string">'Edge'             </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'chrome'    </span><span class="keyword">)                           ) return </span><span class="string">'Chrome'           </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'safari'    </span><span class="keyword">)                           ) return </span><span class="string">'Safari'           </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'firefox'   </span><span class="keyword">)                           ) return </span><span class="string">'Firefox'          </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'msie'      </span><span class="keyword">) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'trident/7'</span><span class="keyword">)) return </span><span class="string">'Internet Explorer'</span><span class="keyword">;<br /><br />        </span><span class="comment">// Search Engines  <br />        </span><span class="keyword">elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'google'    </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] Googlebot'   </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'bing'      </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] Bingbot'     </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'slurp'     </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] Yahoo! Slurp'</span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'duckduckgo'</span><span class="keyword">)                           ) return </span><span class="string">'[Bot] DuckDuckBot' </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'baidu'     </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] Baidu'       </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'yandex'    </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] Yandex'      </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'sogou'     </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] Sogou'       </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'exabot'    </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] Exabot'      </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'msn'       </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] MSN'         </span><span class="keyword">;<br /><br />        </span><span class="comment">// Common Tools and Bots<br />        </span><span class="keyword">elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'mj12bot'   </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] Majestic'     </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'ahrefs'    </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] Ahrefs'       </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'semrush'   </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] SEMRush'      </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'rogerbot'  </span><span class="keyword">) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'dotbot'</span><span class="keyword">)   ) return </span><span class="string">'[Bot] Moz or OpenSiteExplorer'</span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'frog'      </span><span class="keyword">) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'screaming'</span><span class="keyword">)) return </span><span class="string">'[Bot] Screaming Frog'</span><span class="keyword">;<br />        <br />        </span><span class="comment">// Miscellaneous <br />        </span><span class="keyword">elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'facebook'  </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] Facebook'     </span><span class="keyword">;<br />        elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'pinterest' </span><span class="keyword">)                           ) return </span><span class="string">'[Bot] Pinterest'    </span><span class="keyword">;<br />        <br />        </span><span class="comment">// Check for strings commonly used in bot user agents   <br />        </span><span class="keyword">elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'crawler' </span><span class="keyword">) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'api'    </span><span class="keyword">) ||<br />                </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'spider'  </span><span class="keyword">) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'http'   </span><span class="keyword">) ||<br />                </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'bot'     </span><span class="keyword">) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'archive'</span><span class="keyword">) || <br />                </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'info'    </span><span class="keyword">) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="string">'data'   </span><span class="keyword">)    ) return </span><span class="string">'[Bot] Other'   </span><span class="keyword">;<br />        <br />        return </span><span class="string">'Other (Unknown)'</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span>Post with more depth here:<br /><a href="https://www.256kilobytes.com/content/show/1922/how-to-parse-a-user-agent-in-php-with-minimal-effort" rel="nofollow" target="_blank">https://www.256kilobytes.com/content/show/1922/how-to-parse-a-user-agent-in-php-with-minimal-effort</a></span></code></div>
  </div>
 </div>
  <div class="note" id="120489">  <div class="votes">
    <div id="Vu120489">
    <a href="/manual/vote-note.php?id=120489&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120489">
    <a href="/manual/vote-note.php?id=120489&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120489" title="66% like this...">
    16
    </div>
  </div>
  <a href="#120489" class="name">
  <strong class="user"><em>The Digital Orchard</em></strong></a><a class="genanchor" href="#120489"> &para;</a><div class="date" title="2017-01-20 09:39"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120489">
<div class="phpcode"><code><span class="html">Good news! The latest version of PHP has a performance fix for this function. It's reportedly now 100x faster. See the ChangeLog for specifics.</span></code></div>
  </div>
 </div>
  <div class="note" id="126797">  <div class="votes">
    <div id="Vu126797">
    <a href="/manual/vote-note.php?id=126797&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126797">
    <a href="/manual/vote-note.php?id=126797&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126797" title="71% like this...">
    6
    </div>
  </div>
  <a href="#126797" class="name">
  <strong class="user"><em>tom at tgibbons dot com</em></strong></a><a class="genanchor" href="#126797"> &para;</a><div class="date" title="2022-01-24 02:01"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126797">
<div class="phpcode"><code><span class="html">PHP cron script to automatically update browscap.ini. It compares version numbers to determine if update is needed:<br /><br /><span class="default">&lt;?php<br />       $eol</span><span class="keyword">=</span><span class="string">"\r\n"</span><span class="keyword">;                           </span><span class="comment">//set end of line - cron<br /><br />       </span><span class="default">$fileurl </span><span class="keyword">= </span><span class="string">"<a href="https://browscap.org/stream?q=PHP_BrowsCapINI" rel="nofollow" target="_blank">https://browscap.org/stream?q=PHP_BrowsCapINI</a>"</span><span class="keyword">;<br />       </span><span class="default">$verurl </span><span class="keyword">= </span><span class="string">"<a href="https://browscap.org/version-number" rel="nofollow" target="_blank">https://browscap.org/version-number</a>"</span><span class="keyword">;<br />       </span><span class="default">$file </span><span class="keyword">= </span><span class="string">"/path/to/browscap.ini"</span><span class="keyword">;<br /><br />       </span><span class="comment">//Find current version<br />       </span><span class="default">$fp </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">, </span><span class="string">"r+"</span><span class="keyword">);<br />       while ((</span><span class="default">$line </span><span class="keyword">= </span><span class="default">stream_get_line</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">, </span><span class="default">1024 </span><span class="keyword">* </span><span class="default">1024</span><span class="keyword">, </span><span class="string">"\n"</span><span class="keyword">)) !== </span><span class="default">false</span><span class="keyword">) {<br />           if(</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$line</span><span class="keyword">,</span><span class="string">"Version="</span><span class="keyword">)===</span><span class="default">0</span><span class="keyword">) {<br />               list(</span><span class="default">$temp</span><span class="keyword">, </span><span class="default">$curver</span><span class="keyword">) = </span><span class="default">explode</span><span class="keyword">(</span><span class="string">"="</span><span class="keyword">,</span><span class="default">$line</span><span class="keyword">);<br />               break;<br />           }<br />       }<br />       </span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">);<br />       echo(</span><span class="string">"Current browscap.ini file version: " </span><span class="keyword">. </span><span class="default">$curver</span><span class="keyword">);<br />       </span><span class="comment">//Get browscap.org current version<br />       </span><span class="default">$newver </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">$verurl</span><span class="keyword">);<br />       echo(</span><span class="default">$eol </span><span class="keyword">. </span><span class="string">"New browscap.ini file version: " </span><span class="keyword">. </span><span class="default">$newver</span><span class="keyword">);<br />       </span><span class="comment">//Update if new version available<br />       </span><span class="keyword">if(</span><span class="default">$newver </span><span class="keyword">&gt; </span><span class="default">$curver</span><span class="keyword">) {<br />           if(</span><span class="default">file_put_contents</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">, </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">$fileurl</span><span class="keyword">))) {<br />               echo(</span><span class="default">$eol </span><span class="keyword">. </span><span class="string">"browscap.ini has been updated!"</span><span class="keyword">);<br />           }<br />           else {<br />               echo(</span><span class="default">$eol </span><span class="keyword">. </span><span class="string">"browscap.ini update failed!"</span><span class="keyword">);<br />           }<br />       }<br />       else {<br />           echo(</span><span class="default">$eol </span><span class="keyword">. </span><span class="string">"browscap.ini is up to date!"</span><span class="keyword">); <br />       }<br />       echo(</span><span class="default">$eol </span><span class="keyword">. </span><span class="string">"End of Cron job." </span><span class="keyword">. </span><span class="default">$eol</span><span class="string">");<br />?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="122670">  <div class="votes">
    <div id="Vu122670">
    <a href="/manual/vote-note.php?id=122670&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122670">
    <a href="/manual/vote-note.php?id=122670&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122670" title="71% like this...">
    6
    </div>
  </div>
  <a href="#122670" class="name">
  <strong class="user"><em>Jeff Williams</em></strong></a><a class="genanchor" href="#122670"> &para;</a><div class="date" title="2018-04-26 06:33"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122670">
<div class="phpcode"><code><span class="html">To automatically update your browscap.ini file on linux servers, you can use this simple shell script:<br /><br />wget -O /etc/browscap.ini "<a href="http://browscap.org/stream?q=Full_PHP_BrowsCapINI" rel="nofollow" target="_blank">http://browscap.org/stream?q=Full_PHP_BrowsCapINI</a>"<br />chmod 664 /etc/browscap.ini<br /><br />You can put it in the weekly cron job folder usually located in /etc/cron.weekly just don't forget to make the script executable (chmod 775 scriptname).</span></code></div>
  </div>
 </div>
  <div class="note" id="117481">  <div class="votes">
    <div id="Vu117481">
    <a href="/manual/vote-note.php?id=117481&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117481">
    <a href="/manual/vote-note.php?id=117481&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117481" title="62% like this...">
    7
    </div>
  </div>
  <a href="#117481" class="name">
  <strong class="user"><em>shashank</em></strong></a><a class="genanchor" href="#117481"> &para;</a><div class="date" title="2015-06-17 06:17"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117481">
<div class="phpcode"><code><span class="html">As ruudrp had given the code <a href="http://php.net/manual/en/function.get-browser.php#101125," rel="nofollow" target="_blank">http://php.net/manual/en/function.get-browser.php#101125,</a> I have added code for Internet Explorer 11<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">getBrowser</span><span class="keyword">() <br />{ <br />    </span><span class="default">$u_agent </span><span class="keyword">= </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'HTTP_USER_AGENT'</span><span class="keyword">]; <br />    </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Unknown'</span><span class="keyword">;<br />    </span><span class="default">$platform </span><span class="keyword">= </span><span class="string">'Unknown'</span><span class="keyword">;<br />    </span><span class="default">$version</span><span class="keyword">= </span><span class="string">""</span><span class="keyword">;<br /><br />    </span><span class="comment">//First get the platform?<br />    </span><span class="keyword">if (</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/linux/i'</span><span class="keyword">, </span><span class="default">$u_agent</span><span class="keyword">)) {<br />        </span><span class="default">$platform </span><span class="keyword">= </span><span class="string">'linux'</span><span class="keyword">;<br />    }<br />    elseif (</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/macintosh|mac os x/i'</span><span class="keyword">, </span><span class="default">$u_agent</span><span class="keyword">)) {<br />        </span><span class="default">$platform </span><span class="keyword">= </span><span class="string">'mac'</span><span class="keyword">;<br />    }<br />    elseif (</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/windows|win32/i'</span><span class="keyword">, </span><span class="default">$u_agent</span><span class="keyword">)) {<br />        </span><span class="default">$platform </span><span class="keyword">= </span><span class="string">'windows'</span><span class="keyword">;<br />    }<br /><br />    </span><span class="comment">// Next get the name of the useragent yes seperately and for good reason<br />    </span><span class="keyword">if(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/MSIE/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">) &amp;&amp; !</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Opera/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { <br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Internet Explorer'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"MSIE"</span><span class="keyword">; <br />    } <br />    elseif(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Trident/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { </span><span class="comment">// this condition is for IE11<br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Internet Explorer'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"rv"</span><span class="keyword">; <br />    } <br />    elseif(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Firefox/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { <br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Mozilla Firefox'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"Firefox"</span><span class="keyword">; <br />    } <br />    elseif(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Chrome/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { <br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Google Chrome'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"Chrome"</span><span class="keyword">; <br />    } <br />    elseif(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Safari/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { <br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Apple Safari'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"Safari"</span><span class="keyword">; <br />    } <br />    elseif(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Opera/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { <br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Opera'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"Opera"</span><span class="keyword">; <br />    } <br />    elseif(</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/Netscape/i'</span><span class="keyword">,</span><span class="default">$u_agent</span><span class="keyword">)) <br />    { <br />        </span><span class="default">$bname </span><span class="keyword">= </span><span class="string">'Netscape'</span><span class="keyword">; <br />        </span><span class="default">$ub </span><span class="keyword">= </span><span class="string">"Netscape"</span><span class="keyword">; <br />    } <br />    <br />    </span><span class="comment">// finally get the correct version number<br />    // Added "|:"<br />    </span><span class="default">$known </span><span class="keyword">= array(</span><span class="string">'Version'</span><span class="keyword">, </span><span class="default">$ub</span><span class="keyword">, </span><span class="string">'other'</span><span class="keyword">);<br />    </span><span class="default">$pattern </span><span class="keyword">= </span><span class="string">'#(?&lt;browser&gt;' </span><span class="keyword">. </span><span class="default">join</span><span class="keyword">(</span><span class="string">'|'</span><span class="keyword">, </span><span class="default">$known</span><span class="keyword">) .<br />     </span><span class="string">')[/|: ]+(?&lt;version&gt;[0-9.|a-zA-Z.]*)#'</span><span class="keyword">;<br />    if (!</span><span class="default">preg_match_all</span><span class="keyword">(</span><span class="default">$pattern</span><span class="keyword">, </span><span class="default">$u_agent</span><span class="keyword">, </span><span class="default">$matches</span><span class="keyword">)) {<br />        </span><span class="comment">// we have no matching number just continue<br />    </span><span class="keyword">}<br /><br />    </span><span class="comment">// see how many we have<br />    </span><span class="default">$i </span><span class="keyword">= </span><span class="default">count</span><span class="keyword">(</span><span class="default">$matches</span><span class="keyword">[</span><span class="string">'browser'</span><span class="keyword">]);<br />    if (</span><span class="default">$i </span><span class="keyword">!= </span><span class="default">1</span><span class="keyword">) {<br />        </span><span class="comment">//we will have two since we are not using 'other' argument yet<br />        //see if version is before or after the name<br />        </span><span class="keyword">if (</span><span class="default">strripos</span><span class="keyword">(</span><span class="default">$u_agent</span><span class="keyword">,</span><span class="string">"Version"</span><span class="keyword">) &lt; </span><span class="default">strripos</span><span class="keyword">(</span><span class="default">$u_agent</span><span class="keyword">,</span><span class="default">$ub</span><span class="keyword">)){<br />            </span><span class="default">$version</span><span class="keyword">= </span><span class="default">$matches</span><span class="keyword">[</span><span class="string">'version'</span><span class="keyword">][</span><span class="default">0</span><span class="keyword">];<br />        }<br />        else {<br />            </span><span class="default">$version</span><span class="keyword">= </span><span class="default">$matches</span><span class="keyword">[</span><span class="string">'version'</span><span class="keyword">][</span><span class="default">1</span><span class="keyword">];<br />        }<br />    }<br />    else {<br />        </span><span class="default">$version</span><span class="keyword">= </span><span class="default">$matches</span><span class="keyword">[</span><span class="string">'version'</span><span class="keyword">][</span><span class="default">0</span><span class="keyword">];<br />    }<br /><br />    </span><span class="comment">// check if we have a number<br />    </span><span class="keyword">if (</span><span class="default">$version</span><span class="keyword">==</span><span class="default">null </span><span class="keyword">|| </span><span class="default">$version</span><span class="keyword">==</span><span class="string">""</span><span class="keyword">) {</span><span class="default">$version</span><span class="keyword">=</span><span class="string">"?"</span><span class="keyword">;}<br /><br />    return array(<br />        </span><span class="string">'userAgent' </span><span class="keyword">=&gt; </span><span class="default">$u_agent</span><span class="keyword">,<br />        </span><span class="string">'name'      </span><span class="keyword">=&gt; </span><span class="default">$bname</span><span class="keyword">,<br />        </span><span class="string">'version'   </span><span class="keyword">=&gt; </span><span class="default">$version</span><span class="keyword">,<br />        </span><span class="string">'platform'  </span><span class="keyword">=&gt; </span><span class="default">$platform</span><span class="keyword">,<br />        </span><span class="string">'pattern'    </span><span class="keyword">=&gt; </span><span class="default">$pattern<br />    </span><span class="keyword">);<br />} <br /><br /></span><span class="comment">// now try it<br /></span><span class="default">$ua</span><span class="keyword">=</span><span class="default">getBrowser</span><span class="keyword">();<br /></span><span class="default">$yourbrowser</span><span class="keyword">= </span><span class="string">"Your browser: " </span><span class="keyword">. </span><span class="default">$ua</span><span class="keyword">[</span><span class="string">'name'</span><span class="keyword">] . </span><span class="string">" " </span><span class="keyword">. </span><span class="default">$ua</span><span class="keyword">[</span><span class="string">'version'</span><span class="keyword">] . </span><span class="string">" on " </span><span class="keyword">.</span><span class="default">$ua</span><span class="keyword">[</span><span class="string">'platform'</span><span class="keyword">] . </span><span class="string">" reports: &lt;br &gt;" </span><span class="keyword">. </span><span class="default">$ua</span><span class="keyword">[</span><span class="string">'userAgent'</span><span class="keyword">];<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$yourbrowser</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="115073">  <div class="votes">
    <div id="Vu115073">
    <a href="/manual/vote-note.php?id=115073&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115073">
    <a href="/manual/vote-note.php?id=115073&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115073" title="60% like this...">
    9
    </div>
  </div>
  <a href="#115073" class="name">
  <strong class="user"><em>tim at digicol dot de</em></strong></a><a class="genanchor" href="#115073"> &para;</a><div class="date" title="2014-05-22 01:01"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115073">
<div class="phpcode"><code><span class="html">Be aware that loading php_browscap.ini via the browscap php.ini setting may consume a non-trivial amount of memory. Current versions are several MB in size (even the “lite” one) and can eat tens of MB of RAM in each PHP process. This happens even if you never call get_browser() since php_browscap.ini is loaded when PHP is starting up.<br /><br />Make sure to leave the browscap php.ini setting empty if you don’t use get_browser() – maybe you only call it only from PHP Web pages, but not from PHP CLI code.<br /><br />I’d recommend comparing your processes’ memory consumption with and without php_browscap.ini being loaded. If necesseray, consider creating your own stripped-down copy of php_browscap.ini with just the browsers that are important to you.</span></code></div>
  </div>
 </div>
  <div class="note" id="104848">  <div class="votes">
    <div id="Vu104848">
    <a href="/manual/vote-note.php?id=104848&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104848">
    <a href="/manual/vote-note.php?id=104848&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104848" title="60% like this...">
    6
    </div>
  </div>
  <a href="#104848" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#104848"> &para;</a><div class="date" title="2011-07-11 06:52"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104848">
<div class="phpcode"><code><span class="html">For those of you using this function to target MSIE, a better idea maybe to use MSIE specific conditional comments. More info: &lt;<a href="http://msdn.microsoft.com/en-us/library/ms537512%28VS.85%29.aspx&gt;." rel="nofollow" target="_blank">http://msdn.microsoft.com/en-us/library/ms537512%28VS.85%29.aspx&gt;.</a> 
<br />
<br />For example to indicate your disregard for users of MSIE 6 or earlier:
<br />
<br />&lt;!--[if lt IE 7]&gt;It appears that you are using a &lt;em&gt;very&lt;/em&gt; old version of MS Internet Explorer (MSIE). If you seriously want to continue to use MSIE, at least &lt;a href="<a href="http://www.microsoft.com/windows/internet-explorer/" rel="nofollow" target="_blank">http://www.microsoft.com/windows/internet-explorer/</a>"&gt;upgrade&lt;/a&gt;.&lt;![endif]--&gt;</span></code></div>
  </div>
 </div>
  <div class="note" id="76614">  <div class="votes">
    <div id="Vu76614">
    <a href="/manual/vote-note.php?id=76614&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd76614">
    <a href="/manual/vote-note.php?id=76614&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V76614" title="57% like this...">
    2
    </div>
  </div>
  <a href="#76614" class="name">
  <strong class="user"><em>mike at mike-griffiths dot co dot uk</em></strong></a><a class="genanchor" href="#76614"> &para;</a><div class="date" title="2007-07-23 02:41"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom76614">
<div class="phpcode"><code><span class="html">You should not rely on just this for cross-browser compatibility issues.  Good practice would be to include HTML if-statements for IE stylesheets as well as dynamically checking the browser type.</span></code></div>
  </div>
 </div>
  <div class="note" id="41008">  <div class="votes">
    <div id="Vu41008">
    <a href="/manual/vote-note.php?id=41008&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd41008">
    <a href="/manual/vote-note.php?id=41008&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V41008" title="54% like this...">
    2
    </div>
  </div>
  <a href="#41008" class="name">
  <strong class="user"><em>max at phpexpert dot de</em></strong></a><a class="genanchor" href="#41008"> &para;</a><div class="date" title="2004-03-26 07:14"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom41008">
<div class="phpcode"><code><span class="html">Be aware of the fact that this function shows what a specific browser might be able to show, but NOT what the user has turned on/off.<br /><br />So maybe this function tells you that the browser is abel to to javascript even when javascript is turned off by the user.</span></code></div>
  </div>
 </div>
  <div class="note" id="129693">  <div class="votes">
    <div id="Vu129693">
    <a href="/manual/vote-note.php?id=129693&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129693">
    <a href="/manual/vote-note.php?id=129693&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129693" title="no votes...">
    0
    </div>
  </div>
  <a href="#129693" class="name">
  <strong class="user"><em>Paxtez@example</em></strong></a><a class="genanchor" href="#129693"> &para;</a><div class="date" title="2024-08-08 02:57"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129693">
<div class="phpcode"><code><span class="html">Be careful about using homegrown versions of these.<br /><br />For example Francesco R's highly rated [ <a href="https://www.php.net/manual/en/function.get-browser.php#119332" rel="nofollow" target="_blank">https://www.php.net/manual/en/function.get-browser.php#119332</a> ] version is no longer correct with Edge:<br /><br />Current Edge is reporting a string similar to:<br />Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Safari/537.36 Edg/127.0.0.0<br /><br />Note the "Edg/xxx" instead of "Edge"<br /><br />While it is trivial to update his code to:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">get_browser_name</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">)<br />{<br />    if (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'Opera'</span><span class="keyword">) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'OPR/'</span><span class="keyword">)) return </span><span class="string">'Opera'</span><span class="keyword">;<br />    elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'Edg'</span><span class="keyword">)) return </span><span class="string">'Edge'</span><span class="keyword">;<br />    elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'Chrome'</span><span class="keyword">)) return </span><span class="string">'Chrome'</span><span class="keyword">;<br />    elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'Safari'</span><span class="keyword">)) return </span><span class="string">'Safari'</span><span class="keyword">;<br />    elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'Firefox'</span><span class="keyword">)) return </span><span class="string">'Firefox'</span><span class="keyword">;<br />    elseif (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'MSIE'</span><span class="keyword">) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$user_agent</span><span class="keyword">, </span><span class="string">'Trident/7'</span><span class="keyword">)) return </span><span class="string">'Internet Explorer'</span><span class="keyword">;<br />    return </span><span class="string">'Other'</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />You never know when a value might change in the future.</span></code></div>
  </div>
 </div>
  <div class="note" id="118503">  <div class="votes">
    <div id="Vu118503">
    <a href="/manual/vote-note.php?id=118503&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118503">
    <a href="/manual/vote-note.php?id=118503&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118503" title="50% like this...">
    0
    </div>
  </div>
  <a href="#118503" class="name">
  <strong class="user"><em>jeremie dot legrand at komori-chambon dot fr</em></strong></a><a class="genanchor" href="#118503"> &para;</a><div class="date" title="2015-12-16 04:28"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118503">
<div class="phpcode"><code><span class="html">Be careful if you use the "Full" Browscap INI file in your php.ini config: I wondered why each Apache thread took 350MB RAM on my server until I changed the "Full" version by the "Lite" one (45MB to 0.7MB)<br /><br />Now, each thread takes only 16MB...<br />So if it is enough for you, use the Lite version!</span></code></div>
  </div>
 </div>
  <div class="note" id="119858">  <div class="votes">
    <div id="Vu119858">
    <a href="/manual/vote-note.php?id=119858&amp;page=function.get-browser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119858">
    <a href="/manual/vote-note.php?id=119858&amp;page=function.get-browser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119858" title="46% like this...">
    -2
    </div>
  </div>
  <a href="#119858" class="name">
  <strong class="user"><em>zed</em></strong></a><a class="genanchor" href="#119858"> &para;</a><div class="date" title="2016-09-07 10:20"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119858">
<div class="phpcode"><code><span class="html">To complete Francesco R, I added the version of the navigator :<br /><br />function getNavigateur($user_agent)<br />    {<br /><br />        if(empty($user_agent)) {<br />            return array('nav' =&gt; 'NC', 'name' =&gt; 'NC', 'version' =&gt; 'NC');<br />        }<br /><br />        $content_nav['name'] = 'Unknown';<br /><br />        if (strpos($user_agent, 'Opera') || strpos($user_agent, 'OPR/')) {<br /><br />            $content_nav['name'] = 'Opera';<br /><br />            if (strpos($user_agent, 'OPR/')) {<br />                $content_nav['reel_name'] = 'OPR/';<br />            } else {<br />                $content_nav['reel_name'] = 'Opera';<br />            }<br /><br />        }<br />        elseif (strpos($user_agent, 'Edge')) {<br />            $content_nav['name'] = $content_nav['reel_name'] = 'Edge';<br />        }<br />        elseif (strpos($user_agent, 'Chrome')) $content_nav['name'] = $content_nav['reel_name'] = 'Chrome';<br />        elseif (strpos($user_agent, 'Safari')) $content_nav['name'] = $content_nav['reel_name'] = 'Safari';<br />        elseif (strpos($user_agent, 'Firefox')) $content_nav['name'] = $content_nav['reel_name'] = 'Firefox';<br />        elseif (strpos($user_agent, 'MSIE') || strpos($user_agent, 'Trident/7') || strpos($user_agent, 'Trident/7.0; rv:')) {<br />            $content_nav['name'] = 'Internet Explorer';<br /><br />            if (strpos($user_agent, 'Trident/7.0; rv:')) {<br />                $content_nav['reel_name'] = 'Trident/7.0; rv:';<br />            } elseif (strpos($user_agent, 'Trident/7')) {<br />                $content_nav['reel_name'] = 'Trident/7';<br />            } else {<br />                $content_nav['reel_name'] = 'Opera';<br />            }<br /><br />        }<br /><br />        $pattern = '#' . $content_nav['reel_name'] . '\/*([0-9\.]*)#';<br /><br />        $matches = array();<br /><br />        if(preg_match($pattern, $user_agent, $matches)) {<br /><br />            $content_nav['version'] = $matches[1];<br />            return $content_nav;<br /><br />        }<br /><br />        return array('name' =&gt; $content_nav['name'], 'version' =&gt; 'Inconnu');<br />    }</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.get-browser&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-browser.php">＋<small>add a note</small></a></div>
