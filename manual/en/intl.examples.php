...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intl.examples.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intl.examples.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intl.examples.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.intl.php">
 <link rel="prev" href="https://www.php.net/manual/en/intl.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/intl.examples.basic.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intl.examples.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intl.examples.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intl.examples.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intl.examples.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intl.examples.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intl.examples.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intl.examples.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intl.examples.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intl.examples.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intl.examples.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intl.examples.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intl.examples.basic.php">
          Basic usage of this extension &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intl.examples.php' selected="selected">English</option>
            <option value='de/intl.examples.php'>German</option>
            <option value='es/intl.examples.php'>Spanish</option>
            <option value='fr/intl.examples.php'>French</option>
            <option value='it/intl.examples.php'>Italian</option>
            <option value='ja/intl.examples.php'>Japanese</option>
            <option value='pt_BR/intl.examples.php'>Brazilian Portuguese</option>
            <option value='ru/intl.examples.php'>Russian</option>
            <option value='tr/intl.examples.php'>Turkish</option>
            <option value='uk/intl.examples.php'>Ukrainian</option>
            <option value='zh/intl.examples.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intl.examples" class="chapter">
 <h1 class="title">Examples</h1>
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="intl.examples.basic.php">Basic usage of this extension</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintl.examples%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intl.examples&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intl.examples.php">＋<small>add a note</small></a></span>
