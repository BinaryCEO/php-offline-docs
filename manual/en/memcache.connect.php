...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcache.connect.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcache.connect.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcache.connect.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcache.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcache.close.php">
 <link rel="next" href="https://www.php.net/manual/en/memcache.decrement.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/ru/memcache.connect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcache.connect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcache.connect.php" hreflang="uk">
...
<meta name="Description" content="Open memcached server connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcache::connect - Manual" />
<meta name="twitter:description" content="Open memcached server connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcache::connect - Manual" />
<meta itemprop="description" content="Open memcached server connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open memcached server connection" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcache.connect.php' selected="selected">English</option>
            ...
            <option value='ru/memcache.connect.php'>Russian</option>
            <option value='tr/memcache.connect.php'>Turkish</option>
            <option value='uk/memcache.connect.php'>Ukrainian</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="memcache.close.php" class="function" rel="rdfs-seeAlso">Memcache::close()</a> - Close memcached server connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcache/memcache/connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcache.connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcache.connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcache.connect.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="99461">  <div class="votes">
    <div id="Vu99461">
    <a href="/manual/vote-note.php?id=99461&amp;page=memcache.connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd99461">
    <a href="/manual/vote-note.php?id=99461&amp;page=memcache.connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V99461" title="54% like this...">
    11
    </div>
  </div>
  <a href="#99461" class="name">
  <strong class="user"><em>geoffrey dot hoffman at gmail dot com</em></strong></a><a class="genanchor" href="#99461"> &para;</a><div class="date" title="2010-08-18 12:32"><strong>15 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">If memcached is working, calling memcache_connect( ) returns an Object instance, not a boolean. If memcached is not working, calling memcache_connect( ) throws a notice AND a warning (and returns false as expected). <br /><br /><span class="default">&lt;?php<br /></span><span class="comment">/* memcache is running */<br /></span><span class="default">$test1 </span><span class="keyword">= </span><span class="default">memcache_connect</span><span class="keyword">(</span><span class="string">'127.0.0.1'</span><span class="keyword">,</span><span class="default">11211</span><span class="keyword">);<br />echo </span><span class="default">gettype</span><span class="keyword">(</span><span class="default">$test1</span><span class="keyword">);<br /></span><span class="comment">// object<br /></span><span class="keyword">echo </span><span class="default">get_class</span><span class="keyword">(</span><span class="default">$test1</span><span class="keyword">);<br /></span><span class="comment">// Memcache<br /><br />/* memcached is stopped */<br /></span><span class="default">$test2 </span><span class="keyword">= </span><span class="default">memcache_connect</span><span class="keyword">(</span><span class="string">'127.0.0.1'</span><span class="keyword">,</span><span class="default">11211</span><span class="keyword">);<br /><br /></span><span class="comment">/*<br />Notice: memcache_connect(): Server 127.0.0.1 (tcp 11211) failed with: A connection attempt failed because the connected party did not properly respond after a period of time, or established connection failed because connected host has failed to respond.<br /> (10060) in C:\Program Files\Support Tools\- on line 1<br /><br />Warning: memcache_connect(): Can't connect to 127.0.0.1:11211, A connection attempt failed because the connected party did not properly respond after a period of time, or established connection failed because connected host has failed to respond.<br /> (10060) in C:\Program Files\Support Tools\- on line 1<br />*/<br /><br /></span><span class="keyword">echo </span><span class="default">gettype</span><span class="keyword">(</span><span class="default">$test2</span><span class="keyword">);<br /></span><span class="comment">// boolean<br /></span><span class="keyword">echo </span><span class="default">$test2</span><span class="keyword">===</span><span class="default">false</span><span class="keyword">;<br /></span><span class="comment">// 1<br /></span><span class="default">?&gt;<br /></span><br />There appears to be no way to check whether memcached is actually running without resorting to error suppression:<br /><br /><span class="default">&lt;?php<br />$test3 </span><span class="keyword">= @</span><span class="default">memcache_connect</span><span class="keyword">(</span><span class="string">'127.0.0.1'</span><span class="keyword">,</span><span class="default">11211</span><span class="keyword">);<br />if( </span><span class="default">$test3</span><span class="keyword">===</span><span class="default">false </span><span class="keyword">){<br />   </span><span class="comment">// memcached is _probably_ not running<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="114989">  <div class="votes">
    <div id="Vu114989">
    <a href="/manual/vote-note.php?id=114989&amp;page=memcache.connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114989">
    <a href="/manual/vote-note.php?id=114989&amp;page=memcache.connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114989" title="47% like this...">
    -5
    </div>
  </div>
  <a href="#114989" class="name">
  <strong class="user"><em>webysther at gmail dot com</em></strong></a><a class="genanchor" href="#114989"> &para;</a><div class="date" title="2014-05-10 04:28"><strong>11 years ago</strong></div>
...
<div class="foot"><a href="/manual/add-note.php?sect=memcache.connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcache.connect.php">＋<small>add a note</small></a></div>
