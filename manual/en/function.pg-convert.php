...
<head>
  ...
  <title>PHP: pg_convert - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-convert.php">
 <link rel="shorturl" href="https://www.php.net/pg-convert">
 <link rel="alternate" href="https://www.php.net/pg-convert" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-consume-input.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-copy-from.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-convert.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-convert.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-convert.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-convert.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-convert.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-convert.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-convert.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-convert.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-convert.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-convert.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-convert.php" hreflang="zh">
...
<meta name="Description" content="Convert associative array values into forms suitable for SQL statements" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_convert - Manual" />
<meta name="twitter:description" content="Convert associative array values into forms suitable for SQL statements" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_convert - Manual" />
<meta itemprop="description" content="Convert associative array values into forms suitable for SQL statements" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Convert associative array values into forms suitable for SQL statements" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-copy-from.php">
          pg_copy_from &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-consume-input.php">
          &laquo; pg_consume_input        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-convert.php' selected="selected">English</option>
            <option value='de/function.pg-convert.php'>German</option>
            <option value='es/function.pg-convert.php'>Spanish</option>
            <option value='fr/function.pg-convert.php'>French</option>
            <option value='it/function.pg-convert.php'>Italian</option>
            <option value='ja/function.pg-convert.php'>Japanese</option>
            <option value='pt_BR/function.pg-convert.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-convert.php'>Russian</option>
            <option value='tr/function.pg-convert.php'>Turkish</option>
            <option value='uk/function.pg-convert.php'>Ukrainian</option>
            <option value='zh/function.pg-convert.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-convert" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-delete.php" class="function" rel="rdfs-seeAlso">pg_delete()</a> - Deletes records</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-convert.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-convert%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-convert&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-convert.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">5 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="41136">  <div class="votes">
    <div id="Vu41136">
    <a href="/manual/vote-note.php?id=41136&amp;page=function.pg-convert&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd41136">
    <a href="/manual/vote-note.php?id=41136&amp;page=function.pg-convert&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V41136" title="75% like this...">
    2
    </div>
  </div>
  <a href="#41136" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#41136"> &para;</a><div class="date" title="2004-03-31 08:02"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom41136">
<div class="phpcode"><code><span class="html">The only options that I see are:<br /><br />PGSQL_CONV_IGNORE_DEFAULT  - Do not use DEAFULT value by removing field from returned array<br />PGSQL_CONV_FORCE_NULL - Convert to NULL if string is null string<br />PGSQL_CONV_IGNORE_NOT_NULL  - Ignore NOT NULL constraints<br /><br />These are constants, so don't quote them or anything.</span></code></div>
  </div>
 </div>
  <div class="note" id="115877">  <div class="votes">
    <div id="Vu115877">
    <a href="/manual/vote-note.php?id=115877&amp;page=function.pg-convert&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115877">
    <a href="/manual/vote-note.php?id=115877&amp;page=function.pg-convert&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115877" title="50% like this...">
    0
    </div>
  </div>
  <a href="#115877" class="name">
  <strong class="user"><em>gorhas at gmail dot com</em></strong></a><a class="genanchor" href="#115877"> &para;</a><div class="date" title="2014-10-07 08:41"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom115877">
<div class="phpcode"><code><span class="html">There is a problem when using interval.<br />If in the array <br />"time_pause" =&gt; '00:30:00'<br />and time_pause is an interval<br />the insert fails<br />pg_insert(): '00:30:00' does not match with  '^(@?[ \t]+)?((([-+]?[ \t]+)?[0-9]+(\.[0-9]*)?[ ...</span></code></div>
  </div>
 </div>
  <div class="note" id="31993">  <div class="votes">
    <div id="Vu31993">
    <a href="/manual/vote-note.php?id=31993&amp;page=function.pg-convert&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd31993">
    <a href="/manual/vote-note.php?id=31993&amp;page=function.pg-convert&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V31993" title="50% like this...">
    0
    </div>
  </div>
  <a href="#31993" class="name">
  <strong class="user"><em>dharana at dharana dot net</em></strong></a><a class="genanchor" href="#31993"> &para;</a><div class="date" title="2003-05-12 06:28"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom31993">
<div class="phpcode"><code><span class="html">I've found "options" possible values:<br /><br />PG_CONV_CHECK - check only<br />PG_CONV_STRICT - raise warning for non fatal error<br />PG_CONV_QUOTE - add quote around values for vchar, text datetime.<br />PG_CONV_SLASH - add slashes if it needed.<br />PG_CONV_NULLCHK - check values are defined for NOT NULL fields.<br />PG_CONV_NO_DEFAULT - ignore default value even if value is empty string.</span></code></div>
  </div>
 </div>
  <div class="note" id="122539">  <div class="votes">
    <div id="Vu122539">
    <a href="/manual/vote-note.php?id=122539&amp;page=function.pg-convert&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122539">
    <a href="/manual/vote-note.php?id=122539&amp;page=function.pg-convert&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122539" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#122539" class="name">
  <strong class="user"><em>VLroyrenn</em></strong></a><a class="genanchor" href="#122539"> &para;</a><div class="date" title="2018-03-23 03:57"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122539">
<div class="phpcode"><code><span class="html">Another thing that's not well documented is that (as of PHP 7.0/7.1) pg_convert doesn't like non-scalar types and will fail (but not throw just emit an E_WARNING and return false) if you pass it anything other than a string or a number, including an array or something like a DateTime. If you want to insert those types, you actually have to convert those yourself.<br /><br />Also, somewhat surprisingly, $table_name is not compatible with the output of pg_​escape_​identifier, or seemingly any other kind of escaping.</span></code></div>
  </div>
 </div>
  <div class="note" id="121383">  <div class="votes">
    <div id="Vu121383">
    <a href="/manual/vote-note.php?id=121383&amp;page=function.pg-convert&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121383">
    <a href="/manual/vote-note.php?id=121383&amp;page=function.pg-convert&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121383" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#121383" class="name">
  <strong class="user"><em>Hayley Watson</em></strong></a><a class="genanchor" href="#121383"> &para;</a><div class="date" title="2017-07-16 02:13"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121383">
<div class="phpcode"><code><span class="html">This will only apply the appropriate escaping and such appropriate for embedding the PHP value into an SQL statement.<br /><br />It does (by default) check for nulls when the column is marked NOT NULL, and it will complain about trying to convert strings for an integer column (floats will be truncated).<br /><br />Beyond the barest checking of syntax, however, it does NOT verify that the given value is a legitimate value for the column type.<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Assuming smallints.smallintis a smallint (-32768..32767) type column<br /></span><span class="keyword">foreach([-</span><span class="default">1234</span><span class="keyword">,<br />    </span><span class="default">1234</span><span class="keyword">,<br />    </span><span class="default">0</span><span class="keyword">,<br />    </span><span class="default">32767</span><span class="keyword">,<br />    -</span><span class="default">32768</span><span class="keyword">,<br />    </span><span class="default">32768</span><span class="keyword">,  </span><span class="comment">// bogus value for smallint type<br />    </span><span class="default">45.8</span><span class="keyword">,   </span><span class="comment">// gets truncated to 45<br />    </span><span class="default">400000</span><span class="keyword">, </span><span class="comment">// bogus value for smallint type<br />    </span><span class="keyword">] as </span><span class="default">$smallint</span><span class="keyword">)<br />{<br />    </span><span class="default">$tmp </span><span class="keyword">= [</span><span class="string">'smallint' </span><span class="keyword">=&gt; </span><span class="default">$smallint</span><span class="keyword">];<br />    </span><span class="default">$vals </span><span class="keyword">= </span><span class="default">pg_convert</span><span class="keyword">(</span><span class="default">$dbconn</span><span class="keyword">, </span><span class="string">'smallints'</span><span class="keyword">, [</span><span class="string">'smallint' </span><span class="keyword">=&gt; </span><span class="default">$smallint</span><span class="keyword">]);<br />    echo </span><span class="default">$vals</span><span class="keyword">[</span><span class="string">'"smallint"'</span><span class="keyword">],</span><span class="string">"\n"</span><span class="keyword">;  </span><span class="comment">// Notice the column name is also made SQL-safe<br /></span><span class="keyword">}<br /><br /></span><span class="comment">// Assuming uuids.uuid is a UUID type column<br /></span><span class="keyword">foreach([</span><span class="string">'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11'</span><span class="keyword">,<br />    </span><span class="string">'A0EEBC99-9C0B-4EF8-BB6D-6BB9BD380A11'</span><span class="keyword">,<br />    </span><span class="string">'a0eebc999c0b4ef8bb6d6bb9bd380a11'</span><span class="keyword">,<br />    </span><span class="string">'{a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11}'</span><span class="keyword">,<br />    </span><span class="string">'Invalid Not-a-UUID'</span><span class="keyword">,<br />    </span><span class="string">'{a0eebc99-9c0b4ef8-bb6d6bb9-bd380a11}'</span><span class="keyword">,<br />    </span><span class="string">'a0ee-bc99-9c0b-4ef8-bb6d-6bb9-bd38-0a11'</span><span class="keyword">,<br />    ] as </span><span class="default">$uuid</span><span class="keyword">)<br />{<br />    </span><span class="default">$tmp </span><span class="keyword">= [</span><span class="string">'uuid' </span><span class="keyword">=&gt; </span><span class="default">$uuid</span><span class="keyword">];<br />    </span><span class="default">$vals </span><span class="keyword">= </span><span class="default">pg_convert</span><span class="keyword">(</span><span class="default">$dbconn</span><span class="keyword">, </span><span class="string">'uuids'</span><span class="keyword">, [</span><span class="string">'uuid' </span><span class="keyword">=&gt; </span><span class="default">$uuid</span><span class="keyword">]);<br />    echo </span><span class="default">$vals</span><span class="keyword">[</span><span class="string">'"uuid"'</span><span class="keyword">],</span><span class="string">"\n"</span><span class="keyword">;<br />}<br /><br /></span><span class="default">?&gt;<br /></span><br />All of the above data values will be "converted" - even the invalid ones - without complaint.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-convert&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-convert.php">＋<small>add a note</small></a></div>
