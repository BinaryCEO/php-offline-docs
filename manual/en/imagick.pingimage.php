...
<head>
  ...
  <title>PHP: Imagick::pingImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.pingimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.pingimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.pingimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.painttransparentimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.pingimageblob.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.pingimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.pingimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.pingimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.pingimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.pingimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.pingimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.pingimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.pingimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.pingimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.pingimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.pingimage.php" hreflang="zh">
...
<meta name="Description" content="Fetch basic attributes about the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::pingImage - Manual" />
<meta name="twitter:description" content="Fetch basic attributes about the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::pingImage - Manual" />
<meta itemprop="description" content="Fetch basic attributes about the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetch basic attributes about the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.pingimageblob.php">
          Imagick::pingImageBlob &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.painttransparentimage.php">
          &laquo; Imagick::paintTransparentImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.pingimage.php' selected="selected">English</option>
            <option value='de/imagick.pingimage.php'>German</option>
            <option value='es/imagick.pingimage.php'>Spanish</option>
            <option value='fr/imagick.pingimage.php'>French</option>
            <option value='it/imagick.pingimage.php'>Italian</option>
            <option value='ja/imagick.pingimage.php'>Japanese</option>
            <option value='pt_BR/imagick.pingimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.pingimage.php'>Russian</option>
            <option value='tr/imagick.pingimage.php'>Turkish</option>
            <option value='uk/imagick.pingimage.php'>Ukrainian</option>
            <option value='zh/imagick.pingimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.pingimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::pingImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::pingImage</span> &mdash; <span class="dc-title">Fetch basic attributes about the image</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.pingimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::pingImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/pingimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.pingimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.pingimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.pingimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="112876">  <div class="votes">
    <div id="Vu112876">
    <a href="/manual/vote-note.php?id=112876&amp;page=imagick.pingimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112876">
    <a href="/manual/vote-note.php?id=112876&amp;page=imagick.pingimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112876" title="80% like this...">
    3
    </div>
  </div>
  <a href="#112876" class="name">
  <strong class="user"><em>hello at digitalnature dot eu</em></strong></a><a class="genanchor" href="#112876"> &para;</a><div class="date" title="2013-07-31 11:41"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112876">
<div class="phpcode"><code><span class="html">Just a warning: don't use Eero Niemi's code (identifyImage with pingImage) if you just want to get the image width and height, because it will actually be slower than reading the whole image into memory - about 10x slower!<br /><br />Correct code should be:<br /><br /><span class="default">&lt;?php<br /><br />  $image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />  </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">pingImage</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">);<br />  </span><span class="default">$width </span><span class="keyword">= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getImageWidth</span><span class="keyword">();<br />  </span><span class="default">$height </span><span class="keyword">= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getImageHeight</span><span class="keyword">();<br /><br /></span><span class="default">?&gt;<br /></span><br />(this is around 15 times faster than reading the image in memory)</span></code></div>
  </div>
 </div>
  <div class="note" id="109898">  <div class="votes">
    <div id="Vu109898">
    <a href="/manual/vote-note.php?id=109898&amp;page=imagick.pingimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd109898">
    <a href="/manual/vote-note.php?id=109898&amp;page=imagick.pingimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V109898" title="60% like this...">
    1
    </div>
  </div>
  <a href="#109898" class="name">
  <strong class="user"><em>Sergey</em></strong></a><a class="genanchor" href="#109898"> &para;</a><div class="date" title="2012-09-01 03:06"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109898">
<div class="phpcode"><code><span class="html">If you don't sure whether the file exists or not or maybe it's broken, then you should use try - catch construction. It prevents code fails, when code stops execution after call of pingImage (if the file doesn't exist or it's broken).<br /><br /><span class="default">&lt;?php<br />$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />try {<br />    </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">pingImage</span><span class="keyword">(</span><span class="string">'3.jpg'</span><span class="keyword">);<br />}<br />catch(</span><span class="default">ImagickException $e</span><span class="keyword">) {<br />    echo </span><span class="string">"image doesn't exist"</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.pingimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.pingimage.php">＋<small>add a note</small></a></div>
