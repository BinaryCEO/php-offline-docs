...
<head>
  ...
  <title>PHP: sqlsrv_configure - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sqlsrv-configure.php">
 <link rel="shorturl" href="https://www.php.net/sqlsrv-configure">
 <link rel="alternate" href="https://www.php.net/sqlsrv-configure" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sqlsrv-commit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sqlsrv-connect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sqlsrv-configure.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sqlsrv-configure.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sqlsrv-configure.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sqlsrv-configure.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sqlsrv-configure.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sqlsrv-configure.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sqlsrv-configure.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sqlsrv-configure.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sqlsrv-configure.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sqlsrv-configure.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sqlsrv-configure.php" hreflang="zh">
...
<meta name="Description" content="Changes the driver error handling and logging configurations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sqlsrv_configure - Manual" />
<meta name="twitter:description" content="Changes the driver error handling and logging configurations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sqlsrv_configure - Manual" />
<meta itemprop="description" content="Changes the driver error handling and logging configurations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Changes the driver error handling and logging configurations" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sqlsrv-connect.php">
          sqlsrv_connect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sqlsrv-commit.php">
          &laquo; sqlsrv_commit        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sqlsrv-configure.php' selected="selected">English</option>
            <option value='de/function.sqlsrv-configure.php'>German</option>
            <option value='es/function.sqlsrv-configure.php'>Spanish</option>
            <option value='fr/function.sqlsrv-configure.php'>French</option>
            <option value='it/function.sqlsrv-configure.php'>Italian</option>
            <option value='ja/function.sqlsrv-configure.php'>Japanese</option>
            <option value='pt_BR/function.sqlsrv-configure.php'>Brazilian Portuguese</option>
            <option value='ru/function.sqlsrv-configure.php'>Russian</option>
            <option value='tr/function.sqlsrv-configure.php'>Turkish</option>
            <option value='uk/function.sqlsrv-configure.php'>Ukrainian</option>
            <option value='zh/function.sqlsrv-configure.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sqlsrv-configure" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="http://msdn.microsoft.com/en-us/library/cc296188.aspx" class="link external">&raquo;&nbsp;Logging SQLSRV Activity</a>.</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlsrv/functions/sqlsrv-configure.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sqlsrv-configure%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sqlsrv-configure&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-configure.php">＋<small>add a note</small></a></span>
