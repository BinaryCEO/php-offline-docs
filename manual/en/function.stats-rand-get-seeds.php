...
<head>
  ...
  <title>PHP: stats_rand_get_seeds - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-rand-get-seeds.php">
 <link rel="shorturl" href="https://www.php.net/stats-rand-get-seeds">
 <link rel="alternate" href="https://www.php.net/stats-rand-get-seeds" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-rand-gen-t.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-rand-phrase-to-seeds.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-rand-get-seeds.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-rand-get-seeds.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-rand-get-seeds.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-rand-get-seeds.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-rand-get-seeds.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-rand-get-seeds.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-rand-get-seeds.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-rand-get-seeds.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-rand-get-seeds.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-rand-get-seeds.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-rand-get-seeds.php" hreflang="zh">
...
<meta name="Description" content="Get the seed values of the random number generator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_rand_get_seeds - Manual" />
<meta name="twitter:description" content="Get the seed values of the random number generator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_rand_get_seeds - Manual" />
<meta itemprop="description" content="Get the seed values of the random number generator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the seed values of the random number generator" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stats-rand-phrase-to-seeds.php">
          stats_rand_phrase_to_seeds &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-rand-gen-t.php">
          &laquo; stats_rand_gen_t        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-rand-get-seeds.php' selected="selected">English</option>
            <option value='de/function.stats-rand-get-seeds.php'>German</option>
            <option value='es/function.stats-rand-get-seeds.php'>Spanish</option>
            <option value='fr/function.stats-rand-get-seeds.php'>French</option>
            <option value='it/function.stats-rand-get-seeds.php'>Italian</option>
            <option value='ja/function.stats-rand-get-seeds.php'>Japanese</option>
            <option value='pt_BR/function.stats-rand-get-seeds.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-rand-get-seeds.php'>Russian</option>
            <option value='tr/function.stats-rand-get-seeds.php'>Turkish</option>
            <option value='uk/function.stats-rand-get-seeds.php'>Ukrainian</option>
            <option value='zh/function.stats-rand-get-seeds.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-rand-get-seeds" class="refentry">
  ...
  <p class="para">
   Returns an array of two integers.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-rand-get-seeds.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-rand-get-seeds%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-rand-get-seeds&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-rand-get-seeds.php">＋<small>add a note</small></a></span>
