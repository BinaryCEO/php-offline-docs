...
<head>
  ...
  <title>PHP: http_get_last_response_headers - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.http-get-last-response-headers.php">
 <link rel="shorturl" href="https://www.php.net/http-get-last-response-headers">
 <link rel="alternate" href="https://www.php.net/http-get-last-response-headers" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.network.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.http-clear-last-response-headers.php">
 <link rel="next" href="https://www.php.net/manual/en/function.http-response-code.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.http-get-last-response-headers.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.http-get-last-response-headers.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.http-get-last-response-headers.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.http-get-last-response-headers.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.http-get-last-response-headers.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.http-get-last-response-headers.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.http-get-last-response-headers.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.http-get-last-response-headers.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.http-get-last-response-headers.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.http-get-last-response-headers.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.http-get-last-response-headers.php" hreflang="zh">
...
<meta name="Description" content="Retrieve last HTTP response headers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: http_get_last_response_headers - Manual" />
<meta name="twitter:description" content="Retrieve last HTTP response headers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: http_get_last_response_headers - Manual" />
<meta itemprop="description" content="Retrieve last HTTP response headers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve last HTTP response headers" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.http-response-code.php">
          http_response_code &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.http-clear-last-response-headers.php">
          &laquo; http_clear_last_response_headers        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.http-get-last-response-headers.php' selected="selected">English</option>
            <option value='de/function.http-get-last-response-headers.php'>German</option>
            <option value='es/function.http-get-last-response-headers.php'>Spanish</option>
            <option value='fr/function.http-get-last-response-headers.php'>French</option>
            <option value='it/function.http-get-last-response-headers.php'>Italian</option>
            <option value='ja/function.http-get-last-response-headers.php'>Japanese</option>
            <option value='pt_BR/function.http-get-last-response-headers.php'>Brazilian Portuguese</option>
            <option value='ru/function.http-get-last-response-headers.php'>Russian</option>
            <option value='tr/function.http-get-last-response-headers.php'>Turkish</option>
            <option value='uk/function.http-get-last-response-headers.php'>Ukrainian</option>
            <option value='zh/function.http-get-last-response-headers.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.http-get-last-response-headers" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.http-clear-last-response-headers.php" class="function" rel="rdfs-seeAlso">http_clear_last_response_headers()</a> - Clears the stored HTTP response headers</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/network/functions/http-get-last-response-headers.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.http-get-last-response-headers%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.http-get-last-response-headers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.http-get-last-response-headers.php">＋<small>add a note</small></a></span>
