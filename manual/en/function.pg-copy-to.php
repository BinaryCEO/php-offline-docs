...
<head>
  ...
  <title>PHP: pg_copy_to - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-copy-to.php">
 <link rel="shorturl" href="https://www.php.net/pg-copy-to">
 <link rel="alternate" href="https://www.php.net/pg-copy-to" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-copy-from.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-dbname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-copy-to.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-copy-to.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-copy-to.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-copy-to.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-copy-to.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-copy-to.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-copy-to.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-copy-to.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-copy-to.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-copy-to.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-copy-to.php" hreflang="zh">
...
<meta name="Description" content="Copy a table to an array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_copy_to - Manual" />
<meta name="twitter:description" content="Copy a table to an array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_copy_to - Manual" />
<meta itemprop="description" content="Copy a table to an array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Copy a table to an array" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-dbname.php">
          pg_dbname &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-copy-from.php">
          &laquo; pg_copy_from        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-copy-to.php' selected="selected">English</option>
            <option value='de/function.pg-copy-to.php'>German</option>
            <option value='es/function.pg-copy-to.php'>Spanish</option>
            <option value='fr/function.pg-copy-to.php'>French</option>
            <option value='it/function.pg-copy-to.php'>Italian</option>
            <option value='ja/function.pg-copy-to.php'>Japanese</option>
            <option value='pt_BR/function.pg-copy-to.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-copy-to.php'>Russian</option>
            <option value='tr/function.pg-copy-to.php'>Turkish</option>
            <option value='uk/function.pg-copy-to.php'>Ukrainian</option>
            <option value='zh/function.pg-copy-to.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-copy-to" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_copy_to</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_copy_to</span> &mdash; <span class="dc-title">
 ...
 <div class="refsect1 description" id="refsect1-function.pg-copy-to-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_copy_to</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$table_name</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$separator</code><span class="initializer"> = &quot;\t&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$null_as</code><span class="initializer"> = &quot;\\\\N&quot;</span></span><br>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-copy-to-returnvalues">
  <h3 class="title">Return Values</h3>
   <p class="para">
    An <span class="type"><a href="language.types.array.php" class="type array">array</a></span> with one element for each line of <code class="literal">COPY</code> data,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
   </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.pg-copy-to-changelog">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />   $db </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=publisher"</span><span style="color: #007700">) or die(</span><span style="color: #DD0000">"Could not connect"</span><span style="color: #007700">);<br />   <br />   </span><span style="color: #0000BB">$rows </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_copy_to</span><span style="color: #007700">(</span><span style="color: #0000BB">$db</span><span style="color: #007700">, </span><span style="color: #0000BB">$table_name</span><span style="color: #007700">);<br />   <br />   </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$db</span><span style="color: #007700">, </span><span style="color: #DD0000">"DELETE FROM </span><span style="color: #0000BB">$table_name</span><span style="color: #DD0000">"</span><span style="color: #007700">);<br />   <br />   </span><span style="color: #0000BB">pg_copy_from</span><span style="color: #007700">(</span><span style="color: #0000BB">$db</span><span style="color: #007700">, </span><span style="color: #0000BB">$table_name</span><span style="color: #007700">, </span><span style="color: #0000BB">$rows</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-copy-to-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-copy-from.php" class="function" rel="rdfs-seeAlso">pg_copy_from()</a> - Insert records into a table from an array</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-copy-to.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-copy-to%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-copy-to&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-copy-to.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="27218">  <div class="votes">
    <div id="Vu27218">
    <a href="/manual/vote-note.php?id=27218&amp;page=function.pg-copy-to&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd27218">
    <a href="/manual/vote-note.php?id=27218&amp;page=function.pg-copy-to&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V27218" title="66% like this...">
    1
    </div>
  </div>
  <a href="#27218" class="name">
  <strong class="user"><em>setantae at submonkey dot net</em></strong></a><a class="genanchor" href="#27218"> &para;</a><div class="date" title="2002-11-27 10:50"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom27218">
<div class="phpcode"><code><span class="html">"It issues COPY TO SQL command internally to insert records"<br /><br />I suspect this statement is incorrect, or that s/insert/retrieve/ is appropriate.</span></code></div>
  </div>
 </div>
  <div class="note" id="125262">  <div class="votes">
    <div id="Vu125262">
    <a href="/manual/vote-note.php?id=125262&amp;page=function.pg-copy-to&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125262">
    <a href="/manual/vote-note.php?id=125262&amp;page=function.pg-copy-to&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125262" title="50% like this...">
    0
    </div>
  </div>
  <a href="#125262" class="name">
  <strong class="user"><em>John M</em></strong></a><a class="genanchor" href="#125262"> &para;</a><div class="date" title="2020-08-12 05:41"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125262">
<div class="phpcode"><code><span class="html">Worth noting here that just like the COPY TO statement in PostgreSQL, '$table_name' can include a list of columns or be a select query as well.<br />e.g.:<br />$rows = pg_copy_to($db,'schema."TableName" (column1, column2, ...)';<br />$rows = pg_copy_to($db,'(SELECT ...)');</span></code></div>
  </div>
 </div>
  <div class="note" id="94672">  <div class="votes">
    <div id="Vu94672">
    <a href="/manual/vote-note.php?id=94672&amp;page=function.pg-copy-to&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94672">
    <a href="/manual/vote-note.php?id=94672&amp;page=function.pg-copy-to&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94672" title="28% like this...">
    -3
    </div>
  </div>
  <a href="#94672" class="name">
  <strong class="user"><em>etiger13 at gmail dot com</em></strong></a><a class="genanchor" href="#94672"> &para;</a><div class="date" title="2009-11-17 11:14"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94672">
<div class="phpcode"><code><span class="html">You cannot specify the schema name in this command. You can change the search path for just one query by using the following code: 
<br />
<br /><span class="default">&lt;?php
<br />pg_query</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="string">"SET search_path TO myschema;"</span><span class="keyword">);
<br />    
<br /></span><span class="default">$copy_to </span><span class="keyword">= </span><span class="default">pg_copy_to</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="string">'tablename'</span><span class="keyword">);
<br />    
<br /></span><span class="default">pg_query</span><span class="keyword">(</span><span class="string">"RESET search_path;"</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-copy-to&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-copy-to.php">＋<small>add a note</small></a></div>
