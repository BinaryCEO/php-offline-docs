...
<head>
  ...
  <title>PHP: Imagick::__toString - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.tostring.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.tostring.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.tostring.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.tintimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.transformimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.tostring.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.tostring.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.tostring.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.tostring.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.tostring.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.tostring.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.tostring.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.tostring.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.tostring.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.tostring.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.tostring.php" hreflang="zh">
...
<meta name="Description" content="Returns the image as a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::__toString - Manual" />
<meta name="twitter:description" content="Returns the image as a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::__toString - Manual" />
<meta itemprop="description" content="Returns the image as a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the image as a string" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.transformimage.php">
          Imagick::transformImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.tintimage.php">
          &laquo; Imagick::tintImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.tostring.php' selected="selected">English</option>
            <option value='de/imagick.tostring.php'>German</option>
            <option value='es/imagick.tostring.php'>Spanish</option>
            <option value='fr/imagick.tostring.php'>French</option>
            <option value='it/imagick.tostring.php'>Italian</option>
            <option value='ja/imagick.tostring.php'>Japanese</option>
            <option value='pt_BR/imagick.tostring.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.tostring.php'>Russian</option>
            <option value='tr/imagick.tostring.php'>Turkish</option>
            <option value='uk/imagick.tostring.php'>Ukrainian</option>
            <option value='zh/imagick.tostring.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.tostring" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="imagick.getimagesblob.php" class="methodname" rel="rdfs-seeAlso">Imagick::getImagesBlob()</a> - Returns all image sequences as a blob</span></li>   
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/toString.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.tostring%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.tostring&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.tostring.php">＋<small>add a note</small></a></span>
