...
<head>
  ...
  <title>PHP: Imagick::writeImagesFile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.writeimagesfile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.writeimagesfile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.writeimagesfile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.writeimages.php">
 <link rel="next" href="https://www.php.net/manual/en/class.imagickdraw.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.writeimagesfile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.writeimagesfile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.writeimagesfile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.writeimagesfile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.writeimagesfile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.writeimagesfile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.writeimagesfile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.writeimagesfile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.writeimagesfile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.writeimagesfile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.writeimagesfile.php" hreflang="zh">
...
<meta name="Description" content="Writes frames to a filehandle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::writeImagesFile - Manual" />
<meta name="twitter:description" content="Writes frames to a filehandle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::writeImagesFile - Manual" />
<meta itemprop="description" content="Writes frames to a filehandle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Writes frames to a filehandle" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.writeimagesfile.php' selected="selected">English</option>
            <option value='de/imagick.writeimagesfile.php'>German</option>
            <option value='es/imagick.writeimagesfile.php'>Spanish</option>
            <option value='fr/imagick.writeimagesfile.php'>French</option>
            <option value='it/imagick.writeimagesfile.php'>Italian</option>
            <option value='ja/imagick.writeimagesfile.php'>Japanese</option>
            <option value='pt_BR/imagick.writeimagesfile.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.writeimagesfile.php'>Russian</option>
            <option value='tr/imagick.writeimagesfile.php'>Turkish</option>
            <option value='uk/imagick.writeimagesfile.php'>Ukrainian</option>
            <option value='zh/imagick.writeimagesfile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.writeimagesfile" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="imagick.queryformats.php" class="methodname" rel="rdfs-seeAlso">Imagick::queryFormats()</a> - Returns formats supported by Imagick</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/writeimagesfile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.writeimagesfile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.writeimagesfile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.writeimagesfile.php">＋<small>add a note</small></a></span>
