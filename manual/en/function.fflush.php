...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fflush.php">
 <link rel="shorturl" href="https://www.php.net/fflush">
 <link rel="alternate" href="https://www.php.net/fflush" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.feof.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fgetc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fflush.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fflush.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fflush.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fflush.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fflush.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fflush.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fflush.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fflush.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fflush.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fflush.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fflush.php" hreflang="zh">
...
<meta name="Description" content="Flushes the output to a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fflush - Manual" />
<meta name="twitter:description" content="Flushes the output to a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fflush - Manual" />
<meta itemprop="description" content="Flushes the output to a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Flushes the output to a file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fflush.php' selected="selected">English</option>
            <option value='de/function.fflush.php'>German</option>
            <option value='es/function.fflush.php'>Spanish</option>
            <option value='fr/function.fflush.php'>French</option>
            <option value='it/function.fflush.php'>Italian</option>
            <option value='ja/function.fflush.php'>Japanese</option>
            <option value='pt_BR/function.fflush.php'>Brazilian Portuguese</option>
            <option value='ru/function.fflush.php'>Russian</option>
            <option value='tr/function.fflush.php'>Turkish</option>
            <option value='uk/function.fflush.php'>Ukrainian</option>
            <option value='zh/function.fflush.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fflush" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fflush</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.1, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">fflush</span> &mdash; <span class="dc-title">Flushes the output to a file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.fflush-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fflush</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stream</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   This function forces a write of all buffered output to the resource
   pointed to by the file <code class="parameter">stream</code>.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$filename </span><span style="color: #007700">= </span><span style="color: #DD0000">'bar.txt'</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">$file </span><span style="color: #007700">= </span><span style="color: #0000BB">fopen</span><span style="color: #007700">(</span><span style="color: #0000BB">$filename</span><span style="color: #007700">, </span><span style="color: #DD0000">'r+'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">rewind</span><span style="color: #007700">(</span><span style="color: #0000BB">$file</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">fwrite</span><span style="color: #007700">(</span><span style="color: #0000BB">$file</span><span style="color: #007700">, </span><span style="color: #DD0000">'Foo'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">fflush</span><span style="color: #007700">(</span><span style="color: #0000BB">$file</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ftruncate</span><span style="color: #007700">(</span><span style="color: #0000BB">$file</span><span style="color: #007700">, </span><span style="color: #0000BB">ftell</span><span style="color: #007700">(</span><span style="color: #0000BB">$file</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$file</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.fflush-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.clearstatcache.php" class="function" rel="rdfs-seeAlso">clearstatcache()</a> - Clears file status cache</span></li>
    <li><span class="function"><a href="function.fwrite.php" class="function" rel="rdfs-seeAlso">fwrite()</a> - Binary-safe file write</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/fflush.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fflush%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fflush&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fflush.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123585">  <div class="votes">
    <div id="Vu123585">
    <a href="/manual/vote-note.php?id=123585&amp;page=function.fflush&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123585">
    <a href="/manual/vote-note.php?id=123585&amp;page=function.fflush&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123585" title="77% like this...">
    19
    </div>
  </div>
  <a href="#123585" class="name">
  <strong class="user"><em>michaelsy01[NXSPAM] at informantum dot de</em></strong></a><a class="genanchor" href="#123585"> &para;</a><div class="date" title="2019-02-06 09:30"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123585">
<div class="phpcode"><code><span class="html">A hint for PHP beginners like me:<br />The buffered output which is write by fflush() has nothing to do with the output buffer which is initiated by the ob_start() function.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fflush&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fflush.php">＋<small>add a note</small></a></div>
