...
<head>
  ...
  <title>PHP: posix_ttyname - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-ttyname.php">
 <link rel="shorturl" href="https://www.php.net/posix-ttyname">
 <link rel="alternate" href="https://www.php.net/posix-ttyname" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-times.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-uname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-ttyname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-ttyname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-ttyname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-ttyname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-ttyname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-ttyname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-ttyname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-ttyname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-ttyname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-ttyname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-ttyname.php" hreflang="zh">
...
<meta name="Description" content="Determine terminal device name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_ttyname - Manual" />
<meta name="twitter:description" content="Determine terminal device name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_ttyname - Manual" />
<meta itemprop="description" content="Determine terminal device name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Determine terminal device name" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.posix-uname.php">
          posix_uname &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.posix-times.php">
          &laquo; posix_times        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-ttyname.php' selected="selected">English</option>
            <option value='de/function.posix-ttyname.php'>German</option>
            <option value='es/function.posix-ttyname.php'>Spanish</option>
            <option value='fr/function.posix-ttyname.php'>French</option>
            <option value='it/function.posix-ttyname.php'>Italian</option>
            <option value='ja/function.posix-ttyname.php'>Japanese</option>
            <option value='pt_BR/function.posix-ttyname.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-ttyname.php'>Russian</option>
            <option value='tr/function.posix-ttyname.php'>Turkish</option>
            <option value='uk/function.posix-ttyname.php'>Ukrainian</option>
            <option value='zh/function.posix-ttyname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-ttyname" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.stream-isatty.php" class="function" rel="rdfs-seeAlso">stream_isatty()</a> - Check if a stream is a TTY</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-ttyname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-ttyname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-ttyname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-ttyname.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="64660">  <div class="votes">
    <div id="Vu64660">
    <a href="/manual/vote-note.php?id=64660&amp;page=function.posix-ttyname&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd64660">
    <a href="/manual/vote-note.php?id=64660&amp;page=function.posix-ttyname&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V64660" title="no votes...">
    0
    </div>
  </div>
  <a href="#64660" class="name">
  <strong class="user"><em>casper at bcx dot nl</em></strong></a><a class="genanchor" href="#64660"> &para;</a><div class="date" title="2006-04-19 07:10"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom64660">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br />    var_dump</span><span class="keyword">( </span><span class="default">posix_ttyname</span><span class="keyword">(</span><span class="default">STDOUT</span><span class="keyword">) );<br /></span><span class="default">?&gt;<br /></span><br />returns:<br />string(10) "/dev/pts/0"<br /><br />When using pseudo terminal 1 (ie ssh)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.posix-ttyname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-ttyname.php">＋<small>add a note</small></a></div>
