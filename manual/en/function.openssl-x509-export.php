...
<head>
  ...
  <title>PHP: openssl_x509_export - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-x509-export.php">
 <link rel="shorturl" href="https://www.php.net/openssl-x509-export">
 <link rel="alternate" href="https://www.php.net/openssl-x509-export" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-x509-checkpurpose.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-x509-export-to-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-x509-export.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-x509-export.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-x509-export.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-x509-export.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-x509-export.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-x509-export.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-x509-export.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-x509-export.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-x509-export.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-x509-export.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-x509-export.php" hreflang="zh">
...
<meta name="Description" content="Exports a certificate as a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_x509_export - Manual" />
<meta name="twitter:description" content="Exports a certificate as a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_x509_export - Manual" />
<meta itemprop="description" content="Exports a certificate as a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exports a certificate as a string" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-x509-export-to-file.php">
          openssl_x509_export_to_file &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-x509-checkpurpose.php">
          &laquo; openssl_x509_checkpurpose        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-x509-export.php' selected="selected">English</option>
            <option value='de/function.openssl-x509-export.php'>German</option>
            <option value='es/function.openssl-x509-export.php'>Spanish</option>
            <option value='fr/function.openssl-x509-export.php'>French</option>
            <option value='it/function.openssl-x509-export.php'>Italian</option>
            <option value='ja/function.openssl-x509-export.php'>Japanese</option>
            <option value='pt_BR/function.openssl-x509-export.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-x509-export.php'>Russian</option>
            <option value='tr/function.openssl-x509-export.php'>Turkish</option>
            <option value='uk/function.openssl-x509-export.php'>Ukrainian</option>
            <option value='zh/function.openssl-x509-export.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-x509-export" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_x509_export</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_x509_export</span> &mdash; <span class="dc-title">Exports a certificate as a string</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-x509-export-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>openssl_x509_export</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.opensslcertificate.php" class="type OpenSSLCertificate">OpenSSLCertificate</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$certificate</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter reference">&$output</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$no_text</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>openssl_x509_export()</strong></span> stores
   <code class="parameter">certificate</code> into a string named by
   <code class="parameter">output</code> in a <abbr title="Privacy-Enhanced Mail">PEM</abbr> encoded format.
  </p>
 </div>
 ...
 <dd>
  <p class="para">
   See <a href="openssl.certparams.php" class="link">Key/Certificate parameters</a> for a list of valid values.
     ...
     <dd>
      <p class="para">
       On success, this will hold the <abbr title="Privacy-Enhanced Mail">PEM</abbr>.
      </p>
     </dd>
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-x509-export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-x509-export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-x509-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-x509-export.php">＋<small>add a note</small></a></span>
