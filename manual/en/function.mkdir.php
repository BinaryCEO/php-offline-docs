...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mkdir.php">
 <link rel="shorturl" href="https://www.php.net/mkdir">
 <link rel="alternate" href="https://www.php.net/mkdir" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.lstat.php">
 <link rel="next" href="https://www.php.net/manual/en/function.move-uploaded-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mkdir.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mkdir.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mkdir.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mkdir.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mkdir.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mkdir.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mkdir.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mkdir.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mkdir.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mkdir.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mkdir.php" hreflang="zh">
...
<meta name="Description" content="Makes directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mkdir - Manual" />
<meta name="twitter:description" content="Makes directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mkdir - Manual" />
<meta itemprop="description" content="Makes directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Makes directory" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.move-uploaded-file.php">
          move_uploaded_file &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.lstat.php">
          &laquo; lstat        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mkdir.php' selected="selected">English</option>
            <option value='de/function.mkdir.php'>German</option>
            <option value='es/function.mkdir.php'>Spanish</option>
            <option value='fr/function.mkdir.php'>French</option>
            <option value='it/function.mkdir.php'>Italian</option>
            <option value='ja/function.mkdir.php'>Japanese</option>
            <option value='pt_BR/function.mkdir.php'>Brazilian Portuguese</option>
            <option value='ru/function.mkdir.php'>Russian</option>
            <option value='tr/function.mkdir.php'>Turkish</option>
            <option value='uk/function.mkdir.php'>Ukrainian</option>
            <option value='zh/function.mkdir.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mkdir" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.umask.php" class="function" rel="rdfs-seeAlso">umask()</a> - Changes the current umask</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/mkdir.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mkdir%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mkdir&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mkdir.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">5 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96990">  <div class="votes">
    <div id="Vu96990">
    <a href="/manual/vote-note.php?id=96990&amp;page=function.mkdir&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96990">
    <a href="/manual/vote-note.php?id=96990&amp;page=function.mkdir&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96990" title="57% like this...">
    32
    </div>
  </div>
  <a href="#96990" class="name">
  <strong class="user"><em>jack dot sleight at gmail dot com</em></strong></a><a class="genanchor" href="#96990"> &para;</a><div class="date" title="2010-03-26 03:26"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96990">
<div class="phpcode"><code><span class="html">When using the recursive parameter bear in mind that if you're using chmod() after mkdir() to set the mode without it being modified by the value of uchar() you need to call chmod() on all created directories. ie:<br /><br /><span class="default">&lt;?php<br />mkdir</span><span class="keyword">(</span><span class="string">'/test1/test2'</span><span class="keyword">, </span><span class="default">0777</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">chmod</span><span class="keyword">(</span><span class="string">'/test1/test2'</span><span class="keyword">, </span><span class="default">0777</span><span class="keyword">);<br /></span><span class="default">?&gt;</span> <br /><br />May result in "/test1/test2" having a mode of 0777 but "/test1" still having a mode of 0755 from the mkdir() call. You'd need to do:<br /><br /><span class="default">&lt;?php<br />mkdir</span><span class="keyword">(</span><span class="string">'/test1/test2'</span><span class="keyword">, </span><span class="default">0777</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">chmod</span><span class="keyword">(</span><span class="string">'/test1'</span><span class="keyword">, </span><span class="default">0777</span><span class="keyword">);<br /></span><span class="default">chmod</span><span class="keyword">(</span><span class="string">'/test1/test2'</span><span class="keyword">, </span><span class="default">0777</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="1207">  <div class="votes">
    <div id="Vu1207">
    <a href="/manual/vote-note.php?id=1207&amp;page=function.mkdir&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd1207">
    <a href="/manual/vote-note.php?id=1207&amp;page=function.mkdir&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V1207" title="57% like this...">
    19
    </div>
  </div>
  <a href="#1207" class="name">
  <strong class="user"><em>aulbach at unter dot franken dot de</em></strong></a><a class="genanchor" href="#1207"> &para;</a><div class="date" title="1999-07-22 02:37"><strong>26 years ago</strong></div>
  <div class="text" id="Hcom1207">
<div class="phpcode"><code><span class="html">This is an annotation from Stig Bakken:
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="102823">  <div class="votes">
    <div id="Vu102823">
    <a href="/manual/vote-note.php?id=102823&amp;page=function.mkdir&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102823">
    <a href="/manual/vote-note.php?id=102823&amp;page=function.mkdir&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102823" title="62% like this...">
    9
    </div>
  </div>
  <a href="#102823" class="name">
  <strong class="user"><em>julius - grantzau - c-o-m</em></strong></a><a class="genanchor" href="#102823"> &para;</a><div class="date" title="2011-03-08 08:10"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102823">
<div class="phpcode"><code><span class="html">Remember to use clearstatcache()<br /><br />... when working with filesystem functions.<br /><br />Otherwise, as an example, you can get an error creating a folder (using mkdir) just after deleting it (using rmdir).</span></code></div>
  </div>
 </div>
  <div class="note" id="50568">  <div class="votes">
    <div id="Vu50568">
    <a href="/manual/vote-note.php?id=50568&amp;page=function.mkdir&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd50568">
    <a href="/manual/vote-note.php?id=50568&amp;page=function.mkdir&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V50568" title="56% like this...">
    6
    </div>
  </div>
  <a href="#50568" class="name">
  <strong class="user"><em>Protik Mukherjee</em></strong></a><a class="genanchor" href="#50568"> &para;</a><div class="date" title="2005-03-03 09:29"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom50568">
<div class="phpcode"><code><span class="html">mkdir, file rw, permission related notes for Fedora 3////<br />If you are using Fedora 3 and are facing permission problems, better check if SElinux is enabled on ur system. It add an additional layer of security and as a result PHP cant write to the folder eventhough it has 777 permissions. It took me almost a week to deal with this!<br /><br />If you are not sure google for SElinux or 'disabling SELinux' and it may be the cure! Best of luck!</span></code></div>
  </div>
 </div>
  <div class="note" id="128728">  <div class="votes">
    <div id="Vu128728">
    <a href="/manual/vote-note.php?id=128728&amp;page=function.mkdir&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128728">
    <a href="/manual/vote-note.php?id=128728&amp;page=function.mkdir&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128728" title="44% like this...">
    -2
    </div>
  </div>
  <a href="#128728" class="name">
  <strong class="user"><em>chelidze dot givia at gmail dot com</em></strong></a><a class="genanchor" href="#128728"> &para;</a><div class="date" title="2023-07-12 09:44"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128728">
<div class="phpcode"><code><span class="html">When creating a file using mkdir() the default root will be the DocumentRoot (in XAMPP) itself. <br /><br />C:\xampp\htdocs\project/includes/something.php<br /><br />If you use mkdir("myfile") in something.php, instead of creating the folder in includes, php will create it in the project folder</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mkdir&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mkdir.php">＋<small>add a note</small></a></div>
