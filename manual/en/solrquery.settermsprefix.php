...
<head>
  ...
  <title>PHP: SolrQuery::setTermsPrefix - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.settermsprefix.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.settermsprefix.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsprefix.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.settermsmincount.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.settermsreturnraw.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsprefix.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.settermsprefix.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.settermsprefix.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.settermsprefix.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.settermsprefix.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.settermsprefix.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.settermsprefix.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.settermsprefix.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.settermsprefix.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.settermsprefix.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.settermsprefix.php" hreflang="zh">
...
<meta name="Description" content="Restrict matches to terms that start with the prefix" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setTermsPrefix - Manual" />
<meta name="twitter:description" content="Restrict matches to terms that start with the prefix" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setTermsPrefix - Manual" />
<meta itemprop="description" content="Restrict matches to terms that start with the prefix" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Restrict matches to terms that start with the prefix" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.settermsreturnraw.php">
          SolrQuery::setTermsReturnRaw &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.settermsmincount.php">
          &laquo; SolrQuery::setTermsMinCount        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.settermsprefix.php' selected="selected">English</option>
            <option value='de/solrquery.settermsprefix.php'>German</option>
            <option value='es/solrquery.settermsprefix.php'>Spanish</option>
            <option value='fr/solrquery.settermsprefix.php'>French</option>
            <option value='it/solrquery.settermsprefix.php'>Italian</option>
            <option value='ja/solrquery.settermsprefix.php'>Japanese</option>
            <option value='pt_BR/solrquery.settermsprefix.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.settermsprefix.php'>Russian</option>
            <option value='tr/solrquery.settermsprefix.php'>Turkish</option>
            <option value='uk/solrquery.settermsprefix.php'>Ukrainian</option>
            <option value='zh/solrquery.settermsprefix.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.settermsprefix" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setTermsPrefix</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setTermsPrefix</span> &mdash; <span class="dc-title">Restrict matches to terms that start with the prefix</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.settermsprefix-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setTermsPrefix</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$prefix</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.settermsprefix-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.settermsprefix-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/settermsprefix.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.settermsprefix%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.settermsprefix&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.settermsprefix.php">＋<small>add a note</small></a></span>
