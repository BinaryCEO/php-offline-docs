...
<head>
  ...
  <title>PHP: Gmagick::getimagechanneldepth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagechanneldepth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagechanneldepth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagechanneldepth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagebordercolor.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagecolors.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagechanneldepth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagechanneldepth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagechanneldepth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagechanneldepth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagechanneldepth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagechanneldepth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagechanneldepth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagechanneldepth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagechanneldepth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagechanneldepth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagechanneldepth.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimagechanneldepth - Manual" />
<meta name="twitter:description" content="Gets the depth for a particular image channel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagechanneldepth - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.getimagecolors.php">
          Gmagick::getimagecolors &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagebordercolor.php">
          &laquo; Gmagick::getimagebordercolor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagechanneldepth.php' selected="selected">English</option>
            <option value='de/gmagick.getimagechanneldepth.php'>German</option>
            <option value='es/gmagick.getimagechanneldepth.php'>Spanish</option>
            <option value='fr/gmagick.getimagechanneldepth.php'>French</option>
            <option value='it/gmagick.getimagechanneldepth.php'>Italian</option>
            <option value='ja/gmagick.getimagechanneldepth.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagechanneldepth.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagechanneldepth.php'>Russian</option>
            <option value='tr/gmagick.getimagechanneldepth.php'>Turkish</option>
            <option value='uk/gmagick.getimagechanneldepth.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagechanneldepth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagechanneldepth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagechanneldepth</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagechanneldepth</span> &mdash; <span class="dc-title">Gets the depth for a particular image channel</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagechanneldepth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagechanneldepth</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel_type</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagechanneldepth-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagechanneldepth-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagechanneldepth-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagechanneldepth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagechanneldepth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagechanneldepth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagechanneldepth.php">＋<small>add a note</small></a></span>
