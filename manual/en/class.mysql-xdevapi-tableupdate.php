...
<head>
  ...
  <title>PHP: mysql_xdevapi\TableUpdate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mysql-xdevapi-tableupdate.php">
 <link rel="shorturl" href="https://www.php.net/mysql-xdevapi-tableupdate">
 <link rel="alternate" href="https://www.php.net/mysql-xdevapi-tableupdate" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mysql-xdevapi.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-tableselect.where.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-tableupdate.bind.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mysql-xdevapi-tableupdate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mysql-xdevapi-tableupdate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mysql-xdevapi-tableupdate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mysql-xdevapi-tableupdate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mysql-xdevapi-tableupdate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mysql-xdevapi-tableupdate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mysql-xdevapi-tableupdate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mysql-xdevapi-tableupdate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mysql-xdevapi-tableupdate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mysql-xdevapi-tableupdate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mysql-xdevapi-tableupdate.php" hreflang="zh">
...
<meta name="Description" content="TableUpdate class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_xdevapi\TableUpdate - Manual" />
<meta name="twitter:description" content="TableUpdate class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_xdevapi\TableUpdate - Manual" />
<meta itemprop="description" content="TableUpdate class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="TableUpdate class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysql-xdevapi-tableupdate.bind.php">
          TableUpdate::bind &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysql-xdevapi-tableselect.where.php">
          &laquo; TableSelect::where        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mysql-xdevapi-tableupdate.php' selected="selected">English</option>
            <option value='de/class.mysql-xdevapi-tableupdate.php'>German</option>
            <option value='es/class.mysql-xdevapi-tableupdate.php'>Spanish</option>
            <option value='fr/class.mysql-xdevapi-tableupdate.php'>French</option>
            <option value='it/class.mysql-xdevapi-tableupdate.php'>Italian</option>
            <option value='ja/class.mysql-xdevapi-tableupdate.php'>Japanese</option>
            <option value='pt_BR/class.mysql-xdevapi-tableupdate.php'>Brazilian Portuguese</option>
            <option value='ru/class.mysql-xdevapi-tableupdate.php'>Russian</option>
            <option value='tr/class.mysql-xdevapi-tableupdate.php'>Turkish</option>
            <option value='uk/class.mysql-xdevapi-tableupdate.php'>Ukrainian</option>
            <option value='zh/class.mysql-xdevapi-tableupdate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mysql-xdevapi-tableupdate" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mysql-xdevapi-tableupdate.bind.php">TableUpdate::bind</a> — Bind update query parameters</li><li><a href="mysql-xdevapi-tableupdate.construct.php">TableUpdate::__construct</a> — TableUpdate constructor</li><li><a href="mysql-xdevapi-tableupdate.execute.php">TableUpdate::execute</a> — Execute update query</li><li><a href="mysql-xdevapi-tableupdate.limit.php">TableUpdate::limit</a> — Limit update row count</li><li><a href="mysql-xdevapi-tableupdate.orderby.php">TableUpdate::orderby</a> — Set sorting criteria</li><li><a href="mysql-xdevapi-tableupdate.set.php">TableUpdate::set</a> — Add field to be updated</li><li><a href="mysql-xdevapi-tableupdate.where.php">TableUpdate::where</a> — Set search filter</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql-xdevapi.tableupdate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mysql-xdevapi-tableupdate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mysql-xdevapi-tableupdate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mysql-xdevapi-tableupdate.php">＋<small>add a note</small></a></span>
