...
<head>
  ...
  <title>PHP: mysqli::rollback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.rollback.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.rollback.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.rollback.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.release-savepoint.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.savepoint.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.rollback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.rollback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.rollback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.rollback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.rollback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.rollback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.rollback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.rollback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.rollback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.rollback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.rollback.php" hreflang="zh">
...
<meta name="Description" content="Rolls back current transaction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::rollback - Manual" />
<meta name="twitter:description" content="Rolls back current transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::rollback - Manual" />
<meta itemprop="description" content="Rolls back current transaction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rolls back current transaction" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli.savepoint.php">
          mysqli::savepoint &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.release-savepoint.php">
          &laquo; mysqli::release_savepoint        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.rollback.php' selected="selected">English</option>
            <option value='de/mysqli.rollback.php'>German</option>
            <option value='es/mysqli.rollback.php'>Spanish</option>
            <option value='fr/mysqli.rollback.php'>French</option>
            <option value='it/mysqli.rollback.php'>Italian</option>
            <option value='ja/mysqli.rollback.php'>Japanese</option>
            <option value='pt_BR/mysqli.rollback.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.rollback.php'>Russian</option>
            <option value='tr/mysqli.rollback.php'>Turkish</option>
            <option value='uk/mysqli.rollback.php'>Ukrainian</option>
            <option value='zh/mysqli.rollback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.rollback" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli::rollback</h1>
  <h1 class="refname">mysqli_rollback</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli::rollback</span> -- <span class="refname">mysqli_rollback</span> &mdash; <span class="dc-title">Rolls back current transaction</span></p>
...
returned by <span class="function"><a href="function.mysqli-connect.php" class="function">mysqli_connect()</a></span> or <span class="function"><a href="mysqli.init.php" class="function">mysqli_init()</a></span>
     ...
     <dd>
      <p class="para">
       If provided then <code class="literal">ROLLBACK/*name*/</code> is executed.
      </p>
     </dd>
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli.rollback-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli.release-savepoint.php" class="function" rel="rdfs-seeAlso">mysqli_release_savepoint()</a> - Removes the named savepoint from the set of savepoints of the current transaction</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/rollback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.rollback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.rollback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.rollback.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="107469">  <div class="votes">
    <div id="Vu107469">
    <a href="/manual/vote-note.php?id=107469&amp;page=mysqli.rollback&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd107469">
    <a href="/manual/vote-note.php?id=107469&amp;page=mysqli.rollback&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V107469" title="85% like this...">
    45
    </div>
  </div>
  <a href="#107469" class="name">
  <strong class="user"><em>Steven McCoy</em></strong></a><a class="genanchor" href="#107469"> &para;</a><div class="date" title="2012-02-10 09:16"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom107469">
<div class="phpcode"><code><span class="html">Remember that MyISAM tables do not support rollbacks.<br /><br />I just drove myself crazy for an afternoon trying to figure out what was wrong with my code - meanwhile it was fine all along</span></code></div>
  </div>
 </div>
  <div class="note" id="88838">  <div class="votes">
    <div id="Vu88838">
    <a href="/manual/vote-note.php?id=88838&amp;page=mysqli.rollback&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd88838">
    <a href="/manual/vote-note.php?id=88838&amp;page=mysqli.rollback&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V88838" title="78% like this...">
    35
    </div>
  </div>
  <a href="#88838" class="name">
  <strong class="user"><em>Lorenzo - webmaster AT 4tour DOT it</em></strong></a><a class="genanchor" href="#88838"> &para;</a><div class="date" title="2009-02-10 06:31"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom88838">
<div class="phpcode"><code><span class="html">This is an example to explain the powerful of the rollback and commit functions.
