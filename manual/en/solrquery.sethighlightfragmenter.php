...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightFragmenter - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightfragmenter.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightfragmenter.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightfragmenter.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightformatter.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightfragsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightfragmenter.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightfragmenter.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightfragmenter.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightfragmenter.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightfragmenter.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightfragmenter.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightfragmenter.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightfragmenter.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightfragmenter.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightfragmenter.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightfragmenter.php" hreflang="zh">
...
<meta name="Description" content="Sets a text snippet generator for highlighted text" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightFragmenter - Manual" />
<meta name="twitter:description" content="Sets a text snippet generator for highlighted text" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightFragmenter - Manual" />
<meta itemprop="description" content="Sets a text snippet generator for highlighted text" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets a text snippet generator for highlighted text" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.sethighlightfragsize.php">
          SolrQuery::setHighlightFragsize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightformatter.php">
          &laquo; SolrQuery::setHighlightFormatter        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightfragmenter.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightfragmenter.php'>German</option>
            <option value='es/solrquery.sethighlightfragmenter.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightfragmenter.php'>French</option>
            <option value='it/solrquery.sethighlightfragmenter.php'>Italian</option>
            <option value='ja/solrquery.sethighlightfragmenter.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightfragmenter.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightfragmenter.php'>Russian</option>
            <option value='tr/solrquery.sethighlightfragmenter.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightfragmenter.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightfragmenter.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightfragmenter" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightFragmenter</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightFragmenter</span> &mdash; <span class="dc-title">Sets a text snippet generator for highlighted text</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightfragmenter-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightFragmenter</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$fragmenter</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightfragmenter-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">fragmenter</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightfragmenter-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightfragmenter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightfragmenter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightfragmenter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightfragmenter.php">＋<small>add a note</small></a></span>
