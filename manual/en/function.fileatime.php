...
<head>
  ...
  <title>PHP: fileatime - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fileatime.php">
 <link rel="shorturl" href="https://www.php.net/fileatime">
 <link rel="alternate" href="https://www.php.net/fileatime" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.file-put-contents.php">
 <link rel="next" href="https://www.php.net/manual/en/function.filectime.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fileatime.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fileatime.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fileatime.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fileatime.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fileatime.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fileatime.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fileatime.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fileatime.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fileatime.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fileatime.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fileatime.php" hreflang="zh">
...
<meta name="Description" content="Gets last access time of file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fileatime - Manual" />
<meta name="twitter:description" content="Gets last access time of file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fileatime - Manual" />
<meta itemprop="description" content="Gets last access time of file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets last access time of file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fileatime.php' selected="selected">English</option>
            <option value='de/function.fileatime.php'>German</option>
            <option value='es/function.fileatime.php'>Spanish</option>
            <option value='fr/function.fileatime.php'>French</option>
            <option value='it/function.fileatime.php'>Italian</option>
            <option value='ja/function.fileatime.php'>Japanese</option>
            <option value='pt_BR/function.fileatime.php'>Brazilian Portuguese</option>
            <option value='ru/function.fileatime.php'>Russian</option>
            <option value='tr/function.fileatime.php'>Turkish</option>
            <option value='uk/function.fileatime.php'>Ukrainian</option>
            <option value='zh/function.fileatime.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fileatime" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fileatime</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">fileatime</span> &mdash; <span class="dc-title">Gets last access time of file</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fileatime-returnvalues">
  ...
  <p class="para">
   Returns the time the file was last accessed,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
 ...
 <div class="refsect1 examples" id="refsect1-function.fileatime-examples">
  ...
  <p class="para">
   <div class="example" id="example-2358">
    <p><strong>Example #1 <span class="function"><strong>fileatime()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.date.php" class="function" rel="rdfs-seeAlso">date()</a> - Format a Unix timestamp</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/fileatime.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fileatime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fileatime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fileatime.php">＋<small>add a note</small></a></span>
