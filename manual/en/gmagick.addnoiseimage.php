...
<head>
  ...
  <title>PHP: Gmagick::addnoiseimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.addnoiseimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.addnoiseimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.addnoiseimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.addimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.annotateimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.addnoiseimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.addnoiseimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.addnoiseimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.addnoiseimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.addnoiseimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.addnoiseimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.addnoiseimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.addnoiseimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.addnoiseimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.addnoiseimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.addnoiseimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::addnoiseimage - Manual" />
<meta name="twitter:description" content="Adds random noise to the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::addnoiseimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.annotateimage.php">
          Gmagick::annotateimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.addimage.php">
          &laquo; Gmagick::addimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.addnoiseimage.php' selected="selected">English</option>
            <option value='de/gmagick.addnoiseimage.php'>German</option>
            <option value='es/gmagick.addnoiseimage.php'>Spanish</option>
            <option value='fr/gmagick.addnoiseimage.php'>French</option>
            <option value='it/gmagick.addnoiseimage.php'>Italian</option>
            <option value='ja/gmagick.addnoiseimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.addnoiseimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.addnoiseimage.php'>Russian</option>
            <option value='tr/gmagick.addnoiseimage.php'>Turkish</option>
            <option value='uk/gmagick.addnoiseimage.php'>Ukrainian</option>
            <option value='zh/gmagick.addnoiseimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.addnoiseimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::addnoiseimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::addnoiseimage</span> &mdash; <span class="dc-title">Adds random noise to the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.addnoiseimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::addnoiseimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$noise_type</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.addnoiseimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The type of the noise. Refer to this list of <a href="gmagick.constants.php#gmagick.constants.noise" class="link">noise constants</a>. 
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.addnoiseimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.addnoiseimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/addnoiseimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.addnoiseimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.addnoiseimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.addnoiseimage.php">＋<small>add a note</small></a></span>
