...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-accept.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-addrinfo-bind.php">
...
<meta name="Description" content="Accepts a connection on a socket" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_accept - Manual" />
<meta name="twitter:description" content="Accepts a connection on a socket" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_accept - Manual" />
<meta itemprop="description" content="Accepts a connection on a socket" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Accepts a connection on a socket" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-accept.php' selected="selected">English</option>
            ...
            <option value='zh/function.socket-accept.php'>Chinese (Simplified)</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.socket-strerror.php" class="function" rel="rdfs-seeAlso">socket_strerror()</a> - Return a string describing a socket error</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-accept.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-accept%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-accept&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-accept.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="80691">  <div class="votes">
    ...
    <div class="tally" id="V80691" title="62% like this...">
    25
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">If you want to make a daemon process that forks on each client connection, you'll find out that there's a bug in PHP. The child processes send SIGCHLD to their parent when they exit but the parent can't handle signals while it's waiting for socket_accept (blocking).
<br />
...
<div class="phpcode"><code><span class="html">If you want to have multiple clients on a server you will have to use non blocking.<br /><br /><span class="default">&lt;?php<br /><br />$clients </span><span class="keyword">= array();<br /></span><span class="default">$socket </span><span class="keyword">= </span><span class="default">socket_create</span><span class="keyword">(</span><span class="default">AF_INET</span><span class="keyword">,</span><span class="default">SOCK_STREAM</span><span class="keyword">,</span><span class="default">SOL_TCP</span><span class="keyword">);<br /></span><span class="default">socket_bind</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">,</span><span class="string">'127.0.0.1'</span><span class="keyword">,</span><span class="default">$port</span><span class="keyword">);<br /></span><span class="default">socket_listen</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">);<br /></span><span class="default">socket_set_nonblock</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">);<br /><br />while(</span><span class="default">true</span><span class="keyword">)<br />{<br />    if((</span><span class="default">$newc </span><span class="keyword">= </span><span class="default">socket_accept</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">)) !== </span><span class="default">false</span><span class="keyword">)<br />    {<br />        echo </span><span class="string">"Client </span><span class="default">$newc</span><span class="string"> has connected\n"</span><span class="keyword">;<br />        </span><span class="default">$clients</span><span class="keyword">[] = </span><span class="default">$newc</span><span class="keyword">;<br />    }<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>Greg MacLellan</em></strong></a><a class="genanchor" href="#38198"> &para;</a><div class="date" title="2003-12-11 12:49"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom38198">
<div class="phpcode"><code><span class="html">The socket returned by this resource will be non-blocking, regardless of what the listening socket is set to. This is actually true for all FCNTL modifiers.</span></code></div>
  </div>
 </div>
  <div class="note" id="123751">  <div class="votes">
    ...
    <div class="tally" id="V123751" title="58% like this...">
    2
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">&lt;explain&gt;<br /> This case is a very simple interaction between the TCP client side and the TCP server side<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// create for simple-tcp-server<br /></span><span class="default">$sock </span><span class="keyword">= </span><span class="default">socket_create</span><span class="keyword">(</span><span class="default">AF_INET</span><span class="keyword">, </span><span class="default">SOCK_STREAM</span><span class="keyword">, </span><span class="default">getprotobyname</span><span class="keyword">(</span><span class="string">'tcp'</span><span class="keyword">));<br /></span><span class="default">socket_bind</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">, </span><span class="string">'127.0.0.1'</span><span class="keyword">,</span><span class="default">5000</span><span class="keyword">);<br /></span><span class="default">socket_listen</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">$clnt_sock </span><span class="keyword">= </span><span class="default">socket_accept</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">); </span><span class="comment">//阻塞<br /></span><span class="default">$st </span><span class="keyword">= </span><span class="string">"hello world ^_^"</span><span class="keyword">;<br /></span><span class="default">socket_write</span><span class="keyword">(</span><span class="default">$clnt_sock</span><span class="keyword">, </span><span class="default">$st</span><span class="keyword">,</span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$st</span><span class="keyword">));<br /></span><span class="default">socket_close</span><span class="keyword">(</span><span class="default">$clnt_sock</span><span class="keyword">);<br /></span><span class="default">socket_close</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br /><span class="default">&lt;?php<br /></span><span class="comment">//create for simple-tcp-client     <br /></span><span class="default">$clnt_sock </span><span class="keyword">= </span><span class="default">socket_create</span><span class="keyword">(</span><span class="default">AF_INET</span><span class="keyword">, </span><span class="default">SOCK_STREAM</span><span class="keyword">, </span><span class="default">getprotobyname</span><span class="keyword">(</span><span class="string">'tcp'</span><span class="keyword">));<br /></span><span class="default">socket_connect</span><span class="keyword">(</span><span class="default">$clnt_sock</span><span class="keyword">, </span><span class="string">'127.0.0.1'</span><span class="keyword">, </span><span class="default">5000</span><span class="keyword">);<br /></span><span class="default">$ret</span><span class="keyword">= </span><span class="default">socket_read</span><span class="keyword">(</span><span class="default">$clnt_sock</span><span class="keyword">, </span><span class="default">1024</span><span class="keyword">);<br />print </span><span class="string">"from simple-tcp-server:"</span><span class="keyword">.</span><span class="default">$ret</span><span class="keyword">.</span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">socket_close</span><span class="keyword">(</span><span class="default">$clnt_sock</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />&lt;fruit&gt;<br />from simple-tcp-server:hello world ^_^</span></code></div>
  </div>
 </div>
  <div class="note" id="75289">  <div class="votes">
    ...
    <div class="tally" id="V75289" title="46% like this...">
    -1
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Be aware signal handler functions set with pcntl_signal are not called while a socket is blocking waiting for a connection; the signal is absorbed silently and the handler called when a connection is made.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.socket-accept&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-accept.php">＋<small>add a note</small></a></div>
