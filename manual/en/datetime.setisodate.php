...
<head>
  ...
  <title>PHP: DateTime::setISODate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/datetime.setisodate.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/datetime.setisodate.php">
 <link rel="alternate" href="https://www.php.net/manual/en/datetime.setisodate.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/datetime.setdate.php">
 <link rel="next" href="https://www.php.net/manual/en/datetime.settime.php">

 <link rel="alternate" href="https://www.php.net/manual/en/datetime.setisodate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/datetime.setisodate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/datetime.setisodate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/datetime.setisodate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/datetime.setisodate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/datetime.setisodate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/datetime.setisodate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/datetime.setisodate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/datetime.setisodate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/datetime.setisodate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/datetime.setisodate.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: DateTime::setISODate - Manual" />
<meta name="twitter:description" content="Sets the ISO date" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateTime::setISODate - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="datetime.settime.php">
          DateTime::setTime &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="datetime.setdate.php">
          &laquo; DateTime::setDate        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/datetime.setisodate.php' selected="selected">English</option>
            <option value='de/datetime.setisodate.php'>German</option>
            <option value='es/datetime.setisodate.php'>Spanish</option>
            <option value='fr/datetime.setisodate.php'>French</option>
            <option value='it/datetime.setisodate.php'>Italian</option>
            <option value='ja/datetime.setisodate.php'>Japanese</option>
            <option value='pt_BR/datetime.setisodate.php'>Brazilian Portuguese</option>
            <option value='ru/datetime.setisodate.php'>Russian</option>
            <option value='tr/datetime.setisodate.php'>Turkish</option>
            <option value='uk/datetime.setisodate.php'>Ukrainian</option>
            <option value='zh/datetime.setisodate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="datetime.setisodate" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="datetimeimmutable.setisodate.php" class="function" rel="rdfs-seeAlso">DateTimeImmutable::setISODate()</a> - Sets the ISO date</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datetime/setisodate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdatetime.setisodate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=datetime.setisodate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/datetime.setisodate.php">＋<small>add a note</small></a></span>
