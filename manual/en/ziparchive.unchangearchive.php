...
<head>
  ...
  <title>PHP: ZipArchive::unchangeArchive - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.unchangearchive.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.unchangearchive.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.unchangearchive.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.unchangeall.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.unchangeindex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.unchangearchive.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.unchangearchive.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.unchangearchive.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.unchangearchive.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.unchangearchive.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.unchangearchive.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.unchangearchive.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.unchangearchive.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.unchangearchive.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.unchangearchive.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.unchangearchive.php" hreflang="zh">
...
<meta name="Description" content="Revert all global changes done in the archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::unchangeArchive - Manual" />
<meta name="twitter:description" content="Revert all global changes done in the archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::unchangeArchive - Manual" />
<meta itemprop="description" content="Revert all global changes done in the archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Revert all global changes done in the archive" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.unchangeindex.php">
          ZipArchive::unchangeIndex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.unchangeall.php">
          &laquo; ZipArchive::unchangeAll        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.unchangearchive.php' selected="selected">English</option>
            <option value='de/ziparchive.unchangearchive.php'>German</option>
            <option value='es/ziparchive.unchangearchive.php'>Spanish</option>
            <option value='fr/ziparchive.unchangearchive.php'>French</option>
            <option value='it/ziparchive.unchangearchive.php'>Italian</option>
            <option value='ja/ziparchive.unchangearchive.php'>Japanese</option>
            <option value='pt_BR/ziparchive.unchangearchive.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.unchangearchive.php'>Russian</option>
            <option value='tr/ziparchive.unchangearchive.php'>Turkish</option>
            <option value='uk/ziparchive.unchangearchive.php'>Ukrainian</option>
            <option value='zh/ziparchive.unchangearchive.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.unchangearchive" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ZipArchive::unchangeArchive</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8, PECL zip &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ZipArchive::unchangeArchive</span> &mdash; <span class="dc-title">Revert all global changes done in the archive</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-ziparchive.unchangearchive-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ZipArchive::unchangeArchive</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-ziparchive.unchangearchive-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-ziparchive.unchangearchive-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/unchangearchive.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.unchangearchive%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.unchangearchive&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.unchangearchive.php">＋<small>add a note</small></a></span>
