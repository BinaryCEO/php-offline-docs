...
<head>
  ...
  <title>PHP: SolrQuery::removeExpandSortField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.removeexpandsortfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.removeexpandsortfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removeexpandsortfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.removeexpandfilterquery.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.removefacetdatefield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removeexpandsortfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.removeexpandsortfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.removeexpandsortfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.removeexpandsortfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.removeexpandsortfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.removeexpandsortfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.removeexpandsortfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.removeexpandsortfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.removeexpandsortfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.removeexpandsortfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.removeexpandsortfield.php" hreflang="zh">
...
<meta name="Description" content="Removes an expand sort field from the expand.sort parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::removeExpandSortField - Manual" />
<meta name="twitter:description" content="Removes an expand sort field from the expand.sort parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::removeExpandSortField - Manual" />
<meta itemprop="description" content="Removes an expand sort field from the expand.sort parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes an expand sort field from the expand.sort parameter" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.removefacetdatefield.php">
          SolrQuery::removeFacetDateField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.removeexpandfilterquery.php">
          &laquo; SolrQuery::removeExpandFilterQuery        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.removeexpandsortfield.php' selected="selected">English</option>
            <option value='de/solrquery.removeexpandsortfield.php'>German</option>
            <option value='es/solrquery.removeexpandsortfield.php'>Spanish</option>
            <option value='fr/solrquery.removeexpandsortfield.php'>French</option>
            <option value='it/solrquery.removeexpandsortfield.php'>Italian</option>
            <option value='ja/solrquery.removeexpandsortfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.removeexpandsortfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.removeexpandsortfield.php'>Russian</option>
            <option value='tr/solrquery.removeexpandsortfield.php'>Turkish</option>
            <option value='uk/solrquery.removeexpandsortfield.php'>Ukrainian</option>
            <option value='zh/solrquery.removeexpandsortfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.removeexpandsortfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::removeExpandSortField</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::removeExpandSortField</span> &mdash; <span class="dc-title">Removes an expand sort field from the expand.sort parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.removeexpandsortfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::removeExpandSortField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.removeexpandsortfield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.removeexpandsortfield-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.removeexpandsortfield-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.removeexpandfilterquery.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::removeExpandFilterQuery()</a> - Removes an expand filter query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/removeexpandsortfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.removeexpandsortfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.removeexpandsortfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.removeexpandsortfield.php">＋<small>add a note</small></a></span>
