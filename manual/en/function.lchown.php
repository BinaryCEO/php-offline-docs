...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.lchown.php">
 <link rel="shorturl" href="https://www.php.net/lchown">
 <link rel="alternate" href="https://www.php.net/lchown" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.lchgrp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.link.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.lchown.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.lchown.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.lchown.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.lchown.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.lchown.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.lchown.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.lchown.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.lchown.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.lchown.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.lchown.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.lchown.php" hreflang="zh">
...
<meta name="Description" content="Changes user ownership of symlink" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: lchown - Manual" />
<meta name="twitter:description" content="Changes user ownership of symlink" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: lchown - Manual" />
<meta itemprop="description" content="Changes user ownership of symlink" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Changes user ownership of symlink" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.lchown.php' selected="selected">English</option>
            <option value='de/function.lchown.php'>German</option>
            <option value='es/function.lchown.php'>Spanish</option>
            <option value='fr/function.lchown.php'>French</option>
            <option value='it/function.lchown.php'>Italian</option>
            <option value='ja/function.lchown.php'>Japanese</option>
            <option value='pt_BR/function.lchown.php'>Brazilian Portuguese</option>
            <option value='ru/function.lchown.php'>Russian</option>
            <option value='tr/function.lchown.php'>Turkish</option>
            <option value='uk/function.lchown.php'>Ukrainian</option>
            <option value='zh/function.lchown.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.lchown" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">lchown</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.1.3, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">lchown</span> &mdash; <span class="dc-title">Changes user ownership of symlink</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.lchown-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>lchown</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span> <code class="parameter">$user</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.lchown-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.lchgrp.php" class="function" rel="rdfs-seeAlso">lchgrp()</a> - Changes group ownership of symlink</span></li>
    ...
    <li><span class="function"><a href="function.chmod.php" class="function" rel="rdfs-seeAlso">chmod()</a> - Changes file mode</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/lchown.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.lchown%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.lchown&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.lchown.php">＋<small>add a note</small></a></span>
