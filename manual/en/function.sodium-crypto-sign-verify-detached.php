...
<head>
  ...
  <title>PHP: sodium_crypto_sign_verify_detached - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-sign-verify-detached.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-sign-verify-detached">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-sign-verify-detached" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-sign-seed-keypair.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-stream.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-sign-verify-detached.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-sign-verify-detached.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-sign-verify-detached.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-sign-verify-detached.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-sign-verify-detached.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-sign-verify-detached.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-sign-verify-detached.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-sign-verify-detached.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-sign-verify-detached.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-sign-verify-detached.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-sign-verify-detached.php" hreflang="zh">
...
<meta name="Description" content="Verify signature for the message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_sign_verify_detached - Manual" />
<meta name="twitter:description" content="Verify signature for the message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_sign_verify_detached - Manual" />
<meta itemprop="description" content="Verify signature for the message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Verify signature for the message" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-stream.php">
          sodium_crypto_stream &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-sign-seed-keypair.php">
          &laquo; sodium_crypto_sign_seed_keypair        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-sign-verify-detached.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-sign-verify-detached.php'>German</option>
            <option value='es/function.sodium-crypto-sign-verify-detached.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-sign-verify-detached.php'>French</option>
            <option value='it/function.sodium-crypto-sign-verify-detached.php'>Italian</option>
            <option value='ja/function.sodium-crypto-sign-verify-detached.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-sign-verify-detached.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-sign-verify-detached.php'>Russian</option>
            <option value='tr/function.sodium-crypto-sign-verify-detached.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-sign-verify-detached.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-sign-verify-detached.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-sign-verify-detached" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_sign_verify_detached</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_sign_verify_detached</span> &mdash; <span class="dc-title">Verify signature for the message</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-sign-verify-detached-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_sign_verify_detached</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$signature</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$public_key</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-sign-verify-detached-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      The cryptographic signature obtained from <span class="function"><a href="function.sodium-crypto-sign-detached.php" class="function">sodium_crypto_sign_detached()</a></span>
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-sign-verify-detached-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-sign-verify-detached.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-sign-verify-detached%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-sign-verify-detached&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-sign-verify-detached.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125005">  <div class="votes">
    <div id="Vu125005">
    <a href="/manual/vote-note.php?id=125005&amp;page=function.sodium-crypto-sign-verify-detached&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125005">
    <a href="/manual/vote-note.php?id=125005&amp;page=function.sodium-crypto-sign-verify-detached&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125005" title="62% like this...">
    2
    </div>
  </div>
  <a href="#125005" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#125005"> &para;</a><div class="date" title="2020-05-12 11:50"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125005">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br />$message </span><span class="keyword">= </span><span class="string">'The quick brown fox jumped over the lazy dog.'</span><span class="keyword">;<br /><br /></span><span class="comment"># Generate keypair<br /></span><span class="default">$keyPair </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_keypair</span><span class="keyword">();<br /><br /></span><span class="comment"># Sign a message<br /></span><span class="default">$secKey </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_secretkey</span><span class="keyword">(</span><span class="default">$keyPair</span><span class="keyword">);<br /></span><span class="default">$signature </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_detached</span><span class="keyword">(</span><span class="default">$message</span><span class="keyword">, </span><span class="default">$secKey</span><span class="keyword">);<br /><br /></span><span class="comment"># Verify a message<br /></span><span class="default">$pubKey </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_publickey</span><span class="keyword">(</span><span class="default">$keyPair</span><span class="keyword">);<br /></span><span class="default">$verifyResult </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_verify_detached</span><span class="keyword">(</span><span class="default">$signature</span><span class="keyword">, </span><span class="default">$message</span><span class="keyword">, </span><span class="default">$pubKey</span><span class="keyword">);<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$verifyResult</span><span class="keyword">); </span><span class="comment"># true or false<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-sign-verify-detached&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-sign-verify-detached.php">＋<small>add a note</small></a></div>
