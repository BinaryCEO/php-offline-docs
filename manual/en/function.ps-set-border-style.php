...
<head>
  ...
  <title>PHP: ps_set_border_style - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-set-border-style.php">
 <link rel="shorturl" href="https://www.php.net/ps-set-border-style">
 <link rel="alternate" href="https://www.php.net/ps-set-border-style" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-set-border-dash.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-set-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-set-border-style.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-set-border-style.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-set-border-style.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-set-border-style.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-set-border-style.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-set-border-style.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-set-border-style.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-set-border-style.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-set-border-style.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-set-border-style.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-set-border-style.php" hreflang="zh">
...
<meta name="Description" content="Sets border style of annotations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_set_border_style - Manual" />
<meta name="twitter:description" content="Sets border style of annotations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_set_border_style - Manual" />
<meta itemprop="description" content="Sets border style of annotations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets border style of annotations" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-set-border-style.php' selected="selected">English</option>
            <option value='de/function.ps-set-border-style.php'>German</option>
            <option value='es/function.ps-set-border-style.php'>Spanish</option>
            <option value='fr/function.ps-set-border-style.php'>French</option>
            <option value='it/function.ps-set-border-style.php'>Italian</option>
            <option value='ja/function.ps-set-border-style.php'>Japanese</option>
            <option value='pt_BR/function.ps-set-border-style.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-set-border-style.php'>Russian</option>
            <option value='tr/function.ps-set-border-style.php'>Turkish</option>
            <option value='uk/function.ps-set-border-style.php'>Ukrainian</option>
            <option value='zh/function.ps-set-border-style.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-set-border-style" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-set-border-dash.php" class="function" rel="rdfs-seeAlso">ps_set_border_dash()</a> - Sets length of dashes for border of annotations</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-set-border-style.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-set-border-style%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-set-border-style&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-set-border-style.php">＋<small>add a note</small></a></span>
