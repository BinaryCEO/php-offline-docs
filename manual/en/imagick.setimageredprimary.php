...
<head>
  ...
  <title>PHP: Imagick::setImageRedPrimary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageredprimary.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageredprimary.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageredprimary.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageproperty.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagerenderingintent.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageredprimary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageredprimary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageredprimary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageredprimary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageredprimary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageredprimary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageredprimary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageredprimary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageredprimary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageredprimary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageredprimary.php" hreflang="zh">
...
<meta name="Description" content="Sets the image chromaticity red primary point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageRedPrimary - Manual" />
<meta name="twitter:description" content="Sets the image chromaticity red primary point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageRedPrimary - Manual" />
<meta itemprop="description" content="Sets the image chromaticity red primary point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image chromaticity red primary point" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagerenderingintent.php">
          Imagick::setImageRenderingIntent &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageproperty.php">
          &laquo; Imagick::setImageProperty        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageredprimary.php' selected="selected">English</option>
            <option value='de/imagick.setimageredprimary.php'>German</option>
            <option value='es/imagick.setimageredprimary.php'>Spanish</option>
            <option value='fr/imagick.setimageredprimary.php'>French</option>
            <option value='it/imagick.setimageredprimary.php'>Italian</option>
            <option value='ja/imagick.setimageredprimary.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageredprimary.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageredprimary.php'>Russian</option>
            <option value='tr/imagick.setimageredprimary.php'>Turkish</option>
            <option value='uk/imagick.setimageredprimary.php'>Ukrainian</option>
            <option value='zh/imagick.setimageredprimary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageredprimary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageRedPrimary</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageRedPrimary</span> &mdash; <span class="dc-title">Sets the image chromaticity red primary point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimageredprimary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageRedPrimary</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageredprimary-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageredprimary-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimageredprimary-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageredprimary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageredprimary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageredprimary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageredprimary.php">＋<small>add a note</small></a></span>
