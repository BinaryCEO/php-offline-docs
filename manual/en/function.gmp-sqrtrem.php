...
<head>
  ...
  <title>PHP: gmp_sqrtrem - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-sqrtrem.php">
 <link rel="shorturl" href="https://www.php.net/gmp-sqrtrem">
 <link rel="alternate" href="https://www.php.net/gmp-sqrtrem" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-sqrt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-strval.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-sqrtrem.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-sqrtrem.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-sqrtrem.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-sqrtrem.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-sqrtrem.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-sqrtrem.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-sqrtrem.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-sqrtrem.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-sqrtrem.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-sqrtrem.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-sqrtrem.php" hreflang="zh">
...
<meta name="Description" content="Square root with remainder" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_sqrtrem - Manual" />
<meta name="twitter:description" content="Square root with remainder" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_sqrtrem - Manual" />
<meta itemprop="description" content="Square root with remainder" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Square root with remainder" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-sqrtrem.php' selected="selected">English</option>
            <option value='de/function.gmp-sqrtrem.php'>German</option>
            <option value='es/function.gmp-sqrtrem.php'>Spanish</option>
            <option value='fr/function.gmp-sqrtrem.php'>French</option>
            <option value='it/function.gmp-sqrtrem.php'>Italian</option>
            <option value='ja/function.gmp-sqrtrem.php'>Japanese</option>
            <option value='pt_BR/function.gmp-sqrtrem.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-sqrtrem.php'>Russian</option>
            <option value='tr/function.gmp-sqrtrem.php'>Turkish</option>
            <option value='uk/function.gmp-sqrtrem.php'>Ukrainian</option>
            <option value='zh/function.gmp-sqrtrem.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-sqrtrem" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_sqrtrem</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_sqrtrem</span> &mdash; <span class="dc-title">Square root with remainder</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-sqrtrem-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_sqrtrem</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gmp-sqrtrem-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-sqrtrem-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns array where first element is the integer square root of
   <code class="parameter">num</code> and the second is the remainder
   (i.e., the difference between <code class="parameter">num</code> and the
   first element squared).
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.gmp-sqrtrem-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3354">
    <p><strong>Example #1 <span class="function"><strong>gmp_sqrtrem()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">3, 0
2, 3
1024, 0</pre>
</div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-sqrtrem.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-sqrtrem%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-sqrtrem&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-sqrtrem.php">＋<small>add a note</small></a></span>
