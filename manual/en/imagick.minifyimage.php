...
<head>
  ...
  <title>PHP: Imagick::minifyImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.minifyimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.minifyimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.minifyimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.mergeimagelayers.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.modulateimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.minifyimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.minifyimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.minifyimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.minifyimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.minifyimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.minifyimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.minifyimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.minifyimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.minifyimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.minifyimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.minifyimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::minifyImage - Manual" />
<meta name="twitter:description" content="Scales an image proportionally to half its size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::minifyImage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.modulateimage.php">
          Imagick::modulateImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.mergeimagelayers.php">
          &laquo; Imagick::mergeImageLayers        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.minifyimage.php' selected="selected">English</option>
            <option value='de/imagick.minifyimage.php'>German</option>
            <option value='es/imagick.minifyimage.php'>Spanish</option>
            <option value='fr/imagick.minifyimage.php'>French</option>
            <option value='it/imagick.minifyimage.php'>Italian</option>
            <option value='ja/imagick.minifyimage.php'>Japanese</option>
            <option value='pt_BR/imagick.minifyimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.minifyimage.php'>Russian</option>
            <option value='tr/imagick.minifyimage.php'>Turkish</option>
            <option value='uk/imagick.minifyimage.php'>Ukrainian</option>
            <option value='zh/imagick.minifyimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.minifyimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::minifyImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::minifyImage</span> &mdash; <span class="dc-title">Scales an image proportionally to half its size</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.minifyimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::minifyImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.minifyimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.minifyimage-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/minifyimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.minifyimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.minifyimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.minifyimage.php">＋<small>add a note</small></a></span>
