...
<head>
  ...
  <title>PHP: ibase_db_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-db-info.php">
 <link rel="shorturl" href="https://www.php.net/ibase-db-info">
 <link rel="alternate" href="https://www.php.net/ibase-db-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-connect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-delete-user.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-db-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-db-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-db-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-db-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-db-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-db-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-db-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-db-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-db-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-db-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-db-info.php" hreflang="zh">
...
<meta name="Description" content="Request statistics about a database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_db_info - Manual" />
<meta name="twitter:description" content="Request statistics about a database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_db_info - Manual" />
<meta itemprop="description" content="Request statistics about a database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Request statistics about a database" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-delete-user.php">
          ibase_delete_user &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-connect.php">
          &laquo; ibase_connect        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-db-info.php' selected="selected">English</option>
            <option value='de/function.ibase-db-info.php'>German</option>
            <option value='es/function.ibase-db-info.php'>Spanish</option>
            <option value='fr/function.ibase-db-info.php'>French</option>
            <option value='it/function.ibase-db-info.php'>Italian</option>
            <option value='ja/function.ibase-db-info.php'>Japanese</option>
            <option value='pt_BR/function.ibase-db-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-db-info.php'>Russian</option>
            <option value='tr/function.ibase-db-info.php'>Turkish</option>
            <option value='uk/function.ibase-db-info.php'>Ukrainian</option>
            <option value='zh/function.ibase-db-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-db-info" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_db_info</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_db_info</span> &mdash; <span class="dc-title">Request statistics about a database</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-db-info-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_db_info</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$service_handle</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$db</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$action</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$argument</code><span class="initializer"> = 0</span></span><br>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
currently not documented; only its argument list is available.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-db-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-db-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-db-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-db-info.php">＋<small>add a note</small></a></span>
