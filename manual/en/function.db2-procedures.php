...
<head>
  ...
  <title>PHP: db2_procedures - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-procedures.php">
 <link rel="shorturl" href="https://www.php.net/db2-procedures">
 <link rel="alternate" href="https://www.php.net/db2-procedures" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-procedure-columns.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-result.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-procedures.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-procedures.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-procedures.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-procedures.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-procedures.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-procedures.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-procedures.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-procedures.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-procedures.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-procedures.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-procedures.php" hreflang="zh">
...
<meta name="Description" content="Returns a result set listing the stored procedures registered in a database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_procedures - Manual" />
<meta name="twitter:description" content="Returns a result set listing the stored procedures registered in a database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_procedures - Manual" />
<meta itemprop="description" content="Returns a result set listing the stored procedures registered in a database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a result set listing the stored procedures registered in a database" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.db2-result.php">
          db2_result &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-procedure-columns.php">
          &laquo; db2_procedure_columns        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-procedures.php' selected="selected">English</option>
            <option value='de/function.db2-procedures.php'>German</option>
            <option value='es/function.db2-procedures.php'>Spanish</option>
            <option value='fr/function.db2-procedures.php'>French</option>
            <option value='it/function.db2-procedures.php'>Italian</option>
            <option value='ja/function.db2-procedures.php'>Japanese</option>
            <option value='pt_BR/function.db2-procedures.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-procedures.php'>Russian</option>
            <option value='tr/function.db2-procedures.php'>Turkish</option>
            <option value='uk/function.db2-procedures.php'>Ukrainian</option>
            <option value='zh/function.db2-procedures.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-procedures" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">db2_procedures</h1>
  <p class="verinfo">(PECL ibm_db2 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">db2_procedures</span> &mdash; <span class="dc-title">
   Returns a result set listing the stored procedures registered in a database
  </span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.db2-procedures-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_procedures</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$connection</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$qualifier</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$schema</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$procedure</code></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.db2-procedures-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-procedures-returnvalues">
  ...
  <p class="para">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
       <tr>
        <td>PROCEDURE_CAT</td>
        <td>The catalog that contains the procedure. The value is <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if
       ...
       <tr>
        ...
        <td>Always returns <code class="literal">1</code>, indicating that the stored
 ...
 <div class="refsect1 seealso" id="refsect1-function.db2-procedures-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-tables.php" class="function" rel="rdfs-seeAlso">db2_tables()</a> - Returns a result set listing the tables and associated metadata in a database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-procedures.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-procedures%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-procedures&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-procedures.php">＋<small>add a note</small></a></span>
