...
<head>
  ...
  <title>PHP: Gmagick::getimagecompose - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagecompose.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagecompose.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagecompose.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagecolorspace.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagedelay.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagecompose.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagecompose.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagecompose.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagecompose.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagecompose.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagecompose.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagecompose.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagecompose.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagecompose.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagecompose.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagecompose.php" hreflang="zh">
...
<meta name="Description" content="Returns the composite operator associated with the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::getimagecompose - Manual" />
<meta name="twitter:description" content="Returns the composite operator associated with the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagecompose - Manual" />
<meta itemprop="description" content="Returns the composite operator associated with the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the composite operator associated with the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.getimagedelay.php">
          Gmagick::getimagedelay &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagecolorspace.php">
          &laquo; Gmagick::getimagecolorspace        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagecompose.php' selected="selected">English</option>
            <option value='de/gmagick.getimagecompose.php'>German</option>
            <option value='es/gmagick.getimagecompose.php'>Spanish</option>
            <option value='fr/gmagick.getimagecompose.php'>French</option>
            <option value='it/gmagick.getimagecompose.php'>Italian</option>
            <option value='ja/gmagick.getimagecompose.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagecompose.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagecompose.php'>Russian</option>
            <option value='tr/gmagick.getimagecompose.php'>Turkish</option>
            <option value='uk/gmagick.getimagecompose.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagecompose.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagecompose" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagecompose</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagecompose</span> &mdash; <span class="dc-title">Returns the composite operator associated with the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagecompose-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagecompose</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagecompose-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagecompose-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagecompose-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagecompose.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagecompose%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagecompose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagecompose.php">＋<small>add a note</small></a></span>
