...
<head>
  ...
  <title>PHP: gzclose - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gzclose.php">
 <link rel="shorturl" href="https://www.php.net/gzclose">
 <link rel="alternate" href="https://www.php.net/gzclose" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.zlib.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.deflate-init.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gzcompress.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gzclose.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gzclose.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gzclose.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gzclose.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gzclose.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gzclose.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gzclose.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gzclose.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gzclose.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gzclose.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gzclose.php" hreflang="zh">
...
<meta name="Description" content="Close an open gz-file pointer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gzclose - Manual" />
<meta name="twitter:description" content="Close an open gz-file pointer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gzclose - Manual" />
<meta itemprop="description" content="Close an open gz-file pointer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close an open gz-file pointer" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gzclose.php' selected="selected">English</option>
            <option value='de/function.gzclose.php'>German</option>
            <option value='es/function.gzclose.php'>Spanish</option>
            <option value='fr/function.gzclose.php'>French</option>
            <option value='it/function.gzclose.php'>Italian</option>
            <option value='ja/function.gzclose.php'>Japanese</option>
            <option value='pt_BR/function.gzclose.php'>Brazilian Portuguese</option>
            <option value='ru/function.gzclose.php'>Russian</option>
            <option value='tr/function.gzclose.php'>Turkish</option>
            <option value='uk/function.gzclose.php'>Ukrainian</option>
            <option value='zh/function.gzclose.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gzclose" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gzclose</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gzclose</span> &mdash; <span class="dc-title">Close an open gz-file pointer</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-function.gzclose-examples">
  ...
  <p class="para">
   <div class="example" id="example-961">
    <p><strong>Example #1 <span class="function"><strong>gzclose()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.gzopen.php" class="function" rel="rdfs-seeAlso">gzopen()</a> - Open gz-file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zlib/functions/gzclose.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gzclose%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gzclose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gzclose.php">＋<small>add a note</small></a></span>
