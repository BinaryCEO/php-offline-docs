...
<head>
  ...
  <title>PHP: SolrQuery::getTermsLowerBound - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gettermslowerbound.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gettermslowerbound.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermslowerbound.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gettermslimit.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gettermsmaxcount.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermslowerbound.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gettermslowerbound.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gettermslowerbound.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gettermslowerbound.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gettermslowerbound.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gettermslowerbound.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gettermslowerbound.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gettermslowerbound.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gettermslowerbound.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gettermslowerbound.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gettermslowerbound.php" hreflang="zh">
...
<meta name="Description" content="Returns the term to start at" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getTermsLowerBound - Manual" />
<meta name="twitter:description" content="Returns the term to start at" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getTermsLowerBound - Manual" />
<meta itemprop="description" content="Returns the term to start at" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the term to start at" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gettermsmaxcount.php">
          SolrQuery::getTermsMaxCount &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gettermslimit.php">
          &laquo; SolrQuery::getTermsLimit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gettermslowerbound.php' selected="selected">English</option>
            <option value='de/solrquery.gettermslowerbound.php'>German</option>
            <option value='es/solrquery.gettermslowerbound.php'>Spanish</option>
            <option value='fr/solrquery.gettermslowerbound.php'>French</option>
            <option value='it/solrquery.gettermslowerbound.php'>Italian</option>
            <option value='ja/solrquery.gettermslowerbound.php'>Japanese</option>
            <option value='pt_BR/solrquery.gettermslowerbound.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gettermslowerbound.php'>Russian</option>
            <option value='tr/solrquery.gettermslowerbound.php'>Turkish</option>
            <option value='uk/solrquery.gettermslowerbound.php'>Ukrainian</option>
            <option value='zh/solrquery.gettermslowerbound.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gettermslowerbound" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getTermsLowerBound</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getTermsLowerBound</span> &mdash; <span class="dc-title">Returns the term to start at</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gettermslowerbound-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getTermsLowerBound</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gettermslowerbound-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gettermslowerbound-returnvalues">
...
Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gettermslowerbound.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gettermslowerbound%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gettermslowerbound&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gettermslowerbound.php">＋<small>add a note</small></a></span>
