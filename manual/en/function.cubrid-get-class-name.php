...
<head>
  ...
  <title>PHP: cubrid_get_class_name - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-get-class-name.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-get-class-name">
 <link rel="alternate" href="https://www.php.net/cubrid-get-class-name" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-get-charset.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-get-client-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-get-class-name.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-get-class-name.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-get-class-name.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-get-class-name.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-get-class-name.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-get-class-name.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-get-class-name.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-get-class-name.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-get-class-name.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-get-class-name.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-get-class-name.php" hreflang="zh">
...
<meta name="Description" content="Get the class name using OID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_get_class_name - Manual" />
<meta name="twitter:description" content="Get the class name using OID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_get_class_name - Manual" />
<meta itemprop="description" content="Get the class name using OID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the class name using OID" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-get-client-info.php">
          cubrid_get_client_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-get-charset.php">
          &laquo; cubrid_get_charset        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-get-class-name.php' selected="selected">English</option>
            <option value='de/function.cubrid-get-class-name.php'>German</option>
            <option value='es/function.cubrid-get-class-name.php'>Spanish</option>
            <option value='fr/function.cubrid-get-class-name.php'>French</option>
            <option value='it/function.cubrid-get-class-name.php'>Italian</option>
            <option value='ja/function.cubrid-get-class-name.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-get-class-name.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-get-class-name.php'>Russian</option>
            <option value='tr/function.cubrid-get-class-name.php'>Turkish</option>
            <option value='uk/function.cubrid-get-class-name.php'>Ukrainian</option>
            <option value='zh/function.cubrid-get-class-name.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-get-class-name" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_get_class_name</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_get_class_name</span> &mdash; <span class="dc-title">Get the class name using OID</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-get-class-name-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_get_class_name</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$oid</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_get_class_name()</strong></span> function is used to get the
    class name from <code class="parameter">oid</code>. It doesn&#039;t work when selecting data from the system tables,
    for example db_class.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.cubrid-get-class-name-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-get-class-name-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
    Class name when process is successful, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.cubrid-get-class-name-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-1239">
   <p><strong>Example #1 <span class="function"><strong>cubrid_get_class_name()</strong></span> example</strong></p>
   <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #0000BB">33000</span><span style="color: #007700">, </span><span style="color: #DD0000">"demodb"</span><span style="color: #007700">, </span><span style="color: #DD0000">"dba"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$req </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"SELECT * FROM code"</span><span style="color: #007700">, </span><span style="color: #0000BB">CUBRID_INCLUDE_OID</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$oid </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_current_oid</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$class_name </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_get_class_name</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$oid</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">$class_name</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_disconnect</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>

    <div class="example-contents"><p>The above example will output:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">code</pre>
</div>
   </div>
  </div>
 </div>
  ...
  <div class="refsect1 seealso" id="refsect1-function.cubrid-get-class-name-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
   <li><span class="function"><a href="function.cubrid-is-instance.php" class="function" rel="rdfs-seeAlso">cubrid_is_instance()</a> - Check whether the instance pointed by OID exists</span></li>
   <li><span class="function"><a href="function.cubrid-drop.php" class="function" rel="rdfs-seeAlso">cubrid_drop()</a> - Delete an instance using OID</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-get-class-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-get-class-name%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-get-class-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-get-class-name.php">＋<small>add a note</small></a></span>
