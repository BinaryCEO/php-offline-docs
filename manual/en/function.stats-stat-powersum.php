...
<head>
  ...
  <title>PHP: stats_stat_powersum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-stat-powersum.php">
 <link rel="shorturl" href="https://www.php.net/stats-stat-powersum">
 <link rel="alternate" href="https://www.php.net/stats-stat-powersum" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-stat-percentile.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-variance.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-stat-powersum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-stat-powersum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-stat-powersum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-stat-powersum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-stat-powersum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-stat-powersum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-stat-powersum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-stat-powersum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-stat-powersum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-stat-powersum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-stat-powersum.php" hreflang="zh">
...
<meta name="Description" content="Returns the power sum of a vector" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_stat_powersum - Manual" />
<meta name="twitter:description" content="Returns the power sum of a vector" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_stat_powersum - Manual" />
<meta itemprop="description" content="Returns the power sum of a vector" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the power sum of a vector" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stats-variance.php">
          stats_variance &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-stat-percentile.php">
          &laquo; stats_stat_percentile        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-stat-powersum.php' selected="selected">English</option>
            <option value='de/function.stats-stat-powersum.php'>German</option>
            <option value='es/function.stats-stat-powersum.php'>Spanish</option>
            <option value='fr/function.stats-stat-powersum.php'>French</option>
            <option value='it/function.stats-stat-powersum.php'>Italian</option>
            <option value='ja/function.stats-stat-powersum.php'>Japanese</option>
            <option value='pt_BR/function.stats-stat-powersum.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-stat-powersum.php'>Russian</option>
            <option value='tr/function.stats-stat-powersum.php'>Turkish</option>
            <option value='uk/function.stats-stat-powersum.php'>Ukrainian</option>
            <option value='zh/function.stats-stat-powersum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-stat-powersum" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_stat_powersum</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_stat_powersum</span> &mdash; <span class="dc-title">Returns the power sum of a vector</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-stat-powersum-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_stat_powersum</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$arr</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$power</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stats-stat-powersum-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">power</code></dt>
     <dd>
      <p class="para">
       The power
      </p>
  ...
  <p class="para">
   Returns the power sum of the input array.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-stat-powersum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-stat-powersum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-stat-powersum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-stat-powersum.php">＋<small>add a note</small></a></span>
