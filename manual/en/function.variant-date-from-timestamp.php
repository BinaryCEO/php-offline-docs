...
<head>
  ...
  <title>PHP: variant_date_from_timestamp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-date-from-timestamp.php">
 <link rel="shorturl" href="https://www.php.net/variant-date-from-timestamp">
 <link rel="alternate" href="https://www.php.net/variant-date-from-timestamp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-cmp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-date-to-timestamp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.variant-date-from-timestamp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.variant-date-from-timestamp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.variant-date-from-timestamp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.variant-date-from-timestamp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.variant-date-from-timestamp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.variant-date-from-timestamp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.variant-date-from-timestamp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.variant-date-from-timestamp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.variant-date-from-timestamp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.variant-date-from-timestamp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.variant-date-from-timestamp.php" hreflang="zh">
...
<meta name="Description" content="Returns a variant date representation of a Unix timestamp" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant_date_from_timestamp - Manual" />
<meta name="twitter:description" content="Returns a variant date representation of a Unix timestamp" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant_date_from_timestamp - Manual" />
<meta itemprop="description" content="Returns a variant date representation of a Unix timestamp" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a variant date representation of a Unix timestamp" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.variant-date-to-timestamp.php">
          variant_date_to_timestamp &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.variant-cmp.php">
          &laquo; variant_cmp        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-date-from-timestamp.php' selected="selected">English</option>
            <option value='de/function.variant-date-from-timestamp.php'>German</option>
            <option value='es/function.variant-date-from-timestamp.php'>Spanish</option>
            <option value='fr/function.variant-date-from-timestamp.php'>French</option>
            <option value='it/function.variant-date-from-timestamp.php'>Italian</option>
            <option value='ja/function.variant-date-from-timestamp.php'>Japanese</option>
            <option value='pt_BR/function.variant-date-from-timestamp.php'>Brazilian Portuguese</option>
            <option value='ru/function.variant-date-from-timestamp.php'>Russian</option>
            <option value='tr/function.variant-date-from-timestamp.php'>Turkish</option>
            <option value='uk/function.variant-date-from-timestamp.php'>Ukrainian</option>
            <option value='zh/function.variant-date-from-timestamp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.variant-date-from-timestamp" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.time.php" class="function" rel="rdfs-seeAlso">time()</a> - Return current Unix timestamp</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-date-from-timestamp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-date-from-timestamp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-date-from-timestamp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-date-from-timestamp.php">＋<small>add a note</small></a></span>
