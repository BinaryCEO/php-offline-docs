...
<head>
  ...
  <title>PHP: Imagick::setImageInterlaceScheme - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageinterlacescheme.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageinterlacescheme.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageinterlacescheme.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageindex.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageinterpolatemethod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageinterlacescheme.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageinterlacescheme.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageinterlacescheme.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageinterlacescheme.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageinterlacescheme.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageinterlacescheme.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageinterlacescheme.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageinterlacescheme.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageinterlacescheme.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageinterlacescheme.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageinterlacescheme.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::setImageInterlaceScheme - Manual" />
<meta name="twitter:description" content="Sets the image compression" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageInterlaceScheme - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimageinterpolatemethod.php">
          Imagick::setImageInterpolateMethod &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageindex.php">
          &laquo; Imagick::setImageIndex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageinterlacescheme.php' selected="selected">English</option>
            <option value='de/imagick.setimageinterlacescheme.php'>German</option>
            <option value='es/imagick.setimageinterlacescheme.php'>Spanish</option>
            <option value='fr/imagick.setimageinterlacescheme.php'>French</option>
            <option value='it/imagick.setimageinterlacescheme.php'>Italian</option>
            <option value='ja/imagick.setimageinterlacescheme.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageinterlacescheme.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageinterlacescheme.php'>Russian</option>
            <option value='tr/imagick.setimageinterlacescheme.php'>Turkish</option>
            <option value='uk/imagick.setimageinterlacescheme.php'>Ukrainian</option>
            <option value='zh/imagick.setimageinterlacescheme.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageinterlacescheme" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageInterlaceScheme</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageInterlaceScheme</span> &mdash; <span class="dc-title">Sets the image compression</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimageinterlacescheme-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageInterlaceScheme</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$interlace_scheme</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageinterlacescheme-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageinterlacescheme-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimageinterlacescheme-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageinterlacescheme.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageinterlacescheme%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageinterlacescheme&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageinterlacescheme.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116157">  <div class="votes">
    <div id="Vu116157">
    <a href="/manual/vote-note.php?id=116157&amp;page=imagick.setimageinterlacescheme&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116157">
    <a href="/manual/vote-note.php?id=116157&amp;page=imagick.setimageinterlacescheme&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116157" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#116157" class="name">
  <strong class="user"><em>WJS</em></strong></a><a class="genanchor" href="#116157"> &para;</a><div class="date" title="2014-11-17 03:21"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116157">
<div class="phpcode"><code><span class="html">This function doesn't appear to do anything. Use setInterlaceScheme instead.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimageinterlacescheme&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageinterlacescheme.php">＋<small>add a note</small></a></div>
