...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageiterations.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageiterations.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageiterations.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageinterpolatemethod.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagelength.php">
...
<meta name="Description" content="Gets the image iterations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageIterations - Manual" />
<meta name="twitter:description" content="Gets the image iterations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageIterations - Manual" />
<meta itemprop="description" content="Gets the image iterations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image iterations" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageiterations.php' selected="selected">English</option>
            ...
            <option value='tr/imagick.getimageiterations.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageIterations</span> &mdash; <span class="dc-title">Gets the image iterations</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimageiterations-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageIterations</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageiterations.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageiterations%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageiterations&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageiterations.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>admin at zasmeshi dot ru</em></strong></a><a class="genanchor" href="#120331"> &para;</a><div class="date" title="2016-12-14 12:57"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120331">
<div class="phpcode"><code><span class="html">If you want get the number of the animation (GIF) frames you need to use Imagick::getNumberImages()</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">By using the PHP function getImageIterations, you'll receive back a value indicating the animated nature of the image.  You'll get back a '0' for a still image that is not animated (like a .BMP or a .JPEG file) and a '1' for an animated image (like an animated .GIF file).<br /><br />I have been unable to get any other results from this function, after extensive use.  There is some discussion among the ImageMagick user's group saying that the Iterations should indicate the number of times an animated .Gif file repeats itself.  However, it's possible that either modern browsers default the value to infinity or that this ImageMagick functionality is only available at the Linux command-line.  See more at the discussion group here: <a href="http://studio.imagemagick.org/pipermail/magick-users/2002-October/005814.html" rel="nofollow" target="_blank">http://studio.imagemagick.org/pipermail/magick-users/2002-October/005814.html</a><br /><br />And some sample code :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.gif"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get Image Iterations<br />        //    (Detect Animated Image Versus Non-Animated Image)<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$image_iterations </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageIterations</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Print Iteration Value Interpreted<br />        // ---------------------------------------------<br />    <br />    </span><span class="keyword">if(</span><span class="default">$image_iterations </span><span class="keyword">== </span><span class="default">1</span><span class="keyword">)<br />    {<br />        print(</span><span class="string">"</span><span class="default">$file_to_grab</span><span class="string"> *IS* an animated image."</span><span class="keyword">);<br />    }<br />    else<br />    {<br />        print(</span><span class="string">"</span><span class="default">$file_to_grab</span><span class="string"> *IS NOT* an animated image."</span><span class="keyword">);<br />    }<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimageiterations&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageiterations.php">＋<small>add a note</small></a></div>
