...
<head>
  ...
  <title>PHP: Gmagick::spreadimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.spreadimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.spreadimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.spreadimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.solarizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.stripimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.spreadimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.spreadimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.spreadimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.spreadimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.spreadimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.spreadimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.spreadimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.spreadimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.spreadimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.spreadimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.spreadimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::spreadimage - Manual" />
<meta name="twitter:description" content="Randomly displaces each pixel in a block" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::spreadimage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.stripimage.php">
          Gmagick::stripimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.solarizeimage.php">
          &laquo; Gmagick::solarizeimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.spreadimage.php' selected="selected">English</option>
            <option value='de/gmagick.spreadimage.php'>German</option>
            <option value='es/gmagick.spreadimage.php'>Spanish</option>
            <option value='fr/gmagick.spreadimage.php'>French</option>
            <option value='it/gmagick.spreadimage.php'>Italian</option>
            <option value='ja/gmagick.spreadimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.spreadimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.spreadimage.php'>Russian</option>
            <option value='tr/gmagick.spreadimage.php'>Turkish</option>
            <option value='uk/gmagick.spreadimage.php'>Ukrainian</option>
            <option value='zh/gmagick.spreadimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.spreadimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::spreadimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::spreadimage</span> &mdash; <span class="dc-title">Randomly displaces each pixel in a block</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.spreadimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::spreadimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.spreadimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.spreadimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.spreadimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/spreadimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.spreadimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.spreadimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.spreadimage.php">＋<small>add a note</small></a></span>
