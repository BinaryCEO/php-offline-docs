...
<head>
  ...
  <title>PHP: is_iterable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.is-iterable.php">
 <link rel="shorturl" href="https://www.php.net/is-iterable">
 <link rel="alternate" href="https://www.php.net/is-iterable" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.var.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.is-integer.php">
 <link rel="next" href="https://www.php.net/manual/en/function.is-long.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.is-iterable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.is-iterable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.is-iterable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.is-iterable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.is-iterable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.is-iterable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.is-iterable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.is-iterable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.is-iterable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.is-iterable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.is-iterable.php" hreflang="zh">
...
<meta name="Description" content="Verify that the contents of a variable is an iterable value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: is_iterable - Manual" />
<meta name="twitter:description" content="Verify that the contents of a variable is an iterable value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: is_iterable - Manual" />
<meta itemprop="description" content="Verify that the contents of a variable is an iterable value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Verify that the contents of a variable is an iterable value" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.is-iterable.php' selected="selected">English</option>
            <option value='de/function.is-iterable.php'>German</option>
            <option value='es/function.is-iterable.php'>Spanish</option>
            <option value='fr/function.is-iterable.php'>French</option>
            <option value='it/function.is-iterable.php'>Italian</option>
            <option value='ja/function.is-iterable.php'>Japanese</option>
            <option value='pt_BR/function.is-iterable.php'>Brazilian Portuguese</option>
            <option value='ru/function.is-iterable.php'>Russian</option>
            <option value='tr/function.is-iterable.php'>Turkish</option>
            <option value='uk/function.is-iterable.php'>Ukrainian</option>
            <option value='zh/function.is-iterable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.is-iterable" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.is-iterable-examples">
  ...
  <p class="para">
   <div class="example" id="example-5654">
    <p><strong>Example #1 <span class="function"><strong>is_iterable()</strong></span> examples</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.is-array.php" class="function" rel="rdfs-seeAlso">is_array()</a> - Finds whether a variable is an array</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/var/functions/is-iterable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.is-iterable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.is-iterable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-iterable.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122574">  <div class="votes">
    <div id="Vu122574">
    <a href="/manual/vote-note.php?id=122574&amp;page=function.is-iterable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122574">
    <a href="/manual/vote-note.php?id=122574&amp;page=function.is-iterable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122574" title="90% like this...">
    35
    </div>
  </div>
  <a href="#122574" class="name">
  <strong class="user"><em>mopsyd at me dot com</em></strong></a><a class="genanchor" href="#122574"> &para;</a><div class="date" title="2018-04-01 04:24"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122574">
<div class="phpcode"><code><span class="html">A slight correction to brcontainer's polyfill, which prevents errors on a non-object in a non-blocking way, and also corrects the issue of  the conditional checking "file_exists" instead of the correct "function_exists":<br /><br />if ( !function_exists(  'is_iterable' ) )<br />{<br /><br />    function is_iterable( $obj )<br />    {<br />        return is_array( $obj ) || ( is_object( $obj ) &amp;&amp; ( $obj instanceof \Traversable ) );<br />    }<br /><br />}<br /><br />The original answer would not have resolved correctly, because it was looking for a file instead of a function, and the provided method would error if given a non-iterable non-object value such as false.</span></code></div>
  </div>
 </div>
  <div class="note" id="122340">  <div class="votes">
    <div id="Vu122340">
    <a href="/manual/vote-note.php?id=122340&amp;page=function.is-iterable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122340">
    <a href="/manual/vote-note.php?id=122340&amp;page=function.is-iterable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122340" title="33% like this...">
    -2
    </div>
  </div>
  <a href="#122340" class="name">
  <strong class="user"><em>anatoly dot pashin at gmail dot com</em></strong></a><a class="genanchor" href="#122340"> &para;</a><div class="date" title="2018-02-01 07:02"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122340">
<div class="phpcode"><code><span class="html">Here is more details on iterable type: <a href="http://php.net/manual/en/language.types.iterable.php" rel="nofollow" target="_blank">http://php.net/manual/en/language.types.iterable.php</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.is-iterable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-iterable.php">＋<small>add a note</small></a></div>
