...
<head>
  ...
  <title>PHP: Memcached::deleteMulti - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.deletemulti.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.deletemulti.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.deletemulti.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.deletebykey.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.deletemultibykey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.deletemulti.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.deletemulti.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.deletemulti.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.deletemulti.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.deletemulti.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.deletemulti.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.deletemulti.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.deletemulti.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.deletemulti.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.deletemulti.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.deletemulti.php" hreflang="zh">
...
<meta name="Description" content="Delete multiple items" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::deleteMulti - Manual" />
<meta name="twitter:description" content="Delete multiple items" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::deleteMulti - Manual" />
<meta itemprop="description" content="Delete multiple items" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete multiple items" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="memcached.deletemultibykey.php">
          Memcached::deleteMultiByKey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.deletebykey.php">
          &laquo; Memcached::deleteByKey        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.deletemulti.php' selected="selected">English</option>
            <option value='de/memcached.deletemulti.php'>German</option>
            <option value='es/memcached.deletemulti.php'>Spanish</option>
            <option value='fr/memcached.deletemulti.php'>French</option>
            <option value='it/memcached.deletemulti.php'>Italian</option>
            <option value='ja/memcached.deletemulti.php'>Japanese</option>
            <option value='pt_BR/memcached.deletemulti.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.deletemulti.php'>Russian</option>
            <option value='tr/memcached.deletemulti.php'>Turkish</option>
            <option value='uk/memcached.deletemulti.php'>Ukrainian</option>
            <option value='zh/memcached.deletemulti.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.deletemulti" class="refentry">
 ...
 <div class="refsect1 seealso" id="refsect1-memcached.deletemulti-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="memcached.deletemultibykey.php" class="methodname" rel="rdfs-seeAlso">Memcached::deleteMultiByKey()</a> - Delete multiple items from a specific server</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/deletemulti.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.deletemulti%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.deletemulti&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.deletemulti.php">＋<small>add a note</small></a></span>
