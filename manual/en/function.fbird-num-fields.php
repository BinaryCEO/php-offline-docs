...
<head>
  ...
  <title>PHP: fbird_num_fields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-num-fields.php">
 <link rel="shorturl" href="https://www.php.net/fbird-num-fields">
 <link rel="alternate" href="https://www.php.net/fbird-num-fields" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-name-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-num-params.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-num-fields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-num-fields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-num-fields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-num-fields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-num-fields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-num-fields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-num-fields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-num-fields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-num-fields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-num-fields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-num-fields.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_num_fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_num_fields - Manual" />
<meta name="twitter:description" content="Alias of ibase_num_fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_num_fields - Manual" />
<meta itemprop="description" content="Alias of ibase_num_fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_num_fields" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fbird-num-params.php">
          fbird_num_params &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-name-result.php">
          &laquo; fbird_name_result        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-num-fields.php' selected="selected">English</option>
            <option value='de/function.fbird-num-fields.php'>German</option>
            <option value='es/function.fbird-num-fields.php'>Spanish</option>
            <option value='fr/function.fbird-num-fields.php'>French</option>
            <option value='it/function.fbird-num-fields.php'>Italian</option>
            <option value='ja/function.fbird-num-fields.php'>Japanese</option>
            <option value='pt_BR/function.fbird-num-fields.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-num-fields.php'>Russian</option>
            <option value='tr/function.fbird-num-fields.php'>Turkish</option>
            <option value='uk/function.fbird-num-fields.php'>Ukrainian</option>
            <option value='zh/function.fbird-num-fields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-num-fields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_num_fields</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_num_fields</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-num-fields.php" class="function">ibase_num_fields()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-num-fields-description">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fbird-num-fields-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-field-info.php" class="function" rel="rdfs-seeAlso">fbird_field_info()</a> - Alias of ibase_field_info</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-num-fields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-num-fields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-num-fields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-num-fields.php">＋<small>add a note</small></a></span>
