...
<head>
  ...
  <title>PHP: SolrQuery::setOmitHeader - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setomitheader.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setomitheader.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setomitheader.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setmltminwordlength.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setquery.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setomitheader.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setomitheader.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setomitheader.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setomitheader.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setomitheader.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setomitheader.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setomitheader.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setomitheader.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setomitheader.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setomitheader.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setomitheader.php" hreflang="zh">
...
<meta name="Description" content="Exclude the header from the returned results" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setOmitHeader - Manual" />
<meta name="twitter:description" content="Exclude the header from the returned results" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setOmitHeader - Manual" />
<meta itemprop="description" content="Exclude the header from the returned results" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exclude the header from the returned results" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setquery.php">
          SolrQuery::setQuery &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setmltminwordlength.php">
          &laquo; SolrQuery::setMltMinWordLength        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setomitheader.php' selected="selected">English</option>
            <option value='de/solrquery.setomitheader.php'>German</option>
            <option value='es/solrquery.setomitheader.php'>Spanish</option>
            <option value='fr/solrquery.setomitheader.php'>French</option>
            <option value='it/solrquery.setomitheader.php'>Italian</option>
            <option value='ja/solrquery.setomitheader.php'>Japanese</option>
            <option value='pt_BR/solrquery.setomitheader.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setomitheader.php'>Russian</option>
            <option value='tr/solrquery.setomitheader.php'>Turkish</option>
            <option value='uk/solrquery.setomitheader.php'>Ukrainian</option>
            <option value='zh/solrquery.setomitheader.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setomitheader" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setOmitHeader</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setOmitHeader</span> &mdash; <span class="dc-title">Exclude the header from the returned results</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setomitheader-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setOmitHeader</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setomitheader-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> excludes the header from the result.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setomitheader-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setomitheader.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setomitheader%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setomitheader&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setomitheader.php">＋<small>add a note</small></a></span>
