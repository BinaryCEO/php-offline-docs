...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.ellipse.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.ellipse.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.ellipse.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.destroy.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getclippath.php">
...
<meta name="Description" content="Draws an ellipse on the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::ellipse - Manual" />
<meta name="twitter:description" content="Draws an ellipse on the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::ellipse - Manual" />
<meta itemprop="description" content="Draws an ellipse on the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws an ellipse on the image" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.ellipse.php' selected="selected">English</option>
            ...
            <option value='tr/imagickdraw.ellipse.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::ellipse</span> &mdash; <span class="dc-title">Draws an ellipse on the image</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.ellipse-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">radius_x</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
     ...
     <dt><code class="parameter">radius_y</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
     ...
     <dt><code class="parameter">angle_start</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
     ...
     <dt><code class="parameter">angle_end</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.ellipse-examples">
  ...
  <p class="para">
    <div class="example" id="example-3150">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::ellipse()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/ellipse.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.ellipse%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.ellipse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.ellipse.php">＋<small>add a note</small></a></span>
...
<br /> * Please note that if you use a stroke. ( Imagick::setStrokeWidth( 2 ) ) the
<br /> * stroke is drawn outside the ellipse dimensions. 
<br /> *
<br /> * @param float $ox - Offset X, distance from the center of the ellipse till the left border of the image
<br /> * @param float $oy - Offset Y, distance from the center of the ellipse till the top of the image
<br /> * @param float $rx - X radius
<br /> * @param float $ry - Y radius
<br /> * @param float float $start - Starting angle in degrees.
<br /> * @param float float $end - End angle in degrees.
<br /> *
<br /> */
<br /></span><span class="default">ImagickDraw</span><span class="keyword">::</span><span class="default">ellipse</span><span class="keyword">( </span><span class="default">float $ox  </span><span class="keyword">, </span><span class="default">float $oy  </span><span class="keyword">, </span><span class="default">float $rx  </span><span class="keyword">, </span><span class="default">float $ry  </span><span class="keyword">, </span><span class="default">float $start  </span><span class="keyword">, </span><span class="default">float $end  </span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>
<br />Example of drawing a full ellipse (from 0, 360) and outputting it as a PNG.
<br />Do note, that this is  by default anti-aliased unlike the GD functions which only support it on lines that aren't on a transparent background.
<br /><span class="default">&lt;?php
<br />$width </span><span class="keyword">=  </span><span class="default">200</span><span class="keyword">;
<br /></span><span class="default">$height </span><span class="keyword">= </span><span class="default">100</span><span class="keyword">;
<br /></span><span class="default">$border </span><span class="keyword">= </span><span class="default">2</span><span class="keyword">;
<br />
<br /></span><span class="default">$img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();
...
<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setStrokeColor</span><span class="keyword">( new </span><span class="default">ImagickPixel</span><span class="keyword">( </span><span class="string">'black' </span><span class="keyword">) );
<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setStrokeWidth</span><span class="keyword">( </span><span class="default">2 </span><span class="keyword">);
<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">( new </span><span class="default">ImagickPixel</span><span class="keyword">( </span><span class="string">'transparent' </span><span class="keyword">) );
<br /></span><span class="comment">//Substract the border from the radius so it doesn't fall outside the screen.
<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">ellipse</span><span class="keyword">( </span><span class="default">$width</span><span class="keyword">/</span><span class="default">2</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">/</span><span class="default">2</span><span class="keyword">, (</span><span class="default">$width</span><span class="keyword">/</span><span class="default">2</span><span class="keyword">)-</span><span class="default">$border</span><span class="keyword">, (</span><span class="default">$height</span><span class="keyword">/</span><span class="default">2</span><span class="keyword">)-</span><span class="default">$border</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">360 </span><span class="keyword">);
<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">( </span><span class="default">$draw </span><span class="keyword">);
<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">( </span><span class="string">"png" </span><span class="keyword">);
<br />
...
<br />echo </span><span class="default">$img</span><span class="keyword">;
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.ellipse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.ellipse.php">＋<small>add a note</small></a></div>
