...
<head>
  ...
  <title>PHP: oci_register_taf_callback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-register-taf-callback.php">
 <link rel="shorturl" href="https://www.php.net/oci-register-taf-callback">
 <link rel="alternate" href="https://www.php.net/oci-register-taf-callback" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-pconnect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-result.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-register-taf-callback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-register-taf-callback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-register-taf-callback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-register-taf-callback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-register-taf-callback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-register-taf-callback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-register-taf-callback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-register-taf-callback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-register-taf-callback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-register-taf-callback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-register-taf-callback.php" hreflang="zh">
...
<meta name="Description" content="Register a user-defined callback function for Oracle Database TAF" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_register_taf_callback - Manual" />
<meta name="twitter:description" content="Register a user-defined callback function for Oracle Database TAF" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_register_taf_callback - Manual" />
<meta itemprop="description" content="Register a user-defined callback function for Oracle Database TAF" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Register a user-defined callback function for Oracle Database TAF" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.oci-result.php">
          oci_result &raquo;
              ...
              <div class="prev">
        <a href="function.oci-pconnect.php">
          &laquo; oci_pconnect        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-register-taf-callback.php' selected="selected">English</option>
            <option value='de/function.oci-register-taf-callback.php'>German</option>
            <option value='es/function.oci-register-taf-callback.php'>Spanish</option>
            <option value='fr/function.oci-register-taf-callback.php'>French</option>
            <option value='it/function.oci-register-taf-callback.php'>Italian</option>
            <option value='ja/function.oci-register-taf-callback.php'>Japanese</option>
            <option value='pt_BR/function.oci-register-taf-callback.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-register-taf-callback.php'>Russian</option>
            <option value='tr/function.oci-register-taf-callback.php'>Turkish</option>
            <option value='uk/function.oci-register-taf-callback.php'>Ukrainian</option>
            <option value='zh/function.oci-register-taf-callback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-register-taf-callback" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.oci-unregister-taf-callback.php" class="function" rel="rdfs-seeAlso">oci_unregister_taf_callback()</a> - Unregister a user-defined callback function for Oracle Database TAF</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-register-taf-callback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-register-taf-callback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-register-taf-callback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-register-taf-callback.php">＋<small>add a note</small></a></span>
