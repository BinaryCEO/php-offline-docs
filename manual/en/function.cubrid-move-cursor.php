...
<head>
  ...
  <title>PHP: cubrid_move_cursor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-move-cursor.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-move-cursor">
 <link rel="alternate" href="https://www.php.net/cubrid-move-cursor" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lock-write.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-next-result.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-move-cursor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-move-cursor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-move-cursor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-move-cursor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-move-cursor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-move-cursor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-move-cursor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-move-cursor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-move-cursor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-move-cursor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-move-cursor.php" hreflang="zh">
...
<meta name="Description" content="Move the cursor in the result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_move_cursor - Manual" />
<meta name="twitter:description" content="Move the cursor in the result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_move_cursor - Manual" />
<meta itemprop="description" content="Move the cursor in the result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Move the cursor in the result" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-next-result.php">
          cubrid_next_result &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-lock-write.php">
          &laquo; cubrid_lock_write        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-move-cursor.php' selected="selected">English</option>
            <option value='de/function.cubrid-move-cursor.php'>German</option>
            <option value='es/function.cubrid-move-cursor.php'>Spanish</option>
            <option value='fr/function.cubrid-move-cursor.php'>French</option>
            <option value='it/function.cubrid-move-cursor.php'>Italian</option>
            <option value='ja/function.cubrid-move-cursor.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-move-cursor.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-move-cursor.php'>Russian</option>
            <option value='tr/function.cubrid-move-cursor.php'>Turkish</option>
            <option value='uk/function.cubrid-move-cursor.php'>Ukrainian</option>
            <option value='zh/function.cubrid-move-cursor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-move-cursor" class="refentry">
 ...
 <div class="refsect1 parameters" id="refsect1-function.cubrid-move-cursor-parameters">
  ...
  <dd><p class="para">Number of units you want to move the cursor.</p></dd>
   
  
  <dt><code class="parameter">origin</code></dt>
  <dd><p class="para">Location where you want to move the cursor from <strong><code>CUBRID_CURSOR_FIRST</code></strong>, <strong><code>CUBRID_CURSOR_CURRENT</code></strong>, <strong><code>CUBRID_CURSOR_LAST</code></strong>.</p></dd>
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-execute.php" class="function" rel="rdfs-seeAlso">cubrid_execute()</a> - Execute a prepared SQL statement</span></li>   
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-move-cursor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-move-cursor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-move-cursor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-move-cursor.php">＋<small>add a note</small></a></span>
