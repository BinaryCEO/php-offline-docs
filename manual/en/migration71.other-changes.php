...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration71.other-changes.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration71.other-changes.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration71.other-changes.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration71.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration71.changed-functions.php">
 <link rel="next" href="https://www.php.net/manual/en/migration71.windows-support.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration71.other-changes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration71.other-changes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration71.other-changes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration71.other-changes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration71.other-changes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration71.other-changes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration71.other-changes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration71.other-changes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration71.other-changes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration71.other-changes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration71.other-changes.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="migration71.windows-support.php">
          Windows Support &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="migration71.changed-functions.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration71.other-changes.php' selected="selected">English</option>
            <option value='de/migration71.other-changes.php'>German</option>
            <option value='es/migration71.other-changes.php'>Spanish</option>
            <option value='fr/migration71.other-changes.php'>French</option>
            <option value='it/migration71.other-changes.php'>Italian</option>
            <option value='ja/migration71.other-changes.php'>Japanese</option>
            <option value='pt_BR/migration71.other-changes.php'>Brazilian Portuguese</option>
            <option value='ru/migration71.other-changes.php'>Russian</option>
            <option value='tr/migration71.other-changes.php'>Turkish</option>
            <option value='uk/migration71.other-changes.php'>Ukrainian</option>
            <option value='zh/migration71.other-changes.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration71.other-changes" class="sect1">
  ...
  <p class="para">
   ...
   of &quot;must be ... or null&quot; or &quot;must ... or be null.&quot;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration71/other-changes.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration71.other-changes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration71.other-changes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration71.other-changes.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122452">  <div class="votes">
    <div id="Vu122452">
    <a href="/manual/vote-note.php?id=122452&amp;page=migration71.other-changes&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122452">
    <a href="/manual/vote-note.php?id=122452&amp;page=migration71.other-changes&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122452" title="52% like this...">
    4
    </div>
  </div>
  <a href="#122452" class="name">
  <strong class="user"><em>Ta7To7</em></strong></a><a class="genanchor" href="#122452"> &para;</a><div class="date" title="2018-02-27 05:47"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122452">
<div class="phpcode"><code><span class="html">Note that using Incrementing/Decrementing operators on string is legal <br /><span class="default">&lt;?php<br />$str </span><span class="keyword">= </span><span class="string">""</span><span class="keyword">;<br />echo ++</span><span class="default">$str</span><span class="keyword">; </span><span class="comment">// output: 1<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=migration71.other-changes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration71.other-changes.php">＋<small>add a note</small></a></div>
