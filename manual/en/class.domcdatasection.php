...
<head>
  ...
  <title>PHP: DOMCdataSection - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.domcdatasection.php">
 <link rel="shorturl" href="https://www.php.net/domcdatasection">
 <link rel="alternate" href="https://www.php.net/domcdatasection" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/domattr.isid.php">
 <link rel="next" href="https://www.php.net/manual/en/domcdatasection.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.domcdatasection.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.domcdatasection.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.domcdatasection.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.domcdatasection.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.domcdatasection.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.domcdatasection.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.domcdatasection.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.domcdatasection.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.domcdatasection.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.domcdatasection.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.domcdatasection.php" hreflang="zh">
...
<meta name="Description" content="The DOMCdataSection class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMCdataSection - Manual" />
<meta name="twitter:description" content="The DOMCdataSection class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMCdataSection - Manual" />
<meta itemprop="description" content="The DOMCdataSection class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DOMCdataSection class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="domcdatasection.construct.php">
          DOMCdataSection::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domattr.isid.php">
          &laquo; DOMAttr::isId        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.domcdatasection.php' selected="selected">English</option>
            <option value='de/class.domcdatasection.php'>German</option>
            <option value='es/class.domcdatasection.php'>Spanish</option>
            <option value='fr/class.domcdatasection.php'>French</option>
            <option value='it/class.domcdatasection.php'>Italian</option>
            <option value='ja/class.domcdatasection.php'>Japanese</option>
            <option value='pt_BR/class.domcdatasection.php'>Brazilian Portuguese</option>
            <option value='ru/class.domcdatasection.php'>Russian</option>
            <option value='tr/class.domcdatasection.php'>Turkish</option>
            <option value='uk/class.domcdatasection.php'>Ukrainian</option>
            <option value='zh/class.domcdatasection.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.domcdatasection" class="reference">

 <h1 class="title">The DOMCdataSection class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>


  <div class="section" id="domcdatasection.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    The <span class="classname"><strong class="classname">DOMCdataSection</strong></span> class inherits from
    <span class="classname"><a href="class.domtext.php" class="classname">DOMText</a></span> for textual representation
    of CData constructs.
   </p>
  </div>


  <div class="section" id="domcdatasection.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">DOMCdataSection</strong></strong>
    

    
     <span class="modifier">extends</span>
      <a href="class.domtext.php" class="classname">DOMText</a>
     {</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="domcdatasection.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>)</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Inherited methods */</div>
    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domtext.iselementcontentwhitespace.php" class="methodname">DOMText::isElementContentWhitespace</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domtext.iswhitespaceinelementcontent.php" class="methodname">DOMText::isWhitespaceInElementContent</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domtext.splittext.php" class="methodname">DOMText::splitText</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>): <span class="type"><span class="type"><a href="class.domtext.php" class="type DOMText">DOMText</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="domcdatasection.construct.php">DOMCdataSection::__construct</a> — Constructs a new DOMCdataSection object</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domcdatasection.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.domcdatasection%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.domcdatasection&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.domcdatasection.php">＋<small>add a note</small></a></span>
