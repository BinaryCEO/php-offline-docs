...
<head>
  ...
  <title>PHP: pg_lo_open - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-lo-open.php">
 <link rel="shorturl" href="https://www.php.net/pg-lo-open">
 <link rel="alternate" href="https://www.php.net/pg-lo-open" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-lo-import.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-lo-read.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-lo-open.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-lo-open.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-lo-open.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-lo-open.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-lo-open.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-lo-open.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-lo-open.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-lo-open.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-lo-open.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-lo-open.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-lo-open.php" hreflang="zh">
...
<meta name="Description" content="Open a large object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_lo_open - Manual" />
<meta name="twitter:description" content="Open a large object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_lo_open - Manual" />
<meta itemprop="description" content="Open a large object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open a large object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-lo-read.php">
          pg_lo_read &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-lo-import.php">
          &laquo; pg_lo_import        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-lo-open.php' selected="selected">English</option>
            <option value='de/function.pg-lo-open.php'>German</option>
            <option value='es/function.pg-lo-open.php'>Spanish</option>
            <option value='fr/function.pg-lo-open.php'>French</option>
            <option value='it/function.pg-lo-open.php'>Italian</option>
            <option value='ja/function.pg-lo-open.php'>Japanese</option>
            <option value='pt_BR/function.pg-lo-open.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-lo-open.php'>Russian</option>
            <option value='tr/function.pg-lo-open.php'>Turkish</option>
            <option value='uk/function.pg-lo-open.php'>Ukrainian</option>
            <option value='zh/function.pg-lo-open.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-lo-open" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_lo_open</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_lo_open</span> &mdash; <span class="dc-title">Open a large object</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-lo-open-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_lo_open</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$oid</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$mode</code></span>): <span class="type"><span class="type"><a href="class.pgsql-lob.php" class="type PgSql\Lob">PgSql\Lob</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_lo_open()</strong></span> opens a large object in the database
   and returns an <span class="classname"><a href="class.pgsql-lob.php" class="classname">PgSql\Lob</a></span> instance so that it can be manipulated.
  </p>
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="para">
    Do not close the database connection before closing the <span class="classname"><a href="class.pgsql-lob.php" class="classname">PgSql\Lob</a></span> instance.
   </p>
  </div>
  <p class="para">
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-lo-open-returnvalues">
  ...
  <p class="para">
   An <span class="classname"><a href="class.pgsql-lob.php" class="classname">PgSql\Lob</a></span> instance,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.pg-lo-open-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.1.0</td>
      <td>
       Returns an <span class="classname"><a href="class.pgsql-lob.php" class="classname">PgSql\Lob</a></span> instance now;
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />   $database </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=jacarta"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #DD0000">"begin"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">$oid </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_lo_create</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">);<br />   echo </span><span style="color: #DD0000">"</span><span style="color: #0000BB">$oid</span><span style="color: #DD0000">\n"</span><span style="color: #007700">;<br />   </span><span style="color: #0000BB">$handle </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_lo_open</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #0000BB">$oid</span><span style="color: #007700">, </span><span style="color: #DD0000">"w"</span><span style="color: #007700">);<br />   echo </span><span style="color: #DD0000">"</span><span style="color: #0000BB">$handle</span><span style="color: #DD0000">\n"</span><span style="color: #007700">;<br />   </span><span style="color: #0000BB">pg_lo_write</span><span style="color: #007700">(</span><span style="color: #0000BB">$handle</span><span style="color: #007700">, </span><span style="color: #DD0000">"large object data"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_lo_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$handle</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #DD0000">"commit"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-lo-open-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-lo-close.php" class="function" rel="rdfs-seeAlso">pg_lo_close()</a> - Close a large object</span></li>
    <li><span class="function"><a href="function.pg-lo-create.php" class="function" rel="rdfs-seeAlso">pg_lo_create()</a> - Create a large object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-lo-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-lo-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-lo-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-open.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="56284">  <div class="votes">
    <div id="Vu56284">
    <a href="/manual/vote-note.php?id=56284&amp;page=function.pg-lo-open&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd56284">
    <a href="/manual/vote-note.php?id=56284&amp;page=function.pg-lo-open&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V56284" title="66% like this...">
    1
    </div>
  </div>
  <a href="#56284" class="name">
  <strong class="user"><em>metator at netcabo dot pt</em></strong></a><a class="genanchor" href="#56284"> &para;</a><div class="date" title="2005-08-29 11:15"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom56284">
<div class="phpcode"><code><span class="html">Just for the record, a user must be a superuser (database owner) in order to invoke pg_lo_open() (though pg_lo_create() may be invoked...). This opens a gigantic security hole in the db. If a user is not a superuser, db will raise an error with message "Can't create Large Object.". <br />Thus, imho, one should use pg_escape_bytea() instead.</span></code></div>
  </div>
 </div>
  <div class="note" id="130475">  <div class="votes">
    <div id="Vu130475">
    <a href="/manual/vote-note.php?id=130475&amp;page=function.pg-lo-open&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130475">
    <a href="/manual/vote-note.php?id=130475&amp;page=function.pg-lo-open&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130475" title="no votes...">
    0
    </div>
  </div>
  <a href="#130475" class="name">
  <strong class="user"><em>danydb at noalyss dot eu</em></strong></a><a class="genanchor" href="#130475"> &para;</a><div class="date" title="2025-09-08 03:05"><strong>21 days ago</strong></div>
  <div class="text" id="Hcom130475">
<div class="phpcode"><code><span class="html">If I've just tested the functions pg_lo_write(),pg_lo_create() and pg_lo_open() with PHP8.0 to PHP8.4 , there is no need to be a superuser to write a large object.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-lo-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-open.php">＋<small>add a note</small></a></div>
