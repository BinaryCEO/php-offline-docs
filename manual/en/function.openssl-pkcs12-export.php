...
<head>
  ...
  <title>PHP: openssl_pkcs12_export - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-pkcs12-export.php">
 <link rel="shorturl" href="https://www.php.net/openssl-pkcs12-export">
 <link rel="alternate" href="https://www.php.net/openssl-pkcs12-export" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-pbkdf2.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-pkcs12-export-to-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-pkcs12-export.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-pkcs12-export.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-pkcs12-export.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-pkcs12-export.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-pkcs12-export.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-pkcs12-export.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-pkcs12-export.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-pkcs12-export.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-pkcs12-export.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-pkcs12-export.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-pkcs12-export.php" hreflang="zh">
...
<meta name="Description" content="Exports a PKCS#12 Compatible Certificate Store File to variable" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_pkcs12_export - Manual" />
<meta name="twitter:description" content="Exports a PKCS#12 Compatible Certificate Store File to variable" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_pkcs12_export - Manual" />
<meta itemprop="description" content="Exports a PKCS#12 Compatible Certificate Store File to variable" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exports a PKCS#12 Compatible Certificate Store File to variable" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-pkcs12-export-to-file.php">
          openssl_pkcs12_export_to_file &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-pbkdf2.php">
          &laquo; openssl_pbkdf2        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-pkcs12-export.php' selected="selected">English</option>
            <option value='de/function.openssl-pkcs12-export.php'>German</option>
            <option value='es/function.openssl-pkcs12-export.php'>Spanish</option>
            <option value='fr/function.openssl-pkcs12-export.php'>French</option>
            <option value='it/function.openssl-pkcs12-export.php'>Italian</option>
            <option value='ja/function.openssl-pkcs12-export.php'>Japanese</option>
            <option value='pt_BR/function.openssl-pkcs12-export.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-pkcs12-export.php'>Russian</option>
            <option value='tr/function.openssl-pkcs12-export.php'>Turkish</option>
            <option value='uk/function.openssl-pkcs12-export.php'>Ukrainian</option>
            <option value='zh/function.openssl-pkcs12-export.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-pkcs12-export" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_pkcs12_export</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.2, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_pkcs12_export</span> &mdash; <span class="dc-title">Exports a <abbr title="Public Key Cryptography Standards">PKCS</abbr>#12 Compatible Certificate Store File to variable</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-pkcs12-export-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>openssl_pkcs12_export()</strong></span> stores
   <code class="parameter">certificate</code> into a string named by
   <code class="parameter">output</code> in a <abbr title="Public Key Cryptography Standards">PKCS</abbr>#12 file format.
  </p>
 </div>
 ...
 <dd>
  <p class="para">
   See <a href="openssl.certparams.php" class="link">Key/Certificate parameters</a> for a list of valid values.
     ...
     <dd>
      <p class="para">
       On success, this will hold the <abbr title="Public Key Cryptography Standards">PKCS</abbr>#12.
      </p>
     </dd>
    ...
    <tbody class="tbody">
     ...
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-pkcs12-export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-pkcs12-export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-pkcs12-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkcs12-export.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="97831">  <div class="votes">
    <div id="Vu97831">
    <a href="/manual/vote-note.php?id=97831&amp;page=function.openssl-pkcs12-export&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd97831">
    <a href="/manual/vote-note.php?id=97831&amp;page=function.openssl-pkcs12-export&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V97831" title="59% like this...">
    4
    </div>
  </div>
  <a href="#97831" class="name">
  <strong class="user"><em>simoncpu was here</em></strong></a><a class="genanchor" href="#97831"> &para;</a><div class="date" title="2010-05-11 02:28"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97831">
<div class="phpcode"><code><span class="html">If your certificate is not password-protected, just use null or a blank string.  Otherwise, this function won't work.</span></code></div>
  </div>
 </div>
  <div class="note" id="115037">  <div class="votes">
    <div id="Vu115037">
    <a href="/manual/vote-note.php?id=115037&amp;page=function.openssl-pkcs12-export&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115037">
    <a href="/manual/vote-note.php?id=115037&amp;page=function.openssl-pkcs12-export&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115037" title="66% like this...">
    2
    </div>
  </div>
  <a href="#115037" class="name">
  <strong class="user"><em>Robert</em></strong></a><a class="genanchor" href="#115037"> &para;</a><div class="date" title="2014-05-15 05:36"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115037">
<div class="phpcode"><code><span class="html">If you need to provide multiple additional certificates, the 'extracerts' argument needs to be an array with one certificate per element:<br /><span class="default">&lt;?php<br />$args </span><span class="keyword">= array(<br />    </span><span class="string">'extracerts' </span><span class="keyword">=&gt; array(<br />        </span><span class="default">0 </span><span class="keyword">=&gt; </span><span class="string">'-----BEGIN CERTIFICATE----- cert1 ...'</span><span class="keyword">,<br />        </span><span class="default">1 </span><span class="keyword">=&gt; </span><span class="string">'-----BEGIN CERTIFICATE----- cert2 ...'</span><span class="keyword">,<br />        </span><span class="comment">// ...<br />        </span><span class="keyword">)<br />    );<br /></span><span class="default">?&gt;<br /></span><br />You can use this to prepare a PEM.<br /><br /><span class="default">&lt;?php<br />$pemChain </span><span class="keyword">= </span><span class="string">'...'</span><span class="keyword">;<br /></span><span class="default">preg_match_all</span><span class="keyword">(</span><span class="string">'/(-----BEGIN CERTIFICATE-----.*?-----END CERTIFICATE-----)/si'</span><span class="keyword">, </span><span class="default">$pemChain</span><span class="keyword">, </span><span class="default">$matches</span><span class="keyword">);<br /></span><span class="default">$args </span><span class="keyword">= array(</span><span class="string">'extracerts' </span><span class="keyword">=&gt; </span><span class="default">$matches</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">]);<br /></span><span class="default">openssl_pkcs12_export</span><span class="keyword">(</span><span class="default">$signed_csr</span><span class="keyword">, </span><span class="default">$cerificate_out</span><span class="keyword">, </span><span class="default">$private_key_resource</span><span class="keyword">, </span><span class="default">$passphrase</span><span class="keyword">, </span><span class="default">$args</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="114908">  <div class="votes">
    <div id="Vu114908">
    <a href="/manual/vote-note.php?id=114908&amp;page=function.openssl-pkcs12-export&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114908">
    <a href="/manual/vote-note.php?id=114908&amp;page=function.openssl-pkcs12-export&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114908" title="55% like this...">
    1
    </div>
  </div>
  <a href="#114908" class="name">
  <strong class="user"><em>ismael at privasy dot org</em></strong></a><a class="genanchor" href="#114908"> &para;</a><div class="date" title="2014-04-24 09:38"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114908">
<div class="phpcode"><code><span class="html">in order to export a private key to pkcs12 format, the input certificate must contain both private and associated public key in PEM format ,  <br /><br />-----BEGIN RSA PRIVATE KEY-----<br />-----END RSA PRIVATE KEY-----<br /><br />-----BEGIN CERTIFICATE-----<br />-----END CERTIFICATE-----<br /><br />else this function might return the following error "openssl_pkcs12_export(): cannot get cert from parameter 1"</span></code></div>
  </div>
 </div>
  <div class="note" id="113772">  <div class="votes">
    <div id="Vu113772">
    <a href="/manual/vote-note.php?id=113772&amp;page=function.openssl-pkcs12-export&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113772">
    <a href="/manual/vote-note.php?id=113772&amp;page=function.openssl-pkcs12-export&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113772" title="54% like this...">
    1
    </div>
  </div>
  <a href="#113772" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#113772"> &para;</a><div class="date" title="2013-11-29 12:24"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113772">
<div class="phpcode"><code><span class="html">If you want to include CA-Certificates in the PKCS12 it can be accomplished by using the $args parameter.<br /><span class="default">&lt;?php<br />$args </span><span class="keyword">= array(<br />               </span><span class="string">'extracerts' </span><span class="keyword">=&gt; </span><span class="default">$CAcert</span><span class="keyword">,<br />               </span><span class="string">'friendly_name' </span><span class="keyword">=&gt; </span><span class="string">'My signed cert by CA certificate'<br />              </span><span class="keyword">);<br /></span><span class="default">openssl_pkcs12_export</span><span class="keyword">(</span><span class="default">$signed_csr</span><span class="keyword">, </span><span class="default">$cerificate_out</span><span class="keyword">, </span><span class="default">$private_key_resource</span><span class="keyword">, </span><span class="default">$passphrase</span><span class="keyword">, </span><span class="default">$args</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-pkcs12-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkcs12-export.php">＋<small>add a note</small></a></div>
