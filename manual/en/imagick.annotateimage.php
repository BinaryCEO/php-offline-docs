...
<head>
  ...
  <title>PHP: Imagick::annotateImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.annotateimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.annotateimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.annotateimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.animateimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.appendimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.annotateimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.annotateimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.annotateimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.annotateimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.annotateimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.annotateimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.annotateimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.annotateimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.annotateimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.annotateimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.annotateimage.php" hreflang="zh">
...
<meta name="Description" content="Annotates an image with text" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::annotateImage - Manual" />
<meta name="twitter:description" content="Annotates an image with text" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::annotateImage - Manual" />
<meta itemprop="description" content="Annotates an image with text" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Annotates an image with text" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.appendimages.php">
          Imagick::appendImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.animateimages.php">
          &laquo; Imagick::animateImages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.annotateimage.php' selected="selected">English</option>
            <option value='de/imagick.annotateimage.php'>German</option>
            <option value='es/imagick.annotateimage.php'>Spanish</option>
            <option value='fr/imagick.annotateimage.php'>French</option>
            <option value='it/imagick.annotateimage.php'>Italian</option>
            <option value='ja/imagick.annotateimage.php'>Japanese</option>
            <option value='pt_BR/imagick.annotateimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.annotateimage.php'>Russian</option>
            <option value='tr/imagick.annotateimage.php'>Turkish</option>
            <option value='uk/imagick.annotateimage.php'>Ukrainian</option>
            <option value='zh/imagick.annotateimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.annotateimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::annotateImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::annotateImage</span> &mdash; <span class="dc-title">Annotates an image with text</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.annotateimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::annotateImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.imagickdraw.php" class="type ImagickDraw">ImagickDraw</a></span> <code class="parameter">$draw_settings</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$angle</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$text</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.annotateimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">draw_settings</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.annotateimage-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Create some objects */<br /></span><span style="color: #0000BB">$image </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$draw </span><span style="color: #007700">= new </span><span style="color: #0000BB">ImagickDraw</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$pixel </span><span style="color: #007700">= new </span><span style="color: #0000BB">ImagickPixel</span><span style="color: #007700">( </span><span style="color: #DD0000">'gray' </span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* New image */<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">800</span><span style="color: #007700">, </span><span style="color: #0000BB">75</span><span style="color: #007700">, </span><span style="color: #0000BB">$pixel</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Black text */<br /></span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setFillColor</span><span style="color: #007700">(</span><span style="color: #DD0000">'black'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Font properties */<br /></span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setFont</span><span style="color: #007700">(</span><span style="color: #DD0000">'Bookman-DemiItalic'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setFontSize</span><span style="color: #007700">( </span><span style="color: #0000BB">30 </span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Create text */<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">annotateImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$draw</span><span style="color: #007700">, </span><span style="color: #0000BB">10</span><span style="color: #007700">, </span><span style="color: #0000BB">45</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">'The quick brown fox jumps over the lazy dog'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Give image a format */<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">'png'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Output the image with headers */<br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">'Content-type: image/png'</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$image</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.annotateimage-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagickdraw.annotation.php" class="function" rel="rdfs-seeAlso">ImagickDraw::annotation()</a> - Draws text on the image</span></li>
    <li><span class="function"><a href="imagickdraw.setfont.php" class="function" rel="rdfs-seeAlso">ImagickDraw::setFont()</a> - Sets the fully-specified font to use when annotating with text</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/annotateimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.annotateimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.annotateimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.annotateimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="77306">  <div class="votes">
    <div id="Vu77306">
    <a href="/manual/vote-note.php?id=77306&amp;page=imagick.annotateimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd77306">
    <a href="/manual/vote-note.php?id=77306&amp;page=imagick.annotateimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V77306" title="84% like this...">
    9
    </div>
  </div>
  <a href="#77306" class="name">
  <strong class="user"><em>alan at ridersite dot org</em></strong></a><a class="genanchor" href="#77306"> &para;</a><div class="date" title="2007-08-23 12:37"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom77306">
<div class="phpcode"><code><span class="html">If ImagickDraw::setGravity ( int $gravity ) has been set, e,g; with $gravity= imagick::GRAVITY_CENTER.<br /><br />Then, the x and y values offset the text from where the gravity setting would have placed it. <br /><br />If the example included: $draw-&gt;setGravity (Imagick::GRAVITY_CENTER);<br />$image-&gt;annotateImage($draw, 10, 45, 0, 'The quick brown fox jumps over the lazy dog');<br /><br />The text would be rendered to the right 10px and down 45px from the center.  <br /><br />Gravity constants are very useful as they can save having to calculate the placement of variable text strings and font sizes.</span></code></div>
  </div>
 </div>
  <div class="note" id="105708">  <div class="votes">
    <div id="Vu105708">
    <a href="/manual/vote-note.php?id=105708&amp;page=imagick.annotateimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105708">
    <a href="/manual/vote-note.php?id=105708&amp;page=imagick.annotateimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105708" title="71% like this...">
    3
    </div>
  </div>
  <a href="#105708" class="name">
  <strong class="user"><em>www dot query at gmail dot com</em></strong></a><a class="genanchor" href="#105708"> &para;</a><div class="date" title="2011-09-08 08:13"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105708">
<div class="phpcode"><code><span class="html">$image-&gt;annotateImage($draw, 10, 45, 0, 'The quick brown fox');
<br />
<br />If the third parameter, the 'Y' value, is 0, the text will be invisible because the text is printed ABOVE the image - not on the image.  
<br />
<br />The solution is to start, depending on your chosen font size, with a Y value of about 40 and experiment.
<br />
<br />[Also:]
<br />
<br />When wishing to print some text on a photograph and make that text sufficiently contrasting to the background image, use a 4 byte code for colour and transparency.
<br />
<br />It is the same 4 byte code using by the parameter '-undercolor' in ImageMagick's command lime instruction 'convert'.
<br />
<br />The first 3 bytes are the RGB colour code and the fourth byte is the transparency byte.
<br />
<br /><span class="default">&lt;?php
<br />   $picin </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$pic1</span><span class="keyword">);
<br />   </span><span class="default">$picin</span><span class="keyword">-&gt;</span><span class="default">scaleimage</span><span class="keyword">(</span><span class="default">800</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">);
<br />   </span><span class="default">$height </span><span class="keyword">= </span><span class="default">$picin</span><span class="keyword">-&gt;</span><span class="default">getimageheight</span><span class="keyword">();
<br />
<br />   </span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();
<br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">'#ffff00'</span><span class="keyword">);
<br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFont</span><span class="keyword">(</span><span class="string">'Eurostile'</span><span class="keyword">);
<br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFontSize</span><span class="keyword">(</span><span class="default">21</span><span class="keyword">);
<br />   </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setTextUnderColor</span><span class="keyword">(</span><span class="string">'#ff000088'</span><span class="keyword">);
<br />   </span><span class="default">$picin</span><span class="keyword">-&gt;</span><span class="default">annotateImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">,</span><span class="default">40</span><span class="keyword">,</span><span class="default">$height</span><span class="keyword">-</span><span class="default">10</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="string">"Hallo"</span><span class="keyword">);
<br />
<br />   </span><span class="default">$picin</span><span class="keyword">-&gt;</span><span class="default">writeimage</span><span class="keyword">(</span><span class="default">$pic6</span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>
<br />The example code produces yellow text on a semi-transparent red background.
<br />
<br />$pic1 and $pic6 were previously defined as directory/file strings.</span></code></div>
  </div>
 </div>
  <div class="note" id="119789">  <div class="votes">
    <div id="Vu119789">
    <a href="/manual/vote-note.php?id=119789&amp;page=imagick.annotateimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119789">
    <a href="/manual/vote-note.php?id=119789&amp;page=imagick.annotateimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119789" title="54% like this...">
    1
    </div>
  </div>
  <a href="#119789" class="name">
  <strong class="user"><em>yakuza88 at op dot pl</em></strong></a><a class="genanchor" href="#119789"> &para;</a><div class="date" title="2016-08-26 07:30"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119789">
<div class="phpcode"><code><span class="html">Does not work with CMYK color values and images. Only RGB.</span></code></div>
  </div>
 </div>
  <div class="note" id="129118">  <div class="votes">
    <div id="Vu129118">
    <a href="/manual/vote-note.php?id=129118&amp;page=imagick.annotateimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129118">
    <a href="/manual/vote-note.php?id=129118&amp;page=imagick.annotateimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129118" title="no votes...">
    0
    </div>
  </div>
  <a href="#129118" class="name">
  <strong class="user"><em>tuxedobob</em></strong></a><a class="genanchor" href="#129118"> &para;</a><div class="date" title="2023-12-22 08:39"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129118">
<div class="phpcode"><code><span class="html">Note that $angle is in DEGREES and rotates CLOCKWISE. Negative numbers are allowed.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.annotateimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.annotateimage.php">＋<small>add a note</small></a></div>
