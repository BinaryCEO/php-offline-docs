...
<head>
  ...
  <title>PHP: PharData::decompress - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phardata.decompress.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phardata.decompress.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phardata.decompress.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phardata.php">
 <link rel="prev" href="https://www.php.net/manual/en/phardata.copy.php">
 <link rel="next" href="https://www.php.net/manual/en/phardata.decompressfiles.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phardata.decompress.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phardata.decompress.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phardata.decompress.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phardata.decompress.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phardata.decompress.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phardata.decompress.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phardata.decompress.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phardata.decompress.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phardata.decompress.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phardata.decompress.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phardata.decompress.php" hreflang="zh">
...
<meta name="Description" content="Decompresses the entire Phar archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PharData::decompress - Manual" />
<meta name="twitter:description" content="Decompresses the entire Phar archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PharData::decompress - Manual" />
<meta itemprop="description" content="Decompresses the entire Phar archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decompresses the entire Phar archive" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phardata.decompressfiles.php">
          PharData::decompressFiles &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phardata.copy.php">
          &laquo; PharData::copy        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phardata.decompress.php' selected="selected">English</option>
            <option value='de/phardata.decompress.php'>German</option>
            <option value='es/phardata.decompress.php'>Spanish</option>
            <option value='fr/phardata.decompress.php'>French</option>
            <option value='it/phardata.decompress.php'>Italian</option>
            <option value='ja/phardata.decompress.php'>Japanese</option>
            <option value='pt_BR/phardata.decompress.php'>Brazilian Portuguese</option>
            <option value='ru/phardata.decompress.php'>Russian</option>
            <option value='tr/phardata.decompress.php'>Turkish</option>
            <option value='uk/phardata.decompress.php'>Ukrainian</option>
            <option value='zh/phardata.decompress.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phardata.decompress" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-phardata.decompress-examples">
  ...
  <p class="para">
   <div class="example" id="example-855">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phardata.decompressfiles.php" class="function" rel="rdfs-seeAlso">PharData::decompressFiles()</a> - Decompresses all files in the current zip archive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/PharData/decompress.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphardata.decompress%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phardata.decompress&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.decompress.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123344">  <div class="votes">
    <div id="Vu123344">
    <a href="/manual/vote-note.php?id=123344&amp;page=phardata.decompress&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123344">
    <a href="/manual/vote-note.php?id=123344&amp;page=phardata.decompress&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123344" title="87% like this...">
    6
    </div>
  </div>
  <a href="#123344" class="name">
  <strong class="user"><em>pttlens at gmail dot com</em></strong></a><a class="genanchor" href="#123344"> &para;</a><div class="date" title="2018-11-15 08:25"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123344">
<div class="phpcode"><code><span class="html">If filename contains multiple dots(.), you can preserve other parts by following code (example1).<br /><br />Example #1 (Expected)<br /><span class="default">&lt;?php<br />$filename </span><span class="keyword">= </span><span class="string">"abc.xyz.tar.gz"</span><span class="keyword">;<br /></span><span class="default">$p </span><span class="keyword">= new </span><span class="default">PharData</span><span class="keyword">(</span><span class="default">$filename</span><span class="keyword">);<br /></span><span class="default">$exts </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">(</span><span class="string">'.'</span><span class="keyword">, </span><span class="default">$filename</span><span class="keyword">);<br /></span><span class="default">array_shift</span><span class="keyword">(</span><span class="default">$exts</span><span class="keyword">);<br /></span><span class="default">array_pop</span><span class="keyword">(</span><span class="default">$exts</span><span class="keyword">);<br /></span><span class="default">$ext </span><span class="keyword">= </span><span class="default">implode</span><span class="keyword">(</span><span class="string">'.'</span><span class="keyword">, </span><span class="default">$exts</span><span class="keyword">);<br /></span><span class="default">$p</span><span class="keyword">-&gt;</span><span class="default">decompress</span><span class="keyword">(</span><span class="default">$ext</span><span class="keyword">); </span><span class="comment"># result filename: abc.xyz.tar<br /></span><span class="default">?&gt;<br /></span><br />Example #2 (might be unexpected)<br /><span class="default">&lt;?php<br />$filename </span><span class="keyword">= </span><span class="string">"abc.xyz.tar.gz"</span><span class="keyword">;<br /></span><span class="default">$p </span><span class="keyword">= new </span><span class="default">PharData</span><span class="keyword">(</span><span class="default">$filename</span><span class="keyword">);<br /></span><span class="default">$p</span><span class="keyword">-&gt;</span><span class="default">decompress</span><span class="keyword">(</span><span class="default">$filename</span><span class="keyword">); </span><span class="comment"># result filename: abc.tar; xyz is truncated accidentally.<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phardata.decompress&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.decompress.php">＋<small>add a note</small></a></div>
