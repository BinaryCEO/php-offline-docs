...
<head>
  ...
  <title>PHP: Imagick::statisticImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.statisticimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.statisticimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.statisticimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.spreadimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.steganoimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.statisticimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.statisticimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.statisticimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.statisticimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.statisticimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.statisticimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.statisticimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.statisticimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.statisticimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.statisticimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.statisticimage.php" hreflang="zh">
...
<meta name="Description" content="Modifies image using a statistics function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::statisticImage - Manual" />
<meta name="twitter:description" content="Modifies image using a statistics function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::statisticImage - Manual" />
<meta itemprop="description" content="Modifies image using a statistics function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Modifies image using a statistics function" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.steganoimage.php">
          Imagick::steganoImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.spreadimage.php">
          &laquo; Imagick::spreadImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.statisticimage.php' selected="selected">English</option>
            <option value='de/imagick.statisticimage.php'>German</option>
            <option value='es/imagick.statisticimage.php'>Spanish</option>
            <option value='fr/imagick.statisticimage.php'>French</option>
            <option value='it/imagick.statisticimage.php'>Italian</option>
            <option value='ja/imagick.statisticimage.php'>Japanese</option>
            <option value='pt_BR/imagick.statisticimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.statisticimage.php'>Russian</option>
            <option value='tr/imagick.statisticimage.php'>Turkish</option>
            <option value='uk/imagick.statisticimage.php'>Ukrainian</option>
            <option value='zh/imagick.statisticimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.statisticimage" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.statisticimage-examples">
  ...
  <p class="para">
    <div class="example" id="example-3127">
      <p><strong>Example #1  <span class="function"><strong>Imagick::statisticImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/statisticimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.statisticimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.statisticimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.statisticimage.php">＋<small>add a note</small></a></span>
