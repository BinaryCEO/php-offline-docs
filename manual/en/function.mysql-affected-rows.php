...
<head>
  ...
  <title>PHP: mysql_affected_rows - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-affected-rows.php">
 <link rel="shorturl" href="https://www.php.net/mysql-affected-rows">
 <link rel="alternate" href="https://www.php.net/mysql-affected-rows" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-client-encoding.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-affected-rows.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-affected-rows.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-affected-rows.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-affected-rows.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-affected-rows.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-affected-rows.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-affected-rows.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-affected-rows.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-affected-rows.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-affected-rows.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-affected-rows.php" hreflang="zh">
...
<meta name="Description" content="Get number of affected rows in previous MySQL operation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_affected_rows - Manual" />
<meta name="twitter:description" content="Get number of affected rows in previous MySQL operation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_affected_rows - Manual" />
<meta itemprop="description" content="Get number of affected rows in previous MySQL operation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get number of affected rows in previous MySQL operation" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-client-encoding.php">
          mysql_client_encoding &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.mysql.php">
          &laquo; MySQL Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-affected-rows.php' selected="selected">English</option>
            <option value='de/function.mysql-affected-rows.php'>German</option>
            <option value='es/function.mysql-affected-rows.php'>Spanish</option>
            <option value='fr/function.mysql-affected-rows.php'>French</option>
            <option value='it/function.mysql-affected-rows.php'>Italian</option>
            <option value='ja/function.mysql-affected-rows.php'>Japanese</option>
            <option value='pt_BR/function.mysql-affected-rows.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-affected-rows.php'>Russian</option>
            <option value='tr/function.mysql-affected-rows.php'>Turkish</option>
            <option value='uk/function.mysql-affected-rows.php'>Ukrainian</option>
            <option value='zh/function.mysql-affected-rows.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-affected-rows" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-info.php" class="function" rel="rdfs-seeAlso">mysql_info()</a> - Get information about the most recent query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-affected-rows.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-affected-rows%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-affected-rows&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-affected-rows.php">＋<small>add a note</small></a></span>
