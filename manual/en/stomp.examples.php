...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/stomp.examples.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/stomp.examples.php">
 <link rel="alternate" href="https://www.php.net/manual/en/stomp.examples.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.stomp.php">
 <link rel="prev" href="https://www.php.net/manual/en/stomp.resources.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.stomp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/stomp.examples.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/stomp.examples.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/stomp.examples.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/stomp.examples.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/stomp.examples.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/stomp.examples.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/stomp.examples.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/stomp.examples.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/stomp.examples.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/stomp.examples.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/stomp.examples.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/stomp.examples.php' selected="selected">English</option>
            <option value='de/stomp.examples.php'>German</option>
            <option value='es/stomp.examples.php'>Spanish</option>
            <option value='fr/stomp.examples.php'>French</option>
            <option value='it/stomp.examples.php'>Italian</option>
            <option value='ja/stomp.examples.php'>Japanese</option>
            <option value='pt_BR/stomp.examples.php'>Brazilian Portuguese</option>
            <option value='ru/stomp.examples.php'>Russian</option>
            <option value='tr/stomp.examples.php'>Turkish</option>
            <option value='uk/stomp.examples.php'>Ukrainian</option>
            <option value='zh/stomp.examples.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="stomp.examples" class="chapter">
  ...
  array(6) {
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stomp/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fstomp.examples%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=stomp.examples&amp;repo=en&amp;redirect=https://www.php.net/manual/en/stomp.examples.php">＋<small>add a note</small></a></span>
