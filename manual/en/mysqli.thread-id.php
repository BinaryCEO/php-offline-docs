...
<head>
  ...
  <title>PHP: mysqli::$thread_id - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.thread-id.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.thread-id.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.thread-id.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.store-result.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.thread-safe.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.thread-id.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.thread-id.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.thread-id.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.thread-id.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.thread-id.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.thread-id.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.thread-id.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.thread-id.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.thread-id.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.thread-id.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.thread-id.php" hreflang="zh">
...
<meta name="Description" content="Returns the thread ID for the current connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::$thread_id - Manual" />
<meta name="twitter:description" content="Returns the thread ID for the current connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::$thread_id - Manual" />
<meta itemprop="description" content="Returns the thread ID for the current connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the thread ID for the current connection" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli.thread-safe.php">
          mysqli::thread_safe &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.store-result.php">
          &laquo; mysqli::store_result        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.thread-id.php' selected="selected">English</option>
            <option value='de/mysqli.thread-id.php'>German</option>
            <option value='es/mysqli.thread-id.php'>Spanish</option>
            <option value='fr/mysqli.thread-id.php'>French</option>
            <option value='it/mysqli.thread-id.php'>Italian</option>
            <option value='ja/mysqli.thread-id.php'>Japanese</option>
            <option value='pt_BR/mysqli.thread-id.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.thread-id.php'>Russian</option>
            <option value='tr/mysqli.thread-id.php'>Turkish</option>
            <option value='uk/mysqli.thread-id.php'>Ukrainian</option>
            <option value='zh/mysqli.thread-id.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.thread-id" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli::$thread_id</h1>
  <h1 class="refname">mysqli_thread_id</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli::$thread_id</span> -- <span class="refname">mysqli_thread_id</span> &mdash; <span class="dc-title">Returns the thread ID for the current connection</span></p>
 ...
 <div class="refsect1 description" id="refsect1-mysqli.thread-id-description">
  ...
  <p class="para rdfs-comment">
   The <span class="function"><strong>mysqli_thread_id()</strong></span> function returns the thread
   ID for the current connection which can then be killed using the
   <span class="function"><a href="mysqli.kill.php" class="function">mysqli_kill()</a></span> function. If the connection is lost
   and you reconnect with <span class="function"><a href="mysqli.ping.php" class="function">mysqli_ping()</a></span>, the thread ID
...
returned by <span class="function"><a href="function.mysqli-connect.php" class="function">mysqli_connect()</a></span> or <span class="function"><a href="mysqli.init.php" class="function">mysqli_init()</a></span>
 ...
 <div class="refsect1 examples" id="refsect1-mysqli.thread-id-examples">
  ...
  <div class="example" id="example-1616">
   <p><strong>Example #1 <var class="varname">$mysqli->thread_id</var> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">Error: MySQL server has gone away</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli.thread-id-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli.kill.php" class="function" rel="rdfs-seeAlso">mysqli_kill()</a> - Asks the server to kill a MySQL thread</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/thread-id.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.thread-id%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.thread-id&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.thread-id.php">＋<small>add a note</small></a></span>
