...
<head>
  ...
  <title>PHP: Imagick::posterizeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.posterizeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.posterizeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.posterizeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.polaroidimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.previewimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.posterizeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.posterizeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.posterizeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.posterizeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.posterizeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.posterizeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.posterizeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.posterizeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.posterizeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.posterizeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.posterizeimage.php" hreflang="zh">
...
<meta name="Description" content="Reduces the image to a limited number of color level" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::posterizeImage - Manual" />
<meta name="twitter:description" content="Reduces the image to a limited number of color level" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::posterizeImage - Manual" />
<meta itemprop="description" content="Reduces the image to a limited number of color level" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reduces the image to a limited number of color level" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.previewimages.php">
          Imagick::previewImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.polaroidimage.php">
          &laquo; Imagick::polaroidImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.posterizeimage.php' selected="selected">English</option>
            <option value='de/imagick.posterizeimage.php'>German</option>
            <option value='es/imagick.posterizeimage.php'>Spanish</option>
            <option value='fr/imagick.posterizeimage.php'>French</option>
            <option value='it/imagick.posterizeimage.php'>Italian</option>
            <option value='ja/imagick.posterizeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.posterizeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.posterizeimage.php'>Russian</option>
            <option value='tr/imagick.posterizeimage.php'>Turkish</option>
            <option value='uk/imagick.posterizeimage.php'>Ukrainian</option>
            <option value='zh/imagick.posterizeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.posterizeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::posterizeImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::posterizeImage</span> &mdash; <span class="dc-title">Reduces the image to a limited number of color level</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.posterizeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::posterizeImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$levels</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$dither</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.posterizeimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.posterizeimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3067">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/posterizeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.posterizeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.posterizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.posterizeimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121425">  <div class="votes">
    <div id="Vu121425">
    <a href="/manual/vote-note.php?id=121425&amp;page=imagick.posterizeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121425">
    <a href="/manual/vote-note.php?id=121425&amp;page=imagick.posterizeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121425" title="100% like this...">
    1
    </div>
  </div>
  <a href="#121425" class="name">
  <strong class="user"><em>linspb at gmail dot com</em></strong></a><a class="genanchor" href="#121425"> &para;</a><div class="date" title="2017-07-24 02:19"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121425">
<div class="phpcode"><code><span class="html">At PHP 7.x before<br /><br />$im-&gt;posterizeimage(2, FALSE);<br /><br />do<br /><br />$im-&gt;setImageType(imagick::IMGTYPE_COLORSEPARATION);<br /><br />on PHP 5.x working without setImageType well.<br /><br />Example:<br />$im = new Imagick();<br />$r = $im-&gt;readImageBlob($label);<br />if (!$r) {<br />    return FALSE;<br />}<br />$im-&gt;setImageType(imagick::IMGTYPE_COLORSEPARATION);<br />$im-&gt;posterizeimage(2, 0);<br />$bmp = $im-&gt;getImageBlob();</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.posterizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.posterizeimage.php">＋<small>add a note</small></a></div>
