...
<head>
  ...
  <title>PHP: ibase_fetch_row - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-fetch-row.php">
 <link rel="shorturl" href="https://www.php.net/ibase-fetch-row">
 <link rel="alternate" href="https://www.php.net/ibase-fetch-row" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-fetch-object.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-field-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-fetch-row.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-fetch-row.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-fetch-row.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-fetch-row.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-fetch-row.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-fetch-row.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-fetch-row.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-fetch-row.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-fetch-row.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-fetch-row.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-fetch-row.php" hreflang="zh">
...
<meta name="Description" content="Fetch a row from an InterBase database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_fetch_row - Manual" />
<meta name="twitter:description" content="Fetch a row from an InterBase database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_fetch_row - Manual" />
<meta itemprop="description" content="Fetch a row from an InterBase database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetch a row from an InterBase database" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-field-info.php">
          ibase_field_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-fetch-object.php">
          &laquo; ibase_fetch_object        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-fetch-row.php' selected="selected">English</option>
            <option value='de/function.ibase-fetch-row.php'>German</option>
            <option value='es/function.ibase-fetch-row.php'>Spanish</option>
            <option value='fr/function.ibase-fetch-row.php'>French</option>
            <option value='it/function.ibase-fetch-row.php'>Italian</option>
            <option value='ja/function.ibase-fetch-row.php'>Japanese</option>
            <option value='pt_BR/function.ibase-fetch-row.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-fetch-row.php'>Russian</option>
            <option value='tr/function.ibase-fetch-row.php'>Turkish</option>
            <option value='uk/function.ibase-fetch-row.php'>Ukrainian</option>
            <option value='zh/function.ibase-fetch-row.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-fetch-row" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-fetch-object.php" class="function" rel="rdfs-seeAlso">ibase_fetch_object()</a> - Get an object from a InterBase database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-fetch-row.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-fetch-row%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-fetch-row&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-fetch-row.php">＋<small>add a note</small></a></span>
