...
<head>
  ...
  <title>PHP: Imagick::uniqueImageColors - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.uniqueimagecolors.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.uniqueimagecolors.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.uniqueimagecolors.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.trimimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.unsharpmaskimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.uniqueimagecolors.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.uniqueimagecolors.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.uniqueimagecolors.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.uniqueimagecolors.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.uniqueimagecolors.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.uniqueimagecolors.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.uniqueimagecolors.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.uniqueimagecolors.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.uniqueimagecolors.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.uniqueimagecolors.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.uniqueimagecolors.php" hreflang="zh">
...
<meta name="Description" content="Discards all but one of any pixel color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::uniqueImageColors - Manual" />
<meta name="twitter:description" content="Discards all but one of any pixel color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::uniqueImageColors - Manual" />
<meta itemprop="description" content="Discards all but one of any pixel color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Discards all but one of any pixel color" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.unsharpmaskimage.php">
          Imagick::unsharpMaskImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.trimimage.php">
          &laquo; Imagick::trimImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.uniqueimagecolors.php' selected="selected">English</option>
            <option value='de/imagick.uniqueimagecolors.php'>German</option>
            <option value='es/imagick.uniqueimagecolors.php'>Spanish</option>
            <option value='fr/imagick.uniqueimagecolors.php'>French</option>
            <option value='it/imagick.uniqueimagecolors.php'>Italian</option>
            <option value='ja/imagick.uniqueimagecolors.php'>Japanese</option>
            <option value='pt_BR/imagick.uniqueimagecolors.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.uniqueimagecolors.php'>Russian</option>
            <option value='tr/imagick.uniqueimagecolors.php'>Turkish</option>
            <option value='uk/imagick.uniqueimagecolors.php'>Ukrainian</option>
            <option value='zh/imagick.uniqueimagecolors.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.uniqueimagecolors" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::uniqueImageColors</h1>
  <p class="verinfo">(PECL imagick 2,PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::uniqueImageColors</span> &mdash; <span class="dc-title">Discards all but one of any pixel color</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.uniqueimagecolors-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::uniqueImageColors</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.uniqueimagecolors-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.uniqueimagecolors-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3140">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/uniqueimagecolors.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.uniqueimagecolors%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.uniqueimagecolors&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.uniqueimagecolors.php">＋<small>add a note</small></a></span>
