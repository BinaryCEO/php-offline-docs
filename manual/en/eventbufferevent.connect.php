...
<head>
  ...
  <title>PHP: EventBufferEvent::connect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/eventbufferevent.connect.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/eventbufferevent.connect.php">
 <link rel="alternate" href="https://www.php.net/manual/en/eventbufferevent.connect.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.eventbufferevent.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventbufferevent.close.php">
 <link rel="next" href="https://www.php.net/manual/en/eventbufferevent.connecthost.php">

 <link rel="alternate" href="https://www.php.net/manual/en/eventbufferevent.connect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/eventbufferevent.connect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/eventbufferevent.connect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/eventbufferevent.connect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/eventbufferevent.connect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/eventbufferevent.connect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/eventbufferevent.connect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/eventbufferevent.connect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/eventbufferevent.connect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/eventbufferevent.connect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/eventbufferevent.connect.php" hreflang="zh">
...
<meta name="Description" content="Connect buffer event's file descriptor to given address or
  UNIX socket" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventBufferEvent::connect - Manual" />
<meta name="twitter:description" content="Connect buffer event's file descriptor to given address or
  UNIX socket" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventBufferEvent::connect - Manual" />
<meta itemprop="description" content="Connect buffer event's file descriptor to given address or
  UNIX socket" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Connect buffer event's file descriptor to given address or
  UNIX socket" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="eventbufferevent.connecthost.php">
          EventBufferEvent::connectHost &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="eventbufferevent.close.php">
          &laquo; EventBufferEvent::close        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/eventbufferevent.connect.php' selected="selected">English</option>
            <option value='de/eventbufferevent.connect.php'>German</option>
            <option value='es/eventbufferevent.connect.php'>Spanish</option>
            <option value='fr/eventbufferevent.connect.php'>French</option>
            <option value='it/eventbufferevent.connect.php'>Italian</option>
            <option value='ja/eventbufferevent.connect.php'>Japanese</option>
            <option value='pt_BR/eventbufferevent.connect.php'>Brazilian Portuguese</option>
            <option value='ru/eventbufferevent.connect.php'>Russian</option>
            <option value='tr/eventbufferevent.connect.php'>Turkish</option>
            <option value='uk/eventbufferevent.connect.php'>Ukrainian</option>
            <option value='zh/eventbufferevent.connect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="eventbufferevent.connect" class="refentry">
   ...
   <li>
    <span class="methodname"><a href="eventbufferevent.connecthost.php" class="methodname" rel="rdfs-seeAlso">EventBufferEvent::connectHost()</a> - Connects to a hostname with optionally asyncronous DNS resolving</span>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventbufferevent/connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Feventbufferevent.connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=eventbufferevent.connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eventbufferevent.connect.php">＋<small>add a note</small></a></span>
