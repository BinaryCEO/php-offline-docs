...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-cdf-beta.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-absolute-deviation.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-cdf-binomial.php">
...
<meta name="Description" content="Calculates any one parameter of the beta distribution given values for the others" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_cdf_beta - Manual" />
<meta name="twitter:description" content="Calculates any one parameter of the beta distribution given values for the others" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_cdf_beta - Manual" />
<meta itemprop="description" content="Calculates any one parameter of the beta distribution given values for the others" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calculates any one parameter of the beta distribution given values for the others" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-cdf-beta.php' selected="selected">English</option>
            <option value='de/function.stats-cdf-beta.php'>German</option>
            <option value='es/function.stats-cdf-beta.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_cdf_beta</span> &mdash; <span class="dc-title">Calculates any one parameter of the beta distribution given values for the others</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.stats-cdf-beta-description">
  ...
  <p class="para rdfs-comment">
   ...
   of the beta distribution. The kind of the return value and parameters (<code class="parameter">par1</code>,
   <code class="parameter">par2</code>, and <code class="parameter">par3</code>) are determined by
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-cdf-beta-returnvalues">
  ...
  <p class="para">
   Returns CDF, x, alpha, or beta, determined by <code class="parameter">which</code>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-cdf-beta.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-cdf-beta%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-cdf-beta&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-cdf-beta.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#95380"> &para;</a><div class="date" title="2009-12-30 12:29"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95380">
<div class="phpcode"><code><span class="html">Additional Notes, taken from source.<br /> WHICH --&gt; Integer indicating which of the next four argument<br />       values is to be calculated from the others.<br />     Legal range: 1..4<br />     iwhich = 1 : Calculate P and Q from X,Y,A and B<br />     iwhich = 2 : Calculate X and Y from P,Q,A and B<br />     iwhich = 3 : Calculate A from P,Q,X,Y and B<br />     iwhich = 4 : Calculate B from P,Q,X,Y and A<br />     <br />     P &lt;--&gt; The integral from 0 to X of the chi-square<br />     distribution.<br />     Input range: [0, 1].<br />     <br />     Q &lt;--&gt; 1-P.<br />     Input range: [0, 1].<br />     P + Q = 1.0.<br />     <br />     X &lt;--&gt; Upper limit of integration of beta density.<br />     Input range: [0,1].<br />     Search range: [0,1]<br />     <br />     Y &lt;--&gt; 1-X.<br />     Input range: [0,1].<br />     Search range: [0,1]<br />     X + Y = 1.0.<br />     <br />     A &lt;--&gt; The first parameter of the beta density.<br />     Input range: (0, +infinity).<br />     Search range: [1D-100,1D100]<br />     <br />     B &lt;--&gt; The second parameter of the beta density.<br />     Input range: (0, +infinity).<br />     Search range: [1D-100,1D100]</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Decided to dive into the source code and provide a simple explanation:<br /><br />Parameters:<br />int $which - Select which parameter to use in the CDF Binomial calculation, based on what the prior 3 parameters are.<br /><br />where $which is 4:<br />$arg1 = p<br />$arg2 = sn<br />$arg3 = xn<br />returns pr<br /><br />$which = 3<br />$arg1 = p<br />$arg2 = sn<br />$arg3 = pr<br />returns xn<br /><br />$which = 2<br />$arg1 = p<br />$arg2 = xn<br />$arg3 = pr<br />returns sn<br /><br />$which = 1<br />$arg1 = sn<br />$arg2 = xn<br />$arg3 = pr<br />returns p</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stats-cdf-beta&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-cdf-beta.php">＋<small>add a note</small></a></div>
