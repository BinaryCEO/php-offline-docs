...
<head>
  ...
  <title>PHP: sqlsrv_begin_transaction - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sqlsrv-begin-transaction.php">
 <link rel="shorturl" href="https://www.php.net/sqlsrv-begin-transaction">
 <link rel="alternate" href="https://www.php.net/sqlsrv-begin-transaction" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sqlsrv-cancel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sqlsrv-begin-transaction.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sqlsrv-begin-transaction.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sqlsrv-begin-transaction.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sqlsrv-begin-transaction.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sqlsrv-begin-transaction.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sqlsrv-begin-transaction.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sqlsrv-begin-transaction.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sqlsrv-begin-transaction.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sqlsrv-begin-transaction.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sqlsrv-begin-transaction.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sqlsrv-begin-transaction.php" hreflang="zh">
...
<meta name="Description" content="Begins a database transaction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sqlsrv_begin_transaction - Manual" />
<meta name="twitter:description" content="Begins a database transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sqlsrv_begin_transaction - Manual" />
<meta itemprop="description" content="Begins a database transaction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Begins a database transaction" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sqlsrv-begin-transaction.php' selected="selected">English</option>
            <option value='de/function.sqlsrv-begin-transaction.php'>German</option>
            <option value='es/function.sqlsrv-begin-transaction.php'>Spanish</option>
            <option value='fr/function.sqlsrv-begin-transaction.php'>French</option>
            <option value='it/function.sqlsrv-begin-transaction.php'>Italian</option>
            <option value='ja/function.sqlsrv-begin-transaction.php'>Japanese</option>
            <option value='pt_BR/function.sqlsrv-begin-transaction.php'>Brazilian Portuguese</option>
            <option value='ru/function.sqlsrv-begin-transaction.php'>Russian</option>
            <option value='tr/function.sqlsrv-begin-transaction.php'>Turkish</option>
            <option value='uk/function.sqlsrv-begin-transaction.php'>Ukrainian</option>
            <option value='zh/function.sqlsrv-begin-transaction.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sqlsrv-begin-transaction" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sqlsrv_begin_transaction</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_begin_transaction</span> &mdash; <span class="dc-title">Begins a database transaction</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.sqlsrv-begin-transaction-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sqlsrv_begin_transaction</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   The transaction begun by <span class="function"><strong>sqlsrv_begin_transaction()</strong></span> includes 
   all statements that were executed after the call to 
   <span class="function"><strong>sqlsrv_begin_transaction()</strong></span> and before calls to 
   <span class="function"><a href="function.sqlsrv-rollback.php" class="function">sqlsrv_rollback()</a></span> or <span class="function"><a href="function.sqlsrv-commit.php" class="function">sqlsrv_commit()</a></span>. 
 ...
 <div class="refsect1 examples" id="refsect1-function.sqlsrv-begin-transaction-examples">
  ...
  <p class="para">
   <div class="example" id="example-2148">
    <p><strong>Example #1 <span class="function"><strong>sqlsrv_begin_transaction()</strong></span> example</strong></p>
    <div class="example-contents"><p>
    The following example demonstrates how to use 
    <span class="function"><strong>sqlsrv_begin_transaction()</strong></span> together with 
    <span class="function"><a href="function.sqlsrv-commit.php" class="function">sqlsrv_commit()</a></span> and <span class="function"><a href="function.sqlsrv-rollback.php" class="function">sqlsrv_rollback()</a></span>.
    </p></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.sqlsrv-begin-transaction-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.sqlsrv-rollback.php" class="function" rel="rdfs-seeAlso">sqlsrv_rollback()</a> - Rolls back a transaction that was begun with 
  sqlsrv_begin_transaction</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlsrv/functions/sqlsrv-begin-transaction.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sqlsrv-begin-transaction%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sqlsrv-begin-transaction&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-begin-transaction.php">＋<small>add a note</small></a></span>
