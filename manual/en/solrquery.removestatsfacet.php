...
<head>
  ...
  <title>PHP: SolrQuery::removeStatsFacet - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.removestatsfacet.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.removestatsfacet.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removestatsfacet.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.removesortfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.removestatsfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removestatsfacet.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.removestatsfacet.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.removestatsfacet.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.removestatsfacet.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.removestatsfacet.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.removestatsfacet.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.removestatsfacet.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.removestatsfacet.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.removestatsfacet.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.removestatsfacet.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.removestatsfacet.php" hreflang="zh">
...
<meta name="Description" content="Removes one of the stats.facet parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::removeStatsFacet - Manual" />
<meta name="twitter:description" content="Removes one of the stats.facet parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::removeStatsFacet - Manual" />
<meta itemprop="description" content="Removes one of the stats.facet parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes one of the stats.facet parameters" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.removestatsfield.php">
          SolrQuery::removeStatsField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.removesortfield.php">
          &laquo; SolrQuery::removeSortField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.removestatsfacet.php' selected="selected">English</option>
            <option value='de/solrquery.removestatsfacet.php'>German</option>
            <option value='es/solrquery.removestatsfacet.php'>Spanish</option>
            <option value='fr/solrquery.removestatsfacet.php'>French</option>
            <option value='it/solrquery.removestatsfacet.php'>Italian</option>
            <option value='ja/solrquery.removestatsfacet.php'>Japanese</option>
            <option value='pt_BR/solrquery.removestatsfacet.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.removestatsfacet.php'>Russian</option>
            <option value='tr/solrquery.removestatsfacet.php'>Turkish</option>
            <option value='uk/solrquery.removestatsfacet.php'>Ukrainian</option>
            <option value='zh/solrquery.removestatsfacet.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.removestatsfacet" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::removeStatsFacet</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::removeStatsFacet</span> &mdash; <span class="dc-title">Removes one of the stats.facet parameters</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.removestatsfacet-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::removeStatsFacet</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.removestatsfacet-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.removestatsfacet-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/removestatsfacet.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.removestatsfacet%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.removestatsfacet&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.removestatsfacet.php">＋<small>add a note</small></a></span>
