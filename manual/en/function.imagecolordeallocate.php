...
<head>
  ...
  <title>PHP: imagecolordeallocate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecolordeallocate.php">
 <link rel="shorturl" href="https://www.php.net/imagecolordeallocate">
 <link rel="alternate" href="https://www.php.net/imagecolordeallocate" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecolorclosesthwb.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecolorexact.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecolordeallocate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecolordeallocate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecolordeallocate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecolordeallocate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecolordeallocate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecolordeallocate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecolordeallocate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecolordeallocate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecolordeallocate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecolordeallocate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecolordeallocate.php" hreflang="zh">
...
<meta name="Description" content="De-allocate a color for an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagecolordeallocate - Manual" />
<meta name="twitter:description" content="De-allocate a color for an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecolordeallocate - Manual" />
<meta itemprop="description" content="De-allocate a color for an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="De-allocate a color for an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagecolorexact.php">
          imagecolorexact &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagecolorclosesthwb.php">
          &laquo; imagecolorclosesthwb        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecolordeallocate.php' selected="selected">English</option>
            <option value='de/function.imagecolordeallocate.php'>German</option>
            <option value='es/function.imagecolordeallocate.php'>Spanish</option>
            <option value='fr/function.imagecolordeallocate.php'>French</option>
            <option value='it/function.imagecolordeallocate.php'>Italian</option>
            <option value='ja/function.imagecolordeallocate.php'>Japanese</option>
            <option value='pt_BR/function.imagecolordeallocate.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecolordeallocate.php'>Russian</option>
            <option value='tr/function.imagecolordeallocate.php'>Turkish</option>
            <option value='uk/function.imagecolordeallocate.php'>Ukrainian</option>
            <option value='zh/function.imagecolordeallocate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecolordeallocate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagecolordeallocate</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagecolordeallocate</span> &mdash; <span class="dc-title">De-allocate a color for an image</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagecolordeallocate-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagecolordeallocate</strong></span>(<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$color</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 examples" id="refsect1-function.imagecolordeallocate-examples">
  ...
  <p class="para">
   <div class="example" id="example-2845">
    <p><strong>Example #1 Using <span class="function"><strong>imagecolordeallocate()</strong></span></strong></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imagecolorallocatealpha.php" class="function" rel="rdfs-seeAlso">imagecolorallocatealpha()</a> - Allocate a color for an image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecolordeallocate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecolordeallocate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecolordeallocate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecolordeallocate.php">＋<small>add a note</small></a></span>
