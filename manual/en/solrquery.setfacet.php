...
<head>
  ...
  <title>PHP: SolrQuery::setFacet - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setfacet.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setfacet.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacet.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setexplainother.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setfacetdateend.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacet.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setfacet.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setfacet.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setfacet.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setfacet.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setfacet.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setfacet.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setfacet.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setfacet.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setfacet.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setfacet.php" hreflang="zh">
...
<meta name="Description" content="Maps to the facet parameter. Enables or disables facetting" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setFacet - Manual" />
<meta name="twitter:description" content="Maps to the facet parameter. Enables or disables facetting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setFacet - Manual" />
<meta itemprop="description" content="Maps to the facet parameter. Enables or disables facetting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Maps to the facet parameter. Enables or disables facetting" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setfacetdateend.php">
          SolrQuery::setFacetDateEnd &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setexplainother.php">
          &laquo; SolrQuery::setExplainOther        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setfacet.php' selected="selected">English</option>
            <option value='de/solrquery.setfacet.php'>German</option>
            <option value='es/solrquery.setfacet.php'>Spanish</option>
            <option value='fr/solrquery.setfacet.php'>French</option>
            <option value='it/solrquery.setfacet.php'>Italian</option>
            <option value='ja/solrquery.setfacet.php'>Japanese</option>
            <option value='pt_BR/solrquery.setfacet.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setfacet.php'>Russian</option>
            <option value='tr/solrquery.setfacet.php'>Turkish</option>
            <option value='uk/solrquery.setfacet.php'>Ukrainian</option>
            <option value='zh/solrquery.setfacet.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setfacet" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setFacet</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setFacet</span> &mdash; <span class="dc-title">Maps to the facet parameter. Enables or disables facetting</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setfacet-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setFacet</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setfacet-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> enables faceting and <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> disables it.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setfacet-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setfacet.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setfacet%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setfacet&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setfacet.php">＋<small>add a note</small></a></span>
