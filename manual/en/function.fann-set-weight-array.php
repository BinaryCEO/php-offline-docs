...
<head>
  ...
  <title>PHP: fann_set_weight_array - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-weight-array.php">
 <link rel="shorturl" href="https://www.php.net/fann-set-weight-array">
 <link rel="alternate" href="https://www.php.net/fann-set-weight-array" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-weight.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-shuffle-train-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-set-weight-array.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-set-weight-array.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-set-weight-array.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-set-weight-array.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-set-weight-array.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-set-weight-array.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-set-weight-array.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-set-weight-array.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-set-weight-array.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-set-weight-array.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-set-weight-array.php" hreflang="zh">
...
<meta name="Description" content="Set connections in the network" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_weight_array - Manual" />
<meta name="twitter:description" content="Set connections in the network" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_weight_array - Manual" />
<meta itemprop="description" content="Set connections in the network" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set connections in the network" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-shuffle-train-data.php">
          fann_shuffle_train_data &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-set-weight.php">
          &laquo; fann_set_weight        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-weight-array.php' selected="selected">English</option>
            <option value='de/function.fann-set-weight-array.php'>German</option>
            <option value='es/function.fann-set-weight-array.php'>Spanish</option>
            <option value='fr/function.fann-set-weight-array.php'>French</option>
            <option value='it/function.fann-set-weight-array.php'>Italian</option>
            <option value='ja/function.fann-set-weight-array.php'>Japanese</option>
            <option value='pt_BR/function.fann-set-weight-array.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-set-weight-array.php'>Russian</option>
            <option value='tr/function.fann-set-weight-array.php'>Turkish</option>
            <option value='uk/function.fann-set-weight-array.php'>Ukrainian</option>
            <option value='zh/function.fann-set-weight-array.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-set-weight-array" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_set_weight_array</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_set_weight_array</span> &mdash; <span class="dc-title">Set connections in the network</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-set-weight-array-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_set_weight_array</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$connections</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-set-weight-array-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      An array of <span class="classname"><a href="class.fannconnection.php" class="classname">FANNConnection</a></span> objects
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-set-weight-array-returnvalues">
  ...
  <p class="para">Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-weight-array.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-weight-array%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-weight-array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-weight-array.php">＋<small>add a note</small></a></span>
