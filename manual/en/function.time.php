...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.time.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.strtotime.php">
 <link rel="next" href="https://www.php.net/manual/en/function.timezone-abbreviations-list.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.time.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/function.time.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/function.time.php" hreflang="uk">
...
<meta name="Description" content="Return current Unix timestamp" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: time - Manual" />
<meta name="twitter:description" content="Return current Unix timestamp" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: time - Manual" />
<meta itemprop="description" content="Return current Unix timestamp" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return current Unix timestamp" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.timezone-abbreviations-list.php">
          timezone_abbreviations_list &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.time.php' selected="selected">English</option>
            <option value='de/function.time.php'>German</option>
            <option value='es/function.time.php'>Spanish</option>
            <option value='fr/function.time.php'>French</option>
            <option value='it/function.time.php'>Italian</option>
            <option value='ja/function.time.php'>Japanese</option>
            <option value='pt_BR/function.time.php'>Brazilian Portuguese</option>
            <option value='ru/function.time.php'>Russian</option>
            <option value='tr/function.time.php'>Turkish</option>
            <option value='uk/function.time.php'>Ukrainian</option>
            <option value='zh/function.time.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.time" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">time</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">time</span> &mdash; <span class="dc-title">Return current Unix timestamp</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.time-description">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    <span class="classname"><a href="class.datetimeimmutable.php" class="classname">DateTimeImmutable</a></span> class for handling date and time
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">echo </span><span style="color: #DD0000">'Now: '</span><span style="color: #007700">. </span><span style="color: #0000BB">time</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>

    <div class="example-contents"><p>The above example will output
something similar to:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">Now: 1660338149</pre>
</div>
    </div>
   </div>
  </p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.microtime.php" class="function" rel="rdfs-seeAlso">microtime()</a> - Return current Unix timestamp with microseconds</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/time.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.time%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.time&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.time.php">＋<small>add a note</small></a></span>
