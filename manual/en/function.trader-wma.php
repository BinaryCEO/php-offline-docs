...
<head>
  ...
  <title>PHP: trader_wma - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-wma.php">
 <link rel="shorturl" href="https://www.php.net/trader-wma">
 <link rel="alternate" href="https://www.php.net/trader-wma" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-willr.php">
 <link rel="next" href="https://www.php.net/manual/en/refs.utilspec.nontext.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-wma.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-wma.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-wma.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-wma.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-wma.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-wma.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-wma.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-wma.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-wma.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-wma.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-wma.php" hreflang="zh">
...
<meta name="Description" content="Weighted Moving Average" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_wma - Manual" />
<meta name="twitter:description" content="Weighted Moving Average" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_wma - Manual" />
<meta itemprop="description" content="Weighted Moving Average" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Weighted Moving Average" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="refs.utilspec.nontext.php">
          Non-Text MIME Output &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-willr.php">
          &laquo; trader_willr        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-wma.php' selected="selected">English</option>
            <option value='de/function.trader-wma.php'>German</option>
            <option value='es/function.trader-wma.php'>Spanish</option>
            <option value='fr/function.trader-wma.php'>French</option>
            <option value='it/function.trader-wma.php'>Italian</option>
            <option value='ja/function.trader-wma.php'>Japanese</option>
            <option value='pt_BR/function.trader-wma.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-wma.php'>Russian</option>
            <option value='tr/function.trader-wma.php'>Turkish</option>
            <option value='uk/function.trader-wma.php'>Ukrainian</option>
            <option value='zh/function.trader-wma.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-wma" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_wma</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_wma</span> &mdash; <span class="dc-title">Weighted Moving Average</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-wma-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_wma</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-wma-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-wma-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-wma.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-wma%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-wma&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-wma.php">＋<small>add a note</small></a></span>
