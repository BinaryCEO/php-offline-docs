...
<head>
  ...
  <title>PHP: SplFileInfo::getPathInfo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileinfo.getpathinfo.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileinfo.getpathinfo.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileinfo.getpathinfo.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileinfo.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileinfo.getpath.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileinfo.getpathname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/splfileinfo.getpathinfo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/splfileinfo.getpathinfo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/splfileinfo.getpathinfo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/splfileinfo.getpathinfo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/splfileinfo.getpathinfo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/splfileinfo.getpathinfo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/splfileinfo.getpathinfo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/splfileinfo.getpathinfo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/splfileinfo.getpathinfo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/splfileinfo.getpathinfo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/splfileinfo.getpathinfo.php" hreflang="zh">
...
<meta name="Description" content="Gets an SplFileInfo object for the path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplFileInfo::getPathInfo - Manual" />
<meta name="twitter:description" content="Gets an SplFileInfo object for the path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplFileInfo::getPathInfo - Manual" />
<meta itemprop="description" content="Gets an SplFileInfo object for the path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets an SplFileInfo object for the path" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="splfileinfo.getpathname.php">
          SplFileInfo::getPathname &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="splfileinfo.getpath.php">
          &laquo; SplFileInfo::getPath        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileinfo.getpathinfo.php' selected="selected">English</option>
            <option value='de/splfileinfo.getpathinfo.php'>German</option>
            <option value='es/splfileinfo.getpathinfo.php'>Spanish</option>
            <option value='fr/splfileinfo.getpathinfo.php'>French</option>
            <option value='it/splfileinfo.getpathinfo.php'>Italian</option>
            <option value='ja/splfileinfo.getpathinfo.php'>Japanese</option>
            <option value='pt_BR/splfileinfo.getpathinfo.php'>Brazilian Portuguese</option>
            <option value='ru/splfileinfo.getpathinfo.php'>Russian</option>
            <option value='tr/splfileinfo.getpathinfo.php'>Turkish</option>
            <option value='uk/splfileinfo.getpathinfo.php'>Ukrainian</option>
            <option value='zh/splfileinfo.getpathinfo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="splfileinfo.getpathinfo" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-splfileinfo.getpathinfo-examples">
  ...
  <p class="para">
   <div class="example" id="example-3975">
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="splfileinfo.setinfoclass.php" class="methodname" rel="rdfs-seeAlso">SplFileInfo::setInfoClass()</a> - Sets the class used with SplFileInfo::getFileInfo and SplFileInfo::getPathInfo</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileinfo/getpathinfo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileinfo.getpathinfo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileinfo.getpathinfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileinfo.getpathinfo.php">＋<small>add a note</small></a></span>
