...
<head>
  ...
  <title>PHP: wincache_ucache_inc - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-ucache-inc.php">
 <link rel="shorturl" href="https://www.php.net/wincache-ucache-inc">
 <link rel="alternate" href="https://www.php.net/wincache-ucache-inc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-ucache-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-ucache-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-ucache-inc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-ucache-inc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-ucache-inc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-ucache-inc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-ucache-inc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-ucache-inc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-ucache-inc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-ucache-inc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-ucache-inc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-ucache-inc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-ucache-inc.php" hreflang="zh">
...
<meta name="Description" content="Increments the value associated with the key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_ucache_inc - Manual" />
<meta name="twitter:description" content="Increments the value associated with the key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_ucache_inc - Manual" />
<meta itemprop="description" content="Increments the value associated with the key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Increments the value associated with the key" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.wincache-ucache-info.php">
          wincache_ucache_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-ucache-get.php">
          &laquo; wincache_ucache_get        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-ucache-inc.php' selected="selected">English</option>
            <option value='de/function.wincache-ucache-inc.php'>German</option>
            <option value='es/function.wincache-ucache-inc.php'>Spanish</option>
            <option value='fr/function.wincache-ucache-inc.php'>French</option>
            <option value='it/function.wincache-ucache-inc.php'>Italian</option>
            <option value='ja/function.wincache-ucache-inc.php'>Japanese</option>
            <option value='pt_BR/function.wincache-ucache-inc.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-ucache-inc.php'>Russian</option>
            <option value='tr/function.wincache-ucache-inc.php'>Turkish</option>
            <option value='uk/function.wincache-ucache-inc.php'>Ukrainian</option>
            <option value='zh/function.wincache-ucache-inc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-ucache-inc" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.wincache-ucache-inc-examples">
  ...
  <p class="para">
   <div class="example" id="example-757">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.wincache-ucache-cas.php" class="function" rel="rdfs-seeAlso">wincache_ucache_cas()</a> - Compares the variable with old value and assigns new value to it</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-ucache-inc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-ucache-inc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-ucache-inc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-ucache-inc.php">＋<small>add a note</small></a></span>
