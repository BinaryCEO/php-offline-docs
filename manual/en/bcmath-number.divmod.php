...
<head>
  ...
  <title>PHP: BcMath\Number::divmod - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/bcmath-number.divmod.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/bcmath-number.divmod.php">
 <link rel="alternate" href="https://www.php.net/manual/en/bcmath-number.divmod.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.bcmath-number.php">
 <link rel="prev" href="https://www.php.net/manual/en/bcmath-number.div.php">
 <link rel="next" href="https://www.php.net/manual/en/bcmath-number.floor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/bcmath-number.divmod.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/bcmath-number.divmod.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/bcmath-number.divmod.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/bcmath-number.divmod.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/bcmath-number.divmod.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/bcmath-number.divmod.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/bcmath-number.divmod.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/bcmath-number.divmod.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/bcmath-number.divmod.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/bcmath-number.divmod.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/bcmath-number.divmod.php" hreflang="zh">
...
<meta name="Description" content="Gets the quotient and modulus of an arbitrary precision number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: BcMath\Number::divmod - Manual" />
<meta name="twitter:description" content="Gets the quotient and modulus of an arbitrary precision number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: BcMath\Number::divmod - Manual" />
<meta itemprop="description" content="Gets the quotient and modulus of an arbitrary precision number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the quotient and modulus of an arbitrary precision number" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="bcmath-number.floor.php">
          BcMath\Number::floor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="bcmath-number.div.php">
          &laquo; BcMath\Number::div        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/bcmath-number.divmod.php' selected="selected">English</option>
            <option value='de/bcmath-number.divmod.php'>German</option>
            <option value='es/bcmath-number.divmod.php'>Spanish</option>
            <option value='fr/bcmath-number.divmod.php'>French</option>
            <option value='it/bcmath-number.divmod.php'>Italian</option>
            <option value='ja/bcmath-number.divmod.php'>Japanese</option>
            <option value='pt_BR/bcmath-number.divmod.php'>Brazilian Portuguese</option>
            <option value='ru/bcmath-number.divmod.php'>Russian</option>
            <option value='tr/bcmath-number.divmod.php'>Turkish</option>
            <option value='uk/bcmath-number.divmod.php'>Ukrainian</option>
            <option value='zh/bcmath-number.divmod.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="bcmath-number.divmod" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-bcmath-number.divmod-examples">
  ...
  <div class="example" id="example-3293">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="bcmath-number.mod.php" class="methodname" rel="rdfs-seeAlso">BcMath\Number::mod()</a> - Gets the modulus of an arbitrary precision number</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/bc/bcmath/number/divmod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbcmath-number.divmod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=bcmath-number.divmod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/bcmath-number.divmod.php">＋<small>add a note</small></a></span>
