...
<head>
  ...
  <title>PHP: db2_escape_string - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-escape-string.php">
 <link rel="shorturl" href="https://www.php.net/db2-escape-string">
 <link rel="alternate" href="https://www.php.net/db2-escape-string" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-cursor-type.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-exec.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-escape-string.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-escape-string.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-escape-string.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-escape-string.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-escape-string.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-escape-string.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-escape-string.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-escape-string.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-escape-string.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-escape-string.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-escape-string.php" hreflang="zh">
...
<meta name="Description" content="Used to escape certain characters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_escape_string - Manual" />
<meta name="twitter:description" content="Used to escape certain characters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_escape_string - Manual" />
<meta itemprop="description" content="Used to escape certain characters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Used to escape certain characters" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.db2-exec.php">
          db2_exec &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-cursor-type.php">
          &laquo; db2_cursor_type        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-escape-string.php' selected="selected">English</option>
            <option value='de/function.db2-escape-string.php'>German</option>
            <option value='es/function.db2-escape-string.php'>Spanish</option>
            <option value='fr/function.db2-escape-string.php'>French</option>
            <option value='it/function.db2-escape-string.php'>Italian</option>
            <option value='ja/function.db2-escape-string.php'>Japanese</option>
            <option value='pt_BR/function.db2-escape-string.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-escape-string.php'>Russian</option>
            <option value='tr/function.db2-escape-string.php'>Turkish</option>
            <option value='uk/function.db2-escape-string.php'>Ukrainian</option>
            <option value='zh/function.db2-escape-string.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-escape-string" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">db2_escape_string</h1>
  <p class="verinfo">(PECL ibm_db2 &gt;= 1.6.0)</p><p class="refpurpose"><span class="refname">db2_escape_string</span> &mdash; <span class="dc-title">
   Used to escape certain characters
  </span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.db2-escape-string-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_escape_string</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string_literal</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.db2-escape-string-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">string_literal</code></dt>
     <dd>
      <p class="para">
       The string that contains special characters that need to be modified. 
       Characters that are prepended with a backslash are <code class="literal">\x00</code>, 
       <code class="literal">\n</code>, <code class="literal">\r</code>, <code class="literal">\</code>, 
       <code class="literal">&#039;</code>, <code class="literal">&quot;</code> and <code class="literal">\x1a</code>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-escape-string-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <code class="parameter">string_literal</code> with the special characters 
   noted above prepended with backslashes.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.db2-escape-string-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1353">
    <p><strong>Example #1 A <span class="function"><strong>db2_escape_string()</strong></span> example</strong></p>
    <div class="example-contents"><p>
     Result of using the <span class="function"><strong>db2_escape_string()</strong></span> function
    </p></div>
...
<div class="examplescode"><pre class="examplescode">db2_escape_string: All characters: \0 , \n , \r , \\ , \&#039; , \&quot; , \Z .
...
db2_escape_string:</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.db2-escape-string-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.db2-prepare.php" class="function" rel="rdfs-seeAlso">db2_prepare()</a> - Prepares an SQL statement to be executed</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-escape-string.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-escape-string%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-escape-string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-escape-string.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="91147">  <div class="votes">
    <div id="Vu91147">
    <a href="/manual/vote-note.php?id=91147&amp;page=function.db2-escape-string&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91147">
    <a href="/manual/vote-note.php?id=91147&amp;page=function.db2-escape-string&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91147" title="50% like this...">
    0
    </div>
  </div>
  <a href="#91147" class="name">
  <strong class="user"><em>hippyjim</em></strong></a><a class="genanchor" href="#91147"> &para;</a><div class="date" title="2009-05-27 06:52"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91147">
<div class="phpcode"><code><span class="html">One thing to note here - don't know if it applies to all DB2 installations, and I know I'm using an antiquated one, but my DB2 install wants a ' to be quoted rather than slashed.<br /><br />That means this function is useless to pick up apostrophes ' in strings, as it adds a slash which DB2 ignores.<br /><br />You'll need to use something like str_replace to swap your ' for ''.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-escape-string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-escape-string.php">＋<small>add a note</small></a></div>
