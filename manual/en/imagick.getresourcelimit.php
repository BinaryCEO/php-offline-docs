...
<head>
  ...
  <title>PHP: Imagick::getResourceLimit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getresourcelimit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getresourcelimit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getresourcelimit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getresource.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getsamplingfactors.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getresourcelimit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getresourcelimit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getresourcelimit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getresourcelimit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getresourcelimit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getresourcelimit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getresourcelimit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getresourcelimit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getresourcelimit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getresourcelimit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getresourcelimit.php" hreflang="zh">
...
<meta name="Description" content="Returns the specified resource limit" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getResourceLimit - Manual" />
<meta name="twitter:description" content="Returns the specified resource limit" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getResourceLimit - Manual" />
<meta itemprop="description" content="Returns the specified resource limit" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the specified resource limit" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getsamplingfactors.php">
          Imagick::getSamplingFactors &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getresource.php">
          &laquo; Imagick::getResource        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getresourcelimit.php' selected="selected">English</option>
            <option value='de/imagick.getresourcelimit.php'>German</option>
            <option value='es/imagick.getresourcelimit.php'>Spanish</option>
            <option value='fr/imagick.getresourcelimit.php'>French</option>
            <option value='it/imagick.getresourcelimit.php'>Italian</option>
            <option value='ja/imagick.getresourcelimit.php'>Japanese</option>
            <option value='pt_BR/imagick.getresourcelimit.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getresourcelimit.php'>Russian</option>
            <option value='tr/imagick.getresourcelimit.php'>Turkish</option>
            <option value='uk/imagick.getresourcelimit.php'>Ukrainian</option>
            <option value='zh/imagick.getresourcelimit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getresourcelimit" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="imagick.setresourcelimit.php" class="methodname" rel="rdfs-seeAlso">Imagick::setResourceLimit()</a> - Sets the limit for a particular resource</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getresourcelimit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getresourcelimit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getresourcelimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getresourcelimit.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108776">  <div class="votes">
    <div id="Vu108776">
    <a href="/manual/vote-note.php?id=108776&amp;page=imagick.getresourcelimit&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108776">
    <a href="/manual/vote-note.php?id=108776&amp;page=imagick.getresourcelimit&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108776" title="50% like this...">
    0
    </div>
  </div>
  <a href="#108776" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108776"> &para;</a><div class="date" title="2012-05-23 11:43"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108776">
<div class="phpcode"><code><span class="html">By using the PHP function getResourceLimit, you'll be given the maximum allowed amount of a particular type of resource.  The integer returned is the number of bytes allowed to the resource you specified in the input parameter.  For the input parameter options, you have the predefined ResourceType constants for the ImageMagick package.  In the code, they look like imagick::RESOURCETYPE_AREA, but you have "_VALUE" options of: undefined, area, disk, file, map, and memory.<br /><br />What do each of these particular values represent?  The ImageMagick official documentation is helpful in that matter.  File indicates "maximum number of open pixel cache files", Area indicates "maximum area in bytes of any one image that can reside in the pixel cache memory", Memory indicates "maximum amount of memory in bytes to allocate for the pixel cache", map indicates "maximum amount of memory map in bytes to allocate for the pixel cache", and disk indicates "maximum amount of disk space in bytes permitted for use by the pixel cache".  This is according to the Official ImageMagick Architecture page: <a href="http://www.imagemagick.org/script/architecture.php" rel="nofollow" target="_blank">http://www.imagemagick.org/script/architecture.php</a> .<br /><br />The Official ImageMagick Resource page has more information on how these parameters function.  For instance, the files limit documentation mentions that when a user goes over the limit, any more files will be "cached to disk are closed and reopened on demand."  (Again, a performance hit.)  See that page here: <a href="http://www.imagemagick.org/script/resources.php" rel="nofollow" target="_blank">http://www.imagemagick.org/script/resources.php</a> .<br /><br />What happens when someone exceeds their limit?  It doesn't cause the PHP script to error out, but simply, it relocates their user activity to non-cache memory (i.e.: virtual memory, which is slow).  So, even if you're worried about the limit, it really only indicates the point in a server at which a user's request is devalued compared to other user requests.<br /><br />And remember, you can always set the defaults in the policy.xml file on your own server.<br /><br />Some sample code :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.gif"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get/Display Resource Values<br />        // ---------------------------------------------<br />    <br />    </span><span class="keyword">print(</span><span class="string">"Undefined: "</span><span class="keyword">);<br />    print(</span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getResourceLimit</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">RESOURCETYPE_UNDEFINED</span><span class="keyword">));<br /><br />    print(</span><span class="string">"&lt;br&gt;&lt;br&gt;Area: "</span><span class="keyword">);<br />    print(</span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getResourceLimit</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">RESOURCETYPE_AREA</span><span class="keyword">));<br />    <br />    print(</span><span class="string">"&lt;br&gt;&lt;br&gt;Disk: "</span><span class="keyword">);<br />    print(</span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getResourceLimit</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">RESOURCETYPE_DISK</span><span class="keyword">));<br />    <br />    print(</span><span class="string">"&lt;br&gt;&lt;br&gt;File: "</span><span class="keyword">);<br />    print(</span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getResourceLimit</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">RESOURCETYPE_FILE</span><span class="keyword">));<br />    <br />    print(</span><span class="string">"&lt;br&gt;&lt;br&gt;Map: "</span><span class="keyword">);<br />    print(</span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getResourceLimit</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">RESOURCETYPE_MAP</span><span class="keyword">));<br />    <br />    print(</span><span class="string">"&lt;br&gt;&lt;br&gt;Memory: "</span><span class="keyword">);<br />    print(</span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getResourceLimit</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">RESOURCETYPE_MEMORY</span><span class="keyword">));<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getresourcelimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getresourcelimit.php">＋<small>add a note</small></a></div>
