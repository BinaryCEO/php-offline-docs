...
<head>
  ...
  <title>PHP: Yar_Concurrent_Client::loop - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/yar-concurrent-client.loop.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/yar-concurrent-client.loop.php">
 <link rel="alternate" href="https://www.php.net/manual/en/yar-concurrent-client.loop.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.yar-concurrent-client.php">
 <link rel="prev" href="https://www.php.net/manual/en/yar-concurrent-client.call.php">
 <link rel="next" href="https://www.php.net/manual/en/yar-concurrent-client.reset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/yar-concurrent-client.loop.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/yar-concurrent-client.loop.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/yar-concurrent-client.loop.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/yar-concurrent-client.loop.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/yar-concurrent-client.loop.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/yar-concurrent-client.loop.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/yar-concurrent-client.loop.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/yar-concurrent-client.loop.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/yar-concurrent-client.loop.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/yar-concurrent-client.loop.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/yar-concurrent-client.loop.php" hreflang="zh">
...
<meta name="Description" content="Send all calls" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Yar_Concurrent_Client::loop - Manual" />
<meta name="twitter:description" content="Send all calls" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Yar_Concurrent_Client::loop - Manual" />
<meta itemprop="description" content="Send all calls" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Send all calls" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="yar-concurrent-client.reset.php">
          Yar_Concurrent_Client::reset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="yar-concurrent-client.call.php">
          &laquo; Yar_Concurrent_Client::call        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/yar-concurrent-client.loop.php' selected="selected">English</option>
            <option value='de/yar-concurrent-client.loop.php'>German</option>
            <option value='es/yar-concurrent-client.loop.php'>Spanish</option>
            <option value='fr/yar-concurrent-client.loop.php'>French</option>
            <option value='it/yar-concurrent-client.loop.php'>Italian</option>
            <option value='ja/yar-concurrent-client.loop.php'>Japanese</option>
            <option value='pt_BR/yar-concurrent-client.loop.php'>Brazilian Portuguese</option>
            <option value='ru/yar-concurrent-client.loop.php'>Russian</option>
            <option value='tr/yar-concurrent-client.loop.php'>Turkish</option>
            <option value='uk/yar-concurrent-client.loop.php'>Ukrainian</option>
            <option value='zh/yar-concurrent-client.loop.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="yar-concurrent-client.loop" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-yar-concurrent-client.loop-examples">
  ...
  <div class="example" id="example-5732">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="yar-server.handle.php" class="methodname" rel="rdfs-seeAlso">Yar_Server::handle()</a> - Start RPC Server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yar/yar_concurrent_client/loop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fyar-concurrent-client.loop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=yar-concurrent-client.loop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/yar-concurrent-client.loop.php">＋<small>add a note</small></a></span>
