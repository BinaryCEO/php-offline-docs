...
<head>
  ...
  <title>PHP: Imagick::readImageFile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.readimagefile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.readimagefile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.readimagefile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.readimageblob.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.readimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.readimagefile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.readimagefile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.readimagefile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.readimagefile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.readimagefile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.readimagefile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.readimagefile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.readimagefile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.readimagefile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.readimagefile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.readimagefile.php" hreflang="zh">
...
<meta name="Description" content="Reads image from open filehandle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::readImageFile - Manual" />
<meta name="twitter:description" content="Reads image from open filehandle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::readImageFile - Manual" />
<meta itemprop="description" content="Reads image from open filehandle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads image from open filehandle" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.readimages.php">
          Imagick::readimages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.readimageblob.php">
          &laquo; Imagick::readImageBlob        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.readimagefile.php' selected="selected">English</option>
            <option value='de/imagick.readimagefile.php'>German</option>
            <option value='es/imagick.readimagefile.php'>Spanish</option>
            <option value='fr/imagick.readimagefile.php'>French</option>
            <option value='it/imagick.readimagefile.php'>Italian</option>
            <option value='ja/imagick.readimagefile.php'>Japanese</option>
            <option value='pt_BR/imagick.readimagefile.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.readimagefile.php'>Russian</option>
            <option value='tr/imagick.readimagefile.php'>Turkish</option>
            <option value='uk/imagick.readimagefile.php'>Ukrainian</option>
            <option value='zh/imagick.readimagefile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.readimagefile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::readImageFile</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::readImageFile</span> &mdash; <span class="dc-title">Reads image from open filehandle</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.readimagefile-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::readImageFile</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$filehandle</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$fileName</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.readimagefile-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.readimagefile-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.readimagefile-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/readimagefile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.readimagefile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.readimagefile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.readimagefile.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="87852">  <div class="votes">
    <div id="Vu87852">
    <a href="/manual/vote-note.php?id=87852&amp;page=imagick.readimagefile&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd87852">
    <a href="/manual/vote-note.php?id=87852&amp;page=imagick.readimagefile&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V87852" title="59% like this...">
    4
    </div>
  </div>
  <a href="#87852" class="name">
  <strong class="user"><em>ben dot james at acknowledgement dot co dot uk</em></strong></a><a class="genanchor" href="#87852"> &para;</a><div class="date" title="2008-12-26 01:00"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom87852">
<div class="phpcode"><code><span class="html">An example of reading an image file from a URL, using a handle returned by fopen():<br /><br /><span class="default">&lt;?php<br />$handle </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">'<a href="http://example.com/foo.jpg" rel="nofollow" target="_blank">http://example.com/foo.jpg</a>'</span><span class="keyword">, </span><span class="string">'rb'</span><span class="keyword">);<br /></span><span class="default">$img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$handle</span><span class="keyword">);<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">resizeImage</span><span class="keyword">(</span><span class="default">128</span><span class="keyword">, </span><span class="default">128</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'images/foo.jpg'</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.readimagefile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.readimagefile.php">＋<small>add a note</small></a></div>
