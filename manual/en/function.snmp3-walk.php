...
<head>
  ...
  <title>PHP: snmp3_walk - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.snmp3-walk.php">
 <link rel="shorturl" href="https://www.php.net/snmp3-walk">
 <link rel="alternate" href="https://www.php.net/snmp3-walk" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.snmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.snmp3-set.php">
 <link rel="next" href="https://www.php.net/manual/en/function.snmpget.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.snmp3-walk.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.snmp3-walk.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.snmp3-walk.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.snmp3-walk.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.snmp3-walk.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.snmp3-walk.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.snmp3-walk.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.snmp3-walk.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.snmp3-walk.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.snmp3-walk.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.snmp3-walk.php" hreflang="zh">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.snmp3-walk.php' selected="selected">English</option>
            <option value='de/function.snmp3-walk.php'>German</option>
            <option value='es/function.snmp3-walk.php'>Spanish</option>
            <option value='fr/function.snmp3-walk.php'>French</option>
            <option value='it/function.snmp3-walk.php'>Italian</option>
            <option value='ja/function.snmp3-walk.php'>Japanese</option>
            <option value='pt_BR/function.snmp3-walk.php'>Brazilian Portuguese</option>
            <option value='ru/function.snmp3-walk.php'>Russian</option>
            <option value='tr/function.snmp3-walk.php'>Turkish</option>
            <option value='uk/function.snmp3-walk.php'>Ukrainian</option>
            <option value='zh/function.snmp3-walk.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.snmp3-walk" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">snmp3_walk</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">snmp3_walk</span> &mdash; <span class="dc-title">Fetch all the <abbr title="Simple Network Management Protocol">SNMP</abbr> objects from an agent</span></p>
 ...
 <div class="refsect1 changelog" id="refsect1-function.snmp3-walk-changelog">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$ret </span><span style="color: #007700">= </span><span style="color: #0000BB">snmp3_walk</span><span style="color: #007700">(</span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">, </span><span style="color: #DD0000">'james'</span><span style="color: #007700">, </span><span style="color: #DD0000">'authPriv'</span><span style="color: #007700">, </span><span style="color: #DD0000">'SHA'</span><span style="color: #007700">, </span><span style="color: #DD0000">'secret007'</span><span style="color: #007700">, </span><span style="color: #DD0000">'AES'</span><span style="color: #007700">, </span><span style="color: #DD0000">'secret007'</span><span style="color: #007700">, </span><span style="color: #DD0000">'IF-MIB::ifName'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">var_export</span><span style="color: #007700">(</span><span style="color: #0000BB">$ret</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   ...
   <abbr title="Simple Network Management Protocol">SNMP</abbr> agent running on localhost:
<div class="examplescode"><pre class="examplescode">array (
 ...
 <div class="refsect1 seealso" id="refsect1-function.snmp3-walk-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.snmp3-real-walk.php" class="function" rel="rdfs-seeAlso">snmp3_real_walk()</a> - Return all objects including their respective object ID within the specified one</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/snmp/functions/snmp3-walk.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.snmp3-walk%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.snmp3-walk&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.snmp3-walk.php">＋<small>add a note</small></a></span>
