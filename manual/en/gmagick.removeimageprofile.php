...
<head>
  ...
  <title>PHP: Gmagick::removeimageprofile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.removeimageprofile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.removeimageprofile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.removeimageprofile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.removeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.resampleimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.removeimageprofile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.removeimageprofile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.removeimageprofile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.removeimageprofile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.removeimageprofile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.removeimageprofile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.removeimageprofile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.removeimageprofile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.removeimageprofile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.removeimageprofile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.removeimageprofile.php" hreflang="zh">
...
<meta name="Description" content="Removes the named image profile and returns it" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::removeimageprofile - Manual" />
<meta name="twitter:description" content="Removes the named image profile and returns it" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::removeimageprofile - Manual" />
<meta itemprop="description" content="Removes the named image profile and returns it" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes the named image profile and returns it" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.resampleimage.php">
          Gmagick::resampleimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.removeimage.php">
          &laquo; Gmagick::removeimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.removeimageprofile.php' selected="selected">English</option>
            <option value='de/gmagick.removeimageprofile.php'>German</option>
            <option value='es/gmagick.removeimageprofile.php'>Spanish</option>
            <option value='fr/gmagick.removeimageprofile.php'>French</option>
            <option value='it/gmagick.removeimageprofile.php'>Italian</option>
            <option value='ja/gmagick.removeimageprofile.php'>Japanese</option>
            <option value='pt_BR/gmagick.removeimageprofile.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.removeimageprofile.php'>Russian</option>
            <option value='tr/gmagick.removeimageprofile.php'>Turkish</option>
            <option value='uk/gmagick.removeimageprofile.php'>Ukrainian</option>
            <option value='zh/gmagick.removeimageprofile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.removeimageprofile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::removeimageprofile</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::removeimageprofile</span> &mdash; <span class="dc-title">Removes the named image profile and returns it</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.removeimageprofile-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::removeimageprofile</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.removeimageprofile-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.removeimageprofile-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.removeimageprofile-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/removeimageprofile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.removeimageprofile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.removeimageprofile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.removeimageprofile.php">＋<small>add a note</small></a></span>
