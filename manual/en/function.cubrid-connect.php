...
<head>
  ...
  <title>PHP: cubrid_connect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-connect.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-connect">
 <link rel="alternate" href="https://www.php.net/cubrid-connect" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-commit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-connect-with-url.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-connect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-connect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-connect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-connect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-connect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-connect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-connect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-connect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-connect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-connect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-connect.php" hreflang="zh">
...
<meta name="Description" content="Open a connection to a CUBRID Server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_connect - Manual" />
<meta name="twitter:description" content="Open a connection to a CUBRID Server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_connect - Manual" />
<meta itemprop="description" content="Open a connection to a CUBRID Server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open a connection to a CUBRID Server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-connect-with-url.php">
          cubrid_connect_with_url &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-commit.php">
          &laquo; cubrid_commit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-connect.php' selected="selected">English</option>
            <option value='de/function.cubrid-connect.php'>German</option>
            <option value='es/function.cubrid-connect.php'>Spanish</option>
            <option value='fr/function.cubrid-connect.php'>French</option>
            <option value='it/function.cubrid-connect.php'>Italian</option>
            <option value='ja/function.cubrid-connect.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-connect.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-connect.php'>Russian</option>
            <option value='tr/function.cubrid-connect.php'>Turkish</option>
            <option value='uk/function.cubrid-connect.php'>Ukrainian</option>
            <option value='zh/function.cubrid-connect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-connect" class="refentry">
 ...
 <p class="para">
  <dl>
    ...
    <dd><p class="para">User name for the database. If not given, the default
      value is &quot;public&quot;.</p></dd>
   
   
    <dt><code class="parameter">passwd</code></dt>
    <dd><p class="para">User password. If not given, the default value is &quot;&quot;.</p></dd>
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-close.php" class="function" rel="rdfs-seeAlso">cubrid_close()</a> - Close CUBRID connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-connect.php">＋<small>add a note</small></a></span>
