...
<head>
  ...
  <title>PHP: Imagick::contrastStretchImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.contraststretchimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.contraststretchimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.contraststretchimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.contrastimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.convolveimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.contraststretchimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.contraststretchimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.contraststretchimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.contraststretchimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.contraststretchimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.contraststretchimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.contraststretchimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.contraststretchimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.contraststretchimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.contraststretchimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.contraststretchimage.php" hreflang="zh">
...
<meta name="Description" content="Enhances the contrast of a color image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::contrastStretchImage - Manual" />
<meta name="twitter:description" content="Enhances the contrast of a color image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::contrastStretchImage - Manual" />
<meta itemprop="description" content="Enhances the contrast of a color image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enhances the contrast of a color image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.convolveimage.php">
          Imagick::convolveImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.contrastimage.php">
          &laquo; Imagick::contrastImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.contraststretchimage.php' selected="selected">English</option>
            <option value='de/imagick.contraststretchimage.php'>German</option>
            <option value='es/imagick.contraststretchimage.php'>Spanish</option>
            <option value='fr/imagick.contraststretchimage.php'>French</option>
            <option value='it/imagick.contraststretchimage.php'>Italian</option>
            <option value='ja/imagick.contraststretchimage.php'>Japanese</option>
            <option value='pt_BR/imagick.contraststretchimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.contraststretchimage.php'>Russian</option>
            <option value='tr/imagick.contraststretchimage.php'>Turkish</option>
            <option value='uk/imagick.contraststretchimage.php'>Ukrainian</option>
            <option value='zh/imagick.contraststretchimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.contraststretchimage" class="refentry">
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.contraststretchimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">black_point</code></dt>
     <dd>
      <p class="para">
      The black point.
      </p>
     ...
     <dt><code class="parameter">white_point</code></dt>
     <dd>
      <p class="para">
      The white point.
      </p>
     ...
     <dd>
      <p class="para">
       ...
       bitwise operators. <strong><code><a href="imagick.constants.php#imagick.constants.channel-all">Imagick::CHANNEL_ALL</a></code></strong>. Refer to this
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/contraststretchimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.contraststretchimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.contraststretchimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.contraststretchimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115191">  <div class="votes">
    <div id="Vu115191">
    <a href="/manual/vote-note.php?id=115191&amp;page=imagick.contraststretchimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115191">
    <a href="/manual/vote-note.php?id=115191&amp;page=imagick.contraststretchimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115191" title="100% like this...">
    2
    </div>
  </div>
  <a href="#115191" class="name">
  <strong class="user"><em>SkepticaLee</em></strong></a><a class="genanchor" href="#115191"> &para;</a><div class="date" title="2014-06-11 10:22"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115191">
<div class="phpcode"><code><span class="html">The black and white points refer to the absolute number of pixels. In the following example a coloured image is first desaturated (turned into a grey scale image) and then the darkest 90% of pixels are turned black, the brightest 5% are made white, and those between 90% and 95% are grey-scaled:<br /><br /><span class="default">&lt;?php<br />$im </span><span class="keyword">= new </span><span class="default">Imagick </span><span class="keyword">(</span><span class="string">"some_image.jpg"</span><span class="keyword">);<br />list (</span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">) = </span><span class="default">array_values </span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImageGeometry </span><span class="keyword">());<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">modulateImage </span><span class="keyword">(</span><span class="default">100</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">contrastStretchImage </span><span class="keyword">(</span><span class="default">$width </span><span class="keyword">* </span><span class="default">$height </span><span class="keyword">* </span><span class="default">0.90</span><span class="keyword">, </span><span class="default">$width </span><span class="keyword">* </span><span class="default">$height </span><span class="keyword">* </span><span class="default">0.95</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage </span><span class="keyword">(</span><span class="string">"temp.jpg"</span><span class="keyword">);<br />echo </span><span class="string">"&lt;img src=\"temp.jpg\"&gt;"</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="114451">  <div class="votes">
    <div id="Vu114451">
    <a href="/manual/vote-note.php?id=114451&amp;page=imagick.contraststretchimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114451">
    <a href="/manual/vote-note.php?id=114451&amp;page=imagick.contraststretchimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114451" title="no votes...">
    0
    </div>
  </div>
  <a href="#114451" class="name">
  <strong class="user"><em>SkepticaLee</em></strong></a><a class="genanchor" href="#114451"> &para;</a><div class="date" title="2014-02-21 06:47"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114451">
<div class="phpcode"><code><span class="html">Trying to figure out what values the black and white points can have and what their effects are nearly drove me around the bend. However, this works:<br /><br /><span class="default">&lt;?php<br />$width </span><span class="keyword">= </span><span class="default">480</span><span class="keyword">;<br /></span><span class="default">$height </span><span class="keyword">= </span><span class="default">360</span><span class="keyword">;<br /></span><span class="default">$mask </span><span class="keyword">= new </span><span class="default">Imagick </span><span class="keyword">();<br /></span><span class="default">$mask</span><span class="keyword">-&gt;</span><span class="default">newImage </span><span class="keyword">(</span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">, </span><span class="string">"black"</span><span class="keyword">);<br /></span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw </span><span class="keyword">();<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor </span><span class="keyword">(</span><span class="string">"white"</span><span class="keyword">);<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">ellipse </span><span class="keyword">(</span><span class="default">$width </span><span class="keyword">/ </span><span class="default">2</span><span class="keyword">, </span><span class="default">$height </span><span class="keyword">/ </span><span class="default">2</span><span class="keyword">, </span><span class="default">$width </span><span class="keyword">* </span><span class="default">5 </span><span class="keyword">/ </span><span class="default">12</span><span class="keyword">, </span><span class="default">$height </span><span class="keyword">* </span><span class="default">5 </span><span class="keyword">/ </span><span class="default">12</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">360</span><span class="keyword">);<br /></span><span class="default">$mask</span><span class="keyword">-&gt;</span><span class="default">drawImage </span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">);<br /></span><span class="default">$mask</span><span class="keyword">-&gt;</span><span class="default">blurImage </span><span class="keyword">(</span><span class="default">0</span><span class="keyword">, </span><span class="default">50</span><span class="keyword">);<br /></span><span class="default">$mask</span><span class="keyword">-&gt;</span><span class="default">contrastStretchImage </span><span class="keyword">(</span><span class="default">10</span><span class="keyword">, </span><span class="default">125000</span><span class="keyword">);<br /></span><span class="default">$mask</span><span class="keyword">-&gt;</span><span class="default">writeImage </span><span class="keyword">(</span><span class="string">"mask.png"</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />The result will be a vignette mask with the pixels in the corner being pure black, and the ones in the middle pure white (which is not the case if the line is commented out). Reducing the white value to, say, 100, turns most of the grey pixels white.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.contraststretchimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.contraststretchimage.php">＋<small>add a note</small></a></div>
