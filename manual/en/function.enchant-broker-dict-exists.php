...
<head>
  ...
  <title>PHP: enchant_broker_dict_exists - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.enchant-broker-dict-exists.php">
 <link rel="shorturl" href="https://www.php.net/enchant-broker-dict-exists">
 <link rel="alternate" href="https://www.php.net/enchant-broker-dict-exists" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.enchant.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.enchant-broker-describe.php">
 <link rel="next" href="https://www.php.net/manual/en/function.enchant-broker-free.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.enchant-broker-dict-exists.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.enchant-broker-dict-exists.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.enchant-broker-dict-exists.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.enchant-broker-dict-exists.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.enchant-broker-dict-exists.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.enchant-broker-dict-exists.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.enchant-broker-dict-exists.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.enchant-broker-dict-exists.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.enchant-broker-dict-exists.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.enchant-broker-dict-exists.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.enchant-broker-dict-exists.php" hreflang="zh">
...
<meta name="Description" content="Whether a dictionary exists or not. Using non-empty tag" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: enchant_broker_dict_exists - Manual" />
<meta name="twitter:description" content="Whether a dictionary exists or not. Using non-empty tag" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: enchant_broker_dict_exists - Manual" />
<meta itemprop="description" content="Whether a dictionary exists or not. Using non-empty tag" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Whether a dictionary exists or not. Using non-empty tag" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.enchant-broker-free.php">
          enchant_broker_free &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.enchant-broker-describe.php">
          &laquo; enchant_broker_describe        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.enchant-broker-dict-exists.php' selected="selected">English</option>
            <option value='de/function.enchant-broker-dict-exists.php'>German</option>
            <option value='es/function.enchant-broker-dict-exists.php'>Spanish</option>
            <option value='fr/function.enchant-broker-dict-exists.php'>French</option>
            <option value='it/function.enchant-broker-dict-exists.php'>Italian</option>
            <option value='ja/function.enchant-broker-dict-exists.php'>Japanese</option>
            <option value='pt_BR/function.enchant-broker-dict-exists.php'>Brazilian Portuguese</option>
            <option value='ru/function.enchant-broker-dict-exists.php'>Russian</option>
            <option value='tr/function.enchant-broker-dict-exists.php'>Turkish</option>
            <option value='uk/function.enchant-broker-dict-exists.php'>Ukrainian</option>
            <option value='zh/function.enchant-broker-dict-exists.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.enchant-broker-dict-exists" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">enchant_broker_dict_exists</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL enchant &gt;= 0.1.0 )</p><p class="refpurpose"><span class="refname">enchant_broker_dict_exists</span> &mdash; <span class="dc-title">Whether a dictionary exists or not. Using non-empty tag</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.enchant-broker-dict-exists-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> when the tag exist or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> when not.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.enchant-broker-dict-exists-examples">
  ...
  <p class="para">
   <div class="example" id="example-2453">
    <p><strong>Example #1 A <span class="function"><strong>enchant_broker_dict_exists()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$tag </span><span style="color: #007700">= </span><span style="color: #DD0000">'en_US'</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$r </span><span style="color: #007700">= </span><span style="color: #0000BB">enchant_broker_init</span><span style="color: #007700">();<br />if (</span><span style="color: #0000BB">enchant_broker_dict_exists</span><span style="color: #007700">(</span><span style="color: #0000BB">$r</span><span style="color: #007700">,</span><span style="color: #0000BB">$tag</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #0000BB">$tag </span><span style="color: #007700">. </span><span style="color: #DD0000">" dictionary found.\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.enchant-broker-dict-exists-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.enchant-broker-describe.php" class="function" rel="rdfs-seeAlso">enchant_broker_describe()</a> - Enumerates the Enchant providers</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/enchant/functions/enchant-broker-dict-exists.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.enchant-broker-dict-exists%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.enchant-broker-dict-exists&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.enchant-broker-dict-exists.php">＋<small>add a note</small></a></span>
