...
<head>
  ...
  <title>PHP: Gmagick::setimageprofile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimageprofile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimageprofile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageprofile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimageiterations.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimageredprimary.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageprofile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimageprofile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimageprofile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimageprofile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimageprofile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimageprofile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimageprofile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimageprofile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimageprofile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimageprofile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimageprofile.php" hreflang="zh">
...
<meta name="Description" content="Adds a named profile to the Gmagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::setimageprofile - Manual" />
<meta name="twitter:description" content="Adds a named profile to the Gmagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimageprofile - Manual" />
<meta itemprop="description" content="Adds a named profile to the Gmagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds a named profile to the Gmagick object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.setimageredprimary.php">
          Gmagick::setimageredprimary &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimageiterations.php">
          &laquo; Gmagick::setimageiterations        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimageprofile.php' selected="selected">English</option>
            <option value='de/gmagick.setimageprofile.php'>German</option>
            <option value='es/gmagick.setimageprofile.php'>Spanish</option>
            <option value='fr/gmagick.setimageprofile.php'>French</option>
            <option value='it/gmagick.setimageprofile.php'>Italian</option>
            <option value='ja/gmagick.setimageprofile.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimageprofile.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimageprofile.php'>Russian</option>
            <option value='tr/gmagick.setimageprofile.php'>Turkish</option>
            <option value='uk/gmagick.setimageprofile.php'>Ukrainian</option>
            <option value='zh/gmagick.setimageprofile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimageprofile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimageprofile</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimageprofile</span> &mdash; <span class="dc-title">Adds a named profile to the Gmagick object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimageprofile-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimageprofile</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$profile</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimageprofile-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimageprofile-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimageprofile-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimageprofile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimageprofile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimageprofile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimageprofile.php">＋<small>add a note</small></a></span>
