...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileinfo.getatime.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileinfo.getatime.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileinfo.getatime.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileinfo.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileinfo.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileinfo.getbasename.php">
...
<meta name="Description" content="Gets last access time of the file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplFileInfo::getATime - Manual" />
<meta name="twitter:description" content="Gets last access time of the file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplFileInfo::getATime - Manual" />
<meta itemprop="description" content="Gets last access time of the file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets last access time of the file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileinfo.getatime.php' selected="selected">English</option>
            ...
            <option value='ru/splfileinfo.getatime.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.2, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">SplFileInfo::getATime</span> &mdash; <span class="dc-title">Gets last access time of the file</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-splfileinfo.getatime-returnvalues">
  ...
  <p class="para">
   Returns the time the file was last accessed on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-splfileinfo.getatime-examples">
  ...
  <p class="para">
   <div class="example" id="example-3965">
    <p><strong>Example #1 <span class="methodname"><strong>SplFileInfo::getATime()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$info </span><span style="color: #007700">= new </span><span style="color: #0000BB">SplFileInfo</span><span style="color: #007700">(</span><span style="color: #DD0000">'example.jpg'</span><span style="color: #007700">);<br />echo </span><span style="color: #DD0000">'Last accessed at ' </span><span style="color: #007700">. </span><span style="color: #0000BB">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'g:i a'</span><span style="color: #007700">, </span><span style="color: #0000BB">$info</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getATime</span><span style="color: #007700">());<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>

    <div class="example-contents"><p>The above example will output
something similar to:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">Last accessed at 1:49 pm</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-splfileinfo.getatime-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fileatime.php" class="function" rel="rdfs-seeAlso">fileatime()</a> - Gets last access time of file</span></li>
    ...
    <li><span class="methodname"><a href="splfileinfo.getmtime.php" class="methodname" rel="rdfs-seeAlso">SplFileInfo::getMTime()</a> - Gets the last modified time</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileinfo/getatime.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileinfo.getatime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileinfo.getatime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileinfo.getatime.php">＋<small>add a note</small></a></span>
