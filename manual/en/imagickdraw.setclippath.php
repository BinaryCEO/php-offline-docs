...
<head>
  ...
  <title>PHP: ImagickDraw::setClipPath - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setclippath.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setclippath.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setclippath.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.scale.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setcliprule.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setclippath.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setclippath.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setclippath.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setclippath.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setclippath.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setclippath.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setclippath.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setclippath.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setclippath.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setclippath.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setclippath.php" hreflang="zh">
...
<meta name="Description" content="Associates a named clipping path with the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setClipPath - Manual" />
<meta name="twitter:description" content="Associates a named clipping path with the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setClipPath - Manual" />
<meta itemprop="description" content="Associates a named clipping path with the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Associates a named clipping path with the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setcliprule.php">
          ImagickDraw::setClipRule &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.scale.php">
          &laquo; ImagickDraw::scale        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setclippath.php' selected="selected">English</option>
            <option value='de/imagickdraw.setclippath.php'>German</option>
            <option value='es/imagickdraw.setclippath.php'>Spanish</option>
            <option value='fr/imagickdraw.setclippath.php'>French</option>
            <option value='it/imagickdraw.setclippath.php'>Italian</option>
            <option value='ja/imagickdraw.setclippath.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setclippath.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setclippath.php'>Russian</option>
            <option value='tr/imagickdraw.setclippath.php'>Turkish</option>
            <option value='uk/imagickdraw.setclippath.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setclippath.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setclippath" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setClipPath</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setClipPath</span> &mdash; <span class="dc-title">Associates a named clipping path with the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setclippath-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setClipPath</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$clip_mask</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setclippath-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setclippath-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3167">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setclippath.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setclippath%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setclippath&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setclippath.php">＋<small>add a note</small></a></span>
