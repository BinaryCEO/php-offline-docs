...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.event.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.event.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.event.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.event.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.event.php">
 <link rel="next" href="https://www.php.net/manual/en/event.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.event.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.event.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.event.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.event.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.event.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.event.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.event.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.event.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.event.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.event.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.event.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.event.php' selected="selected">English</option>
            <option value='de/intro.event.php'>German</option>
            <option value='es/intro.event.php'>Spanish</option>
            <option value='fr/intro.event.php'>French</option>
            <option value='it/intro.event.php'>Italian</option>
            <option value='ja/intro.event.php'>Japanese</option>
            <option value='pt_BR/intro.event.php'>Brazilian Portuguese</option>
            <option value='ru/intro.event.php'>Russian</option>
            <option value='tr/intro.event.php'>Turkish</option>
            <option value='uk/intro.event.php'>Ukrainian</option>
            <option value='zh/intro.event.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.event" class="preface">
   ...
   <p class="para">
    ...
    and greater is not compatible with previous versions.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.event%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.event&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.event.php">＋<small>add a note</small></a></span>
