...
<head>
  ...
  <title>PHP: Gmagick::setimagescene - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagescene.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagescene.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagescene.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimageresolution.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagetype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagescene.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimagescene.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimagescene.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimagescene.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimagescene.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimagescene.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimagescene.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimagescene.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimagescene.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimagescene.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimagescene.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimagescene - Manual" />
<meta name="twitter:description" content="Sets the image scene" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimagescene - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.setimagetype.php">
          Gmagick::setimagetype &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimageresolution.php">
          &laquo; Gmagick::setimageresolution        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagescene.php' selected="selected">English</option>
            <option value='de/gmagick.setimagescene.php'>German</option>
            <option value='es/gmagick.setimagescene.php'>Spanish</option>
            <option value='fr/gmagick.setimagescene.php'>French</option>
            <option value='it/gmagick.setimagescene.php'>Italian</option>
            <option value='ja/gmagick.setimagescene.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimagescene.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimagescene.php'>Russian</option>
            <option value='tr/gmagick.setimagescene.php'>Turkish</option>
            <option value='uk/gmagick.setimagescene.php'>Ukrainian</option>
            <option value='zh/gmagick.setimagescene.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimagescene" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimagescene</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimagescene</span> &mdash; <span class="dc-title">Sets the image scene</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimagescene-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimagescene</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$scene</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimagescene-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimagescene-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimagescene-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagescene.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagescene%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagescene&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagescene.php">＋<small>add a note</small></a></span>
