...
<head>
  ...
  <title>PHP: stream_is_local - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-is-local.php">
 <link rel="shorturl" href="https://www.php.net/stream-is-local">
 <link rel="alternate" href="https://www.php.net/stream-is-local" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-get-wrappers.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-isatty.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-is-local.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-is-local.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-is-local.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-is-local.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-is-local.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-is-local.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-is-local.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-is-local.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-is-local.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-is-local.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-is-local.php" hreflang="zh">
...
<meta name="Description" content="Checks if a stream is a local stream" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_is_local - Manual" />
<meta name="twitter:description" content="Checks if a stream is a local stream" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_is_local - Manual" />
<meta itemprop="description" content="Checks if a stream is a local stream" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if a stream is a local stream" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-is-local.php' selected="selected">English</option>
            <option value='de/function.stream-is-local.php'>German</option>
            <option value='es/function.stream-is-local.php'>Spanish</option>
            <option value='fr/function.stream-is-local.php'>French</option>
            <option value='it/function.stream-is-local.php'>Italian</option>
            <option value='ja/function.stream-is-local.php'>Japanese</option>
            <option value='pt_BR/function.stream-is-local.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-is-local.php'>Russian</option>
            <option value='tr/function.stream-is-local.php'>Turkish</option>
            <option value='uk/function.stream-is-local.php'>Ukrainian</option>
            <option value='zh/function.stream-is-local.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-is-local" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stream_is_local</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.4, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_is_local</span> &mdash; <span class="dc-title">Checks if a stream is a local stream</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.stream-is-local-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stream_is_local</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$stream</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stream-is-local-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The stream <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> or URL to check.
      </p>
     </dd>
...
bool(true)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-is-local.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-is-local%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-is-local&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-is-local.php">＋<small>add a note</small></a></span>
