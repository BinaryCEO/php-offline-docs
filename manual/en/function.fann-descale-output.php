...
<head>
  ...
  <title>PHP: fann_descale_output - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-descale-output.php">
 <link rel="shorturl" href="https://www.php.net/fann-descale-output">
 <link rel="alternate" href="https://www.php.net/fann-descale-output" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-descale-input.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-descale-train.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-descale-output.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-descale-output.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-descale-output.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-descale-output.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-descale-output.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-descale-output.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-descale-output.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-descale-output.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-descale-output.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-descale-output.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-descale-output.php" hreflang="zh">
...
<meta name="Description" content="Scale data in output vector after get it from ann based on previously calculated parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_descale_output - Manual" />
<meta name="twitter:description" content="Scale data in output vector after get it from ann based on previously calculated parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_descale_output - Manual" />
<meta itemprop="description" content="Scale data in output vector after get it from ann based on previously calculated parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Scale data in output vector after get it from ann based on previously calculated parameters" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-descale-train.php">
          fann_descale_train &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-descale-input.php">
          &laquo; fann_descale_input        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-descale-output.php' selected="selected">English</option>
            <option value='de/function.fann-descale-output.php'>German</option>
            <option value='es/function.fann-descale-output.php'>Spanish</option>
            <option value='fr/function.fann-descale-output.php'>French</option>
            <option value='it/function.fann-descale-output.php'>Italian</option>
            <option value='ja/function.fann-descale-output.php'>Japanese</option>
            <option value='pt_BR/function.fann-descale-output.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-descale-output.php'>Russian</option>
            <option value='tr/function.fann-descale-output.php'>Turkish</option>
            <option value='uk/function.fann-descale-output.php'>Ukrainian</option>
            <option value='zh/function.fann-descale-output.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-descale-output" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_descale_output</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_descale_output</span> &mdash; <span class="dc-title">Scale data in output vector after get it from ann based on previously calculated parameters</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-descale-output-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_descale_output</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$output_vector</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-descale-output-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-descale-output-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-descale-output-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-descale-input.php" class="function" rel="rdfs-seeAlso">fann_descale_input()</a> - Scale data in input vector after get it from ann based on previously calculated parameters</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-descale-output.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-descale-output%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-descale-output&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-descale-output.php">＋<small>add a note</small></a></span>
