...
<head>
  ...
  <title>PHP: rnp_key_revoke - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rnp-key-revoke.php">
 <link rel="shorturl" href="https://www.php.net/rnp-key-revoke">
 <link rel="alternate" href="https://www.php.net/rnp-key-revoke" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.rnp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.rnp-key-remove.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rnp-list-keys.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rnp-key-revoke.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rnp-key-revoke.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rnp-key-revoke.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rnp-key-revoke.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rnp-key-revoke.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rnp-key-revoke.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rnp-key-revoke.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rnp-key-revoke.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rnp-key-revoke.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rnp-key-revoke.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rnp-key-revoke.php" hreflang="zh">
...
<meta name="Description" content="Revoke a key or subkey by generating and adding revocation signature" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rnp_key_revoke - Manual" />
<meta name="twitter:description" content="Revoke a key or subkey by generating and adding revocation signature" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rnp_key_revoke - Manual" />
<meta itemprop="description" content="Revoke a key or subkey by generating and adding revocation signature" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Revoke a key or subkey by generating and adding revocation signature" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rnp-key-revoke.php' selected="selected">English</option>
            <option value='de/function.rnp-key-revoke.php'>German</option>
            <option value='es/function.rnp-key-revoke.php'>Spanish</option>
            <option value='fr/function.rnp-key-revoke.php'>French</option>
            <option value='it/function.rnp-key-revoke.php'>Italian</option>
            <option value='ja/function.rnp-key-revoke.php'>Japanese</option>
            <option value='pt_BR/function.rnp-key-revoke.php'>Brazilian Portuguese</option>
            <option value='ru/function.rnp-key-revoke.php'>Russian</option>
            <option value='tr/function.rnp-key-revoke.php'>Turkish</option>
            <option value='uk/function.rnp-key-revoke.php'>Ukrainian</option>
            <option value='zh/function.rnp-key-revoke.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rnp-key-revoke" class="refentry">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/functions/rnp-key-revoke.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rnp-key-revoke%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rnp-key-revoke&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rnp-key-revoke.php">＋<small>add a note</small></a></span>
