...
<head>
  ...
  <title>PHP: Phar::addFromString - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.addfromstring.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.addfromstring.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.addfromstring.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.addfile.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.apiversion.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.addfromstring.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.addfromstring.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.addfromstring.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.addfromstring.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.addfromstring.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.addfromstring.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.addfromstring.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.addfromstring.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.addfromstring.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.addfromstring.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.addfromstring.php" hreflang="zh">
...
<meta name="Description" content="Add a file from a string to the phar archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::addFromString - Manual" />
<meta name="twitter:description" content="Add a file from a string to the phar archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::addFromString - Manual" />
<meta itemprop="description" content="Add a file from a string to the phar archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add a file from a string to the phar archive" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.apiversion.php">
          Phar::apiVersion &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.addfile.php">
          &laquo; Phar::addFile        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.addfromstring.php' selected="selected">English</option>
            <option value='de/phar.addfromstring.php'>German</option>
            <option value='es/phar.addfromstring.php'>Spanish</option>
            <option value='fr/phar.addfromstring.php'>French</option>
            <option value='it/phar.addfromstring.php'>Italian</option>
            <option value='ja/phar.addfromstring.php'>Japanese</option>
            <option value='pt_BR/phar.addfromstring.php'>Brazilian Portuguese</option>
            <option value='ru/phar.addfromstring.php'>Russian</option>
            <option value='tr/phar.addfromstring.php'>Turkish</option>
            <option value='uk/phar.addfromstring.php'>Ukrainian</option>
            <option value='zh/phar.addfromstring.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.addfromstring" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::addFromString</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">Phar::addFromString</span> &mdash; <span class="dc-title">Add a file from a string to the phar archive</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-phar.addfromstring-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::addFromString</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$localName</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$contents</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">try {<br />    </span><span style="color: #0000BB">$a </span><span style="color: #007700">= new </span><span style="color: #0000BB">Phar</span><span style="color: #007700">(</span><span style="color: #DD0000">'/path/to/phar.phar'</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$a</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addFromString</span><span style="color: #007700">(</span><span style="color: #DD0000">'path/to/file.txt'</span><span style="color: #007700">, </span><span style="color: #DD0000">'my simple file'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$b </span><span style="color: #007700">= </span><span style="color: #0000BB">$a</span><span style="color: #007700">[</span><span style="color: #DD0000">'path/to/file.txt'</span><span style="color: #007700">]-&gt;</span><span style="color: #0000BB">getContent</span><span style="color: #007700">();<br /><br />    </span><span style="color: #FF8000">// to add contents from a stream handle for large files, use offsetSet()<br />    </span><span style="color: #0000BB">$c </span><span style="color: #007700">= </span><span style="color: #0000BB">fopen</span><span style="color: #007700">(</span><span style="color: #DD0000">'/path/to/hugefile.bin'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$a</span><span style="color: #007700">[</span><span style="color: #DD0000">'largefile.bin'</span><span style="color: #007700">] = </span><span style="color: #0000BB">$c</span><span style="color: #007700">;<br />    </span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$c</span><span style="color: #007700">);<br />} catch (</span><span style="color: #0000BB">Exception $e</span><span style="color: #007700">) {<br />    </span><span style="color: #FF8000">// handle errors here<br /></span><span style="color: #007700">}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-phar.addfromstring-notes">
  <h3 class="title">Notes</h3>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
 <span class="simpara">
  <span class="function"><a href="phar.addfile.php" class="function">Phar::addFile()</a></span>, <span class="function"><strong>Phar::addFromString()</strong></span> and <span class="function"><a href="phar.offsetset.php" class="function">Phar::offsetSet()</a></span>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.addemptydir.php" class="function" rel="rdfs-seeAlso">Phar::addEmptyDir()</a> - Add an empty directory to the phar archive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/addFromString.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.addfromstring%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.addfromstring&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.addfromstring.php">＋<small>add a note</small></a></span>
