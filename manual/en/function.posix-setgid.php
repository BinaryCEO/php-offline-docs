...
<head>
  ...
  <title>PHP: posix_setgid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-setgid.php">
 <link rel="shorturl" href="https://www.php.net/posix-setgid">
 <link rel="alternate" href="https://www.php.net/posix-setgid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-seteuid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-setpgid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-setgid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-setgid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-setgid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-setgid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-setgid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-setgid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-setgid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-setgid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-setgid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-setgid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-setgid.php" hreflang="zh">
...
<meta name="Description" content="Set the GID of the current process" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_setgid - Manual" />
<meta name="twitter:description" content="Set the GID of the current process" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_setgid - Manual" />
<meta itemprop="description" content="Set the GID of the current process" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the GID of the current process" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.posix-setpgid.php">
          posix_setpgid &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.posix-seteuid.php">
          &laquo; posix_seteuid        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-setgid.php' selected="selected">English</option>
            <option value='de/function.posix-setgid.php'>German</option>
            <option value='es/function.posix-setgid.php'>Spanish</option>
            <option value='fr/function.posix-setgid.php'>French</option>
            <option value='it/function.posix-setgid.php'>Italian</option>
            <option value='ja/function.posix-setgid.php'>Japanese</option>
            <option value='pt_BR/function.posix-setgid.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-setgid.php'>Russian</option>
            <option value='tr/function.posix-setgid.php'>Turkish</option>
            <option value='uk/function.posix-setgid.php'>Ukrainian</option>
            <option value='zh/function.posix-setgid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-setgid" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.posix-setgid-examples">
  ...
  <p class="para">
   <div class="example" id="example-3594">
    <p><strong>Example #1 <span class="function"><strong>posix_setgid()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.posix-getgid.php" class="function" rel="rdfs-seeAlso">posix_getgid()</a> - Return the real group ID of the current process</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-setgid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-setgid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-setgid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-setgid.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="104149">  <div class="votes">
    <div id="Vu104149">
    <a href="/manual/vote-note.php?id=104149&amp;page=function.posix-setgid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104149">
    <a href="/manual/vote-note.php?id=104149&amp;page=function.posix-setgid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104149" title="66% like this...">
    1
    </div>
  </div>
  <a href="#104149" class="name">
  <strong class="user"><em>jac</em></strong></a><a class="genanchor" href="#104149"> &para;</a><div class="date" title="2011-05-26 10:26"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104149">
<div class="phpcode"><code><span class="html">if you're going to use this along with posix_setuid, make sure you call posix_setgid first:
<br />
<br /><span class="default">&lt;?php
<br />define </span><span class="keyword">(</span><span class="default">PROC_USER</span><span class="keyword">, </span><span class="string">'john'</span><span class="keyword">);
<br /></span><span class="default">define </span><span class="keyword">(</span><span class="default">PROC_GRP</span><span class="keyword">, </span><span class="string">'admins'</span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>
<br />following works:
<br />
<br /><span class="default">&lt;?php
<br />$user </span><span class="keyword">= </span><span class="default">posix_getpwnam</span><span class="keyword">( </span><span class="default">PROC_USER </span><span class="keyword">);
<br /></span><span class="default">$group </span><span class="keyword">= </span><span class="default">posix_getgrnam</span><span class="keyword">( </span><span class="default">PROC_GRP</span><span class="keyword">);
<br />
<br />echo </span><span class="default">posix_getuid</span><span class="keyword">().</span><span class="string">"\n"</span><span class="keyword">;
<br />echo </span><span class="default">posix_getgid</span><span class="keyword">().</span><span class="string">"\n"</span><span class="keyword">;
<br />
<br /></span><span class="default">posix_setgid</span><span class="keyword">(</span><span class="default">$group</span><span class="keyword">[</span><span class="string">'gid'</span><span class="keyword">]);
<br /></span><span class="default">posix_setuid</span><span class="keyword">(</span><span class="default">$user</span><span class="keyword">[</span><span class="string">'uid'</span><span class="keyword">]);
<br />
<br />echo </span><span class="default">posix_getuid</span><span class="keyword">().</span><span class="string">"\n"</span><span class="keyword">;
<br />echo </span><span class="default">posix_getgid</span><span class="keyword">().</span><span class="string">"\n"</span><span class="keyword">;
<br /></span><span class="default">?&gt;
<br /></span>
<br />following will not set gid
<br />
<br /><span class="default">&lt;?php
<br />$user </span><span class="keyword">= </span><span class="default">posix_getpwnam</span><span class="keyword">( </span><span class="default">PROC_USER </span><span class="keyword">);
<br /></span><span class="default">$group </span><span class="keyword">= </span><span class="default">posix_getgrnam</span><span class="keyword">( </span><span class="default">PROC_GRP</span><span class="keyword">);
...
<div class="foot"><a href="/manual/add-note.php?sect=function.posix-setgid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-setgid.php">＋<small>add a note</small></a></div>
