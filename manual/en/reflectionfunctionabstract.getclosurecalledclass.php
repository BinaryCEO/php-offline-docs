...
<head>
  ...
  <title>PHP: ReflectionFunctionAbstract::getClosureCalledClass - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurecalledclass.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurecalledclass.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurecalledclass.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionfunctionabstract.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionfunctionabstract.getattributes.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurescopeclass.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurecalledclass.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionfunctionabstract.getclosurecalledclass.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionfunctionabstract.getclosurecalledclass.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionfunctionabstract.getclosurecalledclass.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionfunctionabstract.getclosurecalledclass.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionfunctionabstract.getclosurecalledclass.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionfunctionabstract.getclosurecalledclass.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionfunctionabstract.getclosurecalledclass.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionfunctionabstract.getclosurecalledclass.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionfunctionabstract.getclosurecalledclass.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionfunctionabstract.getclosurecalledclass.php" hreflang="zh">
...
<meta name="Description" content="Returns the class corresponding to static:: inside a closure" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionFunctionAbstract::getClosureCalledClass - Manual" />
<meta name="twitter:description" content="Returns the class corresponding to static:: inside a closure" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionFunctionAbstract::getClosureCalledClass - Manual" />
<meta itemprop="description" content="Returns the class corresponding to static:: inside a closure" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the class corresponding to static:: inside a closure" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionfunctionabstract.getclosurescopeclass.php">
          ReflectionFunctionAbstract::getClosureScopeClass &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionfunctionabstract.getattributes.php">
          &laquo; ReflectionFunctionAbstract::getAttributes        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionfunctionabstract.getclosurecalledclass.php' selected="selected">English</option>
            <option value='de/reflectionfunctionabstract.getclosurecalledclass.php'>German</option>
            <option value='es/reflectionfunctionabstract.getclosurecalledclass.php'>Spanish</option>
            <option value='fr/reflectionfunctionabstract.getclosurecalledclass.php'>French</option>
            <option value='it/reflectionfunctionabstract.getclosurecalledclass.php'>Italian</option>
            <option value='ja/reflectionfunctionabstract.getclosurecalledclass.php'>Japanese</option>
            <option value='pt_BR/reflectionfunctionabstract.getclosurecalledclass.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionfunctionabstract.getclosurecalledclass.php'>Russian</option>
            <option value='tr/reflectionfunctionabstract.getclosurecalledclass.php'>Turkish</option>
            <option value='uk/reflectionfunctionabstract.getclosurecalledclass.php'>Ukrainian</option>
            <option value='zh/reflectionfunctionabstract.getclosurecalledclass.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionfunctionabstract.getclosurecalledclass" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionFunctionAbstract::getClosureCalledClass</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.0.23, PHP 8 &gt;= 8.1.11)</p><p class="refpurpose"><span class="refname">ReflectionFunctionAbstract::getClosureCalledClass</span> &mdash; <span class="dc-title">Returns the class corresponding to static:: inside a closure</span></p>
 ...
 <div class="refsect1 description" id="refsect1-reflectionfunctionabstract.getclosurecalledclass-description">
  ...
  <p class="simpara">
   Returns the class as a <span class="classname"><a href="class.reflectionclass.php" class="classname">ReflectionClass</a></span> that
   corresponds to resolving the class name corresponding to <code class="literal">static::</code> inside the
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionfunctionabstract.getclosurecalledclass-returnvalues">
  ...
  <p class="simpara">
   Returns a <span class="classname"><a href="class.reflectionclass.php" class="classname">ReflectionClass</a></span> corresponding to the class
   represented by <code class="literal">static::</code> in the <span class="classname"><a href="class.closure.php" class="classname">Closure</a></span>.
   If the function is not a closure or if it has global scope <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>
   is returned instead.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionfunctionabstract.getclosurecalledclass-examples">
  ...
  <div class="example" id="example-5552">
   <p><strong>Example #1 
    ...
    and <span class="methodname"><a href="reflectionfunctionabstract.getclosurethis.php" class="methodname">ReflectionFunctionAbstract::getClosureThis()</a></span>
...
object(ReflectionClass)#4 (1) {
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionfunctionabstract.getclosurecalledclass-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="reflectionfunctionabstract.getclosurethis.php" class="methodname" rel="rdfs-seeAlso">ReflectionFunctionAbstract::getClosureThis()</a> - Returns the object which corresponds to $this inside a closure</span></li>
   <li><a href="language.oop5.late-static-bindings.php" class="xref">Late Static Bindings</a></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionfunctionabstract/getclosurecalledclass.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionfunctionabstract.getclosurecalledclass%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionfunctionabstract.getclosurecalledclass&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionfunctionabstract.getclosurecalledclass.php">＋<small>add a note</small></a></span>
