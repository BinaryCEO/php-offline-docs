...
<head>
  ...
  <title>PHP: SolrQuery::getStats - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getstats.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getstats.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getstats.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getstart.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getstatsfacets.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getstats.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getstats.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getstats.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getstats.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getstats.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getstats.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getstats.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getstats.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getstats.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getstats.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getstats.php" hreflang="zh">
...
<meta name="Description" content="Returns whether or not stats is enabled" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getStats - Manual" />
<meta name="twitter:description" content="Returns whether or not stats is enabled" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getStats - Manual" />
<meta itemprop="description" content="Returns whether or not stats is enabled" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns whether or not stats is enabled" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getstatsfacets.php">
          SolrQuery::getStatsFacets &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getstart.php">
          &laquo; SolrQuery::getStart        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getstats.php' selected="selected">English</option>
            <option value='de/solrquery.getstats.php'>German</option>
            <option value='es/solrquery.getstats.php'>Spanish</option>
            <option value='fr/solrquery.getstats.php'>French</option>
            <option value='it/solrquery.getstats.php'>Italian</option>
            <option value='ja/solrquery.getstats.php'>Japanese</option>
            <option value='pt_BR/solrquery.getstats.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getstats.php'>Russian</option>
            <option value='tr/solrquery.getstats.php'>Turkish</option>
            <option value='uk/solrquery.getstats.php'>Ukrainian</option>
            <option value='zh/solrquery.getstats.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getstats" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getStats</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getStats</span> &mdash; <span class="dc-title">Returns whether or not stats is enabled</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getstats-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getStats</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getstats-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getstats-returnvalues">
...
Returns a boolean on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getstats.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getstats%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getstats&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getstats.php">＋<small>add a note</small></a></span>
