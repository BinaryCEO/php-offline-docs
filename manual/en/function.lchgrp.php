...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.lchgrp.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.is-writeable.php">
 <link rel="next" href="https://www.php.net/manual/en/function.lchown.php">
...
<meta name="Description" content="Changes group ownership of symlink" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: lchgrp - Manual" />
<meta name="twitter:description" content="Changes group ownership of symlink" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: lchgrp - Manual" />
<meta itemprop="description" content="Changes group ownership of symlink" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Changes group ownership of symlink" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.lchgrp.php' selected="selected">English</option>
            ...
            <option value='ja/function.lchgrp.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.3, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">lchgrp</span> &mdash; <span class="dc-title">Changes group ownership of symlink</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.lchgrp-description">
  ...
  <p class="para rdfs-comment">
   Attempts to change the group of the symlink <code class="parameter">filename</code>
 ...
 <div class="refsect1 examples" id="refsect1-function.lchgrp-examples">
  ...
  <p class="para">
   <div class="example" id="example-2394">
    <p><strong>Example #1 Changing the group of a symbolic link</strong></p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.lchgrp-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.lchown.php" class="function" rel="rdfs-seeAlso">lchown()</a> - Changes user ownership of symlink</span></li>
    ...
    <li><span class="function"><a href="function.chmod.php" class="function" rel="rdfs-seeAlso">chmod()</a> - Changes file mode</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/lchgrp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.lchgrp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.lchgrp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.lchgrp.php">＋<small>add a note</small></a></span>
