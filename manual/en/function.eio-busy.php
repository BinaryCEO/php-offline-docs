...
<head>
  ...
  <title>PHP: eio_busy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-busy.php">
 <link rel="shorturl" href="https://www.php.net/eio-busy">
 <link rel="alternate" href="https://www.php.net/eio-busy" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-cancel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-busy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-busy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-busy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-busy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-busy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-busy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-busy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-busy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-busy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-busy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-busy.php" hreflang="zh">
...
<meta name="Description" content="Artificially increase load. Could be useful in tests,
  benchmarking" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_busy - Manual" />
<meta name="twitter:description" content="Artificially increase load. Could be useful in tests,
  benchmarking" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_busy - Manual" />
<meta itemprop="description" content="Artificially increase load. Could be useful in tests,
  benchmarking" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Artificially increase load. Could be useful in tests,
  benchmarking" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-busy.php' selected="selected">English</option>
            <option value='de/function.eio-busy.php'>German</option>
            <option value='es/function.eio-busy.php'>Spanish</option>
            <option value='fr/function.eio-busy.php'>French</option>
            <option value='it/function.eio-busy.php'>Italian</option>
            <option value='ja/function.eio-busy.php'>Japanese</option>
            <option value='pt_BR/function.eio-busy.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-busy.php'>Russian</option>
            <option value='tr/function.eio-busy.php'>Turkish</option>
            <option value='uk/function.eio-busy.php'>Ukrainian</option>
            <option value='zh/function.eio-busy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-busy" class="refentry">
...
<strong><code><a href="eio.constants.php#constant.eio-pri-default">EIO_PRI_DEFAULT</a></code></strong>.
 ...
 <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_busy()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-nop.php" class="function" rel="rdfs-seeAlso">eio_nop()</a> - Does nothing, except go through the whole request cycle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-busy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-busy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-busy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-busy.php">＋<small>add a note</small></a></span>
