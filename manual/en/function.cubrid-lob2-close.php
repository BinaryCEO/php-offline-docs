...
<head>
  ...
  <title>PHP: cubrid_lob2_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lob2-close.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-lob2-close">
 <link rel="alternate" href="https://www.php.net/cubrid-lob2-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lob2-bind.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lob2-export.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-lob2-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-lob2-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-lob2-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-lob2-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-lob2-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-lob2-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-lob2-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-lob2-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-lob2-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-lob2-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-lob2-close.php" hreflang="zh">
...
<meta name="Description" content="Close LOB object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lob2_close - Manual" />
<meta name="twitter:description" content="Close LOB object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lob2_close - Manual" />
<meta itemprop="description" content="Close LOB object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close LOB object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-lob2-export.php">
          cubrid_lob2_export &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-lob2-bind.php">
          &laquo; cubrid_lob2_bind        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lob2-close.php' selected="selected">English</option>
            <option value='de/function.cubrid-lob2-close.php'>German</option>
            <option value='es/function.cubrid-lob2-close.php'>Spanish</option>
            <option value='fr/function.cubrid-lob2-close.php'>French</option>
            <option value='it/function.cubrid-lob2-close.php'>Italian</option>
            <option value='ja/function.cubrid-lob2-close.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-lob2-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-lob2-close.php'>Russian</option>
            <option value='tr/function.cubrid-lob2-close.php'>Turkish</option>
            <option value='uk/function.cubrid-lob2-close.php'>Ukrainian</option>
            <option value='zh/function.cubrid-lob2-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-lob2-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_lob2_close</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.4.1)</p><p class="refpurpose"><span class="refname">cubrid_lob2_close</span> &mdash; <span class="dc-title">Close LOB object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-lob2-close-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_lob2_close</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$lob_identifier</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   The <span class="function"><strong>cubrid_lob2_close()</strong></span> function is used to close LOB object
   returned from <span class="function"><a href="function.cubrid-lob2-new.php" class="function">cubrid_lob2_new()</a></span> or got from the result set.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.cubrid-lob2-close-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-lob2-close-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.cubrid-lob2-close-seealso">
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-lob2-new.php" class="function" rel="rdfs-seeAlso">cubrid_lob2_new()</a> - Create a lob object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lob2-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lob2-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lob2-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lob2-close.php">＋<small>add a note</small></a></span>
