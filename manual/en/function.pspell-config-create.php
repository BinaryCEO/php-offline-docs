...
<div class="phpcode"><code><span class="html">This might help if you are trying to use multiple custom dictionaries especially if you don't have sudo access to the system aspell dictionary directory ...<br />I created three custom dictionaries (or are they word lists) using "aspell create master" and found a way to use them ...<br />1) Create 3 word lists, one word per line, wordlistA.txt, wordlistB.txt, and wordlistC.txt.<br />2) Create 3 masters ... aspell --lang=en create master ./my_LANG-dictA.rws &lt; wordlistA.txt - repeat for B and C (lang needs to be already installed, I think any lang will work).<br />3) Create 3 multi files, my_LANGA.multi, contents: add my_LANG-dictA.rws) - repeat for B and C. Where my_LANGA can be any name in the same case as explained in the aspell manual.<br />4) Use any one of them (A B or C) with pspell ...<br /><span class="default">&lt;?php<br />$pspell_config </span><span class="keyword">= </span><span class="default">pspell_config_create</span><span class="keyword">(</span><span class="string">'my_LANGC'</span><span class="keyword">, </span><span class="string">''</span><span class="keyword">, </span><span class="string">''</span><span class="keyword">. </span><span class="string">'utf-8'</span><span class="keyword">);<br /></span><span class="default">pspell_config_dict_dir</span><span class="keyword">(</span><span class="default">$pspell_config</span><span class="keyword">, &lt;</span><span class="default">location of my_LANGC</span><span class="keyword">.</span><span class="default">multi</span><span class="keyword">&gt;);<br />if ((</span><span class="default">$pspell </span><span class="keyword">= </span><span class="default">pspell_new_config</span><span class="keyword">(</span><span class="default">$pspell_config</span><span class="keyword">)) == </span><span class="default">false</span><span class="keyword">) {<br />    echo </span><span class="string">'pspell_new_config() for LANGC FAILED!'</span><span class="keyword">);<br />} else {<br />    </span><span class="default">$word </span><span class="keyword">= </span><span class="string">'PHPisgreat'</span><span class="keyword">];<br />    if (</span><span class="default">pspell_check</span><span class="keyword">(</span><span class="default">$pspell</span><span class="keyword">, </span><span class="default">$word</span><span class="keyword">)) {<br />        echo </span><span class="string">"</span><span class="default">$word</span><span class="string">: Valid spelling"</span><span class="keyword">;<br />    } else {<br />        </span><span class="default">$suggestions </span><span class="keyword">= </span><span class="default">pspell_suggest</span><span class="keyword">(</span><span class="default">$pspell</span><span class="keyword">, </span><span class="default">$word</span><span class="keyword">);<br />        echo </span><span class="string">"</span><span class="default">$word</span><span class="string">: suggestions: </span><span class="default">$suggestions</span><span class="string">"<br />    </span><span class="keyword">}<br />}<br /></span><span class="default">?&gt;<br /></span><br />The language arg for pspell_config_create() is the basename of the .multi file.<br />Note that I do not have a file $HOME/.aspell.conf.<br />Note that my .multi and .rws files are in the same directory, which I think is necessary.<br />The wordlist files are not needed once the masters are created.</span></code></div>
  </div>
 </div></div>
