...
<head>
  ...
  <title>PHP: imap_get_quotaroot - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-get-quotaroot.php">
 <link rel="shorturl" href="https://www.php.net/imap-get-quotaroot">
 <link rel="alternate" href="https://www.php.net/imap-get-quotaroot" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-get-quota.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-getacl.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-get-quotaroot.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-get-quotaroot.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-get-quotaroot.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-get-quotaroot.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-get-quotaroot.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-get-quotaroot.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-get-quotaroot.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-get-quotaroot.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-get-quotaroot.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-get-quotaroot.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-get-quotaroot.php" hreflang="zh">
...
<meta name="Description" content="Retrieve the quota settings per user" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_get_quotaroot - Manual" />
<meta name="twitter:description" content="Retrieve the quota settings per user" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_get_quotaroot - Manual" />
<meta itemprop="description" content="Retrieve the quota settings per user" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve the quota settings per user" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-getacl.php">
          imap_getacl &raquo;
              ...
              <div class="prev">
        <a href="function.imap-get-quota.php">
          &laquo; imap_get_quota        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-get-quotaroot.php' selected="selected">English</option>
            <option value='de/function.imap-get-quotaroot.php'>German</option>
            <option value='es/function.imap-get-quotaroot.php'>Spanish</option>
            <option value='fr/function.imap-get-quotaroot.php'>French</option>
            <option value='it/function.imap-get-quotaroot.php'>Italian</option>
            <option value='ja/function.imap-get-quotaroot.php'>Japanese</option>
            <option value='pt_BR/function.imap-get-quotaroot.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-get-quotaroot.php'>Russian</option>
            <option value='tr/function.imap-get-quotaroot.php'>Turkish</option>
            <option value='uk/function.imap-get-quotaroot.php'>Ukrainian</option>
            <option value='zh/function.imap-get-quotaroot.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-get-quotaroot" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.imap-get-quota.php" class="function" rel="rdfs-seeAlso">imap_get_quota()</a> - Retrieve the quota level settings, and usage statics per mailbox</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-get-quotaroot.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-get-quotaroot%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-get-quotaroot&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-get-quotaroot.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="35412">  <div class="votes">
    <div id="Vu35412">
    <a href="/manual/vote-note.php?id=35412&amp;page=function.imap-get-quotaroot&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd35412">
    <a href="/manual/vote-note.php?id=35412&amp;page=function.imap-get-quotaroot&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V35412" title="87% like this...">
    6
    </div>
  </div>
  <a href="#35412" class="name">
  <strong class="user"><em>thomas dot hebinck at digionline dot de</em></strong></a><a class="genanchor" href="#35412"> &para;</a><div class="date" title="2003-08-30 07:55"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom35412">
<div class="phpcode"><code><span class="html">['STORAGE']['usage'] and ['STORAGE']['limit'] are values in KB (1024 Bytes)</span></code></div>
  </div>
 </div>
  <div class="note" id="57028">  <div class="votes">
    <div id="Vu57028">
    <a href="/manual/vote-note.php?id=57028&amp;page=function.imap-get-quotaroot&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd57028">
    <a href="/manual/vote-note.php?id=57028&amp;page=function.imap-get-quotaroot&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V57028" title="75% like this...">
    2
    </div>
  </div>
  <a href="#57028" class="name">
  <strong class="user"><em>uphonesimon at gmail dot com</em></strong></a><a class="genanchor" href="#57028"> &para;</a><div class="date" title="2005-09-21 04:37"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom57028">
<div class="phpcode"><code><span class="html">just to make a note for all the people that are wondering the differences between $quota['STORAGE'] and $quot['MESSAGE']<br />the $quot['STORAGE'] is the size of the mailbox in KB<br />but $quota['MESSAGE'] is actually the number of messages stored in the mailbox and the up limit of the total messages allowed</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-get-quotaroot&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-get-quotaroot.php">＋<small>add a note</small></a></div>
