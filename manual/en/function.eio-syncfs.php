...
<head>
  ...
  <title>PHP: eio_syncfs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-syncfs.php">
 <link rel="shorturl" href="https://www.php.net/eio-syncfs">
 <link rel="alternate" href="https://www.php.net/eio-syncfs" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-sync-file-range.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-truncate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-syncfs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-syncfs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-syncfs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-syncfs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-syncfs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-syncfs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-syncfs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-syncfs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-syncfs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-syncfs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-syncfs.php" hreflang="zh">
...
<meta name="Description" content="Calls Linux' syncfs syscall, if available" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_syncfs - Manual" />
<meta name="twitter:description" content="Calls Linux' syncfs syscall, if available" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_syncfs - Manual" />
<meta itemprop="description" content="Calls Linux' syncfs syscall, if available" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calls Linux' syncfs syscall, if available" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.eio-truncate.php">
          eio_truncate &raquo;
              ...
              <div class="prev">
        <a href="function.eio-sync-file-range.php">
          &laquo; eio_sync_file_range        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-syncfs.php' selected="selected">English</option>
            <option value='de/function.eio-syncfs.php'>German</option>
            <option value='es/function.eio-syncfs.php'>Spanish</option>
            <option value='fr/function.eio-syncfs.php'>French</option>
            <option value='it/function.eio-syncfs.php'>Italian</option>
            <option value='ja/function.eio-syncfs.php'>Japanese</option>
            <option value='pt_BR/function.eio-syncfs.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-syncfs.php'>Russian</option>
            <option value='tr/function.eio-syncfs.php'>Turkish</option>
            <option value='uk/function.eio-syncfs.php'>Ukrainian</option>
            <option value='zh/function.eio-syncfs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-syncfs" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_syncfs</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_syncfs</span> &mdash; <span class="dc-title">Calls Linux&#039; syncfs syscall, if available</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-syncfs-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_syncfs</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-syncfs-parameters">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-syncfs-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_syncfs()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-syncfs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-syncfs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-syncfs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-syncfs.php">＋<small>add a note</small></a></span>
