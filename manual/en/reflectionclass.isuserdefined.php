...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.isuserdefined.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.isuserdefined.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isuserdefined.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.isuninitializedlazyobject.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.marklazyobjectasinitialized.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.isuserdefined.php' selected="selected">English</option>
            ...
            <option value='ja/reflectionclass.isuserdefined.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::isUserDefined</span> &mdash; <span class="dc-title">Checks if user defined</span></p>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.isinternal.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::isInternal()</a> - Checks if class is defined internally by an extension, or the core</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/isuserdefined.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.isuserdefined%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.isuserdefined&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isuserdefined.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">$internalclass = new ReflectionClass('ReflectionClass');<br /><br />class Apple {}<br />$userclass = new ReflectionClass('Apple');<br /><br />var_dump($internalclass-&gt;isUserDefined());<br />var_dump($userclass-&gt;isUserDefined());</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.isuserdefined&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isuserdefined.php">＋<small>add a note</small></a></div>
