...
<head>
  ...
  <title>PHP: SolrQuery::getGroupCachePercent - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getgroupcachepercent.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getgroupcachepercent.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupcachepercent.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getgroup.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getgroupfacet.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupcachepercent.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getgroupcachepercent.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getgroupcachepercent.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getgroupcachepercent.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getgroupcachepercent.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getgroupcachepercent.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getgroupcachepercent.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getgroupcachepercent.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getgroupcachepercent.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getgroupcachepercent.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getgroupcachepercent.php" hreflang="zh">
...
<meta name="Description" content="Returns group cache percent value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getGroupCachePercent - Manual" />
<meta name="twitter:description" content="Returns group cache percent value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getGroupCachePercent - Manual" />
<meta itemprop="description" content="Returns group cache percent value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns group cache percent value" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getgroupfacet.php">
          SolrQuery::getGroupFacet &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getgroup.php">
          &laquo; SolrQuery::getGroup        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getgroupcachepercent.php' selected="selected">English</option>
            <option value='de/solrquery.getgroupcachepercent.php'>German</option>
            <option value='es/solrquery.getgroupcachepercent.php'>Spanish</option>
            <option value='fr/solrquery.getgroupcachepercent.php'>French</option>
            <option value='it/solrquery.getgroupcachepercent.php'>Italian</option>
            <option value='ja/solrquery.getgroupcachepercent.php'>Japanese</option>
            <option value='pt_BR/solrquery.getgroupcachepercent.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getgroupcachepercent.php'>Russian</option>
            <option value='tr/solrquery.getgroupcachepercent.php'>Turkish</option>
            <option value='uk/solrquery.getgroupcachepercent.php'>Ukrainian</option>
            <option value='zh/solrquery.getgroupcachepercent.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getgroupcachepercent" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getGroupCachePercent</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getGroupCachePercent</span> &mdash; <span class="dc-title">Returns group cache percent value</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getgroupcachepercent-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getGroupCachePercent</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getgroupcachepercent-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getgroupcachepercent-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.getgroupcachepercent-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.setgroupcachepercent.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupCachePercent()</a> - Enables caching for result grouping</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getgroupcachepercent.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getgroupcachepercent%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getgroupcachepercent&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getgroupcachepercent.php">＋<small>add a note</small></a></span>
