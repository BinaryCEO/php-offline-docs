...
<head>
  ...
  <title>PHP: eio_event_loop - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-event-loop.php">
 <link rel="shorturl" href="https://www.php.net/eio-event-loop">
 <link rel="alternate" href="https://www.php.net/eio-event-loop" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-dup2.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-fallocate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-event-loop.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-event-loop.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-event-loop.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-event-loop.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-event-loop.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-event-loop.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-event-loop.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-event-loop.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-event-loop.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-event-loop.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-event-loop.php" hreflang="zh">
...
<meta name="Description" content="Polls libeio until all requests proceeded" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_event_loop - Manual" />
<meta name="twitter:description" content="Polls libeio until all requests proceeded" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_event_loop - Manual" />
<meta itemprop="description" content="Polls libeio until all requests proceeded" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Polls libeio until all requests proceeded" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-event-loop.php' selected="selected">English</option>
            <option value='de/function.eio-event-loop.php'>German</option>
            <option value='es/function.eio-event-loop.php'>Spanish</option>
            <option value='fr/function.eio-event-loop.php'>French</option>
            <option value='it/function.eio-event-loop.php'>Italian</option>
            <option value='ja/function.eio-event-loop.php'>Japanese</option>
            <option value='pt_BR/function.eio-event-loop.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-event-loop.php'>Russian</option>
            <option value='tr/function.eio-event-loop.php'>Turkish</option>
            <option value='uk/function.eio-event-loop.php'>Ukrainian</option>
            <option value='zh/function.eio-event-loop.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-event-loop" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-event-loop-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_event_loop</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-event-loop-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>eio_event_loop()</strong></span> returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <p><strong>Example #1 <span class="function"><strong>eio_event_loop()</strong></span> example</strong></p>
...
<div class="example-contents screen">
 <div class="examplescode"><pre class="examplescode">eio_chmod_ok</pre>
</div>
 </div>
 </div>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-poll.php" class="function" rel="rdfs-seeAlso">eio_poll()</a> - Can be to be called whenever there are pending requests that need finishing</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-event-loop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-event-loop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-event-loop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-event-loop.php">＋<small>add a note</small></a></span>
