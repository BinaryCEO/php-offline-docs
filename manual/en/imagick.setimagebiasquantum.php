...
<head>
  ...
  <title>PHP: Imagick::setImageBiasQuantum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagebiasquantum.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagebiasquantum.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagebiasquantum.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagebias.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageblueprimary.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagebiasquantum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagebiasquantum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagebiasquantum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagebiasquantum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagebiasquantum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagebiasquantum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagebiasquantum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagebiasquantum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagebiasquantum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagebiasquantum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagebiasquantum.php" hreflang="zh">
...
<meta name="Description" content="Sets the image bias" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageBiasQuantum - Manual" />
<meta name="twitter:description" content="Sets the image bias" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageBiasQuantum - Manual" />
<meta itemprop="description" content="Sets the image bias" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image bias" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimageblueprimary.php">
          Imagick::setImageBluePrimary &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagebias.php">
          &laquo; Imagick::setImageBias        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagebiasquantum.php' selected="selected">English</option>
            <option value='de/imagick.setimagebiasquantum.php'>German</option>
            <option value='es/imagick.setimagebiasquantum.php'>Spanish</option>
            <option value='fr/imagick.setimagebiasquantum.php'>French</option>
            <option value='it/imagick.setimagebiasquantum.php'>Italian</option>
            <option value='ja/imagick.setimagebiasquantum.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagebiasquantum.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagebiasquantum.php'>Russian</option>
            <option value='tr/imagick.setimagebiasquantum.php'>Turkish</option>
            <option value='uk/imagick.setimagebiasquantum.php'>Ukrainian</option>
            <option value='zh/imagick.setimagebiasquantum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagebiasquantum" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageBiasQuantum</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::setImageBiasQuantum</span> &mdash; <span class="dc-title">Sets the image bias</span></p>

 </div>

 <div id="imagick.setimagebiasquantum-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.setimagebiasquantum-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageBiasQuantum</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$bias</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>

  <p class="para rdfs-comment">
   Sets the image bias. Bias should be scaled with <code class="literal">0</code> (no adjustment) to <code class="literal">1</code> (quantum value).
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.setimagebiasquantum-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagebiasquantum-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagebiasquantum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagebiasquantum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagebiasquantum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagebiasquantum.php">＋<small>add a note</small></a></span>
