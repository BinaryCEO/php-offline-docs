...
<head>
  ...
  <title>PHP: ssh2_publickey_remove - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ssh2-publickey-remove.php">
 <link rel="shorturl" href="https://www.php.net/ssh2-publickey-remove">
 <link rel="alternate" href="https://www.php.net/ssh2-publickey-remove" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ssh2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ssh2-publickey-list.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ssh2-scp-recv.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ssh2-publickey-remove.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ssh2-publickey-remove.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ssh2-publickey-remove.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ssh2-publickey-remove.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ssh2-publickey-remove.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ssh2-publickey-remove.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ssh2-publickey-remove.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ssh2-publickey-remove.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ssh2-publickey-remove.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ssh2-publickey-remove.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ssh2-publickey-remove.php" hreflang="zh">
...
<meta name="Description" content="Remove an authorized publickey" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ssh2_publickey_remove - Manual" />
<meta name="twitter:description" content="Remove an authorized publickey" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ssh2_publickey_remove - Manual" />
<meta itemprop="description" content="Remove an authorized publickey" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Remove an authorized publickey" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ssh2-scp-recv.php">
          ssh2_scp_recv &raquo;
              ...
              <div class="prev">
        <a href="function.ssh2-publickey-list.php">
          &laquo; ssh2_publickey_list        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ssh2-publickey-remove.php' selected="selected">English</option>
            <option value='de/function.ssh2-publickey-remove.php'>German</option>
            <option value='es/function.ssh2-publickey-remove.php'>Spanish</option>
            <option value='fr/function.ssh2-publickey-remove.php'>French</option>
            <option value='it/function.ssh2-publickey-remove.php'>Italian</option>
            <option value='ja/function.ssh2-publickey-remove.php'>Japanese</option>
            <option value='pt_BR/function.ssh2-publickey-remove.php'>Brazilian Portuguese</option>
            <option value='ru/function.ssh2-publickey-remove.php'>Russian</option>
            <option value='tr/function.ssh2-publickey-remove.php'>Turkish</option>
            <option value='uk/function.ssh2-publickey-remove.php'>Ukrainian</option>
            <option value='zh/function.ssh2-publickey-remove.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ssh2-publickey-remove" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ssh2-publickey-remove-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ssh2_publickey_remove</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$pkey</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$algoname</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$blob</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ssh2-publickey-list.php" class="function" rel="rdfs-seeAlso">ssh2_publickey_list()</a> - List currently authorized publickeys</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ssh2/functions/ssh2-publickey-remove.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ssh2-publickey-remove%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ssh2-publickey-remove&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ssh2-publickey-remove.php">＋<small>add a note</small></a></span>
