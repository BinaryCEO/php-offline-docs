...
<head>
  ...
  <title>PHP: ReflectionFunction - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.reflectionfunction.php">
 <link rel="shorturl" href="https://www.php.net/reflectionfunction">
 <link rel="alternate" href="https://www.php.net/reflectionfunction" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.reflection.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionextension.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionfunction.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.reflectionfunction.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.reflectionfunction.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.reflectionfunction.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.reflectionfunction.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.reflectionfunction.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.reflectionfunction.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.reflectionfunction.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.reflectionfunction.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.reflectionfunction.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.reflectionfunction.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.reflectionfunction.php" hreflang="zh">
...
<meta name="Description" content="The ReflectionFunction class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionFunction - Manual" />
<meta name="twitter:description" content="The ReflectionFunction class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionFunction - Manual" />
<meta itemprop="description" content="The ReflectionFunction class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ReflectionFunction class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionfunction.construct.php">
          ReflectionFunction::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionextension.tostring.php">
          &laquo; ReflectionExtension::__toString        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.reflectionfunction.php' selected="selected">English</option>
            <option value='de/class.reflectionfunction.php'>German</option>
            <option value='es/class.reflectionfunction.php'>Spanish</option>
            <option value='fr/class.reflectionfunction.php'>French</option>
            <option value='it/class.reflectionfunction.php'>Italian</option>
            <option value='ja/class.reflectionfunction.php'>Japanese</option>
            <option value='pt_BR/class.reflectionfunction.php'>Brazilian Portuguese</option>
            <option value='ru/class.reflectionfunction.php'>Russian</option>
            <option value='tr/class.reflectionfunction.php'>Turkish</option>
            <option value='uk/class.reflectionfunction.php'>Ukrainian</option>
            <option value='zh/class.reflectionfunction.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.reflectionfunction" class="reference">

 <h1 class="title">The ReflectionFunction class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>


  <div class="section" id="reflectionfunction.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    The <span class="classname"><strong class="classname">ReflectionFunction</strong></span> class reports
    information about a function.
   </p>
  </div>


  <div class="section" id="reflectionfunction.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">ReflectionFunction</strong></strong>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.reflectionfunction.php#reflectionfunction.constants.is-deprecated"><var class="varname">IS_DEPRECATED</var></a></var>;</div>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="reflectionfunction.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.closure.php" class="type Closure">Closure</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$function</code></span>)</div>

    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><a href="reflectionfunction.export.php" class="methodname">export</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$return</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="reflectionfunction.getclosure.php" class="methodname">getClosure</a></span>(): <span class="type"><a href="class.closure.php" class="type Closure">Closure</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="reflectionfunction.invoke.php" class="methodname">invoke</a></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">...$args</code></span>): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="reflectionfunction.invokeargs.php" class="methodname">invokeArgs</a></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$args</code></span>): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="reflectionfunction.isanonymous.php" class="methodname">isAnonymous</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="attribute"><a href="class.deprecated.php">#[\Deprecated]</a> </span><br>
   <span class="modifier">public</span> <span class="methodname"><a href="reflectionfunction.isdisabled.php" class="methodname">isDisabled</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="reflectionfunction.tostring.php" class="methodname">__toString</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
<div class="methodsynopsis dc-description"><span class="modifier">abstract</span> <span class="modifier">public</span> <span class="methodname"><a href="reflectionfunctionabstract.tostring.php" class="methodname">ReflectionFunctionAbstract::__toString</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="reflectionfunction.constants">
   <h2 class="title">Predefined Constants</h2>
   <div class="section" id="reflectionfunction.constants.modifiers">
    <h2 class="title">ReflectionFunction Modifiers</h2>
    <dl>

     
      <dt id="reflectionfunction.constants.is-deprecated">
       <strong><code><a href="class.reflectionfunction.php#reflectionfunction.constants.is-deprecated">ReflectionFunction::IS_DEPRECATED</a></code></strong>
       <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      </dt>
      <dd>
       <p class="para">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <tr>
       <td>8.0.0</td>
       <td>
        <span class="methodname"><a href="reflectionfunction.export.php" class="methodname">ReflectionFunction::export()</a></span> was removed.
       </td>
      </tr>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="reflectionfunction.construct.php">ReflectionFunction::__construct</a> — Constructs a ReflectionFunction object</li><li><a href="reflectionfunction.export.php">ReflectionFunction::export</a> — Exports function</li><li><a href="reflectionfunction.getclosure.php">ReflectionFunction::getClosure</a> — Returns a dynamically created closure for the function</li><li><a href="reflectionfunction.invoke.php">ReflectionFunction::invoke</a> — Invokes function</li><li><a href="reflectionfunction.invokeargs.php">ReflectionFunction::invokeArgs</a> — Invokes function args</li><li><a href="reflectionfunction.isanonymous.php">ReflectionFunction::isAnonymous</a> — Checks if a function is anonymous</li><li><a href="reflectionfunction.isdisabled.php">ReflectionFunction::isDisabled</a> — Checks if function is disabled</li><li><a href="reflectionfunction.tostring.php">ReflectionFunction::__toString</a> — Returns the string representation of the ReflectionFunction object</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionfunction.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.reflectionfunction%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.reflectionfunction&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionfunction.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125552">  <div class="votes">
    <div id="Vu125552">
    <a href="/manual/vote-note.php?id=125552&amp;page=class.reflectionfunction&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125552">
    <a href="/manual/vote-note.php?id=125552&amp;page=class.reflectionfunction&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125552" title="90% like this...">
    8
    </div>
  </div>
  <a href="#125552" class="name">
  <strong class="user"><em>a dot lucassilvadeoliveira at gmail dot com</em></strong></a><a class="genanchor" href="#125552"> &para;</a><div class="date" title="2020-11-28 06:15"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125552">
<div class="phpcode"><code><span class="html">We can use this functionality to automatically pass arguments to our function based on some data structure.<br /><br />NOTE: I am using a php 8.0&gt; feature called "Nameds parameter"<br /><br /><span class="default">&lt;?php<br /><br />$valuesToProcess </span><span class="keyword">= [<br />  </span><span class="string">'name' </span><span class="keyword">=&gt; </span><span class="string">'Anderson Lucas Silva de Oliveira'</span><span class="keyword">,<br />  </span><span class="string">'age' </span><span class="keyword">=&gt; </span><span class="default">21</span><span class="keyword">,<br />  </span><span class="string">'hobbie' </span><span class="keyword">=&gt; </span><span class="string">'Play games'<br /></span><span class="keyword">];<br /><br />function </span><span class="default">processUserData</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">, </span><span class="default">$age</span><span class="keyword">, </span><span class="default">$job </span><span class="keyword">= </span><span class="string">""</span><span class="keyword">, </span><span class="default">$hobbie </span><span class="keyword">= </span><span class="string">""</span><span class="keyword">)<br />{<br />    </span><span class="default">$msg </span><span class="keyword">= </span><span class="string">"Hello </span><span class="default">$name</span><span class="string">. You have </span><span class="default">$age</span><span class="string"> years old"</span><span class="keyword">;<br />    if (!empty(</span><span class="default">$job</span><span class="keyword">)) {<br />    </span><span class="default">$msg </span><span class="keyword">.= </span><span class="string">". Your job is </span><span class="default">$job</span><span class="string">"</span><span class="keyword">;<br />    }<br /><br />    if (!empty(</span><span class="default">$hobbie</span><span class="keyword">)) {<br />        </span><span class="default">$msg </span><span class="keyword">.= </span><span class="string">". Your hobbie is </span><span class="default">$hobbie</span><span class="string">"</span><span class="keyword">;<br />    }<br /><br />    echo </span><span class="default">$msg </span><span class="keyword">. </span><span class="string">"."</span><span class="keyword">;<br />}<br /><br /></span><span class="default">$refFunction </span><span class="keyword">= new </span><span class="default">ReflectionFunction</span><span class="keyword">(</span><span class="string">'processUserData'</span><span class="keyword">);<br /></span><span class="default">$parameters </span><span class="keyword">= </span><span class="default">$refFunction</span><span class="keyword">-&gt;</span><span class="default">getParameters</span><span class="keyword">();<br /><br /></span><span class="default">$validParameters </span><span class="keyword">= [];<br />foreach (</span><span class="default">$parameters </span><span class="keyword">as </span><span class="default">$parameter</span><span class="keyword">) {<br />    if (!</span><span class="default">array_key_exists</span><span class="keyword">(</span><span class="default">$parameter</span><span class="keyword">-&gt;</span><span class="default">getName</span><span class="keyword">(), </span><span class="default">$valuesToProcess</span><span class="keyword">) &amp;&amp; !</span><span class="default">$parameter</span><span class="keyword">-&gt;</span><span class="default">isOptional</span><span class="keyword">()) {<br />        throw new </span><span class="default">DomainException</span><span class="keyword">(</span><span class="string">'Cannot resolve the parameter' </span><span class="keyword">. </span><span class="default">$parameter</span><span class="keyword">-&gt;</span><span class="default">getName</span><span class="keyword">());<br />    }<br /><br />    if(!</span><span class="default">array_key_exists</span><span class="keyword">(</span><span class="default">$parameter</span><span class="keyword">-&gt;</span><span class="default">getName</span><span class="keyword">(), </span><span class="default">$valuesToProcess</span><span class="keyword">)) {<br />        continue;<br />    }<br /><br />    </span><span class="default">$validParameters</span><span class="keyword">[</span><span class="default">$parameter</span><span class="keyword">-&gt;</span><span class="default">getName</span><span class="keyword">()] = </span><span class="default">$valuesToProcess</span><span class="keyword">[</span><span class="default">$parameter</span><span class="keyword">-&gt;</span><span class="default">getName</span><span class="keyword">()];<br />}<br /><br /></span><span class="default">$refFunction</span><span class="keyword">-&gt;</span><span class="default">invoke</span><span class="keyword">(...</span><span class="default">$validParameters</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Results in:<br /><br />Hello Anderson Lucas Silva de Oliveira. You have 21 years old. Your hobbie is Play games.</span></code></div>
  ...
  <div class="note" id="105367">  <div class="votes">
    <div id="Vu105367">
    <a href="/manual/vote-note.php?id=105367&amp;page=class.reflectionfunction&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105367">
    <a href="/manual/vote-note.php?id=105367&amp;page=class.reflectionfunction&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105367" title="44% like this...">
    -3
    </div>
  </div>
  <a href="#105367" class="name">
  <strong class="user"><em>Lorenz R.S.</em></strong></a><a class="genanchor" href="#105367"> &para;</a><div class="date" title="2011-08-12 01:24"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105367">
<div class="phpcode"><code><span class="html">Here is a concise example of ReflectionFunction usage for Parameter Reflection / introspection (e.g. to automatically generate API descriptions)<br /><br /><span class="default">&lt;?php<br />$properties </span><span class="keyword">= </span><span class="default">$reflector</span><span class="keyword">-&gt;</span><span class="default">getProperties</span><span class="keyword">();<br /></span><span class="default">$refFunc </span><span class="keyword">= new </span><span class="default">ReflectionFunction</span><span class="keyword">(</span><span class="string">'preg_replace'</span><span class="keyword">);<br />foreach( </span><span class="default">$refFunc</span><span class="keyword">-&gt;</span><span class="default">getParameters</span><span class="keyword">() as </span><span class="default">$param </span><span class="keyword">){<br />    </span><span class="comment">//invokes ■ReflectionParameter::__toString<br />    </span><span class="keyword">print </span><span class="default">$param</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />prints:<br /><br />Parameter #0 [ &lt;required&gt; $regex ]<br />Parameter #1 [ &lt;required&gt; $replace ]<br />Parameter #2 [ &lt;required&gt; $subject ]<br />Parameter #3 [ &lt;optional&gt; $limit ]<br />Parameter #4 [ &lt;optional&gt; &amp;$count ]</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.reflectionfunction&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionfunction.php">＋<small>add a note</small></a></div>
