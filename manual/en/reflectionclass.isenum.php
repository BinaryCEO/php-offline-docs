...
<head>
  ...
  <title>PHP: ReflectionClass::isEnum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.isenum.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.isenum.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isenum.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.iscloneable.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.isfinal.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isenum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.isenum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.isenum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.isenum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.isenum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.isenum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.isenum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.isenum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.isenum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.isenum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.isenum.php" hreflang="zh">
...
<meta name="Description" content="Returns whether this is an enum" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::isEnum - Manual" />
<meta name="twitter:description" content="Returns whether this is an enum" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::isEnum - Manual" />
<meta itemprop="description" content="Returns whether this is an enum" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns whether this is an enum" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.isfinal.php">
          ReflectionClass::isFinal &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.iscloneable.php">
          &laquo; ReflectionClass::isCloneable        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.isenum.php' selected="selected">English</option>
            <option value='de/reflectionclass.isenum.php'>German</option>
            <option value='es/reflectionclass.isenum.php'>Spanish</option>
            <option value='fr/reflectionclass.isenum.php'>French</option>
            <option value='it/reflectionclass.isenum.php'>Italian</option>
            <option value='ja/reflectionclass.isenum.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.isenum.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.isenum.php'>Russian</option>
            <option value='tr/reflectionclass.isenum.php'>Turkish</option>
            <option value='uk/reflectionclass.isenum.php'>Ukrainian</option>
            <option value='zh/reflectionclass.isenum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.isenum" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::isEnum</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.1.0)</p><p class="refpurpose"><span class="refname">ReflectionClass::isEnum</span> &mdash; <span class="dc-title">Returns whether this is an enum</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.isenum-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::isEnum</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Checks if a class is an <a href="language.enumerations.php" class="link">enum</a>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-reflectionclass.isenum-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.isenum-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if this is an <a href="language.enumerations.php" class="link">enum</a>, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/isenum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.isenum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.isenum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isenum.php">＋<small>add a note</small></a></span>
