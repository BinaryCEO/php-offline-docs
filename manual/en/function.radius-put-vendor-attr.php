...
<head>
  ...
  <title>PHP: radius_put_vendor_attr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.radius-put-vendor-attr.php">
 <link rel="shorturl" href="https://www.php.net/radius-put-vendor-attr">
 <link rel="alternate" href="https://www.php.net/radius-put-vendor-attr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.radius.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.radius-put-vendor-addr.php">
 <link rel="next" href="https://www.php.net/manual/en/function.radius-put-vendor-int.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.radius-put-vendor-attr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.radius-put-vendor-attr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.radius-put-vendor-attr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.radius-put-vendor-attr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.radius-put-vendor-attr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.radius-put-vendor-attr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.radius-put-vendor-attr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.radius-put-vendor-attr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.radius-put-vendor-attr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.radius-put-vendor-attr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.radius-put-vendor-attr.php" hreflang="zh">
...
<meta name="Description" content="Attaches a vendor specific binary attribute" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: radius_put_vendor_attr - Manual" />
<meta name="twitter:description" content="Attaches a vendor specific binary attribute" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: radius_put_vendor_attr - Manual" />
<meta itemprop="description" content="Attaches a vendor specific binary attribute" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Attaches a vendor specific binary attribute" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.radius-put-vendor-int.php">
          radius_put_vendor_int &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.radius-put-vendor-addr.php">
          &laquo; radius_put_vendor_addr        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.radius-put-vendor-attr.php' selected="selected">English</option>
            <option value='de/function.radius-put-vendor-attr.php'>German</option>
            <option value='es/function.radius-put-vendor-attr.php'>Spanish</option>
            <option value='fr/function.radius-put-vendor-attr.php'>French</option>
            <option value='it/function.radius-put-vendor-attr.php'>Italian</option>
            <option value='ja/function.radius-put-vendor-attr.php'>Japanese</option>
            <option value='pt_BR/function.radius-put-vendor-attr.php'>Brazilian Portuguese</option>
            <option value='ru/function.radius-put-vendor-attr.php'>Russian</option>
            <option value='tr/function.radius-put-vendor-attr.php'>Turkish</option>
            <option value='uk/function.radius-put-vendor-attr.php'>Ukrainian</option>
            <option value='zh/function.radius-put-vendor-attr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.radius-put-vendor-attr" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.radius-put-vendor-attr-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>radius_put_vendor_attr</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$radius_handle</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$vendor</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$options</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$tag</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 examples" id="refsect1-function.radius-put-vendor-attr-examples">
  ...
  <p class="para">
   <div class="example" id="example-783">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.radius-get-vendor-attr.php" class="function" rel="rdfs-seeAlso">radius_get_vendor_attr()</a> - Extracts a vendor specific attribute</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/radius/functions/radius-put-vendor-attr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.radius-put-vendor-attr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.radius-put-vendor-attr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.radius-put-vendor-attr.php">＋<small>add a note</small></a></span>
