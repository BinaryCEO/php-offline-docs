...
<head>
  ...
  <title>PHP: imageistruecolor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imageistruecolor.php">
 <link rel="shorturl" href="https://www.php.net/imageistruecolor">
 <link rel="alternate" href="https://www.php.net/imageistruecolor" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imageinterlace.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagejpeg.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imageistruecolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imageistruecolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imageistruecolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imageistruecolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imageistruecolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imageistruecolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imageistruecolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imageistruecolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imageistruecolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imageistruecolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imageistruecolor.php" hreflang="zh">
...
<meta name="Description" content="Finds whether an image is a truecolor image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imageistruecolor - Manual" />
<meta name="twitter:description" content="Finds whether an image is a truecolor image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imageistruecolor - Manual" />
<meta itemprop="description" content="Finds whether an image is a truecolor image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Finds whether an image is a truecolor image" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imageistruecolor.php' selected="selected">English</option>
            <option value='de/function.imageistruecolor.php'>German</option>
            <option value='es/function.imageistruecolor.php'>Spanish</option>
            <option value='fr/function.imageistruecolor.php'>French</option>
            <option value='it/function.imageistruecolor.php'>Italian</option>
            <option value='ja/function.imageistruecolor.php'>Japanese</option>
            <option value='pt_BR/function.imageistruecolor.php'>Brazilian Portuguese</option>
            <option value='ru/function.imageistruecolor.php'>Russian</option>
            <option value='tr/function.imageistruecolor.php'>Turkish</option>
            <option value='uk/function.imageistruecolor.php'>Ukrainian</option>
            <option value='zh/function.imageistruecolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imageistruecolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imageistruecolor</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.2, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imageistruecolor</span> &mdash; <span class="dc-title">Finds whether an image is a truecolor image</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imageistruecolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imageistruecolor</strong></span>(<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>imageistruecolor()</strong></span> finds whether the image
   <code class="parameter">image</code> is a truecolor image.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imageistruecolor-parameters">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imageistruecolor-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the <code class="parameter">image</code> is truecolor, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>
   otherwise.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.imageistruecolor-changelog">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// $im is an image instance<br /><br />// Check if image is a true color image or not<br /></span><span style="color: #007700">if(!</span><span style="color: #0000BB">imageistruecolor</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">))<br />{<br />    </span><span style="color: #FF8000">// Create a new true color image instance<br />    </span><span style="color: #0000BB">$tc </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatetruecolor</span><span style="color: #007700">(</span><span style="color: #0000BB">imagesx</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">), </span><span style="color: #0000BB">imagesy</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">));<br /><br />    </span><span style="color: #FF8000">// Copy over the pixels<br />    </span><span style="color: #0000BB">imagecopy</span><span style="color: #007700">(</span><span style="color: #0000BB">$tc</span><span style="color: #007700">, </span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">imagesx</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">), </span><span style="color: #0000BB">imagesy</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">));<br /><br />    </span><span style="color: #0000BB">$im </span><span style="color: #007700">= </span><span style="color: #0000BB">$tc</span><span style="color: #007700">;<br />    </span><span style="color: #0000BB">$tc </span><span style="color: #007700">= </span><span style="color: #0000BB">NULL</span><span style="color: #007700">;<br /><br />    </span><span style="color: #FF8000">// OR use imagepalettetotruecolor()<br /></span><span style="color: #007700">}<br /><br /></span><span style="color: #FF8000">// Continue working with image instance<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imageistruecolor-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imagepalettetotruecolor.php" class="function" rel="rdfs-seeAlso">imagepalettetotruecolor()</a> - Converts a palette based image to true color</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imageistruecolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imageistruecolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imageistruecolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imageistruecolor.php">＋<small>add a note</small></a></span>
