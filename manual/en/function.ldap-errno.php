...
<head>
  ...
  <title>PHP: ldap_errno - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-errno.php">
 <link rel="shorturl" href="https://www.php.net/ldap-errno">
 <link rel="alternate" href="https://www.php.net/ldap-errno" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-err2str.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-errno.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-errno.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-errno.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-errno.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-errno.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-errno.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-errno.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-errno.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-errno.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-errno.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-errno.php" hreflang="zh">
...
<meta name="Description" content="Return the LDAP error number of the last LDAP command" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_errno - Manual" />
<meta name="twitter:description" content="Return the LDAP error number of the last LDAP command" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_errno - Manual" />
<meta itemprop="description" content="Return the LDAP error number of the last LDAP command" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the LDAP error number of the last LDAP command" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ldap-error.php">
          ldap_error &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-err2str.php">
          &laquo; ldap_err2str        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-errno.php' selected="selected">English</option>
            <option value='de/function.ldap-errno.php'>German</option>
            <option value='es/function.ldap-errno.php'>Spanish</option>
            <option value='fr/function.ldap-errno.php'>French</option>
            <option value='it/function.ldap-errno.php'>Italian</option>
            <option value='ja/function.ldap-errno.php'>Japanese</option>
            <option value='pt_BR/function.ldap-errno.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-errno.php'>Russian</option>
            <option value='tr/function.ldap-errno.php'>Turkish</option>
            <option value='uk/function.ldap-errno.php'>Ukrainian</option>
            <option value='zh/function.ldap-errno.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-errno" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-errno-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_errno</strong></span>(<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.ldap-err2str.php" class="function">ldap_err2str()</a></span>.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// This example contains an error, which we will catch.<br /></span><span style="color: #0000BB">$ld </span><span style="color: #007700">= </span><span style="color: #0000BB">ldap_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$bind </span><span style="color: #007700">= </span><span style="color: #0000BB">ldap_bind</span><span style="color: #007700">(</span><span style="color: #0000BB">$ld</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">// syntax error in filter expression (errno 87),<br />// must be "objectclass=*" to work.<br /></span><span style="color: #0000BB">$res </span><span style="color: #007700">=  @</span><span style="color: #0000BB">ldap_search</span><span style="color: #007700">(</span><span style="color: #0000BB">$ld</span><span style="color: #007700">, </span><span style="color: #DD0000">"o=Myorg, c=DE"</span><span style="color: #007700">, </span><span style="color: #DD0000">"objectclass"</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$res</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">"LDAP-Errno: " </span><span style="color: #007700">. </span><span style="color: #0000BB">ldap_errno</span><span style="color: #007700">(</span><span style="color: #0000BB">$ld</span><span style="color: #007700">) . </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />    echo </span><span style="color: #DD0000">"LDAP-Error: " </span><span style="color: #007700">. </span><span style="color: #0000BB">ldap_error</span><span style="color: #007700">(</span><span style="color: #0000BB">$ld</span><span style="color: #007700">) . </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />    die(</span><span style="color: #DD0000">"Argh!&lt;br /&gt;\n"</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">$info </span><span style="color: #007700">= </span><span style="color: #0000BB">ldap_get_entries</span><span style="color: #007700">(</span><span style="color: #0000BB">$ld</span><span style="color: #007700">, </span><span style="color: #0000BB">$res</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$info</span><span style="color: #007700">[</span><span style="color: #DD0000">"count"</span><span style="color: #007700">] . </span><span style="color: #DD0000">" matching entries.&lt;br /&gt;\n"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ldap-errno-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-err2str.php" class="function" rel="rdfs-seeAlso">ldap_err2str()</a> - Convert LDAP error number into string error message</span></li>
    <li><span class="function"><a href="function.ldap-error.php" class="function" rel="rdfs-seeAlso">ldap_error()</a> - Return the LDAP error message of the last LDAP command</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-errno.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-errno%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-errno.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="14420">  <div class="votes">
    <div id="Vu14420">
    <a href="/manual/vote-note.php?id=14420&amp;page=function.ldap-errno&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd14420">
    <a href="/manual/vote-note.php?id=14420&amp;page=function.ldap-errno&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V14420" title="57% like this...">
    1
    </div>
  </div>
  <a href="#14420" class="name">
  <strong class="user"><em>ahall at mirapoint dot com</em></strong></a><a class="genanchor" href="#14420"> &para;</a><div class="date" title="2001-07-30 07:16"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom14420">
<div class="phpcode"><code><span class="html">Couple of good error codes to get started.  If you want to detect failure of ldap_add due to the record already existing, ldap_error == 0x44.  This means, you can do something like:
<br />
<br />$r = ldap_add($ds, $dn, $info);
<br />if (!$r) {
<br />    if (ldap_errno($ds) == 0x44) {
...
<br />}
<br />
<br />Similarly, on ldap_delete, you will get a 0x20 value (No Such Object) if you try to delete something that isn't there.</span></code></div>
  </div>
 </div>
  <div class="note" id="20665">  <div class="votes">
    <div id="Vu20665">
    <a href="/manual/vote-note.php?id=20665&amp;page=function.ldap-errno&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd20665">
    <a href="/manual/vote-note.php?id=20665&amp;page=function.ldap-errno&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V20665" title="50% like this...">
    0
    </div>
  </div>
  <a href="#20665" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#20665"> &para;</a><div class="date" title="2002-04-11 04:23"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom20665">
<div class="phpcode"><code><span class="html">Common LDAP error codes
<br />
<br />LDAP_SUCCESS                    0x00
<br />LDAP_OPERATIONS_ERROR           0x01
<br />LDAP_PROTOCOL_ERROR             0x02
<br />LDAP_TIMELIMIT_EXCEEDED         0x03
<br />LDAP_SIZELIMIT_EXCEEDED         0x04
<br />LDAP_COMPARE_FALSE              0x05
<br />LDAP_COMPARE_TRUE               0x06
<br />LDAP_AUTH_METHOD_NOT_SUPPORTED  0x07
<br />LDAP_STRONG_AUTH_REQUIRED       0x08
<br />// Not used in LDAPv3
<br />LDAP_PARTIAL_RESULTS            0x09
<br />
<br />// Next 5 new in LDAPv3
<br />LDAP_REFERRAL           0x0a
<br />LDAP_ADMINLIMIT_EXCEEDED        0x0b
<br />LDAP_UNAVAILABLE_CRITICAL_EXTENSION     0x0c
<br />LDAP_CONFIDENTIALITY_REQUIRED   0x0d
<br />LDAP_SASL_BIND_INPROGRESS       0x0e
<br />
<br />LDAP_NO_SUCH_ATTRIBUTE          0x10
<br />LDAP_UNDEFINED_TYPE             0x11
<br />LDAP_INAPPROPRIATE_MATCHING     0x12
<br />LDAP_CONSTRAINT_VIOLATION       0x13
<br />LDAP_TYPE_OR_VALUE_EXISTS       0x14
<br />LDAP_INVALID_SYNTAX             0x15
<br />
<br />LDAP_NO_SUCH_OBJECT             0x20   /* 32 */
<br />LDAP_ALIAS_PROBLEM              0x21
<br />LDAP_INVALID_DN_SYNTAX          0x22
<br />// Next two not used in LDAPv3
<br />LDAP_IS_LEAF                    0x23
<br />LDAP_ALIAS_DEREF_PROBLEM        0x24
<br />
<br />LDAP_INAPPROPRIATE_AUTH         0x30   /* 48 */
<br />LDAP_INVALID_CREDENTIALS        0x31   /* 49 */
<br />LDAP_INSUFFICIENT_ACCESS        0x32
<br />LDAP_BUSY                       0x33
<br />LDAP_UNAVAILABLE                0x34
<br />LDAP_UNWILLING_TO_PERFORM       0x35
<br />LDAP_LOOP_DETECT                0x36
<br />
<br />LDAP_SORT_CONTROL_MISSING       0x3C    /* 60 */
<br />LDAP_INDEX_RANGE_ERROR          0x3D    /* 61 */
<br />
<br />LDAP_NAMING_VIOLATION           0x40
<br />LDAP_OBJECT_CLASS_VIOLATION     0x41
<br />LDAP_NOT_ALLOWED_ON_NONLEAF     0x42
<br />LDAP_NOT_ALLOWED_ON_RDN         0x43
<br />LDAP_ALREADY_EXISTS             0x44    /* 68 */
<br />LDAP_NO_OBJECT_CLASS_MODS       0x45
<br />LDAP_RESULTS_TOO_LARGE          0x46
<br />// Next two for LDAPv3
<br />LDAP_AFFECTS_MULTIPLE_DSAS      0x47
<br />LDAP_OTHER                      0x50
<br />
<br />// Used by some APIs
<br />LDAP_SERVER_DOWN                0x51
<br />LDAP_LOCAL_ERROR                0x52
<br />LDAP_ENCODING_ERROR             0x53
<br />LDAP_DECODING_ERROR             0x54
<br />LDAP_TIMEOUT                    0x55
<br />LDAP_AUTH_UNKNOWN               0x56
<br />LDAP_FILTER_ERROR               0x57    /* 87 */
<br />LDAP_USER_CANCELLED             0x58
<br />LDAP_PARAM_ERROR                0x59
<br />LDAP_NO_MEMORY                  0x5a
<br />
<br />// Preliminary LDAPv3 codes
<br />LDAP_CONNECT_ERROR              0x5b
<br />LDAP_NOT_SUPPORTED              0x5c
<br />LDAP_CONTROL_NOT_FOUND  0x5d
<br />LDAP_NO_RESULTS_RETURNED        0x5e
<br />LDAP_MORE_RESULTS_TO_RETURN     0x5f
<br />LDAP_CLIENT_LOOP        0x60
<br />LDAP_REFERRAL_LIMIT_EXCEEDED    0x61</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-errno.php">＋<small>add a note</small></a></div>
