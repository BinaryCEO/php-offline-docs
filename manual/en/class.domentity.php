...
<head>
  ...
  <title>PHP: DOMEntity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.domentity.php">
 <link rel="shorturl" href="https://www.php.net/domentity">
 <link rel="alternate" href="https://www.php.net/domentity" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/domelement.toggleattribute.php">
 <link rel="next" href="https://www.php.net/manual/en/class.domentityreference.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.domentity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.domentity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.domentity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.domentity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.domentity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.domentity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.domentity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.domentity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.domentity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.domentity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.domentity.php" hreflang="zh">
...
<meta name="Description" content="The DOMEntity class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMEntity - Manual" />
<meta name="twitter:description" content="The DOMEntity class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMEntity - Manual" />
<meta itemprop="description" content="The DOMEntity class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DOMEntity class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.domentityreference.php">
          DOMEntityReference &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domelement.toggleattribute.php">
          &laquo; DOMElement::toggleAttribute        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.domentity.php' selected="selected">English</option>
            <option value='de/class.domentity.php'>German</option>
            <option value='es/class.domentity.php'>Spanish</option>
            <option value='fr/class.domentity.php'>French</option>
            <option value='it/class.domentity.php'>Italian</option>
            <option value='ja/class.domentity.php'>Japanese</option>
            <option value='pt_BR/class.domentity.php'>Brazilian Portuguese</option>
            <option value='ru/class.domentity.php'>Russian</option>
            <option value='tr/class.domentity.php'>Turkish</option>
            <option value='uk/class.domentity.php'>Ukrainian</option>
            <option value='zh/class.domentity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.domentity" class="reference">
 <h1 class="title">The DOMEntity class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>
 

  <div class="section" id="domentity.intro">
  ...
  <div class="section" id="domentity.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">DOMEntity</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.domentity.php#domentity.props.publicid">$<var class="varname">publicId</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.domentity.php#domentity.props.systemid">$<var class="varname">systemId</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.domentity.php#domentity.props.notationname">$<var class="varname">notationName</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.domentity.php#domentity.props.actualencoding">$<var class="varname">actualEncoding</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.domentity.php#domentity.props.encoding">$<var class="varname">encoding</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.domentity.php#domentity.props.version">$<var class="varname">version</var></a></var>;</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domnode.wakeup.php" class="methodname">DOMNode::__wakeup</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="domentity.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="domentity.props.publicid"><var class="varname">publicId</var></dt>
     <dd>
      <p class="para">
     ...
     <dt id="domentity.props.systemid"><var class="varname">systemId</var></dt>
     <dd>
      <p class="para">
       The system identifier associated with the entity if specified, and
       <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> otherwise. This may be an absolute URI or not.
      </p>
     </dd>
    
    
     <dt id="domentity.props.notationname"><var class="varname">notationName</var></dt>
     <dd>
      <p class="para">
       For unparsed entities, the name of the notation for the entity. For
       parsed entities, this is <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.
      </p>
     </dd>
    
    
     <dt id="domentity.props.actualencoding"><var class="varname">actualEncoding</var></dt>
     <dd>
      <p class="para">
       <em>Deprecated as of PHP 8.4.0</em>.
       This has always been equal to <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.
      </p>
     </dd>
    
    
     <dt id="domentity.props.encoding"><var class="varname">encoding</var></dt>
     <dd>
      <p class="para">
       <em>Deprecated as of PHP 8.4.0</em>.
       This has always been equal to <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.
     ...
     <dt id="domentity.props.version"><var class="varname">version</var></dt>
     <dd>
      <p class="para">
       <em>Deprecated as of PHP 8.4.0</em>.
       This has always been equal to <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.4.0</td>
      <td>
       <var class="varname">actualEncoding</var>,
       <var class="varname">encoding</var>, and
       <var class="varname">version</var> are formally deprecated now because they have
       always been equal to <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.
      </td>
     </tr>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domentity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.domentity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.domentity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.domentity.php">＋<small>add a note</small></a></span>
