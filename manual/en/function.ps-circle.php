...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-circle.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-begin-template.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-clip.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-circle.php' selected="selected">English</option>
            ...
            <option value='ja/function.ps-circle.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_circle</span> &mdash; <span class="dc-title">Draws a circle</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ps-circle-description">
  ...
  <p class="para rdfs-comment">
   Draws a circle with its middle point at (<code class="parameter">x</code>,
   <code class="parameter">y</code>). The circle starts and ends at position
   (<code class="parameter">x</code>+<code class="parameter">radius</code>,
   <code class="parameter">y</code>). If this function is called outside a path it
   ...
   (<code class="parameter">x</code>+<code class="parameter">radius</code>,
   <code class="parameter">y</code>) then there will be a gap in the path.
   </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-arcn.php" class="function" rel="rdfs-seeAlso">ps_arcn()</a> - Draws an arc clockwise</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-circle.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-circle%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-circle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-circle.php">＋<small>add a note</small></a></span>
