...
<head>
  ...
  <title>PHP: imap_mutf7_to_utf8 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-mutf7-to-utf8.php">
 <link rel="shorturl" href="https://www.php.net/imap-mutf7-to-utf8">
 <link rel="alternate" href="https://www.php.net/imap-mutf7-to-utf8" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-msgno.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-num-msg.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-mutf7-to-utf8.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-mutf7-to-utf8.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-mutf7-to-utf8.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-mutf7-to-utf8.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-mutf7-to-utf8.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-mutf7-to-utf8.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-mutf7-to-utf8.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-mutf7-to-utf8.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-mutf7-to-utf8.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-mutf7-to-utf8.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-mutf7-to-utf8.php" hreflang="zh">
...
<meta name="Description" content="Decode a modified UTF-7 string to UTF-8" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_mutf7_to_utf8 - Manual" />
<meta name="twitter:description" content="Decode a modified UTF-7 string to UTF-8" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_mutf7_to_utf8 - Manual" />
<meta itemprop="description" content="Decode a modified UTF-7 string to UTF-8" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decode a modified UTF-7 string to UTF-8" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-mutf7-to-utf8.php' selected="selected">English</option>
            <option value='de/function.imap-mutf7-to-utf8.php'>German</option>
            <option value='es/function.imap-mutf7-to-utf8.php'>Spanish</option>
            <option value='fr/function.imap-mutf7-to-utf8.php'>French</option>
            <option value='it/function.imap-mutf7-to-utf8.php'>Italian</option>
            <option value='ja/function.imap-mutf7-to-utf8.php'>Japanese</option>
            <option value='pt_BR/function.imap-mutf7-to-utf8.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-mutf7-to-utf8.php'>Russian</option>
            <option value='tr/function.imap-mutf7-to-utf8.php'>Turkish</option>
            <option value='uk/function.imap-mutf7-to-utf8.php'>Ukrainian</option>
            <option value='zh/function.imap-mutf7-to-utf8.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-mutf7-to-utf8" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_mutf7_to_utf8</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_mutf7_to_utf8</span> &mdash; <span class="dc-title">Decode a modified UTF-7 string to UTF-8</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.imap-mutf7-to-utf8-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_mutf7_to_utf8</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imap-mutf7-to-utf8-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-mutf7-to-utf8-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <code class="parameter">string</code> converted to UTF-8,
    or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.imap-mutf7-to-utf8-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.imap-utf8-to-mutf7.php" class="function" rel="rdfs-seeAlso">imap_utf8_to_mutf7()</a> - Encode a UTF-8 string to modified UTF-7</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-mutf7-to-utf8.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-mutf7-to-utf8%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-mutf7-to-utf8&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-mutf7-to-utf8.php">＋<small>add a note</small></a></span>
