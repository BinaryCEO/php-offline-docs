...
<head>
  ...
  <title>PHP: Gmagick::labelimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.labelimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.labelimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.labelimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.implodeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.levelimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.labelimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.labelimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.labelimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.labelimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.labelimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.labelimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.labelimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.labelimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.labelimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.labelimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.labelimage.php" hreflang="zh">
...
<meta name="Description" content="Adds a label to an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::labelimage - Manual" />
<meta name="twitter:description" content="Adds a label to an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::labelimage - Manual" />
<meta itemprop="description" content="Adds a label to an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds a label to an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.levelimage.php">
          Gmagick::levelimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.implodeimage.php">
          &laquo; Gmagick::implodeimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.labelimage.php' selected="selected">English</option>
            <option value='de/gmagick.labelimage.php'>German</option>
            <option value='es/gmagick.labelimage.php'>Spanish</option>
            <option value='fr/gmagick.labelimage.php'>French</option>
            <option value='it/gmagick.labelimage.php'>Italian</option>
            <option value='ja/gmagick.labelimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.labelimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.labelimage.php'>Russian</option>
            <option value='tr/gmagick.labelimage.php'>Turkish</option>
            <option value='uk/gmagick.labelimage.php'>Ukrainian</option>
            <option value='zh/gmagick.labelimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.labelimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::labelimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::labelimage</span> &mdash; <span class="dc-title">Adds a label to an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.labelimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::labelimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$label</code></span>): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.labelimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.labelimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.labelimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/labelimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.labelimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.labelimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.labelimage.php">＋<small>add a note</small></a></span>
