...
<head>
  ...
  <title>PHP: sodium_crypto_stream_xchacha20 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-stream-xchacha20">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-stream-xchacha20" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-stream-keygen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20-keygen.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-stream-xchacha20.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-stream-xchacha20.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-stream-xchacha20.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-stream-xchacha20.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-stream-xchacha20.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-stream-xchacha20.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-stream-xchacha20.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-stream-xchacha20.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-stream-xchacha20.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-stream-xchacha20.php" hreflang="zh">
...
<meta name="Description" content="Expands the key and nonce into a keystream of pseudorandom bytes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_stream_xchacha20 - Manual" />
<meta name="twitter:description" content="Expands the key and nonce into a keystream of pseudorandom bytes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_stream_xchacha20 - Manual" />
<meta itemprop="description" content="Expands the key and nonce into a keystream of pseudorandom bytes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Expands the key and nonce into a keystream of pseudorandom bytes" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-stream-xchacha20-keygen.php">
          sodium_crypto_stream_xchacha20_keygen &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-stream-keygen.php">
          &laquo; sodium_crypto_stream_keygen        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-stream-xchacha20.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-stream-xchacha20.php'>German</option>
            <option value='es/function.sodium-crypto-stream-xchacha20.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-stream-xchacha20.php'>French</option>
            <option value='it/function.sodium-crypto-stream-xchacha20.php'>Italian</option>
            <option value='ja/function.sodium-crypto-stream-xchacha20.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-stream-xchacha20.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-stream-xchacha20.php'>Russian</option>
            <option value='tr/function.sodium-crypto-stream-xchacha20.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-stream-xchacha20.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-stream-xchacha20.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-stream-xchacha20" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_stream_xchacha20</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.1.0)</p><p class="refpurpose"><span class="refname">sodium_crypto_stream_xchacha20</span> &mdash; <span class="dc-title">Expands the key and nonce into a keystream of pseudorandom bytes</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-stream-xchacha20-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_stream_xchacha20</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$nonce</code></span>, <span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   Expands the <code class="parameter">key</code> and <code class="parameter">nonce</code> into a keystream of pseudorandom bytes.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-stream-xchacha20-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-stream-xchacha20-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a pseudorandom stream that can be used with <span class="function"><a href="function.sodium-crypto-stream-xchacha20-xor.php" class="function">sodium_crypto_stream_xchacha20_xor()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-stream-xchacha20.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-stream-xchacha20%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-stream-xchacha20&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20.php">＋<small>add a note</small></a></span>
