...
<head>
  ...
  <title>PHP: Gmagick::getimagetype - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagetype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagetype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagetype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagesignature.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimageunits.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagetype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagetype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagetype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagetype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagetype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagetype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagetype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagetype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagetype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagetype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagetype.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimagetype - Manual" />
<meta name="twitter:description" content="Gets the potential image type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagetype - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimageunits.php">
          Gmagick::getimageunits &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagesignature.php">
          &laquo; Gmagick::getimagesignature        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagetype.php' selected="selected">English</option>
            <option value='de/gmagick.getimagetype.php'>German</option>
            <option value='es/gmagick.getimagetype.php'>Spanish</option>
            <option value='fr/gmagick.getimagetype.php'>French</option>
            <option value='it/gmagick.getimagetype.php'>Italian</option>
            <option value='ja/gmagick.getimagetype.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagetype.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagetype.php'>Russian</option>
            <option value='tr/gmagick.getimagetype.php'>Turkish</option>
            <option value='uk/gmagick.getimagetype.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagetype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagetype" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagetype</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagetype</span> &mdash; <span class="dc-title">Gets the potential image type</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagetype-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagetype</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagetype-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagetype-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagetype-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagetype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagetype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagetype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagetype.php">＋<small>add a note</small></a></span>
