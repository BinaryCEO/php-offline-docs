...
<head>
  ...
  <title>PHP: yaz_scan_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.yaz-scan-result.php">
 <link rel="shorturl" href="https://www.php.net/yaz-scan-result">
 <link rel="alternate" href="https://www.php.net/yaz-scan-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.yaz.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.yaz-scan.php">
 <link rel="next" href="https://www.php.net/manual/en/function.yaz-schema.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.yaz-scan-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.yaz-scan-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.yaz-scan-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.yaz-scan-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.yaz-scan-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.yaz-scan-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.yaz-scan-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.yaz-scan-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.yaz-scan-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.yaz-scan-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.yaz-scan-result.php" hreflang="zh">
...
<meta name="Description" content="Returns Scan Response result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: yaz_scan_result - Manual" />
<meta name="twitter:description" content="Returns Scan Response result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: yaz_scan_result - Manual" />
<meta itemprop="description" content="Returns Scan Response result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns Scan Response result" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.yaz-scan-result.php' selected="selected">English</option>
            <option value='de/function.yaz-scan-result.php'>German</option>
            <option value='es/function.yaz-scan-result.php'>Spanish</option>
            <option value='fr/function.yaz-scan-result.php'>French</option>
            <option value='it/function.yaz-scan-result.php'>Italian</option>
            <option value='ja/function.yaz-scan-result.php'>Japanese</option>
            <option value='pt_BR/function.yaz-scan-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.yaz-scan-result.php'>Russian</option>
            <option value='tr/function.yaz-scan-result.php'>Turkish</option>
            <option value='uk/function.yaz-scan-result.php'>Ukrainian</option>
            <option value='zh/function.yaz-scan-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.yaz-scan-result" class="refentry">
  ...
  <p class="para">
   ...
   the result-count.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaz/functions/yaz-scan-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.yaz-scan-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.yaz-scan-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.yaz-scan-result.php">＋<small>add a note</small></a></span>
