...
<head>
  ...
  <title>PHP: ldap_exop_whoami - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-exop-whoami.php">
 <link rel="shorturl" href="https://www.php.net/ldap-exop-whoami">
 <link rel="alternate" href="https://www.php.net/ldap-exop-whoami" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-exop-sync.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-explode-dn.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-exop-whoami.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-exop-whoami.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-exop-whoami.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-exop-whoami.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-exop-whoami.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-exop-whoami.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-exop-whoami.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-exop-whoami.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-exop-whoami.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-exop-whoami.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-exop-whoami.php" hreflang="zh">
...
<meta name="Description" content="WHOAMI extended operation helper" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_exop_whoami - Manual" />
<meta name="twitter:description" content="WHOAMI extended operation helper" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_exop_whoami - Manual" />
<meta itemprop="description" content="WHOAMI extended operation helper" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="WHOAMI extended operation helper" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ldap-explode-dn.php">
          ldap_explode_dn &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-exop-sync.php">
          &laquo; ldap_exop_sync        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-exop-whoami.php' selected="selected">English</option>
            <option value='de/function.ldap-exop-whoami.php'>German</option>
            <option value='es/function.ldap-exop-whoami.php'>Spanish</option>
            <option value='fr/function.ldap-exop-whoami.php'>French</option>
            <option value='it/function.ldap-exop-whoami.php'>Italian</option>
            <option value='ja/function.ldap-exop-whoami.php'>Japanese</option>
            <option value='pt_BR/function.ldap-exop-whoami.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-exop-whoami.php'>Russian</option>
            <option value='tr/function.ldap-exop-whoami.php'>Turkish</option>
            <option value='uk/function.ldap-exop-whoami.php'>Ukrainian</option>
            <option value='zh/function.ldap-exop-whoami.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-exop-whoami" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_exop_whoami</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_exop_whoami</span> &mdash; <span class="dc-title">WHOAMI extended operation helper</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ldap-exop-whoami-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_exop_whoami</strong></span>(<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ldap-exop-whoami-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ldap-exop-whoami-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The data returned by the server, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.ldap-exop-whoami-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ldap-exop-whoami-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-exop.php" class="function" rel="rdfs-seeAlso">ldap_exop()</a> - Performs an extended operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-exop-whoami.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-exop-whoami%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-exop-whoami&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-exop-whoami.php">＋<small>add a note</small></a></span>
