...
<head>
  ...
  <title>PHP: pg_get_notify - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-get-notify.php">
 <link rel="shorturl" href="https://www.php.net/pg-get-notify">
 <link rel="alternate" href="https://www.php.net/pg-get-notify" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-free-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-get-pid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-get-notify.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-get-notify.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-get-notify.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-get-notify.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-get-notify.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-get-notify.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-get-notify.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-get-notify.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-get-notify.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-get-notify.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-get-notify.php" hreflang="zh">
...
<meta name="Description" content="Gets SQL NOTIFY message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_get_notify - Manual" />
<meta name="twitter:description" content="Gets SQL NOTIFY message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_get_notify - Manual" />
<meta itemprop="description" content="Gets SQL NOTIFY message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets SQL NOTIFY message" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-get-notify.php' selected="selected">English</option>
            <option value='de/function.pg-get-notify.php'>German</option>
            <option value='es/function.pg-get-notify.php'>Spanish</option>
            <option value='fr/function.pg-get-notify.php'>French</option>
            <option value='it/function.pg-get-notify.php'>Italian</option>
            <option value='ja/function.pg-get-notify.php'>Japanese</option>
            <option value='pt_BR/function.pg-get-notify.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-get-notify.php'>Russian</option>
            <option value='tr/function.pg-get-notify.php'>Turkish</option>
            <option value='uk/function.pg-get-notify.php'>Ukrainian</option>
            <option value='zh/function.pg-get-notify.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-get-notify" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_get_notify</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_get_notify</span> &mdash; <span class="dc-title">Gets SQL NOTIFY message</span></p>
...
while <strong><code><a href="pgsql.constants.php#constant.pgsql-both">PGSQL_BOTH</a></code></strong> will return both numerical and associative indices.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-get-notify-returnvalues">
  ...
  <p class="para">
   An <span class="type"><a href="language.types.array.php" class="type array">array</a></span> containing the <code class="literal">NOTIFY</code> message name and backend PID.
   If supported by the server, the array also contains the server version and the payload.
   Otherwise if no <code class="literal">NOTIFY</code> is waiting, then <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> is returned.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php <br />$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_pconnect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=publisher"</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$conn</span><span style="color: #007700">) {<br />  echo </span><span style="color: #DD0000">"An error occurred.\n"</span><span style="color: #007700">;<br />  exit;<br />}<br /><br /></span><span style="color: #FF8000">// Listen 'author_updated' message from other processes<br /></span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">'LISTEN author_updated;'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$notify </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_get_notify</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$notify</span><span style="color: #007700">) {<br />  echo </span><span style="color: #DD0000">"No messages\n"</span><span style="color: #007700">;<br />} else {<br />  </span><span style="color: #0000BB">print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">$notify</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-get-notify-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-get-pid.php" class="function" rel="rdfs-seeAlso">pg_get_pid()</a> - Gets the backend's process ID</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-get-notify.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-get-notify%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-get-notify&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-get-notify.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121241">  <div class="votes">
    <div id="Vu121241">
    <a href="/manual/vote-note.php?id=121241&amp;page=function.pg-get-notify&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121241">
    <a href="/manual/vote-note.php?id=121241&amp;page=function.pg-get-notify&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121241" title="64% like this...">
    7
    </div>
  </div>
  <a href="#121241" class="name">
  <strong class="user"><em>glococo at gmail dot com</em></strong></a><a class="genanchor" href="#121241"> &para;</a><div class="date" title="2017-06-17 08:12"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121241">
<div class="phpcode"><code><span class="html">Instant yet Simple PHP notification with HTML5 Server-Sent Events<br /><br />sse.php<br /><span class="default">&lt;?php<br />$dbconn </span><span class="keyword">= new </span><span class="default">PDO</span><span class="keyword">(</span><span class="string">"pgsql:host=localhost;dbname=mydb"</span><span class="keyword">, </span><span class="string">"pduser"</span><span class="keyword">, </span><span class="string">"userpass"</span><span class="keyword">);<br /></span><span class="default">$dbconn</span><span class="keyword">-&gt;</span><span class="default">exec</span><span class="keyword">(</span><span class="string">'LISTEN "channel_name"'</span><span class="keyword">);   </span><span class="comment">// those doublequotes are very important<br /><br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"X-Accel-Buffering: no"</span><span class="keyword">); </span><span class="comment">// disable ngnix webServer buffering<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: text/event-stream"</span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Cache-Control: no-cache"</span><span class="keyword">);<br /></span><span class="default">ob_end_flush</span><span class="keyword">();  </span><span class="comment">// close PHP output buffering<br /></span><span class="default">$inc</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">;<br /><br />while (</span><span class="default">1</span><span class="keyword">) {<br />  </span><span class="default">$result </span><span class="keyword">= </span><span class="string">""</span><span class="keyword">;<br />  </span><span class="comment">// wait for one Notify 10seconds instead of using sleep(10)<br />  </span><span class="default">$result </span><span class="keyword">= </span><span class="default">$dbconn</span><span class="keyword">-&gt;</span><span class="default">pgsqlGetNotify</span><span class="keyword">(</span><span class="default">PDO</span><span class="keyword">::</span><span class="default">FETCH_ASSOC</span><span class="keyword">, </span><span class="default">10000</span><span class="keyword">); <br /><br />  if ( </span><span class="default">$result </span><span class="keyword">) { <br />        echo </span><span class="string">"id: </span><span class="default">$inc</span><span class="string">\ndata: "</span><span class="keyword">.</span><span class="default">stripslashes</span><span class="keyword">(</span><span class="default">json_encode</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">)).</span><span class="string">"\n\n"</span><span class="keyword">;<br />        </span><span class="default">$inc</span><span class="keyword">++;<br />  }<br /><br />  </span><span class="default">flush</span><span class="keyword">();<br />}<br /></span><span class="default">?&gt;<br /></span><br />Tested with HTML+JS sample file from Mozilla web site (ssedemo.php)</span></code></div>
  </div>
 </div>
  <div class="note" id="125453">  <div class="votes">
    <div id="Vu125453">
    <a href="/manual/vote-note.php?id=125453&amp;page=function.pg-get-notify&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125453">
    <a href="/manual/vote-note.php?id=125453&amp;page=function.pg-get-notify&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125453" title="no votes...">
    0
    </div>
  </div>
  <a href="#125453" class="name">
  <strong class="user"><em>david at frankieandshadow dot com</em></strong></a><a class="genanchor" href="#125453"> &para;</a><div class="date" title="2020-10-22 01:52"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125453">
<div class="phpcode"><code><span class="html">It appears that pg_get_notify does not distinguish between no message waiting and a failure when checking - both seem to return FALSE.<br /><br />I had to add a pg_check_connection(...) before pg_get_notify to check the connection is still alive (it's quite likely to be a long-standing connection with pg_get_notify as you'll be polling waiting for something to happen). In my case the remote database server had a hiccup, and without pg_check_connection the listeners failed to notice, so never saw later notifications.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-get-notify&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-get-notify.php">＋<small>add a note</small></a></div>
