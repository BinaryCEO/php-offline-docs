...
<head>
  ...
  <title>PHP: Imagick::getFilename - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getfilename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getfilename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getfilename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getcopyright.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getfont.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getfilename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getfilename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getfilename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getfilename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getfilename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getfilename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getfilename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getfilename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getfilename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getfilename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getfilename.php" hreflang="zh">
...
<meta name="Description" content="The filename associated with an image sequence" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getFilename - Manual" />
<meta name="twitter:description" content="The filename associated with an image sequence" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getFilename - Manual" />
<meta itemprop="description" content="The filename associated with an image sequence" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The filename associated with an image sequence" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getfont.php">
          Imagick::getFont &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getcopyright.php">
          &laquo; Imagick::getCopyright        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getfilename.php' selected="selected">English</option>
            <option value='de/imagick.getfilename.php'>German</option>
            <option value='es/imagick.getfilename.php'>Spanish</option>
            <option value='fr/imagick.getfilename.php'>French</option>
            <option value='it/imagick.getfilename.php'>Italian</option>
            <option value='ja/imagick.getfilename.php'>Japanese</option>
            <option value='pt_BR/imagick.getfilename.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getfilename.php'>Russian</option>
            <option value='tr/imagick.getfilename.php'>Turkish</option>
            <option value='uk/imagick.getfilename.php'>Ukrainian</option>
            <option value='zh/imagick.getfilename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getfilename" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getFilename</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getFilename</span> &mdash; <span class="dc-title">The filename associated with an image sequence</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getfilename-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getFilename</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getfilename-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getfilename-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getfilename-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getfilename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getfilename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getfilename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getfilename.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118329">  <div class="votes">
    <div id="Vu118329">
    <a href="/manual/vote-note.php?id=118329&amp;page=imagick.getfilename&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118329">
    <a href="/manual/vote-note.php?id=118329&amp;page=imagick.getfilename&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118329" title="72% like this...">
    8
    </div>
  </div>
  <a href="#118329" class="name">
  <strong class="user"><em>SkepticaLee</em></strong></a><a class="genanchor" href="#118329"> &para;</a><div class="date" title="2015-11-18 04:10"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118329">
<div class="phpcode"><code><span class="html">This function is obviously deprecated as it only returns a zero-length string. The file name (with complete path) is returned by getImageFilename () instead.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getfilename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getfilename.php">＋<small>add a note</small></a></div>
