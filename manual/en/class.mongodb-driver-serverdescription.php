...
<head>
  ...
  <title>PHP: MongoDB\Driver\ServerDescription - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-serverdescription.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-serverdescription">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-serverdescription" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.mongodb.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-server.issecondary.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-serverdescription.gethelloresponse.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-serverdescription.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-serverdescription.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-serverdescription.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-serverdescription.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-serverdescription.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-serverdescription.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-serverdescription.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-serverdescription.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-serverdescription.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-serverdescription.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-serverdescription.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\ServerDescription class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\ServerDescription - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\ServerDescription class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\ServerDescription - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\ServerDescription class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\ServerDescription class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mongodb-driver-serverdescription.gethelloresponse.php">
          MongoDB\Driver\ServerDescription::getHelloResponse &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-server.issecondary.php">
          &laquo; MongoDB\Driver\Server::isSecondary        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-serverdescription.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-serverdescription.php'>German</option>
            <option value='es/class.mongodb-driver-serverdescription.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-serverdescription.php'>French</option>
            <option value='it/class.mongodb-driver-serverdescription.php'>Italian</option>
            <option value='ja/class.mongodb-driver-serverdescription.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-serverdescription.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-serverdescription.php'>Russian</option>
            <option value='tr/class.mongodb-driver-serverdescription.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-serverdescription.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-serverdescription.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-serverdescription" class="reference">

 <h1 class="title">The MongoDB\Driver\ServerDescription class</h1>
 ...
 <div class="partintro"><p class="verinfo">(mongodb &gt;=1.13.0)</p>
  ...
  <div class="section" id="mongodb-driver-serverdescription.intro">
   ...
   <p class="para">
    The <span class="classname"><strong class="classname">MongoDB\Driver\ServerDescription</strong></span> class is a value
    object that represents a server to which the driver is connected. Instances
    of this class are returned by
    <span class="function"><a href="mongodb-driver-server.getserverdescription.php" class="function">MongoDB\Driver\Server::getServerDescription()</a></span> and
    <span class="classname"><a href="class.mongodb-driver-monitoring-serverchangedevent.php" class="classname">MongoDB\Driver\Monitoring\ServerChangedEvent</a></span> methods.
   </p>
  </div>
...
<div class="methodsynopsis dc-description"><span class="modifier">final</span> <span class="modifier">public</span> <span class="methodname"><a href="mongodb-driver-serverdescription.gettype.php" class="methodname">getType</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
  ...
  <div class="section" id="mongodb-driver-serverdescription.constants">
   ...
   <dl>
     ...
     <dd>
      <p class="para">Unknown server type, returned by <span class="methodname"><a href="mongodb-driver-serverdescription.gettype.php" class="methodname">MongoDB\Driver\ServerDescription::getType()</a></span>.</p>
     </dd>
     ...
     <dd>
      <p class="para">Standalone server type, returned by <span class="methodname"><a href="mongodb-driver-serverdescription.gettype.php" class="methodname">MongoDB\Driver\ServerDescription::getType()</a></span>.</p>
     </dd>
     ...
     <dd>
      <p class="para">Mongos server type, returned by <span class="methodname"><a href="mongodb-driver-serverdescription.gettype.php" class="methodname">MongoDB\Driver\ServerDescription::getType()</a></span>.</p>
     </dd>
     ...
     <dd>
      <p class="para">Replica set possible primary server type, returned by <span class="methodname"><a href="mongodb-driver-serverdescription.gettype.php" class="methodname">MongoDB\Driver\ServerDescription::getType()</a></span>.</p>
     ...
     <dd>
      <p class="para">Replica set primary server type, returned by <span class="methodname"><a href="mongodb-driver-serverdescription.gettype.php" class="methodname">MongoDB\Driver\ServerDescription::getType()</a></span>.</p>
     </dd>
     ...
     <dd>
      <p class="para">Replica set secondary server type, returned by <span class="methodname"><a href="mongodb-driver-serverdescription.gettype.php" class="methodname">MongoDB\Driver\ServerDescription::getType()</a></span>.</p>
     </dd>
     ...
     <dd>
      <p class="para">Replica set arbiter server type, returned by <span class="methodname"><a href="mongodb-driver-serverdescription.gettype.php" class="methodname">MongoDB\Driver\ServerDescription::getType()</a></span>.</p>
     </dd>
     ...
     <dd>
      <p class="para">Replica set other server type, returned by <span class="methodname"><a href="mongodb-driver-serverdescription.gettype.php" class="methodname">MongoDB\Driver\ServerDescription::getType()</a></span>.</p>
     ...
     <dd>
      <p class="para">Replica set ghost server type, returned by <span class="methodname"><a href="mongodb-driver-serverdescription.gettype.php" class="methodname">MongoDB\Driver\ServerDescription::getType()</a></span>.</p>
     ...
     <dd>
      <p class="para">Load balancer server type, returned by <span class="methodname"><a href="mongodb-driver-serverdescription.gettype.php" class="methodname">MongoDB\Driver\ServerDescription::getType()</a></span>.</p>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-serverdescription.gethelloresponse.php">MongoDB\Driver\ServerDescription::getHelloResponse</a> — Returns the server's most recent &quot;hello&quot; response</li><li><a href="mongodb-driver-serverdescription.gethost.php">MongoDB\Driver\ServerDescription::getHost</a> — Returns the hostname of this server</li><li><a href="mongodb-driver-serverdescription.getlastupdatetime.php">MongoDB\Driver\ServerDescription::getLastUpdateTime</a> — Returns the server's last update time in microseconds</li><li><a href="mongodb-driver-serverdescription.getport.php">MongoDB\Driver\ServerDescription::getPort</a> — Returns the port on which this server is listening</li><li><a href="mongodb-driver-serverdescription.getroundtriptime.php">MongoDB\Driver\ServerDescription::getRoundTripTime</a> — Returns the server's round trip time in milliseconds</li><li><a href="mongodb-driver-serverdescription.gettype.php">MongoDB\Driver\ServerDescription::getType</a> — Returns a string denoting the type of this server</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/serverdescription.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-serverdescription%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-serverdescription&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-serverdescription.php">＋<small>add a note</small></a></span>
