...
<head>
  ...
  <title>PHP: Anchors - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/regexp.reference.anchors.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/regexp.reference.anchors.php">
 <link rel="alternate" href="https://www.php.net/manual/en/regexp.reference.anchors.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reference.pcre.pattern.syntax.php">
 <link rel="prev" href="https://www.php.net/manual/en/regexp.reference.unicode.php">
 <link rel="next" href="https://www.php.net/manual/en/regexp.reference.dot.php">

 <link rel="alternate" href="https://www.php.net/manual/en/regexp.reference.anchors.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/regexp.reference.anchors.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/regexp.reference.anchors.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/regexp.reference.anchors.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/regexp.reference.anchors.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/regexp.reference.anchors.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/regexp.reference.anchors.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/regexp.reference.anchors.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/regexp.reference.anchors.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/regexp.reference.anchors.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/regexp.reference.anchors.php" hreflang="zh">
...
<meta name="Description" content="Anchors" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Anchors - Manual" />
<meta name="twitter:description" content="Anchors" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Anchors - Manual" />
<meta itemprop="description" content="Anchors" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Anchors" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="regexp.reference.unicode.php">
          &laquo; Unicode character properties        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/regexp.reference.anchors.php' selected="selected">English</option>
            <option value='de/regexp.reference.anchors.php'>German</option>
            <option value='es/regexp.reference.anchors.php'>Spanish</option>
            <option value='fr/regexp.reference.anchors.php'>French</option>
            <option value='it/regexp.reference.anchors.php'>Italian</option>
            <option value='ja/regexp.reference.anchors.php'>Japanese</option>
            <option value='pt_BR/regexp.reference.anchors.php'>Brazilian Portuguese</option>
            <option value='ru/regexp.reference.anchors.php'>Russian</option>
            <option value='tr/regexp.reference.anchors.php'>Turkish</option>
            <option value='uk/regexp.reference.anchors.php'>Ukrainian</option>
            <option value='zh/regexp.reference.anchors.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="regexp.reference.anchors" class="section">
  ...
  <p class="para">
   ...
   is set or not.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fregexp.reference.anchors%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=regexp.reference.anchors&amp;repo=en&amp;redirect=https://www.php.net/manual/en/regexp.reference.anchors.php">＋<small>add a note</small></a></span>
