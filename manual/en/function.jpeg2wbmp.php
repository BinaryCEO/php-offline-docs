...
<head>
  ...
  <title>PHP: jpeg2wbmp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.jpeg2wbmp.php">
 <link rel="shorturl" href="https://www.php.net/jpeg2wbmp">
 <link rel="alternate" href="https://www.php.net/jpeg2wbmp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.iptcparse.php">
 <link rel="next" href="https://www.php.net/manual/en/function.png2wbmp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.jpeg2wbmp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.jpeg2wbmp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.jpeg2wbmp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.jpeg2wbmp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.jpeg2wbmp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.jpeg2wbmp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.jpeg2wbmp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.jpeg2wbmp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.jpeg2wbmp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.jpeg2wbmp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.jpeg2wbmp.php" hreflang="zh">
...
<meta name="Description" content="Convert JPEG image file to WBMP image file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: jpeg2wbmp - Manual" />
<meta name="twitter:description" content="Convert JPEG image file to WBMP image file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: jpeg2wbmp - Manual" />
<meta itemprop="description" content="Convert JPEG image file to WBMP image file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Convert JPEG image file to WBMP image file" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.jpeg2wbmp.php' selected="selected">English</option>
            <option value='de/function.jpeg2wbmp.php'>German</option>
            <option value='es/function.jpeg2wbmp.php'>Spanish</option>
            <option value='fr/function.jpeg2wbmp.php'>French</option>
            <option value='it/function.jpeg2wbmp.php'>Italian</option>
            <option value='ja/function.jpeg2wbmp.php'>Japanese</option>
            <option value='pt_BR/function.jpeg2wbmp.php'>Brazilian Portuguese</option>
            <option value='ru/function.jpeg2wbmp.php'>Russian</option>
            <option value='tr/function.jpeg2wbmp.php'>Turkish</option>
            <option value='uk/function.jpeg2wbmp.php'>Ukrainian</option>
            <option value='zh/function.jpeg2wbmp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.jpeg2wbmp" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">jpeg2wbmp</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PHP 5, PHP 7)</p><p class="refpurpose"><span class="refname">jpeg2wbmp</span> &mdash; <span class="dc-title">Convert JPEG image file to WBMP image file</span></p>

 </div>

 <div id="function.jpeg2wbmp-refsynopsisdiv">
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 description" id="refsect1-function.jpeg2wbmp-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>jpeg2wbmp</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$jpegname</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$wbmpname</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$dest_height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$dest_width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$threshold</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.jpeg2wbmp-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">jpegname</code></dt>
     <dd>
      <p class="para">
       Path to JPEG file.
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.jpeg2wbmp-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.jpeg2wbmp-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2951">
    <p><strong>Example #1 <span class="function"><strong>jpeg2wbmp()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Path to the target jpeg<br /></span><span style="color: #0000BB">$path </span><span style="color: #007700">= </span><span style="color: #DD0000">'./test.jpg'</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">// Get the image sizes<br /></span><span style="color: #0000BB">$image </span><span style="color: #007700">= </span><span style="color: #0000BB">getimagesize</span><span style="color: #007700">(</span><span style="color: #0000BB">$path</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Convert image<br /></span><span style="color: #0000BB">jpeg2wbmp</span><span style="color: #007700">(</span><span style="color: #0000BB">$path</span><span style="color: #007700">, </span><span style="color: #DD0000">'./test.wbmp'</span><span style="color: #007700">, </span><span style="color: #0000BB">$image</span><span style="color: #007700">[</span><span style="color: #0000BB">1</span><span style="color: #007700">], </span><span style="color: #0000BB">$image</span><span style="color: #007700">[</span><span style="color: #0000BB">0</span><span style="color: #007700">], </span><span style="color: #0000BB">5</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.jpeg2wbmp-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.png2wbmp.php" class="function" rel="rdfs-seeAlso">png2wbmp()</a> - Convert PNG image file to WBMP image file</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/jpeg2wbmp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.jpeg2wbmp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.jpeg2wbmp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.jpeg2wbmp.php">＋<small>add a note</small></a></span>
