...
<head>
  ...
  <title>PHP: sqlsrv_connect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sqlsrv-connect.php">
 <link rel="shorturl" href="https://www.php.net/sqlsrv-connect">
 <link rel="alternate" href="https://www.php.net/sqlsrv-connect" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sqlsrv-configure.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sqlsrv-errors.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sqlsrv-connect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sqlsrv-connect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sqlsrv-connect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sqlsrv-connect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sqlsrv-connect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sqlsrv-connect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sqlsrv-connect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sqlsrv-connect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sqlsrv-connect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sqlsrv-connect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sqlsrv-connect.php" hreflang="zh">
...
<meta name="Description" content="Opens a connection to a Microsoft SQL Server database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sqlsrv_connect - Manual" />
<meta name="twitter:description" content="Opens a connection to a Microsoft SQL Server database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sqlsrv_connect - Manual" />
<meta itemprop="description" content="Opens a connection to a Microsoft SQL Server database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Opens a connection to a Microsoft SQL Server database" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sqlsrv-errors.php">
          sqlsrv_errors &raquo;
              ...
              <div class="prev">
        <a href="function.sqlsrv-configure.php">
          &laquo; sqlsrv_configure        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sqlsrv-connect.php' selected="selected">English</option>
            <option value='de/function.sqlsrv-connect.php'>German</option>
            <option value='es/function.sqlsrv-connect.php'>Spanish</option>
            <option value='fr/function.sqlsrv-connect.php'>French</option>
            <option value='it/function.sqlsrv-connect.php'>Italian</option>
            <option value='ja/function.sqlsrv-connect.php'>Japanese</option>
            <option value='pt_BR/function.sqlsrv-connect.php'>Brazilian Portuguese</option>
            <option value='ru/function.sqlsrv-connect.php'>Russian</option>
            <option value='tr/function.sqlsrv-connect.php'>Turkish</option>
            <option value='uk/function.sqlsrv-connect.php'>Ukrainian</option>
            <option value='zh/function.sqlsrv-connect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sqlsrv-connect" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sqlsrv_connect</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_connect</span> &mdash; <span class="dc-title">Opens a connection to a Microsoft SQL Server database</span></p>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       keys, see <a href="http://msdn.microsoft.com/en-us/library/ff628167.aspx" class="link external">&raquo;&nbsp;SQLSRV Connection Options</a>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-connect-returnvalues">
  ...
  <p class="para">
   A connection resource. If a connection cannot be successfully opened, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> is returned.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\\sqlexpress"</span><span style="color: #007700">; </span><span style="color: #FF8000">//serverName\instanceName<br /></span><span style="color: #0000BB">$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"userName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #0000BB">$serverName</span><span style="color: #007700">, </span><span style="color: #0000BB">$connectionInfo</span><span style="color: #007700">);<br /><br />if( </span><span style="color: #0000BB">$conn </span><span style="color: #007700">) {<br />     echo </span><span style="color: #DD0000">"Connection established.&lt;br /&gt;"</span><span style="color: #007700">;<br />}else{<br />     echo </span><span style="color: #DD0000">"Connection could not be established.&lt;br /&gt;"</span><span style="color: #007700">;<br />     die( </span><span style="color: #0000BB">print_r</span><span style="color: #007700">( </span><span style="color: #0000BB">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #0000BB">true</span><span style="color: #007700">));<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-2155">
    <p><strong>Example #3 Connect on a specified port.</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\\sqlexpress, 1542"</span><span style="color: #007700">; </span><span style="color: #FF8000">//serverName\instanceName, portNumber (default is 1433)<br /></span><span style="color: #0000BB">$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"userName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #0000BB">$serverName</span><span style="color: #007700">, </span><span style="color: #0000BB">$connectionInfo</span><span style="color: #007700">);<br /><br />if( </span><span style="color: #0000BB">$conn </span><span style="color: #007700">) {<br />     echo </span><span style="color: #DD0000">"Connection established.&lt;br /&gt;"</span><span style="color: #007700">;<br />}else{<br />     echo </span><span style="color: #DD0000">"Connection could not be established.&lt;br /&gt;"</span><span style="color: #007700">;<br />     die( </span><span style="color: #0000BB">print_r</span><span style="color: #007700">( </span><span style="color: #0000BB">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #0000BB">true</span><span style="color: #007700">));<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.sqlsrv-connect-notes">
  ...
  <p class="para">
   ...
   $connectionOptions array to 0 (or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>). For more information, see 
   <a href="http://msdn.microsoft.com/en-us/library/cc644930.aspx" class="link external">&raquo;&nbsp;SQLSRV Connection Pooling</a>.
  </p>
  <p class="para">
 ...
 <div class="refsect1 seealso" id="refsect1-function.sqlsrv-connect-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.sqlsrv-close.php" class="function" rel="rdfs-seeAlso">sqlsrv_close()</a> - Closes an open connection and releases resourses associated with the connection</span></li>
    <li><span class="function"><a href="function.sqlsrv-errors.php" class="function" rel="rdfs-seeAlso">sqlsrv_errors()</a> - Returns error and warning information about the last SQLSRV operation performed</span></li>
    <li><span class="function"><a href="function.sqlsrv-query.php" class="function" rel="rdfs-seeAlso">sqlsrv_query()</a> - Prepares and executes a query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlsrv/functions/sqlsrv-connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sqlsrv-connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sqlsrv-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-connect.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119863">  <div class="votes">
    <div id="Vu119863">
    <a href="/manual/vote-note.php?id=119863&amp;page=function.sqlsrv-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119863">
    <a href="/manual/vote-note.php?id=119863&amp;page=function.sqlsrv-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119863" title="51% like this...">
    5
    </div>
  </div>
  <a href="#119863" class="name">
  <strong class="user"><em>alvaro at demogracia dot com</em></strong></a><a class="genanchor" href="#119863"> &para;</a><div class="date" title="2016-09-08 09:00"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119863">
<div class="phpcode"><code><span class="html">You can use the connectionInfo parameter to specify connection encoding, e.g.:<br /><br /><span class="default">&lt;?php<br />$connectionInfo </span><span class="keyword">= [<br />    </span><span class="string">'CharacterSet' </span><span class="keyword">=&gt; </span><span class="string">'UTF-8'</span><span class="keyword">,<br />];<br /></span><span class="default">$conn </span><span class="keyword">= </span><span class="default">sqlsrv_connect</span><span class="keyword">(</span><span class="default">$serverName</span><span class="keyword">, </span><span class="default">$connectionInfo</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Beware though that only two options exist:<br />- SQLSRV_ENC_CHAR (constant) for ANSI, which is the default<br />- 'UTF-8' (string) for Unicode</span></code></div>
  </div>
 </div>
  <div class="note" id="118117">  <div class="votes">
    <div id="Vu118117">
    <a href="/manual/vote-note.php?id=118117&amp;page=function.sqlsrv-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118117">
    <a href="/manual/vote-note.php?id=118117&amp;page=function.sqlsrv-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118117" title="52% like this...">
    4
    </div>
  </div>
  <a href="#118117" class="name">
  <strong class="user"><em>Eion Robb</em></strong></a><a class="genanchor" href="#118117"> &para;</a><div class="date" title="2015-10-07 03:16"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118117">
<div class="phpcode"><code><span class="html">As mentioned at <a href="https://msdn.microsoft.com/en-us/library/cc296193.aspx" rel="nofollow" target="_blank">https://msdn.microsoft.com/en-us/library/cc296193.aspx</a> the connection will convert some data into PHP data types.  Of particular difference to other database functions in PHP is that dates will be output as objects instead of strings.<br /><br />To make the sqlsrv_fetch_{array|object}() functions return dates/times/datetimes as strings instead, specify: <br />  'ReturnDatesAsStrings' =&gt; true<br />in the $connectionInfo array.<br /><br />For more info about this behaviour, see <a href="https://msdn.microsoft.com/en-us/library/ee376928.aspx" rel="nofollow" target="_blank">https://msdn.microsoft.com/en-us/library/ee376928.aspx</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sqlsrv-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-connect.php">＋<small>add a note</small></a></div>
