...
<head>
  ...
  <title>PHP: IntlChar::getIntPropertyMaxValue - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.getintpropertymaxvalue.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.getintpropertymaxvalue.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.getintpropertymaxvalue.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.getfc-nfkc-closure.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.getintpropertyminvalue.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.getintpropertymaxvalue.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.getintpropertymaxvalue.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.getintpropertymaxvalue.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.getintpropertymaxvalue.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.getintpropertymaxvalue.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.getintpropertymaxvalue.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.getintpropertymaxvalue.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.getintpropertymaxvalue.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.getintpropertymaxvalue.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.getintpropertymaxvalue.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.getintpropertymaxvalue.php" hreflang="zh">
...
<meta name="Description" content="Get the max value for a Unicode property" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::getIntPropertyMaxValue - Manual" />
<meta name="twitter:description" content="Get the max value for a Unicode property" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::getIntPropertyMaxValue - Manual" />
<meta itemprop="description" content="Get the max value for a Unicode property" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the max value for a Unicode property" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intlchar.getintpropertyminvalue.php">
          IntlChar::getIntPropertyMinValue &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.getfc-nfkc-closure.php">
          &laquo; IntlChar::getFC_NFKC_Closure        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.getintpropertymaxvalue.php' selected="selected">English</option>
            <option value='de/intlchar.getintpropertymaxvalue.php'>German</option>
            <option value='es/intlchar.getintpropertymaxvalue.php'>Spanish</option>
            <option value='fr/intlchar.getintpropertymaxvalue.php'>French</option>
            <option value='it/intlchar.getintpropertymaxvalue.php'>Italian</option>
            <option value='ja/intlchar.getintpropertymaxvalue.php'>Japanese</option>
            <option value='pt_BR/intlchar.getintpropertymaxvalue.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.getintpropertymaxvalue.php'>Russian</option>
            <option value='tr/intlchar.getintpropertymaxvalue.php'>Turkish</option>
            <option value='uk/intlchar.getintpropertymaxvalue.php'>Ukrainian</option>
            <option value='zh/intlchar.getintpropertymaxvalue.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.getintpropertymaxvalue" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::getIntPropertyMaxValue</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::getIntPropertyMaxValue</span> &mdash; <span class="dc-title">Get the max value for a Unicode property</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlchar.getintpropertymaxvalue-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::getIntPropertyMaxValue</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$property</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.getintpropertymaxvalue-returnvalues">
  ...
  <p class="para">
   The maximum value returned by <span class="function"><a href="intlchar.getintpropertyvalue.php" class="function">IntlChar::getIntPropertyValue()</a></span> for a Unicode property.
 ...
 <div class="refsect1 examples" id="refsect1-intlchar.getintpropertymaxvalue-examples">
  ...
  <div class="example" id="example-2710">
   ...
   <div class="example-contents screen">
    <div class="examplescode"><pre class="examplescode">int(22)
int(166)
int(1)
int(-1)</pre>
</div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.getunicodeversion.php" class="function" rel="rdfs-seeAlso">IntlChar::getUnicodeVersion()</a> - Get the Unicode version</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/getintpropertymaxvalue.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.getintpropertymaxvalue%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.getintpropertymaxvalue&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.getintpropertymaxvalue.php">＋<small>add a note</small></a></span>
