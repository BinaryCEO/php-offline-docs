...
<head>
  ...
  <title>PHP: ibase_blob_add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-blob-add.php">
 <link rel="shorturl" href="https://www.php.net/ibase-blob-add">
 <link rel="alternate" href="https://www.php.net/ibase-blob-add" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-backup.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-blob-cancel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-blob-add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-blob-add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-blob-add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-blob-add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-blob-add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-blob-add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-blob-add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-blob-add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-blob-add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-blob-add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-blob-add.php" hreflang="zh">
...
<meta name="Description" content="Add data into a newly created blob" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_blob_add - Manual" />
<meta name="twitter:description" content="Add data into a newly created blob" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_blob_add - Manual" />
<meta itemprop="description" content="Add data into a newly created blob" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add data into a newly created blob" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-blob-cancel.php">
          ibase_blob_cancel &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-backup.php">
          &laquo; ibase_backup        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-blob-add.php' selected="selected">English</option>
            <option value='de/function.ibase-blob-add.php'>German</option>
            <option value='es/function.ibase-blob-add.php'>Spanish</option>
            <option value='fr/function.ibase-blob-add.php'>French</option>
            <option value='it/function.ibase-blob-add.php'>Italian</option>
            <option value='ja/function.ibase-blob-add.php'>Japanese</option>
            <option value='pt_BR/function.ibase-blob-add.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-blob-add.php'>Russian</option>
            <option value='tr/function.ibase-blob-add.php'>Turkish</option>
            <option value='uk/function.ibase-blob-add.php'>Ukrainian</option>
            <option value='zh/function.ibase-blob-add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-blob-add" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_blob_add</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_blob_add</span> &mdash; <span class="dc-title">Add data into a newly created blob</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-blob-add-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_blob_add</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$blob_handle</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>ibase_blob_add()</strong></span> adds data into a blob created with
   <span class="function"><a href="function.ibase-blob-create.php" class="function">ibase_blob_create()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ibase-blob-add-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       A blob handle opened with <span class="function"><a href="function.ibase-blob-create.php" class="function">ibase_blob_create()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-blob-add-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-blob-add-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-blob-import.php" class="function" rel="rdfs-seeAlso">ibase_blob_import()</a> - Create blob, copy file in it, and close it</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-blob-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-blob-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-blob-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-blob-add.php">＋<small>add a note</small></a></span>
