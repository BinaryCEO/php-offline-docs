...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.getservbyport.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.getservbyname.php">
 <link rel="next" href="https://www.php.net/manual/en/function.header.php">
...
<meta name="Description" content="Get Internet service which corresponds to port and protocol" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: getservbyport - Manual" />
<meta name="twitter:description" content="Get Internet service which corresponds to port and protocol" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: getservbyport - Manual" />
<meta itemprop="description" content="Get Internet service which corresponds to port and protocol" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get Internet service which corresponds to port and protocol" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.getservbyport.php' selected="selected">English</option>
            ...
            <option value='ru/function.getservbyport.php'>Russian</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.getservbyname.php" class="function" rel="rdfs-seeAlso">getservbyname()</a> - Get port number associated with an Internet service and protocol</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/network/functions/getservbyport.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.getservbyport%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.getservbyport&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getservbyport.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>paland at stetson dot edu</em></strong></a><a class="genanchor" href="#9890"> &para;</a><div class="date" title="2000-11-29 04:00"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom9890">
<div class="phpcode"><code><span class="html">Example:
<br /><span class="default">&lt;?php $value </span><span class="keyword">= </span><span class="default">getservbyport</span><span class="keyword">(</span><span class="default">137</span><span class="keyword">, </span><span class="string">"udp"</span><span class="keyword">); </span><span class="default">?&gt;
<br /></span>
<br />The same goes for getservbyname()</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.getservbyport&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getservbyport.php">＋<small>add a note</small></a></div>
