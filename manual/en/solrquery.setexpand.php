...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setexpand.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setexpand.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setexpand.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setechoparams.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setexpandquery.php">
...
<meta name="Description" content="Enables/Disables the Expand Component" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setExpand - Manual" />
<meta name="twitter:description" content="Enables/Disables the Expand Component" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setExpand - Manual" />
<meta itemprop="description" content="Enables/Disables the Expand Component" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enables/Disables the Expand Component" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setexpand.php' selected="selected">English</option>
            <option value='de/solrquery.setexpand.php'>German</option>
            <option value='es/solrquery.setexpand.php'>Spanish</option>
            <option value='fr/solrquery.setexpand.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::setExpand</span> &mdash; <span class="dc-title">Enables/Disables the Expand Component</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-solrquery.setexpand-examples">
  ...
  <div class="example" id="example-4954">
   <p><strong>Example #1 <span class="function"><strong>SolrQuery::setExpand()</strong></span> example</strong></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.removeexpandfilterquery.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::removeExpandFilterQuery()</a> - Removes an expand filter query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setexpand.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setexpand%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setexpand&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setexpand.php">＋<small>add a note</small></a></span>
