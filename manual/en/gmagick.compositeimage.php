...
<head>
  ...
  <title>PHP: Gmagick::compositeimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.compositeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.compositeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.compositeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.commentimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.compositeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.compositeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.compositeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.compositeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.compositeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.compositeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.compositeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.compositeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.compositeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.compositeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.compositeimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::compositeimage - Manual" />
<meta name="twitter:description" content="Composite one image onto another" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::compositeimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.construct.php">
          Gmagick::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.commentimage.php">
          &laquo; Gmagick::commentimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.compositeimage.php' selected="selected">English</option>
            <option value='de/gmagick.compositeimage.php'>German</option>
            <option value='es/gmagick.compositeimage.php'>Spanish</option>
            <option value='fr/gmagick.compositeimage.php'>French</option>
            <option value='it/gmagick.compositeimage.php'>Italian</option>
            <option value='ja/gmagick.compositeimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.compositeimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.compositeimage.php'>Russian</option>
            <option value='tr/gmagick.compositeimage.php'>Turkish</option>
            <option value='uk/gmagick.compositeimage.php'>Ukrainian</option>
            <option value='zh/gmagick.compositeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.compositeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::compositeimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::compositeimage</span> &mdash; <span class="dc-title">Composite one image onto another</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.compositeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::compositeimage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span> <code class="parameter">$source</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$COMPOSE</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.compositeimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object which holds the composite image.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.compositeimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object with compositions.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.compositeimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/compositeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.compositeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.compositeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.compositeimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="105233">  <div class="votes">
    <div id="Vu105233">
    <a href="/manual/vote-note.php?id=105233&amp;page=gmagick.compositeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105233">
    <a href="/manual/vote-note.php?id=105233&amp;page=gmagick.compositeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105233" title="0% like this...">
    -3
    </div>
  </div>
  <a href="#105233" class="name">
  <strong class="user"><em>wallace Lau kok poh</em></strong></a><a class="genanchor" href="#105233"> &para;</a><div class="date" title="2011-08-04 12:03"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105233">
<div class="phpcode"><code><span class="html">Quick script for stamping a small image on a large image<br /><br />#!/usr/bin/php<br /><span class="default">&lt;?php<br /></span><span class="comment">//  &lt;wallace@wallacelau.com&gt;<br />//Instantiate a new Gmagick object<br /></span><span class="default">$imgMain </span><span class="keyword">= new </span><span class="default">Gmagick</span><span class="keyword">(</span><span class="string">'Torso_F.tiff'</span><span class="keyword">);<br /><br /></span><span class="comment">// get the image width<br /></span><span class="default">$width </span><span class="keyword">= (int) (</span><span class="default">$imgMain</span><span class="keyword">-&gt;</span><span class="default">getimagewidth</span><span class="keyword">() /</span><span class="default">2</span><span class="keyword">) - </span><span class="default">150</span><span class="keyword">;<br /><br /></span><span class="comment">//Instantiate a barcode img Gmagick object<br /></span><span class="default">$imgBarcode </span><span class="keyword">= new </span><span class="default">Gmagick</span><span class="keyword">(</span><span class="string">'barcode.jpeg'</span><span class="keyword">);<br /><br /></span><span class="comment">//stamp the barcode on top of the Main image<br /></span><span class="default">$imgMain</span><span class="keyword">-&gt;</span><span class="default">compositeimage</span><span class="keyword">(</span><span class="default">$imgBarcode</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">$width</span><span class="keyword">, </span><span class="default">150</span><span class="keyword">);<br /></span><span class="comment">//Write the current image at the current state to a file<br /></span><span class="default">$imgMain</span><span class="keyword">-&gt;</span><span class="default">write</span><span class="keyword">(</span><span class="string">'withBarcode.tiff'</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="105698">  <div class="votes">
    <div id="Vu105698">
    <a href="/manual/vote-note.php?id=105698&amp;page=gmagick.compositeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105698">
    <a href="/manual/vote-note.php?id=105698&amp;page=gmagick.compositeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105698" title="0% like this...">
    -4
    </div>
  </div>
  <a href="#105698" class="name">
  <strong class="user"><em>Paul Janik</em></strong></a><a class="genanchor" href="#105698"> &para;</a><div class="date" title="2011-09-07 06:59"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105698">
<div class="phpcode"><code><span class="html">The second parameter, $COMPOSE, has 3 usable values:<br /><br />1 = the image is displayed normally;<br />2 = the image is displayed on a white background;<br />3 = the image is display in black on a white background;<br /><br />Paul.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gmagick.compositeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.compositeimage.php">＋<small>add a note</small></a></div>
