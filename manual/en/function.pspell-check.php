...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pspell-check.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pspell-add-to-session.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pspell-clear-session.php">
...
<meta name="Description" content="Check a word" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pspell_check - Manual" />
<meta name="twitter:description" content="Check a word" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pspell_check - Manual" />
<meta itemprop="description" content="Check a word" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check a word" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pspell-check.php' selected="selected">English</option>
            ...
            <option value='ja/function.pspell-check.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pspell_check</span> &mdash; <span class="dc-title">Check a word</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pspell-check-description">
  ...
  <p class="simpara">
   <span class="function"><strong>pspell_check()</strong></span> checks the spelling of a word.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pspell-check-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the spelling is correct, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.pspell-check-examples">
  ...
  <p class="para">
   <div class="example" id="example-2796">
    <p><strong>Example #1 <span class="function"><strong>pspell_check()</strong></span> Example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pspell </span><span style="color: #007700">= </span><span style="color: #0000BB">pspell_new</span><span style="color: #007700">(</span><span style="color: #DD0000">"en"</span><span style="color: #007700">);<br /><br />if (</span><span style="color: #0000BB">pspell_check</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell</span><span style="color: #007700">, </span><span style="color: #DD0000">"testt"</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">"This is a valid spelling"</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">"Sorry, wrong spelling"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pspell/functions/pspell-check.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pspell-check%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pspell-check&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pspell-check.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">I felt that it would help to expand on batch spell checking using this function. The previously posted example implodes using spaces as the separator for each word. There are however situations in which doing this will not return the desired result. For example, "Hello, I like coding." will return an array with two problems, "Hello," and "coding.", both these words are spelt correctly, but pspell_check() will deem them as spelled incorrectly because a comma or a period is being passed in to the function along with the word. The following example allows you to extract only the words (using regular expressions to ignore grammar such as periods or commas) in to an array and then add in html font tags to highlight all words spelled incorrectly red before returning the string.<br /><br />&lt;?<br /><br />Function SpellCheck($string) {<br /><br />    $pspell_link = pspell_new("en");<br />    preg_match_all("/[A-Z\']{1,16}/i", $string, $words);<br /><br />    for ($i = 0; $i &lt; count($words[0]); $i++) {<br /><br />        if (!pspell_check($pspell_link, $words[0][$i])) {<br /><br />            $string = str_replace($words[0][$i], "&lt;font color=\"#FF0000\"&gt;" . $words[0][$i] . "&lt;/font&gt;", $string);        <br /><br />        } <br /><br />    }<br /><br />    return $string;<br /><br />}<br /><br />?&gt;</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">A better pattern for splitting the words of a query up is:<br /><br />preg_match_all('/[^\w\']/+/', $query, $word)<br />// $words has the words.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>Jcart</em></strong></a><a class="genanchor" href="#57500"> &para;</a><div class="date" title="2005-10-05 06:50"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom57500">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br /></span><span class="comment">//should be using explode instead of implode<br />//$word = implode(" ", $message);<br /></span><span class="default">$word </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">(</span><span class="string">" "</span><span class="keyword">, </span><span class="default">$message</span><span class="keyword">);<br />foreach(</span><span class="default">$word </span><span class="keyword">as </span><span class="default">$k </span><span class="keyword">=&gt; </span><span class="default">$v</span><span class="keyword">) {<br />   if (</span><span class="default">pspell_check</span><span class="keyword">(</span><span class="default">$pspell_link</span><span class="keyword">, </span><span class="default">$v</span><span class="keyword">)) {<br />      echo </span><span class="string">"spelled right"</span><span class="keyword">;<br />   } else {<br />      echo </span><span class="string">"Sorry, wrong spelling"</span><span class="keyword">;<br />   };<br />};<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pspell-check&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pspell-check.php">＋<small>add a note</small></a></div>
