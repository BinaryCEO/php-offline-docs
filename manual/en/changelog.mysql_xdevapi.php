...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/changelog.mysql_xdevapi.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/changelog.mysql_xdevapi.php">
 <link rel="alternate" href="https://www.php.net/manual/en/changelog.mysql_xdevapi.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mysql-xdevapi.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi.examples.php">

 <link rel="alternate" href="https://www.php.net/manual/en/changelog.mysql_xdevapi.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/changelog.mysql_xdevapi.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/changelog.mysql_xdevapi.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/changelog.mysql_xdevapi.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/changelog.mysql_xdevapi.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/changelog.mysql_xdevapi.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/changelog.mysql_xdevapi.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/changelog.mysql_xdevapi.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/changelog.mysql_xdevapi.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/changelog.mysql_xdevapi.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/changelog.mysql_xdevapi.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/changelog.mysql_xdevapi.php' selected="selected">English</option>
            <option value='de/changelog.mysql_xdevapi.php'>German</option>
            <option value='es/changelog.mysql_xdevapi.php'>Spanish</option>
            <option value='fr/changelog.mysql_xdevapi.php'>French</option>
            <option value='it/changelog.mysql_xdevapi.php'>Italian</option>
            <option value='ja/changelog.mysql_xdevapi.php'>Japanese</option>
            <option value='pt_BR/changelog.mysql_xdevapi.php'>Brazilian Portuguese</option>
            <option value='ru/changelog.mysql_xdevapi.php'>Russian</option>
            <option value='tr/changelog.mysql_xdevapi.php'>Turkish</option>
            <option value='uk/changelog.mysql_xdevapi.php'>Ukrainian</option>
            <option value='zh/changelog.mysql_xdevapi.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="changelog.mysql_xdevapi" class="appendix">
   ...
   <table class="doctable informaltable">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/changelog.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fchangelog.mysql_xdevapi%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=changelog.mysql_xdevapi&amp;repo=en&amp;redirect=https://www.php.net/manual/en/changelog.mysql_xdevapi.php">＋<small>add a note</small></a></span>
