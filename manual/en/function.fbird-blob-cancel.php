...
<head>
  ...
  <title>PHP: fbird_blob_cancel - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-blob-cancel.php">
 <link rel="shorturl" href="https://www.php.net/fbird-blob-cancel">
 <link rel="alternate" href="https://www.php.net/fbird-blob-cancel" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-blob-add.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-blob-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-blob-cancel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-blob-cancel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-blob-cancel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-blob-cancel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-blob-cancel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-blob-cancel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-blob-cancel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-blob-cancel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-blob-cancel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-blob-cancel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-blob-cancel.php" hreflang="zh">
...
<meta name="Description" content="Cancel creating blob" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_blob_cancel - Manual" />
<meta name="twitter:description" content="Cancel creating blob" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_blob_cancel - Manual" />
<meta itemprop="description" content="Cancel creating blob" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Cancel creating blob" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fbird-blob-close.php">
          fbird_blob_close &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-blob-add.php">
          &laquo; fbird_blob_add        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-blob-cancel.php' selected="selected">English</option>
            <option value='de/function.fbird-blob-cancel.php'>German</option>
            <option value='es/function.fbird-blob-cancel.php'>Spanish</option>
            <option value='fr/function.fbird-blob-cancel.php'>French</option>
            <option value='it/function.fbird-blob-cancel.php'>Italian</option>
            <option value='ja/function.fbird-blob-cancel.php'>Japanese</option>
            <option value='pt_BR/function.fbird-blob-cancel.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-blob-cancel.php'>Russian</option>
            <option value='tr/function.fbird-blob-cancel.php'>Turkish</option>
            <option value='uk/function.fbird-blob-cancel.php'>Ukrainian</option>
            <option value='zh/function.fbird-blob-cancel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-blob-cancel" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_blob_cancel</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_blob_cancel</span> &mdash; <span class="dc-title">Cancel creating blob</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-blob-cancel-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fbird_blob_cancel</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$blob_handle</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   This function will discard a BLOB if it has not yet been closed by
   <span class="function"><a href="function.fbird-blob-close.php" class="function">fbird_blob_close()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fbird-blob-cancel-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       A BLOB handle opened with <span class="function"><a href="function.fbird-blob-create.php" class="function">fbird_blob_create()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fbird-blob-cancel-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fbird-blob-cancel-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-blob-close.php" class="function" rel="rdfs-seeAlso">fbird_blob_close()</a> - Alias of ibase_blob_close</span></li>
    <li><span class="function"><a href="function.fbird-blob-create.php" class="function" rel="rdfs-seeAlso">fbird_blob_create()</a> - Alias of ibase_blob_create</span></li>
    <li><span class="function"><a href="function.fbird-blob-import.php" class="function" rel="rdfs-seeAlso">fbird_blob_import()</a> - Alias of ibase_blob_import</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-blob-cancel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-blob-cancel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-blob-cancel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-blob-cancel.php">＋<small>add a note</small></a></span>
