...
<head>
  ...
  <title>PHP: Imagick::despeckleImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.despeckleimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.despeckleimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.despeckleimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.deskewimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.destroy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.despeckleimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.despeckleimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.despeckleimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.despeckleimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.despeckleimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.despeckleimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.despeckleimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.despeckleimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.despeckleimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.despeckleimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.despeckleimage.php" hreflang="zh">
...
<meta name="Description" content="Reduces the speckle noise in an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::despeckleImage - Manual" />
<meta name="twitter:description" content="Reduces the speckle noise in an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::despeckleImage - Manual" />
<meta itemprop="description" content="Reduces the speckle noise in an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reduces the speckle noise in an image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.destroy.php">
          Imagick::destroy &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.deskewimage.php">
          &laquo; Imagick::deskewImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.despeckleimage.php' selected="selected">English</option>
            <option value='de/imagick.despeckleimage.php'>German</option>
            <option value='es/imagick.despeckleimage.php'>Spanish</option>
            <option value='fr/imagick.despeckleimage.php'>French</option>
            <option value='it/imagick.despeckleimage.php'>Italian</option>
            <option value='ja/imagick.despeckleimage.php'>Japanese</option>
            <option value='pt_BR/imagick.despeckleimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.despeckleimage.php'>Russian</option>
            <option value='tr/imagick.despeckleimage.php'>Turkish</option>
            <option value='uk/imagick.despeckleimage.php'>Ukrainian</option>
            <option value='zh/imagick.despeckleimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.despeckleimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::despeckleImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::despeckleImage</span> &mdash; <span class="dc-title">Reduces the speckle noise in an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.despeckleimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::despeckleImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.despeckleimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.despeckleimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.despeckleimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-2990">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/despeckleimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.despeckleimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.despeckleimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.despeckleimage.php">＋<small>add a note</small></a></span>
