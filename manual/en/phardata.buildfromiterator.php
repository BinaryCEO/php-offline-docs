...
<head>
  ...
  <title>PHP: PharData::buildFromIterator - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phardata.buildfromiterator.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phardata.buildfromiterator.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phardata.buildfromiterator.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phardata.php">
 <link rel="prev" href="https://www.php.net/manual/en/phardata.buildfromdirectory.php">
 <link rel="next" href="https://www.php.net/manual/en/phardata.compress.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phardata.buildfromiterator.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phardata.buildfromiterator.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phardata.buildfromiterator.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phardata.buildfromiterator.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phardata.buildfromiterator.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phardata.buildfromiterator.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phardata.buildfromiterator.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phardata.buildfromiterator.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phardata.buildfromiterator.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phardata.buildfromiterator.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phardata.buildfromiterator.php" hreflang="zh">
...
<meta name="Description" content="Construct a tar or zip archive from an iterator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PharData::buildFromIterator - Manual" />
<meta name="twitter:description" content="Construct a tar or zip archive from an iterator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PharData::buildFromIterator - Manual" />
<meta itemprop="description" content="Construct a tar or zip archive from an iterator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Construct a tar or zip archive from an iterator" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phardata.compress.php">
          PharData::compress &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phardata.buildfromdirectory.php">
          &laquo; PharData::buildFromDirectory        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phardata.buildfromiterator.php' selected="selected">English</option>
            <option value='de/phardata.buildfromiterator.php'>German</option>
            <option value='es/phardata.buildfromiterator.php'>Spanish</option>
            <option value='fr/phardata.buildfromiterator.php'>French</option>
            <option value='it/phardata.buildfromiterator.php'>Italian</option>
            <option value='ja/phardata.buildfromiterator.php'>Japanese</option>
            <option value='pt_BR/phardata.buildfromiterator.php'>Brazilian Portuguese</option>
            <option value='ru/phardata.buildfromiterator.php'>Russian</option>
            <option value='tr/phardata.buildfromiterator.php'>Turkish</option>
            <option value='uk/phardata.buildfromiterator.php'>Ukrainian</option>
            <option value='zh/phardata.buildfromiterator.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phardata.buildfromiterator" class="refentry">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.1.0</td>
      <td>
       <span class="methodname"><strong>PharData::buildFromIterator()</strong></span> no longer returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
      </td>
     </tr>
 ...
 <div class="refsect1 examples" id="refsect1-phardata.buildfromiterator-examples">
  ...
  <div class="example" id="example-848">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="phar.buildfromiterator.php" class="function" rel="rdfs-seeAlso">Phar::buildFromIterator()</a> - Construct a phar archive from an iterator</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/PharData/buildFromIterator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphardata.buildfromiterator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phardata.buildfromiterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.buildfromiterator.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115706">  <div class="votes">
    <div id="Vu115706">
    <a href="/manual/vote-note.php?id=115706&amp;page=phardata.buildfromiterator&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115706">
    <a href="/manual/vote-note.php?id=115706&amp;page=phardata.buildfromiterator&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115706" title="100% like this...">
    1
    </div>
  </div>
  <a href="#115706" class="name">
  <strong class="user"><em>cbonnissent</em></strong></a><a class="genanchor" href="#115706"> &para;</a><div class="date" title="2014-09-11 07:41"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115706">
<div class="phpcode"><code><span class="html">The code in the first exemple doesn't work properly without the flag  FilesystemIterator::SKIP_DOTS in the RecursiveDirectoryIterator (on a linux filesystem).<br /><br />So, to build a tar with a phar, I do (with two level of iteration here) :<br /><br />            $pharTar = new \PharData($contentTar.".tar");<br />            $firstLevelIterator = new \DirectoryIterator($this-&gt;inputPath);<br />            foreach ($firstLevelIterator as $fileInfo) {<br />                /* @var \SplFileInfo $fileInfo */<br />                if (in_array($fileInfo-&gt;getFilename(), $allowedDirectory)) {<br />                    $recursiveDirectoryIterator = new \RecursiveDirectoryIterator(<br />                        $this-&gt;inputPath . DIRECTORY_SEPARATOR . $fileInfo-&gt;getFilename(), \FilesystemIterator::SKIP_DOTS);<br />                    $pharTar-&gt;buildFromIterator(new \RecursiveIteratorIterator($recursiveDirectoryIterator), $this-&gt;inputPath);<br />                }<br />            }</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phardata.buildfromiterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.buildfromiterator.php">＋<small>add a note</small></a></div>
