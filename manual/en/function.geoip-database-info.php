...
<head>
  ...
  <title>PHP: geoip_database_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.geoip-database-info.php">
 <link rel="shorturl" href="https://www.php.net/geoip-database-info">
 <link rel="alternate" href="https://www.php.net/geoip-database-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.geoip.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.geoip-country-name-by-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.geoip-db-avail.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.geoip-database-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.geoip-database-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.geoip-database-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.geoip-database-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.geoip-database-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.geoip-database-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.geoip-database-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.geoip-database-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.geoip-database-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.geoip-database-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.geoip-database-info.php" hreflang="zh">
...
<meta name="Description" content="Get GeoIP Database information" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: geoip_database_info - Manual" />
<meta name="twitter:description" content="Get GeoIP Database information" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: geoip_database_info - Manual" />
<meta itemprop="description" content="Get GeoIP Database information" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get GeoIP Database information" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.geoip-db-avail.php">
          geoip_db_avail &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.geoip-country-name-by-name.php">
          &laquo; geoip_country_name_by_name        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.geoip-database-info.php' selected="selected">English</option>
            <option value='de/function.geoip-database-info.php'>German</option>
            <option value='es/function.geoip-database-info.php'>Spanish</option>
            <option value='fr/function.geoip-database-info.php'>French</option>
            <option value='it/function.geoip-database-info.php'>Italian</option>
            <option value='ja/function.geoip-database-info.php'>Japanese</option>
            <option value='pt_BR/function.geoip-database-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.geoip-database-info.php'>Russian</option>
            <option value='tr/function.geoip-database-info.php'>Turkish</option>
            <option value='uk/function.geoip-database-info.php'>Ukrainian</option>
            <option value='zh/function.geoip-database-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.geoip-database-info" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.geoip-database-info-examples">
  ...
  <p class="para">
   <div class="example" id="example-3676">
    <p><strong>Example #1 A <span class="function"><strong>geoip_database_info()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">GEO-106FREE 20060801 Build 1 Copyright (c) 2006 MaxMind LLC All Rights Reserved</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/geoip/functions/geoip-database-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.geoip-database-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.geoip-database-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.geoip-database-info.php">＋<small>add a note</small></a></span>
