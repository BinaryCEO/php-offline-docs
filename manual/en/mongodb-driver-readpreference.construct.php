...
<head>
  ...
  <title>PHP: MongoDB\Driver\ReadPreference::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-readpreference.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-readpreference.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-readpreference.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-readpreference.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-readpreference.bsonserialize.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-readpreference.gethedge.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-readpreference.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-readpreference.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-readpreference.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-readpreference.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-readpreference.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-readpreference.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-readpreference.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-readpreference.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-readpreference.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-readpreference.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-readpreference.construct.php" hreflang="zh">
...
<meta name="Description" content="Create a new ReadPreference" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\ReadPreference::__construct - Manual" />
<meta name="twitter:description" content="Create a new ReadPreference" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\ReadPreference::__construct - Manual" />
<meta itemprop="description" content="Create a new ReadPreference" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a new ReadPreference" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-readpreference.gethedge.php">
          MongoDB\Driver\ReadPreference::getHedge &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-readpreference.bsonserialize.php">
          &laquo; MongoDB\Driver\ReadPreference::bsonSerialize        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-readpreference.construct.php' selected="selected">English</option>
            <option value='de/mongodb-driver-readpreference.construct.php'>German</option>
            <option value='es/mongodb-driver-readpreference.construct.php'>Spanish</option>
            <option value='fr/mongodb-driver-readpreference.construct.php'>French</option>
            <option value='it/mongodb-driver-readpreference.construct.php'>Italian</option>
            <option value='ja/mongodb-driver-readpreference.construct.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-readpreference.construct.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-readpreference.construct.php'>Russian</option>
            <option value='tr/mongodb-driver-readpreference.construct.php'>Turkish</option>
            <option value='uk/mongodb-driver-readpreference.construct.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-readpreference.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-readpreference.construct" class="refentry">
       ...
       <caption><strong>options</strong></caption>
        ...
        <tbody class="tbody">
         <tr>
          ...
          <td>
           <p class="para">Specifies whether to use <a href="https://www.mongodb.com/docs/manual/core/sharded-cluster-query-router/#mongos-hedged-reads" class="link external">&raquo;&nbsp;hedged reads</a>, which are supported by MongoDB 4.4+ for sharded queries.</p>
           <p class="para">
  ...
  <ul class="simplelist">
   <li><a href="https://www.mongodb.com/docs/manual/core/read-preference/" class="link external">&raquo;&nbsp;Read Preference reference</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/readpreference/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-readpreference.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-readpreference.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-readpreference.construct.php">＋<small>add a note</small></a></span>
