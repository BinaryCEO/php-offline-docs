...
<head>
  ...
  <title>PHP: DateTimeImmutable::setTime - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/datetimeimmutable.settime.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/datetimeimmutable.settime.php">
 <link rel="alternate" href="https://www.php.net/manual/en/datetimeimmutable.settime.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.datetimeimmutable.php">
 <link rel="prev" href="https://www.php.net/manual/en/datetimeimmutable.setisodate.php">
 <link rel="next" href="https://www.php.net/manual/en/datetimeimmutable.settimestamp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/datetimeimmutable.settime.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/datetimeimmutable.settime.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/datetimeimmutable.settime.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/datetimeimmutable.settime.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/datetimeimmutable.settime.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/datetimeimmutable.settime.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/datetimeimmutable.settime.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/datetimeimmutable.settime.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/datetimeimmutable.settime.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/datetimeimmutable.settime.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/datetimeimmutable.settime.php" hreflang="zh">
...
<meta name="Description" content="Sets the time" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateTimeImmutable::setTime - Manual" />
<meta name="twitter:description" content="Sets the time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateTimeImmutable::setTime - Manual" />
<meta itemprop="description" content="Sets the time" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the time" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="datetimeimmutable.settimestamp.php">
          DateTimeImmutable::setTimestamp &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="datetimeimmutable.setisodate.php">
          &laquo; DateTimeImmutable::setISODate        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/datetimeimmutable.settime.php' selected="selected">English</option>
            <option value='de/datetimeimmutable.settime.php'>German</option>
            <option value='es/datetimeimmutable.settime.php'>Spanish</option>
            <option value='fr/datetimeimmutable.settime.php'>French</option>
            <option value='it/datetimeimmutable.settime.php'>Italian</option>
            <option value='ja/datetimeimmutable.settime.php'>Japanese</option>
            <option value='pt_BR/datetimeimmutable.settime.php'>Brazilian Portuguese</option>
            <option value='ru/datetimeimmutable.settime.php'>Russian</option>
            <option value='tr/datetimeimmutable.settime.php'>Turkish</option>
            <option value='uk/datetimeimmutable.settime.php'>Ukrainian</option>
            <option value='zh/datetimeimmutable.settime.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="datetimeimmutable.settime" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">DateTimeImmutable::setTime</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">DateTimeImmutable::setTime</span> &mdash; <span class="dc-title">Sets the time</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-datetimeimmutable.settime-examples">
  ...
  <div class="example" id="example-2218">
   <p><strong>Example #1 <span class="function"><strong>DateTimeImmutable::setTime()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">2001-01-01 14:55:00
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$date </span><span style="color: #007700">= new </span><span style="color: #0000BB">DateTimeImmutable</span><span style="color: #007700">(</span><span style="color: #DD0000">'2001-01-01'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$newDate </span><span style="color: #007700">= </span><span style="color: #0000BB">$date</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setTime</span><span style="color: #007700">(</span><span style="color: #0000BB">14</span><span style="color: #007700">, </span><span style="color: #0000BB">55</span><span style="color: #007700">, </span><span style="color: #0000BB">24</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$newDate</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">format</span><span style="color: #007700">(</span><span style="color: #DD0000">'Y-m-d H:i:s'</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">$newDate </span><span style="color: #007700">= </span><span style="color: #0000BB">$date</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setTime</span><span style="color: #007700">(</span><span style="color: #0000BB">14</span><span style="color: #007700">, </span><span style="color: #0000BB">55</span><span style="color: #007700">, </span><span style="color: #0000BB">65</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$newDate</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">format</span><span style="color: #007700">(</span><span style="color: #DD0000">'Y-m-d H:i:s'</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">$newDate </span><span style="color: #007700">= </span><span style="color: #0000BB">$date</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setTime</span><span style="color: #007700">(</span><span style="color: #0000BB">14</span><span style="color: #007700">, </span><span style="color: #0000BB">65</span><span style="color: #007700">, </span><span style="color: #0000BB">24</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$newDate</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">format</span><span style="color: #007700">(</span><span style="color: #DD0000">'Y-m-d H:i:s'</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">$newDate </span><span style="color: #007700">= </span><span style="color: #0000BB">$date</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setTime</span><span style="color: #007700">(</span><span style="color: #0000BB">25</span><span style="color: #007700">, </span><span style="color: #0000BB">55</span><span style="color: #007700">, </span><span style="color: #0000BB">24</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$newDate</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">format</span><span style="color: #007700">(</span><span style="color: #DD0000">'Y-m-d H:i:s'</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   ...
   <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">2001-01-01 14:55:24
2001-01-01 14:56:05
2001-01-01 15:05:24
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="datetimeimmutable.setisodate.php" class="function" rel="rdfs-seeAlso">DateTimeImmutable::setISODate()</a> - Sets the ISO date</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datetimeimmutable/settime.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdatetimeimmutable.settime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=datetimeimmutable.settime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/datetimeimmutable.settime.php">＋<small>add a note</small></a></span>
