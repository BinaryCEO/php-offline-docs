...
<head>
  ...
  <title>PHP: MongoDB\Driver\Manager::executeReadWriteCommand - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-manager.executereadwritecommand.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-manager.executereadwritecommand.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.executereadwritecommand.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-manager.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-manager.executereadcommand.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-manager.executewritecommand.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.executereadwritecommand.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-manager.executereadwritecommand.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-manager.executereadwritecommand.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-manager.executereadwritecommand.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-manager.executereadwritecommand.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-manager.executereadwritecommand.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-manager.executereadwritecommand.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-manager.executereadwritecommand.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-manager.executereadwritecommand.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-manager.executereadwritecommand.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-manager.executereadwritecommand.php" hreflang="zh">
...
<meta name="Description" content="Execute a database command that reads and writes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Manager::executeReadWriteCommand - Manual" />
<meta name="twitter:description" content="Execute a database command that reads and writes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Manager::executeReadWriteCommand - Manual" />
<meta itemprop="description" content="Execute a database command that reads and writes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Execute a database command that reads and writes" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-manager.executewritecommand.php">
          MongoDB\Driver\Manager::executeWriteCommand &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-manager.executereadcommand.php">
          &laquo; MongoDB\Driver\Manager::executeReadCommand        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-manager.executereadwritecommand.php' selected="selected">English</option>
            <option value='de/mongodb-driver-manager.executereadwritecommand.php'>German</option>
            <option value='es/mongodb-driver-manager.executereadwritecommand.php'>Spanish</option>
            <option value='fr/mongodb-driver-manager.executereadwritecommand.php'>French</option>
            <option value='it/mongodb-driver-manager.executereadwritecommand.php'>Italian</option>
            <option value='ja/mongodb-driver-manager.executereadwritecommand.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-manager.executereadwritecommand.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-manager.executereadwritecommand.php'>Russian</option>
            <option value='tr/mongodb-driver-manager.executereadwritecommand.php'>Turkish</option>
            <option value='uk/mongodb-driver-manager.executereadwritecommand.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-manager.executereadwritecommand.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-manager.executereadwritecommand" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-mongodb-driver-manager.executereadwritecommand-description">
  ...
  <p class="para">
   ...
   (e.g. <a href="https://www.mongodb.com/docs/manual/reference/command/aggregate/" class="link external">&raquo;&nbsp;aggregate</a>).
   Default values for the <code class="literal">&quot;readConcern&quot;</code> and
   <code class="literal">&quot;writeConcern&quot;</code> options will be inferred from an active
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="mongodb-driver-server.executereadwritecommand.php" class="function" rel="rdfs-seeAlso">MongoDB\Driver\Server::executeReadWriteCommand()</a> - Execute a database command that reads and writes on this server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/manager/executereadwritecommand.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-manager.executereadwritecommand%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-manager.executereadwritecommand&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-manager.executereadwritecommand.php">＋<small>add a note</small></a></span>
