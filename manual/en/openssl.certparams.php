...
<head>
  ...
  <title>PHP: Key/Certificate parameters - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/openssl.certparams.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/openssl.certparams.php">
 <link rel="alternate" href="https://www.php.net/manual/en/openssl.certparams.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/openssl.constants.other.php">
 <link rel="next" href="https://www.php.net/manual/en/openssl.cert.verification.php">

 <link rel="alternate" href="https://www.php.net/manual/en/openssl.certparams.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/openssl.certparams.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/openssl.certparams.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/openssl.certparams.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/openssl.certparams.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/openssl.certparams.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/openssl.certparams.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/openssl.certparams.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/openssl.certparams.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/openssl.certparams.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/openssl.certparams.php" hreflang="zh">
...
<meta name="Description" content="Key/Certificate parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Key/Certificate parameters - Manual" />
<meta name="twitter:description" content="Key/Certificate parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Key/Certificate parameters - Manual" />
<meta itemprop="description" content="Key/Certificate parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Key/Certificate parameters" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="openssl.cert.verification.php">
          Certificate Verification &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="openssl.constants.other.php">
          &laquo; Other Constants        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/openssl.certparams.php' selected="selected">English</option>
            <option value='de/openssl.certparams.php'>German</option>
            <option value='es/openssl.certparams.php'>Spanish</option>
            <option value='fr/openssl.certparams.php'>French</option>
            <option value='it/openssl.certparams.php'>Italian</option>
            <option value='ja/openssl.certparams.php'>Japanese</option>
            <option value='pt_BR/openssl.certparams.php'>Brazilian Portuguese</option>
            <option value='ru/openssl.certparams.php'>Russian</option>
            <option value='tr/openssl.certparams.php'>Turkish</option>
            <option value='uk/openssl.certparams.php'>Ukrainian</option>
            <option value='zh/openssl.certparams.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="openssl.certparams" class="appendix">
     ...
     <ol type="1">
      <li class="listitem">
       <span class="simpara">
        ...
        (or prior to PHP 8.0.0, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> of type <code class="literal">OpenSSL X.509</code>)
     ...
     <ol type="1">
      <li class="listitem">
       <span class="simpara">
        ...
        (or prior to PHP 8.0.0, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> of type <code class="literal">OpenSSL X.509 CSR</code>)
   ...
   <li class="listitem">
     ...
     <ol type="1">
      <li class="listitem">
       <span class="simpara">
        ...
        (or prior to PHP 8.0.0, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> of type <code class="literal">OpenSSL key</code>)
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/certparams.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fopenssl.certparams%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=openssl.certparams&amp;repo=en&amp;redirect=https://www.php.net/manual/en/openssl.certparams.php">＋<small>add a note</small></a></span>
