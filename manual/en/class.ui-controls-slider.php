...
<head>
  ...
  <title>PHP: UI\Controls\Slider - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-controls-slider.php">
 <link rel="shorturl" href="https://www.php.net/ui-controls-slider">
 <link rel="alternate" href="https://www.php.net/ui-controls-slider" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-controls-spin.setvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-controls-slider.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-controls-slider.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-controls-slider.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-controls-slider.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-controls-slider.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-controls-slider.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-controls-slider.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-controls-slider.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-controls-slider.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-controls-slider.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-controls-slider.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-controls-slider.php" hreflang="zh">
...
<meta name="Description" content="Slider Control" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Controls\Slider - Manual" />
<meta name="twitter:description" content="Slider Control" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Controls\Slider - Manual" />
<meta itemprop="description" content="Slider Control" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Slider Control" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ui-controls-slider.construct.php">
          UI\Controls\Slider::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-controls-spin.setvalue.php">
          &laquo; UI\Controls\Spin::setValue        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-controls-slider.php' selected="selected">English</option>
            <option value='de/class.ui-controls-slider.php'>German</option>
            <option value='es/class.ui-controls-slider.php'>Spanish</option>
            <option value='fr/class.ui-controls-slider.php'>French</option>
            <option value='it/class.ui-controls-slider.php'>Italian</option>
            <option value='ja/class.ui-controls-slider.php'>Japanese</option>
            <option value='pt_BR/class.ui-controls-slider.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-controls-slider.php'>Russian</option>
            <option value='tr/class.ui-controls-slider.php'>Turkish</option>
            <option value='uk/class.ui-controls-slider.php'>Ukrainian</option>
            <option value='zh/class.ui-controls-slider.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-controls-slider" class="reference">

 <h1 class="title">Slider Control</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-controls-slider.intro">
  ...
  <div class="section" id="ui-controls-slider.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Controls\Slider</strong>
     </span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="ui-controls-slider.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$min</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$max</code></span>)</div>
    

    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-slider.getvalue.php" class="methodname">getValue</a></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">protected</span> <span class="methodname"><a href="ui-controls-slider.onchange.php" class="methodname">onChange</a></span>()</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-slider.setvalue.php" class="methodname">setValue</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>)</div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-controls-slider.construct.php">UI\Controls\Slider::__construct</a> — Construct a new Slider</li><li><a href="ui-controls-slider.getvalue.php">UI\Controls\Slider::getValue</a> — Get Value</li><li><a href="ui-controls-slider.onchange.php">UI\Controls\Slider::onChange</a> — Change Handler</li><li><a href="ui-controls-slider.setvalue.php">UI\Controls\Slider::setValue</a> — Set Value</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.controls.slider.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-controls-slider%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-controls-slider&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-controls-slider.php">＋<small>add a note</small></a></span>
