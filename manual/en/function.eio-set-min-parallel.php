...
<head>
  ...
  <title>PHP: eio_set_min_parallel - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-set-min-parallel.php">
 <link rel="shorturl" href="https://www.php.net/eio-set-min-parallel">
 <link rel="alternate" href="https://www.php.net/eio-set-min-parallel" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-set-max-poll-time.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-stat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-set-min-parallel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-set-min-parallel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-set-min-parallel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-set-min-parallel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-set-min-parallel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-set-min-parallel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-set-min-parallel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-set-min-parallel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-set-min-parallel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-set-min-parallel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-set-min-parallel.php" hreflang="zh">
...
<meta name="Description" content="Set minimum parallel thread number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_set_min_parallel - Manual" />
<meta name="twitter:description" content="Set minimum parallel thread number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_set_min_parallel - Manual" />
<meta itemprop="description" content="Set minimum parallel thread number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set minimum parallel thread number" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-stat.php">
          eio_stat &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-set-max-poll-time.php">
          &laquo; eio_set_max_poll_time        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-set-min-parallel.php' selected="selected">English</option>
            <option value='de/function.eio-set-min-parallel.php'>German</option>
            <option value='es/function.eio-set-min-parallel.php'>Spanish</option>
            <option value='fr/function.eio-set-min-parallel.php'>French</option>
            <option value='it/function.eio-set-min-parallel.php'>Italian</option>
            <option value='ja/function.eio-set-min-parallel.php'>Japanese</option>
            <option value='pt_BR/function.eio-set-min-parallel.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-set-min-parallel.php'>Russian</option>
            <option value='tr/function.eio-set-min-parallel.php'>Turkish</option>
            <option value='uk/function.eio-set-min-parallel.php'>Ukrainian</option>
            <option value='zh/function.eio-set-min-parallel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-set-min-parallel" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_set_min_parallel</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_set_min_parallel</span> &mdash; <span class="dc-title">Set minimum parallel thread number</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-set-min-parallel-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_set_min_parallel</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$nthreads</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-set-min-parallel-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-set-min-parallel-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-set-min-parallel-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.eio-set-max-parallel.php" class="function" rel="rdfs-seeAlso">eio_set_max_parallel()</a> - Set maximum parallel threads</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-set-min-parallel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-set-min-parallel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-set-min-parallel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-set-min-parallel.php">＋<small>add a note</small></a></span>
