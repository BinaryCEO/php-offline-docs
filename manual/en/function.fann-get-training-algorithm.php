...
<head>
  ...
  <title>PHP: fann_get_training_algorithm - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-training-algorithm.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-training-algorithm">
 <link rel="alternate" href="https://www.php.net/fann-get-training-algorithm" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-train-stop-function.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-init-weights.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-training-algorithm.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-training-algorithm.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-training-algorithm.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-training-algorithm.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-training-algorithm.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-training-algorithm.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-training-algorithm.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-training-algorithm.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-training-algorithm.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-training-algorithm.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-training-algorithm.php" hreflang="zh">
...
<meta name="Description" content="Returns the training algorithm" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_training_algorithm - Manual" />
<meta name="twitter:description" content="Returns the training algorithm" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_training_algorithm - Manual" />
<meta itemprop="description" content="Returns the training algorithm" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the training algorithm" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-init-weights.php">
          fann_init_weights &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-train-stop-function.php">
          &laquo; fann_get_train_stop_function        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-training-algorithm.php' selected="selected">English</option>
            <option value='de/function.fann-get-training-algorithm.php'>German</option>
            <option value='es/function.fann-get-training-algorithm.php'>Spanish</option>
            <option value='fr/function.fann-get-training-algorithm.php'>French</option>
            <option value='it/function.fann-get-training-algorithm.php'>Italian</option>
            <option value='ja/function.fann-get-training-algorithm.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-training-algorithm.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-training-algorithm.php'>Russian</option>
            <option value='tr/function.fann-get-training-algorithm.php'>Turkish</option>
            <option value='uk/function.fann-get-training-algorithm.php'>Ukrainian</option>
            <option value='zh/function.fann-get-training-algorithm.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-training-algorithm" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_get_training_algorithm</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_get_training_algorithm</span> &mdash; <span class="dc-title">Returns the training algorithm</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-get-training-algorithm-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_get_training_algorithm</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Returns the training algorithm. This training algorithm is used by <span class="function"><a href="function.fann-train-on-data.php" class="function">fann_train_on_data()</a></span> and associated functions.
  </p>
  <p class="para">
   Note that this algorithm is also used during <span class="function"><a href="function.fann-cascadetrain-on-data.php" class="function">fann_cascadetrain_on_data()</a></span>, although only
   <strong><code><a href="fann.constants.php#constant.fann-train-rprop">FANN_TRAIN_RPROP</a></code></strong> and <strong><code><a href="fann.constants.php#constant.fann-train-quickprop">FANN_TRAIN_QUICKPROP</a></code></strong> is allowed during cascade training.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fann-get-training-algorithm-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-training-algorithm-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <a href="fann.constants.php#constants.fann-train" class="link">Training algorithm</a> constant, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fann-get-training-algorithm-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-set-training-algorithm.php" class="function" rel="rdfs-seeAlso">fann_set_training_algorithm()</a> - Sets the training algorithm</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-training-algorithm.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-training-algorithm%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-training-algorithm&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-training-algorithm.php">＋<small>add a note</small></a></span>
