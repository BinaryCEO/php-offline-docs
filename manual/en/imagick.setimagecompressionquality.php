...
<div id="layout" class="clearfix">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.setimagecompressionquality-examples">
  ...
  <p class="para">
    <div class="example" id="example-3095">
...
<div class="phpcode"><code><span class="html">I had strange results when trying to get good png compression.<br /><br />I used Imagick::COMPRESSION_ZIP<br /><br />Here are a few file sizes for a few compression levels.<br /><br />0: 236,100<br />1: 274,035<br />9: 258,379<br />50: 241,282<br />100: 240,156<br /><br />Note the best result at 0. Also I got thrown off for a long time trying to get similar results to gimp. Make sure your image depth is set to 8, it appears to be 16 bits per channel, at least for me.<br /><br />You can check with identify -verbose filename.png<br /><br />You can also strip a bit more file size with $image-&gt;stripImage();</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>nulll</em></strong></a><a class="genanchor" href="#129117"> &para;</a><div class="date" title="2023-12-22 02:57"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129117">
<div class="phpcode"><code><span class="html">Tested on php 8.1.25, ImageMagick 7.1.1-22<br />`setImageCompressionQuality()` does just nothing on an `avif` image.<br />Whatever value you set, the result image is always the same size.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">The setImageCompressionQuality method accepts an integer value as its argument, representing the desired compression quality for the image, from 0 to 100, where 0 represents the lowest quality (highest compression, most lossy), and 100 represents the highest quality (lowest compression, lossless).<br /><br />* Quality 0: Lowest quality, highest compression, most lossy. This will result in a very small file size, but the image will likely have noticeable artifacts and reduced clarity.<br /><br />* Quality 100: Highest quality, lowest compression, lossless. The image will retain all its original details, but the file size will be larger.<br /><br />In most cases, a quality value between 70 and 90 provides a good balance between file size and image quality. However, the optimal value depends on your specific use case and the level of compression you can tolerate while maintaining acceptable image clarity. It's best to experiment with different quality values to find the one that best suits you</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>vhpvhp at msn dot com</em></strong></a><a class="genanchor" href="#123322"> &para;</a><div class="date" title="2018-11-08 09:30"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123322">
<div class="phpcode"><code><span class="html">For a PNG image, `setImageCompressionQuality()` is not work at all, length of the generated files are totally same.<br /><br />But I found an effective way, that is use `setOption('png:compression-level', 9)`, the value range is 0-9.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">This example shows how to set the compression type, set the compression quality, create a thumbnail and remove unnecessary data in order to reduce file size.
<br />
<br />This will use the following functions in reference:
<br />Imagick::setImageCompression
<br />Imagick::setImageCompressionQuality
<br />Imagick::stripImage
<br />Imagick::thumbnailImage
<br />Imagick::writeImage
<br />
<br /><span class="default">&lt;?php
<br />    $image </span><span class="keyword">= </span><span class="string">'image.jpg'</span><span class="keyword">;
<br />    </span><span class="default">$directory </span><span class="keyword">= </span><span class="string">'/path/to/image'</span><span class="keyword">;
<br />    </span><span class="default">$image_location </span><span class="keyword">= </span><span class="default">$directory </span><span class="keyword">. </span><span class="string">"/" </span><span class="keyword">. </span><span class="default">$image</span><span class="keyword">;
<br />    </span><span class="default">$thumb_destination </span><span class="keyword">= </span><span class="default">$directory </span><span class="keyword">. </span><span class="string">"/t" </span><span class="keyword">. </span><span class="default">$image</span><span class="keyword">;
<br />    </span><span class="default">$compression_type </span><span class="keyword">= </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPRESSION_JPEG</span><span class="keyword">;
<br />   
<br />    </span><span class="default">$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$image_location</span><span class="keyword">);
<br />    </span><span class="default">$thumbnail </span><span class="keyword">= </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">clone</span><span class="keyword">;
<br />
<br />    </span><span class="default">$thumbnail</span><span class="keyword">-&gt;</span><span class="default">setImageCompression</span><span class="keyword">(</span><span class="default">$compression_type</span><span class="keyword">);
<br />    </span><span class="default">$thumbnail</span><span class="keyword">-&gt;</span><span class="default">setImageCompressionQuality</span><span class="keyword">(</span><span class="default">40</span><span class="keyword">);
<br />    </span><span class="default">$thumbnail</span><span class="keyword">-&gt;</span><span class="default">stripImage</span><span class="keyword">();
<br />    </span><span class="default">$thumbnail</span><span class="keyword">-&gt;</span><span class="default">thumbnailImage</span><span class="keyword">(</span><span class="default">100</span><span class="keyword">,</span><span class="default">null</span><span class="keyword">);
<br />    </span><span class="default">$thumbnail</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">$thumb_destination</span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>
<br />Now, obviously you don't have to do so much with the variables and the file location.  I only used so many to demonstrate where the images are coming from and where they are going.
<br />
<br />NOTE:  The $thumbnail-&gt;thumbnailImage(100,null); keeps the aspect ration by setting the second parameter to null.  Read about this at Imagick::thumbnailImage
<br />
<br />There is another way to create thumbnails that works quite well if you want to crop the image rather than using the entire image.  Check out Imagick::cropThumbnailImage</span></code></div>
  </div>
 </div></div>
