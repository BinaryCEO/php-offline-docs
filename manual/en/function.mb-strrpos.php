...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-strrpos.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-strripos.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-strstr.php">
...
<meta name="Description" content="Find position of last occurrence of a string in a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_strrpos - Manual" />
<meta name="twitter:description" content="Find position of last occurrence of a string in a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_strrpos - Manual" />
<meta itemprop="description" content="Find position of last occurrence of a string in a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Find position of last occurrence of a string in a string" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-strrpos.php' selected="selected">English</option>
            ...
            <option value='ru/function.mb-strrpos.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_strrpos</span> &mdash; <span class="dc-title">Find position of last occurrence of a string in a string</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-strrpos-description">
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.strrpos.php" class="function">strrpos()</a></span> operation based on the 
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-strrpos-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The <span class="type"><a href="language.types.string.php" class="type string">string</a></span> being checked, for the last occurrence
     ...
     <dd>
      <p class="para">
       The <span class="type"><a href="language.types.string.php" class="type string">string</a></span> to find in <code class="parameter">haystack</code>.
      </p>
     </dd>
     ...
     <dd>
      <span class="simpara">
       ...
       the <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.  Negative values will stop searching at an arbitrary point
       prior to the end of the <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.
      </span>
     </dd>
 ...
 <td>
  <code class="parameter">needle</code> now accepts an empty string.
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       Passing the <code class="parameter">encoding</code> as the third argument 
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.strrpos.php" class="function" rel="rdfs-seeAlso">strrpos()</a> - Find the position of the last occurrence of a substring in a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-strrpos.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-strrpos%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-strrpos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-strrpos.php">＋<small>add a note</small></a></span>
  ...
  <a href="#59161" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#59161"> &para;</a><div class="date" title="2005-11-27 06:32"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom59161">
<div class="phpcode"><code><span class="html">mb_strrpos throws a warning if $haystack is empty. <br />strrpos simply returns FALSE.<br /><br />This is something to be wary of if overloading the mb functions.</span></code></div>
  </div>
 </div>
  <div class="note" id="117058">  <div class="votes">
    ...
    <div class="tally" id="V117058" title="41% like this...">
    -2
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">"Negative values will stop searching at an arbitrary point prior to the end of the string. " ist misleading.<br />The needle may not fully part of searchrange, defined by a negative offset. <br />A negative offsets marks the last byte, where a search could start.<br /><span class="default">&lt;?php<br />$test </span><span class="keyword">= </span><span class="string">"Hallo, Herr Gött"</span><span class="keyword">;<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$test</span><span class="keyword">));                       </span><span class="comment">// int(17)<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">mb_strrpos</span><span class="keyword">(</span><span class="default">$test</span><span class="keyword">,</span><span class="string">'ött'</span><span class="keyword">,</span><span class="default">13</span><span class="keyword">));  </span><span class="comment">// int(13)<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">mb_strrpos</span><span class="keyword">(</span><span class="default">$test</span><span class="keyword">,</span><span class="string">'ött'</span><span class="keyword">,-</span><span class="default">4</span><span class="keyword">)); </span><span class="comment">// int(13) 17-4 = 13<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">mb_strrpos</span><span class="keyword">(</span><span class="default">$test</span><span class="keyword">,</span><span class="string">'ött'</span><span class="keyword">,-</span><span class="default">5</span><span class="keyword">)); </span><span class="comment">// bool(false)<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-strrpos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-strrpos.php">＋<small>add a note</small></a></div>
