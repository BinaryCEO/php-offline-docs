...
<head>
  ...
  <title>PHP: ImagickDraw::getFont - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getfont.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getfont.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfont.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getfillrule.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getfontfamily.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfont.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getfont.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getfont.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getfont.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getfont.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getfont.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getfont.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getfont.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getfont.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getfont.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getfont.php" hreflang="zh">
...
<meta name="Description" content="Returns the font" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getFont - Manual" />
<meta name="twitter:description" content="Returns the font" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getFont - Manual" />
<meta itemprop="description" content="Returns the font" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the font" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.getfontfamily.php">
          ImagickDraw::getFontFamily &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getfillrule.php">
          &laquo; ImagickDraw::getFillRule        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getfont.php' selected="selected">English</option>
            <option value='de/imagickdraw.getfont.php'>German</option>
            <option value='es/imagickdraw.getfont.php'>Spanish</option>
            <option value='fr/imagickdraw.getfont.php'>French</option>
            <option value='it/imagickdraw.getfont.php'>Italian</option>
            <option value='ja/imagickdraw.getfont.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getfont.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getfont.php'>Russian</option>
            <option value='tr/imagickdraw.getfont.php'>Turkish</option>
            <option value='uk/imagickdraw.getfont.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getfont.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getfont" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getFont</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getFont</span> &mdash; <span class="dc-title">Returns the font</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getfont-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getFont</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getfont-returnvalues">
  ...
  <p class="para">
   Returns a string on success and false if no font is set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getfont.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getfont%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getfont&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getfont.php">＋<small>add a note</small></a></span>
