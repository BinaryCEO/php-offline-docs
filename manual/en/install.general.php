...
<head>
  ...
  <title>PHP: General Installation Considerations - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/install.general.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/install.general.php">
 <link rel="alternate" href="https://www.php.net/manual/en/install.general.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/install.php">
 <link rel="prev" href="https://www.php.net/manual/en/install.php">
 <link rel="next" href="https://www.php.net/manual/en/install.unix.php">

 <link rel="alternate" href="https://www.php.net/manual/en/install.general.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/install.general.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/install.general.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/install.general.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/install.general.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/install.general.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/install.general.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/install.general.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/install.general.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/install.general.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/install.general.php" hreflang="zh">
...
<meta name="Description" content="General Installation Considerations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: General Installation Considerations - Manual" />
<meta name="twitter:description" content="General Installation Considerations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: General Installation Considerations - Manual" />
<meta itemprop="description" content="General Installation Considerations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="General Installation Considerations" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="install.unix.php">
          Installation on Unix systems &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="install.php">
          &laquo; Installation and Configuration        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
  ...
  <div class="page-tools">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/install.general.php' selected="selected">English</option>
            ...
            <option value='it/install.general.php'>Italian</option>
            ...
            <option value='uk/install.general.php'>Ukrainian</option>
            <option value='zh/install.general.php'>Chinese (Simplified)</option>
   ...
   <h1 class="title">General Installation Considerations</h1>
   ...
   <p class="para">
    ...
    <a href="introduction.php#intro-whatcando" class="link">What can PHP do?</a>
    section:
   ...
   <p class="para">
    ...
    the section about <a href="features.commandline.php" class="link">writing
   ...
   <p class="para">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/install/intro.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Finstall.general%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=install.general&amp;repo=en&amp;redirect=https://www.php.net/manual/en/install.general.php">＋<small>add a note</small></a></span>
