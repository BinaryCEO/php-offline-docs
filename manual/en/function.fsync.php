...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fsync.php">
 <link rel="shorturl" href="https://www.php.net/fsync">
 <link rel="alternate" href="https://www.php.net/fsync" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fstat.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ftell.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fsync.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fsync.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fsync.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fsync.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fsync.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fsync.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fsync.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fsync.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fsync.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fsync.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fsync.php" hreflang="zh">
...
<meta name="Description" content="Synchronizes changes to the file (including meta-data)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fsync - Manual" />
<meta name="twitter:description" content="Synchronizes changes to the file (including meta-data)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fsync - Manual" />
<meta itemprop="description" content="Synchronizes changes to the file (including meta-data)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Synchronizes changes to the file (including meta-data)" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fsync.php' selected="selected">English</option>
            <option value='de/function.fsync.php'>German</option>
            <option value='es/function.fsync.php'>Spanish</option>
            <option value='fr/function.fsync.php'>French</option>
            <option value='it/function.fsync.php'>Italian</option>
            <option value='ja/function.fsync.php'>Japanese</option>
            <option value='pt_BR/function.fsync.php'>Brazilian Portuguese</option>
            <option value='ru/function.fsync.php'>Russian</option>
            <option value='tr/function.fsync.php'>Turkish</option>
            <option value='uk/function.fsync.php'>Ukrainian</option>
            <option value='zh/function.fsync.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fsync" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fsync</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.1.0)</p><p class="refpurpose"><span class="refname">fsync</span> &mdash; <span class="dc-title">Synchronizes changes to the file (including meta-data)</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fsync-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fsync</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stream</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   This function synchronizes changes to the file, including its meta-data. This is similar to <span class="function"><a href="function.fflush.php" class="function">fflush()</a></span>,
   but it also instructs the operating system to write to the storage media.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fsync-parameters">
...
<span class="function"><a href="function.fclose.php" class="function">fclose()</a></span>).</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fsync-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.fsync-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2381">
    <p><strong>Example #1 <span class="function"><strong>fsync()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$file </span><span style="color: #007700">= </span><span style="color: #DD0000">'test.txt'</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">$stream </span><span style="color: #007700">= </span><span style="color: #0000BB">fopen</span><span style="color: #007700">(</span><span style="color: #0000BB">$file</span><span style="color: #007700">, </span><span style="color: #DD0000">'w'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">fwrite</span><span style="color: #007700">(</span><span style="color: #0000BB">$stream</span><span style="color: #007700">, </span><span style="color: #DD0000">'test data'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">fwrite</span><span style="color: #007700">(</span><span style="color: #0000BB">$stream</span><span style="color: #007700">, </span><span style="color: #DD0000">"\r\n"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">fwrite</span><span style="color: #007700">(</span><span style="color: #0000BB">$stream</span><span style="color: #007700">, </span><span style="color: #DD0000">'additional data'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">fsync</span><span style="color: #007700">(</span><span style="color: #0000BB">$stream</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$stream</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.fsync-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fdatasync.php" class="function" rel="rdfs-seeAlso">fdatasync()</a> - Synchronizes data (but not meta-data) to the file</span></li>
    <li><span class="function"><a href="function.fflush.php" class="function" rel="rdfs-seeAlso">fflush()</a> - Flushes the output to a file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/fsync.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fsync%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fsync&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fsync.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126648">  <div class="votes">
    <div id="Vu126648">
    <a href="/manual/vote-note.php?id=126648&amp;page=function.fsync&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126648">
    <a href="/manual/vote-note.php?id=126648&amp;page=function.fsync&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126648" title="93% like this...">
    14
    </div>
  </div>
  <a href="#126648" class="name">
  <strong class="user"><em>Dave Gebler</em></strong></a><a class="genanchor" href="#126648"> &para;</a><div class="date" title="2021-11-30 10:15"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126648">
<div class="phpcode"><code><span class="html">Two points worth noting:<br /><br />1. fsync() is not suitable for high throughput, use it only when the durability of a file write really matters to you.<br /><br />2. fsync() includes an implicit call to fflush() so you don't need to manually flush before you sync.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fsync&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fsync.php">＋<small>add a note</small></a></div>
