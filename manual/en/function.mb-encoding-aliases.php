...
<head>
  ...
  <title>PHP: mb_encoding_aliases - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-encoding-aliases.php">
 <link rel="shorturl" href="https://www.php.net/mb-encoding-aliases">
 <link rel="alternate" href="https://www.php.net/mb-encoding-aliases" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-encode-numericentity.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-ereg.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-encoding-aliases.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-encoding-aliases.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-encoding-aliases.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-encoding-aliases.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-encoding-aliases.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-encoding-aliases.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-encoding-aliases.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-encoding-aliases.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-encoding-aliases.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-encoding-aliases.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-encoding-aliases.php" hreflang="zh">
...
<meta name="Description" content="Get aliases of a known encoding type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_encoding_aliases - Manual" />
<meta name="twitter:description" content="Get aliases of a known encoding type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_encoding_aliases - Manual" />
<meta itemprop="description" content="Get aliases of a known encoding type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get aliases of a known encoding type" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mb-encode-numericentity.php">
          &laquo; mb_encode_numericentity        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-encoding-aliases.php' selected="selected">English</option>
            <option value='de/function.mb-encoding-aliases.php'>German</option>
            <option value='es/function.mb-encoding-aliases.php'>Spanish</option>
            <option value='fr/function.mb-encoding-aliases.php'>French</option>
            <option value='it/function.mb-encoding-aliases.php'>Italian</option>
            <option value='ja/function.mb-encoding-aliases.php'>Japanese</option>
            <option value='pt_BR/function.mb-encoding-aliases.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-encoding-aliases.php'>Russian</option>
            <option value='tr/function.mb-encoding-aliases.php'>Turkish</option>
            <option value='uk/function.mb-encoding-aliases.php'>Ukrainian</option>
            <option value='zh/function.mb-encoding-aliases.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-encoding-aliases" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_encoding_aliases</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_encoding_aliases</span> &mdash; <span class="dc-title">Get aliases of a known encoding type</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.mb-encoding-aliases-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_encoding_aliases</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$encoding</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   Returns an array of aliases for a known <code class="parameter">encoding</code> type.
  </p>
 </div>

 
 <div class="refsect1 parameters" id="refsect1-function.mb-encoding-aliases-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-encoding-aliases-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-function.mb-encoding-aliases-errors">
  <h3 class="title">Errors/Exceptions</h3>
  <p class="para">
   Throws a <span class="classname"><a href="class.valueerror.php" class="classname">ValueError</a></span> if
   <code class="parameter">encoding</code> is unknown.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.mb-encoding-aliases-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>
       If the <code class="parameter">encoding</code> is unknown, a <span class="classname"><a href="class.valueerror.php" class="classname">ValueError</a></span>
       is now thrown; previously an <strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> was emitted,
 ...
 <div class="refsect1 examples" id="refsect1-function.mb-encoding-aliases-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-2778">
   <p><strong>Example #1 <span class="function"><strong>mb_encoding_aliases()</strong></span> example</strong></p>
   <div class="example-contents">
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$encoding        </span><span style="color: #007700">= </span><span style="color: #DD0000">'ASCII'</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$known_encodings </span><span style="color: #007700">= </span><span style="color: #0000BB">mb_list_encodings</span><span style="color: #007700">();<br /><br />if (</span><span style="color: #0000BB">in_array</span><span style="color: #007700">(</span><span style="color: #0000BB">$encoding</span><span style="color: #007700">, </span><span style="color: #0000BB">$known_encodings</span><span style="color: #007700">)) {<br /><br />    </span><span style="color: #0000BB">$aliases </span><span style="color: #007700">= </span><span style="color: #0000BB">mb_encoding_aliases</span><span style="color: #007700">(</span><span style="color: #0000BB">$encoding</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">$aliases</span><span style="color: #007700">);<br /><br />} else {<br /><br />    echo </span><span style="color: #DD0000">"Unknown (</span><span style="color: #0000BB">$encoding</span><span style="color: #DD0000">) encoding.\n"</span><span style="color: #007700">;<br /><br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.mb-encoding-aliases-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.mb-list-encodings.php" class="function" rel="rdfs-seeAlso">mb_list_encodings()</a> - Returns an array of all supported encodings</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-encoding-aliases.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-encoding-aliases%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-encoding-aliases&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-encoding-aliases.php">＋<small>add a note</small></a></span>
