...
<head>
  ...
  <title>PHP: mysql_fetch_row - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-fetch-row.php">
 <link rel="shorturl" href="https://www.php.net/mysql-fetch-row">
 <link rel="alternate" href="https://www.php.net/mysql-fetch-row" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-fetch-object.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-field-flags.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-fetch-row.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-fetch-row.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-fetch-row.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-fetch-row.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-fetch-row.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-fetch-row.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-fetch-row.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-fetch-row.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-fetch-row.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-fetch-row.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-fetch-row.php" hreflang="zh">
...
<meta name="Description" content="Get a result row as an enumerated array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_fetch_row - Manual" />
<meta name="twitter:description" content="Get a result row as an enumerated array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_fetch_row - Manual" />
<meta itemprop="description" content="Get a result row as an enumerated array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get a result row as an enumerated array" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-field-flags.php">
          mysql_field_flags &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-fetch-object.php">
          &laquo; mysql_fetch_object        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-fetch-row.php' selected="selected">English</option>
            <option value='de/function.mysql-fetch-row.php'>German</option>
            <option value='es/function.mysql-fetch-row.php'>Spanish</option>
            <option value='fr/function.mysql-fetch-row.php'>French</option>
            <option value='it/function.mysql-fetch-row.php'>Italian</option>
            <option value='ja/function.mysql-fetch-row.php'>Japanese</option>
            <option value='pt_BR/function.mysql-fetch-row.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-fetch-row.php'>Russian</option>
            <option value='tr/function.mysql-fetch-row.php'>Turkish</option>
            <option value='uk/function.mysql-fetch-row.php'>Ukrainian</option>
            <option value='zh/function.mysql-fetch-row.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-fetch-row" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_fetch_row</h1>
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_fetch_row</span> &mdash; <span class="dc-title">Get a result row as an enumerated array</span></p>

 </div>

 <div id="function.mysql-fetch-row-refsynopsisdiv">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli-result.fetch-row.php" class="function">mysqli_fetch_row()</a></span></li>
    <li>
     <span class="methodname"><a href="pdostatement.fetch.php" class="methodname">PDOStatement::fetch()</a></span>
     with <code class="parameter">mode</code> as <strong><code><a href="pdo.constants.php#pdo.constants.fetch-num">PDO::FETCH_NUM</a></code></strong>
    </li>
   </ul>
  </div>
 </div>
 ...
 <div class="refsect1 description" id="refsect1-function.mysql-fetch-row-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_fetch_row</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
...
<span class="function"><a href="function.mysql-query.php" class="function">mysql_query()</a></span>.</p></dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-fetch-row-examples">
  ...
  <p class="para">
   <div class="example" id="example-1898">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-result.php" class="function" rel="rdfs-seeAlso">mysql_result()</a> - Get result data</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-fetch-row.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-fetch-row%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-fetch-row&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-fetch-row.php">＋<small>add a note</small></a></span>
