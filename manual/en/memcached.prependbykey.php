...
<head>
  ...
  <title>PHP: Memcached::prependByKey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.prependbykey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.prependbykey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.prependbykey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.prepend.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.quit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.prependbykey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.prependbykey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.prependbykey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.prependbykey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.prependbykey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.prependbykey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.prependbykey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.prependbykey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.prependbykey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.prependbykey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.prependbykey.php" hreflang="zh">
...
<meta name="Description" content="Prepend data to an existing item on a specific server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::prependByKey - Manual" />
<meta name="twitter:description" content="Prepend data to an existing item on a specific server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::prependByKey - Manual" />
<meta itemprop="description" content="Prepend data to an existing item on a specific server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Prepend data to an existing item on a specific server" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="memcached.quit.php">
          Memcached::quit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.prepend.php">
          &laquo; Memcached::prepend        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.prependbykey.php' selected="selected">English</option>
            <option value='de/memcached.prependbykey.php'>German</option>
            <option value='es/memcached.prependbykey.php'>Spanish</option>
            <option value='fr/memcached.prependbykey.php'>French</option>
            <option value='it/memcached.prependbykey.php'>Italian</option>
            <option value='ja/memcached.prependbykey.php'>Japanese</option>
            <option value='pt_BR/memcached.prependbykey.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.prependbykey.php'>Russian</option>
            <option value='tr/memcached.prependbykey.php'>Turkish</option>
            <option value='uk/memcached.prependbykey.php'>Ukrainian</option>
            <option value='zh/memcached.prependbykey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.prependbykey" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="memcached.append.php" class="methodname" rel="rdfs-seeAlso">Memcached::append()</a> - Append data to an existing item</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/prependbykey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.prependbykey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.prependbykey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.prependbykey.php">＋<small>add a note</small></a></span>
