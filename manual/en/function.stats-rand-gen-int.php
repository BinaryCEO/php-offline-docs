...
<head>
  ...
  <title>PHP: stats_rand_gen_int - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-rand-gen-int.php">
 <link rel="shorturl" href="https://www.php.net/stats-rand-gen-int">
 <link rel="alternate" href="https://www.php.net/stats-rand-gen-int" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-rand-gen-ibinomial-negative.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-rand-gen-ipoisson.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-rand-gen-int.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-rand-gen-int.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-rand-gen-int.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-rand-gen-int.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-rand-gen-int.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-rand-gen-int.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-rand-gen-int.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-rand-gen-int.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-rand-gen-int.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-rand-gen-int.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-rand-gen-int.php" hreflang="zh">
...
<meta name="Description" content="Generates random integer between 1 and 2147483562" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_rand_gen_int - Manual" />
<meta name="twitter:description" content="Generates random integer between 1 and 2147483562" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_rand_gen_int - Manual" />
<meta itemprop="description" content="Generates random integer between 1 and 2147483562" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generates random integer between 1 and 2147483562" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stats-rand-gen-ipoisson.php">
          stats_rand_gen_ipoisson &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-rand-gen-ibinomial-negative.php">
          &laquo; stats_rand_gen_ibinomial_negative        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-rand-gen-int.php' selected="selected">English</option>
            <option value='de/function.stats-rand-gen-int.php'>German</option>
            <option value='es/function.stats-rand-gen-int.php'>Spanish</option>
            <option value='fr/function.stats-rand-gen-int.php'>French</option>
            <option value='it/function.stats-rand-gen-int.php'>Italian</option>
            <option value='ja/function.stats-rand-gen-int.php'>Japanese</option>
            <option value='pt_BR/function.stats-rand-gen-int.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-rand-gen-int.php'>Russian</option>
            <option value='tr/function.stats-rand-gen-int.php'>Turkish</option>
            <option value='uk/function.stats-rand-gen-int.php'>Ukrainian</option>
            <option value='zh/function.stats-rand-gen-int.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-rand-gen-int" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_rand_gen_int</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_rand_gen_int</span> &mdash; <span class="dc-title">Generates random integer between 1 and 2147483562</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-rand-gen-int-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_rand_gen_int</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stats-rand-gen-int-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.stats-rand-gen-int-returnvalues">
  ...
  <p class="para">
   A random integer
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-rand-gen-int.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-rand-gen-int%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-rand-gen-int&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-rand-gen-int.php">＋<small>add a note</small></a></span>
