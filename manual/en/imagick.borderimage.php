...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.borderimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.borderimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.borderimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.blurimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.brightnesscontrastimage.php">
...
<meta name="Description" content="Surrounds the image with a border" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::borderImage - Manual" />
<meta name="twitter:description" content="Surrounds the image with a border" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::borderImage - Manual" />
<meta itemprop="description" content="Surrounds the image with a border" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Surrounds the image with a border" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.borderimage.php' selected="selected">English</option>
            <option value='de/imagick.borderimage.php'>German</option>
            <option value='es/imagick.borderimage.php'>Spanish</option>
            <option value='fr/imagick.borderimage.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::borderImage</span> &mdash; <span class="dc-title">Surrounds the image with a border</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.borderimage-examples">
  ...
  <p class="para">
    <div class="example" id="example-2974">
      <p><strong>Example #1  <span class="function"><strong>Imagick::borderImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/borderimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.borderimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.borderimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.borderimage.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">To  get an image with exact dimensions (i.e. add whitespace) use with borderImage:  <br />$desired_width = 1000;<br />$desired_height = 1000;<br /><br /> $image-&gt;scaleImage($desired_width,$desired_height , true);<br /> $image-&gt;borderImage('white', ($image-&gt;getImageWidth() - $desired_width) / 2,($image-&gt;getImageHeight() - $desired_height ) / 2);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.borderimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.borderimage.php">＋<small>add a note</small></a></div>
