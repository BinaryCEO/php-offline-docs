...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-new-connect.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-new-collection.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-new-cursor.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-new-connect.php' selected="selected">English</option>
            <option value='de/function.oci-new-connect.php'>German</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.oci-pconnect.php" class="function" rel="rdfs-seeAlso">oci_pconnect()</a> - Connect to an Oracle database using a persistent connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-new-connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-new-connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-new-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-new-connect.php">＋<small>add a note</small></a></span>
