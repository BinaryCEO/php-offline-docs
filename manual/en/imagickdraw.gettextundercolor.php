...
<head>
  ...
  <title>PHP: ImagickDraw::getTextUnderColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.gettextundercolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.gettextundercolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextundercolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.gettextkerning.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getvectorgraphics.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextundercolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.gettextundercolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.gettextundercolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.gettextundercolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.gettextundercolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.gettextundercolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.gettextundercolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.gettextundercolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.gettextundercolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.gettextundercolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.gettextundercolor.php" hreflang="zh">
...
<meta name="Description" content="Returns the text under color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getTextUnderColor - Manual" />
<meta name="twitter:description" content="Returns the text under color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getTextUnderColor - Manual" />
<meta itemprop="description" content="Returns the text under color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the text under color" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.getvectorgraphics.php">
          ImagickDraw::getVectorGraphics &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.gettextkerning.php">
          &laquo; ImagickDraw::getTextKerning        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.gettextundercolor.php' selected="selected">English</option>
            <option value='de/imagickdraw.gettextundercolor.php'>German</option>
            <option value='es/imagickdraw.gettextundercolor.php'>Spanish</option>
            <option value='fr/imagickdraw.gettextundercolor.php'>French</option>
            <option value='it/imagickdraw.gettextundercolor.php'>Italian</option>
            <option value='ja/imagickdraw.gettextundercolor.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.gettextundercolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.gettextundercolor.php'>Russian</option>
            <option value='tr/imagickdraw.gettextundercolor.php'>Turkish</option>
            <option value='uk/imagickdraw.gettextundercolor.php'>Ukrainian</option>
            <option value='zh/imagickdraw.gettextundercolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.gettextundercolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getTextUnderColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getTextUnderColor</span> &mdash; <span class="dc-title">Returns the text under color</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.gettextundercolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getTextUnderColor</strong></span>(): <span class="type"><a href="class.imagickpixel.php" class="type ImagickPixel">ImagickPixel</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.gettextundercolor-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an <span class="classname"><a href="class.imagickpixel.php" class="classname">ImagickPixel</a></span> object describing the color.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/gettextundercolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.gettextundercolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.gettextundercolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.gettextundercolor.php">＋<small>add a note</small></a></span>
