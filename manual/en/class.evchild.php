...
<head>
  ...
  <title>PHP: EvChild - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.evchild.php">
 <link rel="shorturl" href="https://www.php.net/evchild">
 <link rel="alternate" href="https://www.php.net/evchild" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ev.php">
 <link rel="prev" href="https://www.php.net/manual/en/evcheck.createstopped.php">
 <link rel="next" href="https://www.php.net/manual/en/evchild.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.evchild.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.evchild.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.evchild.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.evchild.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.evchild.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.evchild.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.evchild.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.evchild.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.evchild.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.evchild.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.evchild.php" hreflang="zh">
...
<meta name="Description" content="The EvChild class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EvChild - Manual" />
<meta name="twitter:description" content="The EvChild class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EvChild - Manual" />
<meta itemprop="description" content="The EvChild class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The EvChild class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="evchild.construct.php">
          EvChild::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="evcheck.createstopped.php">
          &laquo; EvCheck::createStopped        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.evchild.php' selected="selected">English</option>
            <option value='de/class.evchild.php'>German</option>
            <option value='es/class.evchild.php'>Spanish</option>
            <option value='fr/class.evchild.php'>French</option>
            <option value='it/class.evchild.php'>Italian</option>
            <option value='ja/class.evchild.php'>Japanese</option>
            <option value='pt_BR/class.evchild.php'>Brazilian Portuguese</option>
            <option value='ru/class.evchild.php'>Russian</option>
            <option value='tr/class.evchild.php'>Turkish</option>
            <option value='uk/class.evchild.php'>Ukrainian</option>
            <option value='zh/class.evchild.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.evchild" class="reference">
 <h1 class="title">The EvChild class</h1>
 
 <div class="partintro"><p class="verinfo">(PECL ev &gt;= 0.2.0)</p>

  <div class="section" id="evchild.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    <span class="classname"><strong class="classname">EvChild</strong></span>
    ...
    <strong><code>EvChild</code></strong>
  ...
  <div class="section" id="evchild.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">EvChild</strong>
     </span>
     <span class="ooclass">
    ...
    <div class="fieldsynopsis">
     <span class="modifier">public</span>
      <var class="varname"><a href="class.evchild.php#evchild.props.pid">$<var class="varname">pid</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
      <var class="varname"><a href="class.evchild.php#evchild.props.rpid">$<var class="varname">rpid</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
      <var class="varname"><a href="class.evchild.php#evchild.props.rstatus">$<var class="varname">rstatus</var></a></var>;</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span>
   <span class="methodname"><a href="evchild.construct.php" class="methodname">__construct</a></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam">
   ...
   <span class="methodname"><a href="evchild.createstopped.php" class="methodname">createStopped</a></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam">
   ...
   <span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam">
    ...
    <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$priority</code>
   <span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.object.php" class="type object">object</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span>
   <span class="methodname"><a href="evchild.set.php" class="methodname">set</a></span>(<span class="methodparam">
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span>
  ...
  <div class="section" id="evchild.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="evchild.props.pid">
      <var class="varname">pid</var>
     </dt>
     <dd>
      <p class="para">
       <em>Readonly</em>.
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="evchild.construct.php">EvChild::__construct</a> — Constructs the EvChild watcher object</li><li><a href="evchild.createstopped.php">EvChild::createStopped</a> — Create instance of a stopped EvCheck watcher</li><li><a href="evchild.set.php">EvChild::set</a> — Configures the watcher</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ev/evchild.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.evchild%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.evchild&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.evchild.php">＋<small>add a note</small></a></span>
