...
<head>
  ...
  <title>PHP: SolrQuery::setMltCount - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setmltcount.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setmltcount.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltcount.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setmltboost.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setmltmaxnumqueryterms.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltcount.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setmltcount.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setmltcount.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setmltcount.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setmltcount.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setmltcount.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setmltcount.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setmltcount.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setmltcount.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setmltcount.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setmltcount.php" hreflang="zh">
...
<meta name="Description" content="Set the number of similar documents to return for each result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setMltCount - Manual" />
<meta name="twitter:description" content="Set the number of similar documents to return for each result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setMltCount - Manual" />
<meta itemprop="description" content="Set the number of similar documents to return for each result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the number of similar documents to return for each result" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setmltmaxnumqueryterms.php">
          SolrQuery::setMltMaxNumQueryTerms &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setmltboost.php">
          &laquo; SolrQuery::setMltBoost        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setmltcount.php' selected="selected">English</option>
            <option value='de/solrquery.setmltcount.php'>German</option>
            <option value='es/solrquery.setmltcount.php'>Spanish</option>
            <option value='fr/solrquery.setmltcount.php'>French</option>
            <option value='it/solrquery.setmltcount.php'>Italian</option>
            <option value='ja/solrquery.setmltcount.php'>Japanese</option>
            <option value='pt_BR/solrquery.setmltcount.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setmltcount.php'>Russian</option>
            <option value='tr/solrquery.setmltcount.php'>Turkish</option>
            <option value='uk/solrquery.setmltcount.php'>Ukrainian</option>
            <option value='zh/solrquery.setmltcount.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setmltcount" class="refentry">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setmltcount.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setmltcount%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setmltcount&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setmltcount.php">＋<small>add a note</small></a></span>
