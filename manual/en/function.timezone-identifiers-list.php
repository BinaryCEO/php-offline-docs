...
<head>
  ...
  <title>PHP: timezone_identifiers_list - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.timezone-identifiers-list.php">
 <link rel="shorturl" href="https://www.php.net/timezone-identifiers-list">
 <link rel="alternate" href="https://www.php.net/timezone-identifiers-list" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.timezone-abbreviations-list.php">
 <link rel="next" href="https://www.php.net/manual/en/function.timezone-location-get.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.timezone-identifiers-list.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.timezone-identifiers-list.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.timezone-identifiers-list.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.timezone-identifiers-list.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.timezone-identifiers-list.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.timezone-identifiers-list.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.timezone-identifiers-list.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.timezone-identifiers-list.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.timezone-identifiers-list.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.timezone-identifiers-list.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.timezone-identifiers-list.php" hreflang="zh">
...
<meta name="Description" content="Alias of DateTimeZone::listIdentifiers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: timezone_identifiers_list - Manual" />
<meta name="twitter:description" content="Alias of DateTimeZone::listIdentifiers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: timezone_identifiers_list - Manual" />
<meta itemprop="description" content="Alias of DateTimeZone::listIdentifiers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTimeZone::listIdentifiers" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.timezone-location-get.php">
          timezone_location_get &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.timezone-abbreviations-list.php">
          &laquo; timezone_abbreviations_list        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.timezone-identifiers-list.php' selected="selected">English</option>
            <option value='de/function.timezone-identifiers-list.php'>German</option>
            <option value='es/function.timezone-identifiers-list.php'>Spanish</option>
            <option value='fr/function.timezone-identifiers-list.php'>French</option>
            <option value='it/function.timezone-identifiers-list.php'>Italian</option>
            <option value='ja/function.timezone-identifiers-list.php'>Japanese</option>
            <option value='pt_BR/function.timezone-identifiers-list.php'>Brazilian Portuguese</option>
            <option value='ru/function.timezone-identifiers-list.php'>Russian</option>
            <option value='tr/function.timezone-identifiers-list.php'>Turkish</option>
            <option value='uk/function.timezone-identifiers-list.php'>Ukrainian</option>
            <option value='zh/function.timezone-identifiers-list.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.timezone-identifiers-list" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">timezone_identifiers_list</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">timezone_identifiers_list</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetimezone.listidentifiers.php" class="methodname">DateTimeZone::listIdentifiers()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.timezone-identifiers-list-description">
  <h3 class="title">Description</h3>
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetimezone.listidentifiers.php" class="methodname">DateTimeZone::listIdentifiers()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/timezone-identifiers-list.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.timezone-identifiers-list%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.timezone-identifiers-list&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.timezone-identifiers-list.php">＋<small>add a note</small></a></span>
