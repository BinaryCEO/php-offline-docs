...
<head>
  ...
  <title>PHP: imap_append - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-append.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-alerts.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-base64.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-append.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-append.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-append.php" hreflang="uk">
...
<meta name="Description" content="Append a string message to a specified mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_append - Manual" />
<meta name="twitter:description" content="Append a string message to a specified mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_append - Manual" />
<meta itemprop="description" content="Append a string message to a specified mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Append a string message to a specified mailbox" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-base64.php">
          imap_base64 &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-alerts.php">
          &laquo; imap_alerts        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-append.php' selected="selected">English</option>
            <option value='de/function.imap-append.php'>German</option>
            <option value='es/function.imap-append.php'>Spanish</option>
            <option value='fr/function.imap-append.php'>French</option>
            <option value='it/function.imap-append.php'>Italian</option>
            <option value='ja/function.imap-append.php'>Japanese</option>
            <option value='pt_BR/function.imap-append.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-append.php'>Russian</option>
            <option value='tr/function.imap-append.php'>Turkish</option>
            <option value='uk/function.imap-append.php'>Ukrainian</option>
            <option value='zh/function.imap-append.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-append" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.imap-append-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_append</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$folder</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$options</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$internal_date</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
     ...
     <dt><code class="parameter">folder</code></dt>
     <dd>
      <p class="para">
...
<a href="imap.configuration.php#ini.imap.enable-insecure-rsh" class="link">imap.enable_insecure_rsh</a> is disabled.
     ...
     <dt><code class="parameter">internal_date</code></dt>
     <dd>
      <p class="para">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$imap </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_open</span><span style="color: #007700">(</span><span style="color: #DD0000">"{imap.example.org}INBOX.Drafts"</span><span style="color: #007700">, </span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$check </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_check</span><span style="color: #007700">(</span><span style="color: #0000BB">$imap</span><span style="color: #007700">);<br />echo </span><span style="color: #DD0000">"Msg Count before append: "</span><span style="color: #007700">. </span><span style="color: #0000BB">$check</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">Nmsgs </span><span style="color: #007700">. </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">imap_append</span><span style="color: #007700">(</span><span style="color: #0000BB">$imap</span><span style="color: #007700">, </span><span style="color: #DD0000">"{imap.example.org}INBOX.Drafts"<br />                   </span><span style="color: #007700">, </span><span style="color: #DD0000">"From: me@example.com\r\n"<br />                   </span><span style="color: #007700">. </span><span style="color: #DD0000">"To: you@example.com\r\n"<br />                   </span><span style="color: #007700">. </span><span style="color: #DD0000">"Subject: test\r\n"<br />                   </span><span style="color: #007700">. </span><span style="color: #DD0000">"\r\n"<br />                   </span><span style="color: #007700">. </span><span style="color: #DD0000">"this is a test message, please ignore\r\n"<br />                   </span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$check </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_check</span><span style="color: #007700">(</span><span style="color: #0000BB">$imap</span><span style="color: #007700">);<br />echo </span><span style="color: #DD0000">"Msg Count after append : "</span><span style="color: #007700">. </span><span style="color: #0000BB">$check</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">Nmsgs </span><span style="color: #007700">. </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">imap_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$imap</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-append.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-append%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-append&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-append.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="111461">  <div class="votes">
    <div id="Vu111461">
    <a href="/manual/vote-note.php?id=111461&amp;page=function.imap-append&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111461">
    <a href="/manual/vote-note.php?id=111461&amp;page=function.imap-append&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111461" title="80% like this...">
    19
    </div>
  </div>
  <a href="#111461" class="name">
  <strong class="user"><em>rixsta at hotmail dot com</em></strong></a><a class="genanchor" href="#111461"> &para;</a><div class="date" title="2013-02-21 08:59"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111461">
<div class="phpcode"><code><span class="html">Hi,<br /><br />As we have been struggling with this for some time I wanted to share how we got imap_append working properly with all MIME parts including attachments.  If you are sending email and also wish to append the sent message to the Sent Items folder, I cannot think of an easier way to do this, as follows:<br /><br />1) Use SwiftMailer to send the message via PHP.<br />$message = Swift_Message::newInstance("Subject goes here");<br />(then add from, to, body, attachments etc)<br />$result = $mailer-&gt;send($message);<br /><br />2) When you construct the message in step 1) above save it to a variable as follows:<br /><br />$msg = $message-&gt;toString(); (this creates the full MIME message required for imap_append()!!  After this you can call imap_append like this:<br /><br />imap_append($imap_conn,$mail_box,$msg."\r\n","\\Seen");<br /><br />I hope this helps the readers, and prevents saves people from doing what we started doing - hand crafting the MIME messages :-0</span></code></div>
  </div>
 </div>
  <div class="note" id="130006">  <div class="votes">
    <div id="Vu130006">
    <a href="/manual/vote-note.php?id=130006&amp;page=function.imap-append&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130006">
    <a href="/manual/vote-note.php?id=130006&amp;page=function.imap-append&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130006" title="100% like this...">
    3
    </div>
  </div>
  <a href="#130006" class="name">
  <strong class="user"><em>jab_creations at yahoo dot com</em></strong></a><a class="genanchor" href="#130006"> &para;</a><div class="date" title="2025-02-02 05:47"><strong>7 months ago</strong></div>
  <div class="text" id="Hcom130006">
<div class="phpcode"><code><span class="html">This function is how you take a sent message in your mail shell and place a copy of it in the remote mail server's sent folder.<br /><br />It is however not intuitive and I struggled for a couple hours so I'm placing these notes here to spare others the aggravation. Some of the errors I encountered:<br /><br /> - Can't append to mailbox with such a name<br /> - Internal date not correctly formatted<br /><br />The second/folder parameter is not the string you might think it is (e.g. "Sent", "Inbox.Sent", etc). It is the connection information used by imap_open() which doesn't make sense as the connection is already open! Whatever, here is a basic example addressing those three errors:<br /><br /><span class="default">&lt;?php<br />$server </span><span class="keyword">= </span><span class="string">'{mail.example.com:993/ssl/imap}INBOX.Sent'</span><span class="keyword">;<br /></span><span class="default">$mail_connection_folder </span><span class="keyword">= </span><span class="default">imap_open</span><span class="keyword">(</span><span class="default">$server</span><span class="keyword">, </span><span class="default">$user</span><span class="keyword">, </span><span class="default">$pass</span><span class="keyword">);<br /><br />if (</span><span class="default">$mail_connection</span><span class="keyword">)<br />{<br /> </span><span class="default">$result </span><span class="keyword">= </span><span class="default">imap_append</span><span class="keyword">(</span><span class="default">$mail_connection</span><span class="keyword">, </span><span class="default">$server</span><span class="keyword">, </span><span class="default">$message_string_raw</span><span class="keyword">, </span><span class="string">'\\Seen'</span><span class="keyword">, </span><span class="default">date</span><span class="keyword">(</span><span class="string">'d-M-Y H:i:s O'</span><span class="keyword">));<br />}<br /></span><span class="default">?&gt;<br /></span><br />I had been using the PHP Pear Mail extension which did a fantastic job with DMARC, SPF, DKIM, etc. However it's not well maintained and I couldn't figure out if it returns the email message string. The PHPMailer library (<a href="https://github.com/PHPMailer/PHPMailer" rel="nofollow" target="_blank">https://github.com/PHPMailer/PHPMailer</a>) does return the message string:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">//Skip to key parts:<br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">$mail</span><span class="keyword">-&gt;</span><span class="default">send</span><span class="keyword">();<br /><br />if (</span><span class="default">$result</span><span class="keyword">)<br />{<br /> </span><span class="default">$message_string_raw </span><span class="keyword">= </span><span class="default">$mail</span><span class="keyword">-&gt;</span><span class="default">getSentMIMEMessage</span><span class="keyword">();<br />}<br />else {</span><span class="comment">/*error handling*/</span><span class="keyword">}<br /></span><span class="default">?&gt;<br /></span><br />Hopefully this will spare some folks a lot of aggravation.</span></code></div>
  </div>
 </div>
  <div class="note" id="117277">  <div class="votes">
    <div id="Vu117277">
    <a href="/manual/vote-note.php?id=117277&amp;page=function.imap-append&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117277">
    <a href="/manual/vote-note.php?id=117277&amp;page=function.imap-append&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117277" title="81% like this...">
    10
    </div>
  </div>
  <a href="#117277" class="name">
  <strong class="user"><em>Krzysiek</em></strong></a><a class="genanchor" href="#117277"> &para;</a><div class="date" title="2015-05-15 12:18"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117277">
<div class="phpcode"><code><span class="html">You can use PHPMailer ( <a href="https://github.com/PHPMailer/PHPMailer/" rel="nofollow" target="_blank">https://github.com/PHPMailer/PHPMailer/</a> ) with imap.<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// after creating content of mail you have to run preSend() - part of send() method<br /></span><span class="default">$mail</span><span class="keyword">-&gt;</span><span class="default">send</span><span class="keyword">();<br /></span><span class="comment">// and you can get whole raw message with getSentMIMEMessage() method<br /></span><span class="default">imap_append</span><span class="keyword">(</span><span class="default">$imap</span><span class="keyword">, </span><span class="default">$mailserver</span><span class="keyword">.</span><span class="string">'INBOX.Sent'</span><span class="keyword">,</span><span class="default">$mail</span><span class="keyword">-&gt;</span><span class="default">getSentMIMEMessage</span><span class="keyword">(), </span><span class="string">"\\Seen"</span><span class="keyword">);</span></span></code></div>
  </div>
 </div>
  <div class="note" id="99407">  <div class="votes">
    <div id="Vu99407">
    <a href="/manual/vote-note.php?id=99407&amp;page=function.imap-append&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd99407">
    <a href="/manual/vote-note.php?id=99407&amp;page=function.imap-append&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V99407" title="85% like this...">
    5
    </div>
  </div>
  <a href="#99407" class="name">
  <strong class="user"><em>kaminski at istori dot com</em></strong></a><a class="genanchor" href="#99407"> &para;</a><div class="date" title="2010-08-15 08:52"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom99407">
<div class="phpcode"><code><span class="html">The date format string to use when creating $internal_date is 'd-M-Y H:i:s O'.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-append&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-append.php">＋<small>add a note</small></a></div>
