...
<head>
  ...
  <title>PHP: fann_randomize_weights - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-randomize-weights.php">
 <link rel="shorturl" href="https://www.php.net/fann-randomize-weights">
 <link rel="alternate" href="https://www.php.net/fann-randomize-weights" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-print-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-read-train-from-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-randomize-weights.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-randomize-weights.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-randomize-weights.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-randomize-weights.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-randomize-weights.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-randomize-weights.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-randomize-weights.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-randomize-weights.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-randomize-weights.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-randomize-weights.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-randomize-weights.php" hreflang="zh">
...
<meta name="Description" content="Give each connection a random weight between min_weight and max_weight" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_randomize_weights - Manual" />
<meta name="twitter:description" content="Give each connection a random weight between min_weight and max_weight" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_randomize_weights - Manual" />
<meta itemprop="description" content="Give each connection a random weight between min_weight and max_weight" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Give each connection a random weight between min_weight and max_weight" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-read-train-from-file.php">
          fann_read_train_from_file &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-print-error.php">
          &laquo; fann_print_error        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-randomize-weights.php' selected="selected">English</option>
            <option value='de/function.fann-randomize-weights.php'>German</option>
            <option value='es/function.fann-randomize-weights.php'>Spanish</option>
            <option value='fr/function.fann-randomize-weights.php'>French</option>
            <option value='it/function.fann-randomize-weights.php'>Italian</option>
            <option value='ja/function.fann-randomize-weights.php'>Japanese</option>
            <option value='pt_BR/function.fann-randomize-weights.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-randomize-weights.php'>Russian</option>
            <option value='tr/function.fann-randomize-weights.php'>Turkish</option>
            <option value='uk/function.fann-randomize-weights.php'>Ukrainian</option>
            <option value='zh/function.fann-randomize-weights.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-randomize-weights" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_randomize_weights</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_randomize_weights</span> &mdash; <span class="dc-title">Give each connection a random weight between min_weight and max_weight</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-randomize-weights-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_randomize_weights</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$min_weight</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$max_weight</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Give each connection a random weight between <code class="parameter">min_weight</code> and <code class="parameter">max_weight</code>
  </p>
  <p class="para">
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-randomize-weights-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">min_weight</code></dt>
    <dd>
     <p class="para">
    ...
    <dt><code class="parameter">max_weight</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-randomize-weights-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-randomize-weights-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-init-weights.php" class="function" rel="rdfs-seeAlso">fann_init_weights()</a> - Initialize the weights using Widrow + Nguyen&rsquo;s algorithm</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-randomize-weights.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-randomize-weights%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-randomize-weights&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-randomize-weights.php">＋<small>add a note</small></a></span>
