...
<head>
  ...
  <title>PHP: Imagick::blurImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.blurimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.blurimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.blurimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.blueshiftimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.borderimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.blurimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.blurimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.blurimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.blurimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.blurimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.blurimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.blurimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.blurimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.blurimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.blurimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.blurimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::blurImage - Manual" />
<meta name="twitter:description" content="Adds blur filter to image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::blurImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.borderimage.php">
          Imagick::borderImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.blueshiftimage.php">
          &laquo; Imagick::blueShiftImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.blurimage.php' selected="selected">English</option>
            <option value='de/imagick.blurimage.php'>German</option>
            <option value='es/imagick.blurimage.php'>Spanish</option>
            <option value='fr/imagick.blurimage.php'>French</option>
            <option value='it/imagick.blurimage.php'>Italian</option>
            <option value='ja/imagick.blurimage.php'>Japanese</option>
            <option value='pt_BR/imagick.blurimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.blurimage.php'>Russian</option>
            <option value='tr/imagick.blurimage.php'>Turkish</option>
            <option value='uk/imagick.blurimage.php'>Ukrainian</option>
            <option value='zh/imagick.blurimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.blurimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::blurImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::blurImage</span> &mdash; <span class="dc-title">Adds blur filter to image</span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="imagick.radialblurimage.php" class="function" rel="rdfs-seeAlso">Imagick::radialBlurImage()</a> - Radial blurs an image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/blurimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.blurimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.blurimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.blurimage.php">＋<small>add a note</small></a></span>
