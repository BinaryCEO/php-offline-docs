...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightMergeContiguous - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightmergecontiguous.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightmergecontiguous.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightmergecontiguous.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightmaxanalyzedchars.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightquery.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightmergecontiguous.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightmergecontiguous.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightmergecontiguous.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightmergecontiguous.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightmergecontiguous.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightmergecontiguous.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightmergecontiguous.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightmergecontiguous.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightmergecontiguous.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightmergecontiguous.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightmergecontiguous.php" hreflang="zh">
...
<meta name="Description" content="Returns whether or not the collapse contiguous fragments into a single fragment" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightMergeContiguous - Manual" />
<meta name="twitter:description" content="Returns whether or not the collapse contiguous fragments into a single fragment" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightMergeContiguous - Manual" />
<meta itemprop="description" content="Returns whether or not the collapse contiguous fragments into a single fragment" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns whether or not the collapse contiguous fragments into a single fragment" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.gethighlightquery.php">
          SolrQuery::getHighlightQuery &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightmaxanalyzedchars.php">
          &laquo; SolrQuery::getHighlightMaxAnalyzedChars        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightmergecontiguous.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightmergecontiguous.php'>German</option>
            <option value='es/solrquery.gethighlightmergecontiguous.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightmergecontiguous.php'>French</option>
            <option value='it/solrquery.gethighlightmergecontiguous.php'>Italian</option>
            <option value='ja/solrquery.gethighlightmergecontiguous.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightmergecontiguous.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightmergecontiguous.php'>Russian</option>
            <option value='tr/solrquery.gethighlightmergecontiguous.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightmergecontiguous.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightmergecontiguous.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightmergecontiguous" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightMergeContiguous</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightMergeContiguous</span> &mdash; <span class="dc-title">Returns whether or not the collapse contiguous fragments into a single fragment</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightmergecontiguous-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightMergeContiguous</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightmergecontiguous-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightmergecontiguous-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
Returns a boolean on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightmergecontiguous.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightmergecontiguous%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightmergecontiguous&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightmergecontiguous.php">＋<small>add a note</small></a></span>
