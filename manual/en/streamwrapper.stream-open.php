...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/streamwrapper.stream-open.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/streamwrapper.stream-open.php">
 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.stream-open.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.streamwrapper.php">
 <link rel="prev" href="https://www.php.net/manual/en/streamwrapper.stream-metadata.php">
 <link rel="next" href="https://www.php.net/manual/en/streamwrapper.stream-read.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/streamwrapper.stream-open.php' selected="selected">English</option>
            <option value='de/streamwrapper.stream-open.php'>German</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.parse-url.php" class="function" rel="rdfs-seeAlso">parse_url()</a> - Parse a URL and return its components</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/streamwrapper/stream-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fstreamwrapper.stream-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=streamwrapper.stream-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/streamwrapper.stream-open.php">＋<small>add a note</small></a></span>
