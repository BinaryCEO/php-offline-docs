...
<head>
  ...
  <title>PHP: Imagick::setImageFormat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageformat.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageformat.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageformat.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagefilename.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagegamma.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageformat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageformat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageformat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageformat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageformat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageformat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageformat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageformat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageformat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageformat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageformat.php" hreflang="zh">
...
<meta name="Description" content="Sets the format of a particular image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageFormat - Manual" />
<meta name="twitter:description" content="Sets the format of a particular image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageFormat - Manual" />
<meta itemprop="description" content="Sets the format of a particular image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the format of a particular image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimagegamma.php">
          Imagick::setImageGamma &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagefilename.php">
          &laquo; Imagick::setImageFilename        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageformat.php' selected="selected">English</option>
            <option value='de/imagick.setimageformat.php'>German</option>
            <option value='es/imagick.setimageformat.php'>Spanish</option>
            <option value='fr/imagick.setimageformat.php'>French</option>
            <option value='it/imagick.setimageformat.php'>Italian</option>
            <option value='ja/imagick.setimageformat.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageformat.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageformat.php'>Russian</option>
            <option value='tr/imagick.setimageformat.php'>Turkish</option>
            <option value='uk/imagick.setimageformat.php'>Ukrainian</option>
            <option value='zh/imagick.setimageformat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageformat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageFormat</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageFormat</span> &mdash; <span class="dc-title">Sets the format of a particular image</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.setimageformat-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageFormat</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$format</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageformat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageformat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageformat.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">7 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="99458">  <div class="votes">
    <div id="Vu99458">
    <a href="/manual/vote-note.php?id=99458&amp;page=imagick.setimageformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd99458">
    <a href="/manual/vote-note.php?id=99458&amp;page=imagick.setimageformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V99458" title="68% like this...">
    9
    </div>
  </div>
  <a href="#99458" class="name">
  <strong class="user"><em>nathan at crause dot name</em></strong></a><a class="genanchor" href="#99458"> &para;</a><div class="date" title="2010-08-18 09:35"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom99458">
<div class="phpcode"><code><span class="html">For those of you completely confused by the utter lack of documentation for this class (including notes being dropped, probably this one included), the differences between any "setXXX" and "setImageXXX" seems to be entirely dependently on HOW the image was loaded.<br /><br />If the image was loaded at object constructor time, it seems that you use "setXXX" - if you loaded it after the fact (such as via "readImageBlob") then you use "setImageXXX".<br /><br />This is irregular, however. For example:<br /><br /><span class="default">&lt;?php<br />        $image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /><br />        </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setResolution</span><span class="keyword">(</span><span class="default">300</span><span class="keyword">, </span><span class="default">300</span><span class="keyword">);<br />        </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">readImageBlob</span><span class="keyword">(...);<br />        </span><span class="comment">// convert the output to JPEG<br />        </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'jpeg'</span><span class="keyword">);<br />        </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageCompressionQuality</span><span class="keyword">(</span><span class="default">90</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Note that we use "setResolution" not "setImageResolution".</span></code></div>
  </div>
 </div>
  <div class="note" id="79343">  <div class="votes">
    <div id="Vu79343">
    <a href="/manual/vote-note.php?id=79343&amp;page=imagick.setimageformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd79343">
    <a href="/manual/vote-note.php?id=79343&amp;page=imagick.setimageformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V79343" title="60% like this...">
    5
    </div>
  </div>
  <a href="#79343" class="name">
  <strong class="user"><em>optymizer at yahoo dot com</em></strong></a><a class="genanchor" href="#79343"> &para;</a><div class="date" title="2007-11-21 03:09"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom79343">
<div class="phpcode"><code><span class="html">The previous example did not work for me. I received an error that the IMagick object cannot be converted to string.<br /><br />This example uses the IMagick::getImageBlob() method to properly output the contents of the converted image:<br /><br />function getImage($filename)<br />{<br />            $image-&gt;readImage($filename);<br />            $image-&gt;setImageFormat("png");<br />            header("Content-type: image/png");<br />            echo $image-&gt;getImageBlob();<br />}<br /><br />Hope this helps!</span></code></div>
  </div>
 </div>
  <div class="note" id="112572">  <div class="votes">
    <div id="Vu112572">
    <a href="/manual/vote-note.php?id=112572&amp;page=imagick.setimageformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112572">
    <a href="/manual/vote-note.php?id=112572&amp;page=imagick.setimageformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112572" title="62% like this...">
    2
    </div>
  </div>
  <a href="#112572" class="name">
  <strong class="user"><em>layzee dot dk at gmail dot com</em></strong></a><a class="genanchor" href="#112572"> &para;</a><div class="date" title="2013-07-01 06:44"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112572">
<div class="phpcode"><code><span class="html">This method only affects the individual loaded/constructed images.<br /><br />To set the format of the entire object, use the Imagick::setFormat method. E.g. load TIFF files, then use setFormat('pdf') on the Imagick object, then writeImagesFile('foo.pdf') or getImagesBlob().</span></code></div>
  </div>
 </div>
  <div class="note" id="110815">  <div class="votes">
    <div id="Vu110815">
    <a href="/manual/vote-note.php?id=110815&amp;page=imagick.setimageformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110815">
    <a href="/manual/vote-note.php?id=110815&amp;page=imagick.setimageformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110815" title="62% like this...">
    2
    </div>
  </div>
  <a href="#110815" class="name">
  <strong class="user"><em>markus dot s dot schmitz at gmail dot com</em></strong></a><a class="genanchor" href="#110815"> &para;</a><div class="date" title="2012-12-11 01:47"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110815">
<div class="phpcode"><code><span class="html">If you use writeFile or writeFiles without setting the format, it is automatically set according to the file extension used within the parameter of writeFile.</span></code></div>
  </div>
 </div>
  <div class="note" id="89210">  <div class="votes">
    <div id="Vu89210">
    <a href="/manual/vote-note.php?id=89210&amp;page=imagick.setimageformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd89210">
    <a href="/manual/vote-note.php?id=89210&amp;page=imagick.setimageformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V89210" title="55% like this...">
    1
    </div>
  </div>
  <a href="#89210" class="name">
  <strong class="user"><em>andy at live dot nl</em></strong></a><a class="genanchor" href="#89210"> &para;</a><div class="date" title="2009-02-26 06:54"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom89210">
<div class="phpcode"><code><span class="html">I had a problem when using $im-&gt;setImageFormat('jpeg');
<br />Image colors got inverted when i converted pdfs to jpg thumbs.
<br />Had to add $im-&gt;setImageColorspace(255); to solve it.
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="comment">// read page 1
<br /></span><span class="default">$im </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">( </span><span class="string">'test.pdf[ 0]' </span><span class="keyword">);
<br />
<br /></span><span class="comment">// convert to jpg
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageColorspace</span><span class="keyword">(</span><span class="default">255</span><span class="keyword">);
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setCompression</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPRESSION_JPEG</span><span class="keyword">);
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setCompressionQuality</span><span class="keyword">(</span><span class="default">60</span><span class="keyword">);
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'jpeg'</span><span class="keyword">);
<br />
<br /></span><span class="comment">//resize
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">resizeImage</span><span class="keyword">(</span><span class="default">290</span><span class="keyword">, </span><span class="default">375</span><span class="keyword">, </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">FILTER_LANCZOS</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);  
<br />
<br /></span><span class="comment">//write image on server
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'thumb.jpg'</span><span class="keyword">);
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">clear</span><span class="keyword">();
<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">();
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="78350">  <div class="votes">
    <div id="Vu78350">
    <a href="/manual/vote-note.php?id=78350&amp;page=imagick.setimageformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd78350">
    <a href="/manual/vote-note.php?id=78350&amp;page=imagick.setimageformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V78350" title="53% like this...">
    1
    </div>
  </div>
  <a href="#78350" class="name">
  <strong class="user"><em>Devo</em></strong></a><a class="genanchor" href="#78350"> &para;</a><div class="date" title="2007-10-07 08:02"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom78350">
<div class="phpcode"><code><span class="html">A list of formats can be found here: <a href="http://www.imagemagick.org/script/formats.php" rel="nofollow" target="_blank">http://www.imagemagick.org/script/formats.php</a><br /><br />Formats marked with a W can be output to file with writeImage (capabilities depend on your particular installation of course).<br /><br />For example:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// create new imagick object from image.jpg<br /></span><span class="default">$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">( </span><span class="string">"image.jpg" </span><span class="keyword">);<br /><br /></span><span class="comment">// change format to png<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">( </span><span class="string">"png" </span><span class="keyword">);<br /><br /></span><span class="comment">// output the image to the browser as a png<br /></span><span class="default">header</span><span class="keyword">( </span><span class="string">"Content-Type: image/png" </span><span class="keyword">);<br />echo </span><span class="default">$im</span><span class="keyword">;<br /><br /></span><span class="comment">// or you could output the image to a file:<br />//$im-&gt;writeImage( "image.png" );<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="81765">  <div class="votes">
    <div id="Vu81765">
    <a href="/manual/vote-note.php?id=81765&amp;page=imagick.setimageformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd81765">
    <a href="/manual/vote-note.php?id=81765&amp;page=imagick.setimageformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V81765" title="50% like this...">
    0
    </div>
  </div>
  <a href="#81765" class="name">
  <strong class="user"><em>barclay[dot]loftus[at]gmail.com</em></strong></a><a class="genanchor" href="#81765"> &para;</a><div class="date" title="2008-03-12 03:04"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom81765">
<div class="phpcode"><code><span class="html">Another note about image output. For jpeg images, the quality is adjusted by Imagick::setCompressionQuality(). <br /><br /><span class="default">&lt;?php<br />$img</span><span class="keyword">-&gt;</span><span class="default">setCompressionQuality</span><span class="keyword">(</span><span class="default">90</span><span class="keyword">);<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'jpeg'</span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'Content-type: image/jpg'</span><span class="keyword">);<br />echo </span><span class="default">$img</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimageformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageformat.php">＋<small>add a note</small></a></div>
