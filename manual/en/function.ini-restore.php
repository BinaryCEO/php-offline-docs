...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ini-restore.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ini-parse-quantity.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ini-set.php">
...
<meta name="Description" content="Restores the value of a configuration option" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ini_restore - Manual" />
<meta name="twitter:description" content="Restores the value of a configuration option" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ini_restore - Manual" />
<meta itemprop="description" content="Restores the value of a configuration option" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Restores the value of a configuration option" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ini-restore.php' selected="selected">English</option>
            ...
            <option value='ru/function.ini-restore.php'>Russian</option>
 ...
 <div class="refsect1 examples" id="refsect1-function.ini-restore-examples">
  ...
  <p class="para">
   <div class="example" id="example-660">
    <p><strong>Example #1 <span class="function"><strong>ini_restore()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ini-set.php" class="function" rel="rdfs-seeAlso">ini_set()</a> - Sets the value of a configuration option</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/ini-restore.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ini-restore%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ini-restore&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ini-restore.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">If like me you thought ini_restore() would restore to the most recent setting rather than the startup value, you could use this.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">/**<br /> * Executes a function using a custom PHP configuration.<br /> * <br /> * @param array $settings A map&lt;ini setting name, ini setting value&gt;.<br /> * @param callable $doThis The code to execute using the given settings.<br /> * @return mixed Returns the value returned by the given callable.<br /> */<br /></span><span class="keyword">function </span><span class="default">ini_using_do</span><span class="keyword">(array </span><span class="default">$settings</span><span class="keyword">, callable </span><span class="default">$doThis</span><span class="keyword">){<br />    foreach(</span><span class="default">$settings </span><span class="keyword">as </span><span class="default">$name </span><span class="keyword">=&gt; </span><span class="default">$value</span><span class="keyword">){<br />        </span><span class="default">$previousSettings</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">] = </span><span class="default">ini_set</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">, </span><span class="default">$value</span><span class="keyword">);<br />    }<br />    </span><span class="default">$returnValue </span><span class="keyword">= </span><span class="default">$doThis</span><span class="keyword">();<br />    if(isset(</span><span class="default">$previousSettings</span><span class="keyword">)){<br />        foreach(</span><span class="default">$previousSettings </span><span class="keyword">as </span><span class="default">$name </span><span class="keyword">=&gt; </span><span class="default">$value</span><span class="keyword">){<br />            </span><span class="default">ini_set</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">, </span><span class="default">$value</span><span class="keyword">);<br />        }<br />    }<br />    return </span><span class="default">$returnValue</span><span class="keyword">;<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ini-restore&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ini-restore.php">＋<small>add a note</small></a></div>
