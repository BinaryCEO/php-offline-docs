...
<head>
  ...
  <title>PHP: pg_put_line - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-put-line.php">
 <link rel="shorturl" href="https://www.php.net/pg-put-line">
 <link rel="alternate" href="https://www.php.net/pg-put-line" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-prepare.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-query.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-put-line.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-put-line.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-put-line.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-put-line.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-put-line.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-put-line.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-put-line.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-put-line.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-put-line.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-put-line.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-put-line.php" hreflang="zh">
...
<meta name="Description" content="Send a NULL-terminated string to PostgreSQL backend" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_put_line - Manual" />
<meta name="twitter:description" content="Send a NULL-terminated string to PostgreSQL backend" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_put_line - Manual" />
<meta itemprop="description" content="Send a NULL-terminated string to PostgreSQL backend" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Send a NULL-terminated string to PostgreSQL backend" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-query.php">
          pg_query &raquo;
              ...
              <div class="prev">
        <a href="function.pg-prepare.php">
          &laquo; pg_prepare        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-put-line.php' selected="selected">English</option>
            <option value='de/function.pg-put-line.php'>German</option>
            <option value='es/function.pg-put-line.php'>Spanish</option>
            <option value='fr/function.pg-put-line.php'>French</option>
            <option value='it/function.pg-put-line.php'>Italian</option>
            <option value='ja/function.pg-put-line.php'>Japanese</option>
            <option value='pt_BR/function.pg-put-line.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-put-line.php'>Russian</option>
            <option value='tr/function.pg-put-line.php'>Turkish</option>
            <option value='uk/function.pg-put-line.php'>Ukrainian</option>
            <option value='zh/function.pg-put-line.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-put-line" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.pg-put-line-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_put_line</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code><span class="initializer"> = ?</span></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   ...
   is to use <span class="function"><a href="function.pg-copy-from.php" class="function">pg_copy_from()</a></span>.  This is a far simpler 
   interface.
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para"> 
    ...
    sending its data, before issuing <span class="function"><a href="function.pg-end-copy.php" class="function">pg_end_copy()</a></span>.
   </p>
  </p></blockquote>
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="para">
    Use of the <span class="function"><strong>pg_put_line()</strong></span> causes most large object
    operations, including <span class="function"><a href="function.pg-lo-read.php" class="function">pg_lo_read()</a></span> and
    <span class="function"><a href="function.pg-lo-tell.php" class="function">pg_lo_tell()</a></span>, to subsequently fail. You can use
    <span class="function"><a href="function.pg-copy-from.php" class="function">pg_copy_from()</a></span> and <span class="function"><a href="function.pg-copy-to.php" class="function">pg_copy_to()</a></span>
    instead.
   </p>
  </div>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php <br />  $conn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_pconnect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=foo"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"create table bar (a int4, b char(16), d float8)"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"copy bar from stdin"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">pg_put_line</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"3\thello world\t4.5\n"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">pg_put_line</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"4\tgoodbye world\t7.11\n"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">pg_put_line</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"\\.\n"</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">pg_end_copy</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-put-line-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-end-copy.php" class="function" rel="rdfs-seeAlso">pg_end_copy()</a> - Sync with PostgreSQL backend</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-put-line.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-put-line%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-put-line&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-put-line.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="56064">  <div class="votes">
    <div id="Vu56064">
    <a href="/manual/vote-note.php?id=56064&amp;page=function.pg-put-line&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd56064">
    <a href="/manual/vote-note.php?id=56064&amp;page=function.pg-put-line&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V56064" title="75% like this...">
    2
    </div>
  </div>
  <a href="#56064" class="name">
  <strong class="user"><em>kurt at nospam dot milliganshome dot net</em></strong></a><a class="genanchor" href="#56064"> &para;</a><div class="date" title="2005-08-22 09:08"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom56064">
<div class="phpcode"><code><span class="html">This is the function you need if you are running into the infamous "must be superuser to COPY to or from a file" error from postgres.</span></code></div>
  </div>
 </div>
  <div class="note" id="125206">  <div class="votes">
    <div id="Vu125206">
    <a href="/manual/vote-note.php?id=125206&amp;page=function.pg-put-line&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125206">
    <a href="/manual/vote-note.php?id=125206&amp;page=function.pg-put-line&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125206" title="no votes...">
    0
    </div>
  </div>
  <a href="#125206" class="name">
  <strong class="user"><em>smcbride at msn dot com</em></strong></a><a class="genanchor" href="#125206"> &para;</a><div class="date" title="2020-07-25 12:54"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125206">
<div class="phpcode"><code><span class="html">When using this function, don't get bit by using 'literal\tanotherliteral\n' issue by using single quotes vs. double quotes.  "literal\tanotherliteral\n" is not the same.  Many of the functions are impacted on how double quotes treats escape characters different than single quotes.  I forget it all the time.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-put-line&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-put-line.php">＋<small>add a note</small></a></div>
