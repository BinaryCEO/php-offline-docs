...
<head>
  ...
  <title>PHP: ReflectionClassConstant - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.reflectionclassconstant.php">
 <link rel="shorturl" href="https://www.php.net/reflectionclassconstant">
 <link rel="alternate" href="https://www.php.net/reflectionclassconstant" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.reflection.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclassconstant.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.reflectionclassconstant.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.reflectionclassconstant.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.reflectionclassconstant.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.reflectionclassconstant.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.reflectionclassconstant.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.reflectionclassconstant.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.reflectionclassconstant.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.reflectionclassconstant.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.reflectionclassconstant.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.reflectionclassconstant.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.reflectionclassconstant.php" hreflang="zh">
...
<meta name="Description" content="The ReflectionClassConstant class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClassConstant - Manual" />
<meta name="twitter:description" content="The ReflectionClassConstant class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClassConstant - Manual" />
<meta itemprop="description" content="The ReflectionClassConstant class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ReflectionClassConstant class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclassconstant.construct.php">
          ReflectionClassConstant::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.tostring.php">
          &laquo; ReflectionClass::__toString        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.reflectionclassconstant.php' selected="selected">English</option>
            <option value='de/class.reflectionclassconstant.php'>German</option>
            <option value='es/class.reflectionclassconstant.php'>Spanish</option>
            <option value='fr/class.reflectionclassconstant.php'>French</option>
            <option value='it/class.reflectionclassconstant.php'>Italian</option>
            <option value='ja/class.reflectionclassconstant.php'>Japanese</option>
            <option value='pt_BR/class.reflectionclassconstant.php'>Brazilian Portuguese</option>
            <option value='ru/class.reflectionclassconstant.php'>Russian</option>
            <option value='tr/class.reflectionclassconstant.php'>Turkish</option>
            <option value='uk/class.reflectionclassconstant.php'>Ukrainian</option>
            <option value='zh/class.reflectionclassconstant.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.reflectionclassconstant" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="reflectionclassconstant.construct.php">ReflectionClassConstant::__construct</a> — Constructs a ReflectionClassConstant</li><li><a href="reflectionclassconstant.export.php">ReflectionClassConstant::export</a> — Export</li><li><a href="reflectionclassconstant.getattributes.php">ReflectionClassConstant::getAttributes</a> — Gets Attributes</li><li><a href="reflectionclassconstant.getdeclaringclass.php">ReflectionClassConstant::getDeclaringClass</a> — Gets declaring class</li><li><a href="reflectionclassconstant.getdoccomment.php">ReflectionClassConstant::getDocComment</a> — Gets doc comments</li><li><a href="reflectionclassconstant.getmodifiers.php">ReflectionClassConstant::getModifiers</a> — Gets the class constant modifiers</li><li><a href="reflectionclassconstant.getname.php">ReflectionClassConstant::getName</a> — Get name of the constant</li><li><a href="reflectionclassconstant.gettype.php">ReflectionClassConstant::getType</a> — Gets a class constant's type</li><li><a href="reflectionclassconstant.getvalue.php">ReflectionClassConstant::getValue</a> — Gets value</li><li><a href="reflectionclassconstant.hastype.php">ReflectionClassConstant::hasType</a> — Checks if class constant has a type</li><li><a href="reflectionclassconstant.isdeprecated.php">ReflectionClassConstant::isDeprecated</a> — Checks if deprecated</li><li><a href="reflectionclassconstant.isenumcase.php">ReflectionClassConstant::isEnumCase</a> — Checks if class constant is an Enum case</li><li><a href="reflectionclassconstant.isfinal.php">ReflectionClassConstant::isFinal</a> — Checks if class constant is final</li><li><a href="reflectionclassconstant.isprivate.php">ReflectionClassConstant::isPrivate</a> — Checks if class constant is private</li><li><a href="reflectionclassconstant.isprotected.php">ReflectionClassConstant::isProtected</a> — Checks if class constant is protected</li><li><a href="reflectionclassconstant.ispublic.php">ReflectionClassConstant::isPublic</a> — Checks if class constant is public</li><li><a href="reflectionclassconstant.tostring.php">ReflectionClassConstant::__toString</a> — Returns the string representation of the ReflectionClassConstant object</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclassconstant.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.reflectionclassconstant%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.reflectionclassconstant&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionclassconstant.php">＋<small>add a note</small></a></span>
