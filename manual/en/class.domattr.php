...
<head>
  ...
  <title>PHP: DOMAttr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.domattr.php">
 <link rel="shorturl" href="https://www.php.net/domattr">
 <link rel="alternate" href="https://www.php.net/domattr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/dom.examples.php">
 <link rel="next" href="https://www.php.net/manual/en/domattr.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.domattr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.domattr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.domattr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.domattr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.domattr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.domattr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.domattr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.domattr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.domattr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.domattr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.domattr.php" hreflang="zh">
...
<meta name="Description" content="The DOMAttr class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMAttr - Manual" />
<meta name="twitter:description" content="The DOMAttr class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMAttr - Manual" />
<meta itemprop="description" content="The DOMAttr class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DOMAttr class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="domattr.construct.php">
          DOMAttr::__construct &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.domattr.php' selected="selected">English</option>
            <option value='de/class.domattr.php'>German</option>
            <option value='es/class.domattr.php'>Spanish</option>
            <option value='fr/class.domattr.php'>French</option>
            <option value='it/class.domattr.php'>Italian</option>
            <option value='ja/class.domattr.php'>Japanese</option>
            <option value='pt_BR/class.domattr.php'>Brazilian Portuguese</option>
            <option value='ru/class.domattr.php'>Russian</option>
            <option value='tr/class.domattr.php'>Turkish</option>
            <option value='uk/class.domattr.php'>Ukrainian</option>
            <option value='zh/class.domattr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.domattr" class="reference">
 <h1 class="title">The <span class="classname"><a href="class.domattr.php" class="classname">DOMAttr</a></span> class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>
  ...
  <div class="section" id="domattr.intro">
   ...
   <p class="para">
    <span class="classname"><strong class="classname">DOMAttr</strong></span> represents an attribute in the 
    <span class="classname"><a href="class.domelement.php" class="classname">DOMElement</a></span> object.
   </p>
  </div>
  ...
  <div class="section" id="domattr.synopsis">
   ...
   <div class="classsynopsis"><div class="classsynopsisinfo">
     ...
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">DOMAttr</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.domattr.php#domattr.props.name">$<var class="varname">name</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span>
      <var class="varname"><a href="class.domattr.php#domattr.props.specified">$<var class="varname">specified</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.domattr.php#domattr.props.value">$<var class="varname">value</var></a></var>;</div>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type">?</span><span class="type"><span class="type"><a href="class.domelement.php" class="type DOMElement">DOMElement</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.domattr.php#domattr.props.ownerelement">$<var class="varname">ownerElement</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span>
      <var class="varname"><a href="class.domattr.php#domattr.props.schematypeinfo">$<var class="varname">schemaTypeInfo</var></a></var>;</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="domattr.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code><span class="initializer"> = &quot;&quot;</span></span>)</div>

    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domattr.isid.php" class="methodname">isId</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="domnode.wakeup.php" class="methodname">DOMNode::__wakeup</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="domattr.props">
   ...
   <dl>
     ...
     <dt id="domattr.props.name"><var class="varname">name</var></dt>
     <dd>
      <p class="para">The name of the attribute.</p>
     </dd>
    
    
     <dt id="domattr.props.ownerelement"><var class="varname">ownerElement</var></dt>
     <dd>
      <p class="para">The element which contains the attribute or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.</p>
     </dd>
    
    
     <dt id="domattr.props.schematypeinfo"><var class="varname">schemaTypeInfo</var></dt>
     <dd>
      <p class="para">Not implemented yet, always is <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.</p>
     </dd>
    
    
     <dt id="domattr.props.specified"><var class="varname">specified</var></dt>
     <dd>
      <p class="para">Not implemented yet, always is <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>.</p>
     </dd>
    
    
     <dt id="domattr.props.value"><var class="varname">value</var></dt>
     <dd>
      <p class="para">The value of the attribute.</p>
      <blockquote class="note"><p><strong class="note">Note</strong>: 
       <p class="para">
        Note, XML entities are expanded upon setting a value.
        Thus the <code class="literal">&amp;</code> character has a special meaning.
        Setting <var class="varname">value</var> to itself will fail when <var class="varname">value</var> contains an <code class="literal">&amp;</code>.
        To avoid entity expansion, use <span class="methodname"><a href="domelement.setattribute.php" class="methodname">DOMElement::setAttribute()</a></span> instead.
       </p>
      </p></blockquote>
     </dd>
  ...
  <div class="section">
   ...
   <p class="para">
    <ul class="simplelist">
     <li><a href="http://www.w3.org/TR/2003/WD-DOM-Level-3-Core-20030226/DOM3-Core.html#core-ID-637646024" class="link external">&raquo;&nbsp;W3C specification of Attr</a></li>
    </ul>
   </p>
  </div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="domattr.construct.php">DOMAttr::__construct</a> — Creates a new DOMAttr object</li><li><a href="domattr.isid.php">DOMAttr::isId</a> — Checks if attribute is a defined ID</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domattr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.domattr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.domattr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.domattr.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116291">  <div class="votes">
    <div id="Vu116291">
    <a href="/manual/vote-note.php?id=116291&amp;page=class.domattr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116291">
    <a href="/manual/vote-note.php?id=116291&amp;page=class.domattr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116291" title="61% like this...">
    3
    </div>
  </div>
  <a href="#116291" class="name">
  <strong class="user"><em>greubel at nkey dot de</em></strong></a><a class="genanchor" href="#116291"> &para;</a><div class="date" title="2014-12-06 03:04"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116291">
<div class="phpcode"><code><span class="html">Please take care on debugging DOMAttr related code. This will cause an E_WARNING that retrieving schemaTypeInfo attribute is not implemented yet. An IDE like Eclipse will inspect the object and its member elements. In conjunction with registered error handlers, which will translate the E_WARNING into Exception your debugging session will end unexpectedly. This has caused me some trouble while debugging my PHPUnit test case in eclipse using "Makegood" plugin.<br /><br />A possible workarround is to deactivate the error handling during debugging using error_reporting(0). Remove the statement after finishing your debugging session.<br /><br />Notable ticket in Bugtracker: <a href="https://bugs.php.net/bug.php?id=61858" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=61858</a><br />And a xdebug tracker ticket: <a href="http://bugs.xdebug.org/view.php?id=910" rel="nofollow" target="_blank">http://bugs.xdebug.org/view.php?id=910</a></span></code></div>
  </div>
 </div>
  <div class="note" id="89791">  <div class="votes">
    <div id="Vu89791">
    <a href="/manual/vote-note.php?id=89791&amp;page=class.domattr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd89791">
    <a href="/manual/vote-note.php?id=89791&amp;page=class.domattr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V89791" title="58% like this...">
    2
    </div>
  </div>
  <a href="#89791" class="name">
  <strong class="user"><em>chregu at php dot net</em></strong></a><a class="genanchor" href="#89791"> &para;</a><div class="date" title="2009-03-23 11:20"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom89791">
<div class="phpcode"><code><span class="html">See also the properties from the inherited class DOMNode ( <a href="http://php.net/manual/en/class.domnode.php" rel="nofollow" target="_blank">http://php.net/manual/en/class.domnode.php</a> ), eg. namespaceURI, prefix, localName, etc, especially if you have to deal with namespaced attributes</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.domattr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.domattr.php">＋<small>add a note</small></a></div>
