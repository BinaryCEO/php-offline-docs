...
<head>
  ...
  <title>PHP: fann_train_on_data - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-train-on-data.php">
 <link rel="shorturl" href="https://www.php.net/fann-train-on-data">
 <link rel="alternate" href="https://www.php.net/fann-train-on-data" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-train-epoch.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-train-on-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-train-on-data.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-train-on-data.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-train-on-data.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-train-on-data.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-train-on-data.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-train-on-data.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-train-on-data.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-train-on-data.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-train-on-data.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-train-on-data.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-train-on-data.php" hreflang="zh">
...
<meta name="Description" content="Trains on an entire dataset for a period of time" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_train_on_data - Manual" />
<meta name="twitter:description" content="Trains on an entire dataset for a period of time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_train_on_data - Manual" />
<meta itemprop="description" content="Trains on an entire dataset for a period of time" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Trains on an entire dataset for a period of time" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-train-on-file.php">
          fann_train_on_file &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-train-epoch.php">
          &laquo; fann_train_epoch        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-train-on-data.php' selected="selected">English</option>
            <option value='de/function.fann-train-on-data.php'>German</option>
            <option value='es/function.fann-train-on-data.php'>Spanish</option>
            <option value='fr/function.fann-train-on-data.php'>French</option>
            <option value='it/function.fann-train-on-data.php'>Italian</option>
            <option value='ja/function.fann-train-on-data.php'>Japanese</option>
            <option value='pt_BR/function.fann-train-on-data.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-train-on-data.php'>Russian</option>
            <option value='tr/function.fann-train-on-data.php'>Turkish</option>
            <option value='uk/function.fann-train-on-data.php'>Ukrainian</option>
            <option value='zh/function.fann-train-on-data.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-train-on-data" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_train_on_data</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_train_on_data</span> &mdash; <span class="dc-title">Trains on an entire dataset for a period of time</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-train-on-data-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_train_on_data</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$data</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$max_epochs</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$epochs_between_reports</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$desired_error</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-train-on-data-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-train-on-data-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-train-on-data-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-set-callback.php" class="function" rel="rdfs-seeAlso">fann_set_callback()</a> - Sets the callback function for use during training</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-train-on-data.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-train-on-data%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-train-on-data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-train-on-data.php">＋<small>add a note</small></a></span>
