...
<head>
  ...
  <title>PHP: fann_get_rprop_delta_max - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-rprop-delta-max.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-rprop-delta-max">
 <link rel="alternate" href="https://www.php.net/fann-get-rprop-delta-max" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-rprop-decrease-factor.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-rprop-delta-min.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-rprop-delta-max.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-rprop-delta-max.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-rprop-delta-max.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-rprop-delta-max.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-rprop-delta-max.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-rprop-delta-max.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-rprop-delta-max.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-rprop-delta-max.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-rprop-delta-max.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-rprop-delta-max.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-rprop-delta-max.php" hreflang="zh">
...
<meta name="Description" content="Returns the maximum step-size" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_rprop_delta_max - Manual" />
<meta name="twitter:description" content="Returns the maximum step-size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_rprop_delta_max - Manual" />
<meta itemprop="description" content="Returns the maximum step-size" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the maximum step-size" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-get-rprop-delta-min.php">
          fann_get_rprop_delta_min &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-rprop-decrease-factor.php">
          &laquo; fann_get_rprop_decrease_factor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-rprop-delta-max.php' selected="selected">English</option>
            <option value='de/function.fann-get-rprop-delta-max.php'>German</option>
            <option value='es/function.fann-get-rprop-delta-max.php'>Spanish</option>
            <option value='fr/function.fann-get-rprop-delta-max.php'>French</option>
            <option value='it/function.fann-get-rprop-delta-max.php'>Italian</option>
            <option value='ja/function.fann-get-rprop-delta-max.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-rprop-delta-max.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-rprop-delta-max.php'>Russian</option>
            <option value='tr/function.fann-get-rprop-delta-max.php'>Turkish</option>
            <option value='uk/function.fann-get-rprop-delta-max.php'>Ukrainian</option>
            <option value='zh/function.fann-get-rprop-delta-max.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-rprop-delta-max" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_get_rprop_delta_max</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_get_rprop_delta_max</span> &mdash; <span class="dc-title">Returns the maximum step-size</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-get-rprop-delta-max-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_get_rprop_delta_max</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-get-rprop-delta-max-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-rprop-delta-max-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The maximum step-size, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fann-get-rprop-delta-max-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-set-rprop-delta-max.php" class="function" rel="rdfs-seeAlso">fann_set_rprop_delta_max()</a> - Sets the maximum step-size</span></li>
    <li><span class="function"><a href="function.fann-get-rprop-delta-min.php" class="function" rel="rdfs-seeAlso">fann_get_rprop_delta_min()</a> - Returns the minimum step-size</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-rprop-delta-max.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-rprop-delta-max%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-rprop-delta-max&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-rprop-delta-max.php">＋<small>add a note</small></a></span>
