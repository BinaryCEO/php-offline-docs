...
<head>
  ...
  <title>PHP: User-Level Output Buffers - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/outcontrol.user-level-output-buffers.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/outcontrol.user-level-output-buffers.php">
 <link rel="alternate" href="https://www.php.net/manual/en/outcontrol.user-level-output-buffers.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.outcontrol.php">
 <link rel="prev" href="https://www.php.net/manual/en/outcontrol.flushing-system-buffers.php">
 <link rel="next" href="https://www.php.net/manual/en/outcontrol.what-output-is-buffered.php">

 <link rel="alternate" href="https://www.php.net/manual/en/outcontrol.user-level-output-buffers.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/outcontrol.user-level-output-buffers.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/outcontrol.user-level-output-buffers.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/outcontrol.user-level-output-buffers.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/outcontrol.user-level-output-buffers.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/outcontrol.user-level-output-buffers.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/outcontrol.user-level-output-buffers.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/outcontrol.user-level-output-buffers.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/outcontrol.user-level-output-buffers.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/outcontrol.user-level-output-buffers.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/outcontrol.user-level-output-buffers.php" hreflang="zh">
...
<meta name="Description" content="User-Level Output Buffers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: User-Level Output Buffers - Manual" />
<meta name="twitter:description" content="User-Level Output Buffers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: User-Level Output Buffers - Manual" />
<meta itemprop="description" content="User-Level Output Buffers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="User-Level Output Buffers" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="outcontrol.what-output-is-buffered.php">
          What Output Is Buffered? &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="outcontrol.flushing-system-buffers.php">
          &laquo; Flushing System Buffers        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/outcontrol.user-level-output-buffers.php' selected="selected">English</option>
            <option value='de/outcontrol.user-level-output-buffers.php'>German</option>
            <option value='es/outcontrol.user-level-output-buffers.php'>Spanish</option>
            <option value='fr/outcontrol.user-level-output-buffers.php'>French</option>
            <option value='it/outcontrol.user-level-output-buffers.php'>Italian</option>
            <option value='ja/outcontrol.user-level-output-buffers.php'>Japanese</option>
            <option value='pt_BR/outcontrol.user-level-output-buffers.php'>Brazilian Portuguese</option>
            <option value='ru/outcontrol.user-level-output-buffers.php'>Russian</option>
            <option value='tr/outcontrol.user-level-output-buffers.php'>Turkish</option>
            <option value='uk/outcontrol.user-level-output-buffers.php'>Ukrainian</option>
            <option value='zh/outcontrol.user-level-output-buffers.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="outcontrol.user-level-output-buffers" class="chapter">
   ...
   <span class="simpara">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Foutcontrol.user-level-output-buffers%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=outcontrol.user-level-output-buffers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/outcontrol.user-level-output-buffers.php">＋<small>add a note</small></a></span>
