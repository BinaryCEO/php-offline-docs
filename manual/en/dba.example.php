...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/dba.example.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/dba.example.php">
 <link rel="alternate" href="https://www.php.net/manual/en/dba.example.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/dba.examples.php">
 <link rel="prev" href="https://www.php.net/manual/en/dba.examples.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dba-connection.php">

 <link rel="alternate" href="https://www.php.net/manual/en/dba.example.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/dba.example.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/dba.example.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/dba.example.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/dba.example.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/dba.example.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/dba.example.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/dba.example.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/dba.example.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/dba.example.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/dba.example.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.dba-connection.php">
          Dba\Connection &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="dba.examples.php">
          &laquo; Examples        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.database.php'>Database Extensions</a></li>      <li><a href='refs.database.abstract.php'>Abstraction Layers</a></li>      <li><a href='book.dba.php'>DBA</a></li>      <li><a href='dba.examples.php'>Examples</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/dba.example.php' selected="selected">English</option>
            <option value='de/dba.example.php'>German</option>
            <option value='es/dba.example.php'>Spanish</option>
            <option value='fr/dba.example.php'>French</option>
            <option value='it/dba.example.php'>Italian</option>
            <option value='ja/dba.example.php'>Japanese</option>
            <option value='pt_BR/dba.example.php'>Brazilian Portuguese</option>
            <option value='ru/dba.example.php'>Russian</option>
            <option value='tr/dba.example.php'>Turkish</option>
            <option value='uk/dba.example.php'>Ukrainian</option>
            <option value='zh/dba.example.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="dba.example" class="section">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// ...open database...<br /><br /></span><span style="color: #0000BB">$key </span><span style="color: #007700">= </span><span style="color: #0000BB">dba_firstkey</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">);<br /><br />while (</span><span style="color: #0000BB">$key </span><span style="color: #007700">!== </span><span style="color: #0000BB">false</span><span style="color: #007700">) {<br />    if (</span><span style="color: #0000BB">true</span><span style="color: #007700">) {          </span><span style="color: #FF8000">// remember the key to perform some action later<br />        </span><span style="color: #0000BB">$handle_later</span><span style="color: #007700">[] = </span><span style="color: #0000BB">$key</span><span style="color: #007700">;<br />    }<br />    </span><span style="color: #0000BB">$key </span><span style="color: #007700">= </span><span style="color: #0000BB">dba_nextkey</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">);<br />}<br /><br />foreach (</span><span style="color: #0000BB">$handle_later </span><span style="color: #007700">as </span><span style="color: #0000BB">$val</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">dba_delete</span><span style="color: #007700">(</span><span style="color: #0000BB">$val</span><span style="color: #007700">, </span><span style="color: #0000BB">$id</span><span style="color: #007700">);<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dba/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdba.example%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=dba.example&amp;repo=en&amp;redirect=https://www.php.net/manual/en/dba.example.php">＋<small>add a note</small></a></span>
 ...
 <div class="note">There are no user contributed notes for this page.</div></section>    </section><!-- layout-content -->
        ...
        <ul class='parent-menu-list'>
                                    <li>
                <a href="dba.examples.php">Examples</a>

                                    <ul class='child-menu-list'>

                                                <li class="current">
                            <a href="dba.example.php" title="Basic usage">Basic usage</a>
                        </li>
