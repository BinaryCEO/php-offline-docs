...
<head>
  ...
  <title>PHP: openssl_pkey_free - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-pkey-free.php">
 <link rel="shorturl" href="https://www.php.net/openssl-pkey-free">
 <link rel="alternate" href="https://www.php.net/openssl-pkey-free" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-pkey-export-to-file.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-pkey-get-details.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-pkey-free.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-pkey-free.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-pkey-free.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-pkey-free.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-pkey-free.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-pkey-free.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-pkey-free.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-pkey-free.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-pkey-free.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-pkey-free.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-pkey-free.php" hreflang="zh">
...
<meta name="Description" content="Frees a private key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_pkey_free - Manual" />
<meta name="twitter:description" content="Frees a private key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_pkey_free - Manual" />
<meta itemprop="description" content="Frees a private key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Frees a private key" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-pkey-get-details.php">
          openssl_pkey_get_details &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-pkey-export-to-file.php">
          &laquo; openssl_pkey_export_to_file        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-pkey-free.php' selected="selected">English</option>
            <option value='de/function.openssl-pkey-free.php'>German</option>
            <option value='es/function.openssl-pkey-free.php'>Spanish</option>
            <option value='fr/function.openssl-pkey-free.php'>French</option>
            <option value='it/function.openssl-pkey-free.php'>Italian</option>
            <option value='ja/function.openssl-pkey-free.php'>Japanese</option>
            <option value='pt_BR/function.openssl-pkey-free.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-pkey-free.php'>Russian</option>
            <option value='tr/function.openssl-pkey-free.php'>Turkish</option>
            <option value='uk/function.openssl-pkey-free.php'>Ukrainian</option>
            <option value='zh/function.openssl-pkey-free.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-pkey-free" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_pkey_free</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_pkey_free</span> &mdash; <span class="dc-title">Frees a private key</span></p>

 </div>

 <div id="function.openssl-pkey-free-refsynopsisdiv">
    ...
    <tbody class="tbody">
     ...
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-pkey-free.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-pkey-free%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-pkey-free&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkey-free.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125655">  <div class="votes">
    <div id="Vu125655">
    <a href="/manual/vote-note.php?id=125655&amp;page=function.openssl-pkey-free&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125655">
    <a href="/manual/vote-note.php?id=125655&amp;page=function.openssl-pkey-free&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125655" title="40% like this...">
    -2
    </div>
  </div>
  <a href="#125655" class="name">
  <strong class="user"><em>suconghou at gmail dot com</em></strong></a><a class="genanchor" href="#125655"> &para;</a><div class="date" title="2021-01-05 08:31"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125655">
<div class="phpcode"><code><span class="html">PHP 8 deprecates openssl_free_key (actually openssl_pkey_free which it aliases) and automatically destroys the key instance when it goes out of scope.</span></code></div>
  </div>
 </div>
  <div class="note" id="124042">  <div class="votes">
    <div id="Vu124042">
    <a href="/manual/vote-note.php?id=124042&amp;page=function.openssl-pkey-free&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124042">
    <a href="/manual/vote-note.php?id=124042&amp;page=function.openssl-pkey-free&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124042" title="20% like this...">
    -3
    </div>
  </div>
  <a href="#124042" class="name">
  <strong class="user"><em>djmaze</em></strong></a><a class="genanchor" href="#124042"> &para;</a><div class="date" title="2019-07-16 08:51"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom124042">
<div class="phpcode"><code><span class="html">This function also frees public key resources as received with openssl_pkey_get_public().<br /><br />Manual above should say: "Frees a pkey resource"</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-pkey-free&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkey-free.php">＋<small>add a note</small></a></div>
