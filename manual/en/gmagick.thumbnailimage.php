...
<head>
  ...
  <title>PHP: Gmagick::thumbnailimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.thumbnailimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.thumbnailimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.thumbnailimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.swirlimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.trimimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.thumbnailimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.thumbnailimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.thumbnailimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.thumbnailimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.thumbnailimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.thumbnailimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.thumbnailimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.thumbnailimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.thumbnailimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.thumbnailimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.thumbnailimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::thumbnailimage - Manual" />
<meta name="twitter:description" content="Changes the size of an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::thumbnailimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.trimimage.php">
          Gmagick::trimimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.swirlimage.php">
          &laquo; Gmagick::swirlimage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.thumbnailimage.php' selected="selected">English</option>
            <option value='de/gmagick.thumbnailimage.php'>German</option>
            <option value='es/gmagick.thumbnailimage.php'>Spanish</option>
            <option value='fr/gmagick.thumbnailimage.php'>French</option>
            <option value='it/gmagick.thumbnailimage.php'>Italian</option>
            <option value='ja/gmagick.thumbnailimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.thumbnailimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.thumbnailimage.php'>Russian</option>
            <option value='tr/gmagick.thumbnailimage.php'>Turkish</option>
            <option value='uk/gmagick.thumbnailimage.php'>Ukrainian</option>
            <option value='zh/gmagick.thumbnailimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.thumbnailimage" class="refentry">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/thumbnailimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.thumbnailimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.thumbnailimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.thumbnailimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115231">  <div class="votes">
    <div id="Vu115231">
    <a href="/manual/vote-note.php?id=115231&amp;page=gmagick.thumbnailimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115231">
    <a href="/manual/vote-note.php?id=115231&amp;page=gmagick.thumbnailimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115231" title="0% like this...">
    -3
    </div>
  </div>
  <a href="#115231" class="name">
  <strong class="user"><em>isius</em></strong></a><a class="genanchor" href="#115231"> &para;</a><div class="date" title="2014-06-17 03:21"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115231">
<div class="phpcode"><code><span class="html">It's not mentioned, but this function removes all profiles, etcetera from the image.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gmagick.thumbnailimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.thumbnailimage.php">＋<small>add a note</small></a></div>
