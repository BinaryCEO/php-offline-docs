...
<head>
  ...
  <title>PHP: eio_lstat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-lstat.php">
 <link rel="shorturl" href="https://www.php.net/eio-lstat">
 <link rel="alternate" href="https://www.php.net/eio-lstat" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-link.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-mkdir.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-lstat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-lstat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-lstat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-lstat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-lstat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-lstat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-lstat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-lstat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-lstat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-lstat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-lstat.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: eio_lstat - Manual" />
<meta name="twitter:description" content="Get file status" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_lstat - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-mkdir.php">
          eio_mkdir &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-link.php">
          &laquo; eio_link        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-lstat.php' selected="selected">English</option>
            <option value='de/function.eio-lstat.php'>German</option>
            <option value='es/function.eio-lstat.php'>Spanish</option>
            <option value='fr/function.eio-lstat.php'>French</option>
            <option value='it/function.eio-lstat.php'>Italian</option>
            <option value='ja/function.eio-lstat.php'>Japanese</option>
            <option value='pt_BR/function.eio-lstat.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-lstat.php'>Russian</option>
            <option value='tr/function.eio-lstat.php'>Turkish</option>
            <option value='uk/function.eio-lstat.php'>Ukrainian</option>
            <option value='zh/function.eio-lstat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-lstat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_lstat</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_lstat</span> &mdash; <span class="dc-title">Get file status</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.eio-lstat-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_lstat</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>eio_lstat()</strong></span> returns file status information in
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-lstat-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>eio_lstat()</strong></span> returns request resource on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.eio-lstat-examples">
  ...
  <div class="example" id="example-3515">
   <p><strong>Example #1 <span class="function"><strong>eio_lstat()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">string(9) &quot;eio_lstat&quot;
array(12) {
 [&quot;st_dev&quot;]=&gt;
  int(2050)
  [&quot;st_ino&quot;]=&gt;
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.eio-fstat.php" class="function" rel="rdfs-seeAlso">eio_fstat()</a> - Get file status</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-lstat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-lstat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-lstat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-lstat.php">＋<small>add a note</small></a></span>
