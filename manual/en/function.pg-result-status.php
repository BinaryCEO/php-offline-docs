...
<head>
  ...
  <title>PHP: pg_result_status - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-result-status.php">
 <link rel="shorturl" href="https://www.php.net/pg-result-status">
 <link rel="alternate" href="https://www.php.net/pg-result-status" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-result-seek.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-select.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-result-status.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-result-status.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-result-status.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-result-status.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-result-status.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-result-status.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-result-status.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-result-status.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-result-status.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-result-status.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-result-status.php" hreflang="zh">
...
<meta name="Description" content="Get status of query result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_result_status - Manual" />
<meta name="twitter:description" content="Get status of query result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_result_status - Manual" />
<meta itemprop="description" content="Get status of query result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get status of query result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-select.php">
          pg_select &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-result-seek.php">
          &laquo; pg_result_seek        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-result-status.php' selected="selected">English</option>
            <option value='de/function.pg-result-status.php'>German</option>
            <option value='es/function.pg-result-status.php'>Spanish</option>
            <option value='fr/function.pg-result-status.php'>French</option>
            <option value='it/function.pg-result-status.php'>Italian</option>
            <option value='ja/function.pg-result-status.php'>Japanese</option>
            <option value='pt_BR/function.pg-result-status.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-result-status.php'>Russian</option>
            <option value='tr/function.pg-result-status.php'>Turkish</option>
            <option value='uk/function.pg-result-status.php'>Ukrainian</option>
            <option value='zh/function.pg-result-status.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-result-status" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-connection-status.php" class="function" rel="rdfs-seeAlso">pg_connection_status()</a> - Get connection status</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-result-status.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-result-status%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-result-status&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-result-status.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114507">  <div class="votes">
    <div id="Vu114507">
    <a href="/manual/vote-note.php?id=114507&amp;page=function.pg-result-status&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114507">
    <a href="/manual/vote-note.php?id=114507&amp;page=function.pg-result-status&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114507" title="100% like this...">
    2
    </div>
  </div>
  <a href="#114507" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#114507"> &para;</a><div class="date" title="2014-03-01 06:44"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114507">
<div class="phpcode"><code><span class="html">This function is useful it may not return a  full non fatal error but you want to see if the query completes anyway.<br /><br />example<br /><br /><span class="default">&lt;?PHP<br /></span><span class="comment">//connect to pg database<br />// create PGSQL<br /><br /></span><span class="default">$PGSTAT </span><span class="keyword">= </span><span class="default">pg_result_status</span><span class="keyword">(</span><span class="default">$PGSQL</span><span class="keyword">);</span><span class="comment">//defaults to long<br /><br />//And run it through a check for example<br /><br /></span><span class="keyword">if((</span><span class="default">$PGSTAT </span><span class="keyword">== </span><span class="default">1</span><span class="keyword">) || (</span><span class="default">$PGSTAT </span><span class="keyword">== </span><span class="default">2</span><span class="keyword">)){<br /> </span><span class="comment">// for query results;<br /></span><span class="keyword">}else if((</span><span class="default">$PGSTAT </span><span class="keyword">== </span><span class="default">3</span><span class="keyword">) || (</span><span class="default">$PGSTAT </span><span class="keyword">== </span><span class="default">4</span><span class="keyword">)){<br /> </span><span class="comment">// for copy results;<br /></span><span class="keyword">}<br />if((</span><span class="default">$PGSTAT </span><span class="keyword">!= </span><span class="default">0</span><span class="keyword">) &amp;&amp; (</span><span class="default">$PGSTAT </span><span class="keyword">!= </span><span class="default">5</span><span class="keyword">) &amp;&amp; (</span><span class="default">$PGSTAT </span><span class="keyword">!= </span><span class="default">6</span><span class="keyword">) &amp;&amp; (</span><span class="default">$PGSTAT </span><span class="keyword">!= </span><span class="default">7</span><span class="keyword">)){<br /></span><span class="comment">// your code;<br /></span><span class="keyword">}else{<br /> </span><span class="comment">// $ERRORS codes;<br /></span><span class="keyword">}<br /></span><span class="comment">// This is worked the best for me so far  I tried using <br />// The command tag and I seem to still get an numeric result<br />//example<br />//$PGSTAT = pg_result_status($PGSQL, PGSQL_COMMAND_OK);<br />// got something like tuples ok so I recommend just use default long<br /></span><span class="default">?&gt;<br /></span>or use what ever condition check you feel fit</span></code></div>
  </div>
 </div>
  <div class="note" id="26050">  <div class="votes">
    <div id="Vu26050">
    <a href="/manual/vote-note.php?id=26050&amp;page=function.pg-result-status&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd26050">
    <a href="/manual/vote-note.php?id=26050&amp;page=function.pg-result-status&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V26050" title="54% like this...">
    1
    </div>
  </div>
  <a href="#26050" class="name">
  <strong class="user"><em>romix at gmx dot de</em></strong></a><a class="genanchor" href="#26050"> &para;</a><div class="date" title="2002-10-16 06:29"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom26050">
<div class="phpcode"><code><span class="html">0 = PGSQL_EMPTY_QUERY<br />1 = PGSQL_COMMAND_OK<br />2 = PGSQL_TUPLES_OK<br />3 = PGSQL_COPY_TO<br />4 = PGSQL_COPY_FROM<br />5 = PGSQL_BAD_RESPONSE<br />6 = PGSQL_NONFATAL_ERROR<br />7 = PGSQL_FATAL_ERROR</span></code></div>
  </div>
 </div>
  <div class="note" id="53675">  <div class="votes">
    <div id="Vu53675">
    <a href="/manual/vote-note.php?id=53675&amp;page=function.pg-result-status&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd53675">
    <a href="/manual/vote-note.php?id=53675&amp;page=function.pg-result-status&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V53675" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#53675" class="name">
  <strong class="user"><em>Meej Vaj</em></strong></a><a class="genanchor" href="#53675"> &para;</a><div class="date" title="2005-06-08 06:45"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom53675">
<div class="phpcode"><code><span class="html">If on "accident" your program passes pg_result_status a variable that is NOT a actual pg resource, it will return an empty string.<br />(This is important to know if you want to make sure a pg resource is "good" before attempting some operation on it).</span></code></div>
  </div>
 </div>
  <div class="note" id="111274">  <div class="votes">
    <div id="Vu111274">
    <a href="/manual/vote-note.php?id=111274&amp;page=function.pg-result-status&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111274">
    <a href="/manual/vote-note.php?id=111274&amp;page=function.pg-result-status&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111274" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#111274" class="name">
  <strong class="user"><em>dean at deansas dot org</em></strong></a><a class="genanchor" href="#111274"> &para;</a><div class="date" title="2013-02-01 03:50"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111274">
<div class="phpcode"><code><span class="html">The postgres docs say that PHP should never be able to return PGRES_NONFATAL_ERROR<br /><br />"A result of status PGRES_NONFATAL_ERROR will never be returned directly by PQexec or other query execution functions" <a href="http://www.postgresql.org/docs/current/static/libpq-exec.html" rel="nofollow" target="_blank">http://www.postgresql.org/docs/current/static/libpq-exec.html</a><br /><br />Therefore you cannot use this function to check if this query produced a notice.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-result-status&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-result-status.php">＋<small>add a note</small></a></div>
