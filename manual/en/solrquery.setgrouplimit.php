...
<head>
  ...
  <title>PHP: SolrQuery::setGroupLimit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setgrouplimit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setgrouplimit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgrouplimit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setgroupformat.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setgroupmain.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgrouplimit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setgrouplimit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setgrouplimit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setgrouplimit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setgrouplimit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setgrouplimit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setgrouplimit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setgrouplimit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setgrouplimit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setgrouplimit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setgrouplimit.php" hreflang="zh">
...
<meta name="Description" content="Specifies the number of results to return for each group. The server default value is 1" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setGroupLimit - Manual" />
<meta name="twitter:description" content="Specifies the number of results to return for each group. The server default value is 1" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setGroupLimit - Manual" />
<meta itemprop="description" content="Specifies the number of results to return for each group. The server default value is 1" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the number of results to return for each group. The server default value is 1" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setgroupmain.php">
          SolrQuery::setGroupMain &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setgroupformat.php">
          &laquo; SolrQuery::setGroupFormat        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setgrouplimit.php' selected="selected">English</option>
            <option value='de/solrquery.setgrouplimit.php'>German</option>
            <option value='es/solrquery.setgrouplimit.php'>Spanish</option>
            <option value='fr/solrquery.setgrouplimit.php'>French</option>
            <option value='it/solrquery.setgrouplimit.php'>Italian</option>
            <option value='ja/solrquery.setgrouplimit.php'>Japanese</option>
            <option value='pt_BR/solrquery.setgrouplimit.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setgrouplimit.php'>Russian</option>
            <option value='tr/solrquery.setgrouplimit.php'>Turkish</option>
            <option value='uk/solrquery.setgrouplimit.php'>Ukrainian</option>
            <option value='zh/solrquery.setgrouplimit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setgrouplimit" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-solrquery.setgrouplimit-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setGroupLimit</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.setgroupcachepercent.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupCachePercent()</a> - Enables caching for result grouping</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setgrouplimit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setgrouplimit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setgrouplimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setgrouplimit.php">＋<small>add a note</small></a></span>
