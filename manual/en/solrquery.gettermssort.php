...
<head>
  ...
  <title>PHP: SolrQuery::getTermsSort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gettermssort.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gettermssort.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermssort.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gettermsreturnraw.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gettermsupperbound.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermssort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gettermssort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gettermssort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gettermssort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gettermssort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gettermssort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gettermssort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gettermssort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gettermssort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gettermssort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gettermssort.php" hreflang="zh">
...
<meta name="Description" content="Returns an integer indicating how terms are sorted" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getTermsSort - Manual" />
<meta name="twitter:description" content="Returns an integer indicating how terms are sorted" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getTermsSort - Manual" />
<meta itemprop="description" content="Returns an integer indicating how terms are sorted" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an integer indicating how terms are sorted" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.gettermsupperbound.php">
          SolrQuery::getTermsUpperBound &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gettermsreturnraw.php">
          &laquo; SolrQuery::getTermsReturnRaw        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gettermssort.php' selected="selected">English</option>
            <option value='de/solrquery.gettermssort.php'>German</option>
            <option value='es/solrquery.gettermssort.php'>Spanish</option>
            <option value='fr/solrquery.gettermssort.php'>French</option>
            <option value='it/solrquery.gettermssort.php'>Italian</option>
            <option value='ja/solrquery.gettermssort.php'>Japanese</option>
            <option value='pt_BR/solrquery.gettermssort.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gettermssort.php'>Russian</option>
            <option value='tr/solrquery.gettermssort.php'>Turkish</option>
            <option value='uk/solrquery.gettermssort.php'>Ukrainian</option>
            <option value='zh/solrquery.gettermssort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gettermssort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getTermsSort</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getTermsSort</span> &mdash; <span class="dc-title">Returns an integer indicating how terms are sorted</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gettermssort-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getTermsSort</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gettermssort-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gettermssort-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gettermssort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gettermssort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gettermssort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gettermssort.php">＋<small>add a note</small></a></span>
