...
<head>
  ...
  <title>PHP: Memcached::flush - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.flush.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.flush.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.flush.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.fetchall.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.get.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.flush.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.flush.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.flush.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.flush.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.flush.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.flush.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.flush.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.flush.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.flush.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.flush.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.flush.php" hreflang="zh">
...
<meta name="Description" content="Invalidate all items in the cache" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::flush - Manual" />
<meta name="twitter:description" content="Invalidate all items in the cache" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::flush - Manual" />
<meta itemprop="description" content="Invalidate all items in the cache" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Invalidate all items in the cache" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="memcached.get.php">
          Memcached::get &raquo;
              ...
              <div class="prev">
        <a href="memcached.fetchall.php">
          &laquo; Memcached::fetchAll        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.flush.php' selected="selected">English</option>
            <option value='de/memcached.flush.php'>German</option>
            <option value='es/memcached.flush.php'>Spanish</option>
            <option value='fr/memcached.flush.php'>French</option>
            <option value='it/memcached.flush.php'>Italian</option>
            <option value='ja/memcached.flush.php'>Japanese</option>
            <option value='pt_BR/memcached.flush.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.flush.php'>Russian</option>
            <option value='tr/memcached.flush.php'>Turkish</option>
            <option value='uk/memcached.flush.php'>Ukrainian</option>
            <option value='zh/memcached.flush.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.flush" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Memcached::flush</h1>
  <p class="verinfo">(PECL memcached &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">Memcached::flush</span> &mdash; <span class="dc-title">Invalidate all items in the cache</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-memcached.flush-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Memcached::flush</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$delay</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::flush()</strong></span> invalidates all existing cache items
   immediately (by default) or after the <code class="parameter">delay</code>
   ...
   key after <span class="function"><strong>Memcached::flush()</strong></span> has invalidated the items).
 ...
 <div class="refsect1 parameters" id="refsect1-memcached.flush-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-memcached.flush-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-memcached.flush-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-4680">
    <p><strong>Example #1 <span class="function"><strong>Memcached::flush()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$m </span><span style="color: #007700">= new </span><span style="color: #0000BB">Memcached</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$m</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addServer</span><span style="color: #007700">(</span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">, </span><span style="color: #0000BB">11211</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* flush all items in 10 seconds */<br /></span><span style="color: #0000BB">$m</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">flush</span><span style="color: #007700">(</span><span style="color: #0000BB">10</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/flush.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.flush%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.flush&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.flush.php">＋<small>add a note</small></a></span>
