...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-draw-text-font.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/ui-draw-text-layout.setwidth.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-draw-text-font.construct.php">
...
<meta name="Description" content="Represents a Font" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Draw\Text\Font - Manual" />
<meta name="twitter:description" content="Represents a Font" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Draw\Text\Font - Manual" />
<meta itemprop="description" content="Represents a Font" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Represents a Font" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-draw-text-font.php' selected="selected">English</option>
            <option value='de/class.ui-draw-text-font.php'>German</option>
            <option value='es/class.ui-draw-text-font.php'>Spanish</option>
            <option value='fr/class.ui-draw-text-font.php'>French</option>
 ...
 <h1 class="title">Represents a Font</h1>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-draw-text-font.construct.php">UI\Draw\Text\Font::__construct</a> — Construct a new Font</li><li><a href="ui-draw-text-font.getascent.php">UI\Draw\Text\Font::getAscent</a> — Font Metrics</li><li><a href="ui-draw-text-font.getdescent.php">UI\Draw\Text\Font::getDescent</a> — Font Metrics</li><li><a href="ui-draw-text-font.getleading.php">UI\Draw\Text\Font::getLeading</a> — Font Metrics</li><li><a href="ui-draw-text-font.getunderlineposition.php">UI\Draw\Text\Font::getUnderlinePosition</a> — Font Metrics</li><li><a href="ui-draw-text-font.getunderlinethickness.php">UI\Draw\Text\Font::getUnderlineThickness</a> — Font Metrics</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.draw.text.font.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-draw-text-font%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-draw-text-font&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-draw-text-font.php">＋<small>add a note</small></a></span>
