...
<head>
  ...
  <title>PHP: ImagickDraw::setVectorGraphics - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setvectorgraphics.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setvectorgraphics.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setvectorgraphics.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.settextundercolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setviewbox.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setvectorgraphics.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setvectorgraphics.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setvectorgraphics.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setvectorgraphics.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setvectorgraphics.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setvectorgraphics.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setvectorgraphics.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setvectorgraphics.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setvectorgraphics.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setvectorgraphics.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setvectorgraphics.php" hreflang="zh">
...
<meta name="Description" content="Sets the vector graphics" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setVectorGraphics - Manual" />
<meta name="twitter:description" content="Sets the vector graphics" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setVectorGraphics - Manual" />
<meta itemprop="description" content="Sets the vector graphics" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the vector graphics" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.setviewbox.php">
          ImagickDraw::setViewbox &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.settextundercolor.php">
          &laquo; ImagickDraw::setTextUnderColor        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setvectorgraphics.php' selected="selected">English</option>
            <option value='de/imagickdraw.setvectorgraphics.php'>German</option>
            <option value='es/imagickdraw.setvectorgraphics.php'>Spanish</option>
            <option value='fr/imagickdraw.setvectorgraphics.php'>French</option>
            <option value='it/imagickdraw.setvectorgraphics.php'>Italian</option>
            <option value='ja/imagickdraw.setvectorgraphics.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setvectorgraphics.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setvectorgraphics.php'>Russian</option>
            <option value='tr/imagickdraw.setvectorgraphics.php'>Turkish</option>
            <option value='uk/imagickdraw.setvectorgraphics.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setvectorgraphics.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setvectorgraphics" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setVectorGraphics</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setVectorGraphics</span> &mdash; <span class="dc-title">Sets the vector graphics</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setvectorgraphics-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setVectorGraphics</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$xml</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
  ...
  <p class="para">
   ...
   object. Use this method with <span class="methodname"><a href="imagickdraw.getvectorgraphics.php" class="methodname">ImagickDraw::getVectorGraphics()</a></span> as a method
   to persist the vector graphics state.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagickdraw.setvectorgraphics-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setvectorgraphics-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.setvectorgraphics-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3195">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::setVectorGraphics()</strong></span> example</strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">setVectorGraphics</span><span style="color: #007700">() {<br />    </span><span style="color: #FF8000">//Setup a draw object with some drawing in it.<br />    </span><span style="color: #0000BB">$draw </span><span style="color: #007700">= new </span><span style="color: #0000BB">\ImagickDraw</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setFillColor</span><span style="color: #007700">(</span><span style="color: #DD0000">"red"</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">circle</span><span style="color: #007700">(</span><span style="color: #0000BB">20</span><span style="color: #007700">, </span><span style="color: #0000BB">20</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setFillColor</span><span style="color: #007700">(</span><span style="color: #DD0000">"blue"</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">circle</span><span style="color: #007700">(</span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #0000BB">70</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">rectangle</span><span style="color: #007700">(</span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #0000BB">120</span><span style="color: #007700">, </span><span style="color: #0000BB">80</span><span style="color: #007700">, </span><span style="color: #0000BB">150</span><span style="color: #007700">);<br /><br />    </span><span style="color: #FF8000">//Get the drawing as a string<br />    </span><span style="color: #0000BB">$SVG </span><span style="color: #007700">= </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getVectorGraphics</span><span style="color: #007700">();<br />    <br />    </span><span style="color: #FF8000">//$svg is a string, and could be saved anywhere a string can be saved<br /><br />    //Use the saved drawing to generate a new draw object<br />    </span><span style="color: #0000BB">$draw2 </span><span style="color: #007700">= new </span><span style="color: #0000BB">\ImagickDraw</span><span style="color: #007700">();<br />    </span><span style="color: #FF8000">//Apparently the SVG text is missing the root element. <br />    </span><span style="color: #0000BB">$draw2</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setVectorGraphics</span><span style="color: #007700">(</span><span style="color: #DD0000">"&lt;root&gt;"</span><span style="color: #007700">.</span><span style="color: #0000BB">$SVG</span><span style="color: #007700">.</span><span style="color: #DD0000">"&lt;/root&gt;"</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #DD0000">'white'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">"png"</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">drawImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$draw2</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />    echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setvectorgraphics.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setvectorgraphics%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setvectorgraphics&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setvectorgraphics.php">＋<small>add a note</small></a></span>
