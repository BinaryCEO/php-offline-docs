...
<head>
  ...
  <title>PHP: ImagickDraw::destroy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.destroy.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.destroy.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.destroy.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.ellipse.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.destroy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.destroy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.destroy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.destroy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.destroy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.destroy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.destroy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.destroy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.destroy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.destroy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.destroy.php" hreflang="zh">
...
<meta name="Description" content="Frees all associated resources" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::destroy - Manual" />
<meta name="twitter:description" content="Frees all associated resources" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::destroy - Manual" />
<meta itemprop="description" content="Frees all associated resources" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Frees all associated resources" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.ellipse.php">
          ImagickDraw::ellipse &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.construct.php">
          &laquo; ImagickDraw::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.destroy.php' selected="selected">English</option>
            <option value='de/imagickdraw.destroy.php'>German</option>
            <option value='es/imagickdraw.destroy.php'>Spanish</option>
            <option value='fr/imagickdraw.destroy.php'>French</option>
            <option value='it/imagickdraw.destroy.php'>Italian</option>
            <option value='ja/imagickdraw.destroy.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.destroy.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.destroy.php'>Russian</option>
            <option value='tr/imagickdraw.destroy.php'>Turkish</option>
            <option value='uk/imagickdraw.destroy.php'>Ukrainian</option>
            <option value='zh/imagickdraw.destroy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.destroy" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::destroy</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::destroy</span> &mdash; <span class="dc-title">Frees all associated resources</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.destroy-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::destroy</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <div class="warning"><strong class="warning">Warning</strong><p class="simpara">This function is
currently not documented; only its argument list is available.
</p></div>
  <p class="para">
   Frees all resources associated with the <span class="classname"><a href="class.imagickdraw.php" class="classname">ImagickDraw</a></span> object.
  </p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.destroy-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/destroy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.destroy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.destroy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.destroy.php">＋<small>add a note</small></a></span>
