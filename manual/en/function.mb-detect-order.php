...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-detect-order.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-detect-encoding.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-encode-mimeheader.php">
...
<meta name="Description" content="Set/Get character encoding detection order" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_detect_order - Manual" />
<meta name="twitter:description" content="Set/Get character encoding detection order" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_detect_order - Manual" />
<meta itemprop="description" content="Set/Get character encoding detection order" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set/Get character encoding detection order" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-detect-order.php' selected="selected">English</option>
            ...
            <option value='tr/function.mb-detect-order.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_detect_order</span> &mdash; <span class="dc-title">Set/Get character encoding detection order</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-detect-order-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_detect_order</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>

  <p class="para rdfs-comment">
   Sets the automatic character
   encoding detection order to <code class="parameter">encoding</code>.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-detect-order-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       <code class="parameter">encoding</code> is an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> or 
       comma separated list of character encoding. See <a href="mbstring.supported-encodings.php" class="link">supported encodings</a>.
      </p>
      <p class="para">
       If <code class="parameter">encoding</code> is omitted or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>, it returns
       the current character encoding detection order as array.
      </p>
      <p class="para">
       This setting affects <span class="function"><a href="function.mb-detect-encoding.php" class="function">mb_detect_encoding()</a></span> and
       <span class="function"><a href="function.mb-send-mail.php" class="function">mb_send_mail()</a></span>.
      </p>
      <p class="para">
       <code class="literal">mbstring</code> currently implements the following
      ...
      <p class="para">
       For <code class="literal">ISO-8859-*</code>, <code class="literal">mbstring</code>
       always detects as <code class="literal">ISO-8859-*</code>.
      </p>
      <p class="para">
       For <code class="literal">UTF-16</code>, <code class="literal">UTF-32</code>,
       <code class="literal">UCS2</code> and <code class="literal">UCS4</code>, encoding
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-detect-order-returnvalues">
  ...
  <p class="para">
   When setting the encoding detection order, <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> is returned on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
  <p class="para">
 ...
 <div class="refsect1 examples" id="refsect1-function.mb-detect-order-examples">
  ...
  <p class="para">
   <div class="example" id="example-2773">
    <p><strong>Example #1 <span class="function"><strong>mb_detect_order()</strong></span> examples</strong></p>
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Set detection order by enumerated list */<br /></span><span style="color: #0000BB">mb_detect_order</span><span style="color: #007700">(</span><span style="color: #DD0000">"eucjp-win,sjis-win,UTF-8"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Set detection order by array */<br /></span><span style="color: #0000BB">$ary</span><span style="color: #007700">[] = </span><span style="color: #DD0000">"ASCII"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$ary</span><span style="color: #007700">[] = </span><span style="color: #DD0000">"JIS"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$ary</span><span style="color: #007700">[] = </span><span style="color: #DD0000">"EUC-JP"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">mb_detect_order</span><span style="color: #007700">(</span><span style="color: #0000BB">$ary</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Display current detection order */<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">implode</span><span style="color: #007700">(</span><span style="color: #DD0000">", "</span><span style="color: #007700">, </span><span style="color: #0000BB">mb_detect_order</span><span style="color: #007700">());<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-2774">
    <p><strong>Example #2 Example showing useless detect orders</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-send-mail.php" class="function" rel="rdfs-seeAlso">mb_send_mail()</a> - Send encoded mail</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-detect-order.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-detect-order%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-detect-order&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-detect-order.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Perhaps obvious to most everyone, but the <br />default filter list was shorter than I expected:<br />['ASCII','UTF-8'], in that order.<br /><br />c. 2024, 60% of websites globally declared charset 'UTF-8'<br />So if you're experimenting with multibyte encodings other than UTF-8, you have to specify your detect_order, choosing from the list of implemented filters.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-detect-order&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-detect-order.php">＋<small>add a note</small></a></div>
