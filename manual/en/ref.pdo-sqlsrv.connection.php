...
<head>
  ...
  <title>PHP: PDO_SQLSRV DSN - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.pdo-sqlsrv.connection.php">
 <link rel="shorturl" href="https://www.php.net/pdo-sqlsrv.connection">
 <link rel="alternate" href="https://www.php.net/pdo-sqlsrv.connection" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pdo-sqlsrv.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.pdo-sqlsrv.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.pdo-oci.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ref.pdo-sqlsrv.connection.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ref.pdo-sqlsrv.connection.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ref.pdo-sqlsrv.connection.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ref.pdo-sqlsrv.connection.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ref.pdo-sqlsrv.connection.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ref.pdo-sqlsrv.connection.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ref.pdo-sqlsrv.connection.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ref.pdo-sqlsrv.connection.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ref.pdo-sqlsrv.connection.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ref.pdo-sqlsrv.connection.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ref.pdo-sqlsrv.connection.php" hreflang="zh">
...
<meta name="Description" content="Connecting to MS SQL Server and SQL Azure databases" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PDO_SQLSRV DSN - Manual" />
<meta name="twitter:description" content="Connecting to MS SQL Server and SQL Azure databases" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PDO_SQLSRV DSN - Manual" />
<meta itemprop="description" content="Connecting to MS SQL Server and SQL Azure databases" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Connecting to MS SQL Server and SQL Azure databases" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ref.pdo-sqlsrv.php">
          ...
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.database.php'>Database Extensions</a></li>      <li><a href='refs.database.abstract.php'>Abstraction Layers</a></li>      <li><a href='book.pdo.php'>PDO</a></li>      <li><a href='pdo.drivers.php'>PDO Drivers</a></li>      <li><a href='ref.pdo-sqlsrv.php'>MS SQL Server PDO Driver</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.pdo-sqlsrv.connection.php' selected="selected">English</option>
            <option value='de/ref.pdo-sqlsrv.connection.php'>German</option>
            <option value='es/ref.pdo-sqlsrv.connection.php'>Spanish</option>
            <option value='fr/ref.pdo-sqlsrv.connection.php'>French</option>
            <option value='it/ref.pdo-sqlsrv.connection.php'>Italian</option>
            <option value='ja/ref.pdo-sqlsrv.connection.php'>Japanese</option>
            <option value='pt_BR/ref.pdo-sqlsrv.connection.php'>Brazilian Portuguese</option>
            <option value='ru/ref.pdo-sqlsrv.connection.php'>Russian</option>
            <option value='tr/ref.pdo-sqlsrv.connection.php'>Turkish</option>
            <option value='uk/ref.pdo-sqlsrv.connection.php'>Ukrainian</option>
            <option value='zh/ref.pdo-sqlsrv.connection.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ref.pdo-sqlsrv.connection" class="refentry">
...
$c = new PDO(&quot;sqlsrv:Server=12345abcde.database.windows.net;Database=testdb&quot;, &quot;UserName@12345abcde&quot;, &quot;Password&quot;);
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fref.pdo-sqlsrv.connection%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ref.pdo-sqlsrv.connection&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.pdo-sqlsrv.connection.php">＋<small>add a note</small></a></span>
 ...
 <div class="note">There are no user contributed notes for this page.</div></section>    </section><!-- layout-content -->
        ...
        <ul class='parent-menu-list'>
                                    <li>
                <a href="ref.pdo-sqlsrv.php">MS SQL Server PDO Driver</a>

                                    <ul class='child-menu-list'>

                                                <li class="current">
                            <a href="ref.pdo-sqlsrv.connection.php" title="PDO_&#8203;SQLSRV DSN">PDO_&#8203;SQLSRV DSN</a>
                        </li>
