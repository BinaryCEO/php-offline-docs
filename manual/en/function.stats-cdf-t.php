...
<head>
  ...
  <title>PHP: stats_cdf_t - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-cdf-t.php">
 <link rel="shorturl" href="https://www.php.net/stats-cdf-t">
 <link rel="alternate" href="https://www.php.net/stats-cdf-t" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-cdf-poisson.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-cdf-uniform.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-cdf-t.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-cdf-t.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-cdf-t.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-cdf-t.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-cdf-t.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-cdf-t.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-cdf-t.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-cdf-t.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-cdf-t.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-cdf-t.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-cdf-t.php" hreflang="zh">
...
<meta name="Description" content="Calculates any one parameter of the t-distribution given values for the others" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_cdf_t - Manual" />
<meta name="twitter:description" content="Calculates any one parameter of the t-distribution given values for the others" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_cdf_t - Manual" />
<meta itemprop="description" content="Calculates any one parameter of the t-distribution given values for the others" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calculates any one parameter of the t-distribution given values for the others" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stats-cdf-uniform.php">
          stats_cdf_uniform &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-cdf-poisson.php">
          &laquo; stats_cdf_poisson        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-cdf-t.php' selected="selected">English</option>
            <option value='de/function.stats-cdf-t.php'>German</option>
            <option value='es/function.stats-cdf-t.php'>Spanish</option>
            <option value='fr/function.stats-cdf-t.php'>French</option>
            <option value='it/function.stats-cdf-t.php'>Italian</option>
            <option value='ja/function.stats-cdf-t.php'>Japanese</option>
            <option value='pt_BR/function.stats-cdf-t.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-cdf-t.php'>Russian</option>
            <option value='tr/function.stats-cdf-t.php'>Turkish</option>
            <option value='uk/function.stats-cdf-t.php'>Ukrainian</option>
            <option value='zh/function.stats-cdf-t.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-cdf-t" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_cdf_t</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_cdf_t</span> &mdash; <span class="dc-title">Calculates any one parameter of the t-distribution given values for the others</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-cdf-t-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_cdf_t</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$par1</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$par2</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$which</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   (<code class="parameter">par1</code> and <code class="parameter">par2</code>) are determined by
 ...
 <div class="refsect1 parameters" id="refsect1-function.stats-cdf-t-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-cdf-t-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns CDF, x, or nu, determined by <code class="parameter">which</code>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-cdf-t.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-cdf-t%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-cdf-t&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-cdf-t.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="100423">  <div class="votes">
    <div id="Vu100423">
    <a href="/manual/vote-note.php?id=100423&amp;page=function.stats-cdf-t&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd100423">
    <a href="/manual/vote-note.php?id=100423&amp;page=function.stats-cdf-t&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V100423" title="61% like this...">
    3
    </div>
  </div>
  <a href="#100423" class="name">
  <strong class="user"><em>Brian</em></strong></a><a class="genanchor" href="#100423"> &para;</a><div class="date" title="2010-10-14 02:14"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom100423">
<div class="phpcode"><code><span class="html">In order to match the output of this function with Excel's TDIST function, you must take 1 - the value.  For example, for a two-tailed T-distribution for x=4 and degrees of freedom=2, the formula would be:<br /><br />(1 - stats_cdf_t(4, 2, 1)) * 2<br /><br />For a single tail, do not include the multiply by 2 portion.</span></code></div>
  </div>
 </div>
  <div class="note" id="108263">  <div class="votes">
    <div id="Vu108263">
    <a href="/manual/vote-note.php?id=108263&amp;page=function.stats-cdf-t&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108263">
    <a href="/manual/vote-note.php?id=108263&amp;page=function.stats-cdf-t&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108263" title="22% like this...">
    -5
    </div>
  </div>
  <a href="#108263" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#108263"> &para;</a><div class="date" title="2012-04-12 07:30"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108263">
<div class="phpcode"><code><span class="html">Input  and return values of stats_cdf_t depends on the $which-parameter:<br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">get_t_p</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="default">$df</span><span class="keyword">){<br />  return </span><span class="default">stats_cdf_t</span><span class="keyword">(</span><span class="default">$t</span><span class="keyword">, </span><span class="default">$df</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br />}<br />function </span><span class="default">get_t_t</span><span class="keyword">(</span><span class="default">$p</span><span class="keyword">, </span><span class="default">$df</span><span class="keyword">){<br />  return </span><span class="default">stats_cdf_t</span><span class="keyword">(</span><span class="default">$p</span><span class="keyword">, </span><span class="default">$df</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">);<br />}<br />function </span><span class="default">get_t_df</span><span class="keyword">(</span><span class="default">$p</span><span class="keyword">, </span><span class="default">$t</span><span class="keyword">){<br />  return </span><span class="default">stats_cdf_t</span><span class="keyword">(</span><span class="default">$p</span><span class="keyword">, </span><span class="default">$t</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stats-cdf-t&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-cdf-t.php">＋<small>add a note</small></a></div>
