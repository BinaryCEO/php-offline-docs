...
<head>
  ...
  <title>PHP: ImagickDraw::getFontStyle - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getfontstyle.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getfontstyle.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfontstyle.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getfontstretch.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getfontweight.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfontstyle.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getfontstyle.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getfontstyle.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getfontstyle.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getfontstyle.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getfontstyle.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getfontstyle.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getfontstyle.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getfontstyle.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getfontstyle.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getfontstyle.php" hreflang="zh">
...
<meta name="Description" content="Returns the font style" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getFontStyle - Manual" />
<meta name="twitter:description" content="Returns the font style" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getFontStyle - Manual" />
<meta itemprop="description" content="Returns the font style" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the font style" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.getfontweight.php">
          ImagickDraw::getFontWeight &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getfontstretch.php">
          &laquo; ImagickDraw::getFontStretch        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getfontstyle.php' selected="selected">English</option>
            <option value='de/imagickdraw.getfontstyle.php'>German</option>
            <option value='es/imagickdraw.getfontstyle.php'>Spanish</option>
            <option value='fr/imagickdraw.getfontstyle.php'>French</option>
            <option value='it/imagickdraw.getfontstyle.php'>Italian</option>
            <option value='ja/imagickdraw.getfontstyle.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getfontstyle.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getfontstyle.php'>Russian</option>
            <option value='tr/imagickdraw.getfontstyle.php'>Turkish</option>
            <option value='uk/imagickdraw.getfontstyle.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getfontstyle.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getfontstyle" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getFontStyle</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getFontStyle</span> &mdash; <span class="dc-title">Returns the font style</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getfontstyle-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getFontStyle</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getfontstyle-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a <a href="imagick.constants.php#imagick.constants.styles" class="link">STYLE</a> constant
   (<code class="literal">imagick::STYLE_*</code>) associated with the <span class="classname"><a href="class.imagickdraw.php" class="classname">ImagickDraw</a></span> object 
   or 0 if no style is set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getfontstyle.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getfontstyle%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getfontstyle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getfontstyle.php">＋<small>add a note</small></a></span>
