...
<head>
  ...
  <title>PHP: iconv_substr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.iconv-substr.php">
 <link rel="shorturl" href="https://www.php.net/iconv-substr">
 <link rel="alternate" href="https://www.php.net/iconv-substr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.iconv.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.iconv-strrpos.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ob-iconv-handler.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.iconv-substr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.iconv-substr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.iconv-substr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.iconv-substr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.iconv-substr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.iconv-substr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.iconv-substr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.iconv-substr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.iconv-substr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.iconv-substr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.iconv-substr.php" hreflang="zh">
...
<meta name="Description" content="Cut out part of a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: iconv_substr - Manual" />
<meta name="twitter:description" content="Cut out part of a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: iconv_substr - Manual" />
<meta itemprop="description" content="Cut out part of a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Cut out part of a string" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ob-iconv-handler.php">
          ob_iconv_handler &raquo;
              ...
              <div class="prev">
        <a href="function.iconv-strrpos.php">
          &laquo; iconv_strrpos        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.iconv-substr.php' selected="selected">English</option>
            <option value='de/function.iconv-substr.php'>German</option>
            <option value='es/function.iconv-substr.php'>Spanish</option>
            <option value='fr/function.iconv-substr.php'>French</option>
            <option value='it/function.iconv-substr.php'>Italian</option>
            <option value='ja/function.iconv-substr.php'>Japanese</option>
            <option value='pt_BR/function.iconv-substr.php'>Brazilian Portuguese</option>
            <option value='ru/function.iconv-substr.php'>Russian</option>
            <option value='tr/function.iconv-substr.php'>Turkish</option>
            <option value='uk/function.iconv-substr.php'>Ukrainian</option>
            <option value='zh/function.iconv-substr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.iconv-substr" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-strcut.php" class="function" rel="rdfs-seeAlso">mb_strcut()</a> - Get part of string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/iconv/functions/iconv-substr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.iconv-substr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.iconv-substr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.iconv-substr.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="95776">  <div class="votes">
    <div id="Vu95776">
    <a href="/manual/vote-note.php?id=95776&amp;page=function.iconv-substr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd95776">
    <a href="/manual/vote-note.php?id=95776&amp;page=function.iconv-substr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V95776" title="50% like this...">
    0
    </div>
  </div>
  <a href="#95776" class="name">
  <strong class="user"><em>doru87 at gmail dot com</em></strong></a><a class="genanchor" href="#95776"> &para;</a><div class="date" title="2010-01-21 05:29"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95776">
<div class="phpcode"><code><span class="html">just fyi, iconv_substr() unknown error (0) has been resolved in PHP 5.2<br /><br />you can also try mb_substr() or just substr() when dealing with this issue. Unfortunately there is no way to fix it in versions prior to 5.2.<br /><br />Regards,<br />Teodor Sandu</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.iconv-substr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.iconv-substr.php">＋<small>add a note</small></a></div>
