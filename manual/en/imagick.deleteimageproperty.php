...
<head>
  ...
  <title>PHP: Imagick::deleteImageProperty - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.deleteimageproperty.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.deleteimageproperty.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.deleteimageproperty.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.deleteimageartifact.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.deskewimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.deleteimageproperty.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.deleteimageproperty.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.deleteimageproperty.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.deleteimageproperty.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.deleteimageproperty.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.deleteimageproperty.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.deleteimageproperty.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.deleteimageproperty.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.deleteimageproperty.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.deleteimageproperty.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.deleteimageproperty.php" hreflang="zh">
...
<meta name="Description" content="Deletes an image property" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::deleteImageProperty - Manual" />
<meta name="twitter:description" content="Deletes an image property" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::deleteImageProperty - Manual" />
<meta itemprop="description" content="Deletes an image property" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Deletes an image property" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.deskewimage.php">
          Imagick::deskewImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.deleteimageartifact.php">
          &laquo; Imagick::deleteImageArtifact        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.deleteimageproperty.php' selected="selected">English</option>
            <option value='de/imagick.deleteimageproperty.php'>German</option>
            <option value='es/imagick.deleteimageproperty.php'>Spanish</option>
            <option value='fr/imagick.deleteimageproperty.php'>French</option>
            <option value='it/imagick.deleteimageproperty.php'>Italian</option>
            <option value='ja/imagick.deleteimageproperty.php'>Japanese</option>
            <option value='pt_BR/imagick.deleteimageproperty.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.deleteimageproperty.php'>Russian</option>
            <option value='tr/imagick.deleteimageproperty.php'>Turkish</option>
            <option value='uk/imagick.deleteimageproperty.php'>Ukrainian</option>
            <option value='zh/imagick.deleteimageproperty.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.deleteimageproperty" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::deleteImageProperty</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::deleteImageProperty</span> &mdash; <span class="dc-title">Deletes an image property</span></p>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/deleteimageproperty.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.deleteimageproperty%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.deleteimageproperty&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.deleteimageproperty.php">＋<small>add a note</small></a></span>
