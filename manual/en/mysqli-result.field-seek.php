...
<head>
  ...
  <title>PHP: mysqli_result::field_seek - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-result.field-seek.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-result.field-seek.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-result.field-seek.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-result.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-result.field-count.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-result.free.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-result.field-seek.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli-result.field-seek.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli-result.field-seek.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli-result.field-seek.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli-result.field-seek.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli-result.field-seek.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli-result.field-seek.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli-result.field-seek.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli-result.field-seek.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli-result.field-seek.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli-result.field-seek.php" hreflang="zh">
...
<meta name="Description" content="Set result pointer to a specified field offset" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_result::field_seek - Manual" />
<meta name="twitter:description" content="Set result pointer to a specified field offset" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_result::field_seek - Manual" />
<meta itemprop="description" content="Set result pointer to a specified field offset" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set result pointer to a specified field offset" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli-result.free.php">
          mysqli_result::free &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli-result.field-count.php">
          &laquo; mysqli_result::$field_count        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-result.field-seek.php' selected="selected">English</option>
            <option value='de/mysqli-result.field-seek.php'>German</option>
            <option value='es/mysqli-result.field-seek.php'>Spanish</option>
            <option value='fr/mysqli-result.field-seek.php'>French</option>
            <option value='it/mysqli-result.field-seek.php'>Italian</option>
            <option value='ja/mysqli-result.field-seek.php'>Japanese</option>
            <option value='pt_BR/mysqli-result.field-seek.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli-result.field-seek.php'>Russian</option>
            <option value='tr/mysqli-result.field-seek.php'>Turkish</option>
            <option value='uk/mysqli-result.field-seek.php'>Ukrainian</option>
            <option value='zh/mysqli-result.field-seek.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli-result.field-seek" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli_result::field_seek</h1>
  <h1 class="refname">mysqli_field_seek</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli_result::field_seek</span> -- <span class="refname">mysqli_field_seek</span> &mdash; <span class="dc-title">Set result pointer to a specified field offset</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-mysqli-result.field-seek-description">
  <h3 class="title">Description</h3>
  <p class="para">Object-oriented style</p>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>mysqli_result::field_seek</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>

  <p class="para rdfs-comment">Procedural style</p>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>mysqli_field_seek</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli-result.php" class="type mysqli_result">mysqli_result</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>

  <p class="para rdfs-comment">
   Sets the field cursor to the given offset. The next call to 
   <span class="function"><a href="mysqli-result.fetch-field.php" class="function">mysqli_fetch_field()</a></span> will retrieve the field definition
 ...
 <div class="refsect1 parameters" id="refsect1-mysqli-result.field-seek-parameters">
...
<span class="function"><a href="mysqli.use-result.php" class="function">mysqli_use_result()</a></span> or <span class="function"><a href="mysqli-stmt.get-result.php" class="function">mysqli_stmt_get_result()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli-result.field-seek-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-mysqli-result.field-seek-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-mysqli-result.field-seek-examples">
...
Type:     4</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli-result.field-seek-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli-result.fetch-field.php" class="function" rel="rdfs-seeAlso">mysqli_fetch_field()</a> - Returns the next field in the result set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_result/field-seek.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli-result.field-seek%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli-result.field-seek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-result.field-seek.php">＋<small>add a note</small></a></span>
