...
<head>
  ...
  <title>PHP: dba_key_split - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.dba-key-split.php">
 <link rel="shorturl" href="https://www.php.net/dba-key-split">
 <link rel="alternate" href="https://www.php.net/dba-key-split" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.dba.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.dba-insert.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dba-list.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.dba-key-split.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.dba-key-split.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.dba-key-split.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.dba-key-split.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.dba-key-split.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.dba-key-split.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.dba-key-split.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.dba-key-split.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.dba-key-split.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.dba-key-split.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.dba-key-split.php" hreflang="zh">
...
<meta name="Description" content="Splits a key in string representation into array representation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: dba_key_split - Manual" />
<meta name="twitter:description" content="Splits a key in string representation into array representation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: dba_key_split - Manual" />
<meta itemprop="description" content="Splits a key in string representation into array representation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Splits a key in string representation into array representation" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.dba-key-split.php' selected="selected">English</option>
            <option value='de/function.dba-key-split.php'>German</option>
            <option value='es/function.dba-key-split.php'>Spanish</option>
            <option value='fr/function.dba-key-split.php'>French</option>
            <option value='it/function.dba-key-split.php'>Italian</option>
            <option value='ja/function.dba-key-split.php'>Japanese</option>
            <option value='pt_BR/function.dba-key-split.php'>Brazilian Portuguese</option>
            <option value='ru/function.dba-key-split.php'>Russian</option>
            <option value='tr/function.dba-key-split.php'>Turkish</option>
            <option value='uk/function.dba-key-split.php'>Ukrainian</option>
            <option value='zh/function.dba-key-split.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.dba-key-split" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.dba-fetch.php" class="function" rel="rdfs-seeAlso">dba_fetch()</a> - Fetch data specified by key</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dba/functions/dba-key-split.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.dba-key-split%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.dba-key-split&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dba-key-split.php">＋<small>add a note</small></a></span>
