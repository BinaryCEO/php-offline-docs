...
<head>
  ...
  <title>PHP: Imagick::getImageBorderColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagebordercolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagebordercolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagebordercolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageblueprimary.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagechanneldepth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagebordercolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagebordercolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagebordercolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagebordercolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagebordercolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagebordercolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagebordercolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagebordercolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagebordercolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagebordercolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagebordercolor.php" hreflang="zh">
...
<meta name="Description" content="Returns the image border color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageBorderColor - Manual" />
<meta name="twitter:description" content="Returns the image border color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageBorderColor - Manual" />
<meta itemprop="description" content="Returns the image border color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the image border color" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagechanneldepth.php">
          Imagick::getImageChannelDepth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageblueprimary.php">
          &laquo; Imagick::getImageBluePrimary        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagebordercolor.php' selected="selected">English</option>
            <option value='de/imagick.getimagebordercolor.php'>German</option>
            <option value='es/imagick.getimagebordercolor.php'>Spanish</option>
            <option value='fr/imagick.getimagebordercolor.php'>French</option>
            <option value='it/imagick.getimagebordercolor.php'>Italian</option>
            <option value='ja/imagick.getimagebordercolor.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagebordercolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagebordercolor.php'>Russian</option>
            <option value='tr/imagick.getimagebordercolor.php'>Turkish</option>
            <option value='uk/imagick.getimagebordercolor.php'>Ukrainian</option>
            <option value='zh/imagick.getimagebordercolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagebordercolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageBorderColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageBorderColor</span> &mdash; <span class="dc-title">Returns the image border color</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagebordercolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageBorderColor</strong></span>(): <span class="type"><a href="class.imagickpixel.php" class="type ImagickPixel">ImagickPixel</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagebordercolor-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagebordercolor-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagebordercolor-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagebordercolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagebordercolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagebordercolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagebordercolor.php">＋<small>add a note</small></a></span>
