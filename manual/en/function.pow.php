...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pow.php">
 <link rel="shorturl" href="https://www.php.net/pow">
 <link rel="alternate" href="https://www.php.net/pow" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.math.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pi.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rad2deg.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pow.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pow.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pow.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pow.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pow.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pow.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pow.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pow.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pow.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pow.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pow.php" hreflang="zh">
...
<meta name="Description" content="Exponential expression" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pow - Manual" />
<meta name="twitter:description" content="Exponential expression" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pow - Manual" />
<meta itemprop="description" content="Exponential expression" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exponential expression" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pow.php' selected="selected">English</option>
            <option value='de/function.pow.php'>German</option>
            <option value='es/function.pow.php'>Spanish</option>
            <option value='fr/function.pow.php'>French</option>
            <option value='it/function.pow.php'>Italian</option>
            <option value='ja/function.pow.php'>Japanese</option>
            <option value='pt_BR/function.pow.php'>Brazilian Portuguese</option>
            <option value='ru/function.pow.php'>Russian</option>
            <option value='tr/function.pow.php'>Turkish</option>
            <option value='uk/function.pow.php'>Ukrainian</option>
            <option value='zh/function.pow.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pow" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.gmp-pow.php" class="function" rel="rdfs-seeAlso">gmp_pow()</a> - Raise number into power</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/math/functions/pow.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pow%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pow&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pow.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="71784">  <div class="votes">
    <div id="Vu71784">
    <a href="/manual/vote-note.php?id=71784&amp;page=function.pow&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd71784">
    <a href="/manual/vote-note.php?id=71784&amp;page=function.pow&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V71784" title="55% like this...">
    19
    </div>
  </div>
  <a href="#71784" class="name">
  <strong class="user"><em>gilthansREMOVEME at gmail dot com</em></strong></a><a class="genanchor" href="#71784"> &para;</a><div class="date" title="2006-12-15 07:50"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom71784">
<div class="phpcode"><code><span class="html">Note that pow(0, 0) equals to 1 although mathematically this is undefined.</span></code></div>
  </div>
 </div>
  <div class="note" id="125605">  <div class="votes">
    <div id="Vu125605">
    <a href="/manual/vote-note.php?id=125605&amp;page=function.pow&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125605">
    <a href="/manual/vote-note.php?id=125605&amp;page=function.pow&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125605" title="50% like this...">
    0
    </div>
  </div>
  <a href="#125605" class="name">
  <strong class="user"><em>Roman</em></strong></a><a class="genanchor" href="#125605"> &para;</a><div class="date" title="2020-12-15 04:15"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125605">
<div class="phpcode"><code><span class="html">If you use negative numbers, you need to use brackets for using with **<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">-</span><span class="default">1 </span><span class="keyword">** </span><span class="default">2</span><span class="keyword">; </span><span class="comment">// -1<br /><br /></span><span class="keyword">(-</span><span class="default">1</span><span class="keyword">) ** </span><span class="default">2</span><span class="keyword">; </span><span class="comment">// 1<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pow&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pow.php">＋<small>add a note</small></a></div>
