...
<head>
  ...
  <title>PHP: PharData::convertToExecutable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phardata.converttoexecutable.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phardata.converttoexecutable.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phardata.converttoexecutable.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phardata.php">
 <link rel="prev" href="https://www.php.net/manual/en/phardata.converttodata.php">
 <link rel="next" href="https://www.php.net/manual/en/phardata.copy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phardata.converttoexecutable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phardata.converttoexecutable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phardata.converttoexecutable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phardata.converttoexecutable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phardata.converttoexecutable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phardata.converttoexecutable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phardata.converttoexecutable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phardata.converttoexecutable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phardata.converttoexecutable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phardata.converttoexecutable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phardata.converttoexecutable.php" hreflang="zh">
...
<meta name="Description" content="Convert a non-executable tar/zip archive to an executable phar archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PharData::convertToExecutable - Manual" />
<meta name="twitter:description" content="Convert a non-executable tar/zip archive to an executable phar archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PharData::convertToExecutable - Manual" />
<meta itemprop="description" content="Convert a non-executable tar/zip archive to an executable phar archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Convert a non-executable tar/zip archive to an executable phar archive" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phardata.copy.php">
          PharData::copy &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phardata.converttodata.php">
          &laquo; PharData::convertToData        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phardata.converttoexecutable.php' selected="selected">English</option>
            <option value='de/phardata.converttoexecutable.php'>German</option>
            <option value='es/phardata.converttoexecutable.php'>Spanish</option>
            <option value='fr/phardata.converttoexecutable.php'>French</option>
            <option value='it/phardata.converttoexecutable.php'>Italian</option>
            <option value='ja/phardata.converttoexecutable.php'>Japanese</option>
            <option value='pt_BR/phardata.converttoexecutable.php'>Brazilian Portuguese</option>
            <option value='ru/phardata.converttoexecutable.php'>Russian</option>
            <option value='tr/phardata.converttoexecutable.php'>Turkish</option>
            <option value='uk/phardata.converttoexecutable.php'>Ukrainian</option>
            <option value='zh/phardata.converttoexecutable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phardata.converttoexecutable" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">PharData::convertToExecutable</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">PharData::convertToExecutable</span> &mdash; <span class="dc-title">Convert a non-executable tar/zip archive to an executable phar archive</span></p>

 </div>


 <div class="refsect1 description" id="refsect1-phardata.converttoexecutable-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>PharData::convertToExecutable</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span> <code class="parameter">$format</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span> <code class="parameter">$compression</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$extension</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.phar.php" class="type Phar">Phar</a></span></span></div>
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
 ...
 <div class="refsect1 parameters" id="refsect1-phardata.converttoexecutable-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-phardata.converttoexecutable-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-phardata.converttoexecutable-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-phardata.converttoexecutable-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">format</code>, <code class="parameter">compression</code>, and <code class="parameter">localName</code> are now nullable.
      </td>
     </tr>
 ...
 <div class="refsect1 examples" id="refsect1-phardata.converttoexecutable-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-853">
    <p><strong>Example #1 A <span class="function"><strong>PharData::convertToExecutable()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">try {<br />    </span><span style="color: #0000BB">$tarphar </span><span style="color: #007700">= new </span><span style="color: #0000BB">PharData</span><span style="color: #007700">(</span><span style="color: #DD0000">'myphar.tar'</span><span style="color: #007700">);<br />    </span><span style="color: #FF8000">// convert it to the phar file format<br />    // note that myphar.tar is *not* unlinked<br />    </span><span style="color: #0000BB">$phar </span><span style="color: #007700">= </span><span style="color: #0000BB">$tarphar</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">convertToExecutable</span><span style="color: #007700">(</span><span style="color: #0000BB">Phar</span><span style="color: #007700">::</span><span style="color: #0000BB">PHAR</span><span style="color: #007700">); </span><span style="color: #FF8000">// creates myphar.phar<br />    </span><span style="color: #0000BB">$phar</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setStub</span><span style="color: #007700">(</span><span style="color: #0000BB">$phar</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">createDefaultStub</span><span style="color: #007700">(</span><span style="color: #DD0000">'cli.php'</span><span style="color: #007700">, </span><span style="color: #DD0000">'web/index.php'</span><span style="color: #007700">));<br />    </span><span style="color: #FF8000">// creates myphar.phar.tgz<br />    </span><span style="color: #0000BB">$compressed </span><span style="color: #007700">= </span><span style="color: #0000BB">$tarphar</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">convertToExecutable</span><span style="color: #007700">(</span><span style="color: #0000BB">Phar</span><span style="color: #007700">::</span><span style="color: #0000BB">TAR</span><span style="color: #007700">, </span><span style="color: #0000BB">Phar</span><span style="color: #007700">::</span><span style="color: #0000BB">GZ</span><span style="color: #007700">, </span><span style="color: #DD0000">'.phar.tgz'</span><span style="color: #007700">);<br />} catch (</span><span style="color: #0000BB">Exception $e</span><span style="color: #007700">) {<br />    </span><span style="color: #FF8000">// handle the error here<br /></span><span style="color: #007700">}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-phardata.converttoexecutable-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phardata.converttodata.php" class="function" rel="rdfs-seeAlso">PharData::convertToData()</a> - Convert a phar archive to a non-executable tar or zip file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/PharData/convertToExecutable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphardata.converttoexecutable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phardata.converttoexecutable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.converttoexecutable.php">＋<small>add a note</small></a></span>
