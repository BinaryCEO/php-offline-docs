...
<head>
  ...
  <title>PHP: posix_getpgrp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-getpgrp.php">
 <link rel="shorturl" href="https://www.php.net/posix-getpgrp">
 <link rel="alternate" href="https://www.php.net/posix-getpgrp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-getpgid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-getpid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-getpgrp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-getpgrp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-getpgrp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-getpgrp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-getpgrp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-getpgrp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-getpgrp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-getpgrp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-getpgrp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-getpgrp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-getpgrp.php" hreflang="zh">
...
<meta name="Description" content="Return the current process group identifier" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_getpgrp - Manual" />
<meta name="twitter:description" content="Return the current process group identifier" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_getpgrp - Manual" />
<meta itemprop="description" content="Return the current process group identifier" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the current process group identifier" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-getpgrp.php' selected="selected">English</option>
            <option value='de/function.posix-getpgrp.php'>German</option>
            <option value='es/function.posix-getpgrp.php'>Spanish</option>
            <option value='fr/function.posix-getpgrp.php'>French</option>
            <option value='it/function.posix-getpgrp.php'>Italian</option>
            <option value='ja/function.posix-getpgrp.php'>Japanese</option>
            <option value='pt_BR/function.posix-getpgrp.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-getpgrp.php'>Russian</option>
            <option value='tr/function.posix-getpgrp.php'>Turkish</option>
            <option value='uk/function.posix-getpgrp.php'>Ukrainian</option>
            <option value='zh/function.posix-getpgrp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-getpgrp" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">posix_getpgrp</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_getpgrp</span> &mdash; <span class="dc-title">Return the current process group identifier</span></p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.posix-getpgrp-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li>POSIX.1 and the getpgrp(2) manual page on the POSIX system for
     more information on process groups.</li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-getpgrp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-getpgrp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-getpgrp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getpgrp.php">＋<small>add a note</small></a></span>
