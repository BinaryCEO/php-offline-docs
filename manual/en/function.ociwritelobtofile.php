...
<head>
  ...
  <title>PHP: ociwritelobtofile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ociwritelobtofile.php">
 <link rel="shorturl" href="https://www.php.net/ociwritelobtofile">
 <link rel="alternate" href="https://www.php.net/ociwritelobtofile" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocistatementtype.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ociwritetemporarylob.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ociwritelobtofile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ociwritelobtofile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ociwritelobtofile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ociwritelobtofile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ociwritelobtofile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ociwritelobtofile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ociwritelobtofile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ociwritelobtofile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ociwritelobtofile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ociwritelobtofile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ociwritelobtofile.php" hreflang="zh">
...
<meta name="Description" content="Alias of OCILob::export" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ociwritelobtofile - Manual" />
<meta name="twitter:description" content="Alias of OCILob::export" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ociwritelobtofile - Manual" />
<meta itemprop="description" content="Alias of OCILob::export" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of OCILob::export" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ociwritetemporarylob.php">
          ociwritetemporarylob &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocistatementtype.php">
          &laquo; ocistatementtype        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ociwritelobtofile.php' selected="selected">English</option>
            <option value='de/function.ociwritelobtofile.php'>German</option>
            <option value='es/function.ociwritelobtofile.php'>Spanish</option>
            <option value='fr/function.ociwritelobtofile.php'>French</option>
            <option value='it/function.ociwritelobtofile.php'>Italian</option>
            <option value='ja/function.ociwritelobtofile.php'>Japanese</option>
            <option value='pt_BR/function.ociwritelobtofile.php'>Brazilian Portuguese</option>
            <option value='ru/function.ociwritelobtofile.php'>Russian</option>
            <option value='tr/function.ociwritelobtofile.php'>Turkish</option>
            <option value='uk/function.ociwritelobtofile.php'>Ukrainian</option>
            <option value='zh/function.ociwritelobtofile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ociwritelobtofile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ociwritelobtofile</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ociwritelobtofile</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="ocilob.export.php" class="function">OCILob::export()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ociwritelobtofile-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="ocilob.export.php" class="function">OCILob::export()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ociwritelobtofile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ociwritelobtofile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ociwritelobtofile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ociwritelobtofile.php">＋<small>add a note</small></a></span>
