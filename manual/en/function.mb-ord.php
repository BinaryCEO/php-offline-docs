...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-ord.php">
 <link rel="shorturl" href="https://www.php.net/mb-ord">
 <link rel="alternate" href="https://www.php.net/mb-ord" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-ltrim.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-output-handler.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-ord.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-ord.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-ord.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-ord.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-ord.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-ord.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-ord.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-ord.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-ord.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-ord.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-ord.php" hreflang="zh">
...
<meta name="Description" content="Get Unicode code point of character" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_ord - Manual" />
<meta name="twitter:description" content="Get Unicode code point of character" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_ord - Manual" />
<meta itemprop="description" content="Get Unicode code point of character" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get Unicode code point of character" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mb-output-handler.php">
          mb_output_handler &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-ord.php' selected="selected">English</option>
            <option value='de/function.mb-ord.php'>German</option>
            <option value='es/function.mb-ord.php'>Spanish</option>
            <option value='fr/function.mb-ord.php'>French</option>
            <option value='it/function.mb-ord.php'>Italian</option>
            <option value='ja/function.mb-ord.php'>Japanese</option>
            <option value='pt_BR/function.mb-ord.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-ord.php'>Russian</option>
            <option value='tr/function.mb-ord.php'>Turkish</option>
            <option value='uk/function.mb-ord.php'>Ukrainian</option>
            <option value='zh/function.mb-ord.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-ord" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_ord</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">mb_ord</span> &mdash; <span class="dc-title">Get Unicode code point of character</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.mb-ord-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_ord</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Returns the Unicode code point value of the given character.
  </p>
  <p class="para">
   This function complements <span class="function"><a href="function.mb-chr.php" class="function">mb_chr()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.mb-ord-parameters">
...
encoding value will be used.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-ord-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The Unicode code point for the first character of <code class="literal">string</code>  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.mb-ord-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.mb-ord-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2783">
    <p><strong>Example #1 A basic <span class="function"><strong>mb_ord()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">mb_ord</span><span style="color: #007700">(</span><span style="color: #DD0000">"A"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UTF-8"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">mb_ord</span><span style="color: #007700">(</span><span style="color: #DD0000">"🐘"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UTF-8"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">mb_ord</span><span style="color: #007700">(</span><span style="color: #DD0000">"\x80"</span><span style="color: #007700">, </span><span style="color: #DD0000">"ISO-8859-1"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">mb_ord</span><span style="color: #007700">(</span><span style="color: #DD0000">"\x80"</span><span style="color: #007700">, </span><span style="color: #DD0000">"Windows-1252"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
int(8364)<br />
 ...
 <div class="refsect1 seealso" id="refsect1-function.mb-ord-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ord.php" class="function" rel="rdfs-seeAlso">ord()</a> - Convert the first byte of a string to a value between 0 and 255</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-ord.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-ord%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-ord&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-ord.php">＋<small>add a note</small></a></span>
