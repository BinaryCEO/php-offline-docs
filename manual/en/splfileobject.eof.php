...
<head>
  ...
  <title>PHP: SplFileObject::eof - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileobject.eof.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileobject.eof.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.eof.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileobject.current.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileobject.fflush.php">

 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.eof.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/splfileobject.eof.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/splfileobject.eof.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/splfileobject.eof.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/splfileobject.eof.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/splfileobject.eof.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/splfileobject.eof.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/splfileobject.eof.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/splfileobject.eof.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/splfileobject.eof.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/splfileobject.eof.php" hreflang="zh">
...
<meta name="Description" content="Reached end of file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplFileObject::eof - Manual" />
<meta name="twitter:description" content="Reached end of file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplFileObject::eof - Manual" />
<meta itemprop="description" content="Reached end of file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reached end of file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="splfileobject.fflush.php">
          SplFileObject::fflush &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="splfileobject.current.php">
          &laquo; SplFileObject::current        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileobject.eof.php' selected="selected">English</option>
            <option value='de/splfileobject.eof.php'>German</option>
            <option value='es/splfileobject.eof.php'>Spanish</option>
            <option value='fr/splfileobject.eof.php'>French</option>
            <option value='it/splfileobject.eof.php'>Italian</option>
            <option value='ja/splfileobject.eof.php'>Japanese</option>
            <option value='pt_BR/splfileobject.eof.php'>Brazilian Portuguese</option>
            <option value='ru/splfileobject.eof.php'>Russian</option>
            <option value='tr/splfileobject.eof.php'>Turkish</option>
            <option value='uk/splfileobject.eof.php'>Ukrainian</option>
            <option value='zh/splfileobject.eof.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="splfileobject.eof" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SplFileObject::eof</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">SplFileObject::eof</span> &mdash; <span class="dc-title">Reached end of file</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-splfileobject.eof-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if file is at EOF, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-splfileobject.eof-examples">
  ...
  <p class="para">
   <div class="example" id="example-3993">
    <p><strong>Example #1 <span class="methodname"><strong>SplFileObject::eof()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.feof.php" class="function" rel="rdfs-seeAlso">feof()</a> - Tests for end-of-file on a file pointer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileobject/eof.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileobject.eof%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileobject.eof&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileobject.eof.php">＋<small>add a note</small></a></span>
