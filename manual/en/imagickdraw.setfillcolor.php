...
<head>
  ...
  <title>PHP: ImagickDraw::setFillColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setfillcolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setfillcolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfillcolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setfillalpha.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setfillopacity.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfillcolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setfillcolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setfillcolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setfillcolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setfillcolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setfillcolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setfillcolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setfillcolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setfillcolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setfillcolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setfillcolor.php" hreflang="zh">
...
<meta name="Description" content="Sets the fill color to be used for drawing filled objects" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setFillColor - Manual" />
<meta name="twitter:description" content="Sets the fill color to be used for drawing filled objects" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setFillColor - Manual" />
<meta itemprop="description" content="Sets the fill color to be used for drawing filled objects" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the fill color to be used for drawing filled objects" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.setfillopacity.php">
          ImagickDraw::setFillOpacity &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setfillalpha.php">
          &laquo; ImagickDraw::setFillAlpha        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setfillcolor.php' selected="selected">English</option>
            <option value='de/imagickdraw.setfillcolor.php'>German</option>
            <option value='es/imagickdraw.setfillcolor.php'>Spanish</option>
            <option value='fr/imagickdraw.setfillcolor.php'>French</option>
            <option value='it/imagickdraw.setfillcolor.php'>Italian</option>
            <option value='ja/imagickdraw.setfillcolor.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setfillcolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setfillcolor.php'>Russian</option>
            <option value='tr/imagickdraw.setfillcolor.php'>Turkish</option>
            <option value='uk/imagickdraw.setfillcolor.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setfillcolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setfillcolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setFillColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setFillColor</span> &mdash; <span class="dc-title">Sets the fill color to be used for drawing filled objects</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setfillcolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setFillColor</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.imagickpixel.php" class="type ImagickPixel">ImagickPixel</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$fill_color</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setfillcolor-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">fill_color</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setfillcolor-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3171">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setfillcolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setfillcolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setfillcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfillcolor.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="102918">  <div class="votes">
    <div id="Vu102918">
    <a href="/manual/vote-note.php?id=102918&amp;page=imagickdraw.setfillcolor&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102918">
    <a href="/manual/vote-note.php?id=102918&amp;page=imagickdraw.setfillcolor&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102918" title="75% like this...">
    2
    </div>
  </div>
  <a href="#102918" class="name">
  <strong class="user"><em>moguchicorp at gmail dot com</em></strong></a><a class="genanchor" href="#102918"> &para;</a><div class="date" title="2011-03-14 03:00"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102918">
<div class="phpcode"><code><span class="html">It also accepts color definitions by name and hexa, as in <br /><br /><span class="default">&lt;?php <br />$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();<br /><br /></span><span class="comment">/* defined color black */<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">'black'</span><span class="keyword">);<br /><br /></span><span class="comment">/* some light brown */<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">'#a4610f'</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.setfillcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfillcolor.php">＋<small>add a note</small></a></div>
