...
<head>
  ...
  <title>PHP: ImagickDraw::pathStart - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pathstart.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pathstart.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathstart.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pathmovetorelative.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.point.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathstart.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pathstart.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pathstart.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pathstart.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pathstart.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pathstart.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pathstart.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pathstart.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pathstart.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pathstart.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pathstart.php" hreflang="zh">
...
<meta name="Description" content="Declares the start of a path drawing list" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::pathStart - Manual" />
<meta name="twitter:description" content="Declares the start of a path drawing list" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pathStart - Manual" />
<meta itemprop="description" content="Declares the start of a path drawing list" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Declares the start of a path drawing list" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.point.php">
          ImagickDraw::point &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pathmovetorelative.php">
          &laquo; ImagickDraw::pathMoveToRelative        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pathstart.php' selected="selected">English</option>
            <option value='de/imagickdraw.pathstart.php'>German</option>
            <option value='es/imagickdraw.pathstart.php'>Spanish</option>
            <option value='fr/imagickdraw.pathstart.php'>French</option>
            <option value='it/imagickdraw.pathstart.php'>Italian</option>
            <option value='ja/imagickdraw.pathstart.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pathstart.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pathstart.php'>Russian</option>
            <option value='tr/imagickdraw.pathstart.php'>Turkish</option>
            <option value='uk/imagickdraw.pathstart.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pathstart.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pathstart" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pathStart</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::pathStart</span> &mdash; <span class="dc-title">Declares the start of a path drawing list</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagickdraw.pathstart-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::pathStart</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.pathstart-examples">
  ...
  <p class="para">
    <div class="example" id="example-3156">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::pathStart()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pathstart.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pathstart%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pathstart&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pathstart.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="129176">  <div class="votes">
    <div id="Vu129176">
    <a href="/manual/vote-note.php?id=129176&amp;page=imagickdraw.pathstart&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129176">
    <a href="/manual/vote-note.php?id=129176&amp;page=imagickdraw.pathstart&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129176" title="no votes...">
    0
    </div>
  </div>
  <a href="#129176" class="name">
  <strong class="user"><em>v010dya</em></strong></a><a class="genanchor" href="#129176"> &para;</a><div class="date" title="2024-01-19 07:19"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129176">
<div class="phpcode"><code><span class="html">Between $draw-&gt;pathStart() and $draw-&gt;pathFinish() you would need to start with $draw-&gt;pathMoveToAbsolute(x, y) to initialise the position. All the subsequent calls to "path functions" (including absolute ones) will continue the path.<br /><br />I would expect pathStart to accept the starting coordinates, and it took me a while to realise that there you need to initialise with a different function.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.pathstart&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pathstart.php">＋<small>add a note</small></a></div>
