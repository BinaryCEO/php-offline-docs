...
<head>
  ...
  <title>PHP: Imagick::charcoalImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.charcoalimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.charcoalimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.charcoalimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.brightnesscontrastimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.chopimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.charcoalimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.charcoalimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.charcoalimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.charcoalimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.charcoalimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.charcoalimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.charcoalimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.charcoalimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.charcoalimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.charcoalimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.charcoalimage.php" hreflang="zh">
...
<meta name="Description" content="Simulates a charcoal drawing" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::charcoalImage - Manual" />
<meta name="twitter:description" content="Simulates a charcoal drawing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::charcoalImage - Manual" />
<meta itemprop="description" content="Simulates a charcoal drawing" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Simulates a charcoal drawing" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.chopimage.php">
          Imagick::chopImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.brightnesscontrastimage.php">
          &laquo; Imagick::brightnessContrastImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.charcoalimage.php' selected="selected">English</option>
            <option value='de/imagick.charcoalimage.php'>German</option>
            <option value='es/imagick.charcoalimage.php'>Spanish</option>
            <option value='fr/imagick.charcoalimage.php'>French</option>
            <option value='it/imagick.charcoalimage.php'>Italian</option>
            <option value='ja/imagick.charcoalimage.php'>Japanese</option>
            <option value='pt_BR/imagick.charcoalimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.charcoalimage.php'>Russian</option>
            <option value='tr/imagick.charcoalimage.php'>Turkish</option>
            <option value='uk/imagick.charcoalimage.php'>Ukrainian</option>
            <option value='zh/imagick.charcoalimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.charcoalimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::charcoalImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::charcoalImage</span> &mdash; <span class="dc-title">Simulates a charcoal drawing</span></p>
  ...
  <p class="para">
    <div class="example" id="example-2976">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/charcoalimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.charcoalimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.charcoalimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.charcoalimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108253">  <div class="votes">
    <div id="Vu108253">
    <a href="/manual/vote-note.php?id=108253&amp;page=imagick.charcoalimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108253">
    <a href="/manual/vote-note.php?id=108253&amp;page=imagick.charcoalimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108253" title="75% like this...">
    4
    </div>
  </div>
  <a href="#108253" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108253"> &para;</a><div class="date" title="2012-04-11 11:13"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108253">
<div class="phpcode"><code><span class="html">The parameters for this function are really scary.  Radius of the Gaussian and Standard Deviation of the Gaussian?  After playing with it for a little bit, I think I put it together.  The Gaussian is the "brush" (in Gimp/Photoshop jargin), the radius is simply the radius of the brush, and the standard deviation is the level of variation among the sizes of the brush imprints.  The $radius parameter can be anything from 0 to as high a number as you can think, but once you beyond 10, 20, or 30 pixels, depending on the image size, the whole image gets blurred beyond useful recognition.  The $sigma, being the standard deviation, should be smaller than your radius to get the desired effect.  Think of it as "Charcoal Brushes of $radius Pixels Size, with each brush being as much as $sigma Pixels bigger or smaller than that."<br /><br />For an average 500 x 500 pixel image, you'll probably want a $radius of 3 to 5 and a $sigma of 1 to 3, but you can go as far as 10 pixels generally before the image is blurred beyond recognition.  (At the moment, $radius: 5 / $sigma: 2 is the perfect blend for this 400x400 image that I'm working on right now.)<br /><br />There was not too help from the official documentation site for this project, either: <a href="http://www.imagemagick.org/RMagick/doc/image1.html" rel="nofollow" target="_blank">http://www.imagemagick.org/RMagick/doc/image1.html</a> .  The authors there note: "You can alter the intensity of the effect by changing the radius and sigma arguments."  So, my description here of the functioning is based mostly on experience rather than documentation, which is difficult to find.<br /><br />The following is the entire code for applying the effect to an image.  This code will open the specified file, it will apply the charcoalImage effect to it, and then it will save it to another specified file.  The arguments are served up through POST data, and the only functions of the ImageMagick class that are used are the readImageFile, charcoalImage, and writeImageFile, as so :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />        <br />        // Grab Inbound Data -- Function Parameters<br />        // --------------------------------------------------<br />        <br />    </span><span class="default">$inbound_gaussian_radius </span><span class="keyword">= </span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'radius_of_gaussian'</span><span class="keyword">];<br />    </span><span class="default">$inbound_standard_deviation </span><span class="keyword">= </span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'standard_deviation_of_gaussian'</span><span class="keyword">];<br /><br />        </span><span class="comment">// Grab Inbound Data -- Read-File and Write-File<br />        // --------------------------------------------------<br /><br />    </span><span class="default">$filename_for_function </span><span class="keyword">= </span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'file_target'</span><span class="keyword">];<br />    </span><span class="default">$inbound_save_as_filename </span><span class="keyword">= </span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'saveable_result_file'</span><span class="keyword">];<br />        <br />        </span><span class="comment">// Grab Image File Data<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$folder_location </span><span class="keyword">= </span><span class="string">"images/workshop/"</span><span class="keyword">;<br />    </span><span class="default">$file_to_grab_with_location </span><span class="keyword">= </span><span class="default">$folder_location </span><span class="keyword">. </span><span class="default">$filename_for_function</span><span class="keyword">;<br />    <br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />            <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab_with_location</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Read File<br />        // ---------------------------------------------<br />    <br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Perform Function<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">charcoalImage</span><span class="keyword">(</span><span class="default">$inbound_gaussian_radius</span><span class="keyword">, </span><span class="default">$inbound_standard_deviation</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Save File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$folder_location </span><span class="keyword">= </span><span class="string">"images/workshop/"</span><span class="keyword">;<br />    </span><span class="default">$file_to_grab_with_location </span><span class="keyword">= </span><span class="default">$folder_location </span><span class="keyword">. </span><span class="default">$inbound_save_as_filename</span><span class="keyword">;<br />            <br />    </span><span class="default">$file_handle_for_saving_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab_with_location</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Write File<br />        // ---------------------------------------------<br />    <br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">writeImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_saving_image_file</span><span class="keyword">);<br />        <br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.charcoalimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.charcoalimage.php">＋<small>add a note</small></a></div>
