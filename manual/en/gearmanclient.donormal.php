...
<head>
  ...
  <title>PHP: GearmanClient::doNormal - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.donormal.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.donormal.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.donormal.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.dolowbackground.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.dostatus.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.donormal.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.donormal.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.donormal.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.donormal.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.donormal.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.donormal.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.donormal.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.donormal.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.donormal.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.donormal.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.donormal.php" hreflang="zh">
...
<meta name="Description" content="Run a single task and return a result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::doNormal - Manual" />
<meta name="twitter:description" content="Run a single task and return a result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::doNormal - Manual" />
<meta itemprop="description" content="Run a single task and return a result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Run a single task and return a result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gearmanclient.dostatus.php">
          GearmanClient::doStatus &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.dolowbackground.php">
          &laquo; GearmanClient::doLowBackground        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.donormal.php' selected="selected">English</option>
            <option value='de/gearmanclient.donormal.php'>German</option>
            <option value='es/gearmanclient.donormal.php'>Spanish</option>
            <option value='fr/gearmanclient.donormal.php'>French</option>
            <option value='it/gearmanclient.donormal.php'>Italian</option>
            <option value='ja/gearmanclient.donormal.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.donormal.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.donormal.php'>Russian</option>
            <option value='tr/gearmanclient.donormal.php'>Turkish</option>
            <option value='uk/gearmanclient.donormal.php'>Ukrainian</option>
            <option value='zh/gearmanclient.donormal.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.donormal" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">GearmanClient::doNormal</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">GearmanClient::doNormal</span> &mdash; <span class="dc-title">Run a single task and return a result</span></p>
 ...
 <div class="refsect1 description" id="refsect1-gearmanclient.donormal-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GearmanClient::doNormal</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$function</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$workload</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$unique</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
Success: !olleH</pre>
   ...
   <div class="example" id="example-4604">
    <p><strong>Example #2 Submitting a job and retrieving incremental status</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.dolowbackground.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::doLowBackground()</a> - Run a low priority task in the background</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/donormal.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.donormal%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.donormal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.donormal.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116066">  <div class="votes">
    <div id="Vu116066">
    <a href="/manual/vote-note.php?id=116066&amp;page=gearmanclient.donormal&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116066">
    <a href="/manual/vote-note.php?id=116066&amp;page=gearmanclient.donormal&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116066" title="no votes...">
    0
    </div>
  </div>
  <a href="#116066" class="name">
  <strong class="user"><em>stanislav dot reshetnev at gmail dot com</em></strong></a><a class="genanchor" href="#116066"> &para;</a><div class="date" title="2014-11-05 12:13"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116066">
<div class="phpcode"><code><span class="html">doNormal don't work in version php_gearman 0.8.3:<br /><br />PHP Fatal error:  Call to undefined method GearmanClient::doNormal()<br /><br />But it exist in version 1.1.2.</span></code></div>
  </div>
 </div>
  <div class="note" id="111077">  <div class="votes">
    <div id="Vu111077">
    <a href="/manual/vote-note.php?id=111077&amp;page=gearmanclient.donormal&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111077">
    <a href="/manual/vote-note.php?id=111077&amp;page=gearmanclient.donormal&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111077" title="25% like this...">
    -2
    </div>
  </div>
  <a href="#111077" class="name">
  <strong class="user"><em>fastest963 at gmail dot com</em></strong></a><a class="genanchor" href="#111077"> &para;</a><div class="date" title="2013-01-12 02:19"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111077">
<div class="phpcode"><code><span class="html">do() or doNormal() will block until the job is accepted by the worker. Looping is only necessary if you care about the response from the job. Use setTimeout() to control how long PHP will block.<br /><br />If it does timeout, it throws a PHP Warning:<br />PHP Warning:  GearmanClient::do(): _client_do(GEARMAN_TIMEOUT) occured during gearman_client_run_tasks() -&gt; libgearman/client.cc:174</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gearmanclient.donormal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.donormal.php">＋<small>add a note</small></a></div>
