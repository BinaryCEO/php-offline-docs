...
<head>
  ...
  <title>PHP: ReflectionProperty::getHook - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.gethook.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.gethook.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.gethook.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.getdoccomment.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.gethooks.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.gethook.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.gethook.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.gethook.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.gethook.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.gethook.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.gethook.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.gethook.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.gethook.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.gethook.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.gethook.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.gethook.php" hreflang="zh">
...
<meta name="Description" content="Returns a reflection object for a specified hook" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::getHook - Manual" />
<meta name="twitter:description" content="Returns a reflection object for a specified hook" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::getHook - Manual" />
<meta itemprop="description" content="Returns a reflection object for a specified hook" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a reflection object for a specified hook" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionproperty.gethooks.php">
          ReflectionProperty::getHooks &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.getdoccomment.php">
          &laquo; ReflectionProperty::getDocComment        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.gethook.php' selected="selected">English</option>
            <option value='de/reflectionproperty.gethook.php'>German</option>
            <option value='es/reflectionproperty.gethook.php'>Spanish</option>
            <option value='fr/reflectionproperty.gethook.php'>French</option>
            <option value='it/reflectionproperty.gethook.php'>Italian</option>
            <option value='ja/reflectionproperty.gethook.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.gethook.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.gethook.php'>Russian</option>
            <option value='tr/reflectionproperty.gethook.php'>Turkish</option>
            <option value='uk/reflectionproperty.gethook.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.gethook.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.gethook" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionProperty::getHook</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.4.0)</p><p class="refpurpose"><span class="refname">ReflectionProperty::getHook</span> &mdash; <span class="dc-title">Returns a reflection object for a specified hook</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionproperty.gethook-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionProperty::getHook</strong></span>(<span class="methodparam"><span class="type"><a href="enum.propertyhooktype.php" class="type PropertyHookType">PropertyHookType</a></span> <code class="parameter">$type</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.reflectionmethod.php" class="type ReflectionMethod">ReflectionMethod</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionproperty.gethook-parameters">
...
NULL</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionproperty.gethook-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="enum.propertyhooktype.php" class="classname">PropertyHookType</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/gethook.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.gethook%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.gethook&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.gethook.php">＋<small>add a note</small></a></span>
