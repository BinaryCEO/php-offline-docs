...
<head>
  ...
  <title>PHP: zend_thread_id - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.zend-thread-id.php">
 <link rel="shorturl" href="https://www.php.net/zend-thread-id">
 <link rel="alternate" href="https://www.php.net/zend-thread-id" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.version-compare.php">
 <link rel="next" href="https://www.php.net/manual/en/function.zend-version.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.zend-thread-id.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.zend-thread-id.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.zend-thread-id.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.zend-thread-id.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.zend-thread-id.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.zend-thread-id.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.zend-thread-id.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.zend-thread-id.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.zend-thread-id.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.zend-thread-id.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.zend-thread-id.php" hreflang="zh">
...
<meta name="Description" content="Returns a unique identifier for the current thread" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: zend_thread_id - Manual" />
<meta name="twitter:description" content="Returns a unique identifier for the current thread" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: zend_thread_id - Manual" />
<meta itemprop="description" content="Returns a unique identifier for the current thread" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a unique identifier for the current thread" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.zend-thread-id.php' selected="selected">English</option>
            <option value='de/function.zend-thread-id.php'>German</option>
            <option value='es/function.zend-thread-id.php'>Spanish</option>
            <option value='fr/function.zend-thread-id.php'>French</option>
            <option value='it/function.zend-thread-id.php'>Italian</option>
            <option value='ja/function.zend-thread-id.php'>Japanese</option>
            <option value='pt_BR/function.zend-thread-id.php'>Brazilian Portuguese</option>
            <option value='ru/function.zend-thread-id.php'>Russian</option>
            <option value='tr/function.zend-thread-id.php'>Turkish</option>
            <option value='uk/function.zend-thread-id.php'>Ukrainian</option>
            <option value='zh/function.zend-thread-id.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.zend-thread-id" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">zend_thread_id</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">zend_thread_id</span> &mdash; <span class="dc-title">Returns a unique identifier for the current thread</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-function.zend-thread-id-examples">
  ...
  <p class="para">
   <div class="example" id="example-681">
    <p><strong>Example #1 <span class="function"><strong>zend_thread_id()</strong></span> example</strong></p>
 ...
 <div class="refsect1 notes" id="refsect1-function.zend-thread-id-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    Thread Safety) support and debug mode (<code class="literal">--enable-debug</code>).
   </p>
  </p></blockquote>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/zend-thread-id.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.zend-thread-id%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.zend-thread-id&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.zend-thread-id.php">＋<small>add a note</small></a></span>
