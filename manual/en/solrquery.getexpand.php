...
<head>
  ...
  <title>PHP: SolrQuery::getExpand - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getexpand.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getexpand.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getexpand.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.destruct.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getexpandfilterqueries.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getexpand.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getexpand.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getexpand.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getexpand.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getexpand.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getexpand.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getexpand.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getexpand.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getexpand.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getexpand.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getexpand.php" hreflang="zh">
...
<meta name="Description" content="Returns true if group expanding is enabled" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getExpand - Manual" />
<meta name="twitter:description" content="Returns true if group expanding is enabled" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getExpand - Manual" />
<meta itemprop="description" content="Returns true if group expanding is enabled" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns true if group expanding is enabled" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getexpandfilterqueries.php">
          SolrQuery::getExpandFilterQueries &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.destruct.php">
          &laquo; SolrQuery::__destruct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getexpand.php' selected="selected">English</option>
            <option value='de/solrquery.getexpand.php'>German</option>
            <option value='es/solrquery.getexpand.php'>Spanish</option>
            <option value='fr/solrquery.getexpand.php'>French</option>
            <option value='it/solrquery.getexpand.php'>Italian</option>
            <option value='ja/solrquery.getexpand.php'>Japanese</option>
            <option value='pt_BR/solrquery.getexpand.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getexpand.php'>Russian</option>
            <option value='tr/solrquery.getexpand.php'>Turkish</option>
            <option value='uk/solrquery.getexpand.php'>Ukrainian</option>
            <option value='zh/solrquery.getexpand.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getexpand" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getExpand</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getExpand</span> &mdash; <span class="dc-title">Returns true if group expanding is enabled</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getexpand-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getExpand</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
    Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if group expanding is enabled
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-solrquery.getexpand-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getexpand-returnvalues">
  ...
  <p class="para">
   Returns whether group expanding is enabled.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getexpand.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getexpand%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getexpand&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getexpand.php">＋<small>add a note</small></a></span>
