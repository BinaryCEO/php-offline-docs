...
<head>
  ...
  <title>PHP: ImagickDraw::getTextAlignment - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.gettextalignment.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.gettextalignment.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextalignment.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getstrokewidth.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.gettextantialias.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextalignment.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.gettextalignment.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.gettextalignment.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.gettextalignment.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.gettextalignment.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.gettextalignment.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.gettextalignment.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.gettextalignment.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.gettextalignment.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.gettextalignment.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.gettextalignment.php" hreflang="zh">
...
<meta name="Description" content="Returns the text alignment" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getTextAlignment - Manual" />
<meta name="twitter:description" content="Returns the text alignment" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getTextAlignment - Manual" />
<meta itemprop="description" content="Returns the text alignment" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the text alignment" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.gettextantialias.php">
          ImagickDraw::getTextAntialias &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getstrokewidth.php">
          &laquo; ImagickDraw::getStrokeWidth        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.gettextalignment.php' selected="selected">English</option>
            <option value='de/imagickdraw.gettextalignment.php'>German</option>
            <option value='es/imagickdraw.gettextalignment.php'>Spanish</option>
            <option value='fr/imagickdraw.gettextalignment.php'>French</option>
            <option value='it/imagickdraw.gettextalignment.php'>Italian</option>
            <option value='ja/imagickdraw.gettextalignment.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.gettextalignment.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.gettextalignment.php'>Russian</option>
            <option value='tr/imagickdraw.gettextalignment.php'>Turkish</option>
            <option value='uk/imagickdraw.gettextalignment.php'>Ukrainian</option>
            <option value='zh/imagickdraw.gettextalignment.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.gettextalignment" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getTextAlignment</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getTextAlignment</span> &mdash; <span class="dc-title">Returns the text alignment</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.gettextalignment-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getTextAlignment</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.gettextalignment-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a <a href="imagick.constants.php#imagick.constants.align" class="link">ALIGN</a> constant
   (<code class="literal">imagick::ALIGN_*</code>), and 0 if no align is set.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/gettextalignment.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.gettextalignment%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.gettextalignment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.gettextalignment.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="102919">  <div class="votes">
    <div id="Vu102919">
    <a href="/manual/vote-note.php?id=102919&amp;page=imagickdraw.gettextalignment&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102919">
    <a href="/manual/vote-note.php?id=102919&amp;page=imagickdraw.gettextalignment&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102919" title="100% like this...">
    1
    </div>
  </div>
  <a href="#102919" class="name">
  <strong class="user"><em>moguchicorp at gmail dot com</em></strong></a><a class="genanchor" href="#102919"> &para;</a><div class="date" title="2011-03-14 03:05"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102919">
<div class="phpcode"><code><span class="html">check ImagickDraw::SetTextAlignment notes for examples and constants values
<br />
<br /><a href="http://php.net/manual/en/function.imagickdraw-settextalignment.php" rel="nofollow" target="_blank">http://php.net/manual/en/function.imagickdraw-settextalignment.php</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.gettextalignment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.gettextalignment.php">＋<small>add a note</small></a></div>
