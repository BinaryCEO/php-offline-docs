...
<head>
  ...
  <title>PHP: dbase_replace_record - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.dbase-replace-record.php">
 <link rel="shorturl" href="https://www.php.net/dbase-replace-record">
 <link rel="alternate" href="https://www.php.net/dbase-replace-record" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.dbase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.dbase-pack.php">
 <link rel="next" href="https://www.php.net/manual/en/book.ibase.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.dbase-replace-record.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.dbase-replace-record.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.dbase-replace-record.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.dbase-replace-record.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.dbase-replace-record.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.dbase-replace-record.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.dbase-replace-record.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.dbase-replace-record.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.dbase-replace-record.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.dbase-replace-record.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.dbase-replace-record.php" hreflang="zh">
...
<meta name="Description" content="Replaces a record in a database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: dbase_replace_record - Manual" />
<meta name="twitter:description" content="Replaces a record in a database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: dbase_replace_record - Manual" />
<meta itemprop="description" content="Replaces a record in a database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Replaces a record in a database" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.ibase.php">
          Firebird/InterBase &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.dbase-pack.php">
          &laquo; dbase_pack        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.dbase-replace-record.php' selected="selected">English</option>
            <option value='de/function.dbase-replace-record.php'>German</option>
            <option value='es/function.dbase-replace-record.php'>Spanish</option>
            <option value='fr/function.dbase-replace-record.php'>French</option>
            <option value='it/function.dbase-replace-record.php'>Italian</option>
            <option value='ja/function.dbase-replace-record.php'>Japanese</option>
            <option value='pt_BR/function.dbase-replace-record.php'>Brazilian Portuguese</option>
            <option value='ru/function.dbase-replace-record.php'>Russian</option>
            <option value='tr/function.dbase-replace-record.php'>Turkish</option>
            <option value='uk/function.dbase-replace-record.php'>Ukrainian</option>
            <option value='zh/function.dbase-replace-record.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.dbase-replace-record" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// open in read-write mode<br /></span><span style="color: #0000BB">$db </span><span style="color: #007700">= </span><span style="color: #0000BB">dbase_open</span><span style="color: #007700">(</span><span style="color: #DD0000">'/tmp/test.dbf'</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">);<br /><br />if (</span><span style="color: #0000BB">$db</span><span style="color: #007700">) {<br />  </span><span style="color: #FF8000">// gets the old row<br />  </span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">dbase_get_record_with_names</span><span style="color: #007700">(</span><span style="color: #0000BB">$db</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">);<br />  <br />  </span><span style="color: #FF8000">// remove the 'deleted' entry<br />  </span><span style="color: #007700">unset(</span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #DD0000">'deleted'</span><span style="color: #007700">]);<br />  <br />  </span><span style="color: #FF8000">// Update the date field with the current timestamp<br />  </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #DD0000">'date'</span><span style="color: #007700">] = </span><span style="color: #0000BB">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'Ymd'</span><span style="color: #007700">);<br />  <br />  </span><span style="color: #FF8000">// convert the row to an indexed array<br />  </span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">array_values</span><span style="color: #007700">(</span><span style="color: #0000BB">$row</span><span style="color: #007700">);<br /><br />  </span><span style="color: #FF8000">// Replace the record<br />  </span><span style="color: #0000BB">dbase_replace_record</span><span style="color: #007700">(</span><span style="color: #0000BB">$db</span><span style="color: #007700">, </span><span style="color: #0000BB">$row</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">dbase_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$db</span><span style="color: #007700">);<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.dbase-replace-record-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    Boolean fields result in an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> element value
    (<code class="literal">0</code> or <code class="literal">1</code>) when retrieved via
    <span class="function"><a href="function.dbase-get-record.php" class="function">dbase_get_record()</a></span> or
    <span class="function"><a href="function.dbase-get-record-with-names.php" class="function">dbase_get_record_with_names()</a></span>. If they are written back,
    this results in the value becoming <code class="literal">0</code>, so care has to be
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.dbase-delete-record.php" class="function" rel="rdfs-seeAlso">dbase_delete_record()</a> - Deletes a record from a database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dbase/functions/dbase-replace-record.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.dbase-replace-record%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.dbase-replace-record&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dbase-replace-record.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117316">  <div class="votes">
    <div id="Vu117316">
    <a href="/manual/vote-note.php?id=117316&amp;page=function.dbase-replace-record&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117316">
    <a href="/manual/vote-note.php?id=117316&amp;page=function.dbase-replace-record&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117316" title="50% like this...">
    0
    </div>
  </div>
  <a href="#117316" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#117316"> &para;</a><div class="date" title="2015-05-20 01:53"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117316">
<div class="phpcode"><code><span class="html">Make sure you opened the database for WRITE!<br />dbase_open( "yourfile.dbf", 2)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.dbase-replace-record&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dbase-replace-record.php">＋<small>add a note</small></a></div>
