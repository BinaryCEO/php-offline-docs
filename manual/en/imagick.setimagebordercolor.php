...
<head>
  ...
  <title>PHP: Imagick::setImageBorderColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagebordercolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagebordercolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagebordercolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageblueprimary.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagechanneldepth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagebordercolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagebordercolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagebordercolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagebordercolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagebordercolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagebordercolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagebordercolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagebordercolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagebordercolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagebordercolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagebordercolor.php" hreflang="zh">
...
<meta name="Description" content="Sets the image border color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageBorderColor - Manual" />
<meta name="twitter:description" content="Sets the image border color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageBorderColor - Manual" />
<meta itemprop="description" content="Sets the image border color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image border color" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagechanneldepth.php">
          Imagick::setImageChannelDepth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageblueprimary.php">
          &laquo; Imagick::setImageBluePrimary        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagebordercolor.php' selected="selected">English</option>
            <option value='de/imagick.setimagebordercolor.php'>German</option>
            <option value='es/imagick.setimagebordercolor.php'>Spanish</option>
            <option value='fr/imagick.setimagebordercolor.php'>French</option>
            <option value='it/imagick.setimagebordercolor.php'>Italian</option>
            <option value='ja/imagick.setimagebordercolor.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagebordercolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagebordercolor.php'>Russian</option>
            <option value='tr/imagick.setimagebordercolor.php'>Turkish</option>
            <option value='uk/imagick.setimagebordercolor.php'>Ukrainian</option>
            <option value='zh/imagick.setimagebordercolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagebordercolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageBorderColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageBorderColor</span> &mdash; <span class="dc-title">Sets the image border color</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagebordercolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageBorderColor</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$border</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagebordercolor-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">border</code></dt>
     <dd>
      <p class="para">
       The border color
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagebordercolor-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagebordercolor-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-imagick.setimagebordercolor-changelog">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagebordercolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagebordercolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagebordercolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagebordercolor.php">＋<small>add a note</small></a></span>
