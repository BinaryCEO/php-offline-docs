...
<head>
  ...
  <title>PHP: eio_set_max_poll_time - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-set-max-poll-time.php">
 <link rel="shorturl" href="https://www.php.net/eio-set-max-poll-time">
 <link rel="alternate" href="https://www.php.net/eio-set-max-poll-time" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-set-max-poll-reqs.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-set-min-parallel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-set-max-poll-time.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-set-max-poll-time.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-set-max-poll-time.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-set-max-poll-time.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-set-max-poll-time.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-set-max-poll-time.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-set-max-poll-time.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-set-max-poll-time.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-set-max-poll-time.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-set-max-poll-time.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-set-max-poll-time.php" hreflang="zh">
...
<meta name="Description" content="Set maximum poll time" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_set_max_poll_time - Manual" />
<meta name="twitter:description" content="Set maximum poll time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_set_max_poll_time - Manual" />
<meta itemprop="description" content="Set maximum poll time" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set maximum poll time" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.eio-set-min-parallel.php">
          eio_set_min_parallel &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-set-max-poll-reqs.php">
          &laquo; eio_set_max_poll_reqs        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-set-max-poll-time.php' selected="selected">English</option>
            <option value='de/function.eio-set-max-poll-time.php'>German</option>
            <option value='es/function.eio-set-max-poll-time.php'>Spanish</option>
            <option value='fr/function.eio-set-max-poll-time.php'>French</option>
            <option value='it/function.eio-set-max-poll-time.php'>Italian</option>
            <option value='ja/function.eio-set-max-poll-time.php'>Japanese</option>
            <option value='pt_BR/function.eio-set-max-poll-time.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-set-max-poll-time.php'>Russian</option>
            <option value='tr/function.eio-set-max-poll-time.php'>Turkish</option>
            <option value='uk/function.eio-set-max-poll-time.php'>Ukrainian</option>
            <option value='zh/function.eio-set-max-poll-time.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-set-max-poll-time" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_set_max_poll_time</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_set_max_poll_time</span> &mdash; <span class="dc-title">Set maximum poll time</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-set-max-poll-time-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_set_max_poll_time</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$nseconds</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>

  <p class="para rdfs-comment">
  Polling stops, if poll took longer than <code class="parameter">nseconds</code>
  seconds.
  </p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-set-max-poll-time-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">nseconds</code></dt>
    <dd>
     <p class="para">
     Number of seconds
     </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-set-max-poll-time-returnvalues">
  ...
  No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-set-max-poll-time.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-set-max-poll-time%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-set-max-poll-time&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-set-max-poll-time.php">＋<small>add a note</small></a></span>
