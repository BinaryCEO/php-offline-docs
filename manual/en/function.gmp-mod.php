...
<head>
  ...
  <title>PHP: gmp_mod - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-mod.php">
 <link rel="shorturl" href="https://www.php.net/gmp-mod">
 <link rel="alternate" href="https://www.php.net/gmp-mod" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-legendre.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-mul.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-mod.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-mod.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-mod.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-mod.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-mod.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-mod.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-mod.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-mod.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-mod.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-mod.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-mod.php" hreflang="zh">
...
<meta name="Description" content="Modulo operation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_mod - Manual" />
<meta name="twitter:description" content="Modulo operation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_mod - Manual" />
<meta itemprop="description" content="Modulo operation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Modulo operation" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.gmp-mul.php">
          gmp_mul &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.gmp-legendre.php">
          &laquo; gmp_legendre        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-mod.php' selected="selected">English</option>
            <option value='de/function.gmp-mod.php'>German</option>
            <option value='es/function.gmp-mod.php'>Spanish</option>
            <option value='fr/function.gmp-mod.php'>French</option>
            <option value='it/function.gmp-mod.php'>Italian</option>
            <option value='ja/function.gmp-mod.php'>Japanese</option>
            <option value='pt_BR/function.gmp-mod.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-mod.php'>Russian</option>
            <option value='tr/function.gmp-mod.php'>Turkish</option>
            <option value='uk/function.gmp-mod.php'>Ukrainian</option>
            <option value='zh/function.gmp-mod.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-mod" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_mod</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_mod</span> &mdash; <span class="dc-title">Modulo operation</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-mod-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_mod</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num1</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num2</code></span>): <span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span></div>

  <p class="para rdfs-comment">
   Calculates <code class="parameter">num1</code> modulo
   <code class="parameter">num2</code>. The result is always non-negative, the
   sign of <code class="parameter">num2</code> is ignored.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.gmp-mod-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-mod-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-mod-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3333">
    <p><strong>Example #1 <span class="function"><strong>gmp_mod()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">2</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-mod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-mod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-mod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-mod.php">＋<small>add a note</small></a></span>
