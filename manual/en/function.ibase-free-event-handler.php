...
<head>
  ...
  <title>PHP: ibase_free_event_handler - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-free-event-handler.php">
 <link rel="shorturl" href="https://www.php.net/ibase-free-event-handler">
 <link rel="alternate" href="https://www.php.net/ibase-free-event-handler" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-field-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-free-query.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-free-event-handler.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-free-event-handler.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-free-event-handler.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-free-event-handler.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-free-event-handler.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-free-event-handler.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-free-event-handler.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-free-event-handler.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-free-event-handler.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-free-event-handler.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-free-event-handler.php" hreflang="zh">
...
<meta name="Description" content="Cancels a registered event handler" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_free_event_handler - Manual" />
<meta name="twitter:description" content="Cancels a registered event handler" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_free_event_handler - Manual" />
<meta itemprop="description" content="Cancels a registered event handler" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Cancels a registered event handler" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-free-query.php">
          ibase_free_query &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-field-info.php">
          &laquo; ibase_field_info        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-free-event-handler.php' selected="selected">English</option>
            <option value='de/function.ibase-free-event-handler.php'>German</option>
            <option value='es/function.ibase-free-event-handler.php'>Spanish</option>
            <option value='fr/function.ibase-free-event-handler.php'>French</option>
            <option value='it/function.ibase-free-event-handler.php'>Italian</option>
            <option value='ja/function.ibase-free-event-handler.php'>Japanese</option>
            <option value='pt_BR/function.ibase-free-event-handler.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-free-event-handler.php'>Russian</option>
            <option value='tr/function.ibase-free-event-handler.php'>Turkish</option>
            <option value='uk/function.ibase-free-event-handler.php'>Ukrainian</option>
            <option value='zh/function.ibase-free-event-handler.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-free-event-handler" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_free_event_handler</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_free_event_handler</span> &mdash; <span class="dc-title">Cancels a registered event handler</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-free-event-handler-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_free_event_handler</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$event</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   This function causes the registered event handler specified by
   <code class="parameter">event</code> to be cancelled. The callback function will
   no longer be called for the events it was registered to handle.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ibase-free-event-handler-parameters">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <span class="function"><a href="function.ibase-set-event-handler.php" class="function">ibase_set_event_handler()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-free-event-handler-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-free-event-handler-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ibase-set-event-handler.php" class="function" rel="rdfs-seeAlso">ibase_set_event_handler()</a> - Register a callback function to be called when events are posted</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-free-event-handler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-free-event-handler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-free-event-handler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-free-event-handler.php">＋<small>add a note</small></a></span>
