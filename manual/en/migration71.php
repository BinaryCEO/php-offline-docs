...
<head>
  ...
  <title>PHP: Migrating from PHP 7.0.x to PHP 7.1.x - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration71.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration71.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration71.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/appendices.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration72.other-changes.php">
 <link rel="next" href="https://www.php.net/manual/en/migration71.new-features.php">
...
<meta name="Description" content="Migrating from PHP 7.0.x to PHP 7.1.x" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Migrating from PHP 7.0.x to PHP 7.1.x - Manual" />
<meta name="twitter:description" content="Migrating from PHP 7.0.x to PHP 7.1.x" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Migrating from PHP 7.0.x to PHP 7.1.x - Manual" />
<meta itemprop="description" content="Migrating from PHP 7.0.x to PHP 7.1.x" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Migrating from PHP 7.0.x to PHP 7.1.x" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration71.php' selected="selected">English</option>
            <option value='de/migration71.php'>German</option>
            <option value='es/migration71.php'>Spanish</option>
 ...
 <h1 class="title">Migrating from PHP 7.0.x to PHP 7.1.x</h1>
<h2>Table of Contents</h2><ul class="chunklist chunklist_appendix"><li><a href="migration71.new-features.php">New features</a></li><li><a href="migration71.new-functions.php">New functions</a></li><li><a href="migration71.constants.php">New global constants</a></li><li><a href="migration71.incompatible.php">Backward incompatible changes</a></li><li><a href="migration71.deprecated.php">Deprecated features in PHP 7.1.x</a></li><li><a href="migration71.changed-functions.php">Changed functions</a></li><li><a href="migration71.other-changes.php">Other changes</a></li><li><a href="migration71.windows-support.php">Windows Support</a></li></ul>


 <p class="para">
  This new minor version brings with it a number of
  <a href="migration71.new-features.php" class="link">new features</a> and a
  <a href="migration71.incompatible.php" class="link">few incompatibilities</a>
  ...
  <a href="migration70.php" class="link">7.0.x</a>.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration71.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration71%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration71&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration71.php">＋<small>add a note</small></a></span>
