...
<head>
  ...
  <title>PHP: basename - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.basename.php">
 <link rel="shorturl" href="https://www.php.net/basename">
 <link rel="alternate" href="https://www.php.net/basename" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="next" href="https://www.php.net/manual/en/function.chgrp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.basename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.basename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.basename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.basename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.basename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.basename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.basename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.basename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.basename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.basename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.basename.php" hreflang="zh">
...
<meta name="Description" content="Returns trailing name component of path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: basename - Manual" />
<meta name="twitter:description" content="Returns trailing name component of path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: basename - Manual" />
<meta itemprop="description" content="Returns trailing name component of path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns trailing name component of path" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.basename.php' selected="selected">English</option>
            <option value='de/function.basename.php'>German</option>
            <option value='es/function.basename.php'>Spanish</option>
            <option value='fr/function.basename.php'>French</option>
            <option value='it/function.basename.php'>Italian</option>
            <option value='ja/function.basename.php'>Japanese</option>
            <option value='pt_BR/function.basename.php'>Brazilian Portuguese</option>
            <option value='ru/function.basename.php'>Russian</option>
            <option value='tr/function.basename.php'>Turkish</option>
            <option value='uk/function.basename.php'>Ukrainian</option>
            <option value='zh/function.basename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.basename" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pathinfo.php" class="function" rel="rdfs-seeAlso">pathinfo()</a> - Returns information about a file path</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/basename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.basename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.basename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.basename.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">5 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121405">  <div class="votes">
    <div id="Vu121405">
    <a href="/manual/vote-note.php?id=121405&amp;page=function.basename&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121405">
    <a href="/manual/vote-note.php?id=121405&amp;page=function.basename&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121405" title="68% like this...">
    54
    </div>
  </div>
  <a href="#121405" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#121405"> &para;</a><div class="date" title="2017-07-20 05:04"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121405">
<div class="phpcode"><code><span class="html">It's a shame, that for a 20 years of development we don't have mb_basename() yet!<br /><br />// works both in windows and unix<br />function mb_basename($path) {<br />    if (preg_match('@^.*[\\\\/]([^\\\\/]+)$@s', $path, $matches)) {<br />        return $matches[1];<br />    } else if (preg_match('@^([^\\\\/]+)$@s', $path, $matches)) {<br />        return $matches[1];<br />    }<br />    return '';<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="85369">  <div class="votes">
    <div id="Vu85369">
    <a href="/manual/vote-note.php?id=85369&amp;page=function.basename&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd85369">
    <a href="/manual/vote-note.php?id=85369&amp;page=function.basename&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V85369" title="55% like this...">
    12
    </div>
  </div>
  <a href="#85369" class="name">
  <strong class="user"><em>(remove) dot nasretdinov at (remove) dot gmail dot com</em></strong></a><a class="genanchor" href="#85369"> &para;</a><div class="date" title="2008-08-27 08:20"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom85369">
<div class="phpcode"><code><span class="html">There is only one variant that works in my case for my Russian UTF-8 letters:
<br />
...
<br />&gt;&lt;
<br />
<br /></span><span class="default">It is intented </span><span class="keyword">for </span><span class="default">UNIX servers</span></span></code></div>
  </div>
 </div>
  <div class="note" id="94026">  <div class="votes">
    <div id="Vu94026">
    <a href="/manual/vote-note.php?id=94026&amp;page=function.basename&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94026">
    <a href="/manual/vote-note.php?id=94026&amp;page=function.basename&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94026" title="51% like this...">
    4
    </div>
  </div>
  <a href="#94026" class="name">
  <strong class="user"><em>swedish boy</em></strong></a><a class="genanchor" href="#94026"> &para;</a><div class="date" title="2009-10-12 03:43"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94026">
<div class="phpcode"><code><span class="html">Here is a quick way of fetching only the filename (without extension) regardless of what suffix the file has.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">// your file<br /></span><span class="default">$file </span><span class="keyword">= </span><span class="string">'image.jpg'</span><span class="keyword">;<br /><br /></span><span class="default">$info </span><span class="keyword">= </span><span class="default">pathinfo</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">);<br /></span><span class="default">$file_name </span><span class="keyword">=  </span><span class="default">basename</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">,</span><span class="string">'.'</span><span class="keyword">.</span><span class="default">$info</span><span class="keyword">[</span><span class="string">'extension'</span><span class="keyword">]);<br /><br />echo </span><span class="default">$file_name</span><span class="keyword">; </span><span class="comment">// outputs 'image'<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="130290">  <div class="votes">
    <div id="Vu130290">
    <a href="/manual/vote-note.php?id=130290&amp;page=function.basename&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130290">
    <a href="/manual/vote-note.php?id=130290&amp;page=function.basename&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130290" title="100% like this...">
    1
    </div>
  </div>
  <a href="#130290" class="name">
  <strong class="user"><em>bobray at softville dot com</em></strong></a><a class="genanchor" href="#130290"> &para;</a><div class="date" title="2025-05-12 08:25"><strong>4 months ago</strong></div>
  <div class="text" id="Hcom130290">
<div class="phpcode"><code><span class="html">You might expect that echo basename('directory_name/') would return an empty string. Instead, it returns 'directory_name', without the slash.</span></code></div>
  </div>
 </div>
  <div class="note" id="49486">  <div class="votes">
    <div id="Vu49486">
    <a href="/manual/vote-note.php?id=49486&amp;page=function.basename&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd49486">
    <a href="/manual/vote-note.php?id=49486&amp;page=function.basename&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V49486" title="51% like this...">
    1
    </div>
  </div>
  <a href="#49486" class="name">
  <strong class="user"><em>KOmaSHOOTER at gmx dot de</em></strong></a><a class="genanchor" href="#49486"> &para;</a><div class="date" title="2005-01-29 04:24"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom49486">
<div class="phpcode"><code><span class="html">If you want the current path where youre file is and not the full path then use this :)<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">echo(</span><span class="string">'dir = '</span><span class="keyword">.</span><span class="default">basename </span><span class="keyword">(</span><span class="default">dirname</span><span class="keyword">(</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_SELF'</span><span class="keyword">]),</span><span class="string">"/"</span><span class="keyword">));    <br /></span><span class="comment">// retuns the name of current used directory<br /></span><span class="default">?&gt;<br /></span><br />Example: <br /><br />www dir: domain.com/temp/2005/january/t1.php<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">echo(</span><span class="string">'dirname &lt;br&gt;'</span><span class="keyword">.</span><span class="default">dirname</span><span class="keyword">(</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_SELF'</span><span class="keyword">]).</span><span class="string">'&lt;br&gt;&lt;br&gt;'</span><span class="keyword">);    <br /></span><span class="comment">// returns: /temp/2005/january<br /></span><span class="default">?&gt;<br /></span><br /><span class="default">&lt;?php<br /></span><span class="keyword">echo(</span><span class="string">'file = '</span><span class="keyword">.</span><span class="default">basename </span><span class="keyword">(</span><span class="default">$PHP_SELF</span><span class="keyword">,</span><span class="string">".php"</span><span class="keyword">));    <br /></span><span class="comment">// returns: t1<br /></span><span class="default">?&gt;<br /></span><br />if you combine these two you get this<br /><span class="default">&lt;?php <br /></span><span class="keyword">echo(</span><span class="string">'dir = '</span><span class="keyword">.</span><span class="default">basename </span><span class="keyword">(</span><span class="default">dirname</span><span class="keyword">(</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_SELF'</span><span class="keyword">]),</span><span class="string">"/"</span><span class="keyword">));    <br /></span><span class="comment">// returns: january<br /></span><span class="default">?&gt;<br /></span><br />And for the full path use this<br /><span class="default">&lt;?php <br /></span><span class="keyword">echo(</span><span class="string">' PHP_SELF &lt;br&gt;'</span><span class="keyword">.</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_SELF'</span><span class="keyword">].</span><span class="string">'&lt;br&gt;&lt;br&gt;'</span><span class="keyword">);<br /></span><span class="comment">// returns: /temp/2005/january/t1.php    <br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.basename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.basename.php">＋<small>add a note</small></a></div>
