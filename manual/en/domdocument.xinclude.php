...
<head>
  ...
  <title>PHP: DOMDocument::xinclude - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/domdocument.xinclude.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/domdocument.xinclude.php">
 <link rel="alternate" href="https://www.php.net/manual/en/domdocument.xinclude.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.domdocument.php">
 <link rel="prev" href="https://www.php.net/manual/en/domdocument.validate.php">
 <link rel="next" href="https://www.php.net/manual/en/class.domdocumentfragment.php">

 <link rel="alternate" href="https://www.php.net/manual/en/domdocument.xinclude.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/domdocument.xinclude.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/domdocument.xinclude.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/domdocument.xinclude.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/domdocument.xinclude.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/domdocument.xinclude.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/domdocument.xinclude.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/domdocument.xinclude.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/domdocument.xinclude.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/domdocument.xinclude.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/domdocument.xinclude.php" hreflang="zh">
...
<meta name="Description" content="Substitutes XIncludes in a DOMDocument Object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMDocument::xinclude - Manual" />
<meta name="twitter:description" content="Substitutes XIncludes in a DOMDocument Object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMDocument::xinclude - Manual" />
<meta itemprop="description" content="Substitutes XIncludes in a DOMDocument Object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Substitutes XIncludes in a DOMDocument Object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.domdocumentfragment.php">
          DOMDocumentFragment &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domdocument.validate.php">
          &laquo; DOMDocument::validate        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/domdocument.xinclude.php' selected="selected">English</option>
            <option value='de/domdocument.xinclude.php'>German</option>
            <option value='es/domdocument.xinclude.php'>Spanish</option>
            <option value='fr/domdocument.xinclude.php'>French</option>
            <option value='it/domdocument.xinclude.php'>Italian</option>
            <option value='ja/domdocument.xinclude.php'>Japanese</option>
            <option value='pt_BR/domdocument.xinclude.php'>Brazilian Portuguese</option>
            <option value='ru/domdocument.xinclude.php'>Russian</option>
            <option value='tr/domdocument.xinclude.php'>Turkish</option>
            <option value='uk/domdocument.xinclude.php'>Ukrainian</option>
            <option value='zh/domdocument.xinclude.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="domdocument.xinclude" class="refentry">
...
&lt;/chapter&gt;</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domdocument/xinclude.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdomdocument.xinclude%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=domdocument.xinclude&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domdocument.xinclude.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="76372">  <div class="votes">
    <div id="Vu76372">
    <a href="/manual/vote-note.php?id=76372&amp;page=domdocument.xinclude&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd76372">
    <a href="/manual/vote-note.php?id=76372&amp;page=domdocument.xinclude&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V76372" title="100% like this...">
    8
    </div>
  </div>
  <a href="#76372" class="name">
  <strong class="user"><em>nicolas_rainardNOSPAM at yahoo dot fr</em></strong></a><a class="genanchor" href="#76372"> &para;</a><div class="date" title="2007-07-12 04:56"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom76372">
<div class="phpcode"><code><span class="html">If you use the loadXML() method instead of the load() one (let's say, to process the XML string before loading and parsing it), you will have problems with xinclude(), because the parser will not know where to find the files to include.<br />Using chdir() before xinclude() will not help.<br /><br />The solution is to set the documentURI property of the DOMDocument object accordingly to it's original filename, and everything will work fine !<br /><br /><span class="default">&lt;?php<br /><br />$xml </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">);<br /></span><span class="default">$xml </span><span class="keyword">= </span><span class="default">do_something_with</span><span class="keyword">(</span><span class="default">$xml</span><span class="keyword">);<br /><br /></span><span class="default">$doc </span><span class="keyword">= new </span><span class="default">DOMDocument</span><span class="keyword">;<br /></span><span class="default">$doc</span><span class="keyword">-&gt;</span><span class="default">documentURI </span><span class="keyword">= </span><span class="default">$file</span><span class="keyword">;<br /></span><span class="default">$doc</span><span class="keyword">-&gt;</span><span class="default">loadXML</span><span class="keyword">(</span><span class="default">$xml</span><span class="keyword">);<br /></span><span class="default">$doc</span><span class="keyword">-&gt;</span><span class="default">xinclude</span><span class="keyword">();<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=domdocument.xinclude&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domdocument.xinclude.php">＋<small>add a note</small></a></div>
